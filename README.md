...
> Forked from https://github.com/tatsu-lab/gpt_paper_assistant
...
5. Set your openai key (`OPENAI_API_KEY`) and (`OPENAI_BASE_URL`) as ``a [github secret](https://docs.github.com/en/actions/security-guides/using-secrets-in-github-actions#creating-secrets-for-a-repository)
...
Instead of passing credentials via github secrets, you have to set environment variables `OPENAI_API_KEY`, `SLACK_KEY`, `SLACK_CHANNEL_ID`.
