...
1. [Deep Imaging Meets Motion: Complementing Stream Photometry Through Planetary Nebula Kinematics](#user-content-link1)
**Authors:** Lucas M. Valenzuela, Johannes Stoiber, Rhea-Silvia Remus

2. [Cold vs. Hot Gas Accretion and Angular Momentum in FIRE Simulations: From Halo to Galaxy Scales](#user-content-link2)
**Authors:** Imran Sultan, Claude-Andr\'e Faucher-Gigu\`ere, Jonathan Stern, Guochao Sun

3. [The Last Galactic Firework: Timing the last significant merger with stars, globular clusters and $\omega$Centauri](#user-content-link3)
**Authors:** Chervin F. P. Laporte, Matthew D. A. Orkney

4. [Stream on: Evolution of stellar shells and streams - A case study](#user-content-link4)
**Authors:** Johannes Stoiber, Lucas M. Valenzuela, Rhea-Silvia Remus, Klaus Dolag

5. [FAST and Dark: A catalogue of Dark Galaxy Candidates within 50 Mpc](#user-content-link5)
**Authors:** Marco Monaci, Duncan A. Forbes, Jonah S. Gannon, B\"arbel S. Koribalski, Kenji Bekki, Jean P. Brodie, Warrick J. Couch

6. [The GECKOS survey: Resolving the molecular and ionised gas in the galactic outflow of ESO~484-036](#user-content-link6)
**Authors:** J. Hern\'andez-Y\'evenes, D. B. Fisher, B. Mazzilli Ciraulo, R. L. Davies, M. Martig, A. Fraser-McKelvie, J. van de Sande, M. R. Hayden, R. Elliot, E. Emsellem, F. Combes, A. D. Bolatto, J. Bland-Hawthorn, L. Cortese, T. A. Davis, B. Catinella, L. M. Valenzuela, S. M. Croom, S. A. Fortun\'e, L. A. Silva-Lima, C. L\'opez-Cob\'a, A. Mailvaganam, G. van de Ven

7. [Understanding the regulation of star formation within TNG100 galaxies on kpc-scales using machine learning I: Global versus local](#user-content-link7)
**Authors:** Bryanne McDonough, Sathvika S. Iyengar, Ansa Brew-Smith, Asa F. L. Bluck, Joanna Piotrowska

8. [A simple yet effective model of galaxy mergers](#user-content-link8)
**Authors:** Cesare Chiosi, Mauro D'Onofrio, Emanuela Chiosi

9. [Tracing evolutionary pathways of bar-driven quenching in local Universe disc galaxies](#user-content-link9)
**Authors:** D Renu, Smitha Subramanian, Koshy George

10. [Do galaxy mergers increase star formation and turbulence at cosmic noon?](#user-content-link10)
**Authors:** I. Kanowski, J. T. Mendel, E. Wisnioski, N. M. F\"orster Schreiber, A. Marchal, T. Tsukui

11. [Cosmology of Inelastic Self-Interacting Dark Matter: Linear Evolution and Observational Constraints](#user-content-link11)
**Authors:** Xin-Chen Duan, Yue-Lin Sming Tsai, Ziwei Wang

12. [Stellar nucleosynthesis in the era of large surveys: s-process polluted binaries in GALAH DR4](#user-content-link12)
**Authors:** A. Escorza, S. Vitali, D. Godoy-Rivera, S. Shetye, H. Van Winckel, G. Bustos, S. Goriely, L. Siess, M. Abdul-Masih, T. Masseron, D. A. Garc\'ia-Hern\'andez, A. Ardern-Arentsen, P. Jofr\'e, S. Van Eck

13. [Disk-like galaxies at 4 < z < 7.7 : JWST/NIRCam morphologies revealed by denoising VAE-GCNN classification](#user-content-link13)
**Authors:** S. S. Mirzoyan, A. Avagyan, V. G. Gurzadyan

14. [ALMA-IMF XXII. Role of core subfragmentation in the IMF origin: Hierarchical fragmentation cascade and CMF in W43-MM1](#user-content-link14)
...
19. [Photometric Metallicities for 367,324 stars of Omega Centauri](#user-content-link19)
**Authors:** Xue Lu, Haibo Yuan, Bowen Huang, Tao Wang, Timothy C. Beers

20. [Echoes of Global Cosmic Strings](#user-content-link20)
**Authors:** Jeff A. Dror, Antonios Kyriazis

21. [Tracking ionization balance in intergalactic medium and its implications towards metallicity](#user-content-link21)
**Authors:** Bhaskar Arya, Kartick C. Sarkar, Shiv K. Sethi

22. [Closing the Observational Gap in Cosmic Dynamics: AI-Enabled Reconstruction of the Universe's Vorticity and Rotational Flow Morphology](#user-content-link22)
**Authors:** Ziyong Wu, Xu Xiao, Fuyu Dong, Juhan Kim, Yan-Chuan Cai, Yang Wang, Xi Kang, Le Zhang, Xin Wang, Xiao-Dong Li

23. [Neutrino self-interactions in post-reionization era: Lyman-$\alpha$, 21-cm and cross-spectra](#user-content-link23)
**Authors:** Sourav Pal, Supratik Pal

24. [Emergent structure in the binary black hole mass distribution and implications for population-based cosmology](#user-content-link24)
**Authors:** Vasco Gennari, Tom Bertheas, Nicola Tamanini

25. [The Atacama Cosmology Telescope: A Test of the Gravitational Force Law on Cosmological Scales Using the Kinematic Sunyaev-Zeldovich Effect](#user-content-link25)
**Authors:** Patricio A. Gallardo, Kris Pardo, Oliver H. E. Philcox, Nicholas Battaglia, Elia S. Battistelli, Rachel Bean, Erminia Calabrese, Steve K. Choi, Rolando D\"unner, Mark Devlin, Joanna Dunkley, Simone Ferraro, Yilun Guan, Erin Healy, Carlos Herv\'ias-Caimapo, Matt Hilton, Adam D. Hincks, John C. Hood II, Arthur Kosowsky, Adrien La Posta, Thibaut Louis, Mathew S. Madhavacheril, Jeff McMahon, Kavilan Moodley, Tony Mroczkowski, Sigurd Naess, Laura Newburgh, Michael D. Niemack, Lyman A. Page, Bruce Partridge, Roberto Puddu, Emmanuel Schaan, Neelima Sehgal, Crist\'obal Sif\'on, David N. Spergel, Suzanne T. Staggs, Alexander van Engelen, Cristian Vargas, Eve M. Vavagiakis, Kasey Wagoner, Edward J. Wollack

26. [Forecasting neutrino mass constraints from the Nancy Grace Roman Space Telescope](#user-content-link26)
**Authors:** Francesco Spezzati, Yun Wang, Andrew Hearin

27. [Structure and Large-Scale Kinematics of Young Stellar Populations in the NGC 6357 and NGC 6334 Giant Molecular Cloud Complex](#user-content-link27)
...
28. [Microscopic primordial black holes as macroscopic dark matter from large extra dimensions](#user-content-link28)
**Authors:** Giuseppe Filiberto Vitale, Gaetano Lambiase, Tanmay Kumar Poddar, Luca Visinelli

29. [An FUor-like Outbursting Class I Protostar in NGC 7538](#user-content-link29)
**Authors:** Aidi Fang, Zhiwei Chen, Lin Du, Sheng Zheng

30. [A fast X-ray transient with chromatic flares: signatures of violent collisions induced by late-time central engine reactivation](#user-content-link30)
...
31. [Boson star-black hole binaries: initial data and head-on collisions](#user-content-link31)
**Authors:** Zhuan Ning

32. [FAIR Universe Weak Lensing ML Uncertainty Challenge: Handling Uncertainties and Distribution Shifts for Precision Cosmology](#user-content-link32)
**Authors:** Biwei Dai, Po-Wen Chang, Wahid Bhimji, Paolo Calafiura, Ragansu Chakkappai, Yuan-Tang Chou, Sascha Diefenbacher, Jordan Dudley, Ibrahim Elsharkawy, Steven Farrell, Isabelle Guyon, Chris Harris, Elham E Khoda, Benjamin Nachman, David Rousseau, Uro\v{s} Seljak, Ihsan Ullah, Yulei Zhang

33. [Astrophysical bounds on the high-energy evolution of neutrino mixing](#user-content-link33)
**Authors:** Mauricio Bustamante, Qinrui Liu, Gabriela Barenboim

34. [Ultrahigh-energy cosmogenic neutrino emissions in the high-redshift universe](#user-content-link34)
**Authors:** Shigeru Yoshida, Maximilian Meier

35. [Consistent Treatment of Muons in Binary Neutron Star Mergers](#user-content-link35)
**Authors:** Henrique Gieg, Ramon Jaeger, Maximiliano Ujevic, Tim Dietrich

36. [Could the high-mass black holes from gravitational-wave observations be explained by lensing?](#user-content-link36)
**Authors:** Ritesh Harshe, R. Prasad, Parameswaran Ajith

37. [The splash beneath the largest radio bubble in a cluster core](#user-content-link37)
**Authors:** H. R. Russell, P. E. J. Nulsen, A. C. Fabian, B. R. McNamara, J. S. Sanders, N. Werner

38. [An Improved Fit for Linear Halo Bias at High Redshift](#user-content-link38)
**Authors:** Kuan Wang, Julian B. Mu\~noz, L. Y. Aaron Yung

39. [GRB 210704A: A Luminous Fast Blue Transient in a GRB Afterglow at $z = 2.34$](#user-content-link39)
...
40. [The azimuthal structure of magnetically arrested disks during flux eruption events](#user-content-link40)
**Authors:** Argyrios Loules, Antonios Nathanail, Ioannis Contopoulos

41. [Upper bound of ejecta mass in a nova outburst](#user-content-link41)
**Authors:** Izumi Hachisu, Mariko Kato

42. [NOMAI : A real-time photometric classifier for superluminous supernovae identification. A science module for the Fink broker](#user-content-link42)
...
43. [Quantum correction to the diffusion term in stochastic inflation from composite-operator matching in Soft de Sitter Effective Theory](#user-content-link43)
**Authors:** Martin Beneke, Patrick Hager, Andrea F. Sanfilippo

44. [A Fast and Physically Grounded Ocean Model for GCMs: The Dynamical Slab Ocean Model of the Generic-PCM (rev. 3423)](#user-content-link44)
**Authors:** Siddharth Bhatnagar, Francis Codron, Ehouarn Millour, Emeline Bolmont, Maura Brunetti, J\'er\^ome Kasparian, Martin Turbet, Guillaume Chaverot

45. [Fast neural network surrogate for multimodal effective-one-body gravitational waveforms from generically precessing compact binaries](#user-content-link45)
**Authors:** Christopher Whittall, Geraint Pratten

46. [Inflaton Regeneration via Scalar Couplings: Generic Models and the Higgs Portal](#user-content-link46)
**Authors:** Kunio Kaneta, Tomo Takahashi, Natsumi Watanabe

47. [Impact of Baseline, Cadence, and Host Contamination on AGN Variability Metrics: A Systematic Study with ZTF](#user-content-link47)
**Authors:** Diego Mart\'inez Collipal, Swayamtrupta Panda

48. [Sky background accounting in spectral infrared observations of extended objects at the Caucasus Mountain Observatory of the SAI MSU](#user-content-link48)
**Authors:** A. S. Gusev, A. M. Tatarnikov, S. G. Zheltoukhov, M. S. Kirsanova

49. [Nonlinear backstepping with saturation for low-thrust station-keeping of libration point orbits](#user-content-link49)
**Authors:** Ant\'onio Nunes, S\'ergio Br\'as, Pedro Batista

50. [Systematic assessment of disk truncation in the black hole X-ray binary Swift J1727.8-1613 using NICER](#user-content-link50)
...
51. [Influence of winds on shocked magnetized viscous accretion flows around rotating black holes](#user-content-link51)
**Authors:** Camelia Jana, Santabrata Das

52. [Gravitational-wave lensing beyond rays: a disordered-system approach](#user-content-link52)
**Authors:** Ripalta Amoruso, Ginevra Braga, Alice Garoffolo, Francescopaolo Lopez, Nicola Bartolo, Sabino Matarrese

53. [Nonperturbative stochastic inflation in perturbative dynamical background](#user-content-link53)
**Authors:** Xiao-Quan Ye, Shao-Jiang Wang

54. [Exploring non-equilibrium effects in sequential freeze-in](#user-content-link54)
**Authors:** Shiuli Chatterjee, Andrzej Hryczuk

55. [Static Tidal Perturbations of Relativistic Stars: Corrected Center Expansion and Love Numbers-I](#user-content-link55)
**Authors:** Emel Altas, Ercan Kilicarslan, Onur Oktay, Bayram Tekin

56. [Constraining Quintessential Inflation with ACT: A Gauss-Bonnet Gateway](#user-content-link56)
**Authors:** Yogesh, Imtiyaz Ahmad Bhat, Mayukh R. Gangopadhyay, M. Sami

57. [A Generalized Algorithmic Framework for Detecting Faraday Rotation Measure Flares in Repeating Fast Radio Bursts](#user-content-link57)
**Authors:** Yuan-Pei Yang, Boyang Liu

58. [Localization and Confidence Region Estimation of Short GRBs with the COSI BGO Shield Using a HEALPix-Based Deep Learning Approach](#user-content-link58)
...
59. [Combining spectroscopy and wavefront control at deep contrast with photonic lanterns](#user-content-link59)
...
60. [Numerical investigation of particle acceleration at interplanetary shocks: diffusive and superdiffusive scenarios](#user-content-link60)
**Authors:** Giuseppe Prete, Gaetano Zimbardo, Silvia Perri

61. [Rapid-response 1.3 mm Observations of GRB 260127A with the Submillimeter Array](#user-content-link61)
...
62. [A simple relation: Neutron star magnetic field strength and spectral shape at low mass accretion rates](#user-content-link62)
**Authors:** Nicolas Zalot, Ekaterina Sokolova-Lapa, Aafia Zainab, Philipp Thalhammer, Jakob Stierhof, Katrin Berger, Katja Pottschmidt, Ralf Ballhausen, Christian Malacaria, Esin Gulbahar, J\"orn Wilms

63. [Radiation doses during extreme solar energetic particle events](#user-content-link63)
**Authors:** S. Dalla, K. Herbst, R. Muscheler, M. J. Owens

64. [Synchrotron-cooled plasma distribution in the outer magnetosphere of a neutron star](#user-content-link64)
**Authors:** Mikhail V. Medvedev, Anatoly Spitkovsky, Alexander Philippov

65. [Continuing to Advance European High Contrast Imaging Research and Development towards HWO and LIFE](#user-content-link65)
**Authors:** Gael Chauvin, Oscar Carrion Gonzalez, Iva Laginja, Daniel Dicken, Sebastiaan Haffert, Markus Kasper, Olivier Absil, Jens Kammerer, Axel Potier, Herve Le Coroller, Elisabeth Matthews, Romain Laugier, Denis Defrere, Jonah Hansen, Oliver Krause, Pieter de Visser, Mikael Karlsson, Thomas Henning, Marc Ferrari, Jonas Kuehn, Markus Janson, Feng Zhao, Celia Desgrange

---

## 1. [Deep Imaging Meets Motion: Complementing Stream Photometry Through Planetary Nebula Kinematics](https://arxiv.org/abs/2604.14272) <a id="link1"></a>
...
**Comment:** The paper combines deep imaging and planetary nebula kinematics to study stellar streams in galaxy outskirts using cosmological simulations. This directly relates to near-field cosmology, specifically the study of tidal features and stellar streams, and uses numerical galaxy simulations. It is highly relevant to the criteria.
...
## 3. [The Last Galactic Firework: Timing the last significant merger with stars, globular clusters and $\omega$Centauri](https://arxiv.org/abs/2604.14502) <a id="link3"></a>
...
**Comment:** This paper focuses on the timing and consequences of the last significant merger in the Milky Way, including the accreted stellar halo and globular clusters. It directly addresses near-field cosmology, specifically historic interactions and accreted halo structure. The discussion of globular clusters and merger-induced starburst is also relevant to resolved star formation histories, but the main focus is on near-field cosmology.
...
## 4. [Stream on: Evolution of stellar shells and streams - A case study](https://arxiv.org/abs/2604.14280) <a id="link4"></a>
...
**Comment:** This paper analyzes tidal stellar shells and streams formed from accreted satellite galaxies using cosmological hydrodynamical simulations. It directly addresses near-field cosmology by studying the remnants of satellite galaxy accretion and their stellar distributions, which are highly relevant. The use of high-resolution galaxy simulations also matches the numerical galaxy simulations criterion.
...
## 5. [FAST and Dark: A catalogue of Dark Galaxy Candidates within 50 Mpc](https://arxiv.org/abs/2604.14699) <a id="link5"></a>
...
**Comment:** This paper presents a catalogue of dark galaxy candidates within 50 Mpc, focusing on galaxies without optical counterparts and their HI properties. The topic is closely related to near-field cosmology, specifically the abundance and properties of low-luminosity galaxies and substructure. The catalogue could be useful for studies of satellite luminosity functions and dark matter profiles. No direct mention of resolved star formation histories, quenching, or CGM, but the focus on dark galaxies is highly relevant.
...
## 6. [The GECKOS survey: Resolving the molecular and ionised gas in the galactic outflow of ESO~484-036](https://arxiv.org/abs/2604.14546) <a id="link6"></a>
...
**Comment:** This paper presents a multiphase study of star-formation-driven outflows in a starburst galaxy, measuring mass-loading factors and phase structure. It directly matches the 'Star Formation Driven Outflows' criterion, with detailed measurements of mass-loading factors and comparison to simulations. The galaxy is more massive than the LMC, but the focus on outflows and mass-loading is highly relevant.
...
## 7. [Understanding the regulation of star formation within TNG100 galaxies on kpc-scales using machine learning I: Global versus local](https://arxiv.org/abs/2604.15182) <a id="link7"></a>
...
**Comment:** This paper uses machine learning to analyze star formation and quenching in simulated galaxies (TNG100). It discusses quenching, including environmental quenching in low-mass satellites, and uses numerical galaxy simulations. Relevant to both quenching and numerical simulations, though the focus is on simulated data.
...
## 8. [A simple yet effective model of galaxy mergers](https://arxiv.org/abs/2604.14674) <a id="link8"></a>
...
**Comment:** This paper presents a simple model of galaxy mergers, focusing on dry mergers and their impact on galaxy scaling relations. It discusses star formation, quenching, and energy feedback, and compares results to large-scale cosmo-hydro-dynamical simulations. The relevance is solid for numerical galaxy simulations and star formation quenching, though the focus is on higher mass galaxies and scaling relations rather than dwarfs or satellites.
...
## 10. [Do galaxy mergers increase star formation and turbulence at cosmic noon?](https://arxiv.org/abs/2604.15002) <a id="link10"></a>
...
**Comment:** This paper investigates the impact of galaxy mergers on star formation and turbulence at cosmic noon. It discusses star formation and turbulence, but the focus is on higher-mass galaxies at z~1-2, not dwarfs. The relevance is moderate.
...
## 11. [Cosmology of Inelastic Self-Interacting Dark Matter: Linear Evolution and Observational Constraints](https://arxiv.org/abs/2604.15006) <a id="link11"></a>
...
**Comment:** This paper studies inelastic self-interacting dark matter and its impact on linear cosmological evolution and structure formation. While it discusses small-scale structure suppression and dark acoustic oscillations, it does not directly address near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is borderline due to implications for substructure.
...
## 12. [Stellar nucleosynthesis in the era of large surveys: s-process polluted binaries in GALAH DR4](https://arxiv.org/abs/2604.15197) <a id="link12"></a>
...
**Comment:** Systematic sample of s-process polluted binaries from GALAH DR4, with implications for nucleosynthesis and binary evolution. While it deals with stellar models and nucleosynthesis, the focus is on binary stars and s-process enrichment, not on galaxy-scale processes or near-field cosmology.
...
## 13. [Disk-like galaxies at 4 < z < 7.7 : JWST/NIRCam morphologies revealed by denoising VAE-GCNN classification](https://arxiv.org/abs/2604.14599) <a id="link13"></a>
...
**Comment:** This paper studies disk-like galaxies at high redshift using JWST/NIRCam morphologies. While it is about galaxy morphology and disk formation, it does not focus on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is borderline as disk formation is tangential to near-field cosmology.
...
## 14. [ALMA-IMF XXII. Role of core subfragmentation in the IMF origin: Hierarchical fragmentation cascade and CMF in W43-MM1](https://arxiv.org/abs/2604.14875) <a id="link14"></a>
...
**Comment:** This paper investigates hierarchical fragmentation and the core mass function in a massive protocluster, with implications for the initial mass function (IMF) origin. It discusses star formation and fragmentation, but the focus is on massive protoclusters and the IMF, not on resolved star formation histories of galaxies or dwarf galaxy quenching. It is borderline relevant due to its connection to star formation processes.
...
## 15. [Deeper analysis of Fermi-LAT unassociated 4FGL J2112.5-3043 for possible identification](https://arxiv.org/abs/2604.14794) <a id="link15"></a>
...
**Comment:** The paper analyzes a gamma-ray source for possible dark matter annihilation or pulsar origin. It discusses Galactic subhalos, which are related to near-field cosmology and substructure, but the focus is on gamma-ray emission and source identification, not on satellite galaxies, their properties, or resolved star formation histories. The connection to near-field cosmology is weak but present.
...
## 16. [Las Cumbres Observatory Gravitational-Wave Follow-up in O3 and O4: Strengths and Weaknesses of a Rapid Response Galaxy Targeted Strategy](https://arxiv.org/abs/2604.15129) <a id="link16"></a>
...
**Comment:** This paper discusses gravitational-wave follow-up strategies, including galaxy-targeted approaches. While it mentions galaxy targeting, the focus is on GW counterpart searches, not on galaxy properties, star formation histories, or near-field cosmology. The relevance is borderline due to the galaxy-targeted aspect.
...
## 17. [Discovery of low-redshift analogues to "Little Red Dots" in DESI: A later evolutionary stage of compact LRDs?](https://arxiv.org/abs/2604.14551) <a id="link17"></a>
...
**Comment:** The paper discusses low-redshift analogues to 'Little Red Dots', which are compact, rapidly accreting systems. While it touches on galaxy evolution, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations. The relevance is borderline.
...
## 18. [Enhanced activity in close dual-AGN systems in the local Universe](https://arxiv.org/abs/2604.14900) <a id="link18"></a>

**ArXiv ID:** 2604.14900

**Authors:** Lorenzo Battistini, Alessandra De Rosa, Paola Severgnini, Cristian Vignali, Jasbir Singh, Pedro R. Capelo, Elena Bertola, Stefano Bianchi, Quirino D'Amato, Matteo Guainazzi, Fabio La Franca, Isabella Lamperti, Filippo Mannucci, Manali Parvatikar, Enrico Piconcelli, Federica Ricci, Fabio Rigamonti, Martina Scialpi, Maria Vittoria Zanchettin

**Abstract:** We present the study of an X-ray selected sample of active galactic nuclei (AGN) in pairs at projected spatial separations 1 <$ r_p$/kpc < 100 at z  $10^{22}$ cm$^{-2}$), amongst which ~6% are Compton-thick ($N_H$ > $10^{24}$ cm$^{-2}$). The fraction of absorbed AGN is significantly higher in late-stage mergers ($r_p$  60 kpc). Amongst the AGN in pairs, we also observed an average excess of AGN pairs with respect to a control sample of inactive galaxies in pairs, and that such excess significantly increases with decreasing $r_p$ only for obscured AGN. Finally, in dual-AGN systems, both the bolometric luminosity and the Eddington ratio of the less massive black hole in the pair increase as the separation decreases. These findings suggest that mergers may have an important role in triggering AGN accretion and activity.

**Comment:** This paper studies dual-AGN systems and the effect of mergers on AGN activity. While it discusses galaxy mergers and star formation, the focus is on AGN and not on dwarf galaxies, resolved star formation histories, or galaxy simulations. The relevance is borderline.
...
## 19. [Photometric Metallicities for 367,324 stars of Omega Centauri](https://arxiv.org/abs/2604.15103) <a id="link19"></a>
...
**Comment:** This paper presents a large photometric metallicity catalog for Omega Centauri, a globular cluster. While it deals with stellar populations and metallicity gradients, Omega Cen is not a dwarf galaxy or satellite, and the focus is on cluster-scale stellar populations rather than galaxy-scale processes.
...
## 20. [Echoes of Global Cosmic Strings](https://arxiv.org/abs/2604.15241) <a id="link20"></a>
...
**Comment:** The paper discusses cosmic strings and their cosmological signatures, including constraints from the UV luminosity function. While the UV luminosity function is a relevant keyword, the context is not galaxy formation or near-field cosmology, but rather constraints on particle physics from cosmological probes. No direct connection to satellite galaxies, resolved star formation histories, or quenching.
...
## 21. [Tracking ionization balance in intergalactic medium and its implications towards metallicity](https://arxiv.org/abs/2604.14676) <a id="link21"></a>
...
**Comment:** This paper presents a framework for modeling ionization balance and metallicity in the intergalactic medium (IGM), focusing on quasar absorption spectra and cosmic metal densities. While it deals with gas and metals, it does not directly address dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The focus is on the IGM, not the CGM or galaxy-scale processes.
...
## 22. [Closing the Observational Gap in Cosmic Dynamics: AI-Enabled Reconstruction of the Universe's Vorticity and Rotational Flow Morphology](https://arxiv.org/abs/2604.14653) <a id="link22"></a>
...
**Comment:** The paper presents an AI-enabled reconstruction of cosmic vorticity and velocity fields, which is relevant to large-scale structure and cosmology. However, it does not focus on near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations. The work is more about cosmological methods and structure formation at large scales.
...
## 23. [Neutrino self-interactions in post-reionization era: Lyman-$\alpha$, 21-cm and cross-spectra](https://arxiv.org/abs/2604.15287) <a id="link23"></a>
...
**Comment:** This paper focuses on neutrino self-interactions and their signatures in the matter power spectrum, using Lyman-alpha and 21-cm probes. While it deals with cosmological structure and power spectra, it does not directly address near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on cosmological neutrino physics rather than galaxy-scale phenomena.
...
## 24. [Emergent structure in the binary black hole mass distribution and implications for population-based cosmology](https://arxiv.org/abs/2604.14290) <a id="link24"></a>
...
**Comment:** Reconstruction of binary black hole mass distribution and implications for population-based cosmology using gravitational wave data. The focus is on black hole populations and cosmological inference, not on galaxy-scale processes or near-field cosmology.
...
## 25. [The Atacama Cosmology Telescope: A Test of the Gravitational Force Law on Cosmological Scales Using the Kinematic Sunyaev-Zeldovich Effect](https://arxiv.org/abs/2604.14327) <a id="link25"></a>
...
**Comment:** Test of gravitational force law on cosmological scales using kSZ effect and galaxy catalogs. While it uses galaxy catalogs, the focus is on cosmological gravity and not on galaxy-scale processes or near-field cosmology.
...
## 26. [Forecasting neutrino mass constraints from the Nancy Grace Roman Space Telescope](https://arxiv.org/abs/2604.14504) <a id="link26"></a>
...
**Comment:** Forecasts for neutrino mass constraints using galaxy power spectrum from Roman Space Telescope. While it uses galaxy surveys, the focus is on cosmological parameters and neutrino mass, not on galaxy-scale processes or near-field cosmology.
...
## 27. [Structure and Large-Scale Kinematics of Young Stellar Populations in the NGC 6357 and NGC 6334 Giant Molecular Cloud Complex](https://arxiv.org/abs/2604.15050) <a id="link27"></a>
...
**Comment:** This paper studies the structure and kinematics of young stellar populations in giant molecular clouds, focusing on NGC 6357 and NGC 6334. While it involves star formation and stellar populations, it does not address resolved star formation histories, dwarf galaxies, quenching, or near-field cosmology. The focus is on massive star-forming regions in the Galactic plane, not on satellite galaxies or relevant cosmological topics.
...
## 28. [Microscopic primordial black holes as macroscopic dark matter from large extra dimensions](https://arxiv.org/abs/2604.14871) <a id="link28"></a>
...
**Comment:** This paper studies primordial black holes as dark matter in the context of large extra dimensions. While it discusses dark matter, it does not focus on near-field cosmology, satellite galaxies, or galaxy simulations, and is not directly relevant to the specified criteria.
...
## 29. [An FUor-like Outbursting Class I Protostar in NGC 7538](https://arxiv.org/abs/2604.15089) <a id="link29"></a>
...
**Comment:** This paper focuses on an FUor-like outburst in a Class I protostar, which is related to episodic accretion and early star formation. However, it does not address resolved star formation histories from color-magnitude diagrams, star formation quenching, or galaxy-scale outflows. The focus is on protostellar variability, not on dwarf galaxies or near-field cosmology.
...
## 30. [A fast X-ray transient with chromatic flares: signatures of violent collisions induced by late-time central engine reactivation](https://arxiv.org/abs/2604.14341) <a id="link30"></a>
...
**Comment:** Discovery and analysis of a fast X-ray transient, with implications for central engine reactivation and jet physics. The focus is on transient phenomena and AGN/GRB-like physics, not on galaxy-scale processes or near-field cosmology.
...
## 31. [Boson star-black hole binaries: initial data and head-on collisions](https://arxiv.org/abs/2604.15240) <a id="link31"></a>
...
**Comment:** The paper presents numerical-relativity simulations of boson star-black hole collisions, focusing on gravitational wave emission. It does not address galaxy simulations, star formation, or near-field cosmology.
...
## 32. [FAIR Universe Weak Lensing ML Uncertainty Challenge: Handling Uncertainties and Distribution Shifts for Precision Cosmology](https://arxiv.org/abs/2604.14451) <a id="link32"></a>
...
**Comment:** This paper focuses on weak lensing and machine learning for cosmological parameter estimation. While it involves cosmological simulations, it does not focus on galaxy simulations or any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy-scale outflows. The relevance is low.
...
## 33. [Astrophysical bounds on the high-energy evolution of neutrino mixing](https://arxiv.org/abs/2604.14409) <a id="link33"></a>
...
**Comment:** The paper discusses high-energy neutrino mixing and its evolution, using astrophysical neutrino flavor composition. The focus is on neutrino physics and not on galaxy-scale processes or near-field cosmology.
...
## 34. [Ultrahigh-energy cosmogenic neutrino emissions in the high-redshift universe](https://arxiv.org/abs/2604.14535) <a id="link34"></a>
...
**Comment:** This paper models cosmogenic neutrino production from high-redshift AGN, relating to cosmic ray emissions in the early universe. The focus is on neutrino astrophysics and AGN, not on galaxy-scale processes or near-field cosmology.
...
## 35. [Consistent Treatment of Muons in Binary Neutron Star Mergers](https://arxiv.org/abs/2604.14225) <a id="link35"></a>
...
**Comment:** This paper presents numerical simulations of binary neutron star mergers, focusing on muons and their impact on ejecta and nucleosynthesis. It is not related to galaxy simulations, star formation histories, or near-field cosmology. The focus is on compact object mergers and their microphysics.
...
## 36. [Could the high-mass black holes from gravitational-wave observations be explained by lensing?](https://arxiv.org/abs/2604.14247) <a id="link36"></a>
...
**Comment:** This paper discusses gravitational-wave observations and the mass distribution of black holes, with a focus on lensing effects. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 37. [The splash beneath the largest radio bubble in a cluster core](https://arxiv.org/abs/2604.14292) <a id="link37"></a>
...
**Comment:** The paper studies turbulence and gas motions in the wake of a radio bubble in a galaxy cluster core. It is focused on cluster-scale phenomena and not on dwarf galaxies, star formation histories, or galaxy simulations. The relevance is low.
...
## 38. [An Improved Fit for Linear Halo Bias at High Redshift](https://arxiv.org/abs/2604.14312) <a id="link38"></a>
...
**Comment:** This paper provides an improved fit for linear halo bias at high redshift, focusing on cosmological clustering and halo bias. It does not address galaxy-scale phenomena or any of the core topics.
...
## 39. [GRB 210704A: A Luminous Fast Blue Transient in a GRB Afterglow at $z = 2.34$](https://arxiv.org/abs/2604.14343) <a id="link39"></a>
...
**Comment:** This paper analyzes a gamma-ray burst afterglow and its connection to fast blue optical transients, but does not address any of the core topics (no focus on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 40. [The azimuthal structure of magnetically arrested disks during flux eruption events](https://arxiv.org/abs/2604.14313) <a id="link40"></a>
...
**Comment:** This paper analyzes the azimuthal structure of magnetically arrested disks around black holes using GRMHD simulations. The focus is on accretion disks and black hole environments, not galaxies, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 41. [Upper bound of ejecta mass in a nova outburst](https://arxiv.org/abs/2604.14608) <a id="link41"></a>
...
**Comment:** This paper discusses nova outbursts and the ejecta mass from white dwarfs, with implications for Type Ia supernovae progenitors. It is focused on stellar explosions and white dwarf physics, not on dwarf galaxies, star formation histories, quenching, stellar models (tracks/atmospheres), galaxy simulations, outflows, or CGM.
...
## 42. [NOMAI : A real-time photometric classifier for superluminous supernovae identification. A science module for the Fink broker](https://arxiv.org/abs/2604.14761) <a id="link42"></a>
...
**Comment:** This paper describes a machine learning classifier for identifying superluminous supernovae (SLSNe) in real-time photometric data. While SLSNe are related to stellar explosions, the focus is on classification methodology and transient identification, not on galaxy evolution, star formation histories, quenching, or near-field cosmology. No direct relevance to the core topics.
...
## 43. [Quantum correction to the diffusion term in stochastic inflation from composite-operator matching in Soft de Sitter Effective Theory](https://arxiv.org/abs/2604.14283) <a id="link43"></a>
...
**Comment:** Quantum corrections to stochastic inflation diffusion term using Soft de Sitter Effective Theory. The focus is on inflationary cosmology and quantum field theory, not on galaxy-scale processes or near-field cosmology.
...
## 44. [A Fast and Physically Grounded Ocean Model for GCMs: The Dynamical Slab Ocean Model of the Generic-PCM (rev. 3423)](https://arxiv.org/abs/2604.14342) <a id="link44"></a>
...
**Comment:** This paper presents a new ocean model for exoplanet climate studies. It is not related to galaxy simulations, star formation, or near-field cosmology. The focus is on planetary climate modeling.
...
## 45. [Fast neural network surrogate for multimodal effective-one-body gravitational waveforms from generically precessing compact binaries](https://arxiv.org/abs/2604.14270) <a id="link45"></a>
...
**Comment:** This paper presents a neural network surrogate for gravitational waveforms from compact binary mergers. It is not related to galaxy simulations, star formation, or near-field cosmology.
...
## 46. [Inflaton Regeneration via Scalar Couplings: Generic Models and the Higgs Portal](https://arxiv.org/abs/2604.14620) <a id="link46"></a>
...
**Comment:** This paper is about inflaton regeneration and post-inflationary reheating, which is purely cosmological and not related to galaxy-scale phenomena or any of the core topics.
...
## 47. [Impact of Baseline, Cadence, and Host Contamination on AGN Variability Metrics: A Systematic Study with ZTF](https://arxiv.org/abs/2604.14588) <a id="link47"></a>
...
**Comment:** Systematic study of AGN variability metrics using ZTF. The focus is on AGN variability and accretion physics, not on galaxy-scale processes or near-field cosmology.
...
## 48. [Sky background accounting in spectral infrared observations of extended objects at the Caucasus Mountain Observatory of the SAI MSU](https://arxiv.org/abs/2604.14863) <a id="link48"></a>
...
**Comment:** This paper presents a technique for sky background subtraction in infrared spectra of extended objects, tested on a star-forming region in the Milky Way. The focus is on observational methodology, not on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 49. [Nonlinear backstepping with saturation for low-thrust station-keeping of libration point orbits](https://arxiv.org/abs/2604.15028) <a id="link49"></a>
...
**Comment:** The paper presents a control law for station-keeping in the Earth-Moon system, relevant to spacecraft dynamics. It is unrelated to galaxy simulations, star formation, or near-field cosmology.
...
## 50. [Systematic assessment of disk truncation in the black hole X-ray binary Swift J1727.8-1613 using NICER](https://arxiv.org/abs/2604.14693) <a id="link50"></a>
...
**Comment:** The paper assesses disk truncation in a black hole X-ray binary using NICER. It focuses on accretion physics in compact objects, not on galaxy simulations, star formation, or near-field cosmology.
...
## 51. [Influence of winds on shocked magnetized viscous accretion flows around rotating black holes](https://arxiv.org/abs/2604.14708) <a id="link51"></a>
...
**Comment:** This paper studies winds in magnetized viscous accretion flows around rotating black holes, focusing on accretion disk physics. It does not address galaxy-scale phenomena or any of the core topics.
...
## 52. [Gravitational-wave lensing beyond rays: a disordered-system approach](https://arxiv.org/abs/2604.15313) <a id="link52"></a>
...
**Comment:** This paper develops a framework for gravitational-wave lensing in disordered systems, focusing on wave propagation and interference effects. It is not related to any of the core topics (no focus on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 53. [Nonperturbative stochastic inflation in perturbative dynamical background](https://arxiv.org/abs/2604.15219) <a id="link53"></a>
...
**Comment:** This paper presents a new framework for nonperturbative stochastic inflation in cosmology, focusing on quantum field theory in curved spacetime and inflationary dynamics. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 54. [Exploring non-equilibrium effects in sequential freeze-in](https://arxiv.org/abs/2604.14688) <a id="link54"></a>
...
**Comment:** This paper explores non-equilibrium effects in freeze-in dark matter models, focusing on the evolution and relic abundance of dark matter in a two-scalar model. While it is a cosmology paper, it does not address near-field cosmology, galaxy evolution, or any of the core topics such as satellite galaxies, star formation histories, or quenching. The focus is on particle physics and dark sector dynamics.
...
## 55. [Static Tidal Perturbations of Relativistic Stars: Corrected Center Expansion and Love Numbers-I](https://arxiv.org/abs/2604.15195) <a id="link55"></a>
...
**Comment:** The paper revisits tidal perturbations of relativistic stars and Love numbers, focusing on technical corrections. It is not related to galaxy simulations, star formation, or near-field cosmology.
...
## 56. [Constraining Quintessential Inflation with ACT: A Gauss-Bonnet Gateway](https://arxiv.org/abs/2604.14659) <a id="link56"></a>
...
**Comment:** This paper revisits quintessential inflation in light of ACT results, focusing on cosmological inflationary models and their compatibility with observations. It does not address any of the core topics (no focus on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 57. [A Generalized Algorithmic Framework for Detecting Faraday Rotation Measure Flares in Repeating Fast Radio Bursts](https://arxiv.org/abs/2604.15012) <a id="link57"></a>
...
**Comment:** This paper presents an algorithmic framework for detecting Faraday rotation measure flares in repeating fast radio bursts. It is focused on FRB environments and plasma diagnostics, which are not relevant to the specified criteria.
...
## 58. [Localization and Confidence Region Estimation of Short GRBs with the COSI BGO Shield Using a HEALPix-Based Deep Learning Approach](https://arxiv.org/abs/2604.15119) <a id="link58"></a>
...
**Comment:** This paper discusses localization and confidence region estimation of short GRBs using deep learning. It is focused on GRB detection and localization, which does not match any of the core topics.
...
## 59. [Combining spectroscopy and wavefront control at deep contrast with photonic lanterns](https://arxiv.org/abs/2604.14276) <a id="link59"></a>
...
**Comment:** This paper discusses combining spectroscopy and wavefront control for exoplanet imaging and characterization. It is focused on instrumentation for exoplanet studies, not on any of the core topics such as galaxy simulations or star formation histories.
...
## 60. [Numerical investigation of particle acceleration at interplanetary shocks: diffusive and superdiffusive scenarios](https://arxiv.org/abs/2604.14819) <a id="link60"></a>
...
**Comment:** This paper investigates particle acceleration at interplanetary shocks, focusing on energetic particle transport and acceleration mechanisms. It is not relevant to any of the core topics.
...
## 61. [Rapid-response 1.3 mm Observations of GRB 260127A with the Submillimeter Array](https://arxiv.org/abs/2604.14297) <a id="link61"></a>
...
**Comment:** This paper presents rapid-response millimeter observations of a gamma-ray burst (GRB), discussing afterglow scenarios and light curve evolution. The focus is on GRB afterglows and not on galaxy evolution, near-field cosmology, or any of the core topics. No relevant criteria matched.
...
## 62. [A simple relation: Neutron star magnetic field strength and spectral shape at low mass accretion rates](https://arxiv.org/abs/2604.14968) <a id="link62"></a>
...
**Comment:** This paper focuses on neutron star magnetic fields and spectral shapes in high-mass X-ray binaries, which is unrelated to any of the core topics (no connection to near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 63. [Radiation doses during extreme solar energetic particle events](https://arxiv.org/abs/2604.15160) <a id="link63"></a>
...
**Comment:** This paper discusses radiation doses during extreme solar energetic particle events, focusing on space weather and its impact on aviation and astronauts. It is unrelated to any of the core topics (no focus on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 64. [Synchrotron-cooled plasma distribution in the outer magnetosphere of a neutron star](https://arxiv.org/abs/2604.14402) <a id="link64"></a>
...
**Comment:** This paper analyzes synchrotron-cooled plasma distributions in neutron star magnetospheres. It is focused on particle physics and magnetospheric processes, which are not relevant to any of the specified criteria.
...
## 65. [Continuing to Advance European High Contrast Imaging Research and Development towards HWO and LIFE](https://arxiv.org/abs/2604.15077) <a id="link65"></a>
...
**Comment:** This paper discusses high contrast imaging technology development for exoplanet missions. It is not related to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
