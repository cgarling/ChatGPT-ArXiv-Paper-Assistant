...
1. [LensAgent: A Self Evolving Agent for Autonomous Physical Inference of Sub-galactic Structure](#user-content-link1)
**Authors:** Xiaotang Feng, Zihan Wang, Zilang Shu, Jean-Paul Kneib, Philip Torr

2. [Dynamical clock of the Helmi stream -- Analysis of the clumping of stars in the orbital frequency-space](#user-content-link2)
**Authors:** Kohei Hattori

3. [Intracluster Light as a Probe for Dark Matter: Exploring SIDM and CDM with C-EAGLE Sims](#user-content-link3)
**Authors:** Jaewon Yoo, Ellen L. Sirks, Cristiano G. Sabiu, Changbom Park, Jaehyun Lee, Ankit Singh, Juhan Kim, Jongwan Ko

4. [Comparative Bayesian SED Fitting of PEARLSDG](#user-content-link4)
**Authors:** Bar{\i}\c{s} Bayraktar, Timothy Carleton, Rogier A. Windhorst, S. P. Willner, Christopher N. A. Willmer

5. [A critical analysis of main-sequence fitting in open clusters to derive the helium-to-metal enrichment ratio $\Delta Y/\Delta Z$](#user-content-link5)
**Authors:** G. Valle, N. Ricci, M. Dell'Omodarme, P. G. Prada Moroni, S. Degl'Innocenti, S. Cassisi

6. [The PLATO Science Calibration and Validation Plan: Targets for the First Long-pointing Field](#user-content-link6)
**Authors:** Konstanze Zwintz, Conny Aerts, Andrew Tkachenko, Juan Cabrera, Orlagh Creevey, Rene Heller, Nicholas Jannsen, Chen Jiang, Oleg Kochukhov, Antonino Francesco Lanza, Pierre F. L. Maxted, Sergio Messina, Andrea Miglio, Thierry Morel, Benoi{\i}t Mosser, Rhita Ouazzani, John Southworth, Matthias Ammler van-Eiff, Jeroen Audenaert, Paul G. Beck, Kevin Belkacem, Aaron Birch, Diego Bossini, Angela Bragaglia, Lorenzo Briganti, David Brown, Anko B\"orner, Cristina Chiappini, Cilia Damiani, Patrick Gaulme, Pablo Heise Huijse, Ulrike Heiter, Krysztof G. Helminiak, Mykyta Kliapets, Mikkel N. Lund, Paola Marrese, Thibault Merle, Nicola Miller, Josefina Montalban, Dinil Bose Palakkatharappil, Carsten Paproth, Isabel Rebollido Vazquez, Nena Scheller, Sophia Sulis, Amaury H. M. J. Triaud, Marica Valentini, Mathieu Vrard, Magali Deleuil, Laurent Gizon, Ana M. Heras, J. Miguel Mas-Hesse, Hugh Osborn, Isabella Pagano, Giampaolo Piotto, Don Pollacco, Roberto Raggazoni, Gavin Ramsay, Heike Rauer, Stephane Udry

7. [Galaxy Populations in Groups and Clusters: II. Conditional Luminosity Functions at Redshifts from z ~ 1 to z ~ 0](#user-content-link7)
**Authors:** Ce Gao, Cheng Li, Houjun Mo, Jiacheng Meng, Qinglin Ma, Xiaohu Yang, Yizhou Gu, Qingyang Li

8. [The morphologies of present-day galaxies in the COLIBRE simulations](#user-content-link8)
**Authors:** Victor J. Forouhar Moreno, Joop Schaye, Matthieu Schaller, Aaron Ludlow, Robert J. McGibbon, Alejandro Ben\'itez-Llambay, Evgenii Chaikin, Carlos S. Frenk, Filip Hu\v{s}ko, Sylvia Ploeckinger, Alexander J. Richings, James W. Trayford

9. [Investigating Extended Main-Sequence Turnoffs in Galactic Open Clusters](#user-content-link9)
**Authors:** Khushboo K Rao (Institute of Astronomy, National Central University, 320317 Taoyuan, Taiwan), Wen-Ping Chen (Institute of Astronomy, National Central University, 320317 Taoyuan, Taiwan, Department of Physics, National Central University, 320317 Taoyuan, Taiwan)

10. [Nexae in caverna: the secular evolution of disks via collectively excited, transient spiral structure](#user-content-link10)
**Authors:** Sharon E. Meidt, Arjen van der Wel

11. [SPURS: Evidence for Clumpy Neutral Envelopes and Ionized IGM Surrounding Little Red Dots in Abell 2744 from Ultra-Deep Rest-UV Spectroscopy](#user-content-link11)
...
12. [Silicon, sulfur and iron in the interstellar medium: a high-resolution X-ray spectral study of GX 340+0](#user-content-link12)
...
13. [Measurement of the galaxy-velocity power spectrum of DESI tracers with the kinematic Sunyaev-Zeldovich effect using DESI DR2 and ACT DR6](#user-content-link13)
**Authors:** Edmond Chaussidon, Selim C. Hotinli, Simone Ferraro, Kendrick Smith, Xinyi Chen, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, B. Dey, P. Doel, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, J. Guy, H. K. Herrera-Alcantar, K. Honscheid, C. Howlett, D. Huterer, M. Ishak, R. Joyce, D. Kirkby, A. Kremin, O. Lahav, M. Landriau, L. Le Guillou, M. Manera, A. Meisner, R. Miquel, S. Nadathur, J. A. Newman, N. Palanque-Delabrouille, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, L. Samushia, E. Sanchez, D. Schlegel, M. Schubnell, H. Seo, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver, C. Y\`eche, R. Zhou

14. [Gaussian-Process Emulation of the Redshift-Space Halo Power Spectrum Monopole in Cosmologies with Massive Neutrinos](#user-content-link14)
**Authors:** Jixin Gan, Yonghao Feng, Gong-Bo Zhao

15. [Inference of recoil kicks from binary black hole mergers up to GWTC--4 and their astrophysical implications](#user-content-link15)
**Authors:** Tousif Islam

16. [Random gas motions inside sub-parsec scale supercritical filaments](#user-content-link16)
...
17. [MIDIS: Strong H$\beta$+[OIII] Line Emitters at $z \geq 9$](#user-content-link17)
**Authors:** Thomas R. Greve, Steven Gillman, Pierluigi Rinaldi, Iris Jermann, Jens Melinder, G\"oran \"Ostlin, Pablo G. P\'erez-Gonz\'alez, Luis Colina, Fabian Walter, Javier \'Alvarez-M\'arquez, Martin J. Ward, Alejandro Crespo G\'omez, John P. Pye, Tuomo V. Tikkanen, Edoardo Iani, Roman A. Meyer, Leindert A. Boogaard, Jens Hjorth, Danial Langeroodi, Paul van der Werf, Sarah E. I. Bosman, Karina I. Caputi, Luca Costantin, Marianna Annunziatella, Arjan Bik, \'Alvaro Labiano, Thomas Henning

18. [Diffusion of PeV Cosmic Rays in the Turbulent and Multiphase Interstellar Medium](#user-content-link18)
**Authors:** Yue Hu

19. [A Foundation for Gravitational-Wave Population Inference within the LISA Global Fit](#user-content-link19)
**Authors:** Alexander W. Criswell, Sharan Banagiri, Vera Delfavero, Maria Jose Bustamante-Rosell, Stephen R. Taylor, Robert Rosati

20. [Stellar Parameters and Orbital Period Estimates for Composite-Spectrum sdB+MS Binaries from LAMOST](#user-content-link20)
**Authors:** Jiangdan Li, Jianping Xiong, Jiao Li, Hai-Liang Chen, Hongwei Ge, Mingkuan Yang, Xuefei Chen, Zhanwen Han

21. [The Distribution of Cosmic Ray Electrons in Star-Forming Galaxies](#user-content-link21)
**Authors:** Anvar Shukurov, Charles Jose

22. [Holes in the BH$^\star$? AGN signatures in the FUV spectrum of a black-hole dominated Little Red Dot at $z=7.04$](#user-content-link22)
**Authors:** Xihan Ji, Gabriele Pezzulli, Francesco D'Eugenio, Roberto Maiolino, Stefano Carniani, Sandro Tacchella, Gareth Jones, Aaron Smith, Joris Witstok, Andrew C. Fabian, Sophia Geris, Anishya Harshan, Yuki Isobe, Lucy R. Ivey, Ignas Juod\v{z}balis, Robert Pascalau, Jan Scholtz, Callum Witten

23. [GOPREAUX I: Open-source Code and Data to Model Multi-wavelength Emission of Extragalactic Transients using Gaussian Processes](#user-content-link23)
**Authors:** C. Pellegrino, T. A. Pritchard, M. Modjaz, A. Crawford, S. Khakpash, F. Bianco

24. [A comparison of three neodymium atomic data sets for kilonova modeling](#user-content-link24)
**Authors:** Christopher J. Fontes, Nicholas Vieira, Chris L. Fryer, Adithan Kathirgamaraju, Oleg Korobkin, Marko Risti\'c, Ryan T. Wollaeger

25. [The Identification of Asymmetric Barred Galaxies in Illustris TNG-50](#user-content-link25)
**Authors:** Junwoo Jung, Minjin Kim, Taehyun Kim

26. [From NVSS to RACS: Identifying truly Compact and Steep spectrum Radio sources](#user-content-link26)
**Authors:** Rajat Shinde, Yogesh Maan, Apurba Bera

27. [Independent Recovery of Vanishing Sources on POSS-I Photographic Plates Using Automated Source Detection and Cross-Epoch Matching](#user-content-link27)
**Authors:** Zachary Hayes

28. [Enhancing astrometric registration of Chinese historical Astronomical Digital Plates with deep learning](#user-content-link28)
**Authors:** Quanfeng Xu, Zhengjun Shang, Shiyin Shen, Yong Yu, Meiting Yang, Hao Luo, Zhenghong Tang, Jing Yang, Jianhai Zhao

29. [Multimessenger Signatures of Tilted, Self-Gravitating, Black Hole Disks](#user-content-link29)
**Authors:** Milton Ruiz, Antonios Tsokaros, Stuart L. Shapiro

30. [The VLBI spectrum of the persistent radio source associated with FRB 20190417A](#user-content-link30)
**Authors:** G. Bruni, L. Piro, Y. -P. Yang, L. Nicastro, A. Rossi, E. Palazzi, E. Maiorano, S. Savaglio, B. Zhang

31. [Deep Adaptive Optics Imaging Rules Out a Helium Star Companion to PSR J1928+1815](#user-content-link31)
**Authors:** Pranav Nagarajan, Kareem El-Badry, Jim Fuller, Yunlang Guo, Thomas M. Tauris

32. [Dispersion Measure Distribution of Unlocalized Fast Radio Bursts as a Probe of the Hubble Constant](#user-content-link32)
**Authors:** Yang Liu, Jun-Jie Wei, Puxun Wu, Xue-Feng Wu

33. [Fast Radio Burst Dispersion Measure--Timing Cross-Correlations: Bias Self-Calibration and Primordial Non-Gaussianity Constraints](#user-content-link33)
**Authors:** Simthembile Dlamini

34. [Probing Unification Scenarios with Big Bang Nucleosynthesis](#user-content-link34)
**Authors:** I. M. Dreyer, C. J. A. P. Martins

35. [Replacing Gaussian Processes with Neural Networks in Pulsar Timing Array Inference of the Gravitational-Wave Background](#user-content-link35)
**Authors:** Shreyas Tiruvaskar, Chris Gordon

36. [Information-Geometric Perspective on the Hubble Tension: Eigenmode Rotation and Curvature Suppression in wCDM](#user-content-link36)
**Authors:** Seokcheon Lee

37. [Wings of little dots: Exponential broad lines from a stratified BLR](#user-content-link37)
**Authors:** Piero Madau, Roberto Maiolino, Jan Scholtz, Francesco D'Eugenio

38. [Fast Magnetosonic Turbulence in Two-Dimensional Relativistic Plasmas](#user-content-link38)
**Authors:** Petr Ugarov, Vladimir Zhdankin, Giuseppe Arr\`o

39. [Lattice simulations of scalar-induced gravitational waves from inflation](#user-content-link39)
**Authors:** Angelo Caravano, Gabriele Franciolini, S\'ebastien Renaux-Petel

40. [Is the $w_0w_a$CDM cosmological parameterization evidence for dark energy dynamics partially caused by the excess smoothing of Planck PR4 CMB anisotropy data?](#user-content-link40)
**Authors:** Chan-Gyung Park, Javier de Cruz Perez, Bharat Ratra

41. [Photon Propagation through Magnetar-Hosted Axion Clouds: Time Delays and Polarimetric Constraint](#user-content-link41)
**Authors:** M. M. Chaichian, B. A. Couto e Silva, B. L. S\'anchez-Vega

42. [Detection of High-Velocity Na$\;$I Absorption Toward the Stellar Remnant of SN 1181 AD](#user-content-link42)
**Authors:** Peter Garnavich (Notre Dame), Robert A. Fesen (Dartmouth College)

43. [The Delay Time Distribution of Tidal Disruption Events](#user-content-link43)
...
44. [Multi-field oscillons/I-balls in the Friedberg-Lee-Sirlin model](#user-content-link44)
**Authors:** Kai Murai, Tatsuya Ogawa, Fuminobu Takahashi

45. [Characterizing Gamma-Radio Delayed Flaring Activity from Blazars](#user-content-link45)
**Authors:** Alina Kochocki, Emma Kun, Sam Hori

46. [Preliminary study on the impact of stress-energy tensor compared to scalar field in Nonminimal Derivative model](#user-content-link46)
**Authors:** Ilham Prasetyo, Bobby Eka Gunara, Agus Suroso

47. [Discovery of a Low-Mass Companion to the Accelerating Star HIP 53005 with Strongly Conflicting Mass Estimates](#user-content-link47)
...
48. [On the transformation of the Maxwell-Boltzmann Distribution to a Power-Law](#user-content-link48)
**Authors:** Ari Laor, Igor Gitelman

49. [Directional Tests of the Cosmic Distance Duality Relation using Pantheon+ and BAO](#user-content-link49)
**Authors:** Pushty Shrimankar, Gopal Kashyap

50. [Reconstruction of the Quintessence Scalar Field Potential Using Gaussian Processes](#user-content-link50)
**Authors:** Redouane El Ouardi, Amine Bouali, Ahmed Errahmani, Ryan E. Keeley, Arman Shafieloo, Taoufik Ouali

51. [Big Bang Nucleosynthesis Constraints on the CCC+TL Cosmology](#user-content-link51)
**Authors:** Rajendra P. Gupta, Nikolaos Samaras

52. [Probing cosmic anisotropy with galaxy clusters and supernovae](#user-content-link52)
**Authors:** Shubham Barua, Sujit K. Dalui, Shantanu Desai

53. [A Conformal Boundary Ansatz for Warm Inflation Initialization: A Toy Model](#user-content-link53)
**Authors:** Somnath Das, Rizwan ul Haq Ansari

54. [Friedmann cosmology with fluids and hyperfluids](#user-content-link54)
**Authors:** Ilaria Andrei, Damianos Iosifidis, Laur J\"arv, Margus Saal

55. [What spectators do during inflation](#user-content-link55)
**Authors:** Daniel Boyanovsky

56. [Beyond $f(\phi)\mathcal{G}$: Gauss--Bonnet inflation with $\mu(\phi,X)$](#user-content-link56)
**Authors:** Ali Seidabadi, Sara Saghafi, Kourosh Nozari

57. [Influence of CO versus CH$_4$ on organic haze formation in atmospheres of diverse terrestrial exoplanets](#user-content-link57)
...
58. [The PLATO field selection process III. Selection of the Prime Sample for the LOPS2 field](#user-content-link58)
...
67. [Constraining the PeV gamma-ray emission zone of Cygnus X-3 with contemporaneous GeV timing and spectral observations](#user-content-link67)
**Authors:** Xing-Fu Zhang, Ruo-Yu Liu, Dmitriy Khangulyan, Cui-Yuan Dai, Xiang-Yu Wang

68. [Prediction of Magnetic Flux Evolution During Solar Active Region Emergence using Long Short-Term Memory Networks](#user-content-link68)
...
71. [A Few Years Later: Revisiting Period Variations of Eclipsing Binaries in the Northern Continuous Viewing Zone of TESS](#user-content-link71)
**Authors:** T. Borkovits, T. Mitnyan, D. R. Czavalinga, S. A. Rappaport

72. [Effects of Various Bipolar Approximations of Active Regions on Solar Surface Magnetic Field Simulations](#user-content-link72)
**Authors:** Yukun Luo, Jie Jiang, Ruihui Wang

73. [The hitchhiker's guide to the IXPE data analysis](#user-content-link73)
**Authors:** Alessandro Di Marco

74. [Flare Impulsive-phase Durations](#user-content-link74)
**Authors:** Brian R. Dennis, Hugh Hudson, Joel Allred

75. [FRB Searches with the Irish LOFAR Station](#user-content-link75)
**Authors:** D. J. McKenna, E. F. Keane

76. [Preferential Appearance of H$\alpha$ Moreton Waves along Photospheric Magnetic Network Boundaries](#user-content-link76)
**Authors:** C. H. Zhai, Y. W. Ni, J. H. Guo, P. F. Chen

---

## 1. [LensAgent: A Self Evolving Agent for Autonomous Physical Inference of Sub-galactic Structure](https://arxiv.org/abs/2604.03691) <a id="link1"></a>

**ArXiv ID:** 2604.03691

**Authors:** Xiaotang Feng, Zihan Wang, Zilang Shu, Jean-Paul Kneib, Philip Torr

**Abstract:** Probing dark matter distribution on sub-galactic scales is essential for testing the Cold Dark Matter ($\Lambda$CDM) paradigm. Strong gravitational lensing, as one of the most powerful approach by far, provides a direct, purely gravitational probe of these substructures. However, extracting cosmological constraints is severely bottlenecked by the mass-sheet degeneracy (MSD) and the unscalable nature of manual and neural-network modeling. Here, we introduce LensAgent, a pioneering training-free, large language model (LLM)-driven agentic framework for the autonomous physical inference of mass distributions. Operating as an autonomous scientific agent, LensAgent couples high-level logical reasoning with deterministic physical modeling tools, demonstarting successful reconstruction of mass distribution in SLACS Grade A strong lensing systems. This self-evolving architecture enables the robust extraction of sub-galactic substructures at scale, unlocking the cosmological potential of upcoming wide-field surveys such as the Rubin Observatory (LSST) and Euclid.

**Comment:** LensAgent is a new agentic framework for inferring sub-galactic structure via strong lensing, directly probing dark matter substructure. This is highly relevant to near-field cosmology, especially the core-cusp and substructure criteria.
...
## 2. [Dynamical clock of the Helmi stream -- Analysis of the clumping of stars in the orbital frequency-space](https://arxiv.org/abs/2604.03786) <a id="link2"></a>
...
**Comment:** This paper presents a new framework for deriving the dynamical age of the Helmi stream, a disrupted satellite of the Milky Way, and reconstructs its accretion history. It directly addresses near-field cosmology, specifically the accreted stellar halo and satellite galaxy interactions, and introduces a novel chronometric tool.
...
## 3. [Intracluster Light as a Probe for Dark Matter: Exploring SIDM and CDM with C-EAGLE Sims](https://arxiv.org/abs/2604.03907) <a id="link3"></a>
...
**Comment:** This paper analyzes the properties of dwarf and satellite galaxies in galaxy clusters using numerical simulations (C-EAGLE) to probe dark matter physics (SIDM vs CDM). The focus on satellite galaxies and their sensitivity to dark matter models is highly relevant to near-field cosmology and numerical galaxy simulations. The use of new simulation runs and the proposal of ICL as a novel observational probe adds substantial novelty.
...
## 4. [Comparative Bayesian SED Fitting of PEARLSDG](https://arxiv.org/abs/2604.03761) <a id="link4"></a>
...
**Comment:** The paper revises the distance and environment of PEARLSDG, a quiescent dwarf galaxy, and analyzes its star formation history and quenching. This is directly relevant to near-field cosmology, resolved star formation histories, and star formation quenching in dwarf galaxies.
...
## 6. [The PLATO Science Calibration and Validation Plan: Targets for the First Long-pointing Field](https://arxiv.org/abs/2604.04042) <a id="link6"></a>
...
**Comment:** This paper discusses calibration and validation for the PLATO mission, focusing on stellar age determination and improvement of stellar interior models. The discussion of improved stellar models and bolometric corrections is directly relevant to the 'Stellar Models' criterion.
...
## 8. [The morphologies of present-day galaxies in the COLIBRE simulations](https://arxiv.org/abs/2604.03503) <a id="link8"></a>
...
**Comment:** The paper analyzes galaxy morphologies in the COLIBRE simulations, a cosmological simulation suite. It discusses galaxy properties, including satellites, star formation rates, and morphology correlations, which is relevant to numerical galaxy simulations and, to a lesser extent, near-field cosmology.
...
## 9. [Investigating Extended Main-Sequence Turnoffs in Galactic Open Clusters](https://arxiv.org/abs/2604.03746) <a id="link9"></a>
...
**Comment:** This paper surveys extended main-sequence turnoff phenomena in Galactic open clusters, investigating stellar rotation and cluster properties. The focus is on stellar evolution and cluster properties, with some relevance to stellar models, but not directly on galaxy evolution or near-field cosmology.
...
## 10. [Nexae in caverna: the secular evolution of disks via collectively excited, transient spiral structure](https://arxiv.org/abs/2604.04827) <a id="link10"></a>
...
**Comment:** This paper presents a theoretical framework for the secular evolution of galactic disks via spiral structure. It focuses on disk galaxies and spiral dynamics, not on dwarf galaxies, satellite systems, or resolved star formation histories. The work is relevant to numerical galaxy simulations but does not introduce new simulation results or physics models.
...
## 11. [SPURS: Evidence for Clumpy Neutral Envelopes and Ionized IGM Surrounding Little Red Dots in Abell 2744 from Ultra-Deep Rest-UV Spectroscopy](https://arxiv.org/abs/2604.03563) <a id="link11"></a>
...
**Comment:** Ultra-deep rest-UV spectroscopy of Little Red Dots in Abell 2744, focusing on Lyα emission, neutral gas, and ionized IGM. The paper studies high-redshift galaxies and their environments, but does not focus on near-field cosmology, resolved star formation histories, or dwarf galaxy quenching. The connection to CGM is weak and not specifically about dwarf galaxies. Borderline relevance due to ISM/IGM focus.
...
## 12. [Silicon, sulfur and iron in the interstellar medium: a high-resolution X-ray spectral study of GX 340+0](https://arxiv.org/abs/2604.03375) <a id="link12"></a>
...
**Comment:** High-resolution X-ray spectral study of the ISM along the line of sight to GX 340+0, focusing on dust and gas composition. The paper provides detailed ISM dust and gas characterization, but does not focus on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. Borderline relevance due to ISM focus, but not directly related to the core topics.
...
## 13. [Measurement of the galaxy-velocity power spectrum of DESI tracers with the kinematic Sunyaev-Zeldovich effect using DESI DR2 and ACT DR6](https://arxiv.org/abs/2604.04867) <a id="link13"></a>
...
**Comment:** This paper measures the galaxy-velocity power spectrum using the kinematic Sunyaev-Zeldovich effect, focusing on LRGs, ELGs, and QSOs. While it involves galaxy populations and velocity fields, it does not specifically address dwarf galaxies, satellite luminosity functions, resolved star formation histories, or quenching. The focus is on large-scale structure and cosmology.
...
## 14. [Gaussian-Process Emulation of the Redshift-Space Halo Power Spectrum Monopole in Cosmologies with Massive Neutrinos](https://arxiv.org/abs/2604.04122) <a id="link14"></a>

**ArXiv ID:** 2604.04122

**Authors:** Jixin Gan, Yonghao Feng, Gong-Bo Zhao

**Abstract:** We present a Gaussian-process (GP) emulator for the monopole of the redshift-space halo power spectrum in $\Lambda$CDM cosmologies with massive neutrinos. The emulator is trained on 1000 COLA simulations distributed in a Latin-hypercube design over the six-dimensional cosmological parameter space $\{\Omega_m h^2,\Omega_b h^2,\Omega_\nu h^2,\sigma_8,h,n_s\}$, with outputs at 11 snapshots spanning $0.5 \le z \le 2.0$. From redshift-space halo catalogues we measure shot-noise-subtracted monopole spectra over $0.01 \le k \le 0.50\,h\,\mathrm{Mpc}^{-1}$. We also generate 1000 fixed-cosmology realizations to estimate the covariance matrix and to construct synthetic data vectors for likelihood tests. On held-out cosmologies, the emulator reproduces the simulated spectra to typically better than $2\%$ across the scales and redshifts considered. Combined with its GP-based estimate of interpolation uncertainty, this speed and accuracy make the emulator well suited to repeated likelihood evaluations in Markov Chain Monte Carlo analyses. The resulting framework provides an efficient route toward neutrino-mass inference from DESI-motivated redshift-space clustering measurements.

**Comment:** This paper presents a Gaussian-process emulator for the redshift-space halo power spectrum in cosmologies with massive neutrinos, trained on COLA simulations. While it involves numerical simulations and power spectra, the focus is on cosmological parameter inference and not on galaxy-scale simulations or resolved star formation histories. Borderline relevance due to simulation aspect.
...
## 15. [Inference of recoil kicks from binary black hole mergers up to GWTC--4 and their astrophysical implications](https://arxiv.org/abs/2604.04546) <a id="link15"></a>
...
**Comment:** This paper infers recoil kicks from binary black hole mergers and estimates retention probabilities in various environments, including dwarf galaxies. The discussion of retention probabilities in dwarf galaxies provides a weak link to near-field cosmology, but the main focus is on black hole mergers and their astrophysical implications.
...
## 16. [Random gas motions inside sub-parsec scale supercritical filaments](https://arxiv.org/abs/2604.04501) <a id="link16"></a>
...
**Comment:** The study analyzes gas motions in supercritical filaments within molecular clouds, focusing on turbulence versus gravity in star formation. While it provides insight into star formation conditions, it does not address resolved star formation histories of galaxies, galaxy-scale outflows, or dwarf galaxy properties.
...
## 17. [MIDIS: Strong H$\beta$+[OIII] Line Emitters at $z \geq 9$](https://arxiv.org/abs/2604.04284) <a id="link17"></a>
...
**Comment:** The paper presents a search for strong Hβ+[OIII] emitters at z ≥ 9 using JWST/MIRI, focusing on nebular emission and ionizing efficiency in high-redshift galaxies. It does not address resolved star formation histories from color-magnitude diagrams, dwarf galaxy properties, or galaxy simulations.
...
## 18. [Diffusion of PeV Cosmic Rays in the Turbulent and Multiphase Interstellar Medium](https://arxiv.org/abs/2604.04814) <a id="link18"></a>
...
**Comment:** This paper uses high-resolution MHD simulations to study cosmic ray diffusion in the multiphase ISM. While it involves numerical simulations and ISM physics, it does not focus on galaxy-scale simulations, star formation histories, or outflows, and is more about cosmic ray transport.
...
## 19. [A Foundation for Gravitational-Wave Population Inference within the LISA Global Fit](https://arxiv.org/abs/2604.03390) <a id="link19"></a>
...
**Comment:** This paper develops a statistical formalism for gravitational-wave population inference within the LISA global fit, focusing on compact binaries in the Milky Way. While it mentions the Galactic binary population, the focus is on gravitational-wave data analysis and population inference, not on near-field cosmology, resolved star formation histories, or galaxy-scale processes.
...
## 20. [Stellar Parameters and Orbital Period Estimates for Composite-Spectrum sdB+MS Binaries from LAMOST](https://arxiv.org/abs/2604.04110) <a id="link20"></a>
...
**Comment:** The paper presents stellar parameters and orbital period estimates for sdB+MS binaries, focusing on binary evolution and mass transfer. While it uses stellar evolutionary tracks, it does not present new stellar models or bolometric corrections, nor does it address galaxy-scale topics or resolved star formation histories.
...
## 21. [The Distribution of Cosmic Ray Electrons in Star-Forming Galaxies](https://arxiv.org/abs/2604.04068) <a id="link21"></a>
...
**Comment:** This paper derives explicit expressions for cosmic ray electron distributions in star-forming galaxies, relevant for interpreting radio observations. It does not address resolved star formation histories, dwarf galaxy properties, or galaxy simulations with new physics.
...
## 22. [Holes in the BH$^\star$? AGN signatures in the FUV spectrum of a black-hole dominated Little Red Dot at $z=7.04$](https://arxiv.org/abs/2604.03370) <a id="link22"></a>
...
**Comment:** The paper analyzes JWST spectroscopy of a high-redshift 'Little Red Dot' galaxy, focusing on AGN signatures and the geometry of the absorbing medium. While it discusses galaxy properties, the focus is on AGN and black hole accretion, which is not relevant to the core topics.
...
## 23. [GOPREAUX I: Open-source Code and Data to Model Multi-wavelength Emission of Extragalactic Transients using Gaussian Processes](https://arxiv.org/abs/2604.03372) <a id="link23"></a>
...
**Comment:** This paper introduces an open-source code for modeling multi-wavelength emission of extragalactic transients using Gaussian Processes. While it aggregates a large sample of supernovae and tidal disruption events, it does not focus on galaxy-scale processes, resolved star formation histories, or any of the core topics.
...
## 24. [A comparison of three neodymium atomic data sets for kilonova modeling](https://arxiv.org/abs/2604.04362) <a id="link24"></a>
...
**Comment:** This paper compares neodymium atomic data sets for kilonova modeling, focusing on atomic physics and radiative transfer. It does not present new stellar models or address galaxy-scale topics, resolved star formation histories, or near-field cosmology.
...
## 25. [The Identification of Asymmetric Barred Galaxies in Illustris TNG-50](https://arxiv.org/abs/2604.04303) <a id="link25"></a>
...
**Comment:** The paper analyzes asymmetric barred galaxies in the IllustrisTNG simulation, focusing on bar morphology and galaxy properties. While it uses numerical galaxy simulations, its focus is on bar structures, which are specifically listed as irrelevant in the criteria.
...
## 26. [From NVSS to RACS: Identifying truly Compact and Steep spectrum Radio sources](https://arxiv.org/abs/2604.04577) <a id="link26"></a>
...
**Comment:** The paper identifies compact, steep-spectrum radio sources using new radio surveys, with applications to pulsars and high-redshift radio galaxies. While it touches on extragalactic sources, it does not focus on dwarf galaxies, satellite luminosity functions, or resolved star formation histories.
...
## 27. [Independent Recovery of Vanishing Sources on POSS-I Photographic Plates Using Automated Source Detection and Cross-Epoch Matching](https://arxiv.org/abs/2604.04810) <a id="link27"></a>
...
**Comment:** The paper presents an automated pipeline for detecting vanished sources on POSS-I plates. While it deals with stellar sources, it does not address resolved star formation histories, stellar models, or galaxy formation.
...
## 28. [Enhancing astrometric registration of Chinese historical Astronomical Digital Plates with deep learning](https://arxiv.org/abs/2604.04714) <a id="link28"></a>
...
**Comment:** This paper presents a deep learning method for astrometric registration of historical astronomical plates. While it enhances data processing for time-domain studies, it does not directly address galaxy evolution, star formation histories, or near-field cosmology.
...
## 29. [Multimessenger Signatures of Tilted, Self-Gravitating, Black Hole Disks](https://arxiv.org/abs/2604.03368) <a id="link29"></a>
...
**Comment:** The paper presents GRMHD simulations of tilted, self-gravitating black hole-disk systems, focusing on multimessenger signatures. The simulations are not of galaxies, but of black hole accretion disks, which is outside the core topics.
...
## 30. [The VLBI spectrum of the persistent radio source associated with FRB 20190417A](https://arxiv.org/abs/2604.03429) <a id="link30"></a>
...
**Comment:** The paper studies the radio spectrum of persistent sources associated with FRBs using VLBI. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 31. [Deep Adaptive Optics Imaging Rules Out a Helium Star Companion to PSR J1928+1815](https://arxiv.org/abs/2604.03385) <a id="link31"></a>
...
**Comment:** This paper uses deep adaptive optics imaging to rule out a helium star companion to a millisecond pulsar, focusing on binary evolution and compact objects. It does not address galaxy evolution, star formation histories, or near-field cosmology.
...
## 32. [Dispersion Measure Distribution of Unlocalized Fast Radio Bursts as a Probe of the Hubble Constant](https://arxiv.org/abs/2604.03769) <a id="link32"></a>
...
**Comment:** This paper uses fast radio burst dispersion measures to constrain the Hubble constant. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 33. [Fast Radio Burst Dispersion Measure--Timing Cross-Correlations: Bias Self-Calibration and Primordial Non-Gaussianity Constraints](https://arxiv.org/abs/2604.04897) <a id="link33"></a>
...
**Comment:** The paper uses FRB dispersion measures and timing cross-correlations to constrain primordial non-Gaussianity. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 34. [Probing Unification Scenarios with Big Bang Nucleosynthesis](https://arxiv.org/abs/2604.04870) <a id="link34"></a>
...
**Comment:** This paper extends a BBN code to constrain Grand Unified Theories via fundamental constants. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 35. [Replacing Gaussian Processes with Neural Networks in Pulsar Timing Array Inference of the Gravitational-Wave Background](https://arxiv.org/abs/2604.04340) <a id="link35"></a>
...
**Comment:** This paper focuses on replacing Gaussian Processes with neural networks for inference in pulsar timing array analyses, including a self-interacting dark matter model. However, the focus is on gravitational-wave background inference and computational methods, not on near-field cosmology, resolved star formation histories, or galaxy simulations. No direct match to any core criteria.
...
## 36. [Information-Geometric Perspective on the Hubble Tension: Eigenmode Rotation and Curvature Suppression in wCDM](https://arxiv.org/abs/2604.04422) <a id="link36"></a>
...
**Comment:** The paper analyzes the Hubble tension in the wCDM model using information geometry. While it is cosmology-focused, it does not address near-field cosmology, galaxy simulations, or any of the core criteria.
...
## 37. [Wings of little dots: Exponential broad lines from a stratified BLR](https://arxiv.org/abs/2604.04216) <a id="link37"></a>
...
**Comment:** This paper investigates broad exponential wings in Halpha profiles of JWST-discovered 'little red dots' and 'little blue dots', which are compact AGNs. The focus is on AGN broad-line regions and not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 38. [Fast Magnetosonic Turbulence in Two-Dimensional Relativistic Plasmas](https://arxiv.org/abs/2604.04276) <a id="link38"></a>
...
**Comment:** The paper presents kinetic simulations of fast magnetosonic turbulence in relativistic plasmas, relevant for high-energy astrophysical plasmas. It does not address galaxy-scale processes, dwarf galaxies, or any of the core topics.
...
## 39. [Lattice simulations of scalar-induced gravitational waves from inflation](https://arxiv.org/abs/2604.03628) <a id="link39"></a>
...
**Comment:** This paper presents lattice simulations of scalar-induced gravitational waves from inflation, focusing on early universe physics and inflationary dynamics. There is no direct connection to galaxy simulations, star formation histories, or near-field cosmology.
...
## 40. [Is the $w_0w_a$CDM cosmological parameterization evidence for dark energy dynamics partially caused by the excess smoothing of Planck PR4 CMB anisotropy data?](https://arxiv.org/abs/2604.03756) <a id="link40"></a>
...
**Comment:** This paper focuses on cosmological parameterizations and dark energy dynamics using CMB and large-scale structure data. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 41. [Photon Propagation through Magnetar-Hosted Axion Clouds: Time Delays and Polarimetric Constraint](https://arxiv.org/abs/2604.03945) <a id="link41"></a>
...
**Comment:** This paper investigates photon propagation through axion clouds near magnetars, focusing on propagation effects and polarimetric constraints. It does not address any of the core topics such as galaxy-scale phenomena, near-field cosmology, or stellar models.
...
## 42. [Detection of High-Velocity Na$\;$I Absorption Toward the Stellar Remnant of SN 1181 AD](https://arxiv.org/abs/2604.04275) <a id="link42"></a>
...
**Comment:** The paper reports the detection of high-velocity Na I absorption toward the stellar remnant of SN 1181 AD, focusing on supernova remnant properties. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 43. [The Delay Time Distribution of Tidal Disruption Events](https://arxiv.org/abs/2604.04831) <a id="link43"></a>
...
**Comment:** The paper focuses on tidal disruption events (TDEs) and their delay time distribution in post-starburst galaxies, which are typically more massive than dwarfs and not directly related to the core topics. The connection to star formation history is present but not resolved via color-magnitude diagrams, and the focus is on SMBH-driven events, which are explicitly listed as irrelevant.
...
## 44. [Multi-field oscillons/I-balls in the Friedberg-Lee-Sirlin model](https://arxiv.org/abs/2604.04494) <a id="link44"></a>
...
**Comment:** The paper studies oscillon solutions in a scalar field model, relevant for cosmological scenarios but not directly related to galaxy formation, dwarf galaxies, or any of the core topics.
...
## 45. [Characterizing Gamma-Radio Delayed Flaring Activity from Blazars](https://arxiv.org/abs/2604.03847) <a id="link45"></a>
...
**Comment:** The paper studies delayed flaring activity in blazars, focusing on AGN jets. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 46. [Preliminary study on the impact of stress-energy tensor compared to scalar field in Nonminimal Derivative model](https://arxiv.org/abs/2604.04617) <a id="link46"></a>
...
**Comment:** This paper compares stress-energy tensor and scalar field effects in a gravitation model applied to incompressible stars. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 47. [Discovery of a Low-Mass Companion to the Accelerating Star HIP 53005 with Strongly Conflicting Mass Estimates](https://arxiv.org/abs/2604.03767) <a id="link47"></a>
...
**Comment:** Discovery of a low-mass companion to a star using direct imaging and astrometry. The focus is on stellar multiplicity and mass estimates, not on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No relevant criteria matched.
...
## 48. [On the transformation of the Maxwell-Boltzmann Distribution to a Power-Law](https://arxiv.org/abs/2604.04659) <a id="link48"></a>
...
**Comment:** The paper discusses the transformation of the Maxwell-Boltzmann distribution to a power-law in colliding hard sphere systems. While power-law distributions are relevant in astrophysics, the focus here is on statistical mechanics and general systems, not on galaxies, star formation, or near-field cosmology.
...
## 49. [Directional Tests of the Cosmic Distance Duality Relation using Pantheon+ and BAO](https://arxiv.org/abs/2604.04436) <a id="link49"></a>
...
**Comment:** This paper tests the cosmic distance duality relation using supernova and BAO data. It is cosmology-focused and does not address galaxy evolution, star formation, or near-field cosmology.
...
## 50. [Reconstruction of the Quintessence Scalar Field Potential Using Gaussian Processes](https://arxiv.org/abs/2604.04056) <a id="link50"></a>
...
**Comment:** The paper reconstructs the quintessence scalar field potential using Gaussian Processes and cosmological data. The focus is on dark energy and cosmological parameter inference, not on galaxies, star formation, or near-field cosmology.
...
## 51. [Big Bang Nucleosynthesis Constraints on the CCC+TL Cosmology](https://arxiv.org/abs/2604.03381) <a id="link51"></a>
...
**Comment:** The paper investigates Big Bang nucleosynthesis constraints in an alternative cosmological model. The focus is on early universe cosmology and not on galaxies, star formation, or near-field cosmology.
...
## 53. [A Conformal Boundary Ansatz for Warm Inflation Initialization: A Toy Model](https://arxiv.org/abs/2604.04219) <a id="link53"></a>
...
**Comment:** The paper discusses a theoretical framework for initializing warm inflation, which is cosmology-focused and not related to galaxy evolution, star formation, or near-field cosmology.
...
## 54. [Friedmann cosmology with fluids and hyperfluids](https://arxiv.org/abs/2604.03343) <a id="link54"></a>
...
**Comment:** The paper discusses metric-affine cosmology and the role of fluids and hyperfluids in the FLRW universe, focusing on theoretical cosmology and not on galaxy evolution, star formation, or near-field cosmology.
...
## 56. [Beyond $f(\phi)\mathcal{G}$: Gauss--Bonnet inflation with $\mu(\phi,X)$](https://arxiv.org/abs/2604.03828) <a id="link56"></a>
...
**Comment:** Gauss-Bonnet inflation with trajectory-selective coupling, focusing on higher-curvature effects in inflationary cosmology. The paper is about early universe inflationary physics, not about galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No relevant criteria matched.
...
## 57. [Influence of CO versus CH$_4$ on organic haze formation in atmospheres of diverse terrestrial exoplanets](https://arxiv.org/abs/2604.03575) <a id="link57"></a>
...
**Comment:** This paper investigates haze formation in terrestrial exoplanet atmospheres, focusing on laboratory simulations and atmospheric chemistry. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The topic is unrelated to dwarf galaxies, star formation quenching, or outflows.
...
## 58. [The PLATO field selection process III. Selection of the Prime Sample for the LOPS2 field](https://arxiv.org/abs/2604.03365) <a id="link58"></a>
...
**Comment:** This paper focuses on the PLATO mission's field selection and prioritization of stars for exoplanet discovery. It is primarily about exoplanet detection and stellar selection, not about near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No relevant criteria matched.
...
## 59. [Assessment of PLATO Science Performance](https://arxiv.org/abs/2604.04818) <a id="link59"></a>
...
**Comment:** Assessment of PLATO science performance, focusing on exoplanet detection yields and planet occurrence rates. The paper is about exoplanet statistics and mission planning, not about the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM). No relevant criteria matched.
...
## 60. [The PLATO Input Catalogue of targets (tPIC) for the first Long Pointing Field](https://arxiv.org/abs/2604.03369) <a id="link60"></a>
...
**Comment:** This paper presents the PLATO Input Catalogue for exoplanet target selection, focusing on stellar parameters and exoplanet hosts. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or outflows.
...
## 61. [Interaction between Winds from Weak-lined T Tauri Stars with Exoplanetary Magnetospheres](https://arxiv.org/abs/2604.03792) <a id="link61"></a>
...
**Comment:** The paper studies the interaction between T Tauri stellar winds and exoplanetary magnetospheres, focusing on planetary protection and stellar wind models. It does not address galaxy-scale processes, dwarf galaxies, or any of the core topics.
...
## 62. [Galileon versus Quintessence: A comparative phase space analysis and late-time cosmic relevance](https://arxiv.org/abs/2604.04582) <a id="link62"></a>
...
**Comment:** The paper is a theoretical study comparing Galileon and Quintessence models for late-time cosmic acceleration, focusing on phase space analysis. It does not address galaxy-scale processes, dwarf galaxies, or any of the core topics.
...
## 63. [Light neutrinos, Dark matter and leptogenesis near electroweak scale and $Z_4$ symmetry](https://arxiv.org/abs/2604.04886) <a id="link63"></a>
...
**Comment:** This paper discusses neutrino masses, dark matter, and leptogenesis near the electroweak scale, focusing on particle physics and cosmology. There is no direct connection to galaxy evolution, star formation, or near-field cosmology.
...
## 64. [Extraction method for response functions from X-ray light curves of AGN by optimization algorithm](https://arxiv.org/abs/2604.04014) <a id="link64"></a>
...
**Comment:** Numerical method for extracting X-ray reverberation response functions from AGN light curves. The focus is on AGN variability and accretion physics, not on the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM). No relevant criteria matched.
...
## 65. [The Role of Baryonic and Dark Matter in Bar Kinematics](https://arxiv.org/abs/2604.03389) <a id="link65"></a>
...
**Comment:** Observational study of bar kinematics in galaxies, focusing on the relationship between bar pattern speed and baryonic/dark matter mass. The paper is about bar dynamics and galaxy mass, which is specifically listed as irrelevant (bar, Galactic center) in the criteria. No relevant criteria matched.
...
## 66. [Silicon Photonics-based Heterodyne Interferometric Imager for free-space imaging](https://arxiv.org/abs/2604.03468) <a id="link66"></a>
...
**Comment:** This paper presents a silicon photonics-based interferometric imager for free-space imaging, focusing on instrumentation and imaging technology. It does not address any of the core topics.
...
## 67. [Constraining the PeV gamma-ray emission zone of Cygnus X-3 with contemporaneous GeV timing and spectral observations](https://arxiv.org/abs/2604.04768) <a id="link67"></a>
...
**Comment:** The paper studies gamma-ray emission from Cygnus X-3, focusing on high-energy astrophysics and emission zones in a binary system. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The topic is unrelated to dwarf galaxies, star formation quenching, or outflows.
...
## 68. [Prediction of Magnetic Flux Evolution During Solar Active Region Emergence using Long Short-Term Memory Networks](https://arxiv.org/abs/2604.03507) <a id="link68"></a>
...
**Comment:** This paper develops machine learning models to predict magnetic flux evolution during solar active region emergence. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The topic is unrelated to dwarf galaxies, star formation quenching, or outflows.
...
## 69. [Speckle Interferometry of 25 Gaia Two-Parameter Potential Binaries](https://arxiv.org/abs/2604.04389) <a id="link69"></a>
...
**Comment:** This paper uses speckle interferometry to resolve binary stars identified by Gaia. It is focused on stellar multiplicity and astrometry, not on galaxy-scale processes or any of the core topics.
...
## 70. [Revisiting the X-ray Variability Plane of AGNs: The Significant Role of the Photon Index](https://arxiv.org/abs/2604.04085) <a id="link70"></a>
...
**Comment:** Revisiting X-ray variability in AGNs, focusing on the photon index and black hole mass. The paper is about AGN accretion and variability, not about dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No relevant criteria matched.
...
## 71. [A Few Years Later: Revisiting Period Variations of Eclipsing Binaries in the Northern Continuous Viewing Zone of TESS](https://arxiv.org/abs/2604.04004) <a id="link71"></a>
...
**Comment:** Analysis of period variations in eclipsing binaries in the TESS Northern Continuous Viewing Zone, focusing on hierarchical triple and quadruple star systems. The paper is about stellar multiplicity and orbital dynamics, not about the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM). No relevant criteria matched.
...
## 72. [Effects of Various Bipolar Approximations of Active Regions on Solar Surface Magnetic Field Simulations](https://arxiv.org/abs/2604.04034) <a id="link72"></a>
...
**Comment:** This paper focuses on solar surface magnetic field simulations and the modeling of active regions. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The topic is unrelated to dwarf galaxies, star formation quenching, or outflows.
...
## 73. [The hitchhiker's guide to the IXPE data analysis](https://arxiv.org/abs/2604.03366) <a id="link73"></a>
...
**Comment:** Guide to IXPE data analysis, focusing on X-ray polarimetry methods and instrument response. The paper is a technical guide for data analysis, not about the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM). No relevant criteria matched.
...
## 74. [Flare Impulsive-phase Durations](https://arxiv.org/abs/2604.04798) <a id="link74"></a>
...
**Comment:** This research note discusses flare impulsive-phase durations and particle acceleration in solar flares. The topic is solar physics and not related to galaxy evolution, star formation histories, or near-field cosmology.
...
## 75. [FRB Searches with the Irish LOFAR Station](https://arxiv.org/abs/2604.03283) <a id="link75"></a>
...
**Comment:** The paper reports null results in searches for radio emission from fast radio bursts using LOFAR. The focus is on FRBs, not on galaxies, star formation, or near-field cosmology.
