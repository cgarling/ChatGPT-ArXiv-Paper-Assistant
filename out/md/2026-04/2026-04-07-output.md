...
1. [Higher resolution optical spectra of $M_*<10^{10}~M_{\odot}$ galaxies reveal outflow signatures unresolved by the SDSS](#user-content-link1)
**Authors:** B. Hagedorn, C. Cicone, C. Vignali, P. Severgnini, M. Pedani, M. Sarzi, A. Saintonge, M. Romano

2. [JWST Lensed Quasar Dark Matter Survey V: Measuring the minimum halo mass with strong gravitational lensing](#user-content-link2)
...
3. [What can galaxy clustering really tell us about the galaxy-halo connections?](#user-content-link3)
**Authors:** Xiaoju Xu, Xiaohu Yang, Zhongxu Zhai, Yiyang Guo, Yizhou Gu, Yirong Wang, Jiaxin Han, Zhenlin Tan, Junde Li

4. [Toward Early-type Eclipsing Binaries as Extragalactic Milestones: First Calibration of the SBCR from O- and B-type Stars in Detached Eclipsing Binaries](#user-content-link4)
**Authors:** M\'onica Taormina, G. Pietrzy\'nski, B. Pilecki, R. -P. Kudritzki, D. Graczyk, J. Puls, M. G\'orski

5. [Great Walls of Cosmic Baryons in the Northern Sky](#user-content-link5)
**Authors:** Vikram Ravi, Kritti Sharma, Liam Connor

6. [The Broken Similarity: Sinking and Merging of Dark Matter Subhalos Across Hierarchical Levels](#user-content-link6)
...
7. [Testing the 3-equation Kuhfuss Convection Model using the Sun](#user-content-link7)
**Authors:** T. A. M. Braun, F. Ahlborn, F. Kupka, A. Weiss

8. [The Cluster Completeness Correction Calculator (C-4): A Neural-Network framework and pilot application to the LEGUS Survey of NGC 628](#user-content-link8)
**Authors:** Jianling Tang, Kathryn Grasha, Tomasz R\'o\.za\'nski, Mark R. Krumholz, Alan Zhang

9. [cuRAMSES: Scalable AMR Optimizations for Large-Scale Cosmological Simulations](#user-content-link9)
**Authors:** Juhan Kim

10. [Winding Back the Clock: Recent Star Formation Histories of Massive Quiescent Galaxies Are Consistent With Their Rapid Number Density Evolution Since $\mathbf{z\sim7}$](#user-content-link10)
...
11. [Identifying signatures of inflow onto face-on galaxies using the Balmer decrement](#user-content-link11)
**Authors:** Meghna Sitaram, Hui Li, Yong Zheng, Greg L. Bryan, Mary Putman, Aaron Smith, Rahul Kannan

12. [A Chemical Mismatch Between Young Stars and Their Inner Disks](#user-content-link12)
**Authors:** Diogo Souto, Ilaria Pascucci, Katia Cunha, Shubham Kanodia

13. [An 18 - 25 GHz spectroscopic survey of southern hemisphere dense cores](#user-content-link13)
**Authors:** Dariusz C. Lis, Karen Willacy, Liton Majumdar, Jorge L. Pineda, Susanna Widicus Weaver, Shinji Horiuchi

14. [PANORAMIC: The Dawn of Massive Quiescent Galaxies I. Number Density and Cosmic Variance from 1000 arcmin$^2$ NIRCam Imaging](#user-content-link14)
**Authors:** Zhiyuan Ji, Christina C. Williams, Peter Behroozi, Andrea Weibel, Christian Kragh Jespersen, Pascal A. Oesch, Rachel Bezanson, Katherine E. Whitaker, Jenny E. Greene, Gabriel Brammer, Pratika Dayal, Ivo Labb\'e, Sinclaire M. Manning, Pierluigi Rinaldi, Mengyuan Xiao, Yunchong Zhang

15. [JZ-Tree: GPU friendly neighbour search and friends-of-friends with dual tree walks in JAX plus CUDA](#user-content-link15)
**Authors:** Jens St\"ucker, Oliver Hahn, Lukas Winkler, Adrian Gutierrez Adame, Thomas Fl\"oss

16. [Universal Dark-matter Density Profiles of Cosmic Filaments](#user-content-link16)
**Authors:** Peng Xu, Fangzhou Jiang, Farhanul Hasan, Joanna Woo, Douglas Hellinger, Joel R. Primack, Sandra M. Faber, David Koo

17. [Identification of a Radio Counterpart to SN 2025ulz in the S250818k Localization Area](#user-content-link17)
...
18. [Lithium and the evolution of intermediate-mass T Tauri and Herbig stars. Rotation, accretion, and planets](#user-content-link18)
**Authors:** I. Mendigut\'ia, J. Campbell-White, B. Montesinos, J. Maldonado, L. Fullana-Garc\'ia, G. M. Mirouh, G. Meeus, M. Vioque, A. Sicilia-Aguilar, M. R. Zapatero-Osorio, E. Villaver, R. Kahar

19. [WALLABY pilot survey: HI depletion times within the stellar discs of nearby galaxies](#user-content-link19)
...
20. [Stellar Population Characterisations in nearby, dusty Early-Type Galaxies](#user-content-link20)
**Authors:** Ron W. Savage, Anne E. Sansom, David H. W. Glass

21. [Reconstructing a large-scale matter-density contrast profile to reconcile Pantheon+ supernovae with DESI DR2 BAO in an inhomogeneous universe](#user-content-link21)
**Authors:** Toshifumi Futamase, Reiki Kojima, Masanori Tomonaga

22. [Lyman-$\alpha$ Forest Signatures of Mixed Fuzzy and Cold Dark Matter](#user-content-link22)
**Authors:** Yourong Frank Wang

23. [Electroweak Doublet Dark Matter for a Galactic Halo Gamma-Ray Excess](#user-content-link23)
**Authors:** Yasunori Nomura, Tomonori Totani

24. [One sightline, many systems: a FLASH discovery of HI towards scintillating quasar PKS 0405-385](#user-content-link24)
...
25. [Characterizing the Gamma-ray Emission from Low-Luminosity AGN](#user-content-link25)
**Authors:** Chris Karwin, Nikita Khatiya, Margot Boughelilba, Xiurui Zhao, Anita Reimer, Marco Ajello

26. [A Catalog of Mid-infrared Variable Sources in the Ecliptic Poles](#user-content-link26)
**Authors:** Minjin Kim, Suyeon Son, Shinyu Kim, Luis C. Ho, Woong-Seob Jeong, Bomee Lee, Yujin Yang

27. [Deep Spectroscopy with DESI for Photometric Redshift Training and Calibration](#user-content-link27)
...
28. [Ion Weibel Instability in the hybrid framework: the optimal resolution](#user-content-link28)
**Authors:** Luca Orusa, Taiki Jikei

29. [Model-independent constraints on generalized FLRW consistency relations with bootstrap-based symbolic regression](#user-content-link29)
**Authors:** S. M. Koksbang, A. Heinesen

30. [FluxMC: Rapid and High-Fidelity Inference for Space-Based Gravitational-Wave Observations](#user-content-link30)
...
31. [A Comprehensive Atmospheric Retrieval Analysis of 22 James Webb Space Telescope Spectral Energy Distributions of Cool Brown Dwarfs](#user-content-link31)
**Authors:** Harshil Kothari, Michael C. Cushing, Samuel A. Beiler, Channon Visscher, Mark S. Marley, Ben Burningham, Adam C. Schneider, J. Davy Kirkpatrick

32. [Adiabatic Mass Loss In Binary Stars. VI. Massive Helium Binary Stars](#user-content-link32)
**Authors:** Lifu Zhang

33. [Galactic-scale evolution of classical and complex radio galaxies. Impact of ambient morphology and jet geometry](#user-content-link33)
...
34. [Diagnostic Consistency Tests of the Concordance Cosmology](#user-content-link34)
**Authors:** S. M. Koksbang, A. Heinesen

35. [A generic $\omega_b$ tension in early-time solutions to the Hubble tension](#user-content-link35)
**Authors:** Cara Giovanetti

36. [Multi-Quark Clustering in Neutron-Star Matter from Color-Spin Molecular Dynamics](#user-content-link36)
**Authors:** Nobutoshi Yasutake, Yuta Mukobara, Aaron Park, Su Houng Lee, Toshiki Maruyama

37. [Unveiling axion signals in galactic supernovae with future MeV telescopes](#user-content-link37)
**Authors:** Zhen Xie, Jiahao Liu, Bing Liu, Ruizhi Yang

38. [Kinetic magnetohydrodynamics and Landau fluid closure in relativity](#user-content-link38)
**Authors:** Abhishek Hegade K. R., James M. Stone

39. [High-contrast imaging of Galactic Cepheids with VLT/SPHERE](#user-content-link39)
**Authors:** A. Gallenne, P. Kervella, N. R. Evans, J. Milli, E. Sivkova, W. Gieren, G. Pietrzy\'nski, G. Bras, V. Hocd\'e, W. Kiviaho, N. Nardetto, B. Pilecki, B. Zg\'irski

40. [Investigating ACS/WFC Amp-to-Amp Sensitivities](#user-content-link40)
**Authors:** Gagandeep S. Anand, Norman A. Grogin

41. [The neighboring stars of N6946-BH1 and the observational characteristics of failed supernovae](#user-content-link41)
**Authors:** R. For\'es-Toribio, C. S. Kochanek

42. [The Cohesive Object Sequence: The Mass-Density Distribution of Astronomical Objects from Asteroids to Stars](#user-content-link42)
**Authors:** Gabriel M Steward, Matthew Hedman

43. [Hunting Dark Matter with the Einstein Telescope](#user-content-link43)
**Authors:** A. J. Iovino, M. Maggiore, N. Muttoni, A. Riotto

44. [A New Method for Testing Einstein's Theory of Gravity Close to Rapidly Spinning Black Holes](#user-content-link44)
**Authors:** Shravan Vengalil Menon, Kun Hu, Henric Krawczynski

45. [Approximating the Fourier Transform of Ring-Like Images: the Focal Expansion](#user-content-link45)
**Authors:** Filip Niewi\'nski, Michael D. Johnson

46. [Testing parity with composite-field spectra of BOSS and DESI luminous red galaxies](#user-content-link46)
**Authors:** Zucheng Gao, Marina S. Cagliari, Azadeh Moradinezhad Dizgah, Zvonimir Vlah

47. [SN2023ixf: Radiative-transfer modeling of the photospheric phase evolution from the ultraviolet to the infrared](#user-content-link47)
...
48. [Strontium and helium in the kilonova AT2017gfo: Origin of the 1{\mu}m feature constrained via NLTE calculations](#user-content-link48)
**Authors:** Aayush Arya, Rasmus Damgaard, Albert Sneppen, David J. Dougan, Stuart A. Sim, Connor P. Ballance, Darach Watson

49. [Explaining Neural Networks on the Sky: Machine Learning Interpretability for Cosmic Microwave Background Maps](#user-content-link49)
**Authors:** Indira Ocampo, Guadalupe Ca\~nas-Herrera

50. [Twisted doughnuts: Thick disk torus around equatorial asymmetric black hole](#user-content-link50)
**Authors:** Che-Yu Chen, Eva Hackmann, Audrey Trova

51. [The JWST Search for Earth-Luna Analogs: Upper Limits on Exomoons and Refined Ephemerides for TOI 700 d and e](#user-content-link51)
**Authors:** Emily K. Pass, David Charbonneau, Andrew Vanderburg, Jacob L. Bean

52. [Non-LTE Ionization Modeling for Helium and Strontium in Neutron Star Merger Ejecta](#user-content-link52)
**Authors:** Koya Chiba, Masaomi Tanaka, Shinya Wanajo, Sho Fujibayashi, Kyohei Kawaguchi, Kenta Hotokezaka

53. [Remnant recoil and host environments of GWTC-4.0 binary black-hole mergers](#user-content-link53)
...
54. [Reconstruction of fast-rotating neutron star observables with the neural network](#user-content-link54)
**Authors:** Wen Liu, Lingxiao Wang, Zhenyu Zhu

55. [Instrumental development for Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](#user-content-link55)
**Authors:** Daiki Tanabe, Hsiang-Yu Huang, Yuki Inoue, Mario Juvenal S. Onglao III, Ta-Chun Yu

56. [Implications of low neutron star merger rates for gamma-ray bursts, r-process production and Galactic double neutron stars](#user-content-link56)
**Authors:** Maya Fishbach, Alexander P. Ji, Wen-fai Fong, Tom Y. Wu, Jillian C. Rastinejad, Aditya Vijaykumar, Hsin-Yu Chen

57. [Gravitational Waves from Matter Perturbations of Spectator Scalar Fields](#user-content-link57)
**Authors:** Marcos A. G. Garcia, Angel Garcia-Vega, Sarunas Verner

58. [Electromagnetic Flares from Compact-Object Mergers in AGN Disks: Signatures and Predictions](#user-content-link58)
**Authors:** Hiromichi Tagawa, Zolt\'an Haiman, Shigeo S. Kimura, Hassen M. Yesuf, Hengxiao Guo

59. [Orbital inclination estimates for overcontact binaries using the derivatives of light curves](#user-content-link59)
**Authors:** Shinjirou Kouzuma

60. [Massive Exchange and the Sign of the Equilateral Bispectrum](#user-content-link60)
**Authors:** Diptimoy Ghosh, Suvashis Maity, Farman Ullah

61. [Local primordial non-Gaussianity using cross-correlations of DESI tracers](#user-content-link61)
**Authors:** A. J. Rosado-Mar\'in, A. J. Ross, H. Seo, E. Chaussidon, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, A. de Mattia, R. Demina, B. Dey, P. Doel, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, C. Hahn, H. K. Herrera-Alcantar, D. Huterer, M. Ishak, R. Joyce, D. Kirkby, A. Kremin, O. Lahav, C. Lamman, M. Landriau, M. E. Levi, M. Manera, A. Meisner, R. Miquel, S. Nadathur, J. A. Newman, N. Palanque-Delabrouille, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, J. Silber, G. Tarl\'e, B. A. Weaver, C. Zhao, H. Zou

62. [Searching for Contact Binaries with LAMOST and TESS](#user-content-link62)
**Authors:** Ting Wu, Jin-Zhong Liu, Senyu Qi, Zhi-Xiang Zhang, Hubiao Niu, Ali Esamdin, Wei-Min Gu

63. [Accurate polarization calibration of FAST spectral data for measurements of Zeeman splittings of OH megamasers in IRAS 02524+2046](#user-content-link63)
**Authors:** L. G. Hou, X. Y. Gao, Tao Hong, J. L. Han

64. [Probing the Evolution of Dark Energy: A Joint Analysis of DESI DR2, Pantheon+, and Cosmic Chronometers](#user-content-link64)
**Authors:** Chanchal Kumari, Dinesh Kumar

65. [Forward analytical model for the optical selection bias on galaxy cluster lensing profiles](#user-content-link65)
**Authors:** M. Costanzi, H. Y. Wu, J. H. Esteves, S. Grandis, C. To, M. Aguena

66. [Wide Jets or Low Rates: Reconciling Short GRB and Gravitational-Wave Neutron Star Merger Rates](#user-content-link66)
**Authors:** Keerthi Kunnumkai, Antonella Palmese, Brendan O'Connor, Amanda Farah, Ignacio Magana Hernandez

67. [Spectroscopic confirmation of dual and offset quasars from the Subaru HSC-SSP program](#user-content-link67)
**Authors:** Shenli Tang, John Silverman, Xavier Prochaska, Manda Banerji, Xuheng Ding, Masafusa Onoue, Knud Jahnke

68. [Developing Pre-Supernova Neutrino Support for sntools](#user-content-link68)
**Authors:** Ellie O'Brien, Susan Cartwright, Patrick Stowell

69. [Revisiting The Gravitational Mirroring In Presence of Compact Objects](#user-content-link69)
**Authors:** Bikramarka S Choudhury, Aritra Sanyal, Md Khalid Hossain, Farook Rahaman

70. [Valence and Rydberg excited state bond dissociation curves of CO2 from orbital-optimized density functional calculations](#user-content-link70)
**Authors:** Dar\'io Barreiro-Lage, Gianluca Levi, Hannes Jonss\'on, Thanja Lamberts

71. [Cosmological collider signals of modular spontaneous CP breaking](#user-content-link71)
**Authors:** Shuntaro Aoki, Alessandro Strumia

72. [The NANOGrav 15 yr and 20 yr Datasets: Timing Events and Pulse Shape Changes](#user-content-link72)
...
73. [Detectability of continuous gravitational waves from planetary-mass companions orbiting compact stars](#user-content-link73)
...
74. [Constraints on the Injection of Radiation in the Early Universe](#user-content-link74)
**Authors:** Melissa Joseph, Jason Kumar, Pearl Sandick

75. [Modeling complex plasma instabilities in space plasmas - Three-component electron formalism of heat-flux instabilities](#user-content-link75)
**Authors:** Dustin L. Schr\"oder, Marian Lazar, Horst Fichtner, Rodrigo A. L\'opez, Stefaan Poedts

76. [Noise budget of Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](#user-content-link76)
**Authors:** Mario Juvenal S. Onglao III, Hsiang-Yu Huang, Yuki Inoue, Vivek Kumar, Daiki Tanabe

77. [On the observational distinguishability of the Kerr and Kerr-Hayward metrics to EHT](#user-content-link77)
**Authors:** Nikola Bukowiecka, Angelo Ricarte, Prashant Kocherlakota, Cora Prather

78. [$\xi R\phi^2$ non-minimal coupling, and the long range gravitational potential for different spin fields from 2-2 scattering amplitudes](#user-content-link78)
**Authors:** Avijit Sen Majumder, Ayan Kumar Naskar, Sourav Bhattacharya

79. [Gas Giants Formed by Gravitational Instability May Accrete Atmospheres with Super-Stellar Carbon to Oxygen Ratios](#user-content-link79)
**Authors:** Alan P. Boss

80. [Posterior Predictive Checks for Gravitational-wave Populations: Limitations and Improvements](#user-content-link80)
**Authors:** Simona J. Miller, Sophia Winney, Katerina Chatziioannou, Patrick M. Meyers

81. [Geomagnetic storm suppression of photographic plate transient detections in the POSS-I archive: an independent physical variable strengthening the nuclear test correlation](#user-content-link81)
**Authors:** Kevin Cann

82. [Photon-Count Statistics of Crab X-ray Pulses: Skellam Behavior and Excess Variance in the Main Pulse](#user-content-link82)
...
83. [Scientific Validation of the SPARC4 Pipeline: Multi-band Imaging, Polarimetry, and Photometric Time Series for Improved Characterization of Transiting Exoplanets](#user-content-link83)
...
## 2. [JWST Lensed Quasar Dark Matter Survey V: Measuring the minimum halo mass with strong gravitational lensing](https://arxiv.org/abs/2604.05237) <a id="link2"></a>
...
**Comment:** This paper uses strong gravitational lensing to constrain the minimum halo mass in the CDM halo mass function, directly relevant to near-field cosmology (substructure, satellite luminosity function, core-cusp, etc.). It also compares constraints to those from Milky Way satellite galaxies.
...
## 3. [What can galaxy clustering really tell us about the galaxy-halo connections?](https://arxiv.org/abs/2604.05561) <a id="link3"></a>
...
**Comment:** This paper discusses subhalo abundance matching (SHAM) and the galaxy-halo connection, with a focus on satellite fractions and clustering. It analyzes satellite populations and their connection to galaxy clustering, which is relevant to near-field cosmology and satellite luminosity functions. The work is theoretical and directly addresses satellite populations, making it highly relevant.
...
## 4. [Toward Early-type Eclipsing Binaries as Extragalactic Milestones: First Calibration of the SBCR from O- and B-type Stars in Detached Eclipsing Binaries](https://arxiv.org/abs/2604.05029) <a id="link4"></a>
...
**Comment:** This paper presents a new empirical surface brightness-color relation (SBCR) for O- and B-type stars in detached eclipsing binaries, which is a stellar atmosphere model. This fits the 'Stellar Models' criterion, as it provides new bolometric corrections and calibrations for stellar evolutionary/atmosphere models.
...
## 5. [Great Walls of Cosmic Baryons in the Northern Sky](https://arxiv.org/abs/2604.05093) <a id="link5"></a>
...
**Comment:** Matches 'Near-Field Cosmology' criterion: Uses FRB dispersion measures to map baryon overdensities in local large-scale structure, including circumgalactic medium and local superclusters. Directly relevant to baryon mapping in the near-field.
...
## 6. [The Broken Similarity: Sinking and Merging of Dark Matter Subhalos Across Hierarchical Levels](https://arxiv.org/abs/2604.05580) <a id="link6"></a>
...
**Comment:** This paper investigates hierarchical mergers among dark matter subhalos in a LambdaCDM simulation, focusing on satellite-satellite and central-satellite merger rates, spatial bias, and the physical processes affecting subhalo evolution. It directly matches the 'Near-Field Cosmology' criterion, specifically substructure and satellite mergers, and also fits 'Numerical Galaxy Simulations' as it presents new simulation analysis.
...
## 7. [Testing the 3-equation Kuhfuss Convection Model using the Sun](https://arxiv.org/abs/2604.06151) <a id="link7"></a>
...
**Comment:** This paper tests the 3-equation Kuhfuss turbulent convection model using the Sun, which is a new stellar interior model. This fits the 'Stellar Models' criterion, as it presents new theoretical models for stellar convection.
...
## 8. [The Cluster Completeness Correction Calculator (C-4): A Neural-Network framework and pilot application to the LEGUS Survey of NGC 628](https://arxiv.org/abs/2604.05291) <a id="link8"></a>
...
**Comment:** Introduces a neural-network-based completeness correction tool for star cluster catalogs in external galaxies, applied to NGC 628. The method improves cluster demographic analyses and is relevant to resolved star formation histories and stellar population studies, especially in external galaxies. The tool could be useful for studies of resolved star formation histories in galaxies.
...
## 9. [cuRAMSES: Scalable AMR Optimizations for Large-Scale Cosmological Simulations](https://arxiv.org/abs/2604.06035) <a id="link9"></a>
...
**Comment:** This paper presents substantial improvements to the RAMSES AMR code for large-scale cosmological simulations, including new domain decomposition and GPU optimizations. It fits the 'Numerical Galaxy Simulations' criterion, as it enables more efficient and scalable galaxy simulations, but does not directly address galaxy physics or any of the other core topics.
...
## 11. [Identifying signatures of inflow onto face-on galaxies using the Balmer decrement](https://arxiv.org/abs/2604.05141) <a id="link11"></a>
...
**Comment:** This paper uses simulations to develop a diagnostic for inflow and outflow in Milky Way-mass galaxies, specifically using the Balmer decrement. It discusses star formation driven inflows and outflows, but the focus is on Milky Way-mass galaxies, not dwarfs. Relevant to 'star formation driven outflows', but weighted lower due to galaxy mass.
...
## 12. [A Chemical Mismatch Between Young Stars and Their Inner Disks](https://arxiv.org/abs/2604.05221) <a id="link12"></a>
...
**Comment:** This paper presents stellar abundance measurements for young, very low-mass stars and their inner disks, discussing C/O ratios and implications for disk evolution and planet formation. It is relevant to stellar models and disk chemistry, but does not present new stellar evolutionary tracks or atmosphere models. Borderline relevance to stellar models criterion.
...
## 13. [An 18 - 25 GHz spectroscopic survey of southern hemisphere dense cores](https://arxiv.org/abs/2604.05917) <a id="link13"></a>
...
**Comment:** This paper presents a spectroscopic survey of dense cores in the southern hemisphere, deriving molecular abundances and C/O ratios, and comparing to astrochemical models. It is relevant to stellar models and star formation histories in dense cores, but does not focus on resolved star formation histories of galaxies or dwarf galaxy properties.
...
## 14. [PANORAMIC: The Dawn of Massive Quiescent Galaxies I. Number Density and Cosmic Variance from 1000 arcmin$^2$ NIRCam Imaging](https://arxiv.org/abs/2604.05022) <a id="link14"></a>
...
**Comment:** This paper measures the abundance and clustering of massive quiescent galaxies at high redshift, focusing on their number density and cosmic variance. It fits the 'Star Formation Quenching' criterion, but is weighted lower since it focuses on massive galaxies rather than dwarfs. It also provides empirical constraints on galaxy formation models.
...
## 15. [JZ-Tree: GPU friendly neighbour search and friends-of-friends with dual tree walks in JAX plus CUDA](https://arxiv.org/abs/2604.05885) <a id="link15"></a>
...
**Comment:** This paper presents a new GPU-friendly spatial tree algorithm for neighbor search and friends-of-friends clustering, which is foundational for numerical galaxy simulations. However, it is a technical/methodological paper and does not present new galaxy simulations or physics models.
...
## 16. [Universal Dark-matter Density Profiles of Cosmic Filaments](https://arxiv.org/abs/2604.05033) <a id="link16"></a>
...
**Comment:** The paper analyzes dark matter density profiles of cosmic filaments using hydrodynamical galaxy simulations (TNG50). It presents new numerical simulation analysis and discusses structural self-similarity, but does not focus on galaxies or dwarf galaxy substructure. Borderline relevance to numerical galaxy simulations criterion.
...
## 17. [Identification of a Radio Counterpart to SN 2025ulz in the S250818k Localization Area](https://arxiv.org/abs/2604.05128) <a id="link17"></a>
...
**Comment:** This paper focuses on radio observations of a supernova coincident with a gravitational wave event, discussing ejecta interaction with circumstellar material and possible jet emission. While it touches on core-collapse events and circumstellar interaction, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or CGM. The relevance is borderline due to possible implications for stellar feedback and outflows, but the focus is not on galaxy-scale processes or dwarf galaxies.
...
## 18. [Lithium and the evolution of intermediate-mass T Tauri and Herbig stars. Rotation, accretion, and planets](https://arxiv.org/abs/2604.05040) <a id="link18"></a>
...
**Comment:** Borderline relevance: Focuses on lithium evolution in intermediate-mass T Tauri and Herbig stars, which is tangentially related to 'Stellar Models' criterion but not presenting new models or tracks. Mostly about stellar evolution and accretion.
...
## 19. [WALLABY pilot survey: HI depletion times within the stellar discs of nearby galaxies](https://arxiv.org/abs/2604.05532) <a id="link19"></a>
...
**Comment:** This paper studies HI depletion times and their relation to star formation within stellar discs of nearby galaxies. While it discusses star formation efficiency and the gas-star formation cycle, the focus is on relatively massive, gas-rich galaxies, not specifically on dwarfs or satellites. It does not directly address resolved star formation histories, quenching, or outflows in dwarfs. Borderline relevance due to indirect connection to star formation processes.
...
## 20. [Stellar Population Characterisations in nearby, dusty Early-Type Galaxies](https://arxiv.org/abs/2604.05680) <a id="link20"></a>
...
**Comment:** This paper studies stellar populations in dusty early-type galaxies, using spectral fitting and stellar population models. It discusses age, metallicity, and star formation in ETGs, but these are massive galaxies, not dwarfs or satellites. The use of new stellar population models (sMILES) is somewhat relevant to the 'Stellar Models' criterion, but the focus is not on model development. Borderline relevance.
...
## 22. [Lyman-$\alpha$ Forest Signatures of Mixed Fuzzy and Cold Dark Matter](https://arxiv.org/abs/2604.06038) <a id="link22"></a>
...
**Comment:** This paper uses numerical galaxy simulations (hybrid Schrödinger-Poisson and N-body) to study mixed fuzzy and cold dark matter cosmologies, focusing on Lyman-alpha forest signatures. While the work is simulation-based and relates to dark matter structure, it does not directly address near-field cosmology, resolved star formation histories, or dwarf galaxies. The focus is on cosmological scales and dark matter models, which is tangential to the core topics.
...
## 23. [Electroweak Doublet Dark Matter for a Galactic Halo Gamma-Ray Excess](https://arxiv.org/abs/2604.05016) <a id="link23"></a>
...
**Comment:** This paper discusses electroweak doublet dark matter models to explain a gamma-ray excess in the Galactic halo. It mentions possible suppression of annihilation in dwarf galaxies, but the main focus is on dark matter particle physics and indirect detection, not on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 24. [One sightline, many systems: a FLASH discovery of HI towards scintillating quasar PKS 0405-385](https://arxiv.org/abs/2604.05479) <a id="link24"></a>
...
**Comment:** The paper reports HI absorption systems along a quasar sightline, probing intervening gas and metal-line systems. While it involves gas in galaxies, it does not focus on dwarf galaxies, CGM, or star formation-driven outflows. No direct match to core criteria.
...
## 25. [Characterizing the Gamma-ray Emission from Low-Luminosity AGN](https://arxiv.org/abs/2604.05028) <a id="link25"></a>
...
**Comment:** This paper characterizes gamma-ray emission from low-luminosity AGN, focusing on jets and star formation activity. While it mentions star formation, the focus is on AGN and not on star formation driven outflows in dwarf galaxies or galaxy evolution.
...
## 26. [A Catalog of Mid-infrared Variable Sources in the Ecliptic Poles](https://arxiv.org/abs/2604.05332) <a id="link26"></a>
...
**Comment:** This paper constructs a catalog of mid-infrared variable sources, with some focus on stellar objects in the LMC and AGN variability. While it mentions the LMC and stellar variability, it does not directly address resolved star formation histories, quenching, or near-field cosmology topics. The catalog may be useful for future studies, but the paper itself is only tangentially related.
...
## 27. [Deep Spectroscopy with DESI for Photometric Redshift Training and Calibration](https://arxiv.org/abs/2604.06143) <a id="link27"></a>
...
**Comment:** This paper presents deep spectroscopy for photometric redshift training and calibration, relevant for large imaging surveys. While it improves cosmological inference, it does not address resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 28. [Ion Weibel Instability in the hybrid framework: the optimal resolution](https://arxiv.org/abs/2604.05021) <a id="link28"></a>
...
**Comment:** The paper discusses collisionless shocks and cosmic-ray acceleration, focusing on the ion Weibel instability in hybrid simulations. While relevant to plasma astrophysics and supernova remnants, it does not address galaxy simulations, star formation, or dwarf galaxy properties.
...
## 29. [Model-independent constraints on generalized FLRW consistency relations with bootstrap-based symbolic regression](https://arxiv.org/abs/2604.05822) <a id="link29"></a>
...
**Comment:** This paper presents model-independent constraints on FLRW consistency relations using supernova and BAO data, focusing on cosmological model testing and density field reconstruction. While it is relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or CGM. The relevance is low as it is outside the main research interests.
...
## 30. [FluxMC: Rapid and High-Fidelity Inference for Space-Based Gravitational-Wave Observations](https://arxiv.org/abs/2604.04957) <a id="link30"></a>
...
**Comment:** This paper presents a new machine learning-enhanced Bayesian inference framework for gravitational-wave astronomy, focusing on parameter inversion for massive black hole binaries. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 31. [A Comprehensive Atmospheric Retrieval Analysis of 22 James Webb Space Telescope Spectral Energy Distributions of Cool Brown Dwarfs](https://arxiv.org/abs/2604.05104) <a id="link31"></a>
...
**Comment:** Atmospheric retrieval analysis of brown dwarfs using JWST data, focusing on their chemical and physical properties. This is stellar atmosphere modeling, but for substellar objects (brown dwarfs), not stars. Does not present new stellar models or bolometric corrections for stars.
...
## 32. [Adiabatic Mass Loss In Binary Stars. VI. Massive Helium Binary Stars](https://arxiv.org/abs/2604.05406) <a id="link32"></a>
...
**Comment:** This paper presents new models for massive helium stars in binary systems, focusing on mass transfer stability. While it is a stellar model paper, it is not about low-mass stars or bolometric corrections, and does not address resolved star formation histories or galaxy simulations. The focus is on massive stars and binary evolution, which is outside the core topics.
...
## 33. [Galactic-scale evolution of classical and complex radio galaxies. Impact of ambient morphology and jet geometry](https://arxiv.org/abs/2604.05471) <a id="link33"></a>
...
**Comment:** This paper analyzes radio galaxy jet morphologies and their evolution using 3D RMHD simulations. The focus is on extragalactic jets and radio galaxies, not on galaxy simulations of star formation, dwarf galaxies, or outflows. The relevance is low as it does not match the core topics.
...
## 34. [Diagnostic Consistency Tests of the Concordance Cosmology](https://arxiv.org/abs/2604.05836) <a id="link34"></a>
...
**Comment:** This paper focuses on large-scale cosmological tests and the FLRW metric, which is outside the scope of near-field cosmology and does not address dwarf galaxies, resolved star formation histories, or galaxy simulations. No direct match to any criteria.
...
## 35. [A generic $\omega_b$ tension in early-time solutions to the Hubble tension](https://arxiv.org/abs/2604.05095) <a id="link35"></a>
...
**Comment:** This paper discusses cosmological tensions related to the Hubble constant and baryon density, focusing on early-time solutions and BBN constraints. It does not address galaxy-scale phenomena, dwarf galaxies, or star formation.
...
## 36. [Multi-Quark Clustering in Neutron-Star Matter from Color-Spin Molecular Dynamics](https://arxiv.org/abs/2604.05472) <a id="link36"></a>
...
**Comment:** The paper studies the equation of state of neutron-star matter using color-spin molecular dynamics, focusing on quark clustering and neutron-star radii. It does not address galaxy-scale phenomena, star formation, or dwarf galaxies.
...
## 37. [Unveiling axion signals in galactic supernovae with future MeV telescopes](https://arxiv.org/abs/2604.05817) <a id="link37"></a>
...
**Comment:** This paper focuses on axion-like particle signals from Galactic supernovae and their detectability with future MeV telescopes. While it discusses dark matter candidates and Galactic core-collapse supernovae, it does not directly address near-field cosmology, satellite galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM. The focus is on particle astrophysics and detection methods, not the structure or evolution of galaxies or their satellites.
...
## 38. [Kinetic magnetohydrodynamics and Landau fluid closure in relativity](https://arxiv.org/abs/2604.05058) <a id="link38"></a>
...
**Comment:** This paper presents a theoretical framework for weakly collisional plasmas in relativistic accretion flows near supermassive black holes, introducing a new Landau fluid closure. The focus is on plasma physics and black hole accretion disks, which are outside the core topics (e.g., galaxy simulations, stellar models, near-field cosmology).
...
## 39. [High-contrast imaging of Galactic Cepheids with VLT/SPHERE](https://arxiv.org/abs/2604.05287) <a id="link39"></a>
...
**Comment:** The paper is an observational study of Cepheid binaries using high-contrast imaging. While it involves stellar evolution and binary fraction, it does not present new stellar models or address resolved star formation histories, quenching, or galaxy simulations. The focus is on intermediate-mass stars and binary companions, not dwarf galaxies or near-field cosmology.
...
## 40. [Investigating ACS/WFC Amp-to-Amp Sensitivities](https://arxiv.org/abs/2604.06108) <a id="link40"></a>
...
**Comment:** The paper investigates photometric calibration and sensitivity variations in the ACS/WFC detector, relevant to observational methodology but not directly to stellar models, galaxy simulations, or star formation histories.
...
## 41. [The neighboring stars of N6946-BH1 and the observational characteristics of failed supernovae](https://arxiv.org/abs/2604.05019) <a id="link41"></a>
...
**Comment:** The paper analyzes the remnant emission and stellar neighbors of a failed supernova candidate, comparing properties with stellar mergers. While it involves stellar evolution and collapse, it does not present new stellar models or address resolved star formation histories, quenching, or galaxy simulations. Irrelevant to the core topics.
...
## 42. [The Cohesive Object Sequence: The Mass-Density Distribution of Astronomical Objects from Asteroids to Stars](https://arxiv.org/abs/2604.06029) <a id="link42"></a>
...
**Comment:** The paper discusses mass-density distributions across astronomical objects, but does not focus on galaxies, stellar models, or any of the core topics. It is more of a broad overview.
...
## 43. [Hunting Dark Matter with the Einstein Telescope](https://arxiv.org/abs/2604.06082) <a id="link43"></a>
...
**Comment:** This paper discusses the possibility of dark matter being composed of primordial black holes and the resulting gravitational wave background. While it touches on dark matter, it does not address near-field cosmology, galaxy simulations, or any of the other core topics directly.
...
## 44. [A New Method for Testing Einstein's Theory of Gravity Close to Rapidly Spinning Black Holes](https://arxiv.org/abs/2604.05085) <a id="link44"></a>
...
**Comment:** Proposes a new method for testing gravity near rapidly spinning black holes, focusing on X-ray binaries and frame dragging. Not related to galaxy evolution, star formation, or near-field cosmology.
...
## 45. [Approximating the Fourier Transform of Ring-Like Images: the Focal Expansion](https://arxiv.org/abs/2604.05199) <a id="link45"></a>
...
**Comment:** Presents a new method for approximating Fourier transforms of ring-like images, with application to black hole photon rings. Not related to galaxy evolution, star formation, or near-field cosmology.
...
## 46. [Testing parity with composite-field spectra of BOSS and DESI luminous red galaxies](https://arxiv.org/abs/2604.06021) <a id="link46"></a>
...
**Comment:** Does not match any core criteria. Focuses on parity violation in cosmological galaxy surveys, not on dwarf galaxies, star formation histories, or outflows.
...
## 47. [SN2023ixf: Radiative-transfer modeling of the photospheric phase evolution from the ultraviolet to the infrared](https://arxiv.org/abs/2604.05145) <a id="link47"></a>
...
**Comment:** Does not match any core criteria. Focuses on radiative transfer modeling of a supernova, not on galaxy evolution, star formation histories, or stellar models.
...
## 48. [Strontium and helium in the kilonova AT2017gfo: Origin of the 1{\mu}m feature constrained via NLTE calculations](https://arxiv.org/abs/2604.05812) <a id="link48"></a>
...
**Comment:** Does not match any core criteria. Focuses on kilonova spectral modeling and nucleosynthesis, not on galaxy evolution, star formation, or stellar models.
...
## 49. [Explaining Neural Networks on the Sky: Machine Learning Interpretability for Cosmic Microwave Background Maps](https://arxiv.org/abs/2604.05290) <a id="link49"></a>
...
**Comment:** This paper uses machine learning to classify cosmological models from CMB maps. It is focused on cosmological model selection and interpretability, not on near-field cosmology, resolved star formation histories, or galaxy simulations. No direct relevance to the core topics.
...
## 50. [Twisted doughnuts: Thick disk torus around equatorial asymmetric black hole](https://arxiv.org/abs/2604.05604) <a id="link50"></a>
...
**Comment:** This paper studies thick disk tori around asymmetric black holes, focusing on accretion disk structure and general relativity. It does not address galaxy-scale phenomena, star formation, or dwarf galaxies.
...
## 51. [The JWST Search for Earth-Luna Analogs: Upper Limits on Exomoons and Refined Ephemerides for TOI 700 d and e](https://arxiv.org/abs/2604.05235) <a id="link51"></a>
...
**Comment:** The paper describes a JWST search for exomoons around M-dwarf planets, refining ephemerides and discussing noise sources. It does not address galaxy-scale phenomena, star formation histories, or dwarf galaxy properties.
...
## 52. [Non-LTE Ionization Modeling for Helium and Strontium in Neutron Star Merger Ejecta](https://arxiv.org/abs/2604.05703) <a id="link52"></a>
...
**Comment:** This paper models ionization in neutron star merger ejecta, focusing on kilonova spectra and nucleosynthesis. It is not related to any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models for normal stars, galaxy simulations, or outflows.
...
## 53. [Remnant recoil and host environments of GWTC-4.0 binary black-hole mergers](https://arxiv.org/abs/2604.05492) <a id="link53"></a>
...
**Comment:** The paper analyzes GWTC-4.0 binary black hole mergers, their recoil velocities, and host environments. It focuses on black hole mergers and their retention in clusters, not on galaxy evolution, star formation, or any of the core topics.
...
## 54. [Reconstruction of fast-rotating neutron star observables with the neural network](https://arxiv.org/abs/2604.05428) <a id="link54"></a>
...
**Comment:** This paper develops neural network models for reconstructing neutron star observables. It is focused on compact objects and not galaxies, stellar models, or any of the core topics.
...
## 55. [Instrumental development for Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](https://arxiv.org/abs/2604.05801) <a id="link55"></a>
...
**Comment:** Instrumental development for gravitational wave detection, focused on IMBH binaries. No connection to galaxy simulations, stellar models, or any of the core topics.
...
## 56. [Implications of low neutron star merger rates for gamma-ray bursts, r-process production and Galactic double neutron stars](https://arxiv.org/abs/2604.05059) <a id="link56"></a>
...
**Comment:** This paper discusses neutron star merger rates and their implications for gamma-ray bursts, r-process production, and Galactic double neutron stars. It does not focus on galaxies, stellar models, or any of the core topics.
...
## 57. [Gravitational Waves from Matter Perturbations of Spectator Scalar Fields](https://arxiv.org/abs/2604.05078) <a id="link57"></a>
...
**Comment:** This paper presents theoretical work on gravitational waves from scalar field perturbations during reheating, focusing on early universe physics and inflationary models. It does not address any of the core topics such as near-field cosmology, galaxy simulations, star formation histories, quenching, or CGM. The relevance is low as it is outside the main research interests.
...
## 58. [Electromagnetic Flares from Compact-Object Mergers in AGN Disks: Signatures and Predictions](https://arxiv.org/abs/2604.05020) <a id="link58"></a>
...
**Comment:** The paper discusses electromagnetic flares from compact-object mergers in AGN disks, focusing on post-merger jet emission and its detectability. While it is astrophysical in nature, it does not address any of the core criteria such as dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, or CGM. The focus is on AGN disks and compact-object mergers, which are outside the relevant topics.
...
## 59. [Orbital inclination estimates for overcontact binaries using the derivatives of light curves](https://arxiv.org/abs/2604.06006) <a id="link59"></a>
...
**Comment:** Presents a new method for estimating orbital inclination in overcontact binaries using light curve derivatives. Focus is on binary star systems, not stellar models or galaxy evolution.
...
## 60. [Massive Exchange and the Sign of the Equilateral Bispectrum](https://arxiv.org/abs/2604.06145) <a id="link60"></a>
...
**Comment:** Studies the inflationary bispectrum from massive scalar exchange during inflation, focusing on primordial non-Gaussianity. No direct connection to galaxy evolution, near-field cosmology, or star formation.
...
## 61. [Local primordial non-Gaussianity using cross-correlations of DESI tracers](https://arxiv.org/abs/2604.05213) <a id="link61"></a>
...
**Comment:** Constrains local primordial non-Gaussianity using cross-correlations of DESI tracers. Focus is on cosmological parameters and large-scale structure, not galaxy evolution or near-field cosmology.
...
## 62. [Searching for Contact Binaries with LAMOST and TESS](https://arxiv.org/abs/2604.05487) <a id="link62"></a>
...
**Comment:** Does not match any core criteria. Focuses on contact binaries and stellar population statistics, not on stellar models, galaxy simulations, or dwarf galaxy properties.
...
## 63. [Accurate polarization calibration of FAST spectral data for measurements of Zeeman splittings of OH megamasers in IRAS 02524+2046](https://arxiv.org/abs/2604.05392) <a id="link63"></a>
...
**Comment:** Irrelevant to core criteria. Focuses on polarization calibration and Zeeman splitting in OH megamasers in a high-mass galaxy, not on dwarf galaxies or relevant stellar models.
...
## 64. [Probing the Evolution of Dark Energy: A Joint Analysis of DESI DR2, Pantheon+, and Cosmic Chronometers](https://arxiv.org/abs/2604.05849) <a id="link64"></a>
...
**Comment:** This paper analyzes dark energy parameterizations using cosmological datasets. It is focused on cosmological model fitting and dark energy evolution, not on galaxy simulations, near-field cosmology, or stellar models.
...
## 65. [Forward analytical model for the optical selection bias on galaxy cluster lensing profiles](https://arxiv.org/abs/2604.05833) <a id="link65"></a>
...
**Comment:** This paper presents an analytical model for optical selection bias in galaxy cluster lensing profiles. It focuses on cluster cosmology and selection effects, not on dwarf galaxies, satellites, star formation histories, or galaxy simulations. Irrelevant to the core topics.
...
## 66. [Wide Jets or Low Rates: Reconciling Short GRB and Gravitational-Wave Neutron Star Merger Rates](https://arxiv.org/abs/2604.05046) <a id="link66"></a>
...
**Comment:** This paper compares short GRB and GW neutron star merger rates, focusing on jet opening angles and merger populations. It is not related to galaxy evolution, star formation, or any of the core topics.
...
## 67. [Spectroscopic confirmation of dual and offset quasars from the Subaru HSC-SSP program](https://arxiv.org/abs/2604.06059) <a id="link67"></a>

**ArXiv ID:** 2604.06059

**Authors:** Shenli Tang, John Silverman, Xavier Prochaska, Manda Banerji, Xuheng Ding, Masafusa Onoue, Knud Jahnke

**Abstract:** We present a spectroscopic follow-up program targeting closely-separated dual quasar candidates selected from imaging of SDSS quasars with the Subaru Hyper Suprime-Cam Subaru Strategic Program (HSC-SSP). Using two-dimensional image decomposition, our selection identifies PSF-like companions within 0.6-4 arcsec separation (< 30 kpc) around the SDSS quasar. We newly confirm six broad-line dual quasars and eleven offset quasars (quasar-galaxy pairs), spanning 1.5 < z < 3.3 for the duals and predominantly z  1.5, the confirmed duals exhibit high black hole mass ($M_{\rm BH}$ $=10^{8.5}$-$10^{10} M_{\odot}$) with high bolometric luminosities ($L_{bol}$ $=10^{45.5}$-$10^{47.5}$ erg s$^{-1}$), yet accrete at moderate Eddington ratios ($\lambda_{\rm Edd}=$0.01-0.4). From the spectroscopically-confirmed samples, we estimate the dual fraction of SDSS quasars with separations of 0.6-4 arcsec to be 0.2%-1.2% at z<0.8, 0.08%-0.24% at 0.8<1.5, and 0.06% at 1.5<3.3. These values are broadly consistent with other recent optical studies, but lower than theoretical expectations of a rising dual fraction at cosmic noon. However, we note that these fractions, especially at high $z$, still need a more accurate assessment of selection and observation effects.

**Comment:** The focus is on dual and offset quasars, which are supermassive black hole systems in massive galaxies. No direct connection to any of the relevant criteria (dwarf galaxies, near-field cosmology, star formation histories, etc.).
...
## 68. [Developing Pre-Supernova Neutrino Support for sntools](https://arxiv.org/abs/2604.05894) <a id="link68"></a>
...
**Comment:** This paper is about pre-supernova neutrino modeling and event generation, which is not directly related to any of the core topics (galaxy evolution, stellar models, etc.).
...
## 69. [Revisiting The Gravitational Mirroring In Presence of Compact Objects](https://arxiv.org/abs/2604.05009) <a id="link69"></a>
...
**Comment:** The paper discusses gravitational mirroring near compact objects, which is not related to any of the core topics (galaxy evolution, stellar models, etc.).
...
## 70. [Valence and Rydberg excited state bond dissociation curves of CO2 from orbital-optimized density functional calculations](https://arxiv.org/abs/2604.05802) <a id="link70"></a>
...
**Comment:** This paper presents orbital-optimized density functional calculations for excited states of CO2. It is focused on molecular physics and computational chemistry, not on galaxy simulations, stellar models, or near-field cosmology.
...
## 71. [Cosmological collider signals of modular spontaneous CP breaking](https://arxiv.org/abs/2604.05548) <a id="link71"></a>
...
**Comment:** This paper discusses modular spontaneous CP breaking in the context of cosmological collider signals. It is a theoretical particle physics/cosmology paper and does not address any of the core topics.
...
## 72. [The NANOGrav 15 yr and 20 yr Datasets: Timing Events and Pulse Shape Changes](https://arxiv.org/abs/2604.05453) <a id="link72"></a>
...
**Comment:** This paper analyzes pulse shape changes and timing events in pulsars using NANOGrav datasets. The focus is on pulsar timing and pulse morphology, which does not match any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM. The work is relevant to pulsar astrophysics and gravitational wave detection, but not to the specified topics.
...
## 73. [Detectability of continuous gravitational waves from planetary-mass companions orbiting compact stars](https://arxiv.org/abs/2604.05425) <a id="link73"></a>
...
**Comment:** This paper studies the detectability of continuous gravitational waves from planetary-mass companions orbiting compact stars (pulsars and white dwarfs). The focus is on GW signals and binary systems, not on galaxy structure, evolution, or any of the specified criteria (near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM).
...
## 74. [Constraints on the Injection of Radiation in the Early Universe](https://arxiv.org/abs/2604.05282) <a id="link74"></a>
...
**Comment:** The paper discusses constraints on radiation injection in the early universe, focusing on cosmological parameters and epochs between BBN and recombination. No direct connection to near-field cosmology, galaxy simulations, or star formation histories.
...
## 75. [Modeling complex plasma instabilities in space plasmas - Three-component electron formalism of heat-flux instabilities](https://arxiv.org/abs/2604.05729) <a id="link75"></a>
...
**Comment:** This paper models plasma instabilities in space plasmas, focusing on electron heat-flux instabilities. It does not match any of the core criteria related to galaxies, star formation, or near-field cosmology.
...
## 76. [Noise budget of Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](https://arxiv.org/abs/2604.05840) <a id="link76"></a>
...
**Comment:** Irrelevant to core criteria. Focuses on gravitational wave detector design and noise budget, not on galaxy evolution, star formation, or stellar models.
...
## 77. [On the observational distinguishability of the Kerr and Kerr-Hayward metrics to EHT](https://arxiv.org/abs/2604.06128) <a id="link77"></a>
...
**Comment:** This paper compares the Kerr and Kerr-Hayward metrics for black hole imaging with EHT. It is focused on black hole metrics and GRMHD simulations, not galaxy simulations or stellar models. No relevance to the core topics.
...
## 78. [$\xi R\phi^2$ non-minimal coupling, and the long range gravitational potential for different spin fields from 2-2 scattering amplitudes](https://arxiv.org/abs/2604.06062) <a id="link78"></a>
...
**Comment:** The paper investigates quantum gravity effects of non-minimal scalar-curvature coupling, focusing on gravitational potentials for different spin fields. It is purely theoretical and not related to galaxy evolution, star formation, or any of the core topics.
...
## 79. [Gas Giants Formed by Gravitational Instability May Accrete Atmospheres with Super-Stellar Carbon to Oxygen Ratios](https://arxiv.org/abs/2604.05178) <a id="link79"></a>
...
**Comment:** The paper models gas giant formation via gravitational instability and discusses exoplanet atmospheric C/O ratios. It is focused on planet formation and exoplanet atmospheres, not galaxies, star formation, or any of the core topics.
...
## 80. [Posterior Predictive Checks for Gravitational-wave Populations: Limitations and Improvements](https://arxiv.org/abs/2604.06090) <a id="link80"></a>
...
**Comment:** This paper discusses statistical model checks for GW populations, focusing on spin distributions in binary black holes. It is not related to galaxy evolution, star formation, or any of the core topics.
...
## 81. [Geomagnetic storm suppression of photographic plate transient detections in the POSS-I archive: an independent physical variable strengthening the nuclear test correlation](https://arxiv.org/abs/2604.04950) <a id="link81"></a>
...
**Comment:** This paper investigates the correlation between geomagnetic storms, nuclear tests, and transient detections in the POSS-I photographic plate archive. The focus is on transient detection rates and environmental effects, not on galaxy structure, evolution, or any of the specified criteria (near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM).
...
## 82. [Photon-Count Statistics of Crab X-ray Pulses: Skellam Behavior and Excess Variance in the Main Pulse](https://arxiv.org/abs/2604.05050) <a id="link82"></a>
...
**Comment:** This paper analyzes photon-count statistics of Crab X-ray pulses, focusing on statistical models for pulsar emission. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM. The focus is on pulsar emission and photon-counting statistics, which are unrelated to the specified topics.
...
## 83. [Scientific Validation of the SPARC4 Pipeline: Multi-band Imaging, Polarimetry, and Photometric Time Series for Improved Characterization of Transiting Exoplanets](https://arxiv.org/abs/2604.05305) <a id="link83"></a>
...
**Comment:** Irrelevant to core criteria. Focuses on exoplanet transit observations and instrument pipeline validation, not on galaxy evolution, star formation, or stellar models.
...
## 84. [Testing X-ray Periodicity and Long-Term Trend in PG 1553+113 via Targeted Swift-XRT Monitoring](https://arxiv.org/abs/2604.05905) <a id="link84"></a>
...
**Comment:** This paper studies X-ray periodicity in a blazar, with implications for supermassive black hole binaries. It is focused on AGN variability and not on galaxy simulations, near-field cosmology, or stellar models.
...
## 85. [Extreme Blazars Observed with MAGIC: Second Catalog Release](https://arxiv.org/abs/2604.05576) <a id="link85"></a>
...
**Comment:** This paper focuses on extreme blazars, which are high-energy extragalactic sources. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM. The focus is on blazar catalogs and their emission properties, which are unrelated to the specified topics.
...
## 86. [Statistics of blob properties in two types of coronal streamers](https://arxiv.org/abs/2604.05295) <a id="link86"></a>
...
**Comment:** Statistical analysis of coronal streamer blobs in the solar corona, unrelated to galaxy evolution, star formation, or near-field cosmology.
...
## 87. [Comments on "The impact of Solar magnetic field configurations on the production of gamma rays at the Solar disk'' (arXiv:2512.01403)](https://arxiv.org/abs/2604.05879) <a id="link87"></a>
...
**Comment:** Irrelevant to core criteria. Focuses on solar gamma-ray production and cosmic-ray interactions, not on galaxy evolution, star formation, or stellar models.
