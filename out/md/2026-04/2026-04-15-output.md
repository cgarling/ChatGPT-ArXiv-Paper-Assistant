...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 50291    | 8030         | 58321   |
| **Cost**             | $0.1     | $0.06        | $0.16   |

Total arXiv papers: 186

Total scanned papers: 126

Total relevant papers: 91

**Table of contents with paper titles:**

1. [Intense and extended CIII] emission suggests a strong outflow in JADES-GS-z14-0](#user-content-link1)
**Authors:** Stefano Carniani, Peter Jakobsen, Giacomo Venturi, Francesco D'Eugenio, Tobias J. Looser, Joris Witstok, Christopher N. A. Willmer, Andrea Ferrara, Zihao Wu, Santiago Arribas, Andrew J. Bunker, St\'ephane Charlot, Jacopo Chevallard, Mirko Curti, Emma Curtis-Lake, Daniel J. Eisenstein, Kevin Hainline, Jakob M. Helton, Zhiyuan Ji, Xihan Ji, Benjamin D. Johnson, Mahsa Kohandel, Nimisha Kumari, Roberto Maiolino, Andrea Pallottini, Eleonora Parlanti, Pablo G. P\'erez-Gonz\'alez, Marcia Rieke, Pierluigi Rinaldi, Brant Robertson, Jan Scholtz, Sandro Tacchella, Hannah \"Ubler, Chris Willot

2. [On the possibility of chemically driven convection in red giants. Implications for the He-core flash and mixing above the Red Giant Branch Bump](#user-content-link2)
**Authors:** M. Miguel Ocampo, Marcelo M. Miller Bertolami

3. [Probing Collapsed Dark Matter Halos with Fast Radio Bursts](#user-content-link3)
**Authors:** Yuxuan He, Weiyang Wang, Chen Zhang, Yi-Ming Zhong

4. [No Country for Old Stars -Spectroscopic confirmation of the first intermediate-age RR Lyrae in the open cluster Trumpler 5](#user-content-link4)
...
5. [The $R$-Process Alliance: Actinide Abundances, Variation, and Evolution in Metal-Poor Stars](#user-content-link5)
...
6. [Distinct First-to-Second Peak Yield Ratios and Timescales Reveal a Sub-dominant Prompt Channel](#user-content-link6)
**Authors:** Yossef Zenati, Paz Beniamini, Kenta Hotokezaka

7. [Hot blue progenitors of stellar-mass black holes](#user-content-link7)
**Authors:** Avishai Gilkis, Eva Laplace, Maria Drout, Charles Kilpatrick, Anna O'Grady, Christopher Tout

8. [Phlegethon: a fully compressible magnetohydrodynamic code for simulations in stellar astrophysics](#user-content-link8)
**Authors:** G. Leidi, A. Holas, K. Vitovsky, F. Rizzuti, A. Roy, J. Reichert, K. Bayer, D. Gagnier, R. Andrassy, P. Christians, P. V. F. Edelmann, V. Varma, R. Hirschi, F. K. R\"opke

9. [Dark Matter's influence on Evolution of MBHB in Dwarf Galaxies: A Case Study of Leo I dSph](#user-content-link9)
**Authors:** Muhammad Junaid, Fazeel Mahmood Khan

10. [JWST Observations of Starbursts: Dust Processing in the M82 Superwind](#user-content-link10)
...
11. [A Post-starburst Galaxy Undergoing Ram-pressure Stripping at Redshift 3.06](#user-content-link11)
...
12. [Reconstructing chemical enrichment pathways in disc galaxies: A phylogenetic approach](#user-content-link12)
**Authors:** Brian Tapia-Contreras, Patricia B. Tissera, Emanuel Sillero, Paula Jofr\'e, Keaghan Yaxley, Xia Hua, Robert M. Yates, \'Alvaro M\'arquez S., Theosamuele Signor, Payel Das, \'Alvaro Rojas-Arriagada, Claudia Aguilera-G\'omez, Francisco Jara-Ferreira, Robert A. Foley

13. [Deriving volume density profiles of filaments from observed surface densities](#user-content-link13)
**Authors:** Alexander Men'shchikov, Guo-Yin Zhang

14. [The role of small-scale environments in the quenching of massive galaxies at $1<z<5$](#user-content-link14)
...
15. [The $\mu$ Herculis system solved after nearly three centuries](#user-content-link15)
**Authors:** Marcus L. Marcussen, Mikkel N. Lund, Frank Grundahl, Daniel Huber, Emil Knudstrup, Adam L. Kraus, Christoph Baranec, Pere L. Pall\'e, Trent J. Dupuy, Guillaume Huber, James Ou, Zach Werber, Ruihan Zhang, Reed Riddle

16. [Beyond the Diffusion Coefficient: Propagators and Memory in Cosmic Ray Transport](#user-content-link16)
**Authors:** Naixin Liang, S. Peng Oh

17. [Illuminating the Local Universe: Large-Scale Structure from ZTF Type Ia Supernovae](#user-content-link17)
...
18. [Beyond the Standard Model of Cosmology: Testing new paradigms with a Multiprobe Exploration of the Dark Universe](#user-content-link18)
**Authors:** Juan Garcia-Bellido

19. [Hybrid Simulations of Supersonic Shear Flows: II) Cosmic Ray Viscosity](#user-content-link19)
**Authors:** Naixin Liang, Damiano Caprioli

20. [Infrared Spectral Gap in a Gluonic Dark Sector as the Origin of the Galactic Acceleration Scale](#user-content-link20)
**Authors:** Gilles Cohen-Tannoudji, Jean-Pierre Gazeau, Hamed Pejhan, Jean-Pierre Treuil

21. [Inspecting Cloudy Substellar Atmospheres with JWST MIRI Synthetic Magnitudes from Spitzer Mid-infrared Spectra](#user-content-link21)
**Authors:** Jolie LHeureux (Department of Physics, Graduate Center, City University of New York, New York, USA, Department of Astronomy, Columbia University, New York, USA), Genaro Su\'arez (Department of Astrophysics, American Museum of Natural History, New York, USA), Johanna M. Vos (School of Physics, Trinity College Dublin, Dublin, Ireland), Stanimir Metchev (Department of Physics and Astronomy, Western University, London, Canada, Institute for Earth and Space Exploration, Western University, London, Canada), Jacqueline K. Faherty (Department of Astrophysics, American Museum of Natural History, New York, USA), Sherelyn Alejandro Merchan (Department of Physics, Graduate Center, City University of New York, New York, USA, Department of Astrophysics, American Museum of Natural History, New York, USA), Kelle L. Cruz (Department of Physics, Graduate Center, City University of New York, New York, USA, Department of Physics and Astronomy, Hunter College, City University of New York, New York, USA)

22. [Consistency of the dark matter halo perturbation parameter from morphological and kinematic lopsidedness of galaxies](#user-content-link22)
**Authors:** Prerana Biswas, Narendra Nath Patra, Veselina Kalinova

23. [Metal enrichment in the galaxy group IC 1262](#user-content-link23)
**Authors:** Satish S. Sonkamble, Dharam V. Lal, S. Ilani Loubser, Mahadev B. Pandge

24. [Multiwavelength Study of Blue Straggler Stars in Tombaugh 2: Evidence for Binary Mass Transfer and Constraints on Cluster Dynamical State](#user-content-link24)
**Authors:** D. Bisht, Ing-Guey Jiang, K. Belwal, D. C. C{\i}nar, Arvind K. Dattatrey, Geeta Rangwal, A. Raj, Shraddha Biswas, Mohit Singh Bisht, Alok Durgapal

25. [Acoustic instability at shock-wave precursors](#user-content-link25)
**Authors:** Antonio Capanema, Pasquale Blasi, Emanuele Sobacchi

26. [A Deep ALMA Survey of the Redshift Distribution of Dusty Star-forming Galaxies](#user-content-link26)
**Authors:** S. J. McKay, A. J. Barger, L. L. Cowie, F. E. Bauer

27. [Introducing $\Delta V_{\star-g}$: a new universal kinematic disturbance parameter](#user-content-link27)
**Authors:** Jonah M. Powley, Rebecca J. Smethurst, Chris J. Lintott, Tobias G\'eron

28. [Effective field theory of a single scalar pion field for large scale structure in the Universe](#user-content-link28)
**Authors:** Lara Celik, Bart Horn, Bhavya Mishra, David Muqattash

29. [High-energy Processes in the Bubbles of Wolf-Rayet Stars: The case of WR 102](#user-content-link29)
**Authors:** L. Espinosa, M. V. del Valle

30. [The undetectable fraction of core-collapse supernovae in luminous infrared galaxies -- II. GSAOI/GeMS dataset](#user-content-link30)
**Authors:** I. M\"antynen, E. Kankare, S. Mattila, A. Efstathiou, S. D. Ryder, E. Kool, K. Matilainen, T. M. Reynolds, C. Vassallo, P. V\"ais\"anen

31. [The exponential growth of infinitesimal perturbations in the long-term evolution of simulated galaxies](#user-content-link31)
**Authors:** T. Asano, S. Portegies Zwart

32. [Interaction-powered Type Ibn Supernovae as a Transient PeVatron Candidate: The Case of SN 2023uqf](#user-content-link32)
**Authors:** Ryo Sawada, Yusuke Inoue, Yosuke Ashida

33. [The role of accretion efficiency, natal kicks, and angular momentum transport in the formation of the Gaia black holes](#user-content-link33)
**Authors:** Michela Mapelli, Cecilia Sgalletta, Johanna M\"uller-Horn, Giuliano Iorio, Stefano Rinaldi, Christian Burt, Daniel Mar\'in Pina, Amedeo Romagnolo

34. [A Forward, Analytic, Differentiable, Geometric (But Inflexible) Lens Model](#user-content-link34)
**Authors:** Paul L. Schechter

35. [Evidence for a bloated massive protostar in IRAS20126+4104](#user-content-link35)
**Authors:** Riccardo Cesaroni

36. [Primordial Black Holes Formation Beyond the Standard Cosmic QCD Transition](#user-content-link36)
**Authors:** Ma\"el Gonin, Oleksii Ivanytskyi, David Blaschke, G\"unther Hasinger

37. [Spatially Resolved Kinematics of SLACS Lens Galaxies. II: Breaking Degeneracies with Lensing and Dynamical Models](#user-content-link37)
**Authors:** Shawn Knabel, Tommaso Treu, Michele Cappellari, Simon Birrer, Xiang-Yu Huang, Anowar J. Shajib, William Sheu

38. [M1-92: AGB interruption and isotopic ratio paradox. Chemistry and morpho-kinematics from improved shapemol modelling](#user-content-link38)
**Authors:** E. Masa, J. Alcolea, M. Santander-Garc\'ia, V. Bujarrabal, C. S\'anchez Contreras, A. Castro-Carrizo, W. Steffen, N. Koning

39. [Enhancing Ly{\alpha} Emitter Identification in HETDEX with a Convolutional Neural Network](#user-content-link39)
**Authors:** Shiro Mukae, Erin Mentuch Cooper, Karl Gebhardt, Dustin Davis, Lindsay R. House, Mahdi Qezlou, Julian B. Mu\~noz, Shun Saito, Daniel J. Farrow, Caryl Gronwall, Donald P. Schneider, Eric Gawiser

40. [Variability classification of TESS targets in LOPS2, the first long-term pointing field of PLATO. Version 1 of the public variability catalogue](#user-content-link40)
**Authors:** Mykyta Kliapets, Pablo Huijse, Jeroen Audenaert, Andrew Tkachenko, Marek Skarka, Paul F. X. Gregory, Dominic M. Bowman, Simon J. Murphy, Poojan Agrawal, J\'ozsef M. Benk\H{o}, Hannah Brinkman, Nicholas Jannsen, Yoshi Nike Emilia Eschen, Allison Eto, Dario J. Fritzewski, Alex Kemp, Viktor Khalack, Gang Li, Ricardo Ochoa-Armenta, In\^es Rolo, Nena Scheller, Rose S. Stanley, Keegan Thomson-Paressant, Emese Plachy, Vincent Vanlaer, Mathijs Vanrespaille, Jasmine Vrancken, Haotian Wang, Yian Xia, George R. Ricker, Conny Aerts

41. [KIC 3868420: A high-amplitude $\delta$ Scuti-$\gamma$ Dor hybrid star crossing the Hertzsprung gap](#user-content-link41)
**Authors:** Tao-Zhi Yang (XJTU), Zhao-Yu Zuo (XJTU)

42. [How I Wonder What You Are -- JWST's Little Red Dots do not TWINKLE](#user-content-link42)
...
43. [Post-Newtonian inspiral waveform model for eccentric precessing binaries with higher-order modes and matter effects](#user-content-link43)
**Authors:** Gonzalo Morras, Geraint Pratten, Patricia Schmidt, Alessandra Buonanno

44. [JWST/MIRI Hydrocarbon and Water Absorption in the Wind of a Young Disk: Signatures of Pebble Drift and Carbon Grain Sublimation](#user-content-link44)
**Authors:** Mar\'ia Jos\'e Colmenares, Edwin A. Bergin, Ke Zhang, Geoffrey A. Blake, Klaus M. Pontoppidan, Alexa R. Anderson, John Carr, Emma Dahl, Joan Najita, Jonathan P. Williams, Colette Salyk, Till Kaeufer, Mayank Narang, Ilaria Pascucci, Beno\^it Tabone, Lucas Cieza, Miguel Vioque, Adrien Houge, Sebastiaan Krijt, Aditya M. Arabhavi, Giovanni Rosotti, John Carpenter, Feng Long, Paola Pinilla, Jayatee Kanwar, Eshan Raul, Karina Mauco, James Miley, Abygail Waggoner, the JDISCS collaboration

45. [Unveiling Dominant Toroidal Magnetic Fields in a Protostellar Outflow](#user-content-link45)
...
46. [Finite temperature effects on g-modes of inviscid neutron stars](#user-content-link46)
**Authors:** David Morales-Zapien, Prashanth Jaikumar, Thomas Kl\"ahn

47. [Model-Independent Analysis of Type Ia Supernova Datasets and Implications for Dark Energy](#user-content-link47)
**Authors:** Zhenyuan Wang, Yun Wang

48. [Identifying Changing-Look AGN Transitions in Light Curve Data with the Zwicky Transient Facility](#user-content-link48)
...
49. [Obscured at the Core: Evidence for Nuclear Dust in Reddened Type-1 AGN](#user-content-link49)
**Authors:** Miguel A. Montalvo Hernandez, Andy D. Goulding, Jenny E. Greene

50. [Spectral index evolution of the limb-brightened jet in 3C 84](#user-content-link50)
...
51. [Relativistic Effects on Circumbinary Orbit Stability](#user-content-link51)
**Authors:** Gonzalo C. de El\'ia, Macarena Zanardi, Rebecca G. Martin

52. [Cosmologically viable non-polynomial quasi-topological gravity: explicit models, $\Lambda$CDM limit and observational constraints](#user-content-link52)
**Authors:** Emmanuel N. Saridakis

53. [Disk instability model incorporating a variable inner disk radius in SS Cyg and U Gem](#user-content-link53)
**Authors:** Mariko Kimura, Osaki Yoji

54. [Revisiting the angular size-redshift cosmological test with milliarcsecond radio structures in active galactic nuclei](#user-content-link54)
**Authors:** Mina Ghodsi Yengejeh, Tatiana A. Koryukova, Leonid I. Gurvits, S\'andor Frey, Alexander B. Pushkarev, Alexander V. Plavin, Kenneth I. Kellermann, Andr\'as Kov\'acs

55. [JWST observations of photodissociation regions. IV. Carbonaceous emission band sub-components in NGC 7023 have distinct spatial distributions](#user-content-link55)
**Authors:** D. Van De Putte (Department of Physics & Astronomy, The University of Western Ontario, Space Telescope Science Institute), K. D. Gordon (Space Telescope Science Institute, Sterrenkundig Observatorium, Universiteit Gent), K. Misselt (Steward Observatory, University of Arizona), A. N. Witt (Ritter Astrophysical Research Center, University of Toledo), A. Abergel (Institut d'Astrophysique Spatiale, Universit\'e Paris-Saclay, CNRS), A. Noriega-Crespo (Space Telescope Science Institute), P. Guillard (Sorbonne Universit\'e, CNRS, Institut d'Astrophysique de Paris), M. Zannese (Institut d'Astrophysique Spatiale, Universit\'e Paris-Saclay, CNRS), M. Elyajouri (Space Telescope Science Institute), B. Trahin (Space Telescope Science Institute, Institut d'Astrophysique Spatiale, Universit\'e Paris-Saclay, CNRS), P. Dell'ova (Institut d'Astrophysique Spatiale, Universit\'e Paris-Saclay, CNRS), M. Baes (Sterrenkundig Observatorium, Universiteit Gent), P. Klaassen (United Kingdom Astronomy Technology Centre)

56. [Sensitivities of Black Hole Images from GRMHD Simulations](#user-content-link56)
**Authors:** Pedro Naethe Motta, M\'ario Raia Neto, Cora Prather, Alejandro C\'ardenas-Avenda\~no

57. [Constraints on Coupled Dark Energy in the DESI Era](#user-content-link57)
**Authors:** Adri\`a G\'omez-Valent, Ziyang Zheng, Luca Amendola

58. [Probing Scalar-Tensor-Induced Gravitational Waves in the nHz Band: $\texttt{NANOGrav}$ and SKA](#user-content-link58)
**Authors:** William Iania, Angelo Ricciardone

59. [The Shocking Origin of the Flat $EE/BB$ Ratio](#user-content-link59)
**Authors:** Raphael Flauger, Alexei G. Kritsuk, Guanhao Sun

60. [RAPRAL v1.0: RAdiation Prediction using RAy tracing and Line-by-line methods for hypersonic air flows](#user-content-link60)
**Authors:** Yuzhe Zhang, Qizhen Hong, Xiaoyong Wang, Quanhua Sun

61. [POLARIS: A Sparse Radial Neutrino Telescope Design for the Pacific Ocean](#user-content-link61)
**Authors:** Karolin Hymon (Mark), Alexander Chen (Mark), Meng-Xue (Mark), Tsai (Shane), Wan-Ting Hseu (Shane), Tzu-Hsuan (Shane), Su, Anatoli Fedynitch

62. [FRTSearch: Unified Detection and Parameter Inference of Fast Radio Transients using Instance Segmentation](#user-content-link62)
...
63. [SN 2022riv in RX J2129: Discovery, Spectroscopic Classification, and Microlensing of a Strongly Lensed Type Ia Supernova from JWST and HST Observations](#user-content-link63)
...
64. [Accretion-Mode Transition: The Driver Behind Spectral Changes in Changing-Look AGNs](#user-content-link64)
**Authors:** Pengyuan Han, Huaiyuan Lu, Bing Lyu, Jiancheng Wu, Qingwen Wu

65. [Mapping the emission and spectral properties of the FRI radio galaxy 3C 449 with LOFAR and the VLA](#user-content-link65)
**Authors:** Luca Ricci, Luisa Ostorero, Raffaella Morganti, Judith H. Croston, Martin J. Hardcastle, Timothy W. Shimwell

66. [The spectrum of the persistent radio source associated with FRB 20190417A](#user-content-link66)
**Authors:** L. Bruno, D. Pelliciari, G. Bernardi, M. Pilia, L. Beduzzi, P. Esposito

67. [21 cm Power Spectrum Analysis of North Celestial Pole Observations with the Tianlai Dish Pathfinder Array](#user-content-link67)
...
68. [A sample of short-lived Galactic radio transients from ASKAP VAST](#user-content-link68)
**Authors:** Akash Anumarlapudi, David L. Kaplan, Natasha Hurley Walker, Stella Koch Ocker, Daniel Kelson, Dougal Dobie, Laura Driessen, Tara Murphy, Joshua Pritchard

69. [JOYS: Launching and destruction of dust in protostellar jets. The case of BHR71-IRS1 with JWST/MIRI](#user-content-link69)
**Authors:** {\L}ukasz Tychoniec, Logan Francis, Maria Gabriela Navarro, Jakobus M. Vorster, Ewine F. van Dishoeck, Alessio Caratti o Garatti, Korash Assani, Valentin J. M. Le Gouellec, Beno\^it Tabone, Pamela Klaassen, Adriaan G. M. Janssen, Kay Justtanont, Daniel Harsono, Pooneh Nazari, Simon Reyes, Katerina Slavicinska, Caroline Gieser, Tyler Bourke, Yao-Lun Yang, Brunella Nisini, Teresa Giannini, Henrik Beuther, R. Devaraj, Thomas P. Ray, Nashanty G. C. Brunken, Yuan Chen, Martijn L. van Gelder

70. [Kelvin waves over a differentially rotating spherical shell](#user-content-link70)
**Authors:** T. Boismard, M. Rieutord

71. [Detection and analysis of white-light emission in solar flares through light curve diagnostics](#user-content-link71)
**Authors:** Shuanghong Li, Yongliang Song, Kun Wang, Xianyong Bai, Xiao Yang, Nian Liu, Ziyao Hu

72. [Novel ringdown tests of general relativity with black hole greybody factors](#user-content-link72)
**Authors:** Romeo Felice Rosato, Francesco Crescimbeni, Sophia Yi, Emanuele Berti, Paolo Pani

73. [Impact of the SNe Ia Magnitude Transition at 20 Mpc on Cosmological Parameter Estimation](#user-content-link73)
**Authors:** Leandros Perivolaropoulos, Chrisostomos-Panagiotis Stamou

74. [Astrophysical parameters of LS 437 and the nature of X0726-260](#user-content-link74)
**Authors:** Ignacio Negueruela (Alicante), Sara R. Berlanas (Alicante, IAC), Lee J. Townsend (SAAO), Javier Lorenzo (Alicante), Klaus R\"ubke (Alicante)

75. [A note on Gurzadyan theorem](#user-content-link75)
**Authors:** Christian Carimalo

76. [Intermediate-Mass Mergers: A New Scenario for Several FS CMa Stars](#user-content-link76)
...
77. [OB runaway stars originating in the Vel OB1 association](#user-content-link77)
**Authors:** N. Azatyan, L. Kaper, A. Samsonyan, M. Stoop, D. Andreasyan, J. van den Eijnden, E. Nikoghosyan

78. [Do equation of state parametrizations of dark energy faithfully capture the dynamics of the late universe?](#user-content-link78)
**Authors:** \"Ozg\"ur Akarsu, Maria Caruana, Konstantinos F. Dialektopoulos, Luis A. Escamilla, Emre O. Kahya, Jackson Levi Said

79. [Not too close! Evaluating the impact of the baseline on the localization of binary black holes by next-generation gravitational-wave detectors](#user-content-link79)
**Authors:** Francesco Iacovelli, Luca Reali, Emanuele Berti, Alessandra Corsi, B. S. Sathyaprakash, Digvijay Wadekar

80. [A Search for Hydroacoustic Signals from Bolides](#user-content-link80)
**Authors:** P. Brown, L. McFadden, D. McCormack, M. Adams, D. Vida

81. [An XMM-Newton Analysis of the Supermassive Black Hole Binary Candidate MCG+11--11--032](#user-content-link81)
**Authors:** Yash A. Gursahani, Tingting Liu, Richard Mushotzky, Christopher S. Reynolds, Michael Koss

82. [Self-Lensing Signals in Binary Systems Containing White Dwarfs with Neutron star or Stellar-mass Black hole Companions](#user-content-link82)
**Authors:** Sedighe Sajadian, Man Ho Chan

83. [Graviton Production from Inflaton Condensate: Boltzmann vs Bogoliubov](#user-content-link83)
**Authors:** Chenhuan Wang, Yong Xu, Wenbin Zhao

84. [Gravitational Gertsenshtein-Zeldovich mechanism for the Association between GW190425 and FRB 20190425A](#user-content-link84)
**Authors:** Shao-Qin Wu, Jing-Rui Zhang, Rong-Gen Cai, Bing Zhang, Yun-Long Zhang

85. [A view of the evolution of a CME and the associated wave-trains at high spatial and temporal resolution](#user-content-link85)
**Authors:** G. Russano, Y. De Leo, F. Frassati, G. Jerse, V. Andretta, H. Cremades, M. Temmer, S. Mancuso, L. Abbo, A. Burtovoi, F. Landini, M. Pancrazzi, M. Romoli, C. Sasso, R. Susino, M. Uslenghi

86. [Solar Orbiter observations of solar energetic electron events associated with hard microflares](#user-content-link86)
**Authors:** Diane Mittaine, Andrea Francesco Battaglia, Laura Rodr\'iguez-Garc\'ia, Nils Janitzek, Ra\'ul G\'omez-Herrero, Francisco Espinosa Lara, Louise Harra

87. [Astrophysical Signatures of Einstein-Skyrme Anti-de Sitter Black Holes: Epicyclic Frequencies and QPO Constraints](#user-content-link87)
**Authors:** Faizuddin Ahmed, Ahmad Al-Badawi, \.Izzet Sakall{\i}

88. [In Situ Interferometric Spatial Mapping Of A Microwave Kinetic Inductance Detector Array](#user-content-link88)
**Authors:** Chris Albert, Ritoban Basu Thakur, Farzad Faramarzi, Byeong Ho Eom, Sumit Dahal, Andrew Bear, Reinier Janssen, Henry LeDuc, Thomas Stevenson, Peter Day

89. [Amerigo Vespucci and the discovery of the Southern Sky](#user-content-link89)
**Authors:** Davide Neri

90. [MMS Insights into CME Driven Sub-Alfv\'enic Solar Wind at 1 AU](#user-content-link90)
**Authors:** Harsha Gurram, Li-Jen Chen, Matthew R. Argall, Subash Adhikari, Lynn B. Wilson, Jason R. Shuster, Victoria D. Wilder

91. [Frequency & Radiative Analysis of Random Yagi-UHF/VHF Phased Array](#user-content-link91)
**Authors:** Luis M. Bres, Luis A. Hernandez, Teviet D. Creighton

---

## 1. [Intense and extended CIII] emission suggests a strong outflow in JADES-GS-z14-0](https://arxiv.org/abs/2604.11899) <a id="link1"></a>
...
**Comment:** JWST observations of a high-redshift galaxy with evidence for strong star-formation-driven outflows and mass-loading factor measurement. Directly matches 'Star Formation Driven Outflows' criterion and provides new observational constraints.
...
## 2. [On the possibility of chemically driven convection in red giants. Implications for the He-core flash and mixing above the Red Giant Branch Bump](https://arxiv.org/abs/2604.12117) <a id="link2"></a>
...
**Comment:** This paper presents new theoretical work on chemically driven convection in red giants, with implications for stellar interior mixing and the He-core flash. It directly matches the 'Stellar Models' criterion, as it discusses stellar evolutionary processes and mixing.
...
## 3. [Probing Collapsed Dark Matter Halos with Fast Radio Bursts](https://arxiv.org/abs/2604.12189) <a id="link3"></a>
...
**Comment:** The paper discusses probing collapsed dark matter halos (substructure) using fast radio bursts, focusing on core-collapsed SIDM halos and their density profiles. This is highly relevant to near-field cosmology, especially the core-cusp problem and substructure in dark matter halos, with direct implications for satellite galaxies and small-scale structure.
...
## 4. [No Country for Old Stars -Spectroscopic confirmation of the first intermediate-age RR Lyrae in the open cluster Trumpler 5](https://arxiv.org/abs/2604.11955) <a id="link4"></a>
...
**Comment:** This paper provides spectroscopic confirmation of an intermediate-age RR Lyrae star in an open cluster, challenging canonical stellar evolutionary models. The focus is on stellar models and evolutionary tracks, which matches the 'Stellar Models' criterion. The work is highly relevant for stellar models, especially as it provides constraints on RR Lyrae evolution and abundance patterns.
...
## 5. [The $R$-Process Alliance: Actinide Abundances, Variation, and Evolution in Metal-Poor Stars](https://arxiv.org/abs/2604.12892) <a id="link5"></a>
...
**Comment:** This paper presents actinide abundances in metal-poor stars, with implications for r-process nucleosynthesis and chemical evolution. It is highly relevant to near-field cosmology, as it studies metal-poor stars and the chemical evolution of the Milky Way's stellar halo, directly matching the 'near-field cosmology' criterion.
...
## 6. [Distinct First-to-Second Peak Yield Ratios and Timescales Reveal a Sub-dominant Prompt Channel](https://arxiv.org/abs/2604.11885) <a id="link6"></a>
...
**Comment:** This paper develops a chemical evolution model to explain neutron-capture element abundances in stars, focusing on multiple r-process channels and their timescales. It is highly relevant to near-field cosmology, as it addresses the chemical evolution of the Milky Way's stellar populations and nucleosynthetic signatures.
...
## 7. [Hot blue progenitors of stellar-mass black holes](https://arxiv.org/abs/2604.12868) <a id="link7"></a>
...
**Comment:** Presents new stellar evolutionary and atmosphere models for massive stars, directly matching the 'Stellar Models' criterion. Also provides predictions for observational campaigns, which is highly relevant.
...
## 8. [Phlegethon: a fully compressible magnetohydrodynamic code for simulations in stellar astrophysics](https://arxiv.org/abs/2604.12672) <a id="link8"></a>
...
**Comment:** This paper introduces PHLEGETHON, a new fully compressible MHD code for multidimensional simulations in stellar astrophysics. It presents a new numerical simulation framework for stellar interiors, directly matching the 'stellar models' and 'numerical galaxy simulations' criteria (with emphasis on stellar models).
...
## 9. [Dark Matter's influence on Evolution of MBHB in Dwarf Galaxies: A Case Study of Leo I dSph](https://arxiv.org/abs/2604.12658) <a id="link9"></a>
...
**Comment:** This paper investigates the dynamical evolution of a massive binary black hole in the Leo I dwarf spheroidal galaxy, using high-resolution N-body simulations and examining the influence of dark matter. Directly relevant to near-field cosmology (dwarf galaxy, dark matter profile) and numerical galaxy simulations. Strong match to core topics.
...
## 10. [JWST Observations of Starbursts: Dust Processing in the M82 Superwind](https://arxiv.org/abs/2604.11873) <a id="link10"></a>
...
**Comment:** JWST observations of M82 superwind, analyzing PAH emission and dust processing. Directly matches 'Star Formation Driven Outflows' and 'Circumgalactic Medium' criteria, though M82 is more massive than LMC, so slightly lower relevance. Also discusses mass-loading and feedback.
...
## 11. [A Post-starburst Galaxy Undergoing Ram-pressure Stripping at Redshift 3.06](https://arxiv.org/abs/2604.11892) <a id="link11"></a>
...
**Comment:** This paper discusses star formation quenching via ram-pressure stripping in a post-starburst galaxy at high redshift. While the focus is on a massive galaxy and not a dwarf, the topic of environmental quenching is directly relevant, though weighted lower due to galaxy mass. No direct connection to resolved star formation histories or near-field cosmology.
...
## 12. [Reconstructing chemical enrichment pathways in disc galaxies: A phylogenetic approach](https://arxiv.org/abs/2604.11974) <a id="link12"></a>
...
**Comment:** This paper uses high-resolution galaxy simulations to study chemical enrichment pathways in disc galaxies, focusing on inner and outer regions. While it presents a novel phylogenetic approach to reconstructing star formation and enrichment histories, the focus is on a simulated isolated disc galaxy, not dwarf satellites or resolved star formation histories from observed CMDs. The work is relevant to numerical galaxy simulations and stellar models, but the main focus is on disc galaxies and bar-driven inflows, which are less relevant per the criteria.
...
## 13. [Deriving volume density profiles of filaments from observed surface densities](https://arxiv.org/abs/2604.12570) <a id="link13"></a>
...
**Comment:** This paper presents a new method for deriving volume density profiles of filaments in star-forming clouds from observed surface densities. It is relevant to stellar models and star formation processes, but does not directly address resolved star formation histories, galaxy simulations, or dwarf galaxies.
...
## 15. [The $\mu$ Herculis system solved after nearly three centuries](https://arxiv.org/abs/2604.12492) <a id="link15"></a>
...
**Comment:** This paper presents precise, model-independent dynamical masses for the components of the nearby quadruple system μ Herculis, with implications for asteroseismology and stellar models. While it provides new mass measurements relevant to stellar models, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on galaxy-scale topics such as near-field cosmology, star formation histories, or galaxy simulations. The relevance is moderate due to the connection to stellar models via mass determination.
...
## 16. [Beyond the Diffusion Coefficient: Propagators and Memory in Cosmic Ray Transport](https://arxiv.org/abs/2604.11898) <a id="link16"></a>
...
**Comment:** This paper develops a new framework for cosmic ray transport, including memory effects and multiphase media. While cosmic ray transport is relevant to galaxy simulations and feedback, the focus is on methodology rather than direct application to galaxy-scale outflows or dwarf galaxy environments. Borderline relevance for numerical galaxy simulations if applied to ISM/CGM, but not directly focused on core topics.
...
## 17. [Illuminating the Local Universe: Large-Scale Structure from ZTF Type Ia Supernovae](https://arxiv.org/abs/2604.12714) <a id="link17"></a>
...
**Comment:** The paper uses Type Ia supernovae from ZTF to probe large-scale structure in the local universe, discussing SN rates and their environmental dependence. While it touches on local universe structure, it does not focus on near-field cosmology (dwarf satellites, accreted halo), resolved star formation histories, or galaxy simulations.
...
## 18. [Beyond the Standard Model of Cosmology: Testing new paradigms with a Multiprobe Exploration of the Dark Universe](https://arxiv.org/abs/2604.12020) <a id="link18"></a>
...
**Comment:** This paper proposes new paradigms for dark matter and dark energy, including primordial black holes and entropic acceleration. While it is cosmology-focused, it does not directly address near-field cosmology, satellite galaxies, or resolved star formation histories. The relevance is borderline for near-field cosmology due to discussion of small-scale structure, but the focus is broader.
...
## 19. [Hybrid Simulations of Supersonic Shear Flows: II) Cosmic Ray Viscosity](https://arxiv.org/abs/2604.11901) <a id="link19"></a>
...
**Comment:** This paper studies cosmic ray viscosity in supersonic shear flows using hybrid simulations. While it is a numerical simulation, the focus is on shear layers and cosmic ray dynamics, not galaxy-scale simulations or star-formation-driven outflows. Borderline relevance for numerical galaxy simulations if applied to ISM/CGM, but not directly focused on core topics.
...
## 20. [Infrared Spectral Gap in a Gluonic Dark Sector as the Origin of the Galactic Acceleration Scale](https://arxiv.org/abs/2604.12910) <a id="link20"></a>
...
**Comment:** Proposes a new explanation for the galactic acceleration scale via a gluonic dark sector, which is tangentially related to near-field cosmology and dark matter density profiles, but does not directly address satellite galaxies or resolved star formation histories.
...
## 21. [Inspecting Cloudy Substellar Atmospheres with JWST MIRI Synthetic Magnitudes from Spitzer Mid-infrared Spectra](https://arxiv.org/abs/2604.12132) <a id="link21"></a>
...
**Comment:** The paper examines substellar atmospheres using synthetic JWST MIRI magnitudes, focusing on brown dwarfs and atmospheric modeling. While it involves stellar atmosphere models, it is not presenting new models or evolutionary tracks, but rather testing existing models with new data. Borderline relevance for stellar models.
...
## 22. [Consistency of the dark matter halo perturbation parameter from morphological and kinematic lopsidedness of galaxies](https://arxiv.org/abs/2604.11886) <a id="link22"></a>
...
**Comment:** This paper studies lopsidedness in galaxies and its connection to dark matter halo perturbations using morphological and kinematic analyses. The sample is of nearby galaxies with different morphologies, not specifically dwarf satellites or near-field cosmology. The focus is on disk response to halo potential, which is tangentially related to core-cusp and substructure topics, but not directly. No direct connection to resolved star formation histories, quenching, or outflows.
...
## 23. [Metal enrichment in the galaxy group IC 1262](https://arxiv.org/abs/2604.12608) <a id="link23"></a>
...
**Comment:** This paper analyzes metal enrichment in the galaxy group IC 1262, focusing on metal transport via radio jets, cold fronts, and shocks. The focus is on a galaxy group and metal transport in the intragroup medium, not on dwarf galaxies, near-field cosmology, or resolved star formation histories. The relevance is borderline due to the focus on enrichment and transport processes.
...
## 24. [Multiwavelength Study of Blue Straggler Stars in Tombaugh 2: Evidence for Binary Mass Transfer and Constraints on Cluster Dynamical State](https://arxiv.org/abs/2604.12494) <a id="link24"></a>
...
**Comment:** The paper presents a multiwavelength study of blue straggler stars in an open cluster in the outer Galactic disk, focusing on binary mass transfer and cluster dynamics. While it involves stellar populations and color-magnitude diagrams, the focus is not on resolved star formation histories of galaxies, nor does it address dwarf galaxies or galaxy simulations. The relevance is borderline due to the use of CMDs and stellar models, but the main focus is on cluster dynamics and blue straggler formation.
...
## 25. [Acoustic instability at shock-wave precursors](https://arxiv.org/abs/2604.12514) <a id="link25"></a>
...
**Comment:** The paper presents numerical MHD simulations of acoustic instability at shock-wave precursors, relevant to cosmic-ray acceleration and magnetic field amplification in supernova remnants. While it involves numerical simulations and cosmic-ray physics, it does not focus on galaxy-scale simulations or dwarf galaxies, nor does it address star formation, quenching, or outflows.
...
## 26. [A Deep ALMA Survey of the Redshift Distribution of Dusty Star-forming Galaxies](https://arxiv.org/abs/2604.11879) <a id="link26"></a>
...
**Comment:** This is an observational survey of dusty star-forming galaxies, focusing on redshift distribution and abundance at high redshift. While it discusses galaxy abundance, it is not focused on dwarf galaxies or near-field cosmology, nor does it address resolved star formation histories or quenching.
...
## 27. [Introducing $\Delta V_{\star-g}$: a new universal kinematic disturbance parameter](https://arxiv.org/abs/2604.11905) <a id="link27"></a>
...
**Comment:** This paper introduces a new kinematic disturbance parameter using IFS to quantify differences between stellar and gas velocity maps in galaxies. The initial application is to AGN in MaNGA galaxies. The focus is on kinematic disturbances and AGN, not on dwarf galaxies, near-field cosmology, or resolved star formation histories. The method could be useful for galaxy studies, but is not directly relevant.
...
## 28. [Effective field theory of a single scalar pion field for large scale structure in the Universe](https://arxiv.org/abs/2604.12009) <a id="link28"></a>
...
**Comment:** The paper discusses effective field theory for large scale structure, including N-body simulations, but the focus is on cosmological scales and not on galaxy-scale simulations or properties. While it touches on numerical simulations, it does not address galaxy simulations or any of the other core topics directly.
...
## 29. [High-energy Processes in the Bubbles of Wolf-Rayet Stars: The case of WR 102](https://arxiv.org/abs/2604.12993) <a id="link29"></a>
...
**Comment:** This paper models high-energy processes in the bubbles of Wolf-Rayet stars, focusing on cosmic ray acceleration and non-thermal emission. While it involves stellar feedback and cosmic rays, it does not address galaxy-scale outflows, dwarf galaxies, or galaxy simulations.
...
## 30. [The undetectable fraction of core-collapse supernovae in luminous infrared galaxies -- II. GSAOI/GeMS dataset](https://arxiv.org/abs/2604.12704) <a id="link30"></a>
...
**Comment:** The paper studies the undetectable fraction of core-collapse supernovae in luminous infrared galaxies, focusing on detection limits and extinction. While it discusses supernova rates and galaxy properties, it does not address dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 31. [The exponential growth of infinitesimal perturbations in the long-term evolution of simulated galaxies](https://arxiv.org/abs/2604.12053) <a id="link31"></a>
...
**Comment:** This paper simulates the dynamical evolution of galaxy-scale N-body systems to measure chaos and Lyapunov times, including the formation and evolution of bars. The focus is on numerical galaxy simulations, but specifically on bar formation and evolution, which is listed as irrelevant. The work is relevant to simulation methodology but not to the core topics.
...
## 32. [Interaction-powered Type Ibn Supernovae as a Transient PeVatron Candidate: The Case of SN 2023uqf](https://arxiv.org/abs/2604.12496) <a id="link32"></a>
...
**Comment:** Studies a Type Ibn supernova as a transient PeVatron and its neutrino emission, focusing on shock-CSM interaction. While it involves stellar feedback and CSM, it is not directly related to galaxy-scale outflows or the core topics.
...
## 34. [A Forward, Analytic, Differentiable, Geometric (But Inflexible) Lens Model](https://arxiv.org/abs/2604.11908) <a id="link34"></a>
...
**Comment:** The paper presents an analytic lens model for strong gravitational lensing, relevant for upcoming surveys. While it involves galaxy-scale lensing, it does not address satellite galaxies, star formation histories, or galaxy simulations. The focus is on lens modeling methodology, which is outside the core topics.
...
## 35. [Evidence for a bloated massive protostar in IRAS20126+4104](https://arxiv.org/abs/2604.12552) <a id="link35"></a>
...
**Comment:** Studies variability and periodicity in a massive protostar, focusing on stellar rotation and bloating. While it involves stellar evolution, it does not present new stellar models or address galaxy-scale topics.
...
## 36. [Primordial Black Holes Formation Beyond the Standard Cosmic QCD Transition](https://arxiv.org/abs/2604.12581) <a id="link36"></a>
...
**Comment:** This paper reviews primordial black hole formation during the cosmic QCD transition and its implications for dark matter and cosmological evolution. While it discusses cosmological phase transitions and dark matter, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 37. [Spatially Resolved Kinematics of SLACS Lens Galaxies. II: Breaking Degeneracies with Lensing and Dynamical Models](https://arxiv.org/abs/2604.12155) <a id="link37"></a>
...
**Comment:** The paper models mass density profiles of strong lens galaxies, focusing on mass profile slopes and degeneracies. The galaxies are massive ellipticals, not dwarfs, and the work does not address satellite galaxies, star formation histories, quenching, or galaxy simulations.
...
## 38. [M1-92: AGB interruption and isotopic ratio paradox. Chemistry and morpho-kinematics from improved shapemol modelling](https://arxiv.org/abs/2604.12569) <a id="link38"></a>
...
**Comment:** This paper models the chemistry and morpho-kinematics of a pre-planetary nebula, focusing on molecular line profiles and isotopic ratios. While it involves stellar evolution and modeling, it is not presenting new stellar models or evolutionary tracks, nor is it focused on galaxy-scale phenomena.
...
## 40. [Variability classification of TESS targets in LOPS2, the first long-term pointing field of PLATO. Version 1 of the public variability catalogue](https://arxiv.org/abs/2604.12758) <a id="link40"></a>
...
**Comment:** This paper presents a catalogue of variable stars in the PLATO LOPS2 field using TESS data. While it involves stellar variability and classification, it does not present new stellar models or address resolved star formation histories or galaxy simulations.
...
## 41. [KIC 3868420: A high-amplitude $\delta$ Scuti-$\gamma$ Dor hybrid star crossing the Hertzsprung gap](https://arxiv.org/abs/2604.12399) <a id="link41"></a>
...
**Comment:** The paper analyzes a hybrid pulsating star using photometry and asteroseismology, but does not present new stellar models or address resolved star formation histories or galaxy simulations.
...
## 42. [How I Wonder What You Are -- JWST's Little Red Dots do not TWINKLE](https://arxiv.org/abs/2604.13000) <a id="link42"></a>
...
**Comment:** The paper studies the variability of Little Red Dots (LRDs) observed by JWST, focusing on their central engines and AGN-like properties. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 43. [Post-Newtonian inspiral waveform model for eccentric precessing binaries with higher-order modes and matter effects](https://arxiv.org/abs/2604.11903) <a id="link43"></a>
...
**Comment:** This paper introduces a post-Newtonian inspiral waveform model for eccentric precessing binaries, including higher-order modes and matter effects. While it is a numerical simulation, it is focused on compact binaries and gravitational waves, not galaxy-scale simulations or relevant galaxy physics.
...
## 44. [JWST/MIRI Hydrocarbon and Water Absorption in the Wind of a Young Disk: Signatures of Pebble Drift and Carbon Grain Sublimation](https://arxiv.org/abs/2604.12242) <a id="link44"></a>
...
**Comment:** The paper discusses JWST observations of a young protoplanetary disk, focusing on hydrocarbon and water absorption in disk winds. While it deals with disk chemistry and winds, it is not related to galaxy-scale star formation driven outflows or circumgalactic medium, nor does it address resolved star formation histories or stellar models.
...
## 45. [Unveiling Dominant Toroidal Magnetic Fields in a Protostellar Outflow](https://arxiv.org/abs/2604.12597) <a id="link45"></a>
...
**Comment:** The paper reports on magnetic fields in protostellar outflows, focusing on the magneto-centrifugal mechanism. While it discusses outflows, these are at the protostellar scale and not galaxy-scale star formation driven outflows, nor does it address any of the other core criteria.
...
## 46. [Finite temperature effects on g-modes of inviscid neutron stars](https://arxiv.org/abs/2604.11815) <a id="link46"></a>
...
**Comment:** The paper studies g-modes in neutron stars and their dependence on temperature and nuclear symmetry energy. This is focused on stellar interiors but not on stellar evolutionary tracks or atmosphere models relevant to the criteria.
...
## 47. [Model-Independent Analysis of Type Ia Supernova Datasets and Implications for Dark Energy](https://arxiv.org/abs/2604.11883) <a id="link47"></a>
...
**Comment:** The paper analyzes Type Ia supernova datasets and their implications for dark energy, focusing on cosmological parameters and dataset systematics. It does not address near-field cosmology, resolved star formation histories, galaxy simulations, or dwarf galaxies.
...
## 48. [Identifying Changing-Look AGN Transitions in Light Curve Data with the Zwicky Transient Facility](https://arxiv.org/abs/2604.12109) <a id="link48"></a>
...
**Comment:** This paper studies changing-look AGN transitions using light curve data. It is focused on AGN variability and does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 49. [Obscured at the Core: Evidence for Nuclear Dust in Reddened Type-1 AGN](https://arxiv.org/abs/2604.13031) <a id="link49"></a>
...
**Comment:** The paper investigates nuclear dust in reddened Type-1 AGN, focusing on obscuration mechanisms and AGN structure. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 50. [Spectral index evolution of the limb-brightened jet in 3C 84](https://arxiv.org/abs/2604.11875) <a id="link50"></a>
...
**Comment:** The paper studies the spectral index evolution of the jet in 3C 84, focusing on jet launching mechanisms and AGN physics. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 51. [Relativistic Effects on Circumbinary Orbit Stability](https://arxiv.org/abs/2604.11982) <a id="link51"></a>
...
**Comment:** This paper studies relativistic effects on circumbinary orbit stability, with implications for circumbinary disks, especially around supermassive black hole binaries. It does not address galaxy evolution, star formation, dwarf galaxies, stellar models, or galaxy simulations.
...
## 52. [Cosmologically viable non-polynomial quasi-topological gravity: explicit models, $\Lambda$CDM limit and observational constraints](https://arxiv.org/abs/2604.13002) <a id="link52"></a>
...
**Comment:** This paper investigates cosmological implications of a modified gravity theory and its fit to cosmological data. It does not address any of the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 53. [Disk instability model incorporating a variable inner disk radius in SS Cyg and U Gem](https://arxiv.org/abs/2604.12085) <a id="link53"></a>
...
**Comment:** This paper models disk instability in dwarf novae, focusing on accretion disk physics and evaporation. It is not related to galaxy-scale phenomena, star formation histories, quenching, or stellar models in the context of galaxies.
...
## 55. [JWST observations of photodissociation regions. IV. Carbonaceous emission band sub-components in NGC 7023 have distinct spatial distributions](https://arxiv.org/abs/2604.12860) <a id="link55"></a>
...
**Comment:** This paper analyzes JWST spectroscopy of photodissociation regions in NGC 7023, focusing on carbonaceous emission bands and their spatial distributions. The focus is on ISM chemistry and emission carriers, not on galaxies, near-field cosmology, or resolved star formation histories.
...
## 56. [Sensitivities of Black Hole Images from GRMHD Simulations](https://arxiv.org/abs/2604.11869) <a id="link56"></a>
...
**Comment:** Focuses on black hole imaging and GRMHD simulations, which are not galaxy simulations or related to the core topics. No relevant criteria matched.
...
## 57. [Constraints on Coupled Dark Energy in the DESI Era](https://arxiv.org/abs/2604.12032) <a id="link57"></a>
...
**Comment:** This paper focuses on cosmological constraints on coupled dark energy models using large-scale structure and CMB data. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy properties, or galaxy simulations. The focus is on cosmological parameters and dark energy, which are outside the specified interests.
...
## 58. [Probing Scalar-Tensor-Induced Gravitational Waves in the nHz Band: $\texttt{NANOGrav}$ and SKA](https://arxiv.org/abs/2604.13012) <a id="link58"></a>
...
**Comment:** This paper investigates scalar-tensor-induced gravitational waves as a cosmological source, with applications to PTA datasets. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories. The focus is on gravitational wave backgrounds and early universe physics.
...
## 59. [The Shocking Origin of the Flat $EE/BB$ Ratio](https://arxiv.org/abs/2604.11891) <a id="link59"></a>
...
**Comment:** This paper analyzes the origin of the EE/BB ratio in galactic foregrounds for CMB polarization, using MHD simulations. The focus is on ISM physics and foregrounds, not on galaxy simulations, star formation histories, or near-field cosmology. The relevance is low as it does not address any of the specified criteria.
...
## 60. [RAPRAL v1.0: RAdiation Prediction using RAy tracing and Line-by-line methods for hypersonic air flows](https://arxiv.org/abs/2604.11856) <a id="link60"></a>
...
**Comment:** This paper introduces a new radiation solver for hypersonic air flows, relevant to planetary atmospheres and high-temperature radiative processes, but not to galaxy simulations, star formation, or dwarf galaxies.
...
## 61. [POLARIS: A Sparse Radial Neutrino Telescope Design for the Pacific Ocean](https://arxiv.org/abs/2604.12521) <a id="link61"></a>
...
**Comment:** This paper describes a new neutrino telescope design for high-energy astrophysical neutrino detection. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, dwarf galaxies, stellar models, galaxy simulations, outflows, CGM).
...
## 62. [FRTSearch: Unified Detection and Parameter Inference of Fast Radio Transients using Instance Segmentation](https://arxiv.org/abs/2604.12344) <a id="link62"></a>
...
**Comment:** The paper introduces a new framework for fast radio transient detection and parameter inference, focusing on radio astronomy data processing. It does not address any of the core topics such as galaxy evolution, star formation, or cosmology.
...
## 63. [SN 2022riv in RX J2129: Discovery, Spectroscopic Classification, and Microlensing of a Strongly Lensed Type Ia Supernova from JWST and HST Observations](https://arxiv.org/abs/2604.11882) <a id="link63"></a>
...
**Comment:** The paper focuses on a strongly lensed Type Ia supernova and its magnification, with no direct connection to any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or stellar models.
...
## 64. [Accretion-Mode Transition: The Driver Behind Spectral Changes in Changing-Look AGNs](https://arxiv.org/abs/2604.12427) <a id="link64"></a>
...
**Comment:** This paper discusses changing-look AGNs and accretion mode transitions, focusing on black hole accretion and AGN variability. It does not match any of the core topics (no connection to dwarf galaxies, star formation, or stellar models).
...
## 65. [Mapping the emission and spectral properties of the FRI radio galaxy 3C 449 with LOFAR and the VLA](https://arxiv.org/abs/2604.12043) <a id="link65"></a>
...
**Comment:** The paper presents a radio continuum study of the FRI galaxy 3C 449, focusing on jet dynamics and spectral aging. The galaxy is a massive FRI, not a dwarf, and the work does not address any of the core topics such as near-field cosmology, star formation histories, or stellar models.
...
## 66. [The spectrum of the persistent radio source associated with FRB 20190417A](https://arxiv.org/abs/2604.12791) <a id="link66"></a>
...
**Comment:** The paper measures the spectrum of a persistent radio source associated with a fast radio burst, focusing on magnetar wind nebulae. No direct connection to any of the core topics (no focus on dwarf galaxies, star formation histories, or stellar models).
...
## 67. [21 cm Power Spectrum Analysis of North Celestial Pole Observations with the Tianlai Dish Pathfinder Array](https://arxiv.org/abs/2604.12200) <a id="link67"></a>
...
**Comment:** This paper analyzes the 21 cm power spectrum from the Tianlai Dish Pathfinder Array, focusing on large-scale cosmic structure and intensity mapping. No direct connection to dwarf galaxies, star formation histories, or stellar models.
...
## 68. [A sample of short-lived Galactic radio transients from ASKAP VAST](https://arxiv.org/abs/2604.11881) <a id="link68"></a>
...
**Comment:** This paper focuses on short-lived Galactic radio transients, mainly toward the Galactic center and discusses their possible origins in white dwarf binaries. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 69. [JOYS: Launching and destruction of dust in protostellar jets. The case of BHR71-IRS1 with JWST/MIRI](https://arxiv.org/abs/2604.11904) <a id="link69"></a>
...
**Comment:** This paper presents JWST observations of dust launching and destruction in protostellar jets. The focus is on star formation processes in protostars and the fate of dust, not on galaxies, resolved star formation histories, quenching, or galaxy-scale outflows. No relevant criteria match.
...
## 70. [Kelvin waves over a differentially rotating spherical shell](https://arxiv.org/abs/2604.12598) <a id="link70"></a>
...
**Comment:** This paper studies Kelvin waves in differentially rotating spherical shells, with applications to Be stars. It focuses on stellar physics and wave instabilities in rapidly rotating stars, which does not match any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 71. [Detection and analysis of white-light emission in solar flares through light curve diagnostics](https://arxiv.org/abs/2604.12394) <a id="link71"></a>
...
**Comment:** The paper presents a new method for detecting white-light emission in solar flares, which is relevant to solar physics but not to any of the core topics such as galaxy simulations, star formation histories, or dwarf galaxies.
...
## 72. [Novel ringdown tests of general relativity with black hole greybody factors](https://arxiv.org/abs/2604.11895) <a id="link72"></a>
...
**Comment:** Presents new tests of general relativity using black hole ringdown signals, unrelated to galaxy astrophysics or any of the core topics.
...
## 73. [Impact of the SNe Ia Magnitude Transition at 20 Mpc on Cosmological Parameter Estimation](https://arxiv.org/abs/2604.12587) <a id="link73"></a>
...
**Comment:** This paper analyzes the impact of a magnitude transition in SNe Ia on cosmological parameter estimation. It is not directly related to any of the core topics (no focus on dwarf galaxies, star formation, or stellar models).
...
## 74. [Astrophysical parameters of LS 437 and the nature of X0726-260](https://arxiv.org/abs/2604.12078) <a id="link74"></a>
...
**Comment:** This paper studies a Be/X-ray binary in the Milky Way, focusing on stellar parameters and X-ray behavior. It does not address any of the core topics (no focus on dwarf galaxies, star formation histories, or stellar models).
...
## 75. [A note on Gurzadyan theorem](https://arxiv.org/abs/2603.25323) <a id="link75"></a>
...
**Comment:** The paper discusses Gurzadyan theorem and its mathematical/physical understanding in cosmology, but does not address any of the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 76. [Intermediate-Mass Mergers: A New Scenario for Several FS CMa Stars](https://arxiv.org/abs/2604.11907) <a id="link76"></a>
...
**Comment:** This paper discusses FS CMa stars and the merger hypothesis for their origin. The focus is on peculiar B-type stars and their circumstellar environments, not on galaxies, star formation histories, quenching, or numerical galaxy simulations. No relevant criteria match.
...
## 77. [OB runaway stars originating in the Vel OB1 association](https://arxiv.org/abs/2604.11988) <a id="link77"></a>
...
**Comment:** This paper studies OB runaway stars in the Vel OB1 association, their origins, and impact on the ISM. The focus is on massive stars and their ejection mechanisms, not on dwarf galaxies, near-field cosmology, resolved star formation histories, or galaxy simulations. No relevant criteria match.
...
## 78. [Do equation of state parametrizations of dark energy faithfully capture the dynamics of the late universe?](https://arxiv.org/abs/2604.12987) <a id="link78"></a>
...
**Comment:** Investigates dark energy equation of state parametrizations and late-time cosmology, not related to near-field cosmology or galaxy-scale astrophysics. No relevant criteria matched.
...
## 79. [Not too close! Evaluating the impact of the baseline on the localization of binary black holes by next-generation gravitational-wave detectors](https://arxiv.org/abs/2604.11871) <a id="link79"></a>
...
**Comment:** Focuses on gravitational wave detector design and localization of binary black holes, which is not related to galaxy astrophysics or any of the core topics.
...
## 80. [A Search for Hydroacoustic Signals from Bolides](https://arxiv.org/abs/2604.12723) <a id="link80"></a>
...
**Comment:** The paper surveys hydroacoustic signals from fireballs (bolides) using ocean hydrophones. It is unrelated to any of the core topics (galaxy evolution, star formation, dwarf galaxies, stellar models, galaxy simulations, outflows, CGM).
...
## 81. [An XMM-Newton Analysis of the Supermassive Black Hole Binary Candidate MCG+11--11--032](https://arxiv.org/abs/2604.11874) <a id="link81"></a>
...
**Comment:** This paper analyzes X-ray spectra of a supermassive black hole binary candidate in a Seyfert galaxy. It is unrelated to the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 82. [Self-Lensing Signals in Binary Systems Containing White Dwarfs with Neutron star or Stellar-mass Black hole Companions](https://arxiv.org/abs/2604.12705) <a id="link82"></a>
...
**Comment:** The paper studies self-lensing signals in binary systems with white dwarfs and neutron stars or black holes, focusing on detectability in TESS and Roman observations. It is not related to any of the core topics such as galaxy evolution, star formation, or cosmology.
...
## 83. [Graviton Production from Inflaton Condensate: Boltzmann vs Bogoliubov](https://arxiv.org/abs/2604.12687) <a id="link83"></a>
...
**Comment:** This paper studies graviton production during reheating in the early universe, comparing Boltzmann and Bogoliubov approaches. The focus is on cosmological particle production, not on galaxies, near-field cosmology, star formation histories, or galaxy simulations.
...
## 84. [Gravitational Gertsenshtein-Zeldovich mechanism for the Association between GW190425 and FRB 20190425A](https://arxiv.org/abs/2604.12775) <a id="link84"></a>
...
**Comment:** This paper proposes a mechanism for the association between a gravitational wave event and a fast radio burst. The focus is on high-energy astrophysics and cosmology, not on galaxies, near-field cosmology, star formation histories, or galaxy simulations.
...
## 85. [A view of the evolution of a CME and the associated wave-trains at high spatial and temporal resolution](https://arxiv.org/abs/2604.12836) <a id="link85"></a>
...
**Comment:** This paper focuses on coronal mass ejections (CMEs) and wave-trains in the solar corona, which is unrelated to any of the specified criteria such as near-field cosmology, galaxy simulations, or stellar models.
...
## 86. [Solar Orbiter observations of solar energetic electron events associated with hard microflares](https://arxiv.org/abs/2604.12731) <a id="link86"></a>
...
**Comment:** The paper studies solar energetic electron events associated with microflares, focusing on solar physics and particle acceleration. It does not match any of the core criteria related to galaxies, star formation histories, or stellar models.
...
## 88. [In Situ Interferometric Spatial Mapping Of A Microwave Kinetic Inductance Detector Array](https://arxiv.org/abs/2604.12287) <a id="link88"></a>
...
**Comment:** This paper presents a method for spatial mapping of MKID arrays for telescope instrumentation. It is not related to any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 89. [Amerigo Vespucci and the discovery of the Southern Sky](https://arxiv.org/abs/2604.11826) <a id="link89"></a>
...
**Comment:** This is a historical analysis of Amerigo Vespucci's astronomical observations and their impact on celestial cartography. It does not match any of the specified criteria.
...
## 90. [MMS Insights into CME Driven Sub-Alfv\'enic Solar Wind at 1 AU](https://arxiv.org/abs/2604.12000) <a id="link90"></a>
...
**Comment:** Focuses on solar wind and CME turbulence, which is unrelated to any of the core topics such as near-field cosmology, galaxy simulations, or star formation. No relevant criteria matched.
...
## 91. [Frequency & Radiative Analysis of Random Yagi-UHF/VHF Phased Array](https://arxiv.org/abs/2604.11816) <a id="link91"></a>
...
**Comment:** Paper is about phased array ground station technology and radio engineering, not related to galaxy astrophysics or any of the core topics.
