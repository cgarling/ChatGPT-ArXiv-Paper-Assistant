...
1. [Collisional Dynamics of Stars and Dark Matter in Ultra-Faint Galaxies](#user-content-link1)
**Authors:** Rapha\"el Errani, Nicolas Esser, Jorge Pe\~narrubia, Matthew G. Walker

2. [Dartmouth Stellar Evolution Emulator (DSEE) 1: Generative Stellar Evolution Model Database](#user-content-link2)
**Authors:** Jiaqi (Martin), Ying, Brian Chaboyer, Phillip A. Cargile, Wenxin Du, George Dufresne

3. [Binary Star Evolution Modules in REBOUNDx](#user-content-link3)
**Authors:** Mohamad Ali-Dib

4. [Metal Mayhem at $\rm z \sim 7-10$: Diversity and Evolution of Gas-Phase Metallicity Gradients](#user-content-link4)
**Authors:** Maria Koller, Roberto Maiolino, Hannah \"Ubler, Qiao Duan, Jan Scholtz, Santiago Arribas, William M. Baker, Stefano Carniani, Stephane Charlot, Mirko Curti, Luca Graziani, Gareth Jones, William McClymont, Michele Perna, Bruno Rodr\'iguez Del Pino, Sandro Tacchella, Alessandra Venditti, Giacomo Venturi, Joris Witstok

5. [Learning the Stellar Structure Equations via Self-supervised Physics-Informed Neural Networks](#user-content-link5)
...
6. [Multi-dimensional, time-dependent approximate NLTE unified model atmospheres with winds for hot, massive stars](#user-content-link6)
**Authors:** Dwaipayan Debnath, Jon O. Sundqvist, Nicolas Moens, Luka G. Poniatowski, Cassandra Van der Sijpt, Andreas A. C. Sander

7. [The Evolution of Star-Forming Gas in STARFORGE: From Clouds, to Cores, to Stars](#user-content-link7)
**Authors:** Ananya Kaalva, Stella S. R. Offner, Nina Filippova, Michael Y. Grudic

8. [Dust and Grain Size Evolution in Galaxy Simulations: What Matters and What Does Not](#user-content-link8)
**Authors:** Massimiliano Parente, Desika Narayanan, Paul Torrey

9. [VST-SMASH: VST Survey of Mass Assembly and Structural Hierarchy I. Survey presentation and deep photometry of IC 5332: tracing the mass assembly in the challenging faintest-end regime](#user-content-link9)
**Authors:** R. Ragusa, C. Tortora, L. Hunt, M. Spavone, M. Baes, Abdurro uf, M. Gatto, F. Annibali, N. Bellucco, A. Unni, E. Schinnerer

10. [A Quadruple Excess in Wide Binary Systems: Evidence for Correlated Binary Formation](#user-content-link10)
**Authors:** Dolev Bashi, Cathie J. Clarke, Vasily Belokurov

11. [Extinction Distributions in Nearby Star-resolved Galaxies. II. M33](#user-content-link11)
...
12. [Joint Curvature and Growth Rate measurements with Supernova Peculiar Velocities and the CMB](#user-content-link12)
**Authors:** Camilo Crisman, Miguel Quartin, Jo\~ao Rebou\c{c}as

13. [Observational Tests for Distinguishing Classes of Cosmological Models](#user-content-link13)
**Authors:** Asta Heinesen, Timothy Clifton

14. [Large Interstellar Polarisation Survey. III. Observational constraints on the structure of grains](#user-content-link14)
**Authors:** Ralf Siebenmorgen, Stefano Bagnulo, Lapo Fanciullo, Thomas Vannieuwenhuyse, Vincent Guillet

15. [Magnetic-Field-Induced Inspiral of Binaries with Circumbinary Disk: Black Hole and Protostellar Systems](#user-content-link15)
**Authors:** Tomoaki Matsumoto, Kenta Hotokezaka, Kohei Inayoshi

16. [Harmonic phase diagnostics of long secondary periods. Testing predictions of oscillatory convective dipole modes in the OGLE sample](#user-content-link16)
**Authors:** Benjamin Courtney-Barrer, Xavier Haubois, Michael Ireland, Peter Wood

17. [Wild is the wind from low-luminosity AGN: a jet-driven gas bubble blowing out a massive CO-dark outflow in ESO 420-G13](#user-content-link17)
**Authors:** J. A. Fern\'andez-Ontiveros, L. Spinoglio, M. Pereira-Santaella, A. Hern\'an-Caballero, E. Hatziminaoglou, E. P\'erez-Montero, J. M. V\'ilchez, B. P\'erez-D\'iaz, R. Amor\'in, M. A. Malkan, K. M. Dasyra

18. [Spectral Difference Method with a Posteriori Limiting: III- Navier-Stokes Equations with Arbitrary High-Order Accuracy](#user-content-link18)
**Authors:** David A. Velasco-Romero, Romain Teyssier

19. [The Way We Tally Becomes the Tale: the Impact of Selection Strategies on the Inferred Evolution of Little Red Dots Across Cosmic Time](#user-content-link19)
...
20. [Low-redshift-agnostic BAO Constraints on Binned Dark-energy Density Evolution from DESI DR1 and DR2](#user-content-link20)
**Authors:** Qian-Mo Liu, Gong-Bo Zhao

21. [A Close Quasar Pair in a Massive Galaxy Merger at $z=5.7$](#user-content-link21)
**Authors:** Minghao Yue, Xiaohui Fan, Anna-Christina Eilers, Feige Wang, Jinyi Yang, Robert A. Simcoe

22. [Zooming in on radio relics -- II. How relic morphology probes density fluctuations at the edge of galaxy clusters](#user-content-link22)
**Authors:** Joseph Whittingham, Christoph Pfrommer, Maria Werhahn, L\'ena Jlassi, Philipp Girichidis

23. [LightCurveLynx: Forward Modeling of Time-Domain Surveys with Application to ZTF SN Ia DR2](#user-content-link23)
...
24. [The Wonderful World of Binary Stars](#user-content-link24)
**Authors:** Andrea Barone, Henri M. J. Boffin, Beatrice Caccherano, Simona Di Stefano, Akhila Divakaran, Alexandra S. Murphy, Mar\'ia Jos\'e Rain, Elyar Sedaghati, Paul V. Steimle

25. [The Galaxy Activity, Torus, and outflow Survey (GATOS) XIII: Coupling Driven H2 Excitation in Seyferts](#user-content-link25)
...
26. [Magnetic geometry of M dwarfs in the southern PLATO field](#user-content-link26)
...
27. [Primordial magnetic fields in the light of upcoming post-EoR Lyman-$\alpha$ and 21-cm observations](#user-content-link27)
**Authors:** Arko Bhaumik, Sourav Pal, Supratik Pal

28. [Galactic Rotation Curves from Full-Disk Newtonian Gravity: The Lost and Found Model](#user-content-link28)
**Authors:** Adolfo Santa Fe Due\~nas

29. [Particle-acceleration mechanisms in multispecies relativistic plasmas](#user-content-link29)
**Authors:** Claudio Meringolo, Mario Imbrogno, Alejandro Cruz-Osorio, Sergio Servidio, Luciano Rezzolla

30. [Improving Neutrino Point Source Sensitivity with Source-Informed Event Selection](#user-content-link30)
**Authors:** Jeffrey Lazar, Carlos A. Arg\"uelles, Pavel Zhelnin

31. [Chemical Abundances Shape History (CASH). I. A Link between Giant Planets Orbital Periods and Host Stellar C/O Ratios](#user-content-link31)
**Authors:** Ruisheng Zhang, Ji-Wei Xie, Mengrui Pan, Beibei Liu, Ji-Lin Zhou, Ji Wang, Haiyang S. Wang, Yapeng Zhang

32. [A Hidden Degeneracy in Two-Spot Models for Thermal X-Ray Pulse-Profile Fitting](#user-content-link32)
**Authors:** Tong Zhao, Mingyu Ge, Renxin Xu

33. [Galaxy discs regulate the growth of supermassive black holes](#user-content-link33)
**Authors:** Ryan J. Roberts, Jonathan J. Davies, Robert A. Crain

34. [The Non-Gaussian Weak-Lensing Likelihood: A Multivariate Copula Construction and Impact on Cosmological Constraints](#user-content-link34)
**Authors:** Veronika Oehl, Tilman Tr\"oster

35. [Anisotropic hybrid stars: Interplay of superconductivity and magnetic field leading to gravitational waves](#user-content-link35)
**Authors:** Zenia Zuraiq, Banibrata Mukhopadhyay

36. [The broadband spectral energy distribution of candidate neutrino blazars](#user-content-link36)
**Authors:** Athira M Bharathan, C. S. Stalin, Markus B\"ottcher, S. Sahayanathan, Blesson Mathew, Subir Bhattacharyya

37. [A Unified Model for Shock Interaction and $\gamma$-Ray Emission in Classical Novae](#user-content-link37)
**Authors:** Rebecca Diesing, Brian Metzger

38. [Complex Nuclear Structure in Seyfert 2 Galaxy NGC 4388 Revealed by XRISM Observation](#user-content-link38)
...
39. [RadioAstron reveals a change in the jet collimation profile of 3C 84](#user-content-link39)
**Authors:** P. Benke, T. Savolainen, G. Giovannini, Y. Y. Kovalev, G. Bruni, M. M. Lisakov, M. Giroletti, E. Ros

40. [Data-Driven Constraints on Magnetar Population: No Evidence for a Distinct White Dwarf Channel](#user-content-link40)
**Authors:** R. V. Lobato

41. [Probing the accretion geometry of the transient accreting millisecond pulsar SAX J1808.4-3658: transitions to the propeller regime](#user-content-link41)
**Authors:** Mahasweta Bhattacharya, Aditya S. Mondal, Gulab C. Dewangan

42. [No Period Change in Two Long-Period AM CVn Binaries](#user-content-link42)
...
43. [Analytic Approximations for Fermionic Preheating](#user-content-link43)
**Authors:** Heather E. Logan, Daniel Stolarski, Fazlul Yasin

44. [Tracing the dynamical and structural complexity of spiral galaxy centres](#user-content-link44)
**Authors:** Iris Breda, Glenn van de Ven, Sabine Thater, J. Falc\'on-Barroso, Prashin Jethwa, Masato Onodera, Joop Schaye, Jarle Brinchmann, Bodo Ziegler, Federica Mauro

45. [Storm-Driven Suppression and Post-Storm Enhancement of Photographic Plate Transient Detections at Geosynchronous Altitude: Empirical Evidence and a Candidate Dusty Plasma Mechanism](#user-content-link45)
**Authors:** Kevin Cann

46. [Science of Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](#user-content-link46)
**Authors:** Yuki Inoue, Hsiang-Yu Huang, Vivek Kumar, Mario Juvenal S. Onglao II, Daiki Tanabe, Ta-Chun Yu

47. [UMI: A GPU-Accelerated Asymmetric Robust Estimator for Photometric Detrending in Exoplanet Transit Searches](#user-content-link47)
**Authors:** Omar Khan

48. [A 4.5-s Quasiperiodic Spectral Oscillation in GRB 230307A: Evidence for Free Precession of a Post-Merger Magnetar?](#user-content-link48)
**Authors:** Run-Chao Chen, Jun Yang, Bin-Bin Zhang, Chen-Wei Wang, Wen-Jun Tan, Shao-Lin Xiong, Bing Zhang

49. [Cosmological Dynamics of Exponential Quintessence Constrained by BAO, Cosmic Chronometers, and DES-SN5YR/Pantheon+ Data](#user-content-link49)
**Authors:** Sanjeeda Sultana, Surajit Chattopadhyay

50. [Neutron Star Merger Rates from Multi-messenger Observations: Clues to the Physical Origin of the Short and Long-short Gamma-ray Bursts](#user-content-link50)
**Authors:** Zhi-Ping Jin, Yuan-Zhu Wang, Yin-Jie Li, Yun Wang, Hao Wang, Shao-Peng Tang, Da-Ming Wei

51. [Multi-scale Gas Structure and Dynamics in an Extragalactic Central Molecular Zone](#user-content-link51)
**Authors:** Liam M. Wang, Jiayi Sun, Yu-Hsuan Teng, Eric W. Koch, Sanghyuk Moon, Elias Oakes, Erik Rosolowsky

52. [Loop Blow-up Inflation: An Overview](#user-content-link52)
**Authors:** Suk\c{r}ti Bansal

53. [Determining the Host Stars of Planets in Binary Star Systems with Asterodensity Profiling: Investigating the Canonical Radius Gap](#user-content-link53)
**Authors:** Nathanael Burns-Watson, Kendall Sullivan, Adam Kraus

54. [Reliability of uGMRT Band-4 Polarimetry: Results from a Quadrature Hybrid Polarizer Bypass Experiment](#user-content-link54)
**Authors:** Arpan Pal, Sanjeet Rai, Ganesh Kumbhar

55. [An archival search for gamma-ray bursts gravitationally lensed by galaxy clusters](#user-content-link55)
...
56. [Phase spirals induced by the gas warp](#user-content-link56)
**Authors:** Shuyu Wang, Anthony G. A. Brown, Victor P. Debattista, Tigran Khachaturyants

57. [An astrometric search for planets in debris disk systems](#user-content-link57)
**Authors:** Elisabeth M. Penderghast, Benjamin C. Bromley, Scott J. Kenyon, Joan R. Najita

58. [Neutrino transport and flavor instabilities in a post-merger disk](#user-content-link58)
**Authors:** Erick Urquilla, Swapnil Shankar, Debraj Kundu, Julien Froustey, Sherwood Richers, Jonah M. Miller, Gail C. McLaughlin, James P. Kneller, Francois Foucart

59. [A TESS Test of the Hybrid Ring Strategy for Technosignature Searches Using GRB 221009A](#user-content-link59)
**Authors:** Naoki Seto

60. [Gravitational wave signal and noise response of an optically levitated sensor in a Fabry-P\'erot cavity](#user-content-link60)
...
61. [Gauge Theoretic Signal Processing I: The Commutative Formalism for Single-Detector Adaptive Whitening](#user-content-link61)
**Authors:** James Kennington, Joshua Black

62. [Clues for the accretion regulated dust torus in the changing-look AGN SDSS J101152.98+544206.4](#user-content-link62)
**Authors:** Zhang XueGuang (GXU)

63. [Effects of Geomagnetic Cutoff Rigidity Variations during Forbush Decreases](#user-content-link63)
**Authors:** Pengwei Zhao, Jie Feng

64. [Theoretical and Observational Bounds on Dynamical Chern-Simons Gravity as an Effective Field Theory](#user-content-link64)
**Authors:** Alexander Cassem, Mark P. Hertzberg

65. [Shadow, Sparsity of Radiation and Energy Emission Rate in Skyrmion Black Holes](#user-content-link65)
**Authors:** Faizuddin Ahmed, Ahmad Al-Badawi, \.Izzet Sakall{\i}

66. [Solitary wave structure of transitional flow in the wake of a sphere](#user-content-link66)
**Authors:** Lin Niu, Hua-Shu Dou, Changquan Zhou, Wenqian Xu

67. [Plasma Dynamics of Radiative Cooling Accretion Flow in AM Herculis with XRISM](#user-content-link67)
**Authors:** Yukikatsu Terada (Saitama University), Kaya Mori (Columbia University), Takayuki Hayashi (Kyoto University), Gabriel L. Bridges (Columbia University), Manabu Ishida (ISAS/JAXA), Axel D. Schwope (Leibniz-Institut fur Astrophysik Potsdam), Mariko Kimura (Kanazawa University), Masayoshi Nobukawa (Nara University of Education), David A. H. Buckley (South African Astronomical Observatory), Solen Balman (Istanbul University), Taichi Ichikawa (Saitama University), Atsuto Matsumura (Tokyo Metropolitan University), Mai Takeo (Toyama University), Charles J. Hailey (Columbia University), Gavin Ramsay (Armagh Observatory and Planetarium), Antonio Rodriguez (California Institute of Technology), Samantha Walker (Columbia University)

68. [Big Bang revisited](#user-content-link68)
**Authors:** Frans R. Klinkhamer

69. [Solar Neutrino Flux Fluctuations Caused by Solar Gravity Modes](#user-content-link69)
**Authors:** Yoshiki Hatta, Yuuki Nakano, Sho Sugama, Masanobu Kunitomo, Hiroshi Ito, Takashi Sekii

70. [New insights from cross-correlation studies between solar activity indices and cosmic-ray flux during Forbush decrease events](#user-content-link70)
**Authors:** Mihailo Savi\'c, Nikola Veselinovi\'c, Aleksandar Dragi\'c, Dimitrije Maleti\'c, Dejan Jokovi\'c Vladimir Udovi\v{c}i\'c, Radomir Banjanac, David Kne\v{z}evi\'c

71. [A Major Geomagnetic Storm in 2024 October Linked to Sympathetic CME--Prominence Eruptions](#user-content-link71)
...
72. [Constraints on a fifth force from the stellar orbits around the central supermassive black hole of the Milky Way](#user-content-link72)
**Authors:** Predrag Jovanovi\'c, Du\v{s}ko Borka, Vesna Borka Jovanovi\'c

73. [An Aligned Very-Low-Mass Star Orbiting an M dwarf and Obliquity Patterns Across Giant Planets, Brown Dwarfs, and Binary Stars](#user-content-link73)
**Authors:** Tianjun Gan, Alexandrine L'Heureux, \'Etienne Artigau, Charles Cadieux, Ren\'e Doyon, Neil J. Cook, Shude Mao

74. [The new Geological Age that never was or the multiple layers of the Transientocene](#user-content-link74)
**Authors:** Orfeu Bertolami

---

## 1. [Collisional Dynamics of Stars and Dark Matter in Ultra-Faint Galaxies](https://arxiv.org/abs/2604.06304) <a id="link1"></a>
...
**Comment:** Directly addresses near-field cosmology by studying the collisional dynamics of stars and dark matter in ultra-faint galaxies using N-body simulations. Discusses core-cusp transformation, stellar mass ratios, and the phenomenology of the faintest galaxies, which is highly relevant. Also touches on numerical galaxy simulations.
...
## 2. [Dartmouth Stellar Evolution Emulator (DSEE) 1: Generative Stellar Evolution Model Database](https://arxiv.org/abs/2604.06348) <a id="link2"></a>
...
**Comment:** Presents a new generative stellar evolution model emulator (DSEE) trained on a large database of evolutionary tracks. Directly matches the 'Stellar Models' criterion, offering a new tool for stellar evolutionary tracks and isochrone construction.
...
## 3. [Binary Star Evolution Modules in REBOUNDx](https://arxiv.org/abs/2604.06386) <a id="link3"></a>
...
**Comment:** Presents new modules for binary star evolution in the REBOUNDx N-body code, including stellar winds and mass transfer. This is relevant to the 'Stellar Models' criterion, as it provides new theoretical models for stellar evolution and mass loss, and also to 'Numerical Galaxy Simulations' as it enables new physics in simulations. High relevance due to direct match with two criteria.
...
## 4. [Metal Mayhem at $\rm z \sim 7-10$: Diversity and Evolution of Gas-Phase Metallicity Gradients](https://arxiv.org/abs/2604.07076) <a id="link4"></a>
...
**Comment:** JWST/NIRSpec-IFU study of metallicity gradients in low-mass galaxies at z=7.2-9.5, including three low-metallicity satellite galaxies. Directly relevant to near-field cosmology (satellite galaxies, metallicity gradients, early interactions) and star formation histories in low-mass systems.
...
## 5. [Learning the Stellar Structure Equations via Self-supervised Physics-Informed Neural Networks](https://arxiv.org/abs/2604.06255) <a id="link5"></a>
...
**Comment:** This paper presents a self-supervised physics-informed neural network framework for solving stellar structure equations, directly matching the 'Stellar Models' criterion (new methods for stellar interior modeling).
...
## 6. [Multi-dimensional, time-dependent approximate NLTE unified model atmospheres with winds for hot, massive stars](https://arxiv.org/abs/2604.07317) <a id="link6"></a>
...
**Comment:** This paper presents new multi-dimensional, time-dependent NLTE model atmospheres for hot, massive stars, which fits the 'Stellar Models' criterion (new stellar atmosphere models).
...
## 8. [Dust and Grain Size Evolution in Galaxy Simulations: What Matters and What Does Not](https://arxiv.org/abs/2604.06314) <a id="link8"></a>
...
**Comment:** This paper presents a new implementation of dust grain size evolution in a semi-analytic galaxy model, which fits the 'Numerical Galaxy Simulations' criterion. The work is theoretical and introduces new physics (dust grain size evolution) into galaxy simulations, but does not directly address dwarf galaxies or other core topics. The relevance is moderate due to the focus on galaxy simulations, but the novelty is high as it is the first such implementation.
...
## 9. [VST-SMASH: VST Survey of Mass Assembly and Structural Hierarchy I. Survey presentation and deep photometry of IC 5332: tracing the mass assembly in the challenging faintest-end regime](https://arxiv.org/abs/2604.07083) <a id="link9"></a>
...
**Comment:** VST-SMASH survey paper on deep photometry of IC 5332, a late-type galaxy. Focuses on mass assembly and faint stellar streams in galactic outskirts, with some discussion of accreted populations. While it touches on stellar mass assembly and accretion, the galaxy is not a dwarf or satellite, so only borderline relevance for near-field cosmology.
...
## 10. [A Quadruple Excess in Wide Binary Systems: Evidence for Correlated Binary Formation](https://arxiv.org/abs/2604.06317) <a id="link10"></a>
...
**Comment:** The paper investigates the multiplicity of wide binary systems and correlated binary formation using Gaia data. While it touches on star formation processes, it does not focus on resolved star formation histories, dwarf galaxies, or stellar models. The relevance is borderline due to its connection to star formation, but not directly to the core topics.
...
## 11. [Extinction Distributions in Nearby Star-resolved Galaxies. II. M33](https://arxiv.org/abs/2604.06983) <a id="link11"></a>
...
**Comment:** Presents extinction maps for M33 using resolved RGB stars, enabling accurate stellar population studies. While it uses resolved stars, the focus is on extinction mapping rather than deriving star formation histories from color-magnitude diagrams. Borderline relevance for resolved stellar populations.
...
## 12. [Joint Curvature and Growth Rate measurements with Supernova Peculiar Velocities and the CMB](https://arxiv.org/abs/2604.06361) <a id="link12"></a>
...
**Comment:** The paper discusses cosmological parameters using supernovae and CMB data, focusing on curvature, growth rate, and structure formation. While it touches on large-scale structure and growth, it does not specifically address dwarf galaxies, resolved star formation histories, or galaxy simulations. The relevance is borderline due to the connection to structure growth.
...
## 13. [Observational Tests for Distinguishing Classes of Cosmological Models](https://arxiv.org/abs/2604.07244) <a id="link13"></a>
...
**Comment:** The paper discusses observational tests to distinguish cosmological models, focusing on curvature-consistency tests and FLRW deviations. While it is relevant to cosmology, it does not address near-field cosmology, dwarf galaxies, or galaxy simulations. The relevance is borderline due to its connection to cosmological structure.
...
## 14. [Large Interstellar Polarisation Survey. III. Observational constraints on the structure of grains](https://arxiv.org/abs/2604.06986) <a id="link14"></a>
...
**Comment:** The paper provides observational constraints on interstellar dust grain structure, focusing on dust properties in the diffuse ISM. While dust is relevant to galaxy evolution, the focus is not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 15. [Magnetic-Field-Induced Inspiral of Binaries with Circumbinary Disk: Black Hole and Protostellar Systems](https://arxiv.org/abs/2604.06904) <a id="link15"></a>
...
**Comment:** This paper presents high-resolution MHD simulations of binary systems, focusing on orbital decay and outflows/jets. While it discusses star formation-driven outflows and numerical simulations, the context is binary star formation and massive black hole binaries, not galaxy-scale outflows or galaxy simulations. The relevance to star formation-driven outflows is peripheral, as the focus is on binary systems rather than galaxies.
...
## 16. [Harmonic phase diagnostics of long secondary periods. Testing predictions of oscillatory convective dipole modes in the OGLE sample](https://arxiv.org/abs/2604.06563) <a id="link16"></a>
...
**Comment:** Presents diagnostics for oscillatory convective dipole modes in red giants, which is a stellar variability topic. While it touches on stellar models, it does not present new stellar evolutionary tracks or atmosphere models, nor does it relate to galaxy evolution or star formation histories.
...
## 17. [Wild is the wind from low-luminosity AGN: a jet-driven gas bubble blowing out a massive CO-dark outflow in ESO 420-G13](https://arxiv.org/abs/2604.06305) <a id="link17"></a>
...
**Comment:** Focuses on gas outflows in a post-starburst galaxy, but the outflows are AGN-driven rather than star-formation-driven. The galaxy is not a dwarf and the outflow is not directly linked to star formation processes. No direct relevance to near-field cosmology, resolved star formation histories, or CGM of dwarfs.
...
## 18. [Spectral Difference Method with a Posteriori Limiting: III- Navier-Stokes Equations with Arbitrary High-Order Accuracy](https://arxiv.org/abs/2604.07339) <a id="link18"></a>
...
**Comment:** Describes a high-order numerical method for solving Navier-Stokes equations, with applications to shock capturing. While it is a numerical method, it is not specifically applied to galaxy simulations or relevant physics for galaxy evolution.
...
## 19. [The Way We Tally Becomes the Tale: the Impact of Selection Strategies on the Inferred Evolution of Little Red Dots Across Cosmic Time](https://arxiv.org/abs/2604.07138) <a id="link19"></a>
...
**Comment:** This paper analyzes the selection biases in identifying 'Little Red Dots' (LRDs), a population linked to early black hole growth, using JWST data. The focus is on AGN and compact sources, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 20. [Low-redshift-agnostic BAO Constraints on Binned Dark-energy Density Evolution from DESI DR1 and DR2](https://arxiv.org/abs/2604.06888) <a id="link20"></a>
...
**Comment:** This paper presents a method for compressing BAO measurements to constrain dark-energy density evolution, using DESI data. While it deals with cosmological measurements, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 22. [Zooming in on radio relics -- II. How relic morphology probes density fluctuations at the edge of galaxy clusters](https://arxiv.org/abs/2604.06302) <a id="link22"></a>
...
**Comment:** The paper studies radio relics at the edge of galaxy clusters, using simulations to probe density fluctuations in the intracluster medium. While it involves numerical simulations and gas properties, the focus is on cluster-scale phenomena and not on galaxies or their satellites, star formation histories, quenching, or outflows. No direct connection to the core topics.
...
## 23. [LightCurveLynx: Forward Modeling of Time-Domain Surveys with Application to ZTF SN Ia DR2](https://arxiv.org/abs/2604.07134) <a id="link23"></a>
...
**Comment:** The paper introduces LightCurveLynx, a software framework for forward modeling time-domain light curves, demonstrated with Type Ia supernovae. While it is a numerical tool for time-domain astronomy, it does not directly address galaxy simulations, resolved star formation histories, or outflows. The focus is on supernovae and survey simulation, which are tangential to the core topics.
...
## 24. [The Wonderful World of Binary Stars](https://arxiv.org/abs/2604.06380) <a id="link24"></a>
...
**Comment:** This paper reports on student projects studying binary stars, including the Rossiter-McLaughlin effect, blue straggler stars, and planetary nebulae. While it involves stellar systems and some aspects of star formation, it does not present new stellar models or focus on resolved star formation histories in galaxies.
...
## 25. [The Galaxy Activity, Torus, and outflow Survey (GATOS) XIII: Coupling Driven H2 Excitation in Seyferts](https://arxiv.org/abs/2604.06524) <a id="link25"></a>
...
**Comment:** Studies AGN-driven outflows and molecular gas excitation in Seyfert galaxies. While it discusses outflows, these are AGN-driven and not star-formation-driven, and the galaxies are not dwarfs. No direct relevance to the core topics.
...
## 26. [Magnetic geometry of M dwarfs in the southern PLATO field](https://arxiv.org/abs/2604.06821) <a id="link26"></a>
...
**Comment:** Characterizes magnetic fields in M dwarfs in the southern PLATO field. Focus is on stellar magnetic properties and variability, not stellar models or galaxy-related topics.
...
## 27. [Primordial magnetic fields in the light of upcoming post-EoR Lyman-$\alpha$ and 21-cm observations](https://arxiv.org/abs/2604.07327) <a id="link27"></a>
...
**Comment:** The paper discusses primordial magnetic fields and their impact on the Lyman-alpha and 21-cm power spectra, focusing on constraining PMF parameters with future surveys. While it deals with cosmological observables, it does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 28. [Galactic Rotation Curves from Full-Disk Newtonian Gravity: The Lost and Found Model](https://arxiv.org/abs/2604.06917) <a id="link28"></a>
...
**Comment:** The paper introduces a new model for galactic rotation curves based on full-disk Newtonian gravity, challenging the need for dark matter in disk galaxies. While it deals with galaxy mass inference and rotation curves, it focuses on massive spiral galaxies and not on dwarf satellites or near-field cosmology. The relevance is low, but the novelty is moderate due to the new modeling approach.
...
## 29. [Particle-acceleration mechanisms in multispecies relativistic plasmas](https://arxiv.org/abs/2604.06749) <a id="link29"></a>
...
**Comment:** Investigates particle acceleration in relativistic plasmas near compact objects, focusing on jets and accretion flows. No direct relevance to galaxy evolution, star formation, or near-field cosmology.
...
## 30. [Improving Neutrino Point Source Sensitivity with Source-Informed Event Selection](https://arxiv.org/abs/2604.06509) <a id="link30"></a>
...
**Comment:** The paper proposes a source-informed event selection method for neutrino telescopes to improve point source sensitivity. It is focused on neutrino detection methodology, not on galaxies, star formation, or stellar models.
...
## 31. [Chemical Abundances Shape History (CASH). I. A Link between Giant Planets Orbital Periods and Host Stellar C/O Ratios](https://arxiv.org/abs/2604.06809) <a id="link31"></a>
...
**Comment:** Examines the link between stellar C/O ratios and giant planet orbital periods, focusing on planetary system formation. No direct connection to galaxy evolution, star formation histories, or near-field cosmology.
...
## 32. [A Hidden Degeneracy in Two-Spot Models for Thermal X-Ray Pulse-Profile Fitting](https://arxiv.org/abs/2604.06654) <a id="link32"></a>
...
**Comment:** Focuses on modeling degeneracies in neutron star X-ray pulse profiles, relevant to compact object astrophysics but not to galaxy evolution, star formation, or near-field cosmology.
...
## 33. [Galaxy discs regulate the growth of supermassive black holes](https://arxiv.org/abs/2604.06977) <a id="link33"></a>
...
**Comment:** Focuses on the relationship between galaxy morphology and supermassive black hole growth, using EAGLE simulations. The main topic is SMBH regulation in disc and elliptical galaxies, which is not directly related to near-field cosmology, dwarf galaxies, or any of the core topics. No relevant criteria matched.
...
## 34. [The Non-Gaussian Weak-Lensing Likelihood: A Multivariate Copula Construction and Impact on Cosmological Constraints](https://arxiv.org/abs/2604.07336) <a id="link34"></a>
...
**Comment:** Presents a framework for non-Gaussian likelihoods in weak-lensing analyses. Focus is on cosmological parameter inference and statistical methods, not directly related to any of the core topics.
...
## 35. [Anisotropic hybrid stars: Interplay of superconductivity and magnetic field leading to gravitational waves](https://arxiv.org/abs/2604.06308) <a id="link35"></a>
...
**Comment:** Studies hybrid stars (neutron stars with quark matter cores) and the interplay of superconductivity and magnetic fields, leading to gravitational waves. Focus is on neutron star interiors and gravitational wave signatures, not related to galaxy or stellar model criteria.
...
## 36. [The broadband spectral energy distribution of candidate neutrino blazars](https://arxiv.org/abs/2604.06921) <a id="link36"></a>
...
**Comment:** The paper studies candidate neutrino blazars, their spectral energy distributions, and emission processes. It is focused on AGN and blazars, not on any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 37. [A Unified Model for Shock Interaction and $\gamma$-Ray Emission in Classical Novae](https://arxiv.org/abs/2604.06310) <a id="link37"></a>
...
**Comment:** The paper presents a model for shock interaction and gamma-ray emission in classical novae, focusing on particle acceleration and emission processes. It is not related to the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 38. [Complex Nuclear Structure in Seyfert 2 Galaxy NGC 4388 Revealed by XRISM Observation](https://arxiv.org/abs/2604.06719) <a id="link38"></a>
...
**Comment:** The paper analyzes the nuclear structure of the Seyfert 2 galaxy NGC 4388 using XRISM and NuSTAR observations, focusing on Fe K-alpha line profiles and AGN structure. It is not related to dwarf galaxies, star formation histories, or galaxy simulations.
...
## 39. [RadioAstron reveals a change in the jet collimation profile of 3C 84](https://arxiv.org/abs/2604.06803) <a id="link39"></a>
...
**Comment:** The study investigates jet collimation in the radio galaxy 3C 84, focusing on AGN jet physics and not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 40. [Data-Driven Constraints on Magnetar Population: No Evidence for a Distinct White Dwarf Channel](https://arxiv.org/abs/2604.06472) <a id="link40"></a>
...
**Comment:** This paper analyzes the magnetar population and tests for a white dwarf channel, focusing on compact objects and not on galaxies, star formation, or stellar models.
...
## 41. [Probing the accretion geometry of the transient accreting millisecond pulsar SAX J1808.4-3658: transitions to the propeller regime](https://arxiv.org/abs/2604.06933) <a id="link41"></a>
...
**Comment:** The paper analyzes accretion geometry and transitions in a millisecond pulsar using X-ray observations. It focuses on accretion physics and neutron stars, not on galaxy simulations, star formation histories, or near-field cosmology.
...
## 42. [No Period Change in Two Long-Period AM CVn Binaries](https://arxiv.org/abs/2604.06460) <a id="link42"></a>
...
**Comment:** This paper studies period changes in AM CVn binaries, focusing on angular momentum loss and gravitational wave emission. While it is relevant to compact binaries and gravitational wave astrophysics, it does not match any of the core topics.
...
## 43. [Analytic Approximations for Fermionic Preheating](https://arxiv.org/abs/2604.07326) <a id="link43"></a>
...
**Comment:** The paper analyzes fermion production during preheating in the early universe, which is a theoretical cosmology topic. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 44. [Tracing the dynamical and structural complexity of spiral galaxy centres](https://arxiv.org/abs/2604.07297) <a id="link44"></a>
...
**Comment:** This paper focuses on the structural and dynamical complexity of spiral galaxy centres, specifically intermediate-to-massive spirals. The main focus is on bulge and disk decomposition, stellar population properties, and orbital structure in galaxy centres. It does not address dwarf galaxies, satellite systems, resolved star formation histories, quenching, or outflows. The focus on galaxy centres and bulges is explicitly listed as irrelevant in the criteria.
...
## 45. [Storm-Driven Suppression and Post-Storm Enhancement of Photographic Plate Transient Detections at Geosynchronous Altitude: Empirical Evidence and a Candidate Dusty Plasma Mechanism](https://arxiv.org/abs/2604.06234) <a id="link45"></a>
...
**Comment:** The paper investigates optical transients at geosynchronous altitude, proposing a mechanism involving magnetospheric dust and geomagnetic storms. There is no direct connection to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or outflows. The focus is on magnetospheric phenomena and dust, not galaxies or their evolution.
...
## 46. [Science of Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](https://arxiv.org/abs/2604.06286) <a id="link46"></a>
...
**Comment:** The paper describes a novel gravitational wave detector concept (CHRONOS), which is unrelated to the core topics of galaxy evolution, star formation, or stellar models.
...
## 47. [UMI: A GPU-Accelerated Asymmetric Robust Estimator for Photometric Detrending in Exoplanet Transit Searches](https://arxiv.org/abs/2604.06602) <a id="link47"></a>
...
**Comment:** The paper presents a new method for photometric detrending in exoplanet transit searches. This is an instrumentation/methods paper for exoplanet detection and does not match any of the core topics.
...
## 48. [A 4.5-s Quasiperiodic Spectral Oscillation in GRB 230307A: Evidence for Free Precession of a Post-Merger Magnetar?](https://arxiv.org/abs/2604.06828) <a id="link48"></a>
...
**Comment:** This paper reports quasiperiodic spectral oscillations in a GRB, interpreted as evidence for free precession of a post-merger magnetar. The focus is on GRB central engines and neutron star mergers, not on galaxy-scale phenomena, dwarf galaxies, star formation histories, or outflows. No relevant criteria matched.
...
## 49. [Cosmological Dynamics of Exponential Quintessence Constrained by BAO, Cosmic Chronometers, and DES-SN5YR/Pantheon+ Data](https://arxiv.org/abs/2604.06941) <a id="link49"></a>
...
**Comment:** Cosmological model testing using large-scale structure and supernovae data; does not address galaxy-scale processes, dwarf galaxies, or star formation histories.
...
## 50. [Neutron Star Merger Rates from Multi-messenger Observations: Clues to the Physical Origin of the Short and Long-short Gamma-ray Bursts](https://arxiv.org/abs/2604.06772) <a id="link50"></a>
...
**Comment:** Discusses neutron star merger rates and their connection to gamma-ray bursts. No direct relevance to galaxy evolution, star formation histories, or near-field cosmology.
...
## 51. [Multi-scale Gas Structure and Dynamics in an Extragalactic Central Molecular Zone](https://arxiv.org/abs/2604.06354) <a id="link51"></a>
...
**Comment:** Examines molecular gas structure and dynamics in the central molecular zone of a nearby galaxy (NGC 3351). Focus is on ISM structure in a massive galaxy, not dwarf galaxies or satellite systems. No relevant criteria matched.
...
## 52. [Loop Blow-up Inflation: An Overview](https://arxiv.org/abs/2604.07288) <a id="link52"></a>
...
**Comment:** This paper focuses on inflationary dynamics and string loop corrections, with cosmological predictions compared to CMB and BAO data. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 53. [Determining the Host Stars of Planets in Binary Star Systems with Asterodensity Profiling: Investigating the Canonical Radius Gap](https://arxiv.org/abs/2604.06388) <a id="link53"></a>
...
**Comment:** The paper discusses exoplanet radius distributions in binary star systems, which does not match any of the core topics (no connection to dwarf galaxies, star formation histories, or galaxy simulations).
...
## 54. [Reliability of uGMRT Band-4 Polarimetry: Results from a Quadrature Hybrid Polarizer Bypass Experiment](https://arxiv.org/abs/2604.06399) <a id="link54"></a>
...
**Comment:** This paper focuses on polarimetric calibration for the uGMRT, which is a radio instrumentation/engineering topic. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 56. [Phase spirals induced by the gas warp](https://arxiv.org/abs/2604.06862) <a id="link56"></a>
...
**Comment:** The paper studies phase spirals in the Milky Way disk induced by gas warps using N-body + SPH simulations. However, it focuses on the Galactic disk and perturbations rather than satellite galaxies, star formation histories, or galaxy simulations relevant to the core topics. No direct match to any criteria.
...
## 57. [An astrometric search for planets in debris disk systems](https://arxiv.org/abs/2604.07068) <a id="link57"></a>
...
**Comment:** This paper uses astrometric data to search for planets in debris disk systems. While it involves numerical analysis and exoplanetary systems, it does not address galaxy-scale simulations, star formation histories, or outflows. The focus is on planetary systems and debris disks, which are outside the core topics.
...
## 58. [Neutrino transport and flavor instabilities in a post-merger disk](https://arxiv.org/abs/2604.06404) <a id="link58"></a>
...
**Comment:** This paper studies neutrino transport and flavor instabilities in neutron star merger post-merger disks. It is unrelated to the core topics, as it focuses on compact object mergers and neutrino physics rather than galaxies, star formation, or stellar models.
...
## 59. [A TESS Test of the Hybrid Ring Strategy for Technosignature Searches Using GRB 221009A](https://arxiv.org/abs/2604.06807) <a id="link59"></a>
...
**Comment:** This paper tests a technosignature search strategy using TESS and GRB 221009A, which is not relevant to any of the core topics.
...
## 60. [Gravitational wave signal and noise response of an optically levitated sensor in a Fabry-P\'erot cavity](https://arxiv.org/abs/2604.07302) <a id="link60"></a>
...
**Comment:** The paper discusses optically levitated sensors for gravitational wave detection, which is not relevant to the core topics.
...
## 61. [Gauge Theoretic Signal Processing I: The Commutative Formalism for Single-Detector Adaptive Whitening](https://arxiv.org/abs/2604.06432) <a id="link61"></a>
...
**Comment:** This paper develops a geometric framework for adaptive whitening in gravitational-wave detectors, which is a signal processing/methods paper for gravitational wave instrumentation. It does not address any of the core topics.
...
## 62. [Clues for the accretion regulated dust torus in the changing-look AGN SDSS J101152.98+544206.4](https://arxiv.org/abs/2604.07024) <a id="link62"></a>
...
**Comment:** The paper studies the dust torus in a changing-look AGN, focusing on accretion regulation and variability. The focus is on AGN structure and dust torus dynamics, not on galaxy-scale phenomena, dwarf galaxies, star formation histories, or outflows. No relevant criteria matched.
...
## 63. [Effects of Geomagnetic Cutoff Rigidity Variations during Forbush Decreases](https://arxiv.org/abs/2604.06857) <a id="link63"></a>
...
**Comment:** Studies cosmic ray flux variations during geomagnetic storms and Forbush decreases, focusing on heliospheric and geomagnetic effects. No relevance to galaxy evolution, star formation, or near-field cosmology.
...
## 64. [Theoretical and Observational Bounds on Dynamical Chern-Simons Gravity as an Effective Field Theory](https://arxiv.org/abs/2604.07332) <a id="link64"></a>
...
**Comment:** Theoretical bounds on dynamical Chern-Simons gravity as an effective field theory. Focus is on gravitational theory and modifications to GR, not related to galaxy simulations, stellar models, or any core topics.
...
## 65. [Shadow, Sparsity of Radiation and Energy Emission Rate in Skyrmion Black Holes](https://arxiv.org/abs/2604.06259) <a id="link65"></a>
...
**Comment:** The paper studies optical properties and Hawking radiation of Skyrmion black holes, which is a theoretical black hole physics topic and not related to any of the core topics.
...
## 66. [Solitary wave structure of transitional flow in the wake of a sphere](https://arxiv.org/abs/2604.06965) <a id="link66"></a>
...
**Comment:** This paper investigates soliton-like coherent structures in transitional and turbulent boundary layers in the wake of a sphere, which is a fluid dynamics topic and not related to any of the core topics.
...
## 67. [Plasma Dynamics of Radiative Cooling Accretion Flow in AM Herculis with XRISM](https://arxiv.org/abs/2604.06591) <a id="link67"></a>
...
**Comment:** This paper presents high-resolution X-ray spectroscopy of a magnetic cataclysmic variable (AM Herculis), focusing on plasma dynamics and accretion columns. The study is about accretion physics in a binary system, not galaxy-scale phenomena, dwarf galaxies, star formation histories, or outflows. No relevant criteria matched.
...
## 68. [Big Bang revisited](https://arxiv.org/abs/2604.00077) <a id="link68"></a>
...
**Comment:** Discusses the Big Bang singularity and possible extensions to Einstein's equations; not related to galaxy evolution, star formation, or near-field cosmology.
...
## 69. [Solar Neutrino Flux Fluctuations Caused by Solar Gravity Modes](https://arxiv.org/abs/2604.06535) <a id="link69"></a>
...
**Comment:** Studies solar neutrino flux fluctuations due to solar gravity modes. Focus is on solar physics and neutrino detection, not related to any of the core galaxy or stellar model criteria.
...
## 70. [New insights from cross-correlation studies between solar activity indices and cosmic-ray flux during Forbush decrease events](https://arxiv.org/abs/2604.06383) <a id="link70"></a>
...
**Comment:** This paper focuses on solar activity and cosmic ray flux during Forbush decrease events, which is unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 71. [A Major Geomagnetic Storm in 2024 October Linked to Sympathetic CME--Prominence Eruptions](https://arxiv.org/abs/2604.06786) <a id="link71"></a>
...
**Comment:** This paper analyzes a geomagnetic storm caused by interacting CMEs, focusing on solar-terrestrial physics and space weather prediction, which is not relevant to the core topics.
...
## 72. [Constraints on a fifth force from the stellar orbits around the central supermassive black hole of the Milky Way](https://arxiv.org/abs/2604.06364) <a id="link72"></a>
...
**Comment:** The paper investigates the presence of a fifth force at the Galactic Center, focusing on stellar orbits around the central supermassive black hole. The focus on the Galactic Center and SMBH is explicitly listed as irrelevant. No connection to satellite galaxies, star formation histories, quenching, or outflows.
...
## 73. [An Aligned Very-Low-Mass Star Orbiting an M dwarf and Obliquity Patterns Across Giant Planets, Brown Dwarfs, and Binary Stars](https://arxiv.org/abs/2604.06595) <a id="link73"></a>
...
**Comment:** This paper measures stellar obliquity in a double M dwarf system and compares obliquity patterns across giant planets, brown dwarfs, and binary stars. It does not address any of the core criteria such as near-field cosmology, star formation histories, quenching, or galaxy simulations.
...
## 74. [The new Geological Age that never was or the multiple layers of the Transientocene](https://arxiv.org/abs/2604.06224) <a id="link74"></a>
...
**Comment:** This is a perspective piece on the Anthropocene and its rejection as a geological epoch. It is unrelated to astrophysics or any of the core topics.
