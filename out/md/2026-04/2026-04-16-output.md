...
1. [A Unified HI Rotation Curve Corpus for Computational Astrophysics: 438 Galaxies from SPARC, THINGS, LITTLE THINGS, and WALLABY DR2](#user-content-link1)
**Authors:** David C. Flynn

2. [Substructures of the Milky Way's Retrograde Halo: Evidence for Multiple Accretion Events](#user-content-link2)
**Authors:** Young Kwang Kim, Young Sun Lee, Timothy C. Beers

3. [Witnessing the onset of stellar winds in Super-Luminous Supernova Hosts: implications for star-formation-driven outflows in low and high-redshift galaxies](#user-content-link3)
**Authors:** A. Saldana-Lopez (SU), A. Gkini (SU), M. J. Hayes (SU), R. Lunnan (SU), C. A. Carr, M. Huberty, C. Scarlata, S. Schulze, J. Sollerman

4. [Fundamental effective temperature measurements for eclipsing binary stars -- VIII. NIRPS spectroscopy of CD-27 2812](#user-content-link4)
**Authors:** N. J. Adshead, P. F. L. Maxted, A. Hahlin

5. [The DECam MAGIC Survey: Investigating the Jet Stellar Stream with Photometric Metallicities](#user-content-link5)
**Authors:** H Q. Do, A. Chiti, P. S. Ferguson, A. P. Ji, G. Limberg, K. Atzberger, J. Carlin, W. Cerny, A. Drlica-Wagner, G. F. Lewis, T. S. Li, S. L. Martell, G. E. Medina, N. E. D. Noel, A. B. Pace, V. Placco, A. H. Riley, D. J. Sand, G. S. Stringfellow, J. A. Carballo-Bello, D. Erkal, S. E. Koposov, B. Mutlu-Pakdil, M. Navabi, N. Shipp, A. K. Vivas, A. Zenteno, D. Zucker

6. [CHARA Interferometry and TESS Asteroseismology of the Core-Helium Burning Red Giant $\kappa$ Cyg](#user-content-link6)
...
7. [Phlegethon: a fully compressible magnetohydrodynamic code for simulations in stellar astrophysics](#user-content-link7)
...
8. [From Clumps to Sheets: Geometry Controls the Temperature PDF of Multi-Phase Gas](#user-content-link8)
**Authors:** Zirui Chen, S. Peng Oh

9. [Investigating the Circumgalactic Medium through Mg II absorption coincidence](#user-content-link9)
**Authors:** Paryag Sharma, Raghunathan Srianand, Hum Chand, Labanya Kumar Guha

10. [Sparks II: Panchromatic SED modeling and galaxy physical properties across the starburst to post-starburst sequence](#user-content-link10)
**Authors:** Dalya Baron, David J. Setton, Yilun Ma, J. X. Prochaska, Ric Davies, Jenny E. Greene, Dieter Lutz

11. [Massive star clusters and clumps in the collisional ring galaxy Arp 147](#user-content-link11)
**Authors:** Z. Randriamanakoto, M. Rakototafika, B. Mongwane, P. V\"ais\"anen, M. Rakotomanga

12. [A Salpeter-like filament linear density function across nearby molecular clouds](#user-content-link12)
**Authors:** Guo-Yin Zhang, Alexander Men'shchikov, Jin-Zeng Li

13. [Dark energy, spatial curvature, and star formation efficiency from JWST photometric and spectroscopic high-redshift galaxies](#user-content-link13)
**Authors:** Leonardo Comini, Sunny Vagnozzi, Abraham Loeb

14. [Radial Distribution of Star Formation and Gas-phase Metallicity in Spiral-Elliptical Galaxy Pairs](#user-content-link14)
**Authors:** Cailu Shi, Shuai Feng, Shiyin Shen, Linlin Li, Wenyuan Cui, Guozhen Hu

15. [A spatial and kinematical reinterpretation of Gould's Belt in light of Gaia](#user-content-link15)
**Authors:** Michelangelo Pantaleoni Gonz\'alez, Jo\~ao Alves, Cameren Swiggum, Isak Niederbrunner

16. [Sparks: The Magellan/FIRE survey from starburst to post-starburst](#user-content-link16)
**Authors:** Dalya Baron, David J. Setton, Yilun Ma, J. X. Prochaska, Gabriela Canalizo, Ric Davies, Jenny E. Greene, Dieter Lutz

17. [The Great Escape of ionizing photons during Cosmic Morning](#user-content-link17)
...
18. [Deriving volume density profiles of filaments from observed surface densities](#user-content-link18)
**Authors:** Alexander Men'shchikov, Guo-Yin Zhang

19. [Denoising clustering covariance matrices with Rotational Invariant Estimators](#user-content-link19)
**Authors:** Antonio Farina, Massimo Guidi, Alfonso Veropalumbo, Claudio Guida

20. [Resolving circumgalactic gas flows around a z$\approx$3.6 quasar using MUSE and ALMA](#user-content-link20)
**Authors:** M. Galbiati, A. Pensabene, S. Cantalupo, A. Travascio, G. Pezzulli, R. Decarli, R. Dutta, S. Muzahid, J. Schaye, T. Lazeyras, N. Ledos, G. Quadri, W. Wang

21. [ALESS--JWST: Dust-driven Morphologies and Hidden Stellar Mass in $z\sim3$ Sub-millimeter Galaxies](#user-content-link21)
**Authors:** J. Li, E. da Cunha, J. A. Hodge, I. Smail, S. Kendrew, A. battisti, M. Cracraft, L. A. Boogaard, W. N. Brandt, C. -C. Chen, P. Cox, K. K. Knudsen, C. -L. Liao, G. Calistro Rivera, M. Rybak, A. M. Swinbank, P. van der Werf, F. Walter, A. Weiss, B. A. Westoby

22. [The ALMA-QUARKS Survey: Multipolar episodic molecular outflow associated with W49N, the most energetic water maser source in the Milky Way](#user-content-link22)
...
23. [Into the Gompverse: A robust Gompertzian reionization model for CMB analyses](#user-content-link23)
**Authors:** Paulo Montero-Camacho, Yin Li, Marco Barquero-Hern\'andez, Pablo Renard, Yang Wang, Xiao-Dong Li

24. [Galactic Rain: Cool Gas Inflows in Red Geyser Galaxies and Their Connection to AGN Activity and Interactions](#user-content-link24)
**Authors:** Arian Moghni, Namrata Roy, Timothy M. Heckman, Kevin Bundy, Kyle B. Westfall, Kate H. R. Rubin

25. [CHILES XII: The H I evolution of Luminous Compact Blue Galaxies](#user-content-link25)
**Authors:** H. Arlow, D. J. Pisano, M. A. Bershady, L. R. Hunt, N. Luber, J. Donovan Meyer, E. Momjian, J. Blue Bird, H. B. Gim

26. [The Radial and Vertical Structure of Molecular Gas in the Edge-On Galaxy NGC 4565](#user-content-link26)
**Authors:** Grace Krahm, Adam K. Leroy, Jiayi Sun, Kijeong Yim, Eric W. Koch, Tony Wong, Deanne Fisher, Erik Rosolowsky, Karin Sandstrom, Dyas Utomo, Jesse van de Sande, Marie Martig, Amelia Fraser-McKelvie, Michael R. Hayden

27. [JWST spectroscopy of SN 2010da/NGC 300 ULX-1: a surviving star hidden by dust](#user-content-link27)
**Authors:** Emma R. Beasor, Ryan Lau, Nathan Smith, Dominic J. Walton, Marianne Heida, Ben Davies

28. [Enhancing Ly{\alpha} Emitter Identification in HETDEX with a Convolutional Neural Network](#user-content-link28)
...
29. [JOYS$+$: A JWST/MIRI survey of the evolution of H$_2$ winds and jets from low-mass protostars](#user-content-link29)
**Authors:** L. Francis, {\L}. Tychoniec, E. F. van Dishoeck, A. D. Sellek, A. Caratti o Garatti, V. J. M. Le Gouellec, C. Gieser, H. Beuther, J. M. Vorster, M. E. Ressler, P. Nazari, B. Tabone, K. Assani, R. Devaraj, J. J. Tobin, Maria Gabriela Navarro, P. C. Cort\'es, J. M. Girart, M. G\"udel, Th. Henning, G. \"Ostlin, G. Wright, T. Ray

30. [The 256-antenna Coherent All-Sky Monitor](#user-content-link30)
**Authors:** Liam Connor, Vikram Ravi, Pranav Sanghavi, Vishnu Balakrishan, Luke Chung, Saren Daghlian, Liam Dunn, Anthony Griffin, Charlie Harnach, Mark Hodges, Andrew Jameson, Michael Gutierrez, Calvin Leung, Mei Lin, Advait Mehla, Obinna Modilim, Nimesh Patel, Kendrick Smith, Lingzhen Zeng

31. [Potentials of axisymmetric razor-thin disks](#user-content-link31)
**Authors:** J. An

32. [21 cm Power Spectrum Analysis of North Celestial Pole Observations with the Tianlai Dish Pathfinder Array](#user-content-link32)
...
33. [A Dynamical Test for Cooling-Induced Entrainment in a Runaway Supermassive Black Hole Tail](#user-content-link33)
**Authors:** Ish Kaul, S. Peng Oh

34. [FRTSearch: Unified Detection and Parameter Inference of Fast Radio Transients using Instance Segmentation](#user-content-link34)
...
35. [Search for CBCs with SSM Components in Data from The First Part of LVK Fourth Observing Run](#user-content-link35)
**Authors:** Ines Bentara

36. [Solar photospheric spectrum microvariability III. Radial velocities and line profiles in magnetic active-region granulation](#user-content-link36)
**Authors:** Dainis Dravins, Hans-G\"unter Ludwig, Matthias Steffen, Carlos Allende Prieto, Lars Koesterke

37. [M1-92: AGB interruption and isotopic ratio paradox. Chemistry and morpho-kinematics from improved shapemol modelling](#user-content-link37)
**Authors:** E. Masa, J. Alcolea, M. Santander-Garc\'ia, V. Bujarrabal, C. S\'anchez Contreras, A. Castro-Carrizo, W. Steffen, N. Koning

38. [Radiative cooling effects on black hole hot accretion flows around the sub-Bondi radius](#user-content-link38)
**Authors:** Mu-Qing Liu, Xiao-Hong Yang, De-Fu Bu

39. [4MOST ChANGES: Catalog of high-redshift quasar candidates (4.5 < $z$ < 7) selected with SED fitting](#user-content-link39)
**Authors:** T. Mkrtchyan, C. Mazzucchelli, R. J. Assef, M. J. Temple, A. Rojas-Lilay\'u, F. E. Bauer, V. Toptun, J. A. Acevedo Barroso, S. Belladitta, E. P. Farina, L. N. Mart\'inez-Ram\'irez, G. Papini, S. Satheesh-Sheeba, D. Stern, A. Upadhyayula

40. [Reconstructing inflationary features on large scales using genetic algorithm](#user-content-link40)
**Authors:** Alipriyo Hoory, Dhiraj Kumar Hazra, L. Sriramkumar

41. [Searching for axions with quantum interferometry](#user-content-link41)
**Authors:** Tanmay Kumar Poddar, Michael Spannowsky

42. [Double the axions, half the tension: multi-field early dark energy eases the Hubble tension](#user-content-link42)
**Authors:** Marco Bella, Vivian Poulin, Sunny Vagnozzi, Lloyd Knox

43. [TDCOSMO XXV: A "soup-to-nuts" 6.5% $H_0$ measurement $-$ strong lensing and dynamics with a maximally flexible mass sheet](#user-content-link43)
**Authors:** William Sheu, Tommaso Treu, Martin Millon, Fr\'ed\'eric Dux, Devon Williams, Shawn Knabel, Simon Birrer, Pritom Mozumdar, Giacomo Queirolo, Anowar J. Shajib, Michele Cappellari, Kenneth C. Wong, Ildar M. Asfandiyarov, Otabek A. Burkhonov, Fr\'ed\'eric Courbin, Shuhrat A. Ehgamberdiev, Sof\'ia Rojas-Ruiz, Asadulla M. Shaymanov, Talat A. Akhunov

44. [Variability classification of TESS targets in LOPS2, the first long-term pointing field of PLATO. Version 1 of the public variability catalogue](#user-content-link44)
...
45. [Reanalysing large-scale structure using an updated gamma-ray burst spatial density approach](#user-content-link45)
**Authors:** Istvan Horvath, Zsolt Bagoly, Jon Hakkila, Lajos G. Balazs, Janos Horvath, Sandor Pinter, Istvan I. Racz, Peter Veres, L. Viktor Toth

46. [Bayesian Analysis of Gravitational Wave Microlensing Effects from Galactic Double White Dwarfs](#user-content-link46)
**Authors:** Yan Sun, Yong Yuan, Minghui Du, Wen-Fan Feng, Xilong Fan, Peng Xu

47. [A note on Gurzadyan theorem](#user-content-link47)
**Authors:** Christian Carimalo

48. [Persephone's Torch: A 15th Magnitude Quadruply-Lensed Quasar From the Couch Discovered with SPHEREx and the LBT](#user-content-link48)
**Authors:** Frederick B. Davies, Eduardo Ba\~nados, Sarah E. I. Bosman, Arpita Ganguly, Silvia Belladitta, Jennifer Power, Jon Rees

49. [Rings Around Non-Spherical Worlds: Sub-mm Dust Retention Around Triaxial Small Bodies in the Solar System](#user-content-link49)
**Authors:** Zs. Regaly, V. Frohlich, Cs. Kalup, Cs. Kiss

50. [Radiation hydrodynamic simulations for the origin of quasi-periodic oscillations for accretion onto supermassive black holes](#user-content-link50)
**Authors:** Yiyang Lin, Erlin Qiao, Jifeng Liu, Meng Guo, Zikun Lin

51. [Observational constraints on nonlocal black holes via gravitational lensing](#user-content-link51)
**Authors:** Rocco D'Agostino, Vittorio De Falco

52. [In Situ Interferometric Spatial Mapping Of A Microwave Kinetic Inductance Detector Array](#user-content-link52)
...
53. [Optical depth to reionization in a Universe with multiple inhomogeneous domains](#user-content-link53)
**Authors:** Shashank Shekhar Pandey, Ruchika, Subhadeep Mukherjee, A. S. Majumdar

54. [CII fine-structure line observations of the Sagittarius C Region in the Galaxy's Central Molecular Zone](#user-content-link54)
...
55. [SN 2022riv in RX J2129: Discovery, Spectroscopic Classification, and Microlensing of a Strongly Lensed Type Ia Supernova from JWST and HST Observations](#user-content-link55)
...
56. [BROOM: a python package for model-independent analysis of microwave astronomical data](#user-content-link56)
**Authors:** Alessandro Carones, Sijil Jose, Aliza Mustafa, Nicoletta Krachmalnicoff, Carlo Baccigalupi

57. [Radial Velocity Evidence for a Post-Mass-Transfer Massive Binary System: NaSt1](#user-content-link57)
...
58. [Axion Inflation from Heavy-Fermion One-Loop Effects](#user-content-link58)
**Authors:** Kai-Ge Zhang, Jian-Feng He, Chengjie Fu, Zong-Kuan Guo

59. [SJET: An Interactive Solar Jet Extraction Tool](#user-content-link59)
**Authors:** Song Tan, Alexander Warmuth, Fr\'ed\'eric Schuller, Yuandeng Shen, Yue Fang, Jake A. J. Mitchell, Zedong Liu

60. [Robust parameter inference for Taiji via time-frequency contrastive learning and normalizing flows](#user-content-link60)
**Authors:** Tian-Yang Sun, Bo Liang, Ji-Yu Song, Song-Tao Liu, Shang-Jie Jin, He Wang, Ming-Hui Du, Jing-Fei Zhang, Xin Zhang

61. [Basilic: An end-to-end pipeline for Bayesian burst inference and model classification in gravitational-wave data](#user-content-link61)
**Authors:** Iuliu Cuceu, Marie Anne Bizouard

62. [Analysis of Lyman-beta and Lyman-gamma Lines in a Pre-Eruptive and Eruptive Prominence with Solar Orbiter SPICE Observations](#user-content-link62)
**Authors:** Yong Zhang (SUPA School of Physics and Astronomy, University of Glasgow, Glasgow G12 8QQ UK), Nicolas Labrosse (SUPA School of Physics and Astronomy, University of Glasgow, Glasgow G12 8QQ UK), Susanna Parenti (Institut d'Astrophysique Spatiale, Bat 121, Universit\'e Paris-Saclay/CNRS 91405 Orsay Cedex France), Therese A. Kucera (Heliophysics Science Division, NASA Goddard Space Flight Center, Greenbelt, MD, 20771 USA)

63. [A Search for Hydroacoustic Signals from Bolides](#user-content-link63)
**Authors:** P. Brown, L. McFadden, D. McCormack, M. Adams, D. Vida

64. [Prospects for GRB Afterglow Discovery with the Eric and Wendy Schmidt Observatory System](#user-content-link64)
**Authors:** James Freeburn, Dougal Dobie, Akash Anumarlapudi, Igor Andreoni, Brendan O'Connor, Eric Burns, Jonathan Carney, Hank Corbett, Michael W. Coughlin, Anna Tartaglia, V. Ashley Villar

65. [Understanding mechanisms underlying solar cycle predictability with a general framework](#user-content-link65)
**Authors:** Binghang Li, Jie Jiang, Yukun Luo

66. [Fast Neutrino-Flavor Conversion with Attenuation and Global Lepton Gradient](#user-content-link66)
**Authors:** Masamichi Zaizen, Hiroki Nagakura

67. [Correlation between Ultra-High-Energy Neutrino KM3-230213A and Gamma-Ray Bursts](#user-content-link67)
**Authors:** Ruiqi Wang, Bo-Qiang Ma

68. [Gravitational Sommerfeld Effects: Formalism, Renormalization, and Perturbation to $O(G^{10})$](#user-content-link68)
**Authors:** Chih-Hao Chang, Chia-Hsien Shen, Zihan Zhou

69. [Not too close! Evaluating the impact of the baseline on the localization of binary black holes by next-generation gravitational-wave detectors](#user-content-link69)
**Authors:** Francesco Iacovelli, Luca Reali, Emanuele Berti, Alessandra Corsi, B. S. Sathyaprakash, Digvijay Wadekar

70. [The NuSTAR view of Ultra-Compact X-ray Binaries](#user-content-link70)
**Authors:** A. Borghese, M. Armas Padilla, T. Mu\~noz-Darias

71. [Simulation of non X-ray background for the DIffuse X-ray Explorer (DIXE) mission](#user-content-link71)
**Authors:** Ruixuan Tian, Junjie Mao, Jiejia Liu, Hai Jin, Wei Cui

72. [Relaxation of magnetically-confined mountains on accreting neutron stars through cross-field mass transport](#user-content-link72)
**Authors:** Ryan Brunet, Andrew Melatos, Pedro Rossetto

73. [Targeted search for eccentric supermassive binary black holes in OJ 287 and nearby galaxy clusters with PPTA DR3](#user-content-link73)
**Authors:** Shi-Yi Zhao, Xingjiang Zhu, Jacob Cardinal Tremblay, Yiqin Chen, Ma{\l}gorzata Cury{\l}o, Shi Dai, Valentina Di Marco, Pratyasha Gitika, George Hobbs, Simon C. -C. Ho, Xiao-Song Hu, Agastya Kapur, Wenhua Ling, Richard N. Manchester, Saurav Mishra, Daniel J. Reardon, Christopher J. Russell, Ryan M. Shannon, Sharon Mary Tomson, Jingbo Wang, Shuangqiang Wang, Andrew Zic

74. [Investigating the effect of sensitivity of KAGRA on sky localization of gravitational-wave sources from compact binary coalescences](#user-content-link74)
**Authors:** Alvin K. Y. Li, Peony K. K. Lai, Elwin K. Y. Li, Otto A. Hannuksela

75. [Non-LTE Analysis of Pre-eruptive Prominence Plasma Parameters Effects on the Lyman-beta and Lyman-gamma Lines with Solar Orbiter SPICE Observations](#user-content-link75)
...
76. [Analysis of Eruptive Prominence Plasma Parameters' Effects on the \ion{He}{2} 304~\AA\ Line with Solar Orbiter EUI Observations](#user-content-link76)
**Authors:** Yong Zhang, Nicolas Labrosse, Sargam M. Mulay

77. [Prominence Plasma Parameters Maps Inferred From Lyman $\beta$ and Lyman $\gamma$ Observations and Non-LTE Modelling](#user-content-link77)
**Authors:** Y. Zhang, N. Labrosse, T. A. Kucera, S. Parenti

78. [Probing Coronal Activity Using Radio Signals Based on the 2021 superior conjunction of Mars: the Downlink Data from Tianwen-1](#user-content-link78)
**Authors:** Yu-Chen Liu, De-Qing Kong, Song Tan, Zi-Han Zhao, Zan Wang, Dong-Hao Liu, Xin-Ying Zhu, Yan Su, Hong-Bo Zhang

79. [Large-scale Morphology of the Optical F-corona from a Total Solar Eclipse Observation During the Artemis II Lunar Flyby](#user-content-link79)
**Authors:** Kohji Tsumura, Ko Arimatsu

80. [Shock properties for solar energetic particle events with signatures of inverse velocity arrival](#user-content-link80)
**Authors:** A. Kouloumvakos, D. Lario, G. M. Mason, A. Vourlidas, R. C. Allen, N. Wijsen, X. Chen, Z. Ding, I. C. Jebaraj, P. Riley, D. J. McComas, C. M. S. Cohen, E. Paouris, S. Raptis, L. Rodr\'iguez-Garc\'ia, Z. G. Xu, G. D. Berland, G. C. Ho, D. G. Mitchell, E. C. Roelof, J. Rodriguez-Pacheco, M. E. Hill, R. F. Wimmer-Schweingruber

81. [Amerigo Vespucci and the discovery of the Southern Sky](#user-content-link81)
**Authors:** Davide Neri

82. [Frequency & Radiative Analysis of Random Yagi-UHF/VHF Phased Array](#user-content-link82)
**Authors:** Luis M. Bres, Luis A. Hernandez, Teviet D. Creighton

---

## 1. [A Unified HI Rotation Curve Corpus for Computational Astrophysics: 438 Galaxies from SPARC, THINGS, LITTLE THINGS, and WALLABY DR2](https://arxiv.org/abs/2604.13489) <a id="link1"></a>
...
**Comment:** Provides a unified corpus of HI rotation curves for 438 galaxies, including many from SPARC, THINGS, LITTLE THINGS, and WALLABY. This is highly relevant for near-field cosmology, dark matter density profiles (core-cusp), and satellite galaxy studies. The dataset enables foundational analysis for these topics.
...
## 2. [Substructures of the Milky Way's Retrograde Halo: Evidence for Multiple Accretion Events](https://arxiv.org/abs/2604.13482) <a id="link2"></a>
...
**Comment:** Investigates retrograde substructures in the Milky Way halo, identifying multiple accretion events and progenitors. Directly relevant to 'Near-Field Cosmology' (accreted stellar halo, dwarf galaxy remnants, substructure), with strong focus on the assembly history of the MW halo.
...
## 3. [Witnessing the onset of stellar winds in Super-Luminous Supernova Hosts: implications for star-formation-driven outflows in low and high-redshift galaxies](https://arxiv.org/abs/2604.13865) <a id="link3"></a>
...
**Comment:** Directly matches the 'Star Formation Driven Outflows' criterion, with observational constraints on stellar-wind-driven outflows in low-mass galaxies and measurements of mass-loading factors. Also relevant to feedback in galaxy formation simulations.
...
## 4. [Fundamental effective temperature measurements for eclipsing binary stars -- VIII. NIRPS spectroscopy of CD-27 2812](https://arxiv.org/abs/2604.13631) <a id="link4"></a>
...
**Comment:** This paper presents accurate measurements of mass, radius, and effective temperature for M-dwarfs in eclipsing binaries, which can be used to test stellar models. This directly matches the 'Stellar Models' criterion, as it provides new constraints for low-mass stellar evolutionary tracks.
...
## 5. [The DECam MAGIC Survey: Investigating the Jet Stellar Stream with Photometric Metallicities](https://arxiv.org/abs/2604.13374) <a id="link5"></a>
...
**Comment:** This paper investigates the Jet stellar stream, a structure formed by tidal disruption of a globular cluster, using photometric metallicities and Gaia proper motions. It directly addresses near-field cosmology by probing the Milky Way's accretion history and dark matter substructure via stellar streams, matching the criteria for signs of historic interactions and substructure.
...
## 6. [CHARA Interferometry and TESS Asteroseismology of the Core-Helium Burning Red Giant $\kappa$ Cyg](https://arxiv.org/abs/2604.13501) <a id="link6"></a>
...
**Comment:** Combines interferometry and asteroseismology to test stellar evolutionary models for a core-helium burning red giant. Directly relevant to the 'Stellar Models' criterion, presenting new tests and highlighting deficiencies in current models.
...
## 7. [Phlegethon: a fully compressible magnetohydrodynamic code for simulations in stellar astrophysics](https://arxiv.org/abs/2604.12672) <a id="link7"></a>
...
**Comment:** This paper introduces a new fully compressible MHD code for multidimensional simulations in stellar astrophysics. It is highly relevant to the 'Stellar Models' criterion, as it enables modeling of stellar interior dynamics and evolutionary stages. The code is novel in its versatility and physical effects, representing a substantial improvement for stellar modeling.
...
## 8. [From Clumps to Sheets: Geometry Controls the Temperature PDF of Multi-Phase Gas](https://arxiv.org/abs/2604.13154) <a id="link8"></a>
...
**Comment:** This paper investigates the temperature probability distribution functions (PDFs) of multi-phase gas in both ISM and CGM conditions using 3D hydrodynamic simulations. It directly addresses the geometry and thermal structure of the CGM, with implications for the phase structure and mass fractions in the CGM and ISM. The discussion of the CGM, OVI reservoir, and mixing layers is highly relevant to the 'Circumgalactic Medium' and 'Numerical Galaxy Simulations' criteria, especially as it connects simulation results to observable properties and phase structure.
...
## 9. [Investigating the Circumgalactic Medium through Mg II absorption coincidence](https://arxiv.org/abs/2604.13162) <a id="link9"></a>
...
**Comment:** This paper presents a statistical measurement of the transverse coherence of Mg II absorption, probing the circumgalactic medium (CGM) using quasar sightline pairs. The focus is on the CGM, which is a core topic, though the sample is not specifically limited to dwarf galaxies. The methodology and results are highly relevant to CGM studies.
...
## 10. [Sparks II: Panchromatic SED modeling and galaxy physical properties across the starburst to post-starburst sequence](https://arxiv.org/abs/2604.13216) <a id="link10"></a>
...
**Comment:** This paper models panchromatic SEDs and galaxy physical properties across the starburst to post-starburst sequence, focusing on star formation rates and histories. It is relevant to resolved star formation histories and star formation quenching, though the sample is of massive galaxies rather than dwarfs. The methodology is robust and addresses SFR measurement challenges.
...
## 11. [Massive star clusters and clumps in the collisional ring galaxy Arp 147](https://arxiv.org/abs/2604.13655) <a id="link11"></a>
...
**Comment:** Photometric study of star clusters in the collisional ring galaxy Arp 147, tracing star formation history across the ring. This fits the 'Resolved Star Formation Histories' criterion, as it derives star formation histories from observed color-magnitude diagrams and cluster ages. The focus is on a specific galaxy, not dwarfs, but the methodology is directly relevant.
...
## 12. [A Salpeter-like filament linear density function across nearby molecular clouds](https://arxiv.org/abs/2604.14093) <a id="link12"></a>
...
**Comment:** Systematic analysis of filament linear density function in molecular clouds, connecting filamentary structure to the stellar initial mass function (IMF). This is relevant to 'Stellar Models' and 'Resolved Star Formation Histories' as it links gas structure to star formation and the IMF, though the focus is on molecular clouds rather than galaxies.
...
## 13. [Dark energy, spatial curvature, and star formation efficiency from JWST photometric and spectroscopic high-redshift galaxies](https://arxiv.org/abs/2604.13866) <a id="link13"></a>
...
**Comment:** This paper analyzes high-redshift galaxy abundances and star formation efficiency using JWST data, discussing implications for galaxy formation. It is relevant to star formation efficiency and galaxy formation, but does not directly address resolved star formation histories or dwarf galaxies.
...
## 14. [Radial Distribution of Star Formation and Gas-phase Metallicity in Spiral-Elliptical Galaxy Pairs](https://arxiv.org/abs/2604.14092) <a id="link14"></a>
...
**Comment:** Investigates star formation and metallicity in spiral galaxies in spiral-elliptical pairs, discussing star formation quenching and gas accretion suppression. While the focus is on spirals, the quenching mechanism is relevant, but not directly for dwarf galaxies.
...
## 15. [A spatial and kinematical reinterpretation of Gould's Belt in light of Gaia](https://arxiv.org/abs/2604.13225) <a id="link15"></a>
...
**Comment:** Reinterprets Gould's Belt using Gaia data, focusing on the spatial and kinematical structure of local young clusters and star formation history. Some relevance to 'Resolved Star Formation Histories' and local star formation, but not directly focused on dwarf galaxies or satellite systems.
...
## 16. [Sparks: The Magellan/FIRE survey from starburst to post-starburst](https://arxiv.org/abs/2604.13211) <a id="link16"></a>
...
**Comment:** Infrared survey of local massive galaxies, focusing on the transition from starburst to post-starburst and quenching. The paper discusses star formation quenching and star formation histories, but the focus is on massive galaxies, not dwarfs. Still, the methodology and results are relevant to the quenching criterion, though weighted lower.
...
## 18. [Deriving volume density profiles of filaments from observed surface densities](https://arxiv.org/abs/2604.12570) <a id="link18"></a>
...
**Comment:** This paper presents a new method for deriving volume density profiles of filaments in star-forming clouds from observed surface densities. It is relevant to stellar models and star formation, specifically the structure of filaments in star-forming regions, which is tangentially related to resolved star formation histories and stellar models, but not directly to galaxy-scale topics.
...
## 19. [Denoising clustering covariance matrices with Rotational Invariant Estimators](https://arxiv.org/abs/2604.13851) <a id="link19"></a>
...
**Comment:** The paper presents a new statistical estimator for galaxy clustering covariance matrices, which is relevant for cosmological parameter inference but does not directly address galaxy simulations, star formation histories, or near-field cosmology.
...
## 20. [Resolving circumgalactic gas flows around a z$\approx$3.6 quasar using MUSE and ALMA](https://arxiv.org/abs/2604.13159) <a id="link20"></a>
...
**Comment:** The paper studies circumgalactic gas flows around a high-redshift quasar using MUSE and ALMA. While it investigates the CGM, the focus is on a massive quasar host at z~3.6, not dwarf galaxies or the CGM of dwarfs. The relevance is borderline due to the CGM focus.
...
## 21. [ALESS--JWST: Dust-driven Morphologies and Hidden Stellar Mass in $z\sim3$ Sub-millimeter Galaxies](https://arxiv.org/abs/2604.13408) <a id="link21"></a>
...
**Comment:** JWST and ALMA observations of z~3 sub-millimeter galaxies, focusing on dust-driven morphologies and hidden stellar mass. While it discusses star formation and dust attenuation, the focus is on massive galaxies at high redshift, not dwarfs or resolved star formation histories. Some relevance for star formation quenching and stellar models, but weighted lower due to galaxy mass and redshift.
...
## 22. [The ALMA-QUARKS Survey: Multipolar episodic molecular outflow associated with W49N, the most energetic water maser source in the Milky Way](https://arxiv.org/abs/2604.13671) <a id="link22"></a>
...
**Comment:** This paper studies molecular outflows in a massive star-forming region (W49N) in the Milky Way. While it discusses star-formation-driven outflows, the focus is on a massive star-forming region, not dwarf galaxies or galaxy-scale outflows. The relevance is borderline, as the mechanisms may be analogous but the context is not directly aligned with the core topics.
...
## 23. [Into the Gompverse: A robust Gompertzian reionization model for CMB analyses](https://arxiv.org/abs/2604.13423) <a id="link23"></a>
...
**Comment:** Presents a new physically motivated reionization model for CMB analyses, connecting cosmology and reionization. While reionization is a broad cosmological topic, the paper does not focus on near-field cosmology, dwarf galaxies, or resolved star formation histories.
...
## 24. [Galactic Rain: Cool Gas Inflows in Red Geyser Galaxies and Their Connection to AGN Activity and Interactions](https://arxiv.org/abs/2604.13195) <a id="link24"></a>
...
**Comment:** This paper studies cool gas inflows in massive, quiescent galaxies (red geysers), their connection to AGN activity, and galaxy interactions. It focuses on galaxies much more massive than the LMC and does not address dwarf galaxies, satellite quenching, or CGM in dwarfs. The topic of gas inflows and quenching is relevant but only peripherally, as it is not focused on dwarfs.
...
## 25. [CHILES XII: The H I evolution of Luminous Compact Blue Galaxies](https://arxiv.org/abs/2604.13679) <a id="link25"></a>
...
**Comment:** The paper studies HI evolution in Luminous Compact Blue Galaxies, focusing on gas fractions and depletion timescales. While it discusses star formation and gas content, LCBGs are not dwarf galaxies and the focus is not on resolved star formation histories or quenching.
...
## 26. [The Radial and Vertical Structure of Molecular Gas in the Edge-On Galaxy NGC 4565](https://arxiv.org/abs/2604.14136) <a id="link26"></a>
...
**Comment:** High-resolution ALMA observations of molecular gas in the edge-on galaxy NGC 4565, focusing on radial and vertical structure and molecular cloud properties. While it discusses molecular clouds and star-forming complexes, the galaxy is a massive spiral and not a dwarf or satellite. The paper does not directly address resolved star formation histories, quenching, or outflows in dwarfs.
...
## 27. [JWST spectroscopy of SN 2010da/NGC 300 ULX-1: a surviving star hidden by dust](https://arxiv.org/abs/2604.13711) <a id="link27"></a>
...
**Comment:** JWST spectroscopy of SN 2010da/NGC 300 ULX-1, focusing on a surviving star hidden by dust and binary interaction. While it discusses mass loss and dust formation, the system is not a dwarf galaxy or satellite, nor does it address resolved star formation histories or stellar models in a way that matches the core criteria.
...
## 28. [Enhancing Ly{\alpha} Emitter Identification in HETDEX with a Convolutional Neural Network](https://arxiv.org/abs/2604.12414) <a id="link28"></a>
...
**Comment:** This paper presents a deep learning method for identifying Lyα emitters in a large spectroscopic survey. While Lyα emitters are galaxies, the focus is on survey methodology and identification, not on resolved star formation histories, dwarf galaxy properties, or numerical galaxy simulations.
...
## 30. [The 256-antenna Coherent All-Sky Monitor](https://arxiv.org/abs/2604.13903) <a id="link30"></a>
...
**Comment:** The paper describes a new radio array (CASM-256) and its capabilities for detecting fast radio bursts (FRBs) and probing the baryonic content of nearby galaxy halos. While the mention of measuring baryonic content in galaxy halos is tangentially related to the circumgalactic medium, the focus is on instrumentation and FRBs, not on dwarf galaxies or resolved star formation histories.
...
## 31. [Potentials of axisymmetric razor-thin disks](https://arxiv.org/abs/2604.13091) <a id="link31"></a>
...
**Comment:** The paper investigates gravitational potentials of axisymmetric razor-thin disks, which is a theoretical study of disk mass distributions. While disk models are relevant to galaxy structure, the focus is not on dwarf galaxies, satellite systems, or resolved star formation histories. It is only tangentially related to numerical galaxy simulations.
...
## 32. [21 cm Power Spectrum Analysis of North Celestial Pole Observations with the Tianlai Dish Pathfinder Array](https://arxiv.org/abs/2604.12200) <a id="link32"></a>
...
**Comment:** Analysis of 21 cm power spectrum with the Tianlai Dish Pathfinder Array, focusing on intensity mapping and large-scale structure. While 21 cm studies can be relevant to reionization and cosmic structure, this paper does not focus on dwarf galaxies, resolved star formation histories, or circumgalactic medium.
...
## 33. [A Dynamical Test for Cooling-Induced Entrainment in a Runaway Supermassive Black Hole Tail](https://arxiv.org/abs/2604.13155) <a id="link33"></a>
...
**Comment:** Models the tail of a runaway supermassive black hole using hydrodynamical simulations and mixing-layer theory. While it involves galaxy simulations, the focus is on SMBH-driven phenomena, not galaxy evolution or star-formation-driven outflows.
...
## 34. [FRTSearch: Unified Detection and Parameter Inference of Fast Radio Transients using Instance Segmentation](https://arxiv.org/abs/2604.12344) <a id="link34"></a>
...
**Comment:** Presents a new framework for fast radio transient detection and parameter inference. While innovative for radio astronomy, it does not match any of the core topics (no relevance to galaxy evolution, star formation, or stellar models).
...
## 35. [Search for CBCs with SSM Components in Data from The First Part of LVK Fourth Observing Run](https://arxiv.org/abs/2604.14095) <a id="link35"></a>
...
**Comment:** This paper reports a search for compact binary coalescences with sub-solar mass components, with implications for primordial black holes and dark matter. While it touches on dark matter, it does not address galaxy-scale dark matter profiles, satellite galaxies, or near-field cosmology.
...
## 36. [Solar photospheric spectrum microvariability III. Radial velocities and line profiles in magnetic active-region granulation](https://arxiv.org/abs/2604.13166) <a id="link36"></a>
...
**Comment:** The paper studies solar photospheric spectrum microvariability and its impact on radial velocities, focusing on stellar activity and line profiles. While it involves stellar models and line formation, it is not presenting new stellar evolutionary tracks or atmosphere models, nor is it directly relevant to the core topics.
...
## 37. [M1-92: AGB interruption and isotopic ratio paradox. Chemistry and morpho-kinematics from improved shapemol modelling](https://arxiv.org/abs/2604.12569) <a id="link37"></a>
...
**Comment:** The paper presents improved modeling tools for pre-planetary nebulae, focusing on chemistry and morpho-kinematics. While it involves stellar evolution and modeling, it does not present new stellar evolutionary tracks or atmosphere models, nor does it address galaxy-scale topics.
...
## 38. [Radiative cooling effects on black hole hot accretion flows around the sub-Bondi radius](https://arxiv.org/abs/2604.13762) <a id="link38"></a>
...
**Comment:** Simulates radiative cooling effects on black hole hot accretion flows around the sub-Bondi radius. Focus is on SMBH accretion and winds, not star-formation-driven outflows or galaxy-scale simulations.
...
## 40. [Reconstructing inflationary features on large scales using genetic algorithm](https://arxiv.org/abs/2604.13547) <a id="link40"></a>
...
**Comment:** Focuses on reconstructing inflationary features in the primordial power spectrum using genetic algorithms and CMB data. This is cosmology and not related to any of the core topics (no connection to near-field cosmology, galaxy evolution, star formation, or stellar models).
...
## 41. [Searching for axions with quantum interferometry](https://arxiv.org/abs/2604.13181) <a id="link41"></a>
...
**Comment:** Quantum interferometry for axion searches, focusing on fundamental physics and dark matter detection. No direct relevance to galaxy evolution, star formation, or near-field cosmology.
...
## 42. [Double the axions, half the tension: multi-field early dark energy eases the Hubble tension](https://arxiv.org/abs/2604.13535) <a id="link42"></a>
...
**Comment:** This paper discusses early dark energy models and their impact on the Hubble tension, using axion-like fields and CMB data. While it is cosmology-related, it does not address near-field cosmology, satellite galaxies, star formation histories, galaxy simulations, or stellar models. The focus is on cosmological parameters and early universe physics, which are outside the core topics.
...
## 43. [TDCOSMO XXV: A "soup-to-nuts" 6.5% $H_0$ measurement $-$ strong lensing and dynamics with a maximally flexible mass sheet](https://arxiv.org/abs/2604.14145) <a id="link43"></a>
...
**Comment:** This paper presents a strong lensing and dynamical analysis to measure H0, focusing on cosmological parameters and mass-sheet degeneracy. It does not address near-field cosmology, dwarf galaxies, or any of the other core topics. The relevance is low.
...
## 44. [Variability classification of TESS targets in LOPS2, the first long-term pointing field of PLATO. Version 1 of the public variability catalogue](https://arxiv.org/abs/2604.12758) <a id="link44"></a>
...
**Comment:** This paper presents a catalogue of variable stars in the PLATO LOPS2 field using TESS data and machine learning classification. The focus is on stellar variability, pulsators, and eclipsing stars, not on galaxy-scale phenomena, dwarf galaxies, star formation histories, or circumgalactic medium. The work is outside the core topics and does not match any of the relevant criteria.
...
## 45. [Reanalysing large-scale structure using an updated gamma-ray burst spatial density approach](https://arxiv.org/abs/2604.13712) <a id="link45"></a>
...
**Comment:** The paper analyzes large-scale structure using gamma-ray burst spatial density, with implications for cosmological principle and isotropy. While it touches on cosmology, it does not address near-field cosmology, galaxy satellites, or any of the core topics.
...
## 46. [Bayesian Analysis of Gravitational Wave Microlensing Effects from Galactic Double White Dwarfs](https://arxiv.org/abs/2604.13930) <a id="link46"></a>
...
**Comment:** The paper discusses gravitational wave microlensing effects from Galactic double white dwarfs, focusing on GW detection and lensing. While it involves Galactic compact objects, it does not address satellite galaxies, star formation histories, or galaxy simulations.
...
## 47. [A note on Gurzadyan theorem](https://arxiv.org/abs/2603.25323) <a id="link47"></a>
...
**Comment:** Discussion of Gurzadyan theorem and its mathematical/physical understanding in cosmology. The paper is theoretical and general, not directly related to near-field cosmology, galaxy simulations, or stellar models.
...
## 48. [Persephone's Torch: A 15th Magnitude Quadruply-Lensed Quasar From the Couch Discovered with SPHEREx and the LBT](https://arxiv.org/abs/2604.13152) <a id="link48"></a>
...
**Comment:** The paper reports the discovery of a quadruply-lensed quasar, focusing on lensing and microlensing studies. It does not address satellite galaxies, star formation histories, or galaxy simulations.
...
## 49. [Rings Around Non-Spherical Worlds: Sub-mm Dust Retention Around Triaxial Small Bodies in the Solar System](https://arxiv.org/abs/2604.13234) <a id="link49"></a>
...
**Comment:** This paper focuses on rings around small bodies in the Solar System, specifically Chiron, Chariklo, Quaoar, and Haumea. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 50. [Radiation hydrodynamic simulations for the origin of quasi-periodic oscillations for accretion onto supermassive black holes](https://arxiv.org/abs/2604.13199) <a id="link50"></a>
...
**Comment:** Radiation hydrodynamic simulations of accretion onto supermassive black holes, with focus on QPOs in AGNs and TDEs. This is not relevant to galaxy simulations or any of the core topics, as it centers on SMBH accretion physics.
...
## 51. [Observational constraints on nonlocal black holes via gravitational lensing](https://arxiv.org/abs/2604.13223) <a id="link51"></a>
...
**Comment:** Observational constraints on nonlocal black holes via gravitational lensing. The focus is on black hole physics and testing gravity, not on galaxies, star formation, or stellar models.
...
## 52. [In Situ Interferometric Spatial Mapping Of A Microwave Kinetic Inductance Detector Array](https://arxiv.org/abs/2604.12287) <a id="link52"></a>
...
**Comment:** This paper presents a new method for spatial mapping of MKID arrays, which is relevant for instrumentation but does not match any of the core topics (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 53. [Optical depth to reionization in a Universe with multiple inhomogeneous domains](https://arxiv.org/abs/2604.13718) <a id="link53"></a>
...
**Comment:** Studies optical depth to reionization in a cosmological model with inhomogeneous domains. This is cosmology and not related to the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 54. [CII fine-structure line observations of the Sagittarius C Region in the Galaxy's Central Molecular Zone](https://arxiv.org/abs/2604.13336) <a id="link54"></a>
...
**Comment:** Observes CII fine-structure line in the Sagittarius C region of the Galaxy's Central Molecular Zone. Focus is on the Galactic center and massive star formation, which is explicitly listed as irrelevant in the criteria.
...
## 55. [SN 2022riv in RX J2129: Discovery, Spectroscopic Classification, and Microlensing of a Strongly Lensed Type Ia Supernova from JWST and HST Observations](https://arxiv.org/abs/2604.11882) <a id="link55"></a>
...
**Comment:** This paper focuses on a strongly lensed Type Ia supernova and its microlensing, with implications for lens modeling and cosmology. No direct relevance to near-field cosmology, resolved star formation histories, or dwarf galaxy science.
...
## 56. [BROOM: a python package for model-independent analysis of microwave astronomical data](https://arxiv.org/abs/2604.14088) <a id="link56"></a>
...
**Comment:** This paper presents a Python package for component separation in microwave astronomical data, focusing on CMB and foregrounds. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The methods are general-purpose and not directly relevant.
...
## 57. [Radial Velocity Evidence for a Post-Mass-Transfer Massive Binary System: NaSt1](https://arxiv.org/abs/2604.13983) <a id="link57"></a>
...
**Comment:** This paper focuses on a massive binary system in the Milky Way, specifically NaSt1, and its circumstellar medium. The study is centered on stellar evolution and mass transfer in a massive binary, with implications for stripped-envelope supernova progenitors. However, it does not address dwarf galaxies, satellite systems, resolved star formation histories, or galaxy-scale simulations. The focus is on stellar and binary evolution, not on the core topics of near-field cosmology or galaxy evolution.
...
## 58. [Axion Inflation from Heavy-Fermion One-Loop Effects](https://arxiv.org/abs/2604.13674) <a id="link58"></a>
...
**Comment:** Theoretical work on axion inflation and gravitational wave production from heavy-fermion one-loop effects. This is cosmology/particle physics and does not match any of the core galaxy or stellar criteria.
...
## 59. [SJET: An Interactive Solar Jet Extraction Tool](https://arxiv.org/abs/2604.13590) <a id="link59"></a>
...
**Comment:** Development of an interactive tool for solar jet extraction. The focus is on solar phenomena and image processing, not on galaxies, star formation, or stellar models.
...
## 60. [Robust parameter inference for Taiji via time-frequency contrastive learning and normalizing flows](https://arxiv.org/abs/2604.13867) <a id="link60"></a>
...
**Comment:** This paper focuses on robust parameter inference for gravitational wave observations, specifically for massive black hole binaries in the Taiji detector. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The focus is on GW data analysis and machine learning methods, which are outside the relevant topics.
...
## 61. [Basilic: An end-to-end pipeline for Bayesian burst inference and model classification in gravitational-wave data](https://arxiv.org/abs/2604.13839) <a id="link61"></a>
...
**Comment:** This paper presents a pipeline for Bayesian burst inference in gravitational-wave data, focusing on model selection for GW bursts. It does not address any of the core topics such as galaxy simulations or star formation.
...
## 62. [Analysis of Lyman-beta and Lyman-gamma Lines in a Pre-Eruptive and Eruptive Prominence with Solar Orbiter SPICE Observations](https://arxiv.org/abs/2604.13990) <a id="link62"></a>
...
**Comment:** Analysis of Lyman-beta and Lyman-gamma lines in solar prominences using Solar Orbiter SPICE. The focus is on solar plasma diagnostics, not on galaxies, star formation histories, or stellar models.
...
## 63. [A Search for Hydroacoustic Signals from Bolides](https://arxiv.org/abs/2604.12723) <a id="link63"></a>
...
**Comment:** Survey for hydroacoustic signals from fireballs using hydrophone stations. The focus is on meteor impacts and acoustic detection, not on galaxies, star formation, or stellar models.
...
## 64. [Prospects for GRB Afterglow Discovery with the Eric and Wendy Schmidt Observatory System](https://arxiv.org/abs/2604.13650) <a id="link64"></a>
...
**Comment:** This paper simulates GRB afterglow detection rates for new observatory systems. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 65. [Understanding mechanisms underlying solar cycle predictability with a general framework](https://arxiv.org/abs/2604.13585) <a id="link65"></a>
...
**Comment:** The paper discusses solar cycle predictability and dynamo models, which is unrelated to the core topics of near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 66. [Fast Neutrino-Flavor Conversion with Attenuation and Global Lepton Gradient](https://arxiv.org/abs/2604.13617) <a id="link66"></a>
...
**Comment:** This paper investigates fast neutrino-flavor conversion in supernovae and neutron star mergers, which is unrelated to the core topics of near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 67. [Correlation between Ultra-High-Energy Neutrino KM3-230213A and Gamma-Ray Bursts](https://arxiv.org/abs/2604.13879) <a id="link67"></a>
...
**Comment:** Analyzes correlations between an ultra-high-energy neutrino event and gamma-ray bursts, with implications for Lorentz invariance violation. No connection to the core topics (no relevance to galaxy evolution, star formation, or stellar models).
...
## 68. [Gravitational Sommerfeld Effects: Formalism, Renormalization, and Perturbation to $O(G^{10})$](https://arxiv.org/abs/2604.14112) <a id="link68"></a>
...
**Comment:** Theoretical work on gravitational waveform corrections in binary inspirals, using effective field theory. No connection to galaxy evolution, star formation, or near-field cosmology.
...
## 69. [Not too close! Evaluating the impact of the baseline on the localization of binary black holes by next-generation gravitational-wave detectors](https://arxiv.org/abs/2604.11871) <a id="link69"></a>
...
**Comment:** Study of localization of binary black holes by next-generation gravitational-wave detectors. No connection to galaxy evolution, star formation, or near-field cosmology.
...
## 70. [The NuSTAR view of Ultra-Compact X-ray Binaries](https://arxiv.org/abs/2604.13187) <a id="link70"></a>
...
**Comment:** The paper studies ultra-compact X-ray binaries (UCXBs), a subclass of low-mass X-ray binaries, using NuSTAR observations. The focus is on X-ray spectral states and properties of accretion disks and neutron stars, not on galaxy-scale phenomena, dwarf galaxies, star formation histories, or circumgalactic medium. The work is outside the core topics and does not match any of the relevant criteria.
...
## 71. [Simulation of non X-ray background for the DIffuse X-ray Explorer (DIXE) mission](https://arxiv.org/abs/2604.13569) <a id="link71"></a>
...
**Comment:** This paper focuses on simulating the non X-ray background for an X-ray mission targeting the hot gas in the Milky Way. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 72. [Relaxation of magnetically-confined mountains on accreting neutron stars through cross-field mass transport](https://arxiv.org/abs/2604.13557) <a id="link72"></a>
...
**Comment:** The paper studies magnetically-confined mountains on accreting neutron stars, focusing on hydromagnetic instabilities and mass transport. This is not related to galaxy evolution, star formation histories, or CGM. No relevant criteria matched.
...
## 73. [Targeted search for eccentric supermassive binary black holes in OJ 287 and nearby galaxy clusters with PPTA DR3](https://arxiv.org/abs/2604.13173) <a id="link73"></a>
...
**Comment:** This paper is a targeted search for eccentric supermassive binary black holes in OJ 287 and galaxy clusters using pulsar timing arrays. It is unrelated to galaxy evolution, star formation histories, or CGM.
...
## 74. [Investigating the effect of sensitivity of KAGRA on sky localization of gravitational-wave sources from compact binary coalescences](https://arxiv.org/abs/2604.13580) <a id="link74"></a>
...
**Comment:** The paper investigates the effect of KAGRA's sensitivity on sky localization of gravitational-wave sources from compact binary coalescences. It is unrelated to galaxy evolution, star formation, or CGM.
...
## 75. [Non-LTE Analysis of Pre-eruptive Prominence Plasma Parameters Effects on the Lyman-beta and Lyman-gamma Lines with Solar Orbiter SPICE Observations](https://arxiv.org/abs/2604.14043) <a id="link75"></a>
...
**Comment:** This paper analyzes solar prominence plasma parameters and their effect on Lyman lines, focusing on solar physics and not on any of the core galaxy-related criteria.
...
## 76. [Analysis of Eruptive Prominence Plasma Parameters' Effects on the \ion{He}{2} 304~\AA\ Line with Solar Orbiter EUI Observations](https://arxiv.org/abs/2604.14080) <a id="link76"></a>
...
**Comment:** This paper focuses on solar prominence plasma parameters and their effects on the He II 304 Å line, which is unrelated to any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 77. [Prominence Plasma Parameters Maps Inferred From Lyman $\beta$ and Lyman $\gamma$ Observations and Non-LTE Modelling](https://arxiv.org/abs/2604.14063) <a id="link77"></a>
...
**Comment:** This paper studies plasma parameters in solar prominences using Lyman β and γ lines, which is unrelated to the core topics of near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 78. [Probing Coronal Activity Using Radio Signals Based on the 2021 superior conjunction of Mars: the Downlink Data from Tianwen-1](https://arxiv.org/abs/2604.13670) <a id="link78"></a>
...
**Comment:** Study of solar coronal activity using radio signals from a Mars probe. The focus is on solar physics and radio propagation, not on galaxy evolution, star formation, or near-field cosmology.
...
## 79. [Large-scale Morphology of the Optical F-corona from a Total Solar Eclipse Observation During the Artemis II Lunar Flyby](https://arxiv.org/abs/2604.13908) <a id="link79"></a>
...
**Comment:** This paper focuses on the morphology of the optical F-corona (inner zodiacal light) and interplanetary dust, which is unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or CGM. No relevant criteria matched.
...
## 80. [Shock properties for solar energetic particle events with signatures of inverse velocity arrival](https://arxiv.org/abs/2604.13962) <a id="link80"></a>
...
**Comment:** This paper investigates shock properties in solar energetic particle events, focusing on SEP arrival and shock evolution. It does not relate to galaxy evolution, star formation, or CGM. No relevant criteria matched.
...
## 81. [Amerigo Vespucci and the discovery of the Southern Sky](https://arxiv.org/abs/2604.11826) <a id="link81"></a>
...
**Comment:** Historical analysis of Amerigo Vespucci's astronomical observations and their impact on celestial cartography. No direct connection to any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 82. [Frequency & Radiative Analysis of Random Yagi-UHF/VHF Phased Array](https://arxiv.org/abs/2604.11816) <a id="link82"></a>
...
**Comment:** This paper is about phased array ground stations and antenna analysis, which is unrelated to any of the core topics. No relevant criteria matched.
