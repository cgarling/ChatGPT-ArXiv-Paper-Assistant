...
1. [Bypassed Core Formation in Milky Way-Mass SIDM Halos: Implications for the Local Group Past-Pericenter Scenario](#user-content-link1)
**Authors:** Zhichao Carton Zeng, Odelia V. Hartl, Louis E. Strigari, Annika H. G. Peter, Xiaolong Du, Charlie Mace, Andrew Benson

2. [Optical identification of the FASHI sources: toward the extended Local Volume](#user-content-link2)
**Authors:** Aleksandra E. Nazarova, Dmitry I. Makarov, Igor D. Karachentsev, Chuan-Peng Zhang, Maksim I. Chazov, Ming Zhu

3. [The k-MENDEL sample of local analogs to reionization galaxies. Spectral identification of EELGs and properties of green peas in DESI](#user-content-link3)
**Authors:** L. Bonatto, R. Amor\'in, A. Gim\'enez-Alc\'azar, J. A. Fern\'andez-Ontiveros, A. Hern\'an-Caballero, S. Su\'arez, J. M. V\'ilchez, E. P\'erez-Montero, M. Llerena, J. S\'anchez Almeida

4. [The missing ultra-faint satellites of the Milky Way](#user-content-link4)
**Authors:** Isabel M. E. Santos-Santos, Carlos S. Frenk, Julio F. Navarro

5. [Temperature asymmetry in the Milky Way's hot circumgalactic medium induced by the Magellanic Clouds](#user-content-link5)
**Authors:** Alexandru Oprea, Filippo Fraternali, Else Starkenburg, Thor Tepper-Garcia, Joss Bland-Hawthorn

6. [An automated method for planetary nebula detection with SIGNALS: first applications to NGC 4214 and NGC 4449](#user-content-link6)
**Authors:** Nancy Yang, Johanna Hartke, Martin Bureau, Chiara Spiniello, Louis-Simon Guit\'e, Guy Flint, Magda Arnaboldi, Ana In\'es Ennis, R. Pierre Martin, Thomas Martin, Carmelle Robert, Laurie Rousseau-Nepton, Lucas M. Valenzuela, S\'ebastien Vicens-Mouret

7. [FolpsD: combining EFT and phenomenological approaches for joint power spectrum and bispectrum analyses](#user-content-link7)
**Authors:** P. Bansal, A. Aviles, H. E. Noriega, C. Guandalin, I. Garzon, G. Niz, M. S. Wang, U. Andrade, F. Beutler, A. de Mattia, D. Gonzalez, J. Hou, D. Huterer, E. Paillas, M. Pellejero Ibanez, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, B. Dey, P. Doel, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, C. Hahn, H. K. Herrera-Alcantar, K. Honscheid, C. Howlett, M. Ishak, R. Joyce, S. Juneau, D. Kirkby, A. Kremin, M. Landriau, L. Le Guillou, M. Manera, A. Meisner, R. Miquel, S. Nadathur, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, L. Samushia, E. Sanchez, D. Schlegel, M. Schubnell, H. Seo, J. Silber, G. Tarl\'e, B. A. Weaver, P. Zarrouk, R. Zhou

8. [Constraining the Molecular Kennicutt-Schmidt Relation with Multi-Transition CO Observations of Nearby Galaxies](#user-content-link8)
**Authors:** Victoria G. G. Samboco, Ryan P. Keenan

9. [Beyond Mass and Multiscale Environments: What Shapes Low Surface Brightness Galaxies? Evidence from MaNGA](#user-content-link9)
**Authors:** Mengting Shen, Hassen M. Yesuf, Lei Hao, Chong Ge, Jun Yin, Junfeng Wang, Shiyin Shen

10. [The Hubble sequence in JWST CEERS from unbiased galaxy morphologies](#user-content-link10)
**Authors:** Elizaveta Sazonova, Cameron R. Morgan, Michael Balogh

11. [Tracing the s-Process: Spectroscopic Insights into Chemical Abundances in O- and C-rich Evolved Stars](#user-content-link11)
**Authors:** Sophie Van Eck, Carlos Abia, Inma Dominguez

12. [The Cliff: A Metal-Poor Little Red Dot Hosting an Overmassive Black Hole at $z = 3.55$](#user-content-link12)
**Authors:** Lucy R. Ivey, Francesco D'Eugenio, Roberto Maiolino, Yuki Isobe, Ignas Juod\v{z}balis, Sophie Koudmani, Michele Perna, Saiyang Zhang, Volker Bromm, Andrew J. Bunker, Stefano Carniani, Andrew C. Fabian, Kohei Inayoshi, Xihan Ji, Gareth C. Jones, Boyuan Liu, Robert Pascalau, Pierluigi Rinaldi, Brant Robertson, Jan Scholtz, Sandro Tacchella

13. [A first [CII] view of high-z quiescent galaxies](#user-content-link13)
...
14. [A New Measurement of the Extragalactic Background Light using 15\,yr of {\it Fermi}-Large Area Telescope Data](#user-content-link14)
**Authors:** Anuvab Banerjee, Justin D. Finke, Marco Ajello, Alberto Dom\'inguez, Abhishek Desai, Joshua Baxter, Dieter Hartmann, Vaidehi S. Paliya

15. [Analytic compression of the effective field theory of the Lyman-alpha forest](#user-content-link15)
**Authors:** N. G. Kara\c{c}ayl{\i}, M. Ivanov, R. de Belsunce, C. Ravoux, J. M. Sexton, Z. Luki\'c

16. [GLIMPSED: Direct evidence for a fast AGN-driven outflow from a z=6.64 Little Red Dot host galaxy](#user-content-link16)
**Authors:** Damien Korber, Rui Marques-Chaves, Daniel Schaerer, Gabriel Brammer, Archana Aravindan, Arghyadeep Basu, Qinyue Fei, Emma Giovinazzo, Vasily Kokorev, Alberto Saldana-Lopez, Maxime Trebitsch, Hakim Atek, John Chisholm, Ryan Endsley, Seiji Fujimoto, Lukas Furtak, Richard Pan, Rohan P. Naidu

17. [The Cosmic Web and Its Filaments: Neutrino Mass from Topology and Persistent Homology](#user-content-link17)
**Authors:** Graziano Rossi, Hogyun Yu, Micha\"el Michaux

18. [Paschen Jumps in Little Red Dots: Evidence for Nebular Continua](#user-content-link18)
...
19. [EPISODE IV: Ice Inventory in the Envelope of EC 53](#user-content-link19)
**Authors:** Jaeyeong Kim, Jeong-Eun Lee, Chul-Hwan Kim, Seokho Lee, Giseon Baek, Seonjae Lee, Yao-Lun Yang, Yuri Aikawa, Gregory J. Herczeg, Doug Johnstone, Joel D. Green, Woong-Seob Jeong

20. [cTreeBalls: a fast 3-point correlation function code for clustering measurements](#user-content-link20)
**Authors:** Mario A. Rodriguez-Meza, Eladio Moreno, Alejandro Aviles, Gustavo Niz

21. [Ghosts of eruptions past: Searching for historical Galactic supernovae using variable thermal dust echoes and machine learning](#user-content-link21)
**Authors:** Justin Vega, Kishalay De, Ashish Mahabal, Jacob E. Jencson, Viraj R. Karambelkar, Armin Rest, Megan Masterson

22. [Large or bright satellite constellations: Effects on observations, including on the background sky brightness](#user-content-link22)
**Authors:** Olivier R. Hainaut

23. [Photoionization modelling of circumstellar nebulae using irregular grains](#user-content-link23)
**Authors:** P. Jim\'enez-Hern\'andez, S. J. Arthur, D. Guirado, O. Mu\~noz, J. Martikainen, L. Sabin, W. J. Henney

24. [Joining forces: 30 years optical monitoring of the Einstein Cross](#user-content-link24)
**Authors:** V. N. Shalyapin, L. J. Goicoechea, R. Gil-Merino, A. Esteban-Guti\'errez, C. W. Morgan, E. Mediavilla, A. Yonehara, A. Sergeyev

25. [Blueshifted lines from the inner accretion disc's rotation can explain quasar absorption "forests''](#user-content-link25)
**Authors:** Amelia M. Hankla, Fergus J. E. Baker, Daniel R. Wilkins, Andrew C. Fabian

26. [Nii-body: Bayesian Inference of Multiplanet Dynamics via N-body Simulations](#user-content-link26)
**Authors:** Hong-Fei Jia, Sheng Jin, Dong-Hong Wu, Shang-Fei Liu

27. [Terrestrial planet formation in the era of GPU computing](#user-content-link27)
**Authors:** Simon L. Grimm, Joachim G. Stadel

28. [Primordial Neutron Stars](#user-content-link28)
**Authors:** Gordan Krnjaic, Duncan Rocha, Huangyu Xiao

29. [A practical re-weighting scheme of data fitting: application to asteroids orbit determination with Gaia](#user-content-link29)
**Authors:** Dmitri. E. Vavilov, Ziyu. Liu, Daniel. Hestroffer, Josselin. Desmars

30. [High-dimensional inference for the $\gamma$-ray sky with differentiable programming](#user-content-link30)
**Authors:** Siddharth Mishra-Sharma, Tracy R. Slatyer, Yitian Sun, Yuqing Wu

31. [CMB signatures of gravity-mediated dark radiation in $\mathbf{\Delta N_{\rm eff}}$](#user-content-link31)
**Authors:** Anish Ghoshal, Sk Jeesun, Kazunori Kohri

32. [Probing Solar Symmetrons with Direct Detection](#user-content-link32)
**Authors:** Hannah Banks, Anne-Christine Davis, Luca Visinelli

33. [Bounding axion dark energy](#user-content-link33)
**Authors:** Gary Shiu, Flavio Tonioni, Hung V. Tran

34. [Probing the Kinematic Dipole with LISA: an analytical treatment](#user-content-link34)
**Authors:** Jacopo Fumagalli, Giulia Cusin, Cyril Pitrou, Gianmassimo Tasinato

35. [Tidal Response of Compact Objects](#user-content-link35)
**Authors:** Sumanta Chakraborty, Paolo Pani

36. [The evolution of the mid-infrared spectrum of SN 1987A observed with the JWST/MIRI-MRS](#user-content-link36)
...
37. [A TeV-based Determination of the Local Extragalactic Background Light and its Consistency with Galaxy Counts and Direct Measurements](#user-content-link37)
**Authors:** J. Baxter, A. Dominguez, J. D. Finke, A. Desai, M. Ajello, A. Banerjee, Dieter Hartmann, Vaidehi S. Paliya

38. [Short-Time Plasma Evolution: Flow Generation and Magnetogenesis](#user-content-link38)
**Authors:** Zain H. Saleem, Hamid Saleem

39. [Dust Processing in Protoplanetary Discs From Infall to Dispersal: the Origin of Solar System Isotopic Heterogeneities](#user-content-link39)
**Authors:** Mark A. Hutchison, Maria Sch\"onb\"achler, Lucio Mayer, Jean-David Bod\'enan

40. [Enhancing event reconstruction for $\gamma$-ray particle detector arrays using transformers](#user-content-link40)
**Authors:** Markus Pirke, Youngwan Son, Jonas Glombitza, Martin Schneider, Ian James Watson, Christopher van Eldik

41. [A Convolutional Neural Network-Derived Catalog of Solar Flares from Soft X-Ray Observations](#user-content-link41)
**Authors:** Nastaran Farhang, Michael. S. Wheatland, Andrew Melatos

42. [Methanimine as a sink in the HCN and HNC solid state hydrogenation network](#user-content-link42)
**Authors:** Joan Enrique-Romero, Thanja Lamberts

43. [Chasing Gamma-Ray Signals from Binary Neutron Star Coalescences with the Cherenkov Telescope Array: Prospects and Observing Strategies](#user-content-link43)
...
44. [Polarimetry in Planetary Sciences and Astronomy](#user-content-link44)
**Authors:** C. H. Lucas Patty, Jonathan Grone, Brice-Olivier Demory, Jonas K\"uhn, Jie Ma, Willeke Mulder, Olivier Poch, Antoine Pommerol, Hans Martin Schmid, Stefano Spadaccia

45. [Genericness of quantum damping of cosmological shear in modified loop quantum cosmology](#user-content-link45)
**Authors:** Wen-Cong Gan, Leila L. Graef, Rudnei O. Ramos, Gustavo S. Vicente, Anzhong Wang

46. [Covariant scalar-tensor theories beyond second derivatives](#user-content-link46)
**Authors:** Mohammad Ali Gorji, Pavel Petrov, Karim Noui

47. [Gardening on the Moon: An Advection-Diffusion Model to Guide the Search for Supernova Debris in the Lunar Regolith](#user-content-link47)
**Authors:** Emily S. Costello, John Ellis, Brian D. Fields, Rebecca Surman, Xilu Wang

48. [Relative Magnification Factor of Point Sources on Accretion Disks](#user-content-link48)
**Authors:** Qing-Hua Zhu

49. [Finding Circumbinary Planets: A Semi-Automated Transit Search of TESS Eclipsing Binaries](#user-content-link49)
**Authors:** Benjamin D. R. Davies, David J. A. Brown, Samuel Gill, Jenni R. French

50. [Fast and Scalable Production of Stacked Prism X-ray Lenses for Astrophysics Using Two-Photon Polymerization](#user-content-link50)
**Authors:** Filip af Malmborg, Chlo\'e Delmotte, Kian Shaker, Mark Pearce

51. [Minimum mass, maximum charge and hyperbolicity in scalar Gauss-Bonnet gravity](#user-content-link51)
**Authors:** Dario Rossi, Leonardo Gualtieri, Thomas P. Sotiriou

52. [Evaluating Deep Learning Models for Multiclass Classification of LIGO Gravitational-Wave Glitches](#user-content-link52)
**Authors:** Rudhresh Manoharan (Baylor University), Gerald Cleaver (Baylor University)

53. [labrador: A domain-optimized machine-learning tool for gravitational wave inference](#user-content-link53)
**Authors:** Javier Roulet, Marco Crisostomi, Lucy M. Thomas, Katerina Chatziioannou

54. [Love numbers of black holes and compact objects](#user-content-link54)
**Authors:** Mar\'ia J. Rodr\'iguez, Luca Santoni, Adam R. Solomon

55. [Long-period transiting exoplanets: advances in detection and characterization](#user-content-link55)
**Authors:** Sol\`ene Ulmer-Moll, Babatunde Akinsanmi, Simon M\"uller

56. [Development of the New Optical Sensor for IceCube-Gen2](#user-content-link56)
**Authors:** Delaney Butterfield (for the IceCube-Gen2 Collaboration), Chris Wendt (for the IceCube-Gen2 Collaboration)

57. [The Illusory Precision of TTV Masses: Hidden Solutions Behind Kepler-9's Tight Mass Ratio](#user-content-link57)
**Authors:** Sheng Jin, Dong-Hong Wu, Xiao-Ling Xu, Jianghui Ji

58. [Validating a Non-conventional Method for Expansion of Coronal Mass Ejections (CMEs) and Investigating the Evolution of a CME Substructures Using Solar Orbiter and Wind Observations](#user-content-link58)
**Authors:** Anjali Agarwal, Wageesh Mishra, Mathew J. Owens, Tanja Amerstorfer

59. [Inverse Energy Cascade in Turbulent Taylor-Couette Flows](#user-content-link59)
**Authors:** Changquan Zhou, Hua-Shu Dou, Lin Niu, Wenqian Xu

60. [Choice of optical transformation for photonic circuit wavefront sensors](#user-content-link60)
**Authors:** Jonathan Lin

61. [IFS spectrograph designs for the Wide-field Spectroscopic Telescope: Architecture and performance gains from curved sensors](#user-content-link61)
**Authors:** Corentin Cudennec, Alexandre Jeanneau, Roland Bacon, Thierry L\'epine, Matthew Lehnert

62. [Recent development in high-precision high-fidelity spectrographs for exoplanet research and characterization](#user-content-link62)
**Authors:** Fran\c{c}ois Bouchy, Francesco Pepe, Xavier Dumusque, Tobias Schmidt, Christophe Lovis, St\'ephane Udry

63. [Radio Monitoring Campaign of Active Repeater FRB 20220912A with CHIME](#user-content-link63)
...
64. [What Heats the Dense Gas in the Galactic Center?](#user-content-link64)
**Authors:** Zhenyi Yue, Yiping Ao, Xindi Tang, Xing Lu, Yan Gong, Christian Henkel

65. [Overview of Hayabusa2 extended mission's flyby of Near-Earth Asteroid (98943) Torifune](#user-content-link65)
...
66. [The Northern High Time Resolution Universe pulsar survey: III. Single-pulse search continuation, follow-up observations, and initial results](#user-content-link66)
**Authors:** L. J. M. Houben, H. Falcke, L. G. Spitler, E. D. Barr, M. Berezina, D. J. Champion, R. Karuppusamy, M. Kramer

67. [Colloquium: Radio astronomy with the Arecibo 305-m telescope: In contemporaneous context](#user-content-link67)
**Authors:** Tapasi Ghosh, Chris Salter

68. [Unseen Astronomy](#user-content-link68)
**Authors:** Dr James W. Trayford

---

## 1. [Bypassed Core Formation in Milky Way-Mass SIDM Halos: Implications for the Local Group Past-Pericenter Scenario](https://arxiv.org/abs/2604.08647) <a id="link1"></a>
...
**Comment:** Directly relevant to near-field cosmology: investigates Milky Way and M31 interactions, structural evolution of MW halo, and implications for dark matter density profiles (core-collapse vs core-formation) using numerical galaxy simulations. Also touches on historic interactions and dark matter models.
...
## 2. [Optical identification of the FASHI sources: toward the extended Local Volume](https://arxiv.org/abs/2604.09082) <a id="link2"></a>
...
**Comment:** This paper reports the discovery of 71 new dwarf irregular galaxies within ~16 Mpc, with ongoing star formation. The focus on dwarf galaxies, their abundance, and properties directly matches the 'Near-Field Cosmology' criterion. The identification of new dwarfs is highly relevant for satellite luminosity functions and resolved star formation histories.
...
## 4. [The missing ultra-faint satellites of the Milky Way](https://arxiv.org/abs/2604.09539) <a id="link4"></a>
...
**Comment:** This paper directly addresses near-field cosmology by studying the satellite population of the Milky Way, the satellite luminosity function, and the properties of ultra-faint dwarf galaxies using high-resolution simulations and semi-analytic models. It also touches on core-cusp and substructure issues.
...
## 5. [Temperature asymmetry in the Milky Way's hot circumgalactic medium induced by the Magellanic Clouds](https://arxiv.org/abs/2604.08652) <a id="link5"></a>
...
**Comment:** This paper investigates the Milky Way's CGM and the impact of the Magellanic Clouds, directly matching the near-field cosmology criterion (historic interactions between the Milky Way and satellites) and the circumgalactic medium criterion. The simulation aspect also touches on numerical galaxy simulations.
...
## 6. [An automated method for planetary nebula detection with SIGNALS: first applications to NGC 4214 and NGC 4449](https://arxiv.org/abs/2604.09209) <a id="link6"></a>
...
**Comment:** This paper presents an automated method for planetary nebula detection in two dwarf irregular galaxies, NGC 4214 and NGC 4449. The focus on dwarf galaxies and their stellar populations is relevant to 'Near-Field Cosmology' and 'Resolved Star Formation Histories', as planetary nebulae are tracers of stellar evolution and star formation history in these galaxies.
...
## 7. [FolpsD: combining EFT and phenomenological approaches for joint power spectrum and bispectrum analyses](https://arxiv.org/abs/2604.08895) <a id="link7"></a>
...
**Comment:** The paper presents a new model for galaxy clustering power spectrum and bispectrum, tested on DESI galaxy mocks. This fits the numerical galaxy simulations criterion, especially as it involves new theoretical modeling and analysis of galaxy clustering statistics.
...
## 8. [Constraining the Molecular Kennicutt-Schmidt Relation with Multi-Transition CO Observations of Nearby Galaxies](https://arxiv.org/abs/2604.09353) <a id="link8"></a>
...
**Comment:** This paper investigates the molecular Kennicutt-Schmidt relation in nearby galaxies using multi-transition CO observations. It directly addresses the relationship between star formation rate and molecular gas, which is relevant to star formation histories and quenching, though the sample is of nearby galaxies and not specifically dwarfs. The focus on star formation efficiency and gas density is closely aligned with the resolved star formation histories and star formation quenching criteria.
...
## 10. [The Hubble sequence in JWST CEERS from unbiased galaxy morphologies](https://arxiv.org/abs/2604.08682) <a id="link10"></a>
...
**Comment:** The paper studies galaxy morphologies and the Hubble sequence up to z~4, including the evolution of star-forming disks and quenching in massive galaxies. The discussion of quenching and star formation histories is relevant, but the focus is on higher mass galaxies and not specifically dwarfs or resolved CMDs.
...
## 11. [Tracing the s-Process: Spectroscopic Insights into Chemical Abundances in O- and C-rich Evolved Stars](https://arxiv.org/abs/2604.09205) <a id="link11"></a>
...
**Comment:** The paper discusses s-process nucleosynthesis and chemical abundances in evolved stars, which fits the 'Stellar Models' criterion, as it constrains theoretical AGB models and discusses mixing and nucleosynthesis. However, it is more about stellar evolution than galaxy-scale processes.
...
## 12. [The Cliff: A Metal-Poor Little Red Dot Hosting an Overmassive Black Hole at $z = 3.55$](https://arxiv.org/abs/2604.09177) <a id="link12"></a>
...
**Comment:** This paper presents JWST observations of a metal-poor galaxy hosting an overmassive black hole at z=3.55, with discussion of simulations of black hole growth and evolution. While it involves galaxy simulations and metallicity, the focus is on a high-redshift, massive black hole system, not dwarf galaxies or near-field cosmology. The relevance is borderline due to the simulation aspect.
...
## 13. [A first [CII] view of high-z quiescent galaxies](https://arxiv.org/abs/2604.09347) <a id="link13"></a>
...
**Comment:** The paper discusses quenching and ISM properties in high-redshift massive quiescent galaxies, with some mention of merger-driven origins and ISM outflows. However, the focus is on massive galaxies, not dwarfs, so it is only borderline relevant to the star formation quenching and outflow criteria.
...
## 14. [A New Measurement of the Extragalactic Background Light using 15\,yr of {\it Fermi}-Large Area Telescope Data](https://arxiv.org/abs/2604.09139) <a id="link14"></a>
...
**Comment:** This paper measures the extragalactic background light (EBL) using gamma-ray blazars, which is relevant to models of star formation and galaxy evolution, but does not directly address resolved star formation histories, near-field cosmology, or dwarf galaxies. The connection to core topics is indirect.
...
## 15. [Analytic compression of the effective field theory of the Lyman-alpha forest](https://arxiv.org/abs/2604.09407) <a id="link15"></a>
...
**Comment:** This paper develops analytic compression for the effective field theory of the Lyman-alpha forest, probing small-scale structure formation. While it touches on cosmological structure and dark matter, it does not directly address near-field cosmology, resolved star formation histories, or galaxy simulations of galaxies.
...
## 16. [GLIMPSED: Direct evidence for a fast AGN-driven outflow from a z=6.64 Little Red Dot host galaxy](https://arxiv.org/abs/2604.08687) <a id="link16"></a>
...
**Comment:** This paper reports a fast AGN-driven outflow in a z=6.64 galaxy, with discussion of mass loading factor and outflow properties. The focus is on AGN-driven outflows, but it does mention mass loading factor and the impact on star formation, which is relevant to the star formation driven outflows criterion, though the outflow is AGN-dominated.
...
## 17. [The Cosmic Web and Its Filaments: Neutrino Mass from Topology and Persistent Homology](https://arxiv.org/abs/2604.09148) <a id="link17"></a>
...
**Comment:** Uses N-body simulations to study cosmic web topology and neutrino mass effects, but focus is on large-scale structure and filaments, not on galaxy-scale simulations or near-field cosmology.
...
## 18. [Paschen Jumps in Little Red Dots: Evidence for Nebular Continua](https://arxiv.org/abs/2604.09399) <a id="link18"></a>
...
**Comment:** This paper studies 'Little Red Dots' (LRDs) at high redshift, focusing on nebular continua and recombination emission. While it discusses emission mechanisms and AGN contributions, it does not directly address resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 19. [EPISODE IV: Ice Inventory in the Envelope of EC 53](https://arxiv.org/abs/2604.08769) <a id="link19"></a>
...
**Comment:** The paper presents ice inventory in a protostellar envelope using JWST spectra. While it involves star formation and chemical evolution, it does not focus on resolved star formation histories of galaxies, quenching, or dwarf galaxy properties. The work is more relevant to protostellar chemistry and episodic accretion.
...
## 20. [cTreeBalls: a fast 3-point correlation function code for clustering measurements](https://arxiv.org/abs/2604.08855) <a id="link20"></a>
...
**Comment:** This paper presents a new code for measuring 2- and 3-point correlation functions for clustering statistics, mainly for large-scale structure surveys. While it is a technical improvement for cosmological data analysis, it does not directly address any of the core topics (e.g., near-field cosmology, dwarf galaxies, star formation histories, galaxy simulations).
...
## 21. [Ghosts of eruptions past: Searching for historical Galactic supernovae using variable thermal dust echoes and machine learning](https://arxiv.org/abs/2604.08686) <a id="link21"></a>
...
**Comment:** Searches for historical Galactic supernovae using dust echoes; while interesting, it focuses on the Galactic plane and supernova remnants, not on dwarf galaxies, satellite quenching, or resolved star formation histories.
...
## 22. [Large or bright satellite constellations: Effects on observations, including on the background sky brightness](https://arxiv.org/abs/2604.09427) <a id="link22"></a>
...
**Comment:** This paper evaluates the effect of satellite constellations on sky brightness and astronomical observations. While it is important for observational astronomy, it does not match any of the core criteria related to galaxy science or stellar models.
...
## 23. [Photoionization modelling of circumstellar nebulae using irregular grains](https://arxiv.org/abs/2604.09006) <a id="link23"></a>
...
**Comment:** The paper discusses photoionization modeling of circumstellar nebulae using irregular dust grains. While it involves stellar environments, it does not present new stellar models or address galaxy-scale phenomena relevant to the core topics.
...
## 24. [Joining forces: 30 years optical monitoring of the Einstein Cross](https://arxiv.org/abs/2604.09160) <a id="link24"></a>
...
**Comment:** Long-term optical monitoring of a lensed quasar (Einstein Cross); focuses on quasar emission and microlensing, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 25. [Blueshifted lines from the inner accretion disc's rotation can explain quasar absorption "forests''](https://arxiv.org/abs/2604.09433) <a id="link25"></a>
...
**Comment:** Explains quasar absorption lines via accretion disk rotation; focus is on quasar physics and accretion disks, not on galaxy simulations, star formation, or near-field cosmology.
...
## 26. [Nii-body: Bayesian Inference of Multiplanet Dynamics via N-body Simulations](https://arxiv.org/abs/2604.09383) <a id="link26"></a>
...
**Comment:** This paper introduces a Bayesian N-body fitting framework for multiplanet exoplanet systems. It is not relevant to the core criteria, as it focuses on planetary system dynamics rather than galaxies or stellar models.
...
## 27. [Terrestrial planet formation in the era of GPU computing](https://arxiv.org/abs/2604.09184) <a id="link27"></a>
...
**Comment:** This paper discusses numerical N-body simulations of terrestrial planet formation, which is planetary science and not galaxy simulations or any other core criteria.
...
## 28. [Primordial Neutron Stars](https://arxiv.org/abs/2604.08651) <a id="link28"></a>
...
**Comment:** This theoretical paper proposes the formation of primordial neutron stars in the early universe, which is not directly related to any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 29. [A practical re-weighting scheme of data fitting: application to asteroids orbit determination with Gaia](https://arxiv.org/abs/2604.08820) <a id="link29"></a>
...
**Comment:** This paper presents a re-weighting scheme for data fitting, applied to asteroid orbit determination with Gaia. The method is general for parameter estimation but not directly related to galaxy simulations, stellar models, or any of the core topics.
...
## 30. [High-dimensional inference for the $\gamma$-ray sky with differentiable programming](https://arxiv.org/abs/2604.08648) <a id="link30"></a>
...
**Comment:** This paper presents a new differentiable programming approach for high-dimensional inference in gamma-ray sky analyses, specifically targeting the Galactic Center gamma-ray excess. The focus is on the Galactic Center, which is not relevant to the core topics, and the methods are not directly applicable to dwarf galaxies or galaxy evolution.
...
## 31. [CMB signatures of gravity-mediated dark radiation in $\mathbf{\Delta N_{\rm eff}}$](https://arxiv.org/abs/2604.09356) <a id="link31"></a>
...
**Comment:** Studies gravity-mediated dark radiation and its CMB signatures; not related to galaxy-scale phenomena, star formation, or near-field cosmology.
...
## 32. [Probing Solar Symmetrons with Direct Detection](https://arxiv.org/abs/2604.09283) <a id="link32"></a>
...
**Comment:** This paper focuses on solar symmetron production and direct detection, which is related to particle astrophysics and solar physics, but does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 33. [Bounding axion dark energy](https://arxiv.org/abs/2604.09141) <a id="link33"></a>
...
**Comment:** The paper is about axion dark energy and cosmological bounds, which is not directly related to any of the core criteria such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 34. [Probing the Kinematic Dipole with LISA: an analytical treatment](https://arxiv.org/abs/2604.08968) <a id="link34"></a>
...
**Comment:** This paper focuses on the kinematic dipole in the gravitational-wave background and its detection with LISA, which is not related to galaxy simulations, star formation, or near-field cosmology.
...
## 35. [Tidal Response of Compact Objects](https://arxiv.org/abs/2604.08679) <a id="link35"></a>
...
**Comment:** The paper reviews tidal responses of compact objects (black holes, neutron stars, exotic objects), which is not related to galaxy simulations, star formation, or near-field cosmology.
...
## 36. [The evolution of the mid-infrared spectrum of SN 1987A observed with the JWST/MIRI-MRS](https://arxiv.org/abs/2604.09211) <a id="link36"></a>
...
**Comment:** This paper presents mid-IR spectroscopic monitoring of SN 1987A, focusing on supernova evolution, dust, and ejecta. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 37. [A TeV-based Determination of the Local Extragalactic Background Light and its Consistency with Galaxy Counts and Direct Measurements](https://arxiv.org/abs/2604.09397) <a id="link37"></a>
...
**Comment:** This paper focuses on the extragalactic background light (EBL) and its measurement via gamma-ray attenuation, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy properties, or stellar models. The work is more about cosmic background measurements and galaxy counts.
...
## 38. [Short-Time Plasma Evolution: Flow Generation and Magnetogenesis](https://arxiv.org/abs/2604.09194) <a id="link38"></a>
...
**Comment:** This paper develops a plasma evolution framework for flow generation and magnetogenesis, which is not directly related to galaxy simulations, stellar models, or any of the core topics. The focus is on plasma physics and magnetogenesis in general astrophysical systems.
...
## 39. [Dust Processing in Protoplanetary Discs From Infall to Dispersal: the Origin of Solar System Isotopic Heterogeneities](https://arxiv.org/abs/2604.09122) <a id="link39"></a>
...
**Comment:** This paper focuses on dust processing and isotopic heterogeneity in protoplanetary discs, which is outside the core topics (no direct connection to near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations). It is more relevant to planet formation and solar system origins.
...
## 40. [Enhancing event reconstruction for $\gamma$-ray particle detector arrays using transformers](https://arxiv.org/abs/2604.09402) <a id="link40"></a>
...
**Comment:** This paper presents deep learning methods for gamma-ray event reconstruction in particle detector arrays. It is not relevant to any of the core criteria, as it does not focus on galaxies, star formation, or stellar models.
...
## 41. [A Convolutional Neural Network-Derived Catalog of Solar Flares from Soft X-Ray Observations](https://arxiv.org/abs/2604.08928) <a id="link41"></a>
...
**Comment:** This paper presents a CNN-derived catalog of solar flares from GOES X-ray data. It is not relevant to any of the core criteria, as it focuses on solar activity rather than galaxies or stellar models.
...
## 42. [Methanimine as a sink in the HCN and HNC solid state hydrogenation network](https://arxiv.org/abs/2604.09228) <a id="link42"></a>
...
**Comment:** This paper is focused on astrochemical modeling of hydrogenation networks on interstellar ices, specifically connecting HCN/HNC to methylamine. It does not match any of the core criteria related to galaxies, star formation histories, or stellar models.
...
## 43. [Chasing Gamma-Ray Signals from Binary Neutron Star Coalescences with the Cherenkov Telescope Array: Prospects and Observing Strategies](https://arxiv.org/abs/2604.08748) <a id="link43"></a>
...
**Comment:** This paper discusses gamma-ray follow-up strategies for binary neutron star mergers with the Cherenkov Telescope Array. It focuses on multi-messenger astronomy and observing strategies for GRBs, which is not directly related to any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 44. [Polarimetry in Planetary Sciences and Astronomy](https://arxiv.org/abs/2604.08975) <a id="link44"></a>
...
**Comment:** This paper reviews polarimetry in planetary sciences and astronomy, focusing on exoplanet detection and planetary surfaces. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 45. [Genericness of quantum damping of cosmological shear in modified loop quantum cosmology](https://arxiv.org/abs/2604.08912) <a id="link45"></a>
...
**Comment:** This paper discusses quantum damping of cosmological shear in modified loop quantum cosmology, focusing on early universe cosmology and quantum gravity. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 46. [Covariant scalar-tensor theories beyond second derivatives](https://arxiv.org/abs/2604.09170) <a id="link46"></a>
...
**Comment:** Theoretical work on scalar-tensor gravity; not related to galaxy simulations, star formation, or near-field cosmology.
...
## 47. [Gardening on the Moon: An Advection-Diffusion Model to Guide the Search for Supernova Debris in the Lunar Regolith](https://arxiv.org/abs/2604.09524) <a id="link47"></a>
...
**Comment:** Advection-diffusion model for supernova debris in lunar regolith; planetary science focus, not related to galaxy simulations, star formation, or near-field cosmology.
...
## 48. [Relative Magnification Factor of Point Sources on Accretion Disks](https://arxiv.org/abs/2604.09046) <a id="link48"></a>
...
**Comment:** This paper studies magnification factors for point sources on accretion disks near supermassive black holes. It is not relevant to any of the core criteria, as it focuses on black hole accretion disks and not galaxies or stellar models.
...
## 49. [Finding Circumbinary Planets: A Semi-Automated Transit Search of TESS Eclipsing Binaries](https://arxiv.org/abs/2604.09435) <a id="link49"></a>
...
**Comment:** This paper presents a semi-automated transit search for circumbinary planets in TESS eclipsing binaries. It is not relevant to the core criteria, as it focuses on exoplanet detection rather than galaxies or stellar models.
...
## 50. [Fast and Scalable Production of Stacked Prism X-ray Lenses for Astrophysics Using Two-Photon Polymerization](https://arxiv.org/abs/2604.09182) <a id="link50"></a>
...
**Comment:** This paper discusses the production of stacked prism X-ray lenses for astrophysics. It is not relevant to any of the core criteria, as it focuses on instrumentation rather than galaxies or stellar models.
...
## 51. [Minimum mass, maximum charge and hyperbolicity in scalar Gauss-Bonnet gravity](https://arxiv.org/abs/2604.08668) <a id="link51"></a>
...
**Comment:** This paper studies black hole solutions in scalar Gauss-Bonnet gravity, focusing on hyperbolicity and minimum mass. It is not relevant to any of the core criteria, as it focuses on black hole physics rather than galaxies or stellar models.
...
## 52. [Evaluating Deep Learning Models for Multiclass Classification of LIGO Gravitational-Wave Glitches](https://arxiv.org/abs/2604.08796) <a id="link52"></a>
...
**Comment:** The paper evaluates deep learning models for LIGO gravitational-wave glitch classification, which is not related to galaxy simulations, star formation, or near-field cosmology.
...
## 53. [labrador: A domain-optimized machine-learning tool for gravitational wave inference](https://arxiv.org/abs/2604.08897) <a id="link53"></a>
...
**Comment:** This paper presents a machine learning tool for gravitational wave inference, which is unrelated to any of the core topics (near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 54. [Love numbers of black holes and compact objects](https://arxiv.org/abs/2604.08653) <a id="link54"></a>
...
**Comment:** This review discusses Love numbers and tidal effects in black holes and neutron stars, which is unrelated to the core topics (galaxy evolution, star formation, dwarf galaxies, etc.).
...
## 55. [Long-period transiting exoplanets: advances in detection and characterization](https://arxiv.org/abs/2604.09254) <a id="link55"></a>
...
**Comment:** The paper discusses advances in detection and characterization of long-period transiting exoplanets, which is not related to any of the core topics (galaxy evolution, dwarf galaxies, stellar models, etc.). The focus is on exoplanetary science.
...
## 56. [Development of the New Optical Sensor for IceCube-Gen2](https://arxiv.org/abs/2604.08785) <a id="link56"></a>
...
**Comment:** This paper describes the development of a new optical sensor for IceCube-Gen2, which is focused on instrumentation for neutrino detection. It does not match any of the core topics related to galaxy evolution, dwarf galaxies, or star formation.
...
## 57. [The Illusory Precision of TTV Masses: Hidden Solutions Behind Kepler-9's Tight Mass Ratio](https://arxiv.org/abs/2604.09268) <a id="link57"></a>
...
**Comment:** Focuses on exoplanet mass determination via transit timing variations; not related to galaxy simulations, star formation, or near-field cosmology.
...
## 58. [Validating a Non-conventional Method for Expansion of Coronal Mass Ejections (CMEs) and Investigating the Evolution of a CME Substructures Using Solar Orbiter and Wind Observations](https://arxiv.org/abs/2604.08842) <a id="link58"></a>
...
**Comment:** Presents a method for coronal mass ejection expansion and solar wind studies; not related to galaxy simulations, star formation, or near-field cosmology.
...
## 59. [Inverse Energy Cascade in Turbulent Taylor-Couette Flows](https://arxiv.org/abs/2604.08614) <a id="link59"></a>
...
**Comment:** This paper studies turbulent Taylor-Couette flows and inverse energy cascades, which is fluid dynamics and not related to galaxy simulations, star formation, or near-field cosmology.
...
## 60. [Choice of optical transformation for photonic circuit wavefront sensors](https://arxiv.org/abs/2604.08665) <a id="link60"></a>
...
**Comment:** This paper discusses photonic circuit wavefront sensors for exoplanet imaging, which is not related to any of the core criteria.
...
## 61. [IFS spectrograph designs for the Wide-field Spectroscopic Telescope: Architecture and performance gains from curved sensors](https://arxiv.org/abs/2604.09488) <a id="link61"></a>
...
**Comment:** The paper is about spectrograph design for a wide-field telescope, which is instrumentation and not related to any of the core criteria.
...
## 62. [Recent development in high-precision high-fidelity spectrographs for exoplanet research and characterization](https://arxiv.org/abs/2604.09020) <a id="link62"></a>
...
**Comment:** This paper discusses high-precision spectrographs for exoplanet research, which is unrelated to the core topics (galaxy evolution, star formation, dwarf galaxies, etc.).
...
## 63. [Radio Monitoring Campaign of Active Repeater FRB 20220912A with CHIME](https://arxiv.org/abs/2604.09098) <a id="link63"></a>
...
**Comment:** This paper presents radio monitoring of a repeating fast radio burst (FRB), which is unrelated to the core topics (galaxy evolution, star formation, dwarf galaxies, etc.).
...
## 64. [What Heats the Dense Gas in the Galactic Center?](https://arxiv.org/abs/2604.08909) <a id="link64"></a>
...
**Comment:** This paper investigates the heating mechanisms of dense gas in the Galactic Center, focusing on molecular clouds and the role of cosmic rays and turbulence. The focus is on the Galactic Center, which is explicitly listed as irrelevant in the criteria, and does not address dwarf galaxies, star formation histories, or galaxy simulations.
...
## 65. [Overview of Hayabusa2 extended mission's flyby of Near-Earth Asteroid (98943) Torifune](https://arxiv.org/abs/2604.08832) <a id="link65"></a>
...
**Comment:** The paper provides an overview of the Hayabusa2 extended mission's flyby of a near-Earth asteroid, focusing on planetary defense and material transport in the solar system. It does not address any of the core topics related to galaxies, star formation histories, or stellar models.
...
## 66. [The Northern High Time Resolution Universe pulsar survey: III. Single-pulse search continuation, follow-up observations, and initial results](https://arxiv.org/abs/2604.09080) <a id="link66"></a>
...
**Comment:** Pulsar and radio transient survey; does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 67. [Colloquium: Radio astronomy with the Arecibo 305-m telescope: In contemporaneous context](https://arxiv.org/abs/2604.08775) <a id="link67"></a>
...
**Comment:** This is a historical review of the Arecibo telescope's contributions to radio astronomy. It does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 68. [Unseen Astronomy](https://arxiv.org/abs/2604.09250) <a id="link68"></a>
...
**Comment:** Focuses on multimodal astronomy and science communication, not related to any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
