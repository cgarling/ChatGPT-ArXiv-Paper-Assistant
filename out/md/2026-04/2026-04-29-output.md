...
1. [Multi-component, axisymmetric dynamical models of dSphs based on distribution functions: inferences on dark matter and intermediate-mass black holes in Draco and Ursa Minor](#user-content-link1)
**Authors:** R. Pascale, G. Battaglia, J. M. Arroyo-Polonio, E. Vasiliev, C. Nipoti, G. F. Thomas

2. [The evolution of the baryonic content and mass profiles of satellite galaxies in the MTNG simulations](#user-content-link2)
...
3. [Galactic tides and the outer density profile of the Sculptor and Ursa Minor dwarf spheroidals](#user-content-link3)
**Authors:** Daniel A. Boyea, Julio F. Navarro, Jaclyn Jensen, Rapha\"el Errani

4. [Galaxy mergers and disk angular momentum evolution: stellar halos as a critical test](#user-content-link4)
**Authors:** Eric F. Bell, Richard D'Souza, Monica Valluri, Katya Gozman

5. [Characterisation of the Clouds' young stellar Bridge using Gaia DR3](#user-content-link5)
**Authors:** Marie Sch\"olch (Departament de F\'isica Qu\`antica i Astrof\'isica, Institut d'Estudis Espacials de Catalunya), \'Oscar Jim\'enez-Arranz (Lund Observatory, Division of Astrophysics, Lund University), Merc\`e Romero-G\'omez (Departament de F\'isica Qu\`antica i Astrof\'isica, Institut d'Estudis Espacials de Catalunya), Xavier Luri (Departament de F\'isica Qu\`antica i Astrof\'isica, Institut d'Estudis Espacials de Catalunya)

6. [The Thermodynamic and Kinematic Evolution of Circumgalactic Gas around $z=1$ in the IllustrisTNG model](#user-content-link6)
**Authors:** Daniel DeFelippis, Shy Genel, Greg L. Bryan

7. [SN Ia Population Machine. I. A Unified Cosmological Simulation-Binary Synthesis Framework Establishing Non-universal Delay-time Distributions and Cosmic Progenitor-channel Dominance Crossover](#user-content-link7)
**Authors:** Suk-Jin Yoon, Inhyuk Park, Woong-Bae G. Zee, Chul Chung, Jun-Sung Moon, Sanjaya Paudel, Kiyun Yun, Myung-Hun Kim, Eun-Taek Gim

8. [JWST Constraints on Primordial Magnetic Fields](#user-content-link8)
**Authors:** Malcolm Fairbairn, Mar\'ia Olalla Olea-Romacho, Juan Urrutia, Ville Vaskonen

9. [Effects on vsini determinations of O-stars from 3D model atmospheres with large turbulent velocities](#user-content-link9)
**Authors:** L. Delbroek, J. O. Sundqvist, F. Backs, T. Ceulemans, D. Debnath, P. Schillemans

10. [Asteroseismic analysis of RY Leporis: the post-main sequence HADS in a binary system](#user-content-link10)
**Authors:** Wojciech Niewiadomski, Jadwiga Daszy\'nska-Daszkiewicz, Przemys{\l}aw Walczak, Wojciech Szewczuk, Eloy Rodr\'iguez, Piotr Ko{\l}aczek-Szyma\'nski, Aliz Derekas

11. [Homogeneous Stellar Parameters from Heterogeneous Spectra with Deep Learning](#user-content-link11)
**Authors:** Jeff Shen, Joshua S. Speagle, Shirley Ho

12. [The PHANGS-H{\alpha} survey. Ground-based narrow-band imaging of nearby star-forming galaxies](#user-content-link12)
**Authors:** Alessandro Razza, Guillermo A. Blanc, Brent Groves, Enrico Congiu, Justus Neumann, Hsi-An Pan, I-Ting Ho, Ashley T. Barnes, Francesco Belfiore, M\'ed\'eric Boquien, Charlie Burton, M\'elanie Chevance, Oleg Egorov, Eric Emsellem, Chris Faesi, Simon C. O. Glover, Kathryn Grasha, Ralf S. Klessen, Kathryn Kreckel, Adam K. Leroy, Rebecca McElroy, Ismael Pessa, Eva Schinnerer, Neven Tomi\v{c}i\'c, Amirnezam Amiri, Gagandeep S. Anand, Yixian Cao, Daniel A. Dale, Simthembile Dlamini, Jing Li, J. Eduardo M\'endez-Delgado, Eric J. Murphy, Debosmita Pathak, Miguel Querejeta, Lise Ramambason, Erik Rosolowsky, Fabian Scheuermann, Leonardo \'Ubeda, Thomas G. Williams

13. [Bound or blown: the fate of hot gas in galaxy groups](#user-content-link13)
...
14. [Multi-tracers, multi-surveys: data-driven EFT prior calibration from the PFS--DESI overlap](#user-content-link14)
**Authors:** Nhat-Minh Nguyen

15. [Variance-aware model discrimination with the Sunyaev-Zel'dovich effect of the 21 cm background (SZE-21cm)](#user-content-link15)
**Authors:** Charles Mpho Takalana

16. [Environmental dependence of the Mass-Metallicity Star Formation Relations at z=4-10 with JWST](#user-content-link16)
...
17. [$N$-body modelling of the ED-2 stream progenitor shows Gaia BH3's formation involved dynamical interactions](#user-content-link17)
**Authors:** Daniel Mar\'in Pina, Mark Gieles, Sara Rastello, Cl\`audia Garcia-Diago, Giuliano Iorio, Marc Ard\`evol

18. [Decoupling the AGN outflow and star-forming disk kinematics in the nuclear region of NGC 7582 with JWST NIRSpec and MIRI/MRS](#user-content-link18)
**Authors:** Oscar Veenema, Niranjan Thatte, Dimitra Rigopoulou, Ismael Garc\'ia-Bernete, Almudena Alonso-Herrero, Miguel Pereira-Santaella, Anelise Audibert, Enrica Bellocchi, Andrew J. Bunker, Steph Campbell, Francoise Combes, Ric I. Davies, Fergus R. Donnan, Santiago Garc\'ia-Burillo, Omaira Gonzalez Martin, Laura Hermosa Mu\~noz, Erin K. S. Hicks, Sebastian F. Hoenig, Alvaro Labiano, Nancy A. Levenson, Chris Packham, Cristina Ramos Almeida, Claudio Ricci, Rogemar A. Riffel, David Rosario, Taro Shimizu, Lulu Zhang

19. [Constraining the nature of active galactic nuclei through circumgalactic Lya emission at z=2-3](#user-content-link19)
...
20. [Core Collapse Supernova Modeling: The Next Ten Years](#user-content-link20)
**Authors:** Anthony Mezzacappa

21. [Microlensing of fast and slow compact objects](#user-content-link21)
**Authors:** Manish Tamta, Nirmal Raj, Himanshu Verma

22. [Joint Multiband Photometry with crowdsource](#user-content-link22)
**Authors:** Jayashree Behera, Edward F. Schlafly, Aaron M. Meisner, Lucas Napolitano

23. [V446 Cephei: a $\beta$ Cep pulsator in a multiple system](#user-content-link23)
**Authors:** A. Moharana, J. Southworth, K. Pavlovski, A. Miszuda, R. S. Rathour, K. G. He{\l}miniak, F. Marcadon, D. M. Bowman, T. B. Pawar, A. Tkachenko

24. [Cosmic gas accretion from filaments onto galaxy clusters using the IllustrisTNG simulation](#user-content-link24)
**Authors:** Jade Past\'e, C\'eline Gouin, Nabila Aghanim, Jenny G. Sorce

25. [On the Relation Between Field-Level Posteriors, Correlators, and their Likelihoods](#user-content-link25)
**Authors:** Massimo Pietroni, Fabian Schmidt

26. [Forward modeling solar spectra onto Doppler images of {\lambda} And](#user-content-link26)
**Authors:** \"O. Adebali, A. G. M. Pietrow

27. [LAMOST J052016.79+345651.7: An EW-type Binary with Emission Line Spectra and Circumstellar Material](#user-content-link27)
**Authors:** Yanhui Chen, Chaomi Duan, Yi Yu

28. [Non-Monotonic Rotation Imprint on Time-Integrated Neutrino Spectral Moments in a 15\,$M_\odot$ Core-Collapse Supernova Sequence](#user-content-link28)
**Authors:** Nicolas Viaux

29. [The Bulge Cluster Origin (BulCO) survey with CRIRES at the ESO-VLT: a chemical screening of the Globular Cluster NGC 6553](#user-content-link29)
...
30. [Ultra-thick warm absorbers: Enlarging the parameter space of AGN ionised outflows](#user-content-link30)
**Authors:** R. Middei, E. Piconcelli, E. Nardini, A. Marinucci, M. Laurenti, A. Luminari, A. Trindade Falc\~ao, A. Tortosa, M. Perri, S. Puccetti, D. \L. Kr\'ol, L. Borrelli

31. [ORCHARD: A General Planetary Evolution Code](#user-content-link31)
**Authors:** Roberto Tejada Arevalo, Adam Burrows, Ankan Sur, Yubo Su

32. [A Monte Carlo method for tracking dust properties during coagulation in protoplanetary disks](#user-content-link32)
**Authors:** Nerea Gurrutxaga, Vignesh Vaikundaraman, Joanna Drazkowska

33. [HyGAL: Characterizing the Galactic ISM with observations of hydrides and other small molecules. III. The absorption lines of [O I], CH, and OH](#user-content-link33)
**Authors:** W. -J. Kim, A. M. Jacob, D. A. Neufeld, P. Schilke, H. Wiesemeyer, M. Gerin, M. G. Wolfire, V. Ossenkopf-Okada, V. Valdivia, E. Falgarone, D. C. Lis, S. Bialy, M. R. Rugel, \'A. S\'anchez-Monge, M. Busch, T. M\"oller, F. Wyrowski, D. Seifried, K. M. Menten, A. Saintonge

34. [Peculiar velocities in the $\Lambda$CDM universe](#user-content-link34)
**Authors:** Evanthia Patliaka, Christos G. Tsagas

35. [Disc lifetime distribution as a function of the mass of host star](#user-content-link35)
**Authors:** Susanne Pfalzner, Furkan Dincer, Nienke van der Marel, Frank W. Wagner

36. [A Physics Informed Bayesian Neural Network for the Neutron Star Equation of State](#user-content-link36)
**Authors:** J. D. Baker, C. A. Bertulani, R. V. Lobato

37. [Impact of segmented deformable mirrors on high-contrast testbeds for exoplanet imaging with future large space telescopes: contrast stability assessment on the HiCAT bench](#user-content-link37)
**Authors:** Benjamin Buralli, Mamadou N'Diaye, Rapha\"el Pourcelot, Marcel Carbillet, Emiel H. Por, Iva Laginja, Ludovic Canas, Sarah Steiger, Peter Petrone, Meiji M. Nguyen, Bryony Nickson, Susan F. Redmond, Ananya Sahoo, Laurent Pueyo, Marshall D. Perrin, R\'emi Soummer

38. [The Impact of Elliptical Broad-Line Regions on Reverberation-Based Black Hole Mass Estimates](#user-content-link38)
**Authors:** Jiancheng Wu, Haicheng Feng, Qingwen Wu, Xinwu Cao

39. [Recovering cosmological parameters from the mock gravitational wave data of the Einstein Telescope](#user-content-link39)
**Authors:** Pinaki Roy, Tomasz Bulik

40. [3D Kinetic Simulations of Driven Reconnection in Merging Flux Tubes](#user-content-link40)
**Authors:** Camille Granier, Fabio Bacchini, Daniel Groselj, Lorenzo Sironi

41. [Compton-thick AGN Characterisation in a Multi-wavelength Context: Insights from the 70-Month \textit{SWIFT}/BAT Catalogue](#user-content-link41)
**Authors:** Muhammad Luqman Hakeem Musa, Zamri Zainal Abidin, Masatoshi Imanishi, Yoshiaki Hagiwara, Adlyka Ainul Annuar

42. [Enabling real-time multi-messenger follow-up of transient events with Astro-COLIBRI](#user-content-link42)
**Authors:** Bernardo Cornejo Avila, Sofia Bisero, Mick\"ael Costa, Antoine Ciric, Ilja Jaroschewski, Weizmann Kiendr\'eb\'eogo, Fabian Sch\"ussler

43. [Pair-Rich Corona of an Accreting Kerr Black Hole](#user-content-link43)
**Authors:** Jonathan Zhang, Christopher Thompson

44. [Moving-Mesh Simulations of Mini-Common Envelope Ejection in Classical Novae](#user-content-link44)
**Authors:** Nicholas Nelson, Philip Chang

45. [RSCL Earth Lookback Simulator: A Real-Time Multi-Physics Framework for Relativistic Signal Propagation from Confirmed Milky Way Exoplanets](#user-content-link45)
**Authors:** Mohamed El-Hadedy

46. [TDCOSMO XXVI: Uniform lens modeling of eight doubly imaged quasars](#user-content-link46)
...
47. [The Singular Behaviour of Ambipolar Diffusion Revealed by 1D Cartesian Solutions](#user-content-link47)
**Authors:** F. Moreno-Insertis, E. R. Priest, D. N\'obrega-Siverio

48. [Fast radio burst dispersion is an unbiased tracer of matter on large scales](#user-content-link48)
**Authors:** Shion Andrew, Haochen Wang, Kiyoshi Masui, Josh Borrow, Calvin Leung, Ryan Raikman, Matthieu Schaller, Joop Schaye, James M. Sullivan

49. [Oxygen Isotopic Compositions of Chondrules as Probes of Solar Protoplanetary Disk Formation](#user-content-link49)
**Authors:** Sota Arakawa, Takayuki Ushikubo, Ryosuke T. Tominaga

50. [JOYS+ analyses of OCN$^-$, N$_2$O, NO, and complex cyanides in ices -- Thermal processing results in modest enhancement of OCN$^-$ ice](#user-content-link50)
**Authors:** P. Nazari, N. Brunken, Y. Chen, K. Slavicinska, E. F. van Dishoeck, W. R. M. Rocha, A. C. A. Boogert, M. G. Navarro, V. J. M. Le Gouellec, L. Francis, \L. Tychoniec, A. Caratti o Garatti, C. Gieser, T. P. Greene, P. J. Kavanagh

51. [Collective neutrino-antineutrino pair oscillations](#user-content-link51)
**Authors:** Shih-Jie Huang, Meng-Ru Wu

52. [Intergalactic Magnetic Field constraints from detected very high-energy Gamma-Ray Bursts using the Cherenkov Telescope Array Observatory](#user-content-link52)
**Authors:** T\'en\'eman Keita, Renaud Belmont, Thierry Stolarczyk

53. [spectroxide: A code package for computing cosmic microwave background spectral distortions](#user-content-link53)
**Authors:** Ethan Baker, Hongwan Liu, Siddharth Mishra-Sharma

54. [The effects of image augmentations when training machine learning models in astronomy](#user-content-link54)
**Authors:** Leon H. Butterworth, Ashley Spindler

55. [Symmetric kiloparsec-scale radio knots in NGC 7213: evidence for a confined weak jet and recurrent nuclear activity](#user-content-link55)
...
56. [Generalizing the CPL Parametrization through Dark Sector Interaction](#user-content-link56)
**Authors:** Mikel Artola, Ruth Lazkoz, Vincenzo Salzano

57. [Joint Estimation of Properties of the Lunar Subsurface and Galactic Foregrounds with LuSEE-Night](#user-content-link57)
...
58. [The GMRT High-Resolution Southern Sky Survey for pulsars and transients -- VIII: Orbital Variability and the Evolution of a 1-Day He-WD Millisecond Pulsar J2101-4208](#user-content-link58)
...
65. [Plausible but Wrong: A case study on Agentic Failures in Astrophysical Workflows](#user-content-link65)
**Authors:** Shivam Rawat, Lucie Flek

66. [Massive Black holes and their galaxies](#user-content-link66)
**Authors:** Ricarda S. Beckmann, Rebecca J. Smethurst

67. [Simple Analytical Solutions of the Wheeler-DeWitt Equation in the Classical Hamilton-Jacobi Limit](#user-content-link67)
**Authors:** Naoto Maki, Chia-Min Lin, Kazunori Kohri

68. [The Unstable Chromosphere: Effects of the Thermal Farley-Buneman Instability Across a Broad Range of Solar Chromospheric Conditions](#user-content-link68)
**Authors:** Samuel Evans, Meers Oppenheim, Juan Mart\'inez-Sykora, Alexander Green

69. [Correlation Between Lunar Surface and Exospheric Sodium: Effects of Albedo-Driven Temperature on Multilayer Sodium Reservoirs Rather Than Surface Abundance Variations](#user-content-link69)
**Authors:** A. Devaraj, S. Narendranath, Sreeja. S. Kartha, Netra S. Pillai

70. [Seismic background mitigation with the Lunar Gravitational-wave Antenna](#user-content-link70)
**Authors:** Han Yan, Jan Harms

71. [Solar Energetic Particle Reflection by Precursor ICMEs: Multi-spacecraft Observations of Bi-Directional Electron Beams at 1 AU](#user-content-link71)
**Authors:** Lucas Liuzzo, Wenwen Wei, Andrew R. Poppe, Christina O. Lee, Vassilis Angelopoulos

72. [Towards Seamless Lunar Mosaics: Deep Radiometric Normalization for Cross-Sensor Orbital Imagery Using Chandrayaan-2 TMC Data](#user-content-link72)
**Authors:** Pratincha Singh, Jai Gopal Singla, Prashant Hemrajani, Nitant Dube, Amithabh, Hinal Patel

---

## 1. [Multi-component, axisymmetric dynamical models of dSphs based on distribution functions: inferences on dark matter and intermediate-mass black holes in Draco and Ursa Minor](https://arxiv.org/abs/2604.24855) <a id="link1"></a>
...
**Comment:** Directly matches near-field cosmology criteria: axisymmetric dynamical models of Milky Way dwarf spheroidals (Draco and Ursa Minor), measuring dark matter density profiles (core-cusp), stellar populations, and IMBH limits. Highly relevant.
...
## 2. [The evolution of the baryonic content and mass profiles of satellite galaxies in the MTNG simulations](https://arxiv.org/abs/2604.24837) <a id="link2"></a>
...
**Comment:** Directly relevant to near-field cosmology and numerical galaxy simulations: studies the evolution of baryonic content and mass profiles of satellite galaxies in a cosmological hydrodynamic simulation, with focus on stripping and mass loss mechanisms. Also touches on satellite quenching and mass profiles.
...
## 3. [Galactic tides and the outer density profile of the Sculptor and Ursa Minor dwarf spheroidals](https://arxiv.org/abs/2604.24853) <a id="link3"></a>
...
**Comment:** Directly matches near-field cosmology: investigates the outer density profiles of Milky Way dwarf spheroidals (Sculptor and Ursa Minor), discusses tidal effects, dark matter profiles, and possible merger histories. Highly relevant.
...
## 4. [Galaxy mergers and disk angular momentum evolution: stellar halos as a critical test](https://arxiv.org/abs/2604.24965) <a id="link4"></a>
...
**Comment:** This paper analyzes Milky Way-mass galaxies in TNG-50 simulations, focusing on angular momentum evolution and the role of mergers, with a specific emphasis on accreted stellar halos and their kinematic signatures. The discussion of the Milky Way's accreted stellar halo and merger history is highly relevant to near-field cosmology, especially signs of historic interactions and accreted stellar halo structure. Also fits numerical galaxy simulations criterion.
...
## 5. [Characterisation of the Clouds' young stellar Bridge using Gaia DR3](https://arxiv.org/abs/2604.25741) <a id="link5"></a>
...
**Comment:** This paper characterizes the young stellar Bridge between the LMC and SMC using Gaia DR3, focusing on tidal features and historic interactions. It matches the 'Near-Field Cosmology' criterion, specifically signs of historic interactions between the Milky Way satellites (LMC/SMC) and the formation of tidal features. It also touches on resolved stellar populations.
...
## 6. [The Thermodynamic and Kinematic Evolution of Circumgalactic Gas around $z=1$ in the IllustrisTNG model](https://arxiv.org/abs/2604.24836) <a id="link6"></a>
...
**Comment:** Directly relevant to the circumgalactic medium criterion: studies the thermodynamic and kinematic evolution of CGM gas around galaxies in the IllustrisTNG simulation, including feedback and phase structure. Also fits numerical galaxy simulations criterion.
...
## 7. [SN Ia Population Machine. I. A Unified Cosmological Simulation-Binary Synthesis Framework Establishing Non-universal Delay-time Distributions and Cosmic Progenitor-channel Dominance Crossover](https://arxiv.org/abs/2604.24846) <a id="link7"></a>
...
**Comment:** Presents a framework coupling cosmological hydrodynamic simulations to binary population synthesis to model SN Ia populations, delay-time distributions, and progenitor channel dominance. Directly matches the 'Numerical Galaxy Simulations' criterion, with new physics (binary evolution) and implications for galaxy evolution and SN rates. Also relevant for resolved star formation histories in simulations.
...
## 8. [JWST Constraints on Primordial Magnetic Fields](https://arxiv.org/abs/2604.24835) <a id="link8"></a>
...
**Comment:** The paper uses JWST constraints on primordial magnetic fields, focusing on their effect on small-scale structure formation and the UV luminosity function. The discussion of low-mass halos and their hosted galaxies, and the use of the UVLF, is relevant to near-field cosmology and satellite luminosity functions.
...
## 9. [Effects on vsini determinations of O-stars from 3D model atmospheres with large turbulent velocities](https://arxiv.org/abs/2604.25391) <a id="link9"></a>
...
**Comment:** This paper presents new 3D stellar atmosphere models for O-stars and discusses implications for stellar rotation measurements and evolutionary models. It fits the 'Stellar Models' criterion, as it presents new theoretical models relevant to stellar evolution.
...
## 10. [Asteroseismic analysis of RY Leporis: the post-main sequence HADS in a binary system](https://arxiv.org/abs/2604.25594) <a id="link10"></a>
...
**Comment:** Asteroseismic analysis and seismic modeling of a post-main sequence star in a binary system; relevant to the stellar models criterion due to seismic modeling and atmospheric parameter determination.
...
## 11. [Homogeneous Stellar Parameters from Heterogeneous Spectra with Deep Learning](https://arxiv.org/abs/2604.25786) <a id="link11"></a>
...
**Comment:** This paper presents a deep learning framework for deriving homogeneous stellar parameters and abundances from heterogeneous spectroscopic surveys. While it enables large-scale Galactic archaeology, it does not directly address resolved star formation histories from color-magnitude diagrams, stellar models, or dwarf galaxy evolution. It is borderline relevant for stellar models and resolved star formation histories (theoretical/indirect), but not a direct match.
...
## 12. [The PHANGS-H{\alpha} survey. Ground-based narrow-band imaging of nearby star-forming galaxies](https://arxiv.org/abs/2604.25627) <a id="link12"></a>
...
**Comment:** The PHANGS-Hα survey provides narrow-band imaging of nearby massive star-forming galaxies, enabling mapping of HII regions and star formation rates. While it is relevant to resolved star formation histories, the focus is on massive galaxies, not dwarfs, so it is somewhat relevant but not a direct match.
...
## 13. [Bound or blown: the fate of hot gas in galaxy groups](https://arxiv.org/abs/2604.24863) <a id="link13"></a>
...
**Comment:** Compares X-ray observations of galaxy groups to hydrodynamical simulations with varying AGN feedback. The focus is on the fate of hot gas in galaxy groups, which are more massive than dwarf galaxies, but the paper does discuss feedback and baryon content in low-mass halos. Borderline relevance for numerical galaxy simulations and star formation driven outflows, but not a direct match.
...
## 15. [Variance-aware model discrimination with the Sunyaev-Zel'dovich effect of the 21 cm background (SZE-21cm)](https://arxiv.org/abs/2604.24980) <a id="link15"></a>
...
**Comment:** Uses semi-numerical simulations of the global 21 cm background and the Sunyaev-Zel'dovich effect to discriminate Cosmic Dawn models. While it involves galaxy cluster physics and early universe star formation, it does not directly address resolved star formation histories, dwarf galaxies, or numerical galaxy simulations as defined in the criteria.
...
## 17. [$N$-body modelling of the ED-2 stream progenitor shows Gaia BH3's formation involved dynamical interactions](https://arxiv.org/abs/2604.24874) <a id="link17"></a>
...
**Comment:** This paper uses N-body simulations to study the formation of a black hole binary in the ED-2 stellar stream, focusing on cluster dynamics and stellar evolution. While it uses numerical simulations and discusses stellar streams, it does not focus on galaxy-scale simulations or dwarf galaxies. The relevance is borderline, as stellar streams are sometimes considered in near-field cosmology, but the focus is on black hole binary formation.
...
## 18. [Decoupling the AGN outflow and star-forming disk kinematics in the nuclear region of NGC 7582 with JWST NIRSpec and MIRI/MRS](https://arxiv.org/abs/2604.24892) <a id="link18"></a>
...
**Comment:** This paper analyzes AGN-driven outflows and circumnuclear disk dynamics in a Seyfert galaxy. While it discusses outflows, the focus is on AGN-driven outflows in a massive galaxy, not star-formation-driven outflows or dwarf galaxies. It is borderline relevant due to the outflow discussion.
...
## 19. [Constraining the nature of active galactic nuclei through circumgalactic Lya emission at z=2-3](https://arxiv.org/abs/2604.25127) <a id="link19"></a>
...
**Comment:** Analyzes circumgalactic Lyα nebulae around quasars at z=2-3, focusing on AGN feedback and outflows. While it discusses outflows and the CGM, the work is on massive galaxies (quasars) and not dwarfs, so relevance is limited.
...
## 20. [Core Collapse Supernova Modeling: The Next Ten Years](https://arxiv.org/abs/2604.24970) <a id="link20"></a>
...
**Comment:** Review of core collapse supernova modeling, discussing advances in simulation techniques and the importance of stellar evolution and nuclear theory. While it touches on stellar models and numerical simulations, it is a broad review and not presenting new models or simulations directly relevant to the core topics.
...
## 21. [Microlensing of fast and slow compact objects](https://arxiv.org/abs/2604.25434) <a id="link21"></a>
...
**Comment:** This paper discusses microlensing constraints on compact objects with non-standard velocity distributions. While it touches on dark matter and halo structure, it does not focus on galaxy substructure, satellite galaxies, or near-field cosmology topics.
...
## 22. [Joint Multiband Photometry with crowdsource](https://arxiv.org/abs/2604.24875) <a id="link22"></a>
...
**Comment:** Presents a multiband photometric pipeline for crowded fields, improving source detection and photometry. While useful for stellar population studies, it does not directly address resolved star formation histories or any other core criteria.
...
## 24. [Cosmic gas accretion from filaments onto galaxy clusters using the IllustrisTNG simulation](https://arxiv.org/abs/2604.24852) <a id="link24"></a>
...
**Comment:** This paper analyzes gas accretion from filaments onto galaxy clusters using the IllustrisTNG simulation. The focus is on clusters, not dwarf galaxies or the CGM of dwarfs, so it does not match the core criteria.
...
## 25. [On the Relation Between Field-Level Posteriors, Correlators, and their Likelihoods](https://arxiv.org/abs/2604.25385) <a id="link25"></a>
...
**Comment:** Develops a field-level posterior for cosmological data, focusing on inference methods for large-scale structure. While methodologically interesting, it does not directly address any of the specified galaxy or stellar criteria.
...
## 27. [LAMOST J052016.79+345651.7: An EW-type Binary with Emission Line Spectra and Circumstellar Material](https://arxiv.org/abs/2604.25327) <a id="link27"></a>
...
**Comment:** Focuses on an eclipsing binary with emission lines and circumstellar material, including evolutionary modeling. While it uses stellar evolution codes, it does not present new stellar models or relate to galaxy-scale phenomena.
...
## 28. [Non-Monotonic Rotation Imprint on Time-Integrated Neutrino Spectral Moments in a 15\,$M_\odot$ Core-Collapse Supernova Sequence](https://arxiv.org/abs/2604.25084) <a id="link28"></a>
...
**Comment:** Analyzes neutrino signals from core-collapse supernova simulations, focusing on rotation effects. While it uses numerical simulations, it is not about galaxy simulations or stellar models relevant to the criteria.
...
## 29. [The Bulge Cluster Origin (BulCO) survey with CRIRES at the ESO-VLT: a chemical screening of the Globular Cluster NGC 6553](https://arxiv.org/abs/2604.24856) <a id="link29"></a>
...
**Comment:** The paper presents a chemical screening of a globular cluster in the Galactic bulge. While it involves stellar abundances and multiple populations, it focuses on the bulge and globular clusters, not dwarf satellites or near-field cosmology. No direct match to core criteria.
...
## 30. [Ultra-thick warm absorbers: Enlarging the parameter space of AGN ionised outflows](https://arxiv.org/abs/2604.24899) <a id="link30"></a>
...
**Comment:** The paper studies ionized outflows in AGN, specifically ultra-thick warm absorbers and their connection to AGN feedback. The focus is on AGN-driven outflows, not star-formation-driven outflows or CGM of dwarf galaxies, so it does not match any core criteria.
...
## 31. [ORCHARD: A General Planetary Evolution Code](https://arxiv.org/abs/2604.24845) <a id="link31"></a>
...
**Comment:** ORCHARD is a planetary evolution code for modeling planets and exoplanets, not galaxies or stellar models. It does not match any of the core topics (no galaxy simulations, star formation histories, quenching, or CGM).
...
## 32. [A Monte Carlo method for tracking dust properties during coagulation in protoplanetary disks](https://arxiv.org/abs/2604.24857) <a id="link32"></a>
...
**Comment:** Presents a new Monte Carlo method for tracking dust properties in protoplanetary disks, which is not directly relevant to galaxy simulations or the other core topics.
...
## 33. [HyGAL: Characterizing the Galactic ISM with observations of hydrides and other small molecules. III. The absorption lines of [O I], CH, and OH](https://arxiv.org/abs/2604.25590) <a id="link33"></a>
...
**Comment:** This paper studies the Galactic ISM using hydrides and small molecules, focusing on molecular tracers and abundance variations in the Milky Way. It does not address dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 34. [Peculiar velocities in the $\Lambda$CDM universe](https://arxiv.org/abs/2604.24974) <a id="link34"></a>
...
**Comment:** Studies peculiar velocities in the ΛCDM universe, focusing on linear evolution after recombination. While it is cosmological, it does not address near-field cosmology, galaxy simulations, or any of the specified criteria.
...
## 35. [Disc lifetime distribution as a function of the mass of host star](https://arxiv.org/abs/2604.25277) <a id="link35"></a>
...
**Comment:** The paper studies protoplanetary disc lifetimes as a function of stellar mass, relevant to planet formation but not to stellar models, resolved star formation histories, or galaxy evolution.
...
## 37. [Impact of segmented deformable mirrors on high-contrast testbeds for exoplanet imaging with future large space telescopes: contrast stability assessment on the HiCAT bench](https://arxiv.org/abs/2604.25675) <a id="link37"></a>
...
**Comment:** This paper investigates segmented deformable mirrors for exoplanet imaging, focusing on instrumentation and contrast stability. It does not match any of the core topics (no galaxy focus, no star formation, quenching, stellar models, or galaxy simulations).
...
## 38. [The Impact of Elliptical Broad-Line Regions on Reverberation-Based Black Hole Mass Estimates](https://arxiv.org/abs/2604.25163) <a id="link38"></a>
...
**Comment:** The paper investigates the impact of elliptical broad-line regions on SMBH mass estimates, focusing on BLR geometry and reverberation mapping. It does not match any of the core topics (no galaxy focus, no star formation, quenching, stellar models, or galaxy simulations).
...
## 39. [Recovering cosmological parameters from the mock gravitational wave data of the Einstein Telescope](https://arxiv.org/abs/2604.25307) <a id="link39"></a>
...
**Comment:** This paper uses mock gravitational wave data to recover cosmological parameters, focusing on the Hubble constant and matter density. It does not address galaxies, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 40. [3D Kinetic Simulations of Driven Reconnection in Merging Flux Tubes](https://arxiv.org/abs/2604.10431) <a id="link40"></a>
...
**Comment:** This paper focuses on kinetic simulations of magnetic reconnection in pair plasmas, which is not directly related to any of the core topics such as galaxy simulations, near-field cosmology, or stellar models.
...
## 41. [Compton-thick AGN Characterisation in a Multi-wavelength Context: Insights from the 70-Month \textit{SWIFT}/BAT Catalogue](https://arxiv.org/abs/2604.25543) <a id="link41"></a>
...
**Comment:** Characterizes Compton-thick AGN using multi-wavelength data; AGN studies are not relevant to the core topics (no connection to dwarf galaxies, star formation, or galaxy simulations).
...
## 42. [Enabling real-time multi-messenger follow-up of transient events with Astro-COLIBRI](https://arxiv.org/abs/2604.25529) <a id="link42"></a>
...
**Comment:** Describes a platform for real-time multi-messenger follow-up of transient events; while useful for time-domain astrophysics, it does not directly address any of the core topics.
...
## 43. [Pair-Rich Corona of an Accreting Kerr Black Hole](https://arxiv.org/abs/2604.24961) <a id="link43"></a>
...
**Comment:** Models the corona of an accreting Kerr black hole, focusing on pair creation and X-ray spectra; not relevant to galaxy simulations, near-field cosmology, or stellar models.
...
## 44. [Moving-Mesh Simulations of Mini-Common Envelope Ejection in Classical Novae](https://arxiv.org/abs/2604.24963) <a id="link44"></a>
...
**Comment:** Simulates mass ejection in cataclysmic variables, focusing on binary interaction and angular momentum; not directly relevant to galaxy simulations or the other core topics.
...
## 45. [RSCL Earth Lookback Simulator: A Real-Time Multi-Physics Framework for Relativistic Signal Propagation from Confirmed Milky Way Exoplanets](https://arxiv.org/abs/2604.24988) <a id="link45"></a>
...
**Comment:** This paper focuses on signal propagation effects for exoplanets in the Milky Way, relevant to SETI and exoplanet science. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, dwarf galaxies, stellar models, galaxy simulations, outflows, CGM).
...
## 46. [TDCOSMO XXVI: Uniform lens modeling of eight doubly imaged quasars](https://arxiv.org/abs/2604.24908) <a id="link46"></a>
...
**Comment:** Uniform lens modeling of doubly imaged quasars for cosmography. Focus is on gravitational lensing and cosmological parameters, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 48. [Fast radio burst dispersion is an unbiased tracer of matter on large scales](https://arxiv.org/abs/2604.25828) <a id="link48"></a>
...
**Comment:** The paper discusses fast radio burst dispersion as a tracer of large-scale matter distribution, focusing on cosmological applications. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, dwarf galaxies, etc.).
...
## 49. [Oxygen Isotopic Compositions of Chondrules as Probes of Solar Protoplanetary Disk Formation](https://arxiv.org/abs/2604.25263) <a id="link49"></a>
...
**Comment:** This paper models oxygen isotopic compositions in chondrules to probe protoplanetary disk formation. It is focused on planet formation and disk chemistry, not on galaxies, star formation histories, or near-field cosmology.
...
## 50. [JOYS+ analyses of OCN$^-$, N$_2$O, NO, and complex cyanides in ices -- Thermal processing results in modest enhancement of OCN$^-$ ice](https://arxiv.org/abs/2604.25915) <a id="link50"></a>
...
**Comment:** This paper studies nitrogen-bearing molecules in ices in young stellar objects using JWST. It is focused on astrochemistry and star formation in protostellar environments, not on galaxies, star formation histories, or near-field cosmology.
...
## 52. [Intergalactic Magnetic Field constraints from detected very high-energy Gamma-Ray Bursts using the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2604.25647) <a id="link52"></a>
...
**Comment:** This paper discusses constraints on the intergalactic magnetic field from gamma-ray bursts using CTAO. It is focused on cosmological magnetic fields and gamma-ray bursts, not on galaxies, star formation, or near-field cosmology.
...
## 53. [spectroxide: A code package for computing cosmic microwave background spectral distortions](https://arxiv.org/abs/2604.24838) <a id="link53"></a>
...
**Comment:** This paper presents a code package for computing CMB spectral distortions, which is not relevant to galaxy evolution, star formation, or stellar models.
...
## 54. [The effects of image augmentations when training machine learning models in astronomy](https://arxiv.org/abs/2604.24862) <a id="link54"></a>
...
**Comment:** This paper focuses on machine learning methods for galaxy morphology classification, which is not directly related to any of the core topics (e.g., near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 55. [Symmetric kiloparsec-scale radio knots in NGC 7213: evidence for a confined weak jet and recurrent nuclear activity](https://arxiv.org/abs/2604.25046) <a id="link55"></a>
...
**Comment:** Focuses on radio jets and nuclear activity in a low-luminosity AGN, which is not relevant to any of the core topics (no connection to dwarf galaxies, star formation histories, or galaxy simulations).
...
## 56. [Generalizing the CPL Parametrization through Dark Sector Interaction](https://arxiv.org/abs/2604.25373) <a id="link56"></a>

**ArXiv ID:** 2604.25373

**Authors:** Mikel Artola, Ruth Lazkoz, Vincenzo Salzano

**Abstract:** We investigate a hierarchy of interacting dark energy (IDE) models featuring a non-gravitational coupling between dark matter and dark energy. Specifically, we examine scenarios where the background interaction kernel, $Q = 3H(\delta + \eta a)\rho_\mathrm{de}$, allows for both constant and dynamical coupling parameters. Adopting the CPL parametrization for the dark energy equation of state, $w_\mathrm{de} = w_0 + w_a(1-a)$, we derive closed analytical expressions for the energy densities of dark matter and dark energy. Afterwards, we obtain observational constraints using joint combinations of DESI DR2 baryon acoustic oscillations, Pantheon$+$ Type Ia supernovae, and Planck$+$ACT compressed cosmic microwave background likelihoods. For constant coupling models, we find parametric deviations from $\Lambda$ ranging from $2.7\sigma$ to $2.9\sigma$; however, for interactions with dynamical couplings, these significances are reduced to $1.3\sigma$--$1.5\sigma$. Ultimately, our Bayesian model comparison reveals that no investigated IDE scenario is statistically preferred over the concordance $\Lambda$CDM model. These results highlight the necessity of reporting Bayesian evidence alongside conventional frequentist maximum-likelihood analyses to ensure robust cosmological claims concerning dark energy evolution and interaction.

**Comment:** Examines interacting dark energy models and cosmological parameter constraints, which is not directly relevant to near-field cosmology or galaxy-scale topics.
...
## 57. [Joint Estimation of Properties of the Lunar Subsurface and Galactic Foregrounds with LuSEE-Night](https://arxiv.org/abs/2604.21170) <a id="link57"></a>
...
**Comment:** Joint estimation of lunar subsurface and galactic foregrounds for a lunar radio telescope. The galactic foreground modeling is not directly related to the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 58. [The GMRT High-Resolution Southern Sky Survey for pulsars and transients -- VIII: Orbital Variability and the Evolution of a 1-Day He-WD Millisecond Pulsar J2101-4208](https://arxiv.org/abs/2604.25278) <a id="link58"></a>
...
**Comment:** This paper presents timing and polarimetry of a millisecond pulsar in a binary system, discussing its evolution and orbital variability. It does not match any of the core criteria (no focus on galaxies, star formation histories, or near-field cosmology).
...
## 59. [Rotation Measure Substructures Induced by the Ponderomotive Force of Inertial \alfven Waves](https://arxiv.org/abs/2604.25469) <a id="link59"></a>
...
**Comment:** The paper discusses rotation measure substructures in fast radio bursts due to plasma waves. It is focused on plasma physics and FRB environments, not on galaxies, star formation, or near-field cosmology.
...
## 60. [Can BLR line profile shape improve single-epoch black hole mass estimates?](https://arxiv.org/abs/2604.24901) <a id="link60"></a>
...
**Comment:** This paper discusses the virial coefficient in AGN broad-line region modeling for black hole mass estimates. It is focused on AGN and black hole mass estimation, not on galaxies, star formation, or near-field cosmology.
...
## 61. [Euclid: Asteroid rotation periods from the Euclid Ecliptic Survey](https://arxiv.org/abs/2604.25652) <a id="link61"></a>
...
**Comment:** This paper focuses on asteroid rotation periods from Euclid survey data. It is unrelated to any of the core topics (near-field cosmology, galaxy simulations, star formation histories, quenching, stellar models, outflows, or CGM).
...
## 62. [Polarization-preserving wavefront rotator](https://arxiv.org/abs/2604.25475) <a id="link62"></a>
...
**Comment:** This paper presents an optical engineering solution for polarization-preserving wavefront rotation. It is not relevant to any astrophysical criteria listed.
...
## 63. [Geometric Constraints on the Pre-Recombination Expansion History from the Hubble Tension](https://arxiv.org/abs/2604.25813) <a id="link63"></a>
...
**Comment:** This paper reconstructs the pre-recombination expansion history to address the Hubble tension. It is a cosmology paper and does not relate to galaxy evolution, star formation, or stellar models.
...
## 64. [Gauge Theoretic Signal Processing II: Zero-Latency Whitening for Early Warning Pipelines](https://arxiv.org/abs/2604.25116) <a id="link64"></a>
...
**Comment:** The paper discusses signal processing for gravitational wave pipelines, which is not related to any of the core topics (no galaxy focus, no star formation, quenching, stellar models, or galaxy simulations).
...
## 65. [Plausible but Wrong: A case study on Agentic Failures in Astrophysical Workflows](https://arxiv.org/abs/2604.25345) <a id="link65"></a>
...
**Comment:** Discusses agentic AI failures in astrophysical workflows, which is not directly related to any of the core topics (no connection to galaxy simulations, star formation, or stellar models).
...
## 66. [Massive Black holes and their galaxies](https://arxiv.org/abs/2604.25560) <a id="link66"></a>
...
**Comment:** Focuses on massive black holes and their host galaxies, including coevolution and feedback. This is not relevant to near-field cosmology, dwarf galaxies, or any of the specified criteria. The focus is on supermassive black holes and galaxy-scale properties.
...
## 68. [The Unstable Chromosphere: Effects of the Thermal Farley-Buneman Instability Across a Broad Range of Solar Chromospheric Conditions](https://arxiv.org/abs/2604.25027) <a id="link68"></a>
...
**Comment:** This paper studies plasma instabilities in the solar chromosphere, which is unrelated to the core topics (no galaxy focus, no star formation, quenching, stellar models, or galaxy simulations).
...
## 69. [Correlation Between Lunar Surface and Exospheric Sodium: Effects of Albedo-Driven Temperature on Multilayer Sodium Reservoirs Rather Than Surface Abundance Variations](https://arxiv.org/abs/2604.25281) <a id="link69"></a>
...
**Comment:** The paper studies sodium release mechanisms in the lunar exosphere, focusing on lunar surface and exospheric sodium. It is unrelated to the core topics (no galaxy focus, no star formation, quenching, stellar models, or galaxy simulations).
...
## 70. [Seismic background mitigation with the Lunar Gravitational-wave Antenna](https://arxiv.org/abs/2604.24866) <a id="link70"></a>
...
**Comment:** This paper discusses seismic background mitigation for lunar gravitational-wave detectors. It is unrelated to galaxy evolution, star formation histories, or near-field cosmology.
...
## 71. [Solar Energetic Particle Reflection by Precursor ICMEs: Multi-spacecraft Observations of Bi-Directional Electron Beams at 1 AU](https://arxiv.org/abs/2604.25019) <a id="link71"></a>
...
**Comment:** Multi-spacecraft observations of solar energetic particle reflection by ICMEs. Focus is on solar system particle physics and astronaut safety, not on galaxy evolution, star formation, or near-field cosmology.
...
## 72. [Towards Seamless Lunar Mosaics: Deep Radiometric Normalization for Cross-Sensor Orbital Imagery Using Chandrayaan-2 TMC Data](https://arxiv.org/abs/2604.25208) <a id="link72"></a>
...
**Comment:** Paper is about lunar mosaics and radiometric normalization for planetary imagery. No connection to any of the specified astrophysical criteria.
