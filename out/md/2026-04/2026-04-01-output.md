...
1. [PAC in DESI. II. Galaxy-halo connection into the $10^{6}{\rm M}_{\odot}$ frontier](#user-content-link1)
**Authors:** Kun Xu, Carlos S. Frenk, Y. P. Jing, Shaun Cole, Sownak Bose, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, F. J. Castander, T. Claybaugh, A. de la Macorra, P. Doel, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, C. Hahn, R. Joyce, S. Juneau, R. Kehoe, T. Kisner, M. Landriau, L. Le Guillou, M. Manera, R. Miquel, J. Moustakas, S. Nadathur, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, L. Samushia, E. Sanchez, D. Schlegel, J. H. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver, H. Zou

2. [Pervasive Cavity-Ring Structure for Star Formation in Dwarf Irregular Galaxies](#user-content-link2)
**Authors:** Bruce G. Elmegreen, Deidre A. Hunter

3. [Introducing PxP: A Population Synthesis Framework for Predicting YSO Properties](#user-content-link3)
**Authors:** J. Peltonen, E. Rosolowsky, A Ginsburg, R. Indebetouw, T. Richardson, M. Jimena Rodriguez

4. [The Evolving Faber-Jackson Relation: A Unifying Framework for Galaxy Ages and the Baryonic Tully-Fisher Connection](#user-content-link4)
**Authors:** Stuart Marongwe, Stuart Kauffman

5. [Direct N-body simulations of rotating and extremely massive Population III star clusters](#user-content-link5)
...
6. [Enhanced Multiphase Circumgalactic Medium and Gas Cycling in Galaxy Mergers](#user-content-link6)
**Authors:** Maolan Yang, Suoqing Ji, Robert Feldmann, Feng Yuan, Jorge Moreno, Taotao Fang, Coral Wheeler, Luigi Bassini, Jing Wang, Jonathan Stern, Claude-Andr\'e Faucher-Gigu\`ere, Du\v{s}an Kere\v{s}

7. [Ripples of Stellar Enrichment (RoSE) -- simulating element production and mixing in the Milky Way star-by-star](#user-content-link7)
**Authors:** Chuhan Zhang, Mark R. Krumholz, Melissa K. Ness, Yuan-sen Ting, Zefeng Li, Zipeng Hu

8. [Data-driven discovery of dynamo cycle equations](#user-content-link8)
**Authors:** Anna Guseva, Calum Skene, Steve Tobias

9. [The Actinide-Boost Star LAMOST J122216.85-063345.2: A Detailed R-process Abundance Study with Gemini-S/GHOST](#user-content-link9)
**Authors:** Miji Jeong, Young Sun Lee, Vinicius M. Placco, Yutaka Hirai, Timothy C. Beers, Jeong-Eun Heo, Kristin Chiboucas, Emily Deibert, Roberto Gamen, Venu M. Kalari, Eder Martioli, Ruben Diaz, Manuel Gomez-Jimenez, Roque Ruiz-Carmona, Greg Burley, J. Gordon Robertson, Kathleen Labrie, Joanna Thomas-Osip

10. [The CAVITY project. The spatially resolved SFR of galaxies in voids](#user-content-link10)
**Authors:** Ana M. Conrado, Rub\'en Garc\'ia-Benito, Rosa M. Gonz\'alez Delgado, Bahar Bidaran, H\'el\`ene M. Courtois, Salvador Duarte Puertas, Daniel Espada, Andoni Jim\'enez, Ignacio del Moral-Castro, Isabel P\'erez, Tom\'as Ruiz-Lara, Laura S\'anchez-Menguiano, Gloria Torres-R\'ios, Simon Verley, Mar\'ia Argudo-Fern\'andez, Simon B. De Daniloff, Estrella Florido, Yllari K. Gonz\'alez-Koda, Alejandra Z. Lugo-Aranda, Javier Rom\'an, Smitha Subramanian, Pedro Villalba-Gonz\'alez, Manuel Alc\'azar-Laynez, M\'onica Hern\'andez-S\'anchez, M\'onica Rodr\'iguez Mart\'inez, Paulo V\'asquez-Bustos, Martin Blazek

11. [A multi-scale molecular and atomic gas view on the HII region N113 in the Large Magellanic Cloud:Evidence for high-mass star formation triggered by supersonically-colliding HI flows](#user-content-link11)
**Authors:** Rin I. Yamada, Kazuki Tokuda, Yasuo Fukui, Daiki Adachi, Marta Sewi{\l}o, R\'emy Indebetouw, C. -H. Rosie Chen, Kisetsu Tsuge, Takeru Nishioka, Hidetoshi Sano, Mao Tamashiro, Naslim Neelamkodan, Tony Wong, Lynn R. Carlson, Joana M. Oliveira, Akiko Kawamura, Kengo Tachihara, Toshikazu Onishi

12. [The Evolution of the Spin Alignments of Dark Matter Halos in the Cosmic Web](#user-content-link12)
**Authors:** David Tobar, Rory Smith, Antonio Montero-Dorta, Katarina Kraljic, Pablo L\'opez

13. [Constraining Lyman-Werner Feedback from Velocity Acoustic Oscillations in the Cosmic Dawn 21 cm Signal](#user-content-link13)
**Authors:** Xi Du, Bin Yue, Furen Deng, Yidong Xu, Yan Gong, Ely D. Kovetz, Xuelei Chen

14. [MUSE-DARK-II: 3D morpho-kinematic modelling of lensed galaxies. Tully-Fisher relation of $z \sim 1$ star-forming galaxies](#user-content-link14)
**Authors:** Alexandre Jeanneau, Johan Richard, Nicolas F. Bouch\'e, Davor Krajnovi\'c, Bianca-Iulia Ciocan, Jonathan Freundlich, Beno\^it Epinat, Thierry Contini

15. [The Binary-Binary Hierarchical System XY Leo: A Laboratory for Stellar Activity and Concealed Companions](#user-content-link15)
**Authors:** D. Ko\c{c}ak, K. Yakut, C. A. Tout

16. [The Depletion of Collisionless Dark Matter Spikes](#user-content-link16)
**Authors:** Charlie Sharpe, Yonadav Barry Ginat, Thomas F. M. Spieksma, Bence Kocsis

17. [Robustness of cosmic void statistics: insights from SDSS DR7 and the ELUCID simulation](#user-content-link17)
**Authors:** Youcai Zhang, Xiaohu Yang, Hong Guo, Peng Wang, Feng Shi

18. [Protoplanetary Disk Evolution in a Low-Metallicity Environment: JWST's First Mid-Infrared Census of Low-Mass Stars](#user-content-link18)
**Authors:** Chikako Yasui, Natsuko Izumi, Masao Saito, Ryan M. Lau, Naoto Kobayashi, Michael E. Ressler

19. [Tidal deformations of general-relativistic multifluid compact stars](#user-content-link19)
**Authors:** Ethan Carlier, Nicolas Chamel

20. [From photometric surveys to HI intensity mapping: Improving constraints on magnification biases while testing gravity](#user-content-link20)
**Authors:** T. Sinde, J. Fonseca

21. [Seeding grain nucleation and dust growth: Ionisation, epoxidation and charge disproportionation effects](#user-content-link21)
**Authors:** A. P. Jones

22. [An inverted infall profile for the collapse of the massive star-forming IRDC SDC335.579-0.292](#user-content-link22)
...
23. [Misalignment from kicks: the impact of particle interactions on ultra-light dark matter](#user-content-link23)
**Authors:** Clare Burrage, Sergio Sevillano Mu\~noz

24. [Homogeneous stellar parameters for 717,807 TESS FGK stars using Gaia DR3](#user-content-link24)
**Authors:** Francesca Waines, Angharad Weeks, Vincent Van Eylen

25. [Formation and disruption of wide binaries in star clusters revealed by N-body simulations](#user-content-link25)
**Authors:** Abylay Bissekenov, Xiaoying Pang, Rainer Spurzem, Bekdaulet Shukirgaliyev, Mukhagali Kalambay, Peter Berczik

26. [Constraints on the host galaxy and AGN properties of three z > 6 JWST AGN from NOEMA observations](#user-content-link26)
**Authors:** Giovanni Mazzolari, Hannah \"Ubler, Rodrigo Herrera Camus, Ric Davies, Linda Tacconi, Dieter Lutz, Natascha F\"orster Schreiber, Francesco D'Eugenio, Minju Lee, Capucine Barfety, Elena Bertola, Andrew Bunker, Andreas Burkert, Jianhang Chen, Giovanni Cresci, Frank Eisenhauer, Juan Manuel Espejo Salcedo, Simon Flesch, Reinhard Genzel, Xihan Ji, Lilian Lee, Daizhong Liu, Cosimo Marconcini, Roberto Maiolino, Thorsten Naab, Amit Nestor Shachar, Meghana Pannikkote, Eleonora Parlanti, Stavros Pastras, Michele Perna, Claudia Pulsoni, Bruno Rodriguez del Pino, Eckhard Sturm, Taro Shimizu, Giulia Tozzi

27. [Anomaly detection in Fink. I. Discovery, follow-up, and classification of unusual sources](#user-content-link27)
**Authors:** M. V. Pruzhinskaya, M. V. Kornilov, A. V. Dodin, A. Baluta, T. A. Pshenichniy, A. M. Zubareva, E. E. O. Ishida, J. Peloton, I. Beschastnov, I. Ippolitov, A. A. Belinski, P. Golysheva, N. P. Ikonnikova, V. A. Kiryukhina, V. V. Krushinsky, A. M. Tatarnikov, S. G. Zheltoukhov, D. A. Buckley, A. Kniazev, S. V. Karpov, A. M\"oller, Y. Tampo

28. [STRADAViT: Towards a Foundational Model for Radio Astronomy through Self-Supervised Transfer](#user-content-link28)
**Authors:** Andrea DeMarco, Ian Fenech Conti, Hayley Camilleri, Ardiana Bushi, Simone Riggi

29. [Something Bright at the Edge of Everything: A Uniquely JWST-Dark Radio Source in COSMOS](#user-content-link29)
**Authors:** Mingyu Li

30. [Simulating the jittering-jets explosion mechanism: circum-jet rings account for observed core-collapse supernova remnant morphologies](#user-content-link30)
**Authors:** Muhammad Akashi (Technion, Israel), Noam Soker (Technion, Israel)

31. [Enabling fundamental understanding of Nature with novel binning methods for 2D histograms](#user-content-link31)
**Authors:** Igor Vaiman

32. [Boltzmann Equation Solver for Thermalization](#user-content-link32)
**Authors:** Jong-Hyun Yoon

33. [Multi-hierarchy simulation of Riemann problem for reconnection exhausts](#user-content-link33)
**Authors:** Keita Akutagawa, Shinsuke Imada, Munehito Shoda

34. [An innovative alternative to traditional funding streams for extragalactic astronomy](#user-content-link34)
**Authors:** Stephen M. Wilkins, Jack Turner, Connor Sant Fournier, Behnood Bandi, Aswin Vijayan

35. [Distribution function-based modelling of discrete kinematic datasets, in application to the Milky Way nuclear star cluster](#user-content-link35)
**Authors:** Eugene Vasiliev, Anja Feldmeier-Krause, Mattia C. Sormani

36. [The SPHEREx Instrument: Calibration, testing and performance measurements of the NIR 2 spectroscopic surveyor from the laboratory to in-orbit commissioning](#user-content-link36)
...
37. [Galactic Constellations in DESI DR1 and the Scales of Cosmological Homogeneity](#user-content-link37)
**Authors:** Claire Lamman

38. [Revisiting QCD-induced little inflation with chiral density wave state and its implications on pulsar timing array gravitational-wave signals](#user-content-link38)
**Authors:** Tae Hyun Jung, Seyong Kim, Jong-Wan Lee, Chang Sub Shin, Hee Beom Yang

39. [From Detection to Host Galaxy Identification: Precision Continuous Gravitational Wave Localization with a Few Anchor Pulsars](#user-content-link39)
**Authors:** Chao-Fan Wen, Yi-Qin Chen, Shi-Yi Zhao, Hao Ding, Xingjiang Zhu

40. [Synthesis imaging with a lunar orbit array: II. Impacts of instrument-induced phase errors](#user-content-link40)
**Authors:** Meng Zhou, Furen Deng, Yidong Xu, Li Zhou, Xuelei Chen

41. [Dark radiation from Kerr primordial black holes: the role of superradiance](#user-content-link41)
**Authors:** Nayun Jia, Chen Zhang, Xin Zhang

42. [Neutrinos as Dark Matter](#user-content-link42)
**Authors:** James M. Cline, Gonzalo Herrera, Jean-Samuel Roux

43. [Eccentricity constraints disfavor single-single capture in nuclear star clusters as the origin of all LIGO-Virgo-KAGRA binary black holes](#user-content-link43)
**Authors:** Nihar Gupte, M. Coleman Miller, Rhiannon Udall, Sophie Bini, Alessandra Buonanno, Jonathan Gair, Aldo Gamboa, Lorenzo Pompili, Antoni Ramos-Buades, Maximilian Dax, Stephen R. Green, Annalena Kofler, Jakob Macke, Bernhard Sch\"olkopf

44. [Quasi-linear theory of fast flavor instabilities in homogeneous environments](#user-content-link44)
**Authors:** Damiano F. G. Fiorillo, Georg G. Raffelt

45. [AGN Disks as Supernova Mufflers I: 3D Local Hydrodynamic Models](#user-content-link45)
**Authors:** Harrison E. Cook, Wladimir Lyra, Mordecai-Mark Mac Low, K. E. Saavik Ford, Barry McKernan

46. [Constraining the Galactic bar and spiral pattern speeds with the Hyades tidal stream](#user-content-link46)
**Authors:** Zi-yi Zhou, Long Wang, Tereza Jerabkova, Zhenghao He

47. [AGN Fueling and Radio Jet Evolution in the Galaxy Group NGC 5044 revealed by VLBA HI Absorption and Proper-Motion Radio Observations](#user-content-link47)
...
48. [Accurate Determination of Chemical Abundances near a Supermassive Black Hole](#user-content-link48)
**Authors:** The XRISM collaboration

49. [Fermion scattering in a Bose-Einstein condensate](#user-content-link49)
**Authors:** C\'esar E. Echevarr\'ia, Jos\'e F. Nieves, Francisco Orbe, Sarira Sahu

50. [Large Dust Grains and a Possible Dust Trap in the Polar Circumbinary Disc of HD 98800B](#user-content-link50)
**Authors:** \'Alvaro Ribas, Thomas Lack, Francesco Zagaria, Enrique Mac\'ias, Sean M. Andrews, Amelia Bayo, Cathie J. Clarke, Nicol\'as Cuello, Catherine C. Espaillat

51. [Conventional and Unitarity-Conserving Pecci-Quinn Inflation Models and ACT](#user-content-link51)
**Authors:** J. McDonald

52. [Rotation of the polarization plane in axion fields: application to neutron star polar cap regions](#user-content-link52)
**Authors:** Iver H. Brevik, Moshe M. Chaichian, Tiberiu Harko, Yuri N. Obukhov

53. [StarHash: unique, memorable, and deterministic names for astronomical objects](#user-content-link53)
**Authors:** T. L. Killestein

54. [Revisiting the Coprecessing Frame in the Presence of Orbital Eccentricity](#user-content-link54)
**Authors:** Lucy M. Thomas, Katerina Chatziioannou, Sam Johar, Taylor Knapp, Michael Boyle

55. [Declarative bespoke modelling: A new approach](#user-content-link55)
**Authors:** DBM Collaboration, David Komanek, Vaclav Pavl\'ik, Santiago Jimenez, Rhys Taylor

56. [JWST MIRI-MRS observations of the Red Rectangle: AIB class transformation in the outer nebula](#user-content-link56)
**Authors:** A. Ebenbichler, P. Moraga Baez, A. Candian, E. Peeters, J. Cami, P. J. Sarre, A. N. Witt, I. Argyriou, B. Vandenbussche, H. Van Winckel, L. B. F. M. Waters

57. [The WEAVE acquisition and guiding software: pattern recognition-based acquisition and multi-fibre guiding](#user-content-link57)
**Authors:** Emanuel Gafton (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Gavin B. Dalton (University of Oxford, Oxford, UK, RAL Space, Oxford, UK), Don Carlos Abrams (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Jure Skvar\v{c} (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Sergio Pic\'o (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Lilian Dom\'inguez-Palmero (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain, Instituto de Astrof\'isica de Canarias, La Laguna, Spain), Illa R. Losada (Department of Physics and Kavli Institute, Cambridge, USA), Sarah Hughes (Department of Physics and Kavli Institute, Cambridge, USA), Neil O'Mahony (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Frank J. Gribbin (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Andy Ridings (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), David L. Terrett (University of Oxford, Oxford, UK, RAL Space, Oxford, UK), Cecilia Fari\~na (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain, Instituto de Astrof\'isica de Canarias, La Laguna, Spain), Chris R. Benn (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Esperanza Carrasco (Instituto Nacional de Astrof\'isica, \'Optica y Electr\'onica, Tonantzintla, Mexico), P. Joel Concepci\'on Hern\'andez (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Kevin Dee (Isaac Newton Group of Telescopes, Santa Cruz de La Palma, Spain), Rafael Izazaga (Instituto Nacional de Astrof\'isica, \'Optica y Electr\'onica, Tonantzintla, Mexico), Shoko Jin (Kapteyn Astronomical Institute, Groningen, The Netherlands), Ian J. Lewis (University of Oxford, Oxford, UK), J. Alfonso L. Aguerri (Instituto de Astrof\'isica de Canarias, La Laguna, Spain, Departamento de Astrof\'isica, Universidad de La Laguna, La Laguna, Spain), Gonzalo P\'aez (Centro de Investigaciones en \'Optica, Le\'on, Mexico)

58. [Baryogenesis from Exploding Primordial Black Holes](#user-content-link58)
**Authors:** Alexandra P. Klipfel, Miguel Vanvlasselaer, Sokratis Trifinopoulos, David I. Kaiser

59. [Milky Way evolution on a human timescale](#user-content-link59)
**Authors:** Eugene, Neige

60. [Constraining The Neutrino-Nucleon Cross Section with the Ultrahigh-Energy KM3NeT Event](#user-content-link60)
**Authors:** Toni Bert\'olez-Mart\'inez, Dan Hooper

61. [Survey of compact sources for pulsars and exotic objects -- I. Overview and initial discoveries](#user-content-link61)
**Authors:** Yogesh Maan, Apurba Bera, Dharam Vir Lal, Yash Bhusare, Preeti Kharb, Banshi Lal, Pikky Atri

62. [Optical spectroscopy of high redshift BL Lac objects](#user-content-link62)
**Authors:** Renato Falomo, Aldo Treves, Simona Paiano, Riccardo Scarpa

63. [Gravitational waves from gaps of neutron stars](#user-content-link63)
**Authors:** Akira Dohi, Asuka Ito, Shota Kisaka

64. [AI Cosplaying as Astrophysicists: A Controlled Synthetic-Agent Study of AI-Assisted Astrophysical Research Workflows](#user-content-link64)
**Authors:** Chun Huang

65. [Spectroscopic study of the broad component of [O III]{\lambda}5007 profile in type 1 AGNs](#user-content-link65)
**Authors:** Qi Zheng, Yansong Ma, Xueguang Zhang, Qirong Yuan

66. [Nonthermal Velocity Dispersion in the Outer Disk of HL Tau](#user-content-link66)
**Authors:** Jinshi Sai, Shigehisa Takakuwa, Hsi-Wei Yen, Yusuke Tsukamoto, Yuya Fukuhara

67. [Spectroscopic orbits for three SB2s and one hierarchical triple using SALT data](#user-content-link67)
**Authors:** Mikhail Kovalev (YNAO, CAS), Alexey Kniazev (ZAAO), Oleg Malkov (INASAN, RAS)

68. [Mercury Craters Named after Tajik-Persian Poets: Planetary Nomenclature as a Form of Preserving Cultural Heritage](#user-content-link68)
**Authors:** Rizoi Bakhromzod

69. [Gaia DR3 IDs for TESS Input Catalog Targets](#user-content-link69)
**Authors:** Kevin K. Hardegree-Ullman, Melanie Swain, Jessie L. Christiansen, Emily A. Gilbert, Marcy Harbut, Aurora Y. Kesseli, Michael B. Lund, Meca Lynn, Julian C. van Eyken

70. [Warm Warped Throats](#user-content-link70)
**Authors:** Dibya Chakraborty, Rudnei O. Ramos

71. [Reducing the Virgo site infrastructure noise in preparation of the O4 observing run](#user-content-link71)
...
72. [A Lower Bound on the Number of Fundamental Constants](#user-content-link72)
**Authors:** William Luke Matthewson

73. [New Paradigms in Pasta: Introducing $\mathtt{GF \ pastamarkers}$ for Enhanced Inclusivity and Productivity](#user-content-link73)
**Authors:** Julian Falcone, Nabanita Das

74. [The Impact of Computing Data Centres Orbiting Earth](#user-content-link74)
**Authors:** Geoffrey W. Marcy

75. [Brightness, Colour, Polarisation: A Multi-Instrument Observation Campaign of the Gorizont-6 Satellite](#user-content-link75)
**Authors:** Robert J. S Airey, Paul Chote, Klaas Wiersema, Ioannis Apergis, James McCormac, James A. Blake, Benjamin F. Cooke, Isobel S. Lockley, Peter J. Wheatley, Daniel Bayliss, Samuel Gill, Christopher A. Watson, Stefano Covino, Frans Snik, Jon Marchant, Justyn Maund, Brooke Simmons, Iain A. Steele

76. [The Instrumented Baffle at the Input Mode Cleaner of Advanced Virgo Plus: Four years of Successful Operation as a Monitor of Stray Light](#user-content-link76)
**Authors:** Dounia Nanadoumgar-Lacroze, Monica Seglar-Arroyo, Mario Martinez, Llu\"isa-Maria Mir, Otger Ballester

77. [Lots of Shade on Satellite Constellations](#user-content-link77)
**Authors:** Michael B. Lund

78. [The Universe Favors Primes: A Study in the Primality of Cosmic Structures](#user-content-link78)
**Authors:** Nan Li, Shiyin Shen

79. [Your Outie Is a Wonderful Astronomer: Macrodata Refinement of the Astro-ph ArXiv Feed at Phermon Industries](#user-content-link79)
**Authors:** Yuan-Sen Ting

80. [A Therapy Session with Sgr A*](#user-content-link80)
**Authors:** Mayura Balakrishnan, Robert Frazier, Joseph Michail

81. [No hair but plenty of feathers: are birds black holes?](#user-content-link81)
**Authors:** Andrew Laeuger, Taylor Knapp

82. [Sugar Rush: Improving Observing Productivity via Night Dessert](#user-content-link82)
**Authors:** J. J. Charfman Jr, S. Hyman, N. T. S

83. [Schr\"odinger's Seed: Purr-fect Initialization for an Impurr-fect Universe](#user-content-link83)
**Authors:** Mi chen, Renhao Ye

84. [Do Papers with Titles Ending in a Question Mark Usually Have the Answer "No"?](#user-content-link84)
**Authors:** Daniel Stern, Brian Grefenstette

85. [What does the Universe sound like?](#user-content-link85)
**Authors:** Francesco Iacovelli

86. [The Hollyfeld Gambit in Astrophysics](#user-content-link86)
**Authors:** Benne Holwerda (personal title)

87. [On The Detection of Digiorno-like Objects in the Flavor Zone](#user-content-link87)
**Authors:** Logan A. Pearce, Sue D'Oh Nym

88. [Where to Search For Life: Evidence from narrative sources with established predictive efficacy](#user-content-link88)
**Authors:** Elizabeth R Stanway (Warwick)

89. [CROCS Data Release I: Constraints on the Hubble Constant](#user-content-link89)
**Authors:** Luke Weisenbach, Sophie L. Newman, Kieran Graham, Sai S. Dhavala, Benjamin Floyd, Neel Shah, Gemini 3 Flash, The CROCS Collaboration

---

## 1. [PAC in DESI. II. Galaxy-halo connection into the $10^{6}{\rm M}_{\odot}$ frontier](https://arxiv.org/abs/2603.29331) <a id="link1"></a>
...
**Comment:** Directly matches near-field cosmology and numerical galaxy simulations criteria. Focuses on dwarf galaxy formation, stellar mass-halo mass relation, and the impact of reionization on star formation and quenching in low-mass halos. Uses high-resolution N-body simulations and abundance matching, making it highly relevant.
...
## 2. [Pervasive Cavity-Ring Structure for Star Formation in Dwarf Irregular Galaxies](https://arxiv.org/abs/2603.29061) <a id="link2"></a>
...
**Comment:** This paper examines star formation in dwarf irregular galaxies, including the structure of HI cavities and star formation efficiency. The focus on star formation in dwarf galaxies and the sequential nature of star formation is highly relevant to resolved star formation histories and star formation quenching in dwarfs.
...
## 3. [Introducing PxP: A Population Synthesis Framework for Predicting YSO Properties](https://arxiv.org/abs/2603.29012) <a id="link3"></a>
...
**Comment:** This paper introduces a population synthesis framework for predicting YSO properties and directly determines recent star formation history in N44 and NGC 604. It matches the 'Resolved Star Formation Histories' criterion, as it derives star formation histories from observed YSO populations.
...
## 5. [Direct N-body simulations of rotating and extremely massive Population III star clusters](https://arxiv.org/abs/2603.29657) <a id="link5"></a>
...
**Comment:** Presents direct N-body simulations of extremely massive Population III star clusters, including updated stellar models and cluster dynamics. This fits the 'Numerical Galaxy Simulations' and 'Stellar Models' criteria, especially as it discusses new physics and high-resolution simulations.
...
## 6. [Enhanced Multiphase Circumgalactic Medium and Gas Cycling in Galaxy Mergers](https://arxiv.org/abs/2603.28862) <a id="link6"></a>
...
**Comment:** This paper investigates the impact of galaxy mergers on the circumgalactic medium (CGM) using cosmological hydrodynamic simulations. It directly matches the 'Circumgalactic Medium' and 'Numerical Galaxy Simulations' criteria, though the focus is on galaxies more massive than the LMC. Still, the CGM and gas cycling analysis are highly relevant.
...
## 7. [Ripples of Stellar Enrichment (RoSE) -- simulating element production and mixing in the Milky Way star-by-star](https://arxiv.org/abs/2603.29242) <a id="link7"></a>
...
**Comment:** Presents new high-resolution galaxy simulations (RoSE) with star-by-star feedback and nucleosynthesis, connecting simulation results to observed stellar abundances. This matches the 'Numerical Galaxy Simulations' criterion and also touches on stellar models and chemical enrichment.
...
## 8. [Data-driven discovery of dynamo cycle equations](https://arxiv.org/abs/2603.29079) <a id="link8"></a>
...
**Comment:** Presents new data-driven models for stellar dynamo cycles, matching the 'Stellar Models' criterion. The work introduces a novel method for modeling stellar magnetic activity directly from simulation data.
...
## 10. [The CAVITY project. The spatially resolved SFR of galaxies in voids](https://arxiv.org/abs/2603.28855) <a id="link10"></a>
...
**Comment:** This paper presents spatially resolved star formation rates for galaxies in voids, using integral field spectroscopy. It directly matches the 'Resolved Star Formation Histories' criterion, though the focus is on void galaxies rather than dwarfs or satellites.
...
## 11. [A multi-scale molecular and atomic gas view on the HII region N113 in the Large Magellanic Cloud:Evidence for high-mass star formation triggered by supersonically-colliding HI flows](https://arxiv.org/abs/2603.29899) <a id="link11"></a>
...
**Comment:** This paper focuses on high-mass star formation in the HII region N113 in the LMC, examining molecular and atomic gas structures and evidence for triggered star formation by colliding HI flows. The study is relevant to star formation processes in the LMC, which is a dwarf galaxy, and discusses ISM evolution and large-scale gas flows, touching on star formation driven outflows and circumgalactic medium criteria, though the main focus is on triggered star formation rather than outflows or CGM. The relevance is solid but not maximal.
...
## 12. [The Evolution of the Spin Alignments of Dark Matter Halos in the Cosmic Web](https://arxiv.org/abs/2603.29021) <a id="link12"></a>
...
**Comment:** This paper presents dark matter-only N-body simulations of halo spin alignments in the cosmic web, resolving low-mass halos and their evolution. It is relevant to numerical galaxy simulations, especially as it focuses on substructure and halo properties, which are important for near-field cosmology. However, it does not directly address satellite galaxies, resolved star formation histories, or quenching. The relevance is solid due to the simulation focus and connection to substructure.
...
## 13. [Constraining Lyman-Werner Feedback from Velocity Acoustic Oscillations in the Cosmic Dawn 21 cm Signal](https://arxiv.org/abs/2603.29947) <a id="link13"></a>
...
**Comment:** Focuses on constraining Lyman-Werner feedback during Cosmic Dawn using 21 cm signal simulations. While it discusses star formation regulation in minihalos, it does not directly address dwarf galaxies in the local universe or resolved star formation histories, but is borderline relevant for numerical galaxy simulations and star formation quenching.
...
## 14. [MUSE-DARK-II: 3D morpho-kinematic modelling of lensed galaxies. Tully-Fisher relation of $z \sim 1$ star-forming galaxies](https://arxiv.org/abs/2603.28856) <a id="link14"></a>
...
**Comment:** The paper studies the Tully-Fisher relation evolution in lensed star-forming galaxies at z~1, including galaxies with stellar masses down to 10^8.1 Msun. While this includes some low-mass galaxies, the focus is on morpho-kinematic modeling and TFR evolution, not specifically on satellite galaxies, resolved star formation histories, quenching, or CGM. The relevance is borderline, as the sample includes galaxies in the mass range of interest but does not directly address the core topics.
...
## 15. [The Binary-Binary Hierarchical System XY Leo: A Laboratory for Stellar Activity and Concealed Companions](https://arxiv.org/abs/2603.28934) <a id="link15"></a>
...
**Comment:** The paper models the evolution of a hierarchical multiple star system using the Cambridge STARS code, which is a stellar evolutionary track code. The focus is on testing stellar evolution models in a multiple-star context, which fits the 'Stellar Models' criterion, though not presenting new models or tracks.
...
## 16. [The Depletion of Collisionless Dark Matter Spikes](https://arxiv.org/abs/2603.28866) <a id="link16"></a>
...
**Comment:** Examines the depletion of collisionless dark matter spikes around black holes, using numerical simulations. While it involves dark matter density profiles, the focus is on black hole environments rather than galaxy-scale substructure or satellite galaxies, so relevance is borderline.
...
## 17. [Robustness of cosmic void statistics: insights from SDSS DR7 and the ELUCID simulation](https://arxiv.org/abs/2603.29706) <a id="link17"></a>
...
**Comment:** The paper analyzes cosmic void statistics using SDSS DR7 and the ELUCID simulation. While it involves galaxy simulations and large-scale structure, it does not focus on dwarf galaxies, satellite systems, or resolved star formation histories. It is borderline relevant due to its use of galaxy simulations.
...
## 18. [Protoplanetary Disk Evolution in a Low-Metallicity Environment: JWST's First Mid-Infrared Census of Low-Mass Stars](https://arxiv.org/abs/2603.29007) <a id="link18"></a>
...
**Comment:** Observational study of protoplanetary disk evolution in a low-metallicity environment using JWST. While it discusses star formation and disk retention, the focus is on young stellar clusters and protoplanetary disks, not resolved star formation histories of galaxies or dwarf galaxy evolution.
...
## 19. [Tidal deformations of general-relativistic multifluid compact stars](https://arxiv.org/abs/2603.29726) <a id="link19"></a>
...
**Comment:** Develops a multifluid model for tidal deformations of compact stars, with applications to superfluid neutron stars and dark matter admixed compact stars. This is relevant to stellar models, but specifically for compact objects (neutron stars), not for stellar evolutionary tracks or atmospheres relevant to galaxy evolution or resolved star formation histories.
...
## 20. [From photometric surveys to HI intensity mapping: Improving constraints on magnification biases while testing gravity](https://arxiv.org/abs/2603.28840) <a id="link20"></a>
...
**Comment:** This paper discusses constraints on magnification biases and tests of gravity using HI intensity mapping and photometric surveys. While it deals with large-scale structure and galaxy surveys, it does not focus on satellite galaxies, resolved star formation histories, or dwarf galaxy properties.
...
## 21. [Seeding grain nucleation and dust growth: Ionisation, epoxidation and charge disproportionation effects](https://arxiv.org/abs/2603.29840) <a id="link21"></a>
...
**Comment:** Studies dust seeding processes in various astrophysical environments, including molecular clouds and novae. While it touches on dust formation, it does not directly address galaxy-scale processes or any of the core topics.
...
## 22. [An inverted infall profile for the collapse of the massive star-forming IRDC SDC335.579-0.292](https://arxiv.org/abs/2603.30029) <a id="link22"></a>
...
**Comment:** Examines infall profiles in a massive star-forming cloud. While it discusses star formation, it focuses on massive star formation in IRDCs, not dwarf galaxies or resolved star formation histories.
...
## 23. [Misalignment from kicks: the impact of particle interactions on ultra-light dark matter](https://arxiv.org/abs/2603.28881) <a id="link23"></a>
...
**Comment:** Focuses on ultra-light dark matter and its interactions, affecting the abundance of dark matter. While dark matter is a relevant topic, the paper does not discuss galaxy-scale substructure, core-cusp, or satellite galaxies, so the connection is weak.
...
## 24. [Homogeneous stellar parameters for 717,807 TESS FGK stars using Gaia DR3](https://arxiv.org/abs/2603.29817) <a id="link24"></a>
...
**Comment:** This paper presents a large homogeneous catalogue of stellar parameters for TESS FGK stars using Gaia DR3. While it involves stellar models and evolutionary tracks, the focus is on exoplanet host characterization and not on new stellar models or bolometric corrections. It does not directly address resolved star formation histories, near-field cosmology, or galaxy simulations.
...
## 25. [Formation and disruption of wide binaries in star clusters revealed by N-body simulations](https://arxiv.org/abs/2603.28878) <a id="link25"></a>
...
**Comment:** The paper uses N-body simulations to study the formation and disruption of wide binaries in star clusters. While it involves numerical simulations, the focus is on star clusters and binary stars, not galaxies or the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 26. [Constraints on the host galaxy and AGN properties of three z > 6 JWST AGN from NOEMA observations](https://arxiv.org/abs/2603.29652) <a id="link26"></a>

**ArXiv ID:** 2603.29652

**Authors:** Giovanni Mazzolari, Hannah \"Ubler, Rodrigo Herrera Camus, Ric Davies, Linda Tacconi, Dieter Lutz, Natascha F\"orster Schreiber, Francesco D'Eugenio, Minju Lee, Capucine Barfety, Elena Bertola, Andrew Bunker, Andreas Burkert, Jianhang Chen, Giovanni Cresci, Frank Eisenhauer, Juan Manuel Espejo Salcedo, Simon Flesch, Reinhard Genzel, Xihan Ji, Lilian Lee, Daizhong Liu, Cosimo Marconcini, Roberto Maiolino, Thorsten Naab, Amit Nestor Shachar, Meghana Pannikkote, Eleonora Parlanti, Stavros Pastras, Michele Perna, Claudia Pulsoni, Bruno Rodriguez del Pino, Eckhard Sturm, Taro Shimizu, Giulia Tozzi

**Abstract:** We targeted with deep NOEMA observations the [CII]158$\mu$m emission of three JWST-discovered AGN at z>6. Two of them have the typical features of Little Red Dots (LRDs), while the third one is a blue, extended, Type I AGN. We do not significantly detect [CII] emission or dust continuum in any of the targets, even after stacking. The resulting [CII] luminosity upper limits, $\log (L_{[CII]}/L_{\odot})<7.77-8.1$, lie $\sim2\sigma$ below the values expected from the [CII]-SFR relation, and we explore different scenarios to explain the lack of [CII]. We obtained upper limits on the gas masses of $\log (M_{gas}/M_{\odot})<9.26-9.59$ corresponding to $\log( M_{dust}/M_{\odot})<5.68-6.55$ assuming a metallicity dependent dust to gas ratio. Using the continuum non-detections (rms $\sim 16-25 ~\mu Jy$) together with JWST/MIRI constraints, we performed a revised SED-fitting decomposition, resulting in stellar masses up to $\sim 2$ dex lower than previously reported, and implying $0.03\lesssim M_{BH}/M_{*}\lesssim0.7$. For the two LRDs, the SED is well reproduced by stellar emission in the rest-frame UV, while the rising rest-frame optical slope, flattening toward the near-infrared, is consistent with emission from a Type I AGN partially obscured along the polar direction with $E(B-V)_{\rm polar}\simeq 1$, in agreement with attenuation derived from the broad lines Balmer decrement. This decomposition demonstrates that a relatively standard AGN configuration can reproduce the SEDs of the two LRDs, without invoking more exotic scenarios. Finally, we investigate the positions of the three sources in the $IRX-\beta_{UV}$ plane, finding that they lie in a parameter space where galaxies are typically characterized by patchy dust distributions. Our analysis highlights the importance of millimeter constraints to characterize the different physical properties of high-z AGN.

**Comment:** Studies high-redshift AGN and their host galaxies using NOEMA and JWST. While it discusses stellar masses and gas content, the focus is on AGN and massive galaxies at z>6, not dwarf galaxies or near-field cosmology. Some relevance for galaxy evolution, but not directly matching the core topics.
...
## 27. [Anomaly detection in Fink. I. Discovery, follow-up, and classification of unusual sources](https://arxiv.org/abs/2603.29511) <a id="link27"></a>
...
**Comment:** Describes anomaly detection in time-domain surveys, leading to discovery of rare phenomena including supernovae, AM CVn systems, UX Ori-type stars, and dwarf novae. While it mentions discovery of new dwarf novae, these are stellar systems, not dwarf galaxies. The paper is mostly about survey methodology and transient classification.
...
## 28. [STRADAViT: Towards a Foundational Model for Radio Astronomy through Self-Supervised Transfer](https://arxiv.org/abs/2603.29660) <a id="link28"></a>
...
**Comment:** Presents a self-supervised Vision Transformer model for radio astronomy image analysis, improving morphology classification. While this is a methodological advance for radio galaxy surveys, it does not directly address any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 29. [Something Bright at the Edge of Everything: A Uniquely JWST-Dark Radio Source in COSMOS](https://arxiv.org/abs/2603.28863) <a id="link29"></a>
...
**Comment:** Describes a radio source undetected in JWST bands, possibly at cosmic dawn. While interesting, it does not directly address any of the core topics such as dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 30. [Simulating the jittering-jets explosion mechanism: circum-jet rings account for observed core-collapse supernova remnant morphologies](https://arxiv.org/abs/2603.29527) <a id="link30"></a>
...
**Comment:** This paper presents 3D hydrodynamical simulations of core-collapse supernovae, focusing on the morphology of supernova remnants. While it involves numerical simulations, the focus is on supernovae and not on galaxy simulations or the core topics such as dwarf galaxies, star formation histories, or outflows.
...
## 31. [Enabling fundamental understanding of Nature with novel binning methods for 2D histograms](https://arxiv.org/abs/2603.30006) <a id="link31"></a>
...
**Comment:** Presents a new method for 2D histogram binning and visualization, which is a data analysis technique. While potentially useful for astrophysics, it does not directly address any of the core topics.
...
## 32. [Boltzmann Equation Solver for Thermalization](https://arxiv.org/abs/2603.28848) <a id="link32"></a>
...
**Comment:** Presents a Boltzmann equation solver for thermalization processes, with applications to particle physics and cosmology. No direct connection to galaxy simulations, star formation, or near-field cosmology.
...
## 33. [Multi-hierarchy simulation of Riemann problem for reconnection exhausts](https://arxiv.org/abs/2603.29638) <a id="link33"></a>
...
**Comment:** Presents multi-hierarchy simulations of magnetic reconnection, relevant for plasma physics and solar flares. Does not address galaxy simulations, star formation, or near-field cosmology.
...
## 34. [An innovative alternative to traditional funding streams for extragalactic astronomy](https://arxiv.org/abs/2603.29340) <a id="link34"></a>
...
**Comment:** This paper proposes a cryptocurrency linked to galaxy catalogues as an alternative funding stream. While it references galaxies, it is not scientific research on galaxy properties or evolution and does not match any core criteria.
...
## 35. [Distribution function-based modelling of discrete kinematic datasets, in application to the Milky Way nuclear star cluster](https://arxiv.org/abs/2603.29502) <a id="link35"></a>
...
**Comment:** This paper presents dynamical modeling of the Milky Way nuclear star cluster using kinematic data. It focuses on the Galactic center and bar, which are explicitly listed as irrelevant in the criteria.
...
## 36. [The SPHEREx Instrument: Calibration, testing and performance measurements of the NIR 2 spectroscopic surveyor from the laboratory to in-orbit commissioning](https://arxiv.org/abs/2603.29835) <a id="link36"></a>
...
**Comment:** This paper describes the calibration and performance of the SPHEREx NIR space telescope. While SPHEREx will provide data relevant to galaxy evolution and large-scale structure, this paper is focused on instrument performance and not on any of the core science topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 37. [Galactic Constellations in DESI DR1 and the Scales of Cosmological Homogeneity](https://arxiv.org/abs/2603.29912) <a id="link37"></a>
...
**Comment:** Analyzes 'galactic constellations' in DESI data as a probe of cosmological homogeneity. While it uses galaxy survey data, it does not address satellite galaxies, star formation histories, or galaxy simulations.
...
## 38. [Revisiting QCD-induced little inflation with chiral density wave state and its implications on pulsar timing array gravitational-wave signals](https://arxiv.org/abs/2603.29772) <a id="link38"></a>
...
**Comment:** This paper discusses QCD phase transitions and their cosmological implications, specifically gravitational wave signals relevant for pulsar timing arrays. However, it does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 39. [From Detection to Host Galaxy Identification: Precision Continuous Gravitational Wave Localization with a Few Anchor Pulsars](https://arxiv.org/abs/2603.28897) <a id="link39"></a>
...
**Comment:** Focuses on gravitational wave localization using pulsar timing arrays, with implications for multi-messenger astronomy. No direct connection to galaxy simulations, star formation, or near-field cosmology.
...
## 40. [Synthesis imaging with a lunar orbit array: II. Impacts of instrument-induced phase errors](https://arxiv.org/abs/2603.29251) <a id="link40"></a>
...
**Comment:** This paper discusses phase errors in lunar orbit interferometer arrays for ultra-long wavelength sky imaging. It is focused on instrumentation and does not match any of the core astrophysical criteria.
...
## 41. [Dark radiation from Kerr primordial black holes: the role of superradiance](https://arxiv.org/abs/2603.29790) <a id="link41"></a>
...
**Comment:** This paper discusses dark radiation from primordial black holes and the role of superradiance. It is focused on early universe cosmology and particle physics, not near-field cosmology or galaxy evolution.
...
## 42. [Neutrinos as Dark Matter](https://arxiv.org/abs/2603.28859) <a id="link42"></a>
...
**Comment:** The paper discusses a scenario where cold Standard Model neutrinos could behave as dark matter, involving late-time decays of a light scalar field. While it is cosmology-related, it does not address near-field cosmology, galaxy simulations, or any of the core topics.
...
## 44. [Quasi-linear theory of fast flavor instabilities in homogeneous environments](https://arxiv.org/abs/2603.28854) <a id="link44"></a>
...
**Comment:** Presents a quasi-linear theory for fast flavor instabilities in dense neutrino plasmas, relevant to neutrino physics and supernova environments, but not directly to any of the core topics (near-field cosmology, galaxy simulations, star formation histories, etc.).
...
## 45. [AGN Disks as Supernova Mufflers I: 3D Local Hydrodynamic Models](https://arxiv.org/abs/2603.29049) <a id="link45"></a>
...
**Comment:** Focuses on supernova shocks in AGN accretion disks, which are not related to star-formation-driven outflows or dwarf galaxy environments. The topic is outside the core criteria.
...
## 46. [Constraining the Galactic bar and spiral pattern speeds with the Hyades tidal stream](https://arxiv.org/abs/2603.29360) <a id="link46"></a>
...
**Comment:** Uses N-body simulations to constrain the Galactic bar and spiral pattern speeds using the Hyades tidal stream. The focus is on the Milky Way bar and spiral arms, which is specifically listed as irrelevant in the criteria.
...
## 47. [AGN Fueling and Radio Jet Evolution in the Galaxy Group NGC 5044 revealed by VLBA HI Absorption and Proper-Motion Radio Observations](https://arxiv.org/abs/2603.28864) <a id="link47"></a>
...
**Comment:** This paper focuses on AGN fueling and radio jet evolution in a galaxy group, specifically NGC 5044. The main focus is on AGN feedback, jet dynamics, and cold gas feeding in a group environment. It does not address dwarf galaxies, satellite luminosity functions, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM of dwarfs. The relevance to the core topics is low.
...
## 48. [Accurate Determination of Chemical Abundances near a Supermassive Black Hole](https://arxiv.org/abs/2603.29748) <a id="link48"></a>
...
**Comment:** Focuses on chemical abundances near a supermassive black hole in a galactic nucleus, which is not relevant to near-field cosmology, dwarf galaxies, or any of the specified criteria.
...
## 49. [Fermion scattering in a Bose-Einstein condensate](https://arxiv.org/abs/2603.29000) <a id="link49"></a>
...
**Comment:** The paper studies fermion scattering in a Bose-Einstein condensate, with applications to cosmic-ray electron cooling and dark matter-electron scattering. While it mentions cosmic-ray and dark matter contexts, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 50. [Large Dust Grains and a Possible Dust Trap in the Polar Circumbinary Disc of HD 98800B](https://arxiv.org/abs/2603.28867) <a id="link50"></a>
...
**Comment:** Focuses on dust grain properties and possible dust traps in a circumbinary disk around HD 98800B, a young stellar system. This is related to planet formation and disk physics, not to any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 52. [Rotation of the polarization plane in axion fields: application to neutron star polar cap regions](https://arxiv.org/abs/2603.28826) <a id="link52"></a>
...
**Comment:** This paper focuses on axion fields and their effects in neutron star polar cap regions, specifically polarization rotation. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 53. [StarHash: unique, memorable, and deterministic names for astronomical objects](https://arxiv.org/abs/2603.29584) <a id="link53"></a>
...
**Comment:** This paper proposes a new naming scheme for astronomical objects. It is not relevant to any of the core astrophysics topics.
...
## 54. [Revisiting the Coprecessing Frame in the Presence of Orbital Eccentricity](https://arxiv.org/abs/2603.29307) <a id="link54"></a>
...
**Comment:** Focuses on gravitational waveform modeling for compact binaries, including spin precession and orbital eccentricity. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 55. [Declarative bespoke modelling: A new approach](https://arxiv.org/abs/2603.28847) <a id="link55"></a>
...
**Comment:** This paper proposes a new modelling paradigm, but it is not specific to galaxies or any of the core astrophysical criteria. No direct relevance to near-field cosmology, star formation histories, or galaxy simulations.
...
## 56. [JWST MIRI-MRS observations of the Red Rectangle: AIB class transformation in the outer nebula](https://arxiv.org/abs/2603.28923) <a id="link56"></a>
...
**Comment:** JWST observations of the Red Rectangle nebula focus on dust and molecular content in a post-AGB environment, not related to galaxies, star formation histories, or near-field cosmology.
...
## 57. [The WEAVE acquisition and guiding software: pattern recognition-based acquisition and multi-fibre guiding](https://arxiv.org/abs/2603.30044) <a id="link57"></a>
...
**Comment:** This paper describes acquisition and guiding software for the WEAVE instrument. It is a technical instrumentation paper and does not address any of the core astrophysics topics.
...
## 58. [Baryogenesis from Exploding Primordial Black Holes](https://arxiv.org/abs/2603.29024) <a id="link58"></a>
...
**Comment:** This paper discusses baryogenesis from exploding primordial black holes, focusing on early universe physics and not on galaxy evolution, star formation, or near-field cosmology.
...
## 59. [Milky Way evolution on a human timescale](https://arxiv.org/abs/2603.29503) <a id="link59"></a>
...
**Comment:** Studies the evolution of Milky Way properties such as the central black hole, bar, and Galactic center. These are specifically listed as irrelevant in the criteria.
...
## 60. [Constraining The Neutrino-Nucleon Cross Section with the Ultrahigh-Energy KM3NeT Event](https://arxiv.org/abs/2603.28941) <a id="link60"></a>
...
**Comment:** This paper focuses on constraining the neutrino-nucleon cross section using a high-energy neutrino event. It is particle physics and does not match any of the core topics (near-field cosmology, galaxy simulations, star formation histories, etc.).
...
## 61. [Survey of compact sources for pulsars and exotic objects -- I. Overview and initial discoveries](https://arxiv.org/abs/2603.28885) <a id="link61"></a>
...
**Comment:** This paper is a survey for pulsars and exotic objects, focusing on radio sources and their classification. It does not match any of the core topics (galaxy evolution, star formation, CGM, etc.).
...
## 62. [Optical spectroscopy of high redshift BL Lac objects](https://arxiv.org/abs/2603.29327) <a id="link62"></a>

**ArXiv ID:** 2603.29327

**Authors:** Renato Falomo, Aldo Treves, Simona Paiano, Riccardo Scarpa

**Abstract:** BL Lac objects (BLL) are defined by the presence of very weak (typically $$ 0.6) BLL, many of which are commonly cited in the literature despite appearing questionable. We present new spectra for 52 objects obtained with the 10.4 m GTC. For 16 of them we propose a new redshift, or provide a spectroscopic lower limit, while for 14 sources we confirm previously published values. In 22 cases the spectra remain featureless, even with high S/N observations. These objects are likely to lie at 0.3 $<$ z $$ 0.6 that meet our selection criteria.

**Comment:** This paper presents optical spectroscopy of high redshift BL Lac objects, focusing on AGN and not on galaxy evolution, star formation, or CGM.
...
## 63. [Gravitational waves from gaps of neutron stars](https://arxiv.org/abs/2603.29514) <a id="link63"></a>
...
**Comment:** This paper estimates gravitational wave strain from neutron star magnetospheres, focusing on the physics of pulsar gaps. It is unrelated to the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 64. [AI Cosplaying as Astrophysicists: A Controlled Synthetic-Agent Study of AI-Assisted Astrophysical Research Workflows](https://arxiv.org/abs/2603.29039) <a id="link64"></a>
...
**Comment:** This paper is about AI-assisted workflows in astrophysics, not about any of the core topics (near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM). No relevant criteria matched.
...
## 65. [Spectroscopic study of the broad component of [O III]{\lambda}5007 profile in type 1 AGNs](https://arxiv.org/abs/2603.29305) <a id="link65"></a>
...
**Comment:** The paper studies outflows in AGNs via [O III] emission, but the outflows are AGN-driven, not star-formation-driven. The focus is on black hole mass and AGN properties, which are not relevant to the core topics.
...
## 66. [Nonthermal Velocity Dispersion in the Outer Disk of HL Tau](https://arxiv.org/abs/2603.29147) <a id="link66"></a>
...
**Comment:** This paper measures turbulence in a protoplanetary disk (HL Tau), focusing on planet formation and disk structure. It does not address galaxy-scale processes or any of the core topics.
...
## 67. [Spectroscopic orbits for three SB2s and one hierarchical triple using SALT data](https://arxiv.org/abs/2603.29274) <a id="link67"></a>
...
**Comment:** Presents spectroscopic orbits for binary and triple star systems, which does not match any of the specified criteria related to galaxies, star formation, or stellar models.
...
## 68. [Mercury Craters Named after Tajik-Persian Poets: Planetary Nomenclature as a Form of Preserving Cultural Heritage](https://arxiv.org/abs/2603.28837) <a id="link68"></a>
...
**Comment:** Discusses planetary nomenclature and cultural heritage, focusing on Mercury craters. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 69. [Gaia DR3 IDs for TESS Input Catalog Targets](https://arxiv.org/abs/2603.28850) <a id="link69"></a>
...
**Comment:** This paper describes a cross-match between the TESS Input Catalog and Gaia DR3 for exoplanet research. It does not address any of the core topics (galaxy evolution, star formation, CGM, etc.).
...
## 70. [Warm Warped Throats](https://arxiv.org/abs/2603.29781) <a id="link70"></a>
...
**Comment:** Explores warm inflation in brane models, focusing on early universe cosmology and inflationary physics. Not related to the core topics of galaxy evolution, star formation histories, or near-field cosmology.
...
## 71. [Reducing the Virgo site infrastructure noise in preparation of the O4 observing run](https://arxiv.org/abs/2603.28960) <a id="link71"></a>
...
**Comment:** Paper discusses noise mitigation in gravitational wave observatories, which is unrelated to any of the core galaxy or star formation criteria.
...
## 72. [A Lower Bound on the Number of Fundamental Constants](https://arxiv.org/abs/2603.29300) <a id="link72"></a>
...
**Comment:** This paper discusses the number of fundamental constants required for a mathematical description of the universe. It does not match any of the specified criteria related to near-field cosmology, galaxy simulations, star formation histories, or stellar models.
...
## 73. [New Paradigms in Pasta: Introducing $\mathtt{GF \ pastamarkers}$ for Enhanced Inclusivity and Productivity](https://arxiv.org/abs/2603.28957) <a id="link73"></a>
...
**Comment:** Describes a data visualization package using pasta markers. No connection to astrophysical or galaxy science topics.
...
## 74. [The Impact of Computing Data Centres Orbiting Earth](https://arxiv.org/abs/2603.28829) <a id="link74"></a>
...
**Comment:** This paper discusses the impact of orbiting data centers on the night sky and astronomy, but does not address any of the core topics (galaxy evolution, star formation, CGM, etc.).
...
## 75. [Brightness, Colour, Polarisation: A Multi-Instrument Observation Campaign of the Gorizont-6 Satellite](https://arxiv.org/abs/2603.29534) <a id="link75"></a>
...
**Comment:** This paper is a multi-instrument observational campaign of a defunct geosynchronous satellite, focusing on photometry and polarimetry for rotation-state determination. It is unrelated to any of the core astrophysical topics.
...
## 76. [The Instrumented Baffle at the Input Mode Cleaner of Advanced Virgo Plus: Four years of Successful Operation as a Monitor of Stray Light](https://arxiv.org/abs/2603.29873) <a id="link76"></a>
...
**Comment:** This paper discusses the operation of an instrumented baffle in the Advanced Virgo Plus interferometer for monitoring stray light. It is unrelated to any of the core astrophysical topics.
...
## 77. [Lots of Shade on Satellite Constellations](https://arxiv.org/abs/2603.29212) <a id="link77"></a>
...
**Comment:** This is a speculative paper about satellite constellations and their impact on solar flux and climate change, not related to any of the core astrophysics topics.
...
## 78. [The Universe Favors Primes: A Study in the Primality of Cosmic Structures](https://arxiv.org/abs/2603.29321) <a id="link78"></a>
...
**Comment:** This is an April Fools' paper about the universe favoring prime numbers in galaxy groups. It is not relevant to any of the core topics.
...
## 79. [Your Outie Is a Wonderful Astronomer: Macrodata Refinement of the Astro-ph ArXiv Feed at Phermon Industries](https://arxiv.org/abs/2603.29771) <a id="link79"></a>
...
**Comment:** This is an April Fools' paper about macrodata refinement of the arXiv feed. It is not relevant to any of the core topics.
...
## 80. [A Therapy Session with Sgr A*](https://arxiv.org/abs/2603.29963) <a id="link80"></a>
...
**Comment:** A humorous, non-scientific paper interviewing Sgr A*. No connection to any of the core topics.
...
## 81. [No hair but plenty of feathers: are birds black holes?](https://arxiv.org/abs/2603.29064) <a id="link81"></a>
...
**Comment:** A humorous paper comparing bird chirps to gravitational waveforms. No connection to any of the core topics.
...
## 82. [Sugar Rush: Improving Observing Productivity via Night Dessert](https://arxiv.org/abs/2603.28915) <a id="link82"></a>
...
**Comment:** A humorous white paper about boosting observing productivity with sugar. No scientific relevance to any of the core topics.
...
## 83. [Schr\"odinger's Seed: Purr-fect Initialization for an Impurr-fect Universe](https://arxiv.org/abs/2603.29115) <a id="link83"></a>
...
**Comment:** A humorous paper about random seed selection in deep learning using cats. No relevance to any astrophysical or galaxy-related criteria.
...
## 84. [Do Papers with Titles Ending in a Question Mark Usually Have the Answer "No"?](https://arxiv.org/abs/2603.29936) <a id="link84"></a>
...
**Comment:** This is a humorous meta-analysis of paper titles and does not relate to any of the core astrophysical topics.
...
## 85. [What does the Universe sound like?](https://arxiv.org/abs/2603.29996) <a id="link85"></a>
...
**Comment:** This paper is about converting gravitational wave signals into sound; it is unrelated to any of the core topics (near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 86. [The Hollyfeld Gambit in Astrophysics](https://arxiv.org/abs/2603.29964) <a id="link86"></a>
...
**Comment:** This paper discusses the 'Hollyfeld Gambit' and compares lottery returns to astrophysical grant funding; it is not relevant to any of the core astrophysics topics.
...
## 87. [On The Detection of Digiorno-like Objects in the Flavor Zone](https://arxiv.org/abs/2603.28977) <a id="link87"></a>
...
**Comment:** This is a humorous SETI-themed paper about detecting 'Digiorno-like Objects' in the 'Flavor Zone', with no relevance to any core astrophysical criteria.
...
## 88. [Where to Search For Life: Evidence from narrative sources with established predictive efficacy](https://arxiv.org/abs/2603.28883) <a id="link88"></a>
...
**Comment:** This paper is a humorous or speculative analysis using science fiction magazine mentions of constellations to suggest where to search for life. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. Completely unrelated to the core topics.
