...
1. [Tailored mass estimators for Milky Way dwarf Spheroidals](#user-content-link1)
**Authors:** Sofia L. Splawska, Rapha\"el Errani, Jorge Pe\~narrubia, Matthew G. Walker

2. [The faint end of the UV luminosity function at $0.4 < z < 0.7$ from the Hubble Frontier Fields](#user-content-link2)
**Authors:** Lei Sun, Xiao-Lei Meng, Xin Wang, Hu Zhan, Anahita Alavi, Nicha Leethochawalit, Brian Siana, Hang Zhou, Shengzhe Wang, Shamuhawu Hailanhazi

3. [First statistical constraints on galactic scale outflows properties traced by their extended Mg II emission with MUSE](#user-content-link3)
**Authors:** Ismael Pessa, Lutz Wisotzki, Tanya Urrutia, Nicolas F. Bouch\'e, Floriane Leclercq, Ramona Augustin, Yucheng Guo, Daria Kozlova, Haruka Kusakabe, John Pharo

4. [The Curious Case of Centaurus A II: On the Subject of the Quenched satellites](#user-content-link4)
**Authors:** Sachi Weerasooriya, Mia Sauda Bovill, Matthew A. Taylor, Andrew J. Benson, Cameron Leahy, Alexis Vazquez, Niusha Ahvazi, Pamela M. Marcum, Alejandro S. Borlaff

5. [The connection between surface brightness and satellite systems for central galaxies through Illustris TNG](#user-content-link5)
**Authors:** Silvio Rodriguez, Yamila Yaryura, Jose A. Benavides, Diego Garcia Lambas, Susana Pedrosa, Laura D. Baravalle, Laura Ceccarelli, Heliana E. Luparello, Lucas Bignone, Gaspar Galaz

6. [BlastBerries: How Supernovae Affect Lyman Continuum Escape Fractions and Ionizing Photon Production in Local Analogs of High-Redshift Galaxies](#user-content-link6)
**Authors:** Miranda Y. Kong, David O. Jones, Nicole E. Drakos, Sangeeta Malhotra, Kartheik Iyer, Brian C. Lemaux, Rohan P. Naidu, Thomas de Boer, Ken C. Chambers, John Fairlamb, Willem B. Hoogendam, Mark E. Huber, Chien-Cheng Lin, Thomas Bernard Lowe, Eugene A. Magnier, Paloma M\'inguez, Gregory S. H. Paek, Angie Schultz, Richard J. Wainscoat

7. [A Multiwavelength Evaluation of AGN in the Post-Starburst Phase](#user-content-link7)
**Authors:** Yuanze Luo, Kate Rowlands, Katherine Alatalo, Lauranne Lanz, Timothy Heckman, Elizaveta Sazonova, Pallavi Patil, Omar Almaini, Vincenzo R. D'Onofrio, K. Decker French, Justin Otter, Andreea O. Petric, Namrata Roy, Maya Skarbinski, Justin S. Spilker, Margaret E. Verrico, Vivienne Wild

8. [Surface brightness-colour relations of Milky Way and Magellanic Clouds classical Cepheids based on Gaia magnitudes](#user-content-link8)
**Authors:** M. C. Bailleul, N. Nardetto, V. Hocd\'e, P. Kervella, W. Gieren, J. Storm, G. Pietrzy\'nski, A. Gallenne, D. Graczyk, G. Bras, O. Creevey, A. Recio Blanco, P. de Laverny, P. A. Palicio, W. Kiviaho

9. [The "bubbly" interstellar medium as origin for the inhomogeneous internal metallicity distributions in large disk galaxies](#user-content-link9)
**Authors:** Benjamin Metha, Michele Trenti, Colin Norman

10. [Tango of Titans: Centaurus A and M83 as a Local Group Analog](#user-content-link10)
**Authors:** David Benisty, Noam Libeskind, Dmitry Makarov

11. [Population synthesis predictions of the Galactic compact binary gravitational wave foreground detectable by LISA](#user-content-link11)
**Authors:** Jake McMillan (School of Mathematics, Statistics, and Physics, Newcastle University, Centre for Advanced Instrumentation, Department of Physics, Durham University), Adam Ingram (School of Mathematics, Statistics, and Physics, Newcastle University), Cordelia Dashwood Brown (School of Physics and Astronomy, University of Southampton), Andrei Igoshev (School of Mathematics, Statistics, and Physics, Newcastle University), Matthew Middleton (School of Physics and Astronomy, University of Southampton), Grzegorz Wiktorowicz (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences), Simone Scaringi (Centre for Extragalactic Astronomy, Department of Physics, Durham University, INAF - Osservatorio Astronomico di Capodimonte)

12. [Measurement prospects for the pair-instability mass cutoff with gravitational waves](#user-content-link12)
**Authors:** Matthew Mould, Jack Heinzel, Sofia Alvarez-Lopez, Cailin Plunkett, Noah E. Wolfe, Salvatore Vitale

13. [Dynamic modeling of coronal abundances during flares on M-dwarf stars](#user-content-link13)
**Authors:** David H. Brooks, Jeffrey W. Reep, Andy S. H. To, Luke Fushimi Benavitz, Lucas A. Tarr

14. [Characterising Ly$\alpha$ damping wings at the onset of reionisation: Evidence for highly efficient star formation driven by dense, neutral gas in UV-bright galaxies at $z>9$](#user-content-link14)
**Authors:** Clara L. Pollock, Kasper E. Heintz, Joris Witstok, Rashmi Gottumukkala, Gabriel Brammer, Sownak Bose, Alex J. Cameron, Pratika Dayal, Pieter van Dokkum, Johan Fynbo, Viola Gelli, Matthew J. Hayes, Akio K. Inoue, Claudia del P. Lagos, Peter Laursen, Romain A. Meyer, Rohan Naidu, Pascal Oesch, Lucie E. Rowland, Nial R. Tanvir, Sandro Tacchella, Chamilla Terp, Francesco Valentino, Fabian Walter, John Weaver, Callum Witten

15. [Stone Skipping Black Holes in Ultralight Dark Matter Solitons](#user-content-link15)
**Authors:** Alan Zhang, Yourong Wang, J. Luna Zagorac, Richard Easther

16. [Evolution of submillimeter galaxies across cosmic-web environments](#user-content-link16)
...
17. [Simulation-Based Cosmological Mass Calibration of XXL Galaxy Clusters using HSC Weak Lensing](#user-content-link17)
...
18. [A Portrait of the Cosmic Reionisation History in the Context of the Early Dark Energy Model](#user-content-link18)
**Authors:** Weiyang Liu, Xin Wang, Hu Zhan, Karl Glazebrook, Mengtao Tang, Michele Trenti

19. [Evidence for Shallow Nebular Attenuation Curves and Patchy Dust Geometry at z~2 with Pa-beta/H-alpha Measurements from JWST-MegaScience Medium Band Photometry](#user-content-link19)
...
20. [The Wandering Supermassive Black Hole Powering the off-nuclear TDE AT2024tvd](#user-content-link20)
...
21. [Filling The Pockets: The Spherical Nature of 3D Deflagration in Thermonuclear Supernovae](#user-content-link21)
...
22. [SPT-3G D1: Compton-$y$ maps using data from the SPT-3G and Planck surveys](#user-content-link22)
**Authors:** A. S. Maniyar, F. Bianchini, W. L. K. Wu, S. Raghunathan, A. J. Anderson, B. Ansarinejad, M. Archipley, L. Balkenhol, D. R. Barron, P. S. Barry, K. Benabed, A. N. Bender, B. A. Benson, L. E. Bleem, S. Bocquet, F. R. Bouchet, L. Bryant, E. Camphuis, M. G. Campitiello, J. E. Carlstrom, J. Carron, C. L. Chang, P. Chaubal, P. M. Chichura, A. Chokshi, T. -L. Chou, A. Coerver, T. M. Crawford, C. Daley, T. de Haan, K. R. Dibert, M. A. Dobbs, M. Doohan, A. Doussot, D. Dutcher, W. Everett, C. Feng, K. R. Ferguson, N. C. Ferree, K. Fichman, A. Foster, S. Galli, A. E. Gambrel, A. K. Gao, R. W. Gardner, F. Ge, N. Goeckner-Wald, R. Gualtieri, F. Guidi, S. Guns, N. W. Halverson, E. Hivon, A. Y. Q. Ho, G. P. Holder, W. L. Holzapfel, J. C. Hood, A. Hryciuk, N. Huang, T. Jhaveri, F. K\'eruzor\'e, A. R. Khalife, L. Knox, M. Korman, K. Kornoelje, C. -L. Kuo, K. Levy, Y. Li, A. E. Lowitz, C. Lu, G. P. Lynch, T. J. Maccarone, E. S. Martsen, F. Menanteau, M. Millea, J. Montgomery, Y. Nakato, T. Natoli, G. I. Noble, Y. Omori, A. Ouellette, Z. Pan, P. Paschos, K. A. Phadke, A. W. Pollak, K. Prabhu, W. Quan, M. Rahimi, A. Rahlin, C. L. Reichardt, M. Rouble, J. E. Ruhl, E. Schiappucci, A. C. Silva Oliveira, A. Simpson, J. A. Sobrin, A. A. Stark, J. Stephen, C. Tandoi, B. Thorne, C. Trendafilova, C. Umilta, J. D. Vieira, A. G. Vieregg, A. Vitrier, Y. Wan, N. Whitehorn, M. R. Young, J. A. Zebrowski

23. [Probing baryonic feedback with fast radio bursts: joint analyses with cosmic shear and galaxy clustering](#user-content-link23)
**Authors:** Amy Wayland, David Alonso, Robert Reischke

24. [Reionization Bubbles from Real-Space Cross Correlations of Line Intensity Maps](#user-content-link24)
**Authors:** Emilie Th\'elie, Sarah Libanore, Yonatan Sklansky, Julian B. Mu\~noz, Ely D. Kovetz

25. [NE2025: An Updated Electron Density Model for the Galactic Interstellar Medium](#user-content-link25)
**Authors:** S. K. Ocker, J. M. Cordes

26. [Extending the Cosmological Collider: New Scaling Regimes and Constraints from BOSS](#user-content-link26)
**Authors:** Daniel Green, Jiashu Han, Benjamin Wallisch

27. [3D insights into SN 1987A: ALMA observations compared to hydrodynamical explosion simulations](#user-content-link27)
**Authors:** R. Wesson (Cardiff University, UK, University College London, UK, Maynooth University, Ireland), M. Gabler (Universitat de Val\`encia, Spain), M. Lyons (Cardiff University, UK), J. Wildman (Cardiff University, UK), Mikako Matsuura (Cardiff University, UK), H. -T. Janka (MPI for Astrophysics, Garching, Germany), B. Giudici (Universitat de Val\`encia, Spain), P. Cigan (U.S. Naval Observatory, United States), H. L. Gomez (Cardiff University, UK), R. Indebetouw (National Radio Astronomy Observatory, United States, University of Virginia, United States), A. M. S. Richards (University of Manchester, UK), A. Wongwathanarat (MPI for Astrophysics, Garching, Germany)

28. [The ALMA-QUARKS Survey: Discovery of Dusty Fibrils inside Massive Star-forming Clumps](#user-content-link28)
**Authors:** Yan-Kun Zhang, Tie Liu, Wenyu Jiao, Pak-Shing Li, Jia Zeng, Chao Zhang, Pablo Garc\'ia, Mika Juvela, Guido Garay, Amelia M. Stutz, Sami Dib, Dezhao Meng, Jian-Cheng Feng, Dongting Yang, Fengwei Xu, Anandmayee Tej, Enrique V\'azquez-Semadeni, Gilberto C. G\'omez, Yong Zhang, Xindi Tang, Paul F. Goldsmith, Kee-Tae Kim, James O. Chibueze, Zhiyuan Ren, Patricio Sanhueza, Aiyuan Yang, Jihye Hwang, Shanghuo Li, Tapas Baug, Shivani Gupta, Swagat R. Das, Gang Wu, Jianjun Zhou, Chang Won Lee, Lokesh Dewangan, Prasanta Gorai, Tianning Lyu, Lei Zhu

29. [The Dark Side of the Moon: Listening to Scalar-Induced Gravitational Waves](#user-content-link29)
**Authors:** D. Blas, J. W. Foster, Y. Gouttenoire, A. J. Iovino, I. Musco, S. Trifinopoulos, M. Vanvlasselaer

30. [Is cosmic birefringence due to dark energy or dark matter? Simulation-based inference](#user-content-link30)
...
31. [Subaru High-$z$ Exploration of Low-Luminosity Quasars (SHELLQs). XXV. Large-scale environments of low-luminosity quasars at $z\sim6$ traced by Ly$\alpha$ emitters](#user-content-link31)
...
32. [DeepRed: an architecture for redshift estimation](#user-content-link32)
**Authors:** Alessandro Meroni, Nicol\`o Oreste Pinciroli Vago, Piero Fraternali

33. [Probing Dynamical Dark Energy with Late-Time Data: Evidence, Tensions, and the Limits of the $w_0w_a$CDM Framework](#user-content-link33)
**Authors:** Tengpeng Xu, Suresh Kumar, Yun Chen, Abra\~ao J. S. Capistrano, \"Ozg\"ur Akarsu

34. [Oxygen left behind: Atmospheric Enrichment due to Fractionation in Sub-Neptunes using BOREAS](#user-content-link34)
**Authors:** Marilina Valatsou, Caroline Dorn, Pierlou Marty, James E. Owen

35. [pespace: A new tool of GPU-accelerated and auto-differentiable response generation and likelihood evaluation for space-borne gravitational wave detectors](#user-content-link35)
**Authors:** Rui Niu, Chang Feng, Wen Zhao

36. [Status of the $S_8$ Tension: A 2026 Review of Probe Discrepancies](#user-content-link36)
**Authors:** Ioannis Pantos, Leandros Perivolaropoulos

37. [A simple model for extracting astrophysics from black hole images](#user-content-link37)
**Authors:** Alexandra G. Guerrero, Daniel E. Holz

38. [Searching for Anisotropy in the Gravitational Wave Background Using the Parkes Pulsar Timing Array](#user-content-link38)
**Authors:** Yiqin Chen, Shi-Yi Zhao, Zhi-Zhang Peng, Xingjiang Zhu, N. D. Ramesh Bhat, Zu-Cheng Chen, Ma{\l}gorzata Cury{\l}o, Valentina Di Marco, George Hobbs, Agastya Kapur, Wenhua Ling, Rami Mandow, Saurav Mishra, Daniel J. Reardon, Christopher J. Russell, Ryan M. Shannon, Jacob Cardinal Tremblay, Jingbo Wang, Lei Zhang, Andrew Zic

39. [Search for Sub-Solar Mass Binaries in the First Part of LIGO's Fourth Observing Run](#user-content-link39)
**Authors:** Keisi Kacanja, Kanchan Soni, Aleyna Akyuz, Alexander H. Nitz

40. [Efficient parallel finite-element methods for planetary gravitation: DtN and multipole expansions](#user-content-link40)
**Authors:** Ziheng Yu, Alex D. C. Myhill, David Al-Attar

41. [Impact of crust-core connection procedures on the tidal deformability of neutron stars](#user-content-link41)
**Authors:** Junbo Pang, Hong Shen, Jinniu Hu

42. [Poloidal Field Amplification through Compression-Shear Dynamics in Schwarzschild Accretion: Pathways to MAD States](#user-content-link42)
**Authors:** Malihe Mousapour Gharghabi, Jamshid Ghanbari, Mahboobe Moeen Moghaddas

43. [Using astrochemical models to simulate reactivity experiments on cold surfaces](#user-content-link43)
...
44. [ALMA Band1 observations of the rhoOphW filament I. Enhanced power from excess microwave emission at high spatial frequencies](#user-content-link44)
**Authors:** Simon Casassus, Matias Vidal, Miguel Carcamo, Laurent Verstraete, Nathalie Ysard, Emilie Habart

45. [Spectro-timing origin of large amplitude X-ray variability in GRS 1915+105 using AstroSat/LAXPC and SXT](#user-content-link45)
**Authors:** Shree Suman (IIT Hyderabad), Shuvajit Khatua (RRI Bangalore), Vishal Jadoliya (IIT Hyderabad), Prathamesh Narayan Gupta (DTU New Delhi), Mayukh Pahari (IIT Hyderabad)

46. [The Outflow of the B335 Protostar II: After the Outburst](#user-content-link46)
...
47. [Sterile neutrino dark matter in conformal Majoron models](#user-content-link47)
**Authors:** Jo\~ao Gon\c{c}alves, Danny Marfatia, Ant\'onio P. Morais, Vin\'icius Oliveira, Roman Pasechnik

48. [GR from RG: Gravity Is Induced From Renormalization Group Flow In The Infrared](#user-content-link48)
**Authors:** M. M. Sheikh-Jabbari, V. Taghiloo

49. [Beyond One-Thousandth Energy Resolution with an AlMn TES Detector](#user-content-link49)
...
50. [Testing and Validation of the Updated Pixel-Based Non-Linearity Calibration File for WFC3/IR](#user-content-link50)
**Authors:** K. Huynh, V. Bajaj, M. Marinelli, J. Mack, S. Shenoy, N. Grogin

51. [Cosmographic Connection Between Cosmological And Planck Scales: The Barrow-Tsallis Entropy](#user-content-link51)
**Authors:** Yu. L. Bolotin, V. V. Yanovsky, D. A. Yerokhin

52. [What does a regular star look like?](#user-content-link52)
**Authors:** Yu Liang, Yuhao Cui, Kai Lin, Sen Guo, V. H. Satheeshkumar, Yang Huang, Yang-Yi Sun, Elcio Abdalla

53. [Linear Growth of Matter Perturbations Probed by Redshift-Space Distortions in Interacting $\Lambda(t)$CDM Cosmologies](#user-content-link53)
**Authors:** A. A. Escobal, H. A. P. Macedo, J. F. Jesus, R. C. Nunes, J. A. S. Lima

54. [Numerical simulation of the stochastic formalism including non-Markovianity](#user-content-link54)
**Authors:** Masahiro Kawasaki, Tomotaka Kuroda

55. [Ubiquitous yet forgotten: broad absorptions in the optical spectra of low-mass X-ray binaries](#user-content-link55)
**Authors:** D. Mata Sanchez, T. Munoz-Darias, J. Casares, M. A. P. Torres, M. Armas Padilla

56. [The Interstellar Scintillation of the Radio-Loud Magnetar XTE J1810-197](#user-content-link56)
...
57. [Velocities of Free Floaters in a Sea of Stars](#user-content-link57)
**Authors:** Jun Yan Lau, Dong Lai

58. [Time delays and stationarity in quasar light curves](#user-content-link58)
**Authors:** Namu Kroupa, David Yallup, Will Handley

59. [An optical transient candidate of $\lesssim$ 2-second duration captured by wide-field video observations](#user-content-link59)
...
60. [The Radius Cliff is a Waterfall: Explaining Sub-Neptune Exoplanets with Steam Worlds](#user-content-link60)
**Authors:** Aritra Chakrabarty, Gijs D. Mulders, Artyom Aguichine, Natalie Batalha

61. [Three-dimensional mapping of coronal magnetic field and plasma parameters in a solar flare](#user-content-link61)
**Authors:** Tatyana Kaltman, Sijie Yu, Gregory D. Fleishman, Daniel F. Ryan

62. [Understanding coronal geometry in NGC 4593 using Fourier frequency-resolved covariance and time-lag spectral analysis](#user-content-link62)
**Authors:** Shree Suman (IIT Hyderabad), Mayukh Pahari (IIT Hyderabad), Gulab Dewangan (IUCAA, Pune), Ian M McHardy (University of Southampton, UK)

63. [Unification Model of Active Galactic Nuclei by Photoionization Equilibrium Calculation Based on Radiative Hydrodynamic Simulations](#user-content-link63)
**Authors:** Atsushi Tanimoto, Keiichi Wada, Yuki Kudoh, Nozomu Kawakatu, Mariko Nomura, Hirokazu Odaka

64. [Selecting Optimal Stellar Calibration Fields for the CSST Imaging Survey](#user-content-link64)
**Authors:** Chenxiaoji Ling, Juanjuan Ren, Li Shao, Zhimin Zhou, Peng Wei, Youhua Xu, Jinyu Hu, Xin Zhang, Su Yao, Hu Zhan, Chao Liu

65. [Signatures of Damping Nonlinear Oscillations by KHI-induced Turbulence in Synthetic Observations](#user-content-link65)
**Authors:** Sihui Zhong, Andrew Hillier, I\~nigo Arregui

66. [Rotation catalyzed chiral magnetovortical instability](#user-content-link66)
**Authors:** Shuai Wang, Xu-Guang Huang

67. [The Quasar Proximity Effect as an Alternative Probe of Quasar Pair Distances](#user-content-link67)
**Authors:** Huanqing Chen, Camille Avestruz, Jakob Wiest

68. [Evolution of the transitional millisecond pulsar PSR J1023+0038 from Aqueye+ and NICER observations](#user-content-link68)
**Authors:** Silvia Conforti, Luca Zampieri, Michele Fiori, Alessia Spolon, Giampiero Naletto, Aleksandr Burtovoi

69. [Design and characterization of W-band and D-band calibration sources for the AliCPT-1 experiment](#user-content-link69)
...
70. [Tidal triggers and the predictability of solar activity](#user-content-link70)
**Authors:** F. Stefani, G. M. Horstmann, G. Mamatsashvili, T. Weier

71. [Monitoring the upper atmospheric temperature and interplanetary magnetic field with the GRAPES-3 muon telescope](#user-content-link71)
...
## 1. [Tailored mass estimators for Milky Way dwarf Spheroidals](https://arxiv.org/abs/2602.11273) <a id="link1"></a>
...
**Comment:** Directly matches the 'Near-Field Cosmology' criterion: focuses on Milky Way dwarf spheroidal satellites, their stellar density profiles, and dynamical mass estimators. Also touches on dark matter density profiles and scaling relations, which are highly relevant.
...
## 2. [The faint end of the UV luminosity function at $0.4 < z < 0.7$ from the Hubble Frontier Fields](https://arxiv.org/abs/2602.11681) <a id="link2"></a>

**ArXiv ID:** 2602.11681

**Authors:** Lei Sun, Xiao-Lei Meng, Xin Wang, Hu Zhan, Anahita Alavi, Nicha Leethochawalit, Brian Siana, Hang Zhou, Shengzhe Wang, Shamuhawu Hailanhazi

**Abstract:** By extending the Hubble Frontier Fields (HFF) observations to the F225W band using HST WFC3/UVIS, we measure the rest-frame UV luminosity function (LF) of galaxies at $0.4 < z < 0.7$, pushing into the low-luminosity galaxy regime. In this first paper of a series, we describe the HST Cycle-27 GO-15940 F225W observations and data reduction, and present a corresponding catalog for the Abell 2744 field, which is the most data-rich HFF cluster field. Combining deep Near-UV imaging and the high magnification from strong gravitational lensing of the foreground cluster, we identify 152 faint galaxies with $-19.5 < M_{UV} < -12.1$ at $0.4 < z < 0.7$ through hybrid photometric-spectroscopic redshift selection from the Abell 2744 F225W catalog. Using a sample defined by a $50\%$ completeness cut and applying the maximum likelihood estimation, we derive the best-fit Schechter parameters for the UV LF at $z \sim 0.55$ down to $M_\text{UV} < -13.5$ mag, including a faint-end slope of $\alpha = -1.324^{+0.072}_{-0.074}$. We incorporate a curvature parameter $\delta$ in parameter estimation to account for a possible turn-over at the faint end of the UV LF, leveraging the exceedingly low luminosities probed by our sample. Our results rule out a turn-over brighter than $M_{UV} = -15.5$ at the $3\sigma$ confidence level.

**Comment:** This paper measures the faint end of the UV luminosity function at 0.4 < z < 0.7 using Hubble Frontier Fields, identifying faint galaxies and probing the luminosity function down to very low luminosities. The focus on low-luminosity galaxies and the luminosity function is directly relevant to near-field cosmology and satellite luminosity function criteria, especially as it pushes into the regime of dwarf galaxies.
...
## 4. [The Curious Case of Centaurus A II: On the Subject of the Quenched satellites](https://arxiv.org/abs/2602.11270) <a id="link4"></a>
...
**Comment:** Directly relevant to near-field cosmology and star formation quenching in dwarf satellites. The paper investigates the deficit of luminous satellites in Centaurus A, explores quenching mechanisms, and discusses AGN feedback's impact on satellite survival and evolution. Strong match to satellite quenching and near-field cosmology criteria.
...
## 7. [A Multiwavelength Evaluation of AGN in the Post-Starburst Phase](https://arxiv.org/abs/2602.11644) <a id="link7"></a>
...
**Comment:** Addresses star formation quenching, but focuses on post-starburst galaxies and AGN feedback, mostly in higher-mass galaxies. Dwarf galaxies are not the main focus, so relevance is moderate.
...
## 8. [Surface brightness-colour relations of Milky Way and Magellanic Clouds classical Cepheids based on Gaia magnitudes](https://arxiv.org/abs/2602.11994) <a id="link8"></a>
...
**Comment:** The paper derives surface brightness-color relations for classical Cepheids in the Milky Way and Magellanic Clouds, using Gaia data. It presents new relations and quantifies metallicity effects. While it involves stellar models and bolometric corrections, it is focused on Cepheids and not on galaxy-scale processes or resolved star formation histories. Some relevance to 'Stellar Models' criterion.
...
## 9. [The "bubbly" interstellar medium as origin for the inhomogeneous internal metallicity distributions in large disk galaxies](https://arxiv.org/abs/2602.11450) <a id="link9"></a>
...
**Comment:** Analyzes resolved metallicity maps in disk galaxies, connecting small-scale ISM inhomogeneities to superbubble-driven star formation. While it discusses ISM structure and star formation, the focus is on large disk galaxies, not dwarfs or satellites. Some relevance to star formation driven outflows and ISM structure, but not a direct match.
...
## 10. [Tango of Titans: Centaurus A and M83 as a Local Group Analog](https://arxiv.org/abs/2602.11268) <a id="link10"></a>
...
**Comment:** This paper discusses the dynamical interaction between Centaurus A and M83, drawing analogies to the Milky Way-Andromeda system in the Local Group. While it focuses on galaxy pairs and their masses, it does not directly address satellite galaxies, near-field cosmology, or resolved star formation histories. The relevance is borderline, as it touches on Local Group analogs but not the core topics.
...
## 11. [Population synthesis predictions of the Galactic compact binary gravitational wave foreground detectable by LISA](https://arxiv.org/abs/2602.11765) <a id="link11"></a>
...
**Comment:** Uses population synthesis modeling to predict the gravitational wave signal from Galactic compact binaries, implementing realistic star formation histories and metallicity. The inclusion of star formation history modeling is relevant, though the focus is on compact binaries and gravitational waves rather than resolved star formation histories of galaxies. Borderline relevance.
...
## 12. [Measurement prospects for the pair-instability mass cutoff with gravitational waves](https://arxiv.org/abs/2602.11282) <a id="link12"></a>
...
**Comment:** This paper investigates the pair-instability mass cutoff in black hole populations using gravitational wave data. It discusses implications for stellar models, specifically the mass gap left by pair-instability supernovae, which is relevant to the stellar models criterion. However, the focus is on black hole remnants rather than stellar evolutionary tracks or atmospheres, so relevance is borderline.
...
## 13. [Dynamic modeling of coronal abundances during flares on M-dwarf stars](https://arxiv.org/abs/2602.11649) <a id="link13"></a>
...
**Comment:** This paper models coronal abundances during flares on M-dwarf stars, focusing on stellar atmospheric composition and flare dynamics. It is relevant to stellar models, specifically stellar atmosphere modeling, but does not present new evolutionary tracks or bolometric corrections. Some relevance to the 'Stellar Models' criterion.
...
## 14. [Characterising Ly$\alpha$ damping wings at the onset of reionisation: Evidence for highly efficient star formation driven by dense, neutral gas in UV-bright galaxies at $z>9$](https://arxiv.org/abs/2602.11783) <a id="link14"></a>
...
**Comment:** The paper discusses star formation efficiency and gas properties in UV-bright galaxies at z>9, using JWST observations. While it focuses on star formation histories and gas assembly, the galaxies are not resolved in the sense of color-magnitude diagrams, and the focus is on high-redshift, massive galaxies rather than dwarfs. The connection to resolved star formation histories is weak, but the discussion of star formation efficiency and gas depletion timescales is tangentially relevant.
...
## 15. [Stone Skipping Black Holes in Ultralight Dark Matter Solitons](https://arxiv.org/abs/2602.11512) <a id="link15"></a>
...
**Comment:** This paper models the dynamics of black holes in ultralight dark matter solitons, discussing the impact of dipole excitations on inspiral timescales. While it touches on dark matter substructure and dynamics, the focus is on black holes and soliton dynamics rather than satellite galaxies or near-field cosmology. The relevance is borderline due to the mention of dark matter substructure.
...
## 16. [Evolution of submillimeter galaxies across cosmic-web environments](https://arxiv.org/abs/2602.11751) <a id="link16"></a>
...
**Comment:** This paper uses the FLAMINGO simulation to study submillimeter galaxies (SMGs) across cosmic environments, including cluster-halos and filaments. It analyzes satellite and central SMGs, their abundance, and environmental effects. While SMGs are not dwarf galaxies, the paper does discuss satellite populations and environmental effects on galaxy evolution, which is tangentially relevant to near-field cosmology and numerical galaxy simulations, but not directly focused on dwarfs or resolved star formation histories.
...
## 18. [A Portrait of the Cosmic Reionisation History in the Context of the Early Dark Energy Model](https://arxiv.org/abs/2601.11068) <a id="link18"></a>

**ArXiv ID:** 2601.11068

**Authors:** Weiyang Liu, Xin Wang, Hu Zhan, Karl Glazebrook, Mengtao Tang, Michele Trenti

**Abstract:** Recent JWST observations of Lyman-$\alpha$ emission at $z \sim 11-6$ indicate a rapid reionization of the intergalactic medium within the first $\sim700$ Myr. The required Lyman continuum (LyC) photon budget may naturally arise from the unexpectedly high galaxy number densities revealed by JWST, reducing the need for scenarios invoking very high LyC escape fractions ($f_{\rm esc}\gtrsim0.2$) or dominant contributions from ultra-faint galaxies ($M_{\rm UV}>-15$) in the standard $\Lambda$CDM framework. In this work, we model the reionization history under the Early Dark Energy (EDE) paradigm -- originally proposed to ease the Hubble tension -- which also explains the observed over-abundance of high-$z$ galaxies without extreme star formation efficiencies. The EDE model yields reionization histories consistent with current constraints while requiring only moderate LyC escape fractions and UV luminosity densities ($f_{\rm esc}\sim 0.05-0.1$, $M_{\rm UV}\lesssim -17$ to $-15$). Our results suggest that, once key astrophysical parameters are better constrained, the reionization history could serve as an independent and complementary probe of EDE cosmologies.

**Comment:** Models cosmic reionization history in the context of Early Dark Energy, referencing galaxy number densities and star formation efficiencies at high redshift. While it touches on star formation and galaxy abundances, it is not focused on resolved star formation histories or dwarf galaxies, and is more cosmological than near-field. Borderline relevance.
...
## 20. [The Wandering Supermassive Black Hole Powering the off-nuclear TDE AT2024tvd](https://arxiv.org/abs/2602.12272) <a id="link20"></a>
...
**Comment:** This paper analyzes an off-nuclear tidal disruption event (TDE) and discusses the absence of a detected star cluster or dwarf galaxy associated with the source. It briefly touches on the mass limit for a possible dwarf galaxy, but the main focus is on the TDE and wandering supermassive black hole. Only a weak connection to near-field cosmology via the discussion of stripped nuclei and dwarf galaxy mass limits.
...
## 21. [Filling The Pockets: The Spherical Nature of 3D Deflagration in Thermonuclear Supernovae](https://arxiv.org/abs/2602.11341) <a id="link21"></a>
...
**Comment:** Presents 3D magnetohydrodynamic simulations of thermonuclear supernovae, focusing on mixing and burning in white dwarfs. While it involves numerical simulations, it is not about galaxy simulations or stellar models relevant to the core topics.
...
## 22. [SPT-3G D1: Compton-$y$ maps using data from the SPT-3G and Planck surveys](https://arxiv.org/abs/2602.11279) <a id="link22"></a>
...
**Comment:** This paper presents Compton-y maps from SPT-3G and Planck, focusing on the thermal Sunyaev-Zel'dovich effect and cluster pressure profiles. It is relevant to large-scale structure and baryons, but does not address dwarf galaxies, near-field cosmology, or galaxy simulations.
...
## 23. [Probing baryonic feedback with fast radio bursts: joint analyses with cosmic shear and galaxy clustering](https://arxiv.org/abs/2602.12174) <a id="link23"></a>
...
**Comment:** Addresses baryonic feedback effects on the matter power spectrum using cosmological probes (FRBs, weak lensing, galaxy clustering). While baryonic feedback is relevant to galaxy evolution, the focus is on cosmological parameter inference and not on galaxy-scale feedback, outflows, or dwarf galaxy properties. No direct match to core criteria.
...
## 24. [Reionization Bubbles from Real-Space Cross Correlations of Line Intensity Maps](https://arxiv.org/abs/2602.12277) <a id="link24"></a>
...
**Comment:** Proposes a new method to reconstruct ionized bubble size distributions during reionization using cross-correlations of 21-cm and line-intensity maps. Focus is on EoR and bubble statistics, not on resolved star formation histories, galaxy simulations, or outflows in the local universe.
...
## 25. [NE2025: An Updated Electron Density Model for the Galactic Interstellar Medium](https://arxiv.org/abs/2602.11838) <a id="link25"></a>
...
**Comment:** This paper presents an updated electron density model for the Galactic ISM, focusing on large-scale components like disks and spiral arms, and revising the Galactic Center component. While it is useful for studies of the Milky Way and extragalactic foregrounds, it does not focus on dwarf satellite galaxies, resolved star formation histories, or galaxy simulations. No direct match to any core criteria.
...
## 26. [Extending the Cosmological Collider: New Scaling Regimes and Constraints from BOSS](https://arxiv.org/abs/2602.12232) <a id="link26"></a>
...
**Comment:** The paper explores primordial non-Gaussianity and its signatures in large-scale structure, using galaxy surveys. While it is cosmological, it does not address near-field cosmology, dwarf galaxies, or any of the core topics.
...
## 27. [3D insights into SN 1987A: ALMA observations compared to hydrodynamical explosion simulations](https://arxiv.org/abs/2602.11259) <a id="link27"></a>
...
**Comment:** Compares 3D ALMA observations of SN 1987A to hydrodynamical explosion simulations, focusing on supernova ejecta and progenitor models. While it uses numerical simulations, the focus is on supernovae, not galaxies or any of the core topics.
...
## 28. [The ALMA-QUARKS Survey: Discovery of Dusty Fibrils inside Massive Star-forming Clumps](https://arxiv.org/abs/2602.11617) <a id="link28"></a>
...
**Comment:** Reports discovery of superfine dusty filamentary structures inside massive star-forming clumps. While it discusses star formation and filamentary structures, the focus is on molecular clouds and clumps, not galaxies or resolved star formation histories. Not directly relevant.
...
## 29. [The Dark Side of the Moon: Listening to Scalar-Induced Gravitational Waves](https://arxiv.org/abs/2602.12252) <a id="link29"></a>

**ArXiv ID:** 2602.12252

**Authors:** D. Blas, J. W. Foster, Y. Gouttenoire, A. J. Iovino, I. Musco, S. Trifinopoulos, M. Vanvlasselaer

**Abstract:** The collapse of large-amplitude primordial curvature perturbations into planetary-mass primordial black holes generates a scalar-induced gravitational wave background in the $\mu $Hz frequency range that may be detectable by future Lunar Laser Ranging and Satellite Laser Ranging data. We derive projected constraints on the primordial black hole population from a null detection of stochastic gravitational wave background by these experiments, including the impact of the electroweak phase transition on the abundance of planetary-mass primordial black holes. We also discuss the connection between the obtained projected constraints and the recent microlensing observations by the HSC collaboration of the Andromeda Galaxy.

**Comment:** Discusses primordial black holes and gravitational waves, with some connection to microlensing observations of the Andromeda Galaxy. However, it does not focus on satellite galaxies, resolved star formation histories, or other core topics.
...
## 30. [Is cosmic birefringence due to dark energy or dark matter? Simulation-based inference](https://arxiv.org/abs/2602.12019) <a id="link30"></a>
...
**Comment:** Focuses on cosmic birefringence and its connection to dark energy or dark matter, using simulation-based inference. While interesting, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 32. [DeepRed: an architecture for redshift estimation](https://arxiv.org/abs/2602.11281) <a id="link32"></a>
...
**Comment:** Presents a deep learning pipeline for redshift estimation from images, which is a technical method not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 34. [Oxygen left behind: Atmospheric Enrichment due to Fractionation in Sub-Neptunes using BOREAS](https://arxiv.org/abs/2602.12201) <a id="link34"></a>
...
**Comment:** This paper models atmospheric escape and fractionation in sub-Neptunes, focusing on exoplanet atmospheres and chemical enrichment. It does not address galaxy-scale processes, resolved star formation histories, or any of the core criteria.
...
## 35. [pespace: A new tool of GPU-accelerated and auto-differentiable response generation and likelihood evaluation for space-borne gravitational wave detectors](https://arxiv.org/abs/2602.12011) <a id="link35"></a>
...
**Comment:** This paper introduces a GPU-accelerated tool for parameter estimation for space-borne gravitational wave detectors, focusing on massive black hole binaries. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 36. [Status of the $S_8$ Tension: A 2026 Review of Probe Discrepancies](https://arxiv.org/abs/2602.12238) <a id="link36"></a>

**ArXiv ID:** 2602.12238

**Authors:** Ioannis Pantos, Leandros Perivolaropoulos

**Abstract:** The parameter $S_8 \equiv \sigma_8 (\Omega_m/0.3)^{0.5}$ quantifies the amplitude of matter density fluctuations. A persistent discrepancy exists between early-universe CMB observations and late-universe probes. This review assesses the ``$S_8$ tension'' against a new 2026 baseline: a unified ``Combined CMB'' framework incorporating Planck, ACT DR6, and SPT-3G. This combined analysis yields $S_8 = 0.836^{+0.012}_{-0.013}$, providing a higher central value and reduced uncertainties compared to Planck alone. Compiling measurements from 2019--2026, we reveal a striking bifurcation: DES Year 6 results exhibit a statistically significant tension of $2.4\sigma$--$2.7\sigma$ \citep{DESY6}, whereas KiDS Legacy results demonstrate statistical consistency at $<1\sigma$ \citep{Wright2025}. We examine systematic origins of this dichotomy, including photometric redshift calibration, intrinsic alignment modeling, and shear measurement pipelines. We further contextualize these findings with cluster counts (where eROSITA favors high values while SPT favors low), galaxy-galaxy lensing, and redshift-space distortions. The heterogeneous landscape suggests survey-specific systematic effects contribute substantially to observed discrepancies, though new physics beyond $\Lambda$CDM cannot be excluded.

**Comment:** Reviews the $S_8$ tension between early- and late-universe cosmological probes. While it discusses galaxy cluster counts and lensing, the focus is on cosmological parameters, not on galaxy-scale phenomena or any of the core topics.
...
## 37. [A simple model for extracting astrophysics from black hole images](https://arxiv.org/abs/2602.12195) <a id="link37"></a>
...
**Comment:** Focuses on black hole imaging and accretion disk properties in M87*, a massive elliptical galaxy. Does not match any of the core criteria (no dwarf galaxies, star formation histories, or stellar models).
...
## 38. [Searching for Anisotropy in the Gravitational Wave Background Using the Parkes Pulsar Timing Array](https://arxiv.org/abs/2602.11529) <a id="link38"></a>
...
**Comment:** This paper searches for anisotropy in the gravitational wave background using pulsar timing arrays. It is focused on gravitational wave astrophysics and not on galaxy-scale processes, near-field cosmology, or any of the core criteria.
...
## 39. [Search for Sub-Solar Mass Binaries in the First Part of LIGO's Fourth Observing Run](https://arxiv.org/abs/2602.12115) <a id="link39"></a>
...
**Comment:** This paper reports a search for sub-solar mass binaries in LIGO's fourth observing run, constraining merger rates and primordial black hole dark matter fraction. It is focused on compact object astrophysics and not on galaxy-scale processes or any of the core criteria.
...
## 40. [Efficient parallel finite-element methods for planetary gravitation: DtN and multipole expansions](https://arxiv.org/abs/2602.12075) <a id="link40"></a>
...
**Comment:** This paper discusses efficient parallel finite-element methods for planetary gravitation, focusing on numerical methods for geophysical modeling. It does not address galaxy-scale simulations or any of the core criteria.
...
## 41. [Impact of crust-core connection procedures on the tidal deformability of neutron stars](https://arxiv.org/abs/2602.11809) <a id="link41"></a>
...
**Comment:** The paper studies the impact of crust-core connection procedures on neutron star tidal deformability. It is focused on neutron star structure and gravitational wave measurements, not on any of the core topics.
...
## 42. [Poloidal Field Amplification through Compression-Shear Dynamics in Schwarzschild Accretion: Pathways to MAD States](https://arxiv.org/abs/2602.12165) <a id="link42"></a>
...
**Comment:** Focuses on magnetic field amplification in black hole accretion disks, specifically in the context of Schwarzschild accretion and MAD states. This is not related to galaxy simulations, stellar models, or any of the core topics (e.g., near-field cosmology, star formation histories, outflows, CGM).
...
## 43. [Using astrochemical models to simulate reactivity experiments on cold surfaces](https://arxiv.org/abs/2602.11347) <a id="link43"></a>
...
**Comment:** Uses astrochemical models to simulate laboratory experiments on cold surfaces, focusing on solid-state chemistry and molecular complexity. No direct relevance to galaxy simulations, star formation histories, or outflows.
...
## 44. [ALMA Band1 observations of the rhoOphW filament I. Enhanced power from excess microwave emission at high spatial frequencies](https://arxiv.org/abs/2602.11356) <a id="link44"></a>
...
**Comment:** ALMA observations of a photo-dissociation region, focusing on excess microwave emission and spinning dust. No connection to galaxy simulations, star formation histories, or outflows.
...
## 46. [The Outflow of the B335 Protostar II: After the Outburst](https://arxiv.org/abs/2602.12060) <a id="link46"></a>
...
**Comment:** Studies the outflow of a protostar (B335) and its effect on jets and shock fronts. While it discusses outflows, these are protostellar and not galaxy-scale, nor are they driven by star formation in galaxies. Not relevant to the core topics.
...
## 47. [Sterile neutrino dark matter in conformal Majoron models](https://arxiv.org/abs/2602.11085) <a id="link47"></a>
...
**Comment:** Studies sterile neutrino dark matter in a conformal Majoron model, focusing on dark matter production and constraints from structure formation. While it touches on dark matter and structure formation, it does not address galaxy-scale phenomena, satellite galaxies, or resolved star formation histories. Irrelevant.
...
## 48. [GR from RG: Gravity Is Induced From Renormalization Group Flow In The Infrared](https://arxiv.org/abs/2602.11806) <a id="link48"></a>
...
**Comment:** This essay discusses gravity induced from renormalization group flow in the infrared, focusing on quantum gravity and holography. It does not address any of the core topics.
...
## 49. [Beyond One-Thousandth Energy Resolution with an AlMn TES Detector](https://arxiv.org/abs/2602.11728) <a id="link49"></a>
...
**Comment:** Describes a new AlMn TES detector for X-ray detection, focusing on instrumentation and energy resolution. No connection to stellar models, galaxy simulations, or any of the core topics.
...
## 50. [Testing and Validation of the Updated Pixel-Based Non-Linearity Calibration File for WFC3/IR](https://arxiv.org/abs/2602.12110) <a id="link50"></a>
...
**Comment:** This paper focuses on calibration improvements for the WFC3/IR instrument, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. It is a technical paper about detector calibration.
...
## 51. [Cosmographic Connection Between Cosmological And Planck Scales: The Barrow-Tsallis Entropy](https://arxiv.org/abs/2602.12077) <a id="link51"></a>
...
**Comment:** Discusses quantum gravity and cosmological horizon entropy, not directly related to any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 52. [What does a regular star look like?](https://arxiv.org/abs/2602.12200) <a id="link52"></a>
...
**Comment:** Discusses gravitational lensing by regular stars and their optical appearances, but does not address stellar models, resolved star formation histories, or any other core topics.
...
## 54. [Numerical simulation of the stochastic formalism including non-Markovianity](https://arxiv.org/abs/2602.11652) <a id="link54"></a>
...
**Comment:** The paper presents numerical simulations of stochastic dynamics in cosmology, focusing on non-Markovian effects in IR and UV modes. While it is a simulation paper, it does not focus on galaxy simulations or any of the core criteria.
...
## 55. [Ubiquitous yet forgotten: broad absorptions in the optical spectra of low-mass X-ray binaries](https://arxiv.org/abs/2602.12282) <a id="link55"></a>
...
**Comment:** The paper studies broad absorptions in optical spectra of low-mass X-ray binaries, focusing on accretion disc properties and outburst phenomena. It does not address galaxy-scale processes, star formation histories, quenching, or near-field cosmology. No direct match to any core criteria.
...
## 56. [The Interstellar Scintillation of the Radio-Loud Magnetar XTE J1810-197](https://arxiv.org/abs/2602.12051) <a id="link56"></a>
...
**Comment:** This paper focuses on interstellar scintillation of a magnetar and the ionized interstellar medium in the Sagittarius Arm. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 57. [Velocities of Free Floaters in a Sea of Stars](https://arxiv.org/abs/2602.12017) <a id="link57"></a>
...
**Comment:** The paper studies the velocity evolution of free-floating planets and interstellar objects in the Galactic disk. While it touches on stellar kinematics, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 58. [Time delays and stationarity in quasar light curves](https://arxiv.org/abs/2602.11264) <a id="link58"></a>

**ArXiv ID:** 2602.11264

**Authors:** Namu Kroupa, David Yallup, Will Handley

**Abstract:** We present a fully Bayesian framework for time delay inference and stationarity tests in quasar light curves using marginalised Gaussian processes. The model separates a deterministic, non-stationary drift (piecewise linear mean) from stationary stochastic variability (Mat\'ern and Spectral Mixture kernels), and jointly models multiple images with per-image microlensing. Bayesian evidence and parameter posteriors are obtained via nested sampling and marginalised over model choices. Applied to the quasars WFI J2033 - 4723, B 1608 + 656, and HE 0435 - 1223, we find strong evidence for non-stationarity in B 1608 + 656 and HE 0435 - 1223, while WFI J2033 - 4723 is consistent with stationarity. The stochastic component favours an Markovian exponential kernel for B 1608 + 656 and a non-Markovian Mat\'ern-$\frac32$ kernel for WFI J2033 - 4723 and HE 0435 - 1223. Multi-length-scale Spectral Mixture kernels are disfavoured. Time delays are shown to be robust to model assumptions and consistent with prior work within the error. We further identify and mitigate a likelihood pathology which biases toward large delays, providing a practical nested sampling convergence protocol.

**Comment:** The paper presents a Bayesian framework for time delay inference in quasar light curves. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 59. [An optical transient candidate of $\lesssim$ 2-second duration captured by wide-field video observations](https://arxiv.org/abs/2602.11600) <a id="link59"></a>
...
**Comment:** This paper reports the discovery of a short-duration optical transient and discusses possible origins. The focus is on transient detection and not on galaxy evolution, star formation, or near-field cosmology.
...
## 60. [The Radius Cliff is a Waterfall: Explaining Sub-Neptune Exoplanets with Steam Worlds](https://arxiv.org/abs/2602.11923) <a id="link60"></a>
...
**Comment:** This paper discusses exoplanet demographics and interior structure models, focusing on the radius valley between super-Earths and sub-Neptunes. It is unrelated to the core topics of near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 61. [Three-dimensional mapping of coronal magnetic field and plasma parameters in a solar flare](https://arxiv.org/abs/2602.11853) <a id="link61"></a>
...
**Comment:** The paper reconstructs 3D maps of coronal magnetic field and plasma parameters in a solar flare. It is focused on solar physics and does not address any of the core topics.
...
## 62. [Understanding coronal geometry in NGC 4593 using Fourier frequency-resolved covariance and time-lag spectral analysis](https://arxiv.org/abs/2602.11624) <a id="link62"></a>
...
**Comment:** The paper studies X-ray variability and coronal geometry in a Seyfert galaxy. The focus is on AGN and coronal physics, which is not relevant to any of the core criteria (near-field cosmology, star formation histories, dwarf galaxies, etc.).
...
## 63. [Unification Model of Active Galactic Nuclei by Photoionization Equilibrium Calculation Based on Radiative Hydrodynamic Simulations](https://arxiv.org/abs/2602.11474) <a id="link63"></a>
...
**Comment:** This paper presents a model for AGN unification based on radiative hydrodynamic simulations and photoionization equilibrium calculations. The focus is on AGN covering factors and X-ray observations, which is not relevant to any of the core criteria.
...
## 64. [Selecting Optimal Stellar Calibration Fields for the CSST Imaging Survey](https://arxiv.org/abs/2602.11864) <a id="link64"></a>
...
**Comment:** The paper selects optimal stellar calibration fields for the CSST imaging survey, focusing on globular clusters for photometric calibration. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 65. [Signatures of Damping Nonlinear Oscillations by KHI-induced Turbulence in Synthetic Observations](https://arxiv.org/abs/2602.11884) <a id="link65"></a>
...
**Comment:** The paper investigates nonlinear damping and turbulence in coronal loop oscillations using MHD simulations. The focus is on solar coronal physics and not on galaxy simulations, star formation, or near-field cosmology.
...
## 66. [Rotation catalyzed chiral magnetovortical instability](https://arxiv.org/abs/2602.11228) <a id="link66"></a>
...
**Comment:** The paper discusses chiral magnetovortical instability in rotating plasmas, focusing on magnetohydrodynamics and plasma physics. It is not relevant to any of the core criteria.
...
## 67. [The Quasar Proximity Effect as an Alternative Probe of Quasar Pair Distances](https://arxiv.org/abs/2602.11269) <a id="link67"></a>
...
**Comment:** Focuses on quasar pairs at high redshift and methods to probe their distances. Does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. Purely unrelated.
...
## 68. [Evolution of the transitional millisecond pulsar PSR J1023+0038 from Aqueye+ and NICER observations](https://arxiv.org/abs/2602.11274) <a id="link68"></a>
...
**Comment:** Studies the evolution of a transitional millisecond pulsar, focusing on timing and phase lag between optical and X-ray pulses. No connection to galaxy-scale phenomena, near-field cosmology, or any of the core topics.
...
## 69. [Design and characterization of W-band and D-band calibration sources for the AliCPT-1 experiment](https://arxiv.org/abs/2602.11620) <a id="link69"></a>
...
**Comment:** Describes calibration sources for a CMB polarization experiment. No connection to galaxy simulations, star formation histories, outflows, or near-field cosmology.
...
## 70. [Tidal triggers and the predictability of solar activity](https://arxiv.org/abs/2602.11227) <a id="link70"></a>
...
**Comment:** Examines solar activity and tidal triggers, focusing on planetary influences on solar cycles. No connection to galaxy-scale phenomena, near-field cosmology, or any of the core topics.
...
## 71. [Monitoring the upper atmospheric temperature and interplanetary magnetic field with the GRAPES-3 muon telescope](https://arxiv.org/abs/2602.11847) <a id="link71"></a>
...
**Comment:** Monitors upper atmospheric temperature and interplanetary magnetic field using cosmic ray variations. Focus is on solar and heliospheric phenomena, not galaxy-scale or near-field cosmology topics.
