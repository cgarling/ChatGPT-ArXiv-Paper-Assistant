...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 40067    | 6411         | 46478   |
| **Cost**             | $0.08    | $0.05        | $0.13   |

Total arXiv papers: 153
...
1. [Comparison of MOND and Verlinde's emergent gravity in dwarf spheroidals](#user-content-link1)
**Authors:** Youngsub Yoon, Sanghyeon Han, Ho Seong Hwang

2. [MARVELously Dark: the gravothermal evolution of dwarf halos in velocity-dependent SIDM](#user-content-link2)
...
3. [Older Ages for 23 Pre-Main Sequence Stars in Upper Scorpius Using Dynamical Mass-Constrained Stellar Evolutionary Models](#user-content-link3)
**Authors:** Allison P. M. Towner, Joshua A. Eisner, Patrick D. Sheehan, Lynne D. Hillenbrand, Ya-Lin Wu

4. [The LBT $Y_{\rm p}$ Project II: MODS Spectra, Physical Conditions, and Oxygen Abundances in Local Metal-Poor Nebulae](#user-content-link4)
...
5. [Contrastive Learning of Extragalactic Stellar Streams: Sculpting a Latent Space of Representations with DES DR2 Photometry](#user-content-link5)
**Authors:** Ernesto Benitez-Walz, Jelle Mes, Juan Mir\'o-Carretero, Koen Kuijken, Amina Helmi

6. [Subsolar mass black holes from stellar collapse induced by primordial black holes](#user-content-link6)
**Authors:** Thomas W. Baumgarte, Stuart L. Shapiro

7. [The GECKOS Survey: Extraplanar ionised gas in star-forming galaxies from eDIG to galaxy-scale winds](#user-content-link7)
...
8. [Statistical study for binary star evolution in dense embedded clusters](#user-content-link8)
**Authors:** Wenjie Wu, Pavel Kroupa, Vikrant V. Jadhav

9. [Apsidal motion and TESS light curves of two southern eclipsing binaries with high eccentricity: V1647 Sgr and V2283 Sgr](#user-content-link9)
**Authors:** Marek Wolf, Petr Zasche, Miloslav Zejda, Martin Ma\v{s}ek

10. [Little Red Dots on FIRE: The Ability of Bursty Galaxies to Host an Abundant Population of High-Redshift AGN](#user-content-link10)
**Authors:** Andrew Marszewski, Claude-Andr\'e Faucher-Gigu\`ere, Guochao Sun, Daniel Angl\'es-Alc\'azar, Robert Feldmann, Kung-Yi Su, Tim B. Miller, Niranjan Chandra Roy

11. [The accretion-ejection connection in the asymmetric Th 28 jet revealed by MUSE-NFM](#user-content-link11)
**Authors:** A. Murphy (Academia Sinica Institute of Astronomy and Astrophysics), E. T. Whelan (Maynooth University), F. Bacciotti (INAF-Osservatorio Astrofisico di Arcetri), A. Kirwan (University College Dublin), D. Coffey (University College Dublin), M. Birney (ESO), J. Eisl\"offel (Th\"uringer Landessternwarte), H. Takami (Academia Sinica Institute of Astronomy and Astrophysics)

12. [Insights into the Physical Nature of Polar Ring Galaxies from H I Observations](#user-content-link12)
**Authors:** Niankun Yu, Han Zheng, Chao-Wei Tsai, Pei Zuo, Luis C. Ho, Amelie Saintonge, Zheng Zheng, Nathan Deg, Ningyu Tang, Xin Ai, Junzhi Wang, Xiang Jie, Di Li

13. [MAGAZ3NE: Dust Deficiency in Ultramassive Quiescent Galaxies at $3<z<4$ with ALMA Observations](#user-content-link13)
**Authors:** Wenjun Chang, Gillian Wilson, Ben Forrest, Ian McConachie, Allison Noble, Adam Muzzin, Danilo Marchesini, Michael C. Cooper, Tracy Webb, Gabriela Canalizo, Percy L. Gomez, Yongda Zhu, Adit Edward, Han Lei, Aur\'elien Henry, Stephanie M. Urbano Stawinski, Marie E. Wisz

14. [Probing Star-Forming Properties via ALMA Observations of Massive Protocluster IRAS 15596-5301](#user-content-link14)
...
15. [Physically-motivated priors in the local distance ladder significantly reduce the Hubble tension](#user-content-link15)
**Authors:** Marcus H\"og{\aa}s, Edvard M\"ortsell

16. [Distinguishing the nature of dark matter by mapping cosmic filaments from Lyman-alpha emission](#user-content-link16)
**Authors:** Yizhou Liu, Liang Gao, Shihong Liao, Kai Zhu, Yingjie Jing, Huijie Hu

17. [The LBT $Y_{\rm p}$ Project III: LUCI Spectra of Metal-Poor Nebulae](#user-content-link17)
**Authors:** Miqaela K. Weller, Richard W. Pogge, Evan D. Skillman, Erik Aver, Noah S. J. Rogers, Danielle A. Berg, John J. Salzer, John H. Miller Jr., Jayde Spiegel

18. [The LBT $Y_{\rm p}$ Project I: An Improved Determination of the Primordial Helium Abundance -- Project Description, Sample Selection, Observations, and Methodology](#user-content-link18)
**Authors:** Evan D. Skillman, Richard W. Pogge, Erik Aver, Noah S. J. Rogers, Miqaela K. Weller, Keith A. Olive, Danielle A. Berg, John J. Salzer, John H. Miller Jr, Jayde Spiegel, Tsung-Han Yeh, Brian D. Fields

19. [The LBT Y$_\mathrm{p}$ Project IV: A New Value of the Primordial Helium Abundance](#user-content-link19)
**Authors:** Erik Aver, Evan D. Skillman, Richard W. Pogge, Noah S. J. Rogers, Miqaela K. Weller, Keith A. Olive, Danielle A. Berg, John J. Salzer, John H. Miller Jr., Jos\'e Eduardo M\'endez-Delgado

20. [Detection of an Extremely Luminous Radio Counterpart to the Be/X-ray Binary A0538-66](#user-content-link20)
...
21. [The size-velocity dispersion relationship of Galactic HII regions](#user-content-link21)
...
22. [Drifters on the edge of town: $\lambda$ Bo\"otis stars in clusters](#user-content-link22)
**Authors:** Richard J. Parker (University of Sheffield, UK), Megan Allen (University of Sheffield, UK)

23. [Isotropic Equivalence of STVG--MOG and $\Lambda$CDM and Its Breakdown in Large--Scale Anisotropic Cosmological Observables](#user-content-link23)
**Authors:** John W. Moffat

24. [A unified framework for hot accretion flows with finite angular momentum: from Bondi-like to disc-like regimes](#user-content-link24)
**Authors:** Cheng-Liang Jiao, Liying Zhu, Er-gang Zhao, Xiang-dong Shi

25. [Mapping dark matter in the Bullet Cluster using JWST imaging and spectroscopy](#user-content-link25)
**Authors:** Gregor Rihtar\v{s}i\v{c}, Maru\v{s}a Brada\v{c}, Guillaume Desprez, Anishya Harshan, Nicholas S. Martis, Chris J. Willott, Yoshihisa Asada, Ghassan T. E. Sarrouh, Carla Cornil-Baiotto, Andrea Biviano, Douglas Clowe, Anthony H. Gonzalez, Christine Jones, Jon Jude\v{z}, Stacy Y. Kim, Marco Lombardi, Danilo Marchesini, Maxim Markevitch, Vladan Markov, Ga\"el Noirot, Annika H. G. Peter, Scott W. Randall, Andrew Robertson, Marcin Sawicki, Roberta Tripodi

26. [The LBT $Y_{\rm p}$ Project V: Cosmological Implications of a New Determination of Primordial $^4$He](#user-content-link26)
**Authors:** Tsung-Han Yeh, Keith A. Olive, Brian D. Fields, Erik Aver, Richard W. Pogge, Noah S. J. Rogers, Evan D. Skillman, Miqaela K. Weller

27. [Axions on a Hyperbolic Ride: Geometric Suppression of CMB Isocurvature and a Blue-Tilted Spectrum](#user-content-link27)
**Authors:** Sai Chaitanya Tadepalli

28. [Rediscussion of eclipsing binaries. Paper XXVIII. The metallic-lined system DV Bootes](#user-content-link28)
**Authors:** John Southworth

29. [Fast, dust-poor outflows in the local candidate dual AGN MCG-03-34-64 observed with VLT/ERIS](#user-content-link29)
**Authors:** I. Lamperti, F. Mannucci, E. Bertola, A. Marconi, G. Cresci, E. Nardini, Q. D'Amato, M. Perna, A. Rojas-Lilay\'u, C. Bracci, V. Braito, E. Cataldi, M. Ceci, A. Chakraborty, C. Cicone, A. De Rosa, A. Feltre, M. Ginolfi, E. Lusso, C. Marconcini, B. Moreschini, E. Portaluri, K. Rubinur, M. Scialpi, P. Severgnini, G. Tozzi, A. Trindade Falc\~ao, L. Ulivi, G. Venturi, C. Vignali, M. V. Zanchettin

30. [Seeds of supermassive black holes in general relativistic and alternative cosmologies: Implications of massive seeds](#user-content-link30)
**Authors:** Nirmali Das, Sanjeev Kalita, Ankita Kakati

31. [Observational Implications of Cosmic Ray-Inverse Compton 'Boosted' Cool Cores in Clusters](#user-content-link31)
**Authors:** Philip F. Hopkins, Emily Silich, Jack Sayers, Sam B. Ponnada, Isabel Sands

32. [Tensions in Cosmology: Interpreting Them Through Inhomogeneous Models](#user-content-link32)
**Authors:** Valerio Marra

33. [The Perpendicularity of Dust Lanes and Radio Jets in Early-Type Galaxies: Implications for AGN Feedback](#user-content-link33)
**Authors:** Emma Jane Weller, Pieter van Dokkum

34. [Linear perturbation theory and structure formation in a Brans-Dicke theory of gravity without dark matter](#user-content-link34)
**Authors:** Lorenzo Gervani, Antonaldo Diaferio, Francesco Pace, Andrea Pierfrancesco Sanna

35. [When inflationary perturbations refuse to classicalise: the role of non-Gaussianity in Wigner negativity](#user-content-link35)
**Authors:** Aurora Ireland, Vincent Vennin

36. [The Bondi universe: How negative mass drives the cosmological expansion](#user-content-link36)
**Authors:** Giovanni Manfredi, Jean-Louis Rouet, Bruce Miller

37. [Physical origin of very-high-energy gamma rays from the low-luminosity active galactic nucleus NGC 4278 and implications for neutrino observations](#user-content-link37)
**Authors:** Shilong Chen, Abhishek Das, B. Theodore Zhang, Shigeo S. Kimura, Kohta Murase, Yunfeng Liang

38. [Too many or too massive? Investigating the high-$z$ demography of active SMBHs from JWST](#user-content-link38)
...
39. [Denoising the Deep Sky: Physics-Based CCD Noise Formation for Astronomical Imaging](#user-content-link39)
**Authors:** Shuhong Liu, Xining Ge, Ziying Gu, Lin Gu, Ziteng Cui, Xuangeng Chu, Jun Liu, Dong Li, Tatsuya Harada

40. [Constructing a gravitational wave analysis pipeline for extremely large mass ratio inspirals](#user-content-link40)
**Authors:** Tian-Xiao Wang, Yan Wang, Alejandro Torres-Orjuela, Yi-Ren Lin, Hui-Min Fan, Ver\'onica V\'azquez-Aceves, Yi-Ming Hu

41. [Quantifying the C/O ratio in the planet-forming environments around very-low-mass stars](#user-content-link41)
**Authors:** Javiera K. D\'iaz-Berr\'ios, Catherine Walsh, Ewine F. van Dishoeck

42. [On the dynamics of magnetoviscous warped discs around compact objects](#user-content-link42)
**Authors:** Arthur G. Suvorov, Kostas Glampedakis

43. [Rotational Spectroscopy as a Tool to Study Vibration-Rotation Interaction: Investigations of $^{13}$CH$_3$CN and CH$_3$$^{13}$CN up to $v_8 = 2$ and a Search for $v_8 = 2$ Transitions toward Sagittarius B2(N)](#user-content-link43)
**Authors:** Holger S. P. M\"uller, Arnaud Belloche, Frank Lewen, Stephan Schlemmer

44. [Warps survive beyond fly-by encounters in protoplanetary disks. RW Aur A as a case study](#user-content-link44)
**Authors:** C. N. Kimmig, P. Weber, G. P. Rosotti, S. Facchini, C. P. Dullemond

45. [Evolution of Supermassive Black Hole Pairs on Inclined Orbits in Post-Merger Galaxies](#user-content-link45)
**Authors:** Sena Ghobadi, David Ballantyne, Tamara Bogdanovic

46. [G183: An outer galaxy filament feeding a massive protostar](#user-content-link46)
...
47. [The Little Blue and Red Dots Rosetta Stones: Non-Gaussian broad lines, hot dust, and X-ray weakness](#user-content-link47)
**Authors:** M. Brazzini, F. D'Eugenio, R. Maiolino, J. Lyu, C. DeCoursey, H. \"Ubler, X. Ji, I. Juod\v{z}balis, J. Scholtz, G. C. Jones, K. Hainline, E. Dalla Bont\`a, P. G. P \'erez-Gonz\'alez, S. Geris, A. Harshan, C. Feruglio, M. Bischetti, G. Mazzolari, G. Rieke, S. Alberts, B. Trefoloni, S. Carniani, E. Parlanti, A. Marconi, G. Risaliti, C. Ramos Almeida, P. Rinaldi, M. Perna, S. Zamora, I. Lamperti, G. Venturi, G. Cresci, Andrew J. Bunker, L. R. Ivey

48. [Obscured AGN at z < 1.5: X-ray to Far-Infrared SEDs and Host Galaxy Morphologies in the GOODS Fields](#user-content-link48)
**Authors:** William W. H. Jarvis (University of Massachusetts - Amherst, University of Wisconsin - Madison), Connor Auge (Eureka Scientific, University of Hawai'i), David Sanders (University of Hawai'i), Xuheng Ding (Wuhan University), Jeana Kim-Bolt (Northwestern University), C. Megan Urry (Yale University), Eric Hooper (University of Wisconsin - Madison), Alessandro Peca (Eureka Scientific, Yale University), Aritra Ghosh (University of Washington), Chuan Tian (Yale University), Tonima T. Ananna (Wayne State University), Md Mahmudunnobe (Wayne State University, Independent University - Bangladesh)

49. [How isotropic is dark energy?](#user-content-link49)
**Authors:** Richard A. Battye, Adam Moss

50. [Unveiling BLR Structure in AGN with High Resolution X-Ray Spectra: An Analytic Approach to Wind Emission Line Profiles](#user-content-link50)
**Authors:** Scott Hagen (IFPU), Chris Done (Durham-CEA), Gabriele A. Matzeu (ESA-ESAC), Hirofumi Noda (Tohoku University)

51. [The SPIRou Legacy Survey: Detection of a nearby world orbiting in the habitable zone of Gl725B achieved by correcting strong telluric contamination in near-infrared radial velocities with WAPITI](#user-content-link51)
**Authors:** M. Ould-Elhkim, C. Moutou, J. -F. Donati, P. Cort\'es-Zuleta, X. Delfosse, \'E. Artigau, C. Cadieux, P. Charpentier, A. Carmona, I. Boisse, C. Reyl\'e, E. Gaidos, R. Cloutier, G. H\'ebrard, L. Arnold, J. -D. do Nascimento Jr., N. J. Cook, R. Doyon

52. [PDRs4All: XVIII. The evolution of the PAH ionisation and PAH size distribution across the Orion Bar](#user-content-link52)
**Authors:** Alexandros Maragkoudakis, Christiaan Boersma, Els Peeters, Louis J. Allamandola, Pasquale Temi, Vincent J. Esposito, Jesse D. Bregman, Alessandra Ricca, Felipe Alarc\'on, Olivier Bern\'e, Mridusmita Buragohain, Jan Cami, Am\'elie Canin, Ryan Chown, Emmanuel Dartois, Asunci\'on Fuente, Javier R. Goicoechea, Emilie Habart, Olga Kannavou, Baria Khan, Thomas S. -Y. Lai, Takashi Onaka, Dries Van De Putte, Ilane Schroetter, Ameek Sidhu, Alexander G. G. M. Tielens, Boris Trahin, Yong Zhang

53. [Exact black holes and black branes with bumpy horizons supported by superfluid pions](#user-content-link53)
**Authors:** Fabrizio Canfora, Andr\'es Gomberoff, Carla Henr\'iquez-Baez, Aldo Vera

54. [A Maximum Entropy Conjecture for Black Hole Mergers](#user-content-link54)
**Authors:** Monica Rincon-Ramirez, Nathan K. Johnson-McDaniel, Eugenio Bianchi, Ish Gupta, Vaishak Prasad, B. S. Sathyaprakash

55. [Operational Solar Flare Forecasting System Using an Explainable Large Language Model](#user-content-link55)
...
56. [SED and Galactic kinematic diagnostics for dormant BH/NS binary candidates](#user-content-link56)
**Authors:** Qian-Yu An, Wei-Min Gu

57. [Prediction of multi-wavelength emissions associated with X-ray flare and extended emission of GRBs](#user-content-link57)
**Authors:** Riki Matsui, Shigeo S. Kimura, Kohta Murase, Bing Theodore Zhang

58. [QSOFEED: Investigating warm molecular, low- and high-ionization atomic gas in six type-2 quasars with GTC/EMIR](#user-content-link58)
...
59. [X-Ray Analysis of an Off-Axis Merger Stage Binary Galaxy Cluster: PSZ2 G279.79+39.09](#user-content-link59)
**Authors:** Sibel D\"oner, Turgay Caglar, Krista L. Smith, Serap Ak, Andrea Botteon, M. Kiyami Erdim, John A. ZuHone

60. [X-ray Spectroscopy of Disk Winds in Black Hole X-ray Binaries](#user-content-link60)
**Authors:** Megumi Shidatsu, Maxime Parra

61. [HEP digital micromirror devices for precision solar spectroscopy](#user-content-link61)
**Authors:** Christian Robles, Suvrath Mahadevan

62. [Stereoscopic Observations of Solar X-ray Sources Explained by a Data-Constrained Magnetohydrodynamic Simulation](#user-content-link62)
**Authors:** Keitarou Matsumoto, Satoshi Inoue, Meiqi Wang, S\"am Krucker, Satoshi Masuda, Muriel Zo\"e Stiefel, Jeongwoo Lee, Bin Chen, Haimin Wang

63. [Equatorially Asymmetric Magnetic Fields and Their Impact on Black Hole Accretion Dynamics](#user-content-link63)
**Authors:** Ishika Palit, Indu Kalpa Dihingia, Yosuke Mizuno, Hsiang-Yi Karen Yang

64. [High energy neutrinos from pulsar-powered optical transients: LFBOTs as potential origin of the KM3NeT event KM3-230213A](#user-content-link64)
**Authors:** Mainak Mukhopadhyay, Shigeo S. Kimura

65. [Editorial: Mass and Angular Momentum Transport of Rapidly Rotating Hot Stars](#user-content-link65)
**Authors:** P. A. Scowen, Carol E. Jones, Ren\'e D. Oudmaijer, Jamie Lomax, Jeremy J. Drake

66. [Approximation of the reception coefficients of cosmic rays neutron component for latitude measurement](#user-content-link66)
**Authors:** Kobelev P. G., Yanke V. G

67. [Sunspot simulations with MURaM -- I. Parameter study using potential field initial conditions](#user-content-link67)
**Authors:** Markus Schmassmann (Institut f\"ur Sonnenphysik), Nazaret Bello Gonz\'alez (Institut f\"ur Sonnenphysik), Rolf Schlichenmaier (Institut f\"ur Sonnenphysik), Jan Jur\v{c}\'ak (Astronomical Institute of the Czech Academy of Sciences, Ond\v{r}ejov)

68. [Ultra-High Energy Cosmic Rays from the Galactic Center](#user-content-link68)
**Authors:** V. N. Zirakashvili, S. I. Rogovaya

69. [Millimeter and submillimeter spectroscopy of methylallene, CH$_3$CHCCH$_2$](#user-content-link69)
**Authors:** Holger S. P. M\"uller, Frank Lewen, Jean-Claude Guillemin, Stephan Schlemmer

70. [Ground Level Enhancement (GLE#77) in the gamma-ray component: First observation from Arctic and Antarctic stations](#user-content-link70)
**Authors:** Pranali Thakur, Geeta Vichare, Selvaraj Chelliah

71. [Testing the Association of Supermassive Black Hole Infrared Flares and High-energy Neutrinos](#user-content-link71)
**Authors:** Megan Wang, Christos Panagiotou, Kishalay De, Erin Kara, Megan Masterson, Foteini Oikonomou

72. [A Formation Crisis of Repeating Partial Tidal Disruption Events](#user-content-link72)
**Authors:** Zhen Pan, Dong Lai

73. [Human versus Artificial Inteligence; a significant example in astrophysics, alas](#user-content-link73)
**Authors:** A. De R\'ujula

74. [Conversion Layer Controls the Evolution of Magnetic Deflections Near the Alfven Surface](#user-content-link74)
...
75. [High-bandwidth frequency domain multiplexed readout of transition-edge sensors for neutrinoless double beta decay searches](#user-content-link75)
**Authors:** M. Adami\v{c} (McGill, LBNL), M. Beretta (UCB, INFN), J. Camilleri (LBNL, Virginia Tech), C. Capelli (LBNL, Zurich U.), M. A. Dobbs (McGill), T. Elleflot (LBNL), B. K. Fujikawa (LBNL), Yu. G. Kolomensky (LBNL, UCB), D. Mayer (MIT), J. Montgomery (McGill), V. Novosad (ANL), A. M. Sindhwad (UCB), V. Singh (UCB), G. Smecher (t0.technology), A. Suzuki (LBNL), B. Welliver (UCB)

76. [The Simons Observatory: On-sky performance of radio-transparent multi-layer insulation (RT-MLI) using Styroace-II Styrofoam](#user-content-link76)
**Authors:** Samuel Day-Weiss, Nicholas Galitzki, Atsuto Takeuchi, Kam Arnold, Kathleen Harrington, Masaya Hasegawa, Bradley R. Johnson, Akito Kusaka, Aashrita Mangu, Jack Orlowski-Scherer, Lyman A. Page, Yoshinori Sueno, Osamu Tajima, Alex Thomas, Yuhan Wang, Edward J. Wollack, Kyohei Yamada

77. [Nonlocal Corrections to Scalar Field Effective Action in de Sitter spacetime](#user-content-link77)
**Authors:** Will Cerne, Teruaki Suyama

---

## 1. [Comparison of MOND and Verlinde's emergent gravity in dwarf spheroidals](https://arxiv.org/abs/2601.01715) <a id="link1"></a>
...
**Comment:** Directly matches the 'Near-Field Cosmology' criterion: the paper compares MOND and Verlinde's emergent gravity in 23 dwarf spheroidal galaxies, focusing on their radial accelerations. Dwarf spheroidals are a key topic, and the work is observationally driven with theoretical implications.
...
## 2. [MARVELously Dark: the gravothermal evolution of dwarf halos in velocity-dependent SIDM](https://arxiv.org/abs/2601.23264) <a id="link2"></a>
...
**Comment:** Presents new cosmological simulations of dwarf halos with velocity-dependent self-interacting dark matter, analyzing core-cusp and core-collapse phenomena. This is highly relevant for near-field cosmology, dark matter density profiles, and numerical galaxy simulations.
...
## 3. [Older Ages for 23 Pre-Main Sequence Stars in Upper Scorpius Using Dynamical Mass-Constrained Stellar Evolutionary Models](https://arxiv.org/abs/2601.22423) <a id="link3"></a>
...
**Comment:** Presents new constraints on pre-main sequence stellar evolutionary models using dynamical masses. Directly relevant to the 'Stellar Models' criterion, as it tests and compares different stellar evolutionary tracks and the impact of magnetic fields.
...
## 4. [The LBT $Y_{\rm p}$ Project II: MODS Spectra, Physical Conditions, and Oxygen Abundances in Local Metal-Poor Nebulae](https://arxiv.org/abs/2601.22236) <a id="link4"></a>
...
**Comment:** Presents deep spectroscopy of 62 low-metallicity galaxies to measure He and O abundances, with implications for primordial He mass fraction and ISM abundance patterns. The sample consists of low-metallicity galaxies, which are often dwarfs, and the work provides new measurements of ISM properties. This is highly relevant to near-field cosmology and chemical evolution in dwarf galaxies.
...
## 5. [Contrastive Learning of Extragalactic Stellar Streams: Sculpting a Latent Space of Representations with DES DR2 Photometry](https://arxiv.org/abs/2601.23013) <a id="link5"></a>
...
**Comment:** This paper uses contrastive learning to characterize low surface brightness tidal features (including stellar streams) in wide-field imaging data. The focus on extragalactic stellar streams and faint tidal substructure is highly relevant to near-field cosmology and the study of accreted stellar halos and substructure.
...
## 6. [Subsolar mass black holes from stellar collapse induced by primordial black holes](https://arxiv.org/abs/2601.22220) <a id="link6"></a>
...
**Comment:** Explores the formation of subsolar mass black holes via primordial black holes consuming dwarf stars, with a focus on dwarf galaxies. This directly matches the near-field cosmology criterion, especially regarding black holes in dwarf galaxies and their origins.
...
## 7. [The GECKOS Survey: Extraplanar ionised gas in star-forming galaxies from eDIG to galaxy-scale winds](https://arxiv.org/abs/2601.22500) <a id="link7"></a>
...
**Comment:** Directly matches the 'Star Formation Driven Outflows' criterion: the paper maps extraplanar ionized gas in star-forming galaxies, discusses outflows, mass-loading, and the connection to feedback and the circumgalactic medium. The sample is Milky Way-mass galaxies, so not dwarfs, but the focus on outflows and CGM is highly relevant.
...
## 9. [Apsidal motion and TESS light curves of two southern eclipsing binaries with high eccentricity: V1647 Sgr and V2283 Sgr](https://arxiv.org/abs/2601.22715) <a id="link9"></a>
...
**Comment:** Analyzes apsidal motion and light curves of two eccentric eclipsing binaries, improving stellar parameters and internal structure constants. This is relevant to stellar models, as it provides observational constraints on stellar structure and evolution.
...
## 10. [Little Red Dots on FIRE: The Ability of Bursty Galaxies to Host an Abundant Population of High-Redshift AGN](https://arxiv.org/abs/2601.22213) <a id="link10"></a>
...
**Comment:** Analyzes high-redshift AGN in low-mass galaxies using FIRE-2 simulations. While the focus is on AGN, the host galaxies are low-mass and the work uses high-resolution galaxy simulations. Some relevance to 'Numerical Galaxy Simulations' and possibly to 'Near-Field Cosmology' due to the focus on low-mass galaxies and their black holes, but not directly on satellite galaxies or resolved star formation histories.
...
## 11. [The accretion-ejection connection in the asymmetric Th 28 jet revealed by MUSE-NFM](https://arxiv.org/abs/2601.22658) <a id="link11"></a>
...
**Comment:** Studies accretion and ejection in the jet of a Classical T Tauri Star, focusing on mass outflow rates and episodic ejections. This is relevant to star formation driven outflows, but the context is a protostellar jet, not galaxy-scale outflows or dwarf galaxies.
...
## 12. [Insights into the Physical Nature of Polar Ring Galaxies from H I Observations](https://arxiv.org/abs/2601.22222) <a id="link12"></a>
...
**Comment:** This paper studies polar ring galaxies, focusing on H I observations, gas accretion, and kinematics. While it discusses quenching and gas accretion, the galaxies are not dwarfs and the main focus is on peculiar gas dynamics and formation mechanisms of PRGs, which are not core topics.
...
## 13. [MAGAZ3NE: Dust Deficiency in Ultramassive Quiescent Galaxies at $3<z<4$ with ALMA Observations](https://arxiv.org/abs/2601.22844) <a id="link13"></a>
...
**Comment:** ALMA observations of ultramassive quiescent galaxies at z>3, focusing on dust deficiency and quenching. While it discusses quenching, the galaxies are ultramassive and at high redshift, not dwarfs. Some relevance for quenching processes, but weighted lower due to galaxy mass.
...
## 14. [Probing Star-Forming Properties via ALMA Observations of Massive Protocluster IRAS 15596-5301](https://arxiv.org/abs/2601.22618) <a id="link14"></a>
...
**Comment:** The paper studies star formation triggered by filament collisions in a massive protocluster using ALMA data. While it discusses star formation processes, the focus is on a massive protocluster rather than dwarf galaxies or resolved star formation histories from color-magnitude diagrams. It does not address quenching, outflows, or CGM in dwarfs.
...
## 15. [Physically-motivated priors in the local distance ladder significantly reduce the Hubble tension](https://arxiv.org/abs/2601.22215) <a id="link15"></a>
...
**Comment:** Addresses the Hubble tension by recalibrating the local distance ladder with physically motivated priors. While it discusses Cepheid distances (which are relevant to stellar models and distance calibration), the focus is on cosmological parameters and not on the core topics of near-field cosmology, resolved SFHs, or dwarf galaxies.
...
## 17. [The LBT $Y_{\rm p}$ Project III: LUCI Spectra of Metal-Poor Nebulae](https://arxiv.org/abs/2601.22237) <a id="link17"></a>
...
**Comment:** Presents new near-IR spectra of metal-poor nebulae to improve helium abundance measurements, relevant for primordial nucleosynthesis. While important for cosmology, it does not directly address near-field cosmology, dwarf galaxies, or resolved star formation histories.
...
## 18. [The LBT $Y_{\rm p}$ Project I: An Improved Determination of the Primordial Helium Abundance -- Project Description, Sample Selection, Observations, and Methodology](https://arxiv.org/abs/2601.22232) <a id="link18"></a>
...
**Comment:** Describes a project to improve the determination of the primordial helium abundance using observations of low-metallicity HII regions. While important for cosmology, it does not directly address near-field cosmology, dwarf galaxies, or resolved star formation histories.
...
## 19. [The LBT Y$_\mathrm{p}$ Project IV: A New Value of the Primordial Helium Abundance](https://arxiv.org/abs/2601.22238) <a id="link19"></a>
...
**Comment:** This paper presents a new, precise measurement of the primordial helium abundance using metal-poor H II regions. While it is important for cosmology, it does not directly address near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on chemical abundances rather than galaxy properties or evolution.
...
## 20. [Detection of an Extremely Luminous Radio Counterpart to the Be/X-ray Binary A0538-66](https://arxiv.org/abs/2601.22741) <a id="link20"></a>
...
**Comment:** Reports the discovery of radio emission from a Be/X-ray binary in the LMC. While the LMC is a relevant environment, the focus is on a high-mass X-ray binary and its radio properties, not on dwarf galaxy populations, star formation histories, or quenching.
...
## 24. [A unified framework for hot accretion flows with finite angular momentum: from Bondi-like to disc-like regimes](https://arxiv.org/abs/2601.22726) <a id="link24"></a>
...
**Comment:** Develops a unified framework for hot accretion flows with finite angular momentum, connecting Bondi-like and disc-like regimes. The focus is on accretion physics in elliptical galaxies and supermassive black holes, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 25. [Mapping dark matter in the Bullet Cluster using JWST imaging and spectroscopy](https://arxiv.org/abs/2601.22245) <a id="link25"></a>
...
**Comment:** This paper presents a gravitational lens model of the Bullet Cluster using JWST data. While it involves dark matter mapping, it focuses on a massive galaxy cluster, not dwarf galaxies or near-field cosmology. No direct relevance to the core topics.
...
## 26. [The LBT $Y_{\rm p}$ Project V: Cosmological Implications of a New Determination of Primordial $^4$He](https://arxiv.org/abs/2601.22239) <a id="link26"></a>
...
**Comment:** This paper presents a new measurement of primordial $^4$He and discusses cosmological implications for big-bang nucleosynthesis and the cosmic microwave background. While it is foundational for cosmology, it does not directly address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other core topics.
...
## 27. [Axions on a Hyperbolic Ride: Geometric Suppression of CMB Isocurvature and a Blue-Tilted Spectrum](https://arxiv.org/abs/2601.22221) <a id="link27"></a>
...
**Comment:** Discusses axion field-space geometry and CMB isocurvature constraints, with implications for dark matter models. However, the focus is on early universe physics and axion cosmology, not on near-field cosmology or galaxy-scale phenomena.
...
## 28. [Rediscussion of eclipsing binaries. Paper XXVIII. The metallic-lined system DV Bootes](https://arxiv.org/abs/2601.23145) <a id="link28"></a>
...
**Comment:** The paper studies an eclipsing binary system and compares its properties to stellar models. While it touches on stellar models, it does not present new evolutionary tracks or atmosphere models, nor does it provide new bolometric corrections. The focus is on a specific binary system, not general stellar modeling.
...
## 29. [Fast, dust-poor outflows in the local candidate dual AGN MCG-03-34-64 observed with VLT/ERIS](https://arxiv.org/abs/2601.22254) <a id="link29"></a>
...
**Comment:** Focuses on fast outflows in a dual AGN system, but the outflows are AGN-driven rather than star-formation-driven. No direct connection to dwarf galaxies, resolved star formation histories, or CGM. Outflow phase structure is discussed, but relevance is low due to AGN focus.
...
## 30. [Seeds of supermassive black holes in general relativistic and alternative cosmologies: Implications of massive seeds](https://arxiv.org/abs/2601.22991) <a id="link30"></a>
...
**Comment:** Discusses the formation and growth of supermassive black holes in various cosmologies, including primordial black holes and their contribution to dark matter. While it touches on cosmology and dark matter, it does not focus on near-field cosmology, dwarf galaxies, or any of the other core topics.
...
## 31. [Observational Implications of Cosmic Ray-Inverse Compton 'Boosted' Cool Cores in Clusters](https://arxiv.org/abs/2601.22229) <a id="link31"></a>
...
**Comment:** Discusses cosmic ray-inverse Compton emission in cool-core galaxy clusters, with implications for cluster X-ray and radio properties. While it touches on cluster astrophysics and non-thermal processes, it does not address dwarf galaxies, near-field cosmology, or star formation histories.
...
## 33. [The Perpendicularity of Dust Lanes and Radio Jets in Early-Type Galaxies: Implications for AGN Feedback](https://arxiv.org/abs/2601.22217) <a id="link33"></a>
...
**Comment:** Studies the orientation of dust lanes and radio jets in early-type galaxies, with implications for AGN feedback and quiescence in massive galaxies. The focus is on AGN and massive galaxies, not on dwarf galaxies, resolved SFHs, or galaxy simulations.
...
## 34. [Linear perturbation theory and structure formation in a Brans-Dicke theory of gravity without dark matter](https://arxiv.org/abs/2601.22937) <a id="link34"></a>
...
**Comment:** Investigates structure formation in a Brans-Dicke gravity theory without dark matter, focusing on large-scale structure and cosmic expansion. The work is on cosmological theory and structure formation, not on near-field cosmology, resolved SFHs, or galaxy simulations.
...
## 35. [When inflationary perturbations refuse to classicalise: the role of non-Gaussianity in Wigner negativity](https://arxiv.org/abs/2601.22219) <a id="link35"></a>
...
**Comment:** Explores quantum signatures in inflationary perturbations and the role of non-Gaussianity. Focus is on early universe cosmology and quantum effects, not on near-field cosmology, galaxy evolution, or any of the core topics.
...
## 36. [The Bondi universe: How negative mass drives the cosmological expansion](https://arxiv.org/abs/2601.22910) <a id="link36"></a>
...
**Comment:** This paper discusses a cosmological model with positive and negative masses and its implications for cosmic expansion, but does not focus on near-field cosmology, dwarf galaxies, resolved star formation histories, or any of the other core topics. It is a theoretical cosmology paper with no direct relevance to the specified criteria.
...
## 37. [Physical origin of very-high-energy gamma rays from the low-luminosity active galactic nucleus NGC 4278 and implications for neutrino observations](https://arxiv.org/abs/2601.23242) <a id="link37"></a>
...
**Comment:** Studies the origin of very-high-energy gamma rays from a low-luminosity AGN, NGC 4278, and implications for neutrino observations. The focus is on AGN physics, not on dwarf galaxies, star formation histories, or any of the core topics.
...
## 39. [Denoising the Deep Sky: Physics-Based CCD Noise Formation for Astronomical Imaging](https://arxiv.org/abs/2601.23276) <a id="link39"></a>
...
**Comment:** Presents a physics-based CCD noise synthesis framework for astronomical imaging. While useful for data analysis, it does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 40. [Constructing a gravitational wave analysis pipeline for extremely large mass ratio inspirals](https://arxiv.org/abs/2601.22464) <a id="link40"></a>
...
**Comment:** Focuses on gravitational wave analysis for extremely large mass ratio inspirals (brown dwarf around SMBH in Galactic center). While it mentions stellar dynamics and strong-field gravity, the focus is on the Galactic center and SMBH, which is outside the near-field cosmology and dwarf galaxy focus. No direct relevance to resolved star formation histories, quenching, stellar models, or galaxy simulations.
...
## 41. [Quantifying the C/O ratio in the planet-forming environments around very-low-mass stars](https://arxiv.org/abs/2601.23069) <a id="link41"></a>
...
**Comment:** Quantifies the C/O ratio in planet-forming disks around very-low-mass stars using chemical kinetics models. Focus is on disk chemistry and planet formation, not on galaxy evolution, star formation histories, or any of the core topics.
...
## 42. [On the dynamics of magnetoviscous warped discs around compact objects](https://arxiv.org/abs/2601.22683) <a id="link42"></a>
...
**Comment:** Reviews warped accretion disk dynamics around compact objects, including magnetic and relativistic effects. Focus is on accretion disks around compact objects, not on galaxy evolution, star formation, or any of the core topics.
...
## 43. [Rotational Spectroscopy as a Tool to Study Vibration-Rotation Interaction: Investigations of $^{13}$CH$_3$CN and CH$_3$$^{13}$CN up to $v_8 = 2$ and a Search for $v_8 = 2$ Transitions toward Sagittarius B2(N)](https://arxiv.org/abs/2601.22824) <a id="link43"></a>
...
**Comment:** Focuses on rotational spectroscopy of methyl cyanide isotopologues in star-forming regions, with searches for transitions in Sagittarius B2(N). This is a molecular spectroscopy paper, not related to any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models.
...
## 44. [Warps survive beyond fly-by encounters in protoplanetary disks. RW Aur A as a case study](https://arxiv.org/abs/2601.22223) <a id="link44"></a>
...
**Comment:** Studies warps in protoplanetary disks due to stellar fly-bys, with a case study of RW Aur A. This is focused on disk dynamics in star formation regions, not galaxies or the core topics.
...
## 45. [Evolution of Supermassive Black Hole Pairs on Inclined Orbits in Post-Merger Galaxies](https://arxiv.org/abs/2601.23260) <a id="link45"></a>
...
**Comment:** Presents a dynamical model for supermassive black hole pairs in post-merger galaxies, focusing on pairing times and orbital inclination. The work is on SMBHs and massive galaxies, not on the core topics.
...
## 46. [G183: An outer galaxy filament feeding a massive protostar](https://arxiv.org/abs/2601.22972) <a id="link46"></a>
...
**Comment:** Presents multi-tracer observations of a 5-pc long outer Galaxy filament and a massive protostar. The study is on star formation in filaments and massive YSOs, not on galaxies or the core topics.
...
## 47. [The Little Blue and Red Dots Rosetta Stones: Non-Gaussian broad lines, hot dust, and X-ray weakness](https://arxiv.org/abs/2601.22214) <a id="link47"></a>
...
**Comment:** Examines AGN populations discovered by JWST, focusing on spectral properties and central engine differences. The work is centered on AGN and their environments, not on dwarf galaxies, resolved star formation histories, quenching, or galaxy simulations. No direct match to any core criteria.
...
## 48. [Obscured AGN at z < 1.5: X-ray to Far-Infrared SEDs and Host Galaxy Morphologies in the GOODS Fields](https://arxiv.org/abs/2601.22227) <a id="link48"></a>
...
**Comment:** Analyzes SEDs and morphologies of X-ray luminous AGN at z < 1.5 in the GOODS fields. The focus is on AGN host galaxies, not on dwarf galaxies, resolved SFHs, or galaxy simulations. No direct match to core criteria.
...
## 49. [How isotropic is dark energy?](https://arxiv.org/abs/2601.22351) <a id="link49"></a>
...
**Comment:** Explores anisotropy in dark energy using cosmological data. The work is on cosmological models and expansion, not on near-field cosmology, resolved SFHs, or galaxy simulations.
...
## 51. [The SPIRou Legacy Survey: Detection of a nearby world orbiting in the habitable zone of Gl725B achieved by correcting strong telluric contamination in near-infrared radial velocities with WAPITI](https://arxiv.org/abs/2601.22815) <a id="link51"></a>
...
**Comment:** Presents the detection of exoplanets around an M dwarf using improved telluric correction methods. This is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 52. [PDRs4All: XVIII. The evolution of the PAH ionisation and PAH size distribution across the Orion Bar](https://arxiv.org/abs/2601.23282) <a id="link52"></a>
...
**Comment:** Studies PAH ionization and size distribution in the Orion Bar using spectral modeling. Focus is on ISM chemistry and PAH evolution, not on galaxy-scale processes, dwarf galaxies, or star formation histories.
...
## 53. [Exact black holes and black branes with bumpy horizons supported by superfluid pions](https://arxiv.org/abs/2601.22914) <a id="link53"></a>
...
**Comment:** Presents exact black hole and black brane solutions with bumpy horizons supported by superfluid pions. The work is theoretical and focused on black hole physics, not galaxy evolution, dwarf galaxies, or star formation.
...
## 54. [A Maximum Entropy Conjecture for Black Hole Mergers](https://arxiv.org/abs/2601.22388) <a id="link54"></a>
...
**Comment:** Proposes a thermodynamic principle for black hole mergers, focusing on entropy maximization. This is a theoretical study in black hole physics, not related to galaxy evolution, dwarf galaxies, or star formation.
...
## 55. [Operational Solar Flare Forecasting System Using an Explainable Large Language Model](https://arxiv.org/abs/2601.22811) <a id="link55"></a>
...
**Comment:** Presents a solar flare forecasting system using a large language model. The focus is on solar physics and machine learning, not on any of the core topics.
...
## 56. [SED and Galactic kinematic diagnostics for dormant BH/NS binary candidates](https://arxiv.org/abs/2601.22490) <a id="link56"></a>
...
**Comment:** Searches for dormant black hole and neutron star binaries using Gaia data and SED fitting. Focus is on compact object binaries, not on galaxy evolution, star formation histories, or any of the core topics.
...
## 57. [Prediction of multi-wavelength emissions associated with X-ray flare and extended emission of GRBs](https://arxiv.org/abs/2601.22749) <a id="link57"></a>
...
**Comment:** Focuses on multi-wavelength emissions from X-ray flares and extended emissions in GRBs. No direct connection to near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The topic is outside the core criteria.
...
## 58. [QSOFEED: Investigating warm molecular, low- and high-ionization atomic gas in six type-2 quasars with GTC/EMIR](https://arxiv.org/abs/2601.22906) <a id="link58"></a>
...
**Comment:** Focuses on outflows in type-2 quasars, but these are AGN-driven outflows in massive galaxies, not star-formation-driven outflows in dwarfs. No direct connection to the relevant criteria.
...
## 59. [X-Ray Analysis of an Off-Axis Merger Stage Binary Galaxy Cluster: PSZ2 G279.79+39.09](https://arxiv.org/abs/2601.22251) <a id="link59"></a>
...
**Comment:** Analyzes a merging binary galaxy cluster using X-ray data. Focus is on cluster-scale dynamics and not on dwarf galaxies, star formation histories, or other core topics.
...
## 60. [X-ray Spectroscopy of Disk Winds in Black Hole X-ray Binaries](https://arxiv.org/abs/2601.22836) <a id="link60"></a>
...
**Comment:** The paper reviews X-ray spectroscopy of disk winds in black hole X-ray binaries, focusing on accretion disk outflows. The outflows discussed are not star-formation-driven and are related to black hole accretion physics, which is outside the core topics.
...
## 61. [HEP digital micromirror devices for precision solar spectroscopy](https://arxiv.org/abs/2601.23176) <a id="link61"></a>
...
**Comment:** Describes a new solar instrument using digital micromirror devices for solar and exoplanetary science. No connection to galaxy evolution, dwarf galaxies, or the core criteria.
...
## 62. [Stereoscopic Observations of Solar X-ray Sources Explained by a Data-Constrained Magnetohydrodynamic Simulation](https://arxiv.org/abs/2601.23046) <a id="link62"></a>
...
**Comment:** This paper is about solar flare particle acceleration and uses MHD simulations, but the topic is solar physics, not galaxy simulations or any of the core criteria.
...
## 63. [Equatorially Asymmetric Magnetic Fields and Their Impact on Black Hole Accretion Dynamics](https://arxiv.org/abs/2601.22894) <a id="link63"></a>
...
**Comment:** Simulates accretion dynamics around spinning black holes with asymmetric magnetic fields. The focus is on black hole accretion disks, not galaxy simulations or the core topics.
...
## 64. [High energy neutrinos from pulsar-powered optical transients: LFBOTs as potential origin of the KM3NeT event KM3-230213A](https://arxiv.org/abs/2601.22266) <a id="link64"></a>
...
**Comment:** Investigates high-energy neutrino production from pulsar-powered optical transients, including supernovae and LFBOTs. The focus is on transient events and neutrino sources, not on galaxies or the core topics.
...
## 65. [Editorial: Mass and Angular Momentum Transport of Rapidly Rotating Hot Stars](https://arxiv.org/abs/2601.22281) <a id="link65"></a>
...
**Comment:** Editorial for a collection on mass and angular momentum transport in rapidly rotating hot stars. While it discusses stellar evolution and rotation, it does not present new stellar models or evolutionary tracks, nor does it focus on galaxy-scale phenomena.
...
## 66. [Approximation of the reception coefficients of cosmic rays neutron component for latitude measurement](https://arxiv.org/abs/2601.22810) <a id="link66"></a>
...
**Comment:** This paper focuses on cosmic ray neutron component measurements for latitude monitoring, which does not match any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The work is more related to cosmic ray physics and geophysical applications.
...
## 68. [Ultra-High Energy Cosmic Rays from the Galactic Center](https://arxiv.org/abs/2601.22747) <a id="link68"></a>
...
**Comment:** Studies ultra-high energy cosmic rays from the Galactic Center, focusing on accretion events and particle acceleration. The focus is on the Galactic Center and cosmic rays, which is explicitly listed as irrelevant.
...
## 69. [Millimeter and submillimeter spectroscopy of methylallene, CH$_3$CHCCH$_2$](https://arxiv.org/abs/2601.22872) <a id="link69"></a>
...
**Comment:** Millimeter and submillimeter spectroscopy of methylallene for astrochemical searches. Focus is on molecular spectroscopy and astrochemistry, not on galaxy evolution, star formation, or any of the core topics.
...
## 70. [Ground Level Enhancement (GLE#77) in the gamma-ray component: First observation from Arctic and Antarctic stations](https://arxiv.org/abs/2601.22807) <a id="link70"></a>
...
**Comment:** Reports ground-level enhancement in gamma-ray component from solar flare events, using polar gamma-ray detectors. Focus is on solar physics and particle events, not on galaxy evolution, star formation, or any of the core topics.
...
## 71. [Testing the Association of Supermassive Black Hole Infrared Flares and High-energy Neutrinos](https://arxiv.org/abs/2601.22309) <a id="link71"></a>
...
**Comment:** Examines the association between supermassive black hole accretion flares and high-energy neutrinos, with a focus on tidal disruption events. TDEs and SMBHs are not relevant to the core topics.
...
## 72. [A Formation Crisis of Repeating Partial Tidal Disruption Events](https://arxiv.org/abs/2601.22465) <a id="link72"></a>
...
**Comment:** Discusses repeating partial tidal disruption events and their formation channels, with implications for hypervelocity stars in the Galactic Center. The focus is on TDEs and SMBHs, which are not relevant to the core topics.
...
## 73. [Human versus Artificial Inteligence; a significant example in astrophysics, alas](https://arxiv.org/abs/2601.23205) <a id="link73"></a>
...
**Comment:** Compares two models of gamma ray bursts using AI. The topic is GRBs, which are not related to any of the core criteria (near-field cosmology, resolved SFHs, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 74. [Conversion Layer Controls the Evolution of Magnetic Deflections Near the Alfven Surface](https://arxiv.org/abs/2601.22321) <a id="link74"></a>
...
**Comment:** Studies magnetic deflections and switchbacks in the solar wind near the Alfven surface. The focus is on solar wind physics, not on galaxies, star formation, or any of the core criteria.
...
## 75. [High-bandwidth frequency domain multiplexed readout of transition-edge sensors for neutrinoless double beta decay searches](https://arxiv.org/abs/2601.23106) <a id="link75"></a>
...
**Comment:** Technical paper on readout systems for transition-edge sensors in neutrinoless double beta decay searches. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 76. [The Simons Observatory: On-sky performance of radio-transparent multi-layer insulation (RT-MLI) using Styroace-II Styrofoam](https://arxiv.org/abs/2601.23168) <a id="link76"></a>
...
**Comment:** Technical report on radio-transparent multi-layer insulation for bolometric detector arrays. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 77. [Nonlocal Corrections to Scalar Field Effective Action in de Sitter spacetime](https://arxiv.org/abs/2601.22644) <a id="link77"></a>
...
**Comment:** This theoretical work investigates quantum corrections to scalar field effective action in de Sitter spacetime, focusing on field theory and cosmological backgrounds. It does not address galaxy formation, star formation histories, or any of the core topics.
