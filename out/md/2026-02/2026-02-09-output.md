...
1. [Dwarf Galaxy Number Counts within 25 Mpc: Predictions from Local Group Analogues in TNG50](#user-content-link1)
**Authors:** Evangela E. Shread, Joanna M. Piotrowska, Daniel R. Weisz, Michael Boylan-Kolchin, Fiona A. Harrison

2. [Dynamic Zoom Simulations of structure formation beyond standard cosmology](#user-content-link2)
**Authors:** Riccardo Zangarelli, Marco Baldi, Federico Marinacci, Enrico Garaldi

3. [ELUCID-DESI I: A Parallel MPI Implementation of the Initial Condition Solver for Large-Scale Reconstruction Simulations](#user-content-link3)
...
4. [A Demonstration of a Neural Network as a Bridge Between Galaxy Simulations and Surveys](#user-content-link4)
**Authors:** E. Elson

5. [Modelling the photometric and morphological evolution of disc galaxies in the cluster environment](#user-content-link5)
**Authors:** A. Marasco, B. M. Poggianti, B. Vulcani, A. Moretti, M. Gullieuszik, J. Fritz

6. [Magnetohydrodynamic instabilities in stellar radiative regions. I. Linear study of shear-driven instabilities](#user-content-link6)
**Authors:** V. Durepaire (LIRA, Observatoire de Paris, Universit\'e PSL, CNRS, Sorbonne Universit\'e, Universit\'e Paris Cit\'e, 5 place Jules Janssen, 92195 Meudon, France), L. Petitdemange (LIRA, Observatoire de Paris, Universit\'e PSL, CNRS, Sorbonne Universit\'e, Universit\'e Paris Cit\'e, 5 place Jules Janssen, 92195 Meudon, France), K. Belkacem (LIRA, Observatoire de Paris, Universit\'e PSL, CNRS, Sorbonne Universit\'e, Universit\'e Paris Cit\'e, 5 place Jules Janssen, 92195 Meudon, France), A. Guseva (Department of Fluid Mechanics, Universitat Polit\`ecnica de Catalunya, BarcelonaTech, LIRA, Observatoire de Paris, Universit\'e PSL, CNRS, Sorbonne Universit\'e, Universit\'e Paris Cit\'e, 5 place Jules Janssen, 92195 Meudon, France), L. Manchon (LIRA, Observatoire de Paris, Universit\'e PSL, CNRS, Sorbonne Universit\'e, Universit\'e Paris Cit\'e, 5 place Jules Janssen, 92195 Meudon, France), R. Hollerbach (School of Mathematics, University of Leeds, Leeds LS2 9JT, UK), F. Daniel (Center for Interdisciplinary Exploration and Research in Astrophysics)

7. [Asteroseismic ages for 17,000 stars in Kepler, K2 and TESS](#user-content-link7)
**Authors:** Emma Willett, Andrea Miglio, Saniya Khan, Yvonne Elsworth, Beno\^it Mosser, Karsten Brogaard, Giada Casali, Cristina Chiappini, Valeria Grisoni, Amalie Stokholm, Diego Bossini, William J. Chaplin

8. [Disk-Regulated Mass Transfer Between Rotating Non-Degenerate Stars: Insights from Be and sdOB Binaries](#user-content-link8)
**Authors:** Zepei Xing, Tassos Fragos, Vicky Kalogera, Seth Gossage, Kyle Akira Rocha, Emmanouil Zapartas

9. [Treecode2: The Power of Pluralism. I. Static Tests](#user-content-link9)
**Authors:** Joshua E. Barnes

10. [Galaxies caught in transition: the role of group environment in shaping the mass-size relation in the local Universe](#user-content-link10)
**Authors:** Gissel P. Montaguth, Claudia Mendes de Oliveira, Ciria Lima-Dias, Antonela Monachesi, Sergio Torres-Flores, Eduardo Telles, F\'abio R. Herpich, Yolanda Jim\'enez-Teja, Antonio Kanaan, Tiago Ribeiro, William Schoenell

11. [Compact HII Regions as Clocks of Massive-Star Formation: Evidence for Long Formation Timescales](#user-content-link11)
**Authors:** Paolo Padoan, Mark Gieles

12. [Real time, cross platform visualizations with zero dependencies for the N-body package REBOUND](#user-content-link12)
**Authors:** Hanno Rein

13. [Correlation Calibration: A Hybrid Calibration Technique for Radio Interferometric Arrays](#user-content-link13)
**Authors:** Robert Pascua, Jonathan Sievers, Adrian Liu

14. [Hypersoft X-ray Sources: A New Class of Luminous Cosmic Emitters](#user-content-link14)
**Authors:** Mustafa Muhibullah, Jimmy A. Irwin, R. Di Stefano

15. [Ne and Fe abundances in the ISM: Archival Study of Fe-L and Ne-K edges in Chandra and XMM-Newton](#user-content-link15)
**Authors:** D. L. Moutard, L. R. Corrales, I. Psaradaki, E. Temple, M. Shi

16. [Primordial Black Hole Abundance from Reionization](#user-content-link16)
**Authors:** Ziwen Yin, Hanyu Cheng, Luca Visinelli

17. [The imprint of AGN-driven outflows on the CGM: the case of Ly{\alpha} nebulae around high-z quasars](#user-content-link17)
...
18. [Primordial Black Hole signatures from femtolensing and spectral fringe of Gamma Ray Bursts](#user-content-link18)
**Authors:** Chang-Yu Dai, Po-Yan Tseng

19. [The Massive and Distant Clusters of WISE Survey 2: Splashback Radii to z=1.65 from Galaxy Density Profiles](#user-content-link19)
**Authors:** Khunanon Thongkham, Anthony H. Gonzalez, Mark Brodwin, Ariane Trudeau, Peter Eisenhardt, S. A. Stanford, Emily Moravec, Thomas Connor, Daniel Stern

20. [The Massive and Distant Clusters of WISE Survey 2: Detection of splashback radii in galaxy cluster total light stacks](#user-content-link20)
**Authors:** A. Trudeau, Anthony H. Gonzalez, K. Thongkham, M. Brodwin, Thomas Connor, Peter R. M. Eisenhardt, Emily Moravec, S. A. Stanford, D. Stern

21. [Revisiting the missing mass problem in MOND for nearby galaxy clusters](#user-content-link21)
**Authors:** Dong Zhang (Bonn), Akram Hasani Zonoozi (Bonn, Zanjan), Pavel Kroupa (Bonn, Prague)

22. [Searching for dark matter signals with high energy astrophysical neutrinos in IceCube](#user-content-link22)
**Authors:** Khushboo Dixit, Gopolang Mohlabeng, Soebur Razzaque

23. [On the Difficulties with Late-Time Solutions for the Hubble Tension](#user-content-link23)
**Authors:** Prakhar Bansal, Dragan Huterer

24. [Dark Matter Heating of Compact Stars Beyond Capture: A Relativistic Framework for Energy Deposition by Particle Beams](#user-content-link24)
**Authors:** Jaime Hoefken Zink, Shihwen Hor, Maura E. Ramirez-Quezada

25. [Bayesian Constraints on the Neutron Star Equation of State with a Smooth Hadron-Quark Crossover](#user-content-link25)
**Authors:** Xavier Grundler, Bao-An Li

26. [Parametric-Resonance Production of QCD Axions](#user-content-link26)
**Authors:** Pirzada, Yu Gao, Qiaoli Yang

27. [Consistency of standard cosmologies using Bayesian model comparison and tension quantification](#user-content-link27)
**Authors:** Lukas Tobias Hergt, Sophie Henrot-Versill\'e, Matthieu Tristram, Douglas Scott

28. [Dilution of accreted planetary matter in hot DA white dwarfs according to their mass](#user-content-link28)
**Authors:** M. Deal, S. Vauclair, S. Charpinet, G. Vauclair

29. [Super-knee cosmic rays from interacting supernovae](#user-content-link29)
**Authors:** Nick Ekanger, Shigeo S. Kimura, Kazumi Kashiyama

30. [Sensipy: simulate gamma-ray observations of transient astrophysical sources](#user-content-link30)
**Authors:** Jarred G. Green, Barbara Patricelli, Antonio Stamerra, Monica Seglar-Arroyo

31. [Studies on the spin and magnetic inclination evolution of magnetars Swift J1834.9-0846 under wind braking](#user-content-link31)
**Authors:** Biaopeng Li, Zhifu Gao, Wenqi Ma, Weifeng Zhang, Quan Cheng, L. C. Garcia de Andrade

32. [Exploring Cosmological Tensions with Hubble Parameter Tomography via Linear Cosmography](#user-content-link32)
**Authors:** Brett Bochner (Hofstra University), Aiden Jin

33. [Mapping plasma properties of Cassiopeia A with XRISM/Resolve: a Bayesian analysis via UltraSPEX](#user-content-link33)
**Authors:** Manan Agarwal, Jacco Vink, Liyi Gu, Paul P. Plucinsky, Aya Bamba, Toshiki Sato, Daniele Rogantini, Yuken Ohshiro

34. [Rotational Behaviour of Exotic Compact Objects](#user-content-link34)
**Authors:** Zakary Buras-Stubbs, Il\'idio Lopes

35. [Non-spherical BUFFALOs: a weak lensing view of the Frontier Field clusters and associated systematics](#user-content-link35)
**Authors:** A. Niemiec, A. Acebron, B. Beauchesne, M. Jauzac, J. M. Diego, D. Eckert, D. Harvey, A. M. Koekemoer, D. J. Lagattuta, M. Limousin, G. Mahler, N. Patel, S. Tam, J. F. V. Allingham, R. Cen, A. Faisst, D. Perera, M. Sereno

36. [Characterization of the Polarization Beam Response of SPT-3G Using Point Sources](#user-content-link36)
**Authors:** T. de Haan, M. Archipley, N. Huang, A. J. Anderson, B. Ansarinejad, L. Balkenhol, D. R. Barron, K. Benabed, A. N. Bender, B. A. Benson, F. Bianchini, L. E. Bleem, S. Bocquet, F. R. Bouchet, L. Bryant, E. Camphuis, M. G. Campitiello, J. E. Carlstrom, J. Carron, C. L. Chang, P. Chaubal, P. M. Chichura, A. Chokshi, T. -L. Chou, A. Coerver, T. M. Crawford, C. Daley, K. R. Dibert, M. A. Dobbs, M. Doohan, A. Doussot, D. Dutcher, W. Everett, C. Feng, K. R. Ferguson, N. C. Ferree, K. Fichman, A. Foster, S. Galli, A. E. Gambrel, R. W. Gardner, F. Ge, N. Goeckner-Wald, R. Gualtieri, F. Guidi, S. Guns, N. W. Halverson, E. Hivon, A. Y. Q. Ho, G. P. Holder, W. L. Holzapfel, J. C. Hood, A. Hryciuk, F. Keruzore, A. R. Khalife, L. Knox, M. Korman, K. Kornoelje, C. -L. Kuo, K. Levy, Y. Li, A. E. Lowitz, C. Lu, G. P. Lynch, T. J. Maccarone, A. S. Maniyar, E. S. Martsen, F. Menanteau, M. Millea, J. Montgomery, Y. Nakato, T. Natoli, G. I. Noble, Y. Omori, A. Ouellette, Z. Pan, P. Paschos, K. A. Phadke, A. W. Pollak, K. Prabhu, W. Quan, M. Rahimi, A. Rahlin, C. L. Reichardt, M. Rouble, J. E. Ruhl, E. Schiappucci, A. C. Silva Oliveira, A. Simpson, J. A. Sobrin, A. A. Stark, J. Stephen, C. Tandoi, B. Thorne, C. Trendafilova, C. Umilta, J. D. Vieira, A. G. Vieregg, A. Vitrier, Y. Wan, N. Whitehorn, W. L. K. Wu, M. R. Young, J. A. Zebrowski

37. [Gravastar on the brane with a timelike extra dimension](#user-content-link37)
**Authors:** Shounak Ghosh, Rikpratik Sengupta, Kazuharu Bamba

38. [Gravitational Raman Scattering: a Systematic Toolkit for Tidal Effects in General Relativity](#user-content-link38)
**Authors:** Mikhail M. Ivanov, Yue-Zhou Li, Julio Parra-Martinez, Zihan Zhou

39. [Merger Driven or Internal Evolution? A New Morphological Study of Tidal Disruption Event Host Galaxies](#user-content-link39)
...
40. [On the radial velocity wave in the Galactic disk](#user-content-link40)
**Authors:** Chris Hamilton, Andrew Mummery, Joss Bland-Hawthorn

41. [The Walkaway Star HP Tau/G2: Evidence for a Stellar Merger](#user-content-link41)
**Authors:** Bo Reipurth, J. Bally, P. Friberg, D. M. Faes, C. Briceno, M. S. Connelley, C. Flores, A. M. Cody, H. Zinnecker

42. [Spectral Appearance of Self-gravitating AGN Disks Powered by Stellar Objects: Universal Effective Temperature in the Optical Continuum and Application to Little Red Dots](#user-content-link42)
**Authors:** Yi-Xian Chen, Hanpu Liu, Ruancun Li, Bingjie Wang, Yilun Ma, Yan-Fei Jiang, Jenny Greene, Eliot Quataert, Jeremy Goodman

43. [An Archival Optical Counterpart Search for Extragalactic Fast X-Ray Transients Discovered by Einstein Probe](#user-content-link43)
**Authors:** Run-Duo Liang, Wen-Xiong Li, Liang-Duan Liu, Ken Smith, Stephen Smartt, Niu Li, Arne Rau, Ling-Zhi Wang, Armin Rest, Ezequiel Treister, Jia-Sheng Huang, Franz Bauer, Jennifer Chacon, Ning-Chen Sun, Qin-Yu Wu, Se\'an Brennan, Matt Nicholl, Ting-Wan Chen, Amar Aryan, Sheng Yang, Albert K. H. Kong, Sofia Rest, Qinan Wang, James Gillanders, Dong-Yue Li, An Li, Jun Yang, Qing-Chang Zhao, Hui Sun, Yun-Fei Xu, Zhi-Xing Ling, Thomas J. L. de Boer, Chien-Cheng Lin, Thomas B. Lowe, Ken C. Chambers, Eugene A. Magnier, J. Quirola-V\'asquez, Xiaofeng Wang, Jing-Wei Hu, Yong Chen, Chen Zhang, Dong-Hua Zhao, He-Yang Liu, Hua-Qing Cheng, Chen-Zhou Cui, Shu-Mei Jia, Cheng-Kui Li, Ju Guan, Mao-Hai Huang, Hao-Wei Peng, Samaporn Tinyanont, Yuan Liu, Wei-Min Yuan

44. [The Host Galaxies of Active Galactic Nuclei with Direct Black Hole Mass Measurements](#user-content-link44)
**Authors:** Vardha N. Bennert, Nico Winkel, Tommaso Treu, Xuheng Ding, Vivian U, Raymond P. Remigio, Aaron J. Barth, Matthew A. Malkan, Lizvette Villafa\~na, Samantha Allen, Ellie Johnson, Sebastian Contreras, Minjin Kim, Simon Birrer, Knud Jahnke, Shaoping Zheng

45. [The X-ray properties of the most luminous quasars with strong emission-line outflows](#user-content-link45)
...
46. [Forecasting Supermassive Black Hole Binary Gravitational Wave Probes: Prospects for Future Pulsar Timing Array and Space-Borne Detectors](#user-content-link46)
**Authors:** Katsunori Kusakabe, Yoshiyuki Inoue, Daisuke Toyouchi, Keitaro Takahashi

47. [The effect of JWST/NIRSpec data reduction on the retrieval of WASP-39b atmospheric properties](#user-content-link47)
**Authors:** J. Roy-Perez, S. P\'erez-Hoyos, N. Barrado-Izagirre, H. Chen-Chen

48. [Universality of Primordial Anisotropies in Gravitational Wave Background](#user-content-link48)
**Authors:** Boyuan Jiang, Ryo Saito, Ying-li Zhang

49. [Towards a Fully Automated Pipeline for Short-Term Forecasting of In Situ Coronal Mass Ejection Magnetic Field Structure](#user-content-link49)
...
50. [Many-body effects on dense matter with hyperons at finite temperature](#user-content-link50)
**Authors:** Rafael B\'an Jacobsen, Ricardo Luciano Sonego Farias, Veronica Dexheimer

51. [How Neutron Star Observations Point Towards Exotic Matter: Existing Explanations and a Prospective Proposal](#user-content-link51)
**Authors:** Mauro Mariani, Ignacio F. Ranea-Sandoval

52. [Heavy interstellar scattering toward the near end of the Galactic bar](#user-content-link52)
**Authors:** A. B. Pushkarev (Crimean Astrophysical Observatory), A. Brunthaler (Max-Planck-Institut f\"ur Radioastronomie), Y. Y. Kovalev (Max-Planck-Institut f\"ur Radioastronomie), M. M. Lisakov (Pontificia Universidad Catolica de Valparaiso), I. N. Pashchenko (Lebedev Physical Institute, Moscow Institute of Physics and Technology), A. V. Plavin (Harvard University), N. Roy (Indian Institute of Science, New Mexico Institute of Mining and Technology), P. A. Voitsik (Lebedev Physical Institute), S. A. Dzib (Max-Planck-Institut f\"ur Radioastronomie), T. A. Koryukova (Lebedev Physical Institute, Crimean Astrophysical Observatory), A. Y. Yang (National Astronomical Observatories, Key Laboratory of Radio Astronomy and Technology)

53. [Astrometric follow-up of near-Earth asteroid 2024 YR4 during a Torino scale level 3 alert](#user-content-link53)
**Authors:** Marco Micheli, Maxime Devog\`ele, Larry Denneau, Eileen V. Ryan, William H. Ryan, Petr Pravec, Kamil Hornoch, Hana Ku\v{c}\'akov\'a, Petr Fatka, Melissa J. Brucker, Cassandra Lejoly, Nicholas Moskovitz, Mikael Granvik, Zuri Gray, Grigori Fedorets, Anlaug Amanda Djupvik, Carson Fuls, David Rankin, Kacper Wierzcho\'s, Bill Gray, Tim Lister, Richard J. Wainscoat, Robert Weryk, Olivier R. Hainaut, Federica Spoto, Peter Veres, Andrew S. Rivkin, Bryan J. Holler, Artem Y. Burdanov, Julien de Wit, Davide Farnocchia, Regina Rudawska, Eduardo Alonso Peleato, Francisco Oca\~na, John Tonry, Jeroen Audenaert, Laura Faggioli, Francesco Gianotto, Marco Fenucci, Luca Conversi, Richard Moissl

54. [Introducing a new generation Adaptive Optics simulation framework: from PASSATA to SPECULA](#user-content-link54)
**Authors:** Fabio Rossi, Alfio Puglisi, Guido Agapito

55. [Chiral phase transition with primordial black holes: Distinct phase structure and catalysis](#user-content-link55)
**Authors:** Masanori Tanaka, Jun-Chen Wang, Jing-Jun Zhang

56. [Antenna for the detection of electromagnetic audio-band disturbances on-board LISA](#user-content-link56)
**Authors:** D. Serrano (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya), A. P\'erez-Ortega (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya), D. Roma-Dollase (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya), J. Salvans-Tort (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya), J. Ho-Zhang (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya), J. Ramos-Castro (Institut d'Estudis Espacials de Catalunya, Departament d'Enginyeria Electr\`onica, Universitat Polit\`ecnica de Catalunya), M. Nofrarias (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya)

57. [Accelerating TTL noise post-processing via combined coefficients and alternative TDI configuration](#user-content-link57)
**Authors:** Xue Wang, Gang Wang

58. [The Non-Eruptive Reconfiguration of a Quiescent Filament After a Nearby Active Region Emergence](#user-content-link58)
**Authors:** James McKevitt, Louise Harra, Gherardo Valori, Deborah Baker, Nils Janitzek, Stephanie Yardley, Sarah Matthews, Hamish Reid, Alexander W. James, Muriel Stiefel, David H. Brooks, Ryan Dewey, Jim M. Raines, Susan T. Lepri, Liang Zhao, Juan Sebasti\'an Castellanos Dur\'an

59. [AB Aur, a Rosetta stone for studies of planet formation (IV): C/O estimates from CS and SO interferometric observations](#user-content-link59)
**Authors:** Pablo Rivi\`ere-Marichalar, Asunci\'on Fuente, Romane le Gal, Roberto Neri, Gisela Esplugues, Dmitry Semenov, Richard Teague, Alejandro Santamar\'ia Miranda

60. [Probing habitable regions with SRG/eROSITA](#user-content-link60)
**Authors:** E. Gatuzz, S. Rukdee, S. Freund, T. Kallman

61. [Simulated LSST Observations of Real Metre-scale Impactors](#user-content-link61)
**Authors:** Michael Frazer, Hadrien Devillepoix, Sophie Deam

62. [Scalar Tsunamis from Black Hole Formation](#user-content-link62)
**Authors:** Arturo de Giorgi, Yeray Garcia del Castillo, Joerg Jaeckel

63. [Joint optical-digital design strategy for adaptive optics systems: application to wavelength selection for satellite imaging](#user-content-link63)
**Authors:** Florian Cheyssial, Laurent Mugnier, Cyril Petit

64. [Spin Light of neutrino in polarized matter](#user-content-link64)
**Authors:** Alexander Grigoriev, Alexei Ternov

65. [Mobile neutron monitor for latitude cosmic ray monitoring](#user-content-link65)
**Authors:** Kobelev P. G., Maurchev E. A., Yanke V. G

66. [Optical spectral characterization of OP 313. Constraining the contribution of thermal and non-thermal optical emission](#user-content-link66)
**Authors:** J. Otero-Santos, M. Nievas Rosillo, J. A. Acosta-Pulido, R. Clavero

67. [SF2A Environmental Transition Commission: Summary of the 2025 workshop](#user-content-link67)
**Authors:** Faustine Cantalloube (IPAG), Jack Berat (LPENS), Na\"is Fargette (IRAP), Pierre Larue (IPAG), N. Pourr\'e (IPAG), Sarah E Anderson (LAM), Julien Milli (IPAG), Jean-Fran\c{c}ois Gonzalez (CRAL), Olivier Bern\'e (IRAP), Didier Barret (IRAP, CESR, UT3, OMP), Ang\`ele Mouini\'e (IRAP), Clarisse Picard (CESBIO), Karine Dassas (CESBIO), J\"urgen Kn\"odlseder (IRAP), David Redon

---

## 1. [Dwarf Galaxy Number Counts within 25 Mpc: Predictions from Local Group Analogues in TNG50](https://arxiv.org/abs/2602.06224) <a id="link1"></a>
...
**Comment:** Directly matches 'Near-Field Cosmology' and 'Dwarf Satellite Galaxies' criteria. The paper predicts dwarf galaxy number counts in the Local Group analogues using TNG50 simulations, discusses satellite and field dwarfs, and quenching in dwarfs. Also relevant to 'Numerical Galaxy Simulations' and 'Star Formation Quenching' for dwarfs. Highly relevant.
...
## 2. [Dynamic Zoom Simulations of structure formation beyond standard cosmology](https://arxiv.org/abs/2602.06133) <a id="link2"></a>
...
**Comment:** Presents a new performance-enhancing technique (Dynamic Zoom Simulations) for large-scale cosmological simulations, including non-standard cosmologies. This fits the 'Numerical Galaxy Simulations' criterion, especially as it enables high-resolution, large-volume simulations and introduces a new computational method.
...
## 3. [ELUCID-DESI I: A Parallel MPI Implementation of the Initial Condition Solver for Large-Scale Reconstruction Simulations](https://arxiv.org/abs/2602.06463) <a id="link3"></a>
...
**Comment:** Presents a highly scalable, MPI-parallelized framework for reconstructing the initial cosmic density field for large-scale simulations, with a novel 'guess' module for efficiency. This fits the 'Numerical Galaxy Simulations' criterion, especially for high-resolution reconstructions.
...
## 4. [A Demonstration of a Neural Network as a Bridge Between Galaxy Simulations and Surveys](https://arxiv.org/abs/2602.06492) <a id="link4"></a>
...
**Comment:** This paper demonstrates a neural network trained on semi-analytic galaxy simulations (SHARK) to predict stellar masses from photometry, transferring to real survey data. It directly matches the 'Numerical Galaxy Simulations' criterion, as it uses simulation data and applies it to observations, and also touches on simulation-to-observation transfer learning.
...
## 5. [Modelling the photometric and morphological evolution of disc galaxies in the cluster environment](https://arxiv.org/abs/2602.06119) <a id="link5"></a>
...
**Comment:** Models photometric and morphological evolution of disc galaxies in clusters, focusing on ram-pressure stripping and quenching timescales. Directly relevant to star formation quenching (especially in lower-mass galaxies) and morphological transformation, with observational and theoretical modeling. Also touches on resolved star formation histories via spectrophotometric ageing.
...
## 6. [Magnetohydrodynamic instabilities in stellar radiative regions. I. Linear study of shear-driven instabilities](https://arxiv.org/abs/2602.06889) <a id="link6"></a>
...
**Comment:** This paper investigates magnetohydrodynamic instabilities in stellar radiative regions, focusing on angular momentum transport and magnetic field evolution. It presents new criteria for instabilities relevant to stellar evolution models, which fits the 'Stellar Models' criterion (new theoretical models for stellar interiors).
...
## 7. [Asteroseismic ages for 17,000 stars in Kepler, K2 and TESS](https://arxiv.org/abs/2602.06870) <a id="link7"></a>
...
**Comment:** This paper presents asteroseismic age estimates for 17,000 red giant stars, enabling time-resolved studies of stellar populations in the Milky Way. While it involves stellar models and age estimation, the focus is on red giants in the Milky Way, not on new stellar models or evolutionary tracks, nor on resolved SFH of galaxies. The relevance is borderline due to the connection to stellar evolution and age estimation.
...
## 8. [Disk-Regulated Mass Transfer Between Rotating Non-Degenerate Stars: Insights from Be and sdOB Binaries](https://arxiv.org/abs/2602.06259) <a id="link8"></a>
...
**Comment:** Presents a new mass-accretion prescription for mass transfer between non-degenerate stars in binaries, with application to Be and sdOB binaries. This is relevant to 'Stellar Models' as it discusses stellar evolution and mass transfer, but does not present new stellar evolutionary tracks or atmosphere models. Borderline relevance.
...
## 9. [Treecode2: The Power of Pluralism. I. Static Tests](https://arxiv.org/abs/2602.06295) <a id="link9"></a>
...
**Comment:** This paper presents improvements to an N-body oct-tree code, focusing on static tests and force accuracy. While it is a numerical method for N-body simulations, it does not specifically address galaxy simulations or include new physics models relevant to the core topics. It is borderline relevant as a general simulation technique, but not directly tied to galaxy simulations.
...
## 10. [Galaxies caught in transition: the role of group environment in shaping the mass-size relation in the local Universe](https://arxiv.org/abs/2602.06719) <a id="link10"></a>

**ArXiv ID:** 2602.06719

**Authors:** Gissel P. Montaguth, Claudia Mendes de Oliveira, Ciria Lima-Dias, Antonela Monachesi, Sergio Torres-Flores, Eduardo Telles, F\'abio R. Herpich, Yolanda Jim\'enez-Teja, Antonio Kanaan, Tiago Ribeiro, William Schoenell

**Abstract:** The stellar mass-size relation is a sensitive probe of how environment shapes galaxy structure. We analyse this relation in the local Universe for galaxies in compact groups (CGs), low-mass groups ($M_{\rm vir} \leq 10^{13}~M_{\odot}$), and high-mass groups, comparing them to field galaxies using data from the Southern Photometric Local Universe Survey. Galaxies are classified as early types (ETGs; $n \geq 2.5$, $(u-r)_0 \geq 2.3$), late types (LTGs; $n < 2.5$, $(u-r)_0 < 2.3$), transition galaxies (TGs; $n < 2.5$, $(u-r)_0 \geq 2.3$), and others (OGs; $n \geq 2.5$, $(u-r)_0 < 2.3$). We find that ETGs and OGs show no significant environmental dependence: their mass-size slopes and intercepts are statistically consistent across CGs, groups, and the field. LTGs also follow similar relations in the field and in most groups, with only a modest tendency for LTGs in CGs to be smaller at fixed stellar mass. By contrast, TGs display a clear environmental signal: in groups the slope steepens to $\alpha \sim 0.4$ (versus $\alpha \sim 0.2$ in the field) and their sizes are smaller than in the field, with non-overlapping 95\% posterior intervals. These trends suggest that TGs in denser environments are more structurally evolved, likely owing to enhanced bulge prominence and fading of the outer disc, consistent with the S\'ersic-index distributions, which show an excess of TGs with $n_r \gtrsim 1.5$ in groups and CGs. Our findings highlight TGs as an environmentally sensitive population, providing insight into the structural transformation of galaxies in group environments.

**Comment:** The paper analyzes the mass-size relation of galaxies in different group environments, focusing on structural transformation and environmental effects. While it discusses galaxy evolution and environmental quenching, the focus is not specifically on dwarf galaxies or resolved star formation histories. The relevance is borderline, as the topic may have implications for quenching and transformation, but is not directly focused on the core topics.
...
## 11. [Compact HII Regions as Clocks of Massive-Star Formation: Evidence for Long Formation Timescales](https://arxiv.org/abs/2602.06196) <a id="link11"></a>
...
**Comment:** Studies compact HII regions and massive star formation timescales in the Milky Way. While it discusses star formation, it is focused on massive stars and HII regions, not resolved star formation histories of galaxies or dwarfs. Borderline relevance.
...
## 12. [Real time, cross platform visualizations with zero dependencies for the N-body package REBOUND](https://arxiv.org/abs/2602.06735) <a id="link12"></a>
...
**Comment:** Describes a new approach for real-time visualizations for the N-body package REBOUND, focusing on visualization technology rather than galaxy simulations or astrophysical results. While it may be useful for simulation work, it does not directly address the core scientific topics.
...
## 13. [Correlation Calibration: A Hybrid Calibration Technique for Radio Interferometric Arrays](https://arxiv.org/abs/2602.06109) <a id="link13"></a>
...
**Comment:** The paper presents a new calibration technique for radio interferometric arrays, relevant for 21 cm cosmology. While it is a technical advance for cosmological observations, it does not directly address galaxy simulations, near-field cosmology, or the other core topics.
...
## 14. [Hypersoft X-ray Sources: A New Class of Luminous Cosmic Emitters](https://arxiv.org/abs/2602.06192) <a id="link14"></a>
...
**Comment:** Reports discovery of a new class of hypersoft X-ray sources, including accreting white dwarfs and black holes. While interesting for stellar evolution and X-ray binaries, does not directly address resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 15. [Ne and Fe abundances in the ISM: Archival Study of Fe-L and Ne-K edges in Chandra and XMM-Newton](https://arxiv.org/abs/2602.06132) <a id="link15"></a>
...
**Comment:** Measures Ne and Fe abundances in the ISM using X-ray absorption features. While relevant for ISM studies and elemental abundances, does not directly address stellar models, resolved star formation histories, or galaxy-scale simulations.
...
## 16. [Primordial Black Hole Abundance from Reionization](https://arxiv.org/abs/2602.06794) <a id="link16"></a>
...
**Comment:** This paper constrains primordial black hole abundance using reionization history and CMB data. While PBH cosmology is tangentially related, it does not match any of the core criteria (near-field cosmology, resolved SFH, dwarf galaxy quenching, etc.).
...
## 17. [The imprint of AGN-driven outflows on the CGM: the case of Ly{\alpha} nebulae around high-z quasars](https://arxiv.org/abs/2602.06128) <a id="link17"></a>

**ArXiv ID:** 2602.06128

**Authors:** Silvia C. Rueda-Vargas, Vincenzo Mainieri, Giulia Tozzi, Darshan Kakkad, Fabrizio Arrigoni-Battaia, Tiago Costa, Emanuele Paolo Farina, Chris M. Harrison

**Abstract:** Some cosmological hydrodynamical simulations predict that outflows driven by active galactic nuclei (AGN) play a key role in powering the Ly$\alpha$ nebulae observed around high-redshift quasars. In such simulations, AGN feedback seeded as powerful outflows leads to extended and luminous nebulae whose morphology and surface-brightness profiles accurately reproduce the observations, while suppressing AGN feedback leads to compact and faint nebulae. This link might arise from outflows opening up a channel for Ly$\alpha$ photons to escape from the galactic nucleus to the circumgalactic medium (CGM). The main aim of this paper is to test this theoretical prediction using observations, by comparing the physical properties of outflows and Ly$\alpha$ nebulae. We analyze integral-field unit data obtained with VLT/ERIS and GEMINI/GNIRS to trace the ionized gas in the interstellar medium (ISM) of a sample of six quasars at $z\sim2-3$, using the [O III] emission line. We detect powerful outflows in all the quasars of our sample, with velocities $>1500~\mathrm{km~s^{-1}}$ and kinetic energies $ \gtrsim 2\times10^{43}~\mathrm{erg~s^{-1}}$. Four of our quasars are spatially resolved and show signs of extended [O III] emission out to distances $>2$ kpc from the central supermassive black hole. When excluding one outlier, we find a positive monotonic correlation between the outflow power and the Ly$\alpha$ nebulae size ($\rho=0.89$, $p=0.03$) and luminosity ($\rho=0.6$, $p=0.28$). Additionally, we find evidence of spatial alignment between the ionization cone and the inner and brightest regions of the Ly$\alpha$ nebula. Our results provide tentative evidence in support of the theoretical prediction that AGN-driven outflows at ISM scales open a low-optical-depth path for central Ly$\alpha$ photons to reach the CGM and create extended nebulae.

**Comment:** Examines AGN-driven outflows and their imprint on the CGM via Lyα nebulae around high-z quasars. Focus is on AGN-driven feedback, not star-formation-driven outflows or CGM of dwarf galaxies. AGN-driven outflows are explicitly listed as irrelevant unless star-formation-driven outflows are also discussed.
...
## 18. [Primordial Black Hole signatures from femtolensing and spectral fringe of Gamma Ray Bursts](https://arxiv.org/abs/2602.06407) <a id="link18"></a>
...
**Comment:** The paper studies femtolensing of gamma ray bursts to constrain primordial black holes as dark matter. While PBH dark matter is a cosmological topic, it does not match any of the core criteria (near-field cosmology, resolved SFH, dwarf galaxy quenching, etc.).
...
## 20. [The Massive and Distant Clusters of WISE Survey 2: Detection of splashback radii in galaxy cluster total light stacks](https://arxiv.org/abs/2602.06439) <a id="link20"></a>
...
**Comment:** Studies splashback radii in galaxy clusters using total light stacks. Focus is on massive galaxy clusters, not dwarfs or satellites. Cluster splashback is not a core topic.
...
## 21. [Revisiting the missing mass problem in MOND for nearby galaxy clusters](https://arxiv.org/abs/2602.06082) <a id="link21"></a>
...
**Comment:** This paper focuses on galaxy clusters and the missing mass problem in MOND, with emphasis on baryonic mass and stellar initial mass function. However, the focus is on massive elliptical galaxies and galaxy clusters, not dwarf galaxies or near-field cosmology. No direct connection to satellite galaxies, resolved star formation histories, or quenching.
...
## 23. [On the Difficulties with Late-Time Solutions for the Hubble Tension](https://arxiv.org/abs/2602.06293) <a id="link23"></a>
...
**Comment:** The paper discusses late-time cosmological solutions for the Hubble tension, focusing on expansion history and supernovae. While it is relevant to cosmology, it does not address galaxy-scale phenomena, near-field cosmology, or the other core topics.
...
## 24. [Dark Matter Heating of Compact Stars Beyond Capture: A Relativistic Framework for Energy Deposition by Particle Beams](https://arxiv.org/abs/2602.06111) <a id="link24"></a>
...
**Comment:** Develops a relativistic framework for energy deposition by particle beams onto compact objects (neutron stars, white dwarfs), with an application to boosted dark matter. No direct connection to galaxy-scale topics, near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 25. [Bayesian Constraints on the Neutron Star Equation of State with a Smooth Hadron-Quark Crossover](https://arxiv.org/abs/2602.06696) <a id="link25"></a>
...
**Comment:** Bayesian inference of neutron star equation of state, including hadron-quark crossover. Focus is on compact object physics, not galaxy-scale phenomena or any of the core topics.
...
## 26. [Parametric-Resonance Production of QCD Axions](https://arxiv.org/abs/2602.06922) <a id="link26"></a>
...
**Comment:** Discusses parametric-resonance production of QCD axions and its impact on dark matter abundance. Focus is on particle physics and early universe cosmology, not galaxy-scale phenomena or any of the core topics.
...
## 27. [Consistency of standard cosmologies using Bayesian model comparison and tension quantification](https://arxiv.org/abs/2602.06115) <a id="link27"></a>
...
**Comment:** Bayesian model comparison and tension quantification for standard cosmological models using CMB, BAO, and SN data. While relevant to cosmology, it does not focus on galaxy simulations, near-field cosmology, or any of the other core topics.
...
## 28. [Dilution of accreted planetary matter in hot DA white dwarfs according to their mass](https://arxiv.org/abs/2602.06738) <a id="link28"></a>
...
**Comment:** Study of dilution of accreted planetary matter in hot DA white dwarfs, focusing on internal transport processes and pollution signatures. This is related to stellar physics but does not present new stellar models or address the core topics.
...
## 29. [Super-knee cosmic rays from interacting supernovae](https://arxiv.org/abs/2602.06410) <a id="link29"></a>
...
**Comment:** This paper models cosmic ray production from interacting supernovae and circumstellar medium. The focus is on cosmic rays and supernovae, not on galaxy-scale processes, dwarf galaxies, or any of the core criteria.
...
## 30. [Sensipy: simulate gamma-ray observations of transient astrophysical sources](https://arxiv.org/abs/2602.06783) <a id="link30"></a>
...
**Comment:** The paper presents a toolkit for simulating gamma-ray observations of transient astrophysical sources. The focus is on observational simulation tools for transients, not on galaxy simulations, resolved SFH, quenching, or CGM.
...
## 31. [Studies on the spin and magnetic inclination evolution of magnetars Swift J1834.9-0846 under wind braking](https://arxiv.org/abs/2602.06615) <a id="link31"></a>
...
**Comment:** Presents a unified spin-evolution model for a magnetar, integrating magnetic dipole radiation, gravitational wave emission, and wind braking. Focuses on neutron star physics, not galaxy evolution or the core topics.
...
## 32. [Exploring Cosmological Tensions with Hubble Parameter Tomography via Linear Cosmography](https://arxiv.org/abs/2602.06092) <a id="link32"></a>
...
**Comment:** Paper discusses cosmological tensions and reconstructs the Hubble parameter history using supernova data. No direct connection to near-field cosmology, resolved star formation histories, dwarf galaxies, quenching, stellar models, galaxy simulations, or outflows.
...
## 33. [Mapping plasma properties of Cassiopeia A with XRISM/Resolve: a Bayesian analysis via UltraSPEX](https://arxiv.org/abs/2602.06952) <a id="link33"></a>
...
**Comment:** This paper presents plasma parameter mapping of Cassiopeia A, a supernova remnant, using XRISM/Resolve. While it involves stellar remnants and plasma properties, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 34. [Rotational Behaviour of Exotic Compact Objects](https://arxiv.org/abs/2602.06660) <a id="link34"></a>
...
**Comment:** The paper models exotic compact objects made of self-interacting asymmetric fermionic dark matter, focusing on their structural and rotational properties. The context is compact objects and gravitational wave signals, not galaxies or near-field cosmology.
...
## 35. [Non-spherical BUFFALOs: a weak lensing view of the Frontier Field clusters and associated systematics](https://arxiv.org/abs/2602.06904) <a id="link35"></a>
...
**Comment:** This paper focuses on weak lensing mass measurements of massive galaxy clusters, not dwarf galaxies or satellite systems. It does not address near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM of dwarfs. The focus is on systematics in cluster mass measurements, which is outside the core topics.
...
## 36. [Characterization of the Polarization Beam Response of SPT-3G Using Point Sources](https://arxiv.org/abs/2602.06334) <a id="link36"></a>

**ArXiv ID:** 2602.06334

**Authors:** T. de Haan, M. Archipley, N. Huang, A. J. Anderson, B. Ansarinejad, L. Balkenhol, D. R. Barron, K. Benabed, A. N. Bender, B. A. Benson, F. Bianchini, L. E. Bleem, S. Bocquet, F. R. Bouchet, L. Bryant, E. Camphuis, M. G. Campitiello, J. E. Carlstrom, J. Carron, C. L. Chang, P. Chaubal, P. M. Chichura, A. Chokshi, T. -L. Chou, A. Coerver, T. M. Crawford, C. Daley, K. R. Dibert, M. A. Dobbs, M. Doohan, A. Doussot, D. Dutcher, W. Everett, C. Feng, K. R. Ferguson, N. C. Ferree, K. Fichman, A. Foster, S. Galli, A. E. Gambrel, R. W. Gardner, F. Ge, N. Goeckner-Wald, R. Gualtieri, F. Guidi, S. Guns, N. W. Halverson, E. Hivon, A. Y. Q. Ho, G. P. Holder, W. L. Holzapfel, J. C. Hood, A. Hryciuk, F. Keruzore, A. R. Khalife, L. Knox, M. Korman, K. Kornoelje, C. -L. Kuo, K. Levy, Y. Li, A. E. Lowitz, C. Lu, G. P. Lynch, T. J. Maccarone, A. S. Maniyar, E. S. Martsen, F. Menanteau, M. Millea, J. Montgomery, Y. Nakato, T. Natoli, G. I. Noble, Y. Omori, A. Ouellette, Z. Pan, P. Paschos, K. A. Phadke, A. W. Pollak, K. Prabhu, W. Quan, M. Rahimi, A. Rahlin, C. L. Reichardt, M. Rouble, J. E. Ruhl, E. Schiappucci, A. C. Silva Oliveira, A. Simpson, J. A. Sobrin, A. A. Stark, J. Stephen, C. Tandoi, B. Thorne, C. Trendafilova, C. Umilta, J. D. Vieira, A. G. Vieregg, A. Vitrier, Y. Wan, N. Whitehorn, W. L. K. Wu, M. R. Young, J. A. Zebrowski

**Abstract:** Precise measurements of cosmic microwave background polarization require rigorous control of instrumental systematics. For the South Pole Telescope's third-generation camera (SPT-3G), accurate characterization of the beam is critical for understanding the polarized mm-wave sky. Here, we present direct measurements of SPT-3G's polarized beam response using observations of 100 polarized extragalactic point sources. Previous SPT-3G CMB power spectrum analyses introduced a phenomenological parameter $\beta_\mathrm{pol}$ to describe the degree of polarization preserved in beam sidelobes. These analyses found evidence for significant depolarization driven by the requirement of polarization power spectrum consistency between different frequency bands. Our direct measurements yield $\beta_\mathrm{pol}=0.90\pm0.10$ at 95 GHz, $1.01\pm0.12$ at 150 GHz, and $0.81\pm0.29$ at 220 GHz, indicating minimal sidelobe depolarization. We validate these results through extensive systematic tests including Bayesian posterior sampling versus frequentist bootstrap resampling, real-space versus Fourier-space analysis, and variations on temperature-to-polarization leakage handling, covariance determination, and source selection. When compared to values inferred from previous cosmological analyses, which favored significant depolarization to resolve inter-frequency power spectrum inconsistencies, we find a mild tension of $1.9\sigma$. However, this apparent discrepancy is dependent on the beam modeling, as our point source-based analysis derives much of its constraining power on $\beta_\mathrm{pol}$ from higher multipoles than the power spectrum analysis. These measurements therefore admit three explanations for the frequency-dependent residuals observed in the power spectrum analysis: a statistical fluctuation, the need for more sophisticated polarized beam models, or systematics other than beam depolarization.

**Comment:** The paper characterizes the polarization beam response of the SPT-3G instrument using extragalactic point sources. It is focused on CMB polarization measurements and instrument systematics, not on any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 37. [Gravastar on the brane with a timelike extra dimension](https://arxiv.org/abs/2602.06691) <a id="link37"></a>
...
**Comment:** The paper discusses gravastar configurations in a braneworld scenario, focusing on compact object alternatives to black holes. There is no connection to any of the core topics: near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM.
...
## 38. [Gravitational Raman Scattering: a Systematic Toolkit for Tidal Effects in General Relativity](https://arxiv.org/abs/2602.06951) <a id="link38"></a>
...
**Comment:** The paper presents a toolkit for tidal effects in general relativity, focusing on gravitational Raman scattering and Love numbers for compact objects. The focus is on fundamental physics and compact object tidal effects, not on any of the core topics.
...
## 39. [Merger Driven or Internal Evolution? A New Morphological Study of Tidal Disruption Event Host Galaxies](https://arxiv.org/abs/2602.06839) <a id="link39"></a>
...
**Comment:** Focuses on tidal disruption event (TDE) host galaxies, their morphology, and bar/ring structures. TDEs and bars are specifically listed as irrelevant. No connection to dwarf galaxies, star formation histories, or galaxy simulations.
...
## 40. [On the radial velocity wave in the Galactic disk](https://arxiv.org/abs/2602.06182) <a id="link40"></a>
...
**Comment:** Studies radial velocity waves in the Galactic disk, focusing on disk dynamics, spiral arms, and bar. Galactic disk and bar are specifically listed as irrelevant. No connection to satellites, dwarfs, or star formation histories.
...
## 41. [The Walkaway Star HP Tau/G2: Evidence for a Stellar Merger](https://arxiv.org/abs/2602.06465) <a id="link41"></a>
...
**Comment:** Examines a walkaway star and evidence for a stellar merger in a young stellar object. Focus is on stellar dynamics and mergers, not on galaxy-scale processes, dwarf galaxies, or star formation histories. Not relevant.
...
## 43. [An Archival Optical Counterpart Search for Extragalactic Fast X-Ray Transients Discovered by Einstein Probe](https://arxiv.org/abs/2602.06321) <a id="link43"></a>
...
**Comment:** Searches for optical counterparts to extragalactic fast X-ray transients, with a focus on supernovae. No connection to dwarf galaxies, star formation histories, or galaxy simulations.
...
## 44. [The Host Galaxies of Active Galactic Nuclei with Direct Black Hole Mass Measurements](https://arxiv.org/abs/2602.06116) <a id="link44"></a>
...
**Comment:** Focuses on host galaxies of AGNs, including disk and bar properties, and scaling relations with supermassive black holes. No direct connection to near-field cosmology, dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows. The mention of bars and galactic centers is explicitly irrelevant.
...
## 45. [The X-ray properties of the most luminous quasars with strong emission-line outflows](https://arxiv.org/abs/2602.06793) <a id="link45"></a>
...
**Comment:** The paper studies X-ray properties and outflows in luminous quasars, focusing on AGN-driven winds. Outflows are discussed, but they are not star-formation-driven and the context is not dwarf galaxies. No direct relevance to the core topics.
...
## 46. [Forecasting Supermassive Black Hole Binary Gravitational Wave Probes: Prospects for Future Pulsar Timing Array and Space-Borne Detectors](https://arxiv.org/abs/2602.06789) <a id="link46"></a>
...
**Comment:** This paper focuses on supermassive black hole binaries and their gravitational wave detection prospects. The topic is not related to near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM of dwarf galaxies. The focus is on SMBHs and AGN, which are specifically listed as irrelevant.
...
## 47. [The effect of JWST/NIRSpec data reduction on the retrieval of WASP-39b atmospheric properties](https://arxiv.org/abs/2602.06722) <a id="link47"></a>
...
**Comment:** The paper studies the effect of JWST/NIRSpec data reduction on exoplanet atmospheric retrievals. The focus is on exoplanet atmospheres, not on any of the core topics.
...
## 48. [Universality of Primordial Anisotropies in Gravitational Wave Background](https://arxiv.org/abs/2602.06562) <a id="link48"></a>
...
**Comment:** Presents a formalism for primordial anisotropies in the gravitational wave background. No connection to galaxy simulations, star formation, or any core topics.
...
## 49. [Towards a Fully Automated Pipeline for Short-Term Forecasting of In Situ Coronal Mass Ejection Magnetic Field Structure](https://arxiv.org/abs/2602.06926) <a id="link49"></a>
...
**Comment:** Presents an automated pipeline for forecasting coronal mass ejection magnetic field structure. Focus is on solar/space weather prediction, not galaxy-scale phenomena or any of the core topics.
...
## 50. [Many-body effects on dense matter with hyperons at finite temperature](https://arxiv.org/abs/2602.06815) <a id="link50"></a>
...
**Comment:** This paper extends the Many-Body Forces Model to finite temperature for nuclear matter and compact stars, including hyperons. It is focused on nuclear physics and compact star modeling, not galaxies, star formation histories, or near-field cosmology.
...
## 51. [How Neutron Star Observations Point Towards Exotic Matter: Existing Explanations and a Prospective Proposal](https://arxiv.org/abs/2602.06170) <a id="link51"></a>
...
**Comment:** The paper discusses neutron star interiors and equations of state, which is not related to any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 53. [Astrometric follow-up of near-Earth asteroid 2024 YR4 during a Torino scale level 3 alert](https://arxiv.org/abs/2602.06890) <a id="link53"></a>
...
**Comment:** This paper presents astrometric follow-up of a near-Earth asteroid during a planetary defense alert. The topic is planetary science and asteroid tracking, which is unrelated to any of the core topics.
...
## 54. [Introducing a new generation Adaptive Optics simulation framework: from PASSATA to SPECULA](https://arxiv.org/abs/2602.06688) <a id="link54"></a>
...
**Comment:** This paper presents a new adaptive optics simulation framework. It is not related to galaxy simulations, star formation, or any of the core topics. Ignore.
...
## 55. [Chiral phase transition with primordial black holes: Distinct phase structure and catalysis](https://arxiv.org/abs/2602.06661) <a id="link55"></a>
...
**Comment:** Studies chiral phase transitions with primordial black holes and gravitational wave signals. No connection to galaxy simulations, star formation, or any core topics.
...
## 56. [Antenna for the detection of electromagnetic audio-band disturbances on-board LISA](https://arxiv.org/abs/2602.06878) <a id="link56"></a>
...
**Comment:** Characterizes magnetic sensors for LISA spacecraft, relevant to gravitational wave detection instrumentation. No connection to galaxy-scale topics or any of the core criteria.
...
## 57. [Accelerating TTL noise post-processing via combined coefficients and alternative TDI configuration](https://arxiv.org/abs/2602.06731) <a id="link57"></a>
...
**Comment:** Improves TTL noise post-processing for space-based gravitational wave detectors. Focus is on instrumentation and noise calibration, not galaxy-scale phenomena or any of the core topics.
...
## 58. [The Non-Eruptive Reconfiguration of a Quiescent Filament After a Nearby Active Region Emergence](https://arxiv.org/abs/2602.06522) <a id="link58"></a>
...
**Comment:** The paper analyzes the stability and reconfiguration of a solar filament after nearby active region emergence. It is focused on solar physics and filament eruptions, not galaxies, star formation histories, or near-field cosmology.
...
## 59. [AB Aur, a Rosetta stone for studies of planet formation (IV): C/O estimates from CS and SO interferometric observations](https://arxiv.org/abs/2602.06551) <a id="link59"></a>
...
**Comment:** This paper studies the C/O ratio and sulfur abundance in the AB Aur protoplanetary disk using interferometric observations. The focus is on planet formation and disk chemistry, not galaxies, star formation histories, or near-field cosmology.
...
## 60. [Probing habitable regions with SRG/eROSITA](https://arxiv.org/abs/2602.06124) <a id="link60"></a>
...
**Comment:** This paper studies stellar high-energy radiation and its impact on exoplanetary atmospheres, focusing on habitability and atmospheric erosion. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 61. [Simulated LSST Observations of Real Metre-scale Impactors](https://arxiv.org/abs/2602.06314) <a id="link61"></a>
...
**Comment:** The paper simulates LSST observations of meter-scale asteroid impactors, focusing on planetary defense and asteroid research. It does not address any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 62. [Scalar Tsunamis from Black Hole Formation](https://arxiv.org/abs/2602.06112) <a id="link62"></a>
...
**Comment:** This paper discusses scalar fields released during black hole formation, focusing on energy release and field configurations. It does not address any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 63. [Joint optical-digital design strategy for adaptive optics systems: application to wavelength selection for satellite imaging](https://arxiv.org/abs/2602.06537) <a id="link63"></a>
...
**Comment:** Joint optical-digital design strategy for adaptive optics systems, applied to satellite imaging. This is unrelated to the core topics (galaxy evolution, star formation, etc.).
...
## 65. [Mobile neutron monitor for latitude cosmic ray monitoring](https://arxiv.org/abs/2602.06589) <a id="link65"></a>
...
**Comment:** Describes the development and testing of a mobile neutron monitor for cosmic ray monitoring. This is unrelated to the core topics (galaxy evolution, star formation, etc.).
...
## 66. [Optical spectral characterization of OP 313. Constraining the contribution of thermal and non-thermal optical emission](https://arxiv.org/abs/2602.06919) <a id="link66"></a>
...
**Comment:** The paper is about the optical spectral characterization of a quasar, focusing on accretion disk, broad line region, and dusty torus. No connection to near-field cosmology, dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 67. [SF2A Environmental Transition Commission: Summary of the 2025 workshop](https://arxiv.org/abs/2602.06564) <a id="link67"></a>
...
**Comment:** This is a summary of a workshop on environmental transition in the astronomy community, focusing on institutional actions, early-career researchers, research infrastructure, and geopolitical conditions. It does not match any of the core scientific criteria (near-field cosmology, star formation histories, galaxy simulations, etc.).
