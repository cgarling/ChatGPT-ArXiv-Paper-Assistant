...
1. [Variable Modified Newtonian Mechanics VIII: Ultra faint dwarfs in Milky Way](#user-content-link1)
**Authors:** James Chi Chung Wong

2. [pop-cosmos: Redshifts and physical properties of KiDS-1000 galaxies](#user-content-link2)
**Authors:** Anik Halder, Hiranya V. Peiris, Stephen Thorp, Boris Leistedt, Daniel J. Mortlock, Gurjeet Jagwani, Madalina N. Tudorache, Sinan Deger, Benedict Van den Bussche, Joel Leja, Angus H. Wright

3. [Low-mass stars dominate the hot (0.7 keV) Galactic X-ray emission](#user-content-link3)
**Authors:** G. Ponti, M. C. H. Yeung, G. Stel, N. Locatelli, X. Zheng, B. Stelzer, A. Merloni, M. Caramazza, E. Magaudda, M. Sasaki, K. Dennerl, T. H. Reiprich, A. Schwope, W. Becker, M. Freyberg

4. [Stellar Interpretation of Meteoritic Data and PLotting for Everyone (SIMPLE): Isotope Mixing Lines for Six Sets of Core-Collapse Supernova Models](#user-content-link4)
**Authors:** Marco Pignatari, Mattias Ek, Georgy V. Makhatadze, G\'abor G. B\'alazs, Lorenzo Roberti, James M. Ball, Borb\'ala Cseh, Alessandro Chieffi, Chris Fryer, Falk Herwig, Chiara Incollingo, Thomas Lawson, Marco Limongi, Thomas Rauscher, Maria Sch\"onb\"achler, Andre Sieverding, Reto Trappitsch, Maria Lugaro

5. [pop-cosmos: Forward modeling KiDS-1000 redshift distributions using realistic galaxy populations](#user-content-link5)
**Authors:** Boris Leistedt, Hiranya V. Peiris, Anik Halder, Stephen Thorp, Daniel J. Mortlock, Arthur Loureiro, Justin Alsing, Gurjeet Jagwani, Madalina N. Tudorache, Sinan Deger, Joel Leja, Benedict Van den Bussche, Angus H. Wright, Shun-Sheng Li, Konrad Kuijken, Hendrik Hildebrandt

6. [The local void model for the Hubble and BAO tensions](#user-content-link6)
**Authors:** Indranil Banik, Harry Desmond, Vasileios Kalaitzidis, Sergij Mazurenko

7. [BEACON: JWST NIRCam Pure-parallel Imaging Survey. IV. A Systematic Search for Galaxy Overdensities and Evidence for Gas Accretion Mode Transition](#user-content-link7)
...
8. [Diagnostics for the solar chromosphere using neutral carbon Rydberg lines](#user-content-link8)
**Authors:** R. P. Dufresne, C. M. O. Osborne, G. Del Zanna

9. [From Main Sequence Binary to Blast: MESA Modeling of the Double-Detonation Progenitor PTF1~J2238+7430](#user-content-link9)
**Authors:** Mercedes S. Hernandez, Thomas Kupfer, Diogo Belloni, Matthias R. Schreiber

10. [An emulator for the ionizing photon mean free path in ultra-high resolution simulations: the implications of mean free path measurements for the reionization history](#user-content-link10)
**Authors:** Hurum Maksora Tohfa, Christopher Cain, Matthew McQuinn, Anson D'Aloisio

11. [Large-scale halo velocity correlations and the impact of finite simulation volumes](#user-content-link11)
**Authors:** Yao-Tsung Chuang, Teppei Okumura, Takahiro Nishimichi

12. [On the coupled origin of the stellar IMF and multiplicity](#user-content-link12)
**Authors:** B. Thomasson, I. Joncour, E. Moraux, F. Motte, T. Yoo, A. Ginsburg

13. [Wide binaries without viable bound Newtonian orbits](#user-content-link13)
**Authors:** L. Pasquini, R. Saglia, F. Patat, L. Berni, D. Bossini, L. Magrini, H. Ludwig, M. T. Murphy, J. R. de Medeiros, J. Chanam\'e

14. [Limb Shift of the Fe I 6569 {\AA} line on the Sun](#user-content-link14)
**Authors:** H. C. Yu, M. D. Ding, J. Hong, Y. K. Wang, Z. Li

15. [Evolution of dust attenuation in star-forming galaxies with UV slope, stellar mass, and redshift out to $z \sim 5$](#user-content-link15)
**Authors:** J. V. Wijesekera, M. P. Koprowski, J. S. Dunlop, K. Lisiecki, D. J. McLeod, R. J. McLure, M. J. Micha{\l}owski, M. Solar

16. [A high rate of foreground contaminants toward high-redshift galaxies resolved by JWST](#user-content-link16)
**Authors:** Weiyang Liu, Linhua Jiang

17. [The incidence of LBV variability in the LMC](#user-content-link17)
**Authors:** V. M. Kalari, J. S. Vink, C. Furey, R. Salinas, A. Udalski, M. Pawlak

18. [Weak Lensing Low Multipoles](#user-content-link18)
**Authors:** Albert Bonnefous, Roya Mohayaee

19. [Unclustered tracers remain unclustered: the lack of primordial non-Gaussianity response of bias-zero tracers](#user-content-link19)
**Authors:** Celia Merino, Santiago Avila, A. G. Adame, A. Anguren, V. Gonzalez-Perez, J. Meneses-Rizo

20. [Measurement of the Hubble constant using the Dark Energy Survey Year 6 Gold galaxy catalog and the fourth Gravitational-Wave Transient Catalog](#user-content-link20)
**Authors:** Isaac McMahon, Danny Laghi, Marcelle Soares-Santos, Kendall Ackley, Gergely D\'alya, Yavuz Gen\c{c}el, David S\'anchez-Cid, Felipe Andrade-Oliveira, Sean MacBride, Christian Chapman-Bird, Rachel Gray, Alexander Papadopoulos

21. [Parametric Resonance and Backreaction Effects in Magnetogenesis from Ultralight Dark Matter](#user-content-link21)
**Authors:** Nirmalya Brahma (McGill University), Robert Brandenberger (McGill University)

22. [Nonlinear Saturation of the Acoustic Resonant Drag Instability](#user-content-link22)
**Authors:** Ben Y. Israeli, Jonathan Squire, Eric Moseley, Amitava Bhattacharjee

23. [The Atacama Cosmology Telescope: Constraints on Local Non-Gaussianity from the ACT Cluster Catalog](#user-content-link23)
**Authors:** Leonid Sarieddine, J. Richard Bond, Matt Hilton, Raul Jimenez, Arthur Kosowsky, Kavilan Moodley, Bernardita Ried Guachalla, Crist\'obal Sif\'on, Suzanne T. Staggs, Licia Verde, Edward J. Wollack

24. [Modeling X-ray Bursting Neutron Star Atmospheres](#user-content-link24)
**Authors:** Lourenzo Colleyn, Zach Medin, Alan Calder

25. [SN 2024abfl: A Low-Luminosity Type IIP Supernova in NGC 2146 from a Low-Mass Red Supergiant Progenitor](#user-content-link25)
**Authors:** Xiaohan Chen, Ning-Chen Sun, Qiang Xi, Chun Chen, Yu Zhang, Zexi Niu, Junjie Jin, Yiming Mao, Beichuan Wang, Samaporn Tinyanont, Krittapas Chanchaiworawit, Kanthanakorn Noysena, David Aguado, Ismael Perez-Fournon, Fr\'ed\'eric Poidevin, Justyn R. Maund, Xunhao Chen, Pengliang Du, David L\'opez Fern\'andez-Nespral, Liguo Fang, Guolin Gao, Jiupeng Guo, Min He, Xinyi Hong, Zhigang Hou, Qingzheng Li, Wenxiong Li, Tongyu Liu, Alicia L\'opez-Oramas, Haiyang Mu, C\'esar Rojas-Bravo, Jianfeng Tian, Jinhui Wang, Lingzhi Wang, Rui Wang, Yanan Wang, Ziyang Wang, Klaas Wiersema, Ying Wu, Guo Zhen, Jie Zheng, Guoyin Zhu, Yinan Zhu, Zhou Fan, Jing Li, Hong Wu, Jifeng Liu

26. [SN 2017ati: A luminous type IIb explosion from a massive progenitor](#user-content-link26)
...
27. [The Standard siren tests of viable $f(R)$ cosmologies](#user-content-link27)
**Authors:** Yi Zhang, Xuanjun Niu, Xianfu Su, Dong-Ze He

28. [EPISODE III: The Nested Jet/Outflow Morphology of EC 53 Revealed by JWST and ALMA](#user-content-link28)
**Authors:** Seonjae Lee, Jeong-Eun Lee, Chul-Hwan Kim, Seokho Lee, Doug Johnstone, Gregory J. Herczeg, Joel Green, Logan Francis, Yao-Lun Yang, Hyundong Lee, Nagayoshi Ohashi

29. [Primordial black holes as cosmic accelerators of light dark matter: Novel direct detection constraints](#user-content-link29)
**Authors:** Sk Jeesun, Anirban Majumdar, Rahul Srivastava

30. [A Quantum Computing Framework for VLBI Data Correlation](#user-content-link30)
**Authors:** Lei Liu

31. [$\gamma$-Ray Lines -- Signatures of Nucleosynthesis, Cosmic Rays, Positron Annihilation, and Fundamental Physics](#user-content-link31)
...
32. [Dynamical Systematics on Time Delay Lenses and the Impact on the Hubble Constant](#user-content-link32)
**Authors:** R. For\'es-Toribio, C. S. Kochanek, J. A. Mu\~noz

33. [From Nonparametric Distance Reconstruction to Testing the Etherington Relation and Cosmic Curvature Using 2D and 3D BAO Measurements](#user-content-link33)
**Authors:** Darshan Kumar (HNAS), Jie Zheng (HNAS), Zhi-Qiang You (HNAS), Da-Chun Qiang (HNAS)

34. [Separation of polarized dust emission in Planck observations with Scattering Transforms](#user-content-link34)
**Authors:** Alexandros Tsouros, Elisa Russier, Erwan Allys, Constant Auclair, Fran\c{c}ois Boulanger, Jacques Delabrouille

35. [Discovery of crested quasi-periodic eruptions following the most luminous SRG/eROSITA tidal disruption event](#user-content-link35)
**Authors:** Pietro Baldini, Arne Rau, Andrea Merloni, Benny Trakhtenbrot, Riccardo Arcodia, Margherita Giustini, Giovanni Miniutti, Se\'an J. Brennan, Michael Freyberg, Paula S\'anchez-S\'aez, Iuliia Grotova, Zhu Liu, Tianying Lian, Kirpal Nandra

36. [Intermediate-Mass Black Hole Formation from Hierarchical Mergers in Galactic Nuclei](#user-content-link36)
**Authors:** Amanda Newton, Sanaea C Rose, Fulya Kiroglu, Bao-Minh Hoang, Frederic Rasio

37. [An Afterglow Study of the "New Year's Burst" GRB 220101A](#user-content-link37)
...
38. [McFACTS IV: Electromagnetic Counterparts to AGN Disk Embedded Binary Black Hole Mergers](#user-content-link38)
**Authors:** Emily McPike, Rosalba Perna, K. E. Saavik Ford, Barry McKernan, Vera Delfavero, Miranda McCarthy, Kaila Nathaniel, Jake Postiglione, Nicolas Posner, Varun Pritmani, Shawn Ray, Richard O'Shaughnessy

39. [A model-independent measurement of the Hubble constant from gravitational-wave standard sirens and electromagnetic observations](#user-content-link39)
**Authors:** Gaurav N. Gadbail, Kazuharu Bamba

40. [A gas-phase "top-down" chemical link between aldehydes and alcohols](#user-content-link40)
**Authors:** Christopher N. Shingledecker, Germ\'an Molpeceres, A. Mackenzie Flowers, Deaton Warren, Emma Stanley, Anthony Remijan

41. [Constraints on cyclotron features and accretion regime in the high-mass X-ray binary 4U 1700--37 from NuSTAR](#user-content-link41)
**Authors:** Lautaro West-Ocampo, Federico A. Fogantini, Enzo A. Saavedra, Jorge A. Combi, Federico Garc\'ia, Pedro L. Luque-Escamilla, Josep Mart\'i, Sylvain Chaty, Juan F. Albacete-Colombo

42. [Eigenmodes in an ultra-relativistic ultra-magnetized pair QED-plasma](#user-content-link42)
**Authors:** Ryan T. Low, Mikhail V. Medvedev

43. [Atom Addition Formation of Thionylimide (HNSO) on Interstellar Dust Grains: Chemical routes requiring oxygen and nitrogen atom surface diffusion](#user-content-link43)
**Authors:** Juan Carlos del Valle, Miguel Sanz-Novo, Johannes K\"astner, Kenji Furuya, V\'ictor M. Rivilla, Rafael Mart\'in-Dom\'nech, Germ\'an Molpeceres

44. [Ultralight time-oscillating scalars from magnetized compact stars: electrophilic radiation and photon propagation effects](#user-content-link44)
**Authors:** Tanmay kumar Poddar, Gaetano Lambiase

45. [Early Stages of Protostellar Disk Evolution: A Link to the Initial Cloud Core](#user-content-link45)
**Authors:** Majd Noel, Rahul Khanna, Shahram Abbassi, Sami Dib, Shantanu Basu

46. [A Two-Dimensional Analytic Solution for the Generation of Hyperbolic Trajectories Via A Single Close Encounter with Applications To Interstellar Objects](#user-content-link46)
**Authors:** Hayden Monk, Darryl Z. Seligman

47. [Emergence of cyclic flux eruptions in kinetic simulations of magnetized spherical accretion onto a Schwarzschild black hole](#user-content-link47)
**Authors:** Enzo Figueiredo, John Mehlhaff, Adrien Soudais, Beno\^it Cerutti

48. [Near-Resonant Thermal Leptogenesis](#user-content-link48)
**Authors:** Angus Spalding

49. [WFC3/UVIS Geometric Distortion -- Time Evolution of Linear Terms w.r.t Gaia](#user-content-link49)
**Authors:** Anne O'Connor, Varun Bajaj, Jennifer Mack, Annalisa Calamida

50. [Kinematic-Distance Biases in the Inner Milky Way from a Stellar-Dynamically Constrained Bar](#user-content-link50)
**Authors:** Junichi Baba (Kagoshima U./NAOJ)

51. [Neutron Dark Decay and Exotic Compact Objects](#user-content-link51)
**Authors:** M. Vikiaris, V. Petousis, M. Veselsky, Ch. C. Moustakidis

52. [Cosmic Ray Inter-Station Correlation Variations as Precursors of Geomagnetic Storms: A Statistical Study and Multi-Parameter Early Warning Framework](#user-content-link52)
**Authors:** Haoyang Li, Zongyuan Ge, Zhaoming Wang

53. [A simple mechanism for the enhancement of the inflationary power spectrum](#user-content-link53)
**Authors:** I. Dalianis, A. Katsis, N. Tetradis

54. [Electromagnetic Couplings of Dark Domain Walls](#user-content-link54)
**Authors:** Nemanja Kaloper

55. [Propulsion Trades for a 2035-2040 Solar Gravitational Lens Mission](#user-content-link55)
**Authors:** Slava G. Turyshev

56. [The Frequency of Solar Eclipses for a Given Place: A New Approach to a Classic Question](#user-content-link56)
**Authors:** Graham Jones, Renate Mauland-Hus, Frank Thomas Tveter, Anne Buckle, S\'ebastien Emonet, Adalbert Michelic, Anna Smith, David Usken, Steffen Thorsen

57. [Expanding the Horizon of Black Hole Imaging with AtLAST](#user-content-link57)
**Authors:** Kazunori Akiyama, Mariafelicia De Laurentis, Ziri Younsi, Yuto Akiyama, Dominic W. Pesce, Geoffrey C. Bower, Kazuhiro Hada, Jens Kauffmann, Shoko Koyama, Kotaro Moriyama, Derek-Ward Thompson

58. [GASV: A New VLBI analysis software for Geodesy and Astrometry](#user-content-link58)
**Authors:** Dang Yao, Yuan-wei Wu, Xu-hai Yang

59. [Thermal conductivity of various CFRPs from 100 mK to 20 K](#user-content-link59)
**Authors:** Valentin Sauvage

60. [Impact of Higher-Order Modes on Eccentricity Measurement in Binary Black Hole Gravitational Waves](#user-content-link60)
**Authors:** Honglue Tang, Jinzhao Yang, Baoxiang Wang, Tao Yang

61. [The EXoplanet Climate Infrared TElescope (EXCITE): A balloon-borne mission to measure spectroscopic phase curves of transiting hot Jupiters](#user-content-link61)
**Authors:** Timothy D. Rehm, Caitlyn Altermatt, Lee Bernard, Andrea Bocchieri, Nathaniel Butler, Oliver Carey, Ryan C. Challener, John Hartley, Kyle R. Helson, Daniel P. Kelly, Kanchita Klangboonkrong, Andrei L. Korotkov, Maura Lally, Edward Leong, Nikole K. Lewis, Steven Li, Michael Line, Stephen F. Maher, Ryan McClelland, Lorenzo V. Mugnai, Peter C. Nagler, C. Barth Netterfield, Vivien Parmentier, Enzo Pascale, Jennifer Patience, L. Javier Romualdez, Paul A. Scowen, Gregory S. Tucker, Ingo Waldmann

62. [Lessons Learned from Integrating Generative AI into an Introductory Undergraduate Astronomy Course at Harvard](#user-content-link62)
**Authors:** Christopher W. Stubbs, Dongpeng Huang, Jungyoon Koh, Madeleine Woods, Andr\'es A. Plazas Malag\'on

63. [The Landscape of Undergraduate Astronomy and Astrophysics Degree Requirements](#user-content-link63)
...
## 1. [Variable Modified Newtonian Mechanics VIII: Ultra faint dwarfs in Milky Way](https://arxiv.org/abs/2602.04273) <a id="link1"></a>
...
**Comment:** Directly relevant to near-field cosmology: focuses on ultra faint dwarf galaxies in the Milky Way and their velocity dispersions, which is a core topic. Also touches on dark matter density profiles (core-cusp) via modified gravity models.
...
## 3. [Low-mass stars dominate the hot (0.7 keV) Galactic X-ray emission](https://arxiv.org/abs/2602.03941) <a id="link3"></a>
...
**Comment:** This paper analyzes the origin of the hot (0.7 keV) Galactic X-ray emission and finds that low-mass stars dominate this emission, with implications for the circumgalactic medium (CGM) of the Milky Way. It directly addresses the 'Circumgalactic Medium' criterion, discussing the nature and density constraints of the CGM and its connection to stellar populations. The findings have implications for models of the CGM in external galaxies.
...
## 4. [Stellar Interpretation of Meteoritic Data and PLotting for Everyone (SIMPLE): Isotope Mixing Lines for Six Sets of Core-Collapse Supernova Models](https://arxiv.org/abs/2602.04354) <a id="link4"></a>
...
**Comment:** This paper presents a new open-source tool (SIMPLE) for comparing isotopic compositions from core-collapse supernova models with meteoritic data. It is relevant to stellar models, specifically nucleosynthesis and isotopic abundances, which are part of the 'Stellar Models' criterion. The tool and dataset are new, and the work is directly related to stellar evolution and nucleosynthesis.
...
## 6. [The local void model for the Hubble and BAO tensions](https://arxiv.org/abs/2602.03928) <a id="link6"></a>
...
**Comment:** This paper discusses the local void model as a solution to the Hubble and BAO tensions, referencing the KBC void and local underdensity. While it touches on local cosmology and galaxy number counts, it does not directly address dwarf satellites, resolved star formation histories, or galaxy simulations.
...
## 8. [Diagnostics for the solar chromosphere using neutral carbon Rydberg lines](https://arxiv.org/abs/2602.04848) <a id="link8"></a>
...
**Comment:** The paper models neutral carbon Rydberg lines for solar chromosphere diagnostics. It presents new stellar atmosphere modeling, which matches the 'Stellar Models' criterion, though the focus is on the Sun rather than broader stellar populations or evolutionary tracks.
...
## 9. [From Main Sequence Binary to Blast: MESA Modeling of the Double-Detonation Progenitor PTF1~J2238+7430](https://arxiv.org/abs/2602.04421) <a id="link9"></a>
...
**Comment:** This paper uses MESA to model the binary evolution of a system that could be a double-detonation supernova progenitor. It is relevant to the 'Stellar Models' criterion due to its use of detailed stellar evolution modeling and binary evolution simulations. However, it does not address galaxy-scale phenomena or dwarf galaxies.
...
## 10. [An emulator for the ionizing photon mean free path in ultra-high resolution simulations: the implications of mean free path measurements for the reionization history](https://arxiv.org/abs/2602.03923) <a id="link10"></a>
...
**Comment:** This paper presents a deep learning emulator for the ionizing photon mean free path in ultra-high resolution simulations, with implications for reionization history. While it involves high-resolution simulations and radiative transfer, the focus is on the epoch of reionization and large-scale cosmology, not on resolved star formation histories, dwarf galaxies, or near-field cosmology. It is borderline relevant for the 'Numerical Galaxy Simulations' criterion, but does not directly address galaxy-scale physics.
...
## 11. [Large-scale halo velocity correlations and the impact of finite simulation volumes](https://arxiv.org/abs/2602.04485) <a id="link11"></a>
...
**Comment:** This paper investigates velocity correlation functions of dark matter halos in N-body simulations, focusing on the impact of finite simulation volumes. It is relevant to numerical galaxy simulations, especially regarding simulation methodology and halo statistics, but does not present new galaxy formation physics or focus on dwarf galaxies. Solid relevance for simulation methodology.
...
## 12. [On the coupled origin of the stellar IMF and multiplicity](https://arxiv.org/abs/2602.03976) <a id="link12"></a>
...
**Comment:** This paper presents a theoretical model for the origin of the stellar IMF and multiplicity, using hierarchical fragmentation. It is relevant to the 'Stellar Models' criterion, as it discusses the formation and properties of stellar populations, but does not present new stellar evolutionary tracks or atmosphere models. Borderline relevance.
...
## 13. [Wide binaries without viable bound Newtonian orbits](https://arxiv.org/abs/2602.04661) <a id="link13"></a>
...
**Comment:** The study uses wide binaries to test gravity in the low acceleration regime, which is tangentially related to near-field cosmology through the context of Milky Way stellar populations and Galactic tides. However, it does not focus on dwarf galaxies, satellite systems, or resolved star formation histories.
...
## 14. [Limb Shift of the Fe I 6569 {\AA} line on the Sun](https://arxiv.org/abs/2602.04274) <a id="link14"></a>
...
**Comment:** The paper analyzes the limb shift effect in a solar photospheric line using observations and simulations. It is relevant to 'Stellar Models' as it involves numerical simulations of stellar atmospheres and line formation, but does not present new stellar evolutionary tracks or bolometric corrections. Borderline relevance.
...
## 17. [The incidence of LBV variability in the LMC](https://arxiv.org/abs/2602.04645) <a id="link17"></a>
...
**Comment:** The paper quantifies LBV-like variability in blue supergiants in the LMC using OGLE survey data. While it is an observational study of massive stars in the LMC, it does not focus on resolved star formation histories, dwarf galaxies, or galaxy-scale processes. It is tangentially related to stellar models but does not present new models.
...
## 18. [Weak Lensing Low Multipoles](https://arxiv.org/abs/2602.04504) <a id="link18"></a>
...
**Comment:** Weak lensing analysis with some connection to Milky Way-like environments, but the focus is on large-scale structure and cosmic dipole anomalies, not on dwarf galaxies, resolved star formation histories, or other core topics.
...
## 19. [Unclustered tracers remain unclustered: the lack of primordial non-Gaussianity response of bias-zero tracers](https://arxiv.org/abs/2602.04698) <a id="link19"></a>

**ArXiv ID:** 2602.04698

**Authors:** Celia Merino, Santiago Avila, A. G. Adame, A. Anguren, V. Gonzalez-Perez, J. Meneses-Rizo

**Abstract:** Constraining primordial non-Gaussianities (PNG) is one of the main goals of new-generation large-scale galaxy surveys. It had been proposed that unclustered tracers (with bias $b_1=0$) could be optimal for PNG studies, and that these could be found by selecting galaxies in bins of their local density. Here, we test this hypothesis in state-of-the-art simulations from the PNG-UNITsim suite with local $f_{\rm NL}=100$ and $f_{\rm NL}=-20$. We consider different parent tracer catalogues: all halos together, halos in large mass bins, and HOD models for LRGs and QSO. We then classify these tracers by their local density ($\delta_{t,R}$) and measure the linear bias ($b_1$) and PNG-response ($b_\phi$). Most $\delta_{t,R}$ bins show a PNG-response compatible with $b_\phi=0$ for all halos or the low-mass bin (log$M$12), QSO or LRG, we recover a trend closer to the universality relation ($b_\phi = 2 \delta_{\rm crit}(b_1-1)$) for $b_1>1$, but the $b_\phi(b_1)$ curve flattens to 0 below $\vert b_1\lvert<1$. Hence, we find $b_\phi\approx0$ for all bias-zero tracers considered. The complex $\delta_{t,R}$-based selection causes their clustering to strongly deviate from simple assumptions, namely the universality relation and Poisson shot noise, hindering their capability to constrain PNG.

**Comment:** The paper investigates the clustering properties of bias-zero tracers in simulations to constrain primordial non-Gaussianity. While it uses galaxy simulations, the focus is on large-scale structure and primordial non-Gaussianity, not on galaxy formation, dwarf galaxies, or resolved star formation histories.
...
## 20. [Measurement of the Hubble constant using the Dark Energy Survey Year 6 Gold galaxy catalog and the fourth Gravitational-Wave Transient Catalog](https://arxiv.org/abs/2602.04766) <a id="link20"></a>

**ArXiv ID:** 2602.04766

**Authors:** Isaac McMahon, Danny Laghi, Marcelle Soares-Santos, Kendall Ackley, Gergely D\'alya, Yavuz Gen\c{c}el, David S\'anchez-Cid, Felipe Andrade-Oliveira, Sean MacBride, Christian Chapman-Bird, Rachel Gray, Alexander Papadopoulos

**Abstract:** Gravitational wave standard sirens enable independent measurements of the Hubble constant $H_0$. In the absence of electromagnetic counterparts, the "dark siren" method statistically correlates GW events with potential host galaxies. We present a measurement of $H_0$ using 142 compact binary coalescences from the fourth Gravitational-Wave Transient Catalog (GWTC-4.0) combined with the Dark Energy Survey Year 6 Gold photometric galaxy catalog. Using the gwcosmo pipeline, we jointly infer cosmological and GW population parameters. We analyze the impact of galaxy catalog properties on the inference, identifying significant features in the galaxy redshift distribution which can introduce biases. By restricting the galaxy catalog to $0.05<0.35$ to maintain consistency with a uniform in comoving volume galaxy distribution, we obtain a result of $H_0 = 70.9^{+22.3}_{-18.6}\;\text{km}\;\text{s}^{-1}\;\text{Mpc}^{-1}$ from dark sirens and $H_0=73.1^{+11.7}_{-8.6}\;\text{km}\;\text{s}^{-1}\;\text{Mpc}^{-1}$ when combined with the bright siren GW170817. This study demonstrates the adaptation of deep galaxy catalogs for GW cosmology, highlighting key challenges and methodologies essential for maximizing the potential of next-generation galaxy surveys.

**Comment:** This paper focuses on measuring the Hubble constant using gravitational wave events and galaxy catalogs. While it uses galaxy catalogs, the focus is on cosmological parameters and not on near-field cosmology, resolved star formation histories, or dwarf galaxies. No core criteria are closely matched.
...
## 21. [Parametric Resonance and Backreaction Effects in Magnetogenesis from Ultralight Dark Matter](https://arxiv.org/abs/2602.04285) <a id="link21"></a>
...
**Comment:** Discusses magnetogenesis from ultralight dark matter, which is tangentially related to dark matter but does not address near-field cosmology, dwarf galaxies, or other core topics.
...
## 22. [Nonlinear Saturation of the Acoustic Resonant Drag Instability](https://arxiv.org/abs/2602.04710) <a id="link22"></a>
...
**Comment:** This paper presents simulations of the nonlinear saturation of the acoustic resonant drag instability (RDI), which is a dust/fluid instability relevant to various astrophysical environments. While it involves numerical simulations, the focus is on dust-gas interactions and turbulence, not on galaxy-scale simulations, star formation histories, or near-field cosmology.
...
## 23. [The Atacama Cosmology Telescope: Constraints on Local Non-Gaussianity from the ACT Cluster Catalog](https://arxiv.org/abs/2602.03917) <a id="link23"></a>
...
**Comment:** This paper uses the ACT cluster catalog to constrain local-type primordial non-Gaussianity via cluster number counts. While it deals with galaxy clusters and cosmological parameters, it does not address any of the core topics such as dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 24. [Modeling X-ray Bursting Neutron Star Atmospheres](https://arxiv.org/abs/2602.03982) <a id="link24"></a>
...
**Comment:** The paper presents a computational model for simulating radiation transfer in X-ray bursting neutron star atmospheres. It is focused on neutron star atmospheres and does not present new stellar evolutionary tracks or atmosphere models for broader stellar populations.
...
## 25. [SN 2024abfl: A Low-Luminosity Type IIP Supernova in NGC 2146 from a Low-Mass Red Supergiant Progenitor](https://arxiv.org/abs/2602.04309) <a id="link25"></a>
...
**Comment:** This paper presents observations and modeling of a low-luminosity Type IIP supernova from a low-mass red supergiant progenitor. While it discusses stellar evolution and supernovae, it does not address dwarf galaxies, resolved star formation histories, or galaxy simulations. The focus is on individual stellar events, not galaxy-scale processes.
...
## 26. [SN 2017ati: A luminous type IIb explosion from a massive progenitor](https://arxiv.org/abs/2602.04474) <a id="link26"></a>
...
**Comment:** This paper presents observations and modeling of a luminous Type IIb supernova from a massive progenitor. The focus is on supernovae and progenitor properties, not on galaxy-scale processes, dwarf galaxies, or resolved star formation histories.
...
## 28. [EPISODE III: The Nested Jet/Outflow Morphology of EC 53 Revealed by JWST and ALMA](https://arxiv.org/abs/2602.04688) <a id="link28"></a>
...
**Comment:** This study investigates the jet and outflow morphology of a protostar using JWST and ALMA. While it discusses outflows, these are protostellar (not galaxy-scale) and do not pertain to star-formation-driven outflows in galaxies or the CGM. No direct connection to the core topics.
...
## 29. [Primordial black holes as cosmic accelerators of light dark matter: Novel direct detection constraints](https://arxiv.org/abs/2602.04858) <a id="link29"></a>
...
**Comment:** This paper focuses on direct detection constraints for light dark matter produced by primordial black hole evaporation. While it discusses dark matter and cosmic accelerators, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on particle physics and detection methods, not on galaxy-scale phenomena.
...
## 30. [A Quantum Computing Framework for VLBI Data Correlation](https://arxiv.org/abs/2602.04269) <a id="link30"></a>
...
**Comment:** This paper presents a quantum computing framework for VLBI data correlation. While innovative, it is focused on computational methods for radio astronomy and does not address any of the core topics such as near-field cosmology, galaxy simulations, or stellar models.
...
## 32. [Dynamical Systematics on Time Delay Lenses and the Impact on the Hubble Constant](https://arxiv.org/abs/2602.03934) <a id="link32"></a>

**ArXiv ID:** 2602.03934

**Authors:** R. For\'es-Toribio, C. S. Kochanek, J. A. Mu\~noz

**Abstract:** While time-delay lenses can be an independent probe of $H_0$ the estimates are degenerate with the convergence of the lens near the Einstein radius. Velocity dispersions, $\sigma$, can be used to break the degeneracy, with uncertainties $\Delta H/H_0 \propto \Delta\sigma^2/\sigma^2$ ultimately limited by the systematic uncertainties in the kinematic measurements - measuring $H_0$ to 2% requires $\Delta\sigma^2/\sigma^2$ < 2%. Here we explore a broad range of potential systematic uncertainties contributing to eight time-delay lenses used in cosmological analyses. We find that: (1) The characterization of the PSF both in absolute scale and in shape is important, with biases in $\Delta\sigma^2/\sigma^2$ up to 1-6%, depending on the lens system. Small slit miscenterings of the lens are less important. (2) The difference between the measured velocity dispersion and the mean square velocity needed for the Jeans equations is important, with up to $\Delta\sigma^2/\sigma^2 \sim$ 3-8%. (3) The choice of anisotropy models is important with maximum changes of $\Delta\sigma^2/\sigma^2 \sim$ 5-18% and the frequently used Osipkov-Merritt models do not produce $h_4$ velocity moments typical of early-type galaxies. (4) Small differences between the true stellar mass distribution and the model light profile matter ($\Delta\sigma^2/\sigma^2 \sim$ 5-40%), with radial color gradients further complicating the problem. Finally, we discuss how the homogeneity of the early-type galaxy population means that many dynamically related parameters must be marginalized over the lens sample as a whole and not over individual lenses.

**Comment:** The paper discusses systematic uncertainties in time-delay lensing measurements of the Hubble constant, focusing on early-type galaxies and lens modeling. It does not address dwarf galaxies, near-field cosmology, or any of the core criteria.
...
## 34. [Separation of polarized dust emission in Planck observations with Scattering Transforms](https://arxiv.org/abs/2602.04528) <a id="link34"></a>
...
**Comment:** This paper focuses on separating polarized dust emission in Planck observations using scattering transforms. While it deals with astrophysical foregrounds relevant to CMB studies, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 35. [Discovery of crested quasi-periodic eruptions following the most luminous SRG/eROSITA tidal disruption event](https://arxiv.org/abs/2602.03932) <a id="link35"></a>
...
**Comment:** Focuses on tidal disruption events and quasi-periodic eruptions in galactic nuclei, which is not relevant to any of the core criteria (e.g., near-field cosmology, dwarf galaxies, star formation histories, etc.).
...
## 36. [Intermediate-Mass Black Hole Formation from Hierarchical Mergers in Galactic Nuclei](https://arxiv.org/abs/2602.04176) <a id="link36"></a>
...
**Comment:** Examines black hole mergers and intermediate-mass black hole formation in galactic nuclei, with a focus on nuclear star clusters and supermassive black holes. Not relevant to dwarf galaxies, star formation histories, or other core topics.
...
## 37. [An Afterglow Study of the "New Year's Burst" GRB 220101A](https://arxiv.org/abs/2602.04660) <a id="link37"></a>

**ArXiv ID:** 2602.04660

**Authors:** Agniva Roychowdhury, Tuomas Kangas, Andrew Fruchter, A. Pe'er, K. Bhirombhakdi, J. Graham, K. Misra, A. J. Levan, B. Cenko, A. Cucchiara, V. Cunningham, B. P. Gompertz, D. Perley, J. Racusin, N. R. Tanvir

**Abstract:** We present a detailed broadband afterglow study of GRB 220101A ($10^4\lesssim\Delta T\lesssim10^7$ s) combining multi-wavelength data from soft X-rays until 6 GHz. The afterglow light curves in both X-ray and optical show distinct steepening around $\sim9$ days, followed by a sharp post-break decay index of $\sim2.99\pm0.10$. We fit the light curves using the afterglow modelling package \texttt{afterglowpy} for both Top-hat and Gaussian jets for different values of the electronic participation fraction $\xi$ from 0.01 to 1.0 and find that, although the radio behavior is well described by the $\xi=1.0$ case, the required circumburst medium (CBM) densities are very low, $1$ cm$^{-3}$) of GRB environments, which are highly star forming regions. Similarly low ISM densities have been seen in modeling of other LAT GRBs as well, especially ones with reverse-shock features (e.g., GRBs 130427A, 160509A and 160625B), thereby hinting at either an issue with the standard model or possible evacuated cavities where GRBs explode.

**Comment:** This paper presents a detailed afterglow study of a gamma-ray burst (GRB) and discusses the circumburst medium densities and possible evacuated cavities. However, it does not focus on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, or CGM. The focus is on GRB environments, which are not directly relevant to the core topics.
...
## 38. [McFACTS IV: Electromagnetic Counterparts to AGN Disk Embedded Binary Black Hole Mergers](https://arxiv.org/abs/2602.04135) <a id="link38"></a>
...
**Comment:** This paper models electromagnetic counterparts to binary black hole mergers in AGN disks. It focuses on black hole mergers and AGN environments, which are not relevant to the core topics of near-field cosmology, dwarf galaxies, or galaxy-scale processes.
...
## 39. [A model-independent measurement of the Hubble constant from gravitational-wave standard sirens and electromagnetic observations](https://arxiv.org/abs/2602.04497) <a id="link39"></a>
...
**Comment:** This work presents a model-independent measurement of the Hubble constant using gravitational-wave and electromagnetic observations. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 40. [A gas-phase "top-down" chemical link between aldehydes and alcohols](https://arxiv.org/abs/2602.03989) <a id="link40"></a>
...
**Comment:** This paper focuses on astrochemical modeling of alcohols and aldehydes in the interstellar medium, specifically in the Sgr B2 (N) star-forming region. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 41. [Constraints on cyclotron features and accretion regime in the high-mass X-ray binary 4U 1700--37 from NuSTAR](https://arxiv.org/abs/2602.04622) <a id="link41"></a>
...
**Comment:** This paper analyzes X-ray properties of a high-mass X-ray binary, focusing on accretion physics and magnetic field constraints. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 42. [Eigenmodes in an ultra-relativistic ultra-magnetized pair QED-plasma](https://arxiv.org/abs/2602.04065) <a id="link42"></a>
...
**Comment:** This paper investigates plasma eigenmodes in ultra-relativistic, ultra-magnetized pair QED-plasmas, relevant for neutron stars and magnetars. It does not address any of the core topics such as galaxy simulations, dwarf galaxies, or star formation histories.
...
## 43. [Atom Addition Formation of Thionylimide (HNSO) on Interstellar Dust Grains: Chemical routes requiring oxygen and nitrogen atom surface diffusion](https://arxiv.org/abs/2602.04374) <a id="link43"></a>
...
**Comment:** This paper focuses on astrochemical modeling of HNSO formation on interstellar dust grains, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The work is more relevant to interstellar chemistry.
...
## 44. [Ultralight time-oscillating scalars from magnetized compact stars: electrophilic radiation and photon propagation effects](https://arxiv.org/abs/2602.03953) <a id="link44"></a>
...
**Comment:** This paper investigates ultralight scalars and their effects on magnetized compact stars, including pulsars. The focus is on fundamental physics and compact objects, not on galaxies, star formation histories, or near-field cosmology.
...
## 45. [Early Stages of Protostellar Disk Evolution: A Link to the Initial Cloud Core](https://arxiv.org/abs/2602.04701) <a id="link45"></a>
...
**Comment:** This paper studies the early evolution of protostellar disks and their link to the initial cloud core, focusing on angular momentum transport and disk stability. The topic is star formation and disk evolution, not galaxy-scale processes, resolved star formation histories, or near-field cosmology.
...
## 46. [A Two-Dimensional Analytic Solution for the Generation of Hyperbolic Trajectories Via A Single Close Encounter with Applications To Interstellar Objects](https://arxiv.org/abs/2602.04806) <a id="link46"></a>
...
**Comment:** This paper presents analytic solutions for the generation of hyperbolic trajectories via close encounters, with applications to interstellar objects. While it discusses ejection mechanisms in planetary systems, it does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 47. [Emergence of cyclic flux eruptions in kinetic simulations of magnetized spherical accretion onto a Schwarzschild black hole](https://arxiv.org/abs/2602.04519) <a id="link47"></a>
...
**Comment:** The paper presents kinetic simulations of magnetized spherical accretion onto a Schwarzschild black hole, focusing on flux eruptions and particle acceleration. The topic is accretion physics and black hole magnetospheres, which does not match any of the core criteria (no focus on galaxies, star formation, or related processes).
...
## 48. [Near-Resonant Thermal Leptogenesis](https://arxiv.org/abs/2602.04772) <a id="link48"></a>
...
**Comment:** This is a theoretical particle physics paper on leptogenesis and baryon asymmetry, which does not intersect with any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 49. [WFC3/UVIS Geometric Distortion -- Time Evolution of Linear Terms w.r.t Gaia](https://arxiv.org/abs/2602.04041) <a id="link49"></a>
...
**Comment:** This paper discusses the geometric distortion and astrometric calibration of HST WFC3/UVIS images with respect to Gaia. While high-precision astrometry is important for many fields, the focus here is on instrument calibration and not on any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 51. [Neutron Dark Decay and Exotic Compact Objects](https://arxiv.org/abs/2602.04477) <a id="link51"></a>
...
**Comment:** The paper discusses neutron dark decay and its implications for exotic compact objects and neutron stars. It does not address galaxies, star formation, or any of the core criteria.
...
## 52. [Cosmic Ray Inter-Station Correlation Variations as Precursors of Geomagnetic Storms: A Statistical Study and Multi-Parameter Early Warning Framework](https://arxiv.org/abs/2602.04427) <a id="link52"></a>
...
**Comment:** This paper studies cosmic ray inter-station correlation variations as precursors of geomagnetic storms, focusing on heliospheric disturbances and space weather prediction. It does not address any of the core topics such as galaxy evolution, star formation, or dwarf galaxies.
...
## 53. [A simple mechanism for the enhancement of the inflationary power spectrum](https://arxiv.org/abs/2602.04055) <a id="link53"></a>
...
**Comment:** The paper discusses a mechanism for enhancement of the inflationary power spectrum in two-field inflation models, with implications for primordial black holes and gravitational waves. It does not address any of the core topics such as galaxy evolution, star formation, or dwarf galaxies.
...
## 54. [Electromagnetic Couplings of Dark Domain Walls](https://arxiv.org/abs/2602.03933) <a id="link54"></a>
...
**Comment:** The paper extends Maxwell electrodynamics with a Chern-Simons coupling to a dark sector, focusing on domain walls and cosmic microwave background polarization. No core criteria are matched.
...
## 55. [Propulsion Trades for a 2035-2040 Solar Gravitational Lens Mission](https://arxiv.org/abs/2602.04198) <a id="link55"></a>

**ArXiv ID:** 2602.04198

**Authors:** Slava G. Turyshev

**Abstract:** The Solar Gravitational Lens (SGL) enables multipixel imaging and spatially resolved spectroscopy of a nearby terrestrial exoplanet from heliocentric distances $z\simeq 650$-$900$ AU, where solar power is negligible and transportation largely sets time-to-first-science. Reaching 650 AU in 20 yr implies a ballistic lower bound $\bar v_r \simeq 32.5~{\rm AU/yr}\simeq 154$ km/s, motivating propulsion beyond chemical and gravity-assist-only options. We compare close-perihelion solar sailing, fission-powered nuclear electric propulsion (NEP), and Oberth-enabled hybrid injection using simple time-to-distance models that isolate the long outbound leg (i.e., excluding architecture-dependent inner-solar-system injection overhead). For solar sailing, $r_p=0.05$ AU requires $\sigma_{\rm tot}\simeq 4.9~\mathrm{g\,m^{-2}}$ for $v_\infty\simeq 105$ km/s and $\sigma_{\rm tot}\simeq 2.3~\mathrm{g\,m^{-2}}$ for $v_\infty\simeq 155$ km/s, placing sub-20 yr sail-only access in an ultra-low-areal-density, deep-perihelion survivability regime. For NEP, a constant-power stage closure shows that a $m_0=20$ t spacecraft with $m_{\rm pay}=800$ kg and $\eta=0.7$ reaches 650 AU in ~27-33 yr for $\alpha_{\rm tot}=10$-$20~\mathrm{kg\,kW_e^{-1}}$ (typical optima $P_e\simeq 0.18$-$0.30~\mathrm{MW_e}$, thrust of a few newtons). NEP-only sub-20 yr transfers require extremely aggressive assumptions ($\alpha_{\rm tot}\lesssim 3~\mathrm{kg\,kW_e^{-1}}$ and very-high-$I_{\rm sp}$, long-life EP), whereas hybrid architectures become plausible for $\alpha_{\rm tot}\sim 10$-$15~\mathrm{kg\,kW_e^{-1}}$ if an injection stage supplies $v_0\gtrsim 50$-70 km/s prior to NEP cruise. We map these requirements to technology readiness and identify system-level demonstrations needed by the early 2030s for a credible 2035--2040 start.

**Comment:** This paper discusses propulsion technologies for a Solar Gravitational Lens mission, which is unrelated to galaxy formation, star formation, or any of the core criteria.
...
## 56. [The Frequency of Solar Eclipses for a Given Place: A New Approach to a Classic Question](https://arxiv.org/abs/2602.04797) <a id="link56"></a>
...
**Comment:** This paper presents a new statistical approach to the frequency of solar eclipses at a given location. It is unrelated to any of the core topics (galaxy evolution, star formation, dwarf galaxies, etc.).
...
## 57. [Expanding the Horizon of Black Hole Imaging with AtLAST](https://arxiv.org/abs/2602.04666) <a id="link57"></a>
...
**Comment:** Focuses on black hole imaging and demographics of supermassive black holes, not on galaxies, dwarfs, or any of the core criteria.
...
## 58. [GASV: A New VLBI analysis software for Geodesy and Astrometry](https://arxiv.org/abs/2602.04183) <a id="link58"></a>
...
**Comment:** This is a software paper for VLBI data analysis in geodesy and astrometry, with no connection to the core topics of near-field cosmology, galaxy simulations, or star formation histories.
...
## 59. [Thermal conductivity of various CFRPs from 100 mK to 20 K](https://arxiv.org/abs/2602.04020) <a id="link59"></a>
...
**Comment:** This paper measures the thermal conductivity of various carbon-fiber-reinforced polymers at cryogenic temperatures, relevant for spacecraft and aerospace engineering. It does not address any of the core astrophysical topics.
...
## 60. [Impact of Higher-Order Modes on Eccentricity Measurement in Binary Black Hole Gravitational Waves](https://arxiv.org/abs/2602.04642) <a id="link60"></a>
...
**Comment:** This paper analyzes the impact of higher-order gravitational wave modes on eccentricity measurements in binary black hole mergers. It is focused on gravitational wave data analysis and black hole binaries, which are not relevant to any of the specified criteria.
...
## 61. [The EXoplanet Climate Infrared TElescope (EXCITE): A balloon-borne mission to measure spectroscopic phase curves of transiting hot Jupiters](https://arxiv.org/abs/2602.04840) <a id="link61"></a>
...
**Comment:** This paper describes the EXCITE balloon mission for measuring spectroscopic phase curves of hot Jupiters. It is focused on exoplanet atmospheres and instrumentation, not on galaxies, star formation histories, or any of the core topics.
...
## 62. [Lessons Learned from Integrating Generative AI into an Introductory Undergraduate Astronomy Course at Harvard](https://arxiv.org/abs/2602.04389) <a id="link62"></a>
...
**Comment:** This paper describes the integration of generative AI into an undergraduate astronomy course. It is focused on educational methods and does not address any of the core research topics.
...
## 63. [The Landscape of Undergraduate Astronomy and Astrophysics Degree Requirements](https://arxiv.org/abs/2602.03959) <a id="link63"></a>
...
**Comment:** This paper surveys undergraduate astronomy and astrophysics degree requirements. It is an education-focused report and does not address any of the core scientific topics.
