...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 48586    | 8083         | 56669   |
| **Cost**             | $0.1     | $0.06        | $0.16   |

Total arXiv papers: 220

Total scanned papers: 133

Total relevant papers: 99

**Table of contents with paper titles:**

1. [Properties of Galactic Outflows Driven by Starburst at Cosmic Noon: Insights from Hydrodynamical Simulations](#user-content-link1)
**Authors:** Huan Chen, Weishan Zhu, Xue-Fu Li, Tian-Rui Wang, Antonios Katsianis, Long-Long Feng

2. [Massive Star Population in the Sextans A Dwarf Galaxy from HST UV Photometry](#user-content-link2)
**Authors:** Roberto Flores, Elena Fantino, Giuseppina Battaglia, Antonio Aparicio

3. [Toward a Comprehensive Grid of Cepheid Models with MESA II. Impact of Physical and Numerical Assumptions on Elemental Abundances](#user-content-link3)
**Authors:** O. Zi\'o{\l}kowska, R. Smolec, A. Thoul, R. Singh Rathour, V. Hocd\'e

4. [A comprehensive catalogue of high-mass X-ray binaries in the Large Magellanic Cloud detected during the first eROSITA all-sky survey](#user-content-link4)
...
5. [A mapping method of age estimation for binary stars: Application to the $\alpha$ Centauri system A and B](#user-content-link5)
**Authors:** F. Th\'evenin, V. A. Baturin, A. V. Oreshina, P. Morel, S. V. Ayukov, L. Bigot, A. B. Gorshkov

6. [Cosmology with one galaxy: An analytic formula relating $\Omega_{\rm m}$ with galaxy properties](#user-content-link6)
**Authors:** Kito Liao, Francisco Villaescusa-Navarro, Romain Teysser, Natal\'i S. M. de Santi

7. [New Approach to Superflare Energy Determination](#user-content-link7)
**Authors:** Petr Heinzel, Robert Falewicz, Kamil Bicz, Pawe{\l} Pre\'s

8. [Granulation signatures as seen by Kepler short-cadence data. I. A decoupling between granulation and oscillation timescales for dwarfs](#user-content-link8)
**Authors:** Jens R. Larsen, Mia S. Lundkvist, Martin B. Nielsen, Guy R. Davies, Yixiao Zhou, Mikkel N. Lund

9. [K-DRIFT Science Theme: Galaxies in the Faint Universe](#user-content-link9)
...
10. [A Detailed Model Atmosphere Analysis of Hot White Dwarfs in DESI DR1](#user-content-link10)
**Authors:** Mukremin Kilic, Pierre Bergeron, Adam Moss, Simon Blouin, Matthew J. Green, Gracyn Jewett, Manuel Barrientos, Alexander L. Albright, Warren R. Brown

11. [Stratification of the AGN-Driven multi-phase outflows in the dwarf Seyfert galaxy NGC 4395](#user-content-link11)
...
12. [Particle hydrodynamics with accurate gradients: a comparison of different formulations](#user-content-link12)
**Authors:** S. Rosswog

13. [AGN versus Star-formation: A MUSE Analysis of NGC 1365](#user-content-link13)
**Authors:** Kyla Mullaney, Kelly E. Whalen, Jenna Cann, Kimberly Weaver, Jeffrey McKaig, Sara Doan

14. [Emergence of a lithium dip in ~35 Myr "Snake" Open Clusters](#user-content-link14)
**Authors:** Yun-Yi Zhang, Hai-Jun Tian, Jian-Rong Shi, Cheng-Cheng Xie, Xiang-Ming Yang

15. [Clump-Scale Dust Attenuation in Epoch of Reionization Galaxies: Spatially Resolved Properties from FirstLight Simulations](#user-content-link15)
**Authors:** Yurina Nakazato, Kosei Matsumoto, Akio K. Inoue, Daniel Ceverino, Takashi Hosokawa, Daisuke Toyouchi

16. [Synchrotron Self-Compton Process for Constraining sub-GeV Dark Matter in Omega Centauri via SKA](#user-content-link16)
**Authors:** Guan-Sen Wang, Bing-Yu Su, Yang Yu, Bo Zhang, Lei Feng

17. [Exploring the dynamical evolution of binary stars in multiple-population globular clusters](#user-content-link17)
**Authors:** J. Bruce, E. Vesperini, A. Askar, E. Bortolan, M. Giersz, J. Hong, A. Hypki, A. P. Milone

18. [Dynamics of Y Dwarf Atmospheres](#user-content-link18)
**Authors:** C. Ak{\i}n, E. K. H. Lee, L. Gkouvelis, K. Heng

19. [Towards FAIR Astrophysical Simulations](#user-content-link19)
**Authors:** Susanne Pfalzner, Stephan Hachinger, Jolanta Zjupa, Salvatore Cielo, Frank W. Wagner, Marcus Br\"uggen, Annika Hagemeier

20. [Gravitational Wave Informed Inference of 21-cm Global Signal Parameters](#user-content-link20)
**Authors:** Avinash Tiwari, Sajad A. Bhat, Tirthankar Roy Choudhury, Susmita Adhikari, Mukesh Kumar Singh, Shasvath J. Kapadia

21. [A single frequency approach to nonequilibrium modeling of the chromosphere](#user-content-link21)
**Authors:** W. Ruan, D. Przybylski, R. Cameron, S. K. Solanki

22. [Dark Matter from Eternity](#user-content-link22)
**Authors:** G. Franciolini, M. Peloso, A. Riotto

23. [The contribution of neutral gas to Faraday tomographic data at low frequencies. A first extensive comparison between real and synthetic data](#user-content-link23)
**Authors:** Jack Berat, Marc-Antoine Miville-Desch\^enes, Andrea Bracco, Patrick Hennebelle, Jeremy Scholtys

24. [A General Formulation of the Kinematic Dipole as a Functional of Selection and Source Properties: Beyond the Ellis--Baldwin Approximation](#user-content-link24)
**Authors:** Tsutomu T. Takeuchi (Nagoya University)

25. [SunBURST: Deterministic GPU-Accelerated Bayesian Evidence via Mode-Centric Laplace Integration](#user-content-link25)
**Authors:** Ira Wolfson

26. [DerivKit: stable numerical derivatives bridging Fisher forecasts and MCMC](#user-content-link26)
**Authors:** Nikolina \v{S}ar\v{c}evi\'c, Matthijs van der Wild, Cynthia Trendafilova

27. [Identifying Host Galaxies of Binary Black Hole Mergers with Next-Generation Gravitational Wave Detector Networks](#user-content-link27)
**Authors:** Sumedha Biswas, Andrew Levan, Peter G. Jonker, Kendall Ackley, Gregory Ashton, Nikhil Sarin

28. [SXP 31.0 -- the 2025 near-Eddington double X-ray outburst after 26 years of quiescence](#user-content-link28)
...
29. [The stellar velocity anisotropy of strong lensing massive elliptical galaxies and its role in the inference of the Hubble parameter $H_0$ using spatially resolved kinematics](#user-content-link29)
**Authors:** Vishal Verma, Quinn Minor

30. [Active Galactic Nuclei and STaR fOrmation in Nearby Galaxies AGNSTRONG. III. A Study on Ionized and Warm Molecular Gas Outflows of 6 Type-2 AGNs](#user-content-link30)
**Authors:** Ruisong Xia, Chen Qin, Huynh Anh N. Le, Yongquan Xue, Shifu Zhu, Mengqiu Huang, Hao Liu, Xiaozhi Lin

31. [Two-Dimensional Kelvin-Helmholtz Instability with Anisotropic Pressure](#user-content-link31)
**Authors:** Shishir Biswas, Masaru Nakanotani, Dinshaw S. Balsara, Vladimir Florinski, Merav Opher

32. [Complementary Roles of Distance and Growth Probes in Testing Time-Varying Dark Energy](#user-content-link32)
**Authors:** Seokcheon Lee

33. [Hints of sign-changing scalar field energy density and a transient acceleration phase at $z\sim 2$ from model-agnostic reconstructions](#user-content-link33)
**Authors:** \"Ozg\"ur Akarsu, Maria Caruana, Konstantinos F. Dialektopoulos, Luis A. Escamilla, Emre O. Kahya, Jackson Levi Said

34. [An Exploration of the Equation of State Dependence of Core-Collapse Supernova Explosion Outcomes and Signatures](#user-content-link34)
**Authors:** Aleksandr Rusakov, Adam S. Burrows, Tianshu Wang, David Vartanyan

35. [Discovery of a double white dwarf in the Galactic globular cluster NGC 6397](#user-content-link35)
**Authors:** Fabian G\"ottgens, Marilyn Latour, Ulrich Heber, Sebastian Kamann, Kyle Kremer, Sven Martens, Stefan Dreizler

36. [AMICO galaxy clusters in KiDS-1000: Splashback radius from weak lensing and cluster-galaxy correlation function](#user-content-link36)
**Authors:** G. F. Lesci, C. Giocoli, F. Marulli, M. Romanello, L. Moscardini, M. Sereno, M. Maturi, M. Radovich, G. Castignani, H. Hildebrandt, L. Ingoglia, E. Puddu

37. [JWST spectral retrieval of cold directly imaged planet WD0806 b and the first measurement of altitude-dependent K$_{zz}$ in exoplanet atmospheres](#user-content-link37)
...
38. [Is plasmoid-mediated reconnection really important in accretion flows to drive flares in AGNs?](#user-content-link38)
...
39. [IceCube's Sensitivity Prospects to MeV-Scale Axion-Like Particles from Core-Collapse Supernovae](#user-content-link39)
**Authors:** Nora Valtonen-Mattila, Shlok Shah, Segev BenZvi

40. [Accelerating Black Hole Image Generation via Latent Space Diffusion Models](#user-content-link40)
**Authors:** Ao Liu, Xudong Zhang, Cuihong Wen, Wentao Liu, Jieci Wang

41. [New solution to the hyperon puzzle of neutron stars: Quantum many-body effects](#user-content-link41)
**Authors:** Hao-Fu Zhu, Guo-Zhu Liu, Xufen Wu, Ye-Fei Yuan

42. [A New Strategy for Using Spectroscopic Phase Curves to Characterize Non-Transiting Planets](#user-content-link42)
**Authors:** Ted M. Johnson, Avi M. Mandell

43. [Indications of Rapid Dust Formation in the Inner Region of a Protoplanetary Disk](#user-content-link43)
**Authors:** Thanawuth Thanathibodee, Catherine Espaillat, Nuria Calvet, Zhaohuan Zhu, Julalak Nammanee, Caeley Pittman, Maire Volz

44. [Kosmulator: A Python framework for cosmological inference with MCMC](#user-content-link44)
**Authors:** Renier T. Hough, Robert Rugg, Shambel Sahlu, Amare Abebe

45. [Dynamic Black-hole Emission Tomography with Physics-informed Neural Fields](#user-content-link45)
**Authors:** Berthy T. Feng, Andrew A. Chael, David Bromley, Aviad Levis, William T. Freeman, Katherine L. Bouman

46. [Asymptotic Freedom and Vacuum Polarization Determine the Astrophysical End State of Relativistic Gravitational Collapse: Quark--Gluon Plasma Star Instead of Black Hole](#user-content-link46)
**Authors:** Herman J. Mosquera Cuesta, Fabi\'an H. Zuluaga Giraldo, Wilmer D. Alfonso Pardo, Edgardo Marbello Santrich, Guillermo U. Avenda\~no Franco, Rafael Fragozo Larrazabal

47. [FPIC: a new Particle-In-Cell code for stationary and axisymmetric black-hole spacetimes](#user-content-link47)
**Authors:** Claudio Meringolo, Luciano Rezzolla

48. [Is the nitrogen-rich source PN K4-47 a true planetary nebula?](#user-content-link48)
**Authors:** Thomas Steinmetz, Tomasz Kaminski, David Jones, Marcin Hajduk, Denise R. Goncalves, Stavros Akras

49. [CFHT MegaCam Two Deep Fields Imaging Survey (2DFIS) II: Decoding the Lensing Profile of a "Rotating" Cluster with Deep CFHT Imaging](#user-content-link49)
...
50. [Pulsars and Millisecond Pulsars II: Deep diving into the Evolutionary Mechanisms](#user-content-link50)
**Authors:** Maria Rah, Rainer Spurzem, Francesco Flammini Dotti, Areg Mickaelian

51. [CFHT MegaCam Two Deep Fields Imaging Survey (2DFIS) I: Overview](#user-content-link51)
...
52. [Dynamical Mass Constraints on Transition Disk Perturbers with the G23H Catalog](#user-content-link52)
**Authors:** Dori Blakely, William Thompson, Doug Johnstone, Jessica Speedie, Jerry W. Xuan, Simon Blouin, Jingwen Zhang, Jean-Baptiste Ruffio, Eric Nielsen, Brendan P. Bowler, Kyle Franson, William Roberson, Ryan Cloutier, Andre Fogal, Kaitlyn Hessel, Christian Marois, Alexandra Rochon

53. [A Multi-messenger Search for a Nearby Microquasar Contributor to the Cosmic Ray Knee](#user-content-link53)
**Authors:** Lin Nie, Hua Yue, Yi-Qing Guo, Si-Ming Liu

54. [Primordial features as probes of baryogenesis from supersymmetric flat directions](#user-content-link54)
**Authors:** Yi-Peng Wu, Xingang Chen, Nino Ephremidze, Lingfeng Li

55. [Self-resonance preheating in deformed attractor models: oscillon formation and evolution](#user-content-link55)
**Authors:** Bao-Min Gu, Yu-Peng Zhang, Fu-Wen Shu, Yu-Xiao Liu

56. [Two-component $\gamma$-Ray Structure from the CR Sources Within Dense Clouds](#user-content-link56)
**Authors:** Lin Nie, Yi-Qing Guo, Si-Ming Liu

57. [Scavenger hunt: Selection of obscured active galactic nuclei combining multiband optical variability and colors](#user-content-link57)
**Authors:** Demetra De Cicco, Stefano Cavuoti, Maurizio Paolillo, Vincenzo Petrecca, Ylenia Maruccia, Paula S\'anchez-S\'aez

58. [Imprints of gravitational waves from magnetar spindown in GRB X-ray afterglows](#user-content-link58)
**Authors:** Shu-Jin Hou, Rui Xue, Fang-Kun Peng, Zhi-Gang Li, Tong Liu, Ren-Xin Xu

59. [Neutron Stars as Perfect Fluids: Extracting the Linearized Response Function](#user-content-link59)
**Authors:** Irvin Mart\'inez-Rodr\'iguez

60. [A NICER view of the corona through time-dependent Comptonization of the quasi-periodic oscillations in nine black-hole X-ray binaries](#user-content-link60)
**Authors:** Yuexin Zhang, Mariano M\'endez, James F. Steiner, Federico Garc\'ia, Candela Bellavita, Ole K\"onig, Erin Kara, Santiago Ubach Ramirez, Honghui Liu, Zuobin Zhang, Liang Zhang, Zi-Xu Yang, Kevin Alabarta, Sandeep K. Rout, Diego Altamirano

61. [Microquasar Remnants as Pevatrons Illuminating the Galactic Cosmic Ray Knee](#user-content-link61)
**Authors:** Bing Theodore Zhang, Shiqi Yu

62. [Twisted Pseudodisk and Asymmetric Mass Accretion on the Circumstellar Disk](#user-content-link62)
**Authors:** Masahiro N. Machida, Shingo Hirano, Shantanu Basu

63. [Effects of Viscosity on Sloshing Cold Fronts in Galaxy Clusters](#user-content-link63)
**Authors:** Ming-Hsueh Hsieh, H. -Y. Karen Yang, John ZuHone

64. [CHIMPS2: The physical properties and star formation efficiency of molecular gas in the Central Molecular Zone](#user-content-link64)
**Authors:** S. M. King, T. J. T. Moore, S. N. Longmore, D. J. Eden, J. D. Henshaw, A. J. Rigby, R. Rani

65. [Thermal Vacuum Cosmology Explains Hubble Tension](#user-content-link65)
**Authors:** Robert Alicki

66. [A Minimal Interpretation of the Galactic Cosmic-Ray Spectrum from GeV to PeV Energies](#user-content-link66)
**Authors:** Felix Aharonian, Bing Theodore Zhang

67. [Neutrino Emission from Gamma-ray Burst Jet Propagating inside the Cavity within Active Galactic Nucleus Accretion Disks](#user-content-link67)
**Authors:** Hao-Yu Yuan, Wen-Long Xu, Kai Wang, Wei-Hua Lei

68. [SPHEREx as a frontier for infrared transients: Classification of new Galactic FU Ori outbursts and classical novae](#user-content-link68)
**Authors:** Viraj Karambelkar, Kishalay De, Lynne A. Hillenbrand, J. L. Sokoloski, Danielle Frostig, Julianne Dalcanton

69. [Toward Vision-Language Assistants for Radio Astronomical Source Analysis](#user-content-link69)
**Authors:** S. Riggi

70. [Prospective bounds on f(Q) gravity with pulsar timing arrays](#user-content-link70)
**Authors:** Mohammadreza Davari, Alireza Allahyari

71. [The Reawakening of 4U 1755-338 after 25 Years of Quiescence: Spectro-temporal Analysis Using Multi-instrument X-ray Data](#user-content-link71)
**Authors:** Geethu Prabhakar (Department of Earth and Space Sciences, Indian Institute of Space Science and Technology), Samir Mandal (Department of Earth and Space Sciences, Indian Institute of Space Science and Technology)

72. [GaLactic and Extragalactic All-sky Murchison Widefield Array survey eXtended (GLEAM-X) III: Galactic Plane](#user-content-link72)
**Authors:** S. Mantovanini, N. Hurley-Walker, K. Ross, S. W. Duchesne, G. Anderson, T. J. Galvin

73. [Fabrication and Characterization of X-ray TES Detectors Based on Annular AlMn Alloy Films](#user-content-link73)
...
74. [Pulsars and Millisecond Pulsars I: Advancements, Open Questions and finding Gaps via statistical insights](#user-content-link74)
**Authors:** Maria Rah, Areg Mickaelian, Francesco Flammini Dotti, Rainer Spurzem

75. [On the Deepest Search for Galactic Center Pulsars and an Examination of an Intriguing Millisecond Pulsar Candidate](#user-content-link75)
...
76. [The seismic diversity of four successive solar cycle minima as observed by the Birmingham Solar-Oscillations Network (BiSON)](#user-content-link76)
**Authors:** Sarbani Basu, William J. Chaplin, Rachel Howe, Yvonne Elsworth, Steven J. Hale, Eleanor Murray

77. [A MeerKAT search for persistent radio sources towards twenty-five localised Fast Radio Bursts](#user-content-link77)
**Authors:** Lebogang L. Mfulwane, James O. Chibueze, Thulo P. Letsele, Trevor M. Nyambe, Christo Venter, Mechiel Christiaan Bezuidenhout, Benjamin W. Stappers, Laura G. Spitler, Manisha Caleb, Adam Deller, J\'eferson Andr\'e Sales Fortunato, Bernardo Cornejo, Fabian Sch\"ussler, Halim Ashkar, Frederica Bradascio, Surajit Kalita, Anu Kundu, Michael Kramer, Evan. F. Keane, Amanda Weltman

78. [An unusual pair of interstellar HI features and a related white dwarf star inside the HI cavity surrounding the Upper Sco-Cen OB2 Association](#user-content-link78)
**Authors:** Gerrit L. Verschuur

79. [SOLO: wide-field asteroid light curve monitoring system for SPHEREx](#user-content-link79)
...
80. [An Open-Source High-Level Graphical Signal Processing Language with Simulation and HDL Generation](#user-content-link80)
**Authors:** Wei Liu, Jonathon Kocz, Dan Werthimer

81. [Impact of embedded circumplanetary winds on the circumstellar disk: I. Reshaping the local accretion environment](#user-content-link81)
**Authors:** Danilo Sep\'ulveda-Rojas, Pablo Ben\'itez-Llambay, Simon Casassus

82. [NovaMoon: A Strategic Lunar Reference Station for Positioning, Timing, and Largely Enhanced Science in the Earth-Moon System Serena](#user-content-link82)
**Authors:** Serena Molli, Agn\`es Fienga, Pascale Defraigne, Krzysztof So\'snica, Luigi Cacciapuoti, Luca Porcelli, Lotfi Massarweh, Sara Bruni, Riccardo Pozzobon, Albert Roura, Francesco Vespe, Diego Blas, Ozgur Karatekin, Yoann Audet, Floor Melman, Richard Swinden, Javier Ventura-Traveset, Olivier Alibart, Marie-Christine Angonin, Daniel Arnold, Ruth Bamford, Emmanuele Battista, Marco Belloni, J. C. Berton, Orfeu Bertolami, Mathis Blo{\ss}feld, Adrien Bourgoin, Giada Bargiacchi, Salvatore Buoninfante, Nicol\`o Burzill\`a, Roberto Campagnola, Paolo Cappuccio, Salvatore Capozziello, Giuseppe Cim\`o, Cl\'ement Courde, Rolf Dach, Mario Siciliani de Cumis, Simone Dell'Agnello, Fabrizio De Marchi, Valentina Galluzzi, Francesco Gini, Philipp Glaeser, Klaus Gwinner, Alex Guinard, R\"udiger Haas, Aur\'elien Hees, Hauke Hussmann, Luciano Iess, Alexander C. Jenkins, Siddarth K. Joshi, Maria Karbon, Sergei Klioner, Kaisa Laiho, Christophe Le Poncin-Lafitte, Marco Lucente, David Lucchesi, Riccardo March, Lucia McCallum, J\"urgen M\"uller, Weijie Nie, Jillian Oduber, Roberto Peron, Francesco Picciariello, Th\'eo Pichavant, Michael Plumaris, Eleonora Polini, Ana-Catalina Plesa, Dimitrios Psychas, Bernardino Quaranta, Nicolas Rambaux, Marc Rovira-Navarro, Francesco Santoli, Matthias Schartner, Florian Seitz, Ilaria Sesia, Yan Seyffert, Stefano Speretta, Tim Springer, Giuseppe Vallone, Paolo Villoresi, Sebastien Vincent-Bonnieu, Ben Wadsworth, Pierre Waller, Rados{\l}aw Zajdel, Erik Schoenemann

83. [Scalar-Induced Gravitational Waves and Primordial Black Holes from a Localized Bump or Dip Feature in a Single-Field Inflationary Potential](#user-content-link83)
**Authors:** Xiang Zhang, Zhao-Huan Yu

84. [Modeling Tidal Disruption Events and Compact Object Plunges in Nuclear Star Clusters](#user-content-link84)
**Authors:** Philip Cho, Kai Wu, Francesco Flammini Dotti, Taras Panamarev, Rainer Spurzem

85. [Can UV meet IR in the Swiss cheese?](#user-content-link85)
**Authors:** Madina Abilmazhinova, Diana Kulubayeva, Hrishikesh Chakrabarty, Daniele Malafarina

86. [Astrophysical positronium and Dicke superradiance](#user-content-link86)
**Authors:** Abdaljalel E. Alizzi, Zurab K. Silagadze

87. [Sunrise III: The Wavefront Correction System](#user-content-link87)
**Authors:** Thomas Berkefeld, Alexander Bell, Reiner Volkmer, Frank Heidecke, Tobias Preis, Thomas Sonner, Eiji Nakai, Andreas Korpi-Lagg, Achim Gandorfer, Sami K. Solanki, Jose Carlos del Toro Iniesta, Yukio Katsukawa, Pietro Bernasconi, Alex Feller, Tino L. Riethm\"uller, Alberto \'Alvarez-Herrero, Masahito Kubo, Valent\'in Mart\'inez Pillet, H. N. Smitha, David Orozco Su\'arez, Bianca Grauf, Michael Carpenter

88. [High-resolution X-ray spectroscopy of Cen X-3 with XMM-Newton](#user-content-link88)
**Authors:** J. J. Rodes-Roca, J. M. Torrej\'on, G. Sanjurjo-Ferr\'in, J. Planelles Villalva

89. [Machine Learning-Ready Data Sets for the Analysis and Nowcasting of Atmospheric Radiation at Aviation Altitudes](#user-content-link89)
...
90. [Fabrication and characterization of AlMn alloy superconducting films for 0vbb experiments](#user-content-link90)
**Authors:** Zhouhui Liu, Yifei Zhang, Yu Xu, Mengxian Zhang, Qing Yu, Xufang Li, He Gao, Zhengwei Li, Daikang Yan, Shibo Shu, Yongjie Zhang, Xuefeng Lu, Yu Wang, Jianjie Zhang, Yuanyuan Liu, Congzhan Liu

91. [Can Dirac neutrinos destabilize $\mathcal{Z}_2$ domain wall network?](#user-content-link91)
**Authors:** Debasish Borah, Partha Kumar Paul, Narendra Sahu

92. [Evaluating the $\Sigma$-effect Model of the Solar Hemispherical Helicity Bias via Direct Numerical Simulations](#user-content-link92)
**Authors:** Jacob B. Noone Wade, Nicholas H. Brummell

93. [Assessment of DKIST/VTF Capabilities for the Detection of Local Acoustic Source Wavefronts](#user-content-link93)
**Authors:** Corinne Morrell, Mark P. Rast, Shah Mohammad Bahauddin, Ivan Mili\'c

94. [Post-Newtonian accelerations of a Mercury orbiter](#user-content-link94)
**Authors:** Miriam Falletta, Gabriel Rodr\'iguez-Moris, Sergei A. Klioner

95. [Variation of the sunspot area during the rising and declining phases of the solar cycle supports the toroidal flux loss due to flux emergence](#user-content-link95)
**Authors:** Bidya Binay Karak, Soumya Mishra, Anu Sreedevi

96. [Seasonal Variation of Polar Ice: Implications for Ultrahigh Energy Neutrino Detectors](#user-content-link96)
**Authors:** Alexander Kyriacou, Steven Prohira, Dave Besson

97. [WFC3/UVIS: External CTE Monitoring 2009-2024](#user-content-link97)
**Authors:** Benjamin Kuhn

98. [Imagining the Alien: Human Projections and Cognitive Limitations](#user-content-link98)
**Authors:** S. G. Djorgovski

99. [Scintillation muon telescope module with fiber-optic light collection](#user-content-link99)
**Authors:** Belov S. M., Yanke V. G

---

## 1. [Properties of Galactic Outflows Driven by Starburst at Cosmic Noon: Insights from Hydrodynamical Simulations](https://arxiv.org/abs/2602.07592) <a id="link1"></a>
...
**Comment:** Investigates starburst-driven galactic outflows in low-mass galaxies using high-resolution hydrodynamical simulations. Directly matches 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria, with detailed mass-loading factor measurements and phase structure analysis.
...
## 2. [Massive Star Population in the Sextans A Dwarf Galaxy from HST UV Photometry](https://arxiv.org/abs/2602.07177) <a id="link2"></a>
...
**Comment:** This paper builds a catalog of massive main sequence stars in the Sextans A dwarf galaxy using HST UV photometry and stellar evolutionary tracks. It directly matches the 'Stellar Models' criterion (new interpolation of stellar tracks) and is also relevant to 'Near-Field Cosmology' (dwarf galaxy focus).
...
## 3. [Toward a Comprehensive Grid of Cepheid Models with MESA II. Impact of Physical and Numerical Assumptions on Elemental Abundances](https://arxiv.org/abs/2602.08109) <a id="link3"></a>
...
**Comment:** This paper presents a comprehensive grid of Cepheid stellar models using MESA, analyzing the impact of physical and numerical assumptions on elemental abundances. It directly matches the 'Stellar Models' criterion, as it provides new evolutionary tracks and abundance predictions for evolved stars.
...
## 4. [A comprehensive catalogue of high-mass X-ray binaries in the Large Magellanic Cloud detected during the first eROSITA all-sky survey](https://arxiv.org/abs/2602.08152) <a id="link4"></a>
...
**Comment:** Catalogues high-mass X-ray binaries in the Large Magellanic Cloud, estimates star formation rate, and provides population statistics. The LMC is a dwarf satellite galaxy of the Milky Way, making this highly relevant for near-field cosmology and resolved star formation histories. The catalogue enables statistical studies and connects to star formation rates in a relevant galaxy.
...
## 5. [A mapping method of age estimation for binary stars: Application to the $\alpha$ Centauri system A and B](https://arxiv.org/abs/2602.08879) <a id="link5"></a>
...
**Comment:** Presents a mapping method for age estimation in binary stars, applied to the Alpha Centauri system. This is directly relevant to the 'Stellar Models' criterion, as it involves improving stellar evolutionary models and age estimation techniques.
...
## 6. [Cosmology with one galaxy: An analytic formula relating $\Omega_{\rm m}$ with galaxy properties](https://arxiv.org/abs/2602.07651) <a id="link6"></a>
...
**Comment:** Presents an analytic formula relating cosmological parameter Omega_m to galaxy-scale observables using hydrodynamical simulations. This directly matches the 'Numerical Galaxy Simulations' criterion, with a novel approach linking galaxy properties to cosmology.
...
## 7. [New Approach to Superflare Energy Determination](https://arxiv.org/abs/2602.08814) <a id="link7"></a>
...
**Comment:** Presents a new method for estimating superflare energy in stellar flares, focusing on stellar atmospheres and flare modeling. This fits the 'Stellar Models' criterion, as it presents a new approach to modeling stellar flare energy and temperature evolution.
...
## 8. [Granulation signatures as seen by Kepler short-cadence data. I. A decoupling between granulation and oscillation timescales for dwarfs](https://arxiv.org/abs/2602.08978) <a id="link8"></a>
...
**Comment:** Studies granulation and oscillation timescales in low-mass stars using Kepler data, with implications for stellar convection and oscillations. This is relevant to 'Stellar Models' as it provides observational constraints and links to 3D simulations of stellar envelopes.
...
## 9. [K-DRIFT Science Theme: Galaxies in the Faint Universe](https://arxiv.org/abs/2602.08283) <a id="link9"></a>
...
**Comment:** Describes the K-DRIFT telescope and its science goals for studying low-surface-brightness structures in nearby galaxies, including mass assembly and star formation in LSB regimes. The focus on nearby galaxies and LSB features is relevant to near-field cosmology and resolved star formation histories, though the paper is more about instrumentation and survey strategy.
...
## 10. [A Detailed Model Atmosphere Analysis of Hot White Dwarfs in DESI DR1](https://arxiv.org/abs/2602.07246) <a id="link10"></a>
...
**Comment:** This paper presents a detailed model atmosphere analysis of hot white dwarfs, including new spectral fits and mass distributions. It fits the 'Stellar Models' criterion, as it discusses model atmospheres and implications for spectral evolution.
...
## 12. [Particle hydrodynamics with accurate gradients: a comparison of different formulations](https://arxiv.org/abs/2602.08091) <a id="link12"></a>
...
**Comment:** Compares different formulations of particle hydrodynamics (SPH), focusing on gradient accuracy and kernel methods. This is relevant to 'Numerical Galaxy Simulations' as it discusses hydrodynamics methods used in galaxy simulations, though the paper is more methodological and not directly applied to galaxies.
...
## 13. [AGN versus Star-formation: A MUSE Analysis of NGC 1365](https://arxiv.org/abs/2602.07124) <a id="link13"></a>
...
**Comment:** Analysis of AGN and star formation feedback in NGC 1365, a massive spiral galaxy. While it discusses star formation-driven outflows and quenching, the focus is on a galaxy more massive than the LMC and includes AGN-driven feedback. Some relevance to star formation driven outflows and quenching, but weighted lower due to galaxy mass and AGN focus.
...
## 14. [Emergence of a lithium dip in ~35 Myr "Snake" Open Clusters](https://arxiv.org/abs/2602.07367) <a id="link14"></a>
...
**Comment:** This paper reports the discovery of a lithium dip in a young open cluster and discusses rotational velocity and lithium depletion. It is relevant to 'Stellar Models' as it discusses stellar evolution and mixing, but does not directly address galaxy-scale topics.
...
## 15. [Clump-Scale Dust Attenuation in Epoch of Reionization Galaxies: Spatially Resolved Properties from FirstLight Simulations](https://arxiv.org/abs/2602.07347) <a id="link15"></a>
...
**Comment:** Uses cosmological zoom-in simulations to study dust attenuation in high-redshift galaxies, focusing on spatially resolved properties at clump scales. While the work involves numerical galaxy simulations and spatially resolved properties, it is primarily about dust attenuation and not directly about resolved star formation histories, dwarf galaxies, or CGM. Borderline relevance due to simulation aspect.
...
## 16. [Synchrotron Self-Compton Process for Constraining sub-GeV Dark Matter in Omega Centauri via SKA](https://arxiv.org/abs/2602.08731) <a id="link16"></a>
...
**Comment:** Investigates synchrotron self-Compton emission from dark matter annihilation in Omega Centauri, a globular cluster. While it is indirect dark matter detection in a nearby system, Omega Centauri is not a dwarf galaxy and the focus is not on satellite luminosity functions, core-cusp, or resolved star formation histories. Borderline relevance due to connection to near-field cosmology via substructure and dark matter.
...
## 17. [Exploring the dynamical evolution of binary stars in multiple-population globular clusters](https://arxiv.org/abs/2602.07119) <a id="link17"></a>
...
**Comment:** Focuses on the dynamical evolution of binary stars in globular clusters with multiple populations. While it discusses cluster dynamics and binary evolution, it does not directly address near-field cosmology, resolved star formation histories, or dwarf galaxies. The relevance is borderline as globular clusters can be related to stellar models and evolutionary tracks, but the main focus is not on new stellar models.
...
## 18. [Dynamics of Y Dwarf Atmospheres](https://arxiv.org/abs/2602.08434) <a id="link18"></a>
...
**Comment:** This paper models Y dwarf atmospheres, focusing on convection, rotation, and cloud feedback. It is relevant to stellar atmosphere models, but Y dwarfs are substellar objects and the work is not directly presenting new stellar models or evolutionary tracks. The relevance is borderline for the stellar models criterion.
...
## 19. [Towards FAIR Astrophysical Simulations](https://arxiv.org/abs/2602.08416) <a id="link19"></a>
...
**Comment:** This paper discusses FAIR principles in astrophysical simulations and proposes steps for better data/code publication. It is relevant to 'Numerical Galaxy Simulations' in terms of simulation community practices, but does not present new simulations or physics models.
...
## 20. [Gravitational Wave Informed Inference of 21-cm Global Signal Parameters](https://arxiv.org/abs/2602.07631) <a id="link20"></a>
...
**Comment:** Establishes a multi-messenger framework using gravitational wave and 21-cm signal observations to infer parameters of the early universe. While it discusses star formation rate density at high redshift, it does not focus on resolved star formation histories or dwarf galaxies, and is not directly relevant to the core criteria.
...
## 21. [A single frequency approach to nonequilibrium modeling of the chromosphere](https://arxiv.org/abs/2602.08763) <a id="link21"></a>
...
**Comment:** Presents an updated numerical model for the solar chromosphere, focusing on non-LTE radiative transfer and hydrogen level populations. While it is a stellar model, it is for the Sun and not for general stellar evolutionary tracks or atmospheres as defined in the criteria.
...
## 22. [Dark Matter from Eternity](https://arxiv.org/abs/2602.08338) <a id="link22"></a>
...
**Comment:** This paper proposes a new mechanism for the origin of dark matter via eternal inflation and primordial black holes. While it discusses dark matter, it does not focus on galaxy-scale dark matter density profiles, satellite galaxies, or near-field cosmology. The topic is cosmological and theoretical, not directly related to the core topics such as resolved star formation histories or galaxy simulations.
...
## 23. [The contribution of neutral gas to Faraday tomographic data at low frequencies. A first extensive comparison between real and synthetic data](https://arxiv.org/abs/2602.08839) <a id="link23"></a>
...
**Comment:** This paper investigates the contribution of neutral gas to Faraday tomographic data, focusing on the Solar neighborhood ISM and magnetic field morphology. While it uses MHD simulations and discusses the multi-phase ISM, it does not directly address dwarf galaxies, galaxy simulations, or star formation histories. The focus is on ISM structure and polarization.
...
## 24. [A General Formulation of the Kinematic Dipole as a Functional of Selection and Source Properties: Beyond the Ellis--Baldwin Approximation](https://arxiv.org/abs/2602.07389) <a id="link24"></a>
...
**Comment:** This paper presents a general theoretical framework for the kinematic dipole in galaxy and QSO number counts. While it is cosmological, it does not focus on near-field cosmology, dwarf galaxies, or any of the core criteria.
...
## 25. [SunBURST: Deterministic GPU-Accelerated Bayesian Evidence via Mode-Centric Laplace Integration](https://arxiv.org/abs/2601.19957) <a id="link25"></a>
...
**Comment:** SunBURST is a computational method for Bayesian evidence evaluation, targeting high-dimensional parameter estimation. While it may be useful for statistical inference in astrophysics, it does not directly address any of the core topics such as galaxy simulations, star formation histories, or stellar models.
...
## 26. [DerivKit: stable numerical derivatives bridging Fisher forecasts and MCMC](https://arxiv.org/abs/2602.08078) <a id="link26"></a>
...
**Comment:** DerivKit is a Python package for derivative-based statistical inference, supporting Fisher forecasts and likelihood approximations. While it is a useful tool for scientific inference, it does not directly address any of the core topics such as galaxy simulations, star formation histories, or stellar models.
...
## 27. [Identifying Host Galaxies of Binary Black Hole Mergers with Next-Generation Gravitational Wave Detector Networks](https://arxiv.org/abs/2602.08459) <a id="link27"></a>
...
**Comment:** Focuses on host galaxy identification for binary black hole mergers via gravitational wave localization. While it touches on galaxy properties, it does not address any of the core topics (no near-field cosmology, star formation histories, or galaxy simulations).
...
## 28. [SXP 31.0 -- the 2025 near-Eddington double X-ray outburst after 26 years of quiescence](https://arxiv.org/abs/2602.07459) <a id="link28"></a>
...
**Comment:** This paper reports on X-ray outbursts from a Be X-ray binary in the Small Magellanic Cloud, including observations of a surrounding HII region. While it is in a dwarf galaxy, the focus is on the binary system and its outbursts, not on galaxy-scale properties or star formation histories.
...
## 29. [The stellar velocity anisotropy of strong lensing massive elliptical galaxies and its role in the inference of the Hubble parameter $H_0$ using spatially resolved kinematics](https://arxiv.org/abs/2602.07159) <a id="link29"></a>
...
**Comment:** This paper investigates stellar velocity anisotropy in massive elliptical galaxies and its impact on Hubble parameter inference. It is not relevant to the core topics, as it focuses on massive ellipticals and cosmological measurements, not dwarf galaxies or near-field cosmology.
...
## 30. [Active Galactic Nuclei and STaR fOrmation in Nearby Galaxies AGNSTRONG. III. A Study on Ionized and Warm Molecular Gas Outflows of 6 Type-2 AGNs](https://arxiv.org/abs/2602.07392) <a id="link30"></a>
...
**Comment:** Studies AGN-driven gas outflows in type-2 AGNs, focusing on ionized and warm molecular gas. The outflows are AGN-driven, not star-formation-driven, and the galaxies are not dwarfs. The paper is largely outside the core topics.
...
## 31. [Two-Dimensional Kelvin-Helmholtz Instability with Anisotropic Pressure](https://arxiv.org/abs/2602.08806) <a id="link31"></a>
...
**Comment:** The paper presents a study of the Kelvin-Helmholtz instability in collisionless plasmas, with applications to heliospheric and interstellar environments. While it discusses turbulence and reconnection, it does not focus on galaxies, star formation, or stellar models. The relevance to galaxy-scale processes is minimal.
...
## 32. [Complementary Roles of Distance and Growth Probes in Testing Time-Varying Dark Energy](https://arxiv.org/abs/2602.08207) <a id="link32"></a>
...
**Comment:** Examines cosmological probes for time-varying dark energy using distance and growth measurements. While it is cosmology, it does not focus on near-field cosmology, galaxy simulations, or any of the core criteria.
...
## 34. [An Exploration of the Equation of State Dependence of Core-Collapse Supernova Explosion Outcomes and Signatures](https://arxiv.org/abs/2602.09025) <a id="link34"></a>
...
**Comment:** Explores core-collapse supernovae and the impact of the nuclear equation of state, which is not directly related to any of the core topics (no focus on galaxy simulations, stellar models, or dwarf galaxies).
...
## 35. [Discovery of a double white dwarf in the Galactic globular cluster NGC 6397](https://arxiv.org/abs/2602.08898) <a id="link35"></a>
...
**Comment:** This paper reports the discovery of a double white dwarf in a globular cluster. While interesting, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 36. [AMICO galaxy clusters in KiDS-1000: Splashback radius from weak lensing and cluster-galaxy correlation function](https://arxiv.org/abs/2602.07114) <a id="link36"></a>
...
**Comment:** Analyzes splashback radius in galaxy clusters using weak lensing and cluster-galaxy correlation functions. The focus is on massive galaxy clusters, not dwarf galaxies or satellite systems, and does not match any core criteria.
...
## 37. [JWST spectral retrieval of cold directly imaged planet WD0806 b and the first measurement of altitude-dependent K$_{zz}$ in exoplanet atmospheres](https://arxiv.org/abs/2602.08200) <a id="link37"></a>
...
**Comment:** This paper presents JWST observations and atmospheric retrievals for a cold exoplanet. It does not match any of the core criteria, as it focuses on exoplanet atmospheres and vertical mixing, not galaxies or stellar models.
...
## 38. [Is plasmoid-mediated reconnection really important in accretion flows to drive flares in AGNs?](https://arxiv.org/abs/2602.08710) <a id="link38"></a>
...
**Comment:** This paper presents MHD simulations of reconnection in accretion flows and AGN jets, focusing on turbulence-driven reconnection. It does not match any of the core criteria, as it is not about galaxy simulations in the context of galaxy evolution, nor about stellar models or near-field cosmology.
...
## 39. [IceCube's Sensitivity Prospects to MeV-Scale Axion-Like Particles from Core-Collapse Supernovae](https://arxiv.org/abs/2602.08649) <a id="link39"></a>
...
**Comment:** This paper discusses IceCube's sensitivity to axion-like particles from core-collapse supernovae. It is not relevant to the core topics, as it focuses on particle physics and supernovae, not galaxies or stellar models.
...
## 40. [Accelerating Black Hole Image Generation via Latent Space Diffusion Models](https://arxiv.org/abs/2602.07786) <a id="link40"></a>
...
**Comment:** Accelerates black hole image generation using diffusion models. Focus is on black hole imaging and computational methods, not related to galaxy-scale simulations or any core criteria.
...
## 41. [New solution to the hyperon puzzle of neutron stars: Quantum many-body effects](https://arxiv.org/abs/2602.07939) <a id="link41"></a>
...
**Comment:** Addresses neutron star interiors and the hyperon puzzle, which is not directly related to any of the core topics (no connection to near-field cosmology, galaxy simulations, or stellar models as defined).
...
## 42. [A New Strategy for Using Spectroscopic Phase Curves to Characterize Non-Transiting Planets](https://arxiv.org/abs/2602.07127) <a id="link42"></a>
...
**Comment:** Presents a new method for characterizing non-transiting exoplanets using spectroscopic phase curves. The focus is on exoplanet atmospheres and observational techniques, which does not match any of the core criteria.
...
## 43. [Indications of Rapid Dust Formation in the Inner Region of a Protoplanetary Disk](https://arxiv.org/abs/2602.08973) <a id="link43"></a>
...
**Comment:** Reports rapid dust formation in the inner region of a protoplanetary disk, possibly from planetesimal collisions. The focus is on disk physics and planet formation, not galaxy-scale processes or stellar models.
...
## 44. [Kosmulator: A Python framework for cosmological inference with MCMC](https://arxiv.org/abs/2602.08424) <a id="link44"></a>

**ArXiv ID:** 2602.08424

**Authors:** Renier T. Hough, Robert Rugg, Shambel Sahlu, Amare Abebe

**Abstract:** We present Kosmulator, a modular and vectorised Python framework designed to accelerate the statistical testing of cosmological models. As the theoretical landscape expands beyond standard $\Lambda$CDM, implementing new expansion histories into traditional Einstein--Boltzmann solvers becomes a significant computational bottleneck. Kosmulator addresses this by leveraging array-native execution and efficient ensemble slice sampling (via Zeus) to perform rapid Bayesian inference. We validate the framework against the industry-standard Cobaya code using a combination of Type Ia Supernovae, Cosmic Chronometers, and Baryon Acoustic Oscillation (BAO) data. Our results demonstrate that Kosmulator reproduces Cobaya's posterior constraints to within $\leq0.3\sigma$ statistical agreement on $H_{0}$ and $\Omega_{m}$ and $<0.6\%$ precision on $\chi^{2}$, while achieving a $\sim 4.5\times$ reduction in wall-clock time on a single CPU core compared to a standard MPI-parallelised baseline. Furthermore, we showcase the framework's utility by constraining the implicit power-law $f(Q)$ "$f_1$CDM" model and demonstrating its automated model selection capabilities (AIC/BIC). Kosmulator is introduced as a "scientific sieve" for rapid hypothesis testing, allowing researchers to efficiently filter theoretical candidates before deploying high-precision resources.

**Comment:** This paper introduces a new Python framework for cosmological inference, focusing on rapid hypothesis testing for cosmological models. It does not address galaxy simulations, star formation, or near-field cosmology.
...
## 45. [Dynamic Black-hole Emission Tomography with Physics-informed Neural Fields](https://arxiv.org/abs/2602.08029) <a id="link45"></a>
...
**Comment:** Focuses on dynamic and 3D imaging of black holes using neural fields. The topic is centered on black hole accretion and emission tomography, which does not match any of the core criteria (e.g., near-field cosmology, dwarf galaxies, stellar models, galaxy simulations, etc.).
...
## 46. [Asymptotic Freedom and Vacuum Polarization Determine the Astrophysical End State of Relativistic Gravitational Collapse: Quark--Gluon Plasma Star Instead of Black Hole](https://arxiv.org/abs/2602.07004) <a id="link46"></a>
...
**Comment:** Proposes a model for quark-gluon plasma stars as an alternative to black holes. The focus is on compact object physics and stellar collapse, not on galaxy-scale astrophysics, dwarf galaxies, or star formation histories.
...
## 47. [FPIC: a new Particle-In-Cell code for stationary and axisymmetric black-hole spacetimes](https://arxiv.org/abs/2602.07452) <a id="link47"></a>
...
**Comment:** This paper presents a new Particle-In-Cell code for black hole spacetimes, focusing on plasma physics and relativistic environments near black holes. It does not address galaxy simulations, stellar models, or any of the core topics such as near-field cosmology, star formation histories, or outflows. The focus is on black hole accretion and relativistic plasma, which is outside the relevant criteria.
...
## 48. [Is the nitrogen-rich source PN K4-47 a true planetary nebula?](https://arxiv.org/abs/2602.08959) <a id="link48"></a>
...
**Comment:** This paper focuses on the properties and classification of a planetary nebula, including its molecular environment and progenitor star. While it discusses stellar evolution and molecular outflows, it does not present new stellar models or address galaxy-scale processes, resolved star formation histories, or near-field cosmology. The focus is on a single evolved star system, not galaxies.
...
## 49. [CFHT MegaCam Two Deep Fields Imaging Survey (2DFIS) II: Decoding the Lensing Profile of a "Rotating" Cluster with Deep CFHT Imaging](https://arxiv.org/abs/2602.08360) <a id="link49"></a>
...
**Comment:** The paper analyzes a galaxy cluster using deep imaging and lensing, focusing on mass distribution and substructure. The subject is a massive galaxy cluster, not dwarf galaxies or satellite systems, and does not address star formation histories, quenching, or galaxy simulations relevant to the core topics.
...
## 50. [Pulsars and Millisecond Pulsars II: Deep diving into the Evolutionary Mechanisms](https://arxiv.org/abs/2602.08106) <a id="link50"></a>
...
**Comment:** Investigates evolutionary mechanisms of pulsars and millisecond pulsars, including binary interactions and population studies in globular clusters and the Galactic field. While it uses numerical tools and discusses compact object evolution, it does not directly address any of the core criteria.
...
## 51. [CFHT MegaCam Two Deep Fields Imaging Survey (2DFIS) I: Overview](https://arxiv.org/abs/2602.08312) <a id="link51"></a>
...
**Comment:** Describes a deep imaging survey targeting a region with a repeating FRB and a rotating galaxy cluster. The main applications are FRB host environments and cluster mass reconstruction, not dwarf galaxies, star formation histories, or galaxy simulations. No direct match to core criteria.
...
## 52. [Dynamical Mass Constraints on Transition Disk Perturbers with the G23H Catalog](https://arxiv.org/abs/2602.07731) <a id="link52"></a>
...
**Comment:** This paper uses astrometry to constrain companions in transition disk systems, focusing on protoplanetary disks and planet formation. It does not match any of the core criteria, as it is not about galaxies, stellar models, or near-field cosmology.
...
## 53. [A Multi-messenger Search for a Nearby Microquasar Contributor to the Cosmic Ray Knee](https://arxiv.org/abs/2602.07620) <a id="link53"></a>
...
**Comment:** This paper investigates microquasars as contributors to the cosmic ray knee, focusing on gamma-ray observations and cosmic ray spectra. It does not match any of the core criteria, as it is not about galaxies, stellar models, or near-field cosmology.
...
## 54. [Primordial features as probes of baryogenesis from supersymmetric flat directions](https://arxiv.org/abs/2602.08781) <a id="link54"></a>
...
**Comment:** This paper focuses on primordial features as probes of baryogenesis from supersymmetric flat directions, relating to early universe cosmology and inflation. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 55. [Self-resonance preheating in deformed attractor models: oscillon formation and evolution](https://arxiv.org/abs/2602.07972) <a id="link55"></a>
...
**Comment:** Investigates preheating and oscillon formation in inflationary models, focusing on early universe dynamics. No connection to galaxy simulations, star formation histories, or near-field cosmology.
...
## 56. [Two-component $\gamma$-Ray Structure from the CR Sources Within Dense Clouds](https://arxiv.org/abs/2602.07610) <a id="link56"></a>
...
**Comment:** Proposes a two-component model for cosmic ray sources and gamma-ray spectra, focusing on supernova remnants and cosmic ray propagation. No direct connection to the core criteria.
...
## 57. [Scavenger hunt: Selection of obscured active galactic nuclei combining multiband optical variability and colors](https://arxiv.org/abs/2602.07109) <a id="link57"></a>
...
**Comment:** Presents a method for selecting obscured AGN using optical variability and colors, relevant to AGN studies but not to any of the core criteria such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 58. [Imprints of gravitational waves from magnetar spindown in GRB X-ray afterglows](https://arxiv.org/abs/2602.07419) <a id="link58"></a>
...
**Comment:** Focuses on magnetar spindown and gravitational wave signatures in GRB X-ray afterglows. This is primarily neutron star physics and GRB central engine modeling, not related to near-field cosmology, resolved star formation histories, galaxy quenching, stellar models, galaxy simulations, or outflows.
...
## 59. [Neutron Stars as Perfect Fluids: Extracting the Linearized Response Function](https://arxiv.org/abs/2602.07115) <a id="link59"></a>
...
**Comment:** Theoretical modeling of neutron star tidal response as a perfect fluid. This is neutron star interior physics, not stellar models for evolutionary tracks or atmospheres, nor galaxy-scale topics.
...
## 60. [A NICER view of the corona through time-dependent Comptonization of the quasi-periodic oscillations in nine black-hole X-ray binaries](https://arxiv.org/abs/2602.07247) <a id="link60"></a>
...
**Comment:** Studies corona geometry evolution in black hole X-ray binaries using NICER data. Focus is on compact object accretion and corona physics, not galaxy-scale phenomena or any core criteria.
...
## 61. [Microquasar Remnants as Pevatrons Illuminating the Galactic Cosmic Ray Knee](https://arxiv.org/abs/2602.08940) <a id="link61"></a>
...
**Comment:** Simulates cosmic ray propagation from microquasar remnants, focusing on Galactic cosmic ray knee. No direct connection to any core topics (no galaxy simulations, star formation, or dwarf galaxy focus).
...
## 62. [Twisted Pseudodisk and Asymmetric Mass Accretion on the Circumstellar Disk](https://arxiv.org/abs/2602.07741) <a id="link62"></a>
...
**Comment:** Models gas inflow and accretion onto circumstellar disks using 3D MHD simulations. The focus is on protostellar disk formation and accretion, not galaxy simulations or star formation histories in galaxies. No direct match to the core criteria.
...
## 63. [Effects of Viscosity on Sloshing Cold Fronts in Galaxy Clusters](https://arxiv.org/abs/2602.07661) <a id="link63"></a>
...
**Comment:** Simulates sloshing cold fronts in galaxy clusters to probe ICM viscosity. The focus is on cluster-scale gas dynamics, not galaxy-scale processes or dwarf galaxies. No direct match to the core criteria.
...
## 64. [CHIMPS2: The physical properties and star formation efficiency of molecular gas in the Central Molecular Zone](https://arxiv.org/abs/2602.08824) <a id="link64"></a>
...
**Comment:** Studies molecular gas properties and star formation efficiency in the Central Molecular Zone (CMZ) of the Milky Way. The focus is on the Galactic center and star formation in a massive spiral galaxy, which is specifically listed as irrelevant.
...
## 65. [Thermal Vacuum Cosmology Explains Hubble Tension](https://arxiv.org/abs/2602.08522) <a id="link65"></a>

**ArXiv ID:** 2602.08522

**Authors:** Robert Alicki

**Abstract:** It is argued that the previously proposed modification of the standard (flat) inflationary $\Lambda CDM$ model in which cosmological constant is replaced by thermal energy of expanding vacum, characterized by the Gibbons-Hawking temperature, explains the origin of notorious ``Hubble tension''.

**Comment:** This paper discusses a modification to the standard cosmological model to explain the Hubble tension. While it is cosmology-focused, it does not address near-field cosmology, satellite galaxies, resolved star formation histories, or any of the other core topics.
...
## 66. [A Minimal Interpretation of the Galactic Cosmic-Ray Spectrum from GeV to PeV Energies](https://arxiv.org/abs/2602.08223) <a id="link66"></a>
...
**Comment:** This paper proposes a minimal interpretation of the Galactic cosmic-ray spectrum. It does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 67. [Neutrino Emission from Gamma-ray Burst Jet Propagating inside the Cavity within Active Galactic Nucleus Accretion Disks](https://arxiv.org/abs/2602.08319) <a id="link67"></a>
...
**Comment:** Studies neutrino emission from gamma-ray burst jets in AGN accretion disks. The focus is on high-energy phenomena and jet interactions, not on galaxy-scale processes, dwarf galaxies, or star formation histories. No direct match to any core criteria.
...
## 68. [SPHEREx as a frontier for infrared transients: Classification of new Galactic FU Ori outbursts and classical novae](https://arxiv.org/abs/2602.07129) <a id="link68"></a>
...
**Comment:** Presents SPHEREx spectra for Galactic infrared transients, including FU Orionis outbursts and classical novae. The focus is on transient classification and Galactic sources, not on galaxy-scale processes or any core criteria.
...
## 69. [Toward Vision-Language Assistants for Radio Astronomical Source Analysis](https://arxiv.org/abs/2602.07469) <a id="link69"></a>
...
**Comment:** Evaluates vision-language models for radio astronomical source analysis. The focus is on machine learning for radio source classification, not on galaxy-scale astrophysics or any of the core criteria.
...
## 70. [Prospective bounds on f(Q) gravity with pulsar timing arrays](https://arxiv.org/abs/2602.07557) <a id="link70"></a>
...
**Comment:** The paper discusses constraints on modified gravity using pulsar timing arrays and gravitational waves. While it is astrophysics-related, it does not address any of the core topics such as near-field cosmology, galaxy simulations, star formation histories, or outflows. The focus is on fundamental physics and gravity, not galaxies or their evolution.
...
## 71. [The Reawakening of 4U 1755-338 after 25 Years of Quiescence: Spectro-temporal Analysis Using Multi-instrument X-ray Data](https://arxiv.org/abs/2602.08926) <a id="link71"></a>
...
**Comment:** This paper focuses on the X-ray outburst of a black hole binary system, analyzing accretion disk properties and spectral features. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, dwarf galaxies, stellar models, galaxy simulations, outflows, or CGM).
...
## 72. [GaLactic and Extragalactic All-sky Murchison Widefield Array survey eXtended (GLEAM-X) III: Galactic Plane](https://arxiv.org/abs/2602.08475) <a id="link72"></a>
...
**Comment:** Presents a radio survey of the Galactic Plane, providing catalogues and images. No direct connection to any of the core criteria such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 73. [Fabrication and Characterization of X-ray TES Detectors Based on Annular AlMn Alloy Films](https://arxiv.org/abs/2510.00642) <a id="link73"></a>
...
**Comment:** This paper describes the fabrication and characterization of X-ray TES detectors, which are relevant for instrumentation but not for the core topics such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations. It does not present new stellar models or address galaxy-scale processes.
...
## 74. [Pulsars and Millisecond Pulsars I: Advancements, Open Questions and finding Gaps via statistical insights](https://arxiv.org/abs/2602.08065) <a id="link74"></a>
...
**Comment:** Statistical study of pulsars and millisecond pulsars, including their emission properties, timing, and binary evolution. While it uses numerical tools and discusses compact object evolution, it does not focus on galaxies, star formation histories, quenching, or outflows. No direct match to any core criteria.
...
## 75. [On the Deepest Search for Galactic Center Pulsars and an Examination of an Intriguing Millisecond Pulsar Candidate](https://arxiv.org/abs/2602.08922) <a id="link75"></a>
...
**Comment:** Focuses on pulsar searches in the Galactic Center, which is specifically excluded from the relevant topics (irrelevant: papers that focus on Galactic center). No match to any core criteria.
...
## 76. [The seismic diversity of four successive solar cycle minima as observed by the Birmingham Solar-Oscillations Network (BiSON)](https://arxiv.org/abs/2602.09019) <a id="link76"></a>
...
**Comment:** Helioseismic study of the Sun's internal structure across solar cycle minima. This is not related to any of the core topics (no galaxy simulations, star formation, or dwarf galaxy focus).
...
## 77. [A MeerKAT search for persistent radio sources towards twenty-five localised Fast Radio Bursts](https://arxiv.org/abs/2602.07716) <a id="link77"></a>
...
**Comment:** This paper reports a search for persistent radio sources associated with fast radio bursts. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 78. [An unusual pair of interstellar HI features and a related white dwarf star inside the HI cavity surrounding the Upper Sco-Cen OB2 Association](https://arxiv.org/abs/2602.08756) <a id="link78"></a>
...
**Comment:** Reports on HI features and a white dwarf inside an HI cavity, possibly related to a planetary nebula remnant. The focus is on interstellar medium structures and stellar remnants, not on galaxy-scale processes or any core criteria.
...
## 79. [SOLO: wide-field asteroid light curve monitoring system for SPHEREx](https://arxiv.org/abs/2602.08037) <a id="link79"></a>
...
**Comment:** This paper describes a new survey system for asteroid light curves, supporting the SPHEREx mission. It is unrelated to the core topics, as it focuses on Solar System objects and asteroid photometry.
...
## 80. [An Open-Source High-Level Graphical Signal Processing Language with Simulation and HDL Generation](https://arxiv.org/abs/2602.07130) <a id="link80"></a>
...
**Comment:** This paper introduces an open-source graphical signal processing language for radio astronomy instrumentation. It is unrelated to the core topics, as it focuses on instrumentation and software tools.
...
## 81. [Impact of embedded circumplanetary winds on the circumstellar disk: I. Reshaping the local accretion environment](https://arxiv.org/abs/2602.08087) <a id="link81"></a>
...
**Comment:** Hydrodynamic simulations of circumplanetary winds and their effect on circumstellar disks and planetary growth. This is focused on planet formation and disk physics, not galaxy-scale phenomena or any of the core criteria.
...
## 82. [NovaMoon: A Strategic Lunar Reference Station for Positioning, Timing, and Largely Enhanced Science in the Earth-Moon System Serena](https://arxiv.org/abs/2602.08432) <a id="link82"></a>
...
**Comment:** Describes a lunar geodetic and timing station for navigation and science; not related to any core topics (no galaxy simulations, star formation, or dwarf galaxy focus).
...
## 83. [Scalar-Induced Gravitational Waves and Primordial Black Holes from a Localized Bump or Dip Feature in a Single-Field Inflationary Potential](https://arxiv.org/abs/2602.07951) <a id="link83"></a>
...
**Comment:** Studies scalar-induced gravitational waves and primordial black holes from inflationary features. The focus is on early universe cosmology and not near-field cosmology or galaxy-scale processes.
...
## 84. [Modeling Tidal Disruption Events and Compact Object Plunges in Nuclear Star Clusters](https://arxiv.org/abs/2602.08574) <a id="link84"></a>
...
**Comment:** Simulates tidal disruption events and compact object inspirals in nuclear star clusters with a central SMBH. The focus is on SMBH growth and TDEs, which are explicitly listed as irrelevant in the criteria.
...
## 85. [Can UV meet IR in the Swiss cheese?](https://arxiv.org/abs/2602.08487) <a id="link85"></a>
...
**Comment:** The paper discusses embedding regular black holes in cosmological models and the impact of UV modifications on the universe's expansion. It is unrelated to near-field cosmology, galaxy simulations, star formation histories, or stellar models. The focus is on black hole physics and cosmological expansion.
...
## 86. [Astrophysical positronium and Dicke superradiance](https://arxiv.org/abs/2602.07489) <a id="link86"></a>
...
**Comment:** This paper reviews Dicke superradiance and speculates on its astrophysical significance for hydrogen and positronium, especially near the galactic center. The focus is on atomic physics and emission processes, not on galaxy-scale phenomena, stellar models, or near-field cosmology.
...
## 87. [Sunrise III: The Wavefront Correction System](https://arxiv.org/abs/2602.07448) <a id="link87"></a>
...
**Comment:** This paper describes the wavefront correction system for the Sunrise III telescope, focusing on instrumentation and image stabilization. It does not address galaxy-scale processes, star formation, or stellar models.
...
## 88. [High-resolution X-ray spectroscopy of Cen X-3 with XMM-Newton](https://arxiv.org/abs/2602.08408) <a id="link88"></a>
...
**Comment:** Spectral analysis of X-ray binary Cen X-3, focusing on accretion and plasma properties. This is compact object astrophysics, not related to galaxy-scale topics or any core criteria.
...
## 89. [Machine Learning-Ready Data Sets for the Analysis and Nowcasting of Atmospheric Radiation at Aviation Altitudes](https://arxiv.org/abs/2602.07108) <a id="link89"></a>
...
**Comment:** Machine learning datasets for nowcasting atmospheric radiation at aviation altitudes. This is Earth atmosphere and radiation environment work, not related to any galaxy or stellar criteria.
...
## 90. [Fabrication and characterization of AlMn alloy superconducting films for 0vbb experiments](https://arxiv.org/abs/2510.00641) <a id="link90"></a>
...
**Comment:** Experimental work on superconducting films for neutrinoless double-beta decay detectors; not related to any core topics (no galaxy simulations, star formation, or stellar models as defined).
...
## 91. [Can Dirac neutrinos destabilize $\mathcal{Z}_2$ domain wall network?](https://arxiv.org/abs/2602.07380) <a id="link91"></a>
...
**Comment:** Discusses domain wall networks and Dirac neutrino mass generation in particle physics, with implications for gravitational waves and baryogenesis. No direct connection to any of the astrophysical core criteria.
...
## 92. [Evaluating the $\Sigma$-effect Model of the Solar Hemispherical Helicity Bias via Direct Numerical Simulations](https://arxiv.org/abs/2602.08992) <a id="link92"></a>
...
**Comment:** This paper evaluates the Sigma-effect model for solar hemispherical helicity bias using simulations. It is not relevant to galaxy simulations, star formation, or near-field cosmology.
...
## 93. [Assessment of DKIST/VTF Capabilities for the Detection of Local Acoustic Source Wavefronts](https://arxiv.org/abs/2602.07137) <a id="link93"></a>
...
**Comment:** This paper assesses DKIST/VTF capabilities for detecting local acoustic wavefronts in the solar photosphere. It does not address any of the core topics.
...
## 94. [Post-Newtonian accelerations of a Mercury orbiter](https://arxiv.org/abs/2602.08720) <a id="link94"></a>
...
**Comment:** Relativistic modeling of spacecraft motion in Mercury's local coordinates. The focus is on planetary dynamics and relativistic corrections for spacecraft, not on galaxy-scale astrophysics or any of the core criteria.
...
## 95. [Variation of the sunspot area during the rising and declining phases of the solar cycle supports the toroidal flux loss due to flux emergence](https://arxiv.org/abs/2602.07194) <a id="link95"></a>
...
**Comment:** The paper studies sunspot area variation and solar cycle dynamics, which is not relevant to any of the core criteria (no connection to dwarf galaxies, star formation histories, galaxy simulations, or stellar models).
...
## 96. [Seasonal Variation of Polar Ice: Implications for Ultrahigh Energy Neutrino Detectors](https://arxiv.org/abs/2602.08921) <a id="link96"></a>
...
**Comment:** The paper studies seasonal variations in polar ice and their implications for ultrahigh energy neutrino detectors. It is focused on detector physics and ice properties, not on galaxy-scale processes, star formation, or stellar models.
...
## 97. [WFC3/UVIS: External CTE Monitoring 2009-2024](https://arxiv.org/abs/2602.07133) <a id="link97"></a>
...
**Comment:** This paper examines charge transfer efficiency in the Hubble WFC3/UVIS detector. It is not relevant to any of the core topics.
...
## 98. [Imagining the Alien: Human Projections and Cognitive Limitations](https://arxiv.org/abs/2602.07284) <a id="link98"></a>
...
**Comment:** Philosophical discussion of human imagination regarding alien life; not related to any core astrophysical topics.
...
## 99. [Scintillation muon telescope module with fiber-optic light collection](https://arxiv.org/abs/2602.07490) <a id="link99"></a>
...
**Comment:** This paper describes the development and testing of a muon telescope module for cosmic ray monitoring. It is unrelated to the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
