...
1. [ARCHITECTS I: Impact of subgrid physics on the simulated properties of the circumgalactic medium](#user-content-link1)
**Authors:** Maxime Rey, J\'er\'emy Blaizot, Taysun Kimm, Joakim Rosdahl, L\'eo Michel-Dansac

2. [Modeling Globular Cluster Stellar Streams with a Basis-Expansion N-body Code](#user-content-link2)
...
3. [First detection of the TiO i1Pi-a1Delta system in stellar spectra and its laboratory characterization](#user-content-link3)
**Authors:** M. R. Schmidt

4. [Gaia FGK Benchmark Stars: Selecting Infrared Lines for Abundance Determination](#user-content-link4)
**Authors:** Scarlet Elgueta, Paula Jofr\'e, Claudia Aguilera-G\'omez, Ditte Slumstrup, \'Alvaro Rojas-Arriagada, Ulrike Heiter, Laia Casamiquela, Manuela Zoccali, Clare Worley, Caroline Soubiran

5. [ARCHITECTS II: Impact of subgrid physics on the observable properties of the circumgalactic medium](#user-content-link5)
**Authors:** Maxime Rey, J\'er\'emy Blaizot, Taysun Kimm, Joakim Rosdahl, L\'eo Michel-Dansac, Valentin Mauerhofer

6. [Modelling the non-equilibrium chemistry of the Milky Way's cold nuclear wind](#user-content-link6)
**Authors:** Karlie A. Noon, Mark R. Krumholz, Naomi M. McClure-Griffiths, Enrico M. Di Teodoro, Lucia Armillotta

7. [LIGHTS. The Thin Encircling Stellar Stream of NGC 3938](#user-content-link7)
**Authors:** Dennis Zaritsky, Jacob Nibauer, Giulia Golini, Ignacio Ruiz Cejudo, Ignacio Trujillo, Sarah Pearson, Nushkia Chamba, Chen-Yu Chuang, Mauro D'Onofrio, Sepideh Eskandarlou, Sergio Guerra Arencibia, S. Zahra Hosseini-ShahiSavandi, Ouldouz Kaboud, Minh Ngoc Le, Garreth Martin, Mireia Montes, Samane Raji, Javier Rom\'an, Nafise Sedighi, Zahra Sharba

8. [[C/N] Ages and Extra-Mixing for [Fe/H] <- 0.5: Insights from the LMC and SMC](#user-content-link8)
**Authors:** Yuxi Lu, John D. Roberts, Joshua T. Povick, Marc H. Pinsonneault, Madeline Howell, David L. Nidever, Jennifer A. Johnson

9. [I-Band Asymptotic Giant Branch (IAGB) Stars: II. A First Estimate of their Precision and a Differential Zero Point](#user-content-link9)
**Authors:** Wendy L. Freedman, Barry F. Madore, Taylor Hoyt, In Sung Jang, Abigail J. Lee, Kayla A. Owens

10. [S-PLUS: Beyond Spectroscopy IV. Stellar Parameters and Elemental-abundance Ratios for Six Million Stars from DR4 and First Results for the Magellanic Clouds](#user-content-link10)
**Authors:** Yang Huang, Timothy C. Beers, Kai Xiao, C. Mendes de Oliveira, Felipe Almeida-Fernandes, G. B. Oliveira Schwarz, Young Sun Lee, Jihye Hong, Huiling Chen, Huawei Zhang, Guilherme Limberg, Maiara S. Carvalho, P. K. Humire, Andr\'e Luiz Figueiredo, Bruno Dias, Alvaro Alvarez-Candal, Marcos Fonseca-Faria, A. Kanaan, T. Ribeiro, W. Schoenell, Silvia Rossi

11. [Revising the Milky Way Cepheid Calibration: Quantifying and Correcting for Previously Undetected Distance Modulus Errors in the Gaia-based Multi-Wavelength Period-Luminosity Relations](#user-content-link11)
**Authors:** Barry F. Madore, Wendy L. Freedman

12. [Exploring Non-minimal coupling using ultra-diffuse galaxies](#user-content-link12)
**Authors:** Saboura Zamani, Vincenzo Salzano, Dario Bettoni

13. [I-Band Asymptotic Giant Branch (IAGB) Stars: I. Exploring a New Standard Candle for the Extragalactic Distance Scale](#user-content-link13)
**Authors:** Barry F. Madore, Wendy L. Freedman, Taylor Hoyt, In Sung Jang, Abigail Lee, Kayla Owens

14. [Infrared period-luminosity relations of Galactic Miras based on multi-epoch photometry and the Gaia parallax uncertainty](#user-content-link14)
**Authors:** S. Uttenthaler, T. Lebzelter, S. Meingast

15. [Seismic detection of core magnetic fields in red giants using the gravity offset](#user-content-link15)
**Authors:** Matisse Villate, S\'ebastien Deheuvels, J\'er\^ome Ballot

16. [Effective Magnetic Susceptibility of Dust Grains with Superparamagnetic Inclusions and Implications](#user-content-link16)
**Authors:** Thiem Hoang (KASI, UST)

17. [Large-scale and local environmental drivers of quenching: tracing H$\alpha$ concentration in X-ray and optical galaxy groups](#user-content-link17)
...
18. [The Signature of Strong High-Redshift Radio Backgrounds on the Cosmic Dawn 21-cm Bispectrum](#user-content-link18)
**Authors:** Sudipta Sikder, Rajesh Mondal, Rennan Barkana, Anastasia Fialkov

19. [Generalization from Low- to Moderate-Resolution Spectra with Neural Networks for Stellar Parameter Estimation: A Case Study with DESI](#user-content-link19)
...
20. [Characterizing Lyman alpha emission from high-redshift galaxies](#user-content-link20)
**Authors:** Samuel Gagnon-Hartman, Andrei Mesinger, Ivan Nikoli\'c, Eleonora Parlanti, Giacomo Venturi

21. [Multiwavelength Characterization of a Dynamically Relaxed Cool Core Galaxy Cluster at $z=1.5$](#user-content-link21)
...
22. [Bayesian Cosmic Void Finding with Graph Flows](#user-content-link22)
**Authors:** Leander Thiele

23. [Nonlinear diffusive shock acceleration with upstream escape reproduces DAMPE observations](#user-content-link23)
**Authors:** Han-Xiang Hu, Xing-Jian Lv, Xiao-Jun Bi, Tian-Lu Chen, Kun Fang, Peng-Fei Yin

24. [Constraining Lorentz Violation using 21cm and CMB Cross Correlations](#user-content-link24)
**Authors:** Bhuwan Joshi, Rahul Kothari, Shyam Chaudhary

25. [Dyad: a binary-star dynamics and statistics library for Python](#user-content-link25)
**Authors:** Amery Gration

26. [Predicting New Concept-Object Associations in Astronomy by Mining the Literature](#user-content-link26)
**Authors:** Jinchu Li (Georgia Institute of Technology), Yuan-Sen Ting (The Ohio State University), Alberto Accomazzi (The Center for Astrophysics | Harvard & Smithsonian), Tirthankar Ghosal (Oak Ridge National Laboratory), Nesar Ramachandra (Argonne National Laboratory)

27. [The Physical Properties of PS1-12sk and the Implications to Its Progenitor System](#user-content-link27)
**Authors:** Kai-Li Mi, Shan-Qin Wang, Wen-Pei Gan, Qiu-Ping Huang, Tao Wang, En-Wei Liang

28. [Holographic Dark Matter](#user-content-link28)
**Authors:** Sylvain Fichet, Eugenio Megias, Mariano Quiros

29. [Estimation of neutron star mass and radius of FRB 20240114A by identification of crustal oscillations](#user-content-link29)
**Authors:** Hajime Sotani, Zorawar Wadiasingh, Cecilia Chirenti

30. [Kinematic Evidence for Open Cluster Origins of Galactic Binary Neutron Stars](#user-content-link30)
**Authors:** Wen-Jie Yu, Lu Zhou, Zhi-Qiang You, Hao Ding, Lu Li, Long Wang, Xing-Jiang Zhu

31. [Ultramassive Black Holes and the Three $M$-$\sigma$ Relations](#user-content-link31)
**Authors:** Andrew King

32. [Surveying the Giant HII Regions of the Milky Way with SOFIA: VIII. W43 Main](#user-content-link32)
**Authors:** James M. De Buizer (SETI Institute), Wanggi Lim (IPAC), James T. Radomski (Independent Researcher), Nicole Karnath (SSI)

33. [AT 2025abao: the fourth luminous red nova in M 31](#user-content-link33)
...
34. [Local Short-Time Acceleration and deSitter Spacetime induced Extra Spectral Broadening: a Simple Interpretation of Modified Inertial in MOND](#user-content-link34)
**Authors:** M. J. Luo

35. [Pulsars and Millisecond Pulsars III: Tracing Compact Object Dynamics in Globular Clusters with NBODY6++GPU](#user-content-link35)
**Authors:** M. Rah, R. Spurzem, F. Flammini Dotti, A. Mickaelian

36. [Evidence for the merger hypothesis in V4332 Sgr: a low $^{12}$C/$^{13}$C ratio and multiple outbursts](#user-content-link36)
**Authors:** D. P. K. Banerjee (Physical Research Laboratory, Ahmedabad, India), A. Evans (Keele University, UK), Watson P. Varricatt (UKIRT Observatory), N. M. Ashok (PRL, Ahmedabad, India)

37. [Zel'dovich smearing approximation of the BAO feature for model-agnostic cosmological inference](#user-content-link37)
**Authors:** Aseem Paranjape (IUCAA), Ravi K. Sheth (UPenn/ICTP)

38. [Back to Normal Again: Possible Destinies of JWST overmassive SMBHs and "Little Red Dots" in the View of Shin-Uchuu Simulation](#user-content-link38)
**Authors:** Haojie Hu, Hiroto Yanagisawa, Moka Nishigaki, Tomokazu Kiyota, Tomoaki Ishiyama, Ken Ohsuga

39. [Multi-frequency mapping of the S255IR region at a wavelength of 1~mm](#user-content-link39)
**Authors:** E. A. Mikheeva (Lebedev Physical Institute, Russian Academy of Sciences, Astro Space Center, Moscow, Russia), S. V. Kalenskii (Lebedev Physical Institute, Russian Academy of Sciences, Astro Space Center, Moscow, Russia), S. -Y. Liu (Institute of Astronomy and Astrophysics, Academia Sinica, Taipei, Taiwan), A. M. Sobolev (Xinjiang Astronomical Observatory, Chinese Academy of Sciences, Urumqi, China, Ural Federal University, Yekaterinburg, Russia), S. Kurtz (Instituto de Radioastronom\'ia y Astrof\'isica, Universidad Nacional Aut\'onoma de M\'exico, Morelia, Mexico)

40. [Accelerating Posterior Inference from Pulsar Light Curves via Learned Latent Representations and Local Simulator-Guided Optimization](#user-content-link40)
...
41. [Gravitational Wave Echoes of the First Order Phase Transition in a Kination-Induced Big Bang](#user-content-link41)
**Authors:** Richard Casey, Katherine Freese, Evangelos I. Sfakianakis

42. [Quarkyonic matter and hadron-quark crossover from an ultracold atom perspective](#user-content-link42)
**Authors:** Hiroyuki Tajima, Kei Iida, Toru Kojo, Haozhao Liang

43. [Detection of Cyclotron Absorption in the Radio Emission of GPM 1839-10](#user-content-link43)
...
44. [VENUS: Strong-lensing model of MACS J1931.8-2635 -- revealing the farthest multiply imaged supernova](#user-content-link44)
...
45. [Prospects of Indirect Detection of Dark Matter via Primordial Black Hole Induced Gravitational Waves](#user-content-link45)
**Authors:** Debarun Paul, Md Riajul Haque, Supratik Pal

46. [Production of Jets before Neutron Star Mergers](#user-content-link46)
**Authors:** Praveen Sharma, Maxim Lyutikov, Slava G. Turyshev, Maxim V. Barkov

47. [Gravitational waves from supercooled phase transitions and pulsar timing array signals](#user-content-link47)
**Authors:** Jinzheng Li, Pran Nath

48. [MeerKAT discovery of a high-redshift strongly-lensed hydroxyl gigamaser](#user-content-link48)
**Authors:** Thato E. Manamela (University of Pretoria), Roger P. Deane (University of Pretoria, Inter-University Institute for Data Intensive Astronomy, University of the Witwatersrand), Tariq Blecher (Rhodes University, South African Radio Astronomy Observatory), Ian Heywood (SKA Observatory, University of Oxford, Rhodes University, South African Radio Astronomy Observatory), Athol J. Kemball (University of Illinois), Danail Obreschkow (University of Western Australia, ARC Centre of Excellence for All Sky Astrophysics in 3 Dimensions)

49. [Improved frequency hierarchy treatment for anisotropic spectral distortions](#user-content-link49)
**Authors:** Jens Chluba, Sara Evangelista, Tom Daman, Geoff Vasil

50. [Gauge-independent gravitational waves from a minimal dark $U(1)$ sector with viable dark matter candidates](#user-content-link50)
**Authors:** Wan-Zhe Feng, Zi-Hui Zhang

51. [CMB Spectral Distortions from Resonant Conversions in Atomic Dark Sectors](#user-content-link51)
**Authors:** Duncan K. Adams, Jared Barron, Bryce Cyr, Xiuyuan Zhang

52. [A universal critical accretion rate for black hole jet formation](#user-content-link52)
**Authors:** Adelle J. Goodwin, Andrew Mummery

53. [MarsRetrieval: Benchmarking Vision-Language Models for Planetary-Scale Geospatial Retrieval on Mars](#user-content-link53)
**Authors:** Shuoyuan Wang, Yiran Wang, Hongxin Wei

54. [Reduction of bar fraction in paired galaxies in the SDSS](#user-content-link54)
**Authors:** Linlin Li, Shuai Feng, Shiyin Shen, Qi'an Deng, Ying Zu, Wenyuan Cui

55. [The initial states of high frequency gravitons](#user-content-link55)
**Authors:** Massimo Giovannini

56. [Searching for Neutron Star Mergers in the Absence of Gravitational Waves with Optical Afterglow Emission](#user-content-link56)
**Authors:** Haille M. L. Perkins, Gautham Narayan, Brian D. Fields, Ved G. Shah, Genevieve Schroeder

57. [Habitable Zones Around Massive Stars: From the Main Sequence to Supergiants](#user-content-link57)
**Authors:** Devesh Nandal, Abraham Loeb

58. [Constraining Binary Neutron Star Populations using Short Gamma-Ray Burst Observations](#user-content-link58)
**Authors:** Alessio Ludovico De Santis, Samuele Ronchini, Filippo Santoliquido, Marica Branchesi

59. [Superorbital Phase Evolution and a Soft-Hard X-ray Phase Shift in LMC X-4](#user-content-link59)
**Authors:** Yi Chou

60. [Circular orbits and observational features of the rotating Simpson-Visser black hole surrounded by a thin accretion disk](#user-content-link60)
**Authors:** Ziyang Li, Shou-Qi Liu, Jia-Hui Huang

61. [New Dynamical Measurements from a Lensed Quasar Sample: Joint Analysis Constrains the Mass Profile Evolution of Lens Galaxies](#user-content-link61)
**Authors:** Ziyu Guo, Yun Chen, Yiping Shu, Jiaze Gao, Hui Li, Zizhao He, Jun Wang

62. [Quintessence with tachyonic resonance and late-time cosmic-microwave-background and gravitational-wave signals](#user-content-link62)
**Authors:** Shun Yoshioka, Kiyotomo Ichiki, Yuichiro Tada, Takahiro Terada

63. [Multiscale feature integration network for inpainting of full-sky CMB $B$-modes](#user-content-link63)
**Authors:** Reyhan D. Lambaga, Vipin Sudevan, Pisin Chen

64. [The James Webb Space Telescope Absolute Flux Calibration. V. Near-Infrared Camera Wide Field](#user-content-link64)
**Authors:** Nor Pirzkal, Martha Boyer, Russel E. Ryan Jr

65. [Exploring the magnetic field of the ultraluminous X-ray pulsar NGC 4631 X-8](#user-content-link65)
**Authors:** Amar Deo Chandra

66. [Investigating the impact of quasi-universal relations on neutron star constraints in third-generation detectors](#user-content-link66)
**Authors:** Natalie Williams, Anna Puecher, Guilherme Grams, C\'esar V. Flores, Tim Dietrich

67. [Infrared spectra of methane-containing ice mixtures for JWST data analysis](#user-content-link67)
**Authors:** Varvara Karteyeva, Ruslan Nakibov, Igor Petrashkevich, Mikhail Medvedev, Anton Vasyunin

68. [Modelling the Break in the Specific Angular Momentum within the Envelope-Disk Transition Zone](#user-content-link68)
**Authors:** Indrani Das, Shantanu Basu, Nagayoshi Ohashi, Eduard Vorobyov, Yusuke Aso

69. [Dense Molecular Clumps with Large Blue Asymmetries: Evidence for Collapse](#user-content-link69)
...
70. [Geodetically Anchored 0.30m Digital Elevation Model of the Chandrayaan-3 Vikram Landing Site from Chandrayaan-2 Orbital High Resolution Camera (OHRC) Stereo Imagery](#user-content-link70)
**Authors:** Chandra Tungathurthi

71. [Unprecedented Multipoint Observation of Spatially Varying ICME Turbulence of Different Ages during October 2024 Extreme Solar Storm at 1 AU](#user-content-link71)
**Authors:** Shibotosh Biswas, Ankush Bhaskar, SG Abitha, Omkar Dhamane, Sanchita Pal, Dibyendu Chakrabarty, Vipin K Yadav

72. [Agent Mars: Multi-Agent Simulation for Multi-Planetary Life Exploration and Settlement](#user-content-link72)
**Authors:** Ziyang Wang

73. [4U 1556-60 as a very faint neutron star X-ray binary at 700 pc with an undetected radio jet](#user-content-link73)
**Authors:** Eliot C. Pattie, Thomas J. Maccarone, Thomas Russell, Matteo Bachetti, Nathalie Degenaar, Thomas Kupfer

74. [The Cosmological Parameters (2025)](#user-content-link74)
**Authors:** Marina Cort\^es, Ofer Lahav, Andrew R Liddle

75. [Carbon chain diversity in L1544 and IRAS 16293-2422: an astrochemical pathfinder study for the SKAO](#user-content-link75)
...
76. [Superhumps and their Relation to the Disk Instability Model](#user-content-link76)
**Authors:** Daisaku Nogami

77. [Optimal polarization modulation and calibration schemes](#user-content-link77)
**Authors:** Roberto Casini, David M. Harrington, Alfred G. de Wijn

78. [J-PAS: Semi-Supervised Sim-to-Obs Transfer for Robust Star--Galaxy--Quasar Classification](#user-content-link78)
**Authors:** Daniel L\'opez-Cano, L. Raul Abramo, L. Nakazono, I. P\'erez-R\`afols, G. Mart\'inez-Solaeche, J. Chaves-Montero, Matthew M. Pieri, Jailson Alcaniz, Narciso Benitez, Silvia Bonoli, Saulo Carneiro, Javier Cenarro, David Crist\'obal-Hornillos, Simone Daflon, Renato Dupke, Alessandro Ederoclite, Rosa Gonz\'alez Delgado, Antonio Hern\'an-Caballero, Carlos Hern\'andez-Monteagudo, Jifeng Liu, Carlos L\'opez-Sanjuan, Antonio Mar\'in-Franch, Claudia Mendes de Oliveira, Mariano Moles, Fernando Roig, Laerte Sodr\'e Jr., Keith Taylor, Jes\'us Varela, H\'ector V\'azquez Rami\'o, Jose Vilchez, Javier Zaragoza-Cardiel

79. [The impact of the formation channel on gravitational-wave-galaxy cross-correlations](#user-content-link79)
**Authors:** Kabir Chakravarti, Federico R. Urban

80. [Leveling of MHD turbulence imbalance in shear flows](#user-content-link80)
**Authors:** M. Kavtaradze, G. Mamatsashvili, G. Chagelishvili, E. Uchava

81. [Nonlinearity in H4RG-10 Near-Infrared Detectors at Elevated Temperatures: Characterization and Data-Driven Correction Method](#user-content-link81)
**Authors:** Ryusei Hamada, Gregory Mosby Jr., Shota Miyazaki, Daisuke Suzuki, Alexander Kutyrev, Joseph Durbak, Yuki Hirao, Takahiro Sumi

82. [Dynamical Preconditions for Ice Formation in Supernova Remnant and Cloud Interactions: A 2D MHD Study](#user-content-link82)
**Authors:** A. Yeghikyan, M. Rah, S. Shamyar, S. Khachatryan

83. [Estimatingthe Contribution of Galactic Neutrino Sources](#user-content-link83)
**Authors:** Mohadeseh Ozlati Moghadam, Kathrin Egberts, Rowan Batzofin, Constantin Steppa, Elisa Bernardini

84. [Dust and Ices in the SNR](#user-content-link84)
**Authors:** A. Yeghikyan, M. Rah, S. Shamyar

85. [Tracing Fe K X-ray reverberation lag in the energy-resolved spectra of Narrow-line Seyfert 1 galaxy Ton S180](#user-content-link85)
**Authors:** Dilip Kumar Roy, Samuzal Barua, Ranjeev Misra, Rathin Sarma, V. Jithesh

86. [Bounds on Lorentz invariance violation from muon fluctuations at the Pierre Auger Observatory](#user-content-link86)
...
87. [Measuring neutrino mixing above 1 TeV with astrophysical neutrinos](#user-content-link87)
**Authors:** Mauricio Bustamante, Qinrui Liu, Gabriela Barenboim

88. [In-orbit Demonstration of X-ray Pulsar Navigation with NinjaSat](#user-content-link88)
...
89. [Evolution of Linear Perturbations under Time-Dependent Hubble Friction I: SR-USR-SR Inflation](#user-content-link89)
**Authors:** Wen Li, Chao Chen

90. [H.E.S.S. detection of the PSR J0855-4644 nebula](#user-content-link90)
**Authors:** F. Aharonian (H.E.S.S. Collaboration), H. Ashkar (H.E.S.S. Collaboration), M. Backes (H.E.S.S. Collaboration), R. Batzofin (H.E.S.S. Collaboration), Y. Becherini (H.E.S.S. Collaboration), D. Berge (H.E.S.S. Collaboration), K. Bernl\"ohr (H.E.S.S. Collaboration), M. B\"ottcher (H.E.S.S. Collaboration), C. Boisson (H.E.S.S. Collaboration), J. Bolmont (H.E.S.S. Collaboration), F. Brun (H.E.S.S. Collaboration), B. Bruno (H.E.S.S. Collaboration), C. Burger-Scheidlin (H.E.S.S. Collaboration), T. Bylund (H.E.S.S. Collaboration), S. Casanova (H.E.S.S. Collaboration), D. Cecchin Momesso (H.E.S.S. Collaboration), J. Celic (H.E.S.S. Collaboration), M. Cerruti (H.E.S.S. Collaboration), A. Chen (H.E.S.S. Collaboration), M. Chernyakova (H.E.S.S. Collaboration), J. O. Chibueze (H.E.S.S. Collaboration), O. Chibueze (H.E.S.S. Collaboration), B. Cornejo (H.E.S.S. Collaboration), G. Cotter (H.E.S.S. Collaboration), G. Cozzolongo (H.E.S.S. Collaboration), J. de Assis Scarpin (H.E.S.S. Collaboration), M. de Bony de Lavergne (H.E.S.S. Collaboration), M. de Naurois (H.E.S.S. Collaboration), E. de O\~na Wilhelmi (H.E.S.S. Collaboration), A. G. Delgado Giler (H.E.S.S. Collaboration), J. Devin (H.E.S.S. Collaboration), A. Dmytriiev (H.E.S.S. Collaboration), K. Egberts (H.E.S.S. Collaboration), K. Egg (H.E.S.S. Collaboration), J. -P. Ernenwein (H.E.S.S. Collaboration), C. Esca\~nuela Nieves (H.E.S.S. Collaboration), P. Fauverge (H.E.S.S. Collaboration), K. Feijen (H.E.S.S. Collaboration), M. D. Filipovic (H.E.S.S. Collaboration), G. Fontaine (H.E.S.S. Collaboration), S. Funk (H.E.S.S. Collaboration), S. Gabici (H.E.S.S. Collaboration), Y. A. Gallant (H.E.S.S. Collaboration), M. Genaro (H.E.S.S. Collaboration), J. F. Glicenstein (H.E.S.S. Collaboration), J. Glombitza (H.E.S.S. Collaboration), P. Goswami (H.E.S.S. Collaboration), M. -H. Grondin (H.E.S.S. Collaboration), L. Heckmann (H.E.S.S. Collaboration), B. He{\ss} (H.E.S.S. Collaboration), W. Hofmann (H.E.S.S. Collaboration), T. L. Holch (H.E.S.S. Collaboration), M. Holler (H.E.S.S. Collaboration), D. Horns (H.E.S.S. Collaboration), M. Jamrozy (H.E.S.S. Collaboration), F. Jankowsky (H.E.S.S. Collaboration), A. Jardin-Blicq (H.E.S.S. Collaboration), I. Jaroschewski (H.E.S.S. Collaboration), D. Jimeno (H.E.S.S. Collaboration), I. Jung-Richardt (H.E.S.S. Collaboration), E. Kasai (H.E.S.S. Collaboration), K. Katarzy\'nski (H.E.S.S. Collaboration), D. Kerszberg (H.E.S.S. Collaboration), B. Kh\'elifi (H.E.S.S. Collaboration), W. Klu\'zniak (H.E.S.S. Collaboration), N. Komin (H.E.S.S. Collaboration), K. Kosack (H.E.S.S. Collaboration), D. Kostunin (H.E.S.S. Collaboration), R. G. Lang (H.E.S.S. Collaboration), S. Lazarevi\'c (H.E.S.S. Collaboration), A. Lemi\`ere (H.E.S.S. Collaboration), M. Lemoine-Goumard (H.E.S.S. Collaboration), J. -P. Lenain (H.E.S.S. Collaboration), P. Liniewicz (H.E.S.S. Collaboration), A. Luashvili (H.E.S.S. Collaboration), J. Mackey (H.E.S.S. Collaboration), D. Malyshev (H.E.S.S. Collaboration), D. Malyshev (H.E.S.S. Collaboration), V. Marandon (H.E.S.S. Collaboration), M. G. F. Mayer (H.E.S.S. Collaboration), A. Mehta (H.E.S.S. Collaboration), A. M. W. Mitchell (H.E.S.S. Collaboration), R. Moderski (H.E.S.S. Collaboration), L. Mohrmann (H.E.S.S. Collaboration), E. Moulin (H.E.S.S. Collaboration), J. Niemiec (H.E.S.S. Collaboration), P. O'Brien (H.E.S.S. Collaboration), L. Olivera-Nieto (H.E.S.S. Collaboration), M. O. Moghadam (H.E.S.S. Collaboration), S. Panny (H.E.S.S. Collaboration), M. Panter (H.E.S.S. Collaboration), R. D. Parsons (H.E.S.S. Collaboration), P. Pichard (H.E.S.S. Collaboration), T. Preis (H.E.S.S. Collaboration), G. P\"uhlhofer (H.E.S.S. Collaboration), M. Punch (H.E.S.S. Collaboration), A. Quirrenbach (H.E.S.S. Collaboration), A. Reimer (H.E.S.S. Collaboration), O. Reimer (H.E.S.S. Collaboration), I. Reis (H.E.S.S. Collaboration), Q. Remy (H.E.S.S. Collaboration), H. X. Ren (H.E.S.S. Collaboration), B. Reville (H.E.S.S. Collaboration), F. Rieger (H.E.S.S. Collaboration), G. Rowell (H.E.S.S. Collaboration), B. Rudak (H.E.S.S. Collaboration), K. Sabri (H.E.S.S. Collaboration), V. Sahakian (H.E.S.S. Collaboration), M. Sasaki (H.E.S.S. Collaboration), F. Sch\"ussler (H.E.S.S. Collaboration), J. N. S. Shapopi (H.E.S.S. Collaboration), W. Si Said (H.E.S.S. Collaboration), {\L}. Stawarz (H.E.S.S. Collaboration), R. Steenkamp (H.E.S.S. Collaboration), S. Steinmassl (H.E.S.S. Collaboration), T. Tanaka (H.E.S.S. Collaboration), A. M. Taylor (H.E.S.S. Collaboration), G. L. Taylor (H.E.S.S. Collaboration), R. Terrier (H.E.S.S. Collaboration), Y. Tian (H.E.S.S. Collaboration), M. Tsirou (H.E.S.S. Collaboration), T. Unbehaunz (H.E.S.S. Collaboration), C. van Eldik (H.E.S.S. Collaboration), M. Vecchi (H.E.S.S. Collaboration), C. Venter (H.E.S.S. Collaboration), J. Vink (H.E.S.S. Collaboration), V. Voitsekhovskyi (H.E.S.S. Collaboration), T. Wach (H.E.S.S. Collaboration), S. J. Wagner (H.E.S.S. Collaboration), A. Wierzcholska (H.E.S.S. Collaboration), M. Zacharias (H.E.S.S. Collaboration), A. Zech (H.E.S.S. Collaboration), W. Zhong (H.E.S.S. Collaboration), F. Acero, L. Giunti

91. [The radial velocity curve for HeII emission cannot be used for component mass determination in SS433](#user-content-link91)
**Authors:** A. V. Dodin, K. A. Postnov, A. M. Cherepashchuk

92. [Pulsar Timing Array in the past decade](#user-content-link92)
**Authors:** Kuo Liu, Siyuan Chen

93. [On the Cuspy Structure of Rotating Wormhole Shadows](#user-content-link93)
**Authors:** Peng Cheng, Ruo-Fan Xu, Peng Zhao

94. [LHAASO observation of Mrk 421 during 2021 March - 2024 March: a comprehensive VHE catalog of multi-timescale outbursts and its time average behavior](#user-content-link94)
...
95. [Harmonic Analysis on Correlation for Gravitational-Wave Backgrounds of Arbitrary Polarization from Interfering Sources in Generic Dispersion Relation](#user-content-link95)
**Authors:** Yan-Chen Bi, Yu-Mei Wu, Qing-Guo Huang

96. [PeV neutrons as origin of separated SS433 TeV signals](#user-content-link96)
**Authors:** D. Fargion, P. G. De Sanctis Lucentini, S. Turriziani, M. Y. Khlopov, D. Sopin

97. [Pre-perihelion Volatile Evolution of Interstellar Comet 3I/ATLAS Indicating Significant Contribution from Extended Source in the Coma](#user-content-link97)
**Authors:** Juncen Li, Xian Shi, Man-To Hui, Jianchun Shi

98. [Pulsar based modeling of point spread function of Fermi Large Area Telescope](#user-content-link98)
**Authors:** J. Blunier, A. Neronov, D. Semikoz

99. [High Energy Emission from the Galactic Center](#user-content-link99)
**Authors:** Andrea Goldwurm, Ma\"ica Clavel, Stefano Gabici, R\'egis Terrier

100. [Solar active region scaling laws revisited](#user-content-link100)
**Authors:** Guilherme A. L. Nogueira, Robertus Erdelyi, Ruihui Wang, Kristof Petrovay

101. [Modeling isolated magnetar spin-down evolution and implications for long-period radio transients](#user-content-link101)
**Authors:** Jon Kwong, Kaya Mori

102. [Image instabilities and polarization cross-talk](#user-content-link102)
**Authors:** Roberto Casini, Alfred G. de Wijn

103. [Three-dimensional kink modes in solar coronal slabs: group velocities and their implications for impulsively excited waves](#user-content-link103)
**Authors:** Jing Liu, Bo Li, Mijie Shi, Mingzhe Guo, Hui Yu

104. [Recalibrating the Sensitivities of the STIS First-Order, Medium-Resolution Modes](#user-content-link104)
**Authors:** Alex Fullerton

105. [Updated Sensitivities of the Five STIS L-mode Gratings](#user-content-link105)
**Authors:** Amy M. Jones, Svea Hernandez, Joleen K. Carlberg, Daniel Welty

106. [Description of 4 Spacecraft, Moving on Elliptic Kepler Orbits](#user-content-link106)
**Authors:** Vladimir P. Zhukov, Nikolai K. Iakovlev, Alexander A. Bochkarev, Nikita E. Logvinenko, Sergei M. Kurchev, Vlas A. Karavaikin, Ivan A. Radko

107. [The Habitable Worlds Observatory in Historical Context](#user-content-link107)
**Authors:** Marc Postman, Karl Stapelfeldt

108. [Human versus Artificial Intelligence; various significant examples in astrophysics](#user-content-link108)
**Authors:** A. De R\'ujula

109. [Polarization fringes in optical systems: a compendium](#user-content-link109)
**Authors:** Roberto Casini, David M. Harrington

110. [Excavation of a 69-m diameter and 94-m high cavern for the Hyper-Kamiokande detector](#user-content-link110)
...
## 1. [ARCHITECTS I: Impact of subgrid physics on the simulated properties of the circumgalactic medium](https://arxiv.org/abs/2602.13392) <a id="link1"></a>
...
**Comment:** Directly matches the 'Numerical Galaxy Simulations' and 'Circumgalactic Medium' criteria. The paper presents new cosmological zoom-in simulations with different subgrid feedback models, focusing on the impact on the CGM and feedback modes. High relevance due to direct connection to galaxy simulations and CGM properties.
...
## 2. [Modeling Globular Cluster Stellar Streams with a Basis-Expansion N-body Code](https://arxiv.org/abs/2602.13385) <a id="link2"></a>
...
**Comment:** This paper presents a new N-body code (KRIOS) for modeling globular cluster stellar streams, comparing it to other methods and discussing progenitor physics. The focus on stellar streams and numerical galaxy simulations is highly relevant to near-field cosmology and simulation criteria.
...
## 3. [First detection of the TiO i1Pi-a1Delta system in stellar spectra and its laboratory characterization](https://arxiv.org/abs/2602.14895) <a id="link3"></a>
...
**Comment:** This paper reports the first detection and laboratory characterization of a TiO molecular band in stellar spectra, which is highly relevant to the 'Stellar Models' criterion, as it presents new empirical and synthetic spectral data for stellar atmospheres.
...
## 4. [Gaia FGK Benchmark Stars: Selecting Infrared Lines for Abundance Determination](https://arxiv.org/abs/2602.14294) <a id="link4"></a>
...
**Comment:** Presents a quantitative framework for selecting infrared atomic lines for abundance determination in benchmark stars. Directly relevant to the 'Stellar Models' criterion, as it advances stellar atmosphere models and line lists for abundance analysis.
...
## 5. [ARCHITECTS II: Impact of subgrid physics on the observable properties of the circumgalactic medium](https://arxiv.org/abs/2602.13394) <a id="link5"></a>
...
**Comment:** Directly relevant to the 'Circumgalactic Medium' and 'Numerical Galaxy Simulations' criteria. The paper analyzes how different subgrid feedback models affect the observable properties of the CGM in cosmological zoom-in simulations, using quasar absorption sightlines. Strong match to core topics, especially as it connects feedback models to CGM diagnostics.
...
## 6. [Modelling the non-equilibrium chemistry of the Milky Way's cold nuclear wind](https://arxiv.org/abs/2602.13580) <a id="link6"></a>
...
**Comment:** Directly relevant to 'Star Formation Driven Outflows' and 'Mass-loading factor' criteria. The paper models the non-equilibrium chemistry of cold gas in the Milky Way's nuclear wind, discusses mass-loading, and provides a new framework for interpreting cold gas in galactic winds. Strong match to core topics, especially outflows and their phase structure.
...
## 7. [LIGHTS. The Thin Encircling Stellar Stream of NGC 3938](https://arxiv.org/abs/2602.14192) <a id="link7"></a>
...
**Comment:** This paper presents the discovery and modeling of a stellar stream around NGC 3938, a late-type galaxy. The focus on stellar streams and accretion history is directly relevant to near-field cosmology, especially extragalactic satellite interactions and accreted stellar halo features.
...
## 8. [[C/N] Ages and Extra-Mixing for [Fe/H] <- 0.5: Insights from the LMC and SMC](https://arxiv.org/abs/2602.14925) <a id="link8"></a>
...
**Comment:** Directly addresses resolved star formation histories and stellar models by studying [C/N]-age relations and extra mixing in the LMC and SMC, with implications for deriving ages of individual stars in external galaxies. Strong match to 'Resolved Star Formation Histories' and 'Stellar Models' criteria.
...
## 10. [S-PLUS: Beyond Spectroscopy IV. Stellar Parameters and Elemental-abundance Ratios for Six Million Stars from DR4 and First Results for the Magellanic Clouds](https://arxiv.org/abs/2602.14087) <a id="link10"></a>
...
**Comment:** This paper presents stellar parameters and elemental-abundance ratios for millions of stars in the Milky Way and Magellanic Clouds, including metallicity and carbon abundance measurements. The Magellanic Clouds are relevant as extragalactic satellites, and the work provides a large dataset for studies of their stellar populations, which is relevant to near-field cosmology and resolved star formation histories.
...
## 11. [Revising the Milky Way Cepheid Calibration: Quantifying and Correcting for Previously Undetected Distance Modulus Errors in the Gaia-based Multi-Wavelength Period-Luminosity Relations](https://arxiv.org/abs/2602.13397) <a id="link11"></a>
...
**Comment:** This paper revises Cepheid calibration and period-luminosity-color relations, which is directly relevant to stellar models and bolometric corrections. It also impacts extragalactic distance measurements, which are important for near-field cosmology.
...
## 12. [Exploring Non-minimal coupling using ultra-diffuse galaxies](https://arxiv.org/abs/2602.14747) <a id="link12"></a>
...
**Comment:** This paper investigates the internal dynamics of ultra-diffuse galaxies, including their dark matter halo profiles and the possibility of non-minimal coupling between dark matter and gravity. Ultra-diffuse galaxies are often considered low-mass systems, and the paper analyzes their dark matter profiles, which is relevant to near-field cosmology and core-cusp issues.
...
## 13. [I-Band Asymptotic Giant Branch (IAGB) Stars: I. Exploring a New Standard Candle for the Extragalactic Distance Scale](https://arxiv.org/abs/2602.14242) <a id="link13"></a>

**ArXiv ID:** 2602.14242

**Authors:** Barry F. Madore, Wendy L. Freedman, Taylor Hoyt, In Sung Jang, Abigail Lee, Kayla Owens

**Abstract:** In the I-band color-magnitude diagrams (CMD) of resolved nearby galaxies, the reddest asymptotic giant branch (AGB) stars form a previously unremarked-upon, but nevertheless distinct and easily-identified population of high-luminosity stars. Hereafter we refer to this population as being comprised of I-Band AGB (IAGB) stars. Identifying these stars in the Large Magellanic Cloud (LMC), the Small Magellanic Cloud (SMC) and in NGC4258 (for all three of which there are published geometric distances) we find that the marginalized luminosity functions are each well approximated by single-peaked Gaussians, having one-sigma dispersions of +/- 0.22 mag, +/- 0.25 mag and +/- 0.24 mag, respectively. The zero points for the modal I-band absolute magnitudes of IAGB stars are found to be M_I = -4.49 +/- 0.003 mag (stat) in the LMC (4204 stars), M_I = -4.67 +/- 0.008 mag (stat), for the SMC sample (916 stars), and M_I = -4.78 +/- 0.030 mag (stat) for NGC4258 (62 stars). A global average over these three independent calibrations of the IAGB zero point (weighted inversely by squares of their systematic errors) gives  = -4.65 +/- 0.119 mag (stat) +/- 0.025 (sys). In Paper II we will show the results of applying the IAGB Method to 92 galaxies additional galaxies resolved by HST, reaching out to distances just short of 10 Mpc.

**Comment:** This paper identifies a new population of I-band AGB stars as standard candles in resolved galaxies, using color-magnitude diagrams. The focus on resolved stellar populations and CMDs is directly relevant to the resolved star formation histories criterion.
...
## 14. [Infrared period-luminosity relations of Galactic Miras based on multi-epoch photometry and the Gaia parallax uncertainty](https://arxiv.org/abs/2602.14775) <a id="link14"></a>
...
**Comment:** This paper establishes period-luminosity relations for Galactic Miras using multi-epoch photometry and Gaia parallaxes. It includes application of AGB evolutionary models and bolometric corrections, which fits the 'Stellar Models' criterion (new relations, bolometric corrections, evolutionary tracks).
...
## 15. [Seismic detection of core magnetic fields in red giants using the gravity offset](https://arxiv.org/abs/2602.14570) <a id="link15"></a>
...
**Comment:** Presents a method for detecting core magnetic fields in red giants using asteroseismology and stellar models. Directly relevant to the 'Stellar Models' criterion, as it uses and tests stellar interior models.
...
## 16. [Effective Magnetic Susceptibility of Dust Grains with Superparamagnetic Inclusions and Implications](https://arxiv.org/abs/2602.14101) <a id="link16"></a>
...
**Comment:** The paper develops a model for the magnetic susceptibility of dust grains with superparamagnetic inclusions, which is relevant to stellar atmosphere models and dust polarization. This fits the 'Stellar Models' criterion, specifically new theoretical models for stellar atmospheres and dust properties.
...
## 17. [Large-scale and local environmental drivers of quenching: tracing H$\alpha$ concentration in X-ray and optical galaxy groups](https://arxiv.org/abs/2602.14628) <a id="link17"></a>
...
**Comment:** This paper studies environmental drivers of star formation quenching, focusing on Hα concentration in galaxy groups. While the main focus is on quenching, it is primarily for higher mass galaxies and not specifically dwarfs, but the topic is still relevant.
...
## 18. [The Signature of Strong High-Redshift Radio Backgrounds on the Cosmic Dawn 21-cm Bispectrum](https://arxiv.org/abs/2602.13445) <a id="link18"></a>
...
**Comment:** The paper analyzes the impact of a strong high-redshift radio background on the 21-cm bispectrum, focusing on non-Gaussianity and early galaxies. The connection to early galaxies and the 21-cm signal is somewhat relevant to near-field cosmology and star formation histories, but the main focus is on radio backgrounds and cosmological signals.
...
## 19. [Generalization from Low- to Moderate-Resolution Spectra with Neural Networks for Stellar Parameter Estimation: A Case Study with DESI](https://arxiv.org/abs/2602.15021) <a id="link19"></a>
...
**Comment:** This paper presents neural network methods for stellar parameter estimation from spectra, with a focus on cross-survey generalization. While it involves stellar parameters, it does not present new stellar models or evolutionary tracks, nor does it address the other core topics. Borderline relevance for stellar models, but mostly methodological.
...
## 21. [Multiwavelength Characterization of a Dynamically Relaxed Cool Core Galaxy Cluster at $z=1.5$](https://arxiv.org/abs/2602.14882) <a id="link21"></a>
...
**Comment:** This paper studies a massive, high-redshift galaxy cluster and its cool core, focusing on AGN feedback and star formation quenching in the brightest cluster galaxy. While quenching is discussed, the focus is on a massive galaxy cluster and its BCG, not dwarf galaxies or resolved star formation histories.
...
## 22. [Bayesian Cosmic Void Finding with Graph Flows](https://arxiv.org/abs/2602.14630) <a id="link22"></a>
...
**Comment:** Presents a new Bayesian method for cosmic void finding using graph neural networks. While cosmic voids are a cosmological topic, the paper does not focus on galaxy-scale simulations, dwarf galaxies, or near-field cosmology. Methodological advance in void finding, but only tangentially related to core topics.
...
## 23. [Nonlinear diffusive shock acceleration with upstream escape reproduces DAMPE observations](https://arxiv.org/abs/2602.14196) <a id="link23"></a>
...
**Comment:** This paper presents a nonlinear diffusive shock acceleration model for cosmic rays and applies it to reproduce DAMPE proton spectrum. While cosmic ray acceleration is tangentially related to galaxy outflows, the focus is on supernova remnants and cosmic ray spectra, not on star formation driven outflows or galaxy simulations.
...
## 24. [Constraining Lorentz Violation using 21cm and CMB Cross Correlations](https://arxiv.org/abs/2602.14052) <a id="link24"></a>
...
**Comment:** This paper constrains Lorentz violation using 21cm and CMB cross-correlations. While 21cm cosmology is tangentially related to near-field cosmology, the focus is on fundamental physics and not on galaxy evolution, star formation histories, or dwarf galaxies.
...
## 25. [Dyad: a binary-star dynamics and statistics library for Python](https://arxiv.org/abs/2602.13388) <a id="link25"></a>
...
**Comment:** Presents a Python library for binary star dynamics and statistics. While useful for stellar population studies, it does not directly address stellar models, resolved star formation histories, or galaxy-scale simulations.
...
## 26. [Predicting New Concept-Object Associations in Astronomy by Mining the Literature](https://arxiv.org/abs/2602.14335) <a id="link26"></a>
...
**Comment:** The paper constructs a concept-object knowledge graph from the astronomy literature and tests predictive associations. While it is a novel bibliometric tool, it does not directly address any of the core astrophysical topics.
...
## 27. [The Physical Properties of PS1-12sk and the Implications to Its Progenitor System](https://arxiv.org/abs/2602.14427) <a id="link27"></a>
...
**Comment:** The paper analyzes the physical properties and progenitor system of PS1-12sk, a type Ibn supernova, considering double white dwarf merger scenarios. It discusses stellar evolution and explosion models, but does not present new stellar models or address the core topics directly.
...
## 28. [Holographic Dark Matter](https://arxiv.org/abs/2602.13393) <a id="link28"></a>
...
**Comment:** The paper presents a new model for dark matter as a strongly-interacting hidden sector with a holographic description. While it is a novel approach to dark matter, it does not focus on galaxy-scale properties, satellite galaxies, or any of the specified relevant topics.
...
## 29. [Estimation of neutron star mass and radius of FRB 20240114A by identification of crustal oscillations](https://arxiv.org/abs/2602.14353) <a id="link29"></a>
...
**Comment:** Estimation of neutron star mass and radius using crustal oscillations and FRB QPOs. While neutron star structure is tangentially related to stellar models, this paper does not present new stellar evolutionary tracks or atmosphere models.
...
## 30. [Kinematic Evidence for Open Cluster Origins of Galactic Binary Neutron Stars](https://arxiv.org/abs/2602.14145) <a id="link30"></a>
...
**Comment:** This paper investigates the origins of Galactic binary neutron stars, focusing on their kinematics and possible formation in open clusters. While it uses Gaia data and discusses stellar populations, it does not address resolved star formation histories, galaxy simulations, or any of the specified relevant topics.
...
## 31. [Ultramassive Black Holes and the Three $M$-$\sigma$ Relations](https://arxiv.org/abs/2602.13382) <a id="link31"></a>
...
**Comment:** The paper discusses ultramassive black holes and the M-sigma relation in different galaxy types. It focuses on central black holes and galaxy spheroids, which are not relevant to the specified topics (dwarf galaxies, satellite galaxies, etc.).
...
## 32. [Surveying the Giant HII Regions of the Milky Way with SOFIA: VIII. W43 Main](https://arxiv.org/abs/2602.13470) <a id="link32"></a>
...
**Comment:** Analyzes star formation in the massive star-forming complex W43 Main in the Milky Way. Focus is on massive star formation in a giant HII region, not on dwarf galaxies, satellite quenching, or near-field cosmology. No direct connection to resolved star formation histories or galaxy simulations.
...
## 33. [AT 2025abao: the fourth luminous red nova in M 31](https://arxiv.org/abs/2602.13678) <a id="link33"></a>
...
**Comment:** This paper presents observations of a luminous red nova in M31, focusing on the progenitor system and light curve behavior. While it involves resolved stellar phenomena and archival data, it does not directly address near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The focus is on a transient event in a higher mass galaxy (M31), not dwarf satellites.
...
## 34. [Local Short-Time Acceleration and deSitter Spacetime induced Extra Spectral Broadening: a Simple Interpretation of Modified Inertial in MOND](https://arxiv.org/abs/2602.14515) <a id="link34"></a>
...
**Comment:** The paper discusses quantum effects and MOND, with some connection to galactic rotation curves, but does not focus on satellite galaxies, dwarf galaxy properties, or any of the core topics. MOND is tangentially related to near-field cosmology but the focus is on quantum kinematics.
...
## 35. [Pulsars and Millisecond Pulsars III: Tracing Compact Object Dynamics in Globular Clusters with NBODY6++GPU](https://arxiv.org/abs/2602.13688) <a id="link35"></a>
...
**Comment:** The paper discusses neutron star and pulsar evolution in globular clusters using N-body simulations. While it presents new simulation methods, the focus is on compact object dynamics, not galaxy evolution or the core topics.
...
## 36. [Evidence for the merger hypothesis in V4332 Sgr: a low $^{12}$C/$^{13}$C ratio and multiple outbursts](https://arxiv.org/abs/2602.14781) <a id="link36"></a>
...
**Comment:** The paper discusses evidence for a stellar merger in V4332 Sgr, focusing on merger events and outbursts in luminous red novae. While it touches on stellar evolution and merger scenarios, it does not present new stellar models or address the core topics directly.
...
## 37. [Zel'dovich smearing approximation of the BAO feature for model-agnostic cosmological inference](https://arxiv.org/abs/2602.14533) <a id="link37"></a>
...
**Comment:** This paper presents a model-agnostic framework for BAO feature inference in cosmology. While it is relevant to cosmological inference, it does not address near-field cosmology, galaxy simulations, or other core topics.
...
## 38. [Back to Normal Again: Possible Destinies of JWST overmassive SMBHs and "Little Red Dots" in the View of Shin-Uchuu Simulation](https://arxiv.org/abs/2602.14496) <a id="link38"></a>
...
**Comment:** This paper models the evolution of overmassive SMBHs discovered by JWST, using N-body simulations and phenomenological modeling. The focus is on SMBH-galaxy coevolution and scaling relations, not on dwarf galaxies, resolved star formation histories, or galaxy-scale simulations with new physics. The relevance is low.
...
## 39. [Multi-frequency mapping of the S255IR region at a wavelength of 1~mm](https://arxiv.org/abs/2602.14956) <a id="link39"></a>
...
**Comment:** Interferometric mapping of a star-forming region (S255IR) with molecular line analysis, including outflow cavity structures. While it discusses outflows, the region is a massive star-forming core, not a galaxy or dwarf galaxy. No direct connection to galaxy-scale outflows or CGM.
...
## 40. [Accelerating Posterior Inference from Pulsar Light Curves via Learned Latent Representations and Local Simulator-Guided Optimization](https://arxiv.org/abs/2602.14520) <a id="link40"></a>
...
**Comment:** This paper focuses on accelerating posterior inference for pulsar light curves, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. Pulsar studies are outside the scope.
...
## 41. [Gravitational Wave Echoes of the First Order Phase Transition in a Kination-Induced Big Bang](https://arxiv.org/abs/2602.15023) <a id="link41"></a>
...
**Comment:** This paper studies gravitational wave production from first-order phase transitions in the early universe, specifically in a kination-induced Big Bang scenario. It is focused on early universe cosmology and not on galaxy-scale processes or any of the specified relevant topics.
...
## 42. [Quarkyonic matter and hadron-quark crossover from an ultracold atom perspective](https://arxiv.org/abs/2602.14113) <a id="link42"></a>
...
**Comment:** The paper explores the hadron-quark crossover in dense matter, drawing analogies with ultracold atom physics. It is relevant to neutron star interiors and dense matter physics, but not to galaxy-scale processes or any of the specified relevant topics.
...
## 43. [Detection of Cyclotron Absorption in the Radio Emission of GPM 1839-10](https://arxiv.org/abs/2602.13742) <a id="link43"></a>
...
**Comment:** The paper reports cyclotron absorption in the radio emission of a long-period radio transient, discussing its emission characteristics and possible binary nature. It is not relevant to galaxy-scale processes or any of the specified relevant topics.
...
## 44. [VENUS: Strong-lensing model of MACS J1931.8-2635 -- revealing the farthest multiply imaged supernova](https://arxiv.org/abs/2602.14074) <a id="link44"></a>
...
**Comment:** Strong-lensing model of a galaxy cluster and multiply imaged supernova at high redshift. Focus is on lens modeling and cluster-scale phenomena, not on dwarf galaxies, satellite luminosity functions, or near-field cosmology. No direct connection to resolved star formation histories, quenching, stellar models, or galaxy simulations.
...
## 45. [Prospects of Indirect Detection of Dark Matter via Primordial Black Hole Induced Gravitational Waves](https://arxiv.org/abs/2602.15026) <a id="link45"></a>
...
**Comment:** Discusses indirect detection of dark matter via primordial black hole induced gravitational waves. Focus is on early universe cosmology and dark matter production, not on near-field cosmology, satellite galaxies, or galaxy-scale phenomena.
...
## 46. [Production of Jets before Neutron Star Mergers](https://arxiv.org/abs/2602.14300) <a id="link46"></a>
...
**Comment:** Studies jet production before neutron star mergers using 3D relativistic MHD simulations. Focus is on compact object interactions, not on galaxy-scale phenomena, star formation histories, quenching, or near-field cosmology.
...
## 47. [Gravitational waves from supercooled phase transitions and pulsar timing array signals](https://arxiv.org/abs/2602.14324) <a id="link47"></a>
...
**Comment:** Explores gravitational waves from supercooled phase transitions and their connection to pulsar timing array signals. Focus is on early universe physics and hidden sector phase transitions, not on galaxy-scale phenomena or near-field cosmology.
...
## 48. [MeerKAT discovery of a high-redshift strongly-lensed hydroxyl gigamaser](https://arxiv.org/abs/2602.13396) <a id="link48"></a>
...
**Comment:** Discovery of a high-redshift hydroxyl gigamaser in a strongly-lensed system. The focus is on maser emission and galaxy mergers at high redshift, not on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No direct relevance to the core topics.
...
## 49. [Improved frequency hierarchy treatment for anisotropic spectral distortions](https://arxiv.org/abs/2602.14963) <a id="link49"></a>
...
**Comment:** Presents improved theoretical methods for modeling CMB spectral distortion anisotropies. While this is cosmology, it does not address near-field cosmology, resolved SFH, quenching, stellar models, galaxy simulations, outflows, or CGM. No direct relevance to the core topics.
...
## 50. [Gauge-independent gravitational waves from a minimal dark $U(1)$ sector with viable dark matter candidates](https://arxiv.org/abs/2602.14866) <a id="link50"></a>
...
**Comment:** Studies gravitational waves from a minimal dark U(1) sector and its connection to dark matter candidates. While interesting for cosmology, it does not address near-field cosmology, galaxy evolution, or stellar models.
...
## 51. [CMB Spectral Distortions from Resonant Conversions in Atomic Dark Sectors](https://arxiv.org/abs/2602.13384) <a id="link51"></a>
...
**Comment:** Explores CMB spectral distortions from atomic dark sectors and their impact on cosmological parameters. No direct connection to near-field cosmology, resolved star formation histories, or stellar models.
...
## 52. [A universal critical accretion rate for black hole jet formation](https://arxiv.org/abs/2602.14838) <a id="link52"></a>
...
**Comment:** This paper focuses on black hole accretion and jet formation, specifically in the context of tidal disruption events (TDEs) and supermassive black holes. The topic is not related to near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the circumgalactic medium. The focus is on accretion physics and jet formation, which is outside the core topics.
...
## 53. [MarsRetrieval: Benchmarking Vision-Language Models for Planetary-Scale Geospatial Retrieval on Mars](https://arxiv.org/abs/2602.13961) <a id="link53"></a>
...
**Comment:** MarsRetrieval benchmarks vision-language models for geospatial retrieval on Mars. This is planetary science and machine learning, not related to any of the core astrophysical topics.
...
## 54. [Reduction of bar fraction in paired galaxies in the SDSS](https://arxiv.org/abs/2602.14873) <a id="link54"></a>
...
**Comment:** The paper investigates the effect of galaxy interactions on bar fractions in paired galaxies, focusing on bar suppression during mergers. Bars and galactic centers are specifically listed as irrelevant topics, so this is outside the core interests.
...
## 55. [The initial states of high frequency gravitons](https://arxiv.org/abs/2602.14235) <a id="link55"></a>
...
**Comment:** This paper discusses the initial states of high frequency gravitons in cosmological backgrounds. It is focused on early universe cosmology and quantum gravity, not on near-field cosmology, galaxy simulations, or any of the specified relevant topics.
...
## 56. [Searching for Neutron Star Mergers in the Absence of Gravitational Waves with Optical Afterglow Emission](https://arxiv.org/abs/2602.13471) <a id="link56"></a>
...
**Comment:** The paper discusses strategies for detecting neutron star mergers via optical afterglow emission, focusing on kilonovae and short gamma-ray bursts. While it is astrophysical, it does not address galaxy-scale processes, star formation histories, or any of the specified relevant topics.
...
## 57. [Habitable Zones Around Massive Stars: From the Main Sequence to Supergiants](https://arxiv.org/abs/2602.13875) <a id="link57"></a>
...
**Comment:** The paper quantifies habitable zones around massive stars, mapping their time-dependent boundaries and lifetimes. It is focused on stellar evolution and habitability, not on galaxy-scale processes or any of the specified relevant topics.
...
## 58. [Constraining Binary Neutron Star Populations using Short Gamma-Ray Burst Observations](https://arxiv.org/abs/2602.13391) <a id="link58"></a>
...
**Comment:** Constrains binary neutron star populations using short gamma-ray burst observations. Focuses on population synthesis and jet geometry, but not on galaxy-scale phenomena, star formation histories, quenching, or near-field cosmology.
...
## 59. [Superorbital Phase Evolution and a Soft-Hard X-ray Phase Shift in LMC X-4](https://arxiv.org/abs/2602.13491) <a id="link59"></a>
...
**Comment:** Analyzes superorbital phase evolution and X-ray phase shifts in LMC X-4, a high-mass X-ray binary. Focus is on accretion disk and X-ray variability, not on dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 60. [Circular orbits and observational features of the rotating Simpson-Visser black hole surrounded by a thin accretion disk](https://arxiv.org/abs/2602.14458) <a id="link60"></a>
...
**Comment:** Investigates observational features of rotating Simpson-Visser black holes and accretion disks. Focus is on black hole physics and accretion disk modeling, not on galaxy-scale phenomena, dwarf galaxies, or near-field cosmology.
...
## 61. [New Dynamical Measurements from a Lensed Quasar Sample: Joint Analysis Constrains the Mass Profile Evolution of Lens Galaxies](https://arxiv.org/abs/2602.13578) <a id="link61"></a>
...
**Comment:** The paper studies mass profiles of early-type galaxies using strong lensing and stellar kinematics, focusing on massive galaxies rather than dwarfs or satellites. It does not address near-field cosmology, resolved star formation histories, or other core topics.
...
## 62. [Quintessence with tachyonic resonance and late-time cosmic-microwave-background and gravitational-wave signals](https://arxiv.org/abs/2602.14389) <a id="link62"></a>
...
**Comment:** The paper discusses quintessence models and late-time cosmological signals, focusing on dark energy and gravitational waves. It does not address any of the core topics (near-field cosmology, galaxy evolution, star formation histories, or CGM).
...
## 63. [Multiscale feature integration network for inpainting of full-sky CMB $B$-modes](https://arxiv.org/abs/2602.14547) <a id="link63"></a>
...
**Comment:** This paper presents a neural network for inpainting CMB polarization maps, focusing on cosmological parameter inference. It does not address any of the core topics.
...
## 64. [The James Webb Space Telescope Absolute Flux Calibration. V. Near-Infrared Camera Wide Field](https://arxiv.org/abs/2602.13918) <a id="link64"></a>
...
**Comment:** Presents calibration for JWST NIRCam slitless spectroscopy. While important for observational astronomy, it does not directly address any of the core topics such as resolved star formation histories or stellar models.
...
## 65. [Exploring the magnetic field of the ultraluminous X-ray pulsar NGC 4631 X-8](https://arxiv.org/abs/2602.14876) <a id="link65"></a>
...
**Comment:** Explores the magnetic field and spin evolution of an ultraluminous X-ray pulsar, focusing on neutron star evolution and accretion. No direct connection to galaxy evolution, star formation histories, or stellar models as defined in the criteria.
...
## 66. [Investigating the impact of quasi-universal relations on neutron star constraints in third-generation detectors](https://arxiv.org/abs/2602.14659) <a id="link66"></a>
...
**Comment:** Investigates neutron star properties and gravitational wave constraints, focusing on quasi-universal relations and the equation of state. Not directly related to galaxy evolution, star formation, or stellar models as defined in the criteria.
...
## 68. [Modelling the Break in the Specific Angular Momentum within the Envelope-Disk Transition Zone](https://arxiv.org/abs/2602.13683) <a id="link68"></a>
...
**Comment:** Global MHD disk simulations of protostellar collapse, focusing on angular momentum transition from envelope to disk. The work is on star-disk formation, not galaxy-scale simulations or resolved star formation histories. No direct relevance to the core topics.
...
## 69. [Dense Molecular Clumps with Large Blue Asymmetries: Evidence for Collapse](https://arxiv.org/abs/2602.13992) <a id="link69"></a>
...
**Comment:** Analyzes dense molecular clumps with collapse motions using molecular line profiles. Focuses on star-forming regions and collapse, not on galaxy-scale phenomena, dwarf galaxies, or resolved star formation histories.
...
## 70. [Geodetically Anchored 0.30m Digital Elevation Model of the Chandrayaan-3 Vikram Landing Site from Chandrayaan-2 Orbital High Resolution Camera (OHRC) Stereo Imagery](https://arxiv.org/abs/2602.14993) <a id="link70"></a>
...
**Comment:** This paper presents a digital elevation model of the Chandrayaan-3 landing site on the Moon, which is unrelated to any of the core topics (galaxy evolution, star formation, etc.).
...
## 71. [Unprecedented Multipoint Observation of Spatially Varying ICME Turbulence of Different Ages during October 2024 Extreme Solar Storm at 1 AU](https://arxiv.org/abs/2602.13644) <a id="link71"></a>
...
**Comment:** This paper studies turbulence in interplanetary coronal mass ejections using multipoint spacecraft observations. The focus is on solar and space plasma physics, not on galaxy evolution, star formation, or any of the core topics.
...
## 72. [Agent Mars: Multi-Agent Simulation for Multi-Planetary Life Exploration and Settlement](https://arxiv.org/abs/2602.13291) <a id="link72"></a>
...
**Comment:** Presents a multi-agent simulation framework for Mars base operations, relevant to AI and space robotics, not astrophysics or galaxy-related topics.
...
## 73. [4U 1556-60 as a very faint neutron star X-ray binary at 700 pc with an undetected radio jet](https://arxiv.org/abs/2602.14695) <a id="link73"></a>
...
**Comment:** Study of a neutron star X-ray binary, focusing on accretion and radio jet properties. While neutron stars are relevant to stellar models, this paper does not present new stellar evolutionary tracks or atmosphere models, nor does it address galaxy-scale topics.
...
## 74. [The Cosmological Parameters (2025)](https://arxiv.org/abs/2602.13523) <a id="link74"></a>
...
**Comment:** A review of cosmological parameters and probes, but does not focus on near-field cosmology, satellite galaxies, or resolved star formation histories. General cosmology is outside the core topics.
...
## 75. [Carbon chain diversity in L1544 and IRAS 16293-2422: an astrochemical pathfinder study for the SKAO](https://arxiv.org/abs/2602.14804) <a id="link75"></a>
...
**Comment:** Astrochemical study of carbon chains in star-forming regions. While it involves molecular abundances and chemistry, it does not match any core topics such as resolved star formation histories, galaxy simulations, or stellar models.
...
## 76. [Superhumps and their Relation to the Disk Instability Model](https://arxiv.org/abs/2602.13996) <a id="link76"></a>
...
**Comment:** This review discusses superhumps and disk instabilities in cataclysmic variable stars, focusing on accretion disk dynamics. It is not relevant to galaxy-scale processes or any of the specified relevant topics.
...
## 77. [Optimal polarization modulation and calibration schemes](https://arxiv.org/abs/2602.13997) <a id="link77"></a>
...
**Comment:** The paper discusses polarization modulation and calibration schemes for spectro-polarimetry, which is relevant to instrumentation but not directly to the core astrophysical topics (near-field cosmology, resolved SFH, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 78. [J-PAS: Semi-Supervised Sim-to-Obs Transfer for Robust Star--Galaxy--Quasar Classification](https://arxiv.org/abs/2602.13902) <a id="link78"></a>
...
**Comment:** This paper presents a machine learning pipeline for star-galaxy-quasar classification in J-PAS survey data. It does not address any of the core topics (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 79. [The impact of the formation channel on gravitational-wave-galaxy cross-correlations](https://arxiv.org/abs/2602.14825) <a id="link79"></a>
...
**Comment:** The paper analyzes the impact of binary formation channels on gravitational-wave-galaxy cross-correlations. It does not address any of the core topics directly.
...
## 80. [Leveling of MHD turbulence imbalance in shear flows](https://arxiv.org/abs/2602.13528) <a id="link80"></a>
...
**Comment:** This paper investigates MHD turbulence imbalance in shear flows, with implications for solar wind turbulence. It does not address galaxy simulations or other core topics.
...
## 81. [Nonlinearity in H4RG-10 Near-Infrared Detectors at Elevated Temperatures: Characterization and Data-Driven Correction Method](https://arxiv.org/abs/2602.13983) <a id="link81"></a>
...
**Comment:** This paper focuses on detector nonlinearity and calibration methods for near-infrared detectors, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models.
...
## 82. [Dynamical Preconditions for Ice Formation in Supernova Remnant and Cloud Interactions: A 2D MHD Study](https://arxiv.org/abs/2602.13777) <a id="link82"></a>
...
**Comment:** This paper uses 2D MHD simulations to study supernova shock interactions with dense interstellar clouds, focusing on conditions for water ice formation. While it involves numerical simulations and ISM processes, it does not focus on galaxy-scale phenomena, dwarf galaxies, or star formation histories. It is not directly relevant to the core topics.
...
## 83. [Estimatingthe Contribution of Galactic Neutrino Sources](https://arxiv.org/abs/2602.13815) <a id="link83"></a>
...
**Comment:** Estimates the contribution of Galactic neutrino sources using simulated populations of gamma-ray sources. Focuses on cosmic ray interactions and neutrino flux, not on galaxy-scale phenomena, dwarf galaxies, or star formation histories.
...
## 84. [Dust and Ices in the SNR](https://arxiv.org/abs/2602.13754) <a id="link84"></a>
...
**Comment:** Explores dust and water ice in supernova remnants using observational data and modeling. Focuses on SNRs and ISM conditions, not on galaxy-scale phenomena or core topics.
...
## 85. [Tracing Fe K X-ray reverberation lag in the energy-resolved spectra of Narrow-line Seyfert 1 galaxy Ton S180](https://arxiv.org/abs/2602.14197) <a id="link85"></a>
...
**Comment:** The paper studies X-ray reverberation lags in a Seyfert galaxy, focusing on black hole spin and corona properties. This is not relevant to any of the core topics, as it deals with AGN and supermassive black holes.
...
## 86. [Bounds on Lorentz invariance violation from muon fluctuations at the Pierre Auger Observatory](https://arxiv.org/abs/2602.14720) <a id="link86"></a>
...
**Comment:** This paper uses muon fluctuations in cosmic ray air showers to constrain Lorentz invariance violation. The focus is on fundamental physics and cosmic rays, not on galaxy evolution, dwarf galaxies, resolved SFH, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 88. [In-orbit Demonstration of X-ray Pulsar Navigation with NinjaSat](https://arxiv.org/abs/2602.14166) <a id="link88"></a>
...
**Comment:** Demonstrates X-ray pulsar navigation with a CubeSat, which is unrelated to the core topics. No direct connection to galaxy evolution, star formation, or stellar models.
...
## 89. [Evolution of Linear Perturbations under Time-Dependent Hubble Friction I: SR-USR-SR Inflation](https://arxiv.org/abs/2602.13074) <a id="link89"></a>
...
**Comment:** This paper discusses inflationary cosmology and the evolution of linear perturbations, with implications for the CMB power spectrum. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the circumgalactic medium. The focus is on early universe physics, which is outside the core topics.
...
## 91. [The radial velocity curve for HeII emission cannot be used for component mass determination in SS433](https://arxiv.org/abs/2602.14978) <a id="link91"></a>
...
**Comment:** The paper discusses the limitations of using HeII emission for mass determination in SS433, focusing on emission line formation and binary mass estimates. It does not address any of the core topics.
...
## 92. [Pulsar Timing Array in the past decade](https://arxiv.org/abs/2602.14014) <a id="link92"></a>
...
**Comment:** Review of pulsar timing arrays and nanohertz gravitational wave detection. No direct connection to any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 93. [On the Cuspy Structure of Rotating Wormhole Shadows](https://arxiv.org/abs/2602.14182) <a id="link93"></a>
...
**Comment:** Investigates the shadow structure of rotating wormholes, focusing on theoretical aspects of compact objects. No connection to near-field cosmology, resolved SFH, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 94. [LHAASO observation of Mrk 421 during 2021 March - 2024 March: a comprehensive VHE catalog of multi-timescale outbursts and its time average behavior](https://arxiv.org/abs/2602.13411) <a id="link94"></a>
...
**Comment:** This paper presents VHE monitoring of Mrk 421, a blazar, and analyzes outburst phenomena. It is unrelated to the core topics (no focus on galaxies, star formation histories, quenching, or CGM).
...
## 95. [Harmonic Analysis on Correlation for Gravitational-Wave Backgrounds of Arbitrary Polarization from Interfering Sources in Generic Dispersion Relation](https://arxiv.org/abs/2602.13621) <a id="link95"></a>
...
**Comment:** Harmonic analysis of gravitational-wave background correlations, focusing on polarization and source interference. No connection to galaxy simulations, star formation histories, or near-field cosmology.
...
## 96. [PeV neutrons as origin of separated SS433 TeV signals](https://arxiv.org/abs/2602.14212) <a id="link96"></a>
...
**Comment:** Explains TeV signals from SS433 via PeV neutron beams and their decay products. Focuses on high-energy astrophysics and binary systems, not on galaxy-scale phenomena or core topics.
...
## 97. [Pre-perihelion Volatile Evolution of Interstellar Comet 3I/ATLAS Indicating Significant Contribution from Extended Source in the Coma](https://arxiv.org/abs/2602.14218) <a id="link97"></a>
...
**Comment:** Observations of an interstellar comet's volatile evolution. No connection to galaxy simulations, near-field cosmology, or stellar models.
...
## 98. [Pulsar based modeling of point spread function of Fermi Large Area Telescope](https://arxiv.org/abs/2602.14764) <a id="link98"></a>
...
**Comment:** Paper focuses on modeling the point spread function of the Fermi LAT using pulsar data, relevant to gamma-ray instrumentation and analysis, not to any of the core topics.
...
## 99. [High Energy Emission from the Galactic Center](https://arxiv.org/abs/2602.14148) <a id="link99"></a>
...
**Comment:** Review of high-energy emission from the Galactic Center, focusing on the SMBH, feedback, and nuclear activity. The Galactic Center is explicitly listed as irrelevant in the criteria. No direct connection to dwarf galaxies, resolved SFH, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 100. [Solar active region scaling laws revisited](https://arxiv.org/abs/2602.13677) <a id="link100"></a>
...
**Comment:** This paper focuses on solar active regions and their scaling laws, which is unrelated to any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 102. [Image instabilities and polarization cross-talk](https://arxiv.org/abs/2602.14006) <a id="link102"></a>
...
**Comment:** The paper discusses polarimetric instrumentation and image instabilities, which is unrelated to the core topics (no focus on galaxies, star formation histories, quenching, or CGM).
...
## 103. [Three-dimensional kink modes in solar coronal slabs: group velocities and their implications for impulsively excited waves](https://arxiv.org/abs/2602.13952) <a id="link103"></a>
...
**Comment:** This paper focuses on MHD waves in solar coronal slabs, which is unrelated to any of the core topics such as near-field cosmology, galaxy simulations, or stellar models. No relevant criteria matched.
...
## 104. [Recalibrating the Sensitivities of the STIS First-Order, Medium-Resolution Modes](https://arxiv.org/abs/2602.14891) <a id="link104"></a>
...
**Comment:** This paper recalibrates sensitivities for STIS spectrograph modes, which is instrumentation-focused and not related to any of the core topics (e.g., stellar models, galaxy simulations, near-field cosmology).
...
## 105. [Updated Sensitivities of the Five STIS L-mode Gratings](https://arxiv.org/abs/2602.13441) <a id="link105"></a>
...
**Comment:** Re-derivation of STIS sensitivities for low-resolution gratings is an instrumentation calibration paper, not related to any of the core topics.
...
## 106. [Description of 4 Spacecraft, Moving on Elliptic Kepler Orbits](https://arxiv.org/abs/2602.13604) <a id="link106"></a>
...
**Comment:** Describes spacecraft formation for measuring interplanetary fields and testing gravity theories. No connection to galaxy simulations, stellar models, or near-field cosmology.
...
## 107. [The Habitable Worlds Observatory in Historical Context](https://arxiv.org/abs/2602.14823) <a id="link107"></a>
...
**Comment:** Historical summary of exoplanet imaging missions and the Habitable Worlds Observatory. No direct connection to any of the core topics.
...
## 108. [Human versus Artificial Intelligence; various significant examples in astrophysics](https://arxiv.org/abs/2602.14567) <a id="link108"></a>
...
**Comment:** This paper is a meta-analysis comparing AI and human approaches to astrophysical phenomena such as GRBs, neutron star mergers, and cosmic rays. None of these topics match the core criteria (near-field cosmology, resolved SFH, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 109. [Polarization fringes in optical systems: a compendium](https://arxiv.org/abs/2602.14000) <a id="link109"></a>
...
**Comment:** This paper focuses on polarization fringes in optical systems and their mitigation in instrumentation. It does not match any of the core topics (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 110. [Excavation of a 69-m diameter and 94-m high cavern for the Hyper-Kamiokande detector](https://arxiv.org/abs/2602.14810) <a id="link110"></a>
...
**Comment:** This paper describes the engineering and excavation of the Hyper-Kamiokande detector cavern. It is unrelated to the core astrophysical topics listed.
