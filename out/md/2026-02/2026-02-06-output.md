...
1. [Modeling the recent interactions between the Magellanic Clouds and Milky Way](#user-content-link1)
**Authors:** Bethany Garver, David Nidever, Victor Debattista, Nathan Deg

2. [Complex hydrogen chemical equilibrium and Gaia low mass problem in cool white dwarfs](#user-content-link2)
**Authors:** Piotr M. Kowalski (Forschungszentrum Juelich)

3. [Galactic seismology: can a disc-crossing impulse explain the large-scale perturbations in the Milky Way's disc?](#user-content-link3)
**Authors:** Pavadol Yamsiri, Joss Bland-Hawthorn, Thor Tepper-Garcia

4. [Improved Heavy Dark Matter Annihilation Search from Dwarf Galaxies with HAWC](#user-content-link4)
**Authors:** A. Albert, R. Alfaro, C. Alvarez, A. Andr\'es, E. Anita-Rangel, M. Araya, J. C. Arteaga-Vel\'azquez, D. Avila Rojas, H. A. Ayala Solares, R. Babu, P. Bangale, E. Belmont-Moreno, A. Bernal, K. S. Caballero-Mora, T. Capistr\'an, A. Carrami\~nana, F. Carre\'on, S. Casanova, A. L. Colmenero-Cesar, U. Cotti, J. Cotzomi, S. Couti\~no de Le\'on, E. De la Fuente, C. de Le\'on, P. Desiati, N. Di Lalla, R. Diaz Hernandez, M. A. DuVernois, J. C. D\'iaz-V\'elez, K. Engel, T. Ergin, C. Espinoza, N. Fraija, S. Fraija, A. Galv\'an-G\'amez, J. A. Garc\'ia-Gonz\'alez, F. Garfias, N. Ghosh, A. Gonzalez Mu\~noz, M. M. Gonz\'alez, J. A. Gonz\'alez, J. A. Goodman, J. Gyeong, J. P. Harding, S. Hern\'andez-Cadena, I. Herzog, D. Huang, F. Hueyotl-Zahuantitla, P. H\"untemeyer, A. Iriarte, S. Kaufmann, D. Kieda, K. Leavitt, W. H. Lee, J. Lee, H. Le\'on Vargas, J. T. Linnemann, A. L. Longinotti, G. Luis-Raya, C. Lundy, K. Malone, O. Martinez, J. Mart\'inez-Castro, H. Mart\'inez-Huerta, J. A. Matthews, P. Miranda-Romagnoli, P. E. Mir\'on-Enriquez, J. A. Morales-Soto, E. Moreno, M. Mostaf\'a, M. Najafi, A. Nayerhoda, L. Nellen, M. U. Nisa, R. Noriega-Papaqui, N. Omodei, E. Ponce, Y. P\'erez Araujo, E. G. P\'erez-P\'erez, C. D. Rho, A. Rodriguez Parra, D. Rosa-Gonz\'alez, M. Roth, H. Salazar, D. Salazar-Gallegos, A. Sandoval, M. Schneider, J. Serna-Franco, M. Shin, A. J. Smith, Y. Son, R. W. Springer, O. Tibolla, K. Tollefson, I. Torres, R. Torres-Escobedo, F. Ure\~na-Mena, E. Varela, L. Villase\~nor, X. Wang, Z. Wang, I. J. Watson, H. Wu, S. Yu, X. Zhang, H. Zhou

5. [Impact on Inferred Neutron Star Equation of State due to Nonlinear Hydrodynamics, Background Spin, and Relativity](#user-content-link5)
**Authors:** Joseph Bretz, Hang Yu

6. [The GMRT archive atomic gas survey -- III. Comparative Study of Dark Matter Halos in Nearby Galaxies](#user-content-link6)
**Authors:** Sougata Sarkar, Prerana Biswas, Veselina Kalinova, Nirupam Roy, Narendra Nath Patra, Sushma Kurapati

7. [The Impact of Galaxy Formation on Galaxy Biasing, and Implications for Primordial non-Gaussianity Constraints](#user-content-link7)
**Authors:** Lucia A. Perez, Shy Genel, Elisabeth Krause, Rachel S. Somerville

8. [Momentum-conserving self-gravity in the phantom smoothed particle hydrodynamics code. Parallel dual tree traversal for the symmetric fast multipole method](#user-content-link8)
**Authors:** Yann Bernard, Timoth\'ee David-Cl\'eris, Daniel J. Price, Mike Y. M. Lau

9. [Differentiable Stochastic Halo Occupation Distribution with Galaxy Intrinsic Alignments](#user-content-link9)
**Authors:** Sneh Pandya, Jonathan Blazek

10. [The JWST EXCELS survey: The ages and abundances of $3<z<5$ massive quiescent galaxies show that downsizing was already in place by $z\simeq4$](#user-content-link10)
**Authors:** Ho-Hin Leung, Adam C. Carnall, Elizabeth Taylor, Struan D. Stevenson, Aliza G. Beverage, Fergus Cullen, James S. Dunlop, Derek J. McLeod, Ross J. McLure, Ryan Begley, Omar Almaini, Stella Antonogiannaki, Karla Z. Arellano-C\'ordova, Laia Barrufet, Cecilia Bondestam, Callum T. Donnan, Isaac J. B. Holst, Feng-Yuan F. Liu, Kate Rowlands, Ryan L. Sanders, Dirk Scholte, Maya Skarbinski, Thomas M. Stanton, Vivienne Wild

11. [MIGHTEE/COSMOS-3D: The discovery of three spectroscopically confirmed radio-selected star-forming galaxies at z=4.9-5.6](#user-content-link11)
...
12. [How Do Disk Galaxies Form?](#user-content-link12)
**Authors:** Vadim A. Semenov

13. [Tracing AGN Feedback Power with Cool/Warm Outflow Densities: Predictions and Observational Implications](#user-content-link13)
**Authors:** Ivan Almeida, Tiago Costa, Chris M. Harrison, Samuel R. Ward

14. [Mergers Drive Structural Complexity but Not Starbursts in Lyman-$\alpha$ Emitters at $3 < z < 4$: A JWST Spatially Resolved View](#user-content-link14)
**Authors:** Qi Song, F. S. Liu, Jian Ren, Tianfu Gao, Pinsong Zhao, Qifan Cui, Yubin Li, Hao Mo, Guanghuan Wang

15. [Microlensing constraint on Primordial Black Hole abundance with Subaru Hyper Suprime-Cam observations of Andromeda](#user-content-link15)
**Authors:** Sunao Sugiyama, Masahiro Takada, Naoki Yasuda, Nozomu Tominaga

16. [Growth of High-Redshift Quasars from Fermion Dark Matter Seeds](#user-content-link16)
**Authors:** Yu Wang, Remo Ruffini

17. [A Chemistry-First Centered Icy Chemical Inventory of Protostellar Sources with JWST](#user-content-link17)
**Authors:** Andrew M. Turner, Yao-Lun Yang, Rachel Gross, Nami Sakai, Ralf I. Kaiser

18. [Predicting galaxy bias using machine learning](#user-content-link18)
**Authors:** Catalina Riveros-Jara, Antonio D. Montero-Dorta, Nat\'alia V. N. Rodrigues, P\'ia Amigo, Natal\'i S. M. de Santi, Andr\'es Balaguera-Antol\'inez, Raul Abramo, Neill Guzm\'an, M. Celeste Artale

19. [Early growth of massive black holes in dynamical dark energy models with negative cosmological constant](#user-content-link19)
**Authors:** N. Menci, M. Castellano, P. Mukherjee, D. Roberts, P. Santini, A. A. Sen, F. Shankar

20. [Clustering of z~6.6 Quasars and [O III] Emitters Constrains Host Halo Masses and Duty Cycles in 25 ASPIRE Fields](#user-content-link20)
**Authors:** Jiamu Huang, Joseph Hennawi, Elia Pizzati, Feige Wang, Jinyi Yang, Jaclyn B. Champagne, Xiaohui Fan, Eduardo Ba\~nados, Xiangyu Jin, Koki Kakiichi, Romain A. Meyer, Fengwu Sun, Yunjing Wu, Haowen Zhang, Chiara Mazzucchelli, Anna-Christina Eilers, Maria Pudoka, Huanian Zhang, Jan-Torge Schindler, Matthieu Schaller, Joop Schaye, Ben Snyder, Yi Kang, Silvia Onorato

21. [The sub-arcsecond ILT view of the Bo\"{o}tes Deep Field: A link between low-frequency kiloparsec radio morphology and AGN driven ionised outflows](#user-content-link21)
**Authors:** Emmy L. Escott, Leah K. Morabito, Frits Sweijen, Chris M. Harrison, James Petley, Jurjen M. G. H. J. de Jong, Reinout J. van Weeren, Thomas S. Higginson, Isabella Prandoni, George Miley, Huub J. A. R\"ottgering

22. [ELFO: A Python package for emission line fitting optimization in integral field spectroscopy data](#user-content-link22)
**Authors:** Hui Guo, Guilin Liu, Jianghui Xu, Chao Geng, Zhicheng He, Shiyin Shen, Lei Hao

23. [XGAP with uGMRT I: Old AGN plasma in merging galaxy groups](#user-content-link23)
**Authors:** R. Santra, R. Kale, K. Kolokythas, M. Brienza, E. O'Sullivan, D. Eckert, F. De. Gasperin, T. Pasini, F. Gastaldello, A. Finoguenov, M. Sun, G. Gozaliasl, M. Bourne

24. [Fractal dimension of the cosmic web with different galaxy types](#user-content-link24)
...
25. [Detailed TESS-Based Light Curve Modeling and Fundamental Parameter Estimation of 27 W UMa-Type Contact Binaries](#user-content-link25)
**Authors:** Atila Poro, Ahmad Sarostad, Mohammad Davoudi, Mahsa Marami, Motaharehalsadat Mohtaram, Mohammadparsa Sharififard, Diana Zadkhosh, Aida Rakian, Alireza Shiri Ahmadabadi, AmirAli Akbarzadeh, Amirali Ashrafpour, Aram Ahmadi, Arshida Amiri, Arshida Goudarzi, Atena Ahmadzadeh, Ehsan Abbasi, Helia Dolati, Kimia Foroush Bastani, Mahdis Derakhshan, MehrAna Mehraban Pour, Nazanin Karimi Shoushtari, Parsa Arezoumand, Reyhaneh Saki, Romina Ozhand, Sama Ghonche Sefidi, Shayan Saeidzadeh, Yeganeh Chaji, Zahra Izadi, Negar Sarlak, Ayda Davoudi, Danial Rahbarmah, Hossein Dehghan, Fahri Alicavus

26. [Classifying white dwarfs from multi-object spectroscopy surveys with machine learning](#user-content-link26)
**Authors:** James Munday, Pier-Emmanuel Tremblay, Ingrid Pelisoli, Thomas Killestein, Julia Martikainen, David Jones, Antoine B\'edard, Paulina Sowicka

27. [Abundant hydrocarbons in a buried galactic nucleus with signs of carbonaceous grain and polycyclic aromatic hydrocarbon processing](#user-content-link27)
**Authors:** I. Garc\'ia-Bernete (Centro de Astrobiolog\'ia), M. Pereira-Santaella (Instituto de F\'isica Fundamental), E. Gonz\'alez-Alfonso (Departamento de F\'isica y Matem\'aticas, Universidad de Alcal\'a), M. Ag\'undez (Instituto de F\'isica Fundamental), D. Rigopoulou (Department of Physics, University of Oxford, School of Sciences, European University Cyprus), F. R. Donnan (Department of Physics, University of Oxford), G. Speranza (Instituto de F\'isica Fundamental), N. Thatte (Department of Physics, University of Oxford)

28. [ASPIRE: The Environments and Dark Matter Halos of Luminous Quasars in the Epoch of Reionization](#user-content-link28)
...
29. [ICM-SHOX III. The case of MACS J0018.5+1626, a radio relic that looks like a radio halo?](#user-content-link29)
**Authors:** P. Dom\'inguez-Fern\'andez, J. A. ZuHone, E. M. Silich, E. Bellomi, J. Sayers, T. Mroczkowski, A. Botteon, R. J. van Weeren, L. Hernquist, G. Brunetti, J. Golec, S. Gupta

30. [MESS: Multi-Epoch Spectroscopic Solver for Detecting Double-Lined Systems](#user-content-link30)
**Authors:** Gil Nachmani, Simchon Faigler, Tsevi Mazeh

31. [Bayesian imaging inverse problem with scattering transform](#user-content-link31)
**Authors:** S\'ebastien Pierre, Erwan Allys, Pablo Richard, Roman Soletskyi, Alexandros Tsouros

32. [Water absorption confirms cool atmospheres in two little red dots](#user-content-link32)
...
33. [Establishing a relationship between the cosmological 21 cm power spectrum and interferometric closure phases](#user-content-link33)
**Authors:** Pascal M. Keller, Bojan Nikolic, Nithyanandan Thyagarajan

34. [The CON-quasar stage of IRAS 07251-0248 E](#user-content-link34)
**Authors:** Eduardo Gonz\'alez-Alfonso, Miguel Pereira-Santaella, Ismael Garc\'ia-Bernete, Jacqueline Fischer, Giovanna Speranza

35. [B-field Orion Protostellar Survey (BOPS). IV: The Relative Orientation Between Magnetic Fields and Density Structures in Young Protostellar Envelopes](#user-content-link35)
**Authors:** Kexin Cai, Bo Huang, Josep Miquel Girart, Ian W. Stephens, \'Alvaro S\'anchez-Monge, Valentin J. M. Le Gouellec, Wenyu Jiao, Qianru He, Zu-Jia Lu, Enwei Liang

36. [Rotating strange dwarfs and their indistinguishability from white dwarfs](#user-content-link36)
**Authors:** Edson Otoniel, Jos\'e D. V. Arba\~nil, Geanderson A. Carvalho, Fridolin Weber

37. [Wiggling Through the ICM: Multi-Resolution Radio Imaging of a Tailed Radio Galaxy in MACS J1354.6+7715](#user-content-link37)
**Authors:** Abdul Gani, Roland Timmerman, Leah K. Morabito, Ruta Kale, Satish S. Sonkamble, Arpan Pal, Sravani Vaddi

38. [Photometric variability of nitrogen-rich Wolf-Rayet stars in Magellanic Clouds with OGLE](#user-content-link38)
**Authors:** Jana Markovi\'c, Guadalupe S\'aez-Cano, Ya\"el Naz\'e, Mar\'ia del Mar Rubio-D\'iez, Igor Soszy\'nski, Andrzej Udalski

39. [Direction-dependent calibration with image-domain gridding](#user-content-link39)
**Authors:** Sebastiaan van der Tol, Sarod Yatawatta, Bram Veenboer, David Rafferty

40. [Nano-particle Transition Matrix code implementation](#user-content-link40)
**Authors:** G. La Mura, G. Mulas, G. Aresu, M. A. Iat\`i, C. Cecchi-Pestellini, S. Rezaei, R. Saija

41. [The kinematic cosmic dipole beyond Ellis and Baldwin](#user-content-link41)
**Authors:** Albert Bonnefous

42. [Coalescence Forensics: Weighing the Hosts of Hierarchical Binary Black Hole Mergers](#user-content-link42)
**Authors:** Avinash Tiwari, Shasvath J. Kapadia

43. [Shocks, Winds, and a Torus: The Large Binocular Telescope Interferometer (LBTI) Resolves the Active Nucleus of NGC 4151](#user-content-link43)
**Authors:** Jacob W. Isbell, Steve Ertel, Makoto Kishimoto, Gerd Weigelt, J\"org-Uwe Pott, Jared Carlson, Qixiang Duan, Violeta G\'amez Rosas, Walter Jaffe, James Leftley, Daniel May, Romain. G. Petrov, Jennifer Power, H\'el\`ene Rousseau, Justin Rupert

44. [The Galaxy Bias Profile of Cosmic Voids:A Comparison of Void Finders](#user-content-link44)
**Authors:** Ignacio G. Alfaro, Antonio D. Montero-Dorta, Jorge F. Bustillos, Dante J. Paz, Andr\'es N. Ruiz, Andr\'es Balaguera-Antol\'inez, Ravi K. Sheth, Facundo Rodriguez, Constanza A. Soto-Su\'arez

45. [Searching for gravitational waves from compact binary mergers powering long gamma-ray bursts during LIGO-Virgo-KAGRA's O3 run](#user-content-link45)
**Authors:** Mallika R. Sinha, Teagan A. Clarke, Qifang Zhang, Nikhil Sarin, Eric Thrane, Paul D. Lasky

46. [Early-universe constraints on the electron mass](#user-content-link46)
**Authors:** Michela Garramone, Stefano Gariazzo, Nicolao Fornengo

47. [Wising up to CatWISE: using simulation-based inference to interpret the ecliptic bias and confirm the cosmic dipole excess](#user-content-link47)
**Authors:** Oliver T. Oayda, Geraint F. Lewis

48. [Mesoscopic chemical potentials across the (hyper)nuclear landscape](#user-content-link48)
**Authors:** Jacquelyn Noronha-Hostler

49. [An Accretion-Modulated Internal Shock Model for Long GRBs](#user-content-link49)
**Authors:** R. Moradi, C. W. Wang, E. S. Yorgancioglu

50. [Multi-spin stellar velocity maps of the most massive galaxies](#user-content-link50)
**Authors:** Davor Krajnovic (AIP), Eric Emsellem (ESO, CRAL), Roland Bacon (CRAL), Leindert A. Boogaard (Leiden), Peter M. Weilbacher (AIP), Lutz Wisotzki (AIP)

51. [Wide sdB binaries. I. Orbital and atmospheric parameters](#user-content-link51)
**Authors:** Francisco Molina, Joris Vos, Alexey Bobrick, Maja Vu\v{c}kovi\'c

52. [Does Cosmology require Hermiticity in Quantum Mechanics?](#user-content-link52)
**Authors:** Oem Trivedi, Alfredo Gurrola

53. [Evolution of cataclysmic variables under different magnetic braking prescriptions](#user-content-link53)
**Authors:** Bingyao Zhou, Chunhua Zhu, Guoliang L\"u, Sufen Guo, Helei Liu, Farkhodjon Khamrakulov

54. [ALMA 873 $\mu$m Polarization Observations of the PDS~70 Disk](#user-content-link54)
**Authors:** Hauyu Baobab Liu, Kiyoaki Doi, Simon Casassus, Akimasa Kataoka, Ruobing Dong, Jun Hashimoto, Philipp Weber

55. [Forecast on $f(R)$ Gravity with HI 21cm Intensity Mapping Surveys](#user-content-link55)
**Authors:** Yanling Song, Yu Sang, Linfeng Xiao, Boyu Zhang, Bin Wang

56. [Probing Compact Objects in Wide-Orbit Binaries with Joint LAMOST LRS and MRS](#user-content-link56)
**Authors:** Hao-Bin Liu, Wei-Min Gu

57. [Testing cosmic anisotropy with cluster scaling relations](#user-content-link57)
**Authors:** Tariq Yasin, Richard Stiskalek, Harry Desmond, Sebastian von Hausegger, Pedro G. Ferreira

58. [Simulating first-order phase transition during inflation](#user-content-link58)
**Authors:** Jintao Zou, Ligong Bian, Shao-Jiang Wang

59. [Relativistic Dynamics and Bondi-Hoyle-Lyttleton Accretion onto Rotating Embedded Black Hole Models](#user-content-link59)
**Authors:** Asifa Ashraf, Orhan Donmez, Abdelmalek Bouzenada, Chengxun Yuan, Aylin Caliskan, Gulzoda Rakhimova, Ahmadjon Abdujabbarov

60. [Oort Cloud Bombardment by Dark Matter](#user-content-link60)
**Authors:** Jeremy Mould

61. [An approximate Kappa generator for particle simulations](#user-content-link61)
**Authors:** Seiji Zenitani, Takayuki Umeda

62. [Cosmographic parameters from current and next-generation gravitational wave detectors](#user-content-link62)
**Authors:** Jonathan Morais, Rodrigo Gon\c{c}alves, Jailson Alcaniz

63. [Exploring the central engines of gamma-ray bursts from prompt light curves](#user-content-link63)
**Authors:** Xue Zhang, Shuang-Xi Yi, Wei-Hua Lei, Tong Liu, Yu-Peng Yang, Ying Qin, Yan-Kun Qu, Qing-Wen Tang, Fa-Yin Wang

64. [deci-Hz Gravitational Wave Observations on the Moon and Beyond](#user-content-link64)
...
65. [On the stability of viscous Riemann ellipsoids](#user-content-link65)
**Authors:** Joris Labarbe

66. [The Correlation Length of Turbulence in Magnetic Clouds](#user-content-link66)
**Authors:** S. W. Good, J. Lalueza Pu\'ertolas, A. -S. M. Jylh\"a, E. K. J. Kilpua

67. [Tidal disruption event rates across cosmic time: forecasts for LSST, Roman, and JWST and their constraints on the supermassive black hole mass function](#user-content-link67)
**Authors:** Mitchell Karmen, Suvi Gezari, Colin Norman, Muryel Guolo

68. [First Detailed MeerKAT Imaging Spectroscopy of a Solar Flare](#user-content-link68)
...
69. [Testing black hole space-times with the S2 star orbit: a Bayesian comparison](#user-content-link69)
**Authors:** C\'esar Navarrete, Fernando V\'azquez-Ch\'avez, Alejandro Cruz-Osorio, N\'estor Ortiz

70. [ACT DR6+Planck impact on inflation with non-zero vacuum expectation value and the post-inflationary behavior](#user-content-link70)
**Authors:** F. B. M. dos Santos, J. G. Rodrigues, G. Rodrigues, C. Siqueira, J. S. Alcaniz

71. [Relic of quadrupole deformation produced in a hot neutron star era](#user-content-link71)
**Authors:** Yasufumi Kojima, Akira Dohi, Shota Kisaka, Kotaro Fujisawa

72. [Suppression of Gravitational-Wave Echoes in Diffeomorphism-Invariant Nonlocal Gravity](#user-content-link72)
**Authors:** J. W. Moffat

73. [Dark Energy After DESI DR2: Observational Status, Reconstructions, and Physical Models](#user-content-link73)
**Authors:** Slava G. Turyshev

74. [Induced-Gravity Higgs Inflation in Palatini Supergravity Confronts ACT DR6](#user-content-link74)
**Authors:** C. Pallis

75. [Dynamics of the coronal magnetic field in the 2022-10-02 X-class flare](#user-content-link75)
**Authors:** Gregory D. Fleishman, Tatyana Kaltman, Sijie Yu

76. [A gamma-ray-emitting blazar B3 1239+376 at z = 3.82 identified in a multi-wavelength context](#user-content-link76)
**Authors:** Wei Zhang, Neng-Hui Liao, Hao-Yi Huang, Hai Lei, Xiong Jiang, Ning Jiang, Zhen-Feng Sheng, Lu-Lu Fan, Ting-Gui Wang

77. [IFU Spectroscopic Study of the Planetary Nebula Abell 30: Mapping the Ionisation and Kinematic Structure of the Inner Complex](#user-content-link77)
**Authors:** Kam Ling Chan, Andreas Ritter, Quentin Andrew Parker, Katrina Exter

78. [Long-term timing of the relativistic binary PSR J1906+0746](#user-content-link78)
**Authors:** L. Vleeschower, B. W. Stappers, M. J. Keith, G. Desvignes, P. C. C. Freire, M. Kramer, J. van Leeuwen, L. Levin, A. G. Lyne, I. H. Stairs, V. Venkatraman Krishnan, Y. Y. Wang

79. [The Double-Burst Nature and Early Afterglow Evolution of Long GRB 110801A](#user-content-link79)
**Authors:** Qiu-Li Wang, Hao Zhou, Yun Wang, Jia Ren, Zhi-Ping Jin, Da-Ming Wei

80. [Time lags and their association with the Boundary Layer structure in a Z source GX 349+2](#user-content-link80)
**Authors:** Abhishek M. V. R., Sriram K, Gouse SD

81. [Detecting gravitational wave background with equivalent configurations in the network of space based optical lattice clocks](#user-content-link81)
**Authors:** Mingzhi Lou, Hong Su, Tao Yang, Yun-Long Zhang

82. [Particle acceleration signatures in the time-dependent one-zone synchrotron self-Compton model of blazar flares](#user-content-link82)
**Authors:** Paloma Thevenet, Andreas Zech, Catherine Boisson, Anton Dmytriiev

83. [Effects of Dynamo-Generated Large-Scale Magnetic Fields on the Surface Gravity ($f$) Mode](#user-content-link83)
**Authors:** Rajesh Mondal, Nishant K. Singh

84. [Intereses convergentes: los a\~nos previos a la visita de Einstein a la Argentina en 1925](#user-content-link84)
**Authors:** Alejandro Gangui

---

## 1. [Modeling the recent interactions between the Magellanic Clouds and Milky Way](https://arxiv.org/abs/2602.05021) <a id="link1"></a>
...
**Comment:** This paper models the recent interactions between the Magellanic Clouds (LMC and SMC) and the Milky Way using N-body simulations. It is highly relevant to near-field cosmology, satellite interactions, and numerical galaxy simulations.
...
## 2. [Complex hydrogen chemical equilibrium and Gaia low mass problem in cool white dwarfs](https://arxiv.org/abs/2602.04995) <a id="link2"></a>
...
**Comment:** Addresses the modeling of cool white dwarf atmospheres and the Gaia low mass problem, with a focus on hydrogen chemistry and new insights into stellar atmosphere models. This fits the 'Stellar Models' criterion closely, as it presents new theoretical work on stellar atmospheres.
...
## 3. [Galactic seismology: can a disc-crossing impulse explain the large-scale perturbations in the Milky Way's disc?](https://arxiv.org/abs/2602.05296) <a id="link3"></a>
...
**Comment:** Simulates the impact of the Sagittarius dwarf galaxy's disc crossing on Milky Way disc perturbations, including spiral arms, corrugations, and phase spirals. This directly addresses near-field cosmology, specifically the historic interaction between the Milky Way and a dwarf satellite, and uses numerical galaxy simulations. Highly relevant to the prompt.
...
## 4. [Improved Heavy Dark Matter Annihilation Search from Dwarf Galaxies with HAWC](https://arxiv.org/abs/2602.05955) <a id="link4"></a>
...
**Comment:** This paper uses HAWC to search for dark matter annihilation signals from dwarf spheroidal galaxies, which are a key focus of near-field cosmology. The work is observational and directly relevant to dark matter in dwarf galaxies.
...
## 5. [Impact on Inferred Neutron Star Equation of State due to Nonlinear Hydrodynamics, Background Spin, and Relativity](https://arxiv.org/abs/2602.04951) <a id="link5"></a>
...
**Comment:** Addresses the cusp-core problem by comparing dark matter halo profiles in nearby galaxies, including low surface brightness and dwarf galaxies. Directly relevant to near-field cosmology and measurements of dark matter density profiles (core-cusp).
...
## 6. [The GMRT archive atomic gas survey -- III. Comparative Study of Dark Matter Halos in Nearby Galaxies](https://arxiv.org/abs/2602.04959) <a id="link6"></a>

**ArXiv ID:** 2602.04959

**Authors:** Sougata Sarkar, Prerana Biswas, Veselina Kalinova, Nirupam Roy, Narendra Nath Patra, Sushma Kurapati

**Abstract:** The distribution of dark matter in the inner regions of galaxies poses a key challenge for small-scale {\Lambda}CDM cosmology. While cold dark matter simulations predict cuspy inner density profiles, observations of low surface brightness (LSB) and dwarf galaxies often favour cored profiles, an issue known as the cusp-core problem. We investigate this problem by comparing four dark matter halo profiles: NFW (cuspy), Einasto (intermediate), Burkert (cored), and pseudo-isothermal (pISO) (cored) in a pilot sample of $11$ galaxies from the GMRT archive atomic gas survey (GARCIA). We have performed mass modelling using Markov Chain Monte Carlo (MCMC) techniques, utilising rotation curves derived from robust 3D Kinematic modelling. Baryonic contributions from stars derived using stellar kinematics based on $3.6\mu\mathrm{m}$ or $r$-band photometry via Multi-Gaussian Expansion (MGE) combined with Jeans Anisotropic Model (JAM) and from gas, calculated directly from the gas surface density (HI + He) without assuming any predefined functional form, are included. Our mass modelling shows that all halo profiles provide statistically good fits, yielding consistent estimates of halo mass and stellar mass-to-light ratio. To validate our analysis, we examine the stellar-to-halo mass relation and find broad agreement with empirical models. Non-parametric density profiles derived from baryon-subtracted rotation curves show that NFW fits the inner regions best, while all profiles converge in the outskirts. Future studies with a larger sample from GARCIA will be helpful in refining this trend and addressing the cusp-core issue in greater depth.

**Comment:** Compares dark matter halo profiles (NFW, Einasto, Burkert, pISO) in nearby galaxies, including LSB and dwarf galaxies, with a focus on the cusp-core problem. Directly relevant to near-field cosmology and core-cusp measurements.
...
## 7. [The Impact of Galaxy Formation on Galaxy Biasing, and Implications for Primordial non-Gaussianity Constraints](https://arxiv.org/abs/2602.04987) <a id="link7"></a>
...
**Comment:** Uses semi-analytic models and N-body simulations to study galaxy biasing and implications for primordial non-Gaussianity. Directly matches the 'Numerical Galaxy Simulations' criterion, with new simulations and semi-analytic modeling relevant to galaxy formation.
...
## 8. [Momentum-conserving self-gravity in the phantom smoothed particle hydrodynamics code. Parallel dual tree traversal for the symmetric fast multipole method](https://arxiv.org/abs/2602.05804) <a id="link8"></a>
...
**Comment:** Presents a new parallel fast multipole method for self-gravity in SPH simulations, directly matching the 'Numerical Galaxy Simulations' criterion, with improvements in simulation methodology.
...
## 9. [Differentiable Stochastic Halo Occupation Distribution with Galaxy Intrinsic Alignments](https://arxiv.org/abs/2602.04977) <a id="link9"></a>
...
**Comment:** Presents a differentiable halo occupation distribution model including galaxy intrinsic alignments, validated on simulations. This fits the 'Numerical Galaxy Simulations' criterion, as it presents a new simulation/modeling framework for galaxy populations and their alignments, with applications to weak lensing and clustering statistics.
...
## 11. [MIGHTEE/COSMOS-3D: The discovery of three spectroscopically confirmed radio-selected star-forming galaxies at z=4.9-5.6](https://arxiv.org/abs/2602.05808) <a id="link11"></a>
...
**Comment:** Discovery and analysis of high-redshift star-forming galaxies, including star formation rates and morphologies. While it discusses star formation, the focus is on massive galaxies at high redshift, not on dwarf galaxies or resolved star formation histories from CMDs.
...
## 12. [How Do Disk Galaxies Form?](https://arxiv.org/abs/2602.04950) <a id="link12"></a>
...
**Comment:** Presents an analytical model for disk galaxy formation, validated against TNG50 simulations. While it discusses galaxy morphology and simulations, the focus is on disk formation in higher mass galaxies, not dwarfs or satellites. Some relevance to numerical galaxy simulations, but not a core match.
...
## 13. [Tracing AGN Feedback Power with Cool/Warm Outflow Densities: Predictions and Observational Implications](https://arxiv.org/abs/2602.05954) <a id="link13"></a>
...
**Comment:** Uses hydrodynamic simulations to study AGN-driven outflows and the density of cool/warm outflowing gas. The simulations are high-resolution and include new refinement schemes, but the focus is on AGN feedback rather than star-formation-driven outflows or dwarf galaxies. The work is relevant to outflow physics, but not the core topics.
...
## 15. [Microlensing constraint on Primordial Black Hole abundance with Subaru Hyper Suprime-Cam observations of Andromeda](https://arxiv.org/abs/2602.05840) <a id="link15"></a>
...
**Comment:** Microlensing constraints on primordial black hole abundance using Andromeda observations. While it involves dark matter, the focus is on PBH constraints and not on satellite galaxies, resolved star formation histories, or galaxy simulations.
...
## 16. [Growth of High-Redshift Quasars from Fermion Dark Matter Seeds](https://arxiv.org/abs/2602.05135) <a id="link16"></a>
...
**Comment:** Models the growth of high-redshift quasars from massive seed black holes, with implications for early black hole formation. While it touches on cosmology and dark matter, it does not focus on near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 17. [A Chemistry-First Centered Icy Chemical Inventory of Protostellar Sources with JWST](https://arxiv.org/abs/2602.05383) <a id="link17"></a>
...
**Comment:** Presents JWST-based chemical inventory of protostellar sources, focusing on ice chemistry and complex organic molecules. This is relevant to star formation and chemical evolution in star-forming regions, but does not address resolved star formation histories, quenching, or galaxy simulations.
...
## 19. [Early growth of massive black holes in dynamical dark energy models with negative cosmological constant](https://arxiv.org/abs/2602.05921) <a id="link19"></a>
...
**Comment:** Explores early growth of massive black holes in dynamical dark energy models, with implications for galaxy and AGN number counts at high redshift. While it touches on galaxy formation, it does not focus on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 21. [The sub-arcsecond ILT view of the Bo\"{o}tes Deep Field: A link between low-frequency kiloparsec radio morphology and AGN driven ionised outflows](https://arxiv.org/abs/2602.05318) <a id="link21"></a>

**ArXiv ID:** 2602.05318

**Authors:** Emmy L. Escott, Leah K. Morabito, Frits Sweijen, Chris M. Harrison, James Petley, Jurjen M. G. H. J. de Jong, Reinout J. van Weeren, Thomas S. Higginson, Isabella Prandoni, George Miley, Huub J. A. R\"ottgering

**Abstract:** Active Galactic Nuclei (AGN) outflows can regulate host galaxy evolution via AGN feedback. Ionised gas outflows have been linked to enhanced radio emission. In the first paper of this series, AGN detected with the International LOFAR Telescope (ILT) at 6" were more likely to host an [O III] 5007 outflow than AGN not detected, although only high-powered jets were ruled out as the origin of radio emission. New wide-field, sub-arcsecond resolution imaging at 144 MHz with the ILT now enables a resolved morphological study of this sample. We present the first wide-field, sub-arcsecond images of the Bo\"otes Deep Field at 144 MHz, detecting 4074 sources in the $\sim$0.3" image with a central sensitivity of 33.8 uJy $\mathrm{beam^{-1}}$. For 47 AGN matched in AGN luminosity, we probe radio emission on kiloparsec-scales to investigate correlations with [O III] outflows. This sample spans $z<0.83$, $10^{40}<10^{43}~\mathrm{erg~s^{-1}}$, and $10^{21}<10^{24.5}~\mathrm{W~Hz^{-1}}$. We find that if we detect an AGN on both large-scales (6") and small-scales (0.3"), 90$\pm$7 per cent have an [O III] outflow, compared to 63$\pm$9 per cent of sources detected on large-scales, but undetected on small-scales. Furthermore, 17$\pm$6 per cent of sources without an [O III] outflow are detected on kiloparsec-scales, compared to 51$\pm$12 per cent of sources with an [O III] outflow. This implies a connection between [O III] outflows and kiloparsec-scale radio emission, which is likely AGN-driven. In contrast, AGN without an [O III] outflow are dominated by diffuse radio emission, likely to be associated with star formation.

**Comment:** Examines AGN-driven ionized outflows and their connection to radio morphology. The focus is on AGN feedback and outflows, but these are AGN-driven rather than star-formation-driven. The paper does mention diffuse radio emission likely associated with star formation, but the main thrust is AGN outflows, not star-formation-driven outflows or dwarf galaxies.
...
## 22. [ELFO: A Python package for emission line fitting optimization in integral field spectroscopy data](https://arxiv.org/abs/2602.05396) <a id="link22"></a>
...
**Comment:** Presents a Python package for emission line fitting in integral field spectroscopy, tested on quasar data. While relevant for ISM studies, it does not focus on galaxy simulations, star formation histories, or dwarf galaxies. Could be tangentially useful for ISM/CGM studies, but not directly aligned.
...
## 23. [XGAP with uGMRT I: Old AGN plasma in merging galaxy groups](https://arxiv.org/abs/2602.05609) <a id="link23"></a>
...
**Comment:** Studies AGN plasma in merging galaxy groups using multi-wavelength data. Focuses on AGN feedback and group-scale outflows, but the systems are galaxy groups, not dwarfs or satellites. Outflows are AGN-driven, not star-formation-driven, so only tangential relevance.
...
## 25. [Detailed TESS-Based Light Curve Modeling and Fundamental Parameter Estimation of 27 W UMa-Type Contact Binaries](https://arxiv.org/abs/2602.05038) <a id="link25"></a>
...
**Comment:** TESS-based light curve modeling of 27 W UMa-type contact binaries, focusing on fundamental parameters and evolutionary states. While it involves stellar modeling, it is focused on binary stars and not on new stellar evolutionary tracks or atmosphere models relevant to the criteria.
...
## 26. [Classifying white dwarfs from multi-object spectroscopy surveys with machine learning](https://arxiv.org/abs/2602.04964) <a id="link26"></a>
...
**Comment:** Machine learning classification of white dwarfs from spectroscopic surveys. Focus is on stellar classification, not on stellar models, resolved star formation histories, or galaxy simulations.
...
## 27. [Abundant hydrocarbons in a buried galactic nucleus with signs of carbonaceous grain and polycyclic aromatic hydrocarbon processing](https://arxiv.org/abs/2602.04967) <a id="link27"></a>
...
**Comment:** Observational study of hydrocarbons in a buried galactic nucleus, focusing on ISM chemistry and grain processing. No direct relevance to near-field cosmology, star formation histories, or galaxy simulations.
...
## 28. [ASPIRE: The Environments and Dark Matter Halos of Luminous Quasars in the Epoch of Reionization](https://arxiv.org/abs/2602.04979) <a id="link28"></a>

**ArXiv ID:** 2602.04979

**Authors:** Feige Wang, Jaclyn B. Champagne, Jiamu Huang, Jinyi Yang, Joseph F. Hennawi, Xiaohui Fan, Haowen Zhang, Tiago Costa, Roberto Decarli, Melanie Habouzit, Fengwu Sun, Eduardo Banados, Xiangyu Jin, Koki Kakiichi, Romain A. Meyer, Yunjing Wu, Silvia Belladitta, Laura Blecha, Sarah E. I. Bosman, Zheng Cai, Thomas Connor, Frederick B. Davies, Anna-Christina Eilers, Zoltan Haiman, Hyunsung D. Jun, Mingyu Li, Zihao Li, Weizhe Liu, Alessandro Lupi, Jianwei Lyu, Chiara Mazzucchelli, Masafusa Onoue, Maria Pudoka, Sofia Rojas-Ruiz, Jan-Torge Schindler, Yue Shen, Wei Leong Tee, Benny Trakhtenbrot, Maxime Trebitsch, Marianne Vestergaard, Marta Volonteri, Fabian Walter, Huanian Zhang, Siwei Zou

**Abstract:** We present a systematic study of the environments of 25 luminous quasars at $z > 6.5$ from the ASPIRE program. Using JWST/NIRCam WFSS data, we identified 487 galaxies at $5.3 \lesssim z \lesssim 7.0$ exhibiting [OIII] emission. Among these, 122 [OIII] emitters lie within $|\Delta v_{\rm los}|  5$ within a volume of $V \sim 500~{\rm cMpc^3}$. We also find that $|\Delta v_{\rm los}|$ increases rapidly toward smaller galaxy-quasar separations in protocluster fields, consistent with galaxy kinematics around extremely massive halos in cosmological simulations. By combining JWST and ALMA data, we reveal the complex and diverse environments of these early quasars, providing robust evidence that the earliest luminous quasars are effective tracers of galaxy overdensities, albeit with substantial field-to-field variation.

**Comment:** Focuses on environments and dark matter halos of luminous quasars at high redshift, using JWST and ALMA. While it discusses galaxy overdensities and massive halos, the work is centered on quasars and protoclusters, not dwarf galaxies or near-field cosmology. No direct connection to resolved star formation histories, quenching, or CGM of dwarfs.
...
## 29. [ICM-SHOX III. The case of MACS J0018.5+1626, a radio relic that looks like a radio halo?](https://arxiv.org/abs/2602.05050) <a id="link29"></a>
...
**Comment:** Numerical modeling of radio emission from a merging galaxy cluster, including magnetohydrodynamic simulations. While it uses advanced simulations, the focus is on cluster mergers and radio relics/halos, not on galaxy formation, dwarf galaxies, or near-field cosmology.
...
## 30. [MESS: Multi-Epoch Spectroscopic Solver for Detecting Double-Lined Systems](https://arxiv.org/abs/2602.05610) <a id="link30"></a>
...
**Comment:** Presents a new algorithm for identifying double-lined spectroscopic binaries in large spectroscopic datasets. While relevant to stellar populations, it does not present new stellar models or address resolved star formation histories, quenching, or galaxy simulations.
...
## 31. [Bayesian imaging inverse problem with scattering transform](https://arxiv.org/abs/2602.05816) <a id="link31"></a>
...
**Comment:** Presents a Bayesian imaging inverse problem approach using scattering transform statistics, applied to large-scale structure column density fields from simulations. While it is a methodological advance in cosmological imaging, it does not address galaxy simulations, dwarf galaxies, or resolved star formation histories.
...
## 32. [Water absorption confirms cool atmospheres in two little red dots](https://arxiv.org/abs/2602.06024) <a id="link32"></a>
...
**Comment:** This paper focuses on the atmospheres of compact high-redshift sources (little red dots) and uses stellar atmosphere models to interpret water absorption features. While it discusses stellar atmosphere modeling, the context is AGN and not stars in galaxies or resolved stellar populations. No direct connection to near-field cosmology, resolved star formation histories, or dwarf galaxies.
...
## 33. [Establishing a relationship between the cosmological 21 cm power spectrum and interferometric closure phases](https://arxiv.org/abs/2602.04965) <a id="link33"></a>
...
**Comment:** Establishes a relationship between the cosmological 21 cm power spectrum and interferometric closure phases. While relevant to cosmology, it does not focus on galaxies, star formation, or the other core topics.
...
## 34. [The CON-quasar stage of IRAS 07251-0248 E](https://arxiv.org/abs/2602.04997) <a id="link34"></a>

**ArXiv ID:** 2602.04997

**Authors:** Eduardo Gonz\'alez-Alfonso, Miguel Pereira-Santaella, Ismael Garc\'ia-Bernete, Jacqueline Fischer, Giovanna Speranza

**Abstract:** ALMA continuum measurements of the local ULIRG IRAS 07251-0248 E at 667$\mu$m reveal an extremely compact (R 200 K) nucleus with an absorbing foreground envelope and a surrounding (R ~ 75 pc) disk or torus seen nearly face-on. The bright and unresolved nuclear emission implies large optical depths ($\tau_{667\mu m}$ >0.5, corresponding to $N_H > 10^{25}$ cm^-2) of hot dust at >500 K. In addition, JWST observations of the source show strong mid-infrared (mid-IR) absorption in the ro-vibrational bands of H2O nu_2=1-0 (5-7 $\mu$m) and of other species including CO, HCN, C2H2, CH4, and CO2, and Herschel/PACS observations exhibit strong and saturated absorption due to OH, H2O, CH^+, and CH. We propose a model in which the unresolved ALMA submillimeter and JWST mid-IR continua trace the same nuclear source, the former penetrating deep into the nucleus and the latter probing the nuclear photosphere. The continuum model, which includes trapping of photons (the "greenhouse" effect), indicates that the nuclear ($R_h$ ~ 13 pc) luminosity and luminosity surface density are ~10$^{12}$ Lsun and $\Sigma_{bol}$~ 5e8 Lsun pc^-2, arising from an active galactic nucleus (AGN) so buried that high-ionization lines are completely obscured. The observed mid-IR gas-phase molecular bands probe outflowing gas with velocities of ~160 km s^-1 and are reproduced with the predicted $T_{dust}$ profile, while the far-IR molecular absorption lines are generated in the surrounding thick disk or torus with $\tau_{100 \mu m}$~10. We conclude that IRAS 07251-0248 harbors a compact obscured nucleus (CON) that hides an AGN currently emitting at quasar luminosity. While the observed outflow could be driven by radiation pressure, we favor the scenario of a (partially) energy-conserving hot bubble caught in a very early phase of the expulsion of the highly concentrated gas at the galactic nucleus.

**Comment:** This paper studies a compact obscured nucleus in a ULIRG, focusing on AGN and outflows. The outflow is discussed, but it is AGN-driven rather than star-formation-driven, and the galaxy is much more massive than the LMC. Does not match the core criteria.
...
## 35. [B-field Orion Protostellar Survey (BOPS). IV: The Relative Orientation Between Magnetic Fields and Density Structures in Young Protostellar Envelopes](https://arxiv.org/abs/2602.05316) <a id="link35"></a>
...
**Comment:** Studies the alignment between magnetic fields and density structures in protostellar envelopes. While relevant to star formation, it does not address resolved star formation histories, quenching, or galaxy simulations at the galaxy scale.
...
## 36. [Rotating strange dwarfs and their indistinguishability from white dwarfs](https://arxiv.org/abs/2602.05177) <a id="link36"></a>
...
**Comment:** Focuses on the structure and rotation of strange dwarfs (compact stars with quark matter cores and white dwarf crusts). While it discusses mass-radius measurements and the distinction between exotic compact objects and white dwarfs, it does not address near-field cosmology, resolved star formation histories, dwarf galaxy quenching, or galaxy simulations. The topic is stellar structure, but not new stellar models or evolutionary tracks.
...
## 37. [Wiggling Through the ICM: Multi-Resolution Radio Imaging of a Tailed Radio Galaxy in MACS J1354.6+7715](https://arxiv.org/abs/2602.04962) <a id="link37"></a>
...
**Comment:** Studies a tailed radio galaxy in a galaxy cluster, focusing on AGN-ICM interactions and cluster dynamics. While it touches on galaxy evolution and AGN lifecycles, it does not address dwarf galaxies, near-field cosmology, or star-formation-driven outflows.
...
## 38. [Photometric variability of nitrogen-rich Wolf-Rayet stars in Magellanic Clouds with OGLE](https://arxiv.org/abs/2602.05820) <a id="link38"></a>
...
**Comment:** Analyzes photometric variability of nitrogen-rich Wolf-Rayet stars in the Magellanic Clouds. While the Magellanic Clouds are nearby galaxies, the focus is on stellar variability and not on resolved star formation histories, dwarf galaxy evolution, or galaxy simulations.
...
## 39. [Direction-dependent calibration with image-domain gridding](https://arxiv.org/abs/2602.06002) <a id="link39"></a>
...
**Comment:** Presents a new calibration method for radio interferometry imaging. No direct relevance to galaxy simulations, star formation histories, or near-field cosmology.
...
## 40. [Nano-particle Transition Matrix code implementation](https://arxiv.org/abs/2602.05520) <a id="link40"></a>
...
**Comment:** Describes a new code for electromagnetic scattering by nanoparticles using the T-matrix formalism. While relevant to computational astrophysics, it does not address galaxy simulations, stellar models, or other core topics.
...
## 41. [The kinematic cosmic dipole beyond Ellis and Baldwin](https://arxiv.org/abs/2602.05700) <a id="link41"></a>
...
**Comment:** This paper discusses the cosmic dipole anomaly and generalizes the Ellis & Baldwin formula for luminosity functions and spectral profiles. It is focused on large-scale cosmology and quasar samples, not on galaxies, dwarf satellites, or resolved star formation histories.
...
## 42. [Coalescence Forensics: Weighing the Hosts of Hierarchical Binary Black Hole Mergers](https://arxiv.org/abs/2602.05645) <a id="link42"></a>
...
**Comment:** The paper presents a framework to infer the mass of clusters hosting hierarchical binary black hole mergers. It focuses on globular clusters and nuclear star clusters, which are not dwarf galaxies or satellite systems, and does not address galaxy formation, star formation histories, or quenching.
...
## 43. [Shocks, Winds, and a Torus: The Large Binocular Telescope Interferometer (LBTI) Resolves the Active Nucleus of NGC 4151](https://arxiv.org/abs/2602.05094) <a id="link43"></a>
...
**Comment:** Resolves the active nucleus of NGC 4151 using high-resolution interferometry. Focuses on AGN structure, torus, and jet-related heating, not on galaxy formation, dwarf galaxies, or star formation histories.
...
## 44. [The Galaxy Bias Profile of Cosmic Voids:A Comparison of Void Finders](https://arxiv.org/abs/2602.05117) <a id="link44"></a>
...
**Comment:** Examines galaxy bias profiles in cosmic voids using simulations, but does not focus on dwarf galaxies, satellite systems, or near-field cosmology. No direct connection to the core topics.
...
## 45. [Searching for gravitational waves from compact binary mergers powering long gamma-ray bursts during LIGO-Virgo-KAGRA's O3 run](https://arxiv.org/abs/2602.05169) <a id="link45"></a>
...
**Comment:** Searches for gravitational waves from compact binary mergers associated with long GRBs. No direct connection to near-field cosmology, resolved star formation histories, or dwarf galaxy quenching.
...
## 46. [Early-universe constraints on the electron mass](https://arxiv.org/abs/2602.05720) <a id="link46"></a>
...
**Comment:** Examines the impact of a nonstandard electron mass on early universe thermal history and BBN. While cosmological, it does not relate to galaxies, star formation histories, or any of the core topics.
...
## 47. [Wising up to CatWISE: using simulation-based inference to interpret the ecliptic bias and confirm the cosmic dipole excess](https://arxiv.org/abs/2602.05070) <a id="link47"></a>
...
**Comment:** Addresses cosmic dipole excess using simulation-based inference on quasar counts. The work is methodological and cosmological, with no direct relevance to near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 48. [Mesoscopic chemical potentials across the (hyper)nuclear landscape](https://arxiv.org/abs/2602.05824) <a id="link48"></a>
...
**Comment:** Discusses mesoscopic chemical potentials across the nuclear and hypernuclear landscape, focusing on nuclear physics and EOS constraints. Does not match any of the core galaxy or stellar model criteria.
...
## 49. [An Accretion-Modulated Internal Shock Model for Long GRBs](https://arxiv.org/abs/2602.05278) <a id="link49"></a>
...
**Comment:** Presents a new model for long GRB prompt emission, focusing on accretion-modulated internal shocks. This is about GRB physics and does not address any of the core topics such as galaxy simulations, star formation histories, or stellar models.
...
## 50. [Multi-spin stellar velocity maps of the most massive galaxies](https://arxiv.org/abs/2602.04968) <a id="link50"></a>
...
**Comment:** Focuses on the stellar kinematics and orbital structures of the most massive galaxies (BCGs and non-BCGs) in clusters, not dwarf galaxies or near-field cosmology. No direct relevance to satellite galaxies, resolved star formation histories, or core-cusp issues.
...
## 51. [Wide sdB binaries. I. Orbital and atmospheric parameters](https://arxiv.org/abs/2602.05008) <a id="link51"></a>
...
**Comment:** Studies wide sdB binaries, focusing on orbital and atmospheric parameters and binary evolution. No direct relevance to dwarf galaxies, star formation histories, or the core topics.
...
## 52. [Does Cosmology require Hermiticity in Quantum Mechanics?](https://arxiv.org/abs/2602.05973) <a id="link52"></a>
...
**Comment:** Explores non-Hermitian quantum mechanics in cosmology, with implications for inflation and structure growth. No direct relevance to galaxy formation, dwarf galaxies, or the specified core topics.
...
## 53. [Evolution of cataclysmic variables under different magnetic braking prescriptions](https://arxiv.org/abs/2602.05260) <a id="link53"></a>
...
**Comment:** Studies the evolution of cataclysmic variables (CVs) under different magnetic braking prescriptions using MESA simulations. The focus is on binary star evolution and magnetic braking, not on galaxy evolution, dwarf galaxies, or stellar models relevant to resolved star formation histories or galaxy simulations.
...
## 54. [ALMA 873 $\mu$m Polarization Observations of the PDS~70 Disk](https://arxiv.org/abs/2602.05247) <a id="link54"></a>
...
**Comment:** ALMA polarization observations of the PDS 70 protoplanetary disk, focusing on dust growth and planet formation. The work is on disk physics and dust coagulation, not on galaxy evolution, dwarf galaxies, or stellar models.
...
## 55. [Forecast on $f(R)$ Gravity with HI 21cm Intensity Mapping Surveys](https://arxiv.org/abs/2602.05575) <a id="link55"></a>
...
**Comment:** Forecasts constraints on f(R) gravity using HI 21cm intensity mapping surveys. The focus is on cosmological tests of gravity, not on galaxy evolution, dwarf galaxies, or resolved star formation histories.
...
## 56. [Probing Compact Objects in Wide-Orbit Binaries with Joint LAMOST LRS and MRS](https://arxiv.org/abs/2602.05421) <a id="link56"></a>
...
**Comment:** Searches for compact objects in wide-orbit binaries using LAMOST data. Focuses on binary systems and compact object detection, not on galaxy formation, dwarf galaxies, or resolved star formation histories.
...
## 57. [Testing cosmic anisotropy with cluster scaling relations](https://arxiv.org/abs/2602.06007) <a id="link57"></a>
...
**Comment:** Tests cosmic anisotropy using cluster scaling relations and Bayesian modeling. Focuses on cosmological parameters and galaxy clusters, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 58. [Simulating first-order phase transition during inflation](https://arxiv.org/abs/2602.05501) <a id="link58"></a>
...
**Comment:** Simulates first-order phase transitions during inflation, focusing on bubble nucleation and gravitational wave signatures. This is cosmological theory, not related to galaxy formation, near-field cosmology, or any of the core criteria.
...
## 59. [Relativistic Dynamics and Bondi-Hoyle-Lyttleton Accretion onto Rotating Embedded Black Hole Models](https://arxiv.org/abs/2602.05747) <a id="link59"></a>
...
**Comment:** Focuses on relativistic accretion onto black holes and particle dynamics, which is not relevant to near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations. No matching criteria.
...
## 60. [Oort Cloud Bombardment by Dark Matter](https://arxiv.org/abs/2602.04922) <a id="link60"></a>
...
**Comment:** This paper discusses the impact of primordial black holes (PBHs) as dark matter on the Oort cloud, focusing on comet dislodgement. While it touches on dark matter, it is not related to near-field cosmology, dwarf galaxies, or any of the core topics. The focus is on the solar system, not galaxies.
...
## 61. [An approximate Kappa generator for particle simulations](https://arxiv.org/abs/2602.05606) <a id="link61"></a>
...
**Comment:** Presents a random number generator for the Kappa velocity distribution for particle simulations. This is a technical/methodological paper not focused on galaxy simulations or any of the core topics.
...
## 62. [Cosmographic parameters from current and next-generation gravitational wave detectors](https://arxiv.org/abs/2602.05969) <a id="link62"></a>
...
**Comment:** This paper is focused on cosmological parameter estimation using gravitational wave standard sirens. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 63. [Exploring the central engines of gamma-ray bursts from prompt light curves](https://arxiv.org/abs/2602.05587) <a id="link63"></a>
...
**Comment:** Uses GRB light curve morphology to distinguish between central engine mechanisms. This is focused on GRB physics and does not address any of the core topics.
...
## 64. [deci-Hz Gravitational Wave Observations on the Moon and Beyond](https://arxiv.org/abs/2602.05923) <a id="link64"></a>
...
**Comment:** Workshop summary on deci-Hz gravitational wave observations, including lunar and space-based detectors. No direct relevance to galaxy formation, dwarf galaxies, or the specified core topics.
...
## 65. [On the stability of viscous Riemann ellipsoids](https://arxiv.org/abs/2602.05658) <a id="link65"></a>
...
**Comment:** Investigates the stability of Riemann ellipsoids, which is relevant to fluid dynamics in astrophysical contexts but not directly to galaxy evolution, dwarf galaxies, or stellar models. No direct connection to the core topics.
...
## 66. [The Correlation Length of Turbulence in Magnetic Clouds](https://arxiv.org/abs/2602.05450) <a id="link66"></a>
...
**Comment:** Studies turbulence in magnetic clouds in the solar wind, not related to galaxy evolution, dwarf galaxies, or star formation histories.
...
## 67. [Tidal disruption event rates across cosmic time: forecasts for LSST, Roman, and JWST and their constraints on the supermassive black hole mass function](https://arxiv.org/abs/2602.04947) <a id="link67"></a>
...
**Comment:** This paper models tidal disruption event rates to constrain the supermassive black hole mass function. It is focused on SMBHs and TDEs, which are specifically listed as irrelevant in the criteria.
...
## 68. [First Detailed MeerKAT Imaging Spectroscopy of a Solar Flare](https://arxiv.org/abs/2602.05282) <a id="link68"></a>
...
**Comment:** MeerKAT imaging spectroscopy of a solar flare, focusing on energy release and particle acceleration in the Sun. No relevance to galaxy formation, near-field cosmology, or any of the core criteria.
...
## 69. [Testing black hole space-times with the S2 star orbit: a Bayesian comparison](https://arxiv.org/abs/2602.04980) <a id="link69"></a>
...
**Comment:** Bayesian comparison of black hole space-times using S2 star orbit data around Sagittarius A*. Focus is on black hole metrics and Galactic center, which is explicitly excluded from the relevant criteria.
...
## 70. [ACT DR6+Planck impact on inflation with non-zero vacuum expectation value and the post-inflationary behavior](https://arxiv.org/abs/2602.06027) <a id="link70"></a>
...
**Comment:** Studies impact of ACT+Planck CMB data on inflation models and post-inflationary behavior, including lattice simulations of inflaton field. No connection to galaxy formation, near-field cosmology, or any of the core criteria.
...
## 71. [Relic of quadrupole deformation produced in a hot neutron star era](https://arxiv.org/abs/2601.13550) <a id="link71"></a>
...
**Comment:** Investigates quadrupole deformation in neutron stars and its evolution, relevant for gravitational wave astronomy. No connection to galaxy formation, dwarf galaxies, or the specified core topics.
...
## 72. [Suppression of Gravitational-Wave Echoes in Diffeomorphism-Invariant Nonlocal Gravity](https://arxiv.org/abs/2602.04996) <a id="link72"></a>
...
**Comment:** Discusses suppression of gravitational-wave echoes in nonlocal gravity theories, focusing on black holes and quantum gravity. No relevance to galaxy formation, dwarf galaxies, or the specified core topics.
...
## 73. [Dark Energy After DESI DR2: Observational Status, Reconstructions, and Physical Models](https://arxiv.org/abs/2602.05368) <a id="link73"></a>
...
**Comment:** This is a review of dark energy constraints after DESI DR2, focusing on cosmological parameters, BAO, and supernovae. It does not address galaxy formation, dwarf galaxies, resolved star formation histories, or any of the core topics.
...
## 74. [Induced-Gravity Higgs Inflation in Palatini Supergravity Confronts ACT DR6](https://arxiv.org/abs/2602.05623) <a id="link74"></a>
...
**Comment:** Formulates a model of induced-gravity Higgs inflation in Palatini Supergravity, confronting ACT DR6 data. Focuses on inflationary cosmology and particle physics, not on galaxy formation, dwarf galaxies, or resolved star formation histories.
...
## 75. [Dynamics of the coronal magnetic field in the 2022-10-02 X-class flare](https://arxiv.org/abs/2602.05024) <a id="link75"></a>
...
**Comment:** Studies the dynamics of the coronal magnetic field during a solar flare. No connection to galaxy evolution, near-field cosmology, or any of the listed criteria.
...
## 76. [A gamma-ray-emitting blazar B3 1239+376 at z = 3.82 identified in a multi-wavelength context](https://arxiv.org/abs/2602.05222) <a id="link76"></a>

**ArXiv ID:** 2602.05222

**Authors:** Wei Zhang, Neng-Hui Liao, Hao-Yi Huang, Hai Lei, Xiong Jiang, Ning Jiang, Zhen-Feng Sheng, Lu-Lu Fan, Ting-Gui Wang

**Abstract:** Among thousands of extragalactic $\gamma$-ray emitters, only a handful of distant ($z >$ 3) sources are detected, yet they are cruial probes shedding light on the cosmic evolution of jets of active galactic nuclei and the initial phase of mass growth of supermassive black holes. Here, we report on a multi-band study of a radio quasar B3 1239+376 with $z$ = 3.82. By analyzing the Fermi-LAT data, a significant (globally 7.7$\sigma$) $\gamma$-ray source in its direction, with an estimated association probability of 0.91, is observed in a half-year period of 2025. The analyses also reveal the emergence of co-spatial $\gamma$-ray residues in prior epochs. Moreover, the $\gamma$-ray and infrared light curves are likely correlated, particularly, the two emissions climb to the peaking values at the same time. The temporal coincidence establishes a firm association relationship between the $\gamma$-ray source and the quasar. Therefore, B3 1239+376 is proposed as the {\it third} most distant $\gamma$-ray-emitting blazar to date. Benefiting from the multi-wavelength observations, broadband spectral energy distributions in different flux states are drawn and reproduced by the classic one-zone leptonic radiation model to investigate the jet properties. Considering the recent brightening in $\gamma$ rays, prompt follow-up observations are encouraged, especially radio interferometry observations which may catch the potential ejection of a new jet blob.

**Comment:** Multi-wavelength study of a distant blazar, focusing on AGN jet properties and SMBH growth. Does not match any core topics.
...
## 77. [IFU Spectroscopic Study of the Planetary Nebula Abell 30: Mapping the Ionisation and Kinematic Structure of the Inner Complex](https://arxiv.org/abs/2602.05277) <a id="link77"></a>
...
**Comment:** IFU spectroscopic study of a planetary nebula, mapping ionization and kinematic structure. Not related to galaxies or any of the core topics.
...
## 79. [The Double-Burst Nature and Early Afterglow Evolution of Long GRB 110801A](https://arxiv.org/abs/2602.05404) <a id="link79"></a>
...
**Comment:** Detailed analysis of a long-duration gamma-ray burst, focusing on temporal and spectral properties and afterglow modeling. No connection to any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 80. [Time lags and their association with the Boundary Layer structure in a Z source GX 349+2](https://arxiv.org/abs/2602.05989) <a id="link80"></a>
...
**Comment:** Studies time lags in X-ray emission from a neutron star binary, focusing on accretion disk and boundary layer structure. No connection to galaxy formation, near-field cosmology, or any of the core criteria.
...
## 81. [Detecting gravitational wave background with equivalent configurations in the network of space based optical lattice clocks](https://arxiv.org/abs/2602.05714) <a id="link81"></a>
...
**Comment:** Discusses gravitational wave detection with optical lattice clocks, focusing on detector configurations and sensitivity. No relevance to galaxy formation, dwarf galaxies, or the specified core topics.
...
## 82. [Particle acceleration signatures in the time-dependent one-zone synchrotron self-Compton model of blazar flares](https://arxiv.org/abs/2602.05601) <a id="link82"></a>
...
**Comment:** Models particle acceleration and flare light curves in blazars, focusing on jet physics. No relevance to galaxy formation, dwarf galaxies, or the specified core topics.
...
## 83. [Effects of Dynamo-Generated Large-Scale Magnetic Fields on the Surface Gravity ($f$) Mode](https://arxiv.org/abs/2602.05529) <a id="link83"></a>
...
**Comment:** This paper models the interaction between solar surface gravity modes and dynamo-generated magnetic fields. It is focused on solar physics and does not relate to any of the core topics.
...
## 84. [Intereses convergentes: los a\~nos previos a la visita de Einstein a la Argentina en 1925](https://arxiv.org/abs/2602.05063) <a id="link84"></a>
...
**Comment:** Historical analysis of Einstein's visit to Argentina and the local reception of relativity. No connection to any of the core astrophysical topics.
