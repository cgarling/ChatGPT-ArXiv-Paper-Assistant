...
1. [A Deep Look at the Ultra-Faint Milky Way Satellite Virgo III with Rubin Observatory Data Preview 2](#user-content-link1)
**Authors:** Aashay Pai, Alex Drlica-Wagner, Peter S. Ferguson, William Cerny, Chin Yi Tan, Jeffrey L. Carlin, Yumi Choi, \v{Z}eljko Ivezi\'c, Lauren A. MacArthur, Colin T. Slater, Dan S. Taranu, Brian Yanny

2. [Reaching the Metallicity Floor at $z\sim 10$: Lensed Star Clusters at Cosmic Dawn and Cosmic Noon](#user-content-link2)
**Authors:** Raul Jimenez, Elena Tomasetti, Carmela Lardo, Licia Verde

3. [EFT-Ramses: a code to simulate the effective field theory of dark energy](#user-content-link3)
**Authors:** Nathaniel Ota Woodcock, Sownak Bose, Yunhao Gao, Baojiu Li

4. [Empirical H- and K-band Limb Darkening for 31 CHARA Stars: A Near-Infrared Benchmark for Stellar-Atmosphere Models](#user-content-link4)
**Authors:** Narsireddy Anugu, John D. Monnier, Antoine M\'erand, Becky Flores, Alexandre Gallenne, Douglas R. Gies, Mayra Gutierrez, Robert Klement, Stefan Kraus, Jayadev Rajagopal, Rachael M. Roettenbacher, Gail H. Schaefer

5. [CHORD HI-Galaxy Survey Forecasts: Searching for nearby dark galaxies and high redshift giants](#user-content-link5)
**Authors:** Akanksha Bij (Department of Physics, Engineering Physics and Astronomy, Queen's University, Kingston, Canada), Kristine Spekkens (Department of Physics, Engineering Physics and Astronomy, Queen's University, Kingston, Canada), Hans S. Hopkins (Perimeter Institute for Theoretical Physics, Waterloo, Canada, Waterloo Center for Astrophysics, University of Waterloo, Waterloo, Canada), Michael G. Jones (IPAC, Caltech, Pasadena, USA), Arnab Chakraborty (Department of Physics, McGill University, Montreal, Canada, Trottier Space Institute, Montreal, Canada), Simon Foreman (Department of Physics, Arizona State University, Tempe, USA), Alex S. Hill (Department of Math, Physics, & Statistics, University of British Columbia, Okanagan Campus, Kelowna, Canada, Dominion Radio Astrophysical Observatory, Herzberg Research Centre for Astronomy and Astrophysics, National Research Council, Penticton, Canada), Dustin Lang (Perimeter Institute for Theoretical Physics, Waterloo, Canada, Waterloo Center for Astrophysics, University of Waterloo, Waterloo, Canada), Adrian Liu (Department of Physics, McGill University, Montreal, Canada, Trottier Space Institute, Montreal, Canada)

6. [A Test of FeH Line Parameters using DR19 APOGEE spectra of Benchmark M Dwarfs](#user-content-link6)
**Authors:** Anderson Silva-Andrade, Diogo Souto, Katia Cunha, Verne V. Smith, Carlos Allende Prieto, Ricardo P. Schiavon, Ver\'onica Loaiza-Tacuri, Aida Behmard, Dmitry Bizyaev, Ilija Medan, Dan Qiu, B\'arbara Rojas-Ayala

7. [Tightening Bounds on Warm Dark Matter with High-Redshift Gamma-Ray Bursts](#user-content-link7)
**Authors:** Jun-Jie Wei, Jing-Meng Hao, Ding-Fang Hu, Yang Liu, Bao Wang, Xi Kang, Xue-Feng Wu

8. [Investigating the Observational Progenitor Mass Gap in the White Dwarf Initial-Final Mass Relation. I. Cluster Census and Characterization of the First White Dwarfs in the Gap](#user-content-link8)
**Authors:** David R. Miller, Jeremy Heyl, Pier-Emmanuel Tremblay

9. [Magnetic pressure anisotropy in ultra-dense white dwarfs: Landau quantization and neutronization effects](#user-content-link9)
**Authors:** Edson Otoniel, Juan M. Z. Pretel, Victor B. T. Alves, C\'esar O. V. Flores, Cl\'esio E. Mota

10. [The $\sigma_s^2-\mathcal{M}$ relation in the multi-phase ISM: Exploring the density PDF with the Cloud Factory simulations](#user-content-link10)
**Authors:** Mairi Nonhebel, Rowan J. Smith, Ralf S. Klessen

11. [The IMF package: a toolkit implementing mass functions and statistical tools to analyze them](#user-content-link11)
**Authors:** Theo Richardson, Adam Ginsburg, Sergey Koposov

12. [Binary-induced mass increase and helium enrichment of the envelopes of Type~IIP supernova progenitors](#user-content-link12)
**Authors:** Caroline Mannes, Norbert Langer, Andrea Ercolino

13. [Observational Evidence for Anisotropic Metal Excess around Galaxies](#user-content-link13)
**Authors:** Cheqiu Lyu, Enci Wang, Zeyu Chen, Chengyu Ma, Yangyao Chen, Haoran Yu, Xu Kong

14. [Robust Ly$\alpha$ forest constraints on reionization from semi-analytic galaxy formation models](#user-content-link14)
**Authors:** Yuxiang Qin, J. Stuart B. Wyithe

15. [From Starburst to Quenching: Physical Properties of Extremely Compact Starbursts at z$\sim$0.1](#user-content-link15)
**Authors:** Can Xu, Mengyuan Xiao, Min Bao, Qiusheng Gu, Longji Bing, Yong Shi, Yifei Jin, Shiying Lu

16. [The evolution of galaxy dust scaling relations in the COLIBRE simulations](#user-content-link16)
**Authors:** Aswin P. Vijayan, James W. Trayford, Joop Schaye, Sylvia Ploeckinger, Andrea Gebek, Nick Andreadis, Maarten Baes, Alejandro Ben\'itez-Llambay, Evgenii Chaikin, Carlos S. Frenk, Filip Hu\v{s}ko, Robert J. McGibbon, Alexander J. Richings, Matthieu Schaller

17. [HI Depletion Begins Well Beyond the Virial Radius: A FAST Stacking Study of 36 Galaxy Clusters to 5R200](#user-content-link17)
**Authors:** Cheng Cheng, Chuan-Peng Zhang, Edo Ibar, Rory Smith, Weiwei Xu, Hyowon Kim, Jia-Sheng Huang, Wei Zhang, Pei Zuo, Hugo M\'endez-Hern\'andez, Juan Molina, Ming Zhu, Qian Yu

18. [Cosmological evolution with decaying dark matter: an integral-equation approach](#user-content-link18)
**Authors:** Nanoom Lee, Anna Bencke, Marc Kamionkowski, Jos\'e Luis Bernal

19. [Primordial Physics in the Nonlinear Universe: Revealing the oscillating halo bias from cosmological collider models](#user-content-link19)
**Authors:** Dhayaa Anbajagane, Neal Dalal

20. [Gravitational Wave Modeling of White-Dwarf--Compact-Object Binaries and Observational Outlook](#user-content-link20)
**Authors:** Tristan S. Weaver (The Pennsylvania State University), David Radice (The Pennsylvania State University), Donghui Jeong (The Pennsylvania State University, Korea Institute for Advanced Study), Victor Liu (The Pennsylvania State University)

21. [Anisotropic Secondary Bias of Dark Matter Haloes in a $\Lambda$CDM Universe](#user-content-link21)
**Authors:** Qinglin Ma, Cheng Li

22. [Progenitor models of supernovae interacting with their binary companions](#user-content-link22)
**Authors:** Andrea Ercolino

23. [Low-Metallicity Star Formation Survey in Sh2-284 (LZ-STAR): The Core Mass Function](#user-content-link23)
**Authors:** Yu Cheng, Jonathan C. Tan, Morten Andersen, Alva Kinman, Rub\'en Fedriani, Kei E. I. Tanaka, Yichen Zhang

24. [Ly$\alpha$ Escape in JWST/NIRCam F430M-Selected H$\alpha$ Emitters at $z\simeq5.5$](#user-content-link24)
...
25. [CosmoLattice 2.0](#user-content-link25)
**Authors:** Jorge Baeza-Ballesteros, Daniel G. Figueroa, Adrien Florio, Nicol\'as Loayza, Franz R. Sattler, Francisco Torrent\'i, Ander Urio

26. [A new look at old devils. II: New insights on classical radio galaxies from MeerKAT and uGMRT](#user-content-link26)
**Authors:** Portia P. Legodi, Tiziana Venturi, Dharam V. Lal, Bernie Fanaroff, Oleg M. Smirnov, Simona Giacintucci

27. [SKAO-ALMA Synergies in Star Formation Science](#user-content-link27)
...
28. [Radiation-Driven Evolution and Gas Kinematics of the Bright-Rimmed Cloud SFO 25](#user-content-link28)
**Authors:** Puja Porel, Archana Soam, William D. Vacca, Janik Karoly

29. [Localized magnetic pressure anisotropy in strange dwarfs with crystalline crusts](#user-content-link29)
**Authors:** Mila Leite Garcia Reis, Daniela Eller Uliana, Jaziel G. Coelho, Edson Otoniel

30. [V407 Vul: a triple star system with an AM CVn detectable by gravitational wave observatories](#user-content-link30)
...
31. [Correlated signals of ultralight scalar dark matter in pulsar timing](#user-content-link31)
...
32. [Chemistry of Dark Molecular Clouds](#user-content-link32)
**Authors:** Yuri Aikawa, Izaskun Jimenez-Serra, Paola Caselli

33. [Simulation-based tension quantification of the cosmic dipole](#user-content-link33)
**Authors:** Mali Land-Strykowski, Harry T. J. Bevins, Oliver T. Oayda, Geraint F. Lewis

34. [Weighted Webs: Morphology-Informed Marked Fields](#user-content-link34)
**Authors:** Mikel Martin Barandiaran, Jessica A. Cowell, David Alonso, Javier Carr\'on Duque, Juan Garc\'ia-Bellido

35. [High-energy neutrino emission from the Milky Way](#user-content-link35)
**Authors:** R. Abbasi, M. Ackermann, J. Adams, J. A. Aguilar, M. Ahlers, J. M. Alameddine, S. Ali, N. M. Amin, K. Andeen, C. Arg{\"u}elles, S. Athanasiadou, S. N. Axani, R. Babu, X. Bai, A. Balagopal V., S. W. Barwick, V. Basu, R. Bay, J. J. Beatty, J. Becker Tjus, P. Behrens, J. Beise, C. Bellenghi, S. Benkel, S. BenZvi, D. Berley, E. Bernardini, D. Z. Besson, E. Blaufuss, L. Bloom, S. Blot, F. Bontempo, J. Y. Book Motzkin, C. Boscolo Meneguolo, S. B{\"o}ser, O. Botner, J. B{\"o}ttcher, J. Braun, B. Brinson, Z. Brisson-Tsavoussis, L. Brusa, R. T. Burley, D. Butterfield, K. Carloni, J. Carpio, N. Chau, Y. C. Chen, Z. Chen, D. Chirkin, S. Choi, A. Chubarov, B. A. Clark, D. A. Coloma Borja, A. Connolly, J. M. Conrad, D. F. Cowen, C. De Clercq, J. J. DeLaunay, D. Delgado, T. Delmeulle, S. Deng, P. Desiati, K. D. de Vries, G. de Wasseige, T. DeYoung, J. C. D{\'\i}az-V{\'e}lez, S. DiKerby, T. Ding, M. Dittmer, A. Domi, L. Draper, L. Dueser, D. Durnford, K. Dutta, M. A. DuVernois, T. Ehrhardt, L. Eidenschink, A. Eimer, C. Eldridge, P. Eller, E. Ellinger, D. Els{\"a}sser, R. Engel, H. Erpenbeck, W. Esmail, S. Eulig, J. Evans, P. A. Evenson, K. L. Fan, K. Fang, K. Farrag, A. Fattorini, A. R. Fazely, A. Fedynitch, N. Feigl, C. Finley, D. Fox, A. Franckowiak, S. Fukami, P. F{\"u}rst, J. Gallagher, E. Ganster, A. Garcia, M. Garcia, E. Genton, L. Gerhardt, A. Ghadimi, C. Glaser, T. Gl{\"u}senkamp, J. G. Gonzalez, S. Goswami, A. Granados, D. Grant, S. J. Gray, S. Griffin, S. Griswold, K. M. Groth, D. Guevel, C. G{\"u}nther, P. Gutjahr, C. Ha, A. Hallgren, L. Halve, F. Halzen, L. Hamacher, M. Handt, K. Hanson, J. Hardin, A. A. Harnisch, P. Hatch, A. Haungs, J. H{\"a}u{\ss}ler, K. Helbing, J. Hellrung, B. Henke, L. Hennig, F. Henningsen, L. Heuermann, R. Hewett, N. Heyer, S. Hickford, A. Hidvegi, C. Hill, G. C. Hill, R. Hmaid, K. D. Hoffman, A. Hollnagel, D. Hooper, S. Hori, K. Hoshina, M. Hostert, W. Hou, M. Hrywniak, T. Huber, K. Hultqvist, K. Hymon, A. Ishihara, W. Iwakiri, M. Jacquart, S. Jain, O. Janik, M. Jansson, M. Jin, N. Kamp, D. Kang, W. Kang, A. Kappes, L. Kardum, T. Karg, A. Karle, A. Katil, M. Kauer, J. L. Kelley, M. Khanal, A. Khatee Zathul, A. Kheirandish, T. Kim, H. Kimku, F. Kirchner, J. Kiryluk, C. Klein, S. R. Klein, Y. Kobayashi, S. Koch, A. Kochocki, R. Koirala, H. Kolanoski, T. Kontrimas, L. K{\"o}pke, C. Kopper, D. J. Koskinen, P. Koundal, M. Kowalski, T. Kozynets, A. Kravka, N. Krieger, T. Krishnan, K. Kruiswijk, E. Krupczak, E. Kun, N. Kurahashi, C. Lagunas Gualda, L. Lallement Arnaud, M. J. Larson, F. Lauber, J. P. Lazar, K. Leonard DeHolton, A. Leszczy{\'n}ska, C. Li, J. Liao, C. Lin, Q. R. Liu, Y. T. Liu, M. Liubarska, C. Love, L. Lu, F. Lucarelli, W. Luszczak, Y. Lyu, M. Macdonald, E. Magnus, Y. Makino, E. Manao, S. Mancina, A. Mand, I. C. Mari{\c{s}}, S. Marka, Z. Marka, L. Marten, I. Martinez-Soler, R. Maruyama, J. Mauro, F. Mayhew, F. McNally, K. Meagher, A. Medina, M. Meier, Y. Merckx, L. Merten, S. Minji, J. Mitchell, L. Molchany, S. Mondal, T. Montaruli, R. W. Moore, Y. Morii, A. Mosbrugger, D. Mousadi, E. Moyaux, T. Mukherjee, M. Nakos, U. Naumann, R. Neshat, L. Neste, M. Neumann, H. Niederhausen, M. U. Nisa, K. Noda, A. Noell, A. Novikov, A. Obertacke, V. O'Dell, A. Olivas, R. Orsoe, J. Osborn, E. O'Sullivan, B. Owens, V. Palusova, H. Pandya, A. Parenti, C. Parisel, N. Park, V. Parrish, E. N. Paudel, L. Paul, C. P{\'e}rez de los Heros, T. Pernice, T. C. Petersen, J. Peterson, S. Pick, M. Plum, A. Pont{\'e}n, V. Poojyam, B. Pries, R. Procter-Murphy, G. T. Przybylski, L. Pyras, C. Raab, J. Rack-Helleis, N. Rad, M. Ravn, K. Rawlins, Z. Rechav, A. Rehman, I. Reistroffer, E. Resconi, C. D. Rho, W. Rhode, L. Ricca, B. Riedel, A. Rifaie, E. J. Roberts, S. Rodan, M. Rongen, A. Rosted, C. Rott, T. Ruhe, L. Ruohan, D. Ryckbosch, J. Saffer, D. Salazar-Gallegos, P. Sampathkumar, A. Sandrock, G. Sanger-Johnson, M. Santander, S. Sarkar, M. Scarnera, M. Schaufel, H. Schieler, S. Schindler, L. Schlickmann, B. Schl{\"u}ter, F. Schl{\"u}ter, N. Schmeisser, T. Schmidt, F. Schmitt, A. Scholz, F. G. Schr{\"o}der, S. Schwirn, S. Sclafani, D. Seckel, L. Seen, M. Seikh, S. Seunarine, P. A. Sevle Myhr, R. Shah, S. Shah, S. Shefali, N. Shimizu, B. Skrzypek, R. Snihur, J. Soedingrekso, D. Soldin, P. Soldin, G. Sommani, D. Song, C. Spannfellner, G. M. Spiczak, C. Spiering, J. Stachurska, M. Stamatikos, T. Stanev, T. Stezelberger, T. St{\"u}rwald, T. Stuttard, G. W. Sullivan, I. Taboada, S. Ter-Antonyan, A. Terliuk, A. Thakuri, M. Thiesmeyer, W. G. Thompson, J. Thwaites, W. Tian, S. Tilav, K. Tollefson, J. A. Torres, S. Toscano, D. Tosi, K. Upshaw, A. Vaidyanathan, N. Valtonen-Mattila, J. Valverde, J. Vandenbroucke, T. Van Eeden, N. van Eijndhoven, L. Van Rootselaar, J. van Santen, J. Vara, F. Varsi, M. Velazquez, M. Venugopal, M. Vereecken, S. Vergara Carrasco, S. Verpoest, D. Veske, A. Vijai, J. Villarreal, C. Walck, A. Wang, E. H. S. Warrick, C. Weaver, A. Weindl, J. Weldert, A. Y. Wen, C. Wendt, J. Werthebach, M. Weyrauch, N. Whitehorn, C. H. Wiebusch, D. R. Williams, L. Witthaus, J. Woodward, G. Wrede, X. W. Xu, J. P. Yanez, Y. Yao, E. Yildizci, S. Yoshida, F. Yu, S. Yu, T. Yuan, S. Yun-C{\'a}rcamo, A. Zander Jurowitzki, A. Zegarelli, S. Zhang, Z. Zhang, P. Zhelnin, P. Zilberman, C. Zilleruelo Ca{\~n}as

36. [Vigorous turbulence driven by quasar-mode feedback in a cluster core](#user-content-link36)
**Authors:** Satoshi Yamada, Shutaro Ueda, Hirofumi Noda, Yutaka Fujita, Misaki Mizumoto, Kentaro Nagamine, Claudio Ricci, Shoji Ogawa, Taiki Kawamuro, Shinya Yamada, Yuichi Terashima, Yoshihiro Ueda

37. [LiteBIRD Mission Overview after Mission Reformation](#user-content-link37)
...
38. [The afterglow of gamma-ray burst - supernova connections](#user-content-link38)
**Authors:** Marco Muccino, Rahim Moradi, Yu Wang

39. [Progenitor and Explosion Mechanism of 3C 397 Indicated from XRISM High-resolution Spectroscopy of Fe-group Elements](#user-content-link39)
**Authors:** Hiroshi Nakajima, Yuken Ohshiro, Shing-Chi Leung, Koji Mori, Yoshiaki Kanemaru, Yoshitomo Maeda, Hiroya Yamaguchi, Masayoshi Nobukawa, Kumiko Nobukawa, Manabu Ishida, Yuichiro Ezoe

40. [Toward 3D orbits of wide sdO/B binaries I. Six composite systems spatially resolved with VLTI/GRAVITY](#user-content-link40)
**Authors:** K. Deshmukh, S. Geier, H. Sana, H. Dawson, M. Dorsch, A. J. Frost, U. Heber, T. Kupfer, A. Picco, M. Vu\v{c}kovi\'c

41. [Parametrized beyond-Teukolsky framework in the time domain](#user-content-link41)
**Authors:** Ciro De Simone, Sebastian H. V\"olkel, Kostas D. Kokkotas, Salvatore Capozziello

42. [Probing Parity Violation with Weak Lensing Trispectrum](#user-content-link42)
**Authors:** Sijin Chen, Zhengyangguang Gong, Jiamin Hou

43. [Syntriod: A Robust Initial Parameter Estimator for Radial Velocity Curve Solutions Beyond Conventional Sampling Limits](#user-content-link43)
**Authors:** Emre Barbaros, Hasan Ak, N. Filiz Ak

44. [Fast, accurate, and differentiable: a neural-network surrogate for NRSur7dq4 precessing binary black hole waveforms](#user-content-link44)
**Authors:** Michael P\"urrer, Ashwin Girish, Lucy M. Thomas, Scott E. Field, Vijay Varma

45. [Multiclass Classification without Labels via Posterior Simplex Geometry](#user-content-link45)
**Authors:** Rapha\"el Bonnet-Guerrini, Johann Ioannou-Nikolaides, Troels Petersen, Vincenzo Piuri

46. [TempLat: a versatile C++ engine for lattice field theories](#user-content-link46)
**Authors:** Adrien Florio, Franz R. Sattler

47. [QuickGWecc: Fast Bayesian pipeline for searching eccentric binaries in pulsar timing array data](#user-content-link47)
**Authors:** Lankeswar Dey, Bence B\'ecsy, Abhimanyu Susobhanan, Maria Charisi

48. [A Systematic Study of Quiescent and Outburst Properties of X-ray-bright Young Stellar Objects Using XMM-Newton](#user-content-link48)
**Authors:** Koki Sakuta, Ikuyuki Mitsuishi, Seiya Sasamata, Daigo Nonaka, Mai Yamashita, Shin Toriumi, Takato Tokuno, Yohko Tsuboi, Hiroshi Kobayashi

49. [The influence of dust destruction on gas cooling](#user-content-link49)
**Authors:** S. A. Drozdov, M. P. Yudkevich

50. [SN 2022xus: bridging the gap between Type IIP and IIL supernovae](#user-content-link50)
**Authors:** Monalisa Dubey, Kuntal Misra, Naveen Dukiya, Kumar Pranshu, Raya Dastidar, K. Azalee Bostroem, Yize Dong, Joseph R. Farah, Estefania Padilla Gonzalez, Emily Hoang, D. Andrew Howell, Curtis McCully, Megan Newsome, Craig Pellegrino, Aravind Pazhayath Ravi, Nicolas Meza Retamal, Ajay Kumar Singh, Giacomo Terreran, Stefano Valenti

51. [The Lunar Farside Transients and Technology Telescope (LFT3) Mission](#user-content-link51)
**Authors:** David R. DeBoer, Charlie K. Ashe, Owen A. Johnson, Evan F. Keane, Andrew C. Lesh, Richard Lynch, Ella J. Marshall, Steve Prabu, An\v{z}e Slosar, Chenoa D. Tremblay, Jake D. Turner, Karl F. Warnick, Andrew P. V. Siemion, Jamie Drew, S. Pete Worden

52. [Decay Length of Slow Magnetoacoustic Waves in the Solar Corona using SDO/AIA and SolO/EUI](#user-content-link52)
**Authors:** R. L. Meadowcroft, N. Narang, D. Berghmans, M. Dominique, V. M. Nakariakov

53. [Analytic backreaction of a scalar wig on a Schwarzschild black hole](#user-content-link53)
**Authors:** Marco de Cesare, Manuel Del Piano, Carlos A. R. Herdeiro

54. [High-Frequency Magnetohydrodynamic Waves with Substantial Energy in the Solar Polar Corona](#user-content-link54)
**Authors:** Yuhang Gao, Hui Tian, Richard Morton, Tom Van Doorsselaere, Daye Lim, Mingzhe Guo, Jiansen He, Zhenyong Hou

55. [Interlopers as Signal in Line Intensity Mapping](#user-content-link55)
**Authors:** Anirban Roy

56. [From compact jets to extended lobes: radio morphologies of distant quasars at z > 4](#user-content-link56)
**Authors:** K. \'E. Gab\'anyi, M. Kunert-Bajraszewska, A. Krauze, S. Frey, M. Krezinger, Z. Paragi, H. Cao, T. An, L. I. Gurvits, K. Perger, T. Sbarrato, K. Rozgonyi

57. [Tidal deformation of an accreting compact object](#user-content-link57)
**Authors:** Avijit Chowdhury, Chiranjeeb Singha, Kazuharu Bamba, Sumanta Chakraborty

58. [Probing long-range $L_e-L_\mu$ forces with supernova neutronization burst neutrinos](#user-content-link58)
**Authors:** Amol Dighe, Sadashiv Sahoo, Manibrata Sen

59. [Fast optical spectroscopic observations of PSR J1023+0038 over one orbital period](#user-content-link59)
...
60. [Tracing Obscured AGN Contribution and Number Fraction Across 0 < z < 6 with JWST](#user-content-link60)
**Authors:** Angel Rodriguez Barbosa (Institute of Astronomy, National Tsing Hua University), Tomotsugu Goto (Institute of Astronomy, National Tsing Hua University, Department of Physics, National Tsing Hua University), Daryl Joe D. Santos (Department of Physics, De La Salle University), Chih-Teng Ling (Department of Astronomical Science SOKENDAI), Tetsuya Hashimoto (Department of Physics, National Chung Hsing University), Ece Kilerci (Department of Astronomy and Space Sciences, Istanbul University), Priyanka Jalan (Institute of Astronomy, National Tsing Hua University), Terry Long Phan (Institute of Astronomy, National Tsing Hua University), Deriyan Senjaya (Department of Physics, National Tsing Hua University), Vignesh V. V. Rao (Department of Physics, National Chung Hsing University), Bahareh S. Salmasi (Institute of Astronomy, National Tsing Hua University)

61. [General Relativistic Entropic Acceleration at the perturbation level: a CLASS implementation and first Boltzmann-code constraints](#user-content-link61)
**Authors:** Simone D'Onofrio, Dong Ha Lee, Eleonora Di Valentino, Juan Garc\'ia-Bellido

62. [Minimally modified gravity with Laplacian auxiliary constraints and an inflationary realization](#user-content-link62)
**Authors:** Jakkrit Sangtawee, Antonio De Felice, Khamphee Karwan

63. [How massive and clumpy must a quasar wind be to create emission line blueshifts?](#user-content-link63)
**Authors:** James H. Matthews

64. [GRaTer-JAX: An Accelerated Package for Debris Disk Modeling](#user-content-link64)
**Authors:** Mihir Kondapalli, Briley L. Lewis, Jaren N. Ashcraft, Maxwell A. Millar-Blanchaer

65. [Neutrino-electron scattering kernels in isotropic media](#user-content-link65)
**Authors:** Jens Chluba, Bryce Cyr, Michiru Uwabo-Niibo, Masahide Yamaguchi

66. [Linking dynamics and chemistry in barred galaxies through action-space mapping](#user-content-link66)
**Authors:** Tetsuro Asano, Victor P. Debattista, Michiko S. Fujii

67. [Project Hephaistos -- III. Characterizing anomalous infrared sources identified as Dyson-sphere candidates](#user-content-link67)
**Authors:** Andreas J. Korn, Mat\'ias Suazo, Erik Zackrisson, P\'ia Cort\'es-Zuleta, Adam D. Rains, Armin Nabizadeh

68. [Fixing IR tail of gravitational waves from domain walls](#user-content-link68)
**Authors:** Ivan Dankovsky, Dmitry Gorbunov

69. [$\Lambda$XCDM: a running vacuum strategy for crossing the phantom divide](#user-content-link69)
**Authors:** Joan Sol\`a Peracaula, Adri\`a G\'omez-Valent, Alex Gonz\'alez-Fuentes

70. [Emergence and Detection of Electron-Scale Current Sheets in Turbulence with MMS Observations and fully kinetic 3D simulations](#user-content-link70)
**Authors:** Zachary Davis, Alexandros Chasepis, Colby Haggerty, Luca Comisso, Derek Sikorski

71. [Constraining the lives and times of exoplanets through evolutionary Bayesian retrievals](#user-content-link71)
**Authors:** Harrison Nicholls, Tim Lichtenberg, Ben Riegler, Robb Calder, Vincent Fortuin

72. [Long-Slit Spectroscopy Of Herbig-Haro Outflow System, Associated With IRAS 01166+6635](#user-content-link72)
**Authors:** T. A. Movsessian, T. Yu. Magakian, A. V. Moiseev

73. [Using Scattered Near-Infrared Light to Map Water Ice in Prestellar Cores with SPHEREx](#user-content-link73)
**Authors:** Tamojeet Roychowdhury, Jennifer B. Bergner, Jens Kauffmann, Thushara G. S. Pillai, Silvia Spezzano

74. [Pair luminosity and cooling of newborn strange star: Color-flavor-locked and two-flavor color superconducting quarks](#user-content-link74)
**Authors:** Mikalai Prakapenia, Cheng-Jun Xia, Gregory Vereshchagin

75. [KMT-2025-BLG-0975Lb and KMT-2025-BLG-1160Lb: Two Uranus-Mass Planets Beyond the Snow Line Discovered by Microlensing](#user-content-link75)
**Authors:** Cheongho Han, Chung-Uk Lee, Andrzej Udalski, Andrew Gould, Michael D. Albrow, Sun-Ju Chung, Youn Kil Jung, Kyu-Ha Hwang, Yoon-Hyun Ryu, Yossi Shvartzvald, In-Gu Shin, Jennifer C. Yee, Weicheng Zang, Hongjing Yang, Doeon Kim, Dong-Jin Kim, Byeong-Gon Park, Richard W. Pogge, Przemek Mr\'oz, Micha{\l} K. Szyma\'nski, Jan Skowron, Rados{\l}aw Poleskim Igor Soszy\'nski, Pawe{\l} Pietrukowicz, Szymon Koz{\l}owski, Krzysztof A. Rybicki, Patryk Iwanek, Krzysztof Ulaczyk, Marcin Wrona, Mariusz Gromadzki, Mateusz J. Mr\'oz

76. [JWST/MIRI Detection of Molecular H$_2$ Winds from an Edge-on Class II Source HV Tau C](#user-content-link76)
**Authors:** Vinod Chandra Pathak, P. Manoj, Himanshu Tyagi, B. Shridharan, Th. Henning, I. Kamp, A. Caratti o Garatti, B. Banerjee, Mayank Narang, E. F. van Dishoeck, Kamber Schwarz, Manuel G\"udel, Alice Somigliana, Giulia Perotti, Aditya M. Arabhavi, Sujay Vijay Jadhav, G\"oran Olofsson

77. [A radio view on Gamma-Loud Protostars: Derivation of jet mechanical luminosity](#user-content-link77)
**Authors:** Javier M\'endez-Gallego, Carlos Carrasco-Gonz\'alez, Rub\'en L\'opez-Coto, Iv\'an Agudo, Stefano Menchiari, Rub\'en Fedriani, Emma de O\~na Wilhelmi, Guillem Anglada

78. [Detection of HNCOH+ in the interestellar medium](#user-content-link78)
**Authors:** M. Rey-Montejo (Centro de Astrobiologia, Departamento de Fisica de la Tierra y Astrofisica, Facultad de Ciencias Fisicas, Universidad Complutense de Madrid, Spain), I. Jimenez-Serra (Centro de Astrobiologia), T. Millar (Astrophysics Research Centre, School of Mathematics and Physics, Queens University Belfast, UK), R. C. Fortenberry (Department of Chemistry & Biochemistry, University of Mississippi, University, USA), S. Viti (Leiden Observatory, Leiden University, the Netherlands, Physics and Astronomy, University College London, UK), J. Garcia de la Concepcion (Departamento de Quimica Organica e Inorganica, Facultad de Ciencias, and IACYS-Green Chemistry and Sustainable Development Unit, Universidad de Extremadura, Badajoz, Spain), G. Vermarien (Leiden Observatory, Leiden University, the Netherlands, SURF, Amsterdam, The Netherlands), M. Sanz-Novo (Center for Astrochemical Studies, Max-Planck-Institut fur extraterrestrische Physik, Germany), L. Colzi (Centro de Astrobiologia), S. Zeng (Star and Planet Formation Laboratory, RIKEN Pioneering Research Institute, Japan), V. M. Rivilla (Centro de Astrobiologia)

79. [No preference for generalized emergent dark energy from current cosmological data](#user-content-link79)
**Authors:** Vipin Kumar Sharma, Himanshu Chaudhary, Salvatore Capozziello, Dhruba Jyoti Gogoi, G. Mustafa

80. [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology II: Project Planning and Proposal Evaluation](#user-content-link80)
...
81. [A systematic assessment of the short-term X-ray behaviour of the $\gamma$ Cas analogues](#user-content-link81)
**Authors:** Robbie Webbe, Ya\"el Naz\'e, N. A. Webb

82. [Residual Galactic binary foreground in LISA stochastic gravitational-wave background inference: source power concentration and spectral degeneracy](#user-content-link82)
**Authors:** Ruo-Yu Guan, Yan Wang

83. [Gravitational Waves from Superconducting Cosmic Strings](#user-content-link83)
**Authors:** Jinyoung Jhun, Takashi Hiramatsu

84. [Automated Solar Radio Burst Detection Using Deep Learning on Augmented e-Callisto Data](#user-content-link84)
**Authors:** Vincenzo Timmel, Andr\'e Csillaghy, Christian Monstein

85. [Interferometric molecular line observations toward the 21 {\mu}m protoplanetary nebula IRAS 06530-0213](#user-content-link85)
**Authors:** Hao-Min Sun, Zhuang Zhang, Jun-Yang Liu, Sheng-Li Qin, Yong Zhang

86. [Unmasking (44) Nysa: Evidence for a trilobate structure](#user-content-link86)
**Authors:** Kate Minker, Anthony Berdeu, Gianluca Li Causi, Josef Hanu\v{s}, Micha\"el Marsset, Al Conrad, Fernando Pedichini, Simone Antoniucci, Piero Vaccari, Nick Moskovitz, Benoit Carry, Tom Polakis, Marin Ferrais, Emmanu\"el Jehin, Roberto Bonamico, Rhiannon Hicks, Daejhanae Smith, M. Amine Miftah, Ester Marini

87. [Nuclear matter equation of state and astrophysics](#user-content-link87)
**Authors:** Mateus Reinke Pelicer

88. [CNN-Based Reanalysis of Optical Turbulence at the Canary Islands Observatories (OCAN)](#user-content-link88)
**Authors:** Airam Salas, Bego\~na Garc\'ia-Lorenzo, Julio A. Castro-Almaz\'an, Gelys Trancho

89. [S301 and friends: Measuring the spin of Sgr A*](#user-content-link89)
**Authors:** T. Piran, P. Amaro-Seoane, B. Aytac, G. Bourdarot, A. Burkert, D. Calderon, J. Cuadra, F. Eisenhauer, R. Genzel, S. Gillessen, S. Joharle, F. Mang, T. Naab, T. Ott, H. B. Perets, D. C. Ribeiro, M. Sadun Bordoni, R. Sari

90. [GSpyNetTree-O4: an event validation tool used in the fourth LIGO-Virgo-KAGRA observing run](#user-content-link90)
**Authors:** Sofia Alvarez-Lopez, Man Leong Chan, Franz S. Herbst, Dhatri Raghunathan, Airene Ahuja, Annudesh Liyanage, Julian Ding, Alejandro Garcia-Varela, Raymond Ng, Jess McIver

91. [Compiling the largest multiwavelength database of known changing-look AGN: Prospects in the Rubin era](#user-content-link91)
**Authors:** Mariangella Camus (PUCV), Swayamtrupta Panda (NOIRLab)

92. [Simulation of combined radio and radar signals at the Radar Echo Telescope for Cosmic Rays](#user-content-link92)
...
93. [A Citizen Science Search for Compact Emission Line Nebulae](#user-content-link93)
**Authors:** Bringfried Stecklum, Peter Bresseler

94. [Herbig AeBe Star AS442A as a UXOR-type system](#user-content-link94)
**Authors:** Nariman Ismailov, Faida Surkhai Huseynova, Volkan Bak{\i}\c{s}, Namiq Serdar Dzhalilov, Sabahaddin Amanulla Alishov, Shafaq Kamal Ismayilova

95. [Distribution of the magnetic field relative to the plane of the Galaxy in the region of the Sagittarius spiral arm](#user-content-link95)
**Authors:** R. R. Andreasyan, H. R. Andreasyan, A. M. Mickaelian, A. G. Suqiasyan, G. M. Paronyan

96. [RAISE: A Low-Frequency Space-Based Payload for Solar Radio and RFI Measurements on the SMiLE Mission](#user-content-link96)
**Authors:** Sangeetha A, Harsha Avinash Tanti, Abhirup Datta, Anshu Kumari, Rajesh Bodade

97. [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology I: Literature Review](#user-content-link97)
**Authors:** Anamaria Hell, Kateryna Vovk, Veena Krishnaraj, Jia Liu, Kosuke Aizawa, Adrian E. Bayer, Linda Blot, Jessica Cowell, Suyog Garg, Jonathan Gr\'ee, Ben Horowitz, Masaya Ichikawa, Kanyuni Iemoto, Keigo Kondo, Zacharie Lorsin, Kevin McCarthy, Jamie Robinson, Miguel Ruiz-Granda, Leander Thiele, Ievgen Vovk, Mingshen Zhou

98. [From simulations to observations of cool plasma: What we can learn from synthetic spectra](#user-content-link98)
**Authors:** V. Jer\v{c}i\'{c}, T. A. Kucera, A. G. M. Pietrow, P. Antolin, J. M. Jenkins

99. [Understanding the Travel-time Asymmetry of Acoustic Waves in Sunspots With Time-distance Helioseismology](#user-content-link99)
**Authors:** Haiyu Li, Tob\'ias Felipe, Elena Khomenko, Hui Tian, Paul Rajaguru, Yuhang Gao

100. [Solar Wind Proton Heating and its Effect on Temperature Anisotropy Evolution between 0.05 and 1 au](#user-content-link100)
**Authors:** Etienne Berriot, Arnaud Zaslavsky, Olga Alexandrova, Pascal D\'emoulin, Petr Hellinger, Lorenzo Matteini

101. [Disk-averaged spectrum generation for spherically symmetric planets and moons](#user-content-link101)
**Authors:** Nicholas A. Teanby

102. [Timing and Spectral Analysis of the 2024 Outburst of 2S 1553$-$542 with NuSTAR and NICER](#user-content-link102)
**Authors:** Haifan Zhu, Wei Wang, Wen Yang, Mariano Mendez, Chenxu Gao, Ziyi Xu, Pengfu Tian

103. [Observational Tests of Sgr A*'s State of the Accretion Flow](#user-content-link103)
**Authors:** F. Yusef-Zadeh, R. G. Arendt, H. Bushouse, C. J. Chandler, D. Kunneriath, S. M. Ressler, M. Wardle

104. [Contribution of cosmic alphas to generation of albedo neutrons and gammas in lunar regolith: A computational study based on GEANT4 simulations](#user-content-link104)
**Authors:** Harshala Gaonkar, A. Ilker Topuz

105. [Exploring if a coronal dimming event can produce coronal hole-like properties](#user-content-link105)
**Authors:** Adriana De-Sassi, Louise Harra, Krzysztof Barczynski, David H. Brooks, Lakshmi Pradeep Chitta, Ioannis Kontogiannis, S\"am Krucker, Cristina H. Mandrini, Eric Priest, Alphonse C. Sterling, Yingjie Zhu

106. [Advancing X-Ray Camera Front-End Electronics Architecture through the AXIS-TAP Technology Platform](#user-content-link106)
...
107. [Geometry resolved atomic oxygen risk assessment for very low earth orbit spacecraft](#user-content-link107)
**Authors:** Gun Hi Won, Hyun Jung Kim, SongYi Park, ChangWon Seo, Eunji Lee, SeongSik Yoon

108. [Shear interaction and acceleration of a corotating stream detected by Parker Solar Probe](#user-content-link108)
**Authors:** Andrea Verdini, Simone Landi, Emanuele Papini, Luca Franci, Petr Hellinger, Roberto Livi, Orlando Romeo

---

## 1. [A Deep Look at the Ultra-Faint Milky Way Satellite Virgo III with Rubin Observatory Data Preview 2](https://arxiv.org/abs/2607.25044) <a id="link1"></a>
...
**Comment:** Analyzes the ultra-faint Milky Way satellite Virgo III using deep Rubin Observatory data. Directly relevant to near-field cosmology, satellite galaxy properties, and resolved stellar populations. Also includes star formation history and RR Lyrae analysis. Highly relevant and novel due to new deep data and improved constraints.
...
## 2. [Reaching the Metallicity Floor at $z\sim 10$: Lensed Star Clusters at Cosmic Dawn and Cosmic Noon](https://arxiv.org/abs/2607.24952) <a id="link2"></a>
...
**Comment:** This paper analyzes star cluster populations in strongly lensed galaxies at high redshift, including metallicity measurements and formation histories. It is highly relevant to 'Resolved Star Formation Histories' and 'Near-Field Cosmology', as it discusses star formation histories, metallicity floors, and comparisons to Milky Way globular clusters. It also touches on dwarf galaxy environments.
...
## 4. [Empirical H- and K-band Limb Darkening for 31 CHARA Stars: A Near-Infrared Benchmark for Stellar-Atmosphere Models](https://arxiv.org/abs/2607.24956) <a id="link4"></a>
...
**Comment:** This paper presents empirical limb-darkening measurements in the near-infrared for 31 stars, providing a benchmark for stellar-atmosphere models. This directly matches the 'Stellar Models' criterion, as it tests and compares stellar atmosphere models and provides new empirical constraints.
...
## 5. [CHORD HI-Galaxy Survey Forecasts: Searching for nearby dark galaxies and high redshift giants](https://arxiv.org/abs/2607.24903) <a id="link5"></a>
...
**Comment:** This paper forecasts HI galaxy detections with CHORD, focusing on expanding the census of low-mass HI galaxies (down to ~10^5.5 Msun). This directly matches the 'Near-Field Cosmology' criterion, as it pertains to the abundance and properties of gas-rich dwarf galaxies. The work is observational and will significantly improve the low-mass galaxy census, which is highly relevant.
...
## 6. [A Test of FeH Line Parameters using DR19 APOGEE spectra of Benchmark M Dwarfs](https://arxiv.org/abs/2607.24948) <a id="link6"></a>
...
**Comment:** This paper presents a test of FeH line parameters using APOGEE spectra of M dwarfs, focusing on stellar atmosphere models and metallicity measurements. It directly matches the 'Stellar Models' criterion, as it evaluates and validates spectral line lists and model atmospheres for M dwarfs, which are relevant for stellar evolutionary and atmosphere modeling.
...
## 7. [Tightening Bounds on Warm Dark Matter with High-Redshift Gamma-Ray Bursts](https://arxiv.org/abs/2607.25261) <a id="link7"></a>
...
**Comment:** This paper uses high-redshift gamma-ray bursts to constrain warm dark matter models, focusing on small-scale structure formation. The topic is relevant to near-field cosmology, specifically the abundance and formation of small-scale structures, which is a core criterion. The use of GRBs as probes is novel.
...
## 8. [Investigating the Observational Progenitor Mass Gap in the White Dwarf Initial-Final Mass Relation. I. Cluster Census and Characterization of the First White Dwarfs in the Gap](https://arxiv.org/abs/2607.24941) <a id="link8"></a>
...
**Comment:** Investigates the white dwarf initial-final mass relation and progenitor mass gap using cluster census and spectroscopy. This is relevant to stellar models, specifically evolutionary tracks and mass loss, and provides new observational constraints. High relevance for stellar models.
...
## 9. [Magnetic pressure anisotropy in ultra-dense white dwarfs: Landau quantization and neutronization effects](https://arxiv.org/abs/2607.25104) <a id="link9"></a>
...
**Comment:** This paper investigates the effects of strong magnetic fields on the structure of ultra-dense white dwarfs, including stellar models and mass-radius relations. It fits the 'Stellar Models' criterion, as it presents new theoretical models for stellar interiors and atmospheres, and discusses observational implications.
...
## 10. [The $\sigma_s^2-\mathcal{M}$ relation in the multi-phase ISM: Exploring the density PDF with the Cloud Factory simulations](https://arxiv.org/abs/2607.24977) <a id="link10"></a>
...
**Comment:** This paper analyzes the density PDF in the multi-phase ISM using high-resolution galaxy simulations (Cloud Factory). It directly matches the 'Numerical Galaxy Simulations' criterion, and also touches on ISM phase structure relevant to star formation and outflows.
...
## 11. [The IMF package: a toolkit implementing mass functions and statistical tools to analyze them](https://arxiv.org/abs/2607.26007) <a id="link11"></a>
...
**Comment:** Presents a Python package for mass functions, including the stellar initial mass function (IMF). This is directly relevant to the 'Stellar Models' criterion, as IMF is foundational for stellar population modeling.
...
## 12. [Binary-induced mass increase and helium enrichment of the envelopes of Type~IIP supernova progenitors](https://arxiv.org/abs/2607.25849) <a id="link12"></a>
...
**Comment:** This paper uses binary population synthesis to study the impact of binary-induced mergers on Type IIP supernova progenitors, including envelope mass and helium enrichment. It presents new stellar models and discusses the effects of binary evolution on stellar populations, directly matching the 'Stellar Models' criterion. The focus on progenitor properties and envelope enrichment is highly relevant.
...
## 13. [Observational Evidence for Anisotropic Metal Excess around Galaxies](https://arxiv.org/abs/2607.24929) <a id="link13"></a>
...
**Comment:** Observational evidence for anisotropic metal excess around galaxies, interpreted as enrichment via galactic outflows. Relevant to star formation driven outflows and circumgalactic medium, though focus is on massive galaxies rather than dwarfs. Solid relevance due to connection to feedback and CGM.
...
## 15. [From Starburst to Quenching: Physical Properties of Extremely Compact Starbursts at z$\sim$0.1](https://arxiv.org/abs/2607.25290) <a id="link15"></a>
...
**Comment:** This paper investigates extremely compact starburst galaxies at z~0.1, focusing on their rapid evolution toward quiescence and molecular gas properties. It discusses star formation quenching, but in massive galaxies, not dwarfs. Some relevance for quenching, but weighted lower due to galaxy mass.
...
## 16. [The evolution of galaxy dust scaling relations in the COLIBRE simulations](https://arxiv.org/abs/2607.26058) <a id="link16"></a>
...
**Comment:** This paper presents results from the COLIBRE cosmological simulations, focusing on dust scaling relations in galaxies across cosmic time. It discusses dust mass functions, dust-to-gas ratios, and ISM physics, but does not specifically focus on dwarf galaxies, satellite galaxies, resolved star formation histories, quenching, or outflows. The work is relevant to numerical galaxy simulations, but the main focus is on dust and ISM properties rather than the core topics. The simulation aspect is a borderline match.
...
## 17. [HI Depletion Begins Well Beyond the Virial Radius: A FAST Stacking Study of 36 Galaxy Clusters to 5R200](https://arxiv.org/abs/2607.25800) <a id="link17"></a>
...
**Comment:** This paper studies HI depletion and environmental quenching in galaxies within and around clusters, focusing on gas stripping and pre-processing effects. While the main focus is on galaxies in clusters (not dwarfs or satellites of the Milky Way), the topic of star formation quenching and environmental effects is relevant, though weighted lower since it is not specifically about dwarf galaxies. The paper provides direct evidence for environmental quenching via gas depletion, which matches the 'Star Formation Quenching' criterion, but not at the highest relevance.
...
## 18. [Cosmological evolution with decaying dark matter: an integral-equation approach](https://arxiv.org/abs/2607.24910) <a id="link18"></a>
...
**Comment:** This paper presents a new numerical implementation for modeling decaying dark matter and its impact on cosmological observables. While it is a numerical simulation and discusses cosmological evolution, it does not focus on galaxies, their star formation histories, or near-field cosmology. The relevance is borderline as it may have indirect implications for galaxy formation, but is not directly aligned with the core topics.
...
## 19. [Primordial Physics in the Nonlinear Universe: Revealing the oscillating halo bias from cosmological collider models](https://arxiv.org/abs/2607.24939) <a id="link19"></a>
...
**Comment:** The paper presents new simulations of cosmological collider models and their impact on halo bias. While it deals with halo bias and simulations, the focus is on primordial physics and large-scale structure, not on galaxy-scale simulations, dwarf galaxies, or near-field cosmology. The relevance is borderline due to the simulation aspect.
...
## 20. [Gravitational Wave Modeling of White-Dwarf--Compact-Object Binaries and Observational Outlook](https://arxiv.org/abs/2607.24951) <a id="link20"></a>
...
**Comment:** The paper models gravitational waves from white-dwarf--compact-object binaries and discusses their detectability. It presents new numerical models for binary evolution, but does not focus on galaxy simulations or the core topics. The relevance is borderline due to the modeling aspect.
...
## 21. [Anisotropic Secondary Bias of Dark Matter Haloes in a $\Lambda$CDM Universe](https://arxiv.org/abs/2607.26009) <a id="link21"></a>
...
**Comment:** Analyzes dark matter halo clustering and secondary bias in a cosmological simulation. While it discusses halo properties and environment, it does not focus on satellite galaxies, resolved star formation histories, or galaxy-scale simulations relevant to the prompt. Borderline relevance due to connection to substructure and halo properties.
...
## 22. [Progenitor models of supernovae interacting with their binary companions](https://arxiv.org/abs/2607.25837) <a id="link22"></a>
...
**Comment:** Focuses on progenitor models of supernovae interacting with binary companions, using stellar evolution models. While it discusses binary evolution and supernovae, it is only borderline relevant to stellar models and not directly to the core topics (no focus on galaxy simulations or dwarf galaxies).
...
## 23. [Low-Metallicity Star Formation Survey in Sh2-284 (LZ-STAR): The Core Mass Function](https://arxiv.org/abs/2607.25753) <a id="link23"></a>
...
**Comment:** ALMA study of the dense core mass function in a low-metallicity star-forming complex in the outer Galaxy. While it addresses star formation and the initial mass function, it does not focus on resolved star formation histories from color-magnitude diagrams or dwarf galaxies. Borderline relevance due to connection to star formation in low-metallicity environments.
...
## 24. [Ly$\alpha$ Escape in JWST/NIRCam F430M-Selected H$\alpha$ Emitters at $z\simeq5.5$](https://arxiv.org/abs/2607.25801) <a id="link24"></a>

**ArXiv ID:** 2607.25801

**Authors:** Cheng Cheng, Zhen-Ya Zheng, Chunyan Jiang, Fengwu Sun, Edo Ibar, Xin Wang, Haojing Yan, Fang-Ting Yuan, Jia-Sheng Huang, Juan Molina, Malte Brinch

**Abstract:** We study the Ly$\alpha$ escape fraction ($f_{\rm esc}$) in an H$\alpha$-selected sample of star-forming galaxies at $z\simeq5.5$, identified via JWST/NIRCam F430M excess and covered by archival VLT/MUSE data. By anchoring the intrinsic Ly$\alpha$ production to H$\alpha$ emission, our approach provides a direct and Ly$\alpha$-unbiased probe of the escape of Ly$\alpha$ photons in galaxies with SFR $\gtrsim 0.1\,M_\odot\,{\rm yr^{-1}}$ at this epoch. Ly$\alpha$ emission is detected in 3 out of 12 galaxies covered by VLT/MUSE. Combining detections and upper limits, we place a conservative upper bound of $\langle f_{\rm esc}^{\rm Ly\alpha} \rangle < 0.32$ on the population-averaged Ly$\alpha$ escape fraction. We find that Ly$\alpha$ detections are preferentially associated with nearly dust-free systems, while no clear correlation between SFR and $f_{\rm esc}$, suggesting a stochastic picture of Ly$\alpha$ escape. Interestingly, three of the four Ly$\alpha$-detected galaxies reside within a known overdense structure, suggesting that local environment may further facilitate Ly$\alpha$ photons escape. Our H$\alpha$-selected approach establishes a general and scalable framework for probing Ly$\alpha$ escape by combining JWST medium- or narrow-band imaging with ground-based spectroscopic data, enabling systematic and less biased studies of Ly$\alpha$ visibility in typical star-forming galaxies during the post-reionization era.

**Comment:** Studies Lyα escape fraction in star-forming galaxies at z~5.5, focusing on Hα-selected galaxies. While it deals with star formation and outflows, the galaxies are not specified as dwarfs and the focus is high-redshift. Borderline relevance for star formation driven outflows and resolved star formation histories.
...
## 26. [A new look at old devils. II: New insights on classical radio galaxies from MeerKAT and uGMRT](https://arxiv.org/abs/2607.25867) <a id="link26"></a>
...
**Comment:** Analyzes radio galaxies with MeerKAT and uGMRT, focusing on jet, lobe, and hotspot structures and their evolution. While it discusses galaxy evolution, the focus is on massive radio galaxies, not dwarfs or near-field cosmology. Borderline relevance for galaxy evolution, but not a direct match.
...
## 27. [SKAO-ALMA Synergies in Star Formation Science](https://arxiv.org/abs/2607.25721) <a id="link27"></a>
...
**Comment:** The paper discusses synergies between SKA and ALMA for star formation science, including time-domain studies, molecular tracers, and radio recombination lines. While it addresses star formation, it does not focus on resolved star formation histories from color-magnitude diagrams or galaxy-scale simulations. The relevance is borderline.
...
## 28. [Radiation-Driven Evolution and Gas Kinematics of the Bright-Rimmed Cloud SFO 25](https://arxiv.org/abs/2607.25083) <a id="link28"></a>
...
**Comment:** This paper investigates the kinematics and evolution of a bright-rimmed molecular cloud (SFO 25) and the influence of ionizing radiation on star formation. While it discusses star formation and triggered activity, it does not focus on resolved star formation histories from color-magnitude diagrams, dwarf galaxies, or galaxy-scale processes. The relevance is borderline due to the discussion of star formation and feedback, but it is not directly aligned with the core topics.
...
## 29. [Localized magnetic pressure anisotropy in strange dwarfs with crystalline crusts](https://arxiv.org/abs/2607.25055) <a id="link29"></a>
...
**Comment:** This paper studies magnetized strange dwarfs with crystalline crusts, focusing on mass-radius relations and magnetic pressure anisotropy. While it deals with compact objects and white dwarfs, it does not address satellite galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is borderline, as it may have implications for stellar models but is not directly focused on them.
...
## 30. [V407 Vul: a triple star system with an AM CVn detectable by gravitational wave observatories](https://arxiv.org/abs/2607.25557) <a id="link30"></a>
...
**Comment:** This paper confirms the triple nature of V407 Vul, an AM CVn system, and discusses its detectability by gravitational wave observatories. While it involves white dwarfs and binary evolution, it does not present new stellar models or address galaxy-scale topics.
...
## 31. [Correlated signals of ultralight scalar dark matter in pulsar timing](https://arxiv.org/abs/2607.24912) <a id="link31"></a>
...
**Comment:** This paper discusses pulsar timing arrays and their sensitivity to ultralight scalar dark matter. While it is relevant to dark matter detection, it does not focus on near-field cosmology, satellite galaxies, or galaxy-scale substructure, but rather on fundamental physics and cosmology.
...
## 32. [Chemistry of Dark Molecular Clouds](https://arxiv.org/abs/2607.25515) <a id="link32"></a>
...
**Comment:** The paper discusses the chemistry of dark molecular clouds, including molecular inventories and formation pathways. While it touches on star formation processes and the ISM, it does not directly address resolved star formation histories, quenching, or galaxy simulations. The focus is on molecular cloud chemistry rather than galaxy-scale processes.
...
## 33. [Simulation-based tension quantification of the cosmic dipole](https://arxiv.org/abs/2607.25703) <a id="link33"></a>
...
**Comment:** The paper presents a simulation-based method for quantifying tension in the cosmic dipole, comparing observations to expectations from cosmological models. While it is relevant to cosmology, it does not address near-field cosmology, galaxy simulations, or any of the core topics related to dwarf galaxies or star formation histories.
...
## 34. [Weighted Webs: Morphology-Informed Marked Fields](https://arxiv.org/abs/2607.26021) <a id="link34"></a>
...
**Comment:** Explores marked statistics for the cosmic web, focusing on morphology-based marks and their impact on cosmological parameter inference. While it deals with large-scale structure and cosmic web morphology, it does not directly address galaxy simulations, dwarf galaxies, or any core criteria.
...
## 35. [High-energy neutrino emission from the Milky Way](https://arxiv.org/abs/2607.25966) <a id="link35"></a>
...
**Comment:** This paper analyzes high-energy neutrino emission from the Milky Way using IceCube data. The focus is on cosmic ray acceleration and neutrino production in the Galactic plane and inner Galaxy, which is not directly related to near-field cosmology, satellite galaxies, resolved star formation histories, quenching, or galaxy simulations.
...
## 36. [Vigorous turbulence driven by quasar-mode feedback in a cluster core](https://arxiv.org/abs/2607.24911) <a id="link36"></a>
...
**Comment:** This paper studies turbulence driven by quasar-mode feedback in a galaxy cluster core, focusing on AGN-driven feedback and its impact on the intracluster medium. It does not match any of the core criteria, as it is not about star-formation-driven outflows, dwarf galaxies, or galaxy simulations.
...
## 37. [LiteBIRD Mission Overview after Mission Reformation](https://arxiv.org/abs/2607.25285) <a id="link37"></a>
...
**Comment:** LiteBIRD is a mission overview paper focused on CMB polarization and inflationary science. While it mentions broad astrophysical applications, it does not directly address near-field cosmology, resolved star formation histories, dwarf galaxies, galaxy simulations, or stellar models. The relevance to the core topics is low.
...
## 38. [The afterglow of gamma-ray burst - supernova connections](https://arxiv.org/abs/2607.25476) <a id="link38"></a>
...
**Comment:** The paper provides an analytical framework for the afterglow of gamma-ray burst-supernova connections, focusing on the link between relativistic jets and SN ejecta. It does not address any of the core topics such as galaxy simulations, star formation histories, or dwarf galaxies.
...
## 39. [Progenitor and Explosion Mechanism of 3C 397 Indicated from XRISM High-resolution Spectroscopy of Fe-group Elements](https://arxiv.org/abs/2607.25575) <a id="link39"></a>
...
**Comment:** Presents spatially resolved X-ray spectroscopy of a Type Ia supernova remnant, focusing on nucleosynthesis and explosion mechanisms. No direct connection to stellar models as defined in the prompt (tracks/atmospheres), nor to galaxy simulations or near-field cosmology.
...
## 40. [Toward 3D orbits of wide sdO/B binaries I. Six composite systems spatially resolved with VLTI/GRAVITY](https://arxiv.org/abs/2607.25741) <a id="link40"></a>
...
**Comment:** This paper focuses on wide sdO/B binaries and their 3D orbits, which relates to stellar evolution and binary interaction products. However, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, or numerical galaxy simulations. The focus is on binary evolution and mass transfer, which is outside the main scope.
...
## 41. [Parametrized beyond-Teukolsky framework in the time domain](https://arxiv.org/abs/2607.25311) <a id="link41"></a>
...
**Comment:** This paper presents a time-domain framework for testing deviations from General Relativity in black-hole perturbation theory. It is focused on black hole physics and does not address any of the core topics.
...
## 42. [Probing Parity Violation with Weak Lensing Trispectrum](https://arxiv.org/abs/2607.26046) <a id="link42"></a>
...
**Comment:** Probes parity violation in cosmology using weak lensing trispectrum. Focus is on fundamental symmetries and large-scale structure, not galaxy-scale processes or near-field cosmology. Irrelevant to core topics.
...
## 43. [Syntriod: A Robust Initial Parameter Estimator for Radial Velocity Curve Solutions Beyond Conventional Sampling Limits](https://arxiv.org/abs/2607.24926) <a id="link43"></a>
...
**Comment:** Presents a new algorithm for initial parameter estimation in radial velocity curve solutions for spectroscopic binaries. While it is a methodological advance, it does not relate to stellar models, galaxy simulations, or the other core topics.
...
## 44. [Fast, accurate, and differentiable: a neural-network surrogate for NRSur7dq4 precessing binary black hole waveforms](https://arxiv.org/abs/2607.24960) <a id="link44"></a>
...
**Comment:** The paper introduces a neural network surrogate for gravitational waveforms from precessing binary black hole mergers. The focus is on compact object mergers and waveform modeling, not on galaxy-scale simulations or any of the core criteria.
...
## 45. [Multiclass Classification without Labels via Posterior Simplex Geometry](https://arxiv.org/abs/2607.24943) <a id="link45"></a>
...
**Comment:** Presents a method for multiclass classification without labels, with applications to datasets including Galaxy10 DECaLS. The method is general and not specific to galaxy simulations or any core astrophysical criteria.
...
## 46. [TempLat: a versatile C++ engine for lattice field theories](https://arxiv.org/abs/2607.24908) <a id="link46"></a>
...
**Comment:** Presents a C++ framework for lattice field theory simulations, not galaxy simulations or any other relevant astrophysical criteria.
...
## 47. [QuickGWecc: Fast Bayesian pipeline for searching eccentric binaries in pulsar timing array data](https://arxiv.org/abs/2607.26051) <a id="link47"></a>
...
**Comment:** This paper focuses on pulsar timing arrays and searches for gravitational waves from supermassive black hole binaries. The topic is not related to near-field cosmology, resolved star formation histories, dwarf galaxies, galaxy simulations, or stellar models. The focus is on SMBHBs and gravitational wave detection, which is outside the core topics.
...
## 48. [A Systematic Study of Quiescent and Outburst Properties of X-ray-bright Young Stellar Objects Using XMM-Newton](https://arxiv.org/abs/2607.25384) <a id="link48"></a>
...
**Comment:** This paper studies X-ray emission mechanisms in young stellar objects (YSOs), focusing on quiescent and outburst phases. While it discusses stellar activity and accretion, it does not directly address resolved star formation histories, stellar models, or galaxy-scale processes. The focus is on individual stars, not galaxies or their satellites.
...
## 49. [The influence of dust destruction on gas cooling](https://arxiv.org/abs/2607.25934) <a id="link49"></a>
...
**Comment:** Examines dust destruction and gas cooling in the ISM, but does not focus on galaxies, star formation histories, or outflows. No direct match to any relevant criteria.
...
## 50. [SN 2022xus: bridging the gap between Type IIP and IIL supernovae](https://arxiv.org/abs/2607.25323) <a id="link50"></a>
...
**Comment:** Observational study of a Type II supernova, focusing on progenitor mass and classification. No direct match to any relevant criteria (not about galaxy evolution, star formation histories, or stellar models).
...
## 51. [The Lunar Farside Transients and Technology Telescope (LFT3) Mission](https://arxiv.org/abs/2607.25762) <a id="link51"></a>
...
**Comment:** This paper describes a lunar radio telescope mission and its science goals, including cosmological observations. However, it does not focus on any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The main focus is on instrumentation and general radio astronomy.
...
## 52. [Decay Length of Slow Magnetoacoustic Waves in the Solar Corona using SDO/AIA and SolO/EUI](https://arxiv.org/abs/2607.25509) <a id="link52"></a>
...
**Comment:** The paper studies slow magnetoacoustic waves in the solar corona, focusing on decay lengths and observational effects. It does not address any of the core topics such as galaxy simulations, star formation, or dwarf galaxies.
...
## 53. [Analytic backreaction of a scalar wig on a Schwarzschild black hole](https://arxiv.org/abs/2607.25932) <a id="link53"></a>
...
**Comment:** This paper analytically studies the backreaction of a scalar field on a Schwarzschild black hole. It is focused on black hole physics and does not address any of the core topics such as galaxy simulations, star formation, or dwarf galaxies.
...
## 54. [High-Frequency Magnetohydrodynamic Waves with Substantial Energy in the Solar Polar Corona](https://arxiv.org/abs/2607.25799) <a id="link54"></a>
...
**Comment:** The paper identifies high-frequency MHD waves in the solar polar corona and their role in solar wind acceleration. It does not address any of the core topics such as galaxy simulations, star formation, or dwarf galaxies.
...
## 55. [Interlopers as Signal in Line Intensity Mapping](https://arxiv.org/abs/2607.24917) <a id="link55"></a>
...
**Comment:** The paper discusses line intensity mapping and the treatment of interlopers as signal, focusing on cosmological measurements and large-scale structure. No direct connection to near-field cosmology, resolved star formation histories, or galaxy simulations. Irrelevant to core topics.
...
## 56. [From compact jets to extended lobes: radio morphologies of distant quasars at z > 4](https://arxiv.org/abs/2607.25378) <a id="link56"></a>
...
**Comment:** Studies radio morphologies of distant quasars (z>4), focusing on AGN jets and lobes. No connection to dwarf galaxies, near-field cosmology, or galaxy simulations. Irrelevant to core topics.
...
## 57. [Tidal deformation of an accreting compact object](https://arxiv.org/abs/2607.24938) <a id="link57"></a>
...
**Comment:** This paper studies tidal deformation of accreting compact objects, focusing on environmental effects on tidal signatures. The topic is compact object physics, not galaxy-scale processes or any of the core criteria.
...
## 58. [Probing long-range $L_e-L_\mu$ forces with supernova neutronization burst neutrinos](https://arxiv.org/abs/2607.24918) <a id="link58"></a>
...
**Comment:** The paper investigates long-range leptonic forces using supernova neutrinos, focusing on neutrino flavor evolution and detection. The topic is particle astrophysics and neutrino physics, not galaxy-scale processes or any of the core criteria.
...
## 59. [Fast optical spectroscopic observations of PSR J1023+0038 over one orbital period](https://arxiv.org/abs/2607.25544) <a id="link59"></a>
...
**Comment:** Fast optical spectroscopic observations of a transitional millisecond pulsar, focusing on accretion and outflow processes in a binary system. Not relevant to the core topics (no connection to galaxy-scale outflows, star formation, or stellar models).
...
## 61. [General Relativistic Entropic Acceleration at the perturbation level: a CLASS implementation and first Boltzmann-code constraints](https://arxiv.org/abs/2607.25841) <a id="link61"></a>
...
**Comment:** Presents a cosmological model for late-time acceleration and its implementation in Boltzmann codes. Focus is on cosmological background and perturbations, not on galaxy-scale phenomena, dwarf galaxies, or near-field cosmology.
...
## 62. [Minimally modified gravity with Laplacian auxiliary constraints and an inflationary realization](https://arxiv.org/abs/2607.26031) <a id="link62"></a>
...
**Comment:** Develops a minimally modified gravity theory and studies its cosmological perturbations and inflationary realization. No direct connection to galaxy simulations, star formation, or near-field cosmology.
...
## 63. [How massive and clumpy must a quasar wind be to create emission line blueshifts?](https://arxiv.org/abs/2607.25035) <a id="link63"></a>
...
**Comment:** The paper studies quasar winds and their role in emission line blueshifts, focusing on massive galaxies (quasars) and AGN-driven feedback. AGN-driven outflows are explicitly listed as irrelevant unless star-formation-driven outflows are discussed, which is not the case here.
...
## 64. [GRaTer-JAX: An Accelerated Package for Debris Disk Modeling](https://arxiv.org/abs/2607.25342) <a id="link64"></a>
...
**Comment:** This is a software package for modeling debris disks around stars, which is not directly related to galaxy-scale processes, star formation histories, or any of the core topics.
...
## 65. [Neutrino-electron scattering kernels in isotropic media](https://arxiv.org/abs/2607.25436) <a id="link65"></a>
...
**Comment:** The paper derives neutrino-electron scattering kernels relevant for early universe physics and Big Bang Nucleosynthesis, but does not address galaxy-scale processes or any of the core topics.
...
## 66. [Linking dynamics and chemistry in barred galaxies through action-space mapping](https://arxiv.org/abs/2607.25052) <a id="link66"></a>
...
**Comment:** Focuses on barred galaxies, specifically the Milky Way bulge and bar. This is explicitly listed as irrelevant under the Near-Field Cosmology criteria. No other criteria are matched.
...
## 67. [Project Hephaistos -- III. Characterizing anomalous infrared sources identified as Dyson-sphere candidates](https://arxiv.org/abs/2607.25701) <a id="link67"></a>
...
**Comment:** Characterizes infrared sources as potential Dyson-sphere candidates, focusing on M dwarfs. No direct match to any relevant criteria (not about galaxy evolution, star formation histories, or stellar models).
...
## 68. [Fixing IR tail of gravitational waves from domain walls](https://arxiv.org/abs/2607.25073) <a id="link68"></a>
...
**Comment:** This paper discusses numerical simulations of gravitational wave production from domain walls in the early Universe and proposes a method to correct nonphysical features in the simulated spectra. While it involves numerical simulations, it does not focus on galaxies or any of the core topics such as near-field cosmology, star formation histories, or galaxy outflows. It is largely unrelated to the specified criteria.
...
## 69. [$\Lambda$XCDM: a running vacuum strategy for crossing the phantom divide](https://arxiv.org/abs/2607.26050) <a id="link69"></a>
...
**Comment:** This paper discusses a composite dynamical dark energy model and its fit to cosmological data, focusing on the phantom divide and cosmic coincidence problem. It does not match any of the core criteria (no focus on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 70. [Emergence and Detection of Electron-Scale Current Sheets in Turbulence with MMS Observations and fully kinetic 3D simulations](https://arxiv.org/abs/2607.25113) <a id="link70"></a>
...
**Comment:** Examines electron-scale current sheets in solar wind turbulence using simulations and MMS observations. Focus is on plasma physics and turbulence, not galaxy evolution or star formation. Not relevant to core topics.
...
## 71. [Constraining the lives and times of exoplanets through evolutionary Bayesian retrievals](https://arxiv.org/abs/2607.25845) <a id="link71"></a>
...
**Comment:** The paper presents a Bayesian retrieval framework for exoplanet evolutionary histories. While it is novel for exoplanet science, it does not match any of the core topics (near-field cosmology, galaxy simulations, etc.).
...
## 72. [Long-Slit Spectroscopy Of Herbig-Haro Outflow System, Associated With IRAS 01166+6635](https://arxiv.org/abs/2607.26033) <a id="link72"></a>
...
**Comment:** This paper studies Herbig-Haro outflows associated with a young stellar object, focusing on electron densities and outflow structure. While it discusses star-formation-driven outflows, it is not in the context of galaxy-scale outflows or dwarf galaxies, and is more about protostellar jets. No direct match to the core criteria.
...
## 73. [Using Scattered Near-Infrared Light to Map Water Ice in Prestellar Cores with SPHEREx](https://arxiv.org/abs/2607.24934) <a id="link73"></a>
...
**Comment:** The paper uses SPHEREx to map water ice in prestellar cores, focusing on molecular cloud chemistry and planet formation. No direct connection to galaxy-scale star formation histories, quenching, or outflows. Not relevant to the core topics.
...
## 74. [Pair luminosity and cooling of newborn strange star: Color-flavor-locked and two-flavor color superconducting quarks](https://arxiv.org/abs/2607.25766) <a id="link74"></a>
...
**Comment:** This paper studies the cooling and pair luminosity of newborn strange stars, focusing on quark matter phases. The topic is stellar evolution and compact objects, not galaxy-scale processes or any of the core criteria.
...
## 75. [KMT-2025-BLG-0975Lb and KMT-2025-BLG-1160Lb: Two Uranus-Mass Planets Beyond the Snow Line Discovered by Microlensing](https://arxiv.org/abs/2607.25259) <a id="link75"></a>
...
**Comment:** This paper presents the discovery of two Uranus-mass planets via microlensing, focusing on planetary systems around low-mass stars. The work is not related to galaxy-scale processes, resolved star formation histories, or near-field cosmology.
...
## 76. [JWST/MIRI Detection of Molecular H$_2$ Winds from an Edge-on Class II Source HV Tau C](https://arxiv.org/abs/2607.25770) <a id="link76"></a>
...
**Comment:** Studies molecular H2 winds in a protoplanetary disk (Class II source). While it discusses outflows, these are not galaxy-scale and are not driven by star formation in galaxies, but rather by disk processes. No direct match to any core criteria.
...
## 77. [A radio view on Gamma-Loud Protostars: Derivation of jet mechanical luminosity](https://arxiv.org/abs/2607.24969) <a id="link77"></a>
...
**Comment:** This paper focuses on protostellar jets and their mechanical luminosity, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy-scale outflows. The focus is on individual protostars rather than galaxies or their satellites.
...
## 78. [Detection of HNCOH+ in the interestellar medium](https://arxiv.org/abs/2607.25758) <a id="link78"></a>
...
**Comment:** This paper reports the detection of HNCOH+ in the interstellar medium and discusses the chemistry of metal sulphides. The focus is on astrochemistry and molecular clouds, not on galaxy-scale processes or any of the core topics.
...
## 80. [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology II: Project Planning and Proposal Evaluation](https://arxiv.org/abs/2607.25881) <a id="link80"></a>
...
**Comment:** This paper discusses the use of AI in scientific project planning and proposal evaluation in physics, astrophysics, and cosmology. It does not address any of the specific core topics such as near-field cosmology, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 82. [Residual Galactic binary foreground in LISA stochastic gravitational-wave background inference: source power concentration and spectral degeneracy](https://arxiv.org/abs/2607.25349) <a id="link82"></a>
...
**Comment:** The paper analyzes the residual galactic binary foreground in LISA gravitational-wave background inference. It is focused on gravitational wave data analysis and compact binaries, which is unrelated to the core topics such as near-field cosmology, star formation histories, quenching, or galaxy simulations.
...
## 83. [Gravitational Waves from Superconducting Cosmic Strings](https://arxiv.org/abs/2607.25317) <a id="link83"></a>
...
**Comment:** Studies gravitational waves from superconducting cosmic strings using field-theoretic simulations. No connection to galaxy simulations, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 84. [Automated Solar Radio Burst Detection Using Deep Learning on Augmented e-Callisto Data](https://arxiv.org/abs/2607.26014) <a id="link84"></a>
...
**Comment:** Paper is about solar radio burst detection using deep learning, which is not relevant to any of the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 86. [Unmasking (44) Nysa: Evidence for a trilobate structure](https://arxiv.org/abs/2607.25786) <a id="link86"></a>
...
**Comment:** Study of asteroid (44) Nysa's morphology and satellite using adaptive optics. Not relevant to any of the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 87. [Nuclear matter equation of state and astrophysics](https://arxiv.org/abs/2607.25854) <a id="link87"></a>
...
**Comment:** Reviews the nuclear matter equation of state and its astrophysical implications, focusing on neutron stars and heavy-ion collisions. No direct connection to galaxy simulations, star formation, or near-field cosmology.
...
## 88. [CNN-Based Reanalysis of Optical Turbulence at the Canary Islands Observatories (OCAN)](https://arxiv.org/abs/2607.25940) <a id="link88"></a>
...
**Comment:** This paper presents a deep-learning reanalysis of atmospheric turbulence at observatories, which is not related to any of the core astrophysical topics (galaxy evolution, star formation, etc.).
...
## 89. [S301 and friends: Measuring the spin of Sgr A*](https://arxiv.org/abs/2607.24931) <a id="link89"></a>
...
**Comment:** The paper focuses on measuring the spin of Sgr A* using stellar orbits near the Galactic center. The criteria explicitly list Galactic center studies as irrelevant.
...
## 90. [GSpyNetTree-O4: an event validation tool used in the fourth LIGO-Virgo-KAGRA observing run](https://arxiv.org/abs/2607.25208) <a id="link90"></a>
...
**Comment:** This paper describes a tool for glitch classification in gravitational-wave data, which is not related to any of the core astrophysical topics.
...
## 91. [Compiling the largest multiwavelength database of known changing-look AGN: Prospects in the Rubin era](https://arxiv.org/abs/2607.25839) <a id="link91"></a>
...
**Comment:** Catalogs changing-look AGN, which is not relevant to any of the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 92. [Simulation of combined radio and radar signals at the Radar Echo Telescope for Cosmic Rays](https://arxiv.org/abs/2607.24955) <a id="link92"></a>
...
**Comment:** Simulation of radio and radar signals for cosmic ray detection in ice, not related to galaxy simulations or any other relevant criteria.
...
## 93. [A Citizen Science Search for Compact Emission Line Nebulae](https://arxiv.org/abs/2607.25858) <a id="link93"></a>
...
**Comment:** The paper reports a citizen science search for compact emission line nebulae, mostly associated with young stellar objects. It does not address resolved star formation histories, galaxy simulations, or near-field cosmology. The focus is on stellar phenomena, not galaxy-scale processes.
...
## 94. [Herbig AeBe Star AS442A as a UXOR-type system](https://arxiv.org/abs/2607.25724) <a id="link94"></a>
...
**Comment:** This paper presents a multi-year study of a Herbig Ae/Be star, focusing on its variability and binary nature. The work is centered on stellar variability and binary interactions, not on resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 96. [RAISE: A Low-Frequency Space-Based Payload for Solar Radio and RFI Measurements on the SMiLE Mission](https://arxiv.org/abs/2607.25755) <a id="link96"></a>
...
**Comment:** This paper describes a low-frequency radio payload for solar and terrestrial radio interference measurements. It is a technology demonstration for space-based radio astronomy and space weather studies, with no direct connection to near-field cosmology, galaxy simulations, star formation histories, quenching, or outflows.
...
## 97. [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology I: Literature Review](https://arxiv.org/abs/2607.25672) <a id="link97"></a>
...
**Comment:** This paper reviews the capability of AI in assisting scientific literature reviews in physics, astrophysics, and cosmology. It does not address any of the core astrophysical topics directly, focusing instead on methodology and meta-science.
...
## 98. [From simulations to observations of cool plasma: What we can learn from synthetic spectra](https://arxiv.org/abs/2607.25613) <a id="link98"></a>
...
**Comment:** Analyzes synthetic spectra from MHD simulations of cool plasma in the solar corona, comparing to IRIS observations. Focus is on solar physics, not galaxy simulations or stellar models relevant to the prompt. Irrelevant to core topics.
...
## 99. [Understanding the Travel-time Asymmetry of Acoustic Waves in Sunspots With Time-distance Helioseismology](https://arxiv.org/abs/2607.26006) <a id="link99"></a>
...
**Comment:** Focuses on helioseismology and sunspot subsurface structure, which is unrelated to any of the core topics (no connection to near-field cosmology, galaxy simulations, or stellar models).
...
## 100. [Solar Wind Proton Heating and its Effect on Temperature Anisotropy Evolution between 0.05 and 1 au](https://arxiv.org/abs/2607.25824) <a id="link100"></a>
...
**Comment:** Studies solar wind proton heating and temperature anisotropy in the heliosphere, which is unrelated to the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 102. [Timing and Spectral Analysis of the 2024 Outburst of 2S 1553$-$542 with NuSTAR and NICER](https://arxiv.org/abs/2607.25548) <a id="link102"></a>
...
**Comment:** Timing and spectral analysis of an X-ray binary pulsar outburst. Focus is on compact object accretion and pulsar properties, not on galaxy-scale phenomena or any core criteria.
...
## 103. [Observational Tests of Sgr A*'s State of the Accretion Flow](https://arxiv.org/abs/2607.24966) <a id="link103"></a>
...
**Comment:** The paper discusses the accretion flow around Sgr A*, the supermassive black hole at the Galactic center. This is explicitly listed as irrelevant in the criteria, as it does not pertain to satellite galaxies, star formation histories, or galaxy simulations.
...
## 104. [Contribution of cosmic alphas to generation of albedo neutrons and gammas in lunar regolith: A computational study based on GEANT4 simulations](https://arxiv.org/abs/2607.24816) <a id="link104"></a>
...
**Comment:** Computational study of cosmic alpha particles and secondary radiation in lunar regolith, not related to galaxy evolution, star formation, or stellar models.
...
## 105. [Exploring if a coronal dimming event can produce coronal hole-like properties](https://arxiv.org/abs/2607.25847) <a id="link105"></a>

**ArXiv ID:** 2607.25847

**Authors:** Adriana De-Sassi, Louise Harra, Krzysztof Barczynski, David H. Brooks, Lakshmi Pradeep Chitta, Ioannis Kontogiannis, S\"am Krucker, Cristina H. Mandrini, Eric Priest, Alphonse C. Sterling, Yingjie Zhu

**Abstract:** Coronal dimmings, or transient coronal holes, are manifested as a sudden reduction in extreme ultraviolet (EUV) and X-ray emission, often following solar eruptions. We investigate whether a dimming event can produce coronal hole-like plasma characteristics by comparing imaging and spectroscopic observations from Solar Orbiter, Hinode, IRIS, and SDO prior and during the dimming. The SDO/AIA 193 \r{A} emission intensity in the dimming region was reduced to the same level as the neighbouring coronal hole within 11 hours. The Doppler velocity measured with Fe XII (corona) decreased from $-0.34^{+0.37}_{-0.27}$ km/s towards a predominant upflow of $-3.2^{+0.4}_{-0.6}$ km/s. The first ionisation potential (FIP) bias was reduced towards photospheric values. We found an increase in the number of automatically detected EUV brightenings near the dimming boundary in SDO/AIA 193 \r{A} which could be a sign of magnetic reconnection. In the cooler SDO/AIA 171 \r{A} or Solar Orbiter HRI_EUV 174 \r{A} channel, we did not observe such an increase. Coronal bright points (CBPs) appeared relatively unaffected by the formation of the dimming. The Mg II $k_3$ (chromosphere) Doppler velocities were unchanged, except for a small reduction in the dimming upflows in areas with weak magnetic fields ($1$ MK. We suggest that this is due to the dimming resulting from plasma depletion only at higher altitudes. Since the CBPs were not significantly impacted by the dimming, we used their magnetic loop heights ($\sim 10$ Mm) as the lower limit to the dimming height. Our findings provide new insights into the atmospheric structure of coronal dimmings.

**Comment:** Studies coronal dimming events and coronal hole-like properties in the solar atmosphere, not related to galaxy evolution, star formation, or stellar models.
...
## 106. [Advancing X-Ray Camera Front-End Electronics Architecture through the AXIS-TAP Technology Platform](https://arxiv.org/abs/2607.26002) <a id="link106"></a>
...
**Comment:** Describes front-end electronics for X-ray cameras, relevant for instrumentation but not for galaxy simulations, star formation histories, or near-field cosmology. Irrelevant to core topics.
...
## 107. [Geometry resolved atomic oxygen risk assessment for very low earth orbit spacecraft](https://arxiv.org/abs/2607.25525) <a id="link107"></a>
...
**Comment:** Risk assessment for spacecraft in very low Earth orbit, not related to any relevant astrophysical criteria.
...
## 108. [Shear interaction and acceleration of a corotating stream detected by Parker Solar Probe](https://arxiv.org/abs/2607.25829) <a id="link108"></a>
...
**Comment:** This paper focuses on solar wind streams and their acceleration, which is unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. No relevant criteria are matched.
