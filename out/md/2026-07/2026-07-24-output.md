...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 48151    | 7663         | 55814   |
| **Cost**             | $0.1     | $0.06        | $0.16   |

Total arXiv papers: 179
...
1. [A RELHIC twin candidate near the galaxy M51](#user-content-link1)
**Authors:** Qingze Chen, Jie Wang, Yingjie Jing, Chen Xu, Tiantian Liang, Zerui Liu, Zhipeng Hou, Yiwei Xu, Cheng Cheng, Wei Du

2. [Spirited Away: Advective Loss of Cosmic Rays into the Milky Way's Circumgalactic Medium Explains the Large Magellanic Cloud's Low Gamma-ray Luminosity](#user-content-link2)
**Authors:** Taaseen Islam, Hilay Shah, Mark R. Krumholz, Roland Crocker

3. [A Naked Dwarf: Molecular Gas in the Completely Stripped HI Tail of VCC 1249](#user-content-link3)
...
4. [RAMSES-GPU: Cell-by-Cell Adaptive Mesh Refinement with Magneto-Hydrodynamics and Self-Gravity on Graphics Processing Units](#user-content-link4)
...
5. [An extensive grid of DARWIN models for M-type AGB stars II. Effects of pulsation periods on wind properties](#user-content-link5)
**Authors:** Emelie Siderud, Kjell Eriksson, Susanne H\"ofner, Arief Ahmad

6. [Identifying and Distinguishing Quenching Galaxies with Spatially Resolved Star Formation in the Hubble Frontier Fields](#user-content-link6)
**Authors:** Cameron Lawlor-Forsyth, Michael L. Balogh, Sean L. McGee, Gregory H. Rudnick

7. [A lower bound on primordial power spectrum from halo substructure](#user-content-link7)
**Authors:** Shin'ichiro Ando, Nagisa Hiroshima, Koji Ishiwata, Tomo Takahashi

8. [Two stellar clocks, one history: a Gaia colour-magnitude-diagram reconstruction of the solar-neighbourhood star-formation history tested against white dwarfs](#user-content-link8)
**Authors:** Michele Cignoni (Dipartimento di Fisica, Universit\`a di Pisa, Pisa, Italy, INFN Pisa, Pisa, Italy, INAF - Osservatorio di Astrofisica e Scienza dello Spazio di Bologna, Bologna, Italy), Pier Giorgio Prada Moroni (Dipartimento di Fisica, Universit\`a di Pisa, Pisa, Italy, INFN Pisa, Pisa, Italy), Martina Gabbanini (Dipartimento di Fisica, Universit\`a di Pisa, Pisa, Italy), Scilla Degl'Innocenti (Dipartimento di Fisica, Universit\`a di Pisa, Pisa, Italy, INFN Pisa, Pisa, Italy), Antonio Tinarelli (Dipartimento di Fisica, Universit\`a di Pisa, Pisa, Italy)

9. [Hierarchical Bayesian inference with compositional score modeling for stellar streams](#user-content-link9)
**Authors:** Giuseppe Viterbo, Jonas Arruda, Tobias Buck

10. [Outflows in the Early Universe: Neutral gas Absorption in Galaxies at z > 3 from low-resolution JWST Spectroscopy](#user-content-link10)
**Authors:** Matteo Sapori, Sirio Belli, Letizia Bugiani, Amir H. Khoram, Caterina Liboni, Gabriel Maheson, Gabriel Brammer, Rebecca Davies, Pratika Dayal, Anna de Graaff, Joel Leja, Rohan Naidu, Pascal Oesch, Stefano Sotira, Sandro Tacchella, Bingjie Wang, Katherine E. Whitaker

11. [When galaxies burst II. Implications of enhanced burstiness for the 21-cm Cosmic Dawn signal](#user-content-link11)
**Authors:** Hovav Lazare, Sarah Libanore, Eleonora Vanzan, Julian B. Mu\~noz, Ely D. Kovetz

12. [STORM: RDMA-based Monte Carlo Transport Scheme for Distributed-Memory Particle Simulations](#user-content-link12)
**Authors:** Maor Mizrachi, Barak Raveh, Elad Steinberg

13. [What's Missing in AGN Feedback? Lessons learnt from Magneticum, IllustrisTNG and Simba](#user-content-link13)
**Authors:** D. T. Mazengo, P. Popesso, I. Marini, L. M. Valenzuela, N. de Is\'idio, V. Toptun, Mirjana Povi\'c, Petri V\"ais\"anen, J. M. Sunzu, R. -S. Remus, V. Biffi, K. Dolag, R. Dav\'e, A. Fraser-McKelvie, A. Dev, S. Vladutescu-Zopp, A. Merloni, G. Ponti, C. Aydar, S. Shreeram, L. A. Kahinga, J. O. Chibueze, P. Privatus

14. [The Stellar Mass Function of Gas-Rich Galaxies and the Underlying $M_{\rm HI}-M_{\rm star}$ Scaling Relation in the Local Universe](#user-content-link14)
**Authors:** Tanya Tripty, Nishikanta Khandai, Saili Dutta, Khushi Sharma

15. [On the numerical reliability of nonadiabatic pulsation solutions in AGB envelopes](#user-content-link15)
**Authors:** Jan Zalewski

16. [A New Model for the Milky Way Halo Dispersion Measure with the ENGAWA Simulations: Low DMs and Large Anisotropy](#user-content-link16)
**Authors:** Scott Lucchini, Liam Connor, Samuel McCarty, Ralf M. Konietzka

17. [HARPS Abundances with Korg I: 22 Element Abundances for 426 Red Giant Stars](#user-content-link17)
**Authors:** Sarah E. Aquilina, Melissa Ness, Adam J. Wheeler, Sven Buder

18. [Accurate Extragalactic Magnetic Fields from Faraday Rotation with Optimal Dispersion Measure Estimators](#user-content-link18)
**Authors:** Hilay Shah, Mark Krumholz, Naomi McClure-Griffiths, Zipeng Hu

19. [Gravitational Lensing Predictions from Wave Simulations of Fuzzy Dark Matter](#user-content-link19)
**Authors:** Jiajun Zhou, Zhengxiang Li, Amruth Alfred, Ran Gao, Jeremy Lim, Zong-Hong Zhu

20. [Transport of angular momentum and chemical elements by the MRI dynamo in stellar radiative zones](#user-content-link20)
**Authors:** Laur\`ene Jouve, Fran\c{c}ois Ligni\`eres, J\'er\^ome Guilet, Alexis Vanbesien

21. [Web-Halo Model Peak-Background Split (WHM-PBS): halo bias as a distribution, not a number](#user-content-link21)
**Authors:** Samuel Brieden, Alexander Tipp

22. [MIGHTEE: The Host-Galaxy Associated Catalogue of the Radio Sources in MIGHTEE Continuum Data Release 1](#user-content-link22)
**Authors:** C. L. Hale, J. Hamlett, I. H. Whittam, M. J. Jarvis, M. J. Hardcastle, S. L. Jung, N. Stylianou, R. G. Varadaraj, M. Vaccari, L. Barchiesi, P. N. Best, K. K. L. Charlton, E. Malefahlo, E. Moravec, J. P. Moss, M. Rakototafika, T. F. Rarivoarinoro, F. Sinigaglia, M. N. Tudorache, S. I. Loubser, L. Heino, A. Saintonge, A. Mazumder, N. Netshiavha, D. J. B. Smith, L. Verdes-Montenegro, J. Delhaize, H. Pan, F. Pozzi, Z. Randriamanakoto, L. Stockenstroom, A. A. V\u{a}r\u{a}\c{s}teanu, E. Vardoulaki, W. L. Williams, R. A. A. Bowler, L. Marchetti, A. Matthews

23. [ALMA CO-CAVITY II. Resolved Scaling Relations in Void Galaxies](#user-content-link23)
**Authors:** S. B. De Daniloff, D. Espada, S. Duarte Puertas, Y. K. Gonz\'alez-Koda, G. Torres-R\'ios, S. F. S\'anchez, R. Garc\'ia-Benito, S. Verley, I. P\'erez, M. Argudo-Fern\'andez, A. Bongiovanni, M. S\'anchez-Portal, U. Lisenfeld, M. I. Rodr\'iguez, A. Conrado, A. Jim\'enez, B. Bidaran, L. S\'anchez-Menguiano, T. Ruiz-Lara, A. Zurita, P. V\'asquez-Bustos, M. Alc\'azar-Laynez, P. Villalba-Gonz\'alez, E. Florido, R. E. Miura

24. [A Framework for Linking Pre- and Post-Common Envelope Binary Properties with Star Clusters: The First Demonstration with a Massive White Dwarf+M Dwarf Binary in Alessi 12](#user-content-link24)
**Authors:** Steffani M. Grondin, Maria R. Drout, Jason Nordhaus, Philip S. Muirhead, Bailey Filer, Alexander Laroche, Jeremy J. Webb, Floor S. Broekgaarden, Ryan Chornock, Kyle Kremer, Natalie LeBaron, Raffaella Margutti, Nikki Noughani, Huei Sears, Pier-Emmanuel Tremblay

25. [Semi-analytical Light Curve Model for Transients Preceding Binary Mergers. I: Supernova Precursor Emission from Compact Object Companions](#user-content-link25)
**Authors:** Daichi Tsuna, Morgan Macleod, V. Ashley Villar

26. [Plasma screening and configuration interaction effects induced large enhancement on L-shell photoionization cross sections and opacity](#user-content-link26)
**Authors:** Fuyang Zhou, Shengbo Niu, Simei Lu, Chuangying Li, Xiang Gao, Yong Wu, Yizhi Qu, Jianguo Wang

27. [A Multimodal Approach to Star--Galaxy Separation using SPHEREx Spectrophotometry and DESI Legacy Survey Imaging](#user-content-link27)
**Authors:** Kendrick Nguyen, Richard M. Feder, Sean Bruton, Uro\v{s} Seljak

28. [CO second overtone line variability in three carbon-rich early post-AGB stage stars](#user-content-link28)
**Authors:** K\=arlis Pu\c{k}\=itis

29. [Time-evolving Diagnostic of the Ionized Absorbers in NGC 4051. II. High-throughput Time-resolved Spectroscopy](#user-content-link29)
**Authors:** Alfredo Luminari, Fabrizio Nicastro, Roberto Serafinelli, Riccardo Middei, Yair Krongold, Elias Kammoun, Luigi Piro, Francesca Diaferia

30. [Numerical Backreaction and Finite-Time Energy Transfer in Post-Recombination Magnetogenesis from Ultralight Dark Matter](#user-content-link30)
**Authors:** Aviv David (McGill), Robert Brandenberger (McGill)

31. [Statistics on the population of distant substellar companions to nearby stars](#user-content-link31)
**Authors:** Souleymane Ouedraogo, \'Etienne Artigau, Si\'e Zacharie Kam, Orlagh L. Creevey, Cl\'emence Fontanive, Neil J. Cook, Ren\'e Doyon, Fabrice Bado

32. [High-Resolution [CI] $({^3\mathrm{P}_2}\rightarrow{^3\mathrm{P}_1})$ and CO $(J=7\rightarrow6)$ Observations of Circumnuclear Disks in Nearby Seyfert Galaxies](#user-content-link32)
**Authors:** Dragan Salak, Suphakorn Suphapolthaworn, Yusuke Miyamoto, Naomasa Nakai, Masumichi Seta, Kazuo Sorai

33. [The Effects of Magnetic Accretion on the Spatial Extent of White Dwarf Pollution](#user-content-link33)
**Authors:** Dang Pham, Aster G. Taylor, Tim Cunningham

34. [A Quiet Host in an Active Planet-Forming Disk: Optical Spectroscopy of WISPIT](#user-content-link34)
...
35. [Fast Inference on Astronomical Time Series with Trans-Dimensional Flow Matching Posterior Estimation](#user-content-link35)
**Authors:** Nina van der Meulen, Tin Had\v{z}i Veljkovi\'c, Daniela Huppenkothen, Benjamin Kurt Miller, Christoph Weniger

36. [Exploring Physics beyond the Standard Model from kHz-Gravitational-Wave Signals of Core-Collapse Supernovae](#user-content-link36)
**Authors:** Kei Kotake, Takami Kuroda

37. [Black hole-neutron star binaries with high spins and large mass asymmetries: III. Properties of the ejected material and its electromagnetic signatures](#user-content-link37)
**Authors:** Konrad Topolski, Samuel D. Tootle, Paramvir Singh, Mattia Bulla, Luciano Rezzolla

38. [A story about a tipsy kangaroo: Reversible jump MCMC for model selection in the analysis of gravitational-wave signals from the coalescence of compact objects](#user-content-link38)
**Authors:** Anna Puecher, Tim Dietrich, Hauke Koehn, Jonathan Gair, Gregory Ashton, Luca Negri, Anuradha Samajdar

39. [Measuring Outflow Distances in NGC 5548 Using Absorption-Line Variability Diagnostics](#user-content-link39)
**Authors:** Yaqi Chen, Zhicheng He, Guilin Liu

40. [Solar axion searches with RES-NOVA: projected sensitivity and first prototype limit](#user-content-link40)
...
41. [Reaction-constrained composition \(g\)-modes in neutron stars with antikaon condensates, hyperons, and \(\Delta(1232)\) resonances](#user-content-link41)
**Authors:** Prashant Thakur, Ishfaq Ahmad Rather

42. [MeV Electrophilic Axion-like Particles from Sun](#user-content-link42)
**Authors:** Shao-Feng Ge, Sk Jeesun, Tao Li

43. [Modeling Dependence Structures in Astronomical Multi-Band Time Series Data via Multi-Output Gaussian Processes](#user-content-link43)
**Authors:** Samata Das, Lishan Shi, Yasaman Hamayouni, Hyungsuk Tak, Jong-Hak Woo

44. [Polarization of impulsive relativistic jets propagating in a stratified medium](#user-content-link44)
**Authors:** Gal Birenbaum, Paz Beniamini, Jonathan Granot

45. [A dust-free hierarchically nested supermassive-star model for James Webb Space Telescope Little Red Dots](#user-content-link45)
**Authors:** Pau Amaro Seoane

46. [Revealing the Structure and Magnetization of GRB Jets with ALMA Polarization Observations](#user-content-link46)
**Authors:** Tanmoy Laskar, Collin T. Christy, Noah Franz, Gavin Farley, Kate D. Alexander, Jonathan Granot, Ramandeep Gill, Tarraneh Eftekhari, Shiho Kobayashi, Hendrik van Eerten, Raffaella Margutti, Edo Berger

47. [Dissecting the multiple-component outflow in NGC 5548 with absorption-line Variability](#user-content-link47)
**Authors:** Yaqi Chen, Zhicheng He, Guilin Liu

48. [Relativistic Oblique Shocks at Finite Temperature: Detachment Angle, Shock Polars, and the Turning Parameter](#user-content-link48)
**Authors:** Rushikesh Ashok Sonkusale, Anshuman Verma, Ritam Mallick

49. [The correlation between voids identified in 3D large-scale-structure and 2D weak-lensing maps](#user-content-link49)
**Authors:** Y. Fang, C. T. Davies, N. Hamaus, J. J. Mohr

50. [Using horizon shadows to distinguish a black hole and a white hole](#user-content-link50)
**Authors:** Chengyu Bi, Zhoujian Cao

51. [Atmosphere mitigation in CMB observations using multi-frequency time-domain component separation](#user-content-link51)
**Authors:** Julien Tang, Shamik Ghosh, Jacques Delabrouille, John C. Groh, Oliver Jeong, Reijo Keskitalo, Theodore Kisner

52. [Hubble tension: a short review of theoretical explanations](#user-content-link52)
**Authors:** Jia-Qi Wang, Zong-Kuan Guo

53. [Probing the baryonic--dark matter connection in galaxy clusters using X-rays with gated recurrent unit neural networks](#user-content-link53)
**Authors:** Asif Iqbal, Subhabrata Majumdar, Weiguang Cui, Elena Rasia, Gabriel W. Pratt, Daniel de Andres

54. [What could an emerging Big Bang Nucleosynthesis discrepancy be hinting at?](#user-content-link54)
**Authors:** Vivian Poulin, Julien Froustey, Cyril Pitrou, Tristan L. Smith

55. [XMM-Newton and Swift Unveil Another X-Ray Transient in NGC 4945, XMM J130514.64-493311.27](#user-content-link55)
**Authors:** Ryan W. Pfeifle, Kimberly A. Weaver, Jenna M. Cann, Murray Brightman, Miranda McCarthy

56. [Inferences for f(R) Models from Late-Time Megamaser Observational Data](#user-content-link56)
**Authors:** Umang, Abha Dev Habib, Nisha Rani

57. [Evolving Dark Energy from the Back-Reaction of Cosmological Perturbations](#user-content-link57)
**Authors:** Vincent Comeau

58. [A product template bank to search for compact binary coalescences microlensed by isolated point mass lenses](#user-content-link58)
**Authors:** Sudhir Gholap, Sanjeev V. Dhurandhar, Shasvath J. Kapadia

59. [Dark Matter Weather: Probing Sub-GeV Interactions with Earth-Shielding Modulation](#user-content-link59)
**Authors:** Tetiana Kozynets, Rebecca Leane, Juri Smirnov

60. [Hubble tension: the shape wall](#user-content-link60)
**Authors:** Miguel A. Sabogal, Luis A. Escamilla, Davide Pedrotti, Edvig Selimaj, Sunny Vagnozzi

61. [Rapid Orbital Decay of Supersoft X-Ray Source WX Cen: a Surrounding Circumbinary Disk](#user-content-link61)
**Authors:** Zhi-Qiang Liu, Wei-Min Liu, Wen-Cong Chen

62. [Isotropic deceleration and near-zero baseline acceleration in Pantheon+ supernovae: new arguments in the dark energy debate](#user-content-link62)
**Authors:** Saibal Ray, Maxim Khlopov, Aritra Sanyal, Rikpratik Sengupta, Maxim Krasnov

63. [New Type IIB Poly-instanton Effects and Axion Quintessence](#user-content-link63)
**Authors:** Luca Caraffi, Federico Carta, Michele Cicoli

64. [Dark Monopoles, Bounds on Hidden Sectors, and Cosmological Implications](#user-content-link64)
**Authors:** Donald Liveoak, Anshuman Maharana, James D. Wells

65. [Exploiting Non Redundant Aperture Interferometry as a Diagnostics Tool for Synchrotron Light Characterization](#user-content-link65)
**Authors:** C. Carilli, U. Iriso, B. Nikolic, N. Thyagarajan, L. Torino

66. [Reviving the Affleck-Dine Curvaton Scenario with Compensated Isocurvature Perturbations](#user-content-link66)
**Authors:** Masahiro Kawasaki, Shunsuke Neda

67. [Ultra-High-Energy Particle Production in Binary Mergers Endowed with Magnetic Fields](#user-content-link67)
**Authors:** Carlos H. Coimbra-Araujo, Rita C. Anjos, Jonas P. Pereira, Jaziel G. Coelho

68. [Contribution to the 2026 Cosmology session of the 60th Rencontres de Moriond: Galactic moments: Understanding polarized foregrounds complexity in the quest for CMB primordial $B$ modes with LiteBIRD](#user-content-link68)
**Authors:** S. Vinzl, J. Aumont, L. Vacher, R. T. G\'enova-Santos, D. Adak, A. Rizzieri, for the LiteBIRD Collaboration

69. [The High-Energy Light Isotope eXperiment (HELIX) Instrument](#user-content-link69)
**Authors:** P. S. Allison, M. Baiocchi, J. J. Beatty, L. Beaufore, D. H. Calderon, Y. Chen, S. Coutu, E. Ellingwood, D. Fuehne, N. Green, D. Hanna, H. B. Jeon, B. Kunkler, M. Lang, R. Mbarek, K. McBride, C. E. McGrath, I. Mognet, J. Musser, S. Nutter, S. O'Brien, N. Park, T. Rosin, K. Sakai, M. Tabata, G. Tarle, G. Visser, S. P. Wakely, I. G. Wisher, M. Yu

70. [Importance and Science Outcomes from the first XSPECT/XPoSat Workshop](#user-content-link70)
...
71. [Magnetohydrodynamical opening of dust traps in protoplanetary disks](#user-content-link71)
**Authors:** Sergey Khaibrakhmanov, Vitaly Akimkin

72. [Gravitational Wave Birefringence in generalized Palatini Chern Simons](#user-content-link72)
**Authors:** Jose Perdiguero, Macarena Lagos

73. [Earth rotation turns event timing into a geometric probe of UHE neutrino origin](#user-content-link73)
**Authors:** Andrew Cheek, Jo\~ao Paulo Pinheiro, Jordi Salvado

74. [Evidence for a giant companion orbiting Tabby's star](#user-content-link74)
**Authors:** Cristina Madurga-Favieres, P. A. Str{\o}m, Thomas G. Wilson, Neda Heidari, Flavien Kiefer

75. [PROVIDENCE: a ground station for space observation](#user-content-link75)
**Authors:** P. -L. Mayeur, J. -F. Sauvage, T. Fusco, N. V\'edrenne, C. Petit, D. Barbon-Dubosc, G. Leplat, G. Guerrin, A. Vincent-Randonnier, V. Michau, F. Dolon, M. Ferrari, F. Huppert, P. -E. Blanc, S. Basa, J. Floriot, B. Neichel, T. Guerini, J. Mingot, T. Jolivet, R. Buchard, N. Robbe, J. Dezeuze, S. Idri, F. Rosso, C. Boyer, S. Thomas, S. Egron

76. [Structural, thermal and optical tolerance analysis of SHARP, a near infrared spectrograph for next generation telescope](#user-content-link76)
**Authors:** H. Mahmoodzadeh, P. Saracco, I. DI Antonio, P. Conconi, D. Scaccabarozzi, B. Saggin, E. Molinari, C. Arcidiacono, I. Arosio, E. Cascone, V. Cianniello, V. De Caprio, G. Di Rico, B. Di Francesco, C. Eredia, P. Franzetti, M. Fumana, E. Portaluri

77. [The Origin of the Magnetic Flux Driving TDE Jets](#user-content-link77)
**Authors:** Nimrod Tripto, Julian Krolik, Tsvi Piran

78. [Collisionless stationary states of a stratified plasma in an expanding magnetic tube with stochastic heating](#user-content-link78)
**Authors:** Luca Barbieri, Pascal D\'emoulin, Daniel Verscharen

79. [The Extended Ultrahigh-energy Gamma-Ray Emission in the Vicinity of PSR J2238+5903](#user-content-link79)
**Authors:** Zhen Cao, F. Aharonian, Y. X. Bai, Y. W. Bao, D. Bastieri, X. J. Bi, Y. J. Bi, W. Bian, J. Blunier, A. V. Bukevich, C. M. Cai, W. Y. Cao, Zhe Cao, J. Chang, J. F. Chang, E. S. Chen, G. H. Chen, H. K. Chen, L. F. Chen, Liang Chen, Long Chen, M. J. Chen, M. L. Chen, Q. H. Chen, S. Chen, S. H. Chen, S. Z. Chen, T. L. Chen, X. B. Chen, X. J. Chen, X. P. Chen, Y. Chen, N. Cheng, Q. Y. Cheng, Y. D. Cheng, M. Y. Cui, S. W. Cui, X. H. Cui, Y. D. Cui, B. Z. Dai, H. L. Dai, L. X. Dai, Z. G. Dai, Danzengluobu, Y. X. Diao, A. J. Dong, X. D. Duan, J. H. Fan, Y. Z. Fan, J. Fang, J. H. Fang, K. Fang, C. F. Feng, H. Feng, L. Feng, S. H. Feng, X. T. Feng, Y. Feng, Y. L. Feng, S. Gabici, B. Gao, Q. Gao, W. Gao, C. Ge, M. M. Ge, T. T. Ge, L. S. Geng, G. Giacinti, G. H. Gong, Q. B. Gou, M. H. Gu, W. M. Gu, F. L. Guo, J. Guo, K. J. Guo, X. L. Guo, Y. Q. Guo, R. P. Han, O. A. Hannuksela, M. Hasan, H. H. He, H. N. He, J. Y. He, X. Y. He, Y. He, S. Hern\'andez-Cadena, C. Hou, X. Hou, H. B. Hu, S. C. Hu, D. H. Huang, F. Huang, J. J. Huang, X. L. Huang, X. T. Huang, X. Y. Huang, Y. Huang, Z. J. Huang, A. Inventar, X. L. Ji, H. Y. Jia, K. Jia, H. B. Jiang, K. Jiang, X. W. Jiang, Z. J. Jiang, M. Jin, S. Kaci, M. M. Kang, I. Karpikov, D. Khangulyan, D. Kuleshov, W. H. Lei, Cheng Li, Cong Li, D. Li, F. Li, H. B. Li, H. C. Li, Jian Li, Jie Li, K. Li, L. Li, R. L. Li, T. Y. Li, W. L. Li, X. R. Li, X. Y. Li, Y. Li, Zhe Li, Zhuo Li, E. W. Liang, Y. F. Liang, S. J. Lin, B. Liu, C. Liu, D. Liu, D. B. Liu, H. Liu, J. Liu, J. L. Liu, J. R. Liu, M. Y. Liu, R. Y. Liu, S. M. Liu, T. Liu, W. Liu, Y. Liu, Y. Liu, Y. N. Liu, Y. Q. Lou, Q. Luo, Y. Luo, H. K. Lv, B. Q. Ma, L. L. Ma, X. H. Ma, I. O. Maliy, J. R. Mao, Z. Min, W. Mitthumsiri, Y. Mizuno, G. B. Mou, A. Neronov, K. C. Y. Ng, S. C. -Y. Ng, M. Y. Ni, L. Nie, L. J. Ou, Z. W. Ou, P. Pattarakijwanich, Z. Y. Pei, D. Y. Peng, J. C. Qi, M. Y. Qi, J. J. Qin, H. L. Qu, A. Raza, C. Y. Ren, M. Q. Ruan, D. Ruffolo, A. S\'aiz, D. Savchenko, D. Semikoz, L. Shao, O. Shchegolev, Y. Z. Shen, X. D. Sheng, F. W. Shu, H. C. Song, Yu. V. Stenkin, Y. Su, C. Y. Sun, D. X. Sun, H. Sun, J. X. Sun, M. Sun, Q. N. Sun, X. N. Sun, Z. B. Sun, N. H. Tabasam, J. Takata, P. H. T. Tam, H. B. Tan, Q. W. Tang, R. Tang, Z. B. Tang, W. W. Tian, C. N. Tong, L. H. Wan, C. Wang, D. H. Wang, G. W. Wang, H. G. Wang, J. C. Wang, J. F. Wang, J. S. Wang, K. Wang, Kai Wang, Kai Wang, L. P. Wang, L. Y. Wang, W. Wang, X. G. Wang, X. J. Wang, X. Y. Wang, Y. Wang, Y. D. Wang, Z. H. Wang, Z. X. Wang, Zheng Wang, D. M. Wei, J. J. Wei, Y. J. Wei, T. Wen, S. S. Weng, C. Y. Wu, H. R. Wu, Q. W. Wu, S. Wu, X. F. Wu, Y. S. Wu, S. Q. Xi, J. Xia, G. M. Xiang, D. X. Xiao, G. Xiao, Y. F. Xiao, B. H. Xie, Y. L. Xin, H. D. Xing, Y. Xing, D. R. Xiong, B. N. Xu, C. Y. Xu, D. L. Xu, R. X. Xu, S. S. Xu, L. Xue, D. H. Yan, T. Yan, C. Y. Yang, F. F. Yang, L. L. Yang, M. J. Yang, R. Z. Yang, W. X. Yang, Z. H. Yang, Z. G. Yao, X. A. Ye, L. Q. Yin, N. Yin, X. H. You, Z. Y. You, Y. H. Yu, Q. Yuan, H. Yue, H. D. Zeng, T. X. Zeng, W. Zeng, X. T. Zeng, M. Zha, B. Zhang, B. B. Zhang, B. T. Zhang, C. Zhang, H. Zhang, H. M. Zhang, H. Y. Zhang, J. L. Zhang, J. Y. Zhang, L. Y. Zhang, Li Zhang, P. F. Zhang, R. Zhang, R. Y. Zhang, S. R. Zhang, S. S. Zhang, S. Y. Zhang, W. Zhang, X. Zhang, X. L. Zhang, X. P. Zhang, Yi Zhang, Yong Zhang, Z. P. Zhang, J. Zhao, L. Zhao, L. Z. Zhao, X. H. Zhao, F. Zheng, T. C. Zheng, B. Zhou, H. Zhou, J. N. Zhou, L. Zhou, M. Zhou, P. Zhou, R. Zhou, X. X. Zhou, X. X. Zhou, B. Y. Zhu, C. G. Zhu, F. R. Zhu, H. Zhu, K. J. Zhu, Y. F. Zhu, Z. F. Zhu, Y. C. Zou, X. Zuo

80. [Observations of High Galactic Latitude Line and Continuum Emission (912 - 1600 \AA) with New Horizons](#user-content-link80)
**Authors:** Jayant Murthy, James Overduin, Seth Redfield, J. Michael Shull, Joel Wm. Parker, Jon P. Pineau, Anne J. Verbiscer, Richard C. Henry

81. [Laser Remelting for Reduced Porosity on Additively Manufactured Aluminium Mirrors](#user-content-link81)
**Authors:** Joshua West (STFC - UK Astronomy Technology Centre), Valentina Oyarzun (STFC - UK Astronomy Technology Centre), Marcell Westsik (STFC - UK Astronomy Technology Centre), Younes Chahid (STFC - UK Astronomy Technology Centre), Magdalena Kraus (STFC - UK Astronomy Technology Centre), Scott McPhee (STFC - UK Astronomy Technology Centre), William Brzozowski (STFC - UK Astronomy Technology Centre), Samuel Tammas-Williams (School of Engineering, University of Edinburgh), Nicola Cayzer (School of Geoscience, University of Edinburgh), Fraser Laidlaw (Physics and Astronomy, University of Edinburgh), Sameer Dayanand Meshram (Department of Mechanical Engineering, KU Leuven), Daniel Ordnung (Department of Mechanical Engineering, KU Leuven), Berk Baris Celik (Department of Mechanical Engineering, KU Leuven), Michel Smet (Department of Mechanical Engineering, KU Leuven), Mirko Sinico (Department of Mechanical Engineering, KU Leuven), Wenjuan Sun (Department of Mechanical Engineering, KU Leuven), Brecht Van Hooreweder (Department of Mechanical Engineering, KU Leuven), Michael Harris (STFC - Central Laser Facility Engineering and Technology Centre), Stephen James (STFC - Central Laser Facility Engineering and Technology Centre), Carolyn Atkins (STFC - UK Astronomy Technology Centre)

82. [A multi-band radio flux density catalog of ICRF3 sources using the Onsala Twin Telescopes](#user-content-link82)
**Authors:** Alva Kinman, R\"udiger Haas, Karine Le Bail, Jun Yang, Eskil Varenius

83. [SQUID Readout of a High-$Q$ Superconducting $LC$ Resonator](#user-content-link83)
**Authors:** Roman Kolevatov, Saptarshi Chaudhuri, Lyman Page

84. [HARMONI at ELT: optical design of the spectrograph sub-system](#user-content-link84)
**Authors:** Eduard Muslimov, Matthias Teczaa Edgar Castillo-Dominguez, James Kariuki, Liam Bolanda, Miriam Cisneros-Gonzalez, Kieran McCall, Sophie Paszynska

85. [Comparative 3D Asymmetric Expansion and Angular Widths Evolution of Fast and Slow Coronal Mass Ejections](#user-content-link85)
**Authors:** Anjali Agarwal, Wageesh Mishra, Jie Zhang, Soumyaranjan Khuntia, Manuela Temmer

86. [GCR Spectra Reconstructed with Neutron Monitor Yield Function and Artificial Neural Networks: Comparison of Two Methods](#user-content-link86)
**Authors:** Stepan Siruk, Vladislav Alekseev, Victor Kuzminov, Rustam Yulbarisov, Andrey Mayorov

87. [Infrasound Newtonian Noise Estimation at the Einstein Telescope Candidate Site Sos Enattos](#user-content-link87)
**Authors:** Wathela Alhassan, D. Rosinska, M. Suchenek, E. Fenyvesi, T. Bulik

88. [Charged Higgs Search at Future Neutrino Telescope and Higgs Factory](#user-content-link88)
**Authors:** YiCheng Dai, Wei Liao, Yi-Song Lu, Qi-Shu Yan

89. [How to Craft the Right Language AI Policy For Your Research Group (Some Assembly Required)](#user-content-link89)
**Authors:** Michelle Ntampaka, S. Burke-Spolaor, Ioana Ciuc\u{a}, Ana Maria Delgado, Kartheik G. Iyer, Kelly Lockhart, Adele Plunkett, Mercedes L\'opez-Morales, Ashish A. Mahabal, Susan E. Mullally, Rohit Raj, Jan Rerink, Jeffrey Smith, Joshua S. Speagle, John Soltis, John F. Wu, Mikaeel Yunus

90. [Capabilities and Limitations of Non-Redundant Aperture Interferometry for Beam Size Measurements](#user-content-link90)
**Authors:** C. Carilli, U. Iriso, B. Nikolic, N. Thyagarajan, L. Torino, A. Turull Barot

---

## 1. [A RELHIC twin candidate near the galaxy M51](https://arxiv.org/abs/2607.21034) <a id="link1"></a>
...
**Comment:** Discovery of HI clouds near M51 with no optical counterparts, modeled as hydrostatic HI structures in dark matter halos and compared to RELHIC predictions and simulations. This is highly relevant to 'Near-Field Cosmology' (satellite luminosity function, substructure, dark matter halos) and also touches on 'Numerical Galaxy Simulations' via comparison to TNG50.
...
## 3. [A Naked Dwarf: Molecular Gas in the Completely Stripped HI Tail of VCC 1249](https://arxiv.org/abs/2607.20626) <a id="link3"></a>
...
**Comment:** This paper presents observational evidence for molecular and HI gas removal from the dwarf galaxy VCC 1249, directly addressing star formation quenching in a dwarf galaxy and environmental effects. It closely matches the 'Star Formation Quenching' and 'Near-Field Cosmology' criteria, and provides a unique observational link between gas removal and quenching.
...
## 4. [RAMSES-GPU: Cell-by-Cell Adaptive Mesh Refinement with Magneto-Hydrodynamics and Self-Gravity on Graphics Processing Units](https://arxiv.org/abs/2607.20704) <a id="link4"></a>
...
**Comment:** This paper presents a new GPU-accelerated version of the RAMSES cosmological simulation code, including hydrodynamics, self-gravity, and stellar feedback modules. It is highly relevant to the 'Numerical Galaxy Simulations' criterion, especially as it enables high-resolution simulations and includes new physics modules.
...
## 5. [An extensive grid of DARWIN models for M-type AGB stars II. Effects of pulsation periods on wind properties](https://arxiv.org/abs/2607.20733) <a id="link5"></a>
...
**Comment:** This paper presents a grid of DARWIN models for M-type AGB stars, focusing on the effects of pulsation periods on wind properties. It is directly relevant to the 'Stellar Models' criterion, as it discusses stellar evolutionary models and wind properties. The work is theoretical and provides new insights into stellar modeling.
...
## 6. [Identifying and Distinguishing Quenching Galaxies with Spatially Resolved Star Formation in the Hubble Frontier Fields](https://arxiv.org/abs/2607.21560) <a id="link6"></a>
...
**Comment:** This paper investigates spatially resolved star formation and quenching pathways in galaxies, using SED fitting and morphological metrics. It directly matches the 'Star Formation Quenching' and 'Resolved Star Formation Histories' criteria, with a focus on quenching signatures and spatially resolved star formation in galaxies, including low-mass galaxies.
...
## 7. [A lower bound on primordial power spectrum from halo substructure](https://arxiv.org/abs/2607.20884) <a id="link7"></a>
...
**Comment:** This paper investigates the impact of the primordial power spectrum on halo and subhalo structure, including the subhalo mass function. The focus on subhalo structure and mass function is directly relevant to near-field cosmology, especially the satellite luminosity function and substructure. The connection to observations of stellar streams and lensing further strengthens relevance.
...
## 8. [Two stellar clocks, one history: a Gaia colour-magnitude-diagram reconstruction of the solar-neighbourhood star-formation history tested against white dwarfs](https://arxiv.org/abs/2607.20612) <a id="link8"></a>
...
**Comment:** This paper reconstructs the star formation history of the solar neighborhood using Gaia color-magnitude diagrams and tests against white dwarf luminosity functions. It directly matches the 'Resolved Star Formation Histories' criterion (observational CMD-based SFH). Highly relevant.
...
## 9. [Hierarchical Bayesian inference with compositional score modeling for stellar streams](https://arxiv.org/abs/2607.20725) <a id="link9"></a>
...
**Comment:** This paper presents a hierarchical Bayesian inference framework for modeling the Milky Way potential using multiple stellar streams. It is relevant to near-field cosmology, as stellar streams are used to constrain the Milky Way's dark matter halo and mass distribution. The method is novel in combining multiple streams efficiently.
...
## 11. [When galaxies burst II. Implications of enhanced burstiness for the 21-cm Cosmic Dawn signal](https://arxiv.org/abs/2607.20651) <a id="link11"></a>
...
**Comment:** This paper investigates the impact of bursty star formation in early galaxies on the 21-cm power spectrum during Cosmic Dawn, focusing on low-mass halos ($M_h\lesssim10^{10}\,M_\odot$). The topic is directly relevant to resolved star formation histories and numerical galaxy simulations, especially for low-mass galaxies, and discusses the implications for the abundance and properties of dwarf galaxies in the early universe.
...
## 12. [STORM: RDMA-based Monte Carlo Transport Scheme for Distributed-Memory Particle Simulations](https://arxiv.org/abs/2607.20639) <a id="link12"></a>
...
**Comment:** Presents a new scalable Monte Carlo transport library for astrophysical particle simulations, enabling high-fidelity radiation and neutrino transport in multiphysics codes. This is directly relevant to the 'Numerical Galaxy Simulations' criterion, especially as it enables new physics models and high-resolution simulations.
...
## 13. [What's Missing in AGN Feedback? Lessons learnt from Magneticum, IllustrisTNG and Simba](https://arxiv.org/abs/2607.21140) <a id="link13"></a>
...
**Comment:** Compares AGN feedback models in cosmological simulations (Magneticum, IllustrisTNG, SIMBA) and their impact on galaxy and halo gas properties. Highly relevant to 'Numerical Galaxy Simulations' and touches on 'Star Formation Quenching' in massive galaxies, though less so for dwarfs.
...
## 14. [The Stellar Mass Function of Gas-Rich Galaxies and the Underlying $M_{\rm HI}-M_{\rm star}$ Scaling Relation in the Local Universe](https://arxiv.org/abs/2607.21225) <a id="link14"></a>
...
**Comment:** Estimates the stellar mass function of HI gas-rich galaxies and derives the HI-stellar mass relation in the local universe. This is relevant to 'Near-Field Cosmology' (abundances of dwarf galaxies, satellite luminosity function) and also touches on galaxy properties and gas content.
...
## 15. [On the numerical reliability of nonadiabatic pulsation solutions in AGB envelopes](https://arxiv.org/abs/2607.20979) <a id="link15"></a>
...
**Comment:** This paper re-examines integration methods for linear nonadiabatic radial pulsations in AGB and post-AGB stars, focusing on numerical reliability. It is directly relevant to the 'Stellar Models' criterion, as it deals with stellar pulsation modeling and diagnostics for AGB stars.
...
## 16. [A New Model for the Milky Way Halo Dispersion Measure with the ENGAWA Simulations: Low DMs and Large Anisotropy](https://arxiv.org/abs/2607.20601) <a id="link16"></a>
...
**Comment:** This paper uses high-resolution cosmological zoom-in simulations (ENGAWA) to study the Milky Way's circumgalactic medium, focusing on the DM contribution from the MW halo. It matches the 'Numerical Galaxy Simulations' and 'Circumgalactic Medium' criteria, especially with its focus on the CGM of a Milky Way-like galaxy and new simulation-based estimates.
...
## 17. [HARPS Abundances with Korg I: 22 Element Abundances for 426 Red Giant Stars](https://arxiv.org/abs/2607.21001) <a id="link17"></a>
...
**Comment:** This paper presents new stellar atmosphere and abundance measurements for red giant stars using HARPS and the Korg spectral synthesis code. The development and application of a new pipeline for stellar abundances and atmospheric parameters is directly relevant to the 'Stellar Models' criterion.
...
## 18. [Accurate Extragalactic Magnetic Fields from Faraday Rotation with Optimal Dispersion Measure Estimators](https://arxiv.org/abs/2607.20985) <a id="link18"></a>
...
**Comment:** The paper uses simulated galaxies to improve methods for estimating extragalactic magnetic fields from Faraday rotation measures. While it includes dwarf galaxies in its analysis, the focus is on magnetic field measurement methodology rather than near-field cosmology or star formation histories. It is borderline relevant due to the inclusion of dwarfs and simulation analysis.
...
## 19. [Gravitational Lensing Predictions from Wave Simulations of Fuzzy Dark Matter](https://arxiv.org/abs/2607.20614) <a id="link19"></a>
...
**Comment:** This paper presents wave simulations of fuzzy dark matter and their impact on gravitational lensing. It is relevant to near-field cosmology only in the context of dark matter substructure, but the focus is on lensing and dark matter models rather than satellite galaxies or resolved star formation histories. Borderline relevance.
...
## 20. [Transport of angular momentum and chemical elements by the MRI dynamo in stellar radiative zones](https://arxiv.org/abs/2607.21059) <a id="link20"></a>
...
**Comment:** The paper presents shearing-box simulations of the magneto-rotational instability (MRI) in stellar radiative zones, focusing on angular momentum and chemical transport. It is relevant to the 'Stellar Models' criterion, as it discusses transport processes in stellar interiors and provides scaling laws, though it does not present new evolutionary tracks or atmosphere models.
...
## 21. [Web-Halo Model Peak-Background Split (WHM-PBS): halo bias as a distribution, not a number](https://arxiv.org/abs/2607.21334) <a id="link21"></a>
...
**Comment:** The paper presents an analytic theory for halo bias, focusing on the cosmic web environment and assembly bias. While it deals with dark matter halos and bias, it does not specifically address satellite galaxies, dwarf galaxies, or near-field cosmology. It is somewhat relevant to numerical galaxy simulations, but the focus is on analytic models rather than new simulations.
...
## 22. [MIGHTEE: The Host-Galaxy Associated Catalogue of the Radio Sources in MIGHTEE Continuum Data Release 1](https://arxiv.org/abs/2607.21122) <a id="link22"></a>
...
**Comment:** The paper presents a catalogue of radio sources and their host galaxies from the MIGHTEE survey, including AGN and star-forming galaxies. While it discusses star formation rates and radio luminosity functions, the focus is on large samples and not specifically on dwarf galaxies, resolved star formation histories, or galaxy simulations. Some relevance for star formation quenching and outflows, but not directly focused on dwarfs.
...
## 23. [ALMA CO-CAVITY II. Resolved Scaling Relations in Void Galaxies](https://arxiv.org/abs/2607.21464) <a id="link23"></a>
...
**Comment:** This paper studies scaling relations involving star formation rates, molecular gas mass, and stellar mass in void galaxies. While it focuses on star formation and molecular gas, the sample is void galaxies (not dwarfs or satellites), and the work does not directly address resolved star formation histories, quenching, or outflows. The relevance is borderline, as the results may inform galaxy evolution but are not directly aligned with the core topics.
...
## 24. [A Framework for Linking Pre- and Post-Common Envelope Binary Properties with Star Clusters: The First Demonstration with a Massive White Dwarf+M Dwarf Binary in Alessi 12](https://arxiv.org/abs/2607.20611) <a id="link24"></a>
...
**Comment:** This paper presents a framework for reconstructing the evolutionary histories of post-common envelope binaries in star clusters, with a demonstration using a massive white dwarf + M dwarf binary. It uses stellar evolution models and cluster membership to constrain binary evolution. While it involves stellar evolution and models, it does not present new stellar models or focus on galaxy-scale topics.
...
## 25. [Semi-analytical Light Curve Model for Transients Preceding Binary Mergers. I: Supernova Precursor Emission from Compact Object Companions](https://arxiv.org/abs/2607.20599) <a id="link25"></a>
...
**Comment:** This paper presents a semi-analytical light curve model for transients preceding binary mergers, focusing on supernova precursor emission from compact object companions. While it deals with stellar evolution and binary interactions, it does not present new stellar models or address the core topics directly.
...
## 26. [Plasma screening and configuration interaction effects induced large enhancement on L-shell photoionization cross sections and opacity](https://arxiv.org/abs/2607.21238) <a id="link26"></a>
...
**Comment:** The paper discusses opacity modeling for iron L-shell ions at solar interior temperatures, which is relevant to stellar interior physics but does not present new stellar evolutionary tracks or atmosphere models. It is tangential to the 'Stellar Models' criterion, but not directly relevant.
...
## 27. [A Multimodal Approach to Star--Galaxy Separation using SPHEREx Spectrophotometry and DESI Legacy Survey Imaging](https://arxiv.org/abs/2607.20797) <a id="link27"></a>
...
**Comment:** Presents a multimodal approach for star-galaxy separation in surveys. While useful for survey science, it does not directly address any of the core criteria (near-field cosmology, resolved star formation histories, etc.).
...
## 28. [CO second overtone line variability in three carbon-rich early post-AGB stage stars](https://arxiv.org/abs/2607.21473) <a id="link28"></a>
...
**Comment:** The paper studies CO line variability in post-AGB stars, focusing on stellar atmospheres and pulsation-driven shocks. While it touches on stellar models and atmospheres, it does not present new stellar evolutionary tracks or atmosphere models, nor does it relate to galaxy-scale phenomena or resolved star formation histories.
...
## 29. [Time-evolving Diagnostic of the Ionized Absorbers in NGC 4051. II. High-throughput Time-resolved Spectroscopy](https://arxiv.org/abs/2607.20621) <a id="link29"></a>
...
**Comment:** Time-resolved spectroscopy of ionized absorbers in an AGN, focusing on outflows and their energetics. While it discusses outflows, these are AGN-driven rather than star-formation-driven, so it is not relevant to the 'Star Formation Driven Outflows' criterion.
...
## 30. [Numerical Backreaction and Finite-Time Energy Transfer in Post-Recombination Magnetogenesis from Ultralight Dark Matter](https://arxiv.org/abs/2607.20793) <a id="link30"></a>
...
**Comment:** This paper studies magnetogenesis from ultralight dark matter in the post-recombination era. While it involves cosmology and dark matter, it does not focus on near-field cosmology, galaxy substructure, or any of the core topics.
...
## 32. [High-Resolution [CI] $({^3\mathrm{P}_2}\rightarrow{^3\mathrm{P}_1})$ and CO $(J=7\rightarrow6)$ Observations of Circumnuclear Disks in Nearby Seyfert Galaxies](https://arxiv.org/abs/2607.21237) <a id="link32"></a>
...
**Comment:** This paper presents high-resolution [CI] and CO observations of circumnuclear disks in Seyfert galaxies. The focus is on molecular gas and dust in galaxy nuclei, specifically in Seyfert galaxies (massive galaxies), and not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 33. [The Effects of Magnetic Accretion on the Spatial Extent of White Dwarf Pollution](https://arxiv.org/abs/2607.20747) <a id="link33"></a>
...
**Comment:** The paper models the spatial extent of white dwarf pollution due to magnetic accretion. While it deals with stellar evolution and accretion, it does not present new stellar models or address galaxy-scale topics such as near-field cosmology or star formation histories.
...
## 34. [A Quiet Host in an Active Planet-Forming Disk: Optical Spectroscopy of WISPIT](https://arxiv.org/abs/2607.20649) <a id="link34"></a>
...
**Comment:** Optical spectroscopy of a pre-main-sequence star with a planet-forming disk. Focus is on stellar and disk properties, not galaxy-scale phenomena or stellar models relevant to the criteria.
...
## 35. [Fast Inference on Astronomical Time Series with Trans-Dimensional Flow Matching Posterior Estimation](https://arxiv.org/abs/2607.21134) <a id="link35"></a>
...
**Comment:** This paper presents a new machine learning method for fast inference on astronomical time series, applied to fast radio bursts and magnetar bursts. It does not match any of the core criteria (no connection to galaxy simulations, star formation histories, or stellar models).
...
## 36. [Exploring Physics beyond the Standard Model from kHz-Gravitational-Wave Signals of Core-Collapse Supernovae](https://arxiv.org/abs/2607.20921) <a id="link36"></a>
...
**Comment:** This paper explores gravitational wave signals from core-collapse supernovae and their implications for physics beyond the Standard Model. It does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 37. [Black hole-neutron star binaries with high spins and large mass asymmetries: III. Properties of the ejected material and its electromagnetic signatures](https://arxiv.org/abs/2607.20609) <a id="link37"></a>
...
**Comment:** This paper studies the properties of ejecta from black hole-neutron star mergers, including r-process nucleosynthesis and kilonova light curves. It does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 38. [A story about a tipsy kangaroo: Reversible jump MCMC for model selection in the analysis of gravitational-wave signals from the coalescence of compact objects](https://arxiv.org/abs/2607.21484) <a id="link38"></a>
...
**Comment:** Presents a new MCMC sampler for model selection in gravitational wave analysis of compact object mergers. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 39. [Measuring Outflow Distances in NGC 5548 Using Absorption-Line Variability Diagnostics](https://arxiv.org/abs/2607.21038) <a id="link39"></a>
...
**Comment:** This paper measures outflow distances in NGC 5548 using absorption-line variability diagnostics, focusing on AGN-driven outflows. The outflows discussed are AGN-driven, not star-formation-driven, and the galaxy is much more massive than the LMC. No direct relevance to the core topics.
...
## 40. [Solar axion searches with RES-NOVA: projected sensitivity and first prototype limit](https://arxiv.org/abs/2607.21363) <a id="link40"></a>
...
**Comment:** Solar axion searches with RES-NOVA, focusing on particle physics and detection methods. No direct connection to any of the core criteria (galaxy simulations, star formation, near-field cosmology, etc.).
...
## 41. [Reaction-constrained composition \(g\)-modes in neutron stars with antikaon condensates, hyperons, and \(\Delta(1232)\) resonances](https://arxiv.org/abs/2607.20693) <a id="link41"></a>
...
**Comment:** This paper focuses on neutron star interior physics, specifically g-mode oscillations and exotic matter. It does not match any of the core criteria (no connection to near-field cosmology, galaxy simulations, star formation histories, or stellar models relevant to the prompt).
...
## 42. [MeV Electrophilic Axion-like Particles from Sun](https://arxiv.org/abs/2607.21168) <a id="link42"></a>
...
**Comment:** This paper discusses MeV-scale axion-like particles produced in the Sun and their detection, focusing on dark matter direct detection. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 43. [Modeling Dependence Structures in Astronomical Multi-Band Time Series Data via Multi-Output Gaussian Processes](https://arxiv.org/abs/2607.21431) <a id="link43"></a>
...
**Comment:** The paper presents statistical methods for modeling multi-band time series data in astronomy, with applications to AGN variability. It does not address any of the core topics such as resolved star formation histories, galaxy simulations, or stellar models.
...
## 44. [Polarization of impulsive relativistic jets propagating in a stratified medium](https://arxiv.org/abs/2607.20618) <a id="link44"></a>
...
**Comment:** The paper analyzes polarization in afterglows from relativistic jets in GRBs and TDEs, focusing on shock propagation in stratified media. It does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 45. [A dust-free hierarchically nested supermassive-star model for James Webb Space Telescope Little Red Dots](https://arxiv.org/abs/2607.20617) <a id="link45"></a>
...
**Comment:** The paper proposes a model for high-redshift objects observed by JWST, focusing on supermassive stars and their nested structure. The topic is not related to near-field cosmology, resolved star formation histories, dwarf galaxy quenching, or galaxy simulations. It is focused on early universe objects and supermassive stars.
...
## 46. [Revealing the Structure and Magnetization of GRB Jets with ALMA Polarization Observations](https://arxiv.org/abs/2607.20604) <a id="link46"></a>

**ArXiv ID:** 2607.20604

**Authors:** Tanmoy Laskar, Collin T. Christy, Noah Franz, Gavin Farley, Kate D. Alexander, Jonathan Granot, Ramandeep Gill, Tarraneh Eftekhari, Shiho Kobayashi, Hendrik van Eerten, Raffaella Margutti, Edo Berger

**Abstract:** We present a systematic study of the currently available ALMA millimeter polarimetric sample of gamma-ray burst (GRB) afterglows. Our sample comprises 24 observations (20 new) of 11 long-duration GRBs spanning $\approx0.1$-87 days after the burst. We detect significant linear polarization in 8 observations across 6 events, with polarization degrees ranging from $\Pi_L\approx0.6\%$ to $2.4\%$. For the remaining observations, we place deep upper limits (median $\Pi_L\lesssim1\%$). Multi-epoch observations reveal diverse polarization evolution. GRB 190114C yields the best-sampled $\Pi_L$ for a radio afterglow to date, with early evolution favoring patchy magnetic fields in the reverse shock (RS) and later polarization broadly consistent with forward-shock (FS) models. GRB 220921A exhibits a rapid rise in polarization from $\Pi_L\lesssim0.4\%$ to $2.4\%$ over 1.9-6.8 days, inconsistent with toroidal RS magnetic-field models but broadly consistent with several FS random-field models. GRB 221009A yields the highest-significance polarization detections in the sample ($\Pi_L\approx1.4$-$1.6\%$), yet neither existing FS nor RS polarization models reproduce both the observed polarization evolution and the viewing geometry inferred from broadband afterglow modeling, with the exception of patchy fields in the RS. Deep upper limits for GRB 171205A rule out RS toroidal-field models for the published off-axis geometry, while a strong, single-epoch detection of GRB 190829A, if RS-dominated, requires a nearly on-axis geometry for toroidal-field configurations. Interpreting the observations within a patchy-field framework implies magnetic-field coherence scales of order $\theta_B\sim10^{-3}$-$10^{-2}$ rad. These observations demonstrate the diagnostic power of radio/mm polarimetry for probing the magnetic-field structure, emission region, and viewing geometry of relativistic GRB jets.

**Comment:** This paper presents ALMA polarization observations of GRB afterglows to probe jet structure and magnetization. The focus is on GRBs and their jets, not on galaxies, star formation histories, or near-field cosmology.
...
## 47. [Dissecting the multiple-component outflow in NGC 5548 with absorption-line Variability](https://arxiv.org/abs/2607.21029) <a id="link47"></a>
...
**Comment:** This paper focuses on AGN-driven outflows in NGC 5548, which is a massive galaxy and the outflows are AGN-driven, not star-formation-driven. It does not address star-formation-driven outflows, dwarf galaxies, or the CGM of dwarfs. No direct match to any core criteria.
...
## 48. [Relativistic Oblique Shocks at Finite Temperature: Detachment Angle, Shock Polars, and the Turning Parameter](https://arxiv.org/abs/2607.20978) <a id="link48"></a>
...
**Comment:** The paper is a theoretical study of relativistic oblique shocks, with an application to the Crab pulsar wind nebula. It does not focus on galaxy simulations, star formation, or outflows in galaxies, nor does it address dwarf galaxies or near-field cosmology.
...
## 49. [The correlation between voids identified in 3D large-scale-structure and 2D weak-lensing maps](https://arxiv.org/abs/2607.20637) <a id="link49"></a>
...
**Comment:** This paper focuses on voids in large-scale structure and weak-lensing maps, which is not directly related to any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations. The work is more about cosmological structure and voids, not satellite galaxies or their properties.
...
## 50. [Using horizon shadows to distinguish a black hole and a white hole](https://arxiv.org/abs/2607.20945) <a id="link50"></a>
...
**Comment:** Uses ray-tracing to distinguish black holes and white holes via horizon shadows and polarization. No direct relevance to galaxy simulations, star formation, or near-field cosmology.
...
## 51. [Atmosphere mitigation in CMB observations using multi-frequency time-domain component separation](https://arxiv.org/abs/2607.21432) <a id="link51"></a>
...
**Comment:** Presents a new method for atmospheric mitigation in CMB observations. No direct relevance to galaxy simulations, star formation, or near-field cosmology.
...
## 53. [Probing the baryonic--dark matter connection in galaxy clusters using X-rays with gated recurrent unit neural networks](https://arxiv.org/abs/2607.20721) <a id="link53"></a>
...
**Comment:** This paper presents a deep learning framework for predicting mass profiles of galaxy clusters from X-ray data. The focus is on galaxy clusters, not dwarf galaxies or satellites, and does not address any of the core topics directly. The relevance is low.
...
## 54. [What could an emerging Big Bang Nucleosynthesis discrepancy be hinting at?](https://arxiv.org/abs/2607.20635) <a id="link54"></a>
...
**Comment:** This paper investigates a discrepancy in Big Bang Nucleosynthesis, focusing on primordial deuterium abundance and cosmological models. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows. The focus is on early universe physics, not galaxy or stellar evolution.
...
## 55. [XMM-Newton and Swift Unveil Another X-Ray Transient in NGC 4945, XMM J130514.64-493311.27](https://arxiv.org/abs/2607.21587) <a id="link55"></a>
...
**Comment:** This paper reports the detection of an X-ray transient in NGC 4945, likely an X-ray binary. The focus is on X-ray transients and binaries in a massive galaxy, not on dwarf galaxies, near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 56. [Inferences for f(R) Models from Late-Time Megamaser Observational Data](https://arxiv.org/abs/2607.21129) <a id="link56"></a>
...
**Comment:** This paper uses megamaser observations to constrain cosmological models and the Hubble constant. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations. The focus is on cosmological parameters and modified gravity.
...
## 57. [Evolving Dark Energy from the Back-Reaction of Cosmological Perturbations](https://arxiv.org/abs/2607.20715) <a id="link57"></a>
...
**Comment:** The paper discusses the back-reaction of cosmological perturbations on dark energy, a cosmology topic not related to near-field cosmology, galaxy simulations, or any of the other core criteria.
...
## 58. [A product template bank to search for compact binary coalescences microlensed by isolated point mass lenses](https://arxiv.org/abs/2607.20661) <a id="link58"></a>
...
**Comment:** Focuses on gravitational wave template banks for microlensed compact binary coalescences. No direct relevance to galaxy simulations, star formation, or near-field cosmology.
...
## 59. [Dark Matter Weather: Probing Sub-GeV Interactions with Earth-Shielding Modulation](https://arxiv.org/abs/2607.20620) <a id="link59"></a>
...
**Comment:** This paper discusses daily modulation from Earth shielding as a probe for sub-GeV dark matter interactions in low-threshold experiments. It is not related to near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 60. [Hubble tension: the shape wall](https://arxiv.org/abs/2607.21244) <a id="link60"></a>
...
**Comment:** This paper discusses the Hubble tension and constraints from BAO and SNeIa data. It is cosmology-focused and does not match any of the core criteria.
...
## 61. [Rapid Orbital Decay of Supersoft X-Ray Source WX Cen: a Surrounding Circumbinary Disk](https://arxiv.org/abs/2607.21364) <a id="link61"></a>
...
**Comment:** This paper studies the orbital decay of a supersoft X-ray source binary, focusing on circumbinary disk interactions. It is not relevant to any of the core criteria.
...
## 62. [Isotropic deceleration and near-zero baseline acceleration in Pantheon+ supernovae: new arguments in the dark energy debate](https://arxiv.org/abs/2607.20570) <a id="link62"></a>

**ArXiv ID:** 2607.20570

**Authors:** Saibal Ray, Maxim Khlopov, Aritra Sanyal, Rikpratik Sengupta, Maxim Krasnov

**Abstract:** We perform four independent decompositions of the deceleration parameter $q_0$ using 1564 Type Ia supernovae (SNe Ia) from the Pantheon+ catalogue: by redshift bin, sky hemisphere, host galaxy mass, and supernova colour. Without any progenitor age correction, the full sample yields $q_m$ = - 0.062 -- far below the $\Lambda$CDM expectation of - 0.55 -- challenging the standard picture before any correction. Crucially, the sky hemisphere test shows the deceleration is equally strong in the CMB dipole ($q_m$ = + 1.45) and anti-dipole hemispheres (+ 1.55), directly contradicting the SRS26 anisotropy argument. Our results challenge both current interpretations.

**Comment:** This paper analyzes the deceleration parameter from supernovae data and its implications for dark energy. It is cosmology-focused and does not match any of the core criteria.
...
## 63. [New Type IIB Poly-instanton Effects and Axion Quintessence](https://arxiv.org/abs/2607.20613) <a id="link63"></a>
...
**Comment:** The paper discusses poly-instanton effects in string theory and axion quintessence, focusing on instanton zero modes and Calabi-Yau orientifolds. It does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 64. [Dark Monopoles, Bounds on Hidden Sectors, and Cosmological Implications](https://arxiv.org/abs/2607.20843) <a id="link64"></a>
...
**Comment:** This paper discusses hidden sector magnetic monopoles and their cosmological implications, focusing on string theory and early universe constraints. It does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 65. [Exploiting Non Redundant Aperture Interferometry as a Diagnostics Tool for Synchrotron Light Characterization](https://arxiv.org/abs/2607.19991) <a id="link65"></a>
...
**Comment:** This paper introduces a novel interferometric method for characterizing electron beams in synchrotron light sources. No relevance to galaxy simulations, star formation, or stellar models.
...
## 66. [Reviving the Affleck-Dine Curvaton Scenario with Compensated Isocurvature Perturbations](https://arxiv.org/abs/2607.21008) <a id="link66"></a>
...
**Comment:** Theoretical cosmology paper on the Affleck-Dine curvaton scenario and isocurvature perturbations. No relevance to galaxy simulations, star formation, or near-field cosmology.
...
## 68. [Contribution to the 2026 Cosmology session of the 60th Rencontres de Moriond: Galactic moments: Understanding polarized foregrounds complexity in the quest for CMB primordial $B$ modes with LiteBIRD](https://arxiv.org/abs/2607.21247) <a id="link68"></a>
...
**Comment:** The paper discusses modeling of polarized Galactic emission for CMB foregrounds, focusing on the Milky Way's ISM and dust/synchrotron emission. This is not directly relevant to near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows. The focus is on foregrounds for CMB experiments, not on galaxy or dwarf galaxy science.
...
## 69. [The High-Energy Light Isotope eXperiment (HELIX) Instrument](https://arxiv.org/abs/2607.20774) <a id="link69"></a>
...
**Comment:** This paper describes the HELIX instrument for measuring cosmic-ray isotopes. While cosmic-ray measurements can sometimes be relevant for near-field cosmology, this work is focused on instrumentation and does not directly address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 70. [Importance and Science Outcomes from the first XSPECT/XPoSat Workshop](https://arxiv.org/abs/2607.21365) <a id="link70"></a>
...
**Comment:** Workshop summary on X-ray spectral analysis of compact objects (neutron stars, black holes, X-ray binaries). No focus on galaxies, star formation histories, or stellar models relevant to the criteria.
...
## 71. [Magnetohydrodynamical opening of dust traps in protoplanetary disks](https://arxiv.org/abs/2607.21350) <a id="link71"></a>
...
**Comment:** This paper studies magnetohydrodynamical effects on dust traps in protoplanetary disks. It is focused on planet formation and disk physics, not galaxies or the core topics.
...
## 72. [Gravitational Wave Birefringence in generalized Palatini Chern Simons](https://arxiv.org/abs/2607.20689) <a id="link72"></a>
...
**Comment:** The paper studies gravitational wave birefringence in modified gravity models, focusing on cosmological propagation and dark energy. It is not relevant to near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 73. [Earth rotation turns event timing into a geometric probe of UHE neutrino origin](https://arxiv.org/abs/2607.20608) <a id="link73"></a>
...
**Comment:** This paper discusses UHE neutrino event timing and its implications for dark matter decay hypotheses. It is not relevant to any of the core criteria.
...
## 75. [PROVIDENCE: a ground station for space observation](https://arxiv.org/abs/2607.21304) <a id="link75"></a>
...
**Comment:** This paper describes the PROVIDENCE ground station project, focusing on instrumentation and observatory infrastructure. It does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 76. [Structural, thermal and optical tolerance analysis of SHARP, a near infrared spectrograph for next generation telescope](https://arxiv.org/abs/2607.20610) <a id="link76"></a>
...
**Comment:** This paper presents a structural, thermal, and optical analysis of a near-infrared spectrograph for ELTs. It focuses on instrumentation and does not address any of the core topics such as galaxy evolution, star formation histories, or numerical galaxy simulations.
...
## 77. [The Origin of the Magnetic Flux Driving TDE Jets](https://arxiv.org/abs/2607.20615) <a id="link77"></a>
...
**Comment:** This paper investigates the origin of magnetic flux driving jets in tidal disruption events (TDEs). TDEs and black hole accretion are not relevant to the core topics, as specified in the criteria.
...
## 78. [Collisionless stationary states of a stratified plasma in an expanding magnetic tube with stochastic heating](https://arxiv.org/abs/2607.21313) <a id="link78"></a>
...
**Comment:** This is a theoretical plasma physics paper focused on the solar atmosphere and stellar coronae, not galaxies or their satellites. No match to any core criteria.
...
## 79. [The Extended Ultrahigh-energy Gamma-Ray Emission in the Vicinity of PSR J2238+5903](https://arxiv.org/abs/2607.21026) <a id="link79"></a>
...
**Comment:** The paper analyzes gamma-ray emission from a pulsar wind nebula, not galaxies or their satellites. No match to any core criteria.
...
## 80. [Observations of High Galactic Latitude Line and Continuum Emission (912 - 1600 \AA) with New Horizons](https://arxiv.org/abs/2607.20942) <a id="link80"></a>
...
**Comment:** This paper presents observations of the cosmic ultraviolet background and discusses emission lines and dust-scattered continuum. It does not address any of the core topics (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 81. [Laser Remelting for Reduced Porosity on Additively Manufactured Aluminium Mirrors](https://arxiv.org/abs/2607.21253) <a id="link81"></a>
...
**Comment:** This paper discusses laser remelting to reduce porosity in additively manufactured aluminum mirrors. It is an instrumentation/engineering paper and does not address any of the core astrophysics topics.
...
## 82. [A multi-band radio flux density catalog of ICRF3 sources using the Onsala Twin Telescopes](https://arxiv.org/abs/2607.20671) <a id="link82"></a>
...
**Comment:** This paper presents a radio flux density catalog of AGN sources for geodetic and astrometric VLBI. It is not related to any of the core astrophysics topics.
...
## 83. [SQUID Readout of a High-$Q$ Superconducting $LC$ Resonator](https://arxiv.org/abs/2607.20831) <a id="link83"></a>
...
**Comment:** This paper demonstrates the readout of a superconducting LC resonator using SQUIDs, relevant for axion searches. It is not related to any of the core topics: near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 84. [HARMONI at ELT: optical design of the spectrograph sub-system](https://arxiv.org/abs/2607.21264) <a id="link84"></a>
...
**Comment:** This paper describes the optical design of a spectrograph for the ELT. It is an instrumentation paper and does not match any of the core criteria.
...
## 85. [Comparative 3D Asymmetric Expansion and Angular Widths Evolution of Fast and Slow Coronal Mass Ejections](https://arxiv.org/abs/2607.21236) <a id="link85"></a>
...
**Comment:** This paper studies the expansion and angular width evolution of coronal mass ejections (CMEs). The topic is solar physics and not related to any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 86. [GCR Spectra Reconstructed with Neutron Monitor Yield Function and Artificial Neural Networks: Comparison of Two Methods](https://arxiv.org/abs/2607.21009) <a id="link86"></a>
...
**Comment:** This paper reconstructs galactic cosmic-ray spectra using neutron monitor data and neural networks. It is unrelated to any of the core topics (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 87. [Infrasound Newtonian Noise Estimation at the Einstein Telescope Candidate Site Sos Enattos](https://arxiv.org/abs/2607.21154) <a id="link87"></a>
...
**Comment:** This paper investigates infrasound Newtonian noise at a gravitational wave detector site. It is unrelated to any of the core astrophysics topics.
...
## 88. [Charged Higgs Search at Future Neutrino Telescope and Higgs Factory](https://arxiv.org/abs/2607.20963) <a id="link88"></a>
...
**Comment:** This paper investigates the discovery potential of the charged Higgs boson at future neutrino telescopes and lepton colliders. It is a particle physics paper and does not address any of the core astrophysics topics.
...
## 89. [How to Craft the Right Language AI Policy For Your Research Group (Some Assembly Required)](https://arxiv.org/abs/2607.20836) <a id="link89"></a>
...
**Comment:** This paper discusses AI policy for astronomy research groups. It is not related to any of the core astrophysics topics.
...
## 90. [Capabilities and Limitations of Non-Redundant Aperture Interferometry for Beam Size Measurements](https://arxiv.org/abs/2607.19976) <a id="link90"></a>
...
**Comment:** The paper discusses a beam characterization technique for electron beams using NRAI. This is instrumentation/beam physics and not related to any of the core topics.
