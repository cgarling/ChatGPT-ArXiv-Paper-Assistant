...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 46666    | 7406         | 54072   |
| **Cost**             | $0.09    | $0.06        | $0.15   |

Total arXiv papers: 184
...
1. [Bo\"otes III is a Tidally Disrupting Ultra-Faint Dwarf Galaxy on an Eccentric Polar Orbit](#user-content-link1)
**Authors:** Ting S. Li (the S5 Collaboration), Denis Erkal (the S5 Collaboration), Andrew B. Pace (the S5 Collaboration), Jiaxun Yang (the S5 Collaboration), Sergey E. Koposov (the S5 Collaboration), Jo Bovy (the S5 Collaboration), Nathan R. Sandford (the S5 Collaboration), Andrew P. Li (the S5 Collaboration), Gustavo E. Medina (the S5 Collaboration), Lara R. Cullinane (the S5 Collaboration), Gary S. Da Costa (the S5 Collaboration), Alexander P. Ji (the S5 Collaboration), Kyler Kuehn (the S5 Collaboration), Geraint F. Lewis (the S5 Collaboration), Guilherme Limberg (the S5 Collaboration), Sarah L. Martell (the S5 Collaboration), Aldo Mura-Guzm\'an (the S5 Collaboration), Nora Shipp (the S5 Collaboration), Yong Yang (the S5 Collaboration), Daniel B. Zucker (the S5 Collaboration), Kaia R. Atzberger (the S5 Collaboration), Joss Bland-Hawthorn (the S5 Collaboration), John D. Dixon (the S5 Collaboration)

2. [Beryllium enhancement in stars of the accreted Thamnos-2 system](#user-content-link2)
**Authors:** Paolo Molaro, Piercarlo Bonifacio, Elisabetta Caffau, Lorenzo Monaco, Gabriele Cescutti

3. [Physics of Eclipsing Binaries. VI. Hot, compact stars](#user-content-link3)
**Authors:** David Jones, Nicole Reindl, Kyle Conroy, James Munday, Pier-Emmanuel Tremblay, Michael Abdul-Masih, Matthias Fabry, Joseph Giammarco, Kelly Hambleton, Herbert Pablo, Marcin Wrona, Andrej Prsa

4. [Supersonic Motion in the Driving Region of M82](#user-content-link4)
**Authors:** Skylar Grayson, Evan Scannapieco, Philipp Grete, Erin Boettcher, Marcus Br\"uggen, Edmund Hodges-Kluck, John ZuHone, Yutaka Fujita

5. [HETDEX [OII] galaxies at $z \le 0.48$: Volume-limited samples and their power spectra](#user-content-link5)
**Authors:** Jeongin Moon, Eiichiro Komatsu, Robin Ciardullo, Olivia Curtis, Dustin Davis, Daniel J. Farrow, Karl Gebhardt, Caryl Gronwall, Laura Herold, Gary J. Hill, Donghui Jeong, Chenxu Liu, Maja Lujan Niemeyer, Erin Mentuch Cooper, Shiro Mukae, Shun Saito, Ariel G. S\'anchez, Donald P. Schneider

6. [Multiple populations along the asymptotic giant branch: a Gaia+APOGEE study of 22 Galactic globular clusters](#user-content-link6)
**Authors:** Emanuele Dondoglio, A. P. Milone, A. F. Marino, G. Cordoni, M. V. Legnardi, T. Ziliotto, R. Asa'd, A. Mastrobuono-Battisti, F. Muratore, E. Bortolan, E. P. Lagioia, M. Tailo

7. [Effects of low resolution on the column density PDF of molecular clouds](#user-content-link7)
**Authors:** Yuping Tang, Q. Daniel Wang, Grant W. Wilson, Xing Lu, Jinhua He

8. [Deep Spectroscopic Follow-Up of Maisie's Galaxy -- A Typical Galaxy in the Early Universe](#user-content-link8)
**Authors:** Rebecca L. Larson, Taylor A. Hutchison, Steven L. Finkelstein, Pablo Arrabal Haro, Casey Papovich, Weida Hu, Javier \'Alvarez-M\'arquez, Ruqiu Lin, Jorge A. Zavala, Volker Bromm, Nikko J. Cleri, Abdurro'uf, Brittany Vanderhoof, Bren E. Backhaus, Dan Coe, Henry C. Ferguson, Ananya Ganapathy, Norman A. Grogin, Michaela Hirschmann, Intae Jung, Jeyhan S. Kartaltepe, Anton M. Koekemoer, Dale D. Kocevski, Ray A. Lucas, Alexa M. Morales, Pablo G. P\'erez-Gonz\'alez, Nor Pirzkal, Jonathan R. Trump, L. Y. Aaron Yung

9. [On the detection of Population III galaxies: Emission Line Diagnostics for Hybrid Stellar Populations](#user-content-link9)
**Authors:** S. Goswami, J. M. V\'ilchez, C. Kehrig, A. Ferrara, J. Iglesias-P\'aramo

10. [Thermal Sunyaev-Zel'dovich Measurements of Locally Bright Galaxies with ACT DR6: Radio Source Contamination and Excess Compton-y Signal](#user-content-link10)
**Authors:** Nicholas Battaglia, Jean-Baptiste Melin, J. Colin Hill, James Bartlett

11. [Milky Way Near Twins (MWNeTs). I. A Hierarchical Framework for Identifying the Evolutionary Counterparts of the Milky Way](#user-content-link11)
**Authors:** I. B. Vavilova, A. M. Dmytrenko, D. V. Dobrycheva, P. N. Fedorov, I. O. Izviekova, V. P. Khramtsov, O. V. Kompaniiets, O. N. Kukhar, O. S. Pastoven, O. Sergijenko, A. A. Vasylenko

12. [The incidence of eROSITA X-ray AGN in the local Universe: from dwarf to massive galaxies](#user-content-link12)
...
13. [Robust Heteroskedastic Matrix Factorization: A Generalization of PCA that Flags Outliers and Handles Missing Data](#user-content-link13)
**Authors:** Thomas Hilder, David W. Hogg, Andrew R. Casey, Hans-Walter Rix

14. [Scaling Relations for Binary Black Hole Merger Times from Cosmological Initial Conditions](#user-content-link14)
**Authors:** Thibaut L. Francois, Alessia Gualandris, Walter Dehnen

15. [Disentangling the dark and stellar mass through precise lens modelling of the JWST observation of lensed quasar WFI2033--4723](#user-content-link15)
**Authors:** Tian Li, Thomas E. Collett, Coleman M. Krawczyk, Wolfgang J. R. Enzi, Aymeric Galan

16. [CARPP: Parametric Radiative-Transfer Fitting of Molecular Cores from Dust Continuum Data](#user-content-link16)
**Authors:** Yuchen Xing, Di Li, Nannan Yue, Zhiyuan Ren, Qizhou Zhang, Sihan Jiao, Xin Lyu, Jiawei Liu

17. [There is no single density: star-forming regions and galaxies hold more dense ionized gas than long assumed](#user-content-link17)
**Authors:** J. Eduardo M\'endez-Delgado, Christophe Morisset, William J. Henney, Niv Drory, Oleg V. Egorov, Sebasti\'an F. S\'anchez, Juna A. Kollmeier, Kathryn Kreckel, Guillermo Blanc, Gra\.zyna Stasi\'nska, Evelyn J. Johnston, H\'ector J. Ibarra-Medel, Alfredo J. Mej\'ia-Narv\'aez, C\'esar Esteban, Jorge Garc\'ia-Rojas, Amrita Singh, Ivan Yu. Katkov, Evan D. Skillman, Rogelio Orozco-Duarte, Igor A. Zinchenko, Alejandra Z. Lugo-Aranda, Aida Wofford, Simon C. O. Glover, Evgeniya Egorova, Rodolfo de J. Zerme\~no, Lesly C. Casta\~neda-Carlos, Fu-Heng Liang, Natascha Sattler, Irene Cruz-Gonz\'alez, Joel R. Brownstein, Thomas Hilder, Donald P. Schneider

18. [Compact Objects Merging with Stars as an Origin of Ultra-Long Gamma-Ray Bursts and Luminous Fast Blue Optical Transients](#user-content-link18)
**Authors:** V. Ashley Villar, Anya E. Nugent, Eric Burns, Brian D. Metzger, Tarraneh Eftekhari, Jakub Klencki, Christopher L. Fryer

19. [Multipolar structure of the local expansion rate from incomplete sky data](#user-content-link19)
**Authors:** Jo\~ao G. Vicente, Thiago S. Pereira, Ricardo G. Rodrigues, Sandro D. P. Vitenti, Vitoria M. Gomes

20. [The DESI View of the Faint Radio Source Population in LoTSS DR2](#user-content-link20)
...
21. [Exploring the effect of mixing in Low-Luminosity Type IIp Supernovae by modeling SN 2024abfl](#user-content-link21)
**Authors:** Akshith Karri, Abigail Polin, Paul Duffell

22. [Force convergence in Monte Carlo Lyman-alpha radiative transfer](#user-content-link22)
**Authors:** Joshua Kasiri (UT Dallas), Aaron Smith (UT Dallas), Kevin Lorinc (UT Dallas), Olof Nebrin (Stockholm), Kazutaka Kimura (Tohoku)

23. [Subaru meets JWST: A Direct Measurement of Ly$\boldsymbol{\alpha}$ Escape Fraction at $\boldsymbol{z\simeq6.2}$ with Dual Narrow-Band Imaging](#user-content-link23)
...
24. [Catching Disguised Transients with ASTRANet: Anomaly-Aware Spectroscopic Classification and Conformal Calibration](#user-content-link24)
...
25. [XShooter DESI Lens Program: Sample characterization](#user-content-link25)
...
26. [The Three Hundred Project: validating $H_0$ inference from mock X-ray and millimetre analyses of galaxy clusters](#user-content-link26)
**Authors:** F. De Luca, H. Bourdin, P. Mazzotta, E. Rasia, A. Kozmanyan, W. Cui, M. De Petris, D. de Andres, G. Yepes

27. [A semi-analytical approach to cosmic void evolution](#user-content-link27)
**Authors:** A. N. Baushev, A. G. Nikiforov, M. V. Barkov

28. [Lambda as a Probe of Lensing Consistency](#user-content-link28)
**Authors:** Yuan Shi, Li Cui, Carlo Giocoli

29. [Microscopic description of $^{12}$C+$^{12,13}$C fusion reactions at nuclear astrophysical energies](#user-content-link29)
**Authors:** K. Nagao, K. Hagino, K. Uzawa

30. [Multipolar Dark Matter Freeze-out in an Early Matter-Dominated Universe](#user-content-link30)
**Authors:** Debajit Bose, Prolay Chanda, Suvam Maharana, Poulami Mondal

31. [Probing Quadratically Coupled Ultralight Dark Matter with the Laser Interferometer Space Antenna](#user-content-link31)
**Authors:** Xucheng Gan, Hyungjin Kim, Anna-Malin Lemke, Andrea Mitridate

32. [DegenDetector: Symbolic Recovery of Parameter Degeneracies in Bayesian Posteriors](#user-content-link32)
**Authors:** Chaipat Tirapongprasert, Matthew Ho

33. [A Transport Theory of Turbulent Coronal Heating in General Geometry](#user-content-link33)
**Authors:** Jonathan Squire, Benjamin D. G. Chandran, Toby Adkins, William A. Clarke, Romain Meyrand, Matthew W. Kunz

34. [The SANE, the MAD, and the Chimera](#user-content-link34)
**Authors:** George N. Wong, James M. Stone

35. [Can Distance Duality Violation Save Late-time Solutions to the Hubble Tension?](#user-content-link35)
**Authors:** Yashi Tiwari, Ujjwal Upadhyay, Shao-Jiang Wang, Vivian Poulin

36. [FAST Discovery of $\mu$Jy Radio Pulsations from PSR J2238+5903, Providing a DM Distance Anchor for the Candidate TeV Halo 1LHAASO J2238+5900](#user-content-link36)
...
37. [Enhancing Photometric Redshift Estimation for LSST with a Hybrid LSTM-Mixture Density Network](#user-content-link37)
**Authors:** Zhijian Luo, Yangyang Li, Xinyu Luo, Hubing Xiao, Wei Fang, Shaohua Zhang, Chenggang Shu

38. [Deuterium-Proton Fusion in an Effective Field Theory Constructed from On-Shell Amplitudes](#user-content-link38)
**Authors:** Tim M. P. Tait (University of California, Irvine)

39. [Intensity fluctuations of radio halo in galaxy cluster: Insights from power spectrum estimation](#user-content-link39)
**Authors:** Srijita Pal, Nirupam Roy, Sameer Salunkhe, Surajit Paul, Tanu Sharma, Samir Choudhuri

40. [Multi-Wavelength Signatures of a Giant Cometary Radio Halo in MACSJ0417-1154](#user-content-link40)
**Authors:** Ramananda Santra, Marco Balboni, Ruta Kale

41. [Cluster-Weighted Training of Deep Surrogate Models for Subgrid Turbulent Transport](#user-content-link41)
**Authors:** Rimsha Hameed Syeda, Dustin Kempton, Viacheslav Sadykov, Irina Kitiashvili, Rafal Angryk

42. [A Retrieval Framework for Observationally Constraining the Parameters of Circumplanetary Disks](#user-content-link42)
**Authors:** Aster Taylor, Fred Adams

43. [Causal Horizons, Geodesic Completeness and Stability in Slow Contraction Cosmology](#user-content-link43)
**Authors:** Mariam Khaldieh, Anna I. Rosenzweig, Paul J. Steinhardt

44. [Alcock-Paczynski Blinding Scheme for the Ly-$\alpha$ Forest Analysis](#user-content-link44)
**Authors:** G. Perez-Sanchez, S. F. Beltran, G. Niz, S. Brieden, L. Verde, A. Font-Ribera, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, B. Dey, P. Doel, S. Ferraro, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, A. X. Gonzalez-Morales, G. Gutierrez, H. K. Herrera-Alcantar, K. Honscheid, D. Huterer, M. Ishak, R. Joyce, A. Kremin, O. Lahav, A. Lambert, M. Landriau, L. Le Guillou, M. Manera, P. Martini, R. Miquel, S. Nadathur, N. Palanque-Delabrouille, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, E. F. Schlafly, D. Schlegel, M. Schubnell, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver

45. [Beyond {\Lambda}CDM with the SKA Observatory -- II: Unveiling the Secrets of the Early Universe](#user-content-link45)
**Authors:** Jos\'e Fonseca, Benedict Bahr-Kalus, Mario Ballardini, Matilde Barberi-Squarotti, Steven Cunnington, S\^ecloka L. Guedezounme, Dionysios Karagiannis, Samantha J. Rossiter, Ziad Sakr, Cora Uhlemann, Stefano Camera, Bikash R. Dinda, Cl\'audio Gomes, Roy Maartens, M\'ario G. Santos

46. [VAPOLA -- A multi-year, multi-band polarization survey of AGN and Sgr A* at mm wavelengths with ALMA I. Survey Overview and Science-Ready Archival Products](#user-content-link46)
**Authors:** Alejandro Mus, Ciriaco Goddi, Douglas Carlos, Vincenzo Galluzzi, Ezequiel Albentosa-Ruiz, Ivan Mart\'i-Vidal, Hugo Messias, Kazi L. J. Rygl, Geoffrey B. Crew, Lynn D. Matthews, Elisabetta Liuzzo, Nicola Marchili, Raphael P. Rolim, Mariafelicia De Laurentis, Rocco Lico, Cristiano Urban

47. [A Magnetar Engine and Circumstellar Medium Interaction: Synergistic Effects in Producing Superluminous Supernovae](#user-content-link47)
**Authors:** Guang-Lei Wu, Yun-Wei Yu, Liang-Duan Liu

48. [Detection of the Polycyclic Aromatic Hydrocarbon Phenalene (C$_{13}$H$_{10}$) in the Very Low Luminosity Object (VeLLO) MC27/L1521F](#user-content-link48)
...
49. [Multi-wavelength Constraints on the Transient EP250905a](#user-content-link49)
...
50. [Infrared-enhanced Photometric Redshifts for the Dark Energy Survey Y6 Gold catalogue](#user-content-link50)
**Authors:** M. M. Puebla, I. Sevilla-Noarbe, J. de Vicente, L. Toribio San Cipriano, J. Carretero, A. Drlica-Wagner, J. Garc\'ia-Bellido, D. Gruen, J. Gschwend, T. A. Manning, M. de la Osa, A. Porredon, N. Reynes, E. S\'anchez, P. Tallada, N. Weaverdyck

51. [Probing the origins. III. Exoplanet demographics across Galactic birth radii](#user-content-link51)
**Authors:** Juan Jos\'e Garc\'ia-Delgado, M. L. L. Dantas, Isabel Rebollido, Rodolfo Smiljanic

52. [The Status of Single Scalar Field Dark Energy](#user-content-link52)
**Authors:** Carlos Garc\'ia-Garc\'ia, Pedro G. Ferreira, William J. Wolf

53. [The statistics of curvature-profile dispersion in primordial black hole formation](#user-content-link53)
**Authors:** Albert Escriv\`a

54. [SACRA-K: A Performance-Portable Numerical Relativity Code with Kokkos](#user-content-link54)
**Authors:** Ming-Zhe Han, Kenta Kiuchi, Masaru Shibata

55. [Stellar J-Harvesting: a novel angular momentum technosignature and first search in the Kepler field](#user-content-link55)
**Authors:** Sahin Torlakcik

56. [Signal-to-Noise Ratio Contours for LISA](#user-content-link56)
**Authors:** Kai Schmitz, Joseph D. Romano

57. [Tilted thin accretion disks in the full Kerr spacetime and their implications](#user-content-link57)
**Authors:** K. S. Sruthy (MCNS, India), Chandrachur Chakraborty (MCNS, India), Sudip Bhattacharyya (TIFR, India, MIT, USA)

58. [The Southern-sky MWA Rapid Two-metre (SMART) pulsar survey--IV. Survey update and an atlas of 205 non-recycled southern pulsars](#user-content-link58)
...
59. [H\alpha\ clarifies picture of IIn supernova SN 2015da](#user-content-link59)
**Authors:** Nikolai Chugai

60. [Constraints on the properties of warm ionized gas from low-frequency hydrogen radio recombination lines](#user-content-link60)
**Authors:** Pedro Salas, Kimberly L. Emig, Matteo Luisi, D. Anish Roshi, Loren Anderson

61. [Successive Coronal Jets as Novel Facilitators for Filament Oscillation and Eruption](#user-content-link61)
**Authors:** Chengrui Zhou, Chun Xia, Wentai Fu, Hechao Chen, Qiaoling Li

62. [Photon Acceleration in Magnetized Plasma: A Mechanism for Fast Radio Bursts](#user-content-link62)
...
63. [Blind Line Search System: BLiSS](#user-content-link63)
**Authors:** Luis Abalo, Graciela Sanjurjo-Ferr\'in, Jessica Planelles-Villalva, Jos\'e Joaqu\'in Rodes-Roca, Jos\'e Miguel Torrej\'on

64. [Relativistic Mean Field Approach with Chiral Symmetry Breaking and Quark Confinement in the light of Astrophysical Observations](#user-content-link64)
**Authors:** Bikram Keshari Pradhan, Mohamad Chamseddine, J\'er\^ome Margueron, Hubert Hansen, Guy Chanfray, Jean-Paul Ebran, Elias Khan

65. [Nonlinear hydrodynamics in spinning neutron stars: Theoretical universal relations and equilibrium solutions](#user-content-link65)
...
66. [Beyond black hole spectroscopy: Quasinormal mode contamination by massless scalars](#user-content-link66)
**Authors:** Miguel Yulo Asuncion, Giovanni D'Addario, Thomas P. Sotiriou

67. [Leptogenesis and Low Reheating Temperatures](#user-content-link67)
**Authors:** Marcos A. G. Garcia, Stephen E. Henrich, Wenqi Ke, Keith A. Olive

68. [The Impact of Planetary Phase Functions on Exo-Earth Detectability with EXOSIMS](#user-content-link68)
**Authors:** Searra Foote, Tyler D. Robinson, Rhonda Morgan, Dmitry Savransky, Mario Damiano, Armen Tokadjian

69. [Precision three-Dimensional Atmospheric Neutrino Flux Calculation Based on Honda Flux Model](#user-content-link69)
**Authors:** Jie Cheng, Yu-Feng Li, Liang-Jian Wen

70. [Active galactic nuclei are not responsible for systematics in the empirical properties of type Ia supernovae](#user-content-link70)
**Authors:** Peter Clark

71. [Vetting Ambiguous Planetary Candidates (APC) in TESS Data: Insights from LATTE Package and Detection of Nine Potential Exoplanet Candidates](#user-content-link71)
**Authors:** Umer Hameed Khan, Khushlim Khan, Muhammad Zeshan Ashraf, A. Salam Khumber

72. [RedDots: Magnetic field of the nearby active M dwarf GJ 729, and a search for companions](#user-content-link72)
**Authors:** E. L. Brown, S. V. Jeffers, S. C. Marsden, F. Liebing, S. Bellotti, J. R. Barnes, C. A. Haswell, V. Koseleva

73. [Long-term speckle interferometric monitoring of binary systems II: 2007-2025 positional measurements and improvement of orbits](#user-content-link73)
**Authors:** Arina Mitrofanova, Vladimir Dyachenko, Anatoly Beskakotov, Alexander Maksimov, Margarita Butorina, Yuri Balega, Denis Rastegaev

74. [Space and Lunar Interferometry: Emerging Concepts and Pathways](#user-content-link74)
**Authors:** Gioia Rau

75. [Classification of blazars based on data-driven approaches](#user-content-link75)
**Authors:** Simone Vaccaro (Department of Physics "E. Pancini'', University Federico II of Napoli, Napoli, Italy), Maria Isabel Carnerero (INAF, Osservatorio Astrofisico di Torino, Pino Torinese, Italy), Claudia M. Raiteri (INAF, Osservatorio Astrofisico di Torino, Pino Torinese, Italy), Massimo Brescia (Department of Physics "E. Pancini'', University Federico II of Napoli, Napoli, Italy, INAF - Astronomical Observatory of Capodimonte, Napoli, Italy), Ylenia Maruccia (INAF - Astronomical Observatory of Capodimonte, Napoli, Italy), Natale De Bonis (Department of Physics "E. Pancini'', University Federico II of Napoli, Napoli, Italy), Giuseppe Riccio (INAF - Astronomical Observatory of Capodimonte, Napoli, Italy), Stefano Cavuoti (INAF - Astronomical Observatory of Capodimonte, Napoli, Italy, INFN section of Naples, Napoli, Italy)

76. [Collisionless and collisional kinetics of a plasma atmosphere with spatially and temporally intermittent heating at its base](#user-content-link76)
**Authors:** Luca Barbieri, Pascal D\'emoulin, Filippo Pantellini

77. [On-sky dark hole diggin' with implicit Electric Field Conjugation on MagAO-X](#user-content-link77)
**Authors:** S. Y. Haffert, J. Liberman, J. R. Males, L. M. Close, W. B. Foster, K. Van Gorkom, O. Guyon, A. D. Hedglen, P. T. Johnson, M. Y. Kautz, J. K. Kueny, J. Li, J. D. Long, J. Lumbres, M. Mars, E. A. McEwen, A. McLeod, L. Schatz, E. Tonucci, K. Twitchell

78. [Node-locked phase of annual modulations from the gravitational chiral anomaly in the solar Kerr field](#user-content-link78)
**Authors:** M. Misiaszek (Jagiellonian University, Krakow)

79. [Decoupling Limit of Quiver Theories and the Angular Spectra of Extreme C-metrics](#user-content-link79)
**Authors:** Peng Yang, Kilar Zhang

80. [Near-perihelion activity and composition of 3I/ATLAS from JUICE/MAJIS observations](#user-content-link80)
**Authors:** D. Bockelee-Morvan, F. Poulet, Y. Langevin, B. Seignovert, C. Leyrat, G. Piccioni, C. Royer, S. Rodriguez, E. d'Aversa, R. Brunetto, J. Carter, T. Cavalie, M. De Sanctis, E. Lellouch, A. Migliorini, C. Pilorget, E. Quirico, S. Robert, F. Tosi

81. [TH\'EMIS: a calibration-free solar telescope](#user-content-link81)
**Authors:** V. Bommier, B. Gelly, R. Douet

82. [Multi-Path Quasi-Periodic Fast-mode Propagating Magnetoacoustic Waves to Diagnose Coronal Magnetic Field and Flaring Core](#user-content-link82)
**Authors:** Yuhu Miao

83. [Investigation on the Relation between Active Regions' Compliance with Empirical Laws and Flare Productivity](#user-content-link83)
**Authors:** Jinhui Pan, Rui Liu, Jiangtao Su, Jie Jiang

84. [Cataclysmic Variables Photometric Periods from TESS](#user-content-link84)
**Authors:** S. O. Kepler, Alejandra Daniela Romero, Larissa Luciano Amorim, Marcos Perez Diaz

85. [Phase-dependent chemistry of WASP-43 b revealed with a suite of one-, two-, and three-dimensional models](#user-content-link85)
**Authors:** Robin Baeyens, Julianne I. Moses, Jasmina Blecic, Elspeth K. H. Lee, Lucas Teinturier, Shang-Min Tsai, Jeehyun Yang, Jingxuan Yang, Ludmila Carone, Renyu Hu, Sven Kiefer, Anjali A. A. Piette, Taylor J. Bell, Nicolas Crouzet, Ian Dobbs-Dixon, Christiane Helling, Nicolas Iro, Dominic Samra, Olivia Venot, Jean-Michel D\'esert

86. [Development of a Raman Lidar for the Southern Site of the Cherenkov Telescope Array Observatory](#user-content-link86)
**Authors:** Patrick Brun, Omar Gabella, Stephane Rivoire, George Vasileiadis

87. [On-Orbit Calibration of Danuri/PolCam. II. Radiometric Calibration](#user-content-link87)
**Authors:** Kilho Baek, Sungsoo S. Kim, Minsup Jeong, Young-Jun Choi

88. [Methods of Observing and Characterising the Ionosphere with SKA-Low](#user-content-link88)
**Authors:** John Morgan, Biagio Forte, Kshitija Deshpande, Andrzej Krankowski, Mario Bisi

---

## 1. [Bo\"otes III is a Tidally Disrupting Ultra-Faint Dwarf Galaxy on an Eccentric Polar Orbit](https://arxiv.org/abs/2607.07803) <a id="link1"></a>

**ArXiv ID:** 2607.07803

**Authors:** Ting S. Li (the S5 Collaboration), Denis Erkal (the S5 Collaboration), Andrew B. Pace (the S5 Collaboration), Jiaxun Yang (the S5 Collaboration), Sergey E. Koposov (the S5 Collaboration), Jo Bovy (the S5 Collaboration), Nathan R. Sandford (the S5 Collaboration), Andrew P. Li (the S5 Collaboration), Gustavo E. Medina (the S5 Collaboration), Lara R. Cullinane (the S5 Collaboration), Gary S. Da Costa (the S5 Collaboration), Alexander P. Ji (the S5 Collaboration), Kyler Kuehn (the S5 Collaboration), Geraint F. Lewis (the S5 Collaboration), Guilherme Limberg (the S5 Collaboration), Sarah L. Martell (the S5 Collaboration), Aldo Mura-Guzm\'an (the S5 Collaboration), Nora Shipp (the S5 Collaboration), Yong Yang (the S5 Collaboration), Daniel B. Zucker (the S5 Collaboration), Kaia R. Atzberger (the S5 Collaboration), Joss Bland-Hawthorn (the S5 Collaboration), John D. Dixon (the S5 Collaboration)

**Abstract:** We present updated systemic properties of the ultra-faint dwarf galaxy Bo\"otes III from the Southern Stellar Stream Spectroscopic Survey (S$^5$). We identify 21 high-probability members and measure a velocity dispersion of $\sigma_{v} = 1.69^{+1.03}_{-0.85}$ km s$^{-1}$, about six times smaller than the previously reported $10.7 \pm 3.5$ km s$^{-1}$, and a mean metallicity of [Fe/H] $= -2.34 \pm 0.11$. The revised dispersion brings Bo\"otes III in line with other tidally disrupting dwarfs such as Antlia II and Crater II. Orbit integrations in a Milky Way (MW) + Large Magellanic Cloud (LMC) potential confirm a highly eccentric ($e \approx 0.8$), polar ($i \approx 89.5^\circ$) orbit with a recent pericentric passage $\sim 0.14$ Gyr ago at $r_{\rm peri} \approx 9.5$ kpc. Bo\"otes III is thus likely actively tidally disrupting, as its tidal radius at pericenter, $r_t \approx 164$ pc, is only $\sim 0.35$ of its half-light radius. The unusually low dispersion also implies that Bo\"otes III has either lost most of its dark matter to tides or hosts a cored inner density profile, making it a probe of the nature of dark matter. Simulated tidal streams are broadly consistent with the Styx stellar stream, though the predicted track and kinematics are sensitive to the MW halo mass, LMC mass, and solar velocity. Bo\"otes III overlaps the Typhon stream in integrals-of-motion space but has a much lower mean metallicity, suggesting the two are not the same system but may have had a common group infall origin. Sagittarius-stream contamination prevents a direct tidal-tail detection, so deep spectroscopic follow-up remains essential, both to confirm Styx as a genuine stream and to establish it as Bo\"otes III's tidal tail.

**Comment:** Directly matches Near-Field Cosmology: focuses on the ultra-faint dwarf galaxy Boötes III, its kinematics, metallicity, tidal disruption, and implications for dark matter density profiles. Also discusses historic interactions and satellite properties. Highly relevant.
...
## 2. [Beryllium enhancement in stars of the accreted Thamnos-2 system](https://arxiv.org/abs/2607.08179) <a id="link2"></a>
...
**Comment:** This paper studies beryllium abundances in stars associated with the Thamnos-2 substructure, a stellar population accreted by the Milky Way. This is highly relevant to near-field cosmology, specifically the study of accreted stellar halo substructures and their chemical signatures. The focus on rare enrichment events in a Milky Way accreted dwarf system is a direct match to the 'Near-Field Cosmology' criterion.
...
## 3. [Physics of Eclipsing Binaries. VI. Hot, compact stars](https://arxiv.org/abs/2607.07909) <a id="link3"></a>
...
**Comment:** Presents updates to the PHOEBE code for modeling eclipsing binaries, including new model atmospheres and limb-darkening coefficients for hot, compact stars. This is directly relevant to the 'Stellar Models' criterion, as it provides new stellar atmosphere models and bolometric corrections.
...
## 4. [Supersonic Motion in the Driving Region of M82](https://arxiv.org/abs/2607.07782) <a id="link4"></a>
...
**Comment:** This paper studies the multiphase outflow in the starburst galaxy M82, focusing on the driving mechanism and energetics of the hot wind. While M82 is more massive than the LMC, the paper directly addresses star-formation-driven outflows, including mass and energy loading, and the phase structure of the outflow. This matches the 'Star Formation Driven Outflows' criterion, though with slightly reduced weight due to the galaxy's mass.
...
## 6. [Multiple populations along the asymptotic giant branch: a Gaia+APOGEE study of 22 Galactic globular clusters](https://arxiv.org/abs/2607.08376) <a id="link6"></a>
...
**Comment:** Focuses on multiple stellar populations in globular clusters, using resolved stellar abundances and color-magnitude diagrams. While it uses CMDs, the work is on globular clusters, not galaxies, so it does not match the resolved star formation history criterion for galaxies. Borderline relevance.
...
## 7. [Effects of low resolution on the column density PDF of molecular clouds](https://arxiv.org/abs/2607.08419) <a id="link7"></a>
...
**Comment:** This paper studies the effects of observational resolution on the column density PDFs of molecular clouds, which are important for understanding star formation processes. While it is relevant to star formation in molecular clouds, it does not directly address resolved star formation histories from color-magnitude diagrams, nor does it focus on dwarf galaxies or galaxy-scale outflows.
...
## 8. [Deep Spectroscopic Follow-Up of Maisie's Galaxy -- A Typical Galaxy in the Early Universe](https://arxiv.org/abs/2607.08749) <a id="link8"></a>
...
**Comment:** This paper presents deep spectroscopic follow-up of a high-redshift galaxy, measuring star formation rates, metallicity, and ionization parameters. While it discusses star formation and galaxy properties, it focuses on a typical galaxy at z>10, not on resolved star formation histories from color-magnitude diagrams or on dwarf galaxies in the local universe.
...
## 9. [On the detection of Population III galaxies: Emission Line Diagnostics for Hybrid Stellar Populations](https://arxiv.org/abs/2607.07832) <a id="link9"></a>
...
**Comment:** This paper investigates emission line diagnostics for detecting Population III stars in galaxies using simulations and photoionization models. While it deals with star formation in the early universe, it does not focus on resolved star formation histories, dwarf galaxies, or local universe near-field cosmology. The relevance is borderline due to the connection to star formation diagnostics.
...
## 10. [Thermal Sunyaev-Zel'dovich Measurements of Locally Bright Galaxies with ACT DR6: Radio Source Contamination and Excess Compton-y Signal](https://arxiv.org/abs/2607.08721) <a id="link10"></a>
...
**Comment:** This paper measures the thermal Sunyaev-Zel'dovich effect in galaxies and discusses radio source contamination and excess Compton-y signal. While it touches on the circumgalactic medium and feedback, the focus is on more massive galaxies (Locally Bright Galaxies) and not specifically on dwarfs or star-formation-driven outflows. The connection to CGM is present but not central or focused on dwarfs.
...
## 11. [Milky Way Near Twins (MWNeTs). I. A Hierarchical Framework for Identifying the Evolutionary Counterparts of the Milky Way](https://arxiv.org/abs/2607.08336) <a id="link11"></a>
...
**Comment:** This paper introduces a framework for identifying Milky Way analogues and their evolutionary counterparts, including diagnostics such as merger history, circumgalactic medium properties, and globular cluster systems. While the focus is on Milky Way-mass galaxies (not dwarfs), the discussion of circumgalactic medium and evolutionary diagnostics is tangentially relevant to near-field cosmology and the circumgalactic medium criterion, but not a direct match.
...
## 12. [The incidence of eROSITA X-ray AGN in the local Universe: from dwarf to massive galaxies](https://arxiv.org/abs/2607.07795) <a id="link12"></a>

**ArXiv ID:** 2607.07795

**Authors:** Z. Igo, A. Merloni, A. Georgakakis, J. Buchner, R. Arcodia, M. Salvato, J. Aird, K. Nandra, B. Trakhtenbrot, P. G. Boorman, J. Comparat, G. Lamer, B. Laloux, M. Kluge, W. Roster, E. Bulbul, F. Balzer, T. Dwelly, W. N. Brandt, R. Seppi, S. Morrison, E. Kyritsis, J. Gelfand, S. F. Anderson, D. P. Schneider

**Abstract:** Combining deep, wide-area X-ray surveys with multi-wavelength catalogues provides insights into rare, highly-accreting AGN and low-mass galaxies at low redshift, the latter potentially representing local analogues of the first galaxies in the early Universe. We use the four-pass eROSITA All Sky Survey to select the largest catalogue of X-ray AGN in a highly complete sample of low-redshift galaxies, including low-mass (logM*/Msol<10) ones. We probe their distribution of specific accretion rates, $\lambda$_SAR, and the cumulative AGN fraction above varying $\lambda$_SAR thresholds. Our parent sample consists of ~5.35 million galaxies selected from the Legacy Survey DR10 with z-band fluxes brighter than 20 mag and redshifts 0.0310^-3, we find a cumulative AGN fraction of ~1% for low-mass galaxies, placing a firm lower limit on the black hole occupation fraction in this regime. Overall, our specific accretion rate distributions, sampling down to the as-of-yet unexplored low-mass regime, highlight a more nuanced, mass-dependent view of AGN growth and accretion history that must be taken into account in future modelling.

**Comment:** Touches on dwarf galaxies but focuses on AGN incidence and black hole occupation fraction in low-mass galaxies, not on their star formation histories, quenching, or near-field cosmology. Only tangentially relevant.
...
## 13. [Robust Heteroskedastic Matrix Factorization: A Generalization of PCA that Flags Outliers and Handles Missing Data](https://arxiv.org/abs/2607.08081) <a id="link13"></a>
...
**Comment:** Presents a new robust matrix factorization method (RHMF) and applies it to Gaia DR3 RVS spectra to identify anomalous main-sequence stars. While the method could be useful for stellar population studies, the focus is on methodology and outlier detection, not on resolved star formation histories, stellar models, or near-field cosmology.
...
## 14. [Scaling Relations for Binary Black Hole Merger Times from Cosmological Initial Conditions](https://arxiv.org/abs/2607.07813) <a id="link14"></a>
...
**Comment:** This paper presents high-resolution simulations of massive black hole binary mergers, focusing on scaling relations for merger times and their connection to host galaxy properties. While it uses cosmological simulations and discusses galaxy mergers, its focus is on black hole binaries in massive galaxies, not on dwarf galaxies, resolved star formation histories, or the other core topics.
...
## 15. [Disentangling the dark and stellar mass through precise lens modelling of the JWST observation of lensed quasar WFI2033--4723](https://arxiv.org/abs/2607.08576) <a id="link15"></a>
...
**Comment:** This paper uses lens modeling to disentangle dark and stellar mass in a lensed quasar system. While it discusses dark matter and stellar mass decomposition, the focus is on a massive galaxy lens, not on dwarf galaxies or near-field systems. It does not address the core-cusp problem, satellite galaxies, or resolved star formation histories. Only a very weak connection to dark matter density profiles, but not in the context of the Milky Way or dwarfs.
...
## 16. [CARPP: Parametric Radiative-Transfer Fitting of Molecular Cores from Dust Continuum Data](https://arxiv.org/abs/2607.08192) <a id="link16"></a>
...
**Comment:** The paper introduces a new radiative transfer fitting package (CARPP) for molecular cores using dust continuum data. While it provides new tools for analyzing density and temperature profiles in star-forming regions, it does not directly address resolved star formation histories of galaxies or the other core topics.
...
## 17. [There is no single density: star-forming regions and galaxies hold more dense ionized gas than long assumed](https://arxiv.org/abs/2607.07973) <a id="link17"></a>
...
**Comment:** This paper discusses the density structure of ionized gas in star-forming regions and galaxies, challenging the single-density assumption. While it touches on star-forming regions and the ISM, it does not specifically address dwarf galaxies, resolved star formation histories, or outflows. It is tangentially related to the ISM/CGM structure but not focused on dwarfs.
...
## 18. [Compact Objects Merging with Stars as an Origin of Ultra-Long Gamma-Ray Bursts and Luminous Fast Blue Optical Transients](https://arxiv.org/abs/2607.07819) <a id="link18"></a>
...
**Comment:** This paper investigates the origin of ultra-long gamma-ray bursts and luminous fast blue optical transients, focusing on compact object mergers and their host galaxy environments. It notes that these events occur in lower-mass galaxies, but does not focus on dwarf satellites, resolved star formation histories, or the other core topics.
...
## 19. [Multipolar structure of the local expansion rate from incomplete sky data](https://arxiv.org/abs/2607.07821) <a id="link19"></a>
...
**Comment:** This paper reconstructs the multipolar structure of the local expansion rate using Cosmicflows-4 data. While it deals with local universe structure and bulk flows, it does not focus on satellite galaxies, resolved star formation histories, or the CGM of dwarfs. Only a very weak connection to near-field cosmology via local flows, but not a direct match.
...
## 20. [The DESI View of the Faint Radio Source Population in LoTSS DR2](https://arxiv.org/abs/2607.07818) <a id="link20"></a>
...
**Comment:** This paper analyzes the faint radio source population using LoTSS and DESI data, classifying sources as star-forming galaxies or AGN. While it touches on galaxy evolution and star formation, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 21. [Exploring the effect of mixing in Low-Luminosity Type IIp Supernovae by modeling SN 2024abfl](https://arxiv.org/abs/2607.08424) <a id="link21"></a>
...
**Comment:** The paper models low-luminosity Type IIp supernovae using MESA and STELLA, focusing on mixing in supernova ejecta. While it uses stellar models, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on galaxy-scale processes or resolved star formation histories.
...
## 22. [Force convergence in Monte Carlo Lyman-alpha radiative transfer](https://arxiv.org/abs/2607.08726) <a id="link22"></a>
...
**Comment:** Examines convergence in Monte Carlo Lyman-alpha radiative transfer simulations, focusing on force calculations in static spherical clouds. While relevant to radiative transfer methods, it does not address galaxy simulations, near-field cosmology, or other core topics.
...
## 24. [Catching Disguised Transients with ASTRANet: Anomaly-Aware Spectroscopic Classification and Conformal Calibration](https://arxiv.org/abs/2607.08044) <a id="link24"></a>
...
**Comment:** This paper introduces a new framework for anomaly-aware spectroscopic classification of transients, which is relevant for time-domain astronomy and transient discovery. However, it does not focus on any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The methods could be tangentially useful for identifying rare events, but not directly relevant.
...
## 25. [XShooter DESI Lens Program: Sample characterization](https://arxiv.org/abs/2607.08562) <a id="link25"></a>
...
**Comment:** Characterizes lens and source samples for strong lensing systems in large imaging surveys. While lensing can be relevant for cosmology, this work focuses on redshift measurements and sample characterization, not on satellite galaxies, resolved star formation histories, or galaxy simulations.
...
## 26. [The Three Hundred Project: validating $H_0$ inference from mock X-ray and millimetre analyses of galaxy clusters](https://arxiv.org/abs/2607.08613) <a id="link26"></a>
...
**Comment:** Focuses on H0 inference from mock X-ray and millimetre analyses of galaxy clusters using simulations. While it uses hydrodynamical simulations, the focus is on massive clusters and cosmological parameters, not on galaxy-scale simulations or near-field cosmology. Irrelevant.
...
## 27. [A semi-analytical approach to cosmic void evolution](https://arxiv.org/abs/2607.08414) <a id="link27"></a>
...
**Comment:** Presents a semi-analytical model for cosmic void evolution. While related to large-scale structure, it does not address galaxy-scale processes or any core topic.
...
## 28. [Lambda as a Probe of Lensing Consistency](https://arxiv.org/abs/2607.08286) <a id="link28"></a>
...
**Comment:** This paper introduces a framework for mass reconstruction in galaxy clusters using lensing. While it deals with galaxy clusters, it does not address dwarf galaxies, star formation histories, or the circumgalactic medium of dwarfs.
...
## 29. [Microscopic description of $^{12}$C+$^{12,13}$C fusion reactions at nuclear astrophysical energies](https://arxiv.org/abs/2607.08502) <a id="link29"></a>
...
**Comment:** This paper models the 12C+12C and 12C+13C fusion reactions at nuclear astrophysical energies. The focus is on nuclear reaction rates relevant for stellar evolution, but it does not present new stellar evolutionary tracks or atmosphere models, nor does it address galaxy-scale topics.
...
## 30. [Multipolar Dark Matter Freeze-out in an Early Matter-Dominated Universe](https://arxiv.org/abs/2607.07956) <a id="link30"></a>
...
**Comment:** The paper discusses dark matter freeze-out in an early matter-dominated universe, focusing on particle physics and cosmology. While dark matter is relevant to cosmology, the work does not address near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 31. [Probing Quadratically Coupled Ultralight Dark Matter with the Laser Interferometer Space Antenna](https://arxiv.org/abs/2607.08248) <a id="link31"></a>
...
**Comment:** This paper investigates signals from ultralight dark matter in LISA. While dark matter is a cosmological topic, the focus is on gravitational wave detection and not on near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 32. [DegenDetector: Symbolic Recovery of Parameter Degeneracies in Bayesian Posteriors](https://arxiv.org/abs/2607.08755) <a id="link32"></a>
...
**Comment:** Introduces a framework for identifying parameter degeneracies in Bayesian posteriors. This is a general statistical/methodological tool and not directly related to any of the core astrophysical topics.
...
## 33. [A Transport Theory of Turbulent Coronal Heating in General Geometry](https://arxiv.org/abs/2607.08036) <a id="link33"></a>
...
**Comment:** Presents a new theory for turbulent coronal heating in the solar corona, with broader applications to magnetospheres and accretion flows, but not to galaxies or the core topics. Irrelevant.
...
## 34. [The SANE, the MAD, and the Chimera](https://arxiv.org/abs/2607.07784) <a id="link34"></a>
...
**Comment:** This paper presents GRMHD simulations of black hole accretion flows, focusing on SANE, MAD, and a new 'Chimera' regime. While it is a numerical simulation, it is not about galaxies but about black hole accretion disks, which are specifically listed as irrelevant.
...
## 35. [Can Distance Duality Violation Save Late-time Solutions to the Hubble Tension?](https://arxiv.org/abs/2607.08654) <a id="link35"></a>
...
**Comment:** This paper focuses on the Hubble tension and cosmic distance duality, which are cosmological parameters and not directly related to near-field cosmology, resolved star formation histories, dwarf galaxies, or the other specified criteria.
...
## 36. [FAST Discovery of $\mu$Jy Radio Pulsations from PSR J2238+5903, Providing a DM Distance Anchor for the Candidate TeV Halo 1LHAASO J2238+5900](https://arxiv.org/abs/2607.08596) <a id="link36"></a>
...
**Comment:** This paper reports the detection of radio pulsations from a gamma-ray pulsar and provides a distance anchor for a TeV halo. While it involves pulsars and TeV halos, it does not address near-field cosmology, dwarf galaxies, or the other core topics.
...
## 37. [Enhancing Photometric Redshift Estimation for LSST with a Hybrid LSTM-Mixture Density Network](https://arxiv.org/abs/2607.07960) <a id="link37"></a>
...
**Comment:** This paper presents a machine learning method for photometric redshift estimation for LSST. While relevant for cosmology, it does not address any of the specified criteria such as near-field cosmology, dwarf galaxies, or stellar models.
...
## 38. [Deuterium-Proton Fusion in an Effective Field Theory Constructed from On-Shell Amplitudes](https://arxiv.org/abs/2607.05514) <a id="link38"></a>
...
**Comment:** This paper focuses on nuclear reaction rates relevant for Big Bang nucleosynthesis, specifically deuterium-proton fusion. While BBN is broadly related to cosmology, the work is not focused on near-field cosmology, resolved star formation histories, galaxy simulations, or any of the other core topics. No direct match to any listed criteria.
...
## 39. [Intensity fluctuations of radio halo in galaxy cluster: Insights from power spectrum estimation](https://arxiv.org/abs/2607.07814) <a id="link39"></a>
...
**Comment:** This paper analyzes radio halos in galaxy clusters to study turbulence and merger history in the intra-cluster medium. While it deals with galaxy clusters, it does not address dwarf galaxies, resolved star formation histories, or the circumgalactic medium of dwarfs.
...
## 40. [Multi-Wavelength Signatures of a Giant Cometary Radio Halo in MACSJ0417-1154](https://arxiv.org/abs/2607.07750) <a id="link40"></a>
...
**Comment:** The study focuses on radio halos in a galaxy cluster, analyzing non-thermal emission and merger activity. While it touches on galaxy evolution, it does not address dwarf galaxies, star formation histories, or galaxy simulations.
...
## 41. [Cluster-Weighted Training of Deep Surrogate Models for Subgrid Turbulent Transport](https://arxiv.org/abs/2607.07925) <a id="link41"></a>
...
**Comment:** Applies machine learning to model subgrid turbulence in the solar atmosphere using simulations. The focus is on turbulence modeling in the Sun, not on galaxy simulations, resolved star formation histories, or other core topics.
...
## 42. [A Retrieval Framework for Observationally Constraining the Parameters of Circumplanetary Disks](https://arxiv.org/abs/2607.08026) <a id="link42"></a>
...
**Comment:** Develops a retrieval framework for circumplanetary disks, focusing on protoplanetary systems and planet formation. Does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 43. [Causal Horizons, Geodesic Completeness and Stability in Slow Contraction Cosmology](https://arxiv.org/abs/2607.07815) <a id="link43"></a>
...
**Comment:** Discusses theoretical aspects of slow contraction cosmology and causal horizons. This is a fundamental cosmology paper, not related to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 44. [Alcock-Paczynski Blinding Scheme for the Ly-$\alpha$ Forest Analysis](https://arxiv.org/abs/2607.07875) <a id="link44"></a>
...
**Comment:** Presents a blinding method for Lyman-alpha forest cosmological analysis. While relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, or other core topics. Irrelevant.
...
## 45. [Beyond {\Lambda}CDM with the SKA Observatory -- II: Unveiling the Secrets of the Early Universe](https://arxiv.org/abs/2607.08593) <a id="link45"></a>
...
**Comment:** This paper discusses the SKA's potential for probing the early universe, focusing on large-scale structure, primordial non-Gaussianity, and inflation. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specific criteria.
...
## 46. [VAPOLA -- A multi-year, multi-band polarization survey of AGN and Sgr A* at mm wavelengths with ALMA I. Survey Overview and Science-Ready Archival Products](https://arxiv.org/abs/2607.08657) <a id="link46"></a>
...
**Comment:** This paper presents a multi-year polarization survey of AGN and Sgr A* with ALMA, focusing on data products for AGN and the Galactic Center. While it may be useful for studies of AGN jets and black holes, it does not address galaxies, star formation histories, or the other relevant criteria.
...
## 47. [A Magnetar Engine and Circumstellar Medium Interaction: Synergistic Effects in Producing Superluminous Supernovae](https://arxiv.org/abs/2607.08216) <a id="link47"></a>
...
**Comment:** This paper models superluminous supernovae with a hybrid magnetar and circumstellar medium interaction. While it discusses star formation and feedback in a broad sense, it does not focus on galaxy-scale outflows, dwarf galaxies, or the CGM. No direct relevance to the core topics.
...
## 48. [Detection of the Polycyclic Aromatic Hydrocarbon Phenalene (C$_{13}$H$_{10}$) in the Very Low Luminosity Object (VeLLO) MC27/L1521F](https://arxiv.org/abs/2607.08699) <a id="link48"></a>
...
**Comment:** This paper reports the detection of a PAH molecule in a dense core in Taurus. The focus is on astrochemistry and the ISM in star-forming regions, not on galaxies, resolved star formation histories, or near-field cosmology.
...
## 49. [Multi-wavelength Constraints on the Transient EP250905a](https://arxiv.org/abs/2607.08090) <a id="link49"></a>
...
**Comment:** This paper analyzes a fast X-ray transient and its possible host galaxies, including lensing effects. The focus is on transient phenomena and not on galaxies, star formation histories, or near-field cosmology.
...
## 50. [Infrared-enhanced Photometric Redshifts for the Dark Energy Survey Y6 Gold catalogue](https://arxiv.org/abs/2607.07771) <a id="link50"></a>
...
**Comment:** This paper improves photometric redshifts for the DES Y6 Gold catalogue by adding infrared data. While it is relevant for large-scale structure and cosmology, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 51. [Probing the origins. III. Exoplanet demographics across Galactic birth radii](https://arxiv.org/abs/2607.07787) <a id="link51"></a>
...
**Comment:** This paper studies exoplanet demographics and their relation to Galactic birth radii, radial mixing, and planetary architectures. It does not address dwarf galaxies, star formation histories, or galaxy simulations.
...
## 52. [The Status of Single Scalar Field Dark Energy](https://arxiv.org/abs/2607.07777) <a id="link52"></a>
...
**Comment:** This paper is about scalar field dark energy models and their observational constraints, which is not directly related to any of the specified criteria such as near-field cosmology, dwarf galaxies, or stellar models.
...
## 53. [The statistics of curvature-profile dispersion in primordial black hole formation](https://arxiv.org/abs/2607.08738) <a id="link53"></a>
...
**Comment:** This paper studies the statistics of curvature-profile dispersion in primordial black hole (PBH) formation. While it is a theoretical cosmology paper, it does not address near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations. PBH formation is not among the listed relevant topics.
...
## 54. [SACRA-K: A Performance-Portable Numerical Relativity Code with Kokkos](https://arxiv.org/abs/2607.08743) <a id="link54"></a>
...
**Comment:** Describes a performance-portable numerical relativity code for compact object mergers (black holes, neutron stars). Not related to galaxy simulations or any core topic.
...
## 55. [Stellar J-Harvesting: a novel angular momentum technosignature and first search in the Kepler field](https://arxiv.org/abs/2607.07781) <a id="link55"></a>
...
**Comment:** This paper proposes a technosignature based on stellar angular momentum extraction and searches for it in Kepler stars. It is not related to galaxies, star formation, or any of the relevant criteria.
...
## 56. [Signal-to-Noise Ratio Contours for LISA](https://arxiv.org/abs/2607.08445) <a id="link56"></a>
...
**Comment:** This paper derives new expressions for the signal-to-noise ratio for LISA's gravitational wave background measurements. It is focused on gravitational wave detection methodology, not on galaxies, star formation, or near-field cosmology.
...
## 57. [Tilted thin accretion disks in the full Kerr spacetime and their implications](https://arxiv.org/abs/2607.08728) <a id="link57"></a>
...
**Comment:** This paper develops a new analytic and numerical model for tilted thin accretion disks in the Kerr spacetime, with implications for X-ray observations of accreting black holes and naked singularities. The focus is on accretion disk physics and strong gravity, not on galaxies, star formation, or any of the core topics.
...
## 58. [The Southern-sky MWA Rapid Two-metre (SMART) pulsar survey--IV. Survey update and an atlas of 205 non-recycled southern pulsars](https://arxiv.org/abs/2607.08106) <a id="link58"></a>
...
**Comment:** Presents a pulsar survey and catalog, with applications to ISM studies and SKA, but not to galaxy evolution, near-field cosmology, or other core topics.
...
## 59. [H\alpha\ clarifies picture of IIn supernova SN 2015da](https://arxiv.org/abs/2607.08693) <a id="link59"></a>
...
**Comment:** Focuses on a Type IIn supernova and its circumstellar interaction, not on galaxies, star formation histories, or near-field cosmology.
...
## 60. [Constraints on the properties of warm ionized gas from low-frequency hydrogen radio recombination lines](https://arxiv.org/abs/2607.08542) <a id="link60"></a>
...
**Comment:** Studies warm ionized gas in the Milky Way using radio recombination lines. Focuses on ISM properties, not on galaxies, star formation histories, or near-field cosmology.
...
## 61. [Successive Coronal Jets as Novel Facilitators for Filament Oscillation and Eruption](https://arxiv.org/abs/2607.08390) <a id="link61"></a>
...
**Comment:** Studies solar filament eruptions and coronal jets, which are solar physics topics and not related to the core topics of near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 62. [Photon Acceleration in Magnetized Plasma: A Mechanism for Fast Radio Bursts](https://arxiv.org/abs/2607.08464) <a id="link62"></a>
...
**Comment:** This paper proposes a mechanism for fast radio bursts based on photon acceleration in magnetized plasma, relevant to magnetar magnetospheres. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 63. [Blind Line Search System: BLiSS](https://arxiv.org/abs/2607.07783) <a id="link63"></a>
...
**Comment:** This is a software paper for X-ray emission line searches, with no direct connection to the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 64. [Relativistic Mean Field Approach with Chiral Symmetry Breaking and Quark Confinement in the light of Astrophysical Observations](https://arxiv.org/abs/2607.08412) <a id="link64"></a>
...
**Comment:** This paper is about relativistic mean-field models for neutron stars, nuclear matter, and chiral symmetry breaking, with constraints from astrophysical observations. It does not address galaxies, star formation, or any of the core topics.
...
## 65. [Nonlinear hydrodynamics in spinning neutron stars: Theoretical universal relations and equilibrium solutions](https://arxiv.org/abs/2607.07943) <a id="link65"></a>
...
**Comment:** This paper is about nonlinear hydrodynamics and universal relations in spinning neutron stars, focusing on tidal interactions and gravitational waveforms. It does not address galaxies, star formation, or any of the core topics.
...
## 66. [Beyond black hole spectroscopy: Quasinormal mode contamination by massless scalars](https://arxiv.org/abs/2607.08619) <a id="link66"></a>
...
**Comment:** This paper discusses quasinormal mode contamination in black hole spectroscopy due to massless scalars, which is not related to any of the core topics.
...
## 67. [Leptogenesis and Low Reheating Temperatures](https://arxiv.org/abs/2607.08663) <a id="link67"></a>
...
**Comment:** The paper discusses leptogenesis and reheating in the early universe, which is not related to galaxy formation, dwarf galaxies, or any of the specified criteria.
...
## 68. [The Impact of Planetary Phase Functions on Exo-Earth Detectability with EXOSIMS](https://arxiv.org/abs/2607.08701) <a id="link68"></a>
...
**Comment:** The paper focuses on exoplanet detection metrics and phase functions for exo-Earths, which is unrelated to the specified criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 69. [Precision three-Dimensional Atmospheric Neutrino Flux Calculation Based on Honda Flux Model](https://arxiv.org/abs/2607.08310) <a id="link69"></a>
...
**Comment:** This paper presents a new calculation of atmospheric neutrino fluxes, which is relevant for neutrino oscillation and dark matter experiments, but not for any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. No direct match to any listed criteria.
...
## 70. [Active galactic nuclei are not responsible for systematics in the empirical properties of type Ia supernovae](https://arxiv.org/abs/2607.08604) <a id="link70"></a>
...
**Comment:** This paper focuses on the impact of AGN on Type Ia supernovae systematics. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 71. [Vetting Ambiguous Planetary Candidates (APC) in TESS Data: Insights from LATTE Package and Detection of Nine Potential Exoplanet Candidates](https://arxiv.org/abs/2607.08132) <a id="link71"></a>
...
**Comment:** Focuses on vetting ambiguous planetary candidates in TESS data using the LATTE package. The work is centered on exoplanet detection and validation, not on any of the core topics.
...
## 72. [RedDots: Magnetic field of the nearby active M dwarf GJ 729, and a search for companions](https://arxiv.org/abs/2607.08050) <a id="link72"></a>
...
**Comment:** Studies the magnetic field and exoplanet search in the nearby M dwarf GJ 729. The focus is on stellar activity and exoplanet detection, not on any of the core topics.
...
## 73. [Long-term speckle interferometric monitoring of binary systems II: 2007-2025 positional measurements and improvement of orbits](https://arxiv.org/abs/2607.08467) <a id="link73"></a>

**ArXiv ID:** 2607.08467

**Authors:** Arina Mitrofanova, Vladimir Dyachenko, Anatoly Beskakotov, Alexander Maksimov, Margarita Butorina, Yuri Balega, Denis Rastegaev

**Abstract:** This article is focused on the analysis of observational data and improvement of orbital solutions of 8 objects. The listed objects are members of a sample of approximately 300 nearby (d  200 yr) and, consequently, the lack of observational data. An analysis and comparison of the mass sums and masses of components obtained by two independent methods and based on several parallax values were also carried out. In most cases, the best agreement is found between fundamental parameters calculated using Gaia parallaxes, if available.

**Comment:** This paper presents long-term speckle interferometric monitoring of binary systems and improved orbital solutions. The focus is on binary star orbits, not on galaxies, resolved star formation histories, or near-field cosmology.
...
## 74. [Space and Lunar Interferometry: Emerging Concepts and Pathways](https://arxiv.org/abs/2607.07746) <a id="link74"></a>
...
**Comment:** This is a review of space and lunar interferometry concepts and mission pathways. While it discusses future instrumentation, it does not focus on any of the core science topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 75. [Classification of blazars based on data-driven approaches](https://arxiv.org/abs/2607.08594) <a id="link75"></a>
...
**Comment:** This paper presents a data-driven classification of blazars using optical light curves. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 76. [Collisionless and collisional kinetics of a plasma atmosphere with spatially and temporally intermittent heating at its base](https://arxiv.org/abs/2607.08410) <a id="link76"></a>
...
**Comment:** The paper studies the solar corona's temperature structure using kinetic models of plasma heating. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 77. [On-sky dark hole diggin' with implicit Electric Field Conjugation on MagAO-X](https://arxiv.org/abs/2607.08146) <a id="link77"></a>
...
**Comment:** This paper is about adaptive optics and wavefront control for exoplanet imaging, which is not related to any of the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 78. [Node-locked phase of annual modulations from the gravitational chiral anomaly in the solar Kerr field](https://arxiv.org/abs/2607.07912) <a id="link78"></a>

**ArXiv ID:** 2607.07912

**Authors:** M. Misiaszek (Jagiellonian University, Krakow)

**Abstract:** The Chern-Pontryagin density of the Sun's Kerr field, ${}^*RR\simeq 288\,G^{2}M_{\odot}^{2}a_{\odot}\cos\theta/c^{4}r^{7}$, provides an annually sign-changing parity-odd curvature invariant sampled by a detector in the Solar System and sources the gravitational chiral anomaly $\nabla_{\mu}j^{\mu}_{5}={}^*RR/384\pi^{2}$. Sampled along the Earth's orbit it is odd about the solar equatorial plane, so the accumulated chirality is extremal at the plane crossings. Any observable coupled to this reservoir therefore modulates annually with a phase fixed entirely by ephemerides: the cosine-fit phase is $t^{*}=158.7$ d (June 7-8) for a rate-suppressing coupling or $t^{*}=341.4$ d (December 7-8) for a rate-enhancing one, with a calculable secular drift of $+0.014$ d yr$^{-1}$, strict energy independence, a phase-locked semiannual harmonic of $3.75\%$, and no synodic (27 d) or solar-cycle (11 yr) components. The sign and magnitude of the coupling are not predicted; the phase is. A single-amplitude fit to the DAMA/LIBRA-phase2 residuals selects the suppressing branch and describes the observed modulation as well as the standard-halo dark-matter cosine ($\Delta\chi^{2}=1.8$). The most precise published phase, from the full 3.40 t yr exposure, $t^{*}=153.5\pm3.8$ d, lies $0.3\sigma$ from the halo value and $1.4\sigma$ from the node-locked one: the $6.2$-day separation between the hypotheses is below the current resolution. Unlike the halo phase, the node-locked phase admits no astrophysical adjustment, so phase metrology at the two-day level, and a test of its energy independence, discriminates between the two hypotheses.

**Comment:** This paper discusses annual modulations from gravitational chiral anomaly in the solar Kerr field, with applications to DAMA/LIBRA. It is not related to any of the core topics.
...
## 79. [Decoupling Limit of Quiver Theories and the Angular Spectra of Extreme C-metrics](https://arxiv.org/abs/2607.08747) <a id="link79"></a>
...
**Comment:** This paper is about the angular spectra of extreme C-metrics and their relation to quiver gauge theories, which is not related to any of the core topics.
...
## 80. [Near-perihelion activity and composition of 3I/ATLAS from JUICE/MAJIS observations](https://arxiv.org/abs/2607.08603) <a id="link80"></a>
...
**Comment:** This paper presents observations of the interstellar comet 3I/ATLAS, focusing on its activity and composition. While interesting for cometary science and solar system studies, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 82. [Multi-Path Quasi-Periodic Fast-mode Propagating Magnetoacoustic Waves to Diagnose Coronal Magnetic Field and Flaring Core](https://arxiv.org/abs/2607.08487) <a id="link82"></a>
...
**Comment:** This paper studies magnetoacoustic waves in the solar corona during flares. It is focused on solar physics and coronal diagnostics, not on galaxies, star formation histories, or any of the relevant criteria.
...
## 83. [Investigation on the Relation between Active Regions' Compliance with Empirical Laws and Flare Productivity](https://arxiv.org/abs/2607.08053) <a id="link83"></a>
...
**Comment:** This paper statistically analyzes solar active regions and their flare productivity, focusing on compliance with empirical solar laws. It is not related to galaxies, star formation, or any of the relevant criteria.
...
## 84. [Cataclysmic Variables Photometric Periods from TESS](https://arxiv.org/abs/2607.08727) <a id="link84"></a>
...
**Comment:** The paper presents photometric period determinations for cataclysmic variables using TESS data. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 85. [Phase-dependent chemistry of WASP-43 b revealed with a suite of one-, two-, and three-dimensional models](https://arxiv.org/abs/2607.08486) <a id="link85"></a>
...
**Comment:** This paper investigates the chemistry of a hot Jupiter exoplanet using theoretical models. It does not relate to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 86. [Development of a Raman Lidar for the Southern Site of the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2607.08289) <a id="link86"></a>
...
**Comment:** This paper describes the development of a Raman Lidar system for atmospheric monitoring at the Cherenkov Telescope Array. It is focused on instrumentation and atmospheric calibration, with no connection to near-field cosmology, resolved star formation histories, galaxy simulations, or any other relevant criteria.
...
## 87. [On-Orbit Calibration of Danuri/PolCam. II. Radiometric Calibration](https://arxiv.org/abs/2607.08008) <a id="link87"></a>
...
**Comment:** This paper is about the calibration of a lunar orbiter's polarimetric camera. It does not address any of the relevant topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 88. [Methods of Observing and Characterising the Ionosphere with SKA-Low](https://arxiv.org/abs/2607.08416) <a id="link88"></a>
...
**Comment:** This paper focuses on methods for observing and characterizing the ionosphere with SKA-Low, which is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
