...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 57365    | 8080         | 65445   |
| **Cost**             | $0.11    | $0.06        | $0.18   |

Total arXiv papers: 195
...
1. [LMC-induced Perturbations in the Milky Way Halo II: Bridging Field-level Inference and Summary-level Simulation-Based Inference](#user-content-link1)
**Authors:** Yanjun Sheng, Yuan-Sen Ting, Tomasz R\'o\.za\'nski, Xiang-Xiang Xue, Roland M. Crocker, Jiashu Pan

2. [Boundary conditions for radial pulsations in AGB envelopes](#user-content-link2)
**Authors:** Jan Zalewski

3. [Reading Between the Lines: Forward Modeling Dust, Continuum, and Spectral Cleaning for Multi-Line Intensity Mapping](#user-content-link3)
**Authors:** Anirban Roy, Rachel S. Somerville, Anthony R. Pullen

4. [Large Magellanic Cloud Globular Clusters in the Near-infrared. I. RR Lyrae in Reticulum](#user-content-link4)
...
5. [From Dark Matter to Galaxies: Halo-Free Mock Generation via Conditional Point-Cloud Diffusion](#user-content-link5)
**Authors:** Kana Moriwaki, Ken Osato, Naoki Yoshida

6. [Testing dark matter density profiles based on Pad\'e approximants of different orders](#user-content-link6)
**Authors:** Talgar Konysbayev, Orlando Luongo, Marco Muccino, Yergali Kurmanov, Kuantay Boshkayev, Gulnara Suliyeva, Ainur Urazalina, Guldana Rabigulova

7. [A Scalable Fast Multipole Method Poisson Solver for the RAMSES code: II. Adaptive Mesh Refinement and Adaptive Time Stepping](#user-content-link7)
**Authors:** Jun-Young Lee, Romain Teyssier

8. [Modeling the HI-Halo Connection: Evolution, Scatter, and a Halo-based Prescription for 21-cm Mock Catalogs](#user-content-link8)
**Authors:** Mohd Kamran, Gabriella De Lucia, Marta Spinelli, Lizhi Xie, Fabio Fontanot, Michaela Hirschmann

9. [Strong Gravitational Lensing Posterior Sampling in Pixel-Space Using Diffusion Models and Recurrent Inference Machines](#user-content-link9)
**Authors:** Guillaume Payeur, Laurence Perreault-Levasseur, Gabriel Missael Barco, Yashar Hezaveh

10. [Swing amplification in star-gas disks](#user-content-link10)
**Authors:** Abhishek Hegade K. R., Chris Hamilton

11. [Asteroseismic Analysis of a Red Giant KIC 9145955 by Including the Small-scale Magnetic Fields in the Atmosphere](#user-content-link11)
**Authors:** Yuetong Wang, Guifang Lin, Yan Li, Tao Wu, Yaguang Li

12. [The GOLIATH Survey: OVI Absorption Reveals CGM Evolution through the Starburst-to-Quiescent Transition in Massive Galaxies](#user-content-link12)
**Authors:** Derick Flores, Rongmon Bordoloi, Jason Tumlinson, J. Christopher Howk, Nicolas Lehner, Mary Rickel, Benjamin Oppenheimer, Joseph Burchett, Ahmed Shaban, John O'Meara, Andrew Fox, J. Xavier Prochaska, Simon Xinlin Wu, Jack Higginson, Robert A. Simcoe

13. [Nebular continuum in high-redshift galaxies with JWST](#user-content-link13)
**Authors:** Henrique Miranda, Ciro Pappalardo, Jos\'e Afonso, Polychronis Papaderos, Rodrigo Carvajal

14. [A Probabilistic Framework for Population Studies of the Solar Neighborhood: Application to SDSS-V and Gaia](#user-content-link14)
**Authors:** Ilija Medan, Keivan G. Stassun, Zachary Way, Guy S. Stringfellow, Alexandre Roman-Lopes, Jiadong Li, Madeline Lucey, Andrew R. Casey, B\'arbara Rojas-Ayala, Ricardo L\'opez-Valdivia, Jos\'e G. Fern\'andez-Trincado

15. [The Age-Thickness Relation as a Tracer of the Merger History of Disk Galaxies](#user-content-link15)
**Authors:** Lekshmi Thulasidharan, Elena D'Onghia, Robert Benjamin, Ronald Drimmel, Eloisa Poggio

16. [Estimating Cluster Galaxy Infall Time from Phase Space in TNG](#user-content-link16)
**Authors:** Cameron Lawlor-Forsyth

17. [Exploring the Small-scale Magnetic Fields in the Atmosphere of HD 49385 by Asteroseismic Analysis](#user-content-link17)
**Authors:** Yuetong Wang, Yaguang Li, Yan Li, Guifang Lin, Tao Wu

18. [Cosmic CORALS: Timing the Universe with high-z star clusters](#user-content-link18)
**Authors:** Elena Tomasetti, Martin Millon, Licia Verde, Fr\'ed\'eric Courbin, Raul Jimenez, Michele Moresco, Carmela Lardo, Andrea Cimatti

19. [Resolving Galactic and Cluster Dynamics Without Dark Matter: Tsallis Entropy as the Unique Foundation of Emergent Gravity](#user-content-link19)
**Authors:** S. Shamari, A. Sheykhi

20. [The first dusty galaxies across $6 \lesssim z \lesssim 14$: Blue monsters, red monsters, and the bimodality of dust content in early galaxies](#user-content-link20)
**Authors:** Sergio Mart\'inez-Gonz\'alez, Casiana Mu\~noz-Tu\~n\'on, Santiago Jim\'enez

21. [When Galaxies Refuel: Evolution of the Perturbed Spiral Galaxy NGC1385](#user-content-link21)
**Authors:** Xiaoyu Kang, Eva Sextl, Rolf-Peter Kudritzki, Hassen M. Yesuf, Fenghui Zhang, Ruixiang Chang, Xiejin Li, Yunkun Han

22. [The UK Infrared Telescope M33 monitoring project. VI. Feedback from dusty stellar winds across the galactic disc](#user-content-link22)
**Authors:** Atefeh Javadi, Jacco Th. van Loon, Mina Alizadeh, Seyed Azim Hashemi, Elham Saremi

23. [A universal chromosome map for globular clusters: chemical calibration and environmental regulation of the multiple populations](#user-content-link23)
**Authors:** C. Lardo, M. Salaris, N. Bastian, C. Charbonnel, E. Dalessandro, E. Dondoglio, M. Gieles, M. G. H. Krause, F. Martins, S. Monty

24. [Discovery of Optical Filaments in the North Polar Spur/eROSITA Bubble](#user-content-link24)
**Authors:** Julian Shapiro

25. [Shock cooling emission from late-time mass loss in low-mass He star binaries](#user-content-link25)
**Authors:** Samantha C. Wu, Anthony L. Piro

26. [AGN Feedback Models and AGN Demographics II: Comparing Predictions of Radiative and Total Feedback to Observations](#user-content-link26)
**Authors:** Arjun Suresh, Michael R. Blanton

27. [Rapid growth in a dual AGN during a gas-rich merger at z~4.5](#user-content-link27)
**Authors:** Hyewon Suh, Roberto Decarli, Emanuele Paolo Farina, Julia Scharw\"achter, Mar Mezcua, Giorgio Lanzuisi, Federica Loiacono, Brian C. Lemaux, Sukyoung K. Yi, Stefano Marchesi, Marta Volonteri, G\"unther Hasinger, Francesca Civano, Anniek Gloudemans, Ena Choi, Yeonwoo Nam, Adi Foord, Silvia Onorato

28. [Clarifying Dead Quasars and Downsizing through the Evolution of Star-Forming Galaxies and Active Galactic Nuclei](#user-content-link28)
**Authors:** Shingo Sumie

29. [Mid-Infrared Colors Vary with Galactic Environment: Contrasting Star-Forming Disks, Young Centers, and Quiescent Star-Formation Deserts](#user-content-link29)
**Authors:** Debosmita Pathak, Karin M. Sandstrom, Adam K. Leroy, Ryan Chown, Daniel A. Dale, Hannah B. Koziol, Mansi Padave, Jessica Sutter, Thomas G. Williams, Dalya Baron, Alberto D. Bolatto, Mederic Boquien, Oleg V. Egorov, Eric Emsellem, Simon C. O. Glover, Ralf S. Klessen, Eva Schinnerer, Todd A. Thompson, Francesco Belfiore, Frank Bigiel, Enrico Congiu, Ivan Gerasimov, Jay Gonzalez Lobos, Annie Hughes, Laura A. Lopez, Justus Neumann, Elias K. Oakes, Hsi-An Pan, Erik Rosolowsky, Sumit K. Sarbadhicary

30. [Gas accretion onto the Milky Way: high-velocity cloud survival and the revival of the terminal-velocity paradigm](#user-content-link30)
**Authors:** Michael M. Schulreich, Dieter Breitschwerdt, J\"urgen Kerp

31. [Galactic Science with the LiteBIRD satellite: Spectral characterization of diffuse Galactic polarized emission at the angular power spectrum level](#user-content-link31)
**Authors:** S. Vinzl (for the LiteBIRD Collaboration), J. Aumont (for the LiteBIRD Collaboration), L. Vacher (for the LiteBIRD Collaboration), R. T. G\'enova-Santos (for the LiteBIRD Collaboration), D. Adak (for the LiteBIRD Collaboration), A. Rizzieri (for the LiteBIRD Collaboration), H. Akamatsu (for the LiteBIRD Collaboration), E. Allys (for the LiteBIRD Collaboration), A. Anand (for the LiteBIRD Collaboration), C. Baccigalupi (for the LiteBIRD Collaboration), M. Ballardini (for the LiteBIRD Collaboration), A. J. Banday (for the LiteBIRD Collaboration), R. B. Barreiro (for the LiteBIRD Collaboration), N. Bartolo (for the LiteBIRD Collaboration), S. Basak (for the LiteBIRD Collaboration), A. Basyrov (for the LiteBIRD Collaboration), M. Bersanelli (for the LiteBIRD Collaboration), N. Brancadori (for the LiteBIRD Collaboration), T. Brinckmann (for the LiteBIRD Collaboration), E. Calabrese (for the LiteBIRD Collaboration), P. Campeti (for the LiteBIRD Collaboration), A. Carones (for the LiteBIRD Collaboration), F. Carralot (for the LiteBIRD Collaboration), F. J. Casas (for the LiteBIRD Collaboration), J. Chandran (for the LiteBIRD Collaboration), M. Citran (for the LiteBIRD Collaboration), F. Columbro (for the LiteBIRD Collaboration), A. Coppolecchia (for the LiteBIRD Collaboration), P. de Bernardis (for the LiteBIRD Collaboration), E. de la Hoz (for the LiteBIRD Collaboration), M. De Lucia (for the LiteBIRD Collaboration), S. Della Torre (for the LiteBIRD Collaboration), C. Dickinson (for the LiteBIRD Collaboration), P. Diego-Palazuelos (for the LiteBIRD Collaboration), K. Ebisawa (for the LiteBIRD Collaboration), H. K. Eriksen (for the LiteBIRD Collaboration), J. Errard (for the LiteBIRD Collaboration), F. Finelli (for the LiteBIRD Collaboration), C. Franceschet (for the LiteBIRD Collaboration), U. Fuskeland (for the LiteBIRD Collaboration), G. Galloni (for the LiteBIRD Collaboration), M. Galloway (for the LiteBIRD Collaboration), M. Gerbino (for the LiteBIRD Collaboration), M. Gervasi (for the LiteBIRD Collaboration), T. Ghigna (for the LiteBIRD Collaboration), S. Giardiello (for the LiteBIRD Collaboration), E. Gjerl{\o}w (for the LiteBIRD Collaboration), M. Gomes (for the LiteBIRD Collaboration), S. E. Harper (for the LiteBIRD Collaboration), L. T. Hergt (for the LiteBIRD Collaboration), E. Hivon (for the LiteBIRD Collaboration), H. Ishino (for the LiteBIRD Collaboration), K. Kikuno (for the LiteBIRD Collaboration), K. Kohri (for the LiteBIRD Collaboration), N. Krachmalnicoff (for the LiteBIRD Collaboration), L. Lamagna (for the LiteBIRD Collaboration), M. Lattanzi (for the LiteBIRD Collaboration), C. Leloup (for the LiteBIRD Collaboration), F. Levrier (for the LiteBIRD Collaboration), A. I. Lonappan (for the LiteBIRD Collaboration), M. L\'opez-Caniego (for the LiteBIRD Collaboration), G. Luzzi (for the LiteBIRD Collaboration), D. Maino (for the LiteBIRD Collaboration), V. Maranchery (for the LiteBIRD Collaboration), S. Masi (for the LiteBIRD Collaboration), S. Matarrese (for the LiteBIRD Collaboration), T. Matsumura (for the LiteBIRD Collaboration), S. Micheli (for the LiteBIRD Collaboration), M. Migliaccio (for the LiteBIRD Collaboration), M. Monelli (for the LiteBIRD Collaboration), L. Montier (for the LiteBIRD Collaboration), G. Morgante (for the LiteBIRD Collaboration), L. Mousset (for the LiteBIRD Collaboration), R. Nagata (for the LiteBIRD Collaboration), T. Namikawa (for the LiteBIRD Collaboration), P. Natoli (for the LiteBIRD Collaboration), A. Occhiuzzi (for the LiteBIRD Collaboration), L. Pagano (for the LiteBIRD Collaboration), A. Paiella (for the LiteBIRD Collaboration), D. Paoletti (for the LiteBIRD Collaboration), G. Pascual-Cisneros (for the LiteBIRD Collaboration), G. Patanchon (for the LiteBIRD Collaboration), V. Pavlidou (for the LiteBIRD Collaboration), V. Pelgrims (for the LiteBIRD Collaboration), F. Piacentini (for the LiteBIRD Collaboration), G. Piccirilli (for the LiteBIRD Collaboration), M. Pinchera (for the LiteBIRD Collaboration), G. Polenta (for the LiteBIRD Collaboration), L. Porcelli (for the LiteBIRD Collaboration), M. Remazeilles (for the LiteBIRD Collaboration), J. A. Rubi\~no-Mart\'in (for the LiteBIRD Collaboration), M. Ruiz-Granda (for the LiteBIRD Collaboration), Y. Sakurai (for the LiteBIRD Collaboration), L. Salvati (for the LiteBIRD Collaboration), J. Sanghavi (for the LiteBIRD Collaboration), V. Sauvage (for the LiteBIRD Collaboration), Y. Sekimoto (for the LiteBIRD Collaboration), M. Shiraishi (for the LiteBIRD Collaboration), S. Stellati (for the LiteBIRD Collaboration), R. M. Sullivan (for the LiteBIRD Collaboration), R. Takahashi (for the LiteBIRD Collaboration), A. Tartari (for the LiteBIRD Collaboration), K. Tassis (for the LiteBIRD Collaboration), K. Tateoka (for the LiteBIRD Collaboration), L. Terenzi (for the LiteBIRD Collaboration), M. Tomasi (for the LiteBIRD Collaboration), M. Tristram (for the LiteBIRD Collaboration), B. van Tent (for the LiteBIRD Collaboration), P. Vielva (for the LiteBIRD Collaboration), G. Weymann-Despres (for the LiteBIRD Collaboration), E. J. Wollack (for the LiteBIRD Collaboration)

32. [AGNFormer I: Reconstruction of AGN spectra using a probabilistic transformer model](#user-content-link32)
**Authors:** Benedict L. Rouse, Franz E. Bauer, Tomasz R\'o\.za\'nski, Guillermo Cabrera-Vives, Patricia Ar\'evalo, Crist\'obal Rodrigo Donoso Oliva, Pavlos Protopapas, Gordon T. Richards, Paula S\'anchez-S\'aez, Ezequiel Treister, Christian Wolf

33. [Ringing of the Reionization: A first direct measurement of the intergalactic pressure smoothing scale at redshift z>4.2 as imprinted onto small-scale peculiar velocities in the Lyman-alpha forest](#user-content-link33)
**Authors:** Vid Ir\v{s}i\v{c}, Matteo Viel, Martin G. Haehnelt, James S. Bolton, Ewald Puchwein, Luke I. Gilmartin

34. [A pilot sample of Planck-selected strongly lensed sub-mm galaxies: NOEMA observations and physical characterisation](#user-content-link34)
**Authors:** Leonardo Trobbiani, Matteo Bonato, Ivano Baronchelli, Gianfranco De Zotti, Mattia Negrello, Marika Giulietti, Cristian Vignali, Marcella Massardi

35. [Accurate parameter inference for the Light-cone Epoch of Reionization 21-cm signal](#user-content-link35)
**Authors:** Suman Pramanick, Anoop Krishna, Rajesh Mondal, Somnath Bharadwaj

36. [Can cosmic voids ease the Hubble tension? Local expansion in $w_0w_a$CDM](#user-content-link36)
**Authors:** Tommaso Moretti, Noemi Frusciante, Giovanni Verza

37. [Probing the matter-dominated expansion with multi-redshift Lyman-$\alpha$ BAO from DESI DR2](#user-content-link37)
**Authors:** Hiram K. Herrera-Alcantar, Julien Guy, Alma X. Gonzalez-Morales, Eric Armengaud, Edwin L. P\'erez-Ochoa, Cristhian Garcia-Quintero, J. Aguilar, S. Ahlen, F. Beutler, D. Bianchi, A. Brodzeller, D. Brooks, E. Chaussidon, T. Claybaugh, A. Cuceu, K. S. Dawson, A. de la Macorra, Arjun Dey, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, G. Gutierrez, C. Hahn, K. Honscheid, D. Huterer, M. Ishak, T. Karim, R. Kehoe, D. Kirkby, A. Kremin, O. Lahav, A. Lambert, M. Landriau, L. Le Guillou, M. Manera, P. Martini, A. Meisner, R. Miquel, J. Moustakas, A. Mu\~noz-Guti\'errez, S. Nadathur, G. Niz, E. Paillas, N. Palanque-Delabrouille, W. J. Percival, C. Poppett, F. Prada, I. P\'erez-R\`afols, C. Ravoux, G. Rossi, R. Ruggeri, L. Samushia, E. Sanchez, C. Saulder, D. Schlegel, M. Schubnell, H. Seo, J. Silber, G. Tarl\'e, B. A. Weaver, C. Y\`eche, R. Zhou

38. [2D hydrodynamical simulations of Be star decretion disc formation through boundary layer effects](#user-content-link38)
**Authors:** Madeline Overton, Zhaohuan Zhu, Rebecca G. Martin, Jiayin Dong

39. [Anharmonic Infrared Emission of Cyano-Substituted Polycyclic Aromatic Hydrocarbon Molecules: Cyanonaphthalenes as a Case Study](#user-content-link39)
**Authors:** Tao Chen, Kaijun Li, Aigen Li

40. [The road towards precision measurements of $H_0$ with bright sirens in the Einstein Telescope era](#user-content-link40)
**Authors:** Chiara De Leo, Elsa M. Teixeira, Vivian Poulin

41. [The burgeoning rise of the 21-cm forest I: constraints on the optical depth of the intergalactic medium at $5.38 < z < 5.84$](#user-content-link41)
**Authors:** Chanasorn Kongprachaya, Gianni Bernardi, Emilio Ceccotti, Andrei Mesinger, Benedetta Ciardi, Oleg M. Smirnov

42. [Planetesimal Formation Across the Stellar Mass Spectrum and its Influence on Exoplanet-Inherited Volatile Budgets](#user-content-link42)
**Authors:** Joe Williams, Sebastiaan Krijt, Joanna Dr\k{a}\.zkowska, Tim Lichtenberg

43. [The silent dark sector: a field-theory approach to unified dark fluids with vanishing speed of sound](#user-content-link43)
**Authors:** Javier de Cruz P\'erez, Dar\'io Jaramillo-Garrido, Antonio L. Maroto, Prado Mart\'in-Moruno

44. [Beyond $j=1$: Observational Constraints on Almost-$\Lambda$CDM Cosmologies](#user-content-link44)
**Authors:** Jess Worsley, Saikat Chakraborty, Peter Dunsby

45. [Origin of the Long-Period Radial Velocity Variation in the Red Supergiant HD 216946 (V424 Lac)](#user-content-link45)
**Authors:** Byeong-Cheol Lee, Myeong-Gu Park

46. [Spectral Data-cube Cleaning for CCAT Deep Spectroscopic Survey. I. Effect of correlated noise and filtering on the power spectrum](#user-content-link46)
**Authors:** A. Dev, C. Karoumpis, Y. Okada, K. Basu, F. Bertoldi, D. Chung, J. Clarke, R. Freundt, T. Nikola, T. Oak, D. Riechers

47. [Dynamical Test of Cosmic Acceleration: $k$-nearest Neighbor Cross Correlation of Cosmic Microwave Background and Cosmic Infrared Background](#user-content-link47)
**Authors:** Dongkok Kim, Donghui Jeong, Yi-Kuan Chiang, Ho Seong Hwang

48. [Local morphology and asymmetry of galactic rotation curves in a kinetic gas transport framework: NGC 3198](#user-content-link48)
**Authors:** Anton A. Lipovka, Anna A. Lipovka

49. [Primordial black holes forming during kination: the trapped, the overdense, and the void](#user-content-link49)
**Authors:** Cristian Joana

50. [Interacting Dark Energy and Dark Matter in O(3) No-Scale Gravity](#user-content-link50)
**Authors:** Lincoln da S. Pereira, Muzi Hong, Elisa G. M. Ferreira, Tsutomu T. Yanagida

51. [Pulsar glitches in the presence of vortex traps](#user-content-link51)
**Authors:** Anantharaman Sekharipuram Viswanathan, Dipankar Bhattacharya, M. Ali Alpar, Erbil G\"ugercino\u{g}lu

52. [CATKit2-HCI: a collaborative framework for advancing high-contrast coronagraph testbeds](#user-content-link52)
**Authors:** R\'emi Soummer, Iva Laginja, Emiel H. Por, Rapha\"el Pourcelot, Sarah Steiger, Bryony Nickson, Alexis Lau, Pierre Baudoz, Clarissa Do \'O, Jules Fowler, Rapha\"el Galicher, Tyler D. Groff, Rebecca Jensen-Clem, Dimitri P. Mawet, Johan Mazoyer, Michael W. McElwain, Lane Meier, Axel Potier, Laurent A. Pueyo, Susan F. Redmond, Scott D. Will, Neil T. Zimmerman

53. [Extreme Variability Reveals How the Eddington Ratio Regulates Coronal Power in Active Galactic Nuclei](#user-content-link53)
**Authors:** Arghajit Jana, Claudio Ricci, Franz E. Bauer, Kriti Kamal Gupta, Benny Trakhtenbrot, Alessia Tortosa, Ruancun Li, Luis C. Ho, Richard Mushotzky, Hsiang-Kuang Chang, Yaherlyn Diaz, Georgios Dimopoulos, Krist\'ina Kallov\'a, Michael J. Koss, St\'ephane Paltani, Matthew J. Temple

54. [No Surviving Companion to the Galactic SN 1181: Evidence for a Double-Degenerate Channel for Type Iax Supernovae](#user-content-link54)
**Authors:** Kohki Uno, Daichi Tsuna, Daichi Hiramatsu, Tomoya Kinugawa, Takatoshi Ko

55. [Constraining Effective Viscosity in the Intracluster Medium via the Thermal Sunyaev-Zeldovich Effect -- Predictions from the SLOW Constrained Coma Cluster Simulations](#user-content-link55)
**Authors:** Frederick Groth, Yuan Li, Joseph Golec, Benjamin A. Seidel, Jenny G. Sorce, Tirso Marin-Gilabert, Klaus Dolag

56. [Microlensing Detection and Inference via Learned Bayes Factors](#user-content-link56)
**Authors:** Nolan Smyth, Laurence Perreault-Levasseur, Yashar Hezaveh

57. [Skipper CCD readout time optimization for astronomical applications](#user-content-link57)
**Authors:** Johannes W\"uthrich, Andrin Fazan, Sean MacBride, Marcelle Soares-Santos

58. [QCD CP-violation scenario for a revised cosmological dynamics: analysis of the binned Pantheon Sample of Super Novae Ia](#user-content-link58)
**Authors:** Giovanni Montani, Nakia Carlevaro, Maria Giovanna Dainotti, Eleonora Giovannetti

59. [Long-lived intermittent accretion disks in the jittering jets explosion mechanism (JJEM) of core-collapse supernovae](#user-content-link59)
**Authors:** Noam Soker (Technion, Israel)

60. [The magnetic field strength of a methane dwarf measured from its radio spectral cutoff](#user-content-link60)
**Authors:** Timothy W. H. Yiu, Harish K. Vedantham, Joseph R. Callingham, Timothy W. Shimwell

61. [The High-Speed FPGA Readout System for the Advanced X-ray Imaging Satellite (AXIS)](#user-content-link61)
...
62. [Monopoles, Strings, Walls and Gravitational waves](#user-content-link62)
**Authors:** Rinku Maji, Qaisar Shafi

63. [A Search for Exoplanets around Northern Circumpolar Stars X. The origin of radial velocity variations in the evolved star HD 216595](#user-content-link63)
...
64. [Circumstellar Disc and X-ray Variability in the Be/X-ray Binary SXP 5.05 During its 2024 Outburst](#user-content-link64)
**Authors:** Chintan Patel, Sayantan Bhattacharya, Karan Akbari, Rajapandi Nadar, Sudip Bhattacharyya, Manojendu Choudhury

65. [Four, One, and None: Quantifying the Ultra-High-Energy Neutrino Anomaly Across ANITA-IV, KM3NeT, and IceCube](#user-content-link65)
**Authors:** Dibya S. Chattopadhyay, Carlos A. Arg\"uelles, Vedran Brdar

66. [Can the universe be matter-dominated after a supercooled first-order phase transition?](#user-content-link66)
**Authors:** Henda Mansour, Yann Gouttenoire, Felix Kahlhoefer

67. [A Deep Learning Framework for Predicting Solar EUV Irradiance During Significant Flares](#user-content-link67)
**Authors:** Sathvik Soman, Jason T. L. Wang, Haimin Wang, Haodi Jiang

68. [Solar differential rotation driven by baroclinic forcing](#user-content-link68)
**Authors:** L. S. Menicucci, G. Guerrero, M. Dikpati, R. Hester, J. Zhang, P. K. Smolarkiewicz

69. [RNDR noise modeling in first-generation Single electron Sensitive Readout (SiSeRO) devices](#user-content-link69)
...
70. [Height Dependent Phase Shifts of Wave Pulses in the Lower Solar Atmosphere Measured with SUNRISE III](#user-content-link70)
**Authors:** Andreas Lagg, H. N. Smitha, Sami K. Solanki, Tino L. Riethm\"uller, Achim Gandorfer, Alex Feller, Francisco A. Iglesias, Azaymi L. Siu-Tapia, Jose Carlos del Toro Iniesta, Yukio Katsukawa, Pietro Bernasconi, Thomas Berkefeld, Masahito Kubo, David Orozco Su\'arez, Robert Cameron, Jesper Schou, Damien Przybylski, Alberto \'Alvarez-Herrero, Bianca Grauf, Michael Carpenter, Alexander Bell, Valent\'in Mart\'inez Pillet, Shahin Jafarzadeh, Lakshmi Pradeep Chitta, Francisco Javier Bail\'en, Julian Blanco Rodr\'iguez, Juan Sebasti\'an Castellanos Dur\'an, Edvarda Harnes, Johannes H\"olken, Ryohtaroh T. Ishikawa, Yusuke Kawabata, Takuma Matsumoto, Takayoshi Oba, Hanna Strecker, Du\v{s}an Vukadinovi\'c

71. [Fabrication status and expected performance of the inner-core X-ray optic for BabyIAXO](#user-content-link71)
**Authors:** Jooyun Woo (a), Yue Yu (a), Ipek Altunyurt (a), Todd Decker (a), Desiree Della Monica Ferreira (b, c), Peter Lindquist Henriksen (b), Eftychia Kotsiou (a), Sonny Massahi (b, c), Kerstin Perez (a), Anacorina Romero (a), Jaime Ruz (b), Vyshnavi Sabbi (a, d), Marcela Stern (a), Julia Katharina Vogel (e)

72. [Peculiar Behavior of Optical Polarization in Blazar 1ES 1959+650: Role of Jet Magnetic Field and Geometry](#user-content-link72)
**Authors:** A. Singh, A. Tolamatti, K. K. Singh, A. C. Gupta, K. K. Yadav

73. [Reversive and Non-Reversive Magnetic CP Stars. I. Catalog](#user-content-link73)
**Authors:** I. I. Romanyuk

74. [One cluster, two clusters, no cluster? -- The curious case of HSC 2686 and Lynga 3](#user-content-link74)
**Authors:** Andreas Ritter, Quentin A. Parker, Xizhe Xie, Xingyi Guo

75. [Oscillatory reconnection and resonant response to wave excitation in 2D coronal null points](#user-content-link75)
**Authors:** Konstantinos Karampelas, Tom Van Doorsselaere

76. [Shock acceleration in vortex driven magnetic fields of black holes](#user-content-link76)
**Authors:** Zaza N. Osmanov

77. [Identifying Kilonovae in the Presence of Optical Afterglow for the Wide-Field Survey Telescope](#user-content-link77)
**Authors:** Huan Yang, Zhengyan Liu, Liang-Duan Liu, Wen Zhao, Zigao Dai

78. [Characterization of the Scattered Light Noise in KAGRA Interferometer](#user-content-link78)
**Authors:** Shih-Hong Hsu, Hirotaka Yuzurihara, Chia-Jui Chou, Yi Yang

79. [Probing the High-Energy Emission of the VHE-emitting Changing-Look Blazar B2 1420+32](#user-content-link79)
**Authors:** Anjum Peer, Zahir Shah, Sikandar Akbar, Bari Maqbool, Ranjeev Misra

80. [Constraints on the VHE counterpart of two binary black hole mergers observed by the MAGIC and CTAO LST-1 telescopes](#user-content-link80)
**Authors:** K. Abe, S. Abe, J. Abhir, A. Abhishek, V. A. Acciari, F. Acero, A. Aguasca-Cabot, I. Agudo, I. Albanese, D. Ambrosino, F. Ambrosino, T. Aniello, S. Ansoldi, L. A. Antonelli, C. Aramo, C. Arauner, A. Arbet-Engels, C. Arcaro, T. T. H. Arnesen, P. Aubert, A. Babi\'c, C. Bakshi, A. Baktash, M. Balbo, A. Bamba, A. Baquero Larriva, U. Barres de Almeida, J. A. Barrio, L. Barrios Jim\'enez, I. Batkovic, J. Baxter, J. Becerra Gonz\'alez, W. Bednarek, E. Bernardini, J. Bernete, A. Berti, J. Besenrieder, C. Bigongiari, A. Biland, E. Bissaldi, O. Blanch, \v{Z}, . Bo\v{s}njak, G. Bonnoli, P. Bordas, L. Breton-Zaourat, A. Briscioli, E. Bronzini, G. Brunelli, J. Buces, A. Bulgarelli, I. Burelli, L. Burmistrov, C. Campa, A. Campoy-Ordaz, M. Cardillo, S. Caroff, A. Carosi, R. Carosi, R. Carraro, M. Carretero-Castrillo, F. Cassol, A. J. Castro-Tirado, D. Cerasole, G. Ceribella, A. Cervi\~no Cort\'inez, Y. Chai, A. Chiavassa, A. Chilingarian, G. Chon, L. Chytka, G. M. Cicciari, A. Cifuentes Santos, J. L. Contreras, J. Cortina, H. Costantini, S. Covino, M. Croisonnier, G. D'Amico, P. Da Vela, M. Dalchenko, F. Dazzi, A. De Angelis, M. de Bony de Lavergne, B. De Lotto, R. de Menezes, G. De Palma, V. de Souza, R. Del Burgo, L. Del Peral, M. Delfino, C. Delgado Mendez, J. Delgado Mengual, D. della Volpe, L. Di Bella, C. Di Domenico, A. Di Piano, F. Di Pierro, R. Di Tria, L. Di Venere, C. D\'iaz, A. Dinesh, E. Do Souto Espi\ neira, D. Dominis Prester, A. Donini, D. Dorner, M. Doro, L. Eisenberger, D. Els\"asser, G. Emery, J. Escudero, L. Fari\ na, L. Feligioni, F. Ferrarotto, A. Fiasson, L. Foffano, L. Font, F. Fr\'ias Garc\'ia-Lago, Y. Fukazawa, S. Gallozzi, J. Garcia Garcia, R. J. Garc\'ia L\'opez, S. Garcia Soto, D. Gasparrini, S. Gasparyan, M. Gaug, J. G. Giesbrecht Paiva, N. Giglietto, F. Giordano, P. Gliwny, N. Godinovic, T. Gradetzke, R. Grau, J. Green, G. Grolleron, S. Gunji, P. G\"unther, D. Hadasch, A. Hahn, M. Hashizume, T. Hassan, K. Hayashi, L. Heckmann, M. Heller, J. Herrera Llorente, N. Hiroshima, D. Hoffmann, D. Horns, J. Houles, D. Hrupec, T. Inada, S. Inoue, K. Ioka, M. Iori, D. Israyelyan, A. Iuliano, J. Jahanvi, I. Jim\'enez Mart\'inez, J. Jim\'enez Quiles I. Jorge Rodrigo, J. Jurysek, M. Kagaya, S. Kankkunen, V. Karas, H. Katagiri, T. Kayanoki, D. Kerszberg, M. Khachatryan, G. W. Kluge, Y. Kobayashi, K. Kohri, J. Konrad, P. Kornecki, P. M. Kouch, H. Kubo, J. Kushida, B. Lacave, M. L\'ainez, A. Lamastra, L. Lemoigne, E. Lindfors, M. Linhoff, S. Lombardi, F. Longo, R. L\'opez-Coto, M. L\'opez-Moya, A. L\'opez-Oramas, S. Loporchio, A. Lorini, J. Lozano Bahilo, F. Lucarelli, H. Luciani, L. Luli\'c, P. L. Luque-Escamilla, P. Majumdar, M. Makariev, M. Mallamaci, D. Mandat, G. Maneva, M. Manganaro, S. Mangano, D. K. Maniadakis, G. Manic\`o, K. Mannheim, F. Marini, M. Mariotti, G. Marsella, J. Mart\'i, D. Martin, G. Mart\'inez, M. Mart\'inez, O. Martinez, P. Maru\v{s}, evec, M. Massa, D. Mazin, S. Menchiari, J. M\'endez-Gallego, S. Menon, E. Mestre Guillen, D. Miceli, T. Miener, J. M. Miranda, J. M. Miranda, R. Mirzoyan, M. Mizuno, M. Molero Gonzalez, E. Molina, H. A. Mondal, T. Montaruli, A. Moralejo, S. Morales Sanchez De Lozada, K. Morita, A. Morselli, V. Moya, K. Mrakov\v{c}i\'c, A. L. M\"uller, H. Muraishi, T. Nagata, S. Nagataki, T. Nakamori, C. Nanci, A. Negro, A. Neronov, V. Neustroev, D. Nieto Casta\~no, M. Nievas Rosillo, C. Nigro, L. Nikoli\'c, K. Nilsson, K. Noda, V. Novotny, S. Nozaki, M. Ohishi, A. Okumura, R. Orito, L. Orsini, J. Otero-Santos, P. Ottanelli, S. Paiano, M. Palatiello, G. Panebianco, D. Paneque, R. Paoletti, J. M. Paredes, M. Pech, M. Pecimotika M. Peresano, F. Perrotta, M. Persic, F. Pfeifle, E. Pietropaolo, M. Pihet, G. Pirola, C. Plard, F. Podobnik, M. Polo, C. Pozo-Gonzal\'ez, P. G. Prada Moroni, E. Prandini, S. Rain\`o, R. Rando, W. Rhode, M. Rib\'o, J. Rico, V. Rizi, G. Rodriguez Fernandez, A. Roy, E. Ruiz-Velasco, N. Sahakyan, T. Saito, S. Sakurai, D. A. Sanchez, H. Sano, E. Santos Moura, T. \v{S}ari\'c, Y. Sato, F. G. Saturni, V. Savchenko, F. Schiavone, K. Schmitz, F. Schussler, T. Schweizer, M. Seglar Arroyo U. Sharma, T. Siegert, G. Silvestri, A. Simongini J. Sitarek, V. Sliusar, D. Sobczynska, I. Sofia, A. Stamerra, J. Stri\v{s}kovi\'c, D. Strom, M. Strzys, Y. Suda, A. Sunny, H. Tajima, M. Takahashi, R. Takeishi, S. J. Tanaka, J. Tartera Barber\`a, T. Tavernier, P. Temnikov, Y. Terada, K. Terauchi, T. Terzic, M. Teshima, M. Tluczykont, T. Tomura, D. F. Torres, F. Tramonti, P. Travnicek, G. Tripodo, A. Tutone, S. Ubach, M. Vacula, M. V\'azquez Acosta, S. Ventura, G. Verna, I. Viale, A. Viana, A. Vigliano, C. F. Vigorito, E. Visentin, V. Vitale, M. Vorbrugg, G. Voutsinas, I. Vovk, T. Vuillaume, R. Walter, C. Walther, L. Wan, P. Witczak, F. Wersig, T. Yamamoto, R. Yamazaki, Y. Yao, P. K. H. Yeung, T. Yoshida, T. Yoshikoshi, W. Zhang

81. [Long-term performance of the MLR-TT sensor: two-photon polymerization validation in the telescope environment](#user-content-link81)
**Authors:** Robert J. Harris, Philipp Hottinger, Jonathan Crass, Philipp-Immanuel Dietrich, Christian Koos

82. [Asgard/NOTT: Cryogenic characterization of the mid-infrared chip](#user-content-link82)
**Authors:** G. Garreau, D. Defr\`ere, R. Laugier, P. Chingaipe, M-A. Martinod, T. Mattheussen, K. Missiaen, J. Morren, G. Raskin, M. Salman, W. Verstraeten, A. Bigioli, S. Ertel, S. Gross, X. Haubois, M. Ireland, A. P. Jo\'o, S. Kraus, L. Labadie, S. Madden, F. Martinache, A. Mazzoli, G. Medgyesi, A. Sanny, N. Schuhler, J. P. Scott, T. A. Stuber, B. Vandenbussche

83. [Achieving efficient broadband spatial filtering for LIFE: status and plan](#user-content-link83)
...
84. [Fast, low-noise CCD systems for future strategic X-ray missions](#user-content-link84)
...
85. [Relationship of ICME Composition Signatures with Solar Activity during 2009-2025](#user-content-link85)
**Authors:** Diyorbek Pulatov, Zavkiddin Mirtoshev, Mirabbos Mirkamalov

86. [ESO-VLT BlueMUSE instrument - Conceptual Design for Phase A](#user-content-link86)
**Authors:** Florence Laurent, Johan Richard, R\'emi Giroud, Davor Krajnovi\'c, Alexandre Jeanneau, Manuel Abreu, Angela Adamo, Th\'eo Battrel, Didier Boudon, Zhemin Cai, Diane Chapuis-Kerouanton, Christopher Coote, Malak Galal, Joss Guy, Robert J. Harris, Andreas Kelz, Audrey Lanotte, Jon Lawrence, R\'emy Le Breton, Helen McGregor, Gloria Mellinand, Jonathan Moller, Manuel Monteiro, Guiliano Parma, Arlette P\'econtal, Peter M. Weilbacher

87. [Noise reduction in suspension control with photon-pressure actuator for CHRONOS gravitational wave detector](#user-content-link87)
**Authors:** Daiki Tanabe, Yuki Inoue, Mario Juvenal S. Onglao III

88. [Overview and design optimization of a custom hybrid X-ray telescope for the International Axion Observatory (IAXO)](#user-content-link88)
**Authors:** Yue Yu, Jooyun Woo, Ipek Altunyurt, Stefano Basso, Vadim Burwitz, Francisco R. Cand\'on, Juan Francisco Castel Pablo, Marta M. Civitani, Todd Decker, Klaus Desch, Desiree Della Monica Ferreira, Javier Galan, Maurizio Giannotti, Louis Helary, Peter L. Henriksen, Alba Mar\'ia Huerva, Igor G. Irastorza, Eftychia Kotsiou, Axel Lindner, Frank Marutzky, Sonny Massahi, Sam Moseley, Takashi Okajima, Johanna von Oy, Diego Paredes-Sanz, Giancarlo Parodi, Kerstin Perez, Michael J. Pivovaroff, David Reuther, Anacorina Romero, Jaime Ruz, Vyshnavi Sabbi, Tobias Schiffer, Uwe Schneekloth, Daniele Spiga, Marcela Stern, Julia K. Vogel

89. [Characterising the response of an International LOFAR Station](#user-content-link89)
...
90. [Predicting Atmospheric Re-entries Using Segmented M/A Calibration of Public TLE Data](#user-content-link90)
**Authors:** Joseph Remis

91. [Metric Type II Radio Emission associated with Coronal Mass Ejections of Large Angular Widths: Some New Insights](#user-content-link91)
**Authors:** Mayank Rajput, Susanta Kumar Bisoi, Janardhan Padmanabhan

92. [HARMONI at ELT: Reoptimization of the NGSS natural guide star sensors system for MCAO compatibility](#user-content-link92)
...
93. [Systematic Effects in Gaia CRF Photometry Related to Scanning Geometry and BP/RP excess factor](#user-content-link93)
**Authors:** Valeri V. Makarov

---

## 1. [LMC-induced Perturbations in the Milky Way Halo II: Bridging Field-level Inference and Summary-level Simulation-Based Inference](https://arxiv.org/abs/2607.20006) <a id="link1"></a>
...
**Comment:** This paper studies the gravitational interaction between the Milky Way and the LMC, focusing on the MW halo's dynamical disequilibrium and inference of MW and LMC masses and structural parameters. This is highly relevant to near-field cosmology (criterion 1), specifically MW-LMC interactions and halo structure, and uses advanced simulation-based inference (criterion 5).
...
## 2. [Boundary conditions for radial pulsations in AGB envelopes](https://arxiv.org/abs/2607.19778) <a id="link2"></a>
...
**Comment:** This paper presents new boundary conditions for radial pulsations in AGB/post-AGB envelopes, which is directly relevant to stellar models (criterion 4). It provides a theoretical framework for pulsation spectra and boundary conditions, which is a foundational improvement.
...
## 3. [Reading Between the Lines: Forward Modeling Dust, Continuum, and Spectral Cleaning for Multi-Line Intensity Mapping](https://arxiv.org/abs/2607.19504) <a id="link3"></a>
...
**Comment:** Forward modeling of dust, continuum, and spectral cleaning for multi-line intensity mapping using semi-analytic galaxy models and N-body simulations. This is directly relevant to 'Numerical Galaxy Simulations' and also touches on 'Star Formation Driven Outflows' and 'Circumgalactic Medium' via dust attenuation and aggregate emission from unresolved galaxies. The use of semi-analytic models and intensity mapping is highly relevant.
...
## 4. [Large Magellanic Cloud Globular Clusters in the Near-infrared. I. RR Lyrae in Reticulum](https://arxiv.org/abs/2607.19475) <a id="link4"></a>
...
**Comment:** This paper presents near-infrared observations of RR Lyrae stars in Reticulum, a globular cluster in the outer LMC. It tests stellar pulsation models and calibrates population II distance indicators, directly matching the 'Stellar Models' criterion. The focus on RR Lyrae and PL relations is highly relevant for stellar evolutionary tracks and bolometric corrections.
...
## 5. [From Dark Matter to Galaxies: Halo-Free Mock Generation via Conditional Point-Cloud Diffusion](https://arxiv.org/abs/2607.19808) <a id="link5"></a>
...
**Comment:** This paper presents a new diffusion-based generative model for creating galaxy catalogues from dark matter density fields, bypassing halo finding and directly connecting dark matter statistics to observable galaxy populations. It is highly relevant to the 'Numerical Galaxy Simulations' criterion, as it introduces a novel simulation method and connects galaxy formation to dark matter structure. The method is original and impactful for simulation-based inference.
...
## 6. [Testing dark matter density profiles based on Pad\'e approximants of different orders](https://arxiv.org/abs/2607.20262) <a id="link6"></a>

**ArXiv ID:** 2607.20262

**Authors:** Talgar Konysbayev, Orlando Luongo, Marco Muccino, Yergali Kurmanov, Kuantay Boshkayev, Gulnara Suliyeva, Ainur Urazalina, Guldana Rabigulova

**Abstract:** We investigate whether low-order Pad\'e rational functions can be used as empirical density profiles for modeling dark matter halos from galaxy RCs. We introduce three parameterizations determined from Pad\'e series, denoted Pad\'e 02, Pad\'e 12 and Pad\'e 03, and compare them with pseudo-isothermal, Burkert, Beta, Brownstein, exponential-sphere and Persic models. The analysis is performed for eight galaxies under the assumption that RCs are dark matter dominated. The parameters are inferred from RC data and the relative statistical performance of the models is obtained through the Bayesian Information Criterion. We find that the Pad\'e profiles perform well, being comparable with the other profiles, albeit not universally preferred. In most galaxies, conventional two parameter profiles provide fits of comparable or better statistical quality, whereas the clearest improvement occurs for one particular galaxy, where the Pad\'e 03 profile gives the lowest BIC. Even though the Pad\'e profiles are often statistically less strong than other models, they appear plausible in explaining the dark matter nature. Hence, their empirical construction can therefore be used to reconstruct RCs phenomenologically.

**Comment:** Directly addresses dark matter density profiles (core-cusp) in galaxies using new empirical models, which is highly relevant to near-field cosmology and foundational methods for dark matter halo structure.
...
## 7. [A Scalable Fast Multipole Method Poisson Solver for the RAMSES code: II. Adaptive Mesh Refinement and Adaptive Time Stepping](https://arxiv.org/abs/2607.19489) <a id="link7"></a>
...
**Comment:** This paper presents a new scalable Poisson solver for the RAMSES code, which is a major tool for numerical galaxy simulations. The focus is on algorithmic improvements (AMR, time stepping) rather than galaxy physics, but it is directly relevant to the 'Numerical Galaxy Simulations' criterion, especially as it enables more efficient and scalable galaxy simulations.
...
## 8. [Modeling the HI-Halo Connection: Evolution, Scatter, and a Halo-based Prescription for 21-cm Mock Catalogs](https://arxiv.org/abs/2607.20123) <a id="link8"></a>
...
**Comment:** Presents a new halo-based prescription for HI in galaxies using semi-analytic models and simulations, directly relevant to numerical galaxy simulations and the HI-halo connection, with implications for satellite galaxy populations and mock catalogs.
...
## 9. [Strong Gravitational Lensing Posterior Sampling in Pixel-Space Using Diffusion Models and Recurrent Inference Machines](https://arxiv.org/abs/2607.19459) <a id="link9"></a>
...
**Comment:** This paper presents a new method for posterior sampling in strong gravitational lensing using diffusion models and recurrent inference machines. It models both the source and foreground mass distribution, with galaxies drawn from cosmological hydrodynamical simulations. This fits the 'Numerical Galaxy Simulations' criterion, especially as it involves high-resolution simulations and new modeling techniques.
...
## 10. [Swing amplification in star-gas disks](https://arxiv.org/abs/2607.19540) <a id="link10"></a>
...
**Comment:** This paper presents a theoretical study of swing amplification in star-gas disks, providing new solutions to coupled star-gas linear equations and a Python code for calculation. It is relevant to 'Numerical Galaxy Simulations' and 'Stellar Models' criteria, as it presents new theoretical models for galactic disks and their non-axisymmetric features.
...
## 11. [Asteroseismic Analysis of a Red Giant KIC 9145955 by Including the Small-scale Magnetic Fields in the Atmosphere](https://arxiv.org/abs/2607.19720) <a id="link11"></a>
...
**Comment:** This paper presents asteroseismic modeling of a red giant, including the effect of small-scale magnetic fields. It is relevant to the 'Stellar Models' criterion, as it discusses modifications to stellar atmosphere models and their impact on observed frequencies.
...
## 12. [The GOLIATH Survey: OVI Absorption Reveals CGM Evolution through the Starburst-to-Quiescent Transition in Massive Galaxies](https://arxiv.org/abs/2607.19473) <a id="link12"></a>
...
**Comment:** This paper studies the circumgalactic medium (CGM) of massive galaxies, focusing on OVI absorption and its evolution through the starburst-to-quiescent transition. It matches the 'Circumgalactic Medium' and 'Star Formation Driven Outflows' criteria, but is weighted lower as it focuses on galaxies more massive than the LMC.
...
## 14. [A Probabilistic Framework for Population Studies of the Solar Neighborhood: Application to SDSS-V and Gaia](https://arxiv.org/abs/2607.19501) <a id="link14"></a>
...
**Comment:** This paper presents a probabilistic framework for population studies of the Solar Neighborhood, focusing on characterizing stellar subpopulations and mapping H-alpha emission across the HR diagram. It is somewhat relevant to resolved star formation histories (criterion 2) as it enables mapping of stellar properties and emission, but it does not directly derive star formation histories from color-magnitude diagrams. The methodology could be useful for future studies in resolved star formation histories, but the direct application is limited.
...
## 15. [The Age-Thickness Relation as a Tracer of the Merger History of Disk Galaxies](https://arxiv.org/abs/2607.19537) <a id="link15"></a>
...
**Comment:** This paper analyzes the age-thickness relation in disk galaxies using TNG50 simulations to trace merger history. While it uses numerical galaxy simulations and discusses disk heating and dynamical evolution, its focus is on the stellar disk and merger history rather than satellite galaxies or resolved star formation histories. It is borderline relevant due to its use of galaxy simulations and implications for disk evolution.
...
## 16. [Estimating Cluster Galaxy Infall Time from Phase Space in TNG](https://arxiv.org/abs/2607.20406) <a id="link16"></a>
...
**Comment:** Uses TNG simulations to estimate infall times for cluster galaxies. This is numerical galaxy simulation analysis, but focuses on cluster environments and not specifically on dwarfs or satellites. Relevant to numerical galaxy simulations, but weighted lower as it analyzes existing simulations and does not directly address other core topics.
...
## 17. [Exploring the Small-scale Magnetic Fields in the Atmosphere of HD 49385 by Asteroseismic Analysis](https://arxiv.org/abs/2607.19724) <a id="link17"></a>
...
**Comment:** This paper uses asteroseismic analysis to study small-scale magnetic fields in the atmosphere of an evolved star, HD 49385. It incorporates a modified stellar atmosphere model and discusses stellar parameters and core properties. This fits the 'Stellar Models' criterion, as it presents improvements to stellar atmosphere modeling and interior properties, but is not a major breakthrough. The focus is on a single star, not galaxies or cosmology.
...
## 18. [Cosmic CORALS: Timing the Universe with high-z star clusters](https://arxiv.org/abs/2607.19472) <a id="link18"></a>
...
**Comment:** This paper uses high-redshift star clusters observed with JWST to anchor the age-redshift relation and constrain cosmological parameters. While it involves resolved stellar populations and ages, it does not derive star formation histories from color-magnitude diagrams or focus on dwarf galaxies. It is borderline relevant due to its use of stellar ages, but not a direct match.
...
## 19. [Resolving Galactic and Cluster Dynamics Without Dark Matter: Tsallis Entropy as the Unique Foundation of Emergent Gravity](https://arxiv.org/abs/2607.19435) <a id="link19"></a>
...
**Comment:** This paper proposes Tsallis entropy as the foundation for emergent gravity and applies it to galactic rotation curves, galaxy clusters, and globular clusters. While it discusses galaxy dynamics and dark matter alternatives, it does not focus on dwarf satellites, resolved star formation histories, or galaxy simulations. It is borderline relevant due to its focus on galactic and cluster dynamics.
...
## 21. [When Galaxies Refuel: Evolution of the Perturbed Spiral Galaxy NGC1385](https://arxiv.org/abs/2607.19717) <a id="link21"></a>
...
**Comment:** Analyzes the star formation history, gas, and metallicity distribution of the spiral galaxy NGC 1385 using resolved spectroscopy and population synthesis. While it uses resolved star formation histories, the focus is on a massive spiral galaxy, not dwarfs or satellites. Borderline relevance due to resolved SFH analysis.
...
## 22. [The UK Infrared Telescope M33 monitoring project. VI. Feedback from dusty stellar winds across the galactic disc](https://arxiv.org/abs/2607.19989) <a id="link22"></a>
...
**Comment:** This paper measures dust and gas mass-loss rates from AGB stars and red supergiants across M33, a Local Group spiral galaxy. It discusses mass return to the ISM and feedback, which is tangentially related to star formation driven outflows, but the focus is on stellar winds in a massive galaxy, not dwarfs. No direct match to resolved SFH or quenching.
...
## 23. [A universal chromosome map for globular clusters: chemical calibration and environmental regulation of the multiple populations](https://arxiv.org/abs/2607.20091) <a id="link23"></a>
...
**Comment:** This paper focuses on globular clusters and their multiple stellar populations, using chromosome maps to study chemical enrichment and environmental effects. While it involves stellar populations and chemical abundances, it does not directly address dwarf galaxies, resolved star formation histories, quenching, or numerical galaxy simulations. The work is most closely related to the 'Stellar Models' criterion, as it presents a new photometric enrichment index and discusses chemical calibration, but it is not a foundational stellar model paper. Borderline relevance.
...
## 24. [Discovery of Optical Filaments in the North Polar Spur/eROSITA Bubble](https://arxiv.org/abs/2607.19529) <a id="link24"></a>
...
**Comment:** The paper reports the discovery of optical filaments in the North Polar Spur/eROSITA bubble, discussing their emission and possible origins. The focus is on large-scale Galactic structures and outflows, but the context is the Milky Way's disk and halo, not dwarf galaxies or satellite systems. The relevance is borderline due to the mention of star formation driven winds, but the main focus is not on the specified topics.
...
## 25. [Shock cooling emission from late-time mass loss in low-mass He star binaries](https://arxiv.org/abs/2607.19598) <a id="link25"></a>
...
**Comment:** This paper models shock cooling emission from late-time mass loss in low-mass He star binaries and connects to fast blue optical transients (FBOTs). While it involves binary stellar evolution and supernovae, it does not directly address resolved star formation histories, stellar models, or galaxy simulations. It is borderline relevant due to its focus on stellar evolution and mass loss, but not a direct match.
...
## 26. [AGN Feedback Models and AGN Demographics II: Comparing Predictions of Radiative and Total Feedback to Observations](https://arxiv.org/abs/2607.19603) <a id="link26"></a>
...
**Comment:** This paper compares AGN feedback models in galaxy simulations to observations. While it analyzes galaxy simulations (criterion 5), the focus is on AGN feedback and demographics, not on dwarf galaxies, star formation, or outflows. It is borderline relevant due to the simulation aspect.
...
## 27. [Rapid growth in a dual AGN during a gas-rich merger at z~4.5](https://arxiv.org/abs/2607.19491) <a id="link27"></a>
...
**Comment:** Discovery of a dual AGN in a gas-rich merger at high redshift. Focus is on SMBH growth and galaxy mergers, but the galaxies involved are massive and the topic is AGN-driven processes, not star-formation-driven outflows or dwarf galaxy evolution. No direct match to any core criteria.
...
## 28. [Clarifying Dead Quasars and Downsizing through the Evolution of Star-Forming Galaxies and Active Galactic Nuclei](https://arxiv.org/abs/2607.19428) <a id="link28"></a>
...
**Comment:** This paper discusses the evolution of star-forming galaxies and AGNs, focusing on galaxy number densities and evolutionary scenarios. While it touches on galaxy evolution and quenching, the focus is on higher mass galaxies and AGNs, not dwarf galaxies or resolved star formation histories. No direct match to near-field cosmology, resolved SFH, or star formation quenching in dwarfs.
...
## 29. [Mid-Infrared Colors Vary with Galactic Environment: Contrasting Star-Forming Disks, Young Centers, and Quiescent Star-Formation Deserts](https://arxiv.org/abs/2607.19512) <a id="link29"></a>
...
**Comment:** This paper presents JWST mid-IR measurements of the ISM in nearby star-forming galaxies, focusing on mid-IR color variations and PAH properties in different galactic environments. The study is centered on the ISM of more massive galaxies, not dwarfs, and does not directly address resolved star formation histories, quenching, or outflows.
...
## 30. [Gas accretion onto the Milky Way: high-velocity cloud survival and the revival of the terminal-velocity paradigm](https://arxiv.org/abs/2607.20394) <a id="link30"></a>
...
**Comment:** Focuses on gas accretion onto the Milky Way via high-velocity clouds, but the main focus is on the Galactic disk and halo rather than satellite galaxies or CGM of dwarfs. Only tangentially related to near-field cosmology.
...
## 31. [Galactic Science with the LiteBIRD satellite: Spectral characterization of diffuse Galactic polarized emission at the angular power spectrum level](https://arxiv.org/abs/2607.20080) <a id="link31"></a>
...
**Comment:** The paper focuses on the spectral characterization of diffuse Galactic polarized emission and ISM properties using LiteBIRD, with implications for CMB foregrounds. While it provides insight into the ISM and Galactic structure, it does not directly address any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The focus is on ISM emission and magnetic field structure, which is tangential to the core topics.
...
## 32. [AGNFormer I: Reconstruction of AGN spectra using a probabilistic transformer model](https://arxiv.org/abs/2607.19640) <a id="link32"></a>
...
**Comment:** Development of a transformer model for AGN spectral reconstruction. While it is a novel application of machine learning to AGN spectra, it does not match any of the core criteria (no connection to galaxy simulations, star formation histories, etc.).
...
## 33. [Ringing of the Reionization: A first direct measurement of the intergalactic pressure smoothing scale at redshift z>4.2 as imprinted onto small-scale peculiar velocities in the Lyman-alpha forest](https://arxiv.org/abs/2607.19938) <a id="link33"></a>
...
**Comment:** This paper focuses on measuring the pressure smoothing scale in the intergalactic medium at high redshift using the Lyman-alpha forest. While it is related to cosmology and the thermal history of the universe, it does not directly address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The topic is largely outside the core interests.
...
## 34. [A pilot sample of Planck-selected strongly lensed sub-mm galaxies: NOEMA observations and physical characterisation](https://arxiv.org/abs/2607.19478) <a id="link34"></a>
...
**Comment:** This paper studies high-redshift, strongly lensed sub-mm galaxies using NOEMA observations. While it focuses on star formation and molecular gas in galaxies, the targets are massive, high-z galaxies, not dwarf satellites or near-field cosmology objects. No direct connection to resolved star formation histories, quenching, stellar models, or CGM of dwarfs. The relevance is low.
...
## 35. [Accurate parameter inference for the Light-cone Epoch of Reionization 21-cm signal](https://arxiv.org/abs/2607.19792) <a id="link35"></a>
...
**Comment:** This paper discusses parameter inference for the 21-cm signal during the Epoch of Reionization, focusing on statistical methods for interpreting cosmological signals. It does not address near-field cosmology, resolved star formation histories, dwarf galaxies, quenching, stellar models, or galaxy simulations. The relevance to the core topics is low.
...
## 36. [Can cosmic voids ease the Hubble tension? Local expansion in $w_0w_a$CDM](https://arxiv.org/abs/2607.20257) <a id="link36"></a>
...
**Comment:** This paper investigates the effect of cosmic voids on the Hubble tension. While it discusses local structure and its impact on cosmological measurements, it does not focus on near-field cosmology as defined (dwarf satellites, accreted halo, etc.), nor does it address any other core criteria.
...
## 38. [2D hydrodynamical simulations of Be star decretion disc formation through boundary layer effects](https://arxiv.org/abs/2607.19757) <a id="link38"></a>
...
**Comment:** Hydrodynamical simulations of Be star decretion discs; this is stellar physics but not stellar models (tracks/atmospheres) or galaxy-focused. No direct match to the specified criteria.
...
## 39. [Anharmonic Infrared Emission of Cyano-Substituted Polycyclic Aromatic Hydrocarbon Molecules: Cyanonaphthalenes as a Case Study](https://arxiv.org/abs/2607.20015) <a id="link39"></a>
...
**Comment:** Theoretical modeling of infrared emission from cyano-substituted PAHs, relevant for ISM chemistry and JWST observations. While it involves molecular astrophysics and spectral modeling, it does not match any of the core criteria (stellar models, galaxy simulations, etc.).
...
## 40. [The road towards precision measurements of $H_0$ with bright sirens in the Einstein Telescope era](https://arxiv.org/abs/2607.20413) <a id="link40"></a>
...
**Comment:** Forecasts precision measurements of H0 using gravitational wave sirens, relevant to cosmology but not to near-field cosmology, satellite galaxies, or galaxy-scale phenomena.
...
## 42. [Planetesimal Formation Across the Stellar Mass Spectrum and its Influence on Exoplanet-Inherited Volatile Budgets](https://arxiv.org/abs/2607.20271) <a id="link42"></a>
...
**Comment:** Simulations of planetesimal formation across stellar mass spectrum and implications for exoplanet volatile budgets. Focus is on planet formation, not galaxy evolution or any of the core criteria.
...
## 43. [The silent dark sector: a field-theory approach to unified dark fluids with vanishing speed of sound](https://arxiv.org/abs/2607.19494) <a id="link43"></a>
...
**Comment:** This paper presents a new field-theory model for the dark sector, unifying dark matter and dark energy. While it is cosmological in nature, it does not focus on near-field cosmology, satellite galaxies, star formation histories, quenching, or galaxy simulations. The relevance to the core topics is minimal.
...
## 45. [Origin of the Long-Period Radial Velocity Variation in the Red Supergiant HD 216946 (V424 Lac)](https://arxiv.org/abs/2607.19812) <a id="link45"></a>
...
**Comment:** Long-period radial velocity variations in a red supergiant star, interpreted as chromospheric activity and atmospheric dynamics. No direct connection to stellar models (tracks/atmospheres), galaxy evolution, or any core criteria.
...
## 46. [Spectral Data-cube Cleaning for CCAT Deep Spectroscopic Survey. I. Effect of correlated noise and filtering on the power spectrum](https://arxiv.org/abs/2607.20404) <a id="link46"></a>
...
**Comment:** This paper presents data processing techniques for a deep spectroscopic survey targeting the Epoch of Reionization. While it discusses line-intensity mapping and noise reduction, it does not directly address any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 47. [Dynamical Test of Cosmic Acceleration: $k$-nearest Neighbor Cross Correlation of Cosmic Microwave Background and Cosmic Infrared Background](https://arxiv.org/abs/2607.19648) <a id="link47"></a>
...
**Comment:** This paper measures the cross-correlation between the CMB and CIB to test cosmic acceleration and dark energy models. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 48. [Local morphology and asymmetry of galactic rotation curves in a kinetic gas transport framework: NGC 3198](https://arxiv.org/abs/2607.19505) <a id="link48"></a>
...
**Comment:** The paper analyzes the rotation curve of NGC 3198, a spiral galaxy, using HI distribution and kinetic gas transport. The focus is on the disk of a higher mass galaxy, not on dwarf satellites or near-field cosmology. No direct relevance to resolved star formation histories, quenching, or numerical galaxy simulations.
...
## 49. [Primordial black holes forming during kination: the trapped, the overdense, and the void](https://arxiv.org/abs/2607.20423) <a id="link49"></a>
...
**Comment:** Primordial black hole formation in early universe cosmology, using numerical relativity. No direct connection to near-field cosmology, galaxy evolution, or any of the core criteria.
...
## 50. [Interacting Dark Energy and Dark Matter in O(3) No-Scale Gravity](https://arxiv.org/abs/2607.20320) <a id="link50"></a>
...
**Comment:** Theoretical model for interacting dark energy and dark matter in a modified gravity framework. No direct connection to galaxy evolution, near-field cosmology, or any of the core criteria.
...
## 51. [Pulsar glitches in the presence of vortex traps](https://arxiv.org/abs/2607.20398) <a id="link51"></a>
...
**Comment:** Simulations of pulsar glitches and vortex traps in neutron stars. Focus is on neutron star interior physics, not galaxy evolution or any of the core criteria.
...
## 52. [CATKit2-HCI: a collaborative framework for advancing high-contrast coronagraph testbeds](https://arxiv.org/abs/2607.19921) <a id="link52"></a>
...
**Comment:** This paper describes a collaborative software framework for high-contrast coronagraph testbeds, relevant for exoplanet imaging instrumentation. It does not address galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 54. [No Surviving Companion to the Galactic SN 1181: Evidence for a Double-Degenerate Channel for Type Iax Supernovae](https://arxiv.org/abs/2607.19705) <a id="link54"></a>
...
**Comment:** Investigates the progenitor channel for Type Iax supernovae in the Milky Way, but does not address satellite galaxies, star formation histories, or galaxy simulations. No direct match to any core criteria.
...
## 55. [Constraining Effective Viscosity in the Intracluster Medium via the Thermal Sunyaev-Zeldovich Effect -- Predictions from the SLOW Constrained Coma Cluster Simulations](https://arxiv.org/abs/2607.19753) <a id="link55"></a>
...
**Comment:** This paper focuses on the intracluster medium (ICM) viscosity in the Coma cluster, a massive galaxy cluster. The work is centered on cluster-scale physics and does not address dwarf galaxies, satellite luminosity functions, star formation histories, quenching, stellar models, galaxy simulations, or outflows. The relevance to the core topics is very low.
...
## 56. [Microlensing Detection and Inference via Learned Bayes Factors](https://arxiv.org/abs/2607.20260) <a id="link56"></a>
...
**Comment:** This paper presents a new framework for microlensing detection and inference, with applications to Roman Space Telescope data. While it is a methodological advance in microlensing, it does not address any of the core topics.
...
## 57. [Skipper CCD readout time optimization for astronomical applications](https://arxiv.org/abs/2607.20126) <a id="link57"></a>
...
**Comment:** The paper discusses optimization of Skipper CCD readout for astronomical applications. While relevant for instrumentation, it does not address any of the core astrophysical criteria such as near-field cosmology, resolved SFH, or stellar models.
...
## 58. [QCD CP-violation scenario for a revised cosmological dynamics: analysis of the binned Pantheon Sample of Super Novae Ia](https://arxiv.org/abs/2607.19915) <a id="link58"></a>
...
**Comment:** Presents a modified cosmological model and fits to supernova data, but does not address galaxy-scale phenomena, satellite galaxies, or star formation histories. No direct match to any core criteria.
...
## 59. [Long-lived intermittent accretion disks in the jittering jets explosion mechanism (JJEM) of core-collapse supernovae](https://arxiv.org/abs/2607.20314) <a id="link59"></a>
...
**Comment:** This paper discusses the formation of intermittent accretion disks and jet-driven explosions in core-collapse supernovae, focusing on the jittering jets explosion mechanism. While it involves stellar feedback and disk physics, it does not address galaxy-scale outflows, dwarf galaxies, or resolved star formation histories. The relevance to core topics is low.
...
## 60. [The magnetic field strength of a methane dwarf measured from its radio spectral cutoff](https://arxiv.org/abs/2607.19642) <a id="link60"></a>
...
**Comment:** This paper measures the magnetic field strength of a methane dwarf from its radio spectral cutoff. It is focused on brown dwarfs and planetary magnetic fields, not on any of the core topics.
...
## 61. [The High-Speed FPGA Readout System for the Advanced X-ray Imaging Satellite (AXIS)](https://arxiv.org/abs/2607.20380) <a id="link61"></a>
...
**Comment:** This paper describes the development of a high-speed FPGA readout system for an X-ray imaging satellite. It is an instrumentation/engineering paper and does not match any of the core astrophysical criteria.
...
## 62. [Monopoles, Strings, Walls and Gravitational waves](https://arxiv.org/abs/2607.20340) <a id="link62"></a>
...
**Comment:** This paper discusses gauge symmetry breaking and the resulting topological defects (monopoles, strings, walls) and their gravitational wave signatures. The focus is on particle physics and early universe cosmology, not galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 63. [A Search for Exoplanets around Northern Circumpolar Stars X. The origin of radial velocity variations in the evolved star HD 216595](https://arxiv.org/abs/2607.19775) <a id="link63"></a>
...
**Comment:** This paper focuses on radial velocity variations in an evolved star (HD 216595) and the search for exoplanets. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The focus is on stellar variability and exoplanet detection, which are outside the relevant topics.
...
## 64. [Circumstellar Disc and X-ray Variability in the Be/X-ray Binary SXP 5.05 During its 2024 Outburst](https://arxiv.org/abs/2607.19373) <a id="link64"></a>
...
**Comment:** The paper studies the circumstellar disc and X-ray variability in a Be/X-ray binary system. While it discusses disc structure and variability, it does not address any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The focus is on binary star interactions and accretion, which are not relevant.
...
## 65. [Four, One, and None: Quantifying the Ultra-High-Energy Neutrino Anomaly Across ANITA-IV, KM3NeT, and IceCube](https://arxiv.org/abs/2607.19487) <a id="link65"></a>
...
**Comment:** This paper focuses on ultra-high-energy neutrino anomalies across multiple detectors. It is unrelated to any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 66. [Can the universe be matter-dominated after a supercooled first-order phase transition?](https://arxiv.org/abs/2607.19469) <a id="link66"></a>
...
**Comment:** This paper discusses the equation of state after a supercooled first-order phase transition and its implications for gravitational waves, primordial black holes, and dark matter. It is not related to any of the core topics.
...
## 67. [A Deep Learning Framework for Predicting Solar EUV Irradiance During Significant Flares](https://arxiv.org/abs/2607.19597) <a id="link67"></a>
...
**Comment:** This paper presents a deep learning framework for predicting solar EUV irradiance during flares. It is unrelated to galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 68. [Solar differential rotation driven by baroclinic forcing](https://arxiv.org/abs/2607.19730) <a id="link68"></a>
...
**Comment:** The paper investigates solar differential rotation and baroclinic forcing, focusing on solar interior dynamics. It is unrelated to galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 69. [RNDR noise modeling in first-generation Single electron Sensitive Readout (SiSeRO) devices](https://arxiv.org/abs/2607.19615) <a id="link69"></a>
...
**Comment:** Describes noise modeling in detector technology for X-ray astronomy, not directly related to any core criteria such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 70. [Height Dependent Phase Shifts of Wave Pulses in the Lower Solar Atmosphere Measured with SUNRISE III](https://arxiv.org/abs/2607.20052) <a id="link70"></a>
...
**Comment:** The paper presents measurements of wave pulses in the lower solar atmosphere using spectro-polarimetric observations. This is focused on solar physics and does not match any of the core criteria such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 71. [Fabrication status and expected performance of the inner-core X-ray optic for BabyIAXO](https://arxiv.org/abs/2607.20282) <a id="link71"></a>
...
**Comment:** This paper describes the fabrication and expected performance of an X-ray optic for the BabyIAXO axion experiment. It is focused on instrumentation and particle physics, not galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 72. [Peculiar Behavior of Optical Polarization in Blazar 1ES 1959+650: Role of Jet Magnetic Field and Geometry](https://arxiv.org/abs/2607.19869) <a id="link72"></a>
...
**Comment:** This paper studies optical polarization in a blazar, focusing on jet magnetic fields and geometry. It is unrelated to the core topics of near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, or outflows. The relevance is very low.
...
## 73. [Reversive and Non-Reversive Magnetic CP Stars. I. Catalog](https://arxiv.org/abs/2607.19900) <a id="link73"></a>
...
**Comment:** Catalog and analysis of magnetic chemically peculiar stars. No direct connection to any of the core criteria (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 74. [One cluster, two clusters, no cluster? -- The curious case of HSC 2686 and Lynga 3](https://arxiv.org/abs/2607.19735) <a id="link74"></a>
...
**Comment:** This paper investigates the reality of two open clusters and their association with planetary nebulae. It does not match any of the core criteria, as it focuses on cluster membership and classification rather than near-field cosmology, star formation histories, or stellar models.
...
## 75. [Oscillatory reconnection and resonant response to wave excitation in 2D coronal null points](https://arxiv.org/abs/2607.19978) <a id="link75"></a>
...
**Comment:** This paper studies oscillatory reconnection and wave excitation in coronal null points, which is focused on solar physics and not related to any of the core topics.
...
## 76. [Shock acceleration in vortex driven magnetic fields of black holes](https://arxiv.org/abs/2607.20209) <a id="link76"></a>
...
**Comment:** Focuses on particle acceleration in the magnetospheres of supermassive black holes, which is not relevant to any of the specified criteria (e.g., near-field cosmology, dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 77. [Identifying Kilonovae in the Presence of Optical Afterglow for the Wide-Field Survey Telescope](https://arxiv.org/abs/2607.20233) <a id="link77"></a>
...
**Comment:** Focuses on kilonova identification in optical transients, relevant to multimessenger astronomy but not to any of the specified galaxy or stellar criteria.
...
## 78. [Characterization of the Scattered Light Noise in KAGRA Interferometer](https://arxiv.org/abs/2607.19814) <a id="link78"></a>
...
**Comment:** The paper characterizes scattered light noise in the KAGRA gravitational wave interferometer. This is unrelated to galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 79. [Probing the High-Energy Emission of the VHE-emitting Changing-Look Blazar B2 1420+32](https://arxiv.org/abs/2607.20375) <a id="link79"></a>
...
**Comment:** Multi-wavelength study of a blazar, focused on AGN and jet physics, not related to satellite galaxies, star formation histories, or galaxy simulations.
...
## 80. [Constraints on the VHE counterpart of two binary black hole mergers observed by the MAGIC and CTAO LST-1 telescopes](https://arxiv.org/abs/2607.19972) <a id="link80"></a>
...
**Comment:** This paper presents gamma-ray observations of binary black hole mergers. The focus is on high-energy astrophysics and gravitational wave counterparts, which are not related to the core topics such as dwarf galaxies, star formation histories, galaxy simulations, or stellar models.
...
## 81. [Long-term performance of the MLR-TT sensor: two-photon polymerization validation in the telescope environment](https://arxiv.org/abs/2607.20244) <a id="link81"></a>
...
**Comment:** Reports on the performance of a tip-tilt sensor for telescopes; this is instrumentation-focused and does not match any of the core astrophysical criteria.
...
## 82. [Asgard/NOTT: Cryogenic characterization of the mid-infrared chip](https://arxiv.org/abs/2607.20191) <a id="link82"></a>
...
**Comment:** Describes cryogenic characterization of a mid-infrared chip for exoplanet imaging; this is instrumentation and exoplanet-focused, not relevant to the specified galaxy or stellar criteria.
...
## 84. [Fast, low-noise CCD systems for future strategic X-ray missions](https://arxiv.org/abs/2607.20355) <a id="link84"></a>
...
**Comment:** Reports on CCD systems for X-ray missions; this is instrumentation-focused and not relevant to any of the specified galaxy or stellar criteria.
...
## 85. [Relationship of ICME Composition Signatures with Solar Activity during 2009-2025](https://arxiv.org/abs/2607.20160) <a id="link85"></a>
...
**Comment:** Study of ICME composition signatures and their relation to solar activity. Focuses on solar and heliospheric physics, not galaxy evolution or any of the core criteria.
...
## 86. [ESO-VLT BlueMUSE instrument - Conceptual Design for Phase A](https://arxiv.org/abs/2607.20182) <a id="link86"></a>
...
**Comment:** This paper describes the conceptual design of the BlueMUSE instrument for the VLT. It is an instrumentation paper and does not match any of the core criteria.
...
## 87. [Noise reduction in suspension control with photon-pressure actuator for CHRONOS gravitational wave detector](https://arxiv.org/abs/2607.19983) <a id="link87"></a>
...
**Comment:** This paper discusses noise reduction in gravitational wave detectors using photon-pressure actuators. It is unrelated to the core criteria, as it focuses on instrumentation for gravitational wave detection.
...
## 88. [Overview and design optimization of a custom hybrid X-ray telescope for the International Axion Observatory (IAXO)](https://arxiv.org/abs/2607.20390) <a id="link88"></a>
...
**Comment:** This paper presents the design optimization of a custom X-ray telescope for the International Axion Observatory. It is an instrumentation paper and does not match any of the core criteria.
...
## 89. [Characterising the response of an International LOFAR Station](https://arxiv.org/abs/2607.19585) <a id="link89"></a>
...
**Comment:** This paper characterizes the response of a LOFAR station, focusing on beam modeling and calibration. It is an instrumentation and calibration paper, not matching any of the core criteria.
...
## 90. [Predicting Atmospheric Re-entries Using Segmented M/A Calibration of Public TLE Data](https://arxiv.org/abs/2607.20128) <a id="link90"></a>
...
**Comment:** This paper presents a method for predicting atmospheric re-entries using TLE data. It is unrelated to the core criteria, as it focuses on orbital mechanics and satellite tracking.
...
## 91. [Metric Type II Radio Emission associated with Coronal Mass Ejections of Large Angular Widths: Some New Insights](https://arxiv.org/abs/2607.19784) <a id="link91"></a>
...
**Comment:** The paper is a study of solar radio bursts and coronal mass ejections, which is unrelated to galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 92. [HARMONI at ELT: Reoptimization of the NGSS natural guide star sensors system for MCAO compatibility](https://arxiv.org/abs/2607.20330) <a id="link92"></a>
...
**Comment:** This paper describes technical changes to the adaptive optics system for the HARMONI instrument at the ELT. It is focused on instrumentation and does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 93. [Systematic Effects in Gaia CRF Photometry Related to Scanning Geometry and BP/RP excess factor](https://arxiv.org/abs/2607.19584) <a id="link93"></a>
...
**Comment:** This paper discusses systematic effects in Gaia photometry related to scanning geometry and BP/RP excess factor. It does not match any of the core criteria, as it is focused on instrument systematics and catalog artifacts.
