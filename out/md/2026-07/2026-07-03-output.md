...
1. [The Merger-Driven Origin of the Vast Extended Stellar Disc Around the Andromeda Galaxy](#user-content-link1)
**Authors:** C. Tsakonas, M. Arnaboldi, F. Hammer, Y. Yang, O. Gerhard, A. Burkert, D. Hatzidimitriou

2. [Spherically Symmetric Fluid Simulations of Black Hole Accretion in Self-Interacting Dark Matter Halos](#user-content-link2)
**Authors:** Zhe Meng, Tan Chen, Bocheng Zhu, Fan Zhou, Bin Hu, Liang Gao, Rong-Gen Cai

3. [Stark-Broadened Profiles for Ionized Helium Lines Using Computer Simulations](#user-content-link3)
**Authors:** Patrick Tremblay, Alain Beauchamp, Pierre Bergeron

4. [Indicatives of Early Stages of Star Formation in the Universe](#user-content-link4)
**Authors:** Irina Acharova, Margarita Sharina

5. [Native-Opacity Sensitivity of a Fixed Delta Cephei MESA-RSP Pulsation Model](#user-content-link5)
**Authors:** Zuhoor Elahi, Christopher Sirola, Wafa Gull

6. [Post-starburst Galaxies with Active Galactic Nucleus: Properties and Evolutionary Sequences](#user-content-link6)
...
7. [Resolved HI and Environmental Dynamics](#user-content-link7)
...
8. [SN 2020bij and a Possible Slow-Rise High-Velocity Subclass of Type IIP Supernovae](#user-content-link8)
**Authors:** Sondos Mohsen-Tanev, Iair Arcavi, Shahar Bracha, K. Azalee Bostroem, Griffin Hosseinzadeh, Jesper Sollerman, Claudia P. Guti\'errez, Priscila J. Pessi, Joseph Anderson, Mariusz Gromadzki, Avishay Gal-Yam, Daichi Hiramatsu, Jamison Burke, Koichi Itagaki, Ting-Wan Chen, D. Andrew Howell, Curtis McCully, Megan Newsome, Estefania Padilla Gonzalez, Craig Pellegrino

9. [Can Primordial Black Holes Be Seeds for Early Galaxies in Models Satisfying the Covariant Entropy Bound?](#user-content-link9)
**Authors:** Sidan A, Tom Banks, Willy Fischler

10. [Gravitational Waves from Primordial Black Holes: Connecting Low-Frequency Scalar-Induced Signatures to High-Frequency Binary Mergers](#user-content-link10)
**Authors:** Ashu Kushwaha

11. [Lattice study of primordial black hole formation in bumpy axion inflation](#user-content-link11)
**Authors:** Masahiro Kawasaki, Kai Murai, Shunsuke Tsuchida

12. [Axion Misalignment Across First-Order Phase Transitions](#user-content-link12)
**Authors:** Galymzhan Baltabay, Francesco D'Eramo, Ville Vaskonen

13. [The fingerprint of primordial mass segregation on the tidal tails of star clusters](#user-content-link13)
**Authors:** S. Mojtaba Ghasemi, Hosein Haghi, Mohammad Mansoury, Akram Hasani Zonoozi, Pouriya Miri, Pavel Kroupa

14. [Assessing Ultra-Cool Dwarf Contamination in Photometrically Selected High-Redshift Galaxy Samples](#user-content-link14)
**Authors:** Onnalin Innala, Nicha Leethochawalit, Takahiro Morishita, Michele Trenti

15. [Asteroseismic Analysis of the Merger Product Red Giant in the $\gamma$ Persei System](#user-content-link15)
**Authors:** Roz\'alia Z. \'Ad\'am (Konkoly Observatory, Research Centre for Astronomy and Earth Sciences, HUN-REN, ELTE E\"otv\"os Lor\'and University, Institute of Physics and Astronomy), L\'aszl\'o Moln\'ar (Konkoly Observatory, Research Centre for Astronomy and Earth Sciences, HUN-REN, ELTE E\"otv\"os Lor\'and University, Institute of Physics and Astronomy, MTA-HUN-REN CSFK Lend\"ulet Momentum Stellar Pulsation Research Group), R\'obert Szab\'o (Konkoly Observatory, Research Centre for Astronomy and Earth Sciences, HUN-REN, ELTE E\"otv\"os Lor\'and University, Institute of Physics and Astronomy, MTA-HUN-REN CSFK Lend\"ulet Momentum Stellar Pulsation Research Group), Csilla Kalup (Konkoly Observatory, Research Centre for Astronomy and Earth Sciences, HUN-REN, ELTE E\"otv\"os Lor\'and University, Institute of Physics and Astronomy), Frank Grundahl (Stellar Astrophysics Centre), Daniel Huber (Institute for Astronomy, University of Hawai'i), Mads Skakke Fredslund (Stellar Astrophysics Centre), Pere L. Pall\'e (Instituto de Astrof\'isica de Canarias, Universidad de La Laguna), D\'ora Tarczay-Neh\'ez (Konkoly Observatory, Research Centre for Astronomy and Earth Sciences, HUN-REN, ELTE E\"otv\"os Lor\'and University, Institute of Physics and Astronomy), Jonatan Rudrasingam (Stellar Astrophysics Centre, Sydney Institute for Astronomy, School of Physics, University of Sydney, School of Mathematical and Physical Sciences, Macquarie University)

16. [The Debris Disk Host $\beta$ Piscis Austrinus is a Rapidly Rotating Star Seen Nearly Pole-On](#user-content-link16)
...
17. [Bolometric correction factor and radiative efficiency for the super-Eddington accretion flow in tidal disruption events](#user-content-link17)
**Authors:** Yongxin Wu, Erlin Qiao, Xuan Fang, Yiyang Lin, Jifeng Liu, Meng Guo

18. [Revisiting atmospheric Roche lobe overflow in symbiotic binaries](#user-content-link18)
**Authors:** Tan Liu, Natalia Ivanova, Philipp Podsiadlowski, Joanna Miko{\l}ajewska, Zheng-Wei Liu, Xuefei Chen, Xiangcun Meng, Zhanwen Han

19. [meer21cm: an Analysis Pipeline and Comprehensive Toolkit for HI Intensity Mapping](#user-content-link19)
**Authors:** Zhaoting Chen (MeerKLASS Collaboration), Steven Cunnington (MeerKLASS Collaboration), Daniel Tassie (MeerKLASS Collaboration), Alkistis Pourtsidou (MeerKLASS Collaboration), Laura Wolz (MeerKLASS Collaboration), Gabriele Autieri (MeerKLASS Collaboration), Matilde Barberi-Squarotti (MeerKLASS Collaboration), Jos\'e Luis Bernal (MeerKLASS Collaboration), Phil Bull (MeerKLASS Collaboration), Stefano Camera (MeerKLASS Collaboration), Isabella P. Carucci (MeerKLASS Collaboration), Brandon Engelbrecht (MeerKLASS Collaboration), Jos\'e Fonseca (MeerKLASS Collaboration), Karin Fornazier (MeerKLASS Collaboration), Keith Grainge (MeerKLASS Collaboration), Jiakang Han (MeerKLASS Collaboration), Wenkai Hu (MeerKLASS Collaboration), Melis O. Irfan (MeerKLASS Collaboration), Piyanat Kittiwisit (MeerKLASS Collaboration), Yichao Li (MeerKLASS Collaboration), Sefa Pamuk (MeerKLASS Collaboration), Mario G. Santos (MeerKLASS Collaboration), Marta Spinelli (MeerKLASS Collaboration), Jingying Wang (MeerKLASS Collaboration), Amadeus Witzemann (MeerKLASS Collaboration), Boyan Zhao (MeerKLASS Collaboration)

20. [Tracing grain growth in the forming prestellar core L1506C with 3D modeling of Herschel, IRAM, and CFHT observations](#user-content-link20)
**Authors:** E. Zhu, I. Ristorcelli, K. Demyk, M. Juvela, N. Ysard, D. Paradis, H. Roussel, W. Kiviaho

21. [How I stop worrying about non-universality and $b_\phi$: Constraining local $f_{\rm NL}$ with $b_\phi$ priors from HOD posteriors](#user-content-link21)
**Authors:** Jiaxi Yu, Nhat-Minh Nguyen

22. [Fractional-Dimension Gravity and the Milky Way Galaxy](#user-content-link22)
**Authors:** Gabriele U. Varieschi

23. [Lensing-Reconstructed Dark Matter-Intracluster Medium Coherence as a Probe of Cluster Dynamical State: Application to HSTFF, RELICS, and CLASH Clusters](#user-content-link23)
**Authors:** Giulia Cerini (Jet Propulsion Laboratory California Institute of Technology), Sayan Saha (Northeastern University), Jacqueline McCleary (Northeastern University), Eric Habjan (Northeastern University), Nico Cappelluti (Department of Physics University of Miami), Priyamvada Natarajan (Department of Astronomy Yale University, Department of Physics Yale University, Black Hole Initiative Harvard University), Sabina Khizroev (Duke University), Jason Rhodes (Jet Propulsion Laboratory California Institute of Technology), Eric Huff (Jet Propulsion Laboratory California Institute of Technology), Nicole Chidester (Northeastern University), Maya Amit (New York University), Andrew Robertson (Carnegie Observatories), Bryanne McDonough (Adelphi University), Elena Bellomi (Center for Astrophysics Harvard & Smithsonian), Erwin T. Lau (Nara Womens University), John ZuHone (Center for Astrophysics Harvard & Smithsonian)

24. [A possible high-redshift origin for the short GRB 061201: implications of a compact binary merger beyond cosmic noon](#user-content-link24)
**Authors:** E. Troja, B. O'Connor, Y. -H. Yang, T. M. Gaudin, M. Yadav, N. Passaleva, S. Dichiara

25. [The VLA-COSMOS 3 GHz Large Project: Polarised source counts and catalogue](#user-content-link25)
**Authors:** S. Ranchod, S. A. Mao, R. P. Deane, V. Smol\v{c}i\'c, J. D. Wagenveld, M. Bondi, K. Mooley, E. Schinnerer

26. [Alleviating prior dependencies for DESI DR1 clustering fits through reparameterization](#user-content-link26)
**Authors:** Marco Bonici, Simone Paradiso, Glenn McGee, Guido D'Amico, Minas Karamanis, Hanyu Zhang, Will Percival, Jessica Nicole Aguilar, Steven Ahlen, Davide Bianchi, David Brooks, Francisco Javier Castander, Todd Claybaugh, Axel de la Macorra, Biprateep Dey, Peter Doel, Simone Ferraro, Andreu Font-Ribera, Jaime E. Forero-Romero, Enrique Gazta\~naga, Satya Gontcho A Gontcho, Gaston Gutierrez, ChangHoon Hahn, Klaus Honscheid, Mustapha Ishak, Dick Joyce, Robert Kehoe, Theodore Kisner, Anthony Kremin, Ofer Lahav, Claire Lamman, Martin Landriau, Laurent Le Guillou, Marc Manera, Aaron Meisner, Ramon Miqu\'el, Gustavo Niz, Francisco Prada, Ignasi P\'erez-R\`afols, Graziano Rossi, Lado Samushia, Eusebio Sanchez, Edward Schlafly, David Schlegel, Joseph Harry Silber, David Sprayberry, Gregory Tarl\'e, Mariana Vargas Magana, Benjamin Alan Weaver, Pauline Zarrouk, Hu Zou

27. [Neutron stars as thermometers for reheating induced dipole dark matter](#user-content-link27)
**Authors:** Sahabub Jahedi

28. [Pulsar Science with the SKAO](#user-content-link28)
**Authors:** Bhal Chandra Joshi, Aris Karastergiou, Marta Burgay

29. [Aerosols and hydrocarbons in the atmosphere of a white dwarf planet](#user-content-link29)
...
30. [Polarization Architecture of Steady GRMHD Jets from the Horizon to Infinity](#user-content-link30)
**Authors:** Zhenyu Zhang, Yehui Hou, Yu Song, Yosuke Mizuno, Bin Chen

31. [No Evidence for Superradiant Axions in LIGO-Virgo-KAGRA GWTC-5 Binary Black Hole Spins](#user-content-link31)
**Authors:** Orion Ning, Benjamin R. Safdi, Catherine Welch

32. [TESS's First Bound Microlensing Planet: A Binary Microlensing Event Revealing a Planetary Companion toward the Galactic Plane](#user-content-link32)
**Authors:** Mallory Harris (University of New Mexico), Diana Dragomir (University of New Mexico), Etienne Bachelet (Universit\'e Marie et Louis Pasteur), Michael Fausnaugh (Texas Tech University), Samson Johnson (The Ohio State University)

33. [AI-enabled gravitational-waves searches for binary neutron stars at optimal sensitivity](#user-content-link33)
...
34. [Constraining the near-source relativistic wind medium using Fast Radio Burst circular polarization data](#user-content-link34)
**Authors:** Om Gupta, Pawan Kumar, Paz Beniamini

35. [Efficient high-order explicit symplectic splitting methods for post-Newtonian Hamiltonian systems](#user-content-link35)
**Authors:** Yujie Jiang, Lijie Mei

36. [IRIS: Deciphering Spectral-Line Imagery of the Galactic Center by Machine-Learning on Simulations](#user-content-link36)
...
37. [Revision of the Detached Eclipsing System IR Cas from TESS Observations, Ground-Based Photometry and Spectroscopy](#user-content-link37)
**Authors:** Mat\'u\v{s} Kamenec, Pavol Gajdo\v{s}, Martin Va\v{n}ko, Reddy Charan Reddy Munagala, Marek Skarka, \v{S}tefan Parimucha

38. [Current status of the High-Resolution Multi-Object Spectrograph (MOS-HR) for the Wide-field Spectroscopic Telescope](#user-content-link38)
**Authors:** Andrea Tozzi, Anna Brucalassi, Matteo Munari, Simone D'Auria, Andrea Bianco, Giorgio Pariani, Ciro Del Vecchio, Paolo Picchi, Roland Bacon, Bernard Delabre, David Lee, Sofia Randich, Will Saunders

39. [Discovery of sulfur oxides in the ejecta of a B[e] supergiant](#user-content-link39)
...
40. [Radiative filtering unifies broad-line phenomenology in active galactic nuclei](#user-content-link40)
**Authors:** Mohammad Hassan Naddaf

41. [X-ray Fourier lag-frequency spectra modulated by stochastic turbulent acceleration in the jets of high-frequency-peaked BL Lac](#user-content-link41)
**Authors:** Guang-Cheng Xiao, Wen Hu, Da-Guo Jiang, Jun-Xian Wang, Zhen-Yi Cai, Da-Hai Yan, Fang-Wu Lu

42. [Testing Gravity with Binary Pulsars in the SKA Era](#user-content-link42)
...
43. [Architecture and Validation of the CRS F-Engine for the CHORD Radio Telescope](#user-content-link43)
**Authors:** Ian Hendricksen, Jean-Fran\c{c}ois Cliche, Matt Dobbs, Joshua Montgomery

44. [Gravitational Waves from Multiple First-Order Phase Transitions in a Scenario with Early Matter Domination](#user-content-link44)
**Authors:** Rouzbeh Allahverdi, Fazlollah Hajkarim

45. [Sideband Structure of Axion Electrodynamics](#user-content-link45)
**Authors:** Run-Min Yao, Xiao-Jun Bi, Peng-Fei Yin, Qing-Guo Huang

46. [Signatures of Two Distinct Epochs of FRB 20240114A from January to August 2024 Based on its Energy and Waiting Time Analysis](#user-content-link46)
**Authors:** Xiao Li, Ying Gu, En-Wei Liang

47. [A critical look at low-scale cosmological phase transitions in the PTA era](#user-content-link47)
**Authors:** Simone Biondini, Philipp Schicho

48. [The Galactic Centre G+0.633-0.0604 molecular cloud: a new astrochemical gold mine. I. Gas physical properties](#user-content-link48)
**Authors:** D. San Andr\'es (Centro de Astrobiolog\'ia, Departamento de F\'isica de la Tierra y Astrof\'isica, Facultad de Ciencias F\'isicas, Universidad Complutense de Madrid, Madrid, Spain), L. Colzi (Centro de Astrobiolog\'ia), V. M. Rivilla (Centro de Astrobiolog\'ia), M. Sanz-Novo (Center for Astrochemical Studies, Max-Planck-Institute f\"ur extraterrestrische Physik, Garching bei M\"unchen, Germany), S. Mart\'in (European Southern Observatory, Vitacura, Santiago, Chile, Joint ALMA Observatory, Vitacura, Santiago, Chile), I. Jim\'enez-Serra (Centro de Astrobiolog\'ia), S. Zeng (Star and Planet Formation Laboratory, Pioneering Research Institute)

49. [Extreme outflow velocities and weak UV emission lines indicate quasars shedding their dust cocoons](#user-content-link49)
**Authors:** Guozhen Ma, Stefan J. Geier, Johan P. U. Fynbo, Lise Christensen, Andrei Berdyugin, Rasmus Frederiksen, Kasper E. Heintz, Phillip D. Henriksen, Jens-Kristian Krogager, C\'edric Ledoux, Vilppu Piirola, Palle M{\o}ller, Simone Vejlgaard, Hyunseop Choi

50. [Colour evolution in the radio afterglow of GRB 241025A](#user-content-link50)
...
51. [The Road to Identifying the Earliest Radio-Powerful AGN with the SKA](#user-content-link51)
**Authors:** Jose Afonso, Stergios Amarantidis, Stas Shabala, Ross J. Turner, Luca Ighina, Mojtaba Raouf, Nuno Covas, Pedro Martins, Nick Seymour, Alessandro Caccianiga, Alexander Hedge, Jess W. Broderick, Davi Barbosa, Isabella Prandoni, Sabyasachi Pal, Bruno Arsioli, Luis Barroso, Rodrigo Carvajal, Jo\~ao Tiago, Andrew Hopkins, Manuela Magliocchetti, Israel Matute, Ciro Pappalardo

52. [The Sun's chemical peculiarity: disentangling Galactic chemical evolution and planetary engulfment in solar twins](#user-content-link52)
**Authors:** Mia Babatsikos, Fan Liu, Amanda Karakas, Ilya Mandel, Lachlan Passenger, Megan Bedell, Sharon Wang, Zimo Cheng

53. [Quantum-optimal coronagraphy with spatial mode sorting for direct exoplanet observations](#user-content-link53)
**Authors:** Yinzi Xin, Sebastiaan Haffert, Yoo Jung Kim, Jonathan Lin

54. [HARMONI at ELT: line spread functions in a diffraction limited spectrometer](#user-content-link54)
**Authors:** Stephen P. Todd (UK Astronomy Technology Centre), \'Eamonn J. Harvey (UK Astronomy Technology Centre), Anna MacIver (UK Astronomy Technology Centre), William Taylor (UK Astronomy Technology Centre), Eduard Muslimov (Oxford University), Kjetil Dohlen (Laboratoire d'Astrophysique de Marseille), Matthias Tecza (Oxford University), Magali Loupias (Centre de Recherche Astrophysique de Lyon), Paula Ba\~nares-Palacios (Instituto de Astrof\'isica de Canarias), Mark Swinbank (Durham University), Ryan Griffiths (Oxford University)

55. [Pulsar Backend for 21 CentiMeter Array: Implementation of Data Acquisition and Initial Results](#user-content-link55)
...
56. [Black Boxes in Black Hole Imaging](#user-content-link56)
**Authors:** Juliusz Doboszewski, Jamee Elder

57. [Distance Determination of Southern Galactic Plane Supernova Remnants with the Mopra CO Survey and DECaPS 3D Dust Map](#user-content-link57)
**Authors:** Fupeng Liu, He Zhao, Biwei Jiang, Jun Li, Zhe Zhang

58. [Energetic particle-mediated interplanetary shocks observed by Solar Orbiter](#user-content-link58)
...
59. [Development of a Retrieval-Augmented Generation Virtual Assistant for Enhanced Information Discovery at Rubin Observatory](#user-content-link59)
...
60. [Secondary Production of Photons from ALP Dark Matter interacting with a Cosmological Magnetic Field](#user-content-link60)
**Authors:** Abdias Aires, Robert Brandenberger, Ashu Kushwaha

61. [X-ray polarization in magnetized neutron stars](#user-content-link61)
**Authors:** Tanuman Ghosh, Shiv Sethi

62. [Development of a cosmic ray detector using CMOS sensors embedded in smartphones and Raspberry Pi devices](#user-content-link62)
**Authors:** Wakiko Takano, Shigeharu Udo, Atsushi Shiomi, Kinya Hibino

63. [Design and development of a near-IR integral field spectrograph for the HWO Coronagraph Instrument](#user-content-link63)
...
64. [$J$ and $H$ band sky brightness measurements from polar day to polar night at Dome A, Antarctica](#user-content-link64)
...
65. [Magneto-rotational instabilities in solids: application to neutron-star crusts](#user-content-link65)
**Authors:** Arthur G. Suvorov, Thomas Celora, Kostas D. Kokkotas

66. [TEQUILA: Mechanism-free polarimetry for astronomy](#user-content-link66)
**Authors:** Alan M. Watson, No\'emie Globus

67. [Boson Stars in Teleparallel Gravity with a Nonminimally Coupled Field: The Violation of Energy Conditions and Gravitational Waveforms from EMRIs](#user-content-link67)
**Authors:** Long-Xing Huang, Ke Yang, Yong-Qiang Wang

68. [Timing and spectral analysis of the 2025 outburst of 4U 1630$-$47 with \textit{NICER}](#user-content-link68)
**Authors:** Haifan Zhu, Mariano M\'endez, Xiao Chen, Wei Wang

69. [Analyses on Christoph Clavius' Reports of Total Solar Eclipses in 1560 and 1567: Key References for the Centennial Variations of the Earth's Rotation Speed and the Solar Radius](#user-content-link69)
**Authors:** Hisashi Hayakawa, Mitsuru S\^oma, Jean-Pierre Rozelot, Koji Murata, Alexei A. Pevtsov, Stanislav Gun\'ar, Lucie M. Green

70. [Numerical Investigation of Efficient Electron Acceleration at an Unsteady Solar Flare Loop-Top](#user-content-link70)
**Authors:** Yoshiaki Sato, Takafumi Kaneko, Noriyuki Narukage, Shinsuke Takasao

71. [Research Progress on Solar Small-Scale Dynamo](#user-content-link71)
**Authors:** Wen-Jie Jiang, Lei Ni, Chun-Lan Jin, Zhi Xu, Mei Zhang

72. [Periodic Radio Technosignature Search toward 3I/ATLAS with FAST](#user-content-link72)
**Authors:** Jian-Kang Li, Zhen-Zhao Tao, Tong-Jie Zhang, Men-Quan Liu

73. [Electron stability constrains neutrino time delays](#user-content-link73)
**Authors:** Mauricio Bustamante, Jos\'e Manuel Carmona, Jos\'e Luis Cort\'es, Ardit Gkioni, Maykoll A. Reyes

74. [Detection of Doppler velocity differences between ions and neutrals in an erupting prominence](#user-content-link74)
**Authors:** Yuwei Huang, Kiyoshi Ichimoto, Tetsu Anan

75. [Impact of Spacecraft Orbit Uncertainties and Velocity Mismodeling on the LISA Gravitational-Wave Response](#user-content-link75)
**Authors:** Lorenzo Speri, Olaf Hartwig, Waldemar Martens, Oliver Jennrich, Eric Joffre, Michele Armano, Martin Hewitson, Nora L\"utzgendorf

---

## 1. [The Merger-Driven Origin of the Vast Extended Stellar Disc Around the Andromeda Galaxy](https://arxiv.org/abs/2607.02480) <a id="link1"></a>
...
**Comment:** This paper analyzes the merger-driven origin of the vast extended stellar disc around Andromeda (M31), using N-body hydrodynamical simulations and comparing model particles with resolved tracers. It discusses the evolution of the disc, star formation history, and substructures, which is highly relevant to near-field cosmology and numerical galaxy simulations. The focus on resolved star formation history and merger-driven evolution of a nearby galaxy makes it a strong match.
...
## 2. [Spherically Symmetric Fluid Simulations of Black Hole Accretion in Self-Interacting Dark Matter Halos](https://arxiv.org/abs/2607.02151) <a id="link2"></a>
...
**Comment:** Simulates black hole accretion in self-interacting dark matter halos, using NFW and SIS profiles. The focus on dark matter density profiles and substructure is relevant to near-field cosmology, especially core-cusp and substructure topics. Theoretical work on dark matter in galaxy halos is highly relevant.
...
## 3. [Stark-Broadened Profiles for Ionized Helium Lines Using Computer Simulations](https://arxiv.org/abs/2607.01373) <a id="link3"></a>
...
**Comment:** Presents new calculations of Stark-broadened profiles for ionized helium, a key ingredient in spectroscopic analysis of helium-atmosphere DO white dwarfs. Closely matches the 'Stellar Models' criterion, as it presents new theoretical line-broadening models relevant for stellar atmosphere modeling.
...
## 4. [Indicatives of Early Stages of Star Formation in the Universe](https://arxiv.org/abs/2607.02351) <a id="link4"></a>
...
**Comment:** The paper analyzes globular cluster formation in circumgalactic clouds, discusses metallicity distributions, and sequential enrichment. It directly addresses the circumgalactic medium and star formation in low-mass environments, matching the 'Circumgalactic Medium' and 'Resolved Star Formation Histories' criteria. Highly relevant.
...
## 5. [Native-Opacity Sensitivity of a Fixed Delta Cephei MESA-RSP Pulsation Model](https://arxiv.org/abs/2607.02439) <a id="link5"></a>
...
**Comment:** This paper presents a controlled experiment on the sensitivity of Cepheid pulsation models to opacity choices using MESA-RSP. It directly matches the 'Stellar Models' criterion, as it discusses stellar interior modeling and the impact of microphysics on pulsation properties.
...
## 6. [Post-starburst Galaxies with Active Galactic Nucleus: Properties and Evolutionary Sequences](https://arxiv.org/abs/2607.01832) <a id="link6"></a>
...
**Comment:** Focuses on post-starburst galaxies and their quenching mechanisms, including AGN feedback. While the main focus is on higher mass galaxies, the topic of star formation quenching is relevant, but weighted lower as it is not specifically about dwarf galaxies.
...
## 7. [Resolved HI and Environmental Dynamics](https://arxiv.org/abs/2607.02162) <a id="link7"></a>
...
**Comment:** The paper discusses spatially resolved HI observations and environmental dynamics, including ram pressure stripping and tidal interactions in galaxy clusters and groups. While it covers gas dynamics and environmental effects, it does not focus specifically on dwarf galaxies, resolved star formation histories, or CGM of dwarfs. It is borderline relevant due to its discussion of environmental effects and HI gas, which may relate to star formation quenching and outflows, but the focus is broader.
...
## 8. [SN 2020bij and a Possible Slow-Rise High-Velocity Subclass of Type IIP Supernovae](https://arxiv.org/abs/2607.02253) <a id="link8"></a>
...
**Comment:** Observational analysis of Type IIP supernovae, mapping explosion properties and circumstellar material interaction. While it touches on stellar evolution and mass loss, it does not present new stellar models or focus on galaxy-scale star formation histories.
...
## 9. [Can Primordial Black Holes Be Seeds for Early Galaxies in Models Satisfying the Covariant Entropy Bound?](https://arxiv.org/abs/2607.01292) <a id="link9"></a>
...
**Comment:** This paper discusses primordial black holes as seeds for early galaxies and dark matter, referencing early galaxy formation and cosmological models. While it touches on galaxy formation, it does not focus on near-field cosmology, resolved star formation histories, or dwarf galaxies. The relevance is borderline due to its connection to galaxy formation and dark matter.
...
## 10. [Gravitational Waves from Primordial Black Holes: Connecting Low-Frequency Scalar-Induced Signatures to High-Frequency Binary Mergers](https://arxiv.org/abs/2607.01818) <a id="link10"></a>
...
**Comment:** The paper connects gravitational wave signatures from primordial black holes to their formation and binary mergers. While it discusses dark matter and early universe cosmology, it does not focus on near-field cosmology, resolved star formation histories, or galaxy simulations. Borderline relevance due to indirect connection to galaxy formation and dark matter.
...
## 11. [Lattice study of primordial black hole formation in bumpy axion inflation](https://arxiv.org/abs/2607.01780) <a id="link11"></a>
...
**Comment:** This paper studies primordial black hole formation in axion inflation using lattice simulations, with implications for dark matter. It does not directly address any of the core criteria (near-field cosmology, resolved star formation histories, galaxy simulations, etc.), but is borderline relevant due to its connection to dark matter and early universe structure.
...
## 12. [Axion Misalignment Across First-Order Phase Transitions](https://arxiv.org/abs/2607.01333) <a id="link12"></a>
...
**Comment:** This paper studies axion misalignment production across first-order phase transitions, with implications for dark matter and small-scale structure. It does not directly address any of the core criteria (near-field cosmology, resolved star formation histories, galaxy simulations, etc.), but is borderline relevant due to its connection to dark matter and small-scale structure.
...
## 13. [The fingerprint of primordial mass segregation on the tidal tails of star clusters](https://arxiv.org/abs/2607.01331) <a id="link13"></a>
...
**Comment:** The paper uses N-body simulations to study the effect of primordial mass segregation on tidal tails of star clusters. While it involves numerical simulations and stellar dynamics, it does not focus on galaxy-scale simulations or resolved star formation histories of galaxies. The topic is more about star clusters than galaxies.
...
## 14. [Assessing Ultra-Cool Dwarf Contamination in Photometrically Selected High-Redshift Galaxy Samples](https://arxiv.org/abs/2607.02354) <a id="link14"></a>
...
**Comment:** This paper assesses contamination of high-redshift galaxy samples by ultra-cool dwarf stars, which is tangentially related to resolved star formation histories (as it affects galaxy sample purity) but does not directly address any core topic. The tool developed may be useful for survey design but is not directly relevant.
...
## 17. [Bolometric correction factor and radiative efficiency for the super-Eddington accretion flow in tidal disruption events](https://arxiv.org/abs/2607.01604) <a id="link17"></a>
...
**Comment:** The paper presents bolometric correction factors and radiative efficiency for super-Eddington accretion flows in tidal disruption events (TDEs). It includes new tables of bolometric corrections, which matches the 'Stellar Models' criterion, but the focus is on TDEs and supermassive black holes, which are not relevant to the core topics.
...
## 18. [Revisiting atmospheric Roche lobe overflow in symbiotic binaries](https://arxiv.org/abs/2607.01848) <a id="link18"></a>
...
**Comment:** The paper revisits atmospheric Roche lobe overflow in symbiotic binaries, presenting new models for mass transfer and stability in white-dwarf--giant binaries. While it includes new stellar models and evolutionary tracks, the focus is on binary evolution and symbiotic stars, not on galaxies or resolved star formation histories.
...
## 19. [meer21cm: an Analysis Pipeline and Comprehensive Toolkit for HI Intensity Mapping](https://arxiv.org/abs/2607.01864) <a id="link19"></a>
...
**Comment:** This paper introduces a new analysis pipeline for HI intensity mapping surveys, with a focus on cosmological data analysis and power spectrum estimation. While it is a numerical tool for galaxy surveys, it does not directly address galaxy simulations, resolved star formation histories, or dwarf galaxy science. It is more about survey methodology.
...
## 20. [Tracing grain growth in the forming prestellar core L1506C with 3D modeling of Herschel, IRAM, and CFHT observations](https://arxiv.org/abs/2607.02353) <a id="link20"></a>
...
**Comment:** The paper models dust properties and grain growth in the prestellar core L1506C, using 3D radiative transfer and SED fitting. It is about star formation in molecular clouds, not resolved star formation histories of galaxies, dwarf galaxy science, or galaxy simulations.
...
## 21. [How I stop worrying about non-universality and $b_\phi$: Constraining local $f_{\rm NL}$ with $b_\phi$ priors from HOD posteriors](https://arxiv.org/abs/2607.01314) <a id="link21"></a>
...
**Comment:** Paper on constraining primordial non-Gaussianity using galaxy clustering. While it deals with galaxy surveys and clustering, it does not directly address satellite galaxies, star formation histories, quenching, or galaxy simulations.
...
## 22. [Fractional-Dimension Gravity and the Milky Way Galaxy](https://arxiv.org/abs/2607.01412) <a id="link22"></a>
...
**Comment:** The paper discusses an alternative gravity model applied to the Milky Way rotation curve, aiming to explain it without dark matter. While it touches on galaxy dynamics and dark matter, it focuses on the Milky Way as a whole and not on satellite galaxies, substructure, or near-field cosmology. It does not address core-cusp, satellite luminosity functions, or resolved star formation histories.
...
## 23. [Lensing-Reconstructed Dark Matter-Intracluster Medium Coherence as a Probe of Cluster Dynamical State: Application to HSTFF, RELICS, and CLASH Clusters](https://arxiv.org/abs/2607.01389) <a id="link23"></a>
...
**Comment:** This paper applies lensing-X-ray coherence analysis to galaxy clusters to probe their dynamical state. It is about cluster-scale structure and dynamics, not dwarf galaxies, near-field cosmology, or galaxy simulations.
...
## 24. [A possible high-redshift origin for the short GRB 061201: implications of a compact binary merger beyond cosmic noon](https://arxiv.org/abs/2607.01337) <a id="link24"></a>
...
**Comment:** This paper focuses on a high-redshift short GRB and its host galaxy, discussing compact binary mergers and r-process element production. While it touches on galaxy evolution and early universe star formation, it does not directly address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 25. [The VLA-COSMOS 3 GHz Large Project: Polarised source counts and catalogue](https://arxiv.org/abs/2607.02342) <a id="link25"></a>
...
**Comment:** The paper presents polarised radio source counts at 3 GHz, aiming to probe faint polarised star-forming galaxies. However, it does not focus on dwarf galaxies, resolved star formation histories, quenching, or outflows, and is more about radio source population statistics and magnetic fields.
...
## 26. [Alleviating prior dependencies for DESI DR1 clustering fits through reparameterization](https://arxiv.org/abs/2607.02498) <a id="link26"></a>
...
**Comment:** The paper discusses Bayesian analysis and prior mitigation for DESI DR1 clustering fits, focusing on cosmological parameter inference. It is about large-scale structure and cosmological expansion, not directly related to galaxy simulations, near-field cosmology, or the other core topics.
...
## 27. [Neutron stars as thermometers for reheating induced dipole dark matter](https://arxiv.org/abs/2607.01390) <a id="link27"></a>
...
**Comment:** Study of neutron stars as probes for dipole dark matter, including cosmological scenarios and direct detection. While it discusses dark matter, it is not about galaxy substructure, core-cusp, or near-field cosmology, and does not address the other core topics.
...
## 28. [Pulsar Science with the SKAO](https://arxiv.org/abs/2607.01288) <a id="link28"></a>
...
**Comment:** This overview discusses pulsar science with the SKAO, including surveys of the Galactic field, globular clusters, and the Galactic center. While globular clusters are mentioned, the focus is on pulsar science and not on the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 29. [Aerosols and hydrocarbons in the atmosphere of a white dwarf planet](https://arxiv.org/abs/2607.01316) <a id="link29"></a>
...
**Comment:** The paper discusses the atmospheric detection for a planet orbiting a white dwarf, including transmission spectroscopy and planetary migration. It does not match any of the core criteria related to galaxies, star formation histories, or stellar models.
...
## 30. [Polarization Architecture of Steady GRMHD Jets from the Horizon to Infinity](https://arxiv.org/abs/2607.01820) <a id="link30"></a>
...
**Comment:** The paper develops a semi-analytic framework for GRMHD jets, focusing on jet morphology and polarization diagnostics from black holes. It does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 31. [No Evidence for Superradiant Axions in LIGO-Virgo-KAGRA GWTC-5 Binary Black Hole Spins](https://arxiv.org/abs/2607.01317) <a id="link31"></a>
...
**Comment:** Constrains axion physics using black hole spin measurements. No direct connection to any of the core topics (not about galaxy structure, star formation, or dwarf galaxies).
...
## 32. [TESS's First Bound Microlensing Planet: A Binary Microlensing Event Revealing a Planetary Companion toward the Galactic Plane](https://arxiv.org/abs/2607.01853) <a id="link32"></a>
...
**Comment:** Reports the discovery of a microlensing planet toward the Galactic Plane. While interesting, it does not address any of the core topics (no focus on satellite galaxies, star formation histories, quenching, or galaxy simulations).
...
## 33. [AI-enabled gravitational-waves searches for binary neutron stars at optimal sensitivity](https://arxiv.org/abs/2607.01372) <a id="link33"></a>
...
**Comment:** The paper presents an AI-enabled search for gravitational waves from binary neutron stars, focusing on computational methods for detection. It does not address galaxy-scale simulations, star formation histories, or near-field cosmology.
...
## 34. [Constraining the near-source relativistic wind medium using Fast Radio Burst circular polarization data](https://arxiv.org/abs/2607.01369) <a id="link34"></a>
...
**Comment:** Paper investigates circular polarization in fast radio bursts and constrains properties of magnetar winds. No criteria match closely; not related to galaxy-scale processes or stellar models.
...
## 35. [Efficient high-order explicit symplectic splitting methods for post-Newtonian Hamiltonian systems](https://arxiv.org/abs/2607.01596) <a id="link35"></a>
...
**Comment:** This paper presents new explicit symplectic integrators for post-Newtonian Hamiltonian systems, focusing on computational methods for binary systems. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, galaxy simulations, etc.).
...
## 36. [IRIS: Deciphering Spectral-Line Imagery of the Galactic Center by Machine-Learning on Simulations](https://arxiv.org/abs/2607.01338) <a id="link36"></a>
...
**Comment:** This paper presents a machine-learning method to reconstruct the 3D structure of the Milky Way's Central Molecular Zone using simulations and spectral-line imagery. The focus is on the Galactic center, which is explicitly listed as irrelevant in the criteria.
...
## 37. [Revision of the Detached Eclipsing System IR Cas from TESS Observations, Ground-Based Photometry and Spectroscopy](https://arxiv.org/abs/2607.02076) <a id="link37"></a>
...
**Comment:** The paper analyzes a detached eclipsing binary system, focusing on stellar activity and evolution. While it involves stellar models and evolutionary tracks, it does not present new stellar models or bolometric corrections, nor does it address resolved star formation histories or galaxy-scale phenomena.
...
## 38. [Current status of the High-Resolution Multi-Object Spectrograph (MOS-HR) for the Wide-field Spectroscopic Telescope](https://arxiv.org/abs/2607.01968) <a id="link38"></a>
...
**Comment:** This paper describes the design and development of a high-resolution multi-object spectrograph for a future telescope. While such instrumentation could be used for relevant science (e.g., resolved star formation histories, near-field cosmology), the paper itself is focused on technical and engineering aspects, not on any of the core science topics.
...
## 39. [Discovery of sulfur oxides in the ejecta of a B[e] supergiant](https://arxiv.org/abs/2607.02191) <a id="link39"></a>
...
**Comment:** This paper reports the detection of sulfur oxides in the ejecta of a B[e] supergiant, focusing on molecular chemistry and fractionation processes in massive stars. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 40. [Radiative filtering unifies broad-line phenomenology in active galactic nuclei](https://arxiv.org/abs/2607.01479) <a id="link40"></a>
...
**Comment:** This paper presents a unified explanation for broad emission line phenomenology in AGNs, focusing on ionizing radiation fields and emission line regulation. It does not match any of the core criteria.
...
## 41. [X-ray Fourier lag-frequency spectra modulated by stochastic turbulent acceleration in the jets of high-frequency-peaked BL Lac](https://arxiv.org/abs/2607.01606) <a id="link41"></a>
...
**Comment:** The paper investigates X-ray lag-frequency spectra in BL Lac jets, focusing on jet physics and turbulent acceleration. It does not match any of the core criteria.
...
## 42. [Testing Gravity with Binary Pulsars in the SKA Era](https://arxiv.org/abs/2607.02064) <a id="link42"></a>
...
**Comment:** The paper discusses testing gravity with binary pulsars in the SKA era, focusing on strong field gravity and pulsar timing. It does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 43. [Architecture and Validation of the CRS F-Engine for the CHORD Radio Telescope](https://arxiv.org/abs/2607.01625) <a id="link43"></a>
...
**Comment:** This paper describes the architecture and validation of a radio telescope backend. While relevant for instrumentation, it does not match any of the core topics (near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 44. [Gravitational Waves from Multiple First-Order Phase Transitions in a Scenario with Early Matter Domination](https://arxiv.org/abs/2607.01697) <a id="link44"></a>
...
**Comment:** Studies gravitational waves from early universe phase transitions. No direct connection to galaxy evolution, star formation, or near-field cosmology.
...
## 45. [Sideband Structure of Axion Electrodynamics](https://arxiv.org/abs/2607.02232) <a id="link45"></a>
...
**Comment:** Theoretical work on axion electrodynamics and photon-axion mixing. No direct connection to galaxy evolution, star formation, or near-field cosmology.
...
## 46. [Signatures of Two Distinct Epochs of FRB 20240114A from January to August 2024 Based on its Energy and Waiting Time Analysis](https://arxiv.org/abs/2607.01576) <a id="link46"></a>
...
**Comment:** Analysis of FRB 20240114A burst properties. No direct connection to galaxy evolution, star formation histories, or near-field cosmology.
...
## 47. [A critical look at low-scale cosmological phase transitions in the PTA era](https://arxiv.org/abs/2607.02505) <a id="link47"></a>
...
**Comment:** This paper discusses cosmological phase transitions and gravitational wave signals, with some mention of dark matter phenomenology. However, it does not address near-field cosmology, dwarf galaxies, or galaxy-scale simulations, and is not directly relevant to the core topics.
...
## 48. [The Galactic Centre G+0.633-0.0604 molecular cloud: a new astrochemical gold mine. I. Gas physical properties](https://arxiv.org/abs/2607.01481) <a id="link48"></a>
...
**Comment:** The paper studies a molecular cloud in the Galactic Center, focusing on astrochemistry and star formation in the Central Molecular Zone. It is not relevant to near-field cosmology, dwarf galaxies, or resolved star formation histories of galaxies, as it focuses on the Galactic Center and massive protoclusters.
...
## 49. [Extreme outflow velocities and weak UV emission lines indicate quasars shedding their dust cocoons](https://arxiv.org/abs/2607.01330) <a id="link49"></a>
...
**Comment:** This paper focuses on quasar outflows, specifically LoBAL quasars with high-speed outflows. The outflows discussed are AGN-driven, not star-formation-driven, and the galaxies involved are massive quasars, not dwarfs. No criteria match closely.
...
## 50. [Colour evolution in the radio afterglow of GRB 241025A](https://arxiv.org/abs/2607.01941) <a id="link50"></a>
...
**Comment:** Study of the radio afterglow of a gamma-ray burst, focusing on color evolution and shock physics. No criteria match closely; not related to galaxy-scale outflows, star formation, or resolved histories.
...
## 51. [The Road to Identifying the Earliest Radio-Powerful AGN with the SKA](https://arxiv.org/abs/2607.02366) <a id="link51"></a>
...
**Comment:** This paper reviews strategies for identifying early radio-powerful AGN with the SKA, focusing on the Epoch of Reionization and supermassive black holes. It is not relevant to near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 52. [The Sun's chemical peculiarity: disentangling Galactic chemical evolution and planetary engulfment in solar twins](https://arxiv.org/abs/2607.01699) <a id="link52"></a>
...
**Comment:** This paper analyzes the Sun's chemical peculiarity among solar twins, focusing on Galactic chemical evolution and planetary engulfment. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, galaxy simulations, etc.).
...
## 53. [Quantum-optimal coronagraphy with spatial mode sorting for direct exoplanet observations](https://arxiv.org/abs/2607.02065) <a id="link53"></a>
...
**Comment:** Paper discusses quantum-optimal coronagraphy for direct exoplanet observations, focusing on instrument design and signal processing. No criteria match closely; not related to galaxy evolution, star formation, or stellar models.
...
## 54. [HARMONI at ELT: line spread functions in a diffraction limited spectrometer](https://arxiv.org/abs/2607.02223) <a id="link54"></a>
...
**Comment:** Technical paper on spectrograph design for ELT. No direct connection to any of the core topics (no mention of galaxy simulations, star formation histories, quenching, etc.).
...
## 55. [Pulsar Backend for 21 CentiMeter Array: Implementation of Data Acquisition and Initial Results](https://arxiv.org/abs/2607.01975) <a id="link55"></a>
...
**Comment:** Describes a pulsar backend for the 21 CentiMeter Array and initial results. Instrumentation-focused, not directly related to any of the core topics.
...
## 56. [Black Boxes in Black Hole Imaging](https://arxiv.org/abs/2607.02110) <a id="link56"></a>
...
**Comment:** The paper discusses epistemic opacity in black hole imaging simulations and machine learning, focusing on the Event Horizon Telescope and GRMHD models. It does not address galaxy-scale simulations, star formation histories, or near-field cosmology.
...
## 57. [Distance Determination of Southern Galactic Plane Supernova Remnants with the Mopra CO Survey and DECaPS 3D Dust Map](https://arxiv.org/abs/2607.01886) <a id="link57"></a>
...
**Comment:** This paper focuses on distance determination of supernova remnants in the southern Galactic plane using CO and dust maps. It is primarily about ISM and SNRs in the Milky Way disk, not dwarf galaxies, satellites, or near-field cosmology. No direct relevance to resolved star formation histories, quenching, stellar models, galaxy simulations, or CGM.
...
## 58. [Energetic particle-mediated interplanetary shocks observed by Solar Orbiter](https://arxiv.org/abs/2607.02044) <a id="link58"></a>
...
**Comment:** Analysis of energetic particle-mediated interplanetary shocks observed by Solar Orbiter. Focus is on solar/interplanetary physics, not galaxy-scale outflows or CGM.
...
## 59. [Development of a Retrieval-Augmented Generation Virtual Assistant for Enhanced Information Discovery at Rubin Observatory](https://arxiv.org/abs/2607.01659) <a id="link59"></a>
...
**Comment:** Development of a virtual assistant for information discovery at Rubin Observatory. No criteria match closely; not related to astrophysical science topics.
...
## 60. [Secondary Production of Photons from ALP Dark Matter interacting with a Cosmological Magnetic Field](https://arxiv.org/abs/2607.01399) <a id="link60"></a>
...
**Comment:** Study of secondary photon production from ALP dark matter interacting with cosmological magnetic fields. No criteria match closely; not related to galaxy evolution, star formation, or stellar models.
...
## 61. [X-ray polarization in magnetized neutron stars](https://arxiv.org/abs/2607.01357) <a id="link61"></a>
...
**Comment:** This paper models X-ray polarization in magnetized neutron stars, focusing on compact object physics. It does not match any of the core criteria (near-field cosmology, resolved star formation histories, galaxy simulations, etc.).
...
## 62. [Development of a cosmic ray detector using CMOS sensors embedded in smartphones and Raspberry Pi devices](https://arxiv.org/abs/2607.02106) <a id="link62"></a>
...
**Comment:** The paper presents a method for cosmic ray detection using consumer devices for educational and citizen science purposes. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 63. [Design and development of a near-IR integral field spectrograph for the HWO Coronagraph Instrument](https://arxiv.org/abs/2607.02243) <a id="link63"></a>
...
**Comment:** This paper describes the design and development of a near-IR integral field spectrograph for the HWO Coronagraph Instrument, focusing on instrumentation for exoplanet characterization. It does not match any of the core criteria.
...
## 64. [$J$ and $H$ band sky brightness measurements from polar day to polar night at Dome A, Antarctica](https://arxiv.org/abs/2607.01923) <a id="link64"></a>
...
**Comment:** This paper presents measurements of J and H band sky brightness at Dome A, Antarctica, focusing on atmospheric and observational conditions for infrared astronomy. It does not match any of the core criteria.
...
## 65. [Magneto-rotational instabilities in solids: application to neutron-star crusts](https://arxiv.org/abs/2607.01505) <a id="link65"></a>
...
**Comment:** This paper studies magneto-rotational instabilities in neutron star crusts, which is unrelated to galaxy-scale phenomena, star formation, or near-field cosmology.
...
## 66. [TEQUILA: Mechanism-free polarimetry for astronomy](https://arxiv.org/abs/2607.01325) <a id="link66"></a>
...
**Comment:** This paper describes a new polarimeter instrument for transient astronomy, but does not address any of the core topics (near-field cosmology, galaxy simulations, star formation histories, etc.).
...
## 67. [Boson Stars in Teleparallel Gravity with a Nonminimally Coupled Field: The Violation of Energy Conditions and Gravitational Waveforms from EMRIs](https://arxiv.org/abs/2607.02017) <a id="link67"></a>
...
**Comment:** This paper investigates boson stars in teleparallel gravity and their gravitational wave signatures. It does not address galaxy-scale phenomena, near-field cosmology, or star formation histories.
...
## 68. [Timing and spectral analysis of the 2025 outburst of 4U 1630$-$47 with \textit{NICER}](https://arxiv.org/abs/2607.02228) <a id="link68"></a>
...
**Comment:** The paper analyzes X-ray variability in a black hole X-ray binary, focusing on accretion disk properties and quasi-periodic oscillations. No criteria match closely; not related to galaxy-scale processes or stellar models.
...
## 69. [Analyses on Christoph Clavius' Reports of Total Solar Eclipses in 1560 and 1567: Key References for the Centennial Variations of the Earth's Rotation Speed and the Solar Radius](https://arxiv.org/abs/2607.02347) <a id="link69"></a>
...
**Comment:** Historical analysis of solar eclipses to constrain solar radius and Earth's rotation speed. No criteria match closely; not related to galaxy evolution, star formation, or stellar models.
...
## 70. [Numerical Investigation of Efficient Electron Acceleration at an Unsteady Solar Flare Loop-Top](https://arxiv.org/abs/2607.01644) <a id="link70"></a>
...
**Comment:** Numerical investigation of electron acceleration in solar flare loop-tops. This is solar physics, not related to galaxy simulations, near-field cosmology, or any of the core topics.
...
## 71. [Research Progress on Solar Small-Scale Dynamo](https://arxiv.org/abs/2607.02009) <a id="link71"></a>
...
**Comment:** Review of solar small-scale dynamo theory, including observations, theory, and simulations. This is solar physics and not related to galaxy simulations, near-field cosmology, or the other core topics.
...
## 72. [Periodic Radio Technosignature Search toward 3I/ATLAS with FAST](https://arxiv.org/abs/2607.01666) <a id="link72"></a>
...
**Comment:** This paper is a technosignature search toward an interstellar object using radio observations. It does not match any of the core criteria (near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 74. [Detection of Doppler velocity differences between ions and neutrals in an erupting prominence](https://arxiv.org/abs/2607.01570) <a id="link74"></a>
...
**Comment:** This paper focuses on spectroscopic observations of an erupting solar prominence, which is unrelated to any of the core topics (near-field cosmology, dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 75. [Impact of Spacecraft Orbit Uncertainties and Velocity Mismodeling on the LISA Gravitational-Wave Response](https://arxiv.org/abs/2607.01318) <a id="link75"></a>
...
**Comment:** The paper focuses on the impact of spacecraft orbit uncertainties on LISA's gravitational wave response, which is unrelated to the core topics (galaxy simulations, star formation, near-field cosmology, etc.).
