...
11. [A Comparative Study of Halo Mass Estimates from Group Catalogs and Lensing Signals](#user-content-link11)
...
25. [Rotating Proto-Neutron Stars Admixed with Mirror Dark Matter: A two fluid approach](#user-content-link25)
...
36. [Binary Neutron Star Mergers: Multi-Messenger Systematics and Prospects with Next-Generation Facilities](#user-content-link36)
...
51. [The Concordance of Weak Lensing and Escape Velocity Mass Estimates for Galaxy Clusters](#user-content-link51)
...
65. [First Temperature Profile of a Stellar Flare using Differential Chromatic Refraction](#user-content-link65)
...
78. [Young Stellar Objects in the Carina nebula: Near-Infrared variability and spectroscopy](#user-content-link78)
...
91. [Mixing due to internal gravity waves can explain the CNO surface abundances of B-type detached eclipsing binaries and single stars](#user-content-link91)
...
**Comment:** Directly studies satellite galaxy properties and quenching at intermediate redshift, comparing to local universe results. This is highly relevant to near-field cosmology, satellite galaxy evolution, and environmental effects on substructure.
...
**Comment:** Addresses the abundance of bright galaxies at high redshift using a semi-empirical model for star formation efficiency. While it discusses galaxy abundance and dark matter halos, the focus is on high-redshift (z > 4) galaxies, not on near-field cosmology or local dwarf satellites.
...
**Comment:** Analyzes the Perseus cluster using X-ray data, focusing on cluster mergers and radio galaxies. While it discusses substructure and merging groups, the scale is that of massive clusters, not dwarf satellites or near-field cosmology.
...
**Comment:** Examines the effects of mirror dark matter on rotating neutron stars. While it discusses dark matter, the context is neutron star structure and not the dark matter substructure or satellite galaxies relevant to near-field cosmology.
...
**Comment:** Forecasts cosmological parameter constraints from weak lensing power and bispectra. While relevant to cosmology, it does not focus on near-field cosmology, satellite galaxies, or substructure.
...
**Comment:** Studies radial metallicity gradients in nearby spiral galaxies using HII regions. The focus is on chemical abundances and ISM mixing in spiral disks, not on dwarf satellites, satellite luminosity functions, or near-field cosmology.
...
**Comment:** This paper is about binary neutron star mergers and multi-messenger astronomy, which is not related to near-field cosmology or the study of dwarf galaxies or Milky Way satellites.
...
**Comment:** This paper proposes a new particle physics model for dark energy and tests it with cosmological data. It is focused on dark energy and cosmological parameters, not on near-field cosmology or satellite galaxies.
...
## 42. [The phase spiral's origin and evolution: indications from its varying properties across the Milky Way disk](https://arxiv.org/abs/2507.19579) <a id="link42"></a>
...
**Comment:** Describes a spectroscopic survey of stars in the Kepler and K2 fields, including identification of metal-poor and high-velocity stars. While the catalog may be useful for stellar population studies, it does not focus on dwarf satellites, satellite luminosity functions, or near-field cosmology.
...
**Comment:** Studies the effect of magnetic fields on Bose-Einstein Condensate stars as neutron star alternatives, not on near-field cosmology or satellite galaxies.
...
**Comment:** Focuses on the Fermi bubbles and cosmic ray propagation from the Galactic center, not on near-field cosmology, satellite galaxies, or dark matter substructure.
...
## 47. [Luminous Late-time Radio Emission from Supernovae Interacting with Circumbinary Material](https://arxiv.org/abs/2507.19613) <a id="link47"></a>
...
**Comment:** Focuses on radio emission from supernovae interacting with circumstellar material, specifically in the context of binary evolution and mass transfer. While relevant to stellar evolution and supernovae, it does not address near-field cosmology, dwarf satellites, or dark matter substructure.
...
## 48. [Galactic Super-Accreting X-ray Binaries as Super-PeVatron Accelerators](https://arxiv.org/abs/2507.21048) <a id="link48"></a>
...
**Comment:** Discusses super-accreting X-ray binaries as possible sources of PeV cosmic rays in the Milky Way. While it is about the Milky Way, it is not about satellite galaxies, substructure, or near-field cosmology.
...
## 49. [Possible Neutrino Emission from the Pulsar Wind Nebula G63.7+1.1](https://arxiv.org/abs/2507.19724) <a id="link49"></a>
...
**Comment:** Reports possible neutrino emission from a pulsar wind nebula. While it is about a Galactic object, it is not related to satellite galaxies, substructure, or near-field cosmology.
...
## 50. [Crystal Eye: all sky MeV monitor with high precision real-time localization](https://arxiv.org/abs/2507.19958) <a id="link50"></a>
...
**Comment:** This paper describes a new all-sky MeV monitor for transient detection. While potentially useful for a wide range of astrophysical phenomena, it does not focus on near-field cosmology, satellite galaxies, or related substructure topics.
...
## 51. [The Concordance of Weak Lensing and Escape Velocity Mass Estimates for Galaxy Clusters](https://arxiv.org/abs/2507.20938) <a id="link51"></a>
...
**Comment:** Focuses on mass estimates for galaxy clusters using weak lensing and escape velocity methods. Galaxy clusters are much more massive than the dwarf satellites or substructure relevant to near-field cosmology.
...
## 52. [Finetuning Stellar Spectra Foundation Models with LoRA](https://arxiv.org/abs/2507.20972) <a id="link52"></a>
...
**Comment:** Applies machine learning (LoRA) to fine-tune stellar spectral models. Focus is on stellar spectroscopy, not on satellite galaxies or near-field cosmology.
...
## 53. [Detecting dark objects in the Solar System with Gravitational Wave observatories](https://arxiv.org/abs/2507.19577) <a id="link53"></a>
...
**Comment:** The paper discusses the detectability of dark objects (e.g., primordial black holes) in the Solar System using gravitational wave observatories. This is not related to near-field cosmology, satellite galaxies, or the structure of the Milky Way's halo.
...
## 54. [Interpreting nebular emission lines in the high-redshift Universe](https://arxiv.org/abs/2507.20190) <a id="link54"></a>
...
**Comment:** This paper discusses interpreting nebular emission lines in high-redshift galaxies, focusing on biases in SFR and metallicity diagnostics. It does not address near-field cosmology or satellite galaxies.
...
## 55. [Predicting the X-ray signatures of the imminent T Coronae Borealis outburst through 3D hydrodynamic modeling](https://arxiv.org/abs/2507.20334) <a id="link55"></a>
...
**Comment:** Focuses on modeling the imminent outburst of T Coronae Borealis, a symbiotic recurrent nova. The work is centered on nova outbursts, X-ray signatures, and the circumbinary medium, which are not related to near-field cosmology, dwarf satellites, or dark matter substructure.
...
## 56. [Nonlinear causality of Israel-Stewart theory with diffusion](https://arxiv.org/abs/2507.20064) <a id="link56"></a>
...
**Comment:** Presents theoretical work on causality in Israel-Stewart theory with diffusion, which is not related to near-field cosmology or satellite galaxies.
...
## 57. [Constraints on extra charges in dyonic Kerr-Newman-Kasuya-Taub-NUT black hole from the observations of quasi-periodic oscillations](https://arxiv.org/abs/2507.20165) <a id="link57"></a>
...
**Comment:** Focuses on black hole parameters in X-ray binaries, not on near-field cosmology, satellite galaxies, or dark matter substructure.
...
## 58. [Eccentric von Zeipel-Lidov-Kozai effects under mildly hierarchical triple systems: Influence of Brown corrections upon orbit flipping](https://arxiv.org/abs/2507.19709) <a id="link58"></a>
...
**Comment:** Studies the dynamics of mildly hierarchical triple systems and the von Zeipel-Lidov-Kozai effect, which is not directly related to near-field cosmology, satellite galaxies, or dark matter substructure. No direct connection to the core topics.
...
## 59. [Survival of higher overdensity cold gas in a turbulent, multiphase medium](https://arxiv.org/abs/2507.20962) <a id="link59"></a>
...
**Comment:** Presents simulations of cold gas clouds in turbulent media. While relevant to ISM/CGM physics, it does not address satellite galaxies, substructure, or near-field cosmology.
...
## 60. [Hydrodynamical modeling of SN 2025kg associated with the Fast X-ray Transient EP250108a](https://arxiv.org/abs/2507.20457) <a id="link60"></a>
...
**Comment:** Hydrodynamical modeling of a supernova associated with an X-ray transient; not focused on dwarf galaxies, satellite systems, or near-field cosmology.
...
## 61. [Testing the AGN unified model with simulated emission lines from the circumgalactic medium (CGM)](https://arxiv.org/abs/2507.19585) <a id="link61"></a>
...
**Comment:** This paper simulates emission lines from the circumgalactic medium around AGN, focusing on testing the AGN unified model. It does not address near-field cosmology, satellite galaxies, or substructure.
...
## 62. [Cosmological observational tests in the JWST Era I: angular size - redshift](https://arxiv.org/abs/2507.19651) <a id="link62"></a>
...
**Comment:** This paper uses JWST data to test cosmological models via the angular size-redshift relation, focusing on galaxy sizes at high redshift. It does not address near-field cosmology or satellite galaxies.
...
## 63. [Observability of radio reflections from exoplanet ionospheres with next generation radio telescopes](https://arxiv.org/abs/2507.20978) <a id="link63"></a>
...
**Comment:** Studies radio reflections from exoplanet ionospheres, which is unrelated to near-field cosmology or the structure of dwarf galaxies.
...
## 64. [JWST Observations of SN 2023ixf II: The Panchromatic Evolution Between 250 and 720 Days After the Explosion](https://arxiv.org/abs/2507.19727) <a id="link64"></a>
...
**Comment:** Presents observations of a core-collapse supernova, not related to near-field cosmology or satellite galaxies.
...
## 65. [First Temperature Profile of a Stellar Flare using Differential Chromatic Refraction](https://arxiv.org/abs/2507.19584) <a id="link65"></a>
...
**Comment:** Presents a method for deriving stellar flare temperature profiles using differential chromatic refraction. Focus is on stellar flares, not on near-field cosmology or satellite galaxies.
...
## 66. [Episodic accretion in high-mass star formation: An analysis of thermal instability for axially symmetric disks](https://arxiv.org/abs/2507.20781) <a id="link66"></a>
...
**Comment:** Studies episodic accretion in high-mass star formation using hydrodynamical models. Focus is on massive protostars and disk evolution, not on near-field cosmology or satellite galaxies.
...
## 67. [Precision spectral estimation at sub-Hz frequencies: closed-form posteriors and Bayesian noise projection](https://arxiv.org/abs/2507.20846) <a id="link67"></a>
...
**Comment:** Presents a Bayesian method for spectral estimation in time series, originally developed for LISA Pathfinder data. This is a methodological paper with no direct connection to near-field cosmology or satellite galaxies.
...
## 68. [GW231123: Binary Black Hole Merger or Cosmic String?](https://arxiv.org/abs/2507.20778) <a id="link68"></a>
...
**Comment:** The paper discusses the origin of a gravitational wave event, comparing binary black hole merger and cosmic string scenarios. This is not related to near-field cosmology or satellite galaxies.
...
## 69. [From South to North: Leveraging Ground-Based LATs for Full-Sky CMB Delensing and Constraints on $r$](https://arxiv.org/abs/2507.19897) <a id="link69"></a>
...
**Comment:** This paper is about CMB delensing and constraints on primordial gravitational waves, not about near-field cosmology, satellite galaxies, or Milky Way substructure.
...
## 70. [Long cavity spectral disperser at sub-picometer resolution. Design and analysis](https://arxiv.org/abs/2507.20986) <a id="link70"></a>
...
**Comment:** This paper presents a high-resolution spectrometer design, which is a technical/methodological advance in instrumentation, not directly related to near-field cosmology or satellite galaxies.
...
## 71. [A deep dive down the broad-line region: permitted OI, CaII and FeII emission in an AGN Little Red Dot at z=5.3](https://arxiv.org/abs/2507.20684) <a id="link71"></a>
...
**Comment:** Analyzes a high-redshift AGN and its broad-line region using JWST data. The focus is on AGN physics, supermassive black holes, and early universe galaxy evolution, which are not relevant to near-field cosmology or dwarf satellite studies.
...
## 72. [Rotation of young solar-type stars as seen by Gaia and K2](https://arxiv.org/abs/2507.20909) <a id="link72"></a>
...
**Comment:** Focuses on rotation of young solar-type stars using Gaia and K2 data. While it involves stellar populations, it does not address satellite galaxies, dwarf galaxies, or near-field cosmology topics.
...
## 73. [Confronting Inflation and Reheating with Observations: Improved Predictions Beyond Slow-Roll](https://arxiv.org/abs/2507.20307) <a id="link73"></a>
...
**Comment:** Focuses on inflation and reheating in the early universe, not on near-field cosmology or satellite galaxies.
...
## 74. [Millimeter VLBI constraints on the central magnetic field and symmetric jet production in the twin-jet galaxy NGC 1052](https://arxiv.org/abs/2507.20852) <a id="link74"></a>
...
**Comment:** Focuses on jet properties in a radio galaxy (NGC 1052), not on near-field cosmology or satellite galaxies.
...
## 75. [Radio Emission from a Nearby M dwarf Binary](https://arxiv.org/abs/2507.20681) <a id="link75"></a>
...
**Comment:** Focuses on radio emission from an M dwarf binary and a brown dwarf, not on near-field cosmology or satellite galaxies.
...
## 76. [Thick Disks around White Dwarfs viewed 'Edge-off': Effects on Transit Properties and Infrared Excess](https://arxiv.org/abs/2507.20594) <a id="link76"></a>
...
**Comment:** Studies thick debris disks around white dwarfs and their observational signatures. Focus is on white dwarf systems, not on near-field cosmology or satellite galaxies.
...
## 77. [Radiometric Interferometry for Deep Space Navigation using Geostationary Satellites](https://arxiv.org/abs/2507.19921) <a id="link77"></a>
...
**Comment:** Describes a method for deep space navigation using geostationary satellites and interferometry. No connection to near-field cosmology, satellite galaxies, or dark matter substructure.
...
## 78. [Young Stellar Objects in the Carina nebula: Near-Infrared variability and spectroscopy](https://arxiv.org/abs/2507.20086) <a id="link78"></a>
...
**Comment:** Catalogs young stellar objects in the Carina nebula, focusing on star formation and variability. No relevance to near-field cosmology, satellite galaxies, or dark matter.
...
## 79. [New symbiotic stars or candidates in LAMOST low resolution spectra](https://arxiv.org/abs/2507.20206) <a id="link79"></a>
...
**Comment:** Searches for new symbiotic stars using LAMOST spectra. Focus is on binary star systems and stellar evolution, not on near-field cosmology or satellite galaxies.
...
## 80. [Lithium in V505 Per](https://arxiv.org/abs/2507.19954) <a id="link80"></a>
...
**Comment:** Determines lithium abundance in the components of an eclipsing binary (V505 Per). Focus is on stellar abundances and binary evolution, not on near-field cosmology or satellite galaxies.
...
## 81. [Multi-line Spectropolarimetric Observation of Flare Ribbon Fine Structures with ViSP/DKIST](https://arxiv.org/abs/2507.20070) <a id="link81"></a>
...
**Comment:** Presents spectropolarimetric observations of solar flare ribbon fine structures. This is solar physics and not related to near-field cosmology or satellite galaxies.
...
## 82. [X-Raying a Be star disk: fundamental parameters of the eclipsing binary Be star V658 Car](https://arxiv.org/abs/2507.20053) <a id="link82"></a>
...
**Comment:** Analyzes the disk of an eclipsing Be star binary. This is stellar astrophysics and circumstellar disk structure, not related to near-field cosmology or satellite galaxies.
...
## 83. [Simulating the Milky Way bar and bulge with an initially S\'{e}rsic disc](https://arxiv.org/abs/2507.20790) <a id="link83"></a>
...
**Comment:** Simulates the Milky Way bar and bulge with an initially Sersic disc. The focus is on the bar and bulge, which are specifically listed as irrelevant in the criteria.
...
## 84. [A Systematic Search for AGN Flares in ZTF Data Release 23](https://arxiv.org/abs/2507.20232) <a id="link84"></a>
...
**Comment:** Systematic search for AGN flares in ZTF data. This is about AGN variability and not related to near-field cosmology or satellite galaxies.
...
## 85. [Thermodynamic stability of superflows in General Relativity and Newtonian gravity](https://arxiv.org/abs/2507.19985) <a id="link85"></a>
...
**Comment:** Discusses thermodynamic stability of superflows in general relativity and Newtonian gravity. No connection to near-field cosmology or satellite galaxies.
...
## 86. [A Systematic Search for Big Dippers in ASAS-SN](https://arxiv.org/abs/2507.19594) <a id="link86"></a>
...
**Comment:** Systematic search for 'Big Dippers' (variable stars) in ASAS-SN. Focuses on variable stars, not on satellite galaxies or near-field cosmology.
...
**Comment:** Focuses on the emergence of bipolar magnetic regions and sigmoidal solar active regions, which is solar physics and not related to near-field cosmology or dwarf galaxies.
...
## 88. [Comparing Behavioural Cloning and Reinforcement Learning for Spacecraft Guidance and Control Networks](https://arxiv.org/abs/2507.19535) <a id="link88"></a>
...
**Comment:** Focuses on machine learning methods for spacecraft guidance and control, which is unrelated to near-field cosmology or satellite galaxies.
...
## 89. [Exoplanet Detection Using Machine Learning Models Trained on Synthetic Light Curves](https://arxiv.org/abs/2507.19520) <a id="link89"></a>
...
**Comment:** Discusses machine learning for exoplanet detection, which is not related to near-field cosmology or the study of dwarf galaxies or Milky Way satellites.
...
## 90. [Comparing Quantum Machine Learning Approaches in Astrophysical Signal Detection](https://arxiv.org/abs/2507.19505) <a id="link90"></a>
...
**Comment:** Compares quantum machine learning approaches for astrophysical signal detection, specifically gamma-ray bursts. This is not related to near-field cosmology or satellite galaxies.
...
## 91. [Mixing due to internal gravity waves can explain the CNO surface abundances of B-type detached eclipsing binaries and single stars](https://arxiv.org/abs/2507.20785) <a id="link91"></a>
...
**Comment:** This paper investigates mixing in B-type stars and its effect on surface abundances, focusing on stellar evolution and internal mixing, not on galaxies, satellites, or near-field cosmology.
...
## 92. [Magnetic effect on the evolution of an eccentric and inclined orbit](https://arxiv.org/abs/2507.20093) <a id="link92"></a>
...
**Comment:** Studies magnetic effects on orbital evolution, but not in the context of dwarf galaxies, satellite systems, or near-field cosmology.
...
## 93. [Transmission of the AtmosPhere for AStronomical data: TAPAS upgrade](https://arxiv.org/abs/2507.19997) <a id="link93"></a>
...
**Comment:** Describes an upgrade to the TAPAS atmospheric transmittance tool for astronomical data. This is a technical/methodological paper about atmospheric modeling, not about near-field cosmology or dwarf galaxies.
...
**Comment:** Re-examines fusion cross sections in carbon reactions relevant for astrophysics, but not related to near-field cosmology, satellite galaxies, or dark matter substructure.
...
## 95. [Bo\v{s}kovi\'{c}'s Spherical Trigonometric Solution for Determining the Axis and Rate of Solar Rotation by Observing Sunspots in 1777](https://arxiv.org/abs/2507.20383) <a id="link95"></a>
...
**Comment:** Historical analysis of solar rotation using sunspot observations from 1777. No relevance to near-field cosmology or satellite galaxies.
...
## 96. [The Timing Evolution of the Magnetar Swift J1818.0-1607 During a Period of Reduced Activity](https://arxiv.org/abs/2507.19698) <a id="link96"></a>
...
**Comment:** Reports on the timing evolution of a magnetar. This is neutron star physics and not related to near-field cosmology or satellite galaxies.
...
## 97. [Revealing Flare Energetics and Dynamics with SDO EVE Solar Extreme Ultraviolet Spectral Irradiance Observations](https://arxiv.org/abs/2507.19681) <a id="link97"></a>
...
**Comment:** Solar flare energetics and dynamics using SDO EVE data. Focuses on solar physics, not near-field cosmology or satellite galaxies.
...
## 98. [Methyl Isocyanate Formation from Oxygen Insertion in Methyl Cyanide Ices](https://arxiv.org/abs/2507.21047) <a id="link98"></a>
...
**Comment:** Examines chemical complexity in molecular clouds, not related to near-field cosmology or satellite galaxies.
...
## 99. [Multi-band optical variability of the blazar OP 313 in the outburst state during 2024-2025](https://arxiv.org/abs/2507.20223) <a id="link99"></a>
...
**Comment:** Studies optical variability of a blazar. Not related to near-field cosmology or satellite galaxies.
...
## 100. [BSN-III: The First Multiband Photometric Study on the Eight Total Eclipse Contact Binary Stars](https://arxiv.org/abs/2507.20607) <a id="link100"></a>
...
**Comment:** Study of contact binary stars, not related to near-field cosmology or satellite galaxies.
...
## 101. [Probabilistic Link Budget Analysis for Low Earth Orbit Satellites in the Optical Regime](https://arxiv.org/abs/2507.20908) <a id="link101"></a>
...
**Comment:** This paper is about optical communication link budgets for LEO satellites, which is unrelated to near-field cosmology or the astrophysical topics of interest.
...
>    - Irrelevant: Papers that focus on Milky Way properties like the stellar disk, bar, and Galactic center. Focus on higher mass galaxies, like massive spirals and elliptical galaxies. 
> 
> **Keywords:**
> 
