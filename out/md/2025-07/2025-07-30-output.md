...
10. [Radio Variability in Recently-Quenched Galaxies: The Impact of TDE or AGN Driven Outflows](#user-content-link10)
...
21. [Estimating cluster masses: a comparative study between machine learning and maximum likelihood](#user-content-link21)
...
36. [Optical Emission-Line Properties of eROSITA-selected SDSS-V Galaxies](#user-content-link36)
...
47. [Precovery Observations of 3I/ATLAS from TESS Suggests Possible Distant Activity](#user-content-link47)
...
57. [On the formation of strange quark stars from supernova in compact binaries](#user-content-link57)
...
71. [Requirements for Joint Orbital Characterization of Cold Giants and Habitable Worlds with Habitable Worlds Observatory](#user-content-link71)
...
**Comment:** Studies the red giant members of the globular cluster Palomar 5 and its tidal streams, using APOGEE and Gaia data. The work discusses the disruption of Pal 5 and the density variations in its tidal streams, which are used as probes of the Milky Way's mass distribution and substructure. This is highly relevant to near-field cosmology, especially the study of stellar streams, dark matter subhaloes, and the accreted halo.
...
**Comment:** Addresses 'Star Formation Quenching' criterion: investigates quenching via tidal gas removal in post-starburst galaxies, with spatially resolved molecular gas and star formation measurements. However, the focus is on massive galaxies at z~0.7, not dwarfs, so relevance is moderate.
...
**Comment:** This paper presents numerical MHD simulations of magnetic flux transport in turbulent interstellar media, with direct implications for star formation in molecular clouds. While it does not focus on galaxies per se, it is relevant to the 'Stellar Models' and 'Numerical Galaxy Simulations' criteria in the context of star formation physics, but only peripherally. The main focus is on the ISM and star formation, not on galaxies or their resolved histories.
...
**Comment:** Models spectral energy distributions of Population III stars and their impact on He II emission and the 21-cm signal. While this is relevant to early universe star formation and reionization, it does not directly address resolved star formation histories, near-field cosmology, or dwarf galaxy properties. The focus is on primordial star clusters, not local or resolved galaxies.
...
**Comment:** This paper presents a generative neural network framework for radio interferometric image reconstruction, with fast uncertainty quantification. While it is relevant to radio astronomy techniques, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
**Comment:** Analyzes a chemically peculiar eclipsing binary system (AR Aurigae) using TESS data. While it involves stellar properties and evolutionary models, it does not present new stellar models or tracks, nor does it address the other core topics.
...
## 23. [Image of a time-dependent rotating regular black hole](https://arxiv.org/abs/2507.21628) <a id="link23"></a>
...
**Comment:** Presents a method for probing missing physics in gravitational wave signals from binary black holes. This is focused on gravitational wave astrophysics and tests of gravity, not on galaxy evolution, star formation, or stellar models.
...
## 31. [Does magnetic field promote or suppress fragmentation in AGN disks? Results from local shearing box simulations with simple cooling](https://arxiv.org/abs/2507.21991) <a id="link31"></a>
...
**Comment:** The paper forecasts the sensitivity of high-resolution X-ray spectroscopy to axion-like particle (ALP)-photon mixing. While it is relevant to fundamental physics and X-ray astronomy, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
**Comment:** This paper models tidal heating in detached double white dwarf binaries, focusing on their evolution and implications for transients. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
**Comment:** Studies double-peaked narrow emission-line spaxels in barred galaxies using MaNGA data. The focus is on the dynamics of barred galaxies and nuclear rings, which is outside the core topics (dwarf galaxies, resolved SFHs, etc.).
...
## 43. [A multi-frequency, multi-epoch radio continuum study of the Quintuplet cluster with the Very Large Array](https://arxiv.org/abs/2507.21617) <a id="link43"></a>
...
**Comment:** Does not match any core criteria. Focuses on massive star evolution and supernovae, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
**Abstract:** Quasar microlensing can be used to constrain important astrophysical properties, such as the accretion disk size and the amount of stars in the lensing galaxy. The associated brightness variations over time, in particular high magnification events (HMEs) and caustic crossings, can yield precise constraints due to their strong dependence on the relative projected velocities of the components and accretion disk size. The next generation of large sky area surveys, such as The Vera Rubin Observatory (LSST) and Euclid, are expected to find and follow-up thousands of lensed quasars from which such events could be identified and observed. In this work we present a characterization and estimation of all HMEs that could potentially be observed, focusing on systems that could be identified by ground based telescopes. From systems whose minimum image separation is at least 1 arcsec, and their second dimmest image is at least 21.5 magnitudes in the i-band ($\sim560$ in the southern or northern sky), we estimate $\sim60$ HMEs with amplitudes $>0.3$ [mag] in the r-band per year. We find that on average, saddle images are approximately four times more likely to host events than minima, and $\sim10\%$ ($\sim50\%$) of events are caustic crossings for saddles (minima). We also find that HMEs in saddle images can have amplitudes $\sim1-2$ [mag] larger than minima.

**Comment:** Does not match any core criteria. Focuses on quasar microlensing and accretion disk size constraints, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 46. [Reheating after the Supercooled Phase Transitions with Radiative Symmetry Breaking](https://arxiv.org/abs/2507.21215) <a id="link46"></a>
...
**Comment:** This paper discusses reheating after supercooled phase transitions with radiative symmetry breaking, focusing on early universe cosmology, gravitational waves, and dark matter production. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 47. [Precovery Observations of 3I/ATLAS from TESS Suggests Possible Distant Activity](https://arxiv.org/abs/2507.21967) <a id="link47"></a>
...
**Comment:** Reports precovery observations of the interstellar object 3I/ATLAS. The focus is on Solar System science and interstellar objects, not on galaxies, star formation histories, or near-field cosmology.
...
## 48. [A Late-Time Rise in Planet Occurrence Reproduces the Galactic Height Trend in Planet Occurrence](https://arxiv.org/abs/2507.21250) <a id="link48"></a>
...
**Comment:** Investigates the time-dependence of planet occurrence in the Milky Way and its relation to galactic height. This is focused on exoplanet occurrence and galactic structure, not on any of the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 49. [Symbiotic stars in Galactic open clusters](https://arxiv.org/abs/2507.21994) <a id="link49"></a>
...
**Comment:** Searches for symbiotic stars in Galactic open clusters to constrain their ages. The focus is on binary star systems and stellar populations in clusters, not on galaxies, star formation histories, or near-field cosmology.
...
## 51. [Bondi accretion disk luminosity around neutral and charged Simpson-Visser spacetimes](https://arxiv.org/abs/2507.21580) <a id="link51"></a>
...
**Comment:** This paper studies Bondi accretion in various black hole spacetimes, focusing on accretion rates and luminosities. It does not address galaxy-scale processes, dwarf galaxies, or any of the core topics.
...
## 53. [From Equipartition to Curvature: The Spectral Evolution of 4FGL Blazars](https://arxiv.org/abs/2507.21647) <a id="link53"></a>
...
**Comment:** Investigates the spectral evolution of blazars using SED modeling. The focus is on AGN/blazar physics, not on galaxy evolution, star formation, or the other core topics.
...
## 56. [NIRPS joining HARPS at ESO 3.6 m. On-sky performance and science objectives](https://arxiv.org/abs/2507.21767) <a id="link56"></a>
...
**Comment:** Describes the NIRPS instrument for exoplanet detection and characterization. The focus is on instrumentation and exoplanet science, not on any of the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 58. [Nighttime Cloud Detection, Tracking and Prediction with All-Sky Cameras](https://arxiv.org/abs/2507.21711) <a id="link58"></a>
...
**Comment:** Presents a method for nighttime cloud detection for robotic telescopes. While useful for observatories, it does not address any of the core astrophysical topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 59. [SARD: A YOLOv8-Based System for Solar Active Region Detection with SDO/HMI Magnetograms](https://arxiv.org/abs/2507.21866) <a id="link59"></a>
...
**Comment:** Describes a YOLOv8-based system for detecting solar active regions in SDO/HMI magnetograms. This is a solar physics/machine learning paper and does not address any of the core topics.
...
## 60. [Interpreting the KM3-230213A PeV Neutrino Event via Vector Dark Matter Decay and Its Multi-Messenger Signatures](https://arxiv.org/abs/2507.21534) <a id="link60"></a>
...
**Comment:** This paper interprets a high-energy neutrino event via a vector dark matter decay model, with multi-messenger implications. It is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 61. [Radion Portal Freeze-Out Dark-Matter](https://arxiv.org/abs/2507.21218) <a id="link61"></a>
...
**Comment:** This paper discusses a model of dark matter freeze-out via a radion portal in extra-dimensional theories. It is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 63. [Confronting infrared divergences in de Sitter: loops, logarithms and the stochastic formalism](https://arxiv.org/abs/2507.21310) <a id="link63"></a>
...
**Comment:** Addresses quantum field theory in de Sitter space and infrared divergences, with implications for inflationary cosmology. No relevance to near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 65. [Continuum Reverberation Mapping of Accretion Disks Surrounding Supermassive Black Hole Binaries: Observational Signatures](https://arxiv.org/abs/2507.21671) <a id="link65"></a>
...
**Comment:** Does not match any core criteria. Focuses on accretion disks around supermassive black hole binaries, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 71. [Requirements for Joint Orbital Characterization of Cold Giants and Habitable Worlds with Habitable Worlds Observatory](https://arxiv.org/abs/2507.21443) <a id="link71"></a>
...
**Comment:** This paper discusses requirements for exoplanet detection and characterization with the Habitable Worlds Observatory, focusing on habitable-zone and cold giant planets. It is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 74. [Properties and approximations of a Bessel distribution for data science applications](https://arxiv.org/abs/2507.21812) <a id="link74"></a>
...
**Comment:** Presents properties and approximations of a Bessel distribution for data science applications. No relevance to any of the core astrophysical topics.
...
## 77. [Evaluation of gamma-ray response of the AstroPix4 HV-CMOS active pixel sensor](https://arxiv.org/abs/2507.21618) <a id="link77"></a>
...
**Comment:** Does not match any core criteria. Focuses on gamma-ray detector technology, not on galaxies or star formation.
...
## 78. [Sun sensor calibration algorithms: A systematic mapping and survey](https://arxiv.org/abs/2507.21541) <a id="link78"></a>
...
**Comment:** This is a review of sun sensor calibration algorithms for spacecraft attitude determination. It is focused on engineering and instrumentation, not on any of the astrophysical or galaxy-related core topics.
...
## 79. [Comment on "Dynamical Dark Energy at Late Time $\Lambda$CDM"](https://arxiv.org/abs/2507.21278) <a id="link79"></a>

**ArXiv ID:** 2507.21278

**Authors:** James M. Cline

**Abstract:** In arXiv:2505.18900 it was claimed that an apparent evolution of the dark energy equation of state occurs within the standard $\Lambda$CDM cosmological model. I point out that this erroneous conclusion is due to a mathematical error.

**Comment:** A comment on a previous paper about dark energy evolution in LambdaCDM. This is a cosmological theory clarification and does not address any of the core topics.
