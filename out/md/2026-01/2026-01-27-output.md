...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 44924    | 7741         | 52665   |
| **Cost**             | $0.09    | $0.06        | $0.15   |

Total arXiv papers: 200
...
1. [The mass distribution in and around the Local Group](#user-content-link1)
**Authors:** Ewoud Wempe, Simon D. M. White, Amina Helmi, Guilhem Lavaux, Jens Jasche

2. [The Impact of Star Formation Histories on the Inner Dark Matter Density Slopes of Galaxies](#user-content-link2)
**Authors:** Jorge Sarrato-Al\'os, James Bullock, Arianna Di Cintio, Christopher Brook, Fernando Valenciano, Andrea V. Macci\`o

3. [An Enhanced Isothermal Jeans Approach to Constraining Dark Matter Self-Interactions from Galactic Kinematics](#user-content-link3)
**Authors:** Zixiang Jia, Fangzhou Jiang, Shubo Li, Ran Li, Jing Wang, Ling Zhu

4. [Extragalactic Planetary Nebulae (xPNe). Chemical evolution and assembly histories of nearby galaxies using Oxygen and Argon abundances. From the local universe to cosmic dawn](#user-content-link4)
...
5. [Stellar Disruption of Axion Minihalos and Consequences for Direct Axion Detection](#user-content-link5)
**Authors:** Ian DSouza

6. [Dynamical Mass Loss at the End of TP-AGB stars](#user-content-link6)
**Authors:** Yingzhen Cui, Song Wang, Xiangcun Meng, Jifeng Liu, Shuguo Ma, Weitao Zhao

7. [Detached eclipsing binary star science in the 2040s](#user-content-link7)
**Authors:** Pierre F. L. Maxted, Dominic M. Bowman, Thomas G. Wilson, Sophie Rosu, Keivan G. Stassun, Simon J. Murphy, Ayush Moharana, Amaury H. M. J. Triaud, Axel Hahlin, John Southworth

8. [The multiple coherence scales of C IV at cosmic noon](#user-content-link8)
**Authors:** H. Cort\'es-Mu\~noz, S. Lopez, N. Tejos, J. -K. Krogager, D. Zamora, R. Cuellar, P. Anshul, F. Urbina, A. Afruni

9. [Virgo Filaments VI: H$\alpha$ clumps in the filaments around the Virgo galaxy cluster](#user-content-link9)
**Authors:** G. Nagaraj, P. Jablonka, R. A. Finn, Y. M. Bah\'e, F. Combes, G. Castignani, B. Vulcani, G. Rudnick, D. Zakharova, R. A. Koopmann, D. Zaritsky, K. Conger

10. [Evolution of Stellar Activity and Habitable Zone II: Ca H&K Emissions of Late-type Dwarfs](#user-content-link10)
**Authors:** Henggeng Han, Song Wang, Xue Li, Chuanjie Zheng, Jiahui Wang, Jifeng Liu

11. [Intracluster light as a dark matter tracer: how their spatial and kinematic relationship is shaped by satellite demographics](#user-content-link11)
**Authors:** G Martin (School of Physics and Astronomy, University of Nottingham, UK), F R Pearce (School of Physics and Astronomy, University of Nottingham, UK), N A Hatch (School of Physics and Astronomy, University of Nottingham, UK), H J Brown (School of Physics and Astronomy, University of Nottingham, UK), J Butler (School of Physics and Astronomy, University of Nottingham, UK), Y M Bahe (School of Physics and Astronomy, University of Nottingham, UK, Laboratory of Astrophysics, EPFL, Switzerland), W Cui (Departamento de Fisica Teorica, Universidad Autonoma de Madrid, Spain, Institute for Astronomy, Royal Observatory Edinburgh, UK), Y Dubois (Institut d Astrophysique de Paris, CNRS, Sorbonne Universite, France), A Knebe (Departamento de Fisica Teorica, Universidad Autonoma de Madrid, Spain, ICRAR, University of Western Australia, Australia)

12. [The AIDA-TNG project: gas distributions inside and around haloes](#user-content-link12)
**Authors:** Chi Zhang, Enrico Garaldi, Giulia Despali, Matteo Viel, Lauro Moscardini, Mark Vogelsberger

13. [Non-Equilibrium Relativistic Core Collapse of Self-Interacting Dark Matter Halos -- Limits On Seed Black Hole Mass](#user-content-link13)
**Authors:** Hua-Peng Gu, Fangzhou Jiang, Xian Chen, Ran Li

14. [An ultra-high-resolution map of (dark) matter](#user-content-link14)
...
15. [Discovery of an Extremely Metal-Poor Galaxy at $z=3.654$ Using JWST Infrared Spectroscopy](#user-content-link15)
**Authors:** Zijian Yu, Sijia Cai

16. [Disentangling Drivers of Disk Warps in Tilted and Tumbling TNG50 Halos](#user-content-link16)
**Authors:** Saarthak Johri, Neil Ash, Monica Valluri

17. [Direct Abundance Maps and Radial Metallicity Gradients of two Galaxies at z~4-5 in the GARDEN Survey](#user-content-link17)
...
18. [JOYS: JWST MIRI/MRS spectra of the inner 500 au region of the L1527 IRS bipolar outflow](#user-content-link18)
**Authors:** R. Devaraj, E. F. van Dishoeck, T. P. Ray, {\L}. Tychoniec, A. Caratti o Garatti, L. Francis, C. Gieser, M. L. van Gelder, J. J. Tobin, H. Beuther, P. J. Kavanagh, K. Justtanont, W. B. Drechsler, M. G. Navarro, G. Perotti

19. [Constraining Reionization Morphology and Source Properties with 21cm-Galaxy Cross-Correlation Surveys](#user-content-link19)
**Authors:** Yannic Pietschke, Anne Hutter, Caroline Heneka

20. [Tracing Galaxy Evolution in the Nearby Universe: The Role of Dark Matter](#user-content-link20)
**Authors:** A. Nigoche-Netro, P. Lagos, R. J. Diaz, E. de la Fuente, M. P. Ag\"uero, A. Ruelas-Mayorga, S. N. Kemp, R. A. Marquez-Lugo, R. Ibarra-Nu\~no

21. [Evidence of Gas Depletion in Quasars with Moderate Radio Emission](#user-content-link21)
**Authors:** Yuhan Wen, Ran Wang, Luis C. Ho, Jinyi Shangguan, Ezequiel Treister, Guodong Li, Franz E. Bauer

22. [Baryonification III: An accurate analytical model for the dispersion measure probability density function of fast radio bursts](#user-content-link22)
**Authors:** MohammadReza Torkamani, Robert Reischke, Michael Kova\v{c}, Andrina Nicola, Jozef Bucko, Alexandre Refregier, Sambit K. Giri, Aurel Schneider, Steffen Hagstotz

23. [First Observational Evidence for Split Infall Flow of Cosmic Filaments into Clusters](#user-content-link23)
**Authors:** Ji Yao, Huanyuan Shan, Pengjie Zhang, Xiaohu Yang, Jiale Zhou, Jiaxin Han, Peng Wang

24. [Ancient relic moderately metal-rich bulge cluster Tonantzintla 2](#user-content-link24)
**Authors:** Sergio Ortolani, Stefano O. Souza, Domenico Nardiello, Beatriz Barbuy, Eduardo Bica, Bernardo P. L. Ferreira, Cristina Chiappini, Jos\'e Fernandez-Trincado, Heitor Ernandes

25. [Three-point intrinsic alignments of galaxies and haloes in the FLAMINGO simulations](#user-content-link25)
**Authors:** Casper Vedder, Thomas Bakx, Nora Elisa Chisari, Henk Hoekstra, Matthieu Schaller

26. [New parameters for star cluster dynamics: observational results](#user-content-link26)
**Authors:** Barbara Lanzoni (Dipartimento di Fisica e Astronomia, Universit\`a degli Studi di Bologna, Italy, NAF, Osservatorio di Astrofisica e Scienza dello Spazio di Bologna, Italy), Francesco R. Ferraro (Dipartimento di Fisica e Astronomia, Universit\`a degli Studi di Bologna, Italy, NAF, Osservatorio di Astrofisica e Scienza dello Spazio di Bologna, Italy), Enrico Vesperini (Dept. of Astronomy, Indiana University, Bloomington, IN 47401, USA)

27. [Learning at the Edge: Tailed-Uniform Sampling for Robust Simulation-Based Inference](#user-content-link27)
**Authors:** Chaipat Tirapongprasert, Matthew Ho

28. [2MASS Re-processing I: The Search for Faint Objects](#user-content-link28)
**Authors:** Zehao Liu, Xiyan Peng, Zhenghong Tang, Zhaoxiang Qi, Shilong Liao, Yong Yu

29. [Photoexcitation spectroscopy of highly charged ions for application to astronomy using a compact electron beam ion trap (EBIT) at the synchrotron radiation facility SPring-8](#user-content-link29)
...
30. [Forecasting the E_G measurements from the photometric and spectroscopic surveys of Chinese Space Station Survey Telescope (CSST)](#user-content-link30)
**Authors:** Yu Song, Yi Zheng

31. [Deciphering the Remnants of Core-Collapse Supernovae: Reconstructing Progenitor Star Properties and Explosion Mechanisms](#user-content-link31)
**Authors:** Salvatore Orlando

32. [AI-based separation of turbulence from coherent background flows in decaying hydrodynamic turbulence](#user-content-link32)
**Authors:** Ji-Hoon Ha, Elena S. Volnova

33. [Escaping ionizing photons from massive spiral galaxies at $z\sim 1$](#user-content-link33)
**Authors:** Soumil Maulick, Kanak Saha

34. [Closure models for the feedback of energetic particles on plasma turbulence](#user-content-link34)
**Authors:** J. Pratt

35. [Spectral Evolution and Current Sheet Analysis as Probes of Reconnection-Mediated Decay in Magnetically Dominated Turbulence](#user-content-link35)
**Authors:** Chandranathan Anandavijayan, Pallavi Bhat

36. [A Novel Lensed Point Source Modeling Pipeline using GIGA-Lens with Application to SN Zwicky and SN iPTF16geu](#user-content-link36)
**Authors:** Saul Baltasar, Nicolas Ratier-Werbin, Xiaosheng Huang, W. Sheu, C. J. Storfer, Y. -M. Hsu, Sean Xu, David J. Schlegel

37. [The r-Process: History, Required Conditions, Astrophysical Sites, and Observations](#user-content-link37)
**Authors:** Friedrich-Karl Thielemann, John J. Cowan

38. [Thermodynamic Characteristics of a Fermi Gas with an Invariant Energy Scale and its Astrophysical Implications](#user-content-link38)
**Authors:** Tiyasa Kar, Atul Kedia, Ramkumar Radhakrishnan

39. [The ALMA-ATOMS survey: Methanol emission in a large sample of hot molecular cores](#user-content-link39)
...
40. [Chemical study of two starless cores in the B213/L1495 filament](#user-content-link40)
**Authors:** L. Moral-Almansa, A. Fuente, M. Rodr\'iguez-Baras, T. Alonso-Albi, G. Esplugues, D. Navarro-Almaida, P. Rivi\'ere-Marichalar, B. Tercero, A. Asensio Ramos, C. Westendorp Plaza

41. [Galactic Large-scale Filaments Resident in Asymmetric Environments: Clues from Cross-filament Profiles of Density and Temperature](#user-content-link41)
**Authors:** Keyun Su (Kavli Institute for Astronomy and Astrophysics, Peking University), Ke Wang (Kavli Institute for Astronomy and Astrophysics, Peking University), Fengwei Xu (Max Planck Institute for Astronomy, Heidelberg), N. K. Bhadari (Kavli Institute for Astronomy and Astrophysics, Peking University)

42. [Measuring Rotation Periods in Crowded Star Clusters with TESS: A Proof-of-Concept with NGC 3532](#user-content-link42)
**Authors:** Matthew S. Stafford, Jason L. Curtis, Marcel A. Ag\"ueros

43. [Improving Generalization and Uncertainty Quantification of Photometric Redshift Models](#user-content-link43)
**Authors:** Jonathan Soriano, Tuan Do, Srinath Saikrishnan, Vikram Seenivasan, Bernie Boscoe, Jack Singal, Evan Jones

44. [Hubble Tension as an Effect of Horizon Entanglement Nonequilibrium](#user-content-link44)
**Authors:** Alexander S. Sakharov, Rostislav Konoplich, Merab Gogberashvili, Jack Simoni

45. [The Supermassive Black Hole in the Nearby Spiral Galaxy M81: A Robust Mass from JWST/NIRSpec Stellar Dynamics](#user-content-link45)
**Authors:** Dieu D. Nguyen, Tuan N. Le, Michele Cappellari, Hai N. Ngo, Tinh Q. T. Le, Tien H. T. Ho, Long Q. T. Nguyen, Elena Gallo, Fan Zou, Michele Perna, Niranjan Thatte, Miguel Pereira-Santaella

46. [JWST Spectroscopic Census of ALMA Faint Submillimeter Galaxies in the Hubble Ultra Deep Field](#user-content-link46)
...
47. [Explaining the thermal emission of old neutron stars with rotochemical heating and magnetized superconducting protons](#user-content-link47)
**Authors:** Luis E. Rodr\'iguez, Andreas Reisenegger, Denis Gonz\'alez-Caniulef, Crist\'obal Petrovich

48. [XFit: Global Optimization and Degeneracy Mapping in X-ray Spectral Modeling](#user-content-link48)
**Authors:** Austin MacMaster, Adam Rogers, Jason Fiege, Rebecca Man, Samar Safi-Harb

49. [Galactic Dust Polarization in Turbulent Multiphase ISM: On the Origin of the $EE/BB$ Asymmetry](#user-content-link49)
**Authors:** Yue Hu, Bao Truong, Thiem Hoang, Le Ngoc Tram

50. [On the hadronic origin of the very high energy $\gamma$-ray emission surrounding the young massive stellar cluster Westerlund 1](#user-content-link50)
**Authors:** Zhaodong Shi, Rui-zhi Yang

51. [Radio streaks in the Lighthouse Nebula discovered with MeerKAT -- Particles escaping from the tail and illuminating the ambient magnetic field](#user-content-link51)
**Authors:** Pierrick Martin, Mickael Coriat, Barbara Olmi, Elena Amato, Niccol\`o Bucciantini, Alexandre Marcowith, Sarah Recchia

52. [Neutrino opacities in magnetic fields for binary neutron star merger simulations](#user-content-link52)
**Authors:** Mia Kumamoto, Catherine Welch

53. [Resolution Dependence in Magnetohydrodynamic Simulations of Neutrino-Driven Core-Collapse Supernovae](#user-content-link53)
**Authors:** Vishnu Varma, Bernhard M\"uller

54. [In-depth analysis of bar formation mechanisms of disk galaxies in halos of different concentrations](#user-content-link54)
**Authors:** T. Worrakitpoonpon

55. [Decameter-sized Earth Impactors -- II: A Bayesian Inference Approach to Meteoroid Ablation Modeling](#user-content-link55)
**Authors:** Ian Chow, Peter G. Brown

56. [Exploring the role of accretion shocks in galaxy clusters as sources of ultrahigh-energy cosmic rays](#user-content-link56)
**Authors:** A. D. Supanitsky, S. E. Nuza

57. [Neuro-Parametric Spectral Classification of Black Hole and Neutron Star X-ray Binary Systems](#user-content-link57)
**Authors:** Akash Garg, Aman Kumar, Ajit Kembhavi, Ranjeev Misra, Aniruddha Kembhavi, N. S. Philip, Rohan Pattnaik, Shreya Watwe

58. [Sub-ion scale current sheets in kinetic Alfv\'en wave turbulence](#user-content-link58)
**Authors:** Johan Sharma, Ch Akshath Kumar, Kirit D. Makwana, Tulasi N Parashar, Sruti Satyasmita

59. [Ultra-fast growth of primordial black holes through radiative absorption](#user-content-link59)
**Authors:** Dimitris S. Kallifatides, Theodoros Papanikolaou, Emmanuel N. Saridakis

60. [Learned harmonic mean estimation of the marginal likelihood for multimodal posteriors with flow matching](#user-content-link60)
**Authors:** Alicja Polanska, Jason D. McEwen

61. [Inferring photospheric horizontal flows from multiple observations with SUVEL models](#user-content-link61)
**Authors:** Quan Xie, Jiajia Liu, Robert Erd\'elyi, Yuming Wang

62. [Higher-Order Gravitational Models: A Tutorial on Spherical Harmonics and the Newtonian Model](#user-content-link62)
**Authors:** Felipe Arenas-Uribe

63. [Constraining Quintessence Models with ISW-tSZ Cross-Correlations: A Comparative Analysis of Thawing, Tracker, and Scaling-Freezing Dynamics](#user-content-link63)
**Authors:** Ayodeji Ibitoye, Shiriny Akthar, Md. Wali Hossain, Amare Abebe, Prabhakar Tiwari, Xuelei Chen, Jackson Said, Jacob Oloketuyi

64. [The Most Luminous H$\beta$ Reverberation Mapping of E1821+643 Indicates the Lower Boundary of the Radius-Luminosity Relation](#user-content-link64)
**Authors:** Sha-Sha Li, Hai-Cheng Feng, Jiancheng Wu, J. M. Bai, H. T. Liu, Kai-Xing Lu, Mouyuan Sun, Jian-Guo Wang

65. [Disk-jet-wind coupling from stellar mass to supermassive black holes](#user-content-link65)
**Authors:** Chris Done (University of Durham, UK)

66. [Role of the symmetry energy on hybrid stars](#user-content-link66)
**Authors:** H. G\"uven, K. Bozkurt, E. Khan, J. Margueron

67. [The rest ultraviolet to infrared spectral energy distributions of heavily reddened quasars are "V-shaped" and hot-dust poor](#user-content-link67)
**Authors:** Matthew Stepney, Manda Banerji, Shenli Tang, Matthew J. Temple, Paul C. Hewett

68. [Revisiting a Quasar Microlensing Event Towards AGN~J1249+3449](#user-content-link68)
**Authors:** Mario Cazzolla, Francesco De Paolis, Antonio Franco, Achille Nucita

69. [Energy shift of Fe-K fluorescence lines due to low ionization demonstrated with XRISM in Centaurus X-3](#user-content-link69)
...
70. [Primordial black holes induced stochastic axion-photon oscillations in primordial magnetic field](#user-content-link70)
**Authors:** Hai-Jun Li

71. [SiGMa-Net II: Distinguishing Binary Black Holes from Glitches](#user-content-link71)
**Authors:** Soorya Narayan, Anupreeta More, Sunil Choudhary, Sudhagar Suyamprakasam, Sukanta Bose

72. [Impact of Rastall gravity on hydrostatic mass of galaxy clusters](#user-content-link72)
**Authors:** M. Lawrence Pattersons, Feri Apryandi, Freddy P. Zen

73. [Effect of different Non-Gravitational accelerations on the trajectory of Interstellar Comet 3I/ATLAS](#user-content-link73)
...
74. [Different Transient Phenomena at the Edges of Traveling Foreshocks](#user-content-link74)
**Authors:** Primoz Kajdic, X\'ochitl Blanco-Cano, Diana Rojas-Castllo, Nojan Omidi

75. [The growing family of gamma-ray narrow-line Seyfert 1 galaxies](#user-content-link75)
**Authors:** Luigi Foschini

76. [Assessing astrophysical foreground subtraction in DECIGO using compact binary populations inferred from the first part of the LIGO-Virgo-KAGRA's fourth observation run](#user-content-link76)
**Authors:** Takahiro S. Yamamoto

77. [Multi-epoch VLBI observations of the blazar 3C 66A: Spatial twisting and temporal oscillation of the parsec-scale jet](#user-content-link77)
**Authors:** Paloma Thevenet, Jeonguk Kim, Guang-Yao Zhao, Bong Won Sohn, Suk-Jin Yoon

78. [Single-Pulse Correlations in PSR B0329+54: Implications for Radio Emission Zones](#user-content-link78)
**Authors:** Shyam S. Sharma, Tetsuya Hashimoto, Tomotsugu Goto, Sanjay Kudale, Sujin Eie, Simon C. -C. Ho

79. [Tracing the Heliospheric Magnetic Field via Anisotropic Radio-Wave Scattering](#user-content-link79)
...
80. [tilepy: A Flexible Open-Source Scheduling Engine for Time-Domain and Multi-Messenger Astronomy](#user-content-link80)
**Authors:** Fabian Sch\"ussler, H. Ashkar, W. Kiendr\'eb\'eogo, M. Seglar-Arroyo, M. de Bony, A. Berti, E. Ruiz-Velasco, R. Le Montagner

81. [High-Resolution Solar X-ray Spectroscopy from Archived Solar Maximum Mission Data](#user-content-link81)
**Authors:** Kenneth J. H. Phillips, Barbara Sylwester, Janusz Sylwester

82. [Visualisation of spherical harmonics in Peirce's quincuncial projection](#user-content-link82)
**Authors:** Bjoern Malte Schaefer (ZAH, Heidelberg University)

83. [The optical photometric and spectroscopic periodicities of the cataclysmic variable SRGt 062340.2-265751](#user-content-link83)
**Authors:** J. Brink, D. A. H. Buckley, M. Veresvarska, A. D. Schwope, P. J. Groot, J. R. Thorstensen, V. A. C\'uneo, S. B. Potter, N. Titus, D. Egbo, R. Lees, O. Mogawana, A. van Dyk

84. [Autonomous Mars Rover Module for Soil Sampling and Life Component Analysis](#user-content-link84)
**Authors:** Bibek Adhikari, Rishab Rijal, Rakesh Yadav, Nikchey Khatri, Sandesh Dhakal

85. [STIS Cycle 30 Calibration Programs](#user-content-link85)
**Authors:** D. Welty, R. Bohlin, J. Carlberg, M. Dallas, S. Hernandez, A. Jones, S. Lockwood, S. Medallon, E. Rickman, D. Stapleton, T. Wheeler

86. [Sigmoid Formation, Filament Destabilization, and Initiation of Weak Flare by Tether-Cutting Reconnection](#user-content-link86)
**Authors:** B. Suresh Babu, Pradeep kayshap, Ashok Kumar Baral, Bhola N. Dwivedi

87. [Joint constraint on the propagation origin of the cosmic-ray spectral knee from energy spectrum and anisotropy observations](#user-content-link87)
**Authors:** Hua Yue, Lin Nie, Yi-Qing Guo, Hong-Bo Hu

88. [Gas Kinematics and Cosmic-Ray Acceleration in the Gamma-ray SNRs W41 and G22.7-0.2](#user-content-link88)
**Authors:** Takeru Murase, Hidetoshi Sano, Kohei Matsubara, Yasuo Fukui, Junya Nishi, Sabrina Einecke, Miroslav Filipovic, Rina Kasai, Ren Matsusaka, Gavin Rowell, Hiroshi Sodoh, Hiromasa Suzuki, Yosuke Shibata, Kisetsu Tsuge, Hiroshi Takaba, Toshihiro Handa

89. [AstroTimer: Rethinking Non-Access Stratum Timers in LEO Constellations](#user-content-link89)
**Authors:** Arshiya Rezaie Hezaveh, Peng Hu

90. [150 years of ground-based solar instrumentation at Meudon observatory (1876-2026)](#user-content-link90)
**Authors:** Jean-Marie Malherbe (LIRA, PSL)

91. [Gravitational wave detectors from an experimental perspective](#user-content-link91)
**Authors:** Marina Trad-Nery, Margherita Turconi, Walid Chaibi

---

## 1. [The mass distribution in and around the Local Group](https://arxiv.org/abs/2601.17125) <a id="link1"></a>
...
**Comment:** Directly relevant to near-field cosmology: studies the mass distribution in and around the Local Group, including the Milky Way, Andromeda, and their dwarf companions, using constrained simulations. Addresses the structure and dynamics of the Local Group, matching the highest relevance criterion.
...
## 2. [The Impact of Star Formation Histories on the Inner Dark Matter Density Slopes of Galaxies](https://arxiv.org/abs/2601.17113) <a id="link2"></a>
...
**Comment:** This paper directly matches two core criteria: it analyzes the connection between star formation histories and inner dark matter density profiles (core-cusp) in simulated galaxies, using NIHAO and FIRE-2 simulations. It presents new analytic expressions linking SFH to core-cusp structure, which is highly relevant to near-field cosmology, resolved star formation histories, and numerical galaxy simulations.
...
## 3. [An Enhanced Isothermal Jeans Approach to Constraining Dark Matter Self-Interactions from Galactic Kinematics](https://arxiv.org/abs/2601.17118) <a id="link3"></a>
...
**Comment:** Presents an improved semi-analytical model for SIDM halo density profiles, applied to galaxy rotation curves, including dwarf galaxies. Directly addresses the core-cusp problem and diversity of dwarf galaxy rotation curves, matching the 'Near-Field Cosmology' and 'Numerical Galaxy Simulations' criteria. Also discusses implications for small-scale structure and galaxy-halo scaling relations.
...
## 4. [Extragalactic Planetary Nebulae (xPNe). Chemical evolution and assembly histories of nearby galaxies using Oxygen and Argon abundances. From the local universe to cosmic dawn](https://arxiv.org/abs/2601.17106) <a id="link4"></a>
...
**Comment:** This paper discusses the use of extragalactic planetary nebulae (xPNe) to study chemical evolution and assembly histories of nearby galaxies, with a focus on resolved stellar populations and elemental abundances. It is highly relevant to near-field cosmology and resolved star formation histories, as it aims to probe ancient galactic components and signatures of mergers/interactions in the local universe.
...
## 5. [Stellar Disruption of Axion Minihalos and Consequences for Direct Axion Detection](https://arxiv.org/abs/2601.17478) <a id="link5"></a>
...
**Comment:** This paper investigates the disruption of axion minihalos by stellar encounters and the consequences for axion dark matter detection. It discusses the mass loss of minihalos in the Galactic environment, which is relevant to near-field cosmology, especially regarding dark matter substructure and the impact of stellar interactions on halo properties. The work presents new modeling and implications for axion detection.
...
## 6. [Dynamical Mass Loss at the End of TP-AGB stars](https://arxiv.org/abs/2601.18194) <a id="link6"></a>
...
**Comment:** Simulates dynamical mass loss at the end of the TP-AGB phase using hydrodynamics in MESA. Presents new insights into stellar mass loss mechanisms, which is relevant to the 'Stellar Models' criterion as it involves stellar evolutionary tracks and mass loss processes.
...
## 7. [Detached eclipsing binary star science in the 2040s](https://arxiv.org/abs/2601.17179) <a id="link7"></a>
...
**Comment:** The paper discusses detached eclipsing binary stars as sources of fundamental stellar parameters and their role in constraining stellar structure and evolution. This fits the 'Stellar Models' criterion, as it is relevant to improving stellar evolutionary tracks and interior models.
...
## 9. [Virgo Filaments VI: H$\alpha$ clumps in the filaments around the Virgo galaxy cluster](https://arxiv.org/abs/2601.18762) <a id="link9"></a>
...
**Comment:** This paper analyzes H-alpha clumps in galaxies in and around the Virgo cluster filaments, focusing on resolved star formation regions and environmental effects. While the galaxies are not specifically dwarfs, the work is relevant to resolved star formation histories and environmental quenching, with some connection to the circumgalactic medium and outflows. Solid relevance for resolved star formation histories and environmental effects.
...
## 10. [Evolution of Stellar Activity and Habitable Zone II: Ca H&K Emissions of Late-type Dwarfs](https://arxiv.org/abs/2601.17715) <a id="link10"></a>
...
**Comment:** Investigates Ca H&K emissions and chromospheric activity in late-type dwarfs, with implications for stellar ages and metallicity dependence. Relevant to stellar models and evolutionary tracks, especially for low-mass stars.
...
## 11. [Intracluster light as a dark matter tracer: how their spatial and kinematic relationship is shaped by satellite demographics](https://arxiv.org/abs/2601.18693) <a id="link11"></a>
...
**Comment:** Uses N-body simulations to study the relationship between intracluster light (ICL) and dark matter in galaxy clusters, focusing on the role of satellite galaxy demographics. While it discusses satellite galaxies, the context is massive clusters and ICL, not near-field cosmology or dwarf satellites of the Milky Way. Some relevance for satellite demographics and stripping, but weighted lower due to focus on clusters.
...
## 12. [The AIDA-TNG project: gas distributions inside and around haloes](https://arxiv.org/abs/2601.18578) <a id="link12"></a>
...
**Comment:** This paper uses the AIDA-TNG cosmological simulation suite to predict gas and HI distributions in and around haloes for various dark matter models. It analyzes the impact of DM models on gas profiles and the galaxy-Lyα cross-correlation function, with some focus on halo-to-halo variation and feedback. While the main focus is on massive haloes, there is some relevance to numerical galaxy simulations and dark matter substructure, but the connection to dwarf galaxies and near-field cosmology is limited.
...
## 13. [Non-Equilibrium Relativistic Core Collapse of Self-Interacting Dark Matter Halos -- Limits On Seed Black Hole Mass](https://arxiv.org/abs/2601.17117) <a id="link13"></a>
...
**Comment:** Presents a new general-relativistic model for the core collapse of self-interacting dark matter (SIDM) halos, with implications for seed black hole formation. While it discusses SIDM and halo evolution, the focus is on black hole seeding and not on the core topics of near-field cosmology, resolved star formation histories, or dwarf galaxy structure.
...
## 14. [An ultra-high-resolution map of (dark) matter](https://arxiv.org/abs/2601.17239) <a id="link14"></a>
...
**Comment:** This paper presents a high-resolution weak-lensing mass map using JWST, focusing on the distribution of dark and luminous matter and the evolution of cosmic structure. While it discusses dark matter and structure formation, the focus is on large-scale filaments and clusters rather than near-field cosmology or dwarf galaxies. No direct connection to satellite galaxies, resolved star formation histories, or CGM of dwarfs.
...
## 15. [Discovery of an Extremely Metal-Poor Galaxy at $z=3.654$ Using JWST Infrared Spectroscopy](https://arxiv.org/abs/2601.17498) <a id="link15"></a>
...
**Comment:** This paper reports the discovery of an extremely metal-poor galaxy at z=3.654 using JWST spectroscopy. It discusses chemical enrichment and star formation in young galaxies, but does not focus on resolved star formation histories from CMDs, nor on dwarf satellites or near-field cosmology. The galaxy is low-mass, but the work is more about high-redshift galaxy formation.
...
## 17. [Direct Abundance Maps and Radial Metallicity Gradients of two Galaxies at z~4-5 in the GARDEN Survey](https://arxiv.org/abs/2601.17148) <a id="link17"></a>
...
**Comment:** Presents spatially resolved direct abundance maps and metallicity gradients in two high-redshift galaxies. While it deals with chemical enrichment and metallicity gradients, the focus is on massive galaxies at z~4-5, not dwarf galaxies or near-field cosmology. Marginal relevance for resolved star formation histories and chemical evolution, but not a close match.
...
## 18. [JOYS: JWST MIRI/MRS spectra of the inner 500 au region of the L1527 IRS bipolar outflow](https://arxiv.org/abs/2601.17820) <a id="link18"></a>
...
**Comment:** JWST MIRI/MRS study of the L1527 IRS bipolar outflow, focusing on protostellar outflows and jet-launching mechanisms. Relevant to star formation driven outflows, but the context is a protostar, not a galaxy. Marginal relevance for outflow physics.
...
## 19. [Constraining Reionization Morphology and Source Properties with 21cm-Galaxy Cross-Correlation Surveys](https://arxiv.org/abs/2601.18627) <a id="link19"></a>
...
**Comment:** This paper uses simulations to study 21cm-galaxy cross-correlations to constrain reionization morphology and ionizing source properties. While it is a numerical simulation and discusses star formation efficiency and escape fraction, the focus is on high-redshift reionization and not on resolved star formation histories or near-field cosmology. Relevance is borderline due to the connection to galaxy formation physics.
...
## 21. [Evidence of Gas Depletion in Quasars with Moderate Radio Emission](https://arxiv.org/abs/2601.17951) <a id="link21"></a>
...
**Comment:** This paper investigates gas depletion and outflows in quasars with moderate radio emission, focusing on AGN feedback and its impact on cold gas and star formation. While it discusses outflows and quenching, the focus is on quasars (massive galaxies) rather than dwarf galaxies, so relevance is borderline.
...
## 22. [Baryonification III: An accurate analytical model for the dispersion measure probability density function of fast radio bursts](https://arxiv.org/abs/2601.18784) <a id="link22"></a>
...
**Comment:** Develops an analytical model for the dispersion measure PDF of fast radio bursts using baryonification, connecting gas density profiles to DM statistics. While it discusses baryonic feedback and gas profiles, the focus is on cosmological scales and FRBs, not on galaxy-scale simulations or the CGM of dwarf galaxies.
...
## 23. [First Observational Evidence for Split Infall Flow of Cosmic Filaments into Clusters](https://arxiv.org/abs/2601.18434) <a id="link23"></a>
...
**Comment:** Observational study of velocity fields in cosmic filaments connecting galaxy clusters, using SDSS data. While it discusses large-scale structure and galaxy flows, the focus is on filaments and clusters, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 24. [Ancient relic moderately metal-rich bulge cluster Tonantzintla 2](https://arxiv.org/abs/2601.18567) <a id="link24"></a>
...
**Comment:** Detailed characterization of Tonantzintla 2, a moderately metal-rich globular cluster in the Galactic bulge. While it provides constraints on the early formation of the Milky Way, the focus is on the bulge and globular clusters, not on dwarf satellite galaxies or near-field cosmology as defined by the criteria.
...
## 25. [Three-point intrinsic alignments of galaxies and haloes in the FLAMINGO simulations](https://arxiv.org/abs/2601.17914) <a id="link25"></a>
...
**Comment:** Analyzes three-point intrinsic alignments of galaxies and haloes in the FLAMINGO simulations. While it uses galaxy simulations, the focus is on intrinsic alignments and large halo masses (>10^13 Msun), not on dwarf galaxies or the other core topics.
...
## 26. [New parameters for star cluster dynamics: observational results](https://arxiv.org/abs/2601.18679) <a id="link26"></a>
...
**Comment:** Presents new empirical parameters for tracing dynamical evolution in globular clusters, based on HST observations. While it deals with stellar systems, the focus is on globular clusters rather than dwarf galaxies or galaxy evolution.
...
## 27. [Learning at the Edge: Tailed-Uniform Sampling for Robust Simulation-Based Inference](https://arxiv.org/abs/2601.17120) <a id="link27"></a>
...
**Comment:** This paper introduces a new proposal distribution for simulation-based inference, with applications to cosmological parameter inference from the matter power spectrum. While it is a methodological improvement for cosmological inference, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 28. [2MASS Re-processing I: The Search for Faint Objects](https://arxiv.org/abs/2601.17831) <a id="link28"></a>
...
**Comment:** Presents a pipeline for reprocessing 2MASS data to detect faint point sources. While it may aid studies of Galactic structure and low-luminosity objects, it does not directly address any of the core criteria such as near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 29. [Photoexcitation spectroscopy of highly charged ions for application to astronomy using a compact electron beam ion trap (EBIT) at the synchrotron radiation facility SPring-8](https://arxiv.org/abs/2601.18311) <a id="link29"></a>
...
**Comment:** This work focuses on laboratory plasma spectroscopy to improve atomic data for X-ray spectral modeling of astrophysical objects. While it is important for stellar atmosphere models and spectral analysis, it does not present new stellar models or evolutionary tracks, nor does it directly address the core topics.
...
## 30. [Forecasting the E_G measurements from the photometric and spectroscopic surveys of Chinese Space Station Survey Telescope (CSST)](https://arxiv.org/abs/2601.17874) <a id="link30"></a>
...
**Comment:** Forecasts for the E_G statistic using mock galaxy samples from the CSST, focusing on testing gravity and cosmic acceleration. While it deals with large-scale structure and cosmological tests, it does not address near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 31. [Deciphering the Remnants of Core-Collapse Supernovae: Reconstructing Progenitor Star Properties and Explosion Mechanisms](https://arxiv.org/abs/2601.17499) <a id="link31"></a>
...
**Comment:** High-resolution simulations of core-collapse supernovae tailored to Cassiopeia A, focusing on ejecta substructure and explosion mechanisms. This is a supernova remnant modeling paper, not directly related to the core topics (no focus on galaxy evolution, dwarf galaxies, or star formation histories).
...
## 32. [AI-based separation of turbulence from coherent background flows in decaying hydrodynamic turbulence](https://arxiv.org/abs/2601.18163) <a id="link32"></a>
...
**Comment:** Applies AI-based methods to separate turbulence from coherent flows in hydrodynamic simulations, with implications for astrophysical and cosmological applications. However, the focus is on turbulence analysis methodology, not on galaxy simulations or any of the core topics.
...
## 33. [Escaping ionizing photons from massive spiral galaxies at $z\sim 1$](https://arxiv.org/abs/2601.17746) <a id="link33"></a>
...
**Comment:** Reports detection of Lyman continuum photons from massive spiral galaxies at z~1. The focus is on high-mass galaxies and LyC escape, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 34. [Closure models for the feedback of energetic particles on plasma turbulence](https://arxiv.org/abs/2601.18649) <a id="link34"></a>
...
**Comment:** Develops a new closure model for feedback of energetic particles on plasma turbulence, with potential applications to cosmic ray acceleration. While it discusses plasma processes relevant to cosmic rays, it does not directly address galaxy simulations, star formation, or near-field cosmology.
...
## 35. [Spectral Evolution and Current Sheet Analysis as Probes of Reconnection-Mediated Decay in Magnetically Dominated Turbulence](https://arxiv.org/abs/2601.17955) <a id="link35"></a>
...
**Comment:** Examines reconnection-mediated decay in magnetically dominated turbulence using simulations. While it involves numerical simulations, the focus is on plasma turbulence and reconnection, not on galaxy simulations or the other core topics.
...
## 36. [A Novel Lensed Point Source Modeling Pipeline using GIGA-Lens with Application to SN Zwicky and SN iPTF16geu](https://arxiv.org/abs/2601.18787) <a id="link36"></a>
...
**Comment:** This paper introduces a modeling pipeline for strongly lensed point sources and applies it to lensed SNe Ia. While it is relevant to cosmology and lensing, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 37. [The r-Process: History, Required Conditions, Astrophysical Sites, and Observations](https://arxiv.org/abs/2601.17246) <a id="link37"></a>
...
**Comment:** This is a review of the r-process, its astrophysical sites, and observations, with some discussion of low-metallicity stars and Galactic evolution. While it touches on near-field cosmology and chemical evolution, it does not focus on dwarf galaxies, resolved star formation histories, or satellite systems. Borderline relevance for near-field cosmology.
...
## 38. [Thermodynamic Characteristics of a Fermi Gas with an Invariant Energy Scale and its Astrophysical Implications](https://arxiv.org/abs/2601.17004) <a id="link38"></a>
...
**Comment:** Focuses on thermodynamics of Fermi gases with modified dispersion relations and applies results to white dwarfs and neutron stars. While it discusses compact objects, the main focus is on the equation of state and implications for modified relativity, not on near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 39. [The ALMA-ATOMS survey: Methanol emission in a large sample of hot molecular cores](https://arxiv.org/abs/2601.18628) <a id="link39"></a>
...
**Comment:** ALMA study of methanol emission in hot molecular cores in massive star-forming regions. While it relates to star formation, the focus is on massive star-forming cores and chemical complexity, not on resolved star formation histories of galaxies or dwarf galaxy processes.
...
## 40. [Chemical study of two starless cores in the B213/L1495 filament](https://arxiv.org/abs/2601.18259) <a id="link40"></a>
...
**Comment:** Chemical study of two starless cores in the Taurus Molecular Cloud. Focuses on pre-stellar core chemistry and early star formation, but does not address resolved star formation histories of galaxies or dwarf galaxy processes.
...
## 41. [Galactic Large-scale Filaments Resident in Asymmetric Environments: Clues from Cross-filament Profiles of Density and Temperature](https://arxiv.org/abs/2601.18485) <a id="link41"></a>
...
**Comment:** Focuses on large-scale filaments in the Galactic ISM, analyzing density and temperature profiles. While it discusses ISM structure and evolution, it does not address dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The topic is tangential to the core criteria.
...
## 44. [Hubble Tension as an Effect of Horizon Entanglement Nonequilibrium](https://arxiv.org/abs/2601.17938) <a id="link44"></a>
...
**Comment:** Proposes a cosmological mechanism for the Hubble tension based on horizon entanglement nonequilibrium. The focus is on cosmological parameters and expansion history, not on galaxy evolution, dwarf galaxies, or the other core topics.
...
## 45. [The Supermassive Black Hole in the Nearby Spiral Galaxy M81: A Robust Mass from JWST/NIRSpec Stellar Dynamics](https://arxiv.org/abs/2601.17439) <a id="link45"></a>
...
**Comment:** This paper presents a robust measurement of the supermassive black hole mass in the spiral galaxy M81 using JWST/NIRSpec stellar dynamics. The focus is on SMBH-galaxy scaling relations in a massive spiral, which is outside the scope of near-field cosmology and the core topics.
...
## 46. [JWST Spectroscopic Census of ALMA Faint Submillimeter Galaxies in the Hubble Ultra Deep Field](https://arxiv.org/abs/2601.18149) <a id="link46"></a>

**ArXiv ID:** 2601.18149

**Authors:** Tomokazu Kiyota, Masami Ouchi, Daisuke Iono, Seiji Fujimoto, Kotaro Kohno, Yoshihiro Ueda, Kimihiko Nakajima, Moka Nishigaki, Hidenobu Yajima

**Abstract:** We present a JWST/NIRSpec rest-frame optical spectroscopic census of ALMA 1-mm continuum sources in the Hubble Ultra Deep Field (UDF) identified by the deep ALMA UDF and ASPECS programs. Our sample is composed of the ALMA flux-limited ($S_{1\,\mathrm{mm}}\gtrsim 0.1\,\mathrm{mJy}$) sources observed with medium-resolution NIRSpec spectroscopy from JADES and SMILES, 16 faint submillimeter galaxies (SMGs) at spectroscopic redshifts of $z\sim 1$-$4$. These SMGs show bright longer-wavelength optical lines (H$\alpha$, [N II]$\lambda\lambda6548,6583$, and [S II]$\lambda\lambda6717,6731$) and faint shorter-wavelength optical lines (H$\beta$ and [O III]$\lambda\lambda4959,5007$) with a large nebular attenuation, $E(B-V)\sim0.3$-$1.8$. We test the SMGs using BPT diagnostics and Chandra X-ray fluxes, and find that most SMGs are classified as AGNs; the AGN fraction is $\sim80\%$ for the SMGs at $M_*>10^{10.5} M_\odot$. We find only one SMG ($10^{10.5} M_\odot$), these results indicate that the SMGs are mostly not special, but typical massive star-forming galaxies at high redshift.

**Comment:** JWST spectroscopic census of faint submillimeter galaxies in the UDF, focusing on AGN fraction and properties of massive star-forming galaxies at high redshift. No direct connection to dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 47. [Explaining the thermal emission of old neutron stars with rotochemical heating and magnetized superconducting protons](https://arxiv.org/abs/2601.18725) <a id="link47"></a>
...
**Comment:** Focuses on neutron star thermal emission and internal heating mechanisms, specifically rotochemical heating and superconducting protons. This is a stellar interiors/compact object physics paper, not related to any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 48. [XFit: Global Optimization and Degeneracy Mapping in X-ray Spectral Modeling](https://arxiv.org/abs/2601.18542) <a id="link48"></a>
...
**Comment:** Introduces XFit, a global optimization method for X-ray spectral modeling, demonstrated on supernova remnants. While useful for spectral fitting, it does not address any of the core topics (galaxy evolution, dwarf galaxies, star formation histories, etc.).
...
## 49. [Galactic Dust Polarization in Turbulent Multiphase ISM: On the Origin of the $EE/BB$ Asymmetry](https://arxiv.org/abs/2601.17255) <a id="link49"></a>
...
**Comment:** Uses MHD simulations to study Galactic dust polarization and its impact on CMB foregrounds. The focus is on ISM turbulence and dust, not on dwarf galaxies, star formation histories, or galaxy simulations relevant to the criteria.
...
## 50. [On the hadronic origin of the very high energy $\gamma$-ray emission surrounding the young massive stellar cluster Westerlund 1](https://arxiv.org/abs/2601.17324) <a id="link50"></a>
...
**Comment:** Studies the hadronic origin of very high energy gamma-ray emission around the young massive stellar cluster Westerlund 1. Focus is on cosmic ray acceleration and gamma-ray emission, not on galaxy evolution, dwarf galaxies, or the other core topics.
...
## 51. [Radio streaks in the Lighthouse Nebula discovered with MeerKAT -- Particles escaping from the tail and illuminating the ambient magnetic field](https://arxiv.org/abs/2601.18596) <a id="link51"></a>
...
**Comment:** MeerKAT radio study of the Lighthouse Nebula, focusing on pulsar wind nebulae and particle escape into the ISM. While it discusses ISM and cosmic ray transport, it does not address galaxy evolution, dwarf galaxies, or the other core topics.
...
## 52. [Neutrino opacities in magnetic fields for binary neutron star merger simulations](https://arxiv.org/abs/2601.18051) <a id="link52"></a>
...
**Comment:** The paper studies neutrino opacities in magnetic fields for neutron star merger simulations. It is focused on compact object physics and not on galaxy simulations, star formation, or near-field cosmology.
...
## 53. [Resolution Dependence in Magnetohydrodynamic Simulations of Neutrino-Driven Core-Collapse Supernovae](https://arxiv.org/abs/2601.18357) <a id="link53"></a>
...
**Comment:** The paper investigates resolution dependence in MHD simulations of core-collapse supernovae, focusing on explosion dynamics and compact remnant properties. While it is a numerical simulation, it does not focus on galaxies or any of the core topics.
...
## 54. [In-depth analysis of bar formation mechanisms of disk galaxies in halos of different concentrations](https://arxiv.org/abs/2601.18161) <a id="link54"></a>
...
**Comment:** This paper uses N-body simulations to study bar formation in disk galaxies with different halo concentrations. The focus is on bar formation and disk galaxies, which is specifically listed as irrelevant in the criteria.
...
## 55. [Decameter-sized Earth Impactors -- II: A Bayesian Inference Approach to Meteoroid Ablation Modeling](https://arxiv.org/abs/2601.14371) <a id="link55"></a>
...
**Comment:** This paper presents a Bayesian inference approach to modeling meteoroid ablation and infers physical properties of Earth impactors. The topic is planetary science and meteoroid properties, not related to near-field cosmology, galaxy evolution, or any of the core criteria.
...
## 56. [Exploring the role of accretion shocks in galaxy clusters as sources of ultrahigh-energy cosmic rays](https://arxiv.org/abs/2601.18411) <a id="link56"></a>
...
**Comment:** This paper explores accretion shocks in galaxy clusters as sources of ultrahigh-energy cosmic rays. The focus is on massive galaxy clusters and cosmic ray acceleration, not on dwarf galaxies, near-field cosmology, or the core topics.
...
## 57. [Neuro-Parametric Spectral Classification of Black Hole and Neutron Star X-ray Binary Systems](https://arxiv.org/abs/2601.18139) <a id="link57"></a>
...
**Comment:** This paper uses neural networks to classify black hole and neutron star X-ray binaries based on their X-ray spectra. It does not address any of the core topics such as stellar models, galaxy simulations, or near-field cosmology.
...
## 59. [Ultra-fast growth of primordial black holes through radiative absorption](https://arxiv.org/abs/2601.18708) <a id="link59"></a>
...
**Comment:** This paper discusses primordial black holes and their growth in the early universe, with implications for the origin of black holes of various masses. It does not address galaxies, star formation histories, or the other core topics. Irrelevant to the specified criteria.
...
## 60. [Learned harmonic mean estimation of the marginal likelihood for multimodal posteriors with flow matching](https://arxiv.org/abs/2601.18683) <a id="link60"></a>
...
**Comment:** Presents a new method for Bayesian evidence estimation using flow matching for multimodal posteriors. This is a statistical/methodological paper with no direct connection to the core astrophysical topics.
...
## 61. [Inferring photospheric horizontal flows from multiple observations with SUVEL models](https://arxiv.org/abs/2601.18183) <a id="link61"></a>
...
**Comment:** This paper presents a new machine learning method (SUVEL) for inferring photospheric horizontal flows from solar observations. The focus is on solar physics and velocity field estimation, not on galaxies or the core topics.
...
## 62. [Higher-Order Gravitational Models: A Tutorial on Spherical Harmonics and the Newtonian Model](https://arxiv.org/abs/2601.17628) <a id="link62"></a>
...
**Comment:** Tutorial on spherical harmonics and Newtonian gravity models for celestial bodies, with applications to spacecraft orbits. While relevant to gravitational modeling, it does not address galaxy-scale simulations or any of the core topics.
...
## 64. [The Most Luminous H$\beta$ Reverberation Mapping of E1821+643 Indicates the Lower Boundary of the Radius-Luminosity Relation](https://arxiv.org/abs/2601.18269) <a id="link64"></a>
...
**Comment:** Reverberation mapping of a luminous quasar to probe the radius-luminosity relation and BLR structure. Focus is on AGN physics and SMBH mass estimates, not on any of the core criteria.
...
## 65. [Disk-jet-wind coupling from stellar mass to supermassive black holes](https://arxiv.org/abs/2601.18607) <a id="link65"></a>
...
**Comment:** Reviews disk-jet-wind coupling in black holes from stellar to supermassive scales. The focus is on accretion physics and black hole winds/jets, not on star formation driven outflows in galaxies or the other core criteria.
...
## 66. [Role of the symmetry energy on hybrid stars](https://arxiv.org/abs/2601.18752) <a id="link66"></a>
...
**Comment:** This paper analyzes the impact of symmetry energy on hybrid stars and the interpretation of gravitational wave events. It is focused on compact star physics and does not address galaxy evolution, star formation, or near-field cosmology.
...
## 67. [The rest ultraviolet to infrared spectral energy distributions of heavily reddened quasars are "V-shaped" and hot-dust poor](https://arxiv.org/abs/2601.17416) <a id="link67"></a>
...
**Comment:** This paper analyzes the spectral energy distributions of heavily reddened quasars, focusing on AGN feedback and dust properties. The work is centered on quasars and AGN, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 68. [Revisiting a Quasar Microlensing Event Towards AGN~J1249+3449](https://arxiv.org/abs/2601.18262) <a id="link68"></a>
...
**Comment:** This paper revisits a quasar microlensing event towards an AGN, analyzing the light curve and lensing models. The focus is on AGN and microlensing, not on galaxy evolution, dwarf galaxies, or the core topics.
...
## 69. [Energy shift of Fe-K fluorescence lines due to low ionization demonstrated with XRISM in Centaurus X-3](https://arxiv.org/abs/2601.17792) <a id="link69"></a>
...
**Comment:** This paper discusses the energy shift of Fe-K fluorescence lines due to ionization in X-ray binaries, focusing on atomic physics and X-ray spectroscopy. It does not match any of the core criteria such as stellar models, galaxy simulations, or near-field cosmology.
...
## 70. [Primordial black holes induced stochastic axion-photon oscillations in primordial magnetic field](https://arxiv.org/abs/2208.04605) <a id="link70"></a>
...
**Comment:** This paper discusses primordial black holes and axion-photon oscillations in the early universe, with implications for cosmic backgrounds. While it touches on cosmology, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 71. [SiGMa-Net II: Distinguishing Binary Black Holes from Glitches](https://arxiv.org/abs/2601.17882) <a id="link71"></a>
...
**Comment:** Develops a neural network method to distinguish binary black hole signals from glitches in gravitational wave data. Focus is on GW data analysis, not on galaxy simulations or any of the core topics.
...
## 72. [Impact of Rastall gravity on hydrostatic mass of galaxy clusters](https://arxiv.org/abs/2601.18652) <a id="link72"></a>
...
**Comment:** Examines hydrostatic mass bias in galaxy clusters under Rastall gravity. Focus is on massive galaxy clusters, not dwarf galaxies, satellites, or near-field cosmology.
...
## 73. [Effect of different Non-Gravitational accelerations on the trajectory of Interstellar Comet 3I/ATLAS](https://arxiv.org/abs/2601.17083) <a id="link73"></a>
...
**Comment:** This research note discusses the trajectory of an interstellar comet and the effect of non-gravitational accelerations. The focus is on comet dynamics, not on galaxies, star formation, or near-field cosmology.
...
## 74. [Different Transient Phenomena at the Edges of Traveling Foreshocks](https://arxiv.org/abs/2601.18553) <a id="link74"></a>
...
**Comment:** Discusses transient phenomena at the edges of traveling foreshocks in the solar wind, using spacecraft data. This is a heliophysics/space plasma paper, not related to any of the core topics.
...
## 75. [The growing family of gamma-ray narrow-line Seyfert 1 galaxies](https://arxiv.org/abs/2601.18635) <a id="link75"></a>
...
**Comment:** Statistical study of gamma-ray narrow-line Seyfert 1 galaxies and other AGN types. The focus is on AGN populations, not on dwarf galaxies, star formation, or galaxy simulations.
...
## 76. [Assessing astrophysical foreground subtraction in DECIGO using compact binary populations inferred from the first part of the LIGO-Virgo-KAGRA's fourth observation run](https://arxiv.org/abs/2601.18378) <a id="link76"></a>
...
**Comment:** Assesses foreground subtraction for gravitational wave backgrounds in DECIGO using compact binary populations. The focus is on gravitational wave data analysis, not on galaxy simulations or any of the core topics.
...
## 77. [Multi-epoch VLBI observations of the blazar 3C 66A: Spatial twisting and temporal oscillation of the parsec-scale jet](https://arxiv.org/abs/2601.18551) <a id="link77"></a>
...
**Comment:** VLBI study of blazar 3C 66A jet kinematics, focusing on jet morphology and possible SMBH binary system. The paper is centered on AGN jets and SMBH, which are explicitly outside the relevant criteria.
...
## 78. [Single-Pulse Correlations in PSR B0329+54: Implications for Radio Emission Zones](https://arxiv.org/abs/2601.17299) <a id="link78"></a>
...
**Comment:** Single-pulse radio study of PSR B0329+54, focusing on pulsar emission mechanisms. No connection to galaxy evolution, dwarf galaxies, star formation histories, quenching, or simulations.
...
## 79. [Tracing the Heliospheric Magnetic Field via Anisotropic Radio-Wave Scattering](https://arxiv.org/abs/2503.22553) <a id="link79"></a>
...
**Comment:** The paper traces the heliospheric magnetic field using anisotropic radio-wave scattering from solar radio bursts. It is focused on solar and heliospheric physics, not on galaxies, star formation, or near-field cosmology.
...
## 80. [tilepy: A Flexible Open-Source Scheduling Engine for Time-Domain and Multi-Messenger Astronomy](https://arxiv.org/abs/2601.18668) <a id="link80"></a>
...
**Comment:** This is a software/methodology paper presenting a scheduling engine for time-domain and multi-messenger astronomy. It does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 81. [High-Resolution Solar X-ray Spectroscopy from Archived Solar Maximum Mission Data](https://arxiv.org/abs/2601.17491) <a id="link81"></a>
...
**Comment:** This paper analyzes high-resolution solar X-ray spectra, focusing on atomic data and plasma diagnostics in the Sun. It does not address galaxies, star formation, or the other core topics. Irrelevant to the specified criteria.
...
## 83. [The optical photometric and spectroscopic periodicities of the cataclysmic variable SRGt 062340.2-265751](https://arxiv.org/abs/2601.17477) <a id="link83"></a>
...
**Comment:** This paper presents observations and analysis of a cataclysmic variable, focusing on its periodicities and classification. It is not relevant to any of the core topics.
...
## 84. [Autonomous Mars Rover Module for Soil Sampling and Life Component Analysis](https://arxiv.org/abs/2601.17158) <a id="link84"></a>
...
**Comment:** This paper presents a proof-of-concept for autonomous life detection on Mars, focusing on planetary exploration and astrobiology. It is unrelated to the core topics.
...
## 85. [STIS Cycle 30 Calibration Programs](https://arxiv.org/abs/2601.17159) <a id="link85"></a>
...
**Comment:** This paper describes calibration programs for the STIS instrument on HST, focusing on instrument performance and reference files. It does not address any of the core topics.
...
## 86. [Sigmoid Formation, Filament Destabilization, and Initiation of Weak Flare by Tether-Cutting Reconnection](https://arxiv.org/abs/2601.17771) <a id="link86"></a>
...
**Comment:** This paper focuses on solar flare and filament eruption mechanisms, which are not related to galaxies, star formation, or the other core topics. Irrelevant to the specified criteria.
...
## 87. [Joint constraint on the propagation origin of the cosmic-ray spectral knee from energy spectrum and anisotropy observations](https://arxiv.org/abs/2601.17851) <a id="link87"></a>
...
**Comment:** This paper investigates the origin of the cosmic-ray spectral knee using energy spectrum and anisotropy data. It does not address galaxy evolution, star formation, or any of the specified criteria.
...
## 88. [Gas Kinematics and Cosmic-Ray Acceleration in the Gamma-ray SNRs W41 and G22.7-0.2](https://arxiv.org/abs/2601.18040) <a id="link88"></a>
...
**Comment:** Studies gas kinematics and cosmic-ray acceleration in two supernova remnants. No connection to galaxy evolution, star formation, or any of the core criteria.
...
## 89. [AstroTimer: Rethinking Non-Access Stratum Timers in LEO Constellations](https://arxiv.org/abs/2601.17195) <a id="link89"></a>
...
**Comment:** This paper focuses on adaptive timer frameworks for LEO satellite constellations in 5G/6G networks. It is unrelated to any of the core astrophysics or galaxy evolution criteria.
...
## 90. [150 years of ground-based solar instrumentation at Meudon observatory (1876-2026)](https://arxiv.org/abs/2601.18227) <a id="link90"></a>
...
**Comment:** Historical review of solar instrumentation at Meudon Observatory. No connection to galaxy evolution, star formation, or any of the core criteria.
...
## 91. [Gravitational wave detectors from an experimental perspective](https://arxiv.org/abs/2601.18501) <a id="link91"></a>
...
**Comment:** This is a review chapter on gravitational wave detectors, focusing on experimental principles and noise sources. It does not address any of the core topics such as galaxy simulations, star formation, or near-field cosmology.
