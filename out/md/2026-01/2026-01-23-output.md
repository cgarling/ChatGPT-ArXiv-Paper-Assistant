...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 45644    | 7308         | 52952   |
| **Cost**             | $0.09    | $0.06        | $0.15   |

Total arXiv papers: 177
...
1. [Hierarchical bayesian inference: constraining population distribution of dark matter halo shapes via stellar streams](#user-content-link1)
**Authors:** David Chemaly, Elisabeth Sola, Vasily Belokurov, Sergey Kosposov, GyuChul Meyong, HanYuan Zhang, Denis Erkal

2. [The role of gas stripping in the quenching of satellite galaxies using SHARK v2.0](#user-content-link2)
**Authors:** Megan K. Oxland, Mat\'ias Bravo, Laura C. Parker, Claudia del P. Lagos

3. [HE0144-4657: A Carbon-Enhanced Ultra Metal-Poor Star ([Fe/H] ~ -4.1) from the Helmi Stream Disrupted Dwarf Galaxy](#user-content-link3)
**Authors:** Vinicius M. Placco, Guilherme Limberg, Catherine R. Kennedy, Norbert Christlieb

4. [The age sequence of young clusters in Perseus: Estimating ages from mass distributions](#user-content-link4)
**Authors:** Tatiana Pavlidou (Limassol), Aleks Scholz (St Andrews), Koraljka Muzic (Lisbon)

5. [A general spectral solver for the axisymmetric Jeans equations: fast galaxy modelling with arbitrary anisotropy](#user-content-link5)
**Authors:** Michele Cappellari (University of Oxford)

6. [K-DRIFT Science Theme: Galactic Cirrus Clouds and Circumgalactic Medium](#user-content-link6)
**Authors:** Kwang-il Seon, Jaehyun Lee, Jongwan Ko, Woowon Byun, Jaewon Yoo, Kyungwon Chun, Sang-Hyun Chun, Sungryong Hong, Jae-Woo Kim, Hong Soo Park, Jihye Shin

7. [Enhancing Thermal Sunyaev-Zel'dovich Analyses with Digital Twins of the Local Universe](#user-content-link7)
**Authors:** Richard Stiskalek, Harry Desmond

8. [JADES: Discovery of Large Reservoirs of Small Dust Grains in the Circumgalactic Medium of Massive Galaxies at $z\sim3.5$ through Deep JWST/NIRCam Imaging and Grism Spectroscopy](#user-content-link8)
...
9. [Clump-like Structures in High-Redshift Galaxies: Mass Scaling and Radial Trends from JADES](#user-content-link9)
...
10. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometrically Selected Galaxy Candidates at z > 8](#user-content-link10)
...
11. [Multi-band Reconstruction of Sixteen Gravitational Lens Systems using PISCO data](#user-content-link11)
...
12. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: MIRI Coordinated Parallels in GOODS-S and GOODS-N](#user-content-link12)
...
13. [There Is More to Outshining: 2D Dust Effects on Stellar Mass Estimates at $3 \leq z < 9$ with JWST in the JADES Field](#user-content-link13)
**Authors:** M. Hamed, P. G. P\'erez-Gonz\'alez, M. Annunziatella, L. Colina, I. Shivaei, M. Perna, A. J. Bunker, K. Ma{\l}ek, S. Arribas, J. \'Alvarez-M\'arquez, C. N. A. Willmer, H. \"Ubler, R. Bhatawdekar, J. Chevallard, E. Curtis-Lake, Z. Ji, P. Rinaldi, C. C. Williams

14. [Intrinsic alignments in the FLAMINGO simulations with two-point statistics](#user-content-link14)
**Authors:** A. Herle, N. E. Chisari, H. Hoekstra, D. Navarro-Giron\'es, M. Schaller, J. Schaye

15. [Supernova interactions with aspherical circumstellar material I: calculations of light curves, AB magnitudes, spectra, and polarisation](#user-content-link15)
**Authors:** Petr Kurf\"urst, Georgi Bless, Jakub Fi\v{s}\'ak, Filip Holoubek, Ji\v{r}\'i Krti\v{c}ka, Brankica Kub\'atov\'a, Ji\v{r}\'i Kub\'at, Michal Zaja\v{c}ek

16. [JADES: Evolution of nitrogen abundances in star-forming galaxies from z ~ 1.5-7](#user-content-link16)
...
17. [Spatially resolved stellar-to-total dynamical mass relation: Radial variations, gradients and profiles of galaxy stellar populations](#user-content-link17)
**Authors:** L. Scholz-Diaz, A. R. Gallazzi, S. Zibetti, D. Mattolini

18. [The FarView Low Frequency Radio Array on the Moon's Far Side: Science and Array Architecture](#user-content-link18)
...
19. [OmniSpectra: A Unified Foundation Model for Native Resolution Astronomical Spectra](#user-content-link19)
**Authors:** Md Khairul Islam, Judy Fox

20. [What factors shape the radio luminosity of star-forming galaxies? A new calibration from LoTSS-DR2](#user-content-link20)
**Authors:** Shravya Shenoy, Daniel J. B. Smith, Sarah K. Biddle, G\"ulay G\"urkan, Martin J. Hardcastle, Marina I. Arnaudova, Soumyadeep Das, Luke R. Holden, Gaoxiang Jin, Leah K. Morabito, Huub J. A. R\"ottgering

21. [JADES: A Prominent Galaxy Overdensity Candidate within the First 500 Myr](#user-content-link21)
...
22. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Catalogs of inferred morphological properties of galaxies from JWST/NIRCam imaging in GOODS-N and GOODS-S](#user-content-link22)
**Authors:** Courtney Carreira, Brant E. Robertson, A. Lola Danhaive, Zhiyuan Ji, Marcia Rieke, Sandro Tacchella, Natalia C. Villanueva, Christopher N. A. Willmer, Zihao Wu, Yongda Zhu, William M. Baker, Andrew J. Bunker, Alex J. Cameron, Jacopo Chevallard, Emma Curtis-Lake, Qiao Duan, Daniel J. Eisenstein, Kevin Hainline, Ryan Hausen, Benjamin D. Johnson, Roberto Maiolino, Petra Mengistu, D\'avid Pusk\'as, Pierluigi Rinaldi, Yang Sun, James A. A. Trussler, Hannah \"Ubler, Anavi Uppal, Christina C. Williams

23. [Fuzzy dark matter soliton core hosting a supermassive black hole as a dense low-mass perturber in strong gravitational lensing](#user-content-link23)
**Authors:** Masamune Oguri, Naoi Kubo

24. [Undermassive Hosts of $z = 4-6 $ AGN from JWST/NIRCam Image Decomposition with CONGRESS, FRESCO, and JADES](#user-content-link24)
**Authors:** Zheng Ma, Eichi Egami, Yongda Zhu, Fengwu Sun, Jianwei Lyu, Junyu Zhang, Christopher N. A. Willmer, Andrew J. Bunker, Stefano Carniani, Emma Curtis-Lake, Ryan Hausen, Xihan Ji, Zhiyuan Ji, Ignas Juod\v{z}balis, Roberto Maiolino, George H. Rieke, Pierluigi Rinaldi, Yang Sun, Sandro Tacchella, Hannah \"Ubler, Christina C. Williams

25. [Reanalyzing DESI DR1: 4. Percent-Level Cosmological Constraints from Combined Probes and Robust Evidence for the Normal Neutrino Mass Hierarchy](#user-content-link25)
**Authors:** Mikhail M. Ivanov, James M. Sullivan, Shi-Fan Chen, Anton Chudaykin, Mark Maus, Oliver H. E. Philcox

26. [Solar twins in Gaia DR3 GSP-Spec I. Building a large catalog of Solar twins with ages](#user-content-link26)
**Authors:** Daisuke Taniguchi, Patrick de Laverny, Alejandra Recio-Blanco, Takuji Tsujimoto, Pedro A. Palicio

27. [An Investigation of 5-year Simultaneous X-ray and Radio Light Curves of the Dwarf Seyfert Galaxy UGC 6728](#user-content-link27)
**Authors:** Krista Lynne Smith, Macon Magno, Michael Koss

28. [A Stratification in Magnetic Field Structures: The Radio Outflow in NGC 4151](#user-content-link28)
**Authors:** Salmoli Ghosh (NCRA-TIFR), P. Kharb (NCRA-TIFR), E. Costantini (SRON, API-UvA, The Netherlands), J. Gallimore (Bucknell University), D. Williams-Baldwin (JBCA, The University of Manchester), M. Mehdipour (University of Michigan)

29. [The Back-in-time Void Finder: dynamical identification of cosmic voids through optimal transport reconstruction](#user-content-link29)
**Authors:** Simone Sartori, Sofia Contarini, Elena Sarpa, Giulia Degni, Federico Marulli, Stephanie Escoffier, Lauro Moscardini

30. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: NIRCam Imaging in GOODS-S and GOODS-N](#user-content-link30)
**Authors:** Benjamin D. Johnson, Brant E. Robertson, Daniel J. Eisenstein, Sandro Tacchella, D\'avid Pusk\'as, Qiao Duan, Zihao Wu, Kevin Hainline, Marcia Rieke, Chris Willott, Christopher N. A. Willmer, James A. A. Trussler, Stacey Alberts, Santiago Arribas, William M. Baker, Andrew J. Bunker, Alex J. Cameron, Stefano Carniani, Courtney Carreira, Phillip A. Cargile, Emma Curtis-Lake, Eiichi Egami, Ryan Hausen, Jakob M. Helton, Zhiyuan Ji, Roberto Maiolino, Pablo G. P\'erez-Gonz\'alez, Pierluigi Rinaldi, Fengwu Sun, Yang Sun, Natalia C. Villanueva, Christina C. Williams, Yongda Zhu

31. [A multi-wavelength approach of AGN feedback in LINERs: The case of NGC 4438](#user-content-link31)
**Authors:** M. Puig-Subir\`a, J. Mold\'on, I. M\'arquez, J. Masegosa, O. Gonz\'alez-Mart\'in, L. Hermosa Mu\~noz, S. Cazzoli, D. Williams-Baldwin

32. [An Analysis of AGN Feedback in the Compact Galaxy Group Stephan's Quintet](#user-content-link32)
**Authors:** Maura Kathleen Shea (Department of Physics and Astronomy, Georgia State University, Atlanta, GA, USA), D. Michael Crenshaw (Department of Physics and Astronomy, Georgia State University, Atlanta, GA, USA), Travis C. Fischer (AURA for ESA, Space Telescope Science Institute, Baltimore, MD, USA), Mitchell Revalski (Space Telescope Science Institute, Baltimore, MD, USA), Julia Falcone (Department of Physics and Astronomy, Georgia State University, Atlanta, GA, USA), Beena Meena (Space Telescope Science Institute, Baltimore, MD, USA), Zo Chapman (College of Computer Science, Georgia Institute of Technology, Atlanta, GA, USA), Jacob Tutterow (Kapteyn Astronomical Institute, University of Groningen, AV Groningen, the Netherlands), Madeline Davis (Department of Physics and Astronomy, Georgia State University, Atlanta, GA, USA), Kesha Patel (Department of Physics and Astronomy, Tufts University, Medford, MA, USA)

33. [Gaia20fnr: A binary-lens microlensing event with full orbital motion revealed by four space telescopes](#user-content-link33)
...
34. [Radio-Interferometric Image Reconstruction with Denoising Diffusion Restoration Models](#user-content-link34)
**Authors:** Michel Morales, Emma Tolley, Remi Poitevineau

35. [Nucleosynthesis in Type Ia Supernovae, Classical Novae, and Type I X-Ray Bursts. A Primer on Stellar Explosions](#user-content-link35)
**Authors:** Jordi Jose

36. [Mapping dark matter and the emergence of large-scale structure](#user-content-link36)
...
45. [Development of an early warning method incorporating pre-supernova neutrino light curves](#user-content-link45)
...
46. [The initial spin matters: the impact of rapid rotation on magnetic-field amplification at merger](#user-content-link46)
**Authors:** Harry Ho-Yin Ng, Jin-Liang Jiang, Luciano Rezzolla

47. [Natural Language-Driven Global Mapping of Martian Landforms](#user-content-link47)
...
48. [The reason for the occurrence of W-type contact binaries](#user-content-link48)
**Authors:** Jia Zhang, Sheng-Bang Qian, Li-Ying Zhu, Xu-Zhi Li

49. [SVOM discovery of a strong X-ray outburst of the blazar 1ES~1959+650 and multi-wavelength follow-up with the Neil Gehrels Swift observatory](#user-content-link49)
**Authors:** A. Foisseau, A. Coleiro, S. Komossa, D. Grupe, F. Cangemi, P. Maggi, D. G\"otz, H. -B. Cai, B. Cordier, N. Dagoneau, Z. -G. Dai, Y. -W. Dong, M. Fernandes Moita, O. Godet, A. Goldwurm, H. Goto, S. Guillot, L. Huang, M. -H. Huang, N. Jiang, C. Lachaud, S. Le Stum, E. -W. Liang, X. -M. Lu, L. Michel, C. Plasse, Y. L. Qiu, J. Rodriguez, L. Tao, S. Schanne, J. Wang, X. -G. Wang, X. -Y. Wang, J. Wei, C. Wu, Y. -W. Yu, J. Zhang, L. Zhang, S. -N. Zhang, S. Zheng

50. [Optimizing Optical Searches for Supermassive Black Hole Binaries in AGN Light Curves: Fourier versus Bayesian Periodicity Detection](#user-content-link50)
**Authors:** Sebastian Banaszak, Caitlin Witt, Adam Miller

51. [Evolution of the recent high-accretion state of the recurrent nova T CrB: HST, Swift, NuSTAR, and XMM-Newton observations](#user-content-link51)
**Authors:** G. J. M. Luna, N. P. M. Kuin, K. Mukai, J. L. Sokoloski, K. Page, J. P. Osborne

52. [A multiwavelength ALMA view of gas and dust in binary protoplanetary system AS 205: Evidence of dust asymmetric distribution](#user-content-link52)
**Authors:** Nguyen Thi Phuong, Nguyen Tat Thang

53. [Magnetar fraction in Core-Collapse Supernovae](#user-content-link53)
**Authors:** Celsa Pardo-Araujo, Nanda Rea, Michele Ronchi, Vanessa Graber

54. [Constraining nonminimal f(T) gravity from Primordial Nucleosynthesis to Late-Universe observations](#user-content-link54)
**Authors:** Yahia Al-Omar, Majida Nahili, Nidal Chamoun

55. [Two Fluid Quantum Bouncing Cosmology I: Theoretical Model](#user-content-link55)
**Authors:** Sandro D. P. Vitenti, Nelson Pinto-Neto, Patrick Peter, Luiz Felipe Dem\'etrio

56. [Dynamic shocks powered by a wide, relativistic, super-Eddington outflow launched by an accreting neutron star in the mid-20th century](#user-content-link56)
...
57. [Cyclic sunspot activity during the first millennium CE as reconstructed from radiocarbon](#user-content-link57)
**Authors:** Ilya Usoskin, Sami K. Solanki, Natalie A. Krivova, Theodosis Chatzistergos

58. [GRB~250704B/EP250704a a Short Gamma-Ray Burst Powered by a Magnetar](#user-content-link58)
**Authors:** Nissim Fraija, Antonio Galv\'a, Boris Betancourt Kamenetskaia, Maria G Dainotti

59. [Photon-dark photon oscillation in M87 and Crab Nebula environments](#user-content-link59)
**Authors:** Tanmay Kumar Poddar, Sourov Roy, Pratick Sarkar

60. [Failed ejection and oscillations of a current-carrying filament balanced by gravity](#user-content-link60)
**Authors:** P. Jel\'inek, M. Karlick\'y, S. Belov

61. [Neutrino-Induced Polarization Rotation in Active Galactic Nuclei Plasmas](#user-content-link61)
**Authors:** H. B. C\^amara, A. Smetana, A. Tursunov

62. [Formation and X-ray emission from hot bubbles in planetary nebulae - III. The impact of [Wolf-Rayet]-type winds](#user-content-link62)
**Authors:** Rogelio Orozco-Duarte, Jes\'us A. Toal\'a, S. Jane Arthur, Janis B. Rodr\'iguez-Gonz\'alez, Luke Conmy, Rolf Kuiper

63. [Deuteration of HC3N and CH3CCH in the pre-stellar core L1544](#user-content-link63)
**Authors:** K. Giers, S. Spezzano, Y. Lin, P. Caselli, O. Sipil\"a

64. [Extreme line profile variations in the repeating changing-look active galactic nucleus IRAS23226-3843](#user-content-link64)
...
65. [Single-wave solutions of the neutrino fast flavor system. Part I. Mechanical properties](#user-content-link65)
**Authors:** Damiano F. G. Fiorillo, Georg G. Raffelt

66. [The long quest for vacuum birefringence in magnetars: 1E 1547.0-5408 and the elusive smoking gun](#user-content-link66)
**Authors:** Roberto Taverna, Roberto Turolla, Lorenzo Marra, Ruth M. E. Kelly, Alice Borghese, Gian Luca Israel, Sandro Mereghetti, Silvia Zane, Michela Rigoselli

67. [Source identification for the Swift-BAT 150-month hard X-ray catalog using soft X-ray observations](#user-content-link67)
**Authors:** K. Imam, N. Torres-Alba, S. Marchesi, M. Ajello, S. Joffre, I. Cox, A. Pizzetti, X. Zhao, A. Segreto, A. Banerjee, I. Pal, V. E. Gianolli, D. Stern

68. [Blazars define a stable celestial reference frame](#user-content-link68)
**Authors:** Nathan Secrest, Sebastien Lambert

69. [Does the solar oxygen abundance change over the solar cycle? An investigation into activity-induced variations of the O I infrared triplet](#user-content-link69)
**Authors:** A. G. M. Pietrow, M. Baratella, I. V. Ilyin, M. Steffen, K. G. Strassmeier

70. [Dynamical Origin of (469219) Kamo`oalewa of Tianwen-2 Mission from the Main-Belt: $\nu_6$ Secular Resonance, Flora Family or 3:1 Resonance with Jupiter](#user-content-link70)
**Authors:** Yandong Wang, Shoucun Hu, Jianghui Ji, Jiajun Ying

71. [A 2 au resolution view by ALMA of the planet-hosting WISPIT 2 disk](#user-content-link71)
**Authors:** Stefano Facchini, Pietro Curone, Myriam Benisty, Francesco Zagaria, Richard Teague, Gabriele Cugno, Jaehan Bae

72. [Out-of-Sample Validation of MagNet](#user-content-link72)
**Authors:** Aryiadna Yesmanchyk, Yan Xu, Jason T. L. Wang, Haodi Jiang, Chunhui Xu, Haimin Wang

73. [Unveiling the Spectral Morphological Division of Fast Radio Bursts with CHIME/FRB Catalog 2](#user-content-link73)
...
74. [Evidence for stellar contamination and water absorption in NGTS-5b's transmission spectra with GTC/OSIRIS](#user-content-link74)
**Authors:** Wan-Hao Wang, Guo Chen, Chengzi Jiang, Enric Palle, Felipe Murgas, Hannu Parviainen

75. [Gravitational Waves and Primordial Black Holes produced by Dark Meta Stable Vacuum Decay](#user-content-link75)
**Authors:** Haipeng An, Tingyu Li, Chen Yang

76. [Redshift-Binned Constraints on the Hubble Constant under $\Lambda$CDM, CPL, and Pad\'e Cosmography](#user-content-link76)
**Authors:** Zhi-Yuan Mo, Kang Jiao, Tong-Jie Zhang

77. [Perihelion Asymmetry in the Water Production Rate of the Interstellar Object 3I/ATLAS](#user-content-link77)
**Authors:** Hanjie Tan (Planetary Environmental and Astrobiological Research Laboratory), Xiaoran Yan (National Research Council, Institute of Applied Physics "Nello Carrara"), Jian-Yang Li (Planetary Environmental and Astrobiological Research Laboratory, Xinjiang Astronomical Observatory, Chinese Academy of Sciences, Urumqi, China)

78. [Constraining dark energy models using Jackknife and Bootstrap resampling](#user-content-link78)
**Authors:** Roshna K, Nikhil Fernandes, P Praveen, V. Sreenath

79. [Cis--Trans Rotational Isomerism of Seleno-, Thio-, and Formic Acids and Their Dimers: Chemical Kinetics under Interstellar Conditions](#user-content-link79)
**Authors:** Judith Wurmel, John M. Simmie

80. [On the Missing Red Giants near the Galactic Center](#user-content-link80)
**Authors:** Taeho Kim, Jeremy Goodman

81. [Distance-Independent Atmospheric Refraction Correction for Accurate Retrieval of Fireball Trajectories](#user-content-link81)
**Authors:** Jaakko Visuri, Maria Gritsevich, Janne Sievinen

82. [LISA and the LISA Science Team](#user-content-link82)
**Authors:** Anna Heffernan

83. [Spin-down changes in PSR B0540-69 induced by a drift of the magnetic axis](#user-content-link83)
**Authors:** Lucas G. Bar\~ao, J. E. Horvath

84. [Determination of the longitude difference between Baghdad and Khwarezm using a lunar eclipse (the method of Abu Rayhan al-Biruni and Abu al-Wafa al-Buzjani)](#user-content-link84)
**Authors:** Rizoi Bakhromzod

85. [Non-uniform Antenna Loading Effect on Embedded Element Patterns and Application to Fault Detection](#user-content-link85)
**Authors:** Georgios Kyriakou

---

## 1. [Hierarchical bayesian inference: constraining population distribution of dark matter halo shapes via stellar streams](https://arxiv.org/abs/2601.15373) <a id="link1"></a>
...
**Comment:** Directly matches the near-field cosmology criterion: uses stellar streams (tidal debris of satellites) to constrain dark matter halo shapes in external galaxies. Uses hierarchical Bayesian inference and a new simulation tool. Highly relevant for substructure, dark matter profiles, and satellite interactions.
...
## 2. [The role of gas stripping in the quenching of satellite galaxies using SHARK v2.0](https://arxiv.org/abs/2601.15435) <a id="link2"></a>
...
**Comment:** Directly matches the star formation quenching criterion: investigates quenching of satellite galaxies using semi-analytic models, focusing on gas stripping and quenching timescales. Uses mock observations and calibrates models to SDSS data. Highly relevant for satellite quenching and numerical galaxy simulations.
...
## 3. [HE0144-4657: A Carbon-Enhanced Ultra Metal-Poor Star ([Fe/H] ~ -4.1) from the Helmi Stream Disrupted Dwarf Galaxy](https://arxiv.org/abs/2601.15974) <a id="link3"></a>
...
**Comment:** This paper reports the discovery of an ultra metal-poor, carbon-enhanced star associated with the Helmi Stream, a disrupted dwarf galaxy remnant. It provides evidence for the extragalactic origin of such stars and discusses their formation in ultra-faint dwarf galaxies accreted by the Milky Way. This directly matches the 'Near-Field Cosmology' criterion, with additional relevance for chemical abundances and accreted stellar halo studies.
...
## 4. [The age sequence of young clusters in Perseus: Estimating ages from mass distributions](https://arxiv.org/abs/2601.15413) <a id="link4"></a>
...
**Comment:** Presents a new method for estimating ages of young clusters in Perseus using mass distributions, aiming to track star formation history in a region. This is directly relevant to resolved star formation histories, as it estimates ages for clusters and tracks star formation history observationally.
...
## 5. [A general spectral solver for the axisymmetric Jeans equations: fast galaxy modelling with arbitrary anisotropy](https://arxiv.org/abs/2601.16179) <a id="link5"></a>
...
**Comment:** Presents a new spectral solver for axisymmetric Jeans equations, enabling fast galaxy modeling with arbitrary anisotropy. This is highly relevant to numerical galaxy simulations and modeling of galaxy density profiles, which are core topics.
...
## 6. [K-DRIFT Science Theme: Galactic Cirrus Clouds and Circumgalactic Medium](https://arxiv.org/abs/2601.15665) <a id="link6"></a>
...
**Comment:** This paper reviews science cases for the K-DRIFT telescope, including studies of the circumgalactic medium (CGM), galactic cirrus, and H-alpha emission from ram pressure stripped galaxies. It directly addresses the CGM, especially in the context of environmental effects and multiphase gas reservoirs, matching the 'Circumgalactic Medium' criterion. Increased relevance due to explicit mention of CGM and ISM outflows.
...
## 7. [Enhancing Thermal Sunyaev-Zel'dovich Analyses with Digital Twins of the Local Universe](https://arxiv.org/abs/2601.15935) <a id="link7"></a>
...
**Comment:** Presents new constrained simulations (digital twins) of the local universe and their application to tSZ analyses. This fits the 'Numerical Galaxy Simulations' criterion, especially as it discusses new simulation suites and their validation. The focus is on clusters and large-scale structure, not specifically on dwarf galaxies, but the simulation aspect is directly relevant.
...
## 8. [JADES: Discovery of Large Reservoirs of Small Dust Grains in the Circumgalactic Medium of Massive Galaxies at $z\sim3.5$ through Deep JWST/NIRCam Imaging and Grism Spectroscopy](https://arxiv.org/abs/2601.15961) <a id="link8"></a>
...
**Comment:** Reports discovery of large reservoirs of small dust grains in the circumgalactic medium (CGM) of massive galaxies at z~3.5. Directly relevant to the 'Circumgalactic Medium' criterion, though the focus is on massive galaxies rather than dwarfs. Discusses dust transport, outflows, and CGM enrichment, which are tangentially relevant to star-formation-driven outflows.
...
## 9. [Clump-like Structures in High-Redshift Galaxies: Mass Scaling and Radial Trends from JADES](https://arxiv.org/abs/2601.15965) <a id="link9"></a>
...
**Comment:** This paper presents a statistical analysis of clump-like structures in high-redshift galaxies using JWST JADES data. It investigates star-forming clumps, their properties, and their role in galaxy evolution. While it does not focus on resolved star formation histories from color-magnitude diagrams or dwarf galaxies, it is relevant to sub-galactic structure and star formation processes, making it borderline relevant.
...
## 10. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometrically Selected Galaxy Candidates at z > 8](https://arxiv.org/abs/2601.15959) <a id="link10"></a>
...
**Comment:** This paper presents a large sample of high-redshift galaxy candidates from JWST JADES, including analysis of UV slopes and galaxy morphology at z > 8. While it provides insights into galaxy evolution and star formation at cosmic dawn, it does not focus on resolved star formation histories from color-magnitude diagrams, nor does it address dwarf galaxies or near-field cosmology. The relevance is borderline due to its focus on galaxy evolution.
...
## 11. [Multi-band Reconstruction of Sixteen Gravitational Lens Systems using PISCO data](https://arxiv.org/abs/2601.15585) <a id="link11"></a>
...
**Comment:** This paper develops a scalable, multi-band lens modeling pipeline and applies it to galaxy-galaxy strong lensing systems. While it advances lens modeling for future surveys, it does not focus on dwarf galaxies, near-field cosmology, or resolved star formation histories. The relevance is borderline as lensing can sometimes probe substructure, but this is not the main focus here.
...
## 12. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: MIRI Coordinated Parallels in GOODS-S and GOODS-N](https://arxiv.org/abs/2601.15955) <a id="link12"></a>
...
**Comment:** JWST JADES MIRI data release paper describing ultra-deep mid-infrared imaging in GOODS fields. While this enables studies of early galaxy populations, it does not directly address resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on data reduction and survey description.
...
## 13. [There Is More to Outshining: 2D Dust Effects on Stellar Mass Estimates at $3 \leq z < 9$ with JWST in the JADES Field](https://arxiv.org/abs/2601.15963) <a id="link13"></a>
...
**Comment:** Examines dust effects on stellar mass estimates in high-redshift galaxies using JWST. While it discusses resolved SED fitting, the focus is on high-redshift galaxies (z=3-9), not local dwarfs or resolved star formation histories from color-magnitude diagrams. The methodology is relevant to resolved stellar population studies, but the application is not to the core topics.
...
## 14. [Intrinsic alignments in the FLAMINGO simulations with two-point statistics](https://arxiv.org/abs/2601.15851) <a id="link14"></a>
...
**Comment:** This paper analyzes intrinsic alignments in hydrodynamical simulations (FLAMINGO), focusing on luminous red galaxies and their alignment statistics. While it uses galaxy simulations, the focus is on alignment modeling for large surveys and not on the physics of galaxy formation, star formation histories, or dwarf galaxies. The relevance is borderline due to the use of simulations.
...
## 16. [JADES: Evolution of nitrogen abundances in star-forming galaxies from z ~ 1.5-7](https://arxiv.org/abs/2601.15964) <a id="link16"></a>

**ArXiv ID:** 2601.15964

**Authors:** Alex J. Cameron, Courtney Carreira, Charlotte Simmonds, Andrew J. Bunker, Aayush Saxena, Stefano Carniani, St\'ephane Charlot, Jacopo Chevallard, Emma Curtis-Lake, Kevin Hainline, Ryan Hausen, Xihan Ji, Zhiyuan Ji, Benjamin D. Johnson, Pierluigi Rinaldi, Brant Robertson, Jan Scholtz, Maddie S. Silcock, Sandro Tacchella, James A. A. Trussler, Hannah \"Ubler, Christina C. Williams, Christopher N. A. Willmer, Chris Willott, Joris Witstok

**Abstract:** We present nitrogen abundance measurements based on the low-ionisation [NII]6583 emission line for 588 galaxies between 1.5-1.1) at low-metallicity (12+log(O/H)<8.0) from $T_e$-based measurements. Meanwhile, applying strong-line abundance measurements to the remainder of our sample reveals a further 14 candidate galaxies passing these abundance cuts, implying that around 13 % of 12+log(O/H)<8.0 galaxies at these redshifts are nitrogen-enhanced at this level. We find that N/O abundance in low-metallicity systems correlates with SFR, surface density of SFR, and surface density of stellar mass at high redshift, while only in high-metallicity systems does a correlation with stellar mass emerge. Despite healthy representation of these `moderately nitrogen-enhanced' galaxies (-1.1-0.6, abundances that are typical of high-redshift NIII]- and NIV]-emitters. This demonstrates that the extreme nitrogen enhancements seen in some NIII]- and NIV]-emitters are only attained during the most extreme starbursts. This suggests that these elevated abundances are caused by enrichment from young massive stars in extreme environments and that the impact of this enrichment pathway is milder, though still important, for high-redshift systems on the star-forming main sequence.

**Comment:** Measures nitrogen abundances in star-forming galaxies from z~1.5-7, with a large sample. While it discusses star formation and chemical enrichment, it does not focus on resolved star formation histories from color-magnitude diagrams, dwarf galaxies, or near-field cosmology.
...
## 17. [Spatially resolved stellar-to-total dynamical mass relation: Radial variations, gradients and profiles of galaxy stellar populations](https://arxiv.org/abs/2601.16019) <a id="link17"></a>
...
**Comment:** Analyzes spatially resolved stellar population properties and their relation to dynamical mass in galaxies. While it discusses stellar populations and mass profiles, the focus is on more massive galaxies and does not directly address dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 18. [The FarView Low Frequency Radio Array on the Moon's Far Side: Science and Array Architecture](https://arxiv.org/abs/2601.16170) <a id="link18"></a>
...
**Comment:** Describes a proposed low-frequency radio array on the Moon for cosmology and astrophysics, including studies of the cosmic dark ages and large-scale structure. While it mentions dark matter and cosmology, it does not focus on near-field cosmology, satellite galaxies, or resolved star formation histories.
...
## 19. [OmniSpectra: A Unified Foundation Model for Native Resolution Astronomical Spectra](https://arxiv.org/abs/2601.15351) <a id="link19"></a>
...
**Comment:** Presents a foundation model for astronomical spectra, with applications to source classification, redshift estimation, and properties prediction for stars and galaxies. While broadly useful, it does not directly address any of the core topics such as resolved star formation histories, near-field cosmology, or galaxy simulations.
...
## 20. [What factors shape the radio luminosity of star-forming galaxies? A new calibration from LoTSS-DR2](https://arxiv.org/abs/2601.15374) <a id="link20"></a>
...
**Comment:** Studies the radio continuum-star formation rate relation in local star-forming galaxies, analyzing how galaxy properties (including stellar mass and SFR) affect radio luminosity. While it touches on star formation and galaxy properties, it does not focus on resolved star formation histories, quenching, or dwarf galaxies specifically. The work is more about calibration than about the physical processes of interest.
...
## 21. [JADES: A Prominent Galaxy Overdensity Candidate within the First 500 Myr](https://arxiv.org/abs/2601.15960) <a id="link21"></a>
...
**Comment:** Reports a galaxy overdensity at z~10.5, with analysis of star formation rates, stellar masses, and possible interactions. While it discusses star formation rates and galaxy properties, the focus is on high-redshift galaxies and overdensities, not on resolved star formation histories, quenching, or near-field cosmology. No direct relevance to dwarfs or the local universe.
...
## 22. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Catalogs of inferred morphological properties of galaxies from JWST/NIRCam imaging in GOODS-N and GOODS-S](https://arxiv.org/abs/2601.15957) <a id="link22"></a>
...
**Comment:** Presents catalogs of morphological properties of galaxies from JWST/NIRCam imaging, including Sersic profile fits and bulge-disk decomposition. While it provides data on galaxy structure and evolution, it does not directly address resolved star formation histories, quenching, or near-field cosmology. The focus is on morphology rather than the physical processes of interest.
...
## 23. [Fuzzy dark matter soliton core hosting a supermassive black hole as a dense low-mass perturber in strong gravitational lensing](https://arxiv.org/abs/2601.15718) <a id="link23"></a>
...
**Comment:** Discusses fuzzy dark matter soliton cores hosting SMBHs as perturbers in strong gravitational lensing. While it touches on dark matter substructure, the focus is on lensing and SMBHs, not on dwarf galaxies, satellite luminosity functions, or near-field cosmology.
...
## 24. [Undermassive Hosts of $z = 4-6 $ AGN from JWST/NIRCam Image Decomposition with CONGRESS, FRESCO, and JADES](https://arxiv.org/abs/2601.15962) <a id="link24"></a>
...
**Comment:** Studies the stellar masses of high-redshift AGN host galaxies using JWST imaging. While it involves galaxy properties, the focus is on AGN and their host galaxies at high redshift, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 25. [Reanalyzing DESI DR1: 4. Percent-Level Cosmological Constraints from Combined Probes and Robust Evidence for the Normal Neutrino Mass Hierarchy](https://arxiv.org/abs/2601.16165) <a id="link25"></a>
...
**Comment:** Cosmological constraints from DESI DR1, including neutrino mass hierarchy and dark energy. While this is cosmology, it does not focus on near-field cosmology, satellite galaxies, or resolved star formation histories. The work is large-scale cosmology, not the local universe or galaxy evolution.
...
## 26. [Solar twins in Gaia DR3 GSP-Spec I. Building a large catalog of Solar twins with ages](https://arxiv.org/abs/2601.15387) <a id="link26"></a>
...
**Comment:** Builds a large catalog of Solar twins with ages using Gaia DR3 data. While it deals with stellar populations and ages, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale topics.
...
## 27. [An Investigation of 5-year Simultaneous X-ray and Radio Light Curves of the Dwarf Seyfert Galaxy UGC 6728](https://arxiv.org/abs/2601.15383) <a id="link27"></a>
...
**Comment:** This paper presents simultaneous X-ray and radio light curves of a dwarf Seyfert galaxy, focusing on AGN variability and magnetic reconnection events. While the host is a dwarf galaxy, the study is centered on AGN activity and does not address near-field cosmology, star formation histories, or quenching.
...
## 28. [A Stratification in Magnetic Field Structures: The Radio Outflow in NGC 4151](https://arxiv.org/abs/2601.15382) <a id="link28"></a>
...
**Comment:** Focuses on radio outflows in a Seyfert galaxy (NGC 4151), specifically AGN-driven winds and magnetic field structures. The study is about outflows, but these are AGN-driven, not star-formation-driven, and the galaxy is a massive spiral, not a dwarf. No direct connection to the circumgalactic medium of dwarfs or star-formation-driven outflows.
...
## 29. [The Back-in-time Void Finder: dynamical identification of cosmic voids through optimal transport reconstruction](https://arxiv.org/abs/2601.15378) <a id="link29"></a>
...
**Comment:** Introduces a new void finder algorithm for cosmic voids using optimal transport reconstruction. While it is a numerical method for large-scale structure, it does not focus on galaxy simulations, dwarf galaxies, or any of the core topics.
...
## 30. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: NIRCam Imaging in GOODS-S and GOODS-N](https://arxiv.org/abs/2601.15954) <a id="link30"></a>
...
**Comment:** Describes the JWST JADES NIRCam imaging data release for GOODS-S and GOODS-N fields. This is a data release for extragalactic deep fields, but does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 31. [A multi-wavelength approach of AGN feedback in LINERs: The case of NGC 4438](https://arxiv.org/abs/2601.15991) <a id="link31"></a>
...
**Comment:** This paper presents a multi-wavelength study of AGN feedback in the LINER galaxy NGC 4438, focusing on radio, optical, and X-ray outflows. The outflows are AGN-driven, not star-formation-driven, and the galaxy is not a dwarf. The relevance is low as it does not match the core criteria.
...
## 32. [An Analysis of AGN Feedback in the Compact Galaxy Group Stephan's Quintet](https://arxiv.org/abs/2601.15384) <a id="link32"></a>
...
**Comment:** This paper analyzes AGN feedback in the compact galaxy group Stephan's Quintet, focusing on kinematics and outflows from the active galaxy NGC 7319. The outflows are AGN-driven, and the study does not focus on dwarf galaxies, star-formation-driven outflows, or near-field cosmology. The relevance is low.
...
## 33. [Gaia20fnr: A binary-lens microlensing event with full orbital motion revealed by four space telescopes](https://arxiv.org/abs/2601.15969) <a id="link33"></a>
...
**Comment:** This paper focuses on a microlensing event involving a binary lens system in the solar neighborhood. While it provides detailed characterization of a low-mass binary, it does not address near-field cosmology, resolved star formation histories, dwarf galaxy properties, or other core criteria. The focus is on microlensing methodology and binary star properties.
...
## 34. [Radio-Interferometric Image Reconstruction with Denoising Diffusion Restoration Models](https://arxiv.org/abs/2601.15844) <a id="link34"></a>
...
**Comment:** Presents a new method for radio interferometric image reconstruction using diffusion models. While relevant to radio astronomy, it does not address any of the core topics such as near-field cosmology, star formation histories, quenching, or galaxy simulations.
...
## 35. [Nucleosynthesis in Type Ia Supernovae, Classical Novae, and Type I X-Ray Bursts. A Primer on Stellar Explosions](https://arxiv.org/abs/2601.15740) <a id="link35"></a>
...
**Comment:** Review of nucleosynthesis in stellar explosions (Type Ia SNe, novae, X-ray bursts). While it discusses stellar models and nucleosynthesis, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on resolved star formation histories or galaxy simulations.
...
## 36. [Mapping dark matter and the emergence of large-scale structure](https://arxiv.org/abs/2601.15583) <a id="link36"></a>
...
**Comment:** Discusses a potential survey to map dark matter and large-scale structure. While relevant to cosmology, it does not focus on near-field cosmology, satellite galaxies, or resolved star formation histories. The focus is on large-scale structure, not local galaxy evolution.
...
## 37. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Photometric Catalog](https://arxiv.org/abs/2601.15956) <a id="link37"></a>
...
**Comment:** Describes the release of photometric catalogs from JADES, including methodologies for detection and photometry. While useful for future studies, the paper itself does not address any of the core topics directly (e.g., resolved star formation histories, quenching, near-field cosmology).
...
## 38. [Compact Stars Sourced by Dark Matter Halos and Their Frozen States](https://arxiv.org/abs/2601.15415) <a id="link38"></a>
...
**Comment:** Theoretical work on compact stars sourced by dark matter halos, discussing black hole mimickers. While it touches on dark matter and compact objects, it does not address near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 39. [Constraining Nuclear Molecular Gas Content with High-resolution CO Imaging of GOALS Galaxies](https://arxiv.org/abs/2601.16057) <a id="link39"></a>
...
**Comment:** ALMA study of nuclear molecular gas in merging galaxies, focusing on gas mass and implications for black hole accretion. The work is on higher mass galaxies and SMBHs, not dwarf galaxies or star formation driven outflows, and does not address the core criteria.
...
## 40. [Interaction between the ejecta, the accretion disk, and the secondary star in the recurrent nova system U Sco](https://arxiv.org/abs/2601.15725) <a id="link40"></a>
...
**Comment:** Uses 3D hydrodynamics simulations to study the interaction between nova ejecta, accretion disk, and secondary star in a recurrent nova system. While it uses numerical simulations, the focus is on stellar-scale phenomena, not galaxy simulations.
...
## 41. [Hydrodynamic simulations of the recurrent nova T Coronae Borealis: Nucleosynthesis predictions](https://arxiv.org/abs/2601.15713) <a id="link41"></a>
...
**Comment:** Hydrodynamic simulations of a recurrent nova in the Milky Way, focusing on nucleosynthesis. While it involves stellar models and simulations, it is not about galaxy evolution, dwarf galaxies, or resolved star formation histories. The focus is on nova explosions, not the core topics.
...
## 42. [A compact object with a K type star companion in the solar neighborhood: a wide post common envelope binary with a white dwarf candidate](https://arxiv.org/abs/2601.15619) <a id="link42"></a>
...
**Comment:** This paper reports the discovery and characterization of a wide post-common envelope binary with a white dwarf candidate and a K-type star companion. The study focuses on binary evolution and common envelope physics, not on galaxy formation, dwarf galaxies, or star formation histories.
...
## 43. [Digging into the Interior of Hot Cores with ALMA (DIHCA). VII. Disk candidates around high-mass stars and evidence of anisotropic infall](https://arxiv.org/abs/2601.15371) <a id="link43"></a>
...
**Comment:** Focuses on disk candidates around high-mass stars and anisotropic infall, which is not relevant to near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations. The work is about star formation in high-mass protostars, not dwarf galaxies or their satellites.
...
## 44. [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: Wisp Subtraction with the Non-negative Matrix Factorization Algorithm](https://arxiv.org/abs/2601.15958) <a id="link44"></a>
...
**Comment:** This paper presents a new method for subtracting scattered light artifacts (wisps) in JWST/NIRCam imaging, improving data quality for extragalactic surveys. While useful for observational astronomy, it does not directly address any of the core criteria such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 45. [Development of an early warning method incorporating pre-supernova neutrino light curves](https://arxiv.org/abs/2601.15691) <a id="link45"></a>
...
**Comment:** Develops an early warning method for pre-supernova neutrino light curves. This is focused on stellar evolution and neutrino detection, not on galaxies, star formation histories, or near-field cosmology.
...
## 46. [The initial spin matters: the impact of rapid rotation on magnetic-field amplification at merger](https://arxiv.org/abs/2601.15650) <a id="link46"></a>
...
**Comment:** This paper focuses on the amplification of magnetic fields during neutron star mergers using high-resolution general-relativistic magnetohydrodynamic simulations. While it involves advanced numerical simulations and magnetic field evolution, the topic is not directly related to any of the core criteria such as near-field cosmology, dwarf galaxies, resolved star formation histories, galaxy quenching, or galaxy-scale outflows. The focus is on compact object mergers rather than galaxy evolution or structure.
...
## 47. [Natural Language-Driven Global Mapping of Martian Landforms](https://arxiv.org/abs/2601.15949) <a id="link47"></a>
...
**Comment:** Presents a vision-language framework for mapping Martian landforms using natural language queries. This is planetary science and not relevant to the core galaxy topics.
...
## 48. [The reason for the occurrence of W-type contact binaries](https://arxiv.org/abs/2601.15672) <a id="link48"></a>
...
**Comment:** Investigates the W-type phenomenon in contact binaries, focusing on magnetic activity and temperature inversion. This is a stellar astrophysics paper, but does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale topics.
...
## 49. [SVOM discovery of a strong X-ray outburst of the blazar 1ES~1959+650 and multi-wavelength follow-up with the Neil Gehrels Swift observatory](https://arxiv.org/abs/2601.15994) <a id="link49"></a>
...
**Comment:** Focuses on a blazar outburst and multi-wavelength follow-up. No direct connection to near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The topic is AGN variability and blazar physics, which is outside the core criteria.
...
## 50. [Optimizing Optical Searches for Supermassive Black Hole Binaries in AGN Light Curves: Fourier versus Bayesian Periodicity Detection](https://arxiv.org/abs/2601.15379) <a id="link50"></a>
...
**Comment:** Focuses on periodicity detection in AGN light curves to search for supermassive black hole binaries. No connection to any of the core criteria (dwarf galaxies, star formation, galaxy simulations, etc.).
...
## 51. [Evolution of the recent high-accretion state of the recurrent nova T CrB: HST, Swift, NuSTAR, and XMM-Newton observations](https://arxiv.org/abs/2601.16190) <a id="link51"></a>
...
**Comment:** Multiwavelength study of a recurrent nova (T CrB) focusing on accretion disk evolution and pre-eruption state. No connection to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 52. [A multiwavelength ALMA view of gas and dust in binary protoplanetary system AS 205: Evidence of dust asymmetric distribution](https://arxiv.org/abs/2601.16202) <a id="link52"></a>
...
**Comment:** ALMA study of gas and dust in a binary protoplanetary system. Focus is on disk structure and dust/gas distribution, not on galaxies, star formation histories, or galaxy simulations.
...
## 53. [Magnetar fraction in Core-Collapse Supernovae](https://arxiv.org/abs/2601.16159) <a id="link53"></a>
...
**Comment:** Focuses on magnetar formation rates in core-collapse supernovae using population synthesis of neutron stars in the Milky Way. While it deals with Galactic neutron star populations, it does not address near-field cosmology topics such as dwarf satellites, satellite luminosity functions, or resolved star formation histories. No direct relevance to the core topics.
...
## 54. [Constraining nonminimal f(T) gravity from Primordial Nucleosynthesis to Late-Universe observations](https://arxiv.org/abs/2601.15460) <a id="link54"></a>
...
**Comment:** Constrains nonminimal f(T) gravity using cosmological observations from primordial nucleosynthesis to late-Universe probes. This is a cosmology paper focused on gravity models and expansion history, not on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 55. [Two Fluid Quantum Bouncing Cosmology I: Theoretical Model](https://arxiv.org/abs/2601.15542) <a id="link55"></a>
...
**Comment:** Presents a theoretical model for quantum bouncing cosmology with two fluids (matter and radiation). Focus is on early universe cosmology and perturbation spectra, not on galaxy formation, near-field cosmology, or resolved star formation histories.
...
## 56. [Dynamic shocks powered by a wide, relativistic, super-Eddington outflow launched by an accreting neutron star in the mid-20th century](https://arxiv.org/abs/2601.15400) <a id="link56"></a>
...
**Comment:** Studies dynamic shocks powered by a relativistic outflow from an accreting neutron star in an X-ray binary. Focus is on outflows from accreting neutron stars, not star-formation-driven outflows or galaxy-scale feedback.
...
## 58. [GRB~250704B/EP250704a a Short Gamma-Ray Burst Powered by a Magnetar](https://arxiv.org/abs/2601.15732) <a id="link58"></a>
...
**Comment:** This paper focuses on a short gamma-ray burst powered by a magnetar, analyzing multi-wavelength data and modeling the afterglow. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 59. [Photon-dark photon oscillation in M87 and Crab Nebula environments](https://arxiv.org/abs/2601.15985) <a id="link59"></a>
...
**Comment:** This paper investigates photon-dark photon oscillations in the environments of M87 and the Crab Nebula, focusing on plasma physics and constraints on dark photon mixing. It does not address any of the core topics such as galaxy formation, dwarf galaxies, or star formation histories.
...
## 60. [Failed ejection and oscillations of a current-carrying filament balanced by gravity](https://arxiv.org/abs/2601.15823) <a id="link60"></a>
...
**Comment:** This paper studies the evolution of a current-carrying filament in a gravity-balanced model, using MHD simulations. The focus is on solar/stellar filament dynamics, not on galaxy simulations, star formation, or near-field cosmology.
...
## 61. [Neutrino-Induced Polarization Rotation in Active Galactic Nuclei Plasmas](https://arxiv.org/abs/2601.15910) <a id="link61"></a>
...
**Comment:** This paper studies neutrino-induced polarization rotation in AGN plasmas, focusing on plasma physics and neutrino backgrounds. It does not address any of the core topics related to galaxy formation, star formation, or near-field cosmology.
...
## 62. [Formation and X-ray emission from hot bubbles in planetary nebulae - III. The impact of [Wolf-Rayet]-type winds](https://arxiv.org/abs/2601.16100) <a id="link62"></a>
...
**Comment:** Focuses on radiation-hydrodynamical simulations of planetary nebulae and X-ray emission from [Wolf-Rayet]-type winds. This is primarily about stellar evolution and planetary nebulae, not galaxies, star formation histories, or near-field cosmology.
...
## 63. [Deuteration of HC3N and CH3CCH in the pre-stellar core L1544](https://arxiv.org/abs/2601.15791) <a id="link63"></a>
...
**Comment:** Examines deuteration in molecules within a pre-stellar core, focusing on chemical diagnostics of star formation. This is about molecular clouds and pre-stellar cores, not galaxies or the core topics listed.
...
## 64. [Extreme line profile variations in the repeating changing-look active galactic nucleus IRAS23226-3843](https://arxiv.org/abs/2601.15979) <a id="link64"></a>
...
**Comment:** Studies line profile variations in a changing-look AGN. The focus is on AGN variability and broad line regions, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 65. [Single-wave solutions of the neutrino fast flavor system. Part I. Mechanical properties](https://arxiv.org/abs/2601.15372) <a id="link65"></a>
...
**Comment:** Presents new solutions for neutrino flavor evolution in dense plasmas. While interesting for fundamental physics, it does not relate to galaxy evolution, near-field cosmology, or the other core topics.
...
## 66. [The long quest for vacuum birefringence in magnetars: 1E 1547.0-5408 and the elusive smoking gun](https://arxiv.org/abs/2601.15452) <a id="link66"></a>
...
**Comment:** This paper presents X-ray polarimetry of a magnetar, focusing on vacuum birefringence and QED effects in strong magnetic fields. It is centered on neutron star physics and does not address any of the core criteria.
...
## 67. [Source identification for the Swift-BAT 150-month hard X-ray catalog using soft X-ray observations](https://arxiv.org/abs/2601.15577) <a id="link67"></a>
...
**Comment:** Catalogs X-ray sources and their counterparts, focusing on AGN and galaxies, but not specifically on dwarf galaxies, star formation histories, or galaxy simulations. No direct relevance to the core criteria.
...
## 68. [Blazars define a stable celestial reference frame](https://arxiv.org/abs/2601.15381) <a id="link68"></a>
...
**Comment:** Astrometric reference frame stability using blazars and quasars. No connection to any of the core criteria (dwarf galaxies, star formation, galaxy simulations, etc.).
...
## 69. [Does the solar oxygen abundance change over the solar cycle? An investigation into activity-induced variations of the O I infrared triplet](https://arxiv.org/abs/2601.15919) <a id="link69"></a>
...
**Comment:** Investigates solar oxygen abundance variations over the solar cycle. This is a stellar abundance study focused on the Sun, not on stellar models, galaxy evolution, or resolved star formation histories in galaxies.
...
## 70. [Dynamical Origin of (469219) Kamo`oalewa of Tianwen-2 Mission from the Main-Belt: $\nu_6$ Secular Resonance, Flora Family or 3:1 Resonance with Jupiter](https://arxiv.org/abs/2601.13585) <a id="link70"></a>
...
**Comment:** Focuses on the dynamical origin of a near-Earth asteroid and its connection to the main belt, using simulations. This is planetary science and does not address any of the core galaxy topics.
...
## 71. [A 2 au resolution view by ALMA of the planet-hosting WISPIT 2 disk](https://arxiv.org/abs/2601.15948) <a id="link71"></a>
...
**Comment:** ALMA observations of a planet-hosting disk, focusing on circumplanetary emission and disk structure. This is about planet formation and disk structure, not galaxy evolution, dwarf galaxies, or near-field cosmology.
...
## 72. [Out-of-Sample Validation of MagNet](https://arxiv.org/abs/2601.15926) <a id="link72"></a>
...
**Comment:** Machine learning model for solar magnetograms, focused on solar active regions. Not relevant to galaxy evolution, near-field cosmology, or the other core topics.
...
## 73. [Unveiling the Spectral Morphological Division of Fast Radio Bursts with CHIME/FRB Catalog 2](https://arxiv.org/abs/2601.16048) <a id="link73"></a>
...
**Comment:** This paper uses machine learning to analyze fast radio bursts (FRBs) and their spectral properties. It does not address any of the core topics such as galaxy formation, dwarf galaxies, or star formation histories.
...
## 74. [Evidence for stellar contamination and water absorption in NGTS-5b's transmission spectra with GTC/OSIRIS](https://arxiv.org/abs/2601.15704) <a id="link74"></a>
...
**Comment:** This paper analyzes the transmission spectra of the exoplanet NGTS-5b, focusing on atmospheric properties and stellar contamination. It does not address any of the core topics related to galaxies or star formation.
...
## 75. [Gravitational Waves and Primordial Black Holes produced by Dark Meta Stable Vacuum Decay](https://arxiv.org/abs/2601.14366) <a id="link75"></a>
...
**Comment:** The paper discusses gravitational waves and primordial black holes from dark sector vacuum decay, focusing on cosmological phase transitions and their phenomenology. It does not address galaxy formation, dwarf galaxies, star formation histories, or any of the core criteria.
...
## 76. [Redshift-Binned Constraints on the Hubble Constant under $\Lambda$CDM, CPL, and Pad\'e Cosmography](https://arxiv.org/abs/2601.15765) <a id="link76"></a>
...
**Comment:** This paper analyzes redshift-binned constraints on the Hubble constant using various cosmological probes and models. It focuses on cosmological parameter estimation and does not address galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 77. [Perihelion Asymmetry in the Water Production Rate of the Interstellar Object 3I/ATLAS](https://arxiv.org/abs/2601.15443) <a id="link77"></a>
...
**Comment:** This paper characterizes the water production rate of the interstellar object 3I/ATLAS using space-based observations. The focus is on cometary activity and composition, not on galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 78. [Constraining dark energy models using Jackknife and Bootstrap resampling](https://arxiv.org/abs/2601.16197) <a id="link78"></a>
...
**Comment:** Constrains dark energy models using supernova data and resampling techniques. This is cosmology-focused and does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 79. [Cis--Trans Rotational Isomerism of Seleno-, Thio-, and Formic Acids and Their Dimers: Chemical Kinetics under Interstellar Conditions](https://arxiv.org/abs/2601.16115) <a id="link79"></a>

**ArXiv ID:** 2601.16115

**Authors:** Judith Wurmel, John M. Simmie

**Abstract:** Tunnelling reactions of molecules embedded on cryogenic noble-gas matrices are being used in fundamental studies of how reactivity   varies with the nature of the supposedly inert matrix as well as pointers to the chemistry occurring in the interstellar medium   on ice-grains. To these ends we present chemical kinetic rate constants for the \textit{cis} to \textit{trans} isomerisation of   seleno-, thio- and monomeric formic acids and that of their three dimeric species, based on multidimensional calculations in the   gas-phase, from 10~K to 300~K as a guide to the matrix reactions.

**Comment:** Studies chemical kinetics and isomerism of acids under interstellar conditions, relevant to astrochemistry but not to any of the core galaxy topics.
...
## 80. [On the Missing Red Giants near the Galactic Center](https://arxiv.org/abs/2601.16191) <a id="link80"></a>
...
**Comment:** Examines the deficiency of red giants near the Galactic Center, focusing on tidal stripping and stellar collisions. The topic is the Galactic Center, which is explicitly listed as irrelevant in the criteria.
...
## 81. [Distance-Independent Atmospheric Refraction Correction for Accurate Retrieval of Fireball Trajectories](https://arxiv.org/abs/2601.15805) <a id="link81"></a>
...
**Comment:** Presents a new atmospheric refraction correction technique for fireball trajectory retrieval. This is a methodological paper for meteor science, unrelated to the core topics.
...
## 82. [LISA and the LISA Science Team](https://arxiv.org/abs/2601.15365) <a id="link82"></a>
...
**Comment:** This paper is an overview of the LISA mission and its science team, focusing on gravitational wave detection. It does not address any of the core topics related to galaxy formation, star formation, or near-field cosmology.
...
## 83. [Spin-down changes in PSR B0540-69 induced by a drift of the magnetic axis](https://arxiv.org/abs/2601.15425) <a id="link83"></a>
...
**Comment:** Discusses spin-down changes in a pulsar due to magnetic axis drift, focusing on neutron star physics and magnetic field evolution. Not relevant to galaxy evolution, star formation histories, or near-field cosmology.
...
## 84. [Determination of the longitude difference between Baghdad and Khwarezm using a lunar eclipse (the method of Abu Rayhan al-Biruni and Abu al-Wafa al-Buzjani)](https://arxiv.org/abs/2601.15837) <a id="link84"></a>
...
**Comment:** Historical astronomy paper on longitude determination using lunar eclipses. No connection to any of the core criteria (near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 85. [Non-uniform Antenna Loading Effect on Embedded Element Patterns and Application to Fault Detection](https://arxiv.org/abs/2601.15367) <a id="link85"></a>
...
**Comment:** Technical paper on antenna loading and fault detection, unrelated to any astrophysical or galaxy-related criteria.
