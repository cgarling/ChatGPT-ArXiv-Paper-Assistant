...
1. [Prompt cusps in hierarchical dark matter halos: Implications for annihilation boost](#user-content-link1)
**Authors:** Shin'ichiro Ando, Martin Moro, Youyou Li

2. [Proof that the Milky Way experienced a significant merger only 1.5 billion years after the Big Bang](#user-content-link2)
...
3. [Statistical Predictions of the Accreted Stellar Halos around Milky Way-Like Galaxies](#user-content-link3)
**Authors:** J. Sebastian Monzon, Frank C. van den Bosch, Martin P. Rey

4. [Variations in the Milky Way's Stellar Mass Function at [Fe/H] < -1](#user-content-link4)
**Authors:** Jiadong Li, Hans-Walter Rix, Yuan-Sen Ting, Yu-Ting Wang, Szabolcs M\'esz\'aros, Ilija Medan, Chao Liu, Zhiqiang Yan, Peter J. Smith, Dan Qiu, Alexandre Roman-Lopes, Gregory M. Green, Danny Horta, Zachary Way, Tadafumi Matsuno, Stefano Souza, Jos\'e G. Fern\'andez-Trincado

5. [Homogenous abundances of Mg, Si, Ca, and Ti for about 1500 red giants in 16 globular clusters from FLAMES spectra](#user-content-link5)
**Authors:** Eugenio Carretta (INAF - Osservatorio di Astrofisica e Scienza dello Spazio di Bologna)

6. [Uniform Forward-Modeling Analysis of Ultracool Dwarfs. IV. Benchmarking the Sonora Diamondback and Saumon & Marley (2008) Atmospheric Models Across Late-M, L, and T types with Low-Resolution 0.8-2.5 $\mu$m Spectroscopy](#user-content-link6)
...
7. [An analysis of the J-method from the perspective of the AGB evolution](#user-content-link7)
**Authors:** C. Gavetti, P. Ventura, F. Dell'Agli, M. Correnti, F. La Franca

8. [ERGO-ML: The assembly histories of HSC galaxy images via invertible neural networks, contrastive learning, and cosmological simulations](#user-content-link8)
**Authors:** Lukas Eisert, Connor Bottrell, Annalisa Pillepich, Dylan Nelson, Rhythm Shimakawa, Marc Huertas-Company, Ralf S. Klessen

9. [An essential building block for cosmological zoom-in perturbation theory](#user-content-link9)
**Authors:** Obinna Umeh

10. [Testing the inference of kinematics from mock JWST NIRSpec/MSA observations of TNG50 galaxies at $z\sim2-6$](#user-content-link10)
**Authors:** Ravishankar Anirudh, Anna de Graaff, Florian Lacroix, Sedona H. Price, Annalisa Pillepich

11. [The Solar Neighborhood LIV: 54 Orbits of M Dwarf Multiples within 30 Parsecs with Speckle Interferometry at SOAR](#user-content-link11)
**Authors:** Eliot Halley Vrijmoet (Five College Astronomy Department of Smith College, RECONS Institute), Andrei Tokovinin (Cerro Tololo Inter-American Observatory -- NSF's NOIRLab), Todd J. Henry (RECONS Institute), Jennifer G. Winters (RECONS Institute, Bridgewater State University), Wei-Chun Jao (RECONS Institute, Georgia State University), Elliott Horch (RECONS Institute, Southern Connecticut State University)

12. [Weak Lensing Approximation of Wave-optics Effects from General Symmetric Lens Profiles](#user-content-link12)
**Authors:** Zhao-Feng Wu, Otto A. Hannuksela, Martin Hendry, Quynh Lan Nguyen

13. [High resolution observations of 'dark' neutral hydrogen clouds in the Virgo cluster with the Very Large Array](#user-content-link13)
**Authors:** Robert Minchin, Rhys Taylor, Emmanuel Momjian, Boris Deshev, Vojt\v{e}ch Part\'ik

14. [Equation of State of Highly Asymmetric Neutron-Star Matter from Liquid Drop Model and Meson Polytropes](#user-content-link14)
**Authors:** Elissaios Andronopoulos, Konstantinos N. Gourgouliatos

15. [Homogeneous abundance ratios of hydrostatic and explosive alpha-elements in globular clusters from high resolution optical spectroscopy](#user-content-link15)
**Authors:** Eugenio Carretta (INAF - Osservatorio di Astrofisica e Scienza dello Spazio di Bologna)

16. [AT2018cow Powered by a Shock in Aspherical Circumstellar Media](#user-content-link16)
**Authors:** Taya Govreen-Segal, Ehud Nakar, Kenta Hotokezaka, Christopher M Irwin, Eliot Quataert

17. [Lensing without mixing: Probing Baryonic Acoustic Oscillations and other scale-dependent features in cosmic shear surveys](#user-content-link17)
**Authors:** David Touzeau, Alexandre Barth\'el\'emy, Francis Bernardeau

18. [Non-linear evolution in $f(R)$ gravity: iterative modelling of the Chameleon mechanism](#user-content-link18)
**Authors:** Sharvari Nadkarni-Ghosh, Tanush Reddy Vaka

19. [Minkowski Functionals of the 21 cm Signal as a Probe of Primordial Features](#user-content-link19)
**Authors:** Kanan Virkar (Indian Institute of Astrophysics), Suvedha Suresh Naik (Korea Institute for Advanced Study), Pravabati Chingangbam (Indian Institute of Astrophysics)

20. [Multiwavelength Analysis of Six Luminous, Fast Blue Optical Transients](#user-content-link20)
**Authors:** Cassie Sevilla, Anna Y. Q. Ho, Nayana A. J., Steve Schulze, Daniel A. Perley, Michael Bremer, Igor Andreoni, Ivan Altunin, Thomas G. Brink, Poonam Chandra, Ping Chen, Ashley A. Chrimes, Michael W. Coughlin, Kaustav K. Das, Andrew Drake, Alexei V. Filippenko, Christoffer Fremling, James Freeburn, Avishay Gal Yam, Mary Gerhart, Matthew J. Graham, George Helou, K-Ryan Hinds, Natalya Johnson, Mansi M. Kasliwal, Harsh Kumar, Russ R. Laher, Natalie LeBaron, Maggie L. Li, Chang Liu, Ben Margalit, Yu-Jing Qin, Nabeel Rehemtulla, Sophia Risin, Sam Rose, Rupak Roy, Ben Rusholme, Genevieve Schroeder, Jesper Sollerman, Kailai Wang, Jacob L. Wise, Yi Yang, Yuhan Yao, WeiKang Zheng

21. [How to interpret near-infrared polarisation spectra of active M dwarfs?](#user-content-link21)
**Authors:** Oleg Kochukhov

22. [Exploring the effects of diffuse ionised gas in two local analogues of high-redshift star-forming galaxies](#user-content-link22)
**Authors:** P. Lagos, A. Nigoche-Netro, T. C. Scott, C. Sengupta, R. Demarco

23. [A complete survey of filaments in Cygnus X](#user-content-link23)
**Authors:** Yingxi Li, Keping Qiu

24. [Part II: Low Energy Galactic Neutrinos](#user-content-link24)
**Authors:** Eduardo Flores, Elise Cantu, Ian Marano, Osvan Vivar-Garcia, Shabhaz Khalandar

25. [CH3CCH as a thermometer in warm molecular gas](#user-content-link25)
**Authors:** Yuqiang Li, Junzhi Wang, Juan Li, Xing Lu, Siqi Zheng, Chao Ou, Qian Huang, Miguel Santander-Garc\'ia, Jos\'e Jairo D\'iaz Luis, Seokho Lee, Tie Liu, Zhiqiang Shen

26. [Testing the Equivalence Principle in Galaxy Clusters](#user-content-link26)
**Authors:** Enea Di Dio, Sveva Castello, Camille Bonvin

27. [Almanac: HMC sampling with bounded velocity](#user-content-link27)
**Authors:** Javier Silva Lafaurie, Lorne Whiteway, Elena Sellentin, Kutay Nazli, Andrew H. Jaffe, Alan F. Heavens, Arthur Loureiro

28. [Fading Echoes of Interaction: Probing Centuries of Mass-Loss in Four Old Type IIn Supernovae](#user-content-link28)
...
29. [Spectrum of radiation from global strings and the relic axion density](#user-content-link29)
**Authors:** Richard A. Battye, Lukasz P. Bunio, Steven J. Cotterill, Pranav B. Gangrekalve Manoj

30. [Accelerating radio astronomy imaging with RICK: a step towards SKA-Mid and SKA-Low](#user-content-link30)
**Authors:** Giovanni Lacopo, Emanuele De Rubeis, Claudio Gheller, Giuliano Taffoni, Luca Tornatore

31. [Constraints on Primordial Black Holes from Galactic Diffuse Synchrotron Emissions](#user-content-link31)
**Authors:** Chen-Wei Du, Yu-Feng Zhou

32. [Low-frequency-selected Fast Radio Burst Host Galaxy Candidates](#user-content-link32)
**Authors:** Yu-Zhu Sun, Rhaana L. C. Starling, Rob A. J. Eyles-Ferris, Antonia Rowlinson, Ralph A. M. J. Wijers, Nial R. Tanvir

33. [A Catalog of 971 FR-I Radio Galaxies from the FIRST Survey via Hybrid Deep Learning and Ridgeline Flux Density Distribution Analysis](#user-content-link33)
**Authors:** Baoqiang Lao, Xiaolong Yang, Wenjun Xiao, Tapan K. Sasmal, Yanli Zou, Didi Liu, Zhixian Liao, Ye Lu, Rushuang Zhao

34. [Union3.1: Self-consistent Measurements of Host Galaxy Properties for 2000 Type Ia Supernovae](#user-content-link34)
**Authors:** Taylor J. Hoyt, David Rubin, Greg Aldering, Saul Perlmutter, Andrei Cuceu, Ravi Gupta

35. [Local environmental dependence on weak-lensing shear statistics](#user-content-link35)
**Authors:** Sonia Akter Ema, Md Rasel Hossen, Krzysztof Bolejko, Geraint F. Lewis

36. [Progenitor of the recoiling super-massive black hole RBH-1 identified using HST/JWST imaging](#user-content-link36)
**Authors:** Tousif Islam, Tejaswi Venumadhav, Digvijay Wadekar

37. [Green's Function Formalism for Impurity-Induced Resonances in Sub-barrier Proton-Nucleus Scattering](#user-content-link37)
**Authors:** Bahruz Suleymanli, Kutsal Bozkurt

38. [Q-balls from thermal balls during a first-order phase transition: a numerical study](#user-content-link38)
**Authors:** Yuan-Jie Li, Jing Liu, Zong-Kuan Guo

39. [Dynamical Evidence for a Billion Solar Mass Black Hole in Galaxy NGC 4061 from ALMA $^{12}$CO(2-1) Kinematics](#user-content-link39)
**Authors:** Dieu D. Nguyen, Long Q. T. Nguyen, Elena Gallo, Hai N. Ngo, Que T. Le, Fabio Pacucci, Tinh Q. T. Le, Tuan N. Le, Tien H. T. Ho

40. [Maximum Energy of Particles Accelerated in GRB Afterglow Shocks](#user-content-link40)
**Authors:** Zhao-Feng Wu, Sof\'ia Guevara-Montoya, Paz Beniamini, Dimitrios Giannios, Daniel Gro\v{s}elj, Lorenzo Sironi

41. [Numerical simulations of black hole-neutron star mergers with equal and near-equal mass ratios](#user-content-link41)
**Authors:** Ivan Markin, Mattia Bulla, Tim Dietrich

42. [Large-scale Modeling of the Observed Power Spectrum Multipoles](#user-content-link42)
**Authors:** Robin Y. Wen, Henry S. Grasshorn Gebhardt, Chen Heinrich, Olivier Dor\'e

43. [Banana Split: Improved Cosmological Constraints with Two Light-Curve-Shape and Color Populations Using Union3.1+UNITY1.8](#user-content-link43)
**Authors:** David Rubin, Taylor Hoyt, Greg Aldering, Saul Perlmutter

44. [A nuclear disc at Cosmic Noon: evidence of early bar-driven galaxy evolution](#user-content-link44)
**Authors:** Zoe A. Le Conte, Dimitri A. Gadotti, Thomas Harvey, Leonardo Ferreira, Christopher J. Conselice, Taehyun Kim, Camila de S\'a-Freitas, Francesca Fragkoudi, Justus Neumann, E. Athanassoula

45. [Inside the cocoon: a comprehensive explanation of the spectra of Little Red Dots](#user-content-link45)
...
46. [Physical and Chemical Characterization of GY 91's Multi-ringed Protostellar Disk with ALMA](#user-content-link46)
**Authors:** Sally D. Jiang, Jane Huang, Ian Czekala, Leon Trapman, Yuri Aikawa, Sean M. Andrews, Jaehan Bae, Edwin A. Bergin, Charles J. Law, Romane Le Gal, Feng Long, Fran\c{c}ois M\'enard, Karin I. \"Oberg, Chunhua Qi, Richard Teague, David Wilner, Ke Zhang

47. [The MIRI Excess around Degenerates (MEAD) Survey II: A Probable Planet detected via IR Excess around WD 0644+025](#user-content-link47)
**Authors:** Sabrina Poulsen, John Debes, Ashley Messier, Erika Le Bourdais, Carl Melis, Misty Cracraft, Samuel Boucher, Mukremin Kilic, Scott Kenyon, Mark C. Wyatt, Seth Redfield, Patrick Dufour, Loic Albert, Susan E. Mullally, William T. Reach, Fergal Mullally, David A. Golimowski

48. [Beyond FINDCHIRP: Breaking the memory wall and optimal FFTs for Gravitational-Wave Matched-Filter Searches with Ratio-Filter Dechirping](#user-content-link48)
**Authors:** Alexander H. Nitz, Keisi Kacanja, Kanchan Soni

49. [Gaia serial CTI modelling and radiation damage study](#user-content-link49)
**Authors:** C. Pagani, N. C. Hambly, M. Davidson, N. Rowell, C. Crowley, R. Collins, F. van Leeuwen, G. M. Seabroke, A. Holland, M. A. Barstow, D. W. Evans

50. [Chemically peculiar stars investigated by the BRITE Mission](#user-content-link50)
**Authors:** Teja Begari, Klaus Bernhard, Ernst Paunzen, Prapti Mondal

51. [Energy partition in collisionless counterstreaming plasmas](#user-content-link51)
**Authors:** Alexis Marret, Frederico Fiuza

52. [A multiwavelength view of the nearby Calcium-Strong Transient SN 2025coe in the X-Ray, Near-Infrared, and Radio Wavebands](#user-content-link52)
...
53. [A highly ionised outflow in the X-ray binary 4U 1624-49 detected with XRISM](#user-content-link53)
**Authors:** M. D\'iaz Trigo (ESO), E. Caruso (SRON), E. Costantini (SRON), T. Dotani (JAXA), T. Kohmura (Tokyo University), M. Shidatsu (Ehime University), M. Tsujimoto (JAXA), T. Yoneyama (JAXA), J. Neilsen (Villanova University), T. Yaqoob (NASA/GSFC, CRESST II, University of Maryland), J. M. Miller (University of Michigan)

54. [Hubble Study of the Proper Motion of HST-1 in the Jet of M87](#user-content-link54)
**Authors:** Rameshan Thimmappa, Joey Neilsen, Daryl Haggard, Michael A. Nowak, {\L}ukasz Stawarz

55. [Predicted incidence of Jupiter-like planets around white dwarfs](#user-content-link55)
**Authors:** Alex Mauch-Soriano, Matthias R. Schreiber, Diego Correa, Julio Pinilla, Catalina Riveros-Jara, Javiera Vivanco, Maria Paula Ronco, Diogo Belloni, Felipe Lagos-Vilches, Wolfgang Brandner

56. [Redshift-space 21-cm bispectrum multipoles as an SKA-era gravity test in the post-reionization Universe](#user-content-link56)
**Authors:** Sourav Pal, Debanjan Sarkar

57. [Appraising the Necklace: A post-common-envelope carbon dwarf inside an apparently carbon-poor planetary nebula](#user-content-link57)
**Authors:** David Jones, Romano L. M. Corradi, Gustavo A. Garc\'ia P\'erez, Christophe Morisset, Jorge Garc\'ia-Rojas, Laurence Sabin, Bruce Balick, Jacob Wise, Antonio Mampaso, James Munday, Pablo Rodr\'iguez-Gil, Mar\'ia del Mar Rubio-D\'iez, Miguel Santander-Garc\'ia, Paulina Sowicka, Alexander Csukai, Todd C. Hillwig, Andrea Henderson de la Fuente, Jacco H. Terwel

58. [The Milky Way's circular velocity curve measured using element abundance gradients](#user-content-link58)
**Authors:** Danny Horta, Adrian M. Price-Whelan, Sergey E. Koposov, Jason A. S. Hunt, David W. Hogg, Carrie Filion, Kathryn J. Daniel

59. [Spiral Density Waves and Torque Balance in the Kerr Geometry](#user-content-link59)
**Authors:** Conor Dyson, Daniel J. D'Orazio

60. [STONKS first results: Long-term transients in the XMM-Newton Galactic plane survey](#user-content-link60)
**Authors:** Robbie Webbe, E. Quintin, N. A. Webb, Gabriele Ponti, Tong Bao, Chandreyee Maitra, Shifra Mandel, Samaresh Mondal

61. [Discovery of Galactic center ejected star in DESI DR1](#user-content-link61)
**Authors:** Manuel Cavieres, Sergey E. Koposov, Elena Maria Rossi, Zephyr Penoyre, Sill Verberne

62. [A near-infrared stellar atlas of the Galactic plane from the VVVX survey](#user-content-link62)
**Authors:** Javier Alonso-Garc\'ia, Maren Hempel, Roberto K. Saito, Dante Minniti, Nicholas J. G. Cros, Jorge Anais, Jura Borissova, M\'arcio Catelan, Jos\'e G. Fern\'andez-Trincado, Elisa R. Garro, Zhen Guo, Philip W. Lucas, Mar\'ia G. Navarro, Casmir O. Obasi, Leigh C. Smith

63. [Energetic Ceilings of Astrophysical Gravitational-Wave Backgrounds](#user-content-link63)
**Authors:** Chiara M. F. Mingarelli

64. [Uncertainties in Low-Count STIS Spectra](#user-content-link64)
**Authors:** Joshua D. Lothringer, Leonardo dos Santos, Joleen Carlberg, Sean Lockwood, Jacqueline Brown

65. [Reconstructing inflation in Einstein-Gauss-Bonnet gravity in light of ACT data](#user-content-link65)
**Authors:** Ram\'on Herrera, Carlos R\'ios

66. [Latent characterisation of the complete BATSE gamma ray bursts catalogue using Gaussian mixture of factor analysers and model-estimated overlap-based syncytial clustering](#user-content-link66)
**Authors:** Fan Dai, Ranjan Maitra

67. [Constraining FRB Microstructure with Polarised Shot Noise](#user-content-link67)
**Authors:** J. C. F. Balzan, A. Bera, C. W. James, B. Meyers

68. [Induced Scattering of Fast Radio Bursts in Magnetar Magnetospheres](#user-content-link68)
**Authors:** Rei Nishiura, Shoma F. Kamijima, Kunihito Ioka

69. [Towards a Comprehensive Understanding of Planetary Systems through Population-Level, Large-Scale Surveys](#user-content-link69)
**Authors:** Francisco J. Pozuelos, Pedro J. Amado, Jes\'us Aceituno, Marina Centenera-Merino, Stefan Cikota, Javier Flores, Julius G\"ohring, Sergio Le\'on-Saval, Kalaga Madhav, Giuseppe Morello, Abani Nayak, Jose L. Ortiz, David P\'erez-Medialdea, Mar\'ia Isabel Ruiz-L\'opez, Miguel A. S\'anchez-Carrasco, Alejandro S\'anchez-L\'opez

70. [Signatures of Large-Scale Magnetic Field Disturbances and Switchbacks in Interplanetary Type III Radio Bursts](#user-content-link70)
**Authors:** Daniel L. Clarkson, Eduard P. Kontar

71. [Mercury-Opal: the GPU-accelerated version of the n-body code for planet formation Mercury-Arxes](#user-content-link71)
**Authors:** Paolo Simonetti, Diego Turrini, Romolo Politi, Scig\'e J. Liu, Sergio Fonte, Danae Polychroni, Stavro Lambrov Ivanovski

72. [On the rarity of rocket-driven Penrose extraction in Kerr spacetime](#user-content-link72)
**Authors:** An T. Le

73. [A thin disk and a nearly universal accretion rate in luminous quasars](#user-content-link73)
**Authors:** G. Risaliti, B. Trefoloni, M. Salvati

74. [A study of dark matter-dark energy interaction under the DESI DR2 data constraint](#user-content-link74)
**Authors:** Amin Aboubrahim, Pran Nath

75. [Development of Electroformed X-ray Optics Bridging Synchrotron Technology and Space Astronomy](#user-content-link75)
...
76. [Single-wave solutions of the neutrino fast flavor system. Part II. Weak instabilities and their resonant behavior](#user-content-link76)
**Authors:** Damiano F. G. Fiorillo, Georg G. Raffelt

77. [Development of Low-Noise Two-stage dc-SQUID for TES Detector Readout](#user-content-link77)
...
78. [Silicon-based vacuum window for millimeter and submillimeter-wave astrophysics](#user-content-link78)
**Authors:** Ryota Takaku, Scott Cray, Kosuke Aizawa, Akira Endo, Shaul Hanany, Kenichi Karatsu, J\"urgen Koch, Kuniaki Konishi, Tomotake Matsumura, Haruyuki Sakurai

79. [Reconsidering the consistent use of precessing, higher order multipole models for gravitational wave analyses](#user-content-link79)
**Authors:** Charlie Hoy

80. [Dynamical and observational properties of weakly Proca-charged black holes](#user-content-link80)
**Authors:** Abylaikhan Tlemissov, Arman Tursunov, Ji\v{r}\'i Kov\'a\v{r}, Zden\v{e}k Stuchl\'ik

81. [Dark energy and a new realization of the matter Lagrangian](#user-content-link81)
**Authors:** Shahab Shahidi, Sedigheh Farahzad

82. [Effect of noise characterization on the detection of mHz stochastic gravitational waves](#user-content-link82)
**Authors:** Nikolaos Karnesis, Quentin Baghi, Jean-Baptiste Bayle, Nikiforos Galanis

83. [Continued activity of the 25th cycle: largest in 20 years. Ground-level enhancement and Forbush decrease](#user-content-link83)
**Authors:** B. Sargsyan, A. Chilingarian

84. [Atomic clocks and gravitational waves as probes of non-metricity](#user-content-link84)
**Authors:** Mohsen Khodadi, Emmanuel N. Saridakis

85. [Cosmic Rays as an Interdisciplinary Earth Observation Tool: From Particle Physics and Atmospheric Processes to Geosciences and Urban Science](#user-content-link85)
**Authors:** Bugra Bilin, Nuhcan Ak\c{c}it

---

## 1. [Prompt cusps in hierarchical dark matter halos: Implications for annihilation boost](https://arxiv.org/abs/2601.19863) <a id="link1"></a>
...
**Comment:** Directly relevant to near-field cosmology: discusses the survival and impact of prompt cusps in hierarchical dark matter halos, including Milky Way-size hosts, and implications for dark matter annihilation. Uses semi-analytic substructure framework and merger-tree evolution, which is highly relevant for substructure and core-cusp problems.
...
## 2. [Proof that the Milky Way experienced a significant merger only 1.5 billion years after the Big Bang](https://arxiv.org/abs/2601.18896) <a id="link2"></a>
...
**Comment:** This paper provides evidence for a significant early merger in the Milky Way's history using precise age determinations of globular clusters. It directly addresses near-field cosmology by tracing the merger history of the Milky Way and identifying accreted stellar populations, making it highly relevant. The use of HST data and identification of a previously debated merger event adds substantial novelty.
...
## 3. [Statistical Predictions of the Accreted Stellar Halos around Milky Way-Like Galaxies](https://arxiv.org/abs/2601.18954) <a id="link3"></a>
...
**Comment:** Directly matches the 'Near-Field Cosmology' criterion: statistical predictions of accreted stellar halos around Milky Way-like galaxies, using semi-analytic modeling to study the assembly and observable properties of stellar halos. Also relevant to numerical galaxy simulations and the study of accreted stellar components.
...
## 4. [Variations in the Milky Way's Stellar Mass Function at [Fe/H] < -1](https://arxiv.org/abs/2601.19522) <a id="link4"></a>
...
**Comment:** Presents the first determination of the Galactic stellar mass function for low-mass stars at [Fe/H] < -1, using Gaia and SDSS-V data. This is highly relevant for near-field cosmology, as it probes the stellar population of the Galactic halo and its metallicity dependence, which is crucial for understanding the formation history and initial mass function in the early Galaxy.
...
## 5. [Homogenous abundances of Mg, Si, Ca, and Ti for about 1500 red giants in 16 globular clusters from FLAMES spectra](https://arxiv.org/abs/2601.18878) <a id="link5"></a>
...
**Comment:** Derives homogenous abundances of Mg, Si, Ca, and Ti for red giants in globular clusters, including those accreted in the Milky Way. This is highly relevant to near-field cosmology, as it addresses the chemical abundances and accretion history of globular clusters, which are key to understanding the Milky Way's assembly and satellite populations.
...
## 6. [Uniform Forward-Modeling Analysis of Ultracool Dwarfs. IV. Benchmarking the Sonora Diamondback and Saumon & Marley (2008) Atmospheric Models Across Late-M, L, and T types with Low-Resolution 0.8-2.5 $\mu$m Spectroscopy](https://arxiv.org/abs/2601.18866) <a id="link6"></a>
...
**Comment:** This paper benchmarks two major atmospheric model grids for ultracool dwarfs and brown dwarfs, focusing on atmospheric parameters and cloud properties. It is highly relevant to the 'Stellar Models' criterion, as it presents new calibrations and systematic assessments of stellar atmosphere models, which are directly applicable to the core topic.
...
## 7. [An analysis of the J-method from the perspective of the AGB evolution](https://arxiv.org/abs/2601.19594) <a id="link7"></a>
...
**Comment:** Analyzes the J-method as a distance indicator for Local Group galaxies, focusing on the J region in the color-magnitude diagram of the LMC and SMC. Uses population synthesis and stellar evolution modeling to interpret the luminosity function. Directly relevant to resolved star formation histories and stellar models in dwarf galaxies (LMC/SMC).
...
## 8. [ERGO-ML: The assembly histories of HSC galaxy images via invertible neural networks, contrastive learning, and cosmological simulations](https://arxiv.org/abs/2601.19148) <a id="link8"></a>
...
**Comment:** Uses machine learning to infer merger/assembly histories of galaxies from optical images, trained on cosmological simulations (TNG, EAGLE). This fits the numerical galaxy simulations criterion and also touches on accreted stellar halo and merger history, which are relevant for near-field cosmology.
...
## 9. [An essential building block for cosmological zoom-in perturbation theory](https://arxiv.org/abs/2601.19812) <a id="link9"></a>
...
**Comment:** Discusses a hierarchical framework for cosmological zoom-in N-body simulations, directly referencing the zoom-in technique and its boundary conditions. This matches the 'Numerical Galaxy Simulations' criterion, especially as it relates to simulation methodology.
...
## 10. [Testing the inference of kinematics from mock JWST NIRSpec/MSA observations of TNG50 galaxies at $z\sim2-6$](https://arxiv.org/abs/2601.18890) <a id="link10"></a>
...
**Comment:** Uses TNG50 simulations to test kinematic inference for high-redshift galaxies. While it involves numerical galaxy simulations, the focus is on kinematics and not directly on the core topics (e.g., resolved star formation histories, dwarf galaxy quenching, or near-field cosmology). Relevant as a simulation study, but not a perfect match.
...
## 11. [The Solar Neighborhood LIV: 54 Orbits of M Dwarf Multiples within 30 Parsecs with Speckle Interferometry at SOAR](https://arxiv.org/abs/2601.18905) <a id="link11"></a>
...
**Comment:** This paper presents new orbital characterizations and dynamical mass measurements for M dwarf multiples in the solar neighborhood. The work contributes to refining the mass-luminosity relation for low-mass stars, which is relevant to the 'Stellar Models' criterion. However, it does not directly address galaxy evolution, star formation histories, or dwarf galaxy properties.
...
## 12. [Weak Lensing Approximation of Wave-optics Effects from General Symmetric Lens Profiles](https://arxiv.org/abs/2508.17486) <a id="link12"></a>
...
**Comment:** Presents a new framework for modeling wave-optics effects in gravitational lensing, with potential to probe low-mass halos with minimal baryonic content and dark matter properties. This is tangentially relevant to near-field cosmology and substructure, but does not directly address satellite galaxies, resolved SFHs, or other core topics.
...
## 13. [High resolution observations of 'dark' neutral hydrogen clouds in the Virgo cluster with the Very Large Array](https://arxiv.org/abs/2601.19011) <a id="link13"></a>
...
**Comment:** Observational study of 'dark' HI clouds in the Virgo cluster, including their association with faint optical counterparts and possible origins via ram-pressure stripping or tidal interactions. While it touches on gas clouds and galaxy interactions, it does not focus on dwarf satellites, resolved star formation histories, or CGM of dwarfs.
...
## 14. [Equation of State of Highly Asymmetric Neutron-Star Matter from Liquid Drop Model and Meson Polytropes](https://arxiv.org/abs/2601.19789) <a id="link14"></a>
...
**Comment:** This paper presents a unified equation of state for neutron-star matter using simple models, connecting microphysics to neutron star observables. While it is a stellar model, it is focused on neutron stars rather than stellar evolutionary tracks or atmospheres relevant to the prompt. Borderline relevance.
...
## 15. [Homogeneous abundance ratios of hydrostatic and explosive alpha-elements in globular clusters from high resolution optical spectroscopy](https://arxiv.org/abs/2601.18885) <a id="link15"></a>
...
**Comment:** This paper presents homogeneous abundance ratios of alpha-elements in globular clusters, discussing the hydrostatic to explosive alpha-element ratio (HEx ratio) and its implications for the initial mass function and early GC evolution. While globular clusters are not dwarf galaxies, the work touches on chemical evolution and accretion history, which is tangentially related to near-field cosmology. However, the main focus is on globular clusters rather than satellite galaxies or resolved star formation histories.
...
## 16. [AT2018cow Powered by a Shock in Aspherical Circumstellar Media](https://arxiv.org/abs/2601.18887) <a id="link16"></a>
...
**Comment:** Presents a quantitative model for AT2018cow, a fast blue optical transient, focusing on shock propagation in aspherical circumstellar media. Discusses mass loss, shock interaction, and multiwavelength emission. While relevant to star formation driven outflows and circumstellar medium, the focus is on a transient event, not on galaxy-scale outflows or dwarf galaxies.
...
## 17. [Lensing without mixing: Probing Baryonic Acoustic Oscillations and other scale-dependent features in cosmic shear surveys](https://arxiv.org/abs/2601.19696) <a id="link17"></a>
...
**Comment:** Focuses on extracting BAO and scale-dependent features from weak lensing surveys. While relevant for cosmological structure, it does not address near-field cosmology, dwarf galaxies, or the other core topics.
...
## 18. [Non-linear evolution in $f(R)$ gravity: iterative modelling of the Chameleon mechanism](https://arxiv.org/abs/2601.19108) <a id="link18"></a>
...
**Comment:** Explores non-linear evolution in f(R) gravity and the Chameleon mechanism, with iterative modeling of matter perturbations. While it touches on structure formation, it does not directly address galaxy simulations, dwarf galaxies, or the other core topics.
...
## 19. [Minkowski Functionals of the 21 cm Signal as a Probe of Primordial Features](https://arxiv.org/abs/2601.19450) <a id="link19"></a>
...
**Comment:** Uses morphological statistics (Minkowski Functionals) to probe primordial features in the 21 cm signal, focusing on cosmic dawn and reionization. While it involves simulations and cosmology, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations of the types specified.
...
## 20. [Multiwavelength Analysis of Six Luminous, Fast Blue Optical Transients](https://arxiv.org/abs/2601.18926) <a id="link20"></a>
...
**Comment:** This paper presents a multiwavelength analysis of fast blue optical transients (LFBOTs) in star-forming host galaxies, focusing on radio and X-ray emission and the circumburst medium. While it discusses star formation and outflows in the context of massive star progenitors, the work does not focus on dwarf galaxies, resolved star formation histories, or near-field cosmology. The relevance to 'Star Formation Driven Outflows' is marginal, as the main focus is on transient events rather than galaxy-scale feedback or mass-loading factors.
...
## 21. [How to interpret near-infrared polarisation spectra of active M dwarfs?](https://arxiv.org/abs/2601.19363) <a id="link21"></a>
...
**Comment:** Focuses on magnetic field analysis and modeling in M dwarfs using spectropolarimetric data and Zeeman Doppler imaging. While it involves stellar atmosphere modeling, the main focus is on magnetic field recovery techniques rather than new stellar models or evolutionary tracks.
...
## 22. [Exploring the effects of diffuse ionised gas in two local analogues of high-redshift star-forming galaxies](https://arxiv.org/abs/2601.19725) <a id="link22"></a>
...
**Comment:** This paper studies the effects of diffuse ionized gas on emission line ratios and metallicity measurements in two local analogues of high-redshift star-forming galaxies. While it discusses ISM conditions and feedback-driven shocks, the focus is not on dwarf satellites, resolved star formation histories, quenching, or CGM of dwarfs. The galaxies studied are not specified as dwarfs, and the work is more about metallicity diagnostics than the core topics.
...
## 23. [A complete survey of filaments in Cygnus X](https://arxiv.org/abs/2601.19524) <a id="link23"></a>
...
**Comment:** A complete survey of filaments in Cygnus X, focusing on filamentary structures, core mass functions, magnetic fields, and HII regions. The work is relevant to star formation processes in molecular clouds but does not address resolved star formation histories, dwarf galaxy properties, or galaxy-scale outflows. It is more focused on star formation in the ISM of a molecular cloud.
...
## 24. [Part II: Low Energy Galactic Neutrinos](https://arxiv.org/abs/2601.19015) <a id="link24"></a>
...
**Comment:** Studies low energy galactic neutrinos in the Milky Way, with implications for gravity and dark matter. While it touches on Milky Way dark matter, the focus is on fundamental physics and neutrino properties, not on near-field cosmology, satellite galaxies, or resolved star formation histories.
...
## 25. [CH3CCH as a thermometer in warm molecular gas](https://arxiv.org/abs/2601.19344) <a id="link25"></a>
...
**Comment:** The paper compares molecular thermometers (CH3CCH vs NH3) in massive star-forming regions. While it deals with molecular clouds and star formation, the focus is on massive star-forming regions rather than resolved star formation histories or dwarf galaxies. It does not present new stellar models.
...
## 26. [Testing the Equivalence Principle in Galaxy Clusters](https://arxiv.org/abs/2601.19861) <a id="link26"></a>
...
**Comment:** Tests the equivalence principle in galaxy clusters using gravitational redshift. While it probes dark matter properties, the focus is on galaxy clusters (high mass systems), not dwarf galaxies or near-field cosmology.
...
## 27. [Almanac: HMC sampling with bounded velocity](https://arxiv.org/abs/2601.19390) <a id="link27"></a>
...
**Comment:** Presents improvements to Hamiltonian Monte Carlo sampling for cosmological posterior distributions. While useful for cosmological data analysis, it does not directly address galaxy simulations or the other core topics.
...
## 28. [Fading Echoes of Interaction: Probing Centuries of Mass-Loss in Four Old Type IIn Supernovae](https://arxiv.org/abs/2601.19891) <a id="link28"></a>
...
**Comment:** This paper presents late-time X-ray and radio observations of old Type IIn supernovae to probe mass-loss histories of massive stars. While it discusses stellar feedback and mass-loss, it does not focus on galaxy-scale outflows, dwarf galaxies, or the CGM. The relevance to the prompt is limited.
...
## 29. [Spectrum of radiation from global strings and the relic axion density](https://arxiv.org/abs/2601.19463) <a id="link29"></a>
...
**Comment:** This paper focuses on axion production from global strings and its impact on relic axion density, which is relevant to cosmology but does not directly address near-field cosmology, resolved star formation histories, dwarf galaxy properties, or any of the other specified core topics. The work is more aligned with particle cosmology and early universe physics rather than the structure or evolution of galaxies or their satellites.
...
## 30. [Accelerating radio astronomy imaging with RICK: a step towards SKA-Mid and SKA-Low](https://arxiv.org/abs/2601.19714) <a id="link30"></a>
...
**Comment:** The paper presents a new high-performance radio imaging code for large radio interferometers. While it is relevant to astronomical data processing, it does not address galaxy simulations, star formation, or any of the core topics.
...
## 31. [Constraints on Primordial Black Holes from Galactic Diffuse Synchrotron Emissions](https://arxiv.org/abs/2601.19386) <a id="link31"></a>
...
**Comment:** Constrains primordial black holes using Galactic diffuse synchrotron emissions. While it involves cosmic-ray propagation and Galactic emission, it does not focus on galaxies, their satellites, star formation histories, or any of the core criteria.
...
## 32. [Low-frequency-selected Fast Radio Burst Host Galaxy Candidates](https://arxiv.org/abs/2601.19525) <a id="link32"></a>
...
**Comment:** This paper presents a pilot study on host galaxy environments of CHIME/FRBs using low-frequency radio data. While it discusses star formation rates and host galaxy identification, the focus is on FRB host galaxies, not specifically on dwarf galaxies, resolved star formation histories, or near-field cosmology. The connection to the core criteria is weak.
...
## 33. [A Catalog of 971 FR-I Radio Galaxies from the FIRST Survey via Hybrid Deep Learning and Ridgeline Flux Density Distribution Analysis](https://arxiv.org/abs/2601.19609) <a id="link33"></a>
...
**Comment:** Catalog of FR-I radio galaxies from FIRST survey, focusing on radio morphology and host galaxy properties. FR-I hosts are generally massive galaxies, not dwarfs, and the work does not address near-field cosmology, star formation histories, or galaxy simulations.
...
## 35. [Local environmental dependence on weak-lensing shear statistics](https://arxiv.org/abs/2601.19268) <a id="link35"></a>
...
**Comment:** This paper focuses on weak-lensing shear statistics and the impact of local environment on cosmological parameter inference. While it discusses large-scale structure and observer bias, it does not directly address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations. The connection to galaxy-scale physics is weak.
...
## 36. [Progenitor of the recoiling super-massive black hole RBH-1 identified using HST/JWST imaging](https://arxiv.org/abs/2601.18986) <a id="link36"></a>
...
**Comment:** Focuses on the progenitor of a recoiling supermassive black hole and galaxy mergers at z~0.96. While it discusses galaxy interactions, the main focus is on SMBH dynamics and mergers in a compact star-forming galaxy, not on dwarf satellites, resolved star formation histories, or near-field cosmology. No direct relevance to the core topics.
...
## 37. [Green's Function Formalism for Impurity-Induced Resonances in Sub-barrier Proton-Nucleus Scattering](https://arxiv.org/abs/2601.19374) <a id="link37"></a>
...
**Comment:** Develops a Green's function formalism for impurity-induced resonances in sub-barrier proton-nucleus scattering, motivated by stellar reaction rates. This is focused on nuclear physics and stellar reactions, not on galaxies or the core topics.
...
## 38. [Q-balls from thermal balls during a first-order phase transition: a numerical study](https://arxiv.org/abs/2601.19150) <a id="link38"></a>
...
**Comment:** This paper presents numerical simulations of Q-ball formation during a cosmological phase transition, with implications for dark matter. While it is a numerical simulation, it is not focused on galaxies, but rather on particle physics and early universe cosmology, so it does not match the core topics.
...
## 39. [Dynamical Evidence for a Billion Solar Mass Black Hole in Galaxy NGC 4061 from ALMA $^{12}$CO(2-1) Kinematics](https://arxiv.org/abs/2601.19842) <a id="link39"></a>
...
**Comment:** This paper presents a dynamical measurement of the supermassive black hole mass in NGC 4061 using ALMA CO kinematics. The focus is on a massive early-type galaxy and SMBH, which is outside the scope of near-field cosmology (which focuses on dwarfs and satellites), resolved star formation histories, or galaxy simulations relevant to the prompt.
...
## 40. [Maximum Energy of Particles Accelerated in GRB Afterglow Shocks](https://arxiv.org/abs/2601.19135) <a id="link40"></a>
...
**Comment:** This paper models particle acceleration in GRB afterglow shocks, focusing on the maximum energy of accelerated particles and implications for high-energy astrophysics. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 41. [Numerical simulations of black hole-neutron star mergers with equal and near-equal mass ratios](https://arxiv.org/abs/2601.19405) <a id="link41"></a>
...
**Comment:** Numerical simulations of black hole-neutron star mergers with equal and near-equal mass ratios, focusing on gravitational waveforms, remnant properties, and kilonova emission. The work is relevant to compact object mergers but does not address galaxy simulations, dwarf galaxies, or star formation histories.
...
## 42. [Large-scale Modeling of the Observed Power Spectrum Multipoles](https://arxiv.org/abs/2601.19438) <a id="link42"></a>
...
**Comment:** This paper presents a framework for modeling the observed power spectrum multipoles for large-scale structure surveys, focusing on wide-angle effects, redshift evolution, and survey window functions. While relevant for cosmological surveys, it does not address any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 43. [Banana Split: Improved Cosmological Constraints with Two Light-Curve-Shape and Color Populations Using Union3.1+UNITY1.8](https://arxiv.org/abs/2601.19854) <a id="link43"></a>
...
**Comment:** This paper improves cosmological constraints using two populations of SNe Ia, focusing on light-curve-shape and color distributions. While it advances SN cosmology, it does not address any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 44. [A nuclear disc at Cosmic Noon: evidence of early bar-driven galaxy evolution](https://arxiv.org/abs/2601.18871) <a id="link44"></a>
...
**Comment:** Studies bar-driven evolution and nuclear disc formation in high-redshift galaxies. Focus is on bar and nuclear disc, which are explicitly listed as irrelevant in the criteria. No direct connection to dwarf galaxies, resolved star formation histories, or quenching.
...
## 45. [Inside the cocoon: a comprehensive explanation of the spectra of Little Red Dots](https://arxiv.org/abs/2601.18864) <a id="link45"></a>
...
**Comment:** This paper analyzes the spectra of compact galaxies ('little red dots') at high redshift, attributing their properties to accreting supermassive black holes. The focus is on early universe compact galaxies and AGN, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 46. [Physical and Chemical Characterization of GY 91's Multi-ringed Protostellar Disk with ALMA](https://arxiv.org/abs/2601.18884) <a id="link46"></a>
...
**Comment:** This paper characterizes the physical and chemical properties of a multi-ringed protostellar disk (GY 91) with ALMA. The focus is on disk structure and planet formation, not on resolved star formation histories of galaxies, dwarf galaxies, or galaxy simulations.
...
## 47. [The MIRI Excess around Degenerates (MEAD) Survey II: A Probable Planet detected via IR Excess around WD 0644+025](https://arxiv.org/abs/2601.18965) <a id="link47"></a>
...
**Comment:** The paper reports a probable planetary companion detected via IR excess around a nearby white dwarf. The focus is on planetary system remnants and white dwarf properties, not on galaxy evolution, star formation histories, or dwarf galaxies.
...
## 48. [Beyond FINDCHIRP: Breaking the memory wall and optimal FFTs for Gravitational-Wave Matched-Filter Searches with Ratio-Filter Dechirping](https://arxiv.org/abs/2601.18835) <a id="link48"></a>
...
**Comment:** Presents computational improvements for gravitational-wave matched-filter searches. No connection to any of the specified astrophysical criteria.
...
## 49. [Gaia serial CTI modelling and radiation damage study](https://arxiv.org/abs/2601.19353) <a id="link49"></a>
...
**Comment:** Paper is about CCD radiation damage modeling for Gaia. While Gaia data is relevant for Milky Way studies, this work is focused on instrumentation and data calibration, not on near-field cosmology, star formation histories, or galaxy simulations.
...
## 50. [Chemically peculiar stars investigated by the BRITE Mission](https://arxiv.org/abs/2601.19782) <a id="link50"></a>
...
**Comment:** Presents photometric analysis of chemically peculiar stars to refine rotational periods and identify misclassifications. While it touches on stellar classification, it does not present new stellar models or evolutionary tracks, so only tangentially related.
...
## 51. [Energy partition in collisionless counterstreaming plasmas](https://arxiv.org/abs/2601.18988) <a id="link51"></a>
...
**Comment:** This paper studies energy partition in collisionless counterstreaming plasmas, relevant for environments like supernova remnants and AGN jets. However, it does not focus on galaxies, dwarf galaxies, or any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 52. [A multiwavelength view of the nearby Calcium-Strong Transient SN 2025coe in the X-Ray, Near-Infrared, and Radio Wavebands](https://arxiv.org/abs/2601.19018) <a id="link52"></a>
...
**Comment:** Multiwavelength study of a Calcium-Strong Transient (CaST) SN 2025coe, focusing on its circumstellar material and progenitor scenarios. The work is on supernovae, not on galaxies, star formation histories, or quenching, and does not match the core criteria.
...
## 53. [A highly ionised outflow in the X-ray binary 4U 1624-49 detected with XRISM](https://arxiv.org/abs/2601.19480) <a id="link53"></a>
...
**Comment:** Studies highly ionised outflows in an X-ray binary system, focusing on accretion disc winds. The outflow is not star-formation-driven nor related to galaxy-scale outflows, CGM, or dwarf galaxies.
...
## 54. [Hubble Study of the Proper Motion of HST-1 in the Jet of M87](https://arxiv.org/abs/2601.18893) <a id="link54"></a>
...
**Comment:** Studies the proper motion and emission of HST-1 in the jet of M87, a massive elliptical galaxy. The focus is on jet physics and AGN, not on dwarf galaxies, resolved SFHs, or near-field cosmology.
...
## 55. [Predicted incidence of Jupiter-like planets around white dwarfs](https://arxiv.org/abs/2601.19531) <a id="link55"></a>
...
**Comment:** Population synthesis of Jupiter-like planets around white dwarfs, focusing on the incidence and properties of substellar companions. While it discusses stellar evolution and planetary systems, it does not address galaxy formation, dwarf galaxies, or the other core topics.
...
## 56. [Redshift-space 21-cm bispectrum multipoles as an SKA-era gravity test in the post-reionization Universe](https://arxiv.org/abs/2601.18862) <a id="link56"></a>
...
**Comment:** This paper forecasts the use of the 21-cm bispectrum as a probe of gravity in the post-reionization universe, using SKA-like surveys. While it is cosmological and discusses large-scale structure, it does not focus on near-field cosmology, resolved star formation histories, or galaxy simulations relevant to the prompt. No direct connection to the core topics.
...
## 57. [Appraising the Necklace: A post-common-envelope carbon dwarf inside an apparently carbon-poor planetary nebula](https://arxiv.org/abs/2601.19382) <a id="link57"></a>
...
**Comment:** This paper studies the Necklace nebula, a post-common-envelope planetary nebula with a carbon dwarf companion. The focus is on binary evolution, carbon enrichment, and nebular abundances, which are not directly related to any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 58. [The Milky Way's circular velocity curve measured using element abundance gradients](https://arxiv.org/abs/2601.18876) <a id="link58"></a>
...
**Comment:** This paper measures the Milky Way's circular velocity curve using element abundance gradients, focusing on the disk's kinematics and chemical structure. The work is centered on the Milky Way disk and does not address satellite galaxies, resolved star formation histories, or dwarf galaxy properties, making it irrelevant to the core criteria.
...
## 59. [Spiral Density Waves and Torque Balance in the Kerr Geometry](https://arxiv.org/abs/2601.19123) <a id="link59"></a>
...
**Comment:** Focuses on relativistic accretion disks and EMRIs in Kerr geometry, relevant for black hole physics and LISA, but not for galaxy simulations, near-field cosmology, or dwarf galaxies.
...
## 60. [STONKS first results: Long-term transients in the XMM-Newton Galactic plane survey](https://arxiv.org/abs/2601.19328) <a id="link60"></a>
...
**Comment:** Presents a transient detection pipeline for XMM-Newton and results on X-ray transients in the Galactic plane. Focus is on high-energy transients, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 61. [Discovery of Galactic center ejected star in DESI DR1](https://arxiv.org/abs/2601.19866) <a id="link61"></a>
...
**Comment:** The discovery of a hypervelocity star ejected from the Galactic center is discussed. The focus is on the Galactic center and the Hills mechanism, which is explicitly listed as irrelevant in the criteria. No connection to dwarf galaxies, satellite systems, or near-field cosmology.
...
## 62. [A near-infrared stellar atlas of the Galactic plane from the VVVX survey](https://arxiv.org/abs/2601.19708) <a id="link62"></a>
...
**Comment:** Presents a near-infrared stellar atlas of the Galactic plane, focusing on the disk and bulge. The criteria specifically exclude work focused on the Milky Way disk and bulge.
...
## 63. [Energetic Ceilings of Astrophysical Gravitational-Wave Backgrounds](https://arxiv.org/abs/2601.18859) <a id="link63"></a>
...
**Comment:** This work derives energetic ceilings for astrophysical gravitational-wave backgrounds, focusing on black hole binaries and other compact object mergers. The topic is gravitational waves and black holes, not galaxy evolution, dwarf galaxies, or star formation.
...
## 64. [Uncertainties in Low-Count STIS Spectra](https://arxiv.org/abs/2601.18910) <a id="link64"></a>
...
**Comment:** This paper discusses uncertainty calculations for low-count STIS spectra, focusing on Poisson statistics and software tools for UV-dim sources. While it is technical and relevant for observational astronomy, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 65. [Reconstructing inflation in Einstein-Gauss-Bonnet gravity in light of ACT data](https://arxiv.org/abs/2601.18958) <a id="link65"></a>
...
**Comment:** Focuses on inflationary cosmology and Einstein-Gauss-Bonnet gravity, with reconstruction of cosmological parameters. No direct connection to near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 66. [Latent characterisation of the complete BATSE gamma ray bursts catalogue using Gaussian mixture of factor analysers and model-estimated overlap-based syncytial clustering](https://arxiv.org/abs/2601.19140) <a id="link66"></a>
...
**Comment:** Analyzes gamma-ray burst classification using statistical methods; does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 67. [Constraining FRB Microstructure with Polarised Shot Noise](https://arxiv.org/abs/2601.19254) <a id="link67"></a>
...
**Comment:** Presents a framework for modeling FRB microstructure using polarised shot noise. The focus is on FRB emission mechanisms, not on galaxies, star formation, or any of the core topics.
...
## 68. [Induced Scattering of Fast Radio Bursts in Magnetar Magnetospheres](https://arxiv.org/abs/2601.18865) <a id="link68"></a>
...
**Comment:** Investigates induced scattering of FRBs in magnetar magnetospheres. This is focused on compact object physics and plasma processes, not on galaxies or the core topics.
...
## 69. [Towards a Comprehensive Understanding of Planetary Systems through Population-Level, Large-Scale Surveys](https://arxiv.org/abs/2601.18841) <a id="link69"></a>
...
**Comment:** This white paper discusses the future of exoplanet population studies and the need for large-scale surveys. It is focused on exoplanet characterization and does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 70. [Signatures of Large-Scale Magnetic Field Disturbances and Switchbacks in Interplanetary Type III Radio Bursts](https://arxiv.org/abs/2601.19687) <a id="link70"></a>
...
**Comment:** This paper analyzes solar radio bursts and magnetic field disturbances in the heliosphere. It is focused on solar physics and does not address any of the core topics such as near-field cosmology, galaxy simulations, or stellar models.
...
## 71. [Mercury-Opal: the GPU-accelerated version of the n-body code for planet formation Mercury-Arxes](https://arxiv.org/abs/2601.19654) <a id="link71"></a>
...
**Comment:** Mercury-Opal is a GPU-accelerated n-body code for planet formation simulations. While it is a numerical simulation paper, its focus is on planetary formation rather than galaxy simulations, dwarf galaxies, or star formation histories.
...
## 72. [On the rarity of rocket-driven Penrose extraction in Kerr spacetime](https://arxiv.org/abs/2601.19616) <a id="link72"></a>
...
**Comment:** Focuses on energy extraction from Kerr black holes via the Penrose process, which is unrelated to any of the specified criteria (no connection to near-field cosmology, galaxy simulations, star formation, or stellar models).
...
## 73. [A thin disk and a nearly universal accretion rate in luminous quasars](https://arxiv.org/abs/2601.19412) <a id="link73"></a>
...
**Comment:** Examines accretion rates and disk models in luminous quasars, focusing on AGN physics and accretion disks. No connection to the specified criteria (no relevance to dwarf galaxies, star formation histories, or galaxy simulations).
...
## 75. [Development of Electroformed X-ray Optics Bridging Synchrotron Technology and Space Astronomy](https://arxiv.org/abs/2601.19188) <a id="link75"></a>
...
**Comment:** The paper presents the development of X-ray optics for astronomy and synchrotron applications. It is focused on instrumentation and does not address any of the core topics such as galaxy simulations, star formation, or dwarf galaxies.
...
## 76. [Single-wave solutions of the neutrino fast flavor system. Part II. Weak instabilities and their resonant behavior](https://arxiv.org/abs/2601.18880) <a id="link76"></a>
...
**Comment:** This paper studies neutrino flavor instabilities in dense media, relevant to supernova physics and fundamental particle processes. It does not address galaxy evolution, star formation, or any of the core topics.
...
## 77. [Development of Low-Noise Two-stage dc-SQUID for TES Detector Readout](https://arxiv.org/abs/2601.19565) <a id="link77"></a>
...
**Comment:** Development of a low-noise two-stage dc-SQUID for TES detector readout, aimed at CMB polarization telescopes. This is an instrumentation paper and does not address any of the core topics such as galaxy simulations, star formation, or near-field cosmology.
...
## 78. [Silicon-based vacuum window for millimeter and submillimeter-wave astrophysics](https://arxiv.org/abs/2601.19627) <a id="link78"></a>
...
**Comment:** Instrumentation paper on silicon-based vacuum windows for millimeter and submillimeter-wave astrophysics. No direct relevance to the core topics such as galaxy simulations, star formation, or near-field cosmology.
...
## 79. [Reconsidering the consistent use of precessing, higher order multipole models for gravitational wave analyses](https://arxiv.org/abs/2601.18916) <a id="link79"></a>
...
**Comment:** This paper discusses gravitational wave models and population inference for black holes, focusing on computational efficiency and accuracy. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or stellar models.
...
## 80. [Dynamical and observational properties of weakly Proca-charged black holes](https://arxiv.org/abs/2601.19409) <a id="link80"></a>
...
**Comment:** This paper studies the properties of weakly Proca-charged black holes and their observational implications, including the Galactic center. The focus is on black hole physics and not on any of the core topics such as near-field cosmology, galaxy simulations, or stellar models.
...
## 81. [Dark energy and a new realization of the matter Lagrangian](https://arxiv.org/abs/2601.18825) <a id="link81"></a>
...
**Comment:** This paper introduces a new realization of the matter Lagrangian to model dark energy, focusing on cosmological implications and constraints. It is a theoretical cosmology paper and does not address any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 82. [Effect of noise characterization on the detection of mHz stochastic gravitational waves](https://arxiv.org/abs/2601.19741) <a id="link82"></a>
...
**Comment:** Focuses on noise characterization for mHz stochastic gravitational wave detection with LISA. No connection to galaxy evolution, near-field cosmology, or star formation histories.
...
## 83. [Continued activity of the 25th cycle: largest in 20 years. Ground-level enhancement and Forbush decrease](https://arxiv.org/abs/2601.19289) <a id="link83"></a>
...
**Comment:** Discusses solar cycle events, cosmic ray modulation, and neutron/muon observations. No connection to galaxy evolution, near-field cosmology, or star formation histories.
...
## 84. [Atomic clocks and gravitational waves as probes of non-metricity](https://arxiv.org/abs/2601.19407) <a id="link84"></a>
...
**Comment:** The paper investigates non-metricity in spacetime using atomic clocks and gravitational waves. It is focused on fundamental physics and does not address any of the core topics such as galaxy evolution, star formation, or dwarf galaxies.
...
## 85. [Cosmic Rays as an Interdisciplinary Earth Observation Tool: From Particle Physics and Atmospheric Processes to Geosciences and Urban Science](https://arxiv.org/abs/2601.19265) <a id="link85"></a>
...
**Comment:** Review of cosmic rays as Earth observation tools, with applications in geosciences and urban science. No connection to galaxy evolution, near-field cosmology, or star formation histories.
