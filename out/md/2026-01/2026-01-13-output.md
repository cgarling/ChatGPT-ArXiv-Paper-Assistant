...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 54617    | 9062         | 63679   |
| **Cost**             | $0.11    | $0.07        | $0.18   |

Total arXiv papers: 236

Total scanned papers: 150

Total relevant papers: 109

**Table of contents with paper titles:**

1. [The Isaac Newton Telescope Monitoring Survey of Local Group Dwarf Galaxies-VIII. A Census of Long-Period Variable Stars across the Andromeda Dwarf Satellite System](#user-content-link1)
**Authors:** Hedieh Abdollahi, Atefeh Javadi, Jacco Th. van Loon, Iain McDonald, Mahdi Abdollahi, Elham Saremi, Habib G. Khosroshahi, L\'aszl\'o Moln\'ar, Hamidreza Mahani

2. [CASCO: Cosmological and AStrophysical parameters from Cosmological simulations and Observations IV. Testing warm dark matter cosmologies with galaxy scaling relations: A joint simulation-observation study using DREAMS simulations](#user-content-link2)
...
3. [Cosmological back-reaction of baryons on dark matter in the CAMELS simulations](#user-content-link3)
**Authors:** Matthew Gebhardt, Daniel Angl\'es-Alc\'azar, Shy Genel, Daisuke Nagai, Boon Kiat Oh, Isabel Medlock, Jonathan Mercedes-Feliz, Sagan Sutherland, Max E. Lee, Xavier Sims, Christopher C. Lovell, David N. Spergel, Romeel Dav\'e, Matthieu Schaller, Joop Schaye, Francisco Villaescusa-Navarro

4. [CAMELS Environments: The Impact of Local Neighbours on Galaxy Evolution across the SIMBA, IllustrisTNG, ASTRID, and Swift-EAGLE Simulations](#user-content-link4)
**Authors:** Xavier Sims, Daniel Angl\'es-Alc\'azar, Boon-Kiat Oh, Daisuke Nagai, Jonathan Mercedes-Feliz, Isabel Medlock, Yueying Ni, Christopher C. Lovell, Francisco Villaescusa-Navarro

5. [Impact of Nuclear Reaction Rates on Calcium Production in Population III Stars: A Global Analysis](#user-content-link5)
**Authors:** Qing Wang, Ertao Li, Yinwen Guan, Zhihong Li, Jianjun He, Liyong Zhang, Bing Guo, Youbao Wang, Yunju Li, Jun Su, Xiaodong Tang, Shipeng Hu, Yu Liu, Dong Xiang, Lei Yang, Weiping Liu

6. [Collision between molecular clouds IV: The role of feedback and magnetic field in head on collisions](#user-content-link6)
**Authors:** Tabassum S. Tanvir, Michael Y. Grudi\'c

7. [Joint Optical-HI mock catalogs and prospects for upcoming HI surveys](#user-content-link7)
**Authors:** Sauraj Bharti, Jasjeet Singh Bagla

8. [Emulator-Based Inference of Cosmological Subgrid Models](#user-content-link8)
**Authors:** Nesar Ramachandra, Nicholas Frontiere, Michael Buehlmann, Kelly R. Moran, J. D. Emberson, Katrin Heitmann, Salman Habib

9. [Testing subhalo abundance matching with galaxy kinematics](#user-content-link9)
**Authors:** Fedir Boreiko, Tariq Yasin, Harry Desmond, Richard Stiskalek, Matt J. Jarvis

10. [Star formation quenching precedes morphological transformation in COSMOS-WEB's richest galaxy groups](#user-content-link10)
**Authors:** Z. Ghaffari (INAF Trieste, Italy, IFPU, Italy), G. Gozaliasl (Aalto University, Finland, University of Helsinki, Finland), A. Biviano (INAF Trieste, Italy, IFPU, Italy), G. Toni (University of Bologna, Italy, University Heidelberg, Germany), S. Taamoli (UC Riverside, USA), M. Maturi (University Heidelberg, Germany, ITP Heidelberg, Germany), L. Moscardini (University of Bologna, Italy, INFN Bologna, Italy), A. Zacchei (INAF Trieste, Italy, IFPU, Italy), F. Gentile (CEA Paris-Saclay, France, INAF Bologna, Italy), M. Haas (Ruhr University Bochum, Germany), H. Akins (UT Austin, USA), R. C. Arango-Toro (LAM Marseille, France), Y. Cheng (University of Washington, USA), C. Casey (UC Santa Barbara, USA, DAWN, Denmark), M. Franco (CEA Paris-Saclay, France, UT Austin, USA), S. Harish (RIT, USA), H. Hatamnia (UC Riverside, USA), O. Ilbert (LAM Marseille, France), J. Kartaltepe (RIT, USA), A. H. Khostovan (University of Kentucky, USA, RIT, USA), A. M. Koekemoer (STScI, USA), D. Liu (Purple Mountain Observatory, China), G. A. Mamon (IAP Paris, France), H. J. McCracken (IAP Paris, France), J. McKinney (UT Austin, USA), J. Rhodes (Caltech/IPAC, USA), B. Robertson (UC Santa Cruz, USA), M. Shuntov (DAWN, Denmark, University of Geneva, Switzerland), L. Yang (RIT, USA)

11. [GA-NIFS: high prevalence of dusty and metal-enriched outflows in massive and luminous star-forming galaxies at $z\sim3-9$](#user-content-link11)
**Authors:** B. Rodr\'iguez Del Pino, S. Arribas, M. Perna, I. Lamperti, A. Bunker, S. Carniani, S. Charlot, F. D'Eugenio, R. Maiolino, H. \"Ubler, E. Bertola, T. B\"oker, G. Cresci, G. C. Jones, C. Marconcini, E. Parlanti, J. Scholtz, G. Venturi, S. Zamora

12. [A binary merger product as the direct progenitor of a Type II-P supernova](#user-content-link12)
...
13. [On the 3D time evolution of the dust size distribution in protostellar envelopes](#user-content-link13)
**Authors:** Maxime Lombart, Ugo Lebreuilly, Ana\"elle Maury

14. [The stellar initial mass function of nearby young moving groups](#user-content-link14)
**Authors:** Rafael Bertolotto-Stefanelli, Juan Jos\'e Downes, Genaro Su\'arez, Cecilia Mateu, Jonathan Gagn\'e, Carlos Rom\'an Z\'u\~niga

15. [More power on large scales](#user-content-link15)
**Authors:** Jeremy Mould

16. [Revealing the diversity of Type IIn supernova progenitors through their environments](#user-content-link16)
**Authors:** Zexi Niu, Ning-chen Sun, Emmanouil Zapartas, Conor L. Ransome, Justyn R. Maund, Cesar Rojas-Bravo, Jifeng Liu

17. [Modified Gravity and the Origin of the Excess Radio Galaxy Number-Count Dipole](#user-content-link17)
**Authors:** John. W. Moffat

18. [Galaxy Mergers in UNIONS -- II: Predicting Timescales in the Post-Merger Regime](#user-content-link18)
**Authors:** Leonardo Ferreira, Sara L. Ellison, David R. Patton, Shoshannah Byrne-Mamahit, Scott Wilkinson, Robert W. Bickley

19. [Emergent Complexity in Nuclear Reaction Networks: A Study of Stellar Nucleosynthesis through Chemical Organization Theory](#user-content-link19)
**Authors:** Pedro Maldonado-Lang, Cl\'ement Vidal

20. [First Submillimeter Lights from Dome A: Tracing the Carbon Cycle in the Feedback of Massive Stars](#user-content-link20)
...
21. [Nitrogen abundances in star-forming galaxies 2.2 Gyr after the Big Bang are not elevated](#user-content-link21)
...
22. [A free-fall-based switching criterion for P^3 T N-body methods in collisional stellar systems](#user-content-link22)
**Authors:** Long Wang, David M. Hernandez, Zepeng Zheng, Wanhao Huang

23. [Cosmoglobe DR2. IV. Modelling starlight in DIRBE with Gaia and WISE](#user-content-link23)
**Authors:** M. Galloway, E. Gjerl{\o}w, M. San, R. M. Sullivan, D. J. Watts, R. Aurvik, A. Basyrov, L. A. Bianchi, A. Bonato, M. Brilenkov, H. K. Eriksen, U. Fuskeland, K. A. Glasscock, L. T. Hergt, D. Herman, J. G. S. Lunde, A. I. Silva Martins, D. Sponseller, N. -O. Stutzer, H. Thommesen, V. Vikenes, I. K. Wehus, L. Zapelli

24. [Slow White Dwarf Mergers as a New Galactic Source of Trans-Iron Elements](#user-content-link24)
**Authors:** Umberto Battino, Claudia Lederer-Woods, Claudia Travaglio, Friedrich Konrad R\"opke, Brad Gibson

25. [Formation of massive multiple-star systems: early migration and mergers](#user-content-link25)
**Authors:** Sunmyon Chon, Alejandro Vigna-G\'omez

26. [Possible evidence for a pair-instability supernova nature of ultra-early JWST sources](#user-content-link26)
**Authors:** Andrea Ferrara, Stefano Carniani, Takahiro Morishita, Massimo Stiavelli

27. [Mati\`ere noire et (ou) gravitation modifi\'ee : une approche historique et \'epist\'emologique](#user-content-link27)
**Authors:** Benoit Famaey, Jonathan Freundlich

28. [New $H(z)$ measurement at Redshift = 0.12 with DESI Data Release 1](#user-content-link28)
**Authors:** Ze-fan Wang, Lei Lei, Yi-zhong Fan

29. [The converging gas flow around the infrared dark cloud G28.3](#user-content-link29)
**Authors:** H. Beuther, C. Gieser, H. Linz, Q. Zhang, S. Feng, A. Ahmadi, J. D. Soler, D. Semenov, M. R. A. Wells, S. Reyes-Reyes

30. [A Study of Two Type IIb Supernovae: SNe 2008aq and 2019gaf](#user-content-link30)
...
31. [AstroSat UV Deep Field IV. An Extended UV disk around a massive spiral galaxy at z=0.67](#user-content-link31)
**Authors:** Pushpak Pandey, Kanak Saha, Sanchayeeta Borthakur

32. [Numerical Study of Polytropes with n=1 and Differential Rotation](#user-content-link32)
**Authors:** T. L. Razinkova, A. V. Yudin, S. I. Blinnikov

33. [VLBI Observations of SN 2012au Reveal a Compact Radio Source a Decade Post Explosion](#user-content-link33)
...
34. [Constraining Inflation Models with Spinning Voids](#user-content-link34)
**Authors:** Geonwoo Kang (Seoul National University), Jounghun Lee (Seoul National University)

35. [Spec-o3: A Tool-Augmented Vision-Language Agent for Rare Celestial Object Candidate Vetting via Automated Spectral Inspection](#user-content-link35)
**Authors:** Minghui Jia, Qichao Zhang, Ali Luo, Linjing Li, Shuo Ye, Hailing Lu, Wen Hou, Dongbin Zhao

36. [Asymmetric distribution of Fe-peak elements in Cassiopeia A revealed by XRISM](#user-content-link36)
...
37. [Magnetic winds in resistive compact binary discs](#user-content-link37)
**Authors:** Marc Van den Bossche, Geoffroy Lesur, Guillaume Dubus

38. [Characterizing turbulence in galaxy clusters: defining turbulent energies and assessing multi-scale versus fixed-scale filters](#user-content-link38)
**Authors:** Lorenzo Maria Perrone, Thomas Berlok, Ewald Puchwein, Christoph Pfrommer

39. [Core Scouring Dynamics and Gravitational Wave Consequences: Constraints on Supermassive Black Hole Binary Hardening](#user-content-link39)
**Authors:** C. J. Harris, Kayhan G\"ultekin, Laura Blecha

40. [Tachyonic gravitational dark matter production after inflation](#user-content-link40)
**Authors:** Giorgio Laverda, Tom\'as Mendes, Javier Rubio

41. [Axion misalignment as a synchronization phenomenon](#user-content-link41)
**Authors:** Veronica Sanz

42. [Cosmoglobe DR2. V. Spatial correlations between thermal dust and ionized carbon emission in Planck HFI and COBE-DIRBE](#user-content-link42)
**Authors:** E. Gjerl{\o}w, R. M. Sullivan, R. Aurvik, A. Basyrov, L. A. Bianchi, A. Bonato, M. Brilenkov, H. K. Eriksen, U. Fuskeland, M. Galloway, K. A. Glasscock, L. T. Hergt, D. Herman, J. G. S. Lunde, M. San, A. I. Silva Martins, D. Sponseller, N. -O. Stutzer, H. Thommesen, V. Vikenes, D. J. Watts, I. K. Wehus, L. Zapelli

43. [The magnetic helicity driven solar-type dynamo](#user-content-link43)
**Authors:** V. V. Pipin

44. [Cosmoglobe DR2. VII. Towards a concordance model of large-scale thermal dust emission for microwave and infrared frequencies](#user-content-link44)
**Authors:** E. Gjerl{\o}w, R. M. Sullivan, R. Aurvik, A. Basyrov, L. A. Bianchi, A. Bonato, M. Brilenkov, H. K. Eriksen, U. Fuskeland, M. Galloway, K. A. Glasscock, L. T. Hergt, D. Herman, J. G. S. Lunde, M. San, A. I. Silva Martins, D. Sponseller, N. -O. Stutzer, H. Thommesen, V. Vikenes, D. J. Watts, I. K. Wehus, L. Zapelli

45. [The Hierarchical Structure of the Open Cluster NGC 752](#user-content-link45)
**Authors:** Delong Jia, Heng Yu, Zhengyi Shao, Lu Li

46. [Photometric Redshift Estimation Using Scaled Ensemble Learning](#user-content-link46)
...
47. [Masers and Broad-Line Mapping Favor Magnetically-Dominated AGN Accretion Disks](#user-content-link47)
**Authors:** Philip F. Hopkins, Dalya Baron, Joanna M. Piotrowska

48. [Strong Evidence for Dark Sector Interactions](#user-content-link48)
**Authors:** Tian-Nuo Li, William Giar\`e, Guo-Hong Du, Yun-He Li, Eleonora Di Valentino, Jing-Fei Zhang, Xin Zhang

49. [High-resolution simulations of non-thermal emission from LS 5039](#user-content-link49)
**Authors:** Ralf Kissmann, David Huber, Philipp Gschwandtner

50. [Temperature-Dependent CPT Violation: Constraints from Big Bang Nucleosynthesis](#user-content-link50)
**Authors:** Gabriela Barenboim, Anne-Katherine Burns

51. [Induced gravitational waves - beyond linear cosmological perturbation theory](#user-content-link51)
**Authors:** Raphael Picard

52. [Learning the relations between neutron star and nuclear matter properties with symbolic regression](#user-content-link52)
**Authors:** N. K. Patra, Tuhin Malik, Kai Zhou, Constan\c{c}a Provid\^encia

53. [A New Consistency Test for the $\Lambda$CDM Model using Radial and Transverse BAO Measurements](#user-content-link53)
**Authors:** Xing-Han A. Zhao, Zheng Cai

54. [Functionalization of Benzene Ices by Atomic Oxygen](#user-content-link54)
...
55. [Impact of a negative cosmological constant on the reconstruction of dark energy in light of DESI BAO data](#user-content-link55)
**Authors:** Hao Wang, Yun-Song Piao

56. [Expanding the C$_3$H$_6$O$_2$ Isomeric Interstellar Inventory: Discovery of Lactaldehyde and Methoxyacetaldehyde in G+0.693-0.027](#user-content-link56)
**Authors:** M. Sanz-Novo, V. M. Rivilla, I. Jim\'enez-Serra, L. Colzi, S. Zeng, A. Meg\'ias, D. San Andr\'es, \'A. L\'opez-Gallifa, A. Mart\'inez-Henares, Z. T. P. Fried, B. A. McGuire, S. Mart\'in, M. A. Requena-Torres, B. Tercero, P. de Vicente, L. Kolesnikov\'a, E. R. Alonso, E. J. Cocinero, J. C. Guillemin, I. Kleiner

57. [Generalized Bondi Accretion Flow with and without Outflow](#user-content-link57)
**Authors:** Dongho Han, Myeong-Gu Park

58. [CHEX-MATE: Relationship between X-ray and millimetre inferences of galaxy cluster temperature profiles](#user-content-link58)
**Authors:** F. De Luca, H. Bourdin, P. Mazzotta, G. Luzzi, M. G. Campitiello, M. De Petris, D. Eckert, S. Ettori, A. Ferragamo, W. Forman, M. Gaspari, F. Gastaldello, S. Ghizzardi, M. Gitti, S. T. Kay, J. Kim, L. Lovisari, J. F. Mac\'ias-P\'erez, B. J. Maughan, M. Mu\~noz-Echeverr\'ia, F. Oppizzi, E. Pointecouteau, G. W. Pratt, E. Rasia, M. Rossetti, H. Saxena, J. Sayers, M. Sereno

59. [Temporal variability of polarization in blazars](#user-content-link59)
**Authors:** Filippo Bolis, Emanuele Sobacchi, Fabrizio Tavecchio

60. [Multi-Physics Bayesian Analysis of Neutron Star Crust Using Relativistic Mean-Field Model](#user-content-link60)
**Authors:** Vishal Parmar, Ignazio Bombaci

61. [Popcorn in the sky: Identifying primordial black holes in the gravitational-wave background](#user-content-link61)
**Authors:** Eleni Bagui, S\'ebastien Clesse, Federico De Lillo, Alexander C. Jenkins, Mairi Sakellariadou

62. [Exoplanet characterization with NASA's Habitable Worlds Observatory](#user-content-link62)
**Authors:** Joanna K. Barstow, Beth Biller, Mei Ting Mak, Sarah Rugheimer, Amaury Triaud, Hannah R. Wakeford

63. [Landau damping of disturbances in nearly inviscid inflectional shear flows](#user-content-link63)
**Authors:** Evgeny V. Polyachenko, Ilia G. Shukhman, Michael Karp

64. [Deep Search for Joint Sources of Gravitational Waves and High-Energy Neutrinos with IceCube During the Third Observing Run of LIGO and Virgo](#user-content-link64)
**Authors:** The IceCube Collaboration, The LIGO Scientific Collaboration, The Virgo Collaboration, The KAGRA Collaboration

65. [Systematic Biases in Gravitational-Wave Parameter Estimation from Neglecting Orbital Eccentricity in Space-Based Detectors](#user-content-link65)
**Authors:** Jin-Zhao Yang, Jia-Hao Zhong, Tao Yang

66. [IndIGO-D: Probing Compact Binary Coalescences in the Decihertz GW Band](#user-content-link66)
**Authors:** Abhishek Sharma, Divya Tahelyani, Anand S. Sengupta, Sanjit Mitra

67. [Simulations of Electron Beam Interactions in Brown Dwarf Atmospheres](#user-content-link67)
**Authors:** Anna Zuckerman, J. Sebastian Pineda, David Brain, James Mang, Caroline Morley

68. [Viable f(R) Scenarios Unifying Inflation with Realistic Dynamical Dark Energy](#user-content-link68)
**Authors:** S. D. Odintsov, V. K. Oikonomou, G. S. Sharov

69. [Ruling Out Compact Jets as the Dominant Source of Radio Emission in Radio-quiet, High Eddington-ratio Active Galactic Nuclei](#user-content-link69)
**Authors:** Jeremiah D. Paul, Richard M. Plotkin

70. [The Structure of Poloidal Fields Embedded in Thin Disks](#user-content-link70)
**Authors:** Yossef Zenati, Ethan T. Vishniac, Amir Jafari

71. [Broad line regions behind haze: Intrinsic shape of Br$\gamma$ line and its origin in a type-1 Seyfert galaxy](#user-content-link71)
**Authors:** Keiichi Wada, Tohru Nagao, Taro Shimizu, Daryl Joe D. Santos, Jinyi Shangguan, Richard Davies

72. [Radio Morphing: Fast computation of inclined air shower radio emission](#user-content-link72)
**Authors:** Simon Chiche, Olivier Martineau-Huynh, Matias Tueros, Krijn D. de Vries

73. [Brightest GRB flare observed in GRB 221009A: bridge the last gap between flare and prompt emission in GRB](#user-content-link73)
...
74. [Chiroptical effect induced by gravitational waves](#user-content-link74)
**Authors:** Haorong Wu, Xilong Fan

75. [A Guided Unconditional Diffusion Model to Synthesize and Inpaint Radio Galaxies from FIRST, MGCLS and Radio Zoo](#user-content-link75)
**Authors:** R\'emi Potevineau, Emma Tolley, Verlon Etsebeth

76. [Rotation-dependent $I$-Love-$Q$-$\delta M$ relations in perturbation theory](#user-content-link76)
**Authors:** Eneko Aranguren

77. [What can be learnt from UHECR anisotropies observations Paper III: Update with new data and Galactic magnetic fields models](#user-content-link77)
**Authors:** D. Allard, J. Aublin, B. Baret, E. Parizot

78. [Strong Einstein-Hilbert Gravity Inflation and ACT Phenomenology](#user-content-link78)
**Authors:** V. K. Oikonomou, Eleni I. Manouri, Georgios Konstantellos

79. [Ultraviolet observations of atmospheric escape in exoplanets with the Habitable Worlds Observatory](#user-content-link79)
**Authors:** Leonardo A. Dos Santos, Eric D. Lopez

80. [The Energy-Duration Relationship in Astrophysical Self-Organized Criticality Systems](#user-content-link80)
**Authors:** Markus J. Aschwanden, Alexandre Araujo

81. [Evaluating the efficacy of a data cube treatment procedure for kinematic analyses: application to NGC 3115 and NGC 4699](#user-content-link81)
**Authors:** R. B. Menezes, L. D. B. Sonoda, Patr\'icia da Silva, A. T. Monteiro, T. V. Ricci, R. G. Bravo, D. D. V. Gueter, V. C. Parro

82. [Spectral Signatures of Spinning Dust from Grain Ensembles in Diverse Environments: A Combined Theoretical and Observational Study](#user-content-link82)
**Authors:** Zheng Zhang, Jens Chluba, Roke Cepeda-Arroita, Jos\'e Alberto Rubi\~no-Mart\'in

83. [Limits of vacuum-template subtraction for LISA massive black hole binary sources in realistic environments](#user-content-link83)
**Authors:** Lorenz Zwick

84. [Cosmological Dynamics on a Novel $f(Q)$ Gravity Model with Recent DESI DR2 Observation](#user-content-link84)
**Authors:** S. A. Kadam, D. Revanth Kumar, Santosh Kumar Yadav

85. [Bringing Computation to the data: Interoperable serverless function execution for astrophysical data analysis in the SRCNet](#user-content-link85)
...
86. [In-ice Radio Signatures of Cosmic Ray Particle Cascades](#user-content-link86)
**Authors:** Simon Chiche, Simona Toscano, Krijn D. de Vries

87. [Brahe: A Modern Astrodynamics Library for Research and Engineering Applications](#user-content-link87)
**Authors:** Duncan Eddy, Mykel J. Kochenderfer

88. [A Unified Charge-Dependent Modulation Model for AMS-02 Proton and Antiproton Fluxes during Solar Minimum](#user-content-link88)
**Authors:** Hui-Ming Zhang, Su-Jie Lin, Jie Feng, Jie-Teng Jiang, Li-Li Yang

89. [The Role of Interferometric Phase in Measuring Black Hole Photon Rings](#user-content-link89)
**Authors:** Sol Guti\'errez-Lara, Daniel C. M. Palumbo, Michael D. Johnson

90. [Does the radio-active phase of XTE~J1810$-$197 recur following the same evolutionary pattern?](#user-content-link90)
...
91. [The Potential Impact of Neuromorphic Computing on Radio Telescope Observatories](#user-content-link91)
**Authors:** Nicholas J. Pritchard, Richard Dodson, Andreas Wicenec

92. [First Multi-Constellation Observations of Navigation Satellite Signals in the Lunar Domain by Post-Processing L1/L5 IQ Snapshots](#user-content-link92)
...
93. [Timing Gamma-ray Pulsars using Gibbs Sampling](#user-content-link93)
**Authors:** Colin J. Clark, Serena Valtolina, Lars Nieder, Rutger van Haasteren

94. [Direct detection of the non-thermal X-ray emission from the Arches star cluster](#user-content-link94)
**Authors:** Roman Krivonos, Alexey Vikhlinin, Andrei Bykov, Sergey Sazonov, Ma\"ica Clavel

95. [Transiting exoplanets as the immediate future for population-level atmospheric science](#user-content-link95)
**Authors:** Joanna K. Barstow, Hannah R. Wakeford, Sarah L. Casewell, Vatsal Panwar

96. [Advanced computing for reproducibility of astronomy Big Data Science, with a showcase of AMIGA and the SKA Science prototype](#user-content-link96)
**Authors:** Juli\'an Garrido, Susana S\'anchez, Edgar Ribeiro Jo\~ao, Roger Ianjamasimanana, Manuel Parra, Lourdes Verdes-Montenegro

97. [Oscillatory Freeze from Inertial Holographic Dark Energy](#user-content-link97)
**Authors:** Swapnil Kumar Singh

98. [Kerr-Newman-de Sitter black holes in $f(R)$ gravity with constant curvature: horizon structure and extremality](#user-content-link98)
**Authors:** Alikram N. Aliev, G\"oksel Daylan Esmer

99. [Multi-wavelength properties of changing-state active galactic nuclei: I. the evolution of soft excess and X-ray continuum](#user-content-link99)
**Authors:** Arghajit Jana, Claudio Ricci, Alessia Tortosa, George Dimopoulos, Benny Trakhtenbrot, Franz E. Bauer, Matthew J. Temple, Michael Koss, Kriti Kamal Gupta, Hsian-Kuang Chang, Yaherlyn Diaz, Dragana Illic, Krist\'ina Kallov\'a, Elena Shablovinskaya

100. [Coordinate Systems and Transforms in Space Physics: Terms, Definitions, Implementations, and Recommendations for Reproducibility](#user-content-link100)
**Authors:** R. S. Weigel, A. Y. Shih, R. Ringuette, I. Christopher, S. M. Petrinec, S. Turner, R. M. Candey, G. K. Stephens, B. Cecconi

101. [SPHEREx Re-Observation of Interstellar Object 3I/ATLAS in December 2025: Detection of Increased Post-Perihelion Activity, Refractory Coma Dust, and New Coma Gas Species](#user-content-link101)
**Authors:** C. M. Lisse, YP. Bach, S. A. Bryan, P. M. Korngut, B. P. Crill, A. J. Cukierman, O. Dor\'e, A. Cooray, B. Fabinsky, A. L. Faisst, H. Hui, G. J. Melnick, C. H. Nguyen, Z. Rustamkulov, V. Tolls, M. W. Werner

102. [Radio Signatures of Cosmic-Ray Particle Showers in Deep In-Ice Antennas](#user-content-link102)
**Authors:** Simon Chiche, Krijn D. de Vries, Simona Toscano

103. [Uniform models of neutron and quark (strange) stars in General Relativity](#user-content-link103)
**Authors:** G. S. Bisnovatyi-Kogan, E. A. Patraman

104. [Turbulent Properties of Interplanetary Coronal Mass Ejections Observed by Solar Orbiter in the Inner Heliosphere](#user-content-link104)
**Authors:** Jyoti Sheoran, Supratik Banerjee, Vaibhav Pant, Dipankar Banerjee, M. Saleem Khan

105. [NASA Decadal Astrobiology Research and Exploration Strategy (NASA-DARES 2025) White Paper -- Habitable Worlds Observatory Living Worlds Science Cases: Research Gaps and Needs](#user-content-link105)
**Authors:** Niki Parenteau, Giada Arney, Eleanora Alei, Ruslan Belikov, Svetlana, Berdyugina, Dawn Cardace, Ligia F. Coelho, Kevin Fogarty, Kenneth Gordon, Jonathan Grone, Natalie Hinkel, Nancy Kiang, Ravi Kopparapu, Joshua Krissansen-Totton, Emilie LaFleche, Jacob Lustig-Yaeger, Eric Mamajek, Avi Mandell, Taro Matsuo, Connor Metz, Mark Moussa, Stephanie Olson, Lucas Patty, Bill Philpot, Sukrit Ranjan, Edward Schwieterman, Clara Sousa-Silva, Anna Grace Ulses, Sara Walker, Daniel Whitt

106. [Incorporating Wavefront Error, Wavefront Sensing and Control, and Sensitivities into Exposure Time Calculations for Future Space Missions with the Error Budget Software (EBS)](#user-content-link106)
**Authors:** Sarah Steiger, Pin Chen, Laurent Pueyo

107. [A COLIBRI Photometric Study of SN 2025bvm: A Normal, Slowly Declining Type Ia Supernova](#user-content-link107)
**Authors:** Diego Hernando Gonzalez-Buitrago, Maria Teresa Garcia-Diaz, Andres Eduardo Montoya-Olivo, Santiago Sanchez-Sanjuan, Hernan Avila-Mogollon

108. [A Study Revealing Physical Attributes of Supernova Remnant in G321.3-3.9](#user-content-link108)
**Authors:** Shaobo Zhang, Xianhuan Lei, Hui Zhu, Xueying Hu, Xiaohong Cui, Wenwu Tian, Haiyan Zhang, Dan Wu

109. [Brightness Characterization and Modeling for Amazon Leo Satellites](#user-content-link109)
**Authors:** Anthony Mallama, Richard E. Cole, Hui Zhi, Brad Young, Jay Respler, Olga Zamora, Michelle Dadighat

---

## 1. [The Isaac Newton Telescope Monitoring Survey of Local Group Dwarf Galaxies-VIII. A Census of Long-Period Variable Stars across the Andromeda Dwarf Satellite System](https://arxiv.org/abs/2601.06924) <a id="link1"></a>
...
**Comment:** Presents a comprehensive catalog of long-period variable stars in the spheroidal dwarf satellites of Andromeda, with implications for quenching timescales, stellar mass distributions, and mass-loss in dwarf galaxies. Directly matches the near-field cosmology criterion (focus on dwarf satellites), and is also relevant for resolved star formation histories and quenching.
...
## 2. [CASCO: Cosmological and AStrophysical parameters from Cosmological simulations and Observations IV. Testing warm dark matter cosmologies with galaxy scaling relations: A joint simulation-observation study using DREAMS simulations](https://arxiv.org/abs/2601.07543) <a id="link2"></a>
...
**Comment:** This paper presents a joint simulation-observation study using high-resolution Milky Way zoom-in runs and focuses on dwarf galaxies in the Local Volume, galaxy scaling relations, and the impact of warm dark matter. It directly addresses near-field cosmology, satellite luminosity functions, and uses numerical galaxy simulations with new physics (WDM). Strong match to criteria 1 and 5.
...
## 3. [Cosmological back-reaction of baryons on dark matter in the CAMELS simulations](https://arxiv.org/abs/2601.06258) <a id="link3"></a>
...
**Comment:** This paper investigates the back-reaction of baryons on dark matter in cosmological hydrodynamic simulations (CAMELS), including the impact of feedback and radiative cooling on dark matter profiles and clustering. It directly addresses numerical galaxy simulations and the impact of feedback models, which is a core topic. The analysis of multiple simulation suites and the focus on baryonic feedback effects make it highly relevant.
...
## 4. [CAMELS Environments: The Impact of Local Neighbours on Galaxy Evolution across the SIMBA, IllustrisTNG, ASTRID, and Swift-EAGLE Simulations](https://arxiv.org/abs/2601.06290) <a id="link4"></a>
...
**Comment:** Analyzes the impact of environment on galaxy evolution using multiple cosmological simulations, with specific attention to satellite galaxies, their gas fractions, star formation rates, and circumgalactic medium properties. Directly relevant to numerical galaxy simulations, satellite quenching, and CGM in dwarfs.
...
## 5. [Impact of Nuclear Reaction Rates on Calcium Production in Population III Stars: A Global Analysis](https://arxiv.org/abs/2601.07623) <a id="link5"></a>
...
**Comment:** Presents new stellar models for Population III stars, focusing on nucleosynthesis and the impact of nuclear reaction rates on calcium production. Directly matches the 'Stellar Models' criterion, with new evolutionary tracks and nucleosynthesis predictions.
...
## 6. [Collision between molecular clouds IV: The role of feedback and magnetic field in head on collisions](https://arxiv.org/abs/2601.06355) <a id="link6"></a>
...
**Comment:** Presents numerical simulations of cloud-cloud collisions, modeling individual star formation and feedback mechanisms, including radiative feedback and magnetic fields. Directly matches the 'Numerical Galaxy Simulations' criterion, with new physics models and high-resolution simulations.
...
## 7. [Joint Optical-HI mock catalogs and prospects for upcoming HI surveys](https://arxiv.org/abs/2601.06815) <a id="link7"></a>
...
**Comment:** This paper presents joint optical-HI mock catalogs for upcoming HI surveys, with applications to the HI mass function and scaling relations. The focus on HI in galaxies, the baryon cycle, and the circumgalactic medium (CGM) is directly relevant to the criteria, especially the CGM and star formation driven outflows. The mock catalogs and predictions for HI surveys are highly relevant.
...
## 8. [Emulator-Based Inference of Cosmological Subgrid Models](https://arxiv.org/abs/2601.07306) <a id="link8"></a>
...
**Comment:** Presents a new inference framework for calibrating cosmological subgrid models using high-fidelity emulators and simulations, including feedback and baryonic physics. Directly relevant to numerical galaxy simulations, especially those with new physics models.
...
## 9. [Testing subhalo abundance matching with galaxy kinematics](https://arxiv.org/abs/2601.07799) <a id="link9"></a>
...
**Comment:** Tests subhalo abundance matching using galaxy kinematics, specifically rotation velocities of disc galaxies and their connection to dark matter halo structure. Relevant to near-field cosmology (substructure, satellite luminosity function, core-cusp) and numerical galaxy simulations.
...
## 10. [Star formation quenching precedes morphological transformation in COSMOS-WEB's richest galaxy groups](https://arxiv.org/abs/2601.06297) <a id="link10"></a>
...
**Comment:** Directly addresses star formation quenching in galaxy groups, including mass-dependent and environmental quenching, with a focus on intermediate and low-mass galaxies. Discusses quenching timescales and morphological transformation, which fits the 'Star Formation Quenching' criterion, especially for lower-mass galaxies. Also touches on AGN feedback and environmental effects.
...
## 11. [GA-NIFS: high prevalence of dusty and metal-enriched outflows in massive and luminous star-forming galaxies at $z\sim3-9$](https://arxiv.org/abs/2601.06255) <a id="link11"></a>
...
**Comment:** Examines ionized outflows in massive, luminous star-forming galaxies at high redshift, focusing on mass-loading factors, dust, and metal enrichment. Directly matches the 'Star Formation Driven Outflows' criterion, though the galaxies are more massive than the LMC, so relevance is slightly reduced.
...
## 12. [A binary merger product as the direct progenitor of a Type II-P supernova](https://arxiv.org/abs/2601.06577) <a id="link12"></a>
...
**Comment:** The paper uses binary evolution simulations to explain the progenitor of a Type II-P supernova as a binary merger product. While it presents new stellar models and evolutionary tracks, the focus is on supernova progenitors rather than general stellar models. Relevant to criterion 4, but not a perfect match.
...
## 13. [On the 3D time evolution of the dust size distribution in protostellar envelopes](https://arxiv.org/abs/2601.07088) <a id="link13"></a>
...
**Comment:** Presents a new 3D MHD simulation framework for dust growth and dynamics in protostellar envelopes. This is a numerical simulation paper, but it focuses on star formation and dust evolution in protostellar environments, not galaxies. Marginal relevance to numerical simulation methods, but not directly to galaxy simulations.
...
## 14. [The stellar initial mass function of nearby young moving groups](https://arxiv.org/abs/2601.07184) <a id="link14"></a>

**ArXiv ID:** 2601.07184

**Authors:** Rafael Bertolotto-Stefanelli, Juan Jos\'e Downes, Genaro Su\'arez, Cecilia Mateu, Jonathan Gagn\'e, Carlos Rom\'an Z\'u\~niga

**Abstract:** The solar neighbourhood is populated by nearby, young moving groups (NYMGs) of stars that are candidates to be remnants of individual stellar clusters and associations, currently dispersing in the galactic disc. To derive the initial mass function (IMF) of a large sample of NYMGs, we developed and applied an algorithm that uses photometry and astrometry from Gaia DR3 to detect NYMGs in a kinematic space. We inferred individual masses from the photometry of both the detected and the previously known candidates. We estimated the IMFs for 33 groups, 30 of them for the first time, in an average mass range $0.1M_\odot<5$ with some groups going as low as $0.02~M_{\odot}$ and as high as $10~M_{\odot}$. We parameterized these IMFs using a log-normal for $m1~M_\odot$. We detected 4166 source candidate members of 44 known groups, including 2545 new candidates. We recovered 44-54\% of the literature candidates and estimated a contamination rate from old field stars of 16-24\%. The candidates of the detected groups distribute along young isochrones, which suggests that they are potential members of NYMGs. Parameterizations of both the average of the 33 IMFs based on our detections ($m_c=0.25\pm0.17~M_{\odot}$, $\sigma_c=0.45\pm0.17$, and $\alpha=-2.26\pm0.09$) and the one based on the known candidates from the literature ($m_c=0.22\pm0.14~M_{\odot}$, $\sigma_c=0.45\pm0.17$, and $\alpha=-2.45\pm0.06$) are in agreement with the IMF parameterization of the solar neighbourhood and young stellar associations. Our parameterization of the average IMF together with the distribution of the detected group members along young isochrones provide strong evidence suggesting that the NYMGs are remnants of individual stellar associations and clusters and that there are no systematic biases in our detection and in the literature in the range $0.1M_{\odot}<10$.

**Comment:** The paper derives the initial mass function (IMF) of nearby young moving groups using Gaia data. While it deals with stellar populations and IMF, it does not present new stellar models or focus on dwarf galaxies, resolved star formation histories, or quenching. The focus is on young moving groups in the solar neighborhood, not on satellite galaxies or near-field cosmology.
...
## 15. [More power on large scales](https://arxiv.org/abs/2601.07106) <a id="link15"></a>
...
**Comment:** The paper discusses the impact of primordial black holes (PBHs) as dark matter on large-scale structure formation and cosmological simulations. While it presents N-body simulations and discusses dark matter, the focus is on cosmological scales and PBHs, not on galaxy-scale simulations, dwarf galaxies, or near-field cosmology. It is tangentially relevant to numerical galaxy simulations but does not address the core topics directly.
...
## 16. [Revealing the diversity of Type IIn supernova progenitors through their environments](https://arxiv.org/abs/2601.07542) <a id="link16"></a>
...
**Comment:** This paper analyzes the environments of Type IIn supernovae to infer the diversity of their progenitors. While it touches on stellar evolution and environments, it does not present new stellar models or focus on galaxy-scale processes like star formation histories or quenching. The relevance is borderline due to possible implications for stellar models, but not a direct match.
...
## 17. [Modified Gravity and the Origin of the Excess Radio Galaxy Number-Count Dipole](https://arxiv.org/abs/2601.07487) <a id="link17"></a>
...
**Comment:** This paper explores modified gravity as an explanation for the excess radio galaxy number-count dipole. While it discusses large-scale structure and galaxy surveys, it does not focus on dwarf galaxies, satellite luminosity functions, or near-field cosmology. The relevance is borderline due to its connection to galaxy surveys, but not a direct match.
...
## 18. [Galaxy Mergers in UNIONS -- II: Predicting Timescales in the Post-Merger Regime](https://arxiv.org/abs/2601.07604) <a id="link18"></a>
...
**Comment:** Uses machine learning and simulations to predict post-merger timescales for galaxies, focusing on galaxies with stellar masses log(M_*/M_sun) >= 10. While it involves numerical galaxy simulations and merger-driven evolution, the focus is on higher mass galaxies, not dwarfs, and does not directly address the core topics.
...
## 19. [Emergent Complexity in Nuclear Reaction Networks: A Study of Stellar Nucleosynthesis through Chemical Organization Theory](https://arxiv.org/abs/2601.06143) <a id="link19"></a>
...
**Comment:** The paper presents a theoretical framework for understanding the emergence of complex structures in nuclear reaction networks relevant to stellar nucleosynthesis. While it is related to stellar evolution and nucleosynthesis, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale topics such as near-field cosmology, star formation histories, or quenching.
...
## 20. [First Submillimeter Lights from Dome A: Tracing the Carbon Cycle in the Feedback of Massive Stars](https://arxiv.org/abs/2601.07162) <a id="link20"></a>
...
**Comment:** The paper presents submillimeter observations of carbon phases in massive star-formation regions, focusing on the carbon cycle and feedback from massive stars. While it discusses ISM phase structure and feedback, the focus is on massive star-forming regions, not on dwarf galaxies, resolved star formation histories, or CGM.
...
## 22. [A free-fall-based switching criterion for P^3 T N-body methods in collisional stellar systems](https://arxiv.org/abs/2601.07425) <a id="link22"></a>
...
**Comment:** This paper introduces a new switching criterion for hybrid N-body simulations of collisional stellar systems, specifically star clusters. While it presents improvements in numerical methods for simulating star clusters, it does not focus on galaxy simulations or the evolution of dwarf galaxies, nor does it address star formation histories or quenching.
...
## 23. [Cosmoglobe DR2. IV. Modelling starlight in DIRBE with Gaia and WISE](https://arxiv.org/abs/2601.07831) <a id="link23"></a>
...
**Comment:** This paper models starlight emission in DIRBE data using Gaia and WISE, with stellar parameters and SEDs. While it involves stellar atmosphere models and SED fitting, the focus is on starlight in the Milky Way and not on galaxy formation, resolved star formation histories, or stellar evolutionary tracks for broader application.
...
## 25. [Formation of massive multiple-star systems: early migration and mergers](https://arxiv.org/abs/2601.06251) <a id="link25"></a>
...
**Comment:** Presents star-cluster formation simulations focusing on massive multiple-star systems and their migration/mergers. While it involves numerical simulations, the focus is on massive stars and clusters, not galaxies or dwarfs, so only a weak connection to the numerical galaxy simulations criterion.
...
## 26. [Possible evidence for a pair-instability supernova nature of ultra-early JWST sources](https://arxiv.org/abs/2601.07374) <a id="link26"></a>
...
**Comment:** Explores the nature of a JWST ultra-high redshift transient, possibly a pair-instability supernova from a Population III star. While interesting for early universe studies, it does not address near-field cosmology, resolved SFHs, or dwarf galaxies.
...
## 27. [Mati\`ere noire et (ou) gravitation modifi\'ee : une approche historique et \'epist\'emologique](https://arxiv.org/abs/2601.06592) <a id="link27"></a>
...
**Comment:** This is a historical and epistemological review of dark matter and modified gravity theories, discussing their implications for galaxy formation and evolution. While it touches on galaxy formation, it is a review and does not present new observational or theoretical results on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 28. [New $H(z)$ measurement at Redshift = 0.12 with DESI Data Release 1](https://arxiv.org/abs/2601.07345) <a id="link28"></a>
...
**Comment:** Uses full-spectrum fitting to estimate stellar ages and star-formation histories of massive, passively evolving galaxies to measure H(z). While it touches on resolved star formation histories, the focus is on massive galaxies and cosmological parameters, not dwarfs or satellites.
...
## 29. [The converging gas flow around the infrared dark cloud G28.3](https://arxiv.org/abs/2601.07407) <a id="link29"></a>
...
**Comment:** Studies converging gas flows and star formation in a massive infrared dark cloud. While it touches on star formation, it is not focused on resolved star formation histories or dwarf galaxies, and is more about molecular cloud dynamics.
...
## 30. [A Study of Two Type IIb Supernovae: SNe 2008aq and 2019gaf](https://arxiv.org/abs/2601.07450) <a id="link30"></a>
...
**Comment:** Studies two Type IIb supernovae, focusing on their photometric and spectroscopic properties and progenitor masses. While it touches on stellar evolution, it does not present new stellar models or address the other core topics.
...
## 31. [AstroSat UV Deep Field IV. An Extended UV disk around a massive spiral galaxy at z=0.67](https://arxiv.org/abs/2601.06581) <a id="link31"></a>
...
**Comment:** Focuses on extended UV disks and star formation in a massive spiral galaxy at z=0.67. While it discusses star formation in outer disks and cold gas accretion, the galaxy mass is much higher than the LMC and dwarfs, and does not focus on satellite galaxies, resolved star formation histories, or quenching in dwarfs. Only tangential relevance to star formation processes.
...
## 32. [Numerical Study of Polytropes with n=1 and Differential Rotation](https://arxiv.org/abs/2601.06905) <a id="link32"></a>
...
**Comment:** Numerical study of differentially rotating polytropes. While it involves stellar structure modeling, it does not present new stellar evolutionary tracks or atmosphere models, nor does it connect to the other core topics.
...
## 33. [VLBI Observations of SN 2012au Reveal a Compact Radio Source a Decade Post Explosion](https://arxiv.org/abs/2601.06278) <a id="link33"></a>
...
**Comment:** VLBI observations of a supernova remnant and possible pulsar wind nebula in an extragalactic system. While interesting, it does not address near-field cosmology, dwarf galaxies, or any of the core topics.
...
## 34. [Constraining Inflation Models with Spinning Voids](https://arxiv.org/abs/2601.06589) <a id="link34"></a>
...
**Comment:** Uses void galaxy rotation to constrain inflation models and the running of the scalar spectral index. While it uses galaxy simulations, the focus is on cosmological parameters and inflation, not galaxy evolution or the other core topics.
...
## 35. [Spec-o3: A Tool-Augmented Vision-Language Agent for Rare Celestial Object Candidate Vetting via Automated Spectral Inspection](https://arxiv.org/abs/2601.06498) <a id="link35"></a>
...
**Comment:** This paper presents a new vision-language agent for vetting rare celestial object candidates via automated spectral inspection. While it is a technical advance in data analysis for astronomy, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. The focus is on methodology for object identification, not on galaxy or stellar physics.
...
## 36. [Asymmetric distribution of Fe-peak elements in Cassiopeia A revealed by XRISM](https://arxiv.org/abs/2601.07394) <a id="link36"></a>
...
**Comment:** This paper presents XRISM observations of Cassiopeia A, focusing on the asymmetric distribution of Fe-peak elements. While it is relevant to supernova physics and nucleosynthesis, it does not address the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 37. [Magnetic winds in resistive compact binary discs](https://arxiv.org/abs/2601.06994) <a id="link37"></a>
...
**Comment:** This paper presents global 3D MHD simulations of thin accretion discs in compact binary systems, exploring magnetic winds and accretion/ejection regimes. While it involves high-resolution simulations, the focus is on accretion discs in binaries, not on galaxies or dwarf galaxy outflows.
...
## 38. [Characterizing turbulence in galaxy clusters: defining turbulent energies and assessing multi-scale versus fixed-scale filters](https://arxiv.org/abs/2601.06250) <a id="link38"></a>
...
**Comment:** Analyzes turbulence in the intracluster medium of galaxy clusters using simulations. While it discusses turbulence and simulation techniques, the focus is on massive clusters, not dwarf galaxies or near-field cosmology. No direct connection to the core topics.
...
## 39. [Core Scouring Dynamics and Gravitational Wave Consequences: Constraints on Supermassive Black Hole Binary Hardening](https://arxiv.org/abs/2601.07762) <a id="link39"></a>
...
**Comment:** This paper focuses on the dynamics of supermassive black hole binaries and their impact on galaxy stellar cores, using merger trees from cosmological simulations. While it discusses core mass deficits in galaxies, the context is massive galaxies with supermassive black holes, not dwarf galaxies or near-field cosmology. The focus is on black hole binary hardening and gravitational wave backgrounds, which are not part of the core criteria.
...
## 40. [Tachyonic gravitational dark matter production after inflation](https://arxiv.org/abs/2601.07670) <a id="link40"></a>
...
**Comment:** This paper proposes a new gravitational mechanism for non-thermal dark matter production after inflation, involving tachyonic instabilities. While it is a novel approach in cosmology and dark matter theory, it does not address near-field cosmology, galaxy simulations, or resolved star formation histories.
...
## 41. [Axion misalignment as a synchronization phenomenon](https://arxiv.org/abs/2601.07836) <a id="link41"></a>
...
**Comment:** This paper presents a new perspective on axion misalignment in the early Universe, drawing analogies to synchronization phenomena. While it is a novel approach to axion cosmology, it does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 42. [Cosmoglobe DR2. V. Spatial correlations between thermal dust and ionized carbon emission in Planck HFI and COBE-DIRBE](https://arxiv.org/abs/2601.07818) <a id="link42"></a>
...
**Comment:** This paper focuses on spatial correlations between thermal dust and ionized carbon emission in the ISM using Planck and COBE-DIRBE data. While it deals with ISM phase structure and dust, it does not address dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, or CGM. The focus is on large-scale ISM properties, not on the core topics.
...
## 44. [Cosmoglobe DR2. VII. Towards a concordance model of large-scale thermal dust emission for microwave and infrared frequencies](https://arxiv.org/abs/2601.07822) <a id="link44"></a>
...
**Comment:** This work models large-scale thermal dust emission using a four-component model fit to COBE-DIRBE data. While it involves ISM dust modeling, it does not address galaxy formation, resolved star formation histories, or the CGM of dwarf galaxies. The focus is on dust emission in the Milky Way, which is outside the core topics.
...
## 45. [The Hierarchical Structure of the Open Cluster NGC 752](https://arxiv.org/abs/2601.07127) <a id="link45"></a>
...
**Comment:** This paper studies the hierarchical structure and evolution of the open cluster NGC 752 using Gaia data. While it involves stellar dynamics and cluster evolution, it does not address dwarf galaxies, galaxy simulations, or star formation histories in galaxies.
...
## 46. [Photometric Redshift Estimation Using Scaled Ensemble Learning](https://arxiv.org/abs/2601.07292) <a id="link46"></a>
...
**Comment:** Describes a machine learning framework for photometric redshift estimation for faint galaxies. While useful for cosmological surveys, it does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 47. [Masers and Broad-Line Mapping Favor Magnetically-Dominated AGN Accretion Disks](https://arxiv.org/abs/2601.06253) <a id="link47"></a>
...
**Comment:** Paper focuses on accretion disk physics around supermassive black holes in AGN, not on galaxy-scale processes or dwarf galaxies. No direct relevance to any core criteria.
...
## 48. [Strong Evidence for Dark Sector Interactions](https://arxiv.org/abs/2601.07361) <a id="link48"></a>
...
**Comment:** Cosmological constraints on dark sector interactions using large-scale data. No direct connection to near-field cosmology, dwarf galaxies, or any of the core criteria.
...
## 49. [High-resolution simulations of non-thermal emission from LS 5039](https://arxiv.org/abs/2601.07501) <a id="link49"></a>
...
**Comment:** High-resolution simulations of non-thermal emission from a binary system (LS 5039). Focus is on particle acceleration and emission, not on galaxy-scale simulations or any core criteria.
...
## 51. [Induced gravitational waves - beyond linear cosmological perturbation theory](https://arxiv.org/abs/2601.07716) <a id="link51"></a>
...
**Comment:** Thesis on induced gravitational waves beyond linear cosmological perturbation theory, with a focus on primordial black holes and inflation. No direct connection to galaxy evolution, star formation, or the other core topics.
...
## 52. [Learning the relations between neutron star and nuclear matter properties with symbolic regression](https://arxiv.org/abs/2601.07727) <a id="link52"></a>
...
**Comment:** Uses symbolic regression and PCA to study the relationship between neutron star and nuclear matter properties. Focus is on dense matter physics, not galaxy evolution, star formation, or the other core topics.
...
## 54. [Functionalization of Benzene Ices by Atomic Oxygen](https://arxiv.org/abs/2601.07457) <a id="link54"></a>
...
**Comment:** This paper investigates the formation of oxygenated aromatics in cold astrophysical ices, with implications for star and planet formation chemistry. It does not address any of the core topics such as dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, or CGM.
...
## 55. [Impact of a negative cosmological constant on the reconstruction of dark energy in light of DESI BAO data](https://arxiv.org/abs/2601.06656) <a id="link55"></a>
...
**Comment:** This paper investigates the impact of a negative cosmological constant on dark energy reconstruction using DESI BAO data. It is focused on cosmological parameters and dark energy, not on galaxy-scale topics, dwarf galaxies, or any of the core criteria.
...
## 56. [Expanding the C$_3$H$_6$O$_2$ Isomeric Interstellar Inventory: Discovery of Lactaldehyde and Methoxyacetaldehyde in G+0.693-0.027](https://arxiv.org/abs/2601.07365) <a id="link56"></a>
...
**Comment:** Focuses on the detection of complex organic molecules in the Galactic center molecular cloud. This is not related to near-field cosmology, resolved star formation histories, dwarf galaxies, or any other core criteria.
...
## 57. [Generalized Bondi Accretion Flow with and without Outflow](https://arxiv.org/abs/2601.06397) <a id="link57"></a>
...
**Comment:** Generalized Bondi accretion flow models, with and without outflow, focused on black hole growth and accretion physics. Not relevant to galaxy-scale simulations or any core criteria.
...
## 58. [CHEX-MATE: Relationship between X-ray and millimetre inferences of galaxy cluster temperature profiles](https://arxiv.org/abs/2601.07653) <a id="link58"></a>
...
**Comment:** Focuses on galaxy clusters and their temperature profiles using X-ray and SZ observations. No direct connection to dwarf galaxies, resolved star formation histories, quenching, stellar models, or galaxy simulations. Cluster-scale work is outside the core topics.
...
## 59. [Temporal variability of polarization in blazars](https://arxiv.org/abs/2601.07387) <a id="link59"></a>
...
**Comment:** Investigates polarization variability in blazar jets, focusing on jet dynamics and synchrotron emission. No connection to galaxy evolution, star formation, or the other core topics.
...
## 61. [Popcorn in the sky: Identifying primordial black holes in the gravitational-wave background](https://arxiv.org/abs/2601.07774) <a id="link61"></a>
...
**Comment:** Studies gravitational wave backgrounds from primordial black holes. While it is cosmology-related, it does not address near-field cosmology, galaxy evolution, or any of the core topics.
...
## 62. [Exoplanet characterization with NASA's Habitable Worlds Observatory](https://arxiv.org/abs/2601.06233) <a id="link62"></a>
...
**Comment:** This paper is about exoplanet atmosphere characterization with the Habitable Worlds Observatory. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on exoplanet atmospheres and instrumentation.
...
## 63. [Landau damping of disturbances in nearly inviscid inflectional shear flows](https://arxiv.org/abs/2601.07656) <a id="link63"></a>
...
**Comment:** This paper investigates Landau damping in shear flows, drawing analogies to plasma and stellar systems. However, it does not address galaxy simulations, star formation, or any of the core topics. The focus is on fluid dynamics and theoretical physics.
...
## 64. [Deep Search for Joint Sources of Gravitational Waves and High-Energy Neutrinos with IceCube During the Third Observing Run of LIGO and Virgo](https://arxiv.org/abs/2601.07595) <a id="link64"></a>
...
**Comment:** This paper reports a search for joint sources of gravitational waves and high-energy neutrinos. The focus is on multi-messenger astronomy and compact object mergers, not on galaxy evolution, star formation histories, or dwarf galaxies.
...
## 65. [Systematic Biases in Gravitational-Wave Parameter Estimation from Neglecting Orbital Eccentricity in Space-Based Detectors](https://arxiv.org/abs/2601.07739) <a id="link65"></a>
...
**Comment:** This paper investigates biases in gravitational-wave parameter estimation due to neglecting orbital eccentricity in space-based detectors. The focus is on gravitational wave data analysis and compact binaries, not on galaxy evolution, star formation, or dwarf galaxies.
...
## 66. [IndIGO-D: Probing Compact Binary Coalescences in the Decihertz GW Band](https://arxiv.org/abs/2601.06956) <a id="link66"></a>
...
**Comment:** This paper discusses the IndIGO-D decihertz gravitational-wave mission concept and its prospects for detecting compact binary coalescences. The focus is on gravitational wave instrumentation and compact binaries, not on galaxy evolution, star formation, or dwarf galaxies.
...
## 67. [Simulations of Electron Beam Interactions in Brown Dwarf Atmospheres](https://arxiv.org/abs/2601.06420) <a id="link67"></a>
...
**Comment:** This paper presents Monte Carlo simulations of electron beam interactions in brown dwarf atmospheres, focusing on auroral emission processes. While it involves numerical simulations and stellar atmosphere modeling, brown dwarfs are not galaxies and the work does not address galaxy formation, evolution, or resolved star formation histories. It is not directly relevant to the core topics.
...
## 68. [Viable f(R) Scenarios Unifying Inflation with Realistic Dynamical Dark Energy](https://arxiv.org/abs/2601.06949) <a id="link68"></a>
...
**Comment:** This paper tests f(R) gravity models for cosmological evolution, focusing on inflation and dark energy epochs. It is a cosmology paper and does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 69. [Ruling Out Compact Jets as the Dominant Source of Radio Emission in Radio-quiet, High Eddington-ratio Active Galactic Nuclei](https://arxiv.org/abs/2601.06480) <a id="link69"></a>
...
**Comment:** This paper investigates the origin of radio emission in radio-quiet, high Eddington-ratio AGNs, ruling out compact jets as the dominant source. The focus is on AGN physics and accretion, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 70. [The Structure of Poloidal Fields Embedded in Thin Disks](https://arxiv.org/abs/2601.07031) <a id="link70"></a>
...
**Comment:** Studies poloidal magnetic fields in thin accretion disks, focusing on disk magnetospheres and magnetic field structure. No direct relevance to the specified criteria such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 71. [Broad line regions behind haze: Intrinsic shape of Br$\gamma$ line and its origin in a type-1 Seyfert galaxy](https://arxiv.org/abs/2601.07211) <a id="link71"></a>
...
**Comment:** This paper studies the broad-line region in a Seyfert galaxy using radiation-hydrodynamic simulations and radiative transfer. The focus is on AGN physics, BLR structure, and line broadening mechanisms, which are not related to the core topics such as dwarf galaxies, star formation histories, or galaxy-scale outflows.
...
## 72. [Radio Morphing: Fast computation of inclined air shower radio emission](https://arxiv.org/abs/2601.06418) <a id="link72"></a>
...
**Comment:** This paper introduces a fast semi-analytical tool for simulating radio emission from inclined air showers, relevant for cosmic ray detection. It does not address galaxy simulations, star formation, or any of the core topics.
...
## 73. [Brightest GRB flare observed in GRB 221009A: bridge the last gap between flare and prompt emission in GRB](https://arxiv.org/abs/2601.07688) <a id="link73"></a>
...
**Comment:** Analysis of gamma-ray burst flare emission, focusing on prompt and flare phases. Not relevant to any of the core criteria.
...
## 74. [Chiroptical effect induced by gravitational waves](https://arxiv.org/abs/2601.07179) <a id="link74"></a>
...
**Comment:** Theoretical proposal of a chiroptical effect induced by gravitational waves, with implications for probing gravity and parity violation. No connection to any core criteria.
...
## 75. [A Guided Unconditional Diffusion Model to Synthesize and Inpaint Radio Galaxies from FIRST, MGCLS and Radio Zoo](https://arxiv.org/abs/2601.07485) <a id="link75"></a>
...
**Comment:** Presents a machine learning method for generating and inpainting radio galaxy images. No connection to near-field cosmology, resolved star formation histories, quenching, stellar models, or galaxy simulations relevant to the prompt.
...
## 76. [Rotation-dependent $I$-Love-$Q$-$\delta M$ relations in perturbation theory](https://arxiv.org/abs/2601.07734) <a id="link76"></a>
...
**Comment:** Discusses theoretical relations between neutron star properties (moment of inertia, Love number, quadrupole moment) using perturbation theory. No connection to galaxy evolution, star formation, or near-field cosmology.
...
## 77. [What can be learnt from UHECR anisotropies observations Paper III: Update with new data and Galactic magnetic fields models](https://arxiv.org/abs/2601.07259) <a id="link77"></a>
...
**Comment:** Studies ultra-high-energy cosmic ray anisotropies and their connection to extragalactic sources and galactic magnetic fields. No direct relevance to the core topics of near-field cosmology, star formation histories, or galaxy simulations.
...
## 78. [Strong Einstein-Hilbert Gravity Inflation and ACT Phenomenology](https://arxiv.org/abs/2601.06946) <a id="link78"></a>
...
**Comment:** This paper discusses inflationary models and constraints from CMB and ACT data, focusing on modifications to gravity. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations. The focus is on early universe cosmology and gravity, which is outside the scope of the criteria.
...
## 79. [Ultraviolet observations of atmospheric escape in exoplanets with the Habitable Worlds Observatory](https://arxiv.org/abs/2601.06263) <a id="link79"></a>
...
**Comment:** This paper discusses ultraviolet observations of atmospheric escape in exoplanets with the Habitable Worlds Observatory. The focus is on exoplanet atmospheres and instrumentation, not on galaxy evolution, star formation histories, or dwarf galaxies.
...
## 81. [Evaluating the efficacy of a data cube treatment procedure for kinematic analyses: application to NGC 3115 and NGC 4699](https://arxiv.org/abs/2601.06718) <a id="link81"></a>
...
**Comment:** Focuses on kinematic analyses and data cube treatment for the central regions of two massive galaxies (NGC 3115 and NGC 4699), with emphasis on supermassive black hole mass measurements. Does not match any core criteria (no focus on dwarfs, resolved SFH, quenching, stellar models, or simulations of interest).
...
## 82. [Spectral Signatures of Spinning Dust from Grain Ensembles in Diverse Environments: A Combined Theoretical and Observational Study](https://arxiv.org/abs/2601.06270) <a id="link82"></a>
...
**Comment:** Examines anomalous microwave emission and spinning dust models in various ISM environments. While it discusses ISM phases, it does not address galaxy-scale processes, star formation histories, or CGM in dwarf galaxies. No relevant criteria matched.
...
## 83. [Limits of vacuum-template subtraction for LISA massive black hole binary sources in realistic environments](https://arxiv.org/abs/2601.06684) <a id="link83"></a>
...
**Comment:** Investigates gravitational wave dephasing due to gas accretion in massive black hole binaries for LISA. The focus is on GW signals and MBH binaries, not on galaxy evolution, dwarf galaxies, or star formation.
...
## 84. [Cosmological Dynamics on a Novel $f(Q)$ Gravity Model with Recent DESI DR2 Observation](https://arxiv.org/abs/2601.06438) <a id="link84"></a>
...
**Comment:** This paper investigates a modified gravity model using cosmological datasets to constrain parameters and study cosmic acceleration. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on cosmological parameters and dark energy.
...
## 85. [Bringing Computation to the data: Interoperable serverless function execution for astrophysical data analysis in the SRCNet](https://arxiv.org/abs/2601.07308) <a id="link85"></a>
...
**Comment:** The paper discusses serverless computing and function-as-a-service for astrophysical data analysis, with a focus on radio astronomy workflows and the SKA. It is a technical/methodological paper and does not address any of the core astrophysical topics.
...
## 86. [In-ice Radio Signatures of Cosmic Ray Particle Cascades](https://arxiv.org/abs/2601.06417) <a id="link86"></a>
...
**Comment:** Characterizes in-ice radio emission from cosmic-ray-induced particle showers for neutrino detection. No connection to galaxy evolution, star formation, or the other core topics.
...
## 87. [Brahe: A Modern Astrodynamics Library for Research and Engineering Applications](https://arxiv.org/abs/2601.06452) <a id="link87"></a>
...
**Comment:** Describes a modern astrodynamics library for satellite motion prediction. No direct relevance to any of the specified criteria such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 88. [A Unified Charge-Dependent Modulation Model for AMS-02 Proton and Antiproton Fluxes during Solar Minimum](https://arxiv.org/abs/2601.07649) <a id="link88"></a>
...
**Comment:** Develops a solar modulation model for cosmic ray fluxes. No direct relevance to near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 89. [The Role of Interferometric Phase in Measuring Black Hole Photon Rings](https://arxiv.org/abs/2601.06313) <a id="link89"></a>
...
**Comment:** Focuses on interferometric measurements of black hole photon rings, relevant to black hole imaging and spacetime metrics. No direct relevance to near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 90. [Does the radio-active phase of XTE~J1810$-$197 recur following the same evolutionary pattern?](https://arxiv.org/abs/2601.07173) <a id="link90"></a>
...
**Comment:** Observational study of a magnetar's radio-active phase and spin evolution. No direct relevance to near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 91. [The Potential Impact of Neuromorphic Computing on Radio Telescope Observatories](https://arxiv.org/abs/2601.07130) <a id="link91"></a>
...
**Comment:** Analysis of neuromorphic computing for radio telescope observatories, focusing on computational efficiency and RFI detection. No connection to any core astrophysical criteria.
...
## 92. [First Multi-Constellation Observations of Navigation Satellite Signals in the Lunar Domain by Post-Processing L1/L5 IQ Snapshots](https://arxiv.org/abs/2601.06081) <a id="link92"></a>
...
**Comment:** Reports on GNSS signal observations in the lunar domain for spacecraft autonomy. No connection to any core astrophysical criteria.
...
## 93. [Timing Gamma-ray Pulsars using Gibbs Sampling](https://arxiv.org/abs/2601.07592) <a id="link93"></a>
...
**Comment:** Presents a new method for timing gamma-ray pulsars using Gibbs sampling. The focus is on pulsar timing and noise modeling, not on galaxy evolution, star formation, or near-field cosmology.
...
## 94. [Direct detection of the non-thermal X-ray emission from the Arches star cluster](https://arxiv.org/abs/2601.07357) <a id="link94"></a>
...
**Comment:** Focuses on non-thermal X-ray emission from the Arches star cluster in the Galactic Center. The topic is not related to near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations. No relevant criteria matched.
...
## 95. [Transiting exoplanets as the immediate future for population-level atmospheric science](https://arxiv.org/abs/2601.06236) <a id="link95"></a>
...
**Comment:** This paper reviews the future of population-level atmospheric science using transiting exoplanets. It is focused on exoplanet atmospheres and does not address any of the core topics.
...
## 96. [Advanced computing for reproducibility of astronomy Big Data Science, with a showcase of AMIGA and the SKA Science prototype](https://arxiv.org/abs/2601.07439) <a id="link96"></a>
...
**Comment:** Discusses computational infrastructure and reproducibility for astronomy big data, with a focus on SKA. No direct connection to any of the core astrophysical topics (near-field cosmology, star formation histories, quenching, etc.).
...
## 97. [Oscillatory Freeze from Inertial Holographic Dark Energy](https://arxiv.org/abs/2601.07007) <a id="link97"></a>
...
**Comment:** Theoretical cosmology paper on holographic dark energy and cosmic expansion. No connection to galaxy evolution, star formation, or any of the core topics.
...
## 98. [Kerr-Newman-de Sitter black holes in $f(R)$ gravity with constant curvature: horizon structure and extremality](https://arxiv.org/abs/2601.06661) <a id="link98"></a>
...
**Comment:** Focuses on black hole solutions in modified gravity, specifically Kerr-Newman-de Sitter metrics. No direct connection to near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 99. [Multi-wavelength properties of changing-state active galactic nuclei: I. the evolution of soft excess and X-ray continuum](https://arxiv.org/abs/2601.07337) <a id="link99"></a>
...
**Comment:** Examines X-ray spectral evolution in changing-state AGN. No direct relevance to near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 100. [Coordinate Systems and Transforms in Space Physics: Terms, Definitions, Implementations, and Recommendations for Reproducibility](https://arxiv.org/abs/2601.07605) <a id="link100"></a>
...
**Comment:** Discusses coordinate systems and reproducibility in space physics. No direct relevance to any of the specified criteria.
...
## 101. [SPHEREx Re-Observation of Interstellar Object 3I/ATLAS in December 2025: Detection of Increased Post-Perihelion Activity, Refractory Coma Dust, and New Coma Gas Species](https://arxiv.org/abs/2601.06759) <a id="link101"></a>
...
**Comment:** Reports on SPHEREx observations of an interstellar object (3I/ATLAS) and its cometary activity. No connection to near-field cosmology, dwarf galaxies, resolved SFH, quenching, or galaxy simulations.
...
## 102. [Radio Signatures of Cosmic-Ray Particle Showers in Deep In-Ice Antennas](https://arxiv.org/abs/2601.06409) <a id="link102"></a>
...
**Comment:** Focuses on radio signatures of cosmic-ray particle showers in ice for neutrino detection experiments. No connection to any core criteria.
...
## 103. [Uniform models of neutron and quark (strange) stars in General Relativity](https://arxiv.org/abs/2601.07560) <a id="link103"></a>
...
**Comment:** Presents uniform models of neutron and strange stars, focusing on equations of state and mass limits. No connection to galaxy evolution, dwarf galaxies, or other core criteria.
...
## 104. [Turbulent Properties of Interplanetary Coronal Mass Ejections Observed by Solar Orbiter in the Inner Heliosphere](https://arxiv.org/abs/2601.06904) <a id="link104"></a>
...
**Comment:** Studies turbulent properties of interplanetary coronal mass ejections using Solar Orbiter data. No connection to near-field cosmology, resolved SFH, quenching, or galaxy simulations.
...
## 105. [NASA Decadal Astrobiology Research and Exploration Strategy (NASA-DARES 2025) White Paper -- Habitable Worlds Observatory Living Worlds Science Cases: Research Gaps and Needs](https://arxiv.org/abs/2601.06386) <a id="link105"></a>
...
**Comment:** White paper on the Habitable Worlds Observatory and astrobiology science cases. Focuses on exoplanet biosignatures and observatory design, not on galaxy evolution, near-field cosmology, or stellar models.
...
## 106. [Incorporating Wavefront Error, Wavefront Sensing and Control, and Sensitivities into Exposure Time Calculations for Future Space Missions with the Error Budget Software (EBS)](https://arxiv.org/abs/2601.06342) <a id="link106"></a>
...
**Comment:** Technical paper on exposure time calculations for future space missions, focused on instrumentation and error budgeting. No connection to any of the core astrophysical topics listed.
...
## 107. [A COLIBRI Photometric Study of SN 2025bvm: A Normal, Slowly Declining Type Ia Supernova](https://arxiv.org/abs/2601.07745) <a id="link107"></a>
...
**Comment:** Photometric study of a Type Ia supernova (SN 2025bvm). No connection to near-field cosmology, resolved SFH, quenching, or galaxy simulations.
...
## 108. [A Study Revealing Physical Attributes of Supernova Remnant in G321.3-3.9](https://arxiv.org/abs/2601.07170) <a id="link108"></a>
...
**Comment:** Radio analysis of a supernova remnant (G321.3-3.9), focusing on its morphology and distance. No connection to near-field cosmology, resolved SFH, quenching, or galaxy simulations.
...
## 109. [Brightness Characterization and Modeling for Amazon Leo Satellites](https://arxiv.org/abs/2601.07708) <a id="link109"></a>
...
**Comment:** Characterizes the brightness of Amazon Leo satellites and their impact on night sky observations. No connection to any of the core astrophysical topics.
