...
1. [Relatively Fast and Reasonably Furious: Evidence for Increased Burstiness in Smaller Halos at Cosmic Dawn](#user-content-link1)
**Authors:** Julian B. Mu\~noz, John Chisholm, Guochao Sun, Jenna Samuel, Jordan Mirocha, Emily Bregou, Alessandra Venditti, Mahdi Qezlou, Charlotte Simmonds, Ryan Endsley

2. [QED V: Variations in metal loading of galactic winds with element nucleosynthetic origin](#user-content-link2)
**Authors:** Aditi Vijayan, Mark R. Krumholz, Benjamin D. Wibking

3. [New CDM Crisis Revealed by Multi-Scale Cluster Lensing](#user-content-link3)
**Authors:** Priyamvada Natarajan, Barry T. Chiang, Isaque Dutra

4. [Galaxy interactions in void substructures: Morphology and stellar populations of two triplets from CAVITY](#user-content-link4)
**Authors:** G. M. Azevedo, A. L. Chies-Santos, R. Riffel, I. Perez, F. Ferrari, R. S. de Souza, M. Argudo-Fernand\'ez, B. Bidaran

5. [Thermal-timescale accretion does not always yield critical rotation in mass gainers](#user-content-link5)
...
6. [MUSEQuBES: Investigating the Physical and Chemical Properties of Circumgalactic Gas Around Ly$\alpha$ Emitters at $z \approx 3.3$](#user-content-link6)
**Authors:** Eshita Banerjee, Sowgat Muzahid, Joop Schaye, Sean D. Johnson, Sebastiano Cantalupo

7. [Sahyadri: A simulation suite for the cosmology dependence of the Cosmic Web](#user-content-link7)
**Authors:** Saee Dhawalikar (IUCAA), Shadab Alam (TIFR), Aseem Paranjape (IUCAA), Arka Banerjee (IISER Pune)

8. [Local Group analogues in a cosmological context -- I. Relating velocity structure to the cosmic web](#user-content-link8)
**Authors:** Kai Wang, Peder Norberg, Azadeh Fattahi, Louis E. Strigari

9. [The drastic impact of Eddington-limit induced mass ejections on massive star populations](#user-content-link9)
**Authors:** D. Pauli, N. Langer, A. Schootemeijer, P. Marchant, H. Jin, A. Ercolino, A. Picco, R. Willcox, H. Sana

10. [Revisiting the Great Attractor: The Local Group's streamline trajectory, cosmic velocity and dynamical fate](#user-content-link10)
**Authors:** Richard Stiskalek, Harry Desmond, Stuart McAlpine, Guilhem Lavaux, Jens Jasche, Michael J. Hudson

11. [Stellar Rotation in the First Six Million Years: Rotational Velocities and Radii Estimates of T Tauri Stars in IC 5070 and IC 348](#user-content-link11)
**Authors:** Laurin M. Gray, Katherine L. Rhode, Luisa M. Rebull

12. [First direct electron temperature measurement in [O II] zone in I Zw 18](#user-content-link12)
**Authors:** I. A. Zinchenko, J. M. V\'ilchez, C. Kehrig, P. Papaderos, J. E. M\'endez-Delgado

13. [Three Models of the Gravitational Potential of the Milky Way](#user-content-link13)
**Authors:** V. V. Bobylev, A. T. Bajkova, A. A. Smirnov

14. [Investigating quenching in Recently Quenched Elliptical galaxies with HI studies](#user-content-link14)
**Authors:** Deepak K. Deo, Daniel H. McIntosh, Sravani Vaddi, Kameswara B. Mantha, Ruta Kale, Alfonso G. Franco, Paul Rulis

15. [RotCurves: A PYTHON package for efficient modelling and fitting of galactic rotation curves at high-z](#user-content-link15)
**Authors:** A. Nestor Shachar, A. Sternberg, S. H. Price, N. M. F\"orster Schreiber, R. Genzel, L. J. Tacconi, H. \"Ubler, C. Barfety, A. Burkert, J. Chen, R. Davies, F. Eisenhauer, J. M. Espejo Salcedo, R. Herrera-Camus, J. B. Jolly, L. L. Lee, T. Naab, S. Pastras, C. Pulsoni, T. T. Shimizu, G. Tozzi

16. [Self-consistent dynamical models with a finite extent -- V. Smooth radial truncations and phase-space consistency](#user-content-link16)
**Authors:** Maarten Baes (UGent)

17. [Stellar masses of optically dark galaxies: uncertainty introduced by the attenuation law and star-formation histories](#user-content-link17)
**Authors:** Yash Lapasia, Sandro Tacchella, Francesco D'Eugenio, D\'avid Pusk\'as, Andrew J. Bunker, A. Lola Danhaive, Benjamin D. Johnson, Roberto Maiolino, Brant Robertson, Charlotte Simmonds, Irene Shivaei, Christina C. Williams, Christopher Willmer

18. [MUSE-ALMA Haloes XIII. Molecular gas in $z \sim 0.5$ HI-selected galaxies](#user-content-link18)
...
25. [Probing Dark Matter annihilation in the Galactic Centre with TRIDENT](#user-content-link25)
...
26. [On the Jeans criterion for hydrostatic and infalling gas](#user-content-link26)
**Authors:** Carlo Nipoti

27. [Evolution and afterglow emission of gamma-ray burst jets from binary neutron star mergers](#user-content-link27)
**Authors:** Emma Dreas, Om Sharan Salafia, Andrea Pavan, Riccardo Ciolfi, Annalisa Celotti

28. [A precessing jet from an active galactic nucleus drives gas outflow from a disk galaxy](#user-content-link28)
**Authors:** Justin A. Kader, Vivian U, Loreto Barcos-Mu\~noz, Marina Bianchin, Sean T. Linden, Yiqing Song, Gabriela Canalizo, Archana Aravindan, George C. Privon Tanio D\'iaz-Santos, Christopher Hayward, Matthew A. Malkan, Lee Armus, Rosalie C. McGurk, Jeffrey A. Rich, Anne M. Medling, Sabrina Stierwalt, Claire E. Max, Aaron S. Evans, Christopher J. Agostino, Vassilis Charmandaris, Tianmu Gao, Justin H. Howell, Hanae Inami, Thomas S. -Y. Lai, Kirsten L. Larson, Christopher D. Martin, Mateusz Matuszewski, Joseph M. Mazzarella, James D. Neill, Nikolaus Z. Prusinski, Raymond Remigio, David B. Sanders, Jason Surace

29. [Modeling Cosmogenic 10Be During the Heliosphere's Encounter with an Interstellar Cold Cloud](#user-content-link29)
**Authors:** Anna Nica, Merav Opher, Jesse Miller, Jennifer L. Middleton

30. [Signatures of a subpopulation of hierarchical mergers in the GWTC-4 gravitational-wave dataset](#user-content-link30)
**Authors:** Cailin Plunkett, Thomas Callister, Michael Zevin, Salvatore Vitale

31. [Evidence of Feedback Effects in Low-luminosity Active Galactic Nuclei Revealed by JWST Spectroscopy](#user-content-link31)
**Authors:** Lulu Zhang, Chris Packham, Erin K. S. Hicks, Ric I. Davies, Daniel E. Delaney, Francoise Combes, Miguel Pereira-Santaella, Almudena Alonso-Herrero, Claudio Ricci, Omaira Gonz\'alez-Mart\'in, Laura Hermosa Mu\~noz, Ismael Garc\'ia-Bernete, Cristina Ramos Almeida, Dimitra Rigopoulou, Fergus R. Donnan, Enrica Bellocchi, Nancy A. Levenson, Martin J. Ward, Santiago Garc\'ia-Burillo, Sebastian F. Hoenig

32. [Dense gas linked to star-forming regions photoionised by embedded gamma-ray bursts](#user-content-link32)
**Authors:** Aishwarya Linesh Thakur, Luigi Piro, Alfredo Luminari, Fabrizio Nicastro, Sandra Savaglio, Yair Krongold, Bruce Gendre

33. [A survey of molecular clouds in the Galactic center's outflow](#user-content-link33)
...
34. [Dust Properties of the Interstellar Object 3I/ATLAS Revealed by Optical and Near-Infrared Polarimetry](#user-content-link34)
**Authors:** Seungwon Choi, Masateru Ishiguro, Jun Takahashi, Tomoki Saito, Yoonsoo P. Bach, Bumhoo Lim, Hiroyuki Naito, Jooyeon Geem, Sunho Jin, Jinguk Seo, Hyeonwoo Ju, Hiroshi Akitakya, Koji S. Kawabata, Mahito Sasada, Kazuya Doi, Hisayuki Kubota, Seiko Takagi, Makoto Watanabe, Tomohiko Sekiguchi, Myungshin Im

35. [Relativistic jets from millisecond proto-magnetars](#user-content-link35)
**Authors:** Dhruv K. Desai, Luciano Combi, Daniel M. Siegel, Brian D. Metzger

36. [A persistent bow shock in a diskless magnetised accreting white dwarf](#user-content-link36)
**Authors:** Krystian Ikiewicz (CAMK PAN, Durham University), Simone Scaringi (Durham University, INAF - OACN), Domitilla de Martino (INAF - OACN), Christian Knigge (University of Southampton), Sara E. Motta (INAF-OAB, University of Oxford), Nanda Rea (ICE-CSIC, IEEC), David Buckley (SAAO, University of Cape Town, University of Free State), Noel Castro Segura (University of Warwick), Paul J. Groot (Radboud University Nijmegen, SAAO, University of Cape Town), Anna F. McLeod (Durham University), Luke T. Parker (University of Oxford), Martina Veresvarska (Durham University, ICE-CSIC, IEEC)

37. [Blind Deconvolution in Astronomy: How Does a Standalone U-Net Perform?](#user-content-link37)
**Authors:** Jean-Eric Campagne

38. [Baryon Acoustic Oscillations from the C IV Forest with DESI DR2](#user-content-link38)
**Authors:** Abby Bault, Andrei Cuceu, Julien Guy, J. Aguilar, S. Ahlen, D. Bianchi, A. Brodzeller, D. Brooks, R. Canning, E. Chaussidon, T. Claybaugh, R. de Belsunce, A. de la Macorra, Arjun Dey, P. Doel, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, C. Gordon, D. Green, G. Gutierrez, C. Hahn, H. K. Herrera-Alcantar, K. Honscheid, M. Ishak, R. Joyce, S. Juneau, D. Kirkby, A. Kremin, C. Lamman, M. Landriau, L. Le Guillou, M. E. Levi, M. Manera, P. Martini, A. Meisner, R. Miquel, J. Moustakas, A. Mu\~noz-Guti\'errez, S. Nadathur, N. Palanque-Delabrouille, W. J. Percival, Matthew M. Pieri, C. Poppett, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, H. Seo, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver

39. [Reconstructing Gamma Ray Burst Energy Relations with Observational H(z) data in Neural Network Framework](#user-content-link39)
**Authors:** Nilanjana Bagchi Aurpa, Abha Dev Habib, Nisha Rani

40. [A new magnitude--redshift relation based on SNe Ia](#user-content-link40)
**Authors:** \'Osmar Rodr\'iguez, Alejandro Clocchiatti

41. [The LIRA-Ising Model: Estimating the boundaries of irregularly shaped X-ray sources](#user-content-link41)
**Authors:** Kathryn McKeough, Vinay L. Kashyap, Aneta Siemiginowska, David A. Van Dyk, Shihao Yang, Xiao-Li Meng, Brendan Martin, Andreas Zezas

42. [Long Term (250 years) Hydrodynamical Simulation of the Supermassive Black Hole Binary OJ287](#user-content-link42)
**Authors:** Ariel Chitan, Sarah C. Gallagher, Shahram Abbassi

43. [Bifurcated Impact of Neutrino Fast Flavor Conversion on Core-collapse Supernovae Informed by Multi-angle Neutrino Radiation Hydrodynamics](#user-content-link43)
...
44. [Identification of three new ULXs in NGC 4631 and NGC 1097: evidence for stellar-mass black holes](#user-content-link44)
**Authors:** Sinan Allak, Aysun Akyuz, Yasemin Aladag, Lorenzo Ducci, Andrea Santangelo

45. [The Secret Lives of Open Clusters: a Multiwavelength Examination of Three Open Clusters](#user-content-link45)
**Authors:** Kristen C. Dage, Emily L. Hunt, Jasmine Anderson-Baldwin, Evangelia Tremou, Khushboo K. Rao, Kwangmin Oh, Malu Sudha, Jarrod Hurley, Robert D. Mathieu, Aarya Patil, Richard M. Plotkin, Andrew M. Hopkins, Jacco Th. van Loon, Jayde Willingham

46. [Polychromatic pyramid wavefront sensor with MKID technology for high contrast imaging](#user-content-link46)
**Authors:** Aur\'elie Magniez, Charlotte Z. Bond, Peter Wizinowich, TIm Morris, Kieran O'Brien

47. [Anatomy of Empirical Transit Spectra of Mars based on TGO/NOMAD](#user-content-link47)
**Authors:** Shohei Aoki, Yuka Fujii, Hideo Sagawa, Geronimo L. Villanueva, Ian Thomas, Bojan Ristic, Frank Daerden, Miguel Angel L\'opez-Valverde, Manish R. Patel, Jonathon Mason, Yannick Willame, Giancarlo Bellucci, Ann Carine Vandaele

48. [Diverse Origins of Broad H$\alpha$ Lines in Heavily Obscured AGNs Revealed by Multi-epoch Spectroscopy](#user-content-link48)
...
49. [Quantifying Symmetry: Transformation Information for Planetary Nebulae and Supernova Remnants](#user-content-link49)
**Authors:** Dmitry Shishkin, Amir Michaelis

50. [The GRB Intrinsic Duration Distribution: Progenitor Insights Across Cosmic Time](#user-content-link50)
**Authors:** Nicole M. Lloyd-Ronning, Omer Bromberg, Tsvi Piran

51. [Cascade Processes of Strong and Weak MHD Turbulence](#user-content-link51)
**Authors:** Na-Na Gao, Jian-Fu Zhang, Jungyeon Cho

52. [General gravitational properties of neutron stars: curvature invariants, binding energy, and trace anomaly](#user-content-link52)
**Authors:** Iv\'an Garibay, Christian Ecker, Luciano Rezzolla

53. [Chiral three-nucleon forces for the new local position-space two-nucleon potential in $\textit{ab initio}$ many-body calculations](#user-content-link53)
**Authors:** Rongzhe Hu, Jianguo Li, Siqin Fan, Furong Xu

54. [On the Interstellar Extinction Curve toward HD 93222, A Sightline with an Exceedingly Narrow 2175 Angstrom Extinction Bump](#user-content-link54)
**Authors:** Qian Wang, Aigen Li, Xuejuan Yang

55. [Not so Swift: 20 years of multiwavelength observations of Mrk 421 and Mrk 501](#user-content-link55)
**Authors:** Gabrielle L. Taylor, Stefan J. Wagner, Alicja Wierzcholska, Michael Zacharias

56. [Radio timing constraints on the orbital orientation and component masses of PSR J1455$-$3330](#user-content-link56)
...
57. [Democratic heliocentric coordinates underestimate the rate of instabilities in long-term integrations of the Solar System](#user-content-link57)
**Authors:** Hanno Rein, Kavi Dey, Daniel Tamayo

58. [The Topological Origin of Bohm Resistivity in Magnetic Reconnection](#user-content-link58)
**Authors:** Magnus F Ivarsen

59. [The Scalar Mach-Sciama Theory of Gravitation](#user-content-link59)
**Authors:** Vel\'asquez-Toribio, A. M

60. [Velocity-Space Signatures of Energy Transfer for Ion-Acoustic Instabilities](#user-content-link60)
**Authors:** Mahmoud Saad Afify, Kristopher G. Klein, Mihailo M. Martinovi\'c, Maria Elena Innocenti

61. [Unraveling Year-Long Radial Velocity Variations in Red Clump Region -- I: Comprehensive analysis of a K0 Giant star, 2 Draconis](#user-content-link61)
...
62. [Primordial Gravitational Waves from Scalar Backreaction in Axion-SU(2) Inflation](#user-content-link62)
**Authors:** Mattia Cielo, Matteo Fasiello, Alexandros Papageorgiou

63. [Reducing the Dimensions of AGN Lightcurve Manifolds](#user-content-link63)
...
64. [One-Loop Tensor Power Spectrum from a Non-Minimally Coupled Spectator Field during Inflation](#user-content-link64)
**Authors:** Zhe Li, Chen Yuan, Qing-Guo Huang

65. [Observation of the Forbush decrease on 2024 May 10, using the ALPAQUITA air-shower array at the 70-1000 GV rigidity range](#user-content-link65)
**Authors:** M. Anzorena (The ALPACA Collaboration), E. de la Fuente (The ALPACA Collaboration), K. Fujita (The ALPACA Collaboration), R. Garcia (The ALPACA Collaboration), Y. Hayashi (The ALPACA Collaboration), K. Hibino (The ALPACA Collaboration), N. Hotta (The ALPACA Collaboration), G. Imaizumi (The ALPACA Collaboration), Y. Katayose (The ALPACA Collaboration), C. Kato (The ALPACA Collaboration), S. Kato (The ALPACA Collaboration), T. Kawashima (The ALPACA Collaboration), K. Kawata (The ALPACA Collaboration), M. Kobayashi (The ALPACA Collaboration), S. Kobayashi (The ALPACA Collaboration), T. Koi (The ALPACA Collaboration), H. Kojima (The ALPACA Collaboration), P. Miranda (The ALPACA Collaboration), S. Mitsuishi (The ALPACA Collaboration), A. Mizuno (The ALPACA Collaboration), K. Munakata (The ALPACA Collaboration), Y. Nakamura (The ALPACA Collaboration), M. Nishizawa (The ALPACA Collaboration), Y. Noguchi (The ALPACA Collaboration), S. Ogio (The ALPACA Collaboration), M. Ohishi (The ALPACA Collaboration), M. Ohnishi (The ALPACA Collaboration), A. Oshima (The ALPACA Collaboration), M. Raljevic (The ALPACA Collaboration), H. Rivera (The ALPACA Collaboration), T. Saito (The ALPACA Collaboration), T. Sako (The ALPACA Collaboration), T. K. Sako (The ALPACA Collaboration), S. Shibata (The ALPACA Collaboration), A. Shiomi (The ALPACA Collaboration), M. Subieta (The ALPACA Collaboration), F. Sugimoto (The ALPACA Collaboration), N. Tajima (The ALPACA Collaboration), W. Takano (The ALPACA Collaboration), Y. Takeyama (The ALPACA Collaboration), M. Takita (The ALPACA Collaboration), N. Tamaki (The ALPACA Collaboration), Y. Tameda (The ALPACA Collaboration), K. Tanaka (The ALPACA Collaboration), R. Ticona (The ALPACA Collaboration), H. Tsuchiya (The ALPACA Collaboration), Y. Tsunesada (The ALPACA Collaboration), S. Udo (The ALPACA Collaboration), G. Yamagishi (The ALPACA Collaboration), Y. Yamanaka (The ALPACA Collaboration), K. Yamazaki (The ALPACA Collaboration), Y. Yokoe (The ALPACA Collaboration)

66. [Ghost-free non-local $F(R)$ Gravity Compatible with ACT](#user-content-link66)
**Authors:** Shin'ichi Nojiri, S. D. Odintsov, V. K. Oikonomou

67. [Constraining the Fraction of LIGO/Virgo/KAGRA Binary Black Hole Merger Events Associated with Active Galactic Nucleus Flares](#user-content-link67)
**Authors:** Liang-Gui Zhu, Lei He, Xian Chen, Wen Zhao

68. [Charting the Flavour Structure of Dark Matter](#user-content-link68)
**Authors:** Simone Biondini, Admir Greljo, Xavier Ponce D\'iaz, Alessandro Valenti

69. [Rare Near-Opposition Alignment of 3I/ATLAS on 22 January, 2026](#user-content-link69)
**Authors:** Mauro Barbieri (INAF), Abraham Loeb (Harvard)

70. [Evaluating the effectiveness of radio frequency interference removal algorithms for single pulse searches](#user-content-link70)
...
## 1. [Relatively Fast and Reasonably Furious: Evidence for Increased Burstiness in Smaller Halos at Cosmic Dawn](https://arxiv.org/abs/2601.07912) <a id="link1"></a>
...
**Comment:** Presents a framework for modeling star-formation burstiness in early galaxies, fitting UV luminosity functions and clustering, and providing evidence for increased burstiness in smaller halos. Directly relevant to resolved star formation histories, star formation quenching, and numerical galaxy simulations, especially for low-mass halos and early galaxies.
...
## 2. [QED V: Variations in metal loading of galactic winds with element nucleosynthetic origin](https://arxiv.org/abs/2601.08063) <a id="link2"></a>
...
**Comment:** This paper uses high-resolution simulations to study the metal loading of galactic winds, specifically investigating how different nucleosynthetic sources (Type Ia/II SNe, AGB stars) contribute to metal outflows. It directly matches the 'Star Formation Driven Outflows' criterion and also fits 'Numerical Galaxy Simulations' due to the use of new simulations with varied physics.
...
## 3. [New CDM Crisis Revealed by Multi-Scale Cluster Lensing](https://arxiv.org/abs/2601.07909) <a id="link3"></a>
...
**Comment:** This paper uses cluster lensing to probe substructure properties and test dark matter models, including core-cusp and subhalo mass functions. The focus on subhalo properties, density profiles, and small-scale structure is highly relevant to near-field cosmology and dark matter substructure criteria.
...
## 4. [Galaxy interactions in void substructures: Morphology and stellar populations of two triplets from CAVITY](https://arxiv.org/abs/2601.07952) <a id="link4"></a>
...
**Comment:** This paper studies galaxy interactions, morphologies, and stellar populations in void triplets, including mass assembly histories and quenching. It is relevant to near-field cosmology (void environments, galaxy interactions), resolved star formation histories (stellar populations), and star formation quenching (quenched galaxies), making it highly relevant.
...
## 5. [Thermal-timescale accretion does not always yield critical rotation in mass gainers](https://arxiv.org/abs/2601.08508) <a id="link5"></a>
...
**Comment:** This paper presents new stellar models focused on the rotational evolution of mass gainers in binaries, including detailed single-star models and binary models. It directly matches the 'Stellar Models' criterion, as it discusses new insights into stellar evolutionary tracks and angular momentum transport.
...
## 6. [MUSEQuBES: Investigating the Physical and Chemical Properties of Circumgalactic Gas Around Ly$\alpha$ Emitters at $z \approx 3.3$](https://arxiv.org/abs/2601.07916) <a id="link6"></a>
...
**Comment:** This paper presents a detailed study of the circumgalactic medium (CGM) around Lyα emitters at z~3.3, including metallicity and density measurements, and discusses metal-enriched CGM associated with outflows from faint galaxies. It matches the 'Circumgalactic Medium' criterion, with additional relevance to 'Star Formation Driven Outflows' due to the discussion of outflows from faint galaxies.
...
## 7. [Sahyadri: A simulation suite for the cosmology dependence of the Cosmic Web](https://arxiv.org/abs/2601.07924) <a id="link7"></a>
...
**Comment:** This paper presents Sahyadri, a new suite of cosmological N-body simulations with high resolution, enabling robust identification of dark matter halos down to 3.2e9 Msun. The simulations allow studies of low-mass halos and substructure, which is highly relevant to near-field cosmology, satellite luminosity functions, and numerical galaxy simulations. The work is a substantial improvement over previous suites and directly addresses core topics.
...
## 9. [The drastic impact of Eddington-limit induced mass ejections on massive star populations](https://arxiv.org/abs/2601.08822) <a id="link9"></a>
...
**Comment:** This paper introduces a new mass-loss prescription for massive stars at the Eddington limit, implemented in MESA, and compares synthetic populations to observations in the Magellanic Clouds. It presents new stellar models and evolutionary tracks, directly matching the 'Stellar Models' criterion.
...
## 10. [Revisiting the Great Attractor: The Local Group's streamline trajectory, cosmic velocity and dynamical fate](https://arxiv.org/abs/2601.08524) <a id="link10"></a>
...
**Comment:** This paper revisits the Great Attractor and the Local Group's motion using simulations. It discusses the Local Group's trajectory and cosmic velocity, which is relevant to near-field cosmology, especially regarding the accreted stellar halo and historic interactions.
...
## 11. [Stellar Rotation in the First Six Million Years: Rotational Velocities and Radii Estimates of T Tauri Stars in IC 5070 and IC 348](https://arxiv.org/abs/2601.08048) <a id="link11"></a>
...
**Comment:** This paper presents rotational velocities and radii estimates for T Tauri stars in young clusters, comparing results to stellar evolution models with starspot coverage. It matches the 'Stellar Models' criterion, as it tests and compares stellar evolutionary models.
...
## 13. [Three Models of the Gravitational Potential of the Milky Way](https://arxiv.org/abs/2601.08378) <a id="link13"></a>
...
**Comment:** This paper refines axisymmetric models for the gravitational potential of the Milky Way, using rotation curves that include data from dwarf satellite galaxies. The inclusion of dwarf satellite galaxies and the focus on the halo make it relevant to 'Near-Field Cosmology', though the main focus is on the overall potential model rather than satellite properties.
...
## 14. [Investigating quenching in Recently Quenched Elliptical galaxies with HI studies](https://arxiv.org/abs/2601.08027) <a id="link14"></a>
...
**Comment:** This paper investigates quenching mechanisms in recently quenched elliptical galaxies, focusing on HI content and evolutionary pathways. While it discusses quenching, the main focus is on elliptical galaxies rather than dwarfs, so it is relevant but weighted lower.
...
## 15. [RotCurves: A PYTHON package for efficient modelling and fitting of galactic rotation curves at high-z](https://arxiv.org/abs/2601.08348) <a id="link15"></a>
...
**Comment:** This paper presents a new Python package for modeling and fitting galactic rotation curves at high redshift, enabling rapid analysis of IFU data. While it is a numerical tool for galaxy dynamics, it does not focus on dwarf galaxies, resolved star formation histories, or new physics in simulations.
...
## 16. [Self-consistent dynamical models with a finite extent -- V. Smooth radial truncations and phase-space consistency](https://arxiv.org/abs/2601.08361) <a id="link16"></a>
...
**Comment:** The paper introduces a general method for smoothly truncating stellar system models, with applications to the Hernquist profile. While it is relevant to dynamical modeling of galaxies, it does not focus on dwarf galaxies, resolved star formation histories, or numerical galaxy simulations with new physics. Only a very weak connection to numerical galaxy simulations.
...
## 17. [Stellar masses of optically dark galaxies: uncertainty introduced by the attenuation law and star-formation histories](https://arxiv.org/abs/2601.08693) <a id="link17"></a>
...
**Comment:** The paper discusses uncertainties in stellar mass estimates for high-redshift, optically dark galaxies, focusing on SED modeling, star formation history priors, and dust attenuation laws. While it touches on star formation histories, it does not derive resolved star formation histories from color-magnitude diagrams, nor does it focus on dwarf galaxies or near-field cosmology. Borderline relevance for the 'Resolved Star Formation Histories' criterion.
...
## 18. [MUSE-ALMA Haloes XIII. Molecular gas in $z \sim 0.5$ HI-selected galaxies](https://arxiv.org/abs/2601.08633) <a id="link18"></a>
...
**Comment:** This paper presents new ALMA observations of molecular gas in HI-selected galaxies at z~0.5, examining star formation efficiency and the diversity of galaxy properties. While it discusses star formation and HI absorption, it does not focus on dwarf galaxies, resolved star formation histories, or CGM in dwarfs. Borderline relevance for 'Star Formation Quenching' due to discussion of suppressed star formation in high-mass systems.
...
## 19. [FROST-CLUSTERS -- III. Metallicity-dependent intermediate mass black hole formation by runaway collisions in dense star clusters](https://arxiv.org/abs/2601.07917) <a id="link19"></a>
...
**Comment:** This paper explores the formation of intermediate mass black holes (IMBHs) via runaway stellar collisions in dense star clusters, with metallicity dependence. While it involves stellar evolution and cluster dynamics, it does not present new stellar models or focus on galaxy-scale simulations, dwarf galaxies, or near-field cosmology. The relevance is borderline due to the connection to stellar evolution and cluster formation, but not directly to the core topics.
...
## 20. [Substellar population of the young massive cluster RCW 36 in Vela](https://arxiv.org/abs/2601.08555) <a id="link20"></a>
...
**Comment:** This paper investigates the initial mass function (IMF) and star-to-brown-dwarf ratio in the young massive cluster RCW 36. It involves star formation and cluster dynamics, but does not present resolved star formation histories from color-magnitude diagrams or new stellar models. The relevance is borderline due to its connection to star formation, but not directly to the core topics.
...
## 21. [An eclipsing 8.56 minute orbital period mass-transferring binary](https://arxiv.org/abs/2601.07925) <a id="link21"></a>
...
**Comment:** This paper reports the discovery of an eclipsing, mass-transferring AM CVn binary and measures its orbital evolution, probing gravitational wave emission and donor star response. While it involves stellar evolution and binary dynamics, it does not present new stellar models or address galaxy-scale processes.
...
## 22. [Intermediate-mass black hole incubators. Gas accretion onto stellar black hole clusters in galactic central molecular zones](https://arxiv.org/abs/2601.07905) <a id="link22"></a>
...
**Comment:** This paper discusses gas accretion onto stellar black hole clusters in the central molecular zone of the Milky Way, focusing on intermediate-mass black hole formation. While it touches on star formation history and the central molecular zone, its main focus is on black hole cluster evolution, which is not directly relevant to the specified criteria.
...
## 23. [The Contribution of Stars, Dust, Neutral Gas and SMBHs in Galaxies to the Cosmic Baryon Inventory](https://arxiv.org/abs/2601.08112) <a id="link23"></a>
...
**Comment:** This paper presents a census of baryons in galaxies, including stars, dust, neutral gas, and SMBHs, and discusses the distribution of baryons in the circumgalactic and intergalactic media. While it mentions the CGM, the focus is on the overall baryon inventory and not specifically on the CGM of dwarf galaxies or its connection to ISM outflows. No direct match to core criteria.
...
## 24. [Evidence of sloshing-driven mini-halo formation in the cool-core cluster RXCJ1558.3-1410](https://arxiv.org/abs/2601.08757) <a id="link24"></a>
...
**Comment:** This paper studies radio mini-halos and sloshing in a cool-core galaxy cluster, focusing on AGN feedback, ICM sloshing, and suppression of star formation in the cluster core. While it touches on star formation quenching, it is in the context of massive cluster environments, not dwarf galaxies or resolved star formation histories. Only a weak connection to the quenching criterion.
...
## 26. [On the Jeans criterion for hydrostatic and infalling gas](https://arxiv.org/abs/2601.07929) <a id="link26"></a>
...
**Comment:** This paper studies the Jeans criterion for gravitational instability in hydrostatic and infalling gas, with implications for clump and star cluster formation in streams or shells of gas infalling into galactic potential wells. While it discusses star formation and fragmentation, it does not present new stellar models or focus on galaxy-scale simulations relevant to the core criteria.
...
## 27. [Evolution and afterglow emission of gamma-ray burst jets from binary neutron star mergers](https://arxiv.org/abs/2601.08714) <a id="link27"></a>
...
**Comment:** Examines GRB jets and afterglow emission from binary neutron star mergers using 3D MHD simulations. While it uses high-resolution simulations, the focus is on GRB jets rather than galaxy simulations or any of the core criteria.
...
## 28. [A precessing jet from an active galactic nucleus drives gas outflow from a disk galaxy](https://arxiv.org/abs/2601.08791) <a id="link28"></a>
...
**Comment:** The paper studies gas outflows in a disk galaxy driven by an AGN jet, not by star formation. While it discusses outflows, the driver is AGN feedback, not star formation, which is specifically excluded in the criteria. No direct relevance to dwarf galaxies, CGM, or other core topics.
...
## 29. [Modeling Cosmogenic 10Be During the Heliosphere's Encounter with an Interstellar Cold Cloud](https://arxiv.org/abs/2601.07983) <a id="link29"></a>
...
**Comment:** This paper models cosmogenic 10Be production during the Sun's encounter with interstellar cold clouds, focusing on Earth's exposure to cosmic rays. While it touches on cosmic ray history and heliospheric changes, it does not directly address near-field cosmology, resolved star formation histories, or galaxy-scale processes. No core criteria matched.
...
## 30. [Signatures of a subpopulation of hierarchical mergers in the GWTC-4 gravitational-wave dataset](https://arxiv.org/abs/2601.07908) <a id="link30"></a>
...
**Comment:** This paper analyzes gravitational-wave data to identify hierarchical black hole mergers, discussing mass-dependent substructure in the binary black hole population. The focus is on black hole mergers and stellar clusters, not on galaxy-scale processes or the core criteria.
...
## 32. [Dense gas linked to star-forming regions photoionised by embedded gamma-ray bursts](https://arxiv.org/abs/2601.07919) <a id="link32"></a>
...
**Comment:** This paper uses X-ray absorption to probe the dense gas in star-forming regions around long-duration gamma-ray bursts, estimating density and location of the absorbing medium. While it discusses star-forming regions, it does not focus on resolved star formation histories, quenching, or the other core criteria.
...
## 33. [A survey of molecular clouds in the Galactic center's outflow](https://arxiv.org/abs/2601.07907) <a id="link33"></a>
...
**Comment:** This paper presents a survey of molecular clouds in the Galactic center's outflow, focusing on the phase structure and evolution of molecular clumps in the Milky Way wind. The study is centered on the Galactic Center and its outflow, not on dwarf galaxies or star-formation-driven outflows in low-mass systems. The relevance is low as it does not match the core criteria.
...
## 34. [Dust Properties of the Interstellar Object 3I/ATLAS Revealed by Optical and Near-Infrared Polarimetry](https://arxiv.org/abs/2601.08591) <a id="link34"></a>
...
**Comment:** This paper presents polarimetric observations of the interstellar object 3I/ATLAS, focusing on dust properties and polarimetric behavior. While it involves dust and stellar populations, it does not present new stellar models or address galaxy-scale phenomena relevant to the core criteria.
...
## 35. [Relativistic jets from millisecond proto-magnetars](https://arxiv.org/abs/2601.07918) <a id="link35"></a>
...
**Comment:** Focuses on relativistic jets from proto-magnetars, relevant to compact object explosions and GRBs, but not to any of the core criteria such as galaxy simulations, near-field cosmology, or star formation histories.
...
## 36. [A persistent bow shock in a diskless magnetised accreting white dwarf](https://arxiv.org/abs/2601.07922) <a id="link36"></a>
...
**Comment:** Reports discovery of a bow shock around a diskless accreting white dwarf, with implications for binary evolution and magnetic activity. Does not match any core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 37. [Blind Deconvolution in Astronomy: How Does a Standalone U-Net Perform?](https://arxiv.org/abs/2601.08666) <a id="link37"></a>
...
**Comment:** Investigates blind deconvolution of astronomical images using U-Net, focusing on image processing methods. Does not match any core criteria such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 39. [Reconstructing Gamma Ray Burst Energy Relations with Observational H(z) data in Neural Network Framework](https://arxiv.org/abs/2601.08550) <a id="link39"></a>
...
**Comment:** The paper uses GRBs to probe cosmic expansion history and calibrates luminosity relations with neural networks. It is cosmology-focused and does not address near-field cosmology, star formation histories, dwarf galaxies, or any other core topics.
...
## 40. [A new magnitude--redshift relation based on SNe Ia](https://arxiv.org/abs/2601.08505) <a id="link40"></a>
...
**Comment:** This paper presents a new empirical magnitude-redshift relation for Type Ia supernovae, with implications for cosmic acceleration and isotropy. It is cosmology-focused and does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 41. [The LIRA-Ising Model: Estimating the boundaries of irregularly shaped X-ray sources](https://arxiv.org/abs/2601.08002) <a id="link41"></a>
...
**Comment:** This paper presents a new Bayesian method (LIRA-Ising) for mapping boundaries of irregularly shaped X-ray sources, applied to quasar jets. While it is a methodological advance for X-ray image analysis, it does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 42. [Long Term (250 years) Hydrodynamical Simulation of the Supermassive Black Hole Binary OJ287](https://arxiv.org/abs/2601.08080) <a id="link42"></a>
...
**Comment:** This paper presents hydrodynamical simulations of a supermassive black hole binary in OJ287, focusing on accretion-driven variability and binary dynamics. The work is centered on SMBH binaries and AGN variability, which does not match any of the core criteria (e.g., near-field cosmology, dwarf galaxies, resolved star formation histories, galaxy simulations focused on dwarfs, etc.).
...
## 43. [Bifurcated Impact of Neutrino Fast Flavor Conversion on Core-collapse Supernovae Informed by Multi-angle Neutrino Radiation Hydrodynamics](https://arxiv.org/abs/2601.08269) <a id="link43"></a>
...
**Comment:** This paper investigates neutrino fast flavor conversion in core-collapse supernovae using multi-angle neutrino radiation hydrodynamics. While it is a theoretical astrophysics study, it does not address any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 44. [Identification of three new ULXs in NGC 4631 and NGC 1097: evidence for stellar-mass black holes](https://arxiv.org/abs/2601.08047) <a id="link44"></a>
...
**Comment:** This paper identifies new ULXs in two galaxies and investigates their X-ray and optical properties, focusing on stellar-mass black holes and donor stars. The work is on high-mass X-ray binaries and does not address dwarf galaxies, star formation histories, or galaxy-scale outflows.
...
## 45. [The Secret Lives of Open Clusters: a Multiwavelength Examination of Three Open Clusters](https://arxiv.org/abs/2601.08087) <a id="link45"></a>
...
**Comment:** This paper examines the X-ray and radio populations of three open clusters, focusing on dynamical interactions and variable sources. The work is on star clusters in the Milky Way and does not address dwarf galaxies, star formation histories, or galaxy-scale processes.
...
## 46. [Polychromatic pyramid wavefront sensor with MKID technology for high contrast imaging](https://arxiv.org/abs/2601.08398) <a id="link46"></a>
...
**Comment:** This paper focuses on wavefront sensor technology for high contrast imaging, relevant for instrumentation but not directly related to any of the specified criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 47. [Anatomy of Empirical Transit Spectra of Mars based on TGO/NOMAD](https://arxiv.org/abs/2601.08397) <a id="link47"></a>
...
**Comment:** This paper analyzes transit spectra of Mars to inform exoplanet atmospheric studies. It is focused on planetary atmospheres and does not match any of the specified galaxy-focused criteria.
...
## 48. [Diverse Origins of Broad H$\alpha$ Lines in Heavily Obscured AGNs Revealed by Multi-epoch Spectroscopy](https://arxiv.org/abs/2601.08212) <a id="link48"></a>

**ArXiv ID:** 2601.08212

**Authors:** Shoichiro Mizukoshi, Takeo Minezaki, Subaru Ubukata, Kazuya Matsubayashi, Hiroaki Sameshima, Mitsuru Kokubo, Takashi Horiuchi, Hirofumi Noda, Satoshi Yamada, Bovornpratch Vijarnwannaluk, Chian-Chou Chen

**Abstract:** According to the classical AGN model, broad emission lines originate from the broad-line region (BLR) and are observable only when the attenuation by the dusty torus is small. However, we recently found several heavily-obscured ($A_V > 50$ mag) AGNs with broad H$\alpha$ detections: MCG -3-34-64, UGC 5101, and Mrk 268. To investigate the origin of the observed broad line in these AGNs, we performed multi-epoch optical spectroscopic observations to search for flux variability of the broad H$\alpha$ line. For MCG -3-34-64 and UGC 5101, no significant variability was detected, suggesting that the broad line of these AGNs may arise from sources other than the BLR. Spectral fitting analysis suggests possible large contribution of ionized outflows to the observed broad component of MCG -3-34-64, while both the outflow and scattering by polar material can explain that of UGC 5101. For Mrk 268, we detected a significant ($4.3\sigma$) flux variation of the broad H$\alpha$ line by using the flux ratio of the H$\alpha$ complex and the [SII]$\lambda\lambda6716$, 6731 doublet, indicating that the broad line originates directly from the BLR. The lack of significant flux variation in the optical continuum implies that the line of sight to the nucleus of Mrk 268 is mildly obscured. Our results demonstrate that the observed broad H$\alpha$ lines in obscured AGNs likely have multiple origins. Such complexity may introduce additional uncertainties in black hole mass measurements of distant AGNs revealed by e.g., JWST.

**Comment:** This paper studies broad Hα lines in heavily obscured AGNs, focusing on their origins and implications for black hole mass measurements. It does not match any of the specified criteria.
...
## 49. [Quantifying Symmetry: Transformation Information for Planetary Nebulae and Supernova Remnants](https://arxiv.org/abs/2601.07913) <a id="link49"></a>
...
**Comment:** Focuses on symmetry identification in planetary nebulae and supernova remnants using image analysis. Does not match any core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 50. [The GRB Intrinsic Duration Distribution: Progenitor Insights Across Cosmic Time](https://arxiv.org/abs/2601.07928) <a id="link50"></a>
...
**Comment:** Studies GRB duration distributions and progenitor insights, focusing on collapsars and non-collapsar GRBs. Not directly related to any core criteria such as galaxy evolution, star formation histories, or near-field cosmology.
...
## 51. [Cascade Processes of Strong and Weak MHD Turbulence](https://arxiv.org/abs/2601.08093) <a id="link51"></a>
...
**Comment:** Studies MHD turbulence cascades and applies results to neutron star magnetospheres. While it uses numerical simulations, the focus is on turbulence and neutron stars, not galaxies or any of the core criteria.
...
## 52. [General gravitational properties of neutron stars: curvature invariants, binding energy, and trace anomaly](https://arxiv.org/abs/2601.07931) <a id="link52"></a>
...
**Comment:** Studies gravitational properties of neutron stars, including curvature invariants and binding energy. Focus is on neutron star structure, not galaxies or any of the core criteria.
...
## 53. [Chiral three-nucleon forces for the new local position-space two-nucleon potential in $\textit{ab initio}$ many-body calculations](https://arxiv.org/abs/2601.08199) <a id="link53"></a>
...
**Comment:** This work presents new chiral three-nucleon force models for nuclear structure calculations. It is focused on nuclear physics and stellar interiors at the nucleon level, not on stellar evolutionary tracks, atmospheres, or galaxy simulations. No direct relevance to the specified criteria.
...
## 54. [On the Interstellar Extinction Curve toward HD 93222, A Sightline with an Exceedingly Narrow 2175 Angstrom Extinction Bump](https://arxiv.org/abs/2601.08563) <a id="link54"></a>
...
**Comment:** This paper analyzes the interstellar extinction curve toward a specific star, focusing on the 2175 Angstrom bump and dust grain populations. It is relevant to ISM studies but does not address stellar models, galaxy simulations, or any of the core topics.
...
## 57. [Democratic heliocentric coordinates underestimate the rate of instabilities in long-term integrations of the Solar System](https://arxiv.org/abs/2601.08019) <a id="link57"></a>
...
**Comment:** This paper discusses the impact of coordinate choices on long-term Solar System integrations and the reliability of Wisdom-Holman integrators. It is focused on planetary system simulations, not galaxy simulations or any of the core topics.
...
## 58. [The Topological Origin of Bohm Resistivity in Magnetic Reconnection](https://arxiv.org/abs/2601.08054) <a id="link58"></a>
...
**Comment:** Explores the origin of Bohm resistivity in magnetic reconnection, with applications to solar flares and plasma physics. Not relevant to any core criteria such as galaxy simulations or near-field cosmology.
...
## 60. [Velocity-Space Signatures of Energy Transfer for Ion-Acoustic Instabilities](https://arxiv.org/abs/2601.08329) <a id="link60"></a>
...
**Comment:** This paper studies ion-acoustic instabilities in the solar wind using kinetic simulations. It focuses on plasma heating and energy transfer in the heliosphere, not on galaxy-scale processes or any of the core criteria.
...
## 61. [Unraveling Year-Long Radial Velocity Variations in Red Clump Region -- I: Comprehensive analysis of a K0 Giant star, 2 Draconis](https://arxiv.org/abs/2601.08164) <a id="link61"></a>
...
**Comment:** This paper analyzes radial velocity variations in a K0 giant star, focusing on distinguishing between stellar activity, instrumental effects, and planetary companions. It is a stellar astrophysics study, but does not present new stellar models or address galaxy-scale phenomena.
...
## 62. [Primordial Gravitational Waves from Scalar Backreaction in Axion-SU(2) Inflation](https://arxiv.org/abs/2601.08622) <a id="link62"></a>
...
**Comment:** This paper presents a numerical study of primordial gravitational waves from scalar backreaction in axion-SU(2) inflation, which is not related to galaxy evolution, star formation, or the other specified criteria.
...
## 63. [Reducing the Dimensions of AGN Lightcurve Manifolds](https://arxiv.org/abs/2601.08037) <a id="link63"></a>
...
**Comment:** Applies manifold learning to AGN lightcurves, focusing on AGN classification and variability. AGN studies are not relevant to the core criteria, which exclude SMBH/AGN-focused work.
...
## 64. [One-Loop Tensor Power Spectrum from a Non-Minimally Coupled Spectator Field during Inflation](https://arxiv.org/abs/2601.08675) <a id="link64"></a>
...
**Comment:** This paper presents theoretical work on inflation and primordial tensor power spectra, which does not match any of the specified criteria such as near-field cosmology or galaxy simulations.
...
## 65. [Observation of the Forbush decrease on 2024 May 10, using the ALPAQUITA air-shower array at the 70-1000 GV rigidity range](https://arxiv.org/abs/2601.08154) <a id="link65"></a>
...
**Comment:** The paper reports on cosmic ray observations and Forbush decreases, which are unrelated to the specified criteria focused on galaxy evolution, star formation, or cosmology at the galaxy scale.
...
## 66. [Ghost-free non-local $F(R)$ Gravity Compatible with ACT](https://arxiv.org/abs/2601.07879) <a id="link66"></a>
...
**Comment:** This is a theoretical cosmology paper on non-local gravity models and their compatibility with CMB constraints, not directly related to any of the specified criteria.
...
## 67. [Constraining the Fraction of LIGO/Virgo/KAGRA Binary Black Hole Merger Events Associated with Active Galactic Nucleus Flares](https://arxiv.org/abs/2601.08286) <a id="link67"></a>
...
**Comment:** This paper investigates the association between binary black hole mergers and AGN flares, focusing on gravitational wave events and AGN activity. It does not match any of the core criteria.
...
## 68. [Charting the Flavour Structure of Dark Matter](https://arxiv.org/abs/2601.07921) <a id="link68"></a>
...
**Comment:** This paper discusses the flavour structure of dark matter and its compatibility with flavour physics and direct detection bounds. It does not match any of the core criteria.
...
## 69. [Rare Near-Opposition Alignment of 3I/ATLAS on 22 January, 2026](https://arxiv.org/abs/2601.08624) <a id="link69"></a>
...
**Comment:** This paper is about the rare alignment of an interstellar object (3I/ATLAS) and its observational opportunities. It does not match any of the core criteria (no connection to near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 70. [Evaluating the effectiveness of radio frequency interference removal algorithms for single pulse searches](https://arxiv.org/abs/2601.08351) <a id="link70"></a>
...
**Comment:** The paper evaluates radio frequency interference removal algorithms for single pulse searches in radio astronomy. It does not match any of the core criteria.
