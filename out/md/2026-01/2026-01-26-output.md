...
1. [On the Use of Field RR Lyrae as Galactic Probes -- VIII. Early Formation of the Galactic Spheroid](#user-content-link1)
**Authors:** G. Bono, V. F. Braga, M. Fabrizio, M. Tantalo, K. Baeza-Villagra, J. Crestani, V. D'Orazi, M. Dall'Ora, M. Di Criscienzo, G. Fiorentino, M. Gholami, M. Marengo, C. E. Mart\'inez-V\'azquez, M. Monelli, J. P. Mullen, A. Nunnari, V. D. Pipwala, Z. Prudil, C. Sneden, G. Altavilla, M. Bergemann, G. B\"ocek Topcu, R. Buonanno, A. Calamida, E. Carretta, G. Ceci, B. Chaboyer, M. Correnti, R. da Silva, I. Ferraro, F. A. G\'omez, G. Iannicola, R. -P. Kudritzki, A. Kunder, S. Kwak, M. Marconi, S. Marinoni, N. Matsunaga, F. Matteucci, A. Monachesi, I. Musella, M. G. Navarro Ovando, G. W. Preston, V. Ripepi, M. Salaris, M. S\'anchez-Benavente, E. Spitoni, P. B. Stetson, F. Th\'evenin, I. B. Thompson, P. B. Tissera, T. Tsujimoto, E. Valenti, A. K. Vivas, A. R. Walker, M. Zoccali, A. Zocchi

2. [Simulations of multi-phase gas in and around galaxies](#user-content-link2)
**Authors:** Max Gronke, Evan Schneider

3. [Kinematics of young star clusters in the outer north-eastern region of the Small Magellanic Cloud](#user-content-link3)
**Authors:** Andr\'es E. Piatti

4. [TORRCH: Tomographic reconstruction of the reionization of cosmic hydrogen with Ly${\alpha}$ emitters and non-Ly${\alpha}$-selected galaxies](#user-content-link4)
**Authors:** Soumak Maitra (TIFR), Girish Kulkarni, Vipul Arora, Matteo Viel, Shikhar Asthana, James S. Bolton, Martin G. Haehnelt, Laura Keating

5. [A Binary-Based Reassessment of the Age and Stellar Properties of NGC 7789 Using Twelve Binary Components](#user-content-link5)
**Authors:** Kadri Yakut, Belinda Kalomeni, Saul Rappaport

6. [Constraints on the Hot Circumgalactic Medium around Nearby L* Galaxies from SRG/eROSITA All Sky Survey](#user-content-link6)
**Authors:** Lin He, Zhiyuan Li

7. [UNCOVER/MegaScience Finds Uniform and Highly Bursty Star Formation at 3 < z < 9, consistent with the High-Redshift UV Luminosity Function](#user-content-link7)
...
8. [Flux-ratio anomalies in cusp quasars reveal dark matter beyond CDM](#user-content-link8)
...
9. [One H2 molecule per ten million H-atoms reveals sub-pc scale cold overdensities at z~4](#user-content-link9)
**Authors:** P. Noterdaeme, S. Balashev, T. Berg, S. Cristiani, R. Cuellar, G. Cupani, S. Di Stefano, V. D'Odorico, C. Fian, B. Godard, S. L\'opez, D. Milakovi\'c, A. Trost, L. Welsh

10. [A first GLIMPSE into star clusters populations across cosmic time](#user-content-link10)
**Authors:** Claeyssens Ad\'ela\"ide, Adamo Angela, Kokorev Vasily, Furtak Lukas, Richard Johan, Beauchesne Benjamin, Dessauges-Zavadsky Miroslava, Atek Hakim, Chisholm John, Endsley Ryan, Fujimoto Seiji, Korber Damien, Pan Richard, Saldana-Lopez Alberto, Schaerer Daniel

11. [A shot in the dark: searching for dark substructures in the RX J0437+00 galaxy cluster](#user-content-link11)
**Authors:** David J. Lagattuta (Hertfordshire, CEA, Durham, ICC, Durham), Mathilde Jauzac (CEA, Durham, ICC, Durham, ARC, Durban, UKZN), Jessica E. Doppel (CEA, Durham, ICC, Durham), Guillaume Mahler (STAR Institue, Liege), Anna Niemiec (Grenoble)

12. [Magnetic threads and gravity: ALMA Observations of IRDC G14.225-0.506](#user-content-link12)
**Authors:** Nacho A\~nez-L\'opez, Gemma Busquet, Josep Miquel Girart, Junhao Liu, Qizhou Zhang, Patrick Koch, Ana\"elle Maury, Hauyu Baobab Liu, Zhi-Yun Li, Keping Qiu, Shanghuo Li, Huei-Ru, Vivien Chen, Ya-Wen Tang, Shih-Ping Lai, Ramprasad Rao, Paul Ho

13. [Improved measurements of the age of JWST galaxies at z=6-10](#user-content-link13)
**Authors:** M. Lopez-Corredoira, C. M. Gutierrez

14. [Unifying cluster and galaxy cosmology analyses using the galaxy-halo connection](#user-content-link14)
**Authors:** Shulei Cao, Hao-Yi Wu, Andr\'es N. Salcedo, David H. Weinberg, Matthieu Schaller, Joop Schaye

15. [Improving constraints on primordial non-Gaussianity from Quaia with a new cosmological observable: angular redshift fluctuations](#user-content-link15)
**Authors:** Jos\'e Ram\'on Bermejo-Climent, Carlos Hern\'andez-Monteagudo, Alba Crespo-P\'erez, Jorge Martin Camalich, David Alonso, Giulio Fabbian, Kate Storey-Fisher

16. [The scaling relations of galaxies with different morphology: comparison among WINGS, MANGA and Illustris data samples](#user-content-link16)
**Authors:** Mauro D'Onofrio, Francesco Brevi, Cesare Chiosi, Paola Marziani

17. [Star formation outside galaxies undergoing gravitational and hydrodynamic interactions: dust attenuation and the star formation rate](#user-content-link17)
**Authors:** Geethika Santhosh, Rakhi R, Koshy George, B. M. Poggianti, Smitha Subramanian, Indulekha Kavila

18. [Anisotropy Strikes Back: Modified Gravity and Dark Matter Halos](#user-content-link18)
**Authors:** Paolo M Bassani

19. [Forecast on the generalised dark matter properties from a Euclid-like survey](#user-content-link19)
**Authors:** Ziad Sakr, Jessica N. L\'opez-S\'anchez

20. [Unveiling a Thin Filament of the Cosmic Web in the Ursa Major Supergroup](#user-content-link20)
**Authors:** Jin-Long Xu, Ming Zhu, Peng Jiang, Nai-Ping Yu, Chuan-Peng Zhang, Xiao-Lan Liu, Mei Ai, Yin-Jie Jing, Jie Wang

21. [Cosmography with $\Lambda$-Szekeres Models](#user-content-link21)
**Authors:** Morag Hills, Asta Heinesen

22. [Cosmological analysis of a viable $f(R)$ gravity model](#user-content-link22)
**Authors:** Siqi He, Weiqiang Yang

23. [Drawing the line between explosion and collapse in electron-capture supernovae -- I. Impact of conductive flame speeds and ignition conditions on the explosion mechanism](#user-content-link23)
**Authors:** Alexander Holas, Samuel W. Jones, Friedrich K. Roepke, R\"udiger Pakmor, Christina Fakiola, Giovanni Leidi, Raphael Hirschi, Ken J. Shen

24. [Searching for Ultralight Scalar Dark Matter with Clocks in Low Earth Orbit](#user-content-link24)
**Authors:** Dawid Brzeminski, Aaron Pierce

25. [ReveaLLAGN 1: JWST Emission-Line Spectra Reveal Low-Luminosity AGN with UV-Deficient SEDs and Warm Molecular Gas](#user-content-link25)
**Authors:** Kameron Goold, Anil Seth, Mallory Molina, David Ohlson, Nischal Acharya, Torsten B\"oker, Antoine Dumont, Michael Eracleous, Anja Feldmeier-Krause, Juan Antonio Fern\'andez-Ontiveros, Elena Gallo, Andy D. Goulding, Kayhan G\"ultekin, Luis C. Ho, Nadine Neumayer, Richard M. Plotkin, Almudena Prieto, Jessie C. Runnoe, Shobita Satyapal, Glenn van de Ven, Jonelle L. Walsh, Feng Yuan, Nora L\"utzgendorf

26. [Dynamics of AGN feedback in the X-ray bright East and Southwest arms of M87, mapped by XRISM](#user-content-link26)
**Authors:** A. Simionescu, C. Kilbourne, H. R. Russell, D. Ito, M. Charbonneau, D. Eckert, M. Loewenstein, J. Martin, H. McCall, B. R. McNamara, K. Nakazawa, A. Ogorzalek, A. T\"umer, I. Zhuravleva, N. Dizdar, Y. Ezoe, R. Fujimoto, L. Gu, E. Hodges-Kluck, Y. Ichinohe, S. Kitamoto, M. A. Leutenegger, F. Mernier, E. D. Miller, I. Mitsuishi, K. Sato, A. Szymkowiak

27. [Extragalactic Planetary Nebulae (xPNe). Determining Distances out to 100 Mpc and the Renaissance of the PN Luminosity Function Method](#user-content-link27)
...
28. [XMM-Newton observations of ten high-redshift CAMIRA clusters of galaxies](#user-content-link28)
...
29. [When Primordial Black Holes Absorb During the Early Universe](#user-content-link29)
**Authors:** Md Riajul Haque, Rajesh Karmakar, Yann Mambrini

30. [Hot, Retrograde Tilted MADs: Misaligned, Precessing, and Shaped by Electromagnetic Torques](#user-content-link30)
**Authors:** Sajal Gupta, Jason Dexter

31. [A differential-geometry approach to black hole characterization of megamaser systems in static spherically symmetric spacetimes](#user-content-link31)
**Authors:** Santiago Gonz\'alez-Salud, Rodrigo B\'arcena-Ramos, Alfredo Herrera-Aguilar, Roberto Cartas-Fuentevilla

32. [Measuring the Black Hole and Accretion Parameters of Sagittarius A* from EHT Observations using a Semi-Analytic Model](#user-content-link32)
**Authors:** Braden J. Marazzo-Nowicki, Paul Tiede, Dominic O. Chang, Daniel C. M. Palumbo, Michael D. Johnson

33. [Gaia20dsk: A new MNor discovered by the GLORIOUS collaboration](#user-content-link33)
**Authors:** Patrik E. N\'emeth, Fernando Cruz-S\'aenz de Miera, \'Agnes K\'osp\'al, Eleonora Fiorellino, Zs\'ofia Nagy, M\'at\'e Szil\'agyi, Michal Siwak, Foteini Lykou, M\'aria Kun, P\'eter \'Abrah\'am, Zs\'ofia Marianna Szab\'o, Teresa Giannini, Lukasz Wyrzykowski

34. [Calibrating redshift distributions at $z>2$ with Lyman-$\alpha$ forest cross-correlations](#user-content-link34)
**Authors:** Qianjun Hang, Laura Casas, William d'Assignies, Wynne Turner, Andreu Font-Ribera, Benjamin Joachimi

35. [Probing dark matter interactions with a RES-NOVA prototype cryogenic detector](#user-content-link35)
...
36. [Investigating Twin Star Equation of States in Light of Recent Astrophysical Observations](#user-content-link36)
**Authors:** Shamim Haque, Atharva Shinde, Asim Kumar Saha, Tuhin Malik, Ritam Mallick

37. [proto-Lightspeed: a high-speed, ultra-low read noise imager on the Magellan Clay Telescope](#user-content-link37)
...
38. [Universal relation between dipole polarizability of finite nuclei and neutron-star compactness](#user-content-link38)
**Authors:** P. S. Koliogiannis, T. Ghosh, E. Yuksel, N. Paar

39. [[HP99] 159 -- Properties of the first Supersoft X-ray Source with a Helium star donor](#user-content-link39)
**Authors:** H\'el\`ene Szegedi, Philip A. Charles, David A. H. Buckley, Pieter J. Meintjes, Przemek Mr\'oz, Andrzej Udalski

40. [Accretion Rate Changes Detected in a Polluted White Dwarf](#user-content-link40)
**Authors:** Jay Farihi, Hiba Tu Noor, Carl Melis, Beth L. Klein, Snehalata Sahu, Boris T. G\"ansicke, Mark C. Wyatt, Seth Redfield, Ted M. Johnson

41. [The detectability of bars at high redshift: a case study using Euclid-like mock observations of TNG50 simulated galaxies](#user-content-link41)
**Authors:** Gustavo F. Gon\c{c}alves, Rubens E. G. Machado, Raquel R. Valen\c{c}a, E. Athanassoula, Kar\'in Men\'endez-Delmestre, Thiago Bueno-Dalpiaz

42. [MeerKAT observations of Abell 1775 and Abell 1795: the discovery of a hadronic radio halo?](#user-content-link42)
**Authors:** R. J. van Weeren, E. Osinga, G. Brunetti, C. J. Riseley, A. Botteon, R. Timmerman, A. Bonafede, M. Br\"uggen, R. Cassano, V. Cuciti, D. Dallacasa, F. de Gasperin, J. M. G. H. J. de Jong, F. Gastaldello, K. Knowles, X. Zhang

43. [Mercury-Ar$\chi$es: a high-performance n-body code for planet formation studies](#user-content-link43)
**Authors:** Diego Turrini, Sergio Fonte, Romolo Politi, Danae Polychroni, Scig\'e J. Liu, Paolo Matteo Simonetti, Simona Pirani

44. [Thick Lunar Crust Amplifies Gravitational-Wave Signal](#user-content-link44)
**Authors:** Lei Zhang, Han Yan, Xian Chen, Jinhai Zhang

45. [The Origins of Planets for ArieL (OPAL) Key Science Project: the end-to-end planet formation campaign for the ESA space mission Ariel](#user-content-link45)
**Authors:** Danae Polychroni, Diego Turrini, Romolo Politi, Sergio Fonte, Eugenio Schisano, Elenia Pacetti, Paolo Matteo Simonetti, Michele Zusi, Sergio Molinari, Stavro Ivanovski

46. [Comprehensive Gaia DR3-Based Astrometric, Photometric, and Kinematic Studies of the Binary Open Cluster $h$ and $\chi$ Persei](#user-content-link46)
**Authors:** Seval Ta\c{s}demir, Waleed Elsanhoury, Deniz Cennet \c{C}{\i}nar, Aly Haroon, Sel\c{c}uk Bilir

47. [A compact object with a K type star companion in the solar neighborhood: a wide post common envelope binary with a white dwarf candidate](#user-content-link47)
**Authors:** Jie Lin, Hailiang Chen, Bojun Wang, Yudong Luo, Wenshi Tang, Bo Huang

48. [Analysis of $M1$ capture in the $\alpha(d,\gamma)^6$Li reaction](#user-content-link48)
**Authors:** Ergash M. Tursunov, Daniel Baye

49. [Bondi-Hoyle-Lyttleton accretion flow in a stratified layer](#user-content-link49)
**Authors:** F. J. S\'anchez-Salcedo

50. [The shape function of the observed growth index](#user-content-link50)
**Authors:** Ziad Sakr, Jinglan Zheng

51. [Calibration-independent consistency test of BAO and SNIa data: update](#user-content-link51)
**Authors:** Bikash R. Dinda, Roy Maartens, Chris Clarkson

52. [Cosmic ray electron boosted light dark matter: Implications of LZ 2025 data](#user-content-link52)
**Authors:** Sk Jeesun, Anirban Majumdar

53. [Relaxing DESI DR2 BAO Constraints on $\sum m_\nu$ with Planck and SPT-3G 2018 in the Context of SPT D1](#user-content-link53)
**Authors:** Dmitry Gorbunov, Nikita Nedelko

54. [Superhumps in active dwarf novae. Part I: ER Ursae Majoris](#user-content-link54)
**Authors:** K. Bakowska, B. Kirpluk, P. Zielinski, M. Motylinski, A. Gurgul, J. Golonka, K. Szyszka

55. [Six New Circumbinary Disk Occultation (CBO) Candidates from the Zwicky Transient Facility](#user-content-link55)
**Authors:** Zhecheng Hu, Wei Zhu, Shuming Wang, Sharon Xuesong Wang

56. [TOI-6692b: An eccentric 130 day period giant planet with a single transit from TESS](#user-content-link56)
...
57. [Fast Magnetoacoustic Wave Behavior with Gravitationally Stratified, Magnetically Inhomogeneous Media](#user-content-link57)
**Authors:** Ryan T. Smith, James A. McLaughlin, Gert J. J. Botha

58. [Illuminating the Physics of Cosmic Origin and Evolution: A UK Space Frontiers 2035 White Paper](#user-content-link58)
**Authors:** Florian Beutler, Eva-Maria Mueller, Seshadri Nadathur, Yun Wang, David Alonso, Tessa Baker, Sownak Bose, Rebecca Canning, Shaun Cole, Fergus Cullen, Willem Elbers, Pedro Ferreira, Carlos Frenk, Oscar Gonzalez, Or Graur, Boryana Hadzhiyska, Alex Hall, Catherine Heymans, Sergey Koposov, Kazuya Koyama, Ofer Lahav, Baojiu Li, Avery Meiksin, Johannes Noller, John Peacock, Alkistis Pourtsidou, Giorgio Savini, Andy Taylor, Rita Tojeiro, David Wands, Massimo Robberto, Gregory Wirth, Mark Dickinson, Thomas Greene, Jeffrey Kruk, Will Percival, Andreas Faisst, Lynne Hillenbrand, Jeyhan Kartaltepe, Nikhil Padmanabhan, Lado Samushia, Lee Armus, Andrew Benson, Micol Bolzonella, Samuel Brieden, Jarle Brinchmann, Robert Content, Emanuele Daddi, Kyle Finner, Andrew Hearin, Cullan Howlett, Jon Lawrence, Gregory Mosby, Zoran Ninkov, Ken Osato, Casey Papovich, Jack Piotrowski, Lucia Pozzetti, Alvise Raccanelli, Jason Rhodes, Shun Saito, Hee-Jong Seo, Zachary Slepian, Steve Smee

59. [Characterization of the commercial spectrograph system for astronomical observations: PIXIS 1300BX Camera and IsoPlane 320A Spectrograph](#user-content-link59)
**Authors:** Jiwon Jang, Changsu Choi, Ho Seong Hwang, Haeun Chung, Hyeonguk Bahk, Dongkok Kim, Jae-Woo Kim

60. [A more inclusive effective dark fluid equation of state parameter: constraints from SKA and Euclid like surveys](#user-content-link60)
**Authors:** Ziad Sakr

61. [Post-Perihelion Integral Field Spectroscopy of the Interstellar Comet 3I/ATLAS](#user-content-link61)
...
62. [GRBAlpha, VZLUSAT-2 and GRBBeta -- GRB observations with CubeSats](#user-content-link62)
...
63. [CosmoSlider: An educational tool for cosmology](#user-content-link63)
**Authors:** Andreas Nygaard, Steen Hannestad, Thomas Tram

64. [Multi-wavelength Study of A Superflare on RS CVn-type Star HD22468 Triggered at Hard X-ray by SVOM](#user-content-link64)
...
65. [Probabilistic Graphical Models in Astronomy](#user-content-link65)
**Authors:** Abigail Sheerin, Giuseppe Vinci

66. [The Astrosky Ecosystem: An independent online platform for science communication and social networking](#user-content-link66)
**Authors:** Emily L. Hunt, Vincent S. Carpenter, Kyle W. Cook, Douglas G. Hilton, Mehnaaz Asad, Janine Jochum, Kelly Lepo, Jamie Zvirzdin

67. [Pushchino Multibeam Pulsar Search. X. Observations of pulsars at declinations above $+53^o$](#user-content-link67)
**Authors:** S. A. Tyul'bashev, G. E. Tyul'basheva, M. A. Kitaeva

68. [ALMA publication statistics](#user-content-link68)
**Authors:** Felix Stoehr, Mar\'ia D\'iaz Trigo, Evanthia Hatziminaoglou, Uta Grothkopf, Silvia Meakins, Leslie Kiefer, Lance Utley, Mika Konuma, Eelco van Kampen, Gerg\"o Popping, Enrique Macias, Martin Zwaan

---

## 1. [On the Use of Field RR Lyrae as Galactic Probes -- VIII. Early Formation of the Galactic Spheroid](https://arxiv.org/abs/2601.16523) <a id="link1"></a>
...
**Comment:** This paper presents a large catalog of RR Lyrae and BHB stars, analyzing their metallicity and alpha-element distributions across Galactic components and stellar streams. It discusses the accreted stellar halo, substructure, and the chemical evolution of the Milky Way spheroid, directly matching the near-field cosmology criterion. The work also touches on historic interactions and substructure identification.
...
## 2. [Simulations of multi-phase gas in and around galaxies](https://arxiv.org/abs/2601.16566) <a id="link2"></a>
...
**Comment:** Comprehensive review of numerical simulations of multiphase gas in and around galaxies, including dwarf and Milky Way-mass systems, with emphasis on connecting scales and diagnostics. Directly matches the 'Numerical Galaxy Simulations' and 'Circumgalactic Medium' criteria, with additional relevance for star-formation-driven outflows and CGM.
...
## 3. [Kinematics of young star clusters in the outer north-eastern region of the Small Magellanic Cloud](https://arxiv.org/abs/2601.16833) <a id="link3"></a>
...
**Comment:** Analyzes kinematics of young star clusters in the outer SMC, a tidal structure from interaction with the LMC. Directly relevant to 'Near-Field Cosmology' (historic interactions, dwarf satellite kinematics) and provides observational data on the SMC's outer regions.
...
## 4. [TORRCH: Tomographic reconstruction of the reionization of cosmic hydrogen with Ly${\alpha}$ emitters and non-Ly${\alpha}$-selected galaxies](https://arxiv.org/abs/2601.16263) <a id="link4"></a>
...
**Comment:** Presents a deep-learning framework for tomographic reconstruction of the reionization epoch using Lyα emitters and galaxies, trained on hydrodynamical simulations with radiative transfer. This fits the 'Numerical Galaxy Simulations' criterion (high-resolution, new physics) and is also relevant to near-field cosmology as it reconstructs ionization topology using resolved galaxy populations.
...
## 5. [A Binary-Based Reassessment of the Age and Stellar Properties of NGC 7789 Using Twelve Binary Components](https://arxiv.org/abs/2601.16265) <a id="link5"></a>
...
**Comment:** Binary-based reassessment of the age and stellar properties of NGC 7789, an open cluster. Presents stellar evolution tests and binary parameters, which is relevant to the 'Stellar Models' criterion as it tests evolutionary tracks against observations.
...
## 6. [Constraints on the Hot Circumgalactic Medium around Nearby L* Galaxies from SRG/eROSITA All Sky Survey](https://arxiv.org/abs/2601.16499) <a id="link6"></a>
...
**Comment:** This paper presents a systematic search for the hot circumgalactic medium (CGM) around nearby L* galaxies using X-ray stacking from eROSITA. While the focus is on L* galaxies rather than dwarfs, the topic is directly relevant to the circumgalactic medium criterion, though with lower weight since it is not about dwarfs.
...
## 7. [UNCOVER/MegaScience Finds Uniform and Highly Bursty Star Formation at 3 < z < 9, consistent with the High-Redshift UV Luminosity Function](https://arxiv.org/abs/2601.16284) <a id="link7"></a>

**ArXiv ID:** 2601.16284

**Authors:** Ikki Mitsuhashi, Katherine A. Suess, Joel Leja, Rachel Bezanson, Jenny E. Greene, Emilie Burnham, Gourav Khullar, Abby Mintz, Themiya Nanayakkara, Karl Glazebrook, Sedona H. Price, David J. Setton, Bingjie Wang, John R. Weaver, Hakim Atek, Pratika Dayal, Robert Feldmann, Seiji Fujimoto, Lukas J. Furtak, Brian Lorenz, Natalia Porraz Barrera, Ivo Labbe, Gabriel Brammer, Sam E. Cutler, Richard Pan, Katherine E. Whitaker, the UNCOVER/MegaScience team

**Abstract:** Star formation timescales are key to understanding fundamental physics like feedback mechanisms, as well as the abundance of bright galaxies at $z>10$. We investigate galaxy star formation histories (SFHs) and their evolution across $z\sim3$--9 by measuring the line-to-UV ratio (\rline) and line equivalent width (EW) of \hanii\ and \oiiihb\ directly from UNCOVER/MegaScience spectro-photometry without relying on a specific SFH or nebular line modeling. Our photometric measurements recover \rline\ and EW to $<10\%$ systematic accuracy compared to spectroscopy. This allows us to construct a large mass- (and flux-) complete sample and quantitatively examine how \rline\ evolves with redshift and stellar mass. We find that the intrinsic scatter in \rline\ does not significantly evolve with redshift across $310$. This suggests that no significant evolution in star formation burstiness is required to explain the abundance of UV-bright galaxies at high redshift.

**Comment:** This paper analyzes star formation histories and burstiness in high-redshift galaxies (z=3-9) using spectro-photometry, directly measuring line-to-UV ratios and equivalent widths. While the focus is on unresolved high-redshift galaxies, the methodology and results are relevant to resolved star formation histories and the UV luminosity function, which is a key topic in near-field cosmology and galaxy evolution.
...
## 8. [Flux-ratio anomalies in cusp quasars reveal dark matter beyond CDM](https://arxiv.org/abs/2601.16818) <a id="link8"></a>
...
**Comment:** This paper uses flux-ratio anomalies in strongly lensed quasars to probe small-scale dark matter structure, comparing CDM, SIDM, and FDM scenarios. While it deals with dark matter substructure, the focus is on lensing in quasar systems, not on dwarf galaxies or near-field cosmology. The relevance is borderline due to the substructure focus.
...
## 9. [One H2 molecule per ten million H-atoms reveals sub-pc scale cold overdensities at z~4](https://arxiv.org/abs/2601.16710) <a id="link9"></a>
...
**Comment:** Reports the highest-redshift H2 detection in a quasar absorption system, revealing sub-pc scale cold overdensities in the neutral medium. While the work is observational and probes small-scale structure in the distant universe, it does not focus on dwarf galaxies, resolved star formation histories, or near-field cosmology. Borderline relevance for circumgalactic medium and cold gas structure.
...
## 11. [A shot in the dark: searching for dark substructures in the RX J0437+00 galaxy cluster](https://arxiv.org/abs/2601.16260) <a id="link11"></a>
...
**Comment:** This paper reports a tentative detection of a dark matter subhalo in a galaxy cluster using gravitational lensing. While it discusses substructure and dark matter, the focus is on cluster environments, not on dwarf galaxies or the Milky Way satellite system. The relevance is borderline due to the substructure focus.
...
## 12. [Magnetic threads and gravity: ALMA Observations of IRDC G14.225-0.506](https://arxiv.org/abs/2601.16810) <a id="link12"></a>
...
**Comment:** This paper presents ALMA observations of magnetic fields in an infrared dark cloud, focusing on the role of magnetic fields in star formation and cloud fragmentation. It is relevant to star formation processes but does not specifically address resolved star formation histories, quenching, or galaxy-scale outflows in dwarf galaxies.
...
## 13. [Improved measurements of the age of JWST galaxies at z=6-10](https://arxiv.org/abs/2601.16772) <a id="link13"></a>
...
**Comment:** Presents improved age measurements for high-redshift JWST galaxies using SED fitting and spectroscopic data. While it discusses star formation histories, these are not resolved from color-magnitude diagrams and focus on high-redshift galaxies, not nearby dwarfs. Borderline relevance for star formation history methods.
...
## 14. [Unifying cluster and galaxy cosmology analyses using the galaxy-halo connection](https://arxiv.org/abs/2601.16353) <a id="link14"></a>
...
**Comment:** This paper presents a unified framework for modeling galaxy and cluster cosmology using the galaxy-halo connection, validated on the FLAMINGO hydrodynamic simulation. While it involves galaxy simulations and clustering, the focus is on cosmological parameter constraints and large-scale structure, not specifically on dwarf galaxies, resolved star formation histories, or near-field cosmology. The relevance is borderline for numerical galaxy simulations.
...
## 15. [Improving constraints on primordial non-Gaussianity from Quaia with a new cosmological observable: angular redshift fluctuations](https://arxiv.org/abs/2601.16948) <a id="link15"></a>
...
**Comment:** This paper introduces angular redshift fluctuations as a new cosmological observable and uses it to constrain primordial non-Gaussianity with a large quasar sample. While it is a novel cosmological probe, it does not directly address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 16. [The scaling relations of galaxies with different morphology: comparison among WINGS, MANGA and Illustris data samples](https://arxiv.org/abs/2601.16931) <a id="link16"></a>
...
**Comment:** Compares scaling relations of galaxies of different morphology using observational surveys and simulations (Illustris). While it includes numerical galaxy simulations, the focus is on scaling relations across all galaxy types, not specifically on dwarfs or near-field cosmology. Only weakly relevant to numerical galaxy simulations criterion.
...
## 17. [Star formation outside galaxies undergoing gravitational and hydrodynamic interactions: dust attenuation and the star formation rate](https://arxiv.org/abs/2601.16439) <a id="link17"></a>
...
**Comment:** Studies star formation outside galaxies in extragalactic features (rings, tails) formed by gravitational and hydrodynamic interactions. Focuses on dust attenuation and star formation rates in these features. While it discusses star formation, the galaxies are not dwarfs and the focus is on extragalactic structures formed by interactions, not resolved star formation histories or quenching in dwarfs.
...
## 18. [Anisotropy Strikes Back: Modified Gravity and Dark Matter Halos](https://arxiv.org/abs/2601.16958) <a id="link18"></a>
...
**Comment:** Explores dark matter-like fluids in spherically symmetric backgrounds and modified gravity, with discussion of dark matter halos. While it touches on dark matter density profiles and halo structure, the focus is theoretical and not specifically on dwarf galaxies or near-field cosmology. Borderline relevance for core-cusp and substructure topics.
...
## 19. [Forecast on the generalised dark matter properties from a Euclid-like survey](https://arxiv.org/abs/2601.16943) <a id="link19"></a>
...
**Comment:** This paper forecasts constraints on generalized dark matter properties from a Euclid-like survey, focusing on cosmological parameters and matter fluctuations. While it is relevant to cosmology and dark matter, it does not specifically address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 20. [Unveiling a Thin Filament of the Cosmic Web in the Ursa Major Supergroup](https://arxiv.org/abs/2601.16408) <a id="link20"></a>
...
**Comment:** Reports the detection of a thin filament in the Ursa Major supergroup using HI observations, discussing galaxy-filament alignment and accretion flows. While it involves galaxy groups and cosmic web structure, it does not focus on dwarf satellites, resolved star formation histories, or near-field cosmology.
...
## 22. [Cosmological analysis of a viable $f(R)$ gravity model](https://arxiv.org/abs/2601.16641) <a id="link22"></a>
...
**Comment:** This paper analyzes a viable f(R) gravity model and its cosmological implications, comparing it to LambdaCDM. While it is relevant to cosmology, it does not specifically address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 23. [Drawing the line between explosion and collapse in electron-capture supernovae -- I. Impact of conductive flame speeds and ignition conditions on the explosion mechanism](https://arxiv.org/abs/2601.16918) <a id="link23"></a>
...
**Comment:** This paper presents 3D hydrodynamic simulations of electron-capture supernovae, focusing on the transition between explosion and collapse. It is primarily about stellar evolution and supernova mechanisms, not galaxy simulations, stellar models for evolutionary tracks, or any of the other core criteria.
...
## 24. [Searching for Ultralight Scalar Dark Matter with Clocks in Low Earth Orbit](https://arxiv.org/abs/2601.16259) <a id="link24"></a>
...
**Comment:** This paper discusses searching for ultralight scalar dark matter with clocks in low Earth orbit. While it is relevant to dark matter detection, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 25. [ReveaLLAGN 1: JWST Emission-Line Spectra Reveal Low-Luminosity AGN with UV-Deficient SEDs and Warm Molecular Gas](https://arxiv.org/abs/2601.16977) <a id="link25"></a>
...
**Comment:** Focuses on low-luminosity AGN and their emission-line spectra using JWST. While it discusses outflows and ISM properties, the primary focus is AGN rather than star-formation-driven outflows or dwarf galaxies. No direct match to core topics.
...
## 26. [Dynamics of AGN feedback in the X-ray bright East and Southwest arms of M87, mapped by XRISM](https://arxiv.org/abs/2601.16901) <a id="link26"></a>
...
**Comment:** This paper investigates AGN feedback in M87 using X-ray spectroscopy. While it discusses gas dynamics and feedback, the focus is on a massive elliptical galaxy and AGN-driven outflows, which are not relevant to the core topics of dwarf galaxies, star-formation-driven outflows, or near-field cosmology.
...
## 27. [Extragalactic Planetary Nebulae (xPNe). Determining Distances out to 100 Mpc and the Renaissance of the PN Luminosity Function Method](https://arxiv.org/abs/2601.16893) <a id="link27"></a>
...
**Comment:** Discusses the use of the Planetary Nebula Luminosity Function as a precision distance indicator for early-type galaxies out to 100 Mpc, with implications for H0 measurements. While it touches on extragalactic distance indicators, it does not focus on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 29. [When Primordial Black Holes Absorb During the Early Universe](https://arxiv.org/abs/2601.16717) <a id="link29"></a>
...
**Comment:** This paper studies primordial black holes and their evolution in the early universe, with implications for dark matter. The focus is on cosmological black holes and not on galaxy properties, star formation, or simulations.
...
## 30. [Hot, Retrograde Tilted MADs: Misaligned, Precessing, and Shaped by Electromagnetic Torques](https://arxiv.org/abs/2601.16370) <a id="link30"></a>
...
**Comment:** This paper presents GRMHD simulations of tilted magnetically arrested accretion disks around black holes, focusing on disk alignment and precession. The topic is accretion physics, not galaxy simulations or any of the other core criteria.
...
## 31. [A differential-geometry approach to black hole characterization of megamaser systems in static spherically symmetric spacetimes](https://arxiv.org/abs/2601.16308) <a id="link31"></a>
...
**Comment:** This paper develops a differential-geometry approach to characterizing black holes in megamaser systems. While it is a novel method for black hole characterization, it does not address the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 32. [Measuring the Black Hole and Accretion Parameters of Sagittarius A* from EHT Observations using a Semi-Analytic Model](https://arxiv.org/abs/2601.16267) <a id="link32"></a>
...
**Comment:** This paper uses EHT observations and a semi-analytic model to measure black hole and accretion parameters of Sagittarius A*. The focus is on black hole characterization and accretion physics, not on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 33. [Gaia20dsk: A new MNor discovered by the GLORIOUS collaboration](https://arxiv.org/abs/2601.16826) <a id="link33"></a>
...
**Comment:** The paper discusses the discovery and characterization of an eruptive young stellar object (YSO), focusing on accretion rates and photometric/spectroscopic features. While it touches on star formation in YSOs, it does not address resolved star formation histories of galaxies, quenching, or other core criteria.
...
## 35. [Probing dark matter interactions with a RES-NOVA prototype cryogenic detector](https://arxiv.org/abs/2601.16251) <a id="link35"></a>
...
**Comment:** This paper describes a prototype cryogenic detector for dark matter searches using PbWO4 crystals. It is focused on detector technology and dark matter direct detection, not on galaxy properties, star formation histories, or simulations.
...
## 36. [Investigating Twin Star Equation of States in Light of Recent Astrophysical Observations](https://arxiv.org/abs/2601.16674) <a id="link36"></a>
...
**Comment:** Discusses equations of state for twin stars and implications for neutron star properties. No connection to galaxy evolution, dwarf galaxies, star formation, or CGM.
...
## 37. [proto-Lightspeed: a high-speed, ultra-low read noise imager on the Magellan Clay Telescope](https://arxiv.org/abs/2601.16268) <a id="link37"></a>
...
**Comment:** Describes a new high-speed, low-noise imager for the Magellan Clay Telescope. Instrumentation paper with no direct connection to the core science topics.
...
## 38. [Universal relation between dipole polarizability of finite nuclei and neutron-star compactness](https://arxiv.org/abs/2601.16894) <a id="link38"></a>
...
**Comment:** Presents a universal relation between dipole polarizability of nuclei and neutron star compactness. Focus is on nuclear physics and neutron stars, not galaxy evolution or core topics.
...
## 39. [[HP99] 159 -- Properties of the first Supersoft X-ray Source with a Helium star donor](https://arxiv.org/abs/2601.16789) <a id="link39"></a>
...
**Comment:** Studies a supersoft X-ray source with a helium star donor, relevant for SN Ia progenitor scenarios. Focus is on binary evolution and X-ray properties, not on any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 40. [Accretion Rate Changes Detected in a Polluted White Dwarf](https://arxiv.org/abs/2601.16253) <a id="link40"></a>
...
**Comment:** Reports changes in accretion rates in a polluted white dwarf, with implications for diffusion theory and circumstellar disk evolution. The focus is on stellar remnants and accretion, not on galaxy evolution, dwarf galaxies, or near-field cosmology.
...
## 41. [The detectability of bars at high redshift: a case study using Euclid-like mock observations of TNG50 simulated galaxies](https://arxiv.org/abs/2601.16335) <a id="link41"></a>
...
**Comment:** The paper studies the detectability of bars in simulated galaxies at high redshift, using Euclid-like mock observations and TNG50 simulations. The focus is on bar structures and observational biases, which are specifically listed as irrelevant in the criteria (bar, galactic center).
...
## 42. [MeerKAT observations of Abell 1775 and Abell 1795: the discovery of a hadronic radio halo?](https://arxiv.org/abs/2601.16288) <a id="link42"></a>
...
**Comment:** This paper presents radio observations of galaxy clusters, focusing on radio haloes and mini-haloes, cosmic-ray electrons, and AGN outbursts. The work is on cluster-scale phenomena and does not address dwarf galaxies, resolved SFHs, quenching, or CGM of galaxies.
...
## 43. [Mercury-Ar$\chi$es: a high-performance n-body code for planet formation studies](https://arxiv.org/abs/2601.16791) <a id="link43"></a>
...
**Comment:** Presents a new high-performance n-body code for planet formation studies. While it is a numerical simulation, it is focused on planet formation, not galaxies, and does not match any core criteria.
...
## 44. [Thick Lunar Crust Amplifies Gravitational-Wave Signal](https://arxiv.org/abs/2601.16567) <a id="link44"></a>
...
**Comment:** Focuses on gravitational wave detection using the Moon as a resonant detector. No connection to galaxy evolution, star formation, or simulations.
...
## 45. [The Origins of Planets for ArieL (OPAL) Key Science Project: the end-to-end planet formation campaign for the ESA space mission Ariel](https://arxiv.org/abs/2601.16841) <a id="link45"></a>
...
**Comment:** Describes the OPAL Key Science Project for the ESA Ariel mission, creating synthetic exoplanet atmospheres and modeling planet formation. The focus is on exoplanets and protoplanetary disks, not galaxies or the core topics.
...
## 46. [Comprehensive Gaia DR3-Based Astrometric, Photometric, and Kinematic Studies of the Binary Open Cluster $h$ and $\chi$ Persei](https://arxiv.org/abs/2601.16252) <a id="link46"></a>
...
**Comment:** This paper focuses on binary open clusters in the Milky Way, analyzing their properties and possible future interaction. However, open clusters are not dwarf satellite galaxies and the work does not address near-field cosmology, resolved star formation histories, or other core criteria. The focus is on cluster dynamics and formation within the disk region.
...
## 47. [A compact object with a K type star companion in the solar neighborhood: a wide post common envelope binary with a white dwarf candidate](https://arxiv.org/abs/2601.15619) <a id="link47"></a>
...
**Comment:** This paper presents the discovery and characterization of a wide post-common envelope binary with a white dwarf candidate. The focus is on binary evolution and common envelope physics, not on any of the core criteria.
...
## 48. [Analysis of $M1$ capture in the $\alpha(d,\gamma)^6$Li reaction](https://arxiv.org/abs/2601.16551) <a id="link48"></a>
...
**Comment:** Focuses on nuclear reaction modeling for the $\alpha(d,\gamma)^6$Li reaction, relevant for nuclear astrophysics but not for galaxy evolution, star formation histories, or near-field cosmology.
...
## 49. [Bondi-Hoyle-Lyttleton accretion flow in a stratified layer](https://arxiv.org/abs/2601.16395) <a id="link49"></a>
...
**Comment:** Studies accretion flow in stratified layers, relevant for accretion physics but not for galaxy evolution, star formation, or near-field cosmology.
...
## 50. [The shape function of the observed growth index](https://arxiv.org/abs/2601.16921) <a id="link50"></a>
...
**Comment:** Focuses on cosmological growth index and its redshift dependence, testing modified gravity and dark energy models. No direct connection to any of the core topics (e.g., near-field cosmology, galaxy simulations, star formation histories, etc.).
...
## 51. [Calibration-independent consistency test of BAO and SNIa data: update](https://arxiv.org/abs/2601.16229) <a id="link51"></a>
...
**Comment:** Calibration-independent test of BAO and SNIa data for cosmological consistency. No connection to galaxy properties, star formation, or simulations.
...
## 52. [Cosmic ray electron boosted light dark matter: Implications of LZ 2025 data](https://arxiv.org/abs/2601.16903) <a id="link52"></a>
...
**Comment:** Examines constraints on light dark matter using cosmic ray electron boosting and LZ 2025 data. The focus is on dark matter detection, not on galaxy properties, star formation histories, or near-field cosmology.
...
## 54. [Superhumps in active dwarf novae. Part I: ER Ursae Majoris](https://arxiv.org/abs/2601.16798) <a id="link54"></a>
...
**Comment:** This paper presents photometric analysis of a dwarf nova (ER Ursae Majoris), focusing on outburst parameters and mass-transfer rates. The topic is stellar variability in a binary system, not galaxy evolution, resolved SFHs, quenching, or CGM.
...
## 55. [Six New Circumbinary Disk Occultation (CBO) Candidates from the Zwicky Transient Facility](https://arxiv.org/abs/2601.16828) <a id="link55"></a>
...
**Comment:** Identifies new circumbinary disk occultation candidates from ZTF photometry, relevant for disk structure and dynamics in binary systems. No connection to galaxy evolution, dwarf galaxies, or near-field cosmology.
...
## 56. [TOI-6692b: An eccentric 130 day period giant planet with a single transit from TESS](https://arxiv.org/abs/2601.16357) <a id="link56"></a>
...
**Comment:** This paper reports the discovery and characterization of a giant exoplanet (TOI-6692b) via transit and radial velocity methods. The focus is on exoplanet detection and orbital dynamics, which does not match any of the core criteria (near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 57. [Fast Magnetoacoustic Wave Behavior with Gravitationally Stratified, Magnetically Inhomogeneous Media](https://arxiv.org/abs/2601.16920) <a id="link57"></a>
...
**Comment:** The study investigates fast magnetoacoustic wave behavior in gravitationally stratified, magnetically inhomogeneous media, with applications to the solar atmosphere. This is focused on MHD wave theory and solar physics, not on galaxies or the core criteria.
...
## 59. [Characterization of the commercial spectrograph system for astronomical observations: PIXIS 1300BX Camera and IsoPlane 320A Spectrograph](https://arxiv.org/abs/2601.16371) <a id="link59"></a>
...
**Comment:** This paper focuses on the characterization of a commercial spectrograph system for astronomical observations. While it is relevant for instrumentation, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 60. [A more inclusive effective dark fluid equation of state parameter: constraints from SKA and Euclid like surveys](https://arxiv.org/abs/2601.16899) <a id="link60"></a>
...
**Comment:** Forecasts constraints on an effective dark fluid equation of state using SKA and Euclid surveys, focusing on cosmological parameters and modified gravity. No direct connection to dwarf galaxies, resolved star formation histories, or galaxy simulations. Irrelevant to the core topics.
...
## 61. [Post-Perihelion Integral Field Spectroscopy of the Interstellar Comet 3I/ATLAS](https://arxiv.org/abs/2601.16983) <a id="link61"></a>
...
**Comment:** This paper reports on spectroscopy of the interstellar comet 3I/ATLAS, analyzing its outgassing and comparing it to Solar System comets. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 62. [GRBAlpha, VZLUSAT-2 and GRBBeta -- GRB observations with CubeSats](https://arxiv.org/abs/2601.16609) <a id="link62"></a>
...
**Comment:** Reports on CubeSat missions for GRB detection. Focus is on instrumentation and GRB science, not galaxy evolution or core topics.
...
## 63. [CosmoSlider: An educational tool for cosmology](https://arxiv.org/abs/2601.16919) <a id="link63"></a>
...
**Comment:** Describes an educational tool for cosmology, focused on CMB power spectra and cosmological parameters. No direct relevance to the core topics.
...
## 65. [Probabilistic Graphical Models in Astronomy](https://arxiv.org/abs/2601.16959) <a id="link65"></a>
...
**Comment:** This paper reviews probabilistic graphical models in astronomy and demonstrates their application to exoplanets and host stars. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 66. [The Astrosky Ecosystem: An independent online platform for science communication and social networking](https://arxiv.org/abs/2601.16838) <a id="link66"></a>
...
**Comment:** Describes an online platform for science communication and social networking in astronomy. No scientific content related to the core topics.
...
## 67. [Pushchino Multibeam Pulsar Search. X. Observations of pulsars at declinations above $+53^o$](https://arxiv.org/abs/2601.16714) <a id="link67"></a>

**ArXiv ID:** 2601.16714

**Authors:** S. A. Tyul'bashev, G. E. Tyul'basheva, M. A. Kitaeva

**Abstract:** A search for pulsars was carried out using a Large Phased Array (LPA) radio telescope at a frequency of 110.4 MHz with a time resolution of 3.072 ms and a frequency resolution of 19.5 kHz with a 2.5 MHz bandwidth used. The survey was conducted in a site with declinations of $+53^\circ < \delta < +87^\circ$. The viewing area is approximately 4100 sq.deg. The search was carried out using Fourier power spectra. To increase sensitivity, multiple observations were made in each direction in the sky, and the resulting power spectra were summarized. This made it possible to increase sensitivity by about 5-10 times, depending on the direction in the sky. A blind search opened 35 known pulsars. Estimates of the flux density for 33 pulsars have been obtained.

**Comment:** Pulsar search and flux density estimates. No connection to galaxy evolution, star formation, or simulations.
...
## 68. [ALMA publication statistics](https://arxiv.org/abs/2601.16687) <a id="link68"></a>
...
**Comment:** ALMA publication statistics and impact analysis. No direct connection to any of the core topics.
