...
1. [A possible challenge for Cold and Warm Dark Matter](#user-content-link1)
**Authors:** S. Vegetti, S. D. M. White, J. P. McKean, D. M. Powell, C. Spingola, D. Massari, G. Despali, C. D. Fassnacht

2. [The origin of strong $\alpha$-element bimodalities in FIRE simulations of Milky Way-mass galaxies](#user-content-link2)
**Authors:** Megan Barry, Andrew Wetzel, Sarah Loebman, Jeremy Bailin, Hanna Parul

3. [The winds of OBA hypergiants and luminous blue variables: Dynamically-consistent atmosphere models reveal multiple wind regimes](#user-content-link3)
**Authors:** Matheus Bernini-Peron, Andreas A. C. Sander, Gautham N. Sabhahit, Francisco Najarro, Varsha Ramachandran, Jorick S. Vink

4. [Dynamically consistent analysis of Galactic WN4b stars](#user-content-link4)
**Authors:** Roel R. Lefever, Andreas A. C. Sander, Matheus Bernini-Peron, Gemma Gon\'alez-Tor\`a, Wolf-Rainer Hamann, Joris Josiek, Varsha Ramachandran, Elisa C. Sch\"osser, Helge Todt

5. [Discovery of an Extremely Luminous Type II Cepheid in the Andromeda Giant Stellar Stream: Evidence for a Hierarchical Triple with an Inner Binary Merger](#user-content-link5)
**Authors:** Pinjian Chen, Bingqiu Chen, Xiaodian Chen, Haibo Yuan, Jianrong Shi, Shu Wang, Chunqian Li, Jiyu Wang, Jianxing Zhang, Yi Ren

6. [Asteroseismology of solar-like oscillators: emulating individual mode frequencies with a branching neural network](#user-content-link6)
...
7. [Studying the surface effect in Procyon A as an F-type star](#user-content-link7)
**Authors:** Nuno Moedas, Maria Pia Di Mauro

8. [The intermediate neutron capture process. VI. Proton ingestion and i-process in rotating magnetic asymptotic giant branch stars](#user-content-link8)
**Authors:** A. Choplin, L. Siess, S. Goriely, P. Eggenberger, F. D. Moyano

9. [Cosmic Chance Superpositions: Largest Catalog of Quasar-Galaxy Pairs at a Projected Separation of $D \lesssim 20$ kpc](#user-content-link9)
**Authors:** Labanya Kumar Guha, Raghunathan Srianand, Rajeshwari Dutta

10. [Star Formation in Galaxy Collisions: Dependence on Impact Velocity and Gas Mass of Galaxies in GADGET-4 Simulations](#user-content-link10)
**Authors:** Gustavo Neves Pereira, Paulo Laerte Natti

11. [The Origin of Spin-Alignment of Dark Matter Subhalos](#user-content-link11)
**Authors:** Daiki Osafune, Keiichi Wada, Tomoaki Ishiyama, Takashi Okamoto

12. [A Long Tidal Feature Extending from a Low-Redshift Galaxy Revealed in Rubin Data Preview 1 Imaging](#user-content-link12)
**Authors:** Virginia Johnson, Aaron J. Romanowsky

13. [E-XQR-30: Evidence for an Increase in the Ionization State of Metal Absorbers from z~6 to z~2](#user-content-link13)
**Authors:** Stephanie Rowlands, R. L. Davies, E. Ryan-Weber, L. C. Keating, A. M. Sebastian, G. D. Becker, M. Bischetti, S. E. I. Bosman, H. Chen, F. B. Davies, V. D'Odorico, P. Gaikwad, S. Gallerani, M. G. Haehnelt, G. Kulkarni, R. A. Meyer, L. Welsh, Y. Zhu

14. [CHANG-ES XXXVI. Effects of spectral aging on radio scale heights](#user-content-link14)
**Authors:** D. C. Smolinski, V. Heesen, M. Br\"uggen, J. -T. Li, M. We\.zgowiec, M. Stein, L. -Y. Lu, T. Wiegert, J. Irwin, R. -J. Dettmar

15. [Exactly solved model of a one dimensional self gravitating system](#user-content-link15)
**Authors:** Rajaram Nityananda

16. [BEACON: JWST NIRCam Pure-parallel Imaging Survey. II. Physical Properties of $z=7-14$ Galaxies](#user-content-link16)
...
17. [COUGS-DESI: A Catalog of Unusual Galaxies with Polar Structures in the DESI Legacy Imaging Surveys](#user-content-link17)
**Authors:** Seneca K. H. Bahr, Aleksandr V. Mosenkov, Jacob A. Guerrette, Isaac H. Jensen, Jonah X. George, Thea E. Spigarelli, Ryan P. Smith, Brandon T. Burton, Kevan W. Beckstead, Jonah D. Seguine, Harrison K. Casper

18. [Hunting for the First Explosions at the High-Redshift Frontier](#user-content-link18)
**Authors:** Junehyoung Jeon, Volker Bromm, Alessandra Venditti, Steven L. Finkelstein, Tiger Yu-Yang Hsiao

19. [Electron temperature relations and the direct N, O, Ne, S and Ar abundances of 49959 star-forming galaxies in DESI Data Release 2](#user-content-link19)
**Authors:** D. Scholte, F. Cullen, J. M. Moustakas, H. Zou, A. Saintonge, K. Z. Arellano-Cordova, T. M. Stanton, B. Andrews, J. Sui, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, F. J. Castander, T. Cheng, T. Claybaugh, A. de la Macorra, B. Dey, P. Doel, K. Douglass, S. Ferraro, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, R. Joyce, A. Kremin, O. Lahav, M. Landriau, L. Le Guillou, P. Martini, A. Meisner, R. Miquel, W. J. Percival, C. Poppett, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, Z. Shao, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver

20. [SN 2024abfl: A Flat-Plateau, Low-Luminosity Type IIP Supernova with Early CSM Interaction](#user-content-link20)
...
21. [Exposure-averaged Gaussian Processes for Combining Overlapping Datasets](#user-content-link21)
**Authors:** Jacob K. Luhn, Ryan A. Rubenzahl, Samuel Halverson, Lily L. Zhao

22. [Scalable Gaussian Processes for Integrated and Overlapping Measurements Via Augmented State Space Models](#user-content-link22)
**Authors:** Ryan A. Rubenzahl, Soichiro Hattori, Simo S\"arkk\"a, Will M. Farr, Jacob K. Luhn, Megan Bedell

23. [Optomechanical platform for high-frequency gravitational wave and vector dark matter detection](#user-content-link23)
**Authors:** David Rousso, Moritz Bjoern Kristiansson Kunze, Christoph Reinhardt

24. [A Galactic Supernova Remnant Candidate at l =25.8, b=+0.2 Revealed by Near-Infrared Imaging and Spectroscopy](#user-content-link24)
**Authors:** Kim Yesol, Koo Bon-Chul, Lee Jae-Joon

25. [Composite Bulges - V. Detecting signatures of gas inflows in IFU data: The MUSE view of ionised gas kinematics in nearby galaxies](#user-content-link25)
**Authors:** Tutku Kolcu, Witold Maciejewski, Peter Erwin, Dimitri A. Gadotti, Francesca Fragkoudi, Paula R. T. Coelho, Victor P. Debattista, Adriana de Lorenzo-C\'aceres, Camila de S\'a-Freitas, Patricia S\'anchez-Bl\'azquez

26. [Exploring Composition Mixing in Kilonova Ejecta with Ray-by-ray Simulations](#user-content-link26)
**Authors:** Ruocheng Zhai, David Radice, Fabio Magistrelli, Sebastiano Bernuzzi, Albino Perego

27. [The Lazuli Space Observatory: Architecture & Capabilities](#user-content-link27)
...
28. [Heavy Black-Holes Also Matter in Standard Siren Cosmology](#user-content-link28)
**Authors:** Gr\'egoire Pierra, Alexander Papadopoulos

29. [Measuring the homogeneity scale using the peculiar velocity field](#user-content-link29)
**Authors:** Leonardo Giani, Cullan Howlett, Chris Blake, Ryan J. Turner, Tamara M. Davis

30. [Nonlinear Weak Lensing reconstruction for Galaxy Clusters](#user-content-link30)
**Authors:** Yuan Shi, Li Cui

31. [Probing ionized bubbles around luminous sources during reionization with SKA 21-cm observations](#user-content-link31)
**Authors:** Arnab Mishra, Kanan Kumar Datta, Chandra Shekhar Murmu, Samir Choudhuri, Iffat Nasreen, Snehasish Saha

32. [Investigating the Anisotropy of Dispersion Measure Contribution from the Galactic Halo by Using Fast Radio Bursts](#user-content-link32)
**Authors:** Yang Liu, Bao Wang, Puxun Wu, Jun-Jie Wei, Xue-Feng Wu

33. [The Squeezed Bispectrum from CHIME HI Emission and Planck CMB Lensing: Current Sensitivity and Forecasts](#user-content-link33)
**Authors:** CHIME Collaboration, Arnab Chakraborty, Matt Dobbs, Simon Foreman, Liam Gray, Mark Halpern, Gary Hinshaw, Albin Joseph, Joshua MacEachern, Kiyoshi W. Masui, Juan Mena-Parra, Laura Newburgh, Tristan Pinsonneault-Marotte, Alex Reda, Shabbir Shaikh, Seth Siegel, Haochen Wang, Dallas Wulf, Zeeshan Ahmed, Nickolas Kokron, Emmanuel Schaan

34. [Where does the simplified Stellar Contamination Model fail in Exoplanet Transmission Spectroscopy?](#user-content-link34)
**Authors:** Viktor Y. D. Sumida, Raissa Estrela, Mark Swain, Adriana Valio

35. [Mean opacity tables for probing the interior and atmosphere of giant planets](#user-content-link35)
**Authors:** Louis Siebenaler, Yamila Miguel

36. [Large-scale radio bubbles around the black hole transient V4641 Sgr](#user-content-link36)
**Authors:** Noa Grollimund, St\'ephane Corbel, Rob Fender, James H. Matthews, Ian Heywood, Fraser J. Cowie, Andrew K. Hughes, Francesco Carotenuto, Sara E. Motta, Patrick Woudt

37. [Neutrino flavor instabilities in neutron star mergers with moment transport: slow, fast, and collisional modes](#user-content-link37)
...
38. [Cosmic Collider Gravitational Waves sourced by Right-handed Neutrino production from Bubbles: Testing Seesaw, Leptogenesis and Dark Matter](#user-content-link38)
**Authors:** Anish Ghoshal, Pratyay Pal

39. [Resonances in b-EMRIs: playing the black hole piano](#user-content-link39)
**Authors:** Jo\~ao S. Santos, Vitor Cardoso, Alexandru Lupsasca, Jos\'e Nat\'ario, Maarten van de Meent

40. [A Tale of Two Dust Disks in Our Milky](#user-content-link40)
**Authors:** Ruoyi Zhang, Haibo Yuan, Bingqiu Chen, Maosheng Xiang, Yang Huang, Xiaowei Liu, Jifeng Liu

41. [Thick Disks, Thin Hopes: Suppressed Capture and Merger Rates in AGN](#user-content-link41)
**Authors:** Yashvardhan Tomar, Philip F. Hopkins, Kyle Kremer

42. [Magnetic reconnection with a 0.1 rate: Effective resistivity in general relativistic magnetohydrodynamics](#user-content-link42)
**Authors:** B. Ripperda, M. P. Grehan, A. Moran, S. Selvi, L. Sironi, A. Philippov, A. Bransgrove, O. Porth

43. [Helioseismic Evidence That the Solar Dynamo Originates near the Tachocline](#user-content-link43)
**Authors:** Krishnendu Mandal, Alexander G. Kosovichev

44. [Experiments in binary evolution](#user-content-link44)
**Authors:** Stephan Geier, Thomas Kupfer, Pierre Maxted, Veronika Schaffenroth

45. [Resolving the Fe K$\alpha$ Doublet of the Galactic Center Molecular Cloud G0.11-0.11 with XRISM](#user-content-link45)
**Authors:** Stephen DiKerby, Shuo Zhang, Kumiko Nobukawa, Masayoshi Nobukawa, Yuma Aoki, Jack Uteg

46. [Meteor observations as a tool to constrain cosmogonic models of the Solar System](#user-content-link46)
**Authors:** Vitalii Kuksenko, Juraj T\'oth

47. [Predictability of bursts of a recurrent nova using topological data analysis and machine learning](#user-content-link47)
**Authors:** Ignacio Morales-Gil

48. [Indications of a Late-Time Transition to a Strongly Interacting Dark Sector](#user-content-link48)
**Authors:** Andronikos Paliathanasis

49. [GATOS XI : Excess dust heating in the Narrow Line Regions of nearby AGN revealed with JWST/MIRI](#user-content-link49)
**Authors:** Houda Haidar, David J. Rosario, Ismael Garc\'ia-Bernete, Almudena Alonso-Herrero, Anelise Audibert, Steph Campbell, Chris M. Harrison, Tiago Costa, Laura Hermosa Mu\~noz, Fran\c{c}oise Combes, Dimitra Rigopoulou, Claudio Ricci, Cristina Ramos Almeida, Enrica Bellocchi, Peter Boorman, Andrew Bunker, Richard Davies, Daniel Delaney, Tanio D\'iaz Santos, Federico Esposito, Victoria A. Fawcett, Poshak Gandhi, Santiago Garc\'ia-Burillo, Omaira Gonz\'alez-Mart\'in, Erin K. S. Hicks, Sebastian F. H\"onig, Alvaro Labiano, Nancy A. Levenson, Enrique Lopez-Rodriguez, Chris Packham, Miguel Pereira-Santaella, Rogemar A. Riffel, Alberto Rodr\'iguez Ardila, John Schneider, T. Taro Shimizu, Marko Stalevski, Montserrat Villar Mart\'in, Martin Ward, Lulu Zhang, Gillian Leeds, Fergus R. Donnan

50. [A New Collision Avoidance Fiber Assignment Algorithm for Robotic Fiber Positioners in Multi-Object Spectroscopy](#user-content-link50)
**Authors:** Minseong Kwon, Ho Seong Hwang, Jong Chul Lee, Jae-Woo Kim, Hyeonguk Bahk, Young-Man Choi, Moo-Young Chun, Sang-Hyun Chun, Haeun Chung, Sungwook E. Hong, Minhee Hyun, Donghui Jeong, Kang-Min Kim, Dachan Kim, Dongkok Kim, Yunjong Kim, Jongwan Ko, Ho-Gyu Lee, Yongseok Lee, Hyunho Lim, Heeyoung Oh, Changbom Park, Hyunmi Song, Mingyeong Yang, Yongmin Yoon

51. [Primordial Black Hole Formation in $f(R)=R+\alpha R^2$ Gravity: Perturbative and Non-Perturbative Analysis](#user-content-link51)
**Authors:** G. G. L. Nashed

52. [Gas rotation and turbulence in the galaxy cluster Abell 2029](#user-content-link52)
**Authors:** T. Bartalesi, A. Simionescu, S. Ettori, C. Nipoti, V. Ghirardini, A. Sarkar, M. Sun

53. [Isotopic Ratios in the Disk of HD 163296](#user-content-link53)
**Authors:** Chunhua Qi, David J. Wilner, Catherine C. Espaillat

54. [Beyond Sgr A* and M87*: Sub-Microarcsecond Black Hole Shadow Detection via Lunar-based Extremely Long Baseline Interferometry](#user-content-link54)
**Authors:** Shan-Shan Zhao, Ru-Sen Lu, Lei Liu, Zhiqiang Shen

55. [Finite Plasma Beta Three-dimensional Magnetic Field Extrapolation Based on MHD Relaxation Method](#user-content-link55)
**Authors:** Daiki Yamasaki, Takahiro Miyoshi, Satoshi Inoue

56. [A Universal Upper Bound on the Pressure-to-Energy Density Ratio in Neutron Stars](#user-content-link56)
**Authors:** Bao-Jun Cai, Bao-An Li, Yu-Gang Ma

57. [Tracing Pebble Drift History in Two Protoplanetary Disks with CO Enhancement](#user-content-link57)
**Authors:** Tayt Armitage, Joe Williams, Ke Zhang, Sebastiaan Krijt, Leon Trapman, Richard A. Booth, Richard Teague, Charles J. Law, Chunhua Qi, David J. Wilner, Karin I. \"Oberg, Edwin A. Bergin, Sean M. Andrews, Romane Le Gal, Feng Long, Jane Huang, Jaehan Bae, Felipe Alarc\'on

58. [Orchestral AI: A Framework for Agent Orchestration](#user-content-link58)
**Authors:** Alexander Roman, Jacob Roman

59. [The Maximum Gravity Model for partial Tidal Disruption Events: Mass Loss, Peak Fallback Rate and Dependence on Stellar Properties](#user-content-link59)
**Authors:** Ananya Bandopadhyay, Eric R. Coughlin, C. J. Nixon

60. [Transient Large-Scale Anisotropy in TeV Cosmic Rays due to an Interplanetary Coronal Mass Ejection](#user-content-link60)
...
61. [Dynamical Origins of Azimuthal Metallicity Variations in the Galactic Disk: Insights from Kinematic Ridges with Gaia](#user-content-link61)
**Authors:** Carlos Jurado, Keith Hawkins, Jason A. S. Hunt, Zoe Hackshaw, Carrie Filion, Neige Frankel, Christopher Carr

62. [Bounce Inflation with Dynamical Dark Energy in Light of DESI DR2](#user-content-link62)
**Authors:** Xin-zhe Zhang, Hao-Hao Li, Taotao Qiu

63. [Super-Orbital Variations in Magnetar Rotation Measure Arising from the Precession of Companion Star: Implications for FRB 20220529](#user-content-link63)
**Authors:** Ze-Xin Du, Yun-Wei Yu, Aming Chen, Chen-Hui Niu, Jia-Heng Zhang

64. [Polarization of the CMB in the Standard Model Extension](#user-content-link64)
**Authors:** Iman Motie, Jafar Khodagholizadeh, S. Mahmoudi, Brahim Lamine, Alain Blanchard

65. [SpaceWire-based Data Acquisition Network for the Solar Flare Sounding Rocket Experiment FOXSI-4 and FOXSI-5](#user-content-link65)
...
66. [Models and Observational Predictions of Dust Traps in Protoplanetary Discs](#user-content-link66)
**Authors:** Paola Pinilla

67. [Using 23 Years of ACS/SBC Data to Understand Backgrounds: Significant Reductions in Expected Background Levels](#user-content-link67)
**Authors:** Christopher. J. R. Clark, Roberto J. Avila, Alyssa Guzman, Norman A. Grogin

68. [Utilizing anticoincidence veto in a search for gravitational-wave transients](#user-content-link68)
**Authors:** Souradeep Pal

69. [On the exceptionality of exceptional gravitational-wave events](#user-content-link69)
**Authors:** Rodrigo Tenorio, Davide Gerosa

70. [Standard Model Higgs Peaks: a Note on the Vacuum Instability during Inflation](#user-content-link70)
**Authors:** G. Franciolini, A. Kehagias, A. Riotto

71. [Late-time Background Constraints on Linear and Non-linear Interacting Dark Energy after DESI DR2](#user-content-link71)
**Authors:** David Figueruelo, Marcel van der Westhuizen, Amare Abebe, Eleonora Di Valentino

72. [Validation of Satellite Lifetime Predictions at Leonid Space](#user-content-link72)
**Authors:** Scott Shambaugh

73. [Catching 3I/ATLAS Using a Solar Oberth](#user-content-link73)
**Authors:** Adam Hibberd, T. Marshall Eubanks

74. [Inflation in Extra-Dimensions with one or two branes](#user-content-link74)
**Authors:** Nicol\'as Bernal, Catarina Cosme, Andrea Donini, Nuria Rius

75. [The Study of a Cosmic Ray Candidate Detected by the Askaryan Radio Array](#user-content-link75)
**Authors:** Shoukat Ali (the ARA Collaboration), Dave Z. Besson (the ARA Collaboration)

---

## 1. [A possible challenge for Cold and Warm Dark Matter](https://arxiv.org/abs/2601.02466) <a id="link1"></a>
...
**Comment:** Reports on a gravitational lensing detection of a million-solar-mass object with a density profile incompatible with cold dark matter models. This is highly relevant to near-field cosmology, as it directly addresses dark matter substructure and core-cusp issues.
...
## 2. [The origin of strong $\alpha$-element bimodalities in FIRE simulations of Milky Way-mass galaxies](https://arxiv.org/abs/2601.02520) <a id="link2"></a>
...
**Comment:** This paper analyzes the origin of strong alpha-element bimodalities in FIRE-2 simulations of Milky Way-mass galaxies. It discusses star formation history transitions, chemical evolution, and the role of rapid star formation decline. It fits the 'Numerical Galaxy Simulations' criterion and also touches on 'Star Formation Quenching' and 'Resolved Star Formation Histories' (theoretical), making it highly relevant.
...
## 3. [The winds of OBA hypergiants and luminous blue variables: Dynamically-consistent atmosphere models reveal multiple wind regimes](https://arxiv.org/abs/2601.03072) <a id="link3"></a>
...
**Comment:** This paper presents dynamically-consistent atmosphere models for OBA hypergiants and luminous blue variables, revealing multiple wind regimes and mass-loss patterns. It fits the 'Stellar Models' criterion, as it presents new atmosphere models and discusses mass-loss recipes and wind physics.
...
## 4. [Dynamically consistent analysis of Galactic WN4b stars](https://arxiv.org/abs/2601.02498) <a id="link4"></a>
...
**Comment:** Hydrodynamically-consistent modeling of Galactic WN4b Wolf-Rayet stars, focusing on stellar wind and atmosphere parameters. This fits the 'Stellar Models' criterion, as it presents new stellar atmosphere models and evolutionary implications.
...
## 5. [Discovery of an Extremely Luminous Type II Cepheid in the Andromeda Giant Stellar Stream: Evidence for a Hierarchical Triple with an Inner Binary Merger](https://arxiv.org/abs/2601.02960) <a id="link5"></a>
...
**Comment:** Reports discovery of an extremely luminous Type II Cepheid in the Andromeda Giant Stellar Stream, discusses its formation via a hierarchical triple and binary merger. The focus on the Andromeda Giant Stellar Stream and hierarchical merging is relevant to near-field cosmology, especially regarding signs of historic interactions and accreted stellar halo. Also touches on stellar models and evolutionary tracks.
...
## 6. [Asteroseismology of solar-like oscillators: emulating individual mode frequencies with a branching neural network](https://arxiv.org/abs/2601.02926) <a id="link6"></a>
...
**Comment:** Presents a new neural network for emulating asteroseismic mode frequencies and inferring stellar parameters, which fits the 'Stellar Models' criterion as it advances stellar interior modeling and parameter inference.
...
## 7. [Studying the surface effect in Procyon A as an F-type star](https://arxiv.org/abs/2601.02840) <a id="link7"></a>
...
**Comment:** This paper presents new modeling of the surface effect in F-type stars, focusing on Procyon A. It discusses stellar atmosphere and interior models, including surface corrections and their impact on inferred stellar properties. This fits the 'Stellar Models' criterion closely, as it presents new insights into stellar modeling and corrections.
...
## 8. [The intermediate neutron capture process. VI. Proton ingestion and i-process in rotating magnetic asymptotic giant branch stars](https://arxiv.org/abs/2601.02488) <a id="link8"></a>
...
**Comment:** Presents new theoretical models of nucleosynthesis in AGB stars, including effects of rotation and magnetic fields. This fits the 'Stellar Models' criterion as it presents new stellar evolutionary tracks and nucleosynthesis results.
...
## 9. [Cosmic Chance Superpositions: Largest Catalog of Quasar-Galaxy Pairs at a Projected Separation of $D \lesssim 20$ kpc](https://arxiv.org/abs/2601.02480) <a id="link9"></a>
...
**Comment:** Presents a large catalog of quasar-galaxy pairs probing the disk-halo interface and the inner circumgalactic medium (CGM). The focus on gas flows, cold gas, and dust evolution in the inner CGM is directly relevant to the 'Circumgalactic Medium' criterion, though the galaxies are predominantly normal star-forming disks (not specifically dwarfs).
...
## 10. [Star Formation in Galaxy Collisions: Dependence on Impact Velocity and Gas Mass of Galaxies in GADGET-4 Simulations](https://arxiv.org/abs/2601.02506) <a id="link10"></a>
...
**Comment:** This paper uses GADGET-4 simulations to study star formation rates in galaxy collisions, focusing on the effects of impact velocity and gas mass. It fits the 'Numerical Galaxy Simulations' criterion, though the focus is on galaxy collisions and not specifically on dwarfs or resolved star formation histories.
...
## 11. [The Origin of Spin-Alignment of Dark Matter Subhalos](https://arxiv.org/abs/2601.02678) <a id="link11"></a>
...
**Comment:** This paper uses high-resolution cosmological N-body simulations to study the spin alignment of dark matter subhalos within host halos. The focus on subhalos and their properties is relevant to near-field cosmology, especially regarding substructure and the dynamics of satellite galaxies. However, the paper does not directly address satellite luminosity functions, resolved star formation histories, or quenching, but the subhalo spin alignment is a relevant aspect of substructure in galaxy formation models.
...
## 12. [A Long Tidal Feature Extending from a Low-Redshift Galaxy Revealed in Rubin Data Preview 1 Imaging](https://arxiv.org/abs/2601.03080) <a id="link12"></a>
...
**Comment:** This paper reports the detection and analysis of a long stellar tidal feature (stream) around a massive disk galaxy, analogous to the M31 Giant Stellar Stream. While the discovery of stellar streams is relevant to near-field cosmology, the host galaxy is a massive disk at z=0.1, not a dwarf or Milky Way satellite. The work demonstrates the capabilities of Rubin/LSST for low surface brightness substructure, which is tangentially relevant to near-field cosmology and accreted stellar halo studies, but the main focus is on a higher mass galaxy.
...
## 14. [CHANG-ES XXXVI. Effects of spectral aging on radio scale heights](https://arxiv.org/abs/2601.02483) <a id="link14"></a>
...
**Comment:** Studies cosmic ray transport and radio scale heights in edge-on galaxies, with some discussion of galactic winds and cosmic ray-driven outflows. While it touches on star-formation-driven outflows and the phase structure, the focus is on more massive galaxies and not dwarfs. Borderline relevance for the outflow criterion.
...
## 15. [Exactly solved model of a one dimensional self gravitating system](https://arxiv.org/abs/2601.02423) <a id="link15"></a>
...
**Comment:** Presents an exactly solved model of a 1D self-gravitating system, with a conjecture about caustics in cold collisionless dark matter simulations. This is tangentially relevant to near-field cosmology and dark matter substructure, but not directly focused on galaxies or their properties.
...
## 16. [BEACON: JWST NIRCam Pure-parallel Imaging Survey. II. Physical Properties of $z=7-14$ Galaxies](https://arxiv.org/abs/2601.02861) <a id="link16"></a>
...
**Comment:** Analyzes physical properties of high-redshift galaxies (z=7-14) including star formation rates, stellar masses, and UV slopes. While it discusses star formation and galaxy properties, it does not focus on resolved star formation histories from color-magnitude diagrams or on dwarf galaxies, so relevance is borderline.
...
## 17. [COUGS-DESI: A Catalog of Unusual Galaxies with Polar Structures in the DESI Legacy Imaging Surveys](https://arxiv.org/abs/2601.02579) <a id="link17"></a>
...
**Comment:** Catalogs polar-structure galaxies using DESI imaging. While it provides a large sample for statistical studies of galaxy formation and evolution, the focus is on polar structures in non-dwarf galaxies, not on satellite galaxies, resolved star formation histories, or quenching. Only tangential relevance to galaxy evolution.
...
## 18. [Hunting for the First Explosions at the High-Redshift Frontier](https://arxiv.org/abs/2601.02469) <a id="link18"></a>
...
**Comment:** Explores the possibility of detecting pair-instability supernovae (PISNe) at very high redshift using JWST, with cosmological simulations of first star formation. While this is a simulation of star formation and supernovae, it is focused on the earliest universe and not on resolved star formation histories of nearby galaxies or near-field cosmology.
...
## 19. [Electron temperature relations and the direct N, O, Ne, S and Ar abundances of 49959 star-forming galaxies in DESI Data Release 2](https://arxiv.org/abs/2601.02463) <a id="link19"></a>
...
**Comment:** This paper presents direct-method abundance measurements for nearly 50,000 star-forming galaxies, focusing on electron temperature relations and elemental abundances. While it provides a large dataset relevant to galaxy evolution, it does not specifically address resolved star formation histories, dwarf galaxy quenching, or near-field cosmology. The focus is on chemical abundances in star-forming galaxies, which is tangentially related to the core topics but not directly aligned.
...
## 20. [SN 2024abfl: A Flat-Plateau, Low-Luminosity Type IIP Supernova with Early CSM Interaction](https://arxiv.org/abs/2601.02638) <a id="link20"></a>
...
**Comment:** Observes a low-luminosity Type IIP supernova with early circumstellar material (CSM) interaction. While it discusses CSM and progenitor properties, it does not focus on galaxy-scale outflows, dwarf galaxies, or resolved star formation histories.
...
## 21. [Exposure-averaged Gaussian Processes for Combining Overlapping Datasets](https://arxiv.org/abs/2601.02462) <a id="link21"></a>
...
**Comment:** This paper presents a new Gaussian Process framework for combining overlapping datasets, with a focus on stellar variability and exposure times. While it deals with stellar variability and data analysis methods, it does not directly address any of the core topics such as resolved star formation histories, stellar models, or near-field cosmology. The methods could be tangentially useful for stellar modeling, but the focus is on data combination techniques.
...
## 22. [Scalable Gaussian Processes for Integrated and Overlapping Measurements Via Augmented State Space Models](https://arxiv.org/abs/2601.02527) <a id="link22"></a>
...
**Comment:** Presents a scalable Gaussian Process framework for astronomical time series, which is a methodological advance but not directly relevant to any of the core topics (no focus on galaxies, star formation, or stellar models).
...
## 23. [Optomechanical platform for high-frequency gravitational wave and vector dark matter detection](https://arxiv.org/abs/2601.02576) <a id="link23"></a>
...
**Comment:** This paper presents a new optomechanical platform for detecting high-frequency gravitational waves and vector dark matter. While the dark matter aspect is tangentially related to cosmology, the focus is on instrumentation and detection methods, not on galaxy properties, star formation histories, or near-field cosmology. No direct connection to the core topics.
...
## 24. [A Galactic Supernova Remnant Candidate at l =25.8, b=+0.2 Revealed by Near-Infrared Imaging and Spectroscopy](https://arxiv.org/abs/2601.02761) <a id="link24"></a>
...
**Comment:** This paper presents near-infrared imaging and spectroscopy of a Galactic supernova remnant candidate in a star-forming region. While it discusses star formation and supernova activity, the focus is on a massive star-forming region in the inner Galaxy, not on dwarf galaxies or resolved star formation histories.
...
## 25. [Composite Bulges - V. Detecting signatures of gas inflows in IFU data: The MUSE view of ionised gas kinematics in nearby galaxies](https://arxiv.org/abs/2601.02534) <a id="link25"></a>
...
**Comment:** Studies ionized gas kinematics and signatures of gas inflows in nearby galaxies, focusing on bar-driven shocks and nuclear star formation. While it discusses gas inflows and star formation, the sample is limited to massive galaxies (M* ≥ 10^10 M⊙), not dwarfs, and does not focus on resolved SFHs or quenching in dwarfs.
...
## 26. [Exploring Composition Mixing in Kilonova Ejecta with Ray-by-ray Simulations](https://arxiv.org/abs/2601.02600) <a id="link26"></a>
...
**Comment:** Presents ray-by-ray simulations of kilonova ejecta and composition mixing, focusing on r-process nucleosynthesis. While it involves numerical simulations and stellar evolution, it does not focus on galaxies or present new stellar models relevant to the criteria.
...
## 27. [The Lazuli Space Observatory: Architecture & Capabilities](https://arxiv.org/abs/2601.02556) <a id="link27"></a>
...
**Comment:** Describes the architecture and capabilities of a new space observatory, with broad science goals including cosmology and time-domain astronomy, but does not specifically address any of the core topics (e.g., dwarf galaxies, resolved SFHs, stellar models, etc.).
...
## 28. [Heavy Black-Holes Also Matter in Standard Siren Cosmology](https://arxiv.org/abs/2601.03257) <a id="link28"></a>
...
**Comment:** Investigates the impact of heavy black holes on standard siren cosmology and Hubble constant estimation, but does not address any of the core topics (no focus on dwarf galaxies, resolved SFHs, or stellar models).
...
## 29. [Measuring the homogeneity scale using the peculiar velocity field](https://arxiv.org/abs/2601.02886) <a id="link29"></a>
...
**Comment:** This paper proposes a new method for measuring the homogeneity scale of the Universe using peculiar velocity fields. While it is a cosmology paper, it does not address near-field cosmology, resolved star formation histories, or any of the other core topics. The focus is on large-scale structure and cosmological standard rulers.
...
## 30. [Nonlinear Weak Lensing reconstruction for Galaxy Clusters](https://arxiv.org/abs/2601.02816) <a id="link30"></a>
...
**Comment:** This paper presents a new framework for nonlinear weak lensing mass reconstruction in galaxy clusters. While it deals with mass mapping and dark matter profiles, its focus is on massive galaxy clusters rather than dwarf galaxies or satellite systems. It does not address near-field cosmology, resolved star formation histories, or other core criteria.
...
## 31. [Probing ionized bubbles around luminous sources during reionization with SKA 21-cm observations](https://arxiv.org/abs/2601.02889) <a id="link31"></a>
...
**Comment:** The paper focuses on detecting ionized bubbles during reionization using 21-cm observations. While it is relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, or any of the other specific criteria. It is not directly related to dwarf galaxies or their satellites.
...
## 32. [Investigating the Anisotropy of Dispersion Measure Contribution from the Galactic Halo by Using Fast Radio Bursts](https://arxiv.org/abs/2601.02849) <a id="link32"></a>
...
**Comment:** Uses FRBs to probe the anisotropy of the Galactic halo's dispersion measure. While it deals with the Galactic halo, the focus is on the ISM/CGM of the Milky Way, not on dwarf galaxies or satellite systems. No direct relevance to near-field cosmology or other criteria.
...
## 33. [The Squeezed Bispectrum from CHIME HI Emission and Planck CMB Lensing: Current Sensitivity and Forecasts](https://arxiv.org/abs/2601.03240) <a id="link33"></a>
...
**Comment:** Studies the squeezed bispectrum from CHIME HI emission and Planck CMB lensing, focusing on large-scale structure and cosmological signals. No direct relevance to dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 34. [Where does the simplified Stellar Contamination Model fail in Exoplanet Transmission Spectroscopy?](https://arxiv.org/abs/2601.02621) <a id="link34"></a>
...
**Comment:** Examines the validity of stellar contamination models in exoplanet transmission spectroscopy. While it discusses stellar photospheric heterogeneities and their impact on transmission spectra, it does not present new stellar models or address the core criteria.
...
## 35. [Mean opacity tables for probing the interior and atmosphere of giant planets](https://arxiv.org/abs/2601.02995) <a id="link35"></a>
...
**Comment:** This paper presents new mean opacity tables for giant planet atmospheres and interiors. While it is a significant contribution to planetary modeling, it does not fit any of the core criteria related to galaxies, star formation, or stellar models.
...
## 36. [Large-scale radio bubbles around the black hole transient V4641 Sgr](https://arxiv.org/abs/2601.03140) <a id="link36"></a>
...
**Comment:** Focuses on large-scale radio bubbles around a black hole transient, specifically V4641 Sgr. The work is about microquasar jets and their interaction with the ISM, not galaxy-scale outflows or dwarf galaxies. No direct relevance to near-field cosmology, resolved star formation histories, or other core criteria.
...
## 37. [Neutrino flavor instabilities in neutron star mergers with moment transport: slow, fast, and collisional modes](https://arxiv.org/abs/2601.02461) <a id="link37"></a>
...
**Comment:** Investigates neutrino flavor instabilities in neutron star mergers using moment transport. Focus is on neutrino physics in extreme environments, not on galaxies, star formation histories, or near-field cosmology.
...
## 38. [Cosmic Collider Gravitational Waves sourced by Right-handed Neutrino production from Bubbles: Testing Seesaw, Leptogenesis and Dark Matter](https://arxiv.org/abs/2601.02458) <a id="link38"></a>
...
**Comment:** Discusses gravitational waves from right-handed neutrino production, leptogenesis, and dark matter, which are not directly related to any of the core topics (no focus on galaxies, star formation histories, or stellar models).
...
## 39. [Resonances in b-EMRIs: playing the black hole piano](https://arxiv.org/abs/2601.02468) <a id="link39"></a>
...
**Comment:** This paper focuses on resonant excitation of supermassive black hole (SMBH) modes by nearby stellar-mass binaries, specifically in the context of active galactic nuclei and similar environments. The topic is centered on SMBH physics and gravitational wave emission, which does not match any of the core criteria such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations. The focus is on black hole accretion and tidal interactions, which are explicitly listed as irrelevant.
...
## 40. [A Tale of Two Dust Disks in Our Milky](https://arxiv.org/abs/2601.02724) <a id="link40"></a>
...
**Comment:** This paper investigates the three-dimensional structure of cosmic dust in the Milky Way, focusing on the thin and thick dust disks and their correlation with gas disks. The study is centered on the Milky Way's disk and dust morphology, which is explicitly listed as irrelevant (Milky Way disk properties). No connection to dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 41. [Thick Disks, Thin Hopes: Suppressed Capture and Merger Rates in AGN](https://arxiv.org/abs/2601.02487) <a id="link41"></a>
...
**Comment:** This paper analyzes the rates of capture and merger events in AGN disks, focusing on the impact of disk thickness and pressure support. The work is centered on accretion disk physics around supermassive black holes and the rates of compact object interactions in AGN environments. This is not relevant to near-field cosmology, dwarf galaxies, or any of the core criteria.
...
## 42. [Magnetic reconnection with a 0.1 rate: Effective resistivity in general relativistic magnetohydrodynamics](https://arxiv.org/abs/2601.02460) <a id="link42"></a>
...
**Comment:** This paper focuses on magnetic reconnection in relativistic magnetohydrodynamics, with applications to neutron stars and black holes. It does not address galaxy simulations, stellar models, or any of the other core topics. The work is purely about plasma physics in extreme environments.
...
## 43. [Helioseismic Evidence That the Solar Dynamo Originates near the Tachocline](https://arxiv.org/abs/2601.03238) <a id="link43"></a>
...
**Comment:** This paper uses helioseismic evidence to argue for the location of the solar dynamo. While it discusses stellar interiors and dynamo theory, it does not present new stellar models or evolutionary tracks, nor does it address any of the core galaxy or star formation criteria.
...
## 44. [Experiments in binary evolution](https://arxiv.org/abs/2601.02448) <a id="link44"></a>
...
**Comment:** Focuses on binary star evolution and observational strategies for binaries. While it discusses stellar evolution in binaries, it does not present new stellar models or resolved star formation histories, nor does it focus on dwarf galaxies or near-field cosmology.
...
## 46. [Meteor observations as a tool to constrain cosmogonic models of the Solar System](https://arxiv.org/abs/2601.02599) <a id="link46"></a>
...
**Comment:** This paper uses meteor observations to constrain cosmogonic models of the Solar System, focusing on the composition of the Oort cloud. It does not fit any of the core criteria related to galaxies, star formation, or stellar models.
...
## 47. [Predictability of bursts of a recurrent nova using topological data analysis and machine learning](https://arxiv.org/abs/2601.02403) <a id="link47"></a>
...
**Comment:** Focuses on recurrent nova RS Oph and uses machine learning and topological data analysis to predict nova bursts. This is a study of cataclysmic variables, not dwarf galaxies, resolved star formation histories, or galaxy simulations. No direct relevance to any core criteria.
...
## 48. [Indications of a Late-Time Transition to a Strongly Interacting Dark Sector](https://arxiv.org/abs/2601.02789) <a id="link48"></a>
...
**Comment:** Explores a cosmological model with a late-time transition to a strongly interacting dark sector, using cosmological observations. No direct relevance to galaxy properties, near-field cosmology, or resolved star formation histories.
...
## 49. [GATOS XI : Excess dust heating in the Narrow Line Regions of nearby AGN revealed with JWST/MIRI](https://arxiv.org/abs/2601.02865) <a id="link49"></a>
...
**Comment:** Investigates dust heating in the narrow line regions of nearby AGN using JWST/MIRI, focusing on dust, shocks, and AGN feedback. Does not match any of the core criteria (no focus on star-formation-driven outflows, dwarf galaxies, or CGM).
...
## 50. [A New Collision Avoidance Fiber Assignment Algorithm for Robotic Fiber Positioners in Multi-Object Spectroscopy](https://arxiv.org/abs/2601.02795) <a id="link50"></a>
...
**Comment:** Presents a new algorithm for fiber assignment in multi-object spectroscopy, which is a technical improvement for instrumentation but not directly relevant to the specified criteria.
...
## 51. [Primordial Black Hole Formation in $f(R)=R+\alpha R^2$ Gravity: Perturbative and Non-Perturbative Analysis](https://arxiv.org/abs/2601.02416) <a id="link51"></a>
...
**Comment:** This paper analyzes primordial black hole formation in modified gravity models, focusing on early universe cosmology and gravitational collapse. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or dwarf galaxy properties. The work is purely theoretical and focused on PBH formation, which is outside the scope of the relevant criteria.
...
## 53. [Isotopic Ratios in the Disk of HD 163296](https://arxiv.org/abs/2601.02593) <a id="link53"></a>
...
**Comment:** This paper measures isotopic ratios in the disk of HD 163296, a protoplanetary disk around a Herbig Ae star. While it provides insights into chemical evolution in planet-forming environments, it does not address any of the core criteria such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 54. [Beyond Sgr A* and M87*: Sub-Microarcsecond Black Hole Shadow Detection via Lunar-based Extremely Long Baseline Interferometry](https://arxiv.org/abs/2601.02812) <a id="link54"></a>
...
**Comment:** This paper discusses the potential for lunar-based VLBI to detect black hole shadows of supermassive black holes. The focus is on SMBHs and black hole imaging, which is specifically listed as irrelevant in the criteria.
...
## 55. [Finite Plasma Beta Three-dimensional Magnetic Field Extrapolation Based on MHD Relaxation Method](https://arxiv.org/abs/2601.02772) <a id="link55"></a>
...
**Comment:** Presents a new method for 3D magnetic field extrapolation in the solar atmosphere. This is a stellar/solar physics paper, not related to galaxy evolution, dwarf galaxies, or any core criteria.
...
## 57. [Tracing Pebble Drift History in Two Protoplanetary Disks with CO Enhancement](https://arxiv.org/abs/2601.02545) <a id="link57"></a>
...
**Comment:** Studies pebble drift and CO enhancement in protoplanetary disks, relevant to planet formation, not galaxy evolution or any core criteria.
...
## 58. [Orchestral AI: A Framework for Agent Orchestration](https://arxiv.org/abs/2601.02577) <a id="link58"></a>
...
**Comment:** Presents a framework for agent orchestration in AI, not related to astrophysics or any core criteria.
...
## 59. [The Maximum Gravity Model for partial Tidal Disruption Events: Mass Loss, Peak Fallback Rate and Dependence on Stellar Properties](https://arxiv.org/abs/2601.02476) <a id="link59"></a>
...
**Comment:** Develops an analytical model for partial tidal disruption events (TDEs) involving supermassive black holes and stars. TDEs are explicitly listed as irrelevant in the criteria.
...
## 60. [Transient Large-Scale Anisotropy in TeV Cosmic Rays due to an Interplanetary Coronal Mass Ejection](https://arxiv.org/abs/2601.02801) <a id="link60"></a>
...
**Comment:** The paper reports transient large-scale anisotropy in TeV cosmic rays due to a coronal mass ejection, focusing on cosmic ray propagation and interplanetary magnetic structures. It does not address any of the core criteria such as near-field cosmology, dwarf galaxies, star formation, or galaxy simulations.
...
## 61. [Dynamical Origins of Azimuthal Metallicity Variations in the Galactic Disk: Insights from Kinematic Ridges with Gaia](https://arxiv.org/abs/2601.02494) <a id="link61"></a>
...
**Comment:** This paper investigates azimuthal metallicity variations in the Milky Way disk and their dynamical origins, focusing on the bar, spiral arms, and interactions with a Sagittarius-like dwarf galaxy. However, the main focus is on the Milky Way disk and its non-axisymmetric features, which are specifically listed as irrelevant in the criteria. The mention of a Sagittarius-like dwarf is peripheral and not the main focus.
...
## 62. [Bounce Inflation with Dynamical Dark Energy in Light of DESI DR2](https://arxiv.org/abs/2601.03028) <a id="link62"></a>
...
**Comment:** Examines cosmological models and dark energy evolution using DESI DR2 data. No direct connection to near-field cosmology, resolved star formation histories, or galaxy simulations. Focus is on cosmological parameters, not galaxies or their properties.
...
## 63. [Super-Orbital Variations in Magnetar Rotation Measure Arising from the Precession of Companion Star: Implications for FRB 20220529](https://arxiv.org/abs/2601.02734) <a id="link63"></a>
...
**Comment:** Discusses rotation measure variations in a magnetar binary system and implications for FRBs. No connection to galaxy evolution, dwarf galaxies, or any of the core criteria.
...
## 64. [Polarization of the CMB in the Standard Model Extension](https://arxiv.org/abs/2601.02961) <a id="link64"></a>
...
**Comment:** Explores Lorentz violation effects on CMB polarization. This is a cosmology paper, but not related to galaxy evolution, dwarf galaxies, or any core criteria.
...
## 65. [SpaceWire-based Data Acquisition Network for the Solar Flare Sounding Rocket Experiment FOXSI-4 and FOXSI-5](https://arxiv.org/abs/2601.02788) <a id="link65"></a>
...
**Comment:** Describes a SpaceWire-based data acquisition system for solar flare sounding rocket experiments. Focus is on instrumentation and solar physics, not on galaxies or any core criteria.
...
## 66. [Models and Observational Predictions of Dust Traps in Protoplanetary Discs](https://arxiv.org/abs/2601.02486) <a id="link66"></a>
...
**Comment:** Focuses on dust evolution and trapping in protoplanetary discs, which is not relevant to any of the specified criteria (e.g., near-field cosmology, dwarf galaxies, resolved star formation histories, stellar models, galaxy simulations, outflows, or CGM).
...
## 67. [Using 23 Years of ACS/SBC Data to Understand Backgrounds: Significant Reductions in Expected Background Levels](https://arxiv.org/abs/2601.02551) <a id="link67"></a>
...
**Comment:** Discusses HST background levels and improvements in observational planning. No direct relevance to any of the specified criteria (no connection to galaxy evolution, star formation, or stellar models).
...
## 68. [Utilizing anticoincidence veto in a search for gravitational-wave transients](https://arxiv.org/abs/2601.02713) <a id="link68"></a>
...
**Comment:** Presents a technique for vetoing noise in gravitational-wave transient searches. No connection to galaxy properties, star formation, or near-field cosmology.
...
## 69. [On the exceptionality of exceptional gravitational-wave events](https://arxiv.org/abs/2601.02467) <a id="link69"></a>
...
**Comment:** Discusses the exceptionality of gravitational-wave events and measurement uncertainties. No connection to galaxy properties, star formation, or near-field cosmology.
...
## 70. [Standard Model Higgs Peaks: a Note on the Vacuum Instability during Inflation](https://arxiv.org/abs/2601.03231) <a id="link70"></a>
...
**Comment:** Examines Higgs vacuum instability during inflation, which is not relevant to any of the specified criteria (no connection to galaxies, star formation, or stellar models).
...
## 71. [Late-time Background Constraints on Linear and Non-linear Interacting Dark Energy after DESI DR2](https://arxiv.org/abs/2601.03122) <a id="link71"></a>
...
**Comment:** Focuses on interacting dark energy models and cosmological constraints, which is not relevant to the specified criteria (no connection to galaxies, star formation, or stellar models).
...
## 72. [Validation of Satellite Lifetime Predictions at Leonid Space](https://arxiv.org/abs/2601.02453) <a id="link72"></a>
...
**Comment:** Satellite lifetime prediction and validation, not relevant to any of the specified astrophysical criteria.
...
## 73. [Catching 3I/ATLAS Using a Solar Oberth](https://arxiv.org/abs/2601.02533) <a id="link73"></a>
...
**Comment:** Mission planning for intercepting an interstellar object, not relevant to the specified criteria.
...
## 75. [The Study of a Cosmic Ray Candidate Detected by the Askaryan Radio Array](https://arxiv.org/abs/2601.02718) <a id="link75"></a>
...
**Comment:** Focuses on cosmic ray detection and event reconstruction in the Askaryan Radio Array, unrelated to the specified criteria.
