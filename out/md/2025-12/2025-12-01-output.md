...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 68963    | 10186        | 79149   |
| **Cost**             | $0.14    | $0.08        | $0.22   |

Total arXiv papers: 259
...
1. [LYRA ultra-faints: The emergence of faint dwarf galaxies in the presence of an early Lyman-Werner background](#user-content-link1)
**Authors:** Shaun T. Brown, Azadeh Fattahi, Thales A. Gutcke, Sylvia Ploeckinger, Joaquin Sureda, Sownak Bose, Jessica E. Doppel, R\"udiger Pakmor, Adrian Jenkins

2. [Differentiable N-body code for Galactic Dynamics -- Odisseo](#user-content-link2)
**Authors:** Giuseppe Viterbo, Tobias Buck

3. [Consequences of radially correlated rotation curves for galaxy mass models](#user-content-link3)
**Authors:** Helena Chase (Durham-ICC), Diego Dado (Durham-ICC), Katherine E. Harborne (Durham-ICC), Kyle A. Oman (Durham-ICC)

4. [An improved formalism for measuring the dark matter subhalos mass by its gravitational wake](#user-content-link4)
**Authors:** M. E. Mosquera, K. J. Fushimi, M. J. de L. Dom\'inguez Romero

5. [Non-Gaussianity in SMICA](#user-content-link5)
**Authors:** M. Citran, H. V. Tran, G. Patanchon, B. van Tent

6. [Modeling Galaxy Formation in Cosmological Simulations with CRK-HACC](#user-content-link6)
**Authors:** Nicholas Frontiere, J. D. Emberson, Michael Buehlmann, Salman Habib, Katrin Heitmann, Nesar Ramachandra, Claude-Andr\'e Faucher-Gigu\`ere

7. [From metallicity distributions to mutual information: A new perspective on stellar halo assembly](#user-content-link7)
**Authors:** Amit Mondal, Biswajit Pandey

8. [Constraining dark matter halo profiles with symbolic regression](#user-content-link8)
**Authors:** Alicia Mart\'in, Tariq Yasin, Deaglan J. Bartlett, Harry Desmond, Pedro G. Ferreira

9. [High Mass Dark Matter Searches With the High Speed Flux From the Large Magellanic Cloud](#user-content-link9)
**Authors:** Nassim Bozorgnia, Joseph Bramante, Andrew Buchanan

10. [Investigating the Impacts of AGN Activities on Dwarf Galaxies with FAST HI Observations](#user-content-link10)
...
11. [Bursty star formation, chemical enrichment, and star cluster formation in numerical analogues of GN-z11](#user-content-link11)
**Authors:** Takayuki R. Saitoh, Yutaka Hirai, Michiko S. Fujii, Yuki Isobe

12. [Predictions on gravity mode pulsations of collisional blue straggler stars in globular clusters](#user-content-link12)
**Authors:** Lorenzo Briganti, Walter Eduard van Rossem, Andrea Miglio, Angela Bragaglia, Massimiliano Matteuzzi

13. [The EBLM Project XVIII. 3D Obliquities of Five Low-Mass Eclipsing Binaries](#user-content-link13)
**Authors:** Becca Spejcher, David V. Martin, Jake Pandina, Andy Zhang, Max Ammons, Wata Tubthong, Amaury Triaud, Ritika Sethi, Noah Vowell, Adrian Barker, Pierre Maxted, Alison Duck, Shelby Summers, Fran\c{c}ois Bouchy, Monika Lendl, Maxime Marmier, Vincent Megevand, Francesco Pepe, Malte Tewes, St\'ephane Udry

14. [Asteroseismic detection of an internal magnetic field in the B0.5V pulsator HD 192575](#user-content-link14)
**Authors:** Jelle Vandersnickt, Vincent Vanlaer, Mathijs Vanrespaille, Conny Aerts

15. [Young M dwarfs flare activity model: Towards better exoplanetary atmospheric characterisation](#user-content-link15)
**Authors:** E. Mamonova, A. F. Kowalski, K. Herbst, S. Wedemeyer, S. C. Werner

16. [Predictions from $s$-process AGB models of the isotopic variations of zirconium and neodymium for comparison to bulk meteorites](#user-content-link16)
**Authors:** Maria Lugaro, Giulia C. Cinquegrana, Bal\'azs Sz\'anyi, James M. Ball, Borb\'ala Cseh, Mattias Ek, Amanda I. Karakas, Maria Sch\"onb\"achler, John C. Lattanzio

17. [Galaxy and Mass Assembly (GAMA): The Properties of Quasar Host Galaxies: Star Formation Histories and Stellar Populations](#user-content-link17)
**Authors:** Maria B. Stone (University of Turku), Roberto De Propris (Finnish Centre for Astronomy with ESO), Clare Wethers (Chalmers University of Technology), Jari Kotilainen (Finnish Centre for Astronomy with ESO), Nischal Acharya (Donostia International Physics Center), Benne Holwerda (University of Louisville), Andrew M. Hopkins (Macquarie University), Kevin Pimbblet (Macquarie University)

18. [The network analysis of the cosmic web as a tool to constrain cosmology and cosmic magnetism](#user-content-link18)
**Authors:** Anton Rudakovskyi, Franco Vazza, Maksym Tsizh

19. [Statistical Properties of Cold Streams In Massive Star-Forming Halos in IllustrisTNG-50](#user-content-link19)
**Authors:** Isabel Medlock, Daisuke Nagai, Nir Mandelker, Volker Springel, Frank C. van den Bosch, Elad Zinger, Barry T. Chiang

20. [Effects of Resolution and Local Stability on Galactic Disks: I. Multiple Spiral Mode Formation via Swing Amplification](#user-content-link20)
**Authors:** SungWon Kwak, Ivan Minchev, Christoph Pfrommer, Matthias Steinmetz, Sukyoung K. Yi

21. [Connecting Star Formation in the Milky Way and Nearby Galaxies -II. An Analytical Model to Predict Cloud-Scale Star Formation Rate](#user-content-link21)
**Authors:** J. W. Zhou, Sami Dib, Pavel Kroupa

22. [J-PAS: A value-added catalogue of optical line intensities for nebular emission galaxies (JOLINES)](#user-content-link22)
**Authors:** J. A. Fern\'andez-Ontiveros, C. L\'opez-Sanjuan, A. Hern\'an-Caballero, A. Lumbreras-Calle, J. Iglesias-P\'aramo, A. Torralba, R. M. Gonz\'alez Delgado, A. del Pino, P. T. Rahna, I. E. L\'opez, R. Amor\'in, J. M. V\'ilchez, C. Kehrig, I. Breda, D. Fern\'andez Gil, F. D. Arizo-Borillo, A. Gim\'enez-Alc\'azar, E. P\'erez-Montero, F. J. S\'aez Ruiz, N. Acharya, R. Abramo, J. Alcaniz, N. Ben\'itez, S. Bonoli, S. Carneiro, J. Cenarro, D. Crist\'obal-Hornillos, S. Daflon, R. Dupke, A. Ederoclite, C. Hern\'andez-Monteagudo, J. Liu, A. Mar\'in-Franch, C. Mendes de Oliveira, M. Moles, F. Roig, L. Sodr\'e Jr., K. Taylor, J. Varela, H. V\'azquez Rami\'o, J. Zaragoza-Cardiel

23. [High-resolution cosmological simulations of primordial dark matter clustering under long-range and fractional forces](#user-content-link23)
**Authors:** Derek Inman

24. [Astrophysical constraints from future measurements of the kinetic Sunyaev-Zel'dovich power spectrum](#user-content-link24)
**Authors:** Lisa McBride, Ad\'elie Gorce, Marian Douspis, Romain Meriot, Beno\^it Semelin, Lukas T. Hergt, Stephane Ili\'c, Miren Mu\~noz-Echeverr\'ia, Etienne Pointecouteau, Laura Salvati, Matthieu Tristram

25. [APEX survey of interstellar HCl: $^{35}$Cl/$^{37}$Cl isotopic ratios in dense cores and outflows](#user-content-link25)
**Authors:** Lennart M. B\"ohm, Arshia M. Jacob, Friedrich Wyrowski, Karl M. Menten, Katharina Immer, Ashley T. Barnes

26. [Classical Cepheids in the Galactic thin disk. I. Abundance gradients through NLTE spectral analysis](#user-content-link26)
**Authors:** Antonino Nunnari, Valentina D'Orazi, Giuliana Fiorentino, Vittorio F. Braga, Giuseppe Bono, Michele Fabrizio, Henrik J\"onsson, Rolf-Peter Kudritzki, Ronaldo da Silva, Maria Bergemann, Eloisa Poggio, Jonah V. Otto, Karina Baeza-Villagra, Angela Bragaglia, Giulia Ceci, Massimo Dall'Ora, Laura Inno, Carmela Lardo, Noriyuki Matsunaga, Matteo Monelli, Manuel S\'anchez-Benavente, Chris Sneden, Maria Tantalo, Fr\'ed\'eric Th\'ev\'enin

27. [Probing Exotic Astrophysical Dark objects through Astrometric Microlensing from Gaia](#user-content-link27)
**Authors:** Lalit Singh Bhandari, Vikram Rentala, Arun M. Thalapillil, Himanshu Verma

28. [Deep insights into Abell 2163: unveiling the treasure trove of ICM plasma physics](#user-content-link28)
**Authors:** Ramananda Santra (National Centre for Radio Astrophysics, Tata Institute of Fundamental Research, Pune, India, INAF - IRA, Bologna, Italy), Ruta Kale (National Centre for Radio Astrophysics, Tata Institute of Fundamental Research, Pune, India), Simona Giacintucci (Naval Research Laboratory, Washington, DC, USA), Herve Bourdin (Dipartimento di Fisica, Universit\`a di Roma Tor Vergata, Roma, Italy, INFN, Sezione di Roma 2, Universit\`a di Roma Tor Vergata, Roma, Italy), Rashi Jain (National Centre for Radio Astrophysics, Tata Institute of Fundamental Research, Pune, India), Andrea Botteon (INAF - IRA, Bologna, Italy), Gianfranco Brunetti (INAF - IRA, Bologna, Italy)

29. [Consensus based Algorithm for Nonparametric Detection of Star Clusters (CANDiSC)](#user-content-link29)
...
30. [Macroscopic Dark Matter under siege: from White Dwarf Data to Gravitational Wave Detection](#user-content-link30)
**Authors:** Siyu Jiang, Aidi Yang, Fa Peng Huang

31. [Gravitational Waves as a Probe of Core Collapse Supernova Progenitor Structure](#user-content-link31)
...
32. [The life of central radio galaxies in clusters: AGN-ICM studies of eRASS1 clusters in the ASKAP fields](#user-content-link32)
**Authors:** Angie Veronica, Thomas H. Reiprich, Florian Pacaud, Marcus Br\"uggen, B\"arbel Koribalski, Thomas Pasini, Tessa Vernstrom, Stefan W. Duchesne, Kathrin B\"ockmann, Jeremy S. Sanders, Y. Emre Bahar, Fabian Balzer, Lachlan J. Barnes, Esra Bulbul, Nicolas Clerc, Jessica E. M. Craig, Johan Comparat, Simon Dannhauer, Jakob Dietl, Klaus Dolag, Vittorio Ghirardini, Sebastian Grandis, Duy Hoang, Andrew M. Hopkins, Zsofi Igo, Matthias Kluge, Ang Liu, Konstantinos Migkas, Vanessa A. Moss, Miriam E. Ramos-Ceja, Chris Riseley, Lawrence Rudnick, Mara Salvato, Stanislav Shabala, Riccardo Seppi, Jacco van Loon, Tayyaba Zafar, Xiaoyuan Zhang

33. [The relations between dust properties and galaxy global / integrated quantities in the nearby Universe](#user-content-link33)
**Authors:** Bogdan A. Pastrav

34. [Globules and pillars in Cygnus X IV. Velocity-resolved [OI] 63 mu map of a peculiar proplyd-like object](#user-content-link34)
**Authors:** N. Schneider (I. Physik. Institut, Universit\"at zu K\"oln, Germany), S. Dannhauer (I. Physik. Institut, Universit\"at zu K\"oln, Germany, MPIfR Bonn, Germany), E. Keilmann (I. Physik. Institut, Universit\"at zu K\"oln, Germany), S. Kabanovic (I. Physik. Institut, Universit\"at zu K\"oln, Germany), T. Topkaras (I. Physik. Institut, Universit\"at zu K\"oln, Germany), V. Ossenkopf-Okada (I. Physik. Institut, Universit\"at zu K\"oln, Germany), R. Higgins (I. Physik. Institut, Universit\"at zu K\"oln, Germany), A. Brunthaler (MPIfR Bonn, Germany), Won-Ju Kim (I. Physik. Institut, Universit\"at zu K\"oln, Germany, MPIfR Bonn, Germany), F. Comeron (ESO, Garching, Germany), M. Roellig (Physikalischer Verein, Frankfurt, Germany, I. Physik. Institut, Universit\"at zu K\"oln, Germany), T. Csengeri (LAB Universite de Bordeaux, Pessac, France), R. Simon (I. Physik. Institut, Universit\"at zu K\"oln, Germany), Y. Okada (I. Physik. Institut, Universit\"at zu K\"oln, Germany), M. Justen (I. Physik. Institut, Universit\"at zu K\"oln, Germany), S. A. Dzib (MPIfR Bonn, Germany), G. N. Ortiz-Le\'on (Instituto Nacional de Astrof\'isica, Puebla, Mexico)

35. [Intrinsic galaxy alignments in CAMELS simulations and the significant impact of baryon model](#user-content-link35)
**Authors:** Daniel Bilsborrow, Niall Jeffrey

36. [$\delta$ Circini: A massive hierarchical triple system with an eclipsing binary](#user-content-link36)
**Authors:** J. \v{S}vr\v{c}kov\'a, P. Harmanec, R. Klement, Th. Rivinius, B. N. Barlow, J. Jury\v{s}ek, M. Ma\v{s}ek, K. Ho\v{n}kov\'a, A. Opli\v{s}tilov\'a

37. [Properties of Core Collapse Supernovae from Binary Population Synthesis](#user-content-link37)
**Authors:** Mark Martinez, Anna O'Grady, Katelyn Breivik, Gina Chen

38. [A Comprehensive Study of WIMP Models Explaining the Fermi-LAT Galactic Center Excess](#user-content-link38)
**Authors:** Chuiyang Kong, Mattia Di Mauro

39. [SlotFlow: Amortized Trans-Dimensional Inference with Slot-Based Normalizing Flows](#user-content-link39)
**Authors:** Niklas Houba, Giovanni Giarda, Lorenzo Speri

40. [Incorporating neutron star physics into gravitational wave inference with neural priors](#user-content-link40)
**Authors:** Thibeau Wouters, Peter T. H. Pang, Tim Dietrich, Chris Van Den Broeck

41. [3D Modeling of Solar Oscillations with Hybridizable Discontinuous Galerkin Method](#user-content-link41)
**Authors:** Florian Faucher, Ha Pham, Damien Fournier, Patrick Amestoy, H\'el\`ene Barucq, Jean-Yves L'Excellent, Th\'eo Mary, Laurent Gizon

42. [The Hubble Ultracool Multiplicity (HUM) Survey. I. Characterizing Sensitivity to Companions at Sub-Diffraction Limit Separations with HST WFC3/IR](#user-content-link42)
**Authors:** Kunal Mehta, Matthew De Furio, Daniella Bardalez Gagliuffi, Trent J. Dupuy, Cl\'emence Fontanive, Adam L. Kraus, Michael R. Meyer, Matthew Cole, Fernanda Sophia Morais Laroca

43. [Little Red Dots host Black Hole Stars: A unified family of gas-reddened AGN revealed by JWST/NIRSpec spectroscopy](#user-content-link43)
**Authors:** Anna de Graaff, Raphael E. Hviding, Rohan P. Naidu, Jenny E. Greene, Tim B. Miller, Joel Leja, Jorryt Matthee, Gabriel Brammer, Harley Katz, Rachel Bezanson, Leindert A. Boogaard, Sownak Bose, John Chisholm, Nikko J. Cleri, Pratika Dayal, Robert Feldmann, Yoshinobu Fudamoto, Seiji Fujimoto, Lukas J. Furtak, Karl Glazebrook, Rashmi Gottumukkala, Kasper E. Heintz, Vasily Kokorev, Ivo Labbe, Michael V. Maseda, Ian McConachie, Themiya Nanayakkara, Erica Nelson, Przemys{\l}aw Nowaczyk, Pascal A. Oesch, Hans-Walter Rix, David J. Setton, Alberto Torralba, Fabian Walter, Bingjie Wang, Andrea Weibel, Arjen van der Wel

44. [Skew-spectra: a generalization to spin-$s$](#user-content-link44)
**Authors:** Alexander Roskill, Sara Maleubre, David Alonso, Pedro G. Ferreira

45. [Forecasting Constraint on Primordial Black Hole Properties with the CSST $3\times2$pt Analysis](#user-content-link45)
**Authors:** Dingao Hu, Yan Gong, Pengfei Su, Hengjie Lin, Haitao Miao, Qi Xiong, Xuelei Chen

46. [Identifying Transient Hosts in LSST's Deep Drilling Fields with Galaxy Catalogues](#user-content-link46)
**Authors:** Josh G. Weston, David R. Young, Stephen J. Smartt, Matt Nicholl, Matt J. Jarvis, I. H. Whittam

47. [The Shear-to-Cosmology Paradigm I: Hybrid Field-Level and Simulation-Based Framework for Weak Lensing Surveys](#user-content-link47)
**Authors:** Jiacheng Ding, Chen Su, Ji Yao, Le Zhang, Huanyuan Shan

48. [Primordial Black Holes as Dark Matter and the Tachyonic Trap During Inflation](#user-content-link48)
**Authors:** Yuma S. Furuta, Mindaugas Kar\v{c}iauskas, Kazunori Kohri, Alejandro S\'aez

49. [The LMT 2 Millimeter Receiver System (B4R). I. Overview and Results of Science Demonstration](#user-content-link49)
**Authors:** Ryohei Kawabe, Takeshi Sakai, Kunihiko Tanaka, Akio Taniguchi, Bunyo Hatsukade, Yoichi Tamura, Yuki Yoshimura, Tatsuya Takekoshi, Tai Oshima, Masato Hagimoto, Teppei Yonetsu, Kotomi Taniguchi, Kotaro Kohno, Hiroyuki Maezawa, David H. Hughes, Peter F. Schloerb, Edgar Col\'in-Beltr\'an, Miguel Ch\'avez Dagostino, V\'ictor G\'omez-Rivera, Arturo I. G\'omez-Ruiz, Gopal Narayanan, Iv\'an Rodr\'iguez-Montoya, David S\'anchez-Arg\"uelles, Yoshito Shimajiri, Kamal Souccar, Min S. Yun, Tom J. L. C. Bakx, Kevin C. Harrington, Shinji Fujita, Fumitaka Nakamura, O. S. Rojas-Garc\'ia, Alfredo A. Monta\~na Barbano, Javier Zaragoza-Cardiel

50. [Cosmology of axion dark energy in supersymmetric models and constraints on high scale parameters](#user-content-link50)
**Authors:** Amin Aboubrahim, Andrew H. Giman, Pran Nath

51. [Forecasting Primordial Non-Gaussianity from UNIONS Lyman-Break Galaxies and Planck CMB lensing](#user-content-link51)
**Authors:** Constantin Payerne, William d'Assignies, Christophe Y\`eche, Hendrik Hildebrandt, Dustin Lang, Thomas de Boer

52. [Misalignment dynamics of Scalar Condensates with Yukawa coupling: Particle and Entropy Production](#user-content-link52)
**Authors:** Nathan Herring, Daniel Boyanovsky

53. [Tracing Structure: Shape and Centroid Deviations in 39 Strong Lensing Clusters as a Test of Cluster Formation Predictions](#user-content-link53)
...
54. [ALMACAL. XV. Band 3 ALMA Survey and Number Counts](#user-content-link54)
...
55. [Characterizing Binary Black Hole Subpopulations in GWTC-4 with Binned Gaussian Processes: On the Origins of the $35M_{\odot}$ Peak](#user-content-link55)
**Authors:** Omkar Sridhar, Anarya Ray, Vicky Kalogera

56. [Bubble Nucleation from Boson Star Collapse](#user-content-link56)
**Authors:** Aleksandr Azatov, Takeshi Kobayashi, Nicklas Ramberg

57. [Klein Bottle Cosmology](#user-content-link57)
**Authors:** Brian Greene, Daniel Kabat, Janna Levin, Massimo Porrati

58. [Evaluating Star-Planet Interactions with Zeeman Doppler Imaging: Case Study in YZ Ceti](#user-content-link58)
**Authors:** J. Sebastian Pineda, Stefano Bellotti, Jackie Villadsen, Aline Vidotto, Julien Morin, Colin P. Folsom

59. [Cosmological Constraints on 4D Einstein-Gauss-Bonnet Gravity and Kaniadakis Holographic Dark Energy: Implications for Black Hole Shadows](#user-content-link59)
**Authors:** Xiang-Qian Li, Hao-Peng Yan, Xiao-Jun Yue

60. [Multipole moments do not uniquely characterise spacetimes beyond general relativity](#user-content-link60)
**Authors:** Arthur G. Suvorov, George Pappas

61. [The LMT 2 millimeter receiver system (B4R). II. Science demonstration observations toward Orion-KL/OMC-1](#user-content-link61)
**Authors:** Teppei Yonetsu, Ryohei Kawabe, Yuki Yoshimura, Kotomi Taniguchi, Yoshito Shimajiri, Omar Sergio Rojas-Garc\'ia, Arturo I. G\'omez-Ruiz, Takeshi Sakai, Kunihiko Tanaka, Bunyo Hatsukade, Akio Taniguchi, Yoichi Tamura, Tatsuya Takekoshi, Tai Oshima, Kotaro Kohno, Masato Hagimoto, David H. Hughes, Peter F. Schloerb, David S\'anchez-Arg\"uelles, Kamal Souccar, Gopal Narayanan, Min S. Yun, V\'ictor G\'omez-Rivera, Iv\'an Rodr\'iguez-Montoya, Edgar Col\'in-Beltr\'an, Miguel Ch\'avez Dagostino, Javier Zaragoza-Cardiel, Shinji Fujita, Hiroyuki Maezawa

62. [Vector-field spontaneous baryogenesis with Lorentz invariance violation](#user-content-link62)
**Authors:** Mattia Dubbini, Orlando Luongo, Aniello Quaranta

63. [GANDALF: A hardware-agnostic spectral solver for kinetic reduced MHD turbulence](#user-content-link63)
**Authors:** Anjor Kanekar

64. [A Catalogue of Mid-infrared Variable Sources from unTimely](#user-content-link64)
**Authors:** Zihan kang, Jingyi Zhang, Yanxia Zhang, Changhua Li, Xiao Kong, Minzhi Kong, Jinghang Shi, Shirui Wei, Xue-Bing Wu

65. [Laboratory Detection and Rotational Spectroscopy of $trans$-HNSO: Implications for Astronomical Observations](#user-content-link65)
**Authors:** Valerio Lattanzi, Miguel Sanz-Novo, V\'ictor M. Rivilla, Izaskun Jim\'enez-Serra, Paola Caselli

66. [Baryon fraction from the BAO amplitude: a consistent approach to parameterizing perturbation growth](#user-content-link66)
**Authors:** Andrea Crespi, Will J. Percival, Alex Krolewski, Marco Bonici, Hanyu Zhang, Jessica Nicole Aguilar, Steven Ahlen, Abhijeet Anand, Davide Bianchi, David Brooks, Edmond Chaussidon, Todd Claybaugh, Todd Cuceu, Axel de la Macorra, Peter Doel, Simone Ferraro, Andreu Font-Ribera, Jaime E. Forero-Romero, Enrique Gazta\~naga, Gaston Gutierrez, Julien Guy, Hiram K. Herrera-Alcantar, Dragan Huterer, Mustapha Ishak, Dick Joyce, David Kirkby, Theodore Kisner, Anthony Kremin, Ofer Lahav, Claire Lamman, Martin Landriau, Laurent Le Guillou, Michael E. Levi, Marc Manera, Paul Martini, Aaron Meisner, Ramon Miquel, Seshadri Nadathur, Nathalie Palanque-Delabrouille, Claire Poppett, Francisco Prada, Ignasi P\'erez-R\`afols, Graziano Rossi, Lado Samushia, Eusebio Sanchez, David Schlegel, Michael Schubnell, Hee-Jong Seo, Joseph H. Silber, David Sprayberry, Gregory Tarl\'e, Benjamin A. Weaver, Rongpu Zhou, Hu Zou

67. [Identifying bars in galaxies using machine learning](#user-content-link67)
**Authors:** Rajit Shrivastava

68. [Detection of the Pairwise Kinematic Sunyaev-Zel'dovich Effect and Pairwise Velocity with DESI DR1 Galaxies and ACT DR6 and Planck CMB Data](#user-content-link68)
**Authors:** Yulin Gong, Patricio A. Gallardo, Rachel Bean, Jenna Moore, Eve M. Vavagiakis, Nicholas Battaglia, Boryana Hadzhiyska, Yun-Hsin Hsu, Jessica Nicole Aguilar, Steven Ahlen, Davide Bianchi, David Brooks, Todd Claybaugh, Rebecca Canning, Mark Devlin, Peter Doel, Axel de la Macorra, Simone Ferraro, Andreu Font-Ribera, Jaime E. Forero-Romero, Enrique Gazta\~naga, Gaston Gutierrez, Satya Gontcho A Gontcho, Julien Guy, Klaus Honscheid, Cullan Howlett, R. Henry Liu, Mustapha Ishak, Dick Joyce, Anthony Kremin, Claire Lamman, Michael Levi, Martin Landriau, Marc Manera, Aaron Meisner, Ramon Miquel, Michael D. Niemack, Seshadri Nadathur, Will Percival, Francisco Prada, Graziano Rossi, Bernardita Ried Guachalla, Eusebio Sanchez, Hee-Jong Seo, David Sprayberry, David Schlegel, Crist\'obal Sif\'on, Michael Schubnell, Joseph Harry Silber, Gregory Tarl\'e, Benjamin Alan Weaver, Rongpu Zhou, Hu Zou

69. [The HITRAN2024 methane update](#user-content-link69)
...
70. [The Atacama Cosmology Telescope: $B$-mode delensing with DR6 data and external tracers of large-scale structure](#user-content-link70)
**Authors:** Emilie Hertig, Ant\'on Baleato Lizancos, Frank J. Qu, J. Richard Bond, Erminia Calabrese, Anthony Challinor, Mark J. Devlin, Jo Dunkley, Thibaut Louis, Mathew S. Madhavacheril, Toshiya Namikawa, Lyman A. Page, Neelima Sehgal, Blake Sherwin, Crist\'obal Sif\'on, Suzanne T. Staggs, Edward J. Wollack

71. [Sulfur monoxide as a tracer of the Galactic $^{32}$S/$^{34}$S gradient](#user-content-link71)
...
72. [Galaxy rotation curve based on RGB stars from the Gaia DR3 catalogue](#user-content-link72)
...
73. [Evading the dust fragmentation barrier with the streaming instability in protoplanetary disks](#user-content-link73)
**Authors:** V. Vallucci-Goy, U. Lebreuilly, M. -M. Mac Low, P. Hennebelle

74. [QCD axions and domain walls in dense matter under compact stellar conditions](#user-content-link74)
**Authors:** Zhen-Yan Lu, Shu-Peng Wang, Qi Lu, Bo-Nan Zhang, Marco Ruggieri

75. [Lorentz Violation in Emergent Gravity and Its Cosmological Consequences](#user-content-link75)
**Authors:** Raymond Isichei, Joao Magueijo

76. [Net Charge Accretion in Magnetized Kerr Black Holes](#user-content-link76)
**Authors:** Ethan Berreby, Avner Okun, Shahar Hadar, Amos Ori

77. [Data-driven informative priors for Bayesian inference with quasi-periodic data](#user-content-link77)
**Authors:** Javier Lopez-Santiago, Luca Martino, Joaquin Miguez, Gonzalo Vazquez-Vilar

78. [Interferometric view into RT Pav's long secondary period. binary vs oscillatory convective modes](#user-content-link78)
**Authors:** B. Courtney-Barrer, X. Haubois, P. Wood, D. Dionese, L. Decin, C. Paladini, I. El Mellah, D. Defr\`ere, M. Ireland

79. [Clustering in dynamical dark energy: observational constraints from DESI, CMB, and supernovae](#user-content-link79)
**Authors:** Yuhang Yang, Qingqing Wang, Xin Ren, Emmanuel N. Saridakis, Yi-Fu Cai

80. [A Detection of Sulfur-Bearing Cyclic Hydrocarbons in Space](#user-content-link80)
**Authors:** Mitsunori Araki, Miguel Sanz-Novo, Christian P. Endres, Paola Caselli, V\'ictor M. Rivilla, Izaskun Jim\'enez-Serra, Laura Colzi, Shaoshan Zeng, Andr\'es Meg\'ias, \'Alvaro L\'opez-Gallifa, Antonio Mart\'inez-Henares, David San Andr\'es, Sergio Mart\'in, Miguel A. Requena-Torres, Juan Garc\'ia de la Concepci\'on, Valerio Lattanzi

81. [Scalar field effective potentials in de Sitter spacetime](#user-content-link81)
**Authors:** Lucas Vicente Garc\'ia-Consuegra, Arttu Rajantie

82. [Data span and frequency coverage requirements for robust detection and inference in PTAs: A case study with EPTA DR2](#user-content-link82)
**Authors:** Irene Ferranti, Mikel Falxa, Federico Fantoccoli, Alberto Sesana, Golam Mohiuddin Shaifullah

83. [Simulating AGN feedback in galaxy clusters with pre-existing turbulence](#user-content-link83)
**Authors:** Jia-Lun Li, H. -Y. Karen Yang

84. [ExoJAX Retrievals of VLT/CRIRES Spectra of Luhman 16AB: C/O Ratios and Systematic Uncertainties](#user-content-link84)
**Authors:** Hibiki Yama, Kento Masuda, Yui Kawashima, Hajime Kawahara

85. [Towards Understanding the Origin of Swift Gamma-Ray Bursts Driven by Magnetars](#user-content-link85)
**Authors:** C. T. Hao, J. H. Jing, X. L. Han, H. R. Lan, W. C. Du, X. N. Liu, Z. B. Zhang, H. C. Liu, J. F. Wu, X. L. Xia

86. [Spiral excitation in protoplanetary disks through gap-edge illumination: Distinctive kinematic signatures in CO isotopologues](#user-content-link86)
**Authors:** Dhruv Muley, Le\'on-Alexander H\"uhn, Haochang Jiang, David Melon Fuksman

87. [Structure-Preserving Unpaired Image Translation to Photometrically Calibrate JunoCam with Hubble Data](#user-content-link87)
**Authors:** Aditya Pratap Singh, Shrey Shah, Ramanakumar Sankar, Emma Dahl, Gerald Eichst\"adt, Georgios Georgakis, Bernadette Bucher

88. [Collapse of Axion Domain Wall Induced by Helical Primordial Magnetic Fields](#user-content-link88)
**Authors:** Zizhuo Zhao, Yuefeng Di, Ligong Bian, Jing Shu

89. [Synchrotron Self-Compton Model of TeV Afterglows in Gamma-Ray Bursts](#user-content-link89)
**Authors:** Edilberto Aguilar-Ruiz, Ramandeep Gill, Paz Beniamini, Jonathan Granot

90. [Robust evidence for dynamical dark energy in light of DESI DR2 and joint ACT, SPT, and Planck data](#user-content-link90)
**Authors:** Tian-Nuo Li, Guo-Hong Du, Sheng-Han Zhou, Yun-He Li, Jing-Fei Zhang, Xin Zhang

91. [A measurement of $H_0$ from DESI DR1 using energy densities](#user-content-link91)
**Authors:** Alex Krolewski, Andrea Crespi, Will J. Percival, Marco Bonici, Hanyu Zhang, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, R. Canning, E. Chaussidon, T. Claybaugh, A. Cuceu, S. Cole, A. de la Macorra, J. Della Costa, P. Doel, J. Edelstein, S. Ferraro, A. Font-Ribera, J. Forero-Romero, E. Gazta\~naga, S. Gontcho a Gontcho, G. Gutierrez, J. Guy, H. Herrera-Alcantar, K. Honscheid, D. Huterer, M. Ishak, D. Joyce, R. Kehoe, D. Kirkby, T. Kisner, A. Kremin, O. Lahav, C. Lamman, M. Landriau, L. Le Guillou, M. Levi, M. Manera, A. Meisner, R. Miquel, J. Moustakas, A. Mu\~noz-Guti\'errez, S. Nadathur, G. Niz, N. Palanque-Delabrouille, C. Poppett, F. Prada, I. P\'erez-R\`afols, G. Rossi, L. Samushia, E. Sanchez, D. Schlegel, M. Schubnell, J. H. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver, H. Zou

92. [CO observations in rotating circumbinary post-AGB disks](#user-content-link92)
**Authors:** I. Gallardo Cava, J. Alcolea, H. Van Winckel, V. Bujarrabal, M. Santander-Garc\'ia, M. G\'omez-Garrido

93. [Kinetic Mixing and the Phantom Illusion: Axion-Dilaton Quintessence in Light of DESI DR2](#user-content-link93)
**Authors:** Michael W. Toomey, Ellie Hughes, Mikhail M. Ivanov, James M. Sullivan

94. [Vortex Dynamics in the Neutron Star Inner Crust](#user-content-link94)
**Authors:** Xin Sheng, Bennett Link, Matthew E. Caplan, Yuri Levin

95. [The NANOGrav 12.5-year Data Set: Chromatic Noise Characterization & Mitigation with Time-Domain Kernels](#user-content-link95)
**Authors:** Jeffrey S. Hazboun, Joseph Simon, Jeremy Baier, Bjorn Larsen, Daniel J. Oliver, Paul T. Baker, Bence B\'ecsy, Siyuan Chen, Alberto Diaz Hernandez, Justin A. Ellis, A. Miguel Holgado, Kristina Islo, Aaron Johnson, Andrew R. Kaiser, Nima Laal, Alexander McEwen, Nihan S. Pol, Joey Shapiro Key, Min Young Kim, Matthew Samson, Brent J. Shapiro-Albert, Jerry P. Sun, Stephen R. Taylor, Caitlin A. Witt, Jeremy Volpe, Christine Ye, Harsha Blumer, Paul R. Brook, Shami Chatterjee, James M. Cordes, Fronefield Crawford, H. Thankful Cromartie, Megan E. DeCesar, Paul B. Demorest, Timothy Dolch, Robert D. Ferdman, Elizabeth C. Ferrara, William Fiore, Emmanuel Fonseca, Nathan Garver-Daniels, Peter A. Gentile, Deborah C. Good, Ross J. Jennings, Megan L. Jones, David L. Kaplan, Michael T. Lam, T. Joseph W. Lazio, Duncan R. Lorimer, Jing Luo, Ryan S. Lynch, Dustin R. Madison, Maura A. McLaughlin, Chiara M. F. Mingarelli, Cherry Ng, David J. Nice, Timothy T. Pennucci, Scott M. Ransom, Paul S. Ray, Xavier Siemens, Ren\'ee Spiewak, Ingrid H. Stairs, Daniel R. Stinebring, Kevin Stovall, Joseph K. Swiggum, Jacob E. Turner, Michele Vallisneri, Sarah J. Vigeland

96. [The Solar Close Observations and Proximity Experiments (SCOPE) mission](#user-content-link96)
...
97. [A Paradigm Shift in Exoplanet False Positive Identification with HIP-44302](#user-content-link97)
...
98. [Gravitational waves from the late inspiral, transition, and plunge of small-mass-ratio eccentric binaries](#user-content-link98)
**Authors:** Devin R. Becker, Scott A. Hughes, Gaurav Khanna

99. [Searches for Post-Merger Gravitational Waves with CoCoA: Sensitivity Projections Across Large Template Banks for Current and Next-Generation Detectors](#user-content-link99)
**Authors:** Tanazza Khanam (TTU/Rice U.), Alessandra Corsi (JHU), Robert Coyne (URI), Michael St. Pierre (URI)

100. [Variation of Microphysical Parameters in Reverse-shock Scenario](#user-content-link100)
**Authors:** Nissim Fraija, Boris Betancourt-Kamenetskaia, Antonio Galv\'an, Maria Dainotti

101. [BSN: The First Multiband Light Curve Analysis of the W UMa-type Contact Binary System EM Tucanae](#user-content-link101)
**Authors:** Sepideh Houshiar, Atila Poro, Abbas Abedini, Eduardo Fern\'andez Laj\'us

102. [The Parkes Observatory Pulsar Data Archive](#user-content-link102)
**Authors:** Lawrence Toomey, George Hobbs, James Dempsey, Shane Majewski, Shi Dai, John Reynolds

103. [The Kinematic Properties of T\.ZO Candidate HV 11417 with Gaia DR3](#user-content-link103)
**Authors:** Anna J. G. O'Grady

104. [Probing CMB Polarization Gaussianity with the Statistics of Unpolarized Points: Non-Gaussianity of Planck Data and Prospects for Future B-Mode Measurements](#user-content-link104)
**Authors:** K. O. Parfenov, D. I. Novikov, A. O. Mihalchenko

105. [Manifestation of the stellar wind cycle in infrared images: Example of the heliosphere](#user-content-link105)
**Authors:** I. P. Zabolotnyi, V. V. Izmodenov

106. [Recovering Intrinsic Pulsar Profiles and Scattering Parameters with a CLEAN-Based Algorithm for High-Precision Timing](#user-content-link106)
**Authors:** Adarsh Bathula, M. A. Krishnakumar, S. Jena

107. [Constraining the Properties of GRB Accreting Magnetar with $R/I$ Evolutionary Effects Using \emph{Swift}/XRT Data](#user-content-link107)
**Authors:** Lin Lan, He Gao, Litao Zhao, Shunke Ai, Jie Lin, Long Li, Lang Xie, Li-Ping Xin, Jian-Yan Wei

108. [Calcium versus silicon ejecta velocities and decline rates in supernovae Ia: The role of high-velocity features](#user-content-link108)
**Authors:** A. A. Hakobyan, M. H. Gevorgyan, A. G. Karapetyan, G. A. Mamon, D. Kunth, V. Adibekyan, L. V. Barkhudaryan

109. [Witten-O'Raifeartaigh potential revisited in the context of Warm Inflation](#user-content-link109)
**Authors:** Suratna Das, Umang Kumar, Swagat S. Mishra, Varun Sahni

110. [Inflation, black holes with primary hair, and regular planar black holes from an infinite tower of regularized Lovelock-Proca corrections](#user-content-link110)
**Authors:** Pedro G. S. Fernandes, Jingqian Gou, Lavinia Heisenberg, Nadine Nussbaumer

111. [The First Scientific Flight and Observations of the 50-mm Balloon-Borne White-Light Coronagraph](#user-content-link111)
...
112. [Statistical analysis and correction of the pile-up effect in MAPMT single photoelectron counting with the SPACIROC-3 ASIC: application to the Mini-EUSO experiment](#user-content-link112)
**Authors:** Enzio M'sihid (on behalf of the JEM-EUSO Collaboration), Etienne Parizot (on behalf of the JEM-EUSO Collaboration), Matteo Battisti (on behalf of the JEM-EUSO Collaboration), Sylvie Blin (on behalf of the JEM-EUSO Collaboration)

113. [Closing the gap: Follow-up observations of peculiar dusty objects close to Sgr A* using ERIS](#user-content-link113)
**Authors:** F. Pei{\ss}ker, M. Zajacek, V. Karas, V. Pavl\'ik, E. Bordier, L. \v{S}ubr, J. Haas, M. Melamed, L. Gro{\ss}ekath\"ofer, N. Schm\"okel, M. Singhal

114. [Constraining of Nuclear Matter Equations of State With Rotating Neutron Stars](#user-content-link114)
**Authors:** Hyukjin Kwon, Kazuyuki Sekizawa

115. [Large-amplitude Variability Driven by Giant Dust Storms on a Planetary-mass Companion](#user-content-link115)
**Authors:** Xianyu Tan, Xi Zhang, Mark S. Marley, Yifan Zhou, Ben W. P. Lew, Brittany E. Miles, Natasha E. Batalha, Beth A. Biller, Ga\"el Chauvin, Sasha Hinkley, Kielan K. W. Hoch, Elena Manjavacas, Stanimir Metchev, Simon Petrus, Emily Rickman, Andrew Skemer, Genaro Su\'arez, Ben J. Sutlieff, Johanna M. Vos, Niall Whiteford

116. [Inflation Driven by Scalar-Neutrino Coupling in a Mass-Varying Neutrino Framework](#user-content-link116)
**Authors:** Hemanshi Bundeliya, Gaurav Bhandari, S. D. Pathak, V. K. Sharma

117. [Needle in a Poissonian haystack -- An X-ray astronomer's guide to QPE fishing](#user-content-link117)
**Authors:** E. Quintin, N. Khan, N. A. Webb, R. Webbe, R. D. Saxton, G. Miniutti, M. Giustini

118. [Multipartite entanglement features of primordial non-gaussianities](#user-content-link118)
**Authors:** Alessio Belfiglio, Roberto Franzosi, Orlando Luongo

119. [Numerical implementation of flat FLRW models of cosmic expansion with Planck 2018 cosmological parameters](#user-content-link119)
**Authors:** Julio Carlos Bertua Marasca, Homer Davila Gutierrez, Oswaldo Alberto Martinez Osorio, Josue Ismael Mosquera Hadatty, Renato Cristian Videla Ricci

120. [The observation of Ground Level Enhancement GLE 77 by the neutron detectors of the Experimental Complex NEVOD](#user-content-link120)
**Authors:** Evgenii Volkov, Kseniia Chelidze, Dmitrii Gromushkin, Semen Khokhlov, Evgenii Khomchuk, Anatoly Petrukhin, Ivan Shulzhenko

121. [A Novel Comb Generator for Frequency Phase Transfer](#user-content-link121)
**Authors:** Gabriella Montano, Cheukyu Edward Tong, Dan Marrone

122. [Tools and Advancements towards Data Standardization of the MAGIC Collaboration](#user-content-link122)
**Authors:** C. P. Walther (on behalf of the MAGIC collaboration), C. Nigro (on behalf of the MAGIC collaboration), D. Els\"asser (on behalf of the MAGIC collaboration), W. Rhode (on behalf of the MAGIC collaboration)

123. [Blazar classification from multi-wavelength data using Deep Learning](#user-content-link123)
**Authors:** Saqlain Afroz, Titir Mukherjee, Raj Prince

124. [The impact of magnetic fields during tidal disruption events](#user-content-link124)
**Authors:** Simona Pacuraru, Cl\'ement Bonnerot, Martin E. Pessah

125. [On the Relation between Source Region and In-situ Variability of Low $\delta B$ Solar Wind Streams](#user-content-link125)
**Authors:** Kai Jaffarove, Tamar Ervin, Stuart D. Bale

126. [Blending-induced beating and emission in the symbiotic star Terz V 2513](#user-content-link126)
**Authors:** J. Merc, J. Miko{\l}ajewska, C. Ga{\l}an, K. I{\l}kiewicz, P. G. Beck, B. Monard, M. Gromadzki

127. [Kerr black holes as circular polarizers](#user-content-link127)
**Authors:** De-Chang Dai

---

## 1. [LYRA ultra-faints: The emergence of faint dwarf galaxies in the presence of an early Lyman-Werner background](https://arxiv.org/abs/2511.21824) <a id="link1"></a>
...
**Comment:** Presents high-resolution cosmological hydrodynamical simulations of dwarf galaxies in Local Group-like environments, focusing on the emergence of ultra-faint dwarfs and the impact of the Lyman-Werner background. Directly relevant to near-field cosmology, numerical galaxy simulations, and the abundance of dwarf galaxies.
...
## 2. [Differentiable N-body code for Galactic Dynamics -- Odisseo](https://arxiv.org/abs/2511.22468) <a id="link2"></a>
...
**Comment:** Introduces Odisseo, a differentiable N-body code for galactic dynamics, specifically designed to model accreted structures like stellar streams in the Milky Way. Directly relevant to numerical galaxy simulations and near-field cosmology, especially the study of accreted substructures.
...
## 3. [Consequences of radially correlated rotation curves for galaxy mass models](https://arxiv.org/abs/2511.23106) <a id="link3"></a>
...
**Comment:** This paper analyzes rotation curves of galaxies from the SPARC compilation, specifically addressing the impact of correlated data points on mass modeling and the evidence for core-cusp in dark matter halos. The focus on dark matter density profiles and core-cusp evidence in galaxy rotation curves is highly relevant to near-field cosmology.
...
## 4. [An improved formalism for measuring the dark matter subhalos mass by its gravitational wake](https://arxiv.org/abs/2511.23168) <a id="link4"></a>
...
**Comment:** Presents an improved formalism for measuring dark matter subhalo mass via gravitational wakes in the stellar halo, using Gaia data and simulations. The focus on subhalo mass measurement and stellar halo interactions is highly relevant to near-field cosmology and substructure.
...
## 5. [Non-Gaussianity in SMICA](https://arxiv.org/abs/2511.22641) <a id="link5"></a>
...
**Comment:** This paper presents a new method (symbolic regression) to constrain dark matter halo profiles directly from observations, focusing on the density profiles (core-cusp) of dark matter halos. This is highly relevant to near-field cosmology and dark matter density profile measurements.
...
## 6. [Modeling Galaxy Formation in Cosmological Simulations with CRK-HACC](https://arxiv.org/abs/2511.21921) <a id="link6"></a>
...
**Comment:** Presents a new suite of astrophysical subgrid models for cosmological hydrodynamics simulations (CRK-HACC), including star formation, stellar evolution, and AGN feedback. Directly matches the 'Numerical Galaxy Simulations' criterion, with emphasis on new physics models and exascale computing.
...
## 7. [From metallicity distributions to mutual information: A new perspective on stellar halo assembly](https://arxiv.org/abs/2511.23452) <a id="link7"></a>
...
**Comment:** Directly relevant to near-field cosmology: analyzes the metallicity structure and assembly history of Milky Way-mass stellar halos using simulations, with a novel information-theoretic approach. The focus on stellar halo assembly and accreted substructure is highly aligned with the core criteria.
...
## 8. [Constraining dark matter halo profiles with symbolic regression](https://arxiv.org/abs/2511.23073) <a id="link8"></a>
...
**Comment:** This paper presents a new method (Exhaustive Symbolic Regression) to constrain dark matter halo profiles directly from observations, focusing on the density profiles of dark matter halos. This is highly relevant to the 'core-cusp' and dark matter density profile criteria under near-field cosmology, especially as it provides a simulation-independent approach to halo profile determination.
...
## 9. [High Mass Dark Matter Searches With the High Speed Flux From the Large Magellanic Cloud](https://arxiv.org/abs/2511.21841) <a id="link9"></a>
...
**Comment:** Examines the impact of the Large Magellanic Cloud's dynamics on local dark matter velocity distributions and heavy dark matter searches. The focus on the LMC and its effect on the Milky Way's dark matter environment is directly relevant to near-field cosmology and substructure.
...
## 10. [Investigating the Impacts of AGN Activities on Dwarf Galaxies with FAST HI Observations](https://arxiv.org/abs/2511.23356) <a id="link10"></a>
...
**Comment:** Directly relevant to star formation quenching in dwarf galaxies, with observational data comparing AGN-hosting and non-AGN dwarfs, and environmental effects on quenching. Also touches on gas content regulation in dwarfs.
...
## 11. [Bursty star formation, chemical enrichment, and star cluster formation in numerical analogues of GN-z11](https://arxiv.org/abs/2511.23164) <a id="link11"></a>
...
**Comment:** High-resolution cosmological zoom-in simulations of massive high-redshift galaxies, focusing on bursty star formation, chemical enrichment, and star cluster formation. Relevant to 'Numerical Galaxy Simulations' and 'Resolved Star Formation Histories' (theoretical), with additional relevance for chemical enrichment processes.
...
## 12. [Predictions on gravity mode pulsations of collisional blue straggler stars in globular clusters](https://arxiv.org/abs/2511.23189) <a id="link12"></a>
...
**Comment:** This paper presents new stellar models for blue straggler stars, focusing on their internal structure and pulsations. This matches the 'Stellar Models' criterion closely, as it involves theoretical work on stellar evolutionary tracks and internal structure.
...
## 13. [The EBLM Project XVIII. 3D Obliquities of Five Low-Mass Eclipsing Binaries](https://arxiv.org/abs/2511.23430) <a id="link13"></a>
...
**Comment:** This paper presents new measurements of M-dwarf eclipsing binaries, including precise masses and radii, and discusses inflated radii compared to stellar models. The work is relevant to the 'Stellar Models' criterion, as it tests and challenges stellar evolutionary tracks for low-mass stars. However, it does not address galaxy-scale topics or resolved star formation histories.
...
## 14. [Asteroseismic detection of an internal magnetic field in the B0.5V pulsator HD 192575](https://arxiv.org/abs/2511.21812) <a id="link14"></a>
...
**Comment:** This paper presents asteroseismic modeling of a massive star, detecting an internal magnetic field. It is relevant to stellar models, specifically stellar interior physics, which is a core topic. However, it does not present new evolutionary tracks or atmosphere models, but rather applies existing theory to a specific star.
...
## 15. [Young M dwarfs flare activity model: Towards better exoplanetary atmospheric characterisation](https://arxiv.org/abs/2511.23129) <a id="link15"></a>
...
**Comment:** Presents a new stellar atmosphere model (YMDF) for flaring M dwarfs, which fits the 'Stellar Models' criterion. The model is physically motivated and validated with observations, but does not directly address galaxy evolution or star formation histories.
...
## 16. [Predictions from $s$-process AGB models of the isotopic variations of zirconium and neodymium for comparison to bulk meteorites](https://arxiv.org/abs/2511.23104) <a id="link16"></a>
...
**Comment:** This paper presents predictions from s-process AGB models for isotopic variations in meteorites, focusing on nucleosynthesis and stellar evolution. It is relevant to stellar models, specifically nucleosynthesis and evolutionary tracks, though it does not present new tracks or atmosphere models.
...
## 17. [Galaxy and Mass Assembly (GAMA): The Properties of Quasar Host Galaxies: Star Formation Histories and Stellar Populations](https://arxiv.org/abs/2511.22453) <a id="link17"></a>
...
**Comment:** This paper analyzes the star formation histories of quasar host galaxies using GAMA survey data. It matches the 'Resolved Star Formation Histories' criterion, though the focus is on higher-mass galaxies and quasar hosts rather than dwarfs, so relevance is moderate. The work provides new insights into the connection between quasar activity and star formation, but does not address dwarf galaxies or near-field cosmology.
...
## 18. [The network analysis of the cosmic web as a tool to constrain cosmology and cosmic magnetism](https://arxiv.org/abs/2511.22573) <a id="link18"></a>
...
**Comment:** This paper uses cosmological magneto-hydrodynamical simulations to analyze the cosmic web and halo distributions, including network analysis and the impact of primordial magnetic fields. While it involves numerical galaxy simulations and halo abundances, the focus is on large-scale structure and not specifically on dwarf galaxies or near-field cosmology. Borderline relevance for numerical galaxy simulations.
...
## 19. [Statistical Properties of Cold Streams In Massive Star-Forming Halos in IllustrisTNG-50](https://arxiv.org/abs/2511.21814) <a id="link19"></a>
...
**Comment:** Studies cold streams in massive halos using the IllustrisTNG-50 simulation. While it focuses on massive halos (>10^12 Msun) and the circumgalactic medium, the work is more relevant to CGM and galaxy simulations, but not specifically to dwarfs or near-field cosmology. Borderline relevance for CGM and numerical galaxy simulations.
...
## 20. [Effects of Resolution and Local Stability on Galactic Disks: I. Multiple Spiral Mode Formation via Swing Amplification](https://arxiv.org/abs/2511.21805) <a id="link20"></a>
...
**Comment:** This paper presents new numerical simulations of Milky Way-like galactic disks, focusing on spiral mode formation and the effects of resolution and halo dynamics. It matches the 'Numerical Galaxy Simulations' criterion, though the focus is on disk and spiral structure rather than dwarf galaxies or near-field cosmology.
...
## 21. [Connecting Star Formation in the Milky Way and Nearby Galaxies -II. An Analytical Model to Predict Cloud-Scale Star Formation Rate](https://arxiv.org/abs/2511.22985) <a id="link21"></a>
...
**Comment:** Develops an analytical model to predict cloud-scale star formation rates by integrating Milky Way and nearby galaxy observations. Relevant to 'Resolved Star Formation Histories' and 'Star Formation Quenching' (to a lesser extent), as it models star formation histories and rates, though not specifically for dwarf galaxies.
...
## 22. [J-PAS: A value-added catalogue of optical line intensities for nebular emission galaxies (JOLINES)](https://arxiv.org/abs/2511.21822) <a id="link22"></a>
...
**Comment:** Presents a catalogue of optical line intensities for nebular emission galaxies from J-PAS, enabling studies of star formation and galaxy evolution. While it facilitates large-scale studies of star formation, it does not specifically focus on resolved star formation histories from color-magnitude diagrams, nor does it target dwarf galaxies or quenching.
...
## 23. [High-resolution cosmological simulations of primordial dark matter clustering under long-range and fractional forces](https://arxiv.org/abs/2511.23040) <a id="link23"></a>
...
**Comment:** High-resolution cosmological simulations of dark matter clustering under non-standard forces. While it presents new simulations, the focus is on primordial dark matter clustering and halo density, not specifically on galaxy formation, dwarf galaxies, or near-field cosmology.
...
## 24. [Astrophysical constraints from future measurements of the kinetic Sunyaev-Zel'dovich power spectrum](https://arxiv.org/abs/2511.22309) <a id="link24"></a>
...
**Comment:** Forecasts constraints on reionization-era galaxy properties using the kinetic Sunyaev-Zel'dovich power spectrum. The work connects CMB secondary anisotropies to properties of ionizing sources and reionization-era galaxies, which is tangentially related to near-field cosmology but not focused on resolved star formation histories or dwarf satellites.
...
## 25. [APEX survey of interstellar HCl: $^{35}$Cl/$^{37}$Cl isotopic ratios in dense cores and outflows](https://arxiv.org/abs/2511.21813) <a id="link25"></a>
...
**Comment:** Observational study of chlorine isotopic ratios in high-mass star-forming regions, including outflows; touches on star formation driven outflows but in massive regions, not dwarfs. Outflow phase structure is mentioned, but relevance is limited.
...
## 26. [Classical Cepheids in the Galactic thin disk. I. Abundance gradients through NLTE spectral analysis](https://arxiv.org/abs/2511.22491) <a id="link26"></a>
...
**Comment:** NLTE spectral analysis of classical Cepheids in the Galactic thin disk, focusing on abundance gradients. While it involves stellar atmosphere modeling, the focus is on the Milky Way's disk and not on dwarf galaxies or resolved star formation histories. Marginal relevance for 'Stellar Models' due to NLTE analysis.
...
## 27. [Probing Exotic Astrophysical Dark objects through Astrometric Microlensing from Gaia](https://arxiv.org/abs/2511.21823) <a id="link27"></a>
...
**Comment:** Astrometric microlensing as a probe of exotic dark objects (Q-balls, boson stars) using Gaia. While it deals with dark matter, the focus is on exotic compact objects rather than galaxy substructure, satellite galaxies, or near-field cosmology.
...
## 28. [Deep insights into Abell 2163: unveiling the treasure trove of ICM plasma physics](https://arxiv.org/abs/2511.22124) <a id="link28"></a>
...
**Comment:** Detailed analysis of the radio halo in the merging galaxy cluster Abell 2163, focusing on ICM plasma physics. While it discusses cluster-scale phenomena, it does not address dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 29. [Consensus based Algorithm for Nonparametric Detection of Star Clusters (CANDiSC)](https://arxiv.org/abs/2511.23414) <a id="link29"></a>
...
**Comment:** Presents a new algorithm for detecting star clusters in the Galactic bulge and disk using near-infrared surveys. While it is relevant to stellar populations, it does not focus on resolved star formation histories, dwarf galaxies, or near-field cosmology.
...
## 30. [Macroscopic Dark Matter under siege: from White Dwarf Data to Gravitational Wave Detection](https://arxiv.org/abs/2511.23263) <a id="link30"></a>
...
**Comment:** This paper uses white dwarf data to constrain macroscopic dark matter candidates. While it involves compact objects and dark matter, the focus is on using white dwarfs as astrophysical laboratories rather than on near-field cosmology topics like dwarf satellite galaxies, their star formation histories, or quenching. The connection to core-cusp or satellite luminosity function is not present. The use of white dwarfs is tangentially related to the core topics, but not directly relevant.
...
## 31. [Gravitational Waves as a Probe of Core Collapse Supernova Progenitor Structure](https://arxiv.org/abs/2511.21895) <a id="link31"></a>
...
**Comment:** Uses gravitational waves to probe core collapse supernova progenitor structure. While it deals with stellar evolution, it does not present new stellar models or address galaxy evolution, star formation histories, or near-field cosmology.
...
## 32. [The life of central radio galaxies in clusters: AGN-ICM studies of eRASS1 clusters in the ASKAP fields](https://arxiv.org/abs/2511.22319) <a id="link32"></a>
...
**Comment:** Studies AGN feedback in galaxy clusters by correlating radio and X-ray properties. While it discusses quenching and feedback, the focus is on massive clusters and central radio galaxies, not dwarf galaxies or near-field cosmology.
...
## 33. [The relations between dust properties and galaxy global / integrated quantities in the nearby Universe](https://arxiv.org/abs/2511.21922) <a id="link33"></a>
...
**Comment:** Studies dust properties and their relation to global galaxy quantities in low-redshift galaxies. While it touches on ISM and star formation, it does not focus on resolved star formation histories, dwarf galaxies, or quenching.
...
## 34. [Globules and pillars in Cygnus X IV. Velocity-resolved [OI] 63 mu map of a peculiar proplyd-like object](https://arxiv.org/abs/2511.21800) <a id="link34"></a>
...
**Comment:** Investigates a proplyd-like object in Cygnus X, focusing on velocity-resolved [OI] mapping and star formation processes. While it discusses star formation and feedback, the focus is on a single object and does not address galaxy-scale outflows, dwarf galaxies, or resolved star formation histories.
...
## 35. [Intrinsic galaxy alignments in CAMELS simulations and the significant impact of baryon model](https://arxiv.org/abs/2511.21881) <a id="link35"></a>
...
**Comment:** Analyzes intrinsic galaxy alignments in hydrodynamic simulations, with a focus on feedback parameters. While it uses galaxy simulations, the main topic is galaxy alignments for weak lensing, not near-field cosmology, star formation histories, or dwarf galaxy properties.
...
## 39. [SlotFlow: Amortized Trans-Dimensional Inference with Slot-Based Normalizing Flows](https://arxiv.org/abs/2511.23228) <a id="link39"></a>
...
**Comment:** Presents a deep learning method for trans-dimensional inference, with applications including gravitational-wave astronomy. While it mentions astrophysical applications, it does not directly address any of the core criteria (e.g., galaxy simulations, star formation histories).
...
## 40. [Incorporating neutron star physics into gravitational wave inference with neural priors](https://arxiv.org/abs/2511.22987) <a id="link40"></a>
...
**Comment:** Incorporates neutron star physics into gravitational wave inference using neural priors. Focus is on neutron star mergers and equation of state constraints, not on galaxy evolution, star formation, or near-field cosmology.
...
## 41. [3D Modeling of Solar Oscillations with Hybridizable Discontinuous Galerkin Method](https://arxiv.org/abs/2511.22530) <a id="link41"></a>
...
**Comment:** Focuses on 3D modeling of solar oscillations and improvements in numerical methods for stellar oscillation equations. While it presents new computational techniques for stellar modeling, it is specific to the Sun and solar physics, not general stellar models or galaxy simulations.
...
## 44. [Skew-spectra: a generalization to spin-$s$](https://arxiv.org/abs/2511.22596) <a id="link44"></a>
...
**Comment:** Presents a generalization of skew-spectra to spin-s fields for extracting non-Gaussian information from cosmological datasets, with applications to weak lensing and large scale structure. While it is cosmology-related, it does not address near-field cosmology, galaxy simulations, or any of the other core topics.
...
## 45. [Forecasting Constraint on Primordial Black Hole Properties with the CSST $3\times2$pt Analysis](https://arxiv.org/abs/2511.22575) <a id="link45"></a>
...
**Comment:** Forecasts constraints on primordial black hole properties using galaxy clustering, weak lensing, and galaxy-galaxy lensing from the CSST survey. While it involves large-scale structure and dark matter, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations. PBHs are not a core topic.
...
## 46. [Identifying Transient Hosts in LSST's Deep Drilling Fields with Galaxy Catalogues](https://arxiv.org/abs/2511.22634) <a id="link46"></a>
...
**Comment:** Discusses methods for identifying transient hosts in LSST's Deep Drilling Fields using galaxy catalogues. While it involves galaxy catalogues and transient host association, it does not address resolved star formation histories, near-field cosmology, or any of the other core topics.
...
## 47. [The Shear-to-Cosmology Paradigm I: Hybrid Field-Level and Simulation-Based Framework for Weak Lensing Surveys](https://arxiv.org/abs/2511.22851) <a id="link47"></a>
...
**Comment:** Presents a hybrid machine learning framework for cosmological inference from weak lensing surveys, focusing on extracting non-Gaussian information from shear fields. While it uses simulations and ML, the main application is cosmological parameter inference, not galaxy evolution or the core topics.
...
## 48. [Primordial Black Holes as Dark Matter and the Tachyonic Trap During Inflation](https://arxiv.org/abs/2511.23182) <a id="link48"></a>
...
**Comment:** This paper discusses primordial black holes as dark matter and their formation during inflation, with implications for gravitational wave backgrounds. While it touches on dark matter, it does not address galaxy formation, near-field cosmology, or any of the core topics.
...
## 49. [The LMT 2 Millimeter Receiver System (B4R). I. Overview and Results of Science Demonstration](https://arxiv.org/abs/2511.21816) <a id="link49"></a>
...
**Comment:** Describes a new receiver system for the LMT and its science demonstration, including observations of star-forming galaxies and molecular clouds. While it mentions high-redshift dusty star-forming galaxies, it does not focus on resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 50. [Cosmology of axion dark energy in supersymmetric models and constraints on high scale parameters](https://arxiv.org/abs/2511.22559) <a id="link50"></a>
...
**Comment:** Cosmological analysis of axion dark energy in supersymmetric models; focuses on dark energy and cosmological parameters, not on galaxy evolution, star formation, or near-field cosmology.
...
## 51. [Forecasting Primordial Non-Gaussianity from UNIONS Lyman-Break Galaxies and Planck CMB lensing](https://arxiv.org/abs/2511.22243) <a id="link51"></a>
...
**Comment:** Forecasts constraints on primordial non-Gaussianity using Lyman-break galaxies and CMB lensing. While it involves galaxy samples, it is focused on cosmological parameters and inflation, not near-field cosmology or resolved star formation histories.
...
## 52. [Misalignment dynamics of Scalar Condensates with Yukawa coupling: Particle and Entropy Production](https://arxiv.org/abs/2511.22465) <a id="link52"></a>
...
**Comment:** Theoretical work on scalar condensate dynamics and particle/entropy production, with cosmological implications, but not directly related to any specified criteria.
...
## 54. [ALMACAL. XV. Band 3 ALMA Survey and Number Counts](https://arxiv.org/abs/2511.22574) <a id="link54"></a>
...
**Comment:** ALMA survey and number counts of extragalactic sources, focusing on AGN and dusty star-forming galaxies. While it refines evolutionary models, it does not directly address the core topics such as dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 55. [Characterizing Binary Black Hole Subpopulations in GWTC-4 with Binned Gaussian Processes: On the Origins of the $35M_{\odot}$ Peak](https://arxiv.org/abs/2511.22093) <a id="link55"></a>
...
**Comment:** Analyzes binary black hole subpopulations and their origins using GWTC-4 data. Focus is on black hole mergers and formation channels, not on galaxy formation, dwarf galaxies, or near-field cosmology.
...
## 56. [Bubble Nucleation from Boson Star Collapse](https://arxiv.org/abs/2511.21826) <a id="link56"></a>
...
**Comment:** This paper discusses bubble nucleation from boson star collapse, focusing on cosmological phase transitions. While it is astrophysical, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 57. [Klein Bottle Cosmology](https://arxiv.org/abs/2511.23447) <a id="link57"></a>
...
**Comment:** This paper discusses a higher-dimensional cosmological model with Klein Bottle topology and its implications for CP violation and matter-antimatter asymmetry. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, galaxy simulations, or any of the other core topics.
...
## 59. [Cosmological Constraints on 4D Einstein-Gauss-Bonnet Gravity and Kaniadakis Holographic Dark Energy: Implications for Black Hole Shadows](https://arxiv.org/abs/2511.21789) <a id="link59"></a>
...
**Comment:** Constrains 4D Einstein-Gauss-Bonnet gravity and Kaniadakis Holographic Dark Energy using cosmological data and discusses implications for black hole shadows. The focus is on cosmological models and black hole imaging, not on any of the core topics.
...
## 60. [Multipole moments do not uniquely characterise spacetimes beyond general relativity](https://arxiv.org/abs/2511.22405) <a id="link60"></a>
...
**Comment:** Focuses on multipole moments in spacetimes and their uniqueness in theories beyond general relativity. This is a theoretical gravity paper, not related to galaxy properties, star formation histories, or near-field cosmology.
...
## 61. [The LMT 2 millimeter receiver system (B4R). II. Science demonstration observations toward Orion-KL/OMC-1](https://arxiv.org/abs/2511.21845) <a id="link61"></a>
...
**Comment:** Presents science demonstration observations of Orion-KL/OMC-1 with a new receiver, focusing on astrochemistry and molecular line mapping. This is not related to the core topics of galaxy evolution, star formation histories, or near-field cosmology.
...
## 62. [Vector-field spontaneous baryogenesis with Lorentz invariance violation](https://arxiv.org/abs/2511.23378) <a id="link62"></a>
...
**Comment:** Extends spontaneous baryogenesis with Lorentz invariance violation, focusing on early universe particle physics and baryon asymmetry. Not related to galaxy evolution, star formation, or near-field cosmology.
...
## 64. [A Catalogue of Mid-infrared Variable Sources from unTimely](https://arxiv.org/abs/2511.22071) <a id="link64"></a>
...
**Comment:** Catalog of mid-infrared variable sources, including rare transients and variable AGN; does not match any of the core criteria.
...
## 65. [Laboratory Detection and Rotational Spectroscopy of $trans$-HNSO: Implications for Astronomical Observations](https://arxiv.org/abs/2511.22548) <a id="link65"></a>
...
**Comment:** Laboratory detection and spectroscopy of trans-HNSO, with implications for interstellar chemistry; not relevant to any of the specified criteria.
...
## 66. [Baryon fraction from the BAO amplitude: a consistent approach to parameterizing perturbation growth](https://arxiv.org/abs/2511.23459) <a id="link66"></a>
...
**Comment:** This paper presents a new method for measuring the baryon fraction from BAO amplitude and perturbation growth, with implications for cosmological parameter estimation. It does not address galaxy formation, resolved star formation histories, or any of the core topics.
...
## 67. [Identifying bars in galaxies using machine learning](https://arxiv.org/abs/2511.23383) <a id="link67"></a>
...
**Comment:** Presents a machine learning method for identifying bars in galaxies, with some mention of application to dwarf galaxies. However, the main focus is on bar detection, which is specifically listed as irrelevant in the criteria.
...
## 68. [Detection of the Pairwise Kinematic Sunyaev-Zel'dovich Effect and Pairwise Velocity with DESI DR1 Galaxies and ACT DR6 and Planck CMB Data](https://arxiv.org/abs/2511.23417) <a id="link68"></a>
...
**Comment:** This paper presents a high-significance detection of the pairwise kinematic Sunyaev-Zeldovich effect using Luminous Red Galaxies and CMB data. The focus is on massive galaxies and clusters (LRGs, >1e13 solar masses), which are outside the core topics (dwarf galaxies, near-field cosmology, resolved star formation histories, etc.). No direct relevance to the specified criteria.
...
## 69. [The HITRAN2024 methane update](https://arxiv.org/abs/2511.21840) <a id="link69"></a>
...
**Comment:** This paper presents an update to the HITRAN methane spectroscopic database, focusing on improved line lists and pressure broadening parameters. While this is a significant contribution to molecular spectroscopy and may be useful for atmospheric studies, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, stellar models, or galaxy simulations. The work is not directly relevant to the study of galaxies, their star formation, or their circumgalactic medium.
...
## 70. [The Atacama Cosmology Telescope: $B$-mode delensing with DR6 data and external tracers of large-scale structure](https://arxiv.org/abs/2511.21949) <a id="link70"></a>
...
**Comment:** Focuses on CMB B-mode delensing and large-scale structure tracers, not on galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 71. [Sulfur monoxide as a tracer of the Galactic $^{32}$S/$^{34}$S gradient](https://arxiv.org/abs/2511.23147) <a id="link71"></a>
...
**Comment:** Uses sulfur monoxide as a tracer of the Galactic 32S/34S gradient, focusing on molecular clouds and chemical evolution. The work is not directly related to any of the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 72. [Galaxy rotation curve based on RGB stars from the Gaia DR3 catalogue](https://arxiv.org/abs/2511.22295) <a id="link72"></a>
...
**Comment:** Constructs the Milky Way rotation curve using Gaia DR3 RGB stars. Focus is on the Galactic disk and rotation curve, not on satellite galaxies, dwarf galaxies, or resolved star formation histories.
...
## 73. [Evading the dust fragmentation barrier with the streaming instability in protoplanetary disks](https://arxiv.org/abs/2511.22709) <a id="link73"></a>
...
**Comment:** Focuses on dust growth and streaming instability in protoplanetary disks, which is related to planet formation rather than galaxy evolution, star formation histories, or near-field cosmology. No criteria match.
...
## 74. [QCD axions and domain walls in dense matter under compact stellar conditions](https://arxiv.org/abs/2511.21995) <a id="link74"></a>
...
**Comment:** Examines QCD axions and domain walls in dense matter under compact stellar conditions; relevant to compact stars and axion physics, not to galaxy evolution, star formation, or near-field cosmology.
...
## 75. [Lorentz Violation in Emergent Gravity and Its Cosmological Consequences](https://arxiv.org/abs/2511.22221) <a id="link75"></a>
...
**Comment:** Discusses Lorentz violation in emergent gravity and cosmological consequences; focuses on fundamental physics and cosmology, not on galaxy evolution, star formation, or near-field cosmology.
...
## 76. [Net Charge Accretion in Magnetized Kerr Black Holes](https://arxiv.org/abs/2511.22356) <a id="link76"></a>
...
**Comment:** Studies net charge accretion in magnetized Kerr black holes; relevant to black hole physics, not to galaxy evolution, star formation, or near-field cosmology.
...
## 77. [Data-driven informative priors for Bayesian inference with quasi-periodic data](https://arxiv.org/abs/2511.22296) <a id="link77"></a>
...
**Comment:** This paper presents a Bayesian methodology for quasi-periodic data using Gaussian processes, but does not address any of the core astrophysical topics such as near-field cosmology, resolved star formation histories, or stellar models. The methods could be generically useful for time-series analysis, but there is no direct connection to the specified criteria.
...
## 78. [Interferometric view into RT Pav's long secondary period. binary vs oscillatory convective modes](https://arxiv.org/abs/2511.21987) <a id="link78"></a>
...
**Comment:** Investigates the origin of long secondary periods in evolved stars using interferometry. Focus is on stellar variability and convective modes, not on galaxy formation, dwarf galaxies, or stellar models.
...
## 79. [Clustering in dynamical dark energy: observational constraints from DESI, CMB, and supernovae](https://arxiv.org/abs/2511.22478) <a id="link79"></a>
...
**Comment:** Constrains clustering properties of dynamical dark energy using cosmological observations. The focus is on dark energy models and cosmological parameters, not on galaxy formation or near-field cosmology.
...
## 80. [A Detection of Sulfur-Bearing Cyclic Hydrocarbons in Space](https://arxiv.org/abs/2511.23299) <a id="link80"></a>
...
**Comment:** Reports the detection of a sulfur-bearing cyclic hydrocarbon in the Galactic center molecular cloud. The focus is on astrochemistry and molecular detections, not on any of the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 81. [Scalar field effective potentials in de Sitter spacetime](https://arxiv.org/abs/2511.23076) <a id="link81"></a>
...
**Comment:** Discusses scalar field effective potentials in de Sitter spacetime, focusing on quantum field theory and cosmological implications. Does not address any of the core topics such as galaxy simulations, near-field cosmology, or star formation histories.
...
## 83. [Simulating AGN feedback in galaxy clusters with pre-existing turbulence](https://arxiv.org/abs/2511.23267) <a id="link83"></a>
...
**Comment:** Simulates AGN feedback and turbulence in galaxy clusters, focusing on heating mechanisms in the intracluster medium. AGN-driven feedback and cluster-scale physics are not relevant to the core topics.
...
## 84. [ExoJAX Retrievals of VLT/CRIRES Spectra of Luhman 16AB: C/O Ratios and Systematic Uncertainties](https://arxiv.org/abs/2511.23018) <a id="link84"></a>
...
**Comment:** Atmospheric retrievals of brown dwarf binary spectra, focusing on C/O ratios and systematic uncertainties. This is a substellar atmosphere study, not related to galaxy evolution, star formation, or near-field cosmology.
...
## 85. [Towards Understanding the Origin of Swift Gamma-Ray Bursts Driven by Magnetars](https://arxiv.org/abs/2511.22534) <a id="link85"></a>
...
**Comment:** Analyzes Swift gamma-ray bursts with extended emissions and X-ray plateaus, investigating magnetar-driven GRBs. The focus is on GRB progenitors and magnetars, not on galaxy evolution, star formation, or near-field cosmology.
...
## 86. [Spiral excitation in protoplanetary disks through gap-edge illumination: Distinctive kinematic signatures in CO isotopologues](https://arxiv.org/abs/2511.22527) <a id="link86"></a>
...
**Comment:** Studies spiral excitation in protoplanetary disks and kinematic signatures in CO isotopologues. The focus is on disk substructure and planet-disk interactions, not on galaxy evolution or the core topics.
...
## 87. [Structure-Preserving Unpaired Image Translation to Photometrically Calibrate JunoCam with Hubble Data](https://arxiv.org/abs/2511.22668) <a id="link87"></a>
...
**Comment:** Focuses on photometric calibration of JunoCam data for Jupiter's atmosphere using image translation methods; not relevant to any of the specified criteria.
...
## 88. [Collapse of Axion Domain Wall Induced by Helical Primordial Magnetic Fields](https://arxiv.org/abs/2511.22949) <a id="link88"></a>
...
**Comment:** This paper focuses on axion domain wall decay via coupling to primordial magnetic fields, using lattice simulations. While it involves cosmological simulations and dark matter, it does not focus on galaxy formation, near-field cosmology, or any of the core topics. The connection to galaxy-scale phenomena is very weak.
...
## 89. [Synchrotron Self-Compton Model of TeV Afterglows in Gamma-Ray Bursts](https://arxiv.org/abs/2511.23349) <a id="link89"></a>
...
**Comment:** This paper models the synchrotron self-Compton emission in GRB afterglows, focusing on TeV emission and the circumburst environment. It does not address galaxy formation, near-field cosmology, or any of the core topics.
...
## 90. [Robust evidence for dynamical dark energy in light of DESI DR2 and joint ACT, SPT, and Planck data](https://arxiv.org/abs/2511.22512) <a id="link90"></a>
...
**Comment:** Cosmological analysis of dark energy models using large-scale survey data. No direct relevance to near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 91. [A measurement of $H_0$ from DESI DR1 using energy densities](https://arxiv.org/abs/2511.23432) <a id="link91"></a>
...
**Comment:** Presents a new method for measuring H_0 using DESI DR1 and energy densities, with cosmological implications. No direct relevance to the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 92. [CO observations in rotating circumbinary post-AGB disks](https://arxiv.org/abs/2511.23348) <a id="link92"></a>
...
**Comment:** CO observations in post-AGB circumbinary disks; focuses on evolved stars and disk/outflow properties, not on galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 93. [Kinetic Mixing and the Phantom Illusion: Axion-Dilaton Quintessence in Light of DESI DR2](https://arxiv.org/abs/2511.23463) <a id="link93"></a>
...
**Comment:** This paper investigates axion-dilaton quintessence models in light of DESI BAO data, focusing on dark energy dynamics and cosmological parameter inference. It does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. No core criteria are matched.
...
## 94. [Vortex Dynamics in the Neutron Star Inner Crust](https://arxiv.org/abs/2511.22670) <a id="link94"></a>
...
**Comment:** This paper studies vortex dynamics in the neutron star inner crust, which does not match any of the core criteria such as galaxy simulations, stellar models, or near-field cosmology.
...
## 95. [The NANOGrav 12.5-year Data Set: Chromatic Noise Characterization & Mitigation with Time-Domain Kernels](https://arxiv.org/abs/2511.22597) <a id="link95"></a>
...
**Comment:** Describes new time-domain kernel models for chromatic noise in pulsar timing array data. While relevant to gravitational wave detection and data analysis, it does not address any of the core topics.
...
## 96. [The Solar Close Observations and Proximity Experiments (SCOPE) mission](https://arxiv.org/abs/2511.22472) <a id="link96"></a>
...
**Comment:** This paper describes a solar mission focused on solar eruptions, coronal heating, and solar wind acceleration. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 97. [A Paradigm Shift in Exoplanet False Positive Identification with HIP-44302](https://arxiv.org/abs/2511.21817) <a id="link97"></a>
...
**Comment:** Exoplanet false positive identification in a triple-star system; does not match any of the core criteria.
...
## 98. [Gravitational waves from the late inspiral, transition, and plunge of small-mass-ratio eccentric binaries](https://arxiv.org/abs/2511.21897) <a id="link98"></a>
...
**Comment:** Gravitational wave modeling for small-mass-ratio black hole binaries, relevant for LISA, but not related to galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 99. [Searches for Post-Merger Gravitational Waves with CoCoA: Sensitivity Projections Across Large Template Banks for Current and Next-Generation Detectors](https://arxiv.org/abs/2511.21941) <a id="link99"></a>
...
**Comment:** Gravitational wave searches for post-merger signals from neutron star mergers; not related to galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 100. [Variation of Microphysical Parameters in Reverse-shock Scenario](https://arxiv.org/abs/2511.23426) <a id="link100"></a>
...
**Comment:** Studies microphysical parameters in GRB reverse shocks; relevant to high-energy astrophysics but not to any of the specified criteria (e.g., near-field cosmology, star formation histories, galaxy simulations).
...
## 101. [BSN: The First Multiband Light Curve Analysis of the W UMa-type Contact Binary System EM Tucanae](https://arxiv.org/abs/2511.22907) <a id="link101"></a>
...
**Comment:** Analysis of a contact binary system's light curve and mass transfer; focuses on stellar binaries, not on galaxy evolution, dwarf galaxies, or stellar models relevant to the prompt.
...
## 102. [The Parkes Observatory Pulsar Data Archive](https://arxiv.org/abs/2511.22702) <a id="link102"></a>
...
**Comment:** Describes the Parkes Observatory Pulsar Data Archive; focuses on pulsar data management and accessibility, not on galaxy evolution, star formation, or near-field cosmology.
...
## 104. [Probing CMB Polarization Gaussianity with the Statistics of Unpolarized Points: Non-Gaussianity of Planck Data and Prospects for Future B-Mode Measurements](https://arxiv.org/abs/2511.22220) <a id="link104"></a>
...
**Comment:** Examines CMB polarization Gaussianity and non-Gaussianity in Planck data; does not match any of the core criteria.
...
## 105. [Manifestation of the stellar wind cycle in infrared images: Example of the heliosphere](https://arxiv.org/abs/2511.22401) <a id="link105"></a>
...
**Comment:** Models the effect of the solar wind cycle on infrared images of the heliosphere; not relevant to any of the specified criteria.
...
## 106. [Recovering Intrinsic Pulsar Profiles and Scattering Parameters with a CLEAN-Based Algorithm for High-Precision Timing](https://arxiv.org/abs/2511.22299) <a id="link106"></a>
...
**Comment:** Focuses on pulsar profile recovery and scattering parameters for high-precision timing. No direct connection to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 107. [Constraining the Properties of GRB Accreting Magnetar with $R/I$ Evolutionary Effects Using \emph{Swift}/XRT Data](https://arxiv.org/abs/2511.22149) <a id="link107"></a>
...
**Comment:** This paper studies accreting magnetars in the context of long gamma-ray bursts using Swift/XRT data. The focus is on the central engine of GRBs and magnetar properties, not on galaxy evolution, dwarf galaxies, star formation histories, quenching, or galaxy simulations. No core criteria are matched.
...
## 109. [Witten-O'Raifeartaigh potential revisited in the context of Warm Inflation](https://arxiv.org/abs/2511.23219) <a id="link109"></a>
...
**Comment:** Discusses warm inflation and the Witten-O'Raifeartaigh potential, with implications for early universe cosmology and dark energy. No direct connection to galaxy formation, near-field cosmology, or stellar models.
...
## 110. [Inflation, black holes with primary hair, and regular planar black holes from an infinite tower of regularized Lovelock-Proca corrections](https://arxiv.org/abs/2511.22798) <a id="link110"></a>
...
**Comment:** Explores higher-order corrections to General Relativity for inflation and black hole solutions. The focus is on cosmological singularities and black hole physics, not on galaxies or stellar models.
...
## 111. [The First Scientific Flight and Observations of the 50-mm Balloon-Borne White-Light Coronagraph](https://arxiv.org/abs/2511.22336) <a id="link111"></a>
...
**Comment:** This paper describes a new balloon-borne coronagraph for solar corona observations. It is focused on solar physics and instrumentation, not on any of the core topics.
...
## 112. [Statistical analysis and correction of the pile-up effect in MAPMT single photoelectron counting with the SPACIROC-3 ASIC: application to the Mini-EUSO experiment](https://arxiv.org/abs/2511.23284) <a id="link112"></a>
...
**Comment:** Focuses on statistical analysis and correction of pile-up effects in photomultiplier tubes for the Mini-EUSO experiment, relevant to instrumentation and transient detection, not to any of the core topics.
...
## 113. [Closing the gap: Follow-up observations of peculiar dusty objects close to Sgr A* using ERIS](https://arxiv.org/abs/2511.22761) <a id="link113"></a>
...
**Comment:** Focuses on peculiar dusty objects near Sgr A* in the Galactic center, including G sources and young stellar objects. The focus on the Galactic center and massive YSOs makes it irrelevant to the core topics.
...
## 114. [Constraining of Nuclear Matter Equations of State With Rotating Neutron Stars](https://arxiv.org/abs/2511.22894) <a id="link114"></a>
...
**Comment:** Uses rotating neutron star models to constrain nuclear matter equations of state. This is focused on compact object physics and nuclear matter, not on galaxy evolution, near-field cosmology, or any of the core topics.
...
## 115. [Large-amplitude Variability Driven by Giant Dust Storms on a Planetary-mass Companion](https://arxiv.org/abs/2511.23163) <a id="link115"></a>
...
**Comment:** This paper models atmospheric variability and dust storms on a planetary-mass companion, focusing on exoplanet atmospheres. It does not address galaxy formation, stellar models, or any of the core topics.
...
## 116. [Inflation Driven by Scalar-Neutrino Coupling in a Mass-Varying Neutrino Framework](https://arxiv.org/abs/2511.23422) <a id="link116"></a>
...
**Comment:** Focuses on cosmological inflation and neutrino mass generation, not on galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 117. [Needle in a Poissonian haystack -- An X-ray astronomer's guide to QPE fishing](https://arxiv.org/abs/2511.22520) <a id="link117"></a>
...
**Comment:** Focuses on X-ray transients, QPEs, and TDEs, which are specifically listed as irrelevant in the criteria.
...
## 118. [Multipartite entanglement features of primordial non-gaussianities](https://arxiv.org/abs/2511.23389) <a id="link118"></a>
...
**Comment:** This paper discusses multipartite entanglement in primordial non-Gaussianities during inflation, focusing on quantum correlations in the early universe. It does not address galaxy evolution, dwarf galaxies, star formation histories, or any of the core criteria.
...
## 119. [Numerical implementation of flat FLRW models of cosmic expansion with Planck 2018 cosmological parameters](https://arxiv.org/abs/2511.21991) <a id="link119"></a>
...
**Comment:** This paper presents a pedagogical numerical implementation of FLRW cosmological models, focusing on cosmic expansion and the Friedmann equations. It does not address galaxy formation, resolved star formation histories, or any of the core topics.
...
## 120. [The observation of Ground Level Enhancement GLE 77 by the neutron detectors of the Experimental Complex NEVOD](https://arxiv.org/abs/2511.23048) <a id="link120"></a>
...
**Comment:** Reports on a ground level enhancement event observed by neutron detectors; relevant to cosmic ray physics, not to galaxy evolution, star formation, or near-field cosmology.
...
## 121. [A Novel Comb Generator for Frequency Phase Transfer](https://arxiv.org/abs/2511.22161) <a id="link121"></a>
...
**Comment:** Describes a comb generator for frequency phase transfer for VLBI missions; relevant to instrumentation, not to galaxy evolution, star formation, or near-field cosmology.
...
## 122. [Tools and Advancements towards Data Standardization of the MAGIC Collaboration](https://arxiv.org/abs/2511.23244) <a id="link122"></a>
...
**Comment:** Discusses data standardization for the MAGIC gamma-ray telescope collaboration; not relevant to any of the specified criteria.
...
## 123. [Blazar classification from multi-wavelength data using Deep Learning](https://arxiv.org/abs/2511.23134) <a id="link123"></a>
...
**Comment:** This paper applies deep learning to classify blazars from multi-wavelength data. It does not address galaxy formation, resolved star formation histories, or any of the core topics.
...
## 124. [The impact of magnetic fields during tidal disruption events](https://arxiv.org/abs/2511.21818) <a id="link124"></a>
...
**Comment:** Studies the impact of magnetic fields during tidal disruption events (TDEs) via MHD simulations. TDEs are explicitly listed as irrelevant in the criteria.
...
## 125. [On the Relation between Source Region and In-situ Variability of Low $\delta B$ Solar Wind Streams](https://arxiv.org/abs/2511.21971) <a id="link125"></a>
...
**Comment:** Solar wind stream variability and source region analysis; not related to galaxy evolution, star formation, or near-field cosmology.
...
## 126. [Blending-induced beating and emission in the symbiotic star Terz V 2513](https://arxiv.org/abs/2511.22988) <a id="link126"></a>
...
**Comment:** Analysis of a symbiotic star and blending effects in light curves. No connection to the core topics such as galaxy simulations, star formation histories, or dwarf galaxies.
...
## 127. [Kerr black holes as circular polarizers](https://arxiv.org/abs/2511.22276) <a id="link127"></a>
...
**Comment:** This paper studies the polarization effects of Kerr black holes on light beams, which is unrelated to any of the core criteria such as near-field cosmology, stellar models, or galaxy simulations.
