...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 64765    | 10726        | 75491   |
| **Cost**             | $0.13    | $0.09        | $0.22   |

Total arXiv papers: 238
...
1. [Joint Constraints on Fuzzy and Warm Dark Matter from Satellite Populations of the Milky Way and Andromeda](#user-content-link1)
**Authors:** Jianxiang Liu, Yan Gong, Kai Liao

2. [The Milky Way stellar halo is twisted and doubly broken: insights from DESI DR2 Milky Way Survey observation](#user-content-link2)
...
3. [Exploring the ultra-faint dwarf Bootes I using JWST and HST: Metallicity distribution and binaries](#user-content-link3)
**Authors:** F. Muratore, M. V. Legnardi, A. P. Milone, A. Mastrobuono-Battisti, G. Cordoni, L. N. Gorza, E. P. Lagioia, E. Bortolan, E. Dondoglio, A. F. Marino, T. Ziliotto

4. [The DREAMS Project: A New Suite of 1,024 Simulations to Contextualize the Milky Way and Assess Physics Uncertainties](#user-content-link4)
...
5. [The role of prompt cusps in driving the core collapse of SIDM halos](#user-content-link5)
**Authors:** Vinh Tran, Daniel Gilman, M. Sten Delos, Xuejian Shen, Oliver Zier, Mark Vogelsberger, David Xu

6. [GASTRO library II: Exploring Chemical Bimodalities in Disk Galaxies with GSE-like Mergers and Massive Star-forming Clumps](#user-content-link6)
**Authors:** Jo\~ao A. S. Amarante, Chervin F. P. Laporte, Victor P. Debattista, Leandro Beraldo e Silva, Guilherme Limberg, H\'elio D. Perottoni, Zhao-Yu Li, Lais Borbolato, Karl Fiteni, Chengye Cao, Nathan Deg, Tigran Khachaturyants, Xiaojie Liao

7. [Evidence for the Faint-End Suppression in the z = 6 $\sim$ 8 UV Luminosity Function: A Lensing Analysis of Abell 2744](#user-content-link7)
**Authors:** Xuheng Ma

8. [Gravity-darkening exponents for MESA stellar evolution models](#user-content-link8)
**Authors:** A. Claret (IAA, Spain), G. Torres (CfA, USA)

9. [SMSS J022423.27$-$573705.1: An Extremely Metal-Poor Star with the Most Pronounced Weak $r$-Process Signature](#user-content-link9)
**Authors:** Hiroko Okada, Wako Aoki, Nozomu Tominaga, Satoshi Honda

10. [Constraining Dark Acoustic Oscillations with the High-Redshift UV Luminosity Function](#user-content-link10)
**Authors:** Jared Barron, David Curtin, Hongwan Liu, Julian Munoz, Sandip Roy

11. [CECILIA: The Mass-Metallicity Relation of Low-Mass Galaxies at Cosmic Noon](#user-content-link11)
...
12. [Validating the 1D-3D coupling stellar models via Asteroseismology of 18 Kepler main-sequence stars](#user-content-link12)
**Authors:** Zhikai Li, Tanda Li, Yixiao Zhou, Shaolan Bi

13. [Asteroseismic detection of a predominantly toroidal magnetic field in the deep interior of the main-sequence F star KIC 9244992](#user-content-link13)
**Authors:** Masao Takata, Simon J. Murphy, Donald W. Kurtz, Hideyuki Saio, Hiromoto Shibahashi

14. [JWST & the Waz Arc I: Spatially Resolving the Physical Conditions within a Post-Starburst Galaxy at Redshift 5 with NIRSpec IFS](#user-content-link14)
**Authors:** Taylor A. Hutchison, Gourav Khullar, Jane R. Rigby, Brian Welch, Michael K. Florian, Keren Sharon, Issac Sierra, Julissa Sarmiento, Guillaume Mahler, Nikko J. Cleri, Rachel Bezanson, Michael D. Gladders, Matthew B. Bayliss, Juliana S. M. Karp, Dylan Berry, Alex Ross, T. Emil Rivera-Thorsen, Suhyeon C. Choe, H{\aa}kon Dahle, John Chisholm, Erini L. Lambrides, Rebecca L. Larson, Grace M. Olivier, Riley Owens, Erik Solhaug

15. [Transition from Outside-in to Inside-Out at $z\sim 2$: Evidence from Radial Profiles of Specific Star Formation Rate based on JWST/HST](#user-content-link15)
**Authors:** Jie Song, Enci Wang, Cheng Jia, Cheqiu Lyu, Yangyao Chen, Jinyang Wang, Fujia Li, Weiyu Ding, Guanwen Fang, Xu Kong

16. [Episodic Star Formation -- I. Overview and Scatter of the Star-Forming Main Sequence](#user-content-link16)
**Authors:** Yuqian Gui, Dandan Xu, Haoyi Wang, Xuelun Mei, Enci Wang, Cheng Li, Stijn Wuyts

17. [Accurate cosmological emulator for the probability distribution function of gravitational lensing of point sources](#user-content-link17)
**Authors:** Tun\c{c} T\"urker, Valerio Marra, Tiago Castro, Miguel Quartin, Stefano Borgani

18. [Analytical Emulator for the Baryon EoM inside the Fuzzy Dark Matter Soliton from Machine Learning](#user-content-link18)
**Authors:** Ke Wang, Jianbo Lu, Man Ho Chan

19. [From Black Hole to Galaxy: Neural Operator: Framework for Accretion and Feedback Dynamics](#user-content-link19)
**Authors:** Nihaal Bhojwani, Chuwei Wang, Hai-Yang Wang, Chang Sun, Elias R. Most, Anima Anandkumar

20. [Probing Fuzzy Dark Matter in the 21 cm Signal via Wavelet Scattering Transform](#user-content-link20)
**Authors:** Hayato Shimabukuro, Shihang Liu, Bohua Li

21. [On the multiplicity of red-Herschel sources and its implications for extreme star formation](#user-content-link21)
**Authors:** Marianela Quir\'os-Rojas, Alfredo Monta\~na, Jorge A. Zavala, Itziar Aretxaga, Norma Araceli Nava-Moreno, David H. Hughes

22. [Probing a minimal dark gauge sector via microlensing of compact dark objects](#user-content-link22)
**Authors:** Juan Barranco, Argelia Bernal, V\'ictor Jaramillo, Dar\'io N\'u\~nez, Milton Ruiz

23. [Dynamical Heating from Dark Compact Objects and Axion Minihalos: Implications for the 21-cm Signal](#user-content-link23)
**Authors:** Badal Bhalla, Aurora Ireland, Hongwan Liu, Huangyu Xiao, Tao Xu

24. [Normal or transitional? The evolution and properties of two type Ia supernovae in the Virgo cluster](#user-content-link24)
...
25. [Discovery of a rich population of compact hub-filament systems in a single star-forming complex](#user-content-link25)
**Authors:** L. K. Dewangan (Astronomy & Astrophysics Division, Physical Research Laboratory, Navrangpura, Ahmedabad 380009, India), Ram K. Yadav (National Astronomical Research Institute of Thailand), Saurabh Sharma (Aryabhatta Research Institute of Observational Sciences, Manora Peak, Nainital 263002, India), O. R. Jadhav (Astronomy & Astrophysics Division, Physical Research Laboratory, Navrangpura, Ahmedabad 380009, India), A. K. Maity (Astronomy & Astrophysics Division, Physical Research Laboratory, Navrangpura, Ahmedabad 380009, India), Paul F. Goldsmith (Jet Propulsion Laboratory, California Institute of Technology, 4800 Oak Grove Drive, Pasadena, CA 91109, USA), G. Panchal (75, Jogani Nagar Society, Adajan, Surat 395 009, Gujarat, India)

26. [Mass transfer stability for AM CVn binaries with white dwarf donors](#user-content-link26)
**Authors:** Lucy O. McNeill, Ryosuke Hirai

27. [Substellar Initial Mass Function of Trumpler 14](#user-content-link27)
**Authors:** Tamara Rom (University of Split, Faculty of Science, Split, Croatia, Univ. Grenoble Alpes, CNRS, IPAG, Grenoble, France), Estelle Moraux (Univ. Grenoble Alpes, CNRS, IPAG, Grenoble, France), Koraljka Mu\v{z}i\'c (Instituto de Astrof\'isica e Ci\^encias do Espa\c{c}o, Faculdade de Ci\^encias, Universidade de Lisboa), Morten Andersen (European Southern Observatory, Garching bei M\"unchen, Germany), Mischa Schirmer (Max-Planck-Institut f\"ur Astronomie, Heidelberg, Germany), V\'ictor Almendros-Abad (Istituto Nazionale di Astrofisica)

28. [The Hubble Missing Globular Cluster Survey. II. Survey membership tools and kinematic analysis of NGC 6749](#user-content-link28)
...
29. [Kratos-polrad: Novel GPU system for Monte-Carlo simulations with consistent polarization calculations](#user-content-link29)
**Authors:** Haifeng Yang, Lile Wang

30. [Resonant Annihilation of WIMP Dark Matter for Halo Gamma Ray Signal](#user-content-link30)
**Authors:** Hitoshi Murayama

31. [Type IIP SN 2024bch: Hydrodynamic model, shock breakout, and circumstellar interaction](#user-content-link31)
**Authors:** V. P. Utrobin (NRC "Kurchatov Institute", Moscow, Russia, Institute of Astronomy, Moscow, Russia), N. N. Chugai (Institute of Astronomy, Moscow, Russia)

32. [Ubiquity of Methanol and its related Chemical Segregation in Orion Starless Cores: the ALMASOP Sample](#user-content-link32)
...
33. [Revisiting the Supernova Engines in the 3C 397 and W49B Supernova Remnants](#user-content-link33)
**Authors:** Cole Treyturik, Chelsea Braun, Samar Safi-Harb, Christopher L. Fryer, Gilles Ferrand

34. [Investigating the Correlation between Dark Matter Content, Ages and Mass-to-Light Ratios in Spiral Galaxies](#user-content-link34)
**Authors:** Arpit Kottur, Meet Mehta, Raka Dabhade

35. [The sonic scale does not determine the core separation in turbulent molecular clouds](#user-content-link35)
**Authors:** Zamora-Aviles Manuel, Ballesteros-Paredes Javier, Palau Aina, V\'azquez-Semadeni Enrique, G\'omez Gilberto C

36. [Equivalence of Stability Criteria for Multi-Fluid Stars](#user-content-link36)
**Authors:** Tian-Shun Chen, Xiao-Ding Zhou, Kilar Zhang

37. [Bayesian inference on Calabi--Yau moduli spaces and the axiverse: experimental data meets string theory](#user-content-link37)
**Authors:** Mudit Jain, Elijah Sheridan, David J. E. Marsh, Elli Heyes, Keir K. Rogers, Andreas Schachner

38. [Widen the Resonance at Ultra-High Energies: Novel Probes of Neutrino Self-interactions in the High-Mass Regime](#user-content-link38)
**Authors:** Pedro A. N. Machado, Isaac R. Wang, Xun-Jie Xu, Bei Zhou

39. [Egent: An Autonomous Agent for Equivalent Width Measurement](#user-content-link39)
**Authors:** Yuan-Sen Ting, Serat Mahmud Saad, Fan Liu, Yuting Shen

40. [Cosmology of Gravi-Axions](#user-content-link40)
**Authors:** Stephon Alexander, Gregory Gabadadze, Leah Jenks, Nicol\'as Yunes

41. [Constraints on Chiral-Quintom dark energy after DESI DR2 and impact on unifying dark energy with inflation](#user-content-link41)
**Authors:** Andronikos Paliathanasis, Tommaso Mengoni, Genly Leon, Orlando Luongo

42. [A tale of three tails: A misaligned streamer and mysterious structures around [BHB2007]1](#user-content-link42)
**Authors:** Aashish Gupta, Antonio S. Hales, L. Ilsedore Cleeves, Felipe Alves, Trisha Bhowmik, Nicol\'as Cuello, Josep M. Girart, Zhi-Yun Li, Anna Miotello, Zhaohuan Zhu, Alice Zurlo

43. [First detections of methanol maser lines from a rare transition family](#user-content-link43)
**Authors:** Bradley R. Johnson, Simon P. Ellingsen, Shari L. Breen, Maxim A. Voronkov, Tiege P. McCarthy, Lucas J. Hyland

44. [The ALMA Survey of 70 \mu m Dark High-mass Clumps in Early Stages (ASHES). XIII. Core Mass Function, Lifetime, and Growth of Prestellar Cores](#user-content-link44)
...
45. [Excitation of molecular hydrogen by cosmic-ray protons](#user-content-link45)
**Authors:** Marco Padovani (INAF-Osservatorio Astrofisico di Arcetri, Firenze, Italy), Daniele Galli (INAF-Osservatorio Astrofisico di Arcetri, Firenze, Italy), Corey T. Plowman (Department of Physics, Curtin University, Australia), Liam H. Scarlett (Department of Physics, Curtin University, Australia), Mark C. Zammit (Theoretical Division, Los Alamos National Laboratory, USA), Igor Bray (Department of Physics, Curtin University, Australia), Dmitry V. Fursa (Department of Physics, Curtin University, Australia)

46. [Multi-frequency radio-continuum study of the LMC SNR N206 (Goat's Eye) and its "zig-zag" PWN](#user-content-link46)
**Authors:** M. Ghavam, Z. J. Smeaton, M. D. Filipovic, R. Z. E. Alsaberi, C. Bordiu, W. D. Cotton, E. J. Crawford, A. M. Hopkins, R. Kothes, S. Lazarevic, D. Leahy, N. Rajabpour, S. Ranasinghe, G. P. Rowell, H. Sano, M. Sasaki, D. Shobhana, K. Tsuge, D. Urosevic, N. F. H. Tothill

47. [Stability of Neutron-Dark Matter Mixed Stars and Hybrid Stars](#user-content-link47)
**Authors:** Xiao-Ding Zhou, Tian-Shun Chen, Si-Man Wu, Kilar Zhang

48. [Similar Fermi-GBM sGRBs to GW/sGRB 170817A in MeV-GeV energies](#user-content-link48)
**Authors:** Sanjeeva Rao Prattipati, Reetanjali Moharana, Sourav Dutta

49. [Controlling weak-lensing shear biases from undetected galaxies in the era of Stage IV Surveys](#user-content-link49)
**Authors:** Lisa M Voigt

50. [AI Agent for Source Finding by SoFiA-2 for SKA-SDC2](#user-content-link50)
...
51. [Recoiling Black Hole Candidates from Spatially Offset Broad Emission Lines in MaNGA](#user-content-link51)
**Authors:** R. Scott Barrows, Julia M. Comerford, James Negus, Francisco Muller-Sanchez

52. [An outflow from the X-ray corona as the origin of millimeter emission from radio-quiet AGN](#user-content-link52)
**Authors:** A. Hankla, A. Philippov, R. Mbarek, R. Mushotzky, G. Musoke, D. Gro\v{s}elj, M. Liska

53. [Machine Learning for Exoplanet Discovery: Validating TESS Candidates and Identifying Planets in the Habitable Zone](#user-content-link53)
**Authors:** Sarah Huang, Chen Jiang

54. [Deep Neural Network-Based High-Precision Identification of Weak Stability Boundary Structures](#user-content-link54)
**Authors:** Shuyue Fu, Ziqi Xu, Di Wu, Shengping Gong

55. [The chemical diversity of giant-planet nurseries as revealed by ALMA](#user-content-link55)
**Authors:** Alice S. Booth, Jenny Calahan, Milou Temmink, Lisa W\"olfer, Jamila Pegues, Charles J. Law, Lucy Evans, Margot Leemker, Shota Notsu, Karin \"Oberg, Catherine Walsh, Ewine F. van Dishoeck

56. [Green Bean galaxies and the fading echoes of AGN activity](#user-content-link56)
**Authors:** A. Arshinova, K. Sanderson, A. Moiseev

57. [Images of shadow and thin accretion disk around Bardeen black hole surrounded by perfect fluid dark matter](#user-content-link57)
**Authors:** Haiyuan Feng, Ziqiang Cai, Hao-Peng Yan, Rong-Jia Yang, Jinjun Zhang

58. [Probing ALP-photon couplings in Neutron Stars: Scalar versus pseudoscalar cases](#user-content-link58)
**Authors:** D. Su\'arez-Fontanella, C. Albertus, M. \'Angeles P\'erez-Garc\'ia

59. [Interstellar Ices as Carriers of Supernova Material to the Early Solar System](#user-content-link59)
**Authors:** Martin Bizzarro, Martin Schiller, Jesper Holst, Laura Bouvier, Mirek Groen, Fr\'ed\'eric Moynier, Elishevah van Kooten, Maria Sch\"onb\"achler, Troels Haugb{\o}lle, Darach Watson, Anders Johansen, James Connelly, Emil Bizzarro

60. [Quantum Recoherence in Presence of Excited States in the Early Universe](#user-content-link60)
**Authors:** Mattia Cielo, Simone Scarlatella, Gianpiero Mangano, Ofelia Pisanti, Louis Hamaide

61. [OzDES Reverberation Mapping Program: CIV lags from six years of data](#user-content-link61)
**Authors:** A. Penton, H. McDougall, T. M. Davis, Z. Yu, U. Malik, P. Martini, B. E. Tucker, C. Lidman, G. F. Lewis, R. Sharp, M. Aguena, S. Allam, F. Andrade-Oliveira, J. Asorey, D. Bacon, S. Bocquet, D. Brooks, R. Camilleri, A. Carnero Rosell, D. Carollo, A. Carr, J. Carretero, T. Y. Cheng, L. N. da Costa, M. E. da Silva Pereira, J. De Vicente, S. Desai, S. Everett, J. Garc\'ia-Bellido, K. Glazebrook, D. Gruen, G. Gutierrez, S. R. Hinton, D. L. Hollowood, K. Honscheid, K. Kuehn, O. Lahav, S. Lee, M. March, J. L. Marshall, J. Mena-Fern\'andez, R. Miquel, J. Myles, R. L. C. Ogando, A. A. Plazas Malag\'on, A. Porredon, M. Rodriguez-Monroy, A. K. Romer, E. Sanchez, D. Sanchez Cid, M. Smith, E. Suchyta, M. E. C. Swanson, V. Vikram, N. Weaverdyck

62. [Magnetized Shocks Mediated by Radiation from Leptonic and Hadronic Processes](#user-content-link62)
**Authors:** Shunke Ai, Irene Tamborra

63. [The jetted NLS1 1H 0323+342: the Rosetta stone for accretion/ejection in AGN](#user-content-link63)
**Authors:** Luigi Foschini

64. [Weak, extended water vapor emission in the Horsehead nebula](#user-content-link64)
**Authors:** Dariusz C. Lis, Vincent Maillard, Emeric Bron, Franck Le Petit, Javier R. Goicoechea, Ducheng Lu, David Teyssier

65. [Characterizing the Post-Red Supergiant binary system AFGL 4106 and its complex nebula with SPHERE/VLT](#user-content-link65)
**Authors:** G. Tomassini, E. Lagadec, I. El Mellah, R. D. Oudmaijer, A. Chiavassa, M. N'Diaye, P. de Laverny, N. Nardetto, A. Matter

66. [Pixel-Based Non-Linearity Correction for the WFC3 IR Detector](#user-content-link66)
**Authors:** Sachindev S. Shenoy, Ky Huynh, Varun Bajaj, Jennifer Mack

67. [On extremal black holes](#user-content-link67)
**Authors:** Chiara Coviello, Ruth Gregory

68. [Spatial Phonons: A Phenomenological Viscous Dark Energy Model for DESI](#user-content-link68)
**Authors:** Muhammad Ghulam Khuwajah Khan

69. [The Astrometric Resoeccentric Degeneracy: Eccentric Single Planets Mimic 2:1 Resonant Planet Pairs in Astrometry](#user-content-link69)
**Authors:** Daniel A. Yahalomi, Tiger Lu, Philip J. Armitage, Megan Bedell, Andrew R. Casey, Adrian M. Price-Whelan, Malena Rice

70. [A sudden fine-scale bright kernel captured by Hi-C Flare during an M1.6-class solar flare's post-maximum phase](#user-content-link70)
**Authors:** Sanjiv K. Tiwari, Navdeep K. Panesar, Ronald L. Moore, Sabrina L. Savage, Amy R. Winebarger, Genevieve D. Vigil, Juraj Lorincik, Vanessa Polito, Bart De Pontieu, Leon Golub, Ken Kobayashi, Patrick Champey, Jenna Samra, Anna Rankin, Robert W. Walsh, Crisel Suarez, Christopher S. Moore, Adam R. Kobelski, Jeffery W. Reep, Charles Kankelborg

71. [Nonlinear Orbital Variations in Binary Radio Pulsars from Lense-Thirring Precession](#user-content-link71)
**Authors:** Emmanuel Fonseca

72. [Bayesian inferences on covariant density functionals from multimessenger astrophysical data: The influences of parametrizations of density dependent couplings](#user-content-link72)
**Authors:** Guo-Jun Wei, Jia-Jie Li, Armen Sedrakian, Yong-Jia Wang, Qing-Feng Li, Fu-Hu Liu

73. [General-Relativistic Path Effects and the Local Hubble Expansion](#user-content-link73)
**Authors:** Said Laaroua

74. [Intercepting Interstellar Objects](#user-content-link74)
**Authors:** Colin Snodgrass, Marina Galand, Arnaud Beth, Charlotte Goetz, Abbie Donaldson, Cyrielle Opitom

75. [No Love for black holes: tightest constraints on tidal Love numbers of black holes from GW250114](#user-content-link75)
**Authors:** M. Andr\'es-Carcasona, G. Caneva Santoro

76. [Data-driven Radiative Magnetohydrodynamics Simulations with the MURaM Code: the Emergence of Active Region 11158 and the X2.2 Flare](#user-content-link76)
**Authors:** Feng Chen

77. [A window for water-hydrogen demixing on warm metal-rich sub-Neptunes](#user-content-link77)
...
78. [Large/small eddy simulations: A posteriori analysis in high Reynolds number isotropic turbulence](#user-content-link78)
**Authors:** Chang Hsin Chen, Arnab Moitro, Alexei Y. Poludnenko

79. [Particle Astrophysics with High and Ultrahigh Energy Neutrinos](#user-content-link79)
**Authors:** Ke Fang, Kohta Murase

80. [Starspots and Flares are Generally Not Correlated](#user-content-link80)
**Authors:** Andy B. Zhang, Jason R. Reeves, David V. Martin, Veronica Pratt, Wata Tubthong, Arielle Weinstein, Isabella E. Ward

81. [Identification of new Galactic symbiotic stars with SALT - II. New discoveries and characterization of the sample](#user-content-link81)
**Authors:** J. Merc, J. Miko{\l}ajewska, K. I{\l}kiewicz, B. Monard, A. Udalski

82. [Quiet Skies Report: A Primer on Protecting Radio Astronomy in the Age of Satellite Mega-Constellations](#user-content-link82)
**Authors:** Gregory Hellbourg

83. [Spectroscopic and Decade-long Photometric Observations of the Contact Binary V2790 Ori: Evidence for a Brown Dwarf Companion and a Solar-like Magnetic Activity Cycle](#user-content-link83)
**Authors:** Si-Rui Wang, Kai Li, Qi-Qi Xia, Dong-Yang Gao, Xiang Gao, Jing-Yi Wang, Ya-Ni Guo, Xing Gao, Guo-You Sun

84. [Investigating Circumstellar Atomic Radiation-driven Dynamics](#user-content-link84)
**Authors:** A. Lehtmets, M. Kama, L. Fossati, A. Aret

85. [Impact of positrons on electrical conductivity of hot and dense astrophysical plasma](#user-content-link85)
**Authors:** Tigran Petrosyan, Arus Harutyunyan, Armen Sedrakian

86. [Predicted white-light solar flare emission from the F-CHROMA grid of models](#user-content-link86)
**Authors:** Sascha Ornig, Mats Carlsson

87. [Uniformly-calibrated VPHAS+ photometry in the third quadrant of the Galactic plane](#user-content-link87)
**Authors:** J. E. Drew, R. Greimel, J. Eisl\"offel, R. Raddi, N. J. Wright

88. [Astrometric view of companions in the inner dust cavities of protoplanetary disks](#user-content-link88)
**Authors:** Miguel Vioque, Richard A. Booth, Enrico Ragusa, \'Alvaro Ribas, Nicol\'as T. Kurtovic, Giovanni P. Rosotti, Zephyr Penoyre, Stefano Facchini, Antonio Garufi, Carlo F. Manara, Nuria Hu\'elamo, Andrew Winter, Sebasti\'an P\'erez, Myriam Benisty, Ignacio Mendigut\'ia, Nicol\'as Cuello, Anna B. T. Penzlin, Alfred Castro-Ginard, Richard Teague

89. [The SRG/eROSITA All-Sky Survey: A comprehensive X-ray analysis of the Hydra I galaxy cluster](#user-content-link89)
**Authors:** Alpish Srivastava, Thomas H. Reiprich, Angie Veronica, Florian Pacaud, Jakob Dietl, Fiona Knies, Manami Sasaki

90. [Real-time RFI Excision Techniques and Their Limitations](#user-content-link90)
**Authors:** Kaushal D. Buch, Thushara Gunaratne, Gregory Hellbourg, Cedric Viou, Benjamin Winkel

91. [Nested Sampling for ARIMA Model Selection in Astronomical Time-Series Analysis](#user-content-link91)
**Authors:** Ajinkya Naik, Will Handley

92. [Active chromospheric fibril singularity: Coordinated observations from Solar Orbiter, SST, and IRIS](#user-content-link92)
**Authors:** Reetika Joshi, Luc Rouppe van der Voort, Guillaume Aulanier, Sanja Danilovic, Avijeet Prasad, Carlos J. D\'iaz Baso, Daniel N\'obrega-Siverio, Nicolas Poirier, Daniele Calchetti

93. [OzDES Reverberation Mapping of Active Galactic Nuclei: Final Data Release, Black-Hole Mass Results, & Scaling Relations](#user-content-link93)
**Authors:** H. McDougall, T. M. Davis, Z. Yu, P. Martini, C. Lidman, U. Malik, A. Penton, G. F. Lewis, B. E. Tucker, B. J. S. Pope, S. Allam, F. Andrade-Oliveira, J. Asorey, D. Bacon, S. Bocquet, D. Brooks, A. Carnero Rosell, D. Carollo, A. Carr, J. Carretero, T. Y. Cheng, L. N. da Costa, M. E. da Silva Pereira, J. De Vicente, H. T. Diehl, P. Doel, S. Everett, J. Garc\'ia-Bellido, K. Glazebrook, D. Gruen, G. Gutierrez, K. Herner, S. R. Hinton, D. L. Hollowood, D. J. James, A. G. Kim, K. Kuehn, S. Lee, M. March, J. L. Marshall, J. Mena-Fern\'andez, F. Menanteau, R. Miquel, J. Myles, R. L. C. Ogando, A. Porredon, E. Sanchez, D. Sanchez Cid, R. Sharp, M. Smith, E. Suchyta, M. E. C. Swanson, C. To, D. L. Tucker, A. R. Walker, N. Weaverdyck

94. [Probing the Scalar Hair of Rotating Horndeski Black Holes through Thick Disk Images](#user-content-link94)
**Authors:** Qian Wan, Yehui Hou, Minyong Guo

95. [The 2023 Australian Total Solar Eclipse: Line Emission of Fe XIV, Fe X and Fe XI out to 6 solar radii](#user-content-link95)
**Authors:** Benjamin Boe, Shadia Habbal, Miloslav Druckm\"uller, Pavel \v{S}tarha, Mat\v{e}j \v{S}tarha, Jana Hoderov\'a, Sage Constantinou, Eric Ayars, Daniell Casillas

96. [LST-1 follow-up of the exceptionally bright gamma-ray burst GRB 221009A](#user-content-link96)
**Authors:** Arnau Aguasca-Cabot (for the CTAO-LST Project), Alessandro Carosi (for the CTAO-LST Project), Alice Donini (for the CTAO-LST Project), Susumu Inoue (for the CTAO-LST Project), Yuri Sato (for the CTAO-LST Project), Monica Seglar Arroyo (for the CTAO-LST Project), Kenta Terauchi (for the CTAO-LST Project), Pol Bordas (for the CTAO-LST Project), Marc Rib\'o (for the CTAO-LST Project)

97. [Velocity-space turbulent cascade in the near-Sun solar wind: first insights from the Parker Solar Probe mission](#user-content-link97)
...
98. [Generalization of Elliptical-Cylindrical Flux Rope Models for ICME Reconstruction](#user-content-link98)
**Authors:** Marti Masso Moreno, Carlos Arturo Perez-Alanis, P. K. Manoharan

99. [Analysis of Angular-Differential Post-Processing Algorithms for Exoplanet Direct Detection with a Photonic Lantern Nuller](#user-content-link99)
**Authors:** Suvinay Goyal, Yinzi Xin, Nemanja Jovanovic, Dimitri Mawet, Michael P. Fitzgerald

100. [A First Order Filter for the Detection of Potentially Habitable Exoplanets](#user-content-link100)
**Authors:** Raka Dabhade, Jebraan Mudholkar, Siddhesh Durgude, Arpit Kottur

101. [Revisiting wideband pulsar timing measurement](#user-content-link101)
**Authors:** Abhimanyu Susobhanan, Avinash Kumar Paladi, R\'eka Desmecht, Amarnath, Manjari Bagchi, Manoneeta Chakraborty, Shaswata Chowdhury, Suruj Jyoti Das, Debabrata Deb, Shantanu Desai, Churchil Dwivedi, Himanshu Grover, Jibin Jose, Bhal Chandra Joshi, Shubham Kala, Fazal Kareem, Kuldeep Meena, Sushovan Mondal, K Nobleson, Arul Pandian B, Kaustubh Rai, Adya Shukla, Manpreet Singh, Aman Srivastava, Mayuresh Surnis, Hemanga Tahbildar, Keitaro Takahashi, Pratik Tarafdar, Kunjal Vara, Vaishnavi Vyasraj, Zenia Zuraiq

102. [Non-detection of FAST and Parkes follow-up observation for 27 Parkes discovered FRBs](#user-content-link102)
**Authors:** Xuan Yang, Songbo Zhang, Xuefeng Wu

103. [Tidal disruption and evaporation of rubble-pile and monolithic bodies as a source of flaring activity in Sgr A^\star$](#user-content-link103)
**Authors:** Wen-Han Zhou, Yun Zhang, Jiamu Huang, Douglas N. C. Lin

104. [Resolving Interchange Reconnection Dynamics in a Fan-Spine-like Topology Observed by Solar Orbiter](#user-content-link104)
**Authors:** Yadan Duan, Xiaoli Yan, Junchao Hong, Hechao Chen, Yuhang Gao, Zheng Sun, Zhenyong Hou, Jincheng Wang

105. [Inferring planet occurrence rates from radial velocities](#user-content-link105)
**Authors:** J. P. Faria, J. -B. Delisle, D. S\'egransan

106. [Enhanced detection limits in the SHINE F150 survey through the Regime Switching Model Optimizing thresholds and investigating environmental noise](#user-content-link106)
**Authors:** Mariam Sabalbal, Olivier Absil, Carl-Henrik Dahlqvist, Philippe Delorme

107. [Interferometry of Massive Stars: Multiplicity, Magnetism, and Stellar Winds](#user-content-link107)
**Authors:** H. Sana E. Bordier, K. Deshmukh, A. J. Frost, A. Keskar, C. Lanthermann, R. R. Lefever, L. Mahy, A. A. C. Sander, T. Shenar, F. Tramper

108. [A robust empirical relationship between speed and turbulence energy in the near-Earth solar wind](#user-content-link108)
**Authors:** Rohit Chhiber, Yanwen Wang, Jiaming Wang, Sohom Roy

109. [Possible quasi-periodic optical oscillations of ZTF blazars](#user-content-link109)
**Authors:** Na Wang, Guowei Ren, Shun Zhang, Tingfeng Yi, Tong Liu, Mouyuan Sun

110. [The calm before the storm: High spatial resolution mosaic of active region NOAA 14274 at the onset of an X1.2 flare](#user-content-link110)
**Authors:** Carsten Denker (Leibniz Institute for Astrophysics Potsdam), Robert Kamlah (Leibniz Institute for Astrophysics Potsdam), Meetu Verma (Leibniz Institute for Astrophysics Potsdam), Alexander G. M. Pietrow (Leibniz Institute for Astrophysics Potsdam)

111. [Broadband Spectral Analysis of 1ES2344+514: A Multi-epoch study](#user-content-link111)
**Authors:** Kishor Chaudhury, Abhradeep Roy, Varsha R. Chitnis, Prajval Shastri, Rajat K. Dey

112. [The impact of Solar magnetic field configurations on the production of gamma rays at the Solar disk](#user-content-link112)
**Authors:** Julien D\"orner, Frederic Effenberger, Horst Fichtner, Julia Becker Tjus, Meng Jin, Wei Liu, Vahe' Petrosian

113. [X-CME: From In Situ Flux-Rope Reconstruction to CME Propagation Forecasting](#user-content-link113)
**Authors:** Marti Masso Moreno, Carlos Arturo Perez-Alanis, P. K. Manoharan

114. [Variable X-ray Emission of the Planet Hosting T Tauri Star CI Tau](#user-content-link114)
**Authors:** Stephen L. Skinner, Manuel Guedel

115. [Evolution of Flare Ribbon Bead-like Structures in a Solar Flare](#user-content-link115)
**Authors:** Ryan J. French, Maria D. Kazachenko, David Berghmans, Elke D'Huys, Marie Dominique, Ritesh Patel, Dana-Camelia Talpeanu, Cole A. Tamburri, Rahul Yadav

116. [Can the Efron-Petrosian Method Recover the Inverse-Square Distance Law for Simulated Radio Pulsar Fluxes?](#user-content-link116)
**Authors:** Sanjith A., Shantanu Desai

117. [Euclid Structural-Thermal-Optical Performance](#user-content-link117)
...
118. [Astro-Animation -- How Artists and Scientists Envision the Universe](#user-content-link118)
**Authors:** Laurence Arcadias, Robin H. D. Corbet, Emma Booth

119. [Surveys on the Existence of Extraterrestrial Intelligent Life and Effects of Revealing Expert Consensus](#user-content-link119)
**Authors:** Omer Eldadi, Gershon Tenenbaum, Abraham Loeb

120. [Search for Peak Structures in the Stochastic Gravitational-Wave Background in LIGO-Virgo-KAGRA O1-O4a Datasets](#user-content-link120)
**Authors:** Catalina-Ana Miritescu, Mario Martinez, Oriol Pujolas

121. [Letelier black hole immersed in an electromagnetic universe](#user-content-link121)
**Authors:** Ahmad Al-Badawi, Faizuddin Ahmed, \.Izzet Sakall{\i}

122. [XRISM Observations of Accretion Disk Corona in Cyg X-2](#user-content-link122)
**Authors:** Misaki Mizumoto, Hiromitsu Takahashi, Ehud Behar, Rozenn Boissay-Malaquin, Lia Corrales, Elisa Costantini, Maria Diaz-Trigo, Eric D. Miller, Jon M. Miller

123. [Comment on 'Color astrophotography with a 100 mm-diameter f/2 polymer flat lens', Appl. Phys. Lett. 126, 051701 (2025)](#user-content-link123)
**Authors:** G. K. Skinner, J. F. Krizmanic

---

## 1. [Joint Constraints on Fuzzy and Warm Dark Matter from Satellite Populations of the Milky Way and Andromeda](https://arxiv.org/abs/2512.01361) <a id="link1"></a>
...
**Comment:** Directly matches the 'Near-Field Cosmology' criterion: joint constraints on fuzzy and warm dark matter using the satellite populations of the Milky Way and Andromeda. Uses satellite luminosity functions and substructure counts, which are highly relevant.
...
## 3. [Exploring the ultra-faint dwarf Bootes I using JWST and HST: Metallicity distribution and binaries](https://arxiv.org/abs/2512.01547) <a id="link3"></a>
...
**Comment:** Presents JWST and HST observations of the ultra-faint dwarf galaxy Bootes I, focusing on its metallicity distribution and binary fraction. This is highly relevant to near-field cosmology and resolved star formation histories, directly matching two core criteria.
...
## 4. [The DREAMS Project: A New Suite of 1,024 Simulations to Contextualize the Milky Way and Assess Physics Uncertainties](https://arxiv.org/abs/2512.00148) <a id="link4"></a>
...
**Comment:** This paper introduces a large suite of cosmological zoom-in simulations of Milky Way-mass halos, specifically designed to contextualize the Milky Way and assess physics uncertainties. It directly matches the 'Numerical Galaxy Simulations' criterion, with increased weight due to the focus on the Milky Way and its merger history (near-field cosmology). The investigation of GSE analogs and their impact on present-day properties is highly relevant.
...
## 5. [The role of prompt cusps in driving the core collapse of SIDM halos](https://arxiv.org/abs/2512.00145) <a id="link5"></a>
...
**Comment:** Uses high-resolution N-body simulations to study the evolution of dark matter halos with prompt cusps in the context of self-interacting dark matter (SIDM). The work is highly relevant to numerical galaxy simulations and core-cusp problems, which are central to near-field cosmology and dark matter density profiles in dwarf galaxies.
...
## 6. [GASTRO library II: Exploring Chemical Bimodalities in Disk Galaxies with GSE-like Mergers and Massive Star-forming Clumps](https://arxiv.org/abs/2512.01293) <a id="link6"></a>

**ArXiv ID:** 2512.01293

**Authors:** Jo\~ao A. S. Amarante, Chervin F. P. Laporte, Victor P. Debattista, Leandro Beraldo e Silva, Guilherme Limberg, H\'elio D. Perottoni, Zhao-Yu Li, Lais Borbolato, Karl Fiteni, Chengye Cao, Nathan Deg, Tigran Khachaturyants, Xiaojie Liao

**Abstract:** We use several smoothed particle hydrodynamics+N-body models as part of the GASTRO library to study the role of high-density star-forming clumpy regions and a single merger on the formation of the $\alpha$-rich and $\alpha$-poor populations in the disk galaxies. These experiments are tailored to mimic what is expected to be the Gaia-Sausage/Enceladus (GSE) accretion event, which occurred circa 10 Gyr ago in the Milky Way (MW). We find that either an early clumpy phase or a retrograde merger significantly reduces the star formation rate (SFR) of the disk, giving rise to a chemical bimodality qualitatively similar to the MW's. The decrease of the SFR as the cause of the chemical bimodality is consistent with previous idealized and cosmological simulations. On the other hand, a prograde radial merger does not significantly modify the SFR of the disk, resulting in no clear chemical bimodality. We further show that stars originating from the inner regions ($R_{form}11$ Gyr, $\alpha-$poor stars with disk-like orbits, similar to what has been recently observed in the MW. Our results strengthen the case of clumpy disky galaxies observed at redshift $z\approx 1-2$ as likely progenitors of our Galaxy.

**Comment:** This paper uses numerical simulations to study chemical bimodalities in disk galaxies, specifically mimicking the Gaia-Sausage/Enceladus (GSE) merger event in the Milky Way. It directly addresses near-field cosmology (Milky Way accretion history), numerical galaxy simulations, and the impact of mergers on star formation and chemical evolution. Highly relevant.
...
## 7. [Evidence for the Faint-End Suppression in the z = 6 $\sim$ 8 UV Luminosity Function: A Lensing Analysis of Abell 2744](https://arxiv.org/abs/2512.00730) <a id="link7"></a>

**ArXiv ID:** 2512.00730

**Authors:** Xuheng Ma

**Abstract:** We determine the $z=6-8$ ultraviolet (UV) LF in the JWST UNCOVER field behind Abell 2744, through a depth-tied completeness model and source-plane selection taking multiple images into account. We compute the intrinsic $M_{UV}$ LFs and lens-dependent effective volumes $V_{eff,\ell}(M_{UV})$ for two of them (CATS, GLAFIC), and construct binned LFs with statistical (Gehrels) errors presented separately from the lens-model spread. When fitting each lens model independently with both the original and turnover-extended form (while keeping $M^*=-20.5$), we obtain decisive model selection in favour of a faint-end turnover. The peak of the turnover posteriors is at $\alpha \simeq -1$, $\beta \simeq 1.6$, and drive $M_T$ to the high side of our prior ($\sim -18$) and the difference in normalization between CATS-GLAFIC is absorbed into $\phi^*$. A similar magnification-bias test in the image plane gives a $B(\mu)$ trend matching to what is expected, which provides an internal consistency of our selection and volumes. Our results indicate an early suppression of the UV LF at $z=6-8$, and carry implications for the ionizing contribution of ultra-faint systems during reionization.

**Comment:** This paper analyzes the faint-end of the UV luminosity function at z=6-8 using lensing, which is directly relevant to the satellite luminosity function and near-field cosmology criteria. The work has implications for the abundance of faint galaxies and their role in reionization, closely matching the core topics.
...
## 8. [Gravity-darkening exponents for MESA stellar evolution models](https://arxiv.org/abs/2512.00116) <a id="link8"></a>

**ArXiv ID:** 2512.00116

**Authors:** A. Claret (IAA, Spain), G. Torres (CfA, USA)

**Abstract:** In this Research Note we present new gravity-darkening exponents ($\beta$) for several stellar evolution models from the ZAMS up to the giant phase. The models were computed using the MESA code (version 7385) for the composition $X = 0.70$ and $Z = 0.02$, adopting A09 opacities and a mixing length parameter of $\alpha_{\rm MLT} = 1.84$. Results were calculated using the triangle strategy, for initial stellar masses of 1.0, 1.5, 2.0, 2.5, 3.0, 5.0, 7.0, 10.0, 15.0, and 20.0 $M_{\odot}$, and provide an update on previously available $\beta$ values that used older models.

**Comment:** Presents new gravity-darkening exponents for MESA stellar evolution models, which directly matches the 'Stellar Models' criterion. This is a clear and direct fit to one of the core topics.
...
## 9. [SMSS J022423.27$-$573705.1: An Extremely Metal-Poor Star with the Most Pronounced Weak $r$-Process Signature](https://arxiv.org/abs/2512.00721) <a id="link9"></a>
...
**Comment:** This paper presents detailed abundance measurements of an extremely metal-poor star with a pronounced weak r-process signature. The study is highly relevant to near-field cosmology, as it provides insight into nucleosynthetic processes in the early Galaxy and the nature of the accreted stellar halo. It also touches on stellar models and the chemical evolution of the Milky Way's halo.
...
## 10. [Constraining Dark Acoustic Oscillations with the High-Redshift UV Luminosity Function](https://arxiv.org/abs/2512.01998) <a id="link10"></a>
...
**Comment:** This paper uses measurements of the high-redshift UV luminosity function to constrain dark acoustic oscillations (DAOs) in the matter power spectrum. The work is relevant to near-field cosmology as it discusses small-scale structure and substructure in the dark matter power spectrum, which can impact the abundance and properties of dwarf galaxies. The use of UVLF and N-body simulations also touches on numerical galaxy simulations.
...
## 11. [CECILIA: The Mass-Metallicity Relation of Low-Mass Galaxies at Cosmic Noon](https://arxiv.org/abs/2512.00162) <a id="link11"></a>
...
**Comment:** This paper presents new constraints on the mass-metallicity relation of low-mass galaxies at z~2-3, including galaxies with stellar masses down to log(M_*)~7.2. The focus on low-mass galaxies and their metal retention efficiency is relevant to near-field cosmology and the study of outflows (energy-driven outflows are discussed). The connection to metal enrichment and outflows in low-mass galaxies makes this paper directly relevant to the criteria.
...
## 12. [Validating the 1D-3D coupling stellar models via Asteroseismology of 18 Kepler main-sequence stars](https://arxiv.org/abs/2512.00291) <a id="link12"></a>
...
**Comment:** Validates 1D-3D coupling stellar models using asteroseismology of Kepler main-sequence stars. This fits the 'Stellar Models' criterion, as it presents improvements in stellar atmosphere and interior modeling.
...
## 13. [Asteroseismic detection of a predominantly toroidal magnetic field in the deep interior of the main-sequence F star KIC 9244992](https://arxiv.org/abs/2512.00786) <a id="link13"></a>
...
**Comment:** Asteroseismic detection of magnetic fields in a main-sequence F star, with implications for stellar magnetism and interior structure. This fits the 'Stellar Models' criterion as it presents new constraints on stellar interior models using asteroseismology.
...
## 15. [Transition from Outside-in to Inside-Out at $z\sim 2$: Evidence from Radial Profiles of Specific Star Formation Rate based on JWST/HST](https://arxiv.org/abs/2512.01684) <a id="link15"></a>

**ArXiv ID:** 2512.01684

**Authors:** Jie Song, Enci Wang, Cheng Jia, Cheqiu Lyu, Yangyao Chen, Jinyang Wang, Fujia Li, Weiyu Ding, Guanwen Fang, Xu Kong

**Abstract:** By combining high-resolution observations from JWST and HST, we have measured the stellar masses, star formation rates (SFRs), and multi-wavelength morphologies of galaxies in the CANDELS fields. Furthermore, based on rest-frame 1 $\mu$m morphologies, we have derived spatially resolved stellar mass and SFR surface density ($\Sigma_*$ and $\Sigma_{\rm SFR}$) profiles for 46,313 galaxies with reliable structural measurements at $08$, and provide the corresponding catalogue. For star-forming galaxies (SFGs), our results show excellent consistency with previous studies in terms of the star formation main sequence and the size-mass relation, demonstrating the robustness of our stellar mass and SFR measurements. For spatially resolved profiles, we find that at higher redshifts ($z>2.5$), the median radial profile of $\Sigma_{\rm SFR}$ is nearly parallel to but slightly steeper than that of $\Sigma_*$. This results in mildly negative gradients in the specific SFR (sSFR) profiles across all stellar mass bins considered. These findings indicate that galaxies at $z>2.5$ cannot grow in size via only in-situ star formation, challenging the understanding of galaxy size evolution beyond the cosmic noon. In contrast, at $z<2.0$, the sSFR profiles transition to exhibit more and more positive gradients at lower redshifts, consistent with an inside-out growth scenario where star formation preferentially expands the galactic outskirts.

**Comment:** The paper studies spatially resolved star formation rate profiles in galaxies at z~2 using JWST/HST data. While it discusses star formation histories and quenching, the focus is on general galaxy evolution and not specifically on dwarf galaxies or resolved star formation histories from color-magnitude diagrams. It is borderline relevant for the resolved star formation histories criterion.
...
## 16. [Episodic Star Formation -- I. Overview and Scatter of the Star-Forming Main Sequence](https://arxiv.org/abs/2512.00151) <a id="link16"></a>
...
**Comment:** This paper analyzes episodic star formation histories in simulated galaxies (TNG100), focusing on the scatter in the star-forming main sequence. While it discusses resolved star formation histories, it is based on simulations rather than direct observations, so it matches the 'Resolved Star Formation Histories' criterion but with lower weight. It does not focus on dwarf galaxies or near-field cosmology.
...
## 17. [Accurate cosmological emulator for the probability distribution function of gravitational lensing of point sources](https://arxiv.org/abs/2512.01607) <a id="link17"></a>
...
**Comment:** Develops an emulator for the gravitational lensing magnification PDF using N-body simulations. While it uses galaxy-scale simulations, the focus is on lensing statistics for cosmological inference, not on galaxy formation, resolved star formation histories, or near-field cosmology. The connection to numerical galaxy simulations is present but indirect.
...
## 18. [Analytical Emulator for the Baryon EoM inside the Fuzzy Dark Matter Soliton from Machine Learning](https://arxiv.org/abs/2512.01622) <a id="link18"></a>
...
**Comment:** This paper discusses the effects of baryons on fuzzy dark matter soliton formation, including the baryon equation of motion inside the soliton. While it touches on dark matter density profiles and baryon interactions, it does not directly address near-field cosmology, satellite galaxies, or core-cusp issues in observed dwarf galaxies. The focus is more on theoretical modeling of soliton formation rather than galaxy-scale phenomena.
...
## 19. [From Black Hole to Galaxy: Neural Operator: Framework for Accretion and Feedback Dynamics](https://arxiv.org/abs/2512.01576) <a id="link19"></a>
...
**Comment:** The paper introduces a neural operator framework for modeling accretion and feedback dynamics from black holes to galaxies, focusing on subgrid modeling of black hole feedback. While it presents a new simulation technique, the main focus is on supermassive black hole accretion and feedback, not star-formation-driven outflows, dwarf galaxies, or near-field cosmology.
...
## 20. [Probing Fuzzy Dark Matter in the 21 cm Signal via Wavelet Scattering Transform](https://arxiv.org/abs/2512.00402) <a id="link20"></a>
...
**Comment:** Examines fuzzy dark matter effects on the 21 cm signal using simulations. While it is about dark matter and structure formation, it does not focus on near-field cosmology, resolved star formation histories, or galaxy-scale simulations. The work is more cosmological and does not address Local Group or dwarf galaxy properties.
...
## 21. [On the multiplicity of red-Herschel sources and its implications for extreme star formation](https://arxiv.org/abs/2512.00822) <a id="link21"></a>
...
**Comment:** Analyzes multiplicity and star formation in red-Herschel sources, focusing on submillimeter galaxies and proto-cluster formation. The work is about extreme star formation and galaxy interactions, but not specifically about dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 22. [Probing a minimal dark gauge sector via microlensing of compact dark objects](https://arxiv.org/abs/2512.00701) <a id="link22"></a>
...
**Comment:** Proposes a minimal dark gauge sector and explores compact dark objects via microlensing. While it uses microlensing constraints from surveys that target compact objects (including those in the Milky Way and possibly dwarf galaxies), the focus is on particle physics and dark matter phenomenology, not on galaxy properties or near-field cosmology.
...
## 23. [Dynamical Heating from Dark Compact Objects and Axion Minihalos: Implications for the 21-cm Signal](https://arxiv.org/abs/2512.00169) <a id="link23"></a>
...
**Comment:** Discusses dynamical heating from dark compact objects and axion minihalos and its effect on the 21-cm signal. While it involves dark matter substructure and baryon heating, it does not focus on galaxies, their satellites, or resolved star formation histories. The connection to near-field cosmology is weak, as the focus is on cosmological dark ages and not local galaxy properties.
...
## 24. [Normal or transitional? The evolution and properties of two type Ia supernovae in the Virgo cluster](https://arxiv.org/abs/2512.00555) <a id="link24"></a>
...
**Comment:** Studies two Type Ia supernovae in the Virgo cluster, focusing on their photometric and spectroscopic properties. While it involves extragalactic objects, the focus is on supernova classification and cosmological distance indicators, not on satellite galaxies, resolved star formation histories, or galaxy simulations.
...
## 26. [Mass transfer stability for AM CVn binaries with white dwarf donors](https://arxiv.org/abs/2512.01377) <a id="link26"></a>
...
**Comment:** This paper discusses mass transfer stability in AM CVn binaries with white dwarf donors, using new simulations to revise merger rates. It is relevant to stellar models and binary evolution, but does not directly address the core topics such as near-field cosmology or resolved star formation histories.
...
## 27. [Substellar Initial Mass Function of Trumpler 14](https://arxiv.org/abs/2512.01606) <a id="link27"></a>
...
**Comment:** This paper presents a deep study of the initial mass function (IMF) in the young massive cluster Trumpler 14, with a focus on brown dwarf formation. While it discusses the IMF and star-to-brown-dwarf ratio, it does not address resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on a massive cluster, not on the relevant galaxy types.
...
## 28. [The Hubble Missing Globular Cluster Survey. II. Survey membership tools and kinematic analysis of NGC 6749](https://arxiv.org/abs/2512.01530) <a id="link28"></a>
...
**Comment:** This paper presents new HST and Gaia data for the globular cluster NGC 6749, including proper motion measurements and kinematic analysis. While it involves color-magnitude diagrams and stellar membership, the focus is on a globular cluster, not a dwarf galaxy or satellite system. It does not address resolved star formation histories of galaxies, near-field cosmology, or galaxy simulations. The methods for decontaminating CMDs and measuring kinematics are interesting but only tangentially related to the core topics.
...
## 29. [Kratos-polrad: Novel GPU system for Monte-Carlo simulations with consistent polarization calculations](https://arxiv.org/abs/2512.01283) <a id="link29"></a>
...
**Comment:** This paper presents a new GPU-accelerated Monte Carlo radiative transfer code for polarization calculations. While it is a technical advance in radiative transfer and polarimetry, it does not present new stellar models or address galaxy-scale processes, star formation, or any of the core topics.
...
## 30. [Resonant Annihilation of WIMP Dark Matter for Halo Gamma Ray Signal](https://arxiv.org/abs/2512.01404) <a id="link30"></a>
...
**Comment:** Discusses resonant annihilation of WIMP dark matter to explain gamma ray signals from the Milky Way halo and dwarf galaxies. While it mentions dwarf galaxies in the context of constraints, the focus is on particle physics models and gamma ray signals, not on galaxy properties or near-field cosmology.
...
## 31. [Type IIP SN 2024bch: Hydrodynamic model, shock breakout, and circumstellar interaction](https://arxiv.org/abs/2512.01552) <a id="link31"></a>
...
**Comment:** Hydrodynamic modeling of a Type IIP supernova, including circumstellar interaction and mass-loss rates. While it discusses stellar evolution and mass loss, it does not present new stellar models or focus on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 32. [Ubiquity of Methanol and its related Chemical Segregation in Orion Starless Cores: the ALMASOP Sample](https://arxiv.org/abs/2512.00498) <a id="link32"></a>
...
**Comment:** Chemical survey of starless cores in Orion, focusing on methanol and other molecules. While it discusses early stages of star formation, it does not derive resolved star formation histories from color-magnitude diagrams or focus on dwarf galaxies.
...
## 33. [Revisiting the Supernova Engines in the 3C 397 and W49B Supernova Remnants](https://arxiv.org/abs/2512.01176) <a id="link33"></a>
...
**Comment:** Presents a spectroscopic analysis of supernova remnants, focusing on nucleosynthesis and explosion energetics. While relevant to stellar evolution and supernovae, it does not address the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 34. [Investigating the Correlation between Dark Matter Content, Ages and Mass-to-Light Ratios in Spiral Galaxies](https://arxiv.org/abs/2512.00823) <a id="link34"></a>
...
**Comment:** Investigates the correlation between dark matter content and age in spiral galaxies using rotation curves and mass modeling. While it discusses dark matter, the focus is on higher mass spiral galaxies, not dwarf satellites or near-field cosmology, and does not address the other core topics.
...
## 35. [The sonic scale does not determine the core separation in turbulent molecular clouds](https://arxiv.org/abs/2512.00284) <a id="link35"></a>
...
**Comment:** The paper investigates fragmentation and core separation in turbulent molecular clouds, testing the role of the sonic scale. This is relevant to star formation physics, but does not directly address resolved star formation histories, quenching, or galaxy-scale outflows. The focus is on molecular cloud structure and star formation theory, which is tangential to the core topics.
...
## 36. [Equivalence of Stability Criteria for Multi-Fluid Stars](https://arxiv.org/abs/2512.01640) <a id="link36"></a>
...
**Comment:** Presents a mathematical framework for stability criteria in multi-fluid stars, including dark matter equations of state. While it touches on dark matter, the focus is on stellar interiors and stability, not on galaxy evolution, resolved star formation histories, or near-field cosmology.
...
## 37. [Bayesian inference on Calabi--Yau moduli spaces and the axiverse: experimental data meets string theory](https://arxiv.org/abs/2512.00144) <a id="link37"></a>
...
**Comment:** Discusses Bayesian inference on Calabi-Yau moduli spaces and axion physics, with some connection to dark matter. However, the focus is on string theory and axion phenomenology, not on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 38. [Widen the Resonance at Ultra-High Energies: Novel Probes of Neutrino Self-interactions in the High-Mass Regime](https://arxiv.org/abs/2512.00165) <a id="link38"></a>
...
**Comment:** Proposes new probes of neutrino self-interactions using ultra-high-energy neutrinos, with some discussion of connections to dark matter. However, the focus is on particle physics and neutrino interactions, not on galaxy formation, dwarf galaxies, or star formation histories.
...
## 39. [Egent: An Autonomous Agent for Equivalent Width Measurement](https://arxiv.org/abs/2512.01270) <a id="link39"></a>
...
**Comment:** This paper presents a new autonomous agent for equivalent width measurement in stellar spectra. While it is a technical advance in spectral analysis, it does not present new stellar models or address galaxy-scale processes, star formation, or any of the core topics.
...
## 40. [Cosmology of Gravi-Axions](https://arxiv.org/abs/2512.00154) <a id="link40"></a>
...
**Comment:** This paper discusses the cosmology of gravi-axions, a theoretical particle with implications for dark matter and dark energy. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on fundamental physics and cosmological models, not on the structure or evolution of galaxies.
...
## 42. [A tale of three tails: A misaligned streamer and mysterious structures around [BHB2007]1](https://arxiv.org/abs/2512.00295) <a id="link42"></a>
...
**Comment:** The paper presents ALMA observations of streamer-like structures around a protostellar source, focusing on star formation and infall in a single system. While it discusses star formation processes, it is not about resolved star formation histories of galaxies, quenching, or galaxy-scale outflows, and does not address dwarf galaxies or near-field cosmology.
...
## 43. [First detections of methanol maser lines from a rare transition family](https://arxiv.org/abs/2512.01875) <a id="link43"></a>
...
**Comment:** This paper reports the first detections of rare methanol maser transitions in high-mass star formation regions. The focus is on maser astrophysics and high-mass star formation, not on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No core criteria are matched.
...
## 44. [The ALMA Survey of 70 \mu m Dark High-mass Clumps in Early Stages (ASHES). XIII. Core Mass Function, Lifetime, and Growth of Prestellar Cores](https://arxiv.org/abs/2512.00147) <a id="link44"></a>
...
**Comment:** Focuses on the core mass function (CMF) and its relation to the initial mass function (IMF) in high-mass star formation regions. While it discusses star formation and core evolution, it does not address resolved star formation histories, dwarf galaxies, or galaxy-scale processes. The work is more about star cluster formation than galaxy evolution.
...
## 45. [Excitation of molecular hydrogen by cosmic-ray protons](https://arxiv.org/abs/2512.00474) <a id="link45"></a>
...
**Comment:** Examines excitation of molecular hydrogen by cosmic-ray protons in molecular clouds, which is relevant to ISM physics but does not match any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 46. [Multi-frequency radio-continuum study of the LMC SNR N206 (Goat's Eye) and its "zig-zag" PWN](https://arxiv.org/abs/2512.01221) <a id="link46"></a>
...
**Comment:** This paper presents new radio observations of the LMC SNR N206 and its pulsar wind nebula. While the LMC is a relevant environment for near-field cosmology, the focus here is on a supernova remnant and its PWN, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 47. [Stability of Neutron-Dark Matter Mixed Stars and Hybrid Stars](https://arxiv.org/abs/2512.01641) <a id="link47"></a>
...
**Comment:** Focuses on stability of neutron stars with dark matter admixture. While it discusses dark matter properties and compact star observations, it does not directly address near-field cosmology, dwarf galaxies, or galaxy simulations. The topic is more about stellar interiors and dark matter constraints via neutron stars, which is tangential to the core topics.
...
## 48. [Similar Fermi-GBM sGRBs to GW/sGRB 170817A in MeV-GeV energies](https://arxiv.org/abs/2512.01387) <a id="link48"></a>
...
**Comment:** This paper focuses on identifying short gamma-ray bursts (sGRBs) similar to GW/sGRB 170817A, which is related to neutron star mergers and gravitational wave events. While this is astrophysics and touches on compact object mergers, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on GRB event rates and electromagnetic counterparts to GW events, which is tangential to the core interests.
...
## 49. [Controlling weak-lensing shear biases from undetected galaxies in the era of Stage IV Surveys](https://arxiv.org/abs/2512.00666) <a id="link49"></a>
...
**Comment:** This work quantifies weak-lensing shear biases from undetected faint galaxies in the context of large surveys. While it discusses the properties of faint galaxies, the focus is on lensing systematics and survey calibration rather than near-field cosmology, satellite luminosity functions, or resolved star formation histories. The connection to the core topics is weak.
...
## 50. [AI Agent for Source Finding by SoFiA-2 for SKA-SDC2](https://arxiv.org/abs/2512.00769) <a id="link50"></a>
...
**Comment:** Describes an AI agent for optimizing source finding in radio surveys, which is a technical/methodological paper for data analysis and does not address any of the core topics.
...
## 51. [Recoiling Black Hole Candidates from Spatially Offset Broad Emission Lines in MaNGA](https://arxiv.org/abs/2512.00174) <a id="link51"></a>
...
**Comment:** This paper identifies spatially offset broad emission line sources as recoiling black hole candidates in MaNGA. The focus is on black hole dynamics and AGN, not on galaxy-scale processes, star formation, or any of the core topics.
...
## 52. [An outflow from the X-ray corona as the origin of millimeter emission from radio-quiet AGN](https://arxiv.org/abs/2512.01662) <a id="link52"></a>
...
**Comment:** This work models millimeter emission from radio-quiet AGN, focusing on outflows from the X-ray corona near supermassive black holes. While it discusses outflows, these are AGN-driven and not star-formation-driven, and the focus is on AGN rather than galaxies or dwarfs.
...
## 53. [Machine Learning for Exoplanet Discovery: Validating TESS Candidates and Identifying Planets in the Habitable Zone](https://arxiv.org/abs/2512.00967) <a id="link53"></a>
...
**Comment:** This paper develops a machine learning framework for validating TESS exoplanet candidates and identifying planets in the habitable zone. It does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 54. [Deep Neural Network-Based High-Precision Identification of Weak Stability Boundary Structures](https://arxiv.org/abs/2512.00457) <a id="link54"></a>
...
**Comment:** This paper presents a deep neural network method for identifying weak stability boundary structures, which are relevant for orbital dynamics and low-energy transfers in celestial mechanics. There is no direct connection to any of the core topics such as galaxy simulations, star formation, or near-field cosmology.
...
## 55. [The chemical diversity of giant-planet nurseries as revealed by ALMA](https://arxiv.org/abs/2512.01731) <a id="link55"></a>
...
**Comment:** This paper focuses on chemical diversity in protoplanetary disks around young intermediate/high-mass stars, using ALMA observations. The main topic is disk chemistry and its implications for exoplanet formation, not dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No core criteria are matched.
...
## 56. [Green Bean galaxies and the fading echoes of AGN activity](https://arxiv.org/abs/2512.00793) <a id="link56"></a>
...
**Comment:** Studies Green Bean galaxies and AGN activity, focusing on ionized clouds in the circumgalactic medium. While it discusses the CGM, the context is AGN-driven feedback in massive galaxies, not dwarf galaxies or star-formation-driven outflows.
...
## 57. [Images of shadow and thin accretion disk around Bardeen black hole surrounded by perfect fluid dark matter](https://arxiv.org/abs/2512.00824) <a id="link57"></a>
...
**Comment:** Examines black hole shadows and accretion disks in the context of perfect fluid dark matter, but the focus is on black holes and not on galaxy-scale dark matter or any of the core topics such as satellite galaxies, star formation histories, or galaxy simulations.
...
## 58. [Probing ALP-photon couplings in Neutron Stars: Scalar versus pseudoscalar cases](https://arxiv.org/abs/2508.09141) <a id="link58"></a>
...
**Comment:** Focuses on axion-like particles in neutron stars, with some discussion of dark matter candidates, but does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 59. [Interstellar Ices as Carriers of Supernova Material to the Early Solar System](https://arxiv.org/abs/2512.00522) <a id="link59"></a>
...
**Comment:** Discusses the delivery of supernova material to the early Solar System via interstellar ices, focusing on nucleosynthetic isotope compositions in meteorites. This is planetary science and does not match any of the core topics.
...
## 60. [Quantum Recoherence in Presence of Excited States in the Early Universe](https://arxiv.org/abs/2512.01932) <a id="link60"></a>
...
**Comment:** Studies quantum recoherence in the early universe in the context of inflationary perturbations, which is cosmology but not near-field cosmology or any of the core topics.
...
## 61. [OzDES Reverberation Mapping Program: CIV lags from six years of data](https://arxiv.org/abs/2512.01260) <a id="link61"></a>

**ArXiv ID:** 2512.01260

**Authors:** A. Penton, H. McDougall, T. M. Davis, Z. Yu, U. Malik, P. Martini, B. E. Tucker, C. Lidman, G. F. Lewis, R. Sharp, M. Aguena, S. Allam, F. Andrade-Oliveira, J. Asorey, D. Bacon, S. Bocquet, D. Brooks, R. Camilleri, A. Carnero Rosell, D. Carollo, A. Carr, J. Carretero, T. Y. Cheng, L. N. da Costa, M. E. da Silva Pereira, J. De Vicente, S. Desai, S. Everett, J. Garc\'ia-Bellido, K. Glazebrook, D. Gruen, G. Gutierrez, S. R. Hinton, D. L. Hollowood, K. Honscheid, K. Kuehn, O. Lahav, S. Lee, M. March, J. L. Marshall, J. Mena-Fern\'andez, R. Miquel, J. Myles, R. L. C. Ogando, A. A. Plazas Malag\'on, A. Porredon, M. Rodriguez-Monroy, A. K. Romer, E. Sanchez, D. Sanchez Cid, M. Smith, E. Suchyta, M. E. C. Swanson, V. Vikram, N. Weaverdyck

**Abstract:** We present 29 successfully recovered CIV time lags in Active Galactic Nuclei from the complete Dark Energy Survey Reverberation Mapping campaign. The AGN in this sample span a redshift range of 1.9<3.5. We successfully measure the velocity dispersion from the CIV spectral linewidth for 25 of these 29 sources, and use these to calculate new high-redshift black hole mass estimates, finding masses between 0.8 and 1.3 billion solar masses. We also identify a selection effect due to the duration of the survey that can impact the radius-luminosity relation derived from this and other (high-redshift) data. This paper represents the culmination of the OzDES CIV campaign.

**Comment:** Presents CIV reverberation mapping results for AGN, focusing on black hole mass estimates and survey selection effects. This is AGN science and does not match any of the core topics.
...
## 62. [Magnetized Shocks Mediated by Radiation from Leptonic and Hadronic Processes](https://arxiv.org/abs/2512.00155) <a id="link62"></a>
...
**Comment:** The paper studies radiation-mediated shocks in astrophysical transients, focusing on particle acceleration and photon spectra. While it involves hydrodynamics and radiative transfer, it does not address galaxy-scale simulations, star formation, or any of the core topics.
...
## 63. [The jetted NLS1 1H 0323+342: the Rosetta stone for accretion/ejection in AGN](https://arxiv.org/abs/2512.01053) <a id="link63"></a>
...
**Comment:** This paper presents a reanalysis of X-ray observations of a jetted narrow-line Seyfert 1 galaxy, focusing on accretion/ejection processes in AGN. It does not address galaxy-scale processes, star formation, or any of the core topics.
...
## 64. [Weak, extended water vapor emission in the Horsehead nebula](https://arxiv.org/abs/2512.01901) <a id="link64"></a>
...
**Comment:** The study analyzes water vapor emission in the Horsehead nebula, focusing on PDR chemistry and radiative transfer. While interesting for ISM studies, it does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 66. [Pixel-Based Non-Linearity Correction for the WFC3 IR Detector](https://arxiv.org/abs/2512.01951) <a id="link66"></a>
...
**Comment:** This paper presents a new pixel-based non-linearity correction for the WFC3 IR detector, improving photometric calibration. While this is important for observational astronomy, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models.
...
## 67. [On extremal black holes](https://arxiv.org/abs/2512.01898) <a id="link67"></a>
...
**Comment:** This paper discusses the physical viability of extremal black holes, including mass bounds and instabilities. The focus is on black hole physics and not on galaxies, star formation, or near-field cosmology.
...
## 68. [Spatial Phonons: A Phenomenological Viscous Dark Energy Model for DESI](https://arxiv.org/abs/2512.00056) <a id="link68"></a>
...
**Comment:** The paper proposes a phenomenological viscous dark energy model for DESI, treating space as an elastic brane. This is a cosmology theory paper and does not address any of the core topics related to galaxies, star formation, or stellar models.
...
## 69. [The Astrometric Resoeccentric Degeneracy: Eccentric Single Planets Mimic 2:1 Resonant Planet Pairs in Astrometry](https://arxiv.org/abs/2512.02007) <a id="link69"></a>
...
**Comment:** This paper focuses on astrometric degeneracies in exoplanet detection, specifically how single eccentric planets can mimic resonant planet pairs. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 70. [A sudden fine-scale bright kernel captured by Hi-C Flare during an M1.6-class solar flare's post-maximum phase](https://arxiv.org/abs/2512.01140) <a id="link70"></a>
...
**Comment:** This paper reports on high-resolution observations of a solar flare kernel using the Hi-C Flare sounding rocket. The focus is on solar flare dynamics and magnetic reconnection in the Sun, which does not match any of the core topics such as galaxy simulations, dwarf galaxies, or star formation histories.
...
## 71. [Nonlinear Orbital Variations in Binary Radio Pulsars from Lense-Thirring Precession](https://arxiv.org/abs/2512.00963) <a id="link71"></a>
...
**Comment:** This paper investigates Lense-Thirring precession in binary radio pulsars and its implications for measuring the moment of inertia. The focus is on pulsar timing and relativistic effects in compact binaries, which does not match any of the core topics such as galaxy simulations, dwarf galaxies, or star formation histories.
...
## 72. [Bayesian inferences on covariant density functionals from multimessenger astrophysical data: The influences of parametrizations of density dependent couplings](https://arxiv.org/abs/2512.01503) <a id="link72"></a>
...
**Comment:** This work investigates covariant density functionals and their parametrizations for dense nuclear matter and compact stars, with a focus on neutron star matter. It does not address galaxy formation, dwarf galaxies, resolved star formation histories, or any of the other core topics.
...
## 73. [General-Relativistic Path Effects and the Local Hubble Expansion](https://arxiv.org/abs/2512.00067) <a id="link73"></a>
...
**Comment:** This paper develops a mapping for photon propagation and redshift drift in low-redshift cosmology, focusing on general-relativistic effects and the Hubble relation. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 74. [Intercepting Interstellar Objects](https://arxiv.org/abs/2512.00492) <a id="link74"></a>
...
**Comment:** Describes the concept for a future mission to intercept interstellar objects, based on the Comet Interceptor mission. This is not relevant to any of the specified criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 75. [No Love for black holes: tightest constraints on tidal Love numbers of black holes from GW250114](https://arxiv.org/abs/2512.01918) <a id="link75"></a>
...
**Comment:** This paper constrains tidal Love numbers of black holes using gravitational wave data. It is focused on black hole physics and fundamental tests of gravity, not on galaxy or stellar evolution, dwarf galaxies, or near-field cosmology.
...
## 76. [Data-driven Radiative Magnetohydrodynamics Simulations with the MURaM Code: the Emergence of Active Region 11158 and the X2.2 Flare](https://arxiv.org/abs/2512.01201) <a id="link76"></a>
...
**Comment:** This paper describes data-driven radiative MHD simulations of solar active regions and flares. While it is a numerical simulation, it is focused on solar physics, not on galaxy simulations or any of the core topics.
...
## 77. [A window for water-hydrogen demixing on warm metal-rich sub-Neptunes](https://arxiv.org/abs/2512.01805) <a id="link77"></a>
...
**Comment:** This paper models water-hydrogen demixing in sub-Neptunes, focusing on planetary interiors and atmospheres. It does not address any of the core topics related to galaxy evolution, dwarf galaxies, or star formation.
...
## 78. [Large/small eddy simulations: A posteriori analysis in high Reynolds number isotropic turbulence](https://arxiv.org/abs/2512.00554) <a id="link78"></a>
...
**Comment:** This paper presents a new simulation method for high Reynolds number isotropic turbulence, but it is focused on fluid dynamics and turbulence rather than galaxy simulations or any of the other core criteria. No direct relevance to galaxy simulations, star formation, or near-field cosmology.
...
## 79. [Particle Astrophysics with High and Ultrahigh Energy Neutrinos](https://arxiv.org/abs/2512.00660) <a id="link79"></a>
...
**Comment:** Reviews high and ultrahigh energy neutrino observations and their astrophysical sources. No direct connection to any of the core criteria (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 80. [Starspots and Flares are Generally Not Correlated](https://arxiv.org/abs/2512.01051) <a id="link80"></a>
...
**Comment:** Studies the correlation between starspots and flares on stars, which is related to stellar activity but does not match any of the core topics such as resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 81. [Identification of new Galactic symbiotic stars with SALT - II. New discoveries and characterization of the sample](https://arxiv.org/abs/2512.01744) <a id="link81"></a>
...
**Comment:** This paper focuses on the identification and characterization of new Galactic symbiotic stars. While it involves stellar populations and variability, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, or galaxy simulations. The focus is on binary systems rather than galaxy-scale processes.
...
## 82. [Quiet Skies Report: A Primer on Protecting Radio Astronomy in the Age of Satellite Mega-Constellations](https://arxiv.org/abs/2512.00941) <a id="link82"></a>
...
**Comment:** This is a primer on protecting radio astronomy from satellite interference. While relevant for radio astronomy infrastructure, it does not address any of the core topics.
...
## 83. [Spectroscopic and Decade-long Photometric Observations of the Contact Binary V2790 Ori: Evidence for a Brown Dwarf Companion and a Solar-like Magnetic Activity Cycle](https://arxiv.org/abs/2512.01584) <a id="link83"></a>
...
**Comment:** Presents observations and analysis of a contact binary system, including magnetic activity and evolutionary status. The work is focused on stellar evolution and binary star properties, not on galaxy-scale processes, resolved star formation histories, or near-field cosmology.
...
## 84. [Investigating Circumstellar Atomic Radiation-driven Dynamics](https://arxiv.org/abs/2512.01474) <a id="link84"></a>
...
**Comment:** This work investigates circumstellar atomic dynamics driven by radiation, with implications for exoplanet atmospheres and debris disks. It does not address any of the core topics.
...
## 85. [Impact of positrons on electrical conductivity of hot and dense astrophysical plasma](https://arxiv.org/abs/2512.01044) <a id="link85"></a>
...
**Comment:** The paper studies the impact of positrons on electrical conductivity in neutron star crusts and white dwarf interiors. While it is astrophysical, it does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 86. [Predicted white-light solar flare emission from the F-CHROMA grid of models](https://arxiv.org/abs/2512.01717) <a id="link86"></a>
...
**Comment:** This paper uses the F-CHROMA grid of flare simulations to study white-light emission in solar flares. It focuses on solar physics and stellar atmosphere modeling for the Sun, but does not present new general stellar models or evolutionary tracks. The work is not directly relevant to the core topics, as it does not address galaxy evolution, dwarf galaxies, or resolved star formation histories.
...
## 87. [Uniformly-calibrated VPHAS+ photometry in the third quadrant of the Galactic plane](https://arxiv.org/abs/2512.00650) <a id="link87"></a>
...
**Comment:** This paper presents a photometric survey of the southern Galactic plane, focusing on calibration and mapping of stellar populations and extinction. It does not address dwarf galaxies, resolved star formation histories, quenching, or galaxy simulations.
...
## 88. [Astrometric view of companions in the inner dust cavities of protoplanetary disks](https://arxiv.org/abs/2512.00157) <a id="link88"></a>
...
**Comment:** This paper uses Gaia astrometry to search for planetary and stellar companions in transition disks, focusing on protoplanetary disks and planet formation. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 89. [The SRG/eROSITA All-Sky Survey: A comprehensive X-ray analysis of the Hydra I galaxy cluster](https://arxiv.org/abs/2512.00518) <a id="link89"></a>
...
**Comment:** This paper presents a comprehensive X-ray analysis of the Hydra I galaxy cluster, focusing on the intracluster medium, shocks, and baryon accretion. It does not focus on dwarf galaxies, resolved star formation histories, or near-field cosmology, and is centered on a massive galaxy cluster.
...
## 90. [Real-time RFI Excision Techniques and Their Limitations](https://arxiv.org/abs/2512.01954) <a id="link90"></a>
...
**Comment:** This chapter reviews real-time radio frequency interference excision techniques for radio astronomy. It is focused on observational methodology and data quality, not on galaxy simulations, star formation, or near-field cosmology. No direct relevance to the specified criteria.
...
## 91. [Nested Sampling for ARIMA Model Selection in Astronomical Time-Series Analysis](https://arxiv.org/abs/2512.01929) <a id="link91"></a>
...
**Comment:** Presents a Bayesian method for ARIMA model selection in astronomical time series. No connection to any of the core criteria (galaxy evolution, star formation histories, near-field cosmology, etc.).
...
## 92. [Active chromospheric fibril singularity: Coordinated observations from Solar Orbiter, SST, and IRIS](https://arxiv.org/abs/2512.01886) <a id="link92"></a>
...
**Comment:** Focuses on solar chromospheric structures and magnetic fields, which do not match any of the specified criteria such as near-field cosmology, resolved star formation histories, or stellar models. No relevant keywords or topics.
...
## 93. [OzDES Reverberation Mapping of Active Galactic Nuclei: Final Data Release, Black-Hole Mass Results, & Scaling Relations](https://arxiv.org/abs/2512.01261) <a id="link93"></a>
...
**Comment:** Final data release and analysis of OzDES reverberation mapping for AGN black hole masses and scaling relations. Focuses on supermassive black holes and AGN, which are not relevant to the specified criteria.
...
## 94. [Probing the Scalar Hair of Rotating Horndeski Black Holes through Thick Disk Images](https://arxiv.org/abs/2512.00917) <a id="link94"></a>
...
**Comment:** This paper models accretion disk images around black holes in Horndeski gravity, focusing on scalar hair effects. It does not address galaxy-scale processes, star formation, or any of the core topics. The focus is on black hole physics and imaging.
...
## 95. [The 2023 Australian Total Solar Eclipse: Line Emission of Fe XIV, Fe X and Fe XI out to 6 solar radii](https://arxiv.org/abs/2512.01068) <a id="link95"></a>
...
**Comment:** This paper presents observations of coronal emission lines during a solar eclipse, probing electron temperatures and coronal heating. It does not address galaxy-scale processes, star formation, or any of the core topics.
...
## 97. [Velocity-space turbulent cascade in the near-Sun solar wind: first insights from the Parker Solar Probe mission](https://arxiv.org/abs/2512.01492) <a id="link97"></a>

**ArXiv ID:** 2512.01492

**Authors:** A. Larosa, O. Pezzi, T. Bowen, L. Sorriso-Valvo, N. Sioulas, F. Pucci, D. Trotta, J. L. Verniero, R. Livi, S. Bharati Das, A. Chasapis, D. Perrone, F. Valentini, S. Servidio

**Abstract:** In space plasmas, the rarity of collisions leads to complex structures in the velocity space where a turbulent cascade of the velocity distribution function fluctuations is thought to occur. Previous studies have explored this phenomenon using the Hermite decomposition of the ion velocity distribution function (VDF) in both magnetosheath data and numerical simulations. In this work, we investigate the Hermite spectrum of the ion VDFs measured by Parker Solar Probe in the inner heliosphere. We analyze a superalfv\'enic stream at a radial distances of $R \approx 28 R_{sun}$ and a subalfv\'enic at $R \approx 11 R_{sun}$, the former characterized by a prevalence of VDFs with suprathermal beams (also known as hammerhead). The Hermite analysis is also compared with various proxies of energization and dissipation, in order to establish a connection between turbulent cascades in real space and those in the velocity space. A qualitative agreement between the energization proxies and the Hermite analysis is observed. The results are suggestive of the presence of a dual cascade in real and velocity space.

**Comment:** This paper focuses on turbulent cascades in the solar wind near the Sun, which is not related to any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 98. [Generalization of Elliptical-Cylindrical Flux Rope Models for ICME Reconstruction](https://arxiv.org/abs/2512.01131) <a id="link98"></a>
...
**Comment:** The paper presents a new flux rope model for ICME reconstruction using Parker Solar Probe data. It is focused on solar/interplanetary physics and not on galaxy evolution, dwarf galaxies, or any of the core topics.
...
## 99. [Analysis of Angular-Differential Post-Processing Algorithms for Exoplanet Direct Detection with a Photonic Lantern Nuller](https://arxiv.org/abs/2512.00442) <a id="link99"></a>
...
**Comment:** The paper discusses post-processing algorithms for exoplanet direct detection with a photonic lantern nuller. It is focused on exoplanet detection techniques, not on galaxy evolution, dwarf galaxies, or any of the core topics.
...
## 100. [A First Order Filter for the Detection of Potentially Habitable Exoplanets](https://arxiv.org/abs/2512.00899) <a id="link100"></a>
...
**Comment:** The paper proposes a filter for detecting potentially habitable exoplanets based on orbital parameters. It is focused on exoplanet selection and habitability, not on galaxy evolution, dwarf galaxies, or any of the core topics.
...
## 101. [Revisiting wideband pulsar timing measurement](https://arxiv.org/abs/2512.01288) <a id="link101"></a>
...
**Comment:** Presents a new method for wideband pulsar timing measurements. The work is focused on pulsar timing techniques and does not address galaxy-scale processes, star formation histories, or near-field cosmology.
...
## 102. [Non-detection of FAST and Parkes follow-up observation for 27 Parkes discovered FRBs](https://arxiv.org/abs/2512.01281) <a id="link102"></a>
...
**Comment:** Reports non-detection of repeating FRBs in follow-up observations. The work is focused on FRB repetition rates and radio transient populations, not on galaxy-scale processes, star formation histories, or near-field cosmology.
...
## 103. [Tidal disruption and evaporation of rubble-pile and monolithic bodies as a source of flaring activity in Sgr A^\star$](https://arxiv.org/abs/2512.00808) <a id="link103"></a>
...
**Comment:** The paper models tidal disruption and evaporation of small bodies as a source of flaring activity in Sgr A*, the Galactic center. The focus is on the Galactic center and SMBH, which is explicitly listed as irrelevant.
...
## 104. [Resolving Interchange Reconnection Dynamics in a Fan-Spine-like Topology Observed by Solar Orbiter](https://arxiv.org/abs/2512.01209) <a id="link104"></a>
...
**Comment:** This work analyzes interchange reconnection dynamics in the solar corona using Solar Orbiter data. It is focused on solar physics and magnetic reconnection, not on any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 105. [Inferring planet occurrence rates from radial velocities](https://arxiv.org/abs/2512.01804) <a id="link105"></a>
...
**Comment:** This paper focuses on planet occurrence rates from radial velocity data, which is not related to any of the core topics (near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 106. [Enhanced detection limits in the SHINE F150 survey through the Regime Switching Model Optimizing thresholds and investigating environmental noise](https://arxiv.org/abs/2512.01511) <a id="link106"></a>
...
**Comment:** This paper presents a new detection algorithm for high-contrast imaging in the search for exoplanets, focusing on improving detection limits and noise analysis. It does not match any of the core criteria related to galaxies, star formation, or near-field cosmology.
...
## 107. [Interferometry of Massive Stars: Multiplicity, Magnetism, and Stellar Winds](https://arxiv.org/abs/2512.00444) <a id="link107"></a>
...
**Comment:** This is a review of interferometric studies of massive stars, focusing on multiplicity, magnetism, and stellar winds. It does not present new stellar models or address galaxy-scale processes, star formation, or any of the core topics.
...
## 108. [A robust empirical relationship between speed and turbulence energy in the near-Earth solar wind](https://arxiv.org/abs/2512.00983) <a id="link108"></a>
...
**Comment:** Establishes an empirical law relating speed and turbulence energy in the near-Earth solar wind. No connection to galaxy evolution, star formation, or any of the core criteria.
...
## 109. [Possible quasi-periodic optical oscillations of ZTF blazars](https://arxiv.org/abs/2512.00871) <a id="link109"></a>
...
**Comment:** Studies quasi-periodic oscillations in blazars using optical light curves. Blazars and AGN variability are not relevant to the specified criteria, and there is no connection to dwarf galaxies, star formation histories, or galaxy simulations.
...
## 111. [Broadband Spectral Analysis of 1ES2344+514: A Multi-epoch study](https://arxiv.org/abs/2512.00750) <a id="link111"></a>
...
**Comment:** Broadband spectral analysis of a BL Lac object, focusing on multi-epoch variability and SED modeling. BL Lacs and AGN variability are not relevant to the specified criteria.
...
## 112. [The impact of Solar magnetic field configurations on the production of gamma rays at the Solar disk](https://arxiv.org/abs/2512.01403) <a id="link112"></a>
...
**Comment:** This paper models gamma-ray and neutrino production from cosmic ray interactions in the solar atmosphere, focusing on the role of the solar magnetic field. It does not address galaxy-scale processes, star formation, or any of the core topics.
...
## 113. [X-CME: From In Situ Flux-Rope Reconstruction to CME Propagation Forecasting](https://arxiv.org/abs/2512.01561) <a id="link113"></a>
...
**Comment:** Focuses on forecasting CME arrival times using in situ flux-rope reconstructions and propagation models. The topic is solar physics and space weather, not related to galaxy-scale processes, star formation histories, or near-field cosmology.
...
## 114. [Variable X-ray Emission of the Planet Hosting T Tauri Star CI Tau](https://arxiv.org/abs/2512.00246) <a id="link114"></a>
...
**Comment:** Reports on X-ray variability of a planet-hosting T Tauri star. The work is focused on stellar activity and planet-star interactions, not on galaxy-scale processes, star formation histories, or near-field cosmology.
...
## 115. [Evolution of Flare Ribbon Bead-like Structures in a Solar Flare](https://arxiv.org/abs/2512.00710) <a id="link115"></a>
...
**Comment:** The paper studies small-scale structures in solar flare ribbons using high-resolution imaging. This is focused on solar physics and does not match any of the core criteria.
...
## 117. [Euclid Structural-Thermal-Optical Performance](https://arxiv.org/abs/2512.01075) <a id="link117"></a>
...
**Comment:** This paper is focused on the technical performance of the Euclid telescope, specifically image quality and PSF stability for weak lensing cosmology. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 118. [Astro-Animation -- How Artists and Scientists Envision the Universe](https://arxiv.org/abs/2512.00535) <a id="link118"></a>
...
**Comment:** Describes an outreach program combining animation and astronomy for STEAM education. The work is not scientific research on galaxies, star formation, or near-field cosmology.
...
## 119. [Surveys on the Existence of Extraterrestrial Intelligent Life and Effects of Revealing Expert Consensus](https://arxiv.org/abs/2512.00364) <a id="link119"></a>
...
**Comment:** The paper surveys beliefs about extraterrestrial intelligent life and the effects of revealing expert consensus. This is a sociological/astrobiology study and not relevant to the core astrophysical topics.
...
## 120. [Search for Peak Structures in the Stochastic Gravitational-Wave Background in LIGO-Virgo-KAGRA O1-O4a Datasets](https://arxiv.org/abs/2512.01776) <a id="link120"></a>
...
**Comment:** This paper presents a search for peak structures in the stochastic gravitational-wave background using LIGO-Virgo-KAGRA data. It is focused on gravitational wave cosmology and early-Universe models, which do not match any of the specified criteria.
...
## 121. [Letelier black hole immersed in an electromagnetic universe](https://arxiv.org/abs/2512.00102) <a id="link121"></a>
...
**Comment:** This paper investigates a black hole solution surrounded by a cloud of strings and immersed in an electromagnetic universe, focusing on black hole properties and lensing. It does not match any of the core criteria related to galaxies, star formation, or near-field cosmology.
...
## 122. [XRISM Observations of Accretion Disk Corona in Cyg X-2](https://arxiv.org/abs/2512.00589) <a id="link122"></a>
...
**Comment:** This paper presents XRISM observations of the accretion disk corona in Cyg X-2, focusing on X-ray emission lines and outflows in an X-ray binary. It does not match any of the core criteria related to galaxies, star formation, or near-field cosmology.
...
## 123. [Comment on 'Color astrophotography with a 100 mm-diameter f/2 polymer flat lens', Appl. Phys. Lett. 126, 051701 (2025)](https://arxiv.org/abs/2512.00054) <a id="link123"></a>
...
**Comment:** This is a comment on the technical performance of a polymer flat lens for astrophotography, which is not related to any of the core topics.
