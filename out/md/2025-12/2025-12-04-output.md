...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 57353    | 8576         | 65929   |
| **Cost**             | $0.11    | $0.07        | $0.18   |

Total arXiv papers: 185

Total scanned papers: 129

Total relevant papers: 102

**Table of contents with paper titles:**

1. [On the Origin of Gas-stripping of Galaxies in Group Environments](#user-content-link1)
**Authors:** Jinsu Rhee, Christophe Pichon, Yohan Dubois, Sukyoung K. Yi, Jongwan Ko, Yun-Kyeong Sheen, San Han, Seyoung Jeon, J. K. Jang, Wonki Lee, Emanuele Contini, Bumhyun Lee, Jaehyun Lee, Katarina Kraljic, S\'ebastien Peirani

2. [The DREAMS Project: Disentangling the Impact of Halo-to-Halo Variance and Baryonic Feedback on Milky Way Dark Matter Density Profiles](#user-content-link2)
**Authors:** Alex M. Garcia, Jonah C. Rose, Paul Torrey, Andrea Caputo, Mariangela Lisanti, Andrew B. Pace, Hongwan Liu, Abdelaziz Hussein, Haozhe Liu, Francisco Villaescusa-Navarro, John Barry, Ilem Leisher, Bel\'en Costanza, Jonathan Kho, Ethan Lilie, Jiaxuan Li, Niusha Ahvazi, Aklant Bhowmick, Tri Nguyen, Stephanie O'Neil, Xiaowei Ou, Xuejian Shen, Arya Farahi, Nitya Kallivayalil, Lina Necib, Mark Vogelsberger

3. [JWST Captures Growth of Aromatic Hydrocarbon Dust Particles in the Extremely Metal-poor Galaxy Sextans A](#user-content-link3)
**Authors:** Elizabeth J. Tarantino, Julia Roman-Duval, Karin M. Sandstrom, J. -D. T. Smith, Cory M. Whitcomb, Bruce T. Draine, Martha L. Boyer, J\'er\'emy Chastenet, Ryan Chown, Christopher J. R. Clark, Karl D. Gordon, Brandon S. Hensley, Thomas S. -Y. Lai, Christina W. Lindberg, Kristen B. W. McQuinn, Max J. B. Newman, O. Grace Telford, Dries Van De Putte, Benjamin F. Williams

4. [An Ancient Descendant of the First Galaxies](#user-content-link4)
**Authors:** Jacqueline Antwi-Danso, Adam Muzzin, Luke Robbins, Yoshihisa Asada, Danilo Marchesini, Marcin Sawicki, Kartheik Iyer, Kate Whitaker, Joshua Speagle, Casey Papovich, Chris Willott, Maru\v{s}a Brada\v{c}, Guillaume Desprez, Vladan Markov, Nicholas Martis, Ga\"el Noirot, Ghassan Sarrouh, Rahul Kannan, Roberto Abraham, Seiji Fujimoto, Katherine Myers

5. [The effect of baryons on the positions and velocities of satellite galaxies in the MTNG simulation](#user-content-link5)
**Authors:** Sergio Contreras, Raul E. Angulo, Sownak Bose, Boryana Hadzhiyska, Lars Hernquist, Francisco Maion, Ruediger Pakmor, Volker Springel

6. [Taming the Tarantula: How Stellar Wind Feedback Shapes Gas and Dust in 30 Doradus](#user-content-link6)
...
7. [Push-broom Mapping of Galaxies and Supernova Remnants with the SPRITE CubeSat](#user-content-link7)
...
8. [Separating halo and disk stars in galaxies with Fuzzy Set Theory](#user-content-link8)
**Authors:** Amit Mondal, Biswajit Pandey

9. [The Mass-Metallicity Relation and its Observational Effects at z~3-6](#user-content-link9)
...
10. [The DESI DR1 Peculiar Velocity Survey: The Tully-Fisher Distance Catalog](#user-content-link10)
...
11. [On distance and velocity estimation in cosmology](#user-content-link11)
**Authors:** Adi Nusser

12. [The DESI DR1 Peculiar Velocity Survey: Mock Catalog](#user-content-link12)
**Authors:** J. Bautista, A. J. Amsellem, V. Aronica, S. BenZvi, C. Blake, A. Carr, T. M. Davis, K. Douglass, T. Dumerchat, C. Howlett, Y. Lai, A. Nguyen, A. Palmese, F. Qin, C. Ravoux, C. Ross, K. Said, R. J. Turner, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, P. Doel, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, H. K. Herrera-Alcantar, K. Honscheid, D. Huterer, M. Ishak, R. Joyce, A. Kremin, C. Lamman, M. Landriau, L. Le Guillou, A. Leauthaud, M. Manera, A. Meisner, R. Miquel, J. Moustakas, A. Mu\~noz-Guti\'errez, S. Nadathur, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, M. Schubnell, H. Seo, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver, P. Zarrouk, R. Zhou, H. Zou

13. [Tracing the Cosmic Evolution of the Cool Circumgalactic Medium of Luminous Red Galaxies with DESI Year 1 Data](#user-content-link13)
...
14. [A Wind-Driven Origin for the Firework Morphology of the Supernova Remnant Pa 30](#user-content-link14)
**Authors:** Eric R. Coughlin, Greg Salvesen, Dheeraj R. Pasham

15. [The Nuclear Star Cluster of M 74: a fossil record of the very early stages of a star-forming galaxy](#user-content-link15)
**Authors:** Francesca Pinna (Instituto de Astrof\'isica de Canarias, Departamento de Astrof\'isica, Universidad de La Laguna, Max-Planck-Institut f\"ur Astronomie), Nils Hoyer (Max-Planck-Institut f\"ur Astronomie), Jairo M\'endez Abreu (Departamento de Astrof\'isica, Universidad de La Laguna, Instituto de Astrof\'isica de Canarias), Adriana de Lorenzo C\'aceres Rodriguez (Departamento de Astrof\'isica, Universidad de La Laguna, Instituto de Astrof\'isica de Canarias), Nadine Neumayer (Max-Planck-Institut f\"ur Astronomie), M\'ed\'eric Boquien (Universit\'e C\^ote d Azur, Observatoire de la C\^ote d Azur, CNRS), Salvador Cardona Barrero (Departamento de Astrof\'isica, Universidad de La Laguna, Instituto de Astrof\'isica de Canarias), Daniel A. Dale (Department of Physics and Astronomy, University of Wyoming), Ivan S. Gerasimov (Universit\'e C\^ote d Azur, Observatoire de la C\^ote d Azur, CNRS), Kathryn Grasha (Research School of Astronomy and Astrophysics, Australian National University), Ralf S. Klessen (Universit\"at Heidelberg, Zentrum f\"ur Astronomie, Institut f\"ur Theoretische Astrophysik, Universit\"at Heidelberg, Interdisziplin\"ares Zentrum f\"ur Wissenschaftliches Rechnen), Carlos Marrero de la Rosa (Departamento de Astrof\'isica, Universidad de La Laguna, Instituto de Astrof\'isica de Canarias), Miguel Querejeta (Observatorio Astron\'omico Nacional), Thomas G. Williams (UK ALMA Regional Centre Node, Jodrell Bank Centre for Astrophysics, Department of Physics and Astronomy, The University of Manchester), Smita Mathur (Astronomy Department, The Ohio State University, Center for Cosmology and Astro-Particle Physics, The Ohio State University), Eva Schinnerer (Max-Planck-Institut f\"ur Astronomie)

16. [Modeling of Rayleigh Scattering and Interstellar Polarization for Evolved Late-Type Stars](#user-content-link16)
**Authors:** R Ignace, C Erba, K DeGennaro, G Henson

17. [A Thermal Relic Encyclopedia: Dark Matter Candidates Coupled to Quarks](#user-content-link17)
**Authors:** Dan Hooper, Gordan Krnjaic, Tanner Trickle, Isaac R. Wang

18. [Voyager 1 Data Reveals Signatures of the Local Gas and Cosmic-Ray Source Distributions](#user-content-link18)
**Authors:** Troy A. Porter, Igor V. Moskalenko, Alan C. Cummings, Gu{\dh}laugur J\'ohannesson

19. [BEC vortices as an observational signature of ultra-light bosonic dark matter](#user-content-link19)
**Authors:** Rongzi Zhou, Dylan M. H. Leung, Jason S. C. Poon, Ming-Chung Chu

20. [The DESI DR1 Peculiar Velocity Survey: global zero-point and $H_0$ constraints](#user-content-link20)
**Authors:** A. Carr, C. Howlett, A. J. Amsellem, Tamara M. Davis, K. Said, D. Parkinson, A. Palmese, J. Aguilar, S. Ahlen, J. Bautista, S. BenZvi, D. Bianchi, C. Blake, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, P. Doel, K. Douglass, S. Ferraro, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, H. K. Herrera-Alcantar, K. Honscheid, D. Huterer, M. Ishak, R. Joyce, A. G. Kim, D. Kirkby, A. Kremin, O. Lahav, C. Lamman, M. Landriau, L. Le Guillou, M. E. Levi, M. Manera, A. Meisner, R. Miquel, J. Moustakas, S. Nadathur, W. J. Percival, F. Prada, I. P\'erez-R\`afols, F. Qin, C. Ross, G. Rossi, E. Sanchez, D. Schlegel, H. Seo, D. Sprayberry, G. Tarl\'e, R. J. Turner, B. A. Weaver, P. Zarrouk, R. Zhou, H. Zou

21. [The Nature of Nitrogen Enhanced High Redshift Galaxies](#user-content-link21)
**Authors:** Peixin Zhu, James Trussler, Lisa J. Kewley

22. [Joint JWST-DECam Lensing Reveals That the Bullet Cluster Is a Minor Merger](#user-content-link22)
**Authors:** Boseong Young Cho, M. James Jee, Hyungjin Joo, Sangjun Cha, Kim HyeongHan

23. [The impact of our peculiar motion on primordial non-Gaussianity measurements using the LIGER4GAL framework](#user-content-link23)
**Authors:** Bartolomeo Bottazzi Baldi, Mohamed Yousry Elkhashab, Daniele Bertacca, Cristiano Porciani

24. [(Re)solving the complex multi-scale morphology and V-shaped SED of a newly discovered strongly-lensed Little Red Dot in Abell 383](#user-content-link24)
**Authors:** Josephine F. W. Baggen, Pieter van Dokkum, Ivo Labb\'e, Gabriel Brammer

25. [X TrA through the eyes of MATISSE: More evidence of clumpy molecular layers around C-type asymptotic giant branch stars](#user-content-link25)
**Authors:** V. R\u{a}st\u{a}u, C. Paladini, J. Drevon, J. Hron, F. Kerschbaum, M. Wittkowski, J. P. Fonfria, M. Montarg\`es, T. Khouri, W. Vlemmings, H. Olofsson, K. Ohnaka, J. Alonso-Hernandez, C. S\'anchez Contreras, L. Velilla-Prieto, W. C. Danchi, G. Rau, F. Lykou, J. Sanchez-Bermudez, B. Lopez, S. H\"ofner, B. Aringer, L. Planquart, P. Cruzal\`ebes, G. Weigelt

26. [Forecasts for lifetime and fraction of Decaying Dark Matter based on redshift distortions from Euclid and BOSS](#user-content-link26)
**Authors:** Javier Ju\'arez-Jim\'enez, Ana A. Avilez-L\'opez

27. [Astrophysical Reaction Rates for Charged-Particle Induced Reactions on Proton-Rich Nuclides](#user-content-link27)
**Authors:** Thomas Rauscher

28. [Magnetic activity on the young Sun: a case study of EK Draconis](#user-content-link28)
**Authors:** A. G\"orgei, L. Kriskovics, K. Vida, B. Seli, K. Ol\'ah, P. S\'agi, A. B\'odi, S. P. J\"arvinen, K. G. Strassmeier, A. P\'al, Zs. K\H{o}v\'ari

29. [Radio Detection of a Local Little Red Dot](#user-content-link29)
**Authors:** L. F. Rodriguez, I. F. Mirabel

30. [Modeling Binary Lenses and Sources with the BAGLE Python Package](#user-content-link30)
**Authors:** T. Dex Bhadra, J. R. Lu, Natasha S. Abrams, Andrew Scharf, Edward Broadberry, Casey Lam, Macy J. Huston

31. [From scalar clouds around evaporating black holes to boson star](#user-content-link31)
**Authors:** Daniel Neves, Jo\~ao G. Rosa

32. [Genetic Algorithm for Inferring Model Parameters for Flux Transport Dynamo Simulation](#user-content-link32)
**Authors:** Yuya Shimizu, Hideyuki Hotta

33. [Improving Accretion Diagnostics for Young Stellar Objects with Mid-infrared Hydrogen lines from JWST/MIRI](#user-content-link33)
**Authors:** B Shridharan (TIFR, Mumbai), P Manoj (TIFR, Mumbai), Vinod Chandra Pathak (TIFR, Mumbai), Alessio Caratti O Garatti (INAF, Naples), Bihan Banerjee (TIFR, Mumbai), Th. Henning (MPIA, Heidelberg), I. Kamp (Kapetyn Astronomical Institute, Groningen), E. van Dischoeck (Leiden Observatory, Leiden, MPIE, Garching), H. Tyagi (TIFR, Mumbai), R. Arun (IIA, Bangalore, CHRIST University, Bangalore), B. Mathew (CHRIST University, Bangalore), M. G\"udel (ETH Zurich, Zurich, Universit\'e Paris-Saclay, France), P. -O. Lagage

34. [Comparison of Ne-22 core and shell distilled WD detonations in AREPO](#user-content-link34)
**Authors:** Uri Pierre Burmester, Lilia Ferrario, Ivo R. Seitenzahl, Simon Blouin

35. [Multimessenger Constraints on Supermassive Dark Stars and Their Black Hole Remnants](#user-content-link35)
**Authors:** Marco Manno, Thomas Schwemberger, Volodymyr Takhistov

36. [The DESI DR1 Peculiar Velocity Survey: Fundamental Plane Catalogue](#user-content-link36)
**Authors:** C. E. Ross, C. Howlett, J. R. Lucey, K. Said, T. M. Davis, J. Aguilar, S. Ahlen, A. J. Amsellem, J. Bautista, S. BenZvi, D. Bianchi, C. Blake, D. Brooks, A. Carr, T. Claybaugh, A. Cuceu, A. de la Macorra, B. Dey, P. Doel, K. Douglass, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, J. Guy, K. Honscheid, D. Huterer, M. Ishak, R. Joyce, A. G. Kim, A. Kremin, O. Lahav, C. Lamman, M. Landriau, L. Le Guillou, A. Leauthaud, M. E. Levi, P. Martini, A. Meisner, R. Miquel, J. Moustakas, A. Mu\ noz-Guti\'errez, S. Nadathur, N. Palanque-Delabrouille, W. J. Percival, C. Poppett, F. Prada, I. P\'erez-R\`afols, F. Qin, G. Rossi, E. Sanchez, D. Schlegel, M. Schubnell, D. Sprayberry, G. Tarl\'e, R. J. Turner, B. A. Weaver, R. Zhou, H. Zou

37. [Hydrogen-Rich to Stripped-Envelope:Observational Continuity and Biases in CCSNe](#user-content-link37)
**Authors:** Anjasha Gangopadhyay, Priscila J. Pessi

38. [Approximations and modifications of celestial dynamics tested on the three-body system](#user-content-link38)
**Authors:** S{\o}ren Toxvaerd

39. [A three-dimensional model for the reversal in the local large-scale interstellar magnetic field](#user-content-link39)
**Authors:** Rebecca A. Booth, Anna Ordog, Jo-Anne Brown, T. L. Landecker, Alex S. Hill, Jennifer L. West, Minjie Lei, S. E. Clark, Andrea Bracco, John M. Dickey, Ettore Carretti

40. [GRB 230204B: GIT Discovery of a Fast Fading Afterglow Associated with an Energetic GRB from a Massive-Star Progenitor](#user-content-link40)
...
41. [The DESI DR1 Peculiar Velocity Survey: growth rate measurements from galaxy and momentum correlation functions](#user-content-link41)
**Authors:** R. J. Turner, C. Blake, F. Qin, J. Aguilar, S. Ahlen, A. J. Amsellem, J. Bautista, S. BenZvi, D. Bianchi, D. Brooks, A. Carr, E. Chaussidon, T. Claybaugh, A. Cuceu, A. de la Macorra, P. Doel, K. Douglass, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, J. Guy, H. K. Herrera-Alcantar, K. Honscheid, C. Howlett, D. Huterer, M. Ishak, R. Joyce, R. Kehoe, A. G. Kim, D. Kirkby, A. Kremin, O. Lahav, Y. Lai, C. Lamman, M. Landriau, L. Le Guillou, A. Leauthaud, M. E. Levi, M. Manera, A. Meisner, R. Miquel, J. Moustakas, A. Mu\~noz-Guti\'errez, S. Nadathur, N. Palanque-Delabrouille, W. J. Percival, C. Poppett, F. Prada, I. P\'erez-R\`afols, C. Ross, G. Rossi, K. Said, E. Sanchez, D. Schlegel, M. Schubnell, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver, P. Zarrouk, H. Zou

42. [A Catalogue of Interstellar Material Delivery From Nearby Debris Disks](#user-content-link42)
**Authors:** Cole R. Gregg, Paul A. Wiegert

43. [Infrared emission from $z \sim 6.5$ quasar host galaxies: a direct estimate of dust physical properties](#user-content-link43)
**Authors:** M. Costa, R. Decarli, F. Pozzi, P. Cox, R. A. Meyer, A. Pensabene, B. P. Venemans, F. Walter, F. Xu

44. [High-angular-resolution ALMA imaging of the inhomogeneous dynamical atmosphere of the asymptotic giant branch star W Hya](#user-content-link44)
**Authors:** K. Ohnaka, K. T. Wong, G. Weigelt, K. -H. Hofmann

45. [Subgrid Mean-field Dynamo Model with Dynamical Quenching in General Relativistic Magnetohydrodynamic Simulations](#user-content-link45)
**Authors:** Hongzhe Zhou, Yosuke Mizuno, Zhenyu Zhu

46. [Line Polarization of Si II $\lambda$6355 \AA\ in Type Ia Supernovae: A New Statistical Approach to Probe the Explosion Physics and Diversity](#user-content-link46)
...
47. [A theory-agnostic hierarchical Bayesian framework for black-hole spectroscopy: a case study on GW250114 in Einstein-dilaton-Gauss-Bonnet gravity](#user-content-link47)
**Authors:** Shitong Guo, Yan-Gang Miao

48. [Conformal Holographic Dark Energy](#user-content-link48)
**Authors:** Mario A. Rodr\'iguez-Meza, Jorge L. Cervantes-Cota, Tonatiuh Matos

49. [Resolving the Multiple Component Outflows in PG 1211+143: I. The Fe-K Absorption Structure and UFO Forest](#user-content-link49)
**Authors:** Misaki Mizumoto, James N. Reeves, Valentina Braito, Ehud Behar, Chris Done, Kouichi Hagino, Steven B. Kraemer, Gabriele A. Matzeu, Hirofumi Noda, Mariko Nomura, Shoji Ogawa, Ken Ohsuga, Atsushi Tanimoto, Tracey J. Turner, Yoshihiro Ueda, Satoshi Yamada, Sreeparna Ganguly, Paolo Somenzi

50. [TDCOSMO. XXIV. Measurement of the Hubble constant from the doubly lensed quasar HE1104-1805](#user-content-link50)
**Authors:** Eric Paic, Fr\'ed\'eric Courbin, Christopher D. Fassnacht, Aymeric Galan, Martin Millon, Dominique Sluse, Devon M. Williams, Simon Birrer, Elizabeth J. Buckley-Geer, Michele Cappellari, Fr\'ed\'eric Dux, Xiang-Yu Huang, Shawn Knabel, Cameron Lemon, Anowar J. Shajib, Sherry H. Suyu, Tommaso~Treu, Kenneth C. Wong, Lise Christensen, Veronica Motta, Alessandro Sonnenfeld

51. [The DESI DR1 Peculiar Velocity Survey: Growth Rate Measurements from the Galaxy Power Spectrum](#user-content-link51)
**Authors:** F. Qin, C. Blake, C. Howlett, R. J. Turner, K. Lodha, J. Bautista, Y. Lai, A. J. Amsellem, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, S. BenZvi, A. Carr, E. Chaussidon, T. Claybaugh, A. Cuceu, A. de la Macorra, K. Douglass, P. Doel, S. Ferraro, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, J. Guy, H. K. Herrera-Alcantar, K. Honscheid, D. Huterer, M. Ishak, R. Joyce, A. G. Kim, D. Kirkby, T. Kisner, A. Kremin, O. Lahav, C. Lamman, M. Landriau, L. Le Guillou, M. E. Levi, M. Manera, A. Meisner, R. Miquel, J. Moustakas, A. Mu\~noz-Guti\'errez, S. Nadathur, N. Palanque-Delabrouille, W. J. Percival, C. Poppett, F. Prada, I. Perez-Rafols, C. Ross, G. Rossi, E. Sanchez, D. Schlegel, K. Said, M. Schubnell, H. Seo, J. Silber, D. Sprayberry, G. Tarle, B. A. Weaver, P. Zarrouk, R. Zhou, H. Zou

52. [Building a Radio AGN Sample from Cosmic Morning -- The Radio High-Redshift Quasar Catalog (RHzQCat): I. Catalog from SDSS Quasars and Radio Surveys at $z > 3$](#user-content-link52)
**Authors:** Yingkang Zhang, Ruqiu Lin, Krisztina Perger, S\'andor Frey, Tao An, Xiang Ji, Qiqi Wu, Shilong Liao

53. [Probing for primordial black hole candidates in exoplanet search data](#user-content-link53)
**Authors:** Paul Halpern, Erik Cauley, Max Stoltzmann, Mauritz Wilshusen

54. [The BAGLE Python Package for Bayesian Analysis of Gravitational Lensing Events](#user-content-link54)
**Authors:** J. R. Lu, M. Medford, C. Y. Lam, T. D. Bhadra, M. J. Huston, N. S. Abrams, E. Broadberry, J. Chen, S. K. Terry, N. Arredondo, A. Scharf

55. [New Method for Investigating the Presence of Extragalactic Magnetic Fields](#user-content-link55)
**Authors:** Boris Stern, Igor Tkachev

56. [Long-term calibration and validation of stability of the Auger Engineering Radio Array using the diffuse Galactic radio emission](#user-content-link56)
**Authors:** The Pierre Auger Collaboration, A. Abdul Halim, P. Abreu, M. Aglietta, I. Allekotte, K. Almeida Cheminant, R. Aloisio, J. Alvarez-Mu\~niz, A. Ambrosone, J. Ammerman Yebra, L. Anchordoqui, B. Andrada, L. Andrade Dourado, L. Apollonio, C. Aramo, E. Arnone, J. C. Arteaga Vel\'azquez, P. Assis, G. Avila, E. Avocone, A. Bakalova, Y. Balibrea, A. Baluta, F. Barbato, A. Bartz Mocellin, J. P. Behler, C. Berat, M. E. Bertaina, M. Bianciotto, P. L. Biermann, V. Binet, K. Bismark, T. Bister, J. Biteau, J. Blazek, J. Bl\"umer, M. Boh\'a\v{c}ov\'a, D. Boncioli, C. Bonifazi, N. Borodai, J. Brack, P. G. Brichetto Orquera, A. Bueno, S. Buitink, M. B\"usken, A. Bwembya, K. S. Caballero-Mora, S. Cabana-Freire, L. Caccianiga, J. Cara\c{c}a-Valente, R. Caruso, A. Castellina, F. Catalani, G. Cataldi, L. Cazon, M. Cerda, B. \v{C}erm\'akov\'a, A. Cermenati, K. Cerny, J. A. Chinellato, J. Chudoba, L. Chytka, R. W. Clay, A. C. Cobos Cerutti, R. Colalillo, R. Concei\c{c}\~ao, G. Consolati, M. Conte, F. Convenga, D. Correia dos Santos, P. J. Costa, C. E. Covault, M. Cristinziani, C. S. Cruz Sanchez, S. Dasso, K. Daumiller, B. R. Dawson, R. M. de Almeida, E. -T. de Boone, B. de Errico, J. de Jes\'us, S. J. de Jong, J. R. T. de Mello Neto, I. De Mitri, D. de Oliveira Franco, F. de Palma, V. de Souza, E. De Vito, A. Del Popolo, O. Deligny, N. Denner, K. Denner Syrokvas, L. Deval, A. di Matteo, C. Dobrigkeit, J. C. D'Olivo, L. M. Domingues Mendes, Y. Dominguez Ballesteros, Q. Dorosti, R. C. dos Anjos, J. Ebr, F. Ellwanger, R. Engel, I. Epicoco, M. Erdmann, A. Etchegoyen, C. Evoli, H. Falcke, G. Farrar, A. C. Fauth, T. Fehler, F. Feldbusch, A. Fernandes, M. Fern\'andez Alonso, B. Fick, J. M. Figueira, P. Filip, A. Filip\v{c}i\v{c}, T. Fitoussi, B. Flaggs, A. Franco, M. Freitas, T. Fujii, A. Fuster, C. Galea, B. Garc\'ia, C. Gaudu, P. L. Ghia, U. Giaccari, C. Glaser, F. Gobbi, F. Gollan, G. Golup, P. F. G\'omez Vitale, J. P. Gongora, J. M. Gonz\'alez, N. Gonz\'alez, D. G\'ora, A. Gorgi, M. Gottowik, F. Guarino, G. P. Guedes, Y. C. Guerra, L. G\"ulzow, S. Hahn, P. Hamal, M. R. Hampel, P. Hansen, V. M. Harvey, A. Haungs, T. Hebbeker, C. Hojvat, J. R. H\"orandel, P. Horvath, M. Hrabovsk\'y, T. Huege, A. Insolia, P. G. Isar, M. Ismaiel, P. Janecek, V. Jilek, K. -H. Kampert, B. Keilhauer, A. Khakurdikar, V. V. Kizakke Covilakam, H. O. Klages, M. Kleifges, J. K\"ohler, F. Krieger, M. Kubatova, N. Kunka, B. L. Lago, N. Langner, N. Leal, M. A. Leigui de Oliveira, Y. Lema-Capeans, A. Letessier-Selvon, I. Lhenry-Yvon, L. Lopes, J. P. Lundquist, M. Mallamaci, S. Mancuso, D. Mandat, P. Mantsch, A. G. Mariazzi, I. C. Mari\c{s}, G. Marsella, D. Martello, S. Martinelli, O. Mart\'inez Bravo, M. A. Martins, H. -J. Mathes, J. Matthews, G. Matthiae, E. Mayotte, S. Mayotte, P. O. Mazur, G. Medina-Tanco, J. Meinert, D. Melo, A. Menshikov, C. Merx, S. Michal, M. I. Micheletti, L. Miramonti, M. Mogarkar, S. Mollerach, F. Montanet, L. Morejon, K. Mulrey, R. Mussa, W. M. Namasaka, S. Negi, L. Nellen, K. Nguyen, G. Nicora, M. Niechciol, D. Nitz, D. Nosek, A. Novikov, V. Novotny, L. No\v{z}ka, A. Nucita, L. A. N\'u\~nez, S. E. Nuza, J. Ochoa, M. Olegario, C. Oliveira, L. \"Ostman, M. Palatka, J. Pallotta, S. Panja, G. Parente, T. Paulsen, J. Pawlowsky, M. Pech, J. P\k{e}kala, R. Pelayo, V. Pelgrims, E. E. Pereira Martins, C. P\'erez Bertolli, L. Perrone, S. Petrera, C. Petrucci, T. Pierog, M. Pimenta, B. Pont, M. Pourmohammad Shahvar, P. Privitera, C. Priyadarshi, M. Prouza, K. Pytel, S. Querchfeld, J. Rautenberg, D. Ravignani, J. V. Reginatto Akim, A. Reuzki, J. Ridky, F. Riehn, M. Risse, V. Rizi, E. Rodriguez, G. Rodriguez Fernandez, J. Rodriguez Rojo, S. Rossoni, M. Roth, E. Roulet, A. C. Rovero, A. Saftoiu, M. Saharan, F. Salamida, H. Salazar, G. Salina, P. Sampathkumar, N. San Martin, J. D. Sanabria Gomez, F. S\'anchez, F. M. S\'anchez Rodriguez, E. Santos, F. Sarazin, R. Sarmento, R. Sato, P. Savina, V. Scherini, H. Schieler, M. Schimassek, M. Schimp, D. Schmidt, O. Scholten, H. Schoorlemmer, P. Schov\'anek, F. G. Schr\"oder, J. Schulte, T. Schulz, S. J. Sciutto, M. Scornavacche, A. Sedoski, S. Sehgal, S. U. Shivashankara, G. Sigl, K. Simkova, F. Simon, R. \v{S}m\'ida, S. Soares Sippert, P. Sommers, R. Squartini, M. Stadelmaier, S. Stani\v{c}, J. Stasielak, P. Stassi, S. Str\"ahnz, M. Straub, T. Suomij\"arvi, A. D. Supanitsky, Z. Svozilikova, Z. Szadkowski, F. Tairli, M. Tambone, A. Tapia, C. Taricco, C. Timmermans, O. Tkachenko, P. Tobiska, C. J. Todero Peixoto, B. Tom\'e, A. Travaini, P. Travnicek, C. Trimarelli, M. Tueros, M. Unger, R. Uzeiroska, L. Vaclavek, M. Vacula, I. Vaiman, J. F. Vald\'es Galicia, L. Valore, P. van Dillen, E. Varela, V. Va\v{s}\'i\v{c}kov\'a, A. V\'asquez-Ram\'irez, D. Veberi\v{c}, I. D. Vergara Quispe, S. Verpoest, V. Verzi, J. Vicha, S. Vorobiov, J. B. Vuta, C. Watanabe, A. A. Watson, A. Weindl, M. Weitz, L. Wiencke, H. Wilczy\'nski, B. Wundheiler, B. Yue, A. Yushkov, E. Zas, D. Zavrtanik, M. Zavrtanik

57. [Dynamical and Photometric Analysis of NGC 146 and King 14: Evidence for a Co-Moving, Unbound Cluster Pair](#user-content-link57)
**Authors:** D. Bisht, Ing-Guey Jiang, W. H. Elsanhoury, K. Belwal, D. C. C{\i}nar, A. Raj, Shraddha Biswas, Arvind K. Dattatrey, Geeta Rangwal, Devesh P. Sariya, Mohit Singh Bisht, Alok Durgapal

58. [The DESI DR1 Peculiar Velocity Survey: growth rate measurements from the maximum likelihood fields method](#user-content-link58)
...
59. [The Origins of the Bulk flow](#user-content-link59)
**Authors:** Richard Watkins, Hume A. Feldman

60. [Magnetic Field Amplification and Particle Acceleration in Weakly Magnetized Trans-relativistic Electron-ion Shocks](#user-content-link60)
**Authors:** Taiki Jikei, Daniel Groselj, Lorenzo Sironi

61. [Quasi-linear theory of perpendicular ion heating by critically balanced turbulence](#user-content-link61)
**Authors:** Zade Johnston, Jonathan Squire

62. [A 7 Day Multiwavelength Flare Campaign on AU Mic. IV: Quiescent Gyrosynchrotron and Gyroresonance Radiation from 12 to 25 GHz](#user-content-link62)
**Authors:** Isaiah I. Tristan, Rachel A. Osten, Yuta Notsu, Adam F. Kowalski, Steven R. Cranmer

63. [Screening of dipolar emission in two-scale Gauss-Bonnet gravity](#user-content-link63)
**Authors:** Farid Thaalba, Leonardo Gualtieri, Thomas P. Sotiriou, Enrico Trincherini

64. [The anisotropy and magnetic field structure of neutron stars through gravitational wave](#user-content-link64)
**Authors:** Zhao-Wei Du, Xi-Long Fan

65. [Inferring black hole formation channels in GWTC-4.0 via parametric mass-spin correlations derived from first principles](#user-content-link65)
**Authors:** Emanuele Berti, Francesco Crescimbeni, Gabriele Franciolini, Simone Mastrogiovanni, Paolo Pani, Gr\'egoire Pierra

66. [Statistical and Temporal Analysis of Multi-component Burst-clusters from the Repeating FRB 20190520B](#user-content-link66)
**Authors:** Jia-heng Zhang, Chen-Hui Niu, Yu-hao Zhu, Di Li, Wei-yang Wang, Yi Feng, Xin-ming Li, Jia-rui Niu, Pei Wang, Yun-wei Yu, Yong-kun Zhang, Xiao-ping Zheng

67. [A Deep Chandra X-ray Survey of a Luminous Quasar Sample at $z\sim$ 7](#user-content-link67)
...
68. [Large Language Models for Limited Noisy Data: A Gravitational Wave Identification Study](#user-content-link68)
**Authors:** Yixuan Li, Yuhao Lu, Yang Liu, Liang Li, R. Ruffini, Di Li, Rong-Gen Cai, Xiaoyan Zhu, Wenbin Lin, Yu Wang

69. [A Critical Evaluation of the Physical Nature of the Little Red Dots](#user-content-link69)
**Authors:** Kohei Inayoshi, Luis C. Ho

70. [The helium common-envelope wind scenario for SN 2020eyj](#user-content-link70)
**Authors:** Xiang-Cun Meng, Philipp Podsiadlowski

71. [The Cosmological Dipole in Tilted Anisotropic Universes](#user-content-link71)
**Authors:** Alicia Mart\'in, Constantinos Skordis, Deaglan J. Bartlett, Harry Desmond, Pedro G. Ferreira, Tariq Yasin

72. [A Comprehensive JWST/NIRSpec Census of Broad-Line Active Galactic Nuclei: Faint, Tiny, but Highly Accreting Sources in the Remote Universe](#user-content-link72)
**Authors:** Caroline Baccus (Menlo School, New York University), Xinfeng Xu (CIERA, Northwestern University, Department of Physics and Astronomy, Northwestern University)

73. [Neutrino-dominated relativistic shocked accretion flow around rotating black hole: implications for short gamma-ray bursts](#user-content-link73)
**Authors:** Amit Kumar (IITG), Sayan Chakrabarti (IITG), Santabrata Das (IITG)

74. [Overlapping of photon rings in black hole imaging](#user-content-link74)
**Authors:** Oleg Yu. Tsupko, Fabio Aratore, Volker Perlick

75. [Cosmology after Phantom Crossing by Horndeski Gravity](#user-content-link75)
**Authors:** Eric V. Linder

76. [The broad-lined Type Ic supernova 2020lao reveals an energetic explosion with no central-engine signatures](#user-content-link76)
**Authors:** M. D. Stritzinger (Aarhus), T. J. Moriya, S. Bose, P. A. Mazzali, P. Lundqvist, E. Karamehmetoglu, L. S. Arndt, C. Ashall, L. Galbany, W. B. Hoogendam, E. Baron, J. M. DerKacy, N. Elias-Rosa, E. Y. Hsiao, P. H\"oflich, E. Pian, E. A. M. Jensen, S. Moran, A. Pastorello, M. Shahbandeh, G. Valerin

77. [EFT of Dark Energy with Cosmic Chronometers: Reconstructing Background EFT Functions](#user-content-link77)
**Authors:** Fumiya Okamatsu, Kazufumi Takahashi

78. [Bright Region Reset: an on-detector strategy for minimizing the impacts of atmospheric emission lines on spectral observations](#user-content-link78)
**Authors:** Theodore A. Grosson, Edward L. Chapin, Tim Hardy, Masen Lamb, Jordan Lothrop, Alan W. McConnachie, Richard Murowinski

79. [The first out-of-ecliptic observations of the polar magnetic field of the Sun](#user-content-link79)
**Authors:** D. Calchetti, S. K. Solanki, J. Hirzberger, G. Valori, L. P. Chitta, J. Blanco Blanco Rodr\'iguez, A. Giunta, T. Grundy, K. Albert, T. Appourchaux, F. J. Bail\'en, L. R. Bellot Rubio, A. Feller, A. Gandorfer, L. Gizon, A. Korpi-Lagg, X. Li, A. Moreno Vacas, T. Oba, D. Orozco Su\'arez, J. Schou, U. Sch\"uhle, J. Sinjan, H. Strecker, J. C. del Toro Iniesta, A. Ulyanov, R. Volkmer, J. Woch

80. [A strategy for optimal material identification in solar dark photon absorption](#user-content-link80)
**Authors:** Theresa M. Backes, Riccardo Catena, Michael Kr\"amer

81. [Interferometric Detection and Orbit Modeling of the Subcomponent in the Hot-dust System $\kappa$ Tuc A: A Low-mass Star on an Eccentric Orbit in a Hierarchical-quintuple System](#user-content-link81)
**Authors:** T. A. Stuber (Department of Astronomy and Steward Observatory, The University of Arizona), A. M\'erand (European Southern Observatory Headquarter), F. Kirchschlager (Sterrenkundig Observatorium, Ghent University), S. Wolf (Institute of Theoretical Physics and Astrophysics, Kiel University), G. Weible (Department of Astronomy and Steward Observatory, The University of Arizona), O. Absil (STAR Institute, Universit\'e de Li\`ege), T. D. Pearce (Department of Physics, University of Warwick), G. Garreau (Institute of Astronomy, KU Leuven), J. -C. Augereau (Univ. Grenoble Alpes, CNRS, IPAG), W. C. Danchi (NASA Goddard Space Flight Center), D. Defr\`ere (Institute of Astronomy, KU Leuven), V. Faramaz-Gorka (Department of Astronomy and Steward Observatory, The University of Arizona), J. W. Isbell (Department of Astronomy and Steward Observatory, The University of Arizona), J. Kobus (Institute of Theoretical Physics and Astrophysics, Kiel University), A. V. Krivov (Astrophysikalisches Institut und Universit\"atssternwarte, Friedrich-Schiller-Universit\"at Jena), R. Laugier (Institute of Astronomy, KU Leuven), K. Ollmann (Institute of Theoretical Physics and Astrophysics, Kiel University), R. G. Petrov (Universit\'e C\^ote d'Azur, Observatoire de la C\^ote d'Azur, CNRS, Laboratoire Lagrange), P. Priolet (Univ. Grenoble Alpes, CNRS, IPAG), J. P. Scott (Department of Astronomy and Steward Observatory, The University of Arizona), K. Tsishchankava (Institute of Theoretical Physics and Astrophysics, Kiel University), S. Ertel (Department of Astronomy and Steward Observatory, The University of Arizona, Large Binocular Telescope Observatory, The University of Arizona)

82. [The Extent of Solar Energetic Particle Irradiation in the Sun's Protoplanetary Disk](#user-content-link82)
**Authors:** Steven J. Desch, Ashley K. Herbst, Richard L. Hervig, Benjamin Jacobsen

83. [The ANDICAM-SOFI Near-infrared and Optical type Ia Supernova (ASNOS) sample: Description and data release](#user-content-link83)
**Authors:** Kim Phan, Llu\'is Galbany, Tom\'as E. M\"uller-Bravo, Subhash Bose, Christopher R. Burns, Maximilian D. Stritzinger, Camilla T. G. S{\o}rensen, Chris Ashall, Francisco J. Castander, Cristina Jim\'enez Palau, Joel Johansson, Joseph P. Anderson, Ken. C. Chambers, Mariusz Gromadzki, Priscila J. Pessi, Ting-Wan Chen

84. [The first 10years of the HAWC Gamma-Ray Observatory: science results](#user-content-link84)
**Authors:** Anna Lia Longinotti, HAWC Collaboration

85. [Spectral Characterization of a 90 GHz CLASS Pixel](#user-content-link85)
**Authors:** Gregory Jaehnig, John Appel, Sarah Marie Bruno, Jake Connors, Shannon M. Duff, Naina Gupta, Johannes Hubmayr, Matthew A. Koc, Tammy Lucas, Tobias Marriage, Lola Morales Perez, Caleigh Ryan, Jeff Van Lanen

86. [Gravitational Decays of Secluded Scalars and Graviton Dark Radiation](#user-content-link86)
**Authors:** Kazunori Nakayama, Fuminobu Takahashi, Juntaro Wada

87. [Multi-probe analysis of strong-field effects in $f(Q)$ gravity](#user-content-link87)
**Authors:** Mohsen Khodadi, Behnam Pourhassan, Emmanuel N. Saridakis

88. [Freeze-out and spectral running of primordial gravitational waves in viscous cosmology](#user-content-link88)
**Authors:** Giuseppe Fanizza, Eliseo Pavone, Luigi Tedesco

89. [Trapped fireshell (halo) of photons and pairs around black-hole horizon: source for ultra-high-energy particles](#user-content-link89)
**Authors:** She-Sheng Xue

90. [Roman coronagraph simulations of exozodi observations in the presence of wavefront errors](#user-content-link90)
**Authors:** Jorge Llop-Sayson, Vanessa P. Bailey, Justin Hom, John Krist, Bertrand Mennesson, Samantha N. Hasler, Alexandra Z. Greenbaum, A J Eldorado Riggs, Geoffrey Bryden

91. [Primary gravitational waves at high frequencies I: Origin of suppression in the power spectrum](#user-content-link91)
**Authors:** Alipriyo Hoory, Jerome Martin, Arnab Paul, L. Sriramkumar

92. [Enhanced slow magnetic-Coriolis waves with magnetic field orthogonal to rotation axis](#user-content-link92)
**Authors:** Raviraj Narayan Shinde, Ghanesh Narasimhan

93. [Motion of a charged test particle around a static black hole in a monopole magnetic field](#user-content-link93)
**Authors:** Ken-ichi Nakao, Yota Endo, Hideki Ishihara, Kenta Matsuo, Kensuke Sueto, Koudai Ueda, Hirotaka Yoshino

94. [TT Arietis: New approach to the analysis of quasi-periodic oscillations](#user-content-link94)
**Authors:** I. Vega-Manubens, N. Vogt, A. Lopera-Mej\'ia, G. Aravena-Rojas, P. A. Rojas Lobos

95. [An Analysis of LIGO Glitches Using t-SNE During the First Part of the Fourth LIGO-Virgo-KAGRA Observing Run](#user-content-link95)
**Authors:** Tabata Aira Ferreira, Gabriela Gonz\'alez, Osvaldo Salas

96. [Gamma-ray astronomy from the ground - future perspectives](#user-content-link96)
**Authors:** Jim Hinton

97. [Comparing land- and skyscapes in the three main manorial-conquered lands of the Canary Islands](#user-content-link97)
**Authors:** Maria Florencia Muratore, Alejandro Gangui, Juan Antonio Belmonte, Carmelo Cabrera

98. [Determining the Qibla Direction by Astronomical and Geometrical Methods](#user-content-link98)
**Authors:** Duaa Abdullah

99. [Surprisingly Large Doppler Shifts in Hinode EUV Imaging Spectrometer (EIS) Solar Spectra, Resulting from an Inconspicuous Small-scale Jet in EUV Images](#user-content-link99)
**Authors:** Alphonse C. Sterling, Louise K. Harra, Navdeep K. Panesar, Ronald L. Moore

100. [Fine-Scale Features of the Sun's Atmosphere: Spicules and Jets](#user-content-link100)
**Authors:** Alphonse C. Sterling

101. [Lightweight design and analysis of optical cover plate for exoplanet imaging coronagraph](#user-content-link101)
**Authors:** Lingyi Kong, Mingming Xu, Wei Guo, Jiangpei Dou, Bo Chen, Shu Jiang

102. [An infrasound source analysis of the OSIRIS-REx sample return capsule hypersonic re-entry](#user-content-link102)
**Authors:** Jordan W. Bishop, Philip Blom, Chris Carr, Jeremy Webster

---

## 1. [On the Origin of Gas-stripping of Galaxies in Group Environments](https://arxiv.org/abs/2512.03145) <a id="link1"></a>
...
**Comment:** This paper investigates gas stripping of satellite galaxies in low-mass group environments using the NHtwo simulation. It directly addresses the quenching and gas loss of dwarf satellites, the role of environment, and the emergence of a characteristic stellar mass for efficient gas removal. This matches the 'Near-Field Cosmology', 'Star Formation Quenching', and 'Numerical Galaxy Simulations' criteria very closely.
...
## 2. [The DREAMS Project: Disentangling the Impact of Halo-to-Halo Variance and Baryonic Feedback on Milky Way Dark Matter Density Profiles](https://arxiv.org/abs/2512.03132) <a id="link2"></a>
...
**Comment:** This paper directly addresses the dark matter density profiles of Milky Way-mass halos, using a large suite of high-resolution simulations to disentangle baryonic feedback and halo-to-halo variance. It is highly relevant for near-field cosmology and numerical galaxy simulations, especially regarding the core-cusp problem and Milky Way dark matter profile.
...
## 3. [JWST Captures Growth of Aromatic Hydrocarbon Dust Particles in the Extremely Metal-poor Galaxy Sextans A](https://arxiv.org/abs/2512.04060) <a id="link3"></a>
...
**Comment:** JWST observations of PAH emission in the extremely metal-poor dwarf galaxy Sextans A. Directly relevant to near-field cosmology (dwarf galaxy), resolved ISM structure, and star formation in low-metallicity environments. High relevance due to focus on a Local Group dwarf and ISM processes.
...
## 4. [An Ancient Descendant of the First Galaxies](https://arxiv.org/abs/2512.03154) <a id="link4"></a>
...
**Comment:** This paper reports the discovery of a high-redshift galaxy with a suppressed star formation history after an early burst, using JWST data. The focus on star formation history and evolutionary pathways is highly relevant to the 'Resolved Star Formation Histories' criterion, and the discussion of fading into inefficient dwarfs connects to near-field cosmology and quenching.
...
## 5. [The effect of baryons on the positions and velocities of satellite galaxies in the MTNG simulation](https://arxiv.org/abs/2512.04080) <a id="link5"></a>
...
**Comment:** Directly relevant to near-field cosmology and numerical galaxy simulations. Compares satellite galaxy positions and velocities in hydrodynamic vs. dark-matter-only simulations, quantifying baryonic effects on satellite distributions. Addresses the impact on galaxy clustering and mock catalog construction, which is highly relevant.
...
## 6. [Taming the Tarantula: How Stellar Wind Feedback Shapes Gas and Dust in 30 Doradus](https://arxiv.org/abs/2512.03129) <a id="link6"></a>
...
**Comment:** Presents a multi-wavelength analysis of 30 Doradus (the Tarantula Nebula), focusing on how stellar wind feedback shapes gas and dust. The study investigates stellar feedback-driven bubbles, turbulent mixing, and mass-loading, which directly matches the 'Star Formation Driven Outflows' criterion. The region studied (30 Doradus) is a massive star-forming region, and the work connects feedback processes to observable gas and dust properties.
...
## 7. [Push-broom Mapping of Galaxies and Supernova Remnants with the SPRITE CubeSat](https://arxiv.org/abs/2512.03329) <a id="link7"></a>
...
**Comment:** SPRITE CubeSat will map FUV emission lines in supernova remnants and star-forming galaxies, including the LMC. The focus on mapping stellar feedback and ISM cooling in galaxies, and the demonstration with LMC SNRs, is directly relevant to 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' (instrument simulation). Increased relevance due to connection to feedback processes in low-mass galaxies.
...
## 8. [Separating halo and disk stars in galaxies with Fuzzy Set Theory](https://arxiv.org/abs/2512.03965) <a id="link8"></a>
...
**Comment:** This paper presents a fuzzy set theory approach to separating halo and disk stars in galaxies, using TNG50 simulations. While it analyzes simulated galaxies and stellar populations, the focus is on classification methods rather than resolved star formation histories, near-field cosmology, or dwarf galaxy properties. It is borderline relevant due to its application to galaxy simulations.
...
## 9. [The Mass-Metallicity Relation and its Observational Effects at z~3-6](https://arxiv.org/abs/2512.03134) <a id="link9"></a>
...
**Comment:** Characterizes the mass-metallicity relation at z~3-6 using JWST spectra and forward modeling. While the MZR is important for galaxy evolution, the focus is on high-redshift galaxies, not local dwarfs or satellites. Some relevance for chemical enrichment studies, but not a core match.
...
## 10. [The DESI DR1 Peculiar Velocity Survey: The Tully-Fisher Distance Catalog](https://arxiv.org/abs/2512.03227) <a id="link10"></a>
...
**Comment:** Presents a Tully-Fisher distance catalog for spiral galaxies from DESI DR1. While it is a large-scale survey, the focus is on spiral galaxies (not dwarfs or satellites), and the main topic is peculiar velocities and distance measurements, not near-field cosmology or resolved star formation histories.
...
## 11. [On distance and velocity estimation in cosmology](https://arxiv.org/abs/2512.04075) <a id="link11"></a>
...
**Comment:** This paper discusses biases in distance and velocity estimation in cosmology, with a focus on reconstructing peculiar velocity fields and the Tully-Fisher relation. While it touches on galaxy distances and velocities, it does not directly address dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 12. [The DESI DR1 Peculiar Velocity Survey: Mock Catalog](https://arxiv.org/abs/2512.03228) <a id="link12"></a>
...
**Comment:** This paper describes the production of mock catalogs for the DESI Peculiar Velocity Survey, including galaxy clustering and peculiar velocity samples. While it is a numerical simulation paper, the focus is on large-scale structure and cosmological measurements, not on galaxy-scale simulations, dwarf galaxies, or the other specific criteria. Borderline relevance for simulation methodology.
...
## 13. [Tracing the Cosmic Evolution of the Cool Circumgalactic Medium of Luminous Red Galaxies with DESI Year 1 Data](https://arxiv.org/abs/2512.03845) <a id="link13"></a>
...
**Comment:** This work investigates the circumgalactic medium (CGM) of massive galaxies (luminous red galaxies), but not dwarf galaxies. While CGM is a relevant topic, the focus on massive galaxies makes it only borderline relevant.
...
## 14. [A Wind-Driven Origin for the Firework Morphology of the Supernova Remnant Pa 30](https://arxiv.org/abs/2512.03140) <a id="link14"></a>
...
**Comment:** The paper studies the morphology of a supernova remnant (Pa 30) and the interaction between a white dwarf wind and the circumstellar medium. While it discusses stellar feedback and ISM interactions, the focus is on a single Galactic supernova remnant and not on galaxy-scale outflows, dwarf galaxies, or CGM. Marginal relevance to star formation driven outflows, but not a direct match.
...
## 15. [The Nuclear Star Cluster of M 74: a fossil record of the very early stages of a star-forming galaxy](https://arxiv.org/abs/2512.03999) <a id="link15"></a>
...
**Comment:** This paper analyzes the nuclear star cluster in M74, a massive spiral galaxy, and its fossil record. While it discusses star formation history, the focus is on the nuclear cluster of a massive galaxy, not on dwarf galaxies or resolved star formation histories from color-magnitude diagrams.
...
## 16. [Modeling of Rayleigh Scattering and Interstellar Polarization for Evolved Late-Type Stars](https://arxiv.org/abs/2512.04042) <a id="link16"></a>
...
**Comment:** The paper models Rayleigh scattering and interstellar polarization for evolved late-type stars, focusing on stellar atmospheres and photopolarimetry. It is somewhat relevant to stellar models, but does not present new evolutionary tracks or bolometric corrections.
...
## 17. [A Thermal Relic Encyclopedia: Dark Matter Candidates Coupled to Quarks](https://arxiv.org/abs/2512.03133) <a id="link17"></a>
...
**Comment:** This is a systematic study of dark matter candidates and their interactions with quarks, including relic density calculations and constraints. While it is broadly relevant to cosmology and dark matter, it does not focus on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 18. [Voyager 1 Data Reveals Signatures of the Local Gas and Cosmic-Ray Source Distributions](https://arxiv.org/abs/2512.03385) <a id="link18"></a>
...
**Comment:** This paper investigates cosmic-ray spectra and the local interstellar medium using Voyager 1 data. While it discusses the local Galactic environment, it does not focus on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 19. [BEC vortices as an observational signature of ultra-light bosonic dark matter](https://arxiv.org/abs/2512.03357) <a id="link19"></a>
...
**Comment:** This paper explores the emergence of Bose-Einstein Condensate vortices in ultra-light bosonic dark matter halos and their possible observational signatures. While it discusses dark matter structure in halos, the focus is on theoretical dark matter models and lensing, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 20. [The DESI DR1 Peculiar Velocity Survey: global zero-point and $H_0$ constraints](https://arxiv.org/abs/2512.03232) <a id="link20"></a>
...
**Comment:** This paper uses DESI DR1 data to calibrate the zero-point for the Fundamental Plane and Tully-Fisher relations, enabling a precise measurement of the Hubble constant. While it involves galaxy scaling relations, the focus is on cosmological distance calibration and not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 21. [The Nature of Nitrogen Enhanced High Redshift Galaxies](https://arxiv.org/abs/2512.04043) <a id="link21"></a>
...
**Comment:** The paper analyzes high-redshift galaxies with enhanced nitrogen emission, investigating their excitation sources and physical conditions. While it discusses star formation environments and stellar populations, it does not focus on resolved star formation histories, dwarf galaxies, or near-field cosmology.
...
## 22. [Joint JWST-DECam Lensing Reveals That the Bullet Cluster Is a Minor Merger](https://arxiv.org/abs/2512.03150) <a id="link22"></a>
...
**Comment:** This paper presents a lensing analysis of the Bullet Cluster, resolving its mass components and merger status. While it is a foundational study for dark matter and cluster mergers, it does not focus on dwarf galaxies, near-field cosmology, or resolved star formation histories.
...
## 23. [The impact of our peculiar motion on primordial non-Gaussianity measurements using the LIGER4GAL framework](https://arxiv.org/abs/2512.03824) <a id="link23"></a>
...
**Comment:** The paper presents a simulation framework for relativistic redshift-space distortions and their impact on primordial non-Gaussianity measurements, using luminous red galaxies. While it involves galaxy simulations, the focus is on cosmological measurements and not on galaxy formation, dwarf galaxies, or star formation histories.
...
## 24. [(Re)solving the complex multi-scale morphology and V-shaped SED of a newly discovered strongly-lensed Little Red Dot in Abell 383](https://arxiv.org/abs/2512.03239) <a id="link24"></a>
...
**Comment:** The paper presents a resolved view of a strongly-lensed high-redshift galaxy, focusing on its internal structure and stellar populations. It does not address resolved star formation histories from color-magnitude diagrams, nor does it focus on dwarf galaxies or simulations.
...
## 25. [X TrA through the eyes of MATISSE: More evidence of clumpy molecular layers around C-type asymptotic giant branch stars](https://arxiv.org/abs/2512.03910) <a id="link25"></a>
...
**Comment:** Observational study of clumpy molecular layers around an AGB star. While it touches on stellar atmosphere and wind formation, it does not present new stellar models or evolutionary tracks, nor does it focus on galaxies.
...
## 26. [Forecasts for lifetime and fraction of Decaying Dark Matter based on redshift distortions from Euclid and BOSS](https://arxiv.org/abs/2512.03348) <a id="link26"></a>
...
**Comment:** Forecasts constraints on decaying dark matter using redshift-space distortions. While it is cosmology-focused, it does not address near-field cosmology, satellite galaxies, or resolved star formation histories.
...
## 27. [Astrophysical Reaction Rates for Charged-Particle Induced Reactions on Proton-Rich Nuclides](https://arxiv.org/abs/2512.03206) <a id="link27"></a>
...
**Comment:** Presents new astrophysical reaction rates for charged-particle induced reactions on proton-rich nuclides, relevant for nucleosynthesis. While this is a stellar model/nucleosynthesis paper, it does not present new stellar evolutionary tracks or atmosphere models, nor does it directly address resolved star formation histories or galaxy simulations.
...
## 28. [Magnetic activity on the young Sun: a case study of EK Draconis](https://arxiv.org/abs/2512.03830) <a id="link28"></a>
...
**Comment:** This is a case study of magnetic activity on EK Draconis, a young solar analog, using photometric and spectroscopic data to investigate activity cycles and differential rotation. While it tests stellar models and dynamo theory, it does not present new stellar evolutionary tracks or atmosphere models, nor does it address galaxy evolution or near-field cosmology.
...
## 29. [Radio Detection of a Local Little Red Dot](https://arxiv.org/abs/2512.03331) <a id="link29"></a>
...
**Comment:** The paper studies local analogs of 'Little Red Dots' (compact luminous red galaxies) and their radio properties, with a focus on distinguishing energy sources (supernovae vs. black holes). While it touches on galaxy evolution, it does not focus on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 30. [Modeling Binary Lenses and Sources with the BAGLE Python Package](https://arxiv.org/abs/2512.03392) <a id="link30"></a>
...
**Comment:** Presents a Python package for modeling binary lens and source microlensing events. While useful for future surveys, it does not directly address any core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 31. [From scalar clouds around evaporating black holes to boson star](https://arxiv.org/abs/2512.03155) <a id="link31"></a>

**ArXiv ID:** 2512.03155

**Authors:** Daniel Neves, Jo\~ao G. Rosa

**Abstract:** We study, for the first time, the evolution of a scalar cloud bound to an evaporating black hole. Our simulations of the associated Schr\"odinger-Poisson system for non-relativistic and spherically symmetric clouds reveal that a scalar cloud may (partially) survive as a self-gravitating boson star if the black hole evaporates adiabatically until its mass becomes less than one half of the cloud's mass. This yields a novel mechanism for boson star formation and shows that, as previously conjectured, bosonic dark matter production by light primordial black holes may result in micro-boson stars with very large occupation numbers, greatly enhancing their potential detectability even for very weakly interacting dark matter particles.

**Comment:** This paper studies the evolution of scalar clouds around evaporating black holes and the formation of boson stars. While it touches on dark matter and compact objects, it does not directly address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 32. [Genetic Algorithm for Inferring Model Parameters for Flux Transport Dynamo Simulation](https://arxiv.org/abs/2512.03550) <a id="link32"></a>
...
**Comment:** This paper presents a genetic algorithm for inferring model parameters for solar dynamo simulations. While it involves numerical simulations, it is focused on the Sun and solar cycles, not on galaxies or the specified criteria.
...
## 33. [Improving Accretion Diagnostics for Young Stellar Objects with Mid-infrared Hydrogen lines from JWST/MIRI](https://arxiv.org/abs/2512.03456) <a id="link33"></a>
...
**Comment:** This paper studies mid-infrared hydrogen emission lines in young stellar objects to improve accretion diagnostics. It focuses on accretion in young stars, not on resolved star formation histories of galaxies, galaxy simulations, or dwarf galaxy quenching.
...
## 34. [Comparison of Ne-22 core and shell distilled WD detonations in AREPO](https://arxiv.org/abs/2512.03264) <a id="link34"></a>
...
**Comment:** This paper presents 3D hydrodynamical simulations of white dwarf detonations, focusing on the effects of Ne-22 distillation and its impact on nucleosynthetic yields and observable signatures in Type Ia supernovae. While it involves numerical simulations and stellar models, the focus is on white dwarf explosions and not on galaxy evolution, dwarf galaxies, or near-field cosmology. It does not match any core criteria closely.
...
## 35. [Multimessenger Constraints on Supermassive Dark Stars and Their Black Hole Remnants](https://arxiv.org/abs/2512.04061) <a id="link35"></a>
...
**Comment:** This paper discusses supermassive dark stars and their black hole remnants, focusing on multimessenger constraints and their role in early structure formation. While it touches on the formation of early massive structures, it does not address dwarf galaxies, resolved star formation histories, or the other specific criteria.
...
## 36. [The DESI DR1 Peculiar Velocity Survey: Fundamental Plane Catalogue](https://arxiv.org/abs/2512.03226) <a id="link36"></a>
...
**Comment:** The paper presents a large catalog of peculiar velocity measurements for early-type galaxies using the Fundamental Plane, focusing on cosmological parameters and dark energy. It does not address dwarf galaxies, star formation histories, or galaxy simulations.
...
## 37. [Hydrogen-Rich to Stripped-Envelope:Observational Continuity and Biases in CCSNe](https://arxiv.org/abs/2512.04010) <a id="link37"></a>
...
**Comment:** Reviews the continuum between hydrogen-rich and stripped-envelope core-collapse supernovae, discussing progenitor structure, mass-loss, and circumstellar environments. While it touches on stellar evolution and feedback, it does not present new stellar models or focus on galaxy-scale processes, dwarf galaxies, or resolved star formation histories.
...
## 38. [Approximations and modifications of celestial dynamics tested on the three-body system](https://arxiv.org/abs/2512.03823) <a id="link38"></a>
...
**Comment:** This paper tests modifications and approximations of celestial dynamics (PM, MOND, MOGA) using three-body simulations. While it discusses simulation methods, it does not focus on galaxy-scale simulations or new physics models relevant to galaxy evolution.
...
## 39. [A three-dimensional model for the reversal in the local large-scale interstellar magnetic field](https://arxiv.org/abs/2512.03332) <a id="link39"></a>
...
**Comment:** Models the reversal in the local large-scale interstellar magnetic field using Faraday rotation data. The focus is on the Galactic magnetic field within 1 kpc of the Sun, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 40. [GRB 230204B: GIT Discovery of a Fast Fading Afterglow Associated with an Energetic GRB from a Massive-Star Progenitor](https://arxiv.org/abs/2512.03136) <a id="link40"></a>
...
**Comment:** Multi-wavelength study of a gamma-ray burst (GRB 230204B) and its afterglow, focusing on progenitor properties and jet evolution. While it discusses massive star progenitors and feedback, the focus is on a single GRB event, not on galaxy-scale processes or any of the core topics.
...
## 41. [The DESI DR1 Peculiar Velocity Survey: growth rate measurements from galaxy and momentum correlation functions](https://arxiv.org/abs/2512.03230) <a id="link41"></a>
...
**Comment:** This paper presents growth rate measurements from galaxy and momentum correlation functions using DESI DR1 data. The focus is on cosmological structure growth and testing gravity, not on galaxy-scale simulations, dwarf galaxies, or the other specific criteria.
...
## 42. [A Catalogue of Interstellar Material Delivery From Nearby Debris Disks](https://arxiv.org/abs/2512.03159) <a id="link42"></a>
...
**Comment:** The paper models the delivery of interstellar material from nearby debris disks to the solar system, focusing on the trajectories and detection of interstellar objects. While it touches on the Milky Way and nearby systems, it does not address dwarf galaxies, star formation histories, or galaxy simulations.
...
## 44. [High-angular-resolution ALMA imaging of the inhomogeneous dynamical atmosphere of the asymptotic giant branch star W Hya](https://arxiv.org/abs/2512.03156) <a id="link44"></a>
...
**Comment:** High-resolution ALMA imaging of an AGB star's atmosphere and wind. While it discusses stellar chemistry and dust formation, it does not present new stellar interior or atmosphere models, nor does it address galaxy-scale processes or resolved star formation histories. Marginal connection to stellar models via chemistry, but not direct.
...
## 45. [Subgrid Mean-field Dynamo Model with Dynamical Quenching in General Relativistic Magnetohydrodynamic Simulations](https://arxiv.org/abs/2512.03443) <a id="link45"></a>
...
**Comment:** Focuses on subgrid dynamo models in GRMHD simulations of accretion disks, with applications to black hole systems. Does not match any core criteria (no focus on galaxies, stellar models, or near-field cosmology).
...
## 46. [Line Polarization of Si II $\lambda$6355 \AA\ in Type Ia Supernovae: A New Statistical Approach to Probe the Explosion Physics and Diversity](https://arxiv.org/abs/2512.03957) <a id="link46"></a>
...
**Comment:** Statistical analysis of line polarization in Type Ia supernovae to probe explosion physics. No direct connection to any core criteria (not focused on galaxies, star formation histories, or stellar models).
...
## 47. [A theory-agnostic hierarchical Bayesian framework for black-hole spectroscopy: a case study on GW250114 in Einstein-dilaton-Gauss-Bonnet gravity](https://arxiv.org/abs/2512.03713) <a id="link47"></a>
...
**Comment:** The paper presents a Bayesian framework for black-hole spectroscopy and tests of gravity using gravitational wave data. It does not match any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 48. [Conformal Holographic Dark Energy](https://arxiv.org/abs/2512.03411) <a id="link48"></a>
...
**Comment:** This paper discusses a new dark energy model (conformal holographic DE) and its cosmological implications, including fits to BAO, CMB, and supernova data. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specific criteria. It is not directly relevant.
...
## 49. [Resolving the Multiple Component Outflows in PG 1211+143: I. The Fe-K Absorption Structure and UFO Forest](https://arxiv.org/abs/2512.03533) <a id="link49"></a>
...
**Comment:** This paper studies ultra-fast outflows (UFOs) in a luminous quasar, focusing on X-ray absorption features and mass outflow rates. The outflows are AGN-driven, not star-formation-driven, and the host is a massive galaxy. Does not match the criteria for star-formation-driven outflows or dwarf galaxies.
...
## 50. [TDCOSMO. XXIV. Measurement of the Hubble constant from the doubly lensed quasar HE1104-1805](https://arxiv.org/abs/2512.03178) <a id="link50"></a>
...
**Comment:** Measures the Hubble constant using time-delay cosmography from a doubly lensed quasar. The work is focused on cosmological parameter estimation and strong lensing, not on any of the core criteria.
...
## 51. [The DESI DR1 Peculiar Velocity Survey: Growth Rate Measurements from the Galaxy Power Spectrum](https://arxiv.org/abs/2512.03231) <a id="link51"></a>
...
**Comment:** Measures the growth rate of large-scale structure using galaxy power spectra from DESI surveys. The work is focused on cosmological parameter estimation and large-scale structure, not on any of the core criteria.
...
## 52. [Building a Radio AGN Sample from Cosmic Morning -- The Radio High-Redshift Quasar Catalog (RHzQCat): I. Catalog from SDSS Quasars and Radio Surveys at $z > 3$](https://arxiv.org/abs/2512.03415) <a id="link52"></a>
...
**Comment:** The paper builds a catalog of high-redshift radio-loud quasars, focusing on AGN and jet evolution. It does not address dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 53. [Probing for primordial black hole candidates in exoplanet search data](https://arxiv.org/abs/2512.03118) <a id="link53"></a>
...
**Comment:** The paper searches for primordial black hole candidates in exoplanet search data, focusing on PBH detection via microlensing and radial velocity. It does not address galaxy formation, dwarf galaxies, or star formation histories.
...
## 54. [The BAGLE Python Package for Bayesian Analysis of Gravitational Lensing Events](https://arxiv.org/abs/2512.03364) <a id="link54"></a>
...
**Comment:** Presents a Python package for Bayesian analysis of gravitational lensing events, focusing on microlensing and mass measurements. While useful for stellar-mass black hole identification, it does not address any of the core criteria such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 55. [New Method for Investigating the Presence of Extragalactic Magnetic Fields](https://arxiv.org/abs/2512.03192) <a id="link55"></a>
...
**Comment:** Proposes a new method for investigating extragalactic magnetic fields using gamma-ray observations of blazars. The focus is on high-energy astrophysics and magnetic fields, not on galaxy formation, dwarf galaxies, or star formation histories.
...
## 56. [Long-term calibration and validation of stability of the Auger Engineering Radio Array using the diffuse Galactic radio emission](https://arxiv.org/abs/2512.03692) <a id="link56"></a>
...
**Comment:** This paper discusses calibration and stability of a radio array using Galactic radio emission. While it involves Galactic emission, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 57. [Dynamical and Photometric Analysis of NGC 146 and King 14: Evidence for a Co-Moving, Unbound Cluster Pair](https://arxiv.org/abs/2512.03552) <a id="link57"></a>
...
**Comment:** Analyzes two open clusters (NGC 146 and King 14) for their dynamical and photometric properties, including age, mass function, and orbital dynamics. While it involves stellar populations and cluster dynamics, it does not address dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 58. [The DESI DR1 Peculiar Velocity Survey: growth rate measurements from the maximum likelihood fields method](https://arxiv.org/abs/2512.03229) <a id="link58"></a>
...
**Comment:** This paper presents measurements of the growth rate of structure using peculiar velocity surveys and cosmological data. It does not address galaxy-scale simulations, dwarf galaxies, or resolved star formation histories.
...
## 59. [The Origins of the Bulk flow](https://arxiv.org/abs/2512.03168) <a id="link59"></a>
...
**Comment:** This paper analyzes the origin of large-scale bulk flows using peculiar velocity data, focusing on internal and external contributions to cosmic flows. It does not address galaxy-scale simulations, dwarf galaxies, or resolved star formation histories.
...
## 60. [Magnetic Field Amplification and Particle Acceleration in Weakly Magnetized Trans-relativistic Electron-ion Shocks](https://arxiv.org/abs/2512.03169) <a id="link60"></a>
...
**Comment:** Studies magnetic field amplification and particle acceleration in trans-relativistic shocks, with applications to extragalactic jets and gamma-ray bursts. No direct relevance to galaxy simulations, near-field cosmology, or other criteria.
...
## 61. [Quasi-linear theory of perpendicular ion heating by critically balanced turbulence](https://arxiv.org/abs/2512.03472) <a id="link61"></a>
...
**Comment:** Analytical study of ion heating in collisionless plasmas via turbulence. While relevant to plasma astrophysics, it does not address galaxy simulations, star formation, or other core criteria.
...
## 62. [A 7 Day Multiwavelength Flare Campaign on AU Mic. IV: Quiescent Gyrosynchrotron and Gyroresonance Radiation from 12 to 25 GHz](https://arxiv.org/abs/2512.03523) <a id="link62"></a>
...
**Comment:** Radio study of quiescent emission from the flare star AU Mic. Focus is on stellar activity and emission mechanisms, not on galaxy-scale processes or stellar models.
...
## 63. [Screening of dipolar emission in two-scale Gauss-Bonnet gravity](https://arxiv.org/abs/2512.04083) <a id="link63"></a>
...
**Comment:** This paper focuses on black holes in modified gravity theories, specifically Gauss-Bonnet gravity with Galileon interactions. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 64. [The anisotropy and magnetic field structure of neutron stars through gravitational wave](https://arxiv.org/abs/2512.03888) <a id="link64"></a>
...
**Comment:** Investigates how gravitational wave observations can probe neutron star internal physics, including magnetic fields and anisotropy. The focus is on neutron stars, not on galaxies, star formation, or feedback processes.
...
## 65. [Inferring black hole formation channels in GWTC-4.0 via parametric mass-spin correlations derived from first principles](https://arxiv.org/abs/2512.03152) <a id="link65"></a>
...
**Comment:** Infers black hole formation channels using mass-spin correlations from GW data. The focus is on black hole binaries and their formation scenarios, not on galaxies, star formation, or feedback.
...
## 66. [Statistical and Temporal Analysis of Multi-component Burst-clusters from the Repeating FRB 20190520B](https://arxiv.org/abs/2512.03591) <a id="link66"></a>
...
**Comment:** This paper focuses on statistical and temporal analysis of FRB burst morphology. FRBs and their emission mechanisms are not directly related to any of the specified criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 68. [Large Language Models for Limited Noisy Data: A Gravitational Wave Identification Study](https://arxiv.org/abs/2512.04031) <a id="link68"></a>
...
**Comment:** This paper applies large language models to gravitational wave identification. It is a methodological study in data analysis and does not match any of the core criteria.
...
## 69. [A Critical Evaluation of the Physical Nature of the Little Red Dots](https://arxiv.org/abs/2512.03130) <a id="link69"></a>
...
**Comment:** This review discusses the nature of Little Red Dots, a new class of AGNs, and their connection to early massive black hole formation. The focus is on AGN activity and black hole growth, not on dwarf galaxies, resolved star formation histories, or near-field cosmology. No core criteria are closely matched.
...
## 70. [The helium common-envelope wind scenario for SN 2020eyj](https://arxiv.org/abs/2512.03531) <a id="link70"></a>
...
**Comment:** This paper proposes a helium common-envelope wind scenario for SN 2020eyj, a Type Ia supernova with a helium-rich circumstellar medium. The focus is on binary evolution and supernova progenitors, not on galaxy evolution, dwarf galaxies, or any core criteria.
...
## 71. [The Cosmological Dipole in Tilted Anisotropic Universes](https://arxiv.org/abs/2512.03867) <a id="link71"></a>
...
**Comment:** This paper considers the cosmological dipole in tilted anisotropic universes, exploring possible sources for the quasar dipole anomaly. The focus is on large-scale cosmological models and not on galaxy evolution, dwarf galaxies, or any core criteria.
...
## 72. [A Comprehensive JWST/NIRSpec Census of Broad-Line Active Galactic Nuclei: Faint, Tiny, but Highly Accreting Sources in the Remote Universe](https://arxiv.org/abs/2512.03281) <a id="link72"></a>
...
**Comment:** This paper presents a JWST/NIRSpec census of broad-line AGN across cosmic time, focusing on black hole growth and accretion. It does not address dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM. AGN studies are not relevant to the criteria.
...
## 73. [Neutrino-dominated relativistic shocked accretion flow around rotating black hole: implications for short gamma-ray bursts](https://arxiv.org/abs/2512.03447) <a id="link73"></a>
...
**Comment:** Focuses on neutrino-dominated accretion flows around black holes and their implications for short gamma-ray bursts. The topic is centered on black hole accretion physics and GRB energetics, which does not match any of the core criteria such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 75. [Cosmology after Phantom Crossing by Horndeski Gravity](https://arxiv.org/abs/2512.03139) <a id="link75"></a>
...
**Comment:** Discusses cosmology after phantom crossing in Horndeski gravity, focusing on dark energy equation of state and modified gravity. The work is theoretical cosmology and does not address any of the core criteria.
...
## 76. [The broad-lined Type Ic supernova 2020lao reveals an energetic explosion with no central-engine signatures](https://arxiv.org/abs/2512.03716) <a id="link76"></a>
...
**Comment:** Presents observations and modeling of a broad-lined Type Ic supernova, focusing on explosion energetics and progenitor properties. The study is centered on supernova physics and does not address any of the core criteria.
...
## 77. [EFT of Dark Energy with Cosmic Chronometers: Reconstructing Background EFT Functions](https://arxiv.org/abs/2512.03314) <a id="link77"></a>
...
**Comment:** Uses cosmic chronometer data to reconstruct effective field theory functions for dark energy. While cosmological in nature, it does not address galaxy formation, star formation histories, or any of the core criteria.
...
## 78. [Bright Region Reset: an on-detector strategy for minimizing the impacts of atmospheric emission lines on spectral observations](https://arxiv.org/abs/2512.03151) <a id="link78"></a>
...
**Comment:** This paper presents a new observational technique (bright region reset) for mitigating atmospheric emission lines in near-infrared spectroscopy. It is a technical instrumentation paper and does not address any of the specific criteria.
...
## 79. [The first out-of-ecliptic observations of the polar magnetic field of the Sun](https://arxiv.org/abs/2512.03611) <a id="link79"></a>
...
**Comment:** This paper focuses on solar polar magnetic field measurements, which do not match any of the specified criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 80. [A strategy for optimal material identification in solar dark photon absorption](https://arxiv.org/abs/2512.03801) <a id="link80"></a>
...
**Comment:** This work develops a strategy for material identification in solar dark photon absorption, focusing on detector physics and dark photon searches. It does not match any of the specified criteria.
...
## 82. [The Extent of Solar Energetic Particle Irradiation in the Sun's Protoplanetary Disk](https://arxiv.org/abs/2512.03184) <a id="link82"></a>
...
**Comment:** This paper constrains the flux of solar energetic particles in the Sun's protoplanetary disk using meteoritic data. The focus is on solar system formation and early solar activity, not on galaxy evolution, dwarf galaxies, or any of the core criteria.
...
## 83. [The ANDICAM-SOFI Near-infrared and Optical type Ia Supernova (ASNOS) sample: Description and data release](https://arxiv.org/abs/2512.03695) <a id="link83"></a>
...
**Comment:** This is a data release paper for a sample of Type Ia supernovae observed in optical and NIR bands, with a focus on photometry and light-curve fitting. While it is useful for cosmological distance measurements, it does not address any of the specific criteria such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 84. [The first 10years of the HAWC Gamma-Ray Observatory: science results](https://arxiv.org/abs/2512.03938) <a id="link84"></a>
...
**Comment:** This is a review of the HAWC Gamma-Ray Observatory's science results, covering a broad range of high-energy astrophysics topics. There is no specific focus on any of the core criteria such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 85. [Spectral Characterization of a 90 GHz CLASS Pixel](https://arxiv.org/abs/2512.03260) <a id="link85"></a>
...
**Comment:** Describes the spectral characterization of a detector pixel for the CLASS experiment, which is designed to measure CMB polarization. The focus is on instrumentation and detector characterization, not on any of the core criteria.
...
## 86. [Gravitational Decays of Secluded Scalars and Graviton Dark Radiation](https://arxiv.org/abs/2512.03662) <a id="link86"></a>
...
**Comment:** This paper discusses graviton dark radiation from decays of secluded scalars in the early universe, focusing on cosmological implications and gravitational wave backgrounds. It does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 87. [Multi-probe analysis of strong-field effects in $f(Q)$ gravity](https://arxiv.org/abs/2512.03529) <a id="link87"></a>
...
**Comment:** Tests strong-field effects in f(Q) gravity using black hole observations and lensing. The focus is on gravity theory and black holes, not on galaxies, star formation, or feedback.
...
## 88. [Freeze-out and spectral running of primordial gravitational waves in viscous cosmology](https://arxiv.org/abs/2512.04011) <a id="link88"></a>
...
**Comment:** This paper investigates the effect of shear viscosity on primordial gravitational waves after inflation. It is focused on early universe cosmology and gravitational wave backgrounds, not on galaxies, star formation, or any of the specific criteria.
...
## 89. [Trapped fireshell (halo) of photons and pairs around black-hole horizon: source for ultra-high-energy particles](https://arxiv.org/abs/2512.03702) <a id="link89"></a>
...
**Comment:** This paper studies the Compton-rocket effect and ultra-high-energy particle production in fireballs around black holes, with applications to gamma-ray bursts. It is focused on high-energy astrophysics and black hole physics, not on galaxies or the specific criteria.
...
## 90. [Roman coronagraph simulations of exozodi observations in the presence of wavefront errors](https://arxiv.org/abs/2512.03308) <a id="link90"></a>
...
**Comment:** This paper discusses simulations of exozodiacal dust detection with the Roman coronagraph, focusing on instrument performance and exoplanetary disks. It does not match any of the specified criteria.
...
## 91. [Primary gravitational waves at high frequencies I: Origin of suppression in the power spectrum](https://arxiv.org/abs/2512.03959) <a id="link91"></a>
...
**Comment:** This paper analyzes the power spectrum of primordial gravitational waves from inflation, focusing on regularization and transitions between cosmological epochs. It does not address any of the core topics such as galaxy formation, dwarf galaxies, or stellar feedback.
...
## 92. [Enhanced slow magnetic-Coriolis waves with magnetic field orthogonal to rotation axis](https://arxiv.org/abs/2512.03120) <a id="link92"></a>
...
**Comment:** This paper studies magnetic-Coriolis waves in Earth's core, which is geophysics and not related to any of the core criteria.
...
## 93. [Motion of a charged test particle around a static black hole in a monopole magnetic field](https://arxiv.org/abs/2512.03484) <a id="link93"></a>
...
**Comment:** This paper studies the motion of charged test particles around black holes in a monopole magnetic field, with implications for plasma behavior near black holes. The topic is unrelated to galaxy evolution, dwarf galaxies, or any of the core criteria.
...
## 94. [TT Arietis: New approach to the analysis of quasi-periodic oscillations](https://arxiv.org/abs/2512.04049) <a id="link94"></a>
...
**Comment:** This paper analyzes quasi-periodic oscillations in the cataclysmic variable TT Arietis using space-based photometry. The focus is on accretion physics and variability in compact binaries, not on galaxy evolution, dwarf galaxies, or any core criteria.
...
## 95. [An Analysis of LIGO Glitches Using t-SNE During the First Part of the Fourth LIGO-Virgo-KAGRA Observing Run](https://arxiv.org/abs/2512.03440) <a id="link95"></a>
...
**Comment:** Presents an analysis of LIGO glitches using machine learning. The focus is on gravitational wave detector noise characterization, which is unrelated to the core criteria.
...
## 96. [Gamma-ray astronomy from the ground - future perspectives](https://arxiv.org/abs/2512.03798) <a id="link96"></a>
...
**Comment:** This is a perspective on future ground-based gamma-ray astronomy instrumentation and science. It does not address any of the specified criteria.
...
## 97. [Comparing land- and skyscapes in the three main manorial-conquered lands of the Canary Islands](https://arxiv.org/abs/2512.03889) <a id="link97"></a>
...
**Comment:** This paper studies the orientation of Christian churches in the Canary Islands and their relationship to landscape and astronomy. It is a cultural astronomy paper and not relevant to any of the criteria.
...
## 98. [Determining the Qibla Direction by Astronomical and Geometrical Methods](https://arxiv.org/abs/2512.03271) <a id="link98"></a>
...
**Comment:** Investigates methods for determining the Qibla direction using astronomical and geometrical approaches. The topic is historical and practical astronomy, unrelated to the core criteria.
...
## 99. [Surprisingly Large Doppler Shifts in Hinode EUV Imaging Spectrometer (EIS) Solar Spectra, Resulting from an Inconspicuous Small-scale Jet in EUV Images](https://arxiv.org/abs/2512.03282) <a id="link99"></a>
...
**Comment:** This paper studies solar EUV jets and Doppler shifts, focusing on solar physics and small-scale eruptions. It is unrelated to galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 100. [Fine-Scale Features of the Sun's Atmosphere: Spicules and Jets](https://arxiv.org/abs/2512.03253) <a id="link100"></a>
...
**Comment:** This paper focuses on fine-scale features in the Sun's atmosphere, specifically spicules and jets. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations. Solar physics is outside the scope.
...
## 101. [Lightweight design and analysis of optical cover plate for exoplanet imaging coronagraph](https://arxiv.org/abs/2512.03700) <a id="link101"></a>
...
**Comment:** This is an engineering paper on the design of an optical cover plate for exoplanet imaging coronagraphs. It does not match any of the core criteria.
...
## 102. [An infrasound source analysis of the OSIRIS-REx sample return capsule hypersonic re-entry](https://arxiv.org/abs/2512.03119) <a id="link102"></a>
...
**Comment:** This paper analyzes infrasound from the OSIRIS-REx sample return capsule re-entry, focusing on sonic boom source models and atmospheric propagation. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The topic is unrelated to galaxy evolution, star formation, or the circumgalactic medium.
