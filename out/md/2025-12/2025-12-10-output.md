...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 54914    | 8665         | 63579   |
| **Cost**             | $0.11    | $0.07        | $0.18   |

Total arXiv papers: 209

Total scanned papers: 145

Total relevant papers: 104

**Table of contents with paper titles:**

1. [Predicting Infall Time of Milky-Way Satellites via Machine Learning](#user-content-link1)
**Authors:** Seungyeon Kim, Myoungwon Jeon, Seongjun Hyung

2. [Forecasting Dark Matter Subhalo Constraints from Stellar Streams using Implicit Likelihood Inference](#user-content-link2)
...
3. [Core-halo scaling relations in self-interacting scalar field dark matter](#user-content-link3)
**Authors:** Jessica N. L\'opez-S\'anchez, Erick Munive-Villa, Tanja Rindler-Daller

4. [High-Redshift Galactic Outflows: Orientation Effects, Kinematics, and Metallicity in TNG50 and SERRA](#user-content-link4)
**Authors:** Ivan Kostyuk, Stefano Carniani, Mahsa Kohandel, Andrea Pallottini

5. [HI-detected Dwarf Galaxies in the FASHI Survey: Insights from Single- and Double-Peaked Emission-Line Samples](#user-content-link5)
**Authors:** Cheng Cheng, Jia-Sheng Huang, Wei Du, Hong-Xin Zhang, Chuan-Peng Zhang, Ming Zhu, Gustavo Orellana

6. [Globular Cluster Systems in Dwarf Galaxies: Catalogs and Comparisons](#user-content-link6)
**Authors:** Veronika Dornan, William E. Harris

7. [J-PAS: First Identification, Physical Properties and Ionization Efficiency of Extreme Emission Line Galaxies](#user-content-link7)
**Authors:** A. Gim\'enez-Alc\'azar, R. Amor\'in, J. M. V\'ilchez, A. Hern\'an-Caballero, M. Gonz\'alez-Otero, A. Arroyo-Polonio, J. Iglesias-P\'aramo, A. Lumbreras-Calle, J. A. Fern\'andez-Ontiveros, L. Bonatto, R. M. Gonz\'alez Delgado, C. Kehrig, A. Torralba, P. T. Rahna, Y. Jim\'enez-Teja, I. M\'arquez, I. Breda, A. \'Alvarez-Candal, R. Abramo, J. Alcaniz, N. Benitez, S. Bonoli, S. Carneiro, J. Cenarro, D. Crist\'obal-Hornillos, R. Dupke, A. Ederoclite, C. Hern\'andez-Monteagudo, A. Mar\'in-Franch, C. Mendes de Oliveira, M. Moles, L. Sodr\'e Jr., K. Taylor, J. Varela, H. V\'azquez Rami\'o

8. [The MAGPI Survey: forward modelled gas-phase metallicity gradients in galaxies at $z\sim 0.3$](#user-content-link8)
...
9. [How is cold, star-forming gas in galaxies affected by magnetic fields?](#user-content-link9)
**Authors:** Kamran R. J. Bogue, Rowan J. Smith, Robin G. Tress, Mordecai-Mark Mac Low, David Whitworth, Ralf S. Klessen, No\'e Brucy, Philipp Girichidis, Simon C. O. Glover, Junia G\"oller, Juan D. Soler, Alessio Traficante

10. [Collisional rate coefficients for OH-H$_2$ at high temperatures](#user-content-link10)
**Authors:** Zeno van den Heuvel, Beno\^it Tabone, Ewine F. van Dishoeck, Gerrit C. Groenenboom, Ad van der Avoird

11. [Spatially Resolved Physical Properties of Young Star Clusters and Star-forming Clumps in the Brightest z>6 Galaxy, the Strongly Lensed Cosmic Spear at z=6.2](#user-content-link11)
**Authors:** Abdurro'uf, Dan Coe, Tom Resseguier, Calla Murphy, Xinfeng Xu, Angela Adamo, Namrata Roy, Alaina Henry, Vasily Kokorev, Gabriel Brammer, Seiji Fujimoto, Henry C. Ferguson, Amanda Pagul, Rogier A. Windhorst, Timothy Heckman, Jose M. Diego, Hollis B. Akins, Joseph Allingham, Ricardo O. Amor\'in, Danielle A. Berg, Maru\v{s}a Brada\v{c}, Larry D. Bradley, Wenlei Chen, John Chisholm, Christopher J. Conselice, Pratika Dayal, Miroslava Dessauges-Zavadsky, Andreas L. Faisst, Steven L. Finkelstein, Yoshinobu Fudamoto, Lukas J. Furtak, Yuichi Harikane, Tiger Yu-Yang Hsiao, Yolanda Jimenez-Teja, Anton M. Koekemoer, Rebecca L. Larson, Ray A. Lucas, Matteo Messa, Lamiya Mowla, Minami Nakane, Ga\"el Noirot, Richard Pan, Massimo Pascale, Johan Richard, Massimo Ricotti, Luke Robbins, Daniel Schaerer, Fengwu Sun, Eros Vanzella, Brian Welch, Chris Willott, Adi Zitrin

12. [Near-IR CO and CN in classical Cepheids](#user-content-link12)
**Authors:** Scott G. Call, Thomas Griffith, Eric G. Hintz, Steve Ardern, Victoria Scowcroft, Jared Davidson, Benjamin Boizelle

13. [On the missing dust of super-early galaxies: Supernova blowout and gas-dust venting in Blue Monsters](#user-content-link13)
**Authors:** Sergio Mart\'inez-Gonz\'alez, Santiago Jim\'enez, Casiana Mu\~noz-Tun\'on

14. [Inferring main-sequence stage and buoyancy-glitch amplitudes from Fourier spectra of gravity-mode period spacings: Ensemble Analysis of 26 Slowly Pulsating B Stars](#user-content-link14)
**Authors:** Zhao Guo, Conny Aerts

15. [Probing the Warm Dark Matter mass with [C II] intensity mapping](#user-content-link15)
**Authors:** Elena Marcuzzo, Cristiano Porciani, Emilio Romano-D\'iaz, Azadeh Moradinezhad Dizgah, Prachi Khatri, Matteo Viel

16. [Chemical Signatures of AGB Mass Transfer in Gaia White Dwarf Companions](#user-content-link16)
**Authors:** Natsuko Yamaguchi, Kareem El-Badry, Henrique Reggiani, Ren\'e Andrae, Sahar Shahaf

17. [Tracing Nitrogen Enrichment across Cosmic Time with JWST](#user-content-link17)
...
26. [The Head-on Collision of a Neutron Star with a White Dwarf](#user-content-link26)
**Authors:** Zong-kai Peng, He Gao, Xian-Fei Zhang

27. [Investigating ionising sources and the complex interstellar medium of GHZ2 at $z=12.3$](#user-content-link27)
**Authors:** M. Castellano, L. Napolitano, B. Moreschini, A. Calabr\`o, L. Christensen, M. Llerena, T. J. L. C. Bakx, F. Belfiore, D. Bevacqua, M. Dickinson, A. Fontana, G. Gandolfi, T. Gasparetto, A. Marconi, S. Mascia, E. Merlin, T. Morishita, T. Nanayakkara, D. Paris, L. Pentericci, B. P\'erez-D\'iaz, G. Roberts-Borsani, S. Rojas Ruiz, P. Santini, T. Treu, E. Vanzella, B. Vulcani, X. Wang, I. Yoon, J. Zavala

28. [The Impact of Irradiation on the Radius and Thermal Evolution of Transiting Brown Dwarfs](#user-content-link28)
**Authors:** Sagnick Mukherjee, Jonathan J. Fortney, Theron W. Carmichael, C. Evan Davis, Daniel P. Thorngren

29. [PolySwyft: sequential simulation-based nested sampling](#user-content-link29)
**Authors:** Kilian H. Scheutwinkel, Will Handley, Christoph Weniger, Eloy de Lera Acedo

30. [Evidence for evolving Dark Energy from a new cosmic probe](#user-content-link30)
**Authors:** Isaque Dutra, Colin J. Burke, Priyamvada Natarajan, Weixiang Yu

31. [Magnetic activity of ultracool dwarfs in the LAMOST DR11](#user-content-link31)
**Authors:** Yue Xiang, Shenghong Gu, Dongtao Cao

32. [Self-lensing flares from black hole binaries V: systematic searches in LSST](#user-content-link32)
**Authors:** Kevin Park, Zoltan Haiman, Chengcheng Xin, Tzuken Shen, Ashley Villar, Jordy Davelaar

33. [Supernovae Shock Breakout from Red Supergiants in Two Dimensions](#user-content-link33)
**Authors:** Wun-Yi Chen, Ke-Jung Chen, Keiichi Maeda, Masaomi Ono, Po-Sheng Ou, F. K. Roepke

34. [The mass-to-flux ratio in molecular clouds. What are we really measuring?](#user-content-link34)
**Authors:** Aris Tritsis

35. [The Two-Infall Model Revisited: Constraints on Milky Way Bulge Assembly from >30,000 Galactic Chemical Evolution Models and Machine Learning](#user-content-link35)
**Authors:** Niall Miller, Meridith Joyce, Christian I. Johnson, Jamie Tayar, Thomas Trueman, R Michael Rich

36. [The impact of lunar topography on the 21-cm power spectrum for grid-based arrays : Insights for the Dark-ages EXplorer (DEX)](#user-content-link36)
**Authors:** S. Ghosh, L. V. E. Koopmans, C. Brinkerink, A. R. Offringa, A. J. Boonstra, S. A. Brackenhoff, E. Ceccotti, J. K. Chege, L. Y. Gao, B. K. Gehlot, L. I. Gurvits, C. H\"ofer, F. G. Mertens, M. Mevius, S. Munshi, A. Saxena, J. A. Tauber, H. Vedantham, S. Yatawatta, S. Zaroubi

37. [The Milky Way Imaging Scroll Painting Survey: Data Release 1](#user-content-link37)
**Authors:** Ji Yang (Qinghai), Qing-Zeng Yan (Qinghai), Yang Su (Qinghai), Shaobo Zhang (Qinghai), Xin Zhou (Qinghai), Yan Sun (Qinghai), Yiping Ao (Qinghai), Xuepeng Chen (Qinghai), Zhiwei Chen (Qinghai), Fujun Du (Qinghai), Min Fang (Qinghai), Yan Gong (Qinghai), Zhibo Jiang (Qinghai), Shengyu Jin (Qinghai), Chong Li (Qinghai), Yingjie Li (Qinghai), Yi Liu (Qinghai), Dengrong Lu (Qinghai), Chunsheng Luo (Qinghai), Yuehui Ma (Qinghai), Ruiqing Mao (Qinghai), Jixian Sun (Qinghai), Chen Wang (Qinghai), Hongchi Wang (Qinghai), Min Wang (Qinghai), Min Wang (Qinghai), Xindong Wang, Wenting Xu, Ye Xu, Kun Yan, Ping Yan, Lixia Yuan, Miaomiao Zhang, Yongxing Zhang

38. [SAGAN-VI: When Jets Meet Filaments -- Environmental Imprints on the Growth of Giant Radio Galaxies](#user-content-link38)
**Authors:** Mousumi Mahato, Elmo Tempel, Shishir Sankhyayan, Pratik Dabhade, Kshitij Chavan

39. [Open Effective Field Theory and the Physics of Cosmological Collider Signals](#user-content-link39)
**Authors:** Thomas Colas, Zhehan Qin, Xi Tong

40. [Probing Cosmic Strings via Black Hole Quasinormal Modes in Gravitational Wave Astronomy](#user-content-link40)
**Authors:** Ishan Swamy, Deobrat Singh

41. [Machine learning classification of baseband data of CHIME FRBs](#user-content-link41)
...
42. [Dark Photons in the Early Universe: From Thermal Production to Cosmological Constraints](#user-content-link42)
**Authors:** Xun-Jie Xu, Boting Zhou

43. [Relativistic MHD simulations of merging and collapsing stars and effects on GRB transient](#user-content-link43)
**Authors:** Agnieszka Janiuk, Gerardo Urrutia, Joseph Saji, Piotr Plonka

44. [Self-lensing of moving gravitational-wave sources can break the microlensing crossing timescale degeneracy](#user-content-link44)
**Authors:** Helena Ubach

45. [Detecting Neutrino Emission from Supernova Remnants: A Theoretically Motivated Target Catalog](#user-content-link45)
**Authors:** Emily Simon, Rebecca Diesing, Damiano Caprioli, Stephen Sclafani

46. [Isocurvature Induced Gravitational Waves at Pulsar Timing Arrays](#user-content-link46)
**Authors:** Yi-Fu Cai, Peizhi Du, Jiahang Zhong

47. [A search for successful and choked jets in nearby broad-lined Type Ic supernovae](#user-content-link47)
...
48. [Infrared Freeze-In of Magnetic Dipole Dark Matter](#user-content-link48)
**Authors:** Asher Berlin, Jae Hyeok Chang, Tanner Trickle

49. [Detection of 27 Candidate Circumbinary Planets Through Apsidal Precession of Eclipsing Binaries Observed by TESS](#user-content-link49)
**Authors:** Margo Thornton, Benjamin T. Montet, Riley White, Arden Shao, Diya T. Kumar

50. [Measuring the diffuse Galactic synchrotron spectral index and curvature between 45 and 2300 MHz](#user-content-link50)
**Authors:** Melis O. Irfan, Giuseppe Puglisi

51. [The dynamic central environment of NGC 3516 revealed by XRISM](#user-content-link51)
**Authors:** Anna Jur\'a\v{n}ov\'a, Erin Kara, Ehud Behar, Elisa Costantini, Jon M. Miller, Daniele Rogantini, James N. Reeves, Valentina Braito, Jacobo Ebrero, Luigi Gallo, Noa Keshet, Gerard A. Kriss, Missagh Mehdipour, Hirofumi Noda, Atsushi Tanimoto, Francesco Tombesi, Tracey J. Turner, Satoshi Yamada

52. [Foreground Mitigation for CMB Lensing with the Global Minimum Variance Quadratic Estimator](#user-content-link52)
**Authors:** Yuka Nakato, W. L. Kimmy Wu, Ana Carolina Silva Oliveira, Yuuki Omori, Abhishek S. Maniyar

53. [A Bayesian Approach Study of Hybrid Neutron Stars](#user-content-link53)
**Authors:** F\'abio K\"opp, C\'esar H. Lenzi, C\'esar V. Flores, and D\'ebora P. Menezes

54. [Noble gravitational atoms: Self-gravitating black hole scalar wigs with angular momentum number](#user-content-link54)
**Authors:** Miguel Alcubierre, Juan Barranco, Argelia Bernal, Juan Carlos Degollado, Alberto Diez-Tejedor, Miguel Megevand, Dario Nunez, Olivier Sarbach

55. [Careless Whispers: A population of sub-threshold post-merger gravitational waves constrains the hot nuclear equation of state](#user-content-link55)
**Authors:** Fiona H. Panther, Paul D. Lasky

56. [Superluminal constraints from ultra-high-energy neutrino events](#user-content-link56)
**Authors:** J. M. Carmona, J. L. Cort\'es, M. A. Reyes

57. [The SOFIA Massive(SOMA)Radio Survey. III. Radio Emission from Intermediate-Mass Protostars](#user-content-link57)
**Authors:** Francisco Sequeira-Murillo, Viviana Rosero, Joshua Marvil, Jonathan C. Tan, Ruben Fedriani, Yichen Zhang, Prasanta Gorai, James M. De Buizer, Maria T. Beltr\'an

58. [Delving into the depths of NGC 3783 with XRISM III. Birth of an ultrafast outflow during a soft flare](#user-content-link58)
...
59. [Stellar Multiplicity via Speckle Interferometry with the 3.6 m Devasthal Optical Telescope](#user-content-link59)
**Authors:** Km Nitu Rai, Neelam Panwar, Jeewan C Pandey, T S Kumar, Subrata Sarangi, Prasenjit Saha

60. [Was the Solar System's dynamical instability triggered by a (sub)stellar flyby?](#user-content-link60)
**Authors:** Sean N. Raymond, Nathan A. Kaib

61. [Chemical analysis of the Milky Way's Nuclear Star Cluster: Evidence for a metallicity gradient](#user-content-link61)
**Authors:** M. Schultheis, L. Serrano, B. Thorsbro, F. Nogueras-Lara, A. Feldmeier-Krause, G. Nandakumar, K. Fiteni, M. C. Sormani

62. [The GLEAM 4-Jy (G4Jy) Sample: IV. Multiwavelength data and analysis](#user-content-link62)
...
63. [On the existence of bound states in SIMP dark sectors](#user-content-link63)
**Authors:** Xiaoyong Chu, Josef Pradler, Daris Samart

64. [A magnetar outburst with atypical evolution: the case of Swift J1555.2-5402](#user-content-link64)
...
71. [Predicting Quasar Counts Detectable in the LSST Survey](#user-content-link71)
...
72. [Pulsars identified in the LOFAR Two-metre Sky Survey at 144 MHz](#user-content-link72)
**Authors:** G. A. C. Rijkers, C. G. Bassa, J. R. Callingham, T. Shimwell

73. [High-overtone ringdown fits: start time, no-hair tests, and correlations](#user-content-link73)
**Authors:** Erin Coleman, Eliot Finch

74. [Rapidly Spinning Massive Pulsars as an Indicator of Quark Deconfinement](#user-content-link74)
**Authors:** Christoph G\"artlein, Violetta Sagun, Oleksii Ivanytskyi, David Blaschke, Il\'idio Lopes

75. [The interstellar signature: A computational framework for open source interstellar tracking](#user-content-link75)
**Authors:** Pancha Narayan Sahu

76. [The Birth of Be Star Disks II. A High-Resolution Spectroscopic Campaign and TESS Observations of an Outburst of the Classical Be star {\lambda} Pavonis](#user-content-link76)
**Authors:** Sola S. Nova, Noel D. Richardson, Jonathan Labadie-Bartz, Samantha Garcia Flores

77. [Radiation pressure instability: from heart-beat states in black hole binary systems to Quasars and Changing-Look AGN](#user-content-link77)
**Authors:** Agnieszka Janiuk, Bozena Czerny, Pulkit Ojha, Yuri Cavecchi, Federico Vincentelli

78. [Microlensing Signatures of Dyson Sphere-like Structures around Primordial Black Holes as Technosignatures of Extraterrestrial Advanced Civilizations](#user-content-link78)
**Authors:** Shant Baghram

79. [Resolving the (Debate About) Nozzle Shocks in Tidal Disruption Events](#user-content-link79)
**Authors:** Zachary L. Andalman, Eliot Quataert, Eric R. Coughlin, C. J. Nixon

80. [First detection of X-ray polarization from the long-period X-ray pulsar 4U 1954+319](#user-content-link80)
**Authors:** Alexander Salganik, Lingda Kong, Sofia V. Forsblom, Menglei Zhou, Honghui Liu, Sergey S. Tsygankov, Andrea Santangelo, Juri Poutanen

81. [Centrifugal instability of Taylor-Couette flow in stratified and diffusive fluids](#user-content-link81)
**Authors:** Junho Park

82. [Time-Averaged Template for Stochastic Gravitational-Wave Background Detection in Space-Based Interferometers](#user-content-link82)
**Authors:** Jing-yi Wu, Yong Tang

83. [Inflationary Particle Production and the Swampland](#user-content-link83)
**Authors:** Dieter L\"ust, Joaquin Masias, Mauro Pieroni, Marco Scalisi

84. [The Strong-$CP$ Problem and its Gauge Axion solution as Evidence for Fundamental Strings](#user-content-link84)
**Authors:** Gia Dvali, Lucy Komisel, Otari Sakhelashvili, Anja Wachowitz

85. [Low-Mass Neutron Stars and Effective Phase Transitions from a Hybrid Van der Waals-Polytropic Equation of State](#user-content-link85)
**Authors:** P. H. F. Arruda, S. D. Campos

86. [Extremely energetic EUV late phase of a pair of C-class flares caused by a non-eruptive sigmoid](#user-content-link86)
**Authors:** Ya Wang, Sargam M. Mulay, Lyndsay Fletcher

87. [Single-field D-type inflation in the minimal supergravity in light of Planck-ACT-SPT data](#user-content-link87)
**Authors:** Yermek Aldabergenov, Sergei V. Ketov

88. [UVOIR spectrum, X-ray emission, and proper motion of the isolated neutron star RX J2143.0+0654](#user-content-link88)
**Authors:** George G. Pavlov (Pennsylvania State University), Vadim Abramkin (Independent Researcher), B. Posselt (University of Oxford, Pennsylvania State University)

89. [Neutrino mass constraints in the context of 4-parameter dark energy equation of state and DESI DR2 observations](#user-content-link89)
**Authors:** Gowri S Nair, Amlan Chakraborty, Luca Amendola, Subinoy Das

90. [Backwards Gamma-Ray Bursts: Searching for Exploding Primordial Black Holes in Short-Duration GRB Catalogs](#user-content-link90)
**Authors:** Stefano Profumo, Kally Wen

91. [Photochemistry of interstellar ice forming Complex Organic Molecules](#user-content-link91)
**Authors:** Guillermo M. Mu\~noz Caro, H\'ector Carrascosa de Lucas, Rafael Mart\'in-Dom\'enech

92. [The HIP 54515 b Superjovian Planet as an Early, Critical Look at the Roman Coronagraph's Performance in the Faint Target Star, Small IWA Limit](#user-content-link92)
**Authors:** Thayne Currie, Yiting Li, Brianna Lacy, Mona El Morsy, Masayuki Kuzuhara, Naoshi Murakami, Danielle Bovie

93. [Astrometric Reconnaissance of Exoplanetary Systems (ARES). I. Methodology validation with HST point-source images of Proxima Centauri](#user-content-link93)
**Authors:** M. Libralato, L. Bedin, A. Burgasser

94. [Can meridional flow variations explain the observed rising/declining phase asymmetry in the solar cycle?](#user-content-link94)
**Authors:** Soumitra Hazra, Allan Sacha Brun, Laurene Jouve

95. [Neutrino pair bremsstrahlung due to electromagnetic collisions in neutron star cores revisited](#user-content-link95)
**Authors:** P. S. Shternin

96. [Impact on orbital period of X-ray Binary system attached to a cosmic string](#user-content-link96)
**Authors:** Ishan Swamy, Deobrat Singh

97. [Solar neutron and muon detection on November 11, 2025: First simultaneous recovery of energy spectra](#user-content-link97)
**Authors:** A. Chilingarian, B. Sargsyan, L. Kozliner, T. Karapetyan

98. [Follow-up Observations of Candidate White Dwarf Planets with MIRI](#user-content-link98)
**Authors:** Fergal Mullally, Susan E. Mullally, Misty Cracraft, Samantha N. Bianco, Loic Albert, John Debes, J. J. Hermes, Mukremin Kilic, William T. Reach

99. [Stochastic gravitational-wave background search using data from five pulsar timing arrays](#user-content-link99)
**Authors:** Wang-Wei Yu, Bruce Allen

100. [Small-scale bright point characteristics at high-resolution with the Daniel K. Inouye Solar Telescope](#user-content-link100)
**Authors:** Peter H. Keys, Ryan J. Campbell, Dylan K. J. Magill, Mateus A. Keating, Mihalis Mathioudakis, David B. Jess, Damian J. Christian, Arthur Berberyan, Samuel D. T. Grant, Shahin Jafarzadeh, Marco Stangalini, Robertus Erd\'elyi

101. [Optical polarimetry of the accreting black hole X-ray binary Swift J1727.8$-$1613 over the state transition and radio ejections](#user-content-link101)
**Authors:** Anagha P. Nitindala, Alexandra Veledina, Vadim Kravtsov, Andrei V. Berdyugin, Mar\'ia Alejandra D\'iaz Teodori, Vilppu Piirola, Takeshi Sakanoi, Masato Kagitani, Svetlana V. Berdyugina, Juri Poutanen

102. [Improvements to the NSO Farside Mapping Pipeline: Noise Reduction Updates](#user-content-link102)
**Authors:** Mitchell Creelman, Kiran Jain, Niles Oien, John Britanik, Thomas M. Wentzel

103. [SATMO: a Multi-Planet Thermal Analysis Tool for CubeSat Missions](#user-content-link103)
**Authors:** Alexander Chipps, Daniel Forgette, Kerri Cahoy

104. [NICER Perspective on TeV Blazar Mrk~421: X-ray Variability and Particle Acceleration](#user-content-link104)
**Authors:** Sangeetha Kizhakkekalam, Gopal Bhatta, Navaneeth P K, Tek P. Adhikari

---

## 1. [Predicting Infall Time of Milky-Way Satellites via Machine Learning](https://arxiv.org/abs/2512.08792) <a id="link1"></a>
...
**Comment:** This paper presents a machine learning method to predict the infall time of Milky Way dwarf satellites, using semi-analytic models and features like star formation history and metallicity. It directly addresses near-field cosmology (Milky Way satellites, infall times, quenching) and resolved star formation histories, making it highly relevant. The use of machine learning for this purpose is novel.
...
## 2. [Forecasting Dark Matter Subhalo Constraints from Stellar Streams using Implicit Likelihood Inference](https://arxiv.org/abs/2512.07960) <a id="link2"></a>
...
**Comment:** This paper uses neural posterior estimation and particle spray simulations to forecast constraints on dark matter subhalos from stellar stream kinematics, focusing on the ATLAS-Aliqa Uma stream. This is highly relevant to near-field cosmology, substructure, and numerical galaxy simulations, with direct application to upcoming surveys.
...
## 3. [Core-halo scaling relations in self-interacting scalar field dark matter](https://arxiv.org/abs/2512.07020) <a id="link3"></a>
...
**Comment:** This paper uses numerical simulations to study the impact of self-interactions on scalar field dark matter halos, including core-halo scaling relations. The focus on dark matter density profiles and core properties is highly relevant to near-field cosmology and the core-cusp problem. The use of new simulations and extension of scaling relations adds novelty.
...
## 4. [High-Redshift Galactic Outflows: Orientation Effects, Kinematics, and Metallicity in TNG50 and SERRA](https://arxiv.org/abs/2512.08543) <a id="link4"></a>
...
**Comment:** Analyzes galactic outflows in high-redshift, low-mass galaxies using TNG50 and SERRA simulations, comparing to JWST observations. Directly relevant to 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria, especially for low-mass galaxies.
...
## 5. [HI-detected Dwarf Galaxies in the FASHI Survey: Insights from Single- and Double-Peaked Emission-Line Samples](https://arxiv.org/abs/2512.08644) <a id="link5"></a>
...
**Comment:** This paper presents a sample of HI-detected dwarf galaxies, focusing on their stellar mass densities, HI profiles, and dynamical states. It directly addresses the properties and evolution of dwarf galaxies, which is highly relevant to near-field cosmology. The analysis of HI profiles and their connection to galaxy structure and formation pathways is novel and provides new insights into low-mass galaxy evolution.
...
## 6. [Globular Cluster Systems in Dwarf Galaxies: Catalogs and Comparisons](https://arxiv.org/abs/2512.08453) <a id="link6"></a>
...
**Comment:** This paper compiles and analyzes globular cluster system masses and halo masses for dwarf galaxies, comparing classical dwarfs, ultra diffuse galaxies, and low-surface-brightness galaxies. It is highly relevant to near-field cosmology, as it addresses the properties and scaling relations of dwarf galaxies and their substructure.
...
## 8. [The MAGPI Survey: forward modelled gas-phase metallicity gradients in galaxies at $z\sim 0.3$](https://arxiv.org/abs/2512.08112) <a id="link8"></a>
...
**Comment:** Measures gas-phase metallicity gradients in star-forming galaxies at z~0.3, discussing the role of stellar feedback, gas transport, and accretion. This matches the 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria, as it connects metallicity gradients to feedback and gas mixing processes.
...
## 9. [How is cold, star-forming gas in galaxies affected by magnetic fields?](https://arxiv.org/abs/2512.07948) <a id="link9"></a>
...
**Comment:** Presents Arepo simulations of an isolated star-forming galaxy with and without magnetic fields, examining the impact on star formation and the KS relation. This matches the 'Numerical Galaxy Simulations' criterion, with additional relevance for star formation and ISM physics.
...
## 10. [Collisional rate coefficients for OH-H$_2$ at high temperatures](https://arxiv.org/abs/2512.08420) <a id="link10"></a>
...
**Comment:** Presents new collisional rate coefficients for OH-H2 at high temperatures, which are relevant for stellar atmosphere and ISM modeling. This fits the 'Stellar Models' criterion, as it provides new molecular data for astrophysical modeling.
...
## 11. [Spatially Resolved Physical Properties of Young Star Clusters and Star-forming Clumps in the Brightest z>6 Galaxy, the Strongly Lensed Cosmic Spear at z=6.2](https://arxiv.org/abs/2512.08054) <a id="link11"></a>
...
**Comment:** This paper presents spatially resolved analysis of stellar populations and star-forming clumps in a high-redshift galaxy, including star clusters and feedback-driven channels. It is relevant to resolved star formation histories and star formation driven outflows, though the galaxy is not a dwarf and the focus is on high-redshift environments.
...
## 12. [Near-IR CO and CN in classical Cepheids](https://arxiv.org/abs/2512.08831) <a id="link12"></a>
...
**Comment:** This paper presents near-IR spectral measurements of CO and CN in classical Cepheids, focusing on CNO abundances and stellar atmosphere fitting. It matches the 'Stellar Models' criterion, as it involves stellar atmosphere modeling and abundance analysis.
...
## 13. [On the missing dust of super-early galaxies: Supernova blowout and gas-dust venting in Blue Monsters](https://arxiv.org/abs/2512.07945) <a id="link13"></a>
...
**Comment:** This paper investigates the lack of dust in super-early galaxies (Blue Monsters) and models mechanical blowout and gas-dust venting by supernovae. While focused on high-redshift galaxies, it is relevant to star formation driven outflows and the circumgalactic medium, especially in the context of dust removal and feedback processes.
...
## 14. [Inferring main-sequence stage and buoyancy-glitch amplitudes from Fourier spectra of gravity-mode period spacings: Ensemble Analysis of 26 Slowly Pulsating B Stars](https://arxiv.org/abs/2512.08155) <a id="link14"></a>
...
**Comment:** This paper presents a new method for inferring main-sequence evolutionary stage and buoyancy-glitch amplitudes in Slowly Pulsating B stars using asteroseismology. While it deals with stellar models and evolutionary tracks, the focus is on intermediate-mass stars rather than low-mass stars or dwarf galaxies. Relevant to stellar models, but not a direct match to the highest priority criteria.
...
## 15. [Probing the Warm Dark Matter mass with [C II] intensity mapping](https://arxiv.org/abs/2512.07933) <a id="link15"></a>
...
**Comment:** Uses [C II] intensity mapping to probe warm dark matter mass, focusing on the power spectrum and halo model. Some relevance to near-field cosmology via constraints on dark matter and substructure, but not focused on dwarf galaxies or resolved star formation histories.
...
## 16. [Chemical Signatures of AGB Mass Transfer in Gaia White Dwarf Companions](https://arxiv.org/abs/2512.07972) <a id="link16"></a>
...
**Comment:** This paper presents a homogeneous abundance analysis of main-sequence stars in white dwarf + main-sequence binaries, focusing on chemical signatures of AGB mass transfer. The work is relevant to the 'Stellar Models' criterion, as it discusses nucleosynthesis and abundance patterns, and also touches on binary mass-transfer physics. However, it does not directly address galaxy-scale topics such as near-field cosmology or star formation histories, so relevance is moderate.
...
## 17. [Tracing Nitrogen Enrichment across Cosmic Time with JWST](https://arxiv.org/abs/2512.07955) <a id="link17"></a>
...
**Comment:** This paper analyzes nitrogen-to-oxygen abundance ratios in star-forming galaxies across cosmic time using JWST data. It discusses chemical enrichment, star formation history burstiness, and outflows, but the focus is on general star-forming galaxies at z~1-6, not specifically on dwarf galaxies or resolved star formation histories from color-magnitude diagrams. Some relevance to star formation driven outflows and chemical enrichment, but not a close match.
...
## 18. [Probing the environment around GW170817 with DESI: insights on galaxy group peculiar velocities for standard siren measurements](https://arxiv.org/abs/2512.08818) <a id="link18"></a>
...
**Comment:** Studies the environment around GW170817 and its impact on Hubble constant measurements, focusing on galaxy group dynamics. Some relevance to near-field cosmology via group membership and local dynamics, but not focused on dwarf satellites or resolved star formation histories.
...
## 19. [FIRESTORM I: Stellar Feedback and Gas Kinematics in the Evolved W40 Hub-Filament System](https://arxiv.org/abs/2512.08811) <a id="link19"></a>
...
**Comment:** Multiwavelength study of the W40 star-forming region, focusing on stellar feedback, gas kinematics, and filamentary structure. While it discusses stellar feedback and star formation, the focus is on a high-mass star-forming region within the Milky Way, not on dwarf galaxies or galaxy-scale outflows. Borderline relevance for star formation driven outflows and feedback.
...
## 22. [Danger Zone: Establishing Buffers for Enhanced Classification in BPT Diagrams](https://arxiv.org/abs/2512.07975) <a id="link22"></a>
...
**Comment:** This paper applies machine learning to classify optical spectra from the MaNGA survey, focusing on distinguishing star-forming regions, Seyferts, and LINERs using BPT diagrams. While it involves galaxy spectra and star formation classification, the work is primarily on spectral classification and does not directly address resolved star formation histories, dwarf galaxies, or galaxy simulations. It is borderline relevant due to its connection to star formation diagnostics.
...
## 23. [The frame-dragging vector potential on galaxy scales from DM-only Newtonian $N$-body simulations](https://arxiv.org/abs/2512.08703) <a id="link23"></a>
...
**Comment:** Analyzes the frame-dragging vector potential from DM-only Newtonian N-body simulations, extending previous work to galactic scales. While it uses galaxy simulations, the focus is on relativistic effects and not on galaxy formation, star formation, or feedback. Borderline relevance for numerical galaxy simulations.
...
## 24. [Exploring the binary origin of B and Be rapid rotators](https://arxiv.org/abs/2512.08821) <a id="link24"></a>
...
**Comment:** This paper explores the binary origin of B and Be rapid rotators, discussing mass transfer and evolutionary pathways. While it touches on stellar evolution and binary interaction, it does not present new stellar models or address the other core topics directly.
...
## 25. [The Radius of PSR J0437-4715 from NICER Data](https://arxiv.org/abs/2512.08790) <a id="link25"></a>
...
**Comment:** NICER data analysis for neutron star radius measurement. While it involves stellar modeling, it is focused on neutron stars rather than general stellar evolutionary tracks or atmospheres, and does not address galaxy or star formation topics.
...
## 26. [The Head-on Collision of a Neutron Star with a White Dwarf](https://arxiv.org/abs/2512.08231) <a id="link26"></a>
...
**Comment:** Simulates head-on collisions between neutron stars and white dwarfs, exploring thermonuclear explosions and Thorne-Zytkow-like object formation. While interesting for stellar evolution, it does not present new stellar models or address galaxy evolution, star formation, or near-field cosmology.
...
## 27. [Investigating ionising sources and the complex interstellar medium of GHZ2 at $z=12.3$](https://arxiv.org/abs/2512.08490) <a id="link27"></a>
...
**Comment:** This paper investigates the ionising sources and ISM properties of a high-redshift galaxy (GHZ2 at z=12.3) using multi-zone photoionisation modeling. While it discusses star formation and ISM structure, the focus is on a very high-redshift, UV-bright galaxy, not resolved star formation histories or dwarf galaxies in the local universe.
...
## 28. [The Impact of Irradiation on the Radius and Thermal Evolution of Transiting Brown Dwarfs](https://arxiv.org/abs/2512.08249) <a id="link28"></a>
...
**Comment:** This paper develops atmospheric and evolutionary models for transiting brown dwarfs, focusing on irradiation effects. While it presents new stellar models, these are for brown dwarfs and giant exoplanets, not stars relevant to resolved star formation histories or stellar models for galaxies.
...
## 29. [PolySwyft: sequential simulation-based nested sampling](https://arxiv.org/abs/2512.08316) <a id="link29"></a>
...
**Comment:** PolySwyft is a new simulation-based inference framework for complex posterior distributions, demonstrated on cosmological parameter inference from CMB power spectra. While it is a methodological advance in cosmological inference, it does not directly address near-field cosmology, resolved star formation histories, or galaxy simulations relevant to the prompt.
...
## 31. [Magnetic activity of ultracool dwarfs in the LAMOST DR11](https://arxiv.org/abs/2512.08305) <a id="link31"></a>
...
**Comment:** The study investigates magnetic activity and rotation in ultracool dwarfs, which are low-mass stars and brown dwarfs. While it touches on stellar properties, it does not present new stellar models or focus on resolved star formation histories, quenching, or galaxy-scale phenomena.
...
## 32. [Self-lensing flares from black hole binaries V: systematic searches in LSST](https://arxiv.org/abs/2512.08427) <a id="link32"></a>
...
**Comment:** Systematic search for self-lensing flares from supermassive black hole binaries in LSST quasar light curves. Focuses on SMBHBs and quasar variability, which does not match the core criteria related to dwarf galaxies, star formation, or galaxy simulations.
...
## 33. [Supernovae Shock Breakout from Red Supergiants in Two Dimensions](https://arxiv.org/abs/2512.08212) <a id="link33"></a>
...
**Comment:** This paper presents 2D radiation hydrodynamic simulations of supernova shock breakout from red supergiants, focusing on the effects of circumstellar media and mass-loss histories. While it involves numerical simulations and stellar models, the focus is on massive stars (20-25 Msun) and supernovae, not dwarf galaxies or near-field cosmology. It does not address resolved star formation histories, quenching, or CGM in dwarfs.
...
## 34. [The mass-to-flux ratio in molecular clouds. What are we really measuring?](https://arxiv.org/abs/2512.07943) <a id="link34"></a>
...
**Comment:** This paper uses 3D MHD simulations to study the mass-to-flux ratio in molecular clouds and the biases in observational measurements. While it involves numerical simulations and star formation, the focus is on molecular clouds and magnetic fields, not on galaxies, their satellites, or resolved star formation histories.
...
## 35. [The Two-Infall Model Revisited: Constraints on Milky Way Bulge Assembly from >30,000 Galactic Chemical Evolution Models and Machine Learning](https://arxiv.org/abs/2512.08090) <a id="link35"></a>
...
**Comment:** This paper uses chemical evolution models and machine learning to constrain the formation history of the Milky Way bulge. The focus is on the bulge, not on dwarf galaxies, satellite systems, or resolved star formation histories of galaxies. It is not directly relevant to the core criteria.
...
## 36. [The impact of lunar topography on the 21-cm power spectrum for grid-based arrays : Insights for the Dark-ages EXplorer (DEX)](https://arxiv.org/abs/2512.08906) <a id="link36"></a>
...
**Comment:** Focuses on the technical challenges of measuring the 21-cm signal from the Dark Ages using a lunar array. While relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, or galaxy-scale phenomena.
...
## 37. [The Milky Way Imaging Scroll Painting Survey: Data Release 1](https://arxiv.org/abs/2512.08260) <a id="link37"></a>
...
**Comment:** Presents a large-scale CO survey of the northern Galactic plane, focusing on molecular clouds in the Milky Way. The work is focused on the Galactic disk and molecular gas, not on dwarf galaxies, satellite systems, or resolved star formation histories.
...
## 38. [SAGAN-VI: When Jets Meet Filaments -- Environmental Imprints on the Growth of Giant Radio Galaxies](https://arxiv.org/abs/2512.07985) <a id="link38"></a>
...
**Comment:** This paper studies the environmental impact of cosmic filaments on the growth of giant radio galaxies. The focus is on massive radio galaxies, not dwarf galaxies or near-field cosmology.
...
## 39. [Open Effective Field Theory and the Physics of Cosmological Collider Signals](https://arxiv.org/abs/2512.07941) <a id="link39"></a>
...
**Comment:** Examines cosmological collider signals using open effective field theory. This is a theoretical cosmology paper and does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 40. [Probing Cosmic Strings via Black Hole Quasinormal Modes in Gravitational Wave Astronomy](https://arxiv.org/abs/2512.08368) <a id="link40"></a>
...
**Comment:** Proposes a method to detect cosmic strings via black hole quasinormal modes in gravitational wave signals. This is not relevant to the core criteria focused on galaxies, star formation, or stellar models.
...
## 41. [Machine learning classification of baseband data of CHIME FRBs](https://arxiv.org/abs/2512.08308) <a id="link41"></a>
...
**Comment:** Applies machine learning to classify FRBs using CHIME baseband data. While interesting for transient astronomy, it does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 42. [Dark Photons in the Early Universe: From Thermal Production to Cosmological Constraints](https://arxiv.org/abs/2512.08528) <a id="link42"></a>
...
**Comment:** This paper analyzes the thermal production and cosmological constraints of dark photons in the early universe. While it is relevant to cosmology, it does not address near-field cosmology, galaxy simulations, or any of the core topics.
...
## 43. [Relativistic MHD simulations of merging and collapsing stars and effects on GRB transient](https://arxiv.org/abs/2512.08489) <a id="link43"></a>
...
**Comment:** The paper presents relativistic MHD simulations of merging and collapsing stars, focusing on GRB transients and their environments. While it involves numerical simulations, the focus is on compact objects and high-energy transients, not on galaxy simulations or the core topics.
...
## 44. [Self-lensing of moving gravitational-wave sources can break the microlensing crossing timescale degeneracy](https://arxiv.org/abs/2512.08898) <a id="link44"></a>
...
**Comment:** This paper studies gravitational lensing effects on gravitational wave signals from moving sources, with implications for measuring MBH properties. It does not address galaxy formation, dwarf galaxies, star formation histories, or outflows. No direct match to the core criteria.
...
## 45. [Detecting Neutrino Emission from Supernova Remnants: A Theoretically Motivated Target Catalog](https://arxiv.org/abs/2512.07940) <a id="link45"></a>
...
**Comment:** Develops a catalog of supernova remnants for neutrino emission detection, focusing on cosmic ray acceleration. No direct relevance to the specified criteria.
...
## 46. [Isocurvature Induced Gravitational Waves at Pulsar Timing Arrays](https://arxiv.org/abs/2512.08301) <a id="link46"></a>
...
**Comment:** Studies gravitational waves induced by isocurvature perturbations in the early universe, with a focus on cosmological constraints. Does not match any of the core criteria (no focus on galaxies, star formation, or near-field cosmology).
...
## 47. [A search for successful and choked jets in nearby broad-lined Type Ic supernovae](https://arxiv.org/abs/2512.08822) <a id="link47"></a>
...
**Comment:** Studies broad-lined Type Ic supernovae and the link to gamma-ray bursts, focusing on jet properties and radio/X-ray observations. The focus is on supernovae and GRBs, not on galaxy formation, dwarf galaxies, or star formation histories.
...
## 48. [Infrared Freeze-In of Magnetic Dipole Dark Matter](https://arxiv.org/abs/2512.07927) <a id="link48"></a>
...
**Comment:** This paper discusses a novel mechanism for dark matter production via infrared freeze-in, focusing on magnetic dipole dark matter. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, galaxy simulations, or any of the other core topics.
...
## 49. [Detection of 27 Candidate Circumbinary Planets Through Apsidal Precession of Eclipsing Binaries Observed by TESS](https://arxiv.org/abs/2512.07934) <a id="link49"></a>
...
**Comment:** The paper presents a new method for detecting circumbinary planets via apsidal precession in eclipsing binaries. This is not related to any of the core topics such as near-field cosmology, star formation histories, quenching, or galaxy simulations.
...
## 50. [Measuring the diffuse Galactic synchrotron spectral index and curvature between 45 and 2300 MHz](https://arxiv.org/abs/2512.08522) <a id="link50"></a>
...
**Comment:** This paper presents an all-sky map of the Galactic synchrotron spectral index and curvature. While it is relevant to Galactic foregrounds, it does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 51. [The dynamic central environment of NGC 3516 revealed by XRISM](https://arxiv.org/abs/2512.07950) <a id="link51"></a>
...
**Comment:** This paper analyzes the central environment of the Seyfert galaxy NGC 3516 using XRISM, focusing on time-resolved X-ray spectroscopy and gas flows. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 52. [Foreground Mitigation for CMB Lensing with the Global Minimum Variance Quadratic Estimator](https://arxiv.org/abs/2512.08908) <a id="link52"></a>
...
**Comment:** This paper discusses foreground mitigation for CMB lensing reconstruction, focusing on estimator techniques and astrophysical contamination. It does not address any of the core topics.
...
## 53. [A Bayesian Approach Study of Hybrid Neutron Stars](https://arxiv.org/abs/2512.08911) <a id="link53"></a>
...
**Comment:** This paper focuses on neutron star interiors and phase transitions to quark matter, which is not directly related to any of the core topics (e.g., near-field cosmology, resolved star formation histories, dwarf galaxies, stellar models, galaxy simulations, outflows, or CGM).
...
## 54. [Noble gravitational atoms: Self-gravitating black hole scalar wigs with angular momentum number](https://arxiv.org/abs/2512.08095) <a id="link54"></a>
...
**Comment:** This paper presents new solutions for self-gravitating scalar field configurations around black holes, which is not directly related to any of the core topics (no focus on galaxies, star formation, or stellar models).
...
## 55. [Careless Whispers: A population of sub-threshold post-merger gravitational waves constrains the hot nuclear equation of state](https://arxiv.org/abs/2512.08497) <a id="link55"></a>
...
**Comment:** Discusses constraints on the hot nuclear equation of state using gravitational wave post-merger signals from neutron star mergers. While interesting for compact object physics, it does not match any of the core topics (no focus on galaxies, star formation, or stellar models).
...
## 56. [Superluminal constraints from ultra-high-energy neutrino events](https://arxiv.org/abs/2512.08523) <a id="link56"></a>
...
**Comment:** This paper focuses on ultra-high-energy neutrino events and Lorentz Invariance Violation constraints. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 57. [The SOFIA Massive(SOMA)Radio Survey. III. Radio Emission from Intermediate-Mass Protostars](https://arxiv.org/abs/2512.08105) <a id="link57"></a>
...
**Comment:** The study investigates radio emission from intermediate-mass protostars, focusing on their evolution and ionized jets. While it involves star formation and protostellar evolution, it does not address resolved star formation histories of galaxies, quenching, or near-field cosmology. The focus is on individual protostars, not galaxies or their satellites.
...
## 58. [Delving into the depths of NGC 3783 with XRISM III. Birth of an ultrafast outflow during a soft flare](https://arxiv.org/abs/2512.08448) <a id="link58"></a>
...
**Comment:** This paper studies ultrafast outflows in the AGN NGC 3783 using XRISM data. The focus is on AGN-driven outflows, not star-formation-driven outflows or CGM in dwarf galaxies. AGN outflows are specifically excluded from the relevant criteria.
...
## 59. [Stellar Multiplicity via Speckle Interferometry with the 3.6 m Devasthal Optical Telescope](https://arxiv.org/abs/2512.07971) <a id="link59"></a>
...
**Comment:** The paper discusses speckle interferometry for resolving stellar multiplicity and binary systems. While it involves stellar observations, it does not present new stellar models or address galaxy-scale phenomena relevant to the prompt.
...
## 60. [Was the Solar System's dynamical instability triggered by a (sub)stellar flyby?](https://arxiv.org/abs/2512.07979) <a id="link60"></a>
...
**Comment:** This paper investigates the possibility that the Solar System's dynamical instability was triggered by a (sub)stellar flyby. While it involves N-body simulations and dynamical evolution, it does not focus on galaxies, dwarf galaxies, or near-field cosmology. No direct match to the core criteria.
...
## 61. [Chemical analysis of the Milky Way's Nuclear Star Cluster: Evidence for a metallicity gradient](https://arxiv.org/abs/2512.08387) <a id="link61"></a>
...
**Comment:** This paper presents a chemical analysis of the Milky Way's Nuclear Star Cluster, focusing on metallicity gradients. The focus is on the Galactic center and nuclear star cluster, which is explicitly listed as irrelevant in the criteria.
...
## 62. [The GLEAM 4-Jy (G4Jy) Sample: IV. Multiwavelength data and analysis](https://arxiv.org/abs/2512.08008) <a id="link62"></a>

**ArXiv ID:** 2512.08008

**Authors:** Sarah V. White, Precious K. Sejake, Kshitij Thorat, Heinz Andernach, Thomas M. O. Franzen, O. Ivy Wong, Anna D. Kapinska, Joseph R. Callingham, Christopher J. Riseley, Nick Seymour, Randall Wayth, Lister Staveley-Smith, Rajan Chhetri, Natasha Hurley-Walker, John Morgan, Paul Hancock, Francesco Massaro, Abigail Garcia-Perez, Ana Jimenez-Gallardo, Harold A. Pena-Herazo

**Abstract:** We provide an updated 'multiwavelength' version of the G4Jy catalogue (available at https://github.com/svw26/G4Jy, https://zenodo.org/communities/g4jy/records, and through VizieR), which has 127 new host-galaxy identifications, as described in Paper III of this paper series. We also supplement the redshift information (0.0 < z  4 Jy). For example, we present (for the first time in the literature) the radio-power--size diagram as a function of radio spectral-curvature, [P--D](SCI), noting that the spectral-curvature index (SCI) can act as a proxy for the spectral age of the radio source. This radio-power--size--age diagram shows an interesting predominance of candidate remnant radio-galaxies (SCI > 0.15) with D < 200 kpc (although these may instead be young radio-sources), and a vast range of linear sizes for candidate restarted radio-galaxies (SCI < -0.15). We also show that (i) G4Jy sources populate the entirety of WISE colour-colour space, (ii) optically point-like sources (i.e. candidate quasars) are brighter than the well-studied K--z relation (as expected), and (iii) there is no relation between the SCI of the radio source and its host-galaxy properties.

**Comment:** This paper presents a multiwavelength catalogue and analysis of powerful radio galaxies from the GLEAM 4-Jy sample. The focus is on massive radio galaxies, not dwarf galaxies or near-field cosmology.
...
## 63. [On the existence of bound states in SIMP dark sectors](https://arxiv.org/abs/2512.08517) <a id="link63"></a>
...
**Comment:** This paper studies bound states in SIMP dark sectors, focusing on dark matter particle physics and freeze-out. It does not address galaxy formation, dwarf galaxies, or near-field cosmology.
...
## 64. [A magnetar outburst with atypical evolution: the case of Swift J1555.2-5402](https://arxiv.org/abs/2512.08692) <a id="link64"></a>
...
**Comment:** Focuses on magnetar outburst evolution, X-ray and radio observations. No direct relevance to near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 65. [von Zeipel-Kozai-Lidov oscillations in nearby bright stars. I. Lambda Ophiuchi](https://arxiv.org/abs/2512.07970) <a id="link65"></a>
...
**Comment:** Studies orbital dynamics and ZKL oscillations in a nearby multiple star system. No direct relevance to the specified criteria.
...
## 66. [Estimation of the Hubble parameter from unedited compact object merger catalogues](https://arxiv.org/abs/2512.08164) <a id="link66"></a>
...
**Comment:** Presents a framework for Hubble parameter estimation from compact object merger catalogues. No direct relevance to the specified criteria.
...
## 67. [Supermassive Black Holes with High Accretion Rates in Active Galactic Nuclei. XV. Reverberation Mapping of Mg II Emission Lines](https://arxiv.org/abs/2512.08192) <a id="link67"></a>
...
**Comment:** Focuses on reverberation mapping of Mg II emission lines in supermassive black holes in AGNs. The topic is supermassive black holes and AGN accretion, which is not relevant to the core criteria (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 68. [The Drivers of the Decline in Supermassive Black Hole Growth at $z<2$](https://arxiv.org/abs/2512.08004) <a id="link68"></a>

**ArXiv ID:** 2512.08004

**Authors:** Zhibo Yu, W. N. Brandt, Fan Zou, Bin Luo, Qingling Ni, D. P. Schneider, Fabio Vito

**Abstract:** It is well established that cosmic supermassive black hole (SMBH) growth peaks at $z\approx1.5-2$, followed by a strong decline of $\approx1-1.5\,\rm dex$ toward the present day, with the comoving number density of higher-luminosity active galactic nuclei (AGNs) peaking at higher redshift (referred to as "AGN downsizing"). We leverage the best current measurements of the SMBH accretion distribution, based upon data from nine well-characterized extragalactic fields with a "wedding-cake" design, to investigate and quantify the drivers of the drastic decline in cosmic SMBH growth. The decline in the typical Eddington ratio ($\lambda_\mathrm{Edd}$) of AGNs (decreasing by $\approx1.35\,\rm dex$ from $z\approx1.5-2$ to $z\approx0.2$) is the dominant driver for the broad decline in SMBH growth, rather than a shift of accretion activity to less-massive SMBHs. As $\lambda_\mathrm{Edd}$ decreases toward lower redshift, the primary contributor to the cosmic SMBH accretion density ($\rho_\mathrm{BHAR}$) has shifted from high-$\lambda_\mathrm{Edd}$ AGNs to low-$\lambda_\mathrm{Edd}$ AGNs, even though the latter always dominate the comoving AGN number density at $z<4$. We also find that the decline in SMBH growth toward lower SMBH mass in less-massive galaxies is primarily due to the decreasing outburst luminosity rather than the duty cycle.

**Comment:** Examines the decline in supermassive black hole growth at z<2, focusing on AGN downsizing and Eddington ratios. The focus is on SMBHs and AGN activity, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 69. [Analytical Solutions for the Dynamics of Planetary Nebulae with and without Common Envelope Evolution](https://arxiv.org/abs/2512.07987) <a id="link69"></a>
...
**Comment:** Presents analytical solutions for planetary nebulae dynamics, including common envelope evolution. The focus is on planetary nebulae and stellar evolution, not on galaxy formation, star formation histories, or dwarf galaxies.
...
## 70. [On the Type IIn SN 2025cbj coincidence with the high-energy neutrino IceCube-250421A](https://arxiv.org/abs/2512.07936) <a id="link70"></a>
...
**Comment:** This paper investigates the association between a Type IIn supernova and a high-energy neutrino event. While it is astrophysical, it does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 71. [Predicting Quasar Counts Detectable in the LSST Survey](https://arxiv.org/abs/2512.08654) <a id="link71"></a>
...
**Comment:** This paper predicts quasar and AGN counts for LSST, focusing on survey strategy and luminosity functions for quasars and AGNs. It does not address satellite galaxies, resolved star formation histories, or galaxy simulations.
...
## 72. [Pulsars identified in the LOFAR Two-metre Sky Survey at 144 MHz](https://arxiv.org/abs/2512.08663) <a id="link72"></a>
...
**Comment:** Presents identification of radio pulsars in LOFAR survey data. Pulsars are not directly relevant to the core topics (no focus on galaxies, star formation histories, or stellar models).
...
## 73. [High-overtone ringdown fits: start time, no-hair tests, and correlations](https://arxiv.org/abs/2512.08098) <a id="link73"></a>
...
**Comment:** Focuses on gravitational wave ringdown fits and tests of general relativity using black hole mergers. No connection to galaxy-scale phenomena, star formation, or stellar models.
...
## 74. [Rapidly Spinning Massive Pulsars as an Indicator of Quark Deconfinement](https://arxiv.org/abs/2512.07977) <a id="link74"></a>
...
**Comment:** This paper focuses on the physics of rapidly spinning massive pulsars and the quark deconfinement phase transition in hybrid stars. While it is astrophysical in nature, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models relevant to the prompt. The focus is on compact object physics rather than galaxy evolution or structure.
...
## 75. [The interstellar signature: A computational framework for open source interstellar tracking](https://arxiv.org/abs/2512.07910) <a id="link75"></a>
...
**Comment:** This paper presents an open-source computational framework for tracking interstellar objects. While it is related to astronomy and data analysis, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. Its focus is on interstellar object tracking and public engagement.
...
## 76. [The Birth of Be Star Disks II. A High-Resolution Spectroscopic Campaign and TESS Observations of an Outburst of the Classical Be star {\lambda} Pavonis](https://arxiv.org/abs/2512.08214) <a id="link76"></a>
...
**Comment:** This paper focuses on the disk formation and pulsational variability in a classical Be star. While it involves stellar phenomena and disk outbursts, it does not present new stellar interior or atmosphere models, nor does it address resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on a single massive star, not on galaxy-scale processes.
...
## 77. [Radiation pressure instability: from heart-beat states in black hole binary systems to Quasars and Changing-Look AGN](https://arxiv.org/abs/2512.08502) <a id="link77"></a>
...
**Comment:** This paper discusses radiation pressure instability in accretion disks around black holes and AGN, including heartbeat states and variability. While it touches on accretion physics and disk instability, it does not present new stellar models, nor does it address galaxy-scale processes, dwarf galaxies, or star formation histories. The focus is on compact objects and AGN, which are outside the core topics.
...
## 78. [Microlensing Signatures of Dyson Sphere-like Structures around Primordial Black Holes as Technosignatures of Extraterrestrial Advanced Civilizations](https://arxiv.org/abs/2512.07924) <a id="link78"></a>
...
**Comment:** Discusses microlensing signatures of hypothetical Dyson sphere-like structures around primordial black holes as technosignatures. No direct relevance to any of the specified criteria.
...
## 79. [Resolving the (Debate About) Nozzle Shocks in Tidal Disruption Events](https://arxiv.org/abs/2512.08928) <a id="link79"></a>
...
**Comment:** Focuses on nozzle shocks in tidal disruption events (TDEs) around supermassive black holes. TDEs are explicitly listed as irrelevant in the criteria.
...
## 80. [First detection of X-ray polarization from the long-period X-ray pulsar 4U 1954+319](https://arxiv.org/abs/2512.08195) <a id="link80"></a>
...
**Comment:** Reports X-ray polarization detection from a long-period X-ray pulsar. No direct relevance to the specified criteria.
...
## 81. [Centrifugal instability of Taylor-Couette flow in stratified and diffusive fluids](https://arxiv.org/abs/2512.08664) <a id="link81"></a>

**ArXiv ID:** 2512.08664

**Authors:** Junho Park

**Abstract:** The linear and non-linear dynamics of centrifugal instability in Taylor-Couette flow are investigated when fluids are stably stratified and highly diffusive. One-dimensional local linear stability analysis (LSA) on cylindrical Couette flow confirms that the stabilising role of stratification on centrifugal instability is suppressed by strong thermal diffusion (i.e. low Prandtl number $Pr$). For $Pr\ll1$, it is verified that the instability dependence on thermal diffusion and stratification with the non-dimensional Brunt-V\"ais\"al\"a frequency $N$ can be prescribed by a single rescaled parameter $P_{N}=N^{2}Pr$. From direct numerical simulation (DNS), various non-linear features such as axisymmetric Taylor vortices at saturation, secondary instability leading to non-axisymmetric patterns or transition to chaotic states are investigated for various values of $Pr\leq1$ and the Reynolds number $Re_{i}$. Two-dimensional bi-global LSA on axisymmetric Taylor vortices, which appear as primary centrifugal instability saturates nonlinearly, is also performed to find the secondary critical Reynolds number $Re_{i,2}$ at which the Taylor vortices become unstable by non-axisymmetric perturbation. The bi-global LSA reveals that $Re_{i,2}$ increases (i.e. the onset of secondary instability is delayed) in the range $10^{-3}<1$ at $N=1$ or as $N$ increases at $Pr=0.01$. Secondary instability leading to highly non-axisymmetric or irregular chaotic patterns is further investigated by the 3D DNS. The Nusselt number $Nu$ is also computed from the torque at the inner cylinder for various $Pr$ and $Re_{i}$ at $N=1$ to describe how the angular momentum transfer increases with $Re_{i}$ and how $Nu$ varies differently for saturated and chaotic states.

**Comment:** Studies centrifugal instability in Taylor-Couette flow in stratified and diffusive fluids. This is a fluid dynamics paper and does not match any of the core criteria.
...
## 82. [Time-Averaged Template for Stochastic Gravitational-Wave Background Detection in Space-Based Interferometers](https://arxiv.org/abs/2512.08521) <a id="link82"></a>
...
**Comment:** Focuses on gravitational-wave background detection methods for space-based interferometers. No direct relevance to the specified criteria.
...
## 83. [Inflationary Particle Production and the Swampland](https://arxiv.org/abs/2512.07930) <a id="link83"></a>
...
**Comment:** Discusses inflationary particle production and swampland conjecture, with no direct relevance to the specified criteria.
...
## 84. [The Strong-$CP$ Problem and its Gauge Axion solution as Evidence for Fundamental Strings](https://arxiv.org/abs/2512.08834) <a id="link84"></a>
...
**Comment:** This paper discusses the strong-CP problem and axion solutions, focusing on fundamental strings and gauge theory. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 85. [Low-Mass Neutron Stars and Effective Phase Transitions from a Hybrid Van der Waals-Polytropic Equation of State](https://arxiv.org/abs/2512.08672) <a id="link85"></a>
...
**Comment:** Explores phase transitions in neutron stars using analytic EOS models. The topic is neutron star structure and phase transitions, not related to the core criteria (galaxy formation, star formation, dwarf galaxies, etc.).
...
## 86. [Extremely energetic EUV late phase of a pair of C-class flares caused by a non-eruptive sigmoid](https://arxiv.org/abs/2512.08324) <a id="link86"></a>
...
**Comment:** Examines the EUV late phase of solar flares caused by a non-eruptive sigmoid, focusing on solar physics and magnetic reconnection. Not relevant to any of the core criteria.
...
## 87. [Single-field D-type inflation in the minimal supergravity in light of Planck-ACT-SPT data](https://arxiv.org/abs/2512.08760) <a id="link87"></a>
...
**Comment:** This is a theoretical cosmology paper on inflation models in supergravity, with no connection to the core topics (e.g., dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 90. [Backwards Gamma-Ray Bursts: Searching for Exploding Primordial Black Holes in Short-Duration GRB Catalogs](https://arxiv.org/abs/2512.08778) <a id="link90"></a>
...
**Comment:** This paper searches for signatures of primordial black hole evaporation in short gamma-ray burst catalogs. It does not address any of the core criteria.
...
## 91. [Photochemistry of interstellar ice forming Complex Organic Molecules](https://arxiv.org/abs/2512.08413) <a id="link91"></a>
...
**Comment:** This paper reviews the photochemistry of interstellar ice and the formation of complex organic molecules. While interesting for astrochemistry, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 92. [The HIP 54515 b Superjovian Planet as an Early, Critical Look at the Roman Coronagraph's Performance in the Faint Target Star, Small IWA Limit](https://arxiv.org/abs/2512.07942) <a id="link92"></a>
...
**Comment:** This paper discusses the Roman Coronagraph's performance in imaging exoplanets around faint stars. It does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 93. [Astrometric Reconnaissance of Exoplanetary Systems (ARES). I. Methodology validation with HST point-source images of Proxima Centauri](https://arxiv.org/abs/2512.08533) <a id="link93"></a>
...
**Comment:** This paper presents astrometric methodology for exoplanetary systems using HST data, focusing on Proxima Centauri. It is unrelated to near-field cosmology, resolved star formation histories, galaxy simulations, or any of the core topics.
...
## 94. [Can meridional flow variations explain the observed rising/declining phase asymmetry in the solar cycle?](https://arxiv.org/abs/2512.07989) <a id="link94"></a>
...
**Comment:** The paper investigates solar cycle asymmetry using dynamo simulations and meridional flow variations. It is focused on solar physics and does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 95. [Neutrino pair bremsstrahlung due to electromagnetic collisions in neutron star cores revisited](https://arxiv.org/abs/2512.08780) <a id="link95"></a>
...
**Comment:** This paper revisits neutrino pair bremsstrahlung emission in neutron star cores. It focuses on microphysics in neutron stars, not galaxies, star formation, or near-field cosmology.
...
## 96. [Impact on orbital period of X-ray Binary system attached to a cosmic string](https://arxiv.org/abs/2512.07911) <a id="link96"></a>
...
**Comment:** This paper discusses the impact of cosmic strings on the orbital period of X-ray binary systems. It does not address galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 97. [Solar neutron and muon detection on November 11, 2025: First simultaneous recovery of energy spectra](https://arxiv.org/abs/2512.07859) <a id="link97"></a>
...
**Comment:** This paper reports on the detection of solar neutrons and muons during a solar flare, focusing on solar particle acceleration. It does not address galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 98. [Follow-up Observations of Candidate White Dwarf Planets with MIRI](https://arxiv.org/abs/2512.08191) <a id="link98"></a>
...
**Comment:** Reports on follow-up observations of candidate white dwarf planets. The focus is on exoplanets around white dwarfs, not on galaxy formation, star formation histories, or dwarf galaxies.
...
## 100. [Small-scale bright point characteristics at high-resolution with the Daniel K. Inouye Solar Telescope](https://arxiv.org/abs/2512.08520) <a id="link100"></a>
...
**Comment:** This paper analyzes small-scale bright points on the solar disc using high-resolution solar telescope data. It is focused on solar physics and does not match any of the core criteria.
...
## 101. [Optical polarimetry of the accreting black hole X-ray binary Swift J1727.8$-$1613 over the state transition and radio ejections](https://arxiv.org/abs/2512.08716) <a id="link101"></a>
...
**Comment:** This paper presents optical polarimetry of an accreting black hole X-ray binary. The focus is on accretion disk winds and jet alignment, which does not match any of the core criteria.
...
## 102. [Improvements to the NSO Farside Mapping Pipeline: Noise Reduction Updates](https://arxiv.org/abs/2512.08133) <a id="link102"></a>
...
**Comment:** Describes improvements to a solar farside mapping pipeline for space weather forecasting. This is not relevant to any of the core topics (no focus on galaxies, star formation, or stellar models).
...
## 103. [SATMO: a Multi-Planet Thermal Analysis Tool for CubeSat Missions](https://arxiv.org/abs/2512.07896) <a id="link103"></a>
...
**Comment:** This paper describes a thermal analysis tool for CubeSat missions, which is focused on spacecraft engineering and not on any of the core astrophysical or galaxy evolution topics listed in the criteria.
...
## 104. [NICER Perspective on TeV Blazar Mrk~421: X-ray Variability and Particle Acceleration](https://arxiv.org/abs/2512.08531) <a id="link104"></a>
...
**Comment:** This paper studies X-ray variability and particle acceleration in a TeV blazar (Mrk 421), focusing on jet physics and variability. It does not address near-field cosmology, resolved star formation histories, dwarf galaxies, galaxy simulations, or stellar models. The work is outside the core topics.
