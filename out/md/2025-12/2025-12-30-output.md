...
1. [An Empirical Law to Reproduce the Galaxy Rotation Curves](#user-content-link1)
**Authors:** Kento Kamada

2. [Impacts of the $^{16}$O($^{16}$O, n)$^{31}$S reaction rate on the evolution and nucleosynthesis in Pop III massive stars](#user-content-link2)
**Authors:** Wenyu Xin, Ken'ichi Nomoto, Xianfei Zhang, Shaolan Bi

3. [Simulations of facular magnetic fields on cool stars I: Main sequence stars with solar metallicity](#user-content-link3)
...
4. [Heavy dark matter in rapidly evolving massive stars](#user-content-link4)
**Authors:** Sandra Robles, Walter Tangarife, Giorgio Busoni

5. [Lithium abundance and stellar rotation in the Galactic halo and thick disc: Contribution from low-mass giant field stars](#user-content-link5)
**Authors:** Ramiro de la Reza, Felix Llorente de Andr\'es, Emilio J. Alfaro, Carolina Chavero

6. [MAMMOTH-LyC: Investigating the Role of Galaxy Mergers in a Strong Lyman Continuum Leaker at $z=2.39$](#user-content-link6)
...
7. [Pulsed, Polarized X-ray Emission from Neutron Star Surfaces: the Effects of Vacuum Birefringence in the Magnetosphere](#user-content-link7)
**Authors:** Hoa Dinh Thi, Matthew G. Baring, Kun Hu, Alice K. Harding, Rachael E. Stewart, George A. Younes, Joseph A. Barchas

8. [Quenching pathways in the green valley at low redshift: confronting SDSS AGN hosts with IllustrisTNG and EAGLE](#user-content-link8)
**Authors:** Gaurav Gawade

9. [Why Machine Learning Models Systematically Underestimate Extreme Values II: How to Fix It with LatentNN](#user-content-link9)
**Authors:** Yuan-Sen Ting

10. [The GLASS-JWST Early Release Science Program. V. H$\alpha$ luminosity functions at $z\sim1.3$ and $z\sim2.0$](#user-content-link10)
**Authors:** Yuxuan Pang, Xin Wang, Tommaso Treu, Qianqiao Zhou, Shengzhe Wang, Xue-Bing Wu, Maru\v{s}a Brada\v{c}, Karl Glazebrook, Nicha Leethochawalit, Matthew A. Malkan, Themiya Nanayakkara, Benedetta Vulcani, Peter J. Watson, Hu Zhan

11. [Cloud Properties and Star Formation in M31](#user-content-link11)
**Authors:** J. Armijos-Abenda\~no, S. A. Eales, M. W. L. Smith

12. [SiO emission in the filamentary Infrared Dark Cloud G035.39-00.33: An ALMA view](#user-content-link12)
**Authors:** Rong Liu, Izaskun Jim\'enez-Serra, Giuliana Cosentino, Jonathan C. Tan, Ashley Thomas Barnes, Francesco Fontani, Paola Caselli, Antonio Mart\'inez-Henares, Chi-Yan Law, Jonathan D. Henshaw, Tie Liu

13. [Kinematical and Photometric Deconstruction of the UGC 694-IC 412 System: Evidence for a Line-of-Sight Projection](#user-content-link13)
**Authors:** Ikbar Faiz

14. [Finding Quasars behind the Galactic Plane. IV. Candidate Selection from Chandra with Random Forest](#user-content-link14)
...
15. [Clustering Confuses Spectro-photometry: An Investigation of 2D and 3D Forced Profile Matching for Stacking Line-intensity Mapping Data on Source Catalogues](#user-content-link15)
**Authors:** Ella M. Mansfield, Delaney A. Dunne, Dongwoo T. Chung

16. [Matter environments around black holes: geodesics, light rings and ultracompact configurations](#user-content-link16)
**Authors:** Dylan S. Fonseca, Caio F. B. Macedo, Mateus Malato Corr\^ea, Diego Rubiera-Garcia

17. [The Dependence of the Extinction Coefficient on Reddening for Galactic Cepheids](#user-content-link17)
**Authors:** Huajian Wang, Xiaodian Chen, Shu Wang

18. [Reconstructing Relativistic Magnetohydrodynamics with Physics-Informed Neural Networks](#user-content-link18)
**Authors:** Corwin Cheung, Marcos Johnson-Noya, Michael Xiang, Dominic Chang, Alfredo Guevara

19. [A new path to constrain the expansion history of the Universe in future spectroscopic galaxy surveys](#user-content-link19)
**Authors:** Elena Tomasetti, Michele Moresco, Nicola Borghi, Dinko Milakovi\'c, Stephanie Escoffier, Margherita Talia, Lucia Pozzetti, Andrea Cimatti, Lauro Moscardini

20. [A Linearized Approach to Radial-Velocity Extraction. II: Shot-Noise-Limited Precision via Spectral Factorization](#user-content-link20)
**Authors:** Sahar Shahaf, Barak Zackay

21. [Defect Formation in NaI Crystals: A Novel Pathway to Dark Matter Detection](#user-content-link21)
**Authors:** G. Angloher (The COSINUS Collaboration), M. R. Bharadwaj (The COSINUS Collaboration), A. B\"ohmer (The COSINUS Collaboration), M. Cababie (The COSINUS Collaboration), I. Colantoni (The COSINUS Collaboration), I. Dafinei (The COSINUS Collaboration), N. Di Marco (The COSINUS Collaboration), C. Dittmar (The COSINUS Collaboration), F. Ferella (The COSINUS Collaboration), F. Ferroni (The COSINUS Collaboration), S. Fichtinger (The COSINUS Collaboration), A. Filipponi (The COSINUS Collaboration), T. Frank (The COSINUS Collaboration), M. Friedl (The COSINUS Collaboration), D. Fuchs (The COSINUS Collaboration), L. Gai (The COSINUS Collaboration), M. Gapp (The COSINUS Collaboration), M. Heikinheimo (The COSINUS Collaboration), M. N. Hughes (The COSINUS Collaboration), K. Huitu (The COSINUS Collaboration), M. Kellermann (The COSINUS Collaboration), R. Maji (The COSINUS Collaboration), M. Mancuso (The COSINUS Collaboration), L. Pagnanini (The COSINUS Collaboration), F. Petricca (The COSINUS Collaboration), S. Pirro (The COSINUS Collaboration), F. Pr\"obst (The COSINUS Collaboration), G. Profeta (The COSINUS Collaboration), A. Puiu (The COSINUS Collaboration), F. Reindl (The COSINUS Collaboration), K. Sch\"affner (The COSINUS Collaboration), J. Schieck (The COSINUS Collaboration), P. Schreiner (The COSINUS Collaboration), C. Schwertner (The COSINUS Collaboration), P. Settembri (The COSINUS Collaboration), K. Shera (The COSINUS Collaboration), M. Stahlberg (The COSINUS Collaboration), A. Stendahl (The COSINUS Collaboration), M. Stukel (The COSINUS Collaboration), C. Tresca (The COSINUS Collaboration), S. Yue (The COSINUS Collaboration), V. Zema (The COSINUS Collaboration), Y. Zhu (The COSINUS Collaboration), N. Zimmermann (The COSINUS Collaboration), M. Di Giambattista, F. Giannessi, R. Rollo

22. [Observations of the Fermi bubbles and the Galactic center excess with the DArk Matter Particle Explorer](#user-content-link22)
...
23. [Starkindler: An Uncertainty Aware Objective for Photometric Redshift Estimation](#user-content-link23)
**Authors:** Raahul Singh, Ashutosh Pandey

24. [New Constraints on Cosmic-ray boosted Sub-GeV Dark Matter via Light Mediators](#user-content-link24)
**Authors:** Yang Yu, Guan-Sen Wang, Bo Zhang, Tian-Peng Tang, Bing-Yu Su, Lei Feng

25. [Galaxy Zoo Evo: 1 million human-annotated images of galaxies](#user-content-link25)
**Authors:** Mike Walmsley, Steven Bamford, Hugh Dickinson, Tobias G\'eron, Alexander J. Gordon, Annette M. N. Ferguson, Lucy Fortson, Sandor Kruk, Natalie Lines, Chris J. Lintott, Karen L. Masters, Robert G. Mann, James Pearson, Hayley Roberts, Anna M. M. Scaife, Stefan Schuldt, Brooke Simmons, Rebecca Smethurst, Josh Speagle, Kyle Willett

26. [Cosmological long-wavelength solutions in non-adiabatic multi-fluid systems](#user-content-link26)
**Authors:** Hayami Iizuka, Tomohiro Harada

27. [Limits on dark matter existence in neutron stars from recent astrophysical observations and mass correlation analysis](#user-content-link27)
**Authors:** Jing Fu Hu, Hang Lu, Bao Yuan Sun

28. [Predicting the detection yields of giant planets and brown dwarfs with CSST astrometry](#user-content-link28)
**Authors:** Yifan Xuan, Fabo Feng, Zhensen Fu, Shilong Liao, Zhaoxiang Qi, Yang Chen

29. [Kilonova and progenitor properties of merger-driven gamma-ray bursts](#user-content-link29)
**Authors:** P. Singh, G. Stratta, A. Rossi, P. T. H. Pang, M. Bulla, F. Ragosta, A. De Rosa, D. A. Kann, F. Cogato

30. [A Generative Reconstruction of Low-$\ell$ CMB B-Mode Signal using Reverse Diffusion in Deep Learning](#user-content-link30)
**Authors:** Anumanchi Agastya Sai Ram Likhit, Rajib Saha

31. [Double to tenfold M-shell photoionization of singly charged lanthanum ions](#user-content-link31)
**Authors:** M. Looshorn, B. M. D\"ohring, P. -M. Hillenbrand, M. Martins, A. M\"uller, S. Reinwardt, J. Seltmann, F. Trinter, S. X. Wang, A. K. Sahoo, S. Fritzsche, S. Schippers

32. [SN 2022acko: a low-luminosity SNe IIP with signs of early circumstellar interaction](#user-content-link32)
**Authors:** Lin Han, Zhang Jujia, Wang Xiaofeng, Hu Maokai, Zha Shuai, Xiang Danfeng, Li Liping, Reguitti Andrea, Zhang Xinghan, Cai Yongzhi, Wang Zhenyu, Zhao Zeyi, Zhai Qian, Huang Fang, Lin Weili, Bai Jinming

33. [Interpreting the diversity of afterglow emission from radio-detected tidal disruption events with instantaneous and delayed outflows](#user-content-link33)
**Authors:** Yuri Sato, Mukul Bhattacharya, Jose Carpio, Jewel Capili, Kohta Murase

34. [Unveiling Multimessenger Emission from Hidden Cores of Microquasars](#user-content-link34)
**Authors:** Yu-Jia Wei, Kohta Murase, B. Theodore Zhang

35. [Primordial black holes within Higgs hybrid metric-Palatini approach](#user-content-link35)
**Authors:** Brahim Asfour, Farida Bargach, Yahya Ladghami, Ahmed Errahmani, Taoufik Ouali

36. [Three channel dissipative warm Higgs inflation with global inference via genetic algorithms](#user-content-link36)
**Authors:** Wei Cheng

37. [Hierarchical Test of Lorentz Invariance with Gamma-Ray Burst Spectral-Lag Measurements](#user-content-link37)
**Authors:** Shen-Shi Du, Yi Gong, Jun-Jie Wei, Zi-Ke Liu, Zhi-Qiang You, Yan-Zhi Meng, Xing-Jiang Zhu

38. [Frozen Neutron Stars in Four-Dimensional Non-polynomial Gravities](#user-content-link38)
**Authors:** Chen Tan, Yong-Qiang Wang

39. [Lossless compression of simulated radio interferometric visibilities](#user-content-link39)
**Authors:** A. R. Offringa, R. J. van Weeren

40. [Schwinger-Keldysh Cosmological Cutting Rules](#user-content-link40)
**Authors:** Francisco Colip\'i-Marchant, Gabriel Marin, Gonzalo A. Palma, Francisco Rojas

41. [Compact star and compact star matter properties from a baryonic extended linear sigma model with explicit chiral symmetry breaking](#user-content-link41)
**Authors:** Yao Ma, Yong-Liang Ma, Lu-Qi Zhang

42. [Evidence for a Stratified Accretion Disk Wind in AGN](#user-content-link42)
**Authors:** P. Marziani, E. Bon, S. Panda, N. Bon, A. Del Olmo, A. Deconto-Machado, K. Garnica, D. Dultzin

43. [Colloquium: Multimessenger astronomy with continuous gravitational waves and future detectors](#user-content-link43)
**Authors:** Benjamin J. Owen

44. [Gravitational waves from seesaw assisted collapsing domain walls](#user-content-link44)
**Authors:** Debasish Borah, Indrajit Saha

45. [Dark matter direct detection: status, results and future plans](#user-content-link45)
**Authors:** Laura Baudis

46. [Rotation and stability of the circumnuclear gas disk in the Galactic Center potential by the ALMA CMZ Exploration Survey (ACES)](#user-content-link46)
**Authors:** Yoshiaki Sofue, Steven N. Longmore, Daniel Walker, Adam Ginsburg, Jonathan D. Henshaw, John Bally, Ashley T. Barnes, Cara Battersby, Laura Colzi, Paul Ho, Jimenez-Serra, J. M. Diederik Kruijssen, Elizabeth Mills, Maya A. Petkova, Mattia C. Sormani, Jen Wallace, Jairo Armijos-Abendano, Zi-Xuan Feng, Karl Fiteni, Pablo Garc\'ia, Savannah Gramze, Christian Henkel, Pei-Ying Hsieh, Ralf S. Klessen, Francisco Nogueras-Lara, Dylan M. Par\'e, Victor M., Rivilla, Alvaro S\'anchez-Monge

47. [Unveiling SN 2022eyw: A Bright Member of the Type Iax Supernova Subclass](#user-content-link47)
**Authors:** Hrishav Das, Devendra K. Sahu, Anirban Dutta, Mridweeka Singh, G. C. Anupama, Rishabh Singh Teja

48. [Multi-messenger detectability of continuous gravitational waves from the near future to next generation detectors](#user-content-link48)
**Authors:** Benjamin J. Owen (Texas Tech University, University of Maryland Baltimore County), Binod Rajbhandari (Texas Tech University, University of Maryland Baltimore County, Rochester Institute of Technology)

49. [On the origin of sinusoidal brightness variations in F to O-type stars through radial velocities](#user-content-link49)
**Authors:** E. \v{S}ipkov\'a, M. Skarka, M. Va\v{n}ko, V. Chmela\v{r}, T. Pribulla, Z. Mikul\'a\v{s}ek

50. [Search for Annual Modulation in Combined ANAIS 112 and COSINE 100 Data using Bayesian Model Comparison](#user-content-link50)
**Authors:** Om Godse, Shantanu Desai

51. [Mini-review on the production of Primordial Black Holes from First-Order Phase Transitions in the Early Universe](#user-content-link51)
**Authors:** Indra Kumar Banerjee, Ujjal Kumar Dey, Shaaban Khalil

52. [Neutron Star Equation of State with Nucleon Short-Range Correlations: A Concise Review and Open Issues](#user-content-link52)
**Authors:** Bao-Jun Cai, Bao-An Li, Yu-Gang Ma

53. [Detections of Compact Radio Continuum toward Methanol Maser Rings Using the VLA](#user-content-link53)
...
54. [Precise Physical Parameters, Habitability, and Orbital Stability of Sun-like SB2 Systems: HD 130669, HD 184467, HD 191854, and HD 214222](#user-content-link54)
**Authors:** Ahmad Abushattal, Nikolaos Georgakarakos, Mashhoor A. Al-Wardat, Bilal Algnamat, Hassan B. Haboubi, Deshinta Arrova Dewi, Enas M. Abu-Alrob, Abdallah M. Hussein

55. [The new generation lunar gravitational wave detectors: sky map resolution and joint analysis](#user-content-link55)
**Authors:** Xiaolin Zhang, Chengye Yu, Haoran Li, Sobhan Kazempour, Mingqiu Li, Sichun Sun

56. [Gravitational Noether-Ward identities for scalar field](#user-content-link56)
**Authors:** Tomislav Prokopec

57. [Exploring Interplays Between $^3\text{P}_2$ Neutron Superfluid Vortices and $^1\text{S}_0$ Proton Fluxtubes in the Outer Core of Neutron Stars](#user-content-link57)
**Authors:** Tatsuhiro Hattori, Kazuyuki Sekizawa

58. [Multi-Messenger Predictions for T Coronae Borealis: Probing Particle Acceleration in Novae](#user-content-link58)
**Authors:** Prantik Sarmah, Sovan Chakraborty, Xilu Wang

59. [On Systematic Errors in Cross-Identification of Binary Stars in Gaia](#user-content-link59)
**Authors:** E. Malik, P. Kaigorodov, D. Kovaleva, O. Malkov

60. [Toward the Effective Light and Heavy QCD Axion Scenarios](#user-content-link60)
**Authors:** Hai-Jun Li

61. [Water Production of Interstellar Comet 3I/ATLAS from SOHO/SWAN Observations after Perihelion](#user-content-link61)
**Authors:** M. R. Combi, T. M\^akinen, J. -L. Bertaux, E. Quemerais, S. Ferron, R. Lallement, W. Schmidt

62. [On the origin and nature of double-double radio galaxies](#user-content-link62)
**Authors:** David Garofalo, Zhiyuan Liu, Atticus V. Magerko

63. [Revisiting the Reported Period of FRB 20201124A Using MCMC Methods](#user-content-link63)
**Authors:** Jun-Yi Shen, Yuan-Chuan Zou

64. [The 24 Aqr triple system: A closer look at its unique high-eccentricity hierarchical architecture](#user-content-link64)
**Authors:** Ahmad Abushattal, Mashhoor A. Al-Wardat, Elliott P. Horch, Nikolaos Georgakarakos, Hatem A. Al-Ameryeen, Enas M. Abu-Alrob, Abdallah M. Hussein

65. [Classification and Characteristics of Double-trigger Gamma-ray Bursts](#user-content-link65)
**Authors:** Liang Li

66. [Two birds with one stone: simultaneous realization of both Lunar Coordinate Time and lunar geoid time by a single orbital clock](#user-content-link66)
**Authors:** Tian-Ning Yang, Ren-Fang Geng, Jing Zhang, Chong Yang, Yong Huang, Yi Xie

67. [Space AI: Leveraging Artificial Intelligence for Space to Improve Life on Earth](#user-content-link67)
**Authors:** Ziyang Wang

68. [Sidelobe Modification for an Offset Gregorian Reflector System using a Reconfigurable Intelligent Surface-Equipped Subreflector](#user-content-link68)
**Authors:** S. W. Ellingson, A. J. Yip

69. [Interstellar Interloper 3I/ATLAS: Nucleus Size, Photometry in RGB, Af(rho) and Antitail Structure Analysis](#user-content-link69)
**Authors:** Toni Scarmato

70. [Possibility of Month-scale Quasi-periodic Oscillations in the Gamma-ray Light Curve of OP 313](#user-content-link70)
**Authors:** Sandeep Kumar Mondal, Shubham Kishore, Alok C. Gupta, Gwenael Giacinti

---

## 1. [An Empirical Law to Reproduce the Galaxy Rotation Curves](https://arxiv.org/abs/2512.23008) <a id="link1"></a>

**ArXiv ID:** 2512.23008

**Authors:** Kento Kamada

**Abstract:** Profiles of galaxy's rotation velocity (rotation curves) remain unexpectedly flat at large distances, where visible matter alone should make the rotation speed decrease with radius. The usual explanation requires large amounts of unseen dark matter. Here, we introduce an empirical law in which spacetime itself appears to store additional energy when distorted by baryonic matter. The baryonic potential $\Phi_b$ made by the baryonic energy density $\rho_b$ generates an additional energy density $\rho_s = \mu_s \Phi_b^2 / c^4$, leading to a Poisson equation for the total potential $\Phi_{\rm tot}$, \[ \nabla^2\Phi_{\rm tot} = 4\pi G\,\rho_b /c^2 + 4\pi G\,\mu_s\,\Phi_b^2 / c^6. \] When assuming $\mu_s = K M_b^{-3/2}$ with a parameter $K$, we applied this equation to 91 galaxies from the SPARC database. The model reproduced quite well both the inner rise and outer flat regions of the observed rotation curves using the observed baryonic mass profiles only. The $K$ values for the 91 galaxies were found to be concentrated within a narrow range. These results suggest that dark matter is directly connected to the baryonic gravitational potential. A theoretical interpretation of the empirical law is also discussed, in which a relation between the additional energy and the cosmological constant is implied.

**Comment:** Proposes an empirical law to reproduce galaxy rotation curves using baryonic mass profiles, suggesting a connection between dark matter and baryonic gravitational potential. Directly relevant to near-field cosmology, especially the study of dark matter density profiles and rotation curves in galaxies.
...
## 2. [Impacts of the $^{16}$O($^{16}$O, n)$^{31}$S reaction rate on the evolution and nucleosynthesis in Pop III massive stars](https://arxiv.org/abs/2512.22963) <a id="link2"></a>
...
**Comment:** This paper presents a systematic investigation of the $^{16}$O($^{16}$O, n)$^{31}$S reaction rate on the evolution and nucleosynthesis in Pop III massive stars. It directly addresses the 'Stellar Models' criterion by presenting new theoretical results on stellar evolution and nucleosynthesis, with implications for elemental abundances in metal-poor stars.
...
## 3. [Simulations of facular magnetic fields on cool stars I: Main sequence stars with solar metallicity](https://arxiv.org/abs/2512.22379) <a id="link3"></a>
...
**Comment:** This paper presents new 3D radiative MHD simulations of near-surface convection in main-sequence stars, focusing on the effects of faculae-like magnetic fields. It discusses changes in bolometric intensity and thermodynamic stratification, which are relevant to stellar atmosphere and interior models. The work is a clear match for the 'Stellar Models' criterion, as it provides new insights into stellar convection and magnetic field effects.
...
## 4. [Heavy dark matter in rapidly evolving massive stars](https://arxiv.org/abs/2512.22727) <a id="link4"></a>
...
**Comment:** This paper studies the impact of heavy dark matter capture in massive stars, with a focus on the first stars and stellar evolution simulations. It presents new stellar models and discusses the dependence of DM capture on stellar evolutionary stage and composition. This is relevant to the 'Stellar Models' criterion, and also touches on aspects of near-field cosmology through its focus on primordial stellar populations.
...
## 6. [MAMMOTH-LyC: Investigating the Role of Galaxy Mergers in a Strong Lyman Continuum Leaker at $z=2.39$](https://arxiv.org/abs/2512.23202) <a id="link6"></a>
...
**Comment:** Reports discovery of a strong Lyman continuum leaker at z=2.39 in a merging system, with spatially resolved LyC escape. While this is a significant result for cosmic reionization and star formation, it does not focus on resolved star formation histories from color-magnitude diagrams or dwarf/dwarf satellite galaxies. Some relevance for star formation driven outflows and ISM/CGM escape, but not a core match.
...
## 7. [Pulsed, Polarized X-ray Emission from Neutron Star Surfaces: the Effects of Vacuum Birefringence in the Magnetosphere](https://arxiv.org/abs/2512.22978) <a id="link7"></a>
...
**Comment:** Studies pulsed, polarized X-ray emission from neutron star surfaces, focusing on vacuum birefringence and magnetospheric effects. This is relevant to stellar atmosphere modeling, but does not present new stellar evolutionary tracks or bolometric corrections. Some relevance for stellar models.
...
## 9. [Why Machine Learning Models Systematically Underestimate Extreme Values II: How to Fix It with LatentNN](https://arxiv.org/abs/2512.23138) <a id="link9"></a>
...
**Comment:** Presents a new method (LatentNN) for correcting attenuation bias in neural network regression, with applications to stellar spectroscopy. While this is relevant to stellar models and data analysis, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on resolved star formation histories or galaxy simulations. Borderline relevance for improved inference in astronomical data.
...
## 11. [Cloud Properties and Star Formation in M31](https://arxiv.org/abs/2512.22698) <a id="link11"></a>
...
**Comment:** Presents a catalogue of molecular clouds in M31 and analyzes their properties and star formation rates. M31 is a massive spiral galaxy, and the focus is on molecular cloud properties and star formation, not on resolved star formation histories from color-magnitude diagrams or dwarf galaxies. Borderline relevance for star formation studies.
...
## 12. [SiO emission in the filamentary Infrared Dark Cloud G035.39-00.33: An ALMA view](https://arxiv.org/abs/2512.23384) <a id="link12"></a>
...
**Comment:** This paper studies SiO emission in an infrared dark cloud, focusing on shock activity and star formation triggering mechanisms. While it discusses star formation and cloud formation, the focus is on massive star and cluster formation in IRDCs, not on dwarf galaxies or resolved star formation histories. The relevance is borderline.
...
## 13. [Kinematical and Photometric Deconstruction of the UGC 694-IC 412 System: Evidence for a Line-of-Sight Projection](https://arxiv.org/abs/2512.22661) <a id="link13"></a>
...
**Comment:** Re-evaluates the interaction between two galaxies, showing that a previously assumed tidal interaction is a projection effect. The paper uses kinematical and photometric analysis to study galaxy morphology and interactions. While it touches on galaxy interactions, the galaxies involved are not dwarfs or satellites of the Milky Way, and the focus is not on near-field cosmology or resolved star formation histories.
...
## 15. [Clustering Confuses Spectro-photometry: An Investigation of 2D and 3D Forced Profile Matching for Stacking Line-intensity Mapping Data on Source Catalogues](https://arxiv.org/abs/2512.22356) <a id="link15"></a>
...
**Comment:** This paper focuses on stacking analyses for line-intensity mapping (LIM) data, with applications to the CO Mapping Array Project (COMAP). While it discusses galaxy clustering and luminosity functions, the focus is on methodology for LIM data analysis rather than direct measurement of satellite luminosity functions, resolved star formation histories, or dwarf galaxy properties. No direct match to the core criteria.
...
## 16. [Matter environments around black holes: geodesics, light rings and ultracompact configurations](https://arxiv.org/abs/2512.22267) <a id="link16"></a>
...
**Comment:** Investigates the impact of spherically symmetric dark-matter distributions on black hole environments, geodesics, and ringdown signals. While it discusses dark matter profiles, the focus is on black hole environments rather than galaxy-scale dark matter or near-field cosmology.
...
## 17. [The Dependence of the Extinction Coefficient on Reddening for Galactic Cepheids](https://arxiv.org/abs/2512.23311) <a id="link17"></a>
...
**Comment:** This paper studies the extinction coefficient and reddening for Galactic Cepheids, with implications for distance measurements and the cosmic distance ladder. While it discusses stellar properties and extinction, it does not present new stellar models or evolutionary tracks, nor does it focus on resolved star formation histories or galaxy simulations.
...
## 18. [Reconstructing Relativistic Magnetohydrodynamics with Physics-Informed Neural Networks](https://arxiv.org/abs/2512.23057) <a id="link18"></a>
...
**Comment:** Presents physics-informed neural networks for relativistic magnetohydrodynamics (RMHD). While this is a numerical simulation method, it is not focused on galaxy simulations or the core topics listed.
...
## 19. [A new path to constrain the expansion history of the Universe in future spectroscopic galaxy surveys](https://arxiv.org/abs/2512.22964) <a id="link19"></a>
...
**Comment:** The paper discusses a new method to constrain the expansion history of the Universe using cosmic chronometers in future spectroscopic galaxy surveys. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, or dwarf galaxies. The focus is on large-scale expansion and cosmological parameters.
...
## 20. [A Linearized Approach to Radial-Velocity Extraction. II: Shot-Noise-Limited Precision via Spectral Factorization](https://arxiv.org/abs/2512.23040) <a id="link20"></a>
...
**Comment:** This paper presents a new method for radial velocity extraction in exoplanet searches, focusing on precision measurements for solar-type stars. While it is a methodological advance in stellar spectroscopy, it does not present new stellar models or address any of the core topics.
...
## 21. [Defect Formation in NaI Crystals: A Novel Pathway to Dark Matter Detection](https://arxiv.org/abs/2512.23553) <a id="link21"></a>
...
**Comment:** This paper investigates defect formation in NaI crystals as a novel pathway for dark matter detection. While it is related to dark matter, it does not address near-field cosmology, galaxy properties, or any of the other core topics.
...
## 23. [Starkindler: An Uncertainty Aware Objective for Photometric Redshift Estimation](https://arxiv.org/abs/2512.22566) <a id="link23"></a>
...
**Comment:** Presents a new machine learning objective for photometric redshift estimation. While photometric redshifts are used in galaxy studies, the paper does not address any of the core topics directly (e.g., resolved star formation histories, dwarf galaxies, or galaxy simulations).
...
## 24. [New Constraints on Cosmic-ray boosted Sub-GeV Dark Matter via Light Mediators](https://arxiv.org/abs/2512.23282) <a id="link24"></a>
...
**Comment:** Discusses constraints on sub-GeV dark matter via cosmic-ray upscattering and light mediators. While it touches on dark matter, it does not focus on near-field cosmology, satellite galaxies, or galaxy-scale dark matter profiles.
...
## 25. [Galaxy Zoo Evo: 1 million human-annotated images of galaxies](https://arxiv.org/abs/2512.23691) <a id="link25"></a>
...
**Comment:** This paper introduces a large labeled dataset of galaxy images for machine learning and computer vision applications. While it may be useful for future studies of galaxy morphology, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations. The relevance is low.
...
## 26. [Cosmological long-wavelength solutions in non-adiabatic multi-fluid systems](https://arxiv.org/abs/2512.22531) <a id="link26"></a>
...
**Comment:** The paper develops a formulation for nonlinear cosmological perturbations in multi-fluid systems, focusing on superhorizon scales and entropy modes. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 27. [Limits on dark matter existence in neutron stars from recent astrophysical observations and mass correlation analysis](https://arxiv.org/abs/2512.23577) <a id="link27"></a>
...
**Comment:** Examines the limits on dark matter existence in neutron stars using astrophysical observations. While dark matter is a relevant keyword, the context is neutron stars, not galaxies or near-field cosmology.
...
## 28. [Predicting the detection yields of giant planets and brown dwarfs with CSST astrometry](https://arxiv.org/abs/2512.23378) <a id="link28"></a>
...
**Comment:** This paper predicts the detection yields of giant planets and brown dwarfs with CSST astrometry, focusing on substellar companions around M-dwarfs and brown dwarfs. While it discusses low-mass stars and brown dwarfs, the focus is on planetary and substellar companion detection, not on galaxy properties, star formation histories, or other core criteria.
...
## 29. [Kilonova and progenitor properties of merger-driven gamma-ray bursts](https://arxiv.org/abs/2512.23354) <a id="link29"></a>
...
**Comment:** This paper focuses on kilonovae and progenitor properties of merger-driven gamma-ray bursts, modeling both afterglow and kilonova emission. While it deals with neutron star mergers and their electromagnetic counterparts, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or stellar models. The focus is on transient phenomena and progenitor characterization, which is outside the main scope.
...
## 30. [A Generative Reconstruction of Low-$\ell$ CMB B-Mode Signal using Reverse Diffusion in Deep Learning](https://arxiv.org/abs/2512.22683) <a id="link30"></a>
...
**Comment:** This paper focuses on CMB B-mode signal reconstruction using deep learning. While it is relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, galaxy simulations, or any of the other core topics.
...
## 31. [Double to tenfold M-shell photoionization of singly charged lanthanum ions](https://arxiv.org/abs/2512.22574) <a id="link31"></a>
...
**Comment:** Experimental and theoretical study of photoionization of lanthanum ions, with relevance for atomic data in modeling nonequilibrium plasmas such as kilonovae. No direct connection to any of the core topics.
...
## 33. [Interpreting the diversity of afterglow emission from radio-detected tidal disruption events with instantaneous and delayed outflows](https://arxiv.org/abs/2512.23252) <a id="link33"></a>
...
**Comment:** Models radio afterglow emission from tidal disruption events (TDEs) and outflow mechanisms. TDEs and SMBH environments are explicitly listed as irrelevant in the criteria.
...
## 34. [Unveiling Multimessenger Emission from Hidden Cores of Microquasars](https://arxiv.org/abs/2512.23231) <a id="link34"></a>
...
**Comment:** This paper models multimessenger emission from microquasars, focusing on cosmic-ray acceleration and gamma-ray/neutrino production. The focus is on compact objects and high-energy processes, not on galaxies, dwarf galaxies, or star formation histories. The relevance is low.
...
## 35. [Primordial black holes within Higgs hybrid metric-Palatini approach](https://arxiv.org/abs/2512.22924) <a id="link35"></a>
...
**Comment:** This paper investigates primordial black hole formation in the context of a Higgs hybrid metric-Palatini model. The focus is on early universe physics and dark matter candidates, not on galaxies, star formation, or stellar models.
...
## 36. [Three channel dissipative warm Higgs inflation with global inference via genetic algorithms](https://arxiv.org/abs/2512.23423) <a id="link36"></a>
...
**Comment:** This paper presents a framework for warm Higgs inflation and uses genetic algorithms for global inference. It is focused on early universe cosmology and inflation, not on any of the core topics.
...
## 37. [Hierarchical Test of Lorentz Invariance with Gamma-Ray Burst Spectral-Lag Measurements](https://arxiv.org/abs/2512.22875) <a id="link37"></a>
...
**Comment:** This paper focuses on Lorentz invariance violation constraints using gamma-ray bursts. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 38. [Frozen Neutron Stars in Four-Dimensional Non-polynomial Gravities](https://arxiv.org/abs/2512.23525) <a id="link38"></a>
...
**Comment:** This paper investigates neutron star structure in modified gravity theories. It does not address any of the core topics such as galaxy simulations, star formation histories, or dwarf galaxy properties.
...
## 39. [Lossless compression of simulated radio interferometric visibilities](https://arxiv.org/abs/2512.23490) <a id="link39"></a>
...
**Comment:** Describes a lossless compression method for simulated radio interferometric visibilities. While useful for data processing, it does not address any of the core topics such as galaxy simulations, star formation, or CGM.
...
## 40. [Schwinger-Keldysh Cosmological Cutting Rules](https://arxiv.org/abs/2512.22652) <a id="link40"></a>
...
**Comment:** Discusses cutting rules for cosmological correlators in the Schwinger-Keldysh formalism. The focus is on theoretical cosmology, not near-field cosmology, galaxy simulations, or any of the core topics.
...
## 41. [Compact star and compact star matter properties from a baryonic extended linear sigma model with explicit chiral symmetry breaking](https://arxiv.org/abs/2512.23477) <a id="link41"></a>

**ArXiv ID:** 2512.23477

**Authors:** Yao Ma, Yong-Liang Ma, Lu-Qi Zhang

**Abstract:** Based on a baryonic extended linear sigma model including explicit chiral symmetry breaking effect, the structure of neutron star with the emergence of hyperons is investigated using the relativistic mean field approximation. It's found that, except the lightest scalar meson $\sigma$ whose structure is not well understood so far, the vacuum mass spectra of relevant hadrons and NM properties around saturation density can be well reproduced. Nevertheless, we found that, to have a realistic mass-radius relation of neutron stars, the $\pi N$ sigma term $\sigma_{\pi N}$, which denotes the contribution of explicit symmetry breaking, should deviate from its empirical values at vacuum. Specifically, $\sigma_{\pi N}\sim -600$ MeV, rather than $(32-89) \rm \ MeV$ at vacuum. With an appropriate choice of $\sigma_{\pi N}$ and $K(n_0)$, our framework can give a more data favored mass-radius relation of neutron stars with the emergence of hyperons. The effect of explicit symmetry breaking at densities is hoped to provide a new insight to the relation between microscopic symmetries in medium and macroscopic phenomena.

**Comment:** Studies neutron star structure and matter properties using a baryonic extended linear sigma model. The focus is on neutron star physics, not on galaxies, star formation, or CGM.
...
## 42. [Evidence for a Stratified Accretion Disk Wind in AGN](https://arxiv.org/abs/2512.22617) <a id="link42"></a>
...
**Comment:** This paper presents evidence for stratified accretion disk winds in AGN, focusing on emission line profiles and wind models. The topic is AGN outflows, not star-formation-driven outflows, dwarf galaxies, or CGM, and does not match any of the core criteria.
...
## 43. [Colloquium: Multimessenger astronomy with continuous gravitational waves and future detectors](https://arxiv.org/abs/2512.22945) <a id="link43"></a>
...
**Comment:** This colloquium surveys multimessenger astronomy with continuous gravitational waves from neutron stars, discussing connections to electromagnetic astronomy and nuclear astrophysics. While it is broadly astrophysical, it does not address any of the core criteria (dwarf galaxies, star formation histories, quenching, etc.).
...
## 44. [Gravitational waves from seesaw assisted collapsing domain walls](https://arxiv.org/abs/2512.22339) <a id="link44"></a>
...
**Comment:** This paper discusses gravitational waves from collapsing domain walls in the context of seesaw models and right-handed neutrinos. The focus is on cosmological topological defects and neutrino physics, not on near-field cosmology, resolved star formation histories, or other core criteria.
...
## 45. [Dark matter direct detection: status, results and future plans](https://arxiv.org/abs/2512.23039) <a id="link45"></a>
...
**Comment:** This is a review of the status and future plans for direct dark matter detection experiments. While dark matter is tangentially related to near-field cosmology, the paper does not address satellite galaxies, resolved star formation histories, or any of the other core topics.
...
## 46. [Rotation and stability of the circumnuclear gas disk in the Galactic Center potential by the ALMA CMZ Exploration Survey (ACES)](https://arxiv.org/abs/2512.22751) <a id="link46"></a>
...
**Comment:** Examines the circumnuclear gas disk in the Galactic Center, focusing on mass distribution and stability. Explicitly focuses on the Galactic Center, which is listed as irrelevant in the criteria.
...
## 47. [Unveiling SN 2022eyw: A Bright Member of the Type Iax Supernova Subclass](https://arxiv.org/abs/2512.23428) <a id="link47"></a>
...
**Comment:** This paper presents observations and modeling of a bright Type Iax supernova, focusing on explosion mechanisms and spectral evolution. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. The relevance is low.
...
## 48. [Multi-messenger detectability of continuous gravitational waves from the near future to next generation detectors](https://arxiv.org/abs/2512.22938) <a id="link48"></a>
...
## 49. [On the origin of sinusoidal brightness variations in F to O-type stars through radial velocities](https://arxiv.org/abs/2512.22341) <a id="link49"></a>
...
**Comment:** This paper investigates the origin of sinusoidal brightness variations in F to O-type stars using radial velocities and photometry. It focuses on stellar variability mechanisms and binary identification, but does not address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. The relevance is low.
...
## 50. [Search for Annual Modulation in Combined ANAIS 112 and COSINE 100 Data using Bayesian Model Comparison](https://arxiv.org/abs/2512.23191) <a id="link50"></a>
...
**Comment:** This paper presents a Bayesian analysis searching for annual modulation in dark matter direct detection data. While it is related to dark matter, it does not address near-field cosmology, satellite galaxies, or any of the other core topics. The focus is on experimental particle astrophysics.
...
## 51. [Mini-review on the production of Primordial Black Holes from First-Order Phase Transitions in the Early Universe](https://arxiv.org/abs/2512.22989) <a id="link51"></a>
...
**Comment:** This is a mini-review on primordial black holes from first-order phase transitions in the early universe. It is not directly related to any of the core topics.
...
## 52. [Neutron Star Equation of State with Nucleon Short-Range Correlations: A Concise Review and Open Issues](https://arxiv.org/abs/2512.23455) <a id="link52"></a>
...
**Comment:** A review of neutron star equation of state with nucleon short-range correlations. The focus is on neutron star physics, not on galaxies, star formation, or CGM.
...
## 53. [Detections of Compact Radio Continuum toward Methanol Maser Rings Using the VLA](https://arxiv.org/abs/2512.23452) <a id="link53"></a>
...
**Comment:** This paper presents VLA observations of methanol maser rings and associated radio continuum emission in high-mass young stellar objects. The focus is on massive star formation and maser emission, which does not match any of the core criteria (dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 54. [Precise Physical Parameters, Habitability, and Orbital Stability of Sun-like SB2 Systems: HD 130669, HD 184467, HD 191854, and HD 214222](https://arxiv.org/abs/2512.23652) <a id="link54"></a>
...
**Comment:** This paper analyzes Sun-like double-lined spectroscopic binary systems, determining their physical parameters and assessing planetary habitability and orbital stability. The focus is on stellar and planetary system characterization, not on any of the core criteria (dwarf galaxies, star formation histories, quenching, etc.).
...
## 55. [The new generation lunar gravitational wave detectors: sky map resolution and joint analysis](https://arxiv.org/abs/2512.23556) <a id="link55"></a>
...
**Comment:** Focuses on lunar-based gravitational wave detectors and their sky localization capabilities. No direct connection to any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 56. [Gravitational Noether-Ward identities for scalar field](https://arxiv.org/abs/2512.22958) <a id="link56"></a>
...
**Comment:** This paper discusses Noether-Ward identities in the context of gravitational perturbations and quantum scalar fields. It is theoretical and does not address any of the core topics.
...
## 57. [Exploring Interplays Between $^3\text{P}_2$ Neutron Superfluid Vortices and $^1\text{S}_0$ Proton Fluxtubes in the Outer Core of Neutron Stars](https://arxiv.org/abs/2512.22577) <a id="link57"></a>
...
**Comment:** This paper explores neutron superfluid vortices and proton fluxtubes in neutron stars, focusing on pulsar glitches. It does not address any of the core topics.
...
## 58. [Multi-Messenger Predictions for T Coronae Borealis: Probing Particle Acceleration in Novae](https://arxiv.org/abs/2512.22338) <a id="link58"></a>
...
**Comment:** This paper presents multi-messenger predictions for the nova T Coronae Borealis, focusing on particle acceleration and neutrino/gamma-ray detection. It does not address any of the core topics.
...
## 59. [On Systematic Errors in Cross-Identification of Binary Stars in Gaia](https://arxiv.org/abs/2512.23451) <a id="link59"></a>
...
**Comment:** This paper analyzes systematic errors in cross-identification of binary stars in Gaia data. While it deals with stellar populations and cataloging, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. The relevance is low.
...
## 60. [Toward the Effective Light and Heavy QCD Axion Scenarios](https://arxiv.org/abs/2512.22829) <a id="link60"></a>
...
**Comment:** Investigates axion parameter space in QCD axion scenarios. No direct connection to any of the core topics such as galaxy formation, star formation histories, or stellar models.
...
## 62. [On the origin and nature of double-double radio galaxies](https://arxiv.org/abs/2512.22411) <a id="link62"></a>
...
**Comment:** The paper studies double-double radio galaxies and jet morphology, focusing on accretion and black hole spin. This is not relevant to any of the core topics, as it deals with AGN jets and radio galaxy morphology.
...
## 63. [Revisiting the Reported Period of FRB 20201124A Using MCMC Methods](https://arxiv.org/abs/2512.23392) <a id="link63"></a>
...
**Comment:** This paper presents a method for searching for periodic signals in repeating fast radio bursts (FRBs). The focus is on transient radio phenomena and magnetar models, not on galaxies, star formation, or stellar models.
...
## 64. [The 24 Aqr triple system: A closer look at its unique high-eccentricity hierarchical architecture](https://arxiv.org/abs/2512.23645) <a id="link64"></a>
...
**Comment:** This paper analyzes the architecture of a triple star system (24 Aqr) and its orbital properties. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 65. [Classification and Characteristics of Double-trigger Gamma-ray Bursts](https://arxiv.org/abs/2512.23660) <a id="link65"></a>
...
**Comment:** This paper classifies and characterizes double-trigger gamma-ray bursts. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 66. [Two birds with one stone: simultaneous realization of both Lunar Coordinate Time and lunar geoid time by a single orbital clock](https://arxiv.org/abs/2512.23098) <a id="link66"></a>
...
**Comment:** This paper discusses lunar timekeeping and geoid time using orbital clocks. It is unrelated to any of the core topics.
...
## 67. [Space AI: Leveraging Artificial Intelligence for Space to Improve Life on Earth](https://arxiv.org/abs/2512.22399) <a id="link67"></a>
...
**Comment:** A broad review of AI applications in space science and technology. No direct connection to any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 68. [Sidelobe Modification for an Offset Gregorian Reflector System using a Reconfigurable Intelligent Surface-Equipped Subreflector](https://arxiv.org/abs/2512.23530) <a id="link68"></a>
...
**Comment:** This paper discusses the use of reconfigurable intelligent surfaces for sidelobe modification in offset Gregorian reflector systems, with applications to radio astronomy instrumentation. It does not address any of the core astrophysical criteria (galaxy properties, star formation, quenching, simulations, etc.).
...
## 69. [Interstellar Interloper 3I/ATLAS: Nucleus Size, Photometry in RGB, Af(rho) and Antitail Structure Analysis](https://arxiv.org/abs/2512.22365) <a id="link69"></a>
...
**Comment:** This paper presents an analysis of the interstellar comet 3I/ATLAS, focusing on nucleus size, photometry, and dust features. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The relevance is very low.
...
## 70. [Possibility of Month-scale Quasi-periodic Oscillations in the Gamma-ray Light Curve of OP 313](https://arxiv.org/abs/2512.23416) <a id="link70"></a>
...
**Comment:** The paper analyzes quasi-periodic oscillations in the gamma-ray light curve of a blazar (OP 313). This is unrelated to any of the core topics, as it focuses on AGN variability and jet models, not on galaxies, star formation, or stellar models.
