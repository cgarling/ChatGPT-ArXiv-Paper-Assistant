...
1. [Interpreting the strong clustering of ultra-diffuse galaxies by halo spin bias](#user-content-link1)
**Authors:** Qinglin Ma, Cheng Li, Yangyao Chen, Houjun Mo

2. [Quantifying Systematic Age Discrepancies in Very Young Star Clusters](#user-content-link2)
...
3. [The Competing Influence of Ram Pressure and Tidal Interaction in NGC 2276](#user-content-link3)
**Authors:** Luka Matijevi\'c, Neven Tomi\v{c}i\'c, Antonino Marasco, Alessandro Ignesti, Augusto E. Lassen, Rory Smith, Paul Sell, Ian D. Roberts, Andreas Zezas, Konstantina Anastasopoulou, Panagiotis Kotoulas, Roko Ba\v{s}i\'c

4. [The AURORA Survey: The Mass -- Metallicity and Fundamental Metallicity Relations at $z \sim 2.3$ Based Purely on Direct $T_e$ Metallicities](#user-content-link4)
**Authors:** Ali Ahmad Khostovan, Ryan L. Sanders, Alice E. Shapley, Michael W. Topping, Naveen A. Reddy, Alex M. Garcia, Danielle A. Berg, Leonardo Clarke, Fergus Cullen, Richard S. Ellis, N. M. F\"orster Schreiber, Karl Glazebrook, Tucker Jones, Derek J. McLeod, Anthony J. Pahl, Max Pettini, Paul Torrey

5. [Asymptotic behaviour of galactic small-scale dynamos at modest magnetic Prandtl number](#user-content-link5)
**Authors:** Frederick A. Gent, Mordecai-Mark Mac Low, Maarit J. Korpi-Lagg, Touko Puro, Matthias Reinhardt

6. [Using a neural network approach and starspots dependent models to predict effective temperatures and ages of young stars](#user-content-link6)
**Authors:** Marco Tarantino, Loredana Prisinzano, Nicoletta D Angelo, Francesco Damiani, Giada Adelfio

7. [Reviving sub-keV warm dark matter: a UVLF-based analysis](#user-content-link7)
**Authors:** Raymond T. Co, Siu Cheung Lam, Sai Chaitanya Tadepalli, Tomo Takahashi

8. [Pre-supernova O-C shell mergers could produce more $^{44}\mathrm{Ti}$ than the explosion](#user-content-link8)
**Authors:** Joshua Issa, Falk Herwig

9. [Archaeological investigation of galaxies' evolutionary history in the cosmic middle ages](#user-content-link9)
**Authors:** Anna R. Gallazzi (INAF-Osservatorio Astrofisico di Arcetri, Firenze, Italy), Stefano Zibetti (INAF-Osservatorio Astrofisico di Arcetri, Firenze, Italy), Mark Sargent (EPFL Laboratory of Astrophysics), Nicolas Bouche' (Univ Lyon1, Ens de Lyon, CNRS, Centre de Recherche Astrophysique de Lyon), Luke Davies (ICRAR, The University of Western Australia, Crawley, WA, Australia), Marcella Longhetti (INAF-Osservatorio Astronomico di Brera, Milano, Italy), Annagrazia Puglisi (School of Physics and Astronomy, University of Southampton, Highfield, UK), Laura Scholz-Diaz (INAF-Osservatorio Astrofisico di Arcetri, Firenze, Italy), Fabio Ditrani (INAF-Osservatorio Astronomico di Brera, Milano, Italy, Universita' degli Studi di Milano-Bicocca, Milano, Italy), Daniele Mattolini (INAF-Osservatorio Astrofisico di Arcetri, Firenze, Italy, Dipartimento di Fisica, Universita' di Trento, Povo), Sabine Thater (University of Vienna, Department of Astrophysics, Vienna, Austria), Crescenzo Tortora (INAF - Osservatorio Astronomico di Capodimonte, Salita Moiariello 16, I-80131 Napoli, Italy), Bodo Ziegler (University of Vienna, Department of Astrophysics, Vienna, Austria), Mirko Curti (European Southern Observatory, Garching bei Muenchen, Germany), Lucia Pozzetti (INAF-OAS, Osservatorio di Astrofisica e Scienza dello Spazio di Bologna, Bologna, Italy), Mojtaba Raouf (Leiden Observatory, Leiden University, Leiden, Netherlands), Umberto Rescigno (Instituto de Investigacion en Astronomia y Ciencias Planetarias, Universidad de Atacama, Copiapo, Atacama, Chile)

10. [Empirical instability strip for classical Cepheids II. The Small Magellanic Cloud galaxy](#user-content-link10)
**Authors:** Felipe Espinoza-Arancibia, Bogumi{\l} Pilecki, Matylda {\L}ukaszewicz

11. [A robust morphological classification method for galaxies using dual-encoding contrastive learning and multi-clustering voting on JWST/NIRCam images](#user-content-link11)
**Authors:** Xiaolei Yin, Guanwen Fang, Shiying Lu, Zesen Lin, Yao Dai, Chichun Zhou

12. [ODIN: A New Lyman Alpha Blob Selection Method, Sample, and Statistical Analysis at $z\sim3.1$](#user-content-link12)
**Authors:** Byeongha Moon, Yujin Yang, Kyoung-Soo Lee, Eric Gawiser, Arjun Dey, Francisco Valdes, Dustin Lang, Robin Ciardullo, Caryl Gronwall, Ann Zabludoff, Vandana Ramakrishnan, Nicole M. Firestone, Ethan Pinarski, Seok-jun Chang, Lucia Guaita, Sungryong Hong, Ho Seong Hwang, Sang Hyeok Im, Woong-Seob Jeong, Eunsoo Jun, Seongjae Kim, Jaehyun Lee, Seong-Kook Lee, Gautam Nagaraj, Julie B. Nantais, Nelson Padilla, Changbom Park, Hyunmi Song, Paulina Troncoso

13. [SHARP: Beyond JWST -- Revealing the galaxy birth and growth with the resolution of the ELT](#user-content-link13)
...
14. [Hidden Companions of the Early Milky Way I. New alpha-Enhanced Exoplanet Hosts](#user-content-link14)
...
15. [Self-gravitating Superfluids: The Gross-Pitaevskii-Poisson Framework](#user-content-link15)
**Authors:** Sanjay Shukla, Marc E. Brachet, Rahul Pandit

16. [The contribution of the color space in LSST-like photometry for the selection of extragalactic globular cluster candidates](#user-content-link16)
**Authors:** Nicholas Schweder-Souza, Ana L. Chies-Santos, Rafael S. de Souza, Kristen C. Dage, Charles J. Bonatto, Juan P. Caso, Michele Cantiello, Pedro dos Santos-Lopes, Pedro Floriano, Thayse A. Pacheco, Katherine L. Rhode, Pauline Barmby, Niranjana P., Yasna Ordenes-Brice\~no, Teymoor Saifollahi, Rubens E. G. Machado, Julia Gschwend

17. [Creation of spin-3/2 dark matter via cosmological gravitational particle production](#user-content-link17)
**Authors:** Edward W. Kolb, Andrew J. Long, Evan McDonough, Jingyuan Wang

18. [CLiENT: A new tool for emulating cosmological likelihoods using deep neural networks](#user-content-link18)
**Authors:** Luca Janken, Steen Hannestad, Thomas Tram, Andreas Nygaard

19. [The imprints of massive neutrinos on the 3-point correlation function of large-scale structures](#user-content-link19)
**Authors:** Andrea Labate, Massimo Guidi, Michele Moresco, Alfonso Veropalumbo

20. [Uncovering the population of compact binary mergers and their formation pathways with gravitational waves through the Einstein Telescope](#user-content-link20)
...
21. [Pulsed radio emission from a Central Compact Object](#user-content-link21)
...
22. [The MeerKLASS L-band On-the-Fly Continuum Survey: Data Release 1](#user-content-link22)
...
23. [Magnetic field spreading from stellar and galactic dynamos into the exterior](#user-content-link23)
**Authors:** Axel Brandenburg, Oindrila Ghosh, Franco Vazza, Andrii Neronov

24. [The contribution from smalls scales on two-point shear analysis: comparison between power spectrum and correlation function](#user-content-link24)
**Authors:** Jo\~ao Ferri, Elisa G. M. Ferreira, Ryo Terasawa

25. [Across the Universe: GW231123 as a magnified and diffracted black hole merger](#user-content-link25)
**Authors:** Srashti Goyal, Hector Villarrubia-Rojo, Miguel Zumalacarregui

26. [Constraining primordial non-Gaussianity from DESI DR1 quasars and Planck PR4 CMB Lensing](#user-content-link26)
...
27. [A search for late-type brown dwarfs in the Euclid Quick Data Release 1](#user-content-link27)
...
33. [Implicit Likelihood Inference of the Neutrino Mass Hierarchy from Cosmological Data](#user-content-link33)
**Authors:** Ke Wang

34. [The final stages of binary evolution using multi-messenger studies](#user-content-link34)
**Authors:** Thomas Kupfer, Simone Scaringi, Paul Groot, Boris G\"ansicke, Ingrid Pelisoli, Anna F. Pala, Jan van Roestel, Silvia Toonen, Domitilla de Martino, Noel Castro Segura, David Buckley, Valerie Van Grootel, Kieran O'Brien, Samaya Nissanke

35. [The accretion of quasars at the epoch of reionisation: $JWST$ catches the primeval monsters slowly feasting](#user-content-link35)
...
36. [Gravitational wave oscillations in Multi-Proca dark energy models](#user-content-link36)
**Authors:** Gabriel Gomez, Jose F. Rodriguez

37. [Observations of AGN-driven feedback: dynamics and ionization of the filaments in M87](#user-content-link37)
**Authors:** Camille Poitras (D\'epartement de physique, de g\'enie physique et d'optique, Universit\'e Laval, Qu\'ebec, Canada), Marie-Lou Gendron-Marsolais (D\'epartement de physique, de g\'enie physique et d'optique, Universit\'e Laval, Qu\'ebec, Canada), Valeria Olivares (Departamento de F\'isica, Universidad de Santiago de Chile, Santiago, Chile, Center for Interdisciplinary Research in Astrophysics and Space Exploration), Yuan Li (Department of Astronomy, University of Massachusetts, Amherst, USA), Adrien Picquenot (Department of Astronomy, Louisiana State University, Baton Rouge, USA), Aurora Simionescu (SRON Space Research Organization Netherlands, Leiden, The Netherlands), Matteo Fossati (Dipartimento di Fisica G. Occhialini, Universit\`a degli Studi di Milano-Bicocca, Milano, Italy), Alessandro Boselli (Aix-Marseille Universit\'e, CNRS, CNES, LAM, Marseille, France), Laura Hermosa Mu\~noz (Centro de Astrobiolog\'ia), Sara Cazzoli (Instituto de Astrof\'isica de Andaluc\'ia, IAA-CSIC, Granada, Spain), Julie Hlavacek-Larrondo (D\'epartement de Physique, Universit\'e de Montr\'eal, Montr\'eal, Canada), Annabelle Richard-Laferri\`ere (Institute of Astronomy, University of Cambridge, Cambridge, UK)

38. [Surrogate-Accelerated Bayesian Inversion for Exoplanet Interior Characterization](#user-content-link38)
**Authors:** Tijn De Wringer, Caroline Dorn, Emily O. Garvin, Stefano Marelli

39. [Trails of clouds in binary black holes](#user-content-link39)
**Authors:** Mateja Bo\v{s}kovi\'c, Rafael A. Porto, Matthias Koschnitzke

40. [Selected topics on: 1) proposal of interpreting the Crab supernova with a GRB 2) progress in identifying the seven GRBs episodes 3) the role of Sagittarius A in identifying the dark matter component (the X fermion)](#user-content-link40)
...
41. [A VLA search for compact radio sources in the explosive molecular outflows DR 21 and G5.89](#user-content-link41)
**Authors:** Vanessa Yanza, Sergio A. Dzib, Aina Palau, William J. Henney, Luis F. Rodr\'iguez, Luis A. Zapata

42. [Radio studies of supernovae 1979C, 1986J and 2006X with LOFAR](#user-content-link42)
**Authors:** Peter Lundqvist, Deeepika Venkattu, Miguel P\'erez Torres, Javier Mold\'on, Vijay Mahatma, Poonam Chandra

43. [The Nature of Galactic Spiral Arms](#user-content-link43)
**Authors:** Robert J. J. Grand, Martin Roth

44. [A VERITAS view of HESS J1857+026 within a multi-wavelength analysis](#user-content-link44)
**Authors:** Y. Chen (for the VERITAS collaboration)

45. [The supernova Ia progenitor problem in the 2040s](#user-content-link45)
**Authors:** Thomas Kupfer, Simone Scaringi, Ingrid Pelisoli, Anna F. Pala, Silvia Toonen, Domitilla de Martino, Christa Gall, Kunal Deshmukh, Valerie Van Grootel, St\'ephane Blondin, Samaya Nissanke

46. [Quantum state of interacting primordial inhomogeneities: de-squeezing and decoherence](#user-content-link46)
**Authors:** Amaury Micheli, Yuto Oshima, Tomo Takahashi

47. [Baryogenesis and EDMs in the 2HDM+CS](#user-content-link47)
**Authors:** Bj\"orn Garbrecht, Edward Wang

48. [GW231123: Overlapping Gravitational Wave Signals?](#user-content-link48)
**Authors:** Qian Hu, Harsh Narola, Jef Heynen, Mick Wright, John Veitch, Justin Janquart, Chris Van Den Broeck

49. [Boiling away asymmetries: low-scale phase transitions, gravitational waves and leptogenesis](#user-content-link49)
**Authors:** Leonardo Grimaldi, Michele Lucente, Silvia Pascoli

50. [Fermion Thermal Field Theory for a Rotating Plasma (with Applications to Neutron Stars)](#user-content-link50)
**Authors:** Alberto Salvio

51. [Equilibriums of extremely magnetized compact stars with force-free magnetotunnels](#user-content-link51)
**Authors:** Koji Uryu, Shijun Yoshida, Eric Gourgoulhon, Charalampos Markakis, Kotaro Fujisawa, Antonios Tsokaros, Keisuke Taniguchi, Mina Zamani

52. [Super-resolution-enabled atmospheric tomography for astronomical multi-wavefront-sensor adaptive-optics systems](#user-content-link52)
**Authors:** Carlos M. Correia, Pierre Jouve, Jesse Cranney, Guido Agapito C\'edric Ta\"issir Heritier

53. [Towards an Agnostic Algorithm for Sampling Empirical Structure Models: The case of Uranus and Neptune](#user-content-link53)
**Authors:** Stefano Wirth, Luca Morf, Ravit Helled

54. [Kinetic-Theory Bounds on the Equation of State of Dense QCD Matter](#user-content-link54)
**Authors:** Micha{\l} Marczenko

55. [A Search for Binary Black Hole Mergers in LIGO O1-O3 Data with Convolutional Neural Networks](#user-content-link55)
**Authors:** Ethan Silver, Plamen Krastev, Edo Berger

56. [On Signatures of a Possible New Physics Resonance in Atmospheric Air Showers Using a Parameterized Model](#user-content-link56)
**Authors:** Jiri Kvita

57. [Deviations from Gaussian White Noise in Stochastic Inflation](#user-content-link57)
**Authors:** Zahra Ahmadi, Mahdiyar Noorbala

58. [On the complex nature of coronal heating](#user-content-link58)
**Authors:** C. A. Breu, D. I. Pontin, E. Priest, I. De Moortel

59. [Semantic Model for the SKA Regional Centre Network](#user-content-link59)
**Authors:** Edgar Ribeiro Jo\~ao, Manuel Parra-Roy\'on, Juli\'an Garrido

60. [Origin of Quasi-Periodic Oscillations and Accretion Process in X-Ray Binaries around Quantum Lee-Wick Black Hole](#user-content-link60)
**Authors:** Orhan Donmez, G. Mustafa, M. Yousaf, Faisal Javed, Ikhtiyor Saidov, Farruh Atamurotov

61. [Systematic search of laser and phase modulation noise coupling in heterodyne interferometry](#user-content-link61)
**Authors:** Kohei Yamamoto, Olaf Hartwig, Lennart Wissel, Holly Leopardi, Kenji Numata, Ryan Derosa

62. [Investigating the AGN variability timescale -- black hole mass relationship with Gaia, SDSS and ZTF](#user-content-link62)
**Authors:** Adrien H\'elias, Sarah C. Gallagher, Pauline Barmby

63. [Quantifying sunspot group nesting with density-based unsupervised clustering](#user-content-link63)
**Authors:** Nurdan Karapinar, Emre Isik, Natalie A. Krivova, Hakan V. Senavci

64. [Validating the performance of the Radio Neutrino Observatory in Greenland using cosmic-ray air showers](#user-content-link64)
**Authors:** S. Agarwal, J. A. Aguilar, N. Alden, S. Ali, P. Allison, M. Betts, D. Besson, A. Bishop, O. Botner, S. Bouma, S. Buitink, R. Camphyn, J. Chan, S. Chiche, B. A. Clark, A. Coleman, K. Couberly, S. de Kockere, K. D. de Vries, C. Deaconu, P. Giri, C. Glaser, T. Gl\"usenkamp, H. Gui, A. Hallgren, S. Hallmann, J. C. Hanson, K. Helbing, B. Hendricks, J. Henrichs, N. Heyer, C. Hornhuber, E. Huesca Santiago, K. Hughes, A. Jaitly, T. Karg, A. Karle, J. L. Kelley, C. Kopper, M. Korntheuer, M. Kowalski, I. Kravchenko, R. Krebs, M. Kugelmeier, D. Kullgren, R. Lahmann, C. -H. Liu, Y. Liu, M. J. Marsee, K. Mulrey, M. Muzio, A. Nelles, A. Novikov, A. Nozdrina, E. Oberla, B. Oeyen, N. Punsuebsay, L. Pyras, M. Ravn, A. Rifaie, D. Ryckbosch, F. Schl\"uter, O. Scholten, D. Seckel, M. F. H. Seikh, Z. S. Selcuk, J. Stachurska, J. Stoffels, S. Toscano, D. Tosi, J. Tutt, D. J. Van Den Broeck, N. van Eijndhoven, A. G. Vieregg, A. Vijai, D. Washington, C. Welling, D. R. Williams, P. Windischhofer, S. Wissel, R. Young, A. Zink

65. [Prediction of the Solar Polar Fields in 2026: An Unusually Weak Level Across the Last Five Solar Cycles](#user-content-link65)
**Authors:** Ruihui Wang, Jie Jiang, Yukun Luo

66. [High-Resolution Measurements with the CTAO Southern Array: The Case for Pulsar Wind Nebulae](#user-content-link66)
**Authors:** Georg Schwefer, Jim Hinton

67. [Revisited apparent horizon entropy and GSL in modified gravity](#user-content-link67)
**Authors:** Soma Heydari, Parastoo Askari, Kayoomars Karami

68. [Surveying Ultra-hot Jupiters using Phase Curves with $\textit{Twinkle}$](#user-content-link68)
**Authors:** Kaz Gary, Ji Wang, Anusha Pai Asnodkar, Ian Wong

69. [Ghost-free 2-form fields in cosmology: implications for gravitational parity violation](#user-content-link69)
**Authors:** Yuki Horii, Tomoaki Murata, Tsutomu Kobayashi

70. [Constraining the Nanohertz Gravitational Wave Background with an X-ray Pulsar Timing Array from NICER observations](#user-content-link70)
**Authors:** Tian-Yong Cao, Shi-jie Zheng, Shu-Xu Yi, Ming-Yu Ge, Yi-Tao Yin, Yao-Ming Duan, Xiang Yang, Wen

71. [Constraining the Prompt Atmospheric Neutrino Flux Combining IceCube's Cascade and Track Samples](#user-content-link71)
...
72. [Constraining black hole spin in PG 1535+547 amidst complex multi-layered absorption](#user-content-link72)
...
73. [SatTrack: Software for Evaluating Satellite Interference and Rim-Based Interference Mitigation Using a Reconfigurable Parabolic Antenna](#user-content-link73)
**Authors:** Justin Santana, Luke Heller, R. M. Buehrer

74. [Exoplanets in reflected starlight with dual-field interferometry and a fifth Unit Telescope at VLTI](#user-content-link74)
**Authors:** \'Oscar Carri\'on-Gonz\'alez, Sylvestre Lacour, Mathias Nowak

75. [In situ substrate birefringence characterization in gravitational wave detectors using a heterodyne polarimetry method](#user-content-link75)
...
## 1. [Interpreting the strong clustering of ultra-diffuse galaxies by halo spin bias](https://arxiv.org/abs/2512.17742) <a id="link1"></a>
...
**Comment:** This paper uses the IllustrisTNG300-ODM simulation to study the clustering of ultra-diffuse galaxies (UDGs), focusing on low-mass halos and their spin bias. UDGs are a type of low-mass galaxy, and the work connects their properties to dark matter halo characteristics and clustering, which is highly relevant to near-field cosmology and numerical galaxy simulations. The use of high-resolution simulations and the focus on low-mass galaxies make this paper a strong match.
...
## 2. [Quantifying Systematic Age Discrepancies in Very Young Star Clusters](https://arxiv.org/abs/2512.17033) <a id="link2"></a>
...
**Comment:** This paper investigates systematic age discrepancies in very young star clusters using color-magnitude diagrams and stellar population modeling. It directly addresses the resolved star formation histories criterion, as it uses CMDs to infer ages and discusses implications for stellar models.
...
## 3. [The Competing Influence of Ram Pressure and Tidal Interaction in NGC 2276](https://arxiv.org/abs/2512.17486) <a id="link3"></a>
...
**Comment:** This paper studies the influence of ram pressure and tidal interactions in NGC 2276, a nearby galaxy, using multiwavelength data. It examines the distribution of stellar populations and the effects of environmental processes on galaxy morphology. While NGC 2276 is not a dwarf galaxy, the paper is relevant to the topic of star formation quenching and environmental effects on galaxies, though with lower weight since it is a higher mass galaxy.
...
## 4. [The AURORA Survey: The Mass -- Metallicity and Fundamental Metallicity Relations at $z \sim 2.3$ Based Purely on Direct $T_e$ Metallicities](https://arxiv.org/abs/2512.16989) <a id="link4"></a>
...
**Comment:** Presents new constraints on the mass-metallicity and fundamental metallicity relations at z~2.3 using direct Te metallicities. The sample includes galaxies down to 10^8 Msun, which may include some dwarf galaxies, but the focus is on high-redshift galaxies and chemical evolution, not specifically on local dwarfs, resolved star formation histories, or near-field cosmology. Some borderline relevance due to the focus on low-mass galaxies and feedback processes.
...
## 5. [Asymptotic behaviour of galactic small-scale dynamos at modest magnetic Prandtl number](https://arxiv.org/abs/2512.17885) <a id="link5"></a>
...
**Comment:** This paper presents high-resolution simulations of supernova-driven galactic dynamos, focusing on the small-scale dynamo and turbulent magnetic fields in the interstellar medium. While it uses galaxy simulations, the focus is on magnetic field amplification and not directly on galaxy formation, star formation histories, or near-field cosmology. However, the use of high-resolution galaxy simulations gives it some borderline relevance.
...
## 6. [Using a neural network approach and starspots dependent models to predict effective temperatures and ages of young stars](https://arxiv.org/abs/2512.17480) <a id="link6"></a>
...
**Comment:** This paper presents a neural network approach to predict effective temperatures and ages of young stars, including the use of starspot-dependent models. The focus is on stellar parameter estimation and age dating of young clusters, which is tangentially related to stellar models (criterion 4), but does not present new stellar evolutionary or atmosphere models. The relevance is borderline due to the use of models for age prediction.
...
## 7. [Reviving sub-keV warm dark matter: a UVLF-based analysis](https://arxiv.org/abs/2512.16987) <a id="link7"></a>
...
**Comment:** This paper analyzes constraints on warm dark matter (WDM) models using ultraviolet luminosity functions and other cosmological data. The focus is on the suppression of small-scale structure and the implications for dark matter particle properties. While it touches on small-scale structure, it does not directly address near-field cosmology topics such as satellite galaxies, resolved star formation histories, or galaxy simulations. The connection to the satellite luminosity function is indirect at best.
...
## 8. [Pre-supernova O-C shell mergers could produce more $^{44}\mathrm{Ti}$ than the explosion](https://arxiv.org/abs/2512.17705) <a id="link8"></a>
...
**Comment:** This paper presents new theoretical work on nucleosynthesis in massive stars, specifically the production of radioactive isotopes like $^{44}$Ti during O-C shell mergers. While it involves stellar models and nucleosynthesis, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations. The work is most closely related to the 'Stellar Models' criterion, as it discusses the impact of 3D hydrodynamic mixing on nucleosynthesis yields, but it is not presenting new stellar evolutionary tracks or atmosphere models per se. Thus, it is only borderline relevant.
...
## 9. [Archaeological investigation of galaxies' evolutionary history in the cosmic middle ages](https://arxiv.org/abs/2512.16998) <a id="link9"></a>
...
**Comment:** This paper discusses the need for large spectroscopic surveys to study the evolutionary history of galaxies, including star formation and quenching, over the last 8-10 Gyr. It mentions the importance of tracing galaxies down to 10^9 solar masses, which is at the upper end of the dwarf galaxy regime, and emphasizes the need to reconstruct star formation and assembly histories. This aligns with the 'Resolved Star Formation Histories' criterion, though the focus is on future facilities and survey design rather than presenting new results. The relevance is moderate due to the connection to resolved SFHs and quenching, but the novelty is limited as it is a perspective/white paper.
...
## 10. [Empirical instability strip for classical Cepheids II. The Small Magellanic Cloud galaxy](https://arxiv.org/abs/2512.16997) <a id="link10"></a>
...
**Comment:** This paper empirically determines the instability strip for classical Cepheids in the Small Magellanic Cloud and compares with theoretical models. It involves stellar evolution and pulsation models, which is somewhat related to the 'Stellar Models' criterion, but the focus is on variable star properties and distance indicators rather than new stellar evolutionary or atmosphere models. There is a borderline connection to the core topics.
...
## 13. [SHARP: Beyond JWST -- Revealing the galaxy birth and growth with the resolution of the ELT](https://arxiv.org/abs/2512.17042) <a id="link13"></a>
...
**Comment:** This is a concept study for a new spectrograph (SHARP) for the ELT, aiming to study star formation, chemical enrichment, and quenching in galaxies, with a focus on high-mass galaxies and high redshift. While it mentions quenching and the CGM, the emphasis is on massive galaxies, not dwarfs, and does not directly address the core topics.
...
## 14. [Hidden Companions of the Early Milky Way I. New alpha-Enhanced Exoplanet Hosts](https://arxiv.org/abs/2512.17072) <a id="link14"></a>
...
**Comment:** This paper focuses on exoplanet hosts in the thick disk of the Milky Way, discussing planet formation in chemically ancient environments. While it touches on the early Milky Way and thick disk, it does not focus on dwarf satellite galaxies, resolved star formation histories, or the other core topics. The closest link is to near-field cosmology, but the focus is on exoplanets and planet formation, not the structure or history of the Milky Way's satellites or halo.
...
## 15. [Self-gravitating Superfluids: The Gross-Pitaevskii-Poisson Framework](https://arxiv.org/abs/2512.16936) <a id="link15"></a>
...
**Comment:** This paper provides an overview of the Gross-Pitaevskii-Poisson equation for self-gravitating superfluids, with applications to boson/axion stars, dark matter halos, and neutron stars. While it mentions dark matter halos, the focus is on the theoretical framework and compact objects, not on galaxy-scale simulations or near-field cosmology.
...
## 16. [The contribution of the color space in LSST-like photometry for the selection of extragalactic globular cluster candidates](https://arxiv.org/abs/2512.17644) <a id="link16"></a>
...
**Comment:** This paper discusses the identification of extragalactic globular clusters using LSST-like photometry and machine learning techniques. While globular clusters are important for understanding galaxy evolution, the focus here is on classification methodology and contamination rates, not on near-field cosmology, resolved star formation histories, or the other core topics. There is a weak connection to near-field cosmology via globular clusters as tracers, but the paper does not directly address the core topics.
...
## 17. [Creation of spin-3/2 dark matter via cosmological gravitational particle production](https://arxiv.org/abs/2512.16976) <a id="link17"></a>
...
**Comment:** This paper discusses the production of spin-3/2 dark matter via cosmological gravitational particle production. While dark matter is a relevant topic in near-field cosmology, this work is purely theoretical and cosmological, with no direct connection to dwarf galaxies, satellite systems, or resolved star formation histories. It does not address the structure or evolution of galaxies or their satellites.
...
## 18. [CLiENT: A new tool for emulating cosmological likelihoods using deep neural networks](https://arxiv.org/abs/2512.17509) <a id="link18"></a>
...
**Comment:** This paper presents a new tool for emulating cosmological likelihoods using deep neural networks. While it is a methodological advance in cosmological inference, it does not directly address galaxy simulations, near-field cosmology, or the other core topics.
...
## 20. [Uncovering the population of compact binary mergers and their formation pathways with gravitational waves through the Einstein Telescope](https://arxiv.org/abs/2512.17339) <a id="link20"></a>
...
**Comment:** This paper focuses on gravitational wave detections of compact binary mergers (black holes and neutron stars) and their formation pathways, with implications for the early universe and dark matter. However, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on compact objects and their cosmological implications, not on galaxy-scale processes or structures.
...
## 21. [Pulsed radio emission from a Central Compact Object](https://arxiv.org/abs/2512.17214) <a id="link21"></a>
...
**Comment:** This paper reports the first detection of pulsed radio emission from a Central Compact Object (CCO) in a supernova remnant. While it is an interesting result for neutron star populations and supernova remnants, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, or galaxy simulations.
...
## 22. [The MeerKLASS L-band On-the-Fly Continuum Survey: Data Release 1](https://arxiv.org/abs/2512.17685) <a id="link22"></a>
...
**Comment:** This is a data release paper for a large-area radio continuum survey (MeerKLASS). While the data could be used for studies relevant to the core topics, the paper itself does not focus on near-field cosmology, dwarf galaxies, or star formation histories.
...
## 23. [Magnetic field spreading from stellar and galactic dynamos into the exterior](https://arxiv.org/abs/2512.17770) <a id="link23"></a>
...
**Comment:** This paper discusses the spreading of magnetic fields from stellar and galactic dynamos into their exteriors, with some discussion of the intergalactic medium. However, it does not focus on dwarf galaxies, near-field cosmology, resolved star formation histories, or the other core topics. The focus is on magnetic field theory and not on galaxy simulations or outflows relevant to the prompt.
...
## 24. [The contribution from smalls scales on two-point shear analysis: comparison between power spectrum and correlation function](https://arxiv.org/abs/2512.17022) <a id="link24"></a>
...
**Comment:** This paper focuses on cosmic shear two-point statistics and the impact of small-scale modeling (e.g., baryonic feedback, intrinsic alignments) on cosmological parameter inference. While it discusses baryonic feedback models and their separation from cosmological signals, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on cosmological parameter estimation from large-scale structure, not on galaxy-scale or stellar processes.
...
## 25. [Across the Universe: GW231123 as a magnified and diffracted black hole merger](https://arxiv.org/abs/2512.17631) <a id="link25"></a>
...
**Comment:** This paper analyzes a gravitational wave event as a possible lensed black hole merger, focusing on lensing effects and source properties. While gravitational lensing is a tool in cosmology, the focus here is on black hole mergers and not on galaxies, their satellites, or star formation histories.
...
## 26. [Constraining primordial non-Gaussianity from DESI DR1 quasars and Planck PR4 CMB Lensing](https://arxiv.org/abs/2512.17865) <a id="link26"></a>
...
**Comment:** Focuses on constraining primordial non-Gaussianity using quasars and CMB lensing. While this is cosmology, it does not address near-field cosmology, dwarf galaxies, or any of the core topics.
...
## 27. [A search for late-type brown dwarfs in the Euclid Quick Data Release 1](https://arxiv.org/abs/2512.17494) <a id="link27"></a>
...
**Comment:** Searches for late-type brown dwarfs in the Euclid survey. While this is a study of substellar populations, it does not address near-field cosmology, dwarf galaxies, or any of the core topics.
...
## 28. [Super-resolution wavefront reconstruction in adaptive-optics with pyramid sensors](https://arxiv.org/abs/2512.17469) <a id="link28"></a>
...
**Comment:** This paper presents a method for super-resolution wavefront reconstruction in adaptive optics using pyramid sensors. While adaptive optics is important for astronomical observations, the work is technical and instrumental, not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 29. [ESO Expanding Horizon White Paper: Revealing the properties of matter at supranuclear densities with gravitational waves](https://arxiv.org/abs/2512.16971) <a id="link29"></a>
...
**Comment:** This paper focuses on the properties of matter at supranuclear densities using gravitational waves from neutron star mergers. While it is highly relevant to dense matter and gravitational wave astrophysics, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 31. [Evolving and interacting dark energy: photometric and spectroscopic synergy with DES Y3 and DESI DR2](https://arxiv.org/abs/2512.17684) <a id="link31"></a>
...
**Comment:** The paper investigates interacting dark energy models using cosmological data. While it discusses structure growth, it does not focus on galaxies, their satellites, or resolved star formation histories, and is not directly relevant to the core topics.
...
## 32. [The mass distribution of clumpy accretion onto the nearby young star TW Hya](https://arxiv.org/abs/2512.17074) <a id="link32"></a>
...
**Comment:** Analyzes accretion bursts onto the young star TW Hya using photometry and spectroscopy. While this is a study of star formation in a young stellar object, it does not address resolved star formation histories of galaxies or any of the other core topics.
...
## 33. [Implicit Likelihood Inference of the Neutrino Mass Hierarchy from Cosmological Data](https://arxiv.org/abs/2512.17744) <a id="link33"></a>
...
**Comment:** The paper uses implicit likelihood inference to constrain the neutrino mass hierarchy from cosmological data. While it is cosmology-related, it does not address galaxy evolution, near-field cosmology, or any of the core topics.
...
## 34. [The final stages of binary evolution using multi-messenger studies](https://arxiv.org/abs/2512.16988) <a id="link34"></a>
...
**Comment:** This paper discusses ultracompact Galactic binaries as gravitational wave sources and the science enabled by joint GW and EM observations. While interesting for compact object studies, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 35. [The accretion of quasars at the epoch of reionisation: $JWST$ catches the primeval monsters slowly feasting](https://arxiv.org/abs/2512.16981) <a id="link35"></a>
...
**Comment:** This paper uses JWST observations to study the accretion properties of high-redshift quasars. The focus is on supermassive black holes and quasar accretion, not on dwarf galaxies, near-field cosmology, or the other core topics.
...
## 36. [Gravitational wave oscillations in Multi-Proca dark energy models](https://arxiv.org/abs/2512.17088) <a id="link36"></a>
...
**Comment:** This paper discusses gravitational wave oscillations in the context of Multi-Proca dark energy models. While it touches on cosmology, it does not address near-field cosmology, galaxy formation, or any of the other specified relevant topics.
...
## 37. [Observations of AGN-driven feedback: dynamics and ionization of the filaments in M87](https://arxiv.org/abs/2512.17563) <a id="link37"></a>
...
**Comment:** This paper presents observations of AGN-driven feedback in M87, a massive elliptical galaxy. The focus is on AGN-driven (not star-formation-driven) outflows and the dynamics of filaments in a high-mass galaxy, which is outside the scope of the core topics. No direct connection to dwarf galaxies, star-formation-driven outflows, or the CGM of dwarfs.
...
## 38. [Surrogate-Accelerated Bayesian Inversion for Exoplanet Interior Characterization](https://arxiv.org/abs/2512.17626) <a id="link38"></a>
...
**Comment:** This paper presents a surrogate-accelerated Bayesian inversion framework for exoplanet interior characterization. The focus is on exoplanet structure modeling, not on galaxies, dwarf galaxies, or the other core topics.
...
## 39. [Trails of clouds in binary black holes](https://arxiv.org/abs/2512.17887) <a id="link39"></a>
...
**Comment:** This paper studies the evolution of bosonic clouds around binary black holes and their gravitational wave signatures. It is focused on black hole physics and ultralight particles, not on galaxies, dwarf satellites, star formation histories, or the circumgalactic medium. No core criteria are matched.
...
## 40. [Selected topics on: 1) proposal of interpreting the Crab supernova with a GRB 2) progress in identifying the seven GRBs episodes 3) the role of Sagittarius A in identifying the dark matter component (the X fermion)](https://arxiv.org/abs/2512.17787) <a id="link40"></a>
...
**Comment:** Covers topics in GRBs, the Crab supernova, and dark matter, but does not address near-field cosmology, dwarf galaxies, or any of the core topics.
...
## 41. [A VLA search for compact radio sources in the explosive molecular outflows DR 21 and G5.89](https://arxiv.org/abs/2512.17698) <a id="link41"></a>
...
**Comment:** This paper focuses on compact radio sources in explosive molecular outflows in star-forming regions (DR 21 and G5.89). While it discusses outflows, these are not galaxy-scale outflows but rather related to star formation in molecular clouds. No direct connection to near-field cosmology, resolved star formation histories, or other core topics.
...
## 42. [Radio studies of supernovae 1979C, 1986J and 2006X with LOFAR](https://arxiv.org/abs/2512.17520) <a id="link42"></a>
...
**Comment:** This paper presents radio studies of supernovae, focusing on their long-term evolution and circumstellar environments. While it discusses supernovae and their remnants, it does not address galaxy-scale outflows, dwarf galaxies, or other core topics.
...
## 43. [The Nature of Galactic Spiral Arms](https://arxiv.org/abs/2512.16966) <a id="link43"></a>
...
**Comment:** The paper is about the nature of spiral arms in disk galaxies, focusing on their pattern speeds and implications for galaxy evolution. It does not address dwarf galaxies, near-field cosmology, resolved star formation histories, or the other core topics. The focus is on spiral structure in more massive galaxies.
...
## 44. [A VERITAS view of HESS J1857+026 within a multi-wavelength analysis](https://arxiv.org/abs/2512.17184) <a id="link44"></a>
...
**Comment:** This paper presents a multi-wavelength study of a gamma-ray source, focusing on its morphology and possible pulsar wind nebula scenario. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 45. [The supernova Ia progenitor problem in the 2040s](https://arxiv.org/abs/2512.16991) <a id="link45"></a>
...
**Comment:** This paper discusses the progenitor problem for Type Ia supernovae, focusing on the identification and characterization of compact binaries in the Milky Way that could be SN Ia progenitors. While it touches on galactic chemical evolution and the need for new observational capabilities, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on binary evolution and supernova progenitors, which is outside the main scope.
...
## 46. [Quantum state of interacting primordial inhomogeneities: de-squeezing and decoherence](https://arxiv.org/abs/2512.17622) <a id="link46"></a>
...
**Comment:** The paper focuses on quantum states of primordial inhomogeneities during inflation, which is not related to any of the specified criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 47. [Baryogenesis and EDMs in the 2HDM+CS](https://arxiv.org/abs/2512.17695) <a id="link47"></a>
...
**Comment:** This paper discusses baryogenesis and electric dipole moments in a particle physics model. It does not address any of the core topics such as galaxy evolution, star formation, or simulations of galaxies.
...
## 48. [GW231123: Overlapping Gravitational Wave Signals?](https://arxiv.org/abs/2512.17550) <a id="link48"></a>
...
**Comment:** Paper analyzes gravitational wave signals and their interpretation, with no connection to galaxy formation, dwarf galaxies, or any of the core topics.
...
## 49. [Boiling away asymmetries: low-scale phase transitions, gravitational waves and leptogenesis](https://arxiv.org/abs/2512.17707) <a id="link49"></a>
...
**Comment:** Discusses leptogenesis, gravitational waves, and phase transitions in the early universe, which are not related to the core topics.
...
## 50. [Fermion Thermal Field Theory for a Rotating Plasma (with Applications to Neutron Stars)](https://arxiv.org/abs/2512.16993) <a id="link50"></a>
...
**Comment:** The paper develops thermal field theory for rotating plasmas with applications to neutron stars. The focus is on neutron star physics, not on galaxies, star formation histories, or near-field cosmology.
...
## 51. [Equilibriums of extremely magnetized compact stars with force-free magnetotunnels](https://arxiv.org/abs/2303.17874) <a id="link51"></a>
...
**Comment:** This paper presents numerical solutions for extremely magnetized compact stars, focusing on neutron stars and their magnetospheres. The topic is not related to galaxies, star formation, or near-field cosmology.
...
## 52. [Super-resolution-enabled atmospheric tomography for astronomical multi-wavefront-sensor adaptive-optics systems](https://arxiv.org/abs/2512.17430) <a id="link52"></a>
...
**Comment:** The paper discusses super-resolution-enabled atmospheric tomography for adaptive optics systems. The focus is on instrumentation and methods for improving AO performance, not on galaxies, dwarf galaxies, or the other core topics.
...
## 53. [Towards an Agnostic Algorithm for Sampling Empirical Structure Models: The case of Uranus and Neptune](https://arxiv.org/abs/2512.16995) <a id="link53"></a>
...
**Comment:** This paper presents an algorithm for sampling planetary interior density profiles, specifically for Uranus and Neptune. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models relevant to galaxies or star formation.
...
## 54. [Kinetic-Theory Bounds on the Equation of State of Dense QCD Matter](https://arxiv.org/abs/2512.17410) <a id="link54"></a>
...
**Comment:** This paper derives bounds on the equation of state of dense QCD matter, relevant for neutron stars and nuclear physics, but not for the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 55. [A Search for Binary Black Hole Mergers in LIGO O1-O3 Data with Convolutional Neural Networks](https://arxiv.org/abs/2512.17204) <a id="link55"></a>
...
**Comment:** This paper presents a machine learning pipeline for detecting binary black hole mergers in LIGO data. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 57. [Deviations from Gaussian White Noise in Stochastic Inflation](https://arxiv.org/abs/2512.17070) <a id="link57"></a>
...
**Comment:** This paper discusses deviations from Gaussian white noise in stochastic inflation, which is not related to any of the specified criteria such as galaxy evolution, star formation, or simulations.
...
## 58. [On the complex nature of coronal heating](https://arxiv.org/abs/2512.17880) <a id="link58"></a>
...
**Comment:** Focuses on coronal heating and magnetic field structure in the solar corona using MHD simulations. This is not related to near-field cosmology, dwarf galaxies, resolved star formation histories, or any other core topics.
...
## 59. [Semantic Model for the SKA Regional Centre Network](https://arxiv.org/abs/2512.17305) <a id="link59"></a>
...
**Comment:** Presents a semantic model for the SKA Regional Centre Network, focusing on data management and infrastructure, not on galaxy science or any of the core topics.
...
## 60. [Origin of Quasi-Periodic Oscillations and Accretion Process in X-Ray Binaries around Quantum Lee-Wick Black Hole](https://arxiv.org/abs/2512.17358) <a id="link60"></a>
...
**Comment:** Studies accretion and QPOs around Lee-Wick black holes in X-ray binaries, which is not related to galaxy formation, dwarf galaxies, or any of the core topics.
...
## 61. [Systematic search of laser and phase modulation noise coupling in heterodyne interferometry](https://arxiv.org/abs/2512.17802) <a id="link61"></a>
...
**Comment:** Focuses on noise coupling in heterodyne interferometry for gravitational wave detectors, not on galaxy science or any of the core topics.
...
## 62. [Investigating the AGN variability timescale -- black hole mass relationship with Gaia, SDSS and ZTF](https://arxiv.org/abs/2512.17811) <a id="link62"></a>
...
**Comment:** The paper investigates AGN variability and its relation to black hole mass using large surveys. The focus is on AGN and supermassive black holes, which are not relevant to the core topics (dwarf galaxies, near-field cosmology, star formation histories, etc.).
...
## 63. [Quantifying sunspot group nesting with density-based unsupervised clustering](https://arxiv.org/abs/2512.17364) <a id="link63"></a>
...
**Comment:** The paper quantifies sunspot group nesting on the Sun using clustering techniques. This is solar physics and not related to the core topics of near-field cosmology, galaxy evolution, or star formation histories in galaxies.
...
## 64. [Validating the performance of the Radio Neutrino Observatory in Greenland using cosmic-ray air showers](https://arxiv.org/abs/2512.17664) <a id="link64"></a>
...
**Comment:** This paper validates the performance of the Radio Neutrino Observatory in Greenland using cosmic-ray air showers. It is focused on detector commissioning and high-energy neutrino detection, not on galaxies or the core topics.
...
## 65. [Prediction of the Solar Polar Fields in 2026: An Unusually Weak Level Across the Last Five Solar Cycles](https://arxiv.org/abs/2512.17359) <a id="link65"></a>
...
**Comment:** The paper predicts the solar polar fields for the next solar cycle using surface flux-transport models. This is focused on solar physics and does not relate to any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 66. [High-Resolution Measurements with the CTAO Southern Array: The Case for Pulsar Wind Nebulae](https://arxiv.org/abs/2512.17498) <a id="link66"></a>
...
**Comment:** The paper discusses the use of the Cherenkov Telescope Array for high-resolution studies of pulsar wind nebulae. The focus is on gamma-ray observations of PWNe, not on galaxies, dwarf galaxies, or any of the core topics.
...
## 67. [Revisited apparent horizon entropy and GSL in modified gravity](https://arxiv.org/abs/2512.17861) <a id="link67"></a>
...
**Comment:** The paper presents a formalism for apparent horizon entropy in modified gravity and its implications for the generalized second law of thermodynamics. The focus is on theoretical cosmology and gravity, not on galaxies, dwarf galaxies, or the other core topics.
...
## 68. [Surveying Ultra-hot Jupiters using Phase Curves with $\textit{Twinkle}$](https://arxiv.org/abs/2512.17147) <a id="link68"></a>
...
**Comment:** This paper focuses on phase curve observations of ultra-hot Jupiters, which are exoplanets, not galaxies. None of the core topics (near-field cosmology, resolved star formation histories, galaxy simulations, etc.) are addressed. No relevant criteria match.
...
## 69. [Ghost-free 2-form fields in cosmology: implications for gravitational parity violation](https://arxiv.org/abs/2512.17348) <a id="link69"></a>
...
**Comment:** This paper discusses 2-form fields in cosmology and their implications for gravitational parity violation. It does not address any of the core topics such as dwarf galaxies, star formation histories, galaxy simulations, or stellar models.
...
## 70. [Constraining the Nanohertz Gravitational Wave Background with an X-ray Pulsar Timing Array from NICER observations](https://arxiv.org/abs/2512.17201) <a id="link70"></a>
...
**Comment:** This paper presents constraints on the nanohertz gravitational wave background using X-ray pulsar timing. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 71. [Constraining the Prompt Atmospheric Neutrino Flux Combining IceCube's Cascade and Track Samples](https://arxiv.org/abs/2512.17760) <a id="link71"></a>
...
**Comment:** This paper is focused on constraining the prompt atmospheric neutrino flux using IceCube data. It is entirely about high-energy neutrino astrophysics and particle physics, with no connection to galaxies, star formation, or any of the core topics.
...
## 72. [Constraining black hole spin in PG 1535+547 amidst complex multi-layered absorption](https://arxiv.org/abs/2512.17539) <a id="link72"></a>
...
**Comment:** This paper focuses on X-ray spectroscopy of an active galactic nucleus (AGN), specifically constraining black hole spin and absorption in PG 1535+547. It does not match any of the relevant criteria such as near-field cosmology, resolved star formation histories, or stellar models. The focus is on AGN physics, which is outside the scope of the core topics.
...
## 73. [SatTrack: Software for Evaluating Satellite Interference and Rim-Based Interference Mitigation Using a Reconfigurable Parabolic Antenna](https://arxiv.org/abs/2512.17016) <a id="link73"></a>
...
**Comment:** This paper presents software for evaluating satellite interference and mitigation using reconfigurable antennas. It is unrelated to astrophysics or any of the specified criteria.
...
## 74. [Exoplanets in reflected starlight with dual-field interferometry and a fifth Unit Telescope at VLTI](https://arxiv.org/abs/2512.17026) <a id="link74"></a>
...
**Comment:** This is a white paper proposing an upgrade to the VLTI for exoplanet detection. The focus is on instrumentation for exoplanet studies, not on galaxies, dwarf galaxies, or the other core topics.
...
## 75. [In situ substrate birefringence characterization in gravitational wave detectors using a heterodyne polarimetry method](https://arxiv.org/abs/2512.17395) <a id="link75"></a>
...
**Comment:** This paper focuses on birefringence characterization in gravitational wave detector substrates. It is not related to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
