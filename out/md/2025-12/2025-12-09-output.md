...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 62710    | 10017        | 72727   |
| **Cost**             | $0.13    | $0.08        | $0.21   |

Total arXiv papers: 240
...
1. [A Galactic Transformation -- Understanding the SMC's Structural and Kinematic Disequilibrium](#user-content-link1)
**Authors:** Himansh Rathore (U. Arizona), Gurtina Besla (U. Arizona), Roeland P. van der Marel (STSci), Nitya Kallivayalil (U. Virginia)

2. [The quenched fraction of satellites around simulated Milky Way-mass galaxies](#user-content-link2)
**Authors:** Francisco J. Mercado, Devontae C. Baxter, M. Katy Rodriguez Wimberly, Jorge Moreno, Coral Wheeler, Pratik Gandhi, Andrew Wetzel, Robert Feldmann, Ludas Tortora, Jenna Samuel

3. [The heartbeat of stellar halos: Insights from the stellar halo mass-metallicity relation](#user-content-link3)
**Authors:** Jenny Gonzalez-Jara, Patricia B. Tissera, Antonela Monachesi, Brian Tapia-Contreras, Susana Pedrosa, Rosa Dominguez-Tenreiro, Lucas Bignone

4. [Core-halo scaling relations in self-interacting scalar field dark matter](#user-content-link4)
**Authors:** Jessica N. L\'opez-S\'anchez, Erick Munive-Villa, Tanja Rindler-Daller

5. [Globular clusters in \textsc{OrbIT}: complete dynamical characterisation of the globular cluster population of the Milky Way through updated orbital reconstruction](#user-content-link5)
**Authors:** Michele De Leo, Manuela Zoccali, Julio Olivares-Carvajal, Bel\'en Acosta-Tripailao, Felipe Gran, Rodrigo Contreras-Ramos

6. [The shape-velocity alignment of satellites forged by tidal locking and dynamical friction](#user-content-link6)
...
7. [A Test of Substellar Evolutionary Models with High-Precision Ages from Asteroseismology and Gyrochronology for the Benchmark System HR 7672AB](#user-content-link7)
...
8. [Masked Autoencoder Pretraining on Strong-Lensing Images for Joint Dark-Matter Model Classification and Super-Resolution](#user-content-link8)
...
9. [DESI Strong Lens Foundry V: A Sample of HST-Observed Strong Lenses Modeled with GIGA-Lens](#user-content-link9)
...
10. [CLASSY XIV: The Nitrogen Exception -- Multi-Phase Enrichment and Feedback in High-$z$ Analogs](#user-content-link10)
**Authors:** Bethan L. James, Valentina Abril-Melgarejo, Karla Z. Arellano-C\'ordova, Adarsh Ranjan, Kaelee S. Parker, Danielle A. Berg, Matilde Mingozzi, Alessandra Aloisi, John Chisholm, Timothy Heckman, Alaina Henry, Svea Hernandez, Kristen B. W. McQuinn, Xinfeng Xu, Chiaki Kobayashi, The CLASSY Collaboration

11. [Generating LSB-optimised synthetic images for simulated galaxies](#user-content-link11)
**Authors:** Maarten Baes, Peter Camps, Andrea Gebek, Arno Lauwers, Joop Schaye, Paul Vauterin

12. [A pan-galaxy study of synthetic giant molecular filaments: a turbulence-dominated life cycle](#user-content-link12)
**Authors:** Zipeng Hu, Ke Wang, Mark R. Krumholz, Keyun Su

13. [FEASTS Compared with Simulations: Abnormally Irregular and Extended HI Morphologies at a Column Density of $10^{18}\,\text{cm}^{-2}$ in TNG50 and Auriga](#user-content-link13)
**Authors:** Xuchen Lin, Jing Wang, Guinevere Kauffmann, Volker Springel, R\"udiger Pakmor

14. [Interplay between Escaping Cosmic Rays and Interstellar Medium: Driving of Galactic Winds and Shaping the Local Proton Spectrum](#user-content-link14)
**Authors:** Jiro Shimoda, Katsuaki Asano, Shu-ichiro Inutsuka

15. [The influence of external environment at cosmic noon on the subsequent evolution of galaxy stellar mass](#user-content-link15)
**Authors:** Tianmu Gao, J. Trevor Mendel, Lucas C. Kimmig, Claudia del P. Lagos, Rhea-Silvia Remus, Emily Wisnioski, Kathryn Grasha

16. [Revisiting the Evolutionary Status of Massive Stars at the central parsec of the Milky Way](#user-content-link16)
**Authors:** A. C. Gormaz-Matamala, J. Cuadra, B. Kub\'atov\'a, J. Kub\'at, S. Ekstr\"om

17. [Chemical complexity in star formation induced by stellar feedback: cores shock-formed by the supernova remnant W44](#user-content-link17)
...
18. [A New Torus Generator for AGAMA](#user-content-link18)
**Authors:** James Binney, Thomas J Wright, Eugene Vasiliev

19. [Probing Cosmic Magnetism with Rotation Measure-Squared-Galaxy Cross-Correlations](#user-content-link19)
**Authors:** Zekai Zhang, Adam Lidz

20. [Phase-space perturbation theory for cosmic large-scale structure](#user-content-link20)
**Authors:** Hannes Heisler, Marvin Sipp, Matthias Bartelmann

21. [Lyman-$\alpha$ Visibility During the Epoch of Reionization: Combining JWST FRESCO Grism Data with Keck Archival Spectroscopy](#user-content-link21)
**Authors:** Ecaterina Leonova, Rohan P. Naidu, Pascal A. Oesch, Gabriel Brammer, Jorryt Matthee, Romain A. Meyer, Daniel Schaerer, Mengyuan Xiao

22. [Solver-in-the-Loop Applications in Astrophysical (Magneto)hydrodynamics](#user-content-link22)
**Authors:** Leonard Storcks, Tobias Buck

23. [On the Origin of Intracluster Light based on the High-resolution Simulation, NewCluster](#user-content-link23)
**Authors:** Seyoung Jeon, Emanuele Contini, San Han, Jinsu Rhee, Garreth Martin, Juhan Kim, Jaehyun Lee, Taysun Kimm, Christophe Pichon, Gyeong-Hwan Byun, Yohan Dubois, Corentin Cadiou, J. K. Jang, Sukyoung K. Yi

24. [SHORES II: Multi-frequency Characterisation of the Sub-mJy Radio Population in FIR-selected Fields](#user-content-link24)
**Authors:** Meriem Behiri, Marcella Massardi, Vincenzo Galluzzi, Marika Giulietti, Gayathri Gururajan, Isabella Prandoni, Andrea Lapi

25. [Statistics of the projected angles between the black-hole spin and the host-galaxy rotation axes from NewHorizon](#user-content-link25)
**Authors:** Sebastien Peirani, Yasushi Suto, Clotilde Laigle, Yen-Ting Lin, Yohan Dubois, Sukyoung K. Yi

26. [Diverse stages of star formation in the IRAS 18162-2048 region. Emergence of UV Feedback](#user-content-link26)
**Authors:** R. Fedriani, G. Anglada, A. Caratti o Garatti, J. F. G\'omez, J. Masqu\'e, M. Osorio, B. Stecklum, A. R. Rodr\'iguez-Kamenetzki, R. Galv\'an-Madrid, C. Carrasco-Gonz\'alez, G. Bl\'azquez-Calero, A. F. Placinta-Mitrea, A. Sanna, R. Cesaroni, L. Moscadelli, T. P. Ray, D. Coffey, G. A. Fuller

27. [The Milky Way Project: Bridging Intermediate- and High-Mass Star Formation with the MIRION Catalog of Yellowballs](#user-content-link27)
**Authors:** Kathryn Devine, Grace Wolf-Chase, C. R. Kerton, Nicholas Larose, Maya Coleman, Makenzie Stapley, Ethan Bassingthwaite, Bezawit Mekasa Kassaye, Hritik Rawat, Tharindu Jayasinghe

28. [From the Intergalactic to the Interstellar Scales -- EQUALS: a High-resolution Legacy Survey of Gas in the Distant Universe Using ESPRESSO](#user-content-link28)
**Authors:** Trystyn Berg, Valentina D'Odorico, Elisa Boera, Giorgio Calderone, Rodrigo Cuellar, Guido Cupani, Stefano Cristiani, Simona Di Stefano, Andrea Grazian, Francesco Guarneri, Vid Ir\v{s}i\v{c}, Sebastian Lopez, Dinko Milakovi\'c, Pasquier Noterdaeme, Luca Pasquini, Matteo Viel, Louise Welsh

29. [The THESAN project: Lyman-alpha intensity mapping of cosmic reionization](#user-content-link29)
**Authors:** Mouza Almualla (Harvard), Aaron Smith (UT Dallas), Rahul Kannan (York), Lars Hernquist (Harvard), Enrico Garaldi (Kavli IPMU), Adam Lidz (UPenn), Kevin Lorinc (UT Dallas), Jennifer Yik Ham Chan (Oberlin), Mark Vogelsberger (MIT)

30. [Genesis of Axion Dark Matter via Black Hole and Cosmic String Dynamics](#user-content-link30)
**Authors:** Ishan Swamy, Deobrat Singh

31. [Precise determination of circumstellar disk lifetimes: Disk evolution in a single star-forming region](#user-content-link31)
**Authors:** Fabian A. Polnitzky, Sebastian Ratzenb\"ock, Josefa E. Gro{\ss}schedl, Jo\~ao Alves

32. [Actions of highly eccentric orbits](#user-content-link32)
**Authors:** Thomas J Wright, James Binney

33. [JWST reveals extended stellar disks for ALMA-bright dusty star-forming galaxies in the Spiderweb protocluster](#user-content-link33)
**Authors:** Y. H. Zhang, H. Dannerbauer, J. M. P\'erez-Mart\'inez, Y. Koyama, X. Z. Zheng, R. Calvi, Z. Chen, K. Daikuhara, C. De Breuck, C. D'Eugenio, B. H. C. Emonts, S. Jin, T. Kodama, M. D. Lehnert, J. Nadolny, A. Naufal, P. G. P\'erez-Gonz\'alez

34. [The GLEAM 4-Jy (G4Jy) Sample: III. Further host-galaxy identification, and redshift assessment](#user-content-link34)
**Authors:** Sarah V. White, Precious K. Sejake, Kshitij Thorat, Heinz Andernach, Thomas M. O. Franzen, O. Ivy Wong, Anna D. Kapinska, Joseph R. Callingham, Christopher J. Riseley, Nick Seymour, Randall Wayth, Lister Staveley-Smith, Rajan Chhetri, Natasha Hurley-Walker, John Morgan, Paul Hancock, Francesco Massaro, Abigail Garcia-Perez, Ana Jimenez-Gallardo, Harold A. Pena-Herazo

35. [Simulation Study of Binary Mergers of Galaxy Clusters I: Properties of Merger Shocks and Radio Emission](#user-content-link35)
**Authors:** Hyesung Kang (Department of Earth Sciences, Pusan National University, Korea), Dongsu Ryu (Department of Physics, UNIST, Korea), Jeongbhin Seo (Department of Physics, UNIST, Korea, Los Alamos National Laboratory, Theoretical Division, USA)

36. [What Galaxy Clusters Have to Say About Dynamical Dark Energy and $H_0$](#user-content-link36)
**Authors:** Andr\'es N. Salcedo, Eduardo Rozo, Hao-Yi Wu, Shulei Cao, Enrique Paillas, Hanyu Zhang, Eli S. Rykoff

37. [The eROSITA Final Equatorial-Depth Survey (eFEDS): X-ray stacking analysis of Subaru's optically selected clusters spanning low richness regime](#user-content-link37)
**Authors:** N. T. Nguyen-Dang, N. Ota, N. Okabe, M. Oguri, I. Mitsuishi, T. H. Reiprich, F. Pacaud, E. Bulbul, J. S. Sanders, M. Br\"uggen, A. Liu, Y. Tsujita, I. Chiu, V. Ghirardini, S. Grandis, M. Klein, K. Migkas, H. Miyatake, S. Miyazaki, M. E. Ramos-Ceja

38. [Black hole merger rates for LISA and LGWA from semi-analytical modelling of light seeds](#user-content-link38)
**Authors:** Jasbir Singh, Paola Severgnini, Vieri Cammelli, Alessandra De Rosa, Cristian Vignali, Fabio Rigamonti, Rosa Valiante, Pierluigi Monaco, Jonathan C. Tan, Lorenzo Battistini, Roberto Della Ceca, Jan Harms, Manali Parvatikar

39. [An Ancient Brown Dwarf Transiting a Metal-Poor Thick Disk Star](#user-content-link39)
**Authors:** J\'ea Adams Redai, Vedant Chandra, Samuel W. Yee, Victoria DiTomasso, Sean Andrews, Karin \"Oberg, Rebecca Woody, David W. Latham, Allyson Bieryla, Samuel N. Quinn, David Charbonneau, Theron W. Carmichael, Chih-Chun Hsu, Noah Vowell, Jason J. Wang, Sebastian Zieba, Paul Benni, Karen A. Collins, David R. Ciardi, Julian van Eyken, William Fong, Michael B. Lund, Andrei M. Tatarnikov

40. [Squeezed Limit non-Gaussianity Estimation with Cosmic Shear](#user-content-link40)
**Authors:** Shi-Hui Zang, Moritz M\"unchmeyer

41. [Vision Transformers for Cosmological Fields: Application to Weak Lensing Mass Maps](#user-content-link41)
**Authors:** Jash Kakadia, Shubh Agrawal, Kunhao Zhong, Bhuvnesh Jain

42. [Counting voids and filaments: Betti Curves as a Powerful Probe for Cosmology](#user-content-link42)
**Authors:** Jiayi Li, Cheng Zhao

43. [Revealing Hidden Repeaters in the CHIME/FRB Catalog: Semi-Supervised Insights into the Fast Radio Burst Population](#user-content-link43)
**Authors:** N. Mankatwit, P. Thongkonsing, S. Loekkesee, P. Chainakun, W. Luangtip, S. Sanpa-arsa

44. [Probing memory-burdened Primordial Black Holes with global 21 cm signal](#user-content-link44)
**Authors:** Priyanka Sarmah, Kingman Cheung

45. [Modelling dust coagulation, dynamical drag and turbulent mixing during star and disc formation](#user-content-link45)
**Authors:** Matthew R. Bate, Mark A. Hutchison, Daniel Elsender

46. [A XRISM/Resolve view of the dynamics in the hot gaseous atmosphere of M87](#user-content-link46)
...
47. [A Fully Photometric Approach to Type Ia Supernova Cosmology in the LSST Era: Host Galaxy Redshifts and Supernova Classification](#user-content-link47)
...
48. [Interstellar Medium in Extremely High Star-Formation Regions: A Prospect of Observations on the Millimetron](#user-content-link48)
**Authors:** E. O. Vasiliev, S. A. Drozdov, P. V. Baklanov, O. P. Vorobyov, S. Yu. Dedikov, M. S. Kirsanova, T. I. Larchenkova, N. N. Shakhvorostova

49. [SN 2024afav: A Superluminous Supernova with Multiple Light Curve Bumps and Spectroscopic Signatures of Circumstellar Interaction](#user-content-link49)
**Authors:** Harsh Kumar, Peter K. Blanchard, Edo Berger, Wasundara Athukoralalage, Daichi Hiramatsu, Sebastian Gomez, Moira Andrews, K. Azalee Bostroem, Joseph R. Farah, D. Andrew Howell, Curtis McCully

50. [An Extended WZDR Model with Interacting Scalar Field Dark Matter and Stepped Dark Radiation](#user-content-link50)
**Authors:** Gang Liu

51. [EP241217a: a likely Type II GRB with an achromatic bump at z = 4.59](#user-content-link51)
...
52. [Extreme mass ratio inspirals in the cold vector dark matter environment](#user-content-link52)
**Authors:** Rajesh Karmakar, Kaustubh Mukund Vispute, Debaprasad Maity

53. [Generalized tension metrics for multiple cosmological datasets](#user-content-link53)
**Authors:** Mat\'ias Leizerovich, Susana J. Landau, Claudia G. Sc\'occola

54. [Microquasar remnants as hidden PeVatrons](#user-content-link54)
**Authors:** Leandro Abaroa, Gustavo E. Romero, Valent\'i Bosch-Ramon

55. [Diagnosing Interstellar Magnetic Turbulence with TeV Pulsar Halos](#user-content-link55)
**Authors:** Chao-Ming Li, Ruo-Yu Liu, Huirong Yan

56. [Giant outbursts of clumpy material preceding Type II supernova 2024qiw](#user-content-link56)
**Authors:** T. Nagao, H. Kuncarayakti, K. Maeda, S. Mattila, R. Kotak, T. Killestein, C. Humina, D. Steeghs, D. Jarvis

57. [Multi-Wavelength Afterglows as Diagnostic Probes of Dense Circumburst Medium in GRBs](#user-content-link57)
**Authors:** Xiao-Hong Zhao

58. [Surface temperature of an accretion disk around a wormhole Kerr-mimicker](#user-content-link58)
**Authors:** A. Karakonstantakis, W. Klu\'zniak

59. [Non-thermal Synchrotron Emission and Polarization Signatures during Black Hole Flux Eruptions](#user-content-link59)
**Authors:** Fan Zhou, Jiewei Huang, Yuehang Li, Zhenyu Zhang, Yehui Hou, Minyong Guo, Bin Chen

60. [A Multi-Probe ISW Study of Dark Energy Models with Negative Energy Density: Galaxy Correlations, Lensing Bispectrum, and Planck ISW-Lensing Likelihood](#user-content-link60)
**Authors:** Payam Ghafari, Mahdi Najafi, Mina Ghodsi Yengejeh, Emre \"Oz\"ulker, Eleonora Di Valentino, Javad T. Firouzjaee

61. [Understanding the Planetary Formation and Evolution in Star Clusters(UPiC)-II: Catalog of planets/candidates in Open Clusters and Moving Groups](#user-content-link61)
**Authors:** Yuan-Zhe Dai, Hui-Gen Liu, Xiaoying Pang, Yueyue Jiang, Jerome P. de Leon, Jing Zhong, Ji-Lin Zhou

62. [Angular BAO Forecasts for the IBIS Medium-Band Survey](#user-content-link62)
**Authors:** Richard M. Feder, Martin White

63. [Shock trapping and inertial escape: Dust-particle clustering in compressible turbulence](#user-content-link63)
**Authors:** Anikat Kankaria, Samriddhi Sankar Ray

64. [A Song of Lines and Winds: Tracing the Signatures of AGN Outflows in X-rays](#user-content-link64)
**Authors:** M. Laurenti, F. Tombesi, P. Cond\`o, M. Gaspari, F. Nicastro, E. Torresi, A. Luminari, E. Piconcelli, L. Zappacosta, K. Fukumura, G. Lanzuisi, R. Serafinelli, M. Dadina, M. Cappi, R. Middei, F. Arevalo Gonzalez, F. Di Salvo

65. [Do Low-Mass, Low-Luminosity AGNs Deviate from the Quasar Main Sequence?](#user-content-link65)
**Authors:** Himanshu Sharma, Vivek Kumar Jha, Hum Chand, Swayamtrupta Panda

66. [Hot, Photoionized X-ray Gas in Two Luminous Type 2 Quasars: Chandra-HST Evidence for a Wind-Driven Sequence](#user-content-link66)
**Authors:** Anna Trindade Falc\~ao, S. Kraemer, L. Feuillet, R. Middei, T. J. Turner, J. Reeves, V. Braito, A. Ptak, H. R. Schmitt, T. C. Fischer, D. M. Crenshaw, Luis C. Ho, M. Revalski, T. Storchi-Bergmann, M. Vestergaard, C. M. Gaskell, W. P. Maksym, M. Elvis, M. J. Ward, H. Netzer

67. [The impact of surface acetylene cyclotrimerization on the abundance of aromatic hydrocarbons in carbon-rich asymptotic giant branch stars](#user-content-link67)
**Authors:** M. S. Murga, I. V. Loginov, D. S. Wiebe, D. R. Fedotova, V. S. Krasnoukhov, I. O. Antonov

68. [Water vapor emission at the warm cavity wall of the HD 100546 disk as revealed by ALMA](#user-content-link68)
**Authors:** Luna Rampinelli, Stefano Facchini, Margot Leemker, Andrea Isella, Pietro Curone, Myriam Benisty, Elizabeth M. Humphreys, Leonardo Testi
...
70. [SPHEREx Pre-Perihelion Mapping of $\mathrm{H_2O}$, $\mathrm{CO_2}$, and $\mathrm{CO}$ in Interstellar Object 3I/ATLAS](#user-content-link70)
**Authors:** Carey M. Lisse, Yoonsoo P. Bach, Sean A. Bryan, Brendan P. Crill, Phil M. Korngut, Ari J. Cukierman, Michael W. Werner, Asantha Cooray, Michael Zemcov, Volker Tolls, Gary J. Melnick, Andreas L. Faisst, C. Darren Dowell, Seungwon Choi, Jooyeon Geem, Masateru Ishiguro, Hangbin Jo, Bumhoo Lim, Max Mahlke, Joseph L. Hora, Yun-Ting Cheng, Spencer Everett, Jeong-Eun Lee, Zafar Rustamkulov, Sunho Jin, Howard Hui, Daniel C. Masters, Chi H. Nguyen, Roberta Paladini, Yujin Yang, James J. Bock, O. Dor\'e, M. L. Sitko, C. Champagne, M. Connelley, J. P. Emery, Y. R. Fernandez, W. T. Reach

71. [Widen the Resonance at Ultra-High Energies: Novel Probes of Neutrino Self-interactions in the High-Mass Regime](#user-content-link71)
**Authors:** Pedro A. N. Machado, Isaac R. Wang, Xun-Jie Xu, Bei Zhou

72. [A Fast, Parallelized, GPU-Accelerated Photochemical Model, XODIAC, with Built-in Equilibrium Chemistry and Multiple Chemical Networks for Exoplanetary Atmospheres](#user-content-link72)
**Authors:** Priyankush Ghosh, Sambit Mishra, Shubham Dey, Debayan Das, Paul B. Rimmer, Liton Majumdar

73. [Effects of helium sedimentation on late star formation in galaxy clusters](#user-content-link73)
**Authors:** J. Racker, N. Padilla

74. [Testing the Distance Duality Relation with Cosmological Observations at high Redshift using Artificial Neural Network](#user-content-link74)
**Authors:** Yukang Xie, Yang Liu, Puxun Wu, Xiangyun Fu, Nan Liang

75. [Apparent Phantom Crossing in Gauss-Bonnet Gravity](#user-content-link75)
**Authors:** Shin'ichi Nojiri, Sergei D. Odintsov, V. K Oikonomou

76. [Dynamical Dark Energy and the Unresolved Hubble Tension: Multi-model Constraints from DESI 2025 and Other Probes](#user-content-link76)
**Authors:** Zhuoming Zhang, Tengpeng Xu, Yun Chen

77. [BSN: Light Curve Modeling and Orbital Evolution of the Total-Eclipse Contact Binary EZ Oct](#user-content-link77)
**Authors:** Asma Ababafi, Atila Poro, Mehmet Tanriver, Eduardo Fern\'andez Laj\'us

78. [Relationship between Poincar\'e Sections and Spectral Characteristics of Orbits of Globular Clusters in the Central Region of the Galaxy](#user-content-link78)
**Authors:** Anisa Bajkova, Anton Smirnov, Vadim Bobylev

79. [Anisotropic Diffusion Modeling of Cosmic-Ray Lepton Propagation](#user-content-link79)
**Authors:** V. D. Borisov, I. A. Kudryashov

80. [ExoNAMD: Leveraging the spin-orbit angle to constrain the dynamics of multiplanetary systems](#user-content-link80)
**Authors:** A. Bocchieri, J. Zak, D. Turrini

81. [FIP-TOI: Fast Imaging Pipeline for Pulsar Localisation with a Transient-Oriented Radio Astronomical Imager](#user-content-link81)
**Authors:** X. Li, K. Adamek, M. Giles, W. Armour

82. [Revisiting PBH Accretion, Evaporation and Their Cosmological Consequences](#user-content-link82)
**Authors:** Jitumani Kalita, Debaprasad Maity

83. [Dynamical Dark Energy in light of DESI BAO and Full-Shape Data](#user-content-link83)
**Authors:** Quan Zhou, Sibo Zheng

84. [Inference of $B$-mode polarization in the presence of non-Gaussian foregrounds](#user-content-link84)
**Authors:** Sen Li, Chang Feng, Filipe B. Abdalla

85. [Prospects for independent measurement of $\boldsymbol{\ell}$=1,2,3 CMB anisotropy multipoles using the anisotropic Sunyaev-Zel'dovich effect](#user-content-link85)
**Authors:** D. I. Novikov, A. O. Mihalchenko, A. M. Osipova, K. O. Parfenov, S. V. Pilipenko

86. [The influence of Parker spiral on the reflection-driven turbulence](#user-content-link86)
**Authors:** Khurram Abbas, Jonathan Squire

87. [Constraining meV Axion Dark Matter with ALMA Observations of the Galactic Center Magnetar SGR 1745-2900](#user-content-link87)
**Authors:** Javier De Miguel, Evanthia Hatziminaoglou, Fr\'ed\'eric Poidevin, Nanda Rea, Daniel L. Walker, Davide De Grandis, Jaime Prieto-Polo

88. [SS433 PeV neutron jet feeding the far TeV gamma beam](#user-content-link88)
**Authors:** Daniele Fargion, Pier Giorgio De Sanctis Lucentini, Sara Turriziani, Danila Sopin, Maxim Yu. Khlopov

89. [Observability of eccentricity in a population of merging compact binaries](#user-content-link89)
**Authors:** Mukesh Kumar Singh, Ben G. Patterson, Stephen Fairhurst

90. [Fast X-ray Variability from the Coronae of Supermassive Black Holes](#user-content-link90)
**Authors:** Xiurui Zhao, Luca Comisso, Stefano Marchesi, Marco Ajello, Elias Kammoun, Yue Shen, Qiaoya Wu

91. [Universal relation involving fundamental modes in two-fluid dark matter admixed neutron stars](#user-content-link91)
**Authors:** Hajime Sotani, Ankit Kumar

92. [Investigating all-sky Frequency Hough performances for neutron stars](#user-content-link92)
**Authors:** Martina Di Cesare, Pia Astone, Rosario De Rosa, David Keitel, Cristiano Palomba, Marco Serra

93. [Evidence of young magnetars in massive binary embedded in a supernova remnant as sources of active fast radio bursts](#user-content-link93)
**Authors:** F. Y. Wang, H. T. Lan, Z. Y. Zhao, Q. Wu, Y. Feng, S. X. Yi, Z. G. Dai, K. S. Cheng

94. [Revealing the accelerating wind in the inner region of the colliding-wind binary WR 112](#user-content-link94)
**Authors:** John D. Monnier (U. Michigan), Yinuo Han (Caltech), Michael F. Corcoran (NASA GSFC X-ray Lab, Catholic Univ. America), Sanne Bloot (ASTRON, Kapteyn Inst), Joseph R. Callingham (ASTRON, Univ. Amsterdam), William Danchi (NASA GSFC Astrophysics), Philip G. Edwards (CSIRO Space & Astronomy / ATNF), Lincoln Greenhill (Smithsonian Astrophysical Observatory), Kenji Hamaguchi (NASA GSFC X-ray Lab, UMBC), Matthew J. Hankins (Arkansas Tech Univ), Ryan Lau (NSF NOIRLab), Jon M. Miller (U. Michigan), Anthony F. J. Moffat (Univ. Montr\'eal), Garreth Ruane (JPL), Christopher M. P. Russell (Univ. Delaware), Anthony Soulain (Univ. Grenoble Alpes & CNRS), Samaporn Tinyanont (NARIT), Peter Tuthill (Univ. Sydney), Jason J. Wang (Northwestern), Peredur M. Williams (Edinburgh)

95. [Trends in gravitational wave emission in axisymmetric simulations of rotating core-collapse supernovae](#user-content-link95)
**Authors:** Bailey Sykes, Bernhard M\"uller

96. [Deciphering transmission spectra by exploring the solar paradigm](#user-content-link96)
**Authors:** Nina-Elisabeth N\`emec, \`Oscar Porqueras- L\'eon, Ignasi Ribas, Alexander I. Shapiro

97. [The phases of QCD reached in terrestrial and cosmic colliders](#user-content-link97)
**Authors:** Sourendu Gupta

98. [Quenching factors for Na recoils as a function of Tl dopant concentrations in NaI(Tl) crystals](#user-content-link98)
**Authors:** G. Angloher, M. R. Bharadwaj, A. B\"ohmer, M. Cababie, I. Colantoni, I. Dafinei, N. Di Marco, C. Dittmar, L. Einfalt, F. Ferrella, F. Ferroni, S. Fichtinger, A. Filipponi, T. Frank, M. Friedl, M. Gapp, L. Gai, Z. Ge, M. Heikinheimo, M. N. Hughes, K. Huitu, M. Kellermann, R. Maji, M. Mancuso, L. Pagnanini, F. Petricca, S. Pirro, F. Pr\"obst, G. Profeta, A. Puiu, F. Reindl, K. Sch\"affner, J. Schieck, P. Schreiner, C. Schwertner, K. Shera, M. Stahlberg, A. Stendahl, M. Stukel, C. Tresca, F. Wagner, S. Yue, V. Zema, Y. Zhu, P. S. Barbeau, S. C. Hedges, C. Awe, J. Runge, T. Johnson, D. M. Markoff, P. An, C. G. Prior, A. Bracho, S. Alawabdeh

99. [Optical Study of TRAPUM Pulsars and Modelling of the Redbacks: PSR J1036$-$4353 and PSR J1803$-$6707](#user-content-link99)
**Authors:** A. Phosrisom, R. P. Breton, C. J. Clark, M. Burgay, J. Strader, L. Chomiuk, K. V. Sokolovsky, I. Molina, R. Urquhart, M. R. Kennedy, S. J. Wagner, V. S. Dhillon, O. G. Dodge, B. W. Stappers, T. Thongmeearkom

100. [Paucity of downward UHE neutrino tracks in IceCube versus unexpected huge KM3-230213A event: solving the puzzles?](#user-content-link100)
**Authors:** D. Fargion

101. [ZTF-SEDm Type Ia supernova sample for Twins Embedding spectrophotometric standardisation](#user-content-link101)
...
102. [NEO and imminent impactor discoveries from Hungary: recent results and lessons learnt](#user-content-link102)
**Authors:** Norton O. Szabo, Krisztian Sarneczky, Laszlo L. Kiss, Szabolcs Velkei, Attila Bodi, Zsofia Bora, Balazs Csak, Borbala Cseh, Agoston Horti-David, Andras Joo, Csilla Kalup, Zoltan Kuli, Laszlo Meszaros, Andras Pal, Balint Seli, Adam Sodor, Robert Szakats, Nora Takacs

103. [Unified models revisited I: modelling the effect of source geometry on radio galaxy/quasar unification](#user-content-link103)
**Authors:** Siddhant Pinjarkar, Martin J. Hardcastle, Jonathon C. S. Pierce, Frits Sweijen

104. [Evaporation of Primordial Black Holes in a Thermal Universe: A Thermofield Dynamics Approach](#user-content-link104)
**Authors:** Ayan Chatterjee, Jitumani Kalita, Debaprasad Maity

105. [Over-abundant gamma-like signals around Solar disk shadows by twin bent and smeared muon and electron pairs secondaries, versus rare local TeV gamma](#user-content-link105)
**Authors:** Daniele Fargion, Omar Tibolla, Pier Giorgio De Sanctis Lucentini, Sara Turriziani, Sarah Kaufmann, Danila Sopin, Maxim Yu. Khlopov

106. [Rotational Spectra and Search for Aromatic Imines: 9-Iminofluorene and Benzophenone imine](#user-content-link106)
**Authors:** Huanyu Ren, D. Archie Stewart, Gabi Wenzel, Thomas H. Speak, Martin S. Holdren, Reace H. J. Willis, Brett A. McGuire

107. [Two-stage primary acceleration in filament initial eruption under a fan-spine magnetic configuration](#user-content-link107)
**Authors:** Haitang Li, Ke Yu, Chang Zhou, Qiang Liu, Xin Cheng, Jinhan Guo, Feiyang Sha, Ye Qiu, Yu Liu

108. [Back-End System of BURSTT](#user-content-link108)
...
109. [X-ray Analysis of Gamma-Ray Burst Flares and Underlying Afterglows: Insights into Origin of Flares](#user-content-link109)
**Authors:** H. Dereli-B\'egu\'e (Bar-Ilan University), A. Pe'er (Bar-Ilan University), D. B\'egu\'e (Bar-Ilan University), F. Ryde (KTH Royal Institute of Technology), A. Gowri (Indian Institute of Science Education and Research)

110. [Rebrightenings of gamma-ray burst afterglows from an increasing magnetic inclination angle of a nascent magnetar](#user-content-link110)
**Authors:** M. Xu, J. Li, C. F. Xiao, H. H. Qiu

111. [Photometric Analysis of TCP J20171288$+$1156589 -- WZ Sge Type Dwarf Nova with Delayed Ordinary Superhumps Emergence](#user-content-link111)
**Authors:** Alexander Tarasenkov, Sergey Shugarov, Natalia Ikonnikova, Marina Burlak, Sergey Nazarov, Sjoerd Dufoer

112. [Revisiting the atmosphere of HAT-P-70b with CARMENES high-resolution transmission spectroscopy](#user-content-link112)
**Authors:** Tianjun Gan, Jaume Orell-Miquel, Fei Yan, Lisa Nortmann, Jorge Sanz-Forcada, Enric Pall\'e, Shude Mao, Pedro J. Amado, Jos\'e A. Caballero, Stefan Cikota, David Cont, Artie P. Hatzes, Thomas Henning, Fabio Lesjak, Manuel L\'opez-Puertas, David Montes, Juan Carlos Morales, Alberto Pel\'aez-Torres, Andreas Quirrenbach, Ansgar Reiners, Ignasi Ribas, Andreas Schweitzer

113. [Small EUV Brightenings in the Quiet Solar Atmosphere: New Insights from the Solar Orbiter Mission](#user-content-link113)
**Authors:** Susanna Parenti

114. [Spatial and Dynamical Relations between Spicules and Network Bright Points](#user-content-link114)
**Authors:** Jeongwoo Lee, Eun-Kyung Lim, Viggo Hansteen

115. [Long-wavelength UV-LEDs and charge management in the detection of gravitational waves in space](#user-content-link115)
...
116. [Limits on Unintended Radio Emission from Geostationary and Geosynchronous Satellites in the SKA-Low Frequency Range](#user-content-link116)
**Authors:** S. J. Tingay, N. Hurley-Walker, K. Ross, T. J. Galvin, J. Morgan, B. Venville

117. [yieldplotlib: A unified library for exoplanet yield code visualizations](#user-content-link117)
**Authors:** Corey Spohn, Sarah Steiger, Alex R. Howe

118. [A few ideas to promote inclusion](#user-content-link118)
**Authors:** Thibaut Paumard, Aur\'elie Guilbert-Lepoutre, Ma\"ica Clavel, Florence Cornu, Ludovic Petitdemange, Fran\c{c}ois Dulieu, L\'ea Griton, Rhita-Maria Ouazzani

---

## 1. [A Galactic Transformation -- Understanding the SMC's Structural and Kinematic Disequilibrium](https://arxiv.org/abs/2512.06075) <a id="link1"></a>
...
**Comment:** This paper is highly relevant to near-field cosmology, focusing on the Small Magellanic Cloud (SMC), a dwarf satellite galaxy of the Milky Way. It uses simulations to explain the SMC's structural and kinematic disequilibrium, including the effects of a recent collision with the LMC, and discusses implications for dwarf galaxy transformation and dark matter/ISM physics. This is a direct match to the near-field cosmology and numerical galaxy simulations criteria.
...
## 2. [The quenched fraction of satellites around simulated Milky Way-mass galaxies](https://arxiv.org/abs/2512.06071) <a id="link2"></a>
...
**Comment:** Directly matches the 'Star Formation Quenching' criterion, focusing on the quenched fraction of satellite galaxies around Milky Way-mass hosts in both simulations and observations. Also relevant to 'Near-Field Cosmology' due to the focus on satellite galaxies and their properties. High relevance due to strong alignment with multiple core topics.
...
## 3. [The heartbeat of stellar halos: Insights from the stellar halo mass-metallicity relation](https://arxiv.org/abs/2512.07780) <a id="link3"></a>
...
**Comment:** Studies the mass-metallicity relation of stellar halos in simulated galaxies (CIELO), focusing on the assembly history and accretion of satellites. This is highly relevant to near-field cosmology, stellar halos, and the accretion history of galaxies, directly matching the criteria.
...
## 4. [Core-halo scaling relations in self-interacting scalar field dark matter](https://arxiv.org/abs/2512.07020) <a id="link4"></a>
...
**Comment:** This paper studies the core-halo scaling relations in self-interacting scalar field dark matter using 3D simulations, with implications for the structure of galactic cores and dark matter density profiles (core-cusp). This is directly relevant to near-field cosmology and the core-cusp problem.
...
## 5. [Globular clusters in \textsc{OrbIT}: complete dynamical characterisation of the globular cluster population of the Milky Way through updated orbital reconstruction](https://arxiv.org/abs/2512.06079) <a id="link5"></a>
...
**Comment:** This paper provides a complete dynamical characterization of the Milky Way's globular cluster population, including associations with accreted and in-situ structures and merger events. This closely matches the 'Near-Field Cosmology' criterion, as it directly addresses the assembly history of the Milky Way via globular clusters and accretion events.
...
## 6. [The shape-velocity alignment of satellites forged by tidal locking and dynamical friction](https://arxiv.org/abs/2512.07637) <a id="link6"></a>
...
**Comment:** This paper uses the TNG50 simulation to study the alignments of satellite galaxies/subhalos, directly relating to near-field cosmology and the structure of satellite systems. The analysis of satellite alignments and the use of high-resolution simulations are highly relevant.
...
## 7. [A Test of Substellar Evolutionary Models with High-Precision Ages from Asteroseismology and Gyrochronology for the Benchmark System HR 7672AB](https://arxiv.org/abs/2512.06083) <a id="link7"></a>
...
**Comment:** This paper tests substellar evolutionary models using a benchmark system with precise age and mass measurements. It directly addresses the 'Stellar Models' criterion by comparing brown dwarf cooling models and stellar evolutionary tracks with new observational constraints.
...
## 8. [Masked Autoencoder Pretraining on Strong-Lensing Images for Joint Dark-Matter Model Classification and Super-Resolution](https://arxiv.org/abs/2512.06642) <a id="link8"></a>
...
**Comment:** This paper uses strong gravitational lensing images to classify dark matter models and reconstruct high-resolution images. The focus on dark matter substructure in galaxies via lensing is relevant to near-field cosmology, particularly the study of substructure and the nature of dark matter. The use of machine learning for substructure detection is a novel approach.
...
## 9. [DESI Strong Lens Foundry V: A Sample of HST-Observed Strong Lenses Modeled with GIGA-Lens](https://arxiv.org/abs/2512.07823) <a id="link9"></a>
...
**Comment:** This paper discusses strong gravitational lensing and the detection of low-mass dark matter subhalos via lens modeling. While the focus is on lensing, the explicit mention of constraining the mass-density profile of galaxies and detecting low-mass dark matter subhalos is relevant to near-field cosmology, particularly the substructure and core-cusp problem. However, the galaxies studied are not specifically dwarfs or satellites, so the relevance is moderate.
...
## 10. [CLASSY XIV: The Nitrogen Exception -- Multi-Phase Enrichment and Feedback in High-$z$ Analogs](https://arxiv.org/abs/2512.06271) <a id="link10"></a>
...
**Comment:** This paper analyzes multi-phase chemical enrichment and feedback in local star-forming galaxies, with a focus on ISM outflows, phase-dependent mixing, and the regulation of chemical evolution. The discussion of ISM outflows, feedback, and their impact on chemical abundances is directly relevant to the 'Star Formation Driven Outflows' and 'Circumgalactic Medium' criteria, especially as it connects outflows to chemical evolution in galaxies. The sample includes analogs of high-z galaxies, which may include dwarfs, but the focus is not exclusively on dwarfs.
...
## 11. [Generating LSB-optimised synthetic images for simulated galaxies](https://arxiv.org/abs/2512.07320) <a id="link11"></a>
...
**Comment:** This paper presents a new emission-biasing scheme in the SKIRT radiative transfer code to generate synthetic images optimized for low-surface-brightness (LSB) science, tested on a Milky-Way-like galaxy from the TNG50 simulation. While the method is relevant for producing deep synthetic images of simulated galaxies, it does not directly address near-field cosmology, resolved star formation histories, or other core topics, but is tangentially relevant to numerical galaxy simulations.
...
## 12. [A pan-galaxy study of synthetic giant molecular filaments: a turbulence-dominated life cycle](https://arxiv.org/abs/2512.06241) <a id="link12"></a>
...
**Comment:** Analyzes giant molecular filaments in a high-resolution simulation of a Milky Way-like galaxy, focusing on their formation, dynamics, and star formation. While it uses galaxy simulations and discusses star formation, the focus is on molecular filaments and not on dwarf galaxies, resolved star formation histories, or outflows. It is borderline relevant for the 'Numerical Galaxy Simulations' criterion, but not a direct match.
...
## 13. [FEASTS Compared with Simulations: Abnormally Irregular and Extended HI Morphologies at a Column Density of $10^{18}\,\text{cm}^{-2}$ in TNG50 and Auriga](https://arxiv.org/abs/2512.07223) <a id="link13"></a>
...
**Comment:** Compares HI morphology in cosmological simulations (TNG50, Auriga) to observations, focusing on Milky Way-like galaxies and the effects of stellar feedback. This is relevant to numerical galaxy simulations and the impact of feedback, but the focus is on central galaxies rather than satellites or dwarfs. Still, the analysis of feedback and HI structure is somewhat relevant.
...
## 14. [Interplay between Escaping Cosmic Rays and Interstellar Medium: Driving of Galactic Winds and Shaping the Local Proton Spectrum](https://arxiv.org/abs/2512.07239) <a id="link14"></a>
...
**Comment:** This paper uses CR-hydrodynamical simulations to study the effects of escaping cosmic rays on the ISM and the driving of galactic winds. It discusses gas outflows driven by cosmic rays, which is relevant to the 'Star Formation Driven Outflows' and 'Circumgalactic Medium' criteria, though the focus is on cosmic ray-driven rather than star-formation-driven outflows. Still, the connection to galactic winds and the ISM/CGM is notable.
...
## 15. [The influence of external environment at cosmic noon on the subsequent evolution of galaxy stellar mass](https://arxiv.org/abs/2512.06792) <a id="link15"></a>
...
**Comment:** This paper uses the EAGLE and MAGNETICUM simulations to study how high-redshift environmental factors affect the stellar mass evolution of galaxies to z~0. It analyzes simulated galaxy evolution, which fits the 'Numerical Galaxy Simulations' criterion, though the focus is not specifically on dwarfs or new physics models. The work is more about environmental effects on galaxy growth.
...
## 16. [Revisiting the Evolutionary Status of Massive Stars at the central parsec of the Milky Way](https://arxiv.org/abs/2512.07432) <a id="link16"></a>
...
**Comment:** This paper revisits the evolutionary status of massive stars in the Galactic Center, presenting new stellar evolution models. It matches the 'Stellar Models' criterion, as it presents new evolutionary tracks and mass-loss prescriptions, though the focus is on massive stars in the Galactic Center, which is less relevant than models for general stellar populations.
...
## 17. [Chemical complexity in star formation induced by stellar feedback: cores shock-formed by the supernova remnant W44](https://arxiv.org/abs/2512.07562) <a id="link17"></a>
...
**Comment:** This paper studies the chemical complexity of a shock-impacted clump at the interface of a supernova remnant and a molecular cloud, with implications for star formation triggered by stellar feedback. It discusses the early stages of star formation and the chemical conditions, but does not focus on resolved star formation histories from color-magnitude diagrams, dwarf galaxies, or galaxy-scale outflows. Some tangential relevance to star formation driven outflows and feedback.
...
## 18. [A New Torus Generator for AGAMA](https://arxiv.org/abs/2512.06512) <a id="link18"></a>
...
**Comment:** This paper presents a new code for generating orbital tori in axisymmetric potentials, with applications to modeling tidal streams (e.g., GD1). While tidal streams are related to the accreted stellar halo and can be relevant for near-field cosmology, the focus here is on the code and its application to a specific stream, not on the broader properties of dwarf satellites or the halo. This is borderline relevant due to the connection to the accreted halo.
...
## 19. [Probing Cosmic Magnetism with Rotation Measure-Squared-Galaxy Cross-Correlations](https://arxiv.org/abs/2512.06584) <a id="link19"></a>
...
**Comment:** This paper proposes a new method for probing cosmic magnetic fields using cross-correlations between Faraday rotation measures and galaxy surveys. While it uses galaxy surveys, the focus is on cosmic magnetism and large-scale fields, not on the CGM of dwarf galaxies or other core topics.
...
## 20. [Phase-space perturbation theory for cosmic large-scale structure](https://arxiv.org/abs/2512.07396) <a id="link20"></a>
...
**Comment:** This paper develops a perturbative approach to the Vlasov-Poisson system for cosmic structure formation, which is a theoretical advance in large-scale structure modeling. While it is relevant to cosmological simulations, it does not focus on galaxy-scale simulations or near-field cosmology, and thus is only tangentially relevant.
...
## 22. [Solver-in-the-Loop Applications in Astrophysical (Magneto)hydrodynamics](https://arxiv.org/abs/2512.05999) <a id="link22"></a>
...
**Comment:** Presents new machine learning applications within astrophysical (magneto)hydrodynamics simulations. While it discusses simulation methodology, it does not focus on galaxy simulations or relevant physics (e.g., star formation, feedback) as per the criteria.
...
## 23. [On the Origin of Intracluster Light based on the High-resolution Simulation, NewCluster](https://arxiv.org/abs/2512.06098) <a id="link23"></a>
...
**Comment:** This paper uses high-resolution simulations to study the origin of intracluster light (ICL) in galaxy clusters, focusing on the contribution from satellite galaxies and their disruption. While it discusses satellite galaxies, the focus is on massive clusters, not the Milky Way or dwarf galaxies, and is thus outside the core near-field cosmology and dwarf galaxy focus. No direct connection to resolved star formation histories, quenching, or CGM of dwarfs.
...
## 24. [SHORES II: Multi-frequency Characterisation of the Sub-mJy Radio Population in FIR-selected Fields](https://arxiv.org/abs/2512.06089) <a id="link24"></a>
...
**Comment:** This paper presents a deep multi-frequency radio survey of extragalactic fields, focusing on the sub-mJy radio population and star-forming galaxies. While it discusses star formation in galaxies, it does not focus on resolved star formation histories, quenching, or dwarf galaxies, nor does it present new galaxy simulations.
...
## 25. [Statistics of the projected angles between the black-hole spin and the host-galaxy rotation axes from NewHorizon](https://arxiv.org/abs/2512.07129) <a id="link25"></a>
...
**Comment:** Uses the NewHorizon simulation to study the alignment between AGN jets and host galaxy rotation axes. While it uses a high-resolution galaxy simulation, the focus is on AGN/jet alignment in massive galaxies, not on dwarf galaxies, near-field cosmology, or the other core topics.
...
## 26. [Diverse stages of star formation in the IRAS 18162-2048 region. Emergence of UV Feedback](https://arxiv.org/abs/2512.07604) <a id="link26"></a>
...
**Comment:** The study investigates star formation stages and UV feedback in a specific star-forming region, using multi-wavelength observations. While it discusses star formation, it is focused on a massive star-forming region and not on resolved star formation histories of galaxies or dwarf galaxy quenching.
...
## 27. [The Milky Way Project: Bridging Intermediate- and High-Mass Star Formation with the MIRION Catalog of Yellowballs](https://arxiv.org/abs/2512.06213) <a id="link27"></a>
...
**Comment:** This paper presents the MIRION catalog of 'yellowballs', which are compact photodissociation regions associated with intermediate- and high-mass star formation. While it provides a large database for studying star-forming regions, it does not focus on dwarf galaxies, resolved star formation histories, or numerical galaxy simulations as defined in the core topics.
...
## 28. [From the Intergalactic to the Interstellar Scales -- EQUALS: a High-resolution Legacy Survey of Gas in the Distant Universe Using ESPRESSO](https://arxiv.org/abs/2512.06159) <a id="link28"></a>
...
**Comment:** Describes a high-resolution quasar absorption line survey (EQUALS) with ESPRESSO, focusing on the intergalactic medium, dark matter constraints, and chemical evolution at high redshift. While it is relevant to cosmology and galaxy formation, it does not address near-field cosmology, resolved star formation histories, or the CGM of dwarf galaxies.
...
## 29. [The THESAN project: Lyman-alpha intensity mapping of cosmic reionization](https://arxiv.org/abs/2512.06085) <a id="link29"></a>
...
**Comment:** This paper uses cosmological simulations to predict Lyman-alpha intensity mapping signals during reionization. While it involves simulations and outflows are mentioned in a toy model, the focus is on large-scale structure and the epoch of reionization, not on galaxy-scale outflows, dwarf galaxies, or resolved star formation histories.
...
## 30. [Genesis of Axion Dark Matter via Black Hole and Cosmic String Dynamics](https://arxiv.org/abs/2512.07268) <a id="link30"></a>
...
**Comment:** The paper explores axion dark matter production via cosmic string and black hole dynamics. While it touches on dark matter in galactic halos, it is primarily a cosmological/particle physics study and does not address near-field cosmology, satellite galaxies, or resolved star formation histories.
...
## 31. [Precise determination of circumstellar disk lifetimes: Disk evolution in a single star-forming region](https://arxiv.org/abs/2512.06873) <a id="link31"></a>
...
**Comment:** This paper determines circumstellar disk lifetimes in a single star-forming region, which is relevant to star and planet formation but does not address resolved star formation histories of galaxies, near-field cosmology, or numerical galaxy simulations.
...
## 32. [Actions of highly eccentric orbits](https://arxiv.org/abs/2512.06519) <a id="link32"></a>
...
**Comment:** Presents algorithms for computing actions of highly eccentric orbits in axisymmetric potentials. While this is relevant to galactic dynamics, it does not address the specific core topics (no focus on dwarf galaxies, star formation histories, or galaxy simulations).
...
## 33. [JWST reveals extended stellar disks for ALMA-bright dusty star-forming galaxies in the Spiderweb protocluster](https://arxiv.org/abs/2512.07050) <a id="link33"></a>
...
**Comment:** This paper studies dusty star-forming galaxies in a protocluster at z~2, focusing on their stellar disk sizes and structural evolution. While it discusses star formation and galaxy evolution, the focus is on massive galaxies in a protocluster environment, not on dwarf galaxies, resolved star formation histories, or near-field cosmology. No direct relevance to the core topics.
...
## 34. [The GLEAM 4-Jy (G4Jy) Sample: III. Further host-galaxy identification, and redshift assessment](https://arxiv.org/abs/2512.06947) <a id="link34"></a>
...
**Comment:** Presents host-galaxy identifications and redshift assessments for a radio galaxy sample. The focus is on massive radio galaxies, not dwarfs, satellites, or the other core topics.
...
## 35. [Simulation Study of Binary Mergers of Galaxy Clusters I: Properties of Merger Shocks and Radio Emission](https://arxiv.org/abs/2512.07214) <a id="link35"></a>
...
**Comment:** This paper presents 3D MHD simulations of galaxy cluster mergers, focusing on merger shocks and radio relics. While it involves numerical galaxy simulations, the focus is on massive galaxy clusters, not on galaxies or dwarfs, and does not address the core topics such as dwarf galaxies, star formation histories, or outflows. Only tangentially related to the core topics.
...
## 36. [What Galaxy Clusters Have to Say About Dynamical Dark Energy and $H_0$](https://arxiv.org/abs/2512.06701) <a id="link36"></a>

**ArXiv ID:** 2512.06701

**Authors:** Andr\'es N. Salcedo, Eduardo Rozo, Hao-Yi Wu, Shulei Cao, Enrique Paillas, Hanyu Zhang, Eli S. Rykoff

**Abstract:** We show that, in flat $\Lambda$CDM, low-redshift structure probes -- cluster abundances, 3$\times$2-point analyses, and full-shape clustering -- are mutually consistent, jointly delivering precise constraints on $\sigma_8$ and $\Omega_{\rm m}$ that agree with geometrical datasets (CMB+BAO+SN). In $w_0w_a$CDM, adding clusters to the geometry dataset reduces the evidence for evolving dark energy while relaxing the $H_0$ tension, suggesting a $\Lambda$CDM evolution of the late-time Universe and a sound horizon that differs from its standard value.

**Comment:** This paper uses galaxy cluster abundances and cosmological probes to constrain dark energy and H0. While it involves clusters and cosmology, it does not focus on near-field cosmology, dwarf galaxies, or the other core topics.
...
## 37. [The eROSITA Final Equatorial-Depth Survey (eFEDS): X-ray stacking analysis of Subaru's optically selected clusters spanning low richness regime](https://arxiv.org/abs/2512.06138) <a id="link37"></a>
...
**Comment:** Studies X-ray and optical scaling relations for galaxy clusters, extending into lower mass and luminosity regimes. However, the focus is on clusters, not dwarf galaxies or satellites, and does not address near-field cosmology or the other core topics.
...
## 38. [Black hole merger rates for LISA and LGWA from semi-analytical modelling of light seeds](https://arxiv.org/abs/2512.06094) <a id="link38"></a>
...
**Comment:** Focuses on black hole merger rates and seeding models using semi-analytic galaxy formation models. While it uses galaxy simulations, the primary focus is on black hole populations and gravitational wave detections, not on galaxy properties or processes relevant to the core criteria.
...
## 39. [An Ancient Brown Dwarf Transiting a Metal-Poor Thick Disk Star](https://arxiv.org/abs/2512.06069) <a id="link39"></a>
...
**Comment:** Reports the discovery of a transiting brown dwarf around a thick disk star. While it touches on Milky Way structure (thick disk), it does not address satellite galaxies, star formation histories, or any of the other core topics.
...
## 40. [Squeezed Limit non-Gaussianity Estimation with Cosmic Shear](https://arxiv.org/abs/2512.07295) <a id="link40"></a>
...
**Comment:** The paper presents a new method for constraining primordial non-Gaussianity using cosmic shear. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, or galaxy-scale processes.
...
## 41. [Vision Transformers for Cosmological Fields: Application to Weak Lensing Mass Maps](https://arxiv.org/abs/2512.07125) <a id="link41"></a>
...
**Comment:** This paper applies vision transformers to weak lensing mass maps to constrain cosmological parameters. While it is about cosmological inference, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 42. [Counting voids and filaments: Betti Curves as a Powerful Probe for Cosmology](https://arxiv.org/abs/2512.07236) <a id="link42"></a>
...
**Comment:** Applies topological statistics (Betti curves) to large-scale structure for cosmological parameter inference. This is not related to the core topics (no focus on galaxies, dwarfs, or star formation).
...
## 43. [Revealing Hidden Repeaters in the CHIME/FRB Catalog: Semi-Supervised Insights into the Fast Radio Burst Population](https://arxiv.org/abs/2512.06316) <a id="link43"></a>
...
**Comment:** Uses machine learning to identify repeating fast radio bursts (FRBs) in the CHIME/FRB catalog. While interesting, this is not related to near-field cosmology, resolved star formation histories, or the other specified criteria.
...
## 44. [Probing memory-burdened Primordial Black Holes with global 21 cm signal](https://arxiv.org/abs/2512.06941) <a id="link44"></a>
...
**Comment:** This paper investigates primordial black holes and their effect on the 21 cm signal, focusing on dark matter constraints. While it touches on cosmology, it does not address near-field cosmology, galaxy formation, or any of the core topics.
...
## 45. [Modelling dust coagulation, dynamical drag and turbulent mixing during star and disc formation](https://arxiv.org/abs/2512.06409) <a id="link45"></a>
...
**Comment:** The paper presents a new SPH code for simulating dust coagulation, drag, and turbulent mixing during star and disc formation. While it involves numerical simulations, the focus is on protoplanetary discs and star formation, not on galaxies or the core topics listed.
...
## 46. [A XRISM/Resolve view of the dynamics in the hot gaseous atmosphere of M87](https://arxiv.org/abs/2512.06596) <a id="link46"></a>
...
**Comment:** Studies the hot gaseous atmosphere and AGN feedback in M87, a massive elliptical galaxy. The focus is on cluster-scale gas dynamics and AGN-driven turbulence, which does not match any of the core criteria (e.g., not on dwarf galaxies, star formation quenching, or near-field cosmology).
...
## 47. [A Fully Photometric Approach to Type Ia Supernova Cosmology in the LSST Era: Host Galaxy Redshifts and Supernova Classification](https://arxiv.org/abs/2512.06319) <a id="link47"></a>
...
**Comment:** This paper focuses on photometric classification and redshift estimation for Type Ia supernovae in the LSST era, with the goal of improving cosmological constraints. While it is relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specific core topics. No direct match to the listed criteria.
...
## 48. [Interstellar Medium in Extremely High Star-Formation Regions: A Prospect of Observations on the Millimetron](https://arxiv.org/abs/2512.07565) <a id="link48"></a>
...
**Comment:** The paper discusses the interstellar medium in ultra-luminous infrared galaxies (ULIRGs) with extremely high star formation rates, focusing on the effects of intense star formation and AGN activity. While it touches on star formation and outflows, the focus is on very massive galaxies, not dwarfs, and the outflows are not specifically star-formation-driven. No direct match to the core topics.
...
## 50. [An Extended WZDR Model with Interacting Scalar Field Dark Matter and Stepped Dark Radiation](https://arxiv.org/abs/2512.06719) <a id="link50"></a>
...
**Comment:** Presents a cosmological model with interacting scalar field dark matter and stepped dark radiation, aiming to address the Hubble and S8 tensions. This is cosmology-focused and does not address any of the core topics.
...
## 51. [EP241217a: a likely Type II GRB with an achromatic bump at z = 4.59](https://arxiv.org/abs/2512.07233) <a id="link51"></a>
...
**Comment:** Studies a high-redshift X-ray transient, likely a Type II GRB, and models its afterglow. While it discusses star formation and the interstellar medium in the context of GRBs, it does not address the core topics (no focus on dwarf galaxies, resolved star formation histories, or galaxy simulations).
...
## 52. [Extreme mass ratio inspirals in the cold vector dark matter environment](https://arxiv.org/abs/2512.06807) <a id="link52"></a>
...
**Comment:** This paper studies the effect of vector dark matter on gravitational wave signals from extreme mass ratio inspirals. It discusses dark matter density profiles near black holes, but not in the context of galaxies or the core-cusp problem. No direct relevance to the core topics.
...
## 53. [Generalized tension metrics for multiple cosmological datasets](https://arxiv.org/abs/2512.06086) <a id="link53"></a>
...
**Comment:** Presents a new statistical estimator for quantifying tension between cosmological datasets. This is a methodological cosmology paper, not related to the core topics.
...
## 54. [Microquasar remnants as hidden PeVatrons](https://arxiv.org/abs/2512.07781) <a id="link54"></a>
...
**Comment:** This paper proposes that microquasar remnants could explain some unidentified PeVatron sources in the Galaxy. The focus is on cosmic ray acceleration and gamma-ray emission from microquasar remnants, not on galaxies, dwarfs, or the other core topics. No direct relevance.
...
## 55. [Diagnosing Interstellar Magnetic Turbulence with TeV Pulsar Halos](https://arxiv.org/abs/2512.07290) <a id="link55"></a>
...
**Comment:** The paper discusses using TeV pulsar halos to probe interstellar magnetic turbulence. This is not related to any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 56. [Giant outbursts of clumpy material preceding Type II supernova 2024qiw](https://arxiv.org/abs/2512.07049) <a id="link56"></a>
...
**Comment:** This paper studies pre-supernova mass loss in massive stars leading to Type II supernovae. It focuses on stellar evolution and mass loss in massive stars, not on dwarf galaxies, galaxy simulations, or the other core topics.
...
## 57. [Multi-Wavelength Afterglows as Diagnostic Probes of Dense Circumburst Medium in GRBs](https://arxiv.org/abs/2512.07719) <a id="link57"></a>
...
**Comment:** This paper investigates GRB afterglows in dense circumburst media, including AGN disks. While it discusses outflows (GRB jets), these are not star-formation-driven galaxy-scale outflows, nor is there a focus on dwarf galaxies or the other core topics.
...
## 58. [Surface temperature of an accretion disk around a wormhole Kerr-mimicker](https://arxiv.org/abs/2512.07466) <a id="link58"></a>
...
**Comment:** Focuses on accretion disks around wormhole Kerr-mimickers, comparing them to black holes. This is not related to near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specified criteria.
...
## 59. [Non-thermal Synchrotron Emission and Polarization Signatures during Black Hole Flux Eruptions](https://arxiv.org/abs/2512.06803) <a id="link59"></a>
...
**Comment:** Investigates synchrotron emission and polarization in black hole accretion disks using GRMHD simulations. The focus is on black hole variability, not on galaxy-scale processes, dwarf galaxies, or the other relevant topics.
...
## 61. [Understanding the Planetary Formation and Evolution in Star Clusters(UPiC)-II: Catalog of planets/candidates in Open Clusters and Moving Groups](https://arxiv.org/abs/2512.07029) <a id="link61"></a>
...
**Comment:** This paper focuses on exoplanets in open clusters and moving groups, which does not match any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on planetary systems, not galaxies or stellar models.
...
## 63. [Shock trapping and inertial escape: Dust-particle clustering in compressible turbulence](https://arxiv.org/abs/2512.07164) <a id="link63"></a>
...
**Comment:** This paper studies dust-particle clustering in compressible turbulence, with relevance to dust concentration in protoplanetary discs. While it involves numerical simulations and astrophysical environments, it does not focus on galaxies, star formation histories, or near-field cosmology. No core criteria are closely matched.
...
## 64. [A Song of Lines and Winds: Tracing the Signatures of AGN Outflows in X-rays](https://arxiv.org/abs/2512.06077) <a id="link64"></a>
...
**Comment:** The paper analyzes AGN outflows in X-rays, focusing on ultra-fast outflows and their properties. The outflows are AGN-driven, not star-formation-driven, and the work does not address the CGM, dwarf galaxies, or other core topics.
...
## 65. [Do Low-Mass, Low-Luminosity AGNs Deviate from the Quasar Main Sequence?](https://arxiv.org/abs/2512.06068) <a id="link65"></a>
...
**Comment:** This paper characterizes low-mass, low-luminosity AGNs and their deviation from the quasar main sequence. The focus is on AGN properties and accretion states, not on near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 67. [The impact of surface acetylene cyclotrimerization on the abundance of aromatic hydrocarbons in carbon-rich asymptotic giant branch stars](https://arxiv.org/abs/2512.06510) <a id="link67"></a>
...
**Comment:** This paper focuses on astrochemical modeling of aromatic hydrocarbon formation in the circumstellar envelopes of carbon-rich AGB stars. While it involves stellar evolution and dust chemistry, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 68. [Water vapor emission at the warm cavity wall of the HD 100546 disk as revealed by ALMA](https://arxiv.org/abs/2512.06439) <a id="link68"></a>
...
**Comment:** ALMA observations of water vapor in a protoplanetary disk. This is about planet formation and disk chemistry, not galaxies or the core topics.
...
**Comment:** Searches for high-energy neutrino emission from supermassive black hole binaries. This is not related to any of the specified criteria such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 71. [Widen the Resonance at Ultra-High Energies: Novel Probes of Neutrino Self-interactions in the High-Mass Regime](https://arxiv.org/abs/2512.00165) <a id="link71"></a>
...
**Comment:** This paper discusses neutrino self-interactions and their cosmological implications, but does not address galaxy formation, star formation histories, or any of the core topics.
...
## 72. [A Fast, Parallelized, GPU-Accelerated Photochemical Model, XODIAC, with Built-in Equilibrium Chemistry and Multiple Chemical Networks for Exoplanetary Atmospheres](https://arxiv.org/abs/2512.06729) <a id="link72"></a>
...
**Comment:** This paper presents a new GPU-accelerated photochemical model for exoplanetary atmospheres. It does not address stellar models, galaxy simulations, or any of the core topics.
...
## 73. [Effects of helium sedimentation on late star formation in galaxy clusters](https://arxiv.org/abs/2512.06223) <a id="link73"></a>
...
**Comment:** The paper studies the effects of helium sedimentation on star formation in the central galaxies of galaxy clusters, focusing on high-mass systems (halo mass > 10^14 Msun). This is outside the scope of dwarf galaxies or near-field cosmology, and does not address resolved star formation histories or numerical galaxy simulations relevant to the prompt.
...
## 74. [Testing the Distance Duality Relation with Cosmological Observations at high Redshift using Artificial Neural Network](https://arxiv.org/abs/2512.06454) <a id="link74"></a>
...
**Comment:** This paper tests the Distance Duality Relation using cosmological probes (SNe Ia, GRBs, BAO, SGL) at high redshift. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specific criteria.
...
## 76. [Dynamical Dark Energy and the Unresolved Hubble Tension: Multi-model Constraints from DESI 2025 and Other Probes](https://arxiv.org/abs/2512.07281) <a id="link76"></a>

**ArXiv ID:** 2512.07281

**Authors:** Zhuoming Zhang, Tengpeng Xu, Yun Chen

**Abstract:** We present a Bayesian comparative analysis of five cosmological models: $\Lambda$CDM, $w$CDM, $w_0w_a$CDM, $\phi$CDM (with scalar-field dark energy), and an interacting dark energy scenario (the $\xi$ model), to investigate dark energy evolution and the Hubble tension. Utilizing the latest data from the Dark Energy Spectroscopic Instrument (DESI) DR2 (Baryon Acoustic Oscillations, BAO), Pantheon+ (Type Ia Supernovae, SNIa), and Cosmic Microwave Background (CMB) data (including lensing) from \textit{Planck} and the Atacama Cosmology Telescope (ACT), we report three key findings. First, the Hubble constant ($H_0$) inferred from the combined data consistently aligns with early-universe measurements across all models, indicating a persistent Hubble tension. Second, we find compelling evidence for dynamical dark energy: early-universe (CMB) constraints favor a phantom phase (with an equation-of-state parameter $w  -1$). Third, the full dataset suggests a late-time interaction between dark energy and matter. Our results demonstrate that dark energy evolves with cosmic time, challenging the cosmological constant paradigm.

**Comment:** This paper analyzes cosmological models and the Hubble tension using large-scale structure and CMB data. While it discusses dark energy and cosmology, it does not address near-field cosmology, dwarf galaxies, or any of the other core topics.
...
## 77. [BSN: Light Curve Modeling and Orbital Evolution of the Total-Eclipse Contact Binary EZ Oct](https://arxiv.org/abs/2512.07372) <a id="link77"></a>
...
**Comment:** Presents a photometric and orbital analysis of a contact binary star system. This is stellar astrophysics but not related to new stellar models, resolved star formation histories, or the other core topics.
...
## 78. [Relationship between Poincar\'e Sections and Spectral Characteristics of Orbits of Globular Clusters in the Central Region of the Galaxy](https://arxiv.org/abs/2512.07502) <a id="link78"></a>

**ArXiv ID:** 2512.07502

**Authors:** Anisa Bajkova, Anton Smirnov, Vadim Bobylev

**Abstract:** In the paper, orbital dynamics, regular or chaotic, of globular clusters (GCs) in the central region of the Galaxy, which is subject to the greatest influence of the rotating bar, has been studied. Such methods for determining chaos as Poincar\'e sections and spectral methods have been compared. The relationship between the Poincar\'e sections and the spectral characteristics of the orbits has been estimated. The sample includes 45 globular clusters in the central region of the Galaxy with a radius of 3.5 kpc. To form the 6D-phase space required for integrating the orbits, the most accurate astrometric data to date from the Gaia satellite, as well as new refined average distances, have been used. The following, most realistic, bar parameters have been adopted: mass $10^{10} M_\odot$, length of the major semi-axis of the bar model in the form of a triaxial ellipsoid is 5 kpc, angle of rotation of the bar axis is $25^o$, rotation velocity is 40 km s$^{-1}$ kpc $^{-1}$. The result of the study is that a 100\% correlation between the classification by Poincar\'e sections and the spectral characteristics of the orbits has been established. Consequently, the classification by Poincar\'e sections can be replaced by a more visual analysis of the amplitude spectra of the orbits. Thus, two lists of GCs: with regular and chaotic dynamics have been compiled. The GCs with varying degrees of orbital chaos have separately been distinguish.

**Comment:** The paper studies the orbital dynamics of globular clusters in the central region of the Galaxy, focusing on chaos due to the Galactic bar. The focus on the central region and bar makes it irrelevant to near-field cosmology or satellite galaxy studies.
...
## 79. [Anisotropic Diffusion Modeling of Cosmic-Ray Lepton Propagation](https://arxiv.org/abs/2512.06972) <a id="link79"></a>
...
**Comment:** This paper models cosmic-ray lepton propagation using anisotropic diffusion, focusing on cosmic-ray data and Galactic magnetic fields. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 80. [ExoNAMD: Leveraging the spin-orbit angle to constrain the dynamics of multiplanetary systems](https://arxiv.org/abs/2512.06126) <a id="link80"></a>
...
**Comment:** Focuses on exoplanetary system dynamics and the spin-orbit angle in multiplanetary systems. This is not related to any of the core topics (no connection to near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 81. [FIP-TOI: Fast Imaging Pipeline for Pulsar Localisation with a Transient-Oriented Radio Astronomical Imager](https://arxiv.org/abs/2512.06254) <a id="link81"></a>
...
**Comment:** Describes a fast imaging pipeline for pulsar localization in radio astronomy. This is a technical/methodological paper for pulsar studies, not related to the core topics.
...
## 82. [Revisiting PBH Accretion, Evaporation and Their Cosmological Consequences](https://arxiv.org/abs/2512.07291) <a id="link82"></a>
...
**Comment:** This paper is about primordial black holes, their accretion and evaporation, and cosmological consequences. It does not address galaxies, star formation histories, or any of the core topics.
...
## 83. [Dynamical Dark Energy in light of DESI BAO and Full-Shape Data](https://arxiv.org/abs/2512.07104) <a id="link83"></a>

**ArXiv ID:** 2512.07104

**Authors:** Quan Zhou, Sibo Zheng

**Abstract:** Recently, the DESI BAO data has reported a preference of dynamical dark energy (DDE) over the $\Lambda$CDM.Apart from the BAO data, the DDE model should be also sensitive to low-redshift measurements of matter power spectrum.In this study, we address this point by combining the DESI Y1 data about the matter power spectrum, extracted from the DESI Full-Shape data, with the DESI DR2 BAO data among others.After building the DESI Y1 likelihood,we carry out a Markov Chain Monte Carlo analysis, showing that the constraints on $w_0$ and $w_{a}$ with DESI Y1 data included are improved over those without it for three different datasets widely considered,especially in the case of DESY5 sample.

**Comment:** This paper analyzes dynamical dark energy models using DESI BAO and full-shape data. It is focused on cosmological parameter estimation and not on any of the core topics.
...
## 84. [Inference of $B$-mode polarization in the presence of non-Gaussian foregrounds](https://arxiv.org/abs/2512.07235) <a id="link84"></a>
...
**Comment:** Focuses on CMB B-mode polarization and foregrounds, not on galaxies, star formation, or the other core topics.
...
## 85. [Prospects for independent measurement of $\boldsymbol{\ell}$=1,2,3 CMB anisotropy multipoles using the anisotropic Sunyaev-Zel'dovich effect](https://arxiv.org/abs/2512.07441) <a id="link85"></a>
...
**Comment:** Discusses the anisotropic Sunyaev-Zel'dovich effect for measuring CMB multipoles. This is not related to galaxy evolution or the core topics.
...
## 87. [Constraining meV Axion Dark Matter with ALMA Observations of the Galactic Center Magnetar SGR 1745-2900](https://arxiv.org/abs/2512.06441) <a id="link87"></a>
...
**Comment:** This paper reports ALMA observations of a magnetar in the Galactic Center to constrain axion dark matter. The focus is on particle physics and the Galactic Center, which is explicitly listed as irrelevant in the criteria.
...
## 88. [SS433 PeV neutron jet feeding the far TeV gamma beam](https://arxiv.org/abs/2512.07012) <a id="link88"></a>
...
**Comment:** This paper discusses the SS433 system and proposes a model for TeV gamma-ray emission via PeV neutron jets. The focus is on high-energy astrophysics and binary systems, not on galaxies, dwarfs, or the other core topics.
...
## 89. [Observability of eccentricity in a population of merging compact binaries](https://arxiv.org/abs/2512.07688) <a id="link89"></a>
...
**Comment:** This paper investigates the observability of eccentricity in merging compact binaries using simulations and gravitational wave data. The focus is on compact object mergers, not on galaxies, dwarfs, or the other core topics.
...
## 90. [Fast X-ray Variability from the Coronae of Supermassive Black Holes](https://arxiv.org/abs/2512.06622) <a id="link90"></a>
...
**Comment:** The paper studies X-ray variability in AGN coronae, focusing on supermassive black holes. This is not related to the core topics, which exclude AGN and focus on galaxies, especially dwarfs, and their evolution.
...
## 91. [Universal relation involving fundamental modes in two-fluid dark matter admixed neutron stars](https://arxiv.org/abs/2512.07105) <a id="link91"></a>
...
**Comment:** Studies oscillation frequencies in dark matter admixed neutron stars. This is not related to galaxies, star formation histories, or the other specified criteria.
...
## 92. [Investigating all-sky Frequency Hough performances for neutron stars](https://arxiv.org/abs/2512.06055) <a id="link92"></a>
...
**Comment:** Investigates all-sky Frequency Hough performance for neutron star gravitational wave searches. This is not related to galaxies, star formation, or the other specified criteria.
...
## 93. [Evidence of young magnetars in massive binary embedded in a supernova remnant as sources of active fast radio bursts](https://arxiv.org/abs/2512.07140) <a id="link93"></a>
...
**Comment:** The paper discusses fast radio bursts and young magnetars in supernova remnants, which does not match any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 94. [Revealing the accelerating wind in the inner region of the colliding-wind binary WR 112](https://arxiv.org/abs/2512.06066) <a id="link94"></a>
...
**Comment:** Examines colliding winds in a massive binary system (WR 112), focusing on wind dynamics, X-ray, and radio emission. This is not related to galaxy-scale processes, star formation histories, or any of the core criteria.
...
## 95. [Trends in gravitational wave emission in axisymmetric simulations of rotating core-collapse supernovae](https://arxiv.org/abs/2512.07066) <a id="link95"></a>
...
**Comment:** This paper presents simulations of gravitational wave emission from core-collapse supernovae in massive stars. It does not address galaxy evolution, dwarf galaxies, star formation histories, or any of the other core topics. No direct match to the listed criteria.
...
## 96. [Deciphering transmission spectra by exploring the solar paradigm](https://arxiv.org/abs/2512.06487) <a id="link96"></a>
...
**Comment:** This paper discusses the impact of stellar magnetic activity on exoplanet transmission spectra, using the Sun as a benchmark. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 97. [The phases of QCD reached in terrestrial and cosmic colliders](https://arxiv.org/abs/2511.21108) <a id="link97"></a>
...
**Comment:** This is a review of the QCD phase diagram and its relevance to neutron stars and high-energy physics. It is not relevant to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 98. [Quenching factors for Na recoils as a function of Tl dopant concentrations in NaI(Tl) crystals](https://arxiv.org/abs/2512.05980) <a id="link98"></a>
...
**Comment:** This is a laboratory study of NaI(Tl) crystals for dark matter direct detection. It does not address any of the core topics (no connection to galaxies, star formation, or near-field cosmology).
...
## 99. [Optical Study of TRAPUM Pulsars and Modelling of the Redbacks: PSR J1036$-$4353 and PSR J1803$-$6707](https://arxiv.org/abs/2512.06503) <a id="link99"></a>
...
**Comment:** Focuses on optical studies and modeling of redback millisecond pulsar binaries. This is not related to any of the core topics (no connection to galaxies, star formation histories, or galaxy simulations).
...
## 100. [Paucity of downward UHE neutrino tracks in IceCube versus unexpected huge KM3-230213A event: solving the puzzles?](https://arxiv.org/abs/2512.07042) <a id="link100"></a>
...
**Comment:** Discusses ultra-high-energy neutrino events and their interpretation. This is not related to any of the core topics.
...
## 101. [ZTF-SEDm Type Ia supernova sample for Twins Embedding spectrophotometric standardisation](https://arxiv.org/abs/2512.07696) <a id="link101"></a>
...
**Comment:** This paper presents a large sample of Type Ia supernova spectra and discusses spectrophotometric standardization. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 102. [NEO and imminent impactor discoveries from Hungary: recent results and lessons learnt](https://arxiv.org/abs/2512.06594) <a id="link102"></a>
...
**Comment:** Describes NEO and imminent impactor discoveries and survey methodology. This is about Solar System objects, not galaxies or the core topics.
...
## 103. [Unified models revisited I: modelling the effect of source geometry on radio galaxy/quasar unification](https://arxiv.org/abs/2512.06469) <a id="link103"></a>
...
**Comment:** This paper revisits unified models of radio galaxies and quasars, focusing on the effects of source geometry and projection. The topic is not related to any of the core criteria such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 104. [Evaporation of Primordial Black Holes in a Thermal Universe: A Thermofield Dynamics Approach](https://arxiv.org/abs/2512.07284) <a id="link104"></a>
...
**Comment:** This paper studies the evaporation of primordial black holes in a thermal universe using thermofield dynamics. The focus is on black hole physics and early universe cosmology, not on galaxies, dwarfs, or the other core topics.
...
## 105. [Over-abundant gamma-like signals around Solar disk shadows by twin bent and smeared muon and electron pairs secondaries, versus rare local TeV gamma](https://arxiv.org/abs/2512.06975) <a id="link105"></a>
...
**Comment:** This paper discusses cosmic ray interactions near the Sun and resulting gamma-like signals. It is unrelated to the core topics of near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 106. [Rotational Spectra and Search for Aromatic Imines: 9-Iminofluorene and Benzophenone imine](https://arxiv.org/abs/2512.06579) <a id="link106"></a>
...
**Comment:** The paper presents laboratory and observational searches for aromatic imines in the interstellar medium, focusing on molecular spectroscopy and astrochemistry. It does not address any of the core topics.
...
## 107. [Two-stage primary acceleration in filament initial eruption under a fan-spine magnetic configuration](https://arxiv.org/abs/2512.07566) <a id="link107"></a>
...
**Comment:** Studies the eruption of a solar filament and its acceleration stages. This is solar physics and not related to galaxies, star formation, or the other specified criteria.
...
## 108. [Back-End System of BURSTT](https://arxiv.org/abs/2512.07300) <a id="link108"></a>
...
**Comment:** This paper describes the technical backend of a radio telescope for FRB detection. It does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 109. [X-ray Analysis of Gamma-Ray Burst Flares and Underlying Afterglows: Insights into Origin of Flares](https://arxiv.org/abs/2512.07731) <a id="link109"></a>
...
**Comment:** This paper analyzes X-ray flares in gamma-ray burst afterglows, which is not related to galaxy formation, star formation histories, or any of the core topics.
...
## 110. [Rebrightenings of gamma-ray burst afterglows from an increasing magnetic inclination angle of a nascent magnetar](https://arxiv.org/abs/2512.06394) <a id="link110"></a>
...
**Comment:** The paper discusses the effect of a nascent magnetar's magnetic inclination angle on GRB afterglows. This is not related to galaxy formation, star formation histories, or any of the core topics.
...
## 111. [Photometric Analysis of TCP J20171288$+$1156589 -- WZ Sge Type Dwarf Nova with Delayed Ordinary Superhumps Emergence](https://arxiv.org/abs/2512.06372) <a id="link111"></a>
...
**Comment:** This is a photometric analysis of a WZ Sge type dwarf nova, focusing on binary system parameters and outburst behavior. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 112. [Revisiting the atmosphere of HAT-P-70b with CARMENES high-resolution transmission spectroscopy](https://arxiv.org/abs/2512.06731) <a id="link112"></a>
...
**Comment:** This paper focuses on exoplanet atmosphere characterization via transmission spectroscopy of an ultra-hot Jupiter. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations.
...
## 113. [Small EUV Brightenings in the Quiet Solar Atmosphere: New Insights from the Solar Orbiter Mission](https://arxiv.org/abs/2512.07286) <a id="link113"></a>
...
**Comment:** This is a review of small-scale EUV brightenings in the solar atmosphere, based on Solar Orbiter data. It is unrelated to the core topics of near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 114. [Spatial and Dynamical Relations between Spicules and Network Bright Points](https://arxiv.org/abs/2512.07681) <a id="link114"></a>
...
**Comment:** This paper investigates the spatial and dynamical relations between spicules and network bright points in the solar chromosphere. It is not relevant to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 115. [Long-wavelength UV-LEDs and charge management in the detection of gravitational waves in space](https://arxiv.org/abs/2512.07546) <a id="link115"></a>
...
**Comment:** This paper discusses charge management systems for gravitational wave detectors in space. It is not relevant to the core topics.
...
## 116. [Limits on Unintended Radio Emission from Geostationary and Geosynchronous Satellites in the SKA-Low Frequency Range](https://arxiv.org/abs/2512.07341) <a id="link116"></a>
...
**Comment:** This paper searches for unintended radio emissions from geostationary satellites in the SKA-Low frequency range. It is not relevant to the core topics.
...
## 117. [yieldplotlib: A unified library for exoplanet yield code visualizations](https://arxiv.org/abs/2512.06149) <a id="link117"></a>
...
**Comment:** This paper presents a visualization library for exoplanet yield codes. The topic is exoplanet detection and mission planning, not related to any of the core topics.
...
## 118. [A few ideas to promote inclusion](https://arxiv.org/abs/2512.06011) <a id="link118"></a>
...
**Comment:** This is a paper on diversity, equity, inclusion, and accessibility in French research institutions. It is not relevant to the core scientific topics.
