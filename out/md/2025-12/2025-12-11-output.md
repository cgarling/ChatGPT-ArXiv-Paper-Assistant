...
1. [Search for Dark Matter Annihilation and Decay with H$\alpha$ Line Emission](#user-content-link1)
**Authors:** Rebecca K. Leane

2. [TiNy Titans HI: Discovering Satellites via HI Gas in an Isolated, Compact Group of Dwarf Galaxies](#user-content-link2)
**Authors:** Sabrina Stierwalt, Nicholas Luber, Zelie Goldberg Little, George C. Privon, Gurtina Besla, Kelsey E. Johnson, Nitya Kallivayalil, David R. Patton, Mary Putman, David Simpson Heil

3. [CWTHF: Subhalo Identification with Continuous Wavelet Transform](#user-content-link3)
**Authors:** Minxing Li, Yun Wang, Ping He

4. [Interpretable machine learning of halo gas density profiles: a sensitivity analysis of cosmological hydrodynamical simulations](#user-content-link4)
**Authors:** Daniele Sorini, Sownak Bose, Mathilda Denison, Romeel Dav\'e

5. [GA-NIFS: Understanding the ionization nature of EGSY8p7/CEERS-1019. Evidence for a star formation-driven outflow at z = 8.6](#user-content-link5)
**Authors:** Sandra Zamora, Stefano Carniani, Elena Bertola, Eleonora Parlanti, Pablo G. P\'erez-Gonz\'alez, Santiago Arribas, Torsten B\"oker, Andrew J. Bunker, Francesco D'Eugenio, Roberto Maiolino, Michele Perna, Bruno Rodr\'iguez Del Pino, Hannah \"Ubler, Giovanni Cresci, Gareth C. Jones, Isabella Lamperti, Jan Scholtz, Bartolomeo Trefoloni, Giacomo Venturi

6. [The Early Maturity of High-Redshift Galaxies: Insights from sSFR, M/L and SFHs at z~7-14](#user-content-link6)
**Authors:** P. Santini, M. Castellano, A. Calabr\`o, A. Fontana, E. Merlin, D. Bevacqua, P. Bergamini, S. Cantarella, L. Ciesla, A. Ferrara, S. L. Finkelstein, F. Fortuni, G. Gandolfi, T. Gasparetto, E. Giallongo, N. A. Grogin, S. T. Guida, A. M. Koekemoer, N. Menci, L. Napolitano, D. Paris, L. Pentericci, B. Perez-Diaz, B. Stoyanova, T. Treu

7. [Kinematics of Distant Milky Way Halo RR Lyrae Stars out to 160 kpc](#user-content-link7)
**Authors:** Yuting Feng, Puragra Guhathakurta, Eric W. Peng, Emily C. Cunningham, Patrick C\^ot\'e, Laura Ferrarese, Stephen D. J. Gwyn

8. [Self-consistent secondary cosmic microwave background anisotropies and extragalactic foregrounds in the FLAMINGO simulations](#user-content-link8)
**Authors:** Tianyi Yang, Ian G. McCarthy, Fiona McCarthy, Boris Bolliet, Jens Chluba, William Coulton, John C. Helly, Matthieu Schaller, Joop Schaye

9. [Enhanced rates of stellar radial migration in gas-rich discs at high redshift](#user-content-link9)
**Authors:** HanYuan Zhang, Thor Tepper-Garc\'ia, Vasily Belokurov, N. Wyn Evans, Takafumi Tsukui, Hillary Davis, Joss Bland-Hawthorn, Jason L. Sanders, Oscar Agertz

10. [The Limits of Line Broadening: Modeling Stellar Spectra and Formation Temperatures at High Resolution](#user-content-link10)
**Authors:** Michael L. Palumbo III

11. [A High-resolution Study of the Cold Neutral Medium in and around 30 Doradus](#user-content-link11)
**Authors:** Gyueun Park, Min-Young Lee, John M. Dickey, Nick M. Pingel, James Dempsey, Helga D\'enes, Steven Gibson, Katie Jameson, Ian Kemp, Chang-Goo Kim, Denis Leahy, Bumhyun Lee, Callum Lynn, Yik Ki Ma, Antoine Marchal, Naomi M. McClure-Griffiths, Eric Muller, Hiep Nguyen, Sne\v{z}ana Stanimirovi\'c, Jacco Th. Van Loon

12. [Clumpy, dense gas in the outflow of NGC 1266](#user-content-link12)
...
13. [Distance to the Globular Cluster M 3 from the Infrared Surface Brightness Technique applied to RR Lyrae stars](#user-content-link13)
**Authors:** Bart{\l}omiej Zgirski, Wolfgang Gieren, Grzegorz Pietrzy\'nski, Gergely Hajdu, Piotr Wielg\'orski, Marek G\'orski, Jesper Storm, Nicolas Nardetto, Alexandre Gallenne, Garance Bras, Pierre Kervella, Paulina Karczmarek, Weronika Narloch

14. [Can Clump Properties Predict Core Distribution in Star Formation? A Statistical Analysis of MHD Simulations](#user-content-link14)
**Authors:** Wei-An Chen, Seamus D. Clarke, Ya-Wen Tang

15. [The stellar and dark matter distributions in elliptical galaxies measured by stacked weak gravitational lensing](#user-content-link15)
**Authors:** Momoka Fujikawa, Masamune Oguri

16. [On the connection between galaxy orientation and halo absorption properties](#user-content-link16)
**Authors:** Rohan Venkat (The University of Chicago), Soo May Wee (The University of Chicago), Hsiao-Wen Chen (The University of Chicago)

17. [Core-wing transitions and the breakdown of diffusion in Lyman-$\alpha$ radiative transfer](#user-content-link17)
**Authors:** Kevin Lorinc (UT Dallas), Aaron Smith (UT Dallas), Olof Nebrin (Stockholm), Joshua Kasiri (UT Dallas)

18. [Probing the origin of the kilonova candidate GRB 230307A: analysis of host galaxy and offset](#user-content-link18)
**Authors:** Clecio R. Bom, Davi C. Rodrigues, Arianna Cortesi, Amanda E. Araujo-Carvalho, Daniel Ruschel-Dutra, Giuliano Iorio, Luidhy Santana-Silva, Charles D. Kilpatrick, Fabricio Ferrari, Luis Lomeli-Nu\~nez, Thomas Harvey, Duncan Austin, Christopher J. Conselice, Nathan Adams, Roberto Cid Fernandes

19. [CASCADE: Filamentary accretion flows in Cygnus X DR20](#user-content-link19)
...
20. [Unsupervised Kinematic Dissection of the Solar Neighborhood: Identifying Stellar Moving Groups with Gaia DR3](#user-content-link20)
**Authors:** Aanmay Raj

21. [Optimizing Photometric Redshift Training Sets I: Efficient Compression of the Galaxy Color-Redshift Relation with UMAP](#user-content-link21)
**Authors:** Finian Ashmead, Jeffrey A. Newman, Brett H. Andrews, Rachel Bezanson, Biprateep Dey, Daniel C. Masters, S. A. Stanford

22. [The Statistical Analysis Of The Galactic Open Clusters' Structure](#user-content-link22)
**Authors:** Jin-Sheng Qiu, Zhen Wan, Xu-Zhi Li, Qing-Feng Zhu, Lu-lu Fan, Xiao-Hui Xu, Jun-Han Zhao, Zhi-Yong Pu

23. [No evidence for accretion around the intermediate-mass black hole in Omega Centauri](#user-content-link23)
...
24. [Constraining the outer boundary condition for the Babcock-Leighton dynamo models](#user-content-link24)
**Authors:** Yukun Luo, Jie Jiang, Binghang Li, Zebin Zhang, Ruihui Wang

25. [Exploring Machine Learning Regression Models for Advancing Foreground Mitigation and Global 21cm Signal Parameter Extraction](#user-content-link25)
**Authors:** Anshuman Tripathi, Abhirup Datta, Gursharanjit Kaur

26. [An extragalactic gamma-ray binary formed in supernova 2022jli](#user-content-link26)
**Authors:** Pengfei Zhang (Yunnan University, China), Zhongxiang Wang (Yunnan University, China), Shunhao Ji (Yunnan University, China)

27. [SN 2022ngb: a faint, slow-evolving Type IIb Supernova with a low-mass envelope](#user-content-link27)
**Authors:** J. -W. Zhao, S. Benetti, Y. -Z. Cai, A. Pastorello, N. Elias-Rosa, A. Reguitti, G. Valerin, Z. -Y. Wang, E. Cappellaro, G. -F. Feng, A. Fiore, B. Fitzpatrick, M. Fraser, J. Isern, E. Kankare, T. Kravtsov, B. Kumar, P. Lundqvist, K. Matilainen, S. Mattila, P. A. Mazzali, S. Moran, P. Ochner, Z. -H. Peng, T. M. Reynolds, I. Salmaso, S. Srivastav, M. D. Stritzinger, S. Taubenberger, L. Tomasella, J. Vink\'o, J. C. Wheeler, S. Williams, S. -P. Pei, Y. -J. Yang, X. -K. Liu, X. -W. Liu, Y. -P. Yang

28. [Correlations of Simulated Black-Hole Movies Reveal Extreme-Lensing Signatures](#user-content-link28)
**Authors:** Barbora Bezd\v{e}kov\'a, Shahar Hadar, George Wong, Maciek Wielgus

29. [Ultimate large-$Rm$ regime of the solar dynamo](#user-content-link29)
**Authors:** Fran\c{c}ois Rincon (IRAP, CNRS, UPS)

30. [Cosmic-Ray Bath in a Past Supernova Gives Birth to Earth-Like Planets](#user-content-link30)
**Authors:** Ryo Sawada, Hiroyuki Kurokawa, Yudai Suwa, Tetsuo Taki, Shiu-Hang Lee, Ataru Tanikawa

31. [SLICE -- Combining Strong Lensing and X-ray in AC\,114. Insights into the Merger Scenario](#user-content-link31)
**Authors:** Marceau Limousin, Benjamin Beauchesne, Keren Sharon, Johan Richard, Gourav Khullar, Mathilde Jauzac, Mike Gladders, Eric Jullo, Catherine Cerny, Stefano Ettori, Gavin Leroy, Nency Patel

32. [Primordial non-Gaussianity -- Fast simulations and persistent summary statistics](#user-content-link32)
**Authors:** Juan Calles, Gabriella Contardo, Jorge Nore\~na, Jacky H. T. Yip, Gary Shiu

33. [First Resolution of a Main Sequence G-Star Astrosphere Using Chandra](#user-content-link33)
...
34. [Gravitational-Wave Signatures of Massive Black Hole Formation](#user-content-link34)
**Authors:** Bernard J. Kelly, Sarah Gossan, Leonardo R. Werneck, John Wise, Zachariah B. Etienne, Thiago Assump\c{c}\~ao, Al\'aine Lee, John G. Baker

35. [Improving the inference of the stellar quantities using the extended $I$-Love-$Q$-$\delta M$ relations](#user-content-link35)
**Authors:** Eneko Aranguren, Jos\'e A. Font, Nicolas Sanchis-Gual, Ra\"ul Vera

36. [High deuteration of methanol in L1544](#user-content-link36)
**Authors:** S. Spezzano, W. Riedel, P. Caselli, O. Sipil\"a, Y. Lin, H. A. Bunn, E. Redaelli, L. H. Coudert, A. Meg\'ias, I. Jimenez-Serra

37. [High Order Numerical Methods Preserving Invariant Domain for Hyperbolic and Related Systems](#user-content-link37)
**Authors:** Kailiang Wu, Xiangxiong Zhang, Chi-Wang Shu

38. [Footprints in the Wind: Probing X-ray Outflows in NGC 7469 using Near-Infrared Emission Lines](#user-content-link38)
**Authors:** L\'ea M. Feuillet, Steve Kraemer, Anna Trindade Falc\~ao, Valentina Braito, Marcio Mel\'endez, Henrique R. Schmitt, James N. Reeves, Riccardo Middei, Travis C. Fischer, Mitchell Revalski

39. [Kinematics and physical structure of Ou 5: A bipolar planetary nebula with extreme abundance discrepancy and an eclipsing binary core](#user-content-link39)
**Authors:** William J. Henney (Instituto de Radioastronom\'ia y Astrof\'isica, UNAM, Morelia, Mexico), J. A. L\'opez (Instituto de Astronom\'ia, UNAM, Ensenada, Mexico), Ma. T. Garc\'ia-D\'iaz (Instituto de Astronom\'ia, UNAM, Ensenada, Mexico), M. G. Richer (Instituto de Astronom\'ia, UNAM, Ensenada, Mexico), D. H. Gonz\'alez-Buitrago (Instituto de Astronom\'ia, UNAM, Ensenada, Mexico), S. V. Zharikov (Instituto de Astronom\'ia, UNAM, Ensenada, Mexico), S. Noroozi (Constructor University, Bremen, Germany), F. Pozo Nu\~nez (Heidelberg Institute for Theoretical Studies, Heidelberg, Germany)

40. [GFH-v2 Pipeline for Searches of Long-Transient Gravitational Waves from Newborn Magnetars](#user-content-link40)
...
41. [Age, Chemistry, and Kinematics of the Inner Galaxy Revealed by MUSE](#user-content-link41)
**Authors:** Zixian Wang (Purmortal), Michael R. Hayden, Sanjib Sharma, Joss Bland-Hawthorn, Anil C. Seth, Gail Zasowski

42. [Bimetric MOND as a framework for variable-$G$ theories -- local systems and cosmology](#user-content-link42)
**Authors:** Mordehai Milgrom

43. [A jet bent by a stellar wind in the black hole X-ray binary Cygnus X-1](#user-content-link43)
**Authors:** Steve Prabu, James C. A. Miller-Jones, Arash Bahramian, Valenti Bosch-Ramon, Sebastian Heinz, Steven J. Tingay, Callan M. Wood, Alexandra Tetarenko, Tyrone N. O'Doherty, Valeriu Tudose

44. [Delving into the depths of NGC 3783 with XRISM IV. Mapping of the accretion flow with Fe K$\alpha$ emission lines](#user-content-link44)
**Authors:** Chen Li, Jelle S. Kaastra, Liyi Gu, Missagh Mehdipour, Megan E. Eckart, Matteo Guainazzi, Erin Kara, Laura W. Brenneman, Misaki Mizumoto, Jon Miller, Keigo Fukumura, Ehud Behar, Christos Panagiotou, Matilde Signorini, Keqin Zhao, Ralf Ballhausen, Camille M. Diez, Timothy R. Kallman, Shoji Ogawa, Atsushi Tanimoto, Yoshihiro Ueda

45. [iSTARMOD: A Python Code to Quantify Chromospheric Activity by Using the Spectral Subtraction Technique](#user-content-link45)
**Authors:** Fernando Labarga, David Montes

46. [A Classic Nonlinearity Correction Algorithm for Detectors Read Out Up-The-Ramp](#user-content-link46)
**Authors:** Timothy D. Brandt

47. [Tidal disruption event Calorimetry: Observational constraints on the physics of TDE optical flares](#user-content-link47)
**Authors:** Andrew Mummery, Brian Metzger, Sjoert van Velzen, Muryel Guolo

48. [Viscously Spreading Accretion Disks around Black Holes: Implications for TDEs, LFBOTs and other Transients](#user-content-link48)
**Authors:** Mila Winter-Granic, Eliot Quataert

49. [Surface image and activity-corrected orbit of the RS CVn binary HR 7275: Disentangling activity tracers](#user-content-link49)
**Authors:** \"O. Adebali, M. Weber, K. G. Strassmeier, I. V. Ilyin, M. Steffen, Zs. Kov\'ari

50. [Centrally concentrated star formation in young clusters](#user-content-link50)
...
51. [Numerical simulations of astrophysical dynamos and applications to giant planets](#user-content-link51)
**Authors:** Albert Elias-L\'opez

52. [Confirming the Magnetic Field Detection at the Surface of $\chi$ Cyg](#user-content-link52)
**Authors:** Alexis Lavail, Arturo L\'opez Ariste, Quentin Pilate, Philippe Mathias, Fabrice Herpin, Agn\`es L\`ebre

53. [Adding electromagnetic birefringence to pulsar timing and astrometry to detect gravitational waves](#user-content-link53)
**Authors:** Keisuke Inomata, Marc Kamionkowski

54. [Curvaton-assisted hilltop inflation](#user-content-link54)
**Authors:** Wen-Yuan Ai, Stephen F. King, Xin Wang, Ye-Ling Zhou

55. [The ONs and OFFs of Pulsar Radio Emission: Characterizing the Nulling Phenomenon](#user-content-link55)
**Authors:** Garvit Grover, N. D. Ramesh Bhat, Samuel J. McSweeney, Christopher P. Lee, Chia Min Tan, Shih Ching Fu, Bradley W. Meyers

56. [Relativistic accretion process onto rotating black holes in Einstein-Euler-Heisenberg nonlinear electrodynamic gravity](#user-content-link56)
**Authors:** Orhan Donmez, G. Mustafa, Himanshu Chaudhary, M. Yousaf, Abdelmalek Bouzenada, Allah Ditta, Farruh Atamurotov

57. [Beyond Two Parameters: Revisiting Dark Energy with the Latest Cosmic Probes](#user-content-link57)
**Authors:** Hanyu Cheng, Supriya Pan, Eleonora Di Valentino

58. [Discovery of the redback millisecond pulsar PSR J1728-4608 with ASKAP](#user-content-link58)
...
59. [Primordial magnetic field from chiral plasma instability with sourcing](#user-content-link59)
**Authors:** Murman Gurgenidze, Andrew J. Long, Alberto Roper Pol, Axel Brandenburg, Tina Kahniashvili

60. [Predicting CME Arrivals with Heliospheric Imagers from L5: A Data Assimilation Approach](#user-content-link60)
**Authors:** Tanja Amerstorfer, Justin Le Lou\"edec, David Barnes, Maike Bauer, Jackie A. Davies, Satabdwa Majumdar, Eva Weiler, Christian M\"ostl

61. [Four Giant Planets from 2024 KMTNet Microlensing Campaign](#user-content-link61)
...
76. [Self-calibration of weak lensing cosmic shear biases](#user-content-link76)
**Authors:** G. Congedo, A. N. Taylor

77. [Frequency- and phase-resolved polarimetry of millisecond pulsars and its application to timing](#user-content-link77)
**Authors:** Ma{\l}gorzata Cury{\l}o, Andrew Zic, Shuangqiang Wang, Eric Thrane, Paul D. Lasky, Jacob Cardinal Tremblay, Zu-Cheng Chen, Shi Dai, Valentina Di Marco, George Hobbs, Agastya Kapur, Wenhua Ling, Marcus E. Lower, Saurav Mishra, Daniel J. Reardon, Christopher J. Russell, Ryan M. Shannon, Xing-Jiang Zhu

78. [Tracing a Multi-Temperature Quiescent Prominence's Thermodynamic Evolution from Sun to Earth](#user-content-link78)
**Authors:** Callie A. Garc\'ia, Yeimy J. Rivera, Samuel T. Badman, John C. Raymond, Katharine K. Reeves, Tatiana Niembro, Kristoff W. Paulson, Michael L. Stevens

79. [Quasinormal ringing of Kerr black holes. III. Excitation coefficients for equatorial inspirals from the innermost stable circular orbit](#user-content-link79)
**Authors:** Matteo Della Rocca, Laura Pezzella, Emanuele Berti, Leonardo Gualtieri, Andrea Maselli

80. [Revisiting the X-ray-to-UV relation of Quasars in the era of all-sky surveys](#user-content-link80)
...
81. [3-Dimensional WIMP Effective Velocity Distribution](#user-content-link81)
**Authors:** Chung-Lin Shan

82. [Massive Star Clusters as sources of high-energy gamma radiation](#user-content-link82)
**Authors:** Luana N. Padilha, Rita C. Anjos

83. [Metrics for Optimizing Searches for Orbital Precession and Tidal Decay via Transit- and Occultation-Timing](#user-content-link83)
**Authors:** Brian Jackson, Elisabeth R. Adams, Rachel M. Huchmala, Malia Barker, Marvin Rothmeier, Jeffrey P. Morgenthaler, Amanda A. Sickafoose

84. [X-ray Polarization and Spectral Variations in an Extreme High-Synchrotron-Peaked Blazar 1ES 1101--232](#user-content-link84)
**Authors:** Xin-Ke Hu, Jin Zhang, Fei Xie, Xiang-Gao Wang

85. [University of Hawaii 88-inch Telescope Observations of the Interstellar Comet 3I/ATLAS: Spectrophotometric Blue-Sensitive Spectral Time Series Spanning Two Months from Discovery](#user-content-link85)
...
86. [Investigating the interaction of a Cosmic String with an Accreting Black Hole](#user-content-link86)
**Authors:** Ishan Swamy, Deobrat Singh

87. [Double tidal disruption events or repeating partial tidal disruption events in AT 2020vdq](#user-content-link87)
**Authors:** Zhang XueGuang (GXU)

88. [Warm Inflation in a Braneworld Scenario](#user-content-link88)
**Authors:** Sabina Yeasmin, Atri Deshamukhya

89. [Observational constraints on New Tsallis holographic energy in Rastall theory](#user-content-link89)
**Authors:** N. Sadeghnezhad, R. Jalalzadeh, Z. Davari, B. Afshar

90. [Tachyonic dark energy- Constraints from current observations](#user-content-link90)
**Authors:** Ramanpreet Singh, Athul C N, H. K. Jassal

---

## 1. [Search for Dark Matter Annihilation and Decay with H$\alpha$ Line Emission](https://arxiv.org/abs/2512.09019) <a id="link1"></a>

**ArXiv ID:** 2512.09019

**Authors:** Rebecca K. Leane

**Abstract:** I present a new indirect search for dark matter (DM) using Hydrogen-$\alpha$ (H$\alpha$) recombination emission. DM annihilation or decay products can ionize neutral gas; subsequent recombination cascades generate H$\alpha$ photons through the $3\rightarrow2$ transition. In quiet gas-rich dwarf galaxies, the $n{=}2$ population is negligible, so H$\alpha$ is effectively unabsorbed and traces the DM-energy injection site. Using the non-detection of extended H$\alpha$ emission in the Leo T dwarf galaxy with Multi Unit Spectroscopic Explorer (MUSE) observations, I derive the first H$\alpha$-based limits on DM annihilation and decay, reaching leading sensitivity for parts of the eV-GeV mass range. Existing and upcoming telescopes can further extend this reach, establishing H$\alpha$ imaging as a powerful DM search strategy.

**Comment:** This paper presents a new indirect search for dark matter using H-alpha emission in the Leo T dwarf galaxy, directly connecting to near-field cosmology and dark matter density profiles in dwarf galaxies. The use of H-alpha as a tracer for DM annihilation/decay is novel and the focus on a gas-rich dwarf galaxy is highly relevant.
...
## 2. [TiNy Titans HI: Discovering Satellites via HI Gas in an Isolated, Compact Group of Dwarf Galaxies](https://arxiv.org/abs/2512.09174) <a id="link2"></a>
...
**Comment:** This paper reports the discovery of two new dwarf satellites in a compact group of dwarf galaxies via HI mapping, discusses the satellite mass function, and compares results to simulations. It directly matches the 'Near-Field Cosmology' criterion (satellite galaxies, satellite luminosity function, group environment) and also touches on numerical galaxy simulations and the circumgalactic medium of dwarfs. Highly relevant.
...
## 3. [CWTHF: Subhalo Identification with Continuous Wavelet Transform](https://arxiv.org/abs/2512.09359) <a id="link3"></a>
...
**Comment:** Presents a new subhalo identification algorithm for cosmological simulations, validated on TNG simulations. This is highly relevant to 'Numerical Galaxy Simulations' and 'substructure' in near-field cosmology.
...
## 4. [Interpretable machine learning of halo gas density profiles: a sensitivity analysis of cosmological hydrodynamical simulations](https://arxiv.org/abs/2512.09021) <a id="link4"></a>
...
**Comment:** Analyzes halo gas density profiles using cosmological hydrodynamical simulations (EAGLE, IllustrisTNG, Simba) and machine learning. This fits the 'Numerical Galaxy Simulations' criterion and is also relevant to the circumgalactic medium and feedback processes.
...
## 5. [GA-NIFS: Understanding the ionization nature of EGSY8p7/CEERS-1019. Evidence for a star formation-driven outflow at z = 8.6](https://arxiv.org/abs/2512.09022) <a id="link5"></a>
...
**Comment:** This paper presents spatially resolved spectroscopy of a high-redshift galaxy, identifying a star-formation-driven outflow and measuring mass-loading factor and ionizing photon escape fraction. It matches the 'Star Formation Driven Outflows' criterion and provides direct measurements of mass-loading factor.
...
## 6. [The Early Maturity of High-Redshift Galaxies: Insights from sSFR, M/L and SFHs at z~7-14](https://arxiv.org/abs/2512.09139) <a id="link6"></a>
...
**Comment:** This paper analyzes star formation histories (SFHs), specific star formation rates (sSFR), and mass-to-light ratios of high-redshift galaxies using JWST data. It directly matches the 'Resolved Star Formation Histories' criterion, as it derives SFHs from observed color-magnitude diagrams and models galaxy assembly histories. Highly relevant.
...
## 7. [Kinematics of Distant Milky Way Halo RR Lyrae Stars out to 160 kpc](https://arxiv.org/abs/2512.09795) <a id="link7"></a>
...
**Comment:** This paper presents a kinematical study of RR Lyrae stars in the distant Milky Way halo (60-160 kpc), probing the outer halo's velocity structure and possible disequilibrium due to the LMC. It directly addresses near-field cosmology, specifically the structure and dynamics of the Milky Way's stellar halo and its interaction history. The use of RR Lyrae stars as tracers is a strong match to the criteria.
...
## 8. [Self-consistent secondary cosmic microwave background anisotropies and extragalactic foregrounds in the FLAMINGO simulations](https://arxiv.org/abs/2512.09891) <a id="link8"></a>
...
**Comment:** Presents new mock CMB maps from the FLAMINGO cosmological hydrodynamical simulations, including feedback modeling and cross-correlations between secondary anisotropies. This fits the 'Numerical Galaxy Simulations' criterion, especially as it discusses feedback and galaxy formation models.
...
## 9. [Enhanced rates of stellar radial migration in gas-rich discs at high redshift](https://arxiv.org/abs/2512.09030) <a id="link9"></a>
...
**Comment:** This paper presents numerical simulations of galactic discs, specifically investigating stellar radial migration and mixing in gas-rich discs. It matches the 'Numerical Galaxy Simulations' criterion and discusses chemo-kinematic evolution relevant to near-field cosmology.
...
## 10. [The Limits of Line Broadening: Modeling Stellar Spectra and Formation Temperatures at High Resolution](https://arxiv.org/abs/2512.09861) <a id="link10"></a>
...
**Comment:** Discusses modeling of stellar spectra and formation temperatures, presenting a new package for computing line contribution functions. This fits the 'Stellar Models' criterion as it deals with stellar atmosphere modeling and radiative transfer.
...
## 11. [A High-resolution Study of the Cold Neutral Medium in and around 30 Doradus](https://arxiv.org/abs/2512.09035) <a id="link11"></a>
...
**Comment:** High-resolution study of the cold neutral medium in and around 30 Doradus (LMC). Discusses inflows and outflows, including mass flux rates, which is relevant to 'Star Formation Driven Outflows' and the phase structure of outflows in a galaxy less massive than the Milky Way. Also touches on the ISM and baryon cycle.
...
## 12. [Clumpy, dense gas in the outflow of NGC 1266](https://arxiv.org/abs/2512.09889) <a id="link12"></a>
...
**Comment:** This paper analyzes dense molecular gas in the outflow of NGC 1266, focusing on the phase structure and mass-loading factor of the outflow. It matches the 'Star Formation Driven Outflows' criterion, though the host galaxy is more massive than the LMC, so relevance is slightly reduced.
...
## 13. [Distance to the Globular Cluster M 3 from the Infrared Surface Brightness Technique applied to RR Lyrae stars](https://arxiv.org/abs/2512.09119) <a id="link13"></a>
...
**Comment:** This paper uses the IRSB technique to determine distances and radii for RR Lyrae stars in a globular cluster, comparing empirical and theoretical period-radius relations. It is relevant to 'Stellar Models' as it tests theoretical predictions for stellar radii and period-radius relations.
...
## 14. [Can Clump Properties Predict Core Distribution in Star Formation? A Statistical Analysis of MHD Simulations](https://arxiv.org/abs/2512.09529) <a id="link14"></a>
...
**Comment:** Uses MHD simulations to study the relationship between clump properties and core distribution in star formation. This is tangentially related to 'Numerical Galaxy Simulations' and 'Stellar Models', but focuses on star formation at the clump/core scale rather than galaxy scale.
...
## 15. [The stellar and dark matter distributions in elliptical galaxies measured by stacked weak gravitational lensing](https://arxiv.org/abs/2512.09342) <a id="link15"></a>
...
**Comment:** This paper measures stellar and dark matter distributions in elliptical galaxies using weak lensing. It discusses core radii of dark matter profiles, which is related to the core-cusp problem, but the focus is on massive elliptical galaxies (stellar masses ~10^10-10^12 Msun), not dwarfs or satellites. Some relevance due to core-cusp and dark matter profile measurement, but weighted lower due to galaxy mass.
...
## 16. [On the connection between galaxy orientation and halo absorption properties](https://arxiv.org/abs/2512.09075) <a id="link16"></a>

**ArXiv ID:** 2512.09075

**Authors:** Rohan Venkat (The University of Chicago), Soo May Wee (The University of Chicago), Hsiao-Wen Chen (The University of Chicago)

**Abstract:** We present a systematic investigation of the azimuthal dependence of metal-line absorption in the circumgalactic medium (CGM) using a uniformly selected sample of 87 isolated galaxies at z  0.1 Ang, shows no measurable azimuthal dependence. To assess potential biases, we quantify the effects of projection, disk inclination, and variations in imaging quality. After accounting for these systematics, the spatial distribution of low-redshift MgII and CaII absorbers is consistent with arising from a randomly distributed population, with no compelling evidence for azimuthal anisotropy at d <~ 50 kpc. A larger sample with robust constraints on the disk orientation will be required to uncover or rule out subtle anisotropic trends.

**Comment:** This paper investigates the circumgalactic medium (CGM) of isolated galaxies at low redshift, focusing on metal-line absorption and its spatial distribution. While the CGM is a relevant topic, the sample is not specified as dwarf galaxies and the focus is on azimuthal dependence rather than direct connection to ISM outflows or dwarf galaxy CGM properties. Thus, relevance is moderate.
...
## 17. [Core-wing transitions and the breakdown of diffusion in Lyman-$\alpha$ radiative transfer](https://arxiv.org/abs/2512.09031) <a id="link17"></a>
...
**Comment:** This paper analyzes Lyman-alpha radiative transfer and the breakdown of diffusion approximations, with implications for interpreting LyA in star-forming galaxies. While it is relevant to understanding star formation and radiative transfer, it does not directly address resolved star formation histories, quenching, or galaxy simulations. Borderline relevance.
...
## 18. [Probing the origin of the kilonova candidate GRB 230307A: analysis of host galaxy and offset](https://arxiv.org/abs/2512.09036) <a id="link18"></a>
...
**Comment:** This paper analyzes the host galaxy and offset of a kilonova candidate associated with a gamma-ray burst, focusing on the origin of the event and the host galaxy's mass model. While it involves galaxy modeling and population synthesis, the main focus is on the transient's origin and not on dwarf galaxies, resolved star formation histories, or galaxy simulations as defined in the criteria. The relevance is borderline.
...
## 19. [CASCADE: Filamentary accretion flows in Cygnus X DR20](https://arxiv.org/abs/2512.09519) <a id="link19"></a>
...
**Comment:** This paper investigates filamentary accretion flows in a high-mass star-forming region (Cygnus X DR20), focusing on gas flows along filaments and their properties. While it discusses star formation and filamentary structure, the focus is on high-mass star formation and not on dwarf galaxies, resolved star formation histories, or galaxy-scale outflows. Borderline relevance for star formation processes.
...
## 20. [Unsupervised Kinematic Dissection of the Solar Neighborhood: Identifying Stellar Moving Groups with Gaia DR3](https://arxiv.org/abs/2512.09078) <a id="link20"></a>
...
**Comment:** Uses Gaia DR3 data to identify stellar moving groups in the solar neighborhood, focusing on the Milky Way disk. While it discusses kinematic substructures, it does not address dwarf galaxies, satellite systems, or other core criteria.
...
## 21. [Optimizing Photometric Redshift Training Sets I: Efficient Compression of the Galaxy Color-Redshift Relation with UMAP](https://arxiv.org/abs/2512.09032) <a id="link21"></a>
...
**Comment:** This paper presents a new method for compressing galaxy color-redshift relations using UMAP, improving photometric redshift estimation. While it involves galaxy properties and machine learning, it does not directly address any of the core topics such as resolved star formation histories, dwarf galaxies, or galaxy simulations. The work is more focused on methodology for redshift estimation.
...
## 22. [The Statistical Analysis Of The Galactic Open Clusters' Structure](https://arxiv.org/abs/2512.09387) <a id="link22"></a>
...
**Comment:** Analyzes the structure and evolution of Galactic open clusters, focusing on their dynamical properties and environmental effects. While it discusses evolutionary processes, it does not address dwarf galaxies, resolved star formation histories, or galaxy-scale simulations.
...
## 23. [No evidence for accretion around the intermediate-mass black hole in Omega Centauri](https://arxiv.org/abs/2512.09649) <a id="link23"></a>
...
**Comment:** Investigates accretion signatures of an intermediate-mass black hole in Omega Centauri, a globular cluster. While Omega Cen is a Milky Way satellite, the focus is on black hole accretion, not on near-field cosmology, star formation histories, or galaxy simulations.
...
## 24. [Constraining the outer boundary condition for the Babcock-Leighton dynamo models](https://arxiv.org/abs/2512.09371) <a id="link24"></a>
...
**Comment:** Constrains boundary conditions for Babcock-Leighton dynamo models, focusing on solar and stellar magnetic cycles. While it involves stellar physics, it does not present new stellar evolutionary or atmosphere models relevant to the prompt.
...
## 25. [Exploring Machine Learning Regression Models for Advancing Foreground Mitigation and Global 21cm Signal Parameter Extraction](https://arxiv.org/abs/2512.09361) <a id="link25"></a>
...
**Comment:** Machine learning methods for foreground mitigation and 21cm global signal extraction. While 21cm cosmology is important, this paper is focused on signal extraction and not on resolved star formation histories, dwarf galaxies, or near-field cosmology.
...
## 26. [An extragalactic gamma-ray binary formed in supernova 2022jli](https://arxiv.org/abs/2512.09223) <a id="link26"></a>
...
**Comment:** This paper discusses the formation of a gamma-ray binary system following a supernova in an extragalactic context. While it touches on binary formation and compact objects, it does not focus on near-field cosmology, dwarf galaxies, resolved star formation histories, or other core criteria.
...
## 27. [SN 2022ngb: a faint, slow-evolving Type IIb Supernova with a low-mass envelope](https://arxiv.org/abs/2512.09384) <a id="link27"></a>
...
**Comment:** Detailed study of a Type IIb supernova, focusing on explosion parameters and progenitor properties. No direct relevance to the core criteria such as dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 28. [Correlations of Simulated Black-Hole Movies Reveal Extreme-Lensing Signatures](https://arxiv.org/abs/2512.09641) <a id="link28"></a>
...
**Comment:** Examines gravitational lensing signatures in black hole movies using GRMHD simulations. While it uses simulations, the focus is on black hole environments rather than galaxy-scale simulations or near-field cosmology.
...
## 29. [Ultimate large-$Rm$ regime of the solar dynamo](https://arxiv.org/abs/2512.09536) <a id="link29"></a>
...
**Comment:** Presents new insights into solar dynamo regimes using MHD simulations. While it involves numerical simulations and stellar physics, it is focused on the Sun and not on galaxy-scale simulations or stellar models relevant to the prompt.
...
## 30. [Cosmic-Ray Bath in a Past Supernova Gives Birth to Earth-Like Planets](https://arxiv.org/abs/2512.09660) <a id="link30"></a>
...
**Comment:** The paper discusses the formation of Earth-like planets via cosmic-ray nucleosynthesis from supernovae, with implications for planet formation and SLR abundances. It does not match any of the core criteria focused on galaxies, star formation histories, or stellar models.
...
## 31. [SLICE -- Combining Strong Lensing and X-ray in AC\,114. Insights into the Merger Scenario](https://arxiv.org/abs/2512.09512) <a id="link31"></a>
...
**Comment:** Strong lensing and X-ray analysis of a galaxy cluster merger. While it discusses dark matter distribution, the focus is on a massive cluster, not on dwarf galaxies, satellite systems, or near-field cosmology. No direct relevance to the core topics.
...
## 32. [Primordial non-Gaussianity -- Fast simulations and persistent summary statistics](https://arxiv.org/abs/2512.09852) <a id="link32"></a>
...
**Comment:** This paper introduces a new simulation suite for primordial non-Gaussianity and compares summary statistics for constraining PNG. While it involves large-scale structure and halo catalogs, it does not focus on galaxy-scale simulations, dwarf galaxies, or any of the core topics. The focus is on cosmological initial conditions and statistics.
...
## 33. [First Resolution of a Main Sequence G-Star Astrosphere Using Chandra](https://arxiv.org/abs/2512.09613) <a id="link33"></a>
...
**Comment:** Resolves the astrosphere of a main sequence G-star using X-ray observations. While it discusses the interaction of stellar wind and the local ISM, it does not address galaxy-scale outflows, dwarf galaxies, or circumgalactic medium.
...
## 34. [Gravitational-Wave Signatures of Massive Black Hole Formation](https://arxiv.org/abs/2512.09197) <a id="link34"></a>
...
**Comment:** Simulations of direct-collapse black hole formation and gravitational wave signatures; while it involves numerical simulations, the focus is on black holes rather than galaxies, so it does not match the 'Numerical Galaxy Simulations' criterion.
...
## 35. [Improving the inference of the stellar quantities using the extended $I$-Love-$Q$-$\delta M$ relations](https://arxiv.org/abs/2512.09554) <a id="link35"></a>
...
**Comment:** The paper discusses improved inference of stellar quantities using extended I-Love-Q relations, which are relevant to compact object astrophysics but do not present new stellar evolutionary or atmosphere models. No core criteria are matched.
...
## 36. [High deuteration of methanol in L1544](https://arxiv.org/abs/2512.09110) <a id="link36"></a>
...
**Comment:** This paper investigates the deuteration of methanol in pre-stellar cores, using observations and chemical models. While it involves star formation chemistry, the focus is on molecular clouds and pre-stellar cores, not on galaxies or resolved star formation histories.
...
## 37. [High Order Numerical Methods Preserving Invariant Domain for Hyperbolic and Related Systems](https://arxiv.org/abs/2512.09116) <a id="link37"></a>
...
**Comment:** This is a survey of numerical methods for hyperbolic systems, with applications in gas dynamics and magnetohydrodynamics. While numerical methods are relevant to simulations, this paper is methodological and not focused on galaxy simulations or any of the core topics.
...
## 38. [Footprints in the Wind: Probing X-ray Outflows in NGC 7469 using Near-Infrared Emission Lines](https://arxiv.org/abs/2512.09815) <a id="link38"></a>
...
**Comment:** This paper probes AGN-driven X-ray outflows in NGC 7469 using near-infrared emission lines. While it discusses outflows and feedback, the focus is on AGN-driven processes in a massive galaxy, not star-formation-driven outflows or dwarf galaxies. Only tangential relevance.
...
## 39. [Kinematics and physical structure of Ou 5: A bipolar planetary nebula with extreme abundance discrepancy and an eclipsing binary core](https://arxiv.org/abs/2512.09012) <a id="link39"></a>
...
**Comment:** This paper studies the kinematics and physical structure of a planetary nebula, including abundance discrepancies and binary core properties. While it involves stellar evolution and nebular modeling, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on galaxies or the other core topics. The relevance is low.
...
## 40. [GFH-v2 Pipeline for Searches of Long-Transient Gravitational Waves from Newborn Magnetars](https://arxiv.org/abs/2512.09878) <a id="link40"></a>
...
**Comment:** Describes a pipeline for searching long-transient gravitational waves from newborn magnetars. No direct relevance to galaxy simulations, near-field cosmology, or other core criteria.
...
## 41. [Age, Chemistry, and Kinematics of the Inner Galaxy Revealed by MUSE](https://arxiv.org/abs/2512.09527) <a id="link41"></a>
...
**Comment:** Studies ages, chemistry, and kinematics of stars in the inner Galaxy (bar/bulge and inner disk) using MUSE. The focus is on the inner Galaxy, which is specifically excluded from the core topics (irrelevant: bar, Galactic center).
...
## 42. [Bimetric MOND as a framework for variable-$G$ theories -- local systems and cosmology](https://arxiv.org/abs/2512.09353) <a id="link42"></a>
...
**Comment:** The paper discusses bimetric MOND and variable-G theories in the context of cosmology, but does not address near-field cosmology, dwarf galaxies, or galaxy simulations. No relevant criteria are met.
...
## 43. [A jet bent by a stellar wind in the black hole X-ray binary Cygnus X-1](https://arxiv.org/abs/2512.09645) <a id="link43"></a>
...
**Comment:** Study of jet bending in the black hole X-ray binary Cygnus X-1. Focuses on jet power and feedback, but in a stellar-mass black hole system, not in galaxies or star-formation-driven outflows. Not relevant to the core topics.
...
## 44. [Delving into the depths of NGC 3783 with XRISM IV. Mapping of the accretion flow with Fe K$\alpha$ emission lines](https://arxiv.org/abs/2512.09207) <a id="link44"></a>
...
**Comment:** Maps accretion flow in an AGN using Fe Kα emission lines. Focuses on AGN accretion and black hole spin, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 45. [iSTARMOD: A Python Code to Quantify Chromospheric Activity by Using the Spectral Subtraction Technique](https://arxiv.org/abs/2512.09192) <a id="link45"></a>
...
**Comment:** Presents a Python code for quantifying chromospheric activity in late-type stars using spectral subtraction. Focuses on stellar activity indicators, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 46. [A Classic Nonlinearity Correction Algorithm for Detectors Read Out Up-The-Ramp](https://arxiv.org/abs/2512.09132) <a id="link46"></a>
...
**Comment:** This paper presents a new algorithm for nonlinearity correction in detector readouts, with application to the Roman Space Telescope. While it is a technical advance in instrumentation, it does not present new stellar models or address any of the core astrophysical topics (near-field cosmology, star formation histories, quenching, etc.).
...
## 47. [Tidal disruption event Calorimetry: Observational constraints on the physics of TDE optical flares](https://arxiv.org/abs/2512.09143) <a id="link47"></a>
...
**Comment:** This paper focuses on tidal disruption events (TDEs), specifically the physics of their optical/UV flares and their relation to black hole mass. TDEs are not relevant to near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or star-formation-driven outflows. The focus is on accretion physics around black holes, which is outside the core topics.
...
## 48. [Viscously Spreading Accretion Disks around Black Holes: Implications for TDEs, LFBOTs and other Transients](https://arxiv.org/abs/2512.09017) <a id="link48"></a>
...
**Comment:** This paper presents models of viscously spreading accretion disks around black holes, with applications to TDEs and LFBOTs. The work is focused on accretion disk physics and transient phenomena, not on galaxies, dwarf galaxies, or the other core topics. No direct relevance to near-field cosmology, star formation histories, quenching, or galaxy simulations.
...
## 49. [Surface image and activity-corrected orbit of the RS CVn binary HR 7275: Disentangling activity tracers](https://arxiv.org/abs/2512.09521) <a id="link49"></a>
...
**Comment:** This paper studies magnetic activity and surface imaging in a binary star system, focusing on stellar spots and magnetic fields. While it touches on stellar properties, it does not present new stellar models or evolutionary tracks, so it does not match the 'Stellar Models' criterion.
...
## 50. [Centrally concentrated star formation in young clusters](https://arxiv.org/abs/2507.05016) <a id="link50"></a>
...
**Comment:** This paper presents numerical simulations of star cluster formation and evolution, focusing on density profiles and feedback. While it involves star formation and simulations, the focus is on star clusters rather than galaxies, and does not address resolved star formation histories, quenching, or galaxy-scale outflows. Only tangential relevance.
...
## 51. [Numerical simulations of astrophysical dynamos and applications to giant planets](https://arxiv.org/abs/2512.09725) <a id="link51"></a>
...
**Comment:** This thesis presents numerical simulations of astrophysical dynamos in the ISM and giant planets. While it includes ISM simulations, the focus is on magnetic field generation and planetary interiors, not on galaxy simulations or the specified core topics.
...
## 52. [Confirming the Magnetic Field Detection at the Surface of $\chi$ Cyg](https://arxiv.org/abs/2512.09392) <a id="link52"></a>

**ArXiv ID:** 2512.09392

**Authors:** Alexis Lavail, Arturo L\'opez Ariste, Quentin Pilate, Philippe Mathias, Fabrice Herpin, Agn\`es L\`ebre

**Abstract:** We present spectropolarimetric observations of $\chi$ Cygni obtained with Neo-Narval at T\'elescope Bernard Lyot in 2025. We obtained observations across three epochs (2025 Jul, Aug, and Oct) near maximum light to search for magnetic field signatures at the stellar photosphere. We detected a clear circular polarization signal in the 2025 Aug observations (pulsation phases $0.99$ to $0.01$). We measure a mean longitudinal magnetic field of $B_l = 3.4 \pm 0.6$ G. No detections were obtained for the 2025 Jul and Oct epochs. The pulsation-phase dependence suggests that field detection is tied to specific shock conditions near maximum light.

**Comment:** This paper presents spectropolarimetric observations of the star χ Cygni, focusing on magnetic field detection at its surface. While it involves stellar magnetic fields and some aspects of stellar atmospheres, it does not present new stellar atmosphere or interior models, nor does it address resolved star formation histories, near-field cosmology, or galaxy simulations. The work is largely outside the core topics, with only a weak association to the 'Stellar Models' criterion.
...
## 53. [Adding electromagnetic birefringence to pulsar timing and astrometry to detect gravitational waves](https://arxiv.org/abs/2512.09759) <a id="link53"></a>
...
**Comment:** Presents a method for detecting gravitational waves using pulsar timing and astrometry, with a focus on electromagnetic birefringence. No direct relevance to galaxy simulations, near-field cosmology, or other core criteria.
...
## 54. [Curvaton-assisted hilltop inflation](https://arxiv.org/abs/2512.09079) <a id="link54"></a>
...
**Comment:** Discusses inflationary cosmology and curvaton models, with no direct connection to galaxy simulations, near-field cosmology, or other core criteria.
...
## 55. [The ONs and OFFs of Pulsar Radio Emission: Characterizing the Nulling Phenomenon](https://arxiv.org/abs/2512.09274) <a id="link55"></a>
...
**Comment:** Characterizes pulsar radio emission and nulling phenomena. No direct connection to galaxy simulations, near-field cosmology, or other core criteria.
...
## 56. [Relativistic accretion process onto rotating black holes in Einstein-Euler-Heisenberg nonlinear electrodynamic gravity](https://arxiv.org/abs/2512.09845) <a id="link56"></a>
...
**Comment:** Studies accretion dynamics around rotating black holes in nonlinear electrodynamics, focusing on accretion flows and QPOs. This is not relevant to any of the core topics (no connection to galaxy simulations, near-field cosmology, or stellar models).
...
## 57. [Beyond Two Parameters: Revisiting Dark Energy with the Latest Cosmic Probes](https://arxiv.org/abs/2512.09866) <a id="link57"></a>
...
**Comment:** This paper focuses on dark energy models and cosmological constraints, which do not match any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. No relevant criteria are met.
...
## 58. [Discovery of the redback millisecond pulsar PSR J1728-4608 with ASKAP](https://arxiv.org/abs/2512.09339) <a id="link58"></a>
...
**Comment:** Discovery of a millisecond pulsar in a binary system; while interesting for compact object studies, it does not match any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 59. [Primordial magnetic field from chiral plasma instability with sourcing](https://arxiv.org/abs/2512.09177) <a id="link59"></a>
...
**Comment:** Primordial magnetic field generation via chiral plasma instability in the early universe. This is a theoretical cosmology paper, not related to near-field cosmology, resolved star formation histories, or any of the other core criteria.
...
## 60. [Predicting CME Arrivals with Heliospheric Imagers from L5: A Data Assimilation Approach](https://arxiv.org/abs/2512.09738) <a id="link60"></a>
...
**Comment:** This paper focuses on predicting coronal mass ejection (CME) arrivals at Earth using heliospheric imager data. While it involves astrophysical simulations and data assimilation, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, or outflows. The focus is on solar system space weather.
...
## 61. [Four Giant Planets from 2024 KMTNet Microlensing Campaign](https://arxiv.org/abs/2512.09325) <a id="link61"></a>
...
**Comment:** This paper presents analyses of four newly discovered planetary microlensing events, focusing on giant planets around low-mass stars. While it involves low-mass stellar hosts, it does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 63. [Accretion bottleneck in protoplanetary discs: the role of the stellar spin](https://arxiv.org/abs/2512.09638) <a id="link63"></a>
...
**Comment:** Examines accretion and angular momentum transport in protoplanetary discs, focusing on stellar spin and accretion bottlenecks. Not related to galaxy simulations, dwarf galaxies, or star formation histories.
...
## 65. [Dirac vs. Majorana Dark Matter Imprints on Neutron Star Observables](https://arxiv.org/abs/2512.09498) <a id="link65"></a>
...
**Comment:** Examines the impact of Dirac vs. Majorana dark matter on neutron star observables. Focuses on compact stars and dark matter, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 66. [Galaxy Cluster Detection and Dynamical Analysis in the VIPERS High-Redshift Spectroscopic Survey](https://arxiv.org/abs/2512.09303) <a id="link66"></a>
...
**Comment:** This paper focuses on galaxy clusters at high redshift, analyzing their dynamical properties and mass estimators. The work is centered on massive galaxy clusters, not dwarf galaxies or near-field cosmology, and does not address resolved star formation histories, quenching, stellar models, or galaxy simulations. It is largely outside the core topics.
...
## 67. [Probing jet base emission of M87* with the 2021 Event Horizon Telescope observations](https://arxiv.org/abs/2512.08970) <a id="link67"></a>
...
**Comment:** Investigates jet base emission in M87* using EHT observations. Focus is on AGN jet emission and black hole accretion, which is not relevant to any of the core topics.
...
## 68. [Non-Equilibrium Thermodynamics of Black-Hole Coronae: QPOs, Turbulence, and Jets](https://arxiv.org/abs/2512.09026) <a id="link68"></a>
...
**Comment:** This paper develops a new theoretical framework for the variability of X-rays in black hole coronae, focusing on QPOs, turbulence, and jets. The work is centered on accreting black holes and does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 69. [The impact of AGN environmental effects on testing general relativity with space-borne gravitational wave detector](https://arxiv.org/abs/2512.09635) <a id="link69"></a>
...
**Comment:** Focuses on gravitational wave detection in AGN environments and tests of General Relativity. No direct connection to galaxy simulations, near-field cosmology, or other core criteria.
...
## 70. [Probing stellar rotation in the Pleiades with gravity-mode pulsators](https://arxiv.org/abs/2512.09395) <a id="link70"></a>
...
**Comment:** This paper uses asteroseismology to probe stellar rotation in the Pleiades cluster, focusing on gravity-mode pulsators. It does not present new stellar models or address galaxy-scale topics.
...
## 71. [Bayesian Model Selection with an Application to Cosmology](https://arxiv.org/abs/2512.09724) <a id="link71"></a>
...
**Comment:** This paper focuses on Bayesian model selection for cosmological models using Type Ia supernova data. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specific criteria. It is a general cosmology/model selection paper.
...
## 72. [Constraints on Spatial Curvature and Dark Energy Dynamics in the $w$CDM Model from DESI DR1 and DR2](https://arxiv.org/abs/2512.09486) <a id="link72"></a>
...
**Comment:** Constraints on spatial curvature and dark energy dynamics using DESI data. This is a cosmology paper focused on large-scale parameters, not on near-field cosmology, dwarf galaxies, or any of the other core criteria.
...
## 73. [WASP-12, shrouded in mystery or just cold gas?](https://arxiv.org/abs/2512.09593) <a id="link73"></a>
...
**Comment:** This paper studies the Mg II absorption in the WASP-12 system, focusing on the gas torus around a planet-hosting star. The work involves hydrodynamical simulations and ISM absorption, but does not address any of the core topics such as dwarf galaxies, star formation histories, quenching, or galaxy-scale outflows. The focus is on exoplanetary systems and circumstellar material.
...
## 74. [Reconciling ALP Dark Matter and Electroweak Baryogenesis through First-Order Electroweak Phase Transition](https://arxiv.org/abs/2512.09760) <a id="link74"></a>
...
**Comment:** Explores axionlike particle dark matter and electroweak baryogenesis, with a focus on early universe phase transitions. No direct connection to any of the core topics (no relevance to galaxy formation, near-field cosmology, or stellar models).
...
## 75. [Characterising the X-ray variability of QSOs to the highest Eddington ratios and black hole masses with eROSITA light curves](https://arxiv.org/abs/2512.09047) <a id="link75"></a>
...
**Comment:** Characterizes X-ray variability of QSOs with eROSITA, focusing on accretion flows onto supermassive black holes. No connection to the core topics (no relevance to galaxy simulations, near-field cosmology, or stellar models).
...
## 76. [Self-calibration of weak lensing cosmic shear biases](https://arxiv.org/abs/2512.09922) <a id="link76"></a>
...
**Comment:** This paper presents a new methodology for self-calibrating weak lensing cosmic shear biases, relevant for cosmological surveys. It does not address any of the specified core topics related to galaxies, dwarf galaxies, or star formation.
...
## 77. [Frequency- and phase-resolved polarimetry of millisecond pulsars and its application to timing](https://arxiv.org/abs/2512.09220) <a id="link77"></a>
...
**Comment:** Polarimetry and timing of millisecond pulsars. This is a pulsar timing/methods paper and does not match any of the core criteria.
...
## 78. [Tracing a Multi-Temperature Quiescent Prominence's Thermodynamic Evolution from Sun to Earth](https://arxiv.org/abs/2512.09234) <a id="link78"></a>
...
**Comment:** This paper traces the thermodynamic evolution of a solar prominence from the Sun to Earth, focusing on multi-temperature plasma and ionization states. The work is centered on solar physics and does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 79. [Quasinormal ringing of Kerr black holes. III. Excitation coefficients for equatorial inspirals from the innermost stable circular orbit](https://arxiv.org/abs/2512.07959) <a id="link79"></a>
...
**Comment:** Studies quasinormal ringing of Kerr black holes and excitation coefficients for inspirals. Focuses on black hole physics, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 80. [Revisiting the X-ray-to-UV relation of Quasars in the era of all-sky surveys](https://arxiv.org/abs/2512.09767) <a id="link80"></a>
...
**Comment:** This paper studies the X-ray-to-UV relation in quasars/AGNs, focusing on accretion physics and its evolution with redshift. It does not address dwarf galaxies, near-field cosmology, resolved star formation histories, quenching, stellar models, or galaxy simulations. The topic is not relevant to the core criteria.
...
## 81. [3-Dimensional WIMP Effective Velocity Distribution](https://arxiv.org/abs/2512.09567) <a id="link81"></a>
...
**Comment:** This paper discusses the velocity distribution of WIMPs for direct detection experiments. It is focused on dark matter detection methods and does not address near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 82. [Massive Star Clusters as sources of high-energy gamma radiation](https://arxiv.org/abs/2512.09743) <a id="link82"></a>
...
**Comment:** This paper investigates massive star clusters as sources of high-energy gamma rays, focusing on cosmic ray acceleration and gamma-ray production. The focus is on star clusters and high-energy processes, not on galaxies or the specified core topics.
...
## 83. [Metrics for Optimizing Searches for Orbital Precession and Tidal Decay via Transit- and Occultation-Timing](https://arxiv.org/abs/2512.09122) <a id="link83"></a>
...
**Comment:** Focuses on exoplanet orbital precession and tidal decay via transit timing, which is unrelated to any of the core topics (no connection to near-field cosmology, star formation histories, galaxy simulations, or stellar models).
...
## 84. [X-ray Polarization and Spectral Variations in an Extreme High-Synchrotron-Peaked Blazar 1ES 1101--232](https://arxiv.org/abs/2512.09448) <a id="link84"></a>
...
**Comment:** X-ray polarization study of a blazar; this is not relevant to any of the core topics such as galaxy simulations, near-field cosmology, or star formation histories.
...
## 85. [University of Hawaii 88-inch Telescope Observations of the Interstellar Comet 3I/ATLAS: Spectrophotometric Blue-Sensitive Spectral Time Series Spanning Two Months from Discovery](https://arxiv.org/abs/2512.09020) <a id="link85"></a>
...
**Comment:** Observations of the interstellar comet 3I/ATLAS. This is a solar system/small body paper and does not match any of the core criteria.
...
## 86. [Investigating the interaction of a Cosmic String with an Accreting Black Hole](https://arxiv.org/abs/2512.09380) <a id="link86"></a>
...
**Comment:** Study of cosmic string interactions with accreting black holes. This is not related to any of the core topics (galaxy evolution, dwarf galaxies, star formation, etc.).
...
## 87. [Double tidal disruption events or repeating partial tidal disruption events in AT 2020vdq](https://arxiv.org/abs/2512.09204) <a id="link87"></a>
...
**Comment:** Analysis of tidal disruption events (TDEs) in a specific source. TDEs are not relevant to the core topics.
...
## 88. [Warm Inflation in a Braneworld Scenario](https://arxiv.org/abs/2512.09389) <a id="link88"></a>
...
**Comment:** This paper presents a warm inflationary model in a braneworld scenario, focusing on cosmological observables and early universe physics. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 89. [Observational constraints on New Tsallis holographic energy in Rastall theory](https://arxiv.org/abs/2512.09540) <a id="link89"></a>
...
**Comment:** Cosmological model constraints (dark energy) using large-scale structure and expansion history data. No connection to near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 90. [Tachyonic dark energy- Constraints from current observations](https://arxiv.org/abs/2512.09744) <a id="link90"></a>
...
**Comment:** This paper discusses constraints on tachyonic dark energy models using cosmological datasets. It is focused on cosmological parameters and dark energy, not on near-field cosmology, dwarf galaxies, or any of the other specified topics.
