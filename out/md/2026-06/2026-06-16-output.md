...
1. [The Milky Way's Missing In-Situ Halo](#user-content-link1)
**Authors:** Madeline Lucey, Robyn E. Sanderson, Alexander H. Riley, Andreia Carrillo, Jenna Samuel, Emma Tasso

2. [Groups of Dwarf Galaxies in the Local Universe](#user-content-link2)
**Authors:** Sanjaya Paudel, Cristiano G. Sabiu, Suk-Jin Yoon, Daya Nidhi Chhatkuli, Jaewon Yoo, Nau Raj Pokhrel

3. [Joint Modeling of GD-1 and C-19 as Old Streams](#user-content-link3)
**Authors:** Raymond G. Carlberg, Ting S. Li, Emma Jarvis, Nasser Mohammed, Joan Najita, Arjun Dey, Sergey E. Koposov, Jakob Piafsky, Leandro Beraldo e Silva, Constance M. Rockosi, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. de la Macorra, Biprateep Dey, P. Doel, A. Font-Ribera, J. E. Forero-Romero, Satya Gontcho A Gontcho, G. Gutierrez, R. Joyce, S. Junea, A. Kremin, O. Lahav, M. Landriau, L. Le Guillou, A. Meisner, R. Miquel, W. J. Percival, C. Poppett, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, J. Silber, G. Tarl\'e, B. A. Weaver, R. Zhou, H. Zou

4. [A Strong Stellar Age-Metallicity Gradient Relation in Nearby Dwarf Galaxies Driven by Stellar Migration and Environmental Quenching](#user-content-link4)
...
5. [TODDLERS 2.0: Stellar feedback and observables across diverse IMFs, binary populations, and cloud environments](#user-content-link5)
**Authors:** Anand Utsav Kapoor, Andrea Gebek, Maarten Baes, Sven De Rijcke, Arjen van der Wel, S\'ebastien Vicens-Mouret, Carmelle Robert

6. [GridFire: A new, open source, nuclear network for stellar structure and evolution](#user-content-link6)
**Authors:** Emily M. Boudreaux, Aaron Dotter

7. [The impact of the white dwarf initial-final mass relation on star clusters' ages inferred from their cooling sequence](#user-content-link7)
**Authors:** Maurizio Salaris (INAF -- Osservatorio di Astrofisica e Scienza dello Spazio di Bologna, Italy, ARI -- Liverpool John Moores University, UK), Santi Cassisi (INAF -- Osservatorio Astronomico d'Abruzzo, Teramo, Italy, INFN -- Sezione di Pisa, Italy), Luigi R. Bedin (INAF -- Osservatorio Astronomico di Padova, Italy)

8. [Neutrino Constraints on memory-burdened Primordial Black Holes from Dwarf Spheroidal Galaxies](#user-content-link8)
**Authors:** Xiu-Hui Tan, Jun-qing Xia, Yu-Feng Zhou

9. [Optically Invisible Galaxies at Cosmic Noon and beyond with JWST/UNCOVER](#user-content-link9)
**Authors:** Pralay Biswas, Rashi Jain, Yogesh Wadadekar

10. [Constraints with CMB lensing on dark matter decays to massive decay products](#user-content-link10)
**Authors:** Anna Bencke, Nanoom Lee, Marc Kamionkowski

11. [Probing the fate of large primordial perturbations with exoplanets](#user-content-link11)
**Authors:** Th\'eo Par\'e, Julien Lavalle

12. [Simulating winds in the Galactic centre: I. Supernova-driven multiphase outflows and HI cloud acceleration](#user-content-link12)
**Authors:** Nicolas Peschken, Enrico M. Di Teodoro, Micha{\l} Hanasz, Lucia Armillotta, Robin Tress, Thorsten Naab, Dominik W\'olta\'nski, Artur Gawryszczak

13. [KRONOS II: Solar-like Umbra and Penumbra Properties on the Young Sun V1298~Tau](#user-content-link13)
**Authors:** Matthew M. Murphy, Adina D. Feinstein, Meir E. Schochet, Benjamin V. Rackham, Luis Welbanks, Darryl Z. Seligman, Girish M. Duvvuri, Eva-Maria Ahrer, John H. Livingston, Saugata Barat, Jean-Michel D\'esert, Rafael Luque, Catriona Murray, Matthew C. Nixon, Sydney Petz, Michael Radica, Hinna Shivkumar

14. [XP-TEAL: Gaia XP tool for emission and absorption lines. I. Balmer lines in open clusters](#user-content-link14)
**Authors:** J. M. Carrasco, M. Weiler, S. Malhotra, F. Anders, C. Jordi, E. Masana, J. Casta\~neda, F. Boix

15. [The Edge-on Galaxies in the DESI survey (EGIDE): sample building and photometry](#user-content-link15)
...
16. [Intermediate-mass black hole seeding in galactic nuclei from star cluster migration](#user-content-link16)
**Authors:** Stefano Torniamenti, Nils Hoyer, Nadine Neumayer, Peter J. Smith, Manuel Arca Sedda

17. [Systematic and Statistical Uncertainties in Cepheid PL Relations: Incorporating a Cross-Filter Random-Phase Mitigation Approach](#user-content-link17)
**Authors:** Mahdi Abdollahi, Atefeh Javadi

18. [Centaurus A Inner Lobes -- I. Hydrodynamic modeling of a Precessing Jet](#user-content-link18)
**Authors:** Rita C. Anjos, Brian Reville

19. [Physical characterization of the local system NGC 1313: A flattening in its chemical abundance by past interactions](#user-content-link19)
**Authors:** Bel\'en Ojeda-D\'iaz, Sergio Torres-Flores, Daniela E. Olave-Rojas, Ciria Lima-Dias, Paulo J. A. Lago, Claudia Mendes de Oliveira, Philippe Amram, Bruno C. Quint

20. [A Comparative Study of Isothermal Turbulence Statistics: Fourier Space Driving vs. Point Source Driving](#user-content-link20)
**Authors:** Tejahni Desire, Chang-Goo Kim, Rajsekhar Mohapatra

21. [PEARLS: NuSTAR and XMM-Newton Extragalactic Survey of the JWST North Ecliptic Pole Time Domain Field VI: Multiwavelength SED Analysis](#user-content-link21)
...
22. [Encounters of star clusters as a possible source of disturbances in their internal structure](#user-content-link22)
**Authors:** M. D. Sizova, L. A. Maksimova, S. V. Vereshchagin

23. [The Peculiar Growth of Structure: Validating $f\sigma_8$ Measurements from TITAN Type Ia Supernovae and the Uchuu Simulations](#user-content-link23)
...
24. [The Narrow-Line Seyfert 1 Phenomenon: Accretion State Versus Host Galaxy Properties](#user-content-link24)
**Authors:** Kaizheng Guo, Hassen M. Yesuf, Lei Hao, Vineet Ojha, Lin Lin, Zhenzhen Li

25. [A HINSA view of cosmic-ray ionization in IC 348 and NGC 1333: evidence for a strong low-energy cosmic-ray disparity](#user-content-link25)
**Authors:** Gan Luo, Marco Padovani, Daniele Galli, Thomas G. Bisbas, Brandt A. L. Gaches, Di Li, Marko Kr\v{c}o, Ningyu Tang

26. [COSMOS-Web: A Multi-wavelength Morphological Catalog of ~780,000 Galaxies](#user-content-link26)
...
27. [Probing Direct Contributions of Galaxies and AGN to Cosmic Reionization in a Quasar Field J0226+0302 with JWST NIRCam and NIRSpec](#user-content-link27)
...
28. [A First Post-Friedmann Extension of the Schr\"odinger Approach to Cosmic Structure Formation](#user-content-link28)
**Authors:** Yiwen Deng-Huang, Daniele Bertacca, Sabino Matarrese

29. [Magnetic Fields in Massive Star-forming Regions (MagMaR). VII. On the dynamical importance of B-fields in massive protocluster W33 A](#user-content-link29)
**Authors:** Fengwei Xu (MPIA, PKU), Q. Zhang, P. Sanhueza, K. Wang, Hauyu Baobab Liu, H. Beuther, Wenyu Jiao, C. Wang, P. C. Cort\'es, P. M. Koch, J. M. Girart, M. T. Beltr\'an, J. -W. Wang, J. Liu, F. A. Olguin, Xing Lu, S. Li, Pak Shing Li, T. Liu, K. Morii, J. Hwang, H. -R. V. Chen, S. Jiao, Y. Cheng, Q. Luo, Piyali Saha, Ji-hyun Kang, C. Y. Law, L. K. Dewangan, O. R. Jadhav, E. J. Chung, Chakali Eswaraiah, Luis A. Zapata

30. [HYPERION. The cold ISM of rapidly growing $z>6$ quasars: diverse gas reservoirs, dust enrichment, and feedback signatures](#user-content-link30)
...
31. [The Dynamics of Old Inner Galaxy Stars in Milky Way-mass Galaxies Using FIRE-2 Simulations](#user-content-link31)
**Authors:** Emma Tasso, Madeline Lucey, Robyn Sanderson, Aritra Kundu, Lina Necib

32. [Revisiting Approaches to Stellar White-Light Flare Energy Based on Spatiotemporally Resolved Solar Observations](#user-content-link32)
**Authors:** Yingjie Cai, Yijun Hou, Ting Li, Ying Li, Mingde Ding, Dechao Song, Changwen Zeng, Jifeng Liu

33. [Galaxy-cluster-stacked Fermi-LAT, part IV: $\sim70$ GeV WIMP annihilation lines](#user-content-link33)
**Authors:** Uri Keshet

34. [Deep Learning Segmentation of Spiral Arms and Bars for 600,000 Galaxies in DESI](#user-content-link34)
**Authors:** Ashley Spindler, Mike Walmsley, Karen L. Masters, Tobias G\'eron, Izzy L. Garland, B. D. Simmons, J\"urgen J. Popp

35. [Polarization Signatures of Rotating Black Holes in Perfect Fluid Dark Matter Spacetimes](#user-content-link35)
**Authors:** Yu-Xiang Huang, Sen Guo, En-Wei Liang, Kuan Liu, Kai Lin

36. [The Milky Way as a distant galaxy: an IFU and panchromatic view](#user-content-link36)
**Authors:** Sergey Khoperskov, Alina Boecker, Nikolay Kacharov, Davor Krajnovi\'c, Matthias Steinmetz, Glenn van de Ven, Jakob C. Walcher

37. [The gas kinematics in 70 {\mu}m dark molecular clumps with ammonia](#user-content-link37)
**Authors:** Chao Ou, Shanghuo Li, Junzhi Wang, Yuqiang Li, Shuting Lin, Ian W. Stephens, Qizhou Zhang, Bo Zhang

38. [Galaxy Spiral Arm Count vs. Concentration and Mass: A First Look with Euclid](#user-content-link38)
**Authors:** Beverly J. Smith, Sydnie Bergner, Mark L. Giroux, Curtis Struck

39. [An Analytic Model for Stellar Metallicity Gradient Residuals in Cold, Phase-Mixed Galactic Disks](#user-content-link39)
**Authors:** Shaunak Modak, Zoe Hackshaw, Keith Hawkins

40. [Mapping a Quasar Outflow from Parsec to Kiloparsec Scales: A Combined HST Absorption and VLT Emission Investigation](#user-content-link40)
**Authors:** Mayank Sharma, Travis C. Fischer, Manuela Bischetti, Nahum Arav, Fabrizio Fiore, Chiara Feruglio, Manoj Ghosh

41. [Tomography of the gamma-ray sky from cross-correlation with DESI DR2 and unWISE galaxies](#user-content-link41)
...
42. [Constraining hydrodynamic model of nearby type IIP SN 2023ixf](#user-content-link42)
...
43. [From One to Two: A Second Binary Millisecond Pulsar in the Globular Cluster M92 (NGC 6341)](#user-content-link43)
**Authors:** Dejiang Yin, Li-yun Zhang, Baoda Li, Yinfeng Dai, Lin Wang, Qiuyu Yu, Yujie Lian

44. [Co-evolution of bar and spiral arms in TNG50 simulations using Information Theory](#user-content-link44)
**Authors:** Anagha A G, Arunima Banerjee

45. [Scalable Bayesian data curation for next-generation radio experiments](#user-content-link45)
...
46. [A Universal Physics Defining the Radiation Spectra of Blazars and Gamma-Ray Bursts](#user-content-link46)
**Authors:** Z. Lucas Uhm, Sang-Sung Lee, Bing Zhang, Judith Racusin, Bindu Rani, Myungshin Im, Aeree Chung, Hyung Mok Lee

47. [A Supernova Constraint on F-theory](#user-content-link47)
**Authors:** Sebastian Vander Ploeg Fallon, James Halverson, Liam McAllister, David J. E. Marsh

48. [Multi-band cross-correlation dark sirens: Enhancing cosmological parameter and gravitational-wave bias constraints](#user-content-link48)
**Authors:** Ji-Yu Song, Ya-Nan Du, Yue-Yan Dong, Jing-Fei Zhang, Xin Zhang

49. [The 3D Architecture of a pair of 6:1 Resonant Brown Dwarfs around the Naked-eye star $\nu$ Ophiuchi](#user-content-link49)
...
50. [From Morphology to Variability: Radiative Cooling Effects on Horizon-Scale Polarization in Two-Temperature GRMHD Simulations](#user-content-link50)
**Authors:** Jane SiNan Long, Akhil Uniyal, Mingyuan Zhang, Yosuke Mizuno, Ziri Younsi, Christian M. Fromm, Kinwah Wu

51. [Line-of-sight magnetic-field propagation effects on axion-like particle constraints from GRB 221009A](#user-content-link51)
**Authors:** Chengcheng Han, Zhanhong Lei, Jiajie Yang, Shutong Zhao

52. [Black hole mergers from dense star clusters with realistic binary populations](#user-content-link52)
**Authors:** Christopher E. O'Connor, Kyle Kremer, Saloni Agrawal, Elena Gonz\'alez Prieto, Fulya K{\i}ro\u{g}lu, Maia A. S. Martinez, Claire S. Ye, Frederic A. Rasio

53. [Tidal Stripping of Matter Bound to the Secondary in Extreme Mass-Ratio Inspirals](#user-content-link53)
**Authors:** Sreejith Nair, Sayak Datta

54. [Gamma-Ray Periodicity in Jetted AGN: Revisiting Periodicity Candidates with >17 years of Fermi-LAT Data](#user-content-link54)
**Authors:** P. Pe\~nil, A. Rico, A. Dom\'inguez, M. Ajello, S. Buson, S. Adhikari

55. [Seeing through the dust: Unraveling near-infrared variability in type 2 active galactic nuclei](#user-content-link55)
**Authors:** J. Cer\'on-Meneses, P. Ar\'evalo, P. S\'anchez-S\'aez, W. Yu, P. Lira, B. Milvang-Jensen

56. [Detection of C$_{60}$ Combination Bands in the Near-IR Spectrum of Tc 1](#user-content-link56)
**Authors:** Morgan M. Giese, Vincent J. Esposito, Simon Van Schuylenbergh, Jan Cami, Els Peeters, Charmi Bhatt, Dries Van De Putte, A. G. G. M. Tielens, Michael J. Barlow, Jeronimo Bernard-Salas, Alessandra Candian, Bryan Changala, Nick L. J. Cox, Harriet L. Dinerstein, D. A. Garc\'ia-Hern\'andez, Marco A. G\'omez-Mu\~noz, Kay Justtanont, Kathleen E. Kraemer, Eric Lagadec, Arturo Manchado, Ana Monreal Ibero, Raghvendra Sahai, Ameek Sidhu, G. C. Sloan, N. C. Sterling, Jeremy R. Walsh, Roger Wesson, Joshua Cole Whitman, Albert Zijlstra

57. [LIGO, LISA and Ultralight Axion-like Dark Matter](#user-content-link57)
**Authors:** Lawrence M. Krauss (The Origins Project Foundation)

58. [The limits of lattice inflation: a cautionary tale](#user-content-link58)
**Authors:** Will Barker, Benjamin Gladwyn, Sebastian Zell

59. [Resolving protoplanetary H-alpha emission with the high-resolution spectrograph RISTRETTO](#user-content-link59)
**Authors:** J. W. Blackman, C. Mordasini, G. -D. Marleau, C. Lovis, M. Bugatti, Y. Aoyama, N. Blind

60. [Axiverse Strings Resolved](#user-content-link60)
**Authors:** Rudin Petrossian-Byrne, Giovanni Villadoro

61. [Optical Variability as a Probe of Hidden Nuclear Activity in Type 2 AGNs](#user-content-link61)
**Authors:** Ma\v{s}a Laki\'cevi\'c

62. [\textsc{SPLIT}: a robust semi-coherent inference pipeline for long-inspiral gravitational-wave sources](#user-content-link62)
**Authors:** Shubham Kejriwal

63. [Interactions in the dark sector: intrinsic entropy couplings](#user-content-link63)
**Authors:** Elsa M. Teixeira

64. [Spiking Neural Dedispersion: A Neuromorphic Fast Radio Burst Detection Pipeline](#user-content-link64)
**Authors:** Alessio Magro

65. [Detection of the Earth Tides by Diamagnetic Levitation](#user-content-link65)
**Authors:** Tim M. Fuchs, Elliot Simcox, Michael Hawker, Francis J. Headley, Hendrik Ulbricht

66. [Towards the Detection of Thermal Solar Neutrinos](#user-content-link66)
**Authors:** Carlos A. Arg\"uelles, Christopher V. Cappiello, P. S. Bhupal Dev, Pablo Figueroa, Gonzalo Herrera, Icarus Scoville

67. [Oxygen in the protostellar clump OMC-2 FIR4](#user-content-link67)
**Authors:** Jorma Harju, Paola Caselli, Rolf G\"usten, Helmut Wiesemeyer, Sandra Br\"unken, Marc Mertens, Olli Sipil\"a, J\"urgen Stutzki, Friedrich Wyrowski

68. [Ultraviolet Structure of Real-time Gravitational Wave Linear Response in a Resonant Scalar Field](#user-content-link68)
**Authors:** Han Lai, Atsuhisa Ota

69. [Transfer learning for transient search with small-field optical survey telescopes](#user-content-link69)
**Authors:** Kumar Pranshu, Kuntal Misra, Rithesh A, Jean Surdej, Sarvesh Kumar Yadav

70. [Particle and Gravitational Wave Probes of Minimal Seesaw Neutrinos](#user-content-link70)
**Authors:** Sanjoy Mandal, Rishav Roshan, Jose W. F. Valle

71. [The cosmic tetrarchy: four estimators breaking the assumption degeneracy in cosmological distance tensions](#user-content-link71)
**Authors:** Matteo Martinelli, Domenico Sapone

72. [Cosmological Tensions in a Gauge-Invariant Modified Gravity](#user-content-link72)
**Authors:** Zahra Tabatabaei, Sohrab Rahvar, Shahin Rouhani

73. [Generalized Unimodular Gravity and Cosmological Perturbations](#user-content-link73)
**Authors:** J\'ulio C. Fabris, Alexander Yu. Kamenshchik

74. [Photometric and spectral variability of the candidate post-AGB star IRAS 07506-0345](#user-content-link74)
**Authors:** N. P. Ikonnikova, M. A. Burlak, A. V. Dodin

75. [Minimising magnetic activity effects in PLATO observations: insights from the Sun-as-a-star](#user-content-link75)
**Authors:** J\'er\^ome B\'etrisey, Anne-Marie Broomhall, Sylvain N. Breton, Eva Panetier, Rafael A. Garc\'ia, Henry Davenport, Oleg Kochukhov

76. [A Multimessenger Analysis of the High-Energy Milky Way: Source Populations Contribute Significantly to IceCube's Galactic Neutrino Flux](#user-content-link76)
**Authors:** Alisha Roberts, Ilias Cholis, Dan Hooper, Samyak Jain

77. [Comparison of X-ray Emission Properties of TDEs and Soft Flares from AGNs](#user-content-link77)
**Authors:** Samaresh Mondal, K. Decker French, Jason T. Hinkle

78. [Detection and luminosity-dependent evolution of the high-energy hump in the Be/X-ray pulsar 1A 1118-61](#user-content-link78)
...
79. [Mrk 382: A Narrow-line Seyfert 1 Galaxy with Recurrent X-ray State Transitions](#user-content-link79)
...
80. [Relativistic Accretion Flow in a Generic Class of Spherically Symmetric Static Spacetime](#user-content-link80)
**Authors:** Pradeepkumar Yadav, Sayan Chakrabarti, Santabrata Das

81. [Consistency between X-ray and UV-Optical reverberation measurements in NGC 5548](#user-content-link81)
**Authors:** Amit Kumar Mandal, Bo\.zena Czerny, Michal Dov\v{c}iak, Elias Kammoun, Iossif Papadakis

82. [Inflationary branch decoherence and the cosmological arrow of time](#user-content-link82)
**Authors:** Ali Nayeri

83. [Upconversion Dual-comb Passive Spectroscopy of Mid-IR Incoherent Light](#user-content-link83)
**Authors:** Mingchen Liu, Matthew Heyrich, Sichong Ma, Scott A. Diddams

84. [Graph Neural Networks Trained on Null Signal for Angle Reconstruction in X-ray Polarimetry](#user-content-link84)
**Authors:** Vittorio Latorre (Universtitas Mercatorum, Piazza Mattei 10, 00186 Rome, Italy), Victor Rodriguez-Fernandez (Universidad Politecnica de Madrid, Madrid, Spain), Alessandro Di Marco (INAF-IAPS, Via Fosso Del Cavaliere 100, 00133 Rome, Italy), Fabio La Monaca (INAF-IAPS, Via Fosso Del Cavaliere 100, 00133 Rome, Italy), Fabio Muleri (INAF-IAPS, Via Fosso Del Cavaliere 100, 00133 Rome, Italy), Paolo Soffitta (INAF-IAPS, Via Fosso Del Cavaliere 100, 00133 Rome, Italy)

85. [Axion-Sourced Gravitational Waves in $\mathrm{B\!-\!L}$ Hybrid Inflation](#user-content-link85)
**Authors:** Ahmed Ayad, Shaaban Khalil

86. [Mapping Domain-Wall Bayesian Reconstruction with LISA](#user-content-link86)
**Authors:** Satyabrata Datta, Rome Samanta

87. [Direct Observations of Magnetic Reconnection in the Solar Wind Current Sheets near Mars](#user-content-link87)
...
88. [Benchmarking Exact, GP-Emulated, and Simulation-Based Inference for Late-Time Cosmology](#user-content-link88)
**Authors:** Sai Swagat Mishra

89. [Neural Bayesian Anomaly Mitigation: A Robust Loss that Doubles as an Unsupervised Contamination Classifier](#user-content-link89)
**Authors:** S. A. K. Leeney, W. J. Handley, H. T. J. Bevins, E. de Lera Acedo

90. [Direct High-Resolution Imaging of Earth-like Exoplanets with the Solar Gravitational Lens](#user-content-link90)
**Authors:** Slava G. Turyshev

91. [The Rapid ASKAP Continuum Survey (RACS) VIII: total intensity and circular polarization images and catalogues at 887.5 MHz from RACS-low2](#user-content-link91)
...
92. [Impact of CMB low-$\ell$ EE polarization data on dark energy parameterizations](#user-content-link92)
**Authors:** Shubham Barua, Shantanu Desai

93. [A 1.3 cm spectral line study of the W33 region](#user-content-link93)
...
94. [Investigation of Solar Wind Speed Characteristics Using IPS Observations and the PFSS+SCS Model](#user-content-link94)
**Authors:** Kyogo Tokoro, Munehito Shoda, Shinsuke Imada

95. [Vector Magnetic Field associated with an Active Region Filament Observed by SUNRISE III/SCIP in the Ca II 8542 {\AA} Line](#user-content-link95)
**Authors:** Takuma Matsumoto, Yukio Katsukawa, Masahito Kubo, Yusuke Kawabata, Takayoshi Oba, Ryohtaroh T. Ishikawa, Yoshihiro Naito, Hirohisa Hara, Toshifumi Shimizu, Fumihiro Uraguchi, Toshihiro Tsuduki, Kazuya Shinoda, Tomonori Tamura, Yoshinori Suematsu, Carlos Quintero Noda, Sami K. Solanki, Andreas Lagg, Achim Gandorfer, Jose Carlos Del Toro Iniesta, Pietro Bernasconi, Thomas Berkefeld, Alex Feller, Tino L. Riethm\"uller, Alberto \'Alvarez-Herrero, H. N. Smitha, David Orozco Su\'arez, Bianca Grauf, Michael Carpenter, Alexander Bell, Valent\'in Mart\'inez Pillet, Francisco Javier Bail\'en, Julian Blanco Rodr\'iguez, Juan Sebasti\'an Castellanos Dur\'an, Edvarda Harnes, Johannes H\"olken, Francisco A. Iglesias, Azaymi L. Siu Tapia, Hanna Strecker, Du\v{s}an Vukadinovi\'c, Pablo Santamarina Guerrero, Nour E. Raouafi

96. [Discovery of Unusual Jet Orientation Variations in the Microquasar GRS 1915+105](#user-content-link96)
**Authors:** Xi Yan, Lang Cui, Wu Jiang, Zhen Yan, S\'andor Frey, Sergei Trushkin, Timur Mufakharov, Ruchika Dhaka, Shuangjing Xu

97. [Short Spike, Long Story: Episode-Dependent Shifts of Long-Duration Type-I GRBs on $E_{\rm p,z}$--$E_{\rm iso}$ Plane](#user-content-link97)
**Authors:** Ya-Hui Jiang, Run-Chao Chen, Zhen-Yu Yan, Kamil Nadaf, Xiao-Hong Zhao, Bin-Bin Zhang

98. [Nonlinear Dynamical Regimes of Cosmological Frequency Combs](#user-content-link98)
**Authors:** Madhurendra Mishra, Oem Trivedi, Adarsh Ganesan

99. [Curvature--Radiation Geometries Across the Second CHIME/FRB Fast Radio Burst Population](#user-content-link99)
**Authors:** Thonimar V. Alencar, J\'eferson A. S. Fortunato, Wiliam S. Hip\'olito-Ricaldi

100. [Red Giant Destruction by Stellar and Black Hole Collisions in Galactic Nuclei](#user-content-link100)
**Authors:** Barak Rom, Eliot Quataert

101. [Eccentricity in Disguise? Insights from GW231123 and Numerically Simulated Binary Black Hole Merger Signals](#user-content-link101)
**Authors:** Koustav Chandra, Johann Fernandes, Akshita Mittal, Gregorio Carullo

102. [Cosmological Dynamics of the Thermal Scalar Near the Hagedorn Temperature](#user-content-link102)
**Authors:** Arnab Pradhan, Luis Rufino, Scott Watson

103. [Imaging spectroscopy reveals spike-like repeating radio burst pairs in the solar corona](#user-content-link103)
**Authors:** Suli Ma, Eduard P. Kontar, Daniel L. Clarkson, Huadong Chen, Yihua Yan

104. [Comprehensive Statistical Validation of TOI-7701.01: A Sub-Saturn Companion at the Giant Planet Boundary](#user-content-link104)
**Authors:** Biel Escol\`a-Rodrigo

105. [Revisiting the Lyth bound constraints on inflation from ACT DR6 results](#user-content-link105)
**Authors:** Rui Yang, Jun Tao, Peng Wang, Mian Zhu

106. [Domain walls and magnetic monopoles in Grand Unified Models](#user-content-link106)
**Authors:** Harish Hemming, Tanmay Vachaspati, Anja Wachowitz

107. [The Effect of Anomalous Resistivity on Tearing Instability](#user-content-link107)
**Authors:** D. Tsiklauri

108. [Comparative Analysis of Ellerman and Quiet Sun Ellerman Bombs in the Solar Atmosphere](#user-content-link108)
**Authors:** Ravi Chaurasiya, Ankala Raja Bayanna, Jayant Joshi

109. [Mapping deep-mantle compositional heterogeneity using a directional geoneutrino detector](#user-content-link109)
**Authors:** Zhihao Xu, Misaki Hosoya, William F. McDonough, Taichi Sakai, Hiroko Watanabe

110. [Analytic results for slow-roll curved-space inflation and exponential potentials](#user-content-link110)
**Authors:** Dimitrios Tsimpis, Govind Venugopal

111. [Simultaneous Tricolor Video Observations of Three Tiny Near-Earth Asteroids with Sub-Minute Rotation Periods](#user-content-link111)
**Authors:** Jin Beniyama, Ryou Ohsawa, Shigeyuki Sako, Satoshi Takita, Daisuke Kuroda, Tomohiko Sekiguchi, Keisuke Isogai

112. [Polarity Reversal of the Polar Magnetic Fields in Solar Cycle 25](#user-content-link112)
**Authors:** Li Yin, Yang Shuhong, Zhang Yuzong, Song Qiao, Zhou Guiping, Deng Yuanyong, Wang Jingxiu

113. [Near-Sun Switchbacks Show Statistical Signatures of Solar Activity](#user-content-link113)
**Authors:** Sneha Pandit, Thierry Dudok de Wit, Clara Froment, Durgesh Tripathi, Vishal Upendran, Gabriel Ho Hin Suen

114. [LLM Judges Have Dark Current: A Psychometric Datasheet for LLM-as-a-Judge Evaluation](#user-content-link114)
**Authors:** Hiroyasu Usami, Keisuke Hara, Ayato Tsuboi, Naohiko Matsuda

115. [The capability of CSST in characterizing planetary atmospheres. I. transmission spectroscopy of hot Jupiters](#user-content-link115)
**Authors:** Zibo Liu, Wei Wang, Meng Zhai, Jinpeng Wang, Qinglin Ouyang, Fei Yan, Guo Chen, Dongdong Ni, Yong Zhao, Yujuan Liu, Fei Zhao, Gang Zhao

116. [Shigatse Astronomical Site Testing. I. Cloud-cover Climatology and Selected Local Meteorological Conditions](#user-content-link116)
...
## 1. [The Milky Way's Missing In-Situ Halo](https://arxiv.org/abs/2606.16277) <a id="link1"></a>
...
**Comment:** Strong match to near-field cosmology: focuses on the Milky Way's stellar halo, accreted components, and comparison to cosmological simulations. Directly addresses the assembly history and accreted stellar halo, which are core topics.
...
## 2. [Groups of Dwarf Galaxies in the Local Universe](https://arxiv.org/abs/2606.16299) <a id="link2"></a>
...
**Comment:** This paper presents a systematic search for groups of dwarf galaxies in the local Universe, identifying systems with low-mass centrals and their satellites. It directly addresses near-field cosmology, satellite luminosity functions, and small-scale structure formation, matching the highest relevance criteria.
...
## 3. [Joint Modeling of GD-1 and C-19 as Old Streams](https://arxiv.org/abs/2606.15863) <a id="link3"></a>
...
**Comment:** This paper models the GD-1 and C-19 stellar streams in the Milky Way halo, comparing their properties to CDM and WDM subhalo populations. The focus on stream density power spectra, velocity spread, and implications for dark matter substructure directly matches the 'Near-Field Cosmology' criterion, especially the substructure and core-cusp aspects. The use of cosmological simulations and comparison to observational data further strengthens relevance.
...
## 4. [A Strong Stellar Age-Metallicity Gradient Relation in Nearby Dwarf Galaxies Driven by Stellar Migration and Environmental Quenching](https://arxiv.org/abs/2606.16218) <a id="link4"></a>
...
**Comment:** This paper analyzes stellar metallicity gradients and their relation to stellar age in nearby dwarf galaxies, with a focus on environmental quenching and stellar migration. It directly matches the 'Near-Field Cosmology' and 'Star Formation Quenching' criteria, and also touches on resolved star formation histories and numerical galaxy simulations (FIRE-2).
...
## 5. [TODDLERS 2.0: Stellar feedback and observables across diverse IMFs, binary populations, and cloud environments](https://arxiv.org/abs/2606.15184) <a id="link5"></a>
...
**Comment:** TODDLERS 2.0 models stellar feedback, star formation, and cloud evolution, including stochastic IMF sampling and binary populations. The focus on feedback-driven evolution, fragmentation, and multi-wavelength emission is directly relevant to 'Stellar Models', 'Numerical Galaxy Simulations', and 'Star Formation Driven Outflows' criteria. The tool is designed for galaxy simulations and sub-grid modeling, increasing relevance.
...
## 6. [GridFire: A new, open source, nuclear network for stellar structure and evolution](https://arxiv.org/abs/2606.15354) <a id="link6"></a>
...
**Comment:** This paper presents GridFire, a new open-source nuclear network for stellar structure and evolution. It directly matches the 'Stellar Models' criterion, as it introduces a new tool for stellar evolutionary modeling.
...
## 7. [The impact of the white dwarf initial-final mass relation on star clusters' ages inferred from their cooling sequence](https://arxiv.org/abs/2606.14826) <a id="link7"></a>
...
**Comment:** Directly relevant to stellar models: investigates the impact of the white dwarf initial-final mass relation (IFMR) on cluster age determination, including theoretical and semi-empirical models. This fits the 'Stellar Models' criterion closely.
...
## 8. [Neutrino Constraints on memory-burdened Primordial Black Holes from Dwarf Spheroidal Galaxies](https://arxiv.org/abs/2606.16145) <a id="link8"></a>
...
**Comment:** This paper conducts a search for neutrino signals from primordial black holes using dwarf spheroidal galaxies, directly matching the 'Near-Field Cosmology' criterion. It uses dSphs as targets and discusses their dark matter content and distributions.
...
## 10. [Constraints with CMB lensing on dark matter decays to massive decay products](https://arxiv.org/abs/2606.14849) <a id="link10"></a>
...
**Comment:** This paper investigates decaying dark matter models and their constraints from CMB lensing, with implications for small-scale power suppression and potential relevance to dwarf galaxy anomalies. The mention of addressing dwarf galaxy anomalies links it to near-field cosmology and core-cusp/substructure issues, though the focus is on cosmological constraints rather than direct galaxy observations.
...
## 11. [Probing the fate of large primordial perturbations with exoplanets](https://arxiv.org/abs/2606.14827) <a id="link11"></a>
...
**Comment:** This paper proposes using ultra-wide-orbit exoplanets as probes of small-scale dark matter objects, including ultra-compact minihalos, which may relate to primordial perturbations and substructure. The focus on constraints relevant to dwarf galaxy anomalies and substructure links it to near-field cosmology and core-cusp/substructure issues.
...
## 12. [Simulating winds in the Galactic centre: I. Supernova-driven multiphase outflows and HI cloud acceleration](https://arxiv.org/abs/2606.16553) <a id="link12"></a>
...
**Comment:** Presents high-resolution numerical simulations of supernova-driven multiphase outflows in the Galactic Center, focusing on the launching and properties of HI clouds. While the focus is on the Galactic Center (which is generally excluded), the paper does address star-formation-driven outflows and mass-loading factors, which are relevant criteria, but the context is not dwarf galaxies or satellites.
...
## 13. [KRONOS II: Solar-like Umbra and Penumbra Properties on the Young Sun V1298~Tau](https://arxiv.org/abs/2606.16782) <a id="link13"></a>
...
**Comment:** The paper studies starspot properties on a young Sun-like star using exoplanet transit observations. It leverages stellar atmosphere models and discusses spot substructure, which matches the 'Stellar Models' criterion, though the focus is on a single star rather than model development.
...
## 14. [XP-TEAL: Gaia XP tool for emission and absorption lines. I. Balmer lines in open clusters](https://arxiv.org/abs/2606.16520) <a id="link14"></a>
...
**Comment:** This paper presents a tool for detecting Balmer emission and absorption lines in Gaia XP spectra, focusing on stars in open clusters. It relates to stellar atmosphere models and bolometric corrections, as it extracts line information from spectrophotometry, but does not present new stellar evolutionary tracks or atmosphere models. The method is useful for stellar studies, making it borderline relevant.
...
## 15. [The Edge-on Galaxies in the DESI survey (EGIDE): sample building and photometry](https://arxiv.org/abs/2606.16734) <a id="link15"></a>
...
**Comment:** This paper presents a catalogue of edge-on galaxies from the DESI survey, including photometry, stellar mass, and star formation rates. While it provides a large dataset, the focus is on edge-on galaxies, not specifically on dwarf satellites, resolved star formation histories, or quenching. Some relevance for galaxy structure studies, but not a direct match.
...
## 16. [Intermediate-mass black hole seeding in galactic nuclei from star cluster migration](https://arxiv.org/abs/2606.14852) <a id="link16"></a>
...
**Comment:** This paper models intermediate-mass black hole seeding in galactic nuclei via star cluster migration, using a semi-analytic model. While it involves galaxy formation and star cluster dynamics, the focus is on black hole mergers and nuclear star clusters in galactic nuclei, not on dwarf galaxies, satellite systems, or resolved star formation histories. Only borderline relevance to 'Numerical Galaxy Simulations' criterion.
...
## 17. [Systematic and Statistical Uncertainties in Cepheid PL Relations: Incorporating a Cross-Filter Random-Phase Mitigation Approach](https://arxiv.org/abs/2606.17008) <a id="link17"></a>
...
**Comment:** The paper discusses uncertainties in Cepheid Period-Luminosity relations and introduces a method to mitigate random-phase errors, improving extragalactic distance measurements and H0 precision. While it deals with stellar models and bolometric corrections, the focus is on Cepheid variables and their use in distance measurements, which is tangentially relevant to stellar models but not directly presenting new stellar evolutionary tracks or atmosphere models.
...
## 18. [Centaurus A Inner Lobes -- I. Hydrodynamic modeling of a Precessing Jet](https://arxiv.org/abs/2606.14807) <a id="link18"></a>
...
**Comment:** This paper presents hydrodynamic simulations of precessing jets in Centaurus A, focusing on jet-lobe morphology. While it involves galaxy simulations, the focus is on AGN jets in a massive galaxy, not on dwarf galaxies or galaxy evolution. Only borderline relevance for numerical galaxy simulations.
...
## 19. [Physical characterization of the local system NGC 1313: A flattening in its chemical abundance by past interactions](https://arxiv.org/abs/2606.14860) <a id="link19"></a>
...
**Comment:** This paper studies the physical and kinematical properties of NGC 1313, a low-mass barred spiral galaxy, including its chemical abundance gradient and signs of past interactions. While it discusses minor interactions and chemical evolution, the focus is on a low-mass spiral rather than a dwarf satellite or resolved star formation history. The relevance is borderline due to the focus on a low-mass galaxy and interaction history.
...
## 20. [A Comparative Study of Isothermal Turbulence Statistics: Fourier Space Driving vs. Point Source Driving](https://arxiv.org/abs/2606.14946) <a id="link20"></a>
...
**Comment:** Compares turbulence statistics in simulations using different driving methods, relevant to numerical galaxy simulations and ISM physics. The focus is on turbulence driving diagnostics, which is tangentially relevant to galaxy simulations, but not directly tied to the core topics.
...
## 21. [PEARLS: NuSTAR and XMM-Newton Extragalactic Survey of the JWST North Ecliptic Pole Time Domain Field VI: Multiwavelength SED Analysis](https://arxiv.org/abs/2606.15365) <a id="link21"></a>
...
**Comment:** This paper analyzes X-ray sources in the JWST North Ecliptic Pole field, focusing on AGN accretion rates and star formation rates. While it discusses SFR and quenching in galaxies, the sample is X-ray-selected and dominated by AGN, not dwarf galaxies. Only borderline relevance to 'Star Formation Quenching' criterion.
...
## 22. [Encounters of star clusters as a possible source of disturbances in their internal structure](https://arxiv.org/abs/2606.14833) <a id="link22"></a>
...
**Comment:** The paper investigates past close encounters between star clusters, including the Hyades and Pleiades, and their impact on internal structure. While it touches on historic interactions, it is not focused on dwarf satellite galaxies or near-field cosmology as defined in the criteria.
...
## 23. [The Peculiar Growth of Structure: Validating $f\sigma_8$ Measurements from TITAN Type Ia Supernovae and the Uchuu Simulations](https://arxiv.org/abs/2606.14962) <a id="link23"></a>

**ArXiv ID:** 2606.14962

**Authors:** Mitchell Dixon, David O. Jones, Nicole E. Drakos, Bastien Carreres, Jack W. Tweddle, Yukei S. Murakami, Chris Ashall, Dillon Brout, Thomas de Jaeger, Aaron Do, Elijah G. Marlin, David Rubin, Stephen J. Smartt, Ken W. Smith

**Abstract:** The growth rate of cosmic structure, parameterized by $f\sigma_8$, is a fundamental test of $\Lambda$CDM and general relativity. Using Type Ia supernova (SN Ia) peculiar velocities in conjunction with galaxy redshift surveys may be one of the most precise pathways to measuring $f\sigma_8$ in the local Universe, yet existing analyses have not quantified its systematic uncertainties. Here, we present an end-to-end simulated $f\sigma_8$ measurement tailored to the Type Ia Supernova Trove from ATLAS in the Nearby Universe (TITAN) survey, using ~2000 simulated SNe Ia at $z < 0.067$. We use the Uchuu $N$-body simulations to generate mock galaxy catalogs and SN Ia simulations with realistic, correlated peculiar velocities, and use these catalogs to reconstruct density fields that replicate the 2M++ redshift survey. Using a modified forward likelihood framework across eight mock realizations, we recover $\langle f\sigma_8 \rangle = 0.429 \pm 0.038$ ($\sigma_{\rm stat} = 0.030$, $\sigma_{\rm sys} = 0.023$), consistent with the Uchuu simulation input $f\sigma_8 = 0.428$ to within 0.1%. The mock-to-mock scatter of 0.031 is consistent with our uncertainties, highlighting the reliability of our error estimates. Our measurement is dominated by the statistical uncertainty, with approximately equal contributions from SN Ia ($\sigma_{\rm sys}^{\rm SN}=0.017$) and density reconstruction ($\sigma_{\rm sys}^{\rm recon}=0.016$) systematic uncertainties. The assumed intrinsic scatter model is the largest single systematic contribution, and a different model choice can shift $f\sigma_8$ to lower values, largely driven by red SNe with a skewed color distribution. Our analysis provides the first systematic uncertainty budget for the "reconstruction-and-scaling" method of measuring $f\sigma_8$ with SNe Ia, and demonstrates that SNe Ia are a competitive probe of the growth of structure in the local Universe.

**Comment:** Paper focuses on cosmic structure growth rate using Type Ia supernovae and N-body simulations. While it uses galaxy simulations, the focus is on large-scale structure and not on galaxy-scale simulations or resolved star formation histories.
...
## 24. [The Narrow-Line Seyfert 1 Phenomenon: Accretion State Versus Host Galaxy Properties](https://arxiv.org/abs/2606.16528) <a id="link24"></a>
...
**Comment:** Analyzes the NLS1/BLS1 dichotomy in AGN, focusing on accretion state and host galaxy properties. While it discusses star formation rates and host galaxy evolution, the focus is on AGN and not on dwarf galaxies or resolved star formation histories.
...
## 25. [A HINSA view of cosmic-ray ionization in IC 348 and NGC 1333: evidence for a strong low-energy cosmic-ray disparity](https://arxiv.org/abs/2606.16796) <a id="link25"></a>
...
**Comment:** Studies cosmic-ray ionization rates in low-mass star-forming clouds, focusing on local acceleration sources. While it discusses star formation regions, it does not address resolved star formation histories or galaxy-scale simulations.
...
## 26. [COSMOS-Web: A Multi-wavelength Morphological Catalog of ~780,000 Galaxies](https://arxiv.org/abs/2606.14869) <a id="link26"></a>

**ArXiv ID:** 2606.14869

**Authors:** Lilan Yang, Jeyhan S. Kartaltepe, Nicole E. Drakos, Andreas L. Faisst, Carter Flayhart, Maximilien Franco, Anton M. Koekemoer, Olivier Ilbert, Hollis B. Akins, Caitlin M. Casey, Xuheng Ding, Ali Hadi, Santosh Harish, Ronaldo Laishram, Daizhong Liu, Georgios E. Magdis, Felix Martinez III, Henry Joy McCracken, Louise Paquereau, Jason Rhodes, Brant E. Robertson, Marko Shuntov, Greta Toni

**Abstract:** We present multi-wavelength morphological measurements for all galaxies in the COSMOS-Web survey, i.e., $\sim$780,000 galaxies contained in the COSMOS2025 catalog. We perform both parametric (e.g., single and double S\'ersic modeling) and non-parametric (e.g., Gini-$M_{20}$) morphology analyses in four NIRCam bands, independently. Our parametric fits reveal a strong correlation between galaxy structure and star formation activity up to $z\sim4$, as evidenced by the dependence of the S\'ersic index ($n_{\rm s\'ersic}$) and bulge-to-total ratio ($B/T$) on the position of the star formation rate-stellar mass plane. A tight correlation between $n_{\rm s\'ersic}$ and $B/T$ is observed. The evolution of $n_{\rm s\'ersic}$ and $B/T$ depends on stellar mass; for example, the median $n_{\rm s\'ersic}$ increases from $\sim1$ at $z\sim6$ to $\sim2.5$ at $z\sim2$ for massive galaxies with $M_*>10^{10.5} M_{\odot}$, while lower mass galaxies remain $n_{\rm s\'ersic}\sim1.2$ at all epochs. The UV $n_{\rm s\'ersic}$ values are systematically smaller than those in the optical, although both exhibit similar evolutionary trends. From non-parametric analyses, we demonstrate the distribution of galaxies on the Gini-$M_{20}$ and asymmetry-concentration planes, and find that morphological classifications based on non-parametric indicators are consistent with those derived from the S\'ersic index. The resulting catalog provides the largest and most detailed set of JWST multi-wavelength morphological measurements to date, serving as a valuable community resource for studies of structural transformation, bulge growth, and galaxy-supermassive black hole coevolution across cosmic time.

**Comment:** This paper presents a large morphological catalog of galaxies from COSMOS-Web, including structural measurements and star formation activity correlations. While it provides valuable data for galaxy evolution, it does not focus on resolved star formation histories from color-magnitude diagrams, dwarf galaxies, or satellite quenching.
...
## 29. [Magnetic Fields in Massive Star-forming Regions (MagMaR). VII. On the dynamical importance of B-fields in massive protocluster W33 A](https://arxiv.org/abs/2606.16915) <a id="link29"></a>
...
**Comment:** This paper presents ALMA polarization observations of a massive star-forming region, focusing on magnetic fields, turbulence, and accretion in high-mass protoclusters. While it discusses star formation and feedback, the focus is on massive star formation, not dwarf galaxies or galaxy-scale outflows. It does not match the resolved star formation histories, quenching, or numerical galaxy simulations criteria.
...
## 30. [HYPERION. The cold ISM of rapidly growing $z>6$ quasars: diverse gas reservoirs, dust enrichment, and feedback signatures](https://arxiv.org/abs/2606.16012) <a id="link30"></a>
...
**Comment:** The paper investigates the cold ISM, gas reservoirs, dust enrichment, and feedback signatures in z>6 quasars using ALMA observations. The focus is on high-redshift, massive quasar hosts and their ISM properties, not dwarf galaxies or near-field cosmology. While it discusses star formation and feedback, the galaxies are much more massive than the LMC, making it only tangentially relevant.
...
## 31. [The Dynamics of Old Inner Galaxy Stars in Milky Way-mass Galaxies Using FIRE-2 Simulations](https://arxiv.org/abs/2606.16079) <a id="link31"></a>
...
**Comment:** This paper analyzes the kinematics and origins of old inner galaxy stars in Milky Way-mass galaxies using FIRE-2 simulations. The focus is on the inner galaxy (r < 5 kpc), not on satellite galaxies, resolved star formation histories, or quenching in dwarfs. Only tangential relevance to 'Numerical Galaxy Simulations' criterion, but not directly matching core topics.
...
## 32. [Revisiting Approaches to Stellar White-Light Flare Energy Based on Spatiotemporally Resolved Solar Observations](https://arxiv.org/abs/2606.15913) <a id="link32"></a>
...
**Comment:** The paper discusses bolometric energy estimation for solar and stellar white-light flares, including methods for evolving flare area and temperature. While it touches on stellar atmosphere modeling, it does not present new stellar models or evolutionary tracks, nor does it address galaxy evolution or resolved star formation histories.
...
## 33. [Galaxy-cluster-stacked Fermi-LAT, part IV: $\sim70$ GeV WIMP annihilation lines](https://arxiv.org/abs/2606.17044) <a id="link33"></a>
...
**Comment:** This paper analyzes stacked Fermi-LAT data for galaxy clusters to search for WIMP annihilation lines. While it deals with dark matter and galaxy clusters, it does not focus on dwarf galaxies, satellite systems, or near-field cosmology. Galaxy clusters are outside the mass range of interest.
...
## 34. [Deep Learning Segmentation of Spiral Arms and Bars for 600,000 Galaxies in DESI](https://arxiv.org/abs/2606.16507) <a id="link34"></a>
...
**Comment:** This paper presents deep learning segmentation of spiral arms and bars in galaxies from DESI. While it is a large-scale morphological study, it focuses on spiral arms and bars, which are specifically listed as irrelevant in the criteria. It does not address satellite galaxies, dwarf galaxies, or star formation histories.
...
## 35. [Polarization Signatures of Rotating Black Holes in Perfect Fluid Dark Matter Spacetimes](https://arxiv.org/abs/2606.14736) <a id="link35"></a>
...
**Comment:** Investigates polarization signatures of rotating black holes in dark matter spacetimes, motivated by EHT observations. While it mentions dark matter, the focus is on black hole environments, not galaxy-scale dark matter profiles or near-field cosmology.
...
## 36. [The Milky Way as a distant galaxy: an IFU and panchromatic view](https://arxiv.org/abs/2606.14973) <a id="link36"></a>
...
**Comment:** This paper models the Milky Way as an external galaxy using IFU and radiative transfer techniques. The focus is on the MW's disk, bar, and bulge, not on satellite galaxies, resolved star formation histories, or near-field cosmology. It does not match any core criteria.
...
## 37. [The gas kinematics in 70 {\mu}m dark molecular clumps with ammonia](https://arxiv.org/abs/2606.16355) <a id="link37"></a>
...
**Comment:** The paper studies gas kinematics in dense cores within infrared dark clouds, focusing on early star formation and collapse. While it involves star formation, it is at the scale of molecular clumps and not galaxies, and does not address resolved star formation histories or galaxy-scale quenching.
...
## 38. [Galaxy Spiral Arm Count vs. Concentration and Mass: A First Look with Euclid](https://arxiv.org/abs/2606.14896) <a id="link38"></a>
...
**Comment:** This paper analyzes spiral arm counts, concentration, and mass in galaxies using Euclid data. It discusses spiral structure and star formation rates, but focuses on more massive spiral galaxies and not dwarfs or satellite galaxies. No direct match to core criteria.
...
## 39. [An Analytic Model for Stellar Metallicity Gradient Residuals in Cold, Phase-Mixed Galactic Disks](https://arxiv.org/abs/2606.14850) <a id="link39"></a>
...
**Comment:** Analytic model for metallicity gradient residuals in galactic disks, applied to the Galactic thin disk. Focus is on disk properties and radial migration, not on satellite galaxies, resolved star formation histories, or dwarf galaxy quenching.
...
## 40. [Mapping a Quasar Outflow from Parsec to Kiloparsec Scales: A Combined HST Absorption and VLT Emission Investigation](https://arxiv.org/abs/2606.16967) <a id="link40"></a>
...
**Comment:** The paper investigates quasar-driven outflows from parsec to kiloparsec scales, focusing on AGN feedback. While it discusses mass-loading and outflow kinematics, the outflows are AGN-driven, not star-formation-driven, and the host is a quasar, not a dwarf galaxy. Only tangential relevance to the 'Star Formation Driven Outflows' criterion.
...
## 42. [Constraining hydrodynamic model of nearby type IIP SN 2023ixf](https://arxiv.org/abs/2606.15395) <a id="link42"></a>
...
**Comment:** Hydrodynamic modeling of a nearby Type IIP supernova, focusing on explosion parameters and circumstellar matter. While it involves stellar evolution and hydrodynamics, it does not present new stellar models or address galaxy-scale phenomena.
...
## 43. [From One to Two: A Second Binary Millisecond Pulsar in the Globular Cluster M92 (NGC 6341)](https://arxiv.org/abs/2606.15639) <a id="link43"></a>
...
**Comment:** Discovery and timing of a binary millisecond pulsar in a globular cluster, with implications for cluster dynamics. While it provides dynamical information, it is not focused on dwarf galaxies, galaxy simulations, or star formation histories.
...
## 44. [Co-evolution of bar and spiral arms in TNG50 simulations using Information Theory](https://arxiv.org/abs/2606.16403) <a id="link44"></a>
...
**Comment:** The paper analyzes the co-evolution of bars and spiral arms in galaxies using TNG50 simulations. The focus is on bar and spiral arm dynamics, which are specifically listed as irrelevant. The work does use numerical galaxy simulations, but the topic is outside the core interests.
...
## 45. [Scalable Bayesian data curation for next-generation radio experiments](https://arxiv.org/abs/2606.16525) <a id="link45"></a>
...
**Comment:** Presents a Bayesian anomaly-detection method for radio data curation, demonstrated on cosmic hydrogen experiments. While relevant to radio astronomy infrastructure, it does not address any of the core topics such as galaxy simulations or star formation histories.
...
## 46. [A Universal Physics Defining the Radiation Spectra of Blazars and Gamma-Ray Bursts](https://arxiv.org/abs/2606.15759) <a id="link46"></a>
...
**Comment:** Discusses universal physics in radiation spectra of blazars and gamma-ray bursts, focusing on cooling physics. Does not address any of the core topics such as galaxy simulations, star formation histories, or dwarf galaxies.
...
## 47. [A Supernova Constraint on F-theory](https://arxiv.org/abs/2606.14575) <a id="link47"></a>
...
**Comment:** The paper discusses constraints on the QCD axion in F-theory, relating to string theory and supernova observations. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 48. [Multi-band cross-correlation dark sirens: Enhancing cosmological parameter and gravitational-wave bias constraints](https://arxiv.org/abs/2606.15844) <a id="link48"></a>
...
**Comment:** This paper discusses multi-band gravitational-wave observations for cosmological parameter constraints and GW bias measurements. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 50. [From Morphology to Variability: Radiative Cooling Effects on Horizon-Scale Polarization in Two-Temperature GRMHD Simulations](https://arxiv.org/abs/2606.16818) <a id="link50"></a>
...
**Comment:** Studies polarization in GRMHD simulations of black hole accretion flows, focusing on radiative cooling effects. This is not directly relevant to galaxy simulations or any of the core topics.
...
## 51. [Line-of-sight magnetic-field propagation effects on axion-like particle constraints from GRB 221009A](https://arxiv.org/abs/2606.15269) <a id="link51"></a>
...
**Comment:** Examines axion-like particle constraints from GRB observations, focusing on magnetic field propagation effects. Does not address any of the core topics such as galaxy simulations, star formation histories, or dwarf galaxies.
...
## 52. [Black hole mergers from dense star clusters with realistic binary populations](https://arxiv.org/abs/2606.14846) <a id="link52"></a>
...
**Comment:** This paper focuses on black hole mergers in dense star clusters, using updated input physics and realistic binary populations. While it involves numerical simulations and stellar populations, it does not focus on galaxy-scale simulations, dwarf galaxies, or near-field cosmology. The relevance to core topics is low.
...
## 53. [Tidal Stripping of Matter Bound to the Secondary in Extreme Mass-Ratio Inspirals](https://arxiv.org/abs/2606.14894) <a id="link53"></a>
...
**Comment:** The paper studies tidal stripping of matter bound to the secondary in extreme mass-ratio inspirals, focusing on gravitational wave signals and environmental effects. It does not address galaxy-scale phenomena or any of the core criteria.
...
## 54. [Gamma-Ray Periodicity in Jetted AGN: Revisiting Periodicity Candidates with >17 years of Fermi-LAT Data](https://arxiv.org/abs/2606.15676) <a id="link54"></a>
...
**Comment:** The paper reanalyzes gamma-ray periodicity in jetted AGN using Fermi-LAT data. The focus is on AGN variability and periodicity, not on galaxy-scale phenomena or any of the core criteria.
...
## 55. [Seeing through the dust: Unraveling near-infrared variability in type 2 active galactic nuclei](https://arxiv.org/abs/2606.15016) <a id="link55"></a>
...
**Comment:** This paper studies near-infrared variability in type 2 AGN, focusing on variability diagnostics and classification. The focus is on AGN and not on galaxy-scale phenomena or any of the core criteria.
...
## 56. [Detection of C$_{60}$ Combination Bands in the Near-IR Spectrum of Tc 1](https://arxiv.org/abs/2606.16928) <a id="link56"></a>
...
**Comment:** Detection of C60 combination bands in a planetary nebula, focusing on molecular astrophysics. This is not relevant to the core topics (no connection to galaxy evolution, star formation histories, or galaxy simulations).
...
## 57. [LIGO, LISA and Ultralight Axion-like Dark Matter](https://arxiv.org/abs/2606.16099) <a id="link57"></a>

**ArXiv ID:** 2606.16099

**Authors:** Lawrence M. Krauss (The Origins Project Foundation)

**Abstract:** A coherent cosmic background of axion-like particles (ALPs) coupled to photons can produce a small periodic differential phase or polarization modulation for photons traversing separate arms in gravitational wave interferometers, peaked at a frequency associated with the particle mass, and suppressed whenever the dark-matter coherence length $\lambda_{\rm coh}$ exceeds the arm length~$L$. For the LIGO audio frequency band the sensitivity to cosmic ALPs is below current bounds. For LISA, however, the natural mass range $m_a \sim 4\times10^{-19}$--$4\times10^{-16}$~eV -- corresponding to a sideband frequency in LISA's science band of $0.1$~mHz--$0.1$~Hz -- may be observable. A 1-year shot-noise-limited search projects a sensitivity $g_{a\gamma\gamma} \lesssim 5\times 10^{-14}$~GeV$^{-1}$ across most of the band, reaching $\sim 7\times 10^{-15}$~GeV$^{-1}$ near $0.1$~Hz, which is $10^{3}$--$10^{4}$ below the CAST helioscope bound. An RF heterodyne photodetection upgrade -- to either detector -- might extend the search sensitivity to $g_{a\gamma\gamma}\sim 6.5\times 10^{-14}$~GeV$^{-1}$ at $m_a\sim 3\times 10^{-7}$~eV for LIGO and $g_{a\gamma\gamma}\sim 3.3\times 10^{-17}$~GeV$^{-1}$ at $m_a\sim 5\times 10^{-13}$~eV for LISA. Dark-matter substructure can affect the signal in a several interesting ways.

**Comment:** Explores the detectability of ultralight axion-like dark matter using gravitational wave interferometers, focusing on particle physics and dark matter detection, not galaxy evolution or near-field cosmology.
...
## 59. [Resolving protoplanetary H-alpha emission with the high-resolution spectrograph RISTRETTO](https://arxiv.org/abs/2606.14844) <a id="link59"></a>
...
**Comment:** This paper discusses resolving protoplanetary H-alpha emission with a new spectrograph, focusing on planet formation and accretion shocks. It does not address galaxy evolution, dwarf galaxies, or stellar models.
...
## 60. [Axiverse Strings Resolved](https://arxiv.org/abs/2606.15957) <a id="link60"></a>
...
**Comment:** The paper discusses axiverse cosmic strings and their resolution in string theory, focusing on cosmological implications. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 61. [Optical Variability as a Probe of Hidden Nuclear Activity in Type 2 AGNs](https://arxiv.org/abs/2606.16343) <a id="link61"></a>
...
**Comment:** The paper studies optical variability in Type 2 AGNs as a probe of hidden nuclear activity. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 63. [Interactions in the dark sector: intrinsic entropy couplings](https://arxiv.org/abs/2606.16574) <a id="link63"></a>

**ArXiv ID:** 2606.16574

**Authors:** Elsa M. Teixeira

**Abstract:** We present a new class of interacting dark sector models in which the intrinsic entropy of a dark matter fluid couples to a scalar field describing dark energy. These interactions are constructed within a covariant Lagrangian framework, including algebraic and derivative entropy couplings, effectively leading to pure momentum exchange in the dark sector. A key feature is that the background cosmology remains unchanged and therefore indistinguishable from $\Lambda$CDM or uncoupled quintessence. However, at the level of the linear perturbations, the dark matter Euler equation exhibits scale-dependent contributions, while the continuity equation is unmodified. We show that these classes of models are compatible with current CMB constraints and can potentially produce observable signatures in large-scale structure.

**Comment:** This paper presents new models for dark sector interactions in cosmology, focusing on entropy couplings and their effects on linear perturbations and large-scale structure. It does not match any of the core criteria (near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 64. [Spiking Neural Dedispersion: A Neuromorphic Fast Radio Burst Detection Pipeline](https://arxiv.org/abs/2606.15361) <a id="link64"></a>
...
**Comment:** This paper presents a neuromorphic pipeline for fast radio burst detection, which is unrelated to the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 65. [Detection of the Earth Tides by Diamagnetic Levitation](https://arxiv.org/abs/2606.14738) <a id="link65"></a>
...
**Comment:** This paper presents a new gravimeter for geophysical applications, focusing on Earth tides and mass distribution mapping. It does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 66. [Towards the Detection of Thermal Solar Neutrinos](https://arxiv.org/abs/2606.15904) <a id="link66"></a>
...
**Comment:** This paper discusses detection of thermal solar neutrinos and implications for stellar physics, but does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 67. [Oxygen in the protostellar clump OMC-2 FIR4](https://arxiv.org/abs/2606.16833) <a id="link67"></a>
...
**Comment:** This paper studies oxygen and related molecules in a protostellar clump in Orion, focusing on shock chemistry and outflows. The topic is star formation and ISM chemistry in a protostellar region, not galaxy-scale outflows or dwarf galaxy CGM.
...
## 68. [Ultraviolet Structure of Real-time Gravitational Wave Linear Response in a Resonant Scalar Field](https://arxiv.org/abs/2606.16296) <a id="link68"></a>
...
**Comment:** This paper focuses on gravitational wave linear response in a resonant scalar field, with emphasis on quantum field theory and renormalization. No direct connection to near-field cosmology, galaxy simulations, or stellar models.
...
## 69. [Transfer learning for transient search with small-field optical survey telescopes](https://arxiv.org/abs/2606.15705) <a id="link69"></a>
...
**Comment:** Focuses on machine learning for transient detection in optical surveys. No direct connection to resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 70. [Particle and Gravitational Wave Probes of Minimal Seesaw Neutrinos](https://arxiv.org/abs/2606.15316) <a id="link70"></a>
...
**Comment:** Explores gravitational waves and particle physics signatures in the context of minimal seesaw neutrinos and early-universe cosmology. No direct relevance to galaxy simulations, near-field cosmology, or stellar models.
...
## 71. [The cosmic tetrarchy: four estimators breaking the assumption degeneracy in cosmological distance tensions](https://arxiv.org/abs/2606.16844) <a id="link71"></a>
...
**Comment:** Paper addresses cosmological distance tensions using BAO, SNIa, and cosmic chronometers. No direct relevance to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 72. [Cosmological Tensions in a Gauge-Invariant Modified Gravity](https://arxiv.org/abs/2606.14968) <a id="link72"></a>
...
**Comment:** This paper discusses a gauge-invariant modified gravity model and its cosmological implications, focusing on tensions between early and late universe constraints. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 73. [Generalized Unimodular Gravity and Cosmological Perturbations](https://arxiv.org/abs/2606.16378) <a id="link73"></a>
...
**Comment:** This paper revisits generalized unimodular gravity and its cosmological consequences, focusing on the dark sector and perturbations. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 74. [Photometric and spectral variability of the candidate post-AGB star IRAS 07506-0345](https://arxiv.org/abs/2606.15660) <a id="link74"></a>
...
**Comment:** This paper reports photometric and spectroscopic observations of a post-AGB star, focusing on variability and classification. It does not address any of the core topics such as galaxy-scale phenomena, star formation histories, or galaxy simulations.
...
## 75. [Minimising magnetic activity effects in PLATO observations: insights from the Sun-as-a-star](https://arxiv.org/abs/2606.16450) <a id="link75"></a>
...
**Comment:** This paper analyzes magnetic activity effects in solar-type stars and their impact on seismic inferences, which is not directly relevant to the core topics (no connection to galaxy evolution, dwarf galaxies, or stellar models for populations).
...
## 76. [A Multimessenger Analysis of the High-Energy Milky Way: Source Populations Contribute Significantly to IceCube's Galactic Neutrino Flux](https://arxiv.org/abs/2606.14848) <a id="link76"></a>
...
**Comment:** This paper focuses on high-energy neutrino and gamma-ray emission from the Galactic Plane, analyzing source populations and cosmic-ray transport. It does not address near-field cosmology, dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, or outflows. The focus is on the Milky Way's disk and cosmic-ray sources, which are specifically listed as irrelevant.
...
## 78. [Detection and luminosity-dependent evolution of the high-energy hump in the Be/X-ray pulsar 1A 1118-61](https://arxiv.org/abs/2606.16805) <a id="link78"></a>
...
**Comment:** The paper studies luminosity-dependent spectral evolution in a Be/X-ray pulsar, focusing on accretion and spectral morphology. It does not address galaxy evolution, dwarf galaxies, or stellar models.
...
## 79. [Mrk 382: A Narrow-line Seyfert 1 Galaxy with Recurrent X-ray State Transitions](https://arxiv.org/abs/2606.15674) <a id="link79"></a>
...
**Comment:** The paper discusses X-ray state transitions in a Seyfert galaxy, focusing on AGN variability and coronal geometry. It does not address galaxy evolution, dwarf galaxies, or stellar models.
...
## 80. [Relativistic Accretion Flow in a Generic Class of Spherically Symmetric Static Spacetime](https://arxiv.org/abs/2606.15143) <a id="link80"></a>

**ArXiv ID:** 2606.15143

**Authors:** Pradeepkumar Yadav, Sayan Chakrabarti, Santabrata Das

**Abstract:** We investigate the properties of low angular momentum, inviscid, advective accretion flows in a generic static and spherically symmetric spacetime that incorporates higher-order corrections up to the fourth order in $1/r$. Employing this metric, we self-consistently solve the relativistic hydrodynamical equations and obtain the family of global transonic accretion solutions ($O$, $A$, $W$ and $I$-types) by means of the spacetime parameters ($\delta$, $\eta$, $\beta$) and the flow parameters (specific energy $\mathscr{E}$ and angular momentum $\lambda$). Our analysis reveals that the accretion flow possesses either single or multiple critical points depending on these input parameters. We delineate the regions of the $\delta-\lambda$ and $\lambda-\mathscr{E}$ parameter spaces that admits solutions with multiple critical points and demonstrate how these regions evolve with increasing spacetime parameter $\delta$. Furthermore, while connecting the spacetime geometry with observable signatures, we compute the spectral energy distribution (SED) from thermal bremsstrahlung emission and observe that increasing $\delta$ enhances the SED relative to the Schwarzschild case. Finally, we find that global transonic solutions harbouring inner critical points ($I$-types) yields more luminous power than those with only outer critical points ($O$ and $A$ types).

**Comment:** The paper investigates relativistic accretion flows in spherically symmetric spacetimes, focusing on accretion physics and spectral energy distributions. It does not address galaxy evolution, dwarf galaxies, or stellar models.
...
## 81. [Consistency between X-ray and UV-Optical reverberation measurements in NGC 5548](https://arxiv.org/abs/2606.15406) <a id="link81"></a>
...
**Comment:** The paper examines X-ray and UV-optical reverberation mapping in an AGN, focusing on corona height and variability. It does not address galaxy evolution, dwarf galaxies, or stellar models.
...
## 82. [Inflationary branch decoherence and the cosmological arrow of time](https://arxiv.org/abs/2602.21263) <a id="link82"></a>
...
**Comment:** This is a theoretical cosmology paper about quantum decoherence in inflationary cosmology. It does not address near-field cosmology, galaxy evolution, or any of the core topics.
...
## 83. [Upconversion Dual-comb Passive Spectroscopy of Mid-IR Incoherent Light](https://arxiv.org/abs/2606.14744) <a id="link83"></a>
...
**Comment:** This paper introduces a spectroscopy technique for mid-IR incoherent light. It is instrumentation-focused and not related to galaxy evolution, near-field cosmology, or any core criteria.
...
## 84. [Graph Neural Networks Trained on Null Signal for Angle Reconstruction in X-ray Polarimetry](https://arxiv.org/abs/2606.16922) <a id="link84"></a>
...
**Comment:** The paper presents a machine learning approach for X-ray polarimetry signal reconstruction. It is focused on detector technology and signal processing, not galaxy simulations, star formation, or near-field cosmology.
...
## 85. [Axion-Sourced Gravitational Waves in $\mathrm{B\!-\!L}$ Hybrid Inflation](https://arxiv.org/abs/2606.15961) <a id="link85"></a>
...
**Comment:** This paper discusses axion-sourced gravitational waves in B-L hybrid inflation, focusing on early universe physics and gravitational wave signals. It does not address galaxy-scale phenomena or any of the core criteria.
...
## 87. [Direct Observations of Magnetic Reconnection in the Solar Wind Current Sheets near Mars](https://arxiv.org/abs/2606.16105) <a id="link87"></a>
...
**Comment:** The paper reports direct observations of magnetic reconnection in solar wind current sheets near Mars. The focus is on solar wind and plasma physics, not on galaxy-scale phenomena or any of the core criteria.
...
## 88. [Benchmarking Exact, GP-Emulated, and Simulation-Based Inference for Late-Time Cosmology](https://arxiv.org/abs/2606.16248) <a id="link88"></a>
...
**Comment:** This paper benchmarks inference methods for late-time cosmology using large-scale structure and expansion history datasets. It does not match any of the core criteria (near-field cosmology, star formation histories, galaxy simulations, etc.).
...
## 89. [Neural Bayesian Anomaly Mitigation: A Robust Loss that Doubles as an Unsupervised Contamination Classifier](https://arxiv.org/abs/2606.16524) <a id="link89"></a>
...
**Comment:** This paper introduces a robust loss function for supervised models, with applications to contamination classification in machine learning. It is not related to astrophysics or any of the core topics.
...
## 90. [Direct High-Resolution Imaging of Earth-like Exoplanets with the Solar Gravitational Lens](https://arxiv.org/abs/2606.14899) <a id="link90"></a>
...
**Comment:** This paper focuses on high-resolution imaging of exoplanets using the solar gravitational lens. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, stellar models, or galaxy simulations.
...
## 91. [The Rapid ASKAP Continuum Survey (RACS) VIII: total intensity and circular polarization images and catalogues at 887.5 MHz from RACS-low2](https://arxiv.org/abs/2606.16182) <a id="link91"></a>
...
**Comment:** This is a radio survey data release, providing catalogues of sources including radio stars, pulsars, and AGN. While large surveys can be useful for galaxy studies, this paper does not focus on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No direct match to any core criteria.
...
## 93. [A 1.3 cm spectral line study of the W33 region](https://arxiv.org/abs/2606.16220) <a id="link93"></a>
...
**Comment:** Spectral line study of W33 region, a massive star-forming region. No direct relevance to dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 94. [Investigation of Solar Wind Speed Characteristics Using IPS Observations and the PFSS+SCS Model](https://arxiv.org/abs/2606.16279) <a id="link94"></a>
...
**Comment:** Focuses on solar wind speed and coronal magnetic field using IPS observations and models. Not relevant to any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 95. [Vector Magnetic Field associated with an Active Region Filament Observed by SUNRISE III/SCIP in the Ca II 8542 {\AA} Line](https://arxiv.org/abs/2606.16088) <a id="link95"></a>

**ArXiv ID:** 2606.16088

**Authors:** Takuma Matsumoto, Yukio Katsukawa, Masahito Kubo, Yusuke Kawabata, Takayoshi Oba, Ryohtaroh T. Ishikawa, Yoshihiro Naito, Hirohisa Hara, Toshifumi Shimizu, Fumihiro Uraguchi, Toshihiro Tsuduki, Kazuya Shinoda, Tomonori Tamura, Yoshinori Suematsu, Carlos Quintero Noda, Sami K. Solanki, Andreas Lagg, Achim Gandorfer, Jose Carlos Del Toro Iniesta, Pietro Bernasconi, Thomas Berkefeld, Alex Feller, Tino L. Riethm\"uller, Alberto \'Alvarez-Herrero, H. N. Smitha, David Orozco Su\'arez, Bianca Grauf, Michael Carpenter, Alexander Bell, Valent\'in Mart\'inez Pillet, Francisco Javier Bail\'en, Julian Blanco Rodr\'iguez, Juan Sebasti\'an Castellanos Dur\'an, Edvarda Harnes, Johannes H\"olken, Francisco A. Iglesias, Azaymi L. Siu Tapia, Hanna Strecker, Du\v{s}an Vukadinovi\'c, Pablo Santamarina Guerrero, Nour E. Raouafi

**Abstract:** We report high-spatial-resolution spectropolarimetric observations spatially associated with a solar filament, obtained with the SUNRISE Chromospheric Infrared spectro-Polarimeter (SCIP) onboard the SUNRISE III balloon-borne solar observatory on 15 July 2024. The observed filament was located near the solar disk center, adjacent to an active region, and remained quiescent for at least two hours during the observing period. SCIP recorded full Stokes profiles in the Ca II 8542 {\AA} line, revealing clear signatures of linear polarization produced by the transverse Zeeman effect. The detected linear polarization signals within the filament region exceeded the 2$\sigma$ noise level and exhibited a characteristic Zeeman double-lobe spectral shape that distinguishes them from polarization due to scattering. The magnetic field strength derived using the weak field approximation is approximately -80 G along the line of sight and 300-500 G in the transverse direction. These values likely reflect the magnetic properties of the filament and its supporting chromospheric environment. The orientation of the magnetic field vector is nearly parallel to the filament axis in its northeastern portion, while the southeastern part of the filament extends outside the field of view. To our knowledge, this is the first unambiguous detection of linear polarization associated with a solar filament with the Ca II 8542 {\AA} line. Our results open a new diagnostic window on the vector magnetic structure of solar filaments in the lower chromosphere, complementing existing He I based diagnostics that probe the upper chromosphere.

**Comment:** This paper presents spectropolarimetric observations of a solar filament, focusing on magnetic field measurements in the chromosphere. It is solar physics and does not relate to any of the core galaxy or near-field cosmology criteria.
...
## 96. [Discovery of Unusual Jet Orientation Variations in the Microquasar GRS 1915+105](https://arxiv.org/abs/2606.16228) <a id="link96"></a>
...
**Comment:** This paper studies jet orientation variations in a microquasar (GRS 1915+105), focusing on accretion disk and jet physics. It does not relate to galaxy-scale processes or any of the core criteria.
...
## 97. [Short Spike, Long Story: Episode-Dependent Shifts of Long-Duration Type-I GRBs on $E_{\rm p,z}$--$E_{\rm iso}$ Plane](https://arxiv.org/abs/2606.15098) <a id="link97"></a>
...
**Comment:** This paper analyzes gamma-ray bursts (GRBs), focusing on classification and spectral properties. GRBs are not related to the core topics of near-field cosmology, galaxy evolution, or stellar models.
...
## 98. [Nonlinear Dynamical Regimes of Cosmological Frequency Combs](https://arxiv.org/abs/2606.16227) <a id="link98"></a>
...
**Comment:** The paper studies nonlinear dynamical regimes in cosmological frequency combs within quintessence cosmology. It is theoretical cosmology and does not address galaxy-scale phenomena, resolved star formation histories, or near-field cosmology. No direct match to any criteria.
...
## 100. [Red Giant Destruction by Stellar and Black Hole Collisions in Galactic Nuclei](https://arxiv.org/abs/2606.14843) <a id="link100"></a>
...
**Comment:** Studies red giant destruction in galactic nuclei, focusing on collisions in the Galactic Center and massive black holes. The focus is on high-mass environments and the Galactic Center, which is explicitly excluded from the relevant criteria.
...
## 102. [Cosmological Dynamics of the Thermal Scalar Near the Hagedorn Temperature](https://arxiv.org/abs/2606.13611) <a id="link102"></a>
...
**Comment:** The paper studies the cosmological dynamics of the thermal scalar near the Hagedorn temperature in string cosmology. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 103. [Imaging spectroscopy reveals spike-like repeating radio burst pairs in the solar corona](https://arxiv.org/abs/2605.23484) <a id="link103"></a>
...
**Comment:** This paper analyzes solar radio bursts and coronal plasma dynamics. It is unrelated to the core criteria (galaxy evolution, star formation, near-field cosmology, etc.).
...
## 104. [Comprehensive Statistical Validation of TOI-7701.01: A Sub-Saturn Companion at the Giant Planet Boundary](https://arxiv.org/abs/2606.15430) <a id="link104"></a>
...
**Comment:** This paper validates a sub-Saturn companion using statistical methods. It is focused on exoplanet detection and characterization, not on galaxy evolution, star formation, or near-field cosmology.
...
## 105. [Revisiting the Lyth bound constraints on inflation from ACT DR6 results](https://arxiv.org/abs/2606.16711) <a id="link105"></a>
...
**Comment:** This paper revisits inflationary constraints using ACT data, focusing on cosmological inflation and the Lyth bound, which is not relevant to the core topics (no connection to galaxies, star formation, or stellar models).
...
## 106. [Domain walls and magnetic monopoles in Grand Unified Models](https://arxiv.org/abs/2606.14996) <a id="link106"></a>
...
**Comment:** Study of domain walls and magnetic monopoles in grand unified models, focusing on early universe physics and cosmological monopole abundance. No connection to galaxy evolution, star formation, or stellar models.
...
## 107. [The Effect of Anomalous Resistivity on Tearing Instability](https://arxiv.org/abs/2606.16363) <a id="link107"></a>
...
**Comment:** The paper studies the effect of anomalous resistivity on tearing instability in MHD, with applications to solar flares and fusion devices. It does not address any of the core topics such as galaxy simulations, near-field cosmology, or star formation histories.
...
## 108. [Comparative Analysis of Ellerman and Quiet Sun Ellerman Bombs in the Solar Atmosphere](https://arxiv.org/abs/2606.15111) <a id="link108"></a>
...
**Comment:** The paper compares Ellerman Bombs and Quiet Sun Ellerman Bombs in the solar atmosphere, focusing on magnetic reconnection and heating in the Sun. It does not address any of the core topics such as galaxy simulations, near-field cosmology, or star formation histories.
...
## 109. [Mapping deep-mantle compositional heterogeneity using a directional geoneutrino detector](https://arxiv.org/abs/2606.15680) <a id="link109"></a>
...
**Comment:** This paper focuses on geoneutrino detection and Earth's deep mantle composition, which is unrelated to any of the core astrophysics or galaxy evolution criteria.
...
## 110. [Analytic results for slow-roll curved-space inflation and exponential potentials](https://arxiv.org/abs/2606.16906) <a id="link110"></a>
...
**Comment:** This paper presents analytic results for inflationary cosmology and primordial power spectra, which is not relevant to near-field cosmology, galaxy evolution, or any of the specified criteria.
...
## 111. [Simultaneous Tricolor Video Observations of Three Tiny Near-Earth Asteroids with Sub-Minute Rotation Periods](https://arxiv.org/abs/2606.17047) <a id="link111"></a>
...
**Comment:** This paper focuses on the physical properties and rotation periods of tiny near-Earth asteroids, which is unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 112. [Polarity Reversal of the Polar Magnetic Fields in Solar Cycle 25](https://arxiv.org/abs/2606.15259) <a id="link112"></a>
...
**Comment:** The paper discusses solar magnetic field polarity reversal and its timing, which is not relevant to any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 114. [LLM Judges Have Dark Current: A Psychometric Datasheet for LLM-as-a-Judge Evaluation](https://arxiv.org/abs/2606.15610) <a id="link114"></a>
...
**Comment:** This paper is about psychometric evaluation of LLMs as judges, which is unrelated to astrophysics or any of the specified criteria.
...
## 115. [The capability of CSST in characterizing planetary atmospheres. I. transmission spectroscopy of hot Jupiters](https://arxiv.org/abs/2606.16452) <a id="link115"></a>
...
**Comment:** This paper discusses transmission spectroscopy of exoplanet atmospheres using the CSST. It does not match any of the core criteria (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 116. [Shigatse Astronomical Site Testing. I. Cloud-cover Climatology and Selected Local Meteorological Conditions](https://arxiv.org/abs/2606.15839) <a id="link116"></a>
...
**Comment:** This is a site-testing paper for an astronomical observatory, focusing on cloud cover and meteorological conditions. It does not address any of the core astrophysics or galaxy evolution criteria.
