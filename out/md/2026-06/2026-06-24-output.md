...
1. [First measurement of narrow-line flux ratios for a lensed quasar with JWST/NIRSpec IFS](#user-content-link1)
**Authors:** Hadrien Paugnat, Tommaso Treu, Anna M. Nierenberg, Anowar J. Shajib, Shawn Knabel, Daniel Gilman

2. [Beyond the Tayler instability: A new global instability of toroidal magnetic fields in stars](#user-content-link2)
**Authors:** Mikhail E. Gusakov, Laura Becerra, Elena M. Kantor, Andreas Reisenegger, Juan Alejandro Valdivia

3. [Discovery of a Barred-Spiral Galaxy at $z_{spec}$ = 3.16 II. The Star Formation History](#user-content-link3)
...
4. [Calibrating angular momentum transport in intermediate-mass stars from gravity-mode asteroseismology. II. Modelling 2937 BAF-type stars](#user-content-link4)
**Authors:** J. S. G. Mombarg, S. Mathis

5. [GalSBI: Forward Modelling Galaxy Clustering and Population](#user-content-link5)
**Authors:** Silvan Fischbacher, Luca Tortorelli, Tomasz Kacprzak, Alexandre Refregier

6. [Composition of Radiation-Driven Winds from Type I X-ray Bursts](#user-content-link6)
**Authors:** Jason S. Pero, Nevin N. Weinberg

7. [The dependence of Circumgalactic Medium properties on halo assembly histories in the IllustrisTNG simulations](#user-content-link7)
**Authors:** Yiyuan Zhang, Houzun Chen, Xi Kang

8. [A First Measurement of Circumgalactic Dust Reddening from Only 4.6 deg$^2$ of the Rubin Observatory's DP1](#user-content-link8)
**Authors:** John Franklin Crenshaw, Matthew McQuinn, Jessica K. Werk

9. [Universal Fitting Formulae for the Peak Concentration of Dark Matter Halos](#user-content-link9)
**Authors:** Dao-zhou Wang, Weipeng Lin, Tian-Cheng Luan

10. [Asteroseismology of neutron stars with both hyperons and $\Delta$ resonances](#user-content-link10)
**Authors:** Hao Sun, Jia-Xing Niu, Yong Gao, Hong-Bo Li, Cheng-Jun Xia

11. [Anisotropic quenching beyond $z=1$ and its implications for preprocessing around high-redshift galaxy clusters](#user-content-link11)
**Authors:** Makoto Ando, Kazuhiro Shimasaku, Kei Ito, Takumi S. Tanaka, Suin Matsui

12. [Dual-disk galaxies and thermal states of circumgalactic medium](#user-content-link12)
**Authors:** Masafumi Noguchi

13. [Overview: Extragalactic Continuum Science with the SKAO](#user-content-link13)
**Authors:** Catherine L. Hale, Fatemeh S. Tabatabaei

14. [Probing Baryonic Feedback Effect with CSST Weak Lensing and Future FRB Measurements](#user-content-link14)
**Authors:** Shuai Feng, Yan Gong, Qi Xiong, Xiaohui Liu, Hengjie Lin, Dingao Hu, Xuelei Chen

15. [JWST NIRSpec Spectral Standards for M, L, and T Dwarfs and Subdwarfs](#user-content-link15)
**Authors:** Evan Pritchard, Marylin Loritsch, Julia Haynes, Sara Morrissey, Emma Softich, Adam Burgasser

16. [Active galactic nucleus driven jet feedback in cosmologically forming cool-core galaxy clusters I: The effect of hierarchical assembly on intra-cluster medium properties](#user-content-link16)
**Authors:** Rainer Weinberger, Lorenzo Maria Perrone, Christoph Pfrommer, Thomas Berlok, Ewald Puchwein, L\'ena Jlassi, Rosie Talbot, Joseph Whittingham, R\"udiger Pakmor, Volker Springel

17. [Red vs. Blue: How metallicity shapes black hole dynamics and mergers in dense star clusters](#user-content-link17)
**Authors:** Saloni Agrawal, Kyle Kremer, Michael Zevin, Cailin Plunkett, Elena Gonz\'alez Prieto, Fulya K{\i}ro\u{g}lu, Christopher E. O'Connor, Frederic A. Rasio, Claire S. Ye

18. [The 3D clustering of Lyman Alpha Emitters measured with DESI](#user-content-link18)
**Authors:** Haruki Ebina, Martin J. White, Rongpu Zhou, Arjun Dey, David Schlegel, Jessica Nicole Aguilar, Steven Ahlen, Davide Bianchi, David Brooks, Francisco Javier Castander, Todd Claybaugh, Kyle S. Dawson, Axel de la Macorra, Peter Doel, Simone Ferraro, Andreu Font-Ribera, Jaime E. Forero-Romero, Satya Gontcho A Gontcho, Alma Xochitl Gonzalez-Morales, Gaston Gutierrez, Julien Guy, ChangHoon Hahn, Hiram K. Herrera-Alcantar, Mustapha Ishak, David Kirkby, Anthony Kremin, Ofer Lahav, Martin Landriau, Dustin Lang, Laurent Le Guillou, Michael E. Levi, Marc Manera, Paul Martini, Aaron Meisner, Ramon Miquel, Seshadri Nadathur, Nathalie Palanque-Delabrouille, Will J. Percival, Francisco Prada, Ignasi P\'erez-R\`afols, Ashley J. Ross, Graziano Rossi, Eusebio Sanchez, Michael Schubnell, Hee-Jong Seo, Gregory Tarl\'e, Benjamin Alan Weaver

19. [Measuring Magnetic Fields Near and Far with the SKA via the Zeeman Effect](#user-content-link19)
**Authors:** Timothy Robishaw, Marta Nowotka, Tao-Chung Ching, James A. Green, Anita M. S. Richards, Sandra Etoka, Malcolm Gray, Susan E. Clark, Tyler L. Bourke, Vincent Fish

20. [A Strongly Lensed Ultra-faint Arc at $z \approx 10$ with an F200W excess in Abell S1063](#user-content-link20)
**Authors:** Fujiang Yu, Mingyu Li, Zheng Cai, Yuduo Guo, Hao Zhang, Jose M. Diego, Sijia Cai

21. [Exploring the Cosmic Dawn through the 21 cm Forest and High-redshift Radio Sources with the SKA](#user-content-link21)
**Authors:** Junsong Cang, Benedetta Ciardi, Barun Maity, Atsushi J. Nishizawa, Qi Niu, Yue Shao, Abinash Kumar Shaw, Hayato Shimabukuro, Tom\'a\v{s} \v{S}oltinsk\'y, Tian-Yang Sun, Tsutomu T. Takeuchi, Yidong Xu, Kohji Yoshikawa, Bin Yue, Xin Zhang

22. [Evaluating the Sensitivity of the Age Inferences of Red Giant Stars to Machine Learning Methodology](#user-content-link22)
...
23. [Probing Merger Shocks in Galaxy Clusters in the SKA Era](#user-content-link23)
...
24. [Only obscured yet luminous active galactic nuclei are closely associated with galaxy mergers: Direct observational evidence from type 2 active galactic nuclei](#user-content-link24)
**Authors:** Yongmin Yoon, Yongjung Kim, Dohyeong Kim, Jaejun Cho, Woowon Byun

25. [The Impact of Host Galaxy Properties on Supernova Classification with Hierarchical Labels](#user-content-link25)
**Authors:** V. Ashley Villar, Sebastian Gomez, Edo Berger, Alex Gagliano

26. [Statistical Properties of Molecular Clouds in the Milky Way: Insights from Three-Isotopologue CO Observations of the MWISP Project](#user-content-link26)
**Authors:** Xin Zhou, Ji Yang, Qing-Zeng Yan, Yan Sun, Lixia Yuan, Yang Su, Xuepeng Chen, Shaobo Zhang

27. [NGC 6134: a comprehensive study through photometric and kinematic analysis using Gaia DR3](#user-content-link27)
...
28. [Opening new parameter space windows on galaxy/AGN co-evolution with SKA radio continuum surveys](#user-content-link28)
**Authors:** Isabella Prandoni, Mark T. Sargent, Matteo Bonato, Dharam V. Lal, Mahdiyar Mousavi-Sadr, Masoumeh Ghasemi-Nodehi, Nicholas Seymour, Fatemeh S. Tabatabaei, Gianfranco De Zotti, Ivano Baronchelli, Elisabetta Liuzzo, Nicola Marchili, Marcella Massardi, Rosita Paladino

29. [Kepler Image-Subtracted Light Curves and Variable Star Catalog of NGC 6819](#user-content-link29)
**Authors:** Melinda Soares-Furtado, Rianna Kuenzi, Rachel Lee McClure, Nicholas T. Marston, Evan Linck, Robert D. Mathieu, Andrew Vanderburg, Joel D. Hartman, Kyle Cudworth, Robert Gagliano, Thomas Jacobs, Martti H. Kristiansen, Mark Omohundro, Hans Martin Schwengeler

30. [Interferometric HI Intensity Mapping of the Late Time Universe with SKA-Mid](#user-content-link30)
**Authors:** Aishrila Mazumder, Zhaoting Chen, Junaid Townsend, Suman Chatterjee, Zhixing Li, Sourabh Paul, Reza Ansari, Laura Wolz, Mario G. Santos

31. [Characterising magnetic fields at the onset of star cluster formation: From giant molecular clouds to infrared dark clumps](#user-content-link31)
**Authors:** Ria Ramkumar, Nicolas Peretto, Gary A. Fuller, Patrick M. Koch, Ya-Wen Tang

32. [A Collapsar-Disk Origin for GW190814](#user-content-link32)
**Authors:** Vishal Baibhav, Brian D. Metzger, Lam Hui

33. [Discovery of a Barred-Spiral Galaxy at $z_{spec}$ = 3.16 I: Bar Identification and Properties](#user-content-link33)
...
34. [Using SKAO to Understand the Clustering of Gravitational Wave Sources](#user-content-link34)
**Authors:** Michele Bosi, Sarah Libanore, Nicola Bellomo, Caterina Scarpel, Federico Semenzato, Alvise Raccanelli, Michele Liguori

35. [Modern tidal interaction models for rapid binary population synthesis: II. Binary black hole formation, mergers, and spins](#user-content-link35)
**Authors:** Veome Kapil, Ilya Mandel, Jeff Riley, Evgeni Grishin, Jim Fuller, Emanuele Berti

36. [Unlocking the Full Potential of SKAO Extra-galactic Science with High-multiplex Optical Spectroscopy](#user-content-link36)
**Authors:** Kenneth J Duncan, Natasha Maddox, Daniel J. B Smith, Marina I Arnaudova, Catherine L Hale, Sophia Flury, Luke Holden, Matt J Jarvis, Elizabeth A. K. Adams, S. Ilani Loubser, Mamta Pandey-Pommier, Anastasia Ponomareva

37. [First Results from the LSST Shadow Survey: The Restless Luminous Blue Variable AT2017des in the Virgo-Cluster Galaxy, NGC4532](#user-content-link37)
...
38. [Galactic Hubs: New Insights and SKA View of AGN Feedback in Galaxy Groups](#user-content-link38)
**Authors:** T. Pasini, M. Brienza, C. J. Riseley

39. [Unlocking the Hidden Potential of ALMA Calibrators: A Pilot Blind Search for Galactic Molecular Gas in ALMA Band 1](#user-content-link39)
**Authors:** Kanako Narita, Bunyo Hatsukade

40. [Constraints on the Gas Geometry Surrounding Little Red Dots through Narrow-Line Diagnostics](#user-content-link40)
**Authors:** Visal Sok, Erica J. Nelson, Mitchell C. Begelman, Jason Dexter, Francesco D'Eugenio, Jenny E. Greene, Joel Leja, Katherine E. Whitaker, Andrew J. Bunker, Pablo G. P\'erez-Gonz\'alez, Pierluigi Rinaldi, Alberto Torralba, Hannah \"Ubler

41. [Jet-ISM Interaction and Multi-channel AGN Feedback in the Post-merger Galaxy 4C+29.30](#user-content-link41)
**Authors:** Xiao Cao, Junfeng Wang, Yan-Mei Chen, Min Bao, Xiaoyu Xu, Chunyi Zhang, Taotao Fang, Jianfeng Wu

42. [Radial gradients revealed by mutliscale outflows from down-the-barrel spectroscopy toward a quasar at redshift 3.4](#user-content-link42)
**Authors:** Weimin Yi, Paola Rodriguez Hidalgo, Chen Chen, P. B. Hall, Zhicheng He, R. P. Easton, D. P. Schneider, W. N. Brandt, Xue-Bing Wu, Kai-Xing Lu, Chuanjun Wang, Yuanjie Feng

43. [Accurate modeling for 3$\times$2pt analyses in Roman and Rubin: a study of model approximations](#user-content-link43)
...
44. [SN1987A Constraints of Light $\boldsymbol{Z'}$ with Non-Mixing Polarisations](#user-content-link44)
**Authors:** Debottam Das, Purusottam Ghosh, Rahul Puri

45. [Cosmological constraints from the DESI DR1 Bispectrum Full-Shape and DR2 BAO](#user-content-link45)
**Authors:** D. Forero-S\'anchez (DESI Collaboration), S. Novell Masot (DESI Collaboration), H. Gil-Mar\'in (DESI Collaboration), L. Verde (DESI Collaboration), J. Aguilar (DESI Collaboration), S. Ahlen (DESI Collaboration), D. Bianchi (DESI Collaboration), A. Brodzeller (DESI Collaboration), D. Brooks (DESI Collaboration), F. J. Castander (DESI Collaboration), S. Cole (DESI Collaboration), A. de la Macorra (DESI Collaboration), J. Della Costa (DESI Collaboration), Biprateep Dey (DESI Collaboration), P. Doel (DESI Collaboration), S. Ferraro (DESI Collaboration), A. Font-Ribera (DESI Collaboration), J. E. Forero-Romero (DESI Collaboration), Satya Gontcho A Gontcho (DESI Collaboration), G. Gutierrez (DESI Collaboration), C. Hahn (DESI Collaboration), H. K. Herrera-Alcantar (DESI Collaboration), K. Honscheid (DESI Collaboration), D. Huterer (DESI Collaboration), M. Ishak (DESI Collaboration), D. Kirkby (DESI Collaboration), A. Kremin (DESI Collaboration), O. Lahav (DESI Collaboration), C. Lamman (DESI Collaboration), M. Landriau (DESI Collaboration), L. Le Guillou (DESI Collaboration), M. E. Levi (DESI Collaboration), M. Manera (DESI Collaboration), A. Meisner (DESI Collaboration), R. Miquel (DESI Collaboration), J. Moustakas (DESI Collaboration), S. Nadathur (DESI Collaboration), J. A. Newman (DESI Collaboration), G. Niz (DESI Collaboration), N. Palanque-Delabrouille (DESI Collaboration), W. J. Percival (DESI Collaboration), F. Prada (DESI Collaboration), I. P\'erez-R\`afols (DESI Collaboration), G. Rossi (DESI Collaboration), L. Samushia (DESI Collaboration), E. Sanchez (DESI Collaboration), D. Schlegel (DESI Collaboration), M. Schubnell (DESI Collaboration), J. Silber (DESI Collaboration), G. Tarl\'e (DESI Collaboration), B. A. Weaver (DESI Collaboration)

46. [Exploring Gravitational Wave Signatures Due to Primordial Non-gaussianity and Large Scale Structure Using SKAO](#user-content-link46)
**Authors:** H. V. Ragavendra, Giulia Capurri, Alina Mierna, Gabriele Perna, Federico Semenzato, Nicola Bartolo, Daniele Bertacca, Lorenzo Valbusa Dall'Armi, Sabino Matarrese, Matteo Pegorin, Angelo Ricciardone

47. [MINDS: Complementary inclinations in the binary system HK Tau reveal gas- and ice-phase chemistry](#user-content-link47)
**Authors:** Alice Somigliana, Giulia Perotti, Nicol\'as T. Kurtovic, Thomas Henning, Myriam Benisty, Andrew D. Sellek, Melissa McClure, Zak L. Smith, Aditya M. Arabhavi, Alessio Caratti o Garatti, Valentin Christiaens, Ewine F. van Dishoeck, Danny Gasman, Sierra L. Grant, Manuel G\"udel, Till Kaeufer, Inga Kamp, Lucas Stapper, Beno\^it Tabone, Milou Temmink, Marissa Vlasblom

48. [Extragalactic test of General Relativity with time-delay gravitational lenses](#user-content-link48)
**Authors:** Wuzheng Guo, Shuo Cao, Qiumin Wang, Yun Chen, Marek Biesiada, Tonghua Liu, Yujie Lian

49. [Newtonian Shirokov Effect: Epicyclic Frequency Splitting from Mass Multipoles](#user-content-link49)
**Authors:** Anuar Idrissov, Kuantay Boshkayev, Abylaikhan Tlemissov, Hernando Quevedo

50. [Imaging the 21-cm Signal from the Cosmic Dawn & Epoch of Reionization and the Connection with the Global Signal](#user-content-link50)
**Authors:** Satadru Bag, Michele Bianco, Samir Choudhuri, Saswata Dasgupta, Abhirup Datta, Kanan K. Datta, Ivelin Georgiev, Sambit K. Giri, Ian Hothi, Akanksha Kapahtia, Suman Majumdar, Garrelt Mellema, Arnab Mishra, Samit Kumar Pal, Feiyu Zhao

51. [EP251023a: A fast X-ray transient featuring a magnetar-powered optical internal plateau followed by a steep decay](#user-content-link51)
**Authors:** Shuai-Qing Jiang, Dong Xu, Wei-Hua Lei, Jie An, Yuan-Chuan Zou, Zi-Pei Zhu, Ryan Chornock, Dmitry Svinkin, Wen-Xiong Li, E. Fern\'andez-Garc\'ia, Yue Wu, Wen-Da Zhang, Shao-Yu Fu, Xing Liu, Lin-Bo He, Moira Andrews, A. J. Castro-Tirado, Joseph R. Farah, Dmitry Frederiks, M. Gritsevich, D. Andrew Howell, Ding-Fang Hu, Alexandra L. Lysenko, A. Maury, Curtis McCully, S. B. Pandey, I. P\'erez-Garc\'ia, Anna Ridnaia, Anastasia Tsvetkova, Mikhail Ulanov, S. -Y. Wu, Kathryn Wynn, D. -R. Xiong, Hao-Nan Yang, B. -B. Zhang, Tong Zhao

52. [Late-Time Oscillating Quintessence in Light of DESI](#user-content-link52)
**Authors:** Jun-Qian Jiang, Mustafa A. Amin, Arman Shafieloo

53. [Nuclei in high-energy neutrino sources: A multimessenger study of in-source propagation](#user-content-link53)
**Authors:** AmirFarzan Esmaeili, Arman Esmaili, Pasquale Dario Serpico

54. [Stellar Wind Driven Alfv\'en Wing Dynamics in Planetary and Exoplanetary Magnetospheres](#user-content-link54)
**Authors:** Sakshi Gupta, Arnab Basak, Dibyendu Nandy

55. [As above, so below: assessing extremeness of the neutron-star equation of state based on the unstable branch](#user-content-link55)
**Authors:** Tyler Gorda, Oleg Komoltsev, Aleksi Kurkela, J\"urgen Schaffner-Bielich

56. [Signatures of $^{56}$Ni Mixing and Neutron-rich Ejecta in Supernovae](#user-content-link56)
**Authors:** Nikhil Sarin

57. [Low-mass X-ray binaries as a probe of Kerr-MOG black hole spacetime](#user-content-link57)
**Authors:** Bakhodirkhon Saidov, Bakhtiyor Narzilloev, Ibrar Hussain, Bobomurat Ahmedov

58. [Indication for Decreasing Dispersion Measure in the Population of Repeating Fast Radio Bursts and Connection to Young Supernova Remnant Expansion](#user-content-link58)
**Authors:** Xiang-han Cui, Cheng-min Zhang, Di Li, Pei Wang, Erbil G\"ugercino\u{g}lu, Joeri van Leeuwen, Yi-dan Wang, Chao-wei Tsai, Xiang-lei Chen, Wen-qi Ma, Habtamu Menberu Tedila

59. [Weak Lensing with the SKAO: Radio Shear Measurement](#user-content-link59)
**Authors:** Priyamvad Tripathi, Marzia Rivi, Simon Prunet, Ian Harrison, Andr\'e Ferrari

60. [Measuring local primordial non-Gaussianity from the clustering of DESI DR1 LRGs and QSOs](#user-content-link60)
...
66. [Quantum Stochastic Inflation](#user-content-link66)
**Authors:** Robson Christie, Jaewoo Joo, Greg Kaplanek, Vincent Vennin, David Wands

67. [Hydrogen airglow from an escaping ultrahot Jupiter atmosphere](#user-content-link67)
...
68. [Charge transfer from ammonia neutralizes propylene oxide cations: Implications for the astrochemistry of chiral molecules](#user-content-link68)
**Authors:** Sanjana Maheshwari, Darya Kisuryna, Leah G. Dodson

69. [Discovery of a nebula associated with a high proper motion sdB star](#user-content-link69)
**Authors:** R. Ortiz, F. Bijarchian, M. A. Guerrero, M. Akhlaghi, M. Serra-Ricart

70. [Improving Radio Source Count Estimation Using Kernel Density Estimation](#user-content-link70)
**Authors:** Luozhenhan Liu, Zunli Yuan, Wenjie Wang, Chuanqi Li

71. [The Topology of the Universe](#user-content-link71)
**Authors:** Craig J. Copi, Deyan P. Mihaylov, Anna Negro, Amirhossein Samandar, Glenn D. Starkman, Yashar Akrami, George Alestas, Stefano Anselmi, Javier Carr\'on Duque, Fernando Cornet-Gomez, Linn Htat Lu, Andrew H. Jaffe, Arthur Kosowsky, Mikel Martin Barandiaran, Thiago S. Pereira, Catherine Petretti, Andrius Tamosiunas

72. [An Agnostic Machine Learning Model of Photosynthetic Habitability](#user-content-link72)
...
73. [Effects of Super-rotating Jets on Phase-Resolved Transmission Spectra at High Spectral Resolution](#user-content-link73)
**Authors:** Hayley Beltz, Arjun B. Savel

74. [Ultra-Precise Astrometric Search for Exoplanets with SKA-VLBI](#user-content-link74)
**Authors:** Salvador Curiel, Mar\'ia J. Rioja, Richard Dodson, Huib Jan van Langevelde, Tao An

75. [Coupled atmospHere Interior modeL Intercomparison (CHILI). I. Evolutionary Modelling -- Primordial Magma Oceans of Earth and Venus](#user-content-link75)
...
76. [Minimal Extensions of the $\alpha$-Starobinsky Model: Reconciling ACT DR6 and Reheating Constraints](#user-content-link76)
**Authors:** Nehla Shobcha, Norma Sidik Risdianto, Romy Hanang Setya Budhi

77. [Radio eclipse of the slowest spinning Galactic-field spider pulsar PSR J1932+2121 and its X-ray emission prospect](#user-content-link77)
**Authors:** Ze-Xin Du, Yun-Wei Yu, Zong-Lin Yang, Aming Chen, Peng-Fei Wang, Jin-Lin Han, De-Jiang Zhou, Xiao-Peng You

78. [A thorough investigation of cross-correlation estimators for stochastic gravitational-wave background searches in ground-based detector data](#user-content-link78)
**Authors:** Haowen Zhong, Joseph D. Romano, Vuk Mandic, Shivaraj Kandhasamy, Arianna I. Renzini

79. [Multi-peaked high-frequency gravitational waves from PBH-assisted leptogenesis](#user-content-link79)
**Authors:** Debasish Borah, Nayan Das

80. [Stochastic Expectation Maximization for Robust State-Space Radio Interferometric Imaging](#user-content-link80)
**Authors:** Nawel Arab, Mohammed Nabil El Korso, Isabelle Vin, Pascal Larzabal

81. [The large scale structure probes of dark energy](#user-content-link81)
**Authors:** Pengjie Zhang, Shang Li

82. [Machine Learning and Deep Learning for Exoplanet Detection and Atmospheric Characterization with JWST and the Upcoming Ariel Mission](#user-content-link82)
**Authors:** Muallim Yakubu, Vwavware Oruaode Jude

83. [Chinese Sunspot Drawings and Their Digitization-(VIII) Release of a Machine Readable Parameters Catalog](#user-content-link83)
**Authors:** G. H. Lin, S. Liu

84. [Reconstructing the slope of a nearly flat quintessence potential from cosmography](#user-content-link84)
**Authors:** Saikat Chakraborty, Peter K. S. Dunsby, Robert J. Scherrer

85. [Magnetized Coulomb crystals in neutron star crusts](#user-content-link85)
**Authors:** Cheng-Jun Xia, Toshiki Maruyama, Nobutoshi Yasutake, Toshitaka Tatsumi

86. [Constant-Roll Inflation: Analytical Formulae for Power Spectrum and Implications for Induced Gravitational Waves](#user-content-link86)
**Authors:** Hayato Motohashi, Shi Pi, Yuichiro Tada, Jianing Wang

87. [Inflation in a nutshell: From basics to latest advances](#user-content-link87)
**Authors:** Zhi-Chong Qiu, Qing-Guo Huang

88. [Energy Extraction via Magnetic Reconnection from a Rotating Dyonic Black Hole in $N = 2, \ U(1)^2$ Gauged Supergravity](#user-content-link88)
**Authors:** Raid M Suleiman, Shanshan Rodriguez, Dominic O. Chang, Leo Rodriguez

89. [A Novel Arm-Length Stabilization Scheme for Gravitational-Wave Detectors with AlGaAs/GaAs Coated Mirrors](#user-content-link89)
**Authors:** Jian Liu, Juntao Pan, Carl Blair, Chiara Di Fronzo, Li Ju, Chunnong Zhao, Sheon S. Y. Chua, Bram J. J. Slagmolen, Nutsinee Kijbunchoo, David Ottaway

90. [Primordial Black Holes: A Review of Formation and Evolution](#user-content-link90)
**Authors:** S. Shankaranarayanan, Soumya Bhattacharya, Archit Vidyarthi

91. [Widefield Spectroscopic Telescope (WST): coating strategy to achieve high optical throughput](#user-content-link91)
**Authors:** Benoit Sassolas, Matthieu Coulon, Christophe Michel, Laurent Pinard, Roland Bacon, Corentin Cudennec, Philippe Dierickx

92. [Toeplitz Determinants and Admissible Correlation Intervals](#user-content-link92)
**Authors:** Thomas Erben

93. [White paper on the relevance of the European Solar Telescope (EST) for the French heliophysics](#user-content-link93)
**Authors:** E. Pariat, Q. Noraz, B. Perri, N. Poirier, C. Froment, L. Bigot, G. Aulanier, B. Gelly, J. Aboudarham, S. Aizawa, O. Alexandrova, S. Alqeeq, T. Amari, F. Auch\`ere, G. Bernoux, M. Berthomier, V. Bommier, X. Bonnin, P. Boumier, A. S. Brun, I. Bual\'e, E. Buchlin, A. Canou P. Canu, T. Corbard, F. Cornu, C. Coustillet, G. Cozzani, L. D'herbomez, S. Diaz Castillo, T. Dudok de Wit, M. Faurobert, A. Finley, D. Fontaine, R. A. Garcia, R. Grappin, L. Hadid, K. H. Henadhira Arachchige, M. Janvier, L. Jouve, R. Kieokaew, H. Kirkwood, B. Lavraud, J. -P. Le Breton, O. Le Contel, N. Le Nestour, F. Leblanc, S. Masson, N. Meyer-Vernet, S. Parenti, F. Pitout, M. Rieutord, J. Romero Casta\~neda, A. Rouillard, C. Ruiz de Galarreta, F. Sahraoui, B. Schmieder, P. Simon, A. Strugarek, M. Tallon, P. Thepthong, J. Touresse, J. -C. Vial, N. Vilmer, A. Zaslavsky

94. [Astrobiology in the Time of Artificial Intelligence](#user-content-link94)
**Authors:** Caleb Scharf

95. [The Space Debris Tracking and Surveillance program of the IAC80 telescope](#user-content-link95)
**Authors:** Olga Zamora

96. [FAST Pulsar Database IV. Spike subpulses and quasi-periodic subpulses of 25 pulsars observed by FAST](#user-content-link96)
**Authors:** Tao Wang, N. N. Cai, J. L. Han, W. C. Jing, Z. L. Yang, Y. Yan, D. J. Zhou, P. F. Wang, C. Wang

97. [Simulated Gravitational Lensing in the Undergraduate Lab](#user-content-link97)
**Authors:** Daniel FitzGreen

98. [The Galactic Center as a connected ecosystem across spatial and temporal scales](#user-content-link98)
**Authors:** Michal Zaja\v{c}ek, Bo\.zena Czerny, Martin Mondek, Samik Mitra, Mat\'u\v{s} Labaj, Tom\'a\v{s} Ondro, Jan Jan\'ik, Ji\v{r}\'i Du\v{s}ek

99. [Pioneer 10/11 Telemetry Explanatory Almanac](#user-content-link99)
**Authors:** Viktor T. Toth

100. [On-orbit Calibration of the Carruthers GCI: Photon Background Removal](#user-content-link100)
**Authors:** Alex Zhang, Heather Filippini, Jackson Craig, Lara Waldrop, John Clarke, Farzad Kamalabadi, Pratik Joshi

---

## 1. [First measurement of narrow-line flux ratios for a lensed quasar with JWST/NIRSpec IFS](https://arxiv.org/abs/2606.23808) <a id="link1"></a>
...
**Comment:** This paper uses strong gravitational lensing flux-ratio anomalies to probe dark matter substructure on subgalactic scales, directly matching the 'near-field cosmology' criterion (substructure, core-cusp, satellite luminosity function). The use of JWST/NIRSpec for narrow-line flux ratios is novel.
...
## 2. [Beyond the Tayler instability: A new global instability of toroidal magnetic fields in stars](https://arxiv.org/abs/2606.24607) <a id="link2"></a>
...
**Comment:** This paper presents a new global instability of toroidal magnetic fields in stars, which is relevant to stellar models and stellar interior physics. It matches the 'Stellar Models' criterion closely, as it introduces new theoretical insights into stellar magnetic field instabilities.
...
## 3. [Discovery of a Barred-Spiral Galaxy at $z_{spec}$ = 3.16 II. The Star Formation History](https://arxiv.org/abs/2606.23793) <a id="link3"></a>
...
**Comment:** Presents spatially resolved star formation history for a barred-spiral galaxy at z=3.16 using JWST and HST. The focus is on resolved star formation histories from imaging and SED modeling, matching the 'Resolved Star Formation Histories' criterion. Also discusses bar quenching, which is relevant but less central.
...
## 4. [Calibrating angular momentum transport in intermediate-mass stars from gravity-mode asteroseismology. II. Modelling 2937 BAF-type stars](https://arxiv.org/abs/2606.23819) <a id="link4"></a>
...
**Comment:** This paper presents new stellar models for angular momentum transport in intermediate-mass stars, directly matching the 'stellar models' criterion. The use of a large sample and new modeling is novel.
...
## 5. [GalSBI: Forward Modelling Galaxy Clustering and Population](https://arxiv.org/abs/2606.23783) <a id="link5"></a>
...
**Comment:** This paper presents an updated forward modeling framework (GalSBI) for galaxy population and clustering, including subhalo abundance matching and simulation-based inference. It measures the galaxy luminosity function and galaxy-halo connection, which are relevant to near-field cosmology and numerical galaxy simulations. The work enables accurate forward-modeled image simulations, which is directly relevant to the numerical galaxy simulations criterion, and also touches on satellite luminosity functions.
...
## 6. [Composition of Radiation-Driven Winds from Type I X-ray Bursts](https://arxiv.org/abs/2606.23818) <a id="link6"></a>
...
**Comment:** This paper uses MESA stellar evolution code to simulate radiation-driven winds from Type I X-ray bursts, focusing on wind composition and nuclear ashes. It presents new stellar models and discusses stellar evolutionary tracks, matching the 'Stellar Models' criterion.
...
## 7. [The dependence of Circumgalactic Medium properties on halo assembly histories in the IllustrisTNG simulations](https://arxiv.org/abs/2606.24735) <a id="link7"></a>
...
**Comment:** This paper analyzes the dependence of circumgalactic medium (CGM) properties on halo assembly histories in the IllustrisTNG simulations. The focus on CGM, halo assembly, and numerical galaxy simulations matches the criteria for circumgalactic medium and numerical galaxy simulations, especially for halos in the mass range that includes dwarfs.
...
## 8. [A First Measurement of Circumgalactic Dust Reddening from Only 4.6 deg$^2$ of the Rubin Observatory's DP1](https://arxiv.org/abs/2606.24159) <a id="link8"></a>
...
**Comment:** Measures circumgalactic dust reddening using Rubin Observatory data. The focus is on the CGM and dust distribution around galaxies, with some attention to lower-mass galaxies. This fits the 'Circumgalactic Medium' criterion, though the main focus is dust rather than gas or outflows.
...
## 9. [Universal Fitting Formulae for the Peak Concentration of Dark Matter Halos](https://arxiv.org/abs/2606.24071) <a id="link9"></a>
...
**Comment:** This paper presents universal fitting formulae for the peak concentration of dark matter halos, derived from N-body simulations. The focus on halo concentration and mass-concentration relations is relevant to near-field cosmology and numerical galaxy simulations, especially as it pertains to dark matter halo structure.
...
## 10. [Asteroseismology of neutron stars with both hyperons and $\Delta$ resonances](https://arxiv.org/abs/2606.24343) <a id="link10"></a>

**ArXiv ID:** 2606.24343

**Authors:** Hao Sun, Jia-Xing Niu, Yong Gao, Hong-Bo Li, Cheng-Jun Xia

**Abstract:** Employing various relativistic energy density functionals for nucleon-nucleon interactions, we investigate the impact of hyperons and $\Delta$ resonances on the frequencies of non-radial oscillations in neutron stars, where the universal coupling scheme is adopted for the $\Delta$-meson couplings. It is found that the inclusion of $\Delta$ resonances is essential for neutron stars to accommodate the recent mass and radius measurements of PSR J0030+0451, PSR J0740+6620, PSR J0437-4715, PSR J0614-3329, and HESS J1731-347. As $\Delta$ resonances start to emerge in neutron stars' inner core, the $g$-mode oscillation energy becomes concentrated within the $\Delta$-admixed region, leading to a sharp increase in the $g$-mode frequency. We also examine the $f$-mode and $p$-mode oscillations and find that the impact of $\Delta$ resonances on these modes is less pronounced than the $g$-modes. The oscillation frequencies calculated in the Cowling approximation are then compared with those from full general relativity, confirming that the Cowling approximation introduces an error of approximately 20\% for the $f$-modes and within 10\% for the $g$-modes. The notable effect of $\Delta$ resonances on neutron stars' $g$-mode frequencies holds important implications for probing the internal composition of neutron stars.

**Comment:** The paper investigates asteroseismology of neutron stars, focusing on oscillation modes and the impact of hyperons and Delta resonances. It presents new stellar models and theoretical work on neutron star interiors, matching the 'Stellar Models' criterion.
...
## 12. [Dual-disk galaxies and thermal states of circumgalactic medium](https://arxiv.org/abs/2606.24158) <a id="link12"></a>
...
**Comment:** The paper discusses dual-disk galaxies and the thermal states of the circumgalactic medium, including the transition between disk types and the role of CGM in galaxy evolution. While it focuses on disk galaxies, it does address the CGM and its connection to galaxy evolution, which is a relevant criterion, though the focus is on more massive galaxies rather than dwarfs. Relevance is moderate.
...
## 13. [Overview: Extragalactic Continuum Science with the SKAO](https://arxiv.org/abs/2606.24843) <a id="link13"></a>
...
**Comment:** This overview discusses extragalactic continuum science with the SKAO, including star formation history measurements, AGN studies, and cosmic ray acceleration. While it mentions dust-unbiased measurements of cosmic star-formation history and spectral energy distribution analyses, the focus is broad and not specifically on resolved star formation histories from color-magnitude diagrams or dwarf galaxies. The relevance is borderline due to the mention of star formation history.
...
## 14. [Probing Baryonic Feedback Effect with CSST Weak Lensing and Future FRB Measurements](https://arxiv.org/abs/2606.24061) <a id="link14"></a>
...
**Comment:** This paper investigates baryonic feedback using weak lensing and FRB measurements, focusing on cosmological parameter constraints and baryonic effects on large-scale structure. While baryonic feedback is relevant to galaxy formation, the work is not specifically focused on dwarf galaxies, resolved star formation histories, quenching, or galaxy simulations. The relevance is borderline due to indirect connection to galaxy evolution.
...
## 15. [JWST NIRSpec Spectral Standards for M, L, and T Dwarfs and Subdwarfs](https://arxiv.org/abs/2606.23928) <a id="link15"></a>

**ArXiv ID:** 2606.23928

**Authors:** Evan Pritchard, Marylin Loritsch, Julia Haynes, Sara Morrissey, Emma Softich, Adam Burgasser

**Abstract:** We present low resolution infrared spectral standards in the 0.76 to 5.0 {\mu}m range based on JWST NIRspec Prism data from deep sky surveys. Our standards encompass spectral types M, L, and T and dwarf and subdwarf metallicity classes. The standards extend ground based spectral templates and enable classification of low temperature stellar substellar discoveries from deep JWST NIRSpec data.

**Comment:** Presents new spectral standards for M, L, and T dwarfs using JWST NIRSpec. While this is related to stellar atmosphere models, it is not a new theoretical model or evolutionary track, but rather observational templates. Borderline relevance for the 'Stellar Models' criterion.
...
## 16. [Active galactic nucleus driven jet feedback in cosmologically forming cool-core galaxy clusters I: The effect of hierarchical assembly on intra-cluster medium properties](https://arxiv.org/abs/2606.23775) <a id="link16"></a>
...
**Comment:** This paper presents hydrodynamic simulations of galaxy clusters, focusing on AGN jet feedback and its effect on the intra-cluster medium. While it involves numerical galaxy simulations, the focus is on massive galaxy clusters and AGN feedback, not dwarf galaxies or star-formation-driven outflows. It is borderline relevant due to the simulation aspect.
...
## 17. [Red vs. Blue: How metallicity shapes black hole dynamics and mergers in dense star clusters](https://arxiv.org/abs/2606.23788) <a id="link17"></a>
...
**Comment:** This paper presents Monte Carlo star cluster simulations with refined metallicity coverage, focusing on black hole dynamics and mergers in dense star clusters. It discusses numerical simulations of star clusters and the effect of metallicity, but does not directly address galaxy simulations or the core topics. It is borderline relevant due to the simulation aspect.
...
## 19. [Measuring Magnetic Fields Near and Far with the SKA via the Zeeman Effect](https://arxiv.org/abs/2606.24810) <a id="link19"></a>
...
**Comment:** The paper discusses Zeeman effect measurements of magnetic fields in the Milky Way and external galaxies, including starburst galaxies and damped Lyman-alpha systems. While it covers galaxy formation and cosmic evolution, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations. The relevance is borderline due to the mention of external galaxies and cosmic evolution.
...
## 20. [A Strongly Lensed Ultra-faint Arc at $z \approx 10$ with an F200W excess in Abell S1063](https://arxiv.org/abs/2606.23869) <a id="link20"></a>
...
**Comment:** This paper studies an ultra-faint galaxy at z~10 using strong lensing and JWST imaging. While it probes faint galaxy formation and stellar populations, it is not focused on near-field cosmology, resolved star formation histories, or dwarf satellites of the Milky Way. The relevance is borderline, as it deals with galaxy formation and stellar populations, but at high redshift and not in the local universe.
...
## 21. [Exploring the Cosmic Dawn through the 21 cm Forest and High-redshift Radio Sources with the SKA](https://arxiv.org/abs/2606.24665) <a id="link21"></a>
...
**Comment:** This review discusses the 21 cm forest as a probe of the neutral intergalactic medium during reionization, with implications for early galaxy formation and small-scale structure. It is not focused on near-field cosmology or resolved star formation histories of local galaxies, but it does touch on galaxy formation and the impact of small-scale structure, which is borderline relevant.
...
## 22. [Evaluating the Sensitivity of the Age Inferences of Red Giant Stars to Machine Learning Methodology](https://arxiv.org/abs/2606.24383) <a id="link22"></a>
...
**Comment:** This paper evaluates the sensitivity of age inferences for red giant stars using machine learning, with implications for understanding the formation of the Milky Way. While stellar ages are important for galactic archaeology, the paper does not present new stellar models or focus on resolved star formation histories from color-magnitude diagrams. The relevance is borderline due to indirect connection to stellar models and galactic evolution.
...
## 23. [Probing Merger Shocks in Galaxy Clusters in the SKA Era](https://arxiv.org/abs/2606.24738) <a id="link23"></a>
...
**Comment:** The paper reviews merger shocks in galaxy clusters, focusing on radio relics and shock physics in the intracluster medium. The focus is on massive galaxy clusters, not dwarf galaxies or near-field cosmology. It is borderline relevant due to the discussion of galaxy cluster environments.
...
## 24. [Only obscured yet luminous active galactic nuclei are closely associated with galaxy mergers: Direct observational evidence from type 2 active galactic nuclei](https://arxiv.org/abs/2606.24684) <a id="link24"></a>
...
**Comment:** This paper studies the connection between galaxy mergers and AGN activity, specifically in type 2 AGNs. The focus is on AGN triggering and merger-driven evolution, not star-formation-driven outflows or dwarf galaxies. It is borderline relevant due to the galaxy merger aspect.
...
## 25. [The Impact of Host Galaxy Properties on Supernova Classification with Hierarchical Labels](https://arxiv.org/abs/2606.24807) <a id="link25"></a>
...
**Comment:** The paper discusses supernova classification using host galaxy properties, but does not focus on dwarf galaxies, star formation histories, quenching, or galaxy simulations. The relevance is borderline as host galaxy properties may tangentially relate to galaxy evolution, but not directly to the core topics.
...
## 26. [Statistical Properties of Molecular Clouds in the Milky Way: Insights from Three-Isotopologue CO Observations of the MWISP Project](https://arxiv.org/abs/2606.24444) <a id="link26"></a>
...
**Comment:** The paper presents a statistical analysis of molecular clouds in the Milky Way, focusing on their properties and scaling relations. While it discusses star formation and molecular cloud structure, it does not address dwarf galaxies, resolved star formation histories, or galaxy simulations. The relevance is borderline due to its connection to star formation processes.
...
## 27. [NGC 6134: a comprehensive study through photometric and kinematic analysis using Gaia DR3](https://arxiv.org/abs/2606.24270) <a id="link27"></a>
...
**Comment:** This paper studies the open cluster NGC 6134 using Gaia DR3, focusing on cluster parameters, spatial distribution, substructures, and mass segregation. It analyzes color-magnitude diagrams and identifies blue straggler stars, which is somewhat relevant to stellar models and resolved star formation histories, but the focus is on a star cluster, not galaxies. The relevance is borderline due to the CMD analysis.
...
## 28. [Opening new parameter space windows on galaxy/AGN co-evolution with SKA radio continuum surveys](https://arxiv.org/abs/2606.24802) <a id="link28"></a>
...
**Comment:** This paper reviews the science enabled by SKA radio continuum surveys, focusing on galaxy/AGN co-evolution. While it discusses extragalactic surveys and galaxy evolution, the focus is on AGN and galaxy co-evolution, not specifically on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. It is borderline relevant due to its broad coverage of galaxy evolution, but lacks direct connection to the core topics.
...
## 29. [Kepler Image-Subtracted Light Curves and Variable Star Catalog of NGC 6819](https://arxiv.org/abs/2606.24114) <a id="link29"></a>
...
**Comment:** This paper presents variable star light curves and a catalog for an open cluster (NGC 6819), enabling studies of stellar variability and angular momentum evolution. While it provides data relevant to stellar evolution, it does not present new stellar models or focus on resolved star formation histories of galaxies, nor does it address galaxy simulations or quenching.
...
## 30. [Interferometric HI Intensity Mapping of the Late Time Universe with SKA-Mid](https://arxiv.org/abs/2606.24730) <a id="link30"></a>
...
**Comment:** The paper discusses HI intensity mapping and the HI power spectrum at high redshift, which relates to galaxy evolution but does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 31. [Characterising magnetic fields at the onset of star cluster formation: From giant molecular clouds to infrared dark clumps](https://arxiv.org/abs/2606.23802) <a id="link31"></a>
...
**Comment:** This paper studies magnetic fields in molecular clouds and their role in star formation efficiency, but focuses on cluster-forming clumps and larger molecular clouds, not dwarf galaxies or resolved star formation histories. It is tangentially related to star formation but not directly to the core criteria.
...
## 32. [A Collapsar-Disk Origin for GW190814](https://arxiv.org/abs/2606.23786) <a id="link32"></a>
...
**Comment:** The paper proposes a collapsar-disk origin for a gravitational wave event, discussing compact object mergers and their electromagnetic counterparts. While it touches on galaxy evolution and supernovae, it does not directly address any of the core topics such as near-field cosmology, dwarf galaxy properties, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 33. [Discovery of a Barred-Spiral Galaxy at $z_{spec}$ = 3.16 I: Bar Identification and Properties](https://arxiv.org/abs/2606.23792) <a id="link33"></a>
...
**Comment:** The paper reports the discovery of a barred-spiral galaxy at z=3.16, focusing on bar identification and properties. The topic is the formation and evolution of massive spiral galaxies, not dwarf galaxies or near-field cosmology. It does not address resolved star formation histories, quenching, stellar models, or galaxy simulations.
...
## 34. [Using SKAO to Understand the Clustering of Gravitational Wave Sources](https://arxiv.org/abs/2606.24846) <a id="link34"></a>
...
**Comment:** Forecasts the use of SKAO and GW detectors to study the clustering of GW sources and their connection to large-scale structure. While it touches on galaxy environments, it does not directly address any core criteria such as near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 36. [Unlocking the Full Potential of SKAO Extra-galactic Science with High-multiplex Optical Spectroscopy](https://arxiv.org/abs/2606.24744) <a id="link36"></a>
...
**Comment:** This paper focuses on the synergy between radio and optical spectroscopy for extragalactic science, including HI content and environmental effects. While it touches on galaxy evolution and environmental effects, it does not directly address any of the core topics such as dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 37. [First Results from the LSST Shadow Survey: The Restless Luminous Blue Variable AT2017des in the Virgo-Cluster Galaxy, NGC4532](https://arxiv.org/abs/2606.23784) <a id="link37"></a>
...
**Comment:** Reports on a luminous blue variable in a Virgo-cluster galaxy and describes the LSST Shadow Survey. While the survey may eventually contribute to galaxy evolution studies, this paper focuses on a transient event and does not match any core criteria.
...
## 38. [Galactic Hubs: New Insights and SKA View of AGN Feedback in Galaxy Groups](https://arxiv.org/abs/2606.24762) <a id="link38"></a>
...
**Comment:** The paper reviews AGN feedback in galaxy groups, focusing on radio-loud AGN and their impact on group environments. While it discusses galaxy evolution and feedback, the emphasis is on AGN-driven processes in galaxy groups, not star-formation-driven outflows or dwarf galaxies. It does not match any core criteria closely.
...
## 39. [Unlocking the Hidden Potential of ALMA Calibrators: A Pilot Blind Search for Galactic Molecular Gas in ALMA Band 1](https://arxiv.org/abs/2606.24463) <a id="link39"></a>
...
**Comment:** This paper presents a pilot blind search for Galactic molecular gas using ALMA calibrator data. While it is innovative in methodology, it does not directly address any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 40. [Constraints on the Gas Geometry Surrounding Little Red Dots through Narrow-Line Diagnostics](https://arxiv.org/abs/2606.23778) <a id="link40"></a>
...
**Comment:** The paper studies the gas geometry around high-redshift sources interpreted as accreting black holes. The focus is on AGN and gas envelopes, not on star formation histories, dwarf galaxies, or galaxy simulations.
...
## 41. [Jet-ISM Interaction and Multi-channel AGN Feedback in the Post-merger Galaxy 4C+29.30](https://arxiv.org/abs/2606.24211) <a id="link41"></a>
...
**Comment:** This paper studies AGN feedback in a post-merger galaxy, focusing on jet-ISM interaction and radiative/mechanical feedback. The outflows discussed are AGN-driven, not star-formation-driven, and the galaxy is not a dwarf. No relevant criteria match.
...
## 42. [Radial gradients revealed by mutliscale outflows from down-the-barrel spectroscopy toward a quasar at redshift 3.4](https://arxiv.org/abs/2606.24085) <a id="link42"></a>
...
**Comment:** The paper discusses multiscale outflows from a quasar, focusing on AGN feedback and wind-ISM/CGM coupling. The outflows are AGN-driven, not star-formation-driven, and the galaxy is a luminous quasar, not a dwarf. No relevant criteria match.
...
## 43. [Accurate modeling for 3$\times$2pt analyses in Roman and Rubin: a study of model approximations](https://arxiv.org/abs/2606.23781) <a id="link43"></a>
...
**Comment:** This paper studies modeling approximations for cosmological analyses in galaxy imaging surveys (Roman and Rubin). While it deals with galaxy imaging and large-scale structure, it does not focus on dwarf galaxies, resolved star formation histories, or numerical galaxy simulations. No criteria match closely.
...
## 44. [SN1987A Constraints of Light $\boldsymbol{Z'}$ with Non-Mixing Polarisations](https://arxiv.org/abs/2606.23769) <a id="link44"></a>
...
**Comment:** This paper revisits constraints on light gauge bosons from SN1987A observations. While SN1987A is a supernova in the LMC, the focus is on particle physics constraints and not on near-field cosmology, resolved star formation histories, or galaxy-scale phenomena.
...
## 45. [Cosmological constraints from the DESI DR1 Bispectrum Full-Shape and DR2 BAO](https://arxiv.org/abs/2606.23936) <a id="link45"></a>
...
**Comment:** This paper presents cosmological constraints from DESI data, focusing on bispectrum and BAO measurements. While it discusses galaxy clustering and the galaxy-halo connection, it does not specifically address near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations. The focus is on cosmological parameters and large-scale structure, not on the detailed properties of galaxies or their evolution.
...
## 46. [Exploring Gravitational Wave Signatures Due to Primordial Non-gaussianity and Large Scale Structure Using SKAO](https://arxiv.org/abs/2606.24868) <a id="link46"></a>
...
**Comment:** This paper explores gravitational wave signatures due to primordial non-gaussianity and large scale structure using SKAO. It is focused on cosmology and gravitational waves, not on galaxy formation, dwarf galaxies, or any of the core topics.
...
## 47. [MINDS: Complementary inclinations in the binary system HK Tau reveal gas- and ice-phase chemistry](https://arxiv.org/abs/2606.23794) <a id="link47"></a>
...
**Comment:** This paper presents JWST/MIRI observations of the binary system HK Tau, revealing gas- and ice-phase chemistry in protoplanetary disks. It is focused on protoplanetary disk chemistry and not on galaxy-scale phenomena, star formation histories, or near-field cosmology.
...
## 48. [Extragalactic test of General Relativity with time-delay gravitational lenses](https://arxiv.org/abs/2606.24278) <a id="link48"></a>
...
**Comment:** This paper tests General Relativity using extragalactic strong lensing systems. While it is astrophysics and extragalactic, it does not focus on near-field cosmology, satellite galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM. The focus is on cosmological tests of gravity, which is outside the core topics.
...
## 49. [Newtonian Shirokov Effect: Epicyclic Frequency Splitting from Mass Multipoles](https://arxiv.org/abs/2606.23912) <a id="link49"></a>
...
**Comment:** This paper analyzes epicyclic frequency splitting in Newtonian potentials, discussing mass multipoles and their effects on orbital dynamics. While it is relevant to stellar and planetary dynamics, it does not address galaxy-scale phenomena, dwarf galaxies, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 50. [Imaging the 21-cm Signal from the Cosmic Dawn & Epoch of Reionization and the Connection with the Global Signal](https://arxiv.org/abs/2606.24724) <a id="link50"></a>
...
**Comment:** The paper discusses imaging the 21-cm signal from the Cosmic Dawn and Epoch of Reionization, focusing on SKA-Low capabilities and analysis methods. While it is cosmological in nature, it does not address near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM of dwarf galaxies. The focus is on large-scale cosmology and not the local universe or galaxy-scale processes.
...
## 51. [EP251023a: A fast X-ray transient featuring a magnetar-powered optical internal plateau followed by a steep decay](https://arxiv.org/abs/2606.24329) <a id="link51"></a>
...
**Comment:** This paper discusses a fast X-ray transient and its magnetar-powered optical plateau, focusing on high-energy transient phenomena in an extragalactic context. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or CGM/outflows. The focus is on transient astrophysical events and magnetar physics.
...
## 52. [Late-Time Oscillating Quintessence in Light of DESI](https://arxiv.org/abs/2606.24221) <a id="link52"></a>
...
**Comment:** The paper studies late-time oscillating quintessence and its impact on cosmological expansion, using DESI data. The focus is on dark energy dynamics and cosmological parameters, not on galaxy-scale phenomena, dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 53. [Nuclei in high-energy neutrino sources: A multimessenger study of in-source propagation](https://arxiv.org/abs/2606.23812) <a id="link53"></a>
...
**Comment:** The paper investigates nuclear composition in high-energy neutrino sources, focusing on multimessenger signals from NGC 1068. The topic is high-energy astrophysics and source physics, not related to near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 54. [Stellar Wind Driven Alfv\'en Wing Dynamics in Planetary and Exoplanetary Magnetospheres](https://arxiv.org/abs/2606.24743) <a id="link54"></a>
...
**Comment:** The paper studies Alfvén wing dynamics in planetary and exoplanetary magnetospheres using MHD simulations. The focus is on planetary magnetospheres and plasma physics, not galaxy-scale phenomena, dwarf galaxies, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 55. [As above, so below: assessing extremeness of the neutron-star equation of state based on the unstable branch](https://arxiv.org/abs/2606.23929) <a id="link55"></a>
...
**Comment:** This paper focuses on neutron star equations of state and high-density physics, which does not match any of the core criteria (no connection to near-field cosmology, galaxy simulations, or stellar models relevant to resolved star formation histories or dwarf galaxies).
...
## 56. [Signatures of $^{56}$Ni Mixing and Neutron-rich Ejecta in Supernovae](https://arxiv.org/abs/2606.23780) <a id="link56"></a>
...
**Comment:** Explores $^{56}$Ni mixing and neutron-rich ejecta in supernovae, focusing on lightcurve modeling and progenitor mapping. Does not match any core criteria (no connection to galaxy evolution, star formation histories, or dwarf galaxies).
...
## 57. [Low-mass X-ray binaries as a probe of Kerr-MOG black hole spacetime](https://arxiv.org/abs/2606.24258) <a id="link57"></a>
...
**Comment:** Studies X-ray binaries and modified gravity black holes, focusing on accretion disk efficiency and jet power. No connection to any core criteria (not related to galaxy evolution, star formation, or stellar models).
...
## 58. [Indication for Decreasing Dispersion Measure in the Population of Repeating Fast Radio Bursts and Connection to Young Supernova Remnant Expansion](https://arxiv.org/abs/2606.23903) <a id="link58"></a>
...
**Comment:** This paper studies dispersion measure evolution in repeating fast radio bursts and connects decreasing DM trends to young supernova remnant expansion. While it discusses SNRs and FRBs, it does not match any of the core galaxy or star formation criteria.
...
## 59. [Weak Lensing with the SKAO: Radio Shear Measurement](https://arxiv.org/abs/2606.24638) <a id="link59"></a>
...
**Comment:** The paper discusses weak lensing measurements in radio surveys, focusing on shape measurement techniques. While weak lensing is a cosmological probe, it does not directly relate to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 60. [Measuring local primordial non-Gaussianity from the clustering of DESI DR1 LRGs and QSOs](https://arxiv.org/abs/2606.24651) <a id="link60"></a>
...
**Comment:** This paper measures primordial non-Gaussianity using DESI LRGs and QSOs. It is focused on cosmological large-scale structure and not on galaxy-scale phenomena, dwarf galaxies, or resolved star formation histories. No criteria match closely.
...
## 61. [Bayesian analysis of Gaia epoch astrometry and radial velocities with kima](https://arxiv.org/abs/2606.24132) <a id="link61"></a>
...
**Comment:** This paper presents software for analyzing Gaia astrometry and radial velocities, mainly for exoplanets and binary stars. It does not address galaxy-scale phenomena, star formation histories, or near-field cosmology.
...
## 62. [Deep Newtonian Afterglows: Theoretical Light Curves for Quasi-spherical Outflows](https://arxiv.org/abs/2606.23904) <a id="link62"></a>
...
**Comment:** This paper models late-time GRB afterglows from quasi-spherical outflows, with implications for the dynamics and energetics of GRB progenitors. It is focused on GRB afterglows and not on galaxy-scale phenomena, star formation histories, or near-field cosmology.
...
## 63. [CHEX-MATE: AMALGAM weak-lensing analysis of 41 Planck Sunyaev-Zel'dovich-selected galaxy clusters](https://arxiv.org/abs/2606.24142) <a id="link63"></a>
...
**Comment:** This paper focuses on weak-lensing analysis and mass calibration of massive galaxy clusters, not dwarf galaxies or satellite systems. It does not address near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM of dwarfs. The focus is on high-mass clusters, which are explicitly outside the relevant criteria.
...
## 64. [Direct Imaging Discovery of Giant Exoplanet $\beta$ Pictoris d: A Decade-Long Game of Hide-and-Seek](https://arxiv.org/abs/2606.23801) <a id="link64"></a>
...
**Comment:** Direct imaging discovery of a giant exoplanet in the $eta$ Pictoris system. No connection to any core criteria (not related to galaxy evolution, star formation, or stellar models).
...
## 65. [Detection of relativistic orbital deformation from improved timing of PSR J1757$-$1854](https://arxiv.org/abs/2606.23926) <a id="link65"></a>
...
**Comment:** The paper reports improved timing of a double neutron star system, testing general relativity. It is focused on pulsar timing and relativistic effects, not on galaxy formation or any of the core topics.
...
## 66. [Quantum Stochastic Inflation](https://arxiv.org/abs/2606.12636) <a id="link66"></a>
...
**Comment:** This paper presents a quantum open-system framework for stochastic inflation, which is cosmology theory and not related to galaxy simulations, star formation histories, or near-field cosmology. No criteria match closely.
...
## 67. [Hydrogen airglow from an escaping ultrahot Jupiter atmosphere](https://arxiv.org/abs/2606.23899) <a id="link67"></a>
...
**Comment:** This paper reports hydrogen emission from an escaping atmosphere of an ultrahot Jupiter exoplanet. It is focused on exoplanet atmospheres and not on galaxy-scale phenomena, star formation histories, or near-field cosmology.
...
## 68. [Charge transfer from ammonia neutralizes propylene oxide cations: Implications for the astrochemistry of chiral molecules](https://arxiv.org/abs/2606.23890) <a id="link68"></a>
...
**Comment:** This paper investigates astrochemical reactions relevant to chiral molecules in the interstellar medium, which is not related to any of the core topics (galaxy evolution, star formation histories, dwarf galaxies, etc.).
...
## 69. [Discovery of a nebula associated with a high proper motion sdB star](https://arxiv.org/abs/2606.24398) <a id="link69"></a>
...
**Comment:** This paper reports the discovery of a nebula associated with a high proper motion sdB star, focusing on stellar and ISM interaction. It does not address any of the core topics (galaxy evolution, star formation histories, dwarf galaxies, etc.).
...
## 70. [Improving Radio Source Count Estimation Using Kernel Density Estimation](https://arxiv.org/abs/2606.24117) <a id="link70"></a>
...
**Comment:** The paper presents improved radio source count estimation using kernel density estimation. While it discusses radio source counts and statistical methods, it does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 71. [The Topology of the Universe](https://arxiv.org/abs/2606.24886) <a id="link71"></a>
...
**Comment:** This paper reviews cosmic topology and its signatures in the CMB and large-scale matter distribution. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on the global structure of the universe, which is outside the scope of the relevant criteria.
...
## 72. [An Agnostic Machine Learning Model of Photosynthetic Habitability](https://arxiv.org/abs/2606.24458) <a id="link72"></a>
...
**Comment:** Presents a machine learning model for photosynthetic habitability on exoplanets, focusing on biosignatures and photosynthesis. No connection to any core criteria (not related to galaxy evolution, star formation, or stellar models).
...
## 73. [Effects of Super-rotating Jets on Phase-Resolved Transmission Spectra at High Spectral Resolution](https://arxiv.org/abs/2606.23910) <a id="link73"></a>
...
**Comment:** This paper models hot Jupiter atmospheric circulation and Doppler shifts in exoplanet transmission spectra. It is unrelated to any of the core criteria (galaxy simulations, star formation histories, etc.).
...
## 74. [Ultra-Precise Astrometric Search for Exoplanets with SKA-VLBI](https://arxiv.org/abs/2606.24862) <a id="link74"></a>
...
**Comment:** The paper discusses ultra-precise astrometric searches for exoplanets using SKA-VLBI. It is focused on exoplanet detection and stellar astrometry, not on any of the core galaxy or star formation criteria.
...
## 75. [Coupled atmospHere Interior modeL Intercomparison (CHILI). I. Evolutionary Modelling -- Primordial Magma Oceans of Earth and Venus](https://arxiv.org/abs/2606.24757) <a id="link75"></a>
...
**Comment:** This paper focuses on coupled interior-atmosphere modeling for Earth and Venus, specifically their primordial magma oceans. It is about planetary evolution and not galaxies, stellar models, or near-field cosmology. No relevant criteria match.
...
## 76. [Minimal Extensions of the $\alpha$-Starobinsky Model: Reconciling ACT DR6 and Reheating Constraints](https://arxiv.org/abs/2606.24131) <a id="link76"></a>

**ArXiv ID:** 2606.24131

**Authors:** Nehla Shobcha, Norma Sidik Risdianto, Romy Hanang Setya Budhi

**Abstract:** The latest combined data from the Atacama Cosmology Telescope (ACT) DR6, Planck, and DESI yields a scalar spectral index $n_s = 0.9743 \pm 0.0034$, which lies approximately $2\sigma$ above the prediction of the standard $\alpha$-Starobinsky inflation model. To address this tension, we propose two minimal extensions that preserve the model's plateau structure and attractor properties: a multiplicative exponential modification and an additive polynomial deformation, both governed by a single small perturbative parameter $\delta>0$. We analytically derive the slow-roll parameters and inflationary observables up to second order in $\delta$ and integrate them with reheating dynamics via the consistency equation. It is shown that the $\delta$ term effectively shifts $n_s$ into the $1\sigma$ confidence region of the joint P-ACT-LB-BK18 dataset without violating the tensor-to-scalar ratio bound ($r < 0.038$). The viable parameter space at $1\sigma$ requires $\alpha \lesssim 35$ with $\delta \sim \mathcal{O}(10^{-2})$ for the exponential model, while the additive model requires $\delta \sim \mathcal{O}(10^{-3})$ for $p=1$ and $\delta \sim \mathcal{O}(10^{-4})$ for $p=2$. For the e-folding range $N_k \in [50, 65]$, the relevant reheating equation of state is $0<\omega_{\mathrm{re}}\le1$. All viable scenarios yield a reheating temperature $T_{\mathrm{re}} \sim 10^9$ GeV, which is safely above the Big Bang Nucleosynthesis (BBN) bound and below the gravitino overproduction limit.

**Comment:** This paper proposes extensions to the Starobinsky inflation model to reconcile cosmological data. It is focused on early universe cosmology and inflation, not galaxy evolution or any of the core criteria.
...
## 77. [Radio eclipse of the slowest spinning Galactic-field spider pulsar PSR J1932+2121 and its X-ray emission prospect](https://arxiv.org/abs/2606.24069) <a id="link77"></a>
...
**Comment:** This paper studies a spider pulsar system, modeling radio eclipses and predicting X-ray emission. It is focused on pulsar binaries and not on galaxy-scale phenomena, star formation histories, or near-field cosmology.
...
## 78. [A thorough investigation of cross-correlation estimators for stochastic gravitational-wave background searches in ground-based detector data](https://arxiv.org/abs/2606.23816) <a id="link78"></a>
...
**Comment:** This paper investigates cross-correlation estimators for stochastic gravitational-wave background searches. It is focused on gravitational wave data analysis and not on galaxy-scale phenomena, star formation histories, or near-field cosmology.
...
## 79. [Multi-peaked high-frequency gravitational waves from PBH-assisted leptogenesis](https://arxiv.org/abs/2606.23787) <a id="link79"></a>
...
**Comment:** This paper discusses primordial black holes and their role in leptogenesis, as well as gravitational wave signatures. It does not address galaxy evolution, star formation histories, dwarf galaxies, or numerical galaxy simulations. The focus is on early universe physics and high-frequency gravitational waves, which are not relevant to the core topics.
...
## 80. [Stochastic Expectation Maximization for Robust State-Space Radio Interferometric Imaging](https://arxiv.org/abs/2606.23944) <a id="link80"></a>
...
**Comment:** This paper presents a robust state-space modeling method for radio interferometric imaging, specifically addressing noise and interference. It is a technical/methodological paper for radio imaging and does not address any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 81. [The large scale structure probes of dark energy](https://arxiv.org/abs/2606.24288) <a id="link81"></a>
...
**Comment:** A review of large scale structure probes of dark energy, including BAO, weak lensing, and cluster counts. These are cosmological probes and do not directly relate to the core topics such as near-field cosmology or galaxy simulations.
...
## 82. [Machine Learning and Deep Learning for Exoplanet Detection and Atmospheric Characterization with JWST and the Upcoming Ariel Mission](https://arxiv.org/abs/2606.23766) <a id="link82"></a>
...
**Comment:** Review of machine learning for exoplanet detection and atmospheric characterization with JWST and Ariel. No connection to any core criteria (not related to galaxy evolution, star formation, or stellar models).
...
## 83. [Chinese Sunspot Drawings and Their Digitization-(VIII) Release of a Machine Readable Parameters Catalog](https://arxiv.org/abs/2606.24321) <a id="link83"></a>
...
**Comment:** This paper presents a digitized catalog of historical sunspot drawings from Chinese observatories. The focus is on solar activity and sunspot measurements, which do not match any of the core criteria (near-field cosmology, resolved star formation histories, galaxy simulations, etc.).
...
## 85. [Magnetized Coulomb crystals in neutron star crusts](https://arxiv.org/abs/2606.24355) <a id="link85"></a>
...
**Comment:** The paper studies magnetized Coulomb crystals in neutron star crusts, which is unrelated to any of the core topics (galaxy evolution, star formation, dwarf galaxies, etc.).
...
## 86. [Constant-Roll Inflation: Analytical Formulae for Power Spectrum and Implications for Induced Gravitational Waves](https://arxiv.org/abs/2606.24111) <a id="link86"></a>
...
**Comment:** This paper discusses constant-roll inflation and its implications for induced gravitational waves, which is unrelated to any of the core topics (galaxy evolution, star formation histories, dwarf galaxies, etc.).
...
## 87. [Inflation in a nutshell: From basics to latest advances](https://arxiv.org/abs/2606.24474) <a id="link87"></a>
...
**Comment:** This is a review and update on inflationary cosmology, focusing on early universe physics and CMB anisotropies. It does not match any of the core criteria related to galaxy evolution, dwarf galaxies, or star formation histories.
...
## 88. [Energy Extraction via Magnetic Reconnection from a Rotating Dyonic Black Hole in $N = 2, \ U(1)^2$ Gauged Supergravity](https://arxiv.org/abs/2606.23862) <a id="link88"></a>
...
**Comment:** The paper studies energy extraction from rotating dyonic black holes via magnetic reconnection, focusing on supergravity and black hole physics. It is unrelated to galaxy evolution, star formation, or any of the core criteria.
...
## 89. [A Novel Arm-Length Stabilization Scheme for Gravitational-Wave Detectors with AlGaAs/GaAs Coated Mirrors](https://arxiv.org/abs/2606.24149) <a id="link89"></a>
...
**Comment:** This paper presents a novel arm-length stabilization scheme for gravitational-wave detectors. It is focused on instrumentation and does not address any of the core topics such as galaxy evolution, star formation, or numerical galaxy simulations.
...
## 90. [Primordial Black Holes: A Review of Formation and Evolution](https://arxiv.org/abs/2606.23846) <a id="link90"></a>
...
**Comment:** This review covers primordial black holes as dark matter candidates and their formation/evolution. It does not address galaxy evolution, star formation histories, dwarf galaxies, or numerical galaxy simulations. The focus is on early universe physics and black holes.
...
## 91. [Widefield Spectroscopic Telescope (WST): coating strategy to achieve high optical throughput](https://arxiv.org/abs/2606.24179) <a id="link91"></a>
...
**Comment:** This paper discusses coating strategies for the Widefield Spectroscopic Telescope, focusing on optical throughput and mirror/lens coatings. It is an instrumentation paper and does not address any of the core topics (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 92. [Toeplitz Determinants and Admissible Correlation Intervals](https://arxiv.org/abs/2606.24603) <a id="link92"></a>
...
**Comment:** This is a mathematical paper on Toeplitz determinants and correlation intervals in random fields. It does not address any astrophysical or galaxy-related criteria, nor does it relate to near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 93. [White paper on the relevance of the European Solar Telescope (EST) for the French heliophysics](https://arxiv.org/abs/2606.24354) <a id="link93"></a>
...
**Comment:** This white paper discusses the European Solar Telescope and its relevance for solar and heliophysics research. The focus is on solar physics, not galaxy-scale phenomena, dwarf galaxies, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 94. [Astrobiology in the Time of Artificial Intelligence](https://arxiv.org/abs/2606.23854) <a id="link94"></a>
...
**Comment:** Discusses the impact of AI on astrobiology and space exploration, with no direct connection to any core criteria (not related to galaxy evolution, star formation, or stellar models).
...
## 95. [The Space Debris Tracking and Surveillance program of the IAC80 telescope](https://arxiv.org/abs/2606.24413) <a id="link95"></a>
...
**Comment:** The paper describes the space debris tracking and surveillance program of the IAC80 telescope. It is about space surveillance and tracking, not galaxy formation or any of the core topics.
...
## 96. [FAST Pulsar Database IV. Spike subpulses and quasi-periodic subpulses of 25 pulsars observed by FAST](https://arxiv.org/abs/2606.23970) <a id="link96"></a>
...
**Comment:** This paper focuses on pulsar subpulse structures and polarization, which does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations. It is unrelated to the specified topics.
...
## 97. [Simulated Gravitational Lensing in the Undergraduate Lab](https://arxiv.org/abs/2606.24581) <a id="link97"></a>
...
**Comment:** This paper describes a laboratory simulation of gravitational lensing for educational purposes. It is unrelated to galaxy evolution, star formation, or any of the core criteria.
...
## 98. [The Galactic Center as a connected ecosystem across spatial and temporal scales](https://arxiv.org/abs/2606.24706) <a id="link98"></a>
...
**Comment:** This paper centers on the Galactic Center, including the supermassive black hole and circumnuclear medium. According to the criteria, papers focused on the Galactic Center are explicitly irrelevant. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 99. [Pioneer 10/11 Telemetry Explanatory Almanac](https://arxiv.org/abs/2606.23755) <a id="link99"></a>

**ArXiv ID:** 2606.23755

**Authors:** Viktor T. Toth

**Abstract:** This document is intended to accompany our first release of edited Pioneer 10/11 telemetry data. The purpose of this data release is to provide a data set for the evaluation of the effect of on-board systematic forces on Pioneer orbits. Telemetry readings were selected for inclusion with this purpose in mind. The files presented here are all in standard formats (tab-delimited ASCII text or Microsoft Excel spreadsheets) and can be utilized using standard data editing tools.   We describe the history and availability of the raw telemetry data, documentation that can be used to interpret the data, and the tools we built in order to extract the data. We also describe script programs that were used to generate data files for release, and the manual editing process that was used to bring these data files to their final form.

**Comment:** This document describes the release of Pioneer 10/11 telemetry data for evaluating systematic forces on spacecraft orbits. The focus is on spacecraft data and orbital mechanics, not galaxy-scale phenomena, dwarf galaxies, star formation histories, quenching, stellar models, or galaxy simulations.
...
## 100. [On-orbit Calibration of the Carruthers GCI: Photon Background Removal](https://arxiv.org/abs/2606.24030) <a id="link100"></a>
...
**Comment:** The paper describes calibration methods for an instrument studying Earth's exosphere. It is unrelated to galaxy evolution, star formation, or any of the core criteria.
