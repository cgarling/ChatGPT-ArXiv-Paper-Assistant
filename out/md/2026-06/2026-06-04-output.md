...
1. [New Measurements of Distances to Galaxies in the NGC 1052 Field with the Hubble and James Webb Space Telescopes: Testing the Bullet-Dwarf Origin of the Trail](#user-content-link1)
**Authors:** Yimeng Tang, Gagandeep S. Anand, Aaron J. Romanowsky, Pieter G. van Dokkum, Kevin A. Bundy

2. [A More Complex Than Expected Formation History of the Milky Way's Last Major Merger](#user-content-link2)
**Authors:** Hai-Feng Wang, Guan-Yu Wang, Giovanni Carraro, Gra\v{z}ina Tautvai\v{s}ien\.e, Joss Bland-Hawthorn, Thor Tepper-Garc\'ia

3. [Studying the absorption signatures of H I Lyman-\alpha\ in the warm-hot circumgalactic medium with TNG50](#user-content-link3)
**Authors:** P. Aparicio Marcos, P. Richter, M. Sparre, F. R\"unger, D. Nelson

4. [TDEs on FIRE: Illuminating the Cosmic Evolution of Tidal Disruption Rates](#user-content-link4)
**Authors:** Rudrani Kar Chowdhury, Lixin Dai, Janet N. Y. Chang, Tsang Keung Chan

5. [The GALAH Survey: Neutron-Capture Elemental Abundances for 350,000 Gaia-RVS Spectra and the Chemodynamics of Accreted Structures](#user-content-link5)
**Authors:** Pradosh Barun Das, Daniel B. Zucker, Aldo Mura-Guzm\'an, Nicholas W. Borsato, Gayandhi M. De Silva, Sven Buder, Diane Feuillet, Thomas Nordlander, Melissa K. Ness, Sarah L. Martell, Janez Kos, Joss Bland-Hawthorn, Ken C. Freeman, Andrew R. Casey, Geraint F. Lewis, Dennis Stello, Richard de Grijs, the GALAH Collaboration

6. [Steep Redshift Evolution of the Ionizing Escape Fraction at $z = 5$--$12$: Empirical Constraints and Comparison with Simulations](#user-content-link6)
**Authors:** Zihan Wang, Huanyuan Shan

7. [A Planetary Nebula from a 5.7 $M_{\odot}$ Progenitor in a 90 Myr M31 Star Cluster](#user-content-link7)
**Authors:** Pinjian Chen, Bingqiu Chen, Xiaodian Chen, Shu Wang, Haibo Yuan

8. [Full Nonlinear Velocity Reconstruction With Transformer and Ensemble Tree Machine Learning](#user-content-link8)
**Authors:** Yulin Gong, Rachel Bean

9. [Cooler Phases of the Circumgalactic Medium Are More Centrally Concentrated: Constraints from Multiphase Absorption Lines](#user-content-link9)
**Authors:** Weiwen Kong, Zeyu Chen, Enci Wang, Haoran Yu, Kai Wang, Dongdong Shi, Cheqiu Lyu, Yuxuan Zhang, Haoyi Zhang, Haowen Guan

10. [Simulating realistic radio morphologies of Fanaroff-Riley I jets in a self-regulating cool-core cluster](#user-content-link10)
**Authors:** L\'ena Jlassi, Rainer Weinberger, Christoph Pfrommer, Maria Werhahn, Joseph Whittingham, Philipp Girichidis

11. [Environmental Dependence of Star Formation and Galaxy Colors around Abell 2029](#user-content-link11)
**Authors:** Xiaolan Hou, Heng Yu

12. [Observational signatures of thermonuclear electron-capture supernovae -- Ne II line strengthening and color evolution as traces of the explosion mechanism](#user-content-link12)
**Authors:** Alexander Holas, Fionntan P. Callan, Samuel W. Jones, Friedrich K. Roepke, R\"udiger Pakmor, Alexandra Kozyreva, Christine E. Collins, Luke J. Shingles, Stuart A. Sim, Joshua M. Pollin

13. [The Origin of Da Scaling: Suppressed Cooling in Fast-Cooling Mixing Layers](#user-content-link13)
**Authors:** Lachlan Lancaster, Drummond B. Fielding, Rajsekhar Mohapatra, Greg L. Bryan

14. [CO-dark molecular gas traced by HCO$^+$ in the diffuse interstellar medium](#user-content-link14)
**Authors:** Daniel R. Rybarczyk, Michael P. Busch, J. R. Dawson, Min-Young Lee, Gan Luo

15. [Three Extremely Metal-Poor stars: discovery of a new CEMP-no star](#user-content-link15)
**Authors:** Partha Pratim Goswami, Aruna Goswami

16. [The Y Dwarf Companion to the White Dwarf WD 0806-66: Resolving the Discrepancy Between Atmospheric and Evolutionary Models](#user-content-link16)
**Authors:** S. K. Leggett, Pascal Tremblin

17. [The role of major mergers in triggering super-Eddington accretion](#user-content-link17)
...
18. [Ceci n'est pas une Couche de M\'elange: The Meaning of Resolved Turbulent Radiative Mixing](#user-content-link18)
**Authors:** Lachlan Lancaster, Rajsekhar Mohapatra, Drummond B. Fielding, Greg L. Bryan

19. [A Measurement of the Thermal and Ionization State of the IGM at $z < 0.5$](#user-content-link19)
**Authors:** Teng Hu, Vikram Khaire, Joseph F. Hennawi, Todd M. Tripp, Jose Onorbe, Michael Walther, Zarija Lukic

20. [Primordial Binary Stars, Mass segregation and Fractality Effects on the Early Evolution of Young Open Clusters](#user-content-link20)
...
21. [Fast-spinning massive black holes from slowly rotating low-metallicity stars: implications for GW231123](#user-content-link21)
**Authors:** N. H. Ismail, N. Yusof, R. Hirschi, A. Griffiths, M. \'A. Aloy, S. Ekstr\"om, G. Meynet

22. [First Constraints on the Ellipticities of Self-Interacting Fermionic Dark Matter Admixed Neutron Stars from Continuous Gravitational-Wave Searches](#user-content-link22)
**Authors:** Premachand Mahapatra, Andrew L. Miller, Prasanta Kumar Das

23. [HETDEX Public Data Release 1: Source Catalog 2 and Data Cubes from ~90 sq deg of Integral-Field Optical Spectroscopy](#user-content-link23)
**Authors:** Erin Mentuch Cooper, Karl Gebhardt, Dustin Davis, Chenxu Liu, Barbara G. Castanheira, Owen Chase, Oscar A. Chavez Ortiz, Robin Ciardullo, Olivia Curtis, Delaney A. Dunne, Neal J. Evans II, Daniel J. Farrow, Maximilian Fabricius, Steven L. Finkelstein, Caryl Gronwall, Nathaniel J. Hamme, Gary J. Hill, Lindsay R. House, Matt J. Jarvis, Donghui Jeong, Andreas Kelz, Eiichiro Komatsu, Mahan Mirza Khanlari, Hasti Khoraminezhad, Wolfram Kollatschny, Maja Lujan Niemeyer, Hanshin Lee, Phillip MacQueen, Deeshani Mitra, Shiro Mukae, Masami Ouchi, Jennifer Poppe, Meredith C. Powell, Mahdi Qezlou, Shun Saito, Donald P. Schneider, Laurel Weiss, Lutz Wisotzki, Gregory R. Zeimann

24. [Cosmic variance or galaxy bias? Disentangling finite-volume and galaxy formation effects in cosmological analysis](#user-content-link24)
**Authors:** Francesco Sinigaglia, Francisco-Shu Kitaura

25. [A multi-eigenbasis approach to covariance matrix denoising for cosmological inference](#user-content-link25)
**Authors:** Wynne Turner

26. [Earliest simultaneous multi-color optical observations of GRB 230328B: from 41 seconds to the host-galaxy identification](#user-content-link26)
**Authors:** T. Komesh, A. Pozanenko, N. Pankov, A. Volnova, P. Minaev, R. Gill, D. Berdikhan, B. Grossan, Z. Maksut, Z. Abdullayev, S. Belkin, M. Krugov, A. Moskvitin, K. Baigarin, A. Tursynkan, E. Klunko, A. Tatarnikov, S. Zheltoukhov, V. Rumyantsev, A. Volvach, L. Volvach, O. A. Burkhonov, S. A. Ehgamberdiev, R. Inasaridze, L. Elenin, A. Krylov, M. Zheltobryukhov, S. B. Pandey, A. K. Ror, R. Gupta, V. Swain, V. Bhalerao, G. C. Anupama, S. Barway, R. S\'anchez-Ram\'irez, A. J. Castro-Tirado, S. Antier, P. Beniamini, E. Abdikamalov

27. [Cosmography of the Sloan Basin of Attraction and Neighborhood](#user-content-link27)
**Authors:** Daniel Pomarede, R. Brent Tully, Aurelien Valade, Noam Libeskind, Yehuda Hoffman

28. [Towards Exascale Computing for Astrophysical Simulation Leveraging the Leonardo EuroHPC System](#user-content-link28)
...
29. [Mapping the star formation peak with LIGO A# and Next-Generation detectors](#user-content-link29)
**Authors:** Divyajyoti, Stephen Fairhurst, Mark Hannam, Mukesh Kumar Singh

30. [SMUGGLE-Ring: Evolutionary link between nuclear star cluster and nuclear disk](#user-content-link30)
**Authors:** SungWon Kwak, Mathias Schultheis, Ivan Minchev, Cristina Chiappini, Woong-Tae Kim, Seungwon Baek, Federico Marinacci, Mark Vogelsberger, Laura V. Sales, Hui Li, Matthias Steinmetz

31. [Multifrequency Synthesis via CHIBI: Colorful Hierarchical Interferometric Bayesian Imaging](#user-content-link31)
**Authors:** Erandi Chavez, Paul Tiede, Sara Issaoun, Michael D. Johnson, Dominic Pesce, Yuh Tsunetoe, Daniel C. M. Palumbo

32. [Preparing for the Early eVolution Explorer: Detecting the Primordial, Transiting Exoplanet Population](#user-content-link32)
...
33. [Fast gravitational waveform models for quasi-circular coalescences of neutron star--black hole binaries](#user-content-link33)
...
34. [Early Multiwavelength Observations of AT 2026fgk: The Luminous Afterglow to Sub-luminous GRB 260310A, Identified Independently of a Gamma-ray Trigger](#user-content-link34)
...
35. [Blue Straggler Stars in Berkeley 18: A Multiwavelength Study of Their Physical Properties and Dynamical Evolution](#user-content-link35)
**Authors:** D. Bisht, Ing-Guey Jiang, K. Belwal, D. C. \c{C}{\i}nar, Alok Durgapal, Shraddha Biswas, A. Raj, Geeta Rangwal, M. S. Bisht, M. Manu

36. [BBN constraints on primordial black holes with a continuous memory-burden crossover](#user-content-link36)
**Authors:** Xuan-Yu Zhang, Mei-Ting Yang, Hong-Bo Jin

37. [Periodic Radio and X-ray Emission from an Accreting White Dwarf Binary](#user-content-link37)
...
38. [Predictive Rankings of the Probability for Temperate Terrestrial Worlds for the HWO ExEP Mission Star List](#user-content-link38)
**Authors:** Jamie Dietrich, Katelyn Ruppert, Austin Ware, Patrick A. Young

39. [Shape of U: Measuring the Curvature of the Universe with Gravitational Waves](#user-content-link39)
**Authors:** Arindam Sharma, Ish Gupta, Anuradha Gupta

40. [Posterior sampling in the Age of Emulators](#user-content-link40)
**Authors:** Andreas Nygaard, Luca Janken, Steen Hannestad, Thomas Tram

41. [HST's Deep Blue: extremely deep UV imaging to reveal the contributors to reionization](#user-content-link41)
...
42. [Identifying Gems from Roman RAPIDly](#user-content-link42)
...
43. [A Model Selection Criterion for Multidimensional Gaussian Processes: Application to Radial Velocities](#user-content-link43)
**Authors:** Barrag\'an Oscar

44. [A candidate cyclotron line at 1.89 keV in the ultraluminous X-ray source NGC 4861 X-2](#user-content-link44)
**Authors:** Sinan Allak, Lorenzo Ducci, Valery F. Suleimanov, Andrea Santangelo, Aysun Akyuz, Santina Piraino, Faruk Soydugan, Amar Deo Chandra, Wei Yu

45. [Rotational Modulation and Long-Term Variability of Magnetic Fields in T-Tauri Stars with IGRINS](#user-content-link45)
**Authors:** Facundo P\'erez Paolino, Lynne Hillenbrand, Jeff Bary

46. [Dissipative Dark Energy can explain the DESI phantom crossing](#user-content-link46)
**Authors:** Prolay Chanda, Subinoy Das, Suratna Das

47. [Long-term investigation of gamma Cas analogs](#user-content-link47)
**Authors:** Yael Naze (FNRS/ULiege), Robbie Webbe (IRAP), Myron A. Smith (Cath. Univ. of America), Christian Motch (Univ. Strasbourg)

48. [Statistical analysis of the relative orientations between filaments and magnetic fields using Herschel and Planck data in star-forming regions](#user-content-link48)
**Authors:** Jonathan Oers, Isabelle Ristorcelli, Katia Ferri\`ere, Mika Juvela, Ludovic Montier, Dana Alina, Julien Montillaud

49. [Rediscussion of eclipsing binaries. Paper 31. The slowly-pulsating B-star system CV Velorum in the PLATO southern field](#user-content-link49)
**Authors:** John Southworth

50. [CMB Bounds on Primordial Black Holes via Radiation Capture](#user-content-link50)
**Authors:** Marzieh Farhang, S. M. S. Movahed

51. [Predictions for the X-ray polarisation modulation in Cygnus X-1 from reflection off the stellar companion and its wind](#user-content-link51)
**Authors:** Bert Vander Meulen, Kun Hu, Victoria Grinberg, Henric Krawczynski

52. [Characterizing Transiting Exoplanet Atmospheres in the 2030s with the Hubble Space Telescope](#user-content-link52)
**Authors:** Joshua D. Lothringer, Hannah R. Wakeford, Robert C. Frazier, Lili Alderson, Munazza K. Alam, David K. Sing, Mei Ting Mak, Nikole K. Lewis, Lia Corrales, Eva-Maria Ahrer

53. [Dynamics and detectability of long-lived non-accretion phases for massive black hole binaries in cold, thermally regulating disks](#user-content-link53)
**Authors:** Christopher Tiede, David O'Neill, Daniel J. D'Orazio

54. [The Extreme Rarity and Physical Properties of Low-redshift AGNs with Balmer Absorption](#user-content-link54)
...
55. [ABCD: The Nuclear Structure of the Little Red Dots Revealted through Absorption, Break, Continuum, and Decrement](#user-content-link55)
**Authors:** Chang-Hao Chen, Jinyi Shangguan, Luis C. Ho, Zijian Zhang, Kohei Inayoshi, Ruancun Li

56. [The geometry of lunar gravitational wave detection](#user-content-link56)
**Authors:** Jacopo Tissino, Filippo Santoliquido, Francesco Iacovelli, Ulyana Dupletsa, Tito Dal Canton, Matteo Ballelli, Ansh Chopra, Luis Enrique Espinosa Castro, Laura Pezzella, Matteo Schulz, Izumi Takimoto Schmiegelow, Jan Harms

57. [Deep Learning with Magnetic Parameter Constraints for Short-Term Prediction of Solar Active Region Vector Magnetic Fields](#user-content-link57)
**Authors:** Yuqing Zhou, Hui Liu, Zhenyu Jin, Yuyang Li, Sizhong Zou, Jiaben Lin, Mingfu Shao, Zhuoheng Huang

58. [The ALMA Survey of Gas Evolution of PROtoplanetary Disks (AGE-PRO): Formaldehyde (H$_2$CO) emission and its links to disk properties](#user-content-link58)
**Authors:** Ella Chevalier, Ke Zhang, Miguel Vioque, Nicol\'as T. Kurtovic, Paola Pinilla, James Miley, Dingshan Deng, John Carpenter, Carolina Agurto-Gangas, Anibal Sierra

59. [Hybrid Particle Gaussian Mixture (H-PGM) Solution for Cislunar Target Tracking](#user-content-link59)
**Authors:** Ishan Paranjape, Tarun Hejmadi, Utkarsh Ranjan Mishra, Suman Chakravorty

60. [Bridging Roche Lobe Overflow and micro-TDEs: The Runaway Evolution of Eccentric Mass Transfer in Star-Black Hole Binaries](#user-content-link60)
**Authors:** Tian-Shun Chen, Dong Lai

61. [Compressed \emph{Gaussian} likelihood for the \textit{Planck} low-$\ell$ data](#user-content-link61)
**Authors:** Nanoom Lee

62. [All-Sky Ultra-Narrowband Spectral Imaging with the OVRO-LWA: Technosignature Constraints and Axion-Like Particle Prospects](#user-content-link62)
...
63. [The open cluster NGC 2509. Stellar rotation and main sequence turnoff extension from FLAMES spectroscopy](#user-content-link63)
**Authors:** C. Boeche, J. Alonso-Santiago, A. Bragaglia, A. Frasca, A. Vallenari, I. N. Kallimanis, R. Carrera, D. Bossini, S. Lucatello, V. DOrazi, G. Costa

64. [Galactic absorption measured by X-ray observations of clusters of galaxies at the low Galactic latitude](#user-content-link64)
**Authors:** Yumiko Anraku, Shigeo Yamauchi, Anje Yoshimoto, Masayoshi Nobukawa, Kumiko K. Nobukawa, Hideki Uchiyama

65. [Radiation-induced electron spin polarization in ultrarelativistic kinetic turbulence](#user-content-link65)
**Authors:** Peng Liu, Karen Z. Hatsagortsyan, Christoph H. Keitel, Zheng Gong

66. [A High-Likelihood Polar Interstellar Meteor Candidate](#user-content-link66)
**Authors:** Richard Cloete, Abraham Loeb

67. [Full-Disk Spectroscopy of the Solar Corona Across a Solar Cycle with Hinode/EIS](#user-content-link67)
**Authors:** James McKevitt, Ignacio Ugarte-Urra, Peter R. Young

68. [Constraining Cosmological Parameters From Statistical Superluminal Effects Without a Distance Ladder](#user-content-link68)
**Authors:** Hichem Guergouri, Omar Nemoul, Jamal Mimouni

69. [The Cosmological Hart-Tipler Conjecture](#user-content-link69)
**Authors:** David Kipping

70. [Mapping the nuclear environments of extreme coronal line emitting galaxies](#user-content-link70)
**Authors:** Daniel Kynoch, Or Graur, Peter Clark, J. N. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. de la Macorra, P. Doel, J. E. Forero-Romero, S. Gontcho A Gontcho, G. Gutierrez, R. Joyce, S. Juneau, M. Landriau, L. Le Guillou, A. Meisner, R. Miquel, J. Moustakas, S. Panda, W. J. Percival, F. Prada, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver, R. Zhou, H. Zou

71. [Temporal Invariance Is an Illusion: Time-Dependent Influences of the Galactic Magnetic Field on UHECR Observations](#user-content-link71)
**Authors:** Veronika Va\v{s}\'i\v{c}kov\'a, Leonel Morej\'on, Karl-Heinz Kampert

72. [Neutrino mass constraints in interacting dark energy models after DESI DR2](#user-content-link72)
**Authors:** Hui Li, Guo-Hong Du, Tian-Nuo Li, Hai-Li Li, Lu Feng, Jing-Fei Zhang, Xin Zhang

73. [Granular mass perturbations on the pulsar - supermassive black hole system](#user-content-link73)
**Authors:** Zexin Hu, Lijing Shao

74. [NSV 4031 is a gamma Doradus variable after all](#user-content-link74)
**Authors:** Christopher Lloyd

75. [$E_{\rm peak}$-$\alpha$ Correlation in Time Resolved GRB Spectra: A Bottom-Up Approach with Optically Thin Inverse Compton Scattering Model](#user-content-link75)
**Authors:** Pragyan Pratim Bordoloi, Ayush Shivkumar, Shabnam Iyyani

76. [NICER detection of a new candidate cyclotron line in the bursting X-ray pulsar GRO J1744-28](#user-content-link76)
**Authors:** Qi Liu, Lingda Kong, Long Ji, Lorenzo Ducci, Xiaohang Dai, Andrea Santangelo, Ce Cai, Shuwang Cui, Mingyu Ge, Shu Zhang, Shuang-Nan Zhang, Lian Tao, Hua Feng, Wei Wang, Valery Suleimanov, Sergey Tsygankov, Juri Poutanen, Alexander Mushtukov

77. [An update to Allocating Time on Scientific Platforms in Outer Space using five cycles of JWST General Observer programs](#user-content-link77)
**Authors:** Christopher Williams

78. [A Common Antimatter Response in AMS-02 Positrons and Antiprotons](#user-content-link78)
**Authors:** Yi Yang

79. [Upper limits on exosatellites around $\beta$ Pictoris b](#user-content-link79)
**Authors:** M. A. Kenworthy, R. Landman, A. Vanderburg, J. E. Rodriguez, J. L. Birkby, I. Macias, D. Gonz\'alez Picos, S. A. Jenkins, E. Kleisioti, T. Stolker, I. Koutalios

80. [Recurrent Coronal Jets and QPPs: Periodic Reconnection and Localized Heating Across Quiet-Sun to Active Regions](#user-content-link80)
**Authors:** Sudheer K. Mishra, Kartika Sangal, Balveer Singh, Ayumi Asai, A. K. Srivastava, Ding Yuan

81. [Relativistic Lightsail Propulsion Dynamics](#user-content-link81)
**Authors:** Chao Shen, Jiaze Li

82. [Integrability of cosmological $R^2$ gravity models with radiation](#user-content-link82)
**Authors:** Vsevolod R. Ivanov, Sergey Yu. Vernov

83. [Blackholistic 2026 meeting report](#user-content-link83)
**Authors:** Rob Fender, Jane Dai, Erin Kara, Sera Markoff, Francesca Panessa, Jiri Svoboda, Heino Falcke

---

## 1. [New Measurements of Distances to Galaxies in the NGC 1052 Field with the Hubble and James Webb Space Telescopes: Testing the Bullet-Dwarf Origin of the Trail](https://arxiv.org/abs/2606.05144) <a id="link1"></a>
...
**Comment:** This paper is highly relevant to near-field cosmology, focusing on the distances and properties of dwarf galaxies in the NGC 1052 field, including ultra-diffuse galaxies deficient in dark matter. It directly addresses satellite galaxy populations and their origins, matching the 'Near-Field Cosmology' criterion.
...
## 2. [A More Complex Than Expected Formation History of the Milky Way's Last Major Merger](https://arxiv.org/abs/2606.04462) <a id="link2"></a>
...
**Comment:** This paper presents evidence for a more complex formation history of the Gaia-Sausage-Enceladus (GSE) structure, identifying multiple substructures and merger episodes in the Milky Way's inner halo. This directly matches the 'Near-Field Cosmology' criterion, specifically signs of historic interactions and accreted stellar halo, and provides new insights into the complexity of the Milky Way's last major merger.
...
## 3. [Studying the absorption signatures of H I Lyman-\alpha\ in the warm-hot circumgalactic medium with TNG50](https://arxiv.org/abs/2606.04083) <a id="link3"></a>
...
**Comment:** This paper investigates the warm-hot circumgalactic medium (CGM) of Milky Way-like galaxies using the TNG50 simulation, focusing on HI Lyman-alpha absorption. It directly matches the 'Circumgalactic Medium' criterion, especially for MW-like galaxies, and uses high-resolution numerical galaxy simulations, making it highly relevant.
...
## 4. [TDEs on FIRE: Illuminating the Cosmic Evolution of Tidal Disruption Rates](https://arxiv.org/abs/2606.04740) <a id="link4"></a>
...
**Comment:** This paper studies tidal disruption rates in galaxies using FIRE-2 cosmological zoom-in simulations, including satellite galaxies and their contribution to TDRs. The focus on satellite galaxies and their role in galaxy assembly is directly relevant to near-field cosmology and numerical galaxy simulations. The use of high-resolution simulations and analysis of satellite contributions makes this highly relevant.
...
## 5. [The GALAH Survey: Neutron-Capture Elemental Abundances for 350,000 Gaia-RVS Spectra and the Chemodynamics of Accreted Structures](https://arxiv.org/abs/2606.04567) <a id="link5"></a>
...
**Comment:** This paper uses chemical abundances to identify debris from the Gaia-Sausage-Enceladus (GSE) accretion event, directly matching the 'Near-Field Cosmology' criterion, specifically signs of historic interactions and accreted stellar halo. The work also uses large spectroscopic datasets and novel data-driven techniques.
...
## 6. [Steep Redshift Evolution of the Ionizing Escape Fraction at $z = 5$--$12$: Empirical Constraints and Comparison with Simulations](https://arxiv.org/abs/2606.04827) <a id="link6"></a>
...
**Comment:** This paper presents empirical constraints on the ionizing photon escape fraction as a function of halo mass and redshift, comparing with simulations. It is relevant to 'Numerical Galaxy Simulations' (comparison with THESAN) and 'Star Formation Driven Outflows' (escape fraction relates to ionizing outflows), and touches on low-mass halos which are important for near-field cosmology and dwarf galaxy evolution.
...
## 7. [A Planetary Nebula from a 5.7 $M_{\odot}$ Progenitor in a 90 Myr M31 Star Cluster](https://arxiv.org/abs/2606.04368) <a id="link7"></a>
...
**Comment:** This paper presents an empirical constraint on the progenitor mass of a planetary nebula in a young M31 star cluster, using color-magnitude diagrams and isochrone fitting. It is relevant to the 'Stellar Models' criterion, as it provides observational constraints on stellar evolution at the high-mass end of PN progenitors, and also touches on resolved star formation histories via CMD analysis. However, it is not directly focused on dwarf galaxies or near-field cosmology.
...
## 8. [Full Nonlinear Velocity Reconstruction With Transformer and Ensemble Tree Machine Learning](https://arxiv.org/abs/2606.05047) <a id="link8"></a>
...
**Comment:** This paper presents machine learning methods for nonlinear velocity reconstruction from galaxy positions, using simulations tailored to DESI and LSST surveys. It is relevant to 'Numerical Galaxy Simulations' (AbacusSummit simulations) and provides new applications for survey data, but does not directly address dwarf galaxies or star formation histories.
...
## 10. [Simulating realistic radio morphologies of Fanaroff-Riley I jets in a self-regulating cool-core cluster](https://arxiv.org/abs/2606.04084) <a id="link10"></a>
...
**Comment:** This paper simulates radio morphologies of AGN jets in a cool-core cluster, using magneto-hydrodynamical simulations and cosmic ray electron spectra. It is relevant to 'Numerical Galaxy Simulations' (high-resolution cluster simulations with new physics models), but the focus is on AGN feedback in massive clusters, not dwarf galaxies or near-field cosmology.
...
## 11. [Environmental Dependence of Star Formation and Galaxy Colors around Abell 2029](https://arxiv.org/abs/2606.04655) <a id="link11"></a>
...
**Comment:** The paper discusses star formation quenching and environmental effects on galaxy evolution, including low-mass galaxies. While the focus is on a cluster environment and includes higher-mass galaxies, the analysis of quenching in low-mass galaxies is relevant to the 'Star Formation Quenching' criterion, but not exclusively focused on dwarfs.
...
## 12. [Observational signatures of thermonuclear electron-capture supernovae -- Ne II line strengthening and color evolution as traces of the explosion mechanism](https://arxiv.org/abs/2606.05119) <a id="link12"></a>
...
**Comment:** This paper presents synthetic observables for thermonuclear electron-capture supernovae, focusing on distinguishing them from CO white dwarf deflagrations. It involves stellar models and explosion mechanisms, which fits the 'Stellar Models' criterion, though the focus is on supernovae rather than evolutionary tracks or atmospheres.
...
## 13. [The Origin of Da Scaling: Suppressed Cooling in Fast-Cooling Mixing Layers](https://arxiv.org/abs/2606.04093) <a id="link13"></a>
...
**Comment:** This paper studies turbulent radiative mixing layers and their cooling behavior, which is relevant to the phase structure of outflows and the circumgalactic medium, especially in the context of galaxy-scale gas flows. However, it does not directly focus on dwarf galaxies or star-formation-driven outflows, so relevance is moderate.
...
## 14. [CO-dark molecular gas traced by HCO$^+$ in the diffuse interstellar medium](https://arxiv.org/abs/2606.04309) <a id="link14"></a>
...
**Comment:** This paper studies CO-dark molecular gas in the diffuse ISM, using HCO+ absorption to trace H2 and constrain the HI-to-H2 transition. It is relevant to 'Stellar Models' (ISM phase transitions) and 'Star Formation Driven Outflows' (as it constrains the conditions for molecular gas formation, which is related to star formation processes), but does not directly address galaxy-scale outflows or dwarf galaxies.
...
## 15. [Three Extremely Metal-Poor stars: discovery of a new CEMP-no star](https://arxiv.org/abs/2606.05154) <a id="link15"></a>
...
**Comment:** This paper presents high-resolution spectroscopic studies of three extremely metal-poor stars, including the discovery of a new CEMP-no star. The focus is on stellar abundances and early nucleosynthetic processes, which are relevant to near-field cosmology, especially constraints on early chemical enrichment and the nature of the first generations of stars. However, it does not directly address satellite galaxies or resolved star formation histories.
...
## 16. [The Y Dwarf Companion to the White Dwarf WD 0806-66: Resolving the Discrepancy Between Atmospheric and Evolutionary Models](https://arxiv.org/abs/2606.04294) <a id="link16"></a>
...
**Comment:** This paper analyzes the atmospheric and evolutionary models of a Y dwarf companion to a white dwarf, focusing on stellar parameters and model discrepancies. It is relevant to stellar models, particularly atmospheric models, but does not present new models or bolometric corrections. The relevance is moderate due to the focus on model comparison.
...
## 17. [The role of major mergers in triggering super-Eddington accretion](https://arxiv.org/abs/2606.04081) <a id="link17"></a>
...
**Comment:** The paper investigates super-Eddington accretion in major mergers of low-mass halos at high redshift using cosmological zoom-in simulations. While it uses high-resolution galaxy simulations and discusses feedback, its focus is on black hole growth and accretion, not on dwarf galaxy evolution, star formation histories, or outflows.
...
## 18. [Ceci n'est pas une Couche de M\'elange: The Meaning of Resolved Turbulent Radiative Mixing](https://arxiv.org/abs/2606.04087) <a id="link18"></a>
...
**Comment:** This paper presents high-resolution simulations of turbulent radiative mixing layers, focusing on phase structure and resolution requirements. While it discusses multiphase astrophysical fluids and simulation methodology, it does not directly address galaxy-scale outflows, CGM, or dwarf galaxies. The simulation work is relevant to numerical methods but not directly to galaxy simulations or the core topics.
...
## 19. [A Measurement of the Thermal and Ionization State of the IGM at $z < 0.5$](https://arxiv.org/abs/2606.05006) <a id="link19"></a>
...
**Comment:** This paper measures the thermal and ionization state of the low-redshift IGM using Ly-alpha forest data and machine learning. It discusses turbulence and heating mechanisms in the IGM, which is tangentially relevant to the circumgalactic medium criterion, but does not focus on dwarf galaxies or connect directly to galaxy outflows.
...
## 20. [Primordial Binary Stars, Mass segregation and Fractality Effects on the Early Evolution of Young Open Clusters](https://arxiv.org/abs/2606.04509) <a id="link20"></a>
...
**Comment:** This paper uses N-body simulations to study the early evolution of young open clusters, focusing on primordial binaries, mass segregation, and fractality. It is relevant to stellar models and numerical simulations, but the focus is on star clusters rather than galaxies. The relevance is borderline due to the simulation aspect.
...
## 21. [Fast-spinning massive black holes from slowly rotating low-metallicity stars: implications for GW231123](https://arxiv.org/abs/2606.04428) <a id="link21"></a>
...
**Comment:** The paper models the evolution and black hole formation of massive Pop III stars, focusing on their rotation and collapse. While it involves stellar models and black hole formation, it does not address galaxy evolution, near-field cosmology, or the other core topics.
...
## 22. [First Constraints on the Ellipticities of Self-Interacting Fermionic Dark Matter Admixed Neutron Stars from Continuous Gravitational-Wave Searches](https://arxiv.org/abs/2606.05082) <a id="link22"></a>
...
**Comment:** The paper investigates gravitational wave emission from neutron stars admixed with self-interacting fermionic dark matter, placing constraints on DM-induced ellipticities. While it deals with dark matter, it focuses on neutron stars and gravitational waves, not on galaxy-scale dark matter profiles or near-field cosmology.
...
## 24. [Cosmic variance or galaxy bias? Disentangling finite-volume and galaxy formation effects in cosmological analysis](https://arxiv.org/abs/2606.04830) <a id="link24"></a>
...
**Comment:** The paper discusses cosmic variance and galaxy bias in cosmological analysis, with applications to BAO measurements. While it is relevant to cosmological parameter estimation, it does not address galaxy evolution, near-field cosmology, or the other core topics.
...
## 25. [A multi-eigenbasis approach to covariance matrix denoising for cosmological inference](https://arxiv.org/abs/2606.04089) <a id="link25"></a>
...
**Comment:** This paper presents a new method for covariance matrix denoising in cosmological inference, specifically for Lyα forest analysis. While it is relevant to cosmological parameter estimation, it does not match any of the core criteria (no focus on galaxy simulations, star formation, or stellar models).
...
## 26. [Earliest simultaneous multi-color optical observations of GRB 230328B: from 41 seconds to the host-galaxy identification](https://arxiv.org/abs/2606.04585) <a id="link26"></a>
...
**Comment:** The paper presents multi-wavelength observations of a gamma-ray burst and its host galaxy, including dust extinction and possible galaxy interactions. While it mentions the host galaxy and its properties, it does not focus on resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 27. [Cosmography of the Sloan Basin of Attraction and Neighborhood](https://arxiv.org/abs/2606.04578) <a id="link27"></a>
...
**Comment:** The paper reconstructs density and velocity fields in the local universe, focusing on the Sloan Great Wall and its basin of attraction. While it deals with cosmic flows and large-scale structure, it does not focus on near-field cosmology topics such as Milky Way satellites or dwarf galaxies.
...
## 28. [Towards Exascale Computing for Astrophysical Simulation Leveraging the Leonardo EuroHPC System](https://arxiv.org/abs/2510.24175) <a id="link28"></a>
...
**Comment:** This paper discusses exascale computing for astrophysical simulations, focusing on code optimization and scalability. While it is relevant to numerical methods, it does not match any of the core criteria (no focus on galaxy simulations, star formation, or stellar models).
...
## 29. [Mapping the star formation peak with LIGO A# and Next-Generation detectors](https://arxiv.org/abs/2606.05151) <a id="link29"></a>
...
**Comment:** This paper discusses mapping the star formation rate density peak using gravitational wave detectors. While it deals with star formation history, it is not resolved (i.e., not from color-magnitude diagrams) and focuses on global SFR at high redshift, not on dwarf galaxies or near-field cosmology. No direct match to core topics.
...
## 30. [SMUGGLE-Ring: Evolutionary link between nuclear star cluster and nuclear disk](https://arxiv.org/abs/2606.05157) <a id="link30"></a>
...
**Comment:** This paper presents high-resolution galaxy simulations (SMUGGLE) of nuclear structures in a Milky Way-mass galaxy, focusing on the bar, nuclear disk, and nuclear star cluster. While it uses advanced numerical galaxy simulations, its focus is on the central regions and bar, which are specifically listed as irrelevant. No direct connection to dwarf galaxies or relevant outflows.
...
## 31. [Multifrequency Synthesis via CHIBI: Colorful Hierarchical Interferometric Bayesian Imaging](https://arxiv.org/abs/2606.04094) <a id="link31"></a>
...
**Comment:** The paper presents a new Bayesian imaging method for radio sources, focusing on jets and galactic nuclei. It does not address galaxy-scale simulations, dwarf galaxies, or any of the core criteria.
...
## 32. [Preparing for the Early eVolution Explorer: Detecting the Primordial, Transiting Exoplanet Population](https://arxiv.org/abs/2606.04283) <a id="link32"></a>
...
**Comment:** The paper discusses a mission to detect young, transiting exoplanets and differentiate between formation scenarios. It does not address resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 33. [Fast gravitational waveform models for quasi-circular coalescences of neutron star--black hole binaries](https://arxiv.org/abs/2606.04810) <a id="link33"></a>
...
**Comment:** This paper presents new gravitational waveform models for neutron star-black hole binaries, including tidal effects and higher-order modes. While it is a numerical modeling paper, it focuses on compact object mergers, not galaxy simulations or star formation histories.
...
## 34. [Early Multiwavelength Observations of AT 2026fgk: The Luminous Afterglow to Sub-luminous GRB 260310A, Identified Independently of a Gamma-ray Trigger](https://arxiv.org/abs/2606.05146) <a id="link34"></a>

**ArXiv ID:** 2606.05146

**Authors:** K. -R. Hinds, A. Y. Q. Ho, Y. Wagh, R. Jayaraman, D. A. Perley, G. Waratkar, A. Bochenek, B. P. Gompertz, C. Fremling, J. Rastinejad, N. Sarin, G. Schroeder, R. A. Perley, G. P. Srinivasaragavan, K. Ackley, T. Ahumada, M. F. Aller, I. Andreoni, A. Aryan, S. Belkin, E. C. Bellm, S. Ben-Ami, T. de Boer, M. Bremer, R. P. Breton, S. B. Cenko, K. C. Chambers, T. -W. Chen, C. T. Christy, G. Corcoran, L. Cotter, M. W. Coughlin, F. Cuadra, V. D'Elia, K. De, V. S. Dhillon, Dimple, M. J. Dyer, A. R. Escorial, D. K. Galloway, S. Garrappa, J. H. Gillanders, M. A. Gurwell, X. J. Hall, M. E. Huber, S. Ibrahim, J. C. Jaimes, P. Jakobsson, E. Kammoun, M. Kasliwal, G. K. Keating, T. Killestein, R. Konno, R. Kotak, D. Kovaleva, A. Krassilchtchikov, A. Kraus, A. Kumar, R. R. Laher, A. Levan, J. Lyman, A. Martin-Carrillo, Z. McGrath, P. Minguez, G. Mo, M. Nicholl, K. Noysena, A. Nugent, L. K. Nuttall, P. O'Brien, D. O'Neill, E. O. Ofek, G. S. H. Paek, P. V. de la Parra, D. Polishook, A. Ruiz Del Pozo, G. Pugliese, J. Purdum, M. Pursiainen, G. Ramsay, R. Rao, A. C. Readhead, P. Rekhi, R. Riddle, S. Rose, B. Rusholme, A. Sasli, D. Schiminovich, E. Segre, C. Sevilla, Y. M. Shani, M. Shrestha, S. J. Smartt, K. W. Smith, J. Sollerman, N. Sravan, S. Srivastav, D. Steeghs, R. Stein, T. Surti, K. Ulaczyk, J. C. Vel'azquez, R. Wainscoat, J. L. Wise, D. Xu, S. Yang

**Abstract:** The origins of sub-luminous ($L_\mathrm{\gamma,\mathrm{iso}} 1\,$mag\,d$^{-1}$), red ($g-r=0.4$\,mag) transient using the Gravitational-wave Optical Transient Observatory, Large Array Survey Telescope, and Zwicky Transient Facility (ZTF) data streams. We present multiwavelength follow-up observations from the first 50\,days, which reveal that GRB 260310A/AT\,2026fgk was sub-luminous ($L_\mathrm{\gamma,iso}=10^{48.8}\,$erg\,s$^{-1}$); it was the most nearby ($z=0.153$) afterglow identified blindly by an optical survey; and that it is one of the brightest afterglows ever observed at X-ray, optical, and radio (cm to mm) wavelengths. We spectroscopically confirm an underlying Ic-BL SN with properties typical of GRB-SNe ($M_\mathrm{ej}\approx3\,M_\odot$, $E_{\rm K}\approx 10^{52}\,$erg). With basic modeling of the afterglow, including the long optical rise ($\approx10^{3}\,$s), we infer either a low initial Lorentz factor ($\Gamma_0\approx40$) or a slightly off-axis viewing angle ($\lesssim3^\circ$). The host galaxy's mass and star formation rate are similar to the hosts of other sub-luminous GRBs. ZTF's flux-limited survey gives a volumetric rate of AT\,2026fgk-like events of $0.30^{+1.37}_{-0.29}\,$Gpc\,$^{-3}$\,yr$^{-1}$, which is consistent with the on-axis, high luminosity ($L_{\rm \gamma,iso}>10^{49.5}$\,erg\,s$^{-1}$) long-GRB rate. The similarity in the rates strongly constrains the prevalence of low-$\Gamma_0$ bursts and the beaming of the initial relativistic material in GRBs.

**Comment:** The paper presents multiwavelength observations of a GRB afterglow and its host galaxy, including star formation rate and mass. However, the focus is on GRB properties and afterglow modeling, not on resolved star formation histories, dwarf galaxy quenching, or near-field cosmology.
...
## 36. [BBN constraints on primordial black holes with a continuous memory-burden crossover](https://arxiv.org/abs/2606.04707) <a id="link36"></a>
...
**Comment:** This paper discusses primordial black holes and their evaporation, focusing on cosmological constraints from Big Bang nucleosynthesis. While it is related to cosmology, it does not address near-field cosmology, dwarf galaxies, or any of the other core topics.
...
## 37. [Periodic Radio and X-ray Emission from an Accreting White Dwarf Binary](https://arxiv.org/abs/2606.04232) <a id="link37"></a>
...
**Comment:** The paper reports on an accreting white dwarf binary and its radio/X-ray emission. While it is an interesting stellar system, it does not relate to near-field cosmology, resolved star formation histories, galaxy simulations, or the other core topics.
...
## 38. [Predictive Rankings of the Probability for Temperate Terrestrial Worlds for the HWO ExEP Mission Star List](https://arxiv.org/abs/2606.04105) <a id="link38"></a>
...
**Comment:** The paper ranks stars for the Habitable Worlds Observatory based on their likelihood of hosting temperate terrestrial planets. While it involves simulated planetary systems, it does not address galaxy evolution, near-field cosmology, or the other core topics.
...
## 39. [Shape of U: Measuring the Curvature of the Universe with Gravitational Waves](https://arxiv.org/abs/2606.04216) <a id="link39"></a>
...
**Comment:** This paper uses gravitational wave standard sirens to measure the curvature of the universe, which is cosmological but not related to near-field cosmology, galaxy simulations, or star formation histories.
...
## 41. [HST's Deep Blue: extremely deep UV imaging to reveal the contributors to reionization](https://arxiv.org/abs/2606.04136) <a id="link41"></a>

**ArXiv ID:** 2606.04136

**Authors:** Ilias Goovaerts, Alexander Beckett, Matthew Hayes, Alberto Saldana-Lopez, Annalisa Citro, Hakim Atek, Harry Teplitz, Roser Pello, Peter Watson, Claudia Scarlata, Mitchell Revalski, Davide Tornotti, Nicolas Laporte, Meriam Ezziati, Callum Witten

**Abstract:** Understanding galaxy evolution in the epoch of reionization and the effect these galaxies had on the transformation of the intergalactic medium from neutral to ionized, is a key goal of modern astrophsyics, and is central to both HST's and JWST's missions. The biggest remaining uncertainty is the escape fraction of ionizing photons from galaxies. Quantifying and understanding this at redshifts close to reionization is an objective only achievable through observations with HST, in particular, deep imaging with the WFC3/UVIS instrument to detect ionizing photons from galaxies at 2<4. A survey across 20 fields with supporting spectroscopy would both build up a sample similar to the state of the art at low redshift, and also overcome the uncertainty stemming from the unknown transmission of ionizing photons through the intergalactic medium. Such a program would establish the tracers of ionizing photon escape to use within the epoch of reionization and reconcile the growth of the first galaxies with the progression and topology of reionization.

**Comment:** The paper focuses on deep UV imaging to study contributors to reionization, mainly at high redshift. It does not address resolved star formation histories, dwarf galaxies, or any of the core criteria.
...
## 42. [Identifying Gems from Roman RAPIDly](https://arxiv.org/abs/2606.05103) <a id="link42"></a>
...
**Comment:** This paper presents a machine learning pipeline for transient detection in the Roman Space Telescope era. While it is relevant to survey data processing, it does not match any of the core criteria (no focus on galaxy simulations, star formation histories, or CGM).
...
## 43. [A Model Selection Criterion for Multidimensional Gaussian Processes: Application to Radial Velocities](https://arxiv.org/abs/2606.04875) <a id="link43"></a>
...
**Comment:** This paper presents a new model selection criterion for multidimensional Gaussian Processes, applied to radial velocity analysis. While it is a methodological improvement for exoplanet detection and stellar activity disentanglement, it does not relate to any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 44. [A candidate cyclotron line at 1.89 keV in the ultraluminous X-ray source NGC 4861 X-2](https://arxiv.org/abs/2606.04734) <a id="link44"></a>
...
**Comment:** This paper reports a candidate cyclotron line in an ultraluminous X-ray source in NGC 4861. The focus is on X-ray spectral features and magnetic fields in a compact object, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 45. [Rotational Modulation and Long-Term Variability of Magnetic Fields in T-Tauri Stars with IGRINS](https://arxiv.org/abs/2606.04124) <a id="link45"></a>
...
**Comment:** The paper investigates magnetic field variability in T-Tauri stars using high-resolution spectra. It focuses on stellar magnetic fields and pre-main-sequence evolution, not on galaxy-scale processes, resolved star formation histories, or near-field cosmology.
...
## 46. [Dissipative Dark Energy can explain the DESI phantom crossing](https://arxiv.org/abs/2606.04886) <a id="link46"></a>
...
**Comment:** The paper presents a dissipative dark energy model to explain DESI phantom crossing. It is focused on cosmological parameters and dark energy, not on galaxy-scale processes, near-field cosmology, or resolved star formation histories.
...
## 47. [Long-term investigation of gamma Cas analogs](https://arxiv.org/abs/2606.04692) <a id="link47"></a>
...
**Comment:** This paper investigates gamma Cas analogs, a subcategory of Be stars with X-ray emission, focusing on their binary status and variability. It is not relevant to the core topics, as it does not address galaxy evolution, star formation histories, or simulations.
...
## 48. [Statistical analysis of the relative orientations between filaments and magnetic fields using Herschel and Planck data in star-forming regions](https://arxiv.org/abs/2606.04713) <a id="link48"></a>
...
**Comment:** The paper analyzes the orientation of filaments and magnetic fields in star-forming regions, but does not address galaxy-scale processes, resolved star formation histories, or dwarf galaxies. It is outside the core criteria.
...
## 49. [Rediscussion of eclipsing binaries. Paper 31. The slowly-pulsating B-star system CV Velorum in the PLATO southern field](https://arxiv.org/abs/2606.04870) <a id="link49"></a>
...
**Comment:** The paper analyzes a B-star eclipsing binary system, focusing on pulsations and stellar parameters. It does not present new stellar models or address any of the core criteria.
...
## 50. [CMB Bounds on Primordial Black Holes via Radiation Capture](https://arxiv.org/abs/2606.05133) <a id="link50"></a>
...
**Comment:** This paper constrains primordial black hole abundance using CMB data. While it is cosmological, it does not address near-field cosmology, galaxy simulations, or star formation histories.
...
## 51. [Predictions for the X-ray polarisation modulation in Cygnus X-1 from reflection off the stellar companion and its wind](https://arxiv.org/abs/2606.04159) <a id="link51"></a>
...
**Comment:** This paper models X-ray polarization in Cygnus X-1 due to reflection off the companion star and its wind. The focus is on X-ray binaries and wind structure, not galaxy-scale outflows or CGM.
...
## 52. [Characterizing Transiting Exoplanet Atmospheres in the 2030s with the Hubble Space Telescope](https://arxiv.org/abs/2606.04144) <a id="link52"></a>
...
**Comment:** This white paper discusses the future of exoplanet atmospheric characterization with Hubble. It does not address galaxy evolution, resolved star formation histories, or near-field cosmology.
...
## 53. [Dynamics and detectability of long-lived non-accretion phases for massive black hole binaries in cold, thermally regulating disks](https://arxiv.org/abs/2606.04082) <a id="link53"></a>
...
**Comment:** This paper studies accretion phases for massive black hole binaries in circumbinary disks, focusing on AGN and accretion disk physics. It does not address galaxy-scale topics, star formation, or near-field cosmology.
...
## 54. [The Extreme Rarity and Physical Properties of Low-redshift AGNs with Balmer Absorption](https://arxiv.org/abs/2606.04712) <a id="link54"></a>
...
**Comment:** This paper studies low-redshift AGNs with Balmer absorption, focusing on circumnuclear gas and accretion properties. It does not address galaxy-scale topics, star formation histories, or near-field cosmology.
...
## 56. [The geometry of lunar gravitational wave detection](https://arxiv.org/abs/2606.04918) <a id="link56"></a>
...
**Comment:** This paper is about lunar gravitational wave detection and its geometry, with a case study on black hole binaries. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 57. [Deep Learning with Magnetic Parameter Constraints for Short-Term Prediction of Solar Active Region Vector Magnetic Fields](https://arxiv.org/abs/2606.04991) <a id="link57"></a>
...
**Comment:** This paper presents a deep learning method for predicting solar active region vector magnetic fields, relevant for space weather forecasting. It does not address galaxy evolution, star formation, or any of the core topics.
...
## 58. [The ALMA Survey of Gas Evolution of PROtoplanetary Disks (AGE-PRO): Formaldehyde (H$_2$CO) emission and its links to disk properties](https://arxiv.org/abs/2606.05132) <a id="link58"></a>
...
**Comment:** This paper studies formaldehyde emission in protoplanetary disks, focusing on disk chemistry and links to disk properties. It is unrelated to galaxy-scale topics, dwarf galaxies, or star formation histories.
...
## 59. [Hybrid Particle Gaussian Mixture (H-PGM) Solution for Cislunar Target Tracking](https://arxiv.org/abs/2606.04334) <a id="link59"></a>
...
**Comment:** This paper presents a new method for cislunar target tracking, which is unrelated to galaxy evolution, near-field cosmology, or star formation histories.
...
## 60. [Bridging Roche Lobe Overflow and micro-TDEs: The Runaway Evolution of Eccentric Mass Transfer in Star-Black Hole Binaries](https://arxiv.org/abs/2606.04966) <a id="link60"></a>
...
**Comment:** The paper studies mass transfer and tidal disruption in star-black hole binaries, focusing on micro-TDEs. This is not relevant to galaxy-scale simulations or any of the core criteria.
...
## 62. [All-Sky Ultra-Narrowband Spectral Imaging with the OVRO-LWA: Technosignature Constraints and Axion-Like Particle Prospects](https://arxiv.org/abs/2606.04304) <a id="link62"></a>
...
**Comment:** The paper presents an all-sky search for technosignatures and axion-like particles using radio imaging. It does not address galaxy evolution, star formation histories, or near-field cosmology.
...
## 63. [The open cluster NGC 2509. Stellar rotation and main sequence turnoff extension from FLAMES spectroscopy](https://arxiv.org/abs/2606.04839) <a id="link63"></a>
...
**Comment:** This paper studies an open cluster in the Galactic disk, focusing on stellar rotation and main sequence turnoff. It does not match any of the core criteria (no resolved star formation histories, no stellar models, no dwarf galaxy focus).
...
## 65. [Radiation-induced electron spin polarization in ultrarelativistic kinetic turbulence](https://arxiv.org/abs/2606.04332) <a id="link65"></a>
...
**Comment:** The focus is on electron spin polarization in ultrarelativistic kinetic turbulence in plasmas, with applications to black holes and magnetar magnetospheres. This is outside the core topics, as it does not address galaxy evolution, star formation, or the other relevant criteria.
...
## 66. [A High-Likelihood Polar Interstellar Meteor Candidate](https://arxiv.org/abs/2606.04379) <a id="link66"></a>
...
**Comment:** This paper reports a candidate interstellar meteor, which is unrelated to the core topics of near-field cosmology, galaxy simulations, or star formation histories.
...
## 68. [Constraining Cosmological Parameters From Statistical Superluminal Effects Without a Distance Ladder](https://arxiv.org/abs/2606.04873) <a id="link68"></a>
...
**Comment:** This paper presents a statistical cosmological test using superluminal motion, focusing on cosmological parameters. It does not address galaxy-scale processes, dwarf galaxies, or any of the core criteria.
...
## 69. [The Cosmological Hart-Tipler Conjecture](https://arxiv.org/abs/2606.04044) <a id="link69"></a>
...
**Comment:** The paper discusses the Hart-Tipler conjecture and cosmological implications of self-replicating probes, not related to galaxy-scale processes or any of the core criteria.
...
## 70. [Mapping the nuclear environments of extreme coronal line emitting galaxies](https://arxiv.org/abs/2606.04090) <a id="link70"></a>
...
**Comment:** The paper studies extreme coronal line emitters and their link to tidal disruption events in galactic nuclei. It does not address galaxy-scale processes, dwarf galaxies, or any of the core criteria.
...
## 71. [Temporal Invariance Is an Illusion: Time-Dependent Influences of the Galactic Magnetic Field on UHECR Observations](https://arxiv.org/abs/2606.04140) <a id="link71"></a>
...
**Comment:** This paper studies the time-dependent influence of the Galactic magnetic field on ultra-high-energy cosmic ray observations. It does not match any of the core criteria (no focus on galaxies, star formation, or stellar models).
...
## 72. [Neutrino mass constraints in interacting dark energy models after DESI DR2](https://arxiv.org/abs/2606.05005) <a id="link72"></a>
...
**Comment:** This paper investigates neutrino mass constraints in interacting dark energy models using cosmological datasets. It is not relevant to near-field cosmology, galaxy simulations, or star formation histories.
...
## 73. [Granular mass perturbations on the pulsar - supermassive black hole system](https://arxiv.org/abs/2606.04762) <a id="link73"></a>
...
**Comment:** This paper models mass perturbations on a pulsar-SMBH system in the Galactic Center. The focus is on the Galactic Center and SMBH, which is explicitly listed as irrelevant for near-field cosmology. No match to core topics.
...
## 74. [NSV 4031 is a gamma Doradus variable after all](https://arxiv.org/abs/2606.04117) <a id="link74"></a>
...
**Comment:** The paper identifies NSV 4031 as a gamma Doradus variable star, which is unrelated to the core topics of galaxy evolution, near-field cosmology, or star formation histories.
...
## 75. [$E_{\rm peak}$-$\alpha$ Correlation in Time Resolved GRB Spectra: A Bottom-Up Approach with Optically Thin Inverse Compton Scattering Model](https://arxiv.org/abs/2606.04894) <a id="link75"></a>
...
**Comment:** This paper investigates gamma-ray burst spectra and their evolution, focusing on radiation mechanisms. It does not match any of the core criteria (no connection to galaxy evolution, star formation, or stellar models).
...
## 76. [NICER detection of a new candidate cyclotron line in the bursting X-ray pulsar GRO J1744-28](https://arxiv.org/abs/2606.04664) <a id="link76"></a>
...
**Comment:** Detection of cyclotron lines in an X-ray pulsar, focusing on accretion physics and magnetic fields. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 77. [An update to Allocating Time on Scientific Platforms in Outer Space using five cycles of JWST General Observer programs](https://arxiv.org/abs/2606.04977) <a id="link77"></a>
...
**Comment:** This paper analyzes time allocation bias in JWST General Observer programs. It is a meta-science study about telescope time allocation, not about galaxy evolution, star formation histories, or numerical simulations.
...
## 81. [Relativistic Lightsail Propulsion Dynamics](https://arxiv.org/abs/2606.04052) <a id="link81"></a>
...
**Comment:** This paper is about relativistic lightsail propulsion for interstellar travel, which is unrelated to any of the core topics such as near-field cosmology, galaxy simulations, or star formation.
...
## 82. [Integrability of cosmological $R^2$ gravity models with radiation](https://arxiv.org/abs/2606.05075) <a id="link82"></a>
...
**Comment:** This is a theoretical cosmology paper on R^2 gravity models with radiation, focusing on integrability and scalar fields. It does not address galaxy-scale topics, star formation, or near-field cosmology.
...
## 83. [Blackholistic 2026 meeting report](https://arxiv.org/abs/2606.04022) <a id="link83"></a>
...
**Comment:** Meeting report on black hole accretion and jet formation across the mass spectrum. No direct connection to dwarf galaxies, galaxy simulations, or star formation histories.
