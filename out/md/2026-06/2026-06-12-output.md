...
1. [DESI as sparse Integral Field Spectrograph I: Spatially resolved chemical enrichment in star-forming galaxies at $z\leq0.1$](#user-content-link1)
...
2. [The Hubble Missing Globular Clusters Survey IV. Ultra-faint compact satellites of the Milky Way. The case of Koposov 2](#user-content-link2)
**Authors:** M. Bellazzini, R. Pascale, E. Dodd, E. Ceccarelli, D. Massari, M. Libralato, S. Cassisi, M. De Leo, A. Della Croce, E. Vesperini, A. Mucciarelli, E. Dalessandro, M. Salaris, F. Aguado-Agelet, A. Bellini, F. R. Ferraro, B. Lanzoni, M. Monelli, S. Saracino

3. [Carbon Abundances in Metal-Poor Stars Reveal Distinct Galaxy and Star Formation Pathways in the Early Universe](#user-content-link3)
**Authors:** Alexander Yelland, Anna Frebel, Xiaowei Ou, Sarah Hughes, Mohammad K. Mardini

4. [SIDM and CDM interpretations of the million-solar-mass lensing perturber JVAS B1938+666-$\mathcal{V}$](#user-content-link4)
**Authors:** Xingyu Zhang, Hai-Bo Yu

5. [Getting to know the Stellar Clusters in NGC 1569: Bayesian inference of stellar cluster properties in a dwarf starburst galaxy](#user-content-link5)
**Authors:** Bjarki Bj\"orgvinsson, Anna F. McLeod, Bronwyn Reichardt Chu, Magdalena J. Hamel-Bravo, Deanne B. Fisher, Mark R. Krumholz

6. [Directional dark matter signatures of the Large Magellanic Cloud](#user-content-link6)
**Authors:** Javier Reynoso-Cordova, Nassim Bozorgnia, Marie-C\'ecile Piro

7. [Feedback in Extragalactic Star Clusters (FEAST): Spectral Energy Distributions and the Physical Properties of Star Clusters in NGC 628 with CIGALE](#user-content-link7)
**Authors:** Sean T. Linden, Angela Adamo, Alex Pedrini, Daniela Calzetti, Helena Faustino Vieira, Bruce E. Elmegreen, John S. Gallagher, Kelsey Johnson, Matteo Messa, Kathryn Grasha, Ana Duarte-Cabral, Arjan Bik, Giacomo Bortolini, Matteo Correnti, Drew Lapeer, Thomas S. -Y. Lai, Goran Ostlin, Linda J. Smith, Monica Tosi

8. [Chemical signatures from the first stars embedded in metal-poor gas in galaxies at cosmic dawn](#user-content-link8)
...
9. [Stellar Population Spectra Incorporating Detailed Binary Evolution using POSYDON](#user-content-link9)
**Authors:** Eirini Kasdagli, Jeff J. Andrews, Bret Lehmer, Rich Townsend, Manor Zapartas, Andreas Zezas, Max Briel, Tassos Fragos, Seth Gossage, Philipp M. Srivastava, Elizabeth Teng

10. [Galaxy formation in modified gravity -- II. galaxy halo connection and assembly bias](#user-content-link10)
**Authors:** Michael Collier, Sownak Bose, Baojiu Li

11. [Feedback-Free Star Formation in Clusters within a Galaxy Simulated at High Resolution in Cosmic Dawn](#user-content-link11)
**Authors:** Hou-Zun Chen, Zhaozhou Li, Avishai Dekel, Zhiyuan Yao, Nir Mandelker, Xi Kang

12. [Unprecedented Constraints on Gas Flows at High Redshift Using Deep JWST/NIRSpec Observations from the LyC22, EXCELS, and AURORA Surveys](#user-content-link12)
...
13. [The effect of near-core mixing on rejuvenation and the asteroseismic properties of massive accretors](#user-content-link13)
**Authors:** Jan Henneco, Dominic M. Bowman

14. [Centrally concentrated star formation in young clusters II: Jet feedback](#user-content-link14)
...
15. [Bar-induced migration of $\omega$ Centauri away from Gaia Sausage-Enceladus](#user-content-link15)
**Authors:** Adam M. Dillamore, Hanyuan Zhang, Vasily Belokurov

16. [Supermassive Black Hole Assembly from Heavy Seeds with Dynamical Friction in the BRAHMA Simulations: Implications for JWST, LISA, and the Local Universe](#user-content-link16)
...
17. [Direct detection of cool molecular gas in a star-forming galaxy at $z=7.31$](#user-content-link17)
**Authors:** Karin Cescon, Jacqueline A. Hodge, Leindert A. Boogaard, Hiddo S. B. Algera, Lucie E. Rowland, Dominik A. Riechers, Renske Smit, Ilse De Looze, Rychard Bouwens, Paul van der Werf, Manuel Aravena, Elisabete da Cunha, Pratika Dayal, Andrea Ferrara, Rebecca Fisher, Hanae Inami, Pavel E. Mancera Pi\~na, Pascal A. Oesch, Andrea Pallottini, Matus Rybak, Sander Schouws, Laura Sommovigo, Mauro Stefanon, Livia Vallini

18. [Are Primordial Black Holes a Natural Dark Matter Candidate?](#user-content-link18)
**Authors:** Stefano Profumo

19. [Beyond the Fundamental Metallicity Relation: galaxy sizes encode the link between inflow and metallicity](#user-content-link19)
**Authors:** N. F. Boardman, V. Wild, D. Scholte, K. Wang, N. Vale Asari, A. Saintonge

20. [Machine Learning Does It and Does It Better: Unearthing Primordial Dark-Matter Velocities from the Matter Power Spectrum](#user-content-link20)
**Authors:** Keith R. Dienes, Jessica N. Howard, Fei Huang, Yuan-Zhen Li, Brooks Thomas

21. [Cluster Mass Inference from Galaxy Kinematics](#user-content-link21)
**Authors:** Bonny Y. Wang, Leander Thiele, Matthew Ho

22. [Magnetic fields at the dawn of structure formation I. The CARLA J1510+5958 proto-cluster](#user-content-link22)
**Authors:** A. Pagliotta, A. Bonafede, C. Stuardi, C. J. Riseley, D. Vall\'es-P\'eerez, P. Tozzi, L. Di Mascolo

23. [Dark Matter with a Drag at Low Redshift](#user-content-link23)
**Authors:** Martin Schmaltz, Eashwar N. Sivarajan

24. [Galaxy clusters in the VIDEO fields: detection and characterisation in the context of MOONRISE](#user-content-link24)
**Authors:** Pierre Galois, Christophe Benoist, Gianluca Castignani, Matteo Maturi, Sophie Maurogordato, Pascale Jablonka, Yannick Bah\'e, Derek McLeod, Rebecca Bowler, Olga Cucciati, Lauro Moscardini, Manuela Magliocchetti, Mario Radovich, Michele Cirasuolo, Giovani Covone, Fergus Cullen, Callum Donnan, Hector Flores, William Hartley, Roberto Maiolino, Ross McLure, Nicolarosario Napolitano, Maurizio Paolillo, Mattia Vaccari

25. [A local Universe catalogue of structures and voids dynamically identified using Cosmic-Flows4++ZOA peculiar velocities](#user-content-link25)
**Authors:** A. M. Hollinger, H. M. Courtois

26. [Dark and Luminous Matter in the Coma Cluster: Probing Galaxy Cluster Assembly Through Filaments with Weak Lensing and Multiwavelength Observations](#user-content-link26)
**Authors:** K. HyeongHan, K. Finner, M. James Jee, W. Lee, Y. Jim\'enez-Teja, S. Cha, W. Kang, H. S. Hwang, H. Cho, E. Churazov, I. Khabibullin, N. Lyskova, R. Sunyaev, A. M. Bykov

27. [3DSTokesFlow: simulation-based inference for 3D Stokes profiles using flow matching](#user-content-link27)
**Authors:** A. Asensio Ramos (IAC, ULL), K. E. Yang (SETI), M. J. Martinez Gonzalez (IAC, ULL), S. Curt Dodds (U. Hawaii), X. Sun (U. Hawaii)

28. [A robust super-time-stepping scheme for Ohmic and ambipolar diffusion](#user-content-link28)
**Authors:** Giancarlo Mattia, Mario Flock, David Melon Fuksman, Anastasia Tzouvanou, Vittoria Berta, Daniele Crocco

29. [A Delayed Multi-channel Progenitor for Apparently Nonrepeating Fast Radio Bursts](#user-content-link29)
**Authors:** Zhao-Wei Du, Xi-Long Fan, Yi-Xiao Li

30. [Natural Supercooling and Reheating along Supersymmetric Flat Directions and Observable Gravitational Waves at the Einstein Telescope and the Cosmic Explorer](#user-content-link30)
**Authors:** Jinzheng Li, Pran Nath

31. [TESS detection of periodic brightness variations during the rise of classical nova PGIR22akgylf](#user-content-link31)
**Authors:** Kirill V. Sokolovsky, Elias Aydi, Konstantin Malanchev, Koji Mukai, Jennifer L. Sokoloski, Laura Chomiuk, Peter Allen Craig, Rebekah A. Hounsell, Justin D. Linford, Isabella Molina, Montana N. Williams, Kishalay De, Mansi M. Kasliwal, Nicholas Earley, David J. Lane, Filipp D. Romanov, Richard Schmidt

32. [Complex yet Hermitian: Gaussian covariance of cross-correlation and multi-tracer power spectra](#user-content-link32)
**Authors:** Federico Montano, Stefano Camera, Emiliano Sefusatti, Mohamed Yousry Elkhashab

33. [Constraining the Geometry of Galactic Dark Matter with Gaia Data Release 3](#user-content-link33)
**Authors:** Francesco Sylos Labini, Roberto Capuzzo-Dolcetta

34. [Multi-Epoch X-Ray Detection of SLSN-I 2018bsz: Constraints on the Powering Mechanism and Ejecta Structure](#user-content-link34)
**Authors:** Julia Ahlvind, Josefin Larsson, Dennis Alp, Ragnhild Lunnan

35. [AESTRA II: Generative Spectral Modeling of the Sun as a Star for Precise Radial Velocities](#user-content-link35)
**Authors:** Yan Liang, Joshua N. Winn, Peter Melchior, Sicong Lu, Quang H. Tran

36. [Classification of Compact Stars via Machine Learning and Neural Network Models](#user-content-link36)
**Authors:** D. Neraki, G. Koufetidis, I. Stergakis, Th. Diakonidis, Ch. C. Moustakidis

37. [X-ray Emission and Stellar Ages of Sun-Like Stars](#user-content-link37)
**Authors:** Breanna A. Binder, Edward W. Schwieterman, Alison Farrish, Sarah Peacock, Margaret C. Turnbull, Stephen R. Kane, Katherine Garcia-Sage

38. [Basis sets and Coulomb resolutions in rotational coordinates](#user-content-link38)
**Authors:** Edward Lilley

39. [Deep optical spectroscopic monitoring of the pulsating ULX NGC 1313 X-2 with longslit Gemini observations](#user-content-link39)
**Authors:** Rajath Sathyaprakash, Timothy. P. Roberts

40. [Grain Alignment and Dust Evolution Physics with Polarisation (GRADE-POL). II. On the physical basis of Serkowski and super-Serkowski polarisation spectra](#user-content-link40)
**Authors:** Le Ngoc Tram, Thiem Hoang, B-G Andersson, Alex Lazarian, Lapo Fanciullo, Bao Truong, Archana Soam

41. [Constraining inhomogeneities and asymmetries in SNe, FBOTs, and other high-energy transients from unresolved radio observations](#user-content-link41)
**Authors:** Fabio De Colle, Rosa L. Becerra, Lizeth A. Meza, Nayana A. J., James K. Leung, Luca Izzo, Raffaella Margutti, Gerardo Urrutia, Enrique Moreno-M\'endez, Leonardo Garc\'ia-Garc\'ia

42. [Field line slippage rate signatures in nonlinear force-free field extrapolations](#user-content-link42)
**Authors:** Sage Stanish, David MacTaggart

43. [Black Hole Polarimetry III: Universal Polarization of Synchrotron Radiation at the Horizon](#user-content-link43)
**Authors:** Andrew Chael, Alexandru Lupsasca, George N. Wong, Zachary Gelles, Eliot Quataert

44. [The X-ray photon index Eddington ratio relation in radio-quiet quasars from XMM-Newton and SDSS](#user-content-link44)
**Authors:** SH. M. Shehata, Baraa Hany, Reham Mostafa

45. [Two pathways to diapycnal mixing in strongly stratified flows with no initial vertical shear](#user-content-link45)
**Authors:** Pascale Garaud, Dante Buhl, Jason Johnstone, Arstanbek Tulekeyev, Nathan van Duker

46. [The ultra low-frequency spectral properties of bright extended radio galaxies in the 3CRR catalogue](#user-content-link46)
**Authors:** J. M. Boxelaar, F. De Gasperin, M. J. Hardcastle, E. De Rubeis, R. J. van Weeren

47. [Spectral analysis of magnetized advective accretion flows around rotating black holes](#user-content-link47)
**Authors:** Mayank Pathak (IISc), Shubhrangshu Ghosh (SRMUS), Banibrata Mukhopadhyay (IISc)

48. [Gravitational wave background from extreme-mass-ratio inspirals](#user-content-link48)
**Authors:** Haoyu Zhao, Yuanhao Zhang, Xilong Fan, Wenbiao Han

49. [Observing Cosmic Reheating with the expanded Simons Observatory](#user-content-link49)
**Authors:** Lei Ming, Marco Drewes

50. [Implementation of multi-grid Poisson solver in numerical relativity and its application to gravitational collapse of massive star](#user-content-link50)
**Authors:** Kenta Kiuchi, Hirotada Okawa

51. [Weak Lensing Spectrotomography: A1767 and A2065](#user-content-link51)
**Authors:** Jubee Sohn (Seoul National University), Ian P. Dell'Antonio (Brown University), Margaret J. Geller (Smithsonian Astrophysical Observatory)

52. [Data-driven modeling of Galactic diffuse emission with multi-wavelength observations](#user-content-link52)
**Authors:** Xi Liu, Xiaodong Li, Sujie Lin, Yihan Liu, Chengyu Shao, Lili Yang, Le Zhang

53. [Spectroscopic modeling of ionic structure in stellar winds of high-mass X-ray binaries](#user-content-link53)
**Authors:** G. Sanjurjo-Ferr\'in, V. Grinberg, I. El Mellah, J. M. Torrej\'on, R. Ballhausen, J. Planelles-Villalba, S. Reyero-Serrantes, J. J. Rodes-Roca, M. Mart\'inez-Chicharro

54. [Finding Novel Precursors for Solar Wind Stream Interaction Regions with Interpretable Deep Learning](#user-content-link54)
**Authors:** Prateek Mayank, Yogesh, Enrico Camporeale, D. Chakrabarty, Lan K Jian, Gregory G. Howes, Thomas E. Berger

55. [Tachyonic Encore: A universal shift of inflationary observables](#user-content-link55)
**Authors:** Diogo S. Gorgulho, Margherita Putti, Rodrigo Gonzalez Quaglia, Ema Dimastrogiovanni, Matteo Fasiello, Diederik Roest

56. [CAPOS: The bulge Cluster APOgee Survey XII. Abundances for 98 PIGS metal-poor Bulge field giants](#user-content-link56)
**Authors:** Carolina Salgado, Sandro Villanova, Doug Geisler, Nicol\'as Barrera

57. [Geometric obstruction to resolving the Hubble tension: orthogonality of scale and shape in distance measurements](#user-content-link57)
**Authors:** Zhihuan Zhou, Zhuang Miao, Sheng Bi, Chaoqian Ai, Hongchao Zhang

58. [Bounds on $\Lambda$ at the Galactic Center](#user-content-link58)
**Authors:** Prajwal Hassan Puttasiddappa, Muzammil Mushtaq, Willian Ramirez, David F. Mota

59. [The first hours and days of the 2021 explosion of the recurrent symbiotic nova RS Ophiuchii](#user-content-link59)
**Authors:** Augustin Skopal, Martin Vra\v{s}\v{t}\'ak, Francois Teyssier, Mitsugu Fujii, Sergei Shugarov, Miroslav \v{S}lechta, Marek Wolf

60. [Thermodynamic coefficients in third-order relativistic fluid dynamics](#user-content-link60)
**Authors:** Teboho Abram Moloi, Azwinndini Muronga

61. [Identification of Lensed Gravitational-Wave Beat Patterns by LISA](#user-content-link61)
**Authors:** Hengyu Wu, Tonghua Liu, Kai Liao

62. [Automatic detection of Flare Ribbon Fine Structures as Proxies for Plasmoid Dynamics in Flare Reconnection](#user-content-link62)
**Authors:** Georgios Chouliaras, Peter F. Wyper, Joel T. Dahlin

63. [Search for High-Frequency Gravitational Waves via Geomagnetic Conversion with Radio Telescopes](#user-content-link63)
**Authors:** Hongliang Tian, Lei Wu, Xiaolong Yang, Qiang Yuan, Bin Zhu

64. [Localization of Chiral Electromagnetic Waves on Thick Axion Domain Walls](#user-content-link64)
**Authors:** Nemanja Kaloper

65. [Gotta light? Illuminating AGN disks with LISA EMRIs](#user-content-link65)
**Authors:** Federico Fantocolli, Francisco Duque, Jonathan Gair

66. [Detection and characterisation of binary asteroid candidates through stellar occultations](#user-content-link66)
**Authors:** R. Lallemand, J. Desmars, B. Sicardy, Z. Liu, P. Tanga, L. Liberato, B. Carry, A. Leroy, Y. Kilic, M. Assafin, A. Siakas, L. Abe, D. Mary, R. Leiva, F. Casarramona, D. Smith, D. Antuszewicz, J. -L. Dauvergne, G. Langin, P. Henarejos, P. -L. Phan, F. Braga-Ribas, A. Castro, A. Pal, \'A. S\'odor, A. Cano Ruiz, A. Ossola, A. Pratt, A. Noschese, A. Manna, A. Eberle, A. Schweizer, A. Wendelborn, A. Marciniak, A. Catapano, B. Zi\'o{\l}kowski, B. Begi\c{c}arslan, B. Kattentidt, B. Lade, B. Whitehurst, C. T. Tezcan, C. Weber, C. Schnabel, C. A. Domingues, C. Ziolek, C. Sartini, C. M. Sch\"afer, C. McPartlin, Cs. Kiss, D. Blazewicz, D. Deneuchatel, D. Herald, D. W. Dunham, D. Sailing, E. Fonseca Morato, E. Goni, E. Fernandez-Garcia, E. Namur Neto, E. Smith, E. Gradovski, E. Donate Lucas, E. Garc\'ia Navarro, E. Kaan \"Ulgen, F. Garcia, F. Genc, G. Margoti, G. Arraras, G. Schmidt, G. Privett, G. Krannich, G. Lyzenga, H. de Groot, I. P\'erez-Garcia, I. Z. Kelkitli, J. M\'anek, J. Flores-Mart\'in, J. Prat, J. Bardecker, J. Delincak, J. Siegert, J. Dunham, J. Moore, J. Talbot, J. A. Berlanga, J. A. Reyes, J. L. Maestre, J. L. Ortiz, J. Collada Barcena, J. Per{\l}a, J. Spagnotto, K. Getrost, K. -L. Bath, K. Harrison, K. Okasaki, K. Bender, M. OConnell, M. Skrutskie, M. Jennings, M. Gutekunst, M. Margoti, M. I\c{c}en, M. Acar, M. Fid\^encio Neto, M. Altan, M. Rottenborn, M. Turchenko, M. A. Alava Amat, M. Kretlow, M. Tekkesinoglu, N. Tak\'acs, N. Karaman, N. Castro-Morales, N. Morales, N. Wakefield, O. Erece, O. Canales Moreno, P. Santos Sanz, P. Fini, P. D. Maley, P. Teckenburg, P. Walker, P. Martorell, P. Gilge, P. Zeleny, P. Stuart, A. Ashimbekova, P. Denyer, R. Sfair, R. Nolthenius, R. Piety, R. Liu, R. Jones, R. Szak\'ats, R. Gon\c{c}alves, S. Pastor, S. Chairetas, S. Kalkan, S. \"Ozel, S. \"Otken, S. Ali\c{s}, S. Tsavdaridis, S. Meister, S. Sposetti, S. Conard, S. Tirak, S. Fisek, T. Swift, T. Haymes, T. Jan\'ik, V. Nikitin, V. Cucchiaro, W. Hanna, R. Dahoumane, W. Ogloza, W. Stewart, W. Beisker, Y. Liu, Y. Avcioglu, S. Quinet, J. -F. Counilh, M. Irzyk, C. Marlot, A. Keijzer, Y. Pinard, X. Dupont, T. Salomon, T. Mollier, T. Legault, S. Valat, S. Kindt, S. Kidd, J. Souchu, S. Vasseur, R. Dequinze, P. Couv\'ee, P. Lemoine, P. Barroy, P. Le Cam, P. -J. Mercier, P. Andr\'e, P. Le Guen, O. Schreurs, M. Boutet, M. Giraud, M. Lecossois, M. Serrau, M. Conjat, L. Herrier, L. Rousselot, J. Delpau, J. Bourgeois, J. -C. Dalouzy, J. -F. Gout, J. -F. Pittet, J. -F. Coliac, J. -L. Dumont, J. -N. Ferrier, J. -P. Nombret, J. -P. Masini, J. -P. Arnould, J. -B. Marquette, G. Arlic, G. Vanwalleghem, F. Denjean, F. Cavaill\'e, E. Barbotin, E. Vauthrin, D. Bourdens, D. Walliang, I. Auvray, C. Latg\'e, C. Lavault, A. Stachowicz, E. Jacquet, C. Rizand, J. Raffard, M. Saillenfest, K. Hussein, M. Montarg\`es, N. Robichon, S. Renner, V. Lapeyr\'ere, W. Thuillot, F. Vachier, D. Hestroffer, A. Vienne, J. Vaubaillon, F. Thill, B. Lott, C. Bourdens, R. Boninsegna, M. -C. Lin, Y. -L. Chen, S. H. Tsai, C. -E. Lee, Y. -N. Lee, Z. -Y. Lin, H. -C. Lin, C. -H. Wang, A. T. L. Shen, T. -H. Chuang, C. -C. Chang, Ha. Watanabe, M. Ida, H. Togashi, A. Asai, T. Nemoto, K. Hosoi, Hi. Watanabe, K. Isobe, H. Yoshihara, T. Horikawa, K. Kitazaki, M. Takimoto, H. Yamamura, M. Yamashita, F. Yoshida, F. Gourdon, D. Tamonis

67. [Feasibility of up-the-ramp sampling under variable sky for ground-based spectrographs](#user-content-link67)
**Authors:** Gaia Gaspar, Marcin Sawicki, Nelson Nunes, Rub\'en J. D\'iaz, James E. H. Turner

68. [Japan's Possible Contributions for Coronagraph of the Habitable Worlds Observatory (HWO)](#user-content-link68)
...
69. [The $M_{\rm BH}$$-$$R_{\rm b}$ relation and the high-mass end of the $M_{\rm BH}$$-$$\sigma$ relation](#user-content-link69)
**Authors:** Bililign Dullo

70. [Simulations of 3-Dimensional Recoil Response to Coherent Elastic Neutrino-Nucleus Scattering Events in Directional Direct Dark Matter Detectors](#user-content-link70)
**Authors:** Kwang-Chang Lai, Chung-Lin Shan

71. [Closure-channel identifiability and two-channel recovery in monatomic kinetic normal shocks](#user-content-link71)
**Authors:** Ehsan Roohi

72. [A simple solution to the monopole problem: SU(5) GUT with symmetry breaking into special subgroup](#user-content-link72)
**Authors:** Yu Hamada, Naoki Yamatsu

73. [TBD LBD: The nature of `little blue dots'](#user-content-link73)
**Authors:** Albert Sneppen, Darach Watson, James H. Matthews, Georgios Nikopoulos

74. [Connecting Polarization to Exoplanet Yield Calculations for HWO](#user-content-link74)
**Authors:** Jaren N. Ashcraft, Scott D. Will, Maxwell A. Millar-Blanchaer, Breann Sitarski, Christopher C. Stark, Ewan S. Douglas, John Krist, Brian Kern, Manuel Quijada

75. [Quantifying Surface Heterogeneity Across Asteroid (101955) Bennu using Candidate Site Remote Sensing Data](#user-content-link75)
**Authors:** Emma-Catherine Belhadfa, Neil E. Bowles, Katherine A. Shirley, Amy A. Simon, Victoria E. Hamilton, Hannah H. Kaplan

76. [Artifact-Conditioned Interval Diagnostics for Flow-Matching Neural Posterior Estimation in a Controlled Gravitational-Wave Benchmark](#user-content-link76)
**Authors:** Zhi Luo, Qi-Qin Jing

77. [A Review on Resolving the Hubble Tension via Late-Universe Physics](#user-content-link77)
**Authors:** Xuan-Dong Jia, Xin-Yi Dai, Yu-Peng Yang, Fa-Yin Wang

78. [Unification models of Active Galactic Nuclei](#user-content-link78)
**Authors:** Claudio Ricci

79. [Influence of the resonance ring gravity on the stellar velocity distribution near the OLR of the Galactic bar](#user-content-link79)
**Authors:** A. M. Melnik, E. N. Podzolkova

80. [What I Wish I had Known When I Began Building Astronomical Instruments](#user-content-link80)
**Authors:** Daniel Fabricant

---

## 1. [DESI as sparse Integral Field Spectrograph I: Spatially resolved chemical enrichment in star-forming galaxies at $z\leq0.1$](https://arxiv.org/abs/2606.12541) <a id="link1"></a>
...
**Comment:** This paper presents spatially resolved chemical abundance profiles in star-forming galaxies, including low-mass dwarf galaxies, using DESI as a sparse integral field spectrograph. It discusses metallicity gradients, star formation efficiency, and feedback, which are directly relevant to resolved star formation histories, star formation quenching, and star formation driven outflows in dwarf galaxies.
...
## 2. [The Hubble Missing Globular Clusters Survey IV. Ultra-faint compact satellites of the Milky Way. The case of Koposov 2](https://arxiv.org/abs/2606.12517) <a id="link2"></a>
...
**Comment:** Directly addresses near-field cosmology by studying ultra-faint compact satellites of the Milky Way, specifically Koposov 2. Uses deep HST photometry and spectroscopic metallicities to derive age, distance, and nature of the object. Highly relevant to near-field cosmology and resolved star formation histories.
...
## 3. [Carbon Abundances in Metal-Poor Stars Reveal Distinct Galaxy and Star Formation Pathways in the Early Universe](https://arxiv.org/abs/2606.12617) <a id="link3"></a>
...
**Comment:** Directly relevant to near-field cosmology: analyzes carbon abundances in metal-poor stars across Milky Way halo, ultra-faint dwarfs, classical dwarfs, accreted dwarfs, and streams. Discusses CEMP fractions, galaxy assembly, and star formation pathways in dwarf satellites. Also touches on resolved star formation histories and quenching in UFDs. Multiple criteria matched.
...
## 4. [SIDM and CDM interpretations of the million-solar-mass lensing perturber JVAS B1938+666-$\mathcal{V}$](https://arxiv.org/abs/2606.12909) <a id="link4"></a>
...
**Comment:** This paper analyzes a million-solar-mass lensing perturber, discussing its density profile and possible interpretations in SIDM and CDM. The object is a low-mass substructure, which is highly relevant to near-field cosmology (core-cusp, substructure, dark matter density profiles). The paper directly addresses the core-cusp problem and substructure in the context of galaxy halos.
...
## 5. [Getting to know the Stellar Clusters in NGC 1569: Bayesian inference of stellar cluster properties in a dwarf starburst galaxy](https://arxiv.org/abs/2606.12536) <a id="link5"></a>
...
**Comment:** This paper presents a Bayesian analysis of stellar clusters in the dwarf starburst galaxy NGC 1569, inferring cluster masses and ages and relating them to local ISM conditions. It directly matches the 'Resolved Star Formation Histories' criterion, as it derives cluster properties from observed data in a dwarf galaxy. It also touches on star formation and feedback in a dwarf galaxy context.
...
## 6. [Directional dark matter signatures of the Large Magellanic Cloud](https://arxiv.org/abs/2606.12535) <a id="link6"></a>
...
**Comment:** Studies the impact of the Large Magellanic Cloud (LMC), a Milky Way satellite, on the local dark matter distribution using cosmological simulations. Directly relevant to near-field cosmology and numerical galaxy simulations, with a focus on satellite interactions and substructure.
...
## 7. [Feedback in Extragalactic Star Clusters (FEAST): Spectral Energy Distributions and the Physical Properties of Star Clusters in NGC 628 with CIGALE](https://arxiv.org/abs/2606.13391) <a id="link7"></a>
...
**Comment:** Uses HST and JWST to derive ages, masses, extinctions, and dust properties for star clusters in NGC 628, including young embedded clusters and feedback mechanisms. This fits the 'Resolved Star Formation Histories' criterion (observational SED fitting for star formation histories) and also touches on 'Star Formation Driven Outflows' and feedback. However, the galaxy is more massive than the LMC, so relevance is slightly reduced.
...
## 8. [Chemical signatures from the first stars embedded in metal-poor gas in galaxies at cosmic dawn](https://arxiv.org/abs/2606.13078) <a id="link8"></a>
...
**Comment:** Highly relevant to near-field cosmology and resolved star formation histories: analyzes chemical signatures from first stars in metal-poor gas in galaxies at cosmic dawn, using JWST spectroscopy. Focuses on chemical abundance patterns and Population III supernovae signatures, which inform early galaxy assembly and star formation.
...
## 9. [Stellar Population Spectra Incorporating Detailed Binary Evolution using POSYDON](https://arxiv.org/abs/2606.13351) <a id="link9"></a>
...
**Comment:** Relevant to stellar models: presents new spectral models for stellar populations incorporating detailed binary evolution, including Wolf-Rayet and stripped helium stars. Provides new spectral libraries for use in fitting codes, which is directly relevant to stellar atmosphere and evolutionary models.
...
## 10. [Galaxy formation in modified gravity -- II. galaxy halo connection and assembly bias](https://arxiv.org/abs/2606.12565) <a id="link10"></a>
...
**Comment:** This paper presents hydrodynamical galaxy simulations in modified gravity, focusing on the galaxy-halo connection and assembly bias. It matches the 'Numerical Galaxy Simulations' criterion, as it uses state-of-the-art simulations to study galaxy formation and clustering.
...
## 11. [Feedback-Free Star Formation in Clusters within a Galaxy Simulated at High Resolution in Cosmic Dawn](https://arxiv.org/abs/2606.12605) <a id="link11"></a>
...
**Comment:** This paper presents a high-resolution cosmological simulation of a massive galaxy at z~10, focusing on star formation in clusters, feedback-free starbursts, and cluster properties. It is a numerical galaxy simulation with new physics (feedback delay, cluster formation), and discusses star formation histories and outflows. However, the galaxy is massive (~10^10 Msun), not a dwarf, so relevance is moderate but not maximal.
...
## 12. [Unprecedented Constraints on Gas Flows at High Redshift Using Deep JWST/NIRSpec Observations from the LyC22, EXCELS, and AURORA Surveys](https://arxiv.org/abs/2606.12686) <a id="link12"></a>
...
**Comment:** This paper investigates star-formation-driven outflows in galaxies at z~3 using absorption lines, including mass-loading factors and the dependence of outflow properties on galaxy inclination. The focus on star-formation-driven outflows and their connection to galaxy properties matches the 'Star Formation Driven Outflows' criterion, though the galaxies are more massive and at higher redshift than the most relevant dwarf galaxy regime.
...
## 13. [The effect of near-core mixing on rejuvenation and the asteroseismic properties of massive accretors](https://arxiv.org/abs/2606.13567) <a id="link13"></a>
...
**Comment:** Presents new stellar structure and evolution models, specifically focusing on near-core mixing and asteroseismic properties in massive accretors. This fits the 'Stellar Models' criterion, though the focus is on high-mass stars and binary accretion rather than low-mass or dwarf galaxy contexts.
...
## 14. [Centrally concentrated star formation in young clusters II: Jet feedback](https://arxiv.org/abs/2606.13666) <a id="link14"></a>
...
**Comment:** This paper presents numerical simulations of star cluster formation, specifically focusing on the impact of protostellar jet feedback on star formation efficiency and cluster structure. It matches the 'Numerical Galaxy Simulations' criterion, and also touches on 'Star Formation Driven Outflows' via jet feedback, though the focus is on star clusters rather than galaxies.
...
## 16. [Supermassive Black Hole Assembly from Heavy Seeds with Dynamical Friction in the BRAHMA Simulations: Implications for JWST, LISA, and the Local Universe](https://arxiv.org/abs/2606.12851) <a id="link16"></a>
...
**Comment:** This paper presents cosmological simulations (BRAHMA) of supermassive black hole assembly, focusing on seeding models and their implications for galaxy populations. While it is a numerical galaxy simulation, the focus is on supermassive black holes and massive galaxies, not dwarf galaxies or near-field cosmology. It does not address the core topics directly.
...
## 17. [Direct detection of cool molecular gas in a star-forming galaxy at $z=7.31$](https://arxiv.org/abs/2606.13393) <a id="link17"></a>
...
**Comment:** This paper presents direct detection of molecular gas in a star-forming galaxy at z=7.31, discussing ISM conditions, gas fractions, and depletion timescales. While it provides insights into galaxy assembly and ISM properties, it does not directly address near-field cosmology, resolved star formation histories, or dwarf galaxies.
...
## 18. [Are Primordial Black Holes a Natural Dark Matter Candidate?](https://arxiv.org/abs/2606.12775) <a id="link18"></a>
...
**Comment:** Borderline relevance: discusses primordial black holes as dark matter candidates, which is tangentially related to near-field cosmology but does not focus on dwarf galaxies, satellite luminosity functions, or resolved star formation histories.
...
## 19. [Beyond the Fundamental Metallicity Relation: galaxy sizes encode the link between inflow and metallicity](https://arxiv.org/abs/2606.13124) <a id="link19"></a>
...
**Comment:** This paper analyzes the mass-metallicity relation and its residuals in galaxies, connecting metallicity to gas mass, galaxy size, and inflow histories. It discusses gas inflows and chemical evolution, which are tangentially related to star formation quenching and galaxy evolution, but does not directly address dwarf galaxies or resolved star formation histories.
...
## 20. [Machine Learning Does It and Does It Better: Unearthing Primordial Dark-Matter Velocities from the Matter Power Spectrum](https://arxiv.org/abs/2606.13527) <a id="link20"></a>
...
**Comment:** This paper uses machine learning to reconstruct primordial dark-matter phase-space distributions from the matter power spectrum. While it is cosmology-focused, it does not directly address near-field cosmology, satellite galaxies, or galaxy simulations. The topic is more about early universe dark matter properties.
...
## 21. [Cluster Mass Inference from Galaxy Kinematics](https://arxiv.org/abs/2606.12938) <a id="link21"></a>
...
**Comment:** The paper develops a machine learning pipeline for inferring galaxy cluster masses from kinematic data. While it is a numerical method applied to galaxy clusters, it does not address galaxy-scale simulations, resolved star formation histories, or near-field cosmology. The focus is on clusters, not galaxies or dwarfs.
...
## 22. [Magnetic fields at the dawn of structure formation I. The CARLA J1510+5958 proto-cluster](https://arxiv.org/abs/2606.12522) <a id="link22"></a>
...
**Comment:** The paper studies magnetic fields in a high-redshift proto-cluster, focusing on the magnetisation of the intra-cluster medium and AGN feedback. While it discusses cluster assembly and magnetic fields, it does not focus on dwarf galaxies, satellite quenching, or galaxy simulations.
...
## 24. [Galaxy clusters in the VIDEO fields: detection and characterisation in the context of MOONRISE](https://arxiv.org/abs/2606.13359) <a id="link24"></a>
...
**Comment:** Analyzes galaxy clusters in VIDEO fields, focusing on detection, characterization, and red-sequence populations. While it discusses galaxy evolution in dense environments, the focus is on galaxy clusters and high-mass galaxies, not dwarf galaxies or near-field cosmology.
...
## 25. [A local Universe catalogue of structures and voids dynamically identified using Cosmic-Flows4++ZOA peculiar velocities](https://arxiv.org/abs/2606.13538) <a id="link25"></a>
...
**Comment:** This paper presents a catalogue of cosmic voids and knots in the local Universe using peculiar velocity data. While it deals with large-scale structure, it does not focus on near-field cosmology (dwarf satellites, accreted halo), resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 26. [Dark and Luminous Matter in the Coma Cluster: Probing Galaxy Cluster Assembly Through Filaments with Weak Lensing and Multiwavelength Observations](https://arxiv.org/abs/2606.12523) <a id="link26"></a>
...
**Comment:** This paper focuses on the Coma cluster, a massive galaxy cluster, and studies its assembly and dark matter distribution using weak lensing and multiwavelength observations. While it discusses dark matter and cluster assembly, it does not focus on dwarf galaxies, satellite luminosity functions, or near-field cosmology. The relevance to the core topics is low.
...
## 27. [3DSTokesFlow: simulation-based inference for 3D Stokes profiles using flow matching](https://arxiv.org/abs/2606.13004) <a id="link27"></a>
...
**Comment:** Presents a new simulation-based inference framework for 3D Stokes profiles using flow matching, trained on 3D MHD simulations of the solar atmosphere. While it is a numerical simulation and generative modeling method, the focus is on the solar atmosphere, not galaxies or the core topics.
...
## 28. [A robust super-time-stepping scheme for Ohmic and ambipolar diffusion](https://arxiv.org/abs/2606.13398) <a id="link28"></a>
...
**Comment:** Develops a robust super-time-stepping scheme for Ohmic and ambipolar diffusion in non-ideal MHD, implemented in PLUTO and tested on protoplanetary disks and molecular clouds. While it is a numerical method relevant to simulations, the focus is not on galaxies or the core topics.
...
## 29. [A Delayed Multi-channel Progenitor for Apparently Nonrepeating Fast Radio Bursts](https://arxiv.org/abs/2606.12960) <a id="link29"></a>
...
**Comment:** This paper investigates the progenitor evolution of nonrepeating fast radio bursts using statistical population models and star formation history. While it discusses star formation history, it is not focused on resolved star formation histories from color-magnitude diagrams or galaxy simulations, and is not directly relevant to the core topics.
...
## 30. [Natural Supercooling and Reheating along Supersymmetric Flat Directions and Observable Gravitational Waves at the Einstein Telescope and the Cosmic Explorer](https://arxiv.org/abs/2606.13597) <a id="link30"></a>
...
**Comment:** The paper discusses supercooled phase transitions in a supersymmetric hidden sector and their gravitational wave signatures, as well as dark matter abundance. While it touches on dark matter, it does not address near-field cosmology, galaxy simulations, or any of the core topics directly.
...
## 31. [TESS detection of periodic brightness variations during the rise of classical nova PGIR22akgylf](https://arxiv.org/abs/2606.12532) <a id="link31"></a>
...
**Comment:** The paper studies periodic brightness variations in a classical nova, focusing on binary interaction and envelope structure. While it discusses stellar phenomena, it does not present new stellar models or address resolved star formation histories or galaxy simulations.
...
## 32. [Complex yet Hermitian: Gaussian covariance of cross-correlation and multi-tracer power spectra](https://arxiv.org/abs/2606.12551) <a id="link32"></a>
...
**Comment:** Paper focuses on analytical modeling of covariance for clustering observables and multi-tracer power spectra, which is relevant to large-scale structure but does not directly address near-field cosmology, satellite galaxies, or any of the core topics. No direct match to the criteria.
...
## 33. [Constraining the Geometry of Galactic Dark Matter with Gaia Data Release 3](https://arxiv.org/abs/2606.12548) <a id="link33"></a>
...
**Comment:** Constrains the geometry of Galactic dark matter using Gaia data, but focuses on the Milky Way disk and halo, not satellite galaxies or near-field cosmology. No matching criteria.
...
## 34. [Multi-Epoch X-Ray Detection of SLSN-I 2018bsz: Constraints on the Powering Mechanism and Ejecta Structure](https://arxiv.org/abs/2606.13128) <a id="link34"></a>
...
**Comment:** Multi-epoch X-ray study of a superluminous supernova; discusses ejecta and circumstellar medium interaction, but not galaxy-scale outflows or dwarf galaxy quenching.
...
## 35. [AESTRA II: Generative Spectral Modeling of the Sun as a Star for Precise Radial Velocities](https://arxiv.org/abs/2606.13574) <a id="link35"></a>
...
**Comment:** This paper presents a generative spectral modeling framework for Sun-as-a-star observations to improve radial velocity measurements. It is focused on stellar activity and exoplanet detection, not on stellar models, resolved star formation histories, or galaxy simulations. No direct match to the core criteria.
...
## 36. [Classification of Compact Stars via Machine Learning and Neural Network Models](https://arxiv.org/abs/2606.13369) <a id="link36"></a>
...
**Comment:** This paper uses machine learning to classify compact stars (neutron stars, quark stars) based on observable properties. It is focused on stellar remnants and dense matter, not on stellar models, resolved star formation histories, or galaxy simulations.
...
## 37. [X-ray Emission and Stellar Ages of Sun-Like Stars](https://arxiv.org/abs/2606.12732) <a id="link37"></a>
...
**Comment:** The paper analyzes X-ray emission and stellar ages of Sun-like stars, focusing on coronal properties and their evolution. While it involves stellar astrophysics, it does not present new stellar models or address resolved star formation histories, quenching, or galaxy simulations. The focus is on individual stars, not galaxies.
...
## 38. [Basis sets and Coulomb resolutions in rotational coordinates](https://arxiv.org/abs/2606.13324) <a id="link38"></a>
...
**Comment:** This paper presents mathematical methods for constructing basis sets in various coordinate systems, with some relevance to galactic dynamics. However, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 39. [Deep optical spectroscopic monitoring of the pulsating ULX NGC 1313 X-2 with longslit Gemini observations](https://arxiv.org/abs/2606.13116) <a id="link39"></a>
...
**Comment:** Spectroscopic monitoring of a ULX in NGC 1313; discusses binary formation history but not resolved star formation histories or dwarf galaxy quenching.
...
## 40. [Grain Alignment and Dust Evolution Physics with Polarisation (GRADE-POL). II. On the physical basis of Serkowski and super-Serkowski polarisation spectra](https://arxiv.org/abs/2606.13123) <a id="link40"></a>
...
## 41. [Constraining inhomogeneities and asymmetries in SNe, FBOTs, and other high-energy transients from unresolved radio observations](https://arxiv.org/abs/2606.12846) <a id="link41"></a>
...
**Comment:** The paper discusses radio observations of high-energy transients (SNe, FBOTs, TDEs, GRBs) and constraining inhomogeneities in their emitting regions. It does not address galaxy-scale processes, resolved star formation histories, or numerical galaxy simulations. The focus is on transient phenomena.
...
## 42. [Field line slippage rate signatures in nonlinear force-free field extrapolations](https://arxiv.org/abs/2606.13090) <a id="link42"></a>
...
**Comment:** The paper investigates magnetic reconnection in solar coronal fields using nonlinear force-free field extrapolations. The focus is on solar physics and magnetic reconnection, not galaxy-scale processes, star formation, or near-field cosmology.
...
## 43. [Black Hole Polarimetry III: Universal Polarization of Synchrotron Radiation at the Horizon](https://arxiv.org/abs/2606.12518) <a id="link43"></a>
...
**Comment:** The paper studies polarization of synchrotron radiation near black hole horizons, focusing on black hole spin and magnetospheres. It is unrelated to the core topics of near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 44. [The X-ray photon index Eddington ratio relation in radio-quiet quasars from XMM-Newton and SDSS](https://arxiv.org/abs/2606.12668) <a id="link44"></a>
...
**Comment:** This paper analyzes X-ray properties of quasars, focusing on the relationship between photon index and Eddington ratio in radio-quiet quasars. It is centered on AGN accretion physics and cosmic evolution of quasars, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 45. [Two pathways to diapycnal mixing in strongly stratified flows with no initial vertical shear](https://arxiv.org/abs/2606.12627) <a id="link45"></a>
...
**Comment:** This paper investigates turbulence and mixing in stratified flows using numerical simulations, but the context is fluid dynamics rather than galaxy simulations or stellar models. No direct relevance to the core topics.
...
## 46. [The ultra low-frequency spectral properties of bright extended radio galaxies in the 3CRR catalogue](https://arxiv.org/abs/2606.13493) <a id="link46"></a>

**ArXiv ID:** 2606.13493

**Authors:** J. M. Boxelaar, F. De Gasperin, M. J. Hardcastle, E. De Rubeis, R. J. van Weeren

**Abstract:** Context. Active galactic nuclei (AGN) jets are fundamental drivers of galaxy evolution, injecting kinetic energy into their environments. The large-scale morphology and spectral properties of these radio galaxies are consequences of complex particle acceleration, energy loss, and absorption processes. While the shape of the synchrotron spectrum encodes the plasma's energetic history, understanding the physics of particle acceleration and duty cycles has historically been limited by a lack of well-resolved observations at ultra-low frequencies ( 1.0 in the lobes. For FR II galaxies, hotspots exhibit steep low-frequency spectra (0.5 - 0.9), suggesting complex acceleration or absorption effects.

**Comment:** This paper analyzes ultra low-frequency spectral properties of bright extended radio galaxies in the 3CRR catalogue, focusing on AGN jets and radio galaxy morphology. It does not address dwarf galaxies, star formation histories, or galaxy simulations.
...
## 47. [Spectral analysis of magnetized advective accretion flows around rotating black holes](https://arxiv.org/abs/2606.12543) <a id="link47"></a>
...
**Comment:** Focuses on spectral analysis of magnetized accretion flows around black holes using MHD and GRMHD simulations. The work is on black hole accretion disks, which is explicitly listed as irrelevant in the criteria.
...
## 48. [Gravitational wave background from extreme-mass-ratio inspirals](https://arxiv.org/abs/2606.12952) <a id="link48"></a>
...
**Comment:** Studies the gravitational wave background from extreme-mass-ratio inspirals (EMRIs) in galactic centers, focusing on SMBHs. The focus is on galactic centers and SMBHs, which are not relevant to the core topics.
...
## 49. [Observing Cosmic Reheating with the expanded Simons Observatory](https://arxiv.org/abs/2606.12519) <a id="link49"></a>
...
**Comment:** Studies cosmic reheating and inflation with Simons Observatory; not related to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 50. [Implementation of multi-grid Poisson solver in numerical relativity and its application to gravitational collapse of massive star](https://arxiv.org/abs/2606.12542) <a id="link50"></a>
...
**Comment:** Irrelevant: focuses on numerical relativity and Poisson solvers for gravitational collapse of massive stars, not galaxy simulations or any of the core topics.
...
## 51. [Weak Lensing Spectrotomography: A1767 and A2065](https://arxiv.org/abs/2606.12613) <a id="link51"></a>
...
**Comment:** Irrelevant: describes weak lensing spectrotomography for galaxy clusters, not focused on dwarf galaxies or resolved star formation histories.
...
## 52. [Data-driven modeling of Galactic diffuse emission with multi-wavelength observations](https://arxiv.org/abs/2606.12832) <a id="link52"></a>
...
**Comment:** This paper models Galactic diffuse emission using multi-wavelength data and machine learning, focusing on the inner Galactic disk and center. It does not match any core criteria, as it is not about dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 53. [Spectroscopic modeling of ionic structure in stellar winds of high-mass X-ray binaries](https://arxiv.org/abs/2606.12723) <a id="link53"></a>
...
**Comment:** This paper models the ionic structure in stellar winds of high-mass X-ray binaries, using spectroscopic and Bayesian methods. It does not match any core criteria, as it is not about galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 54. [Finding Novel Precursors for Solar Wind Stream Interaction Regions with Interpretable Deep Learning](https://arxiv.org/abs/2606.12661) <a id="link54"></a>
...
**Comment:** This paper presents a deep learning model for detecting solar wind stream interaction regions, relevant for space weather. It does not address galaxy simulations, star formation histories, or dwarf galaxies.
...
## 55. [Tachyonic Encore: A universal shift of inflationary observables](https://arxiv.org/abs/2606.12549) <a id="link55"></a>
...
**Comment:** This paper discusses inflationary observables and axion dynamics in the early universe, which is unrelated to the core topics of galaxy evolution, star formation, or stellar models.
...
## 56. [CAPOS: The bulge Cluster APOgee Survey XII. Abundances for 98 PIGS metal-poor Bulge field giants](https://arxiv.org/abs/2606.12583) <a id="link56"></a>
...
**Comment:** This paper analyzes metal-poor bulge field giants in the Milky Way, focusing on their chemical abundances and orbital properties. The focus is on the bulge and bar region, which is explicitly listed as irrelevant for near-field cosmology. It does not address satellite galaxies or resolved star formation histories.
...
## 57. [Geometric obstruction to resolving the Hubble tension: orthogonality of scale and shape in distance measurements](https://arxiv.org/abs/2606.12822) <a id="link57"></a>

**ArXiv ID:** 2606.12822

**Authors:** Zhihuan Zhou, Zhuang Miao, Sheng Bi, Chaoqian Ai, Hongchao Zhang

**Abstract:** We identify a geometric obstruction to resolving the Hubble tension by combining early-time sound-horizon reduction with late-time smooth dark energy. Within $\Lambda$CDM, the BAO--SN matter-density gap $\Delta\Omega_m = 0.037$ is exactly invariant under the sound-horizon rescaling $\alpha \equiv r_s^{\rm mod}/r_s^{\Lambda{\rm CDM}}$, and late-time $w(z)$ deformations cannot eliminate this gap either: reconciling the two datasets requires \emph{opposite} deformations -- phantom ($w  -1$) for SN at $z < 0.5$ -- an anti-alignment quantified by $\cos\theta = -0.97$ in $w(z)$ space. A full MCMC analysis of DESI DR2 BAO, Planck plik\_lite, and Pantheon+ bears this out: the optimal $\alpha^* = 0.992$ ($0.8\%$ $r_s$ reduction) brings the joint fit to $H_0 = 70.3 \pm 0.3\;\mathrm{km\,s^{-1}\,Mpc^{-1}}$, still $3.2\sigma$ below SH0ES, with the inter-dataset tension reduced but not removed. The obstruction reflects not a shortage of model freedom but an irreducible disagreement between probes. The deformation space $\{\alpha, \beta_{\rm damp}, w(z)\}$ already spans $93\%$ of the $\Omega_m$ response direction; nonetheless BAO and SN constrain $\Omega_m$ through independent channels and disagree, while the residual $H_0$ deficit, anchored by the local distance ladder, resides in the absolute distance scale that $w(z)$ reshapes but cannot rescale.

**Comment:** This paper discusses the Hubble tension and geometric constraints in cosmological distance measurements. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 58. [Bounds on $\Lambda$ at the Galactic Center](https://arxiv.org/abs/2606.13356) <a id="link58"></a>

**ArXiv ID:** 2606.13356

**Authors:** Prajwal Hassan Puttasiddappa, Muzammil Mushtaq, Willian Ramirez, David F. Mota

**Abstract:** We constrain the cosmological constant $\Lambda$ using astrometric and spectroscopic observations of the S2, S1, and S14 stars orbiting Sgr A$^*$. The stellar motion is modelled by numerically integrating timelike geodesics in Schwarzschild-de Sitter spacetime, including relativistic redshift and time-delay corrections. Orbital and spacetime parameters are inferred using a Bayesian MCMC analysis. The resulting posterior distributions place upper bounds on the magnitude of $\Lambda$ at the Galactic Center (GC). Combining the independent constraints from the S2, S1, and S14 orbits yields upper bounds of $\Lambda \lesssim 6.9\times10^{-48} \mathrm{m}^{-2}$ at 68\% credibility and $\Lambda \lesssim 1.0\times10^{-38} \mathrm{m}^{-2}$ at 95\% credibility.

**Comment:** Constrains the cosmological constant using stellar orbits at the Galactic Center. The focus is on the Galactic Center, which is explicitly listed as irrelevant in the criteria.
...
## 59. [The first hours and days of the 2021 explosion of the recurrent symbiotic nova RS Ophiuchii](https://arxiv.org/abs/2606.13202) <a id="link59"></a>
...
**Comment:** Examines the early evolution of a recurrent symbiotic nova, focusing on ejecta structure and shock emission. The topic is stellar explosions and accretion onto white dwarfs, not related to any of the core topics.
...
## 60. [Thermodynamic coefficients in third-order relativistic fluid dynamics](https://arxiv.org/abs/2606.12463) <a id="link60"></a>
...
**Comment:** Presents third-order relativistic fluid dynamics and thermodynamic coefficients for gases. The focus is on relativistic gas dynamics, not galaxies, star formation, or any of the core topics.
...
## 61. [Identification of Lensed Gravitational-Wave Beat Patterns by LISA](https://arxiv.org/abs/2606.12792) <a id="link61"></a>
...
**Comment:** Gravitational wave lensing and beat patterns in LISA; not related to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 62. [Automatic detection of Flare Ribbon Fine Structures as Proxies for Plasmoid Dynamics in Flare Reconnection](https://arxiv.org/abs/2606.13291) <a id="link62"></a>
...
**Comment:** Automated detection of flare ribbon fine structures in solar flare simulations; not related to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 63. [Search for High-Frequency Gravitational Waves via Geomagnetic Conversion with Radio Telescopes](https://arxiv.org/abs/2606.13642) <a id="link63"></a>
...
**Comment:** Irrelevant: focuses on high-frequency gravitational wave detection via geomagnetic conversion, not related to galaxy simulations, near-field cosmology, or other core topics.
...
## 64. [Localization of Chiral Electromagnetic Waves on Thick Axion Domain Walls](https://arxiv.org/abs/2606.12513) <a id="link64"></a>
...
**Comment:** Irrelevant: discusses chiral electromagnetic waves on axion domain walls, not related to galaxies, star formation, or any core topics.
...
## 65. [Gotta light? Illuminating AGN disks with LISA EMRIs](https://arxiv.org/abs/2606.12531) <a id="link65"></a>
...
**Comment:** Irrelevant: studies LISA's ability to constrain gas torques on EMRIs in AGN disks, not related to galaxy simulations, near-field cosmology, or other core topics.
...
## 66. [Detection and characterisation of binary asteroid candidates through stellar occultations](https://arxiv.org/abs/2606.13353) <a id="link66"></a>
...
**Comment:** This paper focuses on binary asteroids in the Solar System, using stellar occultations and Gaia data. It does not match any of the core criteria, as it is not about galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 67. [Feasibility of up-the-ramp sampling under variable sky for ground-based spectrographs](https://arxiv.org/abs/2606.13600) <a id="link67"></a>
...
**Comment:** This paper focuses on detector readout methods for ground-based near-infrared spectrographs. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 68. [Japan's Possible Contributions for Coronagraph of the Habitable Worlds Observatory (HWO)](https://arxiv.org/abs/2606.13440) <a id="link68"></a>
...
**Comment:** This paper discusses Japan's possible hardware and science contributions to the coronagraph of the Habitable Worlds Observatory. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 69. [The $M_{\rm BH}$$-$$R_{\rm b}$ relation and the high-mass end of the $M_{\rm BH}$$-$$\sigma$ relation](https://arxiv.org/abs/2606.12669) <a id="link69"></a>

**ArXiv ID:** 2606.12669

**Authors:** Bililign Dullo

**Abstract:** Using a sample of 151 galaxies with dynamically measured black hole (BH) masses ($M_{\rm BH}$), we investigate the scaling relations between $M_{\rm BH}$ and the stellar velocity dispersion, $\sigma$, and, for a subsample of 30 core-S\'ersic galaxies, between $M_{\rm BH}$ and the size of the partially depleted core, $R_{\rm b}$. Core-S\'ersic galaxies, identified using high-resolution $Hubble ~ Space ~ Telescope$ imaging and spanning both the normal-core $(R_{\rm b}0.5$ kpc) regimes, define an updated $M_{\rm BH}$$-$$R_{\rm b}$ relation of the form $M_{\rm BH} \propto R_{\rm b}^{1.16 \pm 0.10}$, with an rms scatter of $\Delta_{\rm rms} \simeq 0.28$ dex in $\log M_{\rm BH}$. We find that S\'ersic and normal-core galaxies together follow a common log-linear $M_{\rm BH}$-$\sigma$ relation with a slope of $4.95 \pm 0.29$ and a scatter $\Delta_{\rm rms} \simeq 0.46$ dex. Deviations from this relation arise at the highest BH masses, where large-core galaxies, including six with direct $M_{\rm BH}$ measurements, drive a significant upturn. We find that these galaxies typically host ultramassive black holes whose masses scale more strongly with $R_{\rm b}$ than $\sigma$, and lie $\sim (1-4$) $~\times$ the intrinsic scatter (0.39 dex) above the relation defined by S\'ersic and normal-core galaxies. The $M_{\rm BH}$$-$$R_{\rm b}$ relation shows $\sim 30$-$47\%$ less scatter in $\log M_{\rm BH}$ than the corresponding $M_{\rm BH}$$-$$\sigma$ relation for the same sample. We interpret the high-mass upturn in the $M_{\rm BH}$$-$$\sigma$ diagram as a consequence of successive major, dry mergers, a scenario that naturally explains the observed flattening of the $\sigma-L_V$ relation at $M_V < -23.5$ mag.

**Comment:** This paper investigates scaling relations between black hole mass and galaxy properties, focusing on core-Sérsic galaxies and the high-mass end of the M_BH-sigma relation. The focus is on massive galaxies and supermassive black holes, which are not relevant to the core topics.
...
## 70. [Simulations of 3-Dimensional Recoil Response to Coherent Elastic Neutrino-Nucleus Scattering Events in Directional Direct Dark Matter Detectors](https://arxiv.org/abs/2606.13469) <a id="link70"></a>
...
**Comment:** Simulates neutrino-nucleus scattering in dark matter detectors; not related to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 71. [Closure-channel identifiability and two-channel recovery in monatomic kinetic normal shocks](https://arxiv.org/abs/2606.12447) <a id="link71"></a>
...
**Comment:** This paper deals with kinetic theory and closure variables in monatomic normal shocks, which is a topic in fluid dynamics and plasma physics, not directly related to galaxy simulations or stellar models.
...
## 72. [A simple solution to the monopole problem: SU(5) GUT with symmetry breaking into special subgroup](https://arxiv.org/abs/2606.12874) <a id="link72"></a>
...
**Comment:** Addresses the monopole problem in SU(5) GUTs and cosmic strings; not related to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 73. [TBD LBD: The nature of `little blue dots'](https://arxiv.org/abs/2606.12509) <a id="link73"></a>
...
**Comment:** Explores the nature of 'little blue dots' in AGN spectra; not related to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 74. [Connecting Polarization to Exoplanet Yield Calculations for HWO](https://arxiv.org/abs/2606.12842) <a id="link74"></a>
...
**Comment:** Irrelevant: discusses polarization aberrations in exoplanet yield calculations for the Habitable Worlds Observatory, not related to any core topics.
...
## 75. [Quantifying Surface Heterogeneity Across Asteroid (101955) Bennu using Candidate Site Remote Sensing Data](https://arxiv.org/abs/2606.12642) <a id="link75"></a>
...
**Comment:** Irrelevant: analyzes surface heterogeneity of asteroid Bennu using remote sensing data, not related to galaxies or any core topics.
...
## 76. [Artifact-Conditioned Interval Diagnostics for Flow-Matching Neural Posterior Estimation in a Controlled Gravitational-Wave Benchmark](https://arxiv.org/abs/2606.12496) <a id="link76"></a>
...
**Comment:** This paper is about neural posterior estimation for gravitational-wave inference, focusing on calibration and diagnostics. It does not match any of the core criteria, as it is not about galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM.
...
## 78. [Unification models of Active Galactic Nuclei](https://arxiv.org/abs/2606.12511) <a id="link78"></a>
...
**Comment:** This is a review of unification models for Active Galactic Nuclei, focusing on supermassive black holes, accretion disks, and AGN feedback. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 79. [Influence of the resonance ring gravity on the stellar velocity distribution near the OLR of the Galactic bar](https://arxiv.org/abs/2606.12589) <a id="link79"></a>
...
**Comment:** Focuses on the Galactic bar and resonance rings, which is not relevant to near-field cosmology or satellite galaxies. No matching criteria.
...
## 80. [What I Wish I had Known When I Began Building Astronomical Instruments](https://arxiv.org/abs/2606.12653) <a id="link80"></a>
...
**Comment:** Irrelevant: personal lessons learned in astronomical instrument building, not related to any core topics.
