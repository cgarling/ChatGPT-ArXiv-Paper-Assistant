...
1. [Finite-Core Signatures in LISA-Band Wave-Optics Lensing by Low-Mass Dark Matter Halos](#user-content-link1)
**Authors:** Dejiang Li, Tonghua Liu, Kai Liao, Beining Xia, Cuihong Wen, Jieci Wang

2. [Cooling, conduction, compact objects: Gravothermal evolution of dissipative self-interacting dark matter halos](#user-content-link2)
**Authors:** Ludwig D. Schmidt, Moritz S. Fischer, Mathias Garny

3. [The Curious Case of Dark Faculae on M Dwarf Stars](#user-content-link3)
**Authors:** Alexander~I. ~Shapiro, Sara~Seager, Sami~K. ~Solanki, Nadiia~Kostogryz, Veronika~Witzke, Krishnamurthy~Sowmya, Tanayveer~Bhatia, Yvonne~C. ~Unruh, Robert~Cameron

4. [An Ultramassive White Dwarf with a Likely Oxygen-Neon Core](#user-content-link4)
...
5. [Multi-band Structural Analysis of KiDS-selected Low Surface Brightness Galaxies with Hyper Suprime-Cam Imaging](#user-content-link5)
**Authors:** Dipanjan Mitra, Kanak Saha

6. [Incorporating physical source parameters into microlensing modeling](#user-content-link6)
**Authors:** Mateusz J. Mr\'oz, Rados{\l}aw Poleski, Andrzej Udalski, Jan Skowron, Pawe{\l} Pietrukowicz, Micha{\l} K. Szyma\'nski, Przemek Mr\'oz, Mariusz Gromadzki, Patryk Iwanek, Szymon Koz{\l}owski, Milena Ratajczak, Krzysztof A. Rybicki, Dorota M. Skowron, Igor Soszy\'nski, Krzysztof Ulaczyk, Marcin Wrona, Zofia Buzik

7. [On the impact of the carbon fusion rate over the properties of superbursts -- Numerical simulations of superbursts with MESA](#user-content-link7)
**Authors:** Martin Nava-Callejas, St\'ephane Goriely, Nicolas Chamel

8. [A Be-shell star rotating at the critical limit and a partially stripped companion in a post-mass-transfer solution for the eclipsing binary V505 Mon](#user-content-link8)
**Authors:** Norbert Hauck

9. [A Virgo Environmental Survey Tracing Ionised Gas Emission (VESTIGE) XX. Star formation in the tidal tail of NGC 4254](#user-content-link9)
...
10. [Reimagining SED Fitting with Cosmological Galaxy Simulations and Machine Learning](#user-content-link10)
**Authors:** Dhruv T. Zimmerman, Desika Narayanan

11. [Increasing the sensitivity of full-shape galaxy clustering measurements in configuration-space with three-point statistics](#user-content-link11)
**Authors:** Zachery Brown, Lado Samushia

12. [Steady-state Stellar Winds Driven by Recombination](#user-content-link12)
**Authors:** Eritas Yang, Eliot Quataert

13. [The fate of Earth during the Sun's giant phases: New constraints from ab initio tidal modelling and AGB mass loss](#user-content-link13)
**Authors:** M. Esseldeurs, S. Mathis, L. Decin

14. [The impact of evolving cosmic filaments on mass and spin evolution of dark matter halos](#user-content-link14)
**Authors:** Hannah Jhee, Hyunmi Song, Clotilde Laigle, Christophe Pichon, Corentin Cadiou, Ena Choi

15. [Enhancing the Detection Sensitivity of Primordial Parity Violation using Galaxy Spins](#user-content-link15)
**Authors:** Byoungjo Yu, Junsup Shim, Hyunmi Song

16. [Evidence for protostellar jets as a population of hadronic gamma-ray sources](#user-content-link16)
**Authors:** Javier M\'endez-Gallego, Rub\'en L\'opez-Coto, Emma de O\~na Wilhelmi, Stefano Menchiari, Iv\'an Agudo, Rub\'en Fedriani

17. [Statistical Field Theory for Weak Gravitational Lensing](#user-content-link17)
**Authors:** Zheng Zhang, Philip Bull, Chris Clarkson, Andrina Nicola

18. [Lightstack: A Python Package for Creating Photometric Data Cubes](#user-content-link18)
**Authors:** Andressa Wille, Rafael S. de Souza, Ana L. Chies-Santos, Thallis Pessi, Emille E. O. Ishida, Alberto Krone-Martins

19. [Supernova Remnants in the IXPE era: a review](#user-content-link19)
**Authors:** Riccardo Ferrazzoli, IXPE Collaboration

20. [UCLCHEM 4.0: An open source gas-grain astrochemistry simulation framework](#user-content-link20)
**Authors:** Gijs Vermari\"en, Serena Viti, Tobias M. Dijkhuis, Le Ngoc Tram, Marcus Keil, Katarzyna M. Dutkowska, Felix D. Priestley

21. [Characterizing the Formation and Evolution of S0-galaxies (CaFES-0): Their formation pathways around Galaxy Clusters](#user-content-link21)
**Authors:** Diego Pallero, Yara L. Jaff\'e, Amelia Fraser-McKelvie, Lodovico Coccato, Facundo A. G\'omez, Yannick Bah\'e, Evelyn J. Johnston, Ciria Lima-Dias, Arianna Cortesi, Maria Emilia De Rossi

22. [A Consistent Comparison of Intracluster Light Assembly in Simulations I. Redshift Evolution and Progenitor Galaxies](#user-content-link22)
**Authors:** Harley J. Brown (University of Nottingham), Garreth Martin (University of Nottingham), Frazer R. Pearce (University of Nottingham), Yannick M. Bah\'e (University of Nottingham, \'Ecole Polytechnique F\'ed\'erale de Lausanne), Joseph Butler (University of Nottingham), Weiguang Cui (Universidad Aut\'onoma de Madrid, Edinburgh Royal Observatory), Nina A. Hatch (University of Nottingham), Alexander Knebe (Universidad Aut\'onoma de Madrid, University of Western Australia)

23. [A self-consistent analytical model for both the photoionization rate and reionization history](#user-content-link23)
**Authors:** Christopher Cain, Kevin S. Croker, Anson D'Aloisio, Ivelin Georgiev, Hurum Maksora Tohfa, Yongda Zhu, Rogier Windhorst

24. [Fireworks at Cosmic Dawn: relieving BAO-CMB tensions with the Pop III.1 Flash](#user-content-link24)
**Authors:** Yash Aggarwal, Christopher Cain, Garett Lopez, Hy Trac, Anson D'Aloisio, Philip Tanedo, Jonathan C. Tan

25. [Evolution of starless cores in massive clumps seen by the ALMA ASHES and QUARKS surveys](#user-content-link25)
**Authors:** Dongting Yang, Hong-li Liu, Sheng-li Qin, Tie Liu, Wenyu Jiao, Guido Garay, Patricio Sanhueza, Fengwei Xu, Lei Zhu, Sami Dib, Xindi Tang, Amelia Stutz, Xiaofeng Mai, Siju Zhang, A. Y. Yang, Anandmayee Tej, Shanghuo Li, Xunchuan Liu, Pablo Garc{\i}a, Mika Juvela, James O. Chibueze, Prasanta Gorai, kee-tae Kim, Chang Won Lee, Tapas Baug, Swagat Ranjan Das, Shivani Gupta, Jihye Hwang, Leonardo Bronfman, Archana Soam, L. K. Dewangan

26. [Something green beneath the surface: The dynamical nature of Fossil Structures in IllustrisTNG-100](#user-content-link26)
**Authors:** Mary Verdugo-Santos, Facundo A. G\'omez, Diego Pallero, Franklin Ald\'as, Cristian A. Vega-Mart\'inez

27. [On the later evolution of observationally selected protocluster candidates at $z\,{\gtrsim}\,5$](#user-content-link27)
**Authors:** Seunghwan Lim

28. [Validation of the Hybrid Bias Expansion model for the galaxy bispectrum](#user-content-link28)
**Authors:** Marcos Pellejero Ib\'a\~nez, Raul E. Angulo, Laila Linke, Sara Ortega-Martinez, Maria Tsedrik, Sergio Contreras, John A. Peacock, Kate Storey-Fisher, Jens St\"ucker, Rodrigo Voivodic, Matteo Zennaro

29. [PMO Polaris CO survey. II. Where is the dust?](#user-content-link29)
...
30. [Gravitational Instability for a Multifluid Medium in an Expanding Universe](#user-content-link30)
**Authors:** D. Fargion (Phys. Dept. University of Rome "La Sapienza"-INFN)

31. [Is dark matter decaying ?](#user-content-link31)
**Authors:** Jeremy Mould

32. [Baryonic mass budgets in the central regions of the Bullet Cluster and their consistency with strong lensing in MOND](#user-content-link32)
...
33. [The stability of voids in the local Universe: the role of the cosmological constant](#user-content-link33)
**Authors:** V. G. Gurzadyan, N. N. Fimin, V. M. Chechetkin

34. [From Rags to Jeans: Axion Miniclusters from Early matter domination](#user-content-link34)
**Authors:** Ariel Angulo, Paola Arias, Nicol\'as Bernal, Javier Redondo

35. [Eppur non si trovano Vol. 3: Phoebe -- a Mirage of a Primordial Black Hole](#user-content-link35)
**Authors:** Andrzej Udalski, Przemek Mr\'oz

36. [X-Shooter survey of disk accretion in Upper Scorpius II. A lack of correlation between accretion rates and disk properties](#user-content-link36)
**Authors:** A. Empey, C. F. Manara, R. Garcia Lopez, A. Natta, R. Claes, F. Zagaria, J. M. Alcal\'a, R. Anania, G. Beccari, J. Carpenter, S. Facchini, D. Fedele, G. Lodato, K. Mauco, A. Miotello, B. Nisini, I. Pascucci, L. Piscarreta, G. Rosotti, A. Scholz, L. Testi, M. Vioque

37. [Simulation to a Newborn Supernova Remnant from a Low-mass Iron Core Star](#user-content-link37)
**Authors:** Sudarshan Neopane, Michael A. Sandoval, W. Raphael Hix, J. Austin Harris, O. E. Bronson Messer, Eric J. Lentz

38. [A Whisper from Within: Response of a Pulsar Timing Array to an Internal Gravitational-wave Source](#user-content-link38)
**Authors:** Houyuan Qi, Xian Chen, Lin Wang, Kuo Liu

39. [BayeSN $\times$ Dovekie: Joint Photometric Cross-calibration and SED Modelling of Type Ia Supernovae](#user-content-link39)
**Authors:** M. Grayling, B. Popovic, M. Ginolin, A. Do, K. S. Mandel

40. [A merger shock traced by radio arcs and ultra-long radio tails in galaxy cluster A2142](#user-content-link40)
**Authors:** Chong Ge, Ming Sun, Chris Nolting, Fabio Gastaldello, Dominique Eckert

41. [Dynamical Tidal Response of Neutron Stars: from Effective Field Theory to Gravitational Waveforms](#user-content-link41)
**Authors:** Thomas Apostolidis, Valerio De Luca, Leonardo Gualtieri, Takuya Katagiri, Paolo Pani, Luca Santoni

42. [Physics-guided discovery of dynamical dark-energy equations of state through iterative AI reasoning](#user-content-link42)
**Authors:** Clecio R. Bom, Bernardo M. Fraga, Miguel A. Sabogal, Armando Bernui, Phelipe Darc, Gustavo Schwarz

43. [Evolving Dark Energy Is Vacuum Energy After All](#user-content-link43)
**Authors:** Dong Ha Lee, Carsten van de Bruck, Eleonora Di Valentino, Ludovic Van Waerbeke, Ariel Zhitnitsky

44. [Short-Range Forces Can Catalyze Extreme Orbital Evolution in Hierarchical Triples](#user-content-link44)
**Authors:** Ygal Y. Klein, Chris Hamilton

45. [Ultra high-energy neutrino at GZK energy: Z-WW showering in dark halo and tau airshowers emerging from the Earth](#user-content-link45)
**Authors:** D. Fargion

46. [Advancing Astrophysics with the SKA II](#user-content-link46)
...
47. [The impact of FRB dispersion measure probability distribution functions on cosmographic estimates](#user-content-link47)
**Authors:** Thais Lemos, Rodrigo Gon\c{c}alves, Jailson Alcaniz

48. [The Hubble tension: A decade review](#user-content-link48)
**Authors:** Rong-Gen Cai, Shao-Jiang Wang

49. [MOSAIC at ELT: Design and First Performance Results of Novel Robotic Optical-Relay Positioners](#user-content-link49)
...
50. [Evidence for candidate X-ray pulsations from the ultraluminous X-ray source NGC 7456 ULX-1](#user-content-link50)
**Authors:** Yuanle Yao (NJU), Xiang-Dong Li (NJU), Xiao-Jie Xu (NJU)

51. [SS433 PeV neutron jet feeding the far TeV gamma beam](#user-content-link51)
**Authors:** Daniele Fargion, Pier Giorgio De Sanctis Lucentini, Sara Turriziani, Danila Sopin, Maxim Yu. Khlopov

52. [Kick bimodality of neutron stars and mode dependence of their parameters](#user-content-link52)
**Authors:** Anton D. Lazarev, Sergei B. Popov

53. [Characterization of a symmetric-facet dual-ruled grating for spatial heterodyne spectroscopy](#user-content-link53)
**Authors:** Cole Meyer, Joanne Flores, Jason Corliss, Walter Harris

54. [The SPHEREx View of Galaxy Clusters: A Simulation-based Validation of the Forced Photometry Pipeline for Extended Sources](#user-content-link54)
**Authors:** Hyeonguk Bahk, Ho Seong Hwang, Lindsey Bleem, Yujin Yang, Yoonsoo P. Bach, Yun-Ting Cheng, Brendan P. Crill, Olivier Dor\'e, Andreas L. Faisst, Zhaoyu Huai, Woong-Seob Jeong, Bomee Lee, Jeong Hwan Lee, Jeonghyun Pyo, Michael Zemcov

55. [String Axiverse Enhancement of Superradiant Dark Matter Production](#user-content-link55)
**Authors:** Diogo S. Gorgulho, Jacob A. Litterer, Jo\~ao G. Rosa

56. [High-accuracy polarimetry for CMB: new frontiers with the POLOCALC project](#user-content-link56)
...
57. [PeV neutrons as origin of separated SS433 TeV signals](#user-content-link57)
**Authors:** D. Fargion, P. G. De Sanctis Lucentini, S. Turriziani, M. Y. Khlopov, D. Sopin

58. [Testing X-ray selection effects with four rich, yet X--ray--faint, galaxy clusters](#user-content-link58)
**Authors:** S. Andreon, A. Moretti

59. [Charged Lepton Flavor Violation at Neutrino Telescopes](#user-content-link59)
**Authors:** Writasree Maitra, Carlos A. Arg\"uelles, P. S. Bhupal Dev, Ivan Martinez-Soler, Manibrata Sen

60. [Instruments for Focal Plane X-Ray Polarimetry in the Next Decade](#user-content-link60)
...
61. [Reheating as a variational probe of cosmological observables](#user-content-link61)
**Authors:** Jinn-Ouk Gong

62. [Hybrid stars with hyperons: structure based on QCD sum rule coupling constants](#user-content-link62)
**Authors:** F. Moradi Jangal, H. R. Moshfegh, K. Azizi

63. [Scintillation of the first-known pulsar planetary system](#user-content-link63)
**Authors:** J. M. Yao, L. Zhang, A. Wolszczan, William A. Coles, D. Li, Richard N. Manchester, N. Wang, C. H. Niu, P. Wang, F. F. Kou, J. P. Yuan

64. [V7995 Sgr: A New FU Orionis Accretion Outburst Near NGC 6589/6590](#user-content-link64)
**Authors:** Lynne A. Hillenbrand (California Institute of Technology), Kishalay De (Columbia University, Flatiron Institute), Adolfo S. Carvalho (Harvard University), Dan Stern (California Institute of Technology), Evan Portnoi (California Institute of Technology), Nicholas Earley (California Institute of Technology)

65. [Abundances of CNO in candidate young metal-poor stars](#user-content-link65)
...
66. [Emergent Gauge Symmetries in Particle Physics and Cosmology](#user-content-link66)
**Authors:** Steven D. Bass

67. [Accreting stellar-mass black holes](#user-content-link67)
**Authors:** Greg Marcel, Bailey Tetarenko, Adam Ingram, Tom Maccarone, Alexandra Veledina, Phil Charles

68. [An explicit and differentiable Wilson-Daubechies-Meyer transform for gravitational-wave data analysis](#user-content-link68)
**Authors:** Avi Vajpeyi, Giorgio Mentasti, Quentin Baghi, Ollie Burke, Lorenzo Speri

69. [Detecting Ultra High Energy Neutrinos by Upward Tau Airshowers and Gamma Flashes](#user-content-link69)
**Authors:** Daniele Fargion (Physics Department, , INFN, Rome 1, Pl.A.Moro, 2, Italy)

70. [Cosmological history after higher dimensional inflation](#user-content-link70)
**Authors:** Luis A. Anchordoqui, Ignatios Antoniadis, Jules Cunat

71. [Inverse Compton Scattering onto BBR in High Energy Physics and Gamma (MeV-Tev) Astrophysics](#user-content-link71)
**Authors:** D. Fargion (University of Rome1-INFN), A. Salis (University of Rome1)

72. [VASTER: The ASKAP real-time fast-imaging pipeline -- overview and discovery of two long period transients](#user-content-link72)
...
73. [Damping of Fast Radio Bursts in the Inner Magnetospheres of Magnetars](#user-content-link73)
**Authors:** Siddhant Solanki, Jens Mahlmann, Alexander Philippov, Andrei Beloborodov

74. [NNNN: Neural Networks for Newtonian Noise Mitigation at the Einstein Telescope](#user-content-link74)
**Authors:** Jan Kelleter, Patrick Schillings, Jonathan Kuckert, David Bertram, Markus Bachlechner, Achim Stahl, Johannes Erdmann

75. [sft-wick: A formalism and package for Feynman-diagram expansion and evaluation in stochastic field theories](#user-content-link75)
**Authors:** Zheng Zhang

76. [On the Contribution of Local Sources to the Galactic Cosmic-Ray Spectrum: An Exact Series Solution for Two-Zone Diffusion](#user-content-link76)
**Authors:** Zi-Hang Liu, Yiwei Bao, Ruo-Yu Liu

77. [On the nature of the GRBs-SGRs blazing jet](#user-content-link77)
**Authors:** Daniele Fargion (Physics Dept.Rome Univ.1, Rome, Italy)

78. [A FAST search for radio pulsations during the dormant state of the AMSPs IGR J00291+5934 and MAXI J1957+032](#user-content-link78)
...
79. [Upper Limits on Planet-Induced GHz Radio Emission from Inactive M Dwarfs](#user-content-link79)
...
80. [Constitutive birefringence and critical curves in the rotating Garc\'ia--D\'iaz black hole](#user-content-link80)
**Authors:** Ariel Guzm\'an, Mohsen Fathi, J. R. Villanueva

81. [DEM analysis of the 6 September 2011 large-scale coronal wave](#user-content-link81)
**Authors:** Amaia Razquin, Astrid M. Veronig, Karin Dissauer

82. [Nonlinear Decay of Fast Magnetosonic Waves through Weak Turbulence: Force-Free Electrodynamics Simulations](#user-content-link82)
**Authors:** Siddhant Solanki, Jens Mahlmann, Alexander Philippov

83. [Graviton Floor](#user-content-link83)
**Authors:** Himeka Matsuo, Asuka Ito, Kazunori Kohri, Teruaki Suyama, Ryutaro Tomomatsu

84. [ELMA: ELlipse-based bar MAjor axis estimator](#user-content-link84)
**Authors:** Bruna R. Bragan\c{c}a de Lima, Andressa Wille, Rafael S. de Souza, Ana L. Chies-Santos

85. [Phase Transitions and Gravitational Wave Production at the End of Thermal Inflation](#user-content-link85)
**Authors:** Hyukjung Kim, \.Ilayda Kuzu, Kerem \"Ozsoy, Zeynep Kahraman, Wan-Il Park, Heeseung Zoe

86. [Moduli Stabilisation for ADD and the Dark Dimension Scenario](#user-content-link86)
**Authors:** Andreas P. Braun, Michele Cicoli, Riccardo Milioli, Roberto Valandro

87. [Intermittent turbulent fluctuations in solar coronal mass ejections](#user-content-link87)
**Authors:** Apurva Bhagat, Sumit Tambe, Debesh Bhattacharjee, Prasad Subramanian

88. [The Effects of Energy Conservation in Simulating Solar Eruptions](#user-content-link88)
**Authors:** Xianyu Liu, Spiro K. Antiochos, Nishtha Sachdeva, G\'abor T\'oth, Ward B. Manchester IV, Bart van der Holst, Igor V. Sokolov, Tamas I. Gombosi, Lulu Zhao

89. [Effects of the Background Magnetic Field on Flux Rope Eruptions](#user-content-link89)
**Authors:** Xianyu Liu, Spiro K. Antiochos, Igor V. Sokolov, Tamas I. Gombosi, Bart van der Holst, G\'abor T\'oth, Nishtha Sachdeva, Lulu Zhao

90. [Review of Machine Learning Models for Solar Energetic Particle Prediction](#user-content-link90)
...
91. [New Gauge Forces, Neutron Stars and Schwinger Neutrino Production](#user-content-link91)
**Authors:** Yuxin Liu, Zhen Liu, Andrey Shkerin, Jing Shu, Yue Zhao

92. [On the braking index evolution of PSR B0540-69: wind braking of pulsars](#user-content-link92)
**Authors:** H. Tong

93. [Gamma Ray Burst and Soft Gamma Repeaters. Spinning, Precessing Gamma Jets](#user-content-link93)
**Authors:** Daniele Fargion

94. [Once more: Leaky MHD waves in coronal magnetic flux tubes](#user-content-link94)
**Authors:** Hans Goedbloed, Rony Keppens

95. [A long-term spectro-temporal study of Jovian X-ray and Ultraviolet response to solar activity](#user-content-link95)
...
96. [Mass Extinctions by Gravitational Tides](#user-content-link96)
**Authors:** Daniele Fargion

97. [Paucity of downward UHE neutrino tracks in IceCube versus unexpected huge KM3-230213A event: solving the puzzles?](#user-content-link97)
**Authors:** D. Fargion

98. [Solar Wind Dependence on Source Distance from the Open-Closed Boundary](#user-content-link98)
**Authors:** Chloe P. Wilkins, David I. Pontin, Anthony R. Yeates, Nicholeen M. Viall, Spiro K. Antiochos

---

## 1. [Finite-Core Signatures in LISA-Band Wave-Optics Lensing by Low-Mass Dark Matter Halos](https://arxiv.org/abs/2606.19995) <a id="link1"></a>
...
**Comment:** This paper studies wave-optics lensing of gravitational waves by low-mass dark matter halos, focusing on the inner density profile (core-cusp) and substructure. This directly matches the 'Near-Field Cosmology' criterion, especially the measurement of dark matter density profiles in low-mass halos.
...
## 2. [Cooling, conduction, compact objects: Gravothermal evolution of dissipative self-interacting dark matter halos](https://arxiv.org/abs/2606.19428) <a id="link2"></a>
...
**Comment:** This paper investigates the gravothermal evolution of self-interacting dark matter halos, including dissipative processes and their impact on halo structure. It directly addresses dark matter density profiles (core-cusp) and halo structure, which is highly relevant to near-field cosmology. The connection to compact objects and halo structure is novel, especially with the extension to dissipative SIDM.
...
## 3. [The Curious Case of Dark Faculae on M Dwarf Stars](https://arxiv.org/abs/2606.19854) <a id="link3"></a>
...
**Comment:** This paper presents new stellar atmosphere models for M-dwarf stars, specifically focusing on faculae and their spectral properties. This matches the 'Stellar Models' criterion closely.
...
## 4. [An Ultramassive White Dwarf with a Likely Oxygen-Neon Core](https://arxiv.org/abs/2606.19441) <a id="link4"></a>
...
**Comment:** This paper presents gravitational redshift measurements of an ultramassive white dwarf, inferring its likely oxygen-neon core. The focus is on stellar evolution and white dwarf core composition, which fits the 'Stellar Models' criterion, especially as it discusses mass-radius relations and core structure. Highly relevant for stellar models.
...
## 5. [Multi-band Structural Analysis of KiDS-selected Low Surface Brightness Galaxies with Hyper Suprime-Cam Imaging](https://arxiv.org/abs/2606.19862) <a id="link5"></a>
...
**Comment:** The paper presents a structural analysis of low surface brightness galaxies (LSBGs), which are often dwarf galaxies. The focus on LSBGs and their properties matches the 'Near-Field Cosmology' criterion, especially regarding abundances and structural properties of dwarf galaxies.
...
## 6. [Incorporating physical source parameters into microlensing modeling](https://arxiv.org/abs/2606.20555) <a id="link6"></a>
...
**Comment:** This paper presents a novel approach to microlensing modeling by directly sampling physical parameters of source stars using stellar evolution models (MIST). This directly matches the 'Stellar Models' criterion and also involves modeling of binary systems, which is relevant.
...
## 7. [On the impact of the carbon fusion rate over the properties of superbursts -- Numerical simulations of superbursts with MESA](https://arxiv.org/abs/2606.20088) <a id="link7"></a>
...
**Comment:** This paper presents numerical simulations of superbursts in neutron stars, focusing on the impact of the carbon fusion rate. It is relevant to stellar models, specifically stellar interior models and nucleosynthesis, matching the 'Stellar Models' criterion. The use of MESA and exploration of reaction rates is novel.
...
## 8. [A Be-shell star rotating at the critical limit and a partially stripped companion in a post-mass-transfer solution for the eclipsing binary V505 Mon](https://arxiv.org/abs/2606.20499) <a id="link8"></a>
...
**Comment:** This paper presents a detailed study of a Be-shell star binary, including stellar models and evolutionary phases. It provides new data and fits the stars into the main sequence of stellar models at sub-solar metallicity, directly matching the 'Stellar Models' criterion.
...
## 9. [A Virgo Environmental Survey Tracing Ionised Gas Emission (VESTIGE) XX. Star formation in the tidal tail of NGC 4254](https://arxiv.org/abs/2606.20006) <a id="link9"></a>
...
**Comment:** This paper presents ALMA observations of star-forming regions in the tidal tail of NGC 4254, focusing on giant molecular clouds, their formation, and dissolution. It directly addresses star formation in extragalactic environments, the fate of stripped gas, and the impact of stellar feedback, matching the 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria. It also touches on environmental effects on star formation, which is highly relevant.
...
## 10. [Reimagining SED Fitting with Cosmological Galaxy Simulations and Machine Learning](https://arxiv.org/abs/2606.19447) <a id="link10"></a>
...
**Comment:** This paper presents a new SED fitting tool using machine learning trained on simulated galaxies. It is relevant to 'Numerical Galaxy Simulations' and 'Resolved Star Formation Histories' (theoretical), though the focus is on methodology rather than direct application to dwarf galaxies or resolved SFHs from observations. Solid relevance.
...
## 11. [Increasing the sensitivity of full-shape galaxy clustering measurements in configuration-space with three-point statistics](https://arxiv.org/abs/2606.19518) <a id="link11"></a>
...
**Comment:** This paper investigates galaxy clustering using three-point statistics, with forecasts based on simulations and HOD models. It fits the 'Numerical Galaxy Simulations' criterion, as it uses high-resolution simulations and new analysis methods. The relevance is moderate.
...
## 12. [Steady-state Stellar Winds Driven by Recombination](https://arxiv.org/abs/2606.19422) <a id="link12"></a>
...
**Comment:** The paper investigates the role of recombination energy in driving stellar winds, focusing on stellar mass loss processes. This is relevant to 'Stellar Models' as it presents new theoretical work on stellar wind mechanisms.
...
## 13. [The fate of Earth during the Sun's giant phases: New constraints from ab initio tidal modelling and AGB mass loss](https://arxiv.org/abs/2606.19575) <a id="link13"></a>
...
**Comment:** This paper models the fate of Earth during the Sun's giant phases, focusing on tidal interactions and mass loss. It presents updated stellar evolution tracks and tidal models, which fits the 'Stellar Models' criterion. The relevance is moderate due to the focus on stellar evolutionary tracks.
...
## 14. [The impact of evolving cosmic filaments on mass and spin evolution of dark matter halos](https://arxiv.org/abs/2606.19443) <a id="link14"></a>
...
**Comment:** This paper studies the impact of cosmic filaments on the mass and spin evolution of dark matter halos using cosmological N-body simulations. While it focuses on environmental effects on halos, it does not specifically address dwarf galaxies, satellite luminosity functions, or resolved star formation histories. The relevance is borderline, as the results may have implications for near-field cosmology and numerical galaxy simulations, but the focus is broader.
...
## 15. [Enhancing the Detection Sensitivity of Primordial Parity Violation using Galaxy Spins](https://arxiv.org/abs/2606.19709) <a id="link15"></a>
...
**Comment:** This paper explores the detection sensitivity of primordial parity violation using galaxy spins, with a focus on halo mass and local density in N-body simulations. While it uses galaxy simulations and discusses halo properties, it does not directly address dwarf galaxies, resolved star formation histories, or quenching. Borderline relevance for numerical galaxy simulations.
...
## 16. [Evidence for protostellar jets as a population of hadronic gamma-ray sources](https://arxiv.org/abs/2606.19445) <a id="link16"></a>
...
**Comment:** The paper presents evidence for protostellar jets as sources of hadronic gamma rays, discussing energetic feedback in star formation. While it touches on star formation and feedback, it does not focus on galaxy-scale outflows or resolved star formation histories, nor does it address dwarf galaxies or galaxy simulations. Borderline relevance due to connection to star formation feedback.
...
## 17. [Statistical Field Theory for Weak Gravitational Lensing](https://arxiv.org/abs/2606.19472) <a id="link17"></a>
...
**Comment:** This paper presents a statistical field theory for weak gravitational lensing, introducing a new formalism for lensing observables. While weak lensing is relevant to cosmology, the paper does not focus on near-field cosmology, dwarf galaxies, or galaxy simulations. The relevance is borderline.
...
## 18. [Lightstack: A Python Package for Creating Photometric Data Cubes](https://arxiv.org/abs/2606.20360) <a id="link18"></a>
...
**Comment:** This paper presents a Python package for creating photometric data cubes, which could be useful for studies involving resolved star formation histories, but the paper itself is focused on software and data preparation rather than the science topics directly. Borderline relevance due to potential application.
...
## 19. [Supernova Remnants in the IXPE era: a review](https://arxiv.org/abs/2606.19979) <a id="link19"></a>
...
**Comment:** This review discusses IXPE observations of supernova remnants, focusing on magnetic fields and cosmic-ray acceleration. While it touches on star formation and feedback, it does not address galaxy-scale outflows, resolved star formation histories, or dwarf galaxies. Borderline relevance due to connection to feedback processes.
...
## 20. [UCLCHEM 4.0: An open source gas-grain astrochemistry simulation framework](https://arxiv.org/abs/2606.20265) <a id="link20"></a>
...
**Comment:** This paper presents UCLCHEM 4.0, an astrochemistry simulation framework for modeling gas-grain chemistry in the ISM. While it is a numerical simulation tool, it is not focused on galaxy simulations or the physics of galaxies, but rather on molecular chemistry. Borderline relevance for numerical simulation criterion.
...
## 21. [Characterizing the Formation and Evolution of S0-galaxies (CaFES-0): Their formation pathways around Galaxy Clusters](https://arxiv.org/abs/2606.19461) <a id="link21"></a>
...
**Comment:** This paper analyzes the formation and evolution of S0 galaxies around galaxy clusters using cosmological simulations. While it discusses quenching and environmental effects, the focus is on S0 galaxies (lenticulars) in massive halos, not dwarf galaxies or satellites. The relevance is borderline due to some discussion of quenching and environmental transformation, but not directly on the core topics.
...
## 22. [A Consistent Comparison of Intracluster Light Assembly in Simulations I. Redshift Evolution and Progenitor Galaxies](https://arxiv.org/abs/2606.20175) <a id="link22"></a>
...
**Comment:** This paper investigates the assembly of intracluster light (ICL) in cluster-mass halos using hydrodynamical simulations. The focus is on tidal stripping of satellite galaxies, but the satellites discussed are much more massive than dwarf galaxies. The relevance is borderline due to the discussion of satellite stripping and mass functions, but not directly on the Milky Way or dwarf satellites.
...
## 23. [A self-consistent analytical model for both the photoionization rate and reionization history](https://arxiv.org/abs/2606.19449) <a id="link23"></a>
...
**Comment:** The paper presents a new analytical model for the photoionization rate and reionization history, tested against radiative transfer simulations. While it is relevant to cosmology and galaxy evolution, it does not directly address near-field cosmology, resolved star formation histories, or dwarf galaxy properties. Borderline relevance due to connection to galaxy evolution and modeling.
...
## 24. [Fireworks at Cosmic Dawn: relieving BAO-CMB tensions with the Pop III.1 Flash](https://arxiv.org/abs/2606.19459) <a id="link24"></a>
...
**Comment:** This paper discusses early reionization models and their impact on CMB and BAO tensions, focusing on Pop III.1 stars and their ionizing feedback. While it deals with cosmic dawn and reionization, it does not directly address resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 25. [Evolution of starless cores in massive clumps seen by the ALMA ASHES and QUARKS surveys](https://arxiv.org/abs/2606.19756) <a id="link25"></a>
...
**Comment:** This paper presents a systematic analysis of starless cores in massive clumps, using ALMA data to study their evolution and mass accretion. While it discusses star formation and core evolution, it does not focus on resolved star formation histories from color-magnitude diagrams or dwarf galaxies. The relevance is borderline.
...
## 26. [Something green beneath the surface: The dynamical nature of Fossil Structures in IllustrisTNG-100](https://arxiv.org/abs/2606.19478) <a id="link26"></a>
...
**Comment:** This paper analyzes the evolution and properties of fossil galaxy groups using the IllustrisTNG-100 simulation. It focuses on group-scale structures (M200 > 10^13 Msun), which are more massive than the Milky Way and its satellites, and studies their assembly history, quenching, and dynamical state. While it discusses quenching and assembly history, the focus is on massive groups rather than dwarf galaxies or near-field cosmology. The analysis of quenched fractions and galaxy color-mass distributions is somewhat relevant to star formation quenching, but the mass scale is not ideal. The use of numerical galaxy simulations is relevant, but the application is not directly aligned with the core topics.
...
## 27. [On the later evolution of observationally selected protocluster candidates at $z\,{\gtrsim}\,5$](https://arxiv.org/abs/2606.19463) <a id="link27"></a>
...
**Comment:** This paper uses the FLAMINGO simulations to track the evolution of protocluster candidates at z > 5, focusing on their later merger histories and the reliability of observational selection methods. While it deals with galaxy structure formation and numerical simulations, the focus is on protoclusters and their evolution into massive clusters, not on dwarf galaxies, near-field cosmology, or resolved star formation histories. The relevance is borderline due to the use of galaxy simulations and discussion of assembly histories, but the mass scale and focus are not ideal.
...
## 28. [Validation of the Hybrid Bias Expansion model for the galaxy bispectrum](https://arxiv.org/abs/2606.19452) <a id="link28"></a>
...
**Comment:** The paper validates a bias expansion model for the galaxy bispectrum using mock catalogs and N-body simulations. While it involves numerical galaxy simulations, the focus is on large-scale structure and galaxy clustering, not on high-resolution galaxy simulations or dwarf galaxies. Only a borderline match to the 'Numerical Galaxy Simulations' criterion.
...
## 29. [PMO Polaris CO survey. II. Where is the dust?](https://arxiv.org/abs/2606.19694) <a id="link29"></a>
...
**Comment:** The study analyzes dust distributions in the ISM using CO, HI, and Planck data, focusing on molecular cloud boundaries and CO-dark molecular gas. While it discusses ISM phases and molecular formation, it does not directly address resolved star formation histories, galaxy simulations, or dwarf galaxy properties. Borderline relevance due to ISM and molecular gas connection.
...
## 30. [Gravitational Instability for a Multifluid Medium in an Expanding Universe](https://arxiv.org/abs/9605151) <a id="link30"></a>
...
**Comment:** The paper discusses gravitational instability in a multifluid medium in an expanding universe, with implications for galaxy formation epochs. While it touches on galaxy formation, it does not specifically address near-field cosmology, dwarf galaxies, or resolved star formation histories. Borderline relevance due to possible implications for galaxy formation.
...
## 31. [Is dark matter decaying ?](https://arxiv.org/abs/2606.19837) <a id="link31"></a>
...
**Comment:** The paper discusses the possibility of dark matter decay and its impact on the matter density parameter. It mentions low-mass dark matter halos, which are relevant to near-field cosmology, but the focus is on cosmological parameters and not specifically on dwarf galaxies or their properties. Borderline relevance.
...
## 32. [Baryonic mass budgets in the central regions of the Bullet Cluster and their consistency with strong lensing in MOND](https://arxiv.org/abs/2606.19454) <a id="link32"></a>
...
**Comment:** This paper discusses baryonic mass budgets in the Bullet Cluster and their consistency with MOND, focusing on strong lensing and the integrated galaxy-wide initial mass function (IGIMF). While it touches on stellar population synthesis and mass functions, it is focused on cluster-scale phenomena and not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 33. [The stability of voids in the local Universe: the role of the cosmological constant](https://arxiv.org/abs/2606.19722) <a id="link33"></a>
...
**Comment:** This paper studies the stability of cosmic voids in the local universe and the role of the cosmological constant. While it touches on local universe structure, it does not directly address near-field cosmology (dwarf satellites, accreted halo, etc.), resolved star formation histories, or galaxy simulations.
...
## 34. [From Rags to Jeans: Axion Miniclusters from Early matter domination](https://arxiv.org/abs/2606.19439) <a id="link34"></a>
...
**Comment:** This paper discusses axion miniclusters and their formation in early matter-dominated cosmologies. While it touches on cosmological structure formation, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 35. [Eppur non si trovano Vol. 3: Phoebe -- a Mirage of a Primordial Black Hole](https://arxiv.org/abs/2606.19442) <a id="link35"></a>
...
**Comment:** This paper re-analyzes a microlensing event in the LMC, ultimately concluding it is a variable star and not a primordial black hole. While it touches on dark matter in the Milky Way halo, the focus is on the nature of the event rather than near-field cosmology or satellite galaxy properties. Only a weak connection to the dark matter density profile criterion.
...
## 36. [X-Shooter survey of disk accretion in Upper Scorpius II. A lack of correlation between accretion rates and disk properties](https://arxiv.org/abs/2606.19455) <a id="link36"></a>
...
**Comment:** The paper investigates accretion rates and disk properties in young stars in Upper Scorpius. While it discusses star formation and disk evolution, it does not address resolved star formation histories of galaxies, quenching, or galaxy-scale outflows. The focus is on protoplanetary disks, which is outside the core topics.
...
## 37. [Simulation to a Newborn Supernova Remnant from a Low-mass Iron Core Star](https://arxiv.org/abs/2606.19490) <a id="link37"></a>
...
**Comment:** This paper presents simulations of supernova remnants, focusing on the morphology and radioactive heating. While it involves numerical simulations, it is not about galaxy simulations or the core topics (dwarf galaxies, star formation histories, etc.).
...
## 38. [A Whisper from Within: Response of a Pulsar Timing Array to an Internal Gravitational-wave Source](https://arxiv.org/abs/2606.20021) <a id="link38"></a>
...
**Comment:** The paper discusses pulsar timing arrays and gravitational wave sources in globular clusters and galactic nuclei. While it mentions globular clusters, it does not address near-field cosmology, galaxy evolution, or the other core topics.
...
## 39. [BayeSN $\times$ Dovekie: Joint Photometric Cross-calibration and SED Modelling of Type Ia Supernovae](https://arxiv.org/abs/2606.19429) <a id="link39"></a>
...
**Comment:** This paper presents a new framework for SED modeling and cross-calibration of Type Ia supernovae, relevant for cosmological studies. It does not address any of the core topics (near-field cosmology, resolved star formation histories, dwarf galaxies, etc.).
...
## 40. [A merger shock traced by radio arcs and ultra-long radio tails in galaxy cluster A2142](https://arxiv.org/abs/2606.20335) <a id="link40"></a>
...
**Comment:** The paper studies merger shocks in a massive galaxy cluster, focusing on radio arcs and tails. The subject is galaxy clusters and merger shocks, not dwarf galaxies, star formation histories, or galaxy simulations. Irrelevant to core topics.
...
## 41. [Dynamical Tidal Response of Neutron Stars: from Effective Field Theory to Gravitational Waveforms](https://arxiv.org/abs/2606.19446) <a id="link41"></a>
...
**Comment:** This paper studies the dynamical tidal response of neutron stars and its impact on gravitational waveforms. The focus is on neutron star physics and gravitational waves, not galaxy evolution, stellar models, or any of the core topics.
...
## 42. [Physics-guided discovery of dynamical dark-energy equations of state through iterative AI reasoning](https://arxiv.org/abs/2606.19427) <a id="link42"></a>
...
**Comment:** The paper uses AI to propose new equations of state for dynamical dark energy, which is cosmology-focused and not related to the core topics (near-field cosmology, galaxy simulations, etc.).
...
## 43. [Evolving Dark Energy Is Vacuum Energy After All](https://arxiv.org/abs/2606.20036) <a id="link43"></a>
...
**Comment:** This paper presents a new model for dynamical dark energy based on QCD vacuum effects and compares it to cosmological data. While it is a novel approach to dark energy, it does not address any of the core topics such as dwarf galaxies, star formation, or galaxy simulations.
...
## 44. [Short-Range Forces Can Catalyze Extreme Orbital Evolution in Hierarchical Triples](https://arxiv.org/abs/2606.19456) <a id="link44"></a>
...
**Comment:** The paper discusses orbital evolution in hierarchical triple systems, focusing on the von Zeipel-Lidov-Kozai effect and short-range forces. While it is a theoretical study of stellar dynamics, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No relevant criteria are matched.
...
## 46. [Advancing Astrophysics with the SKA II](https://arxiv.org/abs/2606.20366) <a id="link46"></a>
...
**Comment:** This is a broad overview of science enabled by the SKA telescopes, covering many areas of astrophysics. While SKA will impact galaxy studies, the abstract does not specifically mention dwarf galaxies, near-field cosmology, resolved star formation histories, or other core topics. The relevance is low due to lack of direct focus.
...
## 47. [The impact of FRB dispersion measure probability distribution functions on cosmographic estimates](https://arxiv.org/abs/2606.20471) <a id="link47"></a>
...
**Comment:** The paper uses FRB dispersion measures to constrain cosmographic parameters. It focuses on cosmological model-independent analyses and the intergalactic medium, but does not address the CGM of dwarf galaxies or other core topics. No criteria match closely.
...
## 49. [MOSAIC at ELT: Design and First Performance Results of Novel Robotic Optical-Relay Positioners](https://arxiv.org/abs/2606.20194) <a id="link49"></a>
...
**Comment:** This paper describes the design and performance of robotic positioners for the MOSAIC instrument at the ELT. While it is relevant to observational astronomy instrumentation, it does not match any of the core topics (near-field cosmology, resolved star formation histories, dwarf galaxy studies, etc.).
...
## 50. [Evidence for candidate X-ray pulsations from the ultraluminous X-ray source NGC 7456 ULX-1](https://arxiv.org/abs/2606.20308) <a id="link50"></a>
...
**Comment:** This paper reports candidate X-ray pulsations from an ultraluminous X-ray source, likely an accreting neutron star. It does not address any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 51. [SS433 PeV neutron jet feeding the far TeV gamma beam](https://arxiv.org/abs/2512.07012) <a id="link51"></a>
...
**Comment:** This paper discusses PeV neutron jets from SS433 and their connection to distant TeV gamma-ray beams. The focus is on a specific binary system and jet physics, not on any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 52. [Kick bimodality of neutron stars and mode dependence of their parameters](https://arxiv.org/abs/2606.20201) <a id="link52"></a>
...
**Comment:** The paper analyzes the bimodal kick distribution of neutron stars and its relation to their properties. It does not address any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 53. [Characterization of a symmetric-facet dual-ruled grating for spatial heterodyne spectroscopy](https://arxiv.org/abs/2606.19424) <a id="link53"></a>
...
**Comment:** This paper characterizes a dual-ruled grating for spatial heterodyne spectroscopy, relevant to instrumentation. It does not address galaxy simulations, star formation histories, or stellar models.
...
## 54. [The SPHEREx View of Galaxy Clusters: A Simulation-based Validation of the Forced Photometry Pipeline for Extended Sources](https://arxiv.org/abs/2606.19875) <a id="link54"></a>
...
**Comment:** This paper focuses on galaxy clusters and the performance of the SPHEREx pipeline for cluster science. It does not address dwarf galaxies, satellite luminosity functions, resolved star formation histories, or any of the other core topics. The focus is on photometry and redshift accuracy for cluster galaxies, which are much more massive than the Milky Way satellites.
...
## 55. [String Axiverse Enhancement of Superradiant Dark Matter Production](https://arxiv.org/abs/2606.20524) <a id="link55"></a>
...
**Comment:** The paper discusses string axion emission and dark matter production by primordial black holes. While it is related to dark matter, it does not focus on galaxy-scale processes or dwarf galaxies. No criteria match closely.
...
## 56. [High-accuracy polarimetry for CMB: new frontiers with the POLOCALC project](https://arxiv.org/abs/2606.20171) <a id="link56"></a>
...
**Comment:** This paper discusses high-accuracy polarimetry for CMB experiments, focusing on calibration methods. It does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 57. [PeV neutrons as origin of separated SS433 TeV signals](https://arxiv.org/abs/2602.14212) <a id="link57"></a>
...
**Comment:** This paper focuses on the SS433 binary system, its black hole accretion disk, and jet emissions, including TeV gamma signals. The topic is centered on high-energy phenomena in a massive binary system and does not address dwarf galaxies, satellite luminosity functions, star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM. No relevant criteria are matched.
...
## 58. [Testing X-ray selection effects with four rich, yet X--ray--faint, galaxy clusters](https://arxiv.org/abs/2606.19434) <a id="link58"></a>
...
**Comment:** This paper investigates selection effects in galaxy cluster studies, focusing on rich, X-ray-faint clusters with masses log M200 ~ 14.6. The work is primarily about cluster detection and diversity, not about dwarf galaxies, near-field cosmology, resolved star formation histories, or quenching. The mass scale is much higher than the Milky Way or its satellites, and there is no discussion of star formation, stellar models, or galaxy simulations. The relevance to the core topics is very low.
...
## 59. [Charged Lepton Flavor Violation at Neutrino Telescopes](https://arxiv.org/abs/2606.19723) <a id="link59"></a>
...
**Comment:** The paper proposes a novel search for charged lepton flavor violation at neutrino telescopes. The focus is on particle physics and neutrino detection, not on any of the core topics.
...
## 60. [Instruments for Focal Plane X-Ray Polarimetry in the Next Decade](https://arxiv.org/abs/2606.20337) <a id="link60"></a>
...
**Comment:** This paper presents instrumentation for X-ray polarimetry, focusing on hardware and detector development. It does not address galaxy evolution, stellar models, or any of the core topics.
...
## 61. [Reheating as a variational probe of cosmological observables](https://arxiv.org/abs/2606.19513) <a id="link61"></a>
...
**Comment:** This paper formulates reheating as a variational problem in cosmology, focusing on post-inflationary expansion histories and their impact on cosmological observables. It is unrelated to galaxy evolution, near-field cosmology, or any of the core topics.
...
## 62. [Hybrid stars with hyperons: structure based on QCD sum rule coupling constants](https://arxiv.org/abs/2606.20111) <a id="link62"></a>
...
**Comment:** This paper presents a study of hybrid stars (neutron stars with quark matter) using QCD sum rule coupling constants. The focus is on compact object structure and not on galaxies, star formation histories, or stellar models relevant to the prompt.
...
## 63. [Scintillation of the first-known pulsar planetary system](https://arxiv.org/abs/2606.19406) <a id="link63"></a>
...
**Comment:** This paper studies scintillation in the first-known pulsar planetary system. The focus is on pulsar timing and interstellar medium propagation effects, not on galaxies, star formation histories, or stellar models.
...
## 64. [V7995 Sgr: A New FU Orionis Accretion Outburst Near NGC 6589/6590](https://arxiv.org/abs/2606.20350) <a id="link64"></a>
...
**Comment:** This paper reports a new FU Orionis outburst in a young stellar object. The focus is on stellar accretion and outburst phenomena, not on galaxy-scale processes or dwarf galaxies. No criteria match closely.
...
## 65. [Abundances of CNO in candidate young metal-poor stars](https://arxiv.org/abs/2606.20200) <a id="link65"></a>
...
**Comment:** The paper investigates CNO abundances in candidate young metal-poor stars to distinguish between young and rejuvenated stars. The focus is on stellar evolution and chemical abundances, not on galaxy-scale processes or dwarf galaxies. No criteria match closely.
...
## 66. [Emergent Gauge Symmetries in Particle Physics and Cosmology](https://arxiv.org/abs/2606.19403) <a id="link66"></a>
...
**Comment:** This is a theoretical review on emergent gauge symmetries in particle physics and cosmology, with some discussion of dark matter and dark energy. It does not address any of the core topics such as dwarf galaxies, star formation, or galaxy simulations.
...
## 67. [Accreting stellar-mass black holes](https://arxiv.org/abs/2606.19952) <a id="link67"></a>
...
**Comment:** This is a review of accreting stellar-mass black holes, focusing on accretion physics, jets, and emission lines. It does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 68. [An explicit and differentiable Wilson-Daubechies-Meyer transform for gravitational-wave data analysis](https://arxiv.org/abs/2606.20269) <a id="link68"></a>
...
**Comment:** This paper presents a Python package for the Wilson-Daubechies-Meyer transform for gravitational-wave data analysis. It is focused on data analysis methods for gravitational waves, not on any of the core topics.
...
## 70. [Cosmological history after higher dimensional inflation](https://arxiv.org/abs/2606.20486) <a id="link70"></a>
...
**Comment:** This paper discusses cosmological history after higher dimensional inflation and the stabilization of extra dimensions. It is unrelated to galaxy evolution, near-field cosmology, or any of the core topics.
...
## 71. [Inverse Compton Scattering onto BBR in High Energy Physics and Gamma (MeV-Tev) Astrophysics](https://arxiv.org/abs/9605168) <a id="link71"></a>
...
**Comment:** This paper discusses inverse Compton scattering in high energy physics and gamma astrophysics, focusing on cosmic rays and gamma ray bursts. It is unrelated to galaxy evolution, near-field cosmology, or any of the core topics.
...
## 72. [VASTER: The ASKAP real-time fast-imaging pipeline -- overview and discovery of two long period transients](https://arxiv.org/abs/2606.20067) <a id="link72"></a>
...
**Comment:** The paper presents a real-time radio transient detection pipeline and reports the discovery of long period transients. The focus is on radio astronomy instrumentation and transient source discovery, not galaxy evolution, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 73. [Damping of Fast Radio Bursts in the Inner Magnetospheres of Magnetars](https://arxiv.org/abs/2606.19448) <a id="link73"></a>
...
**Comment:** The paper studies the propagation and damping of fast radio bursts in magnetar magnetospheres using force-free electrodynamics simulations. The focus is on plasma physics and FRB escape, not galaxy evolution, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 74. [NNNN: Neural Networks for Newtonian Noise Mitigation at the Einstein Telescope](https://arxiv.org/abs/2606.19907) <a id="link74"></a>
...
**Comment:** The paper discusses neural network mitigation of Newtonian noise for gravitational wave detectors. The focus is on instrumentation and noise reduction, not galaxy evolution, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 75. [sft-wick: A formalism and package for Feynman-diagram expansion and evaluation in stochastic field theories](https://arxiv.org/abs/2606.19480) <a id="link75"></a>
...
**Comment:** This is a methods paper about Feynman-diagram expansion in stochastic field theories, not related to galaxy simulations or any of the core astrophysical topics.
...
## 76. [On the Contribution of Local Sources to the Galactic Cosmic-Ray Spectrum: An Exact Series Solution for Two-Zone Diffusion](https://arxiv.org/abs/2606.19701) <a id="link76"></a>
...
**Comment:** This paper investigates cosmic-ray spectra and the contribution of local sources, focusing on particle transport and diffusion models. It does not address any of the core criteria related to galaxies, star formation, or stellar models.
...
## 77. [On the nature of the GRBs-SGRs blazing jet](https://arxiv.org/abs/9903433) <a id="link77"></a>

**ArXiv ID:** 9903433

**Authors:** Daniele Fargion (Physics Dept.Rome Univ.1, Rome, Italy)

**Abstract:**   Gamma Ray Burst and Soft Gamma Repeaters are neither standard candle nor isotropic explosions. Our model explain them as strong blazing of a light-house, spinning and precessing gamma jet. Such jets at maximal output (as GRBs in Supernova like sources at cosmic edges) or at late lower power stages (SGRs in nearer planetary nebulae in galactic halo) may blaze the observer by extreme beaming $(\Omega < 10^{-8})$ and apparent huge luminosity. \keywords{GRB, Jet, Inverse Compton, SGR}

**Comment:** The paper discusses models for gamma-ray bursts and soft gamma repeaters, focusing on jet physics. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 78. [A FAST search for radio pulsations during the dormant state of the AMSPs IGR J00291+5934 and MAXI J1957+032](https://arxiv.org/abs/2606.20086) <a id="link78"></a>
...
**Comment:** This paper reports a search for radio pulsations in accreting millisecond pulsars. The focus is on neutron star binaries and pulsar emission, not on galaxies, star formation histories, or stellar models.
...
## 79. [Upper Limits on Planet-Induced GHz Radio Emission from Inactive M Dwarfs](https://arxiv.org/abs/2606.19671) <a id="link79"></a>
...
**Comment:** This paper focuses on radio emission from M dwarfs with exoplanets, discussing stellar activity and magnetospheres. It does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 81. [DEM analysis of the 6 September 2011 large-scale coronal wave](https://arxiv.org/abs/2606.20368) <a id="link81"></a>
...
**Comment:** This paper analyzes a large-scale coronal wave associated with a solar flare and CME, focusing on plasma diagnostics in the solar corona. It is unrelated to galaxy evolution, near-field cosmology, or any of the core topics.
...
## 82. [Nonlinear Decay of Fast Magnetosonic Waves through Weak Turbulence: Force-Free Electrodynamics Simulations](https://arxiv.org/abs/2606.19450) <a id="link82"></a>
...
**Comment:** This paper investigates fast magnetosonic wave decay in magnetar magnetospheres using force-free electrodynamics simulations. The focus is on plasma physics and wave propagation, not galaxy simulations, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 83. [Graviton Floor](https://arxiv.org/abs/2606.19757) <a id="link83"></a>
...
**Comment:** This paper discusses the conversion of the cosmic photon background into gravitons in magnetic fields, relevant for gravitational wave detectors. The focus is on fundamental physics and backgrounds, not galaxy evolution, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 84. [ELMA: ELlipse-based bar MAjor axis estimator](https://arxiv.org/abs/2606.20370) <a id="link84"></a>
...
**Comment:** This paper introduces a Python package for automated bar-length estimation in disk galaxies. The focus is on galactic bars, which are explicitly listed as irrelevant in the criteria. Irrelevant to core topics.
...
## 85. [Phase Transitions and Gravitational Wave Production at the End of Thermal Inflation](https://arxiv.org/abs/2606.20392) <a id="link85"></a>
...
**Comment:** The paper investigates phase transitions at the end of thermal inflation and associated gravitational wave production. The focus is on early universe physics and gravitational waves, not galaxy evolution, star formation, or near-field cosmology. Irrelevant to core topics.
...
## 86. [Moduli Stabilisation for ADD and the Dark Dimension Scenario](https://arxiv.org/abs/2606.19440) <a id="link86"></a>
...
**Comment:** This paper focuses on string compactifications and moduli stabilization, which is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 87. [Intermittent turbulent fluctuations in solar coronal mass ejections](https://arxiv.org/abs/2606.20305) <a id="link87"></a>
...
**Comment:** This paper studies turbulence in solar coronal mass ejections, which is not related to galaxy evolution, dwarf galaxies, or the other core topics.
...
## 89. [Effects of the Background Magnetic Field on Flux Rope Eruptions](https://arxiv.org/abs/2606.19546) <a id="link89"></a>
...
**Comment:** This paper studies the effects of background magnetic fields on flux rope eruptions in the Sun, not related to galaxy simulations or the core topics.
...
## 90. [Review of Machine Learning Models for Solar Energetic Particle Prediction](https://arxiv.org/abs/2606.19539) <a id="link90"></a>
...
**Comment:** This is a review of machine learning models for solar energetic particle prediction, focusing on solar physics and particle acceleration. It does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 92. [On the braking index evolution of PSR B0540-69: wind braking of pulsars](https://arxiv.org/abs/2606.19856) <a id="link92"></a>
...
**Comment:** This paper studies the braking index evolution of a pulsar, focusing on wind braking models. The focus is on pulsar physics and not on galaxies, star formation histories, or stellar models relevant to the prompt.
...
## 94. [Once more: Leaky MHD waves in coronal magnetic flux tubes](https://arxiv.org/abs/2606.20019) <a id="link94"></a>
...
**Comment:** The paper discusses leaky MHD waves in coronal magnetic flux tubes, relevant to solar and stellar physics, not galaxy-scale processes or core topics.
...
## 95. [A long-term spectro-temporal study of Jovian X-ray and Ultraviolet response to solar activity](https://arxiv.org/abs/2606.20355) <a id="link95"></a>
...
**Comment:** The study investigates Jupiter's response to solar activity, which is planetary science and not related to the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 96. [Mass Extinctions by Gravitational Tides](https://arxiv.org/abs/2606.17105) <a id="link96"></a>
...
**Comment:** The paper discusses mass extinctions due to gravitational tides from planetary objects in the Solar System, which is unrelated to the core topics (galaxy evolution, dwarf galaxies, etc.).
...
## 97. [Paucity of downward UHE neutrino tracks in IceCube versus unexpected huge KM3-230213A event: solving the puzzles?](https://arxiv.org/abs/2512.07042) <a id="link97"></a>
...
**Comment:** This paper discusses ultra-high energy neutrino events and their interpretation, focusing on cosmic rays and neutrino astronomy. It does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 98. [Solar Wind Dependence on Source Distance from the Open-Closed Boundary](https://arxiv.org/abs/2606.20204) <a id="link98"></a>
...
**Comment:** This paper studies the solar wind and its dependence on magnetic topology, focusing on solar physics and not on galaxies, star formation, or stellar models.
