...
1. [Single Parameter Model for Galaxy Rotation Curves](#user-content-link1)
**Authors:** Sophia N. Cisneros, Rich Ott, Meagan Crowley, Amy Roberts, Marcus Paz

2. [Starbursts hiding in the main sequence: a pathway toward quenching?](#user-content-link2)
**Authors:** Florent Renaud, Katarina Kraljic, Jonathan Freundlich, Benjamin Magnelli, Matthieu B\'ethermin, C\'edric Accard, Diana Ismail, Emanuele Daddi, David Elbaz, Laure Ciesla, Gareth Martin, Yohan Dubois, S\'ebastien Peirani

3. [Constraining the mass of the M31 ionized baryon Halo using CHIME/FRB Catalog 2](#user-content-link3)
**Authors:** Lordrick A. Kahinga (Department of Astronomy and Astrophysics, University of California, Santa Cruz, CA, USA, Department of Physics, University of Dodoma, Tanzania), J. Xavier Prochaska (Department of Astronomy and Astrophysics, University of California, Santa Cruz, CA, USA, Kavli Institute for the Physics and Mathematics of the Universe, National Astronomical Observatory of Japan), Sunil Simha (Center for Interdisciplinary Exploration and Research in Astronomy, Northwestern University, USA, Department of Astronomy and Astrophysics, University of Chicago, USA), Calvin Leung (Department of Astronomy, University of California, Berkeley, USA), Radu V. Craiu (Department of Statistical Sciences, University of Toronto, Canada), Gwendolyn Eadie (David A. Dunlap Department of Astronomy and Astrophysics, University of Toronto, Canada, Department of Statistical Sciences, University of Toronto, Canada), Emmanuel Fonseca (Department of Physics and Astronomy, West Virginia University, USA, Center for Gravitational Waves and Cosmology, West Virginia University, USA), B. M. Gaensler (Department of Astronomy and Astrophysics, University of California, Santa Cruz, CA, USA, David A. Dunlap Department of Astronomy and Astrophysics, University of Toronto, Canada, Dunlap Institute for Astronomy and Astrophysics, University of Toronto, Canada), Vicky Kaspi (Department of Physics, McGill University, Canada, Trottier Space Institute, McGill University, Canada), Afrokk Khan (Department of Physics, McGill University, Canada, Trottier Space Institute, McGill University, Canada), Bikash Kharel (Department of Physics and Astronomy, West Virginia University, USA, Center for Gravitational Waves and Cosmology, West Virginia University, USA), Adam E. Lanman (MIT Kavli Institute for Astrophysics and Space Research, USA, Department of Physics, MIT, USA), Robert A. Main (Department of Physics, McGill University, Canada, Trottier Space Institute, McGill University, Canada), Lluis Mas-Ribas (Department of Astronomy and Astrophysics, University of California, Santa Cruz, CA, USA), Kiyoshi W. Masui (MIT Kavli Institute for Astrophysics and Space Research, USA, Department of Physics, MIT, USA), Paul Scholz (Department of Physics and Astronomy, York University, Canada), Swarali Shivraj Patil (Department of Physics and Astronomy, West Virginia University, USA, Center for Gravitational Waves and Cosmology, West Virginia University, USA), Aaron B. Pearlman (MIT Kavli Institute for Astrophysics and Space Research, USA, Department of Physics, MIT, USA, Department of Physics, McGill University, Canada, Trottier Space Institute, McGill University, Canada), K. Shin (Cahill Center for Astronomy and Astrophysics, Caltech, USA), Seth R. Siegel (Perimeter Institute for Theoretical Physics, Canada, Department of Physics, McGill University, Canada, Trottier Space Institute, McGill University, Canada), Kendrick Smith (Perimeter Institute for Theoretical Physics, Canada), Michele Woodland (Department of Astronomy and Astrophysics, University of California, Santa Cruz, CA, USA)

4. [Zooming in on the circumgalactic medium with GIBLE: Cloud-scale simulations with cosmological initial conditions](#user-content-link4)
**Authors:** Rahul Ramesh, Dylan Nelson, Drummond Fielding, Marcus Br\"uggen

5. [Probing power spectrum enhancement at small scales with SKA](#user-content-link5)
**Authors:** Hourui Zhu, Bin Yue, Yidong Xu, Xuelei Chen, Zhiqi Huang

6. [The capture of halo material by orbiting subhaloes](#user-content-link6)
**Authors:** Hang Yang, Simon D. M. White, Liang Gao

7. [First spectroscopic identification of the main sequence in Westerlund 1](#user-content-link7)
...
8. [Hydrodynamical simulations of helium-ignited binary white dwarf mergers](#user-content-link8)
**Authors:** Vrutant Mehta, Vishal Tiwari, Ruediger Pakmor, Divyanshu Singh, Robert Fisher

9. [Eigenmode initialisation of 2D (magneto)hydrodynamic simulations](#user-content-link9)
**Authors:** Jordi De Jonghe, Alexander J. B. Russell

10. [Probing inflationary features with galaxy ultraviolet luminosity function observables](#user-content-link10)
**Authors:** Sandeep Kumar Acharya

11. [A New Window into the Baryon Cycle at Cosmic Noon with Line Intensity Mapping: Forecasts for auto- and cross-correlations in [CII]-158$\mu$m, HI 21 cm, CO$_{J+1\rightarrow J}$, and H$\alpha$ galaxies](#user-content-link11)
...
12. [ALMA High-J CO Spectroscopy of High-Redshift Galaxies. I. An Archive-based Catalog of CO Spectral Line Energy Distributions](#user-content-link12)
**Authors:** Ken-ichi Tadaki

13. [Filling the Gap in Cluster Evolution: JWST's Glimpse into a Young, Star-Forming Cluster at Cosmic Noon](#user-content-link13)
**Authors:** Pierluigi Rinaldi, Stacey Alberts, Christopher N. A. Willmer, Courtney Carreira, Christina C. Williams, Ga\"el Noirot, Carys J. E. Gilbert, Andrew J. Bunker, William M. Baker, Luigi Barchiesi, Zhiyuan Ji, Jianwei Lyu, Sandro Tacchella, Zihao Wu, Yongda Zhu

14. [Survival Analysis of Intermediate-Mass Black Holes in Dense Star Clusters](#user-content-link14)
**Authors:** Miguel A. S. Martinez, Elena Gonz\'alez Prieto, Frederic A. Rasio

15. [Transition of Magnetic Reconnection Regimes in Partially Ionized Plasmas](#user-content-link15)
**Authors:** Liang Wang, Chuanfei Dong, Yi-Min Huang, Yue Yuan, Xinmin Li, Yang Zhang

16. [The PLUTO Code on GPUs: Offloading Lagrangian Particle Methods](#user-content-link16)
...
19. [A Quality Framework for Testing Gravity with Wide Binaries: No Evidence for MOND](#user-content-link19)
...
20. [Discovery of a runaway star likely ejected by a Type Iax Supernova](#user-content-link20)
**Authors:** A. Bhat, M. Hollands, M. Dorsch, S. Geier, U. Heber, D. Koester, R. Pakmor, Ken J. Shen

21. [High-Precision Mass Measurements of Proton-Rich Rh, Pd, Cd isotopes in the vicinity of 100Sn and Impact on X-Ray Burst and Supernova Nucleosynthesis](#user-content-link21)
**Authors:** D. S. Hou, W. D. Xian, M. Rosenbusch, M. Wada, P. Schury, A. Takamine, Y. Luo, J. Lee, H. Ishiyama, S. Nishimura, C. Y. Fu, A. Dohi, H. Feng, Z. He, S. Kimura, T. Niwase, V. H. Phong, T. T. Yeung, Q. B. Zeng, S. X. Zha, Y. Hirayama, Y. Ito, S. Iimura, T. Gao, J. M. Yap, M. Zhang, T. Kajino, Y. X. Watanabe, F. Browne, S. D. Chen, M. L. Cortes, P. Doornenbal, N. Fukuda, H. Haba, K. Kusaka, T. M. Kojima, S. Kubono, X. Y. Liu, Z. Liu, W. Marshall, S. Michimasa, J. Y. Moon, H. Miyatake, M. Mukai, M. Ohtake, S. Paschalis, M. Petri, Y. Shimizu, T. Sonoda, H. Suzuki, H. Takeda, R. Taniuchi, Y. Togano, L. Tetly, H. Ueno, H. Wollnik, Y. Yanagisawa, M. Yoshimoto

22. [A Unified Origin of Primordial Black Hole Dark Matter and Nanohertz Gravitational Waves](#user-content-link22)
**Authors:** Guillem Dom\`enech, Shi Pi, Ao Wang

23. [An investigation on the FWHM of absorption features of type Ia supernovae](#user-content-link23)
**Authors:** Xulin Zhao, Keiichi Maeda, Xiaofeng Wang

24. [Comparison of symbolic regression algorithms in Star/galaxy/quasar separation](#user-content-link24)
**Authors:** Rachit Deshpande, Shantanu Desai

25. [Age and metallicity of the Milky Way's nuclear star cluster studied at 3 pc from Sagittarius A*](#user-content-link25)
**Authors:** E. Gallego-Cano, R. Sch\"odel, T. K. Fritz, M. W. Hosek Jr., K. Muzic, A. Feldmeier-Krause, \'A. Mart\'inez-Arranz, F. Nogueras-Lara

26. [The environmental dependence of mid-IR luminous dusty Supernovae](#user-content-link26)
...
27. [Direct VLBI Detection of Interstellar Turbulence Imprint on a Quasar: TXS 2005+403](#user-content-link27)
**Authors:** Alexander Plavin (Harvard), Alexander Pushkarev (CrAO), Yuri Kovalev (MPIfR)

28. [Realistic Equations of State Informing Neutron Star Post-Merger Gravitational-Wave Frequencies](#user-content-link28)
**Authors:** Spencer J. Magnall, Nilaksha Barman, Debarati Chatterjee, Paul D. Lasky, Simon Goode

29. [New possible way to determine stellar wind terminal velocity from analysis of Lyman-$\alpha$ absorption spectra](#user-content-link29)
**Authors:** Sergey D. Korolkov, Vladislav V. Izmodenov

30. [Black hole scalar sirens in the Milky Way](#user-content-link30)
**Authors:** Daniel Gavilan-Martin, Olivier Simon, Dhashin Krishna, Derek F. Jackson Kimball, Dmitry Budker, Arne Wickenbrock

31. [Dark Acoustic Oscillations and the Hubble Tension](#user-content-link31)
**Authors:** Mathias Garny, Florian Niedermann, Martin S. Sloth

32. [Discovery of a nearby radio relic in the low-mass, merging cluster Abell 4067](#user-content-link32)
...
33. [Search for Gamma-ray emission from Abell 119 galaxy cluster using INTEGRAL/ISGRI, COMPTEL, and DAMPE data](#user-content-link33)
**Authors:** Siddhant Manna, Shantanu Desai

34. [A NICER View of PSR J0030+0451: Updated Constraints from Six Years of NICER Observations](#user-content-link34)
**Authors:** Yves Kini, Lucien Mauviard, Tuomo Salmi, Anna L. Watts, Sebastien Guillot, Bas Dorsman, Devarshi Choudhury, Denis Gonz\'alez-Caniulef, Mariska Hoogkamer, Daniela Huppenkothen, Christine Kazantsev, Matthew Kerr, Samaya Nissanke, Paul S. Ray, Pierre Stammler, Serena Vinciguerra

35. [Superposition model for energy reconstruction and mass identification in cosmic ray spectra](#user-content-link35)
**Authors:** Hu Liu, Fanping Li, J. Zhao, L. Y. Wang, Zhe Li, S. Z. Chen

36. [Active Learning for Planet Habitability Classification under Extreme Class Imbalance](#user-content-link36)
**Authors:** R. I. El-Kholy, Z. M. Hayman

37. [Photon rings, gravitational lensing, and ISCOs of exotic compact objects in Einstein-scalar-Maxwell theories](#user-content-link37)
**Authors:** Antonio De Felice, Shinji Tsujikawa

38. [Few Made It Out: A Multi-Messenger Study of an In Situ Solar Energetic Electron Event Driven by a Solar Jet](#user-content-link38)
**Authors:** Meiqi Wang, Bin Chen, Mallory Wickline, Sijie Yu, Sam Krucker, Jeongwoo Lee, Haimin Wang

39. [Weak lensing higher-order statistics to disentangle modified gravity and massive neutrinos](#user-content-link39)
**Authors:** Alessandro Vadal\`a, Vincenzo Fabrizio Cardone, Simone Vinciguerra, Filippo Bouch\`e, Marco Baldi, Carlo Giocoli

40. [Ruling out conventional photoionization models in the closest LINER M31 with CFHT/SITELLE observations](#user-content-link40)
**Authors:** Zongnan Li, Zhiyuan Li, Sumin Wang, Ruben Garcia-Benito, Yifei Jin

41. [Fermion Mass Hierarchy and a High Quality Axion From Gauged U(1) Flavor Symmetry](#user-content-link41)
**Authors:** K. S. Babu, Sai Charan Chandrasekar, Zurab Tavartkiladze

42. [Transient X-ray Sources as Extremely Eccentric Mass-Transfer Binaries with Compact Companions](#user-content-link42)
**Authors:** Jonathan I. Katz, Michael A. Nowak

43. [Gravitational waves from primordial black holes passing by neutron stars: observational prospects for the Galactic center](#user-content-link43)
**Authors:** Nicolas Esser, Juan Garc\'ia-Bellido, Peter Tinyakov

44. [Contemporaneous Optical and Near-Infrared Observations of the Interstellar Comet 3I/ATLAS Pre- and Post-Perihelion](#user-content-link44)
...
45. [Impact of non-standard neutrino-electron interactions on Big Bang Nucleosynthesis](#user-content-link45)
**Authors:** Stefano Gariazzo, Jaume Moncho, Sergio Pastor, Ofelia Pisanti

46. [Weak emission line quasar SDSS J101353.45+492758.1 I. Continuum fitting](#user-content-link46)
**Authors:** Laetitia Gibaud (Faculty of Physics, University of Bia{\l}ystok, ul. Cio{\l}kowskiego 1L, 15-245 Bia{\l}ystok, Poland), Marek Niko{\l}ajuk (Faculty of Physics, University of Bia{\l}ystok, ul. Cio{\l}kowskiego 1L, 15-245 Bia{\l}ystok, Poland), Piotr \.Zycki (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences, ul. Bartycka 18, Warsaw, Poland), Agata R\'o\.za\'nska (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences, ul. Bartycka 18, Warsaw, Poland), Krzysztof Hryniewicz (National Centre for Nuclear Research, Astrophysics Division, ul. Pasteura 7, 02-093 Warsaw, Poland), Rafa{\l} Wojaczy\'nski (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences, ul. Bartycka 18, Warsaw, Poland)

47. [Can the dust eclipses in WR 104 provide constraints on the system's inclination?](#user-content-link47)
**Authors:** Noel D. Richardson, Ryan M. T. White, Anthony J. Fabrega, Emma P. Lieb, Andr\'e-Nicolas Chen\'e, Peter G. Tuthill, John D. Monnier, Grant M. Hill, Peredur M. Williams, Anthony F. J. Moffat, Gerd Weigelt

48. [The hydrodynamics of stratified ultra-relativistic outflows and the origin of GRB X-ray plateaus](#user-content-link48)
**Authors:** Gilad Sadeh, Kenta Hotokezaka, Masaru Shibata

49. [The role of Bethe-Heitler pair production in reconnection-driven flares in M87*](#user-content-link49)
**Authors:** Maria Petropoulou, Despina Karavola, Lorenzo Sironi

50. [The First Four Ground-Level Enhancements in the 1940s: Investigation, Digitisation, and Analysis of Forgotten Data](#user-content-link50)
**Authors:** Hisashi Hayakawa, Stepan Poluianov, Sergey Koldobskiy, Alexander Mishev, Nicholas Larsen, Inna Usoskina, Ilya Usoskin

51. [Monitoring the magnetospheric accretion of the classical T Tauri star DO Tau with SPIRou](#user-content-link51)
**Authors:** J. -F. Donati, P. I. Cristofari, A. Carmona, A. Lavail, C. Moutou, J. Bouvier, K. Perraut, S. H. P. Alencar, F. M\'enard, M. Audard, P. Petit, E. Alecian, T. Ray, the SPIRou science team

52. [Large-amplitude modulations and hours-timescale variability in the early X-ray light curve of a tidal disruption flare](#user-content-link52)
...
53. [Multi-messenger emission derived from relativistic magnetized jet dynamics using a multi-zone framework](#user-content-link53)
**Authors:** Harshita Bhuyan, Bhargav Vaidya, Christian Fendt, Aditya Sharma

54. [Polarisation Singularities of Gravitational Waves](#user-content-link54)
**Authors:** Claire Rigouzzo, Sebastian Golat, Alex J. Vernon, Kyan Louisia, Eugene Lim, Francisco J. Rodriguez-Fortuno

55. [Modeling individual nearby radio galaxies as ultra-high-energy cosmic-ray accelerators](#user-content-link55)
**Authors:** Andressa Cola\c{c}o, Gabriel Azeredo, Isadora Parillo, Cain\~a de Oliveira, Vitor de Souza

56. [Timing and scintillation of a young Galactic halo pulsar](#user-content-link56)
**Authors:** J. M. Yao, F. F. Kou, J. P. Yuan, Y. Wei, William A. Coles, Richard N. Manchester, N. Wang, S. Q. Wang, W. M. Yan

57. [Magnetic Flux Tubes Illuminated by Pulsar Winds](#user-content-link57)
**Authors:** Yifan Sun, C. -Y. Ng, Siming Liu

58. [OmegaNeuron: Applying GravitySpy Similarity Methods to the Search for LIGO Glitch Witnesses](#user-content-link58)
**Authors:** Bri Aleman, Derek Davis

59. [Acceleration of relativistic protons in a CME-perturbed solar wind](#user-content-link59)
**Authors:** Ahmed Houeibib, Filippo Pantellini, Lea Griton

60. [The Split Janus-faced Sun: Magnetic Rhythm and Duality in the Solar Cycle](#user-content-link60)
**Authors:** Weiqi Chen, Kejun Li, Jingchen Xu

61. [Worlds Next Door. III. Indirect Evidence for Enhanced Atmospheric Metallicity and/or the Presence of Water Clouds in the Nearest Jupiter-analog $\epsilon$ Eri b](#user-content-link61)
...
62. [Tri-coupler geometries for achromatic nulling interferometry in the near infrared](#user-content-link62)
...
63. [Universality of the Blandford-Znajek emission in stationary and axisymmetric spacetimes](#user-content-link63)
**Authors:** Filippo Camilloni, Luciano Rezzolla

64. [nanoCMB: A minimal CMB power spectrum calculator in Python](#user-content-link64)
**Authors:** Adam Moss

65. [X-ray Quasi-Periodic Oscillations in Active Galactic Nuclei and Their Implications for the Changing Look Phenomenon](#user-content-link65)
...
66. [Evolution of Sink Pixels in ACS/WFC and Connection to Charge Transfer Efficiency](#user-content-link66)
**Authors:** Alyssa M. Guzman, Jenna E. Ryon

67. [Extending Ground-Based Gravitational-Wave Sensitivity to 5 Hz](#user-content-link67)
...
68. [The Shape of Eccentricity: Rapid Classification of Eccentric Binaries with the Wavelet Scattering Transform](#user-content-link68)
**Authors:** Priscilla Canizares, Seppe J. Staelens, Isobel Romero-Shaw

69. [Temporal Evolution of Sunspot Groups and Increase in the Open flux During Solar Maximum in Cycle 24](#user-content-link69)
**Authors:** Minami Yoshida, Toshifumi Shimizu, Shin Toriumi, Haruhisa Iijima

70. [Principal Component Analysis for ACS/WFC Superbias Temporal Variation](#user-content-link70)
**Authors:** Alyssa M. Guzman, Norman A. Grogin

71. [In-flight calibration of RADEM, the JUICE mission radiation monitor](#user-content-link71)
**Authors:** Marco Pinto, Francisca Santos, Ant\'onio Gomes, Tom\'as Gon\c{c}alves, Lu\'isa Arruda, Patr\'icia Gon\c{c}alves, Laura Rodr\'iguez-Garc\'ia, Rami Vainio, Olivier Witasse, Nicolas Altobelli

72. [Linear Polarization Variations and Circular Polarization are Common Among Airless Bodies](#user-content-link72)
**Authors:** Sloane J. Wiktorowicz, Amanda J. Bayless, Larissa A. Nofi

73. [Monte Carlo Simulations of Secondary Cosmic-Ray Variations in Atmospheric Electric Fields : Implications for Long Duration Electron and Gamma-ray Emissions from Thunderclouds](#user-content-link73)
**Authors:** Harufumi Tsuchiya

74. [Shaping the Digital Future of ErUM Research: Sustainability & Ethics](#user-content-link74)
**Authors:** Luca Di Bella, Jan B\"urger, Markus Demleitner, Torsten En{\ss}lin, Johannes Erdmann, Martin Erdmann, Benjamin Fischer, Martin Gasthuber, Gabriele Gramelsberger, Wolfgang Gr\"undinger, Prateek Gupta, Johannes Hartl, Maximilian Horzela, Vijay Kartik, Stefan Krischer, Eva Kr\"oll, Thomas Kuhr, Katharina K\"urschner, Inga Lakomiec, Valerie Lang, Kristin Lohwasser, Thomas Metcalf, Martin M\"oller, Saskia Nagel, Susanne Pfalzner, Rebecca Redlin, Christopher Schrader, Kathrin Schulz, Markus Schumacher, Kilian Schwarz, Fabian Sigler, Dwayne Spiteri, Achim Stahl, Judith Steinfeld, Wim Vanderbauwhede, Cyrus Walther, Angela Warkentin, Peter Wissmann, Eoin Woods

75. [Updates to the SBC Dark Rate Monitor](#user-content-link75)
**Authors:** Alyssa M. Guzman, Roberto J. Avila

---

## 1. [Single Parameter Model for Galaxy Rotation Curves](https://arxiv.org/abs/2602.24211) <a id="link1"></a>
...
**Comment:** This paper presents a new model for galaxy rotation curves, directly addressing the rotation-curve problem and dark matter in galaxies. It is highly relevant to near-field cosmology, especially the study of dark matter density profiles and satellite luminosity functions. The model's application to the SPARC sample and its potential to reduce free parameters is novel.
...
## 2. [Starbursts hiding in the main sequence: a pathway toward quenching?](https://arxiv.org/abs/2602.23445) <a id="link2"></a>
...
**Comment:** This paper investigates starbursts within the main sequence of star-forming galaxies and their potential link to quenching, using the NewHorizon cosmological simulation. It directly addresses star formation quenching and numerical galaxy simulations, especially the transition between starburst and quenching regimes. Highly relevant.
...
## 3. [Constraining the mass of the M31 ionized baryon Halo using CHIME/FRB Catalog 2](https://arxiv.org/abs/2602.23749) <a id="link3"></a>
...
**Comment:** Directly matches the 'Circumgalactic Medium' criterion, focusing on the CGM of M31 (Andromeda), a near-field cosmology target. Uses FRBs to constrain baryon content, which is a novel observational approach.
...
## 4. [Zooming in on the circumgalactic medium with GIBLE: Cloud-scale simulations with cosmological initial conditions](https://arxiv.org/abs/2602.23416) <a id="link4"></a>
...
**Comment:** Directly matches the 'Circumgalactic Medium' and 'Numerical Galaxy Simulations' criteria. Simulates cool clouds in the CGM of a Milky Way-like galaxy using high-resolution cosmological initial conditions, with implications for CGM structure and evolution.
...
## 5. [Probing power spectrum enhancement at small scales with SKA](https://arxiv.org/abs/2602.24117) <a id="link5"></a>
...
**Comment:** This paper discusses the role of dwarf galaxies and minihalos in reionization, focusing on their clustering and the impact of small-scale power spectrum enhancements. The connection to dwarf galaxies and their abundance, as well as the use of UV luminosity functions, directly matches the 'Near-Field Cosmology' criterion. Theoretical modeling of the ionization field and 21 cm signal also touches on numerical galaxy simulations, but the primary relevance is near-field cosmology.
...
## 6. [The capture of halo material by orbiting subhaloes](https://arxiv.org/abs/2602.23822) <a id="link6"></a>
...
**Comment:** This paper uses high-resolution N-body simulations to study the capture of halo material by orbiting subhaloes, directly addressing the behavior of substructure and satellite galaxies in the context of near-field cosmology and numerical galaxy simulations. It is highly relevant to the near-field cosmology and numerical galaxy simulations criteria.
...
## 7. [First spectroscopic identification of the main sequence in Westerlund 1](https://arxiv.org/abs/2602.24218) <a id="link7"></a>
...
**Comment:** This paper presents spectroscopic identification of the main sequence in Westerlund 1, deriving cluster age and stellar parameters using evolutionary models. It matches the 'Stellar Models' criterion (new application of stellar evolutionary tracks) and also touches on resolved star formation history in a cluster, though not a galaxy. High relevance due to direct use of stellar models and age determination.
...
## 8. [Hydrodynamical simulations of helium-ignited binary white dwarf mergers](https://arxiv.org/abs/2602.23414) <a id="link8"></a>
...
**Comment:** This paper presents 3D hydrodynamical simulations of binary white dwarf mergers, directly relevant to 'Numerical Galaxy Simulations' and also touches on stellar models and explosion mechanisms. The use of two codes and comparison of outcomes adds novelty.
...
## 9. [Eigenmode initialisation of 2D (magneto)hydrodynamic simulations](https://arxiv.org/abs/2602.23849) <a id="link9"></a>
...
**Comment:** This paper presents a novel method for initializing (magneto)hydrodynamic simulations, which is relevant to numerical galaxy simulations. However, the focus is on simulation methodology rather than galaxy physics or new physics models, so relevance is borderline.
...
## 10. [Probing inflationary features with galaxy ultraviolet luminosity function observables](https://arxiv.org/abs/2602.23913) <a id="link10"></a>
...
**Comment:** Uses galaxy ultraviolet luminosity function measurements at high redshift to probe inflationary features. While the luminosity function is a relevant keyword, the focus is on constraining inflationary power spectrum, not on near-field cosmology or satellite luminosity functions. Borderline relevance due to use of galaxy luminosity function.
...
## 11. [A New Window into the Baryon Cycle at Cosmic Noon with Line Intensity Mapping: Forecasts for auto- and cross-correlations in [CII]-158$\mu$m, HI 21 cm, CO$_{J+1\rightarrow J}$, and H$\alpha$ galaxies](https://arxiv.org/abs/2602.24120) <a id="link11"></a>
...
**Comment:** This paper presents simulation-based forecasts for line intensity mapping of various tracers ([CII], HI, CO, Hα) at z~0.5-1.7, focusing on the baryon cycle and star formation at cosmic noon. While it discusses star formation and baryon cycling, it is not focused on resolved star formation histories, dwarf galaxies, or near-field cosmology. The relevance is borderline due to the connection to star formation and baryon cycle.
...
## 12. [ALMA High-J CO Spectroscopy of High-Redshift Galaxies. I. An Archive-based Catalog of CO Spectral Line Energy Distributions](https://arxiv.org/abs/2602.23521) <a id="link12"></a>
...
**Comment:** This paper presents a catalog of high-J CO spectral line energy distributions for high-redshift galaxies, including Hot DOGs, SMGs, and quasars. It analyzes molecular gas excitation and heating mechanisms. While it deals with galaxy-scale molecular gas and excitation, it does not focus on dwarf galaxies, resolved SFHs, or near-field cosmology. The relevance is borderline due to the connection to star formation and ISM physics.
...
## 13. [Filling the Gap in Cluster Evolution: JWST's Glimpse into a Young, Star-Forming Cluster at Cosmic Noon](https://arxiv.org/abs/2602.24162) <a id="link13"></a>
...
**Comment:** The paper presents a detailed study of a proto-cluster at z~1.8, including star-forming galaxies and environmental quenching. While the focus is on a massive cluster, there is discussion of the onset of environmental quenching and star formation, which is tangentially relevant to the star formation quenching criterion, but not focused on dwarfs.
...
## 14. [Survival Analysis of Intermediate-Mass Black Holes in Dense Star Clusters](https://arxiv.org/abs/2602.23431) <a id="link14"></a>
...
**Comment:** This paper studies intermediate-mass black holes in globular clusters, focusing on their survival and ejection probabilities. While it touches on near-field cosmology (globular clusters in the Milky Way), it does not focus on dwarf galaxies or satellite systems, so relevance is borderline.
...
## 15. [Transition of Magnetic Reconnection Regimes in Partially Ionized Plasmas](https://arxiv.org/abs/2602.23683) <a id="link15"></a>
...
**Comment:** Presents a systematic study of magnetic reconnection regimes in partially ionized plasmas. While relevant to plasma physics and possibly ISM processes, it does not directly address any of the core topics (e.g., galaxy simulations, star formation histories, outflows, etc.).
...
## 16. [The PLUTO Code on GPUs: Offloading Lagrangian Particle Methods](https://arxiv.org/abs/2602.23434) <a id="link16"></a>
...
**Comment:** This paper presents a GPU-compatible redesign of the PLUTO code's Lagrangian Particle module for simulating shock-accelerated particles in relativistic magnetized flows. It is a numerical simulation paper, but the focus is on non-thermal emission and cosmic ray transport in large-scale flows, not galaxy simulations or the core topics.
...
## 17. [Forecasting the cross correlation of Terahertz Intensity Mapper [CII] line intensity maps with Euclid galaxies](https://arxiv.org/abs/2602.24204) <a id="link17"></a>

**ArXiv ID:** 2602.24204

**Authors:** Justin S. Bracks, Ryan P. Keenan, Shubh Agrawal, Garrett K. Keating, James E. Aguirre, Adam Lidz, Charles M. Bradford, Brockton Brendal, Jeffrey Filippini, Jianyang Fu, Karolina Garcia, Christopher Groppi, Steven Hailey-Dunsheath, Reinier M. J. Janssen, Wooseok Kang, Lun-Jun Liu, Ian Lowe, Alex Manduca, Daniel P. Marrone, Philip Mauskopf, Evan C. Mayer, Sydnee O'Donnell, Talia Saeid, Simon Tartakovsky, Mathilde Cuyck, Joaquin D. Vieira, Jessica A. Zebrowski

**Abstract:** We forecast that the Terahertz Intensity Mapper (TIM) cross-correlated with Euclid's Fornax deep field (EDF-F), TIM$\times$EDF-F, will detect the [CII]-galaxy cross-power spectrum at a median redshift of 1.1 with $\gtrsim 7 \sigma$ confidence. The Poisson component of the cross-power spectrum at $0.1 \leq k \leq 10$ hMpc$^{-1}$ (i.e. cross-shot noise) will be detected at $\gtrsim 3 \sigma$ in 4 bins spanning $0.5 < z< 1.7$. This measurement will constrain the mean [CII] specific intensity over half of cosmic history and assess the degree to which Euclid-selected galaxies account for the [CII] intensity observed by TIM. We find that TIM can detect the cross-power spectrum across a wide range of [CII] intensity models.

**Comment:** The paper forecasts the cross-correlation of [CII] intensity maps with Euclid galaxies, probing star formation and [CII] emission at z~1.1. While it touches on star formation and galaxy evolution, it does not focus on resolved star formation histories, quenching, or dwarf galaxies.
...
## 19. [A Quality Framework for Testing Gravity with Wide Binaries: No Evidence for MOND](https://arxiv.org/abs/2602.24035) <a id="link19"></a>
...
**Comment:** Tests gravity using wide binaries, with implications for modified gravity theories. Wide binaries are not dwarf satellites or substructure, and the focus is on gravity testing rather than galaxy formation or evolution.
...
## 20. [Discovery of a runaway star likely ejected by a Type Iax Supernova](https://arxiv.org/abs/2602.23900) <a id="link20"></a>
...
**Comment:** The paper reports the discovery of a runaway star likely ejected by a Type Iax supernova. While it deals with stellar evolution and supernovae, it does not address near-field cosmology, resolved star formation histories, quenching, or galaxy simulations.
...
## 21. [High-Precision Mass Measurements of Proton-Rich Rh, Pd, Cd isotopes in the vicinity of 100Sn and Impact on X-Ray Burst and Supernova Nucleosynthesis](https://arxiv.org/abs/2602.23776) <a id="link21"></a>

**ArXiv ID:** 2602.23776

**Authors:** D. S. Hou, W. D. Xian, M. Rosenbusch, M. Wada, P. Schury, A. Takamine, Y. Luo, J. Lee, H. Ishiyama, S. Nishimura, C. Y. Fu, A. Dohi, H. Feng, Z. He, S. Kimura, T. Niwase, V. H. Phong, T. T. Yeung, Q. B. Zeng, S. X. Zha, Y. Hirayama, Y. Ito, S. Iimura, T. Gao, J. M. Yap, M. Zhang, T. Kajino, Y. X. Watanabe, F. Browne, S. D. Chen, M. L. Cortes, P. Doornenbal, N. Fukuda, H. Haba, K. Kusaka, T. M. Kojima, S. Kubono, X. Y. Liu, Z. Liu, W. Marshall, S. Michimasa, J. Y. Moon, H. Miyatake, M. Mukai, M. Ohtake, S. Paschalis, M. Petri, Y. Shimizu, T. Sonoda, H. Suzuki, H. Takeda, R. Taniuchi, Y. Togano, L. Tetly, H. Ueno, H. Wollnik, Y. Yanagisawa, M. Yoshimoto

**Abstract:** Using the ZeroDegree multi-reflection time-of-flight mass spectrograph of the CRISMASS project at RIKEN Radioactive Isotope Beam Factory, we performed high-precision mass measurements of proton-rich nuclei near the doubly magic nucleus 100Sn, achieving uncertainties on the order of 10 keV. The masses of 91Rh, 92Pd, and 96Cd were determined for the first time with high precision, and the accuracy of several additional masses was substantially improved. Incorporating the new data into X-ray burst simulations significantly reduces the abundance uncertainties in the $A$ = 90-100 region, shifting the reaction flow toward $A$ = 90 production and suppressing the synthesis of heavier nuclei. Further investigation of the $\nu p$-process indicates that 99Rh plays a significant role in the reaction flow within the mass region studied. These high-precision mass measurements refine the mass surface near 100Sn and provide critical constraints on models of proton-rich nucleosynthesis.

**Comment:** This paper presents high-precision mass measurements of proton-rich isotopes near 100Sn and discusses their impact on X-ray burst and supernova nucleosynthesis. While it is relevant to nucleosynthesis and stellar evolution, it does not address galaxy-scale topics, resolved SFHs, or near-field cosmology.
...
## 22. [A Unified Origin of Primordial Black Hole Dark Matter and Nanohertz Gravitational Waves](https://arxiv.org/abs/2602.24061) <a id="link22"></a>
...
**Comment:** The paper discusses primordial black holes as dark matter and their connection to gravitational waves. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, galaxy simulations, or any of the other core topics.
...
## 24. [Comparison of symbolic regression algorithms in Star/galaxy/quasar separation](https://arxiv.org/abs/2602.24022) <a id="link24"></a>
...
**Comment:** This paper presents symbolic regression algorithms for star/galaxy/quasar classification in SDSS. While it deals with galaxy classification, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, or galaxy simulations.
...
## 25. [Age and metallicity of the Milky Way's nuclear star cluster studied at 3 pc from Sagittarius A*](https://arxiv.org/abs/2602.23904) <a id="link25"></a>
...
**Comment:** This paper studies the star formation history and metallicity of the Milky Way's nuclear star cluster, focusing on resolved stellar populations and color-magnitude diagram fitting. However, the focus is on the Galactic center, which is explicitly listed as irrelevant. The methods (resolved SFH from CMDs) are relevant, but the target is not.
...
## 26. [The environmental dependence of mid-IR luminous dusty Supernovae](https://arxiv.org/abs/2602.23673) <a id="link26"></a>
...
**Comment:** The paper analyzes the environments of mid-IR luminous dusty supernovae, including correlations with star formation rate and metallicity. While it discusses star formation and supernovae, it does not focus on resolved star formation histories, quenching, or dwarf galaxies.
...
## 27. [Direct VLBI Detection of Interstellar Turbulence Imprint on a Quasar: TXS 2005+403](https://arxiv.org/abs/2602.24255) <a id="link27"></a>
...
**Comment:** This paper focuses on VLBI detection of interstellar turbulence using an AGN as a background source. While it probes Galactic turbulence, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 28. [Realistic Equations of State Informing Neutron Star Post-Merger Gravitational-Wave Frequencies](https://arxiv.org/abs/2602.23646) <a id="link28"></a>
...
**Comment:** This paper uses realistic equations of state to inform neutron star post-merger gravitational-wave frequencies. It is focused on neutron star mergers and gravitational waves, not on the core topics.
...
## 29. [New possible way to determine stellar wind terminal velocity from analysis of Lyman-$\alpha$ absorption spectra](https://arxiv.org/abs/2602.23781) <a id="link29"></a>
...
**Comment:** This paper proposes a new method to determine stellar wind terminal velocity from Lyman-α absorption spectra, involving stellar wind/ISM interactions. While it deals with stellar winds and their interaction with the ISM, it does not address galaxy-scale outflows, resolved star formation histories, or near-field cosmology. The relevance is low.
...
## 30. [Black hole scalar sirens in the Milky Way](https://arxiv.org/abs/2602.23415) <a id="link30"></a>
...
**Comment:** This paper discusses hypothetical scalar particle emission from black holes in the Milky Way, introducing the concept of 'BH scalar sirens.' While it involves Milky Way black holes, it does not address near-field cosmology, satellite galaxies, resolved SFHs, or galaxy evolution. The relevance is low.
...
## 32. [Discovery of a nearby radio relic in the low-mass, merging cluster Abell 4067](https://arxiv.org/abs/2602.24206) <a id="link32"></a>
...
**Comment:** The paper discusses radio relics in a low-mass galaxy cluster, focusing on merger-driven shocks and radio emission. While it touches on galaxy clusters and their evolution, it does not address dwarf galaxies, star formation histories, quenching, or galaxy simulations, and is therefore not directly relevant.
...
## 34. [A NICER View of PSR J0030+0451: Updated Constraints from Six Years of NICER Observations](https://arxiv.org/abs/2602.23743) <a id="link34"></a>
...
**Comment:** This paper focuses on neutron star mass-radius constraints using pulse-profile modeling, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models (as defined by evolutionary tracks/atmospheres).
...
## 35. [Superposition model for energy reconstruction and mass identification in cosmic ray spectra](https://arxiv.org/abs/2602.23637) <a id="link35"></a>
...
**Comment:** Presents a new method for reconstructing energy and mass in cosmic ray spectra, relevant to cosmic ray physics but not to any of the core topics (near-field cosmology, galaxy simulations, star formation, etc.).
...
## 36. [Active Learning for Planet Habitability Classification under Extreme Class Imbalance](https://arxiv.org/abs/2602.23666) <a id="link36"></a>
...
**Comment:** Applies active learning to exoplanet habitability classification. While interesting, this is not related to any of the core topics (near-field cosmology, resolved star formation histories, galaxy simulations, etc.).
...
## 37. [Photon rings, gravitational lensing, and ISCOs of exotic compact objects in Einstein-scalar-Maxwell theories](https://arxiv.org/abs/2602.23657) <a id="link37"></a>
...
**Comment:** Studies exotic compact objects in Einstein-scalar-Maxwell theories, focusing on photon rings and gravitational lensing. Not related to galaxy simulations, star formation, or near-field cosmology.
...
## 38. [Few Made It Out: A Multi-Messenger Study of an In Situ Solar Energetic Electron Event Driven by a Solar Jet](https://arxiv.org/abs/2602.24185) <a id="link38"></a>
...
**Comment:** Multi-messenger study of solar energetic electron events driven by a solar jet. Focus is on solar physics, not on any of the core topics.
...
## 39. [Weak lensing higher-order statistics to disentangle modified gravity and massive neutrinos](https://arxiv.org/abs/2602.24154) <a id="link39"></a>
...
**Comment:** The paper discusses weak lensing higher-order statistics to distinguish modified gravity and massive neutrinos. It is cosmological in nature and does not address near-field cosmology, resolved star formation histories, quenching, or galaxy simulations.
...
## 40. [Ruling out conventional photoionization models in the closest LINER M31 with CFHT/SITELLE observations](https://arxiv.org/abs/2602.23984) <a id="link40"></a>
...
**Comment:** The paper studies the ionization mechanisms in the central region of M31, focusing on LINER emission and photoionization models. Since it focuses on the bulge and central kpc of M31, it is not relevant to near-field cosmology or the other core topics.
...
## 41. [Fermion Mass Hierarchy and a High Quality Axion From Gauged U(1) Flavor Symmetry](https://arxiv.org/abs/2602.24253) <a id="link41"></a>
...
**Comment:** The paper presents models for fermion mass hierarchy and axion physics from a gauged U(1) flavor symmetry. It is particle physics and cosmology, not related to the core topics.
...
## 42. [Transient X-ray Sources as Extremely Eccentric Mass-Transfer Binaries with Compact Companions](https://arxiv.org/abs/2602.23474) <a id="link42"></a>
...
**Comment:** Focuses on X-ray transients in stellar-compact object binaries, with mention of Galactic analogues of tidal disruption events. However, the topic is not directly related to near-field cosmology, dwarf galaxies, or any of the core criteria. TDEs are specifically listed as irrelevant.
...
## 43. [Gravitational waves from primordial black holes passing by neutron stars: observational prospects for the Galactic center](https://arxiv.org/abs/2602.23429) <a id="link43"></a>
...
**Comment:** Investigates gravitational waves from primordial black holes passing by neutron stars, with a focus on the Galactic center. The topic is not related to near-field cosmology, dwarf galaxies, or any of the core criteria.
...
## 44. [Contemporaneous Optical and Near-Infrared Observations of the Interstellar Comet 3I/ATLAS Pre- and Post-Perihelion](https://arxiv.org/abs/2602.23586) <a id="link44"></a>
...
**Comment:** Reports spectroscopic observations of an interstellar comet. The focus is on cometary composition and spectral features, not on any of the core topics.
...
## 45. [Impact of non-standard neutrino-electron interactions on Big Bang Nucleosynthesis](https://arxiv.org/abs/2602.23915) <a id="link45"></a>
...
**Comment:** Examines non-standard neutrino-electron interactions and their impact on Big Bang Nucleosynthesis. This is cosmology/particle physics, not near-field cosmology or any of the core topics.
...
## 46. [Weak emission line quasar SDSS J101353.45+492758.1 I. Continuum fitting](https://arxiv.org/abs/2602.24217) <a id="link46"></a>
...
**Comment:** Broadband study of a weak emission line quasar, focusing on continuum fitting and accretion physics. Not related to any of the core topics.
...
## 47. [Can the dust eclipses in WR 104 provide constraints on the system's inclination?](https://arxiv.org/abs/2602.23606) <a id="link47"></a>
...
**Comment:** The paper studies dust eclipses in a massive binary system (WR 104) to constrain orbital inclination. It focuses on massive stars and their dust production, not on dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 48. [The hydrodynamics of stratified ultra-relativistic outflows and the origin of GRB X-ray plateaus](https://arxiv.org/abs/2602.24085) <a id="link48"></a>
...
**Comment:** No criteria match; focuses on GRB outflows and X-ray plateaus, not on galaxy-scale outflows or star formation driven outflows.
...
## 49. [The role of Bethe-Heitler pair production in reconnection-driven flares in M87*](https://arxiv.org/abs/2602.23435) <a id="link49"></a>
...
**Comment:** The paper investigates Bethe-Heitler pair production in reconnection-driven flares in M87*, focusing on high-energy emission processes near a supermassive black hole. It does not address any of the core topics.
...
## 50. [The First Four Ground-Level Enhancements in the 1940s: Investigation, Digitisation, and Analysis of Forgotten Data](https://arxiv.org/abs/2602.24250) <a id="link50"></a>
...
**Comment:** This paper digitizes and analyzes forgotten data on early ground-level enhancements from solar energetic particles. It is focused on solar and heliospheric physics, not on the core topics.
...
## 51. [Monitoring the magnetospheric accretion of the classical T Tauri star DO Tau with SPIRou](https://arxiv.org/abs/2602.24078) <a id="link51"></a>
...
**Comment:** This paper presents observations of a classical T Tauri star, focusing on magnetospheric accretion, stellar magnetic fields, and possible planet/disk structure. It is not relevant to galaxy-scale star formation, resolved SFHs, or near-field cosmology.
...
## 52. [Large-amplitude modulations and hours-timescale variability in the early X-ray light curve of a tidal disruption flare](https://arxiv.org/abs/2602.23418) <a id="link52"></a>
...
**Comment:** This paper presents observations of a tidal disruption event (TDE) and discusses X-ray variability mechanisms. TDEs and SMBH accretion are explicitly listed as irrelevant.
...
## 53. [Multi-messenger emission derived from relativistic magnetized jet dynamics using a multi-zone framework](https://arxiv.org/abs/2602.24088) <a id="link53"></a>
...
**Comment:** This paper models multi-messenger emission from relativistic AGN jets, focusing on jet dynamics, particle acceleration, and neutrino production. AGN jets and their emission are not relevant to the core topics.
...
## 54. [Polarisation Singularities of Gravitational Waves](https://arxiv.org/abs/2602.23425) <a id="link54"></a>
...
**Comment:** This paper extends the theory of polarization singularities to gravitational waves and higher spin fields, which is not related to any of the core topics.
...
## 55. [Modeling individual nearby radio galaxies as ultra-high-energy cosmic-ray accelerators](https://arxiv.org/abs/2602.23458) <a id="link55"></a>
...
**Comment:** No criteria match; focuses on radio galaxies as cosmic-ray accelerators, not on galaxy simulations or near-field cosmology.
...
## 56. [Timing and scintillation of a young Galactic halo pulsar](https://arxiv.org/abs/2602.23855) <a id="link56"></a>
...
**Comment:** No criteria match; focuses on timing and scintillation of a halo pulsar, not on galaxy or stellar models.
...
## 57. [Magnetic Flux Tubes Illuminated by Pulsar Winds](https://arxiv.org/abs/2602.23850) <a id="link57"></a>
...
**Comment:** No criteria match; focuses on magnetic flux tubes and pulsar winds, not on galaxy or stellar models.
...
## 58. [OmegaNeuron: Applying GravitySpy Similarity Methods to the Search for LIGO Glitch Witnesses](https://arxiv.org/abs/2602.23460) <a id="link58"></a>
...
**Comment:** This paper presents a machine-learning tool for identifying LIGO glitch witnesses, which is unrelated to the core topics of galaxy evolution, star formation, or stellar models.
...
## 59. [Acceleration of relativistic protons in a CME-perturbed solar wind](https://arxiv.org/abs/2602.23723) <a id="link59"></a>
...
**Comment:** The paper investigates proton acceleration in the solar wind during CME events, which is not related to galaxy evolution, star formation, or stellar models.
...
## 60. [The Split Janus-faced Sun: Magnetic Rhythm and Duality in the Solar Cycle](https://arxiv.org/abs/2602.23641) <a id="link60"></a>
...
**Comment:** This paper analyzes the duality in the solar cycle, identifying strong and weak field groups. It is focused on solar physics and does not address any of the core topics.
...
## 62. [Tri-coupler geometries for achromatic nulling interferometry in the near infrared](https://arxiv.org/abs/2602.23693) <a id="link62"></a>
...
**Comment:** This paper is about photonic tri-coupler designs for nulling interferometry in the near-infrared, relevant for exoplanet detection instrumentation. It does not match any of the core topics (galaxy evolution, star formation, near-field cosmology, etc.).
...
## 63. [Universality of the Blandford-Znajek emission in stationary and axisymmetric spacetimes](https://arxiv.org/abs/2602.23417) <a id="link63"></a>
...
**Comment:** This paper studies the Blandford-Znajek mechanism in black hole spacetimes, which is unrelated to the core topics (no connection to galaxy simulations, star formation, or near-field cosmology).
...
## 64. [nanoCMB: A minimal CMB power spectrum calculator in Python](https://arxiv.org/abs/2602.23466) <a id="link64"></a>
...
**Comment:** The paper presents a minimal CMB power spectrum calculator in Python, which is not related to any of the core topics.
...
## 65. [X-ray Quasi-Periodic Oscillations in Active Galactic Nuclei and Their Implications for the Changing Look Phenomenon](https://arxiv.org/abs/2602.23724) <a id="link65"></a>
...
**Comment:** This paper focuses on X-ray quasi-periodic oscillations in AGN, specifically in changing-look AGN, NLS1s, and TDEs. The subject matter is supermassive black holes and accretion phenomena, which are explicitly listed as irrelevant in the criteria. There is no connection to dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 66. [Evolution of Sink Pixels in ACS/WFC and Connection to Charge Transfer Efficiency](https://arxiv.org/abs/2602.23537) <a id="link66"></a>
...
**Comment:** The paper analyzes detector effects (sink pixels and charge transfer efficiency) in the ACS/WFC instrument, which is not related to any of the core astrophysical topics such as galaxy evolution, star formation, or stellar models.
...
## 67. [Extending Ground-Based Gravitational-Wave Sensitivity to 5 Hz](https://arxiv.org/abs/2602.23531) <a id="link67"></a>
...
**Comment:** No criteria match; focuses on gravitational-wave detector technology and sensitivity, not related to galaxy or stellar topics.
...
## 68. [The Shape of Eccentricity: Rapid Classification of Eccentric Binaries with the Wavelet Scattering Transform](https://arxiv.org/abs/2602.24079) <a id="link68"></a>
...
**Comment:** No criteria match; focuses on classification of eccentric binaries in gravitational-wave signals, unrelated to galaxy or stellar topics.
...
## 69. [Temporal Evolution of Sunspot Groups and Increase in the Open flux During Solar Maximum in Cycle 24](https://arxiv.org/abs/2602.24118) <a id="link69"></a>
...
**Comment:** No criteria match; focuses on sunspot groups and solar magnetic field evolution, unrelated to galaxy or stellar models.
...
## 70. [Principal Component Analysis for ACS/WFC Superbias Temporal Variation](https://arxiv.org/abs/2602.24244) <a id="link70"></a>
...
**Comment:** This paper analyzes the temporal variation of superbias calibration frames for HST ACS/WFC using PCA. It is focused on instrumentation calibration and does not match any of the core science topics.
...
## 71. [In-flight calibration of RADEM, the JUICE mission radiation monitor](https://arxiv.org/abs/2602.24246) <a id="link71"></a>
...
**Comment:** This paper presents in-flight calibration of a radiation monitor aboard the JUICE mission, with no connection to the core topics.
...
## 72. [Linear Polarization Variations and Circular Polarization are Common Among Airless Bodies](https://arxiv.org/abs/2602.24196) <a id="link72"></a>
...
**Comment:** No criteria match; focuses on polarization of asteroids and NEOs, which is unrelated to the core topics.
...
## 73. [Monte Carlo Simulations of Secondary Cosmic-Ray Variations in Atmospheric Electric Fields : Implications for Long Duration Electron and Gamma-ray Emissions from Thunderclouds](https://arxiv.org/abs/2602.23542) <a id="link73"></a>
...
**Comment:** No criteria match; focuses on cosmic-ray variations in atmospheric electric fields and thunderclouds, unrelated to galaxy or stellar topics.
...
## 74. [Shaping the Digital Future of ErUM Research: Sustainability & Ethics](https://arxiv.org/abs/2602.24087) <a id="link74"></a>
...
**Comment:** This is a workshop report on sustainability and ethics in data-intensive research. It is not relevant to any of the core astrophysics topics.
...
## 75. [Updates to the SBC Dark Rate Monitor](https://arxiv.org/abs/2602.23555) <a id="link75"></a>
...
**Comment:** This paper focuses on calibration and monitoring of the Solar Blind Channel detector on HST, with no connection to any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
