...
1. [3D NLTE Sodium abundances in late-type stars. Abundance corrections and synthetic spectra](#user-content-link1)
**Authors:** G. Canocchi, E. X. Wang, A. M. Amarsi, K. Lind, M. Racca

2. [The Fate of the Milky Way--Andromeda System: To Merge or Not?](#user-content-link2)
**Authors:** Hao Wu, Yang Huang, Huawei Zhang, Guangze Sun, Shi Shao

3. [How Massive Can a Population III Starburst Be? Simulating the First Galaxies with High Lyman-Werner Background](#user-content-link3)
...
4. [Reinterpreting the puzzling properties of z>6 galaxies within a variable IMF framework](#user-content-link4)
**Authors:** Fabio Fontanot (INAF-OATS, IFPU), Gabriella De Lucia (INAF-OATs, IFPU), Lizhi Xie (Tianjin Normal University), Stefano Zibetti (INAF-OAA), Francesco La Barbera (INAF-OACN), Sebastiano Cantarella (UniTS, INAF-OATS), Michaela Hirschmann (EPFL, INAF-OATS), Stephane Charlot (IAP), Gustavo Bruzual (CRyA-UNAM)

5. [Second Order Closures for the Radiative Transfer Equation: Some Are Unstable](#user-content-link5)
**Authors:** Nickolay Y. Gnedin, Harley Katz

6. [How well does MAGPHYS recover galaxy properties? A test using EAGLE simulated star-forming galaxies](#user-content-link6)
...
7. [Identification of low redshift groups and clusters of galaxies in the X-CLASS survey and the X-ray luminosity-temperature relation](#user-content-link7)
...
8. [CHANG-ES. XXXVIII. A Thin Radio Halo Shaped by Slow Cosmic-Ray Transport in the Quiescent Galaxy NGC 4565](#user-content-link8)
**Authors:** Jianghui Xu, Jiang-Tao Li, Guilin Liu, Luan Luan, Volker Heesen, Rainer Beck, Judith Irwin, Q. Daniel Wang, Michael Stein, Li-Yuan Lu, Yang Yang, Jeroen Stil, Jayanne English, Ralf-J\"urgen Dettmar

9. [HI Gas and Star Formation in Major Galaxy Pairs from the FAST All-Sky HI Survey (FASHI)](#user-content-link9)
**Authors:** Shulan Yan, Qingzheng Yu, Taotao Fang, Chuan He, Andrew Ma, Junfeng Wang, C. Kevin Xu, Ming Zhu, Weishan Zhu

10. [Impact of stellar rotation on type II supernova progenitor masses from pre-explosion imaging](#user-content-link10)
**Authors:** L. Martinez (Instituto de Astrof\'isica de La Plata), O. G. Benvenuto (Instituto de Astrof\'isica de La Plata, Facultad de Ciencias Astron\'omicas y Geof\'isicas - UNLP), M. A. De Vito (Instituto de Astrof\'isica de La Plata, Facultad de Ciencias Astron\'omicas y Geof\'isicas - UNLP)

11. [The time-delay model and its applications to galactic archaeology](#user-content-link11)
**Authors:** Francesca Matteucci

12. [SDSS-V LVM: A spatially resolved study of the physical conditions and the chemical abundance discrepancy in the Lagoon Nebula (M 8)](#user-content-link12)
**Authors:** Amrita Singh, Guillermo A. Blanc, Nimisha Kumari, J. E. M\'endez-Delgado, Sebasti\'an F. S\'anchez, Christophe Morisset, Enrico Congiu, Kathryn Kreckel, Alexandre Roman-Lopes, Oleg Egorov, Niv Drory, Ravi Sankrit, Alfredo Mej\'ia-Narv\'aez, Evgeniya Egorova, Amy M. Jones, Dmitry Bizyaev, Natascha Sattler, Evelyn J. Johnston, Dante Minniti, Rodolfo de J. Zerme\~no, Jos\'e G. Fern\'andez-Trincado, Juna A. Kollmeier

13. [The Two Component Circumgalactic Medium Emission around z~2 Radio-loud Quasars](#user-content-link13)
**Authors:** Sanchit Sabhlok, Shelley A. Wright, Andrey Vayner, Norman Murray, Lee Armus, Maren Cosens, James Wiley, Eileen Meyer, Karthik Reddy, Marie Wingyee Lau

14. [Detailed Analysis of the NGC 2168 Cluster, Leveraging Gaia DR3](#user-content-link14)
**Authors:** Nasser M. Ahmed, Remziye Canbay, Deniz Cennet \c{C}{\i}nar

15. [A systematic study of AGN feedback in a disk galaxy II: MACER prediction of X-ray surface brightness profile and comparison with eROSITA observations](#user-content-link15)
**Authors:** Yuxuan Zou, Feng Yuan, Suoqing Ji, Lin He, Zhiyuan Li, Yi Zhang, Johan Comparat, Zhijie Qu, Taotao Fang

16. [Enhancing cosmological constraints with nonlinear tanh transformations of Hermite-Gaussian Derivative fields](#user-content-link16)
**Authors:** Zhiwei Min, Ye Ma, Zhujun Jiang, Jiacheng Ding, Fenfen Yin, Le Zhang, Xiaodong Li

17. [Primordial Non-Gaussianity and the Field-Level Cramer-Rao Bound](#user-content-link17)
**Authors:** Eugene Chen, Daniel Green, Vincent S. H. Lee

18. [Solving the Cosmic Coincidence Problem: The Locally Pumped Dark Energy Model](#user-content-link18)
**Authors:** Carlo R. Contaldi, Mauro Pieroni

19. [High-resolution near-IR spectroscopy of the B[e] supergiant LHA 115-S 18: discovery of hot water vapor emission](#user-content-link19)
**Authors:** M. L. Arias, A. F. Torres, M. Kraus, L. S. Cidale

20. [A large population of over-massive black hole quasars at z=0.3-0.8 revealed by eROSITA](#user-content-link20)
...
21. [SGR 1935+2154's Quiet Local Environment: Clues for Its Progenitor](#user-content-link21)
**Authors:** Wenlang He, Ping Zhou, Bingqiu Chen

22. [Inside the Black Box of Big Bang Nucleosynthesis: Parameter Sensitivity Studies in Light of new LBT Data](#user-content-link22)
**Authors:** Anne-Katherine Burns

23. [Probing the Bias of Large-Scale Structure with Unlocalized Fast Radio Bursts](#user-content-link23)
**Authors:** Yu-Tong Su, Zhengxiang Li

24. [Dark Matter Detection through Rydberg Atom Transducer](#user-content-link24)
**Authors:** J. F. Chen, Haokun Fu, Christina Gao, Jing Shu, Geng-Bo Wu, Peiran Yin, Yi-Ming Zhong, Ying Zuo

25. [What does it take to have $N_{\rm eff} < 3$ at CMB times?](#user-content-link25)
**Authors:** Miguel Escudero, Maksym Ovchynnikov, Neal Weiner

26. [Unlocking accretion rate diagnostics for high-mass protostars using JWST/MIRI HI lines](#user-content-link26)
**Authors:** S. D. Reyes-Reyes, H. Beuther, E. F. van Dishoeck, C. Gieser, A. Caratti o Garatti, {\L}. Tychoniec, P. J. Kavanagh, P. D. Klaassen, K. Justtanont, L. Francis, V. J. M. Le Gouellec, R. Devaraj, T. P. Ray, Y. Chen, M. G. Navarro, W. R. M. Rocha, M. L. van Gelder

27. [The GRAVITY young stellar object survey -- XV. The star-disk interaction region of the T Tauri star DO Tau](#user-content-link27)
**Authors:** GRAVITY Collaboration, K. Perraut, J. Bouvier, H. Nowacki, A. Sousa, M. Houll\'e, J. F. Donati, E. Alecian, S. Alencar, M. Audard, J. -P. Berger, Y. -I. Bouarour, E. Bordier, G. Bourdarot, A. Carmona, A. Caratti o Garatti, C. Dougados, M. Flock, R. Garcia-Lopez, K. Grankin, A. Kospal, L. Labadie, C. Moutou, J. Sanchez-Bermudez, H. Shang, M. Takami, A. Amorim, W. Brandner, Y. Cl\'enet, R. Davies, R. Dembet, A. Drescher, A. Eckart, F. Eisenhauer, M. Fabricius, H. Feuchtgruber, N. M. F\"orster-Schreiber, P. Garcia, E. Gendron, R. Genzel, S. Gillessen, T. Henning, L. Jocou, S. Joharle, P. Kervella, L. Kreidberg, S. Lacour, V. Lapeyr\`ere, J. -B. Le Bouquin, D. Lutz, F. Mang, T. Ott, T. Paumard, G. Perrin, S. Rabien, D. C. Ribeiro, M. Sadun Bordoni, D. Santos, J. Shangguan, T. Shimizu, C. Straubmeier, E. Sturm, L. Tacconi, F. Vincent

28. [Intracluster light is a close tracer of the dark matter halo shape](#user-content-link28)
**Authors:** Adela Fernandez, Yannick Bah\'e, Nina Hatch, Joseph Butler, Tutku Kolcu, Garreth Martin, Mireia Montes

29. [Cluster Infall for Mass Calibration in the Stage-IV Era](#user-content-link29)
**Authors:** Connor Sweeney, Eduardo Rozo

30. [Analyzing Fermionic Dark Matter scenarios with anomalous compact objects](#user-content-link30)
**Authors:** Yaiza Cano, Jose Manuel Alarc\'on

31. [Formation of spirals in early stage protoplanetary discs](#user-content-link31)
**Authors:** Marc Van den Bossche, Oliver Gressel

32. [MEOW: The increase in the obscured AGN fraction in mid-infrared from 0 < z < 6 with JWST MIRI](#user-content-link32)
...
33. [3D CMZ V: A new orbital model of our Galaxy's Center, informed by data across the electromagnetic spectrum](#user-content-link33)
**Authors:** Dani R. Lipman, Cara Battersby, Daniel Walker, Ma\"ica Clavel, B. L. DuBois, Adam Ginsburg, Jonathan D. Henshaw, Ralf S. Klessen, Elisabeth A. C. Mills, Francisco Nogueras-Lara, Mattia C. Sormani, Robin G. Tress

34. [Data-calibrated point spread function prediction: General description of the method and demonstration on MUSE-NFM](#user-content-link34)
**Authors:** Arseniy Kuznetsov, Benoit Neichel, Sylvain Oberti, Thierry Fusco

35. [Semi-cosmographic constraints on decaying dark matter and dynamical dark energy: DESI DR2 BAO and 21\, cm intensity-mapping forecasts](#user-content-link35)
**Authors:** Mohit Yadav, Pankaj Chavan, Tapomoy Guha Sarkar

36. [Optical Spectroscopy of the IR Source CPM 19 and Surrounding Objects](#user-content-link36)
**Authors:** T. Yu. Magakian, T. A. Movsessian, A. V. Moiseev, T. S. Molyarova, R. I. Uklein

37. [Impact of eccentricity on the population properties of neutron star - black hole mergers](#user-content-link37)
**Authors:** Gonzalo Morras, Geraint Pratten, Patricia Schmidt

38. [Revisiting Constraints on Primordial Curvature Power Spectrum from PBH Abundances](#user-content-link38)
**Authors:** Ashu Kushwaha, Teruaki Suyama

39. [Microlensing by Cluster of Primordial Black Holes](#user-content-link39)
**Authors:** K. A. Toshchenko, P. V. Baklanov, K. M. Belotsky, S. I. Blinnikov

40. [Orbital motion detected in gamma Cas Fe K emission lines](#user-content-link40)
**Authors:** Yael Naze (FNRS/ULiege), Masahiro Tsujimoto (ISAS-JAXA, Univ. of Tokyo), Gregor Rauw (ULiege), Sean J. Gunderson (MIT)

41. [First Detection of the Glycine Isomer Glycolamide in Hot Molecular Core](#user-content-link41)
**Authors:** Chunguo Duan, Fengwei Xu, Qian Gou, Xuefang Xu, Donghui Quan, Laurent Pagani, Xi Chen, Jun Kang, Jiaxin Du

42. [Low-Frequency Stochastic Gravitational-Wave Background in Gaia DR3 catalogue](#user-content-link42)
**Authors:** V. Akhmetov, L. Filipello, M. Crosta, M. G. Lattanzi, B. Bucciarelli, U. Abbas, F. Santucci

43. [Carbon Nitride Monolayer Nanosheets: Astrochemical Insights into the Fate of Interstellar Hydrogen](#user-content-link43)
**Authors:** Dubois David, Guichard Pierre, Pasquier Remi

44. [A Slit Mask Integral Field Unit for the Robert Stobie Spectrograph on the Southern African Large Telescope: I. Instrument Development](#user-content-link44)
**Authors:** Sabyasachi Chattopadhyay, Matthew A. Bershady, Michael P. Smith, Antoine Mahoro, Marsha J. Wolf

45. [$\beta$-decay Measurements Near the $N=40$ Island of Inversion to Quantify Cooling of Accreted Neutron Star Crusts](#user-content-link45)
**Authors:** K. Hermansen, W. -J. Ong, H. Schatz, J. Browne, A. Chester, K. Childers, R. Jain, S. Liddick, S. Lyons, S. A. Miskovich, P. M\"oller, F. Montes, J. Owens-Fryar, A. Palmisano-Kyle, A. L. Richard, N. Rijal, M. Smith, D. Soltesz, A. Spyrou, S. K. Subedi, L. Wagner

46. [Kinetic Isocurvature Perturbation](#user-content-link46)
**Authors:** Kyu Jung Bae, Dhong Yeon Cheong, Jinn-Ouk Gong, Keisuke Harigaya, Chang Sub Shin

47. [Automatic search for transiting planets in TESS-SPOC FFIs with RAVEN: over 100 newly validated planets and over 2000 vetted candidates](#user-content-link47)
**Authors:** M. Lafarga, D. J. Armstrong, K. Cui, A. Hadjigeorghiou, V. Kunovac, L. Doyle, E. M. Bryant, R. F. D\'iaz, L. A. Nieto, A. Osborn

48. [Dimpled scalar vortex coronagraph laboratory demonstration](#user-content-link48)
**Authors:** Niyati Desai, Garreth Ruane, Susan Redmond, Dimitri Mawet, Eugene Serabyn, Bertrand Mennesson

49. [An Opacity-Free Test of the Cosmic Distance Duality Relation Using Strongly Lensed Gravitational Wave Signals with Space-Based Detector Networks](#user-content-link49)
**Authors:** Yong Yuan, Minghui Du, Benyang Zhu, Xin-yi Lin, Wen-Fan Feng, Peng Xu, Xilong Fan

50. [Slow-down of expanding bubbles in the early Universe](#user-content-link50)
**Authors:** Nabeen Bhusal, Simone Blasi, Thomas Konstandin, Enrico Perboni, Jorinde van de Vis

51. [Cosmic Ray Boosted Dark Matter in COSINUS: Modeling and Constraints](#user-content-link51)
**Authors:** G. Angloher, M. R. Bharadwaj, A. B\"ohmer, M. Cababie, I. Colantoni, I. Dafinei, N. Di Marco, C. Dittmar, F. Ferella, F. Ferroni, S. Fichtinger, A. Filipponi, T. Frank, M. Friedl, D. Fuchs, L. Gai, M. Gapp, M. Heikinheimo, M. N. Hughes, K. Huitu, M. Kellermann, R. Maji, M. Mancuso, L. Pagnanini, F. Petricca, S. Pirro, F. Pr\"obst, G. Profeta, A. Puiu, F. Reindl, K. Sch\"affner, J. Schieck, P. Schreiner, C. Schwertner, P. Settembri, K. Shera, M. Stahlberg, A. Stendahl, M. Stukel, C. Tresca, S. Yue, V. Zema, Y. Zhu, N. Zimmermann

52. [Astrophysical aspects of string compactifications](#user-content-link52)
**Authors:** Mario Ramos-Hamud

53. [Shaping the diffuse X-ray sky: Structure, Variability and Visibility](#user-content-link53)
...
73. [Investigating peculiar prompt emission properties of the multi-Peaked GRB 250129A](#user-content-link73)
**Authors:** Ankur Ghosh, Tamador K. M. Aldowma, Soebur Razzaque

74. [Quasiperiodic Slipping Motion of Flare Ribbon Fine Structures Anchored in a Sunspot Light Bridge](#user-content-link74)
...
75. [Signatures of localised particle acceleration at a global coronal shock wave](#user-content-link75)
**Authors:** C. Cuddy, D. M. Long, M. Nedal, S. Bhunia, P. T. Gallagher

76. [Photometric and late-time spectropolarimetric observations of GRB 250129A afterglow](#user-content-link76)
...
## 1. [3D NLTE Sodium abundances in late-type stars. Abundance corrections and synthetic spectra](https://arxiv.org/abs/2603.22975) <a id="link1"></a>
...
**Comment:** Presents new 3D NLTE stellar atmosphere models for sodium abundances in late-type stars, including metal-poor stars. This is directly relevant to the 'Stellar Models' criterion, especially as it provides new grids and corrections for stellar abundance determinations.
...
## 2. [The Fate of the Milky Way--Andromeda System: To Merge or Not?](https://arxiv.org/abs/2603.22863) <a id="link2"></a>
...
**Comment:** This paper revisits the merger probability of the Milky Way and Andromeda, including the influence of the LMC and M33. It directly addresses near-field cosmology, especially historic interactions between the Milky Way and other galaxies, and uses updated proper motions and semi-analytic modeling.
...
## 3. [How Massive Can a Population III Starburst Be? Simulating the First Galaxies with High Lyman-Werner Background](https://arxiv.org/abs/2603.23209) <a id="link3"></a>
...
**Comment:** This paper presents cosmological radiation-hydrodynamic zoom-in simulations of the first galaxies, focusing on Population III starbursts in atomic-cooling halos at the end of the Epoch of Reionization. It directly matches the 'Numerical Galaxy Simulations' criterion, and also touches on 'Resolved Star Formation Histories' (for simulated galaxies) and 'Star Formation Quenching' (via metal enrichment and transition to Pop II). The focus on low-mass galaxies and star formation processes makes it highly relevant.
...
## 4. [Reinterpreting the puzzling properties of z>6 galaxies within a variable IMF framework](https://arxiv.org/abs/2603.22405) <a id="link4"></a>
...
**Comment:** This paper presents theoretical predictions for high-redshift galaxy properties using a semi-analytic model with a variable IMF, inspired by cosmic ray-regulated star formation. It directly addresses galaxy evolution, stellar mass functions, and the impact of IMF variations, which fits the 'Numerical Galaxy Simulations' and 'Stellar Models' criteria. The connection to resolved star formation histories is indirect, but the focus on galaxy assembly and IMF is highly relevant.
...
## 5. [Second Order Closures for the Radiative Transfer Equation: Some Are Unstable](https://arxiv.org/abs/2603.22400) <a id="link5"></a>
...
**Comment:** Paper discusses radiative transfer equation closures relevant for cosmic reionization simulations. This is directly relevant to numerical galaxy simulations, especially those modeling reionization and including new physics (radiative transfer methods).
...
## 6. [How well does MAGPHYS recover galaxy properties? A test using EAGLE simulated star-forming galaxies](https://arxiv.org/abs/2603.22945) <a id="link6"></a>
...
**Comment:** This paper tests the MAGPHYS SED modeling framework using EAGLE simulated star-forming galaxies, directly addressing numerical galaxy simulations and the recovery of star formation histories from simulated data. It is highly relevant to the 'Numerical Galaxy Simulations' and 'Resolved Star Formation Histories' criteria, though the latter is theoretical rather than observational.
...
## 8. [CHANG-ES. XXXVIII. A Thin Radio Halo Shaped by Slow Cosmic-Ray Transport in the Quiescent Galaxy NGC 4565](https://arxiv.org/abs/2603.22417) <a id="link8"></a>
...
**Comment:** Analyzes cosmic ray transport and radio halo structure in NGC 4565, an edge-on spiral galaxy. Discusses star formation-driven outflows, cosmic ray transport, and the conditions for large-scale outflows and radio halos. This matches the 'Star Formation Driven Outflows' and 'Circumgalactic Medium' criteria, though the galaxy is more massive than the LMC, so relevance is slightly reduced.
...
## 9. [HI Gas and Star Formation in Major Galaxy Pairs from the FAST All-Sky HI Survey (FASHI)](https://arxiv.org/abs/2603.22693) <a id="link9"></a>
...
**Comment:** This paper investigates HI gas and star formation in major galaxy pairs, including spiral-spiral and spiral-elliptical systems. It discusses star formation quenching and HI depletion in red spirals, which is relevant to the star formation quenching criterion, though the focus is on more massive galaxies and not specifically dwarfs. The relevance is solid but not maximal.
...
## 10. [Impact of stellar rotation on type II supernova progenitor masses from pre-explosion imaging](https://arxiv.org/abs/2603.23201) <a id="link10"></a>
...
**Comment:** Examines the impact of stellar rotation on progenitor mass estimates for Type II supernovae using stellar evolution models. This fits the 'Stellar Models' criterion, as it discusses the effect of rotation on stellar evolutionary tracks and their application to observations.
...
## 11. [The time-delay model and its applications to galactic archaeology](https://arxiv.org/abs/2603.23066) <a id="link11"></a>
...
**Comment:** This paper discusses the time-delay model for interpreting abundance patterns in stars and interstellar gas, with applications to galactic archaeology and the star formation histories of galaxies. It matches the 'Resolved Star Formation Histories' criterion, as it constrains star formation histories from abundance patterns, and also touches on 'Stellar Models' through nucleosynthesis. However, it is somewhat broad and includes higher mass galaxies, so relevance is solid but not maximal.
...
## 12. [SDSS-V LVM: A spatially resolved study of the physical conditions and the chemical abundance discrepancy in the Lagoon Nebula (M 8)](https://arxiv.org/abs/2603.22382) <a id="link12"></a>
...
**Comment:** This paper presents a spatially resolved study of the Lagoon Nebula, focusing on chemical abundances and the abundance discrepancy problem. While it involves resolved spectroscopy and nebular physics, it does not directly address resolved star formation histories, stellar models, or galaxy evolution. Borderline relevance due to spatially resolved abundance mapping.
...
## 13. [The Two Component Circumgalactic Medium Emission around z~2 Radio-loud Quasars](https://arxiv.org/abs/2603.22657) <a id="link13"></a>

**ArXiv ID:** 2603.22657

**Authors:** Sanchit Sabhlok, Shelley A. Wright, Andrey Vayner, Norman Murray, Lee Armus, Maren Cosens, James Wiley, Eileen Meyer, Karthik Reddy, Marie Wingyee Lau

**Abstract:** We present Ly$\alpha$, He II and C IV observations of 7 redshift ~ 2 radio-loud quasars observed using the Keck Cosmic Web Imager (KCWI) and compare it to observed radio jet emission using archival VLA and ALMA radio observations. We detect 80-120 kpc diameter Ly$\alpha$ and 10-40 kpc He II and C IV emission around the targets. We find the Ly$\alpha$ emission to be brighter in the inner 30 kpc by factors of 2-10 compared to other literature samples. We reproduce the trend for increased total luminosity for a larger area on sky, but find our targets tend to be brighter for a given area when compared to literature observations, even when adjusting for the observational sensitivity. We infer that the He II and C IV is likely powered by quasar photoionization, with the ionizing radiation likely escaping along the radio jet axis which is aligned with the He II and C IV emission. The observations agree with a two component model of the CGM where the inner CGM ( 30 kpc) is influenced by gas turbulence and the larger environment around the host galaxies.

**Comment:** The paper examines the circumgalactic medium (CGM) emission around z~2 radio-loud quasars, but the focus is on massive galaxies hosting quasars, not dwarf galaxies. While CGM is a relevant topic, the emphasis on radio-loud quasars and large-scale environments makes this only borderline relevant.
...
## 14. [Detailed Analysis of the NGC 2168 Cluster, Leveraging Gaia DR3](https://arxiv.org/abs/2603.22410) <a id="link14"></a>
...
**Comment:** This paper analyzes the NGC 2168 star cluster using Gaia data, focusing on cluster properties, stellar evolution, and mass function. While it involves stellar models and cluster dynamics, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on dwarf galaxies or galaxy evolution. Borderline relevance due to mass function analysis.
...
## 15. [A systematic study of AGN feedback in a disk galaxy II: MACER prediction of X-ray surface brightness profile and comparison with eROSITA observations](https://arxiv.org/abs/2603.22412) <a id="link15"></a>
...
**Comment:** This paper studies the circumgalactic medium (CGM) of disk galaxies, specifically focusing on X-ray emission and AGN feedback. While CGM is a relevant topic, the focus is on L* galaxies and AGN-driven feedback, not dwarf galaxies or star-formation-driven outflows. The relevance is borderline due to the CGM connection, but not a close match to the core topics.
...
## 16. [Enhancing cosmological constraints with nonlinear tanh transformations of Hermite-Gaussian Derivative fields](https://arxiv.org/abs/2603.22797) <a id="link16"></a>
...
**Comment:** Presents a new method for extracting cosmological information from large-scale structure using Hermite-Gaussian derivative fields. While it is a simulation/analysis method, it is not focused on galaxy simulations or the relevant topics (dwarf galaxies, star formation, etc.).
...
## 17. [Primordial Non-Gaussianity and the Field-Level Cramer-Rao Bound](https://arxiv.org/abs/2603.22415) <a id="link17"></a>
...
**Comment:** Discusses primordial non-Gaussianity and its measurement in galaxy maps, with implications for inflationary physics. While it involves galaxy maps, it is not focused on galaxy simulations, star formation, or dwarf galaxy properties.
...
## 19. [High-resolution near-IR spectroscopy of the B[e] supergiant LHA 115-S 18: discovery of hot water vapor emission](https://arxiv.org/abs/2603.22334) <a id="link19"></a>
...
**Comment:** The paper presents high-resolution spectroscopy of a B[e] supergiant in the SMC, focusing on mass-loss, circumstellar chemistry, and stellar evolution. While it touches on stellar models and evolution, it does not present new stellar models or address the core topics directly.
...
## 22. [Inside the Black Box of Big Bang Nucleosynthesis: Parameter Sensitivity Studies in Light of new LBT Data](https://arxiv.org/abs/2603.22414) <a id="link22"></a>
...
**Comment:** This paper presents a sensitivity atlas for Big Bang Nucleosynthesis, focusing on primordial abundances and fundamental parameters. While it is relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, or galaxy evolution.
...
## 23. [Probing the Bias of Large-Scale Structure with Unlocalized Fast Radio Bursts](https://arxiv.org/abs/2603.22832) <a id="link23"></a>
...
**Comment:** This paper focuses on using fast radio bursts (FRBs) as tracers of large-scale structure, specifically probing the bias of cosmic matter distribution. While it deals with cosmological structure and bias, it does not directly address near-field cosmology, satellite galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM. The methods could be tangentially relevant for large-scale structure studies, but not for the core topics.
...
## 24. [Dark Matter Detection through Rydberg Atom Transducer](https://arxiv.org/abs/2603.23337) <a id="link24"></a>
...
**Comment:** This paper focuses on a novel method for detecting ultralight bosonic dark matter, specifically axions and dark photons, using Rydberg atom transducers. While it is related to dark matter detection, it does not directly address near-field cosmology, galaxy simulations, or any of the other core topics such as resolved star formation histories, quenching, or stellar models. The relevance is low as it is more about particle physics and detection technology.
...
## 25. [What does it take to have $N_{\rm eff} < 3$ at CMB times?](https://arxiv.org/abs/2603.22391) <a id="link25"></a>
...
**Comment:** Explores scenarios for N_eff < 3 at CMB times, motivated by cosmological measurements. While it is cosmology-focused, it does not address near-field cosmology, galaxy simulations, or dwarf galaxy properties.
...
## 26. [Unlocking accretion rate diagnostics for high-mass protostars using JWST/MIRI HI lines](https://arxiv.org/abs/2603.23180) <a id="link26"></a>
...
**Comment:** This paper investigates accretion rates in high-mass protostars using JWST/MIRI HI lines. While it deals with star formation, it is not about resolved star formation histories in galaxies or quenching, and does not address galaxy-scale processes.
...
## 27. [The GRAVITY young stellar object survey -- XV. The star-disk interaction region of the T Tauri star DO Tau](https://arxiv.org/abs/2603.22444) <a id="link27"></a>
...
**Comment:** Studies the star-disk interaction region of a T Tauri star, focusing on accretion and disk properties. While it involves stellar accretion and disk physics, it does not address resolved star formation histories, galaxy-scale quenching, or numerical galaxy simulations.
...
## 28. [Intracluster light is a close tracer of the dark matter halo shape](https://arxiv.org/abs/2603.23158) <a id="link28"></a>
...
**Comment:** This paper focuses on intracluster light (ICL) as a tracer of dark matter halo shape in galaxy clusters. While it deals with galaxy clusters and dark matter, it does not focus on dwarf galaxies, satellite luminosity functions, or near-field cosmology. The topic is outside the core criteria, as it centers on massive systems rather than dwarfs or satellites.
...
## 29. [Cluster Infall for Mass Calibration in the Stage-IV Era](https://arxiv.org/abs/2603.22670) <a id="link29"></a>
...
**Comment:** This paper discusses cluster infall regions for mass calibration, focusing on the outskirts of galaxy clusters and mass calibration methods. It does not address dwarf galaxies, satellite systems, or near-field cosmology, and is not directly relevant.
...
## 30. [Analyzing Fermionic Dark Matter scenarios with anomalous compact objects](https://arxiv.org/abs/2603.22490) <a id="link30"></a>
...
**Comment:** The paper analyzes compact objects with anomalous mass-radius relations to infer properties of fermionic dark matter. While it discusses dark matter in neutron stars, it does not address galaxy-scale dark matter profiles or near-field cosmology. The focus is on stellar remnants, not galaxies.
...
## 31. [Formation of spirals in early stage protoplanetary discs](https://arxiv.org/abs/2603.23317) <a id="link31"></a>
...
**Comment:** This paper studies spiral formation in protoplanetary discs using high-resolution simulations. While it involves numerical simulations, the focus is on planet formation and disc dynamics, not galaxy evolution or the core topics.
...
## 32. [MEOW: The increase in the obscured AGN fraction in mid-infrared from 0 < z < 6 with JWST MIRI](https://arxiv.org/abs/2603.22393) <a id="link32"></a>
...
**Comment:** The paper investigates obscured AGN fractions using JWST MIRI data, focusing on AGN demographics and black hole growth. AGN studies are not part of the core topics, and the work does not address star formation quenching or galaxy-scale outflows.
...
## 33. [3D CMZ V: A new orbital model of our Galaxy's Center, informed by data across the electromagnetic spectrum](https://arxiv.org/abs/2603.23327) <a id="link33"></a>
...
**Comment:** The paper presents a new orbital model for the Milky Way's Central Molecular Zone, focusing on the Galactic center and gas dynamics. The Galactic center is specifically listed as irrelevant in the criteria.
...
## 34. [Data-calibrated point spread function prediction: General description of the method and demonstration on MUSE-NFM](https://arxiv.org/abs/2603.23339) <a id="link34"></a>
...
**Comment:** This paper presents a new method for predicting the point spread function in adaptive optics observations. While this could be useful for observational studies, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is low as it is focused on data analysis methodology.
...
## 35. [Semi-cosmographic constraints on decaying dark matter and dynamical dark energy: DESI DR2 BAO and 21\, cm intensity-mapping forecasts](https://arxiv.org/abs/2603.23247) <a id="link35"></a>
...
## 36. [Optical Spectroscopy of the IR Source CPM 19 and Surrounding Objects](https://arxiv.org/abs/2603.22462) <a id="link36"></a>
...
**Comment:** This paper presents optical spectroscopy of an infrared source and nearby objects, focusing on pre-main-sequence stars and Herbig-Haro objects. While it touches on star formation, it does not address resolved star formation histories or galaxy-scale processes.
...
## 37. [Impact of eccentricity on the population properties of neutron star - black hole mergers](https://arxiv.org/abs/2603.22461) <a id="link37"></a>
...
**Comment:** This paper focuses on neutron star-black hole mergers and their population properties, which is outside the scope of the core topics (no connection to near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, or outflows).
...
## 38. [Revisiting Constraints on Primordial Curvature Power Spectrum from PBH Abundances](https://arxiv.org/abs/2603.23025) <a id="link38"></a>
...
**Comment:** The paper revisits constraints on the primordial curvature power spectrum from primordial black hole abundances, which is cosmology-focused and not directly related to the core topics (no connection to galaxy evolution, star formation, or near-field cosmology).
...
## 39. [Microlensing by Cluster of Primordial Black Holes](https://arxiv.org/abs/2603.23412) <a id="link39"></a>
...
**Comment:** This paper studies microlensing by clusters of primordial black holes and its implications for dark matter constraints. The focus is on cosmology and compact objects, not galaxy evolution or the core topics.
...
## 40. [Orbital motion detected in gamma Cas Fe K emission lines](https://arxiv.org/abs/2603.22938) <a id="link40"></a>
...
**Comment:** Reports orbital motion in gamma Cas, linking X-ray emission to accretion onto a white dwarf. Focus is on stellar binaries and X-ray emission, not galaxy simulations or relevant topics.
...
## 41. [First Detection of the Glycine Isomer Glycolamide in Hot Molecular Core](https://arxiv.org/abs/2603.23170) <a id="link41"></a>
...
**Comment:** Reports detection of glycolamide in a hot molecular core, relevant to astrochemistry and star formation, but not to resolved star formation histories, quenching, or galaxy-scale processes.
...
## 42. [Low-Frequency Stochastic Gravitational-Wave Background in Gaia DR3 catalogue](https://arxiv.org/abs/2603.23028) <a id="link42"></a>
...
**Comment:** The paper investigates the potential to detect low-frequency gravitational waves using Gaia quasar proper motions. The focus is on astrometric GW detection, not on galaxy simulations, star formation, or dwarf galaxies.
...
## 43. [Carbon Nitride Monolayer Nanosheets: Astrochemical Insights into the Fate of Interstellar Hydrogen](https://arxiv.org/abs/2603.22443) <a id="link43"></a>
...
**Comment:** The paper investigates hydrogen adsorption on carbon nitride monolayer nanosheets, focusing on astrochemistry and dust grain properties. It does not address galaxy-scale processes or any of the core topics.
...
## 44. [A Slit Mask Integral Field Unit for the Robert Stobie Spectrograph on the Southern African Large Telescope: I. Instrument Development](https://arxiv.org/abs/2603.22698) <a id="link44"></a>
...
**Comment:** This paper describes the development of a new integral field unit for a spectrograph, which is an instrumentation paper. It does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is low as it is focused on instrument design.
...
## 46. [Kinetic Isocurvature Perturbation](https://arxiv.org/abs/2603.22394) <a id="link46"></a>
...
**Comment:** The paper introduces a new class of primordial perturbations (kinetic isocurvature) in the early universe, which is cosmology-focused and not related to the core topics (no connection to galaxy evolution, star formation, or near-field cosmology).
...
## 47. [Automatic search for transiting planets in TESS-SPOC FFIs with RAVEN: over 100 newly validated planets and over 2000 vetted candidates](https://arxiv.org/abs/2603.22597) <a id="link47"></a>
...
**Comment:** The paper presents a pipeline for searching transiting planets in TESS data, focusing on exoplanet detection and validation. This is not related to the core topics (no connection to galaxy evolution, star formation, or near-field cosmology).
...
## 48. [Dimpled scalar vortex coronagraph laboratory demonstration](https://arxiv.org/abs/2603.22551) <a id="link48"></a>
...
**Comment:** The paper presents laboratory demonstrations of scalar vortex coronagraphs for high-contrast imaging, relevant to exoplanet detection instrumentation. It does not address galaxy simulations, star formation, or near-field cosmology.
...
## 49. [An Opacity-Free Test of the Cosmic Distance Duality Relation Using Strongly Lensed Gravitational Wave Signals with Space-Based Detector Networks](https://arxiv.org/abs/2603.23373) <a id="link49"></a>
...
**Comment:** Tests the cosmic distance duality relation using simulated gravitational wave signals. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 50. [Slow-down of expanding bubbles in the early Universe](https://arxiv.org/abs/2603.22397) <a id="link50"></a>
...
**Comment:** This paper discusses bubble dynamics in early Universe phase transitions and their impact on gravitational wave emission. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation in galaxies.
...
## 51. [Cosmic Ray Boosted Dark Matter in COSINUS: Modeling and Constraints](https://arxiv.org/abs/2603.22971) <a id="link51"></a>
...
**Comment:** Focuses on direct detection of dark matter, specifically cosmic ray boosted dark matter. No connection to near-field cosmology, galaxy simulations, or star formation histories.
...
## 52. [Astrophysical aspects of string compactifications](https://arxiv.org/abs/2603.23204) <a id="link52"></a>
...
**Comment:** Discusses astrophysical implications of string compactifications, focusing on moduli fields and their effects in strong gravity environments. No direct connection to any of the core topics.
...
## 53. [Shaping the diffuse X-ray sky: Structure, Variability and Visibility](https://arxiv.org/abs/2603.22392) <a id="link53"></a>
...
**Comment:** This paper studies the Local Bubble's X-ray emission using simulations, focusing on the solar neighborhood and supernova-driven bubbles. It does not address galaxy simulations, star formation histories, or dwarf galaxies, and is not relevant to the core criteria.
...
## 54. [Extinction curves, extinction laws, and the failure of interstellar dust models](https://arxiv.org/abs/2603.22941) <a id="link54"></a>
...
**Comment:** This paper discusses interstellar extinction curves and dust models, which are not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. The focus is on dust properties and extinction laws, not on galaxy-scale processes or stellar evolution.
...
## 55. [The Persistent Radio Sources and Multi-wavelength Counterparts of Fast Radio Bursts in Massive Binary Systems](https://arxiv.org/abs/2603.23144) <a id="link55"></a>
...
**Comment:** The paper discusses fast radio bursts and their electromagnetic counterparts in massive binary systems, focusing on magnetar wind nebulae and bow shock radiation. There is no connection to dwarf galaxies, star formation histories, galaxy simulations, or stellar models.
...
## 56. [MAGIC observations of NGC 4278. The first low-luminosity radio galaxy with compact jets detected at TeV energies](https://arxiv.org/abs/2603.22955) <a id="link56"></a>
...
**Comment:** This paper focuses on TeV emission and jet properties in a low-luminosity radio galaxy, NGC 4278. The study is about AGN jets and high-energy phenomena, which are not relevant to any of the core criteria (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or CGM of dwarfs).
...
## 57. [More Than Power: Revisiting the CMB Hemispherical Power Asymmetry with Morphological Descriptors](https://arxiv.org/abs/2603.22449) <a id="link57"></a>
...
**Comment:** The paper investigates CMB hemispherical power asymmetry using morphological descriptors. This is cosmology-focused and not related to the core topics (no connection to galaxy evolution, star formation, or near-field cosmology).
...
## 58. [A Multi-messenger Search for Ultra-high-energy Gamma Rays in Coincidence with Neutrinos](https://arxiv.org/abs/2603.22555) <a id="link58"></a>
...
**Comment:** This paper presents a multi-messenger search for ultra-high-energy gamma rays in coincidence with neutrinos. The focus is on high-energy astrophysics and source identification, not on galaxy simulations, star formation, or dwarf galaxies.
...
## 59. [Model validation and tolerancing of scalar vortex masks in the High Contrast Imaging Testbed (HCIT) facility](https://arxiv.org/abs/2603.22537) <a id="link59"></a>
...
**Comment:** This paper discusses model validation and tolerancing of scalar vortex masks for high-contrast imaging, relevant to exoplanet detection instrumentation. It does not address galaxy simulations, star formation, or near-field cosmology.
...
## 60. [The Radio-wave Observations at the Lunar Surface of the photoElectron Sheath (ROLSES) instrument onboard the Intuitive Machines-1 Mission to the Moon](https://arxiv.org/abs/2603.22600) <a id="link60"></a>
...
**Comment:** The paper describes a radio telescope instrument for lunar surface observations, focusing on radio and plasma wave environments. It does not address galaxy evolution, star formation, or stellar models.
...
## 61. [Wave-particle equilibria with heavy ions in weakly collisional space plasmas](https://arxiv.org/abs/2603.22613) <a id="link61"></a>
...
**Comment:** Study of wave-particle interactions in space plasmas, specifically solar wind and heavy ions. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 62. [Magnetic Connectivity in the Time-Dependent Corona and Heliosphere](https://arxiv.org/abs/2603.22440) <a id="link62"></a>
...
**Comment:** Focuses on magnetic connectivity in the solar corona and heliosphere, not galaxies or their CGM/ISM. No match to core criteria.
...
## 63. [Upper Limits to Long-Term Variability of Solar-Type Stars from Observations of the Open Cluster M67](https://arxiv.org/abs/2603.23291) <a id="link63"></a>
...
**Comment:** This paper analyzes the long-term variability of solar-type stars in the open cluster M67, focusing on the width of the main sequence and implications for paleoclimate. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is very low.
...
## 64. [Dark graviton sensing with magnetically levitated superconductors](https://arxiv.org/abs/2603.22647) <a id="link64"></a>
...
**Comment:** The paper discusses detection of dark gravitons with superconductors, which is not related to any of the core topics (no connection to galaxy evolution, star formation, or near-field cosmology).
...
## 65. [Phantom-Crossing Dark Energy and the $\Omega_m$ Tug-of-War](https://arxiv.org/abs/2603.22406) <a id="link65"></a>
...
**Comment:** The paper discusses dark energy models and cosmological parameter tensions, which is not related to any of the core topics (no connection to galaxy evolution, star formation, or near-field cosmology).
...
## 66. [A High-frequency Geodetic VLBI Experiment for Optical Clock Comparison](https://arxiv.org/abs/2603.23078) <a id="link66"></a>
...
**Comment:** Describes a geodetic VLBI experiment for optical clock comparison. No connection to any of the core astrophysical topics.
...
## 67. [The Lyman-alpha Emission in Solar Flares. II. A Statistical Study on Its Relationship with the White-light plus Soft X-ray Emission](https://arxiv.org/abs/2603.23313) <a id="link67"></a>
...
**Comment:** Statistical study of Lyman-alpha emission in solar flares and its relationship with white-light and soft X-ray emission. Focused on solar physics, not relevant to galaxy-scale star formation or any core topics.
...
## 68. [Perihelion observations of interstellar comet 3I/ATLAS with the IRAM 30-m telescope](https://arxiv.org/abs/2603.23240) <a id="link68"></a>
...
**Comment:** This paper reports perihelion observations of the interstellar comet 3I/ATLAS, focusing on cometary chemistry and outgassing. It is unrelated to galaxy simulations, star formation, or near-field cosmology.
...
## 69. [Anomalously Strong Localized First Ionization Potential Effect Associated with a Solar Subflare](https://arxiv.org/abs/2603.23098) <a id="link69"></a>
...
**Comment:** This paper studies plasma composition and the FIP effect in the solar corona, focusing on solar physics and magnetic reconnection. It does not match any of the core topics related to galaxy evolution or stellar models.
...
## 70. [Ca2+ transient detection and segmentation with the Astronomically motivated algorithm for Background Estimation And Transient Segmentation (Astro-BEATS)](https://arxiv.org/abs/2603.22311) <a id="link70"></a>
...
**Comment:** This paper presents an algorithm for Ca2+ transient detection in neuroscience, inspired by astronomical methods. It is unrelated to the core astrophysics topics.
...
## 71. [LISA science ground segment conventions](https://arxiv.org/abs/2603.22377) <a id="link71"></a>
...
**Comment:** Describes conventions for LISA science ground segment, focused on gravitational wave data processing. No connection to any of the core topics.
...
## 73. [Investigating peculiar prompt emission properties of the multi-Peaked GRB 250129A](https://arxiv.org/abs/2603.23384) <a id="link73"></a>
...
**Comment:** The paper analyzes the prompt emission properties of a gamma-ray burst (GRB), which is unrelated to the core topics. It does not address galaxy evolution, star formation histories, or near-field cosmology.
...
## 74. [Quasiperiodic Slipping Motion of Flare Ribbon Fine Structures Anchored in a Sunspot Light Bridge](https://arxiv.org/abs/2603.22940) <a id="link74"></a>
...
**Comment:** This paper focuses on solar flare ribbon fine structures and their dynamics, which is unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 76. [Photometric and late-time spectropolarimetric observations of GRB 250129A afterglow](https://arxiv.org/abs/2603.23359) <a id="link76"></a>
...
**Comment:** This paper presents spectropolarimetric observations of a GRB afterglow, focusing on jet geometry and magnetic field structure. It does not match any of the core criteria related to galaxies, star formation, or near-field cosmology.
