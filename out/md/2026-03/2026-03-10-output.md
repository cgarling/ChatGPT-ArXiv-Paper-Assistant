...
1. [Fuzzy Dark Matter and the Impact of Core-Halo Diversity on Its Particle Mass Constraints](#user-content-link1)
**Authors:** Dafa Wardana, Kohei Hayashi, Masashi Chiba, Elisa G. M. Ferreira

2. [Ashes of FIRE: Modeling Dust Grain Size Evolution in the Local Group with FIRE](#user-content-link2)
**Authors:** Caleb R. Choban, Samir Salim, Du\v{s}an Kere\v{s}, Julia Roman-Duval, Karin M. Sandstrom

3. [Evolution and formation of ultramassive white dwarf stars: The case for a 9Msun progenitor](#user-content-link3)
**Authors:** Ana S. R. Antonini, Alejandra D. Romero, S. O. Kepler

4. [New Way to Date Globular Clusters: Brown Dwarf Cooling Sequences](#user-content-link4)
**Authors:** Roman Gerasimov

5. [The Binary Populations of Stellar Streams are Set by Cluster Dynamics](#user-content-link5)
**Authors:** Anya Phillips, Charlie Conroy, Jacob Nibauer, Long Wang, Vedant Chandra, Ana Bonaca, Jay Strader, Morgan MacLeod

6. [K-DRIFT Science Theme: New Theoretical Framework Using the Galaxy Replacement Technique for LSB studies](#user-content-link6)
**Authors:** Kyungwon Chun, Jihye Shin, Rory Smith, Jongwan Ko, jaewon Yoo, So-Myoung Park, Woowon Byun, Sang-Hyun Chun, Sungryong Hong, Hyowon Kim, Jae-Woo Kim, Jaehyun Lee, Hong Soo Park, Jinsu Rhee, Kwang-Il Seon, Yongmin Yoon

7. [How interacting winds shape the mechanical feedback of massive star clusters over millions of years](#user-content-link7)
**Authors:** Thibault Vieu, Lucia H\"arer, Brian Reville

8. [To What Extent Are Star Cluster Ages Encoded in Their Environments? Exploring the Spatial Distribution of Age-Related Information with PHANGS-HST Imaging and Convolutional Neural Networks](#user-content-link8)
**Authors:** Javier Via\~na, Janice C. Lee, Andrew Vanderburg, John F. Wu, M. Jimena Rodr\'iguez, Remy Indebetouw, M\'ed\'eric Boquien, Ralf S. Klessen, Sophia Rivera, Erik Rosolowsky, Oleg Y. Gnedin, Daniel A. Dale, Kirsten L. Larson, David A. Thilker, Gagandeep Anand

9. [Systematic selection of surrogate models for nonequilibrium chemistry](#user-content-link9)
**Authors:** Robin Janssen, Lorenzo Branca, Tobias Buck

10. [ML in Astrophysical Turbulence I: Predicting Prestellar Cores in Magnetized Molecular Clouds using eXtreme Gradient Boosting](#user-content-link10)
**Authors:** Nikhil Bisht, David C. Collins

11. [s-process nucleosynthesis in low-mass AGB stars by the $^{13}$C($\alpha$,n)$^{16}$O neutron source](#user-content-link11)
**Authors:** Inma Dom\'inguez, Carlos Abia, Maurizio Busso, Oscar Straniero, Sara Palmerini

12. [Hydrogen photoionization in a magnetized medium: the rigid-wavefunction approach revisited](#user-content-link12)
**Authors:** Ren\'e D. Rohrmann

13. [Imaging the disk-halo interface of NGC 891: a 2.7 kpc-thick molecular gas disk](#user-content-link13)
**Authors:** D. Jim\'enez-L\'opez, S. Garc\'ia-Burillo, M. Querejeta, A. Usero, P. Tarr\'io

14. [Caught in the web: galaxy mergers along cosmic filaments](#user-content-link14)
**Authors:** Carolina Dulcien, Yara L. Jaffe, Jacob P. Crossett, Raul Baier-Soto, Hugo Mendez-Hernandez, Christopher P. Haines, Guillermo Cabrera-Vives, Patricio Olivares, P. Vasquez-Bustos, Maria Argudo-Fernandez, Javiera Vivanco, Lawrence Bilton, Clecio R. Bom, Giuseppe D'Ago, Alexis Finoguenov, Ulrike Kuchner, Ciria Lima-Dias, Paola Merluzzi, Antonela Monachesi, Diego Pallero, Nicolas Tejos, Gabriel S. M. Teixeira, Cristobal Sifon, Maiara S. Carvalho, Ricardo Demarco, Eduardo Ibar, Gissel P. Montaguth, Franco Piraino-Cerda, Umberto Rescigno, Vitor Sampaio, Gustavo B. Oliveira Schwarz, Rory Smith, Benedetta Vulcani, Nicola Malavasi

15. [Identifying Red Supergiants in the Local Group Using JWST Photometry. I. NGC 6822, Sextans A, NGC 300, WLM, and IC 1613](#user-content-link15)
**Authors:** Zhiwen Li, Ming Yang, Biwei Jiang, Yi Ren

16. [A differentiable and optimizable 3D model for interpretation of observed spectral data cubes](#user-content-link16)
**Authors:** T. Grassi, J. E. Pineda, S. Spezzano, D. Arzoumanian, F. Lique, Y. Misugi, E. Redaelli, S. S. Jensen, P. Caselli

17. [Robust ellipticity measurements of 29 Galactic globular clusters](#user-content-link17)
**Authors:** Laurane Fr\'eour, Ellen Leitinger, Elena Pancino, Alice Zocchi, Glenn van de Ven

18. [Pre-Virialized Assembly at Cosmic Dawn: The Dynamics and Extreme Ionization of Compact Group CGG-z7 at $z\sim7.04$](#user-content-link18)
**Authors:** Xiaoyang Wei, Zheng Cai, Fujiang Yu, Mingyu Li, Yunjing Wu

19. [An Alternate Pathway for H$_2$ Formation in the Early Universe: A physical process to account for the presence and coevolution of the luminous galaxies and supermassive black holes at the high redshifts](#user-content-link19)
**Authors:** Amrendra Pandey, Olivier Dulieu, Nadia Bouloufa-Maafa

20. [Extreme mass loss during common envelope evolution: the origin of the double low-mass white dwarf system J2102--4145](#user-content-link20)
**Authors:** Leandro G. Althaus, Alejandro H. Corsico, Monica Zorotovic, Maja Vuckovic, Alberto Rebassa-Mansergas, Santiago Torres

21. [On the relation between magnetic field strength and gas density in the interstellar medium. II. Density uncertainties and diffuse gas constraints](#user-content-link21)
**Authors:** David Whitworth, Amit Seta, Ralph E. Pudritz, Mordecai-Mark Mac Low, Juan D. Soler, Aina Palau, Ralf S. Klessen

22. [Isotopic Evidence for a Cold and Distant Origin of the Interstellar Object 3I/ATLAS](#user-content-link22)
...
23. [Signatures of Extended Dark Energy Parametrisations in Structure Formation under Background Constraints](#user-content-link23)
**Authors:** Greco A. Pe\~na, Mario H. Amante, Javier Chagoya, Cristian Barrera-Hinojosa, C. Ortiz, Graeme Candlish

24. [Effect of gravity-driven longitudinal flows in filaments on angular momentum transport to embedded cores](#user-content-link24)
**Authors:** Griselda Arroyo-Ch\'avez, Shuo Kong, Enrique V\'azquez-Semadeni

25. [BlackGEM observations of compact pulsating stars: Mode identification for the DOV PG 1159--035 using multi-colour photometr](#user-content-link25)
...
26. [A Direct View of the Chemical Properties of Water from Another Planetary System: Water D/H in 3I/ATLAS](#user-content-link26)
**Authors:** Luis E. Salazar Manzano, Teresa Paneque-Carre\~no, Martin A. Cordiner, Edwin A. Bergin, Hsing Wen Lin, Dariusz C. Lis, David W. Gerdes, Jennifer B. Bergner, Nicolas Biver, Dominique Bockel\'ee-Morvan, Dennis Bodewits, Steven B. Charnley, Jacques Crovisier, Davide Farnocchia, Viviana V. Guzm\'an, Stefanie N. Milam, John W. Noonan, Anthony J. Remijan, Nathan X. Roth, John J. Tobin

27. [Empirical signatures of velocity and density cascades in the Local Universe probed by CosmicFlows4 dataset](#user-content-link27)
**Authors:** Yves Grosdidier, H\'el\`ene M. Courtois

28. [High nitrogen and carbon isotopic ratios in the interstellar comet 3I/ATLAS](#user-content-link28)
**Authors:** C. Opitom, J. Manfroid, D. Hutsem\'ekers, E. Jehin, M. M. Knight, K. Aravind, L. Ferellec, D. Bodewits, V. V. Guzm\'an, M. Cordiner, R. C. Dorsey, F. La Forgia, M. Lippi, B. P. Murphy, C. Snodgrass, M. Bannister

29. [A Reproducible Black Hole-Neutron Star Merger Gallery Example for the Einstein Toolkit](#user-content-link29)
**Authors:** Rahime Matur, Beyhan Karaka\c{s}, Roland Haas, Ian Hawke, Nils Andersson, Steven R. Brandt

30. [Flash from the Past: New Gamma-Ray Constraints on Light CP-even Scalar from SN1987A](#user-content-link30)
**Authors:** Yue Yu, Writasree Maitra, P. S. Bhupal Dev, Jean-Franccois Fortin, Steven P. Harris, Kuver Sinha, Yongchao Zhang

31. [The Impact of Dark Matter on Gravitational Wave Detection by Space-based Interferometers](#user-content-link31)
**Authors:** Yuezhe Chen, Pan-Pan Wang, Bo Wang, Rui Luo, Cheng-Gang Shao

32. [The Average Age Map of the Galactic Bulge](#user-content-link32)
**Authors:** Jialu Nie, Mart\'in L\'opez-Corredoira, Chao Liu, Hai-feng Wang, Iulia Simion

33. [BICEP/Keck XXI: Constraints on Early-Universe Parity Violation from Multipole-Dependent Birefringence](#user-content-link33)
**Authors:** Keck Collaboration, P. A. R. Ade, Zeeshan Ahmed, Mandana Amiri, Denis Barkats, Ritoban Basu Thakur, Colin A. Bischoff, Dominic Beck, James J. Bock, Hans Boenish, Victor Buza, Brianna Cantrall, James R. Cheshire IV, Jake Connors, James Cornelison, Michael Crumrine, Ari Jozef Cukierman, Edward Denison, Lionel Duband, Michael Echter, Miranda Eiben, Brodi D. Elwood, Sofia Fatigoni, Jeffrey P. Filippini, Antonio Fortes, Min Gao, Christos Giannakopoulos, Neil Goeckner-Wald, David C. Goldfinger, Stephen Gratton, James A. Grayson, Annsley Greathouse, Paul K. Grimes, Grantland Hall, George Halal, Mark Halpern, Emma Hand, Sam A. Harrison, Shawn Henderson, Thuong Hoang, Johannes Hubmayr, Howard Hui, Kent D. Irwin, Jae Hwan Kang, Kirit S. Karkare, Sinan Kefeli, J. M. Kovac, Chao-Lin Kuo, Kekoa Lasko, King Lau, Margaret Lautzenhiser, Amber Lennox, Tongtian Liu, Scott Mackey, Nolan Maher, Koko G. Megerian, Lorenzo Minutolo, Lorenzo Moncelsi, Yuka Nakato, H. T. Nguyen, Roger O'Brient, Scott Paine, Anika Patel, Matthew A. Petroff, Anna R. Polish, Thomas Prouve, Clement Pryke, Carl D. Reintsema, Steffen Richter, Thibault Romand, Maria Salatino, Alessandro Schillaci, Benjamin Schmitt, Robert Schwarz, Chris D. Sheehy, Baibhav Singari, Ahmed Soliman, Tyler St Germaine, Aaron Steiger, Bryan Steinbach, Rashmi Sudiwala, Grant Teply, Keith L. Thompson, Carole Tucker, Anthony D. Turner, Clara Verg\`es, Abigail G. Vieregg, Albert Wandui, Alexis C. Weber, Justin Willmert, Chin Lin Wong, Wai Ling K. Wu, Hung-I Yang, Cyndia Yu, Lingzhen Zeng, Cheng Zhang, Silvia Zhang

34. [Compression-Driven Kinetic Instabilities in Magnetically Arrested Disks](#user-content-link34)
**Authors:** Vedant Dhruv, Lorenzo Sironi, Jordy Davelaar, Aaron Tran

35. [Impact of Resonant Compton Scattering on Magnetar X-Ray Polarization with QED Vacuum Resonance](#user-content-link35)
**Authors:** Tu Guo, Dong Lai

36. [A Deep Learning Framework for Amplitude Generation of Generic EMRIs](#user-content-link36)
**Authors:** Yan-bo Zeng, Jian-dong Zhang, Yi-Ming Hu, Jianwei Mei

37. [Double White Dwarf Mergers as Progenitors of Long-Period Transients](#user-content-link37)
...
38. [Spatiotemporal Properties of Compressible Magnetohydrodynamic Turbulence from Space Plasma](#user-content-link38)
**Authors:** Siqi Zhao, Huirong Yan, Terry Z. Liu, Chuanpeng Hou, Ka Ho Yuen

39. [A GPU-Accelerated Transient Detection Pipeline for DECam Time-Domain Surveys](#user-content-link39)
**Authors:** Lei Hu, Tom\'as Cabrera, Antonella Palmese, Lifan Wang, Igor Andreoni, Xander J. Hall, Xingzhuo Chen, Jiawen Yang, Frank Valdes, Brendan O'Connor, Yuhan Chen

40. [Exploring the spin dependence on mass inclination and distance for the newly discovered black hole X-ray binary Swift J151857.0-572147](#user-content-link40)
**Authors:** Yujia Song, James F. Steiner, Tong Zhao, Yuexin Zhang, Ningyue Fan, Ole K\"onig, Santiago Ubach, Josephine Wong, Lijun Gou, Javier A. Garcia

41. [New black hole mass calibrations and the fundamental plane of the broad-line region size, luminosity, and velocity](#user-content-link41)
**Authors:** Jong-Hak Woo, Jimin Kim, Hojin Cho, Shu Wang

42. [Gas chemistry in the dust depleted inner regions of protoplanetary disks. I. Near-IR spectra and overtones](#user-content-link42)
**Authors:** J. Bethlehem, Ch. Rab, I. Kamp, M. Flock, G. Bourdarot, P. Caselli

43. [Probing the Dispersion and Rotation Measure Contributions from Supernova Remnants in Fast Radio Burst Source Environments with 1D SNR Simulation](#user-content-link43)
**Authors:** Zhao Joseph Zhang, Gaku Kawashima, Shiu-Hang Lee, Kentaro Nagamine, Bing Zhang, Yusei Fujimura

44. [Here Be SDRAGNs - Spiral Galaxies Hosting Large Double Radio Sources](#user-content-link44)
...
50. [A clean broad iron line in GS 1354--64 as seen by XRISM](#user-content-link50)
**Authors:** Honghui Liu, Lingda Kong, Oluwashina K. Adegoke, Jiachen Jiang, Cosimo Bambi, Andrew C. Fabian, Adam Ingram, Swati Ravi, James F. Steiner, Qingcang Shui, Dominic J. Walton, Yerong Xu, Andrew J. Young, Yuexin Zhang, Zuobin Zhang, Andrea Santangelo

51. [High-Energy Neutrino Emission in NGC1068 driven by Turbulent Magnetic Reconnection](#user-content-link51)
**Authors:** Luana Passos-Reis, Elisabete M. de Gouveia Dal Pino, Juan C. Rodr\'iguez-Ram\'irez, Giovani H. Vicentin

52. [Discovery of a 36-minute long-period transient ASKAP J142431.2-612611](#user-content-link52)
**Authors:** Joshua Pritchard, Tara Murphy, Dougal Dobie, Emil Lenc, Akash Anumarlapudi, Manisha Caleb, Sophia Grainger, Natasha Hurley-Walker, David L. Kaplan, Samuel J. McSweeney, Jackson Mitchell-Bolton, Kovi Rose, Rahul Sengar, Ziteng Wang, Jayde Willingham, Andrew Zic

53. [Spectral sirens cosmology from binary black holes populations with sharper mass features](#user-content-link53)
**Authors:** Tom Bertheas, Vasco Gennari, Dani\`ele Steer, Nicola Tamanini

54. [Estimating the completeness of the QUBRICS Survey with 3501 QSO redshifts from Gaia DR3 spectra](#user-content-link54)
...
55. [Supernovae interacting with Si and S-rich circumstellar matter from double white dwarf mergers](#user-content-link55)
**Authors:** Takashi J. Moriya, Chengyuan Wu, Dongdong Liu, Zheng-Wei Liu, Bo Wang

56. [Measuring the evolution of stellar bars with the host galaxy's spin](#user-content-link56)
**Authors:** Robin Joshi, Scott M. Croom, Stefania Barsanti, Elizabeth J. Iles, Joss Bland-Hawthorn, Jesse van de Sande

57. [A Delayed Radio Flare Traces Kinetic Energy Injection in the SMBHB Candidate SDSS~J143016.05+230344.4](#user-content-link57)
...
58. [A jet formation model for astrophysical objects](#user-content-link58)
**Authors:** Chun Xu

59. [Nonlinear evolution of unstable solar inertial modes: The case of viscous modes on a differentially rotating sphere](#user-content-link59)
**Authors:** Muneeb Mushtaq, Damien Fournier, Rama Ayoub, Peter J. Schmid, Laurent Gizon

60. [The Cluster Evolutionary Reference Ensemble at Low-$z$ (CEREAL) Sample of Galaxy Clusters I: X-ray Morphological Properties and Demographics](#user-content-link60)
...
61. [Interpreting Swift and NuSTAR Observations of the Low-Luminosity Active Galactic Nucleus NGC 4278 with Radiatively Inefficient Accretion Flows and Implications for Neutrino Emission](#user-content-link61)
**Authors:** Abhishek Das, Qi Feng, Eleanor Young, Ashwani Pandey, Shigeo S. Kimura, Kohta Murase

62. [WD 1054-226 revisited: a stable transiting debris system](#user-content-link62)
**Authors:** J. Korth, A. J. Mustill, H. Parviainen, E. Villaver, J. W. Kuehne, V. J. S. B\'ejar, Y. Hayashi, N. Abreu Garc\'ia, T. Kagetani, K. Kawauchi, L. Livingston, M. Mori, G. Morello, N. Watanabe, I. Fukuda, K. Ikuta, I. Bonilla-Mariana, E. Esparza-Borges, G. Fern\'andez-Rodr\'iguez, A. Fukui, S. Gerald\'ia-Gonz\'alez, J. Gonz\'alez-Rodr\'iguez, K. Isogai, N. Narita, E. Palle, A. Pel\'aez-Torres, M. S\'anchez-Benavente

63. [Different polarized components of the quasar 3C 286 revealed by FAST](#user-content-link63)
**Authors:** Pengfu Tian, Xiao Chen, Wen Yang, Wei Wang

64. [Homogenization of the Stetson Photometry with the BEST Database](#user-content-link64)
**Authors:** Zhirui Li, Bowen Huang, Kai Xiao, Haibo Yuan, Yang Huang, Dongwei Fan, Mingyang Ma, Tao Wang

65. [Inefficiency of chiral dynamos in protoneutron stars and the early universe](#user-content-link65)
**Authors:** Valentin A. Skoutnev, Andrei M. Beloborodov

66. [Multi-epoch afterglow rebrightenings in GRB 250129A: Evidence for successive shock interactions](#user-content-link66)
**Authors:** D. Akl, S. Antier, H. Koehn, P. T. H. Pang, J. J. Geng, R. Gill, E. Abdikamalov, C. Adami, V. Aivazyan, L. Almeida, S. Alshamsi, C. Andrade, Q. Andr\'e, C. Angulo-Valdez, J. -L. Atteia, K. Barkaoui, S. Basa, R. L. Becerra, P. Bendjoya, D. Berdikhan, E. Bernaud, S. Boissier, S. Brunier, A. Y. Burdanov, N. R. Butler, J. Chen, F. Colas, W. Corradi, M. W. Coughlin, D. Darson, T. Dietrich, D. Dornic, C. Douzet, C. Dubois, J. -G. Ducoin, T. du Laz, A. Durroux, D. Dutton, P. -A. Duverne, F. Dux, E. G. Elhosseiny, A. Esamdin, A. V. Filippenko, F. Fortin, M. Freeberg, L. Garc\'ia-Garc\'ia, M. Gillon, N. Globus, P. Gokuldass, N. Guessoum, P. Hello, R. Hellot, Y. H. M. Hendy, Y. L. Hua, T. Hussenot-Desenonges, R. Inasaridze, A. Iskandar, M. Jel\'inek, S. Karpov, A. Klotz, N. Kochiashvili, T. Laskar, A. Le Calloch, W. H. Lee, S. Leonini, X. Y. Li, A. Lien, C. Limonta, J. Liu, D. L\'opez-C\'amara, F. Magnani, J. Mao, M. Ma\v{s}ek, E. Moreno M\'endez, L. C. Menegazzi, W. Mercier, B. M. Mihov, M. Molham, S. Oates, M. Odeh, H. Peng, M. Pereyra, M. Pillas, T. Pradier, N. A. Rakotondrainibe, D. Reichart, J. -P. Rivet, F. D. Romanov, F. S\'anchez-\'Alvarez, N. Sasaki, D. Schlekat, B. Schneider, A. Simon, L. Slavcheva-Mihova, R. Strausbaugh, T. R. Sun, A. Takey, M. Tanasan, D. Turpin, A. de Ugarte Postigo, L. T. Wang, X. F. Wang, Z. M. Wang, A. M. Watson, J. de Wit, Y. S. Yan, W. Zheng, S. Z\'u\~niga-Fern\'andez

67. [Local Origin of Hidden Symmetry in Rotating Spacetimes](#user-content-link67)
**Authors:** Hyeong-Chan Kim

68. [Fundamental Limits of Quantum Sensors for Gravitational Wave Detection](#user-content-link68)
**Authors:** Sergio Gaudio

69. [Non-common path aberration compensation and a dark hole loop with a pyramid adaptive optics system: Application to SAXO+](#user-content-link69)
**Authors:** C. Goulas, R. Galicher, F. Vidal, J. Mazoyer, F. Ferreira, A. Sevin, A. Potier, A. Boccaletti, E. Gendron, C. B\'echet, M. Tallon, M. Langlois, C. Kulcs\'ar, H-F. Raynaud, N. Galland, L. Schreiber, I. Bernardino Dinis, F. Wildi, G. Chauvin

70. [Black Hole Mergers as the Fastest Photon Ring Scramblers](#user-content-link70)
**Authors:** D. Giataganas, G. F. Giudice, A. Ianniccari, A. J. Iovino, A. Kehagias, F. Quevedo, D. Perrone, A. Riotto

71. [Post-perihelion Coma Composition of the Interstellar Comet 3I/ATLAS from Optical Spectroscopy](#user-content-link71)
**Authors:** Ruining Zhao, Xiliang Zhang, Bin Yang, Xiangyu Fan, Shu Wang, Yang Huang, Jifeng Liu

72. [Study of the cosmological tensions and DESI-DR2 in the framework of the Little Rip model](#user-content-link72)
**Authors:** Safae Dahmani, Imad El Bojaddaini, Amine Bouali, Ahmed Errahmani, Taoufik Ouali

73. [Study of UV line and continuum variabilities in the Broadline Seyfert 1 Galaxy ESO 141-G55](#user-content-link73)
**Authors:** Mayukh Pahari (IIT Hyderabad), Veda Samhita (Vasavi College of Engineering, Hyderabad), Harikumar N. (NIT Rourkela), Anurag Baruah (IIT Hyderabad), Vivek Shinde (IIT Hyderabad)

74. [Flip-flop states in X-ray binaries and changing-state AGN](#user-content-link74)
...
75. [Flux Variations of Fast Radio Bursts and Their Persistent Radio Sources: Evidence for a Shared Progenitor](#user-content-link75)
...
76. [Broadband SETI: a New Strategy To Find Nearby Alien Civilizations](#user-content-link76)
**Authors:** B. Zuckerman

77. [Thermalization of Neutrinos in a Neutron Star Merger Simulation](#user-content-link77)
**Authors:** Mark G. Alford, Liam Brodie, Francois Foucart, Alexander Haber

78. [Polarimetric Tomography Applied to Synthetic Multi-Spacecraft White-Light Images: Observing Coronal Mass Ejections in 3D](#user-content-link78)
**Authors:** David Barnes, Erika Palmerio, Tanja Amerstorfer, Eleanna Asvestari, Luke Barnard, Maike Bauer, Jasa Calogovic, Greta Cappello, Phillip Hess, Christina Kay

79. [Understanding the formation and eruption of sigmoidal structure through data-driven modeling of magnetic evolution in solar active region 13500](#user-content-link79)
**Authors:** P. Vemareddy, S. Nair, S. Gosain

80. [Anisotropic Diffusion in Pulsar Halos: Interpreting the asymmetric morphology of Geminga and Monogem halos measured by HAWC](#user-content-link80)
**Authors:** Si-Zhe Wu, Chao-Ming Li, Ruo-Yu Liu

81. [Multimessenger Characterization of High-Energy Neutrino Emission from the Brightest Neutrino-Active Galactic Nuclei](#user-content-link81)
**Authors:** Jose Alonso Carpio, Ali Kheirandish, Kohta Murase

82. [Enhanced Neutrino Cooling from Parity-Doubled Nucleons in Neutron Star Cooling Simulations](#user-content-link82)
**Authors:** Rodrigo Negreiros, Liam Brodie, Jan Steinheimer, Veronica Dexheimer, Robert D. Pisarski

83. [Gravitational waves from warm inflation in the weak dissipative regime](#user-content-link83)
**Authors:** Orlando Luongo, Tommaso Mengoni, Paulo M. S\'a

84. [Shadows and Polarization Images of a Four-dimensional Gauss-Bonnet Black Hole Irradiated by a Thick Accretion Disk](#user-content-link84)
**Authors:** Xiao-Xiong Zeng, Huan Ye, Muhammad Israr Aslam, Rabia Saleem

85. [Fine Structure and Formation Mechanism of a Sunspot Bipolar Light Bridge in NOAA AR 13663](#user-content-link85)
**Authors:** Fangfang Qiao, Hao Li, Jiasheng Wang, Yadan Duan, Zheng Sun, Leping Li

86. [Structural Design and Performance Analysis of Laser Transmitting Telescope for Space Gravitational Wave Detection](#user-content-link86)
...
87. [Catching TeV emission from GRB 221009A and alike with LHAASO, LACT and SWGO](#user-content-link87)
**Authors:** Yunlei Huang, Sujie Lin, Soebur Razzaque, Lili Yang, Zijie Huang

88. [One Hundred Years of Venus Polarimetry: PICSARR Observations of the Phase Curves](#user-content-link88)
**Authors:** Jeremy Bailey, Daniel V. Cotton, Kimberly Bott, Ievgeniia Boiko

89. [Disc accretion onto a binary black hole in a hierarchical triple system as an origin of the most luminous hyper-soft sources](#user-content-link89)
**Authors:** Sergei B. Popov, Galina V. Lipunova

90. [Uncertainty-Aware Solar Flare Regression](#user-content-link90)
**Authors:** Jinsu Hong, Chetraj Pandey, Berkay Aydin

91. [An Attempt to Search for Unintended Electromagnetic Radiation from Starlink Satellites with the 21 Centimeter Array: Methodology and RFI Characterization](#user-content-link91)
**Authors:** Xupiao Yang, Qijun Zhi, Yanbin Yang, Quan Guo, Juhua Gu, Jianfeng Wang, Yan Huang, Yun Yu, Feiyu Zhao

---

## 1. [Fuzzy Dark Matter and the Impact of Core-Halo Diversity on Its Particle Mass Constraints](https://arxiv.org/abs/2603.07175) <a id="link1"></a>
...
**Comment:** Directly analyzes Milky Way dwarf spheroidal galaxies' dark matter halos, focusing on core-halo mass relations and constraints on fuzzy dark matter particle mass. This is highly relevant to near-field cosmology, core-cusp, and substructure topics. The work uses both observational data and theoretical modeling.
...
## 2. [Ashes of FIRE: Modeling Dust Grain Size Evolution in the Local Group with FIRE](https://arxiv.org/abs/2603.08504) <a id="link2"></a>
...
**Comment:** This paper introduces a new dust grain size evolution model incorporated into FIRE-3 galaxy simulations, with applications to the Local Group. It matches the 'Numerical Galaxy Simulations' criterion, and also touches on ISM/CGM physics relevant to the Local Group, making it highly relevant.
...
## 3. [Evolution and formation of ultramassive white dwarf stars: The case for a 9Msun progenitor](https://arxiv.org/abs/2603.08573) <a id="link3"></a>
...
**Comment:** This paper presents detailed stellar evolution models for ultramassive white dwarfs, including full evolutionary tracks and cooling times. It matches the 'Stellar Models' criterion closely, as it provides new theoretical models and abundance profiles for white dwarfs.
...
## 4. [New Way to Date Globular Clusters: Brown Dwarf Cooling Sequences](https://arxiv.org/abs/2603.07481) <a id="link4"></a>
...
**Comment:** This paper introduces a new method for dating globular clusters using brown dwarf cooling sequences, presenting new stellar models and bolometric corrections. This directly matches the 'Stellar Models' criterion, as it presents new evolutionary tracks and error analysis for cluster ages.
...
## 5. [The Binary Populations of Stellar Streams are Set by Cluster Dynamics](https://arxiv.org/abs/2603.06790) <a id="link5"></a>
...
**Comment:** This paper presents direct N-body simulations of globular cluster streams, focusing on the binary populations and their dynamical evolution. It directly matches the 'Numerical Galaxy Simulations' criterion, and is also relevant to near-field cosmology as it pertains to globular cluster streams in the Milky Way. The work is highly relevant and presents new simulation results.
...
## 6. [K-DRIFT Science Theme: New Theoretical Framework Using the Galaxy Replacement Technique for LSB studies](https://arxiv.org/abs/2603.07968) <a id="link6"></a>
...
**Comment:** The paper introduces the Galaxy Replacement Technique (GRT), an N-body simulation framework for studying low-surface-brightness (LSB) structures in galaxies, including stellar and dark matter components. This matches the 'Numerical Galaxy Simulations' criterion closely, as it presents a new simulation technique with high resolution for galaxy evolution studies.
...
## 7. [How interacting winds shape the mechanical feedback of massive star clusters over millions of years](https://arxiv.org/abs/2603.08435) <a id="link7"></a>
...
**Comment:** Uses 3D MHD simulations to study mechanical feedback from massive star clusters and the structure of wind-driven outflows. The focus is on star formation driven outflows and numerical galaxy simulations, especially the phase structure and morphology of outflows, which is relevant to the core topics. The work presents new simulation methods and semi-analytical models.
...
## 9. [Systematic selection of surrogate models for nonequilibrium chemistry](https://arxiv.org/abs/2603.08567) <a id="link9"></a>
...
**Comment:** This paper introduces a framework for optimizing and benchmarking neural surrogate models for nonequilibrium chemistry in astrophysical environments. It is relevant to 'Numerical Galaxy Simulations' as it addresses computational bottlenecks in simulations and provides new methods for astrochemical modeling, which can be important for galaxy simulations.
...
## 10. [ML in Astrophysical Turbulence I: Predicting Prestellar Cores in Magnetized Molecular Clouds using eXtreme Gradient Boosting](https://arxiv.org/abs/2603.08513) <a id="link10"></a>
...
**Comment:** This paper presents a machine learning approach to predicting prestellar core formation in magnetized molecular clouds using MHD simulations. It is relevant to 'Numerical Galaxy Simulations' and 'Stellar Models' (as it deals with star formation processes and subgrid modeling for galaxy-scale simulations).
...
## 11. [s-process nucleosynthesis in low-mass AGB stars by the $^{13}$C($\alpha$,n)$^{16}$O neutron source](https://arxiv.org/abs/2603.08140) <a id="link11"></a>
...
**Comment:** This paper focuses on s-process nucleosynthesis in low-mass AGB stars, which is directly relevant to the 'Stellar Models' criterion, specifically stellar interior models and nucleosynthesis. It presents a review of the evolution of modeling approaches and discusses key nuclear reactions in stellar evolution.
...
## 12. [Hydrogen photoionization in a magnetized medium: the rigid-wavefunction approach revisited](https://arxiv.org/abs/2603.07679) <a id="link12"></a>
...
**Comment:** This paper presents improved modeling of hydrogen photoionization in magnetized media, relevant for stellar atmosphere models, especially for magnetic white dwarfs. It fits the 'Stellar Models' criterion, though the focus is on white dwarfs rather than main sequence or giant stars.
...
## 13. [Imaging the disk-halo interface of NGC 891: a 2.7 kpc-thick molecular gas disk](https://arxiv.org/abs/2603.06913) <a id="link13"></a>
...
**Comment:** This paper studies the disk-halo interface of NGC 891, focusing on molecular gas lifted by star formation-driven feedback. It is relevant to star formation driven outflows and the circumgalactic medium, though the galaxy is more massive than the LMC, so relevance is slightly reduced.
...
## 14. [Caught in the web: galaxy mergers along cosmic filaments](https://arxiv.org/abs/2603.06821) <a id="link14"></a>
...
**Comment:** The paper studies galaxy mergers along cosmic filaments and their role in pre-processing before cluster infall, with some discussion of star formation quenching in cluster environments. However, the focus is on higher-mass galaxies and cluster-scale processes, not specifically on dwarf galaxies or satellite quenching. The relevance is borderline due to the mention of quenching and environmental effects.
...
## 15. [Identifying Red Supergiants in the Local Group Using JWST Photometry. I. NGC 6822, Sextans A, NGC 300, WLM, and IC 1613](https://arxiv.org/abs/2603.08031) <a id="link15"></a>
...
**Comment:** Identifies red supergiants in Local Group galaxies using JWST photometry. While the focus is on massive stars, the work is relevant to resolved stellar populations in dwarf galaxies and the Local Group, which is a peripheral match to resolved star formation histories. Increased completeness of RSG samples may aid future star formation history studies.
...
## 16. [A differentiable and optimizable 3D model for interpretation of observed spectral data cubes](https://arxiv.org/abs/2603.06791) <a id="link16"></a>
...
**Comment:** The paper develops a differentiable 3D model for interpreting spectral data cubes of prestellar cores. It is relevant to 'Stellar Models' and possibly to 'Numerical Galaxy Simulations' (as it provides a new modeling tool for star-forming regions), but does not directly address galaxy-scale topics.
...
## 17. [Robust ellipticity measurements of 29 Galactic globular clusters](https://arxiv.org/abs/2603.08432) <a id="link17"></a>
...
**Comment:** This paper develops a robust method for measuring the ellipticity of Galactic globular clusters and investigates their internal dynamics. While it is a technical advance for cluster studies, globular clusters are not dwarf galaxies or satellites, and the focus is not on galaxy evolution or star formation histories. The relevance is borderline due to the connection to stellar populations.
...
## 18. [Pre-Virialized Assembly at Cosmic Dawn: The Dynamics and Extreme Ionization of Compact Group CGG-z7 at $z\sim7.04$](https://arxiv.org/abs/2603.08066) <a id="link18"></a>
...
**Comment:** This paper discusses a compact galaxy group at z~7, focusing on galaxy assembly and extreme ionization. While it is about galaxy formation, it is not near-field cosmology or focused on dwarf galaxies, resolved star formation histories, or galaxy simulations. It is borderline relevant due to its focus on galaxy group dynamics.
...
## 19. [An Alternate Pathway for H$_2$ Formation in the Early Universe: A physical process to account for the presence and coevolution of the luminous galaxies and supermassive black holes at the high redshifts](https://arxiv.org/abs/2603.08662) <a id="link19"></a>
...
**Comment:** Discusses a new pathway for H2 and HD formation in the early universe, with implications for primordial star and galaxy formation. While it touches on early structure formation, it does not focus on resolved star formation histories, dwarf galaxies, or galaxy simulations. The relevance is borderline due to possible implications for galaxy formation models.
...
## 20. [Extreme mass loss during common envelope evolution: the origin of the double low-mass white dwarf system J2102--4145](https://arxiv.org/abs/2603.08470) <a id="link20"></a>
...
**Comment:** This paper focuses on the evolution of double low-mass white dwarf systems and common envelope evolution. While it presents new stellar evolutionary models and constraints on hydrogen envelope masses, it does not directly address resolved star formation histories, near-field cosmology, or dwarf galaxy quenching. The relevance is borderline due to the stellar models aspect.
...
## 21. [On the relation between magnetic field strength and gas density in the interstellar medium. II. Density uncertainties and diffuse gas constraints](https://arxiv.org/abs/2603.06838) <a id="link21"></a>
...
**Comment:** This paper investigates the relationship between magnetic field strength and gas density in the interstellar medium, with implications for star formation. While it discusses ISM properties and star formation, it does not directly address resolved star formation histories, dwarf galaxy quenching, or galaxy simulations. The focus is on Milky Way ISM, not dwarf galaxies or their CGM, so it is borderline relevant due to its connection to star formation processes.
...
## 22. [Isotopic Evidence for a Cold and Distant Origin of the Interstellar Object 3I/ATLAS](https://arxiv.org/abs/2603.06911) <a id="link22"></a>
...
**Comment:** This paper reports isotopic measurements of the interstellar comet 3I/ATLAS, providing insight into exoplanet formation and Galactic chemical evolution. It is tangentially related to near-field cosmology (Galactic history), but does not focus on satellite galaxies, star formation histories, or galaxy simulations.
...
## 24. [Effect of gravity-driven longitudinal flows in filaments on angular momentum transport to embedded cores](https://arxiv.org/abs/2603.06990) <a id="link24"></a>
...
**Comment:** The paper studies angular momentum transport in filaments and its effect on protostellar core formation and outflow alignment, using SPH simulations. While it involves star formation and numerical simulations, the focus is on molecular clouds and filaments, not on galaxy-scale phenomena or resolved star formation histories.
...
## 25. [BlackGEM observations of compact pulsating stars: Mode identification for the DOV PG 1159--035 using multi-colour photometr](https://arxiv.org/abs/2603.07765) <a id="link25"></a>
...
**Comment:** The paper presents asteroseismic mode identification in a pre-white dwarf using ground-based multi-color photometry. While it deals with stellar pulsations and asteroseismology, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale processes. Borderline relevance for stellar models.
...
## 26. [A Direct View of the Chemical Properties of Water from Another Planetary System: Water D/H in 3I/ATLAS](https://arxiv.org/abs/2603.07026) <a id="link26"></a>

**ArXiv ID:** 2603.07026

**Authors:** Luis E. Salazar Manzano, Teresa Paneque-Carre\~no, Martin A. Cordiner, Edwin A. Bergin, Hsing Wen Lin, Dariusz C. Lis, David W. Gerdes, Jennifer B. Bergner, Nicolas Biver, Dominique Bockel\'ee-Morvan, Dennis Bodewits, Steven B. Charnley, Jacques Crovisier, Davide Farnocchia, Viviana V. Guzm\'an, Stefanie N. Milam, John W. Noonan, Anthony J. Remijan, Nathan X. Roth, John J. Tobin

**Abstract:** All detected water reservoirs in the solar system exhibit a deuterium enrichment that links back to the physical environment at the time of stellar birth. Gas-phase and ice-grain D-enrichments occur through chemical processes that operate at low temperatures ($ 6.6\times10^{-3}$, 3I/ATLAS shows a deuterium enrichment exceeding Earth's ocean value by more than a factor of $\gtrsim40$ and typical Solar System cometary values by more than a factor of $\gtrsim30$. The elevated deuterium enrichment points to water that formed under colder, less irradiated conditions and from less thermally processed material, consistent with an origin in a planetary system that formed under different physical and chemical conditions than our own.

**Comment:** This paper measures the D/H ratio in water from the interstellar object 3I/ATLAS, discussing implications for planetary system formation and Galactic conditions. It is tangentially related to near-field cosmology (Galactic chemical evolution), but does not focus on satellite galaxies, star formation histories, or galaxy simulations.
...
## 27. [Empirical signatures of velocity and density cascades in the Local Universe probed by CosmicFlows4 dataset](https://arxiv.org/abs/2603.06867) <a id="link27"></a>
...
**Comment:** The paper analyzes velocity and density fields in the Local Universe using CosmicFlows4, characterizing multiscale statistical properties and intermittency. While it deals with large-scale structure and local universe properties, it does not directly address near-field cosmology, dwarf galaxies, or resolved star formation histories.
...
## 28. [High nitrogen and carbon isotopic ratios in the interstellar comet 3I/ATLAS](https://arxiv.org/abs/2603.07187) <a id="link28"></a>
...
**Comment:** This paper reports measurements of carbon and nitrogen isotopic ratios in the interstellar comet 3I/ATLAS. While it deals with isotopic ratios and interstellar material, it does not address resolved star formation histories, galaxy simulations, or stellar models. No relevant criteria matched.
...
## 29. [A Reproducible Black Hole-Neutron Star Merger Gallery Example for the Einstein Toolkit](https://arxiv.org/abs/2603.07374) <a id="link29"></a>
...
**Comment:** The paper presents a reproducible black hole-neutron star merger simulation for the Einstein Toolkit. While it is a numerical simulation, it focuses on compact object mergers rather than galaxies, so it does not match the core criteria.
...
## 30. [Flash from the Past: New Gamma-Ray Constraints on Light CP-even Scalar from SN1987A](https://arxiv.org/abs/2603.08695) <a id="link30"></a>
...
**Comment:** The paper derives constraints on light CP-even scalars from SN1987A gamma-ray observations. While SN1987A is a nearby supernova, the focus is on particle physics constraints rather than near-field cosmology, resolved star formation histories, or galaxy evolution.
...
## 31. [The Impact of Dark Matter on Gravitational Wave Detection by Space-based Interferometers](https://arxiv.org/abs/2603.07158) <a id="link31"></a>
...
**Comment:** This review discusses the impact of dark matter on gravitational wave detection, including macroscopic distributions and their effects on compact-object systems. While it covers dark matter, it does not focus on near-field cosmology, satellite galaxies, or galaxy-scale dark matter profiles. No relevant criteria matched.
...
## 32. [The Average Age Map of the Galactic Bulge](https://arxiv.org/abs/2603.07905) <a id="link32"></a>
...
**Comment:** Focuses on the Galactic Bulge, which is not relevant to near-field cosmology as defined (Milky Way satellites, halo, etc.). The paper does mention accretion of debris from merged dwarf galaxies, but the main focus is on the bulge's age gradient and its formation via disk/bar processes. No direct connection to satellite galaxies, resolved star formation histories, or quenching in dwarfs.
...
## 33. [BICEP/Keck XXI: Constraints on Early-Universe Parity Violation from Multipole-Dependent Birefringence](https://arxiv.org/abs/2603.06812) <a id="link33"></a>
...
**Comment:** This paper presents constraints on cosmic birefringence and axion-photon coupling using CMB polarization data. It is focused on early-universe physics and does not address any of the core topics related to galaxy evolution, star formation, or near-field cosmology.
...
## 34. [Compression-Driven Kinetic Instabilities in Magnetically Arrested Disks](https://arxiv.org/abs/2603.08296) <a id="link34"></a>
...
**Comment:** This paper investigates kinetic instabilities in magnetically arrested disks around black holes using particle-in-cell simulations. The focus is on accretion disk physics and plasma instabilities, not on galaxy simulations, star formation, or near-field cosmology.
...
## 36. [A Deep Learning Framework for Amplitude Generation of Generic EMRIs](https://arxiv.org/abs/2603.08635) <a id="link36"></a>
...
**Comment:** This paper presents a deep learning framework for generating amplitudes for EMRI gravitational wave signals. It is focused on waveform modeling for black hole systems and does not address galaxy evolution, star formation, or dwarf galaxies.
...
## 37. [Double White Dwarf Mergers as Progenitors of Long-Period Transients](https://arxiv.org/abs/2603.08416) <a id="link37"></a>
...
**Comment:** This paper discusses double white dwarf mergers as progenitors of long-period transients, focusing on the rotational evolution and magnetic properties of white dwarfs. While it involves stellar evolution, it is not directly about stellar models or galaxy-scale phenomena.
...
## 38. [Spatiotemporal Properties of Compressible Magnetohydrodynamic Turbulence from Space Plasma](https://arxiv.org/abs/2603.08530) <a id="link38"></a>
...
**Comment:** This paper presents observational characterization of compressible MHD turbulence in space plasma, focusing on turbulence regimes and implications for plasma heating and energetic particle transport. It does not match any of the core topics.
...
## 39. [A GPU-Accelerated Transient Detection Pipeline for DECam Time-Domain Surveys](https://arxiv.org/abs/2603.08593) <a id="link39"></a>
...
**Comment:** The paper describes a GPU-accelerated transient detection pipeline for DECam time-domain surveys. While it is a technical advance in data processing, it does not directly address any of the core topics such as resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 40. [Exploring the spin dependence on mass inclination and distance for the newly discovered black hole X-ray binary Swift J151857.0-572147](https://arxiv.org/abs/2603.07908) <a id="link40"></a>
...
**Comment:** The paper analyzes the spin of a newly discovered black hole X-ray binary using continuum fitting. The focus is on black hole accretion and spin measurements, not on galaxy evolution, star formation, or any of the core topics.
...
## 41. [New black hole mass calibrations and the fundamental plane of the broad-line region size, luminosity, and velocity](https://arxiv.org/abs/2603.07047) <a id="link41"></a>
...
**Comment:** This paper presents new black hole mass calibrations and BLR scaling relations for AGNs, which is not relevant to the core topics (no connection to dwarf galaxies, star formation, or galaxy simulations).
...
## 42. [Gas chemistry in the dust depleted inner regions of protoplanetary disks. I. Near-IR spectra and overtones](https://arxiv.org/abs/2603.08529) <a id="link42"></a>
...
**Comment:** The paper models gas chemistry in the dust-depleted inner regions of protoplanetary disks, focusing on molecular abundances and emission lines. This is not relevant to the core topics (no connection to galaxies, star formation histories, or stellar models).
...
## 43. [Probing the Dispersion and Rotation Measure Contributions from Supernova Remnants in Fast Radio Burst Source Environments with 1D SNR Simulation](https://arxiv.org/abs/2603.07012) <a id="link43"></a>
...
**Comment:** This paper models SNR contributions to DM and RM in FRB environments, focusing on supernova remnants and their ionized gas. It is not relevant to the core topics (no connection to galaxies, star formation histories, or stellar models).
...
## 44. [Here Be SDRAGNs - Spiral Galaxies Hosting Large Double Radio Sources](https://arxiv.org/abs/2603.07788) <a id="link44"></a>
...
**Comment:** The paper presents a sample of spiral galaxies hosting large double radio sources (SDRAGNs). It focuses on radio AGN in spiral galaxies, which are more massive than the LMC and not dwarf satellites. No relevant criteria matched.
...
## 45. [Very High Energy Gamma Rays from Ultra Fast Outflows](https://arxiv.org/abs/2603.08701) <a id="link45"></a>
...
**Comment:** The paper models gamma-ray and neutrino emission from ultra fast outflows in AGN. It focuses on AGN feedback and particle acceleration, not on star-formation-driven outflows or dwarf galaxies. No relevant criteria matched.
...
## 46. [Symmetry-Protected Momentum Exchange between Dark Matter and Dark Energy](https://arxiv.org/abs/2603.07879) <a id="link46"></a>
...
**Comment:** Presents a theoretical model for dark matter-dark energy interactions and their effect on structure formation. While it discusses cosmological structure suppression, it does not focus on galaxies, satellites, or resolved star formation histories. No direct relevance to the core topics.
...
## 47. [LeMMINGs VII: 5 GHz, 50 mas e-MERLIN observations of a statistically complete sample of nearby AGN](https://arxiv.org/abs/2603.08562) <a id="link47"></a>
...
**Comment:** Presents radio observations of AGN in nearby galaxies, focusing on nuclear activity and compact jets. The work is not relevant to near-field cosmology, dwarf galaxies, or star formation histories.
...
## 48. [A reaction-diffusion model for describing the ring/gap structure in disks surrounding individual young stars](https://arxiv.org/abs/2603.08314) <a id="link48"></a>
...
**Comment:** Presents a reaction-diffusion model for ring/gap structures in protostellar disks. Focus is on planet formation and disk structure, not galaxy-scale processes or the core topics.
...
## 49. [A probable inside-out dwarf nova outburst from the period bouncer candidate ASASSN-25dc](https://arxiv.org/abs/2603.08272) <a id="link49"></a>
...
**Comment:** The paper studies a dwarf nova outburst in a cataclysmic variable system, focusing on accretion disk physics and superhump periods. While it involves a low-mass system, it is not a galaxy or related to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 50. [A clean broad iron line in GS 1354--64 as seen by XRISM](https://arxiv.org/abs/2603.06883) <a id="link50"></a>
...
**Comment:** The paper analyzes X-ray spectra of a black hole X-ray binary, focusing on accretion disk properties and black hole spin. It does not match any of the core criteria (no connection to galaxy simulations, near-field cosmology, or stellar models).
...
## 51. [High-Energy Neutrino Emission in NGC1068 driven by Turbulent Magnetic Reconnection](https://arxiv.org/abs/2603.07883) <a id="link51"></a>
...
**Comment:** This paper models high-energy neutrino emission from an AGN (NGC1068) via turbulent magnetic reconnection. It is not relevant to the core criteria (no connection to galaxy simulations, near-field cosmology, or star formation histories).
...
## 52. [Discovery of a 36-minute long-period transient ASKAP J142431.2-612611](https://arxiv.org/abs/2603.07857) <a id="link52"></a>
...
**Comment:** This paper reports the discovery of a long-period radio transient, discussing its polarization properties and intermittency. It does not match any of the core criteria (no connection to galaxy simulations, near-field cosmology, or stellar models).
...
## 53. [Spectral sirens cosmology from binary black holes populations with sharper mass features](https://arxiv.org/abs/2603.06792) <a id="link53"></a>
...
**Comment:** This paper uses gravitational-wave data to constrain cosmological parameters and discusses black hole mass distributions. It does not address near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 55. [Supernovae interacting with Si and S-rich circumstellar matter from double white dwarf mergers](https://arxiv.org/abs/2603.07064) <a id="link55"></a>
...
**Comment:** This paper focuses on supernovae resulting from double white dwarf mergers and the interaction with Si and S-rich circumstellar matter. While it discusses stellar evolution and supernova mechanisms, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM. The focus is on supernovae and white dwarf mergers, which are outside the main criteria.
...
## 56. [Measuring the evolution of stellar bars with the host galaxy's spin](https://arxiv.org/abs/2603.08015) <a id="link56"></a>
...
**Comment:** The paper focuses on the evolution of stellar bars and their effect on galaxy spin and star formation, specifically in barred galaxies. The main focus is on the bar and disk properties, which are explicitly listed as irrelevant in the criteria.
...
## 57. [A Delayed Radio Flare Traces Kinetic Energy Injection in the SMBHB Candidate SDSS~J143016.05+230344.4](https://arxiv.org/abs/2603.07161) <a id="link57"></a>
...
**Comment:** The paper studies radio flares in a supermassive black hole binary candidate, focusing on VLBI monitoring and jet/outflow properties. The focus is on SMBH binaries and AGN, which are explicitly listed as irrelevant.
...
## 58. [A jet formation model for astrophysical objects](https://arxiv.org/abs/2603.07620) <a id="link58"></a>
...
**Comment:** This paper presents a unified model for jet formation in various astrophysical objects, focusing on accretion disks and jet mechanisms. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM.
...
## 59. [Nonlinear evolution of unstable solar inertial modes: The case of viscous modes on a differentially rotating sphere](https://arxiv.org/abs/2603.08528) <a id="link59"></a>
...
**Comment:** The paper studies nonlinear evolution of solar inertial modes and their saturation, focusing on solar dynamics. It does not match any of the core topics, as it is not about galaxy evolution, star formation, or stellar models beyond solar physics.
...
## 61. [Interpreting Swift and NuSTAR Observations of the Low-Luminosity Active Galactic Nucleus NGC 4278 with Radiatively Inefficient Accretion Flows and Implications for Neutrino Emission](https://arxiv.org/abs/2603.07029) <a id="link61"></a>
...
**Comment:** The paper interprets X-ray and gamma-ray observations of a low-luminosity AGN, focusing on accretion flows and neutrino emission. It does not match any of the core topics (no connection to galaxies, star formation, or stellar models).
...
## 62. [WD 1054-226 revisited: a stable transiting debris system](https://arxiv.org/abs/2603.07677) <a id="link62"></a>
...
**Comment:** Studies a white dwarf with a transiting debris system, focusing on remnant planetary systems. No connection to galaxy simulations, near-field cosmology, or star formation histories.
...
## 63. [Different polarized components of the quasar 3C 286 revealed by FAST](https://arxiv.org/abs/2603.06983) <a id="link63"></a>
...
**Comment:** This paper focuses on polarized radio emission from a quasar (3C 286) and its interaction with the solar wind. It does not match any of the core criteria (no connection to near-field cosmology, star formation histories, galaxy simulations, or stellar models).
...
## 64. [Homogenization of the Stetson Photometry with the BEST Database](https://arxiv.org/abs/2603.08376) <a id="link64"></a>
...
**Comment:** This paper deals with photometric calibration using standard stars and databases. It does not match any of the core criteria (no connection to near-field cosmology, star formation histories, galaxy simulations, or stellar models).
...
## 65. [Inefficiency of chiral dynamos in protoneutron stars and the early universe](https://arxiv.org/abs/2603.07715) <a id="link65"></a>
...
**Comment:** The paper investigates chiral dynamos in protoneutron stars and the early universe, focusing on primordial magnetic field generation. It does not address any of the core topics such as galaxy evolution, star formation histories, or dwarf galaxies.
...
## 66. [Multi-epoch afterglow rebrightenings in GRB 250129A: Evidence for successive shock interactions](https://arxiv.org/abs/2603.08555) <a id="link66"></a>
...
**Comment:** The paper analyzes afterglow rebrightenings in a gamma-ray burst, focusing on shock interactions and modeling frameworks. It does not address galaxy evolution, star formation histories, or dwarf galaxies.
...
## 68. [Fundamental Limits of Quantum Sensors for Gravitational Wave Detection](https://arxiv.org/abs/2603.06772) <a id="link68"></a>
...
**Comment:** This paper discusses quantum sensors for gravitational wave detection and their fundamental limits. It does not address galaxy simulations, star formation, or stellar models. No relevant criteria matched.
...
## 69. [Non-common path aberration compensation and a dark hole loop with a pyramid adaptive optics system: Application to SAXO+](https://arxiv.org/abs/2603.08508) <a id="link69"></a>
...
**Comment:** This paper discusses adaptive optics and speckle removal techniques for ground-based high-contrast instruments. It is focused on instrumentation and not on galaxy simulations, star formation, or stellar models. No relevant criteria matched.
...
## 70. [Black Hole Mergers as the Fastest Photon Ring Scramblers](https://arxiv.org/abs/2603.08643) <a id="link70"></a>
...
**Comment:** This paper discusses photon ring scrambling in black hole mergers, mapping the properties of merger remnants to unstable null orbits. The focus is on black hole physics and not on galaxies, star formation, or any of the core criteria.
...
## 71. [Post-perihelion Coma Composition of the Interstellar Comet 3I/ATLAS from Optical Spectroscopy](https://arxiv.org/abs/2603.07718) <a id="link71"></a>
...
**Comment:** This paper presents optical spectroscopy of the interstellar comet 3I/ATLAS, focusing on its coma composition and volatile production. The study is about cometary chemistry and does not match any of the core criteria related to galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 72. [Study of the cosmological tensions and DESI-DR2 in the framework of the Little Rip model](https://arxiv.org/abs/2603.07398) <a id="link72"></a>
...
**Comment:** This paper analyzes cosmological tensions (H0, S8) in the context of a dark energy model, with statistical analysis using recent data. The focus is on cosmological parameters and not on galaxy-scale phenomena or any of the core topics.
...
## 73. [Study of UV line and continuum variabilities in the Broadline Seyfert 1 Galaxy ESO 141-G55](https://arxiv.org/abs/2603.06841) <a id="link73"></a>
...
**Comment:** The study is about UV variability in a Seyfert galaxy, focusing on AGN and accretion disk physics, which does not match any of the core topics (no connection to dwarf galaxies, star formation, or galaxy simulations).
...
## 74. [Flip-flop states in X-ray binaries and changing-state AGN](https://arxiv.org/abs/2603.07317) <a id="link74"></a>
...
**Comment:** The paper discusses analogies between flip-flop states in X-ray binaries and changing-state AGN, focusing on accretion physics. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 75. [Flux Variations of Fast Radio Bursts and Their Persistent Radio Sources: Evidence for a Shared Progenitor](https://arxiv.org/abs/2603.07123) <a id="link75"></a>
...
**Comment:** The paper studies fast radio bursts and their persistent radio sources, focusing on their progenitors and energetics. This is not related to any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 76. [Broadband SETI: a New Strategy To Find Nearby Alien Civilizations](https://arxiv.org/abs/2603.07333) <a id="link76"></a>
...
**Comment:** The paper proposes a new strategy for SETI, focusing on the search for alien civilizations via electromagnetic signals and probes. This is not related to any of the core topics.
...
## 77. [Thermalization of Neutrinos in a Neutron Star Merger Simulation](https://arxiv.org/abs/2603.06788) <a id="link77"></a>
...
**Comment:** The paper studies neutrino distributions in neutron star merger simulations, which is unrelated to the core topics (no connection to galaxies, star formation, or stellar models).
...
## 78. [Polarimetric Tomography Applied to Synthetic Multi-Spacecraft White-Light Images: Observing Coronal Mass Ejections in 3D](https://arxiv.org/abs/2603.07171) <a id="link78"></a>
...
**Comment:** This paper focuses on coronal mass ejections (CMEs) and their 3D reconstruction using polarimetric tomography. CMEs are solar phenomena and not related to galaxy-scale processes, dwarf galaxies, or stellar models. No relevant criteria matched.
...
## 79. [Understanding the formation and eruption of sigmoidal structure through data-driven modeling of magnetic evolution in solar active region 13500](https://arxiv.org/abs/2603.07281) <a id="link79"></a>
...
**Comment:** The paper models the magnetic evolution of a solar active region leading to a CME. It is focused on solar physics and not on galaxy-scale processes, dwarf galaxies, or stellar models. No relevant criteria matched.
...
## 80. [Anisotropic Diffusion in Pulsar Halos: Interpreting the asymmetric morphology of Geminga and Monogem halos measured by HAWC](https://arxiv.org/abs/2603.07061) <a id="link80"></a>
...
**Comment:** The paper models anisotropic diffusion in pulsar halos and interprets asymmetric morphologies observed by HAWC. It focuses on pulsar wind nebulae and interstellar magnetic fields, not on galaxy-scale processes, dwarf galaxies, or stellar models. No relevant criteria matched.
...
## 81. [Multimessenger Characterization of High-Energy Neutrino Emission from the Brightest Neutrino-Active Galactic Nuclei](https://arxiv.org/abs/2603.08684) <a id="link81"></a>
...
**Comment:** Focuses on high-energy neutrino emission from active galactic nuclei (AGN), specifically supermassive black holes. This is outside the scope of the core topics, which exclude AGN and SMBH-focused work.
...
## 82. [Enhanced Neutrino Cooling from Parity-Doubled Nucleons in Neutron Star Cooling Simulations](https://arxiv.org/abs/2603.06789) <a id="link82"></a>
...
**Comment:** Models neutron star cooling with parity-doubled nucleons. Focus is on neutron star interiors and cooling, not galaxy-scale processes or the core topics.
...
## 83. [Gravitational waves from warm inflation in the weak dissipative regime](https://arxiv.org/abs/2603.07662) <a id="link83"></a>
...
**Comment:** Discusses gravitational waves from warm inflation and their detectability. Focus is on early universe cosmology, not galaxy-scale processes or the core topics.
...
## 84. [Shadows and Polarization Images of a Four-dimensional Gauss-Bonnet Black Hole Irradiated by a Thick Accretion Disk](https://arxiv.org/abs/2603.07185) <a id="link84"></a>
...
**Comment:** This paper studies shadows and polarization images of Gauss-Bonnet black holes with thick accretion disks using ray-tracing. The focus is on black hole physics and accretion disk imaging, which does not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM.
...
## 85. [Fine Structure and Formation Mechanism of a Sunspot Bipolar Light Bridge in NOAA AR 13663](https://arxiv.org/abs/2603.07944) <a id="link85"></a>
...
**Comment:** This paper analyzes the fine structure and formation mechanism of a sunspot bipolar light bridge. The focus is on solar physics and sunspot dynamics, which is outside the core criteria related to galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 86. [Structural Design and Performance Analysis of Laser Transmitting Telescope for Space Gravitational Wave Detection](https://arxiv.org/abs/2603.07967) <a id="link86"></a>
...
**Comment:** This paper describes the structural design and performance analysis of a laser transmitting telescope for space gravitational wave detection. The focus is on instrumentation and engineering for gravitational wave detection, not on any of the core astrophysical criteria.
...
## 87. [Catching TeV emission from GRB 221009A and alike with LHAASO, LACT and SWGO](https://arxiv.org/abs/2603.07429) <a id="link87"></a>
...
**Comment:** This paper discusses gamma-ray bursts and their detection at TeV energies, which is not related to any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 88. [One Hundred Years of Venus Polarimetry: PICSARR Observations of the Phase Curves](https://arxiv.org/abs/2603.08151) <a id="link88"></a>
...
**Comment:** This paper reports polarimetry observations of Venus and atmospheric modeling. It is unrelated to any of the core topics, as it focuses on planetary atmospheres rather than galaxies, star formation, or cosmology.
...
## 89. [Disc accretion onto a binary black hole in a hierarchical triple system as an origin of the most luminous hyper-soft sources](https://arxiv.org/abs/2603.08294) <a id="link89"></a>
...
**Comment:** This paper focuses on accretion onto a binary black hole in a hierarchical triple system, which is unrelated to any of the core topics (no connection to dwarf galaxies, star formation histories, galaxy simulations, or stellar models).
...
## 90. [Uncertainty-Aware Solar Flare Regression](https://arxiv.org/abs/2603.06712) <a id="link90"></a>
...
**Comment:** The paper applies machine learning to solar flare prediction, focusing on space weather forecasting. It does not address any of the core topics such as galaxy evolution, star formation, or dwarf galaxies.
...
## 91. [An Attempt to Search for Unintended Electromagnetic Radiation from Starlink Satellites with the 21 Centimeter Array: Methodology and RFI Characterization](https://arxiv.org/abs/2603.07631) <a id="link91"></a>
...
**Comment:** This paper investigates unintended electromagnetic radiation from Starlink satellites and its impact on radio astronomy. It does not address any of the core topics such as galaxy evolution, star formation, or dwarf galaxies.
