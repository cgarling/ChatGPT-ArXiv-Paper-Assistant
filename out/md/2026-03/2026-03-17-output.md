...
1. [Implications of a contracted dark matter halo for the Milky Way's inferred virial mass](#user-content-link1)
...
2. [The Stellar Initial Mass Function down to 0.16M$_{\odot}$ Towards the Small Magellanic Cloud](#user-content-link2)
**Authors:** Roger E. Cohen, Mario Gennaro, Matteo Correnti, Kristen B. W. McQuinn, Vedant Chandra

3. [Phosphorus in cool stars of various metallicities: The non-local thermodynamic equilibrium consideration](#user-content-link3)
**Authors:** S. M. Andrievsky, S. A. Korotin

4. [Graph Path Likelihood for Galaxy Formation on Layered Halo Graphs](#user-content-link4)
**Authors:** Daneng Yang

5. [A Panchromatic JWST Spectrum of a Giant Starspot on the Fully Convective M-dwarf TOI-3884](#user-content-link5)
**Authors:** C. A. Murray, L. Garcia, B. V. Rackham, Z. Berta-Thompson, A. D. Feinstein, S. J. Mercier, B. Charnay, L. Hebb, J. E. Libby-Roberts, Y. Rotman, A. Stephens, M. Timmermans, L. Welbanks, K. Barkaoui, Caleb I. Canas, M. Delamer, E. Ducrot, S. Kanodia, S. Mahadevan, J. P. Ninan, J. de Wit

6. [Probing the first generations of massive stars through fluorine in CEMP-no stars](#user-content-link6)
**Authors:** Arthur Choplin, Georges Meynet

7. [Revisiting candidate high-velocity stars associated with the Sagittarius dwarf spheroidal galaxy](#user-content-link7)
**Authors:** Jian Zhang, Cuihua Du, Mingji Deng, Haoyang Liu, Zhongcheng Li

8. [Three-dimensional reddening maps of the Magellanic Clouds constructed by RR Lyrae stars](#user-content-link8)
**Authors:** Shunxuan He, Yang Huang

9. [Asteroseismology of red giants in the globular cluster 47 Tuc using the HST](#user-content-link9)
**Authors:** Dennis Stello, Timothy R. Bedding, Ronald L. Gilliland

10. [The Chandrasekhar's Conditions as Equilibrium and Stability of Stars in a Universal Three-Parameter Non-Maxwell Distribution](#user-content-link10)
**Authors:** Wei Hu, Jiulin Du

11. [Towards physically more comprehensive AGN modelling in cosmological simulations: A MACER-based modification of IllustrisTNG](#user-content-link11)
**Authors:** Bocheng Zhu, Volker Springel, Feng Yuan

12. [Molecular gas and star formation in GASP jellyfish galaxies](#user-content-link12)
**Authors:** A. Moretti, R. Paladino, C. Bacchini, A. Marasco, E. Giunchi, B. M. Poggianti, L. K. Hunt, T. Deb, B. Vulcani, M. Gullieuszik, A. Lassen, A. Wolter, M. Gitti, M. Radovich, J. Fritz, N. Tomicic

13. [Prevalent elongated galaxies in the early Universe evidenced by stellar kinematics](#user-content-link13)
**Authors:** Bitao Wang, Yingjie Peng, Hua Gao

14. [Hidden in Plain Sight: Searching for Globular Clusters Within JWST Observations of the PLCK G165.7+67.0 Galaxy Cluster](#user-content-link14)
**Authors:** Tyler R. Hinrichs, Patrick S. Kamieneski, Rogier A. Windhorst, Seth H. Cohen, Brenda L. Frye, Timothy Carleton, Massimo Pascale, Jose M. Diego, Rolf A. Jansen, Jessica Berkheimer, Nathan J. Adams, Christopher J. Conselice, Simon P. Driver, Nicholas Foo, Nikhil Garuda, Nimish P. Hathi, Rachel Honor, Anton M. Koekemoer, Rafael Ortiz III, Marta Reina-Campos, Aaron S. G. Robotham, Jake S. Summers, Haojing Yan, William E. Harris

15. [Direct Experiments of Neutron Capture on Stable and Unstable Isotopes for Stellar Nucleosynthesis Studies](#user-content-link15)
**Authors:** Jorge Lerendegui-Marco, Javier Balibrea-Correa, Victor Babiano-Su\'arez, Cesar Domingo-Pardo, Gabriel de la Fuente-Rosales, Bernardo Gameiro, Ion Ladarescu, Ariel Tarife\~no-Saldivia, Pablo Torres-S\'anchez, the n_TOF Collaboration

16. [Luminosity-Temperature Relation as a Probe for Modified Gravity](#user-content-link16)
**Authors:** Antonino Del Popolo, Saeed Fakhry, David F. Mota

17. [The ALPINE-CRISTAL-JWST Survey: Gas-phase abundance gradients of main sequence star-forming galaxies and their kinematics at $4 < z < 6$](#user-content-link17)
**Authors:** Lilian L. Lee, Natascha M. F\"orster Schreiber, Seiji Fujimoto, Andreas L. Faisst, Rodrigo Herrera-Camus, Reinhard Genzel, Linda J. Tacconi, Dieter Lutz, Alvio Renzini, Ryan Sanders, Emily Wisnioski, Stijn Wuyts, Eleonora Parlanti, Gareth Jones, Hannah \"Ubler, Daizhong Liu, Jianhang Chen, Ric I. Davies, Giulia Tozzi, Andreas Burkert, Sedona H. Price, Manuel Aravena, M\'ed\'eric Boquien, Matthieu B\'ethermin, Elisabete da Cunha, Rebecca L. Davies, Ilse De Looze, Miroslava Dessauges-Zavadsky, Andrea Ferrara, Deanne B. Fisher, Steven Gillman, Michele Ginolfi, Edo Ibar, Anton M. Koekemoer, Juan Molina, Thorsten Naab, M\'onica Rela\~no, Dominik A. Riechers, David B. Sanders, Justin S. Spilker, Livia Vallini, Giovanni Zamorani, Ambra Nanni, Poulomi Dam, Tanio Diaz-Santos, Diego G\'omez-Espinoza, Ali Hadi, Ryota Ikeda, Ana Posses, Michael Romano, Amiel Sternberg, Vicente Villanueva, Wuji Wang

18. [A flexible method for estimating luminosity functions via Kernel Density Estimation - III. Extending to Multiple Flux-Limited Samples](#user-content-link18)
**Authors:** Zunli Yuan, Chuanqi Li, Wenjie Wang, Luozhenhan Liu

19. [A measurement of gas rotation in galaxy groups via the kinetic Sunyaev-Zeldovich effect](#user-content-link19)
**Authors:** Tianyi Yang, Yan-Chuan Cai, Weiguang Cui, John A. Peacock, Romeel Dav\'e, Houjun Mo, Huiyuan Wang, Xiaohu Yang

20. [A hot, nebular-dominated galaxy interacting with a pristine PopIII system uncovered by JWST](#user-content-link20)
**Authors:** Henriette Reumert, Kasper E. Heintz, Clara L. Pollock, Alex J. Cameron, Gabriel B. Brammer, Harley Katz, Albert Sneppen, Joris Witstok, Chamilla Terp, Darach Watson

21. [Mapping Dark-Matter Clusters via Physics-Guided Diffusion Models](#user-content-link21)
**Authors:** Diego Royo, Brandon Zhao, Adolfo Mu\~noz, Diego Gutierrez, Katherine L. Bouman

22. [A Spectral Atlas for Quiescent Galaxies](#user-content-link22)
**Authors:** Massissilia L. Hamadouche, Jacqueline Antwi-Danso, Aliza Beverage, Katherine E. Whitaker

23. [Parametrizing superfluid dark matter with rational approximations](#user-content-link23)
**Authors:** Francesco Lottatori

24. [The Environments of Star-Forming Galaxies Detected in the SFACT Survey: Do Mergers and Interactions Drive the Star Formation?](#user-content-link24)
**Authors:** Brooke Kimsey-Miller, John J. Salzer, Kristin N. Baker, Samantha W. Brunker, David J. Carr, Jennifer Sieben

25. [Cosmic rays: constraints from future MeV detectors](#user-content-link25)
**Authors:** Giada Peron, Sarah Recchia, Stefano Menchiari, Alexandre Marcowith, Andrei Bykov, Martin Pohl, Elena Amato

26. [Measuring impurity-induced shifts in Coulomb crystallization](#user-content-link26)
**Authors:** Mingyao Xu, Aaron A. Smith, Leonid Prokhorov, Vera Guarrera, Giovanni Barontini

27. [Circuit Modeling for In Situ 21 cm Radiometer Calibration](#user-content-link27)
...
28. [Nebular Phase Evolution of SN 2023ixf (I): From Circumstellar Infrared Echo to the onset of in-situ Dust Formation in a Type II Supernova](#user-content-link28)
**Authors:** Avinash Singh, S. Goto, A. Sarangi, J. Johansson, C. Fransson, S. Barmentloo, J. Sollerman, R. S. Teja, K. Maeda, T. Hamada, N. Sarin, M. Yamanaka, T. Nakaoka, K. S. Kawabata, S. Schulze, A. Jerkstrand, S. Rose, D. K. Sahu, A. Gangopadhyay, G. C. Anupama, T. Ahumada, S. Anand, A. Bochenek, S. J. Brennan, X. Chen, S. Covarrubias, K. K. Das, X. Du, M. Dubey, N. Dukiya, N. Earley, X. Er, L. Ferrari, C. Fremling, G. Folatelli, W. V. Jacobson-Gal\'an, L. Galbany, K. -R. Hinds, R. Imazawa, V. Karambelkar, B. Kumar, M. Li, X. Liu, X. Liu, K. Misra, T. Nagayama, Y. Pan, D. A. Perley, Y. -J. Qin, Y. Sano, J. Wise, Y. -P. Yang, X. Zou, J. Adler, E. C. Bellm, M. W. Coughlin, M. Graham, M. M. Kasliwal, J. Purdum, B. Rusholme, A. Sasli, N. Sravan

29. [Exploring the surface of HD 189733 via Doppler shadow analysis of planetary transits](#user-content-link29)
**Authors:** E. C. Gon\c{c}alves, E. Cristo, W. Dethier, N. C. Santos, S. G. Sousa, P. T. P. Viana, T. Azevedo Silva, R. Allart, V. Bourrier

30. [Cosmological peculiar velocities in general relativity](#user-content-link30)
**Authors:** Chris Clarkson, Roy Maartens

31. [Line-driven Radiative Winds in B-Supergiants: Bridging the Gap between Fast and Slow m-CAK Solutions](#user-content-link31)
**Authors:** Mat\'ias Montesinos, Emil Zabala-Arroyo, Juan Jos\'e Castro-Salgado, Michel Cur\'e, Ignacio Araya

32. [Evidence for Atomic Absorption Features in the High Resolution X-ray Spectrum of the Neutron Star in Puppis A](#user-content-link32)
**Authors:** John Groger, Frits Paerels, Slavko Bogdanov, Eric V. Gotthelf, David J. Helfand, Ivan Hubeny, Thierry Lanz, Thomas A. Gomez

33. [The Steep-spectrum Radio-loud AGN Luminosity Function and Its Implications for Black Hole Growth and Star Formation](#user-content-link33)
**Authors:** Wenjie Wang, Zunli Yuan, B. \v{S}laus, Hongwei Yu, Yu Luo

34. [Time-Series Photometric Detection and Physical Characterization of Variable Stars in Four Intermediate- to Old-Age Galactic Open Clusters](#user-content-link34)
**Authors:** K. Belwal, D. Bisht, Ing-Guey Jiang, Mohit Singh Bisht, A. Raj, S. K. Chakrabarti, D. Bhowmick

35. [Formation and rising phase of a flux rope through data-constrained simulations](#user-content-link35)
**Authors:** M. V. Sieyra, A. Strugarek, A. Prasad, A. Wagner, P. D\'emoulin, F. Moreno-Insertis, A. J. Finley, R. Joshi, A. Blaise, A. S. Brun, E. Buchlin

36. [Informational corrections to the early-Universe radiation sector: CET Omega, WIMP freeze-out, and implications for a possible 20 GeV gamma-ray excess](#user-content-link36)
**Authors:** Christian Balfagon

37. [Wasserstein Distance in Cosmological Structure Formation: An Optimal Transport Perspective](#user-content-link37)
**Authors:** Tsutomu T. Takeuchi (Nagoya University)

38. [The ALMA-QUARKS Survey: Evidence of an Explosive Molecular Outflow in IRAS 15520--5234](#user-content-link38)
**Authors:** Ariful Hoque, Tapas Baug, Estrella Guzman, Manuel Fernandez Lopez, Tie Liu, Guido Garay, Paul F. Goldsmith, Fengwei Xu, Xindi Tang, Patricio Sanhueza, Lokesh K. Dewangan, Shivani Gupta, Sami Dib, Luis A. Zapata, Jihye Hwang, N. K. Bhadari, John Bally, Swagat Ranjan Das, Aiyuan Yang, Prasanta Gorai, Arup Kumar Maity, James O. Chibueze, Pablo Garc\'ia, Leonardo Bronfman, Xunchuan Liu, L. Viktor T\'oth, Shehu Muhammad Usman, Kee-Tae Kim

39. [Spatial analysis of PAH molecules in the Pillars of Creation using JWST](#user-content-link39)
**Authors:** Pranav R. Iyengar

40. [The TOLIMAN mission: A low-cost space telescope for high precision narrow-angle astrometry](#user-content-link40)
**Authors:** Peter Tuthill, Christopher Betters, Max Charles, Fred Crous, Donald G. Dansereau, Conaire Deagan, Louis Desdoigts, Mark George, Thomas Holland, Connor J. Langford, Milo Langker, Kieran Larkin, Clarissa Luk, Jack Nelson, Benjamin Pope, Grace Piroscia, Angus Rutherford, David Sweeney, Adam Taras, Karel Valenta, Tim White, Alison Wong, Eduardo Bendek, David Doelman, Kyran Grattan, Olivier Guyon, Peter Klupar, Benjamin T. Montet, Jeffrey Smith, Douglas Caldwell, Frans Snik, Simon P. Worden

41. [Kinematical and dynamical properties of recently discovered bulge and disc star clusters with WINERED](#user-content-link41)
**Authors:** Ilaria Petralia, Dante Minniti, Jos\'e G. Fern\'andez-Trincado, Noriyuki Matsunaga, Daisuke Taniguchi, Sasi Saroon, Elisa R. Garro, Hiroaki Sameshima, Shogo Otsubo, Yuki Sarugaku, Tomomi Takeuchi

42. [The Bochum Survey of the Southern Galactic Disk: III. Complete Data Release](#user-content-link42)
**Authors:** Julia Blex, Moritz Hackstein, Christian Westhues, Michael Ramolla, Markus Demleitner, Dominik J. Bomans, Kerstin Weis, Christofer Fein, Rolf Chini

43. [Investigating the Temporal Evolution of Gamma-Ray Burst Central Engine Parameters Based on Numerical Simulations](#user-content-link43)
**Authors:** Wei-Hua Lei

44. [Mapping of the Cold Neutral Medium via HI Phase Separation in an Atomic Cloud Undergoing Molecular Cloud Formation](#user-content-link44)
**Authors:** Yamato Matsuzuki, Hiroaki Yamamoto, Kengo Tachihara

45. [Dark Matter Induced Scalarization as a Possible Solution to the Hyperon Puzzle](#user-content-link45)
**Authors:** Suchana Adhikari, Teruaki Suyama

46. [Rotation Curve of the Milky Way](#user-content-link46)
**Authors:** Zi Liu

47. [CIV wind properties of the SDSS-V X-ray selected quasars: strong optical-to-UV emission is key regardless of X-ray strength](#user-content-link47)
...
48. [Cosmological angular momentum from quantum rotation](#user-content-link48)
**Authors:** Bo-Qiang Lu

49. [A Hybrid Framework for Kilonova Anomaly Detection using Single-Epoch SEDs from the 7-Dimensional Telescope](#user-content-link49)
**Authors:** Gregory S. H. Paek, Myungshin Im, Seo-Won Chang, Hyeonho Choi, Ji Hoon Kim

50. [iDaVIE v1.0: A virtual reality tool for interactive analysis of astronomical data cubes](#user-content-link50)
**Authors:** Alexander Sivitilli (J.M.), Lucia Marchetti (J.M.), Angus Comrie (J.M.), P. Cilliers Pretorius (J.M.), Thijs (J.M.), van der Hulst, Fabio Vitello, D. J. Pisano, Ugo Becciani, A. Russell Taylor, Paolo Serra, Mayhew Steyn, Michaela van Zyl

51. [An extreme particle accelerator powered by PSR J1849-0001](#user-content-link51)
**Authors:** The LHAASO Collaboration

52. [Multi-Field Dilaton Screening Beyond the Thin-Shell Mechanism](#user-content-link52)
**Authors:** Philippe Brax, Carsten van de Bruck, Anne-Christine Davis, Adam Smith

53. [Smoking-gun signatures of bounce cosmology from echoes of relic gravitational waves](#user-content-link53)
**Authors:** Mian Zhu, Yi-Fu Cai

54. [A user-friendly package and workflow for generating effective homogeneous rheologies for the study of the long-term orbital evolution of multilayered planetary bodies](#user-content-link54)
**Authors:** Yeva Gevorgyan

55. [Quantum Signatures of Cosmic Topology: How Casimir Backreaction Transmits Isotropy Violation](#user-content-link55)
**Authors:** Anna Negro (COMPACT Collaboration), Kurt Hinterbichler (COMPACT Collaboration), Glenn D. Starkman (COMPACT Collaboration), Yashar Akrami (COMPACT Collaboration), Stefano Anselmi (COMPACT Collaboration), Javier Carr\'on Duque (COMPACT Collaboration), Mikel Martin Barandiaran (COMPACT Collaboration), Thiago S. Pereira (COMPACT Collaboration), George Alestas (COMPACT Collaboration), Craig J. Copi (COMPACT Collaboration), Fernando Cornet-Gomez (COMPACT Collaboration), Linn Htat Lu (COMPACT Collaboration), Andrew H. Jaffe (COMPACT Collaboration), Arthur Kosowsky (COMPACT Collaboration), Deyan P. Mihaylov (COMPACT Collaboration), Joline Noltmann (COMPACT Collaboration), Jos\'e Javier Ortega G\'omez (COMPACT Collaboration), Catherine Petretti (COMPACT Collaboration), Amirhossein Samandar (COMPACT Collaboration), Andrius Tamosiunas (COMPACT Collaboration)

56. [Projected Sensitivity of Paleo-Detectors to Dark Matter Effective Interactions with Nuclei](#user-content-link56)
**Authors:** Dionysios P. Theodosopoulos, Katherine Freese, Chris Kelso, Patrick Stengel

57. [A New Catalogue of Galactic Red Supergiants for direct detection of episodic mass-loss events](#user-content-link57)
**Authors:** M. Lauriano, F. Bocchino, M. Miceli, S. Orlando, O. Petruk, A. Pastorello, M. Limongi, A. Chieffi

58. [Energy transfer from jets to surrounding matter to form lateral lobes in SS433/W50](#user-content-link58)
**Authors:** Hajime Inoue

59. [Gravity from surface triangulation: convergence acceleration with nested grids](#user-content-link59)
**Authors:** Jean-Marc Hur\'e

60. [Probing the potential high-energy messengers of the anticipated T Coronae Borealis outburst](#user-content-link60)
**Authors:** O. Petruk, T. Kuzyo, S. Orlando, L. Chomiuk, F. Bocchino, M. Miceli, S. Ustamujic

61. [The JWST Early Release Science Program for Direct Observations of Exoplanetary Systems. VIII. Molecular Mapping Performance with JWST/MIRI MRS: VHS 1256 b as a case study](#user-content-link61)
**Authors:** Mathilde M\^alin, Anthony Boccaletti, Benjamin Charnay, Laurent Pueyo, Alexis Bidot, Polychronis Patapis, Sasha Hinkley, Simon Petrus, Niall Whiteford, Marshall Perrin, Beth A. Biller, Gabriele Cugno, Thayne Currie, Camilla Danielski, Thomas Henning, Kielan K. W. Hoch, Markus Janson, Jens Kammerer, Elisabeth C Matthews, Evert Nasedkin, Paulina Palma-Bifani, Isabel Rebollido, Matthias Samland, Andrew Skemer, Jordan M. Stone, Genaro Su\'arez, Ben J. Sutlieff, Motohide Tamura, Christopher A. Theissen, Johanna M. Vos, Zhoujian Zhang, Alice Zurlo

62. [Primordial non-Gaussianity constraints on dissipative inflation](#user-content-link62)
**Authors:** Santiago Ag\"u\'i Salcedo, Thomas Colas, Petar Suman, Bowei Zhang, James Fergusson, E. P. S. Shellard

63. [Blazar Constraints on Axions through New Spectral Modulation Searches in 1ES 1959+650 & B2 1811+31](#user-content-link63)
**Authors:** Andrea Giovanni De Marchi, Orion Ning, Tianzhuo Xiao

64. [Evolution of wide O star binaries through their LBV stage. Population synthesis with mass-ejection-driven orbital evolution](#user-content-link64)
**Authors:** Xiao-Tian Xu, Philipp Podsiadlowski, Norbert Langer, Xue-Feng Wang, Xiang-Dong Li, Alexander Heger, Jonathan Mackey, G\"otz Gr\"afener, Harim Jin

65. [SIMTERFERE: An optical interferometry simulator for quantifying the coherent flux stability of VLTI/GRAVITY+. Reaching per mill stability: Application to exoplanet spectroscopy](#user-content-link65)
...
66. [A numerical framework for Newtonian-noise estimation at the Einstein Telescope: 2-D simulations beyond the plane-wave approximation](#user-content-link66)
**Authors:** Patrick Schillings, Shi Yao, Johannes Erdmann, Andreas Rietbrock

67. [IRAM 04191+1522: a compact proto-brown dwarf binary candidate](#user-content-link67)
**Authors:** N. Hu\'elamo, I. de Gregorio-Monsalvo, Aina Palau, C. Carrasco-Gonz\'alez, A. Ribas, H. Bouy, R. Pandey, D. Barrado, N. Otten, V. D. Ivanov, M. F. Sterzik, M. Dunham, L. A. Zapata, E. Pantin, E. Mac\'ias

68. [Mass Production of 2023 KMTNet Microlensing Planets. II: Two Planets and A Brown Dwarf](#user-content-link68)
**Authors:** Zhixing Li, Hongyu Li, Weicheng Zang, Yoon-Hyun Ryu, Andrzej Udalski, Takahiro Sumi, Hongjing Yang, Yuchen Tang, Jiyuan Zhang, Shude Mao

69. [The hidden population of long gamma-ray bursts from compact object mergers](#user-content-link69)
**Authors:** R. Maccary, C. Guidorzi, L. Amati, M. Bulla, S. Kobayashi, M. Maistrello, A. Rossi, G. Stratta, A. Tsvetkova

70. [Quasi-Periodic Fast-Mode Wave Trains Associated with the 2015-Jun-22 M6.5 Flare in AR~12371: Observations and 3D MHD Modeling](#user-content-link70)
**Authors:** Tongjiang Wang, Wei Liu, Leon Ofman, Xudong Sun, Meng Jin

71. [Probing Gravitational-Wave Four-Point Correlators](#user-content-link71)
**Authors:** Martina Ciprini, Maria Lucia Marcelli, Gianmassimo Tasinato

72. [Discovery of a millisecond pulsar with a CO white dwarf companion](#user-content-link72)
**Authors:** Jie Zhang, Zerui Wang, Lei Zhang, Yulan Liu, Alessandro Ridolfi, Meng Guo, Di Li, Ryan S. Lynch, Cong Wang, Pei Wang, Mengmeng Ni, Jiale Hu, Mengquan Liu, Zhie Liu, Bo Han, Chenchen Miao

73. [Critical slowing down and bulk viscosity in binary neutron star mergers](#user-content-link73)
**Authors:** Jamie M. Karthein, Maneesha Sushama Pradeep, Rachel Steinhorst

74. [Calibrating spectral siren cosmology with synthetic catalogs of binary black hole mergers](#user-content-link74)
**Authors:** Arianna Scarpa, Simone Mastrogiovanni, Filippo Santoliquido, Manuel Arca-Sedda

75. [Compact and Physically Interpretable Feature Models for Photometric Type Ia Supernova Classification](#user-content-link75)
**Authors:** Anurag Garg

76. [QCD-driven dark matter: AQNs formation and observational tests](#user-content-link76)
**Authors:** Ludovic Van Waerbeke

77. [Distinguishing Kilonovae from Binary Neutron Star and Neutron Star-Black Hole Mergers](#user-content-link77)
**Authors:** Ish Gupta, Yugesh Bhoge, Rahul Kashyap, Mukul Bhattacharya

78. [Non-parametric estimation of the baryon gas fraction and the cosmological bias with clusters](#user-content-link78)
**Authors:** Hyeon Kim, Rapha\"el Wicker, Benjamin L'Huillier, Marian Douspis, Laura Salvati, Arman Shafieloo

79. [Implications of a Cosmogenic Origin of KM3-230213A for Ultra-High-Energy Protons](#user-content-link79)
**Authors:** A. R. Alhebsi, Arjen van Vliet, Domenik Ehlert, Satyendra Thoudam

80. [When One-Parameter Dark Energy Makes Neutrinos Physical Again](#user-content-link80)
**Authors:** Weiqiang Yang, Eleonora Di Valentino, Eric V. Linder, Sibo Zhang, Supriya Pan

81. [A modest change in magnetic braking at the fully convective boundary explains cataclysmic variable evolution](#user-content-link81)
**Authors:** Joaqu\'in A. Barraza-Jorquera, Matthias R. Schreiber, Stuart Littlefair, Diogo Belloni, Axel D. Schwope

82. [Do We Have Sufficient Knowledge of the Galactic Foreground Emission in Cosmic Microwave Background Science?](#user-content-link82)
**Authors:** Jia-Rui Li, Peibo Yuan, Yi-Fu Cai, Hao Liu

83. [The eclipsing novalike cataclysmic variable CRTS SSS100505 J093417-174421](#user-content-link83)
**Authors:** R. Baptista, A. Bruch, R. Lopes de Oliveira, C. V. Rodrigues, A. S. Oliveira, I. J. Lima

84. [The Historical Lightcurve of the R Coronae Borealis Star, V854 Cen, from 1890 to 2026](#user-content-link84)
**Authors:** Geoffrey C Clayton

85. [Comparative analysis of BL Lacertae in flaring and non-flaring states: timing and spectral studies](#user-content-link85)
**Authors:** A. Priyana Noel, Alicja Wierzcholska, Raj Prince

86. [CosmoDS: A Python toolkit for constraining cosmological models via dynamical systems analysis with Cobaya](#user-content-link86)
**Authors:** Nandan Roy, Prasanta Sahoo

87. [Blackbody Quasar and Radio Source (BBQSORS): A Candidate of Transitional Little Red Dots with a $T\sim10^4\ K$ Blackbody Spectrum](#user-content-link87)
...
88. [Dynamics of the Upwind Heliosphere Due to Data-Driven, Solar Wind and Magnetic Field Variations and Implications for Wave Propagation into the Very Local Interstellar Medium](#user-content-link88)
**Authors:** Chika (Boston University), M. Opher (Boston University), E. Powell (Boston University), S. Du (Boston University), J. M. Sok\'o{\l} (Southwest Research Institute), J. D. Richardson (Massachusetts Institute of Technology), B. Van Der Holst (Boston University)

89. [Hidden Connections: Tracing the BCG Stellar Mass-Halo Mass Relation in the SDSS-GalWCat19 Cluster Catalog](#user-content-link89)
...
90. [Spectral Variations of $\gamma$-rays in Mrk 421](#user-content-link90)
**Authors:** Rui-Qi Huang, Xin-Ke Hu, Yu-Wei Yu, Ji-Shun Lian, Jin Zhang

91. [Cosmic ray mass composition measurement in the energy range from $10^{16.5}$ eV to $10^{18.5}$ eV observed with the TALE hybrid detector](#user-content-link91)
...
92. [Background-level reconstruction of scalar-field potentials from dark-energy histories and comparison with analytic potential families](#user-content-link92)
**Authors:** Shahnawaz A. Adil, Miguel A. Zapata, \"Ozg\"ur Akarsu, J. Alberto Vazquez

93. [Searching for Unparticles with the Cosmic Microwave Background](#user-content-link93)
**Authors:** Oliver H. E. Philcox, Guilherme L. Pimentel, Chen Yang

94. [The extinction distances for over a thousand planetary nebulae with Gaia measurements](#user-content-link94)
**Authors:** Juan Deng, Shu Wang, Biwei Jiang, Licai Deng

95. [The Eccentric Disk Model for Superhumps](#user-content-link95)
**Authors:** Stephen H. Lubow

96. [Constraining Spin and Inclination Angle of XTE J2012+381 using AstroSat and NICER](#user-content-link96)
**Authors:** Vaibhav Sharma, Ranjeev Misra, Shivani Chaudhary, J S Yadav, Pankaj Jain

97. [Ultra-compact X-ray Binaries: A Review](#user-content-link97)
**Authors:** Bo Wang, Dongdong Liu, Yunlang Guo, Hailiang Chen, Wencong Chen, Zhanwen Han

98. [Pulsar timing arrays: the emerging gravitational-wave landscape](#user-content-link98)
**Authors:** C. M. F. Mingarelli, J. A. Casey-Clyde, Y. T. Chang, E. Eisenberg, F. Hutchison, N. Khusid, B. Larsen, A. Moran, F. Semenzato, L. Willson, Q. Zheng

99. [Reconnection-driven State Transitions in Flat Spectrum Radio Quasars](#user-content-link99)
**Authors:** Agniva Roychowdhury

100. [Do the sources of the 511 keV excess explain the anomalous CMZ ionization?](#user-content-link100)
**Authors:** Pedro De la Torre Luque, Francesca Calore

101. [Can cyanide radicals drive molecular backbone growth on interstellar icy grains?](#user-content-link101)
**Authors:** Germ\'an Molpeceres, Joan Enrique-Romero

102. [Shocks in the Symbiotic Recurrent Nova V3890 Sgr: VLBI Radio Imaging and Fermi GeV Gamma-Rays](#user-content-link102)
...
103. [Lagrangian Identity and Mass Evolution of Particle-like Objects in Nonminimally Coupled Gravity](#user-content-link103)
**Authors:** S. R. Pinto, P. P. Avelino

104. [Inflation without an Inflaton III: non-Gaussian signatures](#user-content-link104)
**Authors:** Mariam Abdelaziz, Marisol Traforetti, Daniele Bertacca, Raul Jimenez, Sabino Matarrese, Angelo Ricciardone

105. [Born-Infeld AdS Black Holes Surrounded by Perfect Fluid Dark Matter](#user-content-link105)
**Authors:** Behzad Eslam Panah, Bilel Hamil, Manuel E. Rodrigues

106. [The Effect of "Roll-Drift" in ACS/WFC Images](#user-content-link106)
**Authors:** Yotam Cohen

107. [ANNA: a toolbox for Newtonian Noise Analysis](#user-content-link107)
**Authors:** Pieter Reumers, Xhorxha Kucia, Stijn Fran\c{c}ois, Geert Degrande

108. [Dust traps and gas kinematic signatures in a crescent structure of a planet-forming disk](#user-content-link108)
**Authors:** Greta Guidi, Fran\c{c}ois Menard, Daniel J. Price, Marion Villenave, Jie Ma

109. [Dark Matter Search with the DEAP-3600 Detector using the Profile Likelihood Ratio Method](#user-content-link109)
**Authors:** DEAP Collaboration, P. Adhikari, R. Ajaj, M. Alp\'izar-Venegas, P. -A. Amaudruz, J. Anstey, D. J. Auty, M. Baldwin, M. Batygov, B. Beltran, A. Bigentini, C. E. Bina, W. Bonivento, M. G. Boulay, J. F. Bueno, P. M. Burghardt, A. Butcher, M. Cadeddu, B. Cai, M. C\'ardenas-Montes, S. Cavuoti, Y. Chen, S. Choudhary, B. T. Cleveland, R. Crampton, S. Daugherty, P. DelGobbo, P. Di Stefano, G. Dolganov, L. Doria, F. A. Duncan, M. Dunford, E. Ellingwood, A. Erlandson, S. S. Farahani, N. Fatemighomi, G. Fiorillo, R. J. Ford, D. Gahan, D. Gallacher, A. Garai, P. Garc\'ia Abia, S. Garg, P. Giampa, A. Gim\'enez-Alc\'azar, D. Goeldi, P. Gorel, K. Graham, A. Grobov, A. L. Hallin, M. Hamstra, S. Haskins, J. Hu, J. Hucker, D. Huff, T. Hugues, A. Ilyasov, B. Jigmeddorj, C. J. Jillings, A. Joy, G. Kaur, A. Kemp, M. Khoshraftar Yazdi, M. Ku\'zniak, F. La Zia, M. Lai, S. Langrock, B. Lehnert, J. LePage-Bourbonnais, M. Lissia, L. Luzzi, I. Machulin, P. Majewski, A. Maru, J. Mason, A. B. McDonald, T. McElroy, J. B. McLaughlin, C. Mielnichuk, L. Mirasola, A. Moharana, J. Monroe, A. Murray, M. Needs, C. Ng, G. Olivi\'ero, M. Olszewski, S. Pal, D. Papi, B. Park, M. Perry, V. Pesudo, T. R. Pollmann, F. Rad, C. Rethmeier, F. Reti\`ere, I. Rodr\'iguez Garc\'ia, L. Roszkowski, R. Santorelli, F. G. Schuckman II, N. Seeburn, S. Seth, V. Shalamova, P. Skensved, T. Smirnova, N. J. T. Smith, K. Sobotkiewich, T. Sonley, J. Sosiak, J. Soukup, R. Stainforth, M. Stringer, J. Tang, P. Taylor, R. Turcotte-Tardif, E. V\'azquez-J\'auregui, G. Vera D\'iaz, S. Viel, B. Vyas, M. Walczak, J. Walding, M. Ward, S. Westerdale, R. Wormington, A. Zu\~niga-Reyes

110. [Combining data and metadata: hybrid tabular file formats](#user-content-link110)
**Authors:** Mark Taylor

111. [Ultralight Dark Matter: Undergraduate Physics in Modern Cosmology](#user-content-link111)
**Authors:** Timothy D. Wiser

---

## 1. [Implications of a contracted dark matter halo for the Milky Way's inferred virial mass](https://arxiv.org/abs/2603.13516) <a id="link1"></a>
...
**Comment:** Directly addresses the dark matter halo profile and virial mass of the Milky Way, with implications for near-field cosmology and dark matter density profiles (core-cusp). Uses numerical galaxy simulations (ARTEMIS) and discusses biases in mass estimation, matching both near-field cosmology and numerical galaxy simulations criteria.
...
## 3. [Phosphorus in cool stars of various metallicities: The non-local thermodynamic equilibrium consideration](https://arxiv.org/abs/2603.14513) <a id="link3"></a>
...
**Comment:** This paper presents a new atomic model for phosphorus in cool stars, refining abundance measurements with NLTE corrections. It fits the 'Stellar Models' criterion, as it provides new theoretical models for stellar atmospheres and abundance corrections.
...
## 4. [Graph Path Likelihood for Galaxy Formation on Layered Halo Graphs](https://arxiv.org/abs/2603.15128) <a id="link4"></a>
...
**Comment:** Presents a new likelihood-based forward modeling framework for galaxy formation, trained on TNG50-1 simulations. Directly relevant to numerical galaxy simulations, with additional relevance for satellite galaxies and environmental processing. High relevance due to simulation and satellite focus.
...
## 5. [A Panchromatic JWST Spectrum of a Giant Starspot on the Fully Convective M-dwarf TOI-3884](https://arxiv.org/abs/2603.15414) <a id="link5"></a>
...
**Comment:** This paper presents the first empirical panchromatic spectrum of an M-dwarf starspot using JWST, providing a direct observational benchmark for stellar atmosphere models in the fully convective regime. This closely matches the 'Stellar Models' criterion, as it tests and informs stellar atmosphere models with new empirical data.
...
## 6. [Probing the first generations of massive stars through fluorine in CEMP-no stars](https://arxiv.org/abs/2603.14939) <a id="link6"></a>

**ArXiv ID:** 2603.14939

**Authors:** Arthur Choplin, Georges Meynet

**Abstract:** We investigate whether the first discovered fluorine-rich CEMP-no star, CS 29498$-$043, can be explained by a very metal-poor rotating massive star. We consider single rotating stellar models of 20 $M_{\odot}$ at a metallicity of $Z = 10^{-5}$, exploring initial rotation rates from $\upsilon_{\rm ini}/\upsilon_{\rm crit} = 0$ to $0.7$ in increments of $0.1$ ($0<\upsilon_{\rm ini}<644$ km s$^{-1}$). Rotational mixing enhances the production of light elements in the H--He layers, including fluorine. The ejected material can be nitrogen-rich without being fluorine-rich, whereas fluorine-rich ejecta are always predicted to be nitrogen-rich. The model providing the best fit to the abundances of CS 29498$-$043 is the $\upsilon_{\rm ini}/\upsilon_{\rm crit} = 0.6$ model ($\upsilon_{\rm ini} = 547$ km s$^{-1}$), which reproduces C, N, O, Na, Mg, and Al within the observational uncertainties. However, the predicted [F/Fe] $=2.8$ exceeds the observed value of [F/Fe] $=2.0 \pm 0.4$. By simultaneously varying the $^{15}$N($\alpha,\gamma$)$^{19}$F and $^{19}$F($\alpha,p$)$^{22}$Ne reaction rates within their acceptable ranges, the [F/Fe] ratio in the $\upsilon_{\rm ini}/\upsilon_{\rm crit} = 0.6$ model can be reduced to 2.2, providing a plausible solution to the abundance pattern of CS 29498$-$043. Our results support the hypothesis that fluorine-rich CEMP-no stars may originate from material enriched by a single, metal-poor, rotating massive star. A potential observational test of this scenario may be to check whether the nitrogen and fluorine abundances observed at the surface of CEMP-no stars are correlated.

**Comment:** Presents new stellar models for very metal-poor rotating massive stars and their nucleosynthetic yields, directly matching the 'Stellar Models' criterion. Also discusses abundance patterns in CEMP-no stars, which are relevant for stellar evolution and chemical enrichment.
...
## 7. [Revisiting candidate high-velocity stars associated with the Sagittarius dwarf spheroidal galaxy](https://arxiv.org/abs/2603.14678) <a id="link7"></a>
...
**Comment:** This paper investigates high-velocity stars associated with the Sagittarius dwarf spheroidal galaxy, directly relating to near-field cosmology and the study of Milky Way satellite galaxies. It uses orbital analysis and chemical abundances to probe the origins of stars in the context of the Sgr dSph, matching the 'Near-Field Cosmology' criterion.
...
## 8. [Three-dimensional reddening maps of the Magellanic Clouds constructed by RR Lyrae stars](https://arxiv.org/abs/2603.13860) <a id="link8"></a>
...
**Comment:** This paper presents three-dimensional reddening maps of the Magellanic Clouds using RR Lyrae stars, which involves resolved stellar populations and color-magnitude diagram analysis. It matches the 'Resolved Star Formation Histories' criterion and is also relevant to near-field cosmology through the study of the LMC and SMC.
...
## 9. [Asteroseismology of red giants in the globular cluster 47 Tuc using the HST](https://arxiv.org/abs/2603.13701) <a id="link9"></a>
...
**Comment:** Asteroseismology of red giants in globular cluster 47 Tuc, measuring stellar masses and mass loss. Directly relevant to stellar models and stellar evolution, with implications for mass loss and population differences. High relevance for stellar models.
...
## 10. [The Chandrasekhar's Conditions as Equilibrium and Stability of Stars in a Universal Three-Parameter Non-Maxwell Distribution](https://arxiv.org/abs/2603.15060) <a id="link10"></a>
...
**Comment:** The paper revisits Chandrasekhar's conditions for stellar equilibrium and stability using a non-Maxwell distribution. This is directly relevant to the 'Stellar Models' criterion, as it presents new theoretical work on stellar interior models.
...
## 11. [Towards physically more comprehensive AGN modelling in cosmological simulations: A MACER-based modification of IllustrisTNG](https://arxiv.org/abs/2603.15235) <a id="link11"></a>
...
**Comment:** This paper presents a modification of the IllustrisTNG cosmological simulation to include more detailed AGN feedback physics. It directly matches the 'Numerical Galaxy Simulations' criterion, as it introduces new physics models into a major galaxy simulation suite. The focus is on AGN feedback, which is less relevant than star-formation-driven feedback, but the work is still highly relevant for galaxy simulation methodology.
...
## 12. [Molecular gas and star formation in GASP jellyfish galaxies](https://arxiv.org/abs/2603.15239) <a id="link12"></a>
...
**Comment:** This paper studies star formation efficiency and molecular gas in galaxies affected by ram pressure stripping, focusing on the Kennicutt-Schmidt law. While it discusses star formation and environmental effects, the galaxies are not specifically dwarfs or satellites, nor does it focus on resolved star formation histories or quenching in dwarfs. The relevance is borderline due to the focus on star formation processes and environmental effects, but not directly on the core topics.
...
## 13. [Prevalent elongated galaxies in the early Universe evidenced by stellar kinematics](https://arxiv.org/abs/2603.13700) <a id="link13"></a>
...
**Comment:** Examines the morphology and stellar kinematics of low-mass galaxies at high redshift, with implications for the evolution of disc galaxies and the Milky Way. Some relevance to near-field cosmology and galaxy structure evolution, but not directly focused on satellite galaxies or resolved star formation histories.
...
## 14. [Hidden in Plain Sight: Searching for Globular Clusters Within JWST Observations of the PLCK G165.7+67.0 Galaxy Cluster](https://arxiv.org/abs/2603.14480) <a id="link14"></a>
...
**Comment:** This paper searches for globular clusters in a galaxy cluster using JWST data, analyzing their spatial distribution and luminosity function. While it deals with globular clusters and their relation to cluster mass, it does not focus on satellite galaxies, near-field cosmology, or resolved star formation histories. The relevance is borderline due to the connection to substructure and cluster environments.
...
## 15. [Direct Experiments of Neutron Capture on Stable and Unstable Isotopes for Stellar Nucleosynthesis Studies](https://arxiv.org/abs/2603.13540) <a id="link15"></a>
...
**Comment:** Reviews neutron-capture experiments for stellar nucleosynthesis, improving constraints on s-process models. This is relevant to stellar models and nucleosynthesis, but not directly to galaxy evolution, near-field cosmology, or resolved star formation histories.
...
## 16. [Luminosity-Temperature Relation as a Probe for Modified Gravity](https://arxiv.org/abs/2603.15077) <a id="link16"></a>
...
**Comment:** Focuses on the luminosity-temperature relation in galaxy clusters and groups as a probe for modified gravity. While it discusses low-mass systems, the emphasis is on galaxy clusters and groups, not dwarf galaxies or satellites. No direct connection to near-field cosmology, resolved star formation histories, or galaxy simulations. Marginal relevance due to discussion of low-mass systems.
...
## 17. [The ALPINE-CRISTAL-JWST Survey: Gas-phase abundance gradients of main sequence star-forming galaxies and their kinematics at $4 < z < 6$](https://arxiv.org/abs/2603.13493) <a id="link17"></a>

**ArXiv ID:** 2603.13493

**Authors:** Lilian L. Lee, Natascha M. F\"orster Schreiber, Seiji Fujimoto, Andreas L. Faisst, Rodrigo Herrera-Camus, Reinhard Genzel, Linda J. Tacconi, Dieter Lutz, Alvio Renzini, Ryan Sanders, Emily Wisnioski, Stijn Wuyts, Eleonora Parlanti, Gareth Jones, Hannah \"Ubler, Daizhong Liu, Jianhang Chen, Ric I. Davies, Giulia Tozzi, Andreas Burkert, Sedona H. Price, Manuel Aravena, M\'ed\'eric Boquien, Matthieu B\'ethermin, Elisabete da Cunha, Rebecca L. Davies, Ilse De Looze, Miroslava Dessauges-Zavadsky, Andrea Ferrara, Deanne B. Fisher, Steven Gillman, Michele Ginolfi, Edo Ibar, Anton M. Koekemoer, Juan Molina, Thorsten Naab, M\'onica Rela\~no, Dominik A. Riechers, David B. Sanders, Justin S. Spilker, Livia Vallini, Giovanni Zamorani, Ambra Nanni, Poulomi Dam, Tanio Diaz-Santos, Diego G\'omez-Espinoza, Ali Hadi, Ryota Ikeda, Ana Posses, Michael Romano, Amiel Sternberg, Vicente Villanueva, Wuji Wang

**Abstract:** We present gas-phase radial metallicity profiles for 20 main-sequence galaxies at $40.05{\rm dexkpc^{-1}}$ at $1\sigma$, and none have a significant negative gradient. We investigate the correlation between the metallicity gradients and the intrinsic gas velocity dispersion $\sigma_0$, as well as the ratio $V_{\rm rot}/\sigma_0$ of the disks. Combining our sample with mass-matched literature samples at $3<7$, we find a negative shallow correlation between $V_{\rm rot}/\sigma_0$ and the metallicity gradients, but no strong relationships with $\sigma_0$. As $V_{\rm rot}/\sigma_0$ increases towards later cosmic times, the observed negative trend with $V_{\rm rot}/\sigma_0$ is consistent with the overall cosmic evolution of metallicity gradients from high to low redshifts. This suggests that disk maturity plays a crucial role in shaping the radial metallicity gradients. [Abridged abstract]

**Comment:** Studies gas-phase abundance gradients and kinematics in main sequence star-forming galaxies at high redshift. While it touches on star formation and metallicity gradients, it is not focused on dwarf galaxies or resolved star formation histories. Some borderline relevance to star formation quenching and galaxy evolution.
...
## 18. [A flexible method for estimating luminosity functions via Kernel Density Estimation - III. Extending to Multiple Flux-Limited Samples](https://arxiv.org/abs/2603.15441) <a id="link18"></a>
...
**Comment:** Presents a method for estimating luminosity functions, but applies it to quasars and not satellite galaxies or dwarfs. While luminosity function estimation is a relevant technique, the application is not to the satellite or dwarf galaxy context.
...
## 19. [A measurement of gas rotation in galaxy groups via the kinetic Sunyaev-Zeldovich effect](https://arxiv.org/abs/2603.14494) <a id="link19"></a>
...
**Comment:** This paper measures gas rotation in galaxy groups using the kinetic Sunyaev-Zeldovich effect. While it involves galaxy groups and satellite galaxies, the focus is on gas rotation and kSZ measurements in groups with masses much higher than dwarf galaxies (10^14 Msun). It does not directly address near-field cosmology, resolved star formation histories, quenching, or outflows in dwarfs. The relevance is borderline due to the mention of satellite galaxies and group dynamics, but the mass scale and focus are outside the core topics.
...
## 21. [Mapping Dark-Matter Clusters via Physics-Guided Diffusion Models](https://arxiv.org/abs/2603.14503) <a id="link21"></a>
...
**Comment:** This paper introduces a new automated method for reconstructing cluster surface mass density using diffusion models, with a large simulated dataset. While it is a numerical method for galaxy clusters, the focus is on mass reconstruction and cosmological surveys, not on galaxy simulations, near-field cosmology, or the other core topics.
...
## 23. [Parametrizing superfluid dark matter with rational approximations](https://arxiv.org/abs/2603.15053) <a id="link23"></a>
...
**Comment:** Investigates superfluid dark matter structure and core properties using a toy model. Discusses implications for dark matter core structure, which is tangentially related to core-cusp issues in near-field cosmology, but does not directly address dwarf galaxies or satellite systems.
...
## 24. [The Environments of Star-Forming Galaxies Detected in the SFACT Survey: Do Mergers and Interactions Drive the Star Formation?](https://arxiv.org/abs/2603.13656) <a id="link24"></a>
...
**Comment:** Examines star formation in galaxies and the role of mergers/interactions, but the sample is not specified as dwarf galaxies and focuses on general star-forming galaxies. Some relevance to star formation quenching, but not directly focused on dwarfs.
...
## 25. [Cosmic rays: constraints from future MeV detectors](https://arxiv.org/abs/2603.15266) <a id="link25"></a>
...
**Comment:** Reviews cosmic rays and their role in Galactic evolution, including launching outflows and star formation. Some relevance to star formation driven outflows and ISM/CGM processes, but not focused on dwarf galaxies or resolved star formation histories.
...
## 26. [Measuring impurity-induced shifts in Coulomb crystallization](https://arxiv.org/abs/2603.14980) <a id="link26"></a>
...
**Comment:** Paper discusses impurity effects in Coulomb crystallization relevant to stellar crystallization in white dwarfs and neutron stars. While it touches on stellar models and nucleosynthesis, it is not directly related to galaxy evolution, near-field cosmology, or resolved star formation histories.
...
## 28. [Nebular Phase Evolution of SN 2023ixf (I): From Circumstellar Infrared Echo to the onset of in-situ Dust Formation in a Type II Supernova](https://arxiv.org/abs/2603.14137) <a id="link28"></a>
...
**Comment:** Studies dust formation and circumstellar echo in a Type II supernova, focusing on dust signatures and evolution. While interesting for stellar evolution, does not present new stellar models or connect to galaxy-scale topics (no resolved star formation histories, no CGM, etc.).
...
## 29. [Exploring the surface of HD 189733 via Doppler shadow analysis of planetary transits](https://arxiv.org/abs/2603.13463) <a id="link29"></a>
...
**Comment:** The paper explores stellar surface heterogeneities via Doppler shadow analysis during planetary transits, focusing on stellar atmosphere models and line profile variations. While it involves stellar atmosphere modeling, it does not present new stellar models or evolutionary tracks, nor does it relate to dwarf galaxies or galaxy simulations.
...
## 30. [Cosmological peculiar velocities in general relativity](https://arxiv.org/abs/2603.14511) <a id="link30"></a>
...
**Comment:** Analysis of cosmological peculiar velocities and their treatment in general relativity. While it addresses galaxy kinematics, it does not focus on satellite galaxies, dwarf galaxies, or resolved star formation histories.
...
## 32. [Evidence for Atomic Absorption Features in the High Resolution X-ray Spectrum of the Neutron Star in Puppis A](https://arxiv.org/abs/2603.14146) <a id="link32"></a>
...
**Comment:** Presents evidence for atomic absorption features in the X-ray spectrum of a neutron star, with implications for stellar atmosphere models. While it involves model atmospheres, the focus is on neutron stars, not on new stellar evolutionary tracks or atmospheres for normal stars relevant to galaxy studies.
...
## 33. [The Steep-spectrum Radio-loud AGN Luminosity Function and Its Implications for Black Hole Growth and Star Formation](https://arxiv.org/abs/2603.15449) <a id="link33"></a>
...
**Comment:** This paper studies the radio luminosity function of AGNs and its implications for black hole growth and star formation. While it touches on cosmic star formation rate density, the focus is on radio-loud AGNs (not dwarf galaxies) and black hole accretion. The connection to resolved star formation histories or quenching is weak and indirect.
...
## 34. [Time-Series Photometric Detection and Physical Characterization of Variable Stars in Four Intermediate- to Old-Age Galactic Open Clusters](https://arxiv.org/abs/2603.13905) <a id="link34"></a>
...
**Comment:** The paper presents a time-series photometric study of variable stars in intermediate- to old-age open clusters, including color-magnitude diagram analysis and light-curve modeling. While it involves CMD analysis and stellar characterization, the focus is on open clusters rather than galaxies or their star formation histories. The work does not directly match the resolved star formation history criterion, as it is not applied to galaxies, nor does it present new stellar models.
...
## 35. [Formation and rising phase of a flux rope through data-constrained simulations](https://arxiv.org/abs/2603.13921) <a id="link35"></a>
...
**Comment:** The paper presents data-constrained magnetohydrodynamic simulations of solar eruptions, focusing on flux rope formation and Lorentz force effects. While it involves numerical simulations, it is not about galaxy simulations or any of the core topics such as dwarf galaxies or resolved star formation histories.
...
## 36. [Informational corrections to the early-Universe radiation sector: CET Omega, WIMP freeze-out, and implications for a possible 20 GeV gamma-ray excess](https://arxiv.org/abs/2603.15205) <a id="link36"></a>
...
**Comment:** This paper discusses informational corrections to the early-Universe radiation sector and implications for gamma-ray excesses, focusing on cosmological models and dark matter freeze-out. It does not directly relate to any of the core topics such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations.
...
## 37. [Wasserstein Distance in Cosmological Structure Formation: An Optimal Transport Perspective](https://arxiv.org/abs/2603.15342) <a id="link37"></a>
...
**Comment:** This paper introduces the Wasserstein distance as a new statistical tool for cosmological structure formation, focusing on large-scale structure and mass transport. While it is cosmology-related, it does not address near-field cosmology, galaxy simulations, or resolved star formation histories. The relevance is low.
...
## 38. [The ALMA-QUARKS Survey: Evidence of an Explosive Molecular Outflow in IRAS 15520--5234](https://arxiv.org/abs/2603.15040) <a id="link38"></a>
...
**Comment:** Study of explosive molecular outflows in a massive protocluster, focusing on protostellar outflows. While it discusses outflows, these are not star-formation-driven outflows from galaxies, and the focus is on massive protostars, not galaxies.
...
## 39. [Spatial analysis of PAH molecules in the Pillars of Creation using JWST](https://arxiv.org/abs/2603.15458) <a id="link39"></a>
...
**Comment:** Spatial analysis of PAH molecules in the Pillars of Creation, focusing on dust processing in star-forming regions. No direct connection to resolved star formation histories, quenching, or galaxy simulations; mainly ISM/dust physics.
...
## 40. [The TOLIMAN mission: A low-cost space telescope for high precision narrow-angle astrometry](https://arxiv.org/abs/2603.14683) <a id="link40"></a>
...
**Comment:** The TOLIMAN mission aims to detect terrestrial exoplanets via high-precision astrometry in the alpha Centauri system. While innovative, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The focus is on exoplanet detection and astrometry.
...
## 41. [Kinematical and dynamical properties of recently discovered bulge and disc star clusters with WINERED](https://arxiv.org/abs/2603.15450) <a id="link41"></a>
...
**Comment:** Spectroscopic analysis of newly discovered star clusters in the Milky Way, focusing on kinematics and dynamics. These are bulge and disc clusters, not dwarf satellites or extragalactic systems. No direct match to core criteria.
...
## 42. [The Bochum Survey of the Southern Galactic Disk: III. Complete Data Release](https://arxiv.org/abs/2603.13539) <a id="link42"></a>
...
**Comment:** Survey of the southern Galactic disk, providing light curves and photometry for variable stars. Focus is on the Galactic disk, not satellite or dwarf galaxies, so it is not relevant to near-field cosmology or resolved star formation histories.
...
## 43. [Investigating the Temporal Evolution of Gamma-Ray Burst Central Engine Parameters Based on Numerical Simulations](https://arxiv.org/abs/2603.15028) <a id="link43"></a>
...
**Comment:** Numerical simulations of gamma-ray burst central engines, focusing on black hole accretion and jet properties. While it uses numerical simulations, it is not about galaxy simulations or relevant galaxy-scale phenomena.
...
## 44. [Mapping of the Cold Neutral Medium via HI Phase Separation in an Atomic Cloud Undergoing Molecular Cloud Formation](https://arxiv.org/abs/2603.14967) <a id="link44"></a>
...
**Comment:** Investigates the cold neutral medium and atomic-to-molecular gas transition in a molecular formation cloud, focusing on ISM structure and turbulence. No direct connection to core topics such as dwarf galaxies, resolved star formation histories, quenching, or galaxy simulations.
...
## 45. [Dark Matter Induced Scalarization as a Possible Solution to the Hyperon Puzzle](https://arxiv.org/abs/2603.14731) <a id="link45"></a>
...
**Comment:** The paper investigates neutron star properties with a massive scalar field as dark matter, focusing on the hyperon puzzle. While it is astrophysics and discusses dark matter, it does not match any of the core topics (no connection to dwarf galaxies, galaxy simulations, or stellar models).
...
## 46. [Rotation Curve of the Milky Way](https://arxiv.org/abs/2603.14114) <a id="link46"></a>
...
**Comment:** Investigates the rotation curve of the Milky Way, focusing on the stellar disk, bulge/bar, and dark matter halo. While it touches on dark matter halo modeling, the focus is on the inner Galaxy and disk/bar structure, which is specifically listed as irrelevant.
...
## 47. [CIV wind properties of the SDSS-V X-ray selected quasars: strong optical-to-UV emission is key regardless of X-ray strength](https://arxiv.org/abs/2603.15075) <a id="link47"></a>
...
**Comment:** The paper investigates CIV wind properties in quasars, focusing on accretion disk winds and their optical/UV/X-ray properties. While it discusses outflows, these are AGN-driven and not star-formation-driven, and the study is on quasars (not dwarf galaxies or galaxy-scale outflows). No direct match to any core criteria.
...
## 48. [Cosmological angular momentum from quantum rotation](https://arxiv.org/abs/2603.14814) <a id="link48"></a>
...
**Comment:** Proposes a new mechanism for cosmic angular momentum from quantum fluctuations during inflation, with implications for primordial black hole spin. Does not match any core criteria (no galaxy simulations, no star formation history, no CGM, etc.).
...
## 49. [A Hybrid Framework for Kilonova Anomaly Detection using Single-Epoch SEDs from the 7-Dimensional Telescope](https://arxiv.org/abs/2603.13814) <a id="link49"></a>
...
**Comment:** Develops a hybrid framework for kilonova anomaly detection using single-epoch SEDs, relevant for transient classification. Does not match any core criteria (no galaxy simulations, no star formation history, no CGM, etc.).
...
## 50. [iDaVIE v1.0: A virtual reality tool for interactive analysis of astronomical data cubes](https://arxiv.org/abs/2603.15490) <a id="link50"></a>
...
**Comment:** This paper presents a virtual reality tool for interactive analysis of astronomical data cubes. While it is a useful software for data visualization, it does not directly address any of the core scientific criteria.
...
## 51. [An extreme particle accelerator powered by PSR J1849-0001](https://arxiv.org/abs/2603.15537) <a id="link51"></a>

**ArXiv ID:** 2603.15537

**Authors:** The LHAASO Collaboration

**Abstract:** Pulsar wind nebulae (PWNe) are bubbles of relativistic particles, powered by the rotational energy loss of the central pulsars. The Crab Nebula, powered by the Milky Way's most energetic pulsar, was discovered by the Large High Altitude Air Shower Observatory (LHAASO) as a PeV gamma-ray emitter, thereby establishing it as an extreme particle accelerator along with multiwavelength observations. Here we report LHAASO's detection of a point-like ultrahigh-energy (UHE, photon energy $E>100\,$TeV) gamma-ray source associated with the PWN powered by PSR~J1849-0001, a pulsar of spindown power 50 times lower than the Crab pulsar. The measured gamma-ray spectrum extends to PeV energies following a power-law distribution, with the PeV luminosity a few times higher than that of the Crab Nebula. Combined X-ray observations constrain the average magnetic field within the PWN to about $3\mu\,$G, and reveal an extreme particle acceleration efficiency approaching or even exceeding unity. The result challenges the particle acceleration theory in PWN and implies non-ideal magnetohydrodynamics (MHD) conditions within the accelerator, potentially involving magnetic reconnection upstream of the termination shock.

**Comment:** This paper discusses extreme particle acceleration in a pulsar wind nebula, focusing on gamma-ray emission and magnetohydrodynamics. It does not match any of the core criteria related to galaxy evolution, star formation, or stellar models.
...
## 52. [Multi-Field Dilaton Screening Beyond the Thin-Shell Mechanism](https://arxiv.org/abs/2603.13986) <a id="link52"></a>
...
**Comment:** This paper analyzes screening mechanisms in multi-field scalar-tensor theories, focusing on dilaton and axion fields. It does not match any of the core criteria related to galaxy evolution, star formation, or stellar models.
...
## 53. [Smoking-gun signatures of bounce cosmology from echoes of relic gravitational waves](https://arxiv.org/abs/2603.13924) <a id="link53"></a>
...
**Comment:** Paper focuses on bounce cosmology and relic gravitational waves, which is unrelated to near-field cosmology, galaxy evolution, or stellar models.
...
## 54. [A user-friendly package and workflow for generating effective homogeneous rheologies for the study of the long-term orbital evolution of multilayered planetary bodies](https://arxiv.org/abs/2603.14444) <a id="link54"></a>
...
**Comment:** Presents a package for generating effective homogeneous rheologies for multilayered planetary bodies, with application to lunar interior models. This is relevant to planetary science and tidal evolution, not galaxy evolution or stellar models.
...
## 55. [Quantum Signatures of Cosmic Topology: How Casimir Backreaction Transmits Isotropy Violation](https://arxiv.org/abs/2603.12319) <a id="link55"></a>
...
**Comment:** Quantum signatures of cosmic topology and Casimir backreaction in cosmology. This is a fundamental cosmology paper, but does not relate to near-field cosmology, galaxy simulations, or any of the other core topics.
...
## 56. [Projected Sensitivity of Paleo-Detectors to Dark Matter Effective Interactions with Nuclei](https://arxiv.org/abs/2603.13629) <a id="link56"></a>
...
**Comment:** This paper discusses paleo-detectors for direct detection of dark matter via nuclear recoils in minerals. It is not related to near-field cosmology, galaxy simulations, or any of the other core topics.
...
## 57. [A New Catalogue of Galactic Red Supergiants for direct detection of episodic mass-loss events](https://arxiv.org/abs/2603.15133) <a id="link57"></a>
...
**Comment:** Presents a catalogue of Galactic Red Supergiants for monitoring mass-loss events. Focus is on massive stars in the Milky Way, not on dwarf galaxies, star formation histories, or galaxy simulations. No direct relevance to core criteria.
...
## 58. [Energy transfer from jets to surrounding matter to form lateral lobes in SS433/W50](https://arxiv.org/abs/2603.14399) <a id="link58"></a>
...
**Comment:** Investigates energy transfer from jets to surrounding matter in the SS433/W50 system, focusing on jet interactions and lobe formation. While it discusses outflows, these are AGN/jet-driven and not star-formation-driven outflows in galaxies, nor does it focus on dwarf galaxies.
...
## 60. [Probing the potential high-energy messengers of the anticipated T Coronae Borealis outburst](https://arxiv.org/abs/2603.15570) <a id="link60"></a>
...
**Comment:** Focuses on particle acceleration and high-energy emission in a nova system (T CrB), using hydrodynamical simulations. Does not match any core criteria (no galaxy simulations, no star formation history, no CGM, etc.).
...
## 61. [The JWST Early Release Science Program for Direct Observations of Exoplanetary Systems. VIII. Molecular Mapping Performance with JWST/MIRI MRS: VHS 1256 b as a case study](https://arxiv.org/abs/2603.13543) <a id="link61"></a>
...
**Comment:** Focuses on exoplanet atmosphere characterization using JWST/MIRI, with molecular mapping and spectral analysis. Does not match any core criteria (no stellar models, no galaxy simulations, no star formation history, etc.).
...
## 62. [Primordial non-Gaussianity constraints on dissipative inflation](https://arxiv.org/abs/2603.13473) <a id="link62"></a>
...
**Comment:** Constrains dissipative inflation models using primordial non-Gaussianity and CMB data. No direct connection to any core criteria (no galaxy simulations, no star formation history, no CGM, etc.).
...
## 64. [Evolution of wide O star binaries through their LBV stage. Population synthesis with mass-ejection-driven orbital evolution](https://arxiv.org/abs/2603.14840) <a id="link64"></a>
...
**Comment:** The paper discusses the evolution of wide O star binaries and their implications for Wolf-Rayet stars and gravitational-wave sources. While it involves population synthesis and binary evolution, it does not focus on dwarf galaxies, resolved star formation histories, or numerical galaxy simulations relevant to the core topics.
...
## 65. [SIMTERFERE: An optical interferometry simulator for quantifying the coherent flux stability of VLTI/GRAVITY+. Reaching per mill stability: Application to exoplanet spectroscopy](https://arxiv.org/abs/2603.15499) <a id="link65"></a>
...
**Comment:** This paper describes an optical interferometry simulator for exoplanet spectroscopy, focusing on instrument stability and exoplanet characterization. It does not match any of the core topics such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations.
...
## 66. [A numerical framework for Newtonian-noise estimation at the Einstein Telescope: 2-D simulations beyond the plane-wave approximation](https://arxiv.org/abs/2603.15424) <a id="link66"></a>
...
**Comment:** This paper presents a numerical framework for Newtonian-noise estimation for gravitational wave observatories, focusing on seismic modeling. It does not match any of the core criteria related to galaxy evolution, star formation, or stellar models.
...
## 67. [IRAM 04191+1522: a compact proto-brown dwarf binary candidate](https://arxiv.org/abs/2603.15274) <a id="link67"></a>
...
**Comment:** This paper studies a proto-brown dwarf binary candidate in a star-forming region, focusing on multiplicity and formation mechanisms. It does not match any of the core criteria related to galaxy evolution, star formation histories, or stellar models.
...
## 68. [Mass Production of 2023 KMTNet Microlensing Planets. II: Two Planets and A Brown Dwarf](https://arxiv.org/abs/2603.13887) <a id="link68"></a>
...
**Comment:** This paper analyzes microlensing planets and brown dwarfs, focusing on planetary mass ratios and light-curve modeling. It does not match any of the core criteria related to galaxy evolution, star formation, or stellar models.
...
## 70. [Quasi-Periodic Fast-Mode Wave Trains Associated with the 2015-Jun-22 M6.5 Flare in AR~12371: Observations and 3D MHD Modeling](https://arxiv.org/abs/2603.13456) <a id="link70"></a>
...
**Comment:** Observational and 3D MHD modeling of quasi-periodic fast-mode wave trains in the solar corona. Focus is on solar physics, not galaxy evolution, star formation, or stellar models.
...
## 71. [Probing Gravitational-Wave Four-Point Correlators](https://arxiv.org/abs/2603.15514) <a id="link71"></a>
...
**Comment:** Studies non-Gaussian features in the stochastic gravitational-wave background, focusing on early-Universe physics and dark-sector dynamics. No direct connection to galaxy simulations, near-field cosmology, or other core criteria.
...
## 72. [Discovery of a millisecond pulsar with a CO white dwarf companion](https://arxiv.org/abs/2603.13815) <a id="link72"></a>
...
**Comment:** Discovery and characterization of a millisecond pulsar with a white dwarf companion; focuses on binary evolution and Galactic structure, not on any of the core topics (no connection to dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 73. [Critical slowing down and bulk viscosity in binary neutron star mergers](https://arxiv.org/abs/2603.13474) <a id="link73"></a>
...
**Comment:** This paper focuses on hydrodynamic simulations of neutron star mergers and the role of QCD critical points in bulk viscosity. While it is astrophysics, it does not match any of the core topics such as near-field cosmology, galaxy simulations, or stellar models. It is unrelated to dwarf galaxies, star formation histories, or galaxy-scale processes.
...
## 74. [Calibrating spectral siren cosmology with synthetic catalogs of binary black hole mergers](https://arxiv.org/abs/2603.15332) <a id="link74"></a>
...
**Comment:** Calibrating spectral siren cosmology with binary black hole mergers. The focus is on cosmological inference using gravitational waves, not on galaxy simulations, near-field cosmology, or any of the other core topics.
...
## 75. [Compact and Physically Interpretable Feature Models for Photometric Type Ia Supernova Classification](https://arxiv.org/abs/2603.14500) <a id="link75"></a>
...
**Comment:** Focuses on photometric classification of Type Ia supernovae, which is not directly related to any of the core topics (no connection to resolved star formation histories, galaxy simulations, or dwarf galaxies).
...
## 76. [QCD-driven dark matter: AQNs formation and observational tests](https://arxiv.org/abs/2603.15585) <a id="link76"></a>
...
**Comment:** This paper discusses a QCD-driven dark matter scenario (AQNs) and its observational tests. While it is cosmology-related, it does not focus on galaxy-scale phenomena, satellite galaxies, star formation histories, quenching, or outflows. The relevance is low as it does not match any specific criteria.
...
## 77. [Distinguishing Kilonovae from Binary Neutron Star and Neutron Star-Black Hole Mergers](https://arxiv.org/abs/2603.13484) <a id="link77"></a>
...
**Comment:** This paper focuses on distinguishing kilonovae from binary neutron star and neutron star-black hole mergers using light curve modeling. While it involves semi-analytic models and simulated populations, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The focus is on transient classification rather than galaxy evolution or structure.
...
## 78. [Non-parametric estimation of the baryon gas fraction and the cosmological bias with clusters](https://arxiv.org/abs/2603.13763) <a id="link78"></a>
...
**Comment:** Focuses on baryon gas fraction in galaxy clusters, which are massive halos and not dwarf galaxies or satellites. Does not match any core criteria (near-field cosmology, resolved star formation histories, etc.).
...
## 79. [Implications of a Cosmogenic Origin of KM3-230213A for Ultra-High-Energy Protons](https://arxiv.org/abs/2603.13476) <a id="link79"></a>
...
**Comment:** Discusses constraints on ultra-high-energy protons and cosmic rays from a neutrino event, focusing on AGN and UHECR sources. No direct connection to any core criteria (no galaxy simulations, no dwarf galaxies, no star formation history, etc.).
...
## 80. [When One-Parameter Dark Energy Makes Neutrinos Physical Again](https://arxiv.org/abs/2603.15422) <a id="link80"></a>
...
**Comment:** Examines dark energy models and their impact on neutrino mass constraints, with cosmological parameter inference. No direct connection to any core criteria (no galaxy simulations, no star formation history, no CGM, etc.).
...
## 81. [A modest change in magnetic braking at the fully convective boundary explains cataclysmic variable evolution](https://arxiv.org/abs/2603.14560) <a id="link81"></a>
...
**Comment:** This paper focuses on cataclysmic variable evolution and magnetic braking, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models for evolutionary tracks. It deals with binary evolution and stellar dynamo models, but not in the context of dwarf galaxies or galaxy simulations.
...
## 82. [Do We Have Sufficient Knowledge of the Galactic Foreground Emission in Cosmic Microwave Background Science?](https://arxiv.org/abs/2603.14287) <a id="link82"></a>
...
**Comment:** The paper focuses on Galactic foreground emission modeling for CMB science, which is not directly related to any of the core topics such as dwarf galaxies, resolved star formation histories, or numerical galaxy simulations. It deals with Galactic dust and emission complexity, but not in the context of the relevant criteria.
...
## 83. [The eclipsing novalike cataclysmic variable CRTS SSS100505 J093417-174421](https://arxiv.org/abs/2603.14394) <a id="link83"></a>
...
**Comment:** The paper studies an eclipsing novalike cataclysmic variable, focusing on accretion disk structure and binary parameters. It does not match any of the core topics such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations.
...
## 84. [The Historical Lightcurve of the R Coronae Borealis Star, V854 Cen, from 1890 to 2026](https://arxiv.org/abs/2603.14085) <a id="link84"></a>
...
**Comment:** This paper presents the historical lightcurve of an R Coronae Borealis star, focusing on dust-induced variability. It does not match any of the core criteria related to galaxy evolution, star formation, or stellar models.
...
## 85. [Comparative analysis of BL Lacertae in flaring and non-flaring states: timing and spectral studies](https://arxiv.org/abs/2603.14036) <a id="link85"></a>
...
**Comment:** Study of BL Lacertae, a blazar, focusing on spectral and timing properties. No connection to dwarf galaxies, star formation histories, or galaxy simulations.
...
## 86. [CosmoDS: A Python toolkit for constraining cosmological models via dynamical systems analysis with Cobaya](https://arxiv.org/abs/2603.14740) <a id="link86"></a>
...
**Comment:** Describes a Python toolkit for dynamical systems analysis of cosmological models, mainly at the background level. No direct connection to galaxy simulations, near-field cosmology, or any other core criteria.
...
## 87. [Blackbody Quasar and Radio Source (BBQSORS): A Candidate of Transitional Little Red Dots with a $T\sim10^4\ K$ Blackbody Spectrum](https://arxiv.org/abs/2603.13736) <a id="link87"></a>
...
**Comment:** Reports on a radio-loud quasar with a blackbody spectrum, discussing transitional phases and spectral features. Focus is on AGN and SMBH phenomena, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 88. [Dynamics of the Upwind Heliosphere Due to Data-Driven, Solar Wind and Magnetic Field Variations and Implications for Wave Propagation into the Very Local Interstellar Medium](https://arxiv.org/abs/2603.14714) <a id="link88"></a>
...
**Comment:** Studies the heliosphere and solar wind interactions with the interstellar medium, which is not related to any of the core topics (no connection to galaxy simulations, dwarf galaxies, or star formation histories).
...
## 89. [Hidden Connections: Tracing the BCG Stellar Mass-Halo Mass Relation in the SDSS-GalWCat19 Cluster Catalog](https://arxiv.org/abs/2603.14330) <a id="link89"></a>
...
**Comment:** Analyzes the stellar mass-halo mass relation for brightest cluster galaxies (BCGs) in massive clusters, which is outside the scope of dwarf galaxies and near-field cosmology.
...
## 91. [Cosmic ray mass composition measurement in the energy range from $10^{16.5}$ eV to $10^{18.5}$ eV observed with the TALE hybrid detector](https://arxiv.org/abs/2603.14804) <a id="link91"></a>
...
**Comment:** This paper focuses on cosmic ray mass composition and the transition from Galactic to extragalactic cosmic ray sources. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. The focus is on high-energy cosmic rays, not galaxies or their evolution.
...
## 92. [Background-level reconstruction of scalar-field potentials from dark-energy histories and comparison with analytic potential families](https://arxiv.org/abs/2603.14693) <a id="link92"></a>
...
**Comment:** Presents a method for reconstructing scalar-field potentials from dark-energy histories, which is cosmology-focused and not related to near-field cosmology, galaxy simulations, or any other core topic.
...
## 93. [Searching for Unparticles with the Cosmic Microwave Background](https://arxiv.org/abs/2603.13486) <a id="link93"></a>

**ArXiv ID:** 2603.13486

**Authors:** Oliver H. E. Philcox, Guilherme L. Pimentel, Chen Yang

**Abstract:** Multi-field models of inflation typically assume that interactions between particles can be treated perturbatively. Strongly-coupled models provide an intriguing alternative and may offer novel inflationary phenomenology. We study the "unparticle" scenario, where the inflaton is weakly mixed with a strongly-coupled sector, specified by a (gapless) conformal field theory. For certain choices of conformal scaling dimension, $\Delta$, the exchange of unparticles leads to distinctive non-Gaussian features in the primordial curvature distribution, including bispectra with enhanced squeezed limits and oscillations close to the equilateral regime. Efficiently analyzing these models using Cosmic Microwave Background (CMB) data is a challenge since the shapes are non-factorizable in momenta and often highly degenerate with single-field self-interactions. Here, we overcome these limitations using a library of tools, including neural-network factorization schemes and optimal CMB estimators. Our pipeline condenses 161 non-separable templates into just 7 factorizable forms, with negligible loss of signal-to-noise. We apply the model to the \textit{Planck} data, asking two key questions: (1) can we detect unparticles? (2) can we distinguish them from single-field self-interactions? Across $1\leq \Delta\leq 9$, we find a maximal signal-to-noise of $1.2\sigma$, implying no evidence for new physics. We also place the first CMB constraints on the modified consistency-condition-satisfying orthogonal bispectrum with $f^{\rm orth^*}_{\rm NL} = -12\pm12$. While many unparticle models are degenerate with single-field shapes, values of $\Delta$ close to half-integers have very different shapes, offering an intriguing future discovery channel. The methods developed herein can be directly applied to other classes of templates, motivating the exploration of models beyond the standard weakly-coupled paradigm.

**Comment:** Studies unparticle models in inflation and their signatures in the CMB. Purely cosmological and unrelated to any of the core topics (no connection to near-field cosmology, galaxy simulations, star formation histories, quenching, stellar models, outflows, or CGM).
...
## 94. [The extinction distances for over a thousand planetary nebulae with Gaia measurements](https://arxiv.org/abs/2603.15139) <a id="link94"></a>
...
**Comment:** Presents extinction distances for planetary nebulae using Gaia, which is not related to any of the core topics (no connection to galaxy simulations, star formation histories, or dwarf galaxies).
...
## 95. [The Eccentric Disk Model for Superhumps](https://arxiv.org/abs/2603.14083) <a id="link95"></a>
...
**Comment:** Discusses the disk instability model for superhumps in binary systems, focusing on accretion disk dynamics. No connection to any of the core criteria such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, or outflows.
...
## 96. [Constraining Spin and Inclination Angle of XTE J2012+381 using AstroSat and NICER](https://arxiv.org/abs/2603.14834) <a id="link96"></a>
...
**Comment:** Spectral analysis of a black hole X-ray binary, focusing on spin and inclination. This is not related to any of the core topics (no connection to dwarf galaxies, star formation histories, galaxy simulations, or stellar models).
...
## 97. [Ultra-compact X-ray Binaries: A Review](https://arxiv.org/abs/2603.13813) <a id="link97"></a>
...
**Comment:** Review of ultra-compact X-ray binaries, focusing on binary evolution and gravitational wave sources, not on galaxy-scale processes or dwarf galaxies.
...
## 98. [Pulsar timing arrays: the emerging gravitational-wave landscape](https://arxiv.org/abs/2603.13643) <a id="link98"></a>
...
**Comment:** This is a review of pulsar timing arrays and gravitational wave backgrounds, with some mention of supermassive black hole binaries and new physics. It does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 99. [Reconnection-driven State Transitions in Flat Spectrum Radio Quasars](https://arxiv.org/abs/2603.14305) <a id="link99"></a>
...
**Comment:** Focuses on blazar variability and jet physics in flat spectrum radio quasars, which is unrelated to any of the core topics (no connection to dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 100. [Do the sources of the 511 keV excess explain the anomalous CMZ ionization?](https://arxiv.org/abs/2603.15114) <a id="link100"></a>
...
**Comment:** This paper investigates the sources of the 511 keV excess and their role in ionization in the Central Molecular Zone (CMZ). The focus is on the Galactic center, which is explicitly listed as irrelevant in the criteria.
...
## 101. [Can cyanide radicals drive molecular backbone growth on interstellar icy grains?](https://arxiv.org/abs/2603.15138) <a id="link101"></a>
...
**Comment:** Investigates molecular chemistry on interstellar grains, which is not related to any of the core topics (no connection to galaxy simulations, star formation histories, or dwarf galaxies).
...
## 103. [Lagrangian Identity and Mass Evolution of Particle-like Objects in Nonminimally Coupled Gravity](https://arxiv.org/abs/2603.13408) <a id="link103"></a>
...
**Comment:** Discusses the mass evolution of cosmic string loops and p-branes in nonminimally coupled gravity, which is not related to galaxy-scale processes or any of the core topics.
...
## 104. [Inflation without an Inflaton III: non-Gaussian signatures](https://arxiv.org/abs/2603.15036) <a id="link104"></a>
...
**Comment:** The paper investigates primordial non-Gaussianity in a specific inflationary scenario. It is purely theoretical cosmology and does not relate to any of the core topics such as near-field cosmology, galaxy simulations, or stellar models. No relevant criteria are matched.
...
## 105. [Born-Infeld AdS Black Holes Surrounded by Perfect Fluid Dark Matter](https://arxiv.org/abs/2603.14159) <a id="link105"></a>
...
**Comment:** This paper presents new black hole solutions in the context of Einstein Lambda gravity, including effects of perfect fluid dark matter and Born-Infeld electrodynamics. The focus is on black hole thermodynamics and orbital structure, not on galaxy evolution, near-field cosmology, or stellar models. No relevant criteria are matched.
...
## 106. [The Effect of "Roll-Drift" in ACS/WFC Images](https://arxiv.org/abs/2603.15454) <a id="link106"></a>
...
**Comment:** Paper investigates roll-drift effects in HST ACS/WFC images, focusing on data quality and reduction. No connection to galaxy evolution, star formation histories, or stellar models.
...
## 107. [ANNA: a toolbox for Newtonian Noise Analysis](https://arxiv.org/abs/2603.15157) <a id="link107"></a>
...
**Comment:** Presents a toolbox for Newtonian noise analysis in gravitational wave observatories, focusing on seismic coupling. No connection to galaxy simulations, near-field cosmology, or other core criteria.
...
## 108. [Dust traps and gas kinematic signatures in a crescent structure of a planet-forming disk](https://arxiv.org/abs/2603.13510) <a id="link108"></a>
...
**Comment:** Focuses on planet-forming disks and dust traps, which is unrelated to any of the core topics (no connection to near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations).
...
## 109. [Dark Matter Search with the DEAP-3600 Detector using the Profile Likelihood Ratio Method](https://arxiv.org/abs/2603.13965) <a id="link109"></a>
...
**Comment:** This paper presents a search for WIMP dark matter using the DEAP-3600 detector. It is focused on particle physics and direct detection experiments, not on galaxy-scale astrophysics, near-field cosmology, or any of the core topics listed. No relevant criteria are matched.
...
## 110. [Combining data and metadata: hybrid tabular file formats](https://arxiv.org/abs/2603.15104) <a id="link110"></a>
...
**Comment:** Discusses hybrid file formats for astronomical data and metadata. No connection to any of the core scientific criteria.
...
## 111. [Ultralight Dark Matter: Undergraduate Physics in Modern Cosmology](https://arxiv.org/abs/2603.13451) <a id="link111"></a>
...
**Comment:** This is an educational paper about ultralight dark matter, presenting exercises for undergraduate physics. It does not match any of the core topics.
