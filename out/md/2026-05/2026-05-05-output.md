...
1. [NEFERTITI: Linking early galaxy formation to the assembly of the Milky Way](#user-content-link1)
**Authors:** Ioanna Koutsouridou, Stefania Salvadori, \'Asa Sk\'ulad\'ottir, Viola Gelli, Elka Rusta, Lapo Querci, David S. Aguado, Alice Mori

2. [Merge and Strip II: Imprint of galaxy formation physics and viscosity on baryon-dominated dwarf galaxies](#user-content-link2)
**Authors:** Anna Ivleva, Klaus Dolag, Rhea-Silvia Remus, Duncan A. Forbes, Tirso Marin-Gilabert

3. [Tidal pre-conditioning and ram-pressure stripping in NGC 1427A. Deep VLT/MUSE spectroscopy and FUV-to-radio observations trace a Fornax Cluster dwarf in transformation](#user-content-link3)
**Authors:** J. P. Carvajal, T. H. Puzia, M. Bla\~na, P. K. Nayak, K. Fahrion, M. Hilker, E. Emsellem, E. D. Skillman, M. D. Mora, B. Miller, Y. Ordenes-Brice\~no, P. Eigenthaler, R. Rahatgaonkar, J. Chanam\'e

4. [Non-Equilibrium Ionisation in Photoionised Haloes: Implications for Shock Stability and Absorption-Line Signatures](#user-content-link4)
**Authors:** Itai Bromberg, Kartick C. Sarkar, Orly Gnat, Yuval Birnboim

5. [A Virgo Environmental Survey Tracing Ionised Gas Emission (VESTIGE). XXI. Statistical properties of individual HII regions in perturbed galaxies](#user-content-link5)
**Authors:** A. Boselli, M. Fossati, Y. Roehlly, M. Boquien, J. Braine, P. Cote, J. C. Cuillandre, B. Epinat, L. Ferrarese, S. Gwyn, G. Hensler

6. [Galaxy luminosity functions from far-UV to submillimetre at $z=0$ in the COLIBRE simulations](#user-content-link6)
**Authors:** Shengdong Lu, Carlos S. Frenk, Cedric G. Lacey, Andrea Gebek, Joop Schaye, Shaun Cole, Sownak Bose, Nick Andreadis, Maarten Baes, Alejandro Ben\'itez-Llambay, Evgenii Chaikin, Robert A. Crain, Anna Durrant, Filip Hu\v{s}ko, Sylvia Ploeckinger, Alexander J. Richings, Matthieu Schaller, James W. Trayford

7. [A structural degeneracy explains reionization tensions and limits dark matter constraints](#user-content-link7)
**Authors:** Zihan Wang, Huanyuan Shan

8. [The chemical fingerprint of the Gaia BH3 system. Evidence for early cluster enrichment from the analysis of 51 elements](#user-content-link8)
...
9. [The complex history of NGC 1427A revealed by its star clusters and star formation history](#user-content-link9)
**Authors:** Katja Fahrion, Michael Hilker, Avinash Chaturvedi, Juan P. Carvajal, Thomas H. Puzia

10. [Resolving the Unresolved Galactic Winds in Multi-phase Models. I. Methodology and Application](#user-content-link10)
**Authors:** Xinfeng Xu (Northwestern University, USA, CIERA, USA), Drummond Fielding (Cornell University, USA, New York University, USA), Timothy Heckman (Johns Hopkins University, USA, Arizona State University, USA), Greg L. Bryan (Columbia University, USA, Flatiron Institute, USA), Alaina Henry (Space Telescope Science Institute, USA), Karla Z. Arellano-Cordova (University of Edinburgh, UK), Cody Carr (Zhejiang University, China, Institute of Astronomy, Zhejiang University, China), John Chisholm (University of Texas at Austin, USA), Claude-Andre Faucher-Giguere (Northwestern University, USA, CIERA, USA), Matthew Hayes (Stockholm University, Sweden), Mason Huberty (University of Minnesota, USA), Michael Jennings (Johns Hopkins University, USA), Crystal L. Martin (University of California, Santa Barbara, USA), Claudia Scarlata (University of Minnesota, USA), Allison L. Strom (Northwestern University, USA, CIERA, USA)

11. [Cross-Comparison of Galaxies Detected in the CSST Spectroscopic Survey and the SKA HI Survey](#user-content-link11)
**Authors:** Yingfeng Liu, Furen Deng, Wenxiang Pei, Haitao Miao, Qi Xiong, Shuanghao Shu, Xingchen Zhou, Qi Guo, Yan Gong, Yougang Wang, Xuelei Chen

12. [Low-luminosity Wolf-Rayet stars: a model-data comparison](#user-content-link12)
**Authors:** Siyu Wu, Zhi Li, Yan Li

13. [Series solutions to the TOV equations](#user-content-link13)
**Authors:** Paulo Luz

14. [Constraints on Halo Gas Profiles from Joint kSZ and Galaxy Clustering Analysis of ACT DR6 and CMASS](#user-content-link14)
**Authors:** Shaohong Li, Yi Zheng

15. [Baryons in the Darkest Sites of the Universe](#user-content-link15)
...
16. [Fragmentation in the Serpens/Aquila Star-forming Region](#user-content-link16)
**Authors:** Samuel Fielder, Helen Kirk, Michael Dunham, Stella Offner

17. [Using Ly$\alpha$ Transmitted Spectrum to Probe IGM Transmission and Identify Ionized Structures in Cosmic Reionization](#user-content-link17)
...
18. [CHANG-ES XXXIX. Magnetic field structure in edge-on galaxies: Stacking Stokes parameters](#user-content-link18)
**Authors:** M. Stein, R. Beck, B. Adebahr, R. -J. Dettmar, C. Mele, S. Taziaux, P. Kamphuis, J. English, T. Wiegert, J. Stil, V. Heesen, C. Riseley, J. Irwin, N. B. Skeggs, R. Henriksen

19. [A Comprehensive Study of Morphology and Kinematics in Extended Nebulae Around UV Luminous Quasars at $z\approx1$](#user-content-link19)
**Authors:** Zhuoqi Liu, Sean D. Johnson, Eric F. Bell, Zhijie Qu, Beno\^it Epinat, Hsiao-Wen Chen, Marc Rafelski, Jennifer I-Hsiu Li, Alexander Beckett, Mandy C. Chen, Sayak Dutta, David DePalma, Gwen C. Rudie, Joop Schaye, Patrick Petitjean, Sebastiano Cantalupo, Elise Fuller, Wolfram Kollatschny, Sebasti\'an L\'opez, Nishant Mishra, Sowgat Muzahid, Andrea Travascio, Fakhri S. Zahedy

20. [Validating z > 7.5 Lyman Break Galaxy candidates in the COSMOS field with JWST/PASSAGE](#user-content-link20)
...
21. [JWST high-contrast spectroscopy with speckle modelling: Atmospheric retrievals of the T dwarf companion HD 19467 B](#user-content-link21)
**Authors:** Dar\'io Gonz\'alez Picos, Tessa van der Post, Sam de Regt, Jean-Baptiste Ruffio, Natalie Grasser, Ignas Snellen

22. [Stellar mass and morphology segregation in pairs and multiplets in the cosmic web](#user-content-link22)
**Authors:** G. Torres-R\'ios, S. Verley, I. P\'erez, M. Argudo-Fern\'andez, B. Bidaran, S. Duarte Puertas, Y. K. Gonz\'alez-Koda

23. [Formation and Redshift Evolution of Dark Matter Spikes](#user-content-link23)
**Authors:** Gonzalo Herrera, Abdelaziz Hussein, Lina Necib, Elliot Y. Davies, Xuejian Shen

24. [Tracing Primordial Gravitational Waves via non-Gaussian Signatures of Halo Bias](#user-content-link24)
**Authors:** Mariam Abdelaziz, Pritha Bari, Sabino Matarrese, Angelo Ricciardone

25. [Prospects for Observing Galaxy Spectral Energy Distribution from the Radio to the far-Infrared in the Era of Next-Generation Radio Telescopes](#user-content-link25)
**Authors:** Ilsang Yoon, Jonathan Letai, Hansung B. Gim, Eric F. Jim\'enez-Andrade, Intae Jung, Caitlin Casey, Eric J. Murphy, Min S. Yun

26. [Implications of \textit{SARAS3} data for Coulomb-like interacting dark matter](#user-content-link26)
**Authors:** Shikhar Mittal, Prakhar Bansal, Harry Bevins, Saurabh Singh

27. [A Search for Variability of Ultracool Dwarfs with the Zwicky Transient Facility](#user-content-link27)
**Authors:** Haomiao Huang, Shu Wang, Xiaodian Chen, Zhijun Tu, Jifeng Liu

28. [Constraints for Nuclear Astrophysics from an Unusual Presolar Silicate-Oxide Aggregate Grain Found in Primitive Ordinary Chondrite Meteorite Hills 00526](#user-content-link28)
**Authors:** Larry R. Nittler, Jens Barosch, Conel M. O'D. Alexander, Jianhua Wang

29. [The Impact of the Magnetised Cosmic Web on Ultra High Energy Cosmic Ray Propagation](#user-content-link29)
**Authors:** Allegra Firinu, Franco Vazza, Carmelo Evoli

30. [Black Hole Supernovae Outcomes Across a Wide Progenitor Range](#user-content-link30)
**Authors:** Oliver Eggenberger Andersen, Evan O'Connor, Liubov Kovalenko, Haakon Andresen, Sean M. Couch

31. [Chemistry and Isotope Ratios of Substellar Atmospheres in the $\beta$ Pictoris Young Moving Group](#user-content-link31)
...
32. [Type Ib Supernovae are bluer than Type Ic Supernovae](#user-content-link32)
**Authors:** Harim Jin, Selma E. de Mink, Sebastian Holzner, Jakub Klencki, G\'eza Cs\"ornyei, Sung-Chul Yoon, Iair Arcavi, Wolfgang E. Kerzendorf

33. [Constraints on the baryon density from fast radio bursts using a non-parametric reconstruction of the Hubble parameter](#user-content-link33)
**Authors:** L\'azaro L. Sales, Klecio E. L. de Farias, Amilcar R. Queiroz, Rafael A. Batista, Bruno W. Ribeiro, Raiff H. Santos

34. [Coverage is not enough: Frequentist tests of simulation-based inference for primordial non-Gaussianity](#user-content-link34)
**Authors:** Toka Alokda, Cristiano Porciani, Alexander Eggemeier

35. [Neural Posterior Estimation for UHECR source inference from 3D propagation simulations](#user-content-link35)
**Authors:** Nadine Bourriche, Francesca Capel, Nicole Hartmann

36. [A Coordinate System for Dynamical Instabilities in Hierarchical Systems in REBOUND](#user-content-link36)
**Authors:** Tiger Lu, Garett Brown

37. [Alleviating the Hubble Tension Using $\Lambda$sCDM Model: A Coupled Dark Energy - Dark Matter Interaction](#user-content-link37)
**Authors:** Yismaw Wassie Ambelu, Amare Abebe Gidelew, Solomon Belay Tessema, Shambel Sahlu

38. [PDRS : A Linear $\mathcal{O}(N)$ Algorithm for Segmentation of High-Activity Regions in Irregularly Sampled Time Series](#user-content-link38)
**Authors:** Atal Agrawal

39. [Constraints on Phenomenological Amplitudes of CMB Anisotropy with Multi-Datasets](#user-content-link39)
**Authors:** Yang Han, Lu Chen, Guo-Hao Li, Pei-Yuan Xu

40. [Constraints on Ultralight Scalar and Dark Photon Dark Matter from PPTA-DR3 and EPTA-DR2](#user-content-link40)
**Authors:** Xiao-Song Hu, Siyuan Chen, Kuo Liu, Xingjiang Zhu, Shi-Yi Zhao, Wu Jiang, John Antoniadis, N. D. Ramesh Bhat, Amodio Carleo, Shi Dai, Valentina Di Marco, Huanchen Hu, Wenhua Ling, Yang Liu, Saurav Mishra, Christopher J Russell, Ryan M. Shannon, Clemente Smarra, Jingbo Wang, Lin Wang, Andrew Zic

41. [Self-acceleration of Hardening Binaries](#user-content-link41)
**Authors:** Giovanni Maria Tomaselli, Thomas F. M. Spieksma

42. [Beyond collective fluctuations: probing micro-image swarms in lensed quasars with intensity interferometry](#user-content-link42)
**Authors:** Ashish Kumar Meena, Prasenjit Saha

43. [Jet-driven shocks and turbulence in radio-loud Active Galactic Nuclei observed with JWST MIRI/MRS](#user-content-link43)
**Authors:** Rogemar A. Riffel, Gabriel L. Souza-Oliveira, Luis Colina, Almudena Alonso-Herrero, Marina Bianchin, Kalliopi M. Dasyra, Lorenzo Evangelista, Kameron Goold, Pierre Guillard, Rog\'erio Riffel, Anil Seth, Thaisa Storchi-Bergmann, Nadia Zakamska, Samile Araujo-Santos, Anelise Audibert, Enrica Bellocchi, Steph Campbell, Fran\c{c}oise Combes, Guilherme S. Couto, Jos\'e Henrique Costa-Souza, Richard I. Davies, Mait\^e S. Z. de Mellos, Tanio D\'iaz-Santos, Fergus R. Donnan, Ismael Garc\'ia-Bernete, Santiago Garc\'ia-Burillo, Laura Hermosa Mu\~noz, Erin K. S. Hicks, Alvaro Labiano, Enrique Lopez-Rodriguez, Vincenzo Mainieri, Christopher Packham, Miguel Pereira Santaella, Cristina Ramos Almeida, Claudio Ricci, Lucas Ramos Vieira, Vivian U

44. [Hadronic Scenario for Galactic PeVatron LHAASO J1912+1014u Supported by Fermi-LAT $\gamma$-ray Data and FUGIN CO Data](#user-content-link44)
**Authors:** Tsunefumi Mizuno, Hidetoshi Sano, Takeru Murase, Tomohiko Oka, Hiromasa Suzuki, Naohito Nakahara

45. [Powerful parametric instability of Alfven waves in astrophysical pair plasma](#user-content-link45)
**Authors:** Maxim Lyutikov (Purdue University)

46. [AGN STORM 2. XII. Ground-Based Optical Photometry and Lag Measurements of Mrk 817](#user-content-link46)
...
47. [Bounds on massive graviton-like particles from searches for axion-like particles coupling to photons](#user-content-link47)
**Authors:** Jordan Gu\'e, David d'Enterria

48. [Detectability of Polarized Gamma-ray Emission from Blazar Flares with COSI](#user-content-link48)
**Authors:** Garrett A. Latiolais, Jorge Otero-Santos, Michela Negro, Lea Marcotulli, Mohammad Ali Boroumand, Savitri Gallego, Christopher M. Karwin, Israel Martinez-Castellanos, Daniel Kocevski, Marco Ajello, Sara Capecchiacci, Ioannis Liodakis, Srinadh R. Bhavanam, Steven E. Boggs, Dieter H. Hartmann, Carolyn A. Kierans, Tiffany R. Lewis, Alberto Sciaccaluga, John A. Tomsick, Haocheng Zhang, Andreas Zoglauer

49. [Discovery of Quasar Variability and Early Accretion Disk Signatures at Cosmic Dawn](#user-content-link49)
...
50. [Distributions of particles accelerated by strong Alfv\'enic turbulence](#user-content-link50)
**Authors:** Stanislav Boldyrev, Daniel Humphrey, Vadim Roytershteyn

51. [Testing General Relativity Through Gravitational Wave Classification: A Convolutional Neural Network Framework](#user-content-link51)
**Authors:** Lavinia Heisenberg, Shayan Hemmatyar, Hector Villarrubia-Rojo

52. [Formation of Suprathermal Electron Populations in the Expanding, Turbulent Solar Wind](#user-content-link52)
**Authors:** Maximilien P\'eters de Bonhome, Fabio Bacchini, Luca Pezzini, Viviane Pierrard

53. [Probing the kinematics of FU Orionis objects through high-resolution near-infrared spectroscopy](#user-content-link53)
**Authors:** Ellen Lee, Michael Connelley

54. [Speckle Interferometry at SOAR in 2024 and 2025](#user-content-link54)
**Authors:** Andrei Tokovinin, Brian D. Mason, Rene A. Mendez, Edgardo Costa

55. [Investigating cosmic distance duality and dark energy evolution through intermediate and high-z probes](#user-content-link55)
**Authors:** Anna Chiara Alfano

56. [Design, Testing, and Commissioning of the Sun Yat-sen University (SYSU) 80 cm Infrared Telescope](#user-content-link56)
...
57. [Chromospheric dynamics and the O I 135.6~nm spectral line](#user-content-link57)
**Authors:** Viggo Hansteen, Mats Carlsson, Bart De Pontieu, Daniel N\'obrega-Siverio

58. [XRISM/Resolve observations of Hercules X-1: a pulsating, highly broadened Fe K emission line from the neutron star accretion column](#user-content-link58)
...
59. [Constraints on Einstein-aether gravity from the precision timing of PSR J1738+0333](#user-content-link59)
**Authors:** Massimo Vaglio, Amodio Carleo, Abhimanyu Susobhanan, Enrico Barausse, Bilel Ben Salem, Alessandro Corongiu, Paulo C. C. Freire, Delphine Perrodin

60. [Is XRISM/Resolve probing a "raining" absorber in Mrk 509?](#user-content-link60)
...
61. [Modeling large glitches with core superfluidity in a Hybrid star](#user-content-link61)
**Authors:** Yogeesh N., Anil Kumar, Monika Sinha

62. [Non-uniform particle injection into black hole jets by radiative magnetic reconnection](#user-content-link62)
**Authors:** Rin Oikawa, Kenji Toma, Shigeo S. Kimura

63. [A Short-timescale Negative Optical Continuum Lag in SDSS J083717.88+191647](#user-content-link63)
**Authors:** Chen MuLin, Cheng PeiZhen, Chen XingQian, Gu Ying, Zheng Qi, Liao GuiLin, Zhang XueGuang

64. [Optical activity, orbital modulation, and broadband SED constraints for RX J1553.0+4457](#user-content-link64)
...
65. [Millimeter-wave Detections of Symbiotic Stars in SPT and ACT Data](#user-content-link65)
...
66. [Statistically Significant Linear Alignments Among High-Confidence Transient Candidates on POSS-I Photographic Plates](#user-content-link66)
**Authors:** Brian Doherty

67. [Scalar-Electromagnetic Couplings as Source of Deformed Black Hole: From Shadows to Thermodynamic Topology](#user-content-link67)
...
68. [Zooming in on the GeV $\gamma$-ray flare of the blazar PKS 1725+123 with a multimessenger lens](#user-content-link68)
**Authors:** Suvas Chandra Chaudhary, Saikat Das, Raj Prince, Brian van Soelen

69. [Three-flavor supernova neutrino simulation using a hybrid quantum-classical algorithm with qutrits](#user-content-link69)
**Authors:** Daniel J. Heimsoth, A. Baha Balantekin, Pooja Siwach

70. [Revisiting the Rheology of Neutron Star Crusts with Molecular Dynamics](#user-content-link70)
**Authors:** Matthew E Caplan, Ashley Bransgrove

71. [MHD simulations on the large-scale propagation of high-speed solar wind streams](#user-content-link71)
**Authors:** Stefan J. Hofmeister

72. [Wavelength-Dependent Evolution of Full-Field Transfer Matrices in Photonic Lanterns](#user-content-link72)
**Authors:** Caleb Dobias, Miguel R\"omer, Swati Bhargava, Tara Crowe, Liza F. Quinn Reyes, David Smith, Matias Barzallo, Daniel Cruz-Delgado, Sergio Leon-Saval, Stephanos Yerolatsitis, Miguel A. Bandres, Stephen S. Eikenberry, Rodrigo Amezcua-Correa

73. [Radio Signature of Higher Atmospheric Meridional Flow and Implications for Magnetic Trees in the Sun](#user-content-link73)
**Authors:** Srinjana Routh, Anshu Kumari, Rohan Bose, Vaibhav Pant, Divya Paliwal, Dipankar Banerjee, Nat Gopalswamy

74. [Helicity-dependent corrections to black-hole shadows from the gravitational spin Hall effect](#user-content-link74)
**Authors:** C. A. S. Almeida

75. [Hadronic lensing](#user-content-link75)
**Authors:** Fabrizio Canfora, Crist\'obal Corral, Borja Diez

76. [Cosmology since the first Astro/Cosmo Moriond meeting// The emergence of the Big Bang 2.0](#user-content-link76)
**Authors:** Alain Blanchard

77. [ENGRAVE follow-up of a type IIb supernova spatially coincident with the sub-threshold gravitational wave trigger S250818k](#user-content-link77)
**Authors:** K. Ackley, M. T. Botticella, A. Boye, M. Branchesi, G. Bruni, E. Cappellaro, S. Chaty, T. -W. Chen, F. D'Ammando, V. D'Elia, F. F. De Pasquale, Dimple, R. A. J. Eyles-Ferris, M. Fraser, G. Gianfagna, J. H. Gillanders, G. Greco, M. Gromadzki, C. P. Guti\`errez, A. Hajela, L. Izzo, P. G. Jonker, S. Kobayashi, R. Kotak, G. P. Lamb, G. Leloudas, A. J. Levan, J. D. Lyman, K. Maguire, A. Martin-Carrillo, A. Melandri, M. J. Micha{\l}owski, S. R. Oates, F. Onori, B. Patricelli, E. Pian, G. Pignata, S. Piranomonte, L. Piro, Q. Pognan, M. L. Pumo, A. Rossi, R. Roy, A. Saccardi, O. S. Salafia, R. Salvaterra, N. Sarin, S. Schulze, S. J. Smartt, R. L. C. Starling, D. Steeghs, N. R. Tanvir, A. L. Thakur, S. D. Vergani, S. Yi, D. R. Young

78. [4HWC J2029$+$3641: a Pulsar Wind Nebula Powered by PSR J2030$+$3641?](#user-content-link78)
**Authors:** Ziwei Ou, Jie Wang, Songpeng Pei

79. [On the Radial Evolution of the Solar Wind : The Source Alignment Method Applied to Parker Solar Probe and Solar Orbiter Observations](#user-content-link79)
**Authors:** Jean-Baptiste Dakeyo, Tamar Ervin, Stuart Bale, Pascal D\'emoulin, Nikos Sioulas, Victor R\'eville, Mingzhe Liu, Alexis Rouillard, Milan Maksimovic, Davin Larson, Orlando Romeo, Philippe Louarn, Roberto Livi

80. [On the isotropy of viscosity in accretion discs](#user-content-link80)
**Authors:** Chris Nixon, Jim Pringle

81. [Status of the COSmological Microwave Observations CALibrator](#user-content-link81)
**Authors:** L. Mousset (on behalf of the COSMOCal collaboration)

82. [Spinning charged test particle dynamics around a Schwarzschild black hole embedded in a homogeneous magnetic field](#user-content-link82)
**Authors:** Misbah Shahzadi, Martin Kolos, Ondrej Zelenka, Georgios Lukes-Gerakopoulos

83. [A Statistical Survey of Faint Solar X-ray Transients Observed by NuSTAR](#user-content-link83)
**Authors:** Reed B. Masek (University of Minnesota), Lindsay Glesener (University of Minnesota), Jessie Duncan (NASA Marshall Space Flight Center), Kekoa Lasko (University of Minnesota), Nat\'alia Bajnokov\'a (University of Glasgow), Mary Davenport (Epic Systems), Marianne Peterson (University of Minnesota), Ian Markano (University of Minnesota), Zasha Avery (University of Minnesota), Kristopher Cooper (University of Minnesota), Iain G. Hannah (University of Glasgow), Brian W. Grefenstette (California Institute of Technology), Stephen M. White (Air Force Research Laboratory), Hugh Hudson (University of Glasgow), S\"am Krucker (University of Applied Sciences and Arts Northern Switzerland, University of California, Berkeley), David M. Smith (University of California, Santa Cruz), Sarah Paterson (University of Glasgow)

84. [Reviving Motivated Inflationary Potentials with $K$-inflation in the light of ACT](#user-content-link84)
**Authors:** Milad Solbi, Daris Samart, Peera Simakachorn

85. [Unravelling the complex structure of the Fe II emission region in Type 1 active galactic nuclei](#user-content-link85)
**Authors:** Jelena Kova\v{c}evi\'c-Doj\v{c}inovi\'c, Ivan Doj\v{c}inovi\'c, Luka \v{C}. Popovi\'c

86. [Observations of Atmospheric Helium and Oxygen with SPHEREx](#user-content-link86)
**Authors:** Howard Hui, Chi Nguyen, Ryan Wills, Katrina Bossert, Sean Bryan, Yoonsoo Bach, Jamie Bock, Tzu-Ching Chang, Shuang-Shuang Chen, Asantha Cooray, Brendan Crill, Olivier Dor\'e, C. Darren Dowell, Andreas Faisst, Jae Hwan Kang, Phil Korngut, Carey Lisse, Dan Masters, Roberta Paladini, Volker Tolls, Michael Werner, Yujin Yang, Mike Zemcov

87. [A Point-Spread Function for the Extreme Ultraviolet High-Resolution Imager on board Solar Orbiter](#user-content-link87)
...
## 2. [Merge and Strip II: Imprint of galaxy formation physics and viscosity on baryon-dominated dwarf galaxies](https://arxiv.org/abs/2605.00984) <a id="link2"></a>
...
**Comment:** This paper presents hydrodynamic simulations of galaxy mergers in cluster environments, focusing on the formation of tidal dwarf galaxies (TDGs), blue candidates, dark galaxies, and ultra-diffuse galaxies. It directly matches the 'Numerical Galaxy Simulations' criterion and is highly relevant to 'Near-Field Cosmology' due to its focus on dwarf galaxies and their formation mechanisms.
...
## 3. [Tidal pre-conditioning and ram-pressure stripping in NGC 1427A. Deep VLT/MUSE spectroscopy and FUV-to-radio observations trace a Fornax Cluster dwarf in transformation](https://arxiv.org/abs/2605.00988) <a id="link3"></a>
...
**Comment:** This paper studies the environmental transformation of a Fornax cluster dwarf galaxy (NGC 1427A), including spatially resolved star formation history, ram-pressure stripping, and tidal interactions. It matches 'Near-Field Cosmology', 'Resolved Star Formation Histories', and 'Star Formation Quenching' criteria, with strong emphasis on environmental quenching in a dwarf galaxy.
...
## 4. [Non-Equilibrium Ionisation in Photoionised Haloes: Implications for Shock Stability and Absorption-Line Signatures](https://arxiv.org/abs/2605.01505) <a id="link4"></a>
...
**Comment:** The paper investigates non-equilibrium ionization and the UV background in galaxy haloes, with implications for shock stability and absorption-line signatures. It models the CGM and absorption columns (OVI, CIV, HI) in haloes, and discusses the impact of the UV background on the thermal state and observable signatures. This is directly relevant to the 'Circumgalactic Medium' criterion, especially as it connects CGM to galaxy evolution and absorption-line observations.
...
## 5. [A Virgo Environmental Survey Tracing Ionised Gas Emission (VESTIGE). XXI. Statistical properties of individual HII regions in perturbed galaxies](https://arxiv.org/abs/2605.02648) <a id="link5"></a>
...
**Comment:** This paper uses Halpha imaging to study HII regions in perturbed Virgo cluster galaxies, focusing on statistical properties, luminosity functions, and quenching in gas-deficient galaxies. It directly addresses 'Star Formation Quenching' in cluster environments, especially in the context of outer disk quenching and HII region statistics, making it highly relevant.
...
## 6. [Galaxy luminosity functions from far-UV to submillimetre at $z=0$ in the COLIBRE simulations](https://arxiv.org/abs/2605.02022) <a id="link6"></a>
...
**Comment:** This paper presents predictions from the COLIBRE cosmological hydrodynamical simulations for galaxy luminosity functions across a wide wavelength range, including dust attenuation and emission. It is highly relevant to numerical galaxy simulations and the study of stellar populations, with direct application to galaxy formation and evolution.
...
## 7. [A structural degeneracy explains reionization tensions and limits dark matter constraints](https://arxiv.org/abs/2605.01380) <a id="link7"></a>
...
**Comment:** This paper analyzes reionization tensions and dark matter constraints, using N-body simulations of self-interacting dark matter halos in the mass range 10^9-10^11 Msun. It discusses the impact of galaxy-scale structure on reionization observables and the limitations of using reionization to probe dark matter. Directly relevant to near-field cosmology, dark matter density profiles, and numerical galaxy simulations.
...
## 8. [The chemical fingerprint of the Gaia BH3 system. Evidence for early cluster enrichment from the analysis of 51 elements](https://arxiv.org/abs/2605.02353) <a id="link8"></a>
...
**Comment:** The paper analyzes the chemical fingerprint of a metal-poor star in the Gaia BH3 system, investigating early cluster enrichment and nucleosynthesis. This is highly relevant to 'Near-Field Cosmology' as it connects the chemical abundances of a companion star to early enrichment processes and the assembly history of the Milky Way.
...
## 9. [The complex history of NGC 1427A revealed by its star clusters and star formation history](https://arxiv.org/abs/2605.00993) <a id="link9"></a>
...
**Comment:** This paper reconstructs the star formation history of a low-mass galaxy (NGC 1427A) in a cluster environment using resolved star clusters and integrated spectra. It directly matches the 'Resolved Star Formation Histories' criterion and also touches on 'Star Formation Quenching' in a dwarf galaxy context.
...
## 10. [Resolving the Unresolved Galactic Winds in Multi-phase Models. I. Methodology and Application](https://arxiv.org/abs/2605.01105) <a id="link10"></a>
...
**Comment:** This paper directly addresses star-formation-driven outflows, with a focus on mass-loading factors and multiphase wind models. It fits the 'Star Formation Driven Outflows' criterion very closely, and also touches on numerical galaxy simulations. High relevance due to direct match with core topics.
...
## 11. [Cross-Comparison of Galaxies Detected in the CSST Spectroscopic Survey and the SKA HI Survey](https://arxiv.org/abs/2605.01353) <a id="link11"></a>
...
**Comment:** This paper uses semi-analytic models and mock catalogs to cross-compare galaxies detected in optical and HI surveys, studying correlations between HI and emission-line signals, star formation rates, and the baryonic Tully-Fisher relation. It directly addresses numerical galaxy simulations and cold gas/stellar content, with relevance to resolved star formation histories and CGM (via HI content).
...
## 12. [Low-luminosity Wolf-Rayet stars: a model-data comparison](https://arxiv.org/abs/2605.02238) <a id="link12"></a>
...
**Comment:** This paper compares stellar evolutionary tracks to observed low-luminosity Wolf-Rayet stars, discussing mixing and mass-loss prescriptions. It directly addresses the 'Stellar Models' criterion by testing and refining stellar evolutionary models.
...
## 13. [Series solutions to the TOV equations](https://arxiv.org/abs/2605.00986) <a id="link13"></a>
...
**Comment:** This paper presents analytic solutions to the TOV equations for compact stellar objects, focusing on stellar interior models and equations of state. This fits the 'Stellar Models' criterion, as it provides new theoretical methods for modeling stellar interiors.
...
## 14. [Constraints on Halo Gas Profiles from Joint kSZ and Galaxy Clustering Analysis of ACT DR6 and CMASS](https://arxiv.org/abs/2605.01963) <a id="link14"></a>
...
**Comment:** This paper measures the kSZ signal and halo gas profiles using ACT and CMASS data, comparing observations to simulations. It discusses baryonic feedback and gas redistribution in galaxy halos, which is relevant to the circumgalactic medium and numerical galaxy simulations, though the focus is on more massive galaxies. Solid relevance due to CGM and simulation analysis.
...
## 15. [Baryons in the Darkest Sites of the Universe](https://arxiv.org/abs/2605.01994) <a id="link15"></a>
...
**Comment:** This paper presents the first observational constraint on baryon underdensity in cosmic voids using FRB dispersion measures, and discusses implications for feedback models and baryon mapping. While it deals with baryons in low-density environments and feedback, it does not focus on dwarf galaxies, satellite systems, or resolved star formation histories. The relevance to circumgalactic medium and feedback models is borderline.
...
## 16. [Fragmentation in the Serpens/Aquila Star-forming Region](https://arxiv.org/abs/2605.02138) <a id="link16"></a>
...
**Comment:** This paper presents ALMA observations and simulations of fragmentation in dense cores in the Serpens/Aquila star-forming region. It is relevant to resolved star formation histories and numerical galaxy simulations, but focuses on star formation in molecular clouds rather than galaxies or dwarfs. Borderline relevance due to connection to star formation processes.
...
## 18. [CHANG-ES XXXIX. Magnetic field structure in edge-on galaxies: Stacking Stokes parameters](https://arxiv.org/abs/2605.02053) <a id="link18"></a>
...
**Comment:** This paper studies magnetic field structure in edge-on, star-forming late-type galaxies using stacking of Stokes parameters. It focuses on cosmic-ray transport and star formation regulation, but the galaxies are not specifically dwarfs. The methodology is relevant to star formation driven outflows and CGM, but the focus is on more massive galaxies.
...
## 19. [A Comprehensive Study of Morphology and Kinematics in Extended Nebulae Around UV Luminous Quasars at $z\approx1$](https://arxiv.org/abs/2605.01981) <a id="link19"></a>
...
**Comment:** This paper studies extended nebulae around UV-luminous quasars, focusing on morphology, kinematics, and CGM/ISM gas. While it discusses the CGM, the focus is on massive quasar host galaxies and group environments, not dwarf galaxies or star-formation-driven outflows. The relevance is borderline due to CGM discussion.
...
## 20. [Validating z > 7.5 Lyman Break Galaxy candidates in the COSMOS field with JWST/PASSAGE](https://arxiv.org/abs/2605.01095) <a id="link20"></a>
...
**Comment:** This paper validates high-redshift Lyman Break Galaxy candidates in the COSMOS field using JWST. It focuses on galaxy counts and surface density at z~8, which is relevant to galaxy formation and luminosity functions, but not specifically to near-field cosmology or dwarf galaxies. Borderline relevance due to connection to galaxy abundance and luminosity function.
...
## 21. [JWST high-contrast spectroscopy with speckle modelling: Atmospheric retrievals of the T dwarf companion HD 19467 B](https://arxiv.org/abs/2605.02769) <a id="link21"></a>
...
**Comment:** Atmospheric retrievals for T dwarf companions using JWST spectroscopy. While it involves stellar atmosphere modeling, the focus is on substellar atmospheres and not on stellar evolutionary tracks or bolometric corrections relevant to the core 'Stellar Models' criterion. Borderline relevance.
...
## 22. [Stellar mass and morphology segregation in pairs and multiplets in the cosmic web](https://arxiv.org/abs/2605.00982) <a id="link22"></a>
...
**Comment:** The paper investigates stellar mass and morphology segregation in galaxy pairs and multiplets, with a focus on environmental effects (voids, clusters, etc.) on galaxy properties. While it discusses galaxy assembly and environmental dependence, it does not specifically focus on dwarf satellites, resolved star formation histories, quenching, or the CGM. The relevance is borderline, as the results may have implications for near-field cosmology and galaxy evolution, but the focus is on higher mass galaxies and large-scale structure.
...
## 23. [Formation and Redshift Evolution of Dark Matter Spikes](https://arxiv.org/abs/2605.01023) <a id="link23"></a>
...
**Comment:** The paper discusses the formation and evolution of dark matter spikes around black holes, focusing on density profiles and their evolution. While it deals with dark matter density profiles (core-cusp), the context is galactic nuclei and black holes, not dwarf galaxies or satellite systems. It is tangentially relevant to near-field cosmology but not a direct match.
...
## 24. [Tracing Primordial Gravitational Waves via non-Gaussian Signatures of Halo Bias](https://arxiv.org/abs/2605.02882) <a id="link24"></a>
...
**Comment:** This paper studies the imprint of primordial gravitational waves on halo bias and large-scale structure. While it discusses halo bias and non-Gaussianity, it does not focus on satellite galaxies, resolved star formation histories, or galaxy simulations. The relevance to near-field cosmology is peripheral.
...
## 25. [Prospects for Observing Galaxy Spectral Energy Distribution from the Radio to the far-Infrared in the Era of Next-Generation Radio Telescopes](https://arxiv.org/abs/2605.01000) <a id="link25"></a>
...
**Comment:** The paper discusses prospects for observing galaxy SEDs from radio to FIR with next-generation telescopes, focusing on massive galaxies and star-forming galaxies at high redshift. It does not address dwarf galaxies, resolved star formation histories, or CGM/outflows. The focus is on observational capabilities and SED modeling.
...
## 26. [Implications of \textit{SARAS3} data for Coulomb-like interacting dark matter](https://arxiv.org/abs/2605.00991) <a id="link26"></a>
...
**Comment:** This paper discusses the implications of SARAS3 data for Coulomb-like interacting dark matter using the 21-cm signal from cosmic dawn. While it is cosmology-focused and involves structure formation and baryon-DM interactions, it does not directly address near-field cosmology, resolved star formation histories, or dwarf galaxy properties. The focus is on early universe signals rather than galaxy-scale phenomena.
...
## 27. [A Search for Variability of Ultracool Dwarfs with the Zwicky Transient Facility](https://arxiv.org/abs/2605.02216) <a id="link27"></a>
...
**Comment:** The paper studies variability in ultracool dwarfs using ZTF light curves, focusing on rotation periods and atmospheric properties. While it deals with stellar physics, it does not present new stellar models or address galaxy-scale topics such as star formation histories or quenching.
...
## 28. [Constraints for Nuclear Astrophysics from an Unusual Presolar Silicate-Oxide Aggregate Grain Found in Primitive Ordinary Chondrite Meteorite Hills 00526](https://arxiv.org/abs/2605.02055) <a id="link28"></a>
...
**Comment:** The paper discusses isotopic data from a presolar grain and its implications for nuclear astrophysics and galactic chemical evolution. While it touches on galactic chemical evolution, it does not directly address near-field cosmology, resolved star formation histories, or any other core criteria.
...
## 29. [The Impact of the Magnetised Cosmic Web on Ultra High Energy Cosmic Ray Propagation](https://arxiv.org/abs/2605.02324) <a id="link29"></a>
...
**Comment:** The study models ultra-high-energy cosmic ray propagation in the magnetized cosmic web using cosmological simulations. While it uses galaxy-scale simulations, the focus is on cosmic ray propagation and extragalactic magnetic fields, not on galaxy formation, evolution, or the CGM of dwarf galaxies.
...
## 30. [Black Hole Supernovae Outcomes Across a Wide Progenitor Range](https://arxiv.org/abs/2605.01405) <a id="link30"></a>
...
**Comment:** This paper presents core-collapse supernova simulations and black hole formation outcomes across a range of progenitor masses. While it involves stellar evolution and supernovae, it does not present new stellar models or address galaxy-scale processes relevant to the prompt.
...
## 31. [Chemistry and Isotope Ratios of Substellar Atmospheres in the $\beta$ Pictoris Young Moving Group](https://arxiv.org/abs/2605.01012) <a id="link31"></a>
...
**Comment:** The paper measures chemical and isotopic compositions of substellar atmospheres in the beta Pictoris moving group, focusing on formation pathways of planets and brown dwarfs. While it involves stellar and substellar atmospheres, it does not present new stellar models or address galaxy-scale processes.
...
## 32. [Type Ib Supernovae are bluer than Type Ic Supernovae](https://arxiv.org/abs/2605.01200) <a id="link32"></a>
...
**Comment:** The paper analyzes optical colors of Type Ib and Ic supernovae, probing mass stripping in massive star evolution. While it deals with stellar evolution and supernovae, it does not present new stellar models or address resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 34. [Coverage is not enough: Frequentist tests of simulation-based inference for primordial non-Gaussianity](https://arxiv.org/abs/2605.00980) <a id="link34"></a>
...
**Comment:** This paper focuses on simulation-based inference for primordial non-Gaussianity using dark matter halo field simulations. While it deals with cosmological simulations and statistical methods, it does not directly address galaxy simulations, near-field cosmology, or any of the core topics such as satellite galaxies, star formation histories, or quenching.
...
## 35. [Neural Posterior Estimation for UHECR source inference from 3D propagation simulations](https://arxiv.org/abs/2605.01004) <a id="link35"></a>
...
**Comment:** This paper presents a simulation-based inference framework for ultra-high energy cosmic ray source identification. While it uses numerical simulations, these are not galaxy simulations and do not match the core criteria.
...
## 36. [A Coordinate System for Dynamical Instabilities in Hierarchical Systems in REBOUND](https://arxiv.org/abs/2605.01005) <a id="link36"></a>
...
**Comment:** This paper presents a new coordinate system for N-body simulations in REBOUND, focusing on wide binary systems and hierarchical dynamics. While it is a numerical method relevant to galaxy simulations, it does not focus on galaxies or their substructure, but rather on stellar and planetary systems. No direct match to the core topics.
...
## 38. [PDRS : A Linear $\mathcal{O}(N)$ Algorithm for Segmentation of High-Activity Regions in Irregularly Sampled Time Series](https://arxiv.org/abs/2605.02843) <a id="link38"></a>
...
**Comment:** The paper presents a new algorithm for segmenting high-activity regions in irregularly sampled time series, demonstrated on quasar and AGN light curves. While the method is computationally novel, it does not address galaxy simulations, star formation histories, or any of the core topics.
...
## 39. [Constraints on Phenomenological Amplitudes of CMB Anisotropy with Multi-Datasets](https://arxiv.org/abs/2605.01946) <a id="link39"></a>
...
**Comment:** The paper investigates phenomenological amplitude parameters in CMB anisotropy using multiple datasets. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, or any other core criteria.
...
## 40. [Constraints on Ultralight Scalar and Dark Photon Dark Matter from PPTA-DR3 and EPTA-DR2](https://arxiv.org/abs/2605.02172) <a id="link40"></a>
...
**Comment:** This paper uses pulsar timing arrays to constrain ultralight dark matter and dark photon dark matter. It discusses small-scale structure challenges in CDM, but the focus is on particle physics constraints rather than galaxy-scale astrophysics or near-field cosmology.
...
## 41. [Self-acceleration of Hardening Binaries](https://arxiv.org/abs/2605.00976) <a id="link41"></a>
...
**Comment:** The paper studies the hardening of binaries, particularly supermassive black hole binaries, and their displacement from galaxy centers. While it touches on galaxy mergers and binary evolution, it does not focus on dwarf galaxies, satellite systems, or star formation histories. The relevance to near-field cosmology is weak, as the main focus is on binary dynamics and implications for gravitational wave sources.
...
## 42. [Beyond collective fluctuations: probing micro-image swarms in lensed quasars with intensity interferometry](https://arxiv.org/abs/2605.02181) <a id="link42"></a>
...
**Comment:** The paper explores micro-image swarms in lensed quasars using intensity interferometry. The focus is on microlensing and quasar lensing, not on galaxy simulations, star formation histories, or near-field cosmology.
...
## 43. [Jet-driven shocks and turbulence in radio-loud Active Galactic Nuclei observed with JWST MIRI/MRS](https://arxiv.org/abs/2605.02663) <a id="link43"></a>
...
**Comment:** This paper investigates jet-driven shocks and turbulence in radio-loud AGN using JWST. The focus is on AGN feedback and multiphase ISM kinematics in massive galaxies, not on star-formation-driven outflows or dwarf galaxies. AGN-driven feedback is specifically excluded from relevance.
...
## 45. [Powerful parametric instability of Alfven waves in astrophysical pair plasma](https://arxiv.org/abs/2605.01445) <a id="link45"></a>
...
**Comment:** This paper studies parametric instability of Alfven waves in pair plasma, with applications to fast radio bursts and magnetar magnetospheres. It does not address galaxy-scale phenomena, star formation, or any of the core topics.
...
## 46. [AGN STORM 2. XII. Ground-Based Optical Photometry and Lag Measurements of Mrk 817](https://arxiv.org/abs/2605.02875) <a id="link46"></a>
...
**Comment:** This paper presents optical photometry and lag measurements of Mrk 817, a Seyfert galaxy, focusing on AGN variability and disk reprocessing. It does not address dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 47. [Bounds on massive graviton-like particles from searches for axion-like particles coupling to photons](https://arxiv.org/abs/2605.00549) <a id="link47"></a>
...
**Comment:** This paper discusses constraints on massive graviton-like particles and axion-like particles, with some mention of dark matter. However, the focus is on particle physics and cosmological constraints, not on near-field cosmology, galaxy simulations, or resolved star formation histories.
...
## 48. [Detectability of Polarized Gamma-ray Emission from Blazar Flares with COSI](https://arxiv.org/abs/2605.01139) <a id="link48"></a>
...
**Comment:** This paper investigates the detectability of polarized gamma-ray emission from blazar flares with COSI. The focus is on blazar variability and jet geometry, not on galaxy-scale astrophysics or any of the core topics.
...
## 49. [Discovery of Quasar Variability and Early Accretion Disk Signatures at Cosmic Dawn](https://arxiv.org/abs/2605.00978) <a id="link49"></a>
...
**Comment:** Focuses on quasar variability and accretion disk physics at high redshift, with emphasis on SMBH growth. Does not match any core criteria (no connection to dwarf galaxies, resolved SFH, quenching, stellar models, galaxy simulations, or CGM).
...
## 50. [Distributions of particles accelerated by strong Alfv\'enic turbulence](https://arxiv.org/abs/2605.02219) <a id="link50"></a>
...
**Comment:** Presents a model for particle acceleration in turbulent plasmas, relevant to heliospheric and magnetically dominated plasma environments. No direct connection to galaxy evolution, star formation, or stellar models.
...
## 51. [Testing General Relativity Through Gravitational Wave Classification: A Convolutional Neural Network Framework](https://arxiv.org/abs/2605.02453) <a id="link51"></a>
...
**Comment:** The paper presents a machine learning framework for testing general relativity with gravitational wave signals from binary black hole mergers. It does not address galaxy-scale phenomena or any of the core topics.
...
## 52. [Formation of Suprathermal Electron Populations in the Expanding, Turbulent Solar Wind](https://arxiv.org/abs/2605.01895) <a id="link52"></a>
...
**Comment:** This paper investigates suprathermal electron populations in the solar wind using kinetic simulations. It does not address galaxy simulations, star formation, or any of the core topics. The focus is on solar wind plasma physics.
...
## 53. [Probing the kinematics of FU Orionis objects through high-resolution near-infrared spectroscopy](https://arxiv.org/abs/2605.02032) <a id="link53"></a>
...
**Comment:** This paper focuses on FU Orionis objects and their kinematics using high-resolution spectroscopy. The topic is related to stellar evolution and disk physics, but does not present new stellar models or address resolved star formation histories, galaxy simulations, or near-field cosmology. It is not directly relevant to any of the core criteria.
...
## 54. [Speckle Interferometry at SOAR in 2024 and 2025](https://arxiv.org/abs/2605.01487) <a id="link54"></a>
...
**Comment:** This paper presents speckle interferometry results for binary stars, including measurements and orbits. The focus is on stellar binaries and not on galaxy simulations, star formation histories, or near-field cosmology.
...
## 55. [Investigating cosmic distance duality and dark energy evolution through intermediate and high-z probes](https://arxiv.org/abs/2605.02428) <a id="link55"></a>
...
**Comment:** The paper investigates cosmic distance duality and dark energy evolution using various cosmological probes. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 56. [Design, Testing, and Commissioning of the Sun Yat-sen University (SYSU) 80 cm Infrared Telescope](https://arxiv.org/abs/2605.02339) <a id="link56"></a>
...
**Comment:** This paper describes the design and commissioning of an infrared telescope, with applications to time-domain astronomy and observations of various transients and variables. It does not focus on any of the core topics.
...
## 57. [Chromospheric dynamics and the O I 135.6~nm spectral line](https://arxiv.org/abs/2605.02822) <a id="link57"></a>
...
**Comment:** This paper focuses on chromospheric dynamics and numerical modeling of spectral lines in the solar atmosphere. It does not match any of the core criteria (no connection to dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 58. [XRISM/Resolve observations of Hercules X-1: a pulsating, highly broadened Fe K emission line from the neutron star accretion column](https://arxiv.org/abs/2605.01146) <a id="link58"></a>
...
**Comment:** This paper presents XRISM/Resolve observations of Hercules X-1, focusing on accretion physics and Fe K emission lines in a neutron star system. It does not match any of the core criteria.
...
## 59. [Constraints on Einstein-aether gravity from the precision timing of PSR J1738+0333](https://arxiv.org/abs/2605.01436) <a id="link59"></a>
...
**Comment:** The paper constrains Einstein-aether gravity using pulsar timing observations. It does not address any of the core criteria.
...
## 60. [Is XRISM/Resolve probing a "raining" absorber in Mrk 509?](https://arxiv.org/abs/2605.02662) <a id="link60"></a>
...
**Comment:** The paper presents high-resolution X-ray spectroscopy of an AGN, focusing on Fe K emission and absorption features near a supermassive black hole. It does not match any of the core criteria.
...
## 61. [Modeling large glitches with core superfluidity in a Hybrid star](https://arxiv.org/abs/2605.02467) <a id="link61"></a>
...
**Comment:** This paper models pulsar glitches in hybrid stars, focusing on neutron star interiors and superfluidity. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models relevant to the prompt.
...
## 62. [Non-uniform particle injection into black hole jets by radiative magnetic reconnection](https://arxiv.org/abs/2605.01002) <a id="link62"></a>
...
**Comment:** The paper discusses plasma injection into black hole jets via magnetic reconnection, focusing on AGN jet formation. This is not relevant to any of the core topics, as it does not address galaxy-scale processes, dwarf galaxies, or stellar models.
...
## 63. [A Short-timescale Negative Optical Continuum Lag in SDSS J083717.88+191647](https://arxiv.org/abs/2605.01648) <a id="link63"></a>
...
**Comment:** The paper studies optical continuum lags in an AGN, focusing on accretion disk structure and dust obscuration. It does not address any of the core topics such as galaxy simulations, dwarf galaxies, or stellar models.
...
## 64. [Optical activity, orbital modulation, and broadband SED constraints for RX J1553.0+4457](https://arxiv.org/abs/2605.02796) <a id="link64"></a>
...
**Comment:** Multi-wavelength study of a post-common-envelope binary system, focusing on optical activity and X-ray behavior. No connection to galaxy evolution, resolved SFH, quenching, stellar models, or galaxy simulations.
...
## 65. [Millimeter-wave Detections of Symbiotic Stars in SPT and ACT Data](https://arxiv.org/abs/2605.01022) <a id="link65"></a>
...
**Comment:** This paper focuses on millimeter-wave detections of symbiotic stars, which are binary systems in the Milky Way. The study is primarily about stellar variability and binary models, not about dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM. No core criteria are matched.
...
## 66. [Statistically Significant Linear Alignments Among High-Confidence Transient Candidates on POSS-I Photographic Plates](https://arxiv.org/abs/2605.01190) <a id="link66"></a>
...
**Comment:** This paper reports on transient candidates and their spatial alignments in POSS-I plates, focusing on statistical analysis of vanishing sources. The topic is not related to any of the core criteria such as near-field cosmology, star formation histories, quenching, or galaxy simulations.
...
## 67. [Scalar-Electromagnetic Couplings as Source of Deformed Black Hole: From Shadows to Thermodynamic Topology](https://arxiv.org/abs/2605.01934) <a id="link67"></a>
...
**Comment:** This paper reconstructs a black hole geometry with scalar-electromagnetic couplings, analyzes shadows, and discusses thermodynamic topology. The focus is on black hole physics and not on galaxies, star formation, or near-field cosmology.
...
## 68. [Zooming in on the GeV $\gamma$-ray flare of the blazar PKS 1725+123 with a multimessenger lens](https://arxiv.org/abs/2605.01601) <a id="link68"></a>
...
**Comment:** This paper studies a blazar flare with multimessenger observations, focusing on high-energy neutrino production and cosmic-ray acceleration. It does not address any of the core topics.
...
## 69. [Three-flavor supernova neutrino simulation using a hybrid quantum-classical algorithm with qutrits](https://arxiv.org/abs/2605.01099) <a id="link69"></a>
...
**Comment:** The paper simulates neutrino systems in supernovae using quantum algorithms. It is not related to galaxy simulations, star formation, or any of the core topics. The focus is on neutrino physics and quantum computation.
...
## 70. [Revisiting the Rheology of Neutron Star Crusts with Molecular Dynamics](https://arxiv.org/abs/2605.02101) <a id="link70"></a>
...
**Comment:** This paper revisits the rheology of neutron star crusts using molecular dynamics. It is not related to galaxy simulations, star formation, or any of the core topics. The focus is on neutron star physics.
...
## 71. [MHD simulations on the large-scale propagation of high-speed solar wind streams](https://arxiv.org/abs/2605.01613) <a id="link71"></a>
...
**Comment:** This paper presents MHD simulations of solar wind streams. The focus is on solar physics and plasma propagation, not on galaxy simulations or any of the core topics.
...
## 72. [Wavelength-Dependent Evolution of Full-Field Transfer Matrices in Photonic Lanterns](https://arxiv.org/abs/2604.22091) <a id="link72"></a>
...
**Comment:** Study of photonic lanterns and their wavelength-dependent transfer matrices, relevant to instrumentation and photonics, not to galaxy evolution, star formation, or stellar models.
...
## 73. [Radio Signature of Higher Atmospheric Meridional Flow and Implications for Magnetic Trees in the Sun](https://arxiv.org/abs/2605.01947) <a id="link73"></a>
...
**Comment:** Reports detection of meridional flow signatures in the solar atmosphere, relevant to solar physics and magnetic connectivity, not to galaxy evolution, star formation, or stellar models.
...
## 74. [Helicity-dependent corrections to black-hole shadows from the gravitational spin Hall effect](https://arxiv.org/abs/2605.02136) <a id="link74"></a>

**ArXiv ID:** 2605.02136

**Authors:** C. A. S. Almeida

**Abstract:** Black-hole shadows are purely geometric in the leading-order geometric-optics approximation: their boundary is set by null geodesics and carries no information about the polarization of the probing radiation. This changes at subleading order. We show that the gravitational spin Hall effect of light shifts the critical impact parameter governing photon capture by a helicity-dependent amount, causing polarized radiation with opposite helicities to trace slightly different shadow boundaries -- even in static, spherically symmetric spacetimes. The correction is analytic, universal, and scales as $1/\omega$: it depends only on a single geometric function evaluated at the photon-sphere radius. We derive this result from the spin Hall equations of motion, confirm it numerically through ray-tracing calculations, and extend the analysis to Reissner-Nordstr\"om black holes, where electric charge amplifies the effect by up to a factor of $2.5$ at extremality. We further develop a perturbative treatment for slowly rotating (Kerr) spacetimes, showing that frame dragging introduces a $\cos\varphi$ modulation of the shadow splitting that can reverse its sign on one side of the image for spins $\chi \gtrsim 0.21$. Although the magnitude of the effect is small, the conceptual implication is clear: black-hole shadows are not purely geometric observables.

**Comment:** This paper focuses on helicity-dependent corrections to black-hole shadows, which is unrelated to any of the core topics such as near-field cosmology, star formation histories, galaxy simulations, or outflows. It is primarily about black hole physics and photon trajectories.
...
## 75. [Hadronic lensing](https://arxiv.org/abs/2605.02807) <a id="link75"></a>
...
**Comment:** This paper presents an analytic approach to gravitational lensing in the presence of hadronic media, with applications to black holes and superfluid pionic vortices. It is unrelated to galaxy evolution, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 76. [Cosmology since the first Astro/Cosmo Moriond meeting// The emergence of the Big Bang 2.0](https://arxiv.org/abs/2605.01977) <a id="link76"></a>
...
**Comment:** This is a review of cosmology's evolution, including the Big Bang, CMB, and cosmological parameters. It does not focus on near-field cosmology, satellite galaxies, or any of the core topics. The paper is broad and historical.
...
## 77. [ENGRAVE follow-up of a type IIb supernova spatially coincident with the sub-threshold gravitational wave trigger S250818k](https://arxiv.org/abs/2605.02639) <a id="link77"></a>
...
**Comment:** This paper reports follow-up observations of a supernova coincident with a gravitational wave trigger, ultimately classifying the transient as a type IIb supernova. It does not address any of the core criteria such as dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 78. [4HWC J2029$+$3641: a Pulsar Wind Nebula Powered by PSR J2030$+$3641?](https://arxiv.org/abs/2605.01988) <a id="link78"></a>
...
**Comment:** This paper analyzes a pulsar wind nebula and gamma-ray emission models, focusing on pulsar and nebula properties. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or stellar models.
...
## 79. [On the Radial Evolution of the Solar Wind : The Source Alignment Method Applied to Parker Solar Probe and Solar Orbiter Observations](https://arxiv.org/abs/2605.01511) <a id="link79"></a>
...
**Comment:** This paper studies the radial evolution of the solar wind using spacecraft observations. It does not address galaxy simulations, star formation, or any of the relevant topics. The focus is on heliospheric plasma physics.
...
## 80. [On the isotropy of viscosity in accretion discs](https://arxiv.org/abs/2605.00985) <a id="link80"></a>
...
**Comment:** The paper discusses viscosity in accretion discs, with a focus on warped discs and X-ray binaries. It does not address galaxy simulations, star formation, or any of the core topics. The focus is on accretion disc physics.
...
## 81. [Status of the COSmological Microwave Observations CALibrator](https://arxiv.org/abs/2605.01057) <a id="link81"></a>
...
**Comment:** This paper describes the COSMOCal project for CMB calibration. It is focused on instrumentation and calibration for CMB telescopes, not on galaxy-scale astrophysics or any of the core topics.
...
## 82. [Spinning charged test particle dynamics around a Schwarzschild black hole embedded in a homogeneous magnetic field](https://arxiv.org/abs/2605.02084) <a id="link82"></a>
...
**Comment:** This paper studies the dynamics of spinning charged test particles around a Schwarzschild black hole in a magnetic field. The focus is on compact object environments and particle dynamics, not on galaxies or any of the core topics.
...
## 83. [A Statistical Survey of Faint Solar X-ray Transients Observed by NuSTAR](https://arxiv.org/abs/2605.02837) <a id="link83"></a>
...
**Comment:** Statistical survey of faint solar X-ray transients using NuSTAR. Focus is on solar physics and microflares, not on galaxy evolution, star formation, or stellar models.
...
## 84. [Reviving Motivated Inflationary Potentials with $K$-inflation in the light of ACT](https://arxiv.org/abs/2605.01992) <a id="link84"></a>
...
**Comment:** Inflationary cosmology and CMB constraints, with focus on inflationary potentials and gravitational wave backgrounds. No connection to near-field cosmology, resolved SFH, quenching, stellar models, galaxy simulations, or CGM.
...
## 85. [Unravelling the complex structure of the Fe II emission region in Type 1 active galactic nuclei](https://arxiv.org/abs/2605.02508) <a id="link85"></a>
...
**Comment:** The paper studies the Fe II emission region in Type 1 AGN, focusing on atomic processes and broad-line region structure. It is not related to any of the core criteria: near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 86. [Observations of Atmospheric Helium and Oxygen with SPHEREx](https://arxiv.org/abs/2605.00851) <a id="link86"></a>
...
**Comment:** The paper presents measurements of atmospheric helium and oxygen with SPHEREx, focusing on terrestrial airglow and exosphere studies. The topic is unrelated to any of the core criteria.
...
## 87. [A Point-Spread Function for the Extreme Ultraviolet High-Resolution Imager on board Solar Orbiter](https://arxiv.org/abs/2605.01607) <a id="link87"></a>
...
**Comment:** This paper presents the point-spread function for a solar imaging instrument. It does not match any of the core criteria.
...
## 88. [Pole Structure of Kerr Green's Function](https://arxiv.org/abs/2605.01964) <a id="link88"></a>
...
**Comment:** This paper investigates the pole structure of Kerr black hole perturbations, focusing on mathematical aspects of black hole physics. It is unrelated to the core topics.
...
## 89. [A study of the kinematic and volumetric co-evolution of Earth-directed CMEs](https://arxiv.org/abs/2605.02828) <a id="link89"></a>
...
**Comment:** The paper studies the kinematic and volumetric evolution of Earth-directed CMEs, focusing on solar phenomena. It does not address galaxy-scale processes, dwarf galaxies, or stellar models.
...
## 90. [Foundations for Discovery: A Coordinated Fleet Approach to NASA Astrophysics](https://arxiv.org/abs/2605.02880) <a id="link90"></a>
...
**Comment:** White paper on NASA astrophysics mission architecture and strategic planning. No direct connection to any of the core scientific criteria.
...
## 91. [Mean tropical year length at arbitrary ecliptic longitude](https://arxiv.org/abs/2605.02239) <a id="link91"></a>
...
**Comment:** This paper computes the mean tropical year length for calendar purposes, unrelated to galaxy astrophysics or any of the core topics.
...
## 92. [Role of General Users in the Lifecycle of Scientific Software](https://arxiv.org/abs/2605.02870) <a id="link92"></a>
...
**Comment:** The paper discusses the lifecycle of scientific software (CASA) and user involvement. It is not relevant to any of the core astrophysical criteria.
...
## 93. [The connection between solar coronal abundances and the underlying lower atmospheric properties](https://arxiv.org/abs/2605.01993) <a id="link93"></a>
...
**Comment:** This paper focuses on solar coronal abundances and their connection to lower atmospheric properties. It is not relevant to any of the specified criteria, as it deals with solar physics rather than galaxy evolution, star formation, or near-field cosmology.
...
## 94. [The Outer Space Treaty Won't Save Us From Ourselves](https://arxiv.org/abs/2605.01019) <a id="link94"></a>
...
**Comment:** This paper discusses the Outer Space Treaty and legal/ethical frameworks for space activities. It is unrelated to galaxy astrophysics or any of the core topics.
...
## 95. [Recommendations for the Astronomy Graduate Admissions Process](https://arxiv.org/abs/2605.00992) <a id="link95"></a>
...
**Comment:** This paper provides recommendations for the astronomy graduate admissions process. It is not relevant to any of the core astrophysical criteria.
