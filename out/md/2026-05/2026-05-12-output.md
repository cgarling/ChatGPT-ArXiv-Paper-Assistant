...
1. [Unmasking Stellar Feedback-Driven Bubbles: Identification and Properties Analysis](#user-content-link1)
**Authors:** Aaron Angress, Michael M. Foley, Sarah M. R. Jeffreson, Alyssa Goodman, Lars Hernquist

2. [Separate Universe Super-Resolution Emulator](#user-content-link2)
**Authors:** Dennis Fremstad, Julian Adamek, David F. Mota

3. [Co-evolution of the Milky Way high- and low-{\alpha} sequences with chemical evolution models](#user-content-link3)
**Authors:** V. Grisoni, E. Spitoni, F. Matteucci

4. [The MaNGA Low-mass disks HUnt for CO (MaLHUCO) Survey](#user-content-link4)
**Authors:** M. Grossi, E. Corbelli, D. R. Gon\c{c}alves, E. D. Paspaliaris

5. [Satellite Metallicity Enhancement I: Suppressed Star Formation, Stellar Mass Loss, and Enriched Inflow of DESI and EAGLE Galaxies around Massive Clusters](#user-content-link5)
**Authors:** Yuanye Lin, Ying Zu, Jessica Nicole Aguilar, Steven Ahlen, David Brooks, Todd Claybaugh, Andrei Cuceu, Axel de la Macorra, Andreu Font-Ribera, Jaime E. Forero-Romero, Satya Gontcho A Gontcho, Gaston Gutierrez, Dick Joyce, Martin Landriau, Laurent Le Guillou, Aaron Meisner, Ramon Miquel, John Moustakas, Will J. Percival, Francisco Prada, Ignasi P\'erez-R\`afols, Graziano Rossi, Eusebio Sanchez, David Schlegel, Joseph Harry Silber, David Sprayberry, Gregory Tarl\'e, Benjamin Alan Weaver, Hu Zou

6. [STEPSIC: Initial condition generator for stereographic cosmological simulations](#user-content-link6)
**Authors:** Bal\'azs P\'al, G\'abor R\'acz, Istv\'an Csabai, Istv\'an Szapudi

7. [Simulating Star Formation and Star Cluster Assembly in the Aquila Rift Using Archival Observations](#user-content-link7)
**Authors:** Jeremy Karam, Michiko S. Fujii, Rachel Friesen, Alison Sills

8. [Stellar Age Compression Reshapes Interpretations of the Milky Way Thick-Disk Formation History](#user-content-link8)
**Authors:** Zhipeng Zhang

9. [RAYTHEIA: A high-performance ray-tracing algorithm for three-dimensional direction-dependent equations in astronomical simulations](#user-content-link9)
**Authors:** Zhengping Zhu, Thomas G. Bisbas, Xuefei Tang, Brandt A. L. Gaches, Tianwei Zhang, Huaxi Chen

10. [Joint probabilistic inference of galaxy redshifts and rest-frame spectra from photometric fluxes with latent diffusion](#user-content-link10)
**Authors:** Han-Yue Guo, Martin Eriksen

11. [Stardust Galaxies at z>9: A Dust-Origin Transition Behind the Excess of UV-Bright Galaxies](#user-content-link11)
**Authors:** D. Burgarella, V. Buat, A. K. Inoue, T. T. Takeuchi, C. Aurin, J. -C. Bouret, P. Dayal, T. Dewachter, M. Dickinson, C. Kobayashi, G. P. Nikopoulos, R. S. Somerville

12. [Specific Star Formation Rate Enhancement across the Galaxy Merger Sequence: Insights from Citizen Science Classifications](#user-content-link12)
**Authors:** Jacob Lee, Alexandra Le Reste, Claudia Scarlata, Kameswara Mantha Bharadwaj

13. [Identification of Compact Groups of Galaxies in IllustrisTNG300](#user-content-link13)
**Authors:** Seungwu Yoo, Jubee Sohn

14. [Empirical estimates of how massive galaxies can be in {\Lambda}CDM](#user-content-link14)
**Authors:** Miguel Enr\'iquez-Vargas, Aldo Rodr\'iguez-Puebla, Aditya Manuwal, L. Y. Aaron Yung, Vladimir Avila-Reese, Carlo Cannarozzo

15. [Beyond power spectrum to unveil systematics on HI intensity maps](#user-content-link15)
**Authors:** Pauline Gorbatchev, Jean-Luc Starck, Stefano Camera, Marta Spinelli

16. [How to count clustered galaxies](#user-content-link16)
**Authors:** Yunting Wang, Ryley Hill, Douglas Scott, Tessa Vernstrom

17. [Machine Learning Techniques for Astrophysics and Cosmology: Simulation-Based Inference](#user-content-link17)
**Authors:** Leander Thiele

18. [From Large Telescopes to the MUltiplexed Survey Telescope (MUST)](#user-content-link18)
**Authors:** Zheng Cai, Song Huang, Yu Liu, Cheng Zhao, Lei Huang

19. [On the residual missing mass of the Bullet Cluster](#user-content-link19)
**Authors:** Benoit Famaey

20. [Gas Phase Distribution in the Neutral ISM: A Comparison between Observation and Numerical Simulation](#user-content-link20)
**Authors:** Atanu Koley

21. [Reionisation time field reconstruction from 21-cm Maps: Investigating predictor coherence in WDM cosmology](#user-content-link21)
**Authors:** Julien Hiegel, Dominique Aubert, \'Emilie Th\'elie, Rodrigo Ibata, Nicolas Mai

22. [Application of Machine Learning to 21 cm Cosmology](#user-content-link22)
**Authors:** Hayato Shimabukuro

23. [HI absorption in MHONGOOSE -- Spin temperatures and cold neutral medium in nearby disk galaxies](#user-content-link23)
**Authors:** W. J. G. de Blok, F. M. Maccagni, L. Chemin, K. Haubner, R. Morganti, T. A. Oosterloo, D. Kleiner, S. Veronese, S. Kurapati, J. Healy

24. [CosmoDRAGoN III: Shaping the Afterlife -- How Progenitors and Environments Sculpt Radio Galaxy Remnants](#user-content-link24)
...
25. [The Stellar Abundances and Galactic Evolution Survey (SAGES). V. The First Data Release of the DDO51 Band](#user-content-link25)
...
26. [High-Spin BBH Subpopulation from AGN Accretion](#user-content-link26)
**Authors:** I. Bartos, Z. Haiman

27. [Producing the GeV Galactic Center Excess via Cosmic Ray-Dark Matter Scattering](#user-content-link27)
**Authors:** Bhaskar Dutta, Debopam Goswami, Jason Kumar, Mudit Rai, Deepak Sathyan

28. [Accelerating 3D Non-LTE Synthesis with Graph Neural Networks](#user-content-link28)
**Authors:** A. Vicente Ar\'evalo, A. Asensio Ramos, C. J. D\'iaz Baso

29. [When Magnetic Fields Sculpt the Sky: The Riegel-Crutcher cloud in optical polarization](#user-content-link29)
**Authors:** Gabriel A. P. Franco, Mayara Gomides, Zhi-Yun Li, Fabio P. Santos, Farideh S. Tabatabaei

30. [Mitigating residual foregrounds and systematic errors in SKA1-Low AA* EoR observations via Bayesian Gaussian Process Regression](#user-content-link30)
**Authors:** Samit Kumar Pal, Abhirup Datta, Aishrila Mazumder, Anshuman Tripathi

31. [Wolf-Rayet stars as tracers of gamma-ray emission: Isolated stars and stellar clusters/associations](#user-content-link31)
**Authors:** Alexandre Inventar, Giada Peron, Sarah Recchia, Stefano Gabici

32. [Interstellar X-ray Absorption and Scattering](#user-content-link32)
**Authors:** Linli Yan, Aigen Li, Fangjun Lu

33. [Demonstrating the Use of the Spherical Fourier Bessel Basis for Large Scale Clustering Systematics Discovery and Mitigation with eBOSS](#user-content-link33)
**Authors:** Sean Bruton, James R. Cheshire IV, Olivier Dor\'e, Henry S. Grasshorn Gebhardt, Robin Y. Wen

34. [Bayesian Doppler Imaging: Simultaneous Inference of Surface Maps and Geometric Parameters](#user-content-link34)
**Authors:** Yamato Ureshino, Hajime Kawahara, Hibiki Yama, Kento Masuda

35. [Electromagnetic Follow-up of the Sub-Solar Mass Gravitational Wave Candidate S251112cm: Kilonova Constraints and a Coincident IIb Supernova](#user-content-link35)
**Authors:** Xander J. Hall, Tomas Ahumada, Julius Gassert, Antonella Palmese, Brian D. Metzger, Mansi M. Kasliwal, Mattia Bulla, Daniel Gruen, Robert Stein, Christoffer Fremling, Shreya Anand, Igor Andreoni, Malte Busmann, Tom\'as Cabrera, Ryan Christinzio, James Freeburn, Ignacio Maga\~na Hernandez, Lei Hu, Brendan O'Connor, Ji-an Jiang, Zhengyan Liu, Wen Zhao, Eric C. Bellm, David Cook, Michael W. Coughlin, Richard Dekany, Matthew Graham, Russ R. Laher

36. [An Inverse-Compton-Boosted Cool Core Unifies Perseus's Radio and X-ray Halos](#user-content-link36)
**Authors:** Philip F. Hopkins, Emily M. Silich, Jack Sayers, Sam B. Ponnada, Isabel S. Sands

37. [General Grad-Shafranov Equation](#user-content-link37)
**Authors:** Ye Shen

38. [How to augment cosmic shear measurements with radio polarimetry of galaxies?](#user-content-link38)
**Authors:** Liang Dai, Junwu Huang, Weichen Winston Yin, Rui Zhou, Simone Ferraro

39. [Discovery of 30 Repeating Fast Radio Burst Sources and Uniform Population Statistics of 80 Repeating Sources from CHIME/FRB](#user-content-link39)
**Authors:** Amanda M. Cook (Department of Physics, McGill University, Montr\'eal, QC, Canada, Anton Pannekoek Institute for Astronomy, University of Amsterdam, Amsterdam, The Netherlands), Kaitlyn Shin (Cahill Center for Astronomy and Astrophysics, California Institute of Technology, Pasadena, CA, USA), Ziggy Pleunis (Anton Pannekoek Institute for Astronomy, University of Amsterdam, Amsterdam, The Netherlands, ASTRON, Netherlands Institute for Radio Astronomy, Dwingeloo, The Netherlands), Maxwell Fine (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Naman Jain (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Derek Bingham (Department of Statistics and Actuarial Science, Simon Fraser University, Burnaby, BC, Canada), Alice P. Curtin (Department of Physics, McGill University, Montr\'eal, QC, Canada, Anton Pannekoek Institute for Astronomy, University of Amsterdam, Amsterdam, The Netherlands), Gwendolyn Eadie (David A. Dunlap Department of Astronomy and Astrophysics, University of Toronto, Toronto, ON, Canada, Data Sciences Institute, University of Toronto, Toronto, ON, Canada), B. M. Gaensler (Department of Astronomy and Astrophysics, University of California, Santa Cruz, Santa Cruz, CA, USA, David A. Dunlap Department of Astronomy and Astrophysics, University of Toronto, Toronto, ON, Canada), Jason W. T. Hessels (Department of Physics, McGill University, Montr\'eal, QC, Canada, ASTRON, Netherlands Institute for Radio Astronomy, Dwingeloo, The Netherlands), Calvin Leung (Miller Institute for Basic Research, University of California, Berkeley, Berkeley, CA, USA, Department of Astronomy, University of California, Berkeley, Berkeley, CA, USA), Robert Main (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Nicole Mulyk (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Ayush Pandhi (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Paul Scholz (Department of Physics and Astronomy, York University, Toronto, ON, Canada), Seth R. Siegel (SKAO, Science Operations Centre, CSIRO ARRC, Kensington, WA, Australia, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), David C. Stenning (Department of Statistics and Actuarial Science, Simon Fraser University, Burnaby, BC, Canada), Thomas C. Abbott (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Bridget C. Andersen (Department of Astronomy and Astrophysics, University of California, Santa Cruz, Santa Cruz, CA, USA), Mohit Bhardwaj (Department of Space Planetary Astronomical Sciences and Engineering, Indian Institute of Technology Kanpur, Uttar Pradesh, India), Alice Cai (Department of Physics and Astronomy, Northwestern University, Evanston, IL, USA, Center for Interdisciplinary Exploration and Research in Astronomy, Northwestern University, Evanston, IL, USA), Shami Chatterjee (Cornell Center for Astrophysics and Planetary Science, Cornell University, Ithaca, NY, USA), Fengqiu Adam Dong (Department of Physics and Astronomy, York University, Toronto, ON, Canada), Emmanuel Fonseca (Department of Physics and Astronomy, West Virginia University, Morgantown, WV, USA, Center for Gravitational Waves and Cosmology, West Virginia University, Morgantown, WV, USA), Dant\'e M. Hewitt (Anton Pannekoek Institute for Astronomy, University of Amsterdam, Amsterdam, The Netherlands), Ronniy C. Joseph (S&T Netherlands, Delft, The Netherlands), Lordrick Kahinga (Department of Astronomy and Astrophysics, University of California, Santa Cruz, Santa Cruz, CA, USA, Department of Physics, College of Natural and Mathematical Sciences, University of Dodoma, Dodoma, Tanzania), Mattias Lazda (David A. Dunlap Department of Astronomy and Astrophysics, University of Toronto, Toronto, ON, Canada, Dunlap Institute for Astronomy and Astrophysics, University of Toronto, Toronto, ON, Canada), Victoria M. Kaspi (Department of Physics, McGill University, Montr\'eal, QC, Canada, School of Physics and Astronomy, Tel Aviv University, Tel Aviv, Israel), Afrokk Khan (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Bikash Kharel (Department of Physics and Astronomy, West Virginia University, Morgantown, WV, USA, Center for Gravitational Waves and Cosmology, West Virginia University, Morgantown, WV, USA), Lluis Mas-Ribas (Department of Astronomy and Astrophysics, University of California, Santa Cruz, Santa Cruz, CA, USA), Kiyoshi W. Masui (MIT Kavli Institute for Astrophysics and Space Research, MIT, Cambridge, MA, USA, Department of Physics, MIT, Cambridge, MA, USA), Kyle McGregor (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Daniele Michilli (Laboratoire d'Astrophysique de Marseille, Aix-Marseille Univ., CNRS, CNES, Marseille, France), Ryan Mckinven (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Mason Ng (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Kenzie Nimmo (Center for Interdisciplinary Exploration and Research in Astronomy, Northwestern University, Evanston, IL, USA), Swarali Shivraj Patil (Department of Physics and Astronomy, West Virginia University, Morgantown, WV, USA, Center for Gravitational Waves and Cosmology, West Virginia University, Morgantown, WV, USA), Aaron B. Pearlman (MIT Kavli Institute for Astrophysics and Space Research, MIT, Cambridge, MA, USA, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Mawson W. Sammons (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Ketan R. Sand (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Aylar Sedaei Oghani (Department of Physics and Astronomy, York University, Toronto, ON, Canada), Vishwangi Shah (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada), Kendrick Smith (Perimeter Institute for Theoretical Physics, Waterloo, ON, Canada), Ingrid Stairs (Department of Physics and Astronomy, University of British Columbia, Vancouver, BC, Canada), Tarik J. Zegmott (Department of Physics, McGill University, Montr\'eal, QC, Canada, Trottier Space Institute, McGill University, Montr\'eal, QC, Canada)

40. [A study on Dusty Plasma Physics and the examination of Jeans Criteria for the Milky Way](#user-content-link40)
**Authors:** Tanay Gupta, Isha Shailesh, Ram Prasad Prajapati

41. [On the origin of variability in $\alpha$ Cygni variable $\epsilon$ Ori (HD 37128) using TESS observations and modelling](#user-content-link41)
**Authors:** Subharthi Dasgupta, Sugyan Parida, Abhay Pratap Yadav, Wolfgang Glatzel, Michaela Kraus

42. [Milky Way Dynamics Favor Dark Matter over Modified Gravity Models](#user-content-link42)
**Authors:** Zheng-long Wang, Yue-Lin Sming Tsai, Lan Zhang, Yin Wu, Haining Li, Xiang-Xiang Xue, Hongsheng Zhao, Yi-Zhong Fan

43. [Astrons: Reissner-Nordstr\"om Primordial Naked Singularities](#user-content-link43)
**Authors:** Claudio Corian\`o, Paul H. Frampton, Leonardo Torcellini

44. [Non-Parametric Equation of State Reveals Non-Conformal Behavior Beyond Neutron Star Densities](#user-content-link44)
**Authors:** Yong-Jia Huang, Shao-Peng Tang, Yi-Zhong Fan

45. [The Peculiar Velocity of Messier~87 from Microarcsecond Geodetic VLBI Astrometry](#user-content-link45)
**Authors:** Valeri V. Makarov, Phil Cigan, Kyle Corcoran

46. [Black hole mass and distance from accretion disk astrophysical observables](#user-content-link46)
**Authors:** J. R. Fern\'andez-Moreno, A. Gonz\'alez-Ju\'arez, A. Herrera-Aguilar

47. [Neutron stars in a conservative $f(R,T)$ gravity](#user-content-link47)
**Authors:** Ronaldo V. Lobato, Geanderson A. Carvalho, Carlos E. C. Monta\~na, Jose F. Rodriguez-Ruiz

48. [Characterizing the Scale Height and Filamentary Structure of Radiatively Cooled MADs](#user-content-link48)
**Authors:** Akshay Singh (Bar-Ilan University), Damien Begue (Bar-Ilan University), Asaf Pe'er (Bar-Ilan University)

49. [Revisiting predictions for cosmic-ray antinucleon fluxes from Galactic Dark Matter](#user-content-link49)
**Authors:** Lorenzo Stefanuto, Mattia Di Mauro, Fiorenza Donato, Nicolao Fornengo, Jordan Koechler, David Maurin

50. [The dispersal of compact protoplanetary discs](#user-content-link50)
**Authors:** Giovanni Picogna, Barbara Ercolano

51. [Cosmological test of a length-preserving biconnection gravity](#user-content-link51)
**Authors:** Dalale Mhamdi, Amine Bouali, Taoufik Ouali, Tiberiu Harko

52. [JWST observations and a model for the extremely luminous obscured quasar W2246-0526 at z=4.6](#user-content-link52)
**Authors:** Charalambia Varnava, Andreas Efstathiou, Tanio D\'iaz-Santos, Duncan Farrah

53. [Asymmetric Reheating of Dark QED](#user-content-link53)
**Authors:** Simon Cl\'ery, Jean Kimus, Michel H. G. Tytgat

54. [X-ray luminous late-type giants: an overlooked population contributing to the Galactic ridge iron line emission](#user-content-link54)
**Authors:** Tong Bao, Gabriele Ponti, Xiao-jie Xu, Mark R. Morris, Benjamin Levin, Kaya Mori, Shifra Mandel, Nicola Locatelli, T. Mu\~noz-Darias, J. Casares, M. A. P. Torres

55. [You Shall Not Pass (Without Modeling): High-Resolution Analysis of KMT-2019-BLG-0253 using MORIA](#user-content-link55)
**Authors:** T. Dex Bhadra, Sean K. Terry, David P. Bennett, Aparna Bhattacharya, Ian A. Bond, Jon Hulberg, Stela Ishitani Silva, Przemek Mr\'oz, Aikaterini Vandorou

56. [SAPLE: Swift Analysis Pipeline for Lightcurve Extraction](#user-content-link56)
**Authors:** Lea Marcotulli, N\'uria Torres-Alb\`a

57. [An agentic framework for gravitational-wave counterpart association in the multi-messenger era](#user-content-link57)
**Authors:** Yiming Dong, Yacheng Kang, Junjie Zhao, Xinyuan Zhu, Ziming Wang, Lijing Shao

58. [Physical characterization and modeling of candidate Hyper-Compact HII Regions](#user-content-link58)
**Authors:** I. T. Rodr\'iguez-Esnard, S. Kurtz, J. D. Pandian, J. Franco, A. S\'anchez-Monge, M. A. Trinidad, V. Migenes

59. [The evolution of C4H and c-C3H2 in molecular cores](#user-content-link59)
**Authors:** Yijia Liu, Junzhi Wang, Ningyu Tang, Yajiang Lu, Donghui Quan, Juan Li, Kai Yang, Shu Liu, Yuqiang Li, Siqi Zheng, Chao Ou

60. [Breaking Free from the Swampland of Impossible Universes through the DESI Portal](#user-content-link60)
**Authors:** Luis A. Anchordoqui, Dieter Lust

61. [Gravitational-wave standard sirens and application in cosmology](#user-content-link61)
**Authors:** Wen Zhao, Liang-Gui Zhu, Youjun Lu

62. [Uncertainty in Physics and AI: Taxonomy, Quantification, and Validation](#user-content-link62)
**Authors:** Manuel Hau{\ss}mann, Ramon Winterhalder, Maria Ubiali

63. [A NICER and AstroSat view of the neutron star low-mass X-ray binary 1A 1246-588](#user-content-link63)
**Authors:** Vaidehi Poojyam, Vikas Mistry, Yash Bhargava, Sudip Bhattacharyya, Nitinkumar Bijewar

64. [Complexity and Multifractal Variability in Multi-Band Emission of Seyfert AGN](#user-content-link64)
**Authors:** R. A. A. Souza, E. Hatziminaoglou, A. de P\'adua Santos, T. Stosic

65. [Observational Properties of Nonthermal Emission from Relativistic Jets Escaping Active Galactic Nucleus Disks](#user-content-link65)
**Authors:** Ken Chen, Zi-Gao Dai

66. [Primordial Black Hole Hotspots Beyond Flat Spacetime](#user-content-link66)
**Authors:** Doojin Kim, TaeHun Kim, Jong-Chul Park, Jong-Hyun Yoon

67. [Challenges to the cosmological constant model following results from the Dark Energy Survey](#user-content-link67)
**Authors:** S. Avila, J. Mena-Fern\'andez, M. Vincenzi

68. [Characterizing Pulsar Distances Using HI Kinematics](#user-content-link68)
**Authors:** S. Romero-Ruiz, S. K. Ocker

69. [The Influence of Aliphatic Components on the Aromatic Emission Characteristics of Polycyclic Aromatic Hydrocarbons](#user-content-link69)
**Authors:** Zhuang Zhang, Yong Zhang

70. [Axisymmetric Jeans modelling systematically overestimates the circular speed in the inner Milky Way](#user-content-link70)
**Authors:** Tomoki Yamaguchi (Kagoshima U.), Junichi Baba (Kagoshima U./NAOJ)

71. [Small and Complex I: The Three Component Structure of $z \sim 0$ Massive Compact Quiescent Galaxies](#user-content-link71)
**Authors:** K. Slodkowski Clerici, A. Schnorr-M\"uller, A. C. Santiago-Menezes, M. Trevisan, T. V. Ricci, R. Merib-Dias, F. Palacios, W. L. Becker, F. Ferrari

72. [Reionization History and Neutrino Mass](#user-content-link72)
**Authors:** YiCheng Dai, Wei Liao

73. [Thirty Circumbinary Disk Occultation Systems (KH 15D-like stars) from the OGLE Project](#user-content-link73)
**Authors:** M. A. Urbanowicz, I. Soszy\'nski, P. Pietrukowicz, A. Udalski, P. Mr\'oz, M. Wrona, M. Ratajczak, M. K. Szyma\'nski, J. Skowron, D. M. Skowron, R. Poleski, S. Koz{\l}owski, P. Iwanek, K. Ulaczyk, K. Rybicki, M. Gromadzki, M. Mr\'oz

74. [Plato's view on supermassive black hole binaries: Exploring the faint limit of ESA's Plato space mission](#user-content-link74)
**Authors:** Nicholas Jannsen, Pablo Huijse, Kevin Park, Zoltan Haiman, Daniel J. D'Orazio, Conny Aerts

75. [Designing a low-loss high reflectivity mirror for gravitational waves detectors by combining a dielectric metasurface and a multilayer stack](#user-content-link75)
**Authors:** Edith Hartmann, Michel Lequime, Jerome Degallaix, Michael T. Hartman, Paul Rouquette, Claude Amra, Myriam Zerrad

76. [Quantum and Structural Effects Captured via a Statistical Method: the SACM Applied to HCN and HNC Colliding with CO](#user-content-link76)
**Authors:** F. Tonolo, E. Quintas-S\'anchez, A. Batista-Planas, R. Dawes, Fran\c{c}ois Lique

77. [Cooling of Isolated Neutron Stars with Hyperon-mixed Kaon-Condensation Matter](#user-content-link77)
**Authors:** Bhavnesh Bhat, Akira Dohi, Takumi Muto, Tsuneo Noda

78. [Can magnetic reconnection power neutrino emission from AGN coronae?](#user-content-link78)
**Authors:** Omar French, Gregory R. Werner, Mitchell C. Begelman

79. [Neural Posterior Estimation of Terrain Parameters from Radar Sounder Data](#user-content-link79)
**Authors:** Jordy Dal Corso, Annalena Kofler, Marco Cortellazzi, Lorenzo Bruzzone, Bernhard Sch\"olkopf

80. [The Good, the Bad, and the Subtle: Relativistic mode sums for neutron-star tidal response](#user-content-link80)
**Authors:** Abhishek Hegade K. R., K. J. Kwon, Tejaswi Venumadhav, Hang Yu, Nicolas Yunes

81. [Dynamic Competition of Fast and Collisional Neutrino Flavor Instabilities with Collisional Damping in Spatially Inhomogeneous Systems](#user-content-link81)
**Authors:** Shota Takahashi, Hiroki Nagakura, Masamichi Zaizen, Chinami Kato, Jiabao Liu

82. [GSC 08227-00723: An Unusually Large PSH Excess AH Pic Candidate](#user-content-link82)
**Authors:** Xin Li, Yongkang Sun

83. [Chasing the neutrino blazar candidates II: SED modeling with hadronic model](#user-content-link83)
**Authors:** Hubing Xiao, Zhihao Ouyang, Lili Yang, Jingtian Zhu, Minfeng Gu, Liang Chen, Shaohua Zhang, Zhijian Luo, Junhui Fan

84. [Optical Appearance of the Kerr-Bertotti-Robinson Black Hole with a Magnetically Driven Synchrotron Emissivity Model](#user-content-link84)
**Authors:** Zeng-Yi Zhang, Xiang-Qian Li, Hao-Peng Yan, Xiao-Jun Yue

85. [Isolating Broadband Radio Technosignatures (BRaTs): A Framework for Detecting Planetary-Scale Leakage](#user-content-link85)
**Authors:** Michael A. Garrett

86. [The Status of Gravitational Vector Perturbations with Recent CMB Data](#user-content-link86)
**Authors:** Ali Rida Khalife, Cyril Pitrou

87. [Einstein-Cartan pseudoscalaron inflation, reheating and nonthermal leptogenesis](#user-content-link87)
**Authors:** Carlo Di Benedetto, Alessandro Di Marco, Emanuele Orazi, Gianfranco Pradisi

88. [Numerical Study of Some Generalizations of the Starobinsky Inflationary Model](#user-content-link88)
**Authors:** Jordan Zambrano, \'Angel Rodr\'iguez, Melisa Alvear, Clara Rojas

89. [High-speed single-photoelectron detection for Cherenkov astronomy](#user-content-link89)
**Authors:** Luca Giangrande, Matthieu Heller, Teresa Montaruli

90. [BOCOSUR: An all sky network for fireball detection in Uruguay](#user-content-link90)
**Authors:** M. Caldas, A. Guaimare, V. Abraham, L. Barrios, M. Hern\'andez, L. Velasco, G. Tancredi

91. [Can We Distinguish the Source Region Location of Filament/Prominence Eruptions from the Sun-as-a-star H$\alpha$ Spectrum?](#user-content-link91)
**Authors:** Junyi Zhang, Yijun Hou, Xiaofeng Liu, Ting Li, Shihao Rao, Ye Qiu, HuiPing Jin, Yingjie Cai, Yangrui Chen, Chuan Li

92. [A low viscosity relatively thick twisted disk in a supermassive binary black hole as a potential model of OJ 287](#user-content-link92)
**Authors:** Viacheslav V. Zhuravlev, Pavel B. Ivanov

93. [Tracing the kinematic perturbations of the Milky Way spiral arms with APOGEE DR17 and Gaia DR3](#user-content-link93)
**Authors:** Xi-Can Tang, Zhi Li, Iulia T. Simion, Hao Tian, Zhijian Luo, Shuting Fan, Zi-Qi Li

94. [Bayesian Analysis of Massive Boson Star Models for Sagittarius A* Using Near-Infrared Astrometry Data](#user-content-link94)
**Authors:** Xiangyu Wang, Tian-chi Ma, Minyong Guo, Hai-Qing Zhang

95. [Coronal Mass Ejection and Heliospheric Current Sheet Interaction Causing a Long-Duration Magnetic Field Sector Transition](#user-content-link95)
**Authors:** Manuela Temmer, Stephan G. Heinemann, Nina Dresing, Mateja Dumbovic, Eleanna Asvestari

96. [Transition region-induced kinetic Alfven wave conversion. Electric displacement field](#user-content-link96)
**Authors:** Petko Nenovski

97. [Design and in-orbit calibration of the MXT optics](#user-content-link97)
**Authors:** Charly Feldman, James Pearson, Gillian Butcher, Richard Willingale, Paul O'Brien, Julian Osborne, Karine Mercier, Jean-Michel Le Duigou, Diego Gotz

98. [Hydrodynamical simulation of wind production from hot accretion flows in tidal disruption events](#user-content-link98)
**Authors:** Mingjun Liu, De-Fu Bu, Xiao-Hong Yang, Jiaqi Li, Huaqing Cheng, Qinyu Wu, Wenjie Zhang, B. F. Liu

99. [Astrophysical signatures of Kerr-Bertotti-Robinson black holes in a cloud of strings: ISCO, microquasar QPOs, and Bondi-Hoyle-Lyttleton accretion](#user-content-link99)
**Authors:** Faizuddin Ahmed, Orhan Donmez, Ahmad Al-Badawi, Izzet Sakalli

100. [Search for quasar pairs with Gaia astrometric data. II. Photometric redshift prediction with machine learning for the MGQPC catalogue](#user-content-link100)
**Authors:** Xingyu Zhu, Qihang Chen, Liang Jing, Zhuojun Deng, Jun-Qing Xia, Yanxia Zhang, Jianghua Wu

101. [Thermal Deformation Reduction in High-Power Interferometry with Higher-Order Laser Modes](#user-content-link101)
**Authors:** Liu Tao, Yuhang Zhao, Zong-Hong Zhu, Paul Fulda

102. [Quasiparticle Quality Factors in Superconducting Resonators: Effects of Bath Temperature and Readout Power](#user-content-link102)
**Authors:** Zhenyuan Sun, S Withington, Songyuan Zhao

103. [Photonic integrated circuits for astronomy: A formal description of an integrated photonics-based wavefront sensor (IP-WFS)](#user-content-link103)
**Authors:** Diego Portero-Rodr\'iguez, Hugo Garc\'ia-V\'azquez, Jos\'e Javier D\'iaz Garc\'ia, Luis Fernando Rodr\'iguez Ramos, F\'elix Gracia T\'emich, J. Alfonso L. Aguerri

104. [Multifield stochastic inflation: Relevance of number of fields in statistical moments](#user-content-link104)
**Authors:** Tomo Takahashi, Koki Tokeshi

105. [Image Processing Framework for Eclipse Shadow Band Analysis](#user-content-link105)
**Authors:** Joseph Conti

106. [Validating Coronal Magnetic Field Models Using Gaussian Separation](#user-content-link106)
**Authors:** Abhinav G. Iyer, Michael S. Wheatland, Brian T. Welsch, Yang Liu, S. A. Gilchrist

107. [Cyclotron Line Variability and Accretion Dynamics in Vela X-1](#user-content-link107)
**Authors:** Mohammed Tobrej, Binay Rai, Manoj Ghising, Bikash Chandra Paul

108. [Wideband RFI Monitor Requirements, Design, and Commissioning at DRAO](#user-content-link108)
**Authors:** Nicholas Bruce, Charl Baard, Stephen Harrison, Mohammad Islam, Abraham J. Otto, Dustin Lagoy, Robert Messing, Benoit Robert, Timothy Robishaw, Peter F. Driessen

109. [Magnetic Evolution of Highly-Sheared Region in Active Region 13842 Producing Large X9.0 Flare](#user-content-link109)
**Authors:** Yijun Hou, Ting Li, Shuhong Yang, Leping Li, Yingjie Cai, Xiaofeng Liu, Shuo Yang, Yilin Guo, Shihao Rao, Chuan Li, Guiping Zhou

110. [Energy-resolved pulse profiles of Vela X-1: cross-calibrating XMM-Newton and NuSTAR to trace spectral features](#user-content-link110)
**Authors:** Dimitrios K. Maniadakis, Antonino D'A\`i, Camille M. Diez, Giancarlo Cusumano, Elena Ambrosi, Carlo Ferrigno, Ekaterina Sokolova-Lapa, Matteo Lucchini, Peter Kretschmar, Alessio Anitra, Christian Malacaria, Gabriele A. Matzeu, Ciro Pinto, J\"orn Wilms, Felix F\"urst

111. [Search for long-term variability of HESS J1745-290](#user-content-link111)
**Authors:** H. E. S. S. Collaboration, :, A. Acharyya, F. Aharonian, M. Backes, R. Batzofin, D. Berge, K. Bernl\"ohr, M. B\"ottcher, C. Boisson, J. Bolmont, F. Brun, B. Bruno, C. Burger-Scheidlin, T. Bylund, J. Celic, M. Cerruti, A. Chen, M. Chernyakova, J. O. Chibueze, O. Chibueze, B. Cornejo, G. Cotter, J. Damascene Mbarubucyeye, J. de Assis Scarpin, M. de Bony de Lavergne, M. de Naurois, E. de O\~na Wilhelmi, A. G. Delgado Giler, J. Devin, A. Djannati-Ata\"i, A. Dmytriiev, K. Egg, J. -P. Ernenwein, C. Escanuela Nieves, P. Fauverge, K. Feijen, M. D. Filipovic, G. Fontaine, S. Funk, S. Gabici, J. F. Glicenstein, J. Glombitza, P. Goswami, L. Heckmann, B. Hess, J. A. Hinton, W. Hofmann, T. L. Holch, M. Holler, D. Horns, M. Jamrozy, F. Jankowsky, I. Jaroschewski, I. Jung-Richardt, D. Kerszberg, B. Kh\'elifi, N. Komin, K. Kosack, D. Kostunin, R. G. Lang, S. Lazarevic, A. Lemi\`ere, M. Lemoine-Goumard, J. -P. Lenain, P. Liniewicz, J. Mackey, D. Malyshev, V. Marandon, M. G. F. Mayer, A. Mehta, A. M. W. Mitchell, R. Moderski, L. Mohrmann, A. Montanari, J. Niemiec, L. Olivera-Nieto, M. O. Moghadam, S. Panny, R. D. Parsons8, U. Pensec, P. Pichard, T. Preis, G. P\"uhlhofer, M. Punch, A. Quirrenbach, A. Reimer, O. Reimer, I. Reis, H. X. Ren, B. Reville, F. Rieger, G. Rowell, B. Rudak, K. Sabri, V. Sahakian, A. Santangelo, M. Sasaki, F. Sch\"ussler, W. Si Said, H. Sol, L. Stawarz, T. Tanaka, G. L. Taylor, R. Terrier, M. Tsirou, T. Unbehaun, C. van Eldik, M. Vecchi, C. Venter, J. Vink, V. Voitsekhovskyi, T. Wach, S. J. Wagner, A. Wierzcholska, M. Zacharias, A. Zech, W. Zhong, S. Zouari

112. [Controlled Penumbral Inflation from Monodromic Valleys](#user-content-link112)
**Authors:** Pirzada, Tianjun Li

113. [Observations of the 2023 February 27 fireball in northern Sweden using the auroral imaging system ALIS_4D](#user-content-link113)
**Authors:** Gabriel Borderes-Motta, Daniel Kastinen, Tima Sergienko, Urban Br\"andstr\"om, Johan Kero, Jaakko Visuri, Maria Gritsevich, Jarmo Moilanen, Daniela Cardozo Mour\~ao, Barbara Celi Braga Camargo

---

## 1. [Unmasking Stellar Feedback-Driven Bubbles: Identification and Properties Analysis](https://arxiv.org/abs/2605.08534) <a id="link1"></a>
...
**Comment:** This paper investigates the properties and evolution of stellar feedback-driven bubbles in the ISM of a dwarf spiral (NGC300-like) galaxy using simulations. This matches the 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria, with a focus on feedback in a low-mass galaxy.
...
## 2. [Separate Universe Super-Resolution Emulator](https://arxiv.org/abs/2605.09004) <a id="link2"></a>
...
**Comment:** This paper presents a machine-learning model for generating super-resolution N-body simulations, which fits the 'Numerical Galaxy Simulations' criterion. The model enables high-resolution simulations with reduced computational cost and includes new generative modeling techniques.
...
## 3. [Co-evolution of the Milky Way high- and low-{\alpha} sequences with chemical evolution models](https://arxiv.org/abs/2605.10596) <a id="link3"></a>
...
**Comment:** This paper presents chemical evolution models for the Milky Way's high- and low-alpha sequences, including the effects of mergers with massive dwarf galaxies (e.g., Gaia-Enceladus) and star formation histories. The focus on the accreted stellar halo and the impact of dwarf galaxy mergers matches the 'Near-Field Cosmology' criterion.
...
## 4. [The MaNGA Low-mass disks HUnt for CO (MaLHUCO) Survey](https://arxiv.org/abs/2605.08979) <a id="link4"></a>
...
**Comment:** This paper presents CO observations of low-mass, star-forming disk galaxies, focusing on molecular gas content, star formation rates, and scaling relations. The sample is in the M33-like stellar-mass regime, which is close to the dwarf galaxy regime. The paper discusses the Kennicutt-Schmidt law and molecular gas depletion times in low-mass galaxies, which is relevant to 'Star Formation Quenching' and 'Numerical Galaxy Simulations' (if interpreted broadly), but the focus is on star formation and ISM properties in low-mass galaxies. This is a solid match for the 'Star Formation Quenching' and 'Circumgalactic Medium' criteria for low-mass galaxies.
...
## 5. [Satellite Metallicity Enhancement I: Suppressed Star Formation, Stellar Mass Loss, and Enriched Inflow of DESI and EAGLE Galaxies around Massive Clusters](https://arxiv.org/abs/2605.08342) <a id="link5"></a>
...
**Comment:** This paper investigates satellite metallicity enhancement (SME) in galaxies around massive clusters, focusing on environmental effects such as suppressed star formation, stellar mass loss, and enriched inflow. It uses both DESI observations and EAGLE simulations. The topic is closely related to star formation quenching (especially environmental quenching) and chemical evolution in satellite galaxies, but the focus is on satellites of massive clusters rather than Milky Way-like systems or dwarf galaxies. Thus, it is relevant but not maximally so.
...
## 6. [STEPSIC: Initial condition generator for stereographic cosmological simulations](https://arxiv.org/abs/2605.10354) <a id="link6"></a>
...
**Comment:** Presents an initial condition generator for cosmological N-body simulations, including non-periodic, observer-centric configurations. This is relevant to the 'Numerical Galaxy Simulations' criterion, as it provides new tools for generating initial conditions for galaxy/cosmological simulations.
...
## 7. [Simulating Star Formation and Star Cluster Assembly in the Aquila Rift Using Archival Observations](https://arxiv.org/abs/2605.09837) <a id="link7"></a>
...
**Comment:** This paper simulates star formation and star cluster assembly in a molecular cloud, using parameters from observations of the Aquila Rift. It models the evolution of stars and gas, including stellar feedback and cluster formation. This matches the 'Numerical Galaxy Simulations' criterion, with a focus on star formation and cluster assembly, though it is not directly about dwarf galaxies or resolved star formation histories in galaxies, so relevance is moderate.
...
## 8. [Stellar Age Compression Reshapes Interpretations of the Milky Way Thick-Disk Formation History](https://arxiv.org/abs/2605.10220) <a id="link8"></a>
...
**Comment:** This paper analyzes the formation history of the Milky Way thick disk using different stellar age scales. While the thick disk is not a dwarf galaxy, the work is relevant to near-field cosmology as it addresses the formation history of a major Milky Way component and discusses the interpretation of star formation histories. However, it does not focus on satellite galaxies or resolved star formation histories from CMDs, so the relevance is moderate.
...
## 9. [RAYTHEIA: A high-performance ray-tracing algorithm for three-dimensional direction-dependent equations in astronomical simulations](https://arxiv.org/abs/2605.09882) <a id="link9"></a>
...
**Comment:** Presents a new high-performance ray-tracing algorithm for astronomical simulations, with application to photodissociation regions in star-forming clouds. While this is a numerical method relevant to ISM and star formation, it does not focus on galaxy-scale simulations or the core topics (e.g., dwarf galaxies, resolved SFHs, CGM, etc.).
...
## 10. [Joint probabilistic inference of galaxy redshifts and rest-frame spectra from photometric fluxes with latent diffusion](https://arxiv.org/abs/2605.10753) <a id="link10"></a>
...
**Comment:** This paper presents a generative framework for joint probabilistic inference of galaxy redshifts and rest-frame spectra from photometric fluxes. While it involves galaxy spectra, it does not directly address resolved star formation histories, near-field cosmology, or galaxy simulations.
...
## 11. [Stardust Galaxies at z>9: A Dust-Origin Transition Behind the Excess of UV-Bright Galaxies](https://arxiv.org/abs/2605.09829) <a id="link11"></a>
...
**Comment:** This paper investigates the dust properties and UV luminosity functions of high-redshift (z>9) galaxies, focusing on the transition in dust origin and its effect on observed UV-bright galaxies. While it discusses galaxy evolution and star formation, it does not focus on resolved star formation histories from CMDs, dwarf galaxies in the near-field, or the other core topics. The connection to star formation quenching or outflows is indirect at best. Borderline relevance.
...
## 13. [Identification of Compact Groups of Galaxies in IllustrisTNG300](https://arxiv.org/abs/2605.08364) <a id="link13"></a>
...
**Comment:** This paper identifies compact groups of galaxies in the IllustrisTNG-300 simulation using a Friends-of-Friends algorithm. It presents new catalogs and discusses the environments and properties of these groups. While it involves numerical galaxy simulations, the focus is on compact groups (which are typically not dwarf galaxies or satellites) and not on the core topics such as near-field cosmology, resolved star formation histories, or quenching. The relevance is borderline due to the simulation aspect.
...
## 14. [Empirical estimates of how massive galaxies can be in {\Lambda}CDM](https://arxiv.org/abs/2605.08353) <a id="link14"></a>
...
**Comment:** Uses extreme value statistics to empirically estimate the maximum stellar mass of galaxies in ΛCDM, focusing on the most massive galaxies and their star formation efficiencies. While this is cosmology/galaxy formation, it is focused on the high-mass end and not on dwarf galaxies, resolved SFHs, or the other core criteria.
...
## 15. [Beyond power spectrum to unveil systematics on HI intensity maps](https://arxiv.org/abs/2605.08895) <a id="link15"></a>
...
**Comment:** This paper presents a new statistical method (starlet l1-norm) for analyzing HI intensity maps to improve cosmological parameter inference. While it is an improvement in cosmological analysis, it does not focus on galaxies, resolved star formation histories, or the CGM of dwarfs, and does not address any core topic directly. The method could be useful for future galaxy surveys, but the current application is not directly relevant.
...
## 16. [How to count clustered galaxies](https://arxiv.org/abs/2605.09248) <a id="link16"></a>
...
**Comment:** This paper presents a new empirical method for correcting galaxy number counts in confusion-limited surveys, focusing on the effects of galaxy clustering. While it discusses galaxy evolution and number counts, it does not specifically address dwarf galaxies, near-field cosmology, resolved star formation histories, quenching, stellar models, or outflows. The methodology could be useful for simulations, but the focus is not on galaxy simulations themselves.
...
## 17. [Machine Learning Techniques for Astrophysics and Cosmology: Simulation-Based Inference](https://arxiv.org/abs/2605.10719) <a id="link17"></a>
...
**Comment:** This is a methodological review of simulation-based inference (SBI) techniques in astrophysics and cosmology. While SBI is relevant for numerical galaxy simulations (criterion 5), this paper is a general overview and does not present new simulations or direct applications to the core topics. It may be tangentially useful for future work in relevant areas but does not directly address any specific criterion.
...
## 18. [From Large Telescopes to the MUltiplexed Survey Telescope (MUST)](https://arxiv.org/abs/2605.10102) <a id="link18"></a>
...
**Comment:** This is a review of large telescopes and the new MUST spectroscopic facility. While it discusses future capabilities for galaxy surveys, it does not focus on any of the core topics (e.g., near-field cosmology, resolved star formation histories, dwarf galaxies, etc.), but the facility could be relevant for future work in those areas. However, the paper itself is not directly relevant.
...
## 19. [On the residual missing mass of the Bullet Cluster](https://arxiv.org/abs/2605.10022) <a id="link19"></a>
...
**Comment:** The paper discusses the missing mass problem in the Bullet Cluster in the context of MOND. While it touches on galaxy clusters and dark matter, it does not focus on dwarf galaxies, satellite luminosity functions, or near-field cosmology as defined in the criteria.
...
## 20. [Gas Phase Distribution in the Neutral ISM: A Comparison between Observation and Numerical Simulation](https://arxiv.org/abs/2605.10711) <a id="link20"></a>
...
**Comment:** Compares observational and simulated gas phase distributions in the neutral ISM. While it uses numerical simulations and observations, the focus is on the ISM phases (CNM, WNM, UNM) and not on galaxy-scale simulations, dwarf galaxies, or star formation histories. Some tangential relevance to ISM studies, but not a core match.
...
## 21. [Reionisation time field reconstruction from 21-cm Maps: Investigating predictor coherence in WDM cosmology](https://arxiv.org/abs/2605.08970) <a id="link21"></a>
...
**Comment:** This paper discusses reionisation time field reconstruction using 21-cm maps and investigates the impact of warm dark matter (WDM) cosmology. While it touches on dark matter models and cosmic reionisation, it does not focus on near-field cosmology, dwarf galaxies, or resolved star formation histories. The connection to core topics is weak.
...
## 22. [Application of Machine Learning to 21 cm Cosmology](https://arxiv.org/abs/2605.10105) <a id="link22"></a>
...
**Comment:** Reviews the application of machine learning to 21 cm cosmology, focusing on the cosmic dawn and epoch of reionization. While relevant to early galaxy formation, it does not focus on resolved star formation histories, dwarf galaxies, or galaxy simulations as per the core criteria.
...
## 23. [HI absorption in MHONGOOSE -- Spin temperatures and cold neutral medium in nearby disk galaxies](https://arxiv.org/abs/2605.10517) <a id="link23"></a>
...
**Comment:** This paper presents HI absorption/emission studies in nearby disk galaxies (7-22 Mpc), focusing on the cold neutral medium. While it extends ISM phase structure studies beyond the Local Group, it does not focus on dwarf galaxies or the circumgalactic medium of dwarfs, nor does it address the core topics directly.
...
## 24. [CosmoDRAGoN III: Shaping the Afterlife -- How Progenitors and Environments Sculpt Radio Galaxy Remnants](https://arxiv.org/abs/2605.10156) <a id="link24"></a>
...
**Comment:** This paper uses hydrodynamic simulations to study the evolution of remnant radio galaxies, focusing on how progenitor and environmental properties affect their observable characteristics. While it involves galaxy simulations, the focus is on radio-loud AGN remnants and not on galaxy formation, dwarf galaxies, or star formation histories. Thus, it is only tangentially related to the core criteria.
...
## 25. [The Stellar Abundances and Galactic Evolution Survey (SAGES). V. The First Data Release of the DDO51 Band](https://arxiv.org/abs/2605.08770) <a id="link25"></a>
...
**Comment:** This paper presents the first data release of the DDO51 band from SAGES, which is sensitive to stellar surface gravity and can separate dwarfs from giants. While this is useful for Galactic structure studies and may help disentangle Milky Way substructures, it does not directly address any of the core topics such as near-field cosmology (unless used for satellite galaxy studies, which is not specified here), resolved star formation histories, or stellar models (since it is a data release, not a new model).
...
## 26. [High-Spin BBH Subpopulation from AGN Accretion](https://arxiv.org/abs/2605.09351) <a id="link26"></a>
...
**Comment:** This paper analyzes the spin distribution of binary black hole mergers and finds evidence for a subpopulation formed via accretion in AGN disks. While it discusses black hole mergers in galactic environments, it does not focus on galaxies themselves, their star formation histories, or any of the core topics.
...
## 27. [Producing the GeV Galactic Center Excess via Cosmic Ray-Dark Matter Scattering](https://arxiv.org/abs/2605.08010) <a id="link27"></a>
...
**Comment:** The paper proposes a new mechanism for generating gamma rays from the Galactic Center via cosmic ray-dark matter scattering. While it discusses the Galactic Center and dark matter, it does not focus on dwarf galaxies, satellite systems, or other core topics.
...
## 28. [Accelerating 3D Non-LTE Synthesis with Graph Neural Networks](https://arxiv.org/abs/2605.09543) <a id="link28"></a>
...
**Comment:** Presents a new method for 3D non-LTE synthesis using GNNs, but the application is to the solar chromosphere and not to stellar models for general stellar populations or galaxy evolution. Not directly relevant to the core topics.
...
## 29. [When Magnetic Fields Sculpt the Sky: The Riegel-Crutcher cloud in optical polarization](https://arxiv.org/abs/2605.08823) <a id="link29"></a>
...
**Comment:** Examines the role of magnetic fields in shaping the structure of the Riegel-Crutcher cloud in the ISM. While it discusses ISM structure and magnetic fields, it does not focus on galaxy-scale processes, dwarf galaxies, or star formation histories.
...
## 30. [Mitigating residual foregrounds and systematic errors in SKA1-Low AA* EoR observations via Bayesian Gaussian Process Regression](https://arxiv.org/abs/2605.10928) <a id="link30"></a>
...
**Comment:** The paper discusses methods for mitigating foregrounds and systematics in SKA1-Low Epoch of Reionization observations. While it is related to 21-cm cosmology, it does not focus on near-field cosmology, dwarf galaxies, or resolved star formation histories.
...
## 31. [Wolf-Rayet stars as tracers of gamma-ray emission: Isolated stars and stellar clusters/associations](https://arxiv.org/abs/2605.10294) <a id="link31"></a>
...
**Comment:** Examines Wolf-Rayet stars as tracers of gamma-ray emission, focusing on stellar clusters and isolated massive stars. While related to massive star feedback, it does not address star-formation-driven outflows at the galaxy scale, nor does it focus on dwarf galaxies or the other core criteria.
...
## 32. [Interstellar X-ray Absorption and Scattering](https://arxiv.org/abs/2605.08981) <a id="link32"></a>
...
**Comment:** This paper updates X-ray absorption and scattering models for the ISM, which is important for X-ray astronomy but does not directly address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 33. [Demonstrating the Use of the Spherical Fourier Bessel Basis for Large Scale Clustering Systematics Discovery and Mitigation with eBOSS](https://arxiv.org/abs/2605.10935) <a id="link33"></a>
...
**Comment:** This paper discusses the use of the Spherical Fourier-Bessel basis for identifying and mitigating systematics in large-scale clustering surveys. While it is relevant to cosmological large-scale structure, it does not match the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 34. [Bayesian Doppler Imaging: Simultaneous Inference of Surface Maps and Geometric Parameters](https://arxiv.org/abs/2605.08544) <a id="link34"></a>
...
**Comment:** This paper presents a Bayesian Doppler imaging framework for inferring surface maps and geometric parameters of brown dwarfs. While it involves stellar surface mapping and evolutionary models, it does not present new stellar interior or atmosphere models (criterion 4), nor does it address any other core topic.
...
## 35. [Electromagnetic Follow-up of the Sub-Solar Mass Gravitational Wave Candidate S251112cm: Kilonova Constraints and a Coincident IIb Supernova](https://arxiv.org/abs/2605.10940) <a id="link35"></a>
...
**Comment:** This paper presents electromagnetic follow-up of a gravitational wave event and discusses kilonova constraints and a possible supernova association. While it is interesting for compact object mergers, it does not focus on galaxies, star formation histories, or any of the core topics.
...
## 36. [An Inverse-Compton-Boosted Cool Core Unifies Perseus's Radio and X-ray Halos](https://arxiv.org/abs/2605.08349) <a id="link36"></a>
...
**Comment:** This paper models cosmic ray halos and their impact on the Perseus cluster's radio and X-ray emission. The focus is on cluster-scale phenomena, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 37. [General Grad-Shafranov Equation](https://arxiv.org/abs/2605.08597) <a id="link37"></a>
...
**Comment:** Presents a general expression for the Grad-Shafranov equation, relevant to plasma physics and force-free electrodynamics. While broadly applicable, it does not focus on galaxies, star formation, or the other core criteria.
...
## 38. [How to augment cosmic shear measurements with radio polarimetry of galaxies?](https://arxiv.org/abs/2605.08465) <a id="link38"></a>
...
**Comment:** This paper focuses on improving cosmic shear measurements using radio polarimetry of galaxies. While it is related to galaxy shape measurements and weak lensing, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy properties, or galaxy simulations. No criteria match closely.
...
## 39. [Discovery of 30 Repeating Fast Radio Burst Sources and Uniform Population Statistics of 80 Repeating Sources from CHIME/FRB](https://arxiv.org/abs/2605.08410) <a id="link39"></a>
...
**Comment:** This paper presents the discovery and population statistics of repeating fast radio burst (FRB) sources. While it is an important astrophysical result, it does not match any of the specified criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the circumgalactic medium. FRBs are not directly related to galaxy evolution or the structure of dwarf galaxies.
...
## 40. [A study on Dusty Plasma Physics and the examination of Jeans Criteria for the Milky Way](https://arxiv.org/abs/2605.09943) <a id="link40"></a>
...
**Comment:** This paper discusses dusty plasma physics and the Jeans criterion for the Milky Way, focusing on gravitational instability and galaxy formation in the early universe. While it touches on galaxy formation, it does not focus on dwarf galaxies, resolved star formation histories, or other core topics. The connection to the core topics is weak.
...
## 42. [Milky Way Dynamics Favor Dark Matter over Modified Gravity Models](https://arxiv.org/abs/2605.10857) <a id="link42"></a>
...
**Comment:** This paper focuses on Milky Way dynamics and tests of dark matter vs. modified gravity using the Milky Way's rotation curve and vertical structure. While it is related to dark matter, it focuses on the Milky Way's disk and vertical structure, which are explicitly listed as irrelevant in the criteria.
...
## 43. [Astrons: Reissner-Nordstr\"om Primordial Naked Singularities](https://arxiv.org/abs/2605.10587) <a id="link43"></a>
...
**Comment:** This paper discusses a speculative population of primordial charged compact objects ('astrons') and their cosmological implications. It does not focus on galaxies, star formation histories, or any of the core topics.
...
## 44. [Non-Parametric Equation of State Reveals Non-Conformal Behavior Beyond Neutron Star Densities](https://arxiv.org/abs/2605.08584) <a id="link44"></a>
...
**Comment:** This paper presents a non-parametric equation of state for neutron stars and discusses implications for the hadron-quark phase transition. It does not focus on galaxies, star formation histories, or any of the core topics.
...
## 45. [The Peculiar Velocity of Messier~87 from Microarcsecond Geodetic VLBI Astrometry](https://arxiv.org/abs/2605.08407) <a id="link45"></a>
...
**Comment:** This paper measures the proper motion of M87 using VLBI astrometry. While it discusses galaxy kinematics, it focuses on a massive elliptical galaxy (M87), which is outside the scope of the core topics.
...
## 46. [Black hole mass and distance from accretion disk astrophysical observables](https://arxiv.org/abs/2605.08582) <a id="link46"></a>
...
**Comment:** This paper focuses on analytical expressions for black hole mass and distance from accretion disk observables. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 47. [Neutron stars in a conservative $f(R,T)$ gravity](https://arxiv.org/abs/2605.09206) <a id="link47"></a>
...
**Comment:** This paper investigates neutron stars in a modified gravity context, focusing on stellar structure and observables. It does not match any of the core criteria such as stellar models (tracks/atmospheres), galaxy simulations, or resolved star formation histories.
...
## 48. [Characterizing the Scale Height and Filamentary Structure of Radiatively Cooled MADs](https://arxiv.org/abs/2605.09326) <a id="link48"></a>
...
**Comment:** This paper focuses on GR-MHD simulations of black hole accretion disks (MADs), which is not relevant to any of the specified criteria such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations (unless the focus is on galaxies, not accretion disks).
...
## 49. [Revisiting predictions for cosmic-ray antinucleon fluxes from Galactic Dark Matter](https://arxiv.org/abs/2605.08338) <a id="link49"></a>
...
**Comment:** This paper discusses cosmic-ray antinucleon fluxes and dark matter annihilation, which is not directly relevant to near-field cosmology, resolved star formation histories, or galaxy simulations as defined in the criteria.
...
## 50. [The dispersal of compact protoplanetary discs](https://arxiv.org/abs/2605.10399) <a id="link50"></a>
...
**Comment:** Focuses on protoplanetary disk dispersal and photoevaporation, which does not match any of the specified criteria (e.g., not about galaxy-scale star formation, outflows, or dwarf galaxies).
...
## 51. [Cosmological test of a length-preserving biconnection gravity](https://arxiv.org/abs/2605.08576) <a id="link51"></a>
...
**Comment:** Presents a cosmological test of a modified gravity theory, but does not focus on galaxies, star formation histories, or the other core topics.
...
## 52. [JWST observations and a model for the extremely luminous obscured quasar W2246-0526 at z=4.6](https://arxiv.org/abs/2605.09078) <a id="link52"></a>
...
**Comment:** This paper presents JWST observations and SED modeling of a high-redshift, extremely luminous obscured quasar. The focus is on AGN properties, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 53. [Asymmetric Reheating of Dark QED](https://arxiv.org/abs/2605.09686) <a id="link53"></a>
...
**Comment:** This paper studies asymmetric reheating in a dark sector model (Dark QED) and its implications for dark matter production. It does not address any of the core topics.
...
## 54. [X-ray luminous late-type giants: an overlooked population contributing to the Galactic ridge iron line emission](https://arxiv.org/abs/2605.09567) <a id="link54"></a>
...
**Comment:** This paper identifies a population of X-ray luminous late-type giants contributing to the Galactic ridge X-ray emission. The focus is on stellar X-ray sources and the Galactic ridge, not on dwarf galaxies, star formation histories, or galaxy simulations.
...
## 55. [You Shall Not Pass (Without Modeling): High-Resolution Analysis of KMT-2019-BLG-0253 using MORIA](https://arxiv.org/abs/2605.08340) <a id="link55"></a>
...
**Comment:** This paper presents a pipeline for high-resolution imaging analysis of microlensing events, focusing on exoplanet host characterization. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 56. [SAPLE: Swift Analysis Pipeline for Lightcurve Extraction](https://arxiv.org/abs/2605.10423) <a id="link56"></a>
...
**Comment:** This paper introduces a semi-automated pipeline for extracting Swift-UVOT and Swift-XRT lightcurves and spectral information for point sources. While useful for data analysis, it is a general tool and not specific to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 57. [An agentic framework for gravitational-wave counterpart association in the multi-messenger era](https://arxiv.org/abs/2605.10584) <a id="link57"></a>
...
**Comment:** This paper presents a framework for associating gravitational wave events with electromagnetic counterparts using large language models. While innovative for multi-messenger astronomy, it does not match any of the specified criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the circumgalactic medium.
...
## 58. [Physical characterization and modeling of candidate Hyper-Compact HII Regions](https://arxiv.org/abs/2605.09412) <a id="link58"></a>
...
**Comment:** This paper studies hypercompact HII regions and the early stages of high-mass star formation. It does not focus on galaxies, resolved star formation histories, or dwarf galaxies.
...
## 59. [The evolution of C4H and c-C3H2 in molecular cores](https://arxiv.org/abs/2605.08790) <a id="link59"></a>
...
**Comment:** This paper studies the chemistry of small hydrocarbons in massive star-forming regions. It does not focus on galaxies, resolved star formation histories, or any of the core topics.
...
## 60. [Breaking Free from the Swampland of Impossible Universes through the DESI Portal](https://arxiv.org/abs/2605.10476) <a id="link60"></a>
...
**Comment:** This is a review of DESI results and their implications for string theory and dark energy. It does not focus on galaxies, star formation histories, or any of the core topics.
...
## 61. [Gravitational-wave standard sirens and application in cosmology](https://arxiv.org/abs/2605.08595) <a id="link61"></a>
...
**Comment:** This is a review of gravitational-wave standard sirens and their application in cosmology. It does not focus on galaxies, star formation histories, or any of the core topics.
...
## 62. [Uncertainty in Physics and AI: Taxonomy, Quantification, and Validation](https://arxiv.org/abs/2605.10378) <a id="link62"></a>
...
**Comment:** This is a general overview of uncertainty quantification in physics and AI, with no direct connection to the core topics such as galaxy simulations or resolved star formation histories.
...
## 63. [A NICER and AstroSat view of the neutron star low-mass X-ray binary 1A 1246-588](https://arxiv.org/abs/2605.09637) <a id="link63"></a>
...
**Comment:** This paper analyzes the accretion-state evolution of a neutron star low-mass X-ray binary. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 64. [Complexity and Multifractal Variability in Multi-Band Emission of Seyfert AGN](https://arxiv.org/abs/2605.08998) <a id="link64"></a>
...
**Comment:** Studies AGN variability using multifractal analysis, which is not relevant to the specified topics (no focus on dwarf galaxies, star formation histories, or galaxy simulations).
...
## 65. [Observational Properties of Nonthermal Emission from Relativistic Jets Escaping Active Galactic Nucleus Disks](https://arxiv.org/abs/2605.10557) <a id="link65"></a>
...
**Comment:** The paper focuses on nonthermal emission from relativistic jets in AGN disks, which is not related to any of the core topics such as near-field cosmology, dwarf galaxies, or star formation histories.
...
## 66. [Primordial Black Hole Hotspots Beyond Flat Spacetime](https://arxiv.org/abs/2605.08336) <a id="link66"></a>
...
**Comment:** This paper studies primordial black hole hotspots and their evolution in an expanding universe. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 67. [Challenges to the cosmological constant model following results from the Dark Energy Survey](https://arxiv.org/abs/2605.09560) <a id="link67"></a>

**ArXiv ID:** 2605.09560

**Authors:** S. Avila, J. Mena-Fern\'andez, M. Vincenzi

**Abstract:** In the last year, several pieces of evidence have pointed to a possible deviation from the standard cosmological model, $\Lambda$CDM. The recent work by the Dark Energy Survey (DES) collaboration reports a preference in the ballpark of $3\sigma$ in favor of dynamical dark energy against the standard cosmological model. For that, it used its final analyses of Baryonic Acoustic Oscillations and type Ia Supernovae, both sensitive to the expansion history of the Universe, in combination with the Cosmic Microwave Background (CMB) from Planck. This adds to the growing debate about the nature of dark energy. \textit{Published as a Perspective in Nature Astronomy in August 2025}.

**Comment:** This is a perspective piece discussing recent evidence for deviations from the cosmological constant model, based on DES results. While it is of general cosmological interest, it does not address any of the core topics.
...
## 68. [Characterizing Pulsar Distances Using HI Kinematics](https://arxiv.org/abs/2605.10881) <a id="link68"></a>
...
**Comment:** Characterizes pulsar distances using HI kinematics. This is focused on pulsar distance measurements and Galactic structure, not on galaxies, star formation histories, or galaxy simulations.
...
## 69. [The Influence of Aliphatic Components on the Aromatic Emission Characteristics of Polycyclic Aromatic Hydrocarbons](https://arxiv.org/abs/2605.10030) <a id="link69"></a>
...
**Comment:** This paper focuses on the emission properties of PAHs and their diagnostic use in astronomical environments. While PAHs are relevant to ISM studies, there is no direct connection to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 70. [Axisymmetric Jeans modelling systematically overestimates the circular speed in the inner Milky Way](https://arxiv.org/abs/2605.09373) <a id="link70"></a>
...
**Comment:** This paper uses simulations to study biases in rotation curve inference for the Milky Way, focusing on the effects of non-axisymmetry (e.g., the bar). The focus is on the Milky Way's disk and bar, which are explicitly listed as irrelevant in the criteria.
...
## 72. [Reionization History and Neutrino Mass](https://arxiv.org/abs/2605.10116) <a id="link72"></a>
...
**Comment:** This paper investigates the impact of reionization history on neutrino mass constraints from cosmological data. While it is cosmology-focused, it does not address near-field cosmology, galaxy simulations, or any of the other core criteria.
...
## 73. [Thirty Circumbinary Disk Occultation Systems (KH 15D-like stars) from the OGLE Project](https://arxiv.org/abs/2605.08470) <a id="link73"></a>
...
**Comment:** This paper presents a catalog of KH 15D-like binary systems with circumbinary disks, based on OGLE observations. The focus is on stellar variability and disk occultation phenomena, not on galaxies, star formation histories, quenching, or galaxy simulations. It does not match any of the core criteria.
...
## 74. [Plato's view on supermassive black hole binaries: Exploring the faint limit of ESA's Plato space mission](https://arxiv.org/abs/2605.09037) <a id="link74"></a>
...
**Comment:** This paper focuses on the detection of supermassive black hole binaries (SMBHBs) using the Plato mission. SMBHBs and AGN variability are not relevant to any of the core topics (e.g., near-field cosmology, dwarf galaxies, resolved star formation histories, stellar models, galaxy simulations, outflows, or CGM).
...
## 76. [Quantum and Structural Effects Captured via a Statistical Method: the SACM Applied to HCN and HNC Colliding with CO](https://arxiv.org/abs/2605.10389) <a id="link76"></a>
...
**Comment:** This paper presents a statistical method for deriving molecular collision rates relevant for cometary comae. While it involves molecular astrophysics, it does not match any of the core topics.
...
## 77. [Cooling of Isolated Neutron Stars with Hyperon-mixed Kaon-Condensation Matter](https://arxiv.org/abs/2605.09723) <a id="link77"></a>
...
**Comment:** This paper investigates neutron star cooling with exotic matter. While relevant to compact object astrophysics, it does not match any of the core criteria (no focus on galaxies, star formation histories, or galaxy simulations).
...
## 78. [Can magnetic reconnection power neutrino emission from AGN coronae?](https://arxiv.org/abs/2605.10559) <a id="link78"></a>
...
**Comment:** Studies magnetic reconnection and neutrino emission in AGN coronae. This is focused on supermassive black holes and AGN, which are not part of the core criteria.
...
## 79. [Neural Posterior Estimation of Terrain Parameters from Radar Sounder Data](https://arxiv.org/abs/2605.08179) <a id="link79"></a>
...
**Comment:** This paper presents a neural posterior estimation method for terrain parameter inversion from radar sounder data, with applications to Mars. It does not match any of the core criteria.
...
## 80. [The Good, the Bad, and the Subtle: Relativistic mode sums for neutron-star tidal response](https://arxiv.org/abs/2605.08569) <a id="link80"></a>
...
**Comment:** This paper discusses relativistic mode sums for neutron-star tidal response. While it is astrophysical, it does not address any of the core topics such as galaxy evolution, dwarf galaxies, or star formation. No criteria match.
...
## 81. [Dynamic Competition of Fast and Collisional Neutrino Flavor Instabilities with Collisional Damping in Spatially Inhomogeneous Systems](https://arxiv.org/abs/2605.10435) <a id="link81"></a>
...
**Comment:** This paper studies neutrino flavor instabilities in core-collapse supernovae. It does not address any of the core topics such as galaxy evolution, dwarf galaxies, or star formation histories. No criteria match.
...
## 82. [GSC 08227-00723: An Unusually Large PSH Excess AH Pic Candidate](https://arxiv.org/abs/2605.09340) <a id="link82"></a>
...
**Comment:** This paper is about a nova-like cataclysmic variable star and its outburst behavior. It does not match any of the core topics.
...
## 83. [Chasing the neutrino blazar candidates II: SED modeling with hadronic model](https://arxiv.org/abs/2605.08775) <a id="link83"></a>
...
**Comment:** This paper models the SEDs of blazars as neutrino sources. It does not match any of the core topics (no focus on galaxies, star formation histories, or dwarf galaxies).
...
## 84. [Optical Appearance of the Kerr-Bertotti-Robinson Black Hole with a Magnetically Driven Synchrotron Emissivity Model](https://arxiv.org/abs/2605.09593) <a id="link84"></a>
...
**Comment:** This paper models the optical appearance of a Kerr-Bertotti-Robinson black hole with a synchrotron emissivity model. Black hole imaging and accretion disk physics are not relevant to the core topics.
...
## 85. [Isolating Broadband Radio Technosignatures (BRaTs): A Framework for Detecting Planetary-Scale Leakage](https://arxiv.org/abs/2605.10212) <a id="link85"></a>
...
**Comment:** This paper discusses a framework for detecting planetary-scale radio technosignatures (SETI). Technosignature searches are not relevant to the core topics.
...
## 86. [The Status of Gravitational Vector Perturbations with Recent CMB Data](https://arxiv.org/abs/2605.08907) <a id="link86"></a>
...
**Comment:** This paper presents constraints on gravitational vector perturbations using CMB data. It is focused on cosmological perturbations and not on any of the core topics.
...
## 87. [Einstein-Cartan pseudoscalaron inflation, reheating and nonthermal leptogenesis](https://arxiv.org/abs/2605.09571) <a id="link87"></a>
...
**Comment:** The paper discusses inflationary cosmology and leptogenesis, which are not related to the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 88. [Numerical Study of Some Generalizations of the Starobinsky Inflationary Model](https://arxiv.org/abs/2605.10728) <a id="link88"></a>
...
**Comment:** The paper is a numerical study of generalizations of the Starobinsky inflationary model, which is not directly related to any of the core topics such as galaxy simulations or resolved star formation histories.
...
## 89. [High-speed single-photoelectron detection for Cherenkov astronomy](https://arxiv.org/abs/2605.10411) <a id="link89"></a>
...
**Comment:** Describes instrumentation for Cherenkov astronomy, not related to any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 90. [BOCOSUR: An all sky network for fireball detection in Uruguay](https://arxiv.org/abs/2605.08917) <a id="link90"></a>
...
**Comment:** Describes a fireball detection network for meteorites, which is not relevant to the specified galaxy or stellar evolution topics.
...
## 91. [Can We Distinguish the Source Region Location of Filament/Prominence Eruptions from the Sun-as-a-star H$\alpha$ Spectrum?](https://arxiv.org/abs/2605.10891) <a id="link91"></a>
...
**Comment:** Focuses on solar filament/prominence eruptions and their spectral signatures, which is not relevant to the core topics (no connection to galaxy evolution, dwarf galaxies, or star formation histories).
...
## 92. [A low viscosity relatively thick twisted disk in a supermassive binary black hole as a potential model of OJ 287](https://arxiv.org/abs/2605.09517) <a id="link92"></a>
...
**Comment:** The paper models twisted accretion disks in a supermassive binary black hole system, specifically for OJ 287. This is not relevant to any of the core topics.
...
## 94. [Bayesian Analysis of Massive Boson Star Models for Sagittarius A* Using Near-Infrared Astrometry Data](https://arxiv.org/abs/2605.09521) <a id="link94"></a>
...
**Comment:** The paper uses astrometry to test boson star models for Sgr A* at the Galactic center. The focus is on the Galactic center, which is not relevant to the core topics.
...
## 95. [Coronal Mass Ejection and Heliospheric Current Sheet Interaction Causing a Long-Duration Magnetic Field Sector Transition](https://arxiv.org/abs/2605.10193) <a id="link95"></a>
...
**Comment:** This paper focuses on coronal mass ejections and the heliospheric current sheet, which are solar/heliospheric phenomena and do not match any of the core criteria (e.g., near-field cosmology, dwarf galaxies, resolved star formation histories, etc.).
...
## 96. [Transition region-induced kinetic Alfven wave conversion. Electric displacement field](https://arxiv.org/abs/2605.10270) <a id="link96"></a>
...
**Comment:** Focuses on kinetic Alfven wave propagation in the solar transition region. This is a solar/heliospheric plasma physics paper and does not match any of the core criteria.
...
## 97. [Design and in-orbit calibration of the MXT optics](https://arxiv.org/abs/2605.10263) <a id="link97"></a>
...
**Comment:** Describes the design and calibration of the MXT X-ray telescope optics. This is an instrumentation paper and does not match any of the core criteria.
...
## 98. [Hydrodynamical simulation of wind production from hot accretion flows in tidal disruption events](https://arxiv.org/abs/2605.10024) <a id="link98"></a>
...
**Comment:** This paper presents hydrodynamical simulations of wind production from hot accretion flows in tidal disruption events (TDEs) around SMBHs. Simulations of TDEs and SMBH feedback are not relevant to the core topics, which focus on galaxy-scale processes, not black hole accretion.
...
## 99. [Astrophysical signatures of Kerr-Bertotti-Robinson black holes in a cloud of strings: ISCO, microquasar QPOs, and Bondi-Hoyle-Lyttleton accretion](https://arxiv.org/abs/2605.10214) <a id="link99"></a>
...
**Comment:** This paper studies black hole accretion and QPOs in microquasars, with a focus on black hole physics and accretion flows, not on galaxy-scale processes or the core topics.
...
## 100. [Search for quasar pairs with Gaia astrometric data. II. Photometric redshift prediction with machine learning for the MGQPC catalogue](https://arxiv.org/abs/2605.09450) <a id="link100"></a>
...
**Comment:** This paper presents a machine learning approach to identify quasar pairs using Gaia data. The focus is on quasar pairs and supermassive black holes, not on the core topics.
...
## 101. [Thermal Deformation Reduction in High-Power Interferometry with Higher-Order Laser Modes](https://arxiv.org/abs/2605.10222) <a id="link101"></a>
...
**Comment:** This paper focuses on thermal deformation and higher-order laser modes for gravitational-wave interferometry. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 102. [Quasiparticle Quality Factors in Superconducting Resonators: Effects of Bath Temperature and Readout Power](https://arxiv.org/abs/2605.08591) <a id="link102"></a>
...
**Comment:** This paper discusses superconducting resonators and their quality factors, which is not related to any of the core topics such as galaxy simulations, star formation, or near-field cosmology.
...
## 104. [Multifield stochastic inflation: Relevance of number of fields in statistical moments](https://arxiv.org/abs/2605.10656) <a id="link104"></a>
...
**Comment:** This paper presents theoretical work on multifield stochastic inflation and the statistical moments of e-folds. It does not match any of the core criteria.
...
## 105. [Image Processing Framework for Eclipse Shadow Band Analysis](https://arxiv.org/abs/2605.09621) <a id="link105"></a>
...
**Comment:** This paper presents an image processing framework for analyzing eclipse shadow bands. It does not match any of the core criteria.
...
## 106. [Validating Coronal Magnetic Field Models Using Gaussian Separation](https://arxiv.org/abs/2605.09841) <a id="link106"></a>
...
**Comment:** This paper is about validating coronal magnetic field models in solar active regions. It does not relate to any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations. No criteria match.
...
## 107. [Cyclotron Line Variability and Accretion Dynamics in Vela X-1](https://arxiv.org/abs/2605.10103) <a id="link107"></a>
...
**Comment:** This paper analyzes accretion dynamics and cyclotron line variability in the X-ray binary Vela X-1. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 108. [Wideband RFI Monitor Requirements, Design, and Commissioning at DRAO](https://arxiv.org/abs/2605.08479) <a id="link108"></a>
...
**Comment:** This paper describes the design and commissioning of a wideband RFI monitor at DRAO. Instrumentation and RFI monitoring are not relevant to the core topics.
...
## 109. [Magnetic Evolution of Highly-Sheared Region in Active Region 13842 Producing Large X9.0 Flare](https://arxiv.org/abs/2605.10892) <a id="link109"></a>
...
**Comment:** The paper studies solar flares and magnetic evolution in the Sun's active regions, which is not relevant to the core topics focused on galaxies, star formation histories, or galaxy simulations.
...
## 110. [Energy-resolved pulse profiles of Vela X-1: cross-calibrating XMM-Newton and NuSTAR to trace spectral features](https://arxiv.org/abs/2605.10381) <a id="link110"></a>
...
**Comment:** This paper studies energy-resolved pulse profiles of the X-ray pulsar Vela X-1, which is not relevant to the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 112. [Controlled Penumbral Inflation from Monodromic Valleys](https://arxiv.org/abs/2605.10197) <a id="link112"></a>
...
**Comment:** This paper is about inflationary models in high-energy theory and does not relate to any of the astrophysical core topics.
...
## 113. [Observations of the 2023 February 27 fireball in northern Sweden using the auroral imaging system ALIS_4D](https://arxiv.org/abs/2605.08834) <a id="link113"></a>
...
**Comment:** This paper analyzes a fireball event and meteoroid trajectory/origin. It does not relate to any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
