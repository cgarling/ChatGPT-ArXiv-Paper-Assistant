...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 42406    | 5951         | 48357   |
| **Cost**             | $0.08    | $0.05        | $0.13   |

Total arXiv papers: 144
...
1. [The DECam MAGIC Survey $-$ Mapping the Ancient Galaxy in CaHK: Overview and Summary of Early Science](#user-content-link1)
**Authors:** A. Chiti, A. Drlica-Wagner, A. B. Pace, W. Cerny, K. R. Atzberger, F. O. Barbosa, J. A. Carballo-Bello, H. Q. Do, A. P. Ji, G. Limberg, A. M. Luna, C. E. Mart\'inez-V\'azquez, V. M. Placco, D. S. Prabhu, G. S. Stringfellow, A. K. Vivas, A. R. Walker, S. N. Campana, J. L. Carlin, V. Chandra, D. Crnojevi\'c, P. S. Ferguson, J. J. Hermes, N. Kallivayalil, G. E. Medina, M. Navabi, N. E. D. No\"el, A. H. Riley, D. J. Sand, C. W. Skeffington, K. Tavangar, J. F. Wu, Y. Choi, D. Erkal, D. J. James, T. S. Li, P. Massana, B. Mutlu-Pakdil, D. L. Nidever, K. A. G. Olsen, J. D. Sakowska, L. Santana-Silva, J. D. Simon, E. Tollerud, A. Zenteno

2. [For modified gravity, it's the LITTLE THINGS that matter](#user-content-link2)
**Authors:** Geoff Beck

3. [A framework for modelling Population III stars in cosmological simulations](#user-content-link3)
**Authors:** Bipradeep Saha, Rahul Kannan, Giovanni M. Mirouh

4. [Looking into the faintEst WIth MUSE (LEWIS): Exploring the nature of ultra-diffuse galaxies in the Hydra-I cluster. VI. A star-forming UDG in Hydra I: a rare UDG or a transition phase?](#user-content-link4)
**Authors:** Luca Rossi, Chiara Buttitta, Goran Doll, Enrichetta Iodice, Marco Gullieuszik, Marc Sarzi, Marco Mirabile, Johanna Hartke, Magda Arnaboldi, Rosa Calvi, Michele Cantiello, Enrico Maria Corsini, Giuseppe D'Ago, Jes\'us Falc\'on-Barroso, Francesca Fonzo, Duncan A. Forbes, Michael Hilker, Antonio La Marca, Alessandro Loni, Steffen Mieske, Maurizio Paolillo, Marina Rejkuba, Marilena Spavone, Chiara Spiniello

5. [How galaxies acquire their stellar mass at high redshift: High star formation efficiencies and the relative roles of dust and initial mass function](#user-content-link5)
...
6. [Unveiling the dark matter nature with reionization relics](#user-content-link6)
**Authors:** Yao Zhang, Paulo Montero-Camacho, Catalina Morales-Guti\'errez, Heyang Long, Christopher M. Hirata, Yi Mao

7. [Cosmic Ray Feedback in Galactic Disks: Star Formation, Cosmic Ray Transport, and Multiphase Outflows in \tigresspp\ Simulations](#user-content-link7)
...
8. [The Baryonic Faber-Jackson Relation and Fundamental Plane of Galaxy Groups, Elliptical Galaxies, and Dwarf Galaxies](#user-content-link8)
**Authors:** Yong Tian, Federico Lelli, Marcel S. Pawlowski, Stacy McGaugh, Yi Duann, Kyu-Hyun Chae, Enrico Di Teodoro, Konstantin Haubner, Meng Hua Kuo, Chung-Ming Ko

9. [Field-level multi-tracers simulation-based inference of cosmological parameters from 3D maps](#user-content-link9)
**Authors:** Giulio Scelfo, Satvik Mishra, Mauro Rigo, Roberto Trotta, Matteo Viel

10. [First Light and Reionization Epoch Simulations (FLARES) XXII: UV-dust spatial offsets at the Epoch of Reionisation](#user-content-link10)
...
11. [NISER-IUCAA New Simulations of JWST GAlaxies and Quasars(NINJA): Properties of galaxies at $5 \leq z \leq 10$](#user-content-link11)
**Authors:** Ranit Behera, Raghunathan Srianand, Nishikanta Khandai, Prakash Gaikwad

12. [Nearby galaxies in the LOFAR Two-metre Sky Survey IV. A fundamental plane of the radio-SFR relation](#user-content-link12)
**Authors:** V. Heesen, H. W. Edler, M. Br\"uggen, M. Stein, D. J. Bomans, R. Paladino, K. T. Chy\.zy, K. Ma{\l}ek, M. A. Lara-L\'opez, F. S. Tabatabaei

13. [Granulation signatures as seen by Kepler short-cadence data. II. A hierarchical route to inferring stellar radii from granulation](#user-content-link13)
**Authors:** Jens R. Larsen, Mia S. Lundkvist, Guy R. Davies, Martin B. Nielsen

14. [Survival of very small carbonaceous dust grains in the inner-CGM of NGC 891 from JWST/MIRI MRS](#user-content-link14)
**Authors:** J\'er\'emy Chastenet, Ilse De Looze, Karl D. Gordon, Suzanne C. Madden, Monica Rela\~no, Karin M. Sandstrom, Dries Van De Putte, Maarten Baes, Simone Bianchi, Alberto D. Bolatto, Viviana Casasola, Daniel A. Dale, Sara Duval, Jacopo Fritz, Fr\'ed\'eric Galliano, Simon C. O. Glover, Stavroula Katsioli, Vasileios Katsis, Florian Kirchschlager, Ralf S. Klessen, Rebecca C. Levy, Sharon E. Meidt, Aleksandr V. Mosenkov, Kentaro Nagamine, Lara Pantoni, Helena M. Richie, Stefanie Walch, Thomas G. Williams, Emanuele M. Xilouris

15. [Temperature-resolved sensitivities of $^{56}{\rm Ni}$ production to helium-burning reactions in pair-instability supernovae](#user-content-link15)
**Authors:** Hiroki Kawashimo, Nobuya Nishimura, Yudai Suwa

16. [White dwarf planetary systems in the ultraviolet](#user-content-link16)
**Authors:** Jamie Williams, Amy Bonsor, Boris G\"ansicke, Joseph Guidry, JJ Hermes, Lou Baya Ould Rouis, Laura Rogers, Pier-Emmanuel Tremblay, Snehalata Sahu, Andrew Swan, David Wilson, Siyi Xu

17. [Bar-halo interaction: the role of orbital anisotropy](#user-content-link17)
**Authors:** Gherghinescu Paula, Frankgoudi Francesca, Deason Alis

18. [Limited imprint of high-mass IMF variations on sodium abundances in main-sequence galaxies](#user-content-link18)
...
19. [The pollution from massive AGB stars favoured by strong hot bottom burning](#user-content-link19)
**Authors:** Paolo Ventura, Francesca D'Antona

20. [Nuclear Physics of Binary Neutron Star Mergers](#user-content-link20)
**Authors:** Armen Sedrakian

21. [Invariant manifolds in barred galaxy simulations. II. Quantitative evidence of manifold-trapping in spiral arm formation](#user-content-link21)
**Authors:** Toni Soler-Terricabras, Merc\`e Romero-G\'omez, Santi Roca-F\`abrega

22. [Strong-lensing degeneracies of black holes embedded in self-interacting scalar field dark matter halos](#user-content-link22)
**Authors:** Mohsen Fathi, Gabriel G\'omez

23. [From supernovae to neutron stars: crust formation time](#user-content-link23)
**Authors:** Yudai Suwa (U. Tokyo, YITP), Ken'ichiro Nakazato (Kyushu U.)

24. [The Role of Whistler and Ion Cyclotron Waves in Particle Escape from Mirror Modes in the Intracluster Medium](#user-content-link24)
**Authors:** Petr Ugarov, Francisco Ley, Ellen Zweibel

25. [Cosmological Constraints from Bias-Robust Wavelet Scattering Statistics for Stage-IV Galaxy Surveys](#user-content-link25)
**Authors:** Zhujun Jiang, Xu Xiao, Fenfen Yin, Xiao-Dong Li, Le Zhang

26. [Constraining Scattering Medium Geometry with Cyclic Spectroscopy](#user-content-link26)
**Authors:** Jacob E. Turner

27. [OH/IR stars in the inner Galactic bulge: I. Colour, CO line, and stellar light curve characteristics](#user-content-link27)
...
28. [Magnetic field Topology and Star Formation in the Cepheus B Filamentary cloud under External Feedback](#user-content-link28)
...
29. [A Fast Method to Compute Scalar Induced Gravitational Waves on a Lattice with Primordial Non-Gaussianities](#user-content-link29)
**Authors:** Giovanni Piccoli

30. [$w_0$-probe: A new diagnostic of dark energy based on $Om$](#user-content-link30)
**Authors:** Satadru Bag, Ryan E. Keeley, Varun Sahni, Arman Shafieloo

31. [Future Detections of the Warm-Hot Intergalactic Medium using Bright Power Law Sources with NewAthena](#user-content-link31)
**Authors:** Joseph Fisher, Antonio Martin-Carrillo, Thomas Dauser, J\"orn Wilms, Joop Schaye, Didier Barret

32. [Electromagnetic Signatures From Primordial Black Holes in the Solar System](#user-content-link32)
**Authors:** Alexandra P. Klipfel, David I. Kaiser

33. [Heavy element enrichment of gas in surface-accretion disks: A possible origin of the mass-metallicity anti-correlation in exoplanets](#user-content-link33)
**Authors:** Yoshitaka Ikeda, Kazumasa Ohno, Satoshi Okuzumi

34. [GWTC-5.0: Constraints on the Cosmic Expansion Rate and Modified Gravitational-wave Propagation](#user-content-link34)
**Authors:** The LIGO Scientific Collaboration, the Virgo Collaboration, the KAGRA Collaboration

35. [Supermassive Black Holes: modelling strongly and weakly magnetised misaligned accretion disks](#user-content-link35)
**Authors:** Joshua Samuel Stanway, Cora Prather, Derek Ward-Thompson, Timothy J. Walton, Brett Patterson, Hyerin Cho

36. [Constraints on Dynamical Dark Energy from Multiple Probes in the Full Dark Energy Survey](#user-content-link36)
...
37. [A Minute-Cadence Deep Bulge Survey: First Data Release of DREAMS](#user-content-link37)
**Authors:** Hongjing Yang, Weicheng Zang, Francisco Valdes, Qiyue Qian, Yuchen Tang, Zhixing Li, Yuxin Shang, Shude Mao, Yaosong Yu, Guillermo Damke, Alfredo Zenteno, Steve Heathcote, Konstantina Boutsia, Andong Xu, Hao Ma, Jiyuan Zhang, Hongyu Li, Xikai Shan, Przemek Mr\'oz, Xiurui Zhao, Andrew Gould, Jennifer C. Yee, Chung-Uk Lee, Matthew Penny, Sean Terry, Patrick Tamburo, Tim Cunningham, Quanzhi Ye, Eric W. Peng, Rachel Street, Katarzyna Kruszy\'nska, Etienne Bachelet, Yiannis Tsapras, Markus Hundertmark

38. [Spectra and Ionization Efficiencies of Charged Decay Particles in Kilonova Ejecta](#user-content-link38)
**Authors:** L. N. Van den Berg, K. Hotokezaka

39. [Inversion of CHASE H$\alpha$ Spectral Line during Solar Flares Based on RADYN Dataset via Deep Learning](#user-content-link39)
**Authors:** W. Xu, Q. Hao, Z. Zheng, J. Hong, J. Hu, Y. Qiu, C. Li, M. D. Ding, C. Fang

40. [Strong Constraints on Millisecond Pulsar Injection Spectra from Fermi-LAT Observations of the Galactic Center](#user-content-link40)
**Authors:** Jordan Koechler, Pedro De la Torre Luque, Mattia Di Mauro

41. [From Hubble to HWO: Bridging the Frontier of White Dwarf Exoplanet Science](#user-content-link41)
...
42. [Constraining Early Dark Energy cosmological models with Big Bang Nucleosynthesis](#user-content-link42)
**Authors:** Teodora M. Matei, Cristian Croitoru, Tiberiu Harko

43. [Hybrid Expansion Cosmology in f(T) Gravity: Late-Time Evolution and Observational Bounds](#user-content-link43)
**Authors:** Rajalakshmi Jena, Vishal M C, Sankarsan Tarai

44. [Gaussian Process Reconstruction of Cosmological Parameters with Gravitational Wave Sirens using Machine Learning](#user-content-link44)
**Authors:** Gourab Nandi, Anish Ghoshal, David F. Mota

45. [Digging into the Massive Protostar S255IR NIRS3: A Study of Nitrogen-Bearing Molecules and Their Prebiotic Chemistry](#user-content-link45)
**Authors:** Arijit Manna, Sabyasachi Pal, Tapas Baug, Ariful Hoque, Sandip Dutta, Sekhar Sinha, Sushanta Kumar Mondal

46. [Exploring Space Weather From Young Solar-like Stars as Windows to Exoplanetary Habitability](#user-content-link46)
...
47. [Observations of stable pickup He$^+$ tori in a magnetic flux rope at 0.85 au](#user-content-link47)
**Authors:** Chaoran Gu, Lars Berger, Verena Heidrich-Meisner, Erik Jentsch, Robert F. Wimmer-Schweingruber, Lars Seimetz

48. [The first near-infrared high-resolution \'echelle spectroscopy of the outflow in NGC 4151. A study of the clouds covering the Eye of Sauron](#user-content-link48)
...
49. [Bimodality in Rotational Modulation of Planet-Hosting Stars](#user-content-link49)
**Authors:** Alexandre Ara\'ujo, Adriana Valio

50. [NuSTAR as an Axion Helioscope: probing axion-nucleon and axion-electron couplings](#user-content-link50)
**Authors:** Tiziano Zanzarella, Francisco R. Cand\'on, Maurizio Giannotti, Marco Regis, Jaime Ruz, Marco Taoso, Elisa Todarello, Julia K. Vogel

51. [GWTC-5.0: Observations from the Second Part of the Fourth LIGO-Virgo-KAGRA Observing Run and Updates to the Gravitational-Wave Transient Catalog](#user-content-link51)
**Authors:** The LIGO Scientific Collaboration, the Virgo Collaboration, the KAGRA Collaboration

52. [A distributed resource-adaptive implementation of the widefield radio-interferometric measurement model for scalable image formation](#user-content-link52)
**Authors:** Arwa Dabbech, Yves Wiaux

53. [Looking for Condensed Gluons: A Cross-Scale Journey from the Deep Structure of Protons to High-Energy Cosmic Rays -- A Mini-Review](#user-content-link53)
**Authors:** Wei Zhu, Yu-Chen Tang, Ye-Yin Zhao, Bo Yang, Yu-Chen Xiong

54. [Charging Across the Phantom Divide with Modified Gravity](#user-content-link54)
**Authors:** Rodrigo Calderon, Eric V. Linder

55. [Veiling of Photosphere Lines in the Spectra of UX ORI Stars at Deep Light Minima. I. The Star RR Tau](#user-content-link55)
**Authors:** P. O. Dimitrieva, L. V. Tambovtseva, V. P. Grinin

56. [Constraining the Supernova Remnant Environment of FRB 190520B with Dispersion Measure and Scattering Timescale](#user-content-link56)
**Authors:** Jia-Peng Wei, Chen Deng, Gwenael Giacinti, Ze-Cheng Zou, Chen-Ran Hu, Yong-Feng Huang, Jin-Jun Geng

57. [The SPHERE infrared survey for exoplanets (SHINE) V. Full sample characterization](#user-content-link57)
**Authors:** V. Squicciarini, S. Desidera, G. Chauvin, F. Kiefer, V. D'Orazi, C. Fontanive, A. Vigan, D. Nardiello, S. Messina, D. Albert, S. Bergeon, J. -L. Beuzit, B. Biller, A. Boccaletti, M. Bonavita, M. Bonnefoy, W. Brandner, F. Cantalloube, A. Cheetham, P. Delorme, C. Dominik, M. Feldt, R. Galicher, R. Gratton, J. Hagelberg, Th. Henning, M. Janson, E. Lagadec, A. -M. Lagrange, M. Langlois, C. Lazzoni, H. Le Coroller, R. Ligi, A. -L. Maire, G. -D. Marleau, F. M\'enard, D. Mesa, N. Meunier, M. Meyer, C. Mordasini, C. Moutou, A. M\"uller, C. Perrot, M. Samland, H. M. Schmid, T. Schmidt, E. Sissa, M. Turatto, S. Udry, A. Zurlo, L. Abe, J. Antichi, A. Baruffolo, P. Baudoz, J. Baudrand, A. Bazzon, P. Blanchard, A. J. Bohn, M. Carbillet, M. Carle, E. Cascone, J. Charton, R. Claudi, A. Costille, V. De Caprio, A. Delboulb\'e, K. Dohlen, N. Engler, D. Fantinel, P. Feautrier, T. Fusco, P. Gigan, J. H. Girard, E. Giro, D. Gisler, L. Gl\"uck, C. Gry, N. Hubin, E. Hugot, M. Jaquet, M. Kasper, D. Le Mignant, M. Llored, F. Madec, Y. Magnard, P. Mart\'inez, D. Maurel, O. M\"oller-Nilsson, D. Mouillet, T. Moulin, A. Orign\'e, A. Pavlov, D. Perret, C. Petit, J. Pragt, P. Puget, P. Rabou, J. Ramos, F. Rigal, S. Rochat, R. Roelfsema, G. Rousset, A. Roux, B. Salasnich, J. -F. Sauvage, A. Sevin, C. Soenke, E. Stadler, M. Su\'arez, Z. Wahhaj, L. Weber, F. Wildi

58. [The role of the Hubble Space Telescope in advancing our understanding of atmospheric escape in exoplanets](#user-content-link58)
**Authors:** Leonardo A. Dos Santos, Arika Egan, Kevin France, Eric Gaidos, Antonio Garc\'ia Mu\~noz, R. O. Parke Loyd, Keighley Rockcliffe, Mercedes L\'opez-Morales, P. Christian Schneider, Arif Solmaz, Michael Zhang, Vladimir S. Airapetian, Munazza K. Alam, Laura N. R. do Amaral, Tommi Koskinen, Seth Redfield, Jake D. Turner

59. [Open Data from LIGO, Virgo, and KAGRA through the Second Part of the Fourth Observing Run](#user-content-link59)
**Authors:** The LIGO Scientific collaboration, the Virgo collaboration, the KAGRA collaboration

60. [Mars, a Post-Habitable Planet?](#user-content-link60)
**Authors:** Matteo Crismani, Richard Cartwright, Michael Chaffin, Sara Faggi, Stephanie Milam, Geronimo Villanueva

61. [GWTC-5.0: Methods for Identifying and Characterizing Gravitational-wave Transients](#user-content-link61)
**Authors:** The LIGO Scientific Collaboration, the Virgo Collaboration, the KAGRA Collaboration

62. [Improved Big Bang Nucleosynthesis constraints on decaying massive relics](#user-content-link62)
**Authors:** Sara Bianco, Jonas Frerick, Marco Hufnagel, Kai Schmidt-Hoberg

63. [The Simons Observatory: Rotation Performance of Cryogenic Half-Wave Plate Polarization Modulators](#user-content-link63)
**Authors:** Kyohei Yamada, Bryce Bixler, Junna Sugiyama, Daichi Sasaki, Yuki Sakurai, Kam Arnold, Samuel Day-Weiss, Nicholas Galitzki, Bradley R. Johnson, Akito Kusaka, Lyman A. Page, Yoshinori Sueno

64. [Regular black hole solutions and the quark chemical potential at the QCD phase transition](#user-content-link64)
**Authors:** G. Lambiase, A. Ovgun, V. Vertogradov

65. [Effective Phantom Dark Energy: What Cosmological Reconstruction Does and Does Not Imply](#user-content-link65)
**Authors:** Swagat S. Mishra

66. [Energy extraction from NED-deformed rotating black holes via the Comisso-Asenjo reconnection process](#user-content-link66)
**Authors:** Marco Figliolia (Universita degli Studi di Salerno and INFN Gruppo Collegato di Salerno, Italy), Gaetano Lambiase (Universita degli Studi di Salerno and INFN Gruppo Collegato di Salerno, Italy), Ali \"Ovg\"un (Eastern Mediterranean University, Famagusta, Turkiye), R. C. Pantig (Mapua University, Manila, Philippines)

67. [Inflatable devices for planetary aerocapture and aerobraking manoeuvres](#user-content-link67)
**Authors:** Philippe Reynier

68. [A Modified Multi-Level Tracking Scheme for the Detection of Sunspot Umbral Dots](#user-content-link68)
**Authors:** Rohan Eugene Louis, Amit Chaturvedi

69. [Analysis of Short-term Solar Activity Variability and Estimating the Timings of the Next Enhanced Bursts](#user-content-link69)
**Authors:** Juie Shetye, Mausumi Dikpati

---

## 1. [The DECam MAGIC Survey $-$ Mapping the Ancient Galaxy in CaHK: Overview and Summary of Early Science](https://arxiv.org/abs/2605.26581) <a id="link1"></a>

**ArXiv ID:** 2605.26581

**Authors:** A. Chiti, A. Drlica-Wagner, A. B. Pace, W. Cerny, K. R. Atzberger, F. O. Barbosa, J. A. Carballo-Bello, H. Q. Do, A. P. Ji, G. Limberg, A. M. Luna, C. E. Mart\'inez-V\'azquez, V. M. Placco, D. S. Prabhu, G. S. Stringfellow, A. K. Vivas, A. R. Walker, S. N. Campana, J. L. Carlin, V. Chandra, D. Crnojevi\'c, P. S. Ferguson, J. J. Hermes, N. Kallivayalil, G. E. Medina, M. Navabi, N. E. D. No\"el, A. H. Riley, D. J. Sand, C. W. Skeffington, K. Tavangar, J. F. Wu, Y. Choi, D. Erkal, D. J. James, T. S. Li, P. Massana, B. Mutlu-Pakdil, D. L. Nidever, K. A. G. Olsen, J. D. Sakowska, L. Santana-Silva, J. D. Simon, E. Tollerud, A. Zenteno

**Abstract:** We present the DECam Mapping the Ancient Galaxy in CaHK (MAGIC) survey, a 54-night NOIRLab Survey Program to image $\gtrsim$5,000$\,$deg$^2$ of the southern hemisphere using a metallicity-sensitive narrow-band filter covering the Ca$\,$ii$\,$H&K lines centered at 3955$\,$A. This filter is installed on the Dark Energy Camera (DECam), mounted on the 4-m NSF V\'{i}ctor M. Blanco Telescope. The survey reaches typical $10\sigma$ depths of $\text{mag}_{\text{CaHK}} \approx 22.5$, 3$-$4$\,$mag deeper than comparable surveys in the southern hemisphere. By combining photometry from this Ca$\,$ii$\,$H&K filter with existing DECam $g,r,i$ broadband photometry from the DECam Local Volume Exploration (DELVE) survey, MAGIC is deriving photometric metallicities for red giant branch stars down to the magnitude limit of usable proper motions from Gaia data release 3 (DR3). MAGIC has already imaged $\sim$3,000$\,$deg$^2$, supplemented by other affiliated observing programs that have used this filter to image star clusters, dwarf galaxies, and stellar streams. We overview MAGIC's survey strategy, describe data processing through the derivation of metallicities and photometric distances, and summarize early science results that have been published with this dataset. In addition, we present several new results, including the confirmation of a distant ($>5\,r_h$) member of the Reticulum II ultra-faint dwarf galaxy, on-sky density maps of low-metallicity stars into the distant Milky Way halo ($\sim150\,$kpc) recovering 13/14 ultra-faint dwarf galaxies in the current footprint, and a validation of our initial targeting of extremely metal-poor stars. Collectively, these results demonstrate that the MAGIC dataset enables cutting-edge studies of the faint, low-metallicity regime of the Milky Way and its substructures.

**Comment:** The DECam MAGIC survey is directly relevant to near-field cosmology, mapping the Milky Way halo and its substructures, including dwarf galaxies and ultra-faint satellites. It also enables studies of resolved star formation histories and metallicities in the Milky Way halo. Multiple criteria are matched: 'Near-Field Cosmology', 'Resolved Star Formation Histories', and 'Satellite Luminosity Function'.
...
## 2. [For modified gravity, it's the LITTLE THINGS that matter](https://arxiv.org/abs/2605.27217) <a id="link2"></a>
...
**Comment:** This paper directly addresses the core-cusp problem in dwarf galaxies, comparing MOND and dark matter halo models using LITTLE THINGS and SPARC samples. It is highly relevant to near-field cosmology and dark matter density profiles in dwarf galaxies.
...
## 3. [A framework for modelling Population III stars in cosmological simulations](https://arxiv.org/abs/2605.26206) <a id="link3"></a>
...
**Comment:** This paper presents a new framework for modeling Population III stars in cosmological simulations, including stellar evolutionary tracks and feedback. It is highly relevant to stellar models and numerical galaxy simulations, with direct application to early galaxy evolution.
...
## 4. [Looking into the faintEst WIth MUSE (LEWIS): Exploring the nature of ultra-diffuse galaxies in the Hydra-I cluster. VI. A star-forming UDG in Hydra I: a rare UDG or a transition phase?](https://arxiv.org/abs/2605.27109) <a id="link4"></a>
...
**Comment:** This paper analyzes a star-forming ultra-diffuse galaxy (UDG) in the Hydra-I cluster, focusing on its star formation history, environmental effects, and possible tidal interactions. It is relevant to near-field cosmology (UDGs as low-mass galaxies), resolved star formation histories, and star formation quenching in dwarfs.
...
## 5. [How galaxies acquire their stellar mass at high redshift: High star formation efficiencies and the relative roles of dust and initial mass function](https://arxiv.org/abs/2605.26209) <a id="link5"></a>
...
**Comment:** Presents a semi-empirical model for star formation histories of high-redshift galaxies, including star formation efficiency, dust, and IMF variations. Directly matches 'Resolved Star Formation Histories' and 'Numerical Galaxy Simulations' criteria, with additional relevance to star formation quenching and galaxy evolution.
...
## 6. [Unveiling the dark matter nature with reionization relics](https://arxiv.org/abs/2605.26518) <a id="link6"></a>
...
**Comment:** The paper discusses constraints on warm dark matter using reionization relics and the Lyman-alpha forest, with explicit mention of Milky Way satellite galaxies and stellar streams as current constraints. This directly matches the 'Near-Field Cosmology' criterion, especially the satellite luminosity function and substructure.
...
## 7. [Cosmic Ray Feedback in Galactic Disks: Star Formation, Cosmic Ray Transport, and Multiphase Outflows in \tigresspp\ Simulations](https://arxiv.org/abs/2605.26238) <a id="link7"></a>
...
**Comment:** This paper presents new high-resolution simulations of galactic disks including cosmic ray transport and examines star-formation-driven multiphase outflows, with explicit measurement of mass-loading factors. This directly matches the 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria, with increased weight due to inclusion of new physics (cosmic rays).
...
## 9. [Field-level multi-tracers simulation-based inference of cosmological parameters from 3D maps](https://arxiv.org/abs/2605.26210) <a id="link9"></a>
...
**Comment:** This paper develops a simulation-based inference pipeline for cosmological parameters using galaxy and HI maps, leveraging hydrodynamical simulations. It is relevant to numerical galaxy simulations, especially high-resolution and multi-tracer approaches.
...
## 10. [First Light and Reionization Epoch Simulations (FLARES) XXII: UV-dust spatial offsets at the Epoch of Reionisation](https://arxiv.org/abs/2605.27370) <a id="link10"></a>
...
**Comment:** Uses FLARES simulations to study UV-FIR spatial offsets in high-redshift galaxies, connecting star formation history, dust, and metallicity. Matches 'Numerical Galaxy Simulations' and 'Resolved Star Formation Histories' criteria, with relevance to galaxy evolution and star formation processes.
...
## 11. [NISER-IUCAA New Simulations of JWST GAlaxies and Quasars(NINJA): Properties of galaxies at $5 \leq z \leq 10$](https://arxiv.org/abs/2605.26211) <a id="link11"></a>
...
**Comment:** This paper presents new cosmological hydrodynamical simulations (NINJA) of galaxy formation and evolution at high redshift, including feedback prescriptions and dust models. It directly matches the 'Numerical Galaxy Simulations' criterion, with additional relevance for star formation histories and feedback.
...
## 12. [Nearby galaxies in the LOFAR Two-metre Sky Survey IV. A fundamental plane of the radio-SFR relation](https://arxiv.org/abs/2605.27149) <a id="link12"></a>
...
**Comment:** This paper calibrates the radio-SFR relation in nearby galaxies, including dwarf galaxies, and discusses implications for galaxy simulations that include cosmic rays and magnetic fields. It directly matches the 'Resolved Star Formation Histories' and 'Numerical Galaxy Simulations' criteria, as well as touches on 'Star Formation Driven Outflows' through cosmic-ray transport. The unified radio-SFR relation is a substantial improvement for extinction-free SFR tracing and simulation testing.
...
## 13. [Granulation signatures as seen by Kepler short-cadence data. II. A hierarchical route to inferring stellar radii from granulation](https://arxiv.org/abs/2605.26742) <a id="link13"></a>
...
**Comment:** This paper presents a new method for inferring stellar radii from granulation signals, which is closely related to the 'Stellar Models' criterion, as it connects granulation (a stellar property) to fundamental parameters and is applicable to large datasets.
...
## 14. [Survival of very small carbonaceous dust grains in the inner-CGM of NGC 891 from JWST/MIRI MRS](https://arxiv.org/abs/2605.26864) <a id="link14"></a>
...
**Comment:** This paper examines the survival of PAHs in the inner CGM of NGC 891, a massive spiral galaxy. While it discusses the CGM and galactic outflows, the focus is on a high-mass galaxy and dust processing, not dwarf galaxies or satellite systems. The connection to star-formation-driven outflows and CGM is present but weighted lower due to galaxy mass.
...
## 15. [Temperature-resolved sensitivities of $^{56}{\rm Ni}$ production to helium-burning reactions in pair-instability supernovae](https://arxiv.org/abs/2605.27264) <a id="link15"></a>
...
**Comment:** The paper presents new methods for understanding nucleosynthesis in pair-instability supernovae, focusing on stellar models and reaction rates. While it deals with stellar models, it is not directly about evolutionary tracks or atmospheres, nor does it address galaxy-scale topics.
...
## 16. [White dwarf planetary systems in the ultraviolet](https://arxiv.org/abs/2605.26152) <a id="link16"></a>
...
**Comment:** This paper focuses on the composition of exo-planetesimals around white dwarfs using ultraviolet spectroscopy. While it discusses stellar atmosphere models and interior structure models, it does not present new stellar models or bolometric corrections, nor does it address near-field cosmology, resolved star formation histories, quenching, galaxy simulations, outflows, or the CGM. The relevance is borderline due to the connection to stellar atmosphere modeling, but the focus is on planetary system remnants rather than the core topics.
...
## 17. [Bar-halo interaction: the role of orbital anisotropy](https://arxiv.org/abs/2605.26225) <a id="link17"></a>
...
**Comment:** This paper studies bar-halo interactions and orbital anisotropy in the Milky Way, focusing on the stellar halo and phase-space substructure. While it touches on halo substructure, the main focus is on bar dynamics and halo response, which is not directly relevant to near-field cosmology or satellite galaxies. The relevance is borderline due to some connection to halo substructure.
...
## 18. [Limited imprint of high-mass IMF variations on sodium abundances in main-sequence galaxies](https://arxiv.org/abs/2605.26221) <a id="link18"></a>
...
**Comment:** This paper uses semi-analytic simulations and stellar models to study the impact of IMF variations on sodium abundances in main-sequence galaxies. While it involves stellar models and star formation histories, the focus is on chemical evolution and IMF diagnostics in galaxies more massive than dwarfs (10^9-10^11 Msun), not specifically on dwarf galaxies or resolved star formation histories. The relevance is borderline due to the use of stellar models and semi-analytic simulations, but the main focus is not on the core topics.
...
## 19. [The pollution from massive AGB stars favoured by strong hot bottom burning](https://arxiv.org/abs/2605.27160) <a id="link19"></a>
...
**Comment:** Reviews the pollution from massive AGB stars and their role in globular clusters and primordial galaxies. Some relevance to stellar models and chemical evolution, but not presenting new models or tracks. Borderline relevance due to discussion of stellar evolution and nucleosynthesis.
...
## 20. [Nuclear Physics of Binary Neutron Star Mergers](https://arxiv.org/abs/2605.26308) <a id="link20"></a>
...
**Comment:** This review covers nuclear physics in binary neutron star mergers, including the equation of state and r-process nucleosynthesis. While it discusses stellar and nuclear physics, it does not present new stellar models or address galaxy-scale topics.
...
## 21. [Invariant manifolds in barred galaxy simulations. II. Quantitative evidence of manifold-trapping in spiral arm formation](https://arxiv.org/abs/2605.26722) <a id="link21"></a>
...
**Comment:** The paper presents numerical galaxy simulations of barred galaxies, focusing on spiral arm formation via invariant manifolds. While it is a theoretical work presenting new numerical simulations, it focuses on massive spiral galaxies and bar dynamics, which are specifically listed as irrelevant. There is no connection to dwarf galaxies, satellite systems, or the other core topics.
...
## 22. [Strong-lensing degeneracies of black holes embedded in self-interacting scalar field dark matter halos](https://arxiv.org/abs/2605.27242) <a id="link22"></a>
...
**Comment:** Examines strong lensing by black holes embedded in dark matter halos, focusing on supermassive black holes (M87*, Sgr A*). While it touches on dark matter, it is not about galaxy substructure or near-field cosmology, and is not relevant to the core topics.
...
## 23. [From supernovae to neutron stars: crust formation time](https://arxiv.org/abs/2605.26692) <a id="link23"></a>
...
**Comment:** Analytic estimate for crust formation time in neutron stars. Focus is on stellar remnants and cooling, not stellar models or galaxy evolution.
...
## 24. [The Role of Whistler and Ion Cyclotron Waves in Particle Escape from Mirror Modes in the Intracluster Medium](https://arxiv.org/abs/2605.26387) <a id="link24"></a>
...
**Comment:** Studies particle escape from mirror modes in the intracluster medium, focusing on plasma waves. This is relevant to cluster physics but not to galaxy evolution, near-field cosmology, or stellar models.
...
## 25. [Cosmological Constraints from Bias-Robust Wavelet Scattering Statistics for Stage-IV Galaxy Surveys](https://arxiv.org/abs/2605.27087) <a id="link25"></a>
...
**Comment:** The paper introduces a new bias-robust statistic for cosmological parameter inference from galaxy surveys, but it is focused on large-scale structure and cosmological constraints, not on near-field cosmology, resolved star formation histories, or galaxy simulations. No direct match to the core criteria.
...
## 26. [Constraining Scattering Medium Geometry with Cyclic Spectroscopy](https://arxiv.org/abs/2605.26229) <a id="link26"></a>
...
**Comment:** This paper uses cyclic spectroscopy to measure the geometry of the scattering medium for a millisecond pulsar, focusing on ISM structure and pulsar emission scattering. While it is related to the ISM, it does not address the circumgalactic medium of dwarf galaxies or any of the core topics.
...
## 27. [OH/IR stars in the inner Galactic bulge: I. Colour, CO line, and stellar light curve characteristics](https://arxiv.org/abs/2605.26605) <a id="link27"></a>
...
**Comment:** This paper examines mass-loss characteristics of AGB stars in the inner Galactic bulge, focusing on CO line emission and stellar light curves. While it involves stellar evolution and mass loss, it is centered on the Galactic bulge and not on dwarf galaxies or satellite systems. It does not present new stellar models or address resolved star formation histories in galaxies, so it is only tangentially relevant.
...
## 28. [Magnetic field Topology and Star Formation in the Cepheus B Filamentary cloud under External Feedback](https://arxiv.org/abs/2605.26810) <a id="link28"></a>

**ArXiv ID:** 2605.26810

**Authors:** Panigrahy Sandhyarani, Chakali Eswaraiah, Manash R. Samal, Vineet Rawat, Jihye Hwang, Jia-Wei Wang, Yuehui Ma, Patricio Sanhueza, Jessy Jose

**Abstract:** We present a detailed study of the Cep B molecular cloud based on sub-mm dust polarization and $^{13}$CO (J=3--2) spectral line observations obtained with SCUBA-2/POL-2 and HARP on the James Clerk Maxwell Telescope (JCMT). The 850 $\mu$m dust continuum map reveals a prominent filamentary structure oriented Northwest--Southeast (NW-SE), with the magnetic field (B-field) displaying a distinct morphology-curving into a bow-like shape near the filament head and aligning along the spine toward the tail. The filament is thermally supercritical, with its line mass exceeding the critical value for an isothermal filament, indicating that self-gravity drives radial contraction. The mass-to-flux ratio suggests that the filament is magnetically subcritical on global scales, implying that B-fields provide significant support against collapse. Despite this, the presence of dense cores and embedded star formation indicates that collapse proceeds locally. The observed core spacing spans a range of values, with the largest separations comparable to the expected fragmentation scale for a self-gravitating filament undergoing sausage instability, suggesting that gravitational instability sets the primary fragmentation scale. Smaller separations and non-uniform spacing may indicate the influence of local variations and hierarchical fragmentation. Overall, Cep B represents a system in which gravity drives fragmentation, B-fields regulate its evolution, and external feedback shapes both its morphology and star formation activity at the head of the filament.

**Comment:** This paper presents a study of star formation and magnetic fields in the Cepheus B molecular cloud, focusing on fragmentation, magnetic support, and external feedback. While it discusses star formation and feedback, it is not galaxy-scale and does not address resolved star formation histories, quenching, or outflows in galaxies. No criteria match closely.
...
## 29. [A Fast Method to Compute Scalar Induced Gravitational Waves on a Lattice with Primordial Non-Gaussianities](https://arxiv.org/abs/2605.27231) <a id="link29"></a>
...
**Comment:** This paper presents a fast method for computing scalar induced gravitational waves with primordial non-Gaussianities, which is not directly related to galaxy evolution, star formation histories, or near-field cosmology.
...
## 30. [$w_0$-probe: A new diagnostic of dark energy based on $Om$](https://arxiv.org/abs/2605.27230) <a id="link30"></a>
...
**Comment:** Introduces a new diagnostic for dark energy based on Om(z). Focus is on cosmological parameters and dark energy, not near-field cosmology or galaxy evolution.
...
## 33. [Heavy element enrichment of gas in surface-accretion disks: A possible origin of the mass-metallicity anti-correlation in exoplanets](https://arxiv.org/abs/2605.27289) <a id="link33"></a>
...
**Comment:** The paper discusses heavy element enrichment in protoplanetary disks and the mass-metallicity anti-correlation in exoplanets. This is focused on planet formation and disk chemistry, not galaxy evolution, star formation histories, or near-field cosmology.
...
## 34. [GWTC-5.0: Constraints on the Cosmic Expansion Rate and Modified Gravitational-wave Propagation](https://arxiv.org/abs/2605.27227) <a id="link34"></a>
...
**Comment:** This paper uses gravitational wave sources to constrain the Hubble constant and tests modified gravity, but does not focus on galaxy evolution, star formation histories, or near-field cosmology.
...
## 35. [Supermassive Black Holes: modelling strongly and weakly magnetised misaligned accretion disks](https://arxiv.org/abs/2605.27334) <a id="link35"></a>
...
**Comment:** Numerical study of misaligned accretion disks around supermassive black holes. Focus is on black hole accretion physics, not galaxy simulations or stellar models. Irrelevant to core topics.
...
## 36. [Constraints on Dynamical Dark Energy from Multiple Probes in the Full Dark Energy Survey](https://arxiv.org/abs/2605.27221) <a id="link36"></a>
...
**Comment:** The paper presents constraints on dynamical dark energy using multiple probes from the Dark Energy Survey. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or stellar models.
...
## 37. [A Minute-Cadence Deep Bulge Survey: First Data Release of DREAMS](https://arxiv.org/abs/2605.27364) <a id="link37"></a>
...
**Comment:** DREAMS is a deep bulge survey focused on microlensing and rapid stellar variability in the Galactic bulge. The main science goal is the detection of free-floating planets and short-duration variables, not near-field cosmology, resolved star formation histories, or galaxy simulations. The relevance is low.
...
## 38. [Spectra and Ionization Efficiencies of Charged Decay Particles in Kilonova Ejecta](https://arxiv.org/abs/2605.26613) <a id="link38"></a>

**ArXiv ID:** 2605.26613

**Authors:** L. N. Van den Berg, K. Hotokezaka

**Abstract:** Ionization by radioactive decay products including $\alpha$-particles, $\beta$-decay electrons, and fission fragments plays a central role in determining the nebular-phase ionization state and spectra of kilonovae. In this work, ionization cross sections, stopping powers, thermalization histories, and particle degradation spectra are calculated self-consistently for $\alpha$-particles and fission fragments propagating through expanding kilonova ejecta. The treatment includes interactions with bound and free electrons, charge evolution of fission fragments, adiabatic energy losses, and particle spectra obtained from the continuous slowing-down approximation and Spencer--Fano formalism. The work per ion pair is evaluated for a range of ejecta compositions and ionization states. Despite the large differences in mass, charge, and injection energy between $\beta$-electrons, $\alpha$-particles, and fission fragments, the resulting work per ion pair is found to be remarkably similar across all decay channels and target species considered. In particular, heavy-element ions exhibit nearly identical normalized ionization efficiencies for all decay products. This robustness arises because the ionization cross sections and stopping powers are governed by the same underlying collision physics, causing the ratio between ionization and energy loss to remain approximately constant over the relevant energy range. The results imply that the ionization state of late-time kilonova ejecta depends only weakly on the dominant radioactive decay channel, even in ejecta where $\alpha$-decay and fission dominate the heating budget.

**Comment:** This paper focuses on ionization and spectra in kilonova ejecta, which is not related to any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM. The subject is more relevant to transient phenomena and nucleosynthesis.
...
## 39. [Inversion of CHASE H$\alpha$ Spectral Line during Solar Flares Based on RADYN Dataset via Deep Learning](https://arxiv.org/abs/2605.26511) <a id="link39"></a>
...
**Comment:** Applies deep learning to invert H-alpha spectral lines during solar flares using RADYN simulations. This is solar physics and not related to galaxy evolution, stellar models, or any core criteria.
...
## 40. [Strong Constraints on Millisecond Pulsar Injection Spectra from Fermi-LAT Observations of the Galactic Center](https://arxiv.org/abs/2605.26220) <a id="link40"></a>
...
**Comment:** This paper analyzes millisecond pulsars and gamma-ray emission in the Galactic Center, which is not relevant to near-field cosmology or any of the specified galaxy or stellar criteria.
...
## 41. [From Hubble to HWO: Bridging the Frontier of White Dwarf Exoplanet Science](https://arxiv.org/abs/2605.26142) <a id="link41"></a>
...
**Comment:** The focus is on white dwarf exoplanet science and UV spectroscopy for polluted white dwarfs, which is not directly related to any of the core topics such as galaxy simulations, near-field cosmology, or stellar models (tracks/atmospheres).
...
## 42. [Constraining Early Dark Energy cosmological models with Big Bang Nucleosynthesis](https://arxiv.org/abs/2605.26749) <a id="link42"></a>
...
**Comment:** This paper constrains early dark energy models using Big Bang Nucleosynthesis, which is not directly related to any of the core topics such as galaxy simulations, near-field cosmology, or stellar models.
...
## 43. [Hybrid Expansion Cosmology in f(T) Gravity: Late-Time Evolution and Observational Bounds](https://arxiv.org/abs/2605.27196) <a id="link43"></a>
...
**Comment:** This paper investigates cosmological dynamics in f(T) gravity and late-time acceleration, which is not relevant to any of the core topics such as galaxy simulations, near-field cosmology, or stellar models.
...
## 44. [Gaussian Process Reconstruction of Cosmological Parameters with Gravitational Wave Sirens using Machine Learning](https://arxiv.org/abs/2605.27357) <a id="link44"></a>
...
**Comment:** This paper uses machine learning to reconstruct cosmological parameters from gravitational wave sirens, focusing on late-time expansion history and model discrimination. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 45. [Digging into the Massive Protostar S255IR NIRS3: A Study of Nitrogen-Bearing Molecules and Their Prebiotic Chemistry](https://arxiv.org/abs/2605.27177) <a id="link45"></a>
...
**Comment:** The paper studies nitrogen-bearing molecules and prebiotic chemistry in a massive protostar, focusing on astrochemistry and star formation in high-mass protostars. It does not address resolved star formation histories, galaxy simulations, or near-field cosmology.
...
## 46. [Exploring Space Weather From Young Solar-like Stars as Windows to Exoplanetary Habitability](https://arxiv.org/abs/2605.26150) <a id="link46"></a>
...
**Comment:** This paper focuses on space weather from young solar-like stars and its impact on exoplanetary habitability. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM. The focus is on stellar activity and exoplanet environments, which are outside the relevant criteria.
...
## 47. [Observations of stable pickup He$^+$ tori in a magnetic flux rope at 0.85 au](https://arxiv.org/abs/2605.27096) <a id="link47"></a>
...
**Comment:** The paper studies interstellar pickup ions and their velocity distributions in the heliosphere, which does not match any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories. It is more relevant to solar and heliospheric physics.
...
## 48. [The first near-infrared high-resolution \'echelle spectroscopy of the outflow in NGC 4151. A study of the clouds covering the Eye of Sauron](https://arxiv.org/abs/2605.27363) <a id="link48"></a>
...
**Comment:** This paper studies outflows in the Seyfert galaxy NGC 4151, focusing on AGN-driven winds and their response to X-ray flux. The outflows discussed are not star-formation-driven, and the galaxy is much more massive than the LMC. No criteria match closely.
...
## 49. [Bimodality in Rotational Modulation of Planet-Hosting Stars](https://arxiv.org/abs/2605.26197) <a id="link49"></a>
...
**Comment:** The paper analyzes rotational modulation and magnetic activity in planet-hosting stars using Kepler photometry. It does not address resolved star formation histories, stellar models, or any galaxy-scale phenomena.
...
## 50. [NuSTAR as an Axion Helioscope: probing axion-nucleon and axion-electron couplings](https://arxiv.org/abs/2605.26265) <a id="link50"></a>
...
**Comment:** This paper uses solar X-ray observations to constrain axion properties, which is not related to galaxy evolution, star formation, or near-field cosmology.
...
## 51. [GWTC-5.0: Observations from the Second Part of the Fourth LIGO-Virgo-KAGRA Observing Run and Updates to the Gravitational-Wave Transient Catalog](https://arxiv.org/abs/2605.27225) <a id="link51"></a>
...
**Comment:** Catalogs gravitational-wave transients from compact binary coalescences. No connection to galaxy evolution, near-field cosmology, or stellar models.
...
## 52. [A distributed resource-adaptive implementation of the widefield radio-interferometric measurement model for scalable image formation](https://arxiv.org/abs/2605.26347) <a id="link52"></a>
...
**Comment:** The paper presents a computational method for radio interferometric image formation, which is not relevant to any of the core topics such as galaxy simulations, near-field cosmology, or stellar models.
...
## 53. [Looking for Condensed Gluons: A Cross-Scale Journey from the Deep Structure of Protons to High-Energy Cosmic Rays -- A Mini-Review](https://arxiv.org/abs/2605.27018) <a id="link53"></a>
...
**Comment:** This mini-review discusses gluon condensation and its implications for cosmic ray physics and the deep structure of protons. It does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories. The focus is on particle physics and high-energy astrophysics, which are outside the relevant criteria.
...
## 54. [Charging Across the Phantom Divide with Modified Gravity](https://arxiv.org/abs/2605.26259) <a id="link54"></a>
...
**Comment:** This paper discusses modified gravity and dark energy equation of state crossing the phantom divide. It is purely cosmological and does not relate to near-field cosmology, galaxy simulations, or any other listed criteria.
...
## 55. [Veiling of Photosphere Lines in the Spectra of UX ORI Stars at Deep Light Minima. I. The Star RR Tau](https://arxiv.org/abs/2605.26982) <a id="link55"></a>
...
**Comment:** Focuses on veiling of photospheric lines in UX Ori stars, which are young variable stars. This is stellar astrophysics but does not match any of the core criteria (stellar models, resolved star formation histories, etc.).
...
## 56. [Constraining the Supernova Remnant Environment of FRB 190520B with Dispersion Measure and Scattering Timescale](https://arxiv.org/abs/2605.26553) <a id="link56"></a>
...
**Comment:** This paper studies the environment of a fast radio burst (FRB) and its supernova remnant, focusing on dispersion measure and scattering timescales. The work is not related to near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. It is largely outside the core topics.
...
## 57. [The SPHERE infrared survey for exoplanets (SHINE) V. Full sample characterization](https://arxiv.org/abs/2605.27247) <a id="link57"></a>
...
**Comment:** This paper focuses on exoplanet surveys and stellar characterization, which does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on planet formation and stellar properties, not on dwarf galaxies or galaxy-scale processes.
...
## 58. [The role of the Hubble Space Telescope in advancing our understanding of atmospheric escape in exoplanets](https://arxiv.org/abs/2605.26140) <a id="link58"></a>
...
**Comment:** This paper discusses atmospheric escape in exoplanets, focusing on planetary evolution and habitability. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 59. [Open Data from LIGO, Virgo, and KAGRA through the Second Part of the Fourth Observing Run](https://arxiv.org/abs/2605.27090) <a id="link59"></a>
...
**Comment:** This paper describes open data from gravitational wave observatories, which is not relevant to any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 60. [Mars, a Post-Habitable Planet?](https://arxiv.org/abs/2605.26138) <a id="link60"></a>
...
**Comment:** This paper discusses Mars as a post-habitable planet and its implications for planetary habitability and atmospheric evolution, which is not relevant to galaxy evolution, star formation, or near-field cosmology.
...
## 61. [GWTC-5.0: Methods for Identifying and Characterizing Gravitational-wave Transients](https://arxiv.org/abs/2605.27224) <a id="link61"></a>
...
**Comment:** Describes methods for identifying and characterizing gravitational-wave transients. No direct connection to any of the core topics (galaxy evolution, near-field cosmology, etc.).
...
## 63. [The Simons Observatory: Rotation Performance of Cryogenic Half-Wave Plate Polarization Modulators](https://arxiv.org/abs/2605.27056) <a id="link63"></a>
...
**Comment:** This paper describes the performance of cryogenic half-wave plate polarization modulators for the Simons Observatory, which is focused on CMB polarization measurements. It does not address any of the core topics such as galaxy simulations, star formation histories, or dwarf galaxy quenching. The focus is on instrumentation and CMB science, which are outside the relevant criteria.
...
## 64. [Regular black hole solutions and the quark chemical potential at the QCD phase transition](https://arxiv.org/abs/2605.27170) <a id="link64"></a>
...
**Comment:** This paper focuses on black hole interiors and QCD phase transitions, which are unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 65. [Effective Phantom Dark Energy: What Cosmological Reconstruction Does and Does Not Imply](https://arxiv.org/abs/2605.27301) <a id="link65"></a>
...
**Comment:** This paper discusses the interpretation of effective phantom dark energy in cosmological reconstruction, which is unrelated to any of the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 66. [Energy extraction from NED-deformed rotating black holes via the Comisso-Asenjo reconnection process](https://arxiv.org/abs/2605.26369) <a id="link66"></a>
...
**Comment:** This paper studies energy extraction from NED-deformed rotating black holes, focusing on black hole physics and nonlinear electrodynamics. It is unrelated to any of the core topics.
...
## 67. [Inflatable devices for planetary aerocapture and aerobraking manoeuvres](https://arxiv.org/abs/2605.26125) <a id="link67"></a>
...
**Comment:** This paper discusses inflatable devices for planetary aerocapture and aerobraking, which is unrelated to any of the core astrophysics topics listed. It is focused on planetary probe engineering and mission design.
...
## 68. [A Modified Multi-Level Tracking Scheme for the Detection of Sunspot Umbral Dots](https://arxiv.org/abs/2605.26564) <a id="link68"></a>
...
**Comment:** This paper focuses on sunspot umbral dots and solar physics, which is unrelated to any of the core topics (no connection to galaxy evolution, star formation histories, or stellar models relevant to the prompt).
...
## 69. [Analysis of Short-term Solar Activity Variability and Estimating the Timings of the Next Enhanced Bursts](https://arxiv.org/abs/2605.27057) <a id="link69"></a>
...
**Comment:** The paper is about solar activity forecasting and sunspot cycles, which is unrelated to any of the core criteria (no connection to galaxy evolution, star formation histories, or dwarf galaxies).
