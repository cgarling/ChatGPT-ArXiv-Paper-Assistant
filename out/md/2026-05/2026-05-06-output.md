...
1. [Peering down the barrel with DESI DR2: 10 000+ inflows at $z$ < 0.6 reveal how galaxies accrete cold gas](#user-content-link1)
**Authors:** S. Weng, A. Saintonge, Matthew M. Pieri, J. Moustakas, H. Zou, D. Mu\~noz Santos, J. Yu, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, P. Doel, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, Satya Gontcho A. Gontcho, G. Gutierrez, C. Hahn, S. He, K. Honscheid, T. Hu, R. Joyce, R. Kehoe, M. Landriau, L. Le Guillou, A. Meisner, R. Miquel, S. Nadathur, J. A. Newman, W. J. Percival, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, H. Seo, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver

2. [Unifying Transport Models of Thermohaline Convection in Stars](#user-content-link2)
**Authors:** Valentin A. Skoutnev

3. [Environmental Quenching of High-Redshift Galaxies: Interpreting JWST Observations with Simulations](#user-content-link3)
**Authors:** Aleyna D\"oven, Mohammadreza Ayromlou, Cristiano Porciani

4. [PySME v1.0: improved modelling of stellar spectra for survey-scale applications](#user-content-link4)
**Authors:** Mingjie Jian, Nikolai Piskunov, Jeff Valenti, Ella Xi Wang, Brian Thorsbro, Henrik J\"onsson, Ansgar Wehrhahn

5. [Not So Isolated: Green Pea Galaxies in Overdense Environments revealed by VLT/MUSE](#user-content-link5)
**Authors:** A. Arroyo-Polonio, J. M. V\'ilchez, J. Iglesias-P\'aramo, C. Kehrig, E. P\'erez-Montero, R. Amor\'in, B. P\'erez-D\'iaz, M. Hayes, I. Breda, J. S\'anchez Almeida, A. Gim\'enez Alcazar, M. Gonz\'alez-Otero

6. [Built to Rest: The Evolving Star-Forming Main Sequence Requires Episodic Quiescence or Late Assembly](#user-content-link6)
**Authors:** Lucas C. Kimmig, Jesse van de Sande, Rhea-Silvia Remus, Klaus Dolag, Rebecca Davies, Deanne Fisher

7. [Are Nucleosynthetic Yields Universal? Interpreting the Multi-Elemental Abundances of Quiescent Galaxies over Cosmic Time Using Milky Way Stars](#user-content-link7)
**Authors:** Aliza G. Beverage, David H. Weinberg, Mariska Kriek, Nicole Marcelina Gountanis, Andrew B. Newman, Daniel R. Weisz

8. [What is the Strouhal number of turbulence driven by supernovae?](#user-content-link8)
**Authors:** James R. Beattie, Isabelle Connor, Enrico Ramirez-Ruiz

9. [Interpreting Galaxy Physical Properties Using Stellar Population Synthesis](#user-content-link9)
**Authors:** Kenil Rajendrabhai Ajudiya

10. [ArkenstoneBH. A model for high-specific energy black hole feedback in cosmological simulations](#user-content-link10)
...
11. [Reddening maps of the Magellanic Clouds using spectral energy distribution fitting of red giants](#user-content-link11)
**Authors:** H. Netzel, G. Pietrzy\'nski, M. G\'orski, P. Kervella, G. Hajdu, R. Kudritzki, R. Chini, W. Kiviaho, B. Zgirski, P. Wielg\'orski, D. Graczyk, W. Gieren

12. [A Multi-parameter Fuzzy Set Framework for Classifying Red, Blue, and Green Valley Galaxies](#user-content-link12)
**Authors:** Amit Mondal, Biswajit Pandey

13. [Resolving the Multiphase Outflow, Shock Signatures, and PAHs in the AGN-Starburst Composite ULIRG F10565+2448 with JWST MIRI/MRS](#user-content-link13)
...
14. [Uncovering the multi-scale structure of dust distribution in nearby galaxies](#user-content-link14)
**Authors:** E. Tanchon, M. Boquien, J. Chastenet, D. A. Dale, O. V. Egorov, R. Indebetouw, R. S. Klessen, S. E. Meidt, D. Pathak, J. Sutter, D. A. Thilker, A. Amiri, A. T. Barnes, F. Bigiel, I. S. Gerasimov, S. C. O. Glover, K. Grasha, K. L. Larson, J. C. Lee, H. -A. Pan, T. G. Williams

15. [Double Neutron Star Delay Times Across Cosmic Metallicities: The Role of Helium Star Progenitors](#user-content-link15)
...
16. [Primordial Black Hole contribution to the stochastic background of Gravitational Waves](#user-content-link16)
**Authors:** D. Mart\'in-Gonz\'alez

17. [The Significant Role of Hydrogen in the Formation of Silicon Carbide in Evolved Stars](#user-content-link17)
**Authors:** Guillermo Tajuelo-Castilla, Gonzalo Santoro, Lidia Mart\'inez, Pablo Merino, Jos\'e Ignacio Mart\'inez, Pedro L. de Andres, Gary J. Ellis, \'Alvaro Mayoral, Ram\'on J. Pel\'aez, Isabel Tanarro, Marcelino Ag\'undez, Sandra Wiersma, Hassan Sabbah, Jos\'e Cernicharo, Christine Joblin, Jos\'e \'Angel Mart\'in-Gago

18. [Chromosphere of the quiet Sun -- II. Atmospheric response to small-scale magnetic flux emergence](#user-content-link18)
**Authors:** Quentin Noraz, Mats Carlsson, Guillaume Aulanier

19. [Nowhere Left to Hide: Uncovering All of the Massive Young Embedded Star Clusters in the Antennae with JWST](#user-content-link19)
**Authors:** Rupali Chandar, Miranda Caputo, Paul Goudfrooij, Sean T. Linden, Angus Mok, Cory Whitcomb, Grant Donnelly, Florent Renaud, John-David T. Smith, Alberto Bolatto, Danny A. Dale, Sara Duval, Lindsey Hands, Ralf Klessen, Caroline Kuczek, Karin Sandstrom, Eva Schinnerer, Fabian Walter

20. [The JWST early galaxy crisis resolved by a reionization degeneracy](#user-content-link20)
**Authors:** Zihan Wang, Huanyuan Shan

21. [VERSUS: An excursion-set-inspired void-finder for the Stage-IV era](#user-content-link21)
**Authors:** Nathan Findlay, Seshadri Nadathur

22. [The Keplerian disk, envelope, and streamers surrounding an early O-type protostar in the Sagittarius C cloud of the Central Molecular Zone](#user-content-link22)
...
23. [\textit{Euclid} preparation. Baryon acoustic oscillations extraction techniques: comparison and optimisation](#user-content-link23)
**Authors:** Euclid Collaboration, E. Sarpa, A. Veropalumbo, M. Bonici, M. K\"archer, M. Crocce, E. Sefusatti, E. Maragliano, E. Branchini, C. Oliveri, G. Gambardella, B. Camacho Quevedo, C. Moretti, P. Monaco, J. Bautista, M. Viel, W. J. Percival, S. Nadathur, A. Pezzotta, A. Eggemeier, A. G. S\'anchez, J. Bel, C. Carbone, A. Crespi, S. Radinovi\'c, G. Parimbelli, A. Farina, I. Risso, M. Guidi, G. Degni, D. Eisenstein, F. Beutler, C. Garc\'ia-Garc\'ia, G. Piccirilli, J. G. Sorce, B. Altieri, S. Andreon, C. Baccigalupi, M. Baldi, S. Bardelli, P. Battaglia, A. Biviano, M. Brescia, S. Camera, G. Ca\~nas-Herrera, V. Capobianco, J. Carretero, F. J. Castander, M. Castellano, G. Castignani, S. Cavuoti, K. C. Chambers, A. Cimatti, C. Colodro-Conde, G. Congedo, L. Conversi, Y. Copin, F. Courbin, H. M. Courtois, H. Degaudenzi, S. de la Torre, G. De Lucia, F. Dubath, X. Dupac, S. Escoffier, M. Farina, R. Farinelli, F. Faustini, S. Ferriol, F. Finelli, P. Fosalba, N. Fourmanoit, M. Frailis, E. Franceschi, M. Fumana, S. Galeotta, K. George, W. Gillard, B. Gillis, C. Giocoli, J. Gracia-Carpio, A. Grazian, F. Grupp, L. Guzzo, S. V. H. Haugan, W. Holmes, F. Hormuth, A. Hornstrup, K. Jahnke, M. Jhabvala, B. Joachimi, S. Kermiche, A. Kiessling, B. Kubik, M. K\"ummel, M. Kunz, H. Kurki-Suonio, A. M. C. Le Brun, S. Ligori, P. B. Lilje, V. Lindholm, I. Lloro, G. Mainetti, O. Mansutti, O. Marggraf, M. Martinelli, N. Martinet, F. Marulli, R. J. Massey, E. Medinaceli, S. Mei, M. Melchior, M. Meneghetti, E. Merlin, G. Meylan, A. Mora, M. Moresco, L. Moscardini, C. Neissner, S. -M. Niemi, C. Padilla, S. Paltani, F. Pasian, K. Pedersen, V. Pettorino, S. Pires, G. Polenta, M. Poncet, L. A. Popa, F. Raison, J. Rhodes, G. Riccio, F. Rizzo, E. Romelli, M. Roncarelli, R. Saglia, Z. Sakr, D. Sapone, M. Schirmer, P. Schneider, T. Schrabback, M. Scodeggio, A. Secroun, E. Sihvola, C. Sirignano, G. Sirri, L. Stanco, P. Tallada-Cresp\'i, D. Tavagnacco, A. N. Taylor, I. Tereno, N. Tessore, S. Toft, R. Toledo-Moreo, F. Torradeflot, I. Tutusaus, L. Valenziano, J. Valiviita, T. Vassallo, G. Verdoes Kleijn, Y. Wang, J. Weller, A. Zacchei, G. Zamorani, F. M. Zerbi, E. Zucca, M. Ballardini, A. Boucaud, E. Bozzo, C. Burigana, R. Cabanac, M. Calabrese, A. Cappi, T. Castro, J. A. Escartin Vigo, G. Fabbian, J. Garc\'ia-Bellido, J. Macias-Perez, R. Maoli, J. Mart\'in-Fleitas, N. Mauri, R. B. Metcalf, M. P\"ontinen, V. Scottez, M. Sereno, M. Tenti, M. Tucci, M. Wiesmann, Y. Akrami, I. T. Andika, M. Archidiacono, F. Atrio-Barandela, E. Aubourg, L. Bazzanini, D. Bertacca, M. Bethermin, A. Blanchard, L. Blot, S. Borgani, M. L. Brown, S. Bruton, A. Calabro, F. Caro, C. S. Carvalho, F. Cogato, S. Contarini, A. R. Cooray, O. Cucciati, S. Davini, T. de Boer, F. De Paolis, G. Desprez, A. D\'iaz-S\'anchez, S. Di Domizio, J. M. Diego, V. Duret, M. Y. Elkhashab, Y. Fang, P. G. Ferreira, A. Finoguenov, A. Franco, K. Ganga, T. Gasparetto, E. Gaztanaga, Z. Ghaffari, F. Giacomini, F. Gianotti, E. J. Gonzalez, G. Gozaliasl, A. Gruppuso, C. M. Gutierrez, A. Hall, H. Hildebrandt, J. Hjorth, J. J. E. Kajava, Y. Kang, V. Kansal, D. Karagiannis, K. Kiiveri, J. Kim, C. C. Kirkpatrick, K. Koyama, S. Kruk, M. C. Lam, F. Leclercq, L. Legrand, M. Lembo, F. Lepori, G. Leroy, G. F. Lesci, J. Lesgourgues, T. I. Liaudat, S. J. Liu, M. Magliocchetti, C. J. A. P. Martins, L. Maurin, M. Migliaccio, M. Miluzio, G. Morgante, K. Naidoo, A. Navarro-Alsina, S. Nesseris, F. Pace, D. Paoletti, K. Paterson, L. Patrizii, C. Pattison, A. Pisani, D. Potter, A. Pourtsidou, G. W. Pratt, S. Quai, M. Radovich, G. Rodighiero, W. Roster, S. Sacquegna, M. Sahl\'en, D. B. Sanders, A. Schneider, D. Sciotti, E. Sellentin, L. C. Smith, I. Szapudi, K. Tanidis, C. Tao, F. Tarsitano, G. Testera, R. Teyssier, S. Tosi, A. Troja, C. Uhlemann, C. Valieri, F. Vernizzi, G. Verza, S. Vinciguerra, M. von Wietersheim-Kramsta, N. A. Walton, A. H. Wright, H. W. Yeung

24. [On the slope of the power spectrum of the density field in isothermal supersonic compressible turbulence](#user-content-link24)
**Authors:** Pierre Dumond, J\'er\'emy Fensch, Gilles Chabrier, No\'e Brucy

25. [Discovery of the first outbursting hot subdwarf binary: ZTF J0007+4804](#user-content-link25)
**Authors:** E. Stringer, T. Kupfer, K. Deshmukh, T. Maccarone, I. Jackson, A. Kosakowski, C. W. Bradshaw, A. Brown, M. Dorsch, A. Picco, V. S. Dhillon, S. Poshyachinda, S. Awiphan

26. [Identification and characterization of 15265 super-Nyquist frequencies in 1309 {\delta} Scuti stars from Kepler photometry](#user-content-link26)
**Authors:** Yanqi Mo, Weikai Zong, Xuan Wang, Simon Murphy, Zilu Yang, Jian-Ning Fu, Stephane Charpinet, Xiao-Yu Ma

27. [The SRG/eROSITA diffuse soft X-ray background II. spectra and morphology of the eROSITA bubbles in the western Galactic hemisphere](#user-content-link27)
**Authors:** Michael C. H. Yeung, Martin G. F. Mayer, Andy Strong, Michael J. Freyberg, Gabriele Ponti, Konrad Dennerl, Junjie Mao, Manami Sasaki, Xueying Zheng, Jeremy S. Sanders, Yi Zhang, Jiejia Liu, Liyi Gu, Werner Becker, Frank Haberl, Teng Liu, Andrea Merloni, Peter Predehl

28. [Thermal activation rate of dilute axion stars close to the maximum mass](#user-content-link28)
**Authors:** Pierre-Henri Chavanis

29. [Self-Interaction Bounds on Ultralight Dark Matter Couplings to Matter](#user-content-link29)
**Authors:** Mohammad Aghaie, Shao-Ping Li

30. [The ALMA survey to Resolve exoKuiper belt Substructures (ARKS) XI: Gas-dust interactions and radial offsets between micron and millimetre-sized grains](#user-content-link30)
**Authors:** J. Olofsson, M. R. Jankovic, S. Marino, A. V. Krivov, M. Bonduelle, G. Cataldi, Y. Han, A. M. Hughes, T. L\"ohne, S. Mac Manamon, E. Mansell, L. Matr\`a, J. Milli, A. A. Sefilian, P. Th\'ebault, B. Zawadzki, M. Booth, C. del Burgo, J. M. Carpenter, Th. Henning, J. B. Lovell, T. Pearce, S. P\'erez, D. J. Wilner, M. C. Wyatt

31. [Modeling the UV-photon irradiation of CS$_2$-bearing ices in the laboratory with the pyRate gas-grain astrochemical code. New insights into the missing sulfur problem](#user-content-link31)
**Authors:** O. Sipil\"a, R. Mart\'in-Dom\'enech, W. Riedel, D. Navarro-Almaida, A. Fuente, A. Taillard, G. M. Mu\~noz Caro

32. [Constraining Tsallis Corrections to Photon Reheating from Electron-Positron Annihilation](#user-content-link32)
**Authors:** Matias P. Gonzalez

33. [Wave interference as the origin of the cyclic magnetorotational dynamo in accretion disks: insights from weakly nonlinear theory and local shearing box simulations](#user-content-link33)
**Authors:** Uddipan Banik, Amitava Bhattacharjee, James M. Stone

34. [High-Redshift Gravitational Lens Discoveries in JWST NIRCam Using AnomalyMatch](#user-content-link34)
**Authors:** Julia Dima, David O'Ryan, Sandor Kruk, Laslo E. Ruhberg, Pablo G\'omez

35. [A public dataset of Ariel simulated observations for developing exoplanetary atmosphere data reduction pipelines](#user-content-link35)
**Authors:** Lorenzo V. Mugnai, Kai Hou Yip, Andrea Bocchieri, Andreas Papageorgiou, Virginie Batista, Orph\'ee Faucoz, Ang\`ele Syty, Tara Tahseen, Enzo Pascale, Ingo Waldmann

36. [Comparing Hemispheres: Anisotropy in the deceleration parameter $q_0$](#user-content-link36)
**Authors:** Mauricio Lopez-Hernandez, Josue De-Santiago

37. [Systematic underestimation of polarisation angle dispersion and its consequences for magnetic field strength estimates in star-forming regions](#user-content-link37)
**Authors:** Seamus D. Clarke, Ya-Wen Tang, Patrick M. Koch, Gary A. Fuller, Dawei Xi

38. [The jet-shaped pipe morphology in planetary nebulae and core-collapse supernova remnants](#user-content-link38)
**Authors:** Noam Soker (Technion, Israel), Jessica Braudo (Technion, Israel)

39. [Searching for UFOs from the early universe: direct detection prospects for relativistically decoupling dark matter](#user-content-link39)
**Authors:** Stephen E. Henrich, Yann Mambrini, Keith A. Olive

40. [Post-Recombination Fluctuations from a Sequestered Dark Sector](#user-content-link40)
**Authors:** Salvatore Bottaro, Michael Geller, Diego Redigolo, Maya Tsur

41. [On The Nonthermal Power Laws In Magnetized Turbulent Plasmas](#user-content-link41)
**Authors:** Rostom Mbarek, Daniel Gro\v{s}elj, Alexander Philippov

42. [A Search for High Frequency Oscillations in TESS Cycle 7](#user-content-link42)
**Authors:** Guanda Huang, Xiaodian Chen, Shu Wang, Xiaobin Zhang, Licai Deng

43. [Primordial high energy neutrinos](#user-content-link43)
**Authors:** Nicolas Grimbaum Yamamoto

44. [The ESO SupJup Survey. X. A carbon isotope contrast in the young ROXs 12 system](#user-content-link44)
**Authors:** N. Grasser, I. A. G. Snellen, S. de Regt, D. Gonz\'alez Picos, Y. Zhang, T. Stolker, S. Gandhi, R. Landman, P. Molli\`ere, N. F. Allard

45. [New constraints on primordial non-Gaussianity from large-scale cross-correlations of CMB lensing and the cosmic infrared background](#user-content-link45)
**Authors:** Joseph Thornton, Fiona McCarthy, Carmen Embil Villagra, Blake D. Sherwin

46. [Utilizing Dispersion Measure of Fast Radio Bursts to Probe the Intergalactic Medium Turbulence](#user-content-link46)
**Authors:** Rui-Nan Li (NJU), Zhao Joseph Zhang (NJU), Kentaro Nagamine (NJU), Yuri Oku (NJU), Qin Wu (NJU), F. Y. Wang (NJU)

47. [Mitigating effects of telescope jitter through differentiable forward-modeling](#user-content-link47)
**Authors:** Max Charles, Louis Desdoigts, Benjamin Pope, Connor Langford, David Sweeney, Peter Tuthill

48. [IRIS NUV diagnostics for Ellerman bombs: spectral properties, thermodynamics, and formation height](#user-content-link48)
**Authors:** I. J. Soler Poquet, C. J. D\'iaz Baso, A. Sainz Dalda, L. H. M. Rouppe van der Voort, D. N\'obrega-Siverio, R. Joshi

49. [COCONUT: Toward practical time-evolving Sun-to-Earth magnetohydrodynamic modeling](#user-content-link49)
**Authors:** Haopeng Wang, Stefaan Poedts, Andrea Lani, Rayan Dhib, Luis Linan, Tinatin Baratashvili, Fan Zhang, Quentin Noraz, Hyun-Jin Jeong, Nicolas Wijsen, Martina Condoluci, Lingyu Dong, Junyan Liu, Rui Zhuo, Mahdi Najafi-Ziyazi, Ketevan Arabuli, Myrthe Flossie, Jasmina M. Magdaleni\'c Zhukov, Brigitte Schmieder

50. [Resonances as signatures of scalar clouds in eccentric extreme-mass-ratio inspirals](#user-content-link50)
**Authors:** Qi-Xuan Xu, Richard Brito, Riccardo Della Monica, Rodrigo Vicente, Chen Yuan

51. [Non-radial pulsations of gravitationally coupled two-fluid neutron stars in general relativity](#user-content-link51)
**Authors:** Ankit Kumar, Daniel A. Caballero, Hajime Sotani, Nicol\'as Yunes

52. [StreakMind: AI detection and analysis of satellite streaks in astronomical images with automated database integration](#user-content-link52)
**Authors:** Rafael Carrillo Navarro, Ren\'e Duffard, Pablo Garc\'ia-Mart\'in, Javier Romero, Nicol\'as Morales, Luis Gon\c{c}alves

53. [On the cool nature of coronal nanojets](#user-content-link53)
**Authors:** Gabriele Cozzo, Paola Testa, Juan Martinez-Sykora, Paolo Pagano, Fabio Reale, Bart De Pontieu, Viggo Hansteen, Alberto Sainz-Dalda

54. [The Computed Microwave Spectrum of the Protonated Fullerene C60H+](#user-content-link54)
**Authors:** Laszlo Nemes, Jos Oomens, Vincent J. Esposito, Vincent Boudon, Alexander G. G. M. Tielens

55. [The Cocoon from a Massive Star's Death: VLA Radio Polarization Study of Possible Historical Supernova Remnant G7.7$-$3.7](#user-content-link55)
**Authors:** Tian-Xian Luo, Ping Zhou, C. -Y. Ng, Zhi-Yu Zhang, Shumeng Zhang, Hai-Chen Lin

56. [Minimum lifetime of a black hole](#user-content-link56)
**Authors:** Eugenio Bianchi, Matthew Brandsema, Kenneth Czuprynski, Daniel E. Paraizo

57. [Metastable strings at PTAs: classical stability analysis](#user-content-link57)
**Authors:** Simone Blasi, Maxime Grandjean, Alberto Mariotti

58. [The Range of Cumulative XUV Flux on GJ 1132 b](#user-content-link58)
**Authors:** Rory Barnes, Laura N. R. do Amaral, Jessica Birky, James R. A. Davenport, Scott Engle, Megan Gialluca, Evgenya L. Shkolnik

59. [Multipole Functions for Image Analysis II: Equal Area Weighting and Application to Supernova Remnant Images](#user-content-link59)
**Authors:** D. A. Leahy, S. Ranasinghe, M. D. Filipovic, Z. J. Smeaton

60. [Searching For Fast Radio Transients And Radio Pulsars Using SPOTLIGHT](#user-content-link60)
**Authors:** Kenil Rajendrabhai Ajudiya

61. [The Catastrophic Consequences of Agnosticism for Life Searches and a Possible Workaround](#user-content-link61)
**Authors:** David Kipping

62. [Data-Constrained Modeling of Electron Transport and Asymmetric Precipitation in the 2011 August 4 Solar Flare](#user-content-link62)
**Authors:** Feiyu Yu, Xiangliang Kong, Ze Zhong, Zhentong Li, Zelong Jiang, Yingli Cui, Zhao Wu, Yao Chen, Gang Li

63. [Anisotropic non-Maxwellian velocity distributions in the solar transition region](#user-content-link63)
**Authors:** Paola Testa, Bart De Pontieu, Kyuhyoun Cho, Thomas Ayres

64. [Optical Variability Structure Function of Low-Luminosity AGN using ATLAS Lightcurves](#user-content-link64)
**Authors:** Ashley Hai Tung Tan, Christian Wolf, Neelesh Amrutha, Christopher A. Onken, John L. Tonry, Rachel Webster

65. [Unveiling hidden millihertz quasi-periodic oscillations in 1A 0535+262](#user-content-link65)
**Authors:** Zihan Yang, Ruican Ma, Mariano M\'endez, Z. X. Li, Q. C. Zhao, Panping Li, Lian Tao, Shuang-Nan Zhang, Liang Zhang, Hua Feng, Xiang Ma, Yue Huang

66. [Orbital Nodal Phase as a Pipeline Invariant in Black Hole Timing](#user-content-link66)
**Authors:** Mehmet Baran \"Okten

67. [Can wormholes have vanishing Love numbers?](#user-content-link67)
**Authors:** Shauvik Biswas

68. [Microlensing time-scales and flux magnification probabilities of a sample of 204 lensed quasars](#user-content-link68)
**Authors:** F. \'Avila-Vera, V. Motta, E. Mediavilla

69. [The First Look of Gaia: Daily data quality and instrument health assessment with automated early warnings](#user-content-link69)
**Authors:** M. Altmann, Z. Balog, W. L\"offler, U. Bastian, M. Biermann, A. Sagrista Selles, M. Davidson, N. Rowell, E. Serpell, A. Abreu Aramburu, T. Br\"usemeister, C. Crowley, M. Hauser, S. Jordan, J. Mart\'in-Fleitas, A. Mora, E. Fernandez del Peloso, U. Stampa

---

## 1. [Peering down the barrel with DESI DR2: 10 000+ inflows at $z$ < 0.6 reveal how galaxies accrete cold gas](https://arxiv.org/abs/2605.02999) <a id="link1"></a>

**ArXiv ID:** 2605.02999

**Authors:** S. Weng, A. Saintonge, Matthew M. Pieri, J. Moustakas, H. Zou, D. Mu\~noz Santos, J. Yu, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, T. Claybaugh, A. Cuceu, A. de la Macorra, P. Doel, A. Font-Ribera, J. E. Forero-Romero, E. Gazta\~naga, Satya Gontcho A. Gontcho, G. Gutierrez, C. Hahn, S. He, K. Honscheid, T. Hu, R. Joyce, R. Kehoe, M. Landriau, L. Le Guillou, A. Meisner, R. Miquel, S. Nadathur, J. A. Newman, W. J. Percival, I. P\'erez-R\`afols, G. Rossi, E. Sanchez, D. Schlegel, H. Seo, J. Silber, D. Sprayberry, G. Tarl\'e, B. A. Weaver

**Abstract:** Direct observational constraints on how galaxies acquire their gas remain remarkably limited, hindering our understanding of the baryon cycle. We present a search for down-the-barrel \ion{Na}{i} D absorption towards 15.6 million galaxies at $z < 0.6$ in DESI Data Release 2. We use Bayesian evidence ratios to assess whether the absorption requires additional components tracing interstellar gas distinct from the systemic component of the galaxy. We construct a catalogue of 50 088 (27 420) galaxies with moderate (strong) evidence for down-the-barrel absorption. The inferred absorption components are broadly distributed in velocity, with approximately 50% at $v_{\rm flow}  50$ km/s. We find strong evidence for a large population of low-velocity, infalling absorbers with velocities $\sim$20 km/s in edge-on galaxies, consistent with radial inflows predicted in simulations. The stronger correlation in early-type galaxies between inflow velocity and stellar velocity dispersion, compared to that with stellar mass, suggests that a portion of these inflows may be associated with accreting satellites. These results reveal the multiple pathways in which galaxies accrete gas at redshift $z < 0.6$ for the first time in a statistically significant sample.

**Comment:** Directly investigates gas accretion onto galaxies, including inflows and possible accreting satellites. This is highly relevant to near-field cosmology (satellite interactions), circumgalactic medium, and galaxy-scale gas flows. Strong match to multiple criteria.
...
## 2. [Unifying Transport Models of Thermohaline Convection in Stars](https://arxiv.org/abs/2605.03810) <a id="link2"></a>
...
**Comment:** This paper presents theoretical advances in modeling thermohaline convection in stellar interiors, directly matching the 'Stellar Models' criterion. It discusses mixing processes and their impact on stellar models, which is highly relevant. The work offers a potential resolution to discrepancies in mixing efficiency, which is a substantial improvement.
...
## 3. [Environmental Quenching of High-Redshift Galaxies: Interpreting JWST Observations with Simulations](https://arxiv.org/abs/2605.03008) <a id="link3"></a>
...
**Comment:** This paper directly addresses star formation quenching in low-mass galaxies, with a focus on environmental quenching of satellite galaxies at high redshift. It uses numerical galaxy simulations to interpret JWST observations, matching both the 'Star Formation Quenching' and 'Numerical Galaxy Simulations' criteria. The discussion of satellite quenching and environmental effects is highly relevant.
...
## 4. [PySME v1.0: improved modelling of stellar spectra for survey-scale applications](https://arxiv.org/abs/2605.04007) <a id="link4"></a>
...
**Comment:** This paper presents a new Python implementation for modeling stellar spectra, including improved treatment of hydrogen lines and NLTE grids for 17 elements. This directly matches the 'Stellar Models' criterion, as it provides new tools for stellar atmosphere modeling and abundance analysis.
...
## 5. [Not So Isolated: Green Pea Galaxies in Overdense Environments revealed by VLT/MUSE](https://arxiv.org/abs/2605.03676) <a id="link5"></a>
...
**Comment:** This paper studies Green Pea galaxies, which are low-mass, starburst galaxies, and their environments. It investigates star formation triggering mechanisms and the role of environment, directly matching the 'Star Formation Quenching' and 'Near-Field Cosmology' criteria (as GPs are analogues for dwarf galaxies and the study includes environmental effects). The observational approach and new group dynamical mass measurements add substantial novelty.
...
## 7. [Are Nucleosynthetic Yields Universal? Interpreting the Multi-Elemental Abundances of Quiescent Galaxies over Cosmic Time Using Milky Way Stars](https://arxiv.org/abs/2605.03000) <a id="link7"></a>
...
**Comment:** This paper discusses nucleosynthetic yields and abundance patterns in quiescent galaxies, using Milky Way stars as empirical proxies. It directly addresses stellar models and chemical evolution, and mentions previous success in dwarf galaxies. Highly relevant for stellar models and chemical evolution, with some connection to resolved star formation histories.
...
## 8. [What is the Strouhal number of turbulence driven by supernovae?](https://arxiv.org/abs/2605.03768) <a id="link8"></a>
...
**Comment:** This paper presents numerical simulations of the ISM turbulence driven by supernovae, directly matching the 'Numerical Galaxy Simulations' criterion. It also touches on star formation-driven outflows by discussing SN-driven turbulence, which is relevant. The work provides new measurements of the Strouhal number in SN-driven turbulence, which is a substantial improvement.
...
## 9. [Interpreting Galaxy Physical Properties Using Stellar Population Synthesis](https://arxiv.org/abs/2605.03500) <a id="link9"></a>
...
**Comment:** This thesis focuses on stellar population synthesis modeling for interpreting galaxy physical properties, including star formation activity and gas enrichment. It matches the 'Stellar Models' criterion (SPS models) and is relevant to 'Resolved Star Formation Histories' (SED fitting for SFH extraction).
...
## 10. [ArkenstoneBH. A model for high-specific energy black hole feedback in cosmological simulations](https://arxiv.org/abs/2605.03154) <a id="link10"></a>
...
**Comment:** This paper introduces a new subgrid model for black hole feedback in cosmological simulations, focusing on high-specific energy outflows and their effect on star formation and the CGM. It matches the 'Numerical Galaxy Simulations' criterion, and also touches on 'Star Formation Quenching' and 'Circumgalactic Medium' (though for higher mass galaxies).
...
## 11. [Reddening maps of the Magellanic Clouds using spectral energy distribution fitting of red giants](https://arxiv.org/abs/2605.03585) <a id="link11"></a>
...
**Comment:** The paper constructs reddening maps of the Magellanic Clouds using SED fitting of red giants and investigates the impact of stellar atmosphere models. It is relevant to the 'Stellar Models' criterion, as it discusses the effect of different stellar atmosphere models on astrophysical measurements. The focus on the Magellanic Clouds also provides some relevance to near-field cosmology, but the primary match is stellar models.
...
## 12. [A Multi-parameter Fuzzy Set Framework for Classifying Red, Blue, and Green Valley Galaxies](https://arxiv.org/abs/2605.04028) <a id="link12"></a>
...
**Comment:** Presents a new fuzzy set framework for classifying galaxy populations (red, blue, green valley) using SDSS data. The paper discusses star formation and quenching, including green valley galaxies, which are often associated with quenching. However, the focus is on general galaxy populations, not specifically dwarfs, so relevance is moderate.
...
## 13. [Resolving the Multiphase Outflow, Shock Signatures, and PAHs in the AGN-Starburst Composite ULIRG F10565+2448 with JWST MIRI/MRS](https://arxiv.org/abs/2605.03016) <a id="link13"></a>
...
**Comment:** This paper studies multiphase outflows in a ULIRG with both AGN and starburst activity. While it discusses outflows and their energetics, the galaxy is much more massive than the LMC and the focus is on AGN-starburst composite phenomena. Star-formation-driven outflows are discussed, but AGN-driven outflows are also a major component, so relevance is moderate.
...
## 14. [Uncovering the multi-scale structure of dust distribution in nearby galaxies](https://arxiv.org/abs/2605.03024) <a id="link14"></a>
...
**Comment:** This paper studies the multi-scale structure of dust distribution in nearby star-forming galaxies using JWST-MIRI images. It analyzes ISM properties and dust emission, but does not directly address resolved star formation histories, quenching, or near-field cosmology. Borderline relevance due to ISM focus.
...
## 15. [Double Neutron Star Delay Times Across Cosmic Metallicities: The Role of Helium Star Progenitors](https://arxiv.org/abs/2605.03128) <a id="link15"></a>
...
**Comment:** This paper investigates double neutron star delay times and their dependence on metallicity, focusing on binary evolution and implications for r-process enrichment and gamma-ray bursts. While it discusses star formation histories and their impact on DNS mergers, it does not directly derive resolved star formation histories from CMDs or focus on dwarf galaxies. The relevance is borderline, as the results may have implications for star formation histories but are not directly related.
...
## 16. [Primordial Black Hole contribution to the stochastic background of Gravitational Waves](https://arxiv.org/abs/2605.03156) <a id="link16"></a>
...
**Comment:** Examines the contribution of primordial black holes to the stochastic gravitational wave background and SMBH formation. While it touches on dark matter and halo formation, it does not focus on near-field cosmology, satellite galaxies, or resolved star formation histories.
...
## 17. [The Significant Role of Hydrogen in the Formation of Silicon Carbide in Evolved Stars](https://arxiv.org/abs/2605.03575) <a id="link17"></a>
...
**Comment:** Laboratory study of silicon carbide dust formation in evolved stars, focusing on molecular precursors and hydrogen's role. While it discusses dust formation and stellar chemistry, it does not present new stellar models or connect to galaxy-scale phenomena.
...
## 18. [Chromosphere of the quiet Sun -- II. Atmospheric response to small-scale magnetic flux emergence](https://arxiv.org/abs/2605.03019) <a id="link18"></a>
...
**Comment:** 3D radiative-MHD simulations of the quiet Sun's chromosphere, focusing on atmospheric response to small-scale magnetic flux emergence. While it uses numerical simulations and discusses stellar atmospheres, it does not present new stellar models or connect to galaxy-scale phenomena.
...
## 20. [The JWST early galaxy crisis resolved by a reionization degeneracy](https://arxiv.org/abs/2605.03635) <a id="link20"></a>
...
**Comment:** Addresses the abundance of early galaxies and star formation efficiency, but focuses on high-redshift universe and reionization, not near-field cosmology or resolved SFHs of local galaxies.
...
## 21. [VERSUS: An excursion-set-inspired void-finder for the Stage-IV era](https://arxiv.org/abs/2605.03779) <a id="link21"></a>
...
**Comment:** Presents a new void-finding algorithm for cosmic voids, validated against galaxy simulations. While it is a numerical method for large-scale structure, it does not focus on galaxies, satellites, or dwarf galaxy properties. No direct match to the core criteria.
...
## 22. [The Keplerian disk, envelope, and streamers surrounding an early O-type protostar in the Sagittarius C cloud of the Central Molecular Zone](https://arxiv.org/abs/2605.03883) <a id="link22"></a>
...
**Comment:** ALMA observations of a Keplerian disk around an early O-type protostar in the Central Molecular Zone. Focus is on massive star formation and disk/envelope structure near the Galactic Center, not on dwarf galaxies or galaxy-scale phenomena.
...
## 23. [\textit{Euclid} preparation. Baryon acoustic oscillations extraction techniques: comparison and optimisation](https://arxiv.org/abs/2605.03446) <a id="link23"></a>
...
**Comment:** This paper describes methodological advances in extracting baryon acoustic oscillations (BAO) from large-scale structure surveys, focusing on cosmological parameter inference. While it is a cosmology paper, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on cosmological analysis pipelines and survey methodology, which are outside the relevant topics.
...
## 24. [On the slope of the power spectrum of the density field in isothermal supersonic compressible turbulence](https://arxiv.org/abs/2605.03924) <a id="link24"></a>
...
**Comment:** Analyzes the power spectrum of density fields in supersonic turbulence, relevant to ISM structure but not directly to galaxy-scale outflows, resolved SFHs, or near-field cosmology. No direct match to any core criteria.
...
## 25. [Discovery of the first outbursting hot subdwarf binary: ZTF J0007+4804](https://arxiv.org/abs/2605.03010) <a id="link25"></a>
...
**Comment:** Study of a hot subdwarf binary system, its properties, and evolution. While it uses stellar models (MESA), the focus is on binary evolution and accretion, not on new stellar models or galaxy-scale phenomena.
...
## 27. [The SRG/eROSITA diffuse soft X-ray background II. spectra and morphology of the eROSITA bubbles in the western Galactic hemisphere](https://arxiv.org/abs/2605.02998) <a id="link27"></a>
...
**Comment:** The paper analyzes the diffuse soft X-ray background and the eROSITA bubbles, focusing on Galactic halo structures and their properties. It does not address near-field cosmology, satellite galaxies, or any other core topic.
...
## 28. [Thermal activation rate of dilute axion stars close to the maximum mass](https://arxiv.org/abs/2605.03771) <a id="link28"></a>
...
**Comment:** Focuses on axion stars and their stability, which is related to dark matter but does not directly address near-field cosmology, satellite galaxies, or galaxy simulations. No direct match to any core criteria.
...
## 29. [Self-Interaction Bounds on Ultralight Dark Matter Couplings to Matter](https://arxiv.org/abs/2605.03477) <a id="link29"></a>
...
**Comment:** Discusses constraints on ultralight dark matter couplings, relevant to dark matter but not directly to near-field cosmology or galaxy-scale phenomena.
...
## 30. [The ALMA survey to Resolve exoKuiper belt Substructures (ARKS) XI: Gas-dust interactions and radial offsets between micron and millimetre-sized grains](https://arxiv.org/abs/2605.03009) <a id="link30"></a>
...
**Comment:** This paper presents numerical simulations of gas-dust interactions in debris disks, focusing on the dynamics of dust grains and radial offsets. While it involves numerical simulations, the focus is on debris disks and planet formation, not galaxies or the core topics. No direct match to relevant criteria.
...
## 31. [Modeling the UV-photon irradiation of CS$_2$-bearing ices in the laboratory with the pyRate gas-grain astrochemical code. New insights into the missing sulfur problem](https://arxiv.org/abs/2605.03725) <a id="link31"></a>
...
**Comment:** This paper models sulfur chemistry in interstellar ices, focusing on astrochemical processes and laboratory experiments. While it is relevant to interstellar medium studies, it does not match any of the core criteria such as galaxy simulations, star formation histories, quenching, or near-field cosmology.
...
## 32. [Constraining Tsallis Corrections to Photon Reheating from Electron-Positron Annihilation](https://arxiv.org/abs/2605.03223) <a id="link32"></a>
...
**Comment:** The paper discusses entropy transfer in the early Universe and constraints on nonextensive corrections to photon reheating. While it is cosmology-related, it does not match near-field cosmology or any other core criteria focused on galaxies, stellar models, or star formation.
...
## 33. [Wave interference as the origin of the cyclic magnetorotational dynamo in accretion disks: insights from weakly nonlinear theory and local shearing box simulations](https://arxiv.org/abs/2605.02996) <a id="link33"></a>
...
**Comment:** This paper develops a theory for cyclic magnetorotational dynamos in accretion disks, with implications for magnetic variability in protoplanetary disks, X-ray binaries, and AGNs. It does not match any of the core criteria (no focus on galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM).
...
## 34. [High-Redshift Gravitational Lens Discoveries in JWST NIRCam Using AnomalyMatch](https://arxiv.org/abs/2605.03442) <a id="link34"></a>
...
**Comment:** This paper focuses on the identification of high-redshift gravitational lenses using JWST data. While gravitational lensing is a tool in cosmology, the paper does not directly address near-field cosmology, dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM. The focus is on lens discovery and cataloging, which is outside the core topics.
...
## 35. [A public dataset of Ariel simulated observations for developing exoplanetary atmosphere data reduction pipelines](https://arxiv.org/abs/2605.03719) <a id="link35"></a>
...
**Comment:** This paper provides a public dataset for exoplanet atmosphere observations and discusses data reduction pipelines. While it is useful for exoplanetary science, it does not match any of the core criteria such as resolved star formation histories, stellar models, or galaxy simulations.
...
## 36. [Comparing Hemispheres: Anisotropy in the deceleration parameter $q_0$](https://arxiv.org/abs/2605.03004) <a id="link36"></a>
...
**Comment:** The paper analyzes anisotropy in the deceleration parameter using supernovae, focusing on cosmological isotropy and bulk flows. While it touches on local velocity fields, it does not address near-field cosmology, satellite galaxies, or any other core topic.
...
## 37. [Systematic underestimation of polarisation angle dispersion and its consequences for magnetic field strength estimates in star-forming regions](https://arxiv.org/abs/2605.03507) <a id="link37"></a>
...
**Comment:** Discusses magnetic field strength estimates in star-forming regions, but does not address resolved star formation histories, quenching, or galaxy simulations. No direct match to any core criteria.
...
## 38. [The jet-shaped pipe morphology in planetary nebulae and core-collapse supernova remnants](https://arxiv.org/abs/2605.03961) <a id="link38"></a>
...
**Comment:** This paper focuses on jet-shaped morphologies in planetary nebulae and core-collapse supernova remnants, with hydrodynamical simulations. It does not match any of the core criteria (no focus on dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 39. [Searching for UFOs from the early universe: direct detection prospects for relativistically decoupling dark matter](https://arxiv.org/abs/2605.03014) <a id="link39"></a>
...
**Comment:** The paper discusses direct detection prospects for ultrarelativistically decoupling dark matter, focusing on particle physics and cosmology. It does not match any of the core criteria (no focus on galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM).
...
## 40. [Post-Recombination Fluctuations from a Sequestered Dark Sector](https://arxiv.org/abs/2605.03007) <a id="link40"></a>
...
**Comment:** This paper develops a formalism for late-time cosmological fluctuations from a sequestered dark sector, with application to CMB constraints. It does not match any of the core criteria (no focus on galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM).
...
## 41. [On The Nonthermal Power Laws In Magnetized Turbulent Plasmas](https://arxiv.org/abs/2605.03033) <a id="link41"></a>
...
**Comment:** This paper derives scaling laws for nonthermal power laws in magnetized turbulent plasmas, with astrophysical implications for proton acceleration in SMBH coronae. It does not match any of the core criteria (no focus on galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM).
...
## 42. [A Search for High Frequency Oscillations in TESS Cycle 7](https://arxiv.org/abs/2605.03323) <a id="link42"></a>
...
**Comment:** This paper reports a search for high-frequency oscillations in TESS data, identifying rapid oscillators (white dwarfs, hot subdwarfs, A-F stars). It does not match any of the core criteria (no focus on galaxies, star formation histories, quenching, stellar models for populations, galaxy simulations, outflows, or CGM).
...
## 43. [Primordial high energy neutrinos](https://arxiv.org/abs/2605.03630) <a id="link43"></a>
...
**Comment:** This paper discusses primordial high energy neutrinos as probes of the early universe, focusing on particle physics and cosmology before recombination. No direct connection to near-field cosmology, resolved star formation histories, galaxy simulations, or dwarf galaxy properties.
...
## 44. [The ESO SupJup Survey. X. A carbon isotope contrast in the young ROXs 12 system](https://arxiv.org/abs/2605.03508) <a id="link44"></a>
...
**Comment:** Focuses on isotopic ratios in exoplanet and brown dwarf atmospheres, with atmospheric retrievals for a young star and companion. No direct connection to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 45. [New constraints on primordial non-Gaussianity from large-scale cross-correlations of CMB lensing and the cosmic infrared background](https://arxiv.org/abs/2605.03783) <a id="link45"></a>
...
**Comment:** This paper presents constraints on primordial non-Gaussianity using CMB lensing and the cosmic infrared background. It is focused on cosmological parameters and large-scale structure, not on galaxy evolution, star formation, or near-field cosmology.
...
## 46. [Utilizing Dispersion Measure of Fast Radio Bursts to Probe the Intergalactic Medium Turbulence](https://arxiv.org/abs/2605.03253) <a id="link46"></a>
...
**Comment:** The paper uses fast radio bursts to probe turbulence in the intergalactic medium, which is not directly related to any of the core topics (no focus on galaxy evolution, star formation, or near-field cosmology).
...
## 47. [Mitigating effects of telescope jitter through differentiable forward-modeling](https://arxiv.org/abs/2605.03445) <a id="link47"></a>
...
**Comment:** Presents a method for mitigating telescope jitter, relevant to instrumentation but not directly to any core criteria.
...
## 48. [IRIS NUV diagnostics for Ellerman bombs: spectral properties, thermodynamics, and formation height](https://arxiv.org/abs/2605.03818) <a id="link48"></a>
...
**Comment:** This paper studies Ellerman bombs in the solar atmosphere using IRIS NUV spectra. The focus is on solar physics and magnetic reconnection events in the Sun, which does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or stellar models. The work is outside the relevant topics.
...
## 49. [COCONUT: Toward practical time-evolving Sun-to-Earth magnetohydrodynamic modeling](https://arxiv.org/abs/2605.03330) <a id="link49"></a>
...
**Comment:** The paper focuses on magnetohydrodynamic modeling of the solar corona and wind, which is not directly related to any of the core criteria such as near-field cosmology, stellar models, or galaxy simulations. The focus is on solar and heliospheric physics.
...
## 50. [Resonances as signatures of scalar clouds in eccentric extreme-mass-ratio inspirals](https://arxiv.org/abs/2605.03756) <a id="link50"></a>
...
**Comment:** The paper studies resonances in extreme-mass-ratio inspirals (EMRIs) and scalar clouds, which is unrelated to the core topics (no connection to near-field cosmology, dwarf galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM).
...
## 51. [Non-radial pulsations of gravitationally coupled two-fluid neutron stars in general relativity](https://arxiv.org/abs/2605.03305) <a id="link51"></a>
...
**Comment:** This paper develops a relativistic framework for oscillations in two-fluid neutron stars, which is not related to the core topics (no focus on galaxies, star formation histories, quenching, stellar models for populations, galaxy simulations, outflows, or CGM).
...
## 52. [StreakMind: AI detection and analysis of satellite streaks in astronomical images with automated database integration](https://arxiv.org/abs/2605.03429) <a id="link52"></a>
...
**Comment:** The paper presents an AI pipeline for detecting satellite streaks in astronomical images, which is not related to the core topics (no focus on galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 53. [On the cool nature of coronal nanojets](https://arxiv.org/abs/2605.03055) <a id="link53"></a>
...
**Comment:** The paper presents 3D MHD simulations of coronal nanojets, focusing on reconnection and jet morphology in the solar corona. It does not match any of the core criteria (no focus on galaxies, star formation, stellar models, galaxy simulations, outflows, or CGM).
...
## 54. [The Computed Microwave Spectrum of the Protonated Fullerene C60H+](https://arxiv.org/abs/2605.04015) <a id="link54"></a>
...
**Comment:** Computational study of the microwave spectrum of protonated fullerene C60H+. Focus is on molecular spectroscopy and astrochemistry, not on stellar models or galaxy-scale phenomena.
...
## 55. [The Cocoon from a Massive Star's Death: VLA Radio Polarization Study of Possible Historical Supernova Remnant G7.7$-$3.7](https://arxiv.org/abs/2605.03540) <a id="link55"></a>
...
**Comment:** This paper studies a possible historical supernova remnant and its radio polarization, focusing on the cocoon-like morphology and progenitor environment. It does not address any of the core topics (no connection to galaxy evolution, star formation histories, or stellar models).
...
## 56. [Minimum lifetime of a black hole](https://arxiv.org/abs/2605.03922) <a id="link56"></a>
...
**Comment:** Discusses black hole evaporation and quantum gravity, not related to any of the core criteria.
...
## 57. [Metastable strings at PTAs: classical stability analysis](https://arxiv.org/abs/2605.03003) <a id="link57"></a>
...
**Comment:** Focuses on metastable strings and gravitational wave backgrounds, not related to galaxy-scale phenomena or any core criteria.
...
## 58. [The Range of Cumulative XUV Flux on GJ 1132 b](https://arxiv.org/abs/2605.03939) <a id="link58"></a>
...
**Comment:** This paper focuses on the XUV flux history and atmospheric loss for an exoplanet orbiting an M dwarf. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, star formation quenching, stellar models, numerical galaxy simulations, star formation driven outflows, or circumgalactic medium. The focus is on planetary atmospheres and stellar activity, which are outside the relevant topics.
...
## 59. [Multipole Functions for Image Analysis II: Equal Area Weighting and Application to Supernova Remnant Images](https://arxiv.org/abs/2605.03878) <a id="link59"></a>
...
**Comment:** This paper introduces new image analysis methods and applies them to supernova remnant images. The focus is on SNR morphology and not on any of the core topics such as galaxy evolution, star formation histories, quenching, or galaxy simulations.
...
## 60. [Searching For Fast Radio Transients And Radio Pulsars Using SPOTLIGHT](https://arxiv.org/abs/2605.03531) <a id="link60"></a>
...
**Comment:** Focuses on radio transients and pulsars, not on galaxy-scale phenomena or any of the core criteria.
...
## 61. [The Catastrophic Consequences of Agnosticism for Life Searches and a Possible Workaround](https://arxiv.org/abs/2605.02969) <a id="link61"></a>
...
**Comment:** This paper discusses epistemic barriers in searches for life and survey design, which is not relevant to any of the core topics (no connection to galaxy evolution, star formation, or stellar models).
...
## 62. [Data-Constrained Modeling of Electron Transport and Asymmetric Precipitation in the 2011 August 4 Solar Flare](https://arxiv.org/abs/2605.03380) <a id="link62"></a>
...
**Comment:** This paper models electron transport and precipitation in a solar flare, focusing on solar physics and flare emissions. It is unrelated to any of the core topics.
...
## 63. [Anisotropic non-Maxwellian velocity distributions in the solar transition region](https://arxiv.org/abs/2605.03089) <a id="link63"></a>
...
**Comment:** Analyzes solar transition region velocity distributions, not related to galaxy-scale phenomena or any core criteria.
...
## 64. [Optical Variability Structure Function of Low-Luminosity AGN using ATLAS Lightcurves](https://arxiv.org/abs/2605.03577) <a id="link64"></a>
...
**Comment:** The paper focuses on optical variability in low-luminosity AGN and its relation to black hole mass and host galaxy properties. It does not address any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 65. [Unveiling hidden millihertz quasi-periodic oscillations in 1A 0535+262](https://arxiv.org/abs/2605.03527) <a id="link65"></a>
...
**Comment:** This paper focuses on quasi-periodic oscillations in a Be/X-ray binary pulsar, which is unrelated to any of the core topics (no connection to near-field cosmology, dwarf galaxies, star formation histories, galaxy simulations, or stellar models).
...
## 66. [Orbital Nodal Phase as a Pipeline Invariant in Black Hole Timing](https://arxiv.org/abs/2605.02984) <a id="link66"></a>
...
**Comment:** The paper discusses timing analyses of accreting black holes and orbital nodal phase, which is not relevant to any of the core topics (no connection to galaxy simulations, star formation, or near-field cosmology).
...
## 67. [Can wormholes have vanishing Love numbers?](https://arxiv.org/abs/2605.03025) <a id="link67"></a>
...
**Comment:** Studies wormhole solutions and tidal Love numbers, not related to galaxy-scale phenomena or any core criteria.
...
## 68. [Microlensing time-scales and flux magnification probabilities of a sample of 204 lensed quasars](https://arxiv.org/abs/2605.03905) <a id="link68"></a>
...
**Comment:** This paper focuses on microlensing in lensed quasars, which is not related to any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No relevant criteria matched.
...
## 69. [The First Look of Gaia: Daily data quality and instrument health assessment with automated early warnings](https://arxiv.org/abs/2605.03721) <a id="link69"></a>
...
**Comment:** This paper focuses on Gaia's data quality and instrument health assessment. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The focus is on mission operations and data quality, not science topics.
