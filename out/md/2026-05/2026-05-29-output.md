...
1. [Modeling Solitonic Cores, Stabilization of Bar, and Suppression of Bar Dissolution in DDO 168 via GPP Formalism: A Detailed Analysis of Bose--Einstein Condensate/Fuzzy Dark Matter Halo Structure and Bar Dynamics in the Dwarf Galaxy DDO 168](#user-content-link1)
**Authors:** Saroj Khanal, Sanjay Kumar Sah, Kiran Khanal, Sapana Khanal

2. [Problems of cosmology on small scales of the Universe](#user-content-link2)
**Authors:** I. D. Karachentsev

3. [The Impact of the New $^{59}$Fe Decay Rates on $^{60}$Fe and $^{26}$Al Nucleosynthesis in Massive Stars](#user-content-link3)
**Authors:** Bingyang Tan, Wenyu Xin, Ruizheng Jiang, Gang Zhao, Koh Takahashi

4. [Exploring the High-Redshift 21-cm Signal via Self-Consistent Simulations using Artificial Neural Network Emulation](#user-content-link4)
**Authors:** Colton R. Feathers, Eli Visbal, Steven Murray, Ryan Hazlett, Yin-Zhe Ma

5. [From Images to Orbits: A Hubble 2030s Astrometric Legacy for the M31-M33 Star Cluster Systems](#user-content-link5)
**Authors:** Borja Anguiano (CEFCA), Benjamin J. Gibson (STScI), Sten Hasselquist (STScI)

6. [High-S/N Quasar Observations with HST/COS: Deep Fields for Spectroscopy](#user-content-link6)
...
7. [Multiple populations detection with the Chinese Space Station Survey Telescope main survey camera](#user-content-link7)
**Authors:** Zhuohang Li, Xia Li, Hao Tian, Xin Zhang, Antonino P. Milone, Long Wang, Baitian Tang, Edoardo P. Lagioia, Chengyuan Li

8. [Next-generation Exo-REM atmospheric models: application to VHS 1256 b to emulate patchy clouds](#user-content-link8)
**Authors:** Alice Radcliffe, Benjamin Charnay, Anne-Marie Lagrange, Flavien Kiefer, Bruno B\'ezard, Simon Petrus, Paulina Palma-Bifani, Matthieu Ravet, J\'er\'emy Leconte, Gabriel-Dominique Marleau

9. [Stellar Population Astrophysics (SPA) with the TNG. CNO abundances in 28 open clusters](#user-content-link9)
**Authors:** Bruno \'Curjuri\'c, Arnas Drazdauskas, Gra\v{z}ina Tautvai\v{s}ien\.e, Angela Bragaglia, Natalia Alvarez-Baena, Valentina D'Orazi, Marina Dal Ponte

10. [A Deep Study of the Spiral Galaxy W2246f](#user-content-link10)
**Authors:** Evelyn J. Johnston, Sorya Lambert, Aparna Nair, Alejandra Z. Lugo-Aranda, Manuel Aravena, Roberto J. Assef, Tanio Diaz Santos, Rom\'an Fern\'andez Aranda, Hyunsung D. Jun, Guodong Li, Mai Liao, Devika Shobhana, Chao-Wei Tsai

11. [A 1% distance to the Large Magellanic Cloud measured by population-II pulsating stars using Gaia Data Release 3](#user-content-link11)
**Authors:** Bastian Lengen, Richard I. Anderson, Mauricio Cruz Reyes

12. [Three-dimensional Conditional Diffusion Models for Cosmological 21 cm Lightcone Emulation](#user-content-link12)
**Authors:** Bin Xia, John H. Wise

13. [Multi epoch spectroscopic variability of the B supergiant HD75149](#user-content-link13)
**Authors:** J. Chamoun-Contreras, C. Arcos, N. Machuca, C. E. Perez-Ramirez, L. S. Cidale, M. Cur\'e, I. Araya, D. Turis-Gallo, M. Hadjara

14. [Extending Hubble into the 2030s to Resolve the Physics of LyC Escape](#user-content-link14)
...
15. [Efficient computation of the galaxy angular bispectrum in redshift space](#user-content-link15)
**Authors:** Zucheng Gao, Zvonimir Vlah, Anthony Challinor

16. [ODIN: Rest-frame Optical Morphologies and Star Formation Activity of Ly{\alpha} Emitters at z=2.4, 3.1, and 4.5](#user-content-link16)
**Authors:** Sang Hyeok Im, Ho Seong Hwang, Jeong Hwan Lee, Robin Ciardullo, Eric Gawiser, Caryl Gronwall, Lucia Guaita, Woong-Seob Jeong, Ankit Kumar, Kyoung-Soo Lee, Changbom Park, Vandana Ramakrishnan, Akriti Singh, Hyunmi Song, Sungryong Hong, Juhan Kim, Jaehyun Lee, Christophe Pichon, Caitlin M. Casey, Maximilien Franco, Santosh Harish, Jeyhan S. Kartaltepe

17. [Closing the UV Gap: Rest-frame EUV science from high-redshift QSOs as a legacy-defining capability](#user-content-link17)
**Authors:** Rongmon Bordoloi, J. Michael Shull

18. [Determining the incidence rate of magnetic $\delta$ Scuti candidates with CoRoT](#user-content-link18)
**Authors:** Gautam Paul, Coralie Neiner, Claude Catala, Jonathan Labadie-Bartz

19. [Too many protoclusters? Reconciling the overabundance of cluster progenitors within the first billion years of the Universe](#user-content-link19)
...
20. [Evidence of triggered star formation in the Pillars of Creation from JWST observations](#user-content-link20)
**Authors:** Jing Wen, Bingqiu Chen, Jian Gao, Jun Li, Ming Yang, Biwei Jiang

21. [Nebular Fingerprints of a Violent White Dwarf Merger: 3D NLTE Modelling of Type Ia Supernovae](#user-content-link21)
**Authors:** J. M. Pollin, R. Pakmor, L. J. Shingles, F. P. Callan, S. A. Sim, L. A. Kwok, C. E. Collins, F. K. Roepke, A. L. McGarrity

22. [MAMMOTH-Grism: Gas-phase Metallicity Gradients of Star-forming Galaxies in Protocluster Environments at Cosmic Noon](#user-content-link22)
...
23. [A New Cartwheel-like Collisional Ring Galaxy](#user-content-link23)
**Authors:** Vladimir P. Reshetnikov, Sergey S. Savchenko, Alexander A. Marchuk, Ilia V. Chugunov, Matvey D. Kozlov, Dmitry I. Makarov, Aleksandra V. Antipova, Anastasia M. Sypkova

24. [Augmented Correlation Functions for Spectroscopic Galaxy Surveys](#user-content-link24)
**Authors:** Davide Bianchi

25. [Impact of the equation of state on core collapse supernovae I: the low-$T/|W|$ instability](#user-content-link25)
**Authors:** Marco Cusinato, Martin Obergaulinger, Miguel \'Angel Aloy

26. [The observer power spectrum for lightcone statistics, integrated relativistic observables and wide angle effects](#user-content-link26)
**Authors:** Chris Clarkson, Pritha Paul

27. [Supermassive black hole seeds from direct collapse of CDM-curvature peaks](#user-content-link27)
**Authors:** Marco Galoppo, Marco Bruni, Tomohiro Harada

28. [Using GALEX UV Excess to Search for Metal-poor Halo Stars](#user-content-link28)
...
29. [Massive Stars in the Thirties: awaiting new Hubble discoveries](#user-content-link29)
**Authors:** Lidia M. Oskinova, Sylvia Ekstr\"om, Miriam Garcia, Takashi Moriya, Andreas A. C. Sander, Sergio Sim\'on-D\'iaz, Aida Wofford

30. [Supermassive black holes in six triaxial galaxies: Insights from SINFONI and MUSE observations](#user-content-link30)
**Authors:** Sabine Thater, Avinash Chaturvedi, Davor Krajnovic, Michele Cappellari, Sadegh Khochfar, Thorsten Naab, Marc Sarzi, Glenn van de Ven

31. [Kolmogorov--Arnold Networks as Implicit Regularizers: Noise Robustness and Interpretability for Stellar Classification](#user-content-link31)
**Authors:** Kristian Sestak

32. [Sub-luminous Type IIP SN 2024abfl as a result of a significantly low energy Fe-core collapse](#user-content-link32)
...
33. [Quantifying the effect of passband on observations in the Ca II K line](#user-content-link33)
**Authors:** Ajay Kumar Yadav, Theodosios Chatzistergos, Natalie Krivova, Sami K. Solanki, Francisco A. Iglesias, Ilaria Ermolli, Andreas Lagg, Achim Gandorfer, Jose Carlos del Toro Iniesta, Yukio Katsukawa, Pietro Bernasconi, Thomas Berkefeld, Alex Feller, Tino L. Riethm\"uller, Alberto \'Alvarez-Herrero, Masahito Kubo, H. N. Smitha, David Orozco Su\'arez, Bianca Grauf, Michael Carpenter, Alexander Bell, Valent\'in Mart\'inez Pillet, Laurent Gizon, Johannes Hoelken, Francisco Javier Bail\'en, Julian Blanco Rodr\'iguez, Juan Sebasti\'an Castellanos Dur\'an, Edvarda Harnes, Ryohtaroh T. Ishikawa, Yusuke Kawabata, Takuma Matsumoto, Takayoshi Oba, Azaymi L. Siu-Tapia, Hanna Strecker, Du\v{s}an Vukadinovi\'c, Yasuhito Narita

34. [Propagation of waves in weakly ionized two-fluid plasmas. II. Nonlinear Alfv\'enic waves](#user-content-link34)
**Authors:** David Mart\'inez-G\'omez

35. [The outer rings of SN 1987A from year 1994 to 2024: morphology, light curves, and optical to mid-infrared spectra](#user-content-link35)
...
36. [Dominated-Convergence Failure in Cosmological Perturbation Theory and a Numerical Foundation for BBGKY+ZA](#user-content-link36)
**Authors:** Svetlin V. Tassev

37. [Equilibrium Core and Vortex Solutions of Bose Einstein Condensate Dark Matter around a Black Hole](#user-content-link37)
**Authors:** Ivan Alvarez-Rios, Francisco S. Guzman

38. [Late-time Quantum Vacuum Decay and its Cosmological Implications](#user-content-link38)
**Authors:** Yang Bai, Sida Lu, Nicholas Orlofsky

39. [Black Hole Photon Rings Saturate the Quantum Chaos Bound](#user-content-link39)
**Authors:** D. Giataganas, G. F. Giudice, A. Kehagias, F. Quevedo, A. Riotto

40. [Signatures of loop quantum gravity in primordial black hole cosmologies](#user-content-link40)
**Authors:** Antoine Dierckx, S\'ebastien Clesse, Francesca Vidotto

41. [A Designer's Guide to Lunar Far-Side Interferometer Array: Power Spectrum Measurement and Cosmological Constraints from the Dark Ages](#user-content-link41)
**Authors:** Yuewei Wen, Bin Yue, Yidong Xu, Furen Deng, Chen Zhang, Xuelei Chen

42. [Transient Signatures of Star-Envelope Collisions in Little Red Dots](#user-content-link42)
**Authors:** Tomoya Suzuguchi, Kohei Inayoshi

43. [Photometry is all you need: supernova classification as a mixing problem](#user-content-link43)
**Authors:** Ana Sof\'ia M. Uzsoy, V. Ashley Villar

44. [Recoil-regulated extreme mass-ratio inspirals in AGN disks](#user-content-link44)
**Authors:** LingQin Xue, Zolt\'an Haiman, Hiromichi Tagawa, Imre Bartos

45. [From reflection to scattering: polarimetric signatures of funnel-type outflows. Modeling obscured ultraluminous X-ray sources](#user-content-link45)
**Authors:** Varpu Ahlberg, Alexandra Veledina, Eugene Churazov, Ildar Khabibullin

46. [Gamma-ray signature of superluminous supernovae: Fermi-LAT GeV detection of SN 2017egm and evidence of a central engine](#user-content-link46)
**Authors:** F. Acero (for the Fermi-LAT Collaboration), A. Acharyya (for the Fermi-LAT Collaboration), A. Adelfio (for the Fermi-LAT Collaboration), M. Ajello (for the Fermi-LAT Collaboration), E. Aviano (for the Fermi-LAT Collaboration), L. Baldini (for the Fermi-LAT Collaboration), J. Ballet (for the Fermi-LAT Collaboration), C. Bartolini (for the Fermi-LAT Collaboration), D. Bastieri (for the Fermi-LAT Collaboration), J. Becerra Gonzalez (for the Fermi-LAT Collaboration), R. Bellazzini (for the Fermi-LAT Collaboration), E. Bissaldi (for the Fermi-LAT Collaboration), R. Bonino (for the Fermi-LAT Collaboration), P. Bruel (for the Fermi-LAT Collaboration), S. Buson (for the Fermi-LAT Collaboration), R. A. Cameron (for the Fermi-LAT Collaboration), P. A. Caraveo (for the Fermi-LAT Collaboration), F. Casaburo (for the Fermi-LAT Collaboration), F. Casini (for the Fermi-LAT Collaboration), E. Cavazzuti (for the Fermi-LAT Collaboration), C. C. Cheung (for the Fermi-LAT Collaboration), N. Cibrario (for the Fermi-LAT Collaboration), G. Cozzolongo (for the Fermi-LAT Collaboration), P. Cristarella Orestano (for the Fermi-LAT Collaboration), F. Cuna (for the Fermi-LAT Collaboration), S. Cutini (for the Fermi-LAT Collaboration), F. D'Ammando (for the Fermi-LAT Collaboration), D. Depalo (for the Fermi-LAT Collaboration), S. W. Digel (for the Fermi-LAT Collaboration), N. Di Lalla (for the Fermi-LAT Collaboration), A. Dinesh (for the Fermi-LAT Collaboration), L. Di Venere (for the Fermi-LAT Collaboration), P. Fauverge (for the Fermi-LAT Collaboration), A. Fiori (for the Fermi-LAT Collaboration), A. Franckowiak (for the Fermi-LAT Collaboration), Y. Fukazawa (for the Fermi-LAT Collaboration), S. Funk (for the Fermi-LAT Collaboration), P. Fusco (for the Fermi-LAT Collaboration), F. Gargano (for the Fermi-LAT Collaboration), C. Gasbarra (for the Fermi-LAT Collaboration), D. Gasparrini (for the Fermi-LAT Collaboration), S. Germani (for the Fermi-LAT Collaboration), F. Giacchino (for the Fermi-LAT Collaboration), N. Giglietto (for the Fermi-LAT Collaboration), M. Giliberti (for the Fermi-LAT Collaboration), F. Giordano (for the Fermi-LAT Collaboration), M. Giroletti (for the Fermi-LAT Collaboration), I. A. Grenier (for the Fermi-LAT Collaboration), M. -H. Grondin (for the Fermi-LAT Collaboration), S. Guiriec (for the Fermi-LAT Collaboration), R. Gupta (for the Fermi-LAT Collaboration), E. Hays (for the Fermi-LAT Collaboration), J. W. Hewitt (for the Fermi-LAT Collaboration), A. Holzmann Airasca (for the Fermi-LAT Collaboration), D. Horan (for the Fermi-LAT Collaboration), X. Hou (for the Fermi-LAT Collaboration), T. Kayanoki (for the Fermi-LAT Collaboration), M. Kerr (for the Fermi-LAT Collaboration), M. Kuss (for the Fermi-LAT Collaboration), A. Laviron (for the Fermi-LAT Collaboration), M. Lemoine-Goumard (for the Fermi-LAT Collaboration), A. Liguori (for the Fermi-LAT Collaboration), J. Li (for the Fermi-LAT Collaboration), I. Liodakis (for the Fermi-LAT Collaboration), P. Loizzo (for the Fermi-LAT Collaboration), F. Longo (for the Fermi-LAT Collaboration), F. Loparco (for the Fermi-LAT Collaboration), S. L\'opez P\'erez (for the Fermi-LAT Collaboration), L. Lorusso (for the Fermi-LAT Collaboration), M. N. Lovellette (for the Fermi-LAT Collaboration), P. Lubrano (for the Fermi-LAT Collaboration), S. Maldera (for the Fermi-LAT Collaboration), A. Manfreda (for the Fermi-LAT Collaboration), G. Mart\'i-Devesa (for the Fermi-LAT Collaboration), R. Martinelli (for the Fermi-LAT Collaboration), M. N. Mazziotta (for the Fermi-LAT Collaboration), M. Michailidis (for the Fermi-LAT Collaboration), P. F. Michelson (for the Fermi-LAT Collaboration), N. Mirabal (for the Fermi-LAT Collaboration), T. Mizuno (for the Fermi-LAT Collaboration), P. Monti-Guarnieri (for the Fermi-LAT Collaboration), M. E. Monzani (for the Fermi-LAT Collaboration), A. Morselli (for the Fermi-LAT Collaboration), I. V. Moskalenko (for the Fermi-LAT Collaboration), M. Negro (for the Fermi-LAT Collaboration), N. Omodei (for the Fermi-LAT Collaboration), M. Orienti (for the Fermi-LAT Collaboration), E. Orlando (for the Fermi-LAT Collaboration), G. Panzarini (for the Fermi-LAT Collaboration), M. Persic (for the Fermi-LAT Collaboration), M. Pesce-Rollins (for the Fermi-LAT Collaboration), R. Pillera (for the Fermi-LAT Collaboration), T. A. Porter (for the Fermi-LAT Collaboration), G. Principe (for the Fermi-LAT Collaboration), S. Rain\`o (for the Fermi-LAT Collaboration), R. Rando (for the Fermi-LAT Collaboration), B. Rani (for the Fermi-LAT Collaboration), M. Razzano (for the Fermi-LAT Collaboration), A. Reimer (for the Fermi-LAT Collaboration), O. Reimer (for the Fermi-LAT Collaboration), M. S\'anchez-Conde (for the Fermi-LAT Collaboration), P. M. Saz Parkinson (for the Fermi-LAT Collaboration), D. Serini (for the Fermi-LAT Collaboration), C. Sgr\`o (for the Fermi-LAT Collaboration), E. J. Siskind (for the Fermi-LAT Collaboration), G. Spandre (for the Fermi-LAT Collaboration), P. Spinelli (for the Fermi-LAT Collaboration), D. J. Suson (for the Fermi-LAT Collaboration), H. Tajima (for the Fermi-LAT Collaboration), D. J. Thompson (for the Fermi-LAT Collaboration), D. F. Torres (for the Fermi-LAT Collaboration), Z. Wadiasingh (for the Fermi-LAT Collaboration), K. Wood (for the Fermi-LAT Collaboration), G. Zaharijas (for the Fermi-LAT Collaboration), W. Zhang (for the Fermi-LAT Collaboration), E. Chatzopoulos, B. D. Metzger, P. J. Pessi, I. Vurm

47. [The incidence and star-formation properties of X-ray active galactic nuclei across the star-forming main sequence in DESI-eRASS1: the role of host-galaxy morphology](#user-content-link47)
**Authors:** G. Mountrichas, F. J. Carrera, V. A. Masoura, S. Mateos, M. Siudek, A. Corral

48. [Cosmo-PINN: A Physics-Informed Neural Network for Cosmological Reconstruction](#user-content-link48)
**Authors:** Andronikos Paliathanasis

49. [Model Independent Probe of Variation of Cosmic Opacity with Redshift](#user-content-link49)
**Authors:** Savita Gahlaut, Meetu Luthra

50. [Detection of unidentified molecular pure rotational lines in C-rich PNe I. The fullerene-containing PN IC 418](#user-content-link50)
**Authors:** T. Huertas-Rold\'an, J. P. Fonfr\'ia, J. Alcolea, D. A. Garc\'ia-Hern\'andez, S. Mato, J. J. D\'iaz-Luis, R. Barzaga, A. Manchado, V. Bujarrabal, M. A. G\'omez-Mu\~noz

51. [A Calibrated Bayesian Search for Potential Chemical Technosignatures in Polluted White Dwarf](#user-content-link51)
**Authors:** Bo-Lun Huang, Zhen-Zhao Tao, Tong-Jie Zhang

52. [Dynamical Tsallis WIMP Freeze-Out and Residual Memory Channels in the Radiation Sector](#user-content-link52)
**Authors:** Matias P. Gonzalez

53. [Signals from the early Universe: a comprehensive search for primordial features in Planck CMB datasets](#user-content-link53)
**Authors:** Antonio Raffaelli, Mario Ballardini, Nicola Barbieri

54. [The MeerKAT Thousand-Pulsar Polarization Array I: Properties of the Polarization and Rotation Measure Time Series Data](#user-content-link54)
**Authors:** Michael Sarkis (Stellenbosch University, South Africa), Zi-Yan Yuwen (Stellenbosch University, South Africa, APCTP, Korea, ITP/CAS, China), Yin-Zhe Ma (Stellenbosch University, South Africa), Tao Liu (The Hong Kong University of Science and Technology), Jing Ren (IHEP/CAS, China, Peking University, China), Patrick Weltevrede (University of Manchester, UK), Xiao Xue (Barcelona Institute of Science and Technology, Spain)

55. [Assessing the Relative Importance of Neutrino Matter Interaction Channels in Post-Merger Remnant of Binary Neutron Stars](#user-content-link55)
**Authors:** Samantha Rath, Francois Foucart, Lawrence E. Kidder, Harald P. Pfeiffer, Mark A. Scheel

56. [Quantum transitions of vector vortex light in gravitational waves](#user-content-link56)
**Authors:** Haorong Wu, Xilong Fan

57. [A Minimal Dark $SU(2)$ Origin of a Massless Dirac Neutrino](#user-content-link57)
**Authors:** P. S. Bhupal Dev, Julia Gehrlein, Amartya Sengupta, Amarjit Soni

58. [DELOS: Detecting Shallow Transits in Kepler Photometry Using a Contrastive-Learning Framework](#user-content-link58)
**Authors:** Qingtian Liu, Jian Ge, XingChen Yan, Kevin Willis, Xinyu Yao, QuanQuan Hu, Jiapeng Zhu

59. [Delayed Radio Flares in Tidal Disruption Events from Star-Disk Collision Outflows](#user-content-link59)
**Authors:** Itai Linial, Brian D. Metzger, Andrei M. Beloborodov

60. [Dust grain chemistry in the diffuse ISM towards the black hole transient GX 339-4](#user-content-link60)
**Authors:** I. Psaradaki, L. Corrales, E. Costantini, P. Draghis, J. A. Garc\'ia, E. Gatuzz, P. Kosec, G. Mastroserio, M. Mehdipour, F. Paerels, D. Rogantini, N. Schulz, S. Zeegers

61. [Compact near infrared sources in the center of the extraordinary galaxy IC 860](#user-content-link61)
**Authors:** J. S. Gallagher (Department of Physics and Astronomy, Macalester College, St. Paul, MN, USA, Department of Astronomy, University of Wisconsin-Madison, Madison, WI, USA), L. Schisgal (Department of Physics and Astronomy, Macalester College, St. Paul, MN, USA), G. C. Privon (National Radio Astronomy Observatory, Edgemont Rd. Charlottesville, VA, USA, Department of Astronomy, University of Florida, Gainesville, FL, USA, Department of Astronomy, University of Virginia, Charlottesville, VA, USA), S. Aalto (Department of Space, Earth and Environment, Onsala Space Observatory, Chalmers University of Technology, Onsala, Sweden), S. K\"onig (Department of Space, Earth and Environment, Onsala Space Observatory, Chalmers University of Technology, Onsala, Sweden), R. Kotulla (Department of Astronomy, University of Wisconsin-Madison, Madison, WI, USA), J. Mangum (National Radio Astronomy Observatory, Edgemont Rd. Charlottesville, VA, USA), W. St. John (Department of Physics and Astronomy, Macalester College, St. Paul, MN, USA), D. Rigopoulou (Department of Physics, University of Oxford, Oxford, UK, School of Sciences, European University Cyprus, Nicosia, Cyprus), K. Alatalo (Space Telescope Science Institute, Baltimore, MD, USA, William H. Miller III Department of Physics and Astronomy, Johns Hopkins University, Baltimore, MD, USA)

62. [Effective chemical potential and its phenomenological implications for the Hubble parameter](#user-content-link62)
**Authors:** L. L. Sales, F. C. Carvalho

63. [The energy conditions and model selection in the local Universe](#user-content-link63)
**Authors:** Namit Chandak, Fulvio Melia, Junjie Wei

64. [Physics Is All You Need? A Case Study in Physicist-Supervised AI Development of Scientific Software](#user-content-link64)
**Authors:** Nhat-Minh Nguyen

65. [First head-to-head comparison of agentic AI applied to the analysis of simulated data of the Einstein Telescope](#user-content-link65)
**Authors:** Gianluca Inguglia

66. [Optical transmission spectrum of HAT-P-47b: evidence for aerosols and tentative TiO absorption](#user-content-link66)
**Authors:** Wan-Hao Wang, Guo Chen, Fei Yan, Chengzi Jiang, Luigi Mancini, Enric Pall\'e, Felipe Murgas, Hannu Parviainen

67. [Characterization of Spurious Charge in SENSEI Skipper-CCDs](#user-content-link67)
**Authors:** Yikai Wu, Ansh Desai, Sho Uemura, Ana M. Botti, Brenda A. Cervantes-Vergara, Fernando Chierchie, Alex Drlica-Wagner, Rouven Essig, Juan Estrada, Erez Etzion, Guillermo Fernandez Moroni, Miqueas Gamero, Stephen E. Holland, Ian Lawson, Steffon Luoma, Nathan A. Saffold, Miguel Sofo-Haro, Javier Tiffenberg, Tomer Volansky

68. [Assessing Ariel's capabilities to observe free-floating brown dwarfs](#user-content-link68)
**Authors:** Roman Akhmetshyn, Nicolas B Cowan, Sarah Casewell

69. [Towards a Foundation Model for the Martian Atmosphere](#user-content-link69)
**Authors:** Sujit Roy, Udayshankar Nair, Yuling Wu, Georgios Priftis, Liping Wang, Anastasia Georgiou, Anne Jones, Bj\"orn L\"utjens, Johannes Schmude, Campbell Watson, Rachel A. Slank, Ankur Kumar, Anirbit Mukherjee, Procheta Sen, Ramin Lolachi, Haonan Chen, Manil Maskey, Juan Bernab\'e-Moreno, Rahul Ramachandran

70. [The Northern Cross Fast Radio Burst project: VI. The INCART public database](#user-content-link70)
**Authors:** L. Bruno, G. Bernardi, M. Pilia, D. Pelliciari, A. Geminardi, F. Fiori, V. Galluzzi, G. Naldi, M. Trudu, A. Zanichelli

71. [When the Ringing Stops: Purely Imaginary Modes in the Ringdown Spectrum of Dynamical Black Holes](#user-content-link71)
**Authors:** Lodovico Capuano, Thomas Lovo, Gorka Prieto-Varela, Subhodeep Sarkar, Adrien Kuntz, Enrico Barausse, Dawood Kothawala

72. [Enhanced All-Distance Equi-Zenith Angle Method for Cosmic-Ray Anisotropy Measurement](#user-content-link72)
**Authors:** Dong-Xu Sun, Dan Li, Wei Liu, Qiang Yuan, Yi-Qing Guo, Hong-bo Hu

73. [Time-Domain Deep Learning for Pairwise Identification of Strongly Lensed Gravitational-Wave Candidates](#user-content-link73)
**Authors:** Fan Zhang, Qikai Zhang, Qiyuan Yang, Jiaqing Huang, Yong Yuan, Xilong Fan

74. [A new completely parameter-free clustering algorithm for unsupervised classification of BATSE gamma-ray bursts](#user-content-link74)
**Authors:** Soumita Modak

75. [An Obscured Tidal Disruption Event Uncovered by Its Mid- and Near-Infrared Dust Echo in a Star-Forming Galaxy](#user-content-link75)
...
76. [Visible inelasticity as a probe of tau flavor content of astrophysical neutrinos](#user-content-link76)
**Authors:** Alex Y. Wen, Carlos A. Arg\"uelles, Sergio Palomares-Ruiz

77. [Long-Duration GRB 211211A: Internal Energy Dissipation Driven by a Long-Lived Magnetar](#user-content-link77)
**Authors:** Nissim Fraija

78. [Modeling the Effect of the Heliospheric Magnetic Field on Cosmic Ray Muon Shadows](#user-content-link78)
**Authors:** MINOS+ Collaboration, :, P. Adamson, I. Anghel, A. Aurisano, G. Barr, A. Blake, S. V. Cao, T. J. Carroll, C. M. Castromonte, R. Chen, S. Childress, J. A. B. Coelho, S. De Rijck, J. J. Evans, G. J. Feldman, W. Flanagan, S. Fogarty, M. Gabrielyan, H. R. Gallagher, S. Germani, R. A. Gomes, M. C. Goodman, P. Gouffon, N. Graf, N. Grossman, K. Grzelak, A. Habig, S. R. Hahn, J. Hartnell, R. Hatcher, A. Holin, J. Huang, L. W. Koerner, M. Kordosky, A. Kreymer, J. Krueger, K. Lang, P. Lucas, W. A. Mann, M. L. Marshak, N. Mayer, R. Mehdiyev, J. Meier, W. H. Miller, G. Mills, D. Naples, J. K. Nelson, R. Nichol, J. OConnor, R. B. Pahlka, \v{Z}. Pavlovi\'c, G. Pawloski, A. Perch, M. M. Pf\"utzner, D. D. Phan, R. K. Plunkett, N. Poonthottathil, X. Qiu, A. Radovic, P. Sail, M. C. Sanchez, A. Schreckenberger, R. Sharma, N. Skuza, A. Sousa, N. Tagg, J. Thomas, M. A. Thomson, A. Timmons, J. Todd, S. C. Tognini, R. Toner, D. Torretta, P. Vahle, A. Weber, L. H. Whitehead, S. G. Wojcicki

79. [Development and demonstration of a Modular Astrobiological Experiments (MAEx) payload for autonomous biological monitoring in Low Earth Orbit (LEO)](#user-content-link79)
...
80. [Spin-Orbit Geometry of AU Mic b and c from Back-to-Back Transits Observed Contemporaneously with Magellan PFS, LCOGT, and CHEOPS](#user-content-link80)
**Authors:** Zitao Lin, Gyula M. Szab\'o, Krzysztof Sz. Zieli\'nski, Zhen Guo, Zolt\'an Garai, R. Paul Butler, Alexis Brandeker, Johanna K. Teske, Davide Gandolfi, Haochuan Yu, Nicolas Billot, Suzanne Aigrain, Michael Cretignier, Liang Wang, Xuan Mao, Wei M. Yuan, Hongpeng Lu, Jiayin Li, Yann Alibert, \'Ad\'am Boldog, Vincent Bourrier, Giovanni Bruno, Jeffrey D. Crane, Fei Dai, Olivier D. S. Demangeon, Alexis Heitzmann, Zhecheng Hu, Pradip Karkamar, Levente Kriskovics, Monika Lendl, He Y. Liu, Pierre F. L. Maxted, Hugh P. Osborn, Gaetano Scandariato, Stephen A. Shectman, S\'ergio G. Sousa, Sol\`ene Ulmer-Moll, Mu-Tian Wang, Thomas G. Wilson, Sharon X. Wang

81. [JWST's Dusty Blue BOAT -- GRB 221009A](#user-content-link81)
...
## 4. [Exploring the High-Redshift 21-cm Signal via Self-Consistent Simulations using Artificial Neural Network Emulation](https://arxiv.org/abs/2605.29876) <a id="link4"></a>
...
**Comment:** Presents new semi-numeric simulations of Cosmic Dawn, calibrating small-scale star formation to hydrodynamic simulations and predicting 21-cm signals. This fits the numerical galaxy simulations criterion, especially with new physics and high-resolution modeling.
...
## 5. [From Images to Orbits: A Hubble 2030s Astrometric Legacy for the M31-M33 Star Cluster Systems](https://arxiv.org/abs/2605.30249) <a id="link5"></a>
...
**Comment:** The paper proposes a Hubble astrometric legacy for M31 and M33 star cluster systems, enabling systematic orbital mapping of star cluster populations beyond the Milky Way. This is relevant to near-field cosmology, especially regarding accretion histories and interactions between Local Group galaxies, and also touches on resolved star formation histories via cluster populations.
...
## 7. [Multiple populations detection with the Chinese Space Station Survey Telescope main survey camera](https://arxiv.org/abs/2605.29504) <a id="link7"></a>
...
**Comment:** This paper uses synthetic stellar population models and color-magnitude diagrams to study multiple populations in globular clusters, with a focus on resolved star formation histories and stellar models. It matches the 'Resolved Star Formation Histories' and 'Stellar Models' criteria, especially through CMD analysis and synthetic modeling.
...
## 8. [Next-generation Exo-REM atmospheric models: application to VHS 1256 b to emulate patchy clouds](https://arxiv.org/abs/2605.29070) <a id="link8"></a>
...
**Comment:** Relevant to stellar models: Presents new atmospheric models for brown dwarfs and exoplanets, including updated molecular opacities and cloud modeling. This fits the 'Stellar Models' criterion, though the focus is on substellar objects rather than stars. Weighted lower due to the focus on exoplanets and brown dwarfs.
...
## 9. [Stellar Population Astrophysics (SPA) with the TNG. CNO abundances in 28 open clusters](https://arxiv.org/abs/2605.29666) <a id="link9"></a>
...
**Comment:** This paper presents CNO abundances in open cluster giants and discusses [C/N] ratios as chemical clocks for stellar age determinations. It uses high-resolution spectra and compares results to theoretical predictions, touching on stellar models and evolutionary tracks. The focus is on stellar models and chemical clocks, which matches the 'Stellar Models' criterion, though it is observational rather than theoretical model development. Solid relevance.
...
## 10. [A Deep Study of the Spiral Galaxy W2246f](https://arxiv.org/abs/2605.29014) <a id="link10"></a>
...
**Comment:** Deep study of the spiral galaxy W2246f, including spatially resolved stellar and gas properties, star formation rates, and quenching in the central region. The paper discusses inside-out quenching and resolved star formation histories, but the galaxy is a massive spiral, not a dwarf or satellite. Some relevance to star formation quenching and resolved star formation histories, but weighted lower due to galaxy mass.
...
## 11. [A 1% distance to the Large Magellanic Cloud measured by population-II pulsating stars using Gaia Data Release 3](https://arxiv.org/abs/2605.28941) <a id="link11"></a>
...
**Comment:** Measures the distance to the LMC using population-II pulsating stars and Gaia DR3. While the LMC is a satellite galaxy and the paper maps its 3D structure, the focus is on distance measurement rather than near-field cosmology, star formation history, or quenching.
...
## 12. [Three-dimensional Conditional Diffusion Models for Cosmological 21 cm Lightcone Emulation](https://arxiv.org/abs/2605.29016) <a id="link12"></a>
...
**Comment:** This paper presents a new simulation-level baseline for three-dimensional 21 cm lightcone emulation, which is relevant to numerical galaxy simulations, especially as it pertains to cosmological modeling and simulation techniques. However, it does not directly address galaxy-scale physics or dwarf galaxy properties.
...
## 13. [Multi epoch spectroscopic variability of the B supergiant HD75149](https://arxiv.org/abs/2605.29044) <a id="link13"></a>
...
**Comment:** Relevant to stellar models: Investigates spectroscopic variability and mass-loss rates in a B supergiant, including hydrodynamical and radiative-transfer modeling. This fits the 'Stellar Models' criterion, though the focus is on a single massive star rather than new model grids.
...
## 14. [Extending Hubble into the 2030s to Resolve the Physics of LyC Escape](https://arxiv.org/abs/2605.30035) <a id="link14"></a>
...
**Comment:** This paper discusses the physics of Lyman continuum (LyC) escape from star-forming galaxies, the role of stellar feedback and galactic winds, and the need for high-resolution UV spectroscopy. The focus on stellar feedback and galactic winds aligns with the 'Star Formation Driven Outflows' criterion, though the primary context is high-redshift galaxies rather than dwarfs. The relevance is moderate as it touches on outflows and feedback, but not specifically in the context of dwarf galaxies or near-field cosmology.
...
## 15. [Efficient computation of the galaxy angular bispectrum in redshift space](https://arxiv.org/abs/2605.30246) <a id="link15"></a>
...
**Comment:** Borderline relevance: The paper presents efficient computation of the galaxy angular bispectrum in redshift space, which is a numerical method relevant to large-scale structure. However, it does not directly address galaxy simulations, dwarf galaxies, or star formation histories.
...
## 17. [Closing the UV Gap: Rest-frame EUV science from high-redshift QSOs as a legacy-defining capability](https://arxiv.org/abs/2605.28948) <a id="link17"></a>
...
**Comment:** This paper advocates for expanding HST/COS UV spectroscopic observations of intermediate-redshift quasars to study the rest-frame EUV, with applications to the CGM and IGM. While the CGM is mentioned, the focus is on warm-hot CGM/IGM science at intermediate redshift and AGN, not specifically on dwarf galaxies or satellite systems. Some relevance to circumgalactic medium, but not closely matched to the core topics.
...
## 18. [Determining the incidence rate of magnetic $\delta$ Scuti candidates with CoRoT](https://arxiv.org/abs/2605.30171) <a id="link18"></a>
...
**Comment:** The paper investigates magnetic properties and incidence rates in delta Scuti stars using CoRoT data. While it discusses stellar magnetism and asteroseismology, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale topics. The closest match is to stellar models, but only in the context of magneto-asteroseismology, not model development. Borderline relevance.
...
## 20. [Evidence of triggered star formation in the Pillars of Creation from JWST observations](https://arxiv.org/abs/2605.29904) <a id="link20"></a>
...
**Comment:** JWST observations of the Pillars of Creation, identifying YSO candidates and evidence for triggered star formation. While it discusses star formation and feedback, the focus is on a star-forming region within the Milky Way, not on galaxies or resolved star formation histories.
...
## 21. [Nebular Fingerprints of a Violent White Dwarf Merger: 3D NLTE Modelling of Type Ia Supernovae](https://arxiv.org/abs/2605.29038) <a id="link21"></a>
...
**Comment:** Presents 3D NLTE modeling of Type Ia supernovae from violent white dwarf mergers. While it involves numerical simulations and stellar models, the focus is on supernovae and progenitor scenarios, not on galaxy-scale phenomena or the core criteria.
...
## 22. [MAMMOTH-Grism: Gas-phase Metallicity Gradients of Star-forming Galaxies in Protocluster Environments at Cosmic Noon](https://arxiv.org/abs/2605.29623) <a id="link22"></a>
...
**Comment:** Studies metallicity gradients in star-forming galaxies in protocluster environments at z~2.3. While it discusses star formation and environmental effects, it is focused on massive galaxies at high redshift, not dwarfs or resolved star formation histories.
...
## 23. [A New Cartwheel-like Collisional Ring Galaxy](https://arxiv.org/abs/2605.29618) <a id="link23"></a>
...
**Comment:** Discovery and photometric study of a Cartwheel-type collisional ring galaxy. While interesting for star formation in density waves, the focus is on a massive galaxy and not on dwarfs or resolved star formation histories.
...
## 24. [Augmented Correlation Functions for Spectroscopic Galaxy Surveys](https://arxiv.org/abs/2605.30305) <a id="link24"></a>
...
**Comment:** Introduces augmented correlation functions for spectroscopic galaxy surveys, aiming to extract more information about galaxy clustering and cosmological parameters. The focus is on large-scale structure and cosmological parameter constraints, not on galaxy simulations, star formation histories, or dwarf galaxies. No direct match to relevant criteria.
...
## 25. [Impact of the equation of state on core collapse supernovae I: the low-$T/|W|$ instability](https://arxiv.org/abs/2605.28944) <a id="link25"></a>
...
**Comment:** Presents 3D simulations of core-collapse supernovae with different equations of state, focusing on the low-T/|W| instability and its multimessenger signatures. The work is on stellar models and supernovae, but not on stellar evolutionary tracks or atmosphere models relevant to the core criteria. No direct match.
...
## 26. [The observer power spectrum for lightcone statistics, integrated relativistic observables and wide angle effects](https://arxiv.org/abs/2605.29806) <a id="link26"></a>
...
**Comment:** Presents a new formalism for power spectrum statistics in cosmological observables. While relevant to cosmological large-scale structure, it does not directly address any of the core topics (dwarf galaxies, star formation histories, etc.).
...
## 27. [Supermassive black hole seeds from direct collapse of CDM-curvature peaks](https://arxiv.org/abs/2605.30145) <a id="link27"></a>
...
**Comment:** No direct match to any core criteria. Focuses on supermassive black hole seed formation from primordial CDM curvature peaks, which is not related to dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 28. [Using GALEX UV Excess to Search for Metal-poor Halo Stars](https://arxiv.org/abs/2605.29060) <a id="link28"></a>
...
**Comment:** Focuses on identifying metal-poor halo stars using GALEX NUV excess. While it deals with stellar populations in the Milky Way halo, it does not directly address satellite galaxies, resolved star formation histories, or other core criteria.
...
## 29. [Massive Stars in the Thirties: awaiting new Hubble discoveries](https://arxiv.org/abs/2605.28972) <a id="link29"></a>
...
**Comment:** This paper discusses massive stars and their role in galaxy evolution, but focuses on uncertainties in massive star physics and future HST observations. While it touches on stellar models, it does not present new models or focus on resolved star formation histories or dwarf galaxies.
...
## 30. [Supermassive black holes in six triaxial galaxies: Insights from SINFONI and MUSE observations](https://arxiv.org/abs/2605.28959) <a id="link30"></a>
...
**Comment:** Irrelevant: Focuses on supermassive black holes in massive early-type galaxies, which is outside the scope of near-field cosmology (dwarf galaxies, satellite galaxies, etc.).
...
## 31. [Kolmogorov--Arnold Networks as Implicit Regularizers: Noise Robustness and Interpretability for Stellar Classification](https://arxiv.org/abs/2605.29039) <a id="link31"></a>
...
**Comment:** Paper discusses machine learning methods for stellar classification using SDSS and DESI data. While it deals with stars, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale topics. Only tangentially related to stellar models.
...
## 32. [Sub-luminous Type IIP SN 2024abfl as a result of a significantly low energy Fe-core collapse](https://arxiv.org/abs/2605.29363) <a id="link32"></a>
...
**Comment:** Observational study of a low-luminosity Type IIP supernova, including hydrodynamical modeling of the progenitor. While it involves stellar evolution and supernovae, it does not present new stellar models or address galaxy-scale topics.
...
## 33. [Quantifying the effect of passband on observations in the Ca II K line](https://arxiv.org/abs/2605.29982) <a id="link33"></a>
...
**Comment:** Paper quantifies the effect of passband on Ca II K solar observations for cross-calibration of solar activity records. While it deals with stellar atmospheres and solar activity, it does not present new stellar models or address galaxy-scale topics.
...
## 34. [Propagation of waves in weakly ionized two-fluid plasmas. II. Nonlinear Alfv\'enic waves](https://arxiv.org/abs/2605.30057) <a id="link34"></a>
...
**Comment:** Study of nonlinear Alfvénic waves in weakly ionized plasmas, relevant to solar and stellar atmospheres. While it involves plasma physics and stellar atmospheres, it does not present new stellar models or address galaxy-scale topics.
...
## 35. [The outer rings of SN 1987A from year 1994 to 2024: morphology, light curves, and optical to mid-infrared spectra](https://arxiv.org/abs/2605.30043) <a id="link35"></a>
...
**Comment:** The paper studies the outer rings of SN 1987A, focusing on their morphology, light curves, and spectra. While it involves stellar evolution and supernova remnants, it does not present new stellar models or address galaxy-scale topics such as star formation histories or dwarf galaxy properties.
...
## 37. [Equilibrium Core and Vortex Solutions of Bose Einstein Condensate Dark Matter around a Black Hole](https://arxiv.org/abs/2605.29069) <a id="link37"></a>
...
**Comment:** Constructs stationary solutions of Bose-Einstein condensate dark matter around a black hole, including core and vortex solutions. The focus is on dark matter models and their stability, not on galaxy simulations, satellite galaxies, or star formation histories.
...
## 38. [Late-time Quantum Vacuum Decay and its Cosmological Implications](https://arxiv.org/abs/2605.30259) <a id="link38"></a>
...
**Comment:** Explores late-time quantum vacuum decay and its cosmological implications, focusing on vacuum energy, dark matter conversion, and CMB constraints. The work is cosmological but not directly related to galaxy-scale phenomena or the core criteria.
...
## 39. [Black Hole Photon Rings Saturate the Quantum Chaos Bound](https://arxiv.org/abs/2605.29923) <a id="link39"></a>
...
**Comment:** No direct match to any core criteria. Focuses on quantum chaos and photon rings around black holes, not on galaxy evolution, star formation, or stellar models.
...
## 40. [Signatures of loop quantum gravity in primordial black hole cosmologies](https://arxiv.org/abs/2605.28953) <a id="link40"></a>
...
**Comment:** This paper discusses primordial black holes as dark matter and their cosmological signatures, but does not focus on near-field cosmology, dwarf galaxies, or resolved star formation histories. The topic is more about early universe cosmology and quantum gravity, which is outside the core criteria.
...
## 41. [A Designer's Guide to Lunar Far-Side Interferometer Array: Power Spectrum Measurement and Cosmological Constraints from the Dark Ages](https://arxiv.org/abs/2605.29276) <a id="link41"></a>
...
**Comment:** Focuses on 21-cm cosmology during the Dark Ages and lunar interferometer design for inflationary constraints. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations. No direct relevance to the core topics.
...
## 42. [Transient Signatures of Star-Envelope Collisions in Little Red Dots](https://arxiv.org/abs/2605.29895) <a id="link42"></a>
...
**Comment:** Focuses on star-envelope collisions in high-redshift objects (Little Red Dots) and their transient signatures, with a connection to supermassive black holes and AGN. No direct relevance to dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 43. [Photometry is all you need: supernova classification as a mixing problem](https://arxiv.org/abs/2605.28922) <a id="link43"></a>
...
**Comment:** This paper presents a method for supernova classification using photometry. While it is a methodological advance, it does not address any of the core criteria (near-field cosmology, resolved star formation histories, dwarf galaxies, etc.).
...
## 44. [Recoil-regulated extreme mass-ratio inspirals in AGN disks](https://arxiv.org/abs/2605.29305) <a id="link44"></a>
...
**Comment:** This paper focuses on EMRIs in AGN disks, specifically the role of stellar-mass black holes and their interactions in the disk. The topic is centered on supermassive black holes and AGN disks, which is outside the scope of near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the CGM of dwarf galaxies. No relevant criteria are matched.
...
## 45. [From reflection to scattering: polarimetric signatures of funnel-type outflows. Modeling obscured ultraluminous X-ray sources](https://arxiv.org/abs/2605.29487) <a id="link45"></a>
...
**Comment:** This paper models polarimetric signatures of funnel-type outflows in ultraluminous X-ray sources, focusing on super-Eddington accretion and outflows in compact objects. The outflows discussed are not star-formation-driven, but rather accretion-driven, and the context is X-ray binaries, not galaxies or dwarf galaxies. No relevant criteria are matched.
...
## 46. [Gamma-ray signature of superluminous supernovae: Fermi-LAT GeV detection of SN 2017egm and evidence of a central engine](https://arxiv.org/abs/2605.29909) <a id="link46"></a>
...
**Comment:** This paper focuses on gamma-ray emission from superluminous supernovae and investigates the powering mechanism (magnetar vs. CSM interaction). While it discusses outflows and central engines, it does not directly address star-formation-driven outflows, resolved star formation histories, or near-field cosmology. The relevance to core topics is low.
...
## 47. [The incidence and star-formation properties of X-ray active galactic nuclei across the star-forming main sequence in DESI-eRASS1: the role of host-galaxy morphology](https://arxiv.org/abs/2605.28921) <a id="link47"></a>
...
**Comment:** Examines star formation and AGN activity across the star-forming main sequence, with a focus on host-galaxy morphology. The study is on higher-mass galaxies and AGN, not dwarf galaxies or star formation quenching in dwarfs.
...
## 48. [Cosmo-PINN: A Physics-Informed Neural Network for Cosmological Reconstruction](https://arxiv.org/abs/2605.30139) <a id="link48"></a>
...
**Comment:** Cosmo-PINN is a physics-informed neural network for reconstructing the dark energy equation of state from cosmological observations. The focus is on cosmological theory and dark energy, not on galaxies, satellites, or star formation histories. No direct match to any relevant criteria.
...
## 49. [Model Independent Probe of Variation of Cosmic Opacity with Redshift](https://arxiv.org/abs/2605.29805) <a id="link49"></a>
...
**Comment:** Presents a model-independent probe of cosmic opacity variation with redshift using SNe Ia and strong lensing data. While it is cosmological, it does not address galaxy-scale phenomena or any of the core criteria.
...
## 50. [Detection of unidentified molecular pure rotational lines in C-rich PNe I. The fullerene-containing PN IC 418](https://arxiv.org/abs/2605.30020) <a id="link50"></a>
...
**Comment:** Reports detection of unidentified molecular rotational lines in the fullerene-containing planetary nebula IC 418. The focus is on molecular astrophysics and chemistry in evolved stars, not on galaxies or the core criteria.
...
## 51. [A Calibrated Bayesian Search for Potential Chemical Technosignatures in Polluted White Dwarf](https://arxiv.org/abs/2605.29811) <a id="link51"></a>
...
**Comment:** No direct match to any core criteria. Focuses on chemical technosignatures in polluted white dwarfs, which is not related to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 52. [Dynamical Tsallis WIMP Freeze-Out and Residual Memory Channels in the Radiation Sector](https://arxiv.org/abs/2605.29132) <a id="link52"></a>
...
**Comment:** No direct match to any core criteria. Focuses on WIMP freeze-out and nonextensive statistics in cosmology, not on galaxy evolution, dwarf galaxies, or stellar models.
...
## 53. [Signals from the early Universe: a comprehensive search for primordial features in Planck CMB datasets](https://arxiv.org/abs/2605.30236) <a id="link53"></a>
...
**Comment:** No direct match to any core criteria. Focuses on primordial features in the CMB, not on galaxy evolution, star formation, or stellar models.
...
## 54. [The MeerKAT Thousand-Pulsar Polarization Array I: Properties of the Polarization and Rotation Measure Time Series Data](https://arxiv.org/abs/2605.29106) <a id="link54"></a>
...
**Comment:** Polarization and rotation measure time series for pulsars, with a focus on axion-like dark matter. No direct relevance to galaxy-scale topics, near-field cosmology, or resolved star formation histories.
...
## 55. [Assessing the Relative Importance of Neutrino Matter Interaction Channels in Post-Merger Remnant of Binary Neutron Stars](https://arxiv.org/abs/2605.29187) <a id="link55"></a>
...
**Comment:** Assesses neutrino-matter interaction channels in the post-merger remnant of binary neutron stars, with implications for kilonova emission and nucleosynthesis. The focus is on neutron star mergers and neutrino physics, not on galaxies, star formation, or any relevant criteria.
...
## 56. [Quantum transitions of vector vortex light in gravitational waves](https://arxiv.org/abs/2605.29519) <a id="link56"></a>
...
**Comment:** Theoretical framework for quantum transitions of vector vortex light in gravitational waves. No connection to galaxy simulations, star formation, or near-field cosmology.
...
## 57. [A Minimal Dark $SU(2)$ Origin of a Massless Dirac Neutrino](https://arxiv.org/abs/2605.28923) <a id="link57"></a>
...
**Comment:** Paper proposes a dark SU(2) gauge symmetry origin for a massless Dirac neutrino and discusses dark sector completion. No direct relevance to galaxy-scale topics, near-field cosmology, or stellar models.
...
## 58. [DELOS: Detecting Shallow Transits in Kepler Photometry Using a Contrastive-Learning Framework](https://arxiv.org/abs/2605.29428) <a id="link58"></a>
...
**Comment:** This paper presents a new method for detecting shallow transits in Kepler photometry. While it is an advance in exoplanet detection, it does not match any of the core criteria (galaxy simulations, star formation histories, dwarf galaxies, etc.).
...
## 59. [Delayed Radio Flares in Tidal Disruption Events from Star-Disk Collision Outflows](https://arxiv.org/abs/2605.28928) <a id="link59"></a>
...
**Comment:** The paper discusses delayed radio flares in tidal disruption events (TDEs) and proposes a new mechanism involving star-disk collision outflows. The focus is on TDEs and black hole accretion, which is explicitly listed as irrelevant in the criteria. No direct connection to galaxy-scale outflows or other core topics.
...
## 60. [Dust grain chemistry in the diffuse ISM towards the black hole transient GX 339-4](https://arxiv.org/abs/2605.28947) <a id="link60"></a>
...
**Comment:** Analyzes dust grain chemistry in the diffuse ISM toward a black hole transient. Focus is on ISM and dust, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 61. [Compact near infrared sources in the center of the extraordinary galaxy IC 860](https://arxiv.org/abs/2605.29149) <a id="link61"></a>
...
**Comment:** Focuses on the central regions of the luminous infrared galaxy IC 860, examining compact sources and their evolution. The galaxy is not a dwarf or a satellite, and the work is not directly related to any of the core criteria (near-field cosmology, resolved SFH, quenching, etc.).
...
## 62. [Effective chemical potential and its phenomenological implications for the Hubble parameter](https://arxiv.org/abs/2605.28881) <a id="link62"></a>
...
**Comment:** No direct match to any core criteria. Discusses cosmological models and Hubble parameter tension, not galaxy evolution, star formation, or stellar models.
...
## 63. [The energy conditions and model selection in the local Universe](https://arxiv.org/abs/2605.28903) <a id="link63"></a>

**ArXiv ID:** 2605.28903

**Authors:** Namit Chandak, Fulvio Melia, Junjie Wei

**Abstract:** The four principal energy conditions (ECs) in general relativity prohibit negative energies, repulsive gravity and superluminal energy flows. One must invoke exotic matter to violate any one of these, yet $\Lambda$CDM does so quite prominently during inflation and in the epoch of dark energy dominance. In this paper, we carry out model selection between the standard model and the $R_{\rm h}=ct$ universe using a combination of HII galaxy and cosmic chronometer measurements in the local Universe, and directly compare the results to the constraints imposed by the ECs. We find that the latter cosmology is not only strongly favored by these data, with a likelihood of $\sim 92\%$ versus only $\sim 8\%$ for the former, but that its optimized fit is fully compliant with all four ECs, while $\Lambda$CDM's best fit violates the so-called strong energy condition at $z\lesssim 2$.

**Comment:** This paper discusses model selection in cosmology using HII galaxy and cosmic chronometer measurements in the local Universe. While it is cosmological, it does not focus on near-field cosmology topics such as satellite galaxies, resolved star formation histories, or dwarf galaxy properties. No direct match to any core criteria.
...
## 64. [Physics Is All You Need? A Case Study in Physicist-Supervised AI Development of Scientific Software](https://arxiv.org/abs/2605.30353) <a id="link64"></a>
...
**Comment:** This paper is a case study on physicist-supervised AI development for scientific software, specifically a module for perturbation theory in cosmology. It does not address any of the core astrophysical criteria such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is very low.
...
## 65. [First head-to-head comparison of agentic AI applied to the analysis of simulated data of the Einstein Telescope](https://arxiv.org/abs/2605.28916) <a id="link65"></a>
...
**Comment:** Compares agentic AI systems for gravitational wave data analysis from the Einstein Telescope. The focus is on AI methods and gravitational wave data, not on galaxies, star formation, or any relevant criteria.
...
## 66. [Optical transmission spectrum of HAT-P-47b: evidence for aerosols and tentative TiO absorption](https://arxiv.org/abs/2605.29445) <a id="link66"></a>
...
**Comment:** Transmission spectroscopy of the hot Jupiter HAT-P-47b, investigating atmospheric properties and evidence for aerosols and TiO. The focus is on exoplanet atmospheres, not on galaxies, star formation, or any relevant criteria.
...
## 67. [Characterization of Spurious Charge in SENSEI Skipper-CCDs](https://arxiv.org/abs/2605.30281) <a id="link67"></a>
...
**Comment:** Characterizes spurious charge in Skipper-CCDs for rare-event searches (dark matter, neutrino-nucleus scattering). The work is focused on detector technology and backgrounds, not on galaxy science or any of the core criteria.
...
## 68. [Assessing Ariel's capabilities to observe free-floating brown dwarfs](https://arxiv.org/abs/2605.28924) <a id="link68"></a>
...
**Comment:** Paper is about brown dwarfs and their atmospheric variability, not about galaxies, star formation histories, or near-field cosmology. No criteria match.
...
## 69. [Towards a Foundation Model for the Martian Atmosphere](https://arxiv.org/abs/2605.28851) <a id="link69"></a>
...
**Comment:** Paper discusses foundation models for the Martian atmosphere, focusing on AI and atmospheric physics. No relevance to galaxy-scale topics, near-field cosmology, or stellar models.
...
## 70. [The Northern Cross Fast Radio Burst project: VI. The INCART public database](https://arxiv.org/abs/2605.30192) <a id="link70"></a>
...
**Comment:** This paper presents a public database for FRB observations. FRBs are not related to any of the core criteria (near-field cosmology, resolved star formation histories, dwarf galaxies, etc.).
...
## 71. [When the Ringing Stops: Purely Imaginary Modes in the Ringdown Spectrum of Dynamical Black Holes](https://arxiv.org/abs/2605.28951) <a id="link71"></a>
...
**Comment:** The paper studies quasinormal modes in dynamical black holes, which is not related to any of the core criteria (galaxy simulations, star formation histories, dwarf galaxies, etc.).
...
## 72. [Enhanced All-Distance Equi-Zenith Angle Method for Cosmic-Ray Anisotropy Measurement](https://arxiv.org/abs/2605.29644) <a id="link72"></a>
...
**Comment:** This paper presents an improved method for measuring cosmic-ray anisotropy. Cosmic rays and their anisotropy are not related to the core criteria (galaxy simulations, star formation histories, dwarf galaxies, etc.).
...
## 73. [Time-Domain Deep Learning for Pairwise Identification of Strongly Lensed Gravitational-Wave Candidates](https://arxiv.org/abs/2605.29510) <a id="link73"></a>
...
**Comment:** This paper presents a deep learning method for identifying strongly lensed gravitational-wave candidates. It is focused on gravitational wave data analysis and does not address any of the core astrophysical criteria such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The relevance is very low.
...
## 74. [A new completely parameter-free clustering algorithm for unsupervised classification of BATSE gamma-ray bursts](https://arxiv.org/abs/2605.30175) <a id="link74"></a>
...
**Comment:** The paper presents a new clustering algorithm for classifying gamma-ray bursts (GRBs) using BATSE data. The focus is on machine learning and GRB classification, which does not match any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 75. [An Obscured Tidal Disruption Event Uncovered by Its Mid- and Near-Infrared Dust Echo in a Star-Forming Galaxy](https://arxiv.org/abs/2605.29616) <a id="link75"></a>
...
**Comment:** Studies an obscured tidal disruption event (TDE) in a star-forming galaxy. TDEs are explicitly listed as irrelevant in the criteria.
...
## 76. [Visible inelasticity as a probe of tau flavor content of astrophysical neutrinos](https://arxiv.org/abs/2605.29105) <a id="link76"></a>
...
**Comment:** Investigates tau flavor content of astrophysical neutrinos using visible inelasticity in neutrino telescopes. The focus is on neutrino physics and not on galaxies, star formation, or near-field cosmology.
...
## 77. [Long-Duration GRB 211211A: Internal Energy Dissipation Driven by a Long-Lived Magnetar](https://arxiv.org/abs/2605.30025) <a id="link77"></a>
...
**Comment:** Analyzes GRB 211211A and its connection to a long-lived magnetar, focusing on gamma-ray and X-ray observations and accretion models. The topic is not related to galaxy science, near-field cosmology, or any of the core criteria.
...
## 78. [Modeling the Effect of the Heliospheric Magnetic Field on Cosmic Ray Muon Shadows](https://arxiv.org/abs/2605.29306) <a id="link78"></a>
...
**Comment:** Models the effect of the heliospheric magnetic field on cosmic ray muon shadows using MINOS data. The focus is on cosmic rays and magnetic fields, not on galaxies or any of the core criteria.
...
## 80. [Spin-Orbit Geometry of AU Mic b and c from Back-to-Back Transits Observed Contemporaneously with Magellan PFS, LCOGT, and CHEOPS](https://arxiv.org/abs/2605.29946) <a id="link80"></a>
...
**Comment:** No direct match to any core criteria. Focuses on spin-orbit geometry of exoplanets around AU Mic, not on galaxy evolution, star formation, or stellar models.
...
## 81. [JWST's Dusty Blue BOAT -- GRB 221009A](https://arxiv.org/abs/2605.29022) <a id="link81"></a>
...
**Comment:** This paper analyzes the afterglow of GRB 221009A, focusing on extinction and spectral modeling. GRBs and their afterglows are not related to the core criteria (dwarf galaxies, star formation histories, etc.).
...
## 82. [Sub-surface structural changes associated with successive 11-yr solar activity cycles have been progressively more confined near the surface: new helioseismic results on Cycles 22 -- 25 from BiSON](https://arxiv.org/abs/2605.29528) <a id="link82"></a>
...
**Comment:** Helioseismology study of solar cycles and sub-surface structural changes. This is unrelated to the core topics (galaxy evolution, dwarf galaxies, star formation histories, etc.).
...
## 83. [A Note on QPE Timing: False Alarms in O-C](https://arxiv.org/abs/2605.29382) <a id="link83"></a>
...
**Comment:** Discusses O-C timing analysis for quasi-periodic eruptions (QPEs) in specific galaxies, focusing on timing diagnostics and EMRI+disk models. The topic is unrelated to the core criteria (no connection to near-field cosmology, resolved SFH, quenching, etc.).
