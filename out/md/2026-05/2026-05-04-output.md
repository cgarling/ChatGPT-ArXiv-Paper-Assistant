...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 25716    | 3595         | 29311   |
| **Cost**             | $0.05    | $0.03        | $0.08   |

Total arXiv papers: 90

Total scanned papers: 49

Total relevant papers: 43

**Table of contents with paper titles:**

1. [A Universal Dance of Galactic Disks: Ubiquitous Precession and Its Implications](#user-content-link1)
**Authors:** Yuan Wang, Xiong Luo, Huiyuan Wang, Enci Wang, Hao Li, Federico Marinacci, Xuejian Shen, Mark Vogelsberger

2. [Ultra-deep imaging of nearby dwarf irregular galaxies: stellar haloes and disk structure](#user-content-link2)
**Authors:** Deidre A. Hunter, Bruce G. Elmegreen

3. [Optimization of Weak Lensing Lightcone Simulations for Higher-Order Statistics in the LSST era](#user-content-link3)
**Authors:** J. Mena-Fern\'andez, C. Doux, J. Harnois-D\'eraps, K. Heitmann, C. Combet, P. Larsen, N. Frontiere, A. Bera, S. Samario-Nava, L. Castiblanco, C. Uhlemann, the LSST Dark Energy Science Collaboration

4. [Exploring RR Lyrae Variable Stars in the Vera C. Rubin Observatory Data Preview 1](#user-content-link4)
**Authors:** Chow-Choong Ngeow, Anupam Bhardwaj

5. [$4\times3$ Point Correlation Functions in Galaxy Surveys: Impact of Baryonic Feedback](#user-content-link5)
**Authors:** Avijit Bera, Joachim Harnois-D\'eraps, Juan Mena-Fern\'andez, Mike Jarvis, Cyrille Doux, Katrin Heitmann, Mustapha Ishak, The LSST Dark Energy Science Collaboration

6. [Pre-inflationary QCD axion stars after moduli domination](#user-content-link6)
**Authors:** Edward Hardy, Noelia S\'anchez Gonz\'alez, Henry Stubbs, Lorenzo Tranchedone

7. [The NIKA2 Cosmological Legacy Survey in COSMOS: Final 1.2mm and 2mm source catalogs and redshift distribution of dusty star-forming galaxies](#user-content-link7)
**Authors:** C. R. Carvajal-Bohorquez, G. Lagache, A. Beelen, R. Adam, P. Ade, H. Ajeddig, S. Amarantidis, P. Andr\'e, M. Aravena, H. Aussel, A. Beno\^it, S. Berta, M. B\'ethermin, L. -J. Bing, A. Bongiovanni, J. Bounmy, O. Bourrion, M. Calvo, Caitlin M. Casey, A. Catalano, D. Ch\'erouvrier, U. Chowdhury, M. De Petris, F. -X. D\'esert, S. Doyle, E. F. C. Driessen, G. Ejlali, A. L. Faisst, A. Ferragamo, A. Gomez, J. Goupy, C. Hanser, Shuowen Jin, Jeyhan S. Kartaltepe, S. Katsioli, F. K\'eruzor\'e, C. Kramer, B. Ladjelat, S. Leclercq, J. -F. Lestrade, J. F. Mac\'ias-P\'erez, S. C. Madden, Felix Martinez III, A. Maury, F. Mayet, A. Monfardini, A. Moyer-Anin, M. Mu\~noz-Echeverr\'ia, I. Myserlis, R. Neri, A. Paliwal, L. Perotto, G. Pisano, N. Ponthieu, V. Rev\'eret, A. J. Rigby, A. Ritacco, H. Roussel, F. Ruppin, M. S\'anchez-Portal, S. Savorgnano, K. Schuster, A. Sievers, S. Toft, C. Tucker, Jorge A. Zavala, R. Zylka

8. [Towards a measurement of the primordial helium isotope ratio](#user-content-link8)
**Authors:** Ryan J. Cooke (Centre for Extragalactic Astronomy, Durham University), James W. Johnson (Carnegie Observatories), Pasquier Noterdaeme (Institut d'Astrophysique de Paris), Max Pettini (Institute of Astronomy, University of Cambridge), Louise Welsh (Centre for Extragalactic Astronomy, Durham University), Aldric Wong (Centre for Extragalactic Astronomy, Durham University), Celine Peroux (European Southern Observatory, Laboratoire d'Astrophysique de Marseille)

9. [Deep Learning galaxy cluster's structural parameters from Weak Lensing observations](#user-content-link9)
**Authors:** M. Fogliardi, M. Meneghetti, C. Giocoli, L. Moscardini, P. Rosati, L. Leuzzi, G. Angora, L. Bazzanini, C. Spinelli

10. [XMAGNET -- Stir before serving: a Lagrangian perspective on mixing-driven condensation in the intracluster medium](#user-content-link10)
**Authors:** M. Fournier, P. Grete, M. Br\"uggen, B. W. O'Shea, G. M. Voit, B. D. Wibking, D. Prasad

11. [Measuring $f\sigma_8$ and BAO scale in the Local Universe: a joint real and redshift space analysis from CosmicFlows-4++](#user-content-link11)
**Authors:** C. Franco, H. M. Courtois, A. Bernui

12. [A Global 7% Systemic Sensitivity Floor in Gaia DR3: Multi-Wavelength Validation using 2MASS, Pan-STARRS and the 0.75-Magnitude Offset](#user-content-link12)
**Authors:** Andrew Soon

13. [PEARLS: Two Distinct Populations of AGN Hosts Moving Between Star Formation and Quiescence](#user-content-link13)
...
14. [A New Robust Constraint on the Self-interaction Cross-section of Dark Matter with Double Radio Relic Clusters](#user-content-link14)
**Authors:** M. James Jee, Dongak Park, Wonki Lee

15. [The LISA Astrophysics MBHcatalogues Project: A comparison of predictions of simulated massive black hole binaries](#user-content-link15)
...
16. [Maximal mass of neutron stars constrained by neutron star observations](#user-content-link16)
**Authors:** G\'abor Kasza, Gy\"orgy Wolf

17. [Life After the Quasar: Overmassive Black Holes and Remnant Ionised Bubbles in and Around Two z~6.6 Galaxies](#user-content-link17)
...
18. [Correspondence between a decaying dark matter sector scenario and scalar field model](#user-content-link18)
**Authors:** Gilberto Aguilar-P\'erez, Deryan Alvarado, Miguel Cruz, Estefany Ru\'iz-Ramos, Joel Saavedra

19. [Anisotropy of Cosmic Background Photons from Annihilating/Decaying Dark Matter](#user-content-link19)
**Authors:** Ryosuke Kasuya, Kazunori Nakayama

20. [High-resolution ro-vibrational and rotational spectroscopy of the open-shell, linear CCH$^+$ ion ($^3\Pi$)](#user-content-link20)
**Authors:** Kim Steenbakkers, Weslley G. D. P. Silva, Oskar Asvany, Gerrit C. Groenenboom, Pavol Jusko, Britta Redlich, Sandra Br\"unken, Stephan Schlemmer

21. [Training a neural network to rapidly identify candidate gravitational-wave events in the lower mass gap](#user-content-link21)
**Authors:** Nayyer Raza, Man Leong Chan, Daryl Haggard, Ashish Mahabal, Jess McIver, Audrey Durand, Alexandre Larouche, Hadi Moazen

22. [Random Polarization Position Angle Behaviors across Bursts of Repeating Fast Radio Bursts](#user-content-link22)
**Authors:** Xiaohui Liu, Jiarui Niu, Tiancong Wang, Jun-Shuo Zhang, Yuanhong Qu, Jinchen Jiang, Yongkun Zhang, Heng Xu, Dejiang Zhou, Wei-Yang Wang, Weiwei Zhu, Bing Zhang, Xuelei Chen, Xiang-Han Cui, Jinlin Han, Kejia Lee, Di Li, Jiawei Luo, Rui Luo, Chengwei Liang, Chenhui Niu, Wan-Peng Sun, Bojun Wang, Fayin Wang, Pei Wang, Qin Wu, Ziwei Wu, Jiangwei Xu, Yuan-Pei Yang, Shiqian Zhao

23. [ExoplaNeT accRetion mOnitoring sPectroscopic surveY (ENTROPY) III. Optical He I line profiles of the accreting super Jupiter Delorme 1 (AB)b](#user-content-link23)
**Authors:** Gayathri Viswanath, Micka\"el Bonnefoy, Catherine Dougados, Simon C. Ringqvist, Markus Janson, Dorian Demars, Aurora Sicilia-Aguilar, J\'er\^ome Bouvier, Gabriel-Dominique Marleau, Evelyne Alecian, Ga\"el Chauvin

24. [A consistent formulation of stochastic inflation I: Non-Markovian effects and issues beyond linear perturbations](#user-content-link24)
**Authors:** Diego Cruces, Tomotaka Kuroda

25. [Gravitational particle production, the cosmological tensions and fast radio bursts](#user-content-link25)
**Authors:** Recai Erdem

26. [Radial Dependency of ICME-associated Particle Acceleration Processes: Statistical Multipoint Observations from 2016-2023](#user-content-link26)
**Authors:** Malik H. Walker, Robert C. Allen, George C. Ho, Glenn M. Mason, Christina M. S. Cohen, Christina Lee, Christian M\"ostl, Emma E. Davies, Eva Weiler

27. [Radiation Total Dose for PRIMA: Cold Exposure with Alpha Particles](#user-content-link27)
**Authors:** Elijah Kane (Matt), Chris Albert (Matt), Andrew Beyer (Matt), Charles (Matt), Bradford (Rick), Pierre Echternach (Rick), Logan Foote (Rick), Jason Glenn (Rick), Henry (Rick), LeDuc, Hien Nguyen, Thomas Stevenson, Brian Zhu, Jonas Zmuidzinas

28. [A Detailed View of the Large-Scale Sloshing Cold Front in RXJ2014.8-2430](#user-content-link28)
**Authors:** M. J. Sundquist, S. A. Walker, M. S. Mirakhor

29. [Red Quasars: Selecting Candidates in SDSS DR16 and Estimating Their Physical Parameters](#user-content-link29)
**Authors:** M. Yu. Piotrovich, S. D. Buliga, T. M. Natsvlishvili

30. [Extinction law and stellar mass in the Nuclear Bulge from kinematically-selected red clump stars](#user-content-link30)
**Authors:** \'A. Valenzuela Navarro, M. Zoccali, E. Valenti, R. Contreras Ramos, A. Rojas-Arriagada, A. Luna, R. Albarrac\'in, C. Gallart, J. Olivares Carvajal, F. Gran, C. Salvo-Guajardo, G. Nandakumar, A. Renzini

31. [Beyond Bragg-Mirrors for Gravitational Wave Telescopes: A Fabrication Tolerant Hybrid Metasurface-Bragg Mirror Design](#user-content-link31)
**Authors:** Christian Kranhold, Mika Gaedtke, Markus Walther, Falk Eilenberger, Stefanie Kroker, Thomas Siefke

32. [The Rocky Planet Picture Show: Implementation of Surface Reflection and Emission in $\texttt{POSEIDON}$ with Application to and Interpretation of JWST Data](#user-content-link32)
**Authors:** Elijah Mullens, Ryan J. MacDonald, Marina E. Gemma, Ishan Mishra, Esteban Gazel, Nikole K. Lewis

33. [EMBER: Machine-Learning Detection of Modulated Ion Acoustic Waves and Associated Core-Electron Heating in the Solar Wind with Parker Solar Probe](#user-content-link33)
**Authors:** Argyro Sasli, Karish Seebaluck, Chris Colpitts, Michael Coughlin

34. [DESI and Gravitational Wave Constraints Challenge Quintessential {\alpha}-Attractor Inflation](#user-content-link34)
**Authors:** Changcheng Jing, George Alestas, Sachiko Kuroyanagi

35. [Kinematic properties of the TW Hya association](#user-content-link35)
**Authors:** Vadim V. Bobylev

36. [Self-consistent numerical simulations for the formation and dynamics of solar prominences](#user-content-link36)
**Authors:** Lisa-Marie Zessner, Robert H. Cameron, Sami K. Solanki, Damien Przybylski

37. [Merger remnant and eccentricity dynamics surrogates for eccentric nonspinning black hole binaries](#user-content-link37)
**Authors:** Adhrit Ravichandran, Peter James Nee, Keefe Mitman, Tousif Islam, Scott E. Field, Vijay Varma, Michael Boyle, Andrea Ceja, Nils Deppe, Noora Ghadiri, Lawrence E. Kidder, Prayush Kumar, Marlo Morales, Jordan Moxon, Kyle C. Nelli, Harald P. Pfeiffer, Antoni Ramos-Buades, Katie Rink, Hannes R. R\"uter, Mark A Scheel, Md Arif Shaikh, Leo C. Stein, Daniel Tellez, William Throwe, Nils L. Vu

38. [Multi-messenger Constraints on a Primordial Black Hole Origin of the KM3-230213A Event](#user-content-link38)
**Authors:** Yuber F. Perez-Gonzalez

39. [Quantum Noise Fraction and the Thermal Frontier in High-Frequency Gravitational Wave Detection](#user-content-link39)
**Authors:** Sergio Gaudio

40. [A bright wideband radio burst from the isolated neutron star 2XMM J104608.7$-$594306](#user-content-link40)
**Authors:** J. Tian, K. M. Rajwade, I. Pastor-Marazuela, B. W. Stappers, M. Caleb, K. Shaji, S. Singh, E. D. Barr, M. Kramer

41. [Upstream neutrino production and delayed jet emission in the blazar GB6 J1542+6129](#user-content-link41)
**Authors:** Emma Kun, Imre Bartos, Breshna Hadi, Anna G\"obly\"os, Julia Becker Tjus, Peter L. Biermann, Anna Franckowiak, Francis Halzen, Santiago del Palacio, Claudio Ricci

42. [Study of cosmic ray impacts on cryogenic high sensitivity detectors](#user-content-link42)
**Authors:** Ana\"is Besnard, Valentin Sauvage, Bruno Maffei

43. [Magnetic loops in the solar transition region](#user-content-link43)
**Authors:** Zhenghua Huang

---

## 1. [A Universal Dance of Galactic Disks: Ubiquitous Precession and Its Implications](https://arxiv.org/abs/2605.00349) <a id="link1"></a>
...
**Comment:** This paper uses cosmological simulations (IllustrisTNG) to study disk precession in Milky Way-like galaxies and its effects on satellite galaxy alignment and cold gas warps. It directly matches the 'Numerical Galaxy Simulations' criterion and touches on near-field cosmology via satellite galaxy dynamics and disk warps. The connection to satellite galaxy alignment and disk warps makes it highly relevant.
...
## 2. [Ultra-deep imaging of nearby dwarf irregular galaxies: stellar haloes and disk structure](https://arxiv.org/abs/2605.00262) <a id="link2"></a>
...
**Comment:** This paper presents ultra-deep imaging of nearby dwarf irregular galaxies, examining their stellar structure and possible stellar halos. It directly matches the near-field cosmology criterion (focus on dwarf galaxies) and also touches on resolved star formation histories (UBVI colors and ages). Highly relevant.
...
## 3. [Optimization of Weak Lensing Lightcone Simulations for Higher-Order Statistics in the LSST era](https://arxiv.org/abs/2605.00821) <a id="link3"></a>
...
**Comment:** This paper presents a framework for optimizing weak lensing lightcone simulations for higher-order statistics in the LSST era. It is directly relevant to the 'Numerical Galaxy Simulations' criterion, especially as it discusses high-resolution simulations and their optimization for cosmological surveys.
...
## 4. [Exploring RR Lyrae Variable Stars in the Vera C. Rubin Observatory Data Preview 1](https://arxiv.org/abs/2605.00344) <a id="link4"></a>
...
**Comment:** This paper explores RR Lyrae variable stars in Rubin Observatory data, comparing observations to stellar pulsation models. The focus on stellar models (evolutionary tracks and period-luminosity-metallicity relations) matches the 'Stellar Models' criterion, especially as it discusses theoretical models and their calibration.
...
## 5. [$4\times3$ Point Correlation Functions in Galaxy Surveys: Impact of Baryonic Feedback](https://arxiv.org/abs/2605.00818) <a id="link5"></a>
...
**Comment:** This paper investigates baryonic feedback effects on galaxy correlation functions using high-resolution simulations. It matches the numerical galaxy simulations criterion, especially as it includes baryonic physics and analyzes galaxy-scale effects. Relevant, but not directly focused on dwarf galaxies or resolved star formation histories.
...
## 6. [Pre-inflationary QCD axion stars after moduli domination](https://arxiv.org/abs/2605.00103) <a id="link6"></a>
...
**Comment:** The paper discusses axion stars and their formation in the early universe, which is tangentially related to near-field cosmology via dark matter substructure, but does not focus on satellite galaxies, resolved star formation histories, or galaxy simulations. Borderline relevance due to indirect connection to dark matter structure.
...
## 7. [The NIKA2 Cosmological Legacy Survey in COSMOS: Final 1.2mm and 2mm source catalogs and redshift distribution of dusty star-forming galaxies](https://arxiv.org/abs/2605.00659) <a id="link7"></a>
...
**Comment:** This paper presents mm-wavelength source catalogs and redshift distributions for dusty star-forming galaxies in the COSMOS field. It focuses on high-redshift galaxy evolution and star formation, but does not address resolved star formation histories, dwarf galaxies, or galaxy simulations directly. The relevance is borderline due to the connection to star formation, but not in resolved or dwarf contexts.
...
## 8. [Towards a measurement of the primordial helium isotope ratio](https://arxiv.org/abs/2605.00122) <a id="link8"></a>
...
**Comment:** This paper reports measurements of the primordial helium isotope ratio and discusses galactic chemical evolution models. While it involves stellar yields and nucleosynthesis, the focus is on primordial abundances and chemical evolution, not on stellar models or galaxy simulations as defined in the prompt. The relevance is borderline due to the discussion of stellar yields.
...
## 10. [XMAGNET -- Stir before serving: a Lagrangian perspective on mixing-driven condensation in the intracluster medium](https://arxiv.org/abs/2605.00563) <a id="link10"></a>
...
**Comment:** Presents MHD simulations of cool-core clusters, focusing on mixing-driven condensation and the role of magnetic fields. While it involves numerical galaxy simulations, the focus is on intracluster medium and cluster-scale processes, not galaxies or dwarfs. Borderline relevance for simulation methodology.
...
## 11. [Measuring $f\sigma_8$ and BAO scale in the Local Universe: a joint real and redshift space analysis from CosmicFlows-4++](https://arxiv.org/abs/2605.00450) <a id="link11"></a>
...
**Comment:** The paper analyzes BAO and growth rate in the Local Universe using galaxy clustering. While it deals with large-scale structure and local universe, it does not focus on satellite galaxies, resolved star formation histories, or galaxy simulations. The relevance is borderline due to the local universe focus.
...
## 12. [A Global 7% Systemic Sensitivity Floor in Gaia DR3: Multi-Wavelength Validation using 2MASS, Pan-STARRS and the 0.75-Magnitude Offset](https://arxiv.org/abs/2605.00792) <a id="link12"></a>
...
**Comment:** This paper examines Gaia's sensitivity to binaries and the implications for stellar mass density models. While it deals with stellar populations and mass budget, it does not directly address resolved star formation histories, stellar models, or near-field cosmology. The relevance is borderline due to the connection to stellar population modeling.
...
## 13. [PEARLS: Two Distinct Populations of AGN Hosts Moving Between Star Formation and Quiescence](https://arxiv.org/abs/2605.00822) <a id="link13"></a>
...
**Comment:** This paper discusses AGN host galaxies and their transitions between star formation and quiescence, with some focus on star formation quenching. However, the work is primarily on AGN hosts, which are typically more massive galaxies, not dwarfs. The relevance is borderline due to the discussion of quenching and transitions.
...
## 14. [A New Robust Constraint on the Self-interaction Cross-section of Dark Matter with Double Radio Relic Clusters](https://arxiv.org/abs/2605.00093) <a id="link14"></a>
...
**Comment:** This paper constrains the self-interaction cross-section of dark matter using merging galaxy clusters. While it deals with dark matter, it focuses on cluster-scale phenomena rather than galaxy or dwarf galaxy substructure, satellite galaxies, or near-field cosmology. Only weakly relevant.
...
## 15. [The LISA Astrophysics MBHcatalogues Project: A comparison of predictions of simulated massive black hole binaries](https://arxiv.org/abs/2605.00092) <a id="link15"></a>
...
**Comment:** Compares predictions of massive black hole binary merger rates from galaxy simulations. While it involves numerical galaxy simulations, the focus is on MBH mergers and LISA event rates, not on galaxy-scale processes or dwarf galaxies. Some relevance for simulation methodology.
...
## 16. [Maximal mass of neutron stars constrained by neutron star observations](https://arxiv.org/abs/2605.00437) <a id="link16"></a>
...
**Comment:** The paper constrains the maximal mass of neutron stars using multimessenger observations and Bayesian analysis. While it touches on compact object populations, it does not address satellite galaxies, star formation histories, galaxy simulations, or quenching.
...
## 17. [Life After the Quasar: Overmassive Black Holes and Remnant Ionised Bubbles in and Around Two z~6.6 Galaxies](https://arxiv.org/abs/2605.00763) <a id="link17"></a>
...
**Comment:** This paper focuses on supermassive black holes and AGN feedback in high-redshift galaxies, discussing their impact on stellar mass assembly and ionized bubbles. While it touches on star formation quenching and feedback, the context is massive galaxies and AGN-driven processes, not dwarf galaxies or star-formation-driven outflows. No direct match to near-field cosmology, resolved star formation histories, or the other core topics.
...
## 18. [Correspondence between a decaying dark matter sector scenario and scalar field model](https://arxiv.org/abs/2605.00208) <a id="link18"></a>
...
**Comment:** The paper discusses theoretical modeling of a decaying dark matter sector and its correspondence to scalar field models. While it is cosmological, it does not address near-field cosmology, galaxy simulations, or any of the other core criteria.
...
## 19. [Anisotropy of Cosmic Background Photons from Annihilating/Decaying Dark Matter](https://arxiv.org/abs/2605.00648) <a id="link19"></a>
...
**Comment:** This paper discusses the angular power spectrum of cosmic background photons from dark matter decay/annihilation. While it is related to cosmology and dark matter, it does not focus on near-field cosmology, satellite galaxies, or any of the other core topics. The work is more about large-scale background and detector effects.
...
## 21. [Training a neural network to rapidly identify candidate gravitational-wave events in the lower mass gap](https://arxiv.org/abs/2605.00391) <a id="link21"></a>
...
**Comment:** This paper presents a neural network for identifying gravitational-wave events in the lower mass gap between neutron stars and black holes. It is not related to any of the core criteria (no connection to dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 22. [Random Polarization Position Angle Behaviors across Bursts of Repeating Fast Radio Bursts](https://arxiv.org/abs/2605.00372) <a id="link22"></a>
...
**Comment:** The paper studies polarization position angle behaviors in repeating fast radio bursts (FRBs). It is not related to any of the core criteria (no connection to galaxy evolution, star formation, or simulations).
...
## 23. [ExoplaNeT accRetion mOnitoring sPectroscopic surveY (ENTROPY) III. Optical He I line profiles of the accreting super Jupiter Delorme 1 (AB)b](https://arxiv.org/abs/2605.00289) <a id="link23"></a>
...
**Comment:** The paper investigates accretion processes in a planetary-mass companion, using high-resolution spectroscopy to probe accretion geometry. While it discusses star formation and accretion, it is focused on planet formation and accretion onto a protoplanet, not galaxies or dwarf galaxies. No direct match to any of the core criteria.
...
## 24. [A consistent formulation of stochastic inflation I: Non-Markovian effects and issues beyond linear perturbations](https://arxiv.org/abs/2605.00476) <a id="link24"></a>
...
**Comment:** This paper presents a theoretical study of stochastic inflation and non-Markovian effects in cosmological perturbation theory. It is focused on early universe inflation and perturbations, not galaxies, star formation histories, or feedback processes. No direct match to any of the core criteria.
...
## 25. [Gravitational particle production, the cosmological tensions and fast radio bursts](https://arxiv.org/abs/2508.19770) <a id="link25"></a>
...
**Comment:** This paper addresses cosmological tensions (Hubble and sigma_8) and fast radio bursts, but does not focus on any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations. No relevant criteria matched.
...
## 27. [Radiation Total Dose for PRIMA: Cold Exposure with Alpha Particles](https://arxiv.org/abs/2605.00153) <a id="link27"></a>
...
**Comment:** This paper discusses radiation damage to kinetic inductance detectors for the PRIMA far-infrared mission. It is focused on instrumentation and detector physics, not on any of the core criteria (galaxy evolution, star formation histories, simulations, etc.).
...
## 28. [A Detailed View of the Large-Scale Sloshing Cold Front in RXJ2014.8-2430](https://arxiv.org/abs/2605.00178) <a id="link28"></a>
...
**Comment:** The paper analyzes cold fronts in a galaxy cluster, focusing on cluster-scale gas dynamics. It does not relate to dwarf galaxies, satellite galaxies, star formation histories, or galaxy simulations. The focus is on cluster physics.
...
## 29. [Red Quasars: Selecting Candidates in SDSS DR16 and Estimating Their Physical Parameters](https://arxiv.org/abs/2605.00608) <a id="link29"></a>
...
**Comment:** Focuses on red quasars and SMBH properties, which are not related to any of the core topics (dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, CGM).
...
## 30. [Extinction law and stellar mass in the Nuclear Bulge from kinematically-selected red clump stars](https://arxiv.org/abs/2605.00223) <a id="link30"></a>
...
**Comment:** Focuses on extinction law and stellar mass in the Nuclear Bulge of the Milky Way. The Nuclear Bulge is not a dwarf galaxy or satellite, and the work does not address resolved star formation histories or quenching. Irrelevant to core topics.
...
## 31. [Beyond Bragg-Mirrors for Gravitational Wave Telescopes: A Fabrication Tolerant Hybrid Metasurface-Bragg Mirror Design](https://arxiv.org/abs/2605.00714) <a id="link31"></a>
...
**Comment:** This paper presents a hybrid mirror design for gravitational wave detectors. It is unrelated to any of the core topics such as galaxy simulations, star formation, or near-field cosmology.
...
## 32. [The Rocky Planet Picture Show: Implementation of Surface Reflection and Emission in $\texttt{POSEIDON}$ with Application to and Interpretation of JWST Data](https://arxiv.org/abs/2605.00700) <a id="link32"></a>
...
**Comment:** The paper implements surface reflection and emission models for rocky exoplanets in POSEIDON, focusing on exoplanet atmosphere and geology. This is not relevant to any of the core topics (no connection to galaxy simulations, star formation, or stellar models as defined).
...
## 33. [EMBER: Machine-Learning Detection of Modulated Ion Acoustic Waves and Associated Core-Electron Heating in the Solar Wind with Parker Solar Probe](https://arxiv.org/abs/2605.00162) <a id="link33"></a>
...
**Comment:** Study of solar wind electron heating via ion acoustic waves; does not relate to galaxy-scale processes, star formation, or any of the core topics.
...
## 34. [DESI and Gravitational Wave Constraints Challenge Quintessential {\alpha}-Attractor Inflation](https://arxiv.org/abs/2605.00735) <a id="link34"></a>
...
**Comment:** Studies quintessential inflation models and gravitational wave constraints; not related to galaxy-scale astrophysics, star formation, or any of the core topics.
...
## 35. [Kinematic properties of the TW Hya association](https://arxiv.org/abs/2605.00687) <a id="link35"></a>
...
**Comment:** The paper analyzes the kinematics of the TW Hya association, a young stellar association, but does not focus on galaxies, their satellites, or star formation histories. No relevant criteria matched.
...
## 36. [Self-consistent numerical simulations for the formation and dynamics of solar prominences](https://arxiv.org/abs/2605.00102) <a id="link36"></a>
...
**Comment:** This paper presents numerical simulations of solar prominences, which are solar atmospheric phenomena. It does not relate to galaxy simulations, star formation, or any of the core topics.
...
## 37. [Merger remnant and eccentricity dynamics surrogates for eccentric nonspinning black hole binaries](https://arxiv.org/abs/2605.00124) <a id="link37"></a>
...
**Comment:** This paper presents models for merger remnants and eccentricity dynamics in black hole binaries, which is not relevant to any of the core topics (no connection to galaxy simulations, star formation, or near-field cosmology).
...
## 38. [Multi-messenger Constraints on a Primordial Black Hole Origin of the KM3-230213A Event](https://arxiv.org/abs/2605.00565) <a id="link38"></a>
...
**Comment:** This paper constrains the primordial black hole origin of a neutrino event using multimessenger signals. It is not relevant to any of the core topics (no connection to galaxy simulations, star formation, or near-field cosmology).
...
## 39. [Quantum Noise Fraction and the Thermal Frontier in High-Frequency Gravitational Wave Detection](https://arxiv.org/abs/2605.00053) <a id="link39"></a>

**ArXiv ID:** 2605.00053

**Authors:** Sergio Gaudio

**Abstract:** We introduce a diagnostic -- the quantum noise fraction $\beta$ -- that determines the maximum sensitivity improvement achievable through quantum enhancement for any gravitational wave detector. Applied to the landscape of proposed high-frequency (kHz-GHz) detectors, this diagnostic reveals that resonant mass detectors operating through tidal coupling are thermally dominated ($\beta \approx 0$) at all frequencies below ~230 MHz at dilution temperatures, rendering squeezing and entanglement limited in effectiveness. Only above this thermal frontier, defined by $\hbar \omega = k_B T \ln 3$, does the quantum regime become accessible. We identify a single concrete realization: a bulk acoustic wave resonator at 1 GHz and 10 mK ($\beta = 0.98$), and propose a gravitational wave detector employing squeezed phononic states via circuit QED readout. An array of $10^4$ such resonators with 10 dB mechanical squeezing reaches $\sqrt{S_h} = 7.6 \times 10^{-26}/\sqrt{\rm Hz}$ -- still a factor ~$10^9$ above the BBN bound on stochastic backgrounds at 1 GHz, indicating that the sensitivity gap remains predominantly classical in origin and that concurrent advances in classical detector parameters will be required.

**Comment:** This paper focuses on quantum noise in gravitational wave detectors, which is not related to any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories. No relevant criteria matched.
...
## 40. [A bright wideband radio burst from the isolated neutron star 2XMM J104608.7$-$594306](https://arxiv.org/abs/2605.00720) <a id="link40"></a>
...
**Comment:** The paper reports a radio burst from an isolated neutron star. This is not related to any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories. It is focused on neutron star activity.
...
## 41. [Upstream neutrino production and delayed jet emission in the blazar GB6 J1542+6129](https://arxiv.org/abs/2605.00785) <a id="link41"></a>
...
**Comment:** The paper investigates neutrino production in AGN jets, which is not relevant to any of the core topics (no connection to dwarf galaxies, star formation histories, or galaxy simulations).
...
## 42. [Study of cosmic ray impacts on cryogenic high sensitivity detectors](https://arxiv.org/abs/2605.00023) <a id="link42"></a>
...
**Comment:** Examines cosmic ray impacts on cryogenic detectors; not related to galaxy astrophysics or any of the core topics.
...
## 43. [Magnetic loops in the solar transition region](https://arxiv.org/abs/2605.00767) <a id="link43"></a>
...
**Comment:** This paper focuses on solar transition region magnetic loops, which is unrelated to any of the core topics (no connection to near-field cosmology, galaxy simulations, or stellar models relevant to the prompt).
