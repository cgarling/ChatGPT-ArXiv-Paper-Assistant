...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 33306    | 5094         | 38400   |
| **Cost**             | $0.07    | $0.04        | $0.11   |

Total arXiv papers: 115
...
1. [$V/\sigma$ Trends with Mass for Dwarf Galaxies from the Marvelous Massive Dwarfs Suite](#user-content-link1)
...
2. [A Glimpse of the Low-Mass End of the Direct Mass-Metallicity Relation at $z\sim6-8$](#user-content-link2)
...
3. [Scylla VI: Parsec-Scale Dust Extinction Maps in the SMC and LMC](#user-content-link3)
...
4. [Potamides: Mapping Dark Matter Halo Shapes from Stellar Stream Tracks in the Local Universe](#user-content-link4)
**Authors:** Sirui Wu, Nathaniel Starkman, Sarah Pearson, Jacob Nibauer, Juan Miro-Carretero, David Martinez-Delgado

5. [The impact of envelope binding energies on the merger rate density of binary compact objects](#user-content-link5)
...
6. [The galaxy ultraviolet luminosity function from $z=7$ to $15$ in the COLIBRE simulations](#user-content-link6)
**Authors:** Shengdong Lu, Carlos S. Frenk, Cedric G. Lacey, Andrea Gebek, Joop Schaye, Shaun Cole, Sownak Bose, Anna Durrant, Nick Andreadis, Maarten Baes, Alejandro Ben\'itez-Llambay, Evgenii Chaikin, Camila Correa, Robert A. Crain, Filip Hu\v{s}ko, Robert J. McGibbon, Sylvia Ploeckinger, Alexander J. Richings, Matthieu Schaller, James W. Trayford

7. [Origins of Extreme Emission-Line Ratios in z > 3 Galaxies: Insights from the Lumen Model](#user-content-link7)
**Authors:** Lucie Scharr\'e, Michaela Hirschmann, Ad\`ele Plat, Stephane Charlot, Rachel S. Somerville, Emma Curtis-Lake, Gabriella De Lucia, Miroslava Dessauges-Zavadsky, Anna Feltre, Marion Farcy, Natalia Lah\'en, Aswin P. Vijayan, Stephen M. Wilkins

8. [On the origin of the rotation of massive stars](#user-content-link8)
**Authors:** Andr\'e Oliva, Facundo D. Moyano, Luca Sciarini, Sylvia Ekstr\"om, Patrick Eggenberger, Georges Meynet

9. [Radial redistribution of stellar orbits in FIRE simulations of Milky-Way-mass galaxies](#user-content-link9)
**Authors:** Matthew A. Bellardini, Fiona McCluskey, Andrew Wetzel, Cecilia Steel, Sarah R. Loebman, Jorge Moreno

10. [Inferring Asteroseismic Parameters from Short Observations Using Deep Learning: Application to TESS and K2 Red Giants](#user-content-link10)
**Authors:** Nipun Ghanghas, Siddharth Dhanpal, Shravan Hanasoge, Praneeth Netrapalli, Karthikeyan Shanmugam

11. [On the origin of the environmental step: A BayeSN view of the ZTF SN Ia DR2](#user-content-link11)
...
12. [Systematic Comparison between Constrained Transport and Mixed Divergence Cleaning Methods for Astrophysical Magnetohydrodynamic Simulations](#user-content-link12)
**Authors:** Kengo Tomida, Kenji Eric Sadanari, Shinsuke Takasao, Kazunari Iwasaki

13. [Spectrally and spatially resolved (sub)millimeter HCN-to-HCO$^{+}$ flux ratios in nearby ultraluminous infrared galaxies](#user-content-link13)
**Authors:** Masatoshi Imanishi (NAOJ), Yuri Nishimura (University of Tsukuba), Shunsuke Baba (JAXA), Kouichiro Nakanishi (NAOJ), Takuma Izumi (NAOJ)

14. [Testing the BH$^*$ Model: a UV-to-Optical Spectral Fitting of The Cliff](#user-content-link14)
**Authors:** Rosa M. M\'erida, Marcin Sawicki, Gaia Gaspar, Chris J. Willott, Kartheik G. Iyer

15. [Detection of persistent helium absorption in the 91bg-like type Ia Supernova 2022an](#user-content-link15)
**Authors:** Ping Chen, Avishay Gal-Yam, Subo Dong, Renyue Cen, Boaz Katz, Kate Maguire, Steve Schulze, Jesper Sollerman, Joseph P Anderson, Ting-Wan Chen, L. Galbany, Mariusz Gromadzki, Chang Liu, Adam A. Miller, Tom\'as E. M\"uller-Bravo, Tanja Petrushevska, Giuliano Pignata

16. [Space as a spectroscopic laboratory: High-resolution spectroscopy of the [$^{13}$C II] hyperfine structure with SOFIA/upGREAT](#user-content-link16)
**Authors:** S. Kabanovic, V. Ossenkopf-Okada, S. Schlemmer, J. Stutzki, N. Schneider, U. U. Graf, O. Asvany, D. A. Riechers, C. Guevara, R. Higgins, R. Simon, Y. Okada, M. Mertens, L. Schneider, R. G\"usten, A. G. G. M. Tielens

17. [$Ab$ $initio$ modeling of Galactic dust polarized CMB foreground](#user-content-link17)
**Authors:** Alexei G. Kritsuk, Ka Wai Ho, Ka Ho Yuen, Raphael Flauger

18. [TopoFisher: Learning Topological Summary Statistics by Maximizing Fisher Information](#user-content-link18)
**Authors:** Matteo Biagetti, Mathieu Carri\`ere, Francesco Conti, Enrico Maria Ferrari, Sven Heydenreich, Karthik Viswanathan

19. [Nuclear Constraints on $^{12}$C$(\alpha,\gamma)^{16}$O and Their Impact on Black-Hole Mass Predictions](#user-content-link19)
**Authors:** Akram Mukhamedzhanov

20. [Anisotropic Thermal Conduction as a Driver of Jet Collimation and Magnetic Field Amplification on Cold Fronts](#user-content-link20)
**Authors:** Nana Matsuno, Takaaki Yokoyama, Mami Machida

21. [Young Massive Star Clusters as TeV Emitters: Constraints from H.E.S.S. and LHAASO](#user-content-link21)
**Authors:** Rowan Batzofin, Pierre Cristofari, Kathrin Egberts

22. [Characterizing the Extended Molecular Hydrogen Winds in Protoplanetary Disks from the JWST Disk Infrared Spectroscopic Chemistry Survey](#user-content-link22)
**Authors:** Mayank Narang, Klaus M. Pontoppidan, Colette Salyk, Nicole Arulanantham, Geoffrey A. Blake, Andrea Banzatti, Joan Najita, Ilaria Pascucci, Jane Huang, Sebastiaan Krijt, Karin Oberg, Giovanni Rosotti, Till Kaeufer, Emma Dahl, L. Ilsedore Cleeves, Ke Zhang, Joel Green

23. [First Interstellar Detection of Methyl Carbamate: A New Observational Anchor for Glycine Chemistry](#user-content-link23)
**Authors:** Chunguo Duan, Fengwei Xu, Jun Kang, Qian Gou, Xuefang Xu, Laurent Pagani, Jiaxin Du, Xi Chen

24. [The Spitzer Spectroscopic Data Fusion -- Merged Spectroscopic Redshift Catalogs in Spitzer Fields](#user-content-link24)
**Authors:** Mattia Vaccari (University of Cape Town)

25. [Dynamical evolution of Milky Way globular clusters on the cosmological timescale II. Terzan 2, 4, and 5 mass loss and collision tracking](#user-content-link25)
**Authors:** M. Ishchenko, P. Berczik, D. Kuvatova

26. [Diffuse gamma-ray emissions around the stellar cluster Berkeley 59](#user-content-link26)
**Authors:** Ziwei Ou, Xiaolong Yang, Songpeng Pei

27. [The study of the circumnuclear environment of accreting supermassive black holes with realistic X-ray spectral models](#user-content-link27)
**Authors:** Georgios Dimopoulos, Claudio Ricci, St\'ephane Paltani

28. [Probing the Inert Doublet Dark Matter with Stellar-Mass Black Hole Mini-Spikes](#user-content-link28)
**Authors:** Rameswar Sahu

29. [Constraining the Galactic bar using the M92 stellar stream](#user-content-link29)
**Authors:** Amanda Bystr\"om, Sergey E. Koposov, Ting. S. Li, Constance M. Rockosi, Arjun Dey, Guillaume F. Thomas, Raymond G. Carlberg, Oleg Y. Gnedin, Namitha Kizhuprakkat, Mika Lambert, Nasser Mohammed, Gustavo E. Medina, Joan Najita, Alexander H. Riley, Nathan R. Sandford, Leandro Beraldo e Silva, Jessica N. Aguilar, Steven Ahlen, Davide Bianchi, David Brooks, Todd Claybaugh, Andrew P. Cooper, Andrei Cuceu, Axel de la Macorra, Peter Doel, Jaime E. Forero-Romero, Satya Gontcho A Gontcho, Gaston Gutierrez, Richard Joyce, Stephanie Juneau, Anthony Kremin, Martin Landriau, Laurent Le Guillou, Aaron Meisner, Ramon Miquel, Will J. Percival, Francisco Prada, Ignasi P\'erez-R\`afols, Graziano Rossi, Eusebio Sanchez, David Schlegel, Joseph H. Silber, Gregory Tarl\'e, Benjamin A. Weaver, Hu Zou

30. [Decaying spin-3/2 dark matter from baryon number violation](#user-content-link30)
**Authors:** Francesco Costa, Gabriel M. Salla

31. [Complex organic molecules and cosmic ray ionisation rate towards the massive protostar Cepheus A HW2](#user-content-link31)
**Authors:** Emma W. Nielsen, Anna Punanova, Eva Wirstr\"om, Brandt Gaches, A. O. Henrik Olofsson, Paola Caselli, Prasanta Gorai, Jonathan C. Tan

32. [Dark siren cross-correlations and the sensitivity of $H_0$ to methodological choices](#user-content-link32)
**Authors:** Madeline L. Cross-Parkin, Cullan Howlett, Leonardo Giani, Chris Blake, Tamara M. Davis

33. [Hidden Monsters with SPHEREx I: A goldmine for heavily reddened quasars at cosmic noon](#user-content-link33)
**Authors:** Matthew Stepney, Manda Banerji, Franz E. Bauer, Roberto J. Assef, Guodong Li

34. [A PINK update: Improvements to the CELEBI fast radio burst data reduction and analysis pipeline](#user-content-link34)
**Authors:** M. Glowacki, T. Dial, A. Bera, A. T. Deller, K. Gourdji, A. Jaini, D. Scott, Y. Wang, K. Desnos, A. C. Gordon, R. L. Davies, R. M. Shannon

35. [CMB Limits on the Absorption of Light Vector and Axial-Vector Dark Matter](#user-content-link35)
**Authors:** Gabriele Montefalcone, Nicola Bellomo, Kimberly K. Boddy

36. [Neutrino-Antineutrino Conversion from Ultralight Vector Dark Matter](#user-content-link36)
**Authors:** Asher Berlin, Rodolfo Capdevilla, Ting Cheng, Matheus Hostert, Pedro A. N. Machado

37. [Machine Learning Techniques for Astrophysics and Cosmology: Photometric Redshifts](#user-content-link37)
**Authors:** Luca Tortorelli, Daniel Gr\"un

38. [Magnetar field dynamics driven by chiral anomalies without magnetic helicity](#user-content-link38)
**Authors:** Clara Dehman

39. [The diverse morphologies and evolution of low-luminosity edge-brightened radio galaxies](#user-content-link39)
**Authors:** B. Barkus, J. H. Croston, B. Mingo, M. J. Hardcastle, G. G\"urkan, V. H. Mahatma

40. [The structure of multi-axion solutions to the strong CP problem](#user-content-link40)
**Authors:** Mario Fern\'andez Navarro, Marta F. Zamoro, Marko Pesut, Xavier Ponce D\'iaz

41. [You Only Stack Once (YOSO): A Motion-Filtered, Deep-Learning Framework for Detecting Faint Moving Sources](#user-content-link41)
**Authors:** Nitya Pandey, C\'esar Fuentes, Pedro Bernardinelli, Valeria Fr\'ias, Colin Orion Chandler, David E. Trilling, Matthew J. Holman, Steven Stetzler, Dallin Spencer, Hsing Wen Lin, Luis E. Salazar Manzano, Darin Ragozzine, Ryder Strauss, Mario Juri\'c, Andrew J. Connolly, Hayden Smotherman, Scott S. Sheppard, Kevin Napier

42. [A New Global Chemical Equilibrium Code: Refractory Element Signatures in Super-Earths and Sub-Neptunes](#user-content-link42)
**Authors:** Simon Grimm, Marie-Luise Steinmeyer, Aaron Werlen, Caroline Dorn, Hilke Schlichting, Ed Young

43. [The Hubble Advanced Spectral Product (HASP) Program](#user-content-link43)
...
44. [Advance warning of $\gamma$-ray blazar flares from \textit{Fermi}-LAT light curves: a strictly causal machine-learning backtest](#user-content-link44)
**Authors:** Zahir Shah, Sikandar Akbar

45. [Origin and evolution of NiI and FeI in the coma of the interstellar comet 3I/ATLAS throughout its trajectory](#user-content-link45)
**Authors:** Damien Hutsem\'ekers, Jean Manfroid, Cyrielle Opitom, Emmanu\"el Jehin, Aravind Krishnakumar, Fernando Massa Fernandes, Michele Bannister, Dennis Bodewits, Rosemary Dorsey, Fiorangela La Forgia, Brian Murphy

46. [A Changing-Look Seyfert Discovered by eROSITA Reveals a Two-Component Broad-Line Region](#user-content-link46)
**Authors:** Alex Markowitz (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences), Mirko Krumpe (Leibniz-Institut f\"ur Astrophysik Potsdam), David Homan (Leibniz-Institut f\"ur Astrophysik Potsdam, Institute of Astronomy, University of Cambridge), Bo\.zena Czerny (Center for Theoretical Physics, Polish Academy of Sciences), Mariusz Gromazdki (Astronomical Observatory, University of Warsaw), Hartmut Winkler (Department of Physics, University of Johannesburg), Joern Wilms (Karl Remeis-Observatory and Erlangen Centre for Astroparticle Physics, Friedrich-Alexander Universit\"at Erlangen-N\"urnberg), Steven H\"ammerich (Karl Remeis-Observatory and Erlangen Centre for Astroparticle Physics, Friedrich-Alexander Universit\"at Erlangen-N\"urnberg), Georg Lamer (Leibniz-Institut f\"ur Astrophysik Potsdam), Tathagata Saha (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences, Inter-University Centre for Astronomy and Astrophysics), David A. H. Buckley (South African Astronomical Observatory, Department of Physics, University of the Free State), Malte Schramm (Universit\"at Potsdam), Daniel E. Reichart (Department of Physics and Astronomy, University of North Carolina at Chapel Hill), Mara Salvato (Max-Planck-Institut f\"ur Extraterrestrische Physik), Pietro Baldini (Max-Planck-Institut f\"ur Extraterrestrische Physik)

47. [An HST Wide Field Survey of the Galactic Bulge: Overview, Strategy, and First Results](#user-content-link47)
**Authors:** Sean K. Terry, Jay Anderson, Charles A. Beichman, David P. Bennett, Aparna Bhattacharya, Jean-Philippe Beaulieu, B. Scott Gaudi, Joel Green, Macy J. Huston, Jessica R. Lu, Ray A. Lucas, David M. Nataf, Matthew T. Penny, Natalia E. Rektsini, Carolina Rodriguez Sanchez-Vahamonde, Aikaterini Vandorou

48. [Exploring TRAPPIST-1 Climate States with an Energy Balance Model](#user-content-link48)
**Authors:** Jacob Haqq-Misra

49. [Resonant Inverse Compton Scattering and Hard X-ray Emission in Magnetar Magnetospheres](#user-content-link49)
**Authors:** Kun Hu, Nicholas Rackers, Alexander Y. Chen

50. [Plasma heating during the chiral plasma instability](#user-content-link50)
**Authors:** Balin Armstrong, Andrew J. Long, K\'aroly Seller, G\"unter Sigl

51. [KM3-230213A and potential astrophysical sources](#user-content-link51)
**Authors:** Per Arne Sevle Myhr (on behalf of the KM3NeT Collaboration)

52. [Formulation of testing gravitational redshift based on Laser Time link between China Space Station and a ground station](#user-content-link52)
**Authors:** Rui Xu, Wenbin Shen, Hok Sum Fok, Pengfei Zhang, Lihong Li, Lei Wang, Kuangchao Wu, An Ning, Youchao Xie, Ziyu Shen, Lingxuan Wang, Yongqi Zhao, Kai Liu, Yuanjin Pan

53. [X-ray spectroscopy mass constraints on V1674 Her: the fastest nova does not have a near-Chandrasekhar white dwarf](#user-content-link53)
**Authors:** Tekeba Olbemo, Manel Errando, Andrea Gokus

54. [Radio Continuum and Water Maser Monitoring of the Outburst in HOPS 373: Free-Free Emission Does Not Respond to the Outburst](#user-content-link54)
**Authors:** John Tobin, Doug Johnstone, Greg Herczeg, Jeong-Eun Lee, Ho-Gyu Lee, Carlos Contreras-Pena, Sung-Yong Yoon, Steve Mairs

55. [Investigating Pre-flare Signatures in Spectroscopic Observations of an X9-class Solar Flare](#user-content-link55)
**Authors:** Louis Seyfritz, Maria Kazachenko, Ryan French

56. [Mass Production of 2023 KMTNet Microlensing Planets. III: Three Planets from the Subprime Field](#user-content-link56)
**Authors:** Hongyu Li, Zhixing Li, Weicheng Zang, Yoon-Hyun Ryu, Andrzej Udalski, Takahiro Sumi, Hongjing Yang, Jiyuan Zhang, Shude Mao, Michael Albrow, Sun-Ju Chung, Andrew Gould, Cheongho Han, Kyu-Ha Hwang, Youn Kil Jung, In-Gu Shin, Yossi Shvartzvald, Jennifer Yee, Sang-Mok Cha, Dong-Jin Kim, Seung-Lee Kim, Chung-Uk Lee, Dong-Joo Lee, Yongseok Lee, Byeong-Gon Park, Richard Pogge, Przemek Mr\'oz, Micha{\l} Szyma\'nski, Jan Skowron, Radoslaw Poleski, Igor Soszy\'nski, Pawel Pietrukowicz, Szymon Koz{\l}owski, Krzysztof Rybicki, Patryk Iwanek, Krzysztof Ulaczyk, Marcin Wrona, Mariusz Gromadzki, Mateusz J. Mr\'oz, Fumio Abe, David Bennett, Aparna Bhattacharya, Ian Bond, Ryusei Hamada, Yuki Hirao, Stela Silva, Shota Miyazaki, Yasushi Muraki, Kansuke Nunota, Greg Olmschenk, Cl\'ement Ranc, Nicholas Rattenbury, Yuki Satoh, Daisuke Suzuki, Takuto Tamaoki, Sean Terry, Paul Tristram, Aikaterini Vandorou, Hibiki Yama

---

## 1. [$V/\sigma$ Trends with Mass for Dwarf Galaxies from the Marvelous Massive Dwarfs Suite](https://arxiv.org/abs/2605.06893) <a id="link1"></a>

**ArXiv ID:** 2605.06893

**Authors:** Dilys Ruan, Alyson M. Brooks, Leonardo A. Barba, Mithi A. C. de los Reyes, Akaxia Cruz, Robel Geda, Annika H. G. Peter, Benjamin W. Keller, Thomas Quinn, James W. Wadsley

**Abstract:** Galaxy formation scenarios can be interpreted through galaxy morphology and the level of rotational versus pressure support, quantified through the ratio of a galaxy's rotation speed to its velocity dispersion: $V/\sigma$. Observational studies of dwarf galaxies find that $V/\sigma$ does not strongly depend on environment, and may weakly depend on galaxy mass, which could shift our understanding of how dwarf galaxies form. We utilize the Marvelous Massive Dwarfs suite to examine whether $V/\sigma$ depends on mass in simulations, and understand how this varies for different baryonic components of the galaxy: HI gas, young stars ($$ 1 Gyr). We use a simulation sample of 67 isolated dwarf galaxies with M$_\star=10^6-10^9$ M$_\odot$ and produce line-of-sight maps for rotation speed and dispersion for different viewing angles of each galaxy. We find that $V/\sigma$ increases with mass, and that HI gas and young stars are more rotation-supported ($V/\sigma\approx 1-13$) while old stars are more dispersion-supported ($V/\sigma\approx 0.2-5$). This result is consistent with the scenario where young stars are born from dynamically cold gas in the interstellar medium and undergo dynamical heating over time. We quantify the effects of spatial resolution in observational determinations of $V/\sigma$ and find that existing observations using old stars may underestimate the intrinsic $V/\sigma$. We find a correlation between $V/\sigma_\mathrm{HI,global}$ and HI line profile shape that is qualitatively similar to previous simulation results, but we find higher $V/\sigma_\mathrm{HI,global}$ compared to prior work which found values $\lesssim 2$ for most galaxies in this mass range. Our results motivate future work to examine $V/\sigma$ and dwarf galaxy formation with different kinematic tracers of the galaxy.

**Comment:** This paper uses the Marvelous Massive Dwarfs suite to study the kinematic support ($V/\sigma$) in simulated isolated dwarf galaxies (M$_\star=10^6-10^9$ M$_\odot$), directly matching the 'Numerical Galaxy Simulations' and 'Near-Field Cosmology' criteria. The focus on dwarf galaxy kinematics and implications for their formation is highly relevant.
...
## 2. [A Glimpse of the Low-Mass End of the Direct Mass-Metallicity Relation at $z\sim6-8$](https://arxiv.org/abs/2605.06770) <a id="link2"></a>
...
**Comment:** This paper presents direct metallicity measurements for low-mass galaxies at high redshift, focusing on the mass-metallicity relation down to stellar masses of 10^6-10^8 Msun. This is highly relevant to near-field cosmology (dwarf galaxy abundances, chemical evolution) and the study of dwarf galaxies' properties. The use of direct metallicity measurements is novel for this mass and redshift range.
...
## 3. [Scylla VI: Parsec-Scale Dust Extinction Maps in the SMC and LMC](https://arxiv.org/abs/2605.06925) <a id="link3"></a>
...
**Comment:** This paper presents parsec-scale dust extinction maps in the SMC and LMC using HST data. The SMC and LMC are classic targets for near-field cosmology, and the work provides high-resolution ISM structure maps in low-metallicity environments, which are highly relevant for understanding dwarf galaxies and their ISM. This closely matches the 'Near-Field Cosmology' criterion and is also relevant for studies of resolved star formation histories and ISM structure.
...
## 4. [Potamides: Mapping Dark Matter Halo Shapes from Stellar Stream Tracks in the Local Universe](https://arxiv.org/abs/2605.07809) <a id="link4"></a>
...
**Comment:** This paper presents a new method (Potamides) for mapping dark matter halo shapes using extragalactic stellar streams. It directly addresses the measurement of dark matter halo geometry in external galaxies using stellar streams, which is highly relevant to near-field cosmology and the study of substructure and dark matter profiles. The method is novel and will be important for upcoming surveys.
...
## 5. [The impact of envelope binding energies on the merger rate density of binary compact objects](https://arxiv.org/abs/2605.06807) <a id="link5"></a>
...
**Comment:** This paper investigates envelope binding energies in stellar evolution models and their impact on binary compact object merger rates. The work presents new stellar models and discusses their implications for binary evolution, which is relevant to the 'Stellar Models' criterion. The focus is on the theoretical modeling of stellar interiors and their outcomes.
...
## 6. [The galaxy ultraviolet luminosity function from $z=7$ to $15$ in the COLIBRE simulations](https://arxiv.org/abs/2605.06782) <a id="link6"></a>
...
**Comment:** This paper presents results from the COLIBRE cosmological hydrodynamics simulations, focusing on the ultraviolet luminosity function of galaxies at high redshift. It fits the 'Numerical Galaxy Simulations' criterion, as it presents new high-resolution simulations and analyzes their predictions for galaxy populations. However, the focus is on high-redshift galaxies, not specifically on near-field cosmology or dwarfs, so relevance is moderate.
...
## 8. [On the origin of the rotation of massive stars](https://arxiv.org/abs/2605.06872) <a id="link8"></a>
...
**Comment:** This paper investigates the origin of rotation in massive stars using simulations of protostellar jets and angular momentum transport. While it presents new stellar evolution models and simulations, the focus is on massive stars, not on the development of new stellar evolutionary tracks or atmosphere models for general use. Only borderline relevance to the 'Stellar Models' criterion.
...
## 9. [Radial redistribution of stellar orbits in FIRE simulations of Milky-Way-mass galaxies](https://arxiv.org/abs/2605.06781) <a id="link9"></a>
...
**Comment:** This paper uses FIRE-2 simulations of Milky Way-mass galaxies to study the radial redistribution of stellar orbits. While it involves numerical galaxy simulations, the focus is on the stellar disk and orbital migration in Milky Way-mass galaxies, not on dwarf galaxies, near-field cosmology, or the other core topics. Simulations of Milky Way-mass galaxies are less relevant unless they focus on satellites or the stellar halo.
...
## 10. [Inferring Asteroseismic Parameters from Short Observations Using Deep Learning: Application to TESS and K2 Red Giants](https://arxiv.org/abs/2605.08051) <a id="link10"></a>
...
**Comment:** This paper develops a machine learning method to infer asteroseismic parameters from short observations of red giants. While it focuses on stellar parameters and internal structure, it does not present new stellar evolutionary or atmosphere models, but rather a new analysis method. It is tangentially related to 'Stellar Models' but does not directly match the criterion.
...
## 11. [On the origin of the environmental step: A BayeSN view of the ZTF SN Ia DR2](https://arxiv.org/abs/2605.06799) <a id="link11"></a>
...
**Comment:** The paper investigates the environmental dependence of SN Ia properties and their impact on cosmological measurements. While it discusses host galaxy environments, it does not focus on dwarf galaxies, resolved star formation histories, or other core topics.
...
## 12. [Systematic Comparison between Constrained Transport and Mixed Divergence Cleaning Methods for Astrophysical Magnetohydrodynamic Simulations](https://arxiv.org/abs/2605.07928) <a id="link12"></a>
...
**Comment:** This paper systematically compares numerical methods for MHD simulations, which is only peripherally relevant to the core topics unless the methods are applied to galaxy simulations with new physics. The focus is on simulation methodology, not on galaxy formation or evolution.
...
## 14. [Testing the BH$^*$ Model: a UV-to-Optical Spectral Fitting of The Cliff](https://arxiv.org/abs/2605.07976) <a id="link14"></a>
...
**Comment:** The paper presents a UV-to-optical spectral fitting of a low-mass, star-forming, metal-poor galaxy at high redshift. It derives the star formation history of the host galaxy from spectral fitting, which is related to resolved star formation histories, but the galaxy is unresolved and at high redshift. The focus is not on local dwarf galaxies or near-field cosmology, and the star formation history is not derived from resolved stellar populations. The connection to the core topics is weak.
...
## 15. [Detection of persistent helium absorption in the 91bg-like type Ia Supernova 2022an](https://arxiv.org/abs/2605.07827) <a id="link15"></a>
...
**Comment:** This paper presents observations of a peculiar Type Ia supernova and discusses helium absorption features. While it is relevant to stellar evolution and supernovae, it does not present new stellar models or address the core topics such as resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 16. [Space as a spectroscopic laboratory: High-resolution spectroscopy of the [$^{13}$C II] hyperfine structure with SOFIA/upGREAT](https://arxiv.org/abs/2605.07995) <a id="link16"></a>
...
**Comment:** This paper presents high-resolution spectroscopy of the [$^{13}$C II] hyperfine structure, improving atomic data. While it is relevant to ISM studies and may have indirect implications for stellar models, it does not present new stellar evolutionary or atmosphere models, nor does it address any of the core topics directly.
...
## 17. [$Ab$ $initio$ modeling of Galactic dust polarized CMB foreground](https://arxiv.org/abs/2605.06896) <a id="link17"></a>
...
**Comment:** This paper presents high-resolution simulations of magnetized interstellar turbulence to model Galactic dust polarization, relevant for CMB foregrounds. While it involves simulations of the ISM, it does not focus on galaxy-scale simulations, star formation histories, or any of the core topics.
...
## 18. [TopoFisher: Learning Topological Summary Statistics by Maximizing Fisher Information](https://arxiv.org/abs/2605.07720) <a id="link18"></a>
...
**Comment:** This paper introduces TopoFisher, a method for learning topological summary statistics for simulation-based inference, with applications to weak gravitational lensing. While it is a methodological advance in cosmological inference, it does not focus on galaxies, star formation histories, or any of the core topics.
...
## 20. [Anisotropic Thermal Conduction as a Driver of Jet Collimation and Magnetic Field Amplification on Cold Fronts](https://arxiv.org/abs/2605.07235) <a id="link20"></a>
...
**Comment:** This paper presents MHD simulations of AGN jets in galaxy clusters, focusing on the effects of anisotropic thermal conduction on jet collimation and magnetic field amplification. While it involves galaxy clusters and jet dynamics, it does not focus on galaxies themselves, their star formation histories, or outflows driven by star formation. No criteria match.
...
## 21. [Young Massive Star Clusters as TeV Emitters: Constraints from H.E.S.S. and LHAASO](https://arxiv.org/abs/2605.07777) <a id="link21"></a>
...
**Comment:** This paper studies young massive star clusters (YMSCs) as sources of Galactic cosmic rays, using gamma-ray observations and simulations. While it involves simulations and star clusters, it does not focus on galaxy-scale simulations, dwarf galaxies, or star formation histories, and thus does not match the core topics.
...
## 22. [Characterizing the Extended Molecular Hydrogen Winds in Protoplanetary Disks from the JWST Disk Infrared Spectroscopic Chemistry Survey](https://arxiv.org/abs/2605.07016) <a id="link22"></a>
...
**Comment:** The paper analyzes molecular hydrogen winds in protoplanetary disks using JWST data. While it discusses outflows, these are not galaxy-scale star-formation-driven outflows, but rather disk winds in star-forming regions. Does not match the core topics.
...
## 23. [First Interstellar Detection of Methyl Carbamate: A New Observational Anchor for Glycine Chemistry](https://arxiv.org/abs/2605.07159) <a id="link23"></a>
...
**Comment:** This paper reports the first interstellar detection of methyl carbamate, a molecule relevant to glycine chemistry, in a hot molecular core. The focus is on astrochemistry in star-forming regions, not on galaxies, their satellites, or star formation histories. No criteria match.
...
## 24. [The Spitzer Spectroscopic Data Fusion -- Merged Spectroscopic Redshift Catalogs in Spitzer Fields](https://arxiv.org/abs/2605.07998) <a id="link24"></a>
...
**Comment:** This paper presents a merged spectroscopic redshift catalog for extragalactic survey fields. While useful for galaxy studies, it does not focus on any of the core topics such as near-field cosmology, resolved star formation histories, or dwarf galaxy properties. It is a general data resource.
...
## 25. [Dynamical evolution of Milky Way globular clusters on the cosmological timescale II. Terzan 2, 4, and 5 mass loss and collision tracking](https://arxiv.org/abs/2605.07511) <a id="link25"></a>
...
**Comment:** The paper studies the dynamical evolution of Milky Way globular clusters in the Galactic center. While it involves N-body simulations and cluster interactions, the focus is on globular clusters near the Galactic center, which is outside the core topics (dwarf galaxies, satellite galaxies, etc.).
...
## 26. [Diffuse gamma-ray emissions around the stellar cluster Berkeley 59](https://arxiv.org/abs/2605.07479) <a id="link26"></a>
...
**Comment:** This paper analyzes gamma-ray emission around a young stellar cluster (Berkeley 59) and discusses cosmic ray acceleration by cluster winds. While it touches on star formation and outflows, the focus is on a stellar cluster, not a galaxy, and does not address galaxy-scale outflows, dwarf galaxies, or the CGM. Only tangential relevance.
...
## 27. [The study of the circumnuclear environment of accreting supermassive black holes with realistic X-ray spectral models](https://arxiv.org/abs/2605.06794) <a id="link27"></a>
...
**Comment:** The paper focuses on X-ray spectral modeling of the circumnuclear environment of AGN and supermassive black holes. This is not relevant to the core topics, as it does not address galaxy-scale processes, dwarf galaxies, or stellar models.
...
## 28. [Probing the Inert Doublet Dark Matter with Stellar-Mass Black Hole Mini-Spikes](https://arxiv.org/abs/2605.07616) <a id="link28"></a>
...
**Comment:** The paper investigates dark matter constraints using mini-spikes around stellar-mass black holes, focusing on particle physics models. While it touches on dark matter, it does not address near-field cosmology, galaxy formation, or any of the specified criteria.
...
## 29. [Constraining the Galactic bar using the M92 stellar stream](https://arxiv.org/abs/2605.07918) <a id="link29"></a>
...
**Comment:** This paper uses the M92 stellar stream to constrain the properties of the Milky Way bar. While it involves stellar streams, the focus is on the Galactic bar and inner potential, which is explicitly listed as irrelevant in the criteria.
...
## 30. [Decaying spin-3/2 dark matter from baryon number violation](https://arxiv.org/abs/2605.06796) <a id="link30"></a>
...
**Comment:** This paper focuses on dark matter phenomenology, specifically spin-3/2 dark matter with baryon number violating interactions. While it discusses dark matter and baryonic portals, it does not focus on galaxies, their satellites, resolved star formation histories, or any of the core topics. No criteria match closely.
...
## 31. [Complex organic molecules and cosmic ray ionisation rate towards the massive protostar Cepheus A HW2](https://arxiv.org/abs/2605.06767) <a id="link31"></a>
...
**Comment:** This paper studies the impact of cosmic rays on complex organic molecule formation in a high-mass protostar. The focus is on astrochemistry in a star-forming region, not on galaxies, their satellites, or star formation histories. No criteria match.
...
## 32. [Dark siren cross-correlations and the sensitivity of $H_0$ to methodological choices](https://arxiv.org/abs/2605.06783) <a id="link32"></a>
...
**Comment:** This paper focuses on cosmological parameter estimation (H0) using gravitational wave events and galaxy catalogs. While it is cosmology-related, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other core topics. No direct relevance to the specified criteria.
...
## 34. [A PINK update: Improvements to the CELEBI fast radio burst data reduction and analysis pipeline](https://arxiv.org/abs/2605.06766) <a id="link34"></a>
...
**Comment:** This paper describes improvements to a data reduction pipeline for fast radio bursts (FRBs). While FRBs can be used for cosmology, the paper does not address near-field cosmology, galaxy evolution, or any of the core topics.
...
## 35. [CMB Limits on the Absorption of Light Vector and Axial-Vector Dark Matter](https://arxiv.org/abs/2605.08080) <a id="link35"></a>
...
**Comment:** This paper sets CMB limits on the absorption of light vector and axial-vector dark matter. It is focused on cosmological constraints on dark matter properties, not on near-field cosmology, galaxy evolution, or any of the core topics.
...
## 36. [Neutrino-Antineutrino Conversion from Ultralight Vector Dark Matter](https://arxiv.org/abs/2605.06777) <a id="link36"></a>

**ArXiv ID:** 2605.06777

**Authors:** Asher Berlin, Rodolfo Capdevilla, Ting Cheng, Matheus Hostert, Pedro A. N. Machado

**Abstract:** We show that Majorana neutrinos convert into antineutrinos in a background of ultralight vector dark matter coupled to lepton number, such as the gauge boson of $\text{U}(1)_{B-L}$ or $\text{U}(1)_{L_i - L_j}$ with $i, j = e , \mu, \tau$. This effect is suppressed by the small neutrino mass, but the enhancement by long astrophysical baselines can enable future searches for solar and supernova neutrinos to explore uncharted parameter space. For instance, for $\text{U}(1)_{B-L}$ dark matter, the observation of a supernova neutrino burst at DUNE, Hyper-Kamiokande, and JUNO could probe gauge couplings as small as $e^\prime \sim 10^{-32} - 10^{-25}$ for dark matter masses of $m_{A^\prime} \sim 10^{-22} \ \text{eV} - 10^{-14} \ \text{eV}$, beyond the capability of other future probes.

**Comment:** This paper discusses neutrino-antineutrino conversion in the presence of ultralight vector dark matter. While it is related to dark matter, it does not focus on galaxies, their structure, or evolution, and does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation.
...
## 37. [Machine Learning Techniques for Astrophysics and Cosmology: Photometric Redshifts](https://arxiv.org/abs/2605.06790) <a id="link37"></a>
...
**Comment:** This paper reviews machine learning methods for photometric redshift estimation. While photometric redshifts are important for galaxy studies, the focus here is on methodology for redshift inference, not on any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. No direct match to the criteria.
...
## 38. [Magnetar field dynamics driven by chiral anomalies without magnetic helicity](https://arxiv.org/abs/2605.08068) <a id="link38"></a>
...
**Comment:** This paper studies the evolution of magnetar magnetic fields driven by the chiral magnetic effect. The focus is on neutron star magnetic field evolution, which does not match any of the core topics such as galaxy evolution, star formation histories, or stellar models as defined in the criteria.
...
## 39. [The diverse morphologies and evolution of low-luminosity edge-brightened radio galaxies](https://arxiv.org/abs/2605.07684) <a id="link39"></a>
...
**Comment:** The paper investigates the morphologies and evolution of low-luminosity edge-brightened radio galaxies (FRIIs). While it discusses galaxy evolution, the focus is on radio AGN and jet morphology in higher-mass galaxies, not on dwarf galaxies, near-field cosmology, or any of the core topics.
...
## 40. [The structure of multi-axion solutions to the strong CP problem](https://arxiv.org/abs/2605.06787) <a id="link40"></a>
...
**Comment:** This paper discusses multi-axion solutions to the strong CP problem, which is a topic in particle physics and fundamental theory, not related to the core astrophysical topics listed.
...
## 41. [You Only Stack Once (YOSO): A Motion-Filtered, Deep-Learning Framework for Detecting Faint Moving Sources](https://arxiv.org/abs/2605.06913) <a id="link41"></a>
...
**Comment:** This paper presents a new deep-learning framework for detecting faint moving Solar System objects. While it is innovative for Solar System science, it does not match any of the core topics (e.g., near-field cosmology, galaxy simulations, star formation histories, etc.).
...
## 42. [A New Global Chemical Equilibrium Code: Refractory Element Signatures in Super-Earths and Sub-Neptunes](https://arxiv.org/abs/2605.07833) <a id="link42"></a>
...
**Comment:** The paper presents a new global chemical equilibrium code for modeling the atmospheres of super-Earths and sub-Neptunes, focusing on planetary interiors and atmospheric chemistry. It does not address galaxies, star formation, or any of the core topics.
...
## 43. [The Hubble Advanced Spectral Product (HASP) Program](https://arxiv.org/abs/2605.06836) <a id="link43"></a>
...
**Comment:** This paper describes the Hubble Advanced Spectral Products (HASP) program, which provides improved coadded HST spectra. While this is a useful data product for the community, it is a technical/methodological paper and does not directly address any of the core topics such as resolved star formation histories, stellar models, or galaxy simulations.
...
## 45. [Origin and evolution of NiI and FeI in the coma of the interstellar comet 3I/ATLAS throughout its trajectory](https://arxiv.org/abs/2605.07652) <a id="link45"></a>
...
**Comment:** This paper analyzes metal emission in the coma of an interstellar comet, which is unrelated to any of the core topics (dwarf galaxies, star formation histories, galaxy simulations, etc.).
...
## 46. [A Changing-Look Seyfert Discovered by eROSITA Reveals a Two-Component Broad-Line Region](https://arxiv.org/abs/2605.07965) <a id="link46"></a>
...
**Comment:** This paper studies a changing-look Seyfert AGN and the structure of its broad-line region. The focus is on AGN variability and accretion, which is not relevant to the core topics.
...
## 47. [An HST Wide Field Survey of the Galactic Bulge: Overview, Strategy, and First Results](https://arxiv.org/abs/2605.06778) <a id="link47"></a>
...
**Comment:** This paper presents an HST survey of the Galactic Bulge, focusing on stellar populations, exoplanet systems, and the central region of the Milky Way. The focus is on the Galactic Bulge, which is explicitly listed as irrelevant. No criteria match.
...
## 48. [Exploring TRAPPIST-1 Climate States with an Energy Balance Model](https://arxiv.org/abs/2605.06964) <a id="link48"></a>
...
**Comment:** This paper studies the climates of exoplanets in the TRAPPIST-1 system using an energy balance model. It does not address galaxies, star formation histories, or any of the core topics. No criteria match.
...
## 49. [Resonant Inverse Compton Scattering and Hard X-ray Emission in Magnetar Magnetospheres](https://arxiv.org/abs/2605.07255) <a id="link49"></a>
...
**Comment:** This paper focuses on hard X-ray emission mechanisms in magnetar magnetospheres, which is not related to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models as defined. Magnetars are neutron stars and not dwarf galaxies or related to galaxy-scale processes.
...
## 50. [Plasma heating during the chiral plasma instability](https://arxiv.org/abs/2605.06795) <a id="link50"></a>
...
**Comment:** This paper studies plasma heating during the chiral plasma instability, with implications for early universe cosmology. It does not address galaxies, star formation, or any of the core topics.
...
## 51. [KM3-230213A and potential astrophysical sources](https://arxiv.org/abs/2605.07641) <a id="link51"></a>
...
**Comment:** This paper reviews the detection of an ultra-high energy neutrino and discusses potential astrophysical sources. It does not address galaxies, star formation, or any of the core topics.
...
## 52. [Formulation of testing gravitational redshift based on Laser Time link between China Space Station and a ground station](https://arxiv.org/abs/2605.07216) <a id="link52"></a>
...
**Comment:** The paper is about testing gravitational redshift using laser time transfer between the China Space Station and a ground station. It is focused on fundamental physics and geodesy, not on galaxies, star formation, or any of the core topics.
...
## 53. [X-ray spectroscopy mass constraints on V1674 Her: the fastest nova does not have a near-Chandrasekhar white dwarf](https://arxiv.org/abs/2605.06917) <a id="link53"></a>
...
**Comment:** This paper presents X-ray constraints on the mass and magnetic field of a white dwarf in a nova system. It is focused on stellar remnants and novae, not on galaxies, star formation histories, or any of the core topics.
...
## 54. [Radio Continuum and Water Maser Monitoring of the Outburst in HOPS 373: Free-Free Emission Does Not Respond to the Outburst](https://arxiv.org/abs/2605.06805) <a id="link54"></a>
...
**Comment:** This paper presents radio continuum and water maser monitoring of a protostar outburst. It focuses on star formation in the context of protostars, not galaxies, and does not address any of the core topics.
...
## 55. [Investigating Pre-flare Signatures in Spectroscopic Observations of an X9-class Solar Flare](https://arxiv.org/abs/2605.07889) <a id="link55"></a>
...
**Comment:** This paper investigates pre-flare signatures in a solar flare using spectroscopic data. It is focused on solar physics and not on galaxies, star formation, or any of the core topics. No criteria match.
...
## 56. [Mass Production of 2023 KMTNet Microlensing Planets. III: Three Planets from the Subprime Field](https://arxiv.org/abs/2605.07392) <a id="link56"></a>
...
**Comment:** This paper analyzes microlensing planetary events and mass-ratio distributions. It does not focus on galaxies, star formation histories, or any of the core topics. It is unrelated to the main criteria.
