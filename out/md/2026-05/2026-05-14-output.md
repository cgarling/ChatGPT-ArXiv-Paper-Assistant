...
1. [The Metallicity Distribution of the Ultra-Faint Dwarf Galaxy Segue 1](#user-content-link1)
**Authors:** Daisy Bissonette, Alexander P. Ji, Joshua D. Simon, Joss Bland-Hawthorn, Anirudh Chiti, Marla Geha, Ting S. Li, Anna Frebel, Alice M. Luna

2. [Tunneling and tidal stripping in multifield ultralight dark matter halos](#user-content-link2)
**Authors:** Benjamin V. Lehmann, Jackie Lodman, Thomas Steingasser

3. [The Panchromatic Hubble Andromeda Southern Treasury (PHAST). II. The Spatially Resolved Recent Star Formation History in M31](#user-content-link3)
**Authors:** Tobin M. Wainer, Benjamin F. Williams, Zhuo Chen, Margaret Lazzarini, Julianne J. Dalcanton, Eric F. Bell, Kameron Goold, Andrew Dolphin, Meredith J. Durbin, Stefany L. Fabian Dub\'on, Karoline M. Gilbert, Puragra Guhathakurta, Francois Hammer, L. Clifton Johnson, Eric W. Koch, Kristen. B. W. McQuinn, Ekta Patel, Vaishnav V. Rao, Julia Roman-Duval, Adam Smercina, Debby Tran, Daniel R. Weisz

4. [The Galaxy Luminosity Functions in ASTRID: Predictions for LSST](#user-content-link4)
...
5. [Full non-LTE multi-level radiative transfer II. The case of a 5-level Ca ii atom with broadened excited levels](#user-content-link5)
**Authors:** T. Lagache, M. Sampoorna, F. Paletou

6. [From DES to KiDS: Domain adaptation for cross-survey detection of low-surface-brightness galaxies](#user-content-link6)
**Authors:** Hareesh Thuruthipilly, Krzysztof Lisiecki, Junais, Katarzyna Ma{\l}ek, Agnieszka Pollo, William J. Pearson, Antonio Vanzanella, Saptarshi Pal, Miguel Figueira, Pratik Dabhade, Anna Durkalec, Aidan P. Cotter, Unnikrishnan Sureshkumar, Nandini Hazra, Patryk Matera, Subhrata Dey, Michal Vr\'abel, Anirban Dutta, Henry Willems, Nicola Principi Cavaterra, Natalia Dobrowolska, Wojciech Knop

7. [One Merge to Rule Them All: From Galaxy Interactions to Black Hole Mergers Using Horizon-AGN](#user-content-link7)
**Authors:** Ecaterina Leonova, Marta Volonteri, Clotilde Laigle, Samaya Nissanke, Pascal A. Oesch, Yohan Dubois

8. [First Light And Reionization Epoch Simulations (FLARES) XXI: The UV Indices of Galaxies in the Early Universe](#user-content-link8)
...
9. [The HAges Catalog: Stellar Ages for High Priority HWO Target Stars](#user-content-link9)
**Authors:** Austin T. Ware, Katelyn Ruppert, Patrick A. Young

10. [A Spatially Resolved HI Survey of Seyfert Galaxies: the Role of AGN Feedback in Shaping Atomic Gas Reservoirs](#user-content-link10)
...
11. [Strong Progenitor Age Bias in Supernova Cosmology. III. Progenitor Age as the Physical Origin of the Type Ia Supernova Magnitude Steps with Host Properties](#user-content-link11)
**Authors:** Seunghyun Park, Young-Wook Lee, Chul Chung, Suk-Jin Yoon, Junhyuk Son, Hyejeon Cho, Young-Lo Kim

12. [Probing nonlinear structure formation beyond $\Lambda$CDM with the LSS bootstrap: a joint power spectrum and bispectrum analysis](#user-content-link12)
**Authors:** Giorgia Biselli, Marco Marinucci, Guido D'Amico, Massimo Pietroni

13. [The Accretion Process on Protostars](#user-content-link13)
**Authors:** Eleonora Fiorellino, Alice Somigliana

14. [Tracing the sulfur depletion in starless and pre-stellar cores](#user-content-link14)
**Authors:** L. Sch\"oller, S. Spezzano, O. Sipil\"a, E. I. Makarenko, P. Caselli, H. A. Bunn, S. S. Jensen

15. [How much dark matter really matters?](#user-content-link15)
**Authors:** Jenny Wagner

16. [Quantitative Spectroscopic Diagnostics for FU Orionis-Type Young Stellar Objects](#user-content-link16)
**Authors:** Evan R. Portnoi, Lynne A. Hillenbrand, Adolfo S. Carvalho

17. [UNIONS-3500 Weak Lensing: I. A Galaxy Shape Catalogue in the Northern Sky](#user-content-link17)
...
18. [SIMPLIFI -- Study of Interstellar Magnetic Polarization: a Legacy Investigation of Filaments. I. Magnetically-Guided Accretion onto the DR21 Ridge](#user-content-link18)
...
19. [Global and Local Infall in the ASHES Sample (GLASHES). II. Asymmetric Line Profiles around Dense Cores in 70 $\mu$m Dark Massive Clumps](#user-content-link19)
**Authors:** Kaho Morii, Patricio Sanhueza, Qizhou Zhang, James M. Jackson

20. [The Gravitational Spectral Radio Forest: A Signature of Primordial Black Holes](#user-content-link20)
**Authors:** P. George Christopher (IIT Bombay), K. Hari (IIT Bombay), S. Shankaranarayanan (IIT Bombay)

21. [Jets from Scratch: A 3D Dynamo Origin of Long Gamma-Ray Burst Jets](#user-content-link21)
**Authors:** Ho-Sang Chan, Ore Gottlieb, Jonatan Jacquemin-Ide, Matteo Cantiello, Mathieu Renzo

22. [Ariel stellar characterisation IV. Fundamental parameters of 18 hot stars in the Ariel mission candidate sample](#user-content-link22)
**Authors:** H. Ramler, S. P. D. Borthakur, C. P. Folsom, D. Bossini, A. Lehtmets, C. Danielski, D. Turrini, M. Benito, M. Tsantaki, L. Magrini, N. Moedas, K. Biazzo, R. da Silva, M. Kama, E. Siimon, V. Mitrokhina, K. G. He{\l}miniak, S. Benatti, M. Rainer

23. [A New WZ Sagittae-type Dwarf Nova KSP-OT-202104a Near the Period Minimum from the KMTNet Supernova Program](#user-content-link23)
**Authors:** Sang Chul Kim, Youngdae Lee, Dae-Sik Moon, Hong Soo Park, Yuan Qi Ni, Nan Jiang, Hyobin Im

24. [Photometric metallicity of Galactic RR Lyrae stars in the Gaia DR3 era](#user-content-link24)
**Authors:** Mahiguhappriyaprakash, Susmita Das, Harinder P. Singh, Nitesh Kumar

25. [Diversity in Evolutionary Status and Magnetic Activity among Solar-Type Twin Detached Eclipsing Binaries](#user-content-link25)
**Authors:** Fang-Bin Meng, Li-Ying Zhu, Sheng-Bang Qian, Lin-Jia Li, David Mkrtichian, Nian-Ping Liu, Ahmet Dervi\c{s}o\u{g}lu, Er-Gang Zhao, Boonrucksar Soonthornthum, Sergey Zvyagintsev, Somsawat Rattanasoon, Jia Zhang

26. [UNIONS-3500 Weak Lensing: IV. 2D cosmological constraints in harmonic space](#user-content-link26)
**Authors:** S. Guerrini, L. W. K. Goh, F. Hervas-Peters, C. Daley, M. Kilbinger, A. Wittje, C. Murray, S. Fabbro, H. Hildebrandt, M. J. Hudson, L. van Waerbeke, A. H. Wright, T. de Boer, J. -C. Cuillandre, E. Magnier, A. W. McConnachie

27. [Calorimetric approach to paleo-detection of dark matter](#user-content-link27)
**Authors:** Samuel Hedges, Patrick Huber

28. [The impact of flickering variability and magnetisation on the dynamics, stability and morphology of radio-loud AGN jets](#user-content-link28)
**Authors:** Emma L. Elley, James H. Matthews, Henry Whitehead, Alex J. Cooper

29. [On the Reparameterization Between Cartesian Position-Velocity Vectors and Orbital Elements in the Kepler Problem](#user-content-link29)
**Authors:** Kento Masuda, Kansuke Nunota

30. [Inspiral gravitational waveforms from charged compact binaries with scalar hair](#user-content-link30)
**Authors:** Antonio De Felice, Shinji Tsujikawa

31. [A New PSF Deconvolution Algorithm: Simultaneous Spatial Resolution Enhancement and Point Source Removal for Morphological Analysis of AGN Host Galaxies](#user-content-link31)
**Authors:** Ren Kawase, Takatoshi Shibuya, Kazunori Matsuda

32. [Magnetar-powered long gamma-ray bursts and connection to superluminous supernovae and fast radio bursts](#user-content-link32)
**Authors:** Yu-Qi Zhou, Shuang-Xi Yi, Yu-Peng Yang, Yan-Kun Qu, Ning Gai, Yan-Ke Tang, Fa-Yin Wang

33. [COOL-LAMPS IX: A Rare Duo of Quasars Each Lensed by a Single Massive Galaxy Cluster](#user-content-link33)
**Authors:** Erik Solhaug, Michael D. Gladders, Andi M. Kisare, Simon D. Mork, Matthew B. Bayliss, Aidan P. Cloonan, H{\aa}kon Dahle, Isaiah R. Escapa, Michael K. Florian, Gourav Khullar, Guillaume Mahler, Natalie Malagon, Kate Napier, Allison Noble, Jane R. Rigby, Riley Rosener, T. Emil Rivera-Thorsen, Keren Sharon, Antony A. Stark, Kabelo Tsiane, Grace C. Wagner, Brian Welch, Yifan "Megan" Zhao

34. [Survival of Molecular Complexity under Recent Supernova Feedback: Detection of Hot Cores in RX J1713.7-3946](#user-content-link34)
**Authors:** Takashi Shimonishi, Hidetoshi Sano, Kenji Furuya, Yoko Oya

35. [DEFROST: Detecting Excess in Faraday Rotation thrOugh Sophisticated analysis Techniques](#user-content-link35)
**Authors:** Valentina Vacca, Sebastian Hutschenreuter, Andrea Cabriolu, Torsten A. Ensslin, Jakob Roth, Martin Reineke, Philipp Frank, Federica Govoni, Matteo Murgia, Gianni Fenu

36. [The Very Late Time Afterglow of GW170817 Favors a Wobbling Jet](#user-content-link36)
**Authors:** Hao Wang, Ore Gottlieb, Aman Katira, Muskan Yadav, Lei Lei, Yi-Zhong Fan, Da-Ming Wei

37. [Machine-learning applications for weak-lensing cosmology](#user-content-link37)
**Authors:** Masato Shirasaki

38. [Discovery and Characterization of White Dwarf-FGK Main-Sequence Binaries within the Optical Main-Sequence Locus](#user-content-link38)
**Authors:** Mingkuan Yang, Hailong Yuan, Xiaozhen Yang, Zhongrui Bai, Yuji He, Jianping Xiong, Jiao Li, Mengxin Wang, Yiqiao Dong, Ziyue Jiang, Qian Liu, Ganyu Li, Ming Zhou, Haotong Zhang, Xuefei Chen

39. [VLTI/PIONIER imaging of post-AGB binaries. An INSPIRING hunt for inner rim substructures in circumbinary discs](#user-content-link39)
**Authors:** Toon De Prins, Akke Corporaal, Jacques Kluska, Devika Kamath, Hans Van Winckel, Kateryna Andrych, Javier Alcolea, Narsireddy Anugu, Jean-Philippe Berger, Valentin Bujarrabal, Ivan Gallardo Cava, Stefan Kraus, Hans Olofsson

40. [The flare and spiral structure of the Milky Way's disc as traced by young giant stars](#user-content-link40)
**Authors:** E. Poggio, R. Drimmel, S. Khanna, R. Andrae, M. G. Lattanzi

41. [Minimal Majoron Dark Matter](#user-content-link41)
**Authors:** Kensuke Akita, Koichi Hamaguchi, Haruto Kitagawa, Tatsuya Yokoyama

42. [UNIONS-3500 Weak Lensing: III. 2D Cosmological Constraints in Configuration Space](#user-content-link42)
...
43. [Radio sirens: inferring $H_0$ with binary black holes and neutral hydrogen in the era of the Einstein Telescope and the SKA Observatory](#user-content-link43)
**Authors:** Ulyana Dupletsa, Simone Mastrogiovanni, Marta Spinelli, Tommaso Ronconi, Matteo Schulz, Riccardo Murgia, Jan Harms, Tessa Baker, Matteo Calabrese, Carmelita Carbone, Steven Cunnington, Ian Harrison, Konstantin Leyde, Dounia Nanadoumgar-Lacroze

44. [Latent-Space Gaussian Processes for Dark-Energy Reconstruction from Observational \(H(z)\) Data](#user-content-link44)
**Authors:** Jia-yan Jiang, Wei Hong, Tong-jie Zhang

45. [Guitar Nebula: extreme accelerator in extreme environment](#user-content-link45)
**Authors:** Igor Nikolaevich Nikonorov, Maxim Vladimirovich Barkov, Maxim Lyutikov

46. [Inpainting over the cracks: challenges of applying pre-merger searches for massive black hole binaries to realistic LISA datasets](#user-content-link46)
**Authors:** Gareth Cabourn Davies, Ian Harry

47. [Forbidden Formation Histories: The Binary Black Hole Merger Rate Disfavors Long Delay Times](#user-content-link47)
**Authors:** Aryanna Schiebelbein-Zwack, Maya Fishbach

48. [No evidence for phantom crossing: local goodness-of-fit improvements do not persist under global Bayesian model comparison](#user-content-link48)
**Authors:** Bikash R. Dinda, Roy Maartens, Shun Saito

49. [Revisiting the ultraviolet spectroscopy of the eta Tel edge-on debris disk](#user-content-link49)
...
50. [On the Numerical Stability of the Diffusion Coefficient in Microscopic Simulations](#user-content-link50)
**Authors:** Vladimir Yurovsky, Ilya Kudryashov

51. [Comparative analysis of missing data imputation methods for CSST survey: Impact on photometric redshift estimation performance](#user-content-link51)
...
52. [Revisiting constraints on primordial vector modes and implications for sourced magnetic fields and observed $EB$ power spectrum](#user-content-link52)
**Authors:** Kaito Yura, Shohei Saga, Shuichiro Yokoyama, Kiyotomo Ichiki

53. [Secondary Gravitational Wave Signatures from 5D Rotating Primordial Black Holes in the Dark Dimension](#user-content-link53)
**Authors:** Waqas Ahmed, George K. Leontaris

54. [Earth Science Foundation Models: From Perception to Reasoning and Discovery](#user-content-link54)
...
55. [Tidal disruption of a low-mass star in an active galactic nucleus as the origin of the PS16dtm outburst](#user-content-link55)
**Authors:** Marzena \'Sniegowska, Bo\.zena Czerny, Michal Zaja\v{c}ek, Valentina Rosa, Vladim\'ir Karas, Taj Jankovi\v{c}, Tanja Petrushevska, Dragana Ili\'c, Benny Trakhtenbrot, Petr Kurf\"urst

56. [Tracking down the broadband polarimetric properties of PG 1553+113](#user-content-link56)
**Authors:** Riccardo Middei, Svetlana G. Jorstad, Alan P. Marscher, Ioannis Liodakis, Matteo Perri, Alessandro Maselli, Stefano Ciprini, Emanuele Nardini, Simonetta Puccetti, Laura Di Gesu, Iv\'an Agudo, Dawoon E. Kim, Ioannis Myserlis, A. Trindade Falc\~ao, D. \L. Kr\'ol, Lucio A. Antonelli, Tommaso Aniello, Pouya M. Kouch, Kari Nilsson, Elina Lindfors, Tapio Pursimo, Francisco Jos\'e Aceituno, V\'ictor Casanova, Gabriel Emery, Juan Escudero Pedrosa, Jorge Otero-Santos, Alfredo Sota, Vilppu Piirola, George A. Borman, Tatiana S. Grishina, Vladimir A. Hagen-Thorn, Evgenia N. Kopatskaya, Elena G. Larionova, Daria A. Morozova, Sergey S. Savchenko, Ekaterina V. Shishkina, Ivan S. Troitskiy, Yulia V. Troitskaya, Andrey A. Vasilyev, Alexey V. Zhovtan, Petra Benke, Lena Debbrecht, Julia Eich, Florian Eppel, Andrea Gokus, Steven H\"ammerich, Jonas He{\ss}d\"orfer, Matthias Kadler, Dana Kirchner, Georgios F. Paraschos, Florian R\"osch, Wladislaw Schulga, Mark Gurwell, Garrett Keating, Ramprasad Rao, Emmanouil Angelakis, Alexander Kraus, Beatriz Ag\'is-Gonz\'alez, Dmitry Blinov, Anastasia Glykopoulou, Sara Capecchiacci, Alberto Floris, Panagiotis Fotis, Alkmini Koukoutsi, John A. Kypriotakis, Dimitrios A. Langis, Dimitrios Rompogiannakis, Aristeidis Polychronakis, Vasiliki Tsioupli, Stavros Vogiatzis, Orestis Zoumpoulakis, Sumie Tochihara, Ryo Imazawa, Mahito Sasada, Yasushi Fukazawa, Koji S. Kawabata, Makoto Uemura, Tsunefumi Mizuno, Tatsuya Nakaoka, Hiroshi Akitaya, Takahiro Akai

57. [Formation of stable exoplanetary systems around pulsars by capture: An exercise in computational classical mechanics](#user-content-link57)
**Authors:** V\'aclav Pavl\'ik, Steven N. Shore, Vladim\'ir Karas, Maty\'a\v{s} Fuksa

58. [Light Propagation Prescriptions for Black Hole Movies](#user-content-link58)
**Authors:** Daniel Rojas-Paternina, Alejandro C\'ardenas-Avenda\~no

59. [Thin Accretion Disks around Rotating Charged Black Holes in an Effective Higher-Curvature Spacetime](#user-content-link59)
**Authors:** Mohammad Hassani, Kourosh Nozari, Sara Saghafi

60. [Quantum Field Theory of Black Hole Perturbations with Backreaction VI. Apparent Horizons, Quasi-Local Mass and Effective Classical Metrics](#user-content-link60)
**Authors:** Jonas Neuser, Thomas Thiemann

61. [Fixing the Renormalization of Inflationary Loops via Ward Identities](#user-content-link61)
**Authors:** Cheng-Jun Fang, Zong-Kuan Guo

62. [Phase-resolved field-space distance bounds in ekpyrotic, bouncing and cyclic cosmologies](#user-content-link62)
**Authors:** Marcin Postolak

63. [Assessing the imprint of eccentricity in GW signatures using two independent waveform models](#user-content-link63)
**Authors:** Natalie Malagon, Richard O'Shaughnessy

64. [Forward Modeling of Dust-Induced Stray Light in Ground-Based Coronagraphs: A Dual-Path Monitoring Approach for High-Precision Inner Corona Observations](#user-content-link64)
**Authors:** Xiande Liu, Xuefei Zhang, Yu Liu, Tengfei Song, Mingyu Zhao, Mingzhe Sun, Feiyang Sha, Jun Fang

65. [On the Apparent Correlation between X-ray and Neutrino Luminosities of Active Galactic Nuclei](#user-content-link65)
**Authors:** Jian-Jun Luo, Ming-Xuan Lu, Yun-Feng Liang

66. [Revisiting the 2021 Outburst of the BHC MAXI J1803-298 Using NICER, NuSTAR, and Insight-HXMT Data](#user-content-link66)
**Authors:** Kaushik Chatterjee, Sujoy K. Nath

67. [Apocalypse When? Solar System Constraints on an Imminent Big Rip](#user-content-link67)
**Authors:** Robert J. Scherrer, Oem Trivedi

68. [Spectropolarimetric analysis of waves linked to FIP](#user-content-link68)
**Authors:** M. Murabito, M. Stangalini

69. [No Measurable Changes in Radio and X-ray Emission Surrounding Glitches in the Young Pulsar PSR J2229+6114](#user-content-link69)
...
70. [Height Variations of Magnetoacoustic Cutoff Frequency in the Solar Atmosphere](#user-content-link70)
**Authors:** Pradeep Kayshap, Gayathri Hegde, Z. E. Musielak, Kris Murawski, Tob{\i}as Felipe

71. [Resonant shear-flow instability in anisotropic supersonic plasmas with heat flux](#user-content-link71)
**Authors:** Namig S. Dzhalilov

72. [Detector for fast wave trains in the solar radio emission](#user-content-link72)
**Authors:** V. A. Dmitriev, E. G. Kupriyanova, A. V. Mikhalchuk

73. [Geodesics Structure and Thermodynamic Properties of Gaussian Black Hole in Quadratic Ricci Scaler Gravity](#user-content-link73)
**Authors:** M. Haditale, B. Malekolkalami

74. [Depth of Maximum of Air-Shower Profiles above 10^17.7 eV Measured with the Fluorescence Detector of the Pierre Auger Observatory](#user-content-link74)
...
## 1. [The Metallicity Distribution of the Ultra-Faint Dwarf Galaxy Segue 1](https://arxiv.org/abs/2605.12810) <a id="link1"></a>
...
**Comment:** This paper is highly relevant to Near-Field Cosmology as it presents new metallicity measurements and the metallicity distribution function for the ultra-faint dwarf galaxy Segue 1. It discusses chemical enrichment and star formation history in a Milky Way satellite, directly matching the core topics. The work is observational and expands the sample size significantly, providing new insights into the chemical evolution of one of the least massive galaxies.
...
## 2. [Tunneling and tidal stripping in multifield ultralight dark matter halos](https://arxiv.org/abs/2605.12589) <a id="link2"></a>
...
**Comment:** This paper discusses tidal stripping and quantum tunneling in ultralight dark matter halos, with a focus on subhalo evolution and implications for low-mass galaxies. The topic is highly relevant to near-field cosmology, as it addresses the evolution and stability of subhalos (which can host dwarf galaxies) and provides new theoretical insights into dark matter models affecting satellite galaxy populations.
...
## 3. [The Panchromatic Hubble Andromeda Southern Treasury (PHAST). II. The Spatially Resolved Recent Star Formation History in M31](https://arxiv.org/abs/2605.12721) <a id="link3"></a>
...
**Comment:** This paper presents spatially resolved star formation histories (SFHs) derived from HST color-magnitude diagrams for M31. This matches the 'Resolved Star Formation Histories' criterion, though M31 is a massive spiral and not a dwarf galaxy, so relevance is high but not maximal.
...
## 4. [The Galaxy Luminosity Functions in ASTRID: Predictions for LSST](https://arxiv.org/abs/2605.13843) <a id="link4"></a>
...
**Comment:** This paper presents galaxy luminosity functions and photometric predictions using the ASTRID cosmological hydrodynamical simulation, including forward modeling for LSST. The focus on galaxy luminosity functions and use of a new simulation is directly relevant to 'Numerical Galaxy Simulations' and 'Satellite Luminosity Function' criteria. However, the focus is on all galaxies, not specifically dwarfs, so relevance is high but not maximal.
...
## 5. [Full non-LTE multi-level radiative transfer II. The case of a 5-level Ca ii atom with broadened excited levels](https://arxiv.org/abs/2605.13374) <a id="link5"></a>
...
**Comment:** Presents a new method for full non-LTE multi-level radiative transfer for Ca II, including atomic physics and line formation. This fits the 'Stellar Models' criterion, as it presents new theoretical models for stellar atmospheres.
...
## 6. [From DES to KiDS: Domain adaptation for cross-survey detection of low-surface-brightness galaxies](https://arxiv.org/abs/2605.13842) <a id="link6"></a>
...
**Comment:** This paper discusses the identification and characterization of low-surface-brightness galaxies (LSBGs) and ultra-diffuse galaxies (UDGs) across surveys. While it touches on dwarf galaxies and their properties, the main focus is on detection methodology and catalog construction rather than resolved star formation histories, quenching, or near-field cosmology. However, the environmental trends and connection to the dwarf galaxy population provide some relevance, though not a perfect match to the core topics.
...
## 7. [One Merge to Rule Them All: From Galaxy Interactions to Black Hole Mergers Using Horizon-AGN](https://arxiv.org/abs/2605.12599) <a id="link7"></a>
...
**Comment:** This paper presents analysis of galaxy and black hole merger rates using the Horizon-AGN simulation. While it involves numerical galaxy simulations (criterion 5), the focus is on galaxy interactions and black hole mergers, primarily for higher-mass galaxies. There is no specific focus on dwarf galaxies, near-field cosmology, or resolved star formation histories. The simulation aspect is relevant but not central to the core topics.
...
## 8. [First Light And Reionization Epoch Simulations (FLARES) XXI: The UV Indices of Galaxies in the Early Universe](https://arxiv.org/abs/2605.13472) <a id="link8"></a>
...
**Comment:** This paper uses cosmological simulations (FLARES) and synthetic spectral modeling to study UV indices as tracers of metallicity and star formation histories in high-redshift galaxies. While it involves simulations and star formation histories, the focus is on high-redshift, massive galaxies, not on resolved star formation histories of dwarfs or near-field cosmology. Some peripheral relevance due to simulation and SFH analysis.
...
## 9. [The HAges Catalog: Stellar Ages for High Priority HWO Target Stars](https://arxiv.org/abs/2605.12647) <a id="link9"></a>
...
**Comment:** This paper presents a catalog of stellar ages for stars targeted by the Habitable Worlds Observatory, focusing on asteroseismology and gyrochronology. While it involves stellar ages and models, it does not present new stellar evolutionary or atmosphere models, nor does it focus on galaxies or their star formation histories. Only borderline relevance due to the focus on stellar ages.
...
## 10. [A Spatially Resolved HI Survey of Seyfert Galaxies: the Role of AGN Feedback in Shaping Atomic Gas Reservoirs](https://arxiv.org/abs/2605.12973) <a id="link10"></a>
...
**Comment:** This paper presents a spatially resolved HI survey of Seyfert galaxies, focusing on the impact of AGN feedback on atomic gas reservoirs. While it discusses gas outflows and feedback, the focus is on AGN-driven effects in massive galaxies, not star-formation-driven outflows or the CGM of dwarf galaxies. Only a weak peripheral connection to the 'Star Formation Driven Outflows' and 'Circumgalactic Medium' criteria.
...
## 11. [Strong Progenitor Age Bias in Supernova Cosmology. III. Progenitor Age as the Physical Origin of the Type Ia Supernova Magnitude Steps with Host Properties](https://arxiv.org/abs/2605.12596) <a id="link11"></a>
...
**Comment:** Examines the progenitor age bias in SN Ia cosmology and its effect on host galaxy correlations. While it discusses galaxy properties and star formation rates, it does not focus on resolved SFHs, dwarf galaxies, or other core topics.
...
## 12. [Probing nonlinear structure formation beyond $\Lambda$CDM with the LSS bootstrap: a joint power spectrum and bispectrum analysis](https://arxiv.org/abs/2605.13298) <a id="link12"></a>
...
**Comment:** This paper presents a model-independent framework for probing nonlinear structure formation beyond LambdaCDM using galaxy power spectrum and bispectrum analyses. While it involves galaxy surveys and structure formation, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations with new physics. It is only tangentially related to the core topics.
...
## 13. [The Accretion Process on Protostars](https://arxiv.org/abs/2605.13189) <a id="link13"></a>
...
**Comment:** Review of accretion processes in protostars, including observational and numerical perspectives. While related to star formation, it does not focus on resolved star formation histories of galaxies, galaxy simulations, or other core topics.
...
## 14. [Tracing the sulfur depletion in starless and pre-stellar cores](https://arxiv.org/abs/2605.13635) <a id="link14"></a>
...
**Comment:** Observational study of sulfur-bearing molecules in starless and pre-stellar cores, with implications for sulfur chemistry and depletion. While it addresses early star formation environments, it does not focus on resolved star formation histories of galaxies, galaxy simulations, or other core topics.
...
## 15. [How much dark matter really matters?](https://arxiv.org/abs/2605.12593) <a id="link15"></a>
...
**Comment:** This essay discusses the role of dark matter in strong gravitational lensing and critiques mass modeling assumptions. While it touches on dark matter, it does not focus on the core topics such as near-field cosmology, satellite galaxies, or galaxy simulations.
...
## 16. [Quantitative Spectroscopic Diagnostics for FU Orionis-Type Young Stellar Objects](https://arxiv.org/abs/2605.12795) <a id="link16"></a>
...
**Comment:** Presents spectroscopic diagnostics for FU Orionis-type young stellar objects. While it discusses stellar accretion and disk winds, it does not present new stellar models or address the other core topics.
...
## 17. [UNIONS-3500 Weak Lensing: I. A Galaxy Shape Catalogue in the Northern Sky](https://arxiv.org/abs/2605.13549) <a id="link17"></a>
...
**Comment:** This is a weak lensing galaxy shape catalogue for cosmic shear cosmology. While it involves galaxy statistics, it does not focus on the properties of dwarf galaxies, resolved star formation histories, or galaxy simulations relevant to the criteria.
...
## 18. [SIMPLIFI -- Study of Interstellar Magnetic Polarization: a Legacy Investigation of Filaments. I. Magnetically-Guided Accretion onto the DR21 Ridge](https://arxiv.org/abs/2605.12604) <a id="link18"></a>
...
**Comment:** This paper presents polarimetric observations of magnetic fields in a Galactic molecular cloud filament and discusses magnetically-guided accretion. While it is relevant to star formation in the ISM, it does not focus on galaxies, resolved star formation histories, or galaxy simulations.
...
## 20. [The Gravitational Spectral Radio Forest: A Signature of Primordial Black Holes](https://arxiv.org/abs/2605.13042) <a id="link20"></a>
...
**Comment:** Proposes a novel method to detect primordial black holes using interstellar hydrogen as a quantum sensor. While innovative, it does not address any of the core topics.
...
## 21. [Jets from Scratch: A 3D Dynamo Origin of Long Gamma-Ray Burst Jets](https://arxiv.org/abs/2605.12931) <a id="link21"></a>
...
**Comment:** This paper presents 3D GRMHD simulations of jet formation in collapsars (long GRBs). While it involves galaxy-scale phenomena, it does not focus on galaxies, star formation histories, or stellar models, and is not relevant to the specified criteria.
...
## 22. [Ariel stellar characterisation IV. Fundamental parameters of 18 hot stars in the Ariel mission candidate sample](https://arxiv.org/abs/2605.12644) <a id="link22"></a>
...
**Comment:** This paper focuses on the characterization of hot stars for exoplanet host studies, using stellar models and evolutionary tracks. While it involves stellar models, the focus is on parameter determination for exoplanet studies, not on new stellar evolutionary or atmosphere models. Only a weak connection to the 'Stellar Models' criterion.
...
## 23. [A New WZ Sagittae-type Dwarf Nova KSP-OT-202104a Near the Period Minimum from the KMTNet Supernova Program](https://arxiv.org/abs/2605.12722) <a id="link23"></a>
...
**Comment:** This paper presents observations of a new WZ Sge-type dwarf nova. While it discusses a dwarf system, the focus is on accretion physics and binary evolution, not on dwarf galaxies, near-field cosmology, or star formation histories. No direct match to the criteria.
...
## 25. [Diversity in Evolutionary Status and Magnetic Activity among Solar-Type Twin Detached Eclipsing Binaries](https://arxiv.org/abs/2605.13212) <a id="link25"></a>
...
**Comment:** Analysis of solar-type twin detached eclipsing binaries, focusing on evolutionary status and magnetic activity. While it provides stellar parameters, it does not present new stellar models or evolutionary tracks, nor does it address the other core topics.
...
## 26. [UNIONS-3500 Weak Lensing: IV. 2D cosmological constraints in harmonic space](https://arxiv.org/abs/2605.13543) <a id="link26"></a>
...
**Comment:** This paper focuses on weak lensing cosmological constraints using the UNIONS survey. While it involves galaxy surveys and cosmic structure, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy properties, or galaxy simulations. No direct match to the specified criteria.
...
## 27. [Calorimetric approach to paleo-detection of dark matter](https://arxiv.org/abs/2605.13659) <a id="link27"></a>
...
**Comment:** This paper presents a new method for paleo-detection of dark matter using calorimetric readout in minerals. While it is related to dark matter detection, it does not focus on near-field cosmology, dwarf galaxies, or any of the core topics. No direct match to the criteria.
...
## 28. [The impact of flickering variability and magnetisation on the dynamics, stability and morphology of radio-loud AGN jets](https://arxiv.org/abs/2605.13469) <a id="link28"></a>
...
**Comment:** This paper presents relativistic MHD simulations of AGN jets, focusing on jet morphology, magnetization, and variability. It does not address galaxy-scale simulations, star formation, or any of the core topics.
...
## 29. [On the Reparameterization Between Cartesian Position-Velocity Vectors and Orbital Elements in the Kepler Problem](https://arxiv.org/abs/2605.12982) <a id="link29"></a>
...
**Comment:** Presents analytic results for reparameterization between orbital elements and Cartesian vectors, with applications to microlensing and astrometric orbit fitting. While useful for orbit inference, it does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 30. [Inspiral gravitational waveforms from charged compact binaries with scalar hair](https://arxiv.org/abs/2605.13036) <a id="link30"></a>
...
**Comment:** Studies gravitational waveforms from charged compact binaries with scalar hair in modified gravity theories. While relevant to gravitational wave astrophysics and tests of gravity, it does not address any of the core topics (no focus on galaxies, star formation, or stellar models).
...
## 31. [A New PSF Deconvolution Algorithm: Simultaneous Spatial Resolution Enhancement and Point Source Removal for Morphological Analysis of AGN Host Galaxies](https://arxiv.org/abs/2605.13735) <a id="link31"></a>
...
**Comment:** Presents a new PSF deconvolution algorithm for AGN host galaxy imaging. While relevant for galaxy morphology studies, it does not address any of the core topics such as near-field cosmology, resolved SFHs, quenching, stellar models, or galaxy simulations.
...
## 32. [Magnetar-powered long gamma-ray bursts and connection to superluminous supernovae and fast radio bursts](https://arxiv.org/abs/2605.13440) <a id="link32"></a>
...
**Comment:** Statistical study of magnetar-powered long GRBs and their connection to SLSNe and FRBs. While it discusses compact objects and their birth properties, it does not address any of the core topics.
...
## 33. [COOL-LAMPS IX: A Rare Duo of Quasars Each Lensed by a Single Massive Galaxy Cluster](https://arxiv.org/abs/2605.13514) <a id="link33"></a>
...
**Comment:** This paper reports the discovery of two quasars lensed by a massive galaxy cluster. The focus is on strong lensing and quasar/cluster-scale phenomena, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 35. [DEFROST: Detecting Excess in Faraday Rotation thrOugh Sophisticated analysis Techniques](https://arxiv.org/abs/2605.13605) <a id="link35"></a>
...
**Comment:** This paper presents a new algorithm for disentangling Galactic and extragalactic Faraday rotation contributions to study cosmological magnetic fields. While it involves extragalactic environments, it does not focus on galaxies, their star formation histories, or the circumgalactic medium of dwarf galaxies. Not relevant to the core topics.
...
## 36. [The Very Late Time Afterglow of GW170817 Favors a Wobbling Jet](https://arxiv.org/abs/2605.13719) <a id="link36"></a>
...
**Comment:** This paper analyzes the late-time afterglow of GW170817 and proposes a wobbling jet model. While it is an important result for GRB and neutron star merger studies, it does not address galaxies, star formation histories, or any of the core topics.
...
## 37. [Machine-learning applications for weak-lensing cosmology](https://arxiv.org/abs/2605.12877) <a id="link37"></a>
...
**Comment:** This is a review of machine learning applications in weak-lensing cosmology. While weak lensing is important for large-scale structure and dark matter studies, the paper does not focus on galaxies, their star formation histories, or any of the core topics.
...
## 38. [Discovery and Characterization of White Dwarf-FGK Main-Sequence Binaries within the Optical Main-Sequence Locus](https://arxiv.org/abs/2605.13112) <a id="link38"></a>
...
**Comment:** The paper presents a catalog of white dwarf + FGK main-sequence binaries, focusing on binary evolution and the formation of low-mass white dwarfs. It does not address galaxy-scale topics, resolved star formation histories, or simulations of galaxies.
...
## 39. [VLTI/PIONIER imaging of post-AGB binaries. An INSPIRING hunt for inner rim substructures in circumbinary discs](https://arxiv.org/abs/2605.13445) <a id="link39"></a>
...
**Comment:** This paper presents high-resolution imaging of post-AGB circumbinary discs, focusing on disc morphology and substructures. It does not address galaxy-scale topics, star formation histories, or simulations.
...
## 40. [The flare and spiral structure of the Milky Way's disc as traced by young giant stars](https://arxiv.org/abs/2605.12603) <a id="link40"></a>
...
**Comment:** Focuses on the structure of the Milky Way's disk, spiral arms, and vertical structure traced by young giant stars. This is not relevant to near-field cosmology as defined (which excludes Milky Way disk/bar/center studies), nor does it address dwarf galaxies, resolved star formation histories, or other core topics.
...
## 41. [Minimal Majoron Dark Matter](https://arxiv.org/abs/2605.12946) <a id="link41"></a>
...
**Comment:** Theoretical study of Majoron dark matter in the context of the seesaw mechanism and leptogenesis. While dark matter is broadly relevant to cosmology, this work does not address near-field cosmology, galaxy structure, or any of the core topics.
...
## 42. [UNIONS-3500 Weak Lensing: III. 2D Cosmological Constraints in Configuration Space](https://arxiv.org/abs/2605.13547) <a id="link42"></a>
...
**Comment:** This paper presents cosmological constraints from weak lensing using a large photometric survey. It does not focus on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM. No criteria match closely.
...
## 43. [Radio sirens: inferring $H_0$ with binary black holes and neutral hydrogen in the era of the Einstein Telescope and the SKA Observatory](https://arxiv.org/abs/2605.12606) <a id="link43"></a>
...
**Comment:** This paper focuses on using gravitational wave events and neutral hydrogen intensity mapping to constrain the Hubble constant. While it involves large-scale structure and cosmology, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. No direct relevance to the specified criteria.
...
## 44. [Latent-Space Gaussian Processes for Dark-Energy Reconstruction from Observational \(H(z)\) Data](https://arxiv.org/abs/2605.13427) <a id="link44"></a>
...
**Comment:** This paper develops a Bayesian Gaussian-process framework for reconstructing dark energy properties from Hubble parameter data. While it is a methodological advance in cosmology, it does not address galaxies, star formation histories, or any of the core topics.
...
## 45. [Guitar Nebula: extreme accelerator in extreme environment](https://arxiv.org/abs/2605.13697) <a id="link45"></a>
...
**Comment:** This paper studies the Guitar Nebula, a bow-shock pulsar wind nebula, focusing on particle acceleration and ISM structure. It does not address galaxies, star formation histories, galaxy simulations, or any of the other core topics.
...
## 46. [Inpainting over the cracks: challenges of applying pre-merger searches for massive black hole binaries to realistic LISA datasets](https://arxiv.org/abs/2605.13738) <a id="link46"></a>
...
**Comment:** This paper discusses pre-merger searches for massive black hole binaries in LISA datasets. It is not relevant to the specified galaxy or star formation criteria.
...
## 47. [Forbidden Formation Histories: The Binary Black Hole Merger Rate Disfavors Long Delay Times](https://arxiv.org/abs/2605.12858) <a id="link47"></a>
...
**Comment:** This paper analyzes the binary black hole merger rate and delay time distributions, focusing on gravitational wave sources. It does not address galaxies, star formation histories, or stellar models.
...
## 49. [Revisiting the ultraviolet spectroscopy of the eta Tel edge-on debris disk](https://arxiv.org/abs/2605.12627) <a id="link49"></a>
...
**Comment:** Ultraviolet spectroscopy of the eta Tel debris disk, focusing on gas abundances and disk winds. This is a study of a debris disk around an A-type star, not related to the core topics.
...
## 50. [On the Numerical Stability of the Diffusion Coefficient in Microscopic Simulations](https://arxiv.org/abs/2605.12637) <a id="link50"></a>
...
**Comment:** This paper discusses the numerical stability of diffusion coefficient calculations in microscopic simulations of Galactic Cosmic Rays. While it involves numerical simulations and cosmic rays, it does not focus on galaxies, their star formation histories, or any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. Therefore, it is not relevant.
...
## 51. [Comparative analysis of missing data imputation methods for CSST survey: Impact on photometric redshift estimation performance](https://arxiv.org/abs/2605.13219) <a id="link51"></a>
...
**Comment:** This paper evaluates missing data imputation methods for photometric redshift estimation in galaxy surveys. While relevant to survey methodology, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. No direct match to the specified criteria.
...
## 53. [Secondary Gravitational Wave Signatures from 5D Rotating Primordial Black Holes in the Dark Dimension](https://arxiv.org/abs/2605.12948) <a id="link53"></a>
...
**Comment:** This paper discusses gravitational wave signatures from 5D rotating primordial black holes as dark matter candidates. It does not address any of the core topics.
...
## 54. [Earth Science Foundation Models: From Perception to Reasoning and Discovery](https://arxiv.org/abs/2605.12542) <a id="link54"></a>
...
**Comment:** A review of large foundation models for Earth science, covering multimodal data and AI applications. This is not relevant to any of the astrophysics or galaxy-related core topics.
...
## 55. [Tidal disruption of a low-mass star in an active galactic nucleus as the origin of the PS16dtm outburst](https://arxiv.org/abs/2605.13799) <a id="link55"></a>
...
**Comment:** Analysis of a tidal disruption event in an AGN. TDEs are explicitly listed as irrelevant in the criteria.
...
## 56. [Tracking down the broadband polarimetric properties of PG 1553+113](https://arxiv.org/abs/2605.12602) <a id="link56"></a>
...
**Comment:** Broadband polarimetric monitoring of a blazar. No connection to the core topics such as near-field cosmology, resolved SFHs, quenching, stellar models, or galaxy simulations.
...
## 57. [Formation of stable exoplanetary systems around pulsars by capture: An exercise in computational classical mechanics](https://arxiv.org/abs/2605.12591) <a id="link57"></a>
...
**Comment:** Simulates the capture and long-term stability of exoplanets around pulsars. This is not related to any of the core topics.
...
## 58. [Light Propagation Prescriptions for Black Hole Movies](https://arxiv.org/abs/2605.12659) <a id="link58"></a>
...
**Comment:** This paper focuses on light propagation prescriptions for black hole imaging and movies, which is not relevant to any of the specified criteria (no connection to galaxies, star formation histories, or stellar models).
...
## 59. [Thin Accretion Disks around Rotating Charged Black Holes in an Effective Higher-Curvature Spacetime](https://arxiv.org/abs/2605.13797) <a id="link59"></a>
...
**Comment:** This paper investigates thin accretion disks around rotating charged black holes in modified gravity. It does not address galaxies, star formation, or stellar models as per the criteria.
...
## 60. [Quantum Field Theory of Black Hole Perturbations with Backreaction VI. Apparent Horizons, Quasi-Local Mass and Effective Classical Metrics](https://arxiv.org/abs/2605.13714) <a id="link60"></a>
...
**Comment:** This paper is focused on quantum field theory of black hole perturbations and their horizons. It does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 61. [Fixing the Renormalization of Inflationary Loops via Ward Identities](https://arxiv.org/abs/2605.13325) <a id="link61"></a>
...
**Comment:** This paper discusses renormalization in inflationary loop corrections using Ward identities. It is focused on early universe theory and does not address any of the core topics.
...
## 62. [Phase-resolved field-space distance bounds in ekpyrotic, bouncing and cyclic cosmologies](https://arxiv.org/abs/2605.12579) <a id="link62"></a>
...
**Comment:** This paper is focused on theoretical aspects of non-inflationary cosmologies (ekpyrotic, bouncing, cyclic) and field-space distance bounds. It does not address galaxies, star formation histories, or any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 63. [Assessing the imprint of eccentricity in GW signatures using two independent waveform models](https://arxiv.org/abs/2605.12818) <a id="link63"></a>
...
**Comment:** This paper analyzes gravitational wave signals from compact binary mergers, focusing on orbital eccentricity. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 64. [Forward Modeling of Dust-Induced Stray Light in Ground-Based Coronagraphs: A Dual-Path Monitoring Approach for High-Precision Inner Corona Observations](https://arxiv.org/abs/2605.12979) <a id="link64"></a>
...
**Comment:** This paper presents a method for correcting dust-induced stray light in ground-based coronagraphs for solar observations. It is focused on solar physics instrumentation and does not address any of the core topics.
...
## 65. [On the Apparent Correlation between X-ray and Neutrino Luminosities of Active Galactic Nuclei](https://arxiv.org/abs/2605.13588) <a id="link65"></a>
...
**Comment:** This paper investigates the correlation between X-ray and neutrino luminosities in AGN, focusing on selection effects. It does not address any of the core topics.
...
## 66. [Revisiting the 2021 Outburst of the BHC MAXI J1803-298 Using NICER, NuSTAR, and Insight-HXMT Data](https://arxiv.org/abs/2605.13232) <a id="link66"></a>
...
**Comment:** This paper is a study of a black hole candidate outburst and accretion flow using X-ray timing and spectral analysis. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 67. [Apocalypse When? Solar System Constraints on an Imminent Big Rip](https://arxiv.org/abs/2605.13705) <a id="link67"></a>

**ArXiv ID:** 2605.13705

**Authors:** Robert J. Scherrer, Oem Trivedi

**Abstract:** Phantom dark energy models with an equation of state parameter $w < -1$ lead generically to a future big rip singularity, in which the dark energy density becomes infinite in a finite time. Current limits on dark energy constrain $w$ to be close to $-1$, and if $w$ is assumed constant, then a future big rip cannot occur in less than the order of a Hubble time in the future. However, many models allow $w$ to decrease rapidly with time. In that case, or if one assumes an additional phantom component with current energy density far below the dark energy density and $w < 30$ years. While admittedly a poor limit, these results are likely to be improved by future more precise measurements of solar system dynamics. Our results also show that evidence for an imminent big rip would show up first in solar system data, rather than in any cosmological observation.

**Comment:** Addresses constraints on phantom dark energy and the Big Rip using solar system dynamics. This is cosmology, but not near-field cosmology or any of the core topics (no focus on galaxies, star formation, or stellar models).
...
## 68. [Spectropolarimetric analysis of waves linked to FIP](https://arxiv.org/abs/2605.13523) <a id="link68"></a>

**ArXiv ID:** 2605.13523

**Authors:** M. Murabito, M. Stangalini

**Abstract:** High-resolution spectropolarimetry has opened new avenues for understanding how chromospheric waves shape coronal plasma composition. All modeling efforts so far highlight wave activity and, in particular, the ponderomotive force associated to Alfv\'enic perturbations, as a key ingredient. Over recent years, studies based on spectropolarimetric measurements in the solar chromosphere have identified magnetic perturbations associated to waves linked to regions in the corona with enhanced FIP bias. Building on this established framework, the present work explores the diagnostic potential of Stokes V amplitude asymmetries as an alternative diagnostic tool for investigating wave behavior relevant to compositional fractionation processes.

**Comment:** Spectropolarimetric analysis of waves in the solar chromosphere and their effect on coronal plasma composition. This is solar physics and not relevant to the core topics.
...
## 69. [No Measurable Changes in Radio and X-ray Emission Surrounding Glitches in the Young Pulsar PSR J2229+6114](https://arxiv.org/abs/2605.13011) <a id="link69"></a>
...
**Comment:** Focuses on radio and X-ray emission changes in a young pulsar during glitches. No connection to the core topics such as near-field cosmology, resolved SFHs, quenching, stellar models, or galaxy simulations.
...
## 70. [Height Variations of Magnetoacoustic Cutoff Frequency in the Solar Atmosphere](https://arxiv.org/abs/2605.13040) <a id="link70"></a>
...
**Comment:** This paper studies magnetoacoustic cutoff frequencies in the solar atmosphere, which is not relevant to any of the specified criteria.
...
## 71. [Resonant shear-flow instability in anisotropic supersonic plasmas with heat flux](https://arxiv.org/abs/2605.13056) <a id="link71"></a>
...
**Comment:** This paper studies resonant shear-flow instability in anisotropic supersonic plasmas, with applications to solar wind plasma. It does not address galaxies, star formation, or any of the core topics.
...
## 72. [Detector for fast wave trains in the solar radio emission](https://arxiv.org/abs/2605.13728) <a id="link72"></a>
...
**Comment:** This paper presents a machine learning method for detecting fast wave trains in solar radio emission. It is focused on solar physics and does not address any of the core topics.
...
## 73. [Geodesics Structure and Thermodynamic Properties of Gaussian Black Hole in Quadratic Ricci Scaler Gravity](https://arxiv.org/abs/2605.13377) <a id="link73"></a>
...
**Comment:** This paper studies the geodesic structure and thermodynamics of black holes in modified gravity. It does not address galaxies, star formation, or any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 74. [Depth of Maximum of Air-Shower Profiles above 10^17.7 eV Measured with the Fluorescence Detector of the Pierre Auger Observatory](https://arxiv.org/abs/2605.12598) <a id="link74"></a>
...
**Comment:** This paper focuses on cosmic ray air showers and mass composition at ultra-high energies, which is not related to any of the specified core topics such as near-field cosmology, dwarf galaxies, or galaxy evolution. No relevant criteria are matched.
