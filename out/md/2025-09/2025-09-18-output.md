...
9. [A Pearl in the Shell: an ultra-compact dwarf within the tidal debris surrounding spiral galaxy NGC 7531](#user-content-link9)
...
20. [The Galaxy Activity, Torus, and Outflow Survey (GATOS): TBD. Unveiling physical processes in local active galaxies. Unsupervised hierarchical clustering of JWST MIRI/MRS observations](#user-content-link20)
...
26. [Improving cosmological reach of a gravitational wave observatory using Deep Loop Shaping](#user-content-link26)
...
39. [Characterizing the Time Variability of 2M1207 A+b with JWST NIRSpec/PRISM](#user-content-link39)
...
51. [Maximal GW amplitude from bubble collisions in supercooled phase transitions](#user-content-link51)
...
59. [Possible Evidence for the Presence of Volatiles on the Warm Super-Earth TOI-270 b](#user-content-link59)
...
## 2. [A statistical look on kinematic planes of satellite galaxies I: frequency and properties in TNG50 MW/M31-like galaxies](https://arxiv.org/abs/2509.13622) <a id="link2"></a>
...
**Comment:** This paper focuses on main-sequence--white dwarf binaries and barium stars, discussing their formation and evolution. While it deals with binary evolution and stellar abundances, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models. The focus is on binary interaction and s-process enrichment, which is tangential to the core interests.
...
**Comment:** This paper presents simulations of dust coagulation relevant to supernova ejecta and high-redshift dust formation. While it involves numerical simulations, the focus is on dust aggregate structure, not on galaxy-scale simulations or the specified core topics.
...
**Comment:** This paper presents polarization spectrum measurements in star-forming clouds, probing dust grain properties. While it relates to star formation regions, it does not address resolved star formation histories, quenching, or galaxy-scale outflows. Only tangential relevance to stellar models (dust properties), but not a direct match.
...
**Comment:** This paper investigates mass transport and turbulent mixing in black hole accretion flows using GRMHD simulations. The focus is on accretion disks around black holes, not on galaxy simulations, star formation, or near-field cosmology.
...
**Comment:** The paper presents a Bayesian anomaly detection framework for Type Ia supernova cosmology data curation. While it is relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
**Comment:** This paper analyzes cosmic birefringence using CMB polarization data. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on fundamental cosmology and parity violation.
...
## 43. [SuNeRF-CME: Physics-Informed Neural Radiance Fields for Tomographic Reconstruction of Coronal Mass Ejections](https://arxiv.org/abs/2509.13571) <a id="link43"></a>
...
**Comment:** This paper introduces a physics-informed neural radiance field method for tomographic reconstruction of coronal mass ejections (CMEs). The focus is on solar/heliospheric plasma, not on galaxy evolution, dwarf galaxies, or the specified core topics.
...
## 44. [FIVR-NLFFF: A fully-implicit viscous-relaxation code for nonlinear force-free magnetic field extrapolation of the solar corona](https://arxiv.org/abs/2509.13811) <a id="link44"></a>
...
**Comment:** This paper presents a new code for nonlinear force-free magnetic field extrapolation in the solar corona. It is focused on solar physics and magnetic field modeling, with no relevance to galaxy simulations, near-field cosmology, or other core criteria.
...
## 45. [Thermodynamic Split Conjecture and an Observational Test for Cosmological Entropy](https://arxiv.org/abs/2509.13689) <a id="link45"></a>

**ArXiv ID:** 2509.13689

**Authors:** Oem Trivedi

**Abstract:** We revisit string theoretic derivations of black hole entropy and argue that their enabling structures do not persist in realistic cosmologies. We formalize this as the Thermodynamic Split Conjecture (TSC) which is the statement that in any UV complete quantum gravity, black hole and cosmological horizon thermodynamics are generically inequivalent. The BKE criterion is then formulated to formalize this approach while we also discuss ways to falsify the conjecture. Finally, we propose an observational scaling test which is centered around comparisons of data native entropy proxies from tomographic maps to the Bekenstein Hawking prediction. The framework both sharpens when and why the area law holds and provides a roadmap towards a UV complete description of cosmological horizon entropy.

**Comment:** This work discusses the thermodynamics of black hole and cosmological horizons, proposing a conjecture and observational test for cosmological entropy. It is not related to any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 46. [An updated constraint on the Effective Field Theory of Dark Energy](https://arxiv.org/abs/2509.13804) <a id="link46"></a>
...
**Comment:** This paper presents updated constraints on the Effective Field Theory of Dark Energy using cosmological datasets. It is focused on dark energy and modified gravity, not on galaxies, star formation, or near-field cosmology.
...
## 50. [DESI DR1 Ly$\alpha$ 1D power spectrum: Validation of estimators](https://arxiv.org/abs/2509.13593) <a id="link50"></a>
...
**Comment:** This paper validates estimators for the Lyα forest 1D power spectrum using DESI DR1 data. While it involves cosmological simulations and data analysis, it does not focus on galaxies, their satellites, or star formation histories, and thus does not closely match any core criteria.
...
## 51. [Maximal GW amplitude from bubble collisions in supercooled phase transitions](https://arxiv.org/abs/2509.13402) <a id="link51"></a>

**ArXiv ID:** 2509.13402

**Authors:** Masaki Yamada

**Abstract:** We extend analytic formulas for the gravitational-wave (GW) spectrum from first-order phase transitions to include cosmic expansion under the thin-wall and envelope approximations. We demonstrate that even for strongly supercooled transitions the GW amplitude is bounded from above. Moreover, the spectral shape, amplitude, and peak frequency remain largely unaffected by the details of the nucleation rate once expressed in terms of the comformal variables.

**Comment:** Focuses on gravitational wave spectra from cosmological phase transitions, which does not match any of the specified criteria (no connection to galaxies, stellar models, or near-field cosmology).
...
## 52. [Explainable AI-Enhanced Supervisory Control for High-Precision Spacecraft Formation](https://arxiv.org/abs/2509.13331) <a id="link52"></a>
...
**Comment:** This paper discusses AI-enhanced control for spacecraft formation, specifically for the VTXO mission. It is focused on engineering and mission planning, not on galaxy evolution, star formation, or near-field cosmology.
...
## 53. [A simple, flexible method for timing cross-calibration of space missions](https://arxiv.org/abs/2509.13865) <a id="link53"></a>
...
**Comment:** This work presents a method for timing cross-calibration of space missions using pulsar observations. It is technical and instrumental, with no direct relevance to galaxy evolution, near-field cosmology, or the other specified criteria.
...
## 54. [The effect of matter discreteness on gravitational wave propagation in post-geometrical optics](https://arxiv.org/abs/2509.13884) <a id="link54"></a>

**ArXiv ID:** 2509.13884

**Authors:** Sena Atli, Syksy Rasanen

**Abstract:** The gravitational wave equation of motion includes direct coupling to the Riemann tensor. The curvature terms are usually neglected, but they can be large at the location of matter particles and impact the angular diameter distance. We apply the recently introduced post-geometrical optics approximation that includes curvature to gravitational wave propagation. Assuming that particles are localised within their Compton wavelength, the curvature due to electrons leads to a large effect on the angular diameter distance, but caustic formation invalidates the post-geometrical optics approximation. We conclude that the interesting regime of validity of the approximation is limited, as it ceases to apply when the curvature effects become large. Other methods are needed to evaluate the effect of curvature spikes, and the localisation of particles due to decoherence also needs further work.

**Comment:** This paper discusses the effect of matter discreteness on gravitational wave propagation, focusing on curvature effects and the angular diameter distance. The topic is gravitational wave theory, not galaxy simulations or any of the core criteria.
...
## 55. [ARDENT: A Python package for fast dynamical detection limits with radial velocities](https://arxiv.org/abs/2509.13521) <a id="link55"></a>
...
**Comment:** This paper introduces ARDENT, a Python package for refining radial velocity detection limits using N-body stability criteria. The focus is on exoplanet system architecture and detection limits, not on galaxies, star formation, or stellar models.
...
## 57. [First High-Resolution Observations of Chromospheric Swirls with the Dunn Solar Telescope](https://arxiv.org/abs/2509.13461) <a id="link57"></a>
...
**Comment:** Focuses on solar chromospheric swirls and their magnetic origins, which is unrelated to any of the specified criteria (no connection to near-field cosmology, stellar models, galaxy simulations, or dwarf galaxies).
...
## 59. [Possible Evidence for the Presence of Volatiles on the Warm Super-Earth TOI-270 b](https://arxiv.org/abs/2509.14224) <a id="link59"></a>
...
**Comment:** This paper presents JWST observations of a warm super-Earth exoplanet, TOI-270 b, focusing on its atmosphere and volatile content. The work is entirely exoplanet-focused and does not match any of the core criteria (near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 61. [Fermi-LAT Detected Gamma-ray Emission Likely Associated with SNR Kes 78](https://arxiv.org/abs/2509.13812) <a id="link61"></a>
...
**Comment:** This paper analyzes Fermi-LAT gamma-ray emission from the region of SNR Kes 78, focusing on the nature of the emission and possible association with a pulsar. The work is focused on supernova remnants and pulsars, not galaxies or any of the core criteria.
