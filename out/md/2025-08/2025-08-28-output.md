...
9. [The Impact of Radial Migration on Disk Galaxy SFHs: II. The Role of bar strength, disk thickness, and merger history](#user-content-link9)
...
19. [Constraints on dark matter annihilation and turbulent reacceleration set by high-frequency observations of the radio halo in the Coma cluster](#user-content-link19)
...
30. [Euclid: A machine-learning search for dual and lensed AGN at sub-arcsec separations](#user-content-link30)
...
37. [Conformal Weyl Tensor Dynamics and Stability Analysis in Rotating Black Hole Spacetimes: A Novel Approach to Quasinormal Mode Spectra](#user-content-link37)
...
51. [On Ultra-long Period (53.8 min) Pulsar ASKAP J1935+2148: Coherent Radio Emission Triggered by Local Superstrong Magnetic Reconnection](#user-content-link51)
...
64. [Modeling spectral filtering effects on color-matching functions: Implications for observer variability](#user-content-link64)
...
**Comment:** High-resolution cosmological zoom-in simulation of a group of field dwarf galaxies with on-the-fly radiative transfer. Directly matches several criteria: Near-Field Cosmology (focus on dwarf galaxies, satellite abundances, core-cusp), Numerical Galaxy Simulations (new high-res simulation with new physics: radiative transfer), Star Formation Quenching (quenching in ultra-faint dwarfs), and Circumgalactic Medium (CGM properties of dwarfs).
...
**Comment:** Presents new stellar models for lithium depletion in solar analogs and mid-F cluster stars, directly matching the 'Stellar Models' criterion. The work provides theoretical evolutionary tracks and mixing mechanisms relevant to stellar evolution.
...
**Comment:** Presents a new framework for modeling stellar contamination in exoplanet transmission spectra, including stellar atmosphere modeling. Relevant to the 'Stellar Models' criterion as it provides new tools for stellar atmosphere analysis.
...
**Comment:** This paper uses radiative MHD simulations to study the evolution of massive star-forming clumps and calibrates the L/M indicator for star formation efficiency. It matches the 'Numerical Galaxy Simulations' criterion and touches on star formation histories, though the focus is on massive clumps rather than dwarf galaxies.
...
**Comment:** Detailed analysis of the star-forming region Corona Australis, including formation history from stellar and disk analysis. While it discusses star formation history, it is focused on a molecular cloud in the Milky Way and not on resolved star formation histories of galaxies or dwarf galaxies.
...
**Comment:** Observational study of a hyperluminous dust-obscured galaxy (BlueDOG) at z=2.6, focusing on SED analysis and AGN/star formation contributions. The work is on a massive galaxy at high redshift, not on dwarf galaxies, resolved star formation histories, or outflows relevant to the criteria.
...
**Comment:** This paper presents numerical simulations of planetesimal formation in protoplanetary disks. While it is a numerical simulation, the focus is on planet formation, not on galaxy simulations or any of the other core criteria.
...
**Comment:** Numerical simulation of the solar chromosphere with small-scale dynamo-generated magnetic fields. While it is a high-resolution simulation, it focuses on the Sun's atmosphere, not galaxies or stellar models relevant to the criteria.
...
## 37. [Conformal Weyl Tensor Dynamics and Stability Analysis in Rotating Black Hole Spacetimes: A Novel Approach to Quasinormal Mode Spectra](https://arxiv.org/abs/2508.19369) <a id="link37"></a>
...
**Comment:** Presents a novel theoretical framework for black hole stability and quasinormal mode spectra, focusing on conformal Weyl tensor dynamics. This is not relevant to any of the specified criteria (no connection to galaxies, star formation, or stellar models).
...
## 38. [Strong Lens Discoveries in DESI Legacy Imaging Surveys DR10 with Two Deep Learning Architectures](https://arxiv.org/abs/2508.20087) <a id="link38"></a>
...
**Comment:** Strong lensing discoveries in extragalactic surveys; does not focus on dwarf galaxies, near-field cosmology, or any of the core criteria.
...
## 39. [Implications for Pulsar Timing Arrays of Sub-solar Black Hole Detections: From LVK to Einstein Telescope and Cosmic Explorer](https://arxiv.org/abs/2508.19328) <a id="link39"></a>
...
**Comment:** Discusses implications of sub-solar black hole detections and primordial black holes for gravitational wave backgrounds. While it touches on cosmology, it does not address near-field cosmology, dwarf galaxies, or any of the core criteria.
...
## 40. [Constraining Ricci-Cubic Holographic Dark Energy from observational data using the MCMC sampling and enhanced Machine learning analysis](https://arxiv.org/abs/2508.19961) <a id="link40"></a>
...
**Comment:** This paper constrains Ricci-Cubic Holographic Dark Energy models using observational data and machine learning. It is focused on cosmological model fitting and does not address any of the core topics.
...
## 41. [Scalar-induced gravitational waves in spatially covariant gravity](https://arxiv.org/abs/2508.20000) <a id="link41"></a>
...
**Comment:** This is a theoretical study of scalar-induced gravitational waves in modified gravity theories. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 42. [Exploring the astrophysical origins of binary black holes using normalising flows](https://arxiv.org/abs/2508.19336) <a id="link42"></a>

**ArXiv ID:** 2508.19336

**Authors:** Storm Colloms, Christopher P L Berry, John Veitch, Michael Zevin

**Abstract:** The growing number of gravitational-wave detections from binary black holes enables increasingly precise measurements of their population properties. The observed population is most likely drawn from multiple formation channels. Population-synthesis simulations allow detailed modelling of each of these channels, and comparing population-synthesis models with the observations allows us to constrain the uncertain physics of binary black hole formation and evolution. However, the most detailed population-synthesis codes are computationally expensive. We demonstrate the use of normalising flows to emulate five different population synthesis models, reducing the computational expense, and allowing interpolation between the populations predicted for different simulation inputs. With the trained normalising flows, we measure the branching ratios of different formation channels and details of binary stellar evolution, using the current catalogue of gravitational-wave observations.

**Comment:** The paper uses population synthesis and normalizing flows to study binary black hole formation channels. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 44. [Magnetic Field Configurations in Binary Neutron Star Mergers II: Inspiral, Merger and Ejecta](https://arxiv.org/abs/2508.19342) <a id="link44"></a>
...
**Comment:** Simulations of binary neutron star mergers with varying magnetic field configurations. This is focused on compact object mergers and does not address galaxy formation, near-field cosmology, or any of the other core topics.
...
## 47. [Sensitive Constraints on Coherent Radio Emission from Five Isolated White Dwarfs](https://arxiv.org/abs/2508.19520) <a id="link47"></a>
...
**Comment:** Sensitive radio search for coherent emission from isolated white dwarfs, with implications for WD pulsar-like activity. The focus is on compact objects and radio transients, not on galaxy simulations, dwarf galaxies, or resolved star formation histories.
...
## 48. [Lensing by black holes within astrophysical environments](https://arxiv.org/abs/2508.19333) <a id="link48"></a>
...
**Comment:** Studies lensing by black holes within astrophysical environments using a fully relativistic setup, with applications to gravitational wave echoes. The focus is on black hole lensing and gravitational wave signals, not on galaxy simulations, dwarf galaxies, or star formation histories.
...
## 51. [On Ultra-long Period (53.8 min) Pulsar ASKAP J1935+2148: Coherent Radio Emission Triggered by Local Superstrong Magnetic Reconnection](https://arxiv.org/abs/2508.19801) <a id="link51"></a>
...
**Comment:** Discusses ultra-long period pulsars and their emission mechanisms. No direct connection to near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 52. [Prototyping of 6.2-mm-Pitch Fiber Positioner Modules for Stage-V Telescope Instrumentation](https://arxiv.org/abs/2508.19711) <a id="link52"></a>

**ArXiv ID:** 2508.19711

**Authors:** Malak Galal, Maxime Rombach, Jonathan Wei, Ricardo Ara\'ujo, Diane Chapuis, S\'ebastien Pernecker, Abby Bault, Joseph Harry Silber, Nicholas Wenner, William Van Shourt, Stefane Caseiro, Corentin Magnenat, David Schlegel, Jean-Paul Kneib

**Abstract:** Small-pitch populated focal planes are a critical enabling technology for the next generation of highly multiplexed astronomical instruments. This work reports on ongoing prototyping activities for 6.2 mm-pitch alpha-beta (theta-phi) fiber positioner modules. Following a concise review of the underlying concept, the performance of trillium-based and independently actuated robotic designs is compared. Key operational parameters including XY positioning repeatability, non-linearity, backlash, and tilt are quantitatively assessed, with emphasis on their implications for overall instrument performance. Initial prototyping results are highly encouraging, indicating performance levels approaching the preliminary design specifications.

**Comment:** This paper focuses on instrumentation development for fiber positioners in telescopes. While important for observational astronomy, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or numerical galaxy simulations.
...
## 54. [Constraining the Cosmological Constant from Stellar Orbits Around Sgr A* Using Physics-Informed Neural Networks](https://arxiv.org/abs/2508.19719) <a id="link54"></a>
...
**Comment:** Uses stellar orbits around Sgr A* to constrain the cosmological constant. Focus is on the Galactic center and SMBH, which is explicitly excluded from the relevant criteria.
...
## 55. [Coincident morphological transitions in precessing black-hole binaries](https://arxiv.org/abs/2508.19735) <a id="link55"></a>
...
**Comment:** The paper presents new insights into spin precession in black-hole binaries, focusing on coincident morphological transitions. This is not related to any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 57. [Polarization aberration modeling of internal occulters for coronagraphs](https://arxiv.org/abs/2508.19397) <a id="link57"></a>
...
**Comment:** Models polarization aberrations in coronagraphs for exoplanet imaging; not relevant to any of the core galaxy or stellar criteria.
...
## 59. [FRB 20200428 and potentially associated hard X-ray bursts: Maser emission and synchrotron radiation of electrons in a weakly magnetized plasma?](https://arxiv.org/abs/2508.19315) <a id="link59"></a>
...
**Comment:** This paper discusses FRB 20200428 and associated X-ray bursts, focusing on plasma emission mechanisms. It does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 60. [Temperature induced optical scatter changes in titania-germania coatings](https://arxiv.org/abs/2508.20043) <a id="link60"></a>
...
**Comment:** This paper studies optical coatings for gravitational wave detectors. It is focused on instrumentation and materials science, not on any of the core astrophysical criteria.
...
## 61. [Using normal to find abnormal: AI-based anomaly detection in gravitational wave data](https://arxiv.org/abs/2508.19772) <a id="link61"></a>
...
**Comment:** AI-based anomaly detection in gravitational wave data. This is a methodological paper for GW data analysis and does not address any of the core astrophysics topics.
...
## 62. [Bifrost Models of the Quiet Sun. I. Comparison with Solar Observations](https://arxiv.org/abs/2508.19355) <a id="link62"></a>
...
**Comment:** Bifrost models of the quiet Sun compared with solar observations. This is focused on solar physics and does not address any of the core topics.
...
## 63. [Collisional excitation of HCN by CO to refine the modeling of cometary comae](https://arxiv.org/abs/2508.19904) <a id="link63"></a>

**ArXiv ID:** 2508.19904

**Authors:** Francesca Tonolo, Ernesto Quintas-S\'anchez, Adrian Batista-Planas, Richard Dawes, Fran\c{c}ois Lique

**Abstract:** We present the first dataset of collisional (de)-excitation rate coefficients of HCN induced by CO, one of the main perturbing gases in cometary atmospheres. The dataset spans the temperature range of 5-50 K. It includes both state-to-state rate coefficients involving the lowest ten and nine rotational levels of HCN and CO, respectively, and the so-called "thermalized" rate coefficients over the rotational population of CO at each kinetic temperature. The derivation of these coefficients exploited the good performance of the statistical adiabatic channel model (SACM) on top of an accurate interaction potential computed at the CCSD(T)-F12b/CBS level of theory. The reliability of the SACM approach was validated by comparison with full quantum calculations restricted at the lowest total angular momentum of the system. These results provide essential input to accurately model the distribution among the rotational energy levels and the abundance of HCN in cometary atmospheres, accounting for deviations from local thermodynamic equilibrium that typically occurs in such environments.

**Comment:** Provides collisional excitation rate coefficients for HCN by CO to improve modeling of cometary comae. The work is focused on molecular excitation in cometary atmospheres, not on galaxy simulations, dwarf galaxies, or star formation histories.
...
## 64. [Modeling spectral filtering effects on color-matching functions: Implications for observer variability](https://arxiv.org/abs/2508.19291) <a id="link64"></a>
...
**Comment:** Investigates spectral filtering effects on color-matching functions and observer variability in color vision. The work is focused on color vision science, not on galaxy simulations, dwarf galaxies, or star formation histories.
...
## 65. [Testing a Computed Tomography Imaging Spectrometer for Earth Observations on the HEIMDAL Stratospheric Balloon Mission](https://arxiv.org/abs/2508.19693) <a id="link65"></a>
...
**Comment:** Earth observation instrumentation paper; not relevant to any of the core astrophysical criteria.
...
## 66. [Stages of commissioning alignment for three-mirror anastigmat (TMA) telescopes](https://arxiv.org/abs/2508.19338) <a id="link66"></a>
...
**Comment:** Method for multi-stage alignment of three-mirror anastigmat telescopes. This is an instrumentation paper and does not address any of the core topics.
...
## 68. [Modeling Orbital Decay of Low-Earth Orbit Satellites due to Atmospheric Drag: A Simplified Analytical Approach](https://arxiv.org/abs/2508.19549) <a id="link68"></a>

**ArXiv ID:** 2508.19549

**Authors:** Sukdev Mahapatra

**Abstract:** Low-Earth Orbit (LEO) satellites are crucial for communications, navigation, and Earth observation. However, their operational lifetimes are strongly influenced by orbital decay due to atmospheric drag. This work presents a simplified analytical model of orbital decay in LEO, incorporating atmospheric density variations and satellite parameters. Using standard drag force equations and density models, we explore how altitude, satellite mass, and cross-sectional area affect decay timescales. Comparisons are made with existing NASA models and previous literature. The results highlight the importance of accurate atmospheric density representation and solar activity in predicting satellite lifetimes, especially relevant in the context of increasing space debris and mega-constellations.

**Comment:** This paper models orbital decay of LEO satellites due to atmospheric drag. It is focused on satellite engineering and does not address any of the core astrophysics topics such as near-field cosmology, star formation histories, or galaxy simulations.
