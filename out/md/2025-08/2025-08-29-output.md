...
11. [The first detection of cosmic-ray excited H$_2$ in interstellar space](#user-content-link11)
...
22. [New gravitational-wave data support a bimodal black-hole mass distribution](#user-content-link22)
...
34. [HI gas in the rejuvenated radio galaxy PKS 2014-55](#user-content-link34)
...
47. [Mineral Detection of Neutrinos and Dark Matter 2025 Proceedings](#user-content-link47)
...
59. [Challenging $\Lambda$CDM with Higher-Order GUP Corrections](#user-content-link59)
...
73. [Mapping Gamma-Ray Bursts: Distinguishing Progenitor Systems Through Machine Learning](#user-content-link73)
...
**Comment:** Directly matches the 'Near-Field Cosmology' criterion: detailed kinematic and dark matter profile analysis of the Sculptor dwarf spheroidal galaxy, including core-cusp measurements. Also relevant to 'Numerical Galaxy Simulations' via Jeans modeling, but primarily observational.
...
**Comment:** This paper derives atmospheric parameters and chemical abundances for young stars in the Orion star-forming region using APOGEE-2 spectra and model atmospheres. While it uses stellar atmosphere models (matching the 'Stellar Models' criterion), the focus is on young stars in Orion, not on dwarf galaxies or resolved star formation histories of galaxies. The relevance is moderate due to the use of stellar models.
...
**Comment:** Describes visualization software for large-scale astronomy and cosmology simulations, including GADGET and PLUTO. While it mentions galaxy simulations, the focus is on software infrastructure rather than new simulation results or physics.
...
**Comment:** Analyzes potassium abundances in extremely metal-poor stars to study nucleosynthesis in massive stars. While it touches on chemical evolution and early universe nucleosynthesis, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 28. [Efficient ion re-acceleration in laboratory-produced interpenetrating collisionless shocks](https://arxiv.org/abs/2508.20303) <a id="link28"></a>
...
## 34. [HI gas in the rejuvenated radio galaxy PKS 2014-55](https://arxiv.org/abs/2508.20276) <a id="link34"></a>
...
**Comment:** Presents HI absorption observations in a giant, X-shaped radio galaxy, discussing gas kinematics and possible galaxy-galaxy interactions. While it touches on galaxy interactions, the focus is on a massive radio galaxy, not on dwarf galaxies, near-field cosmology, or star formation histories.
...
## 36. [GW emission and relativistic dynamical friction in intermediate mass ratio inspirals](https://arxiv.org/abs/2508.20994) <a id="link36"></a>

**ArXiv ID:** 2508.20994

**Authors:** P. Di Cintio, G. Bertone, C. Chiari, T. K. Karydas, B. J. Kavanagh, M. Pasquato, A. A. Trani

**Abstract:** We present a set of preliminary simulations of intermediate mass ratio inspirals (IMRIs) inside dark matter (DM) spikes accounting for post-Newtonian corrections the interaction between the two black holes up to the order 2.5 in $c^2$, as well as relativistic corrections to the dynamical friction (DF) force exerted by the DM distribution. We find that, incorporating relativity reduces of a factor $1/2$ the inspiral time, for equivalent initial orbital parameters, with respect to the purely classical estimates. Vice versa, neglecting the DF of the spike systematically yields longer inspiral times.

**Comment:** This paper presents simulations of intermediate mass ratio inspirals in dark matter spikes, focusing on gravitational wave emission and dynamical friction. While it involves dark matter, the focus is on black hole inspirals rather than galaxy formation, near-field cosmology, or the other core criteria. The relevance is low.
...
## 37. [Optical Spectroscopy of the Most Compact Accreting Binary Harboring a Magnetic White Dwarf and a Hydrogen-rich Donor](https://arxiv.org/abs/2508.20170) <a id="link37"></a>
...
**Comment:** This paper presents observations of a compact accreting binary with a magnetic white dwarf and a hydrogen-rich donor, focusing on its orbital period and metallicity. While it discusses stellar evolution and binary systems, it does not present new stellar models or address galaxy evolution, near-field cosmology, or resolved star formation histories. The relevance to the core topics is weak.
...
## 38. [Cosmic-ray boosted inelastic dark matter from neutrino-emitting active galactic nuclei](https://arxiv.org/abs/2508.20984) <a id="link38"></a>
...
**Comment:** The paper discusses cosmic-ray boosted dark matter from active galactic nuclei and its detectability. While it touches on dark matter, it is not focused on near-field cosmology, satellite galaxies, or the core-cusp problem. The context is AGN environments, not the Milky Way or its satellites.
...
## 42. [Diamond-loaded polyimide aerogel scattering filters and their applications in astrophysical and planetary science observations](https://arxiv.org/abs/2508.20406) <a id="link42"></a>
...
**Comment:** Describes diamond-loaded polyimide aerogel scattering filters for astrophysical and planetary science instruments. While relevant for instrumentation, it does not address galaxy evolution, star formation histories, or near-field cosmology.
...
## 44. [VIPER: A high-resolution multimode fiber-fed VIPA spectrograph concept for characterizing exoplanet atmospheric escape](https://arxiv.org/abs/2508.20169) <a id="link44"></a>
...
**Comment:** This paper presents a new spectrograph concept for exoplanet atmospheric escape studies. While it is an instrumentation paper with a focus on exoplanet atmospheres, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or dwarf galaxy studies.
...
## 47. [Mineral Detection of Neutrinos and Dark Matter 2025 Proceedings](https://arxiv.org/abs/2508.20482) <a id="link47"></a>
...
**Comment:** These are proceedings from a workshop on mineral detection of neutrinos and dark matter, discussing mineral detectors for rare event searches. While there is a mention of measuring the history of the Milky Way, the focus is on particle physics and detector technology, not on the core topics.
...
## 48. [Revisiting the Radial Metallicity Gradient-Age Relation in the Milky Way's Thin and Thick Disks](https://arxiv.org/abs/2508.20386) <a id="link48"></a>
...
**Comment:** Focuses on the metallicity gradient-age relation in the Milky Way's thin and thick disks. While it discusses star formation and feedback, the main focus is on the disk rather than dwarf satellites or resolved star formation histories. The mention of starburst-driven outflows is peripheral and not the main topic. Does not directly match any core criteria.
...
## 49. [The structure of the giant radio fossil in the Ophiuchus galaxy cluster](https://arxiv.org/abs/2508.20190) <a id="link49"></a>
...
**Comment:** This paper presents radio observations of a fossil radio lobe in the Ophiuchus galaxy cluster, focusing on its structure and spectral properties. It does not address galaxy-scale processes, star formation, or any of the core topics.
...
## 50. [Do White Dwarfs Sample Water-Rich Planetary Material?](https://arxiv.org/abs/2508.20172) <a id="link50"></a>
...
**Comment:** Examines water content in accreted material around polluted white dwarfs to probe exoplanetary body compositions. No direct relevance to any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 52. [Very high-energy gamma-ray and neutrino emission from hadronic interaction in compact binary millisecond pulsars](https://arxiv.org/abs/2508.20952) <a id="link52"></a>
...
**Comment:** Studies high-energy gamma-ray and neutrino emission from compact binary millisecond pulsars (spider pulsars). The work is focused on particle acceleration and emission mechanisms, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 55. [The frequency-independent radio luminosity -- period relation of RS CVn stars](https://arxiv.org/abs/2508.20393) <a id="link55"></a>
...
**Comment:** Studies radio luminosity-period relation in RS CVn stars, focusing on binary star systems and their emission mechanisms. The work is on stellar binaries, not on galaxy evolution, star formation, or near-field cosmology.
...
## 56. [Updated Astrophysical Equation-of-State Constraints on the Color-Superconducting Gap](https://arxiv.org/abs/2508.20763) <a id="link56"></a>
...
**Comment:** This paper focuses on neutron star observations and the color-superconducting gap, which is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or CGM. It is more relevant to compact object physics.
...
## 57. [Dark Forces Gathering](https://arxiv.org/abs/2508.20999) <a id="link57"></a>
...
**Comment:** This paper discusses tensions in cosmological parameters from CMB and BAO, and explores new physics in the dark sector. While it is cosmology-focused, it does not address near-field cosmology, galaxy formation, or any of the core criteria. The relevance is very low.
...
## 60. [Fermionic Love of Black Holes in General Relativity](https://arxiv.org/abs/2508.20155) <a id="link60"></a>
...
**Comment:** This paper presents a theoretical result on black hole tidal Love numbers for fermionic fields. It is not related to galaxies, star formation, or any of the core topics.
...
## 61. [Self-regularized entropy: How much do quantum black holes violate the no-hair theorem?](https://arxiv.org/abs/2508.20421) <a id="link61"></a>
...
**Comment:** Computes entropy of Hawking radiation in quantum black holes with quadrupole deformation, discussing no-hair theorem violations. The focus is on black hole physics, not on galaxy evolution, star formation, or near-field cosmology.
...
## 62. [Numerical computation of electromagnetically sourced nonlinear tails](https://arxiv.org/abs/2508.20499) <a id="link62"></a>
...
**Comment:** Numerically computes nonlinear gravitational wave tails sourced by electromagnetic events, focusing on black hole ringdown and multi-messenger observations. The work is on black hole physics, not on galaxy evolution, star formation, or near-field cosmology.
...
## 64. [Modelling magnetic star-planet interaction in the iconic M dwarfs Proxima Centauri, YZ Ceti and GJ 1151](https://arxiv.org/abs/2508.20891) <a id="link64"></a>
...
**Comment:** Focuses on magnetic star-planet interactions in M-dwarf systems, which does not match any of the core criteria (no connection to dwarf galaxies, star formation histories, or galaxy simulations).
...
## 65. [Probing UHECR sources - Constraints from cosmic-ray measurements](https://arxiv.org/abs/2508.20767) <a id="link65"></a>
...
**Comment:** Reviews constraints on ultra-high-energy cosmic ray sources, focusing on extragalactic sources and cosmic ray propagation. No direct connection to the core criteria.
...
## 67. [Broadband spectroscopy of astrophysical ice analogues: III. Scattering properties and porosity of CO and CO$_2$ ices](https://arxiv.org/abs/2508.20827) <a id="link67"></a>
...
**Comment:** This paper studies the scattering properties and porosity of CO and CO2 ices in laboratory analogues, relevant for interpreting ISM observations. However, it does not address galaxy-scale processes, star formation histories, or any of the core topics.
...
## 68. [The orbital period and inclination of the neutron star X-ray transient MAXI J1807+132](https://arxiv.org/abs/2508.20178) <a id="link68"></a>

**ArXiv ID:** 2508.20178

**Authors:** E. A. Saavedra, T. Mu\~noz-Darias, M. A. P. Torres, I. V. Yanes-Rizo, M. Armas Padilla, A. \'Alvarez-Hern\'andez, J. Casares, D. Mata S\'anchez, S. K. Rout, S. Navarro

**Abstract:** The neutron star X-ray transient MAXI J1807+132 has undergone outbursts in 2017, 2019, and 2023. We conducted an $R$-band time series photometry campaign using the Isaac Newton Telescope during the 2022 quiescent state. We detected a periodic variation in the light curve, consistent with ellipsoidal modulation, which allowed us to determine an orbital period of $P_{\rm orb} = 4.258 \pm 0.008$ hr. By modelling the light curve, we obtained a binary inclination of $ i = 72\pm5 \, \deg $ and a mass ratio $q = 0.24^{+0.19}_{-0.14}$ ($68$ per cent confidence level). Furthermore, our analysis supports an early M-dwarf companion that contributes between 30 and 50 per cent to the total flux in the $R$-band. We extend the previously established absolute magnitude versus orbital period correlation for black hole X-ray transients to neutron star systems. We applied the correlation to MAXI J1807+132, estimating its distance as $6.3 \pm 0.7$ kpc and its height above the Galactic plane to be $1.6 \pm 0.2$ kpc.

**Comment:** This paper determines the orbital period and inclination of a neutron star X-ray transient, with some discussion of the companion star and its contribution to the light curve. It does not address galaxy-scale processes, star formation histories, or any of the core topics.
...
## 70. [Optimized Observation Sequencing in Low-Earth Orbit with the SPHEREx Survey Planning Software](https://arxiv.org/abs/2508.20332) <a id="link70"></a>

**ArXiv ID:** 2508.20332

**Authors:** Sean Bryan, James Bock, Thomas Burk, Tzu-Ching Chang, Brendan P. Crill, Ari Cukierman, Olivier Dore, C. Darren Dowell, Gregory Dubois-Felsmann, Beth Fabinsky, Sergi Hildebrandt-Rafels, Howard Hui, Kyle Hughes, Phillip Korngut, Philip Mauskopf, Julian Mena, Chi Nguyen, Milad Pourrahmani, Dustin Putnam, Keshav Ramanathan, Flora Ridenhour, Cody Roberson, Amy Trangsrud, Stephen Unwin, Pao-Yu Wang, the SPHEREx Team

**Abstract:** SPHEREx is a NASA infrared astronomy mission that launched on March 12th, 2025 and is operating successfully in low-Earth orbit (LEO). The mission is currently observing the entire sky in 102 spectral channels in four independent all-sky surveys and also achieves enhanced coverage in two deep fields. This data will resolve key science questions about the early universe, galaxy formation, and the origin of water and biogenic molecules. In this paper, we describe the survey planning software (SPS) that enables SPHEREx to observe efficiently while mitigating a range of operational challenges in LEO. Our optimal target selection algorithm achieves the required high coverage in both the All-Sky and Deep Surveys. The algorithm plans observations to stay within our time-varying allowable pointing zone, interleaves required data downlink passes, and mitigates outages due to the South Atlantic Anomaly and other events. As demonstrated by the sky coverage achieved in the first SPHEREx public data release, our approach is performing well in flight. The SPHEREx SPS is a key new capability that enables the mission to deliver groundbreaking science from LEO.

**Comment:** Describes survey planning software for the SPHEREx mission, focusing on observation sequencing and sky coverage. While SPHEREx data may be used for galaxy studies, this paper is about mission operations and does not address any of the core topics directly.
...
## 73. [Mapping Gamma-Ray Bursts: Distinguishing Progenitor Systems Through Machine Learning](https://arxiv.org/abs/2508.20214) <a id="link73"></a>
...
**Comment:** Uses machine learning to classify gamma-ray burst progenitors. No connection to the core criteria.
...
## 76. [Unsupervised Classification of Gamma-ray Bursts from Blazars (GRBBLs) with Machine Learning](https://arxiv.org/abs/2508.20927) <a id="link76"></a>
...
**Comment:** This paper uses machine learning to classify gamma-ray bursts from blazars. It is focused on blazar variability and gamma-ray bursts, which does not match any of the core topics such as near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 78. [COCONUT: A time-evolving coronal model with an energy decomposition strategy](https://arxiv.org/abs/2508.20423) <a id="link78"></a>
...
**Comment:** This paper presents a new energy decomposition method for MHD coronal models, improving numerical stability for solar corona simulations. The focus is on solar physics and MHD modeling, not on galaxies, star formation, or near-field cosmology. The relevance is very low.
...
## 79. [Unprecedentedly bright X-ray flaring in Cygnus X-1 observed by INTEGRAL](https://arxiv.org/abs/2508.20874) <a id="link79"></a>
...
**Comment:** Studies X-ray flaring in Cygnus X-1, a black hole binary. No connection to the core criteria.
...
## 81. [Modeling of AR 12760 with GX Simulator and Evidence for the Extended Transition Region in Peripheral Active Region Loops](https://arxiv.org/abs/2508.20979) <a id="link81"></a>

**ArXiv ID:** 2508.20979

**Authors:** Therese A. Kucera, Gelu M. Nita, James A. Klimchuk, Gregory D. Fleishman

**Abstract:** In order to understand solar atmospheric heating it is important to test heating models against spatially resolved data from solar active regions. Here we model a small active region, AR~12760 observed on 2020 April 28, with the GX Simulator package by fitting the EUV intensities in wavebands observed by Solar Dynamics Observatory's Atmospheric Imaging Assembly. We assume the temporally and spatially averaged heating rate along a loop has a power-law dependence on loop length, $L$ and average magnetic field strength along the loop, $B_{avg}$. We find that the best fit heating model for the 211~\AA\ band is $\approx 7\times 10^{-3} (B_{avg}/{100 \mbox{G}})^{1.5}(L/{10^9\mbox{cm}})^{-1}$ erg cm$^{-3}$ s$^{-1}$ but that there is a range of parameters that give qualitatively reasonable fits, which we conclude is due to a correlation between $B_{avg}$ and $L$. In addition, we find that the models of the bands including cooler emission (131 and 171~\AA) greatly underestimate the extent of the emission in the legs of the longer loops at the peripheries of the active region that are the strongest contributors of the emission in those bands. We conclude that this is because the modeling assumes that all transition region emission is confined to the loop foot points, but in reality the upper transition region of longer loops extends significantly farther into the loop. It is important to consider this aspect of the transition region in future efforts to model EUV emission.

**Comment:** Models solar active region heating and transition region structure. Focus is on solar physics, not on galaxy evolution, star formation histories, or any of the core criteria.
...
## 82. [On the Regulation of the Solar Wind Helium Abundance by the Hydrogen Compressibility](https://arxiv.org/abs/2508.20391) <a id="link82"></a>
...
**Comment:** The paper discusses solar wind helium abundance and compressibility, which does not match any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations. It is focused on solar physics.
...
## 83. [On the Transients Handler for the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2508.20726) <a id="link83"></a>
...
**Comment:** Describes the transients handler for the Cherenkov Telescope Array, focusing on alert management and scheduling for gamma-ray transients. No direct relevance to the core topics (galaxy evolution, star formation, near-field cosmology, etc.).
...
## 84. [CONAN: A Python package for modeling lightcurve and radial velocity data of exoplanetary systems](https://arxiv.org/abs/2508.20196) <a id="link84"></a>

**ArXiv ID:** 2508.20196

**Authors:** Babatunde Akinsanmi, Monika Lendl, Andreas Krenn

**Abstract:** We present CONAN (COde for exoplaNet ANalysis), an open-source Python package for comprehensive analyses of exoplanetary systems. It provides a unified Bayesian framework to simultaneously analyze diverse exoplanet datasets to derive global system parameters. CONAN allows to consistently model photometric transit light curves, occultations, phase curves, and radial velocity measurements, while detrending each dataset with any combination of parametric, sinusoidal, Gaussian Processes, and spline models.

**Comment:** Presents a Python package for exoplanetary system analysis. No connection to any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 85. [On fine alignment of transmitted beams for TianQin with far-field wavefront error](https://arxiv.org/abs/2508.20589) <a id="link85"></a>
...
**Comment:** This paper focuses on laser interferometry alignment for the TianQin gravitational wave detector. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
