...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 62940    | 10279        | 73219   |
| **Cost**             | $0.13    | $0.08        | $0.21   |

Total arXiv papers: 226

Total scanned papers: 149

Total relevant papers: 118

**Table of contents with paper titles:**

1. [Modeling stellar convective transport with plumes : II. Transport Properties of Locally and Non-locally driven Convection](#user-content-link1)
**Authors:** Youhei Masada, Tomoya Takiwaki, Nobumitsu Yoko

2. [Chemically primitive dwarf accretion reignites the inner disk assembly of Malin 1](#user-content-link2)
**Authors:** Manish Kataria, Kanak Saha

3. [Not all cores are equal: Phase-space origins of dynamical friction, stalling and buoyancy](#user-content-link3)
**Authors:** Shashank Dattathri, Frank C. van den Bosch, Uddipan Banik, Martin Weinberg, Priyamvada Natarajan, Zhaozhou Li, Avishai Dekel

4. [Topological Signatures of Heating and Dark Matter in the 21 cm Forest](#user-content-link4)
**Authors:** Hayato Shimabukuro

5. [First Light And Reionisation Epoch Simulations (FLARES) XX: Comparing semi-analytic models at high-redshift](#user-content-link5)
...
6. [AGN feedback in merging galaxies with a SMUGGLE multiphase ISM](#user-content-link6)
...
7. [LEGA-C stellar populations scaling relations. II: Dissecting mass-complete archaeological trends and their evolution since z~0.7 with LEGA-C and SDSS](#user-content-link7)
**Authors:** Anna R. Gallazzi (INAF-Arcetri Astrophysical Observatory), Stefano Zibetti (INAF-Arcetri Astrophysical Observatory), Arjen van der Wel (Sterrenkundig Observatorium Universiteit Gent), Angelos Nersesian (Sterrenkundig Observatorium Universiteit Gent), Yasha Kaushal (University of Pittsburgh), Rachel Bezanson (University of Pittsburgh), Daniele Mattolini (INAF-Arcetri Astrophysical Observatory, Universita' di Trento), Eric F. Bell (University of Michigan), Laura Scholz-Diaz (INAF-Arcetri Astrophysical Observatory), Joel Leja (Pennsylvania State University), Francesco D'Eugenio (University of Cambridge), Po-Feng Wu (National Taiwan University), Camilla Pacifici (StSCI Baltimore), Michael Maseda (StSCI Baltimore)

8. [Sub-millimeter galaxies in hierarchical models: revisiting the need for a top-heavy stellar initial mass function with Bayesian optimisation](#user-content-link8)
**Authors:** Edward Elliott (ICC, Durham), C. M. Baugh (ICC, Durham), Cedric Lacey (ICC, Durham)

9. [From Images to Physics: Probabilistic Inference of Galaxy Parameters and Emission Lines via VAE & Normalizing Flows](#user-content-link9)
**Authors:** Adiba Amira Siddiqa, Sayed Shafaat Mahmud, Rafael Martinez-Galarza

10. [Constraining r-process nucleosynthesis with multi-objective Galactic chemical evolution models](#user-content-link10)
**Authors:** M. Molero, A. Arcones, F. Montes, C. J. Hansen

11. [Infrared photometry and CaT spectroscopy of the most metal-poor in-situ globular cluster VVV-CL001](#user-content-link11)
**Authors:** W. Haro Moya, C. Moni Bidin, M. C. Parisi, D. Geisler, M. Bla\~na, S. Villanova, F. Mauro, A. -N. Chen\'e, R. E. Cohen, S. Ram\'irez Alegr\'ia, R. Contreras Ramos, M. Zoccali, C. Mu\~noz, B. Dias

12. [Probing the Nature of Dark Matter Self-Interactions Through Observations of Massive Black Hole Mergers](#user-content-link12)
**Authors:** Zachary J. Hoelscher, Kelly Holley-Bockelmann, Akaxia Cruz, N. Nicole Sanchez

13. [He-star donor pathway for the hypervelocity star D6-2](#user-content-link13)
**Authors:** Abinaya Swaruba Rajamuthukumar, Ruediger Pakmor, Stephen Justham, Aakash Bhat, Ken J Shen

14. [A Fleeting GLIMPSE of N/O Enrichment at Cosmic Dawn: Evidence for Wolf Rayet N Stars in a z = 6.1 Galaxy](#user-content-link14)
**Authors:** Danielle A. Berg, Rohan P. Naidu, John Chisholm, Hakim Atek, Seiji Fujimoto, Vasily Kokorev, Lukas J. Furtak, Chiaki Kobayashi, Daniel Schaerer, Angela Adamo, Qinyue Fei, Damien Korber, Jorryt Matthee, Rui Marques-Chaves, Zorayda Martinez, Kristen B. W. Mcquinn, Julian B. Mu\~noz, Pascal A. Oesch, Daniel P. Stark, Mabel G. Stephenson, Tiger Yu-Yang Hsiao

15. [TransFit-CSM: A Fast, Physically Consistent Framework for Interaction-Powered Transients](#user-content-link15)
**Authors:** Yu-Hao Zhang, Liang-Duan Liu, Ze-Xin Du, Guang-Lei Wu, Jing-Yao Li, Yun-Wei Yu

16. [The influence of AGN feedback on star formation in red spiral galaxies](#user-content-link16)
**Authors:** Moreom Akter (University of North Dakota), Wayne A. Barkhouse (University of North Dakota), Sandanuwan P Kalawila Vithanage (Gettysburg College), Gihan L. Gamage (New Mexico State University-Alamogordo), Omar L\'opez-Cruz (Instituto Nacional de Astrofisica, Optica y Electronica)

17. [PAH Marks the Spot: Digging for Buried Clusters in Nearby Star-forming Galaxies](#user-content-link17)
**Authors:** Gabrielle B. Graham, Daniel A. Dale, Chase L. Smith, Elisabeth Brann, Kaycee D. Conder, Samuel Crowe, Sumitra Dhileepkumar, Nicole A. Imming, Emilio Mendez, Zachary Pleska, Kelsey Sako, Amirnezam Amiri, Ashley T. Barnes, M\'ed\'eric Boquien, Rupali Chandar, Ryan Chown, Oleg Y. Gnedin, Kathryn Grasha, Stephen Hannon, Hamid Hassani, R\'emy Indebetouw, Hwihyun Kim, Jaeyeon Kim, Hannah Koziol, Kirsten L. Larson, Janice C. Lee, Adam K. Leroy, Elias K. Oakes, M. Jimena Rodr\'iguez, Erik Rosolowsky, Karin Sandstrom, Eva Schinnerer, Jessica Sutter, David A. Thilker, Leonardo Ubeda, Bradley C. Whitmore, Tony D. Weinbeck, Thomas G. Williams, Aida Wofford, J. Eduardo M\'endez-Delgado, Qiushi Chris Tian, the PHANGS Collaboration

18. [Learning Cosmology from Nearest Neighbour Statistics](#user-content-link18)
**Authors:** Atrideb Chatterjee, Arka Banerjee, Francisco Villaescusa-Navarro, Tom Abel

19. [Foreground removal in HI 21 cm intensity mapping under frequency-dependent beam distortions](#user-content-link19)
**Authors:** Athanasia Gkogkou, Victor Bonjean, Jean-Luc Starck, Marta Spinelli, Panagiotis Tsakalides

20. [The Scatter of the Many Outweighs the Scatter of the Few: Systematic Error Asymmetry in Steeply-Falling Mass Functions for High-Redshift JWST Galaxies](#user-content-link20)
**Authors:** Jay R. Krishnan, Kevork N. Abazajian

21. [Pre-Supernova Multiple Giant Eruptions in Massive Stars](#user-content-link21)
**Authors:** Bhawna Mukhija, Amit Kashi

22. [Metallicity Effects on Machine Learning Classification of Dusty Stellar Sources in the Magellanic Clouds](#user-content-link22)
...
23. [The homogeneity scale in the Local Universe: model-independent estimate from S-PLUS DR4 blue galaxies](#user-content-link23)
**Authors:** Camila Franco, Felipe Avila, Armando Bernui, Ulisses Ribeiro, Cl\'ecio R. Bom, Arianna Cortesi, E. Telles, W. Schoenell, T. Ribeiro, A. Kanaan, C. Mendes de Oliveira

24. [IdentYS: A Python-Based Tool for Identifying Young Stars in Star-Forming Regions](#user-content-link24)
**Authors:** E. Nikoghosyan, D. Baghdasaryan, D. Andreasyan, N. Azatyan, A. Samsonyan, A. Yeghikyan

25. [Clustering effects on the Dark Siren determination of $H_0$: A simulation study](#user-content-link25)
**Authors:** Marios Kalomenopoulos, Riccardo Barbieri, Sadegh Khochfar, Jonathan Gair, Robert J. McGibbon

26. [The PAH 3.4 micron feature as a tracer of shielding in the Orion Bar and NGC 6240](#user-content-link26)
**Authors:** N. Thatte, D. Rigopoulou, F. R. Donnan, I. Garcia-Bernete, M. Pereira-Santaella, B. Draine, O. Veenema, B. Kerkeni, A. Alonso-Herrero, L. Hermosa Mu\~noz, G. Speranza

27. [Constraining the Neutral Hydrogen Fraction from SKA Simulated Observation using a Double-Gaussian Decomposition Technique](#user-content-link27)
**Authors:** Jiajun Zhang, Huanyuan Shan

28. [Towards Mitigating Systematics in Large-Scale Surveys via Few-Shot Optimal Transport-Based Feature Alignment](#user-content-link28)
**Authors:** Sultan Hassan, Sambatra Andrianomena, Benjamin D. Wandelt

29. [JWST observes the assembly of a massive galaxy at z~4](#user-content-link29)
**Authors:** Aayush Saxena, Roderik A. Overzier, Catarina Aydar, Jianwei Lyu, George H. Rieke, Victoria Reynaldi, Montserrat Villar-Mart\'in, Krisztina \'Eva Gab\'anyi, Kenneth J. Duncan, S\'andor Frey, Andrew Humphrey, George Miley, Laura Pentericci, Krisztina Perger, Huub R\"ottgering, Philip Best, Sarah E. I. Bosman, Gyorgy Mez\H{o}, Masafusa Onoue, Zsolt Paragi, Bram Venemans

30. [The first AKRA mass map reconstruction from HSC Y1 data](#user-content-link30)
**Authors:** Yuan Shi, Pengjie Zhang, Zhao Chen, Jian Qin, Li Cui, Furen Deng, Ji Yao

31. [SourceREACH (Source REconstruction of Arcs behind Cluster Halos): A New Source Reconstruction Algorithm Optimized for Giant Arcs and Galaxy Cluster Lenses](#user-content-link31)
**Authors:** Lana Eid, Charles Keeton

32. [ODIN: Characterizing the Three-dimensional Structure of Two Protocluster Complexes at $z = 3.1$](#user-content-link32)
**Authors:** Vandana Ramakrishnan, Ashley Ortiz, Byeongha Moon, Eunsoo Jun, David Schlegel, Kyoung-Soo Lee, Jessica Nicole Aguilar, Maria Celeste Artale, David Brooks, Maria Candela Cerdosino, Robin Ciardullo, Todd Claybaugh, Andrei Cuceu, Axel de la Macorra, Arjun Dey, Nicole M. Firestone, Andreu Font-Ribera, Jaime E. Forero-Romero, Eric Gawiser, Enrique Gazta\~naga, Caryl Gronwall, Lucia Guaita, Gaston Gutierrez, Sungryong Hong, Ho Seong Hwang, Sang Hyeok Im, Paulina Troncoso Iribarren, Woong-Seob Jeong, Dick Joyce, Ankit Kumar, Claire Lamman, Martin Landriau, Seong-Kook Lee, Jaehyun Lee, Aaron Meisner, Ramon Miquel, John Moustakas, Seshadri Nadathur, Gautam Nagaraj, Julie Nantais, Nelson Padilla, Changbom Park, Will Percival, Francisco Prada, Ignasi P\'erez-R\`afols, Graziano Rossi, Eusebio Sanchez, Joseph Harry Silber, Hyunmi Song, David Sprayberry, Gregory Tarl\'e, Francisco Valdes, Yujin Yang, Ann Zabludoff, Hu Zou

33. [Modeling X-ray photon pile-up with a normalizing flow](#user-content-link33)
**Authors:** Ole K\"onig, Daniela Huppenkothen, Douglas Finkbeiner, Christian Kirsch, J\"orn Wilms, Justina R. Yang, James F. Steiner, Juan Rafael Mart\'inez-Galarza

34. [Investigating the Dark Energy Constraint from Strongly Lensed AGN at LSST-Scale](#user-content-link34)
...
35. [Examining Turbulence in Galactic Molecular Clouds - II: Continuity of Turbulence Cascading in a Portion of the Local Arm](#user-content-link35)
**Authors:** Yuehui Ma, Miaomiao Zhang, Hongchi Wang, Xuepeng Chen, Zhenyi Yue, Suziye He, Xiangyu Ou, Li Sun

36. [Characterization of type Ibn SNe](#user-content-link36)
**Authors:** D. Farias, C. Gall, V. A. Villar, K. Auchettl, K. M. de Soto, A. Gagliano, W. B. Hoogendam, G. Narayan, A. Sedgewick, S. K. Yadavalli, Y. Zenati, C. R. Angus, K. W. Davis, J. Hjorth, W. V. Jacobson-Gal\'an, D. O. Jones, C. D. Kilpatrick, M. J. Bustamante Rosell, D. A. Coulter, G. Dimitriadis, R. J. Foley, A. Gangopadhyay, H. Gao, M. E. Huber, L. Izzo, J. L. Johnson, A. L. Piro, A. Rest, C. Rojas-Bravo, M. R. Siebert, K. Taggart, S. Tinyanont

37. [The Impact of Orbital Anisotropy Assumptions in Lensing-Dynamics Modeling](#user-content-link37)
**Authors:** Yan Liang, Dandan Xu, Anowar J. Shajib, Yiping Shu, Ran Li

38. [Observational properties of a Schwarzschild black hole surrounded by a Dehnen-type dark matter halo](#user-content-link38)
**Authors:** Zhi Li, Jiancheng Yu

39. [Hydrodynamic instabilities in long-term three-dimensional simulations of neutrino-driven supernovae of 13 red supergiant progenitors](#user-content-link39)
**Authors:** Beatrice Giudici, Michael Gabler, Hans-Thomas Janka

40. [Made-to-Measure Outperforms Schwarzschild's Method](#user-content-link40)
**Authors:** Richard J. Long

41. [The physical properties of post-mass-transfer binaries](#user-content-link41)
**Authors:** Rhys Seeburger, Hans-Walter Rix, Kareem El-Badry, Johanna M\"uller-Horn, Alex J. Dimoff, Jan Henneco, Jaime I. Villase\~nor

42. [QuaRT: A toolkit for the exploration of quantum methods for radiation transport](#user-content-link42)
**Authors:** Rasmit Devkota, John H. Wise

43. [Unraveling eMSTO in NGC 2355: Stellar Rotation and Binaries](#user-content-link43)
**Authors:** Jayanand Maurya, Yu Zhang, Hubiao Niu

44. [3D extinction maps of the Milky Way disc from Gaia GSP-Spec parameters](#user-content-link44)
**Authors:** M. Barbillon, A. Recio-Blanco, P. de Laverny, P. A. Palicio

45. [Helical Magnetic Field in the Acceleration--Collimation Zone of the M87 Jet](#user-content-link45)
**Authors:** Jongho Park (Kyung Hee University), Kazuya Takahashi, Kenji Toma, Kazuhiro Hada, Masanori Nakamura, Hung-Yi Pu, Keiichi Asada, Paul T. P. Ho, Motoki Kino, Tomohisa Kawashima, Minchul Kam, Kunwoo Yi, Ilje Cho

46. [AstroMLab 5: Structured Summaries and Concept Extraction for 400,000 Astrophysics Papers](#user-content-link46)
**Authors:** Yuan-Sen Ting, Alberto Accomazzi, Tirthankar Ghosal, Tuan Dung Nguyen, Rui Pan, Zechang Sun, Tijmen de Haan

47. [PDRs4All XX. Haute Couture: Spectral stitching of JWST MIRI-IFU cubes with matrix completion](#user-content-link47)
**Authors:** Am\'elie Canin, C\'edric F\'evotte, Nicolas Dobigeon, Dries Van De Putte, Takashi Onaka, Olivier Bern\'e

48. [Doppler imaging combined with high-cadence photometry. I. Revisiting the surface of a pre-main-sequence flare star](#user-content-link48)
**Authors:** Sanghee Lee, Engin Bahar, Hakan Volkan \c{S}enavc{\i}, Emre I\c{s}{\i}k, Kai Ikuta, Kosuke Namekata, Haruhi Nagata, Kiyoe Kawauchi, Masashi Omiya, Hideyuki Izumiura, Akito Tajitsu, Bun'ei Sato, Satoshi Honda, Daisaku Nogami

49. [The B[e] Phenomenon in Supergiants. A Result of Mass Transfer in Binaries, Mergers, or What?](#user-content-link49)
**Authors:** Anatoly S. Miroshnichenko, Sergey V. Zharikov, Nadezhda L. Vaidman, Serik A. Khokhlov

50. [Mock Observations for the CSST Mission: Multi-Channel Imager--Instrument Simulation](#user-content-link50)
...
51. [Mock Observations for the CSST Mission: Integral Field Spectrograph--Instrument Simulation](#user-content-link51)
...
52. [Prospects for detecting periodic or sharp fast-time features in the supernova neutrino lightcurve with IceCube](#user-content-link52)
**Authors:** Jakob Beise, Mar\'ia Dur\'an de las Heras, Segev BenZvi, Spencer Griswold, Nora Valtonen-Mattila, Evan O'Connor, David Barba-Gonz\'alez, Erin O'Sullivan

53. [Near-infrared [P II] and [Fe II] line mapping of Galactic supernova remnants](#user-content-link53)
**Authors:** Takuma Kokusho, Yuki Katsurada, Yong-Hyun Lee, Bon-Chul Koo, Takahiro Nagayama, Hidehiro Kaneda, Koji S. Kawabata, Tatsuya Nakaoka, Ho-Gyu Lee, Rommy L. S. E. Aliste Castillo

54. [Dual core system candidates: a sample of objects with large velocity offset between absorption and narrow emission lines](#user-content-link54)
**Authors:** Zheng Qi, Zhang Xueguang, Yuan Qirong

55. [Sense and Sensitivity - I. Uncertainty analysis of the gas-phase chemistry in AGB outflows](#user-content-link55)
**Authors:** M. Van de Sande, M. Gueguen, T. Danilovich, T. J. Millar

56. [Disk mass predictions for binary neutron star mergers: limitations of proposed symbolic regression models](#user-content-link56)
**Authors:** Francois Foucart

57. [Unveiling the nature of the Einstein Probe transient EP 241021a](#user-content-link57)
**Authors:** J. Quirola-V\'asquez, P. G. Jonker, A. J. Levan, D. B. Malesani, F. E. Bauer, N. Sarin, G. P. Lamb, A. Martin-Carrillo, J. S\'anchez-Sierras, M. Fraser, L. Izzo, M. E. Ravasio, D. Mata S\'anchez, M. A. P. Torres, J. N. D. van Dalen, A. P. C. van Hoof, J. A. Chac\'on, S. Littlefair, V. S. Dhillon, L. Cotter, G. Corcoran, R. A. J. Eyles-Ferris, P. T. O'Brien, D. Stern, V. D'Elia, D. H. Hartmann

58. [Formation of Close Binaries through Massive Black Hole Perturbations and Chaotic Tides](#user-content-link58)
**Authors:** Howard Hao-Tse Huang, Wenbin Lu

59. [Infrared Signatures of Dusty Tori Formed by MHD-Driven Outflows](#user-content-link59)
**Authors:** Ruiyu Pan, Arkaprabha Sarangi

60. [High-resolution radio imaging of TGSSJ1530+1049, a radio galaxy in a dense environment at z=4](#user-content-link60)
**Authors:** K. \'E. Gab\'anyi, S. Frey, L. I. Gurvits, Z. Paragi, K. Perger, A. Saxena, R. A. Overzier, M. Villar-Mart\'in, V. Reynaldi, G. Miley, H. J. A. R\"ottgering, A. Humphrey, Gy. Mez\H{o}

61. [Cosmic Expansion Driven by Gravitational Particle Production: Toward a Complete Cosmological Scenario](#user-content-link61)
**Authors:** P. W. R. Lima, J. A. S. Lima

62. [A new estimate of the zero-point shift of the Gaia DR3 parallaxes obtained from a comparison with VLBI measurements of masers and radio stars](#user-content-link62)
**Authors:** Vadim Vadimovich Bobylev

63. [Towards an anomaly detection pipeline for gravitational waves at the Einstein Telescope](#user-content-link63)
**Authors:** Gianluca Inguglia, Huw Haigh, Kristyna Vitulova, Ulyana Dupletsa

64. [Auto-encoder model for faster generation of effective one-body gravitational waveform approximations](#user-content-link64)
**Authors:** Suyog Garg, Feng-Li Lin, Kipp Cannon

65. [Simulations of structured upflows from plumes and their connection to the solar wind](#user-content-link65)
**Authors:** Kamlesh Bora, Lakshmi Pradeep Chitta, Yajie Chen, Damien Przybylski, David Pontin, Nikil Panyam

66. [Detection of disk-jet co-precession in a tidal disruption event](#user-content-link66)
...
67. [Efficient Reconstruction of Matched-Filter SNR Time Series from Nearby Templates](#user-content-link67)
**Authors:** Yasuhiro Murakami, Tathagata Ghosh, Soichiro Morisaki

68. [Pulsar B1237+25 Aberration/Retardation Analysis from Decimeter to Decameter Wavelength: Challenge to "Radius-to-Frequency Mapping"](#user-content-link68)
**Authors:** Joanna M. Rankin, Vyacheslav Zakharenko, Oleg Ulyanov, Ihor Kravtsov, Pratik Kumar, Jean-Mathias Griessmeier, N. D. Ramesh Bhat, Geoff Wright, Patrick Weltevrede, Fabian Jankowski, Jerome Petri, Gilles Theureau

69. [Bimodular Gravity: Unimodularising Bimetric Scalar-Tensor Gravity](#user-content-link69)
**Authors:** James Hallam, Jo\~ao Magueijo

70. [Testing general relativity with amplitudes of subdominant gravitational-wave modes](#user-content-link70)
**Authors:** Ish Gupta, Purnima Narayan, Lionel London, Shubhanshu Tiwari, Bangalore Sathyaprakash

71. [The Chandra Strong Lens Sample: Measuring the Dynamical States and Relaxation Fraction of a Sample of 28 Strong Lensing Selected Galaxy Clusters](#user-content-link71)
**Authors:** Raven Gassis, Matthew B. Bayliss, Michael McDonald, Keren Sharon, Guillaume Mahler, Michael D. Gladders, Hakon Dahle, Michael K. Florian, Jane R. Rigby, Lauren A. Elicker, M. Riley Owens, Prasanna Adhikari, Gourav Khullar

72. [Investigating magnetic activity cycles in solar-like oscillators using asteroseismic data from the K2 mission](#user-content-link72)
**Authors:** Gleb Berloff, Anne-Marie Broomhall, George T. Hookway, Mikkel N. Lund, Laura Jade Millson, Dmitrii Kolotkov

73. [On the Temporal Variability in the Magnetic Dichotomy of Late M Dwarf Stars](#user-content-link73)
**Authors:** Giuseppina Nigro, Francesco Berrilli, Giuseppe Bono, Dario Del Moro, Luca Giovannelli, Valentina Penza, Raffaele Reda

74. [Magnetic fields in the close neighborhood of LDN 328 core](#user-content-link74)
**Authors:** Shivani Gupta, Archana Soam, Janik Karoly, Chang Won Lee

75. [SN 2016iog: A fast declining Type II-L supernova with an ultra-faint tail, persistently interacting with circumstellar material](#user-content-link75)
**Authors:** Z. -H. Peng, S. Benetti, Y. -Z. Cai, A. Pastorello, G. Valerin, A. Reguitti, A. Fiore, Q. -L. Fang, Z. -Y. Wang, M. Berton, L. Borsato, E. Cappellaro, E. Congiu, N. Elias-Rosa, V. Granata, J. Isern, G. La Mura, P. Ochner, R. Raddi, G. Terreran, L. Tomasella, M. Turatto, S. -Y. Yan, S. -P. Pei, C. -Y. Wu, S. Zha, X. -F. Wang, B. Wang, Y. Pan

76. [Symmetric Bimetric Cosmology: A Minimal Extension of {\Lambda}CDM](#user-content-link76)
**Authors:** Ghani Imadouchene

77. [The hard ultraluminous state of NGC 5055 ULX X-1](#user-content-link77)
**Authors:** N. Cruz-Sanchez, E. A. Saavedra, F. A. Fogantini, F. Garc\'ia, J. A. Combi

78. [Multi Messenger Study of GRB 221009A with VHE Gamma-ray and Neutrino Afterglow from a Gaussian Structured Jet](#user-content-link78)
**Authors:** T. Mondal, S. Razzaque, JC. Joshi, S. Majumder, D. Bose

79. [Orbital Eccentricities Suggest a Gradual Transition from Giant Planets to Brown Dwarfs](#user-content-link79)
**Authors:** Gregory J. Gilbert, Judah Van Zandt, Erik A. Petigura, Steven Giacalone, Andrew W. Howard, Luke B. Handley

80. [Stray Light Correction for the Helioseismic and Magnetic Imager](#user-content-link80)
**Authors:** A. A. Norton, T. L. Duvall, Jr., J. Schou, R. S. Bogart, J. Zhao, C. Rabello-Soares, P. J. Levens, J. T. Hoeksema, C. S. Baldner

81. [Spin precession effects in the phasing formula of eccentric compact binary inspirals till the second post-Newtonian order](#user-content-link81)
**Authors:** Soham Bhattacharyya, Omkar Sridhar

82. [Gravitational--Electromagnetic Coupling on Kerr Spacetime](#user-content-link82)
**Authors:** Fawzi Aly, Dejan Stojkovic

83. [Thermal Quarkyonic Matter and Its Implications for Neutron Star Structure](#user-content-link83)
**Authors:** K. Folias, Ch. C. Moustakidis

84. [KDP as a thermal blocking filter - Deep near IR observations with a warm narrow band filter](#user-content-link84)
**Authors:** J. K. M. Viuho (Cosmic Dawn Center, Niels Bohr Institute, University of Copenhagen, Jagtvej 155A, DK-2200, Copenhagen N, Denmark, Nordic Optical Telescope, Rambla Jose Ana Fernandez Perez 7, ES-38711 Brena Baja, Spain, Department of Physics and Astronomy, Aarhus University, Munkegade 120, DK-8000 Aarhus C, Denmark), A. A. Djupvik (Nordic Optical Telescope, Rambla Jose Ana Fernandez Perez 7, ES-38711 Brena Baja, Spain, Department of Physics and Astronomy, Aarhus University, Munkegade 120, DK-8000 Aarhus C, Denmark), A. N. S{\o}rensen (Cosmic Dawn Center, Niels Bohr Institute, University of Copenhagen, Jagtvej 155A, DK-2200, Copenhagen N, Denmark), D. Kumar (Ferroperm Optics A/S, Stubbeled 7, Tr{\o}r{\o}d, DK-2950 Vedb{\ae}k, Denmark), P. Steiner (Ferroperm Optics A/S, Stubbeled 7, Tr{\o}r{\o}d, DK-2950 Vedb{\ae}k, Denmark), J. P. U. Fynbo (Cosmic Dawn Center, Niels Bohr Institute, University of Copenhagen, Jagtvej 155A, DK-2200, Copenhagen N, Denmark), S. Armas (Nordic Optical Telescope, Rambla Jose Ana Fernandez Perez 7, ES-38711 Brena Baja, Spain, Department of Physics and Astronomy, Aarhus University, Munkegade 120, DK-8000 Aarhus C, Denmark), M. I. Andersen (Cosmic Dawn Center, Niels Bohr Institute, University of Copenhagen, Jagtvej 155A, DK-2200, Copenhagen N, Denmark)

85. [Spectral-Timing Evolution of a Black hole X-ray binary Swift J1727.8-1613: Linking Disk Reflection and Type-C QPO Frequency During the 2023 Outburst](#user-content-link85)
**Authors:** Manoj Ghising, Nirpat Subba, Mohammed Tobrej, Binay Rai, Bikash Chandra Paul

86. [Relativistic Maxwell-Bloch Equations with Applications to Astrophysics](#user-content-link86)
**Authors:** Ningyan Fang, Martin Houde, Fereshteh Rajabi, Victor Botez

87. [The Spontaneous Genesis of Solar Prominence Structures Driven by Supergranulation in Three-Dimensional Simulations](#user-content-link87)
**Authors:** Huanxin Chen, Chun Xia, Hechao Chen

88. [Gravitational wave standard sirens from GWTC-3 combined with DESI DR2 and DESY5: A late-universe probe of the Hubble constant and dark energy](#user-content-link88)
**Authors:** Ji-Yu Song, Guo-Hong Du, Tian-Nuo Li, Ling-Feng Wang, Jing-Zhao Qi, Jing-Fei Zhang, Xin Zhang

89. [Spectral component imaging of solar X-ray flares](#user-content-link89)
**Authors:** Muriel Zo\"e Stiefel, Paolo Massa, Alessia Guidetti, Marina Battaglia, S\"am Krucker

90. [Non-Parametric Reconstruction of the Hubble Parameter from the Fourth Gravitational Wave Transient Catalog and DESI Baryonic Acoustic Oscillations](#user-content-link90)
**Authors:** Gr\'egoire Pierra, Alberto Colombo, Simone Mastrogiovanni

91. [Inflation without an Inflaton II: observational predictions](#user-content-link91)
**Authors:** Marisol Traforetti, Mariam Abdelaziz, Daniele Bertacca, Raul Jimenez, Sabino Matarrese, Angelo Ricciardone

92. [High-impact Scientific Software in Astronomy and its creators](#user-content-link92)
**Authors:** Johannes Buchner

93. [The Birth of Gravitational Particle Creation: the Enduring Legacy of Leonard Parker's 1966 Thesis](#user-content-link93)
**Authors:** Antonio Ferreiro, Jose Navarro-Salas, Silvia Pla

94. [Stellar Flares in the TESS Light Curves of Planet-hosting M dwarfs](#user-content-link94)
**Authors:** Benjamin K. Capistrant, Jason Dittmann

95. [Reheating and Inflationary dynamics driven by an inverse tangent potential](#user-content-link95)
**Authors:** Mayur Abhisheki, Prasanta Kumar Das

96. [A model-independent assessment of the late-time dark energy density evolution](#user-content-link96)
**Authors:** Rayff de Souza, Agripino Sousa-Neto, Javier E. Gonz\'alez, Jailson Alcaniz

97. [The X-$\gamma$ detector onboard the POEMMA-Balloon with Radio payload](#user-content-link97)
**Authors:** Matteo Battisti

98. [Upper Bound on the Cosmic Baryon Chemical Potential from Lepton-Flavor Asymmetry](#user-content-link98)
**Authors:** Francesco Di Clemente, Alessandro Drago, Lorenzo Formaggio, Claudia Ratti, Volodymyr Vovchenko, Geetika Yadav

99. [The Atmospheric Response to Large Electron Beam Fluxes in Solar Flares III: Comprehensive Modeling of the Brightest Observed Near-Ultraviolet Continuum Source in an X9 Solar Flare](#user-content-link99)
**Authors:** Adam F. Kowalski (University of Colorado, National Solar Observatory, Laboratory for Atmospheric and Space Physics)

100. [Kerr-Bertotti-Robinson Black Holes Surrounded by a Cloud of Strings](#user-content-link100)
**Authors:** Faizuddin Ahmed, \.Izzet Sakall{\i}, Ahmad Al-Badawi

101. [Through the Heliospheric Lens: Directional Deflection of High-Energy Cosmic-Ray Electrons and Positrons](#user-content-link101)
**Authors:** Stefano Profumo, Aria Koul, Anika Malladi, Ben Schmitt

102. [Natural gradient descent for improving variational inference based classification of radio galaxies](#user-content-link102)
**Authors:** Devina Mohan, Anna M. M. Scaife

103. [Sub-Solar Mass Intermediate Mass Ratio Inspirals: Waveform Systematics and Detection Prospects with Gravitational Waves](#user-content-link103)
**Authors:** Devesh Giri, Bhooshan Gadre

104. [Quintessence: Quadratic potentials](#user-content-link104)
**Authors:** Artur Alho, Claes Uggla

105. [Statistical analysis of eclipsing binaries with monotonic orbital-period variations: A-type W UMa contact systems](#user-content-link105)
**Authors:** Shinjirou Kouzuma

106. [Implications of Mini-EUSO measurements for a space-based observation of UHECRs](#user-content-link106)
**Authors:** Mario Bertaina, Matteo Battisti, JEM-EUSO collaboration

107. [An Unusual Velocity Field in a Sunspot Penumbra](#user-content-link107)
**Authors:** H. Balthasar, C. Denker, A. Diercke, S. J. Gonz\'alez Manrique, C. Kuckein, J. L\"ohner B\"ottcher, R. E. Louis, M. Sobotka, M. Verma

108. [Wide-Field X-ray Polarimetry for High Energy Astronomical Transients: First results of the pathfinder CXPD Cubesat Mission](#user-content-link108)
...
109. [Variable-temperature attenuator calibration method for on-wafer microwave noise characterization of low-noise amplifiers](#user-content-link109)
**Authors:** Anthony J. Ardizzi, Jiayin Zhang, Akim A. Babenko, Kieran A. Cleary, Austin J. Minnich

110. [Chiral Magnetic Effect induced Spectator Process for Leptogenesis](#user-content-link110)
**Authors:** Wei Chao

111. [Vortex creep heating in neutron star cooling with direct Urca processes in heavy neutron stars](#user-content-link111)
**Authors:** Yoonhak Nam, Kazuyuki Sekizawa

112. [Functionality of Ice Line Latitudinal EBM Tenacity (FILLET). Protocol Version 1.1](#user-content-link112)
**Authors:** Rory Barnes, Russell Deitrick, Jacob Haqq-Misra, Shintaro Kadoya, Ramses Ramirez, Paolo Simonetti, Vidya Venkatesan, Thomas J. Fauchez

113. [Multiple Components and Spectral Evolution of BL Lacertae as Revealed by Multiwavelength Variability and SED Modeling](#user-content-link113)
**Authors:** Hanxiao Xia, Ziming Wang, Jianghua Wu, Yue Fang, Shiyu Du

114. [Observations of Five Southern-Hemisphere Cataclysmic Binary Stars](#user-content-link114)
**Authors:** John R. Thorstensen (Department of Physics, Astronomy, Dartmouth College), Annabelle E. Niblett (Department of Physics, Astronomy, Dartmouth College), Shreya Gandhi (Department of Physics, Astronomy, Dartmouth College), Lauren P. Zanarini (Department of Physics, Astronomy, Dartmouth College), Gavin D. Goss (Department of Physics, Astronomy, Dartmouth College), Arnav Singh (Department of Physics, Astronomy, Dartmouth College), Divik Verma (Department of Physics, Astronomy, Dartmouth College), Ryan C. Hickox (Department of Physics, Astronomy, Dartmouth College), Emmanuel A. Durodola (Department of Physics, Astronomy, Dartmouth College), Jiaqi Martin Ying (Department of Physics, Astronomy, Dartmouth College)

115. [Thermal infrared characterization of spatially unresolved resident space objects: Prospects from analytical two-component modeling](#user-content-link115)
**Authors:** Stephen Catsamas, Sarah Caddy, Michele Trenti, Benjamin Metha, Simon Barraclough, Robert Mearns, Airlie Chapman, Rachel Webster

116. [From the Virgo interferometer calibration to the bias and uncertainty of the h(t) detector strain during the O4 run](#user-content-link116)
**Authors:** Cervane Grimaud, Florian Aubin, Beno\^it Mours, Thierry Pradier, Lo\"ic Rolland, Monica Seglar-Arroyo, Hans Van Haevermaet, Pierre Van Hove, Didier Verkindt

117. [The Engineering and Programming Methods Used in Manufacture of Astrolabes and Errors Resulting](#user-content-link117)
**Authors:** Duaa Abdullah

118. [The Great January Comet of 1910 (C/1910 A1): A Key Opportunity Missed by New Zealand Astronomers](#user-content-link118)
**Authors:** John Drummond, Wayne Orchiston, Carolyn Brown, Jonathan Horner

---

## 1. [Modeling stellar convective transport with plumes : II. Transport Properties of Locally and Non-locally driven Convection](https://arxiv.org/abs/2511.12824) <a id="link1"></a>
...
**Comment:** Presents 3D hydrodynamic simulations of stellar convection and proposes a new closure model for convective transport. This is directly relevant to the 'Stellar Models' criterion, as it advances the modeling of stellar interiors and convection zones.
...
## 2. [Chemically primitive dwarf accretion reignites the inner disk assembly of Malin 1](https://arxiv.org/abs/2511.12177) <a id="link2"></a>
...
**Comment:** This paper discusses the accretion of a gas-rich dwarf galaxy onto Malin 1, with evidence from kinematics and stellar populations. The focus on dwarf galaxy accretion, chemically primitive gas, and its impact on the assembly of a larger galaxy is directly relevant to near-field cosmology, specifically the study of dwarf galaxy interactions and their role in galaxy evolution. The work is observational and provides new evidence for discrete, externally driven accretion events.
...
## 3. [Not all cores are equal: Phase-space origins of dynamical friction, stalling and buoyancy](https://arxiv.org/abs/2511.11804) <a id="link3"></a>
...
**Comment:** This paper investigates dynamical friction, core stalling, and buoyancy in galaxies and dark matter halos, with implications for the dynamics of massive objects in dwarf galaxies and massive ellipticals. The discussion of core stalling and black hole coalescence in dwarf galaxies is directly relevant to near-field cosmology and the core-cusp problem.
...
## 4. [Topological Signatures of Heating and Dark Matter in the 21 cm Forest](https://arxiv.org/abs/2511.13092) <a id="link4"></a>
...
**Comment:** This paper uses topological data analysis of the 21 cm forest to probe small-scale physics, specifically focusing on the effects of X-ray heating and dark matter free-streaming during Cosmic Dawn. The work is relevant to near-field cosmology, particularly in its use of the 21 cm forest to constrain dark matter properties and small-scale structure, which is closely related to the substructure and core-cusp problems. The use of topological signatures as a new probe is a novel approach.
...
## 5. [First Light And Reionisation Epoch Simulations (FLARES) XX: Comparing semi-analytic models at high-redshift](https://arxiv.org/abs/2511.11982) <a id="link5"></a>
...
**Comment:** This paper compares several semi-analytic models and a hydrodynamical simulation (EAGLE) for high-redshift galaxy formation, including star formation rates, stellar mass functions, and quenching mechanisms. The discussion of environmental and AGN quenching in satellites, as well as the use of semi-analytic and hydrodynamical models, directly matches the 'Numerical Galaxy Simulations' and 'Star Formation Quenching' criteria. The focus on passive galaxies and quenching mechanisms in satellites is particularly relevant.
...
## 6. [AGN feedback in merging galaxies with a SMUGGLE multiphase ISM](https://arxiv.org/abs/2511.13024) <a id="link6"></a>
...
**Comment:** Presents high-resolution simulations of merging galaxies, including SMC analogs (dwarf galaxy scale), and discusses the interplay of AGN feedback, star formation, and black hole dynamics. The inclusion of SMC-like galaxies and explicit modeling of the multiphase ISM makes this relevant to the 'Numerical Galaxy Simulations' criterion, with some peripheral relevance to outflows and CGM in dwarfs.
...
## 7. [LEGA-C stellar populations scaling relations. II: Dissecting mass-complete archaeological trends and their evolution since z~0.7 with LEGA-C and SDSS](https://arxiv.org/abs/2511.11805) <a id="link7"></a>
...
**Comment:** This paper analyzes stellar population scaling relations and their evolution using LEGA-C and SDSS, focusing on stellar ages, metallicities, and quenching in galaxies. While it discusses quenching and star formation histories, the focus is on relatively massive galaxies (logM/Msun > 10.8), not specifically on dwarfs or resolved star formation histories from CMDs. The work is relevant to star formation quenching but not in the dwarf regime, so relevance is moderate.
...
## 8. [Sub-millimeter galaxies in hierarchical models: revisiting the need for a top-heavy stellar initial mass function with Bayesian optimisation](https://arxiv.org/abs/2511.12550) <a id="link8"></a>
...
**Comment:** This paper uses semi-analytic galaxy formation models to address the need for a top-heavy IMF in starbursts to match sub-millimeter galaxy counts and local galaxy properties. It is relevant to numerical galaxy simulations and the impact of stellar models (IMF) on galaxy evolution, but focuses on high-redshift, massive, dusty galaxies rather than dwarfs or near-field cosmology. Still, the use of semi-analytic models and IMF variations is of moderate relevance.
...
## 10. [Constraining r-process nucleosynthesis with multi-objective Galactic chemical evolution models](https://arxiv.org/abs/2511.13372) <a id="link10"></a>
...
**Comment:** This paper uses galactic chemical evolution models to constrain r-process nucleosynthesis sites and event properties. While it deals with chemical evolution in the Milky Way, it does not focus on dwarf galaxies, resolved star formation histories, or the other core topics. The connection to near-field cosmology is weak, as the focus is on nucleosynthesis rather than galaxy structure or evolution.
...
## 12. [Probing the Nature of Dark Matter Self-Interactions Through Observations of Massive Black Hole Mergers](https://arxiv.org/abs/2511.13220) <a id="link12"></a>
...
**Comment:** The paper explores the ability of LISA to distinguish between cold dark matter and self-interacting dark matter using massive black hole mergers. While it touches on dark matter density profiles (core-cusp), the focus is on massive black holes and not on dwarf galaxies or near-field cosmology. The connection to the core-cusp problem is indirect and not centered on the relevant galaxy scales.
...
## 15. [TransFit-CSM: A Fast, Physically Consistent Framework for Interaction-Powered Transients](https://arxiv.org/abs/2511.13265) <a id="link15"></a>
...
**Comment:** Presents a new, physically consistent framework for modeling interaction-powered transients (e.g., supernovae interacting with circumstellar material). While it advances transient modeling, it does not directly address galaxy evolution, star formation histories, or stellar models.
...
## 16. [The influence of AGN feedback on star formation in red spiral galaxies](https://arxiv.org/abs/2511.12454) <a id="link16"></a>
...
**Comment:** This paper investigates AGN feedback and its role in quenching star formation in red spiral galaxies. While it addresses star formation quenching, the focus is on spiral galaxies (not dwarfs), and the quenching is attributed to AGN rather than environmental or internal processes relevant to dwarfs. Some relevance due to the quenching topic, but not a close match.
...
## 18. [Learning Cosmology from Nearest Neighbour Statistics](https://arxiv.org/abs/2511.13393) <a id="link18"></a>
...
**Comment:** This paper presents a new method for extracting cosmological parameters from galaxy/halo catalogues using nearest neighbour statistics and neural networks. While it is cosmology-focused and uses galaxy/halo catalogues, it does not specifically address near-field cosmology, satellite galaxies, resolved star formation histories, or galaxy simulations with new physics. The work is more about cosmological parameter inference than the structure or evolution of galaxies themselves.
...
## 21. [Pre-Supernova Multiple Giant Eruptions in Massive Stars](https://arxiv.org/abs/2511.12312) <a id="link21"></a>
...
**Comment:** Studies pre-supernova eruptions in massive stars, focusing on stellar evolution and mass loss. While it involves stellar models, it is not about new stellar evolutionary tracks or atmosphere models, but rather the behavior of massive stars before supernova. No direct match to the core criteria.
...
## 22. [Metallicity Effects on Machine Learning Classification of Dusty Stellar Sources in the Magellanic Clouds](https://arxiv.org/abs/2511.12210) <a id="link22"></a>
...
**Comment:** This paper examines the effect of metallicity on machine learning classification of dusty stellar sources in the Magellanic Clouds. While it involves the Magellanic Clouds (dwarf galaxies), the focus is on classification methodology and not on star formation histories, quenching, or galaxy simulations. The connection to the core topics is weak.
...
## 23. [The homogeneity scale in the Local Universe: model-independent estimate from S-PLUS DR4 blue galaxies](https://arxiv.org/abs/2511.12532) <a id="link23"></a>
...
**Comment:** This paper estimates the homogeneity scale in the local universe using blue galaxies from S-PLUS. While it uses local galaxies, the focus is on large-scale structure and homogeneity, not on near-field cosmology, resolved star formation histories, or the other core topics.
...
## 24. [IdentYS: A Python-Based Tool for Identifying Young Stars in Star-Forming Regions](https://arxiv.org/abs/2511.12696) <a id="link24"></a>
...
**Comment:** Presents a tool for identifying young stars in star-forming regions using IR data. While it is related to star formation, it does not focus on resolved star formation histories from color-magnitude diagrams, nor does it address galaxy-scale processes or simulations. Only tangentially related.
...
## 25. [Clustering effects on the Dark Siren determination of $H_0$: A simulation study](https://arxiv.org/abs/2511.12334) <a id="link25"></a>
...
**Comment:** This paper uses cosmological simulations to study the impact of galaxy clustering on Hubble constant measurements from gravitational wave events. While it uses galaxy simulations, the focus is on cosmological parameter inference, not on galaxy properties or evolution, and does not address any of the core topics directly.
...
## 26. [The PAH 3.4 micron feature as a tracer of shielding in the Orion Bar and NGC 6240](https://arxiv.org/abs/2511.13395) <a id="link26"></a>
...
**Comment:** This paper analyzes PAH features in the Orion Bar and NGC 6240 to trace ISM shielding and physical conditions. While it provides diagnostics for the ISM in external galaxies, it does not focus on dwarf galaxies, resolved star formation histories, quenching, or the CGM of dwarfs. The work is more about ISM diagnostics in general galaxies, not specifically aligned with the core topics.
...
## 27. [Constraining the Neutral Hydrogen Fraction from SKA Simulated Observation using a Double-Gaussian Decomposition Technique](https://arxiv.org/abs/2511.13370) <a id="link27"></a>
...
**Comment:** This paper presents a method to extract the neutral hydrogen fraction from simulated SKA observations of the Epoch of Reionization. While it deals with neutral hydrogen and reionization, it does not focus on resolved star formation histories, dwarf galaxies, or the circumgalactic medium in the context of the specified criteria.
...
## 28. [Towards Mitigating Systematics in Large-Scale Surveys via Few-Shot Optimal Transport-Based Feature Alignment](https://arxiv.org/abs/2511.11787) <a id="link28"></a>
...
**Comment:** This paper proposes a method for mitigating systematics in large-scale surveys using feature alignment, with an application to maps of neutral hydrogen. While it touches on large-scale structure and HI, it does not directly address the circumgalactic medium of dwarf galaxies or the other core topics.
...
## 29. [JWST observes the assembly of a massive galaxy at z~4](https://arxiv.org/abs/2511.13650) <a id="link29"></a>
...
**Comment:** The paper discusses the assembly of a massive galaxy at z~4 using JWST observations. While it involves galaxy formation and interactions, it focuses on a high-redshift, massive system, not dwarf galaxies or near-field cosmology. No direct connection to resolved star formation histories or the other core topics.
...
## 31. [SourceREACH (Source REconstruction of Arcs behind Cluster Halos): A New Source Reconstruction Algorithm Optimized for Giant Arcs and Galaxy Cluster Lenses](https://arxiv.org/abs/2511.11952) <a id="link31"></a>
...
**Comment:** This paper introduces a new source reconstruction algorithm for giant arcs and galaxy cluster lenses. While it deals with gravitational lensing and cluster-scale phenomena, it does not focus on dwarf galaxies, resolved star formation histories, or the other core topics.
...
## 32. [ODIN: Characterizing the Three-dimensional Structure of Two Protocluster Complexes at $z = 3.1$](https://arxiv.org/abs/2511.11826) <a id="link32"></a>
...
**Comment:** Studies the 3D structure of protocluster complexes at z=3.1 using LAEs. Focus is on large-scale structure and protoclusters, not on near-field cosmology, resolved star formation histories, or dwarf galaxies.
...
## 33. [Modeling X-ray photon pile-up with a normalizing flow](https://arxiv.org/abs/2511.11863) <a id="link33"></a>
...
**Comment:** Presents a machine learning approach to modeling X-ray photon pile-up for eROSITA data. While this could be useful for X-ray studies of galaxies, the focus is on detector effects and not on any of the core topics.
...
## 34. [Investigating the Dark Energy Constraint from Strongly Lensed AGN at LSST-Scale](https://arxiv.org/abs/2511.13669) <a id="link34"></a>
...
**Comment:** This paper investigates cosmological constraints from strongly lensed AGN time delays, focusing on dark energy and Hubble constant measurements. While it uses simulations and hierarchical inference, it does not address galaxy formation, evolution, or any of the core topics.
...
## 35. [Examining Turbulence in Galactic Molecular Clouds - II: Continuity of Turbulence Cascading in a Portion of the Local Arm](https://arxiv.org/abs/2511.12418) <a id="link35"></a>
...
**Comment:** This paper examines turbulence in Galactic molecular clouds using CO data. While turbulence and molecular clouds are important for star formation, the focus is not on resolved star formation histories, quenching, or outflows in dwarf galaxies, nor on galaxy simulations.
...
## 36. [Characterization of type Ibn SNe](https://arxiv.org/abs/2511.12362) <a id="link36"></a>
...
**Comment:** This paper characterizes Type Ibn supernovae, focusing on their progenitors, circumstellar material, and explosion properties. While it discusses stellar evolution and binary systems, it does not present new stellar models or address the other core topics.
...
## 37. [The Impact of Orbital Anisotropy Assumptions in Lensing-Dynamics Modeling](https://arxiv.org/abs/2511.12013) <a id="link37"></a>
...
**Comment:** Focuses on massive early-type galaxies and lensing-dynamics modeling, with emphasis on stellar orbital anisotropy and dark matter density profiles. However, the work is on massive galaxies, not dwarfs or satellites, and does not address near-field cosmology or the core-cusp problem in the context of low-mass galaxies. No direct relevance to the specified criteria.
...
## 38. [Observational properties of a Schwarzschild black hole surrounded by a Dehnen-type dark matter halo](https://arxiv.org/abs/2511.13156) <a id="link38"></a>
...
**Comment:** This paper studies the observational properties of a Schwarzschild black hole surrounded by a Dehnen-type dark matter halo, focusing on accretion disk properties. While it involves dark matter, it is not about galaxy-scale dark matter profiles (core-cusp) or near-field cosmology, but rather the effect of DM on black hole observables.
...
## 39. [Hydrodynamic instabilities in long-term three-dimensional simulations of neutrino-driven supernovae of 13 red supergiant progenitors](https://arxiv.org/abs/2511.11796) <a id="link39"></a>
...
**Comment:** This paper presents 3D simulations of Type-IIP supernovae in red supergiant progenitors, focusing on hydrodynamic instabilities and mixing. While it involves numerical simulations, the focus is on supernovae and stellar evolution, not on galaxy-scale simulations or the other core topics.
...
## 40. [Made-to-Measure Outperforms Schwarzschild's Method](https://arxiv.org/abs/2511.12425) <a id="link40"></a>
...
**Comment:** The paper compares made-to-measure and Schwarzschild's methods for stellar dynamical modeling. While these are galaxy modeling techniques, the focus is on general dynamical modeling and not specifically on dwarf galaxies, resolved star formation histories, or the other core topics.
...
## 41. [The physical properties of post-mass-transfer binaries](https://arxiv.org/abs/2511.13692) <a id="link41"></a>
...
**Comment:** This paper focuses on the physical properties of post-mass-transfer binaries, specifically systems with stripped companions. While it involves stellar evolution and binary interactions, it does not present new stellar models or evolutionary tracks, nor does it focus on resolved star formation histories, dwarf galaxies, or galaxy simulations. The topic is largely outside the core interests.
...
## 42. [QuaRT: A toolkit for the exploration of quantum methods for radiation transport](https://arxiv.org/abs/2511.12356) <a id="link42"></a>
...
**Comment:** QuaRT is a toolkit for quantum simulation of radiative transfer, which could be useful for stellar atmosphere modeling, but the abstract does not indicate any direct application to new stellar models or bolometric corrections. No direct match to the core topics.
...
## 43. [Unraveling eMSTO in NGC 2355: Stellar Rotation and Binaries](https://arxiv.org/abs/2511.12496) <a id="link43"></a>

**ArXiv ID:** 2511.12496

**Authors:** Jayanand Maurya, Yu Zhang, Hubiao Niu

**Abstract:** The extended Main Sequence Turn-off (eMSTO) in the open cluster NGC 2355 is investigated using precise astrometry and photometry from Gaia DR3 and spectroscopic data from the Gaia-ESO Survey. We find a clear positive correlation between the rotational velocity (v sin i) and color of eMSTO stars, supporting the role of stellar rotation and gravity darkening in causing the observed color spread. Contrary to predictions from binary tidal-locking scenarios, spatial distribution analysis reveals that fast-rotating stars are preferentially concentrated in the cluster's central regions. This finding provides the observational evidence favoring star-disk interactions during the pre-main-sequence phase, rather than tidal locking in binaries, as the primary mechanism responsible for the origin of rotational spread in eMSTO stars.

**Comment:** This paper focuses on the extended Main Sequence Turn-off (eMSTO) in an open cluster (NGC 2355), investigating the role of stellar rotation and binaries. While it involves stellar evolution and rotation, it does not present new stellar models or evolutionary tracks, nor does it focus on resolved star formation histories of galaxies, dwarf galaxies, or near-field cosmology. The topic is tangential to the core interests, as it is more about stellar cluster dynamics and rotation than the specified criteria.
...
## 45. [Helical Magnetic Field in the Acceleration--Collimation Zone of the M87 Jet](https://arxiv.org/abs/2511.13008) <a id="link45"></a>
...
**Comment:** Focuses on the magnetic field structure in the M87 jet, which is a massive elliptical galaxy and an AGN jet. This is outside the scope of the core topics, which focus on dwarf galaxies, star formation histories, and galaxy simulations.
...
## 46. [AstroMLab 5: Structured Summaries and Concept Extraction for 400,000 Astrophysics Papers](https://arxiv.org/abs/2511.12353) <a id="link46"></a>
...
**Comment:** This paper presents a large dataset and concept extraction for astrophysics papers, which could be a useful tool for literature review but does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. It is a meta-resource rather than a research contribution to the specified areas.
...
## 47. [PDRs4All XX. Haute Couture: Spectral stitching of JWST MIRI-IFU cubes with matrix completion](https://arxiv.org/abs/2511.13377) <a id="link47"></a>
...
**Comment:** This paper introduces a new algorithm for stitching JWST MIRI-IFU data cubes, applied to the Orion Bar. While it is a technical advance in data processing for JWST, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 50. [Mock Observations for the CSST Mission: Multi-Channel Imager--Instrument Simulation](https://arxiv.org/abs/2511.12481) <a id="link50"></a>
...
**Comment:** Describes mock observation and instrument simulation software for the CSST Multi-Channel Imager. While useful for future surveys, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 51. [Mock Observations for the CSST Mission: Integral Field Spectrograph--Instrument Simulation](https://arxiv.org/abs/2511.12483) <a id="link51"></a>
...
**Comment:** This paper describes a simulation tool for the Integral Field Spectrograph on the Chinese Space Station Survey Telescope, focusing on instrument performance and data pipeline development. It does not present new galaxy simulations or address the other core topics.
...
## 52. [Prospects for detecting periodic or sharp fast-time features in the supernova neutrino lightcurve with IceCube](https://arxiv.org/abs/2511.13148) <a id="link52"></a>
...
**Comment:** Discusses detection of fast-time features in supernova neutrino lightcurves with IceCube. While it involves supernovae, it does not address resolved star formation histories, near-field cosmology, or galaxy simulations.
...
## 53. [Near-infrared [P II] and [Fe II] line mapping of Galactic supernova remnants](https://arxiv.org/abs/2511.12891) <a id="link53"></a>
...
**Comment:** Maps [P II] and [Fe II] lines in Galactic supernova remnants to study phosphorus production. While it involves chemical abundances and supernovae, it does not address galaxy evolution, near-field cosmology, or the other specified criteria.
...
## 55. [Sense and Sensitivity - I. Uncertainty analysis of the gas-phase chemistry in AGB outflows](https://arxiv.org/abs/2511.13638) <a id="link55"></a>
...
**Comment:** This paper analyzes the uncertainties in chemical models of AGB outflows. While it involves stellar evolution and chemistry, it does not present new stellar evolutionary or atmosphere models, nor does it address galaxy-scale processes or resolved star formation histories. It is not directly relevant.
...
## 56. [Disk mass predictions for binary neutron star mergers: limitations of proposed symbolic regression models](https://arxiv.org/abs/2511.11887) <a id="link56"></a>
...
**Comment:** This paper discusses the limitations of symbolic regression models for predicting disk mass in binary neutron star mergers. While it is relevant to compact object mergers and their electromagnetic counterparts, it does not address galaxy-scale processes, resolved star formation histories, or near-field cosmology.
...
## 57. [Unveiling the nature of the Einstein Probe transient EP 241021a](https://arxiv.org/abs/2511.13314) <a id="link57"></a>
...
**Comment:** This paper presents a multi-wavelength analysis of a fast X-ray transient, likely a massive stellar explosion (collapsar/SN). While it involves stellar explosions and transients, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 58. [Formation of Close Binaries through Massive Black Hole Perturbations and Chaotic Tides](https://arxiv.org/abs/2511.11965) <a id="link58"></a>
...
**Comment:** This paper models the formation of close binaries via massive black hole perturbations and chaotic tides, with implications for hyper-velocity stars and nuclear transients. It is not related to galaxy evolution, near-field cosmology, or the other core topics.
...
## 60. [High-resolution radio imaging of TGSSJ1530+1049, a radio galaxy in a dense environment at z=4](https://arxiv.org/abs/2511.13651) <a id="link60"></a>
...
**Comment:** This paper presents high-resolution radio imaging of a high-redshift radio galaxy in a dense environment. The focus is on a massive galaxy at z=4, not on dwarf galaxies, resolved star formation histories, or the other core topics.
...
## 61. [Cosmic Expansion Driven by Gravitational Particle Production: Toward a Complete Cosmological Scenario](https://arxiv.org/abs/2511.13392) <a id="link61"></a>
...
**Comment:** Proposes a cosmological model based on gravitational particle production, focusing on cosmic expansion and dark energy. This is not related to the core topics of near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 62. [A new estimate of the zero-point shift of the Gaia DR3 parallaxes obtained from a comparison with VLBI measurements of masers and radio stars](https://arxiv.org/abs/2511.11871) <a id="link62"></a>

**ArXiv ID:** 2511.11871

**Authors:** Vadim Vadimovich Bobylev

**Abstract:** The most complete sample of radio stars and masers with trigonometric parallaxes measured by the VLBI method, common with the Gaia EDR3 and Gaia DR3 catalogs, has been compiled using literature data. The sample contains 151 stars. An analysis of the differences in parallaxes and proper motions of Gaia-VLBI stars has been performed. A new estimate of the systematic shift of the Gaia parallax zero point relative to the inertial coordinate system has been obtained: $\Delta\pi=-0.038\pm0.011$ mas. The obtained estimates of the relative rotation rates confirm the absence of a significant rotation of the Gaia\,DR3 system relative to the extragalactic coordinate system, which in this case is represented by VLBI measurements.

**Comment:** This paper provides a new estimate of the Gaia DR3 parallax zero-point shift using VLBI measurements. While this is important for astrometry, it does not address any of the core topics such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 63. [Towards an anomaly detection pipeline for gravitational waves at the Einstein Telescope](https://arxiv.org/abs/2511.13154) <a id="link63"></a>
...
**Comment:** This paper focuses on anomaly detection for gravitational wave signals, specifically targeting mergers involving intermediate-mass black holes. There is no connection to near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other specified criteria.
...
## 64. [Auto-encoder model for faster generation of effective one-body gravitational waveform approximations](https://arxiv.org/abs/2511.12642) <a id="link64"></a>
...
**Comment:** This paper presents a machine learning model for faster generation of gravitational waveform approximations for compact object mergers. It is not related to galaxy simulations, star formation, or near-field cosmology.
...
## 66. [Detection of disk-jet co-precession in a tidal disruption event](https://arxiv.org/abs/2511.12477) <a id="link66"></a>
...
**Comment:** The paper reports on disk-jet co-precession in a tidal disruption event (TDE). TDEs are not relevant to the core topics, as they do not pertain to galaxy evolution, dwarf galaxies, or star formation histories.
...
## 67. [Efficient Reconstruction of Matched-Filter SNR Time Series from Nearby Templates](https://arxiv.org/abs/2511.12894) <a id="link67"></a>
...
**Comment:** This paper presents a computational method for gravitational wave data analysis, specifically for compact binary coalescences. It is unrelated to the core topics.
...
## 68. [Pulsar B1237+25 Aberration/Retardation Analysis from Decimeter to Decameter Wavelength: Challenge to "Radius-to-Frequency Mapping"](https://arxiv.org/abs/2511.12716) <a id="link68"></a>
...
**Comment:** This paper analyzes pulsar emission profiles and challenges the radius-to-frequency mapping paradigm. It does not address any of the core topics.
...
## 69. [Bimodular Gravity: Unimodularising Bimetric Scalar-Tensor Gravity](https://arxiv.org/abs/2511.13562) <a id="link69"></a>
...
**Comment:** This paper presents a new theoretical framework for gravity (bimodular gravity) and its cosmological implications. It does not address any of the core topics.
...
## 70. [Testing general relativity with amplitudes of subdominant gravitational-wave modes](https://arxiv.org/abs/2511.11886) <a id="link70"></a>
...
**Comment:** Presents a test of general relativity using gravitational wave higher-order modes. Focus is on strong-field gravity and GW data analysis, not on galaxies, star formation, or stellar models.
...
## 71. [The Chandra Strong Lens Sample: Measuring the Dynamical States and Relaxation Fraction of a Sample of 28 Strong Lensing Selected Galaxy Clusters](https://arxiv.org/abs/2511.12707) <a id="link71"></a>
...
**Comment:** Examines the dynamical state of strong lensing-selected galaxy clusters. The focus is on massive clusters, not dwarf galaxies or near-field cosmology, and does not address any of the specified topics.
...
## 72. [Investigating magnetic activity cycles in solar-like oscillators using asteroseismic data from the K2 mission](https://arxiv.org/abs/2511.13398) <a id="link72"></a>
...
**Comment:** This paper focuses on magnetic activity cycles in solar-like oscillators using asteroseismic data. While it involves stellar physics and asteroseismology, it does not present new stellar evolutionary or atmosphere models, nor does it address resolved star formation histories, near-field cosmology, or galaxy simulations. It is not directly relevant to the core topics.
...
## 74. [Magnetic fields in the close neighborhood of LDN 328 core](https://arxiv.org/abs/2511.13427) <a id="link74"></a>

**ArXiv ID:** 2511.13427

**Authors:** Shivani Gupta, Archana Soam, Janik Karoly, Chang Won Lee

**Abstract:** Linearly polarized dust emission traces the plane-of-sky magnetic field structure, thus allowing us to investigate the role of magnetic fields in the formation and evolution of cloud cores. In this work, we present observations of dust polarization at 850 $\mu{\rm m}$ wavelength toward the LDN\,328 (hereafter, L328) core and its neighborhood regions, classified as R1, R2, and R3, using the James Clerk Maxwell Telescope (JCMT) with SCUBA-2/POL-2. This study extends our previous work on magnetic fields in L328 across different spatial scales. We used the JCMT/POL-2 data in the near vicinity of the L328 core to study the magnetic fields in its nearby regions. We identified clumps in these regions using the \texttt{FellWalker} algorithm and derived the dust temperature and column density by fitting the spectral energy distribution (SED) using combined JCMT and \textit{Herschel} dust continuum maps. We analyzed the magnetic field morphology in the vicinity of the L328 core and employed the structure function analysis to determine the magnetic field dispersion angle. We used the modified Davis-Chandrasekhar-Fermi (DCF) method to estimate magnetic field strengths and also derived the mass-to-flux ratio and Alfv\'en Mach number.

**Comment:** This paper studies magnetic fields in a molecular cloud core (LDN 328) using dust polarization. It is focused on star formation and magnetic fields in molecular clouds, not on galaxy evolution, near-field cosmology, or resolved star formation histories.
...
## 75. [SN 2016iog: A fast declining Type II-L supernova with an ultra-faint tail, persistently interacting with circumstellar material](https://arxiv.org/abs/2511.12929) <a id="link75"></a>
...
**Comment:** This paper presents observations of a Type II-L supernova and its interaction with circumstellar material. It is focused on supernovae and their progenitors, not on galaxy evolution, near-field cosmology, or resolved star formation histories.
...
## 76. [Symmetric Bimetric Cosmology: A Minimal Extension of {\Lambda}CDM](https://arxiv.org/abs/2511.11929) <a id="link76"></a>
...
**Comment:** Presents a symmetric bimetric cosmological model as an extension of LambdaCDM. The focus is on cosmological theory and not on galaxy formation, evolution, or any of the specified core topics.
...
## 77. [The hard ultraluminous state of NGC 5055 ULX X-1](https://arxiv.org/abs/2511.13686) <a id="link77"></a>
...
**Comment:** This paper focuses on the X-ray properties of an ultraluminous X-ray source (ULX) in NGC 5055, analyzing its accretion state and compact object mass. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM.
...
## 78. [Multi Messenger Study of GRB 221009A with VHE Gamma-ray and Neutrino Afterglow from a Gaussian Structured Jet](https://arxiv.org/abs/2511.13633) <a id="link78"></a>
...
**Comment:** This paper models the afterglow and neutrino emission from a gamma-ray burst (GRB), focusing on jet structure and multi-messenger signals. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 81. [Spin precession effects in the phasing formula of eccentric compact binary inspirals till the second post-Newtonian order](https://arxiv.org/abs/2511.12042) <a id="link81"></a>
...
**Comment:** Focuses on gravitational wave phasing for eccentric compact binary inspirals, which is unrelated to galaxy evolution, near-field cosmology, or any of the specified criteria.
...
## 82. [Gravitational--Electromagnetic Coupling on Kerr Spacetime](https://arxiv.org/abs/2511.13642) <a id="link82"></a>
...
**Comment:** This paper discusses gravitational-electromagnetic coupling in Kerr spacetime, focusing on black hole physics and gravitational waves. It does not address any of the core topics such as near-field cosmology, star formation, or galaxy simulations.
...
## 84. [KDP as a thermal blocking filter - Deep near IR observations with a warm narrow band filter](https://arxiv.org/abs/2511.11806) <a id="link84"></a>
...
**Comment:** This paper discusses the use of KDP as a thermal blocking filter for near-IR observations. It is focused on instrumentation and observational technique, not on any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 85. [Spectral-Timing Evolution of a Black hole X-ray binary Swift J1727.8-1613: Linking Disk Reflection and Type-C QPO Frequency During the 2023 Outburst](https://arxiv.org/abs/2511.12466) <a id="link85"></a>
...
**Comment:** This paper presents a spectral-timing analysis of a black hole X-ray binary during an outburst, focusing on accretion geometry and timing properties. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 86. [Relativistic Maxwell-Bloch Equations with Applications to Astrophysics](https://arxiv.org/abs/2511.11861) <a id="link86"></a>
...
**Comment:** This paper derives relativistic Maxwell-Bloch equations for astrophysical masers and superradiance. It is focused on radiative processes and coherence in astrophysical environments, not on any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 87. [The Spontaneous Genesis of Solar Prominence Structures Driven by Supergranulation in Three-Dimensional Simulations](https://arxiv.org/abs/2511.13252) <a id="link87"></a>
...
**Comment:** This paper presents 3D simulations of solar prominence structures driven by supergranulation. It is focused on solar physics, not on galaxy evolution, near-field cosmology, or the other core topics.
...
## 88. [Gravitational wave standard sirens from GWTC-3 combined with DESI DR2 and DESY5: A late-universe probe of the Hubble constant and dark energy](https://arxiv.org/abs/2511.12017) <a id="link88"></a>
...
**Comment:** This paper is about cosmological parameter estimation (Hubble constant, dark energy) using gravitational wave standard sirens and other late-universe probes. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 90. [Non-Parametric Reconstruction of the Hubble Parameter from the Fourth Gravitational Wave Transient Catalog and DESI Baryonic Acoustic Oscillations](https://arxiv.org/abs/2511.11795) <a id="link90"></a>
...
**Comment:** This paper uses gravitational wave data and BAO to reconstruct the Hubble parameter. It is focused on cosmological parameters and expansion history, not on near-field cosmology, dwarf galaxies, or star formation histories. No direct relevance.
...
## 91. [Inflation without an Inflaton II: observational predictions](https://arxiv.org/abs/2511.11808) <a id="link91"></a>
...
**Comment:** This paper discusses an alternative inflationary scenario and its observational predictions. It is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 92. [High-impact Scientific Software in Astronomy and its creators](https://arxiv.org/abs/2511.12195) <a id="link92"></a>
...
**Comment:** This is a meta-analysis of scientific software in astronomy, not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations (unless the software is specifically for those, which is not indicated).
...
## 93. [The Birth of Gravitational Particle Creation: the Enduring Legacy of Leonard Parker's 1966 Thesis](https://arxiv.org/abs/2511.13518) <a id="link93"></a>
...
**Comment:** This is a historical overview of gravitational particle creation and its impact on quantum field theory in curved spacetime and cosmology. It does not address any of the specified core topics.
...
## 96. [A model-independent assessment of the late-time dark energy density evolution](https://arxiv.org/abs/2511.13666) <a id="link96"></a>
...
**Comment:** Assesses the late-time evolution of dark energy density using cosmological probes. This is not related to any of the specified topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 97. [The X-$\gamma$ detector onboard the POEMMA-Balloon with Radio payload](https://arxiv.org/abs/2511.12364) <a id="link97"></a>
...
**Comment:** Describes an instrument for detecting X-rays and gamma rays from cosmic ray air showers. This is not related to any of the specified galaxy evolution or near-field cosmology topics.
...
## 98. [Upper Bound on the Cosmic Baryon Chemical Potential from Lepton-Flavor Asymmetry](https://arxiv.org/abs/2511.11995) <a id="link98"></a>
...
**Comment:** Studies the cosmic baryon chemical potential in the early universe, focusing on lepton-flavor asymmetry and the QCD transition. This is not related to any of the specified galaxy evolution or near-field cosmology topics.
...
## 100. [Kerr-Bertotti-Robinson Black Holes Surrounded by a Cloud of Strings](https://arxiv.org/abs/2511.11792) <a id="link100"></a>
...
**Comment:** This paper is about black hole solutions in general relativity, specifically Kerr black holes with clouds of strings and magnetic fields. It does not relate to any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 101. [Through the Heliospheric Lens: Directional Deflection of High-Energy Cosmic-Ray Electrons and Positrons](https://arxiv.org/abs/2511.11936) <a id="link101"></a>
...
**Comment:** This paper investigates the effect of the heliosphere on the arrival directions of high-energy cosmic-ray electrons and positrons. It does not address any of the core topics such as near-field cosmology, star formation, or galaxy simulations.
...
## 102. [Natural gradient descent for improving variational inference based classification of radio galaxies](https://arxiv.org/abs/2511.13224) <a id="link102"></a>
...
**Comment:** This paper is about machine learning methods (natural gradient descent) for classifying radio galaxies. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 103. [Sub-Solar Mass Intermediate Mass Ratio Inspirals: Waveform Systematics and Detection Prospects with Gravitational Waves](https://arxiv.org/abs/2511.13324) <a id="link103"></a>
...
**Comment:** This paper discusses gravitational wave detection of sub-solar mass intermediate mass ratio inspirals. It is not related to galaxy evolution, near-field cosmology, or the other core topics.
...
## 104. [Quintessence: Quadratic potentials](https://arxiv.org/abs/2511.12244) <a id="link104"></a>
...
**Comment:** This is a theoretical cosmology paper on quintessence models with quadratic potentials, not related to galaxy formation, dwarf galaxies, or any of the specified core topics.
...
## 107. [An Unusual Velocity Field in a Sunspot Penumbra](https://arxiv.org/abs/2511.13374) <a id="link107"></a>

**ArXiv ID:** 2511.13374

**Authors:** H. Balthasar, C. Denker, A. Diercke, S. J. Gonz\'alez Manrique, C. Kuckein, J. L\"ohner B\"ottcher, R. E. Louis, M. Sobotka, M. Verma

**Abstract:** The photospheric Evershed flow is normally oriented radially outward, yet sometimes opposite velocities are observed not only in the chromosphere but also in the photospheric layers of the penumbra. We study the velocity field in a special case of an active region with two mature sunspots, where one of them formed several days later than the main one. Between the two spots, flux emergence is still ongoing influencing the velocity pattern. We observed the active region NOAA 12146 on August 24, 2014, with the GREGOR Fabry-P\'erot Interferometer (GFPI) and the Blue Imaging Channel (BIC) of the GREGOR solar telescope at Observatorio del Teide on Tenerife. Context data from the Helioseismic and Magnetic Imager (HMI) onboard the Solar Dynamics Observatory (SDO) complement the high-resolution data. In the penumbra of a newly formed spot, we observe opposite Doppler velocity streams of up to +-2 km/s very close to each other. These velocities extend beyond the outer penumbral boundary and cross also the polarity-inversion line. The properties of the magnetic field do not change significantly between these two streams. Although the magnetic field is almost horizontal, we do not detect large transversal velocities in horizontal flow maps obtained with the local correlation technique. The ongoing emergence of magnetic flux in an active region causes flows of opposite directions intruding the penumbra of a pre-existing sunspot.

**Comment:** This paper studies velocity fields in sunspot penumbrae, focusing on solar magnetic activity. It does not match any of the specified criteria.
...
## 108. [Wide-Field X-ray Polarimetry for High Energy Astronomical Transients: First results of the pathfinder CXPD Cubesat Mission](https://arxiv.org/abs/2511.13094) <a id="link108"></a>
...
**Comment:** This paper describes the development and first results of an X-ray polarimetry CubeSat mission. It is focused on instrumentation and high-energy transients, not on galaxies, star formation histories, or stellar models. No direct relevance to the core topics.
...
## 109. [Variable-temperature attenuator calibration method for on-wafer microwave noise characterization of low-noise amplifiers](https://arxiv.org/abs/2511.13619) <a id="link109"></a>
...
**Comment:** Describes a calibration method for microwave noise characterization of low-noise amplifiers, relevant for instrumentation but not for any of the core astrophysical topics.
...
## 110. [Chiral Magnetic Effect induced Spectator Process for Leptogenesis](https://arxiv.org/abs/2511.13051) <a id="link110"></a>
...
**Comment:** This paper discusses leptogenesis and the chiral magnetic effect in the early universe, which is not related to any of the specified core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 111. [Vortex creep heating in neutron star cooling with direct Urca processes in heavy neutron stars](https://arxiv.org/abs/2511.13263) <a id="link111"></a>
...
**Comment:** This paper studies neutron star cooling and vortex creep heating, which is not related to any of the core topics such as galaxy evolution, star formation histories, or galaxy simulations.
...
## 112. [Functionality of Ice Line Latitudinal EBM Tenacity (FILLET). Protocol Version 1.1](https://arxiv.org/abs/2511.11957) <a id="link112"></a>
...
**Comment:** This paper focuses on exoplanet climate modeling using energy balance models (EBMs) and does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models. It is unrelated to the specified criteria.
...
## 113. [Multiple Components and Spectral Evolution of BL Lacertae as Revealed by Multiwavelength Variability and SED Modeling](https://arxiv.org/abs/2511.13317) <a id="link113"></a>

**ArXiv ID:** 2511.13317

**Authors:** Hanxiao Xia, Ziming Wang, Jianghua Wu, Yue Fang, Shiyu Du

**Abstract:** BL Lac has entered an active state since 2020, with multiwavelength observations revealing intense flares. In this study, we conducted 12-night multicolor optical monitoring using an 85 cm telescope from 2020 September to 2024 June and collected long-term broad-band archived data from radio to $\gamma$-rays. Intraday variabilities were detected on four nights, and most of them exhibited a bluer-when-brighter behavior. Both clockwise and counterclockwise spectral hysteresis loops were found within a single night. However, no reliable intraband time lag was detected for the intranight variabilities. On long timescales, the cross-correlation analysis shows that the variations of the optical, X-ray, and $\gamma$-ray bands do not reveal an obvious time delay, while the variations in the radio bands lagged them by about 370 days. The measured time lags suggest two distinct emission regions respectively responsible for the optical to $\gamma$-ray radiation and for the radio radiation, with a spatial separation of approximately $4.50\times10^{19}\ \rm cm$. We modeled the broad-band spectral energy distributions during four flaring epochs and one quiescent epoch, and found evidence for the possible persistent existence of a very high energy emission region. We also confirmed a spectral evolution of the source from an intermediate synchrotron peaked BL Lac object to a low synchrotron peaked BL Lac object.

**Comment:** This paper studies the multiwavelength variability and SED modeling of BL Lacertae, a blazar. It focuses on AGN variability and emission regions, which are not related to the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 115. [Thermal infrared characterization of spatially unresolved resident space objects: Prospects from analytical two-component modeling](https://arxiv.org/abs/2511.13030) <a id="link115"></a>
...
**Comment:** This paper focuses on thermal infrared characterization of satellites and resident space objects, which is unrelated to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 116. [From the Virgo interferometer calibration to the bias and uncertainty of the h(t) detector strain during the O4 run](https://arxiv.org/abs/2511.12566) <a id="link116"></a>
...
**Comment:** This paper discusses the calibration of the Virgo interferometer for gravitational wave detection, which is unrelated to the core topics of galaxy evolution, dwarf galaxies, or star formation histories.
...
## 118. [The Great January Comet of 1910 (C/1910 A1): A Key Opportunity Missed by New Zealand Astronomers](https://arxiv.org/abs/2511.12831) <a id="link118"></a>
...
**Comment:** Historical analysis of the observation of the Great January Comet of 1910 in New Zealand. This is not relevant to any of the core topics.
