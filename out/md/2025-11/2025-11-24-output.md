...
1. [HIDES -- I. The population and diversity of HI-rich 'dark' galaxies in the Hestia and Auriga simulations](#user-content-link1)
**Authors:** Haonan Zheng, Fangzhou Jiang, Shihong Liao, Noam I. Libeskind

2. [RGB Tip distance to the faint gas-rich dwarf KK 153](#user-content-link2)
**Authors:** M. Bellazzini (INAF-OAS), G. Beccari (ESO), R. Pascale (INAF-OAS), D. Paris (INAF-OAR), F. Annibali (INAF-OAS), F. Cusano (INAF-OAS), D. P\'erez-Mill\'an (INAF-OAS)

3. [On the baryon budget in the X-ray-emitting circumgalactic medium of Milky Way-mass galaxies](#user-content-link3)
...
4. [Probing Dark Matter Substructure with Image Number Anomaly in Strong Lensing Systems](#user-content-link4)
**Authors:** Wenlin Hou, Jianxiang Liu, Kai Liao

5. [Multiphase Astrophysics to Unveil the Virgo Environment (MAUVE)](#user-content-link5)
**Authors:** Barbara Catinella, Luca Cortese, Jiayi Sun, Toby Brown, Eric Emsellem, Amelia Fraser-McKelvie, Adam B. Watts, Amy Attwater, Andrew Battisti, Alessandro Boselli, Woorak Choi, Aeree Chung, Elisabete da Cunha, Timothy A. Davis, Sara Ellison, Pavel J\'achym, Maria J. Jimenez-Donaire, Tutku Kolcu, Bumhyun Lee, James McGregor, Ian Roberts, Eva Schinnerer, Kristine Spekkens, Sabine Thater, David Thilker, Jesse van de Sande, Vicente Villanueva, Thomas G. Williams, Nikki Zabel

6. [Data-Driven Stellar Spectral Modelling with GSPICE](#user-content-link6)
**Authors:** Douglas P. Finkbeiner, Joshua S. Speagle, Tanveer Karim

7. [A search for cold molecular outflows in cosmic noon galaxies](#user-content-link7)
**Authors:** Ivanna Langan, Gerg\"o Popping, Michele Ginolfi, Simon Weng, Francesco Valentino, Gareth Jones, Jan Scholtz

8. [Comparing galaxy merger orbits in hydrodynamical simulation and in dark-matter-only simulation](#user-content-link8)
**Authors:** Yahan Pu, Lan Wang, Guangquan Zeng, Lizhi Xie

9. [Finding He II: Testing Novel Models of Binary Populations across Cosmic Time](#user-content-link9)
**Authors:** Beryl Hovis-Afflerbach, Allison L. Strom, Alberto Saldana-Lopez, Sophia R. Flury

10. [Ionizing radiation of [WR] stars: atmospheres and photoionization models](#user-content-link10)
**Authors:** L. V. Da Concei\c{c}\~ao, W. LF. Marcolino, V. Maria

11. [Evolution mapping III: A new recipe for the halo mass function](#user-content-link11)
**Authors:** Andrea Fiorilli, Andr\'es N. Ruiz, Ariel G. Sanchez, Matteo Esposito

12. [CO Multi-line Imaging of Nearby Galaxies (COMING). XI. Azimuthally averaged star formation rate and stellar mass relation with molecular gas amount](#user-content-link12)
**Authors:** Ayumi Kajikawa (Department of Cosmosciences, Graduate School of Science, Hokkaido University), Kazuo Sorai (Department of Cosmosciences, Graduate School of Science, Hokkaido University), Kana Morokuma-Matsui (Institute of Astronomy, Graduate School of Science, The University of Tokyo), Tsutomu T. Takeuchi (Division of Particle and Astronautical Science, Nagoya University), Dragan Salak (Department of Cosmosciences, Graduate School of Science, Hokkaido University), Nario Kuno (Graduate School of Pure and Applied Sciences, University of Tsukuba), Kazuyuki Muraoka (Graduate School of Science, Osaka Metropolitan University), Yusuke Miyamoto (National Astronomical Observatory of Japan), Hiroyuki Kaneko (National Astronomical Observatory of Japan), Yoshiyuki Yajima (Department of Cosmosciences, Graduate School of Science, Hokkaido University), Atsushi Yasuda (Graduate School of Pure and Applied Sciences, University of Tsukuba), Takahiro Tanaka (Graduate School of Pure and Applied Sciences, University of Tsukuba), Kiyoaki Christopher Omori (Division of Particle and Astronautical Science, Nagoya University), Kazuki Shimizu (Department of Cosmosciences, Graduate School of Science, Hokkaido University), Suphakorn Suphapolthaworn (Department of Cosmosciences, Graduate School of Science, Hokkaido University), Kyoko Hama (Department of Cosmosciences, Graduate School of Science, Hokkaido University)

13. [A continuous parameterization of the cosmic web](#user-content-link13)
**Authors:** C. Yamila Yaryura, Mario G. Abadi, Noam I. Libeskind, Stefan Gottl\"ober, Sof\'ia A. Cora, Gustavo Yepes

14. [RUBIX: Differentiable forward modelling of galaxy spectral data cubes for gradient-based parameter estimation](#user-content-link14)
**Authors:** Anna Lena Schaible, Ufuk \c{C}ak{\i}r, Tobias Buck, Harald Mack, Aura Obreja, Nihat Oguz, William H. Oliver, Horea-Alexandru C\u{a}r\u{a}mizaru

15. [The ViSta method for stacking in the Fourier domain and its application to the dusty star-forming galaxies in the ALMA Science Archive](#user-content-link15)
**Authors:** Martina Torsello, Marcella Massardi, Elisabetta Liuzzo, Gayathri Gururaian, Francesca Perrotta, Andrea Lapi

16. [Arp@VST: Legacy Survey of the Arp Peculiar Galaxies with the VST](#user-content-link16)
**Authors:** Marilena Spavone, Chiara Buttitta, Rosa Calvi, Alessandro Loni, the VST Team

17. [A deep ALMA Band 3 survey of HDFS/MUSE3D: Survey description and initial results](#user-content-link17)
**Authors:** Hugo Messias, Laura Gomez, Harold Francke, Bill Dent, Bel\'en Alcalde Pampliega, Ruediger Kneissl, Yiqing Song, Dirk Petry, Paulo Cort\'es, Sergio Mart\'in

18. [Effect of local environment on Ly$\alpha$ line profile in DESI/ODIN LAEs](#user-content-link18)
**Authors:** Ana Sof\'ia M. Uzsoy, Arjun Dey, Anand Raichoor, Douglas P. Finkbeiner, Vandana Ramakrishnan, Kyoung-Soo Lee, Eric Gawiser, Jessica Nicole Aguilar, Steven Ahlen, Abhijeet Anand, Davide Bianchi, David Brooks, Todd Claybaugh, Axel de la Macorra, Peter Doel, Simone Ferraro, Nicole M. Firestone, Andreu Font-Ribera, Jaime E. Forero-Romero, Enrique Gazta\~naga, Lucia Guaita, Gaston Gutierrez, Hiram K. Herrera-Alcantar, Ho Seong Hwang, Mustapha Ishak, Dick Joyce, David Kirkby, Theodore Kisner, Anthony Kremin, Ofer Lahav, Claire Lamman, Martin Landriau, Laurent Le Guillou, Marc Manera, Ramon Miquel, John Moustakas, Andrea Mu\~noz-Guti\'errez, Seshadri Nadathur, Nathalie Palanque-Delabrouille, Will Percival, Claire Poppett, Francisco Prada, Ignasi P\'erez-R\`afols, Graziano Rossi, Eusebio Sanchez, David Schlegel, Michael Schubnell, Hee-Jong Seo, Joseph Harry Silber, Hyunmi Song, David Sprayberry, Gregory Tarl\'e, Benjamin Alan Weaver, Hu Zou

19. [Far-infrared to centimeter emission of very nearby galaxies with archival data](#user-content-link19)
...
20. [Cosmological perturbations on an averaged background](#user-content-link20)
**Authors:** Marco Galoppo, Pierre Mourier

21. [TRAO Survey of the Nearby Filamentary Molecular Clouds, the Universal Nursery of Stars (TRAO-FUNS). IV. Filaments and Dense Cores in the W40 and Serpens South Regions of Aquila](#user-content-link21)
...
22. [Deep Investigation of Neutral Gas Origins (DINGO): Options for robust Deep Spectral Line Imaging in the SKA-Era](#user-content-link22)
**Authors:** Jonghwan Rhee, Richard Dodson, Alexander Williamson, Martin Meyer, Krist\'of Rozgony, Pascal J. Elahi, Matthew Whiting, Daniel Mitchell, Tobias Westmeier

23. [Orbital parameters of the bright binary alpha Draconis based on amateur spectra from the STAROS database](#user-content-link23)
**Authors:** G. Bertrand, C. Buil, M. Le Lain, V. Desnoux, O. Garde, E. Bertrand, A. Blais, JJ. Broussat, E. Bryssinck, L. Dalbin, X. Dupont, A. Garrig\'os, M. DiLazzaro, R. Leadbeater, V. Lecocq, J. Lecomte, A. Leduc, P. Louis, A. Maetz, L. Rib\'e de Pont, A. Stiewing, S. de Visscher, F. Weil

24. [In-depth analysis of the clustering of dark matter particles around primordial black holes. Part II. Analytical prescriptions for spikes](#user-content-link24)
**Authors:** Julien Lavalle, Pierre Salati

25. [Morphological Image Similarity Search on the ALMA Science Archive Query Interface Using Deep Unsupervised Contrastive Representation Learning](#user-content-link25)
...
26. [A study of transients from ground-based surveys reveals new AM CVn stars](#user-content-link26)
...
27. [Spectral synthesis techniques for supernovae and kilonovae](#user-content-link27)
**Authors:** Anders Jerkstrand

28. [Angular clustering and bias of photometric quasars in the Kilo-Degree Survey Data Release 4](#user-content-link28)
**Authors:** Anjitha John William, Maciej Bilicki, Wojciech A. Hellwing, Szymon J. Nakoneczny, Priyanka Jalan

29. [Fully self-consistent nova explosion models reproducing light curves of KT Eri, V339 Del, V597 Pup, and SMC NOVA 2016-10a](#user-content-link29)
**Authors:** Mariko Kato, Izumi Hachisu, Hideyuki Saio

30. [Dark Matter Admixed White Dwarfs: A Single-Fluid Approach](#user-content-link30)
**Authors:** Rajasmita Sahoo, Somnath Mukhopadhyay, Mrutunjaya Bhuyan

31. [Pedagogic Null Tests of Dynamical Dark Energy Hints: Reconstructing LambdaCDM with Consistent BAO, CMB, and SNe Mocks](#user-content-link31)
**Authors:** Seokcheon Lee

32. [Deep Learning Analysis of Ions Accelerated at Shocks](#user-content-link32)
**Authors:** Paxson Swierc, Damiano Caprioli, Luca Orusa, Miha Cernetic

33. [WIMP Meets ALP: Coherent Freeze-Out of Dark Matter](#user-content-link33)
**Authors:** Steven Ferrante, Maxim Perelstein, Bingrong Yu

34. [How Significant are Cosmological Collider Signals in the Planck Data?](#user-content-link34)
**Authors:** Petar Suman, Dong-Gang Wang, Wuhyun Sohn, James R. Fergusson, E. P. S. Shellard

35. [A XRISM View of Relativistic Reflection in Cygnus X-1](#user-content-link35)
**Authors:** Paul A. Draghis, Jon M. Miller, Erin Kara, Elisa Costantini, Oluwashina Adegoke, Javier A. Garcia

36. [Quasar clustering and duty cycle measurements at $0\leq z\leq 4$ with the Gaia-unWISE Catalog](#user-content-link36)
**Authors:** Mariona Giner Mascarell, Anna-Christina Eilers, Kate Storey-Fisher

37. [Accelerating the CLEAN algorithm of radio interferometry with convex optimization](#user-content-link37)
**Authors:** Hendrik M\"uller, Mingyu Hsieh, Sanjay Bhatnagar

38. [Which active galaxies might be neutrino emitters?](#user-content-link38)
**Authors:** Shuying Zhou (XMU), Mouyuan Sun (XMU), Guobin Mou (NJNU), Da-bin Lin (GXU), Tong Liu (XMU), Ming-Xuan Lu (GXU), Yongquan Xue (USTC)

39. [Quantifying the impact of selection effects on FRB DM-$z$ relation cosmological inference](#user-content-link39)
**Authors:** Kritti Sharma, Vikram Ravi, Liam Connor, Elisabeth Krause, Pranjal R. S., Dhayaa Anbajagane

40. [The 12CO Gas Structures of Protoplanetary Disks in the Upper Scorpius Region](#user-content-link40)
**Authors:** Luigi Zallio, Giovanni P. Rosotti, Miguel Vioque, Anna Miotello, Sean M. Andrews, Carlo F. Manara, John M. Carpenter, Aaron Empey, Nicol\'as T. Kurtovic, Charles J. Law, Cristiano Longarini, Teresa Paneque-Carre\~no, Richard Teague, Marion Villenave, Hsi-Wei Yen, Francesco Zagaria

41. [Numerical tiling-based simulations of decoherence in multifield models of inflation](#user-content-link41)
**Authors:** Johor D. Pe\~nalba Quispitupa, Guillermo F. Quispe Pe\~na, Jose T. Galvez Ghersi

42. [Effect of the Memory Burden on Primordial Black Hole Hot Spots](#user-content-link42)
**Authors:** Nathaniel Levy, Lucien Heurtier

43. [Fast far-sidelobe modeling for centimeter to sub-millimeter astrophysical observations](#user-content-link43)
**Authors:** Oliver Jeong, Jacques Delabrouille, Michel Piat

44. [The CO-to-H$_2$ conversion factor in the Milky Way's central parsec](#user-content-link44)
**Authors:** Mark Gorski, Lena Murchikova

45. [Turbulence in Core-Collapse Supernovae](#user-content-link45)
**Authors:** David Calvert, Michael Redle, Bibek Gautam, Charles J. Stapleford, Carla Fr\"ohlich, James P. Kneller, Matthias Liebendorfer

46. [Discovering periodic and repeating nuclear transients in the XMM-Newton archives](#user-content-link46)
**Authors:** Natalie A. Webb, Vincent Foustoul, Robbie Webbe, Matteo Bachetti, Erwan Quintin, Laurent Michel

47. [Performance Simulations for Kola: Achieving High-Resolution, Visible-Light AO Correction Over a 1 Arcminute Field](#user-content-link47)
...
48. [Accelerating parameter estimation for parameterized tests of general relativity with gravitational-wave observations](#user-content-link48)
**Authors:** Dhruv Kumar, Ish Gupta, Bangalore Sathyaprakash

49. [An Investigation of Systematic Effects from Background Priors on PSR J0740$+$6620 Radius Estimates using Synthetic NICER and XMM-Newton Data](#user-content-link49)
**Authors:** Isiah M. Holt, M. Coleman Miller, Alexander J. Dittmann, Frederick K. Lamb

50. [Exploring the Cosmological Model Degeneracy with a new evaluate factor G](#user-content-link50)
**Authors:** Yuan-bo Xie, Yun-dong Wu, Wei Hong, Tong-jie Zhang

51. [Radio-Continuum Spectra of Pulsars with Free-Free Thermal Absorption](#user-content-link51)
**Authors:** Mario G. Abadi, Gabriela Castelletti, Namir E. Kassim

52. [Constraining non-minimally coupled squared-Quartic Hilltop Inflation in light of ACT observations](#user-content-link52)
**Authors:** Jureeporn Yuennan, Farruh Atamurotov, Phongpichit Channuie

53. [From Ground to Space: An Overview of the JEM-EUSO Program for the Study of UHECRs and Astrophysical Neutrinos](#user-content-link53)
**Authors:** Zbigniew Plebaniak (on behalf of the JEM-EUSO Collaboration)

54. [An Alternative Explanation for the Helium Star Pulsar Binary J1928$+$1815: The Most Heavyweight Black Widow System to Date](#user-content-link54)
**Authors:** Hang Gong, Alexey Bobrick, Francisco Garz\'on, Deven Bhakta, Thomas Maccarone, Sangita Kumari, Nieves Castro Rodr\'iguez, Antonio Cabrera-Lavers, Arash Bahramian, Jifeng Liu

55. [Gray Spectral Variability in Three Brown Dwarfs Observed by HST/WFC3 Time-Series Observations](#user-content-link55)
**Authors:** Madalyn F. Chapleski, Yifan Zhou

56. [A novel double-rim forebaffle design for centimeter to sub-millimeter astrophysical observations](#user-content-link56)
**Authors:** Jacques Delabrouille, Oliver Jeong, Michel Piat, Alexander Steier

57. [Moving superfluids in the rotating universe](#user-content-link57)
**Authors:** Jose Beltr\'an Jim\'enez, Federico Piazza, Javier Vecino

58. [GSpyNetTreeS: a machine learning solution for glitch localization in time and frequency](#user-content-link58)
**Authors:** Man Leong Chan, Jess McIver, Yannick Lecoeuche, Dhatri Raghunathan, Sof\'ia \'Alvarez-L\'opez, Julian Ding, Annudesh Liyanage, Raymond Ng, Heather Fong

59. [Simulating Disky Broad Line Region Reverberation](#user-content-link59)
**Authors:** Mary Ogborn, Michael Eracleous, Jessie C. Runnoe, Massimo Dotti, Niana N. Mohammed, Collin M. Dabbieri

60. [CLAWDIA: A dictionary learning framework for gravitational-wave data analysis](#user-content-link60)
**Authors:** Miquel Llorens-Monteagudo, Alejandro Torres-Forn\'e, Jos\'e A. Font

61. [Self-bound quark stars with a first-order two-to-three flavor phase transition](#user-content-link61)
**Authors:** G. Teruya, G. Lugones, A. G. Grunfeld

62. [Lord of the (sub-)Rings : Mapping the surface reflectance and spin-axis of Ajisai](#user-content-link62)
**Authors:** Robert J. S Airey, Paul Chote, James A. Blake, James McCormac, Billy Shrive, Don Pollacco, Benjamin F. Cooke

63. [A battle of designs: triangular vs. L-shaped detectors and parity violation in the gravitational-wave background](#user-content-link63)
**Authors:** Hannah Duval, Charles Badger, Mairi Sakellariadou

64. [The nature of UHE source 1LHAASO J1740+0948u and its connection to PSR J1740+1000](#user-content-link64)
**Authors:** Seth Gagnon, Yichao Lin, Alexander Lange, Hui Yang, Noel Klingler, Jeremy Hare, Oleg Kargaltsev

65. [Distributed Acoustic Fiber Sensing for Research Campuses and Large Scientific Infrastructures -- The Hamburg WAVE proto-network](#user-content-link65)
**Authors:** Oliver B\"olt, Luigia Cristiano, Sandy Croatto, Dirk Gajewski, Erik Genthe, Oliver Gerberding, C\'eline Hadziioannou, Conny Hammer, Markus Hoffmann, Katharina-Sophie Isleif, Antonia Kiel, Charlotte M. Krawczyk, Regina Maass, Ingra Barbosa, Norbert Meyners, Reinhardt Rading, Holger Schlarb, Roman Schnabel, Wanda Vossius, Christopher Wollin

66. [Exceptional line and pseudospectrum in black hole spectroscopy](#user-content-link66)
**Authors:** Li-Ming Cao, Ming-Fei Ji, Liang-Bi Wu, Yu-Sen Zhou

67. [Magnetized particle motion and accretion process with shock cone morphology around a decoupled hairy black holes](#user-content-link67)
**Authors:** G. Mustafa, Faisal Javed, S. K. Maurya, A. Ditta, Orhan Donmez, Tayyab Naseer, Abdelmalek Bouzenada, Farruh Atamurotov

68. [Covariance spectrum of MAXI J1820+070: On the nature of the Comptonizing flow](#user-content-link68)
...
69. [Habitable from the start: How initial planetary formation conditions may create habitable worlds](#user-content-link69)
**Authors:** Benjamin J. Farcy, Darryl Z. Seligman, Kathleen E. Mandt, John W. Noonan, Sarah E. Anderson

70. [Validation of optical pathlength stability in a LISA test-bench demonstrator](#user-content-link70)
**Authors:** Shivani Harer, Maxime Vincent, Hubert Halloin, Ouali Acef, Nisrine Arab, Romain Arguel, Axel Arhancet, Damien Bachet, Nathalie Besson, S\'ebastien Bize, Sara Bruhier, Christelle Buy, Michael Carle, Jean-Pierre Coulon, Nicoleta Dinu-Jaeger, Mathieu Dupont, Christophe Fabron, R\'emi Granelli, David Holleville, Dominique Huet, Eric Kajfasz, Mickael Lacroix, Matthieu Laporte, Michel Lintz, Christophe Meessen, Mourad Merzougui, Alexis Mehlman, Marco Nardello, Laure Oudda, Benjamin Pointard, Pierre Prat, Emmanuelle Rivi\`ere, J\'er\^ome Royon, Aur\'elia Secroun, Samuel Sube, Thomas Zerguerras, Julien Zoubian

71. [No Pulsar Detected in Reprocessed Archival Parkes Observations of SNR 1987A](#user-content-link71)
**Authors:** Fronefield Crawford, Haoyang Xu

72. [Growth of Cosmic Strings with Field-Dependent Tension](#user-content-link72)
**Authors:** Luca Brunelli

73. [Exploring Emission Line Variability and Jet-Broad Line Region Interaction in the Blazar TON 599](#user-content-link73)
**Authors:** Jonhatan U. Guerrero-Gonz\'alez, Vahram Chavushyan, V\'ictor M. Pati\~no-\'Alvarez

74. [Solar Cycle 25 Dynamics from Observational and Statistical Parameters: Characterization of the Maximum Phase and Rotational Behaviour](#user-content-link74)
**Authors:** Homer D\'avila Guti\'errez

75. [The 59th Karl Jansky Lecture: Discovering the Radio Universe](#user-content-link75)
**Authors:** K. I. Kellermann

---

## 1. [HIDES -- I. The population and diversity of HI-rich 'dark' galaxies in the Hestia and Auriga simulations](https://arxiv.org/abs/2511.16726) <a id="link1"></a>
...
**Comment:** This paper analyzes HI-rich 'dark' galaxies in the Hestia and Auriga simulations, focusing on faint, gas-rich, low-mass galaxies (M_g > -10, M_HI > 10^5 M_sun), including their demographics, HI density profiles, and environmental effects such as ram pressure stripping and past mergers. The work is highly relevant to near-field cosmology (dwarf satellite galaxies, substructure, environmental history) and numerical galaxy simulations (high-res, new physics). Also touches on star formation quenching (little or no current star formation, mean stellar age ~11 Gyr). Multiple criteria matched.
...
## 2. [RGB Tip distance to the faint gas-rich dwarf KK 153](https://arxiv.org/abs/2511.17132) <a id="link2"></a>
...
**Comment:** Presents a resolved stellar photometry study of the faint, gas-rich dwarf galaxy KK 153, measuring its distance via the RGB tip and discussing its star formation history and mass. Highly relevant to near-field cosmology (dwarf galaxy properties, membership, mass function) and resolved star formation histories (CMD-based analysis). Multiple criteria matched.
...
## 3. [On the baryon budget in the X-ray-emitting circumgalactic medium of Milky Way-mass galaxies](https://arxiv.org/abs/2511.17313) <a id="link3"></a>
...
**Comment:** Directly addresses the baryon budget in the X-ray-emitting circumgalactic medium (CGM) of Milky Way-mass galaxies, discussing uncertainties in mass estimates and the importance of future X-ray missions. This matches the 'Circumgalactic Medium' criterion, especially for MW-mass galaxies, and is highly relevant.
...
## 4. [Probing Dark Matter Substructure with Image Number Anomaly in Strong Lensing Systems](https://arxiv.org/abs/2511.16971) <a id="link4"></a>
...
**Comment:** This paper probes dark matter substructure using strong lensing image anomalies, directly addressing the 'Near-Field Cosmology' criterion (substructure, core-cusp, satellite luminosity function). The focus is on constraints for PBHs and fuzzy dark matter, which are highly relevant to the study of dark matter substructure in galaxies.
...
## 5. [Multiphase Astrophysics to Unveil the Virgo Environment (MAUVE)](https://arxiv.org/abs/2511.17028) <a id="link5"></a>
...
**Comment:** The MAUVE project studies environmental quenching and cold gas evolution in Virgo cluster galaxies, with a focus on satellites and resolved star formation, kinematics, and chemical enrichment. This directly matches the 'Star Formation Quenching' and 'Resolved Star Formation Histories' criteria, with additional relevance for circumgalactic medium and environmental effects on satellites. High relevance due to focus on cluster satellites and quenching.
...
## 6. [Data-Driven Stellar Spectral Modelling with GSPICE](https://arxiv.org/abs/2511.16754) <a id="link6"></a>
...
**Comment:** Presents a new data-driven method (GSPICE) for stellar spectral modeling, applied to millions of LAMOST spectra. Directly relevant to the 'Stellar Models' criterion (stellar atmosphere modeling, spectral templates, bolometric corrections).
...
## 7. [A search for cold molecular outflows in cosmic noon galaxies](https://arxiv.org/abs/2511.16733) <a id="link7"></a>
...
**Comment:** This paper searches for cold molecular outflows in star-forming galaxies at cosmic noon, directly addressing the 'Star Formation Driven Outflows' criterion. It also touches on the CGM and the role of outflows in enriching it, which are core topics. The work is observational and focuses on the connection between outflows and the CGM.
...
## 8. [Comparing galaxy merger orbits in hydrodynamical simulation and in dark-matter-only simulation](https://arxiv.org/abs/2511.17060) <a id="link8"></a>
...
**Comment:** This paper compares galaxy merger orbits in hydrodynamical and dark-matter-only simulations using TNG100. It is directly relevant to the 'Numerical Galaxy Simulations' criterion, as it analyzes the impact of baryons on merger orbits and timescales in high-resolution simulations.
...
## 9. [Finding He II: Testing Novel Models of Binary Populations across Cosmic Time](https://arxiv.org/abs/2511.16752) <a id="link9"></a>
...
**Comment:** Compares models of binary populations (BPASS, stripped star models) to rest-UV-optical spectra of high-z galaxies' local analogs, focusing on He II emission and massive star evolution. Relevant to 'Stellar Models' (massive star evolution, binary effects) and, to a lesser extent, resolved star formation histories (spectral analysis of star-forming galaxies).
...
## 10. [Ionizing radiation of [WR] stars: atmospheres and photoionization models](https://arxiv.org/abs/2511.16761) <a id="link10"></a>
...
**Comment:** This paper presents new NLTE expanding atmosphere models for [WR] stars and their impact on planetary nebulae photoionization. It is relevant to the 'Stellar Models' criterion, as it provides new stellar atmosphere models and discusses their impact on ionizing fluxes.
...
## 11. [Evolution mapping III: A new recipe for the halo mass function](https://arxiv.org/abs/2511.16730) <a id="link11"></a>
...
**Comment:** Presents a new recipe for the halo mass function (HMF) using the Evolution Mapping framework, calibrated against N-body simulations. Relevant to numerical galaxy simulations (new modeling of HMF, structure formation history), but does not directly address dwarf galaxies or resolved star formation histories.
...
## 12. [CO Multi-line Imaging of Nearby Galaxies (COMING). XI. Azimuthally averaged star formation rate and stellar mass relation with molecular gas amount](https://arxiv.org/abs/2511.16892) <a id="link12"></a>
...
**Comment:** This paper investigates the relation between star formation rate, stellar mass, and molecular gas in nearby galaxies, including analysis of star formation efficiency and quenching (inside-out quenching). While the sample is mostly massive galaxies, there is direct discussion of star formation quenching and molecular gas depletion, which matches the 'Star Formation Quenching' criterion, albeit with lower weight due to galaxy mass.
...
## 13. [A continuous parameterization of the cosmic web](https://arxiv.org/abs/2511.16744) <a id="link13"></a>
...
**Comment:** Proposes a continuous parameterization of the cosmic web and analyzes how galaxy properties depend on environment using semi-analytic models and cosmological simulations. This matches the 'Numerical Galaxy Simulations' criterion, especially as it uses semi-analytic models and cosmological simulations to study galaxy properties. The focus on environment and galaxy properties is relevant, though not specifically on dwarfs or resolved star formation histories.
...
## 14. [RUBIX: Differentiable forward modelling of galaxy spectral data cubes for gradient-based parameter estimation](https://arxiv.org/abs/2511.17110) <a id="link14"></a>
...
**Comment:** RUBIX is a new pipeline for differentiable forward modeling of galaxy IFU data, which could be relevant for numerical galaxy simulations and potentially for resolved star formation histories if applied to such data. However, the current work is limited to test cases and does not directly address any of the core topics yet.
...
## 15. [The ViSta method for stacking in the Fourier domain and its application to the dusty star-forming galaxies in the ALMA Science Archive](https://arxiv.org/abs/2511.16753) <a id="link15"></a>
...
**Comment:** ViSta is a new method for stacking interferometric data in the Fourier domain, applied to dusty star-forming galaxies in the ALMA archive. While the method itself is technical, its application to DSFGs and CO(3-2) emission could be relevant for studies of star formation and outflows if extended to those topics. However, the current application is more focused on method validation and signal detection than on the physical processes of interest.
...
## 16. [Arp@VST: Legacy Survey of the Arp Peculiar Galaxies with the VST](https://arxiv.org/abs/2511.17175) <a id="link16"></a>
...
**Comment:** Describes a public survey of peculiar/interacting galaxies (Arp catalogue) with deep imaging. While it may provide data relevant to galaxy interactions, the focus is on a broad range of galaxy types, not specifically dwarf satellites, resolved star formation histories, or CGM. Possible peripheral relevance to near-field cosmology, but not a close match.
...
## 17. [A deep ALMA Band 3 survey of HDFS/MUSE3D: Survey description and initial results](https://arxiv.org/abs/2511.16909) <a id="link17"></a>
...
**Comment:** This paper presents a deep ALMA survey of molecular gas in galaxies in a group environment at z>1, focusing on resolved ISM properties and cosmic molecular gas mass densities. While it discusses resolved molecular gas and group environments, it does not focus on dwarf galaxies, satellite systems, or resolved star formation histories from color-magnitude diagrams. The relevance is borderline, as the work may inform galaxy evolution and quenching in group environments, but does not directly address the core topics.
...
## 18. [Effect of local environment on Ly$\alpha$ line profile in DESI/ODIN LAEs](https://arxiv.org/abs/2511.17498) <a id="link18"></a>
...
**Comment:** This paper investigates the Lyα line profile in LAEs as a function of environment, with some discussion of star formation rates and environmental effects. However, the focus is on high-redshift LAEs and protoclusters, not on dwarf galaxies or resolved star formation histories. Borderline relevance for star formation quenching and outflows, but not a direct match.
...
## 19. [Far-infrared to centimeter emission of very nearby galaxies with archival data](https://arxiv.org/abs/2511.17268) <a id="link19"></a>
...
**Comment:** This paper analyzes the integrated SEDs of six nearby galaxies (including LMC, SMC, M31, M33) in the mm-cm range. While it includes the LMC and SMC, the focus is on integrated emission and SED modeling, not on resolved star formation histories, satellite quenching, or near-field cosmology. It is borderline relevant due to the inclusion of nearby dwarf galaxies.
...
## 20. [Cosmological perturbations on an averaged background](https://arxiv.org/abs/2511.17160) <a id="link20"></a>
...
**Comment:** Discusses cosmological perturbations and backreaction effects on large-scale structure growth. While relevant to cosmology, it does not address near-field cosmology, resolved star formation histories, or galaxy-scale simulations as defined in the criteria.
...
## 21. [TRAO Survey of the Nearby Filamentary Molecular Clouds, the Universal Nursery of Stars (TRAO-FUNS). IV. Filaments and Dense Cores in the W40 and Serpens South Regions of Aquila](https://arxiv.org/abs/2511.16978) <a id="link21"></a>
...
**Comment:** Presents results on filamentary molecular clouds and dense core formation, focusing on star formation processes in molecular clouds. While it discusses star formation, it does not address resolved star formation histories from color-magnitude diagrams, galaxy-scale outflows, or dwarf galaxy properties.
...
## 22. [Deep Investigation of Neutral Gas Origins (DINGO): Options for robust Deep Spectral Line Imaging in the SKA-Era](https://arxiv.org/abs/2511.17307) <a id="link22"></a>
...
**Comment:** This paper presents a new method for deep spectral line imaging in radio astronomy, with application to the DINGO survey. While it is a technical advance in data processing for galaxy surveys, it does not directly address any of the core criteria such as resolved star formation histories, dwarf galaxies, or outflows.
...
## 23. [Orbital parameters of the bright binary alpha Draconis based on amateur spectra from the STAROS database](https://arxiv.org/abs/2511.17206) <a id="link23"></a>
...
**Comment:** Presents amateur spectra and orbital analysis of the bright binary alpha Draconis, including atmosphere modeling. While it uses stellar atmosphere models, the focus is on a single bright binary star, not on new models or galaxy-related topics. Borderline relevance to 'Stellar Models'.
...
## 24. [In-depth analysis of the clustering of dark matter particles around primordial black holes. Part II. Analytical prescriptions for spikes](https://arxiv.org/abs/2511.16800) <a id="link24"></a>
...
**Comment:** This paper provides analytical prescriptions for dark matter density spikes around primordial black holes, including implications for indirect detection and constraints on DM annihilation cross-sections. While it is a detailed study of dark matter substructure, it does not focus on galaxies, satellite systems, or resolved star formation histories. The relevance is low, as it is more about DM physics and PBHs than galaxy evolution.
...
## 25. [Morphological Image Similarity Search on the ALMA Science Archive Query Interface Using Deep Unsupervised Contrastive Representation Learning](https://arxiv.org/abs/2511.17061) <a id="link25"></a>
...
**Comment:** Describes a new deep learning-based image similarity search for the ALMA Science Archive. While innovative for data access, it does not address any of the specified astrophysical criteria.
...
## 26. [A study of transients from ground-based surveys reveals new AM CVn stars](https://arxiv.org/abs/2511.16774) <a id="link26"></a>
...
**Comment:** Focuses on AM CVn stars and cataclysmic variables, including their abundances and properties. While it discusses stellar populations and binary evolution, it does not address resolved star formation histories, dwarf galaxies, or galaxy-scale processes.
...
## 27. [Spectral synthesis techniques for supernovae and kilonovae](https://arxiv.org/abs/2511.17084) <a id="link27"></a>
...
**Comment:** Reviews spectral synthesis techniques for supernovae and kilonovae, focusing on computational methods. While it discusses stellar explosions and element production, it does not present new stellar models or address galaxy-scale processes.
...
## 28. [Angular clustering and bias of photometric quasars in the Kilo-Degree Survey Data Release 4](https://arxiv.org/abs/2511.17311) <a id="link28"></a>
...
**Comment:** Studies angular clustering and bias of photometric quasars in KiDS DR4, focusing on large-scale structure and quasar host halo masses. Not focused on dwarf galaxies, resolved star formation histories, or stellar models. No relevant criteria matched.
...
## 30. [Dark Matter Admixed White Dwarfs: A Single-Fluid Approach](https://arxiv.org/abs/2511.17120) <a id="link30"></a>
...
**Comment:** This paper studies the effect of dark matter admixture on white dwarf structure using a single-fluid approach. While it touches on dark matter, it does not focus on near-field cosmology, satellite galaxies, or any of the core topics. The focus is on stellar remnants rather than galaxy formation or evolution.
...
## 31. [Pedagogic Null Tests of Dynamical Dark Energy Hints: Reconstructing LambdaCDM with Consistent BAO, CMB, and SNe Mocks](https://arxiv.org/abs/2511.16703) <a id="link31"></a>
...
**Comment:** This paper performs a null test of dynamical dark energy hints using mock BAO, CMB, and SNe datasets. While it is cosmology-focused, it does not address near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 32. [Deep Learning Analysis of Ions Accelerated at Shocks](https://arxiv.org/abs/2511.17363) <a id="link32"></a>
...
**Comment:** This paper applies deep learning to classify ions accelerated at shocks in kinetic plasma simulations. While it discusses sub-grid models for fluid approaches, it does not focus on galaxy simulations or any of the core topics.
...
## 33. [WIMP Meets ALP: Coherent Freeze-Out of Dark Matter](https://arxiv.org/abs/2511.16731) <a id="link33"></a>
...
**Comment:** This paper discusses a novel mechanism for dark matter freeze-out involving WIMPs and ALPs, but does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or outflows. The focus is on particle physics and cosmological dark matter abundance, not on galaxy-scale phenomena.
...
## 34. [How Significant are Cosmological Collider Signals in the Planck Data?](https://arxiv.org/abs/2511.17500) <a id="link34"></a>
...
**Comment:** Examines cosmological collider signals in Planck data, focusing on primordial non-Gaussianities and inflation. This is not relevant to any of the specified criteria, as it does not address galaxy or stellar astrophysics.
...
## 35. [A XRISM View of Relativistic Reflection in Cygnus X-1](https://arxiv.org/abs/2511.17338) <a id="link35"></a>
...
**Comment:** This paper presents high-resolution X-ray observations of Cygnus X-1, focusing on relativistic reflection and black hole spin. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 37. [Accelerating the CLEAN algorithm of radio interferometry with convex optimization](https://arxiv.org/abs/2511.17410) <a id="link37"></a>
...
**Comment:** This paper presents acceleration techniques for the CLEAN algorithm in radio interferometry. While useful for data processing, it does not address any of the core topics such as galaxy simulations, star formation, or outflows.
...
## 38. [Which active galaxies might be neutrino emitters?](https://arxiv.org/abs/2511.16869) <a id="link38"></a>
...
**Comment:** This work investigates which types of AGN are neutrino emitters, focusing on supermassive black hole accretion phenomena and AGN variability. It does not address any of the core topics such as dwarf galaxies, star formation, or galaxy simulations.
...
## 39. [Quantifying the impact of selection effects on FRB DM-$z$ relation cosmological inference](https://arxiv.org/abs/2511.16850) <a id="link39"></a>
...
**Comment:** The paper quantifies selection effects in FRB DM-z cosmological inference, focusing on FRBs as cosmological probes. It does not address any of the core topics such as galaxy evolution, star formation, or simulations.
...
## 40. [The 12CO Gas Structures of Protoplanetary Disks in the Upper Scorpius Region](https://arxiv.org/abs/2511.16734) <a id="link40"></a>
...
**Comment:** Focuses on protoplanetary disks and their gas structures in a star-forming region. This is not relevant to any of the specified criteria, as it does not address dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 41. [Numerical tiling-based simulations of decoherence in multifield models of inflation](https://arxiv.org/abs/2511.16801) <a id="link41"></a>
...
**Comment:** This paper presents numerical simulations of decoherence in multifield inflation models, which is not directly related to any of the core criteria (no focus on galaxies, star formation, or stellar models).
...
## 42. [Effect of the Memory Burden on Primordial Black Hole Hot Spots](https://arxiv.org/abs/2511.17329) <a id="link42"></a>
...
**Comment:** The paper studies the effect of memory burden on PBH evaporation and the resulting hot spots. While it discusses primordial black holes, the focus is on early universe physics and not on galaxy substructure, near-field cosmology, or any of the other core criteria.
...
## 43. [Fast far-sidelobe modeling for centimeter to sub-millimeter astrophysical observations](https://arxiv.org/abs/2511.16967) <a id="link43"></a>
...
**Comment:** Develops a fast method for modeling telescope far-sidelobes, applied to CMB experiments. Focus is on instrumentation and observational techniques, not on galaxy or stellar physics. No relevant criteria matched.
...
## 44. [The CO-to-H$_2$ conversion factor in the Milky Way's central parsec](https://arxiv.org/abs/2511.16720) <a id="link44"></a>
...
**Comment:** Focuses on the CO-to-H2 conversion factor in the Milky Way's central parsec, specifically the Circumnuclear Disk/Ring around the Galactic Center. This is not relevant to near-field cosmology (which excludes Galactic center studies), nor does it address dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. The topic is molecular gas in the Galactic center, which is explicitly listed as irrelevant.
...
## 45. [Turbulence in Core-Collapse Supernovae](https://arxiv.org/abs/2511.16755) <a id="link45"></a>
...
**Comment:** Studies turbulence in core-collapse supernovae using 3D MHD simulations. While this is a numerical simulation, it is not focused on galaxies, but rather on supernovae. The criteria specifically exclude simulations not focused on galaxies.
...
## 46. [Discovering periodic and repeating nuclear transients in the XMM-Newton archives](https://arxiv.org/abs/2511.17385) <a id="link46"></a>
...
**Comment:** Searches for periodic and repeating nuclear transients in XMM-Newton archives, including TDEs and black hole binaries. While it discusses tidal disruption events and AGN variability, these are explicitly listed as irrelevant unless they connect to star-formation-driven outflows or CGM, which is not the case here.
...
## 47. [Performance Simulations for Kola: Achieving High-Resolution, Visible-Light AO Correction Over a 1 Arcminute Field](https://arxiv.org/abs/2511.17488) <a id="link47"></a>
...
**Comment:** This paper presents performance simulations for a proposed adaptive optics system for Keck I. It is an instrumentation/methods paper and does not address any of the core topics.
...
## 48. [Accelerating parameter estimation for parameterized tests of general relativity with gravitational-wave observations](https://arxiv.org/abs/2511.16879) <a id="link48"></a>
...
**Comment:** Presents a computational method for accelerating parameter estimation in gravitational wave tests of general relativity. This is not relevant to any of the specified criteria, as it does not address galaxy or stellar astrophysics.
...
## 49. [An Investigation of Systematic Effects from Background Priors on PSR J0740$+$6620 Radius Estimates using Synthetic NICER and XMM-Newton Data](https://arxiv.org/abs/2511.16759) <a id="link49"></a>
...
**Comment:** The paper focuses on neutron star radius measurements using synthetic X-ray data. This is not related to any of the core topics such as galaxy evolution, star formation histories, or outflows.
...
## 50. [Exploring the Cosmological Model Degeneracy with a new evaluate factor G](https://arxiv.org/abs/2511.16944) <a id="link50"></a>
...
**Comment:** The paper discusses cosmological model parameter degeneracy and introduces a new data quality factor, but does not address any of the core topics such as galaxy evolution, star formation, or simulations.
...
## 52. [Constraining non-minimally coupled squared-Quartic Hilltop Inflation in light of ACT observations](https://arxiv.org/abs/2511.17216) <a id="link52"></a>
...
**Comment:** The paper discusses inflationary models in light of new cosmological data, focusing on early universe physics and not on any of the core topics such as galaxy evolution, star formation, or simulations.
...
## 53. [From Ground to Space: An Overview of the JEM-EUSO Program for the Study of UHECRs and Astrophysical Neutrinos](https://arxiv.org/abs/2511.17139) <a id="link53"></a>
...
**Comment:** This is an overview of the JEM-EUSO program for UHECRs and astrophysical neutrinos, focusing on detection technology and cosmic ray physics, not on any of the core topics.
...
## 54. [An Alternative Explanation for the Helium Star Pulsar Binary J1928$+$1815: The Most Heavyweight Black Widow System to Date](https://arxiv.org/abs/2511.17248) <a id="link54"></a>
...
**Comment:** Examines a pulsar binary system in the Galactic plane, discussing possible evolutionary scenarios (black widow system vs. helium star). Focus is on compact object binaries, not on galaxies, star formation, or stellar models. No relevant criteria matched.
...
## 55. [Gray Spectral Variability in Three Brown Dwarfs Observed by HST/WFC3 Time-Series Observations](https://arxiv.org/abs/2511.16813) <a id="link55"></a>
...
**Comment:** Study of brown dwarfs' atmospheric variability and modeling. Does not address any of the core topics: near-field cosmology, resolved star formation histories, quenching, stellar models (unless the atmospheric models are considered, but these are for brown dwarfs, not stars), galaxy simulations, outflows, or CGM.
...
## 56. [A novel double-rim forebaffle design for centimeter to sub-millimeter astrophysical observations](https://arxiv.org/abs/2511.16970) <a id="link56"></a>
...
**Comment:** This paper proposes a new forebaffle design for reducing stray radiation in cm to sub-mm observations. It is an instrumentation/methods paper and does not address any of the core topics directly.
...
## 57. [Moving superfluids in the rotating universe](https://arxiv.org/abs/2511.17472) <a id="link57"></a>
...
**Comment:** This paper is a theoretical study of cosmological models with superfluids and rotation, focusing on the dynamics of anisotropic expansion. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or dwarf galaxy properties. The relevance is very low.
...
## 58. [GSpyNetTreeS: a machine learning solution for glitch localization in time and frequency](https://arxiv.org/abs/2511.16861) <a id="link58"></a>
...
**Comment:** This paper presents a machine learning solution for glitch localization in gravitational wave data, which is not related to any of the core criteria.
...
## 59. [Simulating Disky Broad Line Region Reverberation](https://arxiv.org/abs/2511.17334) <a id="link59"></a>
...
**Comment:** Presents a pipeline to simulate disk-like broad line region (BLR) reverberation in AGNs and quasars. Focus is on AGN variability and BLR modeling, not on galaxies, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 60. [CLAWDIA: A dictionary learning framework for gravitational-wave data analysis](https://arxiv.org/abs/2511.16750) <a id="link60"></a>
...
**Comment:** This paper presents a dictionary learning framework for gravitational-wave data analysis. It is unrelated to the core topics.
...
## 61. [Self-bound quark stars with a first-order two-to-three flavor phase transition](https://arxiv.org/abs/2511.16874) <a id="link61"></a>
...
**Comment:** Discusses self-bound quark stars and their equation of state properties. This is not relevant to any of the specified criteria, as it focuses on compact objects and not galaxies or their evolution.
...
## 62. [Lord of the (sub-)Rings : Mapping the surface reflectance and spin-axis of Ajisai](https://arxiv.org/abs/2511.16780) <a id="link62"></a>
...
**Comment:** Presents a method for determining the spin-state of a satellite (Ajisai) using photometry. This is not relevant to any of the specified criteria, as it deals with space debris and satellite characterization, not galaxy or stellar astrophysics.
...
## 63. [A battle of designs: triangular vs. L-shaped detectors and parity violation in the gravitational-wave background](https://arxiv.org/abs/2511.17422) <a id="link63"></a>
...
**Comment:** This paper discusses gravitational wave detector designs and parity violation in the gravitational-wave background, which is not related to any of the core criteria.
...
## 64. [The nature of UHE source 1LHAASO J1740+0948u and its connection to PSR J1740+1000](https://arxiv.org/abs/2511.16764) <a id="link64"></a>
...
**Comment:** This paper analyzes a UHE source and its connection to a pulsar wind nebula, focusing on particle acceleration and transport. It does not address any of the core criteria.
...
## 65. [Distributed Acoustic Fiber Sensing for Research Campuses and Large Scientific Infrastructures -- The Hamburg WAVE proto-network](https://arxiv.org/abs/2511.17141) <a id="link65"></a>
...
**Comment:** Describes distributed acoustic fiber sensing for research campuses and scientific infrastructures, with applications to vibration monitoring. Not related to galaxies, star formation, or stellar models.
...
## 66. [Exceptional line and pseudospectrum in black hole spectroscopy](https://arxiv.org/abs/2511.17067) <a id="link66"></a>
...
**Comment:** Investigates exceptional points and pseudospectra in black hole perturbation theory. This is focused on black hole spectroscopy and mathematical physics, not on any of the core topics.
...
## 67. [Magnetized particle motion and accretion process with shock cone morphology around a decoupled hairy black holes](https://arxiv.org/abs/2511.17137) <a id="link67"></a>
...
**Comment:** Studies magnetized particle motion and accretion processes around decoupled hairy black holes. Focus is on accretion physics and black hole properties, not on galaxies, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 68. [Covariance spectrum of MAXI J1820+070: On the nature of the Comptonizing flow](https://arxiv.org/abs/2511.17285) <a id="link68"></a>
...
**Comment:** Analyzes the covariance spectrum of a black hole X-ray binary, focusing on the nature of the Comptonizing flow. This is a study of accretion physics in X-ray binaries, not related to the core topics.
...
## 69. [Habitable from the start: How initial planetary formation conditions may create habitable worlds](https://arxiv.org/abs/2511.16714) <a id="link69"></a>
...
**Comment:** Discusses how initial planetary formation conditions may create habitable worlds, focusing on bulk planetary chemistry and habitability. This is a planetary science/astrobiology paper, not related to the core topics.
...
## 70. [Validation of optical pathlength stability in a LISA test-bench demonstrator](https://arxiv.org/abs/2511.16749) <a id="link70"></a>
...
**Comment:** This paper describes a test-bench for LISA, focusing on optical pathlength stability for gravitational wave detection. It is unrelated to the core topics.
...
## 71. [No Pulsar Detected in Reprocessed Archival Parkes Observations of SNR 1987A](https://arxiv.org/abs/2511.16706) <a id="link71"></a>
...
**Comment:** This paper reports a non-detection of a pulsar in SNR 1987A. It does not address any of the core criteria.
...
## 72. [Growth of Cosmic Strings with Field-Dependent Tension](https://arxiv.org/abs/2511.16725) <a id="link72"></a>
...
**Comment:** Focuses on cosmic strings and string tension in cosmological backgrounds, not related to galaxies, star formation, or stellar models. No relevant criteria matched.
...
## 74. [Solar Cycle 25 Dynamics from Observational and Statistical Parameters: Characterization of the Maximum Phase and Rotational Behaviour](https://arxiv.org/abs/2511.16788) <a id="link74"></a>
...
**Comment:** This paper analyzes Solar Cycle 25 dynamics and solar rotation using various observational parameters. It is unrelated to the core topics.
...
## 75. [The 59th Karl Jansky Lecture: Discovering the Radio Universe](https://arxiv.org/abs/2511.16779) <a id="link75"></a>
...
**Comment:** Lecture covering the history and prospects of radio astronomy. No direct connection to any of the core topics; this is a broad overview and historical reflection.
