...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 41569    | 6537         | 48106   |
| **Cost**             | $0.08    | $0.05        | $0.14   |

Total arXiv papers: 140

Total scanned papers: 103

Total relevant papers: 78

**Table of contents with paper titles:**

1. [Baryonic Masses and Properties of Gaseous Satellite Galaxies](#user-content-link1)
...
2. [Disk Formation and the Size-sSFR Relation of Dwarf Galaxies](#user-content-link2)
**Authors:** Robel Geda, Akaxia Cruz, Anna C. Wright, Jenny E. Greene, Alyson Brooks, Thomas Quinn, James Wadsley, Ben Keller

3. [Universal numerical convergence criteria for subhalo tidal evolution](#user-content-link3)
**Authors:** Barry T. Chiang, Frank C. van den Bosch, Hsi-Yu Schive

4. [Identifying substructure associations in the Milky Way halo using chemo-kinematic tagging](#user-content-link4)
**Authors:** Kris Youakim, Karin Lind

5. [DiffstarPop: A generative physical model of galaxy star formation history](#user-content-link5)
**Authors:** Alex Alarcon, Andrew P. Hearin, Matthew R. Becker, Gillian Beltz-Mohrmann, Andrew Benson, Sachi Weerasooriya

6. [A Comparison of Galacticus and COZMIC WDM Subhalo Populations](#user-content-link6)
**Authors:** Jack Lonergan, Andrew Benson, Xiaolong Du

7. [Metallicity Gradients in Modern Cosmological Simulations II: The Role of Bursty Versus Smooth Feedback at High-Redshift](#user-content-link7)
...
8. [Accretion-Driven Turbulence in the Circumgalactic Medium](#user-content-link8)
**Authors:** Roy Goldner, Jonathan Stern, Drummond Fielding, Claude-Andr\'e Faucher-Gigu\`ere, Yakov Faerman, Aharon Kakoly

9. [Galaxy Luminosity Function of the Coma Cluster from Deep $u'-g'-r'$ Wendelstein Imaging Data](#user-content-link9)
**Authors:** Raphael Z\"oller, Matthias Kluge, Ralf Bender, Jan-Niklas Pippert, Benjamin Seidel, Claus G\"ossl, Ulrich Hopp, Hanna Kellermann, Christoph Ries, Arno Riffeser, Michael Schmidt, Luis Thomas

10. [Ultra-diffuse Galaxy Analogues in the Subaru Hyper-Suprime Cam Wide-field Clusters](#user-content-link10)
**Authors:** N. A. Makda, S. L. Blyth, R. E. Skelton

11. [Connecting Star Formation in the Milky Way and Nearby Galaxies. I. Comparability of Molecular Cloud Physical Properties](#user-content-link11)
**Authors:** J. W. Zhou, Sami Dib

12. [Jacobi capture as a pathway to off-center massive black hole binaries in dwarf galaxies](#user-content-link12)
**Authors:** Thibaut L. Fran\c{c}ois

13. [IrisML: Neural Posterior Estimation for the Spectral Energy Distribution fitting](#user-content-link13)
**Authors:** Mateusz Kapusta

14. [jFoF: GPU Cluster Finding with Gradient Propagation](#user-content-link14)
**Authors:** Benjamin Horowitz, Adrian E. Bayer

15. [Detecting the IGM metal enrichment with the 2-point correlation function of the flux. Application to the UVES deep spectrum](#user-content-link15)
...
16. [Direct multi-model dark-matter search with gravitational-wave interferometers using data from the first part of the fourth LIGO-Virgo-KAGRA observing run](#user-content-link16)
**Authors:** The LIGO Scientific Collaboration, the Virgo Collaboration, the KAGRA Collaboration

17. [Earth-lens telescope for distant axion-like particle sources with stimulated backward reflection](#user-content-link17)
**Authors:** Taiyo Nakamura, Kensuke Homma

18. [Reproducing Abell 2744 with the HyperMillennium Simulation](#user-content-link18)
...
19. [Dense Circumstellar Medium around Pulsating Massive Stars Powering Interacting Supernovae](#user-content-link19)
**Authors:** Sutirtha Sengupta, Das Sujit, Arkaprabha Sarangi

20. [SN 2024cld: unveiling the complex mass-loss histories of evolved supergiant progenitors to core collapse supernovae](#user-content-link20)
...
21. [High$-z$ [OI] emission lines: ColdSIM simulations and ALMA observations](#user-content-link21)
...
31. [Can galactic magnetic fields diffuse into the voids?](#user-content-link31)
**Authors:** Oindrila Ghosh, Axel Brandenburg, Chiara Caprini, Andrii Neronov, Franco Vazza

32. [Quantifying Spectroscopic Flux Variations Between JWST NIRISS and NIRSpec: Slit Losses in Emission Line Measurements of z$\sim$1-3 Galaxies](#user-content-link32)
**Authors:** Nicol\`o Dalmasso, Peter J. Watson, Tommaso Treu, Michele Trenti, Benedetta Vulcani, Themiya Nanayakkara, Maru\v{s}a Brada\v{c}, Tucker Jones, Kristan Boyett, Xin Wang, Sara Mascia, Laura Pentericci

33. [Constraints on Axion-photon coupling from the Global 21-cm Signal](#user-content-link33)
**Authors:** Hao Jiao

34. [Rediscussion of eclipsing binaries. Paper XXVII. The totally-eclipsing system UZ Draconis](#user-content-link34)
**Authors:** John Southworth

35. [Shooting for the stars: Jet-mode feedback and AGN jet deceleration from stellar mass-loading](#user-content-link35)
**Authors:** Talia M. O'Shea, Sebastian Heinz, Melinda Soares-Furtado, Zsofi Igo, Andrea Merloni

36. [On the adiabatic initial conditions for a particle gas in cosmology](#user-content-link36)
**Authors:** Guillem Dom\`enech

37. [Conditional variational autoencoders for cosmological model discrimination and anomaly detection in cosmic microwave background power spectra](#user-content-link37)
**Authors:** Tian-Yang Sun, Tian-Nuo Li, He Wang, Jing-Fei Zhang, Xin Zhang

38. [String-induced vacuum decay](#user-content-link38)
**Authors:** Aleksandr Chatrchyan, Florian Niedermann, Phoebe Richman-Taylor

39. [Breaking Eternal Inflation: Empirical Viability of a Spontaneous Collapse Scenario](#user-content-link39)
**Authors:** Mar\'ia P\'ia Piccirilli, Gabriel Le\'on, Rosa-Laura Lechuga-Solis, Daniel Sudarsky

40. [Probing Gravity at Large Scales with kSZ-Reconstructed Velocities and CMB Lensing](#user-content-link40)
**Authors:** Raagini Patki, Nicholas Battaglia, Rachel Bean

41. [A Decade of Solar High-Fidelity Spectroscopy and Precise Radial Velocities from HARPS-N](#user-content-link41)
...
42. [Photometric Redshifts in JWST Deep Fields: A Pixel-Based Alternative with DeepDISC](#user-content-link42)
**Authors:** Grant Merz, Ming-Yang Zhuang, Junyao Li, Qian Yang, Yue Shen, Xin Liu, John Franklin Crenshaw

43. [Cosmological and High Energy Physics implications from gravitational-wave background searches in LIGO-Virgo-KAGRA's O1-O4a runs](#user-content-link43)
**Authors:** The LIGO Scientific Collaboration, the Virgo Collaboration, the KAGRA Collaboration

44. [Faint active galactic nuclei supplied 31-75% of hydrogen-ionizing photons at z>5](#user-content-link44)
**Authors:** Mainak Singha, Sangeeta Malhotra, James Ely Rhoads

45. [Supplementing the 2MRS survey: The 2MZoA catalogue](#user-content-link45)
**Authors:** A. C. Schr\"oder

46. [From Shock to Synchrotron: a mini-review on magnetic turbulence in Supernova Remnants](#user-content-link46)
**Authors:** Emanuele Greco

47. [Ion-molecule routes towards cycles in TMC-1. An automated study of the C2H4 + CH2CCH+ reaction](#user-content-link47)
**Authors:** Mar\'ia Mallo, Marcelino Ag\'undez, Carlos Cabezas, Octavio Roncero, Jos\'e Cernicharo, Germ\'an Molpeceres

48. [Production of Gravitational Waves from Preheating and Tachyonic Instabilities](#user-content-link48)
**Authors:** Khursid Alam, Koushik Dutta, Ahamadullah Khan

49. [CMB observables and reheat temperature as a window to models of inflation and freeze-in dark matter production](#user-content-link49)
**Authors:** Anish Ghoshal, Pawe{\l} Koz\'ow, Marek Olechowski, Stefan Pokorski

50. [First Cosmological Constraints from the Joint Analysis of Galaxy Clustering and the Kinetic Sunyaev-Zel'dovich Effect](#user-content-link50)
**Authors:** Shaohong Li, Yi Zheng

51. [Multi-band infrared imaging reveals dusty spiral arcs around the binary B[e] star 3 Puppis](#user-content-link51)
**Authors:** M. Abello, J. Drevon, A. Meilland, A. Domiciano de Souza, F. Millour, R. Flor, J. H. Leftley, C. Paladini, Ph. Stee, A. Matter, S. Lagarde, B. Lopez, P. \'Abrah\'am, J. -C. Augereau, P. Cruzal\`ebes, W. Danchi, T. Henning, T. Juh\'asz, F. Kerschbaum, F. Lykou, P. Priolet, S. Robbe-Dubois, J. Varga, L. B. F. M. Waters, G. Weigelt, S. Wolf, MATISSE collaboration

52. [Constraining the AGN tori at cosmic noon using high-resolution JWST imaging and simultaneous SED fitting](#user-content-link52)
**Authors:** Devang H. Liya, David J. Rosario, Matthaios Charidis

53. [AGN--Host Galaxy Image Decomposition with JWST](#user-content-link53)
**Authors:** Callum Dewsnap (Department of Physics & Astronomy, The University of Western Ontario), Pauline Barmby (Department of Physics & Astronomy, The University of Western Ontario, Institute for Earth & Space Exploration, The University of Western University), Sarah C. Gallagher (Department of Physics & Astronomy, The University of Western Ontario, Institute for Earth & Space Exploration, The University of Western University)

54. [Geometric acceleration in $f(Q,C)$ theories](#user-content-link54)
**Authors:** Mikel Artola, Ismael Ayuso, Ruth Lazkoz, Gonzalo Olmo, Vincenzo Salzano

55. [X-ray and UV Observations of the Young Sun HIP~67522: Evidence of Lyman-alpha Absorption Within the Planetary System](#user-content-link55)
...
56. [A Next-Generation Exoplanet Atmospheric Retrieval Framework NEXOTRANS for Emission Spectroscopy: New Constraints and Atmospheric Characterization of WASP-69b Using JWST NIRCam and MIRI Observations](#user-content-link56)
**Authors:** Tonmoy Deka, Liton Majumdar, Tasneem Basra Khan, Swastik Dewan, Priyankush Ghosh, Debayan Das, Mithun Patra

57. [When Magnetic Field Lines Stretch, Snap, and Expand: A New Look at Solar Flares with L-maps](#user-content-link57)
**Authors:** Maria D. Kazachenko, Yuhong Fan, Andrey N. Afanasyev

58. [Accelerating Radiative Transfer for Planetary Atmospheres by Orders of Magnitude with a Transformer-Based Machine Learning Model](#user-content-link58)
**Authors:** Isaac Malsky, Tiffany Kataria, Natasha E. Batalha, Matthew Graham

59. [Poincar\'e Maps with the Theory of Functional Connections](#user-content-link59)
**Authors:** A. K. de Almeida Jr, Daniele Mortari

60. [Probing cosmic isotropy with Gamma-ray bursts: A dipole and quadrupole analysis of BATSE and Fermi GBM data](#user-content-link60)
**Authors:** Debosi Mondal, Biswajit Pandey, Amit Mondal

61. [A Critical Examination of the PAH Hypothesis](#user-content-link61)
**Authors:** Alan T. Tokunaga, Lawrence S. Bernstein, Takashi Onaka

62. [UV irradiation of ethanol-containing interstellar ice analogs: Photostability in CH3CH2OH:CO mixtures](#user-content-link62)
**Authors:** J. A. DeVine, J. Terwisscha van Scheltinga, S. Ioppolo, K. -J. Chuang, E. F. van Dishoeck, T. Lamberts

63. [Uniturbulence and Alfv\'en Wave Solar Model in MPI-AMRVAC](#user-content-link63)
**Authors:** M. McMurdo, T. Van Doorsselaere, N. Magyar, L. Banovic, D. Lim

64. [Systematic Absence of Low-Confidence Nighttime Fire Detections in VIIRS Active Fire Product: Evidence of Undocumented Algorithmic Filtering](#user-content-link64)
**Authors:** Rohit Rajendra Dhage

65. [The Physical Origin of Periodic Density Structures in the Solar Wind: Coronal Streamers as Magnetohydrodynamic Resonators](#user-content-link65)
**Authors:** Olena Podladchikova

66. [Revisiting the unification of tidal disruption events with polarimetry](#user-content-link66)
**Authors:** H. C. I. Wichern, G. Leloudas, M. Pursiainen, A. Cikota, G. K. Jaisawal, P. Charalampopoulos, M. Bulla, L. Dai, J. P. Anderson, M. Gromadzki, C. P. Guti\'errez, T. E. M\"uller-Bravo, M. Nicholl

67. [Simulating the late stages of WD-BH/NS mergers: an origin for fast X-ray transients and GRBs with periodic modulations](#user-content-link67)
**Authors:** Jun-Ping Chen (SYSU), Rong-Feng Shen (SYSU), Jin-Hong Chen (HKU)

68. [WallGo investigates: Theoretical uncertainties in the bubble wall velocity](#user-content-link68)
**Authors:** Jorinde van de Vis, Philipp Schicho, Lauri Niemi, Benoit Laurent, Joonas Hirvonen, Oliver Gould

69. [SERVIMON: AI-Driven Predictive Maintenance and Real-Time Monitoring for Astronomical Observatories](#user-content-link69)
**Authors:** Emilio Mastriani, Alessandro Costa, Federico Incardona, Kevin Munari, Sebastiano Spinello

70. [Non-uniform Birefringence in Highly-reflective Substrate-Transferred GaAs/Al$_{0.92}$Ga$_{0.08}$As Coatings at 1064 nm](#user-content-link70)
**Authors:** Andri M. Gretarsson, Ambroise L. M. Juston, Benjamin Nicolai, Naomi Borg, Breck N. Meagher, Garrett D. Cole, GariLynn Billingsley, Camille N. Makarem, Elizabeth M. Gretarsson, Gregory M. Harry, Steven D. Penn

71. [Solar Polar Field Reversals as the Result of the Global Magnetic field Meridional Flows](#user-content-link71)
**Authors:** Irina A. Bilenko

72. [Two-Stage Nature of a Solar Flare with Parallel and Semi-Circular Ribbons](#user-content-link72)
**Authors:** Ruifei Huang, Hao Ning, Ze Zhong, Ye Qiu, Zhenyong Hou, Yang Su, Chuan Li, Xiangliang Kong, Yao Chen

73. [Ionospheric responses over the Antarctic region to Intense Space Weather events: Plasma Convection vs. Auroral Precipitation](#user-content-link73)
**Authors:** Sumanjit Chakraborty, Gopi K. Seemala

74. [Diurnal Variations of Lee Wave Clouds on Mars using Emirates eXploration Imager (EXI)](#user-content-link74)
**Authors:** Mariam R. Alshamsi, Mashhoor A. Al-Wardat

75. [Stacking transmission spectra of different exoplanets](#user-content-link75)
**Authors:** James Kirk, James E. Owen

76. [Moonlit sky polarization patterns from Cerro Paranal](#user-content-link76)
...
77. [Scattered light noise due to dust particles contamination in the vacuum pipes of the Einstein Telescope](#user-content-link77)
**Authors:** Andrea Moscatello, Giacomo Ciani, Livia Conti

78. [Observation and Modeling of Shear Evolution of Post-reconnection Flare Loops](#user-content-link78)
**Authors:** Drake Osaben, Jiong Qiu, Dana W. Longcope

---

## 1. [Baryonic Masses and Properties of Gaseous Satellite Galaxies](https://arxiv.org/abs/2510.27019) <a id="link1"></a>
...
**Comment:** Directly matches Near-Field Cosmology and Star Formation Quenching criteria: focuses on gaseous dwarf satellite galaxies, their baryonic masses, abundance, and quenching mechanisms around Milky Way-mass hosts. Also discusses environmental quenching and gas stripping in satellites, which is highly relevant.
...
## 2. [Disk Formation and the Size-sSFR Relation of Dwarf Galaxies](https://arxiv.org/abs/2510.26875) <a id="link2"></a>
...
**Comment:** This paper uses high-resolution cosmological zoom-in simulations of 39 dwarf galaxies to investigate disk formation and the size-sSFR relation. It directly addresses numerical galaxy simulations, the evolution of dwarf galaxies, and the physical processes influencing their structure, making it highly relevant to near-field cosmology and numerical galaxy simulations.
...
## 3. [Universal numerical convergence criteria for subhalo tidal evolution](https://arxiv.org/abs/2510.26901) <a id="link3"></a>
...
**Comment:** Directly addresses numerical convergence criteria for subhalo tidal evolution in cosmological simulations, with a focus on dark matter subhalos and satellite galaxies. This is highly relevant to near-field cosmology, substructure, and numerical galaxy simulations, especially regarding the overmerging problem and simulation resolution.
...
## 7. [Metallicity Gradients in Modern Cosmological Simulations II: The Role of Bursty Versus Smooth Feedback at High-Redshift](https://arxiv.org/abs/2510.26877) <a id="link7"></a>
...
**Comment:** Directly relevant to the 'Star Formation Driven Outflows' and 'Numerical Galaxy Simulations' criteria. The paper analyzes how bursty versus smooth stellar feedback affects metallicity gradients in cosmological simulations, with implications for feedback-driven outflows and metal redistribution. Uses high-resolution simulations (FIRE-2, Thesan, etc.), which is a plus.
...
## 9. [Galaxy Luminosity Function of the Coma Cluster from Deep $u'-g'-r'$ Wendelstein Imaging Data](https://arxiv.org/abs/2510.26889) <a id="link9"></a>

**ArXiv ID:** 2510.26889

**Authors:** Raphael Z\"oller, Matthias Kluge, Ralf Bender, Jan-Niklas Pippert, Benjamin Seidel, Claus G\"ossl, Ulrich Hopp, Hanna Kellermann, Christoph Ries, Arno Riffeser, Michael Schmidt, Luis Thomas

**Abstract:** We derive the $g'$ band galaxy luminosity function (GLF) of quenched red sequence in the Coma cluster from a deep-imaging survey with $\approx1.5\,\mathrm{deg^2}$ around the cluster center. The dataset comprises deep $u'$-, $g'$-, and $r'$-band data obtained with the Wendelstein Wide Field Imager on the 2.1\,m Fraunhofer Wendelstein Telescope reaching median $3\sigma$ surface brightness limits in $10"\times10"$ boxes of $\mathrm{ (30.0\,u',\,\,29.6\,g',\,\,28.7\,r')\,mag\,arcsec^{-2}}$. We measure structural parameters across a large dynamic range in galaxy brightness ($-24.5\,g'\,\mathrm{mag} \lessapprox M\lessapprox-11.3\,g'\,\mathrm{mag}$), from the brightest cluster galaxy to low-luminosity dwarfs, including compact dwarf galaxies and ultra-diffuse galaxies. We automatically identify 5161 cluster member candidates based on their membership on the quiescent sequence in the $u'-g'$ versus $g'-r'$ color--color diagram and their red sequence membership. The structural parameters of bright galaxies are obtained via isophotal modeling, and fully automated parametric image fitting for faint ones. Injection-recovery tests and two identically analyzed reference fields provide statistical corrections for completeness and contamination, yielding a representative GLF that reliably probes the faint end and may serve as a benchmark for future studies. We report a best-fit double Schechter $g'$ band GLF with a comparatively steep faint-end slope $\alpha_2=-1.539^{+0.024}_{-0.024}$. We perform an apples-to-apples comparison with the Coma counterpart in the SLOW simulations, finding overall agreement but a deficit of bright and an excess of dwarf galaxies in the simulation, despite its shallower faint-end slope, highlighting the need for true apples-to-apples comparisons that consider both normalization and slope for a consistent interpretation of the GLF.

**Comment:** This paper presents a deep measurement of the galaxy luminosity function in the Coma cluster, including the faint end and dwarf galaxies. While the Coma cluster is not the Local Group, the focus on the luminosity function and abundance of dwarf galaxies is directly relevant to near-field cosmology and satellite luminosity function studies. The comparison to simulations further increases relevance.
...
## 10. [Ultra-diffuse Galaxy Analogues in the Subaru Hyper-Suprime Cam Wide-field Clusters](https://arxiv.org/abs/2510.27459) <a id="link10"></a>
...
**Comment:** Systematic study of ultra-diffuse galaxy analogues (NUDGEs) in galaxy clusters, including their abundance, properties, and environmental effects. This is relevant to near-field cosmology, satellite luminosity functions, and the abundance of dwarf galaxies, especially in cluster environments.
...
## 11. [Connecting Star Formation in the Milky Way and Nearby Galaxies. I. Comparability of Molecular Cloud Physical Properties](https://arxiv.org/abs/2510.26976) <a id="link11"></a>
...
**Comment:** This paper compares molecular cloud properties and star formation rates in the Milky Way and nearby galaxies using CO data cubes. It directly addresses the physical conditions regulating star formation in molecular clouds, which is relevant to resolved star formation histories and star formation quenching (especially in the context of the Milky Way and nearby galaxies). The analysis of cloud properties and feedback is also tangentially relevant to numerical galaxy simulations.
...
## 12. [Jacobi capture as a pathway to off-center massive black hole binaries in dwarf galaxies](https://arxiv.org/abs/2510.27332) <a id="link12"></a>
...
**Comment:** Touches on Near-Field Cosmology via discussion of off-center black holes in dwarf galaxies and their dynamics in cored dark matter halos, but the main focus is on black hole binary assembly rather than galaxy properties or star formation histories.
...
## 13. [IrisML: Neural Posterior Estimation for the Spectral Energy Distribution fitting](https://arxiv.org/abs/2510.26964) <a id="link13"></a>

**ArXiv ID:** 2510.26964

**Authors:** Mateusz Kapusta

**Abstract:** Over the past 30 years, numerous large-scale photometric astronomical surveys have been conducted, including SDSS, Pan-STARRS, Gaia,2MASS, WISE, and others. These surveys provide extensive photometric measurements that can be used to infer a wide range of physical parameters of astronomical objects. Traditionally, Bayesian approaches, such as Markov Chain Monte Carlo (MCMC) sampling have been employed for such inference tasks. However, these methods tend to be computationally intensive and often require manual tuning or expert supervision. In this work, we propose a novel machine learning model designed to perform automatic and robust inference from photometric data, offering a scalable and efficient alternative to conventional techniques.

**Comment:** Introduces a machine learning model for spectral energy distribution fitting from photometric data. While SED fitting is relevant to stellar models and star formation histories, the abstract does not specify application to resolved star formation histories or new stellar models. The relevance is borderline, as the method could be applied to relevant topics but is not directly focused on them.
...
## 14. [jFoF: GPU Cluster Finding with Gradient Propagation](https://arxiv.org/abs/2510.26851) <a id="link14"></a>
...
**Comment:** Presents a new GPU-native Friends-of-Friends halo finder for simulation analysis and differentiable modeling. While this is a technical advance in simulation analysis, it is only tangentially relevant to numerical galaxy simulations unless the focus is on galaxy-scale structure, which is not specified.
...
## 16. [Direct multi-model dark-matter search with gravitational-wave interferometers using data from the first part of the fourth LIGO-Virgo-KAGRA observing run](https://arxiv.org/abs/2510.27022) <a id="link16"></a>
...
**Comment:** This paper presents new constraints on dark matter models using gravitational-wave interferometers. While dark matter is a relevant topic, the focus here is on particle physics models and direct detection, not on near-field cosmology, galaxy structure, or resolved star formation histories. No direct connection to the core topics such as dwarf galaxies, satellite luminosity functions, or galaxy simulations.
...
## 17. [Earth-lens telescope for distant axion-like particle sources with stimulated backward reflection](https://arxiv.org/abs/2510.27416) <a id="link17"></a>
...
**Comment:** This paper proposes a novel telescope concept for detecting axion-like particles using Earth's gravitational lensing. While it mentions dark matter and stellar streams, the focus is on particle physics detection methods, not on near-field cosmology, galaxy structure, or star formation histories.
...
## 18. [Reproducing Abell 2744 with the HyperMillennium Simulation](https://arxiv.org/abs/2510.27291) <a id="link18"></a>
...
**Comment:** Presents a large cosmological simulation and tests its ability to reproduce a massive galaxy cluster (Abell 2744). While it is a major simulation effort, its focus is on massive clusters and large-scale structure, not on dwarf galaxies, near-field cosmology, or resolved star formation histories.
...
## 19. [Dense Circumstellar Medium around Pulsating Massive Stars Powering Interacting Supernovae](https://arxiv.org/abs/2510.27189) <a id="link19"></a>
...
**Comment:** This paper models the circumstellar medium around massive stars prior to supernovae, focusing on mass loss and CSM density profiles. While it involves stellar models and mass loss, it is focused on massive stars and supernovae, not on dwarf galaxies, galaxy simulations, or resolved star formation histories. Borderline relevance due to connection to stellar models, but not a direct match.
...
## 20. [SN 2024cld: unveiling the complex mass-loss histories of evolved supergiant progenitors to core collapse supernovae](https://arxiv.org/abs/2510.27631) <a id="link20"></a>
...
**Comment:** This paper presents observations of a core-collapse supernova and its circumstellar material, focusing on mass-loss histories of evolved supergiant progenitors. While it discusses stellar evolution and mass loss, it does not present new stellar models or address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 22. [Evolution of stellar magnetic activity: probing planet engulfment by red giants](https://arxiv.org/abs/2510.27295) <a id="link22"></a>
...
**Comment:** Studies stellar magnetic activity and planet engulfment by red giants using LAMOST and Kepler data. The focus is on stellar evolution and activity, not on new stellar models, resolved star formation histories, or dwarf galaxies.
...
## 23. [Euclid: Systematic uncertainties from the halo mass conversion on galaxy cluster number count data analyses](https://arxiv.org/abs/2510.27505) <a id="link23"></a>
...
**Comment:** This paper investigates systematic uncertainties in halo mass conversion for galaxy cluster number count analyses in the context of the Euclid survey. The focus is on cosmological parameter constraints from galaxy clusters, which are much more massive than the dwarf galaxies of interest and do not address the core topics.
...
## 24. [First evidence for the J$>$1 components of the pygmy dipole resonance in neutron-rich nuclei](https://arxiv.org/abs/2510.27125) <a id="link24"></a>
...
**Comment:** This paper focuses on nuclear structure and gamma decay in neutron-rich nuclei, with implications for nucleosynthesis in neutron star mergers. While it touches on element production in the cosmos, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations.
...
## 25. [Revealing cosmological fluctuations in 21cm intensity maps with MeerKLASS: from maps to power spectra](https://arxiv.org/abs/2510.27549) <a id="link25"></a>
...
**Comment:** Focuses on 21cm intensity mapping and cosmological fluctuations with MeerKLASS. While it is a technical advance in cosmological surveys, it does not directly address any of the core topics such as dwarf galaxies, resolved star formation histories, or feedback/outflows.
...
## 30. [The He I D3 Line as a Proxy for Magnetic Activity using EXPRES Solar Observations](https://arxiv.org/abs/2510.27059) <a id="link30"></a>
...
**Comment:** This paper studies the He I D3 line as a proxy for magnetic activity in solar observations, with implications for exoplanet detection. The focus is on stellar activity indicators, not on stellar models (as defined: evolutionary tracks or atmosphere models), nor on galaxy formation or star formation histories.
...
## 31. [Can galactic magnetic fields diffuse into the voids?](https://arxiv.org/abs/2510.26918) <a id="link31"></a>

**ArXiv ID:** 2510.26918

**Authors:** Oindrila Ghosh, Axel Brandenburg, Chiara Caprini, Andrii Neronov, Franco Vazza

**Abstract:** Cosmic voids are magnetized at the level of at least $10^{-17}$ G on Mpc scales, as implied by blazar observations. We show that an electrically conducting plasma is present in the voids, and that, because of the plasma, \emph{diffusion} into the voids of galactic fields generated by a mean-field dynamo is far too slow to explain the present-day void magnetization. Indeed, we show that even in the presence of turbulence in the voids, dynamo-generated galactic fields diffuse out to a galactocentric radius of only 200-400 kpc. Therefore, it is challenging to meet the required volume filling-factor of the void magnetic field. We conclude that a primordial origin remains the most natural explanation to the space-filling weak fields in voids.

**Comment:** This paper investigates the origin of magnetic fields in cosmic voids, specifically whether galactic magnetic fields can diffuse into voids. While it discusses galactic magnetic fields, it does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 32. [Quantifying Spectroscopic Flux Variations Between JWST NIRISS and NIRSpec: Slit Losses in Emission Line Measurements of z$\sim$1-3 Galaxies](https://arxiv.org/abs/2510.27036) <a id="link32"></a>
...
**Comment:** This paper analyzes spectroscopic flux variations between JWST NIRISS and NIRSpec for z~1-3 galaxies, focusing on instrumental effects and emission line measurements. It does not address resolved star formation histories, dwarf galaxies, or any of the core topics.
...
## 33. [Constraints on Axion-photon coupling from the Global 21-cm Signal](https://arxiv.org/abs/2510.27180) <a id="link33"></a>
...
**Comment:** This paper discusses constraints on axion-photon coupling using the global 21-cm signal, which is a cosmological probe. However, it does not focus on near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other core topics. The connection to galaxy formation is indirect via DCBH formation, but not central to the criteria.
...
## 34. [Rediscussion of eclipsing binaries. Paper XXVII. The totally-eclipsing system UZ Draconis](https://arxiv.org/abs/2510.27389) <a id="link34"></a>

**ArXiv ID:** 2510.27389

**Authors:** John Southworth

**Abstract:** UZ Dra is a detached and totally-eclipsing binary containing two late-F stars in a circular orbit of period 3.261 d. It has been observed by the Transiting Exoplanet Survey Satellite in 41 sectors, yielding a total of 664,809 high-quality flux measurements. We model these data and published radial velocities to determine the physical properties of the system to high precision. The masses of the stars are 1.291 +/- 0.012 Msun and 1.193 +/- 0.009 Msun, and their radii are 1.278 +/- 0.004 Rsun and 1.122 +/- 0.003 Rsun. The high precision of the radius measurements is made possible by the (previously unrecorded) total eclipses and the extraordinary amount of data available. The light curves show spot modulation at the orbital period, and both stars rotate synchronously. Our determination of the distance to the system, 185.7 +/- 2.4 pc, agrees very well with the parallax distance of 185.39 +/- 0.39 pc from Gaia DR3. The properties of the system are consistent with theoretical predictions for an age of 600 +/- 200 Myr and a slightly super-solar metallicity.

**Comment:** Detailed study of an eclipsing binary system, focusing on stellar parameters and evolutionary status. While it provides precise stellar measurements, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale topics.
...
## 35. [Shooting for the stars: Jet-mode feedback and AGN jet deceleration from stellar mass-loading](https://arxiv.org/abs/2510.26881) <a id="link35"></a>
...
**Comment:** Focuses on AGN jet feedback and deceleration via stellar mass-loading. While it discusses mass-loading factors, the context is AGN-driven outflows rather than star-formation-driven outflows or dwarf galaxy feedback, so it does not match the core criteria.
...
## 37. [Conditional variational autoencoders for cosmological model discrimination and anomaly detection in cosmic microwave background power spectra](https://arxiv.org/abs/2510.27086) <a id="link37"></a>
...
**Comment:** Focuses on machine learning for CMB power spectra analysis and cosmological model discrimination, which does not match any of the core criteria (no focus on galaxies, satellites, or star formation histories).
...
## 38. [String-induced vacuum decay](https://arxiv.org/abs/2510.27579) <a id="link38"></a>
...
**Comment:** This paper investigates vacuum decay catalyzed by cosmic strings and discusses possible gravitational wave signals. The focus is on fundamental physics and early universe cosmology, not on galaxy formation, near-field cosmology, or star formation histories.
...
## 40. [Probing Gravity at Large Scales with kSZ-Reconstructed Velocities and CMB Lensing](https://arxiv.org/abs/2510.27605) <a id="link40"></a>
...
**Comment:** Presents a new method for measuring the E_G statistic using kSZ and CMB lensing to probe gravity on large scales. The focus is on testing gravity and cosmological models, not on galaxy formation, dwarf galaxies, or any of the core topics.
...
## 41. [A Decade of Solar High-Fidelity Spectroscopy and Precise Radial Velocities from HARPS-N](https://arxiv.org/abs/2510.27635) <a id="link41"></a>
...
**Comment:** Presents a decade of high-fidelity solar spectroscopy and precise radial velocities from HARPS-N. The work is focused on solar-type stars and instrumental precision, not on new stellar models, resolved star formation histories, or galaxy simulations.
...
## 42. [Photometric Redshifts in JWST Deep Fields: A Pixel-Based Alternative with DeepDISC](https://arxiv.org/abs/2510.27032) <a id="link42"></a>
...
**Comment:** This paper presents a new machine learning method for photometric redshift estimation in JWST deep fields. While it is a technical advance in data analysis for extragalactic surveys, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 43. [Cosmological and High Energy Physics implications from gravitational-wave background searches in LIGO-Virgo-KAGRA's O1-O4a runs](https://arxiv.org/abs/2510.26848) <a id="link43"></a>
...
**Comment:** This paper focuses on gravitational-wave background searches and their implications for early Universe physics, including phase transitions, cosmic strings, and primordial black holes. While it is cosmological in nature, it does not address near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on fundamental physics constraints rather than galaxy-scale processes.
...
## 44. [Faint active galactic nuclei supplied 31-75% of hydrogen-ionizing photons at z>5](https://arxiv.org/abs/2510.26990) <a id="link44"></a>
...
**Comment:** This paper analyzes the contribution of faint AGN to hydrogen reionization at high redshift using luminosity functions and escape fractions. The focus is on the ionizing photon budget and reionization, not on near-field cosmology, resolved star formation histories, or dwarf galaxy properties. No direct connection to the core topics.
...
## 45. [Supplementing the 2MRS survey: The 2MZoA catalogue](https://arxiv.org/abs/2510.26979) <a id="link45"></a>

**ArXiv ID:** 2510.26979

**Authors:** A. C. Schr\"oder

**Abstract:** We present a homogeneous 2MASX galaxy catalogue at low Galactic latitudes (|b| <= 10.0 deg, called Zone of Avoidance, ZoA) which is complete to a Galactic extinction-corrected magnitude of Ko  0.95). This catalogue supersedes the previously presented bright 2MZoA catalogue which was only complete to Ko < 11.25 mag. It fully complements the 2MASS Redshift Survey (2MRS) galaxy catalogue, which has the same magnitude limit but excludes high extinction regions. The combination of the two catalogues, the extended 2MRS or e2MRS, is is a uniquely whole sky redshift survey and forms a sound basis for studies of large-scale structures, flow fields and extinction across the ZoA.   The here presented catalogue comprises 6899 galaxies with 6757 galaxies at low latitudes and 142 galaxies in highly obscured high-latitude areas. The completion rate in redshifts is almost 75%. The catalogue is complete up to star density levels of at least log N_*/deg^2  11.75 mag and Ko,d <= 11.75 mag) to the sample. This extended sample shows good completion rates with extinction up to at least AK < 1.3 mag. Omission of such a diameter-dependent extinction correction may lead to a biased flow field even at intermediate extinction values as found in the 2MRS survey. As in our previous investigations, we do not find a dependence of the correction factor f=0.86 to the extinction maps on Galactic longitudes or latitudes, but note a possible influence by cosmic variance.

**Comment:** Presents a galaxy catalogue at low Galactic latitudes (Zone of Avoidance) to supplement the 2MRS survey. The work is focused on large-scale structure and flow fields, not on dwarf galaxies, resolved star formation histories, or other core topics.
...
## 47. [Ion-molecule routes towards cycles in TMC-1. An automated study of the C2H4 + CH2CCH+ reaction](https://arxiv.org/abs/2510.27501) <a id="link47"></a>
...
**Comment:** Focuses on astrochemistry and formation of PAHs in the ISM, not directly related to any of the core criteria.
...
## 48. [Production of Gravitational Waves from Preheating and Tachyonic Instabilities](https://arxiv.org/abs/2510.27586) <a id="link48"></a>
...
**Comment:** This paper analyzes gravitational wave production during preheating in the early universe, focusing on inflationary physics and primordial gravitational waves. It does not address any of the core topics such as galaxy formation, dwarf galaxies, or star formation histories.
...
## 49. [CMB observables and reheat temperature as a window to models of inflation and freeze-in dark matter production](https://arxiv.org/abs/2510.27587) <a id="link49"></a>
...
**Comment:** This paper discusses CMB observables, inflation, and dark matter production mechanisms. It does not address galaxy formation, dwarf galaxies, star formation histories, or any of the core topics.
...
## 50. [First Cosmological Constraints from the Joint Analysis of Galaxy Clustering and the Kinetic Sunyaev-Zel'dovich Effect](https://arxiv.org/abs/2510.27227) <a id="link50"></a>
...
**Comment:** Joint analysis of galaxy clustering and the kSZ effect to constrain cosmological parameters. The work is focused on cosmological parameter estimation and does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 51. [Multi-band infrared imaging reveals dusty spiral arcs around the binary B[e] star 3 Puppis](https://arxiv.org/abs/2510.27591) <a id="link51"></a>
...
**Comment:** Uses multi-band infrared imaging to study dusty spiral arcs around the binary B[e] star 3 Puppis. The focus is on circumstellar environments and binary star interactions, not on galaxy formation, dwarf galaxies, or stellar models.
...
## 53. [AGN--Host Galaxy Image Decomposition with JWST](https://arxiv.org/abs/2510.27214) <a id="link53"></a>
...
**Comment:** Examines AGN-host galaxy image decomposition with JWST, focusing on morphological measurements and fitting techniques. The work is centered on AGN and their host galaxies, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 54. [Geometric acceleration in $f(Q,C)$ theories](https://arxiv.org/abs/2510.27415) <a id="link54"></a>
...
**Comment:** Explores modified gravity theories and their cosmological implications, focusing on effective dark energy models. Does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 55. [X-ray and UV Observations of the Young Sun HIP~67522: Evidence of Lyman-alpha Absorption Within the Planetary System](https://arxiv.org/abs/2510.27639) <a id="link55"></a>
...
**Comment:** Presents X-ray and UV observations of a young Sun-like star and discusses Lyman-alpha absorption possibly due to exoplanet atmospheric loss or stellar outflows. While it touches on outflows, the context is exoplanetary systems and stellar activity, not galaxy-scale star formation driven outflows or dwarf galaxy feedback.
...
## 56. [A Next-Generation Exoplanet Atmospheric Retrieval Framework NEXOTRANS for Emission Spectroscopy: New Constraints and Atmospheric Characterization of WASP-69b Using JWST NIRCam and MIRI Observations](https://arxiv.org/abs/2510.27223) <a id="link56"></a>
...
**Comment:** Focuses on exoplanet atmospheric retrieval and characterization, which is not related to any of the core criteria.
...
## 57. [When Magnetic Field Lines Stretch, Snap, and Expand: A New Look at Solar Flares with L-maps](https://arxiv.org/abs/2510.27024) <a id="link57"></a>
...
**Comment:** This paper uses data-driven MHD simulations and observations to study the evolution of coronal magnetic fields during solar flares. The focus is on solar physics and magnetic reconnection, not on galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 58. [Accelerating Radiative Transfer for Planetary Atmospheres by Orders of Magnitude with a Transformer-Based Machine Learning Model](https://arxiv.org/abs/2510.27050) <a id="link58"></a>
...
**Comment:** Presents a transformer-based machine learning model to accelerate radiative transfer calculations for planetary atmospheres. Radiative transfer and planetary atmospheres are not part of the core topics.
...
## 59. [Poincar\'e Maps with the Theory of Functional Connections](https://arxiv.org/abs/2510.27626) <a id="link59"></a>
...
**Comment:** Presents a new method for constructing Poincaré maps in dynamical systems, with applications to astrodynamics and the three/four-body problem. Not relevant to any of the core topics (galaxy evolution, near-field cosmology, etc.).
...
## 64. [Systematic Absence of Low-Confidence Nighttime Fire Detections in VIIRS Active Fire Product: Evidence of Undocumented Algorithmic Filtering](https://arxiv.org/abs/2510.26816) <a id="link64"></a>
...
**Comment:** This paper analyzes the VIIRS active fire product and finds undocumented algorithmic filtering in nighttime fire detections. The topic is remote sensing and fire detection algorithms, not related to any of the core astrophysical criteria.
...
## 66. [Revisiting the unification of tidal disruption events with polarimetry](https://arxiv.org/abs/2510.27007) <a id="link66"></a>
...
**Comment:** Focuses on tidal disruption events (TDEs) and their unification via polarimetry. TDEs are explicitly listed as irrelevant in the criteria.
...
## 67. [Simulating the late stages of WD-BH/NS mergers: an origin for fast X-ray transients and GRBs with periodic modulations](https://arxiv.org/abs/2510.27399) <a id="link67"></a>
...
**Comment:** Simulates late stages of white dwarf-neutron star/black hole mergers and their connection to X-ray transients and GRBs. The focus is on compact object mergers and transient phenomena, which are not relevant to the core topics.
...
## 68. [WallGo investigates: Theoretical uncertainties in the bubble wall velocity](https://arxiv.org/abs/2510.27691) <a id="link68"></a>
...
**Comment:** This paper investigates theoretical uncertainties in bubble wall velocity calculations during first-order cosmological phase transitions, relevant for gravitational wave predictions. The work is focused on early Universe physics and does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 69. [SERVIMON: AI-Driven Predictive Maintenance and Real-Time Monitoring for Astronomical Observatories](https://arxiv.org/abs/2510.27146) <a id="link69"></a>
...
**Comment:** Focuses on AI-driven monitoring and maintenance for astronomical observatories, which is not related to any of the core criteria.
...
## 72. [Two-Stage Nature of a Solar Flare with Parallel and Semi-Circular Ribbons](https://arxiv.org/abs/2510.27162) <a id="link72"></a>
...
**Comment:** This paper analyzes the magnetic reconnection and ribbon morphology in a solar flare. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 73. [Ionospheric responses over the Antarctic region to Intense Space Weather events: Plasma Convection vs. Auroral Precipitation](https://arxiv.org/abs/2510.27372) <a id="link73"></a>
...
**Comment:** This paper studies ionospheric responses to space weather events over Antarctica, focusing on plasma convection and auroral precipitation. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 77. [Scattered light noise due to dust particles contamination in the vacuum pipes of the Einstein Telescope](https://arxiv.org/abs/2510.26919) <a id="link77"></a>
...
**Comment:** Focuses on scattered light noise due to dust contamination in the Einstein Telescope, which is a technical study in gravitational wave instrumentation and not related to any of the core astrophysical topics.
