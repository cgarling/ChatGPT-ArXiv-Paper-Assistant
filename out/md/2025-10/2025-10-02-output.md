...
10. [Uncertainties in high-$z$ galaxy properties inferred from SED fitting using JWST NIRCam photometry](#user-content-link10)
...
22. [Forecasting the Observable Rates of Gravitationally Lensed Supernovae for the PASSAGES Dusty Starbursts](#user-content-link22)
...
32. [oMEGACat. VII. Tracing Interstellar and Intracluster Medium of $\omega$ Centauri using Sodium Absorptions](#user-content-link32)
...
45. [Chiral effects and Joule heating in hot and dense matter](#user-content-link45)
...
59. [Quasar Main Sequence unfolded by 2.5D FRADO (Natural expression of Eddington ratio, black hole mass, and inclination)](#user-content-link59)
...
72. [Reducci\'on de ruido por medio de autoencoders: caso de estudio con la se\~nal GW150914](#user-content-link72)
...
84. [ADARI: Visualizing the quality of VLT data](#user-content-link84)
...
**Comment:** This paper discusses the impact of limb-darkening coefficients on exoplanet transit measurements and the need for improved stellar models, specifically limb-darkening models. This matches the 'Stellar Models' criterion, as it highlights the importance of accurate stellar atmosphere models for transit science.
...
**Comment:** Presents star formation and dust attenuation properties for galaxies at 3<z<7 using JWST data, including Balmer decrement measurements and SFRs. While it discusses star formation rates and dust, it does not focus on resolved star formation histories from color-magnitude diagrams or dwarf galaxies.
...
**Comment:** The paper proposes a new mechanism for early supermassive black hole growth via ultralight scalar dark matter accretion. While it touches on dark matter phenomenology, it is focused on black hole growth in the early universe, not on near-field cosmology, dwarf galaxies, or the other core topics. No direct connection to satellite galaxies, resolved SFHs, quenching, or CGM.
...
**Comment:** This paper applies machine learning to classify star-forming galaxies and AGN in the COSMOS field using radio data. While it deals with star formation and galaxy classification, it does not address resolved star formation histories, dwarf galaxy quenching, or other core criteria.
...
**Comment:** This paper focuses on magnetic reconnection and plasmoid formation in 2D MHD simulations. While magnetic reconnection is important in astrophysics, the work is not directly related to any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or outflows in galaxies. The focus is on plasma physics and not on galaxy-scale phenomena.
...
## 42. [Exotic PeVatrons as sources of ultra-high-energy gamma rays](https://arxiv.org/abs/2510.00254) <a id="link42"></a>

**ArXiv ID:** 2510.00254

**Authors:** Andrea Addazi, Salvatore Capozziello, Qingyu Gan

**Abstract:** We explore novel classes of exotic astrophysical sources capable of producing ultra-high-energy gamma rays extending beyond the PeV scale, motivated by quantum gravity scenarios and dark matter phenomenology. These sources include: ultra-spinning black hole vortex-string systems; exotic compact objects such as boson star, axion star and Q-ball. Such Exotica generate powerful magnetic fields through interactions with millicharged dark matter, enabling particle acceleration mechanisms that surpass the energy limits of conventional astrophysical sources like pulsar wind nebulae and supernova remnants. We demonstrate that such exotic PeVatrons could be distributed throughout our Galaxy and may be detectable by current (LHAASO, HAWC) and next-generation (CTA) gamma-ray observatories.

**Comment:** This paper discusses exotic astrophysical sources (e.g., boson stars, axion stars, Q-balls) as PeVatrons for ultra-high-energy gamma rays, with some connection to dark matter phenomenology. However, it does not focus on dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or the CGM. The focus is on particle acceleration and exotic compact objects, which are outside the core topics.
...
## 43. [The Eclipsing $\gamma$ Doradus Star V421 Pegasi](https://arxiv.org/abs/2510.00337) <a id="link43"></a>
...
**Comment:** Focuses on the photometry and pulsations of an eclipsing binary star, with analysis of stellar properties and pulsation signals. While it involves stellar evolution, it does not present new stellar models or evolutionary tracks, nor does it address galaxy-scale phenomena.
...
## 44. [The Silicon Strip Detector Subsystem for the Trans-Iron Galactic Element Recorder for the International Space Station (TIGERISS)](https://arxiv.org/abs/2510.01081) <a id="link44"></a>
...
**Comment:** This paper describes the TIGERISS instrument for measuring ultra-heavy galactic cosmic rays and its implications for galactic nucleosynthesis. While it touches on galactic chemical evolution, it does not address any of the core topics directly.
...
## 45. [Chiral effects and Joule heating in hot and dense matter](https://arxiv.org/abs/2510.00114) <a id="link45"></a>
...
**Comment:** This paper discusses chiral effects and Joule heating in hot and dense matter, with applications to supernovae and neutron star mergers. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 46. [Vanishing Acts: Quantifying Black Hole Formation with the DSNB Signal](https://arxiv.org/abs/2510.01177) <a id="link46"></a>
...
**Comment:** Examines the diffuse supernova neutrino background and its use in constraining black hole formation via invisible supernovae. This is focused on neutrino astronomy and black hole formation, not on galaxy-scale phenomena or the core criteria.
...
## 47. [Gluon Condensation as a Unifying Mechanism for Special Spectra of Cosmic Gamma Rays and Low-Momentum Pion Enhancement at the Large Hadron Collider](https://arxiv.org/abs/2510.00847) <a id="link47"></a>
...
**Comment:** This paper discusses gluon condensation in protons and its implications for cosmic gamma rays and LHC physics. It does not address any of the core topics related to galaxy evolution, star formation, or dwarf galaxies.
...
## 49. [The OATMEAL Survey. III. An Aligned Transiting Warm Brown Dwarf and Evidence for Quiescent Brown Dwarf Migration](https://arxiv.org/abs/2510.00105) <a id="link49"></a>
...
**Comment:** This paper focuses on the orbital properties and migration history of a transiting brown dwarf around an A-type star. While it discusses sub-stellar evolutionary models, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, or galaxy simulations.
...
## 50. [Pan-STARRS follow-up of the gravitational-wave event S250818k and the lightcurve of SN 2025ulz](https://arxiv.org/abs/2510.01142) <a id="link50"></a>
...
**Comment:** This paper presents follow-up observations of a gravitational-wave event and a supernova, with a focus on kilonova searches. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 51. [JWST-discovered AGN: evidence for heavy obscuration in the type-2 sample from the first stacked X-ray detection](https://arxiv.org/abs/2510.00112) <a id="link51"></a>
...
**Comment:** The paper discusses X-ray stacking of JWST-discovered AGN, focusing on obscuration and AGN evolution. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 52. [Faraday Depolarization Study of a Radio Galaxy Using LOFAR Two-metre Sky Survey: Data Release 2](https://arxiv.org/abs/2510.00440) <a id="link52"></a>
...
**Comment:** The paper presents a depolarization analysis of a radio galaxy using LOFAR data, focusing on magnetic fields and turbulence in the magneto-ionic medium. It does not address any of the core topics.
...
## 53. [iPTF16geu through the lens of thermonuclear explosion models](https://arxiv.org/abs/2510.01160) <a id="link53"></a>
...
**Comment:** This paper analyzes a gravitationally lensed supernova and compares it to explosion models. The focus is on supernova physics and cosmological constraints, not on galaxy evolution, dwarf galaxies, or resolved star formation histories.
...
## 58. [AstroMMBench: A Benchmark for Evaluating Multimodal Large Language Models Capabilities in Astronomy](https://arxiv.org/abs/2510.00063) <a id="link58"></a>
...
**Comment:** Benchmark for evaluating multimodal large language models in astronomy. No direct relevance to galaxy evolution, star formation histories, or the core topics.
...
## 59. [Quasar Main Sequence unfolded by 2.5D FRADO (Natural expression of Eddington ratio, black hole mass, and inclination)](https://arxiv.org/abs/2510.01092) <a id="link59"></a>
...
**Comment:** The paper presents a physically motivated model for the quasar main sequence, focusing on the broad-line region and the role of Eddington ratio, black hole mass, and inclination. The topic is AGN/quasar classification and BLR physics, which does not match any of the core criteria (no focus on dwarf galaxies, resolved SFHs, quenching, stellar models, galaxy simulations, outflows, or CGM).
...
## 62. [Testing Gravitation from Light-second to Cosmological Scales with Radio Pulsars](https://arxiv.org/abs/2510.01062) <a id="link62"></a>

**ArXiv ID:** 2510.01062

**Authors:** Emmanuel Fonseca

**Abstract:** Pulsars are spinning neutron stars typically observed as pulses emitted at radio wavelengths. These pulsations exhibit a rotational stability that rival the best atomic clocks, making pulsars one of the most important tools for resolving gravitational phenomena in extreme environments. I will present an overview of the ways in which radio pulsars can be used to test strong-field gravity and observe gravitational radiation, both in the context of historical and ongoing experiments. I will also describe how these measurements can be translated to sought-after quantities like the masses and moments of inertia of neutron stars.

**Comment:** This paper reviews how radio pulsars can be used to test gravitation from light-second to cosmological scales. While it is broadly astrophysical, it does not address any of the core criteria such as galaxy simulations, near-field cosmology, or star formation histories.
...
## 63. [Asymptotic Schwarzschild solutions in $f(R)$ gravity and their observable effects on the photon sphere of black holes](https://arxiv.org/abs/2510.00702) <a id="link63"></a>
...
**Comment:** Studies photon sphere properties in modified gravity scenarios around black holes. This is not relevant to any of the core criteria, as it focuses on black hole lensing and gravity, not galaxy-scale phenomena.
...
## 66. [A planetary system with a sub-Neptune planet in the habitable zone of TOI-2093](https://arxiv.org/abs/2510.00299) <a id="link66"></a>
...
**Comment:** This paper confirms a sub-Neptune planet in the habitable zone of TOI-2093 and discusses its properties. It is focused on exoplanet detection and characterization, not on any of the core topics.
...
## 67. [Technosignatures of Self-Replicating Probes in the Solar System](https://arxiv.org/abs/2510.00082) <a id="link67"></a>
...
**Comment:** This paper explores the possibility of technosignatures from self-replicating probes in the solar system, a SETI topic unrelated to the core criteria.
...
## 68. [High energy emission powered by accreting companions of Be/gamma Cas stars](https://arxiv.org/abs/2510.00891) <a id="link68"></a>
...
**Comment:** Simulations of accretion and X-ray emission in Be/gamma Cas star systems. Focus is on stellar binaries and accretion, not on galaxy evolution, dwarf galaxies, or the core topics.
...
## 69. [Automated Modeling with AAP-Imfit: Astrometry and Photometry via CASA](https://arxiv.org/abs/2510.00119) <a id="link69"></a>
...
**Comment:** Automated modeling tool for VLBI jet component characterization in AGN. No connection to galaxy evolution, dwarf galaxies, or the core topics.
...
## 71. [The gas streamer G1-2-3 in the Galactic Center](https://arxiv.org/abs/2510.00897) <a id="link71"></a>
...
**Comment:** This paper studies gas clumps and streamers in the Galactic Center, specifically around Sgr A*. The focus is on the origin and dynamics of gas clouds near the supermassive black hole, which is explicitly listed as irrelevant (Galactic center, SMBH) in the criteria. No connection to dwarf galaxies, resolved SFHs, quenching, or CGM.
...
## 72. [Reducci\'on de ruido por medio de autoencoders: caso de estudio con la se\~nal GW150914](https://arxiv.org/abs/2510.00873) <a id="link72"></a>
...
**Comment:** This study applies autoencoders to improve the signal-to-noise ratio of gravitational wave signals. It is a methodological paper focused on data analysis for gravitational events, with no connection to the core topics.
...
## 73. [Multiband Optical Photometric and Spectroscopic Monitoring of the 2024 Flare Event in Transition Blazar OP313](https://arxiv.org/abs/2510.00631) <a id="link73"></a>
...
**Comment:** This paper presents multiwavelength monitoring of a blazar flare event, focusing on jet physics and high-energy emission mechanisms. It does not address any of the core topics.
...
## 74. [Evaluating solar wind forecast using magnetic maps that include helioseismic far-side information](https://arxiv.org/abs/2510.00608) <a id="link74"></a>
...
**Comment:** This paper evaluates solar wind forecasts using magnetic maps with helioseismic far-side information. It is focused on solar and heliospheric physics, not on galaxy or near-field cosmology topics.
...
## 76. [Novel very-high-frequency quasi-periodic oscillations of compact, non-singular objects](https://arxiv.org/abs/2510.00986) <a id="link76"></a>
...
**Comment:** This paper reports on very-high-frequency quasi-periodic oscillations in compact, non-singular objects. The focus is on compact object physics and does not match any of the core topics.
...
## 79. [Progress towards stereo observation of ultra-high-energy cosmic rays with Fluorescence detector Array of Single-pixel Telescopes](https://arxiv.org/abs/2510.00397) <a id="link79"></a>
...
**Comment:** The paper describes the development of a new telescope array for ultra-high-energy cosmic ray detection. It does not address any of the core topics related to galaxy evolution, star formation, or dwarf galaxies.
...
## 80. [The Simons Observatory: Characterization of All DC/RF Routing Wafers for Detector Modules](https://arxiv.org/abs/2510.00176) <a id="link80"></a>
...
**Comment:** This paper describes the characterization of routing wafers for detector modules in the Simons Observatory, focusing on instrumentation and detector technology. It does not address any of the core topics.
...
## 81. [Bayesian Model Comparison and Significance: Widespread Errors and how to Correct Them](https://arxiv.org/abs/2510.00169) <a id="link81"></a>
...
**Comment:** The paper discusses Bayesian model comparison methods in exoplanet spectroscopy, focusing on statistical methodology. It does not address any of the core topics.
...
## 82. [KiDS-1000 cosmic shear reanalysis using MetaCalibration](https://arxiv.org/abs/2510.01122) <a id="link82"></a>
...
**Comment:** Cosmic shear reanalysis for cosmological parameter estimation. No connection to galaxy evolution, dwarf galaxies, star formation histories, or any of the core topics.
...
## 83. [Properties of Neutron Stars with Hyperons within a Relativistic Metamodel](https://arxiv.org/abs/2510.00997) <a id="link83"></a>

**ArXiv ID:** 2510.00997

**Authors:** Prasanta Char, Chiranjib Mondal, Timoth\'e Alezraa, Francesca Gulminelli, Micaela Oertel

**Abstract:** In this work, we study the effects of $\Lambda$-hyperons on neutron star properties employing a metamodel framework for the equation of state (EoS). Different choices for defining the hyperonic couplings with different levels of parametric freedom are discussed. In all models, the predicted NS maximum masses are reduced compared with the purely nucleonic composition as expected. In the case of relating hyperonic couplings via $SU(6)$-symmetry arguments to the nucleonic ones, we find that NS radii for intermediate mass stars are shifted to higher values compared with purely nucleonic stars, in agreement with the existing literature. However, allowing for more freedom for the hyperonic couplings, the effect is strongly reduced, and the distributions in the NS mass-radius plane of models with and without hyperons become very close. We have also investigated how different nucleonic density functionals influence the hyperon matter composition and neutron star properties.

**Comment:** Study of neutron star properties with hyperons using a relativistic metamodel. No connection to galaxy evolution, star formation, or any of the core topics.
