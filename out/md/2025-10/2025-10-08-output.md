...
1. [MEGATRON: Reproducing the Diversity of High-Redshift Galaxy Spectra with Cosmological Radiation Hydrodynamics Simulations](#user-content-link1)
**Authors:** Harley Katz, Martin P. Rey, Corentin Cadiou, Oscar Agertz, Jeremy Blaizot, Alex J. Cameron, Nicholas Choustikov, Julien Devriendt, Uliana Hauk, Gareth C. Jones, Taysun Kimm, Isaac Laseter, Sergio Martin-Alvarez, Kosei Matsumoto, Autumn Pearce, Francisco Rodr\'iguez Montero, Joki Rosdahl, Mahsa Sanati, Aayush Saxena, Adrianne Slyz, Richard Stiskalek, Anatole Storck, Oscar Veenema, Wonjae Yee

2. [MEGATRON: how the first stars create an iron metallicity plateau in the smallest dwarf galaxies](#user-content-link2)
...
3. [The Prevalence of Bursty Star Formation in Low-Mass Galaxies at z=1-7 from H{\alpha}-to-UV Diagnostics](#user-content-link3)
**Authors:** Marissa N. Perry (The University of Texas at Austin, Department of Astronomy), Anthony J. Taylor (The University of Texas at Austin, Department of Astronomy), Oscar A. Chavez Ortiz (The University of Texas at Austin, Department of Astronomy), Steven L. Finkelstein (The University of Texas at Austin, Department of Astronomy), Gene C. K. Leung (MIT Kavli Institute for Astrophysics and Space Research), Micaela B. Bagley (Astrophysics Science Division, NASA Goddard Space Flight Center, The University of Texas at Austin, Department of Astronomy), Vital Fernandez (Michigan Institute for Data Science, University of Michigan), Pablo Arrabal Haro (Astrophysics Science Division, NASA Goddard Space Flight Center), Katherine Chworowsky (The University of Texas at Austin, Department of Astronomy), Nikko J. Cleri (Department of Astronomy and Astrophysics, The Pennsylvania State University, Institute for Gravitation and the Cosmos, The Pennsylvania State University), Mark Dickinson (NSF's National Optical-Infrared Astronomy Research Laboratory), Richard S. Ellis (University College London, Department of Physics & Astronomy), Jeyhan S. Kartaltepe (Laboratory for Multiwavelength Astrophysics, School of Physics & Astronomy, Rochester Institute of Technology), Anton M. Koekemoer (Space Telescope Science Institute), Fabio Pacucci (Center for Astrophysics, Harvard & Smithsonian, Black Hole Initiative, Harvard University), Casey Papovich (George P. and Cynthia Woods Mitchell Institute for Fundamental Physics and Astronomy, Department of Physics and Astronomy, Texas A&M University), Nor Pirzkal (ESA/AURA Space Telescope Science Institute), Sandro Tacchella (Kavli Institute for Cosmology, University of Cambridge, Cavendish Laboratory, University of Cambridge)

4. [MEGATRON: the impact of non-equilibrium effects and local radiation fields on the circumgalactic medium at cosmic noon](#user-content-link4)
**Authors:** Corentin Cadiou, Harley Katz, Martin P. Rey, Oscar Agertz, Jeremy Blaizot, Alex J. Cameron, Nicholas Choustikov, Julien Devriendt, Uliana Hauk, Gareth C. Jones, Taysun Kimm, Isaac Laseter, Sergio Mart\'in \'Alvarez, Kosei Matsumoto, Camilla T. Nyhagen, Autumn Pearce, Francisco Rodr\'iguez Montero, Joki Rosdahl, V\'ictor Rufo Pastor, Mahsa Sanati, Aayush Saxena, Adrianne Slyz, Richard Stiskalek, Anatole Storck, Wonjae Yee

5. [Self-interacting dark matter in the center of a Local Group dwarf galaxy and its satellites](#user-content-link5)
**Authors:** Thales A. Gutcke, Giulia Despali, Stephanie O'Neil, Mark Vogelsberger, Azadeh Fattahi, David B. Sanders

6. [Constraints on dark matter models from the stellar cores observed in ultra-faint dwarf galaxies: Self-interacting dark matter](#user-content-link6)
**Authors:** Jorge Sanchez Almeida (Instituto de Astrofisica de Canarias, La Laguna, Tenerife, E-38200, Spain, Departamento de Astrofisica, Universidad de La Laguna, Spain)

7. [Resolving Star Cluster Formation in Galaxy Simulations with Cosmic Ray Feedback](#user-content-link7)
**Authors:** Brandon Sike, Mateusz Ruszkowski, Oleg Y. Gnedin, Yingtian Chen, Matthias Weber, Timon Thomas, Christoph Pfrommer

8. [Mass loading of outflows from evolving Young Massive Clusters](#user-content-link8)
**Authors:** C. J. K. Larkin, C. Hawcroft, J. Mackey, R. R. Lefever, L. H\"arer, A. A. C. Sander

9. [DISCO-DJ II: a differentiable particle-mesh code for cosmology](#user-content-link9)
**Authors:** Florian List, Oliver Hahn, Thomas Fl\"oss, Lukas Winkler

10. [Central Massive Black Holes Are Not Ubiquitous in Local Low-Mass Galaxies](#user-content-link10)
...
11. [Abundance Pattern Fitting with Bayesian Inference: Constraining First Stars' Properties and Their Explosion Mechanism with Extremely Metal-poor Stars](#user-content-link11)
**Authors:** Ruizheng Jiang, Haining Li, Gang Zhao, Qianfan Xing, Wenyu Xin

12. [The inertial dip as a window on the convective core dynamics](#user-content-link12)
**Authors:** Lucas Barrault, Lisa Bugnet, St\'ephane Mathis, Joey S. G. Mombarg

13. [Declining metallicity and extended HeII in the outflow of an epoch of reionization analogue galaxy](#user-content-link13)
**Authors:** M. J. Hamel-Bravo, D. B. Fisher, D. A. Berg, A. J. Cameron, J. Chisholm, G. G. Kacprzak, B. Mazzilli Ciraulo, H. Katz

14. [SN 2021tsz: A luminous, short photospheric phase Type II supernova in a low-metallicity host](#user-content-link14)
**Authors:** R. Dastidar, G. Pignata, N. Dukiya, K. Misra, D. A. Howell, M. Singh, C. P. Guti\'errez, C. Pellegrino, A. Kumar, B. Ayala, A. Gangopadhyay, M. Newsome, E. Padilla Gonzalez, K. A. Bostroem, D. Hiramatsu, G. Terreran, C. McCully

15. [EIGER VIII: First stars signatures in the connection between OI absorption and Galaxies in the Epoch of Reionization](#user-content-link15)
...
16. [Resolved Profiles of Stellar Mass, Star Formation Rate, and Predicted CO-to-H$_2$ Conversion Factor Across Thousands of Local Galaxies](#user-content-link16)
...
17. [Galaxy sizes and compactness at Cosmic Dawn](#user-content-link17)
**Authors:** P. Cataldi, S. Pedrosa, L. J. Pellizza, D. Ceverino, L. A. Bignone

18. [Interpreting anomaly detection of SDSS spectra](#user-content-link18)
**Authors:** Edgar Ortiz Manrique, M\'ed\'eric Boquien

19. [ILLUSTRating red nugget assembly through observations and simulations](#user-content-link19)
**Authors:** Micheli T. Moura, Anna Ferr\'e-Mateu, Ana L. Chies-Santos, Cristina Furlanetto, Michael A. Beasley

20. [Transverse Velocities in Real-Time Cosmology: Position Drift in Relativistic N-Body Simulations](#user-content-link20)
**Authors:** Alexander Oestreicher, Chris Clarkson, Julian Adamek, Sofie Marie Koksbang

21. [A Comparison of Star Formation Rates by Different Tracers in Nearby Galaxies](#user-content-link21)
**Authors:** Huynh Anh N. Le, Jong-Hak Woo, Yongquan Xue, Ashraf Ayubinia, Changseok Kim, Xiaozhi Lin

22. [A Data-Driven Prism: Multi-View Source Separation with Diffusion Model Priors](#user-content-link22)
**Authors:** Sebastian Wagner-Carena, Aizhan Akhmetzhanova, Sydney Erickson

23. [Demagnifying gravitational lenses as probes of dark matter structures and nonminimal couplings to gravity](#user-content-link23)
**Authors:** Hong-Yi Zhang

24. [Accretion, Jets, and Recoil in Merging Supermassive Binary Black Holes](#user-content-link24)
**Authors:** Maria Chiara de Simone (RIT), Manuela Campanelli (RIT), Lorenzo Ennoggi (RIT), Carlos O. Lousto (RIT), Yosef Zlochower (RIT)

25. [Resurging from the ashes: A spectral study of seven candidate revived radio fossils in nearby low-mass galaxy clusters](#user-content-link25)
**Authors:** L. Bruno, A. Botteon, D. Dallacasa, T. Venturi, M. Balboni, N. Biava, M. Brienza, M. Br\"uggen, G. Brunetti, F. de Gasperin, E. De Rubeis, G. Di Gennaro, F. Gastaldello, A. Ignesti, T. Pasini, K. Rajpurohit, A. Shulevski, K. S. L. Srikanth, R. J. van Weeren, X. Zhang

26. [The influence of rotation and metallicity on the explodability of massive stars](#user-content-link26)
**Authors:** Renyu Luo, Chunhua Zhu, Guoliang L\"u, Helei Liu, Sufen Guo, Lei Li, Zhuowen Li

27. [Line shapes of the Na/K resonance line profiles perturbed by H2 at extreme density](#user-content-link27)
**Authors:** N. F. Allard, J. F. Kielkopf

28. [On the Formation of GW231123 in Population III Star Clusters](#user-content-link28)
**Authors:** Shuai Liu, Long Wang, Ataru Tanikawa, Weiwei Wu, Michiko S. Fujii

29. [Rare Transients in Nearby Galaxies Explain Ultra-high-energy Cosmic Rays](#user-content-link29)
**Authors:** Imre Bartos, Marek Kowalski

30. [StarEmbed: Benchmarking Time Series Foundation Models on Astronomical Observations of Variable Stars](#user-content-link30)
**Authors:** Weijian Li, Hong-Yu Chen, Qinjie Lin, Nabeel Rehemtulla, Ved G. Shah, Dennis Wu, Adam A. Miller, Han Liu

31. [Dormant BH candidates from Gaia DR3 summary diagnostics](#user-content-link31)
**Authors:** Johanna M\"uller-Horn, Hans-Walter Rix, Kareem El-Badry, Ben Pennell, Matthew Green, Jiadong Li, Rhys Seeburger

32. [QML-FAST - A Fast Code for low-$\ell$ Tomographic Maximum Likelihood Power Spectrum Estimation](#user-content-link32)
**Authors:** Yurii Kvasiuk, Anderson Lai, Moritz M\"unchmeyer, Kendrick M. Smith

33. [Luminosity distance dispersion in Swiss-cheese cosmology as a function of the hole size distribution](#user-content-link33)
**Authors:** Thippayawis Cheunchitra, Andrew Melatos, Rachel Webster

34. [Studying the gravitational-wave population without looking that FAR out](#user-content-link34)
**Authors:** Noah E. Wolfe, Matthew Mould, Jack Heinzel, Salvatore Vitale

35. [Torus feeding and outflow launching in the active nucleus of the Circinus galaxy](#user-content-link35)
...
36. [Large-scale peculiar velocities in the universe](#user-content-link36)
**Authors:** Christos G. Tsagas, Leandros Perivolaropoulos, Kerkyra Asvesta

37. [Validation of the DESI-DR1 3x2-pt analysis: scale cut and shear ratio tests](#user-content-link37)
**Authors:** N. Emas, A. Porredon, C. Blake, J. DeRose, J. Aguilar, S. Ahlen, D. Bianchi, D. Brooks, F. J. Castander, T. Claybaugh, A. Cuceu, A. de la Macorra, A. Dey, B. Dey, P. Doel, S. Ferraro, J. E. Forero-Romero, C. Garcia-Quintero, E. Gazta\~naga, S. Gontcho A Gontcho, G. Gutierrez, S. Heydenreich, K. Honscheid, D. Huterer, M. Ishak, S. Joudaki, R. Joyce, E. Jullo, S. Juneau, R. Kehoe, D. Kirkby, T. Kisner, A. Kremin, A. Krolewski, O. Lahav, M. Landriau, J. U. Lange, L. Le Guillou, A. Leauthaud, M. Manera, R. Miquel, S. Nadathur, W. J. Percival, F. Prada, G. Rossi, R. Ruggeri, E. Sanchez, C. Saulder, A. Semenaite, H. Seo, J. Silber, D. Sprayberry, Z. Sun, G. Tarl\'e, B. A. Weaver, R. H. Wechsler, R. Zhou

38. [The Cosmic Infrared Background Experiment-2: An Intensity Mapping Optimized Sounding-rocket Payload to Understand the Near-IR Extragalactic Background Light](#user-content-link38)
...
39. [An interferometric mid-infrared study of the eruptive star binary Z CMa with MATISSE/VLTI. I. Imaging the protoplanetary disks during the 2023 outburst](#user-content-link39)
**Authors:** F. Lykou, J. Varga, F. Cruz-Sa\'enz de Miera, P. \'Abrah\'am, \'A. K\'osp\'al, B. Lopez, T. Henning, S. Wolf, G. Weigelt, F. Millour, M. Hogerheijde, L. Chen, T. Ratzka, W. Danchi, P. Boley, J. -C. Augereau, P. Priolet

40. [Ionization Sources of the Local Interstellar Clouds: Two B-stars, Three White Dwarfs, and the Local Hot Bubble](#user-content-link40)
**Authors:** J. Michael Shull (University of Colorado, University of North Carolina), Rachel M. Curran (University of North Carolina), Michael W. Topping (University of Arizona), Jonathan D. Slavin (Harvard/SAO)

41. [Wavefront Error Recovery and Companion Identification with the James Webb Space Telescope](#user-content-link41)
**Authors:** Matthew De Furio, Marie Ygouf, Alexandra Greenbaum, Gra\c{c}a Rocha, Michael Meyer, Charles Beichman, Jorge Llop-Sayson, Gael Roudier, Steph Sallum, Jarron Leisenring, Anand Sivaramakrishnan

42. [Multiprobe constraints on early and late time dark energy](#user-content-link42)
**Authors:** Alexander Reeves, Simone Ferraro, Andrina Nicola, Alexandre Refregier

43. [Binary Neutron Stars from the Moon: Early Warnings and Precision Science for the Artemis Era](#user-content-link43)
**Authors:** Anjali B. Yelikar, Karan Jani

44. [Overlap-aware segmentation for topological reconstruction of obscured objects](#user-content-link44)
**Authors:** J. Schueler, H. M. Ara\'ujo, S. N. Balashov, J. E. Borg, C. Brew, F. M. Brunbauer, C. Cazzaniga, A. Cottle, D. Edgeman, C. D. Frost, F. Garcia, D. Hunt, M. Kastriotou, P. Knights, H. Kraus, A. Lindote, M. Lisowska, D. Loomba, E. Lopez Asamar, P. A. Majewski, T. Marley, C. McCabe, L. Millins, R. Nandakumar, T. Neep, F. Neves, K. Nikolopoulos, E. Oliveri, A. Roy, T. J. Sumner, E. Tilly, W. Thompson, M. A. Vogiatzi

45. [Low-energy Cross Section Measurements of ${}^{\mathsf{12}}\mathsf{C}(\mathsf{p},\gamma)$ Deep Underground at LUNA](#user-content-link45)
**Authors:** Jakub Skowronski, Axel Boeltzig

46. [Everyone wants something better than $\Lambda$CDM](#user-content-link46)
**Authors:** Michael S. Turner

47. [PDRs4All XIX. The 6 to 9 $\mu$m region as a probe of PAH charge and size in the Orion Bar](#user-content-link47)
**Authors:** Baria Khan, Samuel A. Daza Rodriguez, Els Peeters, Alexander G. G. M. Tielens, Takashi Onaka, Jan Cami, Bethany Schefter, Christiaan Boersma, Felipe Alarc\'on, Olivier Bern\'e, Am\'elie Canin, Ryan Chown, Emmanuel Dartois, Javier R. Goicoechea, Emilie Habart, Olga Kannavou, Alexandros Maragkoudakis, Amit Pathak, Alessandra Ricca, Ga\"el Rouill\'e, Dinalva A. Sales, Ilane Schroetter, Ameek Sidhu, Boris Trahin, Dries Van De Putte, Yong Zhang, Henning Zettergren

48. [An in-depth study of brown dwarfs with TESS](#user-content-link48)
**Authors:** F. Marcadon, A. Pr\v{s}a

49. [Intrinsically Quantum Effects of Axion Dark Matter are Undetectable](#user-content-link49)
**Authors:** Yunjia Bao, Dhong Yeon Cheong, Nicholas L. Rodd, Joey Takach, Lian-Tao Wang, Kevin Zhou

50. [The Gamma-ray Luminosity Function of Flat-Spectrum Radio Quasars](#user-content-link50)
**Authors:** Garima Rajguru, Lea Marcotulli, Marco Ajello, Mattia Di Mauro, Meg Urry

51. [Discovery of Changing-Look behavior in AGN NGC 3822: A long-term multiwavelength study](#user-content-link51)
...
52. [Magnetic Fields in the Bones of the Milky Way](#user-content-link52)
...
53. [Microscopic study of nuclei synthesis in pycnonuclear reaction $\isotope[12]{C} + \isotope[12]{C}$ in neutron stars](#user-content-link53)
**Authors:** S. P. Maydanyuk (Southern Center for Nuclear-Science Theory, Institute for Nuclear Research, National Academy of Sciences of Ukraine, Kyiv, 03680, Ukraine), Ju-Jun Xie (Southern Center for Nuclear-Science Theory, School of Nuclear Sciences and Technology, University of Chinese Academy of Sciences, Beijing 101408, China), V. S. Vasilevsky (Bogolyubov Institute for Theoretical Physics, Metrolohichna str., 14b, Kyiv, 03143, Ukraine), K. A. Shaulskyi (Institute for Nuclear Research, National Academy of Sciences of Ukraine, Kyiv, 03680, Ukraine)

54. [First X-ray and radio polarimetry of the neutron star low-mass X-ray binary GX 17+2](#user-content-link54)
...
55. [Beyond $\rho^{2/3}$ Scaling: Microscopic Origins and Multimessengers of High-Density Nuclear Symmetry Energy](#user-content-link55)
**Authors:** Bao-An Li

56. [The effect of extended radio emission on SMBH accretion rate estimates](#user-content-link56)
**Authors:** Stergios Amarantidis, Duncan Farrah, Nick Seymour, Mark Lacy, Iris Breda, Bodo Ziegler, Olmo Piana, Miguel S\'anchez-Portal

57. [Hunting Very High-Energy ($>$100 GeV) Emitting High-Synchrotron Peaked Blazars](#user-content-link57)
**Authors:** Sushmita Agarwal, Vaidehi S. Paliya

58. [Scalarized Hot Neutron Stars Containing Hyperons and $\Delta$-Resonances in Different Evolution Regimes](#user-content-link58)
**Authors:** Fahimeh Rahimi, Zeinab Rezaei, Adamu Issifu

59. [Pulsar timing array analysis in a Legendre polynomial basis](#user-content-link59)
**Authors:** Bruce Allen, Arian L. von Blanckenburg, Ken D. Olum

60. [On the statistical characterization of the synchrotron multi-zone polarization of blazars](#user-content-link60)
**Authors:** Andrea Tramacere

61. [Nonlinear Evolution of the Matter Trispectrum with Primordial Parity Violation](#user-content-link61)
**Authors:** Sha Azyzy, Drew Jamieson, Eiichiro Komatsu, Toshiki Kurita

62. [Gaussian process analysis of type-B quasiperiodic oscillations in the black hole X-ray binary MAXI J1348-630](#user-content-link62)
**Authors:** Yiran Wang, Ruican Ma, Haiyun Zhang, Dahai Yan

63. [Gamma-ray Bursts](#user-content-link63)
**Authors:** Andrew J. Levan

64. [Monitoring of 3C 286 with ALMA, IRAM, and SMA from 2006 to 2025: Stability, Synchrotron Ages, and Frequency-Dependent Polarization Attributed to Core-Shift](#user-content-link64)
**Authors:** Minchul Kam, Hiroshi Nagai, Motoki Kino, Keiichi Asada, R\"udiger Kneissl, Iv\'an Agudo, Sascha Trippe, Seiji Kameno, Ioannis Myserlis, Ramprasada Rao, Hojin Cho, Richard A. Perley, Bryan J. Butler, Mark Gurwell, Tomoki Matsuoka, Jongho Park, Carolina Casadio, Baltasar Vila Vilaro, Celia Verdugo, Matias Radiszcz, Kurt Plarre, Wanchaloem Khwammai, Diego \'Alvarez-Ortega, Juan Escudero, Clemens Thum, Garrett Keating

65. [Constraints on Radial Gas Flows in the Milky Way Disk Revealed by Large Stellar Age Catalogs](#user-content-link65)
**Authors:** James W. Johnson

66. [A systematic meta-analysis of physical parameters of Galactic supernova remnants](#user-content-link66)
**Authors:** I. Chousein-Basia, A. Zezas, I. Leonidaki, M. Kopsacheili

67. [Infall Explains the Disk Kinematics of AB Aur Without Gravitational Instability](#user-content-link67)
**Authors:** Josh Calcino, Daniel J. Price, Chris W. Ormel

68. [Convolution and Graph-based Deep Learning Approaches for Gamma/Hadron Separation in Imaging Atmospheric Cherenkov Telescopes](#user-content-link68)
**Authors:** Abhay Mehta, Dan Parsons, Tim Lukas Holch, David Berge, Matthias Weidlich

69. [Stochastic Gravitational Waves from Modulated Reheating](#user-content-link69)
**Authors:** Michele Benaco, Dimitrios Karamitros, Sami Nurmi, Kimmo Tuominen

70. [Adaptive and Multi-Source Entity Matching for Name Standardization of Astronomical Observation Facilities](#user-content-link70)
**Authors:** Liza Fretel, Baptiste Cecconi, Laura Debisschop

71. [Exploring the Most Extreme Blazars: New Insights from MAGIC](#user-content-link71)
**Authors:** L. Foffano (for the MAGIC Collaboration), C. Arcaro (for the MAGIC Collaboration), A. Arbet-Engels (for the MAGIC Collaboration), F. D'Ammando (for the MAGIC Collaboration), P. Da Vela (for the MAGIC Collaboration), J. Jormanainen (for the MAGIC Collaboration), D. Linder (for the MAGIC Collaboration), S. Menon (for the MAGIC Collaboration), E. Prandini (for the MAGIC Collaboration), S. Ventura (for the MAGIC Collaboration), E. Visentin (for the MAGIC Collaboration)

72. [The gamma-ray emission from Radio Galaxies and their contribution to the Isotropic Gamma-Ray Background](#user-content-link72)
**Authors:** A. Circiello, A. McDaniel, M. Di Mauro, C. Karwin, N. Khatiya, M. Ajello, F. Donato, D. Hartmann, A. Strong

73. [Limits on the Axion-Photon Coupling from Chandrayaan-2](#user-content-link73)
**Authors:** Tanmoy Kumar, N. P. S. Mithun, Subhendra Mohanty, Sourov Roy, B. S. Bharath Saiguhan, Santosh Vadawale

74. [Three-dimensional Reconstruction and Propagation of an Asymmetric Flux-rope Coronal Mass Ejection](#user-content-link74)
**Authors:** Philippe Lamy, Yannick Boursier, Jean Loirat, Andrei Zhukov

75. [Accessing the fine temporal scale of EUV brightenings and their quasi-periodic pulsations: 1 second cadence observations by Solar Orbiter/EUI](#user-content-link75)
...
76. [Testing the arrow of time at the cosmo collider](#user-content-link76)
**Authors:** Shuntaro Aoki, Alessandro Strumia

77. [Kinetic collisionless model of the solar transition region and corona with spatially intermittent heating](#user-content-link77)
**Authors:** Luca Barbieri, Pascal D\'emoulin

78. [Radiative-Corrected Higgs Inflation in Light of the Latest ACT Observations](#user-content-link78)
**Authors:** Jureeporn Yuennan, Farruh Atamurotov, Phongpichit Channuie

79. [Near-continuous tracking of solar active region NOAA 13664 over three solar rotations](#user-content-link79)
**Authors:** I. Kontogiannis (ETH Z\"urich, Institute for Particle Physics and Astrophysics, Istituto Ricerche Solari Aldo e Cele Dacc\`o), Y. Zhu (ETH Z\"urich, Institute for Particle Physics and Astrophysics), K. Barczynski (Physikalisch-Meteorologisches Observatorium Davos/World Radiation Center), M. Z. Stiefel (ETH Z\"urich, Institute for Particle Physics and Astrophysics, University of Applied Sciences and Arts Northwestern Switzerland), H. Collier (ETH Z\"urich, Institute for Particle Physics and Astrophysics, University of Applied Sciences and Arts Northwestern Switzerland), J. McKevitt (University College London, Mullard Space Science Laboratory, University of Vienna, Institute of Astrophysics), J. S. Castellanos Dur\'an (Max Planck Institute for Solar System Research), S. Berdyugina (Istituto Ricerche Solari Aldo e Cele Dacc\`o, Euler Institute, Faculty of Informatics, Universit\`a della Svizzera Italiana), L. K. Harra (ETH Z\"urich, Institute for Particle Physics and Astrophysics, Physikalisch-Meteorologisches Observatorium Davos/World Radiation Center)

80. [Buildup, Explosion, and Untwisting of a Solar Active Region Jet Observed with Solar Orbiter, IRIS, and SDO](#user-content-link80)
...
81. [Estimation of intrinsic fast radio burst width and scattering distributions from CRAFT data](#user-content-link81)
**Authors:** C. W. James, J. Hoffmann, J. X. Prochaska, M. Glowacki

82. [Radio emission from beyond the light cylinder in millisecond pulsars](#user-content-link82)
**Authors:** Michael Kramer (MPIfR), Simon Johnston (CSIRO)

83. [Observation and modeling of a geo-effective event observed on 2011 May 28 from the solar surface to 1au](#user-content-link83)
**Authors:** Nishu Karna, Tatiana Niembro

84. [From X-rays to High-Energy Gamma-rays: A Comprehensive Multi-Wavelength Study of Early Gamma-Ray Burst Afterglows](#user-content-link84)
**Authors:** P. Tiwari, B. Banerjee, D. Miceli, G. Oganesyan, A. Ierardi, S. Macera, M. Branchesi, L. Nava, S. Mohnani, S. Agarwal, A. Shukla

85. [Exploring Complexity Measures for Analysis of Solar Wind Structures and Streams](#user-content-link85)
**Authors:** Venla Koikkalainen, Emilia Kilpua, Simon Good, Adnane Osmane

86. [Comparing LSTM-Based Sequence-to-Sequence Forecasting Strategies for 24-Hour Solar Proton Flux Profiles Using GOES Data](#user-content-link86)
**Authors:** Kangwoo Yi, Bo Shen, Qin Li, Haimin Wang, Yong-Jae Moon, Jaewon Lee, Hwanhee Lee

87. [Land use and anisotropy of artificial light observed by night time satellite](#user-content-link87)
**Authors:** Kai Pong Tong

88. [Empirical Optimization of the Source-Surface Height in the PFSS extrapolation](#user-content-link88)
**Authors:** Munehito Shoda, Kyogo Tokoro, Daikou Shiota, Shinsuke Imada

89. [Inspiring stories from women in astronomy in Africa](#user-content-link89)
**Authors:** Priscilla Muheki, Mirjana Povi\'c, Somaya Saad, Salma Sylla Mbaye, in collaboration with Vanessa McBride, Naomi Asabre Frimpong, Meryem Guennoun, African Science Stars team

---

## 1. [MEGATRON: Reproducing the Diversity of High-Redshift Galaxy Spectra with Cosmological Radiation Hydrodynamics Simulations](https://arxiv.org/abs/2510.05201) <a id="link1"></a>

**ArXiv ID:** 2510.05201

**Authors:** Harley Katz, Martin P. Rey, Corentin Cadiou, Oscar Agertz, Jeremy Blaizot, Alex J. Cameron, Nicholas Choustikov, Julien Devriendt, Uliana Hauk, Gareth C. Jones, Taysun Kimm, Isaac Laseter, Sergio Martin-Alvarez, Kosei Matsumoto, Autumn Pearce, Francisco Rodr\'iguez Montero, Joki Rosdahl, Mahsa Sanati, Aayush Saxena, Adrianne Slyz, Richard Stiskalek, Anatole Storck, Oscar Veenema, Wonjae Yee

**Abstract:** We present the MEGATRON suite of cosmological radiation hydrodynamics simulations following the formation of Milky Way-mass galaxies from the earliest cosmic epochs when Population III stars form to Cosmic Noon. The suite represents the first set of cosmological simulations that couples a vast non-equilibrium thermochemistry network of primordial species, metals, and molecules to multifrequency, on-the-fly radiation transport, allowing us to directly predict the spectral properties of early galaxies. By initializing the simulations at zero metallicity, resolving haloes well below the atomic cooling threshold, reaching parsec-scale resolution, and modeling a Milky Way-mass environment, we aim to address four key science themes: 1) Star formation at cosmic dawn, 2) Galaxy formation and the interstellar medium in the epoch of reionization, 3) The circumgalactic medium towards cosmic noon, and 4) Reionization in a local volume environment and near-field cosmology. In this introductory work, we present an overview of the physical characteristics of high-redshift MEGATRON galaxies and their environment at $z>8$. We present a library of $>175,000$ simulated galaxy spectra and demonstrate how the diversity of galaxy spectra seen by JWST is naturally reproduced in the context of a $\Lambda$CDM cosmology. This project represents a step towards making more direct comparisons between simulations and observations and will enable future work to both optimize methods for inferring galaxy properties from observations and to elucidate the physics that governs galaxy formation in the early Universe.

**Comment:** The MEGATRON suite presents cosmological radiation hydrodynamics simulations of Milky Way-mass galaxies, resolving haloes below the atomic cooling threshold and including multifrequency radiation transport. The abstract explicitly mentions near-field cosmology, resolved star formation, and the circumgalactic medium, directly matching multiple core criteria.
...
## 2. [MEGATRON: how the first stars create an iron metallicity plateau in the smallest dwarf galaxies](https://arxiv.org/abs/2510.05232) <a id="link2"></a>
...
**Comment:** Directly matches near-field cosmology and numerical galaxy simulations criteria. Uses high-resolution cosmological radiation-hydrodynamics simulations to study the stellar mass-iron metallicity relation of dwarf galaxies, including satellite abundances and chemical enrichment. Also discusses the impact of Pop III supernovae on metallicity plateaus in the smallest dwarfs.
...
## 3. [The Prevalence of Bursty Star Formation in Low-Mass Galaxies at z=1-7 from H{\alpha}-to-UV Diagnostics](https://arxiv.org/abs/2510.05388) <a id="link3"></a>

**ArXiv ID:** 2510.05388

**Authors:** Marissa N. Perry (The University of Texas at Austin, Department of Astronomy), Anthony J. Taylor (The University of Texas at Austin, Department of Astronomy), Oscar A. Chavez Ortiz (The University of Texas at Austin, Department of Astronomy), Steven L. Finkelstein (The University of Texas at Austin, Department of Astronomy), Gene C. K. Leung (MIT Kavli Institute for Astrophysics and Space Research), Micaela B. Bagley (Astrophysics Science Division, NASA Goddard Space Flight Center, The University of Texas at Austin, Department of Astronomy), Vital Fernandez (Michigan Institute for Data Science, University of Michigan), Pablo Arrabal Haro (Astrophysics Science Division, NASA Goddard Space Flight Center), Katherine Chworowsky (The University of Texas at Austin, Department of Astronomy), Nikko J. Cleri (Department of Astronomy and Astrophysics, The Pennsylvania State University, Institute for Gravitation and the Cosmos, The Pennsylvania State University), Mark Dickinson (NSF's National Optical-Infrared Astronomy Research Laboratory), Richard S. Ellis (University College London, Department of Physics & Astronomy), Jeyhan S. Kartaltepe (Laboratory for Multiwavelength Astrophysics, School of Physics & Astronomy, Rochester Institute of Technology), Anton M. Koekemoer (Space Telescope Science Institute), Fabio Pacucci (Center for Astrophysics, Harvard & Smithsonian, Black Hole Initiative, Harvard University), Casey Papovich (George P. and Cynthia Woods Mitchell Institute for Fundamental Physics and Astronomy, Department of Physics and Astronomy, Texas A&M University), Nor Pirzkal (ESA/AURA Space Telescope Science Institute), Sandro Tacchella (Kavli Institute for Cosmology, University of Cambridge, Cavendish Laboratory, University of Cambridge)

**Abstract:** We present an analysis of bursty star-formation histories (SFHs) of 346 star-forming galaxies at $1\lesssim z<7$, selected from JWST/NIRSpec G395M and PRISM spectroscopy provided by the CEERS and RUBIES surveys. We analyze the correlation of star-formation rate vs. stellar mass (the star-forming main sequence, SFMS) for our sample and find no significant difference between the intrinsic scatter in the H$\alpha$-based SFMS and the UV-continuum-based SFMS. However, the diagnostic power of the SFMS is limited at high redshift and low stellar mass due to observational biases that exclude faint, quenched galaxies. To more directly probe star-formation variability, we examine the dust-corrected H$\alpha$-to-UV ratio, which is assumed to trace deviations a from constant SFH over the past $\sim100$ Myr. In our sample, $73^{+4}_{-4}$% of galaxies exhibit H$\alpha$-to-UV ratios inconsistent with a constant SFH. We do not observe any statistically significant evolution in the H$\alpha$-to-UV ratio with redshift. Additionally, lower-mass galaxies ($7\leq\text{log}(M_*/M_{\odot})<8.5$) are $30 \pm 1$% more likely to lie above this equilibrium range -- indicative of a recent ($\lesssim 100$ Myr) burst of star formation -- compared to higher-mass systems ($8.5\leq\text{log}(M_*/M_{\odot})\leq10.9$). These results suggest that bursty SFHs are more common in low-mass galaxies at $z\sim 1$-$7$ and that this remains relatively stable across $\sim0.8$-$6$ Gyr after the Big Bang.

**Comment:** Directly addresses resolved star formation histories and bursty star formation in low-mass galaxies at z=1-7 using JWST/NIRSpec spectroscopy. Highly relevant to resolved star formation histories and star formation quenching in dwarf galaxies.
...
## 5. [Self-interacting dark matter in the center of a Local Group dwarf galaxy and its satellites](https://arxiv.org/abs/2510.05258) <a id="link5"></a>
...
**Comment:** Compares a Local Group dwarf galaxy analogue in CDM and SIDM models, analyzing substructure, dark matter density profiles (core-cusp), satellite abundances, and star formation. Directly matches 'Near-Field Cosmology', 'Numerical Galaxy Simulations', and touches on 'Star Formation Quenching' and 'Core-Cusp' problems.
...
## 7. [Resolving Star Cluster Formation in Galaxy Simulations with Cosmic Ray Feedback](https://arxiv.org/abs/2510.06134) <a id="link7"></a>
...
**Comment:** This paper presents simulations of star cluster formation with cosmic ray feedback, resolving parsec-scale star formation sites and the multiphase ISM. It directly matches the 'Numerical Galaxy Simulations' criterion, with increased weight due to inclusion of new physics (cosmic ray transport).
...
## 8. [Mass loading of outflows from evolving Young Massive Clusters](https://arxiv.org/abs/2510.06100) <a id="link8"></a>
...
**Comment:** Directly addresses the mass loading of outflows from young massive clusters, with a focus on mechanical feedback, wind velocities, and metallicity dependence. This matches the 'Star Formation Driven Outflows' criterion, especially regarding mass-loading factors and feedback from stellar populations. The study uses pySTARBURST99 to model cluster wind properties, which is relevant for understanding outflows in different environments.
...
## 9. [DISCO-DJ II: a differentiable particle-mesh code for cosmology](https://arxiv.org/abs/2510.05206) <a id="link9"></a>
...
**Comment:** Presents a new differentiable particle-mesh code for cosmological simulations, enabling fast, accurate, and GPU-accelerated modeling of large-scale structure. Highly relevant to numerical galaxy simulations, especially for cosmological inference.
...
## 10. [Central Massive Black Holes Are Not Ubiquitous in Local Low-Mass Galaxies](https://arxiv.org/abs/2510.05252) <a id="link10"></a>
...
**Comment:** Examines the occupation fraction of central massive black holes in local low-mass and dwarf galaxies. Relevant to near-field cosmology, as it addresses the properties of dwarf galaxies and their black hole content, with implications for galaxy evolution.
...
## 11. [Abundance Pattern Fitting with Bayesian Inference: Constraining First Stars' Properties and Their Explosion Mechanism with Extremely Metal-poor Stars](https://arxiv.org/abs/2510.05712) <a id="link11"></a>

**ArXiv ID:** 2510.05712

**Authors:** Ruizheng Jiang, Haining Li, Gang Zhao, Qianfan Xing, Wenyu Xin

**Abstract:** The abundance patterns of extremely metal-poor stars preserve a fossil record of the Universe's earliest chemical enrichment by the supernova explosions from the evolution of first generation of stars, also referred to as Population III (or Pop III). By applying Bayesian inference to the analysis of abundance patterns of these ancient stars, this study presents a systematic investigation into the properties and explosion mechanism of Pop III stars. We apply NLTE corrections to enhance the reliability of abundance measurements, which significantly reduces the discrepancies in abundances between observations and theoretical yields for odd-Z elements, such as Na and Al. Our Bayesian framework also enables the incorporation of explodability and effectively mitigates biases introduced by varying resolutions across different supernova model grids. In addition to confirming a top-heavy ($\alpha=0.54$) initial mass function for massive Pop III stars, we derive a robust mass--energy relation ($E\propto M^2$) of the first supernovae. These findings demonstrate that stellar abundance analysis provides a powerful and independent approach for probing early supernova physics and the fundamental nature of the first stars.

**Comment:** Presents Bayesian inference of abundance patterns in extremely metal-poor stars to constrain properties of Population III stars and their supernovae. This fits the 'Near-Field Cosmology' criterion, as it uses fossil records in ancient stars to probe early chemical enrichment and supernova physics.
...
## 14. [SN 2021tsz: A luminous, short photospheric phase Type II supernova in a low-metallicity host](https://arxiv.org/abs/2510.05426) <a id="link14"></a>
...
**Comment:** Studies a Type II supernova in a low-metallicity dwarf galaxy, with hydrodynamic modeling and host galaxy analysis. The focus on a dwarf galaxy and implications for binary progenitors and mass loss are relevant to 'Near-Field Cosmology' and possibly 'Star Formation Quenching' (environmental effects), but the main focus is on the SN event.
...
## 15. [EIGER VIII: First stars signatures in the connection between OI absorption and Galaxies in the Epoch of Reionization](https://arxiv.org/abs/2510.05220) <a id="link15"></a>
...
**Comment:** This paper studies the circumgalactic medium (CGM) around galaxies at z~6, focusing on metal-enriched gas and its connection to galaxies, including the role of Population III stars in early metal enrichment. While the CGM is a relevant topic, the focus is on high-redshift galaxies rather than local dwarfs, and the connection to near-field cosmology is indirect. The work is observational and provides new insights into early CGM properties and enrichment.
...
## 16. [Resolved Profiles of Stellar Mass, Star Formation Rate, and Predicted CO-to-H$_2$ Conversion Factor Across Thousands of Local Galaxies](https://arxiv.org/abs/2510.05214) <a id="link16"></a>
...
**Comment:** This paper presents resolved radial profiles of stellar mass and star formation rate for thousands of local galaxies, and discusses molecular gas depletion times and CO-to-H2 conversion factors. While the sample is dominated by galaxies more massive than dwarfs (Mstar > 10^9.3 Msun), the methodology and results on resolved star formation rates and depletion times are relevant to the 'Resolved Star Formation Histories' and 'Star Formation Quenching' criteria, though not focused on dwarfs. Novelty is moderate due to the large sample and empirical approach.
...
## 17. [Galaxy sizes and compactness at Cosmic Dawn](https://arxiv.org/abs/2510.05299) <a id="link17"></a>
...
**Comment:** Uses high-resolution cosmological simulations (FirstLight) to study galaxy sizes and compaction at high redshift. While the focus is on high-mass galaxies, the work presents new simulation results and physical mechanisms relevant to 'Numerical Galaxy Simulations'. However, the mass range is above the LMC, so relevance is moderate.
...
## 18. [Interpreting anomaly detection of SDSS spectra](https://arxiv.org/abs/2510.05235) <a id="link18"></a>
...
**Comment:** Presents a machine learning framework for anomaly detection in SDSS galaxy spectra, identifying unusual starburst and emission-line galaxies. While it touches on star formation and metallicity, it does not directly address resolved star formation histories, quenching, or dwarf galaxy properties.
...
## 21. [A Comparison of Star Formation Rates by Different Tracers in Nearby Galaxies](https://arxiv.org/abs/2510.05687) <a id="link21"></a>
...
**Comment:** This paper compares star formation rate tracers in a large sample of nearby galaxies, including star-forming, composite, Seyfert, and LINER galaxies. While it discusses star formation rates and their connection to AGN activity, it does not focus on resolved star formation histories from color-magnitude diagrams, dwarf galaxy quenching, or other core criteria. The work is more general and not specific to dwarfs or near-field cosmology.
...
## 22. [A Data-Driven Prism: Multi-View Source Separation with Diffusion Model Priors](https://arxiv.org/abs/2510.05205) <a id="link22"></a>
...
**Comment:** This paper presents a diffusion model-based method for multi-view source separation, with applications including deblending galaxies in crowded fields. While deblending is tangentially related to resolved star formation histories, the focus is on methodology rather than direct application to the core topics.
...
## 23. [Demagnifying gravitational lenses as probes of dark matter structures and nonminimal couplings to gravity](https://arxiv.org/abs/2510.05575) <a id="link23"></a>

**ArXiv ID:** 2510.05575

**Authors:** Hong-Yi Zhang

**Abstract:** Magnification of total image fluxes is typically considered a defining feature of gravitational microlensing. In contrast, I will show that nonminimal couplings to gravity can generate regions of negative gravitational potential curvature, giving rise to the distinctive possibility of demagnification. Such events, appearing as flux troughs in microlensing light curves, provide a direct probe of dark matter structures and, crucially, offer a means to disentangle nonminimal couplings to gravity from other astrophysical and cosmological models.

**Comment:** Discusses demagnifying gravitational lenses as probes of dark matter structures and nonminimal couplings to gravity. While it touches on dark matter, the focus is on lensing and fundamental physics, not on galaxy substructure or near-field cosmology.
...
## 25. [Resurging from the ashes: A spectral study of seven candidate revived radio fossils in nearby low-mass galaxy clusters](https://arxiv.org/abs/2510.05673) <a id="link25"></a>
...
**Comment:** Studies revived radio fossils in low-mass galaxy clusters, focusing on radio plasma and intracluster medium microphysics. While the clusters are low-mass, the work does not focus on dwarf galaxies or their satellites, nor does it address star formation histories, quenching, or galaxy simulations.
...
## 26. [The influence of rotation and metallicity on the explodability of massive stars](https://arxiv.org/abs/2510.06043) <a id="link26"></a>
...
**Comment:** Investigates the influence of rotation and metallicity on the explodability of massive stars using MESA simulations. While it involves stellar models and evolution, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on galaxy-scale phenomena.
...
## 27. [Line shapes of the Na/K resonance line profiles perturbed by H2 at extreme density](https://arxiv.org/abs/2510.05763) <a id="link27"></a>

**ArXiv ID:** 2510.05763

**Authors:** N. F. Allard, J. F. Kielkopf

**Abstract:** Collision broadening by molecular hydrogen of sodium and potassium is one of the major broadening mechanisms in the atmospheres of brown dwarf stars and exoplanets at an effective temperature of about 1000K. The accurate computation of line profiles from collision broadening at high density requires use of a Fourier transform of the autocorrelation function inside the model atmosphere code. We strongly warn that use of Lorentzian profiles at a high perturber density neglects radiation during close collisions and may lead to erroneous conclusions.

**Comment:** This paper presents new calculations of Na/K line broadening in brown dwarf and exoplanet atmospheres, which is relevant to stellar atmosphere modeling but does not present new stellar models or bolometric corrections. It is tangential to the 'Stellar Models' criterion.
...
## 28. [On the Formation of GW231123 in Population III Star Clusters](https://arxiv.org/abs/2510.05634) <a id="link28"></a>
...
**Comment:** This paper investigates the formation of a binary black hole merger in Population III star clusters. While it discusses stellar evolution and cluster dynamics, it does not focus on galaxy-scale simulations, resolved star formation histories, or dwarf galaxies.
...
## 29. [Rare Transients in Nearby Galaxies Explain Ultra-high-energy Cosmic Rays](https://arxiv.org/abs/2510.06193) <a id="link29"></a>
...
**Comment:** Explains ultra-high-energy cosmic ray features via rare transients in nearby galaxies, including neutron-star mergers. While it discusses nearby galaxies, the focus is on cosmic ray origins, not on near-field cosmology, dwarf galaxies, or any of the core criteria.
...
## 30. [StarEmbed: Benchmarking Time Series Foundation Models on Astronomical Observations of Variable Stars](https://arxiv.org/abs/2510.06200) <a id="link30"></a>
...
**Comment:** Benchmarks time series foundation models on variable star light curves. While it deals with stellar variability and machine learning, it does not present new stellar models or address the other core topics.
...
## 31. [Dormant BH candidates from Gaia DR3 summary diagnostics](https://arxiv.org/abs/2510.05982) <a id="link31"></a>
...
**Comment:** Identifies dormant black hole and neutron star candidates in binaries using Gaia DR3 data. Focus is on compact object binaries, not on the specified criteria related to galaxies, star formation, or CGM.
...
## 32. [QML-FAST - A Fast Code for low-$\ell$ Tomographic Maximum Likelihood Power Spectrum Estimation](https://arxiv.org/abs/2510.05215) <a id="link32"></a>
...
**Comment:** Describes a new code for tomographic maximum likelihood power spectrum estimation, relevant for cosmological data analysis but not directly tied to galaxy simulations, star formation histories, or near-field cosmology.
...
## 34. [Studying the gravitational-wave population without looking that FAR out](https://arxiv.org/abs/2510.06220) <a id="link34"></a>
...
**Comment:** This paper discusses methods for robust inference of gravitational-wave populations and formation channels of compact binaries. While it touches on population properties, it does not focus on galaxy-scale simulations, resolved star formation histories, or dwarf galaxies.
...
## 36. [Large-scale peculiar velocities in the universe](https://arxiv.org/abs/2510.05340) <a id="link36"></a>
...
**Comment:** This paper discusses large-scale peculiar velocities (bulk flows) in the universe, their origins, and implications for structure formation. While it is broadly cosmological, it does not focus on near-field cosmology, dwarf galaxies, or any of the specified criteria.
...
## 37. [Validation of the DESI-DR1 3x2-pt analysis: scale cut and shear ratio tests](https://arxiv.org/abs/2510.05539) <a id="link37"></a>
...
**Comment:** Validates cosmological analysis methods for large-scale structure surveys, focusing on galaxy clustering and weak lensing. While relevant to cosmology, it does not address near-field cosmology, dwarf galaxies, resolved star formation histories, or other core criteria.
...
## 38. [The Cosmic Infrared Background Experiment-2: An Intensity Mapping Optimized Sounding-rocket Payload to Understand the Near-IR Extragalactic Background Light](https://arxiv.org/abs/2510.05210) <a id="link38"></a>
...
**Comment:** Describes a sounding-rocket experiment to measure the near-IR extragalactic background light. While it touches on cosmic structure formation, it does not address any of the specific core topics such as dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 39. [An interferometric mid-infrared study of the eruptive star binary Z CMa with MATISSE/VLTI. I. Imaging the protoplanetary disks during the 2023 outburst](https://arxiv.org/abs/2510.05818) <a id="link39"></a>
...
**Comment:** Interferometric study of protoplanetary disks in a binary system during an outburst. Focus is on disk structure and star formation in a massive binary, not on dwarf galaxies, resolved star formation histories, or CGM.
...
## 40. [Ionization Sources of the Local Interstellar Clouds: Two B-stars, Three White Dwarfs, and the Local Hot Bubble](https://arxiv.org/abs/2510.05263) <a id="link40"></a>
...
**Comment:** This paper studies the ionization sources of local interstellar clouds, focusing on the impact of nearby B-stars, white dwarfs, and the local hot bubble. While it discusses the local ISM and ionization, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or dwarf galaxy quenching. The focus is on the local interstellar environment rather than galaxies or their satellites.
...
## 41. [Wavefront Error Recovery and Companion Identification with the James Webb Space Telescope](https://arxiv.org/abs/2510.05308) <a id="link41"></a>
...
**Comment:** This paper presents a new high-contrast imaging technique for JWST NIRISS to detect faint companions and recover wavefront errors. While it mentions deblending and companion identification, it does not focus on any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 42. [Multiprobe constraints on early and late time dark energy](https://arxiv.org/abs/2510.06114) <a id="link42"></a>
...
**Comment:** This paper performs a multiprobe cosmological analysis to constrain dark energy models using CMB and LSS data. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 43. [Binary Neutron Stars from the Moon: Early Warnings and Precision Science for the Artemis Era](https://arxiv.org/abs/2510.05400) <a id="link43"></a>
...
**Comment:** Focuses on binary neutron star mergers and lunar-based gravitational wave observatories. While interesting for multi-messenger astrophysics, it does not address any of the core topics such as dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 44. [Overlap-aware segmentation for topological reconstruction of obscured objects](https://arxiv.org/abs/2510.06194) <a id="link44"></a>
...
**Comment:** Presents a new segmentation-regression framework for scientific imaging, demonstrated in the context of the MIGDAL experiment. The focus is on imaging techniques and not on any of the specified astrophysical criteria.
...
## 46. [Everyone wants something better than $\Lambda$CDM](https://arxiv.org/abs/2510.05483) <a id="link46"></a>
...
**Comment:** Reviews the status of Lambda-CDM and discusses future directions in cosmology. General cosmological paradigm discussion, not focused on the specified criteria.
...
## 47. [PDRs4All XIX. The 6 to 9 $\mu$m region as a probe of PAH charge and size in the Orion Bar](https://arxiv.org/abs/2510.06167) <a id="link47"></a>
...
**Comment:** This study investigates PAH charge and size in the Orion Bar using JWST MIRI data. The focus is on molecular cloud rims and PAH properties, which do not match any of the core criteria such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 49. [Intrinsically Quantum Effects of Axion Dark Matter are Undetectable](https://arxiv.org/abs/2510.05198) <a id="link49"></a>
...
**Comment:** This paper discusses quantum effects in axion dark matter detection, focusing on quantum optics and the classical/quantum nature of axion fields. While axion dark matter is a cosmological topic, the work does not address near-field cosmology, galaxy evolution, or any of the specified criteria.
...
## 50. [The Gamma-ray Luminosity Function of Flat-Spectrum Radio Quasars](https://arxiv.org/abs/2510.05515) <a id="link50"></a>
...
**Comment:** Focuses on the gamma-ray luminosity function of flat-spectrum radio quasars (FSRQs), which are massive AGN-hosting galaxies. No direct connection to dwarf galaxies, resolved star formation histories, quenching, stellar models, or galaxy simulations. Irrelevant to all core criteria.
...
## 51. [Discovery of Changing-Look behavior in AGN NGC 3822: A long-term multiwavelength study](https://arxiv.org/abs/2510.05599) <a id="link51"></a>
...
**Comment:** Long-term multiwavelength study of changing-look AGN NGC 3822, focusing on AGN variability and broad emission line transitions. No connection to dwarf galaxies, resolved star formation histories, or other core criteria.
...
## 52. [Magnetic Fields in the Bones of the Milky Way](https://arxiv.org/abs/2510.05933) <a id="link52"></a>
...
**Comment:** Studies magnetic fields in 'bones' of the Milky Way, which are large filamentary molecular clouds near the Galactic plane. The focus is on star formation in the disk, not on dwarf galaxies, satellite systems, or the other core topics.
...
## 53. [Microscopic study of nuclei synthesis in pycnonuclear reaction $\isotope[12]{C} + \isotope[12]{C}$ in neutron stars](https://arxiv.org/abs/2510.05726) <a id="link53"></a>
...
**Comment:** Focuses on pycnonuclear reactions and nuclear synthesis in neutron stars, which is outside the scope of near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or CGM. No direct relevance to the specified criteria.
...
## 54. [First X-ray and radio polarimetry of the neutron star low-mass X-ray binary GX 17+2](https://arxiv.org/abs/2510.05284) <a id="link54"></a>
...
**Comment:** Reports X-ray and radio polarimetry of a neutron star low-mass X-ray binary. The focus is on accretion geometry and polarimetry, not on near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 59. [Pulsar timing array analysis in a Legendre polynomial basis](https://arxiv.org/abs/2510.05913) <a id="link59"></a>
...
**Comment:** Uses Legendre polynomials for pulsar timing array analysis, relevant for gravitational wave detection but not for galaxy evolution, star formation, or near-field cosmology.
...
## 62. [Gaussian process analysis of type-B quasiperiodic oscillations in the black hole X-ray binary MAXI J1348-630](https://arxiv.org/abs/2510.05587) <a id="link62"></a>
...
**Comment:** This paper focuses on quasi-periodic oscillations in a black hole X-ray binary, analyzing accretion disk and corona properties. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, or outflows. The focus is on accretion physics and variability in a stellar-mass black hole system.
...
## 65. [Constraints on Radial Gas Flows in the Milky Way Disk Revealed by Large Stellar Age Catalogs](https://arxiv.org/abs/2510.05223) <a id="link65"></a>
...
**Comment:** Focuses on radial gas flows and chemical evolution in the Milky Way disk, which is not relevant to near-field cosmology (satellite galaxies, dwarf galaxies, etc.) and does not address resolved star formation histories, quenching, or other criteria.
...
## 67. [Infall Explains the Disk Kinematics of AB Aur Without Gravitational Instability](https://arxiv.org/abs/2510.05601) <a id="link67"></a>

**ArXiv ID:** 2510.05601

**Authors:** Josh Calcino, Daniel J. Price, Chris W. Ormel

**Abstract:** Late-stage infall onto protoplanetary disks can produce large scale spiral arms. In this paper we used 3D smoothed particle hydrodynamics and radiative transfer simulations to study the kinematic perturbations induced in disks by infalling material. We found that deviations from Keplerian rotation are predominantly in the radial and vertical velocity components, spatially correlated with spiral arms in the gas surface density. The infall produces observable wiggles in the channel maps, analogous to those produce by the gravitational instability (GI), along with large-scale arcs and filaments. GI induced spiral arms produce radial velocity perturbations that point towards the center of the spiral arm owing to their higher self-gravity. We found a similar signature from infall-induced spiral arms, despite not including self-gravity in our simulation. Our study suggests that recent evidence of GI in the kinematics of the disk around AB Aur may instead be due to the observed infall, without the need for invoking GI.

**Comment:** Uses hydrodynamical simulations to study infall-induced spiral arms in protoplanetary disks, specifically around AB Aur. Focus is on disk kinematics and planet formation, not galaxy-scale simulations or any core criteria.
...
## 69. [Stochastic Gravitational Waves from Modulated Reheating](https://arxiv.org/abs/2510.05967) <a id="link69"></a>
...
**Comment:** Discusses stochastic gravitational waves from modulated reheating in the early universe, with a focus on inflationary physics and gravitational wave backgrounds. No direct connection to the core topics.
...
## 70. [Adaptive and Multi-Source Entity Matching for Name Standardization of Astronomical Observation Facilities](https://arxiv.org/abs/2510.05744) <a id="link70"></a>
...
**Comment:** Develops a methodology for name standardization of astronomical observation facilities using NLP and LLMs. This is a data infrastructure/methods paper and does not address any of the core topics.
...
## 72. [The gamma-ray emission from Radio Galaxies and their contribution to the Isotropic Gamma-Ray Background](https://arxiv.org/abs/2510.06047) <a id="link72"></a>
...
**Comment:** This paper evaluates the contribution of radio galaxies to the isotropic gamma-ray background. It focuses on AGN and radio galaxies, which are not relevant to the core criteria.
...
## 74. [Three-dimensional Reconstruction and Propagation of an Asymmetric Flux-rope Coronal Mass Ejection](https://arxiv.org/abs/2510.05916) <a id="link74"></a>
...
**Comment:** This paper reconstructs a coronal mass ejection (CME) event using solar coronagraph data. The focus is on solar physics and CME morphology, not on galaxy evolution, star formation, or CGM.
...
## 75. [Accessing the fine temporal scale of EUV brightenings and their quasi-periodic pulsations: 1 second cadence observations by Solar Orbiter/EUI](https://arxiv.org/abs/2510.05810) <a id="link75"></a>
...
**Comment:** This paper analyzes small-scale EUV brightenings and quasi-periodic pulsations in the solar corona, with implications for coronal heating. The focus is on solar physics, not on galaxy evolution, star formation, or CGM.
...
## 76. [Testing the arrow of time at the cosmo collider](https://arxiv.org/abs/2510.05204) <a id="link76"></a>
...
**Comment:** Discusses theoretical signals from Lee-Wick ghosts in cosmology and inflation, with no direct connection to galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 77. [Kinetic collisionless model of the solar transition region and corona with spatially intermittent heating](https://arxiv.org/abs/2510.05954) <a id="link77"></a>
...
**Comment:** This paper presents a kinetic model of the solar transition region and corona, focusing on plasma heating and temperature profiles. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 78. [Radiative-Corrected Higgs Inflation in Light of the Latest ACT Observations](https://arxiv.org/abs/2510.05770) <a id="link78"></a>
...
**Comment:** Revisits quantum-corrected Higgs inflation in light of new CMB data. The focus is on inflationary cosmology, not on any of the core topics.
...
## 79. [Near-continuous tracking of solar active region NOAA 13664 over three solar rotations](https://arxiv.org/abs/2510.05979) <a id="link79"></a>
...
**Comment:** Tracks the evolution of a solar active region over multiple rotations. Focus is on solar physics, not galaxy evolution, star formation, or near-field cosmology.
...
## 80. [Buildup, Explosion, and Untwisting of a Solar Active Region Jet Observed with Solar Orbiter, IRIS, and SDO](https://arxiv.org/abs/2510.05439) <a id="link80"></a>
...
**Comment:** Detailed analysis of a solar active region jet. Focus is on solar physics and magnetic activity, not galaxy evolution or near-field cosmology.
...
## 81. [Estimation of intrinsic fast radio burst width and scattering distributions from CRAFT data](https://arxiv.org/abs/2510.05654) <a id="link81"></a>
...
**Comment:** Analyzes fast radio burst width and scattering distributions; does not match any of the core criteria (no connection to galaxy simulations, star formation, dwarf galaxies, etc.).
...
## 84. [From X-rays to High-Energy Gamma-rays: A Comprehensive Multi-Wavelength Study of Early Gamma-Ray Burst Afterglows](https://arxiv.org/abs/2510.05239) <a id="link84"></a>
...
**Comment:** This paper is a multiwavelength study of gamma-ray burst afterglows, focusing on relativistic shock microphysics and emission modeling. It does not match any of the core criteria (galaxy evolution, star formation, CGM, etc.).
...
## 85. [Exploring Complexity Measures for Analysis of Solar Wind Structures and Streams](https://arxiv.org/abs/2510.05873) <a id="link85"></a>
...
**Comment:** This paper applies complexity measures and information theory to solar wind time series, focusing on solar wind structures. It does not match any of the core criteria related to galaxy evolution, star formation, or CGM.
...
## 86. [Comparing LSTM-Based Sequence-to-Sequence Forecasting Strategies for 24-Hour Solar Proton Flux Profiles Using GOES Data](https://arxiv.org/abs/2510.05399) <a id="link86"></a>
...
**Comment:** This paper compares LSTM-based forecasting strategies for solar proton flux profiles using GOES data, focusing on space weather prediction. It does not match any of the core criteria related to galaxy evolution, star formation, or CGM.
...
## 88. [Empirical Optimization of the Source-Surface Height in the PFSS extrapolation](https://arxiv.org/abs/2510.05513) <a id="link88"></a>
...
**Comment:** This paper focuses on solar magnetic field extrapolation and the PFSS method, which is not related to any of the core topics (galaxy evolution, dwarf galaxies, star formation histories, CGM, etc.).
