...
1. [Threading the Magellanic Needle: Hypervelocity Stars Trace the Past Location of the LMC](#user-content-link1)
**Authors:** Scott Lucchini, Jiwon Jesse Han

2. [The LMC Corona as Evidence for a First Passage](#user-content-link2)
**Authors:** Scott Lucchini, Jiwon Jesse Han, Sapna Mishra, Andrew J. Fox

3. [The Milky Way - Large Magellanic Cloud Interaction with Simulation Based Inference](#user-content-link3)
**Authors:** Richard A. N. Brooks, Jason L. Sanders, Vedant Chandra, Nicol\'as Garavito-Camargo, Adam M. Dillamore, Adrian M. Price-Whelan, Yuan-Sen Ting

4. [Chroma+ model stellar surface intensities: Spherical formal solution](#user-content-link4)
**Authors:** C. Ian Short

5. [Analysis of Galaxies at the Extremes: Failed Galaxy Progenitors in the MAGNETICUM Simulations](#user-content-link5)
...
6. [On the sensitivity of different galaxy properties to warm dark matter](#user-content-link6)
**Authors:** Bel\'en Costanza, Bonny Y. Wang, Francisco Villaescusa-Navarro, Alex M. Garcia, Jonah C. Rose, Mark Vogelsberger, Paul Torrey, Arya Farahi, Xuejian Shen, Ilem Leisher

7. [Cosmological Hydrodynamics at Exascale: A Trillion-Particle Leap in Capability](#user-content-link7)
**Authors:** Nicholas Frontiere, J. D. Emberson, Michael Buehlmann, Esteban M. Rangel, Salman Habib, Katrin Heitmann, Patricia Larsen, Vitali Morozov, Adrian Pope, Claude-Andr\'e Faucher-Gigu\`ere, Antigoni Georgiadou, Damien Lebrun-Grandi\'e, Andrey Prokopenko

8. [Woven by the Whirls: The growth and entrainment of cold clouds in turbulent hot winds](#user-content-link8)
**Authors:** Ritali Ghosh, Max Gronke, Prateek Sharma, Alankar Dutta

9. [H I Properties of Field Galaxies at $\boldsymbol{z\approx 0.2}$-0.6: Insights into Declining Cosmic Star Formation](#user-content-link9)
**Authors:** David DePalma, Neeraj Gupta, Hsiao-Wen Chen, Robert A. Simcoe, Sergei Balashev, Erin Boettcher, Sebastiano Cantalupo, Mandy C. Chen, Fran\c{c}oise Combes, Claude-Andr\'e Faucher-Gigu\`ere, Sean D. Johnson, Hans-Rainer Kl\"ockner, Jens-Kristian Krogager, Jennifer I-Hsiu Li, Sebasti\'an L\'opez, Pasquier Noterdaeme, Patrick Petitjean, Zhijie Qu, Gwen C. Rudie, Joop Schaye, Fakhri Zahedy

10. [Physical interpretation of the oscillation spectrum on the RGB and AGB](#user-content-link10)
**Authors:** G. Dr\'eau, Y. Lebreton, B. Mosser, D. Stello

11. [Azimuthal Misalignments in Stellar Warp Structure as Dynamical Tracers of Mergers in Milky Way-like Galaxies](#user-content-link11)
**Authors:** Lekshmi Thulasidharan, Elena D'Onghia, Robert Benjamin

12. [Abundance of strontium in the Galactic globular cluster 47 Tuc](#user-content-link12)
**Authors:** E. Kolomiecas, A. Ku\v{c}inskas, J. Klevas, V. Dobrovolskas

13. [On the Frequency of Multiple Galaxy Mergers in $\Lambda$CDM Cosmological Simulations](#user-content-link13)
**Authors:** Jonathan Mack, Shy Genel

14. [Resonant production of sterile neutrino dark matter with a refined numerical scheme](#user-content-link14)
**Authors:** Kentaro Kasai, Masahiro Kawasaki, Kai Murai

15. [The demographics of core-collapse supernovae I. The role of binary evolution and CSM interaction](#user-content-link15)
**Authors:** Andrea Ercolino, Harim Jin, Norbert Langer, Avishay Gal-Yam, Abel Schootemeijer, Caroline Mannes

16. [Inferring the dark matter distribution of massive galaxy clusters from deep optical observations: insights from the TNG300 simulation](#user-content-link16)
**Authors:** Aditya Manuwal (Universidad Nacional Aut\'onoma de M\'exico, Instituto de Astronom\'ia, A.P. 70-264, 04510 CDMX, M\'exico), Vladimir Avila-Reese (Universidad Nacional Aut\'onoma de M\'exico, Instituto de Astronom\'ia, A.P. 70-264, 04510 CDMX, M\'exico), Daniel Montenegro-Taborda (Instituto de Radioastronom\'ia y Astrof\'isica, Universidad Nacional Aut\'onoma de M\'exico, A.P. 72-3, 58089 Morelia, M\'exico), Vicente Rodriguez-Gomez (Instituto de Radioastronom\'ia y Astrof\'isica, Universidad Nacional Aut\'onoma de M\'exico, A.P. 72-3, 58089 Morelia, M\'exico), Bernardo Cervantes Sodi (Instituto de Radioastronom\'ia y Astrof\'isica, Universidad Nacional Aut\'onoma de M\'exico, A.P. 72-3, 58089 Morelia, M\'exico)

17. [Matching JWST UV Luminosity Functions with Refined $\Lambda$CDM Halo Models](#user-content-link17)
**Authors:** Saeed Fakhry, Maryam Shiravand, Antonino Del Popolo

18. [Interactive High-Performance Visualization for Astronomy and Cosmology](#user-content-link18)
**Authors:** Eva Sciacca, Nicola Tuccari, Umer Arshad, Fabio Pitari, Giuseppa Muscianisi, Emiliano Tramontana

19. [ALMA-IMF. XXI.: N$_2$H$^+$ kinematics in the G012.80 protocluster: Evidence for filament rotation and evolution](#user-content-link19)
**Authors:** J. Salinas, A. M. Stutz, R. H. \'Alvarez-Guti\'errez, N. A. Sandoval-Garrido, F. Louvet, R. Galv\'an-Madrid, F. Motte, M. Armante, T. Csengeri, J. Braine, A. Ginsburg, M. Valeille-Manet, L. Bronfman, P. Sanhueza, D. D\'iaz, G. Busquet, A. Koley, M. Bonfand, M. Fern\'andez-L\'opez, N. Castro-Toledo, R. Veyry, G. Bernal-Mesina

20. [Formation and growth of intermediate-mass black holes in dense star clusters: Lessons from N-body and MOCCA Monte Carlo Simulations](#user-content-link20)
**Authors:** Abbas Askar, Marcelo C. Vergara, Sohaib Ali

21. [DRAGON-III simulation: modelling million-body globular and nuclear star clusters](#user-content-link21)
**Authors:** Kai Wu, Philip Cho, Rainer Spurzem, Long Wang, Francesco Flammini Dotti, Vahid Amiri

22. [A Link Between Rocky Planet Density and Host Star Chemistry](#user-content-link22)
**Authors:** Aida Behmard, Casey L. Brinkman, Soichiro Hattori, Ryan A. Rubenzahl, Megan Bedell

23. [A GLIMPSE into the very faint-end of the H$\beta$+[OIII]$\lambda\lambda$4960,5008 luminosity function at z=7-9 behind Abell S1063](#user-content-link23)
**Authors:** Damien Korber, Iryna Chemerynska, Lukas J. Furtak, Hakim Atek, Ryan Endsley, Daniel Schaerer, John Chisholm, Alberto Saldana-Lopez, Angela Adamo, Julian B. Mu\~noz, Pascal A. Oesch, Romain Meyer, Rui Marques-Chaves, Seiji Fujimoto

24. [The Role of Spiral Arms in Galaxies II: Similarities Amid Diversity](#user-content-link24)
**Authors:** Bingqing Sun, Daniela Calzetti, Andrew J. Battisti

25. [Doubly Discordant SH0ES NGC4258 Cepheid Relations (HVI), and Impactful Extinction Laws](#user-content-link25)
**Authors:** Daniel Majaess

26. [Suzaku observations of outskirts of nearby clusters and groups: I. electron density and gas fraction to the virial radius](#user-content-link26)
**Authors:** Kyoko Matsushita, Marie Kondo, Kosuke Sato, Toru Sasaki, Nobuhiro Okabe, Kotaro Fukushima

27. [Characterizing the variability of a sample of massive stars in eclipsing binaries](#user-content-link27)
**Authors:** C. I. Eze (Nicolaus Copernicus Astronomical Center, Warsaw, Poland, Department of Physics and Astronomy, University of Nigeria, Nsukka, Nigeria), G. Handler (Nicolaus Copernicus Astronomical Center, Warsaw, Poland), F. Kahraman Ali\c{c}avu\c{s} (\c{C}anakkale Onsekiz Mart University, Faculty of Sciences, Physics Department, \c{C}anakkale, T\"urkiye), T. Pawar (Nicolaus Copernicus Astronomical Center, Polish Academy of Sciences, Toru\'n, Poland), A. Miszuda (Nicolaus Copernicus Astronomical Center, Warsaw, Poland)

28. [Faint supernovae and hyper-runaway white-dwarfs from single He-detonation in double HeCO-white-dwarf mergers](#user-content-link28)
**Authors:** Hila Glanz, Hagai B. Perets, Aakash Bhat

29. [Galaxy Model Subtraction with a Convolutional Denoising Autoencoder](#user-content-link29)
**Authors:** Rongrong Liu, Eric W. Peng, Kaixiang Wang, Laura Ferrarese, Patrick C\^ot\'e

30. [Revisiting Gaussian Process Reconstruction for Cosmological Inference: The Generalised GP (Gen GP) Framework](#user-content-link30)
**Authors:** Ruchika, Purba Mukherjee, Arianna Favale

31. [Luminous Fast Blue Optical Transients as very massive star core-collapse events](#user-content-link31)
**Authors:** A. A. Chrimes, P. G. Jonker, A. J. Levan, A. Mummery

32. [Covariant cosmography in the presence of local structures: comparing exact solutions and perturbation theory](#user-content-link32)
**Authors:** Maharshi Sarma, Christian Marinoni, Basheer Kalbouneh, Chris Clarkson, Roy Maartens

33. [The Role of Acoustic Instability in Cosmic-Ray Self-Confinement](#user-content-link33)
**Authors:** Antonio Capanema, Pasquale Blasi, Emanuele Sobacchi

34. [From theory to observation: understanding filamentary flows in high-mass star-forming clusters](#user-content-link34)
**Authors:** M. R. A. Wells, R. Pillsworth, H. Beuther, R. E. Pudritz, E. W. Koch

35. [Exploring Low-Amplitude Variability in First Overtone Cepheids with TESS](#user-content-link35)
**Authors:** E. Plachy, H. Netzel, A. B\'odi

36. [Observation of undepleted phosphine in the atmosphere of a low-temperature brown dwarf](#user-content-link36)
**Authors:** Adam J. Burgasser (UC San Diego), Eileen C. Gonzales (SFSU), Samuel A. Beiler (U. Toledo), Channon Visscher (Dordt U, Space Science Institute), Ben Burningham (U. Hertfordshire), Gregory N. Mace (U. Texas Austin), Jacqueline K. Faherty (AMNH), Zenghua Zhang (Nanjing U.), Clara Sousa-Silva (Bard College, Institute of Astrophysics, Space Sciences), Nicolas Lodieu (IAC, La Laguna U.), Stanimir A. Metchev (Western University), Aaron Meisner (NSF's NOIRLab), Michael Cushing (U. Toledo), Adam C. Schneider (USNO), Genaro Suarez (AMNH), Chih-Chun Hsu (Northwestern U.), Roman Gerasimov (Notre Dame), Christian Aganze (Stanford), Christopher A. Theissen (UC San Diego)

37. [Fisher-Bingham-like normalizing flows on the sphere](#user-content-link37)
**Authors:** Thorsten Gl\"usenkamp

38. [Cosmic topology. Part IIb. Eigenmodes, correlation matrices, and detectability of non-orientable Euclidean manifolds](#user-content-link38)
**Authors:** Craig J. Copi (COMPACT Collaboration), Amirhossein Samandar (COMPACT Collaboration), Glenn D. Starkman (COMPACT Collaboration), Javier Carr\'on Duque (COMPACT Collaboration), Yashar Akrami (COMPACT Collaboration), Stefano Anselmi (COMPACT Collaboration), Andrew H. Jaffe (COMPACT Collaboration), Arthur Kosowsky (COMPACT Collaboration), Fernando Cornet-Gomez (COMPACT Collaboration), Johannes R. Eskilt (COMPACT Collaboration), Mikel Martin Barandiaran (COMPACT Collaboration), Deyan P. Mihaylov (COMPACT Collaboration), Anna Negro (COMPACT Collaboration), Joline Noltmann (COMPACT Collaboration), Thiago S. Pereira (COMPACT Collaboration), Andrius Tamosiunas (COMPACT Collaboration)

39. [A quantum information method for early universe with non-trivial sound speed](#user-content-link39)
**Authors:** Shi-Cheng Liu, Lei-Hua Liu, Bichu Li, Hai-Qing Zhang, Peng-Zhang He

40. [Introducing The SHell misAlignment Detection for straylight Estimation (SHADE) algorithm: the case of XMM-Newton](#user-content-link40)
**Authors:** S. Piscitelli, G. Ponti, M. Civitani, D. Spiga

41. [Gravitomagnetic-Hydrodynamics and Turbulence in Early Universe](#user-content-link41)
**Authors:** Jiaxiang Liang, Peng Xu, Minghui Du, Yifu Cheng, Zhan Wang, Ziren Luo

42. [Finding Supermassive Black Hole Binary Mergers in Pulsar Timing Array Data](#user-content-link42)
**Authors:** Sharon Mary Tomson, Boris Goncharov, Rutger van Haasteren

43. [Beyond CPL: Evidence for dynamical dark energy in three-parameter models](#user-content-link43)
**Authors:** Sonej Alam, Md. Wali Hossain

44. [Stochastic instantons and the tail of the inflationary density perturbation](#user-content-link44)
**Authors:** Jaime Calder\'on-Figueroa, David Seery

45. [The Wave Function of the Universe and Inflation](#user-content-link45)
**Authors:** Gerasimos Kouniatalis

46. [Joint eROSITA and H.E.S.S. analysis of MSH 15-52 using Gammapy](#user-content-link46)
**Authors:** Katharina Egg, Alison M. W. Mitchell

47. [Harnessing the XMM-Newton data: X-ray spectral modelling of 4XMM-DR11 detections and 4XMM-DR11s sources](#user-content-link47)
...
48. [Constraining the $^{30}$P($p,\gamma)^{31}$S reaction rate in ONe novae via the weak, low-energy, $\beta$-delayed proton decay of $^{31}$Cl](#user-content-link48)
**Authors:** T. Budner (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), M. Friedman (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Racah Institute of Physics, Hebrew University, Jerusalem, Israel), C. Wrede (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), B. A. Brown (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), J. Jos\'e (Departament de F\'isica, Universitat Polit\`ecnica de Catalunya, Barcelona, Spain, Institut d'Estudis Espacials de Catalunya, Universitat Polit\`ecnica de Catalunya, Barcelona, Spain), D. P\'erez-Loureiro (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA), L. J. Sun (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, School of Physics and Astronomy, Shanghai Jiao Tong University, Shanghai, China), J. Surbrook (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), Y. Ayyad (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Instituto Galego de F\'isica de Atlas Enerx\'ias, Universidade de Santiago de Compostela, Santiago de Compostela, Spain), D. W. Bardayan (Department of Physics, University of Notre Dame, Notre Dame, USA), K. Chae (Department of Physics, Sungkyunkwan University, Seoul, South Korea), A. A. Chen (Department of Physics and Astronomy, McMaster University, Hamilton, Canada), K. A. Chipps (Physics Division, Oak Ridge National Laboratory, Oak Ridge, USA, Department of Physics and Astronomy, University of Tennessee, Knoxville, USA), M. Cortesi (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA), B. Glassman (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), M. R. Hall (Department of Physics, University of Notre Dame, Notre Dame, USA), M. Janasik (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), J. Liang (Department of Physics and Astronomy, McMaster University, Hamilton, Canada), P. O'Malley (Department of Physics, University of Notre Dame, Notre Dame, USA), E. Pollacco (D\'epartement de Physique Nucl\'eaire, Institut de Recherche sur les lois Fondamentales de l'Univers, Commissariat \`a l\'energie atomique et aux \'energies alternatives, Universit\'e Paris-Saclay, Gif-sur-Yvette, France), A. Psaltis (Department of Physics and Astronomy, McMaster University, Hamilton, Canada), J. Stomps (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), T. Wheeler (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA)

49. [Spectral Properties of Anomalous Microwave Emission in 144 Galactic Clouds](#user-content-link49)
**Authors:** Roke Cepeda-Arroita, J. A. Rubi\~no-Mart\'in, R. T. G\'enova-Santos, C. Dickinson, S. E. Harper, F. Poidevin, M. W. Peel, R. Rebolo, D. Adak, A. Almeida, K. Aryan, R. B. Barreiro, F. J. Casas, J. M. Casas, J. Chluba, M. Fern\'andez-Torreiro, D. Herranz, G. A. Hoerning, Michael E. Jones, J. Leech, E. Mart\'inez-Gonz\'alez, T. J. Pearson, Angela C. Taylor, P. Vielva, R. A. Watson, Z. Zhang

50. [Edge-On Disk Study (EODS) II: HCO$^+$ and CO vertical stratification in the disk surrounding SSTTau042021](#user-content-link50)
**Authors:** C. Foucher, A. Dutrey, V. Pi\'etu, S. Guilloteau, E. Chapillon, O. Denis-Alpizar, E. Dartois, E. Di Folco, S. Gavino, U. Gorti, Th. Henning, \'A. K\'osp\'al, F. Le Petit, L. Majumdar, R. Meshaka, N. T. Phuong, M. Ruaud, D. Semenov, Y. W. Tang, S. Wolf

51. [Limiting the Yukawa Gravity through the Black Hole Shadows of Sgr A* and M87*](#user-content-link51)
**Authors:** Yuan Tan, Youjun Lu, Kunyu Song

52. [VHE $\gamma$-ray observations of bright BL Lacs with the Large-Sized Telescope prototype (LST-1) of the CTAO](#user-content-link52)
**Authors:** The CTAO-LST Project, :, K. Abe, S. Abe, A. Abhishek, F. Acero, A. Aguasca-Cabot, I. Agudo, C. Alispach, D. Ambrosino, F. Ambrosino, L. A. Antonelli, C. Aramo, A. Arbet-Engels, C. Arcaro, T. T. H. Arnesen, K. Asano, P. Aubert, A. Baktash, M. Balbo, A. Bamba, A. Baquero Larriva, U. Barres de Almeida, J. A. Barrio, L. Barrios Jim\'enez, I. Batkovic, J. Baxter, J. Becerra Gonz\'alez, E. Bernardini, J. Bernete, A. Berti, I. Bezshyiko, C. Bigongiari, E. Bissaldi, O. Blanch, G. Bonnoli, P. Bordas, G. Borkowski, G. Brunelli, A. Bulgarelli, M. Bunse, I. Burelli, L. Burmistrov, M. Cardillo, S. Caroff, A. Carosi, R. Carraro, M. S. Carrasco, F. Cassol, D. Cerasole, G. Ceribella, A. Cervi\~no Cort\'inez, Y. Chai, K. Cheng, A. Chiavassa, M. Chikawa, G. Chon, L. Chytk, G. M. Cicciari, A. Cifuentes, J. L. Contreras, J. Cortina, H. Costantini, M. Dalchenko, P. Da Vela, F. Dazzi, A. De Angelis, M. de Bony de Lavergne, R. Del Burgo, C. Delgado, J. Delgado Mengual, M. Dellaiera, D. della Volpe, B. De Lotto, L. Del Peral, R. de Menezes, G. De Palma, C. D\'iaz, G. Di Marco, A. Di Piano, F. Di Pierr, R. Di Tria, L. Di Venere, R. M. Dominik, D. Dominis Prester, A. Donini, D. Dorner, M. Doro, L. Eisenberger, D. Els\"asser, G. Emery, J. Escudero, V. Fallah Ramazani, F. Ferrarotto, A. Fiasson, L. Foffano, F. Fr\'ias Garc\'ia-Lago, S. Fr\"ose, Y. Fukazawa, S. Gallozzi, R. Garcia L\'opez, S. Garcia Soto, C. Gasbarra, D. Gasparrini, D. Geyer, J. Giesbrecht Paiva, N. Giglietto, F. Giordano, N. Godinovic, T. Gradetzke, R. Grau, D. Green, J. Green, S. Gunji, P. G\"unther, J. Hackfeld, D. Hadasch, A. Hahn, M. Hashizume, T. Hassan, K. Hayashi, L. Heckmann, M. Heller, J. Herrera Llorente, K. Hirotani, D. Hoffmann, D. Horns, J. Houles, M. Hrabovsky, D. Hrupec, D. Hui, M. Iarlori, R. Imazawa, T. Inada, Y. Inome, S. Inoue, K. Ioka, M. Iori, T. Itokawa, A. Iuliano, J. Jahanvi, I. Jimenez Martinez, J. Jimenez Quiles, I. Jorge Rodrigo, J. Jurysek, M. Kagaya, O. Kalashev, V. Karas, H. Katagiri, D. Kerszberg, T. Kiyomoto, Y. Kobayashi, K. Kohri, A. Kong, P. Kornecki, H. Kubo, J. Kushida, B. Lacave, M. Lainez, G. Lamanna, A. Lamastra, L. Lemoigne, M. Linhoff, S. Lombardi, F. Longo, R. L\'opez-Coto, M. L\'opez-Moya, A. L\'opez-Oramas, S. Loporchio, A. Lorini, J. Lozano Bahilo, F. Lucarelli, H. Luciani, P. L. Luque-Escamilla, P. Majumdar, M. Makariev, M. Mallamaci, D. Mandat, M. Manganaro, D. K. Maniadakis, G. Manic\`o, K. Mannheim, S. Marchesi, F. Marini, M. Mariotti, P. Marquez, G. Marsella, J. Mart\'i, O. Martinez, G. Mart\'inez, M. Mart\'inez, A. Mas-Aguilar, M. Massa, G. Maurin, D. Mazin, J. M\'endez-Gallego, S. Menon, E. Mestre Guillen, D. Miceli, T. Miener, J. M. Miranda, R. Mirzoyan, M. Mizote, T. Mizuno, M. Molero Gonzalez, E. Molina, T. Montaruli, A. Moralejo, D. Morcuende, A. Moreno Ramos, A. Morselli, V. Moya, H. Muraishi, S. Nagataki, T. Nakamori, A. Neronov, D. Nieto Casta\~no, M. Nievas Rosillo, L. Nikolic, K. Nishijima, K. Noda, D. Nosek, V. Novotny, S. Nozaki, M. Ohishi, Y. Ohtani, T. Oka, A. Okumura, R. Orito, L. Orsini, J. Otero-Santos, P. Ottanelli, M. Palatiello, G. Panebianco, D. Paneque, F. R. Pantaleo, R. Paoletti, J. M. Paredes, M. Pech, M. Pecimotika, M. Peresano, F. Pfeifle, E. Pietropaolo, M. Pihet, G. Pirola, C. Plard, F. Podobnik, M. Polo, E. Prandini, C. Priyadarshi, M. Prouza, S. Rain\`o, R. Rando, W. Rhode, M. Rib\'o, V. Rizi, G. Rodriguez Fernandez, M. D. Rodr\'iguez Fr\'ias, P. Romano, A. Roy, A. Ruina, E. Ruiz-Velasco, T. Saito, S. Sakurai, D. A. Sanchez, H. Sano, T. \v{S}ari\'c, Y. Sato, F. G. Saturni, V. Savchenko, F. Schiavone, B. Schleicher, F. Schmuckermaier, J. L. Schubert, F. Schussler, T. Schweizer, M. Seglar Arroyo, T. Siegert, G. Silvestri, A. Simongini, J. Sitarek, V. Sliusar, A. Stamerra, J. Stri\v{s}kovi\'c, M. Strzys, Y. Suda, A. Sunny, H. Tajima, M. Takahashi, J. Takata, R. Takeishi, P. H. T. Tam, S. J. Tanaka, D. Tateishi, T. Tavernier, P. Temnikov, Y. Terada, K. Terauchi, T. Terzic, M. Teshima, M. Tluczykont, F. Tokanai, T. Tomura, D. F. Torres, F. Tramonti, P. Travnicek, G. Tripodo, A. Tutone, M. Vacula, J. van Scherpenberg, M. V\'azquez Acosta, S. Ventura, S. Vercellone, G. Verna, I. Viale, A. Vigliano, C. F. Vigorito, E. Visentin, V. Vitale, V. Voitsekhovskyi, G. Voutsinas, I. Vovk, T. Vuillaume, R. Walter, L. Wan, M. Will, J. W\'ojtowicz, T. Yamamoto, R. Yamazaki, Y. Yao, P. K. H. Yeung, T. Yoshida, T. Yoshikoshi, W. Zhang

53. [Atmospheric pion, kaon, and muon fluxes for sub-orbital experiments](#user-content-link53)
**Authors:** Diksha Garg, Laksha Pradip Das, Mary Hall Reno

54. [Neutrinogenic CMB spectral distortions](#user-content-link54)
**Authors:** Shao-Ping Li, Jens Chluba

55. [Jet MHD analytical model - framework for radiative transfer](#user-content-link55)
**Authors:** E. E. Nokhrina, I. N. Pashchenko, V. A. Frolova, R. V. Todorov

56. [Theoretical Modelling of Early Massive Black Holes](#user-content-link56)
**Authors:** Marta Volonteri

57. [Ten new, ultracompact triply eclipsing triple star systems](#user-content-link57)
**Authors:** T. Borkovits, S. A. Rappaport, T. Mitnyan, R. Gagliano, T. Jacobs, B. Powell, V. Kostov, M. Omohundro, M. H. Kristiansen, I. Terentev, H. M. Schwengeler, D. LaCourse, Z. Garai, T. Pribulla, I. B. B\'ir\'o, I. Cs\'anyi, Z. Dencs, A. P\'al

58. [Combining the second data release of the European Pulsar Timing Array with low-frequency pulsar data](#user-content-link58)
**Authors:** F. Iraci, A. Chalumeau, C. Tiburzi, J. P. W. Verbiest, A. Possenti, S. C. Susarla, M. A. Krishnakumar, G. M. Shaifullah, J. Antoniadis, M. Bagchi, C. Bassa, R. N. Caballero, B. Cecconi, S. Chen, S. Chowdhury, B. Ciardi, I. Cognard, S. Corbel, S. Desai, D. Deb, J. Girard, A. Golden, J-M. Grie{\ss}meier, L. Guillemot, M. Hoeft, H. Hu, F. Jankowski, G. Janssen, B. C. Joshi, S. Kala, E. Keane, K. Nobelson, A. Konovalenko, I. Kravtsov, M. Kramer, K. Liu, A. Parthasarathy, P. Rana, D. Schwarz, J. Singha, A. Srivastava, K. Takahashi, P. Tarafdar, G. Theureau, O. Ulyanov, C. Vocks, J. Wang, V. Zakharenko, P. Zarka

59. [GRMHD modelling of accretion flow around Sagittarius A$^*$ constrained by EHT measurements](#user-content-link59)
**Authors:** Gargi Sen (IITG), Debaprasad Maity (IITG), Santabrata Das (IITG)

60. [Signatures of Galactic Expansion in Gaia DR3: Implications for the JWST Early-Galaxy Puzzle](#user-content-link60)
**Authors:** G. S. Karapetian, A. P. Mahtessian, L. E. Byzalov, M. A. Hovhannisyan, L. A. Mahtessian

61. [Is CPL dark energy a mirage?](#user-content-link61)
**Authors:** Mikel Artola, Ismael Ayuso, Ruth Lazkoz, Vincenzo Salzano

62. [Methanol emission tracing ice chemistry and dust evolution in the TW Hya protoplanetary disk](#user-content-link62)
**Authors:** John D. Ilee, Catherine Walsh, Jenny C. Calahan

63. [Mixed Stochastic-Deterministic Density Functional Theoretic Decomposition of Kubo-Greenwood Conductivities in the Projector Augmented Wave Formalism](#user-content-link63)
**Authors:** Vidushi Sharma, Lee A. Collins, Alexander J. White

64. [Large Language Models Achieve Gold Medal Performance at International Astronomy & Astrophysics Olympiad](#user-content-link64)
**Authors:** Lucas Carrit Delgado Pinheiro, Ziru Chen, Bruno Caixeta Piazza, Ness Shroff, Yingbin Liang, Yuan-Sen Ting, Huan Sun

65. [Converged simulations of the nozzle shock in tidal disruption events](#user-content-link65)
**Authors:** Fangyi Fitz Hu, Ilya Mandel, Rebecca Nealon, Daniel J. Price

66. [Recent observations of PKS 2155-304 with MAGIC and LST-1 in a multi-wavelength context](#user-content-link66)
**Authors:** Lisa Nikoli\'c, Gaia Verna, Marina Manganaro, Giacomo Bonnoli, Ivan Agudo, Giuseppe Silvestri, Davide Cerasole, Francesco Schiavone, Franjo Podobnik, Jorge Otero-Santos

67. [A systematic study on the properties of aromatic and aliphatic hydrocarbon dust in active galactic nuclei with AKARI near-infrared spectroscopy](#user-content-link67)
**Authors:** Risako Katayama, Hidehiro Kaneda, Takuma Kokusho, Tsubasa Kondo, Shinki Oyabu, Toyoaki Suzuki, Takuro Tsuchikawa

68. [Multiwavelength continuum, emission line and BAL variability with prominent PV absorption in the X-ray-weakest quasar PG0043+039](#user-content-link68)
**Authors:** Wolfram Kollatschny, Norbert Schartel, Malte A. Probst, Martin W. Ochmann, Lucia Ballo, Maria Santos-Lleo

69. [The impact of internal versus external perturbations on close-in exoplanet architectures](#user-content-link69)
**Authors:** Christina Schoettler, James E Owen

70. [Latest view of CTA 1 with VERITAS](#user-content-link70)
**Authors:** Alisha Chromey

71. [Line emission search from DM annihilation in the Galactic Center with LST-1](#user-content-link71)
**Authors:** Abhishek Abhishek (on behalf of the CTAO-LST project), Shotaro Abe (on behalf of the CTAO-LST project), Tomohiro Inada (on behalf of the CTAO-LST project), Sofia Ventura (on behalf of the CTAO-LST project), Michele Doro (on behalf of the CTAO-LST project), Masahiro Teshima (on behalf of the CTAO-LST project), Gaia Verna (on behalf of the CTAO-LST project)

72. [Updated Radio Sigma-D Relation and Distances to the Shell-Like Galactic Supernova Remnants -- IV](#user-content-link72)
**Authors:** D. Uro\v{s}evi\'c, B. Vukoti\'c, M. An{\dj}eli\'c, N. Mladenovi\'c

73. [Probing dust torus radius--luminosity relation: An WISE view](#user-content-link73)
**Authors:** Ashutosh Tomar, Suvendu Rakshit, Amit Kumar Mandal, Shivangi Pandey

74. [Crosschecking Cosmic Distances from DESI BAO and DES SNe Points to Systematics](#user-content-link74)
**Authors:** Mauricio Lopez-Hernandez, Eoin \'O Colg\'ain, Saeed Pourojaghi, M. M. Sheikh-Jabbari

75. [Loop quantum inflation with inverse volume corrections in light of ACT data](#user-content-link75)
**Authors:** Farough Parvizi, Soma Heydari, Milad Solbi, Kayoomars Karami

76. [High energy gamma-ray sources in the VVV survey - III. Spectroscopic confirmation of an AGN at low Galactic latitudes](#user-content-link76)
**Authors:** Eduardo O. Schmidt, Laura D. Baravalle, Ana Pichel, Dami\'an Mast, Mar\'ia Victoria Alonso, Jorge D\'iaz Tello, Luciano H. Garc\'ia, Valentin D. Ivanov, Dante Minniti, Nicola Masetti, Laura G. Donoso, Rodrigo Zelada Bacigalupo

77. [Vision-Based CNN Prediction of Sunspot Numbers from SDO/HMI Images](#user-content-link77)
**Authors:** Fabian C. Quintero-Pareja, Diederik A. Montano-Burbano, Santiago Quintero-Pareja, D. Sierra-Porta

78. [Quasi-Periodic Pulsations Driven by Structural Oscillations in a Kink-Unstable Flaring Coronal Loop](#user-content-link78)
**Authors:** James Stewart, Philippa K. Browning, Mykola Gordovskyy

79. [CCAT: Magnetic Sensitivity Measurements of Kinetic Inductance Detectors](#user-content-link79)
...
80. [Study of Lobster and Kirkpatrick-Baez Designs for a Small Mission dedicated to Gravitational Wave Transient Localization](#user-content-link80)
...
81. [Numerical Modeling of Prominences and Coronal Rain with the MPI-AMRVAC Code](#user-content-link81)
**Authors:** Valeriia Liakh, Jack Jenkins

82. [A type II solar radio burst without a coronal mass ejection association](#user-content-link82)
**Authors:** Anshu Kumari, Nat Gopalswamy

83. [Biased parameter inference of eccentric, spin-precessing binary black holes](#user-content-link83)
...
84. [Testing black hole metrics with binary black hole inspirals](#user-content-link84)
**Authors:** Zhe Zhao, Swarnim Shashank, Debtroy Das, Cosimo Bambi

85. [Spectral Mixture Modeling with Laboratory Near-Infrared Data I: Insights into Compositional Analysis of Europa](#user-content-link85)
**Authors:** A. Emran

86. [Ordinal Encoding as a Regularizer in Binary Loss for Solar Flare Prediction](#user-content-link86)
**Authors:** Chetraj Pandey, Jinsu Hong, Anli Ji, Rafal A. Angryk, Berkay Aydin

87. [Surveying the State of Writing Education in Physics and Astronomy](#user-content-link87)
**Authors:** Briley L. Lewis

---

## 1. [Threading the Magellanic Needle: Hypervelocity Stars Trace the Past Location of the LMC](https://arxiv.org/abs/2510.03393) <a id="link1"></a>
...
**Comment:** Directly relevant to near-field cosmology: uses hypervelocity stars to constrain the past orbit of the LMC, a key satellite of the Milky Way. Also touches on historic interactions between the Milky Way and LMC, and the dynamical center of the LMC. Strong match to criteria.
...
## 2. [The LMC Corona as Evidence for a First Passage](https://arxiv.org/abs/2510.03395) <a id="link2"></a>
...
**Comment:** This paper uses simulations to study the LMC's circumgalactic medium (CGM) and its interaction history with the Milky Way, specifically distinguishing between first and second passage scenarios. It directly addresses near-field cosmology, the CGM of a dwarf galaxy (LMC), and historic interactions between the Milky Way and LMC, matching multiple core criteria.
...
## 3. [The Milky Way - Large Magellanic Cloud Interaction with Simulation Based Inference](https://arxiv.org/abs/2510.04735) <a id="link3"></a>
...
**Comment:** This paper uses simulation-based inference to constrain the Milky Way-LMC interaction, focusing on the reflex motion of the MW and the mass of the LMC using halo star velocities. It directly addresses near-field cosmology, historic interactions between the MW and LMC, and uses numerical galaxy simulations, matching multiple core criteria.
...
## 4. [Chroma+ model stellar surface intensities: Spherical formal solution](https://arxiv.org/abs/2510.05035) <a id="link4"></a>
...
**Comment:** Announces an update to the Chroma+ suite for stellar atmosphere and spectrum modeling, now including spherical geometry. This fits the 'Stellar Models' criterion as it presents new theoretical models for stellar atmospheres and emergent intensities.
...
## 5. [Analysis of Galaxies at the Extremes: Failed Galaxy Progenitors in the MAGNETICUM Simulations](https://arxiv.org/abs/2510.04416) <a id="link5"></a>
...
**Comment:** This paper analyzes simulated 'failed galaxy' progenitors in the MAGNETICUM simulations, focusing on ultradiffuse galaxies (UDGs) and their properties such as cored dark matter halos, extended stellar bodies, and quenching mechanisms. It directly matches the near-field cosmology criterion (dwarf/UDG properties, core-cusp, quenching) and also involves numerical galaxy simulations. Highly relevant.
...
## 6. [On the sensitivity of different galaxy properties to warm dark matter](https://arxiv.org/abs/2510.05037) <a id="link6"></a>
...
**Comment:** Uses a large suite of cosmological hydrodynamical simulations (DREAMS project) to study the impact of warm dark matter on galaxy properties. This fits the 'Numerical Galaxy Simulations' criterion, with additional relevance for near-field cosmology due to the focus on subhalo properties and dark matter. The use of machine learning to extract relations is a substantial methodological improvement.
...
## 7. [Cosmological Hydrodynamics at Exascale: A Trillion-Particle Leap in Capability](https://arxiv.org/abs/2510.03557) <a id="link7"></a>
...
**Comment:** This paper presents a new cosmological hydrodynamics code (CRK-HACC) and describes a breakthrough exascale simulation with trillions of particles. While the focus is on large-scale cosmological structure formation, the development of new high-resolution galaxy simulations is directly relevant to the 'Numerical Galaxy Simulations' criterion. However, the emphasis is on survey-scale volumes rather than detailed galaxy physics, so relevance is solid but not maximal.
...
## 9. [H I Properties of Field Galaxies at $\boldsymbol{z\approx 0.2}$-0.6: Insights into Declining Cosmic Star Formation](https://arxiv.org/abs/2510.03400) <a id="link9"></a>
...
**Comment:** Reports H I 21-cm emission measurements from intermediate-redshift field galaxies, including low-mass galaxies, and connects H I content to cosmic star formation history. The paper discusses H I reservoirs and their connection to star formation decline, which is relevant to the circumgalactic medium and star formation quenching, especially in low-mass galaxies. The detection of H I at >75 kpc also touches on CGM topics.
...
## 12. [Abundance of strontium in the Galactic globular cluster 47 Tuc](https://arxiv.org/abs/2510.04722) <a id="link12"></a>
...
**Comment:** Determines strontium abundance in red giant branch stars in a globular cluster, using stellar atmosphere models and spectral synthesis. This fits the 'Stellar Models' criterion, as it discusses the use of 1D and 3D model atmospheres and the impact of convection on line formation.
...
## 13. [On the Frequency of Multiple Galaxy Mergers in $\Lambda$CDM Cosmological Simulations](https://arxiv.org/abs/2510.03525) <a id="link13"></a>
...
**Comment:** This paper uses cosmological hydrodynamical simulations (Illustris and IllustrisTNG) to study the frequency of multiple galaxy mergers. It is relevant to the 'Numerical Galaxy Simulations' criterion, though the focus is on merger statistics rather than new physics or high-resolution simulations. The work is theoretical and analyzes existing simulations.
...
## 15. [The demographics of core-collapse supernovae I. The role of binary evolution and CSM interaction](https://arxiv.org/abs/2510.04872) <a id="link15"></a>
...
**Comment:** This paper uses population synthesis and binary stellar evolution models to study the demographics of core-collapse supernovae, focusing on the role of binary evolution and circumstellar medium interaction. While it involves stellar models and binary evolution, it does not present new stellar evolutionary tracks or atmosphere models, nor does it focus on galaxy-scale phenomena or dwarf galaxies. The relevance is borderline due to the connection to stellar models.
...
## 16. [Inferring the dark matter distribution of massive galaxy clusters from deep optical observations: insights from the TNG300 simulation](https://arxiv.org/abs/2510.03424) <a id="link16"></a>
...
**Comment:** This paper uses the TNG300 simulation to infer dark matter distributions in massive galaxy clusters from optical observations. While it involves numerical galaxy simulations and dark matter profiles, its focus is on massive clusters, not dwarf galaxies or near-field cosmology. The relevance is borderline due to the simulation aspect.
...
## 17. [Matching JWST UV Luminosity Functions with Refined $\Lambda$CDM Halo Models](https://arxiv.org/abs/2510.04709) <a id="link17"></a>
...
**Comment:** This paper discusses the UV luminosity function at high redshift and its connection to dark matter halo models. While the luminosity function is a relevant metric in near-field cosmology, this work focuses on high-redshift (z > 7) galaxies, not on dwarf satellites or local group galaxies. The methodology (refined halo mass functions) is of interest for galaxy simulations, but the application is not directly to the local universe or resolved star formation histories. Borderline relevance due to connection to luminosity functions and galaxy simulations, but not a core match.
...
## 18. [Interactive High-Performance Visualization for Astronomy and Cosmology](https://arxiv.org/abs/2510.04665) <a id="link18"></a>
...
**Comment:** Describes a visualization framework for astronomy and cosmology, validated on large-scale simulations (GADGET code). While it involves galaxy simulations, the focus is on visualization tools rather than presenting new simulation results or physics models.
...
## 19. [ALMA-IMF. XXI.: N$_2$H$^+$ kinematics in the G012.80 protocluster: Evidence for filament rotation and evolution](https://arxiv.org/abs/2510.03447) <a id="link19"></a>
...
**Comment:** This paper studies the kinematics and evolution of filaments in a protocluster using molecular line observations and discusses star formation rates and filament evolution. While it provides insight into star formation processes and filament evolution, it does not focus on resolved star formation histories from color-magnitude diagrams, dwarf galaxies, or galaxy-scale outflows. The relevance is borderline, as the study of star formation in filaments may have tangential implications for star formation quenching and stellar models, but is not directly aligned with the core criteria.
...
## 20. [Formation and growth of intermediate-mass black holes in dense star clusters: Lessons from N-body and MOCCA Monte Carlo Simulations](https://arxiv.org/abs/2510.03766) <a id="link20"></a>
...
**Comment:** This paper studies the formation and growth of intermediate-mass black holes in dense star clusters, including stripped dwarf-galaxy nuclei. While it mentions dwarf-galaxy nuclei, the focus is on black hole formation and cluster dynamics, not on near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 21. [DRAGON-III simulation: modelling million-body globular and nuclear star clusters](https://arxiv.org/abs/2510.03933) <a id="link21"></a>
...
**Comment:** Million-body simulations of globular and nuclear star clusters. While this is a numerical simulation of star clusters, it does not focus on galaxies or dwarf galaxies, nor does it address the specified criteria directly.
...
## 22. [A Link Between Rocky Planet Density and Host Star Chemistry](https://arxiv.org/abs/2510.04981) <a id="link22"></a>
...
**Comment:** Investigates the link between rocky planet density and host star chemistry, with implications for planet formation and Galactic chemical evolution. While it touches on Galactic chemical evolution, it does not address near-field cosmology, dwarf galaxies, or galaxy simulations.
...
## 23. [A GLIMPSE into the very faint-end of the H$\beta$+[OIII]$\lambda\lambda$4960,5008 luminosity function at z=7-9 behind Abell S1063](https://arxiv.org/abs/2510.04771) <a id="link23"></a>

**ArXiv ID:** 2510.04771

**Authors:** Damien Korber, Iryna Chemerynska, Lukas J. Furtak, Hakim Atek, Ryan Endsley, Daniel Schaerer, John Chisholm, Alberto Saldana-Lopez, Angela Adamo, Julian B. Mu\~noz, Pascal A. Oesch, Romain Meyer, Rui Marques-Chaves, Seiji Fujimoto

**Abstract:** We use the ultra-deep GLIMPSE JWST/NIRCam survey to constrain the faint-end of the H$\beta$+[OIII]$\lambda\lambda$4960,5008 luminosity function (LF) down to $10^{39}$ erg/s at z=7-9 behind the lensed Hubble Frontier Field Abell S1063. We perform SED fitting on a Lyman-Break Galaxy sample, measuring combined H$\beta$+[OIII] fluxes to construct the emission-line LF. The resulting LF ($\alpha$=-1.55 to -1.78) is flatter than the UV LF ($\alpha10^{39}$ erg/s (SFR(H$\alpha$)$>5\times10^{-3} M_\odot$/yr) contribute 21-61% and 24-104% of the ionising photon budget at 7<8 and 8<9, respectively (for $f_{esc}=0.1$). The LF shape suggests faint galaxies contribute minimally to the ionising photon production rate. Our cosmic star formation rate density (CSFRD) estimates align with previous work, but GLIMPSE's sensitivity to low SFRs confirms that very faint galaxies are minor contributors to both the ionising photon production rate and the CSFRD. Our results suggest that GLIMPSE has detected the bulk of the total H$\beta$+[OIII] emission from star-forming galaxies, with fainter sources playing a limited role in cosmic reionisation.

**Comment:** This paper uses JWST/NIRCam data to constrain the faint-end of the Hβ+[OIII] luminosity function at z=7-9, focusing on the contribution of faint galaxies to the ionizing photon budget and cosmic star formation rate density. While it discusses star formation rates and luminosity functions, the focus is on high-redshift galaxies and cosmic reionization, not on resolved star formation histories or satellite luminosity functions in the local universe.
...
## 25. [Doubly Discordant SH0ES NGC4258 Cepheid Relations (HVI), and Impactful Extinction Laws](https://arxiv.org/abs/2510.04998) <a id="link25"></a>

**ArXiv ID:** 2510.04998

**Authors:** Daniel Majaess

**Abstract:** S$H_0$ES 2016-2022 $HVI$ data for classical Cepheids in the keystone galaxy NGC4258 yield doubly discordant Wesenheit Leavitt functions:~$\Delta W_{0,H-VI} = -0.13\pm0^{m}.02$ ($-0^{m}.17$ unweighted) and that is paired with a previously noted $\Delta W_{0,I-VI}\simeq-0^{m}.3$, which in concert with complimentary evidence suggest the 2016 S$H_0$ES NGC4258-anchored $H_0 \pm \sigma_{H_0}$ warrants scrutiny (i.e., $\sigma_{H_0}/{H_0}\gtrsim 6$\%). Cepheid distance uncertainties are further exacerbated by extinction law ambiguities endemic to such Leavitt relations (e.g., NGC4258), particularly for comparatively obscured variables (e.g., $\Delta d \gtrsim 4$\%, reddened Cepheid subsamples in the Milky Way, M31, NGC2442, NGC4424, NGC5643, NGC7250). Lastly, during the analysis it was identified that the 2022 S$H_0$ES database relays incorrect SMC Cepheid photometry.

**Comment:** Discusses Cepheid distance uncertainties and extinction laws in NGC4258 and other galaxies, with implications for the Hubble constant. While Cepheid variables are important for distance measurements, the focus is on calibration and extinction, not on resolved star formation histories or dwarf galaxies.
...
## 26. [Suzaku observations of outskirts of nearby clusters and groups: I. electron density and gas fraction to the virial radius](https://arxiv.org/abs/2510.04523) <a id="link26"></a>
...
**Comment:** This paper analyzes Suzaku observations of galaxy clusters and groups, focusing on electron density and gas fraction profiles out to the virial radius. While it discusses baryon-dark matter connections and feedback, the focus is on massive clusters and groups, not on dwarf galaxies or near-field cosmology.
...
## 28. [Faint supernovae and hyper-runaway white-dwarfs from single He-detonation in double HeCO-white-dwarf mergers](https://arxiv.org/abs/2510.03396) <a id="link28"></a>
...
**Comment:** Simulates mergers of low-mass hybrid HeCO white dwarfs, exploring faint thermonuclear transients and high-velocity stars. This is a study of stellar evolution and transients, not directly related to the core topics (no focus on galaxies, star formation histories, or stellar models as defined).
...
## 29. [Galaxy Model Subtraction with a Convolutional Denoising Autoencoder](https://arxiv.org/abs/2510.04957) <a id="link29"></a>
...
**Comment:** This paper presents a convolutional denoising autoencoder for galaxy model subtraction, enabling improved detection of faint sources in galaxy images. While it is a methodological advance for photometric analysis, it does not directly address any of the core topics such as resolved star formation histories, near-field cosmology, or galaxy simulations.
...
## 30. [Revisiting Gaussian Process Reconstruction for Cosmological Inference: The Generalised GP (Gen GP) Framework](https://arxiv.org/abs/2510.03742) <a id="link30"></a>
...
**Comment:** This paper presents a new Gaussian Process framework for cosmological inference, specifically for estimating the Hubble constant. While it is a methodological advance in cosmology, it does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 31. [Luminous Fast Blue Optical Transients as very massive star core-collapse events](https://arxiv.org/abs/2510.03402) <a id="link31"></a>
...
**Comment:** Discusses Luminous Fast Blue Optical Transients and their possible origin in very massive star core-collapse events, with implications for r-process enrichment. However, the focus is on transient events and massive stars, not on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 32. [Covariant cosmography in the presence of local structures: comparing exact solutions and perturbation theory](https://arxiv.org/abs/2510.03517) <a id="link32"></a>
...
**Comment:** This paper discusses cosmography and local cosmic expansion anisotropies, focusing on the Lemaître-Tolman-Bondi framework and large-scale gravitational field anisotropies. While it deals with local universe structure, it does not specifically address near-field cosmology topics such as dwarf satellites, resolved star formation histories, or galaxy simulations. No direct match to the core criteria.
...
## 34. [From theory to observation: understanding filamentary flows in high-mass star-forming clusters](https://arxiv.org/abs/2510.05101) <a id="link34"></a>
...
**Comment:** This paper uses multi-scale galactic MHD simulations to study filamentary flows and star forming clumps, focusing on flow rates and the impact of feedback. While it involves simulations and star formation, the focus is on high-mass star-forming clusters and filamentary flows, not on dwarf galaxies, resolved star formation histories, or outflows in the context of galaxy evolution. It does not directly address any of the core topics.
...
## 35. [Exploring Low-Amplitude Variability in First Overtone Cepheids with TESS](https://arxiv.org/abs/2510.05017) <a id="link35"></a>
...
**Comment:** This paper systematically searches for low-amplitude variability in first overtone Cepheids using TESS data, identifying additional periodicities and possible non-radial modes. While it involves stellar variability and pulsation, it does not present new stellar models or evolutionary tracks, nor does it address the core topics.
...
## 36. [Observation of undepleted phosphine in the atmosphere of a low-temperature brown dwarf](https://arxiv.org/abs/2510.03916) <a id="link36"></a>
...
**Comment:** Reports JWST observations of phosphine in a brown dwarf atmosphere, relevant to substellar atmospheric chemistry but not to any of the core topics (no connection to galaxy simulations, near-field cosmology, or stellar models as defined).
...
## 37. [Fisher-Bingham-like normalizing flows on the sphere](https://arxiv.org/abs/2510.04762) <a id="link37"></a>
...
**Comment:** Presents a new family of normalizing flows for distributions on the sphere, with some mention of astronomical applications. However, the work is methodological and not directly related to any of the core topics (e.g., galaxy simulations, stellar models, resolved star formation histories).
...
## 38. [Cosmic topology. Part IIb. Eigenmodes, correlation matrices, and detectability of non-orientable Euclidean manifolds](https://arxiv.org/abs/2510.05030) <a id="link38"></a>
...
**Comment:** Studies cosmic topology and its detectability via CMB correlations, focusing on non-orientable Euclidean manifolds. While cosmological, it does not address near-field cosmology, galaxy simulations, or other core topics.
...
## 39. [A quantum information method for early universe with non-trivial sound speed](https://arxiv.org/abs/2510.04011) <a id="link39"></a>
...
**Comment:** Applies quantum information methods to the early universe with non-trivial sound speed, focusing on inflation and quantum complexity. This is cosmology, not near-field cosmology or any of the core topics.
...
## 40. [Introducing The SHell misAlignment Detection for straylight Estimation (SHADE) algorithm: the case of XMM-Newton](https://arxiv.org/abs/2510.04659) <a id="link40"></a>
...
**Comment:** This paper presents a new algorithm for diagnosing mirror misalignments in X-ray telescopes, specifically for XMM-Newton. It is focused on instrumentation and calibration, not on any of the core topics such as near-field cosmology, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 41. [Gravitomagnetic-Hydrodynamics and Turbulence in Early Universe](https://arxiv.org/abs/2510.03711) <a id="link41"></a>
...
**Comment:** This paper establishes a theoretical framework for gravitomagnetic-hydrodynamics and turbulence in the early universe, with implications for gravitational wave backgrounds. It is focused on early universe physics and does not address any of the core topics.
...
## 42. [Finding Supermassive Black Hole Binary Mergers in Pulsar Timing Array Data](https://arxiv.org/abs/2510.04537) <a id="link42"></a>
...
**Comment:** This paper focuses on supermassive black hole binary mergers and their detection via pulsar timing arrays. The topic is not related to near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. It is focused on SMBH mergers, which are explicitly listed as irrelevant.
...
## 46. [Joint eROSITA and H.E.S.S. analysis of MSH 15-52 using Gammapy](https://arxiv.org/abs/2510.04857) <a id="link46"></a>
...
**Comment:** Joint X-ray and gamma-ray study of a pulsar wind nebula, focusing on multiwavelength analysis and particle acceleration. Does not match any of the specified criteria.
...
## 47. [Harnessing the XMM-Newton data: X-ray spectral modelling of 4XMM-DR11 detections and 4XMM-DR11s sources](https://arxiv.org/abs/2510.03409) <a id="link47"></a>
...
**Comment:** X-ray spectral modeling of sources in the XMM-Newton catalogue, with a focus on AGN, stars, X-ray binaries, and cataclysmic variables. Does not match any of the specified criteria.
...
## 48. [Constraining the $^{30}$P($p,\gamma)^{31}$S reaction rate in ONe novae via the weak, low-energy, $\beta$-delayed proton decay of $^{31}$Cl](https://arxiv.org/abs/2204.05444) <a id="link48"></a>

**ArXiv ID:** 2204.05444

**Authors:** T. Budner (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), M. Friedman (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Racah Institute of Physics, Hebrew University, Jerusalem, Israel), C. Wrede (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), B. A. Brown (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), J. Jos\'e (Departament de F\'isica, Universitat Polit\`ecnica de Catalunya, Barcelona, Spain, Institut d'Estudis Espacials de Catalunya, Universitat Polit\`ecnica de Catalunya, Barcelona, Spain), D. P\'erez-Loureiro (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA), L. J. Sun (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, School of Physics and Astronomy, Shanghai Jiao Tong University, Shanghai, China), J. Surbrook (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), Y. Ayyad (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Instituto Galego de F\'isica de Atlas Enerx\'ias, Universidade de Santiago de Compostela, Santiago de Compostela, Spain), D. W. Bardayan (Department of Physics, University of Notre Dame, Notre Dame, USA), K. Chae (Department of Physics, Sungkyunkwan University, Seoul, South Korea), A. A. Chen (Department of Physics and Astronomy, McMaster University, Hamilton, Canada), K. A. Chipps (Physics Division, Oak Ridge National Laboratory, Oak Ridge, USA, Department of Physics and Astronomy, University of Tennessee, Knoxville, USA), M. Cortesi (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA), B. Glassman (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), M. R. Hall (Department of Physics, University of Notre Dame, Notre Dame, USA), M. Janasik (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), J. Liang (Department of Physics and Astronomy, McMaster University, Hamilton, Canada), P. O'Malley (Department of Physics, University of Notre Dame, Notre Dame, USA), E. Pollacco (D\'epartement de Physique Nucl\'eaire, Institut de Recherche sur les lois Fondamentales de l'Univers, Commissariat \`a l\'energie atomique et aux \'energies alternatives, Universit\'e Paris-Saclay, Gif-sur-Yvette, France), A. Psaltis (Department of Physics and Astronomy, McMaster University, Hamilton, Canada), J. Stomps (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA), T. Wheeler (National Superconducting Cyclotron Laboratory, Michigan State University, East Lansing, USA, Department of Physics and Astronomy, Michigan State University, East Lansing, USA)

**Abstract:** The $^{30}$P$(p,\gamma)^{31}$S reaction plays an important role in understanding nucleosynthesis of $A\geq 30$ nuclides in oxygen-neon novae. The Gaseous Detector with Germanium Tagging was used to measure $^{31}$Cl $\beta$-delayed proton decay through the key $J^{\pi}=3/2^{+}$, 260-keV resonance. The intensity $I^{260}_{\beta p} = 8.3^{+1.2}_{-0.9} \times 10^{-6}$ represents the weakest $\beta$-delayed, charged-particle emission ever measured below 400 keV, resulting in a proton branching ratio of $\Gamma_p / \Gamma = 2.5^{+0.4}_{-0.3} \times 10^{-4}$. By combining this measurement with shell-model calculations for $\Gamma_{\gamma}$ and past work on other resonances, the total $^{30}$P$(p,\gamma)^{31}$S rate has been determined with reduced uncertainty. The new rate has been used in hydrodynamic simulations to model the composition of nova ejecta, leading to a concrete prediction of $^{30}$Si/$^{28}$Si excesses in presolar nova grains and the calibration of nuclear thermometers.

**Comment:** Presents nuclear astrophysics measurements relevant to novae nucleosynthesis, but does not address galaxy-scale topics, resolved star formation histories, or stellar models as defined in the prompt.
...
## 49. [Spectral Properties of Anomalous Microwave Emission in 144 Galactic Clouds](https://arxiv.org/abs/2510.05067) <a id="link49"></a>
...
**Comment:** Analyzes anomalous microwave emission in Galactic clouds, focusing on dust grain physics and ISM properties, not on galaxy-scale processes, dwarf galaxies, or any of the core topics.
...
## 50. [Edge-On Disk Study (EODS) II: HCO$^+$ and CO vertical stratification in the disk surrounding SSTTau042021](https://arxiv.org/abs/2510.04677) <a id="link50"></a>
...
**Comment:** Focuses on the vertical structure and molecular stratification in a protoplanetary disk around a T Tauri star. This is a study of planet formation and disk physics, not galaxies or stellar models relevant to the prompt.
...
## 52. [VHE $\gamma$-ray observations of bright BL Lacs with the Large-Sized Telescope prototype (LST-1) of the CTAO](https://arxiv.org/abs/2510.03702) <a id="link52"></a>
...
**Comment:** Reports on VHE gamma-ray observations of bright BL Lac objects with the CTAO LST-1. Focus is on AGN/blazar variability and gamma-ray spectra, not on galaxies, star formation, or stellar models.
...
## 53. [Atmospheric pion, kaon, and muon fluxes for sub-orbital experiments](https://arxiv.org/abs/2510.03428) <a id="link53"></a>
...
**Comment:** The paper models atmospheric pion, kaon, and muon fluxes for sub-orbital experiments, relevant for cosmic ray and neutrino detection backgrounds. It does not address any of the core topics such as galaxy evolution, star formation, or near-field cosmology.
...
## 54. [Neutrinogenic CMB spectral distortions](https://arxiv.org/abs/2510.04684) <a id="link54"></a>
...
**Comment:** The paper discusses CMB spectral distortions from extra radiation injection after neutrino decoupling, with implications for hidden sectors and neutrino physics. It is focused on early universe cosmology and does not address any of the core topics.
...
## 57. [Ten new, ultracompact triply eclipsing triple star systems](https://arxiv.org/abs/2510.04565) <a id="link57"></a>
...
**Comment:** Comprehensive study of ten new ultracompact triply eclipsing triple star systems, focusing on their dynamical and astrophysical parameters. This is not related to any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 58. [Combining the second data release of the European Pulsar Timing Array with low-frequency pulsar data](https://arxiv.org/abs/2510.04639) <a id="link58"></a>
...
**Comment:** Combines low-frequency radio data with pulsar timing array datasets to improve sensitivity to propagation effects and gravitational wave background detection. This is not related to any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 63. [Mixed Stochastic-Deterministic Density Functional Theoretic Decomposition of Kubo-Greenwood Conductivities in the Projector Augmented Wave Formalism](https://arxiv.org/abs/2510.03388) <a id="link63"></a>
...
**Comment:** Presents a mixed stochastic-deterministic DFT approach for conductivity in warm dense matter, focusing on atomic/molecular systems rather than galaxies or stellar models.
...
## 64. [Large Language Models Achieve Gold Medal Performance at International Astronomy & Astrophysics Olympiad](https://arxiv.org/abs/2510.05016) <a id="link64"></a>
...
**Comment:** Benchmarks large language models on astronomy olympiad exams. This is not related to any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 66. [Recent observations of PKS 2155-304 with MAGIC and LST-1 in a multi-wavelength context](https://arxiv.org/abs/2510.04803) <a id="link66"></a>

**ArXiv ID:** 2510.04803

**Authors:** Lisa Nikoli\'c, Gaia Verna, Marina Manganaro, Giacomo Bonnoli, Ivan Agudo, Giuseppe Silvestri, Davide Cerasole, Francesco Schiavone, Franjo Podobnik, Jorge Otero-Santos

**Abstract:** PKS 2155-304 is a well-known high-frequency peaked BL Lac (HBL) at redshift z=0.116, which has been extensively studied across the electromagnetic spectrum due to its rapid and large-amplitude variability. Several violent outbursts in X-rays and $\gamma$-rays have been observed in the past, with intra-night variability in very-high-energy $\gamma$-rays (VHE; E > 100 GeV) detected down to the minute timescale. The alternation of quiescent and enhanced states, observed with a tentative quasi-periodicity of 1.74 $\pm$ 0.13 years in high-energy (HE; 100 MeV < E  55{\deg}), and the VHE data have been complemented with simultaneous observations in HE $\gamma$-rays (Fermi-LAT), X-rays (Swift-XRT) and optical wavelengths (ASAS-SN).

**Comment:** This is a multi-wavelength observational study of a BL Lac object, focusing on variability and high-energy emission. It does not match any of the specified criteria.
...
## 73. [Probing dust torus radius--luminosity relation: An WISE view](https://arxiv.org/abs/2510.04517) <a id="link73"></a>
...
**Comment:** This paper measures the dusty torus sizes in AGNs and examines the radius-luminosity relation using WISE and optical data. The focus is on AGN structure and not on galaxies, star formation, or any of the core criteria.
...
## 74. [Crosschecking Cosmic Distances from DESI BAO and DES SNe Points to Systematics](https://arxiv.org/abs/2510.04179) <a id="link74"></a>
...
**Comment:** This paper crosschecks cosmic distances from BAO and supernovae data, focusing on systematics in cosmological measurements. It does not address galaxy formation, dwarf galaxies, star formation histories, or simulations of galaxies.
...
## 75. [Loop quantum inflation with inverse volume corrections in light of ACT data](https://arxiv.org/abs/2510.03882) <a id="link75"></a>

**ArXiv ID:** 2510.03882

**Authors:** Farough Parvizi, Soma Heydari, Milad Solbi, Kayoomars Karami

**Abstract:** Within the framework of loop quantum cosmology (LQC), we investigate the effect of inverse volume corrections on the low scale spontaneously broken supersymmetric (SB SUSY) and exponential inflationary potentials. The LQC modifications to the Friedmann equations and cosmological perturbation parameters are employed to assess the observational viability of these models against recent data from the Atacama Cosmology Telescope (ACT). Our results indicate that in contrary to the standard model of inflation, in the presence of inverse volume corrections in LQC, the prediction of SB SUSY and exponential potentials in the $r-n_{\rm s}$ plane lie inside the 68\% confidence level interval of the ACT data.

**Comment:** This paper focuses on loop quantum cosmology and inflationary potentials, comparing theoretical predictions to ACT data. It does not address any of the core topics such as near-field cosmology, resolved star formation histories, dwarf galaxies, or galaxy simulations. The focus is on early universe cosmology and inflation, which is outside the scope of the relevant criteria.
...
## 76. [High energy gamma-ray sources in the VVV survey - III. Spectroscopic confirmation of an AGN at low Galactic latitudes](https://arxiv.org/abs/2510.04429) <a id="link76"></a>
...
**Comment:** This paper confirms the nature of an AGN at low Galactic latitude using near-infrared spectroscopy. The focus is on AGN identification and the census of extragalactic sources behind the Milky Way, which does not match any of the core criteria such as dwarf galaxies, star formation histories, or galaxy simulations. The work is outside the scope of the relevant topics.
...
## 79. [CCAT: Magnetic Sensitivity Measurements of Kinetic Inductance Detectors](https://arxiv.org/abs/2510.03653) <a id="link79"></a>
...
**Comment:** This paper discusses magnetic sensitivity measurements of kinetic inductance detectors for the CCAT Observatory. It is focused on instrumentation and detector technology, not on any of the core topics.
...
## 80. [Study of Lobster and Kirkpatrick-Baez Designs for a Small Mission dedicated to Gravitational Wave Transient Localization](https://arxiv.org/abs/2510.05002) <a id="link80"></a>
...
**Comment:** Study of X-ray telescope designs for gravitational wave transient localization. Not relevant to the specified criteria.
...
## 81. [Numerical Modeling of Prominences and Coronal Rain with the MPI-AMRVAC Code](https://arxiv.org/abs/2510.04222) <a id="link81"></a>
...
**Comment:** Focuses on numerical modeling of solar prominences and coronal rain, which is not related to any of the core topics (no connection to galaxy simulations, near-field cosmology, or stellar models relevant to the prompt).
...
## 83. [Biased parameter inference of eccentric, spin-precessing binary black holes](https://arxiv.org/abs/2510.04332) <a id="link83"></a>
...
**Comment:** Focuses on gravitational wave parameter inference for binary black holes, including eccentricity and spin-precession. This is not related to any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 84. [Testing black hole metrics with binary black hole inspirals](https://arxiv.org/abs/2510.04703) <a id="link84"></a>
...
**Comment:** This paper tests black hole metrics using gravitational wave data from binary black hole inspirals. The focus is on strong-field gravity and black hole properties, not on galaxies, star formation, or any of the core criteria.
...
## 85. [Spectral Mixture Modeling with Laboratory Near-Infrared Data I: Insights into Compositional Analysis of Europa](https://arxiv.org/abs/2510.03436) <a id="link85"></a>
...
**Comment:** This paper presents spectral mixture modeling for compositional analysis of Europa, a moon of Jupiter. It is focused on planetary science and does not address any of the core topics related to galaxies, star formation, or cosmology.
...
## 86. [Ordinal Encoding as a Regularizer in Binary Loss for Solar Flare Prediction](https://arxiv.org/abs/2510.04063) <a id="link86"></a>
...
**Comment:** This paper presents a machine learning method for solar flare prediction, which is not related to any of the core topics (galaxy evolution, near-field cosmology, star formation histories, etc.).
...
## 87. [Surveying the State of Writing Education in Physics and Astronomy](https://arxiv.org/abs/2510.03493) <a id="link87"></a>
...
**Comment:** Surveys writing education in physics and astronomy, which is not related to any of the core scientific topics listed.
