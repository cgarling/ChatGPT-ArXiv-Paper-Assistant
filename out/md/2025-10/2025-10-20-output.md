...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 32867    | 4935         | 37802   |
| **Cost**             | $0.07    | $0.04        | $0.11   |

Total arXiv papers: 106
...
1. [Velocity dispersion profiles of dwarf spheroidal galaxies with self-interacting ultralight dark matter](#user-content-link1)
**Authors:** K. Korshynska, E. V. Gorbar, Y. M. Bidasyuk, A. I. Yakimenko, Y. Revaz

2. [An Investigation into the Low-Mass Fundamental Metallicity Relation in the Local and High-z Universe](#user-content-link2)
**Authors:** Isaac H. Laseter, Michael V. Maseda, Andrew J. Bunker, Alex J. Cameron, Mirko Curti, Charlotte Simmonds

3. [Multi-species Dark Matter with Warmth and Randomness](#user-content-link3)
**Authors:** Mustafa A. Amin, M. Sten Delos, Kiaxin Yang

4. [Rare Find: Discovery and chemo-dynamical properties of two s-process enhanced RR Lyrae stars](#user-content-link4)
**Authors:** Valentina D'Orazi, Giuliano Iorio, Borb\'ala Cseh, Chris Sneden, Hedieh Abdollahi, L\'aszl\'o Moln\'ar, Alexey Bobrick, Giuseppe Bono, Vittorio F. Braga, Amanda Karakas, Maria Lugaro, Simon W. Campbell, Michele Fabrizio, Giuliana Fiorentino, Ian U. Roederer, Nicholas Storm, Maria Tantalo, Juliana Crestani

5. [The kinetic Sunyaev Zeldovich effect as a benchmark for AGN feedback models in hydrodynamical simulations: insights from DESI + ACT](#user-content-link5)
...
6. [Very Massive Stars and High N/O: A Tale of the Nitrogen-enriched Super Star Cluster in the Sunburst Arc](#user-content-link6)
**Authors:** Yanlong Shi, Liang Dai, Norman Murray, Claire S. Ye, Christopher D. Matzner, Massimo Pascale

7. [A merger within a merger: Chandra pinpoints the short GRB 230906A in a peculiar environment](#user-content-link7)
**Authors:** S. Dichiara, E. Troja, B. O'Connor, Y. -H. Yang, P. Beniamini, A. Galvan-Gamez, T. Sakamoto, Y. Kawakubo, J. C. Charlton

8. [What is the True HI Gas Content in Massive Quiescent Galaxies in the Local Universe?](#user-content-link8)
**Authors:** Xiao Li, Cheng Li, Cheng Cheng, Houjun Mo, Jing Wang, Am\'elie Saintonge

9. [Evolution of the kinematic properties of rotating multiple-population globular clusters](#user-content-link9)
**Authors:** Ethan B. White, Enrico Vesperini, Emanuele Dalessandro, Anna Lisa Varri

10. [Simulating the LOcal Web (SLOW) - VI: $\gamma$-ray Emission in the Local Universe](#user-content-link10)
**Authors:** Ludwig M. B\"oss, Ildar Khabibullin, Daniel Karner, Klaus Dolag, Ulrich P. Steinwandel, Elena Hernandez-Martinez, Jenny G. Sorce

11. [Impact of Neutrino Flavor Conversions on Neutron Star Merger Dynamics, Ejecta, Nucleosynthesis, and Multi-Messenger Signals](#user-content-link11)
**Authors:** Yi Qiu, David Radice, Sherwood Richers, Federico Maria Guercilena, Albino Perego, Maitraya Bhattacharyya

12. [Bridging observations and simulations: a machine learning approach to galaxy clusters](#user-content-link12)
**Authors:** Efrain Gatuzz

13. [Black Holes in Globular Clusters: A Structural and Kinematic Perspective](#user-content-link13)
**Authors:** Alessandro Della Croce

14. [Anisotropic Dark Matter Bosonic Stars in regularized 4D Einstein$-$Gauss$-$Bonnet gravity](#user-content-link14)
**Authors:** Mohamamd Mazhari

15. [Neural Posterior Estimation for Cataloging Astronomical Images from the Legacy Survey of Space and Time](#user-content-link15)
**Authors:** Yicun Duan, Xinyue Li, Camille Avestruz, Jeffrey Regier

16. [HyperAIRI: a plug-and-play algorithm for precise hyperspectral image reconstruction in radio interferometry](#user-content-link16)
**Authors:** Chao Tang, Arwa Dabbech, Adrian Jackson, Yves Wiaux

17. [A rising tide: Intrinsic alignments since the turn of the millennium](#user-content-link17)
**Authors:** Nora Elisa Chisari

18. [Molecular line emission from 1000 au scales outflows to <30 au compact structures in NGC1333 IRAS4A2](#user-content-link18)
**Authors:** Osmar M. Guerra-Alvarado, N. van der Marel, P. Nazari, J. Di Francesco, {\L}. Tychoniec, L. W. Looney, E. G. Cox, D. J. Wilner, M. R. Hogerheijde

19. [Sensitivity of Nuclear Reaction Rates in X-ray Burst Models](#user-content-link19)
**Authors:** I. Sultana, A. Estrade, B. S. Meyer, H. Schatz

20. [Born to be recycled: a comprehensive population synthesis of the Galactic millisecond pulsars](#user-content-link20)
**Authors:** Matt\'eo Sautron, J\'er\^ome P\'etri, Dipanjan Mitra, Ad\'elie Dupuy--Junet, Marie-Elo\"ise Pietrin

21. [Wave-Mediated Boundary Layers of Accretion Discs: Role of Internal Structure of the Accretor](#user-content-link21)
**Authors:** Samuel G. D. Turner, Roman R. Rafikov, Alexander A. Philippov

22. [Evidence for cloud-to-cloud variations in the ratio of polarized thermal dust emission to starlight polarization](#user-content-link22)
**Authors:** Nidhi Mehandiratta, Georgia V. Panopoulou, Eirik Gjerl{\o}w, Vincent Pelgrims, Konstantinos Tassis, Dmitry Blinov, Brandon Hensley, John A. Kypriotakis, Siddharth Maharana, Nikos Mandarakas, Vasiliki Pavlidou, Stephen B. Potter, A. N. Ramaprakash, Raphael Skalidis, Namita Uppal

23. [Spectroscopic Follow-up of Young High-$\alpha$ Dwarf Star Candidates: Still Likely Genuinely Young](#user-content-link23)
...
24. [BREAKFAST: A Framework for general joint BA duty and follow-up guidance of multiple $\gamma$-ray monitors](#user-content-link24)
...
25. [A family of binaries with an extreme mass ratio](#user-content-link25)
...
26. [Relativistic tidal divergences in circular orbits and the dynamics of light rings](#user-content-link26)
**Authors:** Victor F. C. Vieira, Rafael P. Bernar, Caio F. B. Macedo

27. [Extending TESS Flare Frequency Distributions with CHEOPS: power-law or lognormal?](#user-content-link27)
**Authors:** Julien Poyatos, Octavi Fors, Jos\'e Maria G\'omez Cama

28. [From Localization to Discovery: Bayesian Ranking of Electromagnetic Counterparts to Gravitational-Wave Events](#user-content-link28)
**Authors:** Kendall Ackley

29. [Taming the plunge: A circularization trap of supermassive black hole binaries](#user-content-link29)
...
30. [Precise frequencies of H$_2^{~16}$O lines protected for radio astronomy](#user-content-link30)
**Authors:** Arth\'emise Altman, Roland T\'obi\'as, Alexandr S. Bogomolov, Meissa L. Diouf, Frank M. J. Cozijn, Attila G. Cs\'asz\'ar, Cl\'ement Lauzin, Wim Ubachs

31. [Gradus.jl: spacetime-agnostic general relativistic ray-tracing for X-ray spectral modelling](#user-content-link31)
**Authors:** Fergus J. E. Baker, Andrew J. Young

32. [Event types in H.E.S.S.: a combined analysis for different telescope types and energy ranges](#user-content-link32)
**Authors:** Rodrigo Guedes Lang, Tim Unbehaun, Lars Mohrmann, Simon Steinmassl, Jim Hinton, Stefan Funk

33. [Magnetohydrodynamic-guiding-center-particle-in-cell Method for Multiscale Plasma Kinetic Simulations](#user-content-link33)
**Authors:** Zitao Hu, Xue-Ning Bai, Xiaochen Sun

34. [Impact of neutrino decays on the Cosmic Neutrino Background anisotropies](#user-content-link34)
**Authors:** Nicola Terzaghi, Guillermo Franco Abell\'an, Fabian Zimmer, Shin'ichiro Ando

35. [Atomic Quantum Sensors for High-Frequency Gravitational Wave Searches](#user-content-link35)
**Authors:** Yi-fu Cai, Luca Visinelli, Sheng-Feng Yan

36. [An Improved Atlas of Full-Scan Spectra from ISO/SWS](#user-content-link36)
**Authors:** D. R. Mizuno (Boston College), T. A. Kuchar (Boston College), Kathleen E. Kraemer (Boston College), G. C. Sloan (Space Telescope Science Institute), Samantha Greene (Boston College), Elianna Cohen (Boston College), Holly Branco (Boston College)

37. [J-GEM near-infrared follow-up observations of the gravitational wave event S240422ed](#user-content-link37)
...
38. [Exploring Ultra-Slow-Roll Inflation in Composite Pseudo-Nambu-Goldstone Boson Models: Implications for Primordial Black Holes and Gravitational Waves](#user-content-link38)
**Authors:** Marco Merchand

39. [Transverse BAO scale measurement at $z_{\rm eff} = 1.725$ with the SDSS quasars catalog](#user-content-link39)
**Authors:** Felipe Avila, Armando Bernui, Miguel A. Sabogal, Rafael C. Nunes

40. [Magnetic fields in planetary nebulae detected through non-thermal radio continuum emission](#user-content-link40)
**Authors:** Marcin Hajduk, Timothy Shimwell, Glenn White, Marijke Haverkorn, Jes\'us A. Toal\'a, Ralf-J\"urgen Dettmar

41. [Hints for dynamical dark energy from warm inflation](#user-content-link41)
**Authors:** Anupama B

42. [Constraints on neutrino mass and dark energy agnostic to the sound horizon](#user-content-link42)
**Authors:** Ravi Kumar Sharma, Julien Lesgourgues

43. [Glycolaldehyde and ethanol toward the L1157 outflow: resolved images and constraints on glycolaldehyde formation](#user-content-link43)
**Authors:** Juliette Robuschi, Ana L\'opez-Sepulcre, Cecilia Ceccarelli, Layal Chahine, Claudio Codella, Linda Podio

44. [Effects of Radiative Corrections on Starobinsky Inflation](#user-content-link44)
**Authors:** John Ellis, Tony Gherghetta, Kunio Kaneta, Wenqi Ke, Keith A. Olive

45. [Strong gravitational-wave lensing posterior odds](#user-content-link45)
...
46. [Assessing the Distance for Probing the Nuclear Equation of State with Supernova Gravitational Waves](#user-content-link46)
**Authors:** Y. Sultan Abylkairov, Matthew C. Edwards, Artyom Ostrikov, Yersultan Tleukhanov, Alejandro Torres-Forn\'e, Pablo Cerd\'a-Dur\'an, Jos\'e Antonio Font, Marek J. Szczepa\'nczyk, Ernazar Abdikamalov

47. [Implications of a high growth index on the variation of $G$](#user-content-link47)
**Authors:** \'Icaro. B. S. Cort\^es, L\'eo. G. Medeiros, Ronaldo C. Batista

48. [The lack of fast rotators in Cyg OB2. I. Insights from spectral reclassification of its B0 population](#user-content-link48)
**Authors:** D. Gal\'an-Di\'eguez, S. R. Berlanas, A. Herrero, M. Abdul-Masih, D. J. Lennon, C. Mart\'inez-Sebasti\'an, F. M. P\'erez-Toledo

49. [Polarization based direction of arrival estimation using a radio interferometric array](#user-content-link49)
**Authors:** Sarod Yatawatta

50. [The Missing Multipole Problem: Investigating biases from model starting frequency in gravitational-wave analyses](#user-content-link50)
**Authors:** Ryan Ursell, Charlie Hoy, Ian Harry, Laura K. Nuttall

51. [Universal Relations for Elastic Hybrid Stars and Quark Stars](#user-content-link51)
**Authors:** Chun-Ming Yip, Shu Yan Lau, Kent Yagi

52. [TOI-283 b: A transiting mini-Neptune in a 17.6-day orbit discovered with TESS and ESPRESSO](#user-content-link52)
**Authors:** F. Murgas, E. Pall\'e, A. Su\'arez Mascare\~no, J. Korth, F. J. Pozuelos, M. J. Hobson, B. Lavie, C. Lovis, S. G. Sousa, D. Bossini, H. Parviainen, A. Castro-Gonz\'alez, V. Adibekyan, C. Allende Prieto, Y. Alibert, F. Bouchy, C. Brice\~no, D. A. Caldwell, D. Ciardi, C. Clark, K. A. Collins, K. I. Collins, S. Cristiani, X. Dumusque, D. Ehrenreich, P. Figueira, E. Furlan, R. G\'enova Santos, C. Gnilka, J. I. Gonz\'alez Hern\'andez, Z. Hartman, S. B. Howell, J. M. Jenkins, N. Law, C. Littlefield, G. Lo Curto, A. W. Mann, C. J. A. P. Martins, A. Mehner, G. Micela, P. Molaro, N. J. Nunes, F. Pepe, R. Rebolo, H. M. Relles, N. C. Santos, N. J. Scott, S. Seager, A. Sozzetti, S. Udry, C. N. Watkins, J. N. Winn, M. R. Zapatero Osorio, C. Ziegler

53. [Disentangling two spectral components in the X-ray emission of the blazar 1ES 0229+200](#user-content-link53)
**Authors:** Alicja Wierzcholska, Hubert Siejkowski

54. [Radiative Correction from Secret Neutrino Interactions and Implications for Neutrino-Scattering Experiments](#user-content-link54)
**Authors:** Saeid Foroughi-Abari, Kevin J. Kelly, Yue Zhang

55. [Definition and Realization of the International Lunar Reference Frame](#user-content-link55)
**Authors:** Krzysztof So\'snica, Agn\`es Fienga, Dmitry Pavlov, Nicolas Rambaux, Rados{\l}aw Zajdel

56. [Multiwavelength analysis of polarized light in HD 100453](#user-content-link56)
**Authors:** J. Ma, R. Tazaki, H. M. Schmid, G. Duch\^ene, C. Dominik, C. Ginski, F. M\'enard

57. [Antikaon condensation in magnetized neutron star matter within the framework of the $\sigma$-cut scheme](#user-content-link57)
**Authors:** Fei Wu, Chen Wu

---

## 1. [Velocity dispersion profiles of dwarf spheroidal galaxies with self-interacting ultralight dark matter](https://arxiv.org/abs/2510.15815) <a id="link1"></a>

**ArXiv ID:** 2510.15815

**Authors:** K. Korshynska, E. V. Gorbar, Y. M. Bidasyuk, A. I. Yakimenko, Y. Revaz

**Abstract:** Dark-matter-dominated dwarf galaxies provide an excellent laboratory for testing dark matter models at small scale and, in particular, the ultralight dark matter (ULDM) class of models. Within the framework of self-interacting bosonic dark matter, we use the observed velocity-dispersion pro- files of seven dwarf spheroidal galaxies to constrain the parameters of ULDM. In our modeling, we account for the impact of the baryonic component on the velocity dispersion and ULDM halo structure. We find that in the regime of repulsively interacting ULDM, the self-interaction, which fits the observations, is almost negligible, consistent with non-interacting ULDM with a boson mass of approximately 1.6*10^(-22) eV. In contrast, for attractively interacting ULDM, the best fit corre- sponds to a smaller boson mass of about 1.3*10^(-22) eV, with self-interaction playing a significant role in shaping the dark-matter halo and thereby influencing the interpretation of observations.

**Comment:** Directly relevant to near-field cosmology: uses velocity dispersion profiles of dwarf spheroidal galaxies to constrain ultralight dark matter models, including core-cusp and substructure issues.
...
## 4. [Rare Find: Discovery and chemo-dynamical properties of two s-process enhanced RR Lyrae stars](https://arxiv.org/abs/2510.15723) <a id="link4"></a>
...
**Comment:** This paper reports the discovery and chemo-dynamical analysis of two s-process enhanced RR Lyrae stars, including detailed chemical abundances and comparison with stellar evolution models. The work is relevant to the 'Stellar Models' criterion, as it discusses nucleosynthesis and the need for improved AGB models, and also touches on resolved stellar populations and evolutionary histories.
...
## 9. [Evolution of the kinematic properties of rotating multiple-population globular clusters](https://arxiv.org/abs/2510.15037) <a id="link9"></a>
...
**Comment:** Studies the kinematic evolution of multiple-population globular clusters via N-body simulations. While it uses numerical simulations, the focus is on globular clusters rather than galaxies, so only borderline relevance.
...
## 10. [Simulating the LOcal Web (SLOW) - VI: $\gamma$-ray Emission in the Local Universe](https://arxiv.org/abs/2510.15634) <a id="link10"></a>
...
**Comment:** Presents cosmological MHD simulations with cosmic ray physics, focusing on gamma-ray emission from galaxy clusters and the cosmic web. While it is a numerical galaxy simulation, the focus is on clusters and the cosmic web, not on galaxy-scale processes or dwarf galaxies. No direct relevance to the specified criteria.
...
## 11. [Impact of Neutrino Flavor Conversions on Neutron Star Merger Dynamics, Ejecta, Nucleosynthesis, and Multi-Messenger Signals](https://arxiv.org/abs/2510.15028) <a id="link11"></a>
...
**Comment:** This paper presents numerical simulations of neutron star mergers, focusing on neutrino flavor conversions and their impact on merger dynamics, ejecta, and nucleosynthesis. While it discusses outflows and r-process enrichment, the context is neutron star mergers, not star-formation-driven outflows or the circumgalactic medium of dwarf galaxies. No direct connection to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 12. [Bridging observations and simulations: a machine learning approach to galaxy clusters](https://arxiv.org/abs/2510.14987) <a id="link12"></a>

**ArXiv ID:** 2510.14987

**Authors:** Efrain Gatuzz

**Abstract:** The intracluster medium (ICM) records the history of galaxy clusters through its complex dynamical properties. To effectively interpret these properties, robust methods are needed to compare observational data with theoretical models. We present a novel machine learning framework for comparing ICM line-of-sight velocity maps derived from X-ray observations. Our approach uses convolutional and Siamese neural networks to identify similarities between different kinematic fields. We outline the architecture of this framework and perform a series of sanity checks to validate its performance. These checks demonstrate the model's ability to correctly identify and quantify kinematic features, establishing a powerful new tool for future comparative studies of the ICM.

**Comment:** Presents a machine learning framework for comparing intracluster medium (ICM) velocity maps in galaxy clusters. While it involves simulations and observations, the focus is on clusters and the ICM, not on galaxies or dwarf galaxy properties, so it does not match the core criteria.
...
## 14. [Anisotropic Dark Matter Bosonic Stars in regularized 4D Einstein$-$Gauss$-$Bonnet gravity](https://arxiv.org/abs/2510.15549) <a id="link14"></a>
...
**Comment:** This paper presents numerical simulations of anisotropic dark matter bosonic stars in modified gravity. While it involves compact dark-matter objects and simulations, it does not focus on galaxies, dwarf galaxies, or the other core topics.
...
## 15. [Neural Posterior Estimation for Cataloging Astronomical Images from the Legacy Survey of Space and Time](https://arxiv.org/abs/2510.15315) <a id="link15"></a>
...
**Comment:** Describes a new Bayesian deep learning method for cataloging astronomical images from LSST. While it is relevant to astronomical data processing, it does not directly address any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 16. [HyperAIRI: a plug-and-play algorithm for precise hyperspectral image reconstruction in radio interferometry](https://arxiv.org/abs/2510.15198) <a id="link16"></a>
...
**Comment:** This paper presents a new algorithm for hyperspectral image reconstruction in radio interferometry, with applications to radio astronomy imaging. While it is a methodological advance, it does not directly address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 17. [A rising tide: Intrinsic alignments since the turn of the millennium](https://arxiv.org/abs/2510.15738) <a id="link17"></a>
...
**Comment:** This is a review of intrinsic alignments of galaxies, which is relevant to large-scale structure and lensing systematics, but does not directly address any of the core criteria such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 18. [Molecular line emission from 1000 au scales outflows to <30 au compact structures in NGC1333 IRAS4A2](https://arxiv.org/abs/2510.15578) <a id="link18"></a>
...
**Comment:** Studies molecular line emission and outflows in a protostellar system (NGC1333 IRAS4A2), focusing on disk, envelope, and outflow structures at small scales. While it discusses outflows, these are protostellar and not galaxy-scale star-formation-driven outflows. No direct connection to dwarf galaxies, CGM, or the other core topics.
...
## 19. [Sensitivity of Nuclear Reaction Rates in X-ray Burst Models](https://arxiv.org/abs/2510.15441) <a id="link19"></a>
...
**Comment:** Examines nuclear reaction rates in X-ray burst models, relevant for neutron star physics and nucleosynthesis. This is a study of stellar explosions and nuclear physics, not stellar models in the sense of evolutionary tracks or atmospheres, nor does it address galaxy evolution, star formation histories, or outflows.
...
## 21. [Wave-Mediated Boundary Layers of Accretion Discs: Role of Internal Structure of the Accretor](https://arxiv.org/abs/2510.15064) <a id="link21"></a>
...
**Comment:** Numerical study of boundary layers in accretion discs, focusing on the role of the accretor's internal structure. While it involves hydrodynamic simulations and stellar structure, it is not presenting new stellar evolutionary tracks or atmosphere models, nor is it relevant to galaxy evolution, star formation, or outflows.
...
## 22. [Evidence for cloud-to-cloud variations in the ratio of polarized thermal dust emission to starlight polarization](https://arxiv.org/abs/2510.15389) <a id="link22"></a>
...
**Comment:** Investigates the correlation between optical starlight polarization and polarized thermal dust emission, focusing on cloud-to-cloud variations in dust properties. While it deals with ISM and dust, it does not address galaxy-scale processes, star formation histories, or outflows as specified in the criteria.
...
## 24. [BREAKFAST: A Framework for general joint BA duty and follow-up guidance of multiple $\gamma$-ray monitors](https://arxiv.org/abs/2510.15816) <a id="link24"></a>
...
**Comment:** This paper presents a framework for joint operation and trigger processing for gamma-ray monitors, focusing on rapid analysis and follow-up of transients. While it is relevant to multi-messenger astronomy and transient detection, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 25. [A family of binaries with an extreme mass ratio](https://arxiv.org/abs/2510.15393) <a id="link25"></a>
...
**Comment:** The paper identifies and characterizes binaries with extreme mass ratios, focusing on massive stars and their low-mass companions. While it provides constraints for star formation models, it does not directly address resolved star formation histories, quenching, or near-field cosmology, and is not focused on galaxies or their simulations.
...
## 27. [Extending TESS Flare Frequency Distributions with CHEOPS: power-law or lognormal?](https://arxiv.org/abs/2510.15453) <a id="link27"></a>
...
**Comment:** Examines flare frequency distributions in M dwarfs using TESS and CHEOPS data, with implications for planetary habitability and flare physics. While it involves stellar activity and bolometric corrections, it does not present new stellar atmosphere or evolutionary models, nor does it address galaxy-scale topics.
...
## 28. [From Localization to Discovery: Bayesian Ranking of Electromagnetic Counterparts to Gravitational-Wave Events](https://arxiv.org/abs/2510.15836) <a id="link28"></a>

**ArXiv ID:** 2510.15836

**Authors:** Kendall Ackley

**Abstract:** The robust association of electromagnetic candidates discovered during follow-up of gravitational-wave alerts is challenging, not only due to the large sky areas and broad distance uncertainties, but also due to the tens to hundreds of unrelated optical transients that are observed per event. We present a Bayesian ranking method to identify electromagnetic counterparts to GW events using only location information. The framework combines three-dimensional gravitational wave skymaps with host-galaxy information, a morphology-aware host association, empirical offset priors, and peculiar velocity corrections. We apply the method to GW170817 where it ranks AT2017gfo as the top candidate and correctly selects NGC\,4993 as the host. The approach is directly applicable to transient candidates with only location information and enables more efficient follow-up with prioritized candidates and leads to more reliable counterpart identification in current and future observing runs.

**Comment:** Presents a Bayesian ranking method for identifying electromagnetic counterparts to gravitational-wave events. While it involves galaxy host association, it does not focus on any of the core criteria such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 30. [Precise frequencies of H$_2^{~16}$O lines protected for radio astronomy](https://arxiv.org/abs/2510.15314) <a id="link30"></a>

**ArXiv ID:** 2510.15314

**Authors:** Arth\'emise Altman, Roland T\'obi\'as, Alexandr S. Bogomolov, Meissa L. Diouf, Frank M. J. Cozijn, Attila G. Cs\'asz\'ar, Cl\'ement Lauzin, Wim Ubachs

**Abstract:** Precise frequency values have been determined for H$_2^{~16}$O radio lines appearing in protected line lists of the International Astronomical Union and the Panel on Frequency Allocations of the US National Academy of Sciences. The improved precision is attributable to a spectroscopic network built from a large set of near-infrared Lamb-dip lines augmented with a handful of ultrahigh-accuracy rotational transitions. The ultraprecise H$_2^{~16}$O network contains 376 Lamb-dip lines recorded previously via our frequency-comb locked cavity-enhanced spectrometer. During the present study, altogether 55 target lines have been (re)measured at high accuracy. Due to our network-assisted measurements, the accuracy has been significantly improved with respect to previous direct radio-frequency measurements for all the protected lines of H$_2^{~16}$O above 750 GHz. Furthermore, 43 of these protected transitions now benefit from the accuracy of the new near-infrared Lamb dips reported in this paper.

**Comment:** Presents precise frequency measurements for H2O radio lines, improving spectroscopic data for astronomy. This is relevant to molecular spectroscopy and radio astronomy, but does not match any of the core criteria such as stellar models, galaxy simulations, or near-field cosmology.
...
## 31. [Gradus.jl: spacetime-agnostic general relativistic ray-tracing for X-ray spectral modelling](https://arxiv.org/abs/2510.15049) <a id="link31"></a>
...
**Comment:** Presents a general relativistic ray-tracing toolkit for X-ray spectral modeling, focused on accretion disks and black holes. Not relevant to galaxy simulations or other core topics.
...
## 33. [Magnetohydrodynamic-guiding-center-particle-in-cell Method for Multiscale Plasma Kinetic Simulations](https://arxiv.org/abs/2510.15156) <a id="link33"></a>
...
**Comment:** The paper introduces a new MHD-guiding-center-particle-in-cell method for multiscale plasma kinetic simulations, implemented in Athena++. While it is a methodological advance for plasma simulations, its primary application is particle acceleration and transport, not galaxy simulations or any of the core topics.
...
## 34. [Impact of neutrino decays on the Cosmic Neutrino Background anisotropies](https://arxiv.org/abs/2510.15818) <a id="link34"></a>
...
**Comment:** Studies the impact of neutrino decays on the Cosmic Neutrino Background anisotropies, with a focus on cosmological signatures and detection prospects. No direct connection to any of the core galaxy or stellar topics.
...
## 35. [Atomic Quantum Sensors for High-Frequency Gravitational Wave Searches](https://arxiv.org/abs/2510.15031) <a id="link35"></a>
...
**Comment:** This paper focuses on atomic quantum sensors for high-frequency gravitational wave detection, with implications for fundamental physics and cosmology. However, it does not address any of the core topics such as near-field cosmology, resolved star formation histories, galaxy simulations, or stellar models.
...
## 36. [An Improved Atlas of Full-Scan Spectra from ISO/SWS](https://arxiv.org/abs/2510.15088) <a id="link36"></a>
...
**Comment:** This paper presents an improved atlas of ISO/SWS spectra, which may be useful for stellar atmosphere modeling, but does not present new stellar models or bolometric corrections. No direct relevance to the core topics.
...
## 38. [Exploring Ultra-Slow-Roll Inflation in Composite Pseudo-Nambu-Goldstone Boson Models: Implications for Primordial Black Holes and Gravitational Waves](https://arxiv.org/abs/2510.15460) <a id="link38"></a>

**ArXiv ID:** 2510.15460

**Authors:** Marco Merchand

**Abstract:** We study inflation driven by a scalar potential arising from composite-sector dynamics, inspired by generalized composite Higgs models. The introduction of a non-minimal coupling, possessing the same functional form as the potential, induces a flattening at large field values that enables successful inflation. We analyze the conditions for ultra-slow-roll inflation, which leads to enhanced curvature perturbations, by combining analytical criteria near the inflection point with comprehensive numerical scans of the parameter space. The region consistent with Cosmic Microwave Background constraints and yielding approximately $N_e \approx 55\text{-}60$ e-folds also predicts primordial black holes with masses in the range $10^3\text{-}10^5\,\mathrm{g}$. Although such ultra-light primordial black holes are typically expected to have evaporated, recent proposals invoking evaporation suppression via memory-burden effects could allow their survival as viable dark matter candidates. Under this assumption, the induced gravitational wave signal peaks in a frequency gap between standard interferometers and resonant-cavity experiments, motivating exploration of this observational frontier.

**Comment:** This paper studies ultra-slow-roll inflation in composite pseudo-Nambu-Goldstone boson models, with implications for primordial black holes and gravitational waves. The focus is on early universe cosmology and inflation, not on galaxies, star formation, or near-field cosmology.
...
## 39. [Transverse BAO scale measurement at $z_{\rm eff} = 1.725$ with the SDSS quasars catalog](https://arxiv.org/abs/2510.15650) <a id="link39"></a>
...
**Comment:** This paper measures the transverse BAO scale using SDSS quasars, providing cosmological constraints. It does not address any of the core topics such as near-field cosmology, dwarf galaxies, star formation histories, or galaxy simulations.
...
## 41. [Hints for dynamical dark energy from warm inflation](https://arxiv.org/abs/2510.15051) <a id="link41"></a>
...
**Comment:** This paper discusses warm inflation and its impact on CMB anisotropies and cosmological parameters. It is focused on early universe cosmology and dark energy, not on galaxies, star formation, or related topics.
...
## 43. [Glycolaldehyde and ethanol toward the L1157 outflow: resolved images and constraints on glycolaldehyde formation](https://arxiv.org/abs/2510.15657) <a id="link43"></a>
...
**Comment:** Investigates the formation of complex organic molecules in a protostellar outflow, focusing on chemical evolution and astrochemical modeling. While it involves resolved observations and modeling, it is not about galaxy-scale star formation histories or quenching, but rather molecular chemistry in star-forming regions.
...
## 44. [Effects of Radiative Corrections on Starobinsky Inflation](https://arxiv.org/abs/2510.15137) <a id="link44"></a>
...
**Comment:** The paper analyzes radiative corrections to Starobinsky inflation, focusing on early universe cosmology and inflationary physics. It does not address near-field cosmology, resolved star formation histories, or any of the other core topics.
...
## 45. [Strong gravitational-wave lensing posterior odds](https://arxiv.org/abs/2510.15463) <a id="link45"></a>
...
**Comment:** This paper discusses gravitational-wave lensing and Bayesian methods for detection. While it is astrophysical, it does not match any of the specific criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy studies, or galaxy simulations.
...
## 46. [Assessing the Distance for Probing the Nuclear Equation of State with Supernova Gravitational Waves](https://arxiv.org/abs/2510.15102) <a id="link46"></a>
...
**Comment:** Assesses the potential for probing the nuclear equation of state with supernova gravitational waves. While it involves supernovae and gravitational waves, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 47. [Implications of a high growth index on the variation of $G$](https://arxiv.org/abs/2510.15054) <a id="link47"></a>
...
**Comment:** Cosmological analysis of the growth index and variation of G; does not focus on galaxies, satellites, or resolved star formation histories. Largely outside the core topics.
...
## 48. [The lack of fast rotators in Cyg OB2. I. Insights from spectral reclassification of its B0 population](https://arxiv.org/abs/2510.15540) <a id="link48"></a>
...
**Comment:** This paper studies the rotation properties of O- and B-type stars in Cygnus OB2, a massive star-forming region. It does not address dwarf galaxies, resolved star formation histories, quenching, or galaxy simulations, and is focused on stellar populations in a massive association.
...
## 49. [Polarization based direction of arrival estimation using a radio interferometric array](https://arxiv.org/abs/2510.15116) <a id="link49"></a>
...
**Comment:** Focuses on direction of arrival estimation using radio interferometric arrays, mainly for RFI mitigation and transient detection. Does not match any of the core criteria such as near-field cosmology, star formation histories, or galaxy simulations.
...
## 50. [The Missing Multipole Problem: Investigating biases from model starting frequency in gravitational-wave analyses](https://arxiv.org/abs/2510.15048) <a id="link50"></a>
...
**Comment:** Investigates biases in gravitational-wave analyses due to model starting frequency, focusing on black hole mergers. Does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 52. [TOI-283 b: A transiting mini-Neptune in a 17.6-day orbit discovered with TESS and ESPRESSO](https://arxiv.org/abs/2510.15084) <a id="link52"></a>
...
**Comment:** This paper reports the discovery and characterization of a transiting mini-Neptune exoplanet. It does not address any of the core topics such as dwarf galaxies, star formation histories, quenching, or galaxy simulations.
...
## 54. [Radiative Correction from Secret Neutrino Interactions and Implications for Neutrino-Scattering Experiments](https://arxiv.org/abs/2510.15023) <a id="link54"></a>
...
**Comment:** This work explores radiative corrections from secret neutrino interactions and their implications for neutrino-scattering experiments. It is focused on particle physics and neutrino phenomenology, with no direct relevance to the core topics listed.
...
## 55. [Definition and Realization of the International Lunar Reference Frame](https://arxiv.org/abs/2510.15484) <a id="link55"></a>
...
**Comment:** This paper defines and realizes a lunar reference frame for future lunar missions. It is focused on planetary science and geodesy, not on any of the core astrophysical criteria.
...
## 56. [Multiwavelength analysis of polarized light in HD 100453](https://arxiv.org/abs/2510.15832) <a id="link56"></a>
...
**Comment:** This paper analyzes polarized light in the disk around HD 100453, focusing on dust properties and disk structure. The topic is protoplanetary disks and dust, not galaxies, star formation histories, or outflows.
...
## 57. [Antikaon condensation in magnetized neutron star matter within the framework of the $\sigma$-cut scheme](https://arxiv.org/abs/2510.15521) <a id="link57"></a>

**ArXiv ID:** 2510.15521

**Authors:** Fei Wu, Chen Wu

**Abstract:** This study investigates the effects of strong magnetic fields on antikaon condensation in neutron star matter using the extended FSUGold model model. It is found that the presence of strong magnetic fields alters the threshold density of antikaon condensation significantly, which means the threshold density of antikaon condensation is shifted to higher density compared with the magnetic field-free case. In the presence of strong magnetic fields, the equation of state (EoS) becomes stiffer than that of the zero field case. The effects of the $\sigma$-cut scheme on the EoS are also researched when the appearance of antikaon condensation is occurred. Through careful choice of the parameter of the $\sigma$-cut scheme, we are able to produce a maximum mass neutron star heavier than 2$M_{sun}$.

**Comment:** Focuses on neutron star matter and antikaon condensation, not on galaxies, star formation, or stellar models. Irrelevant to the core topics.
