...
1. [Constraining Ultra-Light Dark Matter mass with Dwarf Galaxy Rotation Curves](#user-content-link1)
**Authors:** Tian-yao Fang, Ming-Chung Chu

2. [Numerical Cosmology](#user-content-link2)
**Authors:** Romain Teyssier

3. [The collision and merger products of stars do not look alike: A magnetohydrodynamics comparison](#user-content-link3)
**Authors:** Pavan Vynatheya, Taeho Ryu, Chen Wang, Alison Sills, R\"udiger Pakmor

4. [Beyond OCCAM: Measuring Optical Neutron Capture Abundances of Open Cluster Stars](#user-content-link4)
**Authors:** Natalie Myers, Sarah Loebman, Henrique Reggiani, Peter Frinchaboy

5. [Comparing subgrid models for cosmic ray diffusion in a magnetized isolated galaxy simulation](#user-content-link5)
**Authors:** Sarah Thiele, Romain Teyssier

6. [Only the Special Survive: Evolution of Long-Lived Star Clusters in Galaxy Simulations](#user-content-link6)
**Authors:** Alessa I. Wiggins, Sarah Loebman, Peter Frinchaboy

7. [Galaxy Protoclusters as Drivers of Cosmic Reionization: I. Bubble Overlap at Redshift z ~ 7 in LAGER-z7OD1](#user-content-link7)
...
8. [Statistical properties of compressible isothermal turbulence from sub- to supersonic conditions](#user-content-link8)
**Authors:** F. Thiesset, C. Federrath

9. [Exploring the connection between compact object mergers and fast X-ray transients: The cases of LXT 240402A & EP250207b](#user-content-link9)
**Authors:** R. L. Becerra, Yu-Han Yang, Eleonora Troja, Massine El Kabir, Simone Dichiara, Niccol\`o Passaleva, Brendan O'Connor, Roberto Ricci, Chris Fryer, Lei Hu, Qinyu Wu, Muskan Yadav, Alan M. Watson, Anastasia Tsvetkova, Camila Angulo-Valdez, Mar\'ia D. Caballero-Garc\'ia, Alberto J. Castro-Tirado, C. C. Cheung, Dmitry Frederiks, Maria Gritsevich, J. E. Grove, M. Kerr, William H. Lee, Alexandra L. Lysenko, Margarita Pereyra Talamantes, Anna Ridnaia, Rub\'en S\'anchez-Ram\'irez, Hui Sun, Dmitry Svinkin, Mikhail Ulanov, R. Woolf, Bing Zhang

10. [InferA: A Smart Assistant for Cosmological Ensemble Data](#user-content-link10)
**Authors:** Justin Z. Tam, Pascal Grosset, Divya Banesh, Nesar Ramachandra, Terece L. Turton, James Ahrens

11. [Toward First-Principles Multi-Messenger Predictions: Coupling Nuclear Networks with GR Radiation-MHD in {\tt Gmunu}](#user-content-link11)
**Authors:** Patrick Chi-Kit Cheong, Christopher L. Fryer

12. [Simulation-Based Pretraining and Domain Adaptation for Astronomical Time Series with Minimal Labeled Data](#user-content-link12)
**Authors:** Rithwik Gupta, Daniel Muthukrishna, Jeroen Audenaert

13. [J-PLUS: Turning Off the Bright Stars](#user-content-link13)
**Authors:** Sepideh Eskandarlou, Mohammad Akhlaghi, Johan H. Knapen, Carlos L\'opez-Sanjuan, Ra\'ul Infante-Sainz, Helena Dom\'inguez S\'anchez, Zahra Sharbaf, H\'ector V\'azquez Rami\'o, Juan Antonio Fern\'andez Ontiveros, C\'esar I\~niguez Garc\'ia, Tamara Civera Lorenzo, David Jos\'e Muniesa Gallardo, Paula R. T. Coelho, Alessandro Ederoclite, Jesus Varela, Fran Jim\'enez-Esteban, A. Javier Cenarro, Antonio Mar\'in-Franch, Renato A. Dupke, Mariano Moles, Carlos Hern\'andez-Monteagudo, Rahna P. T., David Crist\'obal-Hornillos, Jailson Alcaniz, Laerte Sodr\'e Jr., Raul E. Angulo

14. [Discovery of red galaxy candidates at z ~ 12: Early dust growth or significant nebular emission with high-temperature stars?](#user-content-link14)
...
15. [Effects of primordial magnetic fields on 21 cm multifrequency angular power spectra](#user-content-link15)
**Authors:** Kerstin E. Kunze

16. [Cosmic Ray Transport and Gamma-Ray Signatures in the Interstellar Medium](#user-content-link16)
...
17. [Galactic chemical evolution with the short-lived isotopes Mn-53, Fe-60, Hf-182, and Pu-244](#user-content-link17)
**Authors:** Benjamin Wehmeyer, Andr\'es Yag\"ue L\'opez, Benoit C\^ot\'e, Maria K. Pet\H{o}, Chiaki Kobayashi, Maria Lugaro

18. [Galactic X-ray Transients in the First eROSITA All Sky Survey](#user-content-link18)
**Authors:** Vikash Maan, Aman Katira, Kunal. P. Mooley

19. [The Formation Rate and Luminosity Function of Fast X-ray transients from Einstein probe](#user-content-link19)
**Authors:** Yizhou Guo, Houdun Zeng, Junjie Wei, Hao Zhou, Zhiping Jin, Xuefeng Wu, Daming Wei

20. [$\texttt{SBi3PCF:}$ Simulation-based inference with the integrated 3PCF](#user-content-link20)
**Authors:** David Gebauer, Anik Halder, Stella Seitz, Dhayaa Anbajagane

21. [Strategy for identifying Vera C. Rubin Observatory kilonova candidates for targeted gravitational-wave searches](#user-content-link21)
**Authors:** Simon Stevenson, Anais M\"oller, Jade Powell

22. [Euclid: Exploring observational systematics in cluster cosmology -- a comprehensive analysis of cluster counts and clustering](#user-content-link22)
**Authors:** A. Fumagalli, M. Costanzi, T. Castro, A. Saro, S. Borgani, M. Romanello, F. Marulli, E. Tsaprazi, P. Monaco, B. Altieri, A. Amara, L. Amendola, S. Andreon, N. Auricchio, C. Baccigalupi, M. Baldi, A. Balestra, S. Bardelli, A. Biviano, E. Branchini, M. Brescia, S. Camera, G. Ca\~nas-Herrera, V. Capobianco, C. Carbone, J. Carretero, S. Casas, M. Castellano, G. Castignani, S. Cavuoti, K. C. Chambers, A. Cimatti, C. Colodro-Conde, G. Congedo, L. Conversi, Y. Copin, F. Courbin, H. M. Courtois, A. Da Silva, H. Degaudenzi, S. de la Torre, G. De Lucia, A. M. Di Giorgio, H. Dole, M. Douspis, F. Dubath, C. A. J. Duncan, X. Dupac, S. Dusini, S. Escoffier, M. Farina, R. Farinelli, F. Faustini, S. Ferriol, F. Finelli, P. Fosalba, N. Fourmanoit, M. Frailis, E. Franceschi, M. Fumana, S. Galeotta, K. George, B. Gillis, C. Giocoli, J. Gracia-Carpio, A. Grazian, F. Grupp, L. Guzzo, S. V. H. Haugan, W. Holmes, F. Hormuth, A. Hornstrup, K. Jahnke, M. Jhabvala, B. Joachimi, E. Keih\"anen, S. Kermiche, A. Kiessling, B. Kubik, M. K\"ummel, M. Kunz, H. Kurki-Suonio, A. M. C. Le Brun, S. Ligori, P. B. Lilje, V. Lindholm, I. Lloro, G. Mainetti, D. Maino, E. Maiorano, O. Mansutti, O. Marggraf, M. Martinelli, N. Martinet, R. J. Massey, E. Medinaceli, S. Mei, Y. Mellier, M. Meneghetti, E. Merlin, G. Meylan, J. J. Mohr, A. Mora, M. Moresco, L. Moscardini, E. Munari, R. Nakajima, C. Neissner, S. -M. Niemi, C. Padilla, S. Paltani, F. Pasian, K. Pedersen, V. Pettorino, S. Pires, G. Polenta, M. Poncet, L. A. Popa, L. Pozzetti, F. Raison, R. Rebolo, A. Renzi, J. Rhodes, G. Riccio, E. Romelli, M. Roncarelli, C. Rosset, R. Saglia, Z. Sakr, A. G. S\'anchez, D. Sapone, B. Sartoris, P. Schneider, T. Schrabback, A. Secroun, E. Sefusatti, G. Seidel, M. Seiffert, S. Serrano, P. Simon, C. Sirignano, G. Sirri, A. Spurio Mancini, L. Stanco, J. Steinwagner, P. Tallada-Cresp\'i, D. Tavagnacco, A. N. Taylor, I. Tereno, N. Tessore, S. Toft, R. Toledo-Moreo, F. Torradeflot, I. Tutusaus, L. Valenziano, J. Valiviita, T. Vassallo, G. Verdoes Kleijn, A. Veropalumbo, Y. Wang, J. Weller, G. Zamorani, F. M. Zerbi, E. Zucca, C. Burigana, L. Gabarra, M. Maturi, C. Porciani, V. Scottez, M. Sereno, M. Viel

23. [High-Resolution Modelling of Coronae and Winds in Solar-type Stars with Varying Rotation Rates I. X-ray Coronae](#user-content-link23)
**Authors:** Yue-Hong Chen, Juli\'an D. Alvarado-G\'omez, Xin Cheng, Yu Dai, Tong Shi, Katja Poppenh\"ager, Chen Xing, Shun Inoue, J\"orn Warnecke, Maarit J. Korpi-Lagg, Mingde Ding

24. [When Tiny Halos Stir Spacetime: Gravitational Waves from Fifth-Force Mergers](#user-content-link24)
**Authors:** Xinpeng Wang, Yifan Lu, Zachary S. C. Picker, Alexander Kusenko, Misao Sasaki

25. [Unified kinetic theory of induced scattering: Compton, Brillouin, and Raman processes in magnetized electron and positron pair plasma](#user-content-link25)
**Authors:** Rei Nishiura, Shoma F. Kamijima, Kunihito Ioka

26. [Density reconstruction from biased tracers: Testing the equivalence principle through consistency relations](#user-content-link26)
**Authors:** Lawrence Dam, Omar Darwish

27. [Mass and spin coevolution of black holes inspiralling through dark matter](#user-content-link27)
**Authors:** Theophanes K. Karydas, Rodrigo Vicente, Gianfranco Bertone

28. [Some problems associated with the standardization of the light curve of type 1a supernovae](#user-content-link28)
**Authors:** A. P. Mahtessian, G. S. Karapetian, H. F. Khachatryan, M. A. Hovhannisyan, L. A. Mahtessian, L. E. Byzalov, J. M. Sarkissian

29. [Probabilistic Inference of Cosmological Density Parameters from Synthetic Hubble Expansion Data of Varying SNR Using Diverse Artificial Neural Network Architectures](#user-content-link29)
**Authors:** Zijian Jin, Jaehyon Rhee

30. [Condensation sequence of circumstellar cluster seeds (CSCCS)](#user-content-link30)
**Authors:** David Gobrecht

31. [Dark Matter-Electron Interactions Alter the Luminosity and Spectral Index of M87](#user-content-link31)
**Authors:** Abdelaziz Hussein, Gonzalo Herrera

32. [The Stellar Morphology & Size of X-ray-selected Active Galactic Nuclei Host Galaxies Revealed by JWST](#user-content-link32)
...
33. [ALMAGAL VIII. Cataloging Hierarchical Mass Structure from Cores to Clumps across the Galactic Disk](#user-content-link33)
**Authors:** Jennifer Wallace (University of Connecticut, Department of Physics), Taevis Kolz (University of Connecticut, Department of Physics, University of Oregon, Department of Physics), Cara Battersby (University of Connecticut, Department of Physics), Aleksandra Kuznetsova (University of Connecticut, Department of Physics), \'Alvaro S\'anchez-Monge (Institut de Ci\`encies de l'Espai, Institut d'Estudis Espacials de Catalunya), Eugenio Schisano (INAF-Istituto di Astrofisica e Planetologia Spaziale), Alessandro Coletta (INAF-Istituto di Astrofisica e Planetologia Spaziale, Dipartimento di Fisica, Sapienza Universit\`a di Roma), Qizhou Zhang (Center for Astrophysics | Harvard and Smithsonian), Sergio Molinari (INAF-Istituto di Astrofisica e Planetologia Spaziale), Peter Schilke (I. Physikalisches Institut, Universit\"at zu K\"oln), Paul T. P. Ho (Institute of Astronomy and Astrophysics, Academia Sinica, East Asian Observatory), Rolf Kuiper (Faculty of Physics, University of Duisburg-Essen), Tianwei Zhang (Research Center for Astronomical computing, Zhejiang Laboratory, I. Physikalisches Institut, Universit\"at zu K\"oln), Thomas M\"oller (I. Physikalisches Institut, Universit\"at zu K\"oln), Ralf S. Klessen (Universit\"at Heidelberg, Zentrum f\"ur Astronomie, Institut f\"ur Theoretische Astrophysik, Universit\"at Heidelberg, Interdisziplin\"ares Zentrum f\"ur Wissenschaftliches Rechnen), Maria T. Beltr\'an (INAF-Osservatorio Astrofisico di Arcetri), Floris van der Tak (Space Research Organization Netherlands, Kapteyn Astronomical Institute, University of Groningen), Stefania Pezzuto (INAF-Istituto di Astrofisica e Planetologia Spaziale), Henrik Beuther (Max Planck Institute for Astronomy), Alessio Traficante (INAF-Istituto di Astrofisica e Planetologia Spaziale), Davide Elia (INAF-Istituto di Astrofisica e Planetologia Spaziale), Leonardo Bronfman (Departamento de Astronom\'ia, Universidad de Chile), Pamela Klaassen (UK Astronomy Technology Centre, Royal Observatory Edinburgh), Dariusz C. Lis (Jet Propulsion Laboratory, California Institute of Technology), Luca Moscadelli (INAF-Osservatorio Astrofisico di Arcetri), Kazi Rygl (INAF-Istituto di Radioastronomia and Italian ALMA Regional Centre), Milena Benedettini (INAF-Istituto di Astrofisica e Planetologia Spaziale), Chi Yan Law (INAF-Osservatorio Astrofisico di Arcetri), Jofre Allande (INAF-Osservatorio Astrofisico di Arcetri, Dipartimento di Fisica e Astronomia, Universit\`a degli Studi di Firenze), Alice Nucara (INAF-Istituto di Astrofisica e Planetologia Spaziale), Patrick M. Koch (Institute of Astronomy and Astrophysics, Academia Sinica), Won-ju Kim (I. Physikalisches Institut, Universit\"at zu K\"oln, Max-Planck-Institut f\"ur Radioastronomie), Patricio Sanhueza (Institute of Astronomy and Astrophysics, Academia Sinica), Gary Fuller (I. Physikalisches Institut, Universit\"at zu K\"oln, Jodrell Bank Centre for Astrophysics, Oxford Road, The University of Manchester), Georgie Stroud (Jodrell Bank Centre for Astrophysics, Oxford Road, The University of Manchester), Beth Jones (I. Physikalisches Institut, Universit\"at zu K\"oln), Crystal Brogan (National Radio Astronomy Observatory), Todd Hunter (National Radio Astronomy Observatory), Aida Ahmadi (Leiden Observatory, Leiden University), Adam Avison (SKA Observatory, Jodrell Bank, Jodrell Bank Centre for Astrophysics, Oxford Road, The University of Manchester, UK ALMA Regional Centre Node), Katharine Johnston (School of Engineering and Physical Sciences, Isaac Newton Building, University of Lincoln), Sheng-Yuan Liu (Institute of Astronomy and Astrophysics, Academia Sinica), Chiara Mininni (INAF-Istituto di Astrofisica e Planetologia Spaziale), Yu-Nung Su (Institute of Astronomy and Astrophysics, Academia Sinica)

34. [Examining a new form of non-standard dark matter using DESI DR2 data](#user-content-link34)
**Authors:** Yan-Hong Yao, Yi-Hao Shen, Tian-Nuo Li, Guo-Hong Du, Yungui Gong

35. [Abundance of heavy r-process elements in CEMP-rs stars: The role of the i-process](#user-content-link35)
**Authors:** A. M. Riyas, D. Karinkuzhi, S. Van Eck, A. Choplin, S. Goriely, L. Siess, M. V. Keerthy, A. Jorissen, T. Merle

36. [Strong Progenitor Age-bias in Supernova Cosmology. II. Alignment with DESI BAO and Signs of a Non-Accelerating Universe](#user-content-link36)
**Authors:** Junhyuk Son, Young-Wook Lee, Chul Chung, Seunghyun Park, Hyejeon Cho

37. [First Demonstration of Kernel Phase Interferometry on JWST/MIRI: Prospects for Future Planet Searches Around Post Main Sequence Stars](#user-content-link37)
**Authors:** Chelsea Adelman, Steph Sallum, Matthew De Furio, Josh Eisner

38. [A New Method for Aperture Masking Interferometric Imaging: Demonstration with the JWST](#user-content-link38)
...
39. [Dynamics and Observational Signatures of Core-Collapse Supernovae with Central Engines: Hydrodynamics Simulations with Monte Carlo Post-Processing](#user-content-link39)
**Authors:** Kiran Eiden, Daniel Kasen

40. [Polarization dynamics of X-ray synchrotron emission from a multi-zone blazar jet](#user-content-link40)
**Authors:** Benjamin de Jonge, Haocheng Zhang, Manel Errando, Andrea Gokus, Pazit Rabinowitz

41. [Eccentric Disks With Self-Gravity](#user-content-link41)
**Authors:** Yoram Lithwick, Eugene Chiang, Leon Mikulinsky, Zhenbang Yu

42. [Relativistic reflection within an extended hot plasma geometry](#user-content-link42)
...
43. [Gravitational-Wave Signatures of Highly Eccentric Stellar-Mass Binary Black Holes in Galactic Nuclei](#user-content-link43)
**Authors:** Evgeni Grishin, Isobel M. Romero-Shaw, Alessandro A. Trani

44. [Unified Origin of Dirac Neutrino and Asymmetric Dark Matter Masses via a Dirac-Type Leptogenesis](#user-content-link44)
**Authors:** Megumi Ishida, Hiroshi Ohki, Shohei Uemura

45. [Diffusion models for polarimetric reconstruction of circumstellar environments](#user-content-link45)
**Authors:** Quentin Villegas (LRE), Laurence Denneulin (LRE), Simon Prunet (LAGRANGE), Andr\'e Ferrari (LAGRANGE), Nelly Pustelnik (Phys-ENS), \'Eric Thi\'ebaut (CRAL), Julian Tachella (Phys-ENS, CNRS), Maud Langlois (CRAL)

46. [The Supernova 1987A system and its recent evolution - a review](#user-content-link46)
**Authors:** Michael J. Barlow

47. [Probing the magneto-ionic medium of the Milky Way using pulsars](#user-content-link47)
**Authors:** Saakshi Dhakal, Amit Seta

48. [Recent progress on interstellar radionuclides on Earth and the Moon](#user-content-link48)
...
49. [Towards High-Resolution Orbitrap Mass Spectrometry for Next- Generation In-Situ Space Dust Analysis](#user-content-link49)
**Authors:** M. Male\v{c}kov\'a, I. Zymak, A. Spesyvyi, M. Pol\'a\v{s}ek, B. Cherville, M. Lacko, M. Ferus, A. Charvat, J. \v{Z}abka, B. Abel

50. [Mean Motion Resonances in AGN Disks](#user-content-link50)
**Authors:** Marguerite Epstein-Martin, Nicholas Stone, Juliette Becker

51. [Monte Carlo simulation of the Compton scattering and disk reflection of a cylinder with hot electrons moving away from a black hole](#user-content-link51)
**Authors:** Wei Meng, Yuan You, Shuang-Nan Zhang, Jia-Ying Cao

52. [The Dependency of Bar Formation Timescale on Disk Mass Fraction, Toomre $Q$, and Scale Height](#user-content-link52)
**Authors:** Bin-Hui Chen, Juntai Shen

53. [Primordial magnetogenesis in loop quantum cosmology](#user-content-link53)
**Authors:** Ganga R. Nair, V. Sreenath

54. [Spatial Variations of Polarized Synchrotron Emission in the QUIJOTE MFI Data](#user-content-link54)
**Authors:** J. M. Casas, L. Bonavera, J. Gonz\'alez-Nuevo, J. A. Rubi\~no-Mart\'in, R. T. G\'enova-Santos, R. B. Barreiro, M. M. Cueli, D. Crespo, R. Fern\'andez-Fern\'andez, J. A. Cano

55. [Optimizing Supernova Classification with Interpretable Machine Learning Models](#user-content-link55)
**Authors:** Anurag Garg (Ministry of Education, Abu Dhabi, UAE)

56. [Global linear analysis of the magneto-thermal instability in a stratified spherical model of the intracluster medium](#user-content-link56)
**Authors:** J. M. Kempf, H. Latter

57. [Probing Primordial black holes with the distortion of Stochastic Gravitational Wave Background](#user-content-link57)
**Authors:** Mingqi Sun, Liao Kai, Xi-Long Fan

58. [Gravitational-Wave Signatures of Highly Eccentric Stellar Binary Black-Holes in Galactic Nuclei](#user-content-link58)
**Authors:** Evgeni Grishin, Isobel M. Romero-Shaw, Alessandro A. Trani

59. [Investigating double bump air showers with the SKA-Low](#user-content-link59)
**Authors:** V. De Henau, S. Bouma, J. Bray, S. Buitink, A. Corstanje, M. Desmet, E. Dickinson, L. van Dongen, B. Hare, H. He, J. R. H\"orandel, T. Huege, C. W. James, M. Jetti, P. Laub, H. -J. Mathes, K. Mulrey, A. Nelles, O. Scholten, C. Sterpka, S. ter Veen, K. Terveer, P. Turekova, T. N. G. Trinh, S. Saha, S. Sharma, R. Spencer, D. Veberi\v{c}, K. Watanabe, M. Waterson, C. Zhang, P. Zhang, Y. Zhang

60. [On the maximum compactness of neutron stars](#user-content-link60)
**Authors:** Luciano Rezzolla, Christian Ecker

61. [Evidence for Neutrino Emission from X-ray Bright Active Galactic Nuclei with IceCube](#user-content-link61)
...
62. [APRIL: Auxiliary Physically-Redundant Information in Loss - A physics-informed framework for parameter estimation with a gravitational-wave case study](#user-content-link62)
**Authors:** Matteo Scialpi, Francesco Di Clemente, Leigh Smith, Micha{\l} Bejger

63. [The 2024 outburst of the neutron star LMXB EXO 0748-676: an investigation of bursts and eclipses with AstroSat](#user-content-link63)
**Authors:** Aromal P, Unnati Kashyap, Manoneeta Chakraborty, Sudip Bhattacharyya, Thomas J. Maccarone, Vijay Choudhary

64. [Hyperons and $\Delta$'s in rotating protoneutron stars: Local properties](#user-content-link64)
**Authors:** Franciele M. da Silva, Adamu Issifu, Luis C. N. Santos, Tobias Frederico, D\'ebora P. Menezes

65. [Revealing evolution of Dark Energy density from observations](#user-content-link65)
**Authors:** Jos\'e Blanco, V\'ictor H. C\'ardenas an Cauht\'emoc Campuzano

66. [Dependency of the Bar Formation Timescale On The Halo Spin](#user-content-link66)
**Authors:** Bin-Hui Chen, Sandeep Kumar Kataria, Juntai Shen, Meng Guo

67. [The dependence of black hole formation in open clusters on the cluster formation process](#user-content-link67)
**Authors:** Jian-Wen Zhou

68. [Gravity and the Hierarchy Problem](#user-content-link68)
**Authors:** Thede de Boer, Jisuke Kubo, Manfred Lindner, Markus Reinig

69. [Design of an Imaging Air Cherenkov Telescope array layout with differential programming](#user-content-link69)
**Authors:** Cyril Alispach, Matthieu Heller, Teresa Montaruli

70. [New Spallation Background Rejection Techniques to Greatly Improve the Solar Neutrino Sensitivity of JUNO](#user-content-link70)
**Authors:** Obada Nairat, John F. Beacom, Shirley Weishi Li

71. [XRISM Resolves Relativistic Effects from the Innermost Accretion Disk in Serpens X-1](#user-content-link71)
**Authors:** R. M. Ludlam, J. M. Miller, E. M Cackett, J. A. Garcia

72. [Calibration of the ComPair Balloon Instrument](#user-content-link72)
...
73. [Old open clusters NGC 188 and M 67 in Gaia DR3](#user-content-link73)
**Authors:** Anton F. Seleznev, Maxim V. Kulesh

74. [Measuring the precise photometric period of the probable intermediate polar 1RXS J014549.6+514314 based on extensive photometry](#user-content-link74)
**Authors:** V. P. Kozhevnikov

75. [Orbital dynamics and precession in magnetized Kerr spacetime](#user-content-link75)
**Authors:** Karthik Iyer (MCNS, India), Chandrachur Chakraborty (MCNS, India)

76. [Improved Absolute Polarization Calibrator for BICEP CMB Polarimeters](#user-content-link76)
...
77. [Simulation of Time-dependent Karhunen-Loeve Phase Screens: an Ergodic Approach](#user-content-link77)
**Authors:** Richard J. Mathar

78. [Impact of facility timing and coordination for next-generation gravitational-wave detectors](#user-content-link78)
**Authors:** Ssohrab Borhanian, Arianna Renzini, Philippa S. Cole, Costantino Pacilio, Michele Mancarella, Davide Gerosa

79. [Prospects for the Crossing of Comet 3I/ATLAS's Ion Tail](#user-content-link79)
**Authors:** Samuel R. Grant, Geraint H. Jones

80. [Solar Cycle Variation of Sustained Gamma-ray Emission Events from the Sun and Related Energetic Events](#user-content-link80)
**Authors:** N. Gopalswamy, P. M\"akela, S. Akiyama, S. Yashiro, H. Xie

81. [Planetary-mass companions to a retired B star BD+37 3172 and a retired F star BD+42 2315](#user-content-link81)
**Authors:** Andrzej Niedzielski, Robert Jaros, Artur Paczuski, Monika Adam\'ow, Aleksander Wolszczan, Eva Villaver, Gracjan Maciejewski, Beata Deka-Szymankiewicz

82. [ON the stability of triangular Lagrangian points in the spatial restricted three-body problem](#user-content-link82)
**Authors:** Stepan P. Sosnitskii

---

## 1. [Constraining Ultra-Light Dark Matter mass with Dwarf Galaxy Rotation Curves](https://arxiv.org/abs/2510.12848) <a id="link1"></a>

**ArXiv ID:** 2510.12848

**Authors:** Tian-yao Fang, Ming-Chung Chu

**Abstract:** While ultra-light bosonic dark matter (ULDM) in a Bose-Einstein condensate (BEC) state could naturally account for the central core in some galaxies and resolve the core-cusp problem, the dark matter density distribution in the outer regions of galaxies remains less explored. We propose a trial wavefunction to model the ULDM distribution beyond the BEC core. We derive the corresponding rotation velocity curve, which shows excellent agreement with those of 12 dwarf spheroidal galaxies. The best-fit ULDM particle mass for each dwarf galaxy falls within a strikingly narrow range of $m=(1.8-3.2)\times 10^{-23}\text{eV}$.

**Comment:** Directly relevant to near-field cosmology and the core-cusp problem, this paper uses dwarf galaxy rotation curves to constrain ultra-light dark matter models, with a focus on the dark matter density profiles of dwarf spheroidal galaxies.
...
## 3. [The collision and merger products of stars do not look alike: A magnetohydrodynamics comparison](https://arxiv.org/abs/2510.13736) <a id="link3"></a>
...
**Comment:** Simulates stellar collisions and mergers, focusing on the properties of the resulting stars. This fits the 'Stellar Models' criterion, as it presents new insights into stellar evolution and magnetohydrodynamics of merger/collision products.
...
## 4. [Beyond OCCAM: Measuring Optical Neutron Capture Abundances of Open Cluster Stars](https://arxiv.org/abs/2510.13014) <a id="link4"></a>

**ArXiv ID:** 2510.13014

**Authors:** Natalie Myers, Sarah Loebman, Henrique Reggiani, Peter Frinchaboy

**Abstract:** Open clusters have long been used to determine ages of stars, as well as calibrate stellar evolution models and other methods of age-dating stellar groups, e.g., gyrochronology, asteroseismology, and chemical clocks. In this work, we have obtained new high-resolution (R $\ge$ 50,000), high-S/N, optical data for 3+ stellar members in open clusters, using Keck/HIRES, with membership derived from the Open Cluster Chemical Abundances and Mapping (OCCAM) survey. From these new Keck/HIRES data, we have derived neutron capture abundances for stars in seven distant outer Galaxy open cluster

**Comment:** This work presents neutron capture abundances for stars in open clusters, with implications for stellar evolution models. It is relevant to the 'Stellar Models' criterion, as it provides new abundance measurements that can calibrate stellar models.
...
## 5. [Comparing subgrid models for cosmic ray diffusion in a magnetized isolated galaxy simulation](https://arxiv.org/abs/2510.13737) <a id="link5"></a>
...
**Comment:** Compares subgrid models for cosmic ray diffusion in a simulated star-forming galactic disk. Relevant to numerical galaxy simulations, especially those including new physics (cosmic ray transport). However, the focus is on an isolated disk galaxy, not dwarfs or satellites.
...
## 6. [Only the Special Survive: Evolution of Long-Lived Star Clusters in Galaxy Simulations](https://arxiv.org/abs/2510.12942) <a id="link6"></a>

**ArXiv ID:** 2510.12942

**Authors:** Alessa I. Wiggins, Sarah Loebman, Peter Frinchaboy

**Abstract:** In this work, we aim to answer one crucial question behind the discrepancy between chemical trends of field stars and clusters in the Galactic disk: is the chemical gradient mismatch driven by cluster migration and differential survivability as a function of galactic location? To answer this question, we explored the evolution of long-lived (> 1 Gyr) star clusters in Milky Way-galaxy simulations. In particular, we investigated why some star clusters remain bound over billions of years. We have traced the unique trajectories for a sample of open clusters around two FIRE galaxies throughout cosmic time. Additionally, we characterized the small-scale environment surrounding these clusters over their orbital history. We see that clusters across both FIRE galaxies spend the majority of their lives in under-dense regions of gas, except for brief passages where they interact with gas clouds, causing their orbits to be altered.

**Comment:** This paper analyzes the evolution and survivability of long-lived star clusters in Milky Way-like galaxy simulations, using FIRE simulations. It is relevant to numerical galaxy simulations, but focuses on open clusters in the Galactic disk rather than dwarf galaxies or resolved star formation histories.
...
## 7. [Galaxy Protoclusters as Drivers of Cosmic Reionization: I. Bubble Overlap at Redshift z ~ 7 in LAGER-z7OD1](https://arxiv.org/abs/2510.13140) <a id="link7"></a>
...
**Comment:** This paper presents new JWST and Keck spectra of LAEs in a z~7 protocluster, mapping ionized bubbles and discussing cosmic reionization. While it is focused on high-redshift protoclusters and reionization, it does not directly address near-field cosmology, resolved star formation histories, or dwarf galaxy properties.
...
## 8. [Statistical properties of compressible isothermal turbulence from sub- to supersonic conditions](https://arxiv.org/abs/2510.13141) <a id="link8"></a>
...
**Comment:** This paper investigates the statistical properties of compressible isothermal turbulence using hydrodynamical simulations. While it discusses turbulence relevant to ISM and star formation, it does not directly address galaxy-scale simulations, star formation histories, or outflows. Borderline relevance for informing numerical galaxy simulations.
...
## 9. [Exploring the connection between compact object mergers and fast X-ray transients: The cases of LXT 240402A & EP250207b](https://arxiv.org/abs/2510.13015) <a id="link9"></a>
...
**Comment:** Investigates two fast X-ray transients possibly associated with compact object mergers in nearby quiescent galaxies, using multiwavelength observations to search for kilonova emission. The focus on nearby galaxies and compact object mergers is tangentially related to near-field cosmology, but the main topic is transient phenomena rather than galaxy evolution or star formation histories.
...
## 10. [InferA: A Smart Assistant for Cosmological Ensemble Data](https://arxiv.org/abs/2510.12920) <a id="link10"></a>
...
**Comment:** Describes InferA, a multi-agent system for scalable analysis of cosmological ensemble data, demonstrated on HACC cosmology simulations. While it is a tool for analyzing cosmological simulations, it does not present new galaxy simulations or results on galaxy evolution, but could be tangentially relevant for numerical galaxy simulations.
...
## 12. [Simulation-Based Pretraining and Domain Adaptation for Astronomical Time Series with Minimal Labeled Data](https://arxiv.org/abs/2510.12958) <a id="link12"></a>
...
**Comment:** Presents a simulation-based pretraining approach for astronomical time series analysis, enabling domain adaptation with minimal labeled data. While the method is broadly applicable, it is not specifically focused on galaxy simulations, resolved star formation histories, or near-field cosmology.
...
## 13. [J-PLUS: Turning Off the Bright Stars](https://arxiv.org/abs/2510.12940) <a id="link13"></a>
...
**Comment:** This paper presents a new method for PSF characterization and subtraction in photometric surveys, enabling improved study of low surface brightness features. While this could be tangentially useful for resolved star formation histories and LSB features in galaxies, the focus is on survey methodology rather than direct application to the core topics.
...
## 14. [Discovery of red galaxy candidates at z ~ 12: Early dust growth or significant nebular emission with high-temperature stars?](https://arxiv.org/abs/2510.13240) <a id="link14"></a>
...
**Comment:** This paper reports the discovery of z~12 galaxy candidates with red UV slopes, discussing possible origins such as early dust growth or nebular emission. While it is an observational study of high-redshift galaxies, it does not focus on near-field cosmology, resolved star formation histories, or dwarf galaxies. The work is more relevant to galaxy formation at cosmic dawn, which is outside the core topics.
...
## 15. [Effects of primordial magnetic fields on 21 cm multifrequency angular power spectra](https://arxiv.org/abs/2510.13752) <a id="link15"></a>
...
**Comment:** Studies the effects of primordial magnetic fields on the 21 cm multifrequency angular power spectra, relevant for constraining the matter power spectrum. While it touches on cosmological structure formation, it does not focus on near-field cosmology, resolved star formation histories, or dwarf galaxies.
...
## 16. [Cosmic Ray Transport and Gamma-Ray Signatures in the Interstellar Medium](https://arxiv.org/abs/2510.12965) <a id="link16"></a>
...
**Comment:** Reviews cosmic ray transport and presents preliminary simulations of cosmic ray propagation in young massive stellar clusters. While it touches on cosmic ray transport and ISM, it does not directly address star-formation-driven outflows, CGM, or galaxy-scale simulations.
...
## 17. [Galactic chemical evolution with the short-lived isotopes Mn-53, Fe-60, Hf-182, and Pu-244](https://arxiv.org/abs/2510.13070) <a id="link17"></a>
...
**Comment:** Galactic chemical evolution model tracking short-lived isotopes from various astrophysical sources. While it involves galaxy-scale modeling, the focus is on isotope propagation and not on dwarf galaxies, satellites, or star formation histories.
...
## 18. [Galactic X-ray Transients in the First eROSITA All Sky Survey](https://arxiv.org/abs/2510.12982) <a id="link18"></a>
...
**Comment:** Reports on a blind survey of Galactic X-ray transients using eROSITA, ROSAT, and Gaia, identifying various types of transients including compact object systems. The study is focused on the population and properties of X-ray transients in the Milky Way, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 19. [The Formation Rate and Luminosity Function of Fast X-ray transients from Einstein probe](https://arxiv.org/abs/2510.13533) <a id="link19"></a>
...
**Comment:** Derives the luminosity function and formation rate of fast X-ray transients from Einstein Probe data, discussing their possible connection to low-luminosity long GRBs and collapsar progenitors. The work is focused on transient phenomena and their rates, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 21. [Strategy for identifying Vera C. Rubin Observatory kilonova candidates for targeted gravitational-wave searches](https://arxiv.org/abs/2510.12932) <a id="link21"></a>
...
**Comment:** Develops a strategy for identifying kilonova candidates for gravitational-wave searches using Rubin Observatory data. While it involves transient astronomy and multi-messenger searches, it does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 22. [Euclid: Exploring observational systematics in cluster cosmology -- a comprehensive analysis of cluster counts and clustering](https://arxiv.org/abs/2510.13509) <a id="link22"></a>
...
**Comment:** Analyzes cluster counts and clustering for cosmological constraints in the Euclid survey. Focus is on galaxy clusters and large-scale structure, not on dwarf galaxies, resolved star formation histories, or galaxy-scale simulations.
...
## 23. [High-Resolution Modelling of Coronae and Winds in Solar-type Stars with Varying Rotation Rates I. X-ray Coronae](https://arxiv.org/abs/2510.12969) <a id="link23"></a>
...
**Comment:** This paper models the coronae and winds of solar-type stars with varying rotation rates, using high-resolution simulations. While it presents new numerical simulations, these are focused on stellar coronae and winds, not on galaxies or the core topics.
...
## 24. [When Tiny Halos Stir Spacetime: Gravitational Waves from Fifth-Force Mergers](https://arxiv.org/abs/2510.12984) <a id="link24"></a>
...
**Comment:** This paper discusses gravitational wave signals from mergers of tiny dark matter halos with fifth-force interactions. While it is related to dark matter and halo dynamics, it does not focus on near-field cosmology, resolved star formation histories, or galaxy simulations. The focus is on early universe and GW signals, not on the core topics.
...
## 26. [Density reconstruction from biased tracers: Testing the equivalence principle through consistency relations](https://arxiv.org/abs/2510.13803) <a id="link26"></a>
...
**Comment:** The paper discusses large-scale structure consistency relations and tests of the equivalence principle using biased tracers in cosmological surveys. While it is cosmology-related, it does not focus on near-field cosmology, satellite galaxies, or any of the other core topics.
...
## 28. [Some problems associated with the standardization of the light curve of type 1a supernovae](https://arxiv.org/abs/2510.13187) <a id="link28"></a>

**ArXiv ID:** 2510.13187

**Authors:** A. P. Mahtessian, G. S. Karapetian, H. F. Khachatryan, M. A. Hovhannisyan, L. A. Mahtessian, L. E. Byzalov, J. M. Sarkissian

**Abstract:** We show that the parameters used to standardize the luminosity of Type 1a supernovae in the SALT2 and SiFTO models are strongly dependent on the redshift z. Consequently, when standardized with increasing z, the average absolute magnitudes of Type 1a supernovae are artificially increased. This means that for a given apparent magnitude they are, on average, assigned larger distances than they actually are, creating the appearance of their recession with acceleration and requiring the introduction of the concept of antigravity (dark energy) to explain it. We also show that after standardization, Type 1a supernovae cease to be standard candles. We therefore argue that such a standardization is not suitable for measuring the distances to Type 1a supernovae, and hence the accelerating expansion of the Universe is called into question.

**Comment:** Discusses standardization of Type Ia supernova light curves and implications for cosmological distance measurements. While relevant to cosmology, it does not address any of the specified core topics such as near-field cosmology or galaxy simulations.
...
## 29. [Probabilistic Inference of Cosmological Density Parameters from Synthetic Hubble Expansion Data of Varying SNR Using Diverse Artificial Neural Network Architectures](https://arxiv.org/abs/2510.12865) <a id="link29"></a>
...
**Comment:** Uses artificial neural networks to infer cosmological density parameters from synthetic Hubble expansion data. While it involves cosmological parameter estimation, it does not address any of the core topics such as near-field cosmology, galaxy simulations, or star formation histories.
...
## 32. [The Stellar Morphology & Size of X-ray-selected Active Galactic Nuclei Host Galaxies Revealed by JWST](https://arxiv.org/abs/2510.13719) <a id="link32"></a>
...
**Comment:** Investigates the stellar morphology and size-mass relationship of X-ray-selected AGN host galaxies using JWST. The focus is on moderate-luminosity AGN hosts (not dwarfs), galaxy morphology, and merger fractions, but does not address star formation histories, quenching, or near-field cosmology.
...
## 33. [ALMAGAL VIII. Cataloging Hierarchical Mass Structure from Cores to Clumps across the Galactic Disk](https://arxiv.org/abs/2510.12892) <a id="link33"></a>
...
**Comment:** This paper catalogs hierarchical mass structures in dense clumps across the Galactic disk, focusing on high-mass star formation. While it involves numerical simulations and star formation, the focus is on massive star clusters and the Galactic disk, not dwarf galaxies or resolved star formation histories.
...
## 34. [Examining a new form of non-standard dark matter using DESI DR2 data](https://arxiv.org/abs/2510.13436) <a id="link34"></a>
...
**Comment:** This paper examines a non-standard dark matter model using cosmological datasets. While it is about dark matter, the focus is on cosmological parameters and not on galaxy-scale dark matter, dwarf galaxies, or near-field cosmology.
...
## 36. [Strong Progenitor Age-bias in Supernova Cosmology. II. Alignment with DESI BAO and Signs of a Non-Accelerating Universe](https://arxiv.org/abs/2510.13121) <a id="link36"></a>
...
**Comment:** Addresses systematic bias in supernova cosmology due to progenitor age, with implications for cosmological models. No direct connection to near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 37. [First Demonstration of Kernel Phase Interferometry on JWST/MIRI: Prospects for Future Planet Searches Around Post Main Sequence Stars](https://arxiv.org/abs/2510.13064) <a id="link37"></a>
...
**Comment:** Demonstrates kernel phase interferometry on JWST/MIRI for planet searches around post-main-sequence stars. The focus is on exoplanet detection techniques and white dwarfs, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 38. [A New Method for Aperture Masking Interferometric Imaging: Demonstration with the JWST](https://arxiv.org/abs/2510.13502) <a id="link38"></a>
...
**Comment:** Presents a new method for aperture masking interferometric imaging, demonstrated with JWST. The focus is on imaging techniques and instrument calibration, not on galaxy evolution, star formation histories, or near-field cosmology.
...
## 39. [Dynamics and Observational Signatures of Core-Collapse Supernovae with Central Engines: Hydrodynamics Simulations with Monte Carlo Post-Processing](https://arxiv.org/abs/2510.13741) <a id="link39"></a>
...
**Comment:** Hydrodynamics simulations of core-collapse supernovae with central engines, focusing on transient phenomena and supernova light curves. Does not address galaxy-scale simulations, star formation histories, or outflows relevant to the criteria.
...
## 41. [Eccentric Disks With Self-Gravity](https://arxiv.org/abs/2510.12871) <a id="link41"></a>
...
**Comment:** This paper studies the dynamics of eccentric disks with self-gravity, focusing on the conditions for eccentricity in pressureless disks. While it presents new theoretical insights into disk dynamics, it does not address galaxy simulations or any of the core topics.
...
## 42. [Relativistic reflection within an extended hot plasma geometry](https://arxiv.org/abs/2510.13337) <a id="link42"></a>
...
**Comment:** Develops a new relativistic reflection model for X-ray spectra in AGN accretion disks. The focus is on black hole corona geometry and X-ray reflection, not on galaxy simulations, dwarf galaxies, or star formation histories.
...
## 43. [Gravitational-Wave Signatures of Highly Eccentric Stellar-Mass Binary Black Holes in Galactic Nuclei](https://arxiv.org/abs/2510.13066) <a id="link43"></a>
...
**Comment:** Studies gravitational-wave signatures of highly eccentric stellar-mass binary black holes in galactic nuclei. While it involves galaxy centers, the focus is on compact object dynamics and gravitational waves, not on galaxy evolution, dwarf galaxies, or star formation.
...
## 44. [Unified Origin of Dirac Neutrino and Asymmetric Dark Matter Masses via a Dirac-Type Leptogenesis](https://arxiv.org/abs/2510.13723) <a id="link44"></a>
...
**Comment:** This paper proposes a unified framework for Dirac neutrino masses, asymmetric dark matter, and baryogenesis. While it touches on dark matter, the focus is on particle physics and cosmology, not on galaxy-scale dark matter or near-field cosmology.
...
## 46. [The Supernova 1987A system and its recent evolution - a review](https://arxiv.org/abs/2510.13629) <a id="link46"></a>
...
**Comment:** A review of Supernova 1987A and its remnant, focusing on the circumstellar medium, dust, and molecules. While it discusses the evolution of a supernova remnant and its interaction with the surrounding medium, it does not address galaxy-scale processes, resolved star formation histories, or near-field cosmology. The focus is on a single supernova system.
...
## 48. [Recent progress on interstellar radionuclides on Earth and the Moon](https://arxiv.org/abs/2510.13486) <a id="link48"></a>
...
**Comment:** Reviews detection of interstellar radionuclides on Earth and the Moon, with implications for nucleosynthesis and ISM dynamics. While it touches on ISM and nucleosynthesis, it does not address galaxy evolution, dwarf galaxies, or other core topics.
...
## 49. [Towards High-Resolution Orbitrap Mass Spectrometry for Next- Generation In-Situ Space Dust Analysis](https://arxiv.org/abs/2510.12903) <a id="link49"></a>
...
**Comment:** This paper presents a new high-resolution mass spectrometer for in-situ space dust analysis, focusing on instrument development and laboratory results. It does not address any of the core topics.
...
## 52. [The Dependency of Bar Formation Timescale on Disk Mass Fraction, Toomre $Q$, and Scale Height](https://arxiv.org/abs/2510.13152) <a id="link52"></a>
...
**Comment:** Examines bar formation in disk galaxies, specifically the timescale dependence on disk properties. The focus on bars and disk galaxies is explicitly listed as irrelevant in the criteria.
...
## 55. [Optimizing Supernova Classification with Interpretable Machine Learning Models](https://arxiv.org/abs/2510.13765) <a id="link55"></a>
...
**Comment:** Presents a machine learning framework for photometric classification of Type Ia supernovae. While supernovae are important for cosmology, the focus is on classification methods and survey efficiency, not on galaxy properties, star formation histories, or near-field cosmology.
...
## 58. [Gravitational-Wave Signatures of Highly Eccentric Stellar Binary Black-Holes in Galactic Nuclei](https://arxiv.org/abs/2510.13074) <a id="link58"></a>
...
**Comment:** Examines gravitational-wave signatures of eccentric binary black holes in galactic nuclei. Focus is on black hole binaries and gravitational waves, not on galaxy evolution, dwarf galaxies, or star formation.
...
## 59. [Investigating double bump air showers with the SKA-Low](https://arxiv.org/abs/2510.13788) <a id="link59"></a>
...
**Comment:** Investigates double bump air showers with SKA-Low, focusing on cosmic ray air shower detection and hadronic interactions. Not related to any of the specified core topics.
...
## 60. [On the maximum compactness of neutron stars](https://arxiv.org/abs/2510.12870) <a id="link60"></a>
...
**Comment:** Addresses the maximum compactness of neutron stars using statistical EOS analysis. The topic is neutron star structure and nuclear physics, not galaxy evolution, star formation, or near-field cosmology.
...
## 61. [Evidence for Neutrino Emission from X-ray Bright Active Galactic Nuclei with IceCube](https://arxiv.org/abs/2510.13403) <a id="link61"></a>
...
**Comment:** Reports evidence for neutrino emission from X-ray bright AGN using IceCube data. The focus is on AGN and neutrino astronomy, not on galaxy evolution, dwarf galaxies, or star formation histories.
...
## 62. [APRIL: Auxiliary Physically-Redundant Information in Loss - A physics-informed framework for parameter estimation with a gravitational-wave case study](https://arxiv.org/abs/2510.13677) <a id="link62"></a>
...
**Comment:** Presents a physics-informed neural network framework for gravitational-wave parameter estimation. The focus is on machine learning for compact binary coalescence, not on galaxy simulations, star formation, or near-field cosmology.
...
## 63. [The 2024 outburst of the neutron star LMXB EXO 0748-676: an investigation of bursts and eclipses with AstroSat](https://arxiv.org/abs/2510.13556) <a id="link63"></a>
...
**Comment:** This paper analyzes X-ray bursts and eclipses in a neutron star LMXB, focusing on burst physics and binary environment. It does not address any of the core topics such as dwarf galaxies, star formation histories, or galaxy simulations.
...
## 65. [Revealing evolution of Dark Energy density from observations](https://arxiv.org/abs/2510.12881) <a id="link65"></a>
...
**Comment:** This paper presents a model-independent reconstruction of dark energy density from supernova observations. It is focused on cosmological parameters and does not address any of the core topics.
...
## 66. [Dependency of the Bar Formation Timescale On The Halo Spin](https://arxiv.org/abs/2510.13153) <a id="link66"></a>
...
**Comment:** Focuses on bar formation in disk galaxies and the influence of dark matter halo spin. Bars and disk structure are explicitly listed as irrelevant in the criteria. No connection to dwarf galaxies, satellite systems, or other core topics.
...
## 67. [The dependence of black hole formation in open clusters on the cluster formation process](https://arxiv.org/abs/2510.13241) <a id="link67"></a>
...
**Comment:** N-body simulations of open cluster evolution and black hole retention. Focus is on star clusters, not galaxies or their satellites. No direct relevance to the core topics.
...
## 68. [Gravity and the Hierarchy Problem](https://arxiv.org/abs/2510.12882) <a id="link68"></a>

**ArXiv ID:** 2510.12882

**Authors:** Thede de Boer, Jisuke Kubo, Manfred Lindner, Markus Reinig

**Abstract:** We propose a mechanism where the dynamical generation of the Planck mass in scale invariant gravity leads to Einstein gravity, successful inflation and an explanation of the hierarchy problem of the Standard Model. We will discuss in detail the scale generation by dynamical symmetry breaking and phenomenological consequences.

**Comment:** This paper discusses the hierarchy problem and scale invariant gravity, which is a fundamental physics topic and not directly related to any of the specified criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 69. [Design of an Imaging Air Cherenkov Telescope array layout with differential programming](https://arxiv.org/abs/2510.13506) <a id="link69"></a>
...
**Comment:** This paper discusses the optimization of Imaging Air Cherenkov Telescope arrays for cosmic-ray observatories. It is focused on instrumentation and array layout, not on galaxy simulations or any of the core topics.
...
## 70. [New Spallation Background Rejection Techniques to Greatly Improve the Solar Neutrino Sensitivity of JUNO](https://arxiv.org/abs/2510.12873) <a id="link70"></a>
...
**Comment:** Discusses new techniques for background rejection in solar neutrino detection at JUNO. The work is focused on neutrino physics and detector backgrounds, not on galaxy properties, star formation, or near-field cosmology.
...
## 71. [XRISM Resolves Relativistic Effects from the Innermost Accretion Disk in Serpens X-1](https://arxiv.org/abs/2510.13739) <a id="link71"></a>
...
**Comment:** XRISM observation of Serpens X-1, a neutron star X-ray binary, focusing on relativistic effects in the accretion disk. The work is on compact object accretion physics, not on galaxy evolution, star formation, or near-field cosmology.
...
## 73. [Old open clusters NGC 188 and M 67 in Gaia DR3](https://arxiv.org/abs/2510.13288) <a id="link73"></a>
...
**Comment:** This paper studies old open clusters NGC 188 and M 67 using Gaia DR3 data. While it discusses cluster properties and mass spectra, open clusters are not dwarf satellite galaxies and do not fit near-field cosmology or resolved star formation history criteria. No direct relevance to the core topics.
...
## 75. [Orbital dynamics and precession in magnetized Kerr spacetime](https://arxiv.org/abs/2510.13569) <a id="link75"></a>
...
**Comment:** This paper analyzes orbital dynamics and precession in magnetized Kerr spacetime, relevant to black hole physics and strong-field dynamics. It does not address galaxy formation, dwarf galaxies, or any of the core topics.
...
## 76. [Improved Absolute Polarization Calibrator for BICEP CMB Polarimeters](https://arxiv.org/abs/2510.13032) <a id="link76"></a>
...
**Comment:** This paper describes an improved absolute polarization calibrator for BICEP CMB polarimeters, relevant to CMB instrumentation and calibration. It does not address any of the core topics.
...
## 77. [Simulation of Time-dependent Karhunen-Loeve Phase Screens: an Ergodic Approach](https://arxiv.org/abs/2510.12861) <a id="link77"></a>
...
**Comment:** This paper presents an ergodic approach to simulating time-dependent Karhunen-Loeve phase screens for ground-based astronomy, focusing on atmospheric turbulence modeling. It does not address galaxy simulations or any of the core topics.
...
## 78. [Impact of facility timing and coordination for next-generation gravitational-wave detectors](https://arxiv.org/abs/2510.11861) <a id="link78"></a>
...
**Comment:** This paper discusses the impact of timing and coordination for next-generation gravitational-wave detectors. It does not address any of the core topics such as galaxy simulations, star formation histories, or near-field cosmology.
...
## 79. [Prospects for the Crossing of Comet 3I/ATLAS's Ion Tail](https://arxiv.org/abs/2510.13222) <a id="link79"></a>
...
**Comment:** This paper discusses the prospects for spacecraft crossing the ion tail of an interstellar comet. It is unrelated to the core topics of galaxy evolution, star formation, or near-field cosmology.
