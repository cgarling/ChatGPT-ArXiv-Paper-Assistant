...
1. [The radial acceleration relation at the EDGE of galaxy formation: testing its universality in low-mass dwarf galaxies](#user-content-link1)
**Authors:** Mariana P. J\'ulio, Justin I. Read, Marcel S. Pawlowski, Pengfei Li, Daniel Vaz, Jarle Brinchmann, Martin P. Rey, Oscar Agertz, Tom Holmes

2. [A Walk on the Retrograde Side (WRS) project. II. Chemistry to disentangle in situ and accreted components in Thamnos](#user-content-link2)
**Authors:** E. Ceccarelli, D. Massari, M. Palla, A. Mucciarelli, M. Bellazzini, A. Helmi

3. [MUSEQuBES: Physical conditions, origins, and multi-element abundances of the circumgalactic medium of an isolated, star-forming dwarf galaxy at z=0.57](#user-content-link3)
**Authors:** Sean D. Johnson, Nishant Mishra, Sowgat Muzahid, Gwen C. Rudie, Fakhri S. Zahedy, Zhijie Qu, Claude-Andr\'e Faucher-Gigu\`ere, Jonathan Stern, Jennifer I-Hsiu Li, Elise Fuller, Sebastiano Cantalupo, Hsiao-Wen Chen, Ahmad Kadri, Suyash Kumar, Zhuoqi Will Liu, Gregory Walth

4. [Ionized gas components in low surface brightness galaxy AGC 111629](#user-content-link4)
...
5. [MEGATRON: The environments of Population III stars at Cosmic Dawn and their connection to present day galaxies](#user-content-link5)
...
6. [Asymmetries in stellar streams induced by a galactic merger](#user-content-link6)
...
7. [Machine Learning Techniques to Distinguish Giant Stars from Dwarf Stars Using Only Photometry -- Pushing Redwards](#user-content-link7)
**Authors:** Keyi Ding, Carrie Filion, Rosemary F. G. Wyse, Evan N. Kirby, Itsuki Ogami, Masashi Chiba, Yutaka Komiyama, L\'aszl\'o Dobos, Alexander S. Szalay

8. [Ensemble seismic study of the properties of the core of Red Clump stars](#user-content-link8)
**Authors:** Anthony Noll, Sarbani Basu, Saskia Hekker

9. [Understanding an origin of palladium in metal-poor stars based on the non-LTE analysis of Pd~I lines](#user-content-link9)
**Authors:** L. Mashonkina, A. Smogorzhevskii

10. [Modeling gravitational wave sources in the MillenniumTNG simulations](#user-content-link10)
...
11. [A chemodynamical study of $r$-process-enhanced stars](#user-content-link11)
**Authors:** Pallavi Saraf (PRL), Thirupathi Sivarani, Carlos Allende Prieto, Shashikiran Ganesh, Drisya Karinkuzhi

12. [MEGATRON: Disentangling Physical Processes and Observational Bias in the Multi-Phase ISM of High-Redshift Galaxies](#user-content-link12)
...
13. [The rise and fall of Little Red Dots could be driven by the environment](#user-content-link13)
**Authors:** Rosa M. M\'erida, Gaia Gaspar, Yoshihisa Asada, Marcin Sawicki, Kiyoaki Christopher Omori, Chris J. Willott, Nicholas S. Martis, Adam Muzzin, Ga\"el Noirot, Gregor Rihtar\v{s}i\v{c}, Ghassan T. E. Sarrouh, Roberta Tripodi

14. [The Star-forming Main Sequence and Bursty Star-formation Histories at $z>1.4$ in JADES and AURORA](#user-content-link14)
...
15. [Benchmarking AI-evolved cosmological structure formation](#user-content-link15)
**Authors:** Xiaofeng Dong, Nesar Ramachandra, Salman Habib, Katrin Heitmann

16. [Simulations of Globular Cluster Evolution with Multiple Stellar Populations](#user-content-link16)
**Authors:** Mirek Giersz, Abbas Askar, Arkadiusz Hypki, Jongsuk Hong, Grzegorz Wiktorowicz, Lucas Hellstrom

17. [Beyond the stars: Linking H$\alpha$ sizes, kinematics, and star formation in galaxies at $z\approx 4-6$ with JWST grism surveys and $\texttt{geko}$](#user-content-link17)
...
18. [A Deep Look into the Intermediate-Age Open Cluster NGC 2506: What Binary Systems Reveal About Cluster Distance and Age](#user-content-link18)
**Authors:** K. Yakut, B. Kalomeni, S. Rappaport, Veselin Kostov

19. [The cosmic web's Lyman-$\alpha$ glow at $z \approx 2.5$; varying hydrodynamic models, dust, and wide-field, narrow-band imaging detection](#user-content-link19)
**Authors:** Oleksii Sokoliuk, John K. Webb, Kenneth M. Lanzetta, Michael M. Shara, Stefan Gromoll, James S. Bolton, Robert F. Carswell, Gaspar Galaz, C\'edric Ledoux, Gaspare Lo Curto, Alain Smette, David Valls-Gabaud, Anja von der Linden, Frederick M. Walter, Joris Witstok

20. [Beyond diagnostic-diagrams: A critical exploration on the classification of ionization processes](#user-content-link20)
**Authors:** S. F. S\'anchez, C. Mu\~noz-Tu\~n\'on, J. S\'anchez Almeida, O. Gonz\'alez-Mart\'in, E. P\'erez

21. [3D B-fieLds in the InterStellar medium and Star-forming regions (3D-BLISS): I. Using Starlight Polarization in Massive IRDC Filament G11.11-0.12](#user-content-link21)
**Authors:** Bao Truong, Thiem Hoang, Nguyen Bich Ngoc, Nguyen Chau Giang, Le Ngoc Tram, Ngan Le

22. [Low-noise Fourier Transform Spectroscopy Enabled by Superconducting On-Chip Filterbank Spectrometers](#user-content-link22)
**Authors:** Chris S. Benson, Peter S. Barry, Patrick Ashworth, Harry Gordon-Moys, Kirit S. Karkare, Izaak Morris, Gethin Robson

23. [Probing evolution of Long GRB properties through their cosmic formation history aided by Machine Learning predicted redshifts](#user-content-link23)
**Authors:** Dhruv S. Bal, Aditya Narendra, Maria Giovanna Dainotti, Nikita S. Khatiya, Aleksander L. Lenart, Dieter H. Hartmann

24. [Confirming Near- to Mid-IR Photometrically-Identified Obscured AGNs in the JWST era](#user-content-link24)
...
25. [Formation of A Nuclear Star Cluster Through A Merger Event In The Low Surface Brightness Galaxy AGC 223218](#user-content-link25)
...
26. [New ultralight scalar particles and the mass-radius relation of white dwarfs -- the important role of Sirius B](#user-content-link26)
**Authors:** Kai Bartnick, Detlev Koester, Rolf-Peter Kudritzki, Konstantin Springmann, Stefan Stelzl, Andreas Weiler

27. [Probing the cosmological 21~cm global signal from the Antarctic ice sheet](#user-content-link27)
...
28. [CURLING -- II. Improvement on the $H_{0}$ Inference from Pixelized Cluster Strong Lens Modeling](#user-content-link28)
...
29. [AppleCiDEr II: SpectraNet -- A Deep Learning Network for Spectroscopic Data](#user-content-link29)
**Authors:** Maojie Xu (Department of Computer Science & Engineering, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Argyro Sasli (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Alexandra Junell (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Felipe Fontinele Nunes (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Yu-Jing Qin (Division of Physics, Mathematics and Astronomy, California Institute of Technology, Pasadena, CA, USA), Christoffer Fremling (Caltech Optical Observatories, California Institute of Technology, Pasadena, CA, USA, Division of Physics, Mathematics and Astronomy, California Institute of Technology, Pasadena, CA, USA), Sam Rose (Cahill Center for Astrophysics, California Institute of Technology, Pasadena, CA, USA), Theophile Jegou Du Laz (Division of Physics, Mathematics and Astronomy, California Institute of Technology, Pasadena, CA, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Benny Border (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Antoine Le Calloch (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Sushant Sharma Chaudhary (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Hailey Markoff (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Avyukt Raghuvanshi (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Nabeel Rehemtulla (Department of Physics and Astronomy, Northwestern University, Evanston, IL, USA, Center for Interdisciplinary Exploration and Research in Astrophysics, NSF-Simons AI Institute for the Sky), Jesper Sollerman (Department of Astronomy, Stockholm University, Stockholm, Sweden), Yashvi Sharma (Caltech Optical Observatories, California Institute of Technology, Pasadena, CA, USA), Niharika Sravan (Department of Physics, Drexel University, Philadelphia, PA, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Judy Adler (IPAC, California Institute of Technology, Pasadena, CA, USA), Tracy X. Chen (IPAC, California Institute of Technology, Pasadena, CA, USA), Richard Dekany (Caltech Optical Observatories, California Institute of Technology, Pasadena, CA), Reed Riddle (Caltech Optical Observatories, California Institute of Technology, Pasadena, CA, USA), Mansi M. Kasliwal (Division of Physics, Mathematics, and Astronomy, California Institute of Technology, Pasadena, CA, USA), Matthew J. Graham (Cahill Center for Astrophysics, California Institute of Technology, Pasadena, CA, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery), Michael W. Coughlin (School of Physics and Astronomy, University of Minnesota, Minneapolis, MN, USA, NSF Institute on Accelerated AI Algorithms for Data-Driven Discovery)

30. [Comparing XRISM cluster velocity dispersions with predictions from cosmological simulations: are feedback models too ejective?](#user-content-link30)
...
31. [A Giant Peanut-shaped Ultra-High-Energy Gamma-Ray Emitter Off the Galactic Plane](#user-content-link31)
**Authors:** Zhen Cao, Felix Aharonian, Yunxiang Bai, Yiwei Bao, Denis Bastieri, Xiaojun Bi, YuJiang Bi, Mr Bian WenYi, A. Butkevich, Chengmiao Cai, Wenyu Cao, Zhe Cao, Jin Chang, Jinfan Chang, Mr Aming Chen, Ensheng Chen, Mr Guo-Hai Chen, Mr Huaxi Chen, Liang Chen, Long Chen, Mingjun Chen, Mali Chen, Qihui Chen, Shi Chen, Suhong Chen, Songzhan Chen, Tianlu Chen, Xiaobin Chen, Xuejian Chen, Yang Chen, Ning Cheng, Yaodong Cheng, Ming Chung Chu, Mingyang Cui, Shuwang Cui, Xiaohong Cui, Yidong Cui, Benzhong Dai, Hongliang Dai, Z. G. Dai, Danzengluobu ., Yangxuan Diao, Xuqiang Dong, Kaikai Duan, Junhui Fan, Yi-Zhong Fan, Jun Fang, Jianhua Fang, Kun Fang, Cunfeng Feng, Hua Feng, Li Feng, Shaohui Feng, Xiaoting Feng, Yi Feng, Youliang Feng, Stefano Gabici, Bo Gao, Chuandong Gao, Qi Gao, Wei Gao, Weikang Gao, Maomao Ge, Ting-Ting Ge, Lisi Geng, Gwenael Giacinti, Guanghua Gong, Quanbu Gou, Minhao Gu, Fulai Guo, Jing Guo, Xiaolei Guo, Yiqing Guo, Yingying Guo, Yiang Han, Otto A. Hannuksela, Mariam Hasan, Huihai He, Hao-Ning He, Jiayin He, Xinyu He, Yu He, Sergio Hern\'andez-Cadena, Bowen Hou, Chao Hou, Xian Hou, Hongbo Hu, Shicong Hu, Chen Huang, Daihui Huang, Jiajun Huang, Tian-Qi Huang, Wenjun Huang, Xingtao Huang, Xiaoyuan Huang, Yong Huang, Yi-Yun Huang, Xiaolu Ji, Huanyu Jia, Kang Jia, Houbing Jiang, Kun Jiang, Xiaowei Jiang, Zejun Jiang, Min Jin, Samy Kaci, Mingming Kang, Ivan Karpikov, Dmitry Khangulyan, Denis Kuleshov, Kirill Kurinov, Bingbing Li, Cheng Li, Mr Cong Li, Dan Li, Fei Li, Haibo Li, Huicai Li, Jian Li, Jie Li, Kai Li, Long Li, Rong-Lan Li, Sidai Li, Tianyang Li, Wenlian Li, Xiurong Li, Xin Li, Yizhuo Li, Yuan Li, Zhe Li, Zhuo Li, Enwei Liang, Yunfeng Liang, Su-Jie Lin, Bing Liu, Cheng Liu, Dong Liu, Dangbo Liu, Hu Liu, Haidong Liu, Jia Liu, Jiali Liu, Jiren Liu, Maoyuan Liu, Ruo-Yu Liu, Siming Liu, Wei Liu, Xi Liu, Mr Yi Liu, Yu Liu, Yinong Liu, Yu-Qing Lou, Qing Luo, Yu Luo, Hongkui Lv, Bo-Qiang Ma, Lingling Ma, Xinhua Ma, Jirong Mao, Zhen Min, Warit Mitthumsiri, Guobin Mou, Huijun Mu, Andrii Neronov, Kenny Chun Yu Ng, Mingyang Ni, Lin Nie, Mr Lejian Ou, Petchara Pattarakijw anich, Zhiyuan Pei, Jincan Qi, Mengyao Qi, Jiajun Qin, Ali Raza, Chongyang Ren, David Ruffolo, Alejandro S\'aiz, Dmitri Semikoz, Lang Shao, Oleg Shchegolev, Yunzhi Shen, Xiangdong Sheng, Zhaodong Shi, Fuwen Shu, Huichao Song, Vladimir Stepanov Stepanov, Yang Su, Dongxu Sun, Hao Sun, Qinning Sun, Xiaona Sun, Zhibin Sun, Mr Nabeel Tabasam, Jumpei Takata, P. H. T. Tam, Honbin Tan, Qingwen Tang, Ruiyi Tang, Zebo Tang, Wenwu Tian, Chaonan Tong, Li-Hong Wan, Chao Wang, Guangwei Wang, Hongguang Wang, Jiancheng Wang, Ke Wang, Kai Wang, Kai Wang, Liping Wang, Lingyu Wang, Luyao Wang, Ran Wang, Wei Wang, Xianggao Wang, Xinjian Wang, Xiang-Yu Wang, Yang Wang, Yudong Wang, Zhonghai Wang, Zhongxiang Wang, Zheng Wang, Daming Wei, Jun-Jie Wei, Yongjian Wei, Tao Wen, Shan-Shan Weng, Chaoyong Wu, Hanrong Wu, Qingwen Wu, Sha Wu, Xue-Feng Wu, Yusheng Wu, Shaoqiang Xi, Jie Xia, Junji Xia, Guangman Xiang, Dixuan Xiao, Gang Xiao, Yuliang Xin, Yi Xing, Dingrong Xiong, Zheng Xiong, Donglian Xu, Renfeng Xu, Renxin Xu, Weili Xu, Liang Xue, Dahai Yan, Tian Yan, Chaowen Yang, Chuyuan Yang, Fengfan Yang, Lili Yang, Mingjie Yang, Ruizhi Yang, Ms Wen-xin Yang, Zihan Yang, Zhiguo Yao, Xuanang Ye, Liqiao Yin, Na Yin, Xiaohao You, Zhiyong You, Qiang Yuan, Hua Yue, Houdun Zeng, Tingxuan Zeng, Wei Zeng, Xiangtao Zeng, Min Zha, Binbin Zhang, Bing Zhang, Chao Zhang, Feng Zhang, Hongfei Zhang, Haiming Zhang, Hengying Zhang, Jianli Zhang, Li Zhang, Pengfei Zhang, Peipei Zhang, Rui Zhang, Shaoru Zhang, Shoushan Zhang, Weiyan Zhang, Xiao Zhang, Xiaopeng Zhang, Yi Zhang, Yong Zhang, Zhipeng Zhang, Jing Zhao, Lei Zhao, Lizhi Zhao, Shiping Zhao, Xiao-Hong Zhao, Zihao Zhao, Fu Zheng, Wenjuan Zhong, Bin Zhou, Hao Zhou, Jianeng Zhou, Meng Zhou, Ping Zhou, Rong Zhou, Xiaoxi Zhou, Xunxiu Zhou, Ben-Yang Zhu, Chengguang Zhu, Fengrong Zhu, Hui Zhu, Kejun Zhu, Yuan-chuan Zou, Xiong Zuo, Oscar Macias

32. [Polka-dotted Stars II: Starspots and obliquities of Kepler-17 and Kepler-63](#user-content-link32)
**Authors:** Sabina Sagynbayeva, Will M. Farr

33. [Evidence of violation of Case B recombination in Little Red Dots](#user-content-link33)
**Authors:** G. P. Nikopoulos, D. Watson, A. Sneppen, V. Rusakov, K. E. Heintz, J. Witstok, G. Brammer

34. [When vacuum breaks: a self-consistency test for astrophysical environments in extreme mass ratio inspirals](#user-content-link34)
**Authors:** Lorenzo Copparoni, Rohit S. Chandramouli, Enrico Barausse

35. [The formation of Gaia BH3](#user-content-link35)
**Authors:** Daniel Mar\'in Pina, Mark Gieles, Sara Rastello, Giuliano Iorio

36. [Measurement of the $^{35}Cl(n, p)^{35}S$ cross-section at the CERN n\_TOF facility from subthermal energy to 120 keV](#user-content-link36)
**Authors:** Marco Antonio Mart\'inez-Ca\~nadas (The n_TOF Collaboration), Pablo Torres-S\'anchez (The n_TOF Collaboration), Javier Praena (The n_TOF Collaboration), Ignacio Porras (The n_TOF Collaboration), Marta Sabat\'e-Gilarte (The n_TOF Collaboration), Oliver Aberle (The n_TOF Collaboration), Victor Alcayne (The n_TOF Collaboration), Simone Amaducci (The n_TOF Collaboration), J\'ozef Andrzejewski (The n_TOF Collaboration), Laurent Audouin (The n_TOF Collaboration), Vicente B\'ecares (The n_TOF Collaboration), Victor Babiano-Suarez (The n_TOF Collaboration), Michael Bacak (The n_TOF Collaboration), Massimo Barbagallo (The n_TOF Collaboration), Franti\v{s}ek Be\v{c}v\'a\v{r} (The n_TOF Collaboration), Giorgio Bellia (The n_TOF Collaboration), Eric Berthoumieux (The n_TOF Collaboration), Jon Billowes (The n_TOF Collaboration), Damir Bosnar (The n_TOF Collaboration), Adam Brown (The n_TOF Collaboration), Maurizio Busso (The n_TOF Collaboration), Manuel Caama\~no (The n_TOF Collaboration), Luis Caballero (The n_TOF Collaboration), Francisco Calvi\~no (The n_TOF Collaboration), Marco Calviani (The n_TOF Collaboration), Daniel Cano-Ott (The n_TOF Collaboration), Adria Casanovas (The n_TOF Collaboration), Francesco Cerutti (The n_TOF Collaboration), Yonghao Chen (The n_TOF Collaboration), Enrico Chiaveri (The n_TOF Collaboration), Nicola Colonna (The n_TOF Collaboration), Guillem Cort\'es (The n_TOF Collaboration), Miguel Cort\'es-Giraldo (The n_TOF Collaboration), Luigi Cosentino (The n_TOF Collaboration), Sergio Cristallo (The n_TOF Collaboration), Lucia-Anna Damone (The n_TOF Collaboration), Maria Diakaki (The n_TOF Collaboration), Mirco Dietz (The n_TOF Collaboration), C\'esar Domingo-Pardo (The n_TOF Collaboration), Rugard Dressler (The n_TOF Collaboration), Emmeric Dupont (The n_TOF Collaboration), Ignacio Dur\'an (The n_TOF Collaboration), Zinovia Eleme (The n_TOF Collaboration), Beatriz Fern\'andez-Dom\'inguez (The n_TOF Collaboration), Alfredo Ferrari (The n_TOF Collaboration), Francisco Javier Ferrer (The n_TOF Collaboration), Paolo Finocchiaro (The n_TOF Collaboration), Valter Furman (The n_TOF Collaboration), Kathrin G\"obel (The n_TOF Collaboration), Ruchi Garg (The n_TOF Collaboration), Aleksandra Gawlik-Rami\k{e}ga (The n_TOF Collaboration), Benoit Geslot (The n_TOF Collaboration), Simone Gilardoni (The n_TOF Collaboration), Tudor Glodariu (The n_TOF Collaboration), Isabel Gon\c{c}alves (The n_TOF Collaboration), Enrique Gonz\'alez-Romero (The n_TOF Collaboration), Carlos Guerrero (The n_TOF Collaboration), Frank Gunsing (The n_TOF Collaboration), Hideo Harada (The n_TOF Collaboration), Stephan Heinitz (The n_TOF Collaboration), Jan Heyse (The n_TOF Collaboration), David Jenkins (The n_TOF Collaboration), Erwin Jericha (The n_TOF Collaboration), Franz K\"appeler (The n_TOF Collaboration), Yacine Kadi (The n_TOF Collaboration), Atsushi Kimura (The n_TOF Collaboration), Niko Kivel (The n_TOF Collaboration), Michael Kokkoris (The n_TOF Collaboration), Yury Kopatch (The n_TOF Collaboration), Milan Krti\v{c}ka (The n_TOF Collaboration), Deniz Kurtulgil (The n_TOF Collaboration), Ion Ladarescu (The n_TOF Collaboration), Claudia Lederer-Woods (The n_TOF Collaboration), Helmut Leeb (The n_TOF Collaboration), Jorge Lerendegui-Marco (The n_TOF Collaboration), Sergio Lo Meo (The n_TOF Collaboration), Sarah-Jane Lonsdale (The n_TOF Collaboration), Daniela Macina (The n_TOF Collaboration), Alice Manna (The n_TOF Collaboration), Trinitario Mart\'inez (The n_TOF Collaboration), Alessandro Masi (The n_TOF Collaboration), Cristian Massimi (The n_TOF Collaboration), Pierfrancesco Mastinu (The n_TOF Collaboration), Mario Mastromarco (The n_TOF Collaboration), Francesca Matteucci (The n_TOF Collaboration), Emilio-Andrea Maugeri (The n_TOF Collaboration), Annamaria Mazzone (The n_TOF Collaboration), Emilio Mendoza (The n_TOF Collaboration), Alberto Mengoni (The n_TOF Collaboration), Veatriki Michalopoulou (The n_TOF Collaboration), Paolo Maria Milazzo (The n_TOF Collaboration), Federica Mingrone (The n_TOF Collaboration), Agatino Musumarra (The n_TOF Collaboration), Alexandru Negret (The n_TOF Collaboration), Ralf Nolte (The n_TOF Collaboration), Francisco Og\'allar (The n_TOF Collaboration), Andreea Oprea (The n_TOF Collaboration), Nikolas Patronis (The n_TOF Collaboration), Andreas Pavlik (The n_TOF Collaboration), Jaros{\l}aw Perkowski (The n_TOF Collaboration), Luciano Persanti (The n_TOF Collaboration), Jos\'e-Manuel Quesada (The n_TOF Collaboration), D\'esir\'ee Radeck (The n_TOF Collaboration), Diego Ramos-Doval (The n_TOF Collaboration), Thomas Rauscher (The n_TOF Collaboration), Ren\'e Reifarth (The n_TOF Collaboration), Dimitri Rochman (The n_TOF Collaboration), Carlo Rubbia (The n_TOF Collaboration), Alok Saxena (The n_TOF Collaboration), Peter Schillebeeckx (The n_TOF Collaboration), Dorothea Schumann (The n_TOF Collaboration), Gavin Smith (The n_TOF Collaboration), Nikolay Sosnin (The n_TOF Collaboration), Athanasios Stamatopoulos (The n_TOF Collaboration), Giuseppe Tagliente (The n_TOF Collaboration), Jos\'e Tain (The n_TOF Collaboration), Zeynep Talip (The n_TOF Collaboration), Ariel Tarife\~no-Saldivia (The n_TOF Collaboration), Laurent Tassan-Got (The n_TOF Collaboration), Andrea Tsinganis (The n_TOF Collaboration), Jiri Ulrich (The n_TOF Collaboration), Sebastian Urlass (The n_TOF Collaboration), Stanislav Valenta (The n_TOF Collaboration), Gianni Vannini (The n_TOF Collaboration), Vincenzo Variale (The n_TOF Collaboration), Pedro Vaz (The n_TOF Collaboration), Alberto Ventura (The n_TOF Collaboration), Vasilis Vlachoudis (The n_TOF Collaboration), Rosa Vlastou (The n_TOF Collaboration), Anton Wallner (The n_TOF Collaboration), Philip John Woods (The n_TOF Collaboration), Tobias Wright (The n_TOF Collaboration), Petar \v{Z}ugec (The n_TOF Collaboration)

37. [Disk fraction among free-floating planetary-mass objects in Upper Scorpius](#user-content-link37)
**Authors:** Tommy Rodrigues, Herv\'e Bouy, Sean N. Raymond, Eduardo L. Mart\'in, Emmanuel Bertin, Javier Olivares, David Barrado, N\'uria Hu\'elamo, Motohide Tamura, N\'uria Miret Roig, Phillip A. B. Galli, Jean-Charles Cuillandre

38. [Magnetic Helicity, Magnetic Monopoles, and Higgs Winding](#user-content-link38)
**Authors:** Hajime Fukuda, Yuta Hamada, Kohei Kamada, Kyohei Mukaida, Fumio Uchida

39. [Preferential Accretion onto the Secondary Black Hole Strengthens Gravitational Wave Signals](#user-content-link39)
**Authors:** Julia M. Comerford, Joseph Simon

40. [Textual interpretation of transient image classifications from large language models](#user-content-link40)
**Authors:** Fiorenzo Stoppa, Turan Bulmus, Steven Bloemen, Stephen J. Smartt, Paul J. Groot, Paul Vreeswijk, Ken W. Smith

41. [Fomalhaut's debris disc is not dominated by primordial Plutos](#user-content-link41)
**Authors:** Tim D. Pearce, Torsten L\"ohne, Alexander V. Krivov

42. [A Comoving Framework for Planet Migration](#user-content-link42)
**Authors:** Ximena S. Ramos, Pablo Benitez-Llambay

43. [RFSoC receiver calibration system for 21-cm global spectrum experiments from space: The CosmoCube case](#user-content-link43)
**Authors:** Jiacong Zhu, Eloy de Lera Acedo, Kaan Artuc, Xuelei Chen

44. [Classification of $g$-modes for neutron stars with a strong transition: Novel universal relation including slow stable twin stars](#user-content-link44)
**Authors:** M. C. Rodriguez, Jos\'e C. Jim\'enez, Ignacio F. Ranea-Sandoval

45. [Archival Inference for Eccentric Stellar-Mass Binary Black Holes in Space-Based Gravitational Wave Observations](#user-content-link45)
**Authors:** Han Wang, Michael J. Williams, Ian Harry, Yi-Ming Hu

46. [Are all Binary Black Holes Detected from LIGO-Virgo-KAGRA Follow the Universal Time-Delay Distributions? Likely Not](#user-content-link46)
**Authors:** Samsuzzaman Afroz, Navdha, Suvodip Mukherjee

47. [Diffuse continuum emission and large extended sources at MeV energies](#user-content-link47)
**Authors:** Markus Ackermann, Denys Malyshev, Dmitry V. Malyshev

48. [Radiation magnetohydrodynamics modeling of an impulsively driven chromospheric jet in the solar atmosphere](#user-content-link48)
**Authors:** J. J. Gonz\'alez-Avil\'es

49. [Hard X-ray view of two $\gamma$-ray detected low-luminosity active galactic nuclei: NGC 315 and NGC 4261](#user-content-link49)
**Authors:** Yuwei Yu, Jin Zhang

50. [Prolonged fallback and late-time rebrightening episodes in stellar tidal disruptions as imprints of a galactic environment](#user-content-link50)
**Authors:** Cedric O\~na, Sean Fortuna, Ian Vega

51. [A Sample of HeII {\lambda}4686 "Changing-Look" Quasars](#user-content-link51)
**Authors:** Wentao Lu, Jun-Xian Wang

52. [Unlocking AGN Variability with Custom ZTF Photometry for High-Fidelity Light Curves and Robust Selection](#user-content-link52)
**Authors:** P. Ar\'evalo (U. de Valpara\'iso, Chile), P. S\'anchez-S\'aez (ESO, Garching), B. Sotomayor (ESO, Garching), P. Lira (U. de Chile), F. E. Bauer (U. de Tarapac\'a, Chile), S. R\'ios (U. de Chile)

53. [Primordial Black Holes and their Mass Spectra: The Effects of Mergers and Accretion within Stasis Cosmologies](#user-content-link53)
**Authors:** Keith R. Dienes, Lucien Heurtier, Fei Huang, Tim M. P. Tait, Brooks Thomas

54. [Identifying the secondary jet in the RadioAstron image of OJ~287](#user-content-link54)
...
55. [JWST observations of photodissociation regions: II. Warm molecular Hydrogen spectroscopy in the Horsehead nebula](#user-content-link55)
...
56. [Warm absorber outflows in radio-loud active galactic nucleus 3C~59](#user-content-link56)
...
57. [Diagnosing the Properties and Evolutionary Fates of Black Hole and Wolf-Rayet X-ray Binaries as Potential Gravitational Wave Sources for the LIGO-Virgo-KAGRA Network](#user-content-link57)
...
58. [The first proper motion measurement of the acceleration regions in the large-scale jets of SS 433 powering the W50 nebula](#user-content-link58)
...
59. [CCAT: Readout of over 10,000 280 GHz KIDs in Mod-Cam using RFSoC Electronics](#user-content-link59)
**Authors:** Darshan A. Patel (Matt), Yuhan Wang (Matt), Cody J. Duell (Matt), Jason E. Austermann (Matt), James Beall (Matt), James R. Burgoyne (Matt), Scott Chapman (Matt), Steve K. Choi (Matt), Rodrigo G. Freundt (Matt), Eliza Gazda (Matt), Christopher Groppi (Matt), Zachary B. Huber (Matt), Johannes Hubmayr (Matt), Ben Keller (Matt), Lawerence T. Lin (Matt), Philip Mauskopf (Matt), Alicia Middleton (Matt), Michael D. Niemack (Matt), Cody Roberson (Matt), Adrian K. Sinclair (Matt), Ema Smith (Matt), Jeff van Lanen (Matt), Anna Vaskuri (Matt), Benjamin J. Vaughan (Matt), Eve M. Vavagiakis (Matt), Michael Vissers (Matt), Samantha Walker (Matt), Jordan Wheeler (Matt), Ruixuan (Matt), Xie

60. [GW231123: extreme spins or microglitches?](#user-content-link60)
**Authors:** Anarya Ray, Sharan Banagiri, Eric Thrane

61. [Machine Learning for Radial Velocity Analysis I: Vision Transformers as a Robust Alternative for Detecting Planetary Candidates](#user-content-link61)
**Authors:** Anoop Gavankar, Tanish Mittal, Joe Ninan, Shravan Hanasoge

62. [Revealing the Temporally Stable Bimodal Energy Distribution of FRB 20121102A with a Tripled Burst Set from AI Detections](#user-content-link62)
...
63. [Recasting the nature of INTEGRAL hard X-ray transients previously classified as active galactic nuclei](#user-content-link63)
**Authors:** V. Sguera, L. Sidoli

64. [High-energy variability of the gravitationally lensed blazar PKS 1830-211](#user-content-link64)
**Authors:** Sarah M. Wagner, Jeffrey D. Scargle, Greg Madejski, Andrea Gokus, Krzysztof Nalewajko, Patrick G\"unther, Karl Mannheim

65. [A comprehensive look into the accuracy of SpEC binary black hole waveforms](#user-content-link65)
**Authors:** Taylor Knapp, Katerina Chatziioannou, Keefe Mitman, Mark A. Scheel, Michael Boyle, Lawrence E. Kidder, Harald Pfeiffer

66. [In-flight performance of the IXPE telescopes](#user-content-link66)
**Authors:** Riccardo Ferrazzoli, Enrico Costa, Sergio Fabiani, Philip Kaaret, Stephen L. O'Dell, Brian D. Ramsey, Paolo Soffitta, Luca Baldini, Ronaldo Bellazzini, Alessandro Di Marco, Fabio La Monaca, Luca Latronico, Alberto Manfreda, Fabio Muleri, John Rankin, Carmelo Sgr\`o, Stefano Silvestri, Martin C. Weisskopf

67. [Phase-resolved optical spectroscopy of the rapidly varying white dwarf ZTF 1851+1714](#user-content-link67)
**Authors:** C. C. Pedersen, M. R. M. Knudsen, K. Valeckas, L. Izzo, T. M. Tauris, J. P. U. Fynbo

68. [Spectropolarimetry of NGC 1275 reveals a narrow-line radio galaxy with polarization parallel to its radio jet axis](#user-content-link68)
**Authors:** F. Marin, T. Pursimo, I. Liodakis, E. Lindfors, J. Biedermann, D. Hutsem\'ekers, M. Turkki

69. [Is the high-energy environment of K2-18b special?](#user-content-link69)
**Authors:** S. Rukdee, M. G\"udel, I. Vilovi\'c, K. Poppenh\"ager, S. Boro Saikia, J. Buchner, B. Stelzer, G. Roccetti, J. V. Seidel, V. Burwitz

70. [1FLAT: a Firmamento-based catalog of AGN in Fermi-LAT high Galactic latitude {\gamma}-ray sources](#user-content-link70)
**Authors:** P. Giommi, M. Doro, M. Gouv\^ea, L. Fronte, F. Metruccio, F. Arneodo, U. Barres de Almeida, S. Di Pippo, T. Kerscher, A. Macci\'o, B. Mazzon, M. Morrone, E. Prandini, A. Rodr\'iguez, A. Ruina, N. Sahakyan, L. Silveri, D. Tripathi

71. [Rolling with modular symmetry: quintessence and de Sitter in heterotic orbifolds](#user-content-link71)
**Authors:** Hansel Gordillo-Ruiz, Miguel Hernandez-Segura, Ignacio Portillo-Castillo, Saul Ramos-Sanchez, Ivonne Zavala

72. [Vision Transformer for Transient Noise Classification](#user-content-link72)
**Authors:** Divyansh Srivastava, Andrzej Niedzielski

73. [A Review of 10 Years of ProtoSpace: Spacecraft CAD Visualization in Collaborative Augmented Reality](#user-content-link73)
**Authors:** Benjamin Nuernberger, Samuel-Hunter Berndt, Robert Tapella, Laura Mann, Aaron Plave, Sasha Samochina, Victor X. Luo

74. [Testing new-physics scenarios with the combined LHAASO and Carpet-3 fluence spectrum of GRB 221009A: axion-like particles and Lorentz-invariance violation](#user-content-link74)
**Authors:** P. S. Satunin, S. V. Troitsky

75. [Unified Dark Matter and Dark Energy in a model of Non-Canonical Scalar-Tensor Theory](#user-content-link75)
**Authors:** Nihal Jalal Pullisseri, Sanil Unnikrishnan

76. [Influence of Solar Sails on Magnetic Field Measurements in Space Plasmas](#user-content-link76)
**Authors:** Konstantinos Horaites, Juan V. Rodriguez, Ying Liu

77. [Dual perspectives on GX 17+2: a simultaneous NICER and NuSTAR study](#user-content-link77)
**Authors:** Malu Sudha, Renee M. Ludlam, Jeroen Homan, Dacheng Lin, Benjamin Coughenour, Edward M. Cackett

---

## 1. [The radial acceleration relation at the EDGE of galaxy formation: testing its universality in low-mass dwarf galaxies](https://arxiv.org/abs/2510.06905) <a id="link1"></a>
...
**Comment:** Directly addresses the radial acceleration relation (RAR) in low-mass dwarf galaxies, using both observations and simulations. This is highly relevant to near-field cosmology, dark matter density profiles, and the abundance of dwarf galaxies. Also includes analysis of simulated galaxies.
...
## 2. [A Walk on the Retrograde Side (WRS) project. II. Chemistry to disentangle in situ and accreted components in Thamnos](https://arxiv.org/abs/2510.06332) <a id="link2"></a>
...
**Comment:** High-resolution chemical analysis of the Thamnos substructure in the Milky Way, comparing in situ and accreted components. Directly relevant to near-field cosmology, as it investigates accreted stellar halo substructure and the merger history of the Milky Way.
...
## 3. [MUSEQuBES: Physical conditions, origins, and multi-element abundances of the circumgalactic medium of an isolated, star-forming dwarf galaxy at z=0.57](https://arxiv.org/abs/2510.06310) <a id="link3"></a>
...
**Comment:** Directly matches the 'Circumgalactic Medium' criterion for dwarf galaxies. The paper presents detailed observational measurements of the CGM of an isolated, star-forming dwarf galaxy, including metallicity, ionization, and kinematics, and discusses the connection to outflows and supernova enrichment. Highly relevant to near-field cosmology and CGM topics.
...
## 4. [Ionized gas components in low surface brightness galaxy AGC 111629](https://arxiv.org/abs/2510.06667) <a id="link4"></a>
...
**Comment:** Presents integral field spectroscopy of ionized gas in a low surface brightness galaxy (LSBG) with a stellar mass of 5.7e8 Msun, including evidence for a superbubble likely driven by supernova explosions and possible AGN feedback. The paper is relevant to star formation driven outflows, feedback, and the ISM/CGM in a dwarf galaxy context.
...
## 5. [MEGATRON: The environments of Population III stars at Cosmic Dawn and their connection to present day galaxies](https://arxiv.org/abs/2510.06853) <a id="link5"></a>
...
**Comment:** Presents the MEGATRON suite of simulations, focusing on Population III star formation, quenching mechanisms, and the connection to present-day galaxies, including the distribution of Pop III remnants in the Milky Way and its satellites. Highly relevant to near-field cosmology, numerical galaxy simulations, and historic interactions/accreted stellar halo.
...
## 7. [Machine Learning Techniques to Distinguish Giant Stars from Dwarf Stars Using Only Photometry -- Pushing Redwards](https://arxiv.org/abs/2510.07005) <a id="link7"></a>

**ArXiv ID:** 2510.07005

**Authors:** Keyi Ding, Carrie Filion, Rosemary F. G. Wyse, Evan N. Kirby, Itsuki Ogami, Masashi Chiba, Yutaka Komiyama, L\'aszl\'o Dobos, Alexander S. Szalay

**Abstract:** We present our photometric method, which combines Subaru/HSC $NB515$, g, and i band filters to distinguish giant stars in Local Group galaxies from Milky Way dwarf contamination. The $NB515$ filter is a narrow-band filter that covers the MgI+MgH features at $5150$ \r{A}, and is sensitive to stellar surface gravity. Using synthetic photometry derived from large empirical stellar spectral libraries, we model the $NB515$ filter's sensitivity to stellar atmospheric parameters and chemical abundances. Our results demonstrate that the $NB515$ filter effectively separates dwarfs from giants, even for the reddest and coolest M-type stars. To further enhance this separation, we develop machine learning models that improve the classification on the two-color ($g-i$, $NB515-g$) diagram. We apply these models to photometric data from the Fornax dwarf spheroidal galaxy and two fields of M31, successfully identifying red giant branch stars in these galaxies.

**Comment:** Develops a photometric and machine learning method to distinguish giant stars from dwarfs in Local Group galaxies, using Subaru/HSC NB515 filter. The application to Fornax dSph and M31 fields is directly relevant to resolved star formation histories and near-field cosmology, as it enables cleaner samples for CMD analysis in dwarf galaxies.
...
## 9. [Understanding an origin of palladium in metal-poor stars based on the non-LTE analysis of Pd~I lines](https://arxiv.org/abs/2510.06968) <a id="link9"></a>
...
**Comment:** Presents a new comprehensive model atom for Pd I and non-LTE abundance analysis for metal-poor stars, including very metal-poor (VMP) stars. The work is relevant to stellar models and near-field cosmology, as it provides constraints on nucleosynthetic processes in metal-poor stars, which are often found in dwarf galaxies and the Galactic halo.
...
## 10. [Modeling gravitational wave sources in the MillenniumTNG simulations](https://arxiv.org/abs/2510.06311) <a id="link10"></a>
...
**Comment:** This paper introduces a new framework for modeling gravitational wave sources in cosmological hydrodynamic simulations, specifically linking binary population synthesis to galaxy formation simulations. This matches the 'Numerical Galaxy Simulations' criterion, with additional relevance for connecting star formation histories and binary evolution in a cosmological context. The framework is novel and enables new predictions for GW event rates.
...
## 12. [MEGATRON: Disentangling Physical Processes and Observational Bias in the Multi-Phase ISM of High-Redshift Galaxies](https://arxiv.org/abs/2510.06347) <a id="link12"></a>
...
**Comment:** Describes high-resolution cosmological radiation hydrodynamics simulations (MEGATRON) of high-redshift galaxies, focusing on ISM properties, feedback, and spectroscopic diagnostics. While the simulations are high-resolution and include new physics, the focus is on high-redshift galaxies, not dwarfs or near-field cosmology. Relevant for numerical galaxy simulations, but not a direct match to the highest-priority criteria.
...
## 13. [The rise and fall of Little Red Dots could be driven by the environment](https://arxiv.org/abs/2510.06408) <a id="link13"></a>
...
**Comment:** This paper discusses a galaxy system at z=5.12, including a star-forming satellite and environmental effects on its evolution. The mention of a star-forming satellite and its quenching/evolution is relevant to 'Near-Field Cosmology' and 'Star Formation Quenching', though the system is at high redshift and not directly related to the Milky Way or local group dwarfs. Still, the focus on satellite galaxy evolution and environmental effects is a solid match.
...
## 14. [The Star-forming Main Sequence and Bursty Star-formation Histories at $z>1.4$ in JADES and AURORA](https://arxiv.org/abs/2510.06681) <a id="link14"></a>
...
**Comment:** This paper analyzes star formation histories and the star-forming main sequence for galaxies at z > 1.4 using JWST and HST data. It measures burstiness in star formation histories and provides constraints for theoretical models of galaxy evolution. While the focus is on higher redshift galaxies rather than local dwarfs, the resolved star formation history criterion is matched through observational analysis of star formation histories. The relevance is moderate due to the lack of focus on nearby or dwarf galaxies.
...
## 15. [Benchmarking AI-evolved cosmological structure formation](https://arxiv.org/abs/2510.06731) <a id="link15"></a>
...
**Comment:** This paper presents benchmarking of AI-based methods for cosmological structure formation, comparing deep learning approaches to traditional N-body simulations. It is relevant to the 'Numerical Galaxy Simulations' criterion, as it discusses new methods for generating cosmological matter fields and improving simulation accuracy, though the focus is on large-scale structure rather than individual galaxies or dwarfs. The work is novel in its application of physically motivated benchmarks and custom loss functions to improve results.
...
## 16. [Simulations of Globular Cluster Evolution with Multiple Stellar Populations](https://arxiv.org/abs/2510.06942) <a id="link16"></a>
...
**Comment:** Presents MOCCA simulations of globular cluster evolution with multiple stellar populations, including chemical evolution and dynamical processes. While globular clusters are not dwarf galaxies, the work is relevant to stellar models and numerical galaxy simulations, but only peripherally to the core topics.
...
## 17. [Beyond the stars: Linking H$\alpha$ sizes, kinematics, and star formation in galaxies at $z\approx 4-6$ with JWST grism surveys and $\texttt{geko}$](https://arxiv.org/abs/2510.06315) <a id="link17"></a>
...
**Comment:** Uses JWST grism surveys to study H-alpha sizes, kinematics, and star formation in galaxies at z~4-6. While the work is about star formation and galaxy assembly, the focus is on high-redshift galaxies, not resolved star formation histories in nearby dwarfs. Some relevance for star formation quenching and numerical simulations, but not a direct match.
...
## 22. [Low-noise Fourier Transform Spectroscopy Enabled by Superconducting On-Chip Filterbank Spectrometers](https://arxiv.org/abs/2510.06771) <a id="link22"></a>
...
**Comment:** This paper presents a new spectroscopic instrument design for millimeter/sub-millimeter astronomy, with applications to line intensity mapping (e.g., CO power spectra). While relevant to observational techniques in galaxy evolution, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or dwarf galaxy studies. The focus is on instrumentation rather than galaxy properties or processes.
...
## 23. [Probing evolution of Long GRB properties through their cosmic formation history aided by Machine Learning predicted redshifts](https://arxiv.org/abs/2510.07306) <a id="link23"></a>
...
**Comment:** This paper studies the cosmic formation history of long GRBs and their connection to cosmic star formation, but does not focus on resolved star formation histories from color-magnitude diagrams, nor on dwarf galaxies, quenching, stellar models, or galaxy simulations. The work is tangentially related to star formation history at a cosmic scale, but not in the resolved or near-field context.
...
## 24. [Confirming Near- to Mid-IR Photometrically-Identified Obscured AGNs in the JWST era](https://arxiv.org/abs/2510.07303) <a id="link24"></a>
...
**Comment:** This paper discusses the identification of obscured AGNs using IR photometry and SED fitting, focusing on massive galaxies and some low-mass galaxies. While it touches on low-mass galaxies, the focus is on AGN identification and not on the core topics such as dwarf galaxy evolution, star formation histories, or quenching.
...
## 25. [Formation of A Nuclear Star Cluster Through A Merger Event In The Low Surface Brightness Galaxy AGC 223218](https://arxiv.org/abs/2510.06668) <a id="link25"></a>
...
**Comment:** Studies the formation of a nuclear star cluster in a low surface brightness galaxy, including stellar population analysis and evidence for a merger event. While it touches on galaxy evolution and star cluster formation, it does not focus on dwarf satellites, resolved star formation histories, or quenching in dwarfs.
...
## 27. [Probing the cosmological 21~cm global signal from the Antarctic ice sheet](https://arxiv.org/abs/2510.07198) <a id="link27"></a>
...
**Comment:** This paper focuses on instrumentation for detecting the cosmological 21 cm global signal from neutral hydrogen, probing the intergalactic medium and the epoch of first stars and galaxies. While it is cosmology-related, it does not focus on near-field cosmology, resolved star formation histories, or dwarf galaxies, and is not directly relevant to the core topics.
...
## 28. [CURLING -- II. Improvement on the $H_{0}$ Inference from Pixelized Cluster Strong Lens Modeling](https://arxiv.org/abs/2510.07131) <a id="link28"></a>
...
**Comment:** Presents improvements in strong lens modeling for Hubble constant inference using lensed supernovae. While cosmology is discussed, there is no direct connection to near-field cosmology, dwarf galaxies, or the other core topics.
...
## 29. [AppleCiDEr II: SpectraNet -- A Deep Learning Network for Spectroscopic Data](https://arxiv.org/abs/2510.07215) <a id="link29"></a>
...
**Comment:** Presents a deep learning network for spectroscopic data, with application to transient classification and redshift prediction. No direct connection to resolved star formation histories, stellar models, or other core criteria.
...
## 30. [Comparing XRISM cluster velocity dispersions with predictions from cosmological simulations: are feedback models too ejective?](https://arxiv.org/abs/2510.06322) <a id="link30"></a>
...
**Comment:** This paper compares velocity dispersions in galaxy clusters (not dwarf galaxies) using XRISM observations and cosmological simulations. While it discusses feedback models and simulation predictions, the focus is on massive clusters and SMBH feedback, not on dwarf galaxies, satellite systems, or near-field cosmology. No direct relevance to resolved star formation histories, quenching, stellar models, or CGM of dwarfs.
...
## 31. [A Giant Peanut-shaped Ultra-High-Energy Gamma-Ray Emitter Off the Galactic Plane](https://arxiv.org/abs/2510.06786) <a id="link31"></a>
...
**Comment:** This paper reports the discovery of a giant ultra-high-energy gamma-ray emitter off the Galactic plane, possibly associated with a millisecond pulsar. While it discusses cosmic-ray transport and particle acceleration, it does not focus on near-field cosmology, dwarf galaxies, resolved star formation histories, or any of the other core criteria. The focus is on high-energy astrophysics and particle acceleration mechanisms, which are outside the specified interests.
...
## 32. [Polka-dotted Stars II: Starspots and obliquities of Kepler-17 and Kepler-63](https://arxiv.org/abs/2510.07130) <a id="link32"></a>
...
**Comment:** Uses Bayesian surface-mapping to study starspots and obliquities in two planet-hosting stars. While it involves stellar magnetic activity and evolution, it does not present new stellar models or address galaxy evolution or dwarf galaxies.
...
## 33. [Evidence of violation of Case B recombination in Little Red Dots](https://arxiv.org/abs/2510.06362) <a id="link33"></a>
...
**Comment:** Examines Balmer line ratios in Little Red Dots, a new class of compact extragalactic objects, with some discussion of starburst environments and ionized nebulae. However, the main focus is on AGN-like objects and recombination physics, not on dwarf galaxies, resolved star formation histories, or quenching.
...
## 34. [When vacuum breaks: a self-consistency test for astrophysical environments in extreme mass ratio inspirals](https://arxiv.org/abs/2510.06948) <a id="link34"></a>
...
**Comment:** Proposes a test for environmental effects in extreme mass ratio inspirals (EMRIs), with some mention of dark-matter spikes/cores. However, the focus is on gravitational wave signals and EMRIs, not on galaxy formation, dwarf galaxies, or near-field cosmology.
...
## 36. [Measurement of the $^{35}Cl(n, p)^{35}S$ cross-section at the CERN n\_TOF facility from subthermal energy to 120 keV](https://arxiv.org/abs/2510.06885) <a id="link36"></a>
...
**Comment:** This paper measures the $^{35}Cl(n, p)^{35}S$ cross-section for nuclear physics applications, including some mention of astrophysical nucleosynthesis. However, the focus is on nuclear reaction rates and not on any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. Only a tangential connection to astrophysics.
...
## 37. [Disk fraction among free-floating planetary-mass objects in Upper Scorpius](https://arxiv.org/abs/2510.07163) <a id="link37"></a>
...
**Comment:** This paper studies disk fractions among free-floating planetary-mass objects in Upper Scorpius, focusing on circumstellar disk occurrence and evolution. While it deals with star formation and disk dispersal, it does not address resolved star formation histories, dwarf galaxy quenching, or other core criteria. The focus is on substellar/planetary-mass objects, not galaxies.
...
## 39. [Preferential Accretion onto the Secondary Black Hole Strengthens Gravitational Wave Signals](https://arxiv.org/abs/2510.06325) <a id="link39"></a>
...
**Comment:** Focuses on gravitational wave signals from binary supermassive black holes and preferential accretion, which is not related to near-field cosmology, dwarf galaxies, resolved star formation histories, or other core topics.
...
## 40. [Textual interpretation of transient image classifications from large language models](https://arxiv.org/abs/2510.06931) <a id="link40"></a>
...
**Comment:** This paper focuses on using large language models for transient image classification in astronomical surveys. While it is an interesting application of AI to astronomy, it does not match any of the core criteria such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 43. [RFSoC receiver calibration system for 21-cm global spectrum experiments from space: The CosmoCube case](https://arxiv.org/abs/2510.06558) <a id="link43"></a>
...
**Comment:** Describes a calibration system for a 21-cm global spectrum experiment (CosmoCube) aimed at measuring the cosmic Dark Ages and Epoch of Reionization. While relevant to cosmology instrumentation, it does not address any of the specific criteria (dwarf galaxies, resolved SFH, quenching, CGM, etc.).
...
## 45. [Archival Inference for Eccentric Stellar-Mass Binary Black Holes in Space-Based Gravitational Wave Observations](https://arxiv.org/abs/2510.07174) <a id="link45"></a>
...
**Comment:** This paper develops a Bayesian inference pipeline for eccentric stellar-mass binary black holes in space-based gravitational wave data. The focus is on binary black hole mergers and gravitational wave detection, not on galaxies, star formation histories, quenching, stellar models, or galaxy simulations. No core criteria are matched.
...
## 46. [Are all Binary Black Holes Detected from LIGO-Virgo-KAGRA Follow the Universal Time-Delay Distributions? Likely Not](https://arxiv.org/abs/2510.06352) <a id="link46"></a>
...
**Comment:** This paper reconstructs the delay time distribution for binary black hole mergers detected by LIGO-Virgo-KAGRA, focusing on mass-dependent evolutionary pathways. The topic is binary black hole mergers, not galaxies, star formation histories, quenching, stellar models, or galaxy simulations. No core criteria are matched.
...
## 47. [Diffuse continuum emission and large extended sources at MeV energies](https://arxiv.org/abs/2510.07311) <a id="link47"></a>
...
**Comment:** Discusses diffuse continuum emission and large extended sources at MeV energies, focusing on the Milky Way, Fermi bubbles, Loop I, and extragalactic gamma-ray background. No direct relevance to dwarf galaxies, near-field cosmology, or other core criteria.
...
## 48. [Radiation magnetohydrodynamics modeling of an impulsively driven chromospheric jet in the solar atmosphere](https://arxiv.org/abs/2510.06482) <a id="link48"></a>
...
**Comment:** Numerical simulation of a chromospheric jet in the solar atmosphere using radiation MHD. While it involves numerical simulations and stellar physics, it is focused on solar phenomena and not on galaxy evolution, star formation histories, or dwarf galaxies.
...
## 49. [Hard X-ray view of two $\gamma$-ray detected low-luminosity active galactic nuclei: NGC 315 and NGC 4261](https://arxiv.org/abs/2510.06810) <a id="link49"></a>
...
**Comment:** Analyzes X-ray data of two low-luminosity AGNs in massive galaxies, focusing on accretion disk properties. The work is not relevant to dwarf galaxies, near-field cosmology, or star formation histories.
...
## 53. [Primordial Black Holes and their Mass Spectra: The Effects of Mergers and Accretion within Stasis Cosmologies](https://arxiv.org/abs/2510.06551) <a id="link53"></a>
...
**Comment:** Examines primordial black holes and their mass spectra in stasis cosmologies, focusing on mergers and accretion. No direct connection to galaxy formation, dwarf galaxies, or other core criteria.
...
## 54. [Identifying the secondary jet in the RadioAstron image of OJ~287](https://arxiv.org/abs/2510.06744) <a id="link54"></a>
...
**Comment:** Focuses on jets in a binary black hole system (OJ 287), with analysis of jet orientation and spectral properties. This is not related to near-field cosmology, resolved star formation histories, dwarf galaxies, or any of the other core topics. The work is primarily about AGN jets and binary black holes.
...
## 56. [Warm absorber outflows in radio-loud active galactic nucleus 3C~59](https://arxiv.org/abs/2510.06752) <a id="link56"></a>
...
**Comment:** Studies warm absorber outflows in a radio-loud AGN, focusing on the physical properties and driving mechanisms of outflows. The outflows are AGN-driven, not star-formation-driven, and the host is not a dwarf galaxy. Not relevant to the core criteria.
...
## 58. [The first proper motion measurement of the acceleration regions in the large-scale jets of SS 433 powering the W50 nebula](https://arxiv.org/abs/2510.06431) <a id="link58"></a>
...
**Comment:** Focuses on the proper motion and acceleration regions in the jets of SS 433, a Galactic microquasar, and the W50 nebula. This is not related to dwarf galaxies, resolved star formation histories, quenching, stellar models, galaxy simulations, or CGM. The topic is jet physics in a stellar remnant system.
...
## 59. [CCAT: Readout of over 10,000 280 GHz KIDs in Mod-Cam using RFSoC Electronics](https://arxiv.org/abs/2510.06491) <a id="link59"></a>
...
**Comment:** This paper describes the readout electronics and performance for a large array of kinetic inductance detectors (KIDs) for the CCAT Prime-Cam instrument. While this is relevant for instrumentation in astrophysics, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No direct connection to the science topics of interest.
...
## 60. [GW231123: extreme spins or microglitches?](https://arxiv.org/abs/2510.07228) <a id="link60"></a>
...
**Comment:** This paper analyzes the gravitational wave event GW231123, focusing on black hole spins and detector noise. It is not relevant to any of the core topics, as it does not address galaxy evolution, star formation, or dwarf galaxies.
...
## 61. [Machine Learning for Radial Velocity Analysis I: Vision Transformers as a Robust Alternative for Detecting Planetary Candidates](https://arxiv.org/abs/2510.07034) <a id="link61"></a>
...
**Comment:** Presents a machine learning method for detecting planetary candidates in radial velocity data. The focus is on exoplanet detection and not on galaxy evolution, star formation, or dwarf galaxies.
...
## 62. [Revealing the Temporally Stable Bimodal Energy Distribution of FRB 20121102A with a Tripled Burst Set from AI Detections](https://arxiv.org/abs/2510.07002) <a id="link62"></a>
...
**Comment:** Focuses on fast radio bursts (FRBs) and their energy distribution using AI detection. FRBs are not related to the core topics.
...
## 64. [High-energy variability of the gravitationally lensed blazar PKS 1830-211](https://arxiv.org/abs/2510.07220) <a id="link64"></a>
...
**Comment:** Studies high-energy variability of a gravitationally lensed blazar. Focus is on jet physics and lensing, not on galaxy formation, dwarf galaxies, or any of the core criteria.
...
## 65. [A comprehensive look into the accuracy of SpEC binary black hole waveforms](https://arxiv.org/abs/2510.06393) <a id="link65"></a>

**ArXiv ID:** 2510.06393

**Authors:** Taylor Knapp, Katerina Chatziioannou, Keefe Mitman, Mark A. Scheel, Michael Boyle, Lawrence E. Kidder, Harald Pfeiffer

**Abstract:** Numerical relativity simulations provide a full description of the dynamics of binary systems, including gravitational radiation. The waveforms produced by these simulations have a number of applications in gravitational-wave detection and inference. In this work, we revisit the accuracy of the waveforms produced by the Spectral Einstein Code. Motivated by the wide range of waveform applications, we propose and explore three accuracy metrics between simulation resolutions: (i) the generalized frequency-weighted mismatch, (ii) the relative amplitude difference, and (iii) the phase difference at different times. We find that numerical errors accumulate over the binary evolution, but the error is not intrinsically larger during the latest, more dynamical stages. Studying errors across the parameter space, we identify a positive correlation between both the mismatch and the phase difference with precessing spin, but little correlation with aligned spin or eccentricity. Lastly, amplitude and phases differences are symmetric upon exchanging resolutions across the catalog, suggesting that there is no systematic error.

**Comment:** Assesses the accuracy of binary black hole waveforms from numerical relativity. No direct connection to galaxy simulations, star formation, or other core criteria.
...
## 66. [In-flight performance of the IXPE telescopes](https://arxiv.org/abs/2510.06963) <a id="link66"></a>
...
**Comment:** This paper presents the in-flight performance and imaging characterization of the IXPE X-ray telescopes. The focus is on instrument performance and calibration, not on any of the core science topics such as dwarf galaxies, star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM. No direct relevance to the specified criteria.
...
## 68. [Spectropolarimetry of NGC 1275 reveals a narrow-line radio galaxy with polarization parallel to its radio jet axis](https://arxiv.org/abs/2510.06713) <a id="link68"></a>

**ArXiv ID:** 2510.06713

**Authors:** F. Marin, T. Pursimo, I. Liodakis, E. Lindfors, J. Biedermann, D. Hutsem\'ekers, M. Turkki

**Abstract:** Concomitant with the Imaging X-ray Polarimetry Explorer (IXPE) observation of the Perseus cluster, we obtained optical spectropolarimetry of its central active galactic nucleus, NGC 1275, using the Alhambra Faint Object Spectrograph and Camera (ALFOSC) on the Nordic Optical Telescope (NOT). While the total-light spectrum confirms its edge-on, core obscured (type-2) classification, the polarized spectrum shows a polarization angle aligned with the arcsecond radio jet axis -- an exceptional behavior for type-2 objects. Our polarization analysis also reveals wavelength-dependent linear polarization at level 2-3% in the continuum, likely rising from a combination of variable syn

**Comment:** This paper presents spectropolarimetry of the AGN in NGC 1275, focusing on polarization properties and radio jet alignment. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 71. [Rolling with modular symmetry: quintessence and de Sitter in heterotic orbifolds](https://arxiv.org/abs/2509.22781) <a id="link71"></a>
...
**Comment:** Discusses modular symmetry in string compactifications and its implications for quintessence and de Sitter vacua. This is theoretical cosmology and string theory, not related to the core topics.
...
## 72. [Vision Transformer for Transient Noise Classification](https://arxiv.org/abs/2510.06273) <a id="link72"></a>
...
**Comment:** Applies machine learning (Vision Transformer) to classify transient noise in LIGO data, which is unrelated to galaxy astrophysics, near-field cosmology, or any of the core topics.
...
## 73. [A Review of 10 Years of ProtoSpace: Spacecraft CAD Visualization in Collaborative Augmented Reality](https://arxiv.org/abs/2510.06608) <a id="link73"></a>
...
**Comment:** Reviews a visualization platform for spacecraft CAD models in augmented reality. This is entirely outside the scope of the core topics.
...
## 74. [Testing new-physics scenarios with the combined LHAASO and Carpet-3 fluence spectrum of GRB 221009A: axion-like particles and Lorentz-invariance violation](https://arxiv.org/abs/2510.07234) <a id="link74"></a>

**ArXiv ID:** 2510.07234

**Authors:** P. S. Satunin, S. V. Troitsky

**Abstract:** From gamma-ray burst (GRB) 221009A, very high-energy photons were detected: >10 TeV with LHAASO and >100 TeV with Carpet-3. Such energetic photons are expected to be absorbed via electron-positron pair production on their way to the Earth. Their observation might be explained by new physics, including Lorentz invariance violation (LIV) or photon mixing with axion-like particles (ALPs). Here, we construct a joint fluence spectrum by combining flux measurements from both experiments, and fit it under these hypotheses. LIV can account for the Carpet-3 observation, providing a modest improvement over standard physics in the overall fit. ALP mixing improves the description of both LHAASO and Carpet-3 data, yielding a substantial enhancement in fit quality for a specific region of the ALP parameter space.

**Comment:** Tests new-physics scenarios (axion-like particles, Lorentz-invariance violation) using GRB 221009A data. This is unrelated to galaxies, star formation, or near-field cosmology.
...
## 75. [Unified Dark Matter and Dark Energy in a model of Non-Canonical Scalar-Tensor Theory](https://arxiv.org/abs/2510.07103) <a id="link75"></a>
...
**Comment:** Explores a non-canonical scalar-tensor theory for unified dark matter and dark energy. The work is theoretical cosmology, not related to galaxies, star formation, or near-field cosmology.
...
## 76. [Influence of Solar Sails on Magnetic Field Measurements in Space Plasmas](https://arxiv.org/abs/2510.06510) <a id="link76"></a>
...
**Comment:** This paper investigates the influence of solar sails on magnetic field measurements in space plasmas. It is focused on instrumentation and plasma interactions, not on any of the core topics such as galaxy evolution, star formation, or near-field cosmology.
...
## 77. [Dual perspectives on GX 17+2: a simultaneous NICER and NuSTAR study](https://arxiv.org/abs/2510.06614) <a id="link77"></a>
...
**Comment:** This paper presents a spectral and timing study of the Z source GX 17+2, focusing on accretion disk properties and variability in a neutron star system. The study does not address any of the core criteria such as near-field cosmology, dwarf galaxies, star formation histories, quenching, or galaxy simulations. The focus is on X-ray binaries and accretion physics.
