...
|:--------------------:|:--------:|:------------:|:-------:|
| **Token**            | 73701    | 11698        | 85399   |
| **Cost**             | $0.15    | $0.09        | $0.24   |

Total arXiv papers: 258

Total scanned papers: 180

Total relevant papers: 140

**Table of contents with paper titles:**

1. [The First Star-by-star $N$-body/Hydrodynamics Simulation of Our Galaxy Coupling with a Surrogate Model](#user-content-link1)
...
2. [The Cosmic Baryon Cycle in IllustrisTNG: flows of mass, energy, and metals](#user-content-link2)
**Authors:** Yossi Oren, Viraj Pandya, Rachel S. Somerville, Shy Genel, Osase Omoruyi, Amiel Sternberg

3. [How to Build an Empirical Speed Distribution for Dark Matter in the Solar Neighborhood](#user-content-link3)
**Authors:** Tal Shpigel, Dylan Folsom, Mariangela Lisanti, Lina Necib, Mark Vogelsberger, Lars Hernquist

4. [The MandelZoom project II: the impact of stellar feedback on black hole accretion through an $\alpha$-disc in dwarf galaxies with a resolved interstellar medium](#user-content-link4)
**Authors:** Eun-jin Shin, Matthew C. Smith, Debora Sijacki, Martin A. Bourne, Sophie Koudmani

5. [Beyond the Local Group - I: Cosmic Filaments Govern the Spatial Alignments of Galaxy Pairs](#user-content-link5)
**Authors:** Peng Wang (SHAO)

6. [HI Content of Group Galaxies from the FAST All Sky HI Survey](#user-content-link6)
**Authors:** Shulan Yan, Andrew Ma, Qingzheng Yu, Taotao Fang, Chuan He, Ming Zhu

7. [The spatial distribution of dwarf and giant galaxies in and around Virgo cluster](#user-content-link7)
**Authors:** Nelvy Choque-Challapa, Rory Smith, Iv\'an Lacerna, J. Alfonso L. Aguerri, Daniela Palma

8. [Unveiling stellar (and planetary) internal dynamics with the fully compressible MUSIC code](#user-content-link8)
...
9. [SWIFTGalaxy: a Python package to work with particle groups from SWIFT simulations](#user-content-link9)
**Authors:** Kyle A. Oman (Durham-ICC, Durham-CEA)

10. [Fundamental effective temperature measurements for eclipsing binary stars - VI. Improved methodology and application to the circumbinary planet host star BEBOP-3](#user-content-link10)
**Authors:** P. F. L. Maxted, N. J. Miller, T. A. Baycroft, D. Sebastian, A. H. M. J. Triaud, D. V. Martin

11. [Magnesium Isotopic Detection in Cool Stars: Tracing Nucleosynthetic Signatures from MgH Features](#user-content-link11)
**Authors:** Quin Aicken Davies, C. Clare Worley

12. [The oscillation properties of the Blue Large Amplitude Pulsators (BLAPs): relative change rate of periods, excitations, and period relations](#user-content-link12)
**Authors:** Tao Wu, Yan Li

13. [Improved UVIS Aperture Corrections derived from Focus Diverse PSF Maps](#user-content-link13)
**Authors:** K. Huynh, V. Bajaj, J. Mack, A. Calamida

14. [The AMBRE Project: Line-broadening and stellar rotation of ESO/FEROS archived spectra](#user-content-link14)
**Authors:** F. Bado, P. de Laverny, Z. Kam, A. Recio-Blanco, P. A. Palicio, J. Koulidiati

15. [Discovery of SN 2025wny: a Strongly Gravitationally Lensed Superluminous Supernova at z = 2.01](#user-content-link15)
...
16. [Evaluating the chromospheric structure model of AD Leo using RH1.5D and magnetic field data](#user-content-link16)
**Authors:** Shuai Liu, Jianrong Shi, Huigang Wei, Wenxian Li, Jifeng Liu, Shangbin Yang, Henggeng Han

17. [Tracing The Start and End of Cosmic Reionization - Exploring The Role of Ionizing Sources as drivers](#user-content-link17)
**Authors:** Arghyadeep Basu

18. [Cosmic Vine: High abundance of massive galaxies and dark matter halos in a forming cluster at z=3.44](#user-content-link18)
...
19. [Detecting Intermediate-Mass Black Holes out to 20 Mpc with ELT/HARMONI: The Case of FCC 119](#user-content-link19)
**Authors:** Hai N. Ngo, Dieu D. Nguyen, Tinh T. Q. Le, Tien H. T. Ho, Truong N. Nguyen, Trung H. Dang

20. [A great diversity of spectral shapes in the ionising spectra of z ~ 0.6 - 1 galaxies revealed by HST/COS and possible detection of nebular LyC emission](#user-content-link20)
**Authors:** Y. I. Izotov (Bogolyubov Institute for Theoretical Physics, National Academy of Sciences of Ukraine, Kyiv, Uktaine), D. Schaerer (Observatoire de Geneve, Universite de Geneve, Versoix, Switzerland, IRAP/CNRS, Toulouse, France), G. Worseck (17VDI/VDE Innovation+Technik, Berlin, Germany), N. G. Guseva (Bogolyubov Institute for Theoretical Physics, National Academy of Sciences of Ukraine, Kyiv, Uktaine), A. Verhamme (Observatoire de Geneve, Universite de Geneve, Versoix, Switzerland), C. Simmonds (The Kavli Institute for Cosmology, Cavendish Laboratory, University of Cambridge, Cambridge, UK), J. Chisholm (Astronomy Department, University of Texas at Austin, Austin, USA)

21. [Under Pressure: Decoding the Effect of High Densities on Derived Nebular Properties](#user-content-link21)
**Authors:** Z. Martinez, D. A. Berg, B. L. James, K. Z. Arellano-C\'ordova, D. P. Stark, P. Senchyna, E. D. Skillman, N. S. J. Rogers, J. Chisholm

22. [Revisiting the 150 MHz Radio Luminosity Function of Star-Forming Galaxies with LOFAR Deep Fields through a Refined Statistical Framework](#user-content-link22)
**Authors:** Wenjie Wang, Zunli Yuan, Hongwei Yu, Yang Liu, Yu Luo, Puxun Wu

23. [The MiMO Catalog: Physical Parameters and Stellar Mass Functions of 1,232 Open Clusters from Gaia DR3](#user-content-link23)
**Authors:** Lu Li, Zhengyi Shao, Zhaozhou Li, Xiaoting Fu

24. [Multi-Modal Masked Autoencoders for Learning Image-Spectrum Associations for Galaxy Evolution and Cosmology](#user-content-link24)
...
25. [SHELLQs-JWST: Revealing the Spectra of Extended Emission in 12 z > 6 Quasar Host Galaxies using the JWST NIRSpec Fixed Slit](#user-content-link25)
...
26. [The role of supercluster filaments in shaping galaxy clusters](#user-content-link26)
**Authors:** Ra\'ul Baier-Soto, Yara Jaff\'e, Alexis Finoguenov, P. Christopher Haines, Paola Merluzzi, Hugo M\'endez-Hern\'andez, Antonela Monachesi, Ulrike Kuchner, Rory Smith, Nicolas Tejos, Crist\'obal Sif\'on, Maria Argudo-Fern\'andez, C. R. Bom, Johan Comparat, Ricardo Demarco, F. Rodrigo Haack, Ivan Lacerna, E. V. R. Lima, Ciria Lima-Dias, Elismar L\"osch, C. Mendes de Oliveira, Diego Pallero, Laerte Sodr\'e Jr, S. M. Gabriel Teixeira, O. Alghamdi, F. Almeida-Fernandes, Stefania Barsanti, E. Lawrence Bilton, M. Canducci, Maiara Carvalho, Giuseppe D'Ago, Alexander Fritz, R. F\'abio Herpich, E. Ibar, Hyowon Kim, Sebastian Lopez, Alessia Moretti, L. M. I. Nakazono, D. E. Olave-Rojas, G. B. Oliveira Schwarz, Franco Piraino-Cerda, Emanuela Pompei, U. Rescigno, F. Boudewijn Roukema, V. M. Sampaio, P. Ti\~no, P. V\'asquez-Bustos

27. [Validating Open Cluster Candidates with Photometric Bayesian Evidence](#user-content-link27)
**Authors:** Lu Li, Zhaozhou Li, Zhengyi Shao

28. [The Velocity Map Asymmetry of Ionized Gas in MaNGA II. Correlation between Velocity Map Morphology, Star Formation, and Metallicity in Regular Disk Galaxies](#user-content-link28)
**Authors:** Shuai Feng, Shiyin Shen, Yanmei Chen, Y. Sophia Dai, Jun Yin, Wenyuan Cui, Mengting Ju, Linlin Li

29. [Alma Luminous Star catalogue IV: A Massive star census in the Magellanic Clouds](#user-content-link29)
**Authors:** J. A. Molina-Calzada, J. Ma\'iz Apell\'aniz

30. [MIGHTEE-HI: The HI mass-stellar mass relation of massive galaxies and the HI mass function at 0.25<z<0.5](#user-content-link30)
...
31. [Analytic Marginalization over Binary Variables in Physics Data](#user-content-link31)
**Authors:** Marcus H\"og{\aa}s, Edvard M\"ortsell

32. [Using Type-II Cepheids as Extragalactic Standard Candles: Distances to M31](#user-content-link32)
**Authors:** V. D. Pipwala (Astronomisches Rechen-Institut, Zentrum fuer Astronomie der Universitaet Heidelberg, Monchhofstr. 12-14, D-69120 Heidelberg, Germany, Dipartimento di Fisica, Universita di Roma "Tor Vergata", Via della Ricerca Scientifica 1, 00133 Roma, Italy, Dipartimento di Fisica, Sapienza Universita di Roma, Piazzale A. Moro 5, 00185 Roma, Italy, INAF - Osservatorio Astronomico di Roma, Via Frascati 33, I-00078 Monte Porzio Catone, Italy), H. N. Lala (CricViz, Mumbai, India), B. Lemasle (cosnova GmbH, Am Limespark 2, 65843 Sulzbach, Germany), E. K. Grebel (Astronomisches Rechen-Institut, Zentrum fuer Astronomie der Universitaet Heidelberg, Monchhofstr. 12-14, D-69120 Heidelberg, Germany), G. Bono (Dipartimento di Fisica, Universita di Roma "Tor Vergata", Via della Ricerca Scientifica 1, 00133 Roma, Italy, INAF - Osservatorio Astronomico di Roma, Via Frascati 33, I-00078 Monte Porzio Catone, Italy), G. Fiorentino (Dipartimento di Fisica, Universita di Roma "Tor Vergata", Via della Ricerca Scientifica 1, 00133 Roma, Italy)

33. [K-DRIFT: Unveiling New Imagery of the Hidden Universe](#user-content-link33)
...
34. [Recasting and Forecasting Dark Matter Limits Without Raw Data: A Generalized Algorithm for Gamma-Ray Telescopes](#user-content-link34)
**Authors:** Giacomo D'Amico, Michele Doro, Michela De Caria

35. [SPYGLASS. VII-A. The Demographics and Ages of Small Nearby Young Associations](#user-content-link35)
**Authors:** Ronan Kerr, Facundo Pe\'rez Paolino, Jonathan Tan, Joshua S. Speagle, Adam L. Kraus, Jos\'e G. Fern\'andez-Trincado, Keivan G. Stassun, Julio Chanam\'e

36. [SN 2024iss: A Double-peaked Type IIb Supernova with Evidence of Circumstellar Interaction](#user-content-link36)
**Authors:** Liyang Chen, Xiaofeng Wang, Qinyu Wu, Moira Andrews, Joseph Farah, Paolo Ochner, Andrea Reguitti, Thomas G. Brink, Jujia Zhang, Cuiying Song, Jialian Liu, Alexei V. Filippenko, David J. Sand, Irene Albanese, Kate D. Alexander, Jennifer Andrews, K. Azalee Bostroem, Yongzhi Cai, Collin Christy, Ali Esamdin, Andrea Farina, Noah Franz, D. Andrew Howell, Brian Hsu, Maokai Hu, Abdusamatjan Iskandar, Liping Li, Gaici Li, Dongyue Li, Wenxiong Li, Jinzhong Liu, Curtis McCully, Megan Newsome, Yuan Qi Ni, Andrea Pastorello, Estefania Padilla Gonzalez, Jeniveve Pearson, Haowei Peng, Conor Ransome, Manisha Shrestha, Nathan Smith, Bhagya Subrayan, Giacomo Terreran, Giorgio Valerin, J. Vink\'o, Sergiy S. Vasylyev, Letian Wang, Zhenyu Wang, Hao Wang, J. Craig Wheeler, Kathryn Wynn, Danfeng Xiang, Shengyu Yan, Weimin Yuan, Juan Zhang, WeiKang Zheng, Yu Zhang

37. [SN2017ckj: A linearly declining Type IIb supernova with a relatively massive hydrogen envelope](#user-content-link37)
...
38. [Living with Neighbors. V. Better-aligned Spiral+Spiral Galaxy Pairs Show Stronger Star Formation](#user-content-link38)
**Authors:** Woong-Bae G. Zee, Jun-Sung Moon, Sanjaya Paudel, Suk-Jin Yoon

39. [Unveiling the collision between molecular outflows: observational evidence and hydrodynamic simulations](#user-content-link39)
**Authors:** E. Cohen Arazi, P. F. Vel\'azquez, M. E. Ortega, A. Rodr\'iguez-Gonz\'alez, E. Alquicira-Pel\'aez, S. Paron, P. Rivera-Ortiz, A. Esquivel

40. [Cosmic magnification on multi-catalogue Herschel submillimetre galaxies](#user-content-link40)
**Authors:** R. Fernandez-Fernandez, M. M. Cueli, J. Gonz\'alez-Nuevo, L. Bonavera, D. Crespo, E. Goitia, J. M. Casas, J. A. Cano, M. Migliaccio

41. [Spatially Resolved, Multiphase Mass Outflows of the Seyfert 1 Galaxy NGC 3227](#user-content-link41)
...
42. [From Rare Events to a Population: Discovering Overlooked Extragalactic Magnetar Giant Flare Candidates in Archival Fermi Gamma-ray Burst Monitor Data](#user-content-link42)
**Authors:** Aaron C. Trigg, Eric Burns, Michela Negro, Suman Bala, P. N. Bhat, William H. Cleveland, Dmitry D. Frederiks, Adam Goldstein, Boyan A. Hristov, Daniel Kocevski, Niccol\`o Di Lalla, Stephen Lesage, Bagrat Mailyan, Eliza Neights, Nicola Omodei, Oliver J. Roberts, Lorenzo Scotton, Dmitry S. Svinkin, Joshua Wood

43. [The Compressed 3D Lyman-Alpha Forest Bispectrum](#user-content-link43)
**Authors:** Roger de Belsunce, James M. Sullivan, Patrick McDonald

44. [Some Properties of Multi-Component Axion Dark Matter](#user-content-link44)
**Authors:** Hai-Jun Li

45. [Do Young Suns Produce Frequent, Massive CMEs? Results from Five-year Dedicated Optical Observations of EK Draconis and V889 Hercules](#user-content-link45)
**Authors:** Kosuke Namekata, Hiroyuki Maehara, Yuta Notsu, Satoshi Honda, Kai Ikuta, Daisaku Nogami, Kazunari Shibata

46. [The MDW H{\alpha} Sky Survey: Data Release 1](#user-content-link46)
**Authors:** Noor Aftab (Andrew), Xunhe (Andrew), Zhang, Sean Walker, Dennis di Cicco, David R. Mittelman, Sanya Gupta, Andrew K. Saydjari, Mary Putman, David Schiminovich

47. [The Solar Neighborhood. LV. M Dwarf Twin Binaries -- One in Five Twin Sibling Pairs Are Mismatched in Activity and/or Rotation](#user-content-link47)
**Authors:** Andrew A. Couperus, Todd J. Henry, Aman Kar, Wei-Chun Jao, Eliot Halley Vrijmoet, Rachel A. Osten

48. [Dark Energy Survey Year 6 Results: Clustering-redshifts and importance sampling of Self-Organised-Maps $n(z)$ realizations for $3\times2$pt samples](#user-content-link48)
**Authors:** W. d'Assignies, G. M. Bernstein, B. Yin, G. Giannini, A. Alarcon, M. Manera, C. To, M. Yamamoto, N. Weaverdyck, R. Cawthon, M. Gatti, A. Amon, D. Anbajagane, S. Avila, M. R. Becker, K. Bechtol, C. Chang, M. Crocce, J. De Vicente, S. Dodelson, J. Fang, A. Fert\'e, D. Gruen, E. Legnani, A. Porredon, J. Prat, M. Rodriguez-Monroy, C. S\'anchez, T. Schutt, I. Sevilla-Noarbe, D. Sanchez Cid, M. A. Troxel, T. M. C. Abbott, M. Aguena, O. Alves, D. Bacon, S. Bocquet, D. Brooks, R. Camilleri, A. Carnero Rosell, M. Carrasco Kind, J. Carretero, F. J. Castander, L. N. da Costa, M. E. da Silva Pereira, T. M. Davis, S. Desai, P. Doel, C. Doux, A. Drlica-Wagner, T. Eifler, J. Elvin-Poole, S. Everett, B. Flaugher, P. Fosalba, J. Frieman, J. Garcia-Bellido, E. Gaztanaga, P. Giles, G. Gutierrez, S. R. Hinton, D. L. Hollowood, K. Honscheid, D. Huterer, B. Jain, D. J. James, K. Kuehn, O. Lahav, S. Lee, J. L. Marshall, J. Mena-Fernandez, F. Menanteau, R. Miquel, J. Muir, J. Myles, R. L. C. Ogando, A. Palmese, M. Paterno, P. Petravick, A. A. Plazas Malagon, M. Raveri, A. Roodman, S. Samuroff, E. Sanchez, E. Sheldon, T. Shin, M. Smith, E. Suchyta, M. E. C. Swanson, G. Tarle, D. Thomas, V. Vikram, A. R. Walker

49. [The Near-Ultraviolet Spectra of FU Orionis Accretion Disks](#user-content-link49)
**Authors:** Adolfo S. Carvalho, Lynne A. Hillenbrand, Gregory J. Herczeg, Kevin France

50. [COMAP Pathfinder -- Season 2 results IV. A stack on eBOSS/DESI quasars](#user-content-link50)
...
51. [Galactic bars and active galactic nucleus fuelling in the second half of cosmic history](#user-content-link51)
**Authors:** A. La Marca, M. T. Nardone, L. Wang, B. Margalef-Bentabol, S. Kruk, S. C. Trager

52. [Coronal Mass Ejections from Young Suns: Insights from Solar and Stellar Observations and Models](#user-content-link52)
**Authors:** Kosuke Namekata

53. [Avoiding PBH overproduction in inflation model with modified dispersion relation](#user-content-link53)
**Authors:** Chengrui Yang, Weixin Cai, Taotao Qiu

54. [A new group of low-spin $50-70M_\odot$ Black Holes and the high pair-instability mass cutoff](#user-content-link54)
**Authors:** Yuan-Zhu Wang, Yin-Jie Li, Shi-Jie Gao, Shao-Peng Tang, Yi-Zhong Fan

55. [Introducing the Seyfert-LINER Index (SLI): High Resolution (<100pc) Ionization Structures in the ISM of AGN ESO~137-G34](#user-content-link55)
**Authors:** D. {\L}. Kr\'ol G. Fabbiano, M. Elvis, A. Trindade Falc\~ao, P. Zhu, L. J. Kewley, R. Middei, D. Rosario, R. Davies, T. Shimizu, D. Hill

56. [XRISM constraints on the velocity power spectrum in the Coma cluster](#user-content-link56)
**Authors:** D. Eckert, M. Markevitch, J. A. ZuHone, M. Regamey, I. Zhuravleva, Y. Ichinohe, N. Truong, N. Okabe, D. R. Wik

57. [The Sun as an X-ray star V.: A new method to retrieve coronal filling factors](#user-content-link57)
**Authors:** Wilhelmina Maryann Joseph, Beate Stelzer, Salvatore Orlando, Moritz Klawin

58. [Spinning-down RU Lup. Constraints on the physics of the outflow from high-resolution spectroscopy](#user-content-link58)
**Authors:** A. Armeni, B. Stelzer, A. Frasca, C. F. Manara, J. Campbell-White, J. F. Gameiro, M. Gangi

59. [Primordial black hole formation from collapsing domain walls with full general relativity](#user-content-link59)
**Authors:** Naoya Kitajima

60. [Zernike Mode Sorting with Vortex Phase Filters: Perfect Coronagraphs and Ideal Wavefront Sensors](#user-content-link60)
**Authors:** Jacob Trzaska, Amit Ashok

61. [Morphological and Kinematical Diagnostic of FU Orionis-type Outburst Mechanisms](#user-content-link61)
**Authors:** Jinshi Sai, Eduard I. Vorobyov, Alexandr Skliarevskii, Michihiro Takami

62. [QUEST (Quasar Unsupervised Encoder and Synthesis Tool): A machine learning framework to generate quasar spectra](#user-content-link62)
**Authors:** F. Guarneri, J. T. Schindler, R. A. Meyer, D. Yang, J. F. Hennawi, L. Lucie-Smith, S. E. I. Bosman, F. B. Davies

63. [First detection of ultra-high energy emission from gamma-ray binary LS I +61 303](#user-content-link63)
**Authors:** LHAASO Collaboration

64. [Dynamical friction shear and rotation in Chaplygin cosmology](#user-content-link64)
**Authors:** A. Del Popolo, Saeed Fakhry, Maryam Shiravand, Morgan Le Delliou

65. [Cosmic magnification on high-redshift submillimeter galaxies](#user-content-link65)
**Authors:** Marcos M. Cueli, Joaqu\'in Gonz\'alez-Nuevo, Laura Bonavera, Andrea Lapi

66. [Photometric and Spectroscopic Studies of Four Low Mass-ratio Contact Binaries with Period Longer than 0.7 days](#user-content-link66)
**Authors:** Yi-Fan Wang, Kai Li, Fei Liu, Xin Xu, Mu-Zi-Mei Li, Cheng-Yu Wu, Yu-Tong Li, Yan-Ke Tang, Xing Gao, Guo-You Sun

67. [Discovery and Timing Follow-Up of Two FAST-Discovered Pulsars from the FAST CRAFTS Survey](#user-content-link67)
...
68. [Probing AGN-ISM Feedback through Extended X-ray Emission in ESO 137-G034](#user-content-link68)
**Authors:** D. {\L}. Kr\'ol, G. Fabbiano, M. Elvis, A. Trindade Falc\~ao, R. Middei, D. Rosario, R. Davies, T. Shimizu, D. Hill

69. [Constraining and Comparing the Dynamical Dark Energy and f(R) Modified Gravity Models with Cosmological Distance Measurements](#user-content-link69)
**Authors:** Shuai Feng, Yan Gong, Xiaohui Liu, Jun-Hui Yan, Xuelei Chen

70. [Separation of gain fluctuations and continuum signals in total power spectrometers with application to COMAP](#user-content-link70)
...
71. [Constraining the Hubble Constant using Cross-Correlation of Gravitational Wave Events with Flux-Limited Galaxy Catalog](#user-content-link71)
**Authors:** Tathagata Ghosh, Surhud More

72. [On the acceleration of cosmic rays at the post-adiabatic shocks of supernova remnants](#user-content-link72)
**Authors:** O. Petruk, R. Bandiera, T. Kuzyo, R. Brose, A. Ingallinera

73. [Superhorizon Isocurvature as a Window into Dark Matter Production](#user-content-link73)
**Authors:** Christopher Gerlach, Wolfram Ratzinger, Pedro Schwaller

74. [Luminosity Functions and Detectability of Binary Neutron Star Merger-nova Signals with Various Merger Remnants](#user-content-link74)
**Authors:** Zhiwei Chen, Youjun Lu, Hao Ma, Qingbo Chu

75. [Refined Low-Energy Supernova Constraints on Lepton Flavor Violating Axions](#user-content-link75)
**Authors:** Zi-Miao Huang, Changqian Li, Zuowei Liu

76. [Lensing, not luck! Detection prospects of strongly lensed gravitational waves](#user-content-link76)
**Authors:** A. Barsode, K. N. Maity, P. Ajith

77. [Dynamical Dark Energy Meets Varying Electron Mass: Implications for Phantom Crossing and the Hubble Constant](#user-content-link77)
**Authors:** Adam Smith, Emre \"Oz\"ulker, Eleonora Di Valentino, Carsten van de Bruck

78. [Detecting ultralight dark matter in the Galactic Center with pulsars around Sgr A*](#user-content-link78)
**Authors:** Jiang-Chuan Yu, Yan Cao, Zexin Hu, Lijing Shao

79. [Illuminating the Diffuse Radio Emission in Low-Mass Cluster: Abell 13](#user-content-link79)
**Authors:** Nasmi S Anand, Swarna Chatterjee, Ramij Raja, Majidul Rahaman, Abhirup Datta

80. [Discovery of multi-temperature coronal mass ejection signatures from a young solar analogue](#user-content-link80)
...
81. [Tensor network methods for quantum-inspired image processing and classical optics](#user-content-link81)
**Authors:** Nicolas Allegra

82. [Stellar Wind-Blown Bubbles as Environments for Late-Time Rebrightening of Gamma-Ray Burst Afterglows](#user-content-link82)
**Authors:** Jia Ren, Xiao-Yan Li, Yun Wang, Lu-Lu Zhang, Da-Ming Wei, Zi-Gao Dai, Zhi-Ping Jin, Da-Bin Lin

83. [Revisiting Very High Energy Gamma-Ray Absorption in Cosmic Propagation under the Combined Effects of Axion-Like Particles and Lorentz Violation](#user-content-link83)
...
84. [RGC: a radio AGN classifier based on deep learning. I. A semi-supervised model for the VLA images of bent radio AGNs](#user-content-link84)
**Authors:** M. S. Hossain (Center for Computational and Data Sciences, Independent University, Bangladesh), M. S. H. Shahal (Center for Astronomy, Space Science and Astrophysics, Independent University, Bangladesh, Department of Computer Science and Engineering, Independent University, Bangladesh), A. Khan (Center for Computational and Data Sciences, Independent University, Bangladesh, Center for Astronomy, Space Science and Astrophysics, Independent University, Bangladesh), K. M. B. Asad (Center for Astronomy, Space Science and Astrophysics, Independent University, Bangladesh, Department of Physical Sciences, Independent University, Bangladesh), P. Saikia (Department of Astronomy and Physics, Yale University, USA), F. Akter (Department of Agricultural and Biosystems Engineering, North Dakota State University, USA), A. Ali (Center for Computational and Data Sciences, Independent University, Bangladesh, Department of Computer Science and Engineering, Independent University, Bangladesh), M. A. Amin (Center for Computational and Data Sciences, Independent University, Bangladesh, Department of Computer Science and Engineering, Independent University, Bangladesh), A. Momen (Center for Computational and Data Sciences, Independent University, Bangladesh, Center for Astronomy, Space Science and Astrophysics, Independent University, Bangladesh, Department of Physical Sciences, Independent University, Bangladesh), M. Hasan (Department of Computer Science and Engineering, Independent University, Bangladesh), A. K. M. M. Rahman (Center for Computational and Data Sciences, Independent University, Bangladesh, Department of Computer Science and Engineering, Independent University, Bangladesh)

85. [Metallicity regulates planet formation across all masses](#user-content-link85)
**Authors:** Max Nguyen, Vardan Adibekyan

86. [Suppressed "lump" EM signature in radiation pressure dominated accreting massive black hole binaries](#user-content-link86)
**Authors:** Fabiola Cocchiararo, Alessia Franchini, Alessandro Lupi, Alberto Sesana

87. [Analyzing GW231109_235456 and understanding its potential implications for population studies, nuclear physics, and multi-messenger astronomy](#user-content-link87)
**Authors:** Thibeau Wouters, Anna Puecher, Peter T. H. Pang, Tim Dietrich

88. [The Programmable Liquid-crystal Active Coronagraphic Imager for the 4-m DAG telescope (PLACID) instrument: installation and commissioning update](#user-content-link88)
**Authors:** Jonas G. K\"uhn, Ruben Tandon, Lucas Marquis, Liurong Lin, Derya \"Ozt\"urk \c{C}etni, Iljadin Manurung, Axel Potier, Laurent Jolissaint, Audrey Baur, Daniele Piazza, Mathias Br\"andli, Martin Rieder

89. [Characterizing Low-Latency Sky Localization in Multi-Detector Gravitational-Wave Networks](#user-content-link89)
**Authors:** Amazigh Ouzriat, Viola Sordini, Francesco Di Renzo

90. [Bubble wall velocity with out-of-equilibrium corrections](#user-content-link90)
**Authors:** Carlo Branchina, Angela Conaci, Stefania De Curtis, Luigi Delle Rose

91. [Dark Energy Survey Year 6 Results: Redshift Calibration of the Weak Lensing Source Galaxies](#user-content-link91)
**Authors:** B. Yin (DES Collaboration), A. Amon (DES Collaboration), A. Campos (DES Collaboration), M. A. Troxel (DES Collaboration), W. d'Assignies (DES Collaboration), G. M. Bernstein (DES Collaboration), G. Camacho-Ciurana (DES Collaboration), S. Mau (DES Collaboration), M. R. Becker (DES Collaboration), G. Giannini (DES Collaboration), A. Alarc\'on (DES Collaboration), D. Gruen (DES Collaboration), J. McCullough (DES Collaboration), M. Yamamoto (DES Collaboration), D. Anbajagane (DES Collaboration), S. Dodelson (DES Collaboration), C. S\'anchez (DES Collaboration), J. Myles (DES Collaboration), J. Prat (DES Collaboration), C. Chang (DES Collaboration), M. Crocce (DES Collaboration), K. Bechtol (DES Collaboration), A. Fert\'e (DES Collaboration), M. Gatti (DES Collaboration), N. MacCrann (DES Collaboration), R. Marco (DES Collaboration), A. Porred\'on (DES Collaboration), D. S\'anchez Cid (DES Collaboration), T. Schutt (DES Collaboration), M. Tabbut (DES Collaboration), C. To (DES Collaboration), T. Abbott (DES Collaboration), M. Aguena (DES Collaboration), O. Alves (DES Collaboration), D. Bacon (DES Collaboration), S. Bocquet (DES Collaboration), D. Brooks (DES Collaboration), R. Camilleri (DES Collaboration), A. Carnero Rosell (DES Collaboration), M. Carrasco Kind (DES Collaboration), J. Carretero (DES Collaboration), F. Castander (DES Collaboration), R. Cawthon (DES Collaboration), C. Conselice (DES Collaboration), L. da Costa (DES Collaboration), M. da Silva Pereira (DES Collaboration), T. Davis (DES Collaboration), J. De Vicente (DES Collaboration), S. Desai (DES Collaboration), H. Diehl (DES Collaboration), C. Doux (DES Collaboration), A. Drlica-Wagner (DES Collaboration), T. Eifler (DES Collaboration), J. Elvin-Poole (DES Collaboration), S. Everett (DES Collaboration), B. Flaugher (DES Collaboration), P. Fosalba (DES Collaboration), D. Francis de Souza (DES Collaboration), J. Frieman (DES Collaboration), J. Garcia-Bellido (DES Collaboration), E. Gazta\~naga (DES Collaboration), P. Giles (DES Collaboration), G. Gutierrez (DES Collaboration), S. Hinton (DES Collaboration), D. Hollowood (DES Collaboration), K. Honscheid (DES Collaboration), D. Huterer (DES Collaboration), B. Jain (DES Collaboration), D. James (DES Collaboration), K. Kuehn (DES Collaboration), S. Lee (DES Collaboration), H. Lin (DES Collaboration), J. Marshall (DES Collaboration), J. Mena-Fern\'andez (DES Collaboration), F. Menanteau (DES Collaboration), R. Miquel (DES Collaboration), J. Muir (DES Collaboration), R. Ogando (DES Collaboration), A. Palmese (DES Collaboration), D. Petravick (DES Collaboration), A. Plazas Malag\'on (DES Collaboration), A. Roodman (DES Collaboration), R. Rosenfeld (DES Collaboration), S. Samuroff (DES Collaboration), E. S\'anchez (DES Collaboration), I. Sevilla (DES Collaboration), E. Sheldon (DES Collaboration), T. Shin (DES Collaboration), M. Smith (DES Collaboration), E. Suchyta (DES Collaboration), M. Swanson (DES Collaboration), G. Tarl\'e (DES Collaboration), D. Thomas (DES Collaboration), V. Vikram (DES Collaboration), A. Walker (DES Collaboration), P. Wiseman (DES Collaboration)

92. [Automated Exploration of Radical-Molecule Chemistry: The Case of Oxirane + CH in the ISM](#user-content-link92)
**Authors:** Moritz Bensberg, Silvia Alessandrini, Mattia Melosso, Cristina Puzzarini, Markus Reiher

93. [Inferring neutron-star Love-Q relations from gravitational waves in the hierarchical Bayesian framework](#user-content-link93)
**Authors:** Zhihao Zheng, Ziming Wang, Jinwen Deng, Yiming Dong, Lijing Shao

94. [Charge Trap Analysis in a SENSEI Skipper-CCD: Understanding Low-Energy Backgrounds in Rare-Event Searches](#user-content-link94)
...
95. [A Search for Supermassive Black Hole Binary Candidates in 46-Year Radio Light Curves of 83 Blazars](#user-content-link95)
**Authors:** B. Molina, P. Mr\'oz, P. V. De la Parra, A. C. S. Readhead, T. Surti, M. F. Aller, J. D. Scargle, R. A. Reeves, H. Aller, M. C. Begelman, R. D. Blandford, Y. Ding, M. J. Graham, F. Harrison, T. Hovatta, I. Liodakis, M. L. Lister, W. Max-Moerbeck, V. Pavlidou, T. J. Pearson, V. Ravi, A. G. Sullivan, A. Synani, K. Tassis, S. E. Tremblay, J. A. Zensus

96. [A volcanic chronosequence as a time-resolved paleo-detector array to study the cosmic-ray flux in the Late Pleistocene and Holocene](#user-content-link96)
**Authors:** Claudio Galelli, Lorenzo Caccianiga, Lorenzo Apollonio, Paolo Magnani, Vincent Breton

97. [Electroweak Baryogenesis with \texttt{BARYONET}: a self-contained review of the WKB approach](#user-content-link97)
**Authors:** Giulio Barni

98. [Open-Source High-Fidelity Orbit Estimation for Planetary Science and Space Situational Awareness Using the Tudat Software](#user-content-link98)
**Authors:** Luigi Gisolfi, Dominic Dirkx, Sam Fayolle, Valerio Filice, Riva Alkahal, Miguel Avillez, Tristan Dijkstra, Jonas Hener, Lars Hin\"uber, Marco Langbroek, Nicol\`o Maistri, Michael Plumaris, Alejandro Sanchez Rodriguez, Giuseppe Cim\`o, Kevin Cowan, Fabien Dahmani, Jo\~ao Encarnacao, Geoffrey Garrett, Steve Gehly, Xuanyu Hu, Marceau Jeanjean, Antonio L\'opez Rivera, Andrea Minervino Amodio, Guifre Molera Calv\'es, Markus Reichel, Bart Root, Martin S{\o}ndergaard, Dominik Stiller, Simon Van Hulle, Gijs Verdoes Kleijn, Rees Williams, Daan Witte

99. [Beyond Point Matching: Evaluating Multiscale Dubuc Distance for Time Series Similarity](#user-content-link99)
**Authors:** Azim Ahmadzadeh, Mahsa Khazaei, Elaina Rohlfing

100. [Generating background-corrected VPHAS+ HiPS with Montage](#user-content-link100)
**Authors:** Thomas Boch, Caroline Bot, Pierre Fernique

101. [Instability and vertical eccentricity variation in global hydrodynamic disk simulations](#user-content-link101)
**Authors:** Janosz W. Dewberry, Henrik N. Latter, Gordon I. Ogilvie, Sebastien Fromang

102. [The velocity dispersion profile of nine open clusters in the solar neighborhood](#user-content-link102)
**Authors:** Bingqian Ma (Department of Physics, Xi'an Jiaotong-Liverpool University), XiaoYing Pang (Department of Physics, Xi'an Jiaotong-Liverpool University, Shanghai Key Laboratory for Astrophysics, Shanghai Normal University), Sambaran Banerjee (Helmholtz-Instituts f\H{u}r Strahlen-und Kernphysik), Pengfei Ren (Department of Physics, Xi'an Jiaotong-Liverpool University), M. B. N. Kouwenhoven (Department of Physics, Xi'an Jiaotong-Liverpool University)

103. [A targeted radio survey of infrared-selected bow shock candidates](#user-content-link103)
**Authors:** M. Moutzouri, J. Mackey, N. Castro, Y. Gong, P. Jim\'enez-Hern\'andez, J. A. Toal\'a, C. Burger-Scheidlin, M. Rugel, C. Carrasco-Gonz\'alez, R. Brose, K. M. Menten

104. [Evidence for Dynamical Dark Energy using DESI DR2 Ly$\alpha$ Forest](#user-content-link104)
**Authors:** Salvatore Capozziello, Himanshu Chaudhary, G. Mustafa, S. K. J. Pacif

105. [The variability angular diameter distance and the intrinsic brightness temperature of active galactic nuclei](#user-content-link105)
**Authors:** Whee Yeon Cheong (University of Science and Technology, Republic of Korea, Korea Astronomy and Space Science Institute), Sang-Sung Lee (University of Science and Technology, Republic of Korea, Korea Astronomy and Space Science Institute), Chanwoo Song (University of Science and Technology, Republic of Korea, Korea Astronomy and Space Science Institute), Jeffrey Hodgson (Department of Physics and Astronomy, Sejong University), Sanghyun Kim (Korea Astronomy and Space Science Institute), Hyeon-Woo Jeong (University of Science and Technology, Republic of Korea, Korea Astronomy and Space Science Institute), Young-Bin Shin (University of Science and Technology, Republic of Korea, Korea Astronomy and Space Science Institute), Sincheol Kang (Korea Astronomy and Space Science Institute)

106. [Probing Axion-Photon conversion via circular polarization imprints in the CMB $V$-mode observations](#user-content-link106)
**Authors:** Ashu Kushwaha, Rajeev Kumar Jain

107. [Development of the Reconstruction Procedure of the Fluorescence detector Array of Single-pixel Telescopes for measuring Ultra-High Energy Cosmic Rays](#user-content-link107)
**Authors:** Fraser Bradfield

108. [FOXES: A Framework For Operational X-ray Emission Synthesis](#user-content-link108)
...
109. [Seafloor Topography Enhances KM3NeT Sensitivity to ANITA-like Events](#user-content-link109)
**Authors:** Carlos A. Arg\"uelles, Toni Bert\'olez-Mart\'inez, Alba Burgos-Mond\'ejar, Anne-Katherine Burns, Jacobo Lopez-Pavon, Jordi Salvado

110. [Observable Signatures of Quarkyonic Phase in Neutron Stars](#user-content-link110)
**Authors:** Probit J Kalita, Tuhin Malik, Tianqi Zhao, Bharat Kumar, James M. Lattimer

111. [The Missing Mechanism: Picoflare Heating in the Solar Corona](#user-content-link111)
**Authors:** Olena Podladchikova

112. [Learning and Interpreting Gravitational-Wave Features from CNNs with a Random Forest Approach](#user-content-link112)
**Authors:** Jun Tian, He Wang, Jibo He, Yu Pan, Shuo Cao, Qingquan Jiang

113. [Prospects for Observing the Microquasar SS 433 with the LACT Array](#user-content-link113)
**Authors:** Zhen Xie, Zhipeng Zhang, Ruizhi Yang

114. [Multivariate Time Series Classification of Fermi - Detected Gamma-Ray Transients Using Convolutional-Recurrent Neural Networks](#user-content-link114)
**Authors:** Arpan Aryam John, Krushna Govind Shete, Shabnam Iyyani, Saptarshi Bej

115. [Energetics of star-planet magnetic interactions: Novel insights from 3D modelling](#user-content-link115)
**Authors:** Arghyadeep Paul, Antoine Strugarek

116. [Fine details in solar flare ribbons: Statistical insights from observations with the Swedish 1-m Solar Telescope](#user-content-link116)
**Authors:** Jonas Thoen Faber, Reetika Joshi, Luc Rouppe van der Voort, Sven Wedemeyer, Eilif Sommer {\O}yre, Ignasi J. Soler Poquet, Aline Rang{\o}y Brunvoll

117. [Discriminating Between Models of the Nanohertz Gravitational-Wave Background with Pulsar Timing Arrays](#user-content-link117)
**Authors:** Mengshen Wang, Zuocheng Zhang, Hua Xu

118. [Impact of Charge Transfer Inefficiency on transit light-curves: A correction strategy for PLATO](#user-content-link118)
**Authors:** Shaunak Mishra, Reza Samadi, Diane B\'erard

119. [Earth Analogs in Reflected Light: Insights from Early Spectral Characterization in Unconstrained Orbits](#user-content-link119)
**Authors:** Arnaud Salvador, Tyler D. Robinson

120. [Constraint on the physical origin of GRB prompt emission via its non-detected diffuse neutrino emission](#user-content-link120)
**Authors:** Yang-Dong-Jun Ou, Hou-Jun L\"u, Jia-Ming Chen, Ben-Yang Zhu, En-Wei Liang

121. [Coronal Mass Ejections Deflected by Newly Emerging Flux: A Combined Analytic and Numerical Study](#user-content-link121)
...
122. [Testing the cosmic distance duality relation using model-independent approach](#user-content-link122)
**Authors:** Shubham Barua, Sujit K. Dalui, Rikiya Okazaki, Shantanu Desai

123. [Solar flare forecasting with foundational transformer models across image, video, and time-series modalities](#user-content-link123)
**Authors:** S. Riggi, P. Romano, A. Pilzer, U. Becciani

124. [Can KM3-230213A be compatible with a cosmogenic origin?](#user-content-link124)
**Authors:** The KM3NeT collaboration

125. [Symmetry principles of gravitational perturbations in thermal environments](#user-content-link125)
**Authors:** Atsuhisa Ota

126. [Ultraviolet Spectral Evidence for Ansky as a Slowly Evolving Featureless Tidal Disruption Event with Quasi-periodic Eruptions](#user-content-link126)
...
127. [Shadows of the Colossus: Hierarchical Black Hole Mergers in a 10-million-body Globular Cluster Simulation](#user-content-link127)
**Authors:** Aidan Mai, Kyle Kremer, Fulya Kiroglu

128. [Validation of field cage and cathode for low radioactivity operation with the CYGNO experiment](#user-content-link128)
...
129. [Exploring the Landscape of Spontaneous CP Violation in Supersymmetric Theories](#user-content-link129)
**Authors:** Fangchao Liu, Shota Nakagawa, Yuichiro Nakai, Yaoduo Wang

130. [Quasi-Biennial Oscillations and Rieger-type Periodicities in a Babcock-Leighton Solar Dynamo](#user-content-link130)
**Authors:** Pawan Kumar, Belur Ravindra, Partha Chowdhury, Bidya Binay Karak

131. [The Ultra Slow-Roll Phase Of Warm Inflation In Braneworld Cosmology](#user-content-link131)
**Authors:** Aarav Shah

132. [A Search for Ultra-Light Vector Dark Matter with a Rotating Torsion Balance](#user-content-link132)
**Authors:** M. P. Ross, E. A. Shaw, C. Gettings, S. K. Apple, I. A. Paulson, J. H. Gundlach

133. [Thermodynamic Geodesics in Bardeen Regular Black Hole: Conventional vs. Modified Geometrothermodynamics Metrics](#user-content-link133)
**Authors:** Gunindra Krishna Mahanta

134. [Exploring the accelerating black holes from the observations of quasi-periodic oscillations in X-ray binaries](#user-content-link134)
**Authors:** Hamza Rehman, Saddam Hussain, G. Abbas, Tao Zhu

135. [A test of Amati relation using HII galaxy distances](#user-content-link135)
**Authors:** Rikiya Okazaki, Shantanu Desai

136. [Likelihood Reconstruction for Radio Detectors of Neutrinos and Cosmic Rays](#user-content-link136)
**Authors:** Martin Ravn, Christian Glaser, Thorsten Gl\"usenkamp, Ayca \"Ocelikkale, Alan Coleman

137. [A Statistical Study of delta-Sunspots from Solar Cycle 23 to 25](#user-content-link137)
**Authors:** Rohan E. Louis

138. [Radio Follow-Up Observations of a Weak-Line Quasar Exhibiting Remarkable X-ray Variability](#user-content-link138)
...
139. [Definition of Exoplanets and Brown Dwarfs](#user-content-link139)
**Authors:** Jean Schneider

140. [Propellantless space exploration](#user-content-link140)
**Authors:** Roman Ya. Kezerashvili

---

## 1. [The First Star-by-star $N$-body/Hydrodynamics Simulation of Our Galaxy Coupling with a Surrogate Model](https://arxiv.org/abs/2510.23330) <a id="link1"></a>
...
**Comment:** Presents the first star-by-star N-body/hydrodynamics simulation of the Milky Way, using a surrogate model to bypass supernova timestep limitations. Directly relevant to the numerical galaxy simulations criterion, with extremely high resolution and new methodology.
...
## 2. [The Cosmic Baryon Cycle in IllustrisTNG: flows of mass, energy, and metals](https://arxiv.org/abs/2510.23343) <a id="link2"></a>
...
**Comment:** Analyzes inflows and outflows of mass, energy, and metals in the ISM and CGM of galaxies using the IllustrisTNG100 simulations. Directly matches the criteria for numerical galaxy simulations, star formation driven outflows (mass-loading factors), and circumgalactic medium studies. Highly relevant.
...
## 4. [The MandelZoom project II: the impact of stellar feedback on black hole accretion through an $\alpha$-disc in dwarf galaxies with a resolved interstellar medium](https://arxiv.org/abs/2510.23548) <a id="link4"></a>
...
**Comment:** Presents high-resolution simulations of dwarf galaxies with resolved ISM, focusing on the impact of stellar feedback on black hole accretion. This matches the 'Numerical Galaxy Simulations' criterion, with increased weight due to inclusion of new physics (stellar feedback channels) and high resolution. The focus on dwarf galaxies further increases relevance.
...
## 5. [Beyond the Local Group - I: Cosmic Filaments Govern the Spatial Alignments of Galaxy Pairs](https://arxiv.org/abs/2510.22598) <a id="link5"></a>
...
**Comment:** This paper investigates the spatial alignment of galaxy pairs (including MW-M31 analogs) with cosmic filaments, providing insights into Local Group assembly and the role of the cosmic web. This is highly relevant to near-field cosmology, especially regarding the assembly history and environment of the Milky Way and its satellites.
...
## 6. [HI Content of Group Galaxies from the FAST All Sky HI Survey](https://arxiv.org/abs/2510.22902) <a id="link6"></a>
...
**Comment:** This paper uses the FAST HI survey to study the atomic gas content of group galaxies, distinguishing between satellites and centrals. The focus on HI content of satellites and environmental effects is relevant to 'Near-Field Cosmology' and 'Star Formation Quenching', especially as it discusses HI depletion in satellites, which is a key aspect of quenching in low-mass galaxies.
...
## 8. [Unveiling stellar (and planetary) internal dynamics with the fully compressible MUSIC code](https://arxiv.org/abs/2510.23505) <a id="link8"></a>
...
**Comment:** Reviews recent applications of the MUSIC code for multidimensional hydrodynamical simulations of stellar interiors, focusing on convection, boundary mixing, and waves. This matches the 'Stellar Models' criterion, as it presents new methods for modeling stellar interiors and processes relevant to stellar evolution.
...
## 9. [SWIFTGalaxy: a Python package to work with particle groups from SWIFT simulations](https://arxiv.org/abs/2510.22328) <a id="link9"></a>

**ArXiv ID:** 2510.22328

**Authors:** Kyle A. Oman (Durham-ICC, Durham-CEA)

**Abstract:** SWIFTGalaxy is an open-source astrophysics module that extends SWIFTSimIO to analyses of particles belonging to individual galaxies simulated with SWIFT. It inherits from and extends the functionality of SWIFTSimIO's SWIFTDataset class. It understands the content of halo catalogues and therefore which particles belong to a galaxy or other group of particles, and its integrated properties. The particles occupy a coordinate frame that is enforced to be consistent, such that particles loaded on-the-fly will match e.g.~rotations and translations of particles already in memory. Intuitive masking of particle datasets is also enabled. Utilities to make working in cylindrical and spherical coordinate systems more convenient are also provided. Finally, tools to iterate efficiently over multiple galaxies are provided.

**Comment:** This paper presents a Python package for analyzing particle groups from SWIFT galaxy simulations. It is directly relevant to the 'Numerical Galaxy Simulations' criterion, as it provides new tools for working with simulated galaxies and their properties.
...
## 10. [Fundamental effective temperature measurements for eclipsing binary stars - VI. Improved methodology and application to the circumbinary planet host star BEBOP-3](https://arxiv.org/abs/2510.23218) <a id="link10"></a>
...
**Comment:** This paper presents improved methodology for measuring effective temperatures in eclipsing binary stars, including new bolometric corrections and direct measurements of stellar parameters. This fits the 'Stellar Models' criterion, as it provides new data and methods for testing stellar atmosphere and evolutionary models.
...
## 15. [Discovery of SN 2025wny: a Strongly Gravitationally Lensed Superluminous Supernova at z = 2.01](https://arxiv.org/abs/2510.23533) <a id="link15"></a>
...
**Comment:** This paper reports the discovery of a strongly lensed superluminous supernova at z=2.01, with implications for studying distant supernovae and internal properties of dwarf galaxies. The mention of using lensed SNe to study dwarf galaxies and their properties makes it relevant to 'Near-Field Cosmology', though the main focus is on the supernova and lensing.
...
## 16. [Evaluating the chromospheric structure model of AD Leo using RH1.5D and magnetic field data](https://arxiv.org/abs/2510.23072) <a id="link16"></a>
...
**Comment:** This paper evaluates chromospheric structure models for an active M dwarf using spectroscopic and magnetic field data. It is relevant to stellar atmosphere and interior modeling, matching the 'Stellar Models' criterion, though it is focused on a single star rather than providing new model grids or evolutionary tracks.
...
## 17. [Tracing The Start and End of Cosmic Reionization - Exploring The Role of Ionizing Sources as drivers](https://arxiv.org/abs/2510.22043) <a id="link17"></a>
...
**Comment:** This thesis investigates cosmic reionization using radiation-hydrodynamics simulations, including the UV luminosity function of high-redshift galaxies and the impact of feedback models. It is relevant to 'Numerical Galaxy Simulations' and touches on galaxy formation and feedback, though the focus is on the early universe and not specifically on dwarf galaxies or resolved star formation histories.
...
## 18. [Cosmic Vine: High abundance of massive galaxies and dark matter halos in a forming cluster at z=3.44](https://arxiv.org/abs/2510.23549) <a id="link18"></a>
...
**Comment:** Studies the abundance and properties of massive galaxies and dark matter halos in a protocluster at high redshift. While it discusses satellite subgroups and quiescent galaxies, the focus is on massive galaxies and cluster formation, not on dwarf satellites or near-field cosmology. Some relevance to star formation quenching in overdense environments, but weighted lower due to mass scale.
...
## 21. [Under Pressure: Decoding the Effect of High Densities on Derived Nebular Properties](https://arxiv.org/abs/2510.21960) <a id="link21"></a>
...
**Comment:** This paper presents a joint UV and optical abundance analysis using new photoionization models for a sample of star-forming galaxies across a wide redshift range. It discusses nebular diagnostics, chemical abundances, and the impact of high-density environments on abundance determinations. While the sample includes star-forming galaxies, the focus is on chemical evolution and nebular diagnostics, which is tangentially related to resolved star formation histories and stellar models, but does not directly address dwarf galaxies or near-field cosmology.
...
## 22. [Revisiting the 150 MHz Radio Luminosity Function of Star-Forming Galaxies with LOFAR Deep Fields through a Refined Statistical Framework](https://arxiv.org/abs/2510.22934) <a id="link22"></a>
...
**Comment:** This paper analyzes the radio luminosity function of star-forming galaxies using LOFAR data and advanced statistical methods. It is relevant to the study of star formation rates and galaxy evolution, but does not focus on resolved star formation histories, dwarf galaxies, or simulations. Borderline relevance due to its focus on star-forming galaxies and luminosity functions.
...
## 23. [The MiMO Catalog: Physical Parameters and Stellar Mass Functions of 1,232 Open Clusters from Gaia DR3](https://arxiv.org/abs/2510.23374) <a id="link23"></a>
...
**Comment:** Presents a catalog of open clusters with physical parameters and stellar mass functions derived from Gaia DR3 data. The work involves color-magnitude diagram modeling and mass function estimation, which is tangentially related to the 'Stellar Models' criterion, but focuses on open clusters rather than dwarf galaxies or resolved star formation histories.
...
## 24. [Multi-Modal Masked Autoencoders for Learning Image-Spectrum Associations for Galaxy Evolution and Cosmology](https://arxiv.org/abs/2510.22527) <a id="link24"></a>
...
**Comment:** Presents a multi-modal masked autoencoder for learning image-spectrum associations for galaxy evolution and cosmology. While it deals with galaxy images and spectra, it does not specifically address resolved star formation histories, dwarf galaxies, or other core topics. Some relevance for numerical methods in galaxy studies, but not a direct match.
...
## 25. [SHELLQs-JWST: Revealing the Spectra of Extended Emission in 12 z > 6 Quasar Host Galaxies using the JWST NIRSpec Fixed Slit](https://arxiv.org/abs/2510.22403) <a id="link25"></a>
...
**Comment:** Analyzes extended emission in z > 6 quasar host galaxies, including ionized outflows and star formation rates. While it discusses outflows and star formation, the focus is on massive quasar hosts at high redshift, not dwarf galaxies or star-formation-driven outflows in the local universe. Borderline relevance.
...
## 27. [Validating Open Cluster Candidates with Photometric Bayesian Evidence](https://arxiv.org/abs/2510.23375) <a id="link27"></a>
...
**Comment:** Describes a Bayesian framework for validating open cluster candidates using color-magnitude diagrams. While it involves resolved stellar populations, the focus is on cluster validation rather than deriving star formation histories or modeling stellar evolution.
...
## 28. [The Velocity Map Asymmetry of Ionized Gas in MaNGA II. Correlation between Velocity Map Morphology, Star Formation, and Metallicity in Regular Disk Galaxies](https://arxiv.org/abs/2510.22983) <a id="link28"></a>
...
**Comment:** This paper studies the kinematics, star formation, and metallicity in regular disk galaxies using MaNGA data. While it discusses star formation and metallicity, the focus is on regular disk galaxies, not dwarfs or satellites, and does not directly address resolved star formation histories, quenching in dwarfs, or near-field cosmology. The mention of feedback-driven outflows is secondary and not the main focus.
...
## 29. [Alma Luminous Star catalogue IV: A Massive star census in the Magellanic Clouds](https://arxiv.org/abs/2510.23338) <a id="link29"></a>

**ArXiv ID:** 2510.23338

**Authors:** J. A. Molina-Calzada, J. Ma\'iz Apell\'aniz

**Abstract:** The fourth part of the Alma Luminous Star catalogue (ALS IV) aims to create the most comprehensive sample of massive stars in the Magellanic Clouds (MCs). By combining Gaia DR3 with Simbad and complementing this information with other photometric and spectroscopic catalogues, we select the massive stars in this region. To achieve this, we apply filters in photometry, combining different bands, as well as in variability and spectral types from the literature. With this approach, we will obtain one of the most complete samples of massive stars in the MCs, which can be used both to study the Clouds and the Magellanic Bridge, as well as the massive stars they contain.

**Comment:** This paper presents a census of massive stars in the Magellanic Clouds using Gaia and other catalogs. While the Magellanic Clouds are relevant environments, the focus is on massive stars rather than dwarf galaxies, resolved star formation histories, or near-field cosmology. The catalog could be useful for studies of the Magellanic Bridge and star formation, but the direct relevance is limited.
...
## 31. [Analytic Marginalization over Binary Variables in Physics Data](https://arxiv.org/abs/2510.21912) <a id="link31"></a>
...
**Comment:** The paper presents analytic marginalization over binary variables in physics data, with applications including Type Ia supernova calibration. While supernova calibration is important for cosmology, the focus here is on statistical methods and does not directly address near-field cosmology, dwarf galaxies, or the other core topics.
...
## 33. [K-DRIFT: Unveiling New Imagery of the Hidden Universe](https://arxiv.org/abs/2510.22250) <a id="link33"></a>
...
**Comment:** K-DRIFT is a technical paper about a new telescope for low-surface-brightness imaging, which could be relevant for studies of galaxy interactions and dark matter distribution. However, it does not directly address any of the core criteria such as dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 34. [Recasting and Forecasting Dark Matter Limits Without Raw Data: A Generalized Algorithm for Gamma-Ray Telescopes](https://arxiv.org/abs/2510.23168) <a id="link34"></a>
...
**Comment:** Presents a generalized algorithm for recasting and forecasting dark matter limits using gamma-ray telescopes. While dark matter is relevant to near-field cosmology, the focus here is on indirect detection methods and instrument response, not on dwarf galaxies, satellite luminosity functions, or core-cusp measurements.
...
## 36. [SN 2024iss: A Double-peaked Type IIb Supernova with Evidence of Circumstellar Interaction](https://arxiv.org/abs/2510.22997) <a id="link36"></a>
...
**Comment:** This paper presents multi-wavelength observations and modeling of a Type IIb supernova, focusing on its envelope properties, mass-loss rate, and binary interaction scenario. While it discusses stellar evolution and mass loss, it does not present new stellar models or focus on galaxy-scale processes, star formation histories, or dwarf galaxies. Marginal relevance to stellar models, but not a direct match.
...
## 37. [SN2017ckj: A linearly declining Type IIb supernova with a relatively massive hydrogen envelope](https://arxiv.org/abs/2510.22989) <a id="link37"></a>
...
**Comment:** This paper presents observations and modeling of a Type IIb supernova, focusing on its hydrogen envelope and mass-loss rate. While it discusses stellar evolution and mass loss, it does not present new stellar models or address galaxy-scale processes, star formation histories, or dwarf galaxies. Marginal relevance to stellar models, but not a direct match.
...
## 38. [Living with Neighbors. V. Better-aligned Spiral+Spiral Galaxy Pairs Show Stronger Star Formation](https://arxiv.org/abs/2510.22156) <a id="link38"></a>
...
**Comment:** This paper studies star formation enhancement in spiral galaxy pairs, focusing on the effect of spin alignment. While it discusses star formation, the work is on massive spiral galaxies and their interactions, not on dwarf galaxies or resolved star formation histories.
...
## 39. [Unveiling the collision between molecular outflows: observational evidence and hydrodynamic simulations](https://arxiv.org/abs/2510.23526) <a id="link39"></a>
...
**Comment:** This paper investigates the collision between molecular outflows in a star-forming region using observations and hydrodynamic simulations. While it deals with outflows, the context is star formation regions (likely within the Milky Way) and not galaxy-scale outflows or CGM. Only weak relevance to 'Star Formation Driven Outflows'.
...
## 40. [Cosmic magnification on multi-catalogue Herschel submillimetre galaxies](https://arxiv.org/abs/2510.23582) <a id="link40"></a>
...
**Comment:** The paper analyzes cosmic magnification using submillimetre galaxies to constrain cosmological parameters. While it deals with galaxy populations, it does not focus on dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 41. [Spatially Resolved, Multiphase Mass Outflows of the Seyfert 1 Galaxy NGC 3227](https://arxiv.org/abs/2510.23000) <a id="link41"></a>

**ArXiv ID:** 2510.23000

**Authors:** Julia Falcone, D. Michael Crenshaw, Mitchell Revalski, Travis C. Fischer, Beena Meena, Maura Kathleen Shea, Jacob Tutterow, Zo Chapman, Kesha Patel

**Abstract:** We present spatially resolved mass outflow rates of the ionized and molecular gas in the narrow line region of the Seyfert 1 galaxy NGC 3227. Using long-slit spectroscopy and [O III] imaging from from Hubble Space Telescope's Space Telescope Imaging Spectrograph and Apache Point Observatory's Kitt Peak Ohio State Multi-Object Spectrograph, in conjunction with Cloudy photoionization models and emission line diagnostics, we find a peak ionized mass outflow rate of $\dot M_{\text{ion}} =$ $19.9\pm9.2$ M$_\odot$ yr$^{-1}$ at a distance of $47\pm6$ pc from the supermassive black hole (SMBH). Using archival data from the Gemini-North Near-infrared Field Spectrograph measuring H$_2$ $\lambda2.1218$ $\mu$m emission, we find a maximum peak warm molecular outflow rate of $\dot M_{\mathrm{H_2}} \le 9 \times 10^{-4}$ M$_\odot$ yr$^{-1}$ at a distance of $36\pm6$ pc from the SMBH. Using archival data from the Atacama Large Millimeter/submillimeter Array measuring CO(2-1) emission, we find a maximum peak cold molecular gas mass outflow rate of $\dot M_{\mathrm{CO}} \le$ $23.1$ M$_\odot$ year$^{-1}$ at a distance of $57\pm6$ pc from the SMBH. For the first time, we calculate spatially resolved gas evacuation timescales for the cold molecular gas reservoirs ostensibly sourcing the outflows, and find that evacuating gas to $\sim$400 pc from the SMBH occurs on timescales of $10^{6.0} - 10^{7.6}$ years. These results indicate that the multi-phase AGN outflows are effective in clearing the inner few hundred parsecs of NGC 3227's gas content on timescales that may set the AGN duty cycle of $10^5 - 10^8$ years.

**Comment:** The paper presents spatially resolved mass outflow rates in the Seyfert 1 galaxy NGC 3227, focusing on multiphase outflows. However, the outflows are AGN-driven and the host galaxy is a massive spiral, not a dwarf. The study does not address star-formation-driven outflows or the CGM of dwarf galaxies, making it only tangentially relevant.
...
## 42. [From Rare Events to a Population: Discovering Overlooked Extragalactic Magnetar Giant Flare Candidates in Archival Fermi Gamma-ray Burst Monitor Data](https://arxiv.org/abs/2510.23367) <a id="link42"></a>
...
**Comment:** Searches for extragalactic magnetar giant flares in Fermi data. While it deals with rare events in extragalactic environments, it does not focus on dwarf galaxies, star formation histories, quenching, or the other core topics.
...
## 43. [The Compressed 3D Lyman-Alpha Forest Bispectrum](https://arxiv.org/abs/2510.23597) <a id="link43"></a>
...
**Comment:** Presents a compressed bispectrum analysis for the 3D Lyman-Alpha forest, relevant for cosmological parameter estimation. The Lyman-Alpha forest is not directly related to near-field cosmology, dwarf galaxies, or the other core topics.
...
## 44. [Some Properties of Multi-Component Axion Dark Matter](https://arxiv.org/abs/2510.22569) <a id="link44"></a>
...
**Comment:** Discusses multi-component axion dark matter from axion mixing, with implications for dark matter composition. While dark matter is relevant to cosmology, the focus is on axion physics and not on near-field cosmology, galaxy evolution, or the other core topics.
...
## 45. [Do Young Suns Produce Frequent, Massive CMEs? Results from Five-year Dedicated Optical Observations of EK Draconis and V889 Hercules](https://arxiv.org/abs/2510.22111) <a id="link45"></a>
...
**Comment:** Observational campaign on young solar-type stars to constrain coronal mass ejections (CMEs) and mass loss rates. While it discusses stellar outflows, the focus is on individual stars, not galaxies or galaxy-scale outflows. No criteria match closely.
...
## 47. [The Solar Neighborhood. LV. M Dwarf Twin Binaries -- One in Five Twin Sibling Pairs Are Mismatched in Activity and/or Rotation](https://arxiv.org/abs/2510.22093) <a id="link47"></a>

**ArXiv ID:** 2510.22093

**Authors:** Andrew A. Couperus, Todd J. Henry, Aman Kar, Wei-Chun Jao, Eliot Halley Vrijmoet, Rachel A. Osten

**Abstract:** We report on a study of 36 pairs of `twin' M dwarfs in wide binaries and assess how similarly the stars behave. Stars in each twin pair have BP, RP, $J$, $H$, and $K_s$ differing by $<$0.10 mag, mass estimates matching within $$25% differences exist in rotation period for $21\%_{-7\%}^{+14\%}$ of twin pairs, in rotation amplitude for $67\%_{-15\%}^{+10\%}$ of pairs, in multi-year photometric variability for $33\%_{-9\%}^{+12\%}$ of pairs, and in H$\alpha$ activity for $21\%_{-6\%}^{+9\%}$ of pairs, with fully convective systems generally mismatched more often. Thus, roughly one out of five M dwarf twin sets does not match in rotation and/or activity despite otherwise identical fundamental parameters. Furthermore, we compile three key systems showing larger relative active/inactive H$\alpha$ mismatches. We propose the various mismatches likely stem from factors such as dynamo stochasticity, activity cycles, formative disk aspects, and/or star-planet interactions, depending on the system. These well-vetted twins offer ripe targets for many future investigations.

**Comment:** This paper studies rotation and activity mismatches in wide binary M dwarfs. While it touches on stellar activity and rotation, it does not present new stellar models or focus on star formation histories, quenching, or galaxy simulations. It is only tangentially related to the core topics.
...
## 48. [Dark Energy Survey Year 6 Results: Clustering-redshifts and importance sampling of Self-Organised-Maps $n(z)$ realizations for $3\times2$pt samples](https://arxiv.org/abs/2510.23565) <a id="link48"></a>
...
**Comment:** This paper focuses on photometric redshift estimation and clustering-redshift calibration for cosmological analyses in DES Y6. While it is relevant to cosmological surveys, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations. No direct relevance to dwarf galaxies, star formation, or outflows.
...
## 49. [The Near-Ultraviolet Spectra of FU Orionis Accretion Disks](https://arxiv.org/abs/2510.23390) <a id="link49"></a>
...
**Comment:** Presents NUV spectra of FU Orionis accretion disks and compares with accretion disk models. The focus is on young stellar objects and accretion physics, not on galaxy-scale processes, resolved star formation histories, or stellar models relevant to the prompt.
...
## 50. [COMAP Pathfinder -- Season 2 results IV. A stack on eBOSS/DESI quasars](https://arxiv.org/abs/2510.23568) <a id="link50"></a>
...
**Comment:** This paper presents a stack of CO intensity mapping data on quasars at z~3, aiming to constrain molecular gas in quasar environments. While it discusses environmental effects and feedback, the focus is on high-redshift quasars and their environments, not on dwarf galaxies, resolved star formation histories, or near-field cosmology.
...
## 51. [Galactic bars and active galactic nucleus fuelling in the second half of cosmic history](https://arxiv.org/abs/2510.23522) <a id="link51"></a>
...
**Comment:** The paper investigates the role of galactic bars in fueling AGN in disc galaxies up to z~0.8. While it discusses AGN fueling and the role of bars, it is focused on higher mass galaxies and AGN, not on dwarf galaxies, near-field cosmology, or star-formation-driven outflows.
...
## 53. [Avoiding PBH overproduction in inflation model with modified dispersion relation](https://arxiv.org/abs/2510.22218) <a id="link53"></a>
...
**Comment:** Discusses primordial black hole overproduction and inflation models, which is cosmology but not near-field cosmology or any of the other core topics. No direct connection to dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 54. [A new group of low-spin $50-70M_\odot$ Black Holes and the high pair-instability mass cutoff](https://arxiv.org/abs/2510.22698) <a id="link54"></a>
...
**Comment:** Discusses the emergence of a new group of low-spin, massive black holes and the pair-instability mass cutoff, using gravitational wave data. The focus is on black hole populations and supernovae, not on galaxies, star formation, or stellar models.
...
## 56. [XRISM constraints on the velocity power spectrum in the Coma cluster](https://arxiv.org/abs/2510.21918) <a id="link56"></a>
...
**Comment:** This paper focuses on the velocity power spectrum in the Coma cluster, a massive galaxy cluster, and discusses turbulent energy injection and gas motions. While it deals with intracluster medium and turbulence, it does not address dwarf galaxies, near-field cosmology, resolved star formation histories, or star-formation-driven outflows. The focus on clusters makes it largely irrelevant to the core topics.
...
## 61. [Morphological and Kinematical Diagnostic of FU Orionis-type Outburst Mechanisms](https://arxiv.org/abs/2510.22927) <a id="link61"></a>
...
**Comment:** The paper uses numerical simulations to study outburst mechanisms in protoplanetary disks (FU Orionis-type). While it involves numerical simulations, the focus is on star and planet formation, not galaxy simulations or the other core topics.
...
## 62. [QUEST (Quasar Unsupervised Encoder and Synthesis Tool): A machine learning framework to generate quasar spectra](https://arxiv.org/abs/2510.23206) <a id="link62"></a>
...
**Comment:** Presents a machine learning tool for generating quasar spectra, which is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 63. [First detection of ultra-high energy emission from gamma-ray binary LS I +61 303](https://arxiv.org/abs/2510.23345) <a id="link63"></a>
...
**Comment:** Reports detection of ultra-high energy emission from a gamma-ray binary, which is not related to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 65. [Cosmic magnification on high-redshift submillimeter galaxies](https://arxiv.org/abs/2510.22633) <a id="link65"></a>
...
**Comment:** The paper reviews cosmic magnification using high-redshift submillimeter galaxies as background sources for weak lensing studies. While it deals with cosmological inference, it does not focus on dwarf galaxies, resolved star formation histories, or the other core topics.
...
## 66. [Photometric and Spectroscopic Studies of Four Low Mass-ratio Contact Binaries with Period Longer than 0.7 days](https://arxiv.org/abs/2510.22278) <a id="link66"></a>
...
**Comment:** This paper presents photometric and spectroscopic studies of low mass-ratio contact binaries, focusing on their properties and activity. While it discusses stellar evolution and activity, it does not present new stellar models or address the other core topics.
...
## 67. [Discovery and Timing Follow-Up of Two FAST-Discovered Pulsars from the FAST CRAFTS Survey](https://arxiv.org/abs/2510.22910) <a id="link67"></a>
...
**Comment:** Discovery and timing of two pulsars, with some discussion of electron density models in the Milky Way. While it touches on Galactic structure, it does not focus on dwarf galaxies, satellite systems, or any of the core topics.
...
## 68. [Probing AGN-ISM Feedback through Extended X-ray Emission in ESO 137-G034](https://arxiv.org/abs/2510.22453) <a id="link68"></a>
...
**Comment:** This paper analyzes AGN feedback via X-ray emission in a Compton-thick AGN, focusing on the circumnuclear environment. It is not relevant to star-formation-driven outflows, dwarf galaxies, or galaxy simulations, as the feedback is AGN-driven and the galaxy is massive.
...
## 69. [Constraining and Comparing the Dynamical Dark Energy and f(R) Modified Gravity Models with Cosmological Distance Measurements](https://arxiv.org/abs/2510.23105) <a id="link69"></a>
...
**Comment:** This paper constrains dark energy and modified gravity models using cosmological distance measurements. It does not address any of the core topics such as galaxy simulations, star formation, or dwarf galaxies.
...
## 70. [Separation of gain fluctuations and continuum signals in total power spectrometers with application to COMAP](https://arxiv.org/abs/2510.23502) <a id="link70"></a>
...
**Comment:** This paper describes a time-domain technique for separating gain fluctuations and continuum signals in total power spectrometers, with application to the COMAP instrument. While it discusses improvements in data analysis for line intensity mapping and Galactic continuum observations, it does not directly address any of the core topics such as near-field cosmology, resolved star formation histories, or stellar models.
...
## 71. [Constraining the Hubble Constant using Cross-Correlation of Gravitational Wave Events with Flux-Limited Galaxy Catalog](https://arxiv.org/abs/2510.22187) <a id="link71"></a>
...
**Comment:** Describes a Bayesian formalism to constrain the Hubble constant using cross-correlation of gravitational wave events with galaxy catalogs. The focus is on cosmological parameter estimation, not on near-field cosmology, star formation histories, or galaxy simulations.
...
## 72. [On the acceleration of cosmic rays at the post-adiabatic shocks of supernova remnants](https://arxiv.org/abs/2510.21988) <a id="link72"></a>

**ArXiv ID:** 2510.21988

**Authors:** O. Petruk, R. Bandiera, T. Kuzyo, R. Brose, A. Ingallinera

**Abstract:** When a supernova remnant (SNR) interacts with the dense material of an interstellar cloud, its shock wave decelerates rapidly, and the post-shock temperature drops to levels that permit efficient cooling of the shocked plasma. At this stage, the shock enters the post-adiabatic phase of its evolution. During this phase, the internal structure of the SNR undergoes significant changes, particularly in the immediate post-shock region, at spatial scales relevant to cosmic ray acceleration. Once the shock enters the post-adiabatic regime, the efficiency of diffusive shock acceleration increases due to a higher plasma compression, to a change in the direction of the advection velocity, and to an increased rate of momentum gain. As a result, the momentum spectrum of relativistic particles hardens, deviating from a pure power law at high energies. Particles could reach higher maximum values compared to classical predictions. We highlight the dynamics of post-adiabatic flows in SNRs, study their impact on particle acceleration, and present supporting observational evidence in the radio band.

**Comment:** Focuses on cosmic ray acceleration in supernova remnants interacting with interstellar clouds. While it discusses SNRs and shock physics, it does not directly address any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 73. [Superhorizon Isocurvature as a Window into Dark Matter Production](https://arxiv.org/abs/2510.21917) <a id="link73"></a>
...
**Comment:** Discusses isocurvature perturbations and dark matter production mechanisms in the early universe. No direct connection to any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 74. [Luminosity Functions and Detectability of Binary Neutron Star Merger-nova Signals with Various Merger Remnants](https://arxiv.org/abs/2510.23115) <a id="link74"></a>
...
**Comment:** Focuses on luminosity functions and detectability of merger-nova signals from binary neutron star mergers. While it discusses luminosity functions, these are for transient events and not for galaxies or satellites, so it does not match the core criteria.
...
## 76. [Lensing, not luck! Detection prospects of strongly lensed gravitational waves](https://arxiv.org/abs/2510.23238) <a id="link76"></a>
...
**Comment:** Discusses detection prospects for strongly lensed gravitational waves. The focus is on gravitational wave lensing and detection methods, not on galaxy evolution, star formation, or near-field cosmology.
...
## 78. [Detecting ultralight dark matter in the Galactic Center with pulsars around Sgr A*](https://arxiv.org/abs/2510.22573) <a id="link78"></a>
...
**Comment:** Studies the gravitational effects of ultralight dark matter structures on pulsar orbits in the Galactic Center. The focus is on the Galactic Center and black hole environment, not on dwarf galaxies, satellite systems, or near-field cosmology.
...
## 79. [Illuminating the Diffuse Radio Emission in Low-Mass Cluster: Abell 13](https://arxiv.org/abs/2510.21926) <a id="link79"></a>
...
**Comment:** Analyzes diffuse radio emission in a low-mass galaxy cluster, focusing on radio phoenixes and cluster merger activity. The work is on cluster-scale phenomena and does not address dwarf galaxies, satellite systems, or near-field cosmology.
...
## 80. [Discovery of multi-temperature coronal mass ejection signatures from a young solar analogue](https://arxiv.org/abs/2510.22110) <a id="link80"></a>
...
**Comment:** The paper reports multi-temperature coronal mass ejection signatures from a young solar analogue. It is focused on stellar activity and planetary atmospheres, not on galaxies or the core topics.
...
## 81. [Tensor network methods for quantum-inspired image processing and classical optics](https://arxiv.org/abs/2510.23089) <a id="link81"></a>
...
**Comment:** Applies tensor network methods to image processing and classical optics, with some mention of astronomy applications. No direct relevance to any of the core criteria.
...
## 82. [Stellar Wind-Blown Bubbles as Environments for Late-Time Rebrightening of Gamma-Ray Burst Afterglows](https://arxiv.org/abs/2510.22891) <a id="link82"></a>
...
**Comment:** Studies late-time rebrightening of GRB afterglows in stellar wind-blown bubbles. Focus is on GRB environments and jet propagation, not on dwarf galaxies, star formation histories, or the other core topics.
...
## 83. [Revisiting Very High Energy Gamma-Ray Absorption in Cosmic Propagation under the Combined Effects of Axion-Like Particles and Lorentz Violation](https://arxiv.org/abs/2510.23113) <a id="link83"></a>
...
**Comment:** Examines VHE gamma-ray absorption in cosmic propagation with axion-like particles and Lorentz violation. Focus is on high-energy photon propagation, not on any of the core topics.
...
## 84. [RGC: a radio AGN classifier based on deep learning. I. A semi-supervised model for the VLA images of bent radio AGNs](https://arxiv.org/abs/2510.22190) <a id="link84"></a>
...
**Comment:** Focuses on machine learning classification of radio AGNs (WATs and NATs) in VLA images. While AGNs can be found in dense environments like galaxy clusters, the paper is about classification methodology and does not address near-field cosmology, dwarf galaxies, star formation histories, quenching, or galaxy simulations. No direct relevance to the core topics.
...
## 88. [The Programmable Liquid-crystal Active Coronagraphic Imager for the 4-m DAG telescope (PLACID) instrument: installation and commissioning update](https://arxiv.org/abs/2510.23339) <a id="link88"></a>
...
**Comment:** This is an instrumentation paper describing a new coronagraphic imager for direct imaging, with no direct connection to any of the core topics (e.g., near-field cosmology, resolved star formation histories, stellar models, etc.).
...
## 91. [Dark Energy Survey Year 6 Results: Redshift Calibration of the Weak Lensing Source Galaxies](https://arxiv.org/abs/2510.23566) <a id="link91"></a>
...
**Comment:** This work presents redshift calibration for weak lensing source galaxies in the DES survey. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 93. [Inferring neutron-star Love-Q relations from gravitational waves in the hierarchical Bayesian framework](https://arxiv.org/abs/2510.22137) <a id="link93"></a>
...
**Comment:** The paper infers neutron-star Love-Q relations from gravitational waves, focusing on neutron star properties and modified gravity. It does not match any of the core criteria related to galaxies, star formation, or stellar models.
...
## 94. [Charge Trap Analysis in a SENSEI Skipper-CCD: Understanding Low-Energy Backgrounds in Rare-Event Searches](https://arxiv.org/abs/2510.23336) <a id="link94"></a>
...
**Comment:** Analyzes charge traps in Skipper-CCDs for rare-event searches, relevant for detector development but not for any of the core topics such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 95. [A Search for Supermassive Black Hole Binary Candidates in 46-Year Radio Light Curves of 83 Blazars](https://arxiv.org/abs/2510.23103) <a id="link95"></a>
...
**Comment:** This paper focuses on the search for supermassive black hole binaries in blazars using long-term radio light curves. The study is centered on AGN variability and SMBH binaries, which do not match any of the core criteria such as near-field cosmology, resolved star formation histories, dwarf galaxy quenching, stellar models, galaxy simulations, star-formation-driven outflows, or the circumgalactic medium. The focus on blazars and SMBHs is specifically listed as irrelevant.
...
## 96. [A volcanic chronosequence as a time-resolved paleo-detector array to study the cosmic-ray flux in the Late Pleistocene and Holocene](https://arxiv.org/abs/2510.23126) <a id="link96"></a>
...
**Comment:** Presents a new application of paleo-detector technique using volcanic olivine xenoliths to probe cosmic-ray flux over the last 40,000 years. The focus is on cosmic-ray history and paleo-detectors, not on galaxies, star formation, or stellar models.
...
## 99. [Beyond Point Matching: Evaluating Multiscale Dubuc Distance for Time Series Similarity](https://arxiv.org/abs/2510.21824) <a id="link99"></a>
...
**Comment:** Presents a new time series similarity measure (Multiscale Dubuc Distance) and compares it to DTW. This is a data mining/methodology paper with no connection to galaxy evolution, star formation, or any of the core topics.
...
## 100. [Generating background-corrected VPHAS+ HiPS with Montage](https://arxiv.org/abs/2510.21750) <a id="link100"></a>

**ArXiv ID:** 2510.21750

**Authors:** Thomas Boch, Caroline Bot, Pierre Fernique

**Abstract:** We present a technique for creating background-corrected HiPS (Hierarchical Progressive Surveys) from VPHAS+ images using the Montage toolkit. By combining advanced background correction methods and HiPS generation workflows, we produced high-quality color HiPS from the VST Photometric H-alpha Survey of the Southern Galactic Plane and Bulge (VPHAS+). These HiPS have been made publicly available through the HiPS network and serve as an invaluable addition to the HiPS ecosystem for astronomers worldwide.

**Comment:** Describes a technique for creating background-corrected HiPS from VPHAS+ images. While it is a data processing/mapping paper, it does not directly address any of the core topics.
...
## 102. [The velocity dispersion profile of nine open clusters in the solar neighborhood](https://arxiv.org/abs/2510.21921) <a id="link102"></a>
...
**Comment:** The study analyzes velocity dispersion profiles of open clusters to search for stellar-mass black holes. The focus is on star clusters, not galaxies, and does not address the core topics.
...
## 103. [A targeted radio survey of infrared-selected bow shock candidates](https://arxiv.org/abs/2510.23470) <a id="link103"></a>
...
**Comment:** Focuses on radio and IR observations of bow shocks around massive stars, not dwarf galaxies or near-field cosmology. No direct relevance to resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 104. [Evidence for Dynamical Dark Energy using DESI DR2 Ly$\alpha$ Forest](https://arxiv.org/abs/2510.21976) <a id="link104"></a>
...
**Comment:** Analyzes cosmological implications of DESI DR2 Lyα forest BAO measurements and tests dynamical dark energy models. No direct relevance to near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 105. [The variability angular diameter distance and the intrinsic brightness temperature of active galactic nuclei](https://arxiv.org/abs/2510.22079) <a id="link105"></a>
...
**Comment:** Focuses on AGN variability and brightness temperature measurements, which are not related to any of the core topics such as near-field cosmology, dwarf galaxies, resolved star formation histories, or galaxy simulations.
...
## 108. [FOXES: A Framework For Operational X-ray Emission Synthesis](https://arxiv.org/abs/2510.22801) <a id="link108"></a>
...
**Comment:** This paper introduces a framework for operational X-ray emission synthesis for solar flares, using machine learning to predict flare properties. The focus is on solar physics and space weather, not on galaxies or the core topics.
...
## 109. [Seafloor Topography Enhances KM3NeT Sensitivity to ANITA-like Events](https://arxiv.org/abs/2510.21929) <a id="link109"></a>
...
**Comment:** The paper discusses the effect of seafloor topography on the sensitivity of KM3NeT to ultra-high-energy neutrino events, with implications for new physics and detector design. It does not address galaxy evolution, dwarf galaxies, or any of the core topics.
...
## 110. [Observable Signatures of Quarkyonic Phase in Neutron Stars](https://arxiv.org/abs/2510.23405) <a id="link110"></a>
...
**Comment:** Examines observational diagnostics for quarkyonic phases in neutron stars. Focus is on neutron star interiors and equation-of-state constraints, not on galaxy evolution, star formation, or near-field cosmology.
...
## 112. [Learning and Interpreting Gravitational-Wave Features from CNNs with a Random Forest Approach](https://arxiv.org/abs/2505.20357) <a id="link112"></a>
...
**Comment:** Develops a hybrid CNN/random forest approach for gravitational wave detection. No connection to galaxy evolution, star formation, or any of the core topics.
...
## 113. [Prospects for Observing the Microquasar SS 433 with the LACT Array](https://arxiv.org/abs/2510.22776) <a id="link113"></a>

**ArXiv ID:** 2510.22776

**Authors:** Zhen Xie, Zhipeng Zhang, Ruizhi Yang

**Abstract:** We investigate the observational capabilities of the upcoming LACT Cherenkov telescope array for the microquasar SS 433 through detailed simulations. Our results indicate that a detection significance of about 5-sigma can be achieved with approximately 30 hours of observation. The array is capable of spatially resolving the eastern and western jets, and-based on the LHAASO spectral and morphological findings-can distinguish the central hadronic component after roughly 100 h of observation. We further examine its ability to distinguish between the H.E.S.S. and LHAASO spectral models. These findings demonstrate LACT's strong potential to probe the spatial and spectral structure of SS 433 at very high energies, providing valuable insights into particle acceleration in PeVatrons and the radiation mechanisms of microquasars.

**Comment:** Simulates observational prospects for the microquasar SS 433 with the LACT array, focusing on high-energy particle acceleration and radiation mechanisms. No connection to galaxy evolution, star formation, or any of the core topics.
...
## 116. [Fine details in solar flare ribbons: Statistical insights from observations with the Swedish 1-m Solar Telescope](https://arxiv.org/abs/2510.23246) <a id="link116"></a>
...
**Comment:** This paper analyzes fine-scale structure in solar flare ribbons using high-resolution solar observations. It does not match any of the specified criteria.
...
## 117. [Discriminating Between Models of the Nanohertz Gravitational-Wave Background with Pulsar Timing Arrays](https://arxiv.org/abs/2510.22713) <a id="link117"></a>
...
**Comment:** Discusses the nanohertz gravitational-wave background and its origins, focusing on supermassive black hole binaries, cosmic strings, and phase transitions. No direct connection to the core topics.
...
## 118. [Impact of Charge Transfer Inefficiency on transit light-curves: A correction strategy for PLATO](https://arxiv.org/abs/2510.22092) <a id="link118"></a>
...
**Comment:** Discusses correction strategies for charge transfer inefficiency in exoplanet transit photometry for PLATO. No connection to the core topics.
...
## 119. [Earth Analogs in Reflected Light: Insights from Early Spectral Characterization in Unconstrained Orbits](https://arxiv.org/abs/2510.21973) <a id="link119"></a>
...
**Comment:** Examines spectral characterization of Earth-like exoplanets in reflected light. No connection to the core topics.
...
## 120. [Constraint on the physical origin of GRB prompt emission via its non-detected diffuse neutrino emission](https://arxiv.org/abs/2510.22914) <a id="link120"></a>
...
**Comment:** This paper constrains GRB prompt emission models using non-detection of diffuse neutrinos. It is focused on GRB physics and not on galaxies, star formation, or any of the core topics.
...
## 121. [Coronal Mass Ejections Deflected by Newly Emerging Flux: A Combined Analytic and Numerical Study](https://arxiv.org/abs/2510.22958) <a id="link121"></a>
...
**Comment:** This paper studies the effect of newly emerging flux on coronal mass ejections using analytic and numerical methods. It is focused on solar physics and not on galaxies, star formation, or any of the core topics.
...
## 122. [Testing the cosmic distance duality relation using model-independent approach](https://arxiv.org/abs/2510.23037) <a id="link122"></a>
...
**Comment:** Tests the cosmic distance duality relation using cosmological datasets. No direct connection to near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 123. [Solar flare forecasting with foundational transformer models across image, video, and time-series modalities](https://arxiv.org/abs/2510.23400) <a id="link123"></a>
...
**Comment:** This paper applies transformer-based machine learning models to solar flare forecasting using multimodal data. It is not relevant to any of the core topics such as galaxy simulations, star formation, or near-field cosmology.
...
## 126. [Ultraviolet Spectral Evidence for Ansky as a Slowly Evolving Featureless Tidal Disruption Event with Quasi-periodic Eruptions](https://arxiv.org/abs/2510.22211) <a id="link126"></a>
...
**Comment:** This paper discusses a tidal disruption event (TDE) and quasi-periodic eruptions in a galactic nucleus. TDEs and SMBHs are explicitly listed as irrelevant in the criteria.
...
## 127. [Shadows of the Colossus: Hierarchical Black Hole Mergers in a 10-million-body Globular Cluster Simulation](https://arxiv.org/abs/2510.21916) <a id="link127"></a>
...
## 128. [Validation of field cage and cathode for low radioactivity operation with the CYGNO experiment](https://arxiv.org/abs/2510.23229) <a id="link128"></a>
...
**Comment:** Describes validation of detector components for the CYGNO dark matter experiment. No direct relevance to near-field cosmology, resolved star formation histories, quenching, stellar models, galaxy simulations, outflows, or CGM.
...
## 131. [The Ultra Slow-Roll Phase Of Warm Inflation In Braneworld Cosmology](https://arxiv.org/abs/2510.22248) <a id="link131"></a>
...
**Comment:** Focuses on inflationary cosmology and braneworld models, which are not related to near-field cosmology, resolved star formation histories, or galaxy simulations. No criteria match.
...
## 132. [A Search for Ultra-Light Vector Dark Matter with a Rotating Torsion Balance](https://arxiv.org/abs/2510.21764) <a id="link132"></a>

**ArXiv ID:** 2510.21764

**Authors:** M. P. Ross, E. A. Shaw, C. Gettings, S. K. Apple, I. A. Paulson, J. H. Gundlach

**Abstract:** We search for ultra-light vector dark matter interacting with a rotating torsion balance with a baryon minus lepton number composition dipole. Our search spans candidate masses in the ultra-low mass range from 1.3~$\times10^{-22}$ to 1.9~$\times10^{-18}$ eV. We set limits on the coupling strength to baryon minus lepton number for each dark matter candidate reaching a peak sensitivity of $g_{B-L} \leq 9 \times 10^{-26}$.

**Comment:** Searches for ultra-light vector dark matter using a torsion balance. No connection to galaxy simulations, near-field cosmology, or star formation histories.
...
## 136. [Likelihood Reconstruction for Radio Detectors of Neutrinos and Cosmic Rays](https://arxiv.org/abs/2510.21925) <a id="link136"></a>
...
**Comment:** This paper focuses on likelihood reconstruction for radio detectors of neutrinos and cosmic rays. It does not match any of the core criteria such as near-field cosmology, resolved star formation histories, or galaxy simulations.
...
## 137. [A Statistical Study of delta-Sunspots from Solar Cycle 23 to 25](https://arxiv.org/abs/2510.23046) <a id="link137"></a>
...
**Comment:** This is a statistical study of delta-sunspots and their flare activity over solar cycles. It is focused on solar physics and does not address any of the core topics.
...
## 140. [Propellantless space exploration](https://arxiv.org/abs/2510.21743) <a id="link140"></a>
...
**Comment:** This is a review of propellantless propulsion methods for space exploration, including solar sails and magnetic sails. It is entirely unrelated to galaxy evolution, near-field cosmology, or any of the core astrophysical topics.
