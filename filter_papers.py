...
MODEL_PRICING = {
    ...
    # This is a third-party ChatGPT API whose prices are much more expensive than the offical ones.
    ...
    # Here are the prices for "Pay-as-you-go" plan instead of the free plan.
